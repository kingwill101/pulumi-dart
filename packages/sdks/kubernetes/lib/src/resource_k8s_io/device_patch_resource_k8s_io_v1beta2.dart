...
class DevicePatchResourceK8sIoV1beta2 {
  ...
  factory DevicePatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DevicePatchResourceK8sIoV1beta2(
      ...
      consumesCounters: map['consumesCounters'] == null ? null : (pulumi.Input.decodeList<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>(map['consumesCounters'], (value) => DeviceCounterConsumptionPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      taints: map['taints'] == null ? null : (pulumi.Input.decodeList<DeviceTaintPatchResourceK8sIoV1beta2>(map['taints'], (value) => DeviceTaintPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
