...
class DevicePatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>>? consumesCounters;
  ...
  final pulumi.Input<List<DeviceTaintPatchResourceK8sIoV1beta2>>? taints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumesCounters': ?pulumi.Input.mapOptionalInputValue<List<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>, List<Map<String, dynamic>>>(consumesCounters, (value) => pulumi.Input.encodeList<DeviceCounterConsumptionPatchResourceK8sIoV1beta2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      'nodeName': ?nodeName,
      'nodeSelector': ?pulumi.Input.mapOptionalInputValue<NodeSelectorPatch, Map<String, dynamic>>(nodeSelector, (value) => value.toMap()),
      'taints': ?pulumi.Input.mapOptionalInputValue<List<DeviceTaintPatchResourceK8sIoV1beta2>, List<Map<String, dynamic>>>(taints, (value) => pulumi.Input.encodeList<DeviceTaintPatchResourceK8sIoV1beta2, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory DevicePatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DevicePatchResourceK8sIoV1beta2(
      ...
      consumesCounters: (() { final guardedValue = map['consumesCounters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>(guardedValue, (value) => DeviceCounterConsumptionPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      taints: (() { final guardedValue = map['taints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceTaintPatchResourceK8sIoV1beta2>(guardedValue, (value) => DeviceTaintPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
