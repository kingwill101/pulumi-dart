...
class DevicePatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>>?
  consumesCounters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'consumesCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceCounterConsumptionPatchResourceK8sIoV1beta2>,
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceTaintPatchResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
  ...
  factory DevicePatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DevicePatchResourceK8sIoV1beta2(
      ...
      consumesCounters: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceCounterConsumptionPatchResourceK8sIoV1beta2.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceTaintPatchResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceTaintPatchResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
