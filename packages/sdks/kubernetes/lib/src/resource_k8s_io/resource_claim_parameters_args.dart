    ...
    return <String, dynamic>{
      ...
      'driverRequests':
          ...
          >(
            driverRequests,
            (value) =>
                pulumi.Input.encodeList<DriverRequests, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ResourceClaimParametersArgs(
      ...
      driverRequests: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DriverRequests>(
            guardedValue,
            (value) =>
                DriverRequests.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      generatedFrom: (() {
