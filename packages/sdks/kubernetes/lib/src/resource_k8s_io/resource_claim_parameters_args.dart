...
class ResourceClaimParametersArgs {
  ...
  const ResourceClaimParametersArgs({
    this.apiVersion,
    this.driverRequests,
    this.generatedFrom,
    this.kind,
  ...
  factory ResourceClaimParametersArgs.fromMap(Map<String, dynamic> map) {
    return ResourceClaimParametersArgs(
      ...
      driverRequests: (() { final guardedValue = map['driverRequests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DriverRequests>(guardedValue, (value) => DriverRequests.fromMap((value as Map).cast<String, dynamic>()))); })(),
      generatedFrom: (() { final guardedValue = map['generatedFrom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClaimParametersReferenceResourceK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
