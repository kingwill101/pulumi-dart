...
class DeviceClass {
  ...
  DeviceClass({this.apiVersion, this.kind, this.metadata, required this.spec});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': pulumi.Input.mapInputValue<DeviceClassSpec, Map<String, dynamic>>(
        spec,
        (value) => value.toMap(),
      ),
    };
  ...
  factory DeviceClass.fromMap(Map<String, dynamic> map) {
    return DeviceClass(
      ...
      spec: pulumi.Input.fromValue(
        DeviceClassSpec.fromMap((map['spec']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
