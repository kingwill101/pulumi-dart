...
class DeviceTaintRuleStatusResourceK8sIoV1alpha3 {
  ...
  /// Creates a new [DeviceTaintRuleStatusResourceK8sIoV1alpha3].
  ...
  const DeviceTaintRuleStatusResourceK8sIoV1alpha3({
    this.conditions,
  });
  ...
  factory DeviceTaintRuleStatusResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleStatusResourceK8sIoV1alpha3(
