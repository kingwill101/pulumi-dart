...
class DeviceTaintSelectorResourceK8sIoV1beta2 {
  ...
  /// Creates a new [DeviceTaintSelectorResourceK8sIoV1beta2].
  ...
  const DeviceTaintSelectorResourceK8sIoV1beta2({
    this.device,
    this.driver,
    this.pool,
  });
  ...
  factory DeviceTaintSelectorResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceTaintSelectorResourceK8sIoV1beta2(
