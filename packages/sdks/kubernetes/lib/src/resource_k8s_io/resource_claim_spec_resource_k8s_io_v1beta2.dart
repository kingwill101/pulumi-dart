...
class ResourceClaimSpecResourceK8sIoV1beta2 {
  ...
  const ResourceClaimSpecResourceK8sIoV1beta2({
    this.devices,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'devices': ?pulumi.Input.mapOptionalInputValue<DeviceClaimResourceK8sIoV1beta2, Map<String, dynamic>>(devices, (value) => value.toMap()),
    };
  }

  factory ResourceClaimSpecResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecResourceK8sIoV1beta2(
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceClaimResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
