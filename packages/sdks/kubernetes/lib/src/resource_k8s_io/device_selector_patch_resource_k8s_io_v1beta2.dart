...
class DeviceSelectorPatchResourceK8sIoV1beta2 {
  ...
  factory DeviceSelectorPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceSelectorPatchResourceK8sIoV1beta2(
      cel: (() { final guardedValue = map['cel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CELDeviceSelectorPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
