...
class DeviceCapacityPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<CapacityRequestPolicyPatchResourceK8sIoV1beta1>?
  requestPolicy;
  ...
  DeviceCapacityPatchResourceK8sIoV1beta1({this.requestPolicy, this.value});
  ...
  factory DeviceCapacityPatchResourceK8sIoV1beta1.fromMap(
    ...
    return DeviceCapacityPatchResourceK8sIoV1beta1(
      requestPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          CapacityRequestPolicyPatchResourceK8sIoV1beta1.fromMap(
