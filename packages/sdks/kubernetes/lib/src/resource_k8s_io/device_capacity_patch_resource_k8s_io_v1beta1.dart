...
class DeviceCapacityPatchResourceK8sIoV1beta1 {
  ...
  const DeviceCapacityPatchResourceK8sIoV1beta1({
    this.requestPolicy,
    this.value,
  });
  ...
  factory DeviceCapacityPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceCapacityPatchResourceK8sIoV1beta1(
      requestPolicy: (() { final guardedValue = map['requestPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityRequestPolicyPatchResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
