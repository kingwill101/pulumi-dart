...
class ResourceClaimConsumerReferencePatchResourceK8sIoV1beta2 {
  ...
  /// Creates a new [ResourceClaimConsumerReferencePatchResourceK8sIoV1beta2].
  ...
  const ResourceClaimConsumerReferencePatchResourceK8sIoV1beta2({
    this.apiGroup,
    this.name,
    this.resource,
    this.uid,
  ...
  factory ResourceClaimConsumerReferencePatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimConsumerReferencePatchResourceK8sIoV1beta2(
