...
import 'node_allocatable_mapping_patch_resource_k8s_io_v1beta1.dart';
import 'node_allocatable_overhead_patch_resource_k8s_io_v1beta1.dart';
...
class NodeAllocatableResourcePatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<NodeAllocatableMappingPatchResourceK8sIoV1beta1?>? mapping;
  ...
  final pulumi.Input<NodeAllocatableOverheadPatchResourceK8sIoV1beta1?>? overhead;

  /// Creates a new [NodeAllocatableResourcePatchResourceK8sIoV1beta1].
  ...
  const NodeAllocatableResourcePatchResourceK8sIoV1beta1({
    this.mapping,
    this.overhead,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mapping': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableMappingPatchResourceK8sIoV1beta1, Map<String, dynamic>>(mapping, (value) => value.toMap()),
      'overhead': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableOverheadPatchResourceK8sIoV1beta1, Map<String, dynamic>>(overhead, (value) => value.toMap()),
    };
  }

  factory NodeAllocatableResourcePatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableResourcePatchResourceK8sIoV1beta1(
      mapping: (() { final guardedValue = map['mapping']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableMappingPatchResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableOverheadPatchResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
