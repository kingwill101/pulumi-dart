...
class ResourceClassListResourceK8sIoV1alpha2Args {
  ...
  final pulumi.Input<List<ResourceClassResourceK8sIoV1alpha2>> items;
  ...
  const ResourceClassListResourceK8sIoV1alpha2Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<ResourceClassResourceK8sIoV1alpha2>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<ResourceClassResourceK8sIoV1alpha2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory ResourceClassListResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClassListResourceK8sIoV1alpha2Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceClassResourceK8sIoV1alpha2>(map['items']!, (value) => ResourceClassResourceK8sIoV1alpha2.fromMap((value as Map).cast<String, dynamic>()))),
