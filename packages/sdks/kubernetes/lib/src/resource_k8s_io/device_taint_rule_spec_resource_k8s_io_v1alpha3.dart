...
import 'device_taint_selector_resource_k8s_io_v1alpha3.dart';

/// DeviceTaintRuleSpec specifies the selector and one taint.
class DeviceTaintRuleSpecResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<DeviceTaintSelectorResourceK8sIoV1alpha3?>? deviceSelector;
  /// The taint that gets applied to matching devices.
  final pulumi.Input<DeviceTaintResourceK8sIoV1alpha3> taint;

  /// Creates a new [DeviceTaintRuleSpecResourceK8sIoV1alpha3].
  ...
  const DeviceTaintRuleSpecResourceK8sIoV1alpha3({
    this.deviceSelector,
    required this.taint,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'deviceSelector': ?pulumi.Input.mapOptionalInputValue<DeviceTaintSelectorResourceK8sIoV1alpha3, Map<String, dynamic>>(deviceSelector, (value) => value.toMap()),
      'taint': pulumi.Input.mapInputValue<DeviceTaintResourceK8sIoV1alpha3, Map<String, dynamic>>(taint, (value) => value.toMap()),
    };
  }

  factory DeviceTaintRuleSpecResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleSpecResourceK8sIoV1alpha3(
      deviceSelector: (() { final guardedValue = map['deviceSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceTaintSelectorResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
