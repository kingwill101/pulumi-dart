...
class DeviceTaintRuleArgs {
  ...
  DeviceTaintRuleArgs({
    ...
    required pulumi.Output<DeviceTaintRuleSpec> spec,
  }) :
  ...
  factory DeviceTaintRuleArgs.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleArgs(
      ...
      spec: pulumi.Output.create<DeviceTaintRuleSpec>(DeviceTaintRuleSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
