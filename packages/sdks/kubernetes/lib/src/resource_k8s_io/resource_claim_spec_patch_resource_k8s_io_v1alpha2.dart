...
class ResourceClaimSpecPatchResourceK8sIoV1alpha2 {
  ...
  final pulumi.Input<ResourceClaimParametersReferencePatchResourceK8sIoV1alpha2>? parametersRef;
  ...
  const ResourceClaimSpecPatchResourceK8sIoV1alpha2({
    this.allocationMode,
    this.parametersRef,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parametersRef': ?pulumi.Input.mapOptionalInputValue<ResourceClaimParametersReferencePatchResourceK8sIoV1alpha2, Map<String, dynamic>>(parametersRef, (value) => value.toMap()),
  ...
  factory ResourceClaimSpecPatchResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecPatchResourceK8sIoV1alpha2(
      ...
      parametersRef: (() { final guardedValue = map['parametersRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClaimParametersReferencePatchResourceK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
