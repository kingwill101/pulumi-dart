...
class DeviceClassResourceK8sIoV1beta2Args {
  ...
  DeviceClassResourceK8sIoV1beta2Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMeta>? metadata,
    required pulumi.Output<DeviceClassSpecResourceK8sIoV1beta2> spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<DeviceClassSpecResourceK8sIoV1beta2>(spec);
  ...
  factory DeviceClassResourceK8sIoV1beta2Args.fromMap(Map<String, dynamic> map) {
    return DeviceClassResourceK8sIoV1beta2Args(
      ...
      spec: pulumi.Output.create<DeviceClassSpecResourceK8sIoV1beta2>(DeviceClassSpecResourceK8sIoV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
