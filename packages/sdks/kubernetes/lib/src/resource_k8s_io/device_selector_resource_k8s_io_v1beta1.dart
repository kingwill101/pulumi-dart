...
class DeviceSelectorResourceK8sIoV1beta1 {
  ...
  const DeviceSelectorResourceK8sIoV1beta1({
    this.cel,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cel': ?pulumi.Input.mapOptionalInputValue<CELDeviceSelectorResourceK8sIoV1beta1, Map<String, dynamic>>(cel, (value) => value.toMap()),
    };
  }

  factory DeviceSelectorResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceSelectorResourceK8sIoV1beta1(
      cel: (() { final guardedValue = map['cel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CELDeviceSelectorResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
