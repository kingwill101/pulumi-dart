...
class OpaqueDeviceConfigurationResourceK8sIoV1beta1 {
  ...
  /// Creates a new [OpaqueDeviceConfigurationResourceK8sIoV1beta1].
  ...
  const OpaqueDeviceConfigurationResourceK8sIoV1beta1({
  ...
  factory OpaqueDeviceConfigurationResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return OpaqueDeviceConfigurationResourceK8sIoV1beta1(
