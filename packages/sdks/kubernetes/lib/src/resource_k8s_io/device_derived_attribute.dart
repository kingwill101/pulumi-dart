...
class DeviceDerivedAttribute {
  ...
  /// Creates a new [DeviceDerivedAttribute].
  ...
  factory DeviceDerivedAttribute.fromMap(Map<String, dynamic> map) {
    return DeviceDerivedAttribute(
