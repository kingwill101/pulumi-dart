    ...
    return ResourceClassParametersPatchArgs(
      ...
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceFilterPatch>(
            guardedValue,
            (value) => ResourceFilterPatch.fromMap(
      ...
      vendorParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VendorParametersPatch>(
            guardedValue,
            (value) => VendorParametersPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
