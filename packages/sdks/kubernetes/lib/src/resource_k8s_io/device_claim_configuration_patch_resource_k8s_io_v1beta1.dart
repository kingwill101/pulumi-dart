...
class DeviceClaimConfigurationPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1>?
  opaque;
    ...
    return <String, dynamic>{
      'opaque':
          ?pulumi.Input.mapOptionalInputValue<
            OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1,
            Map<String, dynamic>
  ...
  factory DeviceClaimConfigurationPatchResourceK8sIoV1beta1.fromMap(
    ...
    return DeviceClaimConfigurationPatchResourceK8sIoV1beta1(
      opaque: (() {
        ...
        return pulumi.Input.fromValue(
          OpaqueDeviceConfigurationPatchResourceK8sIoV1beta1.fromMap(
