...
class AllocatedDeviceStatusPatchResourceK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkData':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkDeviceDataPatchResourceK8sIoV1beta1,
            Map<String, dynamic>
  ...
  factory AllocatedDeviceStatusPatchResourceK8sIoV1beta1.fromMap(
    ...
    return AllocatedDeviceStatusPatchResourceK8sIoV1beta1(
      ...
      networkData: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkDeviceDataPatchResourceK8sIoV1beta1.fromMap(
