...
import 'network_device_data_patch_resource_k8s_io_v1beta1.dart';
...
class AllocatedDeviceStatusPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<NetworkDeviceDataPatchResourceK8sIoV1beta1?>? networkData;
  ...
  /// Creates a new [AllocatedDeviceStatusPatchResourceK8sIoV1beta1].
  ...
  const AllocatedDeviceStatusPatchResourceK8sIoV1beta1({
    this.conditions,
    this.data,
    this.device,
    this.driver,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'device': ?device,
      'driver': ?driver,
      'networkData': ?pulumi.Input.mapOptionalInputValue<NetworkDeviceDataPatchResourceK8sIoV1beta1, Map<String, dynamic>>(networkData, (value) => value.toMap()),
      'pool': ?pool,
      'shareID': ?shareID,
    };
  }
  ...
  factory AllocatedDeviceStatusPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusPatchResourceK8sIoV1beta1(
      ...
      networkData: (() { final guardedValue = map['networkData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkDeviceDataPatchResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
