...
class DeviceRequestPatchResourceK8sIoV1beta2 {
  ...
  const DeviceRequestPatchResourceK8sIoV1beta2({
    this.exactly,
    this.firstAvailable,
    this.name,
  });
  ...
  factory DeviceRequestPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceRequestPatchResourceK8sIoV1beta2(
      exactly: (() { final guardedValue = map['exactly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExactDeviceRequestPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      firstAvailable: (() { final guardedValue = map['firstAvailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceSubRequestPatchResourceK8sIoV1beta2>(guardedValue, (value) => DeviceSubRequestPatchResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
