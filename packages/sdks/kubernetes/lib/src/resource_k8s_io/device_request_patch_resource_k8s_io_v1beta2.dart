...
class DeviceRequestPatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<DeviceSubRequestPatchResourceK8sIoV1beta2>>?
  firstAvailable;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'firstAvailable':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceSubRequestPatchResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            firstAvailable,
            (value) =>
                pulumi.Input.encodeList<
                  DeviceSubRequestPatchResourceK8sIoV1beta2,
                  Map<String, dynamic>
  ...
  factory DeviceRequestPatchResourceK8sIoV1beta2.fromMap(
    ...
    return DeviceRequestPatchResourceK8sIoV1beta2(
      exactly: (() {
        ...
        return pulumi.Input.fromValue(
          ExactDeviceRequestPatchResourceK8sIoV1beta2.fromMap(
      ...
      firstAvailable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceSubRequestPatchResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceSubRequestPatchResourceK8sIoV1beta2.fromMap(
