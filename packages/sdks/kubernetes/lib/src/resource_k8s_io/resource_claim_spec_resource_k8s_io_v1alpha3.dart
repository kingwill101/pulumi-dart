...
class ResourceClaimSpecResourceK8sIoV1alpha3 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices': ?pulumi.Input.mapOptionalInputValue<DeviceClaimResourceK8sIoV1alpha3, Map<String, dynamic>>(devices, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceClaimSpecResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecResourceK8sIoV1alpha3(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceClaimResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
