...
class DeviceClassConfigurationPatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<OpaqueDeviceConfigurationPatchResourceK8sIoV1beta2>?
  opaque;

  /// Creates a new [DeviceClassConfigurationPatchResourceK8sIoV1beta2].
  /// [opaque] Opaque provides driver-specific configuration parameters.
  DeviceClassConfigurationPatchResourceK8sIoV1beta2({this.opaque});
  ...
  factory DeviceClassConfigurationPatchResourceK8sIoV1beta2.fromMap(
    ...
    return DeviceClassConfigurationPatchResourceK8sIoV1beta2(
      opaque: (() {
        ...
        return pulumi.Input.fromValue(
          OpaqueDeviceConfigurationPatchResourceK8sIoV1beta2.fromMap(
