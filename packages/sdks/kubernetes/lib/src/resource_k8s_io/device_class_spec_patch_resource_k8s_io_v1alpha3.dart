...
class DeviceClassSpecPatchResourceK8sIoV1alpha3 {
  ...
  const DeviceClassSpecPatchResourceK8sIoV1alpha3({
    this.config,
    this.selectors,
    this.suitableNodes,
  });
  ...
  factory DeviceClassSpecPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceClassSpecPatchResourceK8sIoV1alpha3(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceClassConfigurationPatchResourceK8sIoV1alpha3>(guardedValue, (value) => DeviceClassConfigurationPatchResourceK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>()))); })(),
      selectors: (() { final guardedValue = map['selectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceSelectorPatchResourceK8sIoV1alpha3>(guardedValue, (value) => DeviceSelectorPatchResourceK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>()))); })(),
