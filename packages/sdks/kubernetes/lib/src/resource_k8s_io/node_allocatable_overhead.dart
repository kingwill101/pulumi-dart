...
class NodeAllocatableOverhead {
  ...
  /// Creates a new [NodeAllocatableOverhead].
  ...
  factory NodeAllocatableOverhead.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableOverhead(
