...
class NodeAllocatableMappingResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<String?>? capacityMultiplier;
  ...
  final pulumi.Input<String?>? deviceMultiplier;

  /// Creates a new [NodeAllocatableMappingResourceK8sIoV1beta2].
  ...
  const NodeAllocatableMappingResourceK8sIoV1beta2({
    this.capacityKey,
    this.capacityMultiplier,
    this.deviceMultiplier,
  });
  ...
  factory NodeAllocatableMappingResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableMappingResourceK8sIoV1beta2(
      capacityKey: (() { final guardedValue = map['capacityKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      capacityMultiplier: (() { final guardedValue = map['capacityMultiplier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deviceMultiplier: (() { final guardedValue = map['deviceMultiplier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
