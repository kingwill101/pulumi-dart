...
class DeviceAllocationConfigurationResourceK8sIoV1beta2 {
    ...
    return <String, dynamic>{
      'opaque':
          ?pulumi.Input.mapOptionalInputValue<
            OpaqueDeviceConfigurationResourceK8sIoV1beta2,
            Map<String, dynamic>
  ...
  factory DeviceAllocationConfigurationResourceK8sIoV1beta2.fromMap(
    ...
    return DeviceAllocationConfigurationResourceK8sIoV1beta2(
      opaque: (() {
        ...
        return pulumi.Input.fromValue(
          OpaqueDeviceConfigurationResourceK8sIoV1beta2.fromMap(
