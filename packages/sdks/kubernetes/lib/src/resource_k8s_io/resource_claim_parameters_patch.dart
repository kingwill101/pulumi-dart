...
class ResourceClaimParametersPatch {
  ...
  factory ResourceClaimParametersPatch.fromMap(Map<String, dynamic> map) {
    return ResourceClaimParametersPatch(
      ...
      driverRequests: (() {
        final guardedValue = map['driverRequests'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DriverRequestsPatch>(
            guardedValue,
            (value) => DriverRequestsPatch.fromMap(
      ...
      generatedFrom: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceClaimParametersReferencePatchResourceK8sIoV1alpha2.fromMap(
