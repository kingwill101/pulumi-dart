...
class AllocatedDeviceStatusPatch {
  ...
  final NetworkDeviceDataPatch? networkData;
  ...
  factory AllocatedDeviceStatusPatch.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusPatch(
      ...
      networkData: map['networkData'] == null ? null : NetworkDeviceDataPatch.fromMap((map['networkData'] as Map).cast<String, dynamic>()),
