...
import 'network_device_data_patch.dart';
...
class AllocatedDeviceStatusPatch {
  ...
  final pulumi.Input<NetworkDeviceDataPatch>? networkData;
  ...
  /// Creates a new [AllocatedDeviceStatusPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'device': ?device,
      'driver': ?driver,
      'networkData': ?pulumi.Input.mapOptionalInputValue<NetworkDeviceDataPatch, Map<String, dynamic>>(networkData, (value) => value.toMap()),
      'pool': ?pool,
      'shareID': ?shareID,
    };
  }

  factory AllocatedDeviceStatusPatch.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusPatch(
      ...
      networkData: (() { final guardedValue = map['networkData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkDeviceDataPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
