...
class OpaqueDeviceConfigurationResourceK8sIoV1beta2 {
  ...
  /// Creates a new [OpaqueDeviceConfigurationResourceK8sIoV1beta2].
  ...
  const OpaqueDeviceConfigurationResourceK8sIoV1beta2({
  ...
  factory OpaqueDeviceConfigurationResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return OpaqueDeviceConfigurationResourceK8sIoV1beta2(
