...
class ResourceSliceSpecPatchResourceK8sIoV1beta1 {
    ...
    return <String, dynamic>{
      ...
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
            List<DevicePatchResourceK8sIoV1beta1>,
      ...
      'pool':
          ?pulumi.Input.mapOptionalInputValue<
            ResourcePoolPatchResourceK8sIoV1beta1,
            Map<String, dynamic>
          >(pool, (value) => value.toMap()),
      'sharedCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<CounterSetPatchResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            sharedCounters,
            (value) =>
  ...
  factory ResourceSliceSpecPatchResourceK8sIoV1beta1.fromMap(
    ...
    return ResourceSliceSpecPatchResourceK8sIoV1beta1(
      ...
      devices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DevicePatchResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DevicePatchResourceK8sIoV1beta1.fromMap(
      ...
      pool: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourcePoolPatchResourceK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sharedCounters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CounterSetPatchResourceK8sIoV1beta1>(
            guardedValue,
            (value) => CounterSetPatchResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
