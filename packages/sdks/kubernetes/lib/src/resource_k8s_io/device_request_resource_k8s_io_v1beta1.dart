...
import 'device_derived_attribute_resource_k8s_io_v1beta1.dart';
import 'device_selector_resource_k8s_io_v1beta1.dart';
import 'device_sub_request_resource_k8s_io_v1beta1.dart';
import 'device_toleration_resource_k8s_io_v1beta1.dart';

/// DeviceRequest is a request for devices required for a claim. This is typically a request for a single resource like a device, but can also ask for several identical devices.
class DeviceRequestResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<DeviceDerivedAttributeResourceK8sIoV1beta1>?>? derivedAttributes;
  ...
  final pulumi.Input<List<DeviceSubRequestResourceK8sIoV1beta1>?>? firstAvailable;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'count': ?count,
      'derivedAttributes': ?pulumi.Input.mapOptionalInputValue<List<DeviceDerivedAttributeResourceK8sIoV1beta1>, List<Map<String, dynamic>>>(derivedAttributes, (value) => pulumi.Input.encodeList<DeviceDerivedAttributeResourceK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'deviceClassName': ?deviceClassName,
      'firstAvailable': ?pulumi.Input.mapOptionalInputValue<List<DeviceSubRequestResourceK8sIoV1beta1>, List<Map<String, dynamic>>>(firstAvailable, (value) => pulumi.Input.encodeList<DeviceSubRequestResourceK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': name,
  ...
  factory DeviceRequestResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceRequestResourceK8sIoV1beta1(
      ...
      derivedAttributes: (() { final guardedValue = map['derivedAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceDerivedAttributeResourceK8sIoV1beta1>(guardedValue, (value) => DeviceDerivedAttributeResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      firstAvailable: (() { final guardedValue = map['firstAvailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceSubRequestResourceK8sIoV1beta1>(guardedValue, (value) => DeviceSubRequestResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
