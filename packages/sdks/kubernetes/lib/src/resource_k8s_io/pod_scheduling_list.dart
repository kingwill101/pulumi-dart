...
class PodSchedulingList {
  ...
  /// Creates a new [PodSchedulingList].
    ...
    return <String, dynamic>{
      ...
      'items':
          ...
          >(
            items,
            (value) =>
                pulumi.Input.encodeList<PodScheduling, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory PodSchedulingList.fromMap(Map<String, dynamic> map) {
    return PodSchedulingList(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PodScheduling>(
          map['items']!,
          (value) =>
              PodScheduling.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      kind: (() {
