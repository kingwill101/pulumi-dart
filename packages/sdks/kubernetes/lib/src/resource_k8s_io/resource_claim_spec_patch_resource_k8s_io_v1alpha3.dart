...
class ResourceClaimSpecPatchResourceK8sIoV1alpha3 {
  ...
  const ResourceClaimSpecPatchResourceK8sIoV1alpha3({
    this.controller,
    this.devices,
  });
  ...
  factory ResourceClaimSpecPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecPatchResourceK8sIoV1alpha3(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceClaimPatchResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
