...
class PodSchedulingContextPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<PodSchedulingContextStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory PodSchedulingContextPatch.fromMap(Map<String, dynamic> map) {
    return PodSchedulingContextPatch(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodSchedulingContextSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodSchedulingContextStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
