...
import 'node_allocatable_mapping.dart';
import 'node_allocatable_overhead.dart';
...
class NodeAllocatableResource {
  ...
  final pulumi.Input<NodeAllocatableMapping?>? mapping;
  ...
  final pulumi.Input<NodeAllocatableOverhead?>? overhead;

  /// Creates a new [NodeAllocatableResource].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mapping': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableMapping, Map<String, dynamic>>(mapping, (value) => value.toMap()),
      'overhead': ?pulumi.Input.mapOptionalInputValue<NodeAllocatableOverhead, Map<String, dynamic>>(overhead, (value) => value.toMap()),
    };
  }

  factory NodeAllocatableResource.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableResource(
      mapping: (() { final guardedValue = map['mapping']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableMapping.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeAllocatableOverhead.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
