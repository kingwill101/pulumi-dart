...
class PodSchedulingContextStatusResourceK8sIoV1alpha3 {
  ...
  const PodSchedulingContextStatusResourceK8sIoV1alpha3({
    this.resourceClaims,
  });
  ...
  factory PodSchedulingContextStatusResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return PodSchedulingContextStatusResourceK8sIoV1alpha3(
      resourceClaims: (() { final guardedValue = map['resourceClaims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceClaimSchedulingStatusResourceK8sIoV1alpha3>(guardedValue, (value) => ResourceClaimSchedulingStatusResourceK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
