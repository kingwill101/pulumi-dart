...
class DeviceDerivedAttributeResourceK8sIoV1beta2 {
  ...
  /// Creates a new [DeviceDerivedAttributeResourceK8sIoV1beta2].
  ...
  const DeviceDerivedAttributeResourceK8sIoV1beta2({
  ...
  factory DeviceDerivedAttributeResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceDerivedAttributeResourceK8sIoV1beta2(
