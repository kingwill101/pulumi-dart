...
class DeviceTaintRuleStatusPatchResourceK8sIoV1alpha3 {
  ...
  /// Creates a new [DeviceTaintRuleStatusPatchResourceK8sIoV1alpha3].
  ...
  const DeviceTaintRuleStatusPatchResourceK8sIoV1alpha3({
    this.conditions,
  });
  ...
  factory DeviceTaintRuleStatusPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleStatusPatchResourceK8sIoV1alpha3(
