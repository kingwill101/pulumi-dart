...
class DeviceResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<Map<String, DeviceAttributeResourceK8sIoV1beta2>>?
  attributes;
  ...
  final pulumi.Input<List<DeviceCounterConsumptionResourceK8sIoV1beta2>>?
  consumesCounters;
    ...
    return <String, dynamic>{
      ...
      'attributes':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeviceAttributeResourceK8sIoV1beta2>,
      ...
      'capacity':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeviceCapacityResourceK8sIoV1beta2>,
            Map<String, Map<String, dynamic>>
          >(
            capacity,
            (value) =>
      ...
      'consumesCounters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceCounterConsumptionResourceK8sIoV1beta2>,
      ...
      'taints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceTaintResourceK8sIoV1beta2>,
            List<Map<String, dynamic>>
          >(
            taints,
            (value) =>
    ...
    return DeviceResourceK8sIoV1beta2(
      ...
      attributes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeviceAttributeResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceAttributeResourceK8sIoV1beta2.fromMap(
      ...
      capacity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeviceCapacityResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceCapacityResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      consumesCounters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceCounterConsumptionResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceCounterConsumptionResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceTaintResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceTaintResourceK8sIoV1beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
