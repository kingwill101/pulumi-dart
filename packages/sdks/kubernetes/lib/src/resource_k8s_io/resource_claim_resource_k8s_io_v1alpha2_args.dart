...
class ResourceClaimResourceK8sIoV1alpha2Args {
  ...
  ResourceClaimResourceK8sIoV1alpha2Args({
    ...
    required pulumi.Output<ResourceClaimSpecResourceK8sIoV1alpha2> spec,
  }) :
  ...
  factory ResourceClaimResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimResourceK8sIoV1alpha2Args(
      ...
      spec: pulumi.Output.create<ResourceClaimSpecResourceK8sIoV1alpha2>(ResourceClaimSpecResourceK8sIoV1alpha2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
