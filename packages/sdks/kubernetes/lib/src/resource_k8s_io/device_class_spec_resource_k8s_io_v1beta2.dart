...
class DeviceClassSpecResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<DeviceClassConfigurationResourceK8sIoV1beta2>>?
  config;
    ...
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceClassConfigurationResourceK8sIoV1beta2>,
  ...
  factory DeviceClassSpecResourceK8sIoV1beta2.fromMap(
    ...
    return DeviceClassSpecResourceK8sIoV1beta2(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceClassConfigurationResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceClassConfigurationResourceK8sIoV1beta2.fromMap(
