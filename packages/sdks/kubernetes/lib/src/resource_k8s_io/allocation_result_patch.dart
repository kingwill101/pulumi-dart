...
class AllocationResultPatch {
  ...
  final pulumi.Input<DeviceAllocationResultPatch>? devices;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices': ?pulumi.Input.mapOptionalInputValue<DeviceAllocationResultPatch, Map<String, dynamic>>(devices, (value) => value.toMap()),
  ...
  factory AllocationResultPatch.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatch(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceAllocationResultPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
