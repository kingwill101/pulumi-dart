...
class NodeAllocatableResourceMappingPatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [NodeAllocatableResourceMappingPatchResourceK8sIoV1beta1].
  ...
  const NodeAllocatableResourceMappingPatchResourceK8sIoV1beta1({
  ...
  factory NodeAllocatableResourceMappingPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableResourceMappingPatchResourceK8sIoV1beta1(
      allocationMultiplier: (() { final guardedValue = map['allocationMultiplier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
