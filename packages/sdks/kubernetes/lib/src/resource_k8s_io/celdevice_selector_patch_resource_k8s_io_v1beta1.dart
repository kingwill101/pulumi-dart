...
class CELDeviceSelectorPatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [CELDeviceSelectorPatchResourceK8sIoV1beta1].
  ...
  CELDeviceSelectorPatchResourceK8sIoV1beta1({this.expression});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'expression': ?expression};
  }

  factory CELDeviceSelectorPatchResourceK8sIoV1beta1.fromMap(
