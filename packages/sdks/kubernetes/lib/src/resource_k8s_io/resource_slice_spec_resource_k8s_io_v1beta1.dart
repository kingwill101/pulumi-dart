...
class ResourceSliceSpecResourceK8sIoV1beta1 {
  ...
  final List<DeviceResourceK8sIoV1beta1>? devices;
  ...
  final ResourcePoolResourceK8sIoV1beta1 pool;
  ...
  final List<CounterSetResourceK8sIoV1beta1>? sharedCounters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allNodes': ?allNodes,
      'devices': ?devices == null ? null : pulumi.Input.encodeList<DeviceResourceK8sIoV1beta1, Map<String, dynamic>>(devices!, (value) => value.toMap()),
      'driver': driver,
      'nodeName': ?nodeName,
      'nodeSelector': ?nodeSelector == null ? null : nodeSelector!.toMap(),
      'perDeviceNodeSelection': ?perDeviceNodeSelection,
      'pool': pool.toMap(),
      'sharedCounters': ?sharedCounters == null ? null : pulumi.Input.encodeList<CounterSetResourceK8sIoV1beta1, Map<String, dynamic>>(sharedCounters!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceSliceSpecResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecResourceK8sIoV1beta1(
      ...
      devices: map['devices'] == null ? null : pulumi.Input.decodeList<DeviceResourceK8sIoV1beta1>(map['devices'], (value) => DeviceResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pool: ResourcePoolResourceK8sIoV1beta1.fromMap((map['pool'] as Map).cast<String, dynamic>()),
      sharedCounters: map['sharedCounters'] == null ? null : pulumi.Input.decodeList<CounterSetResourceK8sIoV1beta1>(map['sharedCounters'], (value) => CounterSetResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
