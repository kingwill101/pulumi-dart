...
class ResourceSliceSpecResourceK8sIoV1beta1 {
  ...
  const ResourceSliceSpecResourceK8sIoV1beta1({
    this.allNodes,
    this.devices,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allNodes': ?allNodes,
      'devices': ?pulumi.Input.mapOptionalInputValue<List<DeviceResourceK8sIoV1beta1>, List<Map<String, dynamic>>>(devices, (value) => pulumi.Input.encodeList<DeviceResourceK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'driver': driver,
      'nodeName': ?nodeName,
      ...
      'pool': pulumi.Input.mapInputValue<ResourcePoolResourceK8sIoV1beta1, Map<String, dynamic>>(pool, (value) => value.toMap()),
      'sharedCounters': ?pulumi.Input.mapOptionalInputValue<List<CounterSetResourceK8sIoV1beta1>, List<Map<String, dynamic>>>(sharedCounters, (value) => pulumi.Input.encodeList<CounterSetResourceK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'skipNodeOperations': ?skipNodeOperations,
    };
  }

  factory ResourceSliceSpecResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecResourceK8sIoV1beta1(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceResourceK8sIoV1beta1>(guardedValue, (value) => DeviceResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      pool: pulumi.Input.fromValue(ResourcePoolResourceK8sIoV1beta1.fromMap((map['pool']! as Map).cast<String, dynamic>())),
      sharedCounters: (() { final guardedValue = map['sharedCounters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CounterSetResourceK8sIoV1beta1>(guardedValue, (value) => CounterSetResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
