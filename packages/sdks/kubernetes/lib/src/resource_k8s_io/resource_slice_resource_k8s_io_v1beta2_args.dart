...
class ResourceSliceResourceK8sIoV1beta2Args {
  ...
  ResourceSliceResourceK8sIoV1beta2Args({
    ...
    required pulumi.Output<ResourceSliceSpecResourceK8sIoV1beta2> spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<ResourceSliceSpecResourceK8sIoV1beta2>(spec);
  ...
  factory ResourceSliceResourceK8sIoV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ResourceSliceResourceK8sIoV1beta2Args(
      ...
      spec: pulumi.Output.create<ResourceSliceSpecResourceK8sIoV1beta2>(ResourceSliceSpecResourceK8sIoV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
