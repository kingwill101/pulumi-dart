...
class ResourceSliceResourceK8sIoV1beta2Args {
  ...
  const ResourceSliceResourceK8sIoV1beta2Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory ResourceSliceResourceK8sIoV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ResourceSliceResourceK8sIoV1beta2Args(
      ...
      spec: pulumi.Input.fromValue(ResourceSliceSpecResourceK8sIoV1beta2.fromMap((map['spec']! as Map).cast<String, dynamic>())),
    );
  }
}
