...
class DeviceRequestResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<List<DeviceSubRequestResourceK8sIoV1beta2>>?
  firstAvailable;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'firstAvailable':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceSubRequestResourceK8sIoV1beta2>,
    ...
    return DeviceRequestResourceK8sIoV1beta2(
      exactly: (() {
        ...
        return pulumi.Input.fromValue(
          ExactDeviceRequestResourceK8sIoV1beta2.fromMap(
      ...
      firstAvailable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceSubRequestResourceK8sIoV1beta2>(
            guardedValue,
            (value) => DeviceSubRequestResourceK8sIoV1beta2.fromMap(
