...
class ResourceClaimTemplatePatchResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ResourceClaimTemplateSpecPatchResourceK8sIoV1alpha1?>
  spec;
  ...
  ResourceClaimTemplatePatchResource(
    ...
    spec = registerOutput<ResourceClaimTemplateSpecPatchResourceK8sIoV1alpha1?>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ResourceClaimTemplateSpecPatchResourceK8sIoV1alpha1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
