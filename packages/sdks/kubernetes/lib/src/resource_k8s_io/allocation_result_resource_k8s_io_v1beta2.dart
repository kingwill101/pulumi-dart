...
class AllocationResultResourceK8sIoV1beta2 {
  ...
  const AllocationResultResourceK8sIoV1beta2({
  ...
  factory AllocationResultResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocationResultResourceK8sIoV1beta2(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceAllocationResultResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
