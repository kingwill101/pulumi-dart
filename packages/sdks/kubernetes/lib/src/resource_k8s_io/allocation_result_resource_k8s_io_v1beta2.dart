...
class AllocationResultResourceK8sIoV1beta2 {
  ...
  final DeviceAllocationResultResourceK8sIoV1beta2? devices;
  ...
  factory AllocationResultResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocationResultResourceK8sIoV1beta2(
      ...
      devices: map['devices'] == null ? null : DeviceAllocationResultResourceK8sIoV1beta2.fromMap((map['devices'] as Map).cast<String, dynamic>()),
