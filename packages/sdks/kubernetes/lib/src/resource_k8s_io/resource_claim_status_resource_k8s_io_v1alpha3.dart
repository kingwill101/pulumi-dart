...
class ResourceClaimStatusResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<List<ResourceClaimConsumerReferenceResourceK8sIoV1alpha3>?>? reservedFor;
  ...
  const ResourceClaimStatusResourceK8sIoV1alpha3({
    this.allocation,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allocation': ?pulumi.Input.mapOptionalInputValue<AllocationResultResourceK8sIoV1alpha3, Map<String, dynamic>>(allocation, (value) => value.toMap()),
      'deallocationRequested': ?deallocationRequested,
      'reservedFor': ?pulumi.Input.mapOptionalInputValue<List<ResourceClaimConsumerReferenceResourceK8sIoV1alpha3>, List<Map<String, dynamic>>>(reservedFor, (value) => pulumi.Input.encodeList<ResourceClaimConsumerReferenceResourceK8sIoV1alpha3, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory ResourceClaimStatusResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusResourceK8sIoV1alpha3(
      allocation: (() { final guardedValue = map['allocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllocationResultResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      reservedFor: (() { final guardedValue = map['reservedFor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceClaimConsumerReferenceResourceK8sIoV1alpha3>(guardedValue, (value) => ResourceClaimConsumerReferenceResourceK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
