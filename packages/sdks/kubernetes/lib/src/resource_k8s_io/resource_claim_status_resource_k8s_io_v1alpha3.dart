...
class ResourceClaimStatusResourceK8sIoV1alpha3 {
  ...
  final AllocationResultResourceK8sIoV1alpha3? allocation;
  ...
  final List<ResourceClaimConsumerReferenceResourceK8sIoV1alpha3>? reservedFor;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reservedFor': ?reservedFor == null ? null : pulumi.Input.encodeList<ResourceClaimConsumerReferenceResourceK8sIoV1alpha3, Map<String, dynamic>>(reservedFor!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceClaimStatusResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusResourceK8sIoV1alpha3(
      allocation: map['allocation'] == null ? null : AllocationResultResourceK8sIoV1alpha3.fromMap((map['allocation'] as Map).cast<String, dynamic>()),
      deallocationRequested: map['deallocationRequested'] == null ? null : map['deallocationRequested'] as bool,
      reservedFor: map['reservedFor'] == null ? null : pulumi.Input.decodeList<ResourceClaimConsumerReferenceResourceK8sIoV1alpha3>(map['reservedFor'], (value) => ResourceClaimConsumerReferenceResourceK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
