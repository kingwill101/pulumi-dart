...
class AllocatedDeviceStatusResourceK8sIoV1beta1 {
  ...
  const AllocatedDeviceStatusResourceK8sIoV1beta1({
    this.conditions,
    this.data,
  ...
  factory AllocatedDeviceStatusResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusResourceK8sIoV1beta1(
      ...
      networkData: (() { final guardedValue = map['networkData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkDeviceDataResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
