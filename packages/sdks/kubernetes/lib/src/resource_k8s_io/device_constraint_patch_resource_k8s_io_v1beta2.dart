...
class DeviceConstraintPatchResourceK8sIoV1beta2 {
  ...
  /// Creates a new [DeviceConstraintPatchResourceK8sIoV1beta2].
  ...
  const DeviceConstraintPatchResourceK8sIoV1beta2({
  ...
  factory DeviceConstraintPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceConstraintPatchResourceK8sIoV1beta2(
