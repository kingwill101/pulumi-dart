...
class ResourceClaimStatusPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<AllocatedDeviceStatusPatchResourceK8sIoV1beta1>>?
  devices;
  ...
  final pulumi.Input<
    List<ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1>
  >?
  reservedFor;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
            List<AllocatedDeviceStatusPatchResourceK8sIoV1beta1>,
      ...
      'reservedFor':
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    };
  ...
  factory ResourceClaimStatusPatchResourceK8sIoV1beta1.fromMap(
    ...
    return ResourceClaimStatusPatchResourceK8sIoV1beta1(
      allocation: (() {
        ...
        return pulumi.Input.fromValue(
          AllocationResultPatchResourceK8sIoV1beta1.fromMap(
      ...
      devices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<AllocatedDeviceStatusPatchResourceK8sIoV1beta1>(
            guardedValue,
            (value) => AllocatedDeviceStatusPatchResourceK8sIoV1beta1.fromMap(
      ...
      reservedFor: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
