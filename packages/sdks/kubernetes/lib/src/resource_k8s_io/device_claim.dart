...
class DeviceClaim {
  ...
  factory DeviceClaim.fromMap(Map<String, dynamic> map) {
    return DeviceClaim(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceClaimConfiguration>(guardedValue, (value) => DeviceClaimConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      constraints: (() { final guardedValue = map['constraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceConstraint>(guardedValue, (value) => DeviceConstraint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requests: (() { final guardedValue = map['requests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceRequest>(guardedValue, (value) => DeviceRequest.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
