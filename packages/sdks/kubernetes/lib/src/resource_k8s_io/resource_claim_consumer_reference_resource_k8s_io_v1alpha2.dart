...
class ResourceClaimConsumerReferenceResourceK8sIoV1alpha2 {
  ...
  /// Creates a new [ResourceClaimConsumerReferenceResourceK8sIoV1alpha2].
  ...
  const ResourceClaimConsumerReferenceResourceK8sIoV1alpha2({
    this.apiGroup,
    required this.name,
  ...
  factory ResourceClaimConsumerReferenceResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimConsumerReferenceResourceK8sIoV1alpha2(
