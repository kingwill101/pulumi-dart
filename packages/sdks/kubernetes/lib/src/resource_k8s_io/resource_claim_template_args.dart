...
class ResourceClaimTemplateArgs {
  ...
  ResourceClaimTemplateArgs({
    ...
    required pulumi.Output<ResourceClaimTemplateSpec> spec,
  }) :
  ...
  factory ResourceClaimTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplateArgs(
      ...
      spec: pulumi.Output.create<ResourceClaimTemplateSpec>(ResourceClaimTemplateSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
