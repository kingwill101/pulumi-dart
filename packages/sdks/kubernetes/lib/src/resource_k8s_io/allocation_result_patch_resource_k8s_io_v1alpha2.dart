...
class AllocationResultPatchResourceK8sIoV1alpha2 {
  ...
  factory AllocationResultPatchResourceK8sIoV1alpha2.fromMap(
    ...
    return AllocationResultPatchResourceK8sIoV1alpha2(
      ...
      resourceHandles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceHandlePatch>(
            guardedValue,
            (value) => ResourceHandlePatch.fromMap(
