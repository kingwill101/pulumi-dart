...
class AllocationResultPatchResourceK8sIoV1alpha2 {
  ...
  const AllocationResultPatchResourceK8sIoV1alpha2({
  ...
  factory AllocationResultPatchResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatchResourceK8sIoV1alpha2(
      availableOnNodes: (() { final guardedValue = map['availableOnNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeSelectorPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceHandles: (() { final guardedValue = map['resourceHandles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceHandlePatch>(guardedValue, (value) => ResourceHandlePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
