...
class ResourcePoolPatch {
  ...
  /// Creates a new [ResourcePoolPatch].
  ...
  ResourcePoolPatch({this.generation, this.name, this.resourceSliceCount});
  ...
  factory ResourcePoolPatch.fromMap(Map<String, dynamic> map) {
