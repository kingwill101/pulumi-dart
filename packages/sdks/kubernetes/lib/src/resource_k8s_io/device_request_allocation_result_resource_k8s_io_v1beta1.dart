...
class DeviceRequestAllocationResultResourceK8sIoV1beta1 {
  ...
  final Map<String, String>? consumedCapacity;
  ...
  /// Creates a new [DeviceRequestAllocationResultResourceK8sIoV1beta1].
  ...
  DeviceRequestAllocationResultResourceK8sIoV1beta1({
    this.adminAccess,
  ...
  factory DeviceRequestAllocationResultResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceRequestAllocationResultResourceK8sIoV1beta1(
      ...
      consumedCapacity: map['consumedCapacity'] == null ? null : (map['consumedCapacity'] as Map).cast<String, String>(),
