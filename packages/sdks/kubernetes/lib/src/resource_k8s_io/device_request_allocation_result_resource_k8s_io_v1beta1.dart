...
class DeviceRequestAllocationResultResourceK8sIoV1beta1 {
    ...
    return <String, dynamic>{
      ...
      'tolerations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceTolerationResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            tolerations,
            (value) =>
                pulumi.Input.encodeList<
                  DeviceTolerationResourceK8sIoV1beta1,
                  Map<String, dynamic>
  ...
  factory DeviceRequestAllocationResultResourceK8sIoV1beta1.fromMap(
    ...
    return DeviceRequestAllocationResultResourceK8sIoV1beta1(
      ...
      tolerations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceTolerationResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceTolerationResourceK8sIoV1beta1.fromMap(
