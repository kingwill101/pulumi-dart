...
class DeviceClassPatchResourceK8sIoV1beta2Resource
  ...
  DeviceClassPatchResourceK8sIoV1beta2Resource(
    ...
    spec = registerOutput<DeviceClassSpecPatchResourceK8sIoV1beta2?>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return DeviceClassSpecPatchResourceK8sIoV1beta2.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
