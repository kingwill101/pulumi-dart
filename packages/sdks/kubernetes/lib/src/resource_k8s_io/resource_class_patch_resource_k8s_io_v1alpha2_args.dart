...
/// {@template pulumi_resource_k8s_io_v1alpha2_resource_class_patch_resource_k8s_io_v1alpha2_args_doc}
/// The set of arguments for ResourceClassPatch.
/// {@endtemplate}
/// {@macro pulumi_resource_k8s_io_v1alpha2_resource_class_patch_resource_k8s_io_v1alpha2_args_doc}
class ResourceClassPatchResourceK8sIoV1alpha2Args {
  ...
  /// Creates a new [ResourceClassPatchResourceK8sIoV1alpha2Args].
  ...
  const ResourceClassPatchResourceK8sIoV1alpha2Args({
    this.apiVersion,
    this.driverName,
    this.kind,
    this.metadata,
  ...
  factory ResourceClassPatchResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClassPatchResourceK8sIoV1alpha2Args(
      ...
      parametersRef: (() { final guardedValue = map['parametersRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClassParametersReferencePatchResourceK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      structuredParameters: (() { final guardedValue = map['structuredParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
