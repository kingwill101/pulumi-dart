...
class ResourceClassPatchResourceK8sIoV1alpha2Args {
  ...
  factory ResourceClassPatchResourceK8sIoV1alpha2Args.fromMap(
    ...
    return ResourceClassPatchResourceK8sIoV1alpha2Args(
      ...
      parametersRef: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceClassParametersReferencePatchResourceK8sIoV1alpha2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      structuredParameters: (() {
        final guardedValue = map['structuredParameters'];
        if (guardedValue == null) return null;
