...
class ResourceClaimSpecPatchResourceK8sIoV1beta1 {
  ...
  factory ResourceClaimSpecPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecPatchResourceK8sIoV1beta1(
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceClaimPatchResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
