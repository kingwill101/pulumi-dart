...
class CounterSetPatchResourceK8sIoV1beta2 {
  ...
  CounterSetPatchResourceK8sIoV1beta2({this.counters, this.name});
  ...
  factory CounterSetPatchResourceK8sIoV1beta2.fromMap(
