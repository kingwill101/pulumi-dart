...
class NodeAllocatableOverheadPatchResourceK8sIoV1beta2 {
  ...
  /// Creates a new [NodeAllocatableOverheadPatchResourceK8sIoV1beta2].
  ...
  const NodeAllocatableOverheadPatchResourceK8sIoV1beta2({
    this.perContainer,
    this.perPod,
  });
  ...
  factory NodeAllocatableOverheadPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableOverheadPatchResourceK8sIoV1beta2(
