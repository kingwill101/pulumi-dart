...
class PodSchedulingListArgs {
  ...
  PodSchedulingListArgs({
    ...
    required pulumi.Output<List<PodSchedulingResourceK8sIoV1alpha1>> items,
  ...
  factory PodSchedulingListArgs.fromMap(Map<String, dynamic> map) {
    return PodSchedulingListArgs(
      ...
      items: pulumi.Output.create<List<PodSchedulingResourceK8sIoV1alpha1>>((map['items'] as List).cast<PodSchedulingResourceK8sIoV1alpha1>()),
