...
class PodSchedulingContextStatus {
  ...
  final pulumi.Input<List<ResourceClaimSchedulingStatusResourceK8sIoV1alpha2>>?
  resourceClaims;
  ...
  PodSchedulingContextStatus({this.resourceClaims});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'resourceClaims':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceClaimSchedulingStatusResourceK8sIoV1alpha2>,
      ...
      resourceClaims: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceClaimSchedulingStatusResourceK8sIoV1alpha2.fromMap(
