...
class AllocationResultResourceK8sIoV1alpha3 {
  ...
  factory AllocationResultResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return AllocationResultResourceK8sIoV1alpha3(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceAllocationResultResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
