...
class DeviceConstraintPatch {
  ...
  /// Creates a new [DeviceConstraintPatch].
  ...
  factory DeviceConstraintPatch.fromMap(Map<String, dynamic> map) {
    return DeviceConstraintPatch(
