...
class DeviceTolerationResourceK8sIoV1beta1 {
  ...
  /// Creates a new [DeviceTolerationResourceK8sIoV1beta1].
  ...
  const DeviceTolerationResourceK8sIoV1beta1({
    this.effect,
    this.key,
    this.operator,
  ...
  factory DeviceTolerationResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceTolerationResourceK8sIoV1beta1(
