...
class NodeAllocatableMapping {
  ...
  /// Creates a new [NodeAllocatableMapping].
  ...
  factory NodeAllocatableMapping.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableMapping(
