...
class ResourceClassResourceK8sIoV1alpha2Args {
  ...
  const ResourceClassResourceK8sIoV1alpha2Args({
    this.apiVersion,
  ...
  factory ResourceClassResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClassResourceK8sIoV1alpha2Args(
      ...
      parametersRef: (() { final guardedValue = map['parametersRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClassParametersReferenceResourceK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
