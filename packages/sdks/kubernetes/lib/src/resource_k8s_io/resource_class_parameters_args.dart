...
class ResourceClassParametersArgs {
  ...
  final pulumi.Input<ResourceClassParametersReferenceResourceK8sIoV1alpha2>?
  generatedFrom;
    ...
    return <String, dynamic>{
      ...
      'filters':
          ...
          >(
            filters,
            (value) =>
                pulumi.Input.encodeList<ResourceFilter, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'generatedFrom':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(generatedFrom, (value) => value.toMap()),
      'kind': ?kind,
      'metadata':
      ...
      'vendorParameters':
          ...
          >(
            vendorParameters,
            (value) =>
                pulumi.Input.encodeList<VendorParameters, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ResourceClassParametersArgs(
      ...
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceFilter>(
            guardedValue,
            (value) =>
                ResourceFilter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      generatedFrom: (() {
        final guardedValue = map['generatedFrom'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceClassParametersReferenceResourceK8sIoV1alpha2.fromMap(
      ...
      vendorParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VendorParameters>(
            guardedValue,
            (value) => VendorParameters.fromMap(
