...
class ResourceClaimStatusPatchResourceK8sIoV1alpha2 {
  ...
  final AllocationResultPatchResourceK8sIoV1alpha2? allocation;
  ...
  final List<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha2>? reservedFor;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'reservedFor': ?reservedFor == null ? null : pulumi.Input.encodeList<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha2, Map<String, dynamic>>(reservedFor!, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceClaimStatusPatchResourceK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatusPatchResourceK8sIoV1alpha2(
      allocation: map['allocation'] == null ? null : AllocationResultPatchResourceK8sIoV1alpha2.fromMap((map['allocation'] as Map).cast<String, dynamic>()),
      ...
      reservedFor: map['reservedFor'] == null ? null : pulumi.Input.decodeList<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha2>(map['reservedFor'], (value) => ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha2.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
