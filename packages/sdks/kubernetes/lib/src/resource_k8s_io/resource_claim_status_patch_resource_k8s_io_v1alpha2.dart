...
class ResourceClaimStatusPatchResourceK8sIoV1alpha2 {
  ...
  final pulumi.Input<
    List<ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha2>
  >?
  reservedFor;
  ...
  factory ResourceClaimStatusPatchResourceK8sIoV1alpha2.fromMap(
    ...
    return ResourceClaimStatusPatchResourceK8sIoV1alpha2(
      allocation: (() {
        ...
        return pulumi.Input.fromValue(
          AllocationResultPatchResourceK8sIoV1alpha2.fromMap(
      ...
      reservedFor: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourceClaimConsumerReferencePatchResourceK8sIoV1alpha2.fromMap(
