...
class DeviceTaintRuleStatusResourceK8sIoV1beta2 {
  ...
  /// Creates a new [DeviceTaintRuleStatusResourceK8sIoV1beta2].
  ...
  const DeviceTaintRuleStatusResourceK8sIoV1beta2({
    this.conditions,
  });
  ...
  factory DeviceTaintRuleStatusResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceTaintRuleStatusResourceK8sIoV1beta2(
