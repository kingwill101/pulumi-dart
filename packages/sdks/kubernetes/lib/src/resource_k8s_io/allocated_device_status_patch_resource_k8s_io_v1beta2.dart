...
import 'network_device_data_patch_resource_k8s_io_v1beta2.dart';
...
class AllocatedDeviceStatusPatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<NetworkDeviceDataPatchResourceK8sIoV1beta2>? networkData;
  ...
  /// Creates a new [AllocatedDeviceStatusPatchResourceK8sIoV1beta2].
  ...
  const AllocatedDeviceStatusPatchResourceK8sIoV1beta2({
    this.conditions,
    this.data,
    this.device,
    this.driver,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'device': ?device,
      'driver': ?driver,
      'networkData': ?pulumi.Input.mapOptionalInputValue<NetworkDeviceDataPatchResourceK8sIoV1beta2, Map<String, dynamic>>(networkData, (value) => value.toMap()),
      'pool': ?pool,
      'shareID': ?shareID,
    };
  }

  factory AllocatedDeviceStatusPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusPatchResourceK8sIoV1beta2(
      ...
      networkData: (() { final guardedValue = map['networkData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkDeviceDataPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
