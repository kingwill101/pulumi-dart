...
class AllocatedDeviceStatusPatchResourceK8sIoV1beta2 {
  ...
  final NetworkDeviceDataPatchResourceK8sIoV1beta2? networkData;
  ...
  factory AllocatedDeviceStatusPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocatedDeviceStatusPatchResourceK8sIoV1beta2(
      ...
      networkData: map['networkData'] == null ? null : NetworkDeviceDataPatchResourceK8sIoV1beta2.fromMap((map['networkData'] as Map).cast<String, dynamic>()),
