...
class ResourceClaimPatchResourceK8sIoV1alpha2Args {
  ...
  ResourceClaimPatchResourceK8sIoV1alpha2Args({
    ...
    pulumi.Output<ResourceClaimSpecPatchResourceK8sIoV1alpha2>? spec,
  }) :
  ...
  factory ResourceClaimPatchResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimPatchResourceK8sIoV1alpha2Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ResourceClaimSpecPatchResourceK8sIoV1alpha2>(ResourceClaimSpecPatchResourceK8sIoV1alpha2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
