...
class DeviceAllocationResultPatchResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<
    List<DeviceAllocationConfigurationPatchResourceK8sIoV1alpha3>
  >?
  config;

  /// Results lists all allocated devices.
  final pulumi.Input<
    List<DeviceRequestAllocationResultPatchResourceK8sIoV1alpha3>
  >?
  results;
  ...
  DeviceAllocationResultPatchResourceK8sIoV1alpha3({this.config, this.results});
  ...
  factory DeviceAllocationResultPatchResourceK8sIoV1alpha3.fromMap(
      ...
      config: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceAllocationConfigurationPatchResourceK8sIoV1alpha3.fromMap(
      ...
      results: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceRequestAllocationResultPatchResourceK8sIoV1alpha3.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
