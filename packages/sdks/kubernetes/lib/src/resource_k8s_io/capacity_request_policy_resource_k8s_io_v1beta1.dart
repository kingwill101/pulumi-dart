...
import 'capacity_request_policy_range_resource_k8s_io_v1beta1.dart';

/// CapacityRequestPolicy defines how requests consume device capacity.
///
/// Must not set more than one ValidRequestValues.
class CapacityRequestPolicyResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<CapacityRequestPolicyRangeResourceK8sIoV1beta1?>? validRange;
  ...
  /// Creates a new [CapacityRequestPolicyResourceK8sIoV1beta1].
  ...
  const CapacityRequestPolicyResourceK8sIoV1beta1({
    this.default_,
    this.validRange,
    this.validValues,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'default': ?default_,
      'validRange': ?pulumi.Input.mapOptionalInputValue<CapacityRequestPolicyRangeResourceK8sIoV1beta1, Map<String, dynamic>>(validRange, (value) => value.toMap()),
      'validValues': ?validValues,
    };
  }

  factory CapacityRequestPolicyResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicyResourceK8sIoV1beta1(
      ...
      validRange: (() { final guardedValue = map['validRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityRequestPolicyRangeResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
