...
class DeviceCapacityPatchResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<CapacityRequestPolicyPatchResourceK8sIoV1beta2>?
  requestPolicy;
  ...
  DeviceCapacityPatchResourceK8sIoV1beta2({this.requestPolicy, this.value});
  ...
  factory DeviceCapacityPatchResourceK8sIoV1beta2.fromMap(
    ...
    return DeviceCapacityPatchResourceK8sIoV1beta2(
      requestPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          CapacityRequestPolicyPatchResourceK8sIoV1beta2.fromMap(
