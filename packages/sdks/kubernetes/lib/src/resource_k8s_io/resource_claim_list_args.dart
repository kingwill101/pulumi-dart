...
class ResourceClaimListArgs {
  ...
  ResourceClaimListArgs({
    ...
    required pulumi.Output<List<ResourceClaimResourceK8sIoV1>> items,
  ...
  factory ResourceClaimListArgs.fromMap(Map<String, dynamic> map) {
    return ResourceClaimListArgs(
      ...
      items: pulumi.Output.create<List<ResourceClaimResourceK8sIoV1>>((map['items'] as List).cast<ResourceClaimResourceK8sIoV1>()),
