...
class ResourceClaimListArgs {
  ...
  final pulumi.Input<List<ResourceClaim>> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<ResourceClaim>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<ResourceClaim, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory ResourceClaimListArgs.fromMap(Map<String, dynamic> map) {
    return ResourceClaimListArgs(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceClaim>(map['items']!, (value) => ResourceClaim.fromMap((value as Map).cast<String, dynamic>()))),
