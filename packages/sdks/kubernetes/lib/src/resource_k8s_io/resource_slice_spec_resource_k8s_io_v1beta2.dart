...
class ResourceSliceSpecResourceK8sIoV1beta2 {
  ...
  const ResourceSliceSpecResourceK8sIoV1beta2({
    this.allNodes,
    this.devices,
  ...
  factory ResourceSliceSpecResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecResourceK8sIoV1beta2(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceResourceK8sIoV1beta2>(guardedValue, (value) => DeviceResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      pool: pulumi.Input.fromValue(ResourcePoolResourceK8sIoV1beta2.fromMap((map['pool']! as Map).cast<String, dynamic>())),
      sharedCounters: (() { final guardedValue = map['sharedCounters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CounterSetResourceK8sIoV1beta2>(guardedValue, (value) => CounterSetResourceK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
