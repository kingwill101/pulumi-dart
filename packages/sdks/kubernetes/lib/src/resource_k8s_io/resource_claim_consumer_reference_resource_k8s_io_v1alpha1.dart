...
class ResourceClaimConsumerReferenceResourceK8sIoV1alpha1 {
  ...
  /// Creates a new [ResourceClaimConsumerReferenceResourceK8sIoV1alpha1].
  ...
  const ResourceClaimConsumerReferenceResourceK8sIoV1alpha1({
    this.apiGroup,
    required this.name,
  ...
  factory ResourceClaimConsumerReferenceResourceK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ResourceClaimConsumerReferenceResourceK8sIoV1alpha1(
