...
class CapacityRequestPolicyResourceK8sIoV1beta2 {
  ...
  final pulumi.Input<CapacityRequestPolicyRangeResourceK8sIoV1beta2>? validRange;
  ...
  const CapacityRequestPolicyResourceK8sIoV1beta2({
    this.default_,
    this.validRange,
    this.validValues,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'default': ?default_,
      'validRange': ?pulumi.Input.mapOptionalInputValue<CapacityRequestPolicyRangeResourceK8sIoV1beta2, Map<String, dynamic>>(validRange, (value) => value.toMap()),
      'validValues': ?validValues,
    };
  }

  factory CapacityRequestPolicyResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicyResourceK8sIoV1beta2(
      ...
      validRange: (() { final guardedValue = map['validRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityRequestPolicyRangeResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
