...
class DeviceCapacityResourceK8sIoV1beta2 {
  ...
  final CapacityRequestPolicyResourceK8sIoV1beta2? requestPolicy;
  ...
  factory DeviceCapacityResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return DeviceCapacityResourceK8sIoV1beta2(
      requestPolicy: map['requestPolicy'] == null ? null : CapacityRequestPolicyResourceK8sIoV1beta2.fromMap((map['requestPolicy'] as Map).cast<String, dynamic>()),
