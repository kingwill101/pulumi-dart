...
class DeviceTaintRulePatchResourceK8sIoV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [DeviceTaintRulePatchResourceK8sIoV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DeviceTaintRulePatchResourceK8sIoV1]. {@macro pulumi_resource_k8s_io_v1_device_taint_rule_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DeviceTaintRulePatchResourceK8sIoV1(
    String name, {
  ...
  /// Creates a typed reference to an existing [DeviceTaintRulePatchResourceK8sIoV1] resource.
  DeviceTaintRulePatchResourceK8sIoV1.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1:DeviceTaintRulePatch',
