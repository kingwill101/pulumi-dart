...
class DeviceSelectorPatch {
  ...
  factory DeviceSelectorPatch.fromMap(Map<String, dynamic> map) {
    return DeviceSelectorPatch(
      cel: (() { final guardedValue = map['cel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CELDeviceSelectorPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
