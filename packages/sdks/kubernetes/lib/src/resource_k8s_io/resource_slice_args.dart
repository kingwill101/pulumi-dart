...
class ResourceSliceArgs {
  ...
  ResourceSliceArgs({
    ...
    required pulumi.Output<ResourceSliceSpec> spec,
  }) :
  ...
  factory ResourceSliceArgs.fromMap(Map<String, dynamic> map) {
    return ResourceSliceArgs(
      ...
      spec: pulumi.Output.create<ResourceSliceSpec>(ResourceSliceSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
