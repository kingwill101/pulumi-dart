...
class ResourceSliceSpecPatchResourceK8sIoV1alpha3 {
  ...
  final List<DevicePatchResourceK8sIoV1alpha3>? devices;
  ...
  final ResourcePoolPatchResourceK8sIoV1alpha3? pool;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allNodes': ?allNodes,
      'devices': ?devices == null ? null : pulumi.Input.encodeList<DevicePatchResourceK8sIoV1alpha3, Map<String, dynamic>>(devices!, (value) => value.toMap()),
      'driver': ?driver,
      'nodeName': ?nodeName,
  ...
  factory ResourceSliceSpecPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return ResourceSliceSpecPatchResourceK8sIoV1alpha3(
      ...
      devices: map['devices'] == null ? null : pulumi.Input.decodeList<DevicePatchResourceK8sIoV1alpha3>(map['devices'], (value) => DevicePatchResourceK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>())),
      ...
      pool: map['pool'] == null ? null : ResourcePoolPatchResourceK8sIoV1alpha3.fromMap((map['pool'] as Map).cast<String, dynamic>()),
    );
  }
}
