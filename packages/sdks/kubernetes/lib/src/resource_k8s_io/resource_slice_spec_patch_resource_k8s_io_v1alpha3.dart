    ...
    return <String, dynamic>{
      ...
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
            List<DevicePatchResourceK8sIoV1alpha3>,
      ...
      'pool':
          ?pulumi.Input.mapOptionalInputValue<
            ResourcePoolPatchResourceK8sIoV1alpha3,
            Map<String, dynamic>
          >(pool, (value) => value.toMap()),
    };
  }

  factory ResourceSliceSpecPatchResourceK8sIoV1alpha3.fromMap(
    ...
    return ResourceSliceSpecPatchResourceK8sIoV1alpha3(
      ...
      devices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DevicePatchResourceK8sIoV1alpha3>(
            guardedValue,
            (value) => DevicePatchResourceK8sIoV1alpha3.fromMap(
      ...
      pool: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourcePoolPatchResourceK8sIoV1alpha3.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
