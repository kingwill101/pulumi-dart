...
class DeviceCapacityPatch {
  ...
  final CapacityRequestPolicyPatch? requestPolicy;
  ...
  factory DeviceCapacityPatch.fromMap(Map<String, dynamic> map) {
    return DeviceCapacityPatch(
      requestPolicy: map['requestPolicy'] == null ? null : CapacityRequestPolicyPatch.fromMap((map['requestPolicy'] as Map).cast<String, dynamic>()),
