...
class DeviceRequestPatch {
  ...
  DeviceRequestPatch({this.exactly, this.firstAvailable, this.name});
    ...
    return DeviceRequestPatch(
      exactly: (() {
        ...
        return pulumi.Input.fromValue(
          ExactDeviceRequestPatch.fromMap(
      ...
      firstAvailable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceSubRequestPatch>(
            guardedValue,
            (value) => DeviceSubRequestPatch.fromMap(
