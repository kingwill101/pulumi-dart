...
class DeviceRequestPatch {
  ...
  final ExactDeviceRequestPatch? exactly;
  ...
  final List<DeviceSubRequestPatch>? firstAvailable;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'firstAvailable': ?firstAvailable == null ? null : pulumi.Input.encodeList<DeviceSubRequestPatch, Map<String, dynamic>>(firstAvailable!, (value) => value.toMap()),
      'name': ?name,
    };
  }
  ...
  factory DeviceRequestPatch.fromMap(Map<String, dynamic> map) {
    return DeviceRequestPatch(
      exactly: map['exactly'] == null ? null : ExactDeviceRequestPatch.fromMap((map['exactly'] as Map).cast<String, dynamic>()),
      firstAvailable: map['firstAvailable'] == null ? null : pulumi.Input.decodeList<DeviceSubRequestPatch>(map['firstAvailable'], (value) => DeviceSubRequestPatch.fromMap((value as Map).cast<String, dynamic>())),
