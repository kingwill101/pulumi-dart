...
class ResourceClaimStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices': ?devices == null ? null : pulumi.Input.encodeList<AllocatedDeviceStatus, Map<String, dynamic>>(devices!, (value) => value.toMap()),
      'reservedFor': ?reservedFor == null ? null : pulumi.Input.encodeList<ResourceClaimConsumerReference, Map<String, dynamic>>(reservedFor!, (value) => value.toMap()),
    };
  }

  factory ResourceClaimStatus.fromMap(Map<String, dynamic> map) {
    return ResourceClaimStatus(
      allocation: map['allocation'] == null ? null : AllocationResult.fromMap((map['allocation'] as Map).cast<String, dynamic>()),
      devices: map['devices'] == null ? null : pulumi.Input.decodeList<AllocatedDeviceStatus>(map['devices'], (value) => AllocatedDeviceStatus.fromMap((value as Map).cast<String, dynamic>())),
      reservedFor: map['reservedFor'] == null ? null : pulumi.Input.decodeList<ResourceClaimConsumerReference>(map['reservedFor'], (value) => ResourceClaimConsumerReference.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
