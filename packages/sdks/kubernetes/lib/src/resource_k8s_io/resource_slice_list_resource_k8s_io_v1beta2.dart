...
class ResourceSliceListResourceK8sIoV1beta2 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<ResourceSliceResourceK8sIoV1beta2>,
  ...
  factory ResourceSliceListResourceK8sIoV1beta2.fromMap(
    ...
    return ResourceSliceListResourceK8sIoV1beta2(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ResourceSliceResourceK8sIoV1beta2>(
          map['items']!,
          (value) => ResourceSliceResourceK8sIoV1beta2.fromMap(
