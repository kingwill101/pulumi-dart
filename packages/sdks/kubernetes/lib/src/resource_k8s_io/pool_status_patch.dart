...
import 'partition_type_status_patch.dart';
import 'shareable_summary_status_patch.dart';
...
class PoolStatusPatch {
  ...
  final pulumi.Input<List<PartitionTypeStatusPatch>?>? partitionSummary;
  ...
  final pulumi.Input<ShareableSummaryStatusPatch?>? shareableSummary;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeName': ?nodeName,
      'partitionSummary': ?pulumi.Input.mapOptionalInputValue<List<PartitionTypeStatusPatch>, List<Map<String, dynamic>>>(partitionSummary, (value) => pulumi.Input.encodeList<PartitionTypeStatusPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
      'poolName': ?poolName,
      'resourceSliceCount': ?resourceSliceCount,
      'shareableSummary': ?pulumi.Input.mapOptionalInputValue<ShareableSummaryStatusPatch, Map<String, dynamic>>(shareableSummary, (value) => value.toMap()),
