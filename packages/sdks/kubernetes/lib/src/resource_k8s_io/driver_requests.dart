...
class DriverRequests {
  ...
  DriverRequests({this.driverName, this.requests, this.vendorParameters});
    ...
    return <String, dynamic>{
      ...
      'requests':
          ...
          >(
            requests,
            (value) =>
                pulumi.Input.encodeList<ResourceRequest, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DriverRequests(
      ...
      requests: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceRequest>(
            guardedValue,
            (value) =>
                ResourceRequest.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      vendorParameters: (() {
