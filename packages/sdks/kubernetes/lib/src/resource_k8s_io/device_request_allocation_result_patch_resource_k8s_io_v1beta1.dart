...
class DeviceRequestAllocationResultPatchResourceK8sIoV1beta1 {
  ...
  factory DeviceRequestAllocationResultPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceRequestAllocationResultPatchResourceK8sIoV1beta1(
      ...
      tolerations: (() { final guardedValue = map['tolerations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceTolerationPatchResourceK8sIoV1beta1>(guardedValue, (value) => DeviceTolerationPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
