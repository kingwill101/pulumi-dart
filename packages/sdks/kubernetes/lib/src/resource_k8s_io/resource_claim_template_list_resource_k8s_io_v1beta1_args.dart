...
class ResourceClaimTemplateListResourceK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<ResourceClaimTemplateResourceK8sIoV1beta1Resource>>
  items;
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1beta1Args.fromMap(
    ...
    return ResourceClaimTemplateListResourceK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<ResourceClaimTemplateResourceK8sIoV1beta1Resource>(),
      ),
      kind: (() {
