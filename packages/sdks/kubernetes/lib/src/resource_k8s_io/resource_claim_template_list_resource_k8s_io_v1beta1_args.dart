...
class ResourceClaimTemplateListResourceK8sIoV1beta1Args {
  ...
  ResourceClaimTemplateListResourceK8sIoV1beta1Args({
    ...
    required pulumi.Output<List<ResourceClaimTemplateResourceK8sIoV1beta1Resource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ResourceClaimTemplateResourceK8sIoV1beta1Resource>>(items),
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplateListResourceK8sIoV1beta1Args(
      ...
      items: pulumi.Output.create<List<ResourceClaimTemplateResourceK8sIoV1beta1Resource>>((map['items'] as List).cast<ResourceClaimTemplateResourceK8sIoV1beta1Resource>()),
