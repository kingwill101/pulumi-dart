...
class ResourceClaimTemplateResourceK8sIoV1alpha3Args {
  ...
  ResourceClaimTemplateResourceK8sIoV1alpha3Args({
    ...
    required pulumi.Output<ResourceClaimTemplateSpecResourceK8sIoV1alpha3> spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<ResourceClaimTemplateSpecResourceK8sIoV1alpha3>(spec);
  ...
  factory ResourceClaimTemplateResourceK8sIoV1alpha3Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplateResourceK8sIoV1alpha3Args(
      ...
      spec: pulumi.Output.create<ResourceClaimTemplateSpecResourceK8sIoV1alpha3>(ResourceClaimTemplateSpecResourceK8sIoV1alpha3.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
