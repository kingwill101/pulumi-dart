...
class DeviceClassSpecPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<DeviceClassConfigurationPatchResourceK8sIoV1beta1>>?
  config;
    ...
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceClassConfigurationPatchResourceK8sIoV1beta1>,
  ...
  factory DeviceClassSpecPatchResourceK8sIoV1beta1.fromMap(
      ...
      config: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceClassConfigurationPatchResourceK8sIoV1beta1.fromMap(
