...
import 'device_class_configuration_patch_resource_k8s_io_v1beta1.dart';
import 'device_selector_patch_resource_k8s_io_v1beta1.dart';

/// DeviceClassSpec is used in a [DeviceClass] to define what can be allocated and how to configure it.
class DeviceClassSpecPatchResourceK8sIoV1beta1 {
  /// Config defines configuration parameters that apply to each device that is claimed via this class. Some classses may potentially be satisfied by multiple drivers, so each instance of a vendor configuration applies to exactly one driver.
  ///
  /// They are passed to the driver, but are not considered while allocating the claim.
  final pulumi.Input<List<DeviceClassConfigurationPatchResourceK8sIoV1beta1>>? config;
  ...
  /// Creates a new [DeviceClassSpecPatchResourceK8sIoV1beta1].
  ...
  const DeviceClassSpecPatchResourceK8sIoV1beta1({
    this.config,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config': ?pulumi.Input.mapOptionalInputValue<List<DeviceClassConfigurationPatchResourceK8sIoV1beta1>, List<Map<String, dynamic>>>(config, (value) => pulumi.Input.encodeList<DeviceClassConfigurationPatchResourceK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DeviceClassSpecPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceClassSpecPatchResourceK8sIoV1beta1(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceClassConfigurationPatchResourceK8sIoV1beta1>(guardedValue, (value) => DeviceClassConfigurationPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      selectors: (() { final guardedValue = map['selectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceSelectorPatchResourceK8sIoV1beta1>(guardedValue, (value) => DeviceSelectorPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
