...
class DeviceClassSpecPatchResourceK8sIoV1beta1 {
  ...
  final List<DeviceClassConfigurationPatchResourceK8sIoV1beta1>? config;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config': ?config == null ? null : pulumi.Input.encodeList<DeviceClassConfigurationPatchResourceK8sIoV1beta1, Map<String, dynamic>>(config!, (value) => value.toMap()),
  ...
  factory DeviceClassSpecPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceClassSpecPatchResourceK8sIoV1beta1(
      config: map['config'] == null ? null : pulumi.Input.decodeList<DeviceClassConfigurationPatchResourceK8sIoV1beta1>(map['config'], (value) => DeviceClassConfigurationPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
