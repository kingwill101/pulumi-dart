...
class AllocationResultPatchResourceK8sIoV1beta2 {
  ...
  const AllocationResultPatchResourceK8sIoV1beta2({
  ...
  factory AllocationResultPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatchResourceK8sIoV1beta2(
      ...
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceAllocationResultPatchResourceK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
