...
class AllocationResultPatchResourceK8sIoV1beta2 {
  ...
  final DeviceAllocationResultPatchResourceK8sIoV1beta2? devices;
  ...
  factory AllocationResultPatchResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return AllocationResultPatchResourceK8sIoV1beta2(
      ...
      devices: map['devices'] == null ? null : DeviceAllocationResultPatchResourceK8sIoV1beta2.fromMap((map['devices'] as Map).cast<String, dynamic>()),
