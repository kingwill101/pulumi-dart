...
class DeviceClaimPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<DeviceClaimConfigurationPatchResourceK8sIoV1beta1>>?
  config;

  /// These constraints must be satisfied by the set of devices that get allocated for the claim.
  final pulumi.Input<List<DeviceConstraintPatchResourceK8sIoV1beta1>>?
  constraints;
    ...
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceClaimConfigurationPatchResourceK8sIoV1beta1>,
      ...
      'constraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceConstraintPatchResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            constraints,
            (value) =>
      ...
      'requests':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceRequestPatchResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            requests,
            (value) =>
  ...
  factory DeviceClaimPatchResourceK8sIoV1beta1.fromMap(
    ...
    return DeviceClaimPatchResourceK8sIoV1beta1(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceClaimConfigurationPatchResourceK8sIoV1beta1.fromMap(
      ...
      constraints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceConstraintPatchResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceConstraintPatchResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      requests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceRequestPatchResourceK8sIoV1beta1>(
            guardedValue,
            (value) => DeviceRequestPatchResourceK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
