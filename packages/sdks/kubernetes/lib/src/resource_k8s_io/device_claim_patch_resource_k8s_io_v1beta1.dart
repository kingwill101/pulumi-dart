...
class DeviceClaimPatchResourceK8sIoV1beta1 {
  ...
  const DeviceClaimPatchResourceK8sIoV1beta1({
    this.config,
    this.constraints,
    this.requests,
  });
  ...
  factory DeviceClaimPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceClaimPatchResourceK8sIoV1beta1(
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceClaimConfigurationPatchResourceK8sIoV1beta1>(guardedValue, (value) => DeviceClaimConfigurationPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      constraints: (() { final guardedValue = map['constraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceConstraintPatchResourceK8sIoV1beta1>(guardedValue, (value) => DeviceConstraintPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requests: (() { final guardedValue = map['requests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceRequestPatchResourceK8sIoV1beta1>(guardedValue, (value) => DeviceRequestPatchResourceK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
