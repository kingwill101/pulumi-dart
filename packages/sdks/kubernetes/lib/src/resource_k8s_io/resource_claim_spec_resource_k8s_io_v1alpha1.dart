...
class ResourceClaimSpecResourceK8sIoV1alpha1 {
  ...
  const ResourceClaimSpecResourceK8sIoV1alpha1({
    this.allocationMode,
    this.parametersRef,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parametersRef': ?pulumi.Input.mapOptionalInputValue<ResourceClaimParametersReference, Map<String, dynamic>>(parametersRef, (value) => value.toMap()),
      'resourceClassName': resourceClassName,
    };
  }

  factory ResourceClaimSpecResourceK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecResourceK8sIoV1alpha1(
      ...
      parametersRef: (() { final guardedValue = map['parametersRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceClaimParametersReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceClassName: pulumi.Input.fromValue(map['resourceClassName'] as String),
    );
  }
}
