...
class ResourceClaimSpecResourceK8sIoV1alpha1 {
  ...
  factory ResourceClaimSpecResourceK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ResourceClaimSpecResourceK8sIoV1alpha1(
      ...
      parametersRef: map['parametersRef'] == null ? null : ResourceClaimParametersReference.fromMap((map['parametersRef'] as Map).cast<String, dynamic>()),
      resourceClassName: map['resourceClassName'] as String,
    );
  }
}
