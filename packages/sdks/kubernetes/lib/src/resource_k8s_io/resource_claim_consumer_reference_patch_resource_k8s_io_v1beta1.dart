...
class ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1 {
  ...
  /// Creates a new [ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1].
  ...
  const ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1({
    this.apiGroup,
    this.name,
    this.resource,
    this.uid,
  ...
  factory ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourceClaimConsumerReferencePatchResourceK8sIoV1beta1(
