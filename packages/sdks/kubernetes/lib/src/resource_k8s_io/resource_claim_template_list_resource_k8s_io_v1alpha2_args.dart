...
class ResourceClaimTemplateListResourceK8sIoV1alpha2Args {
  ...
  final pulumi.Input<List<ResourceClaimTemplateResourceK8sIoV1alpha2Resource>>
  items;
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1alpha2Args.fromMap(
    ...
    return ResourceClaimTemplateListResourceK8sIoV1alpha2Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<ResourceClaimTemplateResourceK8sIoV1alpha2Resource>(),
      ),
      kind: (() {
