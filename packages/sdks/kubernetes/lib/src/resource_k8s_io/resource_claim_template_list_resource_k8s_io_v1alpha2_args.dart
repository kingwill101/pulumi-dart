...
class ResourceClaimTemplateListResourceK8sIoV1alpha2Args {
  ...
  ResourceClaimTemplateListResourceK8sIoV1alpha2Args({
    pulumi.Output<String>? apiVersion,
    required pulumi.Output<List<ResourceClaimTemplateResourceK8sIoV1alpha2Resource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ResourceClaimTemplateResourceK8sIoV1alpha2Resource>>(items),
  ...
  factory ResourceClaimTemplateListResourceK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return ResourceClaimTemplateListResourceK8sIoV1alpha2Args(
      ...
      items: pulumi.Output.create<List<ResourceClaimTemplateResourceK8sIoV1alpha2Resource>>((map['items'] as List).cast<ResourceClaimTemplateResourceK8sIoV1alpha2Resource>()),
