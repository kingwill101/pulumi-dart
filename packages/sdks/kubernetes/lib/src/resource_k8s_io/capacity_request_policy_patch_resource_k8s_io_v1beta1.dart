...
class CapacityRequestPolicyPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<CapacityRequestPolicyRangePatchResourceK8sIoV1beta1>? validRange;
  ...
  const CapacityRequestPolicyPatchResourceK8sIoV1beta1({
    this.default_,
    this.validRange,
    this.validValues,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'default': ?default_,
      'validRange': ?pulumi.Input.mapOptionalInputValue<CapacityRequestPolicyRangePatchResourceK8sIoV1beta1, Map<String, dynamic>>(validRange, (value) => value.toMap()),
      'validValues': ?validValues,
    };
  }

  factory CapacityRequestPolicyPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicyPatchResourceK8sIoV1beta1(
      ...
      validRange: (() { final guardedValue = map['validRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityRequestPolicyRangePatchResourceK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
