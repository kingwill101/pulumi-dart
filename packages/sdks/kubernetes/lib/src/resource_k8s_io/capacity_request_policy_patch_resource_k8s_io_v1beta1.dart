...
class CapacityRequestPolicyPatchResourceK8sIoV1beta1 {
  ...
  final CapacityRequestPolicyRangePatchResourceK8sIoV1beta1? validRange;
  ...
  factory CapacityRequestPolicyPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CapacityRequestPolicyPatchResourceK8sIoV1beta1(
      ...
      validRange: map['validRange'] == null ? null : CapacityRequestPolicyRangePatchResourceK8sIoV1beta1.fromMap((map['validRange'] as Map).cast<String, dynamic>()),
