...
class DeviceClassSpec {
  ...
  final List<DeviceClassConfiguration>? config;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config': ?config == null ? null : pulumi.Input.encodeList<DeviceClassConfiguration, Map<String, dynamic>>(config!, (value) => value.toMap()),
  ...
  factory DeviceClassSpec.fromMap(Map<String, dynamic> map) {
    return DeviceClassSpec(
      config: map['config'] == null ? null : pulumi.Input.decodeList<DeviceClassConfiguration>(map['config'], (value) => DeviceClassConfiguration.fromMap((value as Map).cast<String, dynamic>())),
