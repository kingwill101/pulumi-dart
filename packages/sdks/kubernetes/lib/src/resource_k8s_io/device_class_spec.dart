...
class DeviceClassSpec {
  ...
  DeviceClassSpec({this.config, this.extendedResourceName, this.selectors});
    ...
    return DeviceClassSpec(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceClassConfiguration>(
            guardedValue,
            (value) => DeviceClassConfiguration.fromMap(
