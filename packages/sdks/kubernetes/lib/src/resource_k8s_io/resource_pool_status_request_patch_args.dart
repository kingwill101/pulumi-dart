...
/// {@template pulumi_resource_k8s_io_v1alpha3_resource_pool_status_request_patch_args_doc}
/// The set of arguments for ResourcePoolStatusRequestPatch.
/// {@endtemplate}
/// {@macro pulumi_resource_k8s_io_v1alpha3_resource_pool_status_request_patch_args_doc}
class ResourcePoolStatusRequestPatchArgs {
  ...
  /// Creates a new [ResourcePoolStatusRequestPatchArgs].
  ...
  const ResourcePoolStatusRequestPatchArgs({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory ResourcePoolStatusRequestPatchArgs.fromMap(Map<String, dynamic> map) {
    return ResourcePoolStatusRequestPatchArgs(
