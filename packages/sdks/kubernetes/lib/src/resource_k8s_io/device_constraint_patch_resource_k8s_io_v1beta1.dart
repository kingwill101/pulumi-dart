...
class DeviceConstraintPatchResourceK8sIoV1beta1 {
  ...
  final String? distinctAttribute;
  ...
  factory DeviceConstraintPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceConstraintPatchResourceK8sIoV1beta1(
      distinctAttribute: map['distinctAttribute'] == null ? null : map['distinctAttribute'] as String,
      matchAttribute: map['matchAttribute'] == null ? null : map['matchAttribute'] as String,
