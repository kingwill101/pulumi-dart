...
class DeviceConstraintPatchResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<String>? distinctAttribute;
  ...
  /// Creates a new [DeviceConstraintPatchResourceK8sIoV1beta1].
  ...
  const DeviceConstraintPatchResourceK8sIoV1beta1({
  ...
  factory DeviceConstraintPatchResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DeviceConstraintPatchResourceK8sIoV1beta1(
      distinctAttribute: (() { final guardedValue = map['distinctAttribute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
