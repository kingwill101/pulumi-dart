...
class DeviceTaintResourceK8sIoV1alpha3 {
  ...
  /// Creates a new [DeviceTaintResourceK8sIoV1alpha3].
  ...
  const DeviceTaintResourceK8sIoV1alpha3({
  ...
  factory DeviceTaintResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
