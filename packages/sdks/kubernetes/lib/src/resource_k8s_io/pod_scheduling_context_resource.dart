...
class PodSchedulingContextResource extends pulumi.CustomResource {
  ...
  PodSchedulingContextResource(
    ...
    spec = registerOutput<PodSchedulingContextSpecResourceK8sIoV1alpha3>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PodSchedulingContextSpecResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    status = registerOutput<PodSchedulingContextStatusResourceK8sIoV1alpha3?>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PodSchedulingContextStatusResourceK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [PodSchedulingContextResource] resource.
  PodSchedulingContextResource.reference(String urn)
    : super(
        'kubernetes:resource.k8s.io/v1alpha3:PodSchedulingContext',
