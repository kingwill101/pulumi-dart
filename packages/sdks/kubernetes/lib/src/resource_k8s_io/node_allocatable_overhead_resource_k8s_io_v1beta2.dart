...
class NodeAllocatableOverheadResourceK8sIoV1beta2 {
  ...
  /// Creates a new [NodeAllocatableOverheadResourceK8sIoV1beta2].
  ...
  const NodeAllocatableOverheadResourceK8sIoV1beta2({
    this.perContainer,
    this.perPod,
  });
  ...
  factory NodeAllocatableOverheadResourceK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableOverheadResourceK8sIoV1beta2(
