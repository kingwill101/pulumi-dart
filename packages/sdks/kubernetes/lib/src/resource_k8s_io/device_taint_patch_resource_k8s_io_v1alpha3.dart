...
class DeviceTaintPatchResourceK8sIoV1alpha3 {
  ...
  /// Creates a new [DeviceTaintPatchResourceK8sIoV1alpha3].
  ...
  const DeviceTaintPatchResourceK8sIoV1alpha3({
    this.effect,
    this.key,
    this.timeAdded,
    this.value,
  ...
  factory DeviceTaintPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceTaintPatchResourceK8sIoV1alpha3(
