...
class DeviceAllocationResultResourceK8sIoV1alpha3 {
  ...
  final pulumi.Input<List<DeviceAllocationConfigurationResourceK8sIoV1alpha3>>?
  config;

  /// Results lists all allocated devices.
  final pulumi.Input<List<DeviceRequestAllocationResultResourceK8sIoV1alpha3>>?
  results;
  ...
  DeviceAllocationResultResourceK8sIoV1alpha3({this.config, this.results});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceAllocationConfigurationResourceK8sIoV1alpha3>,
      ...
      'results':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceRequestAllocationResultResourceK8sIoV1alpha3>,
            List<Map<String, dynamic>>
          >(
            results,
            (value) =>
  ...
  factory DeviceAllocationResultResourceK8sIoV1alpha3.fromMap(
      ...
      config: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceAllocationConfigurationResourceK8sIoV1alpha3.fromMap(
      ...
      results: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceRequestAllocationResultResourceK8sIoV1alpha3.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
