...
class DeviceTaintSelectorPatchResourceK8sIoV1alpha3 {
  ...
  /// Creates a new [DeviceTaintSelectorPatchResourceK8sIoV1alpha3].
  ...
  const DeviceTaintSelectorPatchResourceK8sIoV1alpha3({
    this.device,
    this.driver,
    this.pool,
  });
  ...
  factory DeviceTaintSelectorPatchResourceK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return DeviceTaintSelectorPatchResourceK8sIoV1alpha3(
