...
class DeviceAllocationResultResourceK8sIoV1beta1 {
  ...
  final pulumi.Input<List<DeviceAllocationConfigurationResourceK8sIoV1beta1>>?
  config;

  /// Results lists all allocated devices.
  final pulumi.Input<List<DeviceRequestAllocationResultResourceK8sIoV1beta1>>?
  results;
  ...
  DeviceAllocationResultResourceK8sIoV1beta1({this.config, this.results});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceAllocationConfigurationResourceK8sIoV1beta1>,
      ...
      'results':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeviceRequestAllocationResultResourceK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            results,
            (value) =>
  ...
  factory DeviceAllocationResultResourceK8sIoV1beta1.fromMap(
      ...
      config: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceAllocationConfigurationResourceK8sIoV1beta1.fromMap(
      ...
      results: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DeviceRequestAllocationResultResourceK8sIoV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
