...
class CELDeviceSelectorResourceK8sIoV1beta1 {
  ...
  /// Creates a new [CELDeviceSelectorResourceK8sIoV1beta1].
  ...
  const CELDeviceSelectorResourceK8sIoV1beta1({
  ...
  factory CELDeviceSelectorResourceK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CELDeviceSelectorResourceK8sIoV1beta1(
