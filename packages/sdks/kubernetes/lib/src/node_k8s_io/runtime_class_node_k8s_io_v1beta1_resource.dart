...
class RuntimeClassNodeK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  RuntimeClassNodeK8sIoV1beta1Resource(
    ...
    overhead = registerOutput<OverheadNodeK8sIoV1beta1>(
      'overhead',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return OverheadNodeK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    scheduling = registerOutput<SchedulingNodeK8sIoV1beta1>(
      'scheduling',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return SchedulingNodeK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
