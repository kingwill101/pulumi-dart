...
import 'overhead_patch_node_k8s_io_v1alpha1.dart';
import 'scheduling_patch_node_k8s_io_v1alpha1.dart';
...
class RuntimeClassSpecPatch {
  ...
  /// Creates a new [RuntimeClassSpecPatch].
  ...
  factory RuntimeClassSpecPatch.fromMap(Map<String, dynamic> map) {
    return RuntimeClassSpecPatch(
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OverheadPatchNodeK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      runtimeHandler: (() { final guardedValue = map['runtimeHandler']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scheduling: (() { final guardedValue = map['scheduling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchedulingPatchNodeK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
