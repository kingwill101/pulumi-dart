...
class SchedulingNodeK8sIoV1beta1 {
  ...
  SchedulingNodeK8sIoV1beta1({this.nodeSelector, this.tolerations});
    ...
    return <String, dynamic>{
      ...
      'tolerations':
          ...
          >(
            tolerations,
            (value) =>
                pulumi.Input.encodeList<Toleration, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory SchedulingNodeK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return SchedulingNodeK8sIoV1beta1(
      ...
      tolerations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Toleration>(
            guardedValue,
            (value) =>
                Toleration.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
