...
class RuntimeClassPatchNodeK8sIoV1beta1 {
  ...
  const RuntimeClassPatchNodeK8sIoV1beta1({
    this.apiVersion,
    this.handler,
    this.kind,
    this.metadata,
  ...
  factory RuntimeClassPatchNodeK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return RuntimeClassPatchNodeK8sIoV1beta1(
      ...
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OverheadPatchNodeK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheduling: (() { final guardedValue = map['scheduling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchedulingPatchNodeK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
