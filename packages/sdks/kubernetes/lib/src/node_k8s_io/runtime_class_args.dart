...
/// {@template pulumi_node_k8s_io_v1_runtime_class_args_doc}
/// The set of arguments for RuntimeClass.
/// {@endtemplate}
/// {@macro pulumi_node_k8s_io_v1_runtime_class_args_doc}
class RuntimeClassArgs {
  ...
  RuntimeClassArgs({
    ...
    pulumi.Output<Overhead>? overhead,
    pulumi.Output<Scheduling>? scheduling,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      handler = pulumi.Input.asInput<String>(handler),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      overhead = pulumi.Input.asOptionalInput<Overhead>(overhead),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'overhead': ?pulumi.Input.mapOptionalInputValue<Overhead, Map<String, dynamic>>(overhead, (value) => value.toMap()),
      'scheduling': ?pulumi.Input.mapOptionalInputValue<Scheduling, Map<String, dynamic>>(scheduling, (value) => value.toMap()),
    };
  }

  factory RuntimeClassArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeClassArgs(
      ...
      overhead: map['overhead'] == null ? null : pulumi.Output.create<Overhead>(Overhead.fromMap((map['overhead'] as Map).cast<String, dynamic>())),
      scheduling: map['scheduling'] == null ? null : pulumi.Output.create<Scheduling>(Scheduling.fromMap((map['scheduling'] as Map).cast<String, dynamic>())),
    );
  }
}
