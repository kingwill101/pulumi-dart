...
class RuntimeClassArgs {
  ...
  factory RuntimeClassArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeClassArgs(
      ...
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Overhead.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
