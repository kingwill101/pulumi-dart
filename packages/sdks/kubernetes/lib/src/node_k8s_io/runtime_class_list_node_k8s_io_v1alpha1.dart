...
class RuntimeClassListNodeK8sIoV1alpha1 {
  ...
  const RuntimeClassListNodeK8sIoV1alpha1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory RuntimeClassListNodeK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RuntimeClassListNodeK8sIoV1alpha1(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<RuntimeClassNodeK8sIoV1alpha1>(map['items']!, (value) => RuntimeClassNodeK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
