...
class RuntimeClassNodeK8sIoV1alpha1 {
  ...
  /// Creates a new [RuntimeClassNodeK8sIoV1alpha1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec':
          pulumi.Input.mapInputValue<RuntimeClassSpec, Map<String, dynamic>>(
            spec,
            (value) => value.toMap(),
          ),
    };
  ...
  factory RuntimeClassNodeK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RuntimeClassNodeK8sIoV1alpha1(
      apiVersion: (() {
      ...
      spec: pulumi.Input.fromValue(
        RuntimeClassSpec.fromMap((map['spec']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
