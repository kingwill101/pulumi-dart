...
class RuntimeClassPatchArgs {
  ...
  factory RuntimeClassPatchArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeClassPatchArgs(
      ...
      overhead: (() { final guardedValue = map['overhead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OverheadPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scheduling: (() { final guardedValue = map['scheduling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchedulingPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
