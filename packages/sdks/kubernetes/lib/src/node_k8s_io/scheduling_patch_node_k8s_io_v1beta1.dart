...
class SchedulingPatchNodeK8sIoV1beta1 {
  ...
  /// Creates a new [SchedulingPatchNodeK8sIoV1beta1].
  ...
  SchedulingPatchNodeK8sIoV1beta1({this.nodeSelector, this.tolerations});
  ...
  factory SchedulingPatchNodeK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return SchedulingPatchNodeK8sIoV1beta1(
      nodeSelector: (() {
