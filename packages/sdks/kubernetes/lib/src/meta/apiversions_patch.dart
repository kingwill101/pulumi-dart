...
class APIVersionsPatch {
  ...
  final pulumi.Input<List<ServerAddressByClientCIDRPatch>>?
    ...
    return <String, dynamic>{
      ...
      'serverAddressByClientCIDRs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServerAddressByClientCIDRPatch>,
  ...
  factory APIVersionsPatch.fromMap(Map<String, dynamic> map) {
    return APIVersionsPatch(
      ...
      serverAddressByClientCIDRs: (() {
        final guardedValue = map['serverAddressByClientCIDRs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerAddressByClientCIDRPatch>(
            guardedValue,
            (value) => ServerAddressByClientCIDRPatch.fromMap(
