...
class ObjectMeta {
  ...
  final pulumi.Input<List<ManagedFieldsEntry>?>? managedFields;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'managedFields': ?pulumi.Input.mapOptionalInputValue<List<ManagedFieldsEntry>, List<Map<String, dynamic>>>(managedFields, (value) => pulumi.Input.encodeList<ManagedFieldsEntry, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      'namespace': ?namespace,
  ...
  factory ObjectMeta.fromMap(Map<String, dynamic> map) {
    return ObjectMeta(
      ...
      managedFields: (() { final guardedValue = map['managedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagedFieldsEntry>(guardedValue, (value) => ManagedFieldsEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
