...
class ObjectMeta {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'managedFields': ?managedFields == null ? null : pulumi.Input.encodeList<ManagedFieldsEntry, Map<String, dynamic>>(managedFields!, (value) => value.toMap()),
      'name': ?name,
      'namespace': ?namespace,
  ...
  factory ObjectMeta.fromMap(Map<String, dynamic> map) {
    return ObjectMeta(
      ...
      managedFields: map['managedFields'] == null ? null : pulumi.Input.decodeList<ManagedFieldsEntry>(map['managedFields'], (value) => ManagedFieldsEntry.fromMap((value as Map).cast<String, dynamic>())),
