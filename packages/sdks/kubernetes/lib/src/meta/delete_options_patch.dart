...
class DeleteOptionsPatch {
  ...
  final PreconditionsPatch? preconditions;
  ...
  factory DeleteOptionsPatch.fromMap(Map<String, dynamic> map) {
    return DeleteOptionsPatch(
      ...
      preconditions: map['preconditions'] == null ? null : PreconditionsPatch.fromMap((map['preconditions'] as Map).cast<String, dynamic>()),
