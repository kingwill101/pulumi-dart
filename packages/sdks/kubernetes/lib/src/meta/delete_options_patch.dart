...
import 'preconditions_patch.dart';

/// DeleteOptions may be provided when deleting an API object.
class DeleteOptionsPatch {
  ...
  final pulumi.Input<PreconditionsPatch>? preconditions;
  ...
  /// Creates a new [DeleteOptionsPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'preconditions': ?pulumi.Input.mapOptionalInputValue<PreconditionsPatch, Map<String, dynamic>>(preconditions, (value) => value.toMap()),
      'propagationPolicy': ?propagationPolicy,
    };
  }

  factory DeleteOptionsPatch.fromMap(Map<String, dynamic> map) {
    return DeleteOptionsPatch(
      ...
      preconditions: (() { final guardedValue = map['preconditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PreconditionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
