...
class DeleteOptionsPatch {
    ...
    return <String, dynamic>{
      ...
      'preconditions':
          ?pulumi.Input.mapOptionalInputValue<
            PreconditionsPatch,
            Map<String, dynamic>
          >(preconditions, (value) => value.toMap()),
  ...
  factory DeleteOptionsPatch.fromMap(Map<String, dynamic> map) {
    return DeleteOptionsPatch(
      ...
      ignoreStoreReadErrorWithClusterBreakingPotential: (() {
        final guardedValue =
            map['ignoreStoreReadErrorWithClusterBreakingPotential'];
        if (guardedValue == null) return null;
      ...
      orphanDependents: (() {
        final guardedValue = map['orphanDependents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      preconditions: (() {
        final guardedValue = map['preconditions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PreconditionsPatch.fromMap(
