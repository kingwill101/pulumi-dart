...
class ListMetaPatch {
  ...
  final pulumi.Input<ShardInfoPatch?>? shardInfo;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selfLink': ?selfLink,
      'shardInfo': ?pulumi.Input.mapOptionalInputValue<ShardInfoPatch, Map<String, dynamic>>(shardInfo, (value) => value.toMap()),
    };
  }
