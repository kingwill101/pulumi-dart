...
class StatusArgs {
  ...
  StatusArgs({
    ...
    pulumi.Output<StatusDetails>? details,
    ...
    pulumi.Output<String>? reason,
      ...
      details = pulumi.Input.asOptionalInput<StatusDetails>(details),
  ...
  factory StatusArgs.fromMap(Map<String, dynamic> map) {
    return StatusArgs(
      ...
      details: map['details'] == null ? null : pulumi.Output.create<StatusDetails>(StatusDetails.fromMap((map['details'] as Map).cast<String, dynamic>())),
