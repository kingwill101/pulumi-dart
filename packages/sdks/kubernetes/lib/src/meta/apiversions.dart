...
class APIVersions {
  ...
  final pulumi.Input<List<ServerAddressByClientCIDR>>
  ...
  factory APIVersions.fromMap(Map<String, dynamic> map) {
    return APIVersions(
      ...
      serverAddressByClientCIDRs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ServerAddressByClientCIDR>(
          map['serverAddressByClientCIDRs']!,
          (value) => ServerAddressByClientCIDR.fromMap(
