...
class APIVersions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': ?kind,
      'serverAddressByClientCIDRs': pulumi.Input.encodeList<ServerAddressByClientCIDR, Map<String, dynamic>>(serverAddressByClientCIDRs, (value) => value.toMap()),
      'versions': versions,
    };
  }
  ...
  factory APIVersions.fromMap(Map<String, dynamic> map) {
    return APIVersions(
      ...
      serverAddressByClientCIDRs: pulumi.Input.decodeList<ServerAddressByClientCIDR>(map['serverAddressByClientCIDRs'], (value) => ServerAddressByClientCIDR.fromMap((value as Map).cast<String, dynamic>())),
