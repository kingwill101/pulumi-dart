...
class APIGroupPatch {
  ...
  final GroupVersionForDiscoveryPatch? preferredVersion;
  ...
  final List<GroupVersionForDiscoveryPatch>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'versions': ?versions == null ? null : pulumi.Input.encodeList<GroupVersionForDiscoveryPatch, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory APIGroupPatch.fromMap(Map<String, dynamic> map) {
    return APIGroupPatch(
      ...
      preferredVersion: map['preferredVersion'] == null ? null : GroupVersionForDiscoveryPatch.fromMap((map['preferredVersion'] as Map).cast<String, dynamic>()),
      ...
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<GroupVersionForDiscoveryPatch>(map['versions'], (value) => GroupVersionForDiscoveryPatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
