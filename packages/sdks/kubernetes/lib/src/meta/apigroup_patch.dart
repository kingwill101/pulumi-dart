...
class APIGroupPatch {
    ...
    return <String, dynamic>{
      ...
      'preferredVersion':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(preferredVersion, (value) => value.toMap()),
      'serverAddressByClientCIDRs':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GroupVersionForDiscoveryPatch>,
            List<Map<String, dynamic>>
          >(
            versions,
            (value) =>
  ...
  factory APIGroupPatch.fromMap(Map<String, dynamic> map) {
    return APIGroupPatch(
      ...
      preferredVersion: (() {
        final guardedValue = map['preferredVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupVersionForDiscoveryPatch.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GroupVersionForDiscoveryPatch>(
            guardedValue,
            (value) => GroupVersionForDiscoveryPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
