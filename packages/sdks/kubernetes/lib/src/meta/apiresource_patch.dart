...
class APIResourcePatch {
  ...
  factory APIResourcePatch.fromMap(Map<String, dynamic> map) {
    return APIResourcePatch(
      ...
      namespaced: map['namespaced'] == null ? null : map['namespaced'] as bool,
      shortNames: map['shortNames'] == null ? null : (map['shortNames'] as List).cast<String>(),
      singularName: map['singularName'] == null ? null : map['singularName'] as String,
      storageVersionHash: map['storageVersionHash'] == null ? null : map['storageVersionHash'] as String,
