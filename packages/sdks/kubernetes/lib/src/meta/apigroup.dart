...
class APIGroup {
  ...
  factory APIGroup.fromMap(Map<String, dynamic> map) {
    return APIGroup(
      ...
      preferredVersion: (() { final guardedValue = map['preferredVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GroupVersionForDiscovery.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serverAddressByClientCIDRs: (() { final guardedValue = map['serverAddressByClientCIDRs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServerAddressByClientCIDR>(guardedValue, (value) => ServerAddressByClientCIDR.fromMap((value as Map).cast<String, dynamic>()))); })(),
      versions: pulumi.Input.fromValue(pulumi.Input.decodeList<GroupVersionForDiscovery>(map['versions']!, (value) => GroupVersionForDiscovery.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
