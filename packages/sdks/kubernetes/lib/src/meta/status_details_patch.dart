    ...
    return <String, dynamic>{
      'causes':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatusCausePatch>,
            List<Map<String, dynamic>>
          >(
            causes,
            (value) =>
                pulumi.Input.encodeList<StatusCausePatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return StatusDetailsPatch(
      causes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatusCausePatch>(
            guardedValue,
            (value) => StatusCausePatch.fromMap(
