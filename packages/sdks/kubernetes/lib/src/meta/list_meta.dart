...
class ListMeta {
  ...
  final pulumi.Input<ShardInfo?>? shardInfo;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selfLink': ?selfLink,
      'shardInfo': ?pulumi.Input.mapOptionalInputValue<ShardInfo, Map<String, dynamic>>(shardInfo, (value) => value.toMap()),
    };
  }
  ...
  factory ListMeta.fromMap(Map<String, dynamic> map) {
    return ListMeta(
      ...
      shardInfo: (() { final guardedValue = map['shardInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ShardInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
