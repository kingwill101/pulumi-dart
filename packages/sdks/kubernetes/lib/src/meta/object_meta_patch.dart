...
class ObjectMetaPatch {
  ...
  factory ObjectMetaPatch.fromMap(Map<String, dynamic> map) {
    return ObjectMetaPatch(
      ...
      deletionGracePeriodSeconds: (() { final guardedValue = map['deletionGracePeriodSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
