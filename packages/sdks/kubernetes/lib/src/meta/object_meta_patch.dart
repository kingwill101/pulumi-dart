...
import 'managed_fields_entry_patch.dart';
import 'owner_reference_patch.dart';

/// ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
class ObjectMetaPatch {
  ...
  final pulumi.Input<List<ManagedFieldsEntryPatch>?>? managedFields;
  ...
  final pulumi.Input<List<OwnerReferencePatch>?>? ownerReferences;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'labels': ?labels,
      'managedFields': ?pulumi.Input.mapOptionalInputValue<List<ManagedFieldsEntryPatch>, List<Map<String, dynamic>>>(managedFields, (value) => pulumi.Input.encodeList<ManagedFieldsEntryPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      'namespace': ?namespace,
      'ownerReferences': ?pulumi.Input.mapOptionalInputValue<List<OwnerReferencePatch>, List<Map<String, dynamic>>>(ownerReferences, (value) => pulumi.Input.encodeList<OwnerReferencePatch, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ObjectMetaPatch.fromMap(Map<String, dynamic> map) {
    return ObjectMetaPatch(
      ...
      deletionGracePeriodSeconds: (() { final guardedValue = map['deletionGracePeriodSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      managedFields: (() { final guardedValue = map['managedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagedFieldsEntryPatch>(guardedValue, (value) => ManagedFieldsEntryPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      namespace: (() { final guardedValue = map['namespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ownerReferences: (() { final guardedValue = map['ownerReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OwnerReferencePatch>(guardedValue, (value) => OwnerReferencePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
