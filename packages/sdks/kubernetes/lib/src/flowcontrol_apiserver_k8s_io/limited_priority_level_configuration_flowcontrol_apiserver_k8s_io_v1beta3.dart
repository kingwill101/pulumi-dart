...
class LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<LimitResponseFlowcontrolApiserverK8sIoV1beta3>?
  limitResponse;
    ...
    return <String, dynamic>{
      ...
      'limitResponse':
          ?pulumi.Input.mapOptionalInputValue<
            LimitResponseFlowcontrolApiserverK8sIoV1beta3,
            Map<String, dynamic>
  ...
  factory LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3(
      ...
      limitResponse: (() {
        ...
        return pulumi.Input.fromValue(
          LimitResponseFlowcontrolApiserverK8sIoV1beta3.fromMap(
