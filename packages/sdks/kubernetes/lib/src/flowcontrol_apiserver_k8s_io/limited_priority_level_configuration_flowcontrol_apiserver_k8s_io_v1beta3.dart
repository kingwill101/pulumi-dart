...
import 'limit_response_flowcontrol_apiserver_k8s_io_v1beta3.dart';

/// LimitedPriorityLevelConfiguration specifies how to handle requests that are subject to limits. It addresses two issues:
/// - How are requests for this priority level limited?
/// - What should be done with requests that exceed the limit?
class LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<LimitResponseFlowcontrolApiserverK8sIoV1beta3>? limitResponse;
  ...
  /// Creates a new [LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'limitResponse': ?pulumi.Input.mapOptionalInputValue<LimitResponseFlowcontrolApiserverK8sIoV1beta3, Map<String, dynamic>>(limitResponse, (value) => value.toMap()),
  ...
  factory LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3(
      ...
      limitResponse: map['limitResponse'] == null ? null : (LimitResponseFlowcontrolApiserverK8sIoV1beta3.fromMap((map['limitResponse'] as Map).cast<String, dynamic>())).input(),
