...
class LimitResponseFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final QueuingConfigurationFlowcontrolApiserverK8sIoV1beta1? queuing;
  ...
  factory LimitResponseFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return LimitResponseFlowcontrolApiserverK8sIoV1beta1(
      queuing: map['queuing'] == null ? null : QueuingConfigurationFlowcontrolApiserverK8sIoV1beta1.fromMap((map['queuing'] as Map).cast<String, dynamic>()),
