...
class LimitResponseFlowcontrolApiserverK8sIoV1beta1 {
  ...
  const LimitResponseFlowcontrolApiserverK8sIoV1beta1({
    this.queuing,
    required this.type,
  });
  ...
  factory LimitResponseFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return LimitResponseFlowcontrolApiserverK8sIoV1beta1(
      queuing: (() { final guardedValue = map['queuing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueuingConfigurationFlowcontrolApiserverK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
