...
class FlowSchemaFlowcontrolApiserverK8sIoV1alpha1Args {
  ...
  FlowSchemaFlowcontrolApiserverK8sIoV1alpha1Args({
    ...
    pulumi.Output<FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1>? spec,
  }) :
  ...
  factory FlowSchemaFlowcontrolApiserverK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return FlowSchemaFlowcontrolApiserverK8sIoV1alpha1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1>(FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
