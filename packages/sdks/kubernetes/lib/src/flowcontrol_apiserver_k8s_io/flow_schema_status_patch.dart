...
class FlowSchemaStatusPatch {
  ...
  FlowSchemaStatusPatch({this.conditions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<FlowSchemaConditionPatch>,
    ...
    return FlowSchemaStatusPatch(
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FlowSchemaConditionPatch>(
            guardedValue,
            (value) => FlowSchemaConditionPatch.fromMap(
