...
class PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<
    List<PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3>
  >
  items;
  ...
  factory PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta3(
      ...
      items: pulumi.Input.fromValue(
        ...
        >(
          map['items']!,
          (value) =>
              PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap(
