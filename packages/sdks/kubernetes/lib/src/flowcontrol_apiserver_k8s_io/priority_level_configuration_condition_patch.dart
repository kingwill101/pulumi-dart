...
class PriorityLevelConfigurationConditionPatch {
  ...
  /// Creates a new [PriorityLevelConfigurationConditionPatch].
  ...
  const PriorityLevelConfigurationConditionPatch({
  ...
  factory PriorityLevelConfigurationConditionPatch.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationConditionPatch(
