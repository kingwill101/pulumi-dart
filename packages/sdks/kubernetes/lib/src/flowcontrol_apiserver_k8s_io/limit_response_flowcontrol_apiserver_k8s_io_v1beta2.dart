...
import 'queuing_configuration_flowcontrol_apiserver_k8s_io_v1beta2.dart';

/// LimitResponse defines how to handle requests that can not be executed right now.
class LimitResponseFlowcontrolApiserverK8sIoV1beta2 {
  /// `queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `"Queue"`.
  final QueuingConfigurationFlowcontrolApiserverK8sIoV1beta2? queuing;
  /// `type` is "Queue" or "Reject". "Queue" means that requests that can not be executed upon arrival are held in a queue until they can be executed or a queuing limit is reached. "Reject" means that requests that can not be executed upon arrival are rejected. Required.
  final String type;

  /// Creates a new [LimitResponseFlowcontrolApiserverK8sIoV1beta2].
  ...
  LimitResponseFlowcontrolApiserverK8sIoV1beta2({
    this.queuing,
    required this.type,
  });
  ...
  factory LimitResponseFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return LimitResponseFlowcontrolApiserverK8sIoV1beta2(
      queuing: map['queuing'] == null ? null : QueuingConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap((map['queuing'] as Map).cast<String, dynamic>()),
