    ...
    return <String, dynamic>{
      'group':
          ?pulumi.Input.mapOptionalInputValue<
            GroupSubjectPatchFlowcontrolApiserverK8sIoV1alpha1,
            Map<String, dynamic>
      ...
      'user':
          ?pulumi.Input.mapOptionalInputValue<
            UserSubjectPatchFlowcontrolApiserverK8sIoV1alpha1,
            Map<String, dynamic>
          >(user, (value) => value.toMap()),
    };
  }

  factory SubjectPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
    ...
    return SubjectPatchFlowcontrolApiserverK8sIoV1alpha1(
      group: (() {
        ...
        return pulumi.Input.fromValue(
          GroupSubjectPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      serviceAccount: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceAccountSubjectPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      user: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserSubjectPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
