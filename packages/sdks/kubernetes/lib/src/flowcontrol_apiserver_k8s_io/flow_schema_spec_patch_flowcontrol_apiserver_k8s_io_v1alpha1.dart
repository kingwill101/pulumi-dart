...
class FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  final pulumi.Input<
    List<PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1alpha1>
  >?
  rules;
  ...
  factory FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
    ...
    return FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1alpha1(
      distinguisherMethod: (() {
        ...
        return pulumi.Input.fromValue(
          FlowDistinguisherMethodPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      priorityLevelConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationReferencePatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
