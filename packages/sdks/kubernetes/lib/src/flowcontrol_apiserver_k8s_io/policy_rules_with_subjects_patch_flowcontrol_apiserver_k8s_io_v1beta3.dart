...
class PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<
    List<NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3>
  >?
  nonResourceRules;

  /// `resourceRules` is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty.
  final pulumi.Input<
    List<ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3>
  >?
  resourceRules;

  /// subjects is the list of normal user, serviceaccount, or group that this rule cares about. There must be at least one member in this slice. A slice that includes both the system:authenticated and system:unauthenticated user groups matches every request. Required.
  final pulumi.Input<List<SubjectPatchFlowcontrolApiserverK8sIoV1beta3>>?
  subjects;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subjects':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubjectPatchFlowcontrolApiserverK8sIoV1beta3>,
            List<Map<String, dynamic>>
          >(
            subjects,
            (value) =>
  ...
  factory PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta3(
      nonResourceRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      resourceRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      subjects: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubjectPatchFlowcontrolApiserverK8sIoV1beta3>(
            guardedValue,
            (value) => SubjectPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
