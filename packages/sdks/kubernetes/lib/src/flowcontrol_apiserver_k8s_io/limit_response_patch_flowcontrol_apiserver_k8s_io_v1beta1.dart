...
class LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1? queuing;
  ...
  factory LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1(
      queuing: map['queuing'] == null ? null : QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1.fromMap((map['queuing'] as Map).cast<String, dynamic>()),
