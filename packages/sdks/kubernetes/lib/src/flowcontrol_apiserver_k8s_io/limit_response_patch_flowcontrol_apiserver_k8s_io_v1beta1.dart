...
class LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final pulumi.Input<QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1>?
  queuing;
  ...
  LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1({this.queuing, this.type});
  ...
  factory LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
    ...
    return LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1(
      queuing: (() {
        ...
        return pulumi.Input.fromValue(
          QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
