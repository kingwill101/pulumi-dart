...
class LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  const LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1({
    this.queuing,
    this.type,
  });
  ...
  factory LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return LimitResponsePatchFlowcontrolApiserverK8sIoV1beta1(
      queuing: (() { final guardedValue = map['queuing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
