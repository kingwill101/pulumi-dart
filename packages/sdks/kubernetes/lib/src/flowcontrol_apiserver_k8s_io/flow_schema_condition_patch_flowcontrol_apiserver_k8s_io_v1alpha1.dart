...
class FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  /// Creates a new [FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1alpha1].
  ...
  const FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1alpha1({
  ...
  factory FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1alpha1(
