...
class PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta2 {
  ...
  factory PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta2.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta2.fromMap(
