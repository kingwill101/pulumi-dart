...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3? spec;
  /// `status` is the current status of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta3? status;
  ...
  PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3(
      ...
      status: map['status'] == null ? null : PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta3.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
