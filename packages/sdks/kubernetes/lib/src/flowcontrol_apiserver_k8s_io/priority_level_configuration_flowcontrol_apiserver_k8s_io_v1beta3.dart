...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3 {
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3(
      ...
      spec: map['spec'] == null ? null : (PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta3.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
