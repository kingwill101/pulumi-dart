...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3 {
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta3.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
