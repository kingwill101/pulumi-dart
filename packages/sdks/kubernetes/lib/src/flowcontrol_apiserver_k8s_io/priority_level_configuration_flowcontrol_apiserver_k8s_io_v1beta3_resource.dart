...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3Resource extends pulumi.CustomResource {
  ...
  PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3Resource(
    ...
    this.spec = registerOutput<PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3>('spec');
    this.status = registerOutput<PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta3?>('status');
  }
}
