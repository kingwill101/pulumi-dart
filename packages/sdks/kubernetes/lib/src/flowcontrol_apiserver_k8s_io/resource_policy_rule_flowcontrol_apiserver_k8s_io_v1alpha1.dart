...
class ResourcePolicyRuleFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  /// Creates a new [ResourcePolicyRuleFlowcontrolApiserverK8sIoV1alpha1].
  ...
  const ResourcePolicyRuleFlowcontrolApiserverK8sIoV1alpha1({
  ...
  factory ResourcePolicyRuleFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyRuleFlowcontrolApiserverK8sIoV1alpha1(
      apiGroups: pulumi.Input.fromValue((map['apiGroups'] as List).cast<String>()),
      clusterScope: (() { final guardedValue = map['clusterScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
