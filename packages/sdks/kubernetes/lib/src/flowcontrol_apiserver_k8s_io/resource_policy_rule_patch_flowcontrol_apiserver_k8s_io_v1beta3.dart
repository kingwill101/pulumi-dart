...
class ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  /// Creates a new [ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3].
  ...
  const ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3({
    this.apiGroups,
    this.clusterScope,
    this.namespaces,
    this.resources,
  ...
  factory ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta3(
