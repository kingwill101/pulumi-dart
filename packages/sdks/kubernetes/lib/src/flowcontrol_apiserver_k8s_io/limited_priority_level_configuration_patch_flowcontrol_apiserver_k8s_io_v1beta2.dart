...
import 'limit_response_patch_flowcontrol_apiserver_k8s_io_v1beta2.dart';

/// LimitedPriorityLevelConfiguration specifies how to handle requests that are subject to limits. It addresses two issues:
/// - How are requests for this priority level limited?
/// - What should be done with requests that exceed the limit?
class LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2 {
  ...
  final pulumi.Input<LimitResponsePatchFlowcontrolApiserverK8sIoV1beta2>? limitResponse;

  /// Creates a new [LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'limitResponse': ?pulumi.Input.mapOptionalInputValue<LimitResponsePatchFlowcontrolApiserverK8sIoV1beta2, Map<String, dynamic>>(limitResponse, (value) => value.toMap()),
    };
  }
  ...
  factory LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2(
      ...
      limitResponse: map['limitResponse'] == null ? null : (LimitResponsePatchFlowcontrolApiserverK8sIoV1beta2.fromMap((map['limitResponse']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
