...
class PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta2 {
  ...
  /// Creates a new [PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta2].
  ...
  const PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta2({
  ...
  factory PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta2(
