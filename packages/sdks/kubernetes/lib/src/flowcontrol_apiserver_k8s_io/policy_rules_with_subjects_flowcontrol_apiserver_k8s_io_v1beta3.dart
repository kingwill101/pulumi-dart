...
class PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<
    List<NonResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta3>
  >?
  nonResourceRules;

  /// `resourceRules` is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty.
  final pulumi.Input<List<ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta3>>?
  resourceRules;
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  NonResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta3,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'resourceRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta3>,
            List<Map<String, dynamic>>
          >(
            resourceRules,
            (value) =>
                pulumi.Input.encodeList<
                  ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta3,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'subjects':
          pulumi.Input.mapInputValue<
            List<SubjectFlowcontrolApiserverK8sIoV1beta3>,
            List<Map<String, dynamic>>
          >(
            subjects,
            (value) =>
  ...
  factory PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta3(
      nonResourceRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NonResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      resourceRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta3.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      subjects: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SubjectFlowcontrolApiserverK8sIoV1beta3>(
          map['subjects']!,
          (value) => SubjectFlowcontrolApiserverK8sIoV1beta3.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
