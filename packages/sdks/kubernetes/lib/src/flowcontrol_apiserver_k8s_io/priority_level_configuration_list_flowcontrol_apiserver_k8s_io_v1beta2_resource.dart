...
class PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta2Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2>> items;
  ...
  PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta2Resource(
    ...
    items = registerOutput<List<PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2>(guardedValue, (value) => PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta2Resource] resource.
  PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta2Resource.reference(String urn)
    : super(
        'kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationList',
