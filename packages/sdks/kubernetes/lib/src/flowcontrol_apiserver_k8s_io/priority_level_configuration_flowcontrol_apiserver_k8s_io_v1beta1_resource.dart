...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta1Resource(
    ...
    this.spec = registerOutput<PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta1>('spec');
    this.status = registerOutput<PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta1?>('status');
  }
}
