...
class FlowSchemaListFlowcontrolApiserverK8sIoV1beta3Args {
  ...
  final pulumi.Input<List<FlowSchemaFlowcontrolApiserverK8sIoV1beta3Resource>>
  items;
  ...
  factory FlowSchemaListFlowcontrolApiserverK8sIoV1beta3Args.fromMap(
    ...
    return FlowSchemaListFlowcontrolApiserverK8sIoV1beta3Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<FlowSchemaFlowcontrolApiserverK8sIoV1beta3Resource>(),
      ),
      kind: (() {
