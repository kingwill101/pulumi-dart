...
class PriorityLevelConfigurationSpecPatch {
  ...
  final ExemptPriorityLevelConfigurationPatch? exempt;
  /// `limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `"Limited"`.
  final LimitedPriorityLevelConfigurationPatch? limited;
  ...
  factory PriorityLevelConfigurationSpecPatch.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecPatch(
      exempt: map['exempt'] == null ? null : ExemptPriorityLevelConfigurationPatch.fromMap((map['exempt'] as Map).cast<String, dynamic>()),
      limited: map['limited'] == null ? null : LimitedPriorityLevelConfigurationPatch.fromMap((map['limited'] as Map).cast<String, dynamic>()),
