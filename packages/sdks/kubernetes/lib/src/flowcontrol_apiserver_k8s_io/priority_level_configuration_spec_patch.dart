...
class PriorityLevelConfigurationSpecPatch {
  ...
  const PriorityLevelConfigurationSpecPatch({
    this.exempt,
    this.limited,
    this.type,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exempt': ?pulumi.Input.mapOptionalInputValue<ExemptPriorityLevelConfigurationPatch, Map<String, dynamic>>(exempt, (value) => value.toMap()),
      'limited': ?pulumi.Input.mapOptionalInputValue<LimitedPriorityLevelConfigurationPatch, Map<String, dynamic>>(limited, (value) => value.toMap()),
      'type': ?type,
    };
  }
  ...
  factory PriorityLevelConfigurationSpecPatch.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecPatch(
      exempt: (() { final guardedValue = map['exempt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExemptPriorityLevelConfigurationPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      limited: (() { final guardedValue = map['limited']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LimitedPriorityLevelConfigurationPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
