...
class FlowSchemaFlowcontrolApiserverK8sIoV1beta3Args {
  ...
  FlowSchemaFlowcontrolApiserverK8sIoV1beta3Args({
    ...
    pulumi.Output<FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3>? spec,
  }) :
  ...
  factory FlowSchemaFlowcontrolApiserverK8sIoV1beta3Args.fromMap(Map<String, dynamic> map) {
    return FlowSchemaFlowcontrolApiserverK8sIoV1beta3Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3>(FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
