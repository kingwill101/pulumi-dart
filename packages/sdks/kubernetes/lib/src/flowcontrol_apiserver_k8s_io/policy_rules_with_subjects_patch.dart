...
class PolicyRulesWithSubjectsPatch {
  ...
  const PolicyRulesWithSubjectsPatch({
  ...
  factory PolicyRulesWithSubjectsPatch.fromMap(Map<String, dynamic> map) {
    return PolicyRulesWithSubjectsPatch(
      nonResourceRules: (() { final guardedValue = map['nonResourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NonResourcePolicyRulePatch>(guardedValue, (value) => NonResourcePolicyRulePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceRules: (() { final guardedValue = map['resourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourcePolicyRulePatch>(guardedValue, (value) => ResourcePolicyRulePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
