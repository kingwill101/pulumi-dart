...
class FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final pulumi.Input<
    PriorityLevelConfigurationReferencePatchFlowcontrolApiserverK8sIoV1beta1
  >?
  priorityLevelConfiguration;

  /// `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
  final pulumi.Input<
    List<PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta1>
  >?
  rules;
  ...
  factory FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
    ...
    return FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta1(
      distinguisherMethod: (() {
        ...
        return pulumi.Input.fromValue(
          FlowDistinguisherMethodPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
      ...
      priorityLevelConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationReferencePatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
