...
class FlowSchemaListFlowcontrolApiserverK8sIoV1alpha1Args {
  ...
  FlowSchemaListFlowcontrolApiserverK8sIoV1alpha1Args({
    pulumi.Output<String>? apiVersion,
    required pulumi.Output<List<FlowSchemaResource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<FlowSchemaResource>>(items),
  ...
  factory FlowSchemaListFlowcontrolApiserverK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return FlowSchemaListFlowcontrolApiserverK8sIoV1alpha1Args(
      ...
      items: pulumi.Output.create<List<FlowSchemaResource>>((map['items'] as List).cast<FlowSchemaResource>()),
