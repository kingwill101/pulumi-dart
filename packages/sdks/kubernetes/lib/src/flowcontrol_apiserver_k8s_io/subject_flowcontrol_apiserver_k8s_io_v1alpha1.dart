...
import 'group_subject_flowcontrol_apiserver_k8s_io_v1alpha1.dart';
import 'service_account_subject_flowcontrol_apiserver_k8s_io_v1alpha1.dart';
import 'user_subject_flowcontrol_apiserver_k8s_io_v1alpha1.dart';
...
class SubjectFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  /// [user] Optional.
  const SubjectFlowcontrolApiserverK8sIoV1alpha1({
    this.group,
    required this.kind,
    this.serviceAccount,
    this.user,
  ...
  factory SubjectFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return SubjectFlowcontrolApiserverK8sIoV1alpha1(
      group: (() { final guardedValue = map['group']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GroupSubjectFlowcontrolApiserverK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      serviceAccount: (() { final guardedValue = map['serviceAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAccountSubjectFlowcontrolApiserverK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      user: (() { final guardedValue = map['user']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserSubjectFlowcontrolApiserverK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
