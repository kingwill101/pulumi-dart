...
class PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  /// Creates a new [PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1alpha1].
  ...
  const PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1alpha1({
  ...
  factory PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1alpha1(
