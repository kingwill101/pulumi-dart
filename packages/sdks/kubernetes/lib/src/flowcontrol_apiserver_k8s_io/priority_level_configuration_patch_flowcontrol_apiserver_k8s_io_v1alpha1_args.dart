...
class PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1Args {
  ...
  factory PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1Args.fromMap(
    ...
    return PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1Args(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
