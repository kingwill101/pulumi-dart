...
class PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final ExemptPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3? exempt;
  /// `limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `"Limited"`.
  final LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3? limited;
  ...
  factory PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3(
      exempt: map['exempt'] == null ? null : ExemptPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap((map['exempt'] as Map).cast<String, dynamic>()),
      limited: map['limited'] == null ? null : LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap((map['limited'] as Map).cast<String, dynamic>()),
