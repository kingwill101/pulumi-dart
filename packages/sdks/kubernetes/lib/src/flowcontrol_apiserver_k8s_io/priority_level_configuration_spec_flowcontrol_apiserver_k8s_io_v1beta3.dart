...
import 'exempt_priority_level_configuration_flowcontrol_apiserver_k8s_io_v1beta3.dart';
import 'limited_priority_level_configuration_flowcontrol_apiserver_k8s_io_v1beta3.dart';
...
class PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3 {
  ...
  /// Creates a new [PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3].
  ...
  const PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3({
    this.exempt,
    this.limited,
    required this.type,
  });
  ...
  factory PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta3(
      exempt: (() { final guardedValue = map['exempt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExemptPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      limited: (() { final guardedValue = map['limited']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
