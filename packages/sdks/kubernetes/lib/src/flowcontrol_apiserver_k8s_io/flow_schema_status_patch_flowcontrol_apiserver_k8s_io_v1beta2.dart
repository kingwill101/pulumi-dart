...
class FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta2 {
  ...
  final pulumi.Input<
    List<FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1beta2>
  >?
  conditions;
  ...
  FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta2({this.conditions});
  ...
  factory FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta2.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1beta2.fromMap(
