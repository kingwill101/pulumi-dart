...
class FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<
    List<PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta3>
  >?
  rules;
  ...
  factory FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta3(
      distinguisherMethod: (() {
        ...
        return pulumi.Input.fromValue(
          FlowDistinguisherMethodPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      priorityLevelConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationReferencePatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
