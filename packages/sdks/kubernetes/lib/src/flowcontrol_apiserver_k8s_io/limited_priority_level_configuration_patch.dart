...
import 'limit_response_patch.dart';
...
class LimitedPriorityLevelConfigurationPatch {
  ...
  final LimitResponsePatch? limitResponse;
  ...
  factory LimitedPriorityLevelConfigurationPatch.fromMap(Map<String, dynamic> map) {
    return LimitedPriorityLevelConfigurationPatch(
      ...
      limitResponse: map['limitResponse'] == null ? null : LimitResponsePatch.fromMap((map['limitResponse'] as Map).cast<String, dynamic>()),
