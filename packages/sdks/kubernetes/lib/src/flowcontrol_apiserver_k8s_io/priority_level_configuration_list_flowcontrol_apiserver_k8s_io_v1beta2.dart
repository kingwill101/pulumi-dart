...
class PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta2 {
  ...
  final pulumi.Input<
    List<PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2>
  >
  items;
  ...
  factory PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta2.fromMap(
    ...
    return PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta2(
      ...
      items: pulumi.Input.fromValue(
        ...
        >(
          map['items']!,
          (value) =>
              PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap(
