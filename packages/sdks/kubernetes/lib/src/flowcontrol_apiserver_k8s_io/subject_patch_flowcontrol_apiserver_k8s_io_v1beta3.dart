...
class SubjectPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<
    ServiceAccountSubjectPatchFlowcontrolApiserverK8sIoV1beta3
  >?
  serviceAccount;
  ...
  factory SubjectPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return SubjectPatchFlowcontrolApiserverK8sIoV1beta3(
      group: (() {
        ...
        return pulumi.Input.fromValue(
          GroupSubjectPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      serviceAccount: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceAccountSubjectPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      user: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserSubjectPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
