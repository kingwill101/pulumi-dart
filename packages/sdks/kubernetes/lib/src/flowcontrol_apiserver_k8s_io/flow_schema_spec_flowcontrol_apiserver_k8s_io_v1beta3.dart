...
class FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3 {
  ...
  factory FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3(
      distinguisherMethod: map['distinguisherMethod'] == null ? null : (FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1beta3.fromMap((map['distinguisherMethod'] as Map).cast<String, dynamic>())).input(),
      matchingPrecedence: map['matchingPrecedence'] == null ? null : (map['matchingPrecedence'] as int).input(),
      priorityLevelConfiguration: (PriorityLevelConfigurationReferenceFlowcontrolApiserverK8sIoV1beta3.fromMap((map['priorityLevelConfiguration'] as Map).cast<String, dynamic>())).input(),
      rules: map['rules'] == null ? null : (pulumi.Input.decodeList<PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta3>(map['rules'], (value) => PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta3.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
