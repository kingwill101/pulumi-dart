...
class FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1beta3>?
  distinguisherMethod;
  ...
  final pulumi.Input<
    PriorityLevelConfigurationReferenceFlowcontrolApiserverK8sIoV1beta3
  >
  priorityLevelConfiguration;

  /// `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
  final pulumi.Input<
    List<PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta3>
  >?
  rules;
  ...
  factory FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3(
      distinguisherMethod: (() {
        ...
        return pulumi.Input.fromValue(
          FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      priorityLevelConfiguration: pulumi.Input.fromValue(
        PriorityLevelConfigurationReferenceFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta3.fromMap(
