...
class FlowSchemaFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  factory FlowSchemaFlowcontrolApiserverK8sIoV1alpha1.fromMap(
    ...
    return FlowSchemaFlowcontrolApiserverK8sIoV1alpha1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowSchemaStatusFlowcontrolApiserverK8sIoV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
