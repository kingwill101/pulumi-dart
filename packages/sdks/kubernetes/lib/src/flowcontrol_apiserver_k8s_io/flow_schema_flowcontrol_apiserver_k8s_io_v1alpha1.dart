...
class FlowSchemaFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  factory FlowSchemaFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return FlowSchemaFlowcontrolApiserverK8sIoV1alpha1(
      ...
      spec: map['spec'] == null ? null : (FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (FlowSchemaStatusFlowcontrolApiserverK8sIoV1alpha1.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
