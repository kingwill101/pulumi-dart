...
class FlowSchemaFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  final FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1? spec;
  /// `status` is the current status of a FlowSchema. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final FlowSchemaStatusFlowcontrolApiserverK8sIoV1alpha1? status;
  ...
  factory FlowSchemaFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return FlowSchemaFlowcontrolApiserverK8sIoV1alpha1(
      ...
      status: map['status'] == null ? null : FlowSchemaStatusFlowcontrolApiserverK8sIoV1alpha1.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
