...
class FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1beta1>
  >?
  conditions;
  ...
  FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta1({this.conditions});
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1beta1,
                  Map<String, dynamic>
  ...
  factory FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
