...
class PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  final pulumi.Input<
    List<PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1alpha1>
  >?
  conditions;
    ...
    return <String, dynamic>{
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<
              PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1alpha1
            >,
  ...
  factory PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1alpha1.fromMap(
