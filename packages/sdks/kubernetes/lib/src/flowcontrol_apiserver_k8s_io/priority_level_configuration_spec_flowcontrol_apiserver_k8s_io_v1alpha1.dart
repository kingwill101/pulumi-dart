...
class PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  final pulumi.Input<
    LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1
  >?
  limited;
  ...
  factory PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap(
    ...
    return PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1(
      limited: (() {
        ...
        return pulumi.Input.fromValue(
          LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1.fromMap(
