...
class PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  const PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1({
    this.limited,
    required this.type,
  });
  ...
  factory PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1(
      limited: (() { final guardedValue = map['limited']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
