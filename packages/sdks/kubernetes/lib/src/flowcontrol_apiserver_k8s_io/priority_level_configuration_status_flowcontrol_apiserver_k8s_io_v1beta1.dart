...
class PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta1 {
  ...
  const PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta1({
    this.conditions,
  });
  ...
  factory PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta1(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1>(guardedValue, (value) => PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
