...
class PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1>
  >?
  conditions;
    ...
    return <String, dynamic>{
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<
              PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1
            >,
  ...
  factory PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1.fromMap(
