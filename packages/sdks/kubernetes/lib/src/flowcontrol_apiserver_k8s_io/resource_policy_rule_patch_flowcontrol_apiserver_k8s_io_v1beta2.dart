...
class ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2 {
  ...
  /// Creates a new [ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2].
  ...
  const ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2({
    this.apiGroups,
    this.clusterScope,
    this.namespaces,
    this.resources,
  ...
  factory ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2(
