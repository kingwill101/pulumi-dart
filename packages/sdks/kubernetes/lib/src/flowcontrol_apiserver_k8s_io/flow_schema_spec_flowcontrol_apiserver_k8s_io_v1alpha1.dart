...
class FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  final pulumi.Input<FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1alpha1>?
  distinguisherMethod;
  ...
  final pulumi.Input<
    List<PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1alpha1>
  >?
  rules;
  ...
  factory FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap(
    ...
    return FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1(
      distinguisherMethod: (() {
        ...
        return pulumi.Input.fromValue(
          FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      priorityLevelConfiguration: pulumi.Input.fromValue(
        PriorityLevelConfigurationReferenceFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1alpha1.fromMap(
