...
class FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  final FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1alpha1? distinguisherMethod;
  ...
  final PriorityLevelConfigurationReferenceFlowcontrolApiserverK8sIoV1alpha1 priorityLevelConfiguration;
  /// `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
  final List<PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1alpha1>? rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?rules == null ? null : pulumi.Input.encodeList<PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1alpha1, Map<String, dynamic>>(rules!, (value) => value.toMap()),
    };
  }
  ...
  factory FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return FlowSchemaSpecFlowcontrolApiserverK8sIoV1alpha1(
      distinguisherMethod: map['distinguisherMethod'] == null ? null : FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1alpha1.fromMap((map['distinguisherMethod'] as Map).cast<String, dynamic>()),
      matchingPrecedence: map['matchingPrecedence'] == null ? null : map['matchingPrecedence'] as int,
      priorityLevelConfiguration: PriorityLevelConfigurationReferenceFlowcontrolApiserverK8sIoV1alpha1.fromMap((map['priorityLevelConfiguration'] as Map).cast<String, dynamic>()),
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1alpha1>(map['rules'], (value) => PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
