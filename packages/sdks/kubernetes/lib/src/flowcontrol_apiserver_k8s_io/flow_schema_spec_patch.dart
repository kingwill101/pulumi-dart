...
class FlowSchemaSpecPatch {
  ...
  factory FlowSchemaSpecPatch.fromMap(Map<String, dynamic> map) {
    return FlowSchemaSpecPatch(
      distinguisherMethod: (() { final guardedValue = map['distinguisherMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FlowDistinguisherMethodPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      priorityLevelConfiguration: (() { final guardedValue = map['priorityLevelConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PriorityLevelConfigurationReferencePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PolicyRulesWithSubjectsPatch>(guardedValue, (value) => PolicyRulesWithSubjectsPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
