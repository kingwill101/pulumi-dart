...
class ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  /// Creates a new [ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1].
  ...
  const ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1({
    this.apiGroups,
    this.clusterScope,
    this.namespaces,
    this.resources,
  ...
  factory ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1(
