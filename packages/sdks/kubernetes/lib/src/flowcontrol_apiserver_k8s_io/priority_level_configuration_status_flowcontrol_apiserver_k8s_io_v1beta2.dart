...
class PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta2 {
  ...
  final pulumi.Input<
    List<PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta2>
  >?
  conditions;
  ...
  factory PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta2.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta2.fromMap(
