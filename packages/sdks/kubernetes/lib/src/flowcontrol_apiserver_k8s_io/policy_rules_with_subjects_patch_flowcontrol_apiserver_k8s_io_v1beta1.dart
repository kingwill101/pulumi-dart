...
class PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1>
  >?
  nonResourceRules;

  /// `resourceRules` is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty.
  final pulumi.Input<
    List<ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1>
  >?
  resourceRules;

  /// subjects is the list of normal user, serviceaccount, or group that this rule cares about. There must be at least one member in this slice. A slice that includes both the system:authenticated and system:unauthenticated user groups matches every request. Required.
  final pulumi.Input<List<SubjectPatchFlowcontrolApiserverK8sIoV1beta1>>?
  subjects;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subjects':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubjectPatchFlowcontrolApiserverK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            subjects,
            (value) =>
  ...
  factory PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
    ...
    return PolicyRulesWithSubjectsPatchFlowcontrolApiserverK8sIoV1beta1(
      nonResourceRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
      ...
      resourceRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      subjects: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubjectPatchFlowcontrolApiserverK8sIoV1beta1>(
            guardedValue,
            (value) => SubjectPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
