...
class PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  const PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta3({
    this.conditions,
  });
  ...
  factory PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta3(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta3>(guardedValue, (value) => PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta3.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
