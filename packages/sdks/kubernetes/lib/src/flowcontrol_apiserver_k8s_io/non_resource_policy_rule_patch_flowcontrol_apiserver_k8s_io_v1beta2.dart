...
class NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2 {
  ...
  /// Creates a new [NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2].
  ...
  const NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2({
  ...
  factory NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return NonResourcePolicyRulePatchFlowcontrolApiserverK8sIoV1beta2(
