...
class FlowSchemaFlowcontrolApiserverK8sIoV1beta2 {
  ...
  const FlowSchemaFlowcontrolApiserverK8sIoV1beta2({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory FlowSchemaFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return FlowSchemaFlowcontrolApiserverK8sIoV1beta2(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
