...
class FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta3>?
  status;
  ...
  factory FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta3(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
