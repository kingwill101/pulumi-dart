...
class FlowSchemaArgs {
  ...
  FlowSchemaArgs({
    ...
    pulumi.Output<FlowSchemaSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<FlowSchemaSpec>(spec);
  ...
  factory FlowSchemaArgs.fromMap(Map<String, dynamic> map) {
    return FlowSchemaArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<FlowSchemaSpec>(FlowSchemaSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
