...
class PriorityLevelConfigurationStatusPatch {
  ...
  factory PriorityLevelConfigurationStatusPatch.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationStatusPatch(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PriorityLevelConfigurationConditionPatch>(guardedValue, (value) => PriorityLevelConfigurationConditionPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
