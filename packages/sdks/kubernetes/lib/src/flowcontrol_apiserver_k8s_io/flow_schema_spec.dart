...
class FlowSchemaSpec {
  ...
  final pulumi.Input<FlowDistinguisherMethod>? distinguisherMethod;
  ...
  final pulumi.Input<PriorityLevelConfigurationReference> priorityLevelConfiguration;
  /// `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
  final pulumi.Input<List<PolicyRulesWithSubjects>>? rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'distinguisherMethod': ?pulumi.Input.mapOptionalInputValue<FlowDistinguisherMethod, Map<String, dynamic>>(distinguisherMethod, (value) => value.toMap()),
      'matchingPrecedence': ?matchingPrecedence,
      'priorityLevelConfiguration': pulumi.Input.mapInputValue<PriorityLevelConfigurationReference, Map<String, dynamic>>(priorityLevelConfiguration, (value) => value.toMap()),
      'rules': ?pulumi.Input.mapOptionalInputValue<List<PolicyRulesWithSubjects>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<PolicyRulesWithSubjects, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
