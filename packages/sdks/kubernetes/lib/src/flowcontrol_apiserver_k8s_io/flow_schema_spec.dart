...
class FlowSchemaSpec {
  ...
  final pulumi.Input<PriorityLevelConfigurationReference>
    ...
    return FlowSchemaSpec(
      distinguisherMethod: (() {
        ...
        return pulumi.Input.fromValue(
          FlowDistinguisherMethod.fromMap(
      ...
      priorityLevelConfiguration: pulumi.Input.fromValue(
        PriorityLevelConfigurationReference.fromMap(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyRulesWithSubjects>(
            guardedValue,
            (value) => PolicyRulesWithSubjects.fromMap(
