...
class FlowSchemaConditionFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  /// Creates a new [FlowSchemaConditionFlowcontrolApiserverK8sIoV1alpha1].
  ...
  const FlowSchemaConditionFlowcontrolApiserverK8sIoV1alpha1({
  ...
  factory FlowSchemaConditionFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return FlowSchemaConditionFlowcontrolApiserverK8sIoV1alpha1(
