...
class LimitResponse {
  ...
  final pulumi.Input<QueuingConfiguration>? queuing;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'queuing': ?pulumi.Input.mapOptionalInputValue<QueuingConfiguration, Map<String, dynamic>>(queuing, (value) => value.toMap()),
      'type': type,
    };
  }
  ...
  factory LimitResponse.fromMap(Map<String, dynamic> map) {
    return LimitResponse(
      queuing: (() { final guardedValue = map['queuing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueuingConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
