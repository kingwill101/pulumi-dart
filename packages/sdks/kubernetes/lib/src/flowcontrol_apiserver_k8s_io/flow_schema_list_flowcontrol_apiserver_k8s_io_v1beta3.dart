...
class FlowSchemaListFlowcontrolApiserverK8sIoV1beta3 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<FlowSchemaFlowcontrolApiserverK8sIoV1beta3>,
  ...
  factory FlowSchemaListFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return FlowSchemaListFlowcontrolApiserverK8sIoV1beta3(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FlowSchemaFlowcontrolApiserverK8sIoV1beta3>(
          map['items']!,
          (value) => FlowSchemaFlowcontrolApiserverK8sIoV1beta3.fromMap(
