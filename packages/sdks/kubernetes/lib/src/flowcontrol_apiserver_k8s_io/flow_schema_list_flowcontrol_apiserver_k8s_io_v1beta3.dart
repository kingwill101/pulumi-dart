...
class FlowSchemaListFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<List<FlowSchemaFlowcontrolApiserverK8sIoV1beta3>> items;
  ...
  const FlowSchemaListFlowcontrolApiserverK8sIoV1beta3({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<FlowSchemaFlowcontrolApiserverK8sIoV1beta3>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<FlowSchemaFlowcontrolApiserverK8sIoV1beta3, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory FlowSchemaListFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return FlowSchemaListFlowcontrolApiserverK8sIoV1beta3(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<FlowSchemaFlowcontrolApiserverK8sIoV1beta3>(map['items']!, (value) => FlowSchemaFlowcontrolApiserverK8sIoV1beta3.fromMap((value as Map).cast<String, dynamic>()))),
