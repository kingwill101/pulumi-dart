...
import 'flow_schema_condition_patch_flowcontrol_apiserver_k8s_io_v1alpha1.dart';
...
class FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  const FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1alpha1({
    this.conditions,
  });
  ...
  factory FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return FlowSchemaStatusPatchFlowcontrolApiserverK8sIoV1alpha1(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1alpha1>(guardedValue, (value) => FlowSchemaConditionPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
