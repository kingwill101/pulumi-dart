...
class PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta3Resource extends pulumi.CustomResource {
  /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  late final pulumi.Output<String> apiVersion;
  /// `items` is a list of request-priorities.
  late final pulumi.Output<List<PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3Resource>> items;
  ...
  PriorityLevelConfigurationListFlowcontrolApiserverK8sIoV1beta3Resource(
    ...
    this.items = registerOutput<List<PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta3Resource>>('items');
