...
class PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2 {
  ...
  factory PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2.fromMap(
    ...
    return PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2(
      exempt: (() {
        ...
        return pulumi.Input.fromValue(
          ExemptPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap(
      ...
      limited: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
