...
class PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2 {
  ...
  const PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2({
    this.exempt,
    this.limited,
    required this.type,
  });
  ...
  factory PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2(
      exempt: (() { final guardedValue = map['exempt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExemptPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      limited: (() { final guardedValue = map['limited']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LimitedPriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
