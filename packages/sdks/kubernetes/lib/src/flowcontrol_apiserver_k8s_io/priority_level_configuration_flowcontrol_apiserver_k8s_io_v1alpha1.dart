...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  const PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
