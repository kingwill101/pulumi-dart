...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1.fromMap(
    ...
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
