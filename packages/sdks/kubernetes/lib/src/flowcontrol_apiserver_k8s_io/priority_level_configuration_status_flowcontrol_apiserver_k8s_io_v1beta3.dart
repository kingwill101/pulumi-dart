...
class PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<
    List<PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta3>
  >?
  conditions;
  ...
  factory PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta3.fromMap(
