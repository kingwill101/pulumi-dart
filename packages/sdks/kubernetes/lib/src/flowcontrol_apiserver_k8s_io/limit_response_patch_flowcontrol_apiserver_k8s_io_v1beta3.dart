...
class LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta3>?
  queuing;
  ...
  LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3({this.queuing, this.type});
  ...
  factory LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3(
      queuing: (() {
        ...
        return pulumi.Input.fromValue(
          QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
