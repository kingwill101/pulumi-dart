...
class LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta3? queuing;
  ...
  factory LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3(
      queuing: map['queuing'] == null ? null : QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap((map['queuing'] as Map).cast<String, dynamic>()),
