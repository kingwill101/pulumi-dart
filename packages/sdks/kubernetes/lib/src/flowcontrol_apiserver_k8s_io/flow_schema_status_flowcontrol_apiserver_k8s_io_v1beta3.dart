...
class FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3 {
  ...
  const FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3({
    this.conditions,
  });
  ...
  factory FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FlowSchemaConditionFlowcontrolApiserverK8sIoV1beta3>(guardedValue, (value) => FlowSchemaConditionFlowcontrolApiserverK8sIoV1beta3.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
