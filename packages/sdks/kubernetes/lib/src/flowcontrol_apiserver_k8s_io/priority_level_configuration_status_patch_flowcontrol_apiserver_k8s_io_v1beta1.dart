...
class PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final List<PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta1>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta1, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
    };
  }
  ...
  factory PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta1(
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta1>(map['conditions'], (value) => PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
