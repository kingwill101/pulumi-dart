...
class PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  factory PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
