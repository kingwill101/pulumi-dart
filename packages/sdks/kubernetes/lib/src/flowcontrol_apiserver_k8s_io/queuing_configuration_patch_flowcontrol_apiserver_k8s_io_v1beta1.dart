...
class QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  /// Creates a new [QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1].
  ...
  const QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1({
    this.handSize,
  ...
  factory QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta1(
