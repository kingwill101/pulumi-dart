...
class SubjectFlowcontrolApiserverK8sIoV1beta1 {
  ...
  final pulumi.Input<ServiceAccountSubjectFlowcontrolApiserverK8sIoV1beta1>?
  serviceAccount;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'user':
          ?pulumi.Input.mapOptionalInputValue<
            UserSubjectFlowcontrolApiserverK8sIoV1beta1,
            Map<String, dynamic>
          >(user, (value) => value.toMap()),
    };
  }

  factory SubjectFlowcontrolApiserverK8sIoV1beta1.fromMap(
    ...
    return SubjectFlowcontrolApiserverK8sIoV1beta1(
      group: (() {
        ...
        return pulumi.Input.fromValue(
          GroupSubjectFlowcontrolApiserverK8sIoV1beta1.fromMap(
      ...
      serviceAccount: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceAccountSubjectFlowcontrolApiserverK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      user: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserSubjectFlowcontrolApiserverK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
