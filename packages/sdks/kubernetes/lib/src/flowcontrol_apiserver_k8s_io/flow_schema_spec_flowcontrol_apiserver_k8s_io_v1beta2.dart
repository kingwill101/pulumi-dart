...
class FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta2 {
  ...
  final pulumi.Input<FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1beta2>?
  distinguisherMethod;
  ...
  final pulumi.Input<
    List<PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta2>
  >?
  rules;
    ...
    return <String, dynamic>{
      'distinguisherMethod':
          ?pulumi.Input.mapOptionalInputValue<
            FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1beta2,
            Map<String, dynamic>
  ...
  factory FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta2.fromMap(
    ...
    return FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta2(
      distinguisherMethod: (() {
        ...
        return pulumi.Input.fromValue(
          FlowDistinguisherMethodFlowcontrolApiserverK8sIoV1beta2.fromMap(
      ...
      priorityLevelConfiguration: pulumi.Input.fromValue(
        PriorityLevelConfigurationReferenceFlowcontrolApiserverK8sIoV1beta2.fromMap(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PolicyRulesWithSubjectsFlowcontrolApiserverK8sIoV1beta2.fromMap(
