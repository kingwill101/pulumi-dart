...
class ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta1 {
  ...
  /// Creates a new [ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta1].
  ...
  const ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta1({
  ...
  factory ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyRuleFlowcontrolApiserverK8sIoV1beta1(
