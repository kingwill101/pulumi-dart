...
class PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2Args {
  ...
  PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2Args({
    ...
    pulumi.Output<PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta2>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta2>(spec);
  ...
  factory PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2Args.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta2Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta2>(PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
