...
class FlowSchemaFlowcontrolApiserverK8sIoV1beta3Resource
  ...
  late final pulumi.Output<FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3?>
  status;
  ...
  FlowSchemaFlowcontrolApiserverK8sIoV1beta3Resource(
    ...
    spec = registerOutput<FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FlowSchemaSpecFlowcontrolApiserverK8sIoV1beta3.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3?>(
      'status',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta3.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
