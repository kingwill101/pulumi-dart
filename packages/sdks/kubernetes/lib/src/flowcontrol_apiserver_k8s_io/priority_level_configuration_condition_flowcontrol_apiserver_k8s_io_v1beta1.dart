...
class PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1 {
  ...
  const PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1({
  ...
  factory PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationConditionFlowcontrolApiserverK8sIoV1beta1(
