...
class LimitResponsePatchFlowcontrolApiserverK8sIoV1beta2 {
  ...
  final QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta2? queuing;
  ...
  factory LimitResponsePatchFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return LimitResponsePatchFlowcontrolApiserverK8sIoV1beta2(
      queuing: map['queuing'] == null ? null : QueuingConfigurationPatchFlowcontrolApiserverK8sIoV1beta2.fromMap((map['queuing'] as Map).cast<String, dynamic>()),
