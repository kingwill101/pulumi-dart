...
class FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta2 {
  ...
  factory FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return FlowSchemaStatusFlowcontrolApiserverK8sIoV1beta2(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FlowSchemaConditionFlowcontrolApiserverK8sIoV1beta2>(guardedValue, (value) => FlowSchemaConditionFlowcontrolApiserverK8sIoV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
