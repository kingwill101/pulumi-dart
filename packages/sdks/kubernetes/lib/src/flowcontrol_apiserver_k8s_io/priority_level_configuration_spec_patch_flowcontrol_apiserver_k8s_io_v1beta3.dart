...
class PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  const PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3({
    this.exempt,
    this.limited,
    this.type,
  });
  ...
  factory PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3(
      exempt: (() { final guardedValue = map['exempt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExemptPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      limited: (() { final guardedValue = map['limited']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
