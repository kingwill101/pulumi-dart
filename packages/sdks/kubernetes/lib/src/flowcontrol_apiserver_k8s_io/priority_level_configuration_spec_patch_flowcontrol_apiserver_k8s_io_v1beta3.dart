...
class PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final ExemptPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3? exempt;
  /// `limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `"Limited"`.
  final LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3? limited;
  ...
  factory PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3(
      exempt: map['exempt'] == null ? null : ExemptPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap((map['exempt'] as Map).cast<String, dynamic>()),
      limited: map['limited'] == null ? null : LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap((map['limited'] as Map).cast<String, dynamic>()),
