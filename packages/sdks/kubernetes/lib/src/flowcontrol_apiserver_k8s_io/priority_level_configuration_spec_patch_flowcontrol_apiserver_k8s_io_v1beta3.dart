...
class PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final pulumi.Input<
    ExemptPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3
  >?
  exempt;
  ...
  factory PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
    ...
    return PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta3(
      exempt: (() {
        ...
        return pulumi.Input.fromValue(
          ExemptPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
      ...
      limited: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
