...
class FlowSchemaStatusFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  final pulumi.Input<
    List<FlowSchemaConditionFlowcontrolApiserverK8sIoV1alpha1>
  >?
  conditions;
  ...
  FlowSchemaStatusFlowcontrolApiserverK8sIoV1alpha1({this.conditions});
  ...
  factory FlowSchemaStatusFlowcontrolApiserverK8sIoV1alpha1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FlowSchemaConditionFlowcontrolApiserverK8sIoV1alpha1.fromMap(
