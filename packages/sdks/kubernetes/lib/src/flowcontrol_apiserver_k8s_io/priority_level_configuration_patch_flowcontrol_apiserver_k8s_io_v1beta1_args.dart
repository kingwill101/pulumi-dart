...
class PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta1Args {
  ...
  PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta1Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMetaPatch>? metadata,
    pulumi.Output<PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta1>(spec);
  ...
  factory PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta1>(PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
