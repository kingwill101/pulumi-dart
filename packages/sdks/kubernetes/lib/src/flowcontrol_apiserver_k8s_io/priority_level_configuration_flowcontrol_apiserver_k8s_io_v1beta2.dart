...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2 {
  ...
  const PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta2, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
