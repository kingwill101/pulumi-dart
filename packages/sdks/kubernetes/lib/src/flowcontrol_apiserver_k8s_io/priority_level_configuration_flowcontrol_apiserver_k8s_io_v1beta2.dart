...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2 {
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2.fromMap(
    ...
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1beta2(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1beta2.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationStatusFlowcontrolApiserverK8sIoV1beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
