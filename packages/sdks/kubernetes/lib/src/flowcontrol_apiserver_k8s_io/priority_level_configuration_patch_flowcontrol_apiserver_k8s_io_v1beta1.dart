...
class PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta1 {
  ...
  factory PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
    ...
    return PriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
