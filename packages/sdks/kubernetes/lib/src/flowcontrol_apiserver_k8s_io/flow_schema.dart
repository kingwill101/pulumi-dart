...
class FlowSchema {
  ...
  factory FlowSchema.fromMap(Map<String, dynamic> map) {
    return FlowSchema(
      ...
      spec: map['spec'] == null ? null : FlowSchemaSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : FlowSchemaStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
