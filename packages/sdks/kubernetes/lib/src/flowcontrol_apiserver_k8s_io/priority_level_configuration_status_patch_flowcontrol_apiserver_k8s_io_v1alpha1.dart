...
class PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  factory PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationStatusPatchFlowcontrolApiserverK8sIoV1alpha1(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1alpha1>(guardedValue, (value) => PriorityLevelConfigurationConditionPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
