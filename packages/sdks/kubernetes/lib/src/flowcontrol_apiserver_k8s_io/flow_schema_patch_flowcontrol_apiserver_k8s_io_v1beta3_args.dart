...
class FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta3Args {
  ...
  FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta3Args({
    ...
    pulumi.Output<FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta3>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta3>(spec);
  ...
  factory FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta3Args.fromMap(Map<String, dynamic> map) {
    return FlowSchemaPatchFlowcontrolApiserverK8sIoV1beta3Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta3>(FlowSchemaSpecPatchFlowcontrolApiserverK8sIoV1beta3.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
