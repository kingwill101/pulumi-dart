...
class PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1Args {
  ...
  PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMeta>? metadata,
    pulumi.Output<PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1>(spec);
  ...
  factory PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationFlowcontrolApiserverK8sIoV1alpha1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1>(PriorityLevelConfigurationSpecFlowcontrolApiserverK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
