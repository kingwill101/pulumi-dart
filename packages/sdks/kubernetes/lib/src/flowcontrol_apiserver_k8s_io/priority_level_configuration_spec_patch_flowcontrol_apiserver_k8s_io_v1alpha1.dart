...
class PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1alpha1 {
  ...
  const PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1alpha1({
    this.limited,
    this.type,
  });
  ...
  factory PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return PriorityLevelConfigurationSpecPatchFlowcontrolApiserverK8sIoV1alpha1(
      limited: (() { final guardedValue = map['limited']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
