...
class LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3 {
  ...
  final LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3? limitResponse;
  ...
  LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3({
  ...
  factory LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3.fromMap(Map<String, dynamic> map) {
    return LimitedPriorityLevelConfigurationPatchFlowcontrolApiserverK8sIoV1beta3(
      borrowingLimitPercent: map['borrowingLimitPercent'] == null ? null : map['borrowingLimitPercent'] as int,
      lendablePercent: map['lendablePercent'] == null ? null : map['lendablePercent'] as int,
      limitResponse: map['limitResponse'] == null ? null : LimitResponsePatchFlowcontrolApiserverK8sIoV1beta3.fromMap((map['limitResponse'] as Map).cast<String, dynamic>()),
