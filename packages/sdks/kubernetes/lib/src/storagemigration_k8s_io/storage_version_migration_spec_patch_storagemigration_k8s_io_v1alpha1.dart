...
class StorageVersionMigrationSpecPatchStoragemigrationK8sIoV1alpha1 {
  ...
  /// Creates a new [StorageVersionMigrationSpecPatchStoragemigrationK8sIoV1alpha1].
  ...
  const StorageVersionMigrationSpecPatchStoragemigrationK8sIoV1alpha1({
    this.continueToken,
    this.resource,
  });
  ...
  factory StorageVersionMigrationSpecPatchStoragemigrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return StorageVersionMigrationSpecPatchStoragemigrationK8sIoV1alpha1(
