...
class StorageVersionMigrationStatusPatch {
  ...
  StorageVersionMigrationStatusPatch({this.conditions, this.resourceVersion});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<MigrationConditionPatch>,
    ...
    return StorageVersionMigrationStatusPatch(
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MigrationConditionPatch>(
            guardedValue,
            (value) => MigrationConditionPatch.fromMap(
