...
class StorageVersionMigrationSpecStoragemigrationK8sIoV1alpha1 {
  ...
  /// Creates a new [StorageVersionMigrationSpecStoragemigrationK8sIoV1alpha1].
  ...
  const StorageVersionMigrationSpecStoragemigrationK8sIoV1alpha1({
    this.continueToken,
  ...
  factory StorageVersionMigrationSpecStoragemigrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return StorageVersionMigrationSpecStoragemigrationK8sIoV1alpha1(
