...
class StorageVersionMigrationResource extends pulumi.CustomResource {
  ...
  StorageVersionMigrationResource(
    ...
    spec = registerOutput<StorageVersionMigrationSpecStoragemigrationK8sIoV1beta1>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return StorageVersionMigrationSpecStoragemigrationK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status =
        ...
        >(
          ...
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return StorageVersionMigrationStatusStoragemigrationK8sIoV1beta1.fromMap(
              (guardedValue as Map).cast<String, dynamic>(),
            );
          },
        );
