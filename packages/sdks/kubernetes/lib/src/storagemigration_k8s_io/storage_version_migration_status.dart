...
class StorageVersionMigrationStatus {
  ...
  final List<MigrationCondition>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<MigrationCondition, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory StorageVersionMigrationStatus.fromMap(Map<String, dynamic> map) {
    return StorageVersionMigrationStatus(
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<MigrationCondition>(map['conditions'], (value) => MigrationCondition.fromMap((value as Map).cast<String, dynamic>())),
