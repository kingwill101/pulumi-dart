...
class StorageVersionMigrationArgs {
  ...
  StorageVersionMigrationArgs({
    ...
    pulumi.Output<StorageVersionMigrationSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<StorageVersionMigrationSpec>(spec);
  ...
  factory StorageVersionMigrationArgs.fromMap(Map<String, dynamic> map) {
    return StorageVersionMigrationArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<StorageVersionMigrationSpec>(StorageVersionMigrationSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
