...
import 'directory_kustomize_args.dart';
...
/// {{% /example %}}
/// {{% /examples %}}
class DirectoryKustomize extends pulumi.ComponentResource {
  ...
  /// [args] Arguments used to configure this [DirectoryKustomize]. {@macro pulumi_kustomize_directory_kustomize_args_doc}
