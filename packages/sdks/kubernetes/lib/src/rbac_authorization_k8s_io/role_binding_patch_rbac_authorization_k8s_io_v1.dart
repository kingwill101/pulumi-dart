...
import 'role_binding_patch_args.dart';
...
class RoleBindingPatchRbacAuthorizationK8sIoV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [RoleBindingPatchRbacAuthorizationK8sIoV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RoleBindingPatchRbacAuthorizationK8sIoV1]. {@macro pulumi_rbac_authorization_k8s_io_v1_role_binding_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RoleBindingPatchRbacAuthorizationK8sIoV1(
    String name, {
    RoleBindingPatchArgs? args,
  ...
  /// Creates a typed reference to an existing [RoleBindingPatchRbacAuthorizationK8sIoV1] resource.
  RoleBindingPatchRbacAuthorizationK8sIoV1.reference(String urn)
    : super(
        'kubernetes:rbac.authorization.k8s.io/v1:RoleBindingPatch',
