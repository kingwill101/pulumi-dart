...
class ClusterRoleBindingListRbacAuthorizationK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<ClusterRoleBindingRbacAuthorizationK8sIoV1beta1>> items;
  ...
  const ClusterRoleBindingListRbacAuthorizationK8sIoV1beta1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<ClusterRoleBindingRbacAuthorizationK8sIoV1beta1>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<ClusterRoleBindingRbacAuthorizationK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory ClusterRoleBindingListRbacAuthorizationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterRoleBindingListRbacAuthorizationK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterRoleBindingRbacAuthorizationK8sIoV1beta1>(map['items']!, (value) => ClusterRoleBindingRbacAuthorizationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
