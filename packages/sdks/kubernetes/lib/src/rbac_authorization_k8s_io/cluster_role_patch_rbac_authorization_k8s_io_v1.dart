...
class ClusterRolePatchRbacAuthorizationK8sIoV1 extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ClusterRolePatchRbacAuthorizationK8sIoV1]. {@macro pulumi_rbac_authorization_k8s_io_v1_cluster_role_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ClusterRolePatchRbacAuthorizationK8sIoV1(
    String name, {
    ClusterRolePatchArgs? args,
    ...
    aggregationRule = registerOutput<AggregationRulePatch?>(
      'aggregationRule',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return AggregationRulePatch.fromMap(
