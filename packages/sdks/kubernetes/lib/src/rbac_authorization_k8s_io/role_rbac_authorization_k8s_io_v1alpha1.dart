...
class RoleRbacAuthorizationK8sIoV1alpha1 {
  ...
  /// Creates a new [RoleRbacAuthorizationK8sIoV1alpha1].
  ...
  factory RoleRbacAuthorizationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RoleRbacAuthorizationK8sIoV1alpha1(
