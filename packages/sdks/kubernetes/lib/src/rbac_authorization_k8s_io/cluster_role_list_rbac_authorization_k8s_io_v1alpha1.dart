...
class ClusterRoleListRbacAuthorizationK8sIoV1alpha1 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<ClusterRoleRbacAuthorizationK8sIoV1alpha1>,
  ...
  factory ClusterRoleListRbacAuthorizationK8sIoV1alpha1.fromMap(
    ...
    return ClusterRoleListRbacAuthorizationK8sIoV1alpha1(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClusterRoleRbacAuthorizationK8sIoV1alpha1>(
          map['items']!,
          (value) => ClusterRoleRbacAuthorizationK8sIoV1alpha1.fromMap(
