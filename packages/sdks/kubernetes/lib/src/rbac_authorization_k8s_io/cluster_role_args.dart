...
class ClusterRoleArgs {
  ...
  factory ClusterRoleArgs.fromMap(Map<String, dynamic> map) {
    return ClusterRoleArgs(
      aggregationRule: (() { final guardedValue = map['aggregationRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AggregationRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
