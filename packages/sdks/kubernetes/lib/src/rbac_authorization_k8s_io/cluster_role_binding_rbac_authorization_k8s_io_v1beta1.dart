...
class ClusterRoleBindingRbacAuthorizationK8sIoV1beta1 {
  ...
  /// Creates a new [ClusterRoleBindingRbacAuthorizationK8sIoV1beta1].
  ...
  const ClusterRoleBindingRbacAuthorizationK8sIoV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
  ...
  factory ClusterRoleBindingRbacAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ClusterRoleBindingRbacAuthorizationK8sIoV1beta1(
