...
class ClusterRoleBindingRbacAuthorizationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  ClusterRoleBindingRbacAuthorizationK8sIoV1beta1Resource(
    ...
    this.roleRef = registerOutput<RoleRefRbacAuthorizationK8sIoV1beta1>('roleRef');
    this.subjects = registerOutput<List<SubjectRbacAuthorizationK8sIoV1beta1>>('subjects');
  }
}
