...
class RoleBindingRbacAuthorizationK8sIoV1alpha1Args {
  ...
  const RoleBindingRbacAuthorizationK8sIoV1alpha1Args({
    this.apiVersion,
    this.kind,
    this.metadata,
  ...
  factory RoleBindingRbacAuthorizationK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return RoleBindingRbacAuthorizationK8sIoV1alpha1Args(
      ...
      roleRef: pulumi.Input.fromValue(RoleRefRbacAuthorizationK8sIoV1alpha1.fromMap((map['roleRef']! as Map).cast<String, dynamic>())),
      subjects: (() { final guardedValue = map['subjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubjectRbacAuthorizationK8sIoV1alpha1>(guardedValue, (value) => SubjectRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
