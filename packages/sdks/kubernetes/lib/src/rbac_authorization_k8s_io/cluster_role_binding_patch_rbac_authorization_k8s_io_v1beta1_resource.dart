...
class ClusterRoleBindingPatchRbacAuthorizationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ClusterRoleBindingPatchRbacAuthorizationK8sIoV1beta1Resource] resource.
  ClusterRoleBindingPatchRbacAuthorizationK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:rbac.authorization.k8s.io/v1beta1:ClusterRoleBindingPatch',
