...
class ClusterRoleBindingPatchRbacAuthorizationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  ClusterRoleBindingPatchRbacAuthorizationK8sIoV1beta1Resource(
    ...
    this.roleRef = registerOutput<RoleRefPatchRbacAuthorizationK8sIoV1beta1?>('roleRef');
    this.subjects = registerOutput<List<SubjectPatchRbacAuthorizationK8sIoV1beta1>?>('subjects');
  }
}
