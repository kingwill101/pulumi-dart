...
class ClusterRoleRbacAuthorizationK8sIoV1beta1Args {
  ...
  ClusterRoleRbacAuthorizationK8sIoV1beta1Args({
    pulumi.Output<AggregationRuleRbacAuthorizationK8sIoV1beta1>? aggregationRule,
  ...
  factory ClusterRoleRbacAuthorizationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ClusterRoleRbacAuthorizationK8sIoV1beta1Args(
      aggregationRule: map['aggregationRule'] == null ? null : pulumi.Output.create<AggregationRuleRbacAuthorizationK8sIoV1beta1>(AggregationRuleRbacAuthorizationK8sIoV1beta1.fromMap((map['aggregationRule'] as Map).cast<String, dynamic>())),
