...
class RoleBindingListRbacAuthorizationK8sIoV1alpha1Args {
  ...
  const RoleBindingListRbacAuthorizationK8sIoV1alpha1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory RoleBindingListRbacAuthorizationK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return RoleBindingListRbacAuthorizationK8sIoV1alpha1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<RoleBindingRbacAuthorizationK8sIoV1alpha1>(map['items']!, (value) => RoleBindingRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
