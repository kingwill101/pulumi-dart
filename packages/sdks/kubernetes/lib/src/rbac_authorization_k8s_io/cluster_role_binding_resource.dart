...
class ClusterRoleBindingResource extends pulumi.CustomResource {
  ...
  ClusterRoleBindingResource(
    ...
    this.roleRef = registerOutput<RoleRefRbacAuthorizationK8sIoV1alpha1>('roleRef');
    this.subjects = registerOutput<List<SubjectRbacAuthorizationK8sIoV1alpha1>>('subjects');
  }
}
