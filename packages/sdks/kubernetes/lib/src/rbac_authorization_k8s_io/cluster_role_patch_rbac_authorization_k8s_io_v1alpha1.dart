...
class ClusterRolePatchRbacAuthorizationK8sIoV1alpha1 {
  /// AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.
  final AggregationRulePatchRbacAuthorizationK8sIoV1alpha1? aggregationRule;
  ...
  /// Creates a new [ClusterRolePatchRbacAuthorizationK8sIoV1alpha1].
  ...
  ClusterRolePatchRbacAuthorizationK8sIoV1alpha1({
  ...
  factory ClusterRolePatchRbacAuthorizationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ClusterRolePatchRbacAuthorizationK8sIoV1alpha1(
