...
class ClusterRoleRbacAuthorizationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  ClusterRoleRbacAuthorizationK8sIoV1beta1Resource(
    ...
    this.aggregationRule = registerOutput<AggregationRuleRbacAuthorizationK8sIoV1beta1>('aggregationRule');
    this.apiVersion = registerOutput<String>('apiVersion');
    this.kind = registerOutput<String>('kind');
    this.metadata = registerOutput<ObjectMeta>('metadata');
    this.rules = registerOutput<List<PolicyRuleRbacAuthorizationK8sIoV1beta1>>('rules');
  }
}
