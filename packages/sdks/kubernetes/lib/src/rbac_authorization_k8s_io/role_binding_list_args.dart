...
class RoleBindingListArgs {
  ...
  RoleBindingListArgs({
    ...
    required pulumi.Output<List<RoleBindingRbacAuthorizationK8sIoV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<RoleBindingRbacAuthorizationK8sIoV1>>(items),
  ...
  factory RoleBindingListArgs.fromMap(Map<String, dynamic> map) {
    return RoleBindingListArgs(
      ...
      items: pulumi.Output.create<List<RoleBindingRbacAuthorizationK8sIoV1>>((map['items'] as List).cast<RoleBindingRbacAuthorizationK8sIoV1>()),
