...
class ClusterRoleBindingPatchRbacAuthorizationK8sIoV1alpha1Args {
  ...
  const ClusterRoleBindingPatchRbacAuthorizationK8sIoV1alpha1Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.roleRef,
  ...
  factory ClusterRoleBindingPatchRbacAuthorizationK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ClusterRoleBindingPatchRbacAuthorizationK8sIoV1alpha1Args(
      ...
      roleRef: (() { final guardedValue = map['roleRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoleRefPatchRbacAuthorizationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subjects: (() { final guardedValue = map['subjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubjectPatchRbacAuthorizationK8sIoV1alpha1>(guardedValue, (value) => SubjectPatchRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
