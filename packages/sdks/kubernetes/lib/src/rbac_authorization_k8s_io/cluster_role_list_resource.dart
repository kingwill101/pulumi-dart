...
class ClusterRoleListResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ClusterRoleRbacAuthorizationK8sIoV1alpha1>> items;
  ...
  ClusterRoleListResource(
    ...
    items = registerOutput<List<ClusterRoleRbacAuthorizationK8sIoV1alpha1>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ClusterRoleRbacAuthorizationK8sIoV1alpha1>(guardedValue, (value) => ClusterRoleRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [ClusterRoleListResource] resource.
  ClusterRoleListResource.reference(String urn)
    : super(
        'kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleList',
