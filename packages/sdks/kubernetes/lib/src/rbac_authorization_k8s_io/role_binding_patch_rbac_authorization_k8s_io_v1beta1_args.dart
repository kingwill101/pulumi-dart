...
/// {@template pulumi_rbac_authorization_k8s_io_v1beta1_role_binding_patch_rbac_authorization_k8s_io_v1beta1_args_doc}
/// The set of arguments for RoleBindingPatch.
/// {@endtemplate}
/// {@macro pulumi_rbac_authorization_k8s_io_v1beta1_role_binding_patch_rbac_authorization_k8s_io_v1beta1_args_doc}
class RoleBindingPatchRbacAuthorizationK8sIoV1beta1Args {
  ...
  /// Creates a new [RoleBindingPatchRbacAuthorizationK8sIoV1beta1Args].
  ...
  RoleBindingPatchRbacAuthorizationK8sIoV1beta1Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMetaPatch>? metadata,
    pulumi.Output<RoleRefPatchRbacAuthorizationK8sIoV1beta1>? roleRef,
    pulumi.Output<List<SubjectPatchRbacAuthorizationK8sIoV1beta1>>? subjects,
  }) :
  ...
  factory RoleBindingPatchRbacAuthorizationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RoleBindingPatchRbacAuthorizationK8sIoV1beta1Args(
      ...
      roleRef: map['roleRef'] == null ? null : pulumi.Output.create<RoleRefPatchRbacAuthorizationK8sIoV1beta1>(RoleRefPatchRbacAuthorizationK8sIoV1beta1.fromMap((map['roleRef'] as Map).cast<String, dynamic>())),
      subjects: map['subjects'] == null ? null : pulumi.Output.create<List<SubjectPatchRbacAuthorizationK8sIoV1beta1>>(pulumi.Input.decodeList<SubjectPatchRbacAuthorizationK8sIoV1beta1>(map['subjects'], (value) => SubjectPatchRbacAuthorizationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
