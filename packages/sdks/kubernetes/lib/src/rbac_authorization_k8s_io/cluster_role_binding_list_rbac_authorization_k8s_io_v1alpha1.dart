...
class ClusterRoleBindingListRbacAuthorizationK8sIoV1alpha1 {
  ...
  final pulumi.Input<List<ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1>>
  items;
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1>,
  ...
  factory ClusterRoleBindingListRbacAuthorizationK8sIoV1alpha1.fromMap(
    ...
    return ClusterRoleBindingListRbacAuthorizationK8sIoV1alpha1(
      ...
      items: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1>(
          map['items']!,
          (value) => ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1.fromMap(
