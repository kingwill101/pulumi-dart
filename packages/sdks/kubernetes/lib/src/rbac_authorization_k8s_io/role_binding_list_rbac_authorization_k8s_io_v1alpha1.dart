...
class RoleBindingListRbacAuthorizationK8sIoV1alpha1 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<RoleBindingRbacAuthorizationK8sIoV1alpha1>,
  ...
  factory RoleBindingListRbacAuthorizationK8sIoV1alpha1.fromMap(
    ...
    return RoleBindingListRbacAuthorizationK8sIoV1alpha1(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RoleBindingRbacAuthorizationK8sIoV1alpha1>(
          map['items']!,
          (value) => RoleBindingRbacAuthorizationK8sIoV1alpha1.fromMap(
