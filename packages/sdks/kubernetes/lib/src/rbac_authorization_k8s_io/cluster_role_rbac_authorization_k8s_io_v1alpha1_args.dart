...
class ClusterRoleRbacAuthorizationK8sIoV1alpha1Args {
  ...
  final pulumi.Input<AggregationRuleRbacAuthorizationK8sIoV1alpha1>?
  aggregationRule;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyRuleRbacAuthorizationK8sIoV1alpha1>,
            List<Map<String, dynamic>>
          >(
            rules,
            (value) =>
                pulumi.Input.encodeList<
                  PolicyRuleRbacAuthorizationK8sIoV1alpha1,
                  Map<String, dynamic>
  ...
  factory ClusterRoleRbacAuthorizationK8sIoV1alpha1Args.fromMap(
    ...
    return ClusterRoleRbacAuthorizationK8sIoV1alpha1Args(
      aggregationRule: (() {
        ...
        return pulumi.Input.fromValue(
          AggregationRuleRbacAuthorizationK8sIoV1alpha1.fromMap(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyRuleRbacAuthorizationK8sIoV1alpha1>(
            guardedValue,
            (value) => PolicyRuleRbacAuthorizationK8sIoV1alpha1.fromMap(
