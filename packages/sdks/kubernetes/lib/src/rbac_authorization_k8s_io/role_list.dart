...
class RoleList {
  ...
  RoleList({this.apiVersion, required this.items, this.kind, this.metadata});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiVersion': ?apiVersion,
      'items':
          pulumi.Input.mapInputValue<List<Role>, List<Map<String, dynamic>>>(
            items,
