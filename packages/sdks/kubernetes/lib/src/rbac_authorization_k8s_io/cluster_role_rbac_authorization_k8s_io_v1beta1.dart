...
class ClusterRoleRbacAuthorizationK8sIoV1beta1 {
  ...
  const ClusterRoleRbacAuthorizationK8sIoV1beta1({
  ...
  factory ClusterRoleRbacAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ClusterRoleRbacAuthorizationK8sIoV1beta1(
      aggregationRule: (() { final guardedValue = map['aggregationRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AggregationRuleRbacAuthorizationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
