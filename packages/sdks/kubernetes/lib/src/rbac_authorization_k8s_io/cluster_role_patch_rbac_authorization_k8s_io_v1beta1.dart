...
class ClusterRolePatchRbacAuthorizationK8sIoV1beta1 {
  ...
  factory ClusterRolePatchRbacAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ClusterRolePatchRbacAuthorizationK8sIoV1beta1(
      aggregationRule: map['aggregationRule'] == null ? null : (AggregationRulePatchRbacAuthorizationK8sIoV1beta1.fromMap((map['aggregationRule']! as Map).cast<String, dynamic>())).input(),
