...
class ClusterRoleBindingPatchArgs {
  ...
  ClusterRoleBindingPatchArgs({
    ...
    pulumi.Output<RoleRefPatch>? roleRef,
    pulumi.Output<List<SubjectPatch>>? subjects,
  }) :
  ...
  factory ClusterRoleBindingPatchArgs.fromMap(Map<String, dynamic> map) {
    return ClusterRoleBindingPatchArgs(
      ...
      roleRef: map['roleRef'] == null ? null : pulumi.Output.create<RoleRefPatch>(RoleRefPatch.fromMap((map['roleRef'] as Map).cast<String, dynamic>())),
      subjects: map['subjects'] == null ? null : pulumi.Output.create<List<SubjectPatch>>(pulumi.Input.decodeList<SubjectPatch>(map['subjects'], (value) => SubjectPatch.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
