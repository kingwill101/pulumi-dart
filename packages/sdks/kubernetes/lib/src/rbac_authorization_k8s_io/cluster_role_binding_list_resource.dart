...
class ClusterRoleBindingListResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1>> items;
  ...
  ClusterRoleBindingListResource(
    ...
    items = registerOutput<List<ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1>(guardedValue, (value) => ClusterRoleBindingRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [ClusterRoleBindingListResource] resource.
  ClusterRoleBindingListResource.reference(String urn)
    : super(
        'kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList',
