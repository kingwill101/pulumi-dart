...
class RoleBindingListRbacAuthorizationK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<RoleBindingRbacAuthorizationK8sIoV1beta1Resource>>
  items;
  ...
  factory RoleBindingListRbacAuthorizationK8sIoV1beta1Args.fromMap(
    ...
    return RoleBindingListRbacAuthorizationK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<RoleBindingRbacAuthorizationK8sIoV1beta1Resource>(),
      ),
      kind: (() {
