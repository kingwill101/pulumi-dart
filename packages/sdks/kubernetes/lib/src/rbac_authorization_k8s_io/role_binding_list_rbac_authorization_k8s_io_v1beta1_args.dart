...
import 'role_binding_rbac_authorization_k8s_io_v1beta1.dart';
...
class RoleBindingListRbacAuthorizationK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<RoleBindingRbacAuthorizationK8sIoV1beta1>> items;
  ...
  const RoleBindingListRbacAuthorizationK8sIoV1beta1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<RoleBindingRbacAuthorizationK8sIoV1beta1>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<RoleBindingRbacAuthorizationK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory RoleBindingListRbacAuthorizationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RoleBindingListRbacAuthorizationK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<RoleBindingRbacAuthorizationK8sIoV1beta1>(map['items']!, (value) => RoleBindingRbacAuthorizationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
