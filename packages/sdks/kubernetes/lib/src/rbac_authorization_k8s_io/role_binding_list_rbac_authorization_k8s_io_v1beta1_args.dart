...
class RoleBindingListRbacAuthorizationK8sIoV1beta1Args {
  ...
  RoleBindingListRbacAuthorizationK8sIoV1beta1Args({
    ...
    required pulumi.Output<List<RoleBindingRbacAuthorizationK8sIoV1beta1Resource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<RoleBindingRbacAuthorizationK8sIoV1beta1Resource>>(items),
  ...
  factory RoleBindingListRbacAuthorizationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return RoleBindingListRbacAuthorizationK8sIoV1beta1Args(
      ...
      items: pulumi.Output.create<List<RoleBindingRbacAuthorizationK8sIoV1beta1Resource>>((map['items'] as List).cast<RoleBindingRbacAuthorizationK8sIoV1beta1Resource>()),
