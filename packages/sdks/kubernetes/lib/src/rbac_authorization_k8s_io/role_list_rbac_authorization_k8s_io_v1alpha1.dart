...
class RoleListRbacAuthorizationK8sIoV1alpha1 {
  ...
  final List<RoleRbacAuthorizationK8sIoV1alpha1> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<RoleRbacAuthorizationK8sIoV1alpha1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory RoleListRbacAuthorizationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return RoleListRbacAuthorizationK8sIoV1alpha1(
      ...
      items: pulumi.Input.decodeList<RoleRbacAuthorizationK8sIoV1alpha1>(map['items'], (value) => RoleRbacAuthorizationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
