...
class RoleListRbacAuthorizationK8sIoV1alpha1 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<RoleRbacAuthorizationK8sIoV1alpha1>,
            List<Map<String, dynamic>>
          >(
            items,
            (value) =>
                pulumi.Input.encodeList<
                  RoleRbacAuthorizationK8sIoV1alpha1,
                  Map<String, dynamic>
  ...
  factory RoleListRbacAuthorizationK8sIoV1alpha1.fromMap(
    ...
    return RoleListRbacAuthorizationK8sIoV1alpha1(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RoleRbacAuthorizationK8sIoV1alpha1>(
          map['items']!,
          (value) => RoleRbacAuthorizationK8sIoV1alpha1.fromMap(
