...
class CustomResourceConversionApiextensionsK8sIoV1beta1 {
  ...
  final WebhookClientConfigApiextensionsK8sIoV1beta1? webhookClientConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'strategy': strategy,
      'webhookClientConfig': ?webhookClientConfig == null ? null : webhookClientConfig!.toMap(),
    };
  }
  ...
  factory CustomResourceConversionApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceConversionApiextensionsK8sIoV1beta1(
      ...
      webhookClientConfig: map['webhookClientConfig'] == null ? null : WebhookClientConfigApiextensionsK8sIoV1beta1.fromMap((map['webhookClientConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
