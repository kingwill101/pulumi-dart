...
class CustomResourceConversionApiextensionsK8sIoV1beta1 {
  ...
  const CustomResourceConversionApiextensionsK8sIoV1beta1({
  ...
  factory CustomResourceConversionApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceConversionApiextensionsK8sIoV1beta1(
      ...
      webhookClientConfig: (() { final guardedValue = map['webhookClientConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebhookClientConfigApiextensionsK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
