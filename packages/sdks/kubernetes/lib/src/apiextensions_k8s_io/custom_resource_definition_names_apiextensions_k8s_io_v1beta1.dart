...
class CustomResourceDefinitionNamesApiextensionsK8sIoV1beta1 {
  ...
  const CustomResourceDefinitionNamesApiextensionsK8sIoV1beta1({
    this.categories,
    required this.kind,
    this.listKind,
  ...
  factory CustomResourceDefinitionNamesApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionNamesApiextensionsK8sIoV1beta1(
      ...
      listKind: (() { final guardedValue = map['listKind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      plural: pulumi.Input.fromValue(map['plural'] as String),
