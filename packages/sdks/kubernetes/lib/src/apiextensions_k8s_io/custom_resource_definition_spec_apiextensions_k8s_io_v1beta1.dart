...
class CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1 {
  ...
  final CustomResourceConversionApiextensionsK8sIoV1beta1? conversion;
  /// group is the API group of the defined custom resource. The custom resources are served under `/apis/<group>/...`. Must match the name of the CustomResourceDefinition (in the form `<names.plural>.<group>`).
  final String group;
  /// names specify the resource and kind names for the custom resource.
  final CustomResourceDefinitionNamesApiextensionsK8sIoV1beta1 names;
  ...
  final CustomResourceValidationApiextensionsK8sIoV1beta1? validation;
  ...
  final List<CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1>? versions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'version': ?version,
      'versions': ?versions == null ? null : pulumi.Input.encodeList<CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1, Map<String, dynamic>>(versions!, (value) => value.toMap()),
    };
  }
  ...
  factory CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1(
      ...
      conversion: map['conversion'] == null ? null : CustomResourceConversionApiextensionsK8sIoV1beta1.fromMap((map['conversion'] as Map).cast<String, dynamic>()),
      group: map['group'] as String,
      names: CustomResourceDefinitionNamesApiextensionsK8sIoV1beta1.fromMap((map['names'] as Map).cast<String, dynamic>()),
      ...
      validation: map['validation'] == null ? null : CustomResourceValidationApiextensionsK8sIoV1beta1.fromMap((map['validation'] as Map).cast<String, dynamic>()),
      version: map['version'] == null ? null : map['version'] as String,
      versions: map['versions'] == null ? null : pulumi.Input.decodeList<CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1>(map['versions'], (value) => CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
