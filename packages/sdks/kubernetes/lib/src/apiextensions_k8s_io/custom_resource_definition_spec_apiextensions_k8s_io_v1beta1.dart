...
class CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1 {
  ...
  const CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1({
  ...
  factory CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1(
      ...
      conversion: (() { final guardedValue = map['conversion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomResourceConversionApiextensionsK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      group: pulumi.Input.fromValue(map['group'] as String),
      names: pulumi.Input.fromValue(CustomResourceDefinitionNamesApiextensionsK8sIoV1beta1.fromMap((map['names']! as Map).cast<String, dynamic>())),
      ...
      validation: (() { final guardedValue = map['validation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomResourceValidationApiextensionsK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      version: (() { final guardedValue = map['version']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      versions: (() { final guardedValue = map['versions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1>(guardedValue, (value) => CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
