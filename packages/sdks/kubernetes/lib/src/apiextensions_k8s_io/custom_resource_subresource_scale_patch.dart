...
class CustomResourceSubresourceScalePatch {
  ...
  /// Creates a new [CustomResourceSubresourceScalePatch].
  ...
  factory CustomResourceSubresourceScalePatch.fromMap(
    ...
    return CustomResourceSubresourceScalePatch(
      ...
      specReplicasPath: (() {
        final guardedValue = map['specReplicasPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      statusReplicasPath: (() {
        final guardedValue = map['statusReplicasPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
