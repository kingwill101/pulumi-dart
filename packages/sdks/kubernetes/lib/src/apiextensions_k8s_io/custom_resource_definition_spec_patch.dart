...
class CustomResourceDefinitionSpecPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'versions':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomResourceDefinitionVersionPatch>,
    ...
    return CustomResourceDefinitionSpecPatch(
      conversion: (() {
        ...
        return pulumi.Input.fromValue(
          CustomResourceConversionPatch.fromMap(
      ...
      versions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomResourceDefinitionVersionPatch>(
            guardedValue,
            (value) => CustomResourceDefinitionVersionPatch.fromMap(
