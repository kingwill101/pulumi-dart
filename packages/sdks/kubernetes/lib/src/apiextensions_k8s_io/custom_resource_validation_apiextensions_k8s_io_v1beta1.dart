...
class CustomResourceValidationApiextensionsK8sIoV1beta1 {
  ...
  final JSONSchemaPropsApiextensionsK8sIoV1beta1? openAPIV3Schema;
  ...
  factory CustomResourceValidationApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceValidationApiextensionsK8sIoV1beta1(
      openAPIV3Schema: map['openAPIV3Schema'] == null ? null : JSONSchemaPropsApiextensionsK8sIoV1beta1.fromMap((map['openAPIV3Schema'] as Map).cast<String, dynamic>()),
    );
  }
}
