...
import 'service_reference_patch_apiextensions_k8s_io_v1beta1.dart';
...
class WebhookClientConfigPatchApiextensionsK8sIoV1beta1 {
  ...
  final ServiceReferencePatchApiextensionsK8sIoV1beta1? service;
  ...
  /// Creates a new [WebhookClientConfigPatchApiextensionsK8sIoV1beta1].
  ...
  factory WebhookClientConfigPatchApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return WebhookClientConfigPatchApiextensionsK8sIoV1beta1(
      ...
      service: map['service'] == null ? null : ServiceReferencePatchApiextensionsK8sIoV1beta1.fromMap((map['service'] as Map).cast<String, dynamic>()),
