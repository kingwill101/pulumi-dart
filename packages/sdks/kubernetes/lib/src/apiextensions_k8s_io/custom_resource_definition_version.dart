...
class CustomResourceDefinitionVersion {
  ...
  final pulumi.Input<List<CustomResourceColumnDefinition>>?
    ...
    return <String, dynamic>{
      ...
      'selectableFields':
          ...
          >(
            selectableFields,
            (value) =>
                pulumi.Input.encodeList<SelectableField, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return CustomResourceDefinitionVersion(
      additionalPrinterColumns: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomResourceColumnDefinition>(
            guardedValue,
            (value) => CustomResourceColumnDefinition.fromMap(
      ...
      schema: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceValidation.fromMap(
      ...
      selectableFields: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SelectableField>(
            guardedValue,
            (value) =>
                SelectableField.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      subresources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceSubresources.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
