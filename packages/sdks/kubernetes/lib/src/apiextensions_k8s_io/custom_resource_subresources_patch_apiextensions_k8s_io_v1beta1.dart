...
class CustomResourceSubresourcesPatchApiextensionsK8sIoV1beta1 {
  ...
  const CustomResourceSubresourcesPatchApiextensionsK8sIoV1beta1({
    this.scale,
    this.status,
  });
  ...
  factory CustomResourceSubresourcesPatchApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceSubresourcesPatchApiextensionsK8sIoV1beta1(
      scale: (() { final guardedValue = map['scale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomResourceSubresourceScalePatchApiextensionsK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
