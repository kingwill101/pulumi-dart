...
class CustomResourceDefinitionListApiextensionsK8sIoV1beta1 {
  ...
  /// Creates a new [CustomResourceDefinitionListApiextensionsK8sIoV1beta1].
  ...
  /// [metadata] Optional.
  CustomResourceDefinitionListApiextensionsK8sIoV1beta1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory CustomResourceDefinitionListApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionListApiextensionsK8sIoV1beta1(
      apiVersion: map['apiVersion'] == null ? null : (map['apiVersion'] as String).input(),
      items: (pulumi.Input.decodeList<CustomResourceDefinitionApiextensionsK8sIoV1beta1>(map['items'], (value) => CustomResourceDefinitionApiextensionsK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
