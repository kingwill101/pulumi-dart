...
class CustomResourceSubresourceScale {
  ...
  /// Creates a new [CustomResourceSubresourceScale].
  ...
  factory CustomResourceSubresourceScale.fromMap(Map<String, dynamic> map) {
    return CustomResourceSubresourceScale(
      labelSelectorPath: (() {
        final guardedValue = map['labelSelectorPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      specReplicasPath: pulumi.Input.fromValue(
        map['specReplicasPath'] as String,
      ),
      statusReplicasPath: pulumi.Input.fromValue(
        map['statusReplicasPath'] as String,
      ),
    );
  }
}
