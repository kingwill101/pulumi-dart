...
class CustomResourceConversionPatchApiextensionsK8sIoV1beta1 {
  ...
  final pulumi.Input<WebhookClientConfigPatchApiextensionsK8sIoV1beta1>?
  webhookClientConfig;
    ...
    return <String, dynamic>{
      ...
      'webhookClientConfig':
          ?pulumi.Input.mapOptionalInputValue<
            WebhookClientConfigPatchApiextensionsK8sIoV1beta1,
            Map<String, dynamic>
          >(webhookClientConfig, (value) => value.toMap()),
    };
  }

  factory CustomResourceConversionPatchApiextensionsK8sIoV1beta1.fromMap(
    ...
    return CustomResourceConversionPatchApiextensionsK8sIoV1beta1(
      ...
      webhookClientConfig: (() {
        final guardedValue = map['webhookClientConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WebhookClientConfigPatchApiextensionsK8sIoV1beta1.fromMap(
