...
class WebhookClientConfigApiextensionsK8sIoV1beta1 {
  ...
  final ServiceReferenceApiextensionsK8sIoV1beta1? service;
  ...
  factory WebhookClientConfigApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return WebhookClientConfigApiextensionsK8sIoV1beta1(
      ...
      service: map['service'] == null ? null : ServiceReferenceApiextensionsK8sIoV1beta1.fromMap((map['service'] as Map).cast<String, dynamic>()),
