...
class WebhookClientConfigApiextensionsK8sIoV1beta1 {
    ...
    return <String, dynamic>{
      ...
      'service':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceReferenceApiextensionsK8sIoV1beta1,
            Map<String, dynamic>
  ...
  factory WebhookClientConfigApiextensionsK8sIoV1beta1.fromMap(
    ...
    return WebhookClientConfigApiextensionsK8sIoV1beta1(
      ...
      service: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceReferenceApiextensionsK8sIoV1beta1.fromMap(
