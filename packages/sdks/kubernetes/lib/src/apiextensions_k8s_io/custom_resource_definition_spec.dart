...
class CustomResourceDefinitionSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scope': scope,
      'versions': pulumi.Input.encodeList<CustomResourceDefinitionVersion, Map<String, dynamic>>(versions, (value) => value.toMap()),
    };
  }

  factory CustomResourceDefinitionSpec.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionSpec(
      conversion: map['conversion'] == null ? null : CustomResourceConversion.fromMap((map['conversion'] as Map).cast<String, dynamic>()),
      group: map['group'] as String,
      names: CustomResourceDefinitionNames.fromMap((map['names'] as Map).cast<String, dynamic>()),
      preserveUnknownFields: map['preserveUnknownFields'] == null ? null : map['preserveUnknownFields'] as bool,
      scope: map['scope'] as String,
      versions: pulumi.Input.decodeList<CustomResourceDefinitionVersion>(map['versions'], (value) => CustomResourceDefinitionVersion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
