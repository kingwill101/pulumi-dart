...
class CustomResourceDefinitionSpec {
  ...
  factory CustomResourceDefinitionSpec.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionSpec(
      conversion: (() { final guardedValue = map['conversion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomResourceConversion.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      group: pulumi.Input.fromValue(map['group'] as String),
      names: pulumi.Input.fromValue(CustomResourceDefinitionNames.fromMap((map['names']! as Map).cast<String, dynamic>())),
      ...
      versions: pulumi.Input.fromValue(pulumi.Input.decodeList<CustomResourceDefinitionVersion>(map['versions']!, (value) => CustomResourceDefinitionVersion.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
