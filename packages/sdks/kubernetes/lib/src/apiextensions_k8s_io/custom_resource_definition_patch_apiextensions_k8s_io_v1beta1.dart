...
class CustomResourceDefinitionPatchApiextensionsK8sIoV1beta1 {
  ...
  factory CustomResourceDefinitionPatchApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionPatchApiextensionsK8sIoV1beta1(
      ...
      spec: map['spec'] == null ? null : (CustomResourceDefinitionSpecPatchApiextensionsK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (CustomResourceDefinitionStatusPatchApiextensionsK8sIoV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
