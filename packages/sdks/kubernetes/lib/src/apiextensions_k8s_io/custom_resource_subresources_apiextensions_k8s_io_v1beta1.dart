...
import 'custom_resource_subresource_scale_apiextensions_k8s_io_v1beta1.dart';
...
class CustomResourceSubresourcesApiextensionsK8sIoV1beta1 {
  ...
  /// Creates a new [CustomResourceSubresourcesApiextensionsK8sIoV1beta1].
  ...
  const CustomResourceSubresourcesApiextensionsK8sIoV1beta1({
    this.scale,
    this.status,
  });
  ...
  factory CustomResourceSubresourcesApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceSubresourcesApiextensionsK8sIoV1beta1(
      scale: (() { final guardedValue = map['scale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomResourceSubresourceScaleApiextensionsK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
