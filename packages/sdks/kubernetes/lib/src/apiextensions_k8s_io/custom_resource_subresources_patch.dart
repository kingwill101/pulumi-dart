...
class CustomResourceSubresourcesPatch {
  ...
  const CustomResourceSubresourcesPatch({
    this.scale,
    this.status,
  });
  ...
  factory CustomResourceSubresourcesPatch.fromMap(Map<String, dynamic> map) {
    return CustomResourceSubresourcesPatch(
      scale: (() { final guardedValue = map['scale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomResourceSubresourceScalePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
