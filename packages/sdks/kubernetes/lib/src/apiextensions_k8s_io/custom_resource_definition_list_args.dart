...
class CustomResourceDefinitionListArgs {
  ...
  CustomResourceDefinitionListArgs({
    ...
    required pulumi.Output<List<CustomResourceDefinitionApiextensionsK8sIoV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<CustomResourceDefinitionApiextensionsK8sIoV1>>(items),
  ...
  factory CustomResourceDefinitionListArgs.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionListArgs(
      ...
      items: pulumi.Output.create<List<CustomResourceDefinitionApiextensionsK8sIoV1>>((map['items'] as List).cast<CustomResourceDefinitionApiextensionsK8sIoV1>()),
