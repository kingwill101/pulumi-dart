...
class CustomResourceDefinitionNamesPatchApiextensionsK8sIoV1beta1 {
  ...
  const CustomResourceDefinitionNamesPatchApiextensionsK8sIoV1beta1({
    this.categories,
    this.kind,
    this.listKind,
    this.plural,
  ...
  factory CustomResourceDefinitionNamesPatchApiextensionsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionNamesPatchApiextensionsK8sIoV1beta1(
      ...
      plural: (() { final guardedValue = map['plural']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
