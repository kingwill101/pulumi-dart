...
class CustomResourceDefinitionListApiextensionsK8sIoV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CustomResourceDefinition>> items;
  ...
  CustomResourceDefinitionListApiextensionsK8sIoV1(
    ...
    items = registerOutput<List<CustomResourceDefinition>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<CustomResourceDefinition>(guardedValue, (value) => CustomResourceDefinition.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [CustomResourceDefinitionListApiextensionsK8sIoV1] resource.
  CustomResourceDefinitionListApiextensionsK8sIoV1.reference(String urn)
    : super(
        'kubernetes:apiextensions.k8s.io/v1:CustomResourceDefinitionList',
