...
class ValidationRulePatch {
  ...
  final pulumi.Input<bool>? optionalOldSelf;
  ...
  /// Creates a new [ValidationRulePatch].
  ...
  factory ValidationRulePatch.fromMap(Map<String, dynamic> map) {
    return ValidationRulePatch(
      ...
      optionalOldSelf: (() { final guardedValue = map['optionalOldSelf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
