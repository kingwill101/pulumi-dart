...
class CustomResourceDefinitionApiextensionsK8sIoV1beta1 {
  ...
  final pulumi.Input<CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1>
  spec;

  /// status indicates the actual state of the CustomResourceDefinition
  final pulumi.Input<CustomResourceDefinitionStatusApiextensionsK8sIoV1beta1>?
  status;
  ...
  factory CustomResourceDefinitionApiextensionsK8sIoV1beta1.fromMap(
    ...
    return CustomResourceDefinitionApiextensionsK8sIoV1beta1(
      ...
      spec: pulumi.Input.fromValue(
        CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceDefinitionStatusApiextensionsK8sIoV1beta1.fromMap(
