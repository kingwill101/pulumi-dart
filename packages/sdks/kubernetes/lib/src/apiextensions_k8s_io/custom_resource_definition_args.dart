...
class CustomResourceDefinitionArgs {
  ...
  CustomResourceDefinitionArgs({
    ...
    required pulumi.Output<CustomResourceDefinitionSpec> spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<CustomResourceDefinitionSpec>(spec);
  ...
  factory CustomResourceDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionArgs(
      ...
      spec: pulumi.Output.create<CustomResourceDefinitionSpec>(CustomResourceDefinitionSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
