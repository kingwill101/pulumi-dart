...
class CustomResourceDefinitionVersionPatch {
  ...
  final List<CustomResourceColumnDefinitionPatch>? additionalPrinterColumns;
  ...
  final CustomResourceValidationPatch? schema;
  /// selectableFields specifies paths to fields that may be used as field selectors. A maximum of 8 selectable fields are allowed. See https://kubernetes.io/docs/concepts/overview/working-with-objects/field-selectors
  final List<SelectableFieldPatch>? selectableFields;
  /// served is a flag enabling/disabling this version from being served via REST APIs
  final bool? served;
  /// storage indicates this version should be used when persisting custom resources to storage. There must be exactly one version with storage=true.
  final bool? storage;
  /// subresources specify what subresources this version of the defined custom resource have.
  final CustomResourceSubresourcesPatch? subresources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalPrinterColumns': ?additionalPrinterColumns == null ? null : pulumi.Input.encodeList<CustomResourceColumnDefinitionPatch, Map<String, dynamic>>(additionalPrinterColumns!, (value) => value.toMap()),
      'deprecated': ?deprecated,
      'deprecationWarning': ?deprecationWarning,
      'name': ?name,
      'schema': ?schema == null ? null : schema!.toMap(),
      'selectableFields': ?selectableFields == null ? null : pulumi.Input.encodeList<SelectableFieldPatch, Map<String, dynamic>>(selectableFields!, (value) => value.toMap()),
      'served': ?served,
      'storage': ?storage,
  ...
  factory CustomResourceDefinitionVersionPatch.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionVersionPatch(
      additionalPrinterColumns: map['additionalPrinterColumns'] == null ? null : pulumi.Input.decodeList<CustomResourceColumnDefinitionPatch>(map['additionalPrinterColumns'], (value) => CustomResourceColumnDefinitionPatch.fromMap((value as Map).cast<String, dynamic>())),
      ...
      schema: map['schema'] == null ? null : CustomResourceValidationPatch.fromMap((map['schema'] as Map).cast<String, dynamic>()),
      selectableFields: map['selectableFields'] == null ? null : pulumi.Input.decodeList<SelectableFieldPatch>(map['selectableFields'], (value) => SelectableFieldPatch.fromMap((value as Map).cast<String, dynamic>())),
      served: map['served'] == null ? null : map['served'] as bool,
      storage: map['storage'] == null ? null : map['storage'] as bool,
      subresources: map['subresources'] == null ? null : CustomResourceSubresourcesPatch.fromMap((map['subresources'] as Map).cast<String, dynamic>()),
    );
  }
}
