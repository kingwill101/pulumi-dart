...
class CustomResourceDefinitionVersionPatch {
  ...
  final pulumi.Input<List<CustomResourceColumnDefinitionPatch>>?
    ...
    return <String, dynamic>{
      'additionalPrinterColumns':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomResourceColumnDefinitionPatch>,
      ...
      'subresources':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(subresources, (value) => value.toMap()),
    };
  }

  factory CustomResourceDefinitionVersionPatch.fromMap(
    Map<String, dynamic> map,
  ) {
    return CustomResourceDefinitionVersionPatch(
      additionalPrinterColumns: (() {
        final guardedValue = map['additionalPrinterColumns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomResourceColumnDefinitionPatch>(
            guardedValue,
            (value) => CustomResourceColumnDefinitionPatch.fromMap(
      ...
      deprecationWarning: (() {
        final guardedValue = map['deprecationWarning'];
        if (guardedValue == null) return null;
      ...
      schema: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceValidationPatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      selectableFields: (() {
        final guardedValue = map['selectableFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SelectableFieldPatch>(
            guardedValue,
            (value) => SelectableFieldPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      subresources: (() {
        final guardedValue = map['subresources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceSubresourcesPatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
