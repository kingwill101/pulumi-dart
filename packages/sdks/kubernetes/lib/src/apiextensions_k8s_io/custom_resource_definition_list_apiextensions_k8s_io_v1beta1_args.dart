...
class CustomResourceDefinitionListApiextensionsK8sIoV1beta1Args {
  ...
  /// [metadata] Optional.
  CustomResourceDefinitionListApiextensionsK8sIoV1beta1Args({
    pulumi.Output<String>? apiVersion,
    required pulumi.Output<List<CustomResourceDefinitionResource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<CustomResourceDefinitionResource>>(items),
  ...
  factory CustomResourceDefinitionListApiextensionsK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionListApiextensionsK8sIoV1beta1Args(
      ...
      items: pulumi.Output.create<List<CustomResourceDefinitionResource>>((map['items'] as List).cast<CustomResourceDefinitionResource>()),
