...
class CustomResourceDefinitionApiextensionsK8sIoV1beta1Args {
  ...
  CustomResourceDefinitionApiextensionsK8sIoV1beta1Args({
    ...
    required pulumi.Output<CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1> spec,
  }) :
  ...
  factory CustomResourceDefinitionApiextensionsK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionApiextensionsK8sIoV1beta1Args(
      ...
      spec: pulumi.Output.create<CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1>(CustomResourceDefinitionSpecApiextensionsK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
