...
class CustomResourceDefinitionSpecPatchApiextensionsK8sIoV1beta1 {
  ...
  final pulumi.Input<CustomResourceConversionPatchApiextensionsK8sIoV1beta1>?
  conversion;
  ...
  final pulumi.Input<CustomResourceSubresourcesPatchApiextensionsK8sIoV1beta1>?
  subresources;

  /// validation describes the schema used for validation and pruning of the custom resource. If present, this validation schema is used to validate all versions. Top-level and per-version schemas are mutually exclusive.
  final pulumi.Input<CustomResourceValidationPatchApiextensionsK8sIoV1beta1>?
  validation;
  ...
  final pulumi.Input<
    List<CustomResourceDefinitionVersionPatchApiextensionsK8sIoV1beta1>
  >?
  versions;
  ...
  factory CustomResourceDefinitionSpecPatchApiextensionsK8sIoV1beta1.fromMap(
    ...
    return CustomResourceDefinitionSpecPatchApiextensionsK8sIoV1beta1(
      additionalPrinterColumns: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CustomResourceColumnDefinitionPatchApiextensionsK8sIoV1beta1.fromMap(
      ...
      conversion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceConversionPatchApiextensionsK8sIoV1beta1.fromMap(
      ...
      subresources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceSubresourcesPatchApiextensionsK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      validation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceValidationPatchApiextensionsK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      versions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CustomResourceDefinitionVersionPatchApiextensionsK8sIoV1beta1.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
