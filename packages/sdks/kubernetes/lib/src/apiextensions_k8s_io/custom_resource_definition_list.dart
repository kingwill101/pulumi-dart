...
class CustomResourceDefinitionList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<CustomResourceDefinition, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory CustomResourceDefinitionList.fromMap(Map<String, dynamic> map) {
    return CustomResourceDefinitionList(
      ...
      items: pulumi.Input.decodeList<CustomResourceDefinition>(map['items'], (value) => CustomResourceDefinition.fromMap((value as Map).cast<String, dynamic>())),
