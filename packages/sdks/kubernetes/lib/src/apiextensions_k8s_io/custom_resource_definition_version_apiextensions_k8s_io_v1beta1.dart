...
class CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<CustomResourceColumnDefinitionApiextensionsK8sIoV1beta1>
  >?
  ...
  final pulumi.Input<CustomResourceSubresourcesApiextensionsK8sIoV1beta1>?
  subresources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subresources':
          ?pulumi.Input.mapOptionalInputValue<
            CustomResourceSubresourcesApiextensionsK8sIoV1beta1,
            Map<String, dynamic>
          >(subresources, (value) => value.toMap()),
    };
  }

  factory CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1.fromMap(
    ...
    return CustomResourceDefinitionVersionApiextensionsK8sIoV1beta1(
      additionalPrinterColumns: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CustomResourceColumnDefinitionApiextensionsK8sIoV1beta1.fromMap(
      ...
      schema: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceValidationApiextensionsK8sIoV1beta1.fromMap(
      ...
      subresources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceSubresourcesApiextensionsK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
