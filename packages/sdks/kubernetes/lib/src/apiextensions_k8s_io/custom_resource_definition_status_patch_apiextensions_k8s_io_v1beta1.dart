...
class CustomResourceDefinitionStatusPatchApiextensionsK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<CustomResourceDefinitionConditionPatchApiextensionsK8sIoV1beta1>
  >?
  conditions;
  ...
  factory CustomResourceDefinitionStatusPatchApiextensionsK8sIoV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return CustomResourceDefinitionStatusPatchApiextensionsK8sIoV1beta1(
      acceptedNames: (() {
        final guardedValue = map['acceptedNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomResourceDefinitionNamesPatchApiextensionsK8sIoV1beta1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CustomResourceDefinitionConditionPatchApiextensionsK8sIoV1beta1.fromMap(
      ...
      storedVersions: (() {
        final guardedValue = map['storedVersions'];
        if (guardedValue == null) return null;
