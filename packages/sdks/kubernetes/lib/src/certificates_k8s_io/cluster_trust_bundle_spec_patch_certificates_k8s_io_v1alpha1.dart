...
class ClusterTrustBundleSpecPatchCertificatesK8sIoV1alpha1 {
  ...
  /// Creates a new [ClusterTrustBundleSpecPatchCertificatesK8sIoV1alpha1].
  ...
  const ClusterTrustBundleSpecPatchCertificatesK8sIoV1alpha1({
    this.signerName,
    this.trustBundle,
  });
  ...
  factory ClusterTrustBundleSpecPatchCertificatesK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundleSpecPatchCertificatesK8sIoV1alpha1(
