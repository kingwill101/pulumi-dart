...
class CertificateSigningRequest {
  ...
  factory CertificateSigningRequest.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequest(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateSigningRequestStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
