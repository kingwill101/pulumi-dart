...
class ClusterTrustBundleArgs {
  ...
  ClusterTrustBundleArgs({
    ...
    required pulumi.Output<ClusterTrustBundleSpec> spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<ClusterTrustBundleSpec>(spec);
  ...
  factory ClusterTrustBundleArgs.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundleArgs(
      ...
      spec: pulumi.Output.create<ClusterTrustBundleSpec>(ClusterTrustBundleSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
