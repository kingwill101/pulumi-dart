...
class CertificateSigningRequestCertificatesK8sIoV1beta1 {
  ...
  final pulumi.Input<CertificateSigningRequestStatusCertificatesK8sIoV1beta1>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<CertificateSigningRequestStatusCertificatesK8sIoV1beta1, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory CertificateSigningRequestCertificatesK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestCertificatesK8sIoV1beta1(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateSigningRequestStatusCertificatesK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
