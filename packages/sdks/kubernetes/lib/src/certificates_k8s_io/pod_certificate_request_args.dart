...
class PodCertificateRequestArgs {
  ...
  PodCertificateRequestArgs({
    ...
    required pulumi.Output<PodCertificateRequestSpec> spec,
  }) :
  ...
  factory PodCertificateRequestArgs.fromMap(Map<String, dynamic> map) {
    return PodCertificateRequestArgs(
      ...
      spec: pulumi.Output.create<PodCertificateRequestSpec>(PodCertificateRequestSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
