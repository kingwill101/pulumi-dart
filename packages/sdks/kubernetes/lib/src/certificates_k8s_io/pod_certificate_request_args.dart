...
/// {@template pulumi_certificates_k8s_io_v1_pod_certificate_request_args_doc}
/// The set of arguments for PodCertificateRequest.
/// {@endtemplate}
/// {@macro pulumi_certificates_k8s_io_v1_pod_certificate_request_args_doc}
class PodCertificateRequestArgs {
  ...
  const PodCertificateRequestArgs({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
