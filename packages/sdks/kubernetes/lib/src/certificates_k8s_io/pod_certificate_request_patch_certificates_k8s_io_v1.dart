...
import 'pod_certificate_request_patch_args.dart';
...
class PodCertificateRequestPatchCertificatesK8sIoV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [PodCertificateRequestPatchCertificatesK8sIoV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PodCertificateRequestPatchCertificatesK8sIoV1]. {@macro pulumi_certificates_k8s_io_v1_pod_certificate_request_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  PodCertificateRequestPatchCertificatesK8sIoV1(
    String name, {
    PodCertificateRequestPatchArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'kubernetes:certificates.k8s.io/v1:PodCertificateRequestPatch',
          name,
  ...
  /// Creates a typed reference to an existing [PodCertificateRequestPatchCertificatesK8sIoV1] resource.
  PodCertificateRequestPatchCertificatesK8sIoV1.reference(String urn)
    : super(
        'kubernetes:certificates.k8s.io/v1:PodCertificateRequestPatch',
