...
class PodCertificateRequestCertificatesK8sIoV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [PodCertificateRequestCertificatesK8sIoV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PodCertificateRequestCertificatesK8sIoV1]. {@macro pulumi_certificates_k8s_io_v1_pod_certificate_request_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  PodCertificateRequestCertificatesK8sIoV1(
    String name, {
  ...
  /// Creates a typed reference to an existing [PodCertificateRequestCertificatesK8sIoV1] resource.
  PodCertificateRequestCertificatesK8sIoV1.reference(String urn)
    : super(
        'kubernetes:certificates.k8s.io/v1:PodCertificateRequest',
