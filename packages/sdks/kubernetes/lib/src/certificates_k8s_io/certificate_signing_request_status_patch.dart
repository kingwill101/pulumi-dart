...
class CertificateSigningRequestStatusPatch {
  ...
  factory CertificateSigningRequestStatusPatch.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestStatusPatch(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateSigningRequestConditionPatch>(guardedValue, (value) => CertificateSigningRequestConditionPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
