...
/// {@template pulumi_certificates_k8s_io_v1_certificate_signing_request_patch_args_doc}
/// The set of arguments for CertificateSigningRequestPatch.
/// {@endtemplate}
/// {@macro pulumi_certificates_k8s_io_v1_certificate_signing_request_patch_args_doc}
class CertificateSigningRequestPatchArgs {
  ...
  /// Creates a new [CertificateSigningRequestPatchArgs].
  ...
  CertificateSigningRequestPatchArgs({
    ...
    pulumi.Output<CertificateSigningRequestSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<CertificateSigningRequestSpecPatch>(spec);
  ...
  factory CertificateSigningRequestPatchArgs.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CertificateSigningRequestSpecPatch>(CertificateSigningRequestSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
