...
class CertificateSigningRequestPatchCertificatesK8sIoV1beta1Args {
  ...
  CertificateSigningRequestPatchCertificatesK8sIoV1beta1Args({
    ...
    pulumi.Output<CertificateSigningRequestSpecPatchCertificatesK8sIoV1beta1>? spec,
  }) :
  ...
  factory CertificateSigningRequestPatchCertificatesK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestPatchCertificatesK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CertificateSigningRequestSpecPatchCertificatesK8sIoV1beta1>(CertificateSigningRequestSpecPatchCertificatesK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
