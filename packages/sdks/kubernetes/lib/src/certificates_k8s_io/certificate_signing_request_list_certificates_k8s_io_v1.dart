...
class CertificateSigningRequestListCertificatesK8sIoV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CertificateSigningRequest>> items;
  ...
  CertificateSigningRequestListCertificatesK8sIoV1(
    ...
    items = registerOutput<List<CertificateSigningRequest>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<CertificateSigningRequest>(guardedValue, (value) => CertificateSigningRequest.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [CertificateSigningRequestListCertificatesK8sIoV1] resource.
  CertificateSigningRequestListCertificatesK8sIoV1.reference(String urn)
    : super(
        'kubernetes:certificates.k8s.io/v1:CertificateSigningRequestList',
