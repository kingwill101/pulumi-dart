...
/// {@template pulumi_certificates_k8s_io_v1beta1_pod_certificate_request_certificates_k8s_io_v1beta1_args_doc}
/// The set of arguments for PodCertificateRequest.
/// {@endtemplate}
/// {@macro pulumi_certificates_k8s_io_v1beta1_pod_certificate_request_certificates_k8s_io_v1beta1_args_doc}
class PodCertificateRequestCertificatesK8sIoV1beta1Args {
  ...
  /// Creates a new [PodCertificateRequestCertificatesK8sIoV1beta1Args].
  ...
  const PodCertificateRequestCertificatesK8sIoV1beta1Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory PodCertificateRequestCertificatesK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PodCertificateRequestCertificatesK8sIoV1beta1Args(
