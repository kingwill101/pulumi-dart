...
class PodCertificateRequestPatch {
  ...
  factory PodCertificateRequestPatch.fromMap(Map<String, dynamic> map) {
    return PodCertificateRequestPatch(
      ...
      spec: map['spec'] == null ? null : (PodCertificateRequestSpecPatch.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (PodCertificateRequestStatusPatch.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
