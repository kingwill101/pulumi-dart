...
class ClusterTrustBundlePatchCertificatesK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  ClusterTrustBundlePatchCertificatesK8sIoV1alpha1(
    ...
    spec = registerOutput<ClusterTrustBundleSpecPatch?>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ClusterTrustBundleSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
