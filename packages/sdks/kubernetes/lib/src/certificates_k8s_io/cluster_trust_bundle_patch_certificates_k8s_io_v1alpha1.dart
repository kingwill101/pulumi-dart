...
class ClusterTrustBundlePatchCertificatesK8sIoV1alpha1 {
  ...
  const ClusterTrustBundlePatchCertificatesK8sIoV1alpha1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory ClusterTrustBundlePatchCertificatesK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundlePatchCertificatesK8sIoV1alpha1(
