...
class CertificateSigningRequestListCertificatesK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<CertificateSigningRequestCertificatesK8sIoV1beta1>> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<CertificateSigningRequestCertificatesK8sIoV1beta1>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<CertificateSigningRequestCertificatesK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory CertificateSigningRequestListCertificatesK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestListCertificatesK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateSigningRequestCertificatesK8sIoV1beta1>(map['items']!, (value) => CertificateSigningRequestCertificatesK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
