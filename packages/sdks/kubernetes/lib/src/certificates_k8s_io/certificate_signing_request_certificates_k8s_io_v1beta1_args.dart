...
class CertificateSigningRequestCertificatesK8sIoV1beta1Args {
  ...
  CertificateSigningRequestCertificatesK8sIoV1beta1Args({
    ...
    pulumi.Output<CertificateSigningRequestSpecCertificatesK8sIoV1beta1>? spec,
  }) :
  ...
  factory CertificateSigningRequestCertificatesK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestCertificatesK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CertificateSigningRequestSpecCertificatesK8sIoV1beta1>(CertificateSigningRequestSpecCertificatesK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
