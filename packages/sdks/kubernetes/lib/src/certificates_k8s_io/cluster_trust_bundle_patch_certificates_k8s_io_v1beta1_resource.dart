...
class ClusterTrustBundlePatchCertificatesK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// Creates a new [ClusterTrustBundlePatchCertificatesK8sIoV1beta1Resource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ClusterTrustBundlePatchCertificatesK8sIoV1beta1Resource]. {@macro pulumi_certificates_k8s_io_v1beta1_cluster_trust_bundle_patch_certificates_k8s_io_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ClusterTrustBundlePatchCertificatesK8sIoV1beta1Resource(
    String name, {
  ...
  /// Creates a typed reference to an existing [ClusterTrustBundlePatchCertificatesK8sIoV1beta1Resource] resource.
  ClusterTrustBundlePatchCertificatesK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:certificates.k8s.io/v1beta1:ClusterTrustBundlePatch',
