...
class PodCertificateRequestStatusCertificatesK8sIoV1beta1 {
  ...
  /// Creates a new [PodCertificateRequestStatusCertificatesK8sIoV1beta1].
  ...
  const PodCertificateRequestStatusCertificatesK8sIoV1beta1({
    this.beginRefreshAt,
  ...
  factory PodCertificateRequestStatusCertificatesK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodCertificateRequestStatusCertificatesK8sIoV1beta1(
