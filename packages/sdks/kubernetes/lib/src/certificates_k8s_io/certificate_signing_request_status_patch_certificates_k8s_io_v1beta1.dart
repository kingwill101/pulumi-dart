...
class CertificateSigningRequestStatusPatchCertificatesK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<CertificateSigningRequestConditionPatchCertificatesK8sIoV1beta1>
  >?
  conditions;
  ...
  factory CertificateSigningRequestStatusPatchCertificatesK8sIoV1beta1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CertificateSigningRequestConditionPatchCertificatesK8sIoV1beta1.fromMap(
