...
class CertificateSigningRequestStatusPatchCertificatesK8sIoV1beta1 {
  ...
  const CertificateSigningRequestStatusPatchCertificatesK8sIoV1beta1({
    this.certificate,
    this.conditions,
  });
  ...
  factory CertificateSigningRequestStatusPatchCertificatesK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestStatusPatchCertificatesK8sIoV1beta1(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateSigningRequestConditionPatchCertificatesK8sIoV1beta1>(guardedValue, (value) => CertificateSigningRequestConditionPatchCertificatesK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
