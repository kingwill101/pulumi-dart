...
class ClusterTrustBundleSpecCertificatesK8sIoV1alpha1 {
  ...
  /// Creates a new [ClusterTrustBundleSpecCertificatesK8sIoV1alpha1].
  ...
  const ClusterTrustBundleSpecCertificatesK8sIoV1alpha1({
    this.signerName,
  ...
  factory ClusterTrustBundleSpecCertificatesK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundleSpecCertificatesK8sIoV1alpha1(
