...
class CertificateSigningRequestStatus {
  ...
  factory CertificateSigningRequestStatus.fromMap(Map<String, dynamic> map) {
    return CertificateSigningRequestStatus(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateSigningRequestCondition>(guardedValue, (value) => CertificateSigningRequestCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
