...
class ClusterTrustBundleCertificatesK8sIoV1alpha1 {
  ...
  const ClusterTrustBundleCertificatesK8sIoV1alpha1({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory ClusterTrustBundleCertificatesK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundleCertificatesK8sIoV1alpha1(
