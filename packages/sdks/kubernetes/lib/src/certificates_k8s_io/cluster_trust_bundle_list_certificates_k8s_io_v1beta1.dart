...
class ClusterTrustBundleListCertificatesK8sIoV1beta1 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<ClusterTrustBundleCertificatesK8sIoV1beta1>,
  ...
  factory ClusterTrustBundleListCertificatesK8sIoV1beta1.fromMap(
    ...
    return ClusterTrustBundleListCertificatesK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClusterTrustBundleCertificatesK8sIoV1beta1>(
          map['items']!,
          (value) => ClusterTrustBundleCertificatesK8sIoV1beta1.fromMap(
