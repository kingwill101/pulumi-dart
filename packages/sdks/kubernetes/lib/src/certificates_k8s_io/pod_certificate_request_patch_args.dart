...
class PodCertificateRequestPatchArgs {
  ...
  PodCertificateRequestPatchArgs({
    ...
    pulumi.Output<PodCertificateRequestSpecPatch>? spec,
  }) :
  ...
  factory PodCertificateRequestPatchArgs.fromMap(Map<String, dynamic> map) {
    return PodCertificateRequestPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PodCertificateRequestSpecPatch>(PodCertificateRequestSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
