...
/// {@template pulumi_certificates_k8s_io_v1_pod_certificate_request_patch_args_doc}
/// The set of arguments for PodCertificateRequestPatch.
/// {@endtemplate}
/// {@macro pulumi_certificates_k8s_io_v1_pod_certificate_request_patch_args_doc}
class PodCertificateRequestPatchArgs {
  ...
  const PodCertificateRequestPatchArgs({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
