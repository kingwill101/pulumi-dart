...
class ClusterTrustBundlePatchCertificatesK8sIoV1beta1 {
  ...
  /// Creates a new [ClusterTrustBundlePatchCertificatesK8sIoV1beta1].
  ...
  const ClusterTrustBundlePatchCertificatesK8sIoV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory ClusterTrustBundlePatchCertificatesK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ClusterTrustBundlePatchCertificatesK8sIoV1beta1(
      apiVersion: (() { final guardedValue = map['apiVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kind: (() { final guardedValue = map['kind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectMetaPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterTrustBundleSpecPatchCertificatesK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
