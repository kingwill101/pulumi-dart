...
class PodDisruptionBudget {
  ...
  factory PodDisruptionBudget.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudget(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodDisruptionBudgetSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodDisruptionBudgetStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
