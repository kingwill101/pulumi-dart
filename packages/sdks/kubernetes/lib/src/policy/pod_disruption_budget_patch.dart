...
class PodDisruptionBudgetPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<PodDisruptionBudgetStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory PodDisruptionBudgetPatch.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetPatch(
      apiVersion: map['apiVersion'] == null ? null : (map['apiVersion']! as String).input(),
      kind: map['kind'] == null ? null : (map['kind']! as String).input(),
      metadata: map['metadata'] == null ? null : (ObjectMetaPatch.fromMap((map['metadata']! as Map).cast<String, dynamic>())).input(),
      spec: map['spec'] == null ? null : (PodDisruptionBudgetSpecPatch.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (PodDisruptionBudgetStatusPatch.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
