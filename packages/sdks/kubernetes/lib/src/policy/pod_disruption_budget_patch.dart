...
class PodDisruptionBudgetPatch {
  ...
  factory PodDisruptionBudgetPatch.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodDisruptionBudgetStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
