...
class PodDisruptionBudgetStatusPatch {
  ...
  factory PodDisruptionBudgetStatusPatch.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetStatusPatch(
      ...
      currentHealthy: (() { final guardedValue = map['currentHealthy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      desiredHealthy: (() { final guardedValue = map['desiredHealthy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      disruptionsAllowed: (() { final guardedValue = map['disruptionsAllowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      expectedPods: (() { final guardedValue = map['expectedPods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
