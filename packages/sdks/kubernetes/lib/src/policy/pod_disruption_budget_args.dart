...
class PodDisruptionBudgetArgs {
  ...
  PodDisruptionBudgetArgs({
    ...
    pulumi.Output<PodDisruptionBudgetSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<PodDisruptionBudgetSpec>(spec);
  ...
  factory PodDisruptionBudgetArgs.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PodDisruptionBudgetSpec>(PodDisruptionBudgetSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
