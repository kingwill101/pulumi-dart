...
class PodSecurityPolicySpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowedCSIDrivers': ?pulumi.Input.mapOptionalInputValue<List<AllowedCSIDriver>, List<Map<String, dynamic>>>(allowedCSIDrivers, (value) => pulumi.Input.encodeList<AllowedCSIDriver, Map<String, dynamic>>(value, (value) => value.toMap())),
      'allowedCapabilities': ?allowedCapabilities,
      'allowedFlexVolumes': ?pulumi.Input.mapOptionalInputValue<List<AllowedFlexVolume>, List<Map<String, dynamic>>>(allowedFlexVolumes, (value) => pulumi.Input.encodeList<AllowedFlexVolume, Map<String, dynamic>>(value, (value) => value.toMap())),
      'allowedHostPaths': ?pulumi.Input.mapOptionalInputValue<List<AllowedHostPath>, List<Map<String, dynamic>>>(allowedHostPaths, (value) => pulumi.Input.encodeList<AllowedHostPath, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'fsGroup': pulumi.Input.mapInputValue<FSGroupStrategyOptions, Map<String, dynamic>>(fsGroup, (value) => value.toMap()),
      'hostIPC': ?hostIPC,
      'hostNetwork': ?hostNetwork,
      'hostPID': ?hostPID,
      'hostPorts': ?pulumi.Input.mapOptionalInputValue<List<HostPortRange>, List<Map<String, dynamic>>>(hostPorts, (value) => pulumi.Input.encodeList<HostPortRange, Map<String, dynamic>>(value, (value) => value.toMap())),
      'privileged': ?privileged,
      'readOnlyRootFilesystem': ?readOnlyRootFilesystem,
      'requiredDropCapabilities': ?requiredDropCapabilities,
      'runAsGroup': ?pulumi.Input.mapOptionalInputValue<RunAsGroupStrategyOptions, Map<String, dynamic>>(runAsGroup, (value) => value.toMap()),
      'runAsUser': pulumi.Input.mapInputValue<RunAsUserStrategyOptions, Map<String, dynamic>>(runAsUser, (value) => value.toMap()),
      'runtimeClass': ?pulumi.Input.mapOptionalInputValue<RuntimeClassStrategyOptions, Map<String, dynamic>>(runtimeClass, (value) => value.toMap()),
      'seLinux': pulumi.Input.mapInputValue<SELinuxStrategyOptions, Map<String, dynamic>>(seLinux, (value) => value.toMap()),
      'supplementalGroups': pulumi.Input.mapInputValue<SupplementalGroupsStrategyOptions, Map<String, dynamic>>(supplementalGroups, (value) => value.toMap()),
      'volumes': ?volumes,
    };
  }
  ...
  factory PodSecurityPolicySpec.fromMap(Map<String, dynamic> map) {
    return PodSecurityPolicySpec(
      ...
      allowedCSIDrivers: (() { final guardedValue = map['allowedCSIDrivers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllowedCSIDriver>(guardedValue, (value) => AllowedCSIDriver.fromMap((value as Map).cast<String, dynamic>()))); })(),
      allowedCapabilities: (() { final guardedValue = map['allowedCapabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      allowedFlexVolumes: (() { final guardedValue = map['allowedFlexVolumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllowedFlexVolume>(guardedValue, (value) => AllowedFlexVolume.fromMap((value as Map).cast<String, dynamic>()))); })(),
      allowedHostPaths: (() { final guardedValue = map['allowedHostPaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllowedHostPath>(guardedValue, (value) => AllowedHostPath.fromMap((value as Map).cast<String, dynamic>()))); })(),
      allowedProcMountTypes: (() { final guardedValue = map['allowedProcMountTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      defaultAddCapabilities: (() { final guardedValue = map['defaultAddCapabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      defaultAllowPrivilegeEscalation: (() { final guardedValue = map['defaultAllowPrivilegeEscalation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      forbiddenSysctls: (() { final guardedValue = map['forbiddenSysctls']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      fsGroup: pulumi.Input.fromValue(FSGroupStrategyOptions.fromMap((map['fsGroup']! as Map).cast<String, dynamic>())),
      ...
      hostPorts: (() { final guardedValue = map['hostPorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HostPortRange>(guardedValue, (value) => HostPortRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      requiredDropCapabilities: (() { final guardedValue = map['requiredDropCapabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      runAsGroup: (() { final guardedValue = map['runAsGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RunAsGroupStrategyOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      runAsUser: pulumi.Input.fromValue(RunAsUserStrategyOptions.fromMap((map['runAsUser']! as Map).cast<String, dynamic>())),
      runtimeClass: (() { final guardedValue = map['runtimeClass']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuntimeClassStrategyOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      seLinux: pulumi.Input.fromValue(SELinuxStrategyOptions.fromMap((map['seLinux']! as Map).cast<String, dynamic>())),
      supplementalGroups: pulumi.Input.fromValue(SupplementalGroupsStrategyOptions.fromMap((map['supplementalGroups']! as Map).cast<String, dynamic>())),
