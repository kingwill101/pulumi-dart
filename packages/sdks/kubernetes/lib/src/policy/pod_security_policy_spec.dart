...
class PodSecurityPolicySpec {
  ...
  factory PodSecurityPolicySpec.fromMap(Map<String, dynamic> map) {
    return PodSecurityPolicySpec(
      ...
      allowedCSIDrivers: map['allowedCSIDrivers'] == null ? null : (pulumi.Input.decodeList<AllowedCSIDriver>(map['allowedCSIDrivers'], (value) => AllowedCSIDriver.fromMap((value as Map).cast<String, dynamic>()))).input(),
      allowedCapabilities: map['allowedCapabilities'] == null ? null : ((map['allowedCapabilities'] as List).cast<String>()).input(),
      allowedFlexVolumes: map['allowedFlexVolumes'] == null ? null : (pulumi.Input.decodeList<AllowedFlexVolume>(map['allowedFlexVolumes'], (value) => AllowedFlexVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
      allowedHostPaths: map['allowedHostPaths'] == null ? null : (pulumi.Input.decodeList<AllowedHostPath>(map['allowedHostPaths'], (value) => AllowedHostPath.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      fsGroup: (FSGroupStrategyOptions.fromMap((map['fsGroup'] as Map).cast<String, dynamic>())).input(),
      ...
      hostPorts: map['hostPorts'] == null ? null : (pulumi.Input.decodeList<HostPortRange>(map['hostPorts'], (value) => HostPortRange.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      runAsGroup: map['runAsGroup'] == null ? null : (RunAsGroupStrategyOptions.fromMap((map['runAsGroup'] as Map).cast<String, dynamic>())).input(),
      runAsUser: (RunAsUserStrategyOptions.fromMap((map['runAsUser'] as Map).cast<String, dynamic>())).input(),
      runtimeClass: map['runtimeClass'] == null ? null : (RuntimeClassStrategyOptions.fromMap((map['runtimeClass'] as Map).cast<String, dynamic>())).input(),
      seLinux: (SELinuxStrategyOptions.fromMap((map['seLinux'] as Map).cast<String, dynamic>())).input(),
      supplementalGroups: (SupplementalGroupsStrategyOptions.fromMap((map['supplementalGroups'] as Map).cast<String, dynamic>())).input(),
