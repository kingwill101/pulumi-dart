...
class PodDisruptionBudgetListArgs {
  ...
  PodDisruptionBudgetListArgs({
    ...
    required pulumi.Output<List<PodDisruptionBudgetPolicyV1>> items,
  ...
  factory PodDisruptionBudgetListArgs.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetListArgs(
      ...
      items: pulumi.Output.create<List<PodDisruptionBudgetPolicyV1>>((map['items'] as List).cast<PodDisruptionBudgetPolicyV1>()),
