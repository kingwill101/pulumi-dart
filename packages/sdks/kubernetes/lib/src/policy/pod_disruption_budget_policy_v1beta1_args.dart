...
class PodDisruptionBudgetPolicyV1beta1Args {
  ...
  PodDisruptionBudgetPolicyV1beta1Args({
    ...
    pulumi.Output<PodDisruptionBudgetSpecPolicyV1beta1>? spec,
  }) :
  ...
  factory PodDisruptionBudgetPolicyV1beta1Args.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetPolicyV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PodDisruptionBudgetSpecPolicyV1beta1>(PodDisruptionBudgetSpecPolicyV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
