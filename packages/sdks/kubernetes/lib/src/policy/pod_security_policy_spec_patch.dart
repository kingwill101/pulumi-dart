...
class PodSecurityPolicySpecPatch {
  ...
  const PodSecurityPolicySpecPatch({
  ...
  factory PodSecurityPolicySpecPatch.fromMap(Map<String, dynamic> map) {
    return PodSecurityPolicySpecPatch(
      ...
      allowedCSIDrivers: (() { final guardedValue = map['allowedCSIDrivers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllowedCSIDriverPatch>(guardedValue, (value) => AllowedCSIDriverPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      allowedFlexVolumes: (() { final guardedValue = map['allowedFlexVolumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllowedFlexVolumePatch>(guardedValue, (value) => AllowedFlexVolumePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      allowedHostPaths: (() { final guardedValue = map['allowedHostPaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AllowedHostPathPatch>(guardedValue, (value) => AllowedHostPathPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      fsGroup: (() { final guardedValue = map['fsGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FSGroupStrategyOptionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      hostPorts: (() { final guardedValue = map['hostPorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HostPortRangePatch>(guardedValue, (value) => HostPortRangePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      runAsGroup: (() { final guardedValue = map['runAsGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RunAsGroupStrategyOptionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      runAsUser: (() { final guardedValue = map['runAsUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RunAsUserStrategyOptionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      runtimeClass: (() { final guardedValue = map['runtimeClass']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuntimeClassStrategyOptionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      seLinux: (() { final guardedValue = map['seLinux']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SELinuxStrategyOptionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      supplementalGroups: (() { final guardedValue = map['supplementalGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SupplementalGroupsStrategyOptionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
