...
class PodDisruptionBudgetSpecPatch {
  ...
  final pulumi.Input<dynamic>? minAvailable;
  ...
  /// Creates a new [PodDisruptionBudgetSpecPatch].
  ...
  const PodDisruptionBudgetSpecPatch({
    this.maxUnavailable,
    this.minAvailable,
    this.selector,
  ...
  factory PodDisruptionBudgetSpecPatch.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetSpecPatch(
      ...
      minAvailable: (() { final guardedValue = map['minAvailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
