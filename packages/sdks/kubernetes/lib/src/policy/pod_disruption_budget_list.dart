...
class PodDisruptionBudgetList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<PodDisruptionBudget, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory PodDisruptionBudgetList.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetList(
      ...
      items: pulumi.Input.decodeList<PodDisruptionBudget>(map['items'], (value) => PodDisruptionBudget.fromMap((value as Map).cast<String, dynamic>())),
