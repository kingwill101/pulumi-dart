...
class PodDisruptionBudgetPolicyV1beta1 {
  ...
  factory PodDisruptionBudgetPolicyV1beta1.fromMap(Map<String, dynamic> map) {
    return PodDisruptionBudgetPolicyV1beta1(
      ...
      spec: map['spec'] == null ? null : (PodDisruptionBudgetSpecPolicyV1beta1.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (PodDisruptionBudgetStatusPolicyV1beta1.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
