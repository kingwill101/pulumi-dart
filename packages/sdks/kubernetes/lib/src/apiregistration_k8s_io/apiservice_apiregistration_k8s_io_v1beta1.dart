...
class APIServiceApiregistrationK8sIoV1beta1 {
  ...
  factory APIServiceApiregistrationK8sIoV1beta1.fromMap(
    ...
    return APIServiceApiregistrationK8sIoV1beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          APIServiceSpecApiregistrationK8sIoV1beta1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          APIServiceStatusApiregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
