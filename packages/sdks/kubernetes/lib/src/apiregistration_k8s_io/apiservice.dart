...
class APIService {
  ...
  factory APIService.fromMap(Map<String, dynamic> map) {
    return APIService(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(APIServiceStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
