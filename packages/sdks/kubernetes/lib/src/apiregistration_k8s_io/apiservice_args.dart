...
class APIServiceArgs {
  ...
  factory APIServiceArgs.fromMap(Map<String, dynamic> map) {
    return APIServiceArgs(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(APIServiceSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
