...
class APIServiceListApiregistrationK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<APIServiceApiregistrationK8sIoV1beta1>> items;
  ...
  /// [metadata] Optional.
  const APIServiceListApiregistrationK8sIoV1beta1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<APIServiceApiregistrationK8sIoV1beta1>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<APIServiceApiregistrationK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory APIServiceListApiregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return APIServiceListApiregistrationK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<APIServiceApiregistrationK8sIoV1beta1>(map['items']!, (value) => APIServiceApiregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
