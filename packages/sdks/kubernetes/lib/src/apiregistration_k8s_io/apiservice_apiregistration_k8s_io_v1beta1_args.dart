...
class APIServiceApiregistrationK8sIoV1beta1Args {
  ...
  APIServiceApiregistrationK8sIoV1beta1Args({
    ...
    pulumi.Output<APIServiceSpecApiregistrationK8sIoV1beta1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<APIServiceSpecApiregistrationK8sIoV1beta1>(spec);
  ...
  factory APIServiceApiregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return APIServiceApiregistrationK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<APIServiceSpecApiregistrationK8sIoV1beta1>(APIServiceSpecApiregistrationK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
