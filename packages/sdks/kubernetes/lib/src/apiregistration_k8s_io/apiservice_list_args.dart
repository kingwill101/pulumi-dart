...
class APIServiceListArgs {
  ...
  APIServiceListArgs({
    ...
    required pulumi.Output<List<APIServiceApiregistrationK8sIoV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<APIServiceApiregistrationK8sIoV1>>(items),
  ...
  factory APIServiceListArgs.fromMap(Map<String, dynamic> map) {
    return APIServiceListArgs(
      ...
      items: pulumi.Output.create<List<APIServiceApiregistrationK8sIoV1>>((map['items'] as List).cast<APIServiceApiregistrationK8sIoV1>()),
