...
class APIServiceSpecPatchApiregistrationK8sIoV1beta1 {
  ...
  factory APIServiceSpecPatchApiregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return APIServiceSpecPatchApiregistrationK8sIoV1beta1(
      ...
      groupPriorityMinimum: (() { final guardedValue = map['groupPriorityMinimum']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      versionPriority: (() { final guardedValue = map['versionPriority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
