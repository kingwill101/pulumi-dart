...
class APIServiceSpecPatchApiregistrationK8sIoV1beta1 {
  ...
  final ServiceReferencePatchApiregistrationK8sIoV1beta1? service;
  ...
  APIServiceSpecPatchApiregistrationK8sIoV1beta1({
    this.caBundle,
    this.group,
  ...
  factory APIServiceSpecPatchApiregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return APIServiceSpecPatchApiregistrationK8sIoV1beta1(
      ...
      groupPriorityMinimum: map['groupPriorityMinimum'] == null ? null : map['groupPriorityMinimum'] as int,
      insecureSkipTLSVerify: map['insecureSkipTLSVerify'] == null ? null : map['insecureSkipTLSVerify'] as bool,
      service: map['service'] == null ? null : ServiceReferencePatchApiregistrationK8sIoV1beta1.fromMap((map['service'] as Map).cast<String, dynamic>()),
      version: map['version'] == null ? null : map['version'] as String,
      versionPriority: map['versionPriority'] == null ? null : map['versionPriority'] as int,
    );
  }
}
