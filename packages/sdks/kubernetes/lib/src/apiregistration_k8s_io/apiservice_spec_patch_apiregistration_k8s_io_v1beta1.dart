...
class APIServiceSpecPatchApiregistrationK8sIoV1beta1 {
  ...
  factory APIServiceSpecPatchApiregistrationK8sIoV1beta1.fromMap(
    ...
    return APIServiceSpecPatchApiregistrationK8sIoV1beta1(
      ...
      groupPriorityMinimum: (() {
        final guardedValue = map['groupPriorityMinimum'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      insecureSkipTLSVerify: (() {
        final guardedValue = map['insecureSkipTLSVerify'];
        if (guardedValue == null) return null;
      ...
      service: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceReferencePatchApiregistrationK8sIoV1beta1.fromMap(
      ...
      versionPriority: (() {
        final guardedValue = map['versionPriority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
