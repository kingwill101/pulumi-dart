...
class APIServicePatchApiregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<APIServiceStatusPatchApiregistrationK8sIoV1beta1>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<APIServiceStatusPatchApiregistrationK8sIoV1beta1, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory APIServicePatchApiregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return APIServicePatchApiregistrationK8sIoV1beta1(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(APIServiceSpecPatchApiregistrationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(APIServiceStatusPatchApiregistrationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
