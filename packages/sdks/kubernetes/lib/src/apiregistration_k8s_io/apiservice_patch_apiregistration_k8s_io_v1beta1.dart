...
class APIServicePatchApiregistrationK8sIoV1beta1 {
  ...
  factory APIServicePatchApiregistrationK8sIoV1beta1.fromMap(
    ...
    return APIServicePatchApiregistrationK8sIoV1beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          APIServiceSpecPatchApiregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          APIServiceStatusPatchApiregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
