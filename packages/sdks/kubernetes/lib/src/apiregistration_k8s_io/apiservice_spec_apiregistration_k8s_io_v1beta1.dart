...
class APIServiceSpecApiregistrationK8sIoV1beta1 {
  ...
  factory APIServiceSpecApiregistrationK8sIoV1beta1.fromMap(
    ...
    return APIServiceSpecApiregistrationK8sIoV1beta1(
      ...
      groupPriorityMinimum: pulumi.Input.fromValue(
        map['groupPriorityMinimum'] as int,
      ),
      ...
      service: pulumi.Input.fromValue(
        ServiceReferenceApiregistrationK8sIoV1beta1.fromMap(
