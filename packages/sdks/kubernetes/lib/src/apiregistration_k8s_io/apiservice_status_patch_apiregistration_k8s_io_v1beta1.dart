...
class APIServiceStatusPatchApiregistrationK8sIoV1beta1 {
  ...
  const APIServiceStatusPatchApiregistrationK8sIoV1beta1({
    this.conditions,
  });
  ...
  factory APIServiceStatusPatchApiregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return APIServiceStatusPatchApiregistrationK8sIoV1beta1(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<APIServiceConditionPatchApiregistrationK8sIoV1beta1>(guardedValue, (value) => APIServiceConditionPatchApiregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
