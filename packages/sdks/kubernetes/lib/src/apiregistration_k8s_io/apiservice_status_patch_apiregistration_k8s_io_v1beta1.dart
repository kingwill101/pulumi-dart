...
class APIServiceStatusPatchApiregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<List<APIServiceConditionPatchApiregistrationK8sIoV1beta1>>?
  conditions;

  /// Creates a new [APIServiceStatusPatchApiregistrationK8sIoV1beta1].
  /// [conditions] Current service state of apiService.
  APIServiceStatusPatchApiregistrationK8sIoV1beta1({this.conditions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<APIServiceConditionPatchApiregistrationK8sIoV1beta1>,
  ...
  factory APIServiceStatusPatchApiregistrationK8sIoV1beta1.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                APIServiceConditionPatchApiregistrationK8sIoV1beta1.fromMap(
