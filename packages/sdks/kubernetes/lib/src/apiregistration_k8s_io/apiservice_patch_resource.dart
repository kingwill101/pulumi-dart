...
class APIServicePatchResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<APIServiceSpecPatchApiregistrationK8sIoV1beta1?>
  spec;

  /// Status contains derived information about an API server
  late final pulumi.Output<APIServiceStatusPatchApiregistrationK8sIoV1beta1?>
  status;
  ...
  APIServicePatchResource(
    ...
    spec = registerOutput<APIServiceSpecPatchApiregistrationK8sIoV1beta1?>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return APIServiceSpecPatchApiregistrationK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<APIServiceStatusPatchApiregistrationK8sIoV1beta1?>(
      'status',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return APIServiceStatusPatchApiregistrationK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
