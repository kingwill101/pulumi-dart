...
class APIServicePatchResource extends pulumi.CustomResource {
  ...
  APIServicePatchResource(
    ...
    this.spec = registerOutput<APIServiceSpecPatchApiregistrationK8sIoV1beta1?>('spec');
    this.status = registerOutput<APIServiceStatusPatchApiregistrationK8sIoV1beta1?>('status');
  }
}
