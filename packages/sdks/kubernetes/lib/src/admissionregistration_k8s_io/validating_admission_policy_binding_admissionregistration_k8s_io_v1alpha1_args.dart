...
class ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1Args {
  ...
  factory ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1Args.fromMap(
    ...
    return ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1Args(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1.fromMap(
