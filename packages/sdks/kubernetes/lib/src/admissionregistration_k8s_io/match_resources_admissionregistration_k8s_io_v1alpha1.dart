...
class MatchResourcesAdmissionregistrationK8sIoV1alpha1 {
  ...
  final List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>? excludeResourceRules;
  ...
  final List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>? resourceRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludeResourceRules': ?excludeResourceRules == null ? null : pulumi.Input.encodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(excludeResourceRules!, (value) => value.toMap()),
      ...
      'resourceRules': ?resourceRules == null ? null : pulumi.Input.encodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(resourceRules!, (value) => value.toMap()),
    };
  }
  ...
  factory MatchResourcesAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return MatchResourcesAdmissionregistrationK8sIoV1alpha1(
      excludeResourceRules: map['excludeResourceRules'] == null ? null : pulumi.Input.decodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>(map['excludeResourceRules'], (value) => NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
      ...
      resourceRules: map['resourceRules'] == null ? null : pulumi.Input.decodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>(map['resourceRules'], (value) => NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
