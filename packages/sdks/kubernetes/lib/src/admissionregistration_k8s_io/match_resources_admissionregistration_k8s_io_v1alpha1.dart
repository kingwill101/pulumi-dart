...
class MatchResourcesAdmissionregistrationK8sIoV1alpha1 {
  ...
  final pulumi.Input<
    List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>
  >?
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1,
                  Map<String, dynamic>
  ...
  factory MatchResourcesAdmissionregistrationK8sIoV1alpha1.fromMap(
      ...
      excludeResourceRules: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1.fromMap(
