...
import 'named_rule_with_operations_admissionregistration_k8s_io_v1alpha1.dart';

/// MatchResources decides whether to run the admission control policy on an object based on whether it meets the match criteria. The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
class MatchResourcesAdmissionregistrationK8sIoV1alpha1 {
  ...
  final pulumi.Input<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>?>? excludeResourceRules;
  ...
  final pulumi.Input<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>?>? resourceRules;

  /// Creates a new [MatchResourcesAdmissionregistrationK8sIoV1alpha1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludeResourceRules': ?pulumi.Input.mapOptionalInputValue<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>, List<Map<String, dynamic>>>(excludeResourceRules, (value) => pulumi.Input.encodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'resourceRules': ?pulumi.Input.mapOptionalInputValue<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>, List<Map<String, dynamic>>>(resourceRules, (value) => pulumi.Input.encodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory MatchResourcesAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return MatchResourcesAdmissionregistrationK8sIoV1alpha1(
      excludeResourceRules: (() { final guardedValue = map['excludeResourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      resourceRules: (() { final guardedValue = map['resourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => NamedRuleWithOperationsAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
