...
class MutatingWebhookConfigurationListArgs {
  ...
  final pulumi.Input<
    List<MutatingWebhookConfigurationAdmissionregistrationK8sIoV1>
  >
  items;
  ...
  factory MutatingWebhookConfigurationListArgs.fromMap(
    ...
    return MutatingWebhookConfigurationListArgs(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<MutatingWebhookConfigurationAdmissionregistrationK8sIoV1>(),
      ),
      kind: (() {
