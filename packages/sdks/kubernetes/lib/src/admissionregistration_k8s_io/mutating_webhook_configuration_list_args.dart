...
class MutatingWebhookConfigurationListArgs {
  ...
  final pulumi.Input<List<MutatingWebhookConfiguration>> items;
  ...
  const MutatingWebhookConfigurationListArgs({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<MutatingWebhookConfiguration>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<MutatingWebhookConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory MutatingWebhookConfigurationListArgs.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookConfigurationListArgs(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<MutatingWebhookConfiguration>(map['items']!, (value) => MutatingWebhookConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
