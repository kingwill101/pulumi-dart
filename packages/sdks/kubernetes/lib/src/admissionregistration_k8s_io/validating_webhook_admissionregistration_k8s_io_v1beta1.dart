...
class ValidatingWebhookAdmissionregistrationK8sIoV1beta1 {
  ...
  const ValidatingWebhookAdmissionregistrationK8sIoV1beta1({
  ...
  factory ValidatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookAdmissionregistrationK8sIoV1beta1(
      ...
      clientConfig: pulumi.Input.fromValue(WebhookClientConfigAdmissionregistrationK8sIoV1beta1.fromMap((map['clientConfig']! as Map).cast<String, dynamic>())),
