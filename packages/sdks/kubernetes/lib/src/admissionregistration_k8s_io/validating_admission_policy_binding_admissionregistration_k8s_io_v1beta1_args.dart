...
class ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Args {
  ...
  ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Args({
    ...
    pulumi.Output<ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1>(spec);
  ...
  factory ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1>(ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
