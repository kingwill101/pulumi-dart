...
class NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1 {
  ...
  /// Creates a new [NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1].
  ...
  const NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1({
    this.apiGroups,
    this.apiVersions,
    this.operations,
    this.resourceNames,
  ...
  factory NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1(
