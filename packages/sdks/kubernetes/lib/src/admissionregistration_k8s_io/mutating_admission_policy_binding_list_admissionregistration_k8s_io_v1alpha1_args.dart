...
/// {@template pulumi_admissionregistration_k8s_io_v1alpha1_mutating_admission_policy_binding_list_admissionregistration_k8s_io_v1alpha1_args_doc}
/// The set of arguments for MutatingAdmissionPolicyBindingList.
/// {@endtemplate}
/// {@macro pulumi_admissionregistration_k8s_io_v1alpha1_mutating_admission_policy_binding_list_admissionregistration_k8s_io_v1alpha1_args_doc}
class MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1Args {
  ...
  /// Creates a new [MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1Args].
  ...
  const MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1Args(
