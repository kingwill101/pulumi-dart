...
class MatchResources {
  ...
  factory MatchResources.fromMap(Map<String, dynamic> map) {
    return MatchResources(
      excludeResourceRules: (() { final guardedValue = map['excludeResourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperations>(guardedValue, (value) => NamedRuleWithOperations.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      resourceRules: (() { final guardedValue = map['resourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperations>(guardedValue, (value) => NamedRuleWithOperations.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
