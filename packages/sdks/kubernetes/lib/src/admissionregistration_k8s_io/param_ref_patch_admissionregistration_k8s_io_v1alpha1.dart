...
class ParamRefPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [ParamRefPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  ParamRefPatchAdmissionregistrationK8sIoV1alpha1({
    this.name,
    this.namespace,
