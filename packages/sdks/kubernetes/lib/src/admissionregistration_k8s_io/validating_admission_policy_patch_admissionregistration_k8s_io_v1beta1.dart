...
class ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  factory ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1beta1(
      ...
      spec: map['spec'] == null ? null : (ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
