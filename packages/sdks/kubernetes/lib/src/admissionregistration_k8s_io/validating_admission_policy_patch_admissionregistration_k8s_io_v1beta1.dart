...
class ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  factory ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
