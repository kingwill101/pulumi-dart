...
class ValidatingWebhookConfigurationArgs {
  ...
  ValidatingWebhookConfigurationArgs({
    ...
    pulumi.Output<List<ValidatingWebhook>>? webhooks,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      webhooks = pulumi.Input.asOptionalInput<List<ValidatingWebhook>>(webhooks);
  ...
  factory ValidatingWebhookConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookConfigurationArgs(
      ...
      webhooks: map['webhooks'] == null ? null : pulumi.Output.create<List<ValidatingWebhook>>(pulumi.Input.decodeList<ValidatingWebhook>(map['webhooks'], (value) => ValidatingWebhook.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
