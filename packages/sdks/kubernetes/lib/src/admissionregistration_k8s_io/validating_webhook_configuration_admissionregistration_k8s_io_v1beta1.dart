...
class ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1 {
  ...
  final List<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>? webhooks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'webhooks': ?webhooks == null ? null : pulumi.Input.encodeList<ValidatingWebhookAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(webhooks!, (value) => value.toMap()),
    };
  }
