...
class ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1 {
  ...
  const ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.webhooks,
  ...
  factory ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1(
      ...
      webhooks: (() { final guardedValue = map['webhooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => ValidatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
