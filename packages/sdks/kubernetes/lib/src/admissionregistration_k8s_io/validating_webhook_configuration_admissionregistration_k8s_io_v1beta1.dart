...
class ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<List<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>>?
  webhooks;
    ...
    return <String, dynamic>{
      ...
      'webhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>,
  ...
  factory ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      webhooks: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ValidatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap(
