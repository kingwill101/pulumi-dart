...
/// {@template pulumi_admissionregistration_k8s_io_v1_mutating_webhook_configuration_patch_args_doc}
/// The set of arguments for MutatingWebhookConfigurationPatch.
/// {@endtemplate}
/// {@macro pulumi_admissionregistration_k8s_io_v1_mutating_webhook_configuration_patch_args_doc}
class MutatingWebhookConfigurationPatchArgs {
  ...
  /// Creates a new [MutatingWebhookConfigurationPatchArgs].
  ...
  MutatingWebhookConfigurationPatchArgs({
    ...
    pulumi.Output<List<MutatingWebhookPatch>>? webhooks,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      webhooks = pulumi.Input.asOptionalInput<List<MutatingWebhookPatch>>(webhooks);
  ...
  factory MutatingWebhookConfigurationPatchArgs.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookConfigurationPatchArgs(
      ...
      webhooks: map['webhooks'] == null ? null : pulumi.Output.create<List<MutatingWebhookPatch>>(pulumi.Input.decodeList<MutatingWebhookPatch>(map['webhooks'], (value) => MutatingWebhookPatch.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
