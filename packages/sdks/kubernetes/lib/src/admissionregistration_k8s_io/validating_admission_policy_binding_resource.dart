...
class ValidatingAdmissionPolicyBindingResource extends pulumi.CustomResource {
  ...
  ValidatingAdmissionPolicyBindingResource(
    ...
    spec = registerOutput<ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [ValidatingAdmissionPolicyBindingResource] resource.
  ValidatingAdmissionPolicyBindingResource.reference(String urn)
    : super(
        'kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicyBinding',
