...
class ValidatingAdmissionPolicyBindingResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<
    ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1
  >
  spec;
    ...
    spec =
        ...
        >(
          ...
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1.fromMap(
              (guardedValue as Map).cast<String, dynamic>(),
            );
          },
        );
