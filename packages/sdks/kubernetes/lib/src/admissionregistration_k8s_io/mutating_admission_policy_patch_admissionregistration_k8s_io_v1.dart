...
class MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1]. {@macro pulumi_admissionregistration_k8s_io_v1_mutating_admission_policy_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1(
    String name, {
