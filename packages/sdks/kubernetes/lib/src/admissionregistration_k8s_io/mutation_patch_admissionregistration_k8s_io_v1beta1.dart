...
class MutationPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  final ApplyConfigurationPatchAdmissionregistrationK8sIoV1beta1? applyConfiguration;
  ...
  final JSONPatchPatchAdmissionregistrationK8sIoV1beta1? jsonPatch;
  ...
  factory MutationPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MutationPatchAdmissionregistrationK8sIoV1beta1(
      applyConfiguration: map['applyConfiguration'] == null ? null : ApplyConfigurationPatchAdmissionregistrationK8sIoV1beta1.fromMap((map['applyConfiguration'] as Map).cast<String, dynamic>()),
      jsonPatch: map['jsonPatch'] == null ? null : JSONPatchPatchAdmissionregistrationK8sIoV1beta1.fromMap((map['jsonPatch'] as Map).cast<String, dynamic>()),
