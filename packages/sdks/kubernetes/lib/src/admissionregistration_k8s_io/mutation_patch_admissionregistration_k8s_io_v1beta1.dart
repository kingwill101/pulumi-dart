...
class MutationPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<ApplyConfigurationPatchAdmissionregistrationK8sIoV1beta1>?
  applyConfiguration;
  ...
  final pulumi.Input<JSONPatchPatchAdmissionregistrationK8sIoV1beta1>?
  jsonPatch;
  ...
  factory MutationPatchAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return MutationPatchAdmissionregistrationK8sIoV1beta1(
      applyConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          ApplyConfigurationPatchAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      jsonPatch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JSONPatchPatchAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
