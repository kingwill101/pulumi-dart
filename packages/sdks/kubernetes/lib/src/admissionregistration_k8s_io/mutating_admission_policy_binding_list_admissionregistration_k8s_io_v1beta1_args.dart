...
/// {@endtemplate}
/// {@macro pulumi_admissionregistration_k8s_io_v1beta1_mutating_admission_policy_binding_list_admissionregistration_k8s_io_v1beta1_args_doc}
class MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1Args {
  ...
  MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1Args({
    pulumi.Output<String>? apiVersion,
    required pulumi.Output<List<MutatingAdmissionPolicyBindingResource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<MutatingAdmissionPolicyBindingResource>>(items),
  ...
  factory MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1Args(
      ...
      items: pulumi.Output.create<List<MutatingAdmissionPolicyBindingResource>>((map['items'] as List).cast<MutatingAdmissionPolicyBindingResource>()),
