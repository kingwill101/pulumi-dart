...
class MutatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<MutatingWebhookAdmissionregistrationK8sIoV1beta1>>?
  webhooks;
    ...
    return <String, dynamic>{
      ...
      'webhooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<MutatingWebhookAdmissionregistrationK8sIoV1beta1>,
  ...
  factory MutatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args.fromMap(
    ...
    return MutatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args(
      ...
      webhooks: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => MutatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap(
