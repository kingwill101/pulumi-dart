...
class MutatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args {
  ...
  MutatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args({
    ...
    pulumi.Output<List<MutatingWebhookAdmissionregistrationK8sIoV1beta1>>? webhooks,
  }) :
  ...
  factory MutatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1Args(
      ...
      webhooks: map['webhooks'] == null ? null : pulumi.Output.create<List<MutatingWebhookAdmissionregistrationK8sIoV1beta1>>(pulumi.Input.decodeList<MutatingWebhookAdmissionregistrationK8sIoV1beta1>(map['webhooks'], (value) => MutatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
