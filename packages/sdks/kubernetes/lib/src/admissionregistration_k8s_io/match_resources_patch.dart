...
class MatchResourcesPatch {
  ...
  final pulumi.Input<List<NamedRuleWithOperationsPatch>?>? excludeResourceRules;
  ...
  final pulumi.Input<List<NamedRuleWithOperationsPatch>?>? resourceRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludeResourceRules': ?pulumi.Input.mapOptionalInputValue<List<NamedRuleWithOperationsPatch>, List<Map<String, dynamic>>>(excludeResourceRules, (value) => pulumi.Input.encodeList<NamedRuleWithOperationsPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'resourceRules': ?pulumi.Input.mapOptionalInputValue<List<NamedRuleWithOperationsPatch>, List<Map<String, dynamic>>>(resourceRules, (value) => pulumi.Input.encodeList<NamedRuleWithOperationsPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory MatchResourcesPatch.fromMap(Map<String, dynamic> map) {
    return MatchResourcesPatch(
      excludeResourceRules: (() { final guardedValue = map['excludeResourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsPatch>(guardedValue, (value) => NamedRuleWithOperationsPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      resourceRules: (() { final guardedValue = map['resourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsPatch>(guardedValue, (value) => NamedRuleWithOperationsPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
