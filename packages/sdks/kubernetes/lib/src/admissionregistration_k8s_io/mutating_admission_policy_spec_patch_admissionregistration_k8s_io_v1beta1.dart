...
class MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  const MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1({
    this.failurePolicy,
  ...
  factory MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1(
      ...
      mutations: (() { final guardedValue = map['mutations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MutationPatchAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => MutationPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
