...
class MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<MatchConditionPatchAdmissionregistrationK8sIoV1beta1>
  >?
  matchConditions;
  ...
  final pulumi.Input<MatchResourcesPatchAdmissionregistrationK8sIoV1beta1>?
  matchConstraints;

  /// mutations contain operations to perform on matching objects. mutations may not be empty; a minimum of one mutation is required. mutations are evaluated in order, and are reinvoked according to the reinvocationPolicy. The mutations of a policy are invoked for each binding of this policy and reinvocation of mutations occurs on a per binding basis.
  final pulumi.Input<List<MutationPatchAdmissionregistrationK8sIoV1beta1>>?
  mutations;

  /// paramKind specifies the kind of resources used to parameterize this policy. If absent, there are no parameters for this policy and the param CEL variable will not be provided to validation expressions. If paramKind refers to a non-existent kind, this policy definition is mis-configured and the FailurePolicy is applied. If paramKind is specified but paramRef is unset in MutatingAdmissionPolicyBinding, the params variable will be null.
  final pulumi.Input<ParamKindPatchAdmissionregistrationK8sIoV1beta1>?
  paramKind;
  ...
  final pulumi.Input<List<VariablePatchAdmissionregistrationK8sIoV1beta1>>?
  variables;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  MatchConditionPatchAdmissionregistrationK8sIoV1beta1,
                  Map<String, dynamic>
      ...
      'mutations':
          ?pulumi.Input.mapOptionalInputValue<
            List<MutationPatchAdmissionregistrationK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            mutations,
            (value) =>
      ...
      'variables':
          ?pulumi.Input.mapOptionalInputValue<
            List<VariablePatchAdmissionregistrationK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            variables,
            (value) =>
                pulumi.Input.encodeList<
                  VariablePatchAdmissionregistrationK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    };
  ...
  factory MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1(
      ...
      matchConditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MatchConditionPatchAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      matchConstraints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MatchResourcesPatchAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      mutations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<MutationPatchAdmissionregistrationK8sIoV1beta1>(
            guardedValue,
            (value) => MutationPatchAdmissionregistrationK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      paramKind: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParamKindPatchAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      variables: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<VariablePatchAdmissionregistrationK8sIoV1beta1>(
            guardedValue,
            (value) => VariablePatchAdmissionregistrationK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
