...
class JSONPatchPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [JSONPatchPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  const JSONPatchPatchAdmissionregistrationK8sIoV1alpha1({
    this.expression,
  });
  ...
  factory JSONPatchPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return JSONPatchPatchAdmissionregistrationK8sIoV1alpha1(
