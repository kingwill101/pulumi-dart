...
class MutatingAdmissionPolicyBindingPatchResource
  ...
  MutatingAdmissionPolicyBindingPatchResource(
    String name, {
    MutatingAdmissionPolicyBindingPatchAdmissionregistrationK8sIoV1beta1Args?
    args,
    ...
    spec =
        ...
        >(
          ...
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1beta1.fromMap(
              (guardedValue as Map).cast<String, dynamic>(),
            );
          },
        );
