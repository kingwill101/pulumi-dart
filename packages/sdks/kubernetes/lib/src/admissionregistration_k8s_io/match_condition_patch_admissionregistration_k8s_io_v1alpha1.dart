...
class MatchConditionPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [MatchConditionPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  const MatchConditionPatchAdmissionregistrationK8sIoV1alpha1({
    this.expression,
    this.name,
  });
