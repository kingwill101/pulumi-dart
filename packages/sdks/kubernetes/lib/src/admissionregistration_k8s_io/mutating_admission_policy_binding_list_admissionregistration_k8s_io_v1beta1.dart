...
class MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1>
  >
  items;
  ...
  factory MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return MutatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(
        ...
        >(
          map['items']!,
          (value) =>
              MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1.fromMap(
