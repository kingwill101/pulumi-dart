...
class MutatingAdmissionPolicyBindingSpecPatch {
  ...
  factory MutatingAdmissionPolicyBindingSpecPatch.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyBindingSpecPatch(
      matchResources: (() { final guardedValue = map['matchResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MatchResourcesPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paramRef: (() { final guardedValue = map['paramRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParamRefPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
