...
class MatchConditionPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  /// Creates a new [MatchConditionPatchAdmissionregistrationK8sIoV1beta1].
  ...
  const MatchConditionPatchAdmissionregistrationK8sIoV1beta1({
    this.expression,
    this.name,
  });
  ...
  factory MatchConditionPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MatchConditionPatchAdmissionregistrationK8sIoV1beta1(
