...
class NamedRuleWithOperationsPatch {
  ...
  /// Creates a new [NamedRuleWithOperationsPatch].
  ...
  const NamedRuleWithOperationsPatch({
    this.apiGroups,
    this.apiVersions,
    this.operations,
    this.resourceNames,
  ...
  factory NamedRuleWithOperationsPatch.fromMap(Map<String, dynamic> map) {
    return NamedRuleWithOperationsPatch(
