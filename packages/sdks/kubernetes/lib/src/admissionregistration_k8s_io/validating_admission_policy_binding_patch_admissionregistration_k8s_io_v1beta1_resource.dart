...
class ValidatingAdmissionPolicyBindingPatchAdmissionregistrationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ValidatingAdmissionPolicyBindingPatchAdmissionregistrationK8sIoV1beta1Resource] resource.
  ValidatingAdmissionPolicyBindingPatchAdmissionregistrationK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingAdmissionPolicyBindingPatch',
