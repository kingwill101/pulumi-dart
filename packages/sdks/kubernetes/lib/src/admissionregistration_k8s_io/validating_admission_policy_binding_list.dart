...
class ValidatingAdmissionPolicyBindingList {
  ...
  factory ValidatingAdmissionPolicyBindingList.fromMap(
    ...
    return ValidatingAdmissionPolicyBindingList(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ValidatingAdmissionPolicyBinding>(
          map['items']!,
          (value) => ValidatingAdmissionPolicyBinding.fromMap(
