...
class RuleWithOperationsPatch {
  ...
  /// Creates a new [RuleWithOperationsPatch].
  ...
  factory RuleWithOperationsPatch.fromMap(Map<String, dynamic> map) {
    return RuleWithOperationsPatch(
