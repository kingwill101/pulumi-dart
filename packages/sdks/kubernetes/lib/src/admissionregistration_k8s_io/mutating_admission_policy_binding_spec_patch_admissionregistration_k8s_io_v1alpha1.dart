...
class MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  const MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1({
    this.matchResources,
    this.paramRef,
    this.policyName,
  });
  ...
  factory MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1(
      matchResources: (() { final guardedValue = map['matchResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MatchResourcesPatchAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paramRef: (() { final guardedValue = map['paramRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParamRefPatchAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
