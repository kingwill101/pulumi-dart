...
class ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1 {
  ...
  final List<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1(
      ...
      items: pulumi.Input.decodeList<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1>(map['items'], (value) => ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
