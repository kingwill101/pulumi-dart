...
class ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1>
  >
  items;
  ...
  factory ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(
        ...
        >(
          map['items']!,
          (value) =>
              ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1.fromMap(
