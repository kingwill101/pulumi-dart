...
class ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1 {
  ...
  const ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1>(map['items']!, (value) => ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
