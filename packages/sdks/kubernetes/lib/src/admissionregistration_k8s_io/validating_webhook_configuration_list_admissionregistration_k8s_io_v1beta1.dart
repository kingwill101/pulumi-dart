...
class ValidatingWebhookConfigurationListAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1>
  >
  items;
  ...
  factory ValidatingWebhookConfigurationListAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return ValidatingWebhookConfigurationListAdmissionregistrationK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(
        ...
        >(
          map['items']!,
          (value) =>
              ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1beta1.fromMap(
