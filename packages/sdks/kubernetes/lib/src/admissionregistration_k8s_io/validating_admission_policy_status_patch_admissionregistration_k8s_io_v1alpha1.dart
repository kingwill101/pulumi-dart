...
class ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  const ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1alpha1({
    this.conditions,
  ...
  factory ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1alpha1(
      ...
      typeChecking: (() { final guardedValue = map['typeChecking']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypeCheckingPatchAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
