...
class ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  final pulumi.Input<TypeCheckingPatchAdmissionregistrationK8sIoV1alpha1>?
  typeChecking;
  ...
  factory ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1alpha1.fromMap(
    ...
    return ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1alpha1(
      ...
      typeChecking: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TypeCheckingPatchAdmissionregistrationK8sIoV1alpha1.fromMap(
