...
class MatchResourcesAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1>>? excludeResourceRules;
  ...
  final pulumi.Input<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1>>? resourceRules;
  ...
  const MatchResourcesAdmissionregistrationK8sIoV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'excludeResourceRules': ?pulumi.Input.mapOptionalInputValue<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1>, List<Map<String, dynamic>>>(excludeResourceRules, (value) => pulumi.Input.encodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'resourceRules': ?pulumi.Input.mapOptionalInputValue<List<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1>, List<Map<String, dynamic>>>(resourceRules, (value) => pulumi.Input.encodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory MatchResourcesAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MatchResourcesAdmissionregistrationK8sIoV1beta1(
      excludeResourceRules: (() { final guardedValue = map['excludeResourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      resourceRules: (() { final guardedValue = map['resourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => NamedRuleWithOperationsAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
