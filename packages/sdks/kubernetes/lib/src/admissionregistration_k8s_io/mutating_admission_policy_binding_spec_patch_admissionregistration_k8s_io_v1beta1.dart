...
class MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'paramRef':
          ?pulumi.Input.mapOptionalInputValue<
            ParamRefPatchAdmissionregistrationK8sIoV1beta1,
            Map<String, dynamic>
  ...
  factory MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return MutatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1beta1(
      ...
      paramRef: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParamRefPatchAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
