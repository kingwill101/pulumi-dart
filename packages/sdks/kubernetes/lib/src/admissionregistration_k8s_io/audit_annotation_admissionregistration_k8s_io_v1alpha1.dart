...
class AuditAnnotationAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [AuditAnnotationAdmissionregistrationK8sIoV1alpha1].
  ...
  const AuditAnnotationAdmissionregistrationK8sIoV1alpha1({
    required this.key,
  ...
  factory AuditAnnotationAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return AuditAnnotationAdmissionregistrationK8sIoV1alpha1(
