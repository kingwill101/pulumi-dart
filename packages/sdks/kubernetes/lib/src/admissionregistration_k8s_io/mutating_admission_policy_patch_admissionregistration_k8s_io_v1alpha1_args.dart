...
/// {@template pulumi_admissionregistration_k8s_io_v1alpha1_mutating_admission_policy_patch_admissionregistration_k8s_io_v1alpha1_args_doc}
/// The set of arguments for MutatingAdmissionPolicyPatch.
/// {@endtemplate}
/// {@macro pulumi_admissionregistration_k8s_io_v1alpha1_mutating_admission_policy_patch_admissionregistration_k8s_io_v1alpha1_args_doc}
class MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1alpha1Args {
  ...
  /// Creates a new [MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1alpha1Args].
  ...
  const MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1alpha1Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1alpha1Args(
