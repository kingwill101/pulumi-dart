...
class MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1(
    ...
    spec = registerOutput<MutatingAdmissionPolicyBindingSpec>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MutatingAdmissionPolicyBindingSpec.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }
}
