...
class MatchResourcesPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  const MatchResourcesPatchAdmissionregistrationK8sIoV1beta1({
  ...
  factory MatchResourcesPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MatchResourcesPatchAdmissionregistrationK8sIoV1beta1(
      excludeResourceRules: (() { final guardedValue = map['excludeResourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => NamedRuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      resourceRules: (() { final guardedValue = map['resourceRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedRuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => NamedRuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
