...
class MatchResourcesPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<NamedRuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1>
  >?
  ...
  factory MatchResourcesPatchAdmissionregistrationK8sIoV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return MatchResourcesPatchAdmissionregistrationK8sIoV1beta1(
      excludeResourceRules: (() {
        final guardedValue = map['excludeResourceRules'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                NamedRuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1.fromMap(
