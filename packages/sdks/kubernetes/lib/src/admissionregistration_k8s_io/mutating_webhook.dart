...
class MutatingWebhook {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientConfig':
          pulumi.Input.mapInputValue<WebhookClientConfig, Map<String, dynamic>>(
            clientConfig,
            (value) => value.toMap(),
          ),
      ...
      'matchConditions':
          ...
          >(
            matchConditions,
            (value) =>
                pulumi.Input.encodeList<MatchCondition, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory MutatingWebhook.fromMap(Map<String, dynamic> map) {
    return MutatingWebhook(
      admissionReviewVersions: pulumi.Input.fromValue(
        (map['admissionReviewVersions'] as List).cast<String>(),
      ),
      clientConfig: pulumi.Input.fromValue(
        WebhookClientConfig.fromMap(
      ...
      matchConditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MatchCondition>(
            guardedValue,
            (value) =>
                MatchCondition.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      matchPolicy: (() {
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleWithOperations>(
            guardedValue,
            (value) => RuleWithOperations.fromMap(
