...
class MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args {
  ...
  MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args({
    ...
    pulumi.Output<List<MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1>>? webhooks,
  }) :
  ...
  factory MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args(
      ...
      webhooks: map['webhooks'] == null ? null : pulumi.Output.create<List<MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1>>(pulumi.Input.decodeList<MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1>(map['webhooks'], (value) => MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
