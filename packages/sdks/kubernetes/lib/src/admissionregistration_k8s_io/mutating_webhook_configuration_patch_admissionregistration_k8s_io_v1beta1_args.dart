...
class MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args {
  ...
  const MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.webhooks,
  ...
  factory MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookConfigurationPatchAdmissionregistrationK8sIoV1beta1Args(
      ...
      webhooks: (() { final guardedValue = map['webhooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
