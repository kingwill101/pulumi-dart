...
class ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1Resource(
    ...
    this.spec = registerOutput<ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1>('spec');
    this.status = registerOutput<ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1?>('status');
  }
}
