...
class ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  const ValidatingAdmissionPolicyStatusPatchAdmissionregistrationK8sIoV1beta1({
    this.conditions,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'typeChecking': ?pulumi.Input.mapOptionalInputValue<TypeCheckingPatchAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(typeChecking, (value) => value.toMap()),
    };
  }
