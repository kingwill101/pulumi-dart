...
class MutatingAdmissionPolicyArgs {
  ...
  MutatingAdmissionPolicyArgs({
    ...
    pulumi.Output<MutatingAdmissionPolicySpec>? spec,
  }) :
  ...
  factory MutatingAdmissionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<MutatingAdmissionPolicySpec>(MutatingAdmissionPolicySpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
