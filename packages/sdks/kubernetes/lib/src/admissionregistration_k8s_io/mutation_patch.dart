...
class MutationPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applyConfiguration': ?pulumi.Input.mapOptionalInputValue<ApplyConfigurationPatch, Map<String, dynamic>>(applyConfiguration, (value) => value.toMap()),
      'jsonPatch': ?pulumi.Input.mapOptionalInputValue<JSONPatchPatch, Map<String, dynamic>>(jsonPatch, (value) => value.toMap()),
      'patchType': ?patchType,
    };
  }
  ...
  factory MutationPatch.fromMap(Map<String, dynamic> map) {
    return MutationPatch(
      applyConfiguration: (() { final guardedValue = map['applyConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplyConfigurationPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      jsonPatch: (() { final guardedValue = map['jsonPatch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JSONPatchPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
