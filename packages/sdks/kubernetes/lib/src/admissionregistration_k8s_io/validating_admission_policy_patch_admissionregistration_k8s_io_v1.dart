...
class ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1 extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1] resource.
  ValidatingAdmissionPolicyPatchAdmissionregistrationK8sIoV1.reference(String urn)
    : super(
        'kubernetes:admissionregistration.k8s.io/v1:ValidatingAdmissionPolicyPatch',
