...
class Mutation {
  ...
  Mutation({this.applyConfiguration, this.jsonPatch, required this.patchType});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jsonPatch':
          ?pulumi.Input.mapOptionalInputValue<JSONPatch, Map<String, dynamic>>(
            jsonPatch,
            (value) => value.toMap(),
          ),
      'patchType': patchType,
  ...
  factory Mutation.fromMap(Map<String, dynamic> map) {
    return Mutation(
      ...
      jsonPatch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JSONPatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
