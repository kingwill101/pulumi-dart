...
class Mutation {
  ...
  final ApplyConfiguration? applyConfiguration;
  ...
  factory Mutation.fromMap(Map<String, dynamic> map) {
    return Mutation(
      applyConfiguration: map['applyConfiguration'] == null ? null : ApplyConfiguration.fromMap((map['applyConfiguration'] as Map).cast<String, dynamic>()),
      jsonPatch: map['jsonPatch'] == null ? null : JSONPatch.fromMap((map['jsonPatch'] as Map).cast<String, dynamic>()),
