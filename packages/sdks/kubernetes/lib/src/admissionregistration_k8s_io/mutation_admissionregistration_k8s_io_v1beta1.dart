...
class MutationAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<ApplyConfigurationAdmissionregistrationK8sIoV1beta1>?
  applyConfiguration;
  ...
  factory MutationAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return MutationAdmissionregistrationK8sIoV1beta1(
      applyConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          ApplyConfigurationAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      jsonPatch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JSONPatchAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
