...
class ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1 {
  /// MatchResources declares what resources match this binding and will be validated by it. Note that this is intersected with the policy's matchConstraints, so only requests that are matched by the policy can be selected by this. If this is unset, all resources matched by the policy are validated by this binding When resourceRules is unset, it does not constrain resource matching. If a resource is matched by the other fields of this object, it will be validated. Note that this is differs from ValidatingAdmissionPolicy matchConstraints, where resourceRules are required.
  final MatchResourcesAdmissionregistrationK8sIoV1alpha1? matchResources;
  /// ParamRef specifies the parameter resource used to configure the admission control policy. It should point to a resource of the type specified in ParamKind of the bound ValidatingAdmissionPolicy. If the policy specifies a ParamKind and the resource referred to by ParamRef does not exist, this binding is considered mis-configured and the FailurePolicy of the ValidatingAdmissionPolicy applied.
  final ParamRefAdmissionregistrationK8sIoV1alpha1? paramRef;
  ...
  /// Creates a new [ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1].
  ...
  factory ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1alpha1(
      matchResources: map['matchResources'] == null ? null : MatchResourcesAdmissionregistrationK8sIoV1alpha1.fromMap((map['matchResources'] as Map).cast<String, dynamic>()),
      paramRef: map['paramRef'] == null ? null : ParamRefAdmissionregistrationK8sIoV1alpha1.fromMap((map['paramRef'] as Map).cast<String, dynamic>()),
