...
class ValidatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  final MatchResourcesPatchAdmissionregistrationK8sIoV1alpha1? matchResources;
  /// ParamRef specifies the parameter resource used to configure the admission control policy. It should point to a resource of the type specified in ParamKind of the bound ValidatingAdmissionPolicy. If the policy specifies a ParamKind and the resource referred to by ParamRef does not exist, this binding is considered mis-configured and the FailurePolicy of the ValidatingAdmissionPolicy applied.
  final ParamRefPatchAdmissionregistrationK8sIoV1alpha1? paramRef;
  ...
  factory ValidatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingSpecPatchAdmissionregistrationK8sIoV1alpha1(
      matchResources: map['matchResources'] == null ? null : MatchResourcesPatchAdmissionregistrationK8sIoV1alpha1.fromMap((map['matchResources'] as Map).cast<String, dynamic>()),
      paramRef: map['paramRef'] == null ? null : ParamRefPatchAdmissionregistrationK8sIoV1alpha1.fromMap((map['paramRef'] as Map).cast<String, dynamic>()),
