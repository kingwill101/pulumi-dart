...
class ValidatingAdmissionPolicySpecPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'validations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ValidationPatch>,
            List<Map<String, dynamic>>
          >(
            validations,
            (value) =>
                pulumi.Input.encodeList<ValidationPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'variables':
          ...
          >(
            variables,
            (value) =>
                pulumi.Input.encodeList<VariablePatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ValidatingAdmissionPolicySpecPatch(
      auditAnnotations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuditAnnotationPatch>(
            guardedValue,
            (value) => AuditAnnotationPatch.fromMap(
      ...
      paramKind: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParamKindPatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      validations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ValidationPatch>(
            guardedValue,
            (value) =>
                ValidationPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      variables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VariablePatch>(
            guardedValue,
            (value) =>
                VariablePatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
