...
class ValidatingAdmissionPolicySpecPatch {
  ...
  final pulumi.Input<List<AuditAnnotationPatch>>? auditAnnotations;
  ...
  const ValidatingAdmissionPolicySpecPatch({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditAnnotations': ?pulumi.Input.mapOptionalInputValue<List<AuditAnnotationPatch>, List<Map<String, dynamic>>>(auditAnnotations, (value) => pulumi.Input.encodeList<AuditAnnotationPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'matchConstraints': ?pulumi.Input.mapOptionalInputValue<MatchResourcesPatch, Map<String, dynamic>>(matchConstraints, (value) => value.toMap()),
      'paramKind': ?pulumi.Input.mapOptionalInputValue<ParamKindPatch, Map<String, dynamic>>(paramKind, (value) => value.toMap()),
      'validations': ?pulumi.Input.mapOptionalInputValue<List<ValidationPatch>, List<Map<String, dynamic>>>(validations, (value) => pulumi.Input.encodeList<ValidationPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
      'variables': ?pulumi.Input.mapOptionalInputValue<List<VariablePatch>, List<Map<String, dynamic>>>(variables, (value) => pulumi.Input.encodeList<VariablePatch, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory ValidatingAdmissionPolicySpecPatch.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicySpecPatch(
      auditAnnotations: (() { final guardedValue = map['auditAnnotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuditAnnotationPatch>(guardedValue, (value) => AuditAnnotationPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      matchConstraints: (() { final guardedValue = map['matchConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MatchResourcesPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paramKind: (() { final guardedValue = map['paramKind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParamKindPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      validations: (() { final guardedValue = map['validations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ValidationPatch>(guardedValue, (value) => ValidationPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      variables: (() { final guardedValue = map['variables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VariablePatch>(guardedValue, (value) => VariablePatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
