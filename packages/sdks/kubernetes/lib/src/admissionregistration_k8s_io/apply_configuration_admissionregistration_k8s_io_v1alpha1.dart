...
class ApplyConfigurationAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [ApplyConfigurationAdmissionregistrationK8sIoV1alpha1].
  /// [expression] expression will be evaluated by CEL to create an apply configuration. ref: https://github.com/google/cel-spec
  const ApplyConfigurationAdmissionregistrationK8sIoV1alpha1({
    this.expression,
  });
  ...
  factory ApplyConfigurationAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ApplyConfigurationAdmissionregistrationK8sIoV1alpha1(
