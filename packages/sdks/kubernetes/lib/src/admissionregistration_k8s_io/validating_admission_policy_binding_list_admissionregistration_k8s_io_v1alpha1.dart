...
class ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1 {
  ...
  final pulumi.Input<
    List<ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1>
  >
  items;
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<
              ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1
            >,
  ...
  factory ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1.fromMap(
    ...
    return ValidatingAdmissionPolicyBindingListAdmissionregistrationK8sIoV1alpha1(
      ...
      items: pulumi.Input.fromValue(
        ...
        >(
          map['items']!,
          (value) =>
              ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1alpha1.fromMap(
