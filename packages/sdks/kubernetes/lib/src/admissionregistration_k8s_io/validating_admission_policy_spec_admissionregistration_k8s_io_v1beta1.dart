...
class ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<List<AuditAnnotationAdmissionregistrationK8sIoV1beta1>>?
  auditAnnotations;
  ...
  final pulumi.Input<List<MatchConditionAdmissionregistrationK8sIoV1beta1>>?
  matchConditions;

  /// MatchConstraints specifies what resources this policy is designed to validate. The AdmissionPolicy cares about a request if it matches _all_ Constraints. However, in order to prevent clusters from being put into an unstable state that cannot be recovered from via the API ValidatingAdmissionPolicy cannot match ValidatingAdmissionPolicy and ValidatingAdmissionPolicyBinding. Required.
  final pulumi.Input<MatchResourcesAdmissionregistrationK8sIoV1beta1>?
  matchConstraints;
  ...
  final pulumi.Input<List<ValidationAdmissionregistrationK8sIoV1beta1>>?
  validations;

  /// Variables contain definitions of variables that can be used in composition of other expressions. Each variable is defined as a named CEL expression. The variables defined here will be available under `variables` in other expressions of the policy except MatchConditions because MatchConditions are evaluated before the rest of the policy.
  ///
  /// The expression of a variable can refer to other variables defined earlier in the list but not those after. Thus, Variables must be sorted by the order of first appearance and acyclic.
  final pulumi.Input<List<VariableAdmissionregistrationK8sIoV1beta1>>?
  variables;
    ...
    return <String, dynamic>{
      'auditAnnotations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuditAnnotationAdmissionregistrationK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            auditAnnotations,
            (value) =>
                pulumi.Input.encodeList<
                  AuditAnnotationAdmissionregistrationK8sIoV1beta1,
                  Map<String, dynamic>
      ...
      'matchConditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<MatchConditionAdmissionregistrationK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            matchConditions,
            (value) =>
                pulumi.Input.encodeList<
                  MatchConditionAdmissionregistrationK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'matchConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            MatchResourcesAdmissionregistrationK8sIoV1beta1,
            Map<String, dynamic>
      ...
      'validations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ValidationAdmissionregistrationK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            validations,
            (value) =>
                pulumi.Input.encodeList<
                  ValidationAdmissionregistrationK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'variables':
          ?pulumi.Input.mapOptionalInputValue<
            List<VariableAdmissionregistrationK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            variables,
            (value) =>
                pulumi.Input.encodeList<
                  VariableAdmissionregistrationK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    };
  ...
  factory ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1.fromMap(
    Map<String, dynamic> map,
  ) {
    return ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1(
      auditAnnotations: (() {
        final guardedValue = map['auditAnnotations'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => AuditAnnotationAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      matchConditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => MatchConditionAdmissionregistrationK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      matchConstraints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MatchResourcesAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      paramKind: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParamKindAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      validations: (() {
        final guardedValue = map['validations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ValidationAdmissionregistrationK8sIoV1beta1>(
            guardedValue,
            (value) => ValidationAdmissionregistrationK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      variables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VariableAdmissionregistrationK8sIoV1beta1>(
            guardedValue,
            (value) => VariableAdmissionregistrationK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
