...
import 'audit_annotation_admissionregistration_k8s_io_v1beta1.dart';
...
import 'validation_admissionregistration_k8s_io_v1beta1.dart';
import 'variable_admissionregistration_k8s_io_v1beta1.dart';

/// ValidatingAdmissionPolicySpec is the specification of the desired behavior of the AdmissionPolicy.
class ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1 {
  /// auditAnnotations contains CEL expressions which are used to produce audit annotations for the audit event of the API request. validations and auditAnnotations may not both be empty; a least one of validations or auditAnnotations is required.
  final pulumi.Input<List<AuditAnnotationAdmissionregistrationK8sIoV1beta1>>? auditAnnotations;
  ...
  final pulumi.Input<List<ValidationAdmissionregistrationK8sIoV1beta1>>? validations;
  ...
  /// Creates a new [ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditAnnotations': ?pulumi.Input.mapOptionalInputValue<List<AuditAnnotationAdmissionregistrationK8sIoV1beta1>, List<Map<String, dynamic>>>(auditAnnotations, (value) => pulumi.Input.encodeList<AuditAnnotationAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'validations': ?pulumi.Input.mapOptionalInputValue<List<ValidationAdmissionregistrationK8sIoV1beta1>, List<Map<String, dynamic>>>(validations, (value) => pulumi.Input.encodeList<ValidationAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1(
      auditAnnotations: (() { final guardedValue = map['auditAnnotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuditAnnotationAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => AuditAnnotationAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      matchConditions: (() { final guardedValue = map['matchConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MatchConditionAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => MatchConditionAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      matchConstraints: (() { final guardedValue = map['matchConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MatchResourcesAdmissionregistrationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paramKind: (() { final guardedValue = map['paramKind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParamKindAdmissionregistrationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      validations: (() { final guardedValue = map['validations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ValidationAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => ValidationAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      variables: (() { final guardedValue = map['variables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VariableAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => VariableAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
