...
class ValidatingAdmissionPolicyList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<ValidatingAdmissionPolicy, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory ValidatingAdmissionPolicyList.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyList(
      ...
      items: pulumi.Input.decodeList<ValidatingAdmissionPolicy>(map['items'], (value) => ValidatingAdmissionPolicy.fromMap((value as Map).cast<String, dynamic>())),
