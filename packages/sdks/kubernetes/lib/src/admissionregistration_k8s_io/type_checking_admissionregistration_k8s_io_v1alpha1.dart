...
class TypeCheckingAdmissionregistrationK8sIoV1alpha1 {
  ...
  final pulumi.Input<List<ExpressionWarningAdmissionregistrationK8sIoV1alpha1>>?
  expressionWarnings;
  ...
  TypeCheckingAdmissionregistrationK8sIoV1alpha1({this.expressionWarnings});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'expressionWarnings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ExpressionWarningAdmissionregistrationK8sIoV1alpha1>,
  ...
  factory TypeCheckingAdmissionregistrationK8sIoV1alpha1.fromMap(
      ...
      expressionWarnings: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ExpressionWarningAdmissionregistrationK8sIoV1alpha1.fromMap(
