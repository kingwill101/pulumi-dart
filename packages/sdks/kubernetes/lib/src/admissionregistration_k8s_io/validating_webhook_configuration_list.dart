...
class ValidatingWebhookConfigurationList {
  ...
  factory ValidatingWebhookConfigurationList.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookConfigurationList(
      ...
      items: (pulumi.Input.decodeList<ValidatingWebhookConfiguration>(map['items'], (value) => ValidatingWebhookConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
