...
class ValidatingAdmissionPolicyBindingSpecPatch {
  ...
  /// Creates a new [ValidatingAdmissionPolicyBindingSpecPatch].
  ...
  factory ValidatingAdmissionPolicyBindingSpecPatch.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingSpecPatch(
      matchResources: map['matchResources'] == null ? null : MatchResourcesPatch.fromMap((map['matchResources'] as Map).cast<String, dynamic>()),
      paramRef: map['paramRef'] == null ? null : ParamRefPatch.fromMap((map['paramRef'] as Map).cast<String, dynamic>()),
