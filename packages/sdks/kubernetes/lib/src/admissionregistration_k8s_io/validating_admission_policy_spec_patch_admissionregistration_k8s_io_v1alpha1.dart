...
import 'audit_annotation_patch_admissionregistration_k8s_io_v1alpha1.dart';
...
import 'validation_patch_admissionregistration_k8s_io_v1alpha1.dart';
import 'variable_patch_admissionregistration_k8s_io_v1alpha1.dart';

/// ValidatingAdmissionPolicySpec is the specification of the desired behavior of the AdmissionPolicy.
class ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1 {
  /// auditAnnotations contains CEL expressions which are used to produce audit annotations for the audit event of the API request. validations and auditAnnotations may not both be empty; a least one of validations or auditAnnotations is required.
  final pulumi.Input<List<AuditAnnotationPatchAdmissionregistrationK8sIoV1alpha1>>? auditAnnotations;
  ...
  final pulumi.Input<List<ValidationPatchAdmissionregistrationK8sIoV1alpha1>>? validations;
  ...
  /// Creates a new [ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  const ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditAnnotations': ?pulumi.Input.mapOptionalInputValue<List<AuditAnnotationPatchAdmissionregistrationK8sIoV1alpha1>, List<Map<String, dynamic>>>(auditAnnotations, (value) => pulumi.Input.encodeList<AuditAnnotationPatchAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'validations': ?pulumi.Input.mapOptionalInputValue<List<ValidationPatchAdmissionregistrationK8sIoV1alpha1>, List<Map<String, dynamic>>>(validations, (value) => pulumi.Input.encodeList<ValidationPatchAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1(
      auditAnnotations: (() { final guardedValue = map['auditAnnotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AuditAnnotationPatchAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => AuditAnnotationPatchAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      matchConditions: (() { final guardedValue = map['matchConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MatchConditionPatchAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => MatchConditionPatchAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      matchConstraints: (() { final guardedValue = map['matchConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MatchResourcesPatchAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paramKind: (() { final guardedValue = map['paramKind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParamKindPatchAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      validations: (() { final guardedValue = map['validations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ValidationPatchAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => ValidationPatchAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      variables: (() { final guardedValue = map['variables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VariablePatchAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => VariablePatchAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
