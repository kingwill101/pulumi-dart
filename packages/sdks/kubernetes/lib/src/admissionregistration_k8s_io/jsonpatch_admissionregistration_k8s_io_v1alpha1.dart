...
class JSONPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [JSONPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  const JSONPatchAdmissionregistrationK8sIoV1alpha1({
    this.expression,
  });
  ...
  factory JSONPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return JSONPatchAdmissionregistrationK8sIoV1alpha1(
