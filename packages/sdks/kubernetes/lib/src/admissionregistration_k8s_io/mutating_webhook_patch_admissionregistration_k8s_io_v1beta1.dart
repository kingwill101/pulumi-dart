...
class MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  final WebhookClientConfigPatchAdmissionregistrationK8sIoV1beta1? clientConfig;
  ...
  final List<RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1>? rules;
  ...
  /// Creates a new [MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?rules == null ? null : pulumi.Input.encodeList<RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1, Map<String, dynamic>>(rules!, (value) => value.toMap()),
      'sideEffects': ?sideEffects,
      'timeoutSeconds': ?timeoutSeconds,
    };
  }

  factory MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MutatingWebhookPatchAdmissionregistrationK8sIoV1beta1(
      admissionReviewVersions: map['admissionReviewVersions'] == null ? null : (map['admissionReviewVersions'] as List).cast<String>(),
      clientConfig: map['clientConfig'] == null ? null : WebhookClientConfigPatchAdmissionregistrationK8sIoV1beta1.fromMap((map['clientConfig'] as Map).cast<String, dynamic>()),
      ...
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1>(map['rules'], (value) => RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
