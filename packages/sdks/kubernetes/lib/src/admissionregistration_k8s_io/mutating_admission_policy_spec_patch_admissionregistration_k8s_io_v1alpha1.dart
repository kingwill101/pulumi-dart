...
import 'mutation_patch_admissionregistration_k8s_io_v1alpha1.dart';
...
class MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1 {
  ...
  final pulumi.Input<List<MutationPatchAdmissionregistrationK8sIoV1alpha1>>? mutations;
  ...
  /// Creates a new [MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1].
  ...
  const MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1({
    this.failurePolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mutations': ?pulumi.Input.mapOptionalInputValue<List<MutationPatchAdmissionregistrationK8sIoV1alpha1>, List<Map<String, dynamic>>>(mutations, (value) => pulumi.Input.encodeList<MutationPatchAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1alpha1(
      ...
      mutations: (() { final guardedValue = map['mutations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MutationPatchAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => MutationPatchAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
