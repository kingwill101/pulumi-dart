...
class MutatingAdmissionPolicyBindingPatch {
  ...
  /// Creates a new [MutatingAdmissionPolicyBindingPatch].
  ...
  const MutatingAdmissionPolicyBindingPatch({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory MutatingAdmissionPolicyBindingPatch.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyBindingPatch(
      apiVersion: (() { final guardedValue = map['apiVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kind: (() { final guardedValue = map['kind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectMetaPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MutatingAdmissionPolicyBindingSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
