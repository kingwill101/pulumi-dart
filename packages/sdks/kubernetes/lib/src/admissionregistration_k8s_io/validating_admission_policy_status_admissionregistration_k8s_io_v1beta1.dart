...
class ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<TypeCheckingAdmissionregistrationK8sIoV1beta1>?
  typeChecking;
  ...
  factory ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1(
      ...
      typeChecking: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TypeCheckingAdmissionregistrationK8sIoV1beta1.fromMap(
