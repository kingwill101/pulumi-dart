...
class ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1 {
  ...
  const ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1({
    this.conditions,
  ...
  factory ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1beta1(
      ...
      typeChecking: (() { final guardedValue = map['typeChecking']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypeCheckingAdmissionregistrationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
