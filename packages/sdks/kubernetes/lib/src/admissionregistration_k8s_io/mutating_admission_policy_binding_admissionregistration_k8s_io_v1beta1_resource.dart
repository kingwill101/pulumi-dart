...
class MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// Creates a new [MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource]. {@macro pulumi_admissionregistration_k8s_io_v1beta1_mutating_admission_policy_binding_admissionregistration_k8s_io_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource(
    String name, {
  ...
  /// Creates a typed reference to an existing [MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource] resource.
  MutatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:admissionregistration.k8s.io/v1beta1:MutatingAdmissionPolicyBinding',
