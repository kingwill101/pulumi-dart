...
class ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  factory ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicySpecPatchAdmissionregistrationK8sIoV1beta1(
      auditAnnotations: map['auditAnnotations'] == null ? null : (pulumi.Input.decodeList<AuditAnnotationPatchAdmissionregistrationK8sIoV1beta1>(map['auditAnnotations']!, (value) => AuditAnnotationPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      validations: map['validations'] == null ? null : (pulumi.Input.decodeList<ValidationPatchAdmissionregistrationK8sIoV1beta1>(map['validations']!, (value) => ValidationPatchAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
