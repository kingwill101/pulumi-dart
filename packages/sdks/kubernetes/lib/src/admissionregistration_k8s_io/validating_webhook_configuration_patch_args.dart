...
class ValidatingWebhookConfigurationPatchArgs {
  ...
  ValidatingWebhookConfigurationPatchArgs({
    ...
    pulumi.Output<List<ValidatingWebhookPatch>>? webhooks,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      webhooks = pulumi.Input.asOptionalInput<List<ValidatingWebhookPatch>>(webhooks);
  ...
  factory ValidatingWebhookConfigurationPatchArgs.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookConfigurationPatchArgs(
      ...
      webhooks: map['webhooks'] == null ? null : pulumi.Output.create<List<ValidatingWebhookPatch>>(pulumi.Input.decodeList<ValidatingWebhookPatch>(map['webhooks'], (value) => ValidatingWebhookPatch.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
