...
class ValidatingWebhookConfigurationResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>> webhooks;
  ...
  ValidatingWebhookConfigurationResource(
    ...
    webhooks = registerOutput<List<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>>('webhooks', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ValidatingWebhookAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => ValidatingWebhookAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())); });
  }

  /// Creates a typed reference to an existing [ValidatingWebhookConfigurationResource] resource.
  ValidatingWebhookConfigurationResource.reference(String urn)
    : super(
        'kubernetes:admissionregistration.k8s.io/v1beta1:ValidatingWebhookConfiguration',
