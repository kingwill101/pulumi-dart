...
class TypeCheckingPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<ExpressionWarningPatchAdmissionregistrationK8sIoV1beta1>
  >?
  expressionWarnings;
  ...
  TypeCheckingPatchAdmissionregistrationK8sIoV1beta1({this.expressionWarnings});
  ...
  factory TypeCheckingPatchAdmissionregistrationK8sIoV1beta1.fromMap(
      ...
      expressionWarnings: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ExpressionWarningPatchAdmissionregistrationK8sIoV1beta1.fromMap(
