...
/// {@template pulumi_admissionregistration_k8s_io_v1_mutating_admission_policy_binding_args_doc}
/// The set of arguments for MutatingAdmissionPolicyBinding.
/// {@endtemplate}
/// {@macro pulumi_admissionregistration_k8s_io_v1_mutating_admission_policy_binding_args_doc}
class MutatingAdmissionPolicyBindingArgs {
  ...
  const MutatingAdmissionPolicyBindingArgs({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
