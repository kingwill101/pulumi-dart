...
class MutatingAdmissionPolicyListAdmissionregistrationK8sIoV1beta1 {
  ...
  final pulumi.Input<
    List<MutatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1>
  >
  items;
  ...
  factory MutatingAdmissionPolicyListAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return MutatingAdmissionPolicyListAdmissionregistrationK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(
        ...
        >(
          map['items']!,
          (value) =>
              MutatingAdmissionPolicyAdmissionregistrationK8sIoV1beta1.fromMap(
