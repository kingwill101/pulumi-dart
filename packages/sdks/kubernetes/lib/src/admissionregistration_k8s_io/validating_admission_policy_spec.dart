    ...
    return <String, dynamic>{
      'auditAnnotations':
          ...
          >(
            auditAnnotations,
            (value) =>
                pulumi.Input.encodeList<AuditAnnotation, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'paramKind':
          ?pulumi.Input.mapOptionalInputValue<ParamKind, Map<String, dynamic>>(
            paramKind,
            (value) => value.toMap(),
          ),
      'validations':
          ...
          >(
            validations,
            (value) =>
                pulumi.Input.encodeList<Validation, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'variables':
          ...
          >(
            variables,
            (value) => pulumi.Input.encodeList<Variable, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return ValidatingAdmissionPolicySpec(
      auditAnnotations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuditAnnotation>(
            guardedValue,
            (value) =>
                AuditAnnotation.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      failurePolicy: (() {
      ...
      paramKind: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParamKind.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      validations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Validation>(
            guardedValue,
            (value) =>
                Validation.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      variables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Variable>(
            guardedValue,
            (value) => Variable.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
