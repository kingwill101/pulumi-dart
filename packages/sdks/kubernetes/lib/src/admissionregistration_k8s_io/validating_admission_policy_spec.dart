...
class ValidatingAdmissionPolicySpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auditAnnotations': ?auditAnnotations == null ? null : pulumi.Input.encodeList<AuditAnnotation, Map<String, dynamic>>(auditAnnotations!, (value) => value.toMap()),
      ...
      'validations': ?validations == null ? null : pulumi.Input.encodeList<Validation, Map<String, dynamic>>(validations!, (value) => value.toMap()),
      'variables': ?variables == null ? null : pulumi.Input.encodeList<Variable, Map<String, dynamic>>(variables!, (value) => value.toMap()),
    };
  }

  factory ValidatingAdmissionPolicySpec.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicySpec(
      auditAnnotations: map['auditAnnotations'] == null ? null : pulumi.Input.decodeList<AuditAnnotation>(map['auditAnnotations'], (value) => AuditAnnotation.fromMap((value as Map).cast<String, dynamic>())),
      ...
      matchConstraints: map['matchConstraints'] == null ? null : MatchResources.fromMap((map['matchConstraints'] as Map).cast<String, dynamic>()),
      paramKind: map['paramKind'] == null ? null : ParamKind.fromMap((map['paramKind'] as Map).cast<String, dynamic>()),
      validations: map['validations'] == null ? null : pulumi.Input.decodeList<Validation>(map['validations'], (value) => Validation.fromMap((value as Map).cast<String, dynamic>())),
      variables: map['variables'] == null ? null : pulumi.Input.decodeList<Variable>(map['variables'], (value) => Variable.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
