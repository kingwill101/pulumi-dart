...
class MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1 {
  ...
  factory MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1beta1(
      ...
      mutations: (() { final guardedValue = map['mutations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MutationAdmissionregistrationK8sIoV1beta1>(guardedValue, (value) => MutationAdmissionregistrationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
