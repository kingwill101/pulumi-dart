...
class RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  /// Creates a new [RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1].
  ...
  const RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1({
    this.apiGroups,
    this.apiVersions,
    this.operations,
    this.resources,
  ...
  factory RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return RuleWithOperationsPatchAdmissionregistrationK8sIoV1beta1(
