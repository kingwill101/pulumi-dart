...
class ValidationPatchAdmissionregistrationK8sIoV1beta1 {
  ...
  /// Creates a new [ValidationPatchAdmissionregistrationK8sIoV1beta1].
  ...
  const ValidationPatchAdmissionregistrationK8sIoV1beta1({
    this.expression,
    this.message,
  ...
  factory ValidationPatchAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidationPatchAdmissionregistrationK8sIoV1beta1(
      ...
      messageExpression: (() { final guardedValue = map['messageExpression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
