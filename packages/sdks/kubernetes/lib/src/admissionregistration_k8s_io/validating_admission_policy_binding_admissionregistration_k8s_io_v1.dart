...
class ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1
  ...
  ValidatingAdmissionPolicyBindingAdmissionregistrationK8sIoV1(
    ...
    spec = registerOutput<ValidatingAdmissionPolicyBindingSpec>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ValidatingAdmissionPolicyBindingSpec.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
