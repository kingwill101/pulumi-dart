...
class ValidatingWebhookConfigurationListArgs {
  ...
  final pulumi.Input<
    List<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1>
  >
  items;
  ...
  factory ValidatingWebhookConfigurationListArgs.fromMap(
    ...
    return ValidatingWebhookConfigurationListArgs(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1>(),
      ),
      kind: (() {
