...
class ValidatingWebhookConfigurationListArgs {
  ...
  ValidatingWebhookConfigurationListArgs({
    ...
    required pulumi.Output<List<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1>>(items),
  ...
  factory ValidatingWebhookConfigurationListArgs.fromMap(Map<String, dynamic> map) {
    return ValidatingWebhookConfigurationListArgs(
      ...
      items: pulumi.Output.create<List<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1>>((map['items'] as List).cast<ValidatingWebhookConfigurationAdmissionregistrationK8sIoV1>()),
