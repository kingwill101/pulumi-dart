...
class TypeChecking {
  ...
  factory TypeChecking.fromMap(Map<String, dynamic> map) {
    return TypeChecking(
      expressionWarnings: (() { final guardedValue = map['expressionWarnings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExpressionWarning>(guardedValue, (value) => ExpressionWarning.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
