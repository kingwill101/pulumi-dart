...
class ValidatingAdmissionPolicyResource extends pulumi.CustomResource {
  ...
  ValidatingAdmissionPolicyResource(
    ...
    spec = registerOutput<ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ValidatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    status = registerOutput<ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1alpha1?>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ValidatingAdmissionPolicyStatusAdmissionregistrationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [ValidatingAdmissionPolicyResource] resource.
  ValidatingAdmissionPolicyResource.reference(String urn)
    : super(
        'kubernetes:admissionregistration.k8s.io/v1alpha1:ValidatingAdmissionPolicy',
