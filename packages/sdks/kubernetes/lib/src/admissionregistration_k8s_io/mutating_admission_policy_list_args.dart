...
class MutatingAdmissionPolicyListArgs {
  ...
  MutatingAdmissionPolicyListArgs({
    ...
    required pulumi.Output<List<MutatingAdmissionPolicyAdmissionregistrationK8sIoV1alpha1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<MutatingAdmissionPolicyAdmissionregistrationK8sIoV1alpha1>>(items),
  ...
  factory MutatingAdmissionPolicyListArgs.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyListArgs(
      ...
      items: pulumi.Output.create<List<MutatingAdmissionPolicyAdmissionregistrationK8sIoV1alpha1>>((map['items'] as List).cast<MutatingAdmissionPolicyAdmissionregistrationK8sIoV1alpha1>()),
