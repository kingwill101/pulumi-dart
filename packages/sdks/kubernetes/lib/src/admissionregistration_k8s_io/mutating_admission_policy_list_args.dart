...
class MutatingAdmissionPolicyListArgs {
  ...
  final pulumi.Input<List<MutatingAdmissionPolicy>> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<MutatingAdmissionPolicy>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<MutatingAdmissionPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory MutatingAdmissionPolicyListArgs.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicyListArgs(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<MutatingAdmissionPolicy>(map['items']!, (value) => MutatingAdmissionPolicy.fromMap((value as Map).cast<String, dynamic>()))),
