...
import 'mutation_admissionregistration_k8s_io_v1alpha1.dart';
...
class MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1 {
  ...
  final pulumi.Input<List<MutationAdmissionregistrationK8sIoV1alpha1>>? mutations;
  ...
  /// Creates a new [MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1].
  ...
  const MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1({
    this.failurePolicy,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mutations': ?pulumi.Input.mapOptionalInputValue<List<MutationAdmissionregistrationK8sIoV1alpha1>, List<Map<String, dynamic>>>(mutations, (value) => pulumi.Input.encodeList<MutationAdmissionregistrationK8sIoV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return MutatingAdmissionPolicySpecAdmissionregistrationK8sIoV1alpha1(
      ...
      mutations: (() { final guardedValue = map['mutations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MutationAdmissionregistrationK8sIoV1alpha1>(guardedValue, (value) => MutationAdmissionregistrationK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))); })(),
