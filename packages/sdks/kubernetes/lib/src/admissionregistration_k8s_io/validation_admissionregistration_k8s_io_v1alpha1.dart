...
class ValidationAdmissionregistrationK8sIoV1alpha1 {
  ...
  /// Creates a new [ValidationAdmissionregistrationK8sIoV1alpha1].
  ...
  const ValidationAdmissionregistrationK8sIoV1alpha1({
  ...
  factory ValidationAdmissionregistrationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ValidationAdmissionregistrationK8sIoV1alpha1(
