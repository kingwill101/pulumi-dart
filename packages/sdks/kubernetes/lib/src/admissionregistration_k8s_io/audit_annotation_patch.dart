...
class AuditAnnotationPatch {
  ...
  /// Creates a new [AuditAnnotationPatch].
  ...
  factory AuditAnnotationPatch.fromMap(Map<String, dynamic> map) {
    return AuditAnnotationPatch(
      ...
      valueExpression: (() { final guardedValue = map['valueExpression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
