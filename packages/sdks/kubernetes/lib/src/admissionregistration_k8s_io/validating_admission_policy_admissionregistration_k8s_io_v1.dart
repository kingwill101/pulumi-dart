...
class ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1 extends pulumi.CustomResource {
  ...
  ValidatingAdmissionPolicyAdmissionregistrationK8sIoV1(
    ...
    this.spec = registerOutput<ValidatingAdmissionPolicySpec>('spec');
    this.status = registerOutput<ValidatingAdmissionPolicyStatus?>('status');
  }
}
