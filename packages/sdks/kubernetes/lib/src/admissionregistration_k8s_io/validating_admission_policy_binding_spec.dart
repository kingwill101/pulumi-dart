...
class ValidatingAdmissionPolicyBindingSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'paramRef':
          ?pulumi.Input.mapOptionalInputValue<ParamRef, Map<String, dynamic>>(
            paramRef,
            (value) => value.toMap(),
          ),
  ...
  factory ValidatingAdmissionPolicyBindingSpec.fromMap(
    ...
    return ValidatingAdmissionPolicyBindingSpec(
      matchResources: (() {
        ...
        return pulumi.Input.fromValue(
          MatchResources.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      paramRef: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParamRef.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      policyName: (() {
