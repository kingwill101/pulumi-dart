...
class ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1 {
  ...
  const ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1({
    this.matchResources,
    this.paramRef,
    this.policyName,
  ...
  factory ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1(
      matchResources: (() { final guardedValue = map['matchResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MatchResourcesAdmissionregistrationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      paramRef: (() { final guardedValue = map['paramRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParamRefAdmissionregistrationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
