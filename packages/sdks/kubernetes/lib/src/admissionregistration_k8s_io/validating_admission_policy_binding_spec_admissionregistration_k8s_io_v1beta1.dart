...
class ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'paramRef':
          ?pulumi.Input.mapOptionalInputValue<
            ParamRefAdmissionregistrationK8sIoV1beta1,
            Map<String, dynamic>
  ...
  factory ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1.fromMap(
    ...
    return ValidatingAdmissionPolicyBindingSpecAdmissionregistrationK8sIoV1beta1(
      ...
      paramRef: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParamRefAdmissionregistrationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
