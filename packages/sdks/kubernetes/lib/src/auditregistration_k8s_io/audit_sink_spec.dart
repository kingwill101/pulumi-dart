...
class AuditSinkSpec {
  ...
  AuditSinkSpec({required this.policy, required this.webhook});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'policy': pulumi.Input.mapInputValue<Policy, Map<String, dynamic>>(
        policy,
        (value) => value.toMap(),
      ),
      'webhook': pulumi.Input.mapInputValue<Webhook, Map<String, dynamic>>(
        webhook,
        (value) => value.toMap(),
      ),
    };
  ...
  factory AuditSinkSpec.fromMap(Map<String, dynamic> map) {
    return AuditSinkSpec(
      policy: pulumi.Input.fromValue(
        Policy.fromMap((map['policy']! as Map).cast<String, dynamic>()),
      ),
      webhook: pulumi.Input.fromValue(
        Webhook.fromMap((map['webhook']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
