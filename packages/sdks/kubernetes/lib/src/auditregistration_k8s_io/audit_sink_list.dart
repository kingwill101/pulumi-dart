...
class AuditSinkList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items':
          pulumi
              .Input.mapInputValue<List<AuditSink>, List<Map<String, dynamic>>>(
            items,
            (value) => pulumi.Input.encodeList<AuditSink, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory AuditSinkList.fromMap(Map<String, dynamic> map) {
    return AuditSinkList(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AuditSink>(
          map['items']!,
          (value) => AuditSink.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      kind: (() {
