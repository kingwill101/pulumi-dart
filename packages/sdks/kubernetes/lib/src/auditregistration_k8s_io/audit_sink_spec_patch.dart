...
class AuditSinkSpecPatch {
  ...
  AuditSinkSpecPatch({this.policy, this.webhook});
    ...
    return AuditSinkSpecPatch(
      policy: (() {
        ...
        return pulumi.Input.fromValue(
          PolicyPatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      webhook: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WebhookPatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
