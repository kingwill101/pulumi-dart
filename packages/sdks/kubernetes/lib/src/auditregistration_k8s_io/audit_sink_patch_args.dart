...
class AuditSinkPatchArgs {
  ...
  AuditSinkPatchArgs({
    ...
    pulumi.Output<AuditSinkSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<AuditSinkSpecPatch>(spec);
  ...
  factory AuditSinkPatchArgs.fromMap(Map<String, dynamic> map) {
    return AuditSinkPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<AuditSinkSpecPatch>(AuditSinkSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
