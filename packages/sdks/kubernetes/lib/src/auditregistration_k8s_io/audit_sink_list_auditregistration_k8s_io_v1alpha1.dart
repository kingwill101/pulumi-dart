...
class AuditSinkListAuditregistrationK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<AuditSink>> items;
  ...
  AuditSinkListAuditregistrationK8sIoV1alpha1(
    ...
    items = registerOutput<List<AuditSink>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<AuditSink>(guardedValue, (value) => AuditSink.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [AuditSinkListAuditregistrationK8sIoV1alpha1] resource.
  AuditSinkListAuditregistrationK8sIoV1alpha1.reference(String urn)
    : super(
        'kubernetes:auditregistration.k8s.io/v1alpha1:AuditSinkList',
