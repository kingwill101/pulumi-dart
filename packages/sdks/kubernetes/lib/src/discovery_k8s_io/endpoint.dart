...
class Endpoint {
  ...
  factory Endpoint.fromMap(Map<String, dynamic> map) {
    return Endpoint(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointConditions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      hints: (() { final guardedValue = map['hints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointHints.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
