...
class EndpointSlicePatchArgs {
  ...
  EndpointSlicePatchArgs({
    ...
    pulumi.Output<List<EndpointPatch>>? endpoints,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMetaPatch>? metadata,
    pulumi.Output<List<EndpointPortPatch>>? ports,
  }) :
  ...
  factory EndpointSlicePatchArgs.fromMap(Map<String, dynamic> map) {
    return EndpointSlicePatchArgs(
      ...
      endpoints: map['endpoints'] == null ? null : pulumi.Output.create<List<EndpointPatch>>(pulumi.Input.decodeList<EndpointPatch>(map['endpoints'], (value) => EndpointPatch.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ports: map['ports'] == null ? null : pulumi.Output.create<List<EndpointPortPatch>>(pulumi.Input.decodeList<EndpointPortPatch>(map['ports'], (value) => EndpointPortPatch.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
