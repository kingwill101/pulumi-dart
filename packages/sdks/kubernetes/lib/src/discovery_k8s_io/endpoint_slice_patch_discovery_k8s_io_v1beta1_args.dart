...
class EndpointSlicePatchDiscoveryK8sIoV1beta1Args {
    ...
    return <String, dynamic>{
      ...
      'endpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointPatchDiscoveryK8sIoV1beta1>,
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointPortPatchDiscoveryK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
  ...
  factory EndpointSlicePatchDiscoveryK8sIoV1beta1Args.fromMap(
    ...
    return EndpointSlicePatchDiscoveryK8sIoV1beta1Args(
      ...
      endpoints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPatchDiscoveryK8sIoV1beta1>(
            guardedValue,
            (value) => EndpointPatchDiscoveryK8sIoV1beta1.fromMap(
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPortPatchDiscoveryK8sIoV1beta1>(
            guardedValue,
            (value) => EndpointPortPatchDiscoveryK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
