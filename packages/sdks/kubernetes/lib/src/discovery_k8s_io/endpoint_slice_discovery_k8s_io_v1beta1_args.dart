...
class EndpointSliceDiscoveryK8sIoV1beta1Args {
    ...
    return <String, dynamic>{
      ...
      'endpoints':
          pulumi.Input.mapInputValue<
            List<EndpointDiscoveryK8sIoV1beta1>,
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointPortDiscoveryK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
                pulumi.Input.encodeList<
                  EndpointPortDiscoveryK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    };
  ...
  factory EndpointSliceDiscoveryK8sIoV1beta1Args.fromMap(
    ...
    return EndpointSliceDiscoveryK8sIoV1beta1Args(
      ...
      endpoints: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EndpointDiscoveryK8sIoV1beta1>(
          map['endpoints']!,
          (value) => EndpointDiscoveryK8sIoV1beta1.fromMap(
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPortDiscoveryK8sIoV1beta1>(
            guardedValue,
            (value) => EndpointPortDiscoveryK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
