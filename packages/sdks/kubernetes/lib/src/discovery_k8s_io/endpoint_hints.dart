...
class EndpointHints {
  ...
  factory EndpointHints.fromMap(Map<String, dynamic> map) {
    return EndpointHints(
      forNodes: (() { final guardedValue = map['forNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ForNode>(guardedValue, (value) => ForNode.fromMap((value as Map).cast<String, dynamic>()))); })(),
      forZones: (() { final guardedValue = map['forZones']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ForZone>(guardedValue, (value) => ForZone.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
