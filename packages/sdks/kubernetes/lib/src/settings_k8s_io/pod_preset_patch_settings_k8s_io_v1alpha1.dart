...
class PodPresetPatchSettingsK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  PodPresetPatchSettingsK8sIoV1alpha1(
    ...
    spec = registerOutput<PodPresetSpecPatch?>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PodPresetSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [PodPresetPatchSettingsK8sIoV1alpha1] resource.
  PodPresetPatchSettingsK8sIoV1alpha1.reference(String urn)
    : super(
        'kubernetes:settings.k8s.io/v1alpha1:PodPresetPatch',
