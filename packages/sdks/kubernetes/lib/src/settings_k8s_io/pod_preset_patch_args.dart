...
class PodPresetPatchArgs {
  ...
  PodPresetPatchArgs({
    ...
    pulumi.Output<PodPresetSpecPatch>? spec,
  }) :
  ...
  factory PodPresetPatchArgs.fromMap(Map<String, dynamic> map) {
    return PodPresetPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PodPresetSpecPatch>(PodPresetSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
