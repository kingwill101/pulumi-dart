...
class IngressPatchNetworkingK8sIoV1beta1 {
  ...
  final IngressSpecPatchNetworkingK8sIoV1beta1? spec;
  /// Status is the current state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final IngressStatusPatchNetworkingK8sIoV1beta1? status;
  ...
  IngressPatchNetworkingK8sIoV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory IngressPatchNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return IngressPatchNetworkingK8sIoV1beta1(
      ...
      spec: map['spec'] == null ? null : IngressSpecPatchNetworkingK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : IngressStatusPatchNetworkingK8sIoV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
