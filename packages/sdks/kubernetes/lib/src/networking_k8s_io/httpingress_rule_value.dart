    ...
    return <String, dynamic>{
      'paths':
          ...
          >(
            paths,
            (value) =>
                pulumi.Input.encodeList<HTTPIngressPath, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory HTTPIngressRuleValue.fromMap(Map<String, dynamic> map) {
    return HTTPIngressRuleValue(
      paths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HTTPIngressPath>(
          map['paths']!,
          (value) =>
              HTTPIngressPath.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
