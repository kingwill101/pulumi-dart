...
class IngressRuleNetworkingK8sIoV1beta1 {
  ...
  final pulumi.Input<HTTPIngressRuleValueNetworkingK8sIoV1beta1>? http;
  ...
  /// [http] Optional.
  const IngressRuleNetworkingK8sIoV1beta1({
    this.host,
    this.http,
  });
  ...
  factory IngressRuleNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return IngressRuleNetworkingK8sIoV1beta1(
      ...
      http: (() { final guardedValue = map['http']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HTTPIngressRuleValueNetworkingK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
