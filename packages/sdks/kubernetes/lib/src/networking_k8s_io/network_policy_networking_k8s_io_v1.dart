...
class NetworkPolicyNetworkingK8sIoV1 extends pulumi.CustomResource {
  ...
  NetworkPolicyNetworkingK8sIoV1(
    ...
    spec = registerOutput<NetworkPolicySpec>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NetworkPolicySpec.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    status = registerOutput<NetworkPolicyStatus?>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NetworkPolicyStatus.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [NetworkPolicyNetworkingK8sIoV1] resource.
  NetworkPolicyNetworkingK8sIoV1.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1:NetworkPolicy',
