...
class IngressClassListResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<IngressClassNetworkingK8sIoV1beta1>> items;
  ...
  IngressClassListResource(
    ...
    items = registerOutput<List<IngressClassNetworkingK8sIoV1beta1>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<IngressClassNetworkingK8sIoV1beta1>(guardedValue, (value) => IngressClassNetworkingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [IngressClassListResource] resource.
  IngressClassListResource.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1beta1:IngressClassList',
