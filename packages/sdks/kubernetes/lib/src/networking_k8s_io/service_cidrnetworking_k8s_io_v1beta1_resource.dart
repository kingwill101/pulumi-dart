...
class ServiceCIDRNetworkingK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  ServiceCIDRNetworkingK8sIoV1beta1Resource(
    ...
    spec = registerOutput<ServiceCIDRSpecNetworkingK8sIoV1beta1>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ServiceCIDRSpecNetworkingK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<ServiceCIDRStatusNetworkingK8sIoV1beta1?>(
      'status',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ServiceCIDRStatusNetworkingK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
