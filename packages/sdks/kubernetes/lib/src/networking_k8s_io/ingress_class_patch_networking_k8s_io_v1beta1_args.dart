...
class IngressClassPatchNetworkingK8sIoV1beta1Args {
  ...
  IngressClassPatchNetworkingK8sIoV1beta1Args({
    ...
    pulumi.Output<IngressClassSpecPatchNetworkingK8sIoV1beta1>? spec,
  }) :
  ...
  factory IngressClassPatchNetworkingK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IngressClassPatchNetworkingK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<IngressClassSpecPatchNetworkingK8sIoV1beta1>(IngressClassSpecPatchNetworkingK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
