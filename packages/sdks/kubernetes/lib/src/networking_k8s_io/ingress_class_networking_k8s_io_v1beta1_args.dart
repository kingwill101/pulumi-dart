...
class IngressClassNetworkingK8sIoV1beta1Args {
  ...
  IngressClassNetworkingK8sIoV1beta1Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMeta>? metadata,
    pulumi.Output<IngressClassSpecNetworkingK8sIoV1beta1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<IngressClassSpecNetworkingK8sIoV1beta1>(spec);
  ...
  factory IngressClassNetworkingK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IngressClassNetworkingK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<IngressClassSpecNetworkingK8sIoV1beta1>(IngressClassSpecNetworkingK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
