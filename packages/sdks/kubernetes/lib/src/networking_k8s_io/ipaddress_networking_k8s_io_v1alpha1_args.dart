...
class IPAddressNetworkingK8sIoV1alpha1Args {
  ...
  IPAddressNetworkingK8sIoV1alpha1Args({
    ...
    pulumi.Output<IPAddressSpecNetworkingK8sIoV1alpha1>? spec,
  }) :
  ...
  factory IPAddressNetworkingK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return IPAddressNetworkingK8sIoV1alpha1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<IPAddressSpecNetworkingK8sIoV1alpha1>(IPAddressSpecNetworkingK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
