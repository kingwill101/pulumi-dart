...
class ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1 {
  /// CIDRs defines the IP blocks in CIDR notation (e.g. "192.168.0.0/24" or "2001:db8::/64") from which to assign service cluster IPs. Max of two CIDRs is allowed, one of each IP family. This field is immutable.
  final pulumi.Input<List<String>>? cidrs;

  /// Creates a new [ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1].
  ...
  const ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1({
    this.cidrs,
  });
  ...
  factory ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1(
