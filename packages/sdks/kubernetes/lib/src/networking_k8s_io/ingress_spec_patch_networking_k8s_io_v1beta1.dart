...
class IngressSpecPatchNetworkingK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<IngressRulePatchNetworkingK8sIoV1beta1>,
      ...
      'tls':
          ?pulumi.Input.mapOptionalInputValue<
            List<IngressTLSPatchNetworkingK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            tls,
            (value) =>
                pulumi.Input.encodeList<
                  IngressTLSPatchNetworkingK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    };
  ...
  factory IngressSpecPatchNetworkingK8sIoV1beta1.fromMap(
    ...
    return IngressSpecPatchNetworkingK8sIoV1beta1(
      backend: (() {
        ...
        return pulumi.Input.fromValue(
          IngressBackendPatchNetworkingK8sIoV1beta1.fromMap(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngressRulePatchNetworkingK8sIoV1beta1>(
            guardedValue,
            (value) => IngressRulePatchNetworkingK8sIoV1beta1.fromMap(
      ...
      tls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngressTLSPatchNetworkingK8sIoV1beta1>(
            guardedValue,
            (value) => IngressTLSPatchNetworkingK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
