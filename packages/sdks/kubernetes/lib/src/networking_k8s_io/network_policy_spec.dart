...
class NetworkPolicySpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'podSelector':
          pulumi.Input.mapInputValue<LabelSelector, Map<String, dynamic>>(
            podSelector,
            (value) => value.toMap(),
          ),
      'policyTypes': ?policyTypes,
    ...
    return NetworkPolicySpec(
      egress: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPolicyEgressRule>(
            guardedValue,
            (value) => NetworkPolicyEgressRule.fromMap(
      ...
      ingress: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPolicyIngressRule>(
            guardedValue,
            (value) => NetworkPolicyIngressRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      podSelector: pulumi.Input.fromValue(
        LabelSelector.fromMap(
          (map['podSelector']! as Map).cast<String, dynamic>(),
        ),
      ),
      policyTypes: (() {
        final guardedValue = map['policyTypes'];
        if (guardedValue == null) return null;
