...
class ClusterCIDRListArgs {
  ...
  ClusterCIDRListArgs({
    ...
    required pulumi.Output<List<ClusterCIDRNetworkingK8sIoV1alpha1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ClusterCIDRNetworkingK8sIoV1alpha1>>(items),
  ...
  factory ClusterCIDRListArgs.fromMap(Map<String, dynamic> map) {
    return ClusterCIDRListArgs(
      ...
      items: pulumi.Output.create<List<ClusterCIDRNetworkingK8sIoV1alpha1>>((map['items'] as List).cast<ClusterCIDRNetworkingK8sIoV1alpha1>()),
