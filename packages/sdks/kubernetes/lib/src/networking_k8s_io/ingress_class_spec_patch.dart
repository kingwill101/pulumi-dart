...
class IngressClassSpecPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parameters': ?pulumi.Input.mapOptionalInputValue<IngressClassParametersReferencePatch, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory IngressClassSpecPatch.fromMap(Map<String, dynamic> map) {
    return IngressClassSpecPatch(
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressClassParametersReferencePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
