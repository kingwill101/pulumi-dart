...
class IngressClassSpecPatchNetworkingK8sIoV1beta1 {
  ...
  final pulumi.Input<TypedLocalObjectReferencePatch>? parameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parameters': ?pulumi.Input.mapOptionalInputValue<TypedLocalObjectReferencePatch, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory IngressClassSpecPatchNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return IngressClassSpecPatchNetworkingK8sIoV1beta1(
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypedLocalObjectReferencePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
