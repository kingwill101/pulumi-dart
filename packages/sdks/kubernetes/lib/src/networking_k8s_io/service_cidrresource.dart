...
class ServiceCIDRResource extends pulumi.CustomResource {
  ...
  ServiceCIDRResource(
    ...
    spec = registerOutput<ServiceCIDRSpecNetworkingK8sIoV1alpha1>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceCIDRSpecNetworkingK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    status = registerOutput<ServiceCIDRStatusNetworkingK8sIoV1alpha1?>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceCIDRStatusNetworkingK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [ServiceCIDRResource] resource.
  ServiceCIDRResource.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1alpha1:ServiceCIDR',
