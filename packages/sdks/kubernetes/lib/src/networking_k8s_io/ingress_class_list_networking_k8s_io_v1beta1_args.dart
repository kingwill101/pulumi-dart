...
class IngressClassListNetworkingK8sIoV1beta1Args {
  ...
  const IngressClassListNetworkingK8sIoV1beta1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<IngressClassNetworkingK8sIoV1beta1>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<IngressClassNetworkingK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory IngressClassListNetworkingK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IngressClassListNetworkingK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<IngressClassNetworkingK8sIoV1beta1>(map['items']!, (value) => IngressClassNetworkingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
