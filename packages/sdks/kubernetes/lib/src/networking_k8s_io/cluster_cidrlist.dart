...
class ClusterCIDRList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<ClusterCIDR, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory ClusterCIDRList.fromMap(Map<String, dynamic> map) {
    return ClusterCIDRList(
      ...
      items: pulumi.Input.decodeList<ClusterCIDR>(map['items'], (value) => ClusterCIDR.fromMap((value as Map).cast<String, dynamic>())),
