...
class IngressClassNetworkingK8sIoV1 extends pulumi.CustomResource {
  ...
  IngressClassNetworkingK8sIoV1(
    ...
    spec = registerOutput<IngressClassSpec>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return IngressClassSpec.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [IngressClassNetworkingK8sIoV1] resource.
  IngressClassNetworkingK8sIoV1.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1:IngressClass',
