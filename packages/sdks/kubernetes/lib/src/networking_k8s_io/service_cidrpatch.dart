...
class ServiceCIDRPatch {
  ...
  final ServiceCIDRSpecPatch? spec;
  /// status represents the current state of the ServiceCIDR. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final ServiceCIDRStatusPatch? status;
  ...
  factory ServiceCIDRPatch.fromMap(Map<String, dynamic> map) {
    return ServiceCIDRPatch(
      ...
      status: map['status'] == null ? null : ServiceCIDRStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
