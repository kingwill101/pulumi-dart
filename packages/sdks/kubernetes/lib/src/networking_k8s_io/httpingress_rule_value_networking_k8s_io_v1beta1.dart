...
class HTTPIngressRuleValueNetworkingK8sIoV1beta1 {
  ...
  final List<HTTPIngressPathNetworkingK8sIoV1beta1> paths;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'paths': pulumi.Input.encodeList<HTTPIngressPathNetworkingK8sIoV1beta1, Map<String, dynamic>>(paths, (value) => value.toMap()),
    };
  }
  ...
  factory HTTPIngressRuleValueNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return HTTPIngressRuleValueNetworkingK8sIoV1beta1(
      paths: pulumi.Input.decodeList<HTTPIngressPathNetworkingK8sIoV1beta1>(map['paths'], (value) => HTTPIngressPathNetworkingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
