...
class IngressClassPatch {
  ...
  /// Creates a new [IngressClassPatch].
  ...
  factory IngressClassPatch.fromMap(Map<String, dynamic> map) {
    return IngressClassPatch(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressClassSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
