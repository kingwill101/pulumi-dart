...
class IngressSpecNetworkingK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<IngressRuleNetworkingK8sIoV1beta1>,
      ...
      'tls':
          ?pulumi.Input.mapOptionalInputValue<
            List<IngressTLSNetworkingK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            tls,
            (value) =>
                pulumi.Input.encodeList<
                  IngressTLSNetworkingK8sIoV1beta1,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    };
    ...
    return IngressSpecNetworkingK8sIoV1beta1(
      backend: (() {
        ...
        return pulumi.Input.fromValue(
          IngressBackendNetworkingK8sIoV1beta1.fromMap(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngressRuleNetworkingK8sIoV1beta1>(
            guardedValue,
            (value) => IngressRuleNetworkingK8sIoV1beta1.fromMap(
      ...
      tls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngressTLSNetworkingK8sIoV1beta1>(
            guardedValue,
            (value) => IngressTLSNetworkingK8sIoV1beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
