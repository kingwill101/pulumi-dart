...
class ServiceCIDRPatchNetworkingK8sIoV1alpha1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<ServiceCIDRStatusPatchNetworkingK8sIoV1alpha1, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory ServiceCIDRPatchNetworkingK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ServiceCIDRPatchNetworkingK8sIoV1alpha1(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceCIDRStatusPatchNetworkingK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
