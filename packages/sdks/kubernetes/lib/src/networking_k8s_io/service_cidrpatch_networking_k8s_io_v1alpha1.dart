...
class ServiceCIDRPatchNetworkingK8sIoV1alpha1 {
  ...
  factory ServiceCIDRPatchNetworkingK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return ServiceCIDRPatchNetworkingK8sIoV1alpha1(
      ...
      spec: map['spec'] == null ? null : (ServiceCIDRSpecPatchNetworkingK8sIoV1alpha1.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (ServiceCIDRStatusPatchNetworkingK8sIoV1alpha1.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
