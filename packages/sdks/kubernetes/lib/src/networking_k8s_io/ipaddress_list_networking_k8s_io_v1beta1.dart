...
class IPAddressListNetworkingK8sIoV1beta1 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<IPAddressNetworkingK8sIoV1beta1>,
  ...
  factory IPAddressListNetworkingK8sIoV1beta1.fromMap(
    ...
    return IPAddressListNetworkingK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IPAddressNetworkingK8sIoV1beta1>(
          map['items']!,
          (value) => IPAddressNetworkingK8sIoV1beta1.fromMap(
