...
class ServiceCIDRNetworkingK8sIoV1alpha1Args {
  ...
  ServiceCIDRNetworkingK8sIoV1alpha1Args({
    ...
    pulumi.Output<ServiceCIDRSpecNetworkingK8sIoV1alpha1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<ServiceCIDRSpecNetworkingK8sIoV1alpha1>(spec);
  ...
  factory ServiceCIDRNetworkingK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return ServiceCIDRNetworkingK8sIoV1alpha1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ServiceCIDRSpecNetworkingK8sIoV1alpha1>(ServiceCIDRSpecNetworkingK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
