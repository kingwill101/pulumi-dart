...
class IPAddress {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': ?pulumi.Input.mapOptionalInputValue<IPAddressSpec, Map<String, dynamic>>(spec, (value) => value.toMap()),
    };
  }
  ...
  factory IPAddress.fromMap(Map<String, dynamic> map) {
    return IPAddress(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IPAddressSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
