...
class IngressClassListNetworkingK8sIoV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<IngressClass>> items;
  ...
  IngressClassListNetworkingK8sIoV1(
    ...
    items = registerOutput<List<IngressClass>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<IngressClass>(guardedValue, (value) => IngressClass.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [IngressClassListNetworkingK8sIoV1] resource.
  IngressClassListNetworkingK8sIoV1.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1:IngressClassList',
