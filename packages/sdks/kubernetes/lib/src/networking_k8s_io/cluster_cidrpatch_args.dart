...
class ClusterCIDRPatchArgs {
  ...
  factory ClusterCIDRPatchArgs.fromMap(Map<String, dynamic> map) {
    return ClusterCIDRPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ClusterCIDRSpecPatch>(ClusterCIDRSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
