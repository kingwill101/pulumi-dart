    ...
    return <String, dynamic>{
      'egress':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkPolicyEgressRulePatch>,
      ...
      'ingress':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkPolicyIngressRulePatch>,
            List<Map<String, dynamic>>
          >(
            ingress,
            (value) =>
    ...
    return NetworkPolicySpecPatch(
      egress: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPolicyEgressRulePatch>(
            guardedValue,
            (value) => NetworkPolicyEgressRulePatch.fromMap(
      ...
      ingress: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPolicyIngressRulePatch>(
            guardedValue,
            (value) => NetworkPolicyIngressRulePatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
