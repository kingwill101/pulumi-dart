...
class IPAddressListNetworkingK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<IPAddressNetworkingK8sIoV1beta1>> items;
  ...
  const IPAddressListNetworkingK8sIoV1beta1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<IPAddressNetworkingK8sIoV1beta1>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<IPAddressNetworkingK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory IPAddressListNetworkingK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return IPAddressListNetworkingK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<IPAddressNetworkingK8sIoV1beta1>(map['items']!, (value) => IPAddressNetworkingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
