...
class IPAddressListNetworkingK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<IPAddressNetworkingK8sIoV1beta1>> items;
  ...
  IPAddressListNetworkingK8sIoV1beta1Resource(
    ...
    items = registerOutput<List<IPAddressNetworkingK8sIoV1beta1>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<IPAddressNetworkingK8sIoV1beta1>(guardedValue, (value) => IPAddressNetworkingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [IPAddressListNetworkingK8sIoV1beta1Resource] resource.
  IPAddressListNetworkingK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1beta1:IPAddressList',
