...
class IPAddressArgs {
  ...
  IPAddressArgs({
    ...
    pulumi.Output<IPAddressSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<IPAddressSpec>(spec);
  ...
  factory IPAddressArgs.fromMap(Map<String, dynamic> map) {
    return IPAddressArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<IPAddressSpec>(IPAddressSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
