...
class IPAddressPatchResource extends pulumi.CustomResource {
  ...
  IPAddressPatchResource(
    ...
    spec = registerOutput<IPAddressSpecPatchNetworkingK8sIoV1alpha1?>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return IPAddressSpecPatchNetworkingK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [IPAddressPatchResource] resource.
  IPAddressPatchResource.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1alpha1:IPAddressPatch',
