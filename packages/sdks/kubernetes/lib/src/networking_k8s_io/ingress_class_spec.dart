...
class IngressClassSpec {
  ...
  final pulumi.Input<IngressClassParametersReference?>? parameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'parameters': ?pulumi.Input.mapOptionalInputValue<IngressClassParametersReference, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory IngressClassSpec.fromMap(Map<String, dynamic> map) {
    return IngressClassSpec(
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressClassParametersReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
