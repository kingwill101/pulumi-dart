...
class IPAddressSpecNetworkingK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parentRef': pulumi.Input.mapInputValue<ParentReferenceNetworkingK8sIoV1beta1, Map<String, dynamic>>(parentRef, (value) => value.toMap()),
    };
  }

  factory IPAddressSpecNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return IPAddressSpecNetworkingK8sIoV1beta1(
      parentRef: pulumi.Input.fromValue(ParentReferenceNetworkingK8sIoV1beta1.fromMap((map['parentRef']! as Map).cast<String, dynamic>())),
    );
  }
}
