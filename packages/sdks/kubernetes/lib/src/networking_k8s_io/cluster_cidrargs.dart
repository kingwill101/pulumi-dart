...
class ClusterCIDRArgs {
  ...
  ClusterCIDRArgs({
    ...
    pulumi.Output<ClusterCIDRSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<ClusterCIDRSpec>(spec);
  ...
  factory ClusterCIDRArgs.fromMap(Map<String, dynamic> map) {
    return ClusterCIDRArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ClusterCIDRSpec>(ClusterCIDRSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
