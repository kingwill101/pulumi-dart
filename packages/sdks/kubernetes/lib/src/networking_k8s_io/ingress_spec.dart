...
class IngressSpec {
    ...
    return <String, dynamic>{
      'defaultBackend':
          ?pulumi.Input.mapOptionalInputValue<
            IngressBackend,
            Map<String, dynamic>
          >(defaultBackend, (value) => value.toMap()),
      ...
      'tls':
          ...
          >(
            tls,
            (value) =>
                pulumi.Input.encodeList<IngressTLS, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory IngressSpec.fromMap(Map<String, dynamic> map) {
    return IngressSpec(
      defaultBackend: (() {
        final guardedValue = map['defaultBackend'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IngressBackend.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ingressClassName: (() {
      ...
      tls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngressTLS>(
            guardedValue,
            (value) =>
                IngressTLS.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
