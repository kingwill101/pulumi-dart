...
class ServiceCIDRNetworkingK8sIoV1 extends pulumi.CustomResource {
  ...
  ServiceCIDRNetworkingK8sIoV1(
    ...
    spec = registerOutput<ServiceCIDRSpec>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceCIDRSpec.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    status = registerOutput<ServiceCIDRStatus?>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceCIDRStatus.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [ServiceCIDRNetworkingK8sIoV1] resource.
  ServiceCIDRNetworkingK8sIoV1.reference(String urn)
    : super(
        'kubernetes:networking.k8s.io/v1:ServiceCIDR',
