...
class IngressTLSNetworkingK8sIoV1beta1 {
  ...
  /// Creates a new [IngressTLSNetworkingK8sIoV1beta1].
  ...
  IngressTLSNetworkingK8sIoV1beta1({this.hosts, this.secretName});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'hosts': ?hosts, 'secretName': ?secretName};
  }

  factory IngressTLSNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return IngressTLSNetworkingK8sIoV1beta1(
      hosts: (() {
