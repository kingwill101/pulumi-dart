...
class IngressClassList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<IngressClass, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory IngressClassList.fromMap(Map<String, dynamic> map) {
    return IngressClassList(
      ...
      items: pulumi.Input.decodeList<IngressClass>(map['items'], (value) => IngressClass.fromMap((value as Map).cast<String, dynamic>())),
