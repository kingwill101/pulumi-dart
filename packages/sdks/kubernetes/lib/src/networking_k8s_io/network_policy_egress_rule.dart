...
class NetworkPolicyEgressRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'to': ?pulumi.Input.mapOptionalInputValue<List<NetworkPolicyPeer>, List<Map<String, dynamic>>>(to, (value) => pulumi.Input.encodeList<NetworkPolicyPeer, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory NetworkPolicyEgressRule.fromMap(Map<String, dynamic> map) {
    return NetworkPolicyEgressRule(
      ...
      to: (() { final guardedValue = map['to']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkPolicyPeer>(guardedValue, (value) => NetworkPolicyPeer.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
