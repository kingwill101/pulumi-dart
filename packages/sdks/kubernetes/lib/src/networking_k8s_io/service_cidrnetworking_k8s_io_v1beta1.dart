...
class ServiceCIDRNetworkingK8sIoV1beta1 {
  ...
  factory ServiceCIDRNetworkingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return ServiceCIDRNetworkingK8sIoV1beta1(
      ...
      spec: map['spec'] == null ? null : (ServiceCIDRSpecNetworkingK8sIoV1beta1.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (ServiceCIDRStatusNetworkingK8sIoV1beta1.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
