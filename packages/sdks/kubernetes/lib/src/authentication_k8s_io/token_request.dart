...
class TokenRequest {
  ...
  factory TokenRequest.fromMap(Map<String, dynamic> map) {
    return TokenRequest(
      ...
      spec: TokenRequestSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : TokenRequestStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
