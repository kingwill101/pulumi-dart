...
class SelfSubjectReviewPatchAuthenticationK8sIoV1alpha1 {
  ...
  final pulumi.Input<SelfSubjectReviewStatusPatchAuthenticationK8sIoV1alpha1>?
  status;
  ...
  factory SelfSubjectReviewPatchAuthenticationK8sIoV1alpha1.fromMap(
    ...
    return SelfSubjectReviewPatchAuthenticationK8sIoV1alpha1(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SelfSubjectReviewStatusPatchAuthenticationK8sIoV1alpha1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
