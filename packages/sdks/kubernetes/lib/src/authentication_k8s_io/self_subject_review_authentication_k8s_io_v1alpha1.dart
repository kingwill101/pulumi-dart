...
class SelfSubjectReviewAuthenticationK8sIoV1alpha1 {
  ...
  const SelfSubjectReviewAuthenticationK8sIoV1alpha1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.status,
  ...
  factory SelfSubjectReviewAuthenticationK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return SelfSubjectReviewAuthenticationK8sIoV1alpha1(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SelfSubjectReviewStatusAuthenticationK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
