...
class SelfSubjectReviewAuthenticationK8sIoV1alpha1 {
  ...
  final pulumi.Input<SelfSubjectReviewStatusAuthenticationK8sIoV1alpha1>?
  status;
  ...
  factory SelfSubjectReviewAuthenticationK8sIoV1alpha1.fromMap(
    ...
    return SelfSubjectReviewAuthenticationK8sIoV1alpha1(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SelfSubjectReviewStatusAuthenticationK8sIoV1alpha1.fromMap(
