...
class TokenReviewAuthenticationK8sIoV1beta1 {
  ...
  factory TokenReviewAuthenticationK8sIoV1beta1.fromMap(
    ...
    return TokenReviewAuthenticationK8sIoV1beta1(
      ...
      spec: pulumi.Input.fromValue(
        TokenReviewSpecAuthenticationK8sIoV1beta1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TokenReviewStatusAuthenticationK8sIoV1beta1.fromMap(
