...
class TokenReviewAuthenticationK8sIoV1beta1 {
  ...
  factory TokenReviewAuthenticationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return TokenReviewAuthenticationK8sIoV1beta1(
      ...
      spec: (TokenReviewSpecAuthenticationK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (TokenReviewStatusAuthenticationK8sIoV1beta1.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
