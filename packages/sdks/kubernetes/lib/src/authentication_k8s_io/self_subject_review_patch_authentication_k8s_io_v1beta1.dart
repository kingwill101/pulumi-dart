...
class SelfSubjectReviewPatchAuthenticationK8sIoV1beta1 {
  ...
  final pulumi.Input<SelfSubjectReviewStatusPatchAuthenticationK8sIoV1beta1>?
  status;
  ...
  factory SelfSubjectReviewPatchAuthenticationK8sIoV1beta1.fromMap(
    ...
    return SelfSubjectReviewPatchAuthenticationK8sIoV1beta1(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SelfSubjectReviewStatusPatchAuthenticationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
