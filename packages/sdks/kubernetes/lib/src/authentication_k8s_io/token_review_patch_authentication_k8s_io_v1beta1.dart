...
class TokenReviewPatchAuthenticationK8sIoV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec':
          ?pulumi.Input.mapOptionalInputValue<
            TokenReviewSpecPatchAuthenticationK8sIoV1beta1,
            Map<String, dynamic>
  ...
  factory TokenReviewPatchAuthenticationK8sIoV1beta1.fromMap(
    ...
    return TokenReviewPatchAuthenticationK8sIoV1beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TokenReviewSpecPatchAuthenticationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TokenReviewStatusPatchAuthenticationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
