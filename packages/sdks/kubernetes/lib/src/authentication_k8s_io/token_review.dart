...
class TokenReview {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': pulumi.Input.mapInputValue<TokenReviewSpec, Map<String, dynamic>>(
        spec,
        (value) => value.toMap(),
      ),
      'status':
  ...
  factory TokenReview.fromMap(Map<String, dynamic> map) {
    return TokenReview(
      ...
      spec: pulumi.Input.fromValue(
        TokenReviewSpec.fromMap((map['spec']! as Map).cast<String, dynamic>()),
      ),
      status: (() {
        final guardedValue = map['status'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TokenReviewStatus.fromMap(
