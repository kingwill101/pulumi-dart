...
class SelfSubjectReviewPatch {
  ...
  final pulumi.Input<SelfSubjectReviewStatusPatch>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<SelfSubjectReviewStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory SelfSubjectReviewPatch.fromMap(Map<String, dynamic> map) {
    return SelfSubjectReviewPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SelfSubjectReviewStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
