...
class PodGroupTemplateSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [PodGroupTemplateSchedulingK8sIoV1beta1].
  ...
  const PodGroupTemplateSchedulingK8sIoV1beta1({
    this.disruptionMode,
    required this.name,
  ...
  factory PodGroupTemplateSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupTemplateSchedulingK8sIoV1beta1(
