...
class WorkloadListSchedulingK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Workload>> items;
  ...
  WorkloadListSchedulingK8sIoV1alpha1(
    ...
    items = registerOutput<List<Workload>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<Workload>(guardedValue, (value) => Workload.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [WorkloadListSchedulingK8sIoV1alpha1] resource.
  WorkloadListSchedulingK8sIoV1alpha1.reference(String urn)
    : super(
        'kubernetes:scheduling.k8s.io/v1alpha1:WorkloadList',
