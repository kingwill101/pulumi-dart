...
import 'typed_local_object_reference_patch_scheduling_k8s_io_v1alpha2.dart';

/// WorkloadSpec defines the desired state of a Workload.
class WorkloadSpecPatchSchedulingK8sIoV1alpha2 {
  ...
  final pulumi.Input<TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2?>? controllerRef;
  ...
  /// Creates a new [WorkloadSpecPatchSchedulingK8sIoV1alpha2].
  ...
  const WorkloadSpecPatchSchedulingK8sIoV1alpha2({
    this.controllerRef,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'controllerRef': ?pulumi.Input.mapOptionalInputValue<TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2, Map<String, dynamic>>(controllerRef, (value) => value.toMap()),
  ...
  factory WorkloadSpecPatchSchedulingK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return WorkloadSpecPatchSchedulingK8sIoV1alpha2(
      controllerRef: (() { final guardedValue = map['controllerRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
