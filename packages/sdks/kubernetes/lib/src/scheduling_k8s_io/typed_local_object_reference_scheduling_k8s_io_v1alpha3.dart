...
class TypedLocalObjectReferenceSchedulingK8sIoV1alpha3 {
  ...
  /// Creates a new [TypedLocalObjectReferenceSchedulingK8sIoV1alpha3].
  ...
  const TypedLocalObjectReferenceSchedulingK8sIoV1alpha3({
    this.apiGroup,
    required this.kind,
    required this.name,
  });
  ...
  factory TypedLocalObjectReferenceSchedulingK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return TypedLocalObjectReferenceSchedulingK8sIoV1alpha3(
