...
class PodGroupResourceClaimPatchSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [PodGroupResourceClaimPatchSchedulingK8sIoV1beta1].
  ...
  const PodGroupResourceClaimPatchSchedulingK8sIoV1beta1({
    this.name,
  ...
  factory PodGroupResourceClaimPatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupResourceClaimPatchSchedulingK8sIoV1beta1(
