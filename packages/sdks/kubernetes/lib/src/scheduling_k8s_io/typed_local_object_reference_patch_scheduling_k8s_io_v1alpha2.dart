...
class TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2 {
  ...
  /// Creates a new [TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2].
  ...
  const TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2({
    this.apiGroup,
    this.kind,
    this.name,
  });
  ...
  factory TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha2(
