...
import 'gang_scheduling_policy_scheduling_k8s_io_v1alpha3.dart';
...
class PodGroupSchedulingPolicySchedulingK8sIoV1alpha3 {
  ...
  final pulumi.Input<GangSchedulingPolicySchedulingK8sIoV1alpha3?>? gang;

  /// Creates a new [PodGroupSchedulingPolicySchedulingK8sIoV1alpha3].
  ...
  const PodGroupSchedulingPolicySchedulingK8sIoV1alpha3({
    this.basic,
    this.gang,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'basic': ?basic,
      'gang': ?pulumi.Input.mapOptionalInputValue<GangSchedulingPolicySchedulingK8sIoV1alpha3, Map<String, dynamic>>(gang, (value) => value.toMap()),
    };
  }

  factory PodGroupSchedulingPolicySchedulingK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return PodGroupSchedulingPolicySchedulingK8sIoV1alpha3(
      ...
      gang: (() { final guardedValue = map['gang']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GangSchedulingPolicySchedulingK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
