...
import 'disruption_mode_scheduling_k8s_io_v1beta1.dart';
import 'pod_group_resource_claim_scheduling_k8s_io_v1beta1.dart';
import 'pod_group_scheduling_constraints_scheduling_k8s_io_v1beta1.dart';
import 'pod_group_scheduling_policy_scheduling_k8s_io_v1beta1.dart';
import 'workload_reference_scheduling_k8s_io_v1beta1.dart';

/// PodGroupSpec defines the desired state of a PodGroup.
class PodGroupSpecSchedulingK8sIoV1beta1 {
  ...
  final pulumi.Input<DisruptionModeSchedulingK8sIoV1beta1?>? disruptionMode;
  ...
  final pulumi.Input<List<PodGroupResourceClaimSchedulingK8sIoV1beta1>?>? resourceClaims;
  ...
  final pulumi.Input<PodGroupSchedulingConstraintsSchedulingK8sIoV1beta1?>? schedulingConstraints;
  ...
  final pulumi.Input<PodGroupSchedulingPolicySchedulingK8sIoV1beta1> schedulingPolicy;
  ...
  final pulumi.Input<WorkloadReferenceSchedulingK8sIoV1beta1?>? workloadRef;

  /// Creates a new [PodGroupSpecSchedulingK8sIoV1beta1].
  ...
  const PodGroupSpecSchedulingK8sIoV1beta1({
    this.disruptionMode,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'disruptionMode': ?pulumi.Input.mapOptionalInputValue<DisruptionModeSchedulingK8sIoV1beta1, Map<String, dynamic>>(disruptionMode, (value) => value.toMap()),
      'parentCompositePodGroupName': ?parentCompositePodGroupName,
      'preemptionPolicy': ?preemptionPolicy,
      'priority': ?priority,
      'priorityClassName': ?priorityClassName,
      'resourceClaims': ?pulumi.Input.mapOptionalInputValue<List<PodGroupResourceClaimSchedulingK8sIoV1beta1>, List<Map<String, dynamic>>>(resourceClaims, (value) => pulumi.Input.encodeList<PodGroupResourceClaimSchedulingK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'schedulingConstraints': ?pulumi.Input.mapOptionalInputValue<PodGroupSchedulingConstraintsSchedulingK8sIoV1beta1, Map<String, dynamic>>(schedulingConstraints, (value) => value.toMap()),
      'schedulingPolicy': pulumi.Input.mapInputValue<PodGroupSchedulingPolicySchedulingK8sIoV1beta1, Map<String, dynamic>>(schedulingPolicy, (value) => value.toMap()),
      'workloadRef': ?pulumi.Input.mapOptionalInputValue<WorkloadReferenceSchedulingK8sIoV1beta1, Map<String, dynamic>>(workloadRef, (value) => value.toMap()),
    };
  }

  factory PodGroupSpecSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupSpecSchedulingK8sIoV1beta1(
      disruptionMode: (() { final guardedValue = map['disruptionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DisruptionModeSchedulingK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceClaims: (() { final guardedValue = map['resourceClaims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodGroupResourceClaimSchedulingK8sIoV1beta1>(guardedValue, (value) => PodGroupResourceClaimSchedulingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      schedulingConstraints: (() { final guardedValue = map['schedulingConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodGroupSchedulingConstraintsSchedulingK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      schedulingPolicy: pulumi.Input.fromValue(PodGroupSchedulingPolicySchedulingK8sIoV1beta1.fromMap((map['schedulingPolicy']! as Map).cast<String, dynamic>())),
      workloadRef: (() { final guardedValue = map['workloadRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadReferenceSchedulingK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
