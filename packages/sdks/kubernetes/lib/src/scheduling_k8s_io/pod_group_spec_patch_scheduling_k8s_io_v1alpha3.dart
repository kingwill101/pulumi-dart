...
import 'disruption_mode_patch.dart';
import 'pod_group_resource_claim_patch_scheduling_k8s_io_v1alpha3.dart';
import 'pod_group_scheduling_constraints_patch_scheduling_k8s_io_v1alpha3.dart';
import 'pod_group_scheduling_policy_patch_scheduling_k8s_io_v1alpha3.dart';
import 'workload_reference_patch.dart';

/// PodGroupSpec defines the desired state of a PodGroup.
class PodGroupSpecPatchSchedulingK8sIoV1alpha3 {
  ...
  final pulumi.Input<DisruptionModePatch?>? disruptionMode;
  ...
  final pulumi.Input<List<PodGroupResourceClaimPatchSchedulingK8sIoV1alpha3>?>? resourceClaims;
  ...
  final pulumi.Input<PodGroupSchedulingConstraintsPatchSchedulingK8sIoV1alpha3?>? schedulingConstraints;
  ...
  final pulumi.Input<PodGroupSchedulingPolicyPatchSchedulingK8sIoV1alpha3?>? schedulingPolicy;
  ...
  /// Creates a new [PodGroupSpecPatchSchedulingK8sIoV1alpha3].
  ...
  const PodGroupSpecPatchSchedulingK8sIoV1alpha3({
    this.disruptionMode,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'disruptionMode': ?pulumi.Input.mapOptionalInputValue<DisruptionModePatch, Map<String, dynamic>>(disruptionMode, (value) => value.toMap()),
      'parentCompositePodGroupName': ?parentCompositePodGroupName,
      'preemptionPolicy': ?preemptionPolicy,
      'priority': ?priority,
      'priorityClassName': ?priorityClassName,
      'resourceClaims': ?pulumi.Input.mapOptionalInputValue<List<PodGroupResourceClaimPatchSchedulingK8sIoV1alpha3>, List<Map<String, dynamic>>>(resourceClaims, (value) => pulumi.Input.encodeList<PodGroupResourceClaimPatchSchedulingK8sIoV1alpha3, Map<String, dynamic>>(value, (value) => value.toMap())),
      'schedulingConstraints': ?pulumi.Input.mapOptionalInputValue<PodGroupSchedulingConstraintsPatchSchedulingK8sIoV1alpha3, Map<String, dynamic>>(schedulingConstraints, (value) => value.toMap()),
      'schedulingPolicy': ?pulumi.Input.mapOptionalInputValue<PodGroupSchedulingPolicyPatchSchedulingK8sIoV1alpha3, Map<String, dynamic>>(schedulingPolicy, (value) => value.toMap()),
      'workloadRef': ?pulumi.Input.mapOptionalInputValue<WorkloadReferencePatch, Map<String, dynamic>>(workloadRef, (value) => value.toMap()),
    };
  }

  factory PodGroupSpecPatchSchedulingK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return PodGroupSpecPatchSchedulingK8sIoV1alpha3(
      disruptionMode: (() { final guardedValue = map['disruptionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DisruptionModePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceClaims: (() { final guardedValue = map['resourceClaims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodGroupResourceClaimPatchSchedulingK8sIoV1alpha3>(guardedValue, (value) => PodGroupResourceClaimPatchSchedulingK8sIoV1alpha3.fromMap((value as Map).cast<String, dynamic>()))); })(),
      schedulingConstraints: (() { final guardedValue = map['schedulingConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodGroupSchedulingConstraintsPatchSchedulingK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      schedulingPolicy: (() { final guardedValue = map['schedulingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodGroupSchedulingPolicyPatchSchedulingK8sIoV1alpha3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
