...
class PodGroupTemplatePatch {
  ...
  /// Creates a new [PodGroupTemplatePatch].
  ...
  factory PodGroupTemplatePatch.fromMap(Map<String, dynamic> map) {
    return PodGroupTemplatePatch(
