...
/// {@template pulumi_scheduling_k8s_io_v1alpha3_composite_pod_group_patch_args_doc}
/// The set of arguments for CompositePodGroupPatch.
/// {@endtemplate}
/// {@macro pulumi_scheduling_k8s_io_v1alpha3_composite_pod_group_patch_args_doc}
class CompositePodGroupPatchArgs {
  ...
  /// Creates a new [CompositePodGroupPatchArgs].
  ...
  const CompositePodGroupPatchArgs({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory CompositePodGroupPatchArgs.fromMap(Map<String, dynamic> map) {
    return CompositePodGroupPatchArgs(
