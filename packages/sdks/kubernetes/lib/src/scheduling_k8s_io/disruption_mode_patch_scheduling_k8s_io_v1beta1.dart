...
class DisruptionModePatchSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [DisruptionModePatchSchedulingK8sIoV1beta1].
  ...
  const DisruptionModePatchSchedulingK8sIoV1beta1({
    this.all,
    this.single,
  });
  ...
  factory DisruptionModePatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DisruptionModePatchSchedulingK8sIoV1beta1(
