...
class WorkloadPodGroupResourceClaimPatch {
  ...
  /// Creates a new [WorkloadPodGroupResourceClaimPatch].
  ...
  const WorkloadPodGroupResourceClaimPatch({
    this.name,
  ...
  factory WorkloadPodGroupResourceClaimPatch.fromMap(Map<String, dynamic> map) {
    return WorkloadPodGroupResourceClaimPatch(
