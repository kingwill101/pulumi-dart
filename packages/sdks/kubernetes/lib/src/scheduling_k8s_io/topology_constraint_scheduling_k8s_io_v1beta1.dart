...
class TopologyConstraintSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [TopologyConstraintSchedulingK8sIoV1beta1].
  ...
  const TopologyConstraintSchedulingK8sIoV1beta1({
    required this.key,
  });
  ...
  factory TopologyConstraintSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return TopologyConstraintSchedulingK8sIoV1beta1(
