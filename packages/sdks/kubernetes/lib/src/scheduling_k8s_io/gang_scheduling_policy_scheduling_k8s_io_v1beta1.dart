...
class GangSchedulingPolicySchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [GangSchedulingPolicySchedulingK8sIoV1beta1].
  ...
  const GangSchedulingPolicySchedulingK8sIoV1beta1({
  ...
  factory GangSchedulingPolicySchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return GangSchedulingPolicySchedulingK8sIoV1beta1(
