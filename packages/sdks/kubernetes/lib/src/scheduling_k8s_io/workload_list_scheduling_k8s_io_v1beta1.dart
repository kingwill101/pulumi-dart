...
class WorkloadListSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [WorkloadListSchedulingK8sIoV1beta1].
  ...
  const WorkloadListSchedulingK8sIoV1beta1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory WorkloadListSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return WorkloadListSchedulingK8sIoV1beta1(
