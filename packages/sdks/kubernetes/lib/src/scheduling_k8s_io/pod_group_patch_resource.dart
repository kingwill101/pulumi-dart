...
class PodGroupPatchResource extends pulumi.CustomResource {
  ...
  /// Creates a new [PodGroupPatchResource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PodGroupPatchResource]. {@macro pulumi_scheduling_k8s_io_v1alpha2_pod_group_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  PodGroupPatchResource(
    String name, {
  ...
  /// Creates a typed reference to an existing [PodGroupPatchResource] resource.
  PodGroupPatchResource.reference(String urn)
    : super(
        'kubernetes:scheduling.k8s.io/v1alpha2:PodGroupPatch',
