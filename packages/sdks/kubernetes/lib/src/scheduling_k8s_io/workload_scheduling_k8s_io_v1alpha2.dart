...
class WorkloadSchedulingK8sIoV1alpha2 {
  ...
  const WorkloadSchedulingK8sIoV1alpha2({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory WorkloadSchedulingK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return WorkloadSchedulingK8sIoV1alpha2(
