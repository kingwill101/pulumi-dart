...
/// {@template pulumi_scheduling_k8s_io_v1alpha1_priority_class_patch_scheduling_k8s_io_v1alpha1_args_doc}
/// The set of arguments for PriorityClassPatch.
/// {@endtemplate}
/// {@macro pulumi_scheduling_k8s_io_v1alpha1_priority_class_patch_scheduling_k8s_io_v1alpha1_args_doc}
class PriorityClassPatchSchedulingK8sIoV1alpha1Args {
  ...
  /// Creates a new [PriorityClassPatchSchedulingK8sIoV1alpha1Args].
  ...
  PriorityClassPatchSchedulingK8sIoV1alpha1Args({
    this.apiVersion,
    this.description,
    this.globalDefault,
    this.kind,
  ...
  factory PriorityClassPatchSchedulingK8sIoV1alpha1Args.fromMap(
    Map<String, dynamic> map,
  ) {
    return PriorityClassPatchSchedulingK8sIoV1alpha1Args(
      apiVersion: (() {
      ...
      globalDefault: (() {
        final guardedValue = map['globalDefault'];
        if (guardedValue == null) return null;
      ...
      preemptionPolicy: (() {
        final guardedValue = map['preemptionPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      value: (() {
