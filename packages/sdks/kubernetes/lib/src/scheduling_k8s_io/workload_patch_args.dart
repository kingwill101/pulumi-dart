...
class WorkloadPatchArgs {
  ...
  WorkloadPatchArgs({
    ...
    pulumi.Output<WorkloadSpecPatch>? spec,
  }) :
  ...
  factory WorkloadPatchArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<WorkloadSpecPatch>(WorkloadSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
