...
class PodGroupResourceClaimSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [PodGroupResourceClaimSchedulingK8sIoV1beta1].
  ...
  const PodGroupResourceClaimSchedulingK8sIoV1beta1({
    required this.name,
  ...
  factory PodGroupResourceClaimSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupResourceClaimSchedulingK8sIoV1beta1(
