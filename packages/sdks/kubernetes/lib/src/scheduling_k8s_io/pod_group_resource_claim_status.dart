...
class PodGroupResourceClaimStatus {
  ...
  /// Creates a new [PodGroupResourceClaimStatus].
  ...
  const PodGroupResourceClaimStatus({
    required this.name,
  ...
  factory PodGroupResourceClaimStatus.fromMap(Map<String, dynamic> map) {
