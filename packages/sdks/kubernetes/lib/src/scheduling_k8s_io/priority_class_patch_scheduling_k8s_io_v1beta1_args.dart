...
/// {@template pulumi_scheduling_k8s_io_v1beta1_priority_class_patch_scheduling_k8s_io_v1beta1_args_doc}
/// The set of arguments for PriorityClassPatch.
/// {@endtemplate}
/// {@macro pulumi_scheduling_k8s_io_v1beta1_priority_class_patch_scheduling_k8s_io_v1beta1_args_doc}
class PriorityClassPatchSchedulingK8sIoV1beta1Args {
  ...
  /// Creates a new [PriorityClassPatchSchedulingK8sIoV1beta1Args].
  ...
  PriorityClassPatchSchedulingK8sIoV1beta1Args({
    this.apiVersion,
    this.description,
    this.globalDefault,
    this.kind,
  ...
  factory PriorityClassPatchSchedulingK8sIoV1beta1Args.fromMap(
