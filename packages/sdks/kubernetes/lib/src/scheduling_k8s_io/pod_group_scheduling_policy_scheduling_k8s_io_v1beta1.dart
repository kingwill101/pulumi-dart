...
import 'gang_scheduling_policy_scheduling_k8s_io_v1beta1.dart';
...
class PodGroupSchedulingPolicySchedulingK8sIoV1beta1 {
  ...
  final pulumi.Input<GangSchedulingPolicySchedulingK8sIoV1beta1?>? gang;

  /// Creates a new [PodGroupSchedulingPolicySchedulingK8sIoV1beta1].
  ...
  const PodGroupSchedulingPolicySchedulingK8sIoV1beta1({
    this.basic,
    this.gang,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'basic': ?basic,
      'gang': ?pulumi.Input.mapOptionalInputValue<GangSchedulingPolicySchedulingK8sIoV1beta1, Map<String, dynamic>>(gang, (value) => value.toMap()),
    };
  }

  factory PodGroupSchedulingPolicySchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupSchedulingPolicySchedulingK8sIoV1beta1(
      ...
      gang: (() { final guardedValue = map['gang']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GangSchedulingPolicySchedulingK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
