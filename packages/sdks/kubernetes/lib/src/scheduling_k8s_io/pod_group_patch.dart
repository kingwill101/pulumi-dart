...
class PodGroupPatch {
  ...
  factory PodGroupPatch.fromMap(Map<String, dynamic> map) {
    return PodGroupPatch(
      ...
      policy: (() { final guardedValue = map['policy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodGroupPolicyPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
