...
class TypedLocalObjectReferenceSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [TypedLocalObjectReferenceSchedulingK8sIoV1beta1].
  ...
  const TypedLocalObjectReferenceSchedulingK8sIoV1beta1({
    this.apiGroup,
    required this.kind,
    required this.name,
  });
  ...
  factory TypedLocalObjectReferenceSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return TypedLocalObjectReferenceSchedulingK8sIoV1beta1(
