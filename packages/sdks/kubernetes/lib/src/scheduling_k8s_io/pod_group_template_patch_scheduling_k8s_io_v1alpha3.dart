...
class PodGroupTemplatePatchSchedulingK8sIoV1alpha3 {
  ...
  /// Creates a new [PodGroupTemplatePatchSchedulingK8sIoV1alpha3].
  ...
  const PodGroupTemplatePatchSchedulingK8sIoV1alpha3({
    this.disruptionMode,
    this.name,
  ...
  factory PodGroupTemplatePatchSchedulingK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return PodGroupTemplatePatchSchedulingK8sIoV1alpha3(
