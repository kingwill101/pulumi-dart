...
/// {@template pulumi_scheduling_k8s_io_v1alpha3_composite_pod_group_args_doc}
/// The set of arguments for CompositePodGroup.
/// {@endtemplate}
/// {@macro pulumi_scheduling_k8s_io_v1alpha3_composite_pod_group_args_doc}
class CompositePodGroupArgs {
  ...
  /// Creates a new [CompositePodGroupArgs].
  ...
  factory CompositePodGroupArgs.fromMap(Map<String, dynamic> map) {
    return CompositePodGroupArgs(
