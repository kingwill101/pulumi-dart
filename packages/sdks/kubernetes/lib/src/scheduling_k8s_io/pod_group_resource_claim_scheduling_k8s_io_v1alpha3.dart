...
class PodGroupResourceClaimSchedulingK8sIoV1alpha3 {
  ...
  /// Creates a new [PodGroupResourceClaimSchedulingK8sIoV1alpha3].
  ...
  const PodGroupResourceClaimSchedulingK8sIoV1alpha3({
    required this.name,
  ...
  factory PodGroupResourceClaimSchedulingK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return PodGroupResourceClaimSchedulingK8sIoV1alpha3(
