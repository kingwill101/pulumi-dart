...
/// {@template pulumi_scheduling_k8s_io_v1beta1_workload_scheduling_k8s_io_v1beta1_args_doc}
/// The set of arguments for Workload.
/// {@endtemplate}
/// {@macro pulumi_scheduling_k8s_io_v1beta1_workload_scheduling_k8s_io_v1beta1_args_doc}
class WorkloadSchedulingK8sIoV1beta1Args {
  ...
  /// Creates a new [WorkloadSchedulingK8sIoV1beta1Args].
  ...
  const WorkloadSchedulingK8sIoV1beta1Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory WorkloadSchedulingK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return WorkloadSchedulingK8sIoV1beta1Args(
