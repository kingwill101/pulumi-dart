...
class WorkloadSpecPatch {
  ...
  WorkloadSpecPatch({this.controllerRef, this.podGroups});
    ...
    return <String, dynamic>{
      ...
      'podGroups':
          ...
          >(
            podGroups,
            (value) =>
                pulumi.Input.encodeList<PodGroupPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory WorkloadSpecPatch.fromMap(Map<String, dynamic> map) {
    return WorkloadSpecPatch(
      ...
      podGroups: (() {
        final guardedValue = map['podGroups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PodGroupPatch>(
            guardedValue,
            (value) =>
                PodGroupPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
