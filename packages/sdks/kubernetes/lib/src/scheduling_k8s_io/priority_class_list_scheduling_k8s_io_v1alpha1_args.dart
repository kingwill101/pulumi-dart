...
class PriorityClassListSchedulingK8sIoV1alpha1Args {
  ...
  final pulumi.Input<List<PriorityClassSchedulingK8sIoV1alpha1>> items;
  ...
  const PriorityClassListSchedulingK8sIoV1alpha1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<PriorityClassSchedulingK8sIoV1alpha1>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<PriorityClassSchedulingK8sIoV1alpha1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory PriorityClassListSchedulingK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return PriorityClassListSchedulingK8sIoV1alpha1Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<PriorityClassSchedulingK8sIoV1alpha1>(map['items']!, (value) => PriorityClassSchedulingK8sIoV1alpha1.fromMap((value as Map).cast<String, dynamic>()))),
