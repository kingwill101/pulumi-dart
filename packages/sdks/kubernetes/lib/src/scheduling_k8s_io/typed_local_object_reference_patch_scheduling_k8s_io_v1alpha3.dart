...
class TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha3 {
  ...
  /// Creates a new [TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha3].
  ...
  const TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha3({
    this.apiGroup,
    this.kind,
    this.name,
  });
  ...
  factory TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha3.fromMap(Map<String, dynamic> map) {
    return TypedLocalObjectReferencePatchSchedulingK8sIoV1alpha3(
