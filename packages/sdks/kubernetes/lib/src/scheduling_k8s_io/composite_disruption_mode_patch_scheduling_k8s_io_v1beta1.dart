...
class CompositeDisruptionModePatchSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [CompositeDisruptionModePatchSchedulingK8sIoV1beta1].
  ...
  const CompositeDisruptionModePatchSchedulingK8sIoV1beta1({
    this.all,
    this.single,
  });
  ...
  factory CompositeDisruptionModePatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CompositeDisruptionModePatchSchedulingK8sIoV1beta1(
