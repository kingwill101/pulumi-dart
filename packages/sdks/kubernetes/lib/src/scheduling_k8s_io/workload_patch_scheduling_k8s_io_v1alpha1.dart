...
class WorkloadPatchSchedulingK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  WorkloadPatchSchedulingK8sIoV1alpha1(
    ...
    spec = registerOutput<WorkloadSpecPatch?>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WorkloadSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [WorkloadPatchSchedulingK8sIoV1alpha1] resource.
  WorkloadPatchSchedulingK8sIoV1alpha1.reference(String urn)
    : super(
        'kubernetes:scheduling.k8s.io/v1alpha1:WorkloadPatch',
