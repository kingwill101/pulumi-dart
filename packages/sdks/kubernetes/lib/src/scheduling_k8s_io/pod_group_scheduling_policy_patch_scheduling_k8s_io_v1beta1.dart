...
import 'gang_scheduling_policy_patch_scheduling_k8s_io_v1beta1.dart';
...
class PodGroupSchedulingPolicyPatchSchedulingK8sIoV1beta1 {
  ...
  final pulumi.Input<GangSchedulingPolicyPatchSchedulingK8sIoV1beta1?>? gang;

  /// Creates a new [PodGroupSchedulingPolicyPatchSchedulingK8sIoV1beta1].
  ...
  const PodGroupSchedulingPolicyPatchSchedulingK8sIoV1beta1({
    this.basic,
    this.gang,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'basic': ?basic,
      'gang': ?pulumi.Input.mapOptionalInputValue<GangSchedulingPolicyPatchSchedulingK8sIoV1beta1, Map<String, dynamic>>(gang, (value) => value.toMap()),
    };
  }

  factory PodGroupSchedulingPolicyPatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupSchedulingPolicyPatchSchedulingK8sIoV1beta1(
      ...
      gang: (() { final guardedValue = map['gang']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GangSchedulingPolicyPatchSchedulingK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
