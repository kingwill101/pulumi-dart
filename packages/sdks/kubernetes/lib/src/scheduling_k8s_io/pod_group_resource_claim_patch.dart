...
class PodGroupResourceClaimPatch {
  ...
  /// Creates a new [PodGroupResourceClaimPatch].
  ...
  const PodGroupResourceClaimPatch({
    this.name,
  ...
  factory PodGroupResourceClaimPatch.fromMap(Map<String, dynamic> map) {
    return PodGroupResourceClaimPatch(
