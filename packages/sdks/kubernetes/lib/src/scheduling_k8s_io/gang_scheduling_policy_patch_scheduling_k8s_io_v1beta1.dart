...
class GangSchedulingPolicyPatchSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [GangSchedulingPolicyPatchSchedulingK8sIoV1beta1].
  ...
  const GangSchedulingPolicyPatchSchedulingK8sIoV1beta1({
    this.minCount,
  });
  ...
  factory GangSchedulingPolicyPatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return GangSchedulingPolicyPatchSchedulingK8sIoV1beta1(
