...
class PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1].
  ...
  const PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1({
    this.name,
  ...
  factory PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1(
