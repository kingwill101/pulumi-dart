...
class PodGroupTemplatePatchSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [PodGroupTemplatePatchSchedulingK8sIoV1beta1].
  ...
  const PodGroupTemplatePatchSchedulingK8sIoV1beta1({
    this.disruptionMode,
    this.name,
  ...
  factory PodGroupTemplatePatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupTemplatePatchSchedulingK8sIoV1beta1(
