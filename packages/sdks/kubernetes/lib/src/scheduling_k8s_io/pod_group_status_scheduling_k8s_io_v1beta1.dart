...
import 'pod_group_resource_claim_status_scheduling_k8s_io_v1beta1.dart';

/// PodGroupStatus represents information about the status of a pod group.
class PodGroupStatusSchedulingK8sIoV1beta1 {
  ...
  final pulumi.Input<List<PodGroupResourceClaimStatusSchedulingK8sIoV1beta1>?>? resourceClaimStatuses;

  /// Creates a new [PodGroupStatusSchedulingK8sIoV1beta1].
  ...
  const PodGroupStatusSchedulingK8sIoV1beta1({
    this.conditions,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceClaimStatuses': ?pulumi.Input.mapOptionalInputValue<List<PodGroupResourceClaimStatusSchedulingK8sIoV1beta1>, List<Map<String, dynamic>>>(resourceClaimStatuses, (value) => pulumi.Input.encodeList<PodGroupResourceClaimStatusSchedulingK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory PodGroupStatusSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupStatusSchedulingK8sIoV1beta1(
      ...
      resourceClaimStatuses: (() { final guardedValue = map['resourceClaimStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodGroupResourceClaimStatusSchedulingK8sIoV1beta1>(guardedValue, (value) => PodGroupResourceClaimStatusSchedulingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
