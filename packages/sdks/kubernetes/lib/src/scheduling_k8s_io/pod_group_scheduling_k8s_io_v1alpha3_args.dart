...
/// {@template pulumi_scheduling_k8s_io_v1alpha3_pod_group_scheduling_k8s_io_v1alpha3_args_doc}
/// The set of arguments for PodGroup.
/// {@endtemplate}
/// {@macro pulumi_scheduling_k8s_io_v1alpha3_pod_group_scheduling_k8s_io_v1alpha3_args_doc}
class PodGroupSchedulingK8sIoV1alpha3Args {
  ...
  /// Creates a new [PodGroupSchedulingK8sIoV1alpha3Args].
  ...
  const PodGroupSchedulingK8sIoV1alpha3Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory PodGroupSchedulingK8sIoV1alpha3Args.fromMap(Map<String, dynamic> map) {
    return PodGroupSchedulingK8sIoV1alpha3Args(
