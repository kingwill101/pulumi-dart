...
class CompositePodGroupSpecPatch {
  ...
  /// Creates a new [CompositePodGroupSpecPatch].
  ...
  const CompositePodGroupSpecPatch({
    this.disruptionMode,
  ...
  factory CompositePodGroupSpecPatch.fromMap(Map<String, dynamic> map) {
    return CompositePodGroupSpecPatch(
