...
class DisruptionModeSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [DisruptionModeSchedulingK8sIoV1beta1].
  ...
  const DisruptionModeSchedulingK8sIoV1beta1({
    this.all,
    this.single,
  });
  ...
  factory DisruptionModeSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return DisruptionModeSchedulingK8sIoV1beta1(
