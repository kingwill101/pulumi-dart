...
class WorkloadListArgs {
  ...
  WorkloadListArgs({
    ...
    required pulumi.Output<List<WorkloadSchedulingK8sIoV1alpha1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<WorkloadSchedulingK8sIoV1alpha1>>(items),
  ...
  factory WorkloadListArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadListArgs(
      ...
      items: pulumi.Output.create<List<WorkloadSchedulingK8sIoV1alpha1>>((map['items'] as List).cast<WorkloadSchedulingK8sIoV1alpha1>()),
