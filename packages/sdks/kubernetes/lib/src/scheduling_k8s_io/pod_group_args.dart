...
/// {@template pulumi_scheduling_k8s_io_v1alpha2_pod_group_args_doc}
/// The set of arguments for PodGroup.
/// {@endtemplate}
/// {@macro pulumi_scheduling_k8s_io_v1alpha2_pod_group_args_doc}
class PodGroupArgs {
  ...
  factory PodGroupArgs.fromMap(Map<String, dynamic> map) {
    return PodGroupArgs(
