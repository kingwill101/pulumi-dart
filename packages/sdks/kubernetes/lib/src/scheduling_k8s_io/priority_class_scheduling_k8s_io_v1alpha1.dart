...
class PriorityClassSchedulingK8sIoV1alpha1 {
  ...
  /// Creates a new [PriorityClassSchedulingK8sIoV1alpha1].
  ...
  PriorityClassSchedulingK8sIoV1alpha1({
    this.apiVersion,
    this.description,
    this.globalDefault,
    this.kind,
  ...
  factory PriorityClassSchedulingK8sIoV1alpha1.fromMap(
    Map<String, dynamic> map,
  ) {
    return PriorityClassSchedulingK8sIoV1alpha1(
      apiVersion: (() {
