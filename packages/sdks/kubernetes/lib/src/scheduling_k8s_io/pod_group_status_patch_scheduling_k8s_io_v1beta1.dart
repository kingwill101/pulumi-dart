...
import 'pod_group_resource_claim_status_patch_scheduling_k8s_io_v1beta1.dart';

/// PodGroupStatus represents information about the status of a pod group.
class PodGroupStatusPatchSchedulingK8sIoV1beta1 {
  ...
  final pulumi.Input<List<PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1>?>? resourceClaimStatuses;

  /// Creates a new [PodGroupStatusPatchSchedulingK8sIoV1beta1].
  ...
  const PodGroupStatusPatchSchedulingK8sIoV1beta1({
    this.conditions,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceClaimStatuses': ?pulumi.Input.mapOptionalInputValue<List<PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1>, List<Map<String, dynamic>>>(resourceClaimStatuses, (value) => pulumi.Input.encodeList<PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory PodGroupStatusPatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupStatusPatchSchedulingK8sIoV1beta1(
      ...
      resourceClaimStatuses: (() { final guardedValue = map['resourceClaimStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1>(guardedValue, (value) => PodGroupResourceClaimStatusPatchSchedulingK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
