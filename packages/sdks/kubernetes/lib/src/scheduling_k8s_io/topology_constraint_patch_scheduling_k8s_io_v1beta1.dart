...
class TopologyConstraintPatchSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [TopologyConstraintPatchSchedulingK8sIoV1beta1].
  ...
  const TopologyConstraintPatchSchedulingK8sIoV1beta1({
    this.key,
  });
  ...
  factory TopologyConstraintPatchSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return TopologyConstraintPatchSchedulingK8sIoV1beta1(
