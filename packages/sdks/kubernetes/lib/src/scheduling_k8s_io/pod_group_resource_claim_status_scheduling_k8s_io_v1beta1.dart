...
class PodGroupResourceClaimStatusSchedulingK8sIoV1beta1 {
  ...
  /// Creates a new [PodGroupResourceClaimStatusSchedulingK8sIoV1beta1].
  ...
  const PodGroupResourceClaimStatusSchedulingK8sIoV1beta1({
    required this.name,
  ...
  factory PodGroupResourceClaimStatusSchedulingK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return PodGroupResourceClaimStatusSchedulingK8sIoV1beta1(
