...
class DeploymentPatch {
  ...
  factory DeploymentPatch.fromMap(Map<String, dynamic> map) {
    return DeploymentPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
