...
class DaemonSetStatus {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<DaemonSetCondition, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory DaemonSetStatus.fromMap(Map<String, dynamic> map) {
    return DaemonSetStatus(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<DaemonSetCondition>(map['conditions'], (value) => DaemonSetCondition.fromMap((value as Map).cast<String, dynamic>())),
      currentNumberScheduled: map['currentNumberScheduled'] as int,
      desiredNumberScheduled: map['desiredNumberScheduled'] as int,
      numberAvailable: map['numberAvailable'] == null ? null : map['numberAvailable'] as int,
      numberMisscheduled: map['numberMisscheduled'] as int,
      numberReady: map['numberReady'] as int,
