...
class DeploymentPatchExtensionsV1beta1 extends pulumi.CustomResource {
  ...
  /// Creates a new [DeploymentPatchExtensionsV1beta1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DeploymentPatchExtensionsV1beta1]. {@macro pulumi_extensions_v1beta1_deployment_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DeploymentPatchExtensionsV1beta1(
    String name, {
