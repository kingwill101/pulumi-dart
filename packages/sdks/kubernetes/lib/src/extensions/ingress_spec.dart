...
class IngressSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backend': ?pulumi.Input.mapOptionalInputValue<IngressBackend, Map<String, dynamic>>(backend, (value) => value.toMap()),
  ...
  factory IngressSpec.fromMap(Map<String, dynamic> map) {
    return IngressSpec(
      backend: (() { final guardedValue = map['backend']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressBackend.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
