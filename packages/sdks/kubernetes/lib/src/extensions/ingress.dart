...
class Ingress {
  ...
  factory Ingress.fromMap(Map<String, dynamic> map) {
    return Ingress(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
