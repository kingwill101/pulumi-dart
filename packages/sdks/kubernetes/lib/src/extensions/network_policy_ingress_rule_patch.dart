...
class NetworkPolicyIngressRulePatch {
  ...
  NetworkPolicyIngressRulePatch({this.from, this.ports});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'from':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkPolicyPeerPatch>,
    ...
    return NetworkPolicyIngressRulePatch(
      from: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPolicyPeerPatch>(
            guardedValue,
            (value) => NetworkPolicyPeerPatch.fromMap(
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPolicyPortPatch>(
            guardedValue,
            (value) => NetworkPolicyPortPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
