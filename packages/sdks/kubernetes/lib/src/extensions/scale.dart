...
class Scale {
  ...
  factory Scale.fromMap(Map<String, dynamic> map) {
    return Scale(
      ...
      spec: map['spec'] == null ? null : ScaleSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : ScaleStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
