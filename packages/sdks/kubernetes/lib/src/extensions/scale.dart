...
class Scale {
  ...
  factory Scale.fromMap(Map<String, dynamic> map) {
    return Scale(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
