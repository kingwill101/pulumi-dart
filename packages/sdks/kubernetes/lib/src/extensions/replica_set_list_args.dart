...
class ReplicaSetListArgs {
  ...
  ReplicaSetListArgs({
    ...
    required pulumi.Output<List<ReplicaSetExtensionsV1beta1>> items,
  ...
  factory ReplicaSetListArgs.fromMap(Map<String, dynamic> map) {
    return ReplicaSetListArgs(
      ...
      items: pulumi.Output.create<List<ReplicaSetExtensionsV1beta1>>((map['items'] as List).cast<ReplicaSetExtensionsV1beta1>()),
