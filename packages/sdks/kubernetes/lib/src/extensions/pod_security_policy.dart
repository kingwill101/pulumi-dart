...
class PodSecurityPolicy {
  ...
  factory PodSecurityPolicy.fromMap(Map<String, dynamic> map) {
    return PodSecurityPolicy(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodSecurityPolicySpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
