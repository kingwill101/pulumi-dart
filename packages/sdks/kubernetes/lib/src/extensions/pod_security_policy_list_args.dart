...
class PodSecurityPolicyListArgs {
  ...
  PodSecurityPolicyListArgs({
    ...
    required pulumi.Output<List<PodSecurityPolicyExtensionsV1beta1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<PodSecurityPolicyExtensionsV1beta1>>(items),
  ...
  factory PodSecurityPolicyListArgs.fromMap(Map<String, dynamic> map) {
    return PodSecurityPolicyListArgs(
      ...
      items: pulumi.Output.create<List<PodSecurityPolicyExtensionsV1beta1>>((map['items'] as List).cast<PodSecurityPolicyExtensionsV1beta1>()),
