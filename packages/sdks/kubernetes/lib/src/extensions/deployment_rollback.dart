...
class DeploymentRollback {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'rollbackTo':
          pulumi.Input.mapInputValue<RollbackConfig, Map<String, dynamic>>(
            rollbackTo,
            (value) => value.toMap(),
          ),
  ...
  factory DeploymentRollback.fromMap(Map<String, dynamic> map) {
    return DeploymentRollback(
      ...
      rollbackTo: pulumi.Input.fromValue(
        RollbackConfig.fromMap(
          (map['rollbackTo']! as Map).cast<String, dynamic>(),
        ),
      ),
      updatedAnnotations: (() {
