...
/// {@template pulumi_extensions_v1beta1_network_policy_args_doc}
/// The set of arguments for NetworkPolicy.
/// {@endtemplate}
/// {@macro pulumi_extensions_v1beta1_network_policy_args_doc}
class NetworkPolicyArgs {
  ...
  NetworkPolicyArgs({
    ...
    pulumi.Output<NetworkPolicySpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<NetworkPolicySpec>(spec);
  ...
  factory NetworkPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NetworkPolicyArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<NetworkPolicySpec>(NetworkPolicySpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
