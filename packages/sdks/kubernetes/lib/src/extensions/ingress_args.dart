...
/// {@template pulumi_extensions_v1beta1_ingress_args_doc}
/// The set of arguments for Ingress.
/// {@endtemplate}
/// {@macro pulumi_extensions_v1beta1_ingress_args_doc}
class IngressArgs {
  ...
  IngressArgs({
    ...
    pulumi.Output<IngressSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<IngressSpec>(spec);
  ...
  factory IngressArgs.fromMap(Map<String, dynamic> map) {
    return IngressArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<IngressSpec>(IngressSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
