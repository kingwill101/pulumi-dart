...
/// {@template pulumi_autoscaling_v1_horizontal_pod_autoscaler_args_doc}
/// The set of arguments for HorizontalPodAutoscaler.
/// {@endtemplate}
/// {@macro pulumi_autoscaling_v1_horizontal_pod_autoscaler_args_doc}
class HorizontalPodAutoscalerArgs {
  ...
  HorizontalPodAutoscalerArgs({
    ...
    pulumi.Output<HorizontalPodAutoscalerSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<HorizontalPodAutoscalerSpec>(spec);
  ...
  factory HorizontalPodAutoscalerArgs.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<HorizontalPodAutoscalerSpec>(HorizontalPodAutoscalerSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
