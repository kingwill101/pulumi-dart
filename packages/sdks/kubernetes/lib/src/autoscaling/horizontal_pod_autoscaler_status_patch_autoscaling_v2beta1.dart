...
class HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1 {
  ...
  final List<HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1>? conditions;
  /// currentMetrics is the last read state of the metrics used by this autoscaler.
  final List<MetricStatusPatchAutoscalingV2beta1>? currentMetrics;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
      'currentMetrics': ?currentMetrics == null ? null : pulumi.Input.encodeList<MetricStatusPatchAutoscalingV2beta1, Map<String, dynamic>>(currentMetrics!, (value) => value.toMap()),
  ...
  factory HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1(
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1>(map['conditions'], (value) => HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1.fromMap((value as Map).cast<String, dynamic>())),
      currentMetrics: map['currentMetrics'] == null ? null : pulumi.Input.decodeList<MetricStatusPatchAutoscalingV2beta1>(map['currentMetrics'], (value) => MetricStatusPatchAutoscalingV2beta1.fromMap((value as Map).cast<String, dynamic>())),
