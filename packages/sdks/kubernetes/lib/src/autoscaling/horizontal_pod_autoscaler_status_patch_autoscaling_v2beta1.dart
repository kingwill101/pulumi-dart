...
class HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1 {
  ...
  final pulumi.Input<
    List<HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1>
  >?
  conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'currentMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricStatusPatchAutoscalingV2beta1>,
            List<Map<String, dynamic>>
          >(
            currentMetrics,
            (value) =>
  ...
  factory HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1.fromMap(
    ...
    return HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1(
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1.fromMap(
      ...
      currentMetrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricStatusPatchAutoscalingV2beta1>(
            guardedValue,
            (value) => MetricStatusPatchAutoscalingV2beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
