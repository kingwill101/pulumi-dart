...
class HorizontalPodAutoscalerListAutoscalingV2beta1 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<HorizontalPodAutoscalerAutoscalingV2beta1>,
  ...
  factory HorizontalPodAutoscalerListAutoscalingV2beta1.fromMap(
    ...
    return HorizontalPodAutoscalerListAutoscalingV2beta1(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HorizontalPodAutoscalerAutoscalingV2beta1>(
          map['items']!,
          (value) => HorizontalPodAutoscalerAutoscalingV2beta1.fromMap(
