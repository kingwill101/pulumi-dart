...
class HorizontalPodAutoscalerPatchAutoscalingV2beta2Args {
  ...
  const HorizontalPodAutoscalerPatchAutoscalingV2beta2Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory HorizontalPodAutoscalerPatchAutoscalingV2beta2Args.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerPatchAutoscalingV2beta2Args(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
