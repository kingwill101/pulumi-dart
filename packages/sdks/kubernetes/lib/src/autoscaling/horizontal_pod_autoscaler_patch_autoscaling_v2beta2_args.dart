...
class HorizontalPodAutoscalerPatchAutoscalingV2beta2Args {
  ...
  HorizontalPodAutoscalerPatchAutoscalingV2beta2Args({
    ...
    pulumi.Output<HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2>(spec);
  ...
  factory HorizontalPodAutoscalerPatchAutoscalingV2beta2Args.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerPatchAutoscalingV2beta2Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2>(HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
