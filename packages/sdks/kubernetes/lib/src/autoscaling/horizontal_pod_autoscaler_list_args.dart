...
class HorizontalPodAutoscalerListArgs {
  ...
  HorizontalPodAutoscalerListArgs({
    ...
    required pulumi.Output<List<HorizontalPodAutoscalerAutoscalingV1>> items,
  ...
  factory HorizontalPodAutoscalerListArgs.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerListArgs(
      ...
      items: pulumi.Output.create<List<HorizontalPodAutoscalerAutoscalingV1>>((map['items'] as List).cast<HorizontalPodAutoscalerAutoscalingV1>()),
