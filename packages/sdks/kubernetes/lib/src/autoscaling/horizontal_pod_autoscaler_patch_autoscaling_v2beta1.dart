...
class HorizontalPodAutoscalerPatchAutoscalingV2beta1 {
  ...
  final pulumi.Input<HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1>?
  status;
  ...
  factory HorizontalPodAutoscalerPatchAutoscalingV2beta1.fromMap(
    ...
    return HorizontalPodAutoscalerPatchAutoscalingV2beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerSpecPatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerStatusPatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
