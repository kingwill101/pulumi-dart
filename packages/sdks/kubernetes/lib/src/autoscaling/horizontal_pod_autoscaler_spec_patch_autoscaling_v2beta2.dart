...
class HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2 {
  ...
  final pulumi.Input<HorizontalPodAutoscalerBehaviorPatchAutoscalingV2beta2>?
  behavior;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricSpecPatchAutoscalingV2beta2>,
  ...
  factory HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2.fromMap(
    ...
    return HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2(
      behavior: (() {
        ...
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerBehaviorPatchAutoscalingV2beta2.fromMap(
      ...
      metrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricSpecPatchAutoscalingV2beta2>(
            guardedValue,
            (value) => MetricSpecPatchAutoscalingV2beta2.fromMap(
