...
class HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2 {
  ...
  const HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2({
    this.behavior,
    this.maxReplicas,
    this.metrics,
    this.minReplicas,
  ...
  factory HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerSpecPatchAutoscalingV2beta2(
      behavior: (() { final guardedValue = map['behavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerBehaviorPatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricSpecPatchAutoscalingV2beta2>(guardedValue, (value) => MetricSpecPatchAutoscalingV2beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      scaleTargetRef: (() { final guardedValue = map['scaleTargetRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CrossVersionObjectReferencePatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
