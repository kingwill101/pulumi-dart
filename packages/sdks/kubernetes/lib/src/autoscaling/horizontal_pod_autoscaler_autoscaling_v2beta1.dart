...
class HorizontalPodAutoscalerAutoscalingV2beta1 {
  ...
  factory HorizontalPodAutoscalerAutoscalingV2beta1.fromMap(
    ...
    return HorizontalPodAutoscalerAutoscalingV2beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerSpecAutoscalingV2beta1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerStatusAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
