...
class HorizontalPodAutoscalerAutoscalingV2beta1 {
  ...
  final pulumi.Input<HorizontalPodAutoscalerStatusAutoscalingV2beta1>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<HorizontalPodAutoscalerStatusAutoscalingV2beta1, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory HorizontalPodAutoscalerAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerAutoscalingV2beta1(
      ...
      spec: map['spec'] == null ? null : (HorizontalPodAutoscalerSpecAutoscalingV2beta1.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (HorizontalPodAutoscalerStatusAutoscalingV2beta1.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
