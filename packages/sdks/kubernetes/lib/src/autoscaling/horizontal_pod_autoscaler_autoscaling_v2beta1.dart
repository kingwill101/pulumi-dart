...
class HorizontalPodAutoscalerAutoscalingV2beta1 {
  ...
  const HorizontalPodAutoscalerAutoscalingV2beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory HorizontalPodAutoscalerAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerAutoscalingV2beta1(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerStatusAutoscalingV2beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
