...
class MetricStatusPatchAutoscalingV2beta1 {
  ...
  final pulumi.Input<ContainerResourceMetricStatusPatchAutoscalingV2beta1>?
  containerResource;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resource':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceMetricStatusPatchAutoscalingV2beta1,
            Map<String, dynamic>
  ...
  factory MetricStatusPatchAutoscalingV2beta1.fromMap(
    ...
    return MetricStatusPatchAutoscalingV2beta1(
      containerResource: (() {
        ...
        return pulumi.Input.fromValue(
          ContainerResourceMetricStatusPatchAutoscalingV2beta1.fromMap(
      ...
      external: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalMetricStatusPatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      object_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ObjectMetricStatusPatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodsMetricStatusPatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceMetricStatusPatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
