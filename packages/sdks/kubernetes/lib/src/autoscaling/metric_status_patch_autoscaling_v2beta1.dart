...
class MetricStatusPatchAutoscalingV2beta1 {
  ...
  final ContainerResourceMetricStatusPatchAutoscalingV2beta1? containerResource;
  /// external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster).
  final ExternalMetricStatusPatchAutoscalingV2beta1? external;
  /// object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).
  final ObjectMetricStatusPatchAutoscalingV2beta1? object;
  /// pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.
  final PodsMetricStatusPatchAutoscalingV2beta1? pods;
  /// resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source.
  final ResourceMetricStatusPatchAutoscalingV2beta1? resource;
  ...
  factory MetricStatusPatchAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return MetricStatusPatchAutoscalingV2beta1(
      containerResource: map['containerResource'] == null ? null : ContainerResourceMetricStatusPatchAutoscalingV2beta1.fromMap((map['containerResource'] as Map).cast<String, dynamic>()),
      external: map['external'] == null ? null : ExternalMetricStatusPatchAutoscalingV2beta1.fromMap((map['external'] as Map).cast<String, dynamic>()),
      object: map['object'] == null ? null : ObjectMetricStatusPatchAutoscalingV2beta1.fromMap((map['object'] as Map).cast<String, dynamic>()),
      pods: map['pods'] == null ? null : PodsMetricStatusPatchAutoscalingV2beta1.fromMap((map['pods'] as Map).cast<String, dynamic>()),
      resource: map['resource'] == null ? null : ResourceMetricStatusPatchAutoscalingV2beta1.fromMap((map['resource'] as Map).cast<String, dynamic>()),
