...
class HorizontalPodAutoscalerAutoscalingV2beta2 {
  ...
  factory HorizontalPodAutoscalerAutoscalingV2beta2.fromMap(
    ...
    return HorizontalPodAutoscalerAutoscalingV2beta2(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerSpecAutoscalingV2beta2.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerStatusAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
