...
class HorizontalPodAutoscalerPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<HorizontalPodAutoscalerStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory HorizontalPodAutoscalerPatch.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerPatch(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
