...
class HorizontalPodAutoscalerPatch {
  ...
  factory HorizontalPodAutoscalerPatch.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerPatch(
      ...
      spec: map['spec'] == null ? null : (HorizontalPodAutoscalerSpecPatch.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (HorizontalPodAutoscalerStatusPatch.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
