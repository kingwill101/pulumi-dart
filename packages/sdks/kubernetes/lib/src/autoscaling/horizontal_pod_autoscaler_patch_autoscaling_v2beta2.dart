...
class HorizontalPodAutoscalerPatchAutoscalingV2beta2 {
  ...
  final pulumi.Input<HorizontalPodAutoscalerStatusPatchAutoscalingV2beta2>?
  status;
  ...
  factory HorizontalPodAutoscalerPatchAutoscalingV2beta2.fromMap(
    ...
    return HorizontalPodAutoscalerPatchAutoscalingV2beta2(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerStatusPatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
