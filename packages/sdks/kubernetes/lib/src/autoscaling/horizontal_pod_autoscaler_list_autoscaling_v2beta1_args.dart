...
class HorizontalPodAutoscalerListAutoscalingV2beta1Args {
  ...
  const HorizontalPodAutoscalerListAutoscalingV2beta1Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory HorizontalPodAutoscalerListAutoscalingV2beta1Args.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerListAutoscalingV2beta1Args(
      ...
      items: pulumi.Input.fromValue((map['items'] as List).cast<HorizontalPodAutoscalerAutoscalingV2beta1Resource>()),
