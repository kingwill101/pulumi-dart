...
class HorizontalPodAutoscalerListAutoscalingV2beta1Args {
  ...
  final pulumi.Input<List<HorizontalPodAutoscalerAutoscalingV2beta1Resource>>
  items;
  ...
  factory HorizontalPodAutoscalerListAutoscalingV2beta1Args.fromMap(
    ...
    return HorizontalPodAutoscalerListAutoscalingV2beta1Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<HorizontalPodAutoscalerAutoscalingV2beta1Resource>(),
      ),
      kind: (() {
