...
class HorizontalPodAutoscalerAutoscalingV2Args {
  ...
  HorizontalPodAutoscalerAutoscalingV2Args({
    ...
    pulumi.Output<HorizontalPodAutoscalerSpecAutoscalingV2>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<HorizontalPodAutoscalerSpecAutoscalingV2>(spec);
  ...
  factory HorizontalPodAutoscalerAutoscalingV2Args.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerAutoscalingV2Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<HorizontalPodAutoscalerSpecAutoscalingV2>(HorizontalPodAutoscalerSpecAutoscalingV2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
