...
class HorizontalPodAutoscalerSpecAutoscalingV2beta2 {
  ...
  final HorizontalPodAutoscalerBehaviorAutoscalingV2beta2? behavior;
  ...
  final List<MetricSpecAutoscalingV2beta2>? metrics;
  /// minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down.  It defaults to 1 pod.  minReplicas is allowed to be 0 if the alpha feature gate HPAScaleToZero is enabled and at least one Object or External metric is configured.  Scaling is active as long as at least one metric value is available.
  final int? minReplicas;
  /// scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.
  final CrossVersionObjectReferenceAutoscalingV2beta2 scaleTargetRef;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics': ?metrics == null ? null : pulumi.Input.encodeList<MetricSpecAutoscalingV2beta2, Map<String, dynamic>>(metrics!, (value) => value.toMap()),
  ...
  factory HorizontalPodAutoscalerSpecAutoscalingV2beta2.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerSpecAutoscalingV2beta2(
      behavior: map['behavior'] == null ? null : HorizontalPodAutoscalerBehaviorAutoscalingV2beta2.fromMap((map['behavior'] as Map).cast<String, dynamic>()),
      maxReplicas: map['maxReplicas'] as int,
      metrics: map['metrics'] == null ? null : pulumi.Input.decodeList<MetricSpecAutoscalingV2beta2>(map['metrics'], (value) => MetricSpecAutoscalingV2beta2.fromMap((value as Map).cast<String, dynamic>())),
      minReplicas: map['minReplicas'] == null ? null : map['minReplicas'] as int,
      scaleTargetRef: CrossVersionObjectReferenceAutoscalingV2beta2.fromMap((map['scaleTargetRef'] as Map).cast<String, dynamic>()),
    );
  }
}
