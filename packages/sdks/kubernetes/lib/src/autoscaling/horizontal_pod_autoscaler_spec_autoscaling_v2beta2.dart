...
class HorizontalPodAutoscalerSpecAutoscalingV2beta2 {
  ...
  final pulumi.Input<HorizontalPodAutoscalerBehaviorAutoscalingV2beta2>?
  behavior;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricSpecAutoscalingV2beta2>,
  ...
  factory HorizontalPodAutoscalerSpecAutoscalingV2beta2.fromMap(
    ...
    return HorizontalPodAutoscalerSpecAutoscalingV2beta2(
      behavior: (() {
        ...
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerBehaviorAutoscalingV2beta2.fromMap(
      ...
      metrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricSpecAutoscalingV2beta2>(
            guardedValue,
            (value) => MetricSpecAutoscalingV2beta2.fromMap(
