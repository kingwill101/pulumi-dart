...
class HorizontalPodAutoscalerListAutoscalingV2beta1Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<HorizontalPodAutoscalerAutoscalingV2beta1Resource>> items;
  ...
  HorizontalPodAutoscalerListAutoscalingV2beta1Resource(
    ...
    this.items = registerOutput<List<HorizontalPodAutoscalerAutoscalingV2beta1Resource>>('items');
