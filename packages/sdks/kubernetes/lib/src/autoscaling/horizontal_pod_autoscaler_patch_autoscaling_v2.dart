...
class HorizontalPodAutoscalerPatchAutoscalingV2 {
  ...
  factory HorizontalPodAutoscalerPatchAutoscalingV2.fromMap(
    ...
    return HorizontalPodAutoscalerPatchAutoscalingV2(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerSpecPatchAutoscalingV2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerStatusPatchAutoscalingV2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
