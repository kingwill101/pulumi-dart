...
class HorizontalPodAutoscalerPatchAutoscalingV2 {
  ...
  factory HorizontalPodAutoscalerPatchAutoscalingV2.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerPatchAutoscalingV2(
      ...
      spec: map['spec'] == null ? null : (HorizontalPodAutoscalerSpecPatchAutoscalingV2.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (HorizontalPodAutoscalerStatusPatchAutoscalingV2.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
