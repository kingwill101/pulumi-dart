...
class HorizontalPodAutoscalerPatchAutoscalingV2 {
  ...
  final pulumi.Input<HorizontalPodAutoscalerStatusPatchAutoscalingV2?>? status;
  ...
  const HorizontalPodAutoscalerPatchAutoscalingV2({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<HorizontalPodAutoscalerStatusPatchAutoscalingV2, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory HorizontalPodAutoscalerPatchAutoscalingV2.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerPatchAutoscalingV2(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerSpecPatchAutoscalingV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerStatusPatchAutoscalingV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
