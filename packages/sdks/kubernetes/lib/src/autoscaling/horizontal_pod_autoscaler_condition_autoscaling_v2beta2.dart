...
class HorizontalPodAutoscalerConditionAutoscalingV2beta2 {
  ...
  /// Creates a new [HorizontalPodAutoscalerConditionAutoscalingV2beta2].
  ...
  const HorizontalPodAutoscalerConditionAutoscalingV2beta2({
  ...
  factory HorizontalPodAutoscalerConditionAutoscalingV2beta2.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerConditionAutoscalingV2beta2(
