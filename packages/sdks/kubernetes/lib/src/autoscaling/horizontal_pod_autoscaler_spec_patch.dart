...
class HorizontalPodAutoscalerSpecPatch {
  ...
  final CrossVersionObjectReferencePatch? scaleTargetRef;
  ...
  factory HorizontalPodAutoscalerSpecPatch.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerSpecPatch(
      ...
      scaleTargetRef: map['scaleTargetRef'] == null ? null : CrossVersionObjectReferencePatch.fromMap((map['scaleTargetRef'] as Map).cast<String, dynamic>()),
