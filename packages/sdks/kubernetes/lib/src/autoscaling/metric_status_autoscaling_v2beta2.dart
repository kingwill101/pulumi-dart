...
class MetricStatusAutoscalingV2beta2 {
  ...
  final pulumi.Input<ContainerResourceMetricStatusAutoscalingV2beta2>?
  containerResource;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'external':
          ?pulumi.Input.mapOptionalInputValue<
            ExternalMetricStatusAutoscalingV2beta2,
            Map<String, dynamic>
    ...
    return MetricStatusAutoscalingV2beta2(
      containerResource: (() {
        ...
        return pulumi.Input.fromValue(
          ContainerResourceMetricStatusAutoscalingV2beta2.fromMap(
      ...
      external: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalMetricStatusAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      object_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ObjectMetricStatusAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodsMetricStatusAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceMetricStatusAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
