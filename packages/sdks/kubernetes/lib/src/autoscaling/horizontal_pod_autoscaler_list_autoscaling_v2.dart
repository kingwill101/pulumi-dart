...
class HorizontalPodAutoscalerListAutoscalingV2 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<HorizontalPodAutoscalerAutoscalingV2>,
  ...
  factory HorizontalPodAutoscalerListAutoscalingV2.fromMap(
    ...
    return HorizontalPodAutoscalerListAutoscalingV2(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HorizontalPodAutoscalerAutoscalingV2>(
          map['items']!,
          (value) => HorizontalPodAutoscalerAutoscalingV2.fromMap(
