...
class HorizontalPodAutoscalerStatusAutoscalingV2beta2 {
  ...
  final pulumi.Input<List<HorizontalPodAutoscalerConditionAutoscalingV2beta2>>
  conditions;
    ...
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<HorizontalPodAutoscalerConditionAutoscalingV2beta2>,
            List<Map<String, dynamic>>
          >(
            conditions,
            (value) =>
                pulumi.Input.encodeList<
                  HorizontalPodAutoscalerConditionAutoscalingV2beta2,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'currentMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricStatusAutoscalingV2beta2>,
            List<Map<String, dynamic>>
          >(
            currentMetrics,
            (value) =>
  ...
  factory HorizontalPodAutoscalerStatusAutoscalingV2beta2.fromMap(
    ...
    return HorizontalPodAutoscalerStatusAutoscalingV2beta2(
      conditions: pulumi.Input.fromValue(
        ...
        >(
          map['conditions']!,
          (value) => HorizontalPodAutoscalerConditionAutoscalingV2beta2.fromMap(
      ...
      currentMetrics: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricStatusAutoscalingV2beta2>(
            guardedValue,
            (value) => MetricStatusAutoscalingV2beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
