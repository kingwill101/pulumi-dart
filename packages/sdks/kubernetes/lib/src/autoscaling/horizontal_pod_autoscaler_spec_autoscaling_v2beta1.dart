...
class HorizontalPodAutoscalerSpecAutoscalingV2beta1 {
  ...
  final pulumi.Input<CrossVersionObjectReferenceAutoscalingV2beta1>
  scaleTargetRef;
    ...
    return <String, dynamic>{
      ...
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricSpecAutoscalingV2beta1>,
  ...
  factory HorizontalPodAutoscalerSpecAutoscalingV2beta1.fromMap(
    ...
    return HorizontalPodAutoscalerSpecAutoscalingV2beta1(
      ...
      metrics: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricSpecAutoscalingV2beta1>(
            guardedValue,
            (value) => MetricSpecAutoscalingV2beta1.fromMap(
      ...
      scaleTargetRef: pulumi.Input.fromValue(
        CrossVersionObjectReferenceAutoscalingV2beta1.fromMap(
          (map['scaleTargetRef']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
