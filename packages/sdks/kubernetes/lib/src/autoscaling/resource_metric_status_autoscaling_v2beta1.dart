...
class ResourceMetricStatusAutoscalingV2beta1 {
  ...
  const ResourceMetricStatusAutoscalingV2beta1({
  ...
  factory ResourceMetricStatusAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return ResourceMetricStatusAutoscalingV2beta1(
      currentAverageUtilization: (() { final guardedValue = map['currentAverageUtilization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
