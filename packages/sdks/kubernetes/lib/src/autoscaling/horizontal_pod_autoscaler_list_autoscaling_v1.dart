...
class HorizontalPodAutoscalerListAutoscalingV1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<HorizontalPodAutoscaler>> items;
  ...
  HorizontalPodAutoscalerListAutoscalingV1(
    ...
    items = registerOutput<List<HorizontalPodAutoscaler>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<HorizontalPodAutoscaler>(guardedValue, (value) => HorizontalPodAutoscaler.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [HorizontalPodAutoscalerListAutoscalingV1] resource.
  HorizontalPodAutoscalerListAutoscalingV1.reference(String urn)
    : super(
        'kubernetes:autoscaling/v1:HorizontalPodAutoscalerList',
