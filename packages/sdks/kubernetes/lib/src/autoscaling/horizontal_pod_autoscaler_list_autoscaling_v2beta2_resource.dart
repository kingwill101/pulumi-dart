...
class HorizontalPodAutoscalerListAutoscalingV2beta2Resource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<HorizontalPodAutoscalerAutoscalingV2beta2Resource>> items;
  ...
  HorizontalPodAutoscalerListAutoscalingV2beta2Resource(
    ...
    this.items = registerOutput<List<HorizontalPodAutoscalerAutoscalingV2beta2Resource>>('items');
