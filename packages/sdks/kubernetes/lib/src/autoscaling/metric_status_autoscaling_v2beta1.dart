...
class MetricStatusAutoscalingV2beta1 {
  ...
  final pulumi.Input<ContainerResourceMetricStatusAutoscalingV2beta1>?
  containerResource;
    ...
    return MetricStatusAutoscalingV2beta1(
      containerResource: (() {
        ...
        return pulumi.Input.fromValue(
          ContainerResourceMetricStatusAutoscalingV2beta1.fromMap(
      ...
      external: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalMetricStatusAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      object_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ObjectMetricStatusAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodsMetricStatusAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceMetricStatusAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
