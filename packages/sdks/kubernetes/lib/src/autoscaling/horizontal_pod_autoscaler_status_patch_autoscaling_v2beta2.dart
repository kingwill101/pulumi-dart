...
class HorizontalPodAutoscalerStatusPatchAutoscalingV2beta2 {
  ...
  final pulumi.Input<
    List<HorizontalPodAutoscalerConditionPatchAutoscalingV2beta2>
  >?
  conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'currentMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricStatusPatchAutoscalingV2beta2>,
            List<Map<String, dynamic>>
          >(
            currentMetrics,
            (value) =>
  ...
  factory HorizontalPodAutoscalerStatusPatchAutoscalingV2beta2.fromMap(
    ...
    return HorizontalPodAutoscalerStatusPatchAutoscalingV2beta2(
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                HorizontalPodAutoscalerConditionPatchAutoscalingV2beta2.fromMap(
      ...
      currentMetrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricStatusPatchAutoscalingV2beta2>(
            guardedValue,
            (value) => MetricStatusPatchAutoscalingV2beta2.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
