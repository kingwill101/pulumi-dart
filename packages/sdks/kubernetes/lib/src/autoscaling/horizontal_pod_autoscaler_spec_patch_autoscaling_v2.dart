...
class HorizontalPodAutoscalerSpecPatchAutoscalingV2 {
  ...
  final pulumi.Input<CrossVersionObjectReferencePatchAutoscalingV2>?
  scaleTargetRef;
    ...
    return <String, dynamic>{
      'behavior':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(behavior, (value) => value.toMap()),
      'maxReplicas': ?maxReplicas,
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricSpecPatch>,
            List<Map<String, dynamic>>
          >(
            metrics,
            (value) =>
                pulumi.Input.encodeList<MetricSpecPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'scaleTargetRef':
          ?pulumi.Input.mapOptionalInputValue<
            CrossVersionObjectReferencePatchAutoscalingV2,
            Map<String, dynamic>
          >(scaleTargetRef, (value) => value.toMap()),
    };
  }

  factory HorizontalPodAutoscalerSpecPatchAutoscalingV2.fromMap(
    ...
    return HorizontalPodAutoscalerSpecPatchAutoscalingV2(
      behavior: (() {
        ...
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerBehaviorPatch.fromMap(
      ...
      metrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricSpecPatch>(
            guardedValue,
            (value) =>
                MetricSpecPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      minReplicas: (() {
      ...
      scaleTargetRef: (() {
        final guardedValue = map['scaleTargetRef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CrossVersionObjectReferencePatchAutoscalingV2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
