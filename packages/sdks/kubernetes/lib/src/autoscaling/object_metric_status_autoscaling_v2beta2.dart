...
class ObjectMetricStatusAutoscalingV2beta2 {
  ...
  const ObjectMetricStatusAutoscalingV2beta2({
  ...
  factory ObjectMetricStatusAutoscalingV2beta2.fromMap(Map<String, dynamic> map) {
    return ObjectMetricStatusAutoscalingV2beta2(
      ...
      describedObject: pulumi.Input.fromValue(CrossVersionObjectReferenceAutoscalingV2beta2.fromMap((map['describedObject']! as Map).cast<String, dynamic>())),
