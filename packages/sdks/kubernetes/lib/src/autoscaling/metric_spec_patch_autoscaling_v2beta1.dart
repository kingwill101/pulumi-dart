...
class MetricSpecPatchAutoscalingV2beta1 {
  ...
  final pulumi.Input<ObjectMetricSourcePatchAutoscalingV2beta1>? object_;
  ...
  const MetricSpecPatchAutoscalingV2beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'object': ?pulumi.Input.mapOptionalInputValue<ObjectMetricSourcePatchAutoscalingV2beta1, Map<String, dynamic>>(object_, (value) => value.toMap()),
  ...
  factory MetricSpecPatchAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return MetricSpecPatchAutoscalingV2beta1(
      containerResource: (() { final guardedValue = map['containerResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerResourceMetricSourcePatchAutoscalingV2beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      external: (() { final guardedValue = map['external']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExternalMetricSourcePatchAutoscalingV2beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      object_: (() { final guardedValue = map['object']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectMetricSourcePatchAutoscalingV2beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      pods: (() { final guardedValue = map['pods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodsMetricSourcePatchAutoscalingV2beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resource: (() { final guardedValue = map['resource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceMetricSourcePatchAutoscalingV2beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
