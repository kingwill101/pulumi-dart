...
class MetricSpecPatchAutoscalingV2beta1 {
  ...
  final pulumi.Input<ContainerResourceMetricSourcePatchAutoscalingV2beta1>?
  containerResource;
    ...
    return MetricSpecPatchAutoscalingV2beta1(
      containerResource: (() {
        ...
        return pulumi.Input.fromValue(
          ContainerResourceMetricSourcePatchAutoscalingV2beta1.fromMap(
      ...
      external: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalMetricSourcePatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      object_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ObjectMetricSourcePatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodsMetricSourcePatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceMetricSourcePatchAutoscalingV2beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
