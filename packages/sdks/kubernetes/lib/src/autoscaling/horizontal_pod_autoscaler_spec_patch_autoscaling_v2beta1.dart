...
class HorizontalPodAutoscalerSpecPatchAutoscalingV2beta1 {
  ...
  final pulumi.Input<CrossVersionObjectReferencePatchAutoscalingV2beta1>?
  scaleTargetRef;
    ...
    return <String, dynamic>{
      ...
      'metrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricSpecPatchAutoscalingV2beta1>,
  ...
  factory HorizontalPodAutoscalerSpecPatchAutoscalingV2beta1.fromMap(
    ...
    return HorizontalPodAutoscalerSpecPatchAutoscalingV2beta1(
      ...
      metrics: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricSpecPatchAutoscalingV2beta1>(
            guardedValue,
            (value) => MetricSpecPatchAutoscalingV2beta1.fromMap(
      ...
      scaleTargetRef: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CrossVersionObjectReferencePatchAutoscalingV2beta1.fromMap(
