...
class HorizontalPodAutoscalerAutoscalingV2 {
  ...
  const HorizontalPodAutoscalerAutoscalingV2({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory HorizontalPodAutoscalerAutoscalingV2.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerAutoscalingV2(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HorizontalPodAutoscalerStatusAutoscalingV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
