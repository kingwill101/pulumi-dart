...
class HorizontalPodAutoscalerAutoscalingV2 {
  ...
  final HorizontalPodAutoscalerSpecAutoscalingV2? spec;
  /// status is the current information about the autoscaler.
  final HorizontalPodAutoscalerStatusAutoscalingV2? status;
  ...
  factory HorizontalPodAutoscalerAutoscalingV2.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerAutoscalingV2(
      ...
      spec: map['spec'] == null ? null : HorizontalPodAutoscalerSpecAutoscalingV2.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : HorizontalPodAutoscalerStatusAutoscalingV2.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
