...
class HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1 {
  ...
  /// Creates a new [HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1].
  ...
  factory HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscalerConditionPatchAutoscalingV2beta1(
