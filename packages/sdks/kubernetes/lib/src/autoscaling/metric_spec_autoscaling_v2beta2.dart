...
class MetricSpecAutoscalingV2beta2 {
  ...
  final pulumi.Input<ObjectMetricSourceAutoscalingV2beta2?>? object_;
  ...
  const MetricSpecAutoscalingV2beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'object': ?pulumi.Input.mapOptionalInputValue<ObjectMetricSourceAutoscalingV2beta2, Map<String, dynamic>>(object_, (value) => value.toMap()),
  ...
  factory MetricSpecAutoscalingV2beta2.fromMap(Map<String, dynamic> map) {
    return MetricSpecAutoscalingV2beta2(
      containerResource: (() { final guardedValue = map['containerResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerResourceMetricSourceAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      external: (() { final guardedValue = map['external']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExternalMetricSourceAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      object_: (() { final guardedValue = map['object']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectMetricSourceAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      pods: (() { final guardedValue = map['pods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodsMetricSourceAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resource: (() { final guardedValue = map['resource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceMetricSourceAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
