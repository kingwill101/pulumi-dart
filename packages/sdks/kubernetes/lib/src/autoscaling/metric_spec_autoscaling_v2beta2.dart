...
class MetricSpecAutoscalingV2beta2 {
  ...
  final pulumi.Input<ContainerResourceMetricSourceAutoscalingV2beta2>?
  containerResource;
    ...
    return MetricSpecAutoscalingV2beta2(
      containerResource: (() {
        ...
        return pulumi.Input.fromValue(
          ContainerResourceMetricSourceAutoscalingV2beta2.fromMap(
      ...
      external: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalMetricSourceAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      object_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ObjectMetricSourceAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodsMetricSourceAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceMetricSourceAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
