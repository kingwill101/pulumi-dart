...
class HorizontalPodAutoscaler {
  ...
  factory HorizontalPodAutoscaler.fromMap(Map<String, dynamic> map) {
    return HorizontalPodAutoscaler(
      ...
      spec: map['spec'] == null ? null : HorizontalPodAutoscalerSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : HorizontalPodAutoscalerStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
