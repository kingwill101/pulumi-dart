...
class MetricStatusPatchAutoscalingV2beta2 {
  ...
  final pulumi.Input<ObjectMetricStatusPatchAutoscalingV2beta2?>? object_;
  ...
  const MetricStatusPatchAutoscalingV2beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'object': ?pulumi.Input.mapOptionalInputValue<ObjectMetricStatusPatchAutoscalingV2beta2, Map<String, dynamic>>(object_, (value) => value.toMap()),
  ...
  factory MetricStatusPatchAutoscalingV2beta2.fromMap(Map<String, dynamic> map) {
    return MetricStatusPatchAutoscalingV2beta2(
      containerResource: (() { final guardedValue = map['containerResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerResourceMetricStatusPatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      external: (() { final guardedValue = map['external']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExternalMetricStatusPatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      object_: (() { final guardedValue = map['object']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectMetricStatusPatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      pods: (() { final guardedValue = map['pods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodsMetricStatusPatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resource: (() { final guardedValue = map['resource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceMetricStatusPatchAutoscalingV2beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
