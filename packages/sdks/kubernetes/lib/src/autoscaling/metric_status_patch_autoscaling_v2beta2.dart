...
class MetricStatusPatchAutoscalingV2beta2 {
  ...
  final pulumi.Input<ContainerResourceMetricStatusPatchAutoscalingV2beta2>?
  containerResource;
  ...
  factory MetricStatusPatchAutoscalingV2beta2.fromMap(
    ...
    return MetricStatusPatchAutoscalingV2beta2(
      containerResource: (() {
        ...
        return pulumi.Input.fromValue(
          ContainerResourceMetricStatusPatchAutoscalingV2beta2.fromMap(
      ...
      external: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalMetricStatusPatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      object_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ObjectMetricStatusPatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodsMetricStatusPatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceMetricStatusPatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
