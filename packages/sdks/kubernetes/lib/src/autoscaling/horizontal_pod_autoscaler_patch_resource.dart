...
class HorizontalPodAutoscalerPatchResource extends pulumi.CustomResource {
  ...
  HorizontalPodAutoscalerPatchResource(
    ...
    spec = registerOutput<HorizontalPodAutoscalerSpecPatchAutoscalingV2?>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HorizontalPodAutoscalerSpecPatchAutoscalingV2.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    status = registerOutput<HorizontalPodAutoscalerStatusPatchAutoscalingV2?>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HorizontalPodAutoscalerStatusPatchAutoscalingV2.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [HorizontalPodAutoscalerPatchResource] resource.
  HorizontalPodAutoscalerPatchResource.reference(String urn)
    : super(
        'kubernetes:autoscaling/v2:HorizontalPodAutoscalerPatch',
