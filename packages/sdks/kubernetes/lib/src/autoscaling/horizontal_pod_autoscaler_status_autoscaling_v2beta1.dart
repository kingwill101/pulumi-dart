...
class HorizontalPodAutoscalerStatusAutoscalingV2beta1 {
  ...
  final pulumi.Input<List<HorizontalPodAutoscalerConditionAutoscalingV2beta1>>
  conditions;
    ...
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<HorizontalPodAutoscalerConditionAutoscalingV2beta1>,
      ...
      'currentMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricStatusAutoscalingV2beta1>,
            List<Map<String, dynamic>>
          >(
            currentMetrics,
            (value) =>
  ...
  factory HorizontalPodAutoscalerStatusAutoscalingV2beta1.fromMap(
    ...
    return HorizontalPodAutoscalerStatusAutoscalingV2beta1(
      conditions: pulumi.Input.fromValue(
        ...
        >(
          map['conditions']!,
          (value) => HorizontalPodAutoscalerConditionAutoscalingV2beta1.fromMap(
      ...
      currentMetrics: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricStatusAutoscalingV2beta1>(
            guardedValue,
            (value) => MetricStatusAutoscalingV2beta1.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
