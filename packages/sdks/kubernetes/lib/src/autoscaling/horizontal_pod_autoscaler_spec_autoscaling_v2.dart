...
class HorizontalPodAutoscalerSpecAutoscalingV2 {
    ...
    return <String, dynamic>{
      ...
      'metrics':
          ...
          >(
            metrics,
            (value) =>
                pulumi.Input.encodeList<MetricSpec, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory HorizontalPodAutoscalerSpecAutoscalingV2.fromMap(
    ...
    return HorizontalPodAutoscalerSpecAutoscalingV2(
      behavior: (() {
        ...
        return pulumi.Input.fromValue(
          HorizontalPodAutoscalerBehavior.fromMap(
      ...
      metrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricSpec>(
            guardedValue,
            (value) =>
                MetricSpec.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      minReplicas: (() {
