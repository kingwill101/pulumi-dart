...
class MetricSpecPatchAutoscalingV2beta2 {
  ...
  final pulumi.Input<ContainerResourceMetricSourcePatchAutoscalingV2beta2>?
  containerResource;
    ...
    return MetricSpecPatchAutoscalingV2beta2(
      containerResource: (() {
        ...
        return pulumi.Input.fromValue(
          ContainerResourceMetricSourcePatchAutoscalingV2beta2.fromMap(
      ...
      external: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalMetricSourcePatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      object_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ObjectMetricSourcePatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodsMetricSourcePatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceMetricSourcePatchAutoscalingV2beta2.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
