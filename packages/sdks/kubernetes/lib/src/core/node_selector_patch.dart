...
class NodeSelectorPatch {
  ...
  final pulumi.Input<List<NodeSelectorTermPatch>?>? nodeSelectorTerms;
  ...
  factory NodeSelectorPatch.fromMap(Map<String, dynamic> map) {
    return NodeSelectorPatch(
      nodeSelectorTerms: (() { final guardedValue = map['nodeSelectorTerms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeSelectorTermPatch>(guardedValue, (value) => NodeSelectorTermPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
