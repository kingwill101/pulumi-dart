    ...
    return <String, dynamic>{
      ...
      'env':
          ...
          >(
            env,
            (value) =>
                pulumi.Input.encodeList<EnvVarPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'livenessProbe':
          ?pulumi.Input.mapOptionalInputValue<ProbePatch, Map<String, dynamic>>(
            livenessProbe,
            (value) => value.toMap(),
          ),
      'name': ?name,
      ...
      'resizePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerResizePolicyPatch>,
            List<Map<String, dynamic>>
          >(
            resizePolicy,
            (value) =>
      ...
      'restartPolicyRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerRestartRulePatch>,
            List<Map<String, dynamic>>
          >(
            restartPolicyRules,
            (value) =>
      ...
      'volumeMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<VolumeMountPatch>,
            List<Map<String, dynamic>>
          >(
            volumeMounts,
            (value) =>
                pulumi.Input.encodeList<VolumeMountPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return EphemeralContainerPatch(
      ...
      env: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvVarPatch>(
            guardedValue,
            (value) =>
                EnvVarPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      envFrom: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvFromSourcePatch>(
            guardedValue,
            (value) => EnvFromSourcePatch.fromMap(
      ...
      lifecycle: (() {
        final guardedValue = map['lifecycle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LifecyclePatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      livenessProbe: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProbePatch.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerPortPatch>(
            guardedValue,
            (value) => ContainerPortPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      resizePolicy: (() {
        final guardedValue = map['resizePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerResizePolicyPatch>(
            guardedValue,
            (value) => ContainerResizePolicyPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      restartPolicyRules: (() {
        final guardedValue = map['restartPolicyRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerRestartRulePatch>(
            guardedValue,
            (value) => ContainerRestartRulePatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      stdinOnce: (() {
        final guardedValue = map['stdinOnce'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      targetContainerName: (() {
        final guardedValue = map['targetContainerName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      terminationMessagePath: (() {
        final guardedValue = map['terminationMessagePath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      terminationMessagePolicy: (() {
        final guardedValue = map['terminationMessagePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tty: (() {
      ...
      volumeDevices: (() {
        final guardedValue = map['volumeDevices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeDevicePatch>(
            guardedValue,
            (value) => VolumeDevicePatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumeMounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeMountPatch>(
            guardedValue,
            (value) => VolumeMountPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
