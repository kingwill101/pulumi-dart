...
class ProbePatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'grpc': ?pulumi.Input.mapOptionalInputValue<GRPCActionPatch, Map<String, dynamic>>(grpc, (value) => value.toMap()),
  ...
  factory ProbePatch.fromMap(Map<String, dynamic> map) {
    return ProbePatch(
      ...
      grpc: (() { final guardedValue = map['grpc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GRPCActionPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
