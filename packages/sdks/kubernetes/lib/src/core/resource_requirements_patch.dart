...
class ResourceRequirementsPatch {
  ...
  ResourceRequirementsPatch({this.claims, this.limits, this.requests});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'claims':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceClaimPatch>,
    ...
    return ResourceRequirementsPatch(
      claims: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceClaimPatch>(
            guardedValue,
            (value) => ResourceClaimPatch.fromMap(
