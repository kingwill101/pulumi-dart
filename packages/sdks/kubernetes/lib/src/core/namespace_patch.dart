...
class NamespacePatch {
  ...
  factory NamespacePatch.fromMap(Map<String, dynamic> map) {
    return NamespacePatch(
      ...
      spec: map['spec'] == null ? null : (NamespaceSpecPatch.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (NamespaceStatusPatch.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
