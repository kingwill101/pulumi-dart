...
class LifecycleHandler {
  ...
  factory LifecycleHandler.fromMap(Map<String, dynamic> map) {
    return LifecycleHandler(
      ...
      sleep: (() { final guardedValue = map['sleep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SleepAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
