...
class LifecyclePatch {
  ...
  factory LifecyclePatch.fromMap(Map<String, dynamic> map) {
    return LifecyclePatch(
      postStart: (() { final guardedValue = map['postStart']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LifecycleHandlerPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      preStop: (() { final guardedValue = map['preStop']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LifecycleHandlerPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
