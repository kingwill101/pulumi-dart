...
class LoadBalancerIngressPatch {
  ...
  LoadBalancerIngressPatch({this.hostname, this.ip, this.ipMode, this.ports});
    ...
    return <String, dynamic>{
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<PortStatusPatch>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
                pulumi.Input.encodeList<PortStatusPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return LoadBalancerIngressPatch(
      ...
      ports: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortStatusPatch>(
            guardedValue,
            (value) =>
                PortStatusPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
