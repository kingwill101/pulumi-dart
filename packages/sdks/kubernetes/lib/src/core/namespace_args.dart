...
class NamespaceArgs {
  ...
  NamespaceArgs({
    ...
    pulumi.Output<NamespaceSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<NamespaceSpec>(spec);
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<NamespaceSpec>(NamespaceSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
