...
class EvictionResponderPatch {
  ...
  /// Creates a new [EvictionResponderPatch].
  ...
  factory EvictionResponderPatch.fromMap(Map<String, dynamic> map) {
    return EvictionResponderPatch(
