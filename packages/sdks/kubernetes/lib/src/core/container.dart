...
class Container {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lifecycle':
          ?pulumi.Input.mapOptionalInputValue<Lifecycle, Map<String, dynamic>>(
            lifecycle,
            (value) => value.toMap(),
          ),
      'livenessProbe':
          ?pulumi.Input.mapOptionalInputValue<Probe, Map<String, dynamic>>(
            livenessProbe,
            (value) => value.toMap(),
          ),
      'name': name,
      ...
      'volumeDevices':
          ...
          >(
            volumeDevices,
            (value) =>
                pulumi.Input.encodeList<VolumeDevice, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory Container.fromMap(Map<String, dynamic> map) {
    return Container(
      ...
      lifecycle: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Lifecycle.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      livenessProbe: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Probe.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      resizePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerResizePolicy>(
            guardedValue,
            (value) => ContainerResizePolicy.fromMap(
      ...
      restartPolicyRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerRestartRule>(
            guardedValue,
            (value) => ContainerRestartRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumeDevices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeDevice>(
            guardedValue,
            (value) =>
                VolumeDevice.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      volumeMounts: (() {
