...
class Container {
  ...
  factory Container.fromMap(Map<String, dynamic> map) {
    return Container(
      ...
      lifecycle: (() { final guardedValue = map['lifecycle']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Lifecycle.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resizePolicy: (() { final guardedValue = map['resizePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerResizePolicy>(guardedValue, (value) => ContainerResizePolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      restartPolicyRules: (() { final guardedValue = map['restartPolicyRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerRestartRule>(guardedValue, (value) => ContainerRestartRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      volumeDevices: (() { final guardedValue = map['volumeDevices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeDevice>(guardedValue, (value) => VolumeDevice.fromMap((value as Map).cast<String, dynamic>()))); })(),
