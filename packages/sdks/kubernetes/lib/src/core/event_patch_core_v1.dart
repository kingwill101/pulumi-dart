...
class EventPatchCoreV1 extends pulumi.CustomResource {
  ...
  EventPatchCoreV1(
    ...
    this.involvedObject = registerOutput<ObjectReferencePatch?>('involvedObject');
    ...
    this.series = registerOutput<EventSeriesPatch?>('series');
    this.source = registerOutput<EventSourcePatch?>('source');
