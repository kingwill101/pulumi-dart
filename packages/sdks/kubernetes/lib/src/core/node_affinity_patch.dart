...
class NodeAffinityPatch {
  ...
  factory NodeAffinityPatch.fromMap(Map<String, dynamic> map) {
    return NodeAffinityPatch(
      preferredDuringSchedulingIgnoredDuringExecution: (() { final guardedValue = map['preferredDuringSchedulingIgnoredDuringExecution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PreferredSchedulingTermPatch>(guardedValue, (value) => PreferredSchedulingTermPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requiredDuringSchedulingIgnoredDuringExecution: (() { final guardedValue = map['requiredDuringSchedulingIgnoredDuringExecution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeSelectorPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
