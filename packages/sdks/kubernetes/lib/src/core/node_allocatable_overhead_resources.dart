...
class NodeAllocatableOverheadResources {
  ...
  /// Creates a new [NodeAllocatableOverheadResources].
  ...
  const NodeAllocatableOverheadResources({
    required this.name,
    this.perContainer,
    this.perPod,
  });
  ...
  factory NodeAllocatableOverheadResources.fromMap(Map<String, dynamic> map) {
    return NodeAllocatableOverheadResources(
