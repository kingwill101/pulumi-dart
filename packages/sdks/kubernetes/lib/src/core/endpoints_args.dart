...
class EndpointsArgs {
  ...
  EndpointsArgs({this.apiVersion, this.kind, this.metadata, this.subsets});
    ...
    return <String, dynamic>{
      ...
      'subsets':
          ...
          >(
            subsets,
            (value) =>
                pulumi.Input.encodeList<EndpointSubset, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory EndpointsArgs.fromMap(Map<String, dynamic> map) {
    return EndpointsArgs(
      ...
      subsets: (() {
        final guardedValue = map['subsets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointSubset>(
            guardedValue,
            (value) =>
                EndpointSubset.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
