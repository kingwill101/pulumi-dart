...
class EndpointSubsetPatch {
  ...
  factory EndpointSubsetPatch.fromMap(Map<String, dynamic> map) {
    return EndpointSubsetPatch(
      addresses: (() { final guardedValue = map['addresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointAddressPatch>(guardedValue, (value) => EndpointAddressPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      notReadyAddresses: (() { final guardedValue = map['notReadyAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointAddressPatch>(guardedValue, (value) => EndpointAddressPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
