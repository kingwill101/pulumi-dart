...
class SecretProjectionPatch {
  ...
  SecretProjectionPatch({this.items, this.name, this.optional});
    ...
    return <String, dynamic>{
      'items':
          ...
          >(
            items,
            (value) =>
                pulumi.Input.encodeList<KeyToPathPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return SecretProjectionPatch(
      items: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeyToPathPatch>(
            guardedValue,
            (value) =>
                KeyToPathPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
