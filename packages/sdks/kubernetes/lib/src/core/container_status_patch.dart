...
class ContainerStatusPatch {
  ...
  factory ContainerStatusPatch.fromMap(Map<String, dynamic> map) {
    return ContainerStatusPatch(
      ...
      allocatedResourcesStatus: (() { final guardedValue = map['allocatedResourcesStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceStatusPatch>(guardedValue, (value) => ResourceStatusPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      lastState: (() { final guardedValue = map['lastState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerStatePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      user: (() { final guardedValue = map['user']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerUserPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      volumeMounts: (() { final guardedValue = map['volumeMounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeMountStatusPatch>(guardedValue, (value) => VolumeMountStatusPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
