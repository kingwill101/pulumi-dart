...
class ResourceQuotaArgs {
  ...
  ResourceQuotaArgs({
    ...
    pulumi.Output<ResourceQuotaSpec>? spec,
  }) :
  ...
  factory ResourceQuotaArgs.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ResourceQuotaSpec>(ResourceQuotaSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
