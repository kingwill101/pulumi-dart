...
/// {@template pulumi_core_v1_service_account_patch_args_doc}
/// The set of arguments for ServiceAccountPatch.
/// {@endtemplate}
/// {@macro pulumi_core_v1_service_account_patch_args_doc}
class ServiceAccountPatchArgs {
  ...
  /// Creates a new [ServiceAccountPatchArgs].
    ...
    return <String, dynamic>{
      ...
      'imagePullSecrets':
          ?pulumi.Input.mapOptionalInputValue<
            List<LocalObjectReferencePatch>,
  ...
  factory ServiceAccountPatchArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAccountPatchArgs(
      ...
      automountServiceAccountToken: (() {
        final guardedValue = map['automountServiceAccountToken'];
        if (guardedValue == null) return null;
      ...
      imagePullSecrets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LocalObjectReferencePatch>(
            guardedValue,
            (value) => LocalObjectReferencePatch.fromMap(
