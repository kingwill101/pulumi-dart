...
class LimitRangeList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<LimitRange, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory LimitRangeList.fromMap(Map<String, dynamic> map) {
    return LimitRangeList(
      ...
      items: pulumi.Input.decodeList<LimitRange>(map['items'], (value) => LimitRange.fromMap((value as Map).cast<String, dynamic>())),
