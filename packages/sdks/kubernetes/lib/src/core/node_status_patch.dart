    ...
    return <String, dynamic>{
      'addresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodeAddressPatch>,
            List<Map<String, dynamic>>
          >(
            addresses,
            (value) =>
                pulumi.Input.encodeList<NodeAddressPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return NodeStatusPatch(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeAddressPatch>(
            guardedValue,
            (value) => NodeAddressPatch.fromMap(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeConditionPatch>(
            guardedValue,
            (value) => NodeConditionPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      daemonEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodeDaemonEndpointsPatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      images: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerImagePatch>(
            guardedValue,
            (value) => ContainerImagePatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      runtimeHandlers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeRuntimeHandlerPatch>(
            guardedValue,
            (value) => NodeRuntimeHandlerPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      volumesAttached: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AttachedVolumePatch>(
            guardedValue,
            (value) => AttachedVolumePatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
