...
class PodSecurityContext {
  ...
  factory PodSecurityContext.fromMap(Map<String, dynamic> map) {
    return PodSecurityContext(
      ...
      sysctls: (() { final guardedValue = map['sysctls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Sysctl>(guardedValue, (value) => Sysctl.fromMap((value as Map).cast<String, dynamic>()))); })(),
