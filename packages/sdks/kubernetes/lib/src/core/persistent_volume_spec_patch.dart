...
class PersistentVolumeSpecPatch {
  ...
  const PersistentVolumeSpecPatch({
    this.accessModes,
  ...
  factory PersistentVolumeSpecPatch.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeSpecPatch(
      ...
      azureFile: (() { final guardedValue = map['azureFile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureFilePersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      cephfs: (() { final guardedValue = map['cephfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CephFSPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cinder: (() { final guardedValue = map['cinder']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CinderPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      claimRef: (() { final guardedValue = map['claimRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectReferencePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      csi: (() { final guardedValue = map['csi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CSIPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      flexVolume: (() { final guardedValue = map['flexVolume']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FlexPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      glusterfs: (() { final guardedValue = map['glusterfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GlusterfsPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      iscsi: (() { final guardedValue = map['iscsi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ISCSIPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      local: (() { final guardedValue = map['local']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocalVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nodeAffinity: (() { final guardedValue = map['nodeAffinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeNodeAffinityPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rbd: (() { final guardedValue = map['rbd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RBDPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scaleIO: (() { final guardedValue = map['scaleIO']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleIOPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageos: (() { final guardedValue = map['storageos']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageOSPersistentVolumeSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
