...
class NodeConfigStatus {
  ...
  final pulumi.Input<NodeConfigSource>? lastKnownGood;

  /// Creates a new [NodeConfigStatus].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'active': ?pulumi.Input.mapOptionalInputValue<NodeConfigSource, Map<String, dynamic>>(active, (value) => value.toMap()),
      'assigned': ?pulumi.Input.mapOptionalInputValue<NodeConfigSource, Map<String, dynamic>>(assigned, (value) => value.toMap()),
      'error': ?error,
      'lastKnownGood': ?pulumi.Input.mapOptionalInputValue<NodeConfigSource, Map<String, dynamic>>(lastKnownGood, (value) => value.toMap()),
    };
  }

  factory NodeConfigStatus.fromMap(Map<String, dynamic> map) {
    return NodeConfigStatus(
      active: (() { final guardedValue = map['active']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeConfigSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      assigned: (() { final guardedValue = map['assigned']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeConfigSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      error: (() { final guardedValue = map['error']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      lastKnownGood: (() { final guardedValue = map['lastKnownGood']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeConfigSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
