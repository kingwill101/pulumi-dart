...
class ReplicationController {
  ...
  factory ReplicationController.fromMap(Map<String, dynamic> map) {
    return ReplicationController(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationControllerSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationControllerStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
