...
class ReplicationController {
  ...
  factory ReplicationController.fromMap(Map<String, dynamic> map) {
    return ReplicationController(
      ...
      spec: map['spec'] == null ? null : ReplicationControllerSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : ReplicationControllerStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
