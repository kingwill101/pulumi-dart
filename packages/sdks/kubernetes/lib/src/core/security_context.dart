...
class SecurityContext {
  ...
  final pulumi.Input<Capabilities?>? capabilities;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'capabilities': ?pulumi.Input.mapOptionalInputValue<Capabilities, Map<String, dynamic>>(capabilities, (value) => value.toMap()),
  ...
  factory SecurityContext.fromMap(Map<String, dynamic> map) {
    return SecurityContext(
      ...
      appArmorProfile: (() { final guardedValue = map['appArmorProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppArmorProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      capabilities: (() { final guardedValue = map['capabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Capabilities.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      procMount: (() { final guardedValue = map['procMount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      seLinuxOptions: (() { final guardedValue = map['seLinuxOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SELinuxOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      seccompProfile: (() { final guardedValue = map['seccompProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SeccompProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      windowsOptions: (() { final guardedValue = map['windowsOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsSecurityContextOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
