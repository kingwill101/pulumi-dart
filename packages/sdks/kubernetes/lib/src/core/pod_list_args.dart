...
import 'pod_core_v1.dart';

/// {@template pulumi_core_v1_pod_list_args_doc}
/// The set of arguments for PodList.
/// {@endtemplate}
/// {@macro pulumi_core_v1_pod_list_args_doc}
class PodListArgs {
  ...
  PodListArgs({
    ...
    required pulumi.Output<List<PodCoreV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<PodCoreV1>>(items),
  ...
  factory PodListArgs.fromMap(Map<String, dynamic> map) {
    return PodListArgs(
      ...
      items: pulumi.Output.create<List<PodCoreV1>>((map['items'] as List).cast<PodCoreV1>()),
