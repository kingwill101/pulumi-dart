...
class RBDVolumeSourcePatch {
  ...
  /// Creates a new [RBDVolumeSourcePatch].
  ...
  factory RBDVolumeSourcePatch.fromMap(Map<String, dynamic> map) {
    return RBDVolumeSourcePatch(
