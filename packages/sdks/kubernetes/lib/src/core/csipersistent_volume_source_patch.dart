...
class CSIPersistentVolumeSourcePatch {
    ...
    return <String, dynamic>{
      'controllerExpandSecretRef':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(controllerExpandSecretRef, (value) => value.toMap()),
      'controllerPublishSecretRef':
          ?pulumi.Input.mapOptionalInputValue<
            SecretReferencePatch,
            Map<String, dynamic>
          >(controllerPublishSecretRef, (value) => value.toMap()),
      'driver': ?driver,
      'fsType': ?fsType,
      'nodeExpandSecretRef':
          ?pulumi.Input.mapOptionalInputValue<
            SecretReferencePatch,
            Map<String, dynamic>
          >(nodeExpandSecretRef, (value) => value.toMap()),
      'nodePublishSecretRef':
          ?pulumi.Input.mapOptionalInputValue<
            SecretReferencePatch,
            Map<String, dynamic>
          >(nodePublishSecretRef, (value) => value.toMap()),
      'nodeStageSecretRef':
          ?pulumi.Input.mapOptionalInputValue<
            SecretReferencePatch,
            Map<String, dynamic>
          >(nodeStageSecretRef, (value) => value.toMap()),
      'readOnly': ?readOnly,
  ...
  factory CSIPersistentVolumeSourcePatch.fromMap(Map<String, dynamic> map) {
    return CSIPersistentVolumeSourcePatch(
      controllerExpandSecretRef: (() {
        final guardedValue = map['controllerExpandSecretRef'];
      ...
      controllerPublishSecretRef: (() {
        final guardedValue = map['controllerPublishSecretRef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretReferencePatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      nodeExpandSecretRef: (() {
        final guardedValue = map['nodeExpandSecretRef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretReferencePatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      nodePublishSecretRef: (() {
        final guardedValue = map['nodePublishSecretRef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretReferencePatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      nodeStageSecretRef: (() {
        final guardedValue = map['nodeStageSecretRef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretReferencePatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      volumeAttributes: (() {
        final guardedValue = map['volumeAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      volumeHandle: (() {
        final guardedValue = map['volumeHandle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
