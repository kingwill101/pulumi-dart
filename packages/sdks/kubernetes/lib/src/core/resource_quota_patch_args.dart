...
class ResourceQuotaPatchArgs {
  ...
  ResourceQuotaPatchArgs({
    ...
    pulumi.Output<ResourceQuotaSpecPatch>? spec,
  }) :
  ...
  factory ResourceQuotaPatchArgs.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ResourceQuotaSpecPatch>(ResourceQuotaSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
