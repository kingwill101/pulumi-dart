...
class NodeConfigStatusPatch {
  ...
  final pulumi.Input<NodeConfigSourcePatch>? lastKnownGood;

  /// Creates a new [NodeConfigStatusPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'active': ?pulumi.Input.mapOptionalInputValue<NodeConfigSourcePatch, Map<String, dynamic>>(active, (value) => value.toMap()),
      'assigned': ?pulumi.Input.mapOptionalInputValue<NodeConfigSourcePatch, Map<String, dynamic>>(assigned, (value) => value.toMap()),
      'error': ?error,
      'lastKnownGood': ?pulumi.Input.mapOptionalInputValue<NodeConfigSourcePatch, Map<String, dynamic>>(lastKnownGood, (value) => value.toMap()),
    };
  }

  factory NodeConfigStatusPatch.fromMap(Map<String, dynamic> map) {
    return NodeConfigStatusPatch(
      active: (() { final guardedValue = map['active']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeConfigSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      assigned: (() { final guardedValue = map['assigned']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeConfigSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      error: (() { final guardedValue = map['error']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      lastKnownGood: (() { final guardedValue = map['lastKnownGood']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeConfigSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
