    ...
    return <String, dynamic>{
      'active':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(active, (value) => value.toMap()),
      'assigned':
          ?pulumi.Input.mapOptionalInputValue<
            NodeConfigSourcePatch,
            Map<String, dynamic>
          >(assigned, (value) => value.toMap()),
      'error': ?error,
      'lastKnownGood':
          ?pulumi.Input.mapOptionalInputValue<
            NodeConfigSourcePatch,
            Map<String, dynamic>
          >(lastKnownGood, (value) => value.toMap()),
    };
  }
    ...
    return NodeConfigStatusPatch(
      active: (() {
        ...
        return pulumi.Input.fromValue(
          NodeConfigSourcePatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      assigned: (() {
        final guardedValue = map['assigned'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodeConfigSourcePatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      lastKnownGood: (() {
        final guardedValue = map['lastKnownGood'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodeConfigSourcePatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
