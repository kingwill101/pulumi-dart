...
class NodeConfigStatusPatch {
  ...
  final NodeConfigSourcePatch? lastKnownGood;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'active': ?active == null ? null : active!.toMap(),
      'assigned': ?assigned == null ? null : assigned!.toMap(),
      'error': ?error,
      'lastKnownGood': ?lastKnownGood == null ? null : lastKnownGood!.toMap(),
    };
  }

  factory NodeConfigStatusPatch.fromMap(Map<String, dynamic> map) {
    return NodeConfigStatusPatch(
      active: map['active'] == null ? null : NodeConfigSourcePatch.fromMap((map['active'] as Map).cast<String, dynamic>()),
      assigned: map['assigned'] == null ? null : NodeConfigSourcePatch.fromMap((map['assigned'] as Map).cast<String, dynamic>()),
      error: map['error'] == null ? null : map['error'] as String,
      lastKnownGood: map['lastKnownGood'] == null ? null : NodeConfigSourcePatch.fromMap((map['lastKnownGood'] as Map).cast<String, dynamic>()),
    );
  }
}
