...
class PersistentVolumeArgs {
  ...
  PersistentVolumeArgs({
    ...
    pulumi.Output<PersistentVolumeSpec>? spec,
  }) :
  ...
  factory PersistentVolumeArgs.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PersistentVolumeSpec>(PersistentVolumeSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
