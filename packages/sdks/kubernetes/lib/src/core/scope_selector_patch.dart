...
class ScopeSelectorPatch {
  ...
  factory ScopeSelectorPatch.fromMap(Map<String, dynamic> map) {
    return ScopeSelectorPatch(
      matchExpressions: (() { final guardedValue = map['matchExpressions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScopedResourceSelectorRequirementPatch>(guardedValue, (value) => ScopedResourceSelectorRequirementPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
