...
class ScopeSelectorPatch {
  ...
  final pulumi.Input<List<ScopedResourceSelectorRequirementPatch>>?
  matchExpressions;

  /// Creates a new [ScopeSelectorPatch].
  /// [matchExpressions] A list of scope selector requirements by scope of the resources.
  ScopeSelectorPatch({this.matchExpressions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchExpressions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScopedResourceSelectorRequirementPatch>,
    ...
    return ScopeSelectorPatch(
      matchExpressions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScopedResourceSelectorRequirementPatch>(
            guardedValue,
            (value) => ScopedResourceSelectorRequirementPatch.fromMap(
