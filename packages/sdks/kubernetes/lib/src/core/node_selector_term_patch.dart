...
class NodeSelectorTermPatch {
  ...
  NodeSelectorTermPatch({this.matchExpressions, this.matchFields});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchExpressions':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodeSelectorRequirementPatch>,
    ...
    return NodeSelectorTermPatch(
      matchExpressions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeSelectorRequirementPatch>(
            guardedValue,
            (value) => NodeSelectorRequirementPatch.fromMap(
      ...
      matchFields: (() {
        final guardedValue = map['matchFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeSelectorRequirementPatch>(
            guardedValue,
