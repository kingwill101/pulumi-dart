...
class StorageOSPersistentVolumeSource {
  ...
  final pulumi.Input<ObjectReference>? secretRef;
  ...
  /// Creates a new [StorageOSPersistentVolumeSource].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fsType': ?fsType,
      'readOnly': ?readOnly,
      'secretRef': ?pulumi.Input.mapOptionalInputValue<ObjectReference, Map<String, dynamic>>(secretRef, (value) => value.toMap()),
  ...
  factory StorageOSPersistentVolumeSource.fromMap(Map<String, dynamic> map) {
    return StorageOSPersistentVolumeSource(
      ...
      secretRef: (() { final guardedValue = map['secretRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
