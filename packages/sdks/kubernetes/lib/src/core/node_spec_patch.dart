...
class NodeSpecPatch {
  ...
  factory NodeSpecPatch.fromMap(Map<String, dynamic> map) {
    return NodeSpecPatch(
      configSource: (() { final guardedValue = map['configSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeConfigSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
