...
class PersistentVolumeClaimPatch {
  ...
  final PersistentVolumeClaimStatusPatch? status;
  ...
  factory PersistentVolumeClaimPatch.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeClaimPatch(
      ...
      status: map['status'] == null ? null : PersistentVolumeClaimStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
