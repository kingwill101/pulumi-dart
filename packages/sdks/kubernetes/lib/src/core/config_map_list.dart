...
class ConfigMapList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items':
          pulumi
              .Input.mapInputValue<List<ConfigMap>, List<Map<String, dynamic>>>(
            items,
            (value) => pulumi.Input.encodeList<ConfigMap, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory ConfigMapList.fromMap(Map<String, dynamic> map) {
    return ConfigMapList(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConfigMap>(
          map['items']!,
          (value) => ConfigMap.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      kind: (() {
