...
class ConfigMapPatchArgs {
  ...
  factory ConfigMapPatchArgs.fromMap(Map<String, dynamic> map) {
    return ConfigMapPatchArgs(
      ...
      binaryData: (() { final guardedValue = map['binaryData']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
