...
class PodTemplateList {
  ...
  final pulumi.Input<List<PodTemplate>> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<PodTemplate>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<PodTemplate, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory PodTemplateList.fromMap(Map<String, dynamic> map) {
    return PodTemplateList(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<PodTemplate>(map['items']!, (value) => PodTemplate.fromMap((value as Map).cast<String, dynamic>()))),
