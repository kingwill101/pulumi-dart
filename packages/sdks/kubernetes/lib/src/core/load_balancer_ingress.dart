...
class LoadBalancerIngress {
  ...
  factory LoadBalancerIngress.fromMap(Map<String, dynamic> map) {
    return LoadBalancerIngress(
      ...
      ports: (() { final guardedValue = map['ports']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PortStatus>(guardedValue, (value) => PortStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
