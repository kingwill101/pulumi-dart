...
class LoadBalancerIngress {
  ...
  LoadBalancerIngress({this.hostname, this.ip, this.ipMode, this.ports});
    ...
    return <String, dynamic>{
      ...
      'ports':
          ...
          >(
            ports,
            (value) =>
                pulumi.Input.encodeList<PortStatus, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return LoadBalancerIngress(
      ...
      ports: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortStatus>(
            guardedValue,
            (value) =>
                PortStatus.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
