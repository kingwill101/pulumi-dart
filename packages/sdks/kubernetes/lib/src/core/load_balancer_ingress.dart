...
class LoadBalancerIngress {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ip': ?ip,
      'ipMode': ?ipMode,
      'ports': ?ports == null ? null : pulumi.Input.encodeList<PortStatus, Map<String, dynamic>>(ports!, (value) => value.toMap()),
    };
  }
  ...
  factory LoadBalancerIngress.fromMap(Map<String, dynamic> map) {
    return LoadBalancerIngress(
      ...
      ports: map['ports'] == null ? null : pulumi.Input.decodeList<PortStatus>(map['ports'], (value) => PortStatus.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
