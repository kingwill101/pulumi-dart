    ...
    return VolumeProjection(
      clusterTrustBundle: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterTrustBundleProjection.fromMap(
      ...
      podCertificate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodCertificateProjection.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      serviceAccountToken: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceAccountTokenProjection.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
