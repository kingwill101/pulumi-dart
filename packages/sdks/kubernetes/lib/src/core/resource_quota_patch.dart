...
class ResourceQuotaPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': ?pulumi.Input.mapOptionalInputValue<ResourceQuotaSpecPatch, Map<String, dynamic>>(spec, (value) => value.toMap()),
      'status': ?pulumi.Input.mapOptionalInputValue<ResourceQuotaStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory ResourceQuotaPatch.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaPatch(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceQuotaSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceQuotaStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
