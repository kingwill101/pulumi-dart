...
class PersistentVolumeClaimSpec {
  ...
  factory PersistentVolumeClaimSpec.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeClaimSpec(
      ...
      dataSource: map['dataSource'] == null ? null : TypedLocalObjectReference.fromMap((map['dataSource'] as Map).cast<String, dynamic>()),
      dataSourceRef: map['dataSourceRef'] == null ? null : TypedObjectReference.fromMap((map['dataSourceRef'] as Map).cast<String, dynamic>()),
      resources: map['resources'] == null ? null : VolumeResourceRequirements.fromMap((map['resources'] as Map).cast<String, dynamic>()),
