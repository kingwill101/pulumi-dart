...
class LifecycleHandlerPatch {
  ...
  factory LifecycleHandlerPatch.fromMap(Map<String, dynamic> map) {
    return LifecycleHandlerPatch(
      ...
      sleep: (() { final guardedValue = map['sleep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SleepActionPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
