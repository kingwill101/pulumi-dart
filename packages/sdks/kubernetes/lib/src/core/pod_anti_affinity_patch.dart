...
class PodAntiAffinityPatch {
    ...
    return <String, dynamic>{
      'preferredDuringSchedulingIgnoredDuringExecution':
          ?pulumi.Input.mapOptionalInputValue<
            List<WeightedPodAffinityTermPatch>,
  ...
  factory PodAntiAffinityPatch.fromMap(Map<String, dynamic> map) {
    return PodAntiAffinityPatch(
      preferredDuringSchedulingIgnoredDuringExecution: (() {
        final guardedValue =
            map['preferredDuringSchedulingIgnoredDuringExecution'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WeightedPodAffinityTermPatch>(
            guardedValue,
            (value) => WeightedPodAffinityTermPatch.fromMap(
      ...
      requiredDuringSchedulingIgnoredDuringExecution: (() {
        final guardedValue =
            map['requiredDuringSchedulingIgnoredDuringExecution'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PodAffinityTermPatch>(
            guardedValue,
            (value) => PodAffinityTermPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
