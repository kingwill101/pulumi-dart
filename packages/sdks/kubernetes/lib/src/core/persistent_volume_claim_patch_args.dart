...
class PersistentVolumeClaimPatchArgs {
  ...
  PersistentVolumeClaimPatchArgs({
    ...
    pulumi.Output<PersistentVolumeClaimSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<PersistentVolumeClaimSpecPatch>(spec);
  ...
  factory PersistentVolumeClaimPatchArgs.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeClaimPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PersistentVolumeClaimSpecPatch>(PersistentVolumeClaimSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
