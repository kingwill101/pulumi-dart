...
class ResourceQuotaSpec {
  ...
  factory ResourceQuotaSpec.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaSpec(
      ...
      scopeSelector: (() { final guardedValue = map['scopeSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScopeSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
