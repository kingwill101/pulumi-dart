...
class EnvVarSourcePatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileKeyRef':
          ?pulumi.Input.mapOptionalInputValue<
            FileKeySelectorPatch,
            Map<String, dynamic>
          >(fileKeyRef, (value) => value.toMap()),
      'resourceFieldRef':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory EnvVarSourcePatch.fromMap(Map<String, dynamic> map) {
    return EnvVarSourcePatch(
      configMapKeyRef: (() {
        final guardedValue = map['configMapKeyRef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigMapKeySelectorPatch.fromMap(
      ...
      fileKeyRef: (() {
        final guardedValue = map['fileKeyRef'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FileKeySelectorPatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      secretKeyRef: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretKeySelectorPatch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
