    ...
    return <String, dynamic>{
      ...
      'items':
          ...
          >(
            items,
            (value) =>
                pulumi.Input.encodeList<PersistentVolume, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory PersistentVolumeList.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeList(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PersistentVolume>(
          map['items']!,
          (value) =>
              PersistentVolume.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      kind: (() {
