...
class PersistentVolumeList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<PersistentVolume, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory PersistentVolumeList.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeList(
      ...
      items: pulumi.Input.decodeList<PersistentVolume>(map['items'], (value) => PersistentVolume.fromMap((value as Map).cast<String, dynamic>())),
