...
class PodDNSConfigPatch {
  ...
  PodDNSConfigPatch({this.nameservers, this.options, this.searches});
    ...
    return PodDNSConfigPatch(
      ...
      options: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PodDNSConfigOptionPatch>(
            guardedValue,
            (value) => PodDNSConfigOptionPatch.fromMap(
