...
class PodDNSConfigPatch {
  ...
  final List<PodDNSConfigOptionPatch>? options;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'options': ?options == null ? null : pulumi.Input.encodeList<PodDNSConfigOptionPatch, Map<String, dynamic>>(options!, (value) => value.toMap()),
      'searches': ?searches,
    };
  }
  ...
  factory PodDNSConfigPatch.fromMap(Map<String, dynamic> map) {
    return PodDNSConfigPatch(
      ...
      options: map['options'] == null ? null : pulumi.Input.decodeList<PodDNSConfigOptionPatch>(map['options'], (value) => PodDNSConfigOptionPatch.fromMap((value as Map).cast<String, dynamic>())),
