...
class LimitRangeListArgs {
  ...
  LimitRangeListArgs({
    ...
    required pulumi.Output<List<LimitRangeCoreV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<LimitRangeCoreV1>>(items),
  ...
  factory LimitRangeListArgs.fromMap(Map<String, dynamic> map) {
    return LimitRangeListArgs(
      ...
      items: pulumi.Output.create<List<LimitRangeCoreV1>>((map['items'] as List).cast<LimitRangeCoreV1>()),
