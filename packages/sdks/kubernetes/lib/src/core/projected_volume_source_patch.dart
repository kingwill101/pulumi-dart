...
class ProjectedVolumeSourcePatch {
  ...
  ProjectedVolumeSourcePatch({this.defaultMode, this.sources});
    ...
    return ProjectedVolumeSourcePatch(
      ...
      sources: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeProjectionPatch>(
            guardedValue,
            (value) => VolumeProjectionPatch.fromMap(
