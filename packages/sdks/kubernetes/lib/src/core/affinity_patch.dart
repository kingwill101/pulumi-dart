...
class AffinityPatch {
  ...
  AffinityPatch({this.nodeAffinity, this.podAffinity, this.podAntiAffinity});
    ...
    return <String, dynamic>{
      ...
      'podAffinity':
          ?pulumi.Input.mapOptionalInputValue<
            PodAffinityPatch,
            Map<String, dynamic>
          >(podAffinity, (value) => value.toMap()),
      'podAntiAffinity':
          ?pulumi.Input.mapOptionalInputValue<
            PodAntiAffinityPatch,
            Map<String, dynamic>
          >(podAntiAffinity, (value) => value.toMap()),
    };
  }
