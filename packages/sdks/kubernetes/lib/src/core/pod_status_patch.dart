...
class PodStatusPatch {
  ...
  final pulumi.Input<PodExtendedResourceClaimStatusPatch>?
    ...
    return <String, dynamic>{
      ...
      'hostIPs':
          ...
          >(
            hostIPs,
            (value) =>
                pulumi.Input.encodeList<HostIPPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'podIPs':
          ...
          >(
            podIPs,
            (value) =>
                pulumi.Input.encodeList<PodIPPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'resourceClaimStatuses':
          ?pulumi.Input.mapOptionalInputValue<
            List<PodResourceClaimStatusPatch>,
            List<Map<String, dynamic>>
          >(
            resourceClaimStatuses,
            (value) =>
  ...
  factory PodStatusPatch.fromMap(Map<String, dynamic> map) {
    return PodStatusPatch(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PodConditionPatch>(
            guardedValue,
            (value) => PodConditionPatch.fromMap(
      ...
      containerStatuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerStatusPatch>(
            guardedValue,
            (value) => ContainerStatusPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      extendedResourceClaimStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodExtendedResourceClaimStatusPatch.fromMap(
      ...
      hostIPs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HostIPPatch>(
            guardedValue,
            (value) =>
                HostIPPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      initContainerStatuses: (() {
      ...
      podIPs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PodIPPatch>(
            guardedValue,
            (value) =>
                PodIPPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      qosClass: (() {
      ...
      resourceClaimStatuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PodResourceClaimStatusPatch>(
            guardedValue,
            (value) => PodResourceClaimStatusPatch.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
