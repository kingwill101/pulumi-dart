...
import 'pod_resource_claim_status_patch.dart';
import 'pod_volume_health_patch.dart';
...
class PodStatusPatch {
  ...
  final pulumi.Input<List<PodVolumeHealthPatch>?>? volumeHealth;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTime': ?startTime,
      'volumeHealth': ?pulumi.Input.mapOptionalInputValue<List<PodVolumeHealthPatch>, List<Map<String, dynamic>>>(volumeHealth, (value) => pulumi.Input.encodeList<PodVolumeHealthPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory PodStatusPatch.fromMap(Map<String, dynamic> map) {
    return PodStatusPatch(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodConditionPatch>(guardedValue, (value) => PodConditionPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      containerStatuses: (() { final guardedValue = map['containerStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerStatusPatch>(guardedValue, (value) => ContainerStatusPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ephemeralContainerStatuses: (() { final guardedValue = map['ephemeralContainerStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerStatusPatch>(guardedValue, (value) => ContainerStatusPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      extendedResourceClaimStatus: (() { final guardedValue = map['extendedResourceClaimStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodExtendedResourceClaimStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      podIPs: (() { final guardedValue = map['podIPs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodIPPatch>(guardedValue, (value) => PodIPPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      resourceClaimStatuses: (() { final guardedValue = map['resourceClaimStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodResourceClaimStatusPatch>(guardedValue, (value) => PodResourceClaimStatusPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      volumeHealth: (() { final guardedValue = map['volumeHealth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodVolumeHealthPatch>(guardedValue, (value) => PodVolumeHealthPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
