...
class NodeAffinity {
  ...
  factory NodeAffinity.fromMap(Map<String, dynamic> map) {
    return NodeAffinity(
      preferredDuringSchedulingIgnoredDuringExecution: (() { final guardedValue = map['preferredDuringSchedulingIgnoredDuringExecution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PreferredSchedulingTerm>(guardedValue, (value) => PreferredSchedulingTerm.fromMap((value as Map).cast<String, dynamic>()))); })(),
      requiredDuringSchedulingIgnoredDuringExecution: (() { final guardedValue = map['requiredDuringSchedulingIgnoredDuringExecution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
