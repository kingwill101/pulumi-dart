...
class NodeAffinity {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'preferredDuringSchedulingIgnoredDuringExecution': ?preferredDuringSchedulingIgnoredDuringExecution == null ? null : pulumi.Input.encodeList<PreferredSchedulingTerm, Map<String, dynamic>>(preferredDuringSchedulingIgnoredDuringExecution!, (value) => value.toMap()),
  ...
  factory NodeAffinity.fromMap(Map<String, dynamic> map) {
    return NodeAffinity(
      preferredDuringSchedulingIgnoredDuringExecution: map['preferredDuringSchedulingIgnoredDuringExecution'] == null ? null : pulumi.Input.decodeList<PreferredSchedulingTerm>(map['preferredDuringSchedulingIgnoredDuringExecution'], (value) => PreferredSchedulingTerm.fromMap((value as Map).cast<String, dynamic>())),
      requiredDuringSchedulingIgnoredDuringExecution: map['requiredDuringSchedulingIgnoredDuringExecution'] == null ? null : NodeSelector.fromMap((map['requiredDuringSchedulingIgnoredDuringExecution'] as Map).cast<String, dynamic>()),
    );
  }
}
