...
class NodeAffinity {
  ...
  final pulumi.Input<List<PreferredSchedulingTerm>>?
  preferredDuringSchedulingIgnoredDuringExecution;

  /// If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to an update), the system may or may not try to eventually evict the pod from its node.
  final pulumi.Input<NodeSelector>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requiredDuringSchedulingIgnoredDuringExecution':
          ?pulumi
              .Input.mapOptionalInputValue<NodeSelector, Map<String, dynamic>>(
            requiredDuringSchedulingIgnoredDuringExecution,
            (value) => value.toMap(),
          ),
    };
    ...
    return NodeAffinity(
      preferredDuringSchedulingIgnoredDuringExecution: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PreferredSchedulingTerm>(
            guardedValue,
            (value) => PreferredSchedulingTerm.fromMap(
