...
class HTTPGetActionPatch {
  ...
  factory HTTPGetActionPatch.fromMap(Map<String, dynamic> map) {
    return HTTPGetActionPatch(
      ...
      httpHeaders: map['httpHeaders'] == null ? null : (pulumi.Input.decodeList<HTTPHeaderPatch>(map['httpHeaders'], (value) => HTTPHeaderPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
