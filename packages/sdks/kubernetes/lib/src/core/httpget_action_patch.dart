    ...
    return <String, dynamic>{
      ...
      'httpHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<HTTPHeaderPatch>,
            List<Map<String, dynamic>>
          >(
            httpHeaders,
            (value) =>
                pulumi.Input.encodeList<HTTPHeaderPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return HTTPGetActionPatch(
      ...
      httpHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HTTPHeaderPatch>(
            guardedValue,
            (value) =>
                HTTPHeaderPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      path: (() {
