...
class PersistentVolume {
  ...
  factory PersistentVolume.fromMap(Map<String, dynamic> map) {
    return PersistentVolume(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PersistentVolumeSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PersistentVolumeStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
