...
class VolumePatch {
  ...
  factory VolumePatch.fromMap(Map<String, dynamic> map) {
    return VolumePatch(
      ...
      azureFile: map['azureFile'] == null ? null : (AzureFileVolumeSourcePatch.fromMap((map['azureFile'] as Map).cast<String, dynamic>())).input(),
      cephfs: map['cephfs'] == null ? null : (CephFSVolumeSourcePatch.fromMap((map['cephfs'] as Map).cast<String, dynamic>())).input(),
      cinder: map['cinder'] == null ? null : (CinderVolumeSourcePatch.fromMap((map['cinder'] as Map).cast<String, dynamic>())).input(),
      configMap: map['configMap'] == null ? null : (ConfigMapVolumeSourcePatch.fromMap((map['configMap'] as Map).cast<String, dynamic>())).input(),
      csi: map['csi'] == null ? null : (CSIVolumeSourcePatch.fromMap((map['csi'] as Map).cast<String, dynamic>())).input(),
      downwardAPI: map['downwardAPI'] == null ? null : (DownwardAPIVolumeSourcePatch.fromMap((map['downwardAPI'] as Map).cast<String, dynamic>())).input(),
      emptyDir: map['emptyDir'] == null ? null : (EmptyDirVolumeSourcePatch.fromMap((map['emptyDir'] as Map).cast<String, dynamic>())).input(),
      ephemeral: map['ephemeral'] == null ? null : (EphemeralVolumeSourcePatch.fromMap((map['ephemeral'] as Map).cast<String, dynamic>())).input(),
      fc: map['fc'] == null ? null : (FCVolumeSourcePatch.fromMap((map['fc'] as Map).cast<String, dynamic>())).input(),
      flexVolume: map['flexVolume'] == null ? null : (FlexVolumeSourcePatch.fromMap((map['flexVolume'] as Map).cast<String, dynamic>())).input(),
      ...
      gitRepo: map['gitRepo'] == null ? null : (GitRepoVolumeSourcePatch.fromMap((map['gitRepo'] as Map).cast<String, dynamic>())).input(),
      glusterfs: map['glusterfs'] == null ? null : (GlusterfsVolumeSourcePatch.fromMap((map['glusterfs'] as Map).cast<String, dynamic>())).input(),
      hostPath: map['hostPath'] == null ? null : (HostPathVolumeSourcePatch.fromMap((map['hostPath'] as Map).cast<String, dynamic>())).input(),
      image: map['image'] == null ? null : (ImageVolumeSourcePatch.fromMap((map['image'] as Map).cast<String, dynamic>())).input(),
      iscsi: map['iscsi'] == null ? null : (ISCSIVolumeSourcePatch.fromMap((map['iscsi'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      nfs: map['nfs'] == null ? null : (NFSVolumeSourcePatch.fromMap((map['nfs'] as Map).cast<String, dynamic>())).input(),
      persistentVolumeClaim: map['persistentVolumeClaim'] == null ? null : (PersistentVolumeClaimVolumeSourcePatch.fromMap((map['persistentVolumeClaim'] as Map).cast<String, dynamic>())).input(),
      ...
      projected: map['projected'] == null ? null : (ProjectedVolumeSourcePatch.fromMap((map['projected'] as Map).cast<String, dynamic>())).input(),
      quobyte: map['quobyte'] == null ? null : (QuobyteVolumeSourcePatch.fromMap((map['quobyte'] as Map).cast<String, dynamic>())).input(),
      rbd: map['rbd'] == null ? null : (RBDVolumeSourcePatch.fromMap((map['rbd'] as Map).cast<String, dynamic>())).input(),
      scaleIO: map['scaleIO'] == null ? null : (ScaleIOVolumeSourcePatch.fromMap((map['scaleIO'] as Map).cast<String, dynamic>())).input(),
      secret: map['secret'] == null ? null : (SecretVolumeSourcePatch.fromMap((map['secret'] as Map).cast<String, dynamic>())).input(),
      storageos: map['storageos'] == null ? null : (StorageOSVolumeSourcePatch.fromMap((map['storageos'] as Map).cast<String, dynamic>())).input(),
