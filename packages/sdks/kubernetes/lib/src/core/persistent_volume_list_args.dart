...
class PersistentVolumeListArgs {
  ...
  PersistentVolumeListArgs({
    ...
    required pulumi.Output<List<PersistentVolumeCoreV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<PersistentVolumeCoreV1>>(items),
  ...
  factory PersistentVolumeListArgs.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeListArgs(
      ...
      items: pulumi.Output.create<List<PersistentVolumeCoreV1>>((map['items'] as List).cast<PersistentVolumeCoreV1>()),
