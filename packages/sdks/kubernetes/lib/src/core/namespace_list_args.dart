...
class NamespaceListArgs {
  ...
  NamespaceListArgs({
    ...
    required pulumi.Output<List<NamespaceCoreV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<NamespaceCoreV1>>(items),
  ...
  factory NamespaceListArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceListArgs(
      ...
      items: pulumi.Output.create<List<NamespaceCoreV1>>((map['items'] as List).cast<NamespaceCoreV1>()),
