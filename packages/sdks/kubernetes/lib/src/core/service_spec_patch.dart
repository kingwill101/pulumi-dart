...
import 'service_port_patch.dart';
import 'session_affinity_config_patch.dart';
...
class ServiceSpecPatch {
  ...
  final pulumi.Input<List<ServicePortPatch>>? ports;
  ...
  final pulumi.Input<SessionAffinityConfigPatch>? sessionAffinityConfig;
  ...
  /// Creates a new [ServiceSpecPatch].
    ...
    return <String, dynamic>{
      ...
      'ports':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePortPatch>,
            List<Map<String, dynamic>>
          >(
            ports,
            (value) =>
                pulumi.Input.encodeList<ServicePortPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ServiceSpecPatch.fromMap(Map<String, dynamic> map) {
    return ServiceSpecPatch(
      ...
      ports: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServicePortPatch>(
            guardedValue,
            (value) => ServicePortPatch.fromMap(
      ...
      sessionAffinityConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SessionAffinityConfigPatch.fromMap(
