...
class PodPatch {
  ...
  final pulumi.Input<PodStatusPatch>? status;

  /// Creates a new [PodPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<PodStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory PodPatch.fromMap(Map<String, dynamic> map) {
    return PodPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
