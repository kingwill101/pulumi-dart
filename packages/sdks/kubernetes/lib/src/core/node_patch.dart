...
class NodePatch {
  ...
  factory NodePatch.fromMap(Map<String, dynamic> map) {
    return NodePatch(
      ...
      spec: map['spec'] == null ? null : (NodeSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (NodeStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
