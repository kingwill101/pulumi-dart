...
class ResourceStatus {
  ...
  ResourceStatus({required this.name, this.resources});
    ...
    return <String, dynamic>{
      ...
      'resources':
          ...
          >(
            resources,
            (value) =>
                pulumi.Input.encodeList<ResourceHealth, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ResourceStatus(
      ...
      resources: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceHealth>(
            guardedValue,
            (value) =>
                ResourceHealth.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
