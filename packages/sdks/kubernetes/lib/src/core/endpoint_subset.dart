...
class EndpointSubset {
  ...
  EndpointSubset({this.addresses, this.notReadyAddresses, this.ports});
    ...
    return <String, dynamic>{
      'addresses':
          ...
          >(
            addresses,
            (value) =>
                pulumi.Input.encodeList<EndpointAddress, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'ports':
          ...
          >(
            ports,
            (value) =>
                pulumi.Input.encodeList<EndpointPort, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return EndpointSubset(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointAddress>(
            guardedValue,
            (value) =>
                EndpointAddress.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      notReadyAddresses: (() {
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPort>(
            guardedValue,
            (value) =>
                EndpointPort.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
