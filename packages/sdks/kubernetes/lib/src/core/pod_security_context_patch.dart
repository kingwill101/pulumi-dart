...
class PodSecurityContextPatch {
  ...
  final pulumi.Input<List<SysctlPatch>>? sysctls;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sysctls': ?pulumi.Input.mapOptionalInputValue<List<SysctlPatch>, List<Map<String, dynamic>>>(sysctls, (value) => pulumi.Input.encodeList<SysctlPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory PodSecurityContextPatch.fromMap(Map<String, dynamic> map) {
    return PodSecurityContextPatch(
      ...
      fsGroup: (() { final guardedValue = map['fsGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      supplementalGroupsPolicy: (() { final guardedValue = map['supplementalGroupsPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sysctls: (() { final guardedValue = map['sysctls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SysctlPatch>(guardedValue, (value) => SysctlPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
