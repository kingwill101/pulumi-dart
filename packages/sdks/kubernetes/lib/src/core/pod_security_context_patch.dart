...
class PodSecurityContextPatch {
    ...
    return <String, dynamic>{
      ...
      'sysctls':
          ...
          >(
            sysctls,
            (value) =>
                pulumi.Input.encodeList<SysctlPatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory PodSecurityContextPatch.fromMap(Map<String, dynamic> map) {
    return PodSecurityContextPatch(
      ...
      fsGroupChangePolicy: (() {
        final guardedValue = map['fsGroupChangePolicy'];
        if (guardedValue == null) return null;
      ...
      seLinuxChangePolicy: (() {
        final guardedValue = map['seLinuxChangePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      seLinuxOptions: (() {
      ...
      sysctls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SysctlPatch>(
            guardedValue,
            (value) =>
                SysctlPatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      windowsOptions: (() {
