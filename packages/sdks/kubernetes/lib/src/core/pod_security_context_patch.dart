...
class PodSecurityContextPatch {
  ...
  final SeccompProfilePatch? seccompProfile;
  ...
  final List<SysctlPatch>? sysctls;
  /// The Windows specific settings applied to all containers. If unspecified, the options within a container's SecurityContext will be used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. Note that this field cannot be set when spec.os.name is linux.
  final WindowsSecurityContextOptionsPatch? windowsOptions;

  /// Creates a new [PodSecurityContextPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sysctls': ?sysctls == null ? null : pulumi.Input.encodeList<SysctlPatch, Map<String, dynamic>>(sysctls!, (value) => value.toMap()),
  ...
  factory PodSecurityContextPatch.fromMap(Map<String, dynamic> map) {
    return PodSecurityContextPatch(
      appArmorProfile: map['appArmorProfile'] == null ? null : AppArmorProfilePatch.fromMap((map['appArmorProfile'] as Map).cast<String, dynamic>()),
      ...
      seccompProfile: map['seccompProfile'] == null ? null : SeccompProfilePatch.fromMap((map['seccompProfile'] as Map).cast<String, dynamic>()),
      ...
      sysctls: map['sysctls'] == null ? null : pulumi.Input.decodeList<SysctlPatch>(map['sysctls'], (value) => SysctlPatch.fromMap((value as Map).cast<String, dynamic>())),
      windowsOptions: map['windowsOptions'] == null ? null : WindowsSecurityContextOptionsPatch.fromMap((map['windowsOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
