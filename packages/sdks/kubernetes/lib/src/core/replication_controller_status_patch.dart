...
class ReplicationControllerStatusPatch {
  ...
  final List<ReplicationControllerConditionPatch>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<ReplicationControllerConditionPatch, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory ReplicationControllerStatusPatch.fromMap(Map<String, dynamic> map) {
    return ReplicationControllerStatusPatch(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<ReplicationControllerConditionPatch>(map['conditions'], (value) => ReplicationControllerConditionPatch.fromMap((value as Map).cast<String, dynamic>())),
