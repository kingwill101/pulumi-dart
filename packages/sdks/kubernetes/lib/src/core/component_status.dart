...
class ComponentStatus {
  ...
  factory ComponentStatus.fromMap(Map<String, dynamic> map) {
    return ComponentStatus(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ComponentCondition>(guardedValue, (value) => ComponentCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
