...
class ReplicationControllerPatch {
  ...
  const ReplicationControllerPatch({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory ReplicationControllerPatch.fromMap(Map<String, dynamic> map) {
    return ReplicationControllerPatch(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationControllerSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationControllerStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
