...
class ResourceQuotaSpecPatch {
  ...
  final ScopeSelectorPatch? scopeSelector;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hard': ?hard,
      'scopeSelector': ?scopeSelector == null ? null : scopeSelector!.toMap(),
      'scopes': ?scopes,
    };
  }
  ...
  factory ResourceQuotaSpecPatch.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaSpecPatch(
      ...
      scopeSelector: map['scopeSelector'] == null ? null : ScopeSelectorPatch.fromMap((map['scopeSelector'] as Map).cast<String, dynamic>()),
