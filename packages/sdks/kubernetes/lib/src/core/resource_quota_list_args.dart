...
class ResourceQuotaListArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<ResourceQuota>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<ResourceQuota, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory ResourceQuotaListArgs.fromMap(Map<String, dynamic> map) {
    return ResourceQuotaListArgs(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceQuota>(map['items']!, (value) => ResourceQuota.fromMap((value as Map).cast<String, dynamic>()))),
