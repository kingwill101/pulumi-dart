...
class Pod {
  ...
  Pod({this.apiVersion, this.kind, this.metadata, this.spec, this.status});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status':
          ?pulumi.Input.mapOptionalInputValue<PodStatus, Map<String, dynamic>>(
            status,
            (value) => value.toMap(),
          ),
    };
  ...
  factory Pod.fromMap(Map<String, dynamic> map) {
    return Pod(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PodStatus.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
