...
class PersistentVolumeClaimSpecPatch {
  ...
  final pulumi.Input<TypedLocalObjectReferencePatch?>? dataSource;
  ...
  final pulumi.Input<TypedObjectReferencePatch?>? dataSourceRef;
  ...
  final pulumi.Input<VolumeResourceRequirementsPatch?>? resources;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSource': ?pulumi.Input.mapOptionalInputValue<TypedLocalObjectReferencePatch, Map<String, dynamic>>(dataSource, (value) => value.toMap()),
      'dataSourceRef': ?pulumi.Input.mapOptionalInputValue<TypedObjectReferencePatch, Map<String, dynamic>>(dataSourceRef, (value) => value.toMap()),
      'resources': ?pulumi.Input.mapOptionalInputValue<VolumeResourceRequirementsPatch, Map<String, dynamic>>(resources, (value) => value.toMap()),
  ...
  factory PersistentVolumeClaimSpecPatch.fromMap(Map<String, dynamic> map) {
    return PersistentVolumeClaimSpecPatch(
      ...
      dataSource: (() { final guardedValue = map['dataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypedLocalObjectReferencePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceRef: (() { final guardedValue = map['dataSourceRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypedObjectReferencePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeResourceRequirementsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
