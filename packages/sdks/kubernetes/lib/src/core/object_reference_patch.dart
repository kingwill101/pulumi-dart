...
class ObjectReferencePatch {
  ...
  /// Creates a new [ObjectReferencePatch].
  ...
  factory ObjectReferencePatch.fromMap(Map<String, dynamic> map) {
    return ObjectReferencePatch(
