...
class EventArgs {
  ...
  EventArgs({
    ...
    required pulumi.Output<ObjectReference> involvedObject,
    pulumi.Output<String>? kind,
    pulumi.Output<String>? lastTimestamp,
    pulumi.Output<String>? message,
    required pulumi.Output<ObjectMeta> metadata,
    ...
    pulumi.Output<EventSource>? source,
  ...
  factory EventArgs.fromMap(Map<String, dynamic> map) {
    return EventArgs(
      ...
      involvedObject: pulumi.Output.create<ObjectReference>(ObjectReference.fromMap((map['involvedObject'] as Map).cast<String, dynamic>())),
      ...
      metadata: pulumi.Output.create<ObjectMeta>(ObjectMeta.fromMap((map['metadata'] as Map).cast<String, dynamic>())),
      ...
      source: map['source'] == null ? null : pulumi.Output.create<EventSource>(EventSource.fromMap((map['source'] as Map).cast<String, dynamic>())),
