...
class EventArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'involvedObject':
          pulumi.Input.mapInputValue<ObjectReference, Map<String, dynamic>>(
            involvedObject,
            (value) => value.toMap(),
          ),
      'kind': ?kind,
      ...
      'message': ?message,
      'metadata': pulumi.Input.mapInputValue<ObjectMeta, Map<String, dynamic>>(
        metadata,
        (value) => value.toMap(),
      ),
      'reason': ?reason,
  ...
  factory EventArgs.fromMap(Map<String, dynamic> map) {
    return EventArgs(
      ...
      involvedObject: pulumi.Input.fromValue(
        ObjectReference.fromMap(
          (map['involvedObject']! as Map).cast<String, dynamic>(),
        ),
      ),
      kind: (() {
      ...
      metadata: pulumi.Input.fromValue(
        ObjectMeta.fromMap((map['metadata']! as Map).cast<String, dynamic>()),
      ),
      reason: (() {
      ...
      reportingComponent: (() {
        final guardedValue = map['reportingComponent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reportingInstance: (() {
      ...
      series: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventSeries.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventSource.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      type: (() {
