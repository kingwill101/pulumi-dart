...
import 'eviction_responder.dart';
...
import 'pod_scheduling_group.dart';
...
class PodSpec {
  ...
  final pulumi.Input<List<EvictionResponder>?>? evictionResponders;
  ...
  final pulumi.Input<PodSchedulingGroup?>? schedulingGroup;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'evictionResponders': ?pulumi.Input.mapOptionalInputValue<List<EvictionResponder>, List<Map<String, dynamic>>>(evictionResponders, (value) => pulumi.Input.encodeList<EvictionResponder, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'schedulingGroup': ?pulumi.Input.mapOptionalInputValue<PodSchedulingGroup, Map<String, dynamic>>(schedulingGroup, (value) => value.toMap()),
  ...
  factory PodSpec.fromMap(Map<String, dynamic> map) {
    return PodSpec(
      ...
      affinity: (() { final guardedValue = map['affinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Affinity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dnsConfig: (() { final guardedValue = map['dnsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodDNSConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ephemeralContainers: (() { final guardedValue = map['ephemeralContainers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EphemeralContainer>(guardedValue, (value) => EphemeralContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      evictionResponders: (() { final guardedValue = map['evictionResponders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EvictionResponder>(guardedValue, (value) => EvictionResponder.fromMap((value as Map).cast<String, dynamic>()))); })(),
      hostAliases: (() { final guardedValue = map['hostAliases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HostAlias>(guardedValue, (value) => HostAlias.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initContainers: (() { final guardedValue = map['initContainers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Container>(guardedValue, (value) => Container.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      os: (() { final guardedValue = map['os']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodOS.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      readinessGates: (() { final guardedValue = map['readinessGates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodReadinessGate>(guardedValue, (value) => PodReadinessGate.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceClaims: (() { final guardedValue = map['resourceClaims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodResourceClaim>(guardedValue, (value) => PodResourceClaim.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      schedulingGates: (() { final guardedValue = map['schedulingGates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PodSchedulingGate>(guardedValue, (value) => PodSchedulingGate.fromMap((value as Map).cast<String, dynamic>()))); })(),
      schedulingGroup: (() { final guardedValue = map['schedulingGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodSchedulingGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      securityContext: (() { final guardedValue = map['securityContext']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodSecurityContext.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      topologySpreadConstraints: (() { final guardedValue = map['topologySpreadConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TopologySpreadConstraint>(guardedValue, (value) => TopologySpreadConstraint.fromMap((value as Map).cast<String, dynamic>()))); })(),
