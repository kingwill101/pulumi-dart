    ...
    return <String, dynamic>{
      ...
      'requiredDuringSchedulingIgnoredDuringExecution':
          ...
          >(
            requiredDuringSchedulingIgnoredDuringExecution,
            (value) =>
                pulumi.Input.encodeList<PodAffinityTerm, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return PodAffinity(
      preferredDuringSchedulingIgnoredDuringExecution: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WeightedPodAffinityTerm>(
            guardedValue,
            (value) => WeightedPodAffinityTerm.fromMap(
      ...
      requiredDuringSchedulingIgnoredDuringExecution: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PodAffinityTerm>(
            guardedValue,
            (value) =>
                PodAffinityTerm.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
