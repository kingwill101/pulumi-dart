...
class ProjectedVolumeSource {
  ...
  ProjectedVolumeSource({this.defaultMode, required this.sources});
    ...
    return <String, dynamic>{
      ...
      'sources':
          ...
          >(
            sources,
            (value) =>
                pulumi.Input.encodeList<VolumeProjection, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ProjectedVolumeSource.fromMap(Map<String, dynamic> map) {
    return ProjectedVolumeSource(
      ...
      sources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VolumeProjection>(
          map['sources']!,
          (value) =>
              VolumeProjection.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
