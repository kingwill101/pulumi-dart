    ...
    return <String, dynamic>{
      ...
      'allocatedResourcesStatus':
          ...
          >(
            allocatedResourcesStatus,
            (value) =>
                pulumi.Input.encodeList<ResourceStatus, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ContainerStatus.fromMap(Map<String, dynamic> map) {
    return ContainerStatus(
      ...
      allocatedResourcesStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceStatus>(
            guardedValue,
            (value) =>
                ResourceStatus.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      containerID: (() {
      ...
      lastState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerState.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      user: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerUser.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      volumeMounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeMountStatus>(
            guardedValue,
            (value) => VolumeMountStatus.fromMap(
