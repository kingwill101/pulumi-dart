...
import 'node_pod_preemption_policy.dart';
import 'taint.dart';
...
class NodeSpec {
  ...
  final pulumi.Input<NodePodPreemptionPolicy?>? podPreemptionPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'podCIDR': ?podCIDR,
      'podCIDRs': ?podCIDRs,
      'podPreemptionPolicy': ?pulumi.Input.mapOptionalInputValue<NodePodPreemptionPolicy, Map<String, dynamic>>(podPreemptionPolicy, (value) => value.toMap()),
  ...
  factory NodeSpec.fromMap(Map<String, dynamic> map) {
    return NodeSpec(
      ...
      podPreemptionPolicy: (() { final guardedValue = map['podPreemptionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodePodPreemptionPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
