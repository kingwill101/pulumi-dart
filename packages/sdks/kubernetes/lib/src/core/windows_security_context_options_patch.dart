...
class WindowsSecurityContextOptionsPatch {
  ...
  factory WindowsSecurityContextOptionsPatch.fromMap(Map<String, dynamic> map) {
    return WindowsSecurityContextOptionsPatch(
      gmsaCredentialSpec: map['gmsaCredentialSpec'] == null ? null : map['gmsaCredentialSpec'] as String,
      gmsaCredentialSpecName: map['gmsaCredentialSpecName'] == null ? null : map['gmsaCredentialSpecName'] as String,
      hostProcess: map['hostProcess'] == null ? null : map['hostProcess'] as bool,
      runAsUserName: map['runAsUserName'] == null ? null : map['runAsUserName'] as String,
    );
  }
}
