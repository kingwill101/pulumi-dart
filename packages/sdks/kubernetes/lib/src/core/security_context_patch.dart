...
class SecurityContextPatch {
  ...
  factory SecurityContextPatch.fromMap(Map<String, dynamic> map) {
    return SecurityContextPatch(
      ...
      capabilities: (() { final guardedValue = map['capabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapabilitiesPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      windowsOptions: (() { final guardedValue = map['windowsOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsSecurityContextOptionsPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
