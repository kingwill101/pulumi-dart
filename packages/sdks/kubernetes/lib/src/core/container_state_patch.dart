...
class ContainerStatePatch {
  ...
  factory ContainerStatePatch.fromMap(Map<String, dynamic> map) {
    return ContainerStatePatch(
      running: (() { final guardedValue = map['running']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerStateRunningPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      terminated: (() { final guardedValue = map['terminated']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerStateTerminatedPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      waiting: (() { final guardedValue = map['waiting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerStateWaitingPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
