...
class PodSpecPatch {
  ...
  factory PodSpecPatch.fromMap(Map<String, dynamic> map) {
    return PodSpecPatch(
      ...
      affinity: map['affinity'] == null ? null : (AffinityPatch.fromMap((map['affinity']! as Map).cast<String, dynamic>())).input(),
      automountServiceAccountToken: map['automountServiceAccountToken'] == null ? null : (map['automountServiceAccountToken']! as bool).input(),
      containers: map['containers'] == null ? null : (pulumi.Input.decodeList<ContainerPatch>(map['containers']!, (value) => ContainerPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dnsConfig: map['dnsConfig'] == null ? null : (PodDNSConfigPatch.fromMap((map['dnsConfig']! as Map).cast<String, dynamic>())).input(),
      ...
      ephemeralContainers: map['ephemeralContainers'] == null ? null : (pulumi.Input.decodeList<EphemeralContainerPatch>(map['ephemeralContainers']!, (value) => EphemeralContainerPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      hostAliases: map['hostAliases'] == null ? null : (pulumi.Input.decodeList<HostAliasPatch>(map['hostAliases']!, (value) => HostAliasPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      initContainers: map['initContainers'] == null ? null : (pulumi.Input.decodeList<ContainerPatch>(map['initContainers']!, (value) => ContainerPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      os: map['os'] == null ? null : (PodOSPatch.fromMap((map['os']! as Map).cast<String, dynamic>())).input(),
      ...
      readinessGates: map['readinessGates'] == null ? null : (pulumi.Input.decodeList<PodReadinessGatePatch>(map['readinessGates']!, (value) => PodReadinessGatePatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      resourceClaims: map['resourceClaims'] == null ? null : (pulumi.Input.decodeList<PodResourceClaimPatch>(map['resourceClaims']!, (value) => PodResourceClaimPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      schedulingGates: map['schedulingGates'] == null ? null : (pulumi.Input.decodeList<PodSchedulingGatePatch>(map['schedulingGates']!, (value) => PodSchedulingGatePatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      securityContext: map['securityContext'] == null ? null : (PodSecurityContextPatch.fromMap((map['securityContext']! as Map).cast<String, dynamic>())).input(),
      ...
      topologySpreadConstraints: map['topologySpreadConstraints'] == null ? null : (pulumi.Input.decodeList<TopologySpreadConstraintPatch>(map['topologySpreadConstraints']!, (value) => TopologySpreadConstraintPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      workloadRef: map['workloadRef'] == null ? null : (WorkloadReferencePatch.fromMap((map['workloadRef']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
