...
class EndpointsPatchArgs {
  ...
  EndpointsPatchArgs({
    ...
    pulumi.Output<List<EndpointSubsetPatch>>? subsets,
  }) :
  ...
  factory EndpointsPatchArgs.fromMap(Map<String, dynamic> map) {
    return EndpointsPatchArgs(
      ...
      subsets: map['subsets'] == null ? null : pulumi.Output.create<List<EndpointSubsetPatch>>(pulumi.Input.decodeList<EndpointSubsetPatch>(map['subsets'], (value) => EndpointSubsetPatch.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
