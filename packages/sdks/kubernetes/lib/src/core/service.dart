...
class Service {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<ServiceStatus, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory Service.fromMap(Map<String, dynamic> map) {
    return Service(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
