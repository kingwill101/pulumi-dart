...
/// {@template pulumi_core_v1_pod_patch_args_doc}
/// The set of arguments for PodPatch.
/// {@endtemplate}
/// {@macro pulumi_core_v1_pod_patch_args_doc}
class PodPatchArgs {
  ...
  PodPatchArgs({
    ...
    pulumi.Output<PodSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<PodSpecPatch>(spec);
  ...
  factory PodPatchArgs.fromMap(Map<String, dynamic> map) {
    return PodPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PodSpecPatch>(PodSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
