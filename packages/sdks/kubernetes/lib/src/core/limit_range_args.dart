...
class LimitRangeArgs {
  ...
  LimitRangeArgs({
    ...
    pulumi.Output<LimitRangeSpec>? spec,
  }) :
  ...
  factory LimitRangeArgs.fromMap(Map<String, dynamic> map) {
    return LimitRangeArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<LimitRangeSpec>(LimitRangeSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
