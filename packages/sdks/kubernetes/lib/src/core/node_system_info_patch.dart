...
class NodeSystemInfoPatch {
  ...
  factory NodeSystemInfoPatch.fromMap(Map<String, dynamic> map) {
    return NodeSystemInfoPatch(
      ...
      bootID: (() { final guardedValue = map['bootID']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      containerRuntimeVersion: (() { final guardedValue = map['containerRuntimeVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      kubeProxyVersion: (() { final guardedValue = map['kubeProxyVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kubeletVersion: (() { final guardedValue = map['kubeletVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      osImage: (() { final guardedValue = map['osImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      swap: (() { final guardedValue = map['swap']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeSwapStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      systemUUID: (() { final guardedValue = map['systemUUID']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
