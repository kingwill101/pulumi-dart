...
class NodeSystemInfoPatch {
  ...
  final NodeSwapStatusPatch? swap;
  ...
  factory NodeSystemInfoPatch.fromMap(Map<String, dynamic> map) {
    return NodeSystemInfoPatch(
      ...
      bootID: map['bootID'] == null ? null : map['bootID'] as String,
      containerRuntimeVersion: map['containerRuntimeVersion'] == null ? null : map['containerRuntimeVersion'] as String,
      kernelVersion: map['kernelVersion'] == null ? null : map['kernelVersion'] as String,
      kubeProxyVersion: map['kubeProxyVersion'] == null ? null : map['kubeProxyVersion'] as String,
      kubeletVersion: map['kubeletVersion'] == null ? null : map['kubeletVersion'] as String,
      ...
      swap: map['swap'] == null ? null : NodeSwapStatusPatch.fromMap((map['swap'] as Map).cast<String, dynamic>()),
      systemUUID: map['systemUUID'] == null ? null : map['systemUUID'] as String,
    );
  }
}
