...
class SecretList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<Secret, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
      'metadata': ?metadata == null ? null : metadata!.toMap(),
    };
  }

  factory SecretList.fromMap(Map<String, dynamic> map) {
    return SecretList(
      apiVersion: map['apiVersion'] == null ? null : map['apiVersion'] as String,
      items: pulumi.Input.decodeList<Secret>(map['items'], (value) => Secret.fromMap((value as Map).cast<String, dynamic>())),
