...
/// {@template pulumi_core_v1_persistent_volume_patch_args_doc}
/// The set of arguments for PersistentVolumePatch.
/// {@endtemplate}
/// {@macro pulumi_core_v1_persistent_volume_patch_args_doc}
class PersistentVolumePatchArgs {
  ...
  /// Creates a new [PersistentVolumePatchArgs].
  ...
  PersistentVolumePatchArgs({
    ...
    pulumi.Output<PersistentVolumeSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<PersistentVolumeSpecPatch>(spec);
  ...
  factory PersistentVolumePatchArgs.fromMap(Map<String, dynamic> map) {
    return PersistentVolumePatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<PersistentVolumeSpecPatch>(PersistentVolumeSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
