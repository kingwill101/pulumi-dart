...
class SecretListArgs {
  ...
  SecretListArgs({
    ...
    required pulumi.Output<List<SecretCoreV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<SecretCoreV1>>(items),
  ...
  factory SecretListArgs.fromMap(Map<String, dynamic> map) {
    return SecretListArgs(
      ...
      items: pulumi.Output.create<List<SecretCoreV1>>((map['items'] as List).cast<SecretCoreV1>()),
