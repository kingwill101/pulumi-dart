...
class Node {
  ...
  factory Node.fromMap(Map<String, dynamic> map) {
    return Node(
      ...
      spec: map['spec'] == null ? null : (NodeSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (NodeStatus.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
