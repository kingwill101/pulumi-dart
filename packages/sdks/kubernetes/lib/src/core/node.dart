...
class Node {
  ...
  Node({this.apiVersion, this.kind, this.metadata, this.spec, this.status});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec':
          ?pulumi.Input.mapOptionalInputValue<NodeSpec, Map<String, dynamic>>(
            spec,
            (value) => value.toMap(),
          ),
      'status':
          ?pulumi.Input.mapOptionalInputValue<NodeStatus, Map<String, dynamic>>(
            status,
            (value) => value.toMap(),
          ),
    };
  ...
  factory Node.fromMap(Map<String, dynamic> map) {
    return Node(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodeSpec.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodeStatus.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
