...
class NodeSystemInfo {
  ...
  factory NodeSystemInfo.fromMap(Map<String, dynamic> map) {
    return NodeSystemInfo(
      ...
      bootID: pulumi.Input.fromValue(map['bootID'] as String),
      containerRuntimeVersion: pulumi.Input.fromValue(
        map['containerRuntimeVersion'] as String,
      ),
      kernelVersion: pulumi.Input.fromValue(map['kernelVersion'] as String),
      kubeProxyVersion: pulumi.Input.fromValue(
        map['kubeProxyVersion'] as String,
      ),
      kubeletVersion: pulumi.Input.fromValue(map['kubeletVersion'] as String),
      ...
      swap: (() {
        ...
        return pulumi.Input.fromValue(
          NodeSwapStatus.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
