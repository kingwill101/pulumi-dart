...
class TopologySpreadConstraintPatch {
  ...
  factory TopologySpreadConstraintPatch.fromMap(Map<String, dynamic> map) {
    return TopologySpreadConstraintPatch(
      ...
      matchLabelKeys: (() {
        final guardedValue = map['matchLabelKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      maxSkew: (() {
        final guardedValue = map['maxSkew'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minDomains: (() {
        final guardedValue = map['minDomains'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      nodeAffinityPolicy: (() {
        final guardedValue = map['nodeAffinityPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nodeTaintsPolicy: (() {
        final guardedValue = map['nodeTaintsPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      topologyKey: (() {
        final guardedValue = map['topologyKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      whenUnsatisfiable: (() {
        final guardedValue = map['whenUnsatisfiable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
