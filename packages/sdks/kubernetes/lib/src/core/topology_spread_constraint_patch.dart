...
class TopologySpreadConstraintPatch {
  ...
  factory TopologySpreadConstraintPatch.fromMap(Map<String, dynamic> map) {
    return TopologySpreadConstraintPatch(
      ...
      maxSkew: (() { final guardedValue = map['maxSkew']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minDomains: (() { final guardedValue = map['minDomains']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
