...
class TopologySpreadConstraintPatch {
  ...
  factory TopologySpreadConstraintPatch.fromMap(Map<String, dynamic> map) {
    return TopologySpreadConstraintPatch(
      ...
      matchLabelKeys: map['matchLabelKeys'] == null ? null : (map['matchLabelKeys'] as List).cast<String>(),
      maxSkew: map['maxSkew'] == null ? null : map['maxSkew'] as int,
      minDomains: map['minDomains'] == null ? null : map['minDomains'] as int,
      nodeAffinityPolicy: map['nodeAffinityPolicy'] == null ? null : map['nodeAffinityPolicy'] as String,
      nodeTaintsPolicy: map['nodeTaintsPolicy'] == null ? null : map['nodeTaintsPolicy'] as String,
      topologyKey: map['topologyKey'] == null ? null : map['topologyKey'] as String,
      whenUnsatisfiable: map['whenUnsatisfiable'] == null ? null : map['whenUnsatisfiable'] as String,
    );
  }
}
