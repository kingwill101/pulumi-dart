...
class TopologySpreadConstraintPatch {
  ...
  final pulumi.Input<int?>? maxSkew;
  ...
  final pulumi.Input<String?>? whenUnsatisfiable;

  /// Creates a new [TopologySpreadConstraintPatch].
  ...
  const TopologySpreadConstraintPatch({
    this.labelSelector,
    this.matchLabelKeys,
    this.maxSkew,
    this.minDomains,
  ...
  factory TopologySpreadConstraintPatch.fromMap(Map<String, dynamic> map) {
    return TopologySpreadConstraintPatch(
      ...
      maxSkew: (() { final guardedValue = map['maxSkew']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      whenUnsatisfiable: (() { final guardedValue = map['whenUnsatisfiable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
