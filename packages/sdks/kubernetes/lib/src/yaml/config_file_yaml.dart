...
import 'config_file_yaml_args.dart';
...
/// {{% /example %}}
/// {% /examples %}}
class ConfigFileYaml extends pulumi.ComponentResource {
  /// Resources created by the ConfigFile.
  late final pulumi.Output<String?> resources;

  /// Creates a new [ConfigFileYaml].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConfigFileYaml]. {@macro pulumi_yaml_config_file_yaml_args_doc}
