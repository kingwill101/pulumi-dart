...
import 'config_group_yaml_args.dart';
...
/// {{% /example %}}
/// {% /examples %}}
class ConfigGroupYaml extends pulumi.ComponentResource {
  /// Resources created by the ConfigGroup.
  late final pulumi.Output<String?> resources;

  /// Creates a new [ConfigGroupYaml].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConfigGroupYaml]. {@macro pulumi_yaml_config_group_yaml_args_doc}
