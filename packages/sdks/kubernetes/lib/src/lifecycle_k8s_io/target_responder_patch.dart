...
class TargetResponderPatch {
  ...
  /// Creates a new [TargetResponderPatch].
  ...
  factory TargetResponderPatch.fromMap(Map<String, dynamic> map) {
    return TargetResponderPatch(
