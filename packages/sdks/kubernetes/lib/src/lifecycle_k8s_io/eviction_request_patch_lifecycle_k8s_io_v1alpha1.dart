...
import 'eviction_request_patch_args.dart';
import 'eviction_request_spec_patch.dart';
import 'eviction_request_status_patch.dart';
...
class EvictionRequestPatchLifecycleK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<EvictionRequestSpecPatch?> spec;
  ...
  late final pulumi.Output<EvictionRequestStatusPatch?> status;

  /// Creates a new [EvictionRequestPatchLifecycleK8sIoV1alpha1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EvictionRequestPatchLifecycleK8sIoV1alpha1]. {@macro pulumi_lifecycle_k8s_io_v1alpha1_eviction_request_patch_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  EvictionRequestPatchLifecycleK8sIoV1alpha1(
    String name, {
    EvictionRequestPatchArgs? args,
    ...
    spec = registerOutput<EvictionRequestSpecPatch?>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EvictionRequestSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    status = registerOutput<EvictionRequestStatusPatch?>('status', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EvictionRequestStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [EvictionRequestPatchLifecycleK8sIoV1alpha1] resource.
  EvictionRequestPatchLifecycleK8sIoV1alpha1.reference(String urn)
    : super(
        'kubernetes:lifecycle.k8s.io/v1alpha1:EvictionRequestPatch',
