...
class ResponderStatusPatch {
  ...
  /// Creates a new [ResponderStatusPatch].
  ...
  factory ResponderStatusPatch.fromMap(Map<String, dynamic> map) {
    return ResponderStatusPatch(
