...
class EvictionRequestPatch {
  ...
  final pulumi.Input<EvictionRequestStatusPatch?>? status;

  /// Creates a new [EvictionRequestPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<EvictionRequestStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory EvictionRequestPatch.fromMap(Map<String, dynamic> map) {
    return EvictionRequestPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EvictionRequestStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
