...
class Eviction {
  ...
  final pulumi.Input<EvictionStatus?>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<EvictionStatus, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory Eviction.fromMap(Map<String, dynamic> map) {
    return Eviction(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EvictionStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
