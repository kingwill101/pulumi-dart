...
class EvictionStatus {
  ...
  final pulumi.Input<List<Requester>?>? requesters;
  ...
  final pulumi.Input<List<ResponderStatus>?>? responders;
  ...
  final pulumi.Input<List<TargetResponder>?>? targetResponders;

  /// Creates a new [EvictionStatus].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requesters': ?pulumi.Input.mapOptionalInputValue<List<Requester>, List<Map<String, dynamic>>>(requesters, (value) => pulumi.Input.encodeList<Requester, Map<String, dynamic>>(value, (value) => value.toMap())),
      'responders': ?pulumi.Input.mapOptionalInputValue<List<ResponderStatus>, List<Map<String, dynamic>>>(responders, (value) => pulumi.Input.encodeList<ResponderStatus, Map<String, dynamic>>(value, (value) => value.toMap())),
      'targetResponders': ?pulumi.Input.mapOptionalInputValue<List<TargetResponder>, List<Map<String, dynamic>>>(targetResponders, (value) => pulumi.Input.encodeList<TargetResponder, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory EvictionStatus.fromMap(Map<String, dynamic> map) {
    return EvictionStatus(
      ...
      requesters: (() { final guardedValue = map['requesters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Requester>(guardedValue, (value) => Requester.fromMap((value as Map).cast<String, dynamic>()))); })(),
      responders: (() { final guardedValue = map['responders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResponderStatus>(guardedValue, (value) => ResponderStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      targetResponders: (() { final guardedValue = map['targetResponders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TargetResponder>(guardedValue, (value) => TargetResponder.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
