...
import 'token_request_patch.dart';

/// CSIDriverSpec is the specification of a CSIDriver.
class CSIDriverSpecPatch {
  ...
  final int? nodeAllocatableUpdatePeriodSeconds;
  ...
  final bool? serviceAccountTokenInSecrets;
  ...
  final List<TokenRequestPatch>? tokenRequests;
  ...
  /// Creates a new [CSIDriverSpecPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tokenRequests': ?tokenRequests == null ? null : pulumi.Input.encodeList<TokenRequestPatch, Map<String, dynamic>>(tokenRequests!, (value) => value.toMap()),
      'volumeLifecycleModes': ?volumeLifecycleModes,
    };
  }

  factory CSIDriverSpecPatch.fromMap(Map<String, dynamic> map) {
    return CSIDriverSpecPatch(
      ...
      nodeAllocatableUpdatePeriodSeconds: map['nodeAllocatableUpdatePeriodSeconds'] == null ? null : map['nodeAllocatableUpdatePeriodSeconds'] as int,
      ...
      seLinuxMount: map['seLinuxMount'] == null ? null : map['seLinuxMount'] as bool,
      serviceAccountTokenInSecrets: map['serviceAccountTokenInSecrets'] == null ? null : map['serviceAccountTokenInSecrets'] as bool,
      storageCapacity: map['storageCapacity'] == null ? null : map['storageCapacity'] as bool,
      tokenRequests: map['tokenRequests'] == null ? null : pulumi.Input.decodeList<TokenRequestPatch>(map['tokenRequests'], (value) => TokenRequestPatch.fromMap((value as Map).cast<String, dynamic>())),
