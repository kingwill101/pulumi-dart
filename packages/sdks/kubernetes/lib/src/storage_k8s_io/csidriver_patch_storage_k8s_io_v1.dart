...
class CSIDriverPatchStorageK8sIoV1 extends pulumi.CustomResource {
  ...
  CSIDriverPatchStorageK8sIoV1(
    ...
    spec = registerOutput<CSIDriverSpecPatch?>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CSIDriverSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [CSIDriverPatchStorageK8sIoV1] resource.
  CSIDriverPatchStorageK8sIoV1.reference(String urn)
    : super(
        'kubernetes:storage.k8s.io/v1:CSIDriverPatch',
