...
class CSINodeSpecPatchStorageK8sIoV1beta1 {
  ...
  const CSINodeSpecPatchStorageK8sIoV1beta1({
    this.drivers,
  });
  ...
  factory CSINodeSpecPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeSpecPatchStorageK8sIoV1beta1(
      drivers: (() { final guardedValue = map['drivers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CSINodeDriverPatchStorageK8sIoV1beta1>(guardedValue, (value) => CSINodeDriverPatchStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
