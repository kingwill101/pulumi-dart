...
class CSINodeSpecStorageK8sIoV1beta1 {
  ...
  factory CSINodeSpecStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeSpecStorageK8sIoV1beta1(
      drivers: pulumi.Input.fromValue(pulumi.Input.decodeList<CSINodeDriverStorageK8sIoV1beta1>(map['drivers']!, (value) => CSINodeDriverStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
