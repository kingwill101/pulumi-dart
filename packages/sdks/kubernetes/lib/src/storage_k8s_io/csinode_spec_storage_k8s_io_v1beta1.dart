...
class CSINodeSpecStorageK8sIoV1beta1 {
  ...
  CSINodeSpecStorageK8sIoV1beta1({required this.drivers});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'drivers':
          pulumi.Input.mapInputValue<
            List<CSINodeDriverStorageK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            drivers,
            (value) =>
                pulumi.Input.encodeList<
                  CSINodeDriverStorageK8sIoV1beta1,
                  Map<String, dynamic>
  ...
  factory CSINodeSpecStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeSpecStorageK8sIoV1beta1(
      drivers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CSINodeDriverStorageK8sIoV1beta1>(
          map['drivers']!,
          (value) => CSINodeDriverStorageK8sIoV1beta1.fromMap(
