...
import 'token_request_patch_storage_k8s_io_v1beta1.dart';

/// CSIDriverSpec is the specification of a CSIDriver.
class CSIDriverSpecPatchStorageK8sIoV1beta1 {
  /// attachRequired indicates this CSI volume driver requires an attach operation (because it implements the CSI ControllerPublishVolume() method), and that the Kubernetes attach detach controller should call the attach volume interface which checks the volumeattachment status and waits until the volume is attached before proceeding to mounting. The CSI external-attacher coordinates with CSI volume driver and updates the volumeattachment status when the attach operation is complete. If the CSIDriverRegistry feature gate is enabled and the value is specified to false, the attach operation will be skipped. Otherwise the attach operation will be called.
  final pulumi.Input<bool>? attachRequired;
  ...
  final pulumi.Input<bool>? requiresRepublish;
  ...
  final pulumi.Input<bool>? storageCapacity;
  ...
  ///
  /// This is an alpha feature and only available when the CSIServiceAccountToken feature is enabled.
  final pulumi.Input<List<TokenRequestPatchStorageK8sIoV1beta1>>? tokenRequests;
  ...
  final pulumi.Input<List<String>>? volumeLifecycleModes;

  /// Creates a new [CSIDriverSpecPatchStorageK8sIoV1beta1].
  ...
  const CSIDriverSpecPatchStorageK8sIoV1beta1({
    this.attachRequired,
    this.fsGroupPolicy,
    this.podInfoOnMount,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tokenRequests': ?pulumi.Input.mapOptionalInputValue<List<TokenRequestPatchStorageK8sIoV1beta1>, List<Map<String, dynamic>>>(tokenRequests, (value) => pulumi.Input.encodeList<TokenRequestPatchStorageK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
      'volumeLifecycleModes': ?volumeLifecycleModes,
    };
  }

  factory CSIDriverSpecPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSIDriverSpecPatchStorageK8sIoV1beta1(
      ...
      storageCapacity: (() { final guardedValue = map['storageCapacity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      tokenRequests: (() { final guardedValue = map['tokenRequests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TokenRequestPatchStorageK8sIoV1beta1>(guardedValue, (value) => TokenRequestPatchStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      volumeLifecycleModes: (() { final guardedValue = map['volumeLifecycleModes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
