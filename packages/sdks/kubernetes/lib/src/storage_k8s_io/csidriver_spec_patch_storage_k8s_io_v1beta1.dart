...
class CSIDriverSpecPatchStorageK8sIoV1beta1 {
  ...
  ///
  /// This is an alpha feature and only available when the CSIServiceAccountToken feature is enabled.
  final List<TokenRequestPatchStorageK8sIoV1beta1>? tokenRequests;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tokenRequests': ?tokenRequests == null ? null : pulumi.Input.encodeList<TokenRequestPatchStorageK8sIoV1beta1, Map<String, dynamic>>(tokenRequests!, (value) => value.toMap()),
  ...
  factory CSIDriverSpecPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSIDriverSpecPatchStorageK8sIoV1beta1(
      attachRequired: map['attachRequired'] == null ? null : map['attachRequired'] as bool,
      fsGroupPolicy: map['fsGroupPolicy'] == null ? null : map['fsGroupPolicy'] as String,
      podInfoOnMount: map['podInfoOnMount'] == null ? null : map['podInfoOnMount'] as bool,
      requiresRepublish: map['requiresRepublish'] == null ? null : map['requiresRepublish'] as bool,
      storageCapacity: map['storageCapacity'] == null ? null : map['storageCapacity'] as bool,
      tokenRequests: map['tokenRequests'] == null ? null : pulumi.Input.decodeList<TokenRequestPatchStorageK8sIoV1beta1>(map['tokenRequests'], (value) => TokenRequestPatchStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      volumeLifecycleModes: map['volumeLifecycleModes'] == null ? null : (map['volumeLifecycleModes'] as List).cast<String>(),
    );
  }
}
