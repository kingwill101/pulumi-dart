...
/// {@template pulumi_storage_k8s_io_v1_volume_attributes_class_patch_args_doc}
/// The set of arguments for VolumeAttributesClassPatch.
/// {@endtemplate}
/// {@macro pulumi_storage_k8s_io_v1_volume_attributes_class_patch_args_doc}
class VolumeAttributesClassPatchArgs {
  ...
  /// Creates a new [VolumeAttributesClassPatchArgs].
  ...
  const VolumeAttributesClassPatchArgs({
    this.apiVersion,
    this.driverName,
    this.kind,
    this.metadata,
  ...
  factory VolumeAttributesClassPatchArgs.fromMap(Map<String, dynamic> map) {
    return VolumeAttributesClassPatchArgs(
