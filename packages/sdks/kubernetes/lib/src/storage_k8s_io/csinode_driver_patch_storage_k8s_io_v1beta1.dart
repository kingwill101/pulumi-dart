...
class CSINodeDriverPatchStorageK8sIoV1beta1 {
  ...
  final VolumeNodeResourcesPatchStorageK8sIoV1beta1? allocatable;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allocatable': ?allocatable == null ? null : allocatable!.toMap(),
      'name': ?name,
      'nodeID': ?nodeID,
  ...
  factory CSINodeDriverPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeDriverPatchStorageK8sIoV1beta1(
      allocatable: map['allocatable'] == null ? null : VolumeNodeResourcesPatchStorageK8sIoV1beta1.fromMap((map['allocatable'] as Map).cast<String, dynamic>()),
