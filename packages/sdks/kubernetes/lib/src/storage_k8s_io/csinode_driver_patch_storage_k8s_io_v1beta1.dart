...
class CSINodeDriverPatchStorageK8sIoV1beta1 {
  ...
  const CSINodeDriverPatchStorageK8sIoV1beta1({
    this.allocatable,
    this.name,
    this.nodeID,
    this.topologyKeys,
  ...
  factory CSINodeDriverPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeDriverPatchStorageK8sIoV1beta1(
      allocatable: (() { final guardedValue = map['allocatable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeNodeResourcesPatchStorageK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
