...
class VolumeAttachmentSourcePatchStorageK8sIoV1beta1 {
  ...
  /// Creates a new [VolumeAttachmentSourcePatchStorageK8sIoV1beta1].
  ...
  const VolumeAttachmentSourcePatchStorageK8sIoV1beta1({
  ...
  factory VolumeAttachmentSourcePatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentSourcePatchStorageK8sIoV1beta1(
      inlineVolumeSpec: (() { final guardedValue = map['inlineVolumeSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PersistentVolumeSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
