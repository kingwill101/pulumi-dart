...
class CSIStorageCapacityListArgs {
  ...
  CSIStorageCapacityListArgs({
    ...
    required pulumi.Output<List<CSIStorageCapacityStorageK8sIoV1>> items,
  ...
  factory CSIStorageCapacityListArgs.fromMap(Map<String, dynamic> map) {
    return CSIStorageCapacityListArgs(
      ...
      items: pulumi.Output.create<List<CSIStorageCapacityStorageK8sIoV1>>((map['items'] as List).cast<CSIStorageCapacityStorageK8sIoV1>()),
