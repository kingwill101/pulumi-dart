...
class CSIDriver {
  ...
  CSIDriver({this.apiVersion, this.kind, this.metadata, required this.spec});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': pulumi.Input.mapInputValue<CSIDriverSpec, Map<String, dynamic>>(
        spec,
        (value) => value.toMap(),
      ),
    };
  ...
  factory CSIDriver.fromMap(Map<String, dynamic> map) {
    return CSIDriver(
      ...
      spec: pulumi.Input.fromValue(
        CSIDriverSpec.fromMap((map['spec']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
