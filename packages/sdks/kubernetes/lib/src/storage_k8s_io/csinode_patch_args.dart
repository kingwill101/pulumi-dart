...
class CSINodePatchArgs {
  ...
  CSINodePatchArgs({
    ...
    pulumi.Output<CSINodeSpecPatch>? spec,
  }) :
  ...
  factory CSINodePatchArgs.fromMap(Map<String, dynamic> map) {
    return CSINodePatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CSINodeSpecPatch>(CSINodeSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
