...
class CSINode {
  ...
  CSINode({this.apiVersion, this.kind, this.metadata, required this.spec});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': pulumi.Input.mapInputValue<CSINodeSpec, Map<String, dynamic>>(
        spec,
        (value) => value.toMap(),
      ),
    };
  ...
  factory CSINode.fromMap(Map<String, dynamic> map) {
    return CSINode(
      ...
      spec: pulumi.Input.fromValue(
        CSINodeSpec.fromMap((map['spec']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
