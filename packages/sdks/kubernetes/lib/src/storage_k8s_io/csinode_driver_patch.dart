...
class CSINodeDriverPatch {
  ...
  final VolumeNodeResourcesPatch? allocatable;
  ...
  factory CSINodeDriverPatch.fromMap(Map<String, dynamic> map) {
    return CSINodeDriverPatch(
      allocatable: map['allocatable'] == null ? null : VolumeNodeResourcesPatch.fromMap((map['allocatable'] as Map).cast<String, dynamic>()),
