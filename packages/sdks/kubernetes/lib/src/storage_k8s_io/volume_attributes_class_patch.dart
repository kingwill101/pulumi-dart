...
class VolumeAttributesClassPatch {
  ...
  /// Creates a new [VolumeAttributesClassPatch].
  ...
  const VolumeAttributesClassPatch({
    this.apiVersion,
    this.driverName,
    this.kind,
    this.metadata,
  ...
  factory VolumeAttributesClassPatch.fromMap(Map<String, dynamic> map) {
    return VolumeAttributesClassPatch(
