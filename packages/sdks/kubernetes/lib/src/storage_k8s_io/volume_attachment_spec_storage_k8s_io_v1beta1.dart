...
class VolumeAttachmentSpecStorageK8sIoV1beta1 {
  ...
  final VolumeAttachmentSourceStorageK8sIoV1beta1 source;
  ...
  VolumeAttachmentSpecStorageK8sIoV1beta1({
  ...
  factory VolumeAttachmentSpecStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentSpecStorageK8sIoV1beta1(
      ...
      source: VolumeAttachmentSourceStorageK8sIoV1beta1.fromMap((map['source'] as Map).cast<String, dynamic>()),
    );
  }
}
