...
/// {@template pulumi_storage_k8s_io_v1_csistorage_capacity_args_doc}
/// The set of arguments for CSIStorageCapacity.
/// {@endtemplate}
/// {@macro pulumi_storage_k8s_io_v1_csistorage_capacity_args_doc}
class CSIStorageCapacityArgs {
  ...
  /// Creates a new [CSIStorageCapacityArgs].
  ...
  factory CSIStorageCapacityArgs.fromMap(Map<String, dynamic> map) {
    return CSIStorageCapacityArgs(
