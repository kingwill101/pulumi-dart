...
class VolumeAttachmentPatchArgs {
  ...
  VolumeAttachmentPatchArgs({
    ...
    pulumi.Output<VolumeAttachmentSpecPatch>? spec,
  }) :
  ...
  factory VolumeAttachmentPatchArgs.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<VolumeAttachmentSpecPatch>(VolumeAttachmentSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
