...
class CSIStorageCapacityStorageK8sIoV1beta1Args {
  ...
  const CSIStorageCapacityStorageK8sIoV1beta1Args({
    this.apiVersion,
    this.capacity,
    this.kind,
  ...
  factory CSIStorageCapacityStorageK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CSIStorageCapacityStorageK8sIoV1beta1Args(
      ...
      nodeTopology: (() { final guardedValue = map['nodeTopology']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LabelSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
