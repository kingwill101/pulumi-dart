    ...
    return <String, dynamic>{
      ...
      'nodeTopology':
          ?pulumi.Input.mapOptionalInputValue<
            LabelSelector,
            Map<String, dynamic>
          >(nodeTopology, (value) => value.toMap()),
      'storageClassName': storageClassName,
    };
  }

  factory CSIStorageCapacityStorageK8sIoV1beta1Args.fromMap(
    ...
    return CSIStorageCapacityStorageK8sIoV1beta1Args(
      ...
      maximumVolumeSize: (() {
        final guardedValue = map['maximumVolumeSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      metadata: (() {
      ...
      nodeTopology: (() {
        final guardedValue = map['nodeTopology'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
