...
import 'csistorage_capacity_patch_storage_k8s_io_v1beta1_args.dart';
...
class CSIStorageCapacityPatchResource extends pulumi.CustomResource {
  ...
  /// Creates a new [CSIStorageCapacityPatchResource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CSIStorageCapacityPatchResource]. {@macro pulumi_storage_k8s_io_v1beta1_csistorage_capacity_patch_storage_k8s_io_v1beta1_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  CSIStorageCapacityPatchResource(
    String name, {
    CSIStorageCapacityPatchStorageK8sIoV1beta1Args? args,
  ...
  /// Creates a typed reference to an existing [CSIStorageCapacityPatchResource] resource.
  CSIStorageCapacityPatchResource.reference(String urn)
    : super(
        'kubernetes:storage.k8s.io/v1beta1:CSIStorageCapacityPatch',
