...
class CSIDriverPatchArgs {
  ...
  CSIDriverPatchArgs({
    ...
    pulumi.Output<CSIDriverSpecPatch>? spec,
  }) :
  ...
  factory CSIDriverPatchArgs.fromMap(Map<String, dynamic> map) {
    return CSIDriverPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CSIDriverSpecPatch>(CSIDriverSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
