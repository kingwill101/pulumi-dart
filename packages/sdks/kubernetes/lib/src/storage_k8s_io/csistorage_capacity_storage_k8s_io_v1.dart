...
import 'csistorage_capacity_args.dart';
...
class CSIStorageCapacityStorageK8sIoV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [CSIStorageCapacityStorageK8sIoV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CSIStorageCapacityStorageK8sIoV1]. {@macro pulumi_storage_k8s_io_v1_csistorage_capacity_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  CSIStorageCapacityStorageK8sIoV1(
    String name, {
    CSIStorageCapacityArgs? args,
  ...
  /// Creates a typed reference to an existing [CSIStorageCapacityStorageK8sIoV1] resource.
  CSIStorageCapacityStorageK8sIoV1.reference(String urn)
    : super(
        'kubernetes:storage.k8s.io/v1:CSIStorageCapacity',
