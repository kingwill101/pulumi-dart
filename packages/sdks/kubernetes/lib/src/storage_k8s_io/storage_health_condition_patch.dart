...
class StorageHealthConditionPatch {
  ...
  /// Creates a new [StorageHealthConditionPatch].
  ...
  const StorageHealthConditionPatch({
    this.accessMode,
  ...
  factory StorageHealthConditionPatch.fromMap(Map<String, dynamic> map) {
    return StorageHealthConditionPatch(
