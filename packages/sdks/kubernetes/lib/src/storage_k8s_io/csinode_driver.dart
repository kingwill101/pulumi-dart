...
class CSINodeDriver {
  ...
  factory CSINodeDriver.fromMap(Map<String, dynamic> map) {
    return CSINodeDriver(
      allocatable: (() { final guardedValue = map['allocatable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeNodeResources.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
