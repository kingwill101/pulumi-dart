...
class VolumeAttachmentPatch {
  ...
  factory VolumeAttachmentPatch.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeAttachmentStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
