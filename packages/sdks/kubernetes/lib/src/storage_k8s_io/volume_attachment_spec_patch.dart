...
class VolumeAttachmentSpecPatch {
  ...
  const VolumeAttachmentSpecPatch({
    this.attacher,
    this.nodeName,
    this.source,
  });
  ...
  factory VolumeAttachmentSpecPatch.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentSpecPatch(
      ...
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeAttachmentSourcePatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
