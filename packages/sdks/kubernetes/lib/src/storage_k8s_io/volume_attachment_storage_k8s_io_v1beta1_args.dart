...
class VolumeAttachmentStorageK8sIoV1beta1Args {
  ...
  VolumeAttachmentStorageK8sIoV1beta1Args({
    ...
    required pulumi.Output<VolumeAttachmentSpecStorageK8sIoV1beta1> spec,
  }) :
  ...
  factory VolumeAttachmentStorageK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStorageK8sIoV1beta1Args(
      ...
      spec: pulumi.Output.create<VolumeAttachmentSpecStorageK8sIoV1beta1>(VolumeAttachmentSpecStorageK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
