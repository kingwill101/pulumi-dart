...
class VolumeAttachmentPatchResource extends pulumi.CustomResource {
  ...
  VolumeAttachmentPatchResource(
    ...
    this.spec = registerOutput<VolumeAttachmentSpecPatchStorageK8sIoV1alpha1?>('spec');
    this.status = registerOutput<VolumeAttachmentStatusPatchStorageK8sIoV1alpha1?>('status');
  }
}
