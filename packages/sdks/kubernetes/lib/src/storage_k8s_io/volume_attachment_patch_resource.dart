...
class VolumeAttachmentPatchResource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<VolumeAttachmentStatusPatchStorageK8sIoV1alpha1?>
  status;
  ...
  VolumeAttachmentPatchResource(
    ...
    spec = registerOutput<VolumeAttachmentSpecPatchStorageK8sIoV1alpha1?>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VolumeAttachmentSpecPatchStorageK8sIoV1alpha1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<VolumeAttachmentStatusPatchStorageK8sIoV1alpha1?>(
      'status',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VolumeAttachmentStatusPatchStorageK8sIoV1alpha1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
