...
class VolumeAttachmentStorageK8sIoV1alpha1Args {
  ...
  VolumeAttachmentStorageK8sIoV1alpha1Args({
    ...
    required pulumi.Output<VolumeAttachmentSpecStorageK8sIoV1alpha1> spec,
  }) :
  ...
  factory VolumeAttachmentStorageK8sIoV1alpha1Args.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStorageK8sIoV1alpha1Args(
      ...
      spec: pulumi.Output.create<VolumeAttachmentSpecStorageK8sIoV1alpha1>(VolumeAttachmentSpecStorageK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
