...
class CSIDriverSpec {
  ...
  final pulumi.Input<List<TokenRequest>?>? tokenRequests;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tokenRequests': ?pulumi.Input.mapOptionalInputValue<List<TokenRequest>, List<Map<String, dynamic>>>(tokenRequests, (value) => pulumi.Input.encodeList<TokenRequest, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory CSIDriverSpec.fromMap(Map<String, dynamic> map) {
    return CSIDriverSpec(
      ...
      tokenRequests: (() { final guardedValue = map['tokenRequests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TokenRequest>(guardedValue, (value) => TokenRequest.fromMap((value as Map).cast<String, dynamic>()))); })(),
