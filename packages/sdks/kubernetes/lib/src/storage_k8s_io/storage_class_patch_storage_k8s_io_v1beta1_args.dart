...
class StorageClassPatchStorageK8sIoV1beta1Args {
  ...
  StorageClassPatchStorageK8sIoV1beta1Args({
    ...
    pulumi.Output<List<TopologySelectorTermPatch>>? allowedTopologies,
  ...
  factory StorageClassPatchStorageK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return StorageClassPatchStorageK8sIoV1beta1Args(
      ...
      allowedTopologies: map['allowedTopologies'] == null ? null : pulumi.Output.create<List<TopologySelectorTermPatch>>(pulumi.Input.decodeList<TopologySelectorTermPatch>(map['allowedTopologies'], (value) => TopologySelectorTermPatch.fromMap((value as Map).cast<String, dynamic>()))),
