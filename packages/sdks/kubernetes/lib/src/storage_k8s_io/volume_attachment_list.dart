...
class VolumeAttachmentList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<VolumeAttachment, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory VolumeAttachmentList.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentList(
      ...
      items: pulumi.Input.decodeList<VolumeAttachment>(map['items'], (value) => VolumeAttachment.fromMap((value as Map).cast<String, dynamic>())),
