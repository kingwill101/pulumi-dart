...
class VolumeAttributesClassListStorageK8sIoV1beta1Args {
  ...
  final pulumi.Input<List<VolumeAttributesClassStorageK8sIoV1beta1Resource>>
  items;
  ...
  factory VolumeAttributesClassListStorageK8sIoV1beta1Args.fromMap(
    ...
    return VolumeAttributesClassListStorageK8sIoV1beta1Args(
      ...
      items: pulumi.Input.fromValue(
        (map['items'] as List)
            .cast<VolumeAttributesClassStorageK8sIoV1beta1Resource>(),
      ),
      kind: (() {
