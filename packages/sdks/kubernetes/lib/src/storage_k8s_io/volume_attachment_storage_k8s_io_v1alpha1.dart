    ...
    return <String, dynamic>{
      ...
      'status':
          ?pulumi.Input.mapOptionalInputValue<
            VolumeAttachmentStatusStorageK8sIoV1alpha1,
            Map<String, dynamic>
          >(status, (value) => value.toMap()),
    };
  }

  factory VolumeAttachmentStorageK8sIoV1alpha1.fromMap(
    ...
    return VolumeAttachmentStorageK8sIoV1alpha1(
      ...
      spec: pulumi.Input.fromValue(
        VolumeAttachmentSpecStorageK8sIoV1alpha1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeAttachmentStatusStorageK8sIoV1alpha1.fromMap(
