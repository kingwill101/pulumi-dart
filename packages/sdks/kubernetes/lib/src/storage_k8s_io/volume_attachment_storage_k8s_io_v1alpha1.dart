...
class VolumeAttachmentStorageK8sIoV1alpha1 {
  ...
  final pulumi.Input<VolumeAttachmentStatusStorageK8sIoV1alpha1>? status;

  /// Creates a new [VolumeAttachmentStorageK8sIoV1alpha1].
  ...
  const VolumeAttachmentStorageK8sIoV1alpha1({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<VolumeAttachmentStatusStorageK8sIoV1alpha1, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory VolumeAttachmentStorageK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStorageK8sIoV1alpha1(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeAttachmentStatusStorageK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
