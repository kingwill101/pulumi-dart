...
class VolumeAttachmentPatchStorageK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [VolumeAttachmentPatchStorageK8sIoV1beta1Resource] resource.
  VolumeAttachmentPatchStorageK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:storage.k8s.io/v1beta1:VolumeAttachmentPatch',
