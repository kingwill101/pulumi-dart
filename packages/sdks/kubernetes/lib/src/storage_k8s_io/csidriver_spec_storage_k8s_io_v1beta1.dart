...
class CSIDriverSpecStorageK8sIoV1beta1 {
  ...
  ///
  /// This is an alpha feature and only available when the CSIServiceAccountToken feature is enabled.
  final List<TokenRequestStorageK8sIoV1beta1>? tokenRequests;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tokenRequests': ?tokenRequests == null ? null : pulumi.Input.encodeList<TokenRequestStorageK8sIoV1beta1, Map<String, dynamic>>(tokenRequests!, (value) => value.toMap()),
  ...
  factory CSIDriverSpecStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSIDriverSpecStorageK8sIoV1beta1(
      ...
      tokenRequests: map['tokenRequests'] == null ? null : pulumi.Input.decodeList<TokenRequestStorageK8sIoV1beta1>(map['tokenRequests'], (value) => TokenRequestStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
