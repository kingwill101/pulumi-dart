...
import 'token_request_storage_k8s_io_v1beta1.dart';

/// CSIDriverSpec is the specification of a CSIDriver.
class CSIDriverSpecStorageK8sIoV1beta1 {
  ...
  ///
  /// This is an alpha feature and only available when the CSIServiceAccountToken feature is enabled.
  final pulumi.Input<List<TokenRequestStorageK8sIoV1beta1>?>? tokenRequests;
  ...
  /// Creates a new [CSIDriverSpecStorageK8sIoV1beta1].
  ...
  const CSIDriverSpecStorageK8sIoV1beta1({
    this.attachRequired,
    this.fsGroupPolicy,
    this.podInfoOnMount,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tokenRequests': ?pulumi.Input.mapOptionalInputValue<List<TokenRequestStorageK8sIoV1beta1>, List<Map<String, dynamic>>>(tokenRequests, (value) => pulumi.Input.encodeList<TokenRequestStorageK8sIoV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory CSIDriverSpecStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSIDriverSpecStorageK8sIoV1beta1(
      ...
      tokenRequests: (() { final guardedValue = map['tokenRequests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TokenRequestStorageK8sIoV1beta1>(guardedValue, (value) => TokenRequestStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
