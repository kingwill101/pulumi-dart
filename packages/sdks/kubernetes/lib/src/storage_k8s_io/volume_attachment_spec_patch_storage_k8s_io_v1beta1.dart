...
class VolumeAttachmentSpecPatchStorageK8sIoV1beta1 {
  ...
  final pulumi.Input<VolumeAttachmentSourcePatchStorageK8sIoV1beta1>? source;
  ...
  const VolumeAttachmentSpecPatchStorageK8sIoV1beta1({
    this.attacher,
    this.nodeName,
    this.source,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attacher': ?attacher,
      'nodeName': ?nodeName,
      'source': ?pulumi.Input.mapOptionalInputValue<VolumeAttachmentSourcePatchStorageK8sIoV1beta1, Map<String, dynamic>>(source, (value) => value.toMap()),
    };
  }
  ...
  factory VolumeAttachmentSpecPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentSpecPatchStorageK8sIoV1beta1(
      ...
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeAttachmentSourcePatchStorageK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
