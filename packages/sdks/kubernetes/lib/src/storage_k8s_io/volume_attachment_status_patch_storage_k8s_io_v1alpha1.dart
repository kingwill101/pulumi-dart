...
class VolumeAttachmentStatusPatchStorageK8sIoV1alpha1 {
  ...
  const VolumeAttachmentStatusPatchStorageK8sIoV1alpha1({
    this.attachError,
    this.attached,
  ...
  factory VolumeAttachmentStatusPatchStorageK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStatusPatchStorageK8sIoV1alpha1(
      attachError: (() { final guardedValue = map['attachError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeErrorPatchStorageK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      detachError: (() { final guardedValue = map['detachError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeErrorPatchStorageK8sIoV1alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
