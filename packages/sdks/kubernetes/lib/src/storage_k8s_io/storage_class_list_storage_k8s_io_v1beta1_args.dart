...
class StorageClassListStorageK8sIoV1beta1Args {
  ...
  StorageClassListStorageK8sIoV1beta1Args({
    ...
    required pulumi.Output<List<StorageClassResource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<StorageClassResource>>(items),
  ...
  factory StorageClassListStorageK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return StorageClassListStorageK8sIoV1beta1Args(
      ...
      items: pulumi.Output.create<List<StorageClassResource>>((map['items'] as List).cast<StorageClassResource>()),
