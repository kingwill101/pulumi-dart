...
class VolumeAttachmentStatusStorageK8sIoV1beta1 {
  ...
  const VolumeAttachmentStatusStorageK8sIoV1beta1({
    this.attachError,
  ...
  factory VolumeAttachmentStatusStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStatusStorageK8sIoV1beta1(
      attachError: (() { final guardedValue = map['attachError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeErrorStorageK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      detachError: (() { final guardedValue = map['detachError']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeErrorStorageK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
