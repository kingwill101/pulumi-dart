...
class VolumeAttachmentStatusPatchStorageK8sIoV1beta1 {
  ...
  factory VolumeAttachmentStatusPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStatusPatchStorageK8sIoV1beta1(
      attachError: map['attachError'] == null ? null : (VolumeErrorPatchStorageK8sIoV1beta1.fromMap((map['attachError']! as Map).cast<String, dynamic>())).input(),
      ...
      detachError: map['detachError'] == null ? null : (VolumeErrorPatchStorageK8sIoV1beta1.fromMap((map['detachError']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
