...
import 'volume_error_patch_storage_k8s_io_v1beta1.dart';

/// VolumeAttachmentStatus is the status of a VolumeAttachment request.
class VolumeAttachmentStatusPatchStorageK8sIoV1beta1 {
  /// The last error encountered during attach operation, if any. This field must only be set by the entity completing the attach operation, i.e. the external-attacher.
  final VolumeErrorPatchStorageK8sIoV1beta1? attachError;
  ...
  final VolumeErrorPatchStorageK8sIoV1beta1? detachError;

  /// Creates a new [VolumeAttachmentStatusPatchStorageK8sIoV1beta1].
  ...
  VolumeAttachmentStatusPatchStorageK8sIoV1beta1({
    this.attachError,
    this.attached,
  ...
  factory VolumeAttachmentStatusPatchStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentStatusPatchStorageK8sIoV1beta1(
      attachError: map['attachError'] == null ? null : VolumeErrorPatchStorageK8sIoV1beta1.fromMap((map['attachError'] as Map).cast<String, dynamic>()),
      ...
      detachError: map['detachError'] == null ? null : VolumeErrorPatchStorageK8sIoV1beta1.fromMap((map['detachError'] as Map).cast<String, dynamic>()),
    );
  }
}
