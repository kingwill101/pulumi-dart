...
class VolumeAttachmentPatchStorageK8sIoV1alpha1 {
  ...
  final VolumeAttachmentSpecPatchStorageK8sIoV1alpha1? spec;
  /// Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.
  final VolumeAttachmentStatusPatchStorageK8sIoV1alpha1? status;
  ...
  factory VolumeAttachmentPatchStorageK8sIoV1alpha1.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentPatchStorageK8sIoV1alpha1(
      ...
      spec: map['spec'] == null ? null : VolumeAttachmentSpecPatchStorageK8sIoV1alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : VolumeAttachmentStatusPatchStorageK8sIoV1alpha1.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
