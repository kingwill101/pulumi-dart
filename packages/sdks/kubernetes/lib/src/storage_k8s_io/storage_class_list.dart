...
class StorageClassList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<StorageClass, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory StorageClassList.fromMap(Map<String, dynamic> map) {
    return StorageClassList(
      ...
      items: pulumi.Input.decodeList<StorageClass>(map['items'], (value) => StorageClass.fromMap((value as Map).cast<String, dynamic>())),
