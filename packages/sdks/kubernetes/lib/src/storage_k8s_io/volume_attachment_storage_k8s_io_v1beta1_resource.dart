...
class VolumeAttachmentStorageK8sIoV1beta1Resource
  ...
  VolumeAttachmentStorageK8sIoV1beta1Resource(
    ...
    spec = registerOutput<VolumeAttachmentSpecStorageK8sIoV1beta1>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VolumeAttachmentSpecStorageK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<VolumeAttachmentStatusStorageK8sIoV1beta1?>(
      'status',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VolumeAttachmentStatusStorageK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
