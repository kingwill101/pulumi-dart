...
class VolumeAttachmentStorageK8sIoV1beta1Resource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [VolumeAttachmentStorageK8sIoV1beta1Resource] resource.
  VolumeAttachmentStorageK8sIoV1beta1Resource.reference(String urn)
    : super(
        'kubernetes:storage.k8s.io/v1beta1:VolumeAttachment',
