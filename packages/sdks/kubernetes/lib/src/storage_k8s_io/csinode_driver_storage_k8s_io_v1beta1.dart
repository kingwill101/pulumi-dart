...
import 'volume_node_resources_storage_k8s_io_v1beta1.dart';

/// CSINodeDriver holds information about the specification of one CSI driver installed on a node
class CSINodeDriverStorageK8sIoV1beta1 {
  /// allocatable represents the volume resources of a node that are available for scheduling.
  final pulumi.Input<VolumeNodeResourcesStorageK8sIoV1beta1>? allocatable;
  ...
  /// Creates a new [CSINodeDriverStorageK8sIoV1beta1].
  ...
  const CSINodeDriverStorageK8sIoV1beta1({
    this.allocatable,
    required this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allocatable': ?pulumi.Input.mapOptionalInputValue<VolumeNodeResourcesStorageK8sIoV1beta1, Map<String, dynamic>>(allocatable, (value) => value.toMap()),
      'name': name,
      'nodeID': nodeID,
  ...
  factory CSINodeDriverStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeDriverStorageK8sIoV1beta1(
      allocatable: (() { final guardedValue = map['allocatable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeNodeResourcesStorageK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
