...
class CSINodeDriverStorageK8sIoV1beta1 {
  ...
  final VolumeNodeResourcesStorageK8sIoV1beta1? allocatable;
  ...
  factory CSINodeDriverStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSINodeDriverStorageK8sIoV1beta1(
      allocatable: map['allocatable'] == null ? null : VolumeNodeResourcesStorageK8sIoV1beta1.fromMap((map['allocatable'] as Map).cast<String, dynamic>()),
