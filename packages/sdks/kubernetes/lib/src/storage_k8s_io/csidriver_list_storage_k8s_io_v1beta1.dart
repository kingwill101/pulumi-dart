...
class CSIDriverListStorageK8sIoV1beta1 {
  ...
  final List<CSIDriverStorageK8sIoV1beta1> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<CSIDriverStorageK8sIoV1beta1, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory CSIDriverListStorageK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return CSIDriverListStorageK8sIoV1beta1(
      ...
      items: pulumi.Input.decodeList<CSIDriverStorageK8sIoV1beta1>(map['items'], (value) => CSIDriverStorageK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
