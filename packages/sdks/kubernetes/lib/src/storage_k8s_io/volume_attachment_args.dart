...
class VolumeAttachmentArgs {
  ...
  VolumeAttachmentArgs({
    ...
    required pulumi.Output<VolumeAttachmentSpec> spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asInput<VolumeAttachmentSpec>(spec);
  ...
  factory VolumeAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentArgs(
      ...
      spec: pulumi.Output.create<VolumeAttachmentSpec>(VolumeAttachmentSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
