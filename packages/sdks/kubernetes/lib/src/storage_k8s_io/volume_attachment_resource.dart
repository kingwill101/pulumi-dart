...
class VolumeAttachmentResource extends pulumi.CustomResource {
  ...
  VolumeAttachmentResource(
    ...
    spec = registerOutput<VolumeAttachmentSpecStorageK8sIoV1alpha1>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VolumeAttachmentSpecStorageK8sIoV1alpha1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<VolumeAttachmentStatusStorageK8sIoV1alpha1?>(
      'status',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return VolumeAttachmentStatusStorageK8sIoV1alpha1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
