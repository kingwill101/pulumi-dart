...
class LeaseCandidateCoordinationK8sIoV1beta1Resource
  ...
  LeaseCandidateCoordinationK8sIoV1beta1Resource(
    ...
    spec = registerOutput<LeaseCandidateSpecCoordinationK8sIoV1beta1>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return LeaseCandidateSpecCoordinationK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
