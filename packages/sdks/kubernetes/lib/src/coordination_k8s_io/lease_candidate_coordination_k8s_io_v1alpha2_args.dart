...
class LeaseCandidateCoordinationK8sIoV1alpha2Args {
  ...
  const LeaseCandidateCoordinationK8sIoV1alpha2Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': pulumi.Input.mapInputValue<LeaseCandidateSpecCoordinationK8sIoV1alpha2, Map<String, dynamic>>(spec, (value) => value.toMap()),
    };
  }
  ...
  factory LeaseCandidateCoordinationK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return LeaseCandidateCoordinationK8sIoV1alpha2Args(
      ...
      spec: pulumi.Input.fromValue(LeaseCandidateSpecCoordinationK8sIoV1alpha2.fromMap((map['spec']! as Map).cast<String, dynamic>())),
    );
  }
}
