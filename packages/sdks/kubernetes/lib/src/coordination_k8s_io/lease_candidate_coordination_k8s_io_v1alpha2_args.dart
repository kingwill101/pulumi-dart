    ...
    return <String, dynamic>{
      ...
      'spec':
          ?pulumi.Input.mapOptionalInputValue<
            LeaseCandidateSpecCoordinationK8sIoV1alpha2,
            Map<String, dynamic>
          >(spec, (value) => value.toMap()),
    };
  }

  factory LeaseCandidateCoordinationK8sIoV1alpha2Args.fromMap(
    ...
    return LeaseCandidateCoordinationK8sIoV1alpha2Args(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LeaseCandidateSpecCoordinationK8sIoV1alpha2.fromMap(
