...
class LeasePatchCoordinationK8sIoV1beta1 {
  ...
  const LeasePatchCoordinationK8sIoV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory LeasePatchCoordinationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return LeasePatchCoordinationK8sIoV1beta1(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LeaseSpecPatchCoordinationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
