...
class LeasePatchCoordinationK8sIoV1beta1Args {
  ...
  LeasePatchCoordinationK8sIoV1beta1Args({
    ...
    pulumi.Output<LeaseSpecPatchCoordinationK8sIoV1beta1>? spec,
  }) :
  ...
  factory LeasePatchCoordinationK8sIoV1beta1Args.fromMap(Map<String, dynamic> map) {
    return LeasePatchCoordinationK8sIoV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<LeaseSpecPatchCoordinationK8sIoV1beta1>(LeaseSpecPatchCoordinationK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
