...
class LeaseCandidateSpecCoordinationK8sIoV1alpha2 {
  ...
  /// Creates a new [LeaseCandidateSpecCoordinationK8sIoV1alpha2].
  ...
  const LeaseCandidateSpecCoordinationK8sIoV1alpha2({
  ...
  factory LeaseCandidateSpecCoordinationK8sIoV1alpha2.fromMap(Map<String, dynamic> map) {
    return LeaseCandidateSpecCoordinationK8sIoV1alpha2(
      binaryVersion: pulumi.Input.fromValue(map['binaryVersion'] as String),
      ...
      leaseName: pulumi.Input.fromValue(map['leaseName'] as String),
