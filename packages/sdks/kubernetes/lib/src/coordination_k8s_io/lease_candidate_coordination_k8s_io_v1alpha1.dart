...
class LeaseCandidateCoordinationK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  LeaseCandidateCoordinationK8sIoV1alpha1(
    ...
    spec = registerOutput<LeaseCandidateSpec>('spec', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return LeaseCandidateSpec.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [LeaseCandidateCoordinationK8sIoV1alpha1] resource.
  LeaseCandidateCoordinationK8sIoV1alpha1.reference(String urn)
    : super(
        'kubernetes:coordination.k8s.io/v1alpha1:LeaseCandidate',
