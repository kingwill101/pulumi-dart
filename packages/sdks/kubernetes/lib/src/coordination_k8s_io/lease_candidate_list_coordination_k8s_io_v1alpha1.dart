...
class LeaseCandidateListCoordinationK8sIoV1alpha1 extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<LeaseCandidate>> items;
  ...
  LeaseCandidateListCoordinationK8sIoV1alpha1(
    ...
    items = registerOutput<List<LeaseCandidate>>('items', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<LeaseCandidate>(guardedValue, (value) => LeaseCandidate.fromMap((value as Map).cast<String, dynamic>())); });
    kind = registerOutput<String>('kind');
    metadata = registerOutput<ListMeta>('metadata', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ListMeta.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  }

  /// Creates a typed reference to an existing [LeaseCandidateListCoordinationK8sIoV1alpha1] resource.
  LeaseCandidateListCoordinationK8sIoV1alpha1.reference(String urn)
    : super(
        'kubernetes:coordination.k8s.io/v1alpha1:LeaseCandidateList',
