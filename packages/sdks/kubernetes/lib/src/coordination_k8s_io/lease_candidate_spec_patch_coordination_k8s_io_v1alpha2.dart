...
class LeaseCandidateSpecPatchCoordinationK8sIoV1alpha2 {
  ...
  factory LeaseCandidateSpecPatchCoordinationK8sIoV1alpha2.fromMap(
    Map<String, dynamic> map,
  ) {
    return LeaseCandidateSpecPatchCoordinationK8sIoV1alpha2(
      binaryVersion: (() {
        final guardedValue = map['binaryVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emulationVersion: (() {
        final guardedValue = map['emulationVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      leaseName: (() {
        final guardedValue = map['leaseName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pingTime: (() {
        final guardedValue = map['pingTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      renewTime: (() {
