...
class Lease {
  ...
  Lease({this.apiVersion, this.kind, this.metadata, this.spec});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec':
          ?pulumi.Input.mapOptionalInputValue<LeaseSpec, Map<String, dynamic>>(
            spec,
            (value) => value.toMap(),
          ),
    };
  ...
  factory Lease.fromMap(Map<String, dynamic> map) {
    return Lease(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LeaseSpec.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
