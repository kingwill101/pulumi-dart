...
class LeaseCandidateListCoordinationK8sIoV1beta1 {
    ...
    return <String, dynamic>{
      ...
      'items':
          pulumi.Input.mapInputValue<
            List<LeaseCandidateCoordinationK8sIoV1beta1>,
            List<Map<String, dynamic>>
          >(
            items,
            (value) =>
                pulumi.Input.encodeList<
                  LeaseCandidateCoordinationK8sIoV1beta1,
                  Map<String, dynamic>
  ...
  factory LeaseCandidateListCoordinationK8sIoV1beta1.fromMap(
    ...
    return LeaseCandidateListCoordinationK8sIoV1beta1(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<LeaseCandidateCoordinationK8sIoV1beta1>(
          map['items']!,
          (value) => LeaseCandidateCoordinationK8sIoV1beta1.fromMap(
