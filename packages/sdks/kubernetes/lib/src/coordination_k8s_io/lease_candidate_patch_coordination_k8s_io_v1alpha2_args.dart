...
class LeaseCandidatePatchCoordinationK8sIoV1alpha2Args {
  ...
  LeaseCandidatePatchCoordinationK8sIoV1alpha2Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMetaPatch>? metadata,
    pulumi.Output<LeaseCandidateSpecPatchCoordinationK8sIoV1alpha2>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<LeaseCandidateSpecPatchCoordinationK8sIoV1alpha2>(spec);
  ...
  factory LeaseCandidatePatchCoordinationK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return LeaseCandidatePatchCoordinationK8sIoV1alpha2Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<LeaseCandidateSpecPatchCoordinationK8sIoV1alpha2>(LeaseCandidateSpecPatchCoordinationK8sIoV1alpha2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
