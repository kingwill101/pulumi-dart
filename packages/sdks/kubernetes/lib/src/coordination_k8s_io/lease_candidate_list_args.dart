...
class LeaseCandidateListArgs {
  ...
  LeaseCandidateListArgs({
    pulumi.Output<String>? apiVersion,
    required pulumi.Output<List<LeaseCandidateCoordinationK8sIoV1alpha1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<LeaseCandidateCoordinationK8sIoV1alpha1>>(items),
  ...
  factory LeaseCandidateListArgs.fromMap(Map<String, dynamic> map) {
    return LeaseCandidateListArgs(
      ...
      items: pulumi.Output.create<List<LeaseCandidateCoordinationK8sIoV1alpha1>>((map['items'] as List).cast<LeaseCandidateCoordinationK8sIoV1alpha1>()),
