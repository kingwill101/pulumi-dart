...
class LeaseCandidateListCoordinationK8sIoV1alpha2Args {
  ...
  LeaseCandidateListCoordinationK8sIoV1alpha2Args({
    ...
    required pulumi.Output<List<LeaseCandidateResource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<LeaseCandidateResource>>(items),
  ...
  factory LeaseCandidateListCoordinationK8sIoV1alpha2Args.fromMap(Map<String, dynamic> map) {
    return LeaseCandidateListCoordinationK8sIoV1alpha2Args(
      ...
      items: pulumi.Output.create<List<LeaseCandidateResource>>((map['items'] as List).cast<LeaseCandidateResource>()),
