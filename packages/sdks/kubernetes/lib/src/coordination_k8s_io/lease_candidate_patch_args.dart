...
/// {@template pulumi_coordination_k8s_io_v1alpha1_lease_candidate_patch_args_doc}
/// The set of arguments for LeaseCandidatePatch.
/// {@endtemplate}
/// {@macro pulumi_coordination_k8s_io_v1alpha1_lease_candidate_patch_args_doc}
class LeaseCandidatePatchArgs {
  ...
  /// Creates a new [LeaseCandidatePatchArgs].
  ...
  factory LeaseCandidatePatchArgs.fromMap(Map<String, dynamic> map) {
    return LeaseCandidatePatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<LeaseCandidateSpecPatch>(LeaseCandidateSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
