...
class StatefulSetList {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<StatefulSet, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory StatefulSetList.fromMap(Map<String, dynamic> map) {
    return StatefulSetList(
      ...
      items: pulumi.Input.decodeList<StatefulSet>(map['items'], (value) => StatefulSet.fromMap((value as Map).cast<String, dynamic>())),
