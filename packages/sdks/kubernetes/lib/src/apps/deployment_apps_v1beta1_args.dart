...
class DeploymentAppsV1beta1Args {
  ...
  DeploymentAppsV1beta1Args({
    ...
    pulumi.Output<DeploymentSpecAppsV1beta1>? spec,
  }) :
  ...
  factory DeploymentAppsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return DeploymentAppsV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<DeploymentSpecAppsV1beta1>(DeploymentSpecAppsV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
