...
class ReplicaSetPatchAppsV1beta2 {
  ...
  factory ReplicaSetPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ReplicaSetPatchAppsV1beta2(
      ...
      spec: map['spec'] == null ? null : (ReplicaSetSpecPatchAppsV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (ReplicaSetStatusPatchAppsV1beta2.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
