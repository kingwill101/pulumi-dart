...
class DaemonSetPatchArgs {
  ...
  factory DaemonSetPatchArgs.fromMap(Map<String, dynamic> map) {
    return DaemonSetPatchArgs(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DaemonSetSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
