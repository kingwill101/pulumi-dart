...
class ScalePatchAppsV1beta2 {
  ...
  factory ScalePatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ScalePatchAppsV1beta2(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleSpecPatchAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleStatusPatchAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
