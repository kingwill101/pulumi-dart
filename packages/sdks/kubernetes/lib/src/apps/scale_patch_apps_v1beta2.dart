...
class ScalePatchAppsV1beta2 {
  ...
  final ScaleSpecPatchAppsV1beta2? spec;
  /// current status of the scale. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status. Read-only.
  final ScaleStatusPatchAppsV1beta2? status;
  ...
  factory ScalePatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ScalePatchAppsV1beta2(
      ...
      spec: map['spec'] == null ? null : ScaleSpecPatchAppsV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : ScaleStatusPatchAppsV1beta2.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
