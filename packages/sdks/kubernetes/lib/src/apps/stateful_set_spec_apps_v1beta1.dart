...
import 'stateful_set_update_strategy_apps_v1beta1.dart';

/// A StatefulSetSpec is the specification of a StatefulSet.
class StatefulSetSpecAppsV1beta1 {
  ...
  final pulumi.Input<StatefulSetUpdateStrategyAppsV1beta1>? updateStrategy;
  ...
  /// Creates a new [StatefulSetSpecAppsV1beta1].
  ...
  const StatefulSetSpecAppsV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'updateStrategy': ?pulumi.Input.mapOptionalInputValue<StatefulSetUpdateStrategyAppsV1beta1, Map<String, dynamic>>(updateStrategy, (value) => value.toMap()),
  ...
  factory StatefulSetSpecAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecAppsV1beta1(
      ...
      updateStrategy: (() { final guardedValue = map['updateStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StatefulSetUpdateStrategyAppsV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
