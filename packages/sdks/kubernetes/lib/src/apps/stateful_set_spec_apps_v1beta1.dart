...
class StatefulSetSpecAppsV1beta1 {
  ...
  factory StatefulSetSpecAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecAppsV1beta1(
      podManagementPolicy: (() {
        final guardedValue = map['podManagementPolicy'];
      ...
      updateStrategy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StatefulSetUpdateStrategyAppsV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      volumeClaimTemplates: (() {
        final guardedValue = map['volumeClaimTemplates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PersistentVolumeClaim>(
            guardedValue,
            (value) => PersistentVolumeClaim.fromMap(
