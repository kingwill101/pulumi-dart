...
class StatefulSetUpdateStrategyPatchAppsV1beta1 {
  ...
  final pulumi.Input<RollingUpdateStatefulSetStrategyPatchAppsV1beta1>?
  rollingUpdate;
  ...
  StatefulSetUpdateStrategyPatchAppsV1beta1({this.rollingUpdate, this.type});
  ...
  factory StatefulSetUpdateStrategyPatchAppsV1beta1.fromMap(
    ...
    return StatefulSetUpdateStrategyPatchAppsV1beta1(
      rollingUpdate: (() {
        ...
        return pulumi.Input.fromValue(
          RollingUpdateStatefulSetStrategyPatchAppsV1beta1.fromMap(
