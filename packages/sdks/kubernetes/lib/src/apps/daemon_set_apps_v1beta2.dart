...
class DaemonSetAppsV1beta2 {
  ...
  factory DaemonSetAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DaemonSetAppsV1beta2(
      ...
      spec: map['spec'] == null ? null : (DaemonSetSpecAppsV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (DaemonSetStatusAppsV1beta2.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
