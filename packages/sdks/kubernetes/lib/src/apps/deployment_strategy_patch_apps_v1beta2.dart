...
class DeploymentStrategyPatchAppsV1beta2 {
  ...
  const DeploymentStrategyPatchAppsV1beta2({
    this.rollingUpdate,
    this.type,
  });
  ...
  factory DeploymentStrategyPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentStrategyPatchAppsV1beta2(
      rollingUpdate: (() { final guardedValue = map['rollingUpdate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RollingUpdateDeploymentPatchAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
