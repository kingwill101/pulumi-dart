...
class StatefulSetListAppsV1beta2Args {
  ...
  StatefulSetListAppsV1beta2Args({
    ...
    required pulumi.Output<List<StatefulSetAppsV1beta2Resource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<StatefulSetAppsV1beta2Resource>>(items),
  ...
  factory StatefulSetListAppsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return StatefulSetListAppsV1beta2Args(
      ...
      items: pulumi.Output.create<List<StatefulSetAppsV1beta2Resource>>((map['items'] as List).cast<StatefulSetAppsV1beta2Resource>()),
