...
class ReplicaSetListAppsV1beta2 {
  ...
  final List<ReplicaSetAppsV1beta2> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.encodeList<ReplicaSetAppsV1beta2, Map<String, dynamic>>(items, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory ReplicaSetListAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ReplicaSetListAppsV1beta2(
      ...
      items: pulumi.Input.decodeList<ReplicaSetAppsV1beta2>(map['items'], (value) => ReplicaSetAppsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
