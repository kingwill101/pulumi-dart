...
class ReplicaSetStatusAppsV1beta2 {
  ...
  final List<ReplicaSetConditionAppsV1beta2>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<ReplicaSetConditionAppsV1beta2, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory ReplicaSetStatusAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ReplicaSetStatusAppsV1beta2(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<ReplicaSetConditionAppsV1beta2>(map['conditions'], (value) => ReplicaSetConditionAppsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
