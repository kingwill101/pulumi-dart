    ...
    return DeploymentStatusPatch(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeploymentConditionPatch>(
            guardedValue,
            (value) => DeploymentConditionPatch.fromMap(
      ...
      terminatingReplicas: (() {
        final guardedValue = map['terminatingReplicas'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      unavailableReplicas: (() {
