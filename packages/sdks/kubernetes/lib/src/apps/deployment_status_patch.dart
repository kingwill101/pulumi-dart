...
class DeploymentStatusPatch {
  ...
  final List<DeploymentConditionPatch>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<DeploymentConditionPatch, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory DeploymentStatusPatch.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusPatch(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<DeploymentConditionPatch>(map['conditions'], (value) => DeploymentConditionPatch.fromMap((value as Map).cast<String, dynamic>())),
