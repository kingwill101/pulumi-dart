...
class DeploymentSpecAppsV1beta2 {
  ...
  final pulumi.Input<DeploymentStrategyAppsV1beta2?>? strategy;
  ...
  const DeploymentSpecAppsV1beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'strategy': ?pulumi.Input.mapOptionalInputValue<DeploymentStrategyAppsV1beta2, Map<String, dynamic>>(strategy, (value) => value.toMap()),
  ...
  factory DeploymentSpecAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentSpecAppsV1beta2(
      ...
      progressDeadlineSeconds: (() { final guardedValue = map['progressDeadlineSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      strategy: (() { final guardedValue = map['strategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStrategyAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
