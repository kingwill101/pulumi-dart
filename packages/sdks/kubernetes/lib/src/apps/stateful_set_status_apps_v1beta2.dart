...
import 'stateful_set_condition_apps_v1beta2.dart';
...
class StatefulSetStatusAppsV1beta2 {
  ...
  final List<StatefulSetConditionAppsV1beta2>? conditions;
  ...
  /// Creates a new [StatefulSetStatusAppsV1beta2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<StatefulSetConditionAppsV1beta2, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory StatefulSetStatusAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return StatefulSetStatusAppsV1beta2(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<StatefulSetConditionAppsV1beta2>(map['conditions'], (value) => StatefulSetConditionAppsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
