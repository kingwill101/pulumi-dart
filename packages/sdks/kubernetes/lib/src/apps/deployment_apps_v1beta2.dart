...
class DeploymentAppsV1beta2 {
  ...
  factory DeploymentAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentAppsV1beta2(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentSpecAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStatusAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
