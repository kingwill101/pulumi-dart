...
class ControllerRevisionPatchAppsV1beta1 {
  ...
  /// Creates a new [ControllerRevisionPatchAppsV1beta1].
  ...
  const ControllerRevisionPatchAppsV1beta1({
    this.apiVersion,
    this.data,
    this.kind,
    this.metadata,
  ...
  factory ControllerRevisionPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return ControllerRevisionPatchAppsV1beta1(
