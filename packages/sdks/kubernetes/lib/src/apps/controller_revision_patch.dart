...
class ControllerRevisionPatch {
  ...
  /// Creates a new [ControllerRevisionPatch].
  ...
  factory ControllerRevisionPatch.fromMap(Map<String, dynamic> map) {
    return ControllerRevisionPatch(
