...
/// {@template pulumi_apps_v1_deployment_patch_args_doc}
/// The set of arguments for DeploymentPatch.
/// {@endtemplate}
/// {@macro pulumi_apps_v1_deployment_patch_args_doc}
class DeploymentPatchArgs {
  ...
  DeploymentPatchArgs({
    ...
    pulumi.Output<DeploymentSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<DeploymentSpecPatch>(spec);
  ...
  factory DeploymentPatchArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<DeploymentSpecPatch>(DeploymentSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
