...
class DeploymentStrategyPatchAppsV1beta1 {
  ...
  final RollingUpdateDeploymentPatchAppsV1beta1? rollingUpdate;
  ...
  DeploymentStrategyPatchAppsV1beta1({
    this.rollingUpdate,
    this.type,
  });
  ...
  factory DeploymentStrategyPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentStrategyPatchAppsV1beta1(
      rollingUpdate: map['rollingUpdate'] == null ? null : RollingUpdateDeploymentPatchAppsV1beta1.fromMap((map['rollingUpdate'] as Map).cast<String, dynamic>()),
