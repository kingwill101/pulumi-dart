...
import 'replica_set_apps_v1.dart';
...
class ReplicaSetListArgs {
  ...
  final pulumi.Input<List<ReplicaSetAppsV1>> items;
  ...
  ReplicaSetListArgs({
    ...
    required pulumi.Output<List<ReplicaSetAppsV1>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ReplicaSetAppsV1>>(items),
  ...
  factory ReplicaSetListArgs.fromMap(Map<String, dynamic> map) {
    return ReplicaSetListArgs(
      ...
      items: pulumi.Output.create<List<ReplicaSetAppsV1>>((map['items'] as List).cast<ReplicaSetAppsV1>()),
