...
/// {@template pulumi_apps_v1_replica_set_list_args_doc}
/// The set of arguments for ReplicaSetList.
/// {@endtemplate}
/// {@macro pulumi_apps_v1_replica_set_list_args_doc}
class ReplicaSetListArgs {
  ...
  final pulumi.Input<List<ReplicaSet>> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<ReplicaSet>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<ReplicaSet, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory ReplicaSetListArgs.fromMap(Map<String, dynamic> map) {
    return ReplicaSetListArgs(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ReplicaSet>(map['items']!, (value) => ReplicaSet.fromMap((value as Map).cast<String, dynamic>()))),
