...
class DaemonSetPatchAppsV1beta2Args {
  ...
  DaemonSetPatchAppsV1beta2Args({
    ...
    pulumi.Output<DaemonSetSpecPatchAppsV1beta2>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<DaemonSetSpecPatchAppsV1beta2>(spec);
  ...
  factory DaemonSetPatchAppsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return DaemonSetPatchAppsV1beta2Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<DaemonSetSpecPatchAppsV1beta2>(DaemonSetSpecPatchAppsV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
