...
class DaemonSetStatusAppsV1beta2 {
  ...
  final List<DaemonSetConditionAppsV1beta2>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<DaemonSetConditionAppsV1beta2, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory DaemonSetStatusAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DaemonSetStatusAppsV1beta2(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<DaemonSetConditionAppsV1beta2>(map['conditions'], (value) => DaemonSetConditionAppsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
