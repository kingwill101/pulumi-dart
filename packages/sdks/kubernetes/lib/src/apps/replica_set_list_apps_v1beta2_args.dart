...
class ReplicaSetListAppsV1beta2Args {
  ...
  const ReplicaSetListAppsV1beta2Args({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ReplicaSetListAppsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ReplicaSetListAppsV1beta2Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ReplicaSetAppsV1beta2>(map['items']!, (value) => ReplicaSetAppsV1beta2.fromMap((value as Map).cast<String, dynamic>()))),
