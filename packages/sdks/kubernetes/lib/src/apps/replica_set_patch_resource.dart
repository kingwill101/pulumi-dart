...
class ReplicaSetPatchResource extends pulumi.CustomResource {
  ...
  ReplicaSetPatchResource(
    ...
    spec = registerOutput<ReplicaSetSpecPatchAppsV1beta2?>(
      'spec',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ReplicaSetSpecPatchAppsV1beta2.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
    status = registerOutput<ReplicaSetStatusPatchAppsV1beta2?>(
      'status',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ReplicaSetStatusPatchAppsV1beta2.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
