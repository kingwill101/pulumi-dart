...
class DeploymentStatusPatchAppsV1beta2 {
  ...
  factory DeploymentStatusPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusPatchAppsV1beta2(
      ...
      conditions: map['conditions'] == null ? null : (pulumi.Input.decodeList<DeploymentConditionPatchAppsV1beta2>(map['conditions']!, (value) => DeploymentConditionPatchAppsV1beta2.fromMap((value as Map).cast<String, dynamic>()))).input(),
