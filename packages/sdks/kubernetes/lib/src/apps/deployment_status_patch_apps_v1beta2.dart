...
class DeploymentStatusPatchAppsV1beta2 {
  ...
  final pulumi.Input<List<DeploymentConditionPatchAppsV1beta2>>? conditions;
  ...
  const DeploymentStatusPatchAppsV1beta2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?pulumi.Input.mapOptionalInputValue<List<DeploymentConditionPatchAppsV1beta2>, List<Map<String, dynamic>>>(conditions, (value) => pulumi.Input.encodeList<DeploymentConditionPatchAppsV1beta2, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DeploymentStatusPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusPatchAppsV1beta2(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentConditionPatchAppsV1beta2>(guardedValue, (value) => DeploymentConditionPatchAppsV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
