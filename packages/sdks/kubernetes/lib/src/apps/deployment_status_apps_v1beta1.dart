...
class DeploymentStatusAppsV1beta1 {
  ...
  const DeploymentStatusAppsV1beta1({
  ...
  factory DeploymentStatusAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusAppsV1beta1(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentConditionAppsV1beta1>(guardedValue, (value) => DeploymentConditionAppsV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
