...
class DeploymentStatusAppsV1beta1 {
  ...
  final List<DeploymentConditionAppsV1beta1>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<DeploymentConditionAppsV1beta1, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory DeploymentStatusAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusAppsV1beta1(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<DeploymentConditionAppsV1beta1>(map['conditions'], (value) => DeploymentConditionAppsV1beta1.fromMap((value as Map).cast<String, dynamic>())),
