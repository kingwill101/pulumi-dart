...
class ReplicaSetAppsV1beta2 {
  ...
  final ReplicaSetSpecAppsV1beta2? spec;
  /// Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final ReplicaSetStatusAppsV1beta2? status;
  ...
  factory ReplicaSetAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ReplicaSetAppsV1beta2(
      ...
      status: map['status'] == null ? null : ReplicaSetStatusAppsV1beta2.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
