...
class ReplicaSetAppsV1beta2 {
  ...
  final pulumi.Input<ReplicaSetSpecAppsV1beta2>? spec;
  /// Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final pulumi.Input<ReplicaSetStatusAppsV1beta2>? status;

  /// Creates a new [ReplicaSetAppsV1beta2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': ?pulumi.Input.mapOptionalInputValue<ReplicaSetSpecAppsV1beta2, Map<String, dynamic>>(spec, (value) => value.toMap()),
      'status': ?pulumi.Input.mapOptionalInputValue<ReplicaSetStatusAppsV1beta2, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory ReplicaSetAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ReplicaSetAppsV1beta2(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicaSetSpecAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicaSetStatusAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
