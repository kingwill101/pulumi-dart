...
class DaemonSetSpecPatchAppsV1beta2 {
  ...
  final DaemonSetUpdateStrategyPatchAppsV1beta2? updateStrategy;
  ...
  factory DaemonSetSpecPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DaemonSetSpecPatchAppsV1beta2(
      ...
      updateStrategy: map['updateStrategy'] == null ? null : DaemonSetUpdateStrategyPatchAppsV1beta2.fromMap((map['updateStrategy'] as Map).cast<String, dynamic>()),
    );
  }
}
