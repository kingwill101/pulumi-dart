...
class DeploymentStatusAppsV1beta2 {
  ...
  const DeploymentStatusAppsV1beta2({
  ...
  factory DeploymentStatusAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusAppsV1beta2(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentConditionAppsV1beta2>(guardedValue, (value) => DeploymentConditionAppsV1beta2.fromMap((value as Map).cast<String, dynamic>()))); })(),
