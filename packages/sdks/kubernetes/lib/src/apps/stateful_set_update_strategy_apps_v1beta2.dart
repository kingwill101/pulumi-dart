...
class StatefulSetUpdateStrategyAppsV1beta2 {
  ...
  final pulumi.Input<RollingUpdateStatefulSetStrategyAppsV1beta2>?
  rollingUpdate;
  ...
  StatefulSetUpdateStrategyAppsV1beta2({this.rollingUpdate, this.type});
  ...
  factory StatefulSetUpdateStrategyAppsV1beta2.fromMap(
    ...
    return StatefulSetUpdateStrategyAppsV1beta2(
      rollingUpdate: (() {
        ...
        return pulumi.Input.fromValue(
          RollingUpdateStatefulSetStrategyAppsV1beta2.fromMap(
