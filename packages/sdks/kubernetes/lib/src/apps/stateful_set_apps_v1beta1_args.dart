...
class StatefulSetAppsV1beta1Args {
  ...
  const StatefulSetAppsV1beta1Args({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory StatefulSetAppsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return StatefulSetAppsV1beta1Args(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StatefulSetSpecAppsV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
