...
class StatefulSetAppsV1beta1Args {
  ...
  StatefulSetAppsV1beta1Args({
    ...
    pulumi.Output<StatefulSetSpecAppsV1beta1>? spec,
  }) :
  ...
  factory StatefulSetAppsV1beta1Args.fromMap(Map<String, dynamic> map) {
    return StatefulSetAppsV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<StatefulSetSpecAppsV1beta1>(StatefulSetSpecAppsV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
