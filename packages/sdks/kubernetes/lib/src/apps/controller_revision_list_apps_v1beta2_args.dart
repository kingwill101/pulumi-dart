...
class ControllerRevisionListAppsV1beta2Args {
  ...
  final pulumi.Input<List<ControllerRevisionAppsV1beta2>> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'items': pulumi.Input.mapInputValue<List<ControllerRevisionAppsV1beta2>, List<Map<String, dynamic>>>(items, (value) => pulumi.Input.encodeList<ControllerRevisionAppsV1beta2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'kind': ?kind,
  ...
  factory ControllerRevisionListAppsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ControllerRevisionListAppsV1beta2Args(
      ...
      items: pulumi.Input.fromValue(pulumi.Input.decodeList<ControllerRevisionAppsV1beta2>(map['items']!, (value) => ControllerRevisionAppsV1beta2.fromMap((value as Map).cast<String, dynamic>()))),
