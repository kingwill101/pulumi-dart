...
class ControllerRevisionListAppsV1beta2Args {
  ...
  ControllerRevisionListAppsV1beta2Args({
    ...
    required pulumi.Output<List<ControllerRevisionAppsV1beta2Resource>> items,
    pulumi.Output<String>? kind,
    pulumi.Output<ListMeta>? metadata,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      items = pulumi.Input.asInput<List<ControllerRevisionAppsV1beta2Resource>>(items),
  ...
  factory ControllerRevisionListAppsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return ControllerRevisionListAppsV1beta2Args(
      ...
      items: pulumi.Output.create<List<ControllerRevisionAppsV1beta2Resource>>((map['items'] as List).cast<ControllerRevisionAppsV1beta2Resource>()),
