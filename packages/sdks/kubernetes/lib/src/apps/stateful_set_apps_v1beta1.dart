...
class StatefulSetAppsV1beta1 {
  ...
  factory StatefulSetAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetAppsV1beta1(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StatefulSetStatusAppsV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
