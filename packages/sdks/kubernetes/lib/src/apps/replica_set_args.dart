...
class ReplicaSetArgs {
  ...
  ReplicaSetArgs({
    ...
    pulumi.Output<ReplicaSetSpec>? spec,
  }) :
  ...
  factory ReplicaSetArgs.fromMap(Map<String, dynamic> map) {
    return ReplicaSetArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ReplicaSetSpec>(ReplicaSetSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
