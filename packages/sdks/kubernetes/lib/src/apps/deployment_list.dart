    ...
    return <String, dynamic>{
      ...
      'items':
          ...
          >(
            items,
            (value) =>
                pulumi.Input.encodeList<DeploymentType, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DeploymentList.fromMap(Map<String, dynamic> map) {
    return DeploymentList(
      ...
      items: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeploymentType>(
          map['items']!,
          (value) =>
              DeploymentType.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      kind: (() {
