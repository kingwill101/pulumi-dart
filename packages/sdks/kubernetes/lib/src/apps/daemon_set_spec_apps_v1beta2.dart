...
class DaemonSetSpecAppsV1beta2 {
  ...
  const DaemonSetSpecAppsV1beta2({
  ...
  factory DaemonSetSpecAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DaemonSetSpecAppsV1beta2(
      ...
      updateStrategy: (() { final guardedValue = map['updateStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DaemonSetUpdateStrategyAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
