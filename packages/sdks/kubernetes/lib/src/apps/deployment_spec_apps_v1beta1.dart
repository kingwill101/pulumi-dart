...
class DeploymentSpecAppsV1beta1 {
  ...
  final pulumi.Input<DeploymentStrategyAppsV1beta1?>? strategy;
  ...
  const DeploymentSpecAppsV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rollbackTo': ?pulumi.Input.mapOptionalInputValue<RollbackConfig, Map<String, dynamic>>(rollbackTo, (value) => value.toMap()),
      'selector': ?pulumi.Input.mapOptionalInputValue<LabelSelector, Map<String, dynamic>>(selector, (value) => value.toMap()),
      'strategy': ?pulumi.Input.mapOptionalInputValue<DeploymentStrategyAppsV1beta1, Map<String, dynamic>>(strategy, (value) => value.toMap()),
  ...
  factory DeploymentSpecAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentSpecAppsV1beta1(
      ...
      rollbackTo: (() { final guardedValue = map['rollbackTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RollbackConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      strategy: (() { final guardedValue = map['strategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStrategyAppsV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
