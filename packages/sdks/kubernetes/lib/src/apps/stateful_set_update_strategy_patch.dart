...
class StatefulSetUpdateStrategyPatch {
  ...
  const StatefulSetUpdateStrategyPatch({
    this.rollingUpdate,
    this.type,
  });
  ...
  factory StatefulSetUpdateStrategyPatch.fromMap(Map<String, dynamic> map) {
    return StatefulSetUpdateStrategyPatch(
      rollingUpdate: (() { final guardedValue = map['rollingUpdate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RollingUpdateStatefulSetStrategyPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
