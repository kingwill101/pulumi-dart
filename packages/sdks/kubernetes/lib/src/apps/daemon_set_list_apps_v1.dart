...
class DaemonSetListAppsV1 extends pulumi.CustomResource {
  ...
  /// Creates a new [DaemonSetListAppsV1].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DaemonSetListAppsV1]. {@macro pulumi_apps_v1_daemon_set_list_args_doc}
  ...
  /// Creates a typed reference to an existing [DaemonSetListAppsV1] resource.
  DaemonSetListAppsV1.reference(String urn)
    : super(
        'kubernetes:apps/v1:DaemonSetList',
