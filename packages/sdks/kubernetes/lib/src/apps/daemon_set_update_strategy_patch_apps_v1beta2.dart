...
class DaemonSetUpdateStrategyPatchAppsV1beta2 {
  ...
  DaemonSetUpdateStrategyPatchAppsV1beta2({this.rollingUpdate, this.type});
  ...
  factory DaemonSetUpdateStrategyPatchAppsV1beta2.fromMap(
    ...
    return DaemonSetUpdateStrategyPatchAppsV1beta2(
      rollingUpdate: (() {
        ...
        return pulumi.Input.fromValue(
          RollingUpdateDaemonSetPatchAppsV1beta2.fromMap(
