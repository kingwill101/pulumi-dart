...
class StatefulSetSpecAppsV1beta2 {
  ...
  const StatefulSetSpecAppsV1beta2({
  ...
  factory StatefulSetSpecAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecAppsV1beta2(
      ...
      updateStrategy: (() { final guardedValue = map['updateStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StatefulSetUpdateStrategyAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
