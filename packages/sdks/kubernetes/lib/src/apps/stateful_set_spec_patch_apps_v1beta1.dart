...
class StatefulSetSpecPatchAppsV1beta1 {
  ...
  final StatefulSetUpdateStrategyPatchAppsV1beta1? updateStrategy;
  ...
  factory StatefulSetSpecPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecPatchAppsV1beta1(
      ...
      updateStrategy: map['updateStrategy'] == null ? null : StatefulSetUpdateStrategyPatchAppsV1beta1.fromMap((map['updateStrategy'] as Map).cast<String, dynamic>()),
