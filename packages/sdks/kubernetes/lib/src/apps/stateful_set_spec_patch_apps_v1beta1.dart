...
import 'stateful_set_update_strategy_patch_apps_v1beta1.dart';

/// A StatefulSetSpec is the specification of a StatefulSet.
class StatefulSetSpecPatchAppsV1beta1 {
  ...
  final pulumi.Input<StatefulSetUpdateStrategyPatchAppsV1beta1>? updateStrategy;
  ...
  /// Creates a new [StatefulSetSpecPatchAppsV1beta1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'updateStrategy': ?pulumi.Input.mapOptionalInputValue<StatefulSetUpdateStrategyPatchAppsV1beta1, Map<String, dynamic>>(updateStrategy, (value) => value.toMap()),
  ...
  factory StatefulSetSpecPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecPatchAppsV1beta1(
      ...
      updateStrategy: (() { final guardedValue = map['updateStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StatefulSetUpdateStrategyPatchAppsV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
