...
/// {@template pulumi_apps_v1_replica_set_patch_args_doc}
/// The set of arguments for ReplicaSetPatch.
/// {@endtemplate}
/// {@macro pulumi_apps_v1_replica_set_patch_args_doc}
class ReplicaSetPatchArgs {
  ...
  /// Creates a new [ReplicaSetPatchArgs].
  ...
  ReplicaSetPatchArgs({
    ...
    pulumi.Output<ReplicaSetSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<ReplicaSetSpecPatch>(spec);
  ...
  factory ReplicaSetPatchArgs.fromMap(Map<String, dynamic> map) {
    return ReplicaSetPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<ReplicaSetSpecPatch>(ReplicaSetSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
