...
class ControllerRevisionAppsV1beta1 {
  ...
  /// Creates a new [ControllerRevisionAppsV1beta1].
  ...
  const ControllerRevisionAppsV1beta1({
    this.apiVersion,
    this.data,
    this.kind,
    this.metadata,
  ...
  factory ControllerRevisionAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return ControllerRevisionAppsV1beta1(
