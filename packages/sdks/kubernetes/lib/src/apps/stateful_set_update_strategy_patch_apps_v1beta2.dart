...
class StatefulSetUpdateStrategyPatchAppsV1beta2 {
  ...
  final pulumi.Input<RollingUpdateStatefulSetStrategyPatchAppsV1beta2>?
  rollingUpdate;
  ...
  StatefulSetUpdateStrategyPatchAppsV1beta2({this.rollingUpdate, this.type});
  ...
  factory StatefulSetUpdateStrategyPatchAppsV1beta2.fromMap(
    ...
    return StatefulSetUpdateStrategyPatchAppsV1beta2(
      rollingUpdate: (() {
        ...
        return pulumi.Input.fromValue(
          RollingUpdateStatefulSetStrategyPatchAppsV1beta2.fromMap(
