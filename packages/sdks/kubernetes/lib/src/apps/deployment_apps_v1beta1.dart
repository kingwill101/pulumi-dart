...
class DeploymentAppsV1beta1 {
  ...
  factory DeploymentAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentAppsV1beta1(
      ...
      spec: map['spec'] == null ? null : (DeploymentSpecAppsV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (DeploymentStatusAppsV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
