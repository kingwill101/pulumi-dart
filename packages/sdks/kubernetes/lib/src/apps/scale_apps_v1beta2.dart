...
class ScaleAppsV1beta2 {
  ...
  factory ScaleAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return ScaleAppsV1beta2(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleSpecAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleStatusAppsV1beta2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
