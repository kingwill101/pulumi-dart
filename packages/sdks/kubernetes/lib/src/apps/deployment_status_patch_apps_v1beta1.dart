...
import 'deployment_condition_patch_apps_v1beta1.dart';

/// DeploymentStatus is the most recently observed status of the Deployment.
class DeploymentStatusPatchAppsV1beta1 {
  ...
  final pulumi.Input<List<DeploymentConditionPatchAppsV1beta1>>? conditions;
  ...
  /// Creates a new [DeploymentStatusPatchAppsV1beta1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?pulumi.Input.mapOptionalInputValue<List<DeploymentConditionPatchAppsV1beta1>, List<Map<String, dynamic>>>(conditions, (value) => pulumi.Input.encodeList<DeploymentConditionPatchAppsV1beta1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DeploymentStatusPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusPatchAppsV1beta1(
      ...
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentConditionPatchAppsV1beta1>(guardedValue, (value) => DeploymentConditionPatchAppsV1beta1.fromMap((value as Map).cast<String, dynamic>()))); })(),
