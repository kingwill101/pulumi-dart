...
class DeploymentStatusPatchAppsV1beta1 {
  ...
  final List<DeploymentConditionPatchAppsV1beta1>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<DeploymentConditionPatchAppsV1beta1, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory DeploymentStatusPatchAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return DeploymentStatusPatchAppsV1beta1(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<DeploymentConditionPatchAppsV1beta1>(map['conditions'], (value) => DeploymentConditionPatchAppsV1beta1.fromMap((value as Map).cast<String, dynamic>())),
