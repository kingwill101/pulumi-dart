...
class StatefulSetStatus {
  ...
  factory StatefulSetStatus.fromMap(Map<String, dynamic> map) {
    return StatefulSetStatus(
      ...
      conditions: map['conditions'] == null ? null : (pulumi.Input.decodeList<StatefulSetCondition>(map['conditions']!, (value) => StatefulSetCondition.fromMap((value as Map).cast<String, dynamic>()))).input(),
