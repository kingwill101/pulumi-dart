...
class StatefulSetPatchAppsV1beta2 {
  ...
  final StatefulSetSpecPatchAppsV1beta2? spec;
  /// Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
  final StatefulSetStatusPatchAppsV1beta2? status;
  ...
  factory StatefulSetPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return StatefulSetPatchAppsV1beta2(
      ...
      spec: map['spec'] == null ? null : StatefulSetSpecPatchAppsV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : StatefulSetStatusPatchAppsV1beta2.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
