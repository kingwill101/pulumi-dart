...
class DaemonSetSpecPatch {
  ...
  final pulumi.Input<DaemonSetUpdateStrategyPatch>? updateStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'updateStrategy': ?pulumi.Input.mapOptionalInputValue<DaemonSetUpdateStrategyPatch, Map<String, dynamic>>(updateStrategy, (value) => value.toMap()),
    };
  }
  ...
  factory DaemonSetSpecPatch.fromMap(Map<String, dynamic> map) {
    return DaemonSetSpecPatch(
      ...
      updateStrategy: (() { final guardedValue = map['updateStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DaemonSetUpdateStrategyPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
