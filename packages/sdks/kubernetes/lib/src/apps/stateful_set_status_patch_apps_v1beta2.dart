    ...
    return <String, dynamic>{
      ...
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatefulSetConditionPatchAppsV1beta2>,
    ...
    return StatefulSetStatusPatchAppsV1beta2(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatefulSetConditionPatchAppsV1beta2>(
            guardedValue,
            (value) => StatefulSetConditionPatchAppsV1beta2.fromMap(
