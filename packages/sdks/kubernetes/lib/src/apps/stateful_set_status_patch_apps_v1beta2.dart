...
class StatefulSetStatusPatchAppsV1beta2 {
  ...
  final List<StatefulSetConditionPatchAppsV1beta2>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<StatefulSetConditionPatchAppsV1beta2, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory StatefulSetStatusPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return StatefulSetStatusPatchAppsV1beta2(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<StatefulSetConditionPatchAppsV1beta2>(map['conditions'], (value) => StatefulSetConditionPatchAppsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
