...
class DaemonSetPatch {
  ...
  final pulumi.Input<DaemonSetStatusPatch>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<DaemonSetStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory DaemonSetPatch.fromMap(Map<String, dynamic> map) {
    return DaemonSetPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DaemonSetStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
