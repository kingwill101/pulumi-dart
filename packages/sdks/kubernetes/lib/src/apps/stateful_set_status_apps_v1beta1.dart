...
class StatefulSetStatusAppsV1beta1 {
  ...
  factory StatefulSetStatusAppsV1beta1.fromMap(Map<String, dynamic> map) {
    return StatefulSetStatusAppsV1beta1(
      ...
      conditions: map['conditions'] == null ? null : (pulumi.Input.decodeList<StatefulSetConditionAppsV1beta1>(map['conditions']!, (value) => StatefulSetConditionAppsV1beta1.fromMap((value as Map).cast<String, dynamic>()))).input(),
