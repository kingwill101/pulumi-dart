    ...
    return <String, dynamic>{
      ...
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatefulSetConditionAppsV1beta1>,
            List<Map<String, dynamic>>
          >(
            conditions,
            (value) =>
                pulumi.Input.encodeList<
                  StatefulSetConditionAppsV1beta1,
                  Map<String, dynamic>
    ...
    return StatefulSetStatusAppsV1beta1(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatefulSetConditionAppsV1beta1>(
            guardedValue,
            (value) => StatefulSetConditionAppsV1beta1.fromMap(
