...
/// {@template pulumi_apps_v1_stateful_set_patch_args_doc}
/// The set of arguments for StatefulSetPatch.
/// {@endtemplate}
/// {@macro pulumi_apps_v1_stateful_set_patch_args_doc}
class StatefulSetPatchArgs {
  ...
  /// Creates a new [StatefulSetPatchArgs].
  ...
  StatefulSetPatchArgs({
    ...
    pulumi.Output<StatefulSetSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<StatefulSetSpecPatch>(spec);
  ...
  factory StatefulSetPatchArgs.fromMap(Map<String, dynamic> map) {
    return StatefulSetPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<StatefulSetSpecPatch>(StatefulSetSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
