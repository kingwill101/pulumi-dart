...
class StatefulSetSpecPatch {
  ...
  final StatefulSetOrdinalsPatch? ordinals;
  /// persistentVolumeClaimRetentionPolicy describes the lifecycle of persistent volume claims created from volumeClaimTemplates. By default, all persistent volume claims are created as needed and retained until manually deleted. This policy allows the lifecycle to be altered, for example by deleting persistent volume claims when their stateful set is deleted, or when their pod is scaled down.
  final StatefulSetPersistentVolumeClaimRetentionPolicyPatch? persistentVolumeClaimRetentionPolicy;
  ...
  final StatefulSetUpdateStrategyPatch? updateStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ordinals': ?ordinals == null ? null : ordinals!.toMap(),
      'persistentVolumeClaimRetentionPolicy': ?persistentVolumeClaimRetentionPolicy == null ? null : persistentVolumeClaimRetentionPolicy!.toMap(),
  ...
  factory StatefulSetSpecPatch.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecPatch(
      ...
      ordinals: map['ordinals'] == null ? null : StatefulSetOrdinalsPatch.fromMap((map['ordinals'] as Map).cast<String, dynamic>()),
      persistentVolumeClaimRetentionPolicy: map['persistentVolumeClaimRetentionPolicy'] == null ? null : StatefulSetPersistentVolumeClaimRetentionPolicyPatch.fromMap((map['persistentVolumeClaimRetentionPolicy'] as Map).cast<String, dynamic>()),
      ...
      updateStrategy: map['updateStrategy'] == null ? null : StatefulSetUpdateStrategyPatch.fromMap((map['updateStrategy'] as Map).cast<String, dynamic>()),
