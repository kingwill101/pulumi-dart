...
class StatefulSetSpecPatch {
  ...
  factory StatefulSetSpecPatch.fromMap(Map<String, dynamic> map) {
    return StatefulSetSpecPatch(
      ...
      ordinals: map['ordinals'] == null ? null : (StatefulSetOrdinalsPatch.fromMap((map['ordinals'] as Map).cast<String, dynamic>())).input(),
      persistentVolumeClaimRetentionPolicy: map['persistentVolumeClaimRetentionPolicy'] == null ? null : (StatefulSetPersistentVolumeClaimRetentionPolicyPatch.fromMap((map['persistentVolumeClaimRetentionPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      updateStrategy: map['updateStrategy'] == null ? null : (StatefulSetUpdateStrategyPatch.fromMap((map['updateStrategy'] as Map).cast<String, dynamic>())).input(),
