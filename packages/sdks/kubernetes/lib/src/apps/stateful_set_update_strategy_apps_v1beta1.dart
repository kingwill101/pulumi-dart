...
class StatefulSetUpdateStrategyAppsV1beta1 {
  ...
  final pulumi.Input<RollingUpdateStatefulSetStrategyAppsV1beta1>?
  rollingUpdate;
  ...
  StatefulSetUpdateStrategyAppsV1beta1({this.rollingUpdate, this.type});
  ...
  factory StatefulSetUpdateStrategyAppsV1beta1.fromMap(
    ...
    return StatefulSetUpdateStrategyAppsV1beta1(
      rollingUpdate: (() {
        ...
        return pulumi.Input.fromValue(
          RollingUpdateStatefulSetStrategyAppsV1beta1.fromMap(
