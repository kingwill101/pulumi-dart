...
class DaemonSetStatusPatchAppsV1beta2 {
  ...
  factory DaemonSetStatusPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DaemonSetStatusPatchAppsV1beta2(
      ...
      currentNumberScheduled: (() { final guardedValue = map['currentNumberScheduled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      desiredNumberScheduled: (() { final guardedValue = map['desiredNumberScheduled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      numberMisscheduled: (() { final guardedValue = map['numberMisscheduled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      numberReady: (() { final guardedValue = map['numberReady']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
