    ...
    return <String, dynamic>{
      ...
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<DaemonSetConditionPatchAppsV1beta2>,
            List<Map<String, dynamic>>
          >(
            conditions,
            (value) =>
                pulumi.Input.encodeList<
                  DaemonSetConditionPatchAppsV1beta2,
                  Map<String, dynamic>
    ...
    return DaemonSetStatusPatchAppsV1beta2(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DaemonSetConditionPatchAppsV1beta2>(
            guardedValue,
            (value) => DaemonSetConditionPatchAppsV1beta2.fromMap(
      ...
      currentNumberScheduled: (() {
        final guardedValue = map['currentNumberScheduled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      desiredNumberScheduled: (() {
        final guardedValue = map['desiredNumberScheduled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      numberAvailable: (() {
      ...
      numberMisscheduled: (() {
        final guardedValue = map['numberMisscheduled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      numberReady: (() {
        final guardedValue = map['numberReady'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      numberUnavailable: (() {
