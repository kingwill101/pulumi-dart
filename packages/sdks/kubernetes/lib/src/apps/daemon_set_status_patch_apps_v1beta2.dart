...
class DaemonSetStatusPatchAppsV1beta2 {
  ...
  final List<DaemonSetConditionPatchAppsV1beta2>? conditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': ?conditions == null ? null : pulumi.Input.encodeList<DaemonSetConditionPatchAppsV1beta2, Map<String, dynamic>>(conditions!, (value) => value.toMap()),
  ...
  factory DaemonSetStatusPatchAppsV1beta2.fromMap(Map<String, dynamic> map) {
    return DaemonSetStatusPatchAppsV1beta2(
      ...
      conditions: map['conditions'] == null ? null : pulumi.Input.decodeList<DaemonSetConditionPatchAppsV1beta2>(map['conditions'], (value) => DaemonSetConditionPatchAppsV1beta2.fromMap((value as Map).cast<String, dynamic>())),
