...
class ReplicaSetPatch {
  ...
  final pulumi.Input<ReplicaSetSpecPatch>? spec;
  /// Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final pulumi.Input<ReplicaSetStatusPatch>? status;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': ?pulumi.Input.mapOptionalInputValue<ReplicaSetSpecPatch, Map<String, dynamic>>(spec, (value) => value.toMap()),
      'status': ?pulumi.Input.mapOptionalInputValue<ReplicaSetStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }
  ...
  factory ReplicaSetPatch.fromMap(Map<String, dynamic> map) {
    return ReplicaSetPatch(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicaSetSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicaSetStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
