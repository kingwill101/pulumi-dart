...
class ReplicaSetPatch {
  ...
  factory ReplicaSetPatch.fromMap(Map<String, dynamic> map) {
    return ReplicaSetPatch(
      ...
      spec: map['spec'] == null ? null : (ReplicaSetSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (ReplicaSetStatusPatch.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
