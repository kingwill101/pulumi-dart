...
class DeploymentAppsV1beta2Args {
  ...
  DeploymentAppsV1beta2Args({
    ...
    pulumi.Output<DeploymentSpecAppsV1beta2>? spec,
  }) :
  ...
  factory DeploymentAppsV1beta2Args.fromMap(Map<String, dynamic> map) {
    return DeploymentAppsV1beta2Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<DeploymentSpecAppsV1beta2>(DeploymentSpecAppsV1beta2.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
