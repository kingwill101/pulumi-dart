...
/// {@template pulumi_batch_v1beta1_cron_job_patch_batch_v1beta1_args_doc}
/// The set of arguments for CronJobPatch.
/// {@endtemplate}
/// {@macro pulumi_batch_v1beta1_cron_job_patch_batch_v1beta1_args_doc}
class CronJobPatchBatchV1beta1Args {
  ...
  /// Creates a new [CronJobPatchBatchV1beta1Args].
  ...
  CronJobPatchBatchV1beta1Args({
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? kind,
    pulumi.Output<ObjectMetaPatch>? metadata,
    pulumi.Output<CronJobSpecPatchBatchV1beta1>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<CronJobSpecPatchBatchV1beta1>(spec);
  ...
  factory CronJobPatchBatchV1beta1Args.fromMap(Map<String, dynamic> map) {
    return CronJobPatchBatchV1beta1Args(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CronJobSpecPatchBatchV1beta1>(CronJobSpecPatchBatchV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
