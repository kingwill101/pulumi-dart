...
class CronJobSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobTemplate': pulumi.Input.mapInputValue<JobTemplateSpec, Map<String, dynamic>>(jobTemplate, (value) => value.toMap()),
      'schedule': schedule,
  ...
  factory CronJobSpec.fromMap(Map<String, dynamic> map) {
    return CronJobSpec(
      ...
      jobTemplate: pulumi.Input.fromValue(JobTemplateSpec.fromMap((map['jobTemplate']! as Map).cast<String, dynamic>())),
