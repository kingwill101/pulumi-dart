...
class SuccessPolicy {
  ...
  final List<SuccessPolicyRule> rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'rules': pulumi.Input.encodeList<SuccessPolicyRule, Map<String, dynamic>>(rules, (value) => value.toMap()),
    };
  }

  factory SuccessPolicy.fromMap(Map<String, dynamic> map) {
    return SuccessPolicy(
      rules: pulumi.Input.decodeList<SuccessPolicyRule>(map['rules'], (value) => SuccessPolicyRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
