...
class CronJobSpecBatchV1beta1 {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobTemplate': pulumi.Input.mapInputValue<JobTemplateSpecBatchV1beta1, Map<String, dynamic>>(jobTemplate, (value) => value.toMap()),
      'schedule': schedule,
  ...
  factory CronJobSpecBatchV1beta1.fromMap(Map<String, dynamic> map) {
    return CronJobSpecBatchV1beta1(
      ...
      jobTemplate: pulumi.Input.fromValue(JobTemplateSpecBatchV1beta1.fromMap((map['jobTemplate']! as Map).cast<String, dynamic>())),
