...
class CronJobBatchV2alpha1 {
  ...
  final CronJobSpecBatchV2alpha1? spec;
  /// Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final CronJobStatusBatchV2alpha1? status;
  ...
  factory CronJobBatchV2alpha1.fromMap(Map<String, dynamic> map) {
    return CronJobBatchV2alpha1(
      ...
      status: map['status'] == null ? null : CronJobStatusBatchV2alpha1.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
