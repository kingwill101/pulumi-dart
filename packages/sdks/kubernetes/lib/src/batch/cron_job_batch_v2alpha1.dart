...
class CronJobBatchV2alpha1 {
  ...
  factory CronJobBatchV2alpha1.fromMap(Map<String, dynamic> map) {
    return CronJobBatchV2alpha1(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CronJobSpecBatchV2alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CronJobStatusBatchV2alpha1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
