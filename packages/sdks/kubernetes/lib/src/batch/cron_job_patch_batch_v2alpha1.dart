...
class CronJobPatchBatchV2alpha1 {
  ...
  factory CronJobPatchBatchV2alpha1.fromMap(Map<String, dynamic> map) {
    return CronJobPatchBatchV2alpha1(
      ...
      spec: map['spec'] == null ? null : (CronJobSpecPatchBatchV2alpha1.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (CronJobStatusPatchBatchV2alpha1.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
