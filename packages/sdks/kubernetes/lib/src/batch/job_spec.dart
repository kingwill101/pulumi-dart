...
import 'job_scheduling_configuration.dart';
...
class JobSpec {
  ...
  final pulumi.Input<JobSchedulingConfiguration?>? scheduling;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scheduling': ?pulumi.Input.mapOptionalInputValue<JobSchedulingConfiguration, Map<String, dynamic>>(scheduling, (value) => value.toMap()),
