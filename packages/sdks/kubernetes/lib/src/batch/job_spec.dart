...
import 'pod_failure_policy.dart';
import 'success_policy.dart';
...
class JobSpec {
  ...
  final pulumi.Input<PodFailurePolicy>? podFailurePolicy;
  ...
  final pulumi.Input<SuccessPolicy>? successPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'podFailurePolicy': ?pulumi.Input.mapOptionalInputValue<PodFailurePolicy, Map<String, dynamic>>(podFailurePolicy, (value) => value.toMap()),
      'podReplacementPolicy': ?podReplacementPolicy,
      'selector': ?pulumi.Input.mapOptionalInputValue<LabelSelector, Map<String, dynamic>>(selector, (value) => value.toMap()),
      'successPolicy': ?pulumi.Input.mapOptionalInputValue<SuccessPolicy, Map<String, dynamic>>(successPolicy, (value) => value.toMap()),
      'suspend': ?suspend,
  ...
  factory JobSpec.fromMap(Map<String, dynamic> map) {
    return JobSpec(
      ...
      podFailurePolicy: map['podFailurePolicy'] == null ? null : (PodFailurePolicy.fromMap((map['podFailurePolicy']! as Map).cast<String, dynamic>())).input(),
      ...
      successPolicy: map['successPolicy'] == null ? null : (SuccessPolicy.fromMap((map['successPolicy']! as Map).cast<String, dynamic>())).input(),
