...
class JobSpec {
  ...
  factory JobSpec.fromMap(Map<String, dynamic> map) {
    return JobSpec(
      ...
      podFailurePolicy: map['podFailurePolicy'] == null ? null : PodFailurePolicy.fromMap((map['podFailurePolicy'] as Map).cast<String, dynamic>()),
      ...
      successPolicy: map['successPolicy'] == null ? null : SuccessPolicy.fromMap((map['successPolicy'] as Map).cast<String, dynamic>()),
