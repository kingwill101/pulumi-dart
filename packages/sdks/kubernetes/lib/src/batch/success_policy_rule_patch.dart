...
class SuccessPolicyRulePatch {
  ...
  final pulumi.Input<String>? succeededIndexes;

  /// Creates a new [SuccessPolicyRulePatch].
  ...
  factory SuccessPolicyRulePatch.fromMap(Map<String, dynamic> map) {
    return SuccessPolicyRulePatch(
      succeededCount: (() { final guardedValue = map['succeededCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
