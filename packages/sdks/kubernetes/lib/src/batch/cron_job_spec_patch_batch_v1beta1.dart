...
class CronJobSpecPatchBatchV1beta1 {
  ...
  final JobTemplateSpecPatchBatchV1beta1? jobTemplate;
  ...
  factory CronJobSpecPatchBatchV1beta1.fromMap(Map<String, dynamic> map) {
    return CronJobSpecPatchBatchV1beta1(
      ...
      jobTemplate: map['jobTemplate'] == null ? null : JobTemplateSpecPatchBatchV1beta1.fromMap((map['jobTemplate'] as Map).cast<String, dynamic>()),
