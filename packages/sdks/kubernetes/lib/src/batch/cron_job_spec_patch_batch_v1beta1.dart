...
import 'job_template_spec_patch_batch_v1beta1.dart';

/// CronJobSpec describes how the job execution will look like and when it will actually run.
class CronJobSpecPatchBatchV1beta1 {
  ...
  final pulumi.Input<JobTemplateSpecPatchBatchV1beta1>? jobTemplate;
  ...
  /// Creates a new [CronJobSpecPatchBatchV1beta1].
  ...
  const CronJobSpecPatchBatchV1beta1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobTemplate': ?pulumi.Input.mapOptionalInputValue<JobTemplateSpecPatchBatchV1beta1, Map<String, dynamic>>(jobTemplate, (value) => value.toMap()),
      'schedule': ?schedule,
  ...
  factory CronJobSpecPatchBatchV1beta1.fromMap(Map<String, dynamic> map) {
    return CronJobSpecPatchBatchV1beta1(
      ...
      jobTemplate: (() { final guardedValue = map['jobTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateSpecPatchBatchV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
