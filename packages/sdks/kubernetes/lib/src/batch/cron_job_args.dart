...
/// {@template pulumi_batch_v1_cron_job_args_doc}
/// The set of arguments for CronJob.
/// {@endtemplate}
/// {@macro pulumi_batch_v1_cron_job_args_doc}
class CronJobArgs {
  ...
  CronJobArgs({
    ...
    pulumi.Output<CronJobSpec>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMeta>(metadata),
      spec = pulumi.Input.asOptionalInput<CronJobSpec>(spec);
  ...
  factory CronJobArgs.fromMap(Map<String, dynamic> map) {
    return CronJobArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CronJobSpec>(CronJobSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
