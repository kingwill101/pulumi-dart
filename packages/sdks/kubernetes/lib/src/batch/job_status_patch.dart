...
class JobStatusPatch {
  ...
  factory JobStatusPatch.fromMap(Map<String, dynamic> map) {
    return JobStatusPatch(
      ...
      conditions: map['conditions'] == null ? null : (pulumi.Input.decodeList<JobConditionPatch>(map['conditions']!, (value) => JobConditionPatch.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      uncountedTerminatedPods: map['uncountedTerminatedPods'] == null ? null : (UncountedTerminatedPodsPatch.fromMap((map['uncountedTerminatedPods']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
