...
class JobStatusPatch {
    ...
    return <String, dynamic>{
      ...
      'uncountedTerminatedPods':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(uncountedTerminatedPods, (value) => value.toMap()),
    };
  }
  ...
  factory JobStatusPatch.fromMap(Map<String, dynamic> map) {
    return JobStatusPatch(
      ...
      completedIndexes: (() {
        final guardedValue = map['completedIndexes'];
        if (guardedValue == null) return null;
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobConditionPatch>(
            guardedValue,
            (value) => JobConditionPatch.fromMap(
      ...
      failedIndexes: (() {
        final guardedValue = map['failedIndexes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ready: (() {
      ...
      uncountedTerminatedPods: (() {
        final guardedValue = map['uncountedTerminatedPods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UncountedTerminatedPodsPatch.fromMap(
