...
class CronJobSpecPatch {
  ...
  factory CronJobSpecPatch.fromMap(Map<String, dynamic> map) {
    return CronJobSpecPatch(
      ...
      jobTemplate: (() { final guardedValue = map['jobTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
