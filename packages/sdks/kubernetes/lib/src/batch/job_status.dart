...
class JobStatus {
  ...
  factory JobStatus.fromMap(Map<String, dynamic> map) {
    return JobStatus(
      ...
      uncountedTerminatedPods: (() { final guardedValue = map['uncountedTerminatedPods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UncountedTerminatedPods.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
