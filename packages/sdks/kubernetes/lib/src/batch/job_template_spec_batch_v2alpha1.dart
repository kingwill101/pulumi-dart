...
class JobTemplateSpecBatchV2alpha1 {
  ...
  JobTemplateSpecBatchV2alpha1({this.metadata, this.spec});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec':
          ?pulumi.Input.mapOptionalInputValue<JobSpec, Map<String, dynamic>>(
            spec,
            (value) => value.toMap(),
          ),
    };
  ...
  factory JobTemplateSpecBatchV2alpha1.fromMap(Map<String, dynamic> map) {
    return JobTemplateSpecBatchV2alpha1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobSpec.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
