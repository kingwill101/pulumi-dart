...
class JobPatch {
  ...
  final pulumi.Input<JobStatusPatch>? status;

  /// Creates a new [JobPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?pulumi.Input.mapOptionalInputValue<JobStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory JobPatch.fromMap(Map<String, dynamic> map) {
    return JobPatch(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobStatusPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
