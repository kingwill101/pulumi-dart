...
class JobTemplateSpecPatch {
  ...
  /// Creates a new [JobTemplateSpecPatch].
  ...
  JobTemplateSpecPatch({this.metadata, this.spec});
  ...
  factory JobTemplateSpecPatch.fromMap(Map<String, dynamic> map) {
    return JobTemplateSpecPatch(
      metadata: (() {
