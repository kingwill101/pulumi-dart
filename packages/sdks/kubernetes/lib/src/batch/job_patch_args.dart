...
/// {@template pulumi_batch_v1_job_patch_args_doc}
/// The set of arguments for JobPatch.
/// {@endtemplate}
/// {@macro pulumi_batch_v1_job_patch_args_doc}
class JobPatchArgs {
  ...
  JobPatchArgs({
    ...
    pulumi.Output<JobSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<JobSpecPatch>(spec);
  ...
  factory JobPatchArgs.fromMap(Map<String, dynamic> map) {
    return JobPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<JobSpecPatch>(JobSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
