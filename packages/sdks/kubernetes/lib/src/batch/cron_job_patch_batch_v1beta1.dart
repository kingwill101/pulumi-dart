...
class CronJobPatchBatchV1beta1 {
  ...
  const CronJobPatchBatchV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory CronJobPatchBatchV1beta1.fromMap(Map<String, dynamic> map) {
    return CronJobPatchBatchV1beta1(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CronJobStatusPatchBatchV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
