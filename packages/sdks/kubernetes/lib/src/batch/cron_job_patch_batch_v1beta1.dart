...
class CronJobPatchBatchV1beta1 {
  ...
  final CronJobSpecPatchBatchV1beta1? spec;
  /// Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
  final CronJobStatusPatchBatchV1beta1? status;
  ...
  factory CronJobPatchBatchV1beta1.fromMap(Map<String, dynamic> map) {
    return CronJobPatchBatchV1beta1(
      ...
      status: map['status'] == null ? null : CronJobStatusPatchBatchV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
