...
class SuccessPolicyPatch {
  ...
  final List<SuccessPolicyRulePatch>? rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'rules': ?rules == null ? null : pulumi.Input.encodeList<SuccessPolicyRulePatch, Map<String, dynamic>>(rules!, (value) => value.toMap()),
    };
  }

  factory SuccessPolicyPatch.fromMap(Map<String, dynamic> map) {
    return SuccessPolicyPatch(
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<SuccessPolicyRulePatch>(map['rules'], (value) => SuccessPolicyRulePatch.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
