...
/// {@template pulumi_batch_v1_cron_job_patch_args_doc}
/// The set of arguments for CronJobPatch.
/// {@endtemplate}
/// {@macro pulumi_batch_v1_cron_job_patch_args_doc}
class CronJobPatchArgs {
  ...
  /// Creates a new [CronJobPatchArgs].
  ...
  CronJobPatchArgs({
    ...
    pulumi.Output<CronJobSpecPatch>? spec,
  }) :
      apiVersion = pulumi.Input.asOptionalInput<String>(apiVersion),
      kind = pulumi.Input.asOptionalInput<String>(kind),
      metadata = pulumi.Input.asOptionalInput<ObjectMetaPatch>(metadata),
      spec = pulumi.Input.asOptionalInput<CronJobSpecPatch>(spec);
  ...
  factory CronJobPatchArgs.fromMap(Map<String, dynamic> map) {
    return CronJobPatchArgs(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<CronJobSpecPatch>(CronJobSpecPatch.fromMap((map['spec'] as Map).cast<String, dynamic>())),
    );
  }
}
