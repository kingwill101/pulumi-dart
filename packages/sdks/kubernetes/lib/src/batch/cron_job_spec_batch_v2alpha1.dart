...
import 'job_template_spec_batch_v2alpha1.dart';

/// CronJobSpec describes how the job execution will look like and when it will actually run.
class CronJobSpecBatchV2alpha1 {
  ...
  final pulumi.Input<JobTemplateSpecBatchV2alpha1> jobTemplate;
  ...
  /// Creates a new [CronJobSpecBatchV2alpha1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobTemplate': pulumi.Input.mapInputValue<JobTemplateSpecBatchV2alpha1, Map<String, dynamic>>(jobTemplate, (value) => value.toMap()),
      'schedule': schedule,
