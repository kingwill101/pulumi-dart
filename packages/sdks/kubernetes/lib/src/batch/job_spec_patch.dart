...
class JobSpecPatch {
  ...
  final int? backoffLimitPerIndex;
  ...
  final PodFailurePolicyPatch? podFailurePolicy;
  ...
  final SuccessPolicyPatch? successPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'podFailurePolicy': ?podFailurePolicy == null ? null : podFailurePolicy!.toMap(),
  ...
  factory JobSpecPatch.fromMap(Map<String, dynamic> map) {
    return JobSpecPatch(
      ...
      backoffLimit: map['backoffLimit'] == null ? null : map['backoffLimit'] as int,
      backoffLimitPerIndex: map['backoffLimitPerIndex'] == null ? null : map['backoffLimitPerIndex'] as int,
      completionMode: map['completionMode'] == null ? null : map['completionMode'] as String,
      completions: map['completions'] == null ? null : map['completions'] as int,
      managedBy: map['managedBy'] == null ? null : map['managedBy'] as String,
      manualSelector: map['manualSelector'] == null ? null : map['manualSelector'] as bool,
      maxFailedIndexes: map['maxFailedIndexes'] == null ? null : map['maxFailedIndexes'] as int,
      parallelism: map['parallelism'] == null ? null : map['parallelism'] as int,
      podFailurePolicy: map['podFailurePolicy'] == null ? null : PodFailurePolicyPatch.fromMap((map['podFailurePolicy'] as Map).cast<String, dynamic>()),
      podReplacementPolicy: map['podReplacementPolicy'] == null ? null : map['podReplacementPolicy'] as String,
      selector: map['selector'] == null ? null : LabelSelectorPatch.fromMap((map['selector'] as Map).cast<String, dynamic>()),
      successPolicy: map['successPolicy'] == null ? null : SuccessPolicyPatch.fromMap((map['successPolicy'] as Map).cast<String, dynamic>()),
      ...
      ttlSecondsAfterFinished: map['ttlSecondsAfterFinished'] == null ? null : map['ttlSecondsAfterFinished'] as int,
    );
  }
}
