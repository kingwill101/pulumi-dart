...
import 'pod_failure_policy_patch.dart';
import 'success_policy_patch.dart';
...
class JobSpecPatch {
  ...
  final pulumi.Input<int>? backoffLimit;
  /// Specifies the limit for the number of retries within an index before marking this index as failed. When enabled the number of failures per index is kept in the pod's batch.kubernetes.io/job-index-failure-count annotation. It can only be set when Job's completionMode=Indexed, and the Pod's restart policy is Never. The field is immutable.
  final pulumi.Input<int>? backoffLimitPerIndex;
  ...
  final pulumi.Input<PodFailurePolicyPatch>? podFailurePolicy;
  ...
  final pulumi.Input<String>? podReplacementPolicy;
  ...
  final pulumi.Input<SuccessPolicyPatch>? successPolicy;
  ...
  final pulumi.Input<int>? ttlSecondsAfterFinished;

  /// Creates a new [JobSpecPatch].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'podFailurePolicy': ?pulumi.Input.mapOptionalInputValue<PodFailurePolicyPatch, Map<String, dynamic>>(podFailurePolicy, (value) => value.toMap()),
      'podReplacementPolicy': ?podReplacementPolicy,
      'selector': ?pulumi.Input.mapOptionalInputValue<LabelSelectorPatch, Map<String, dynamic>>(selector, (value) => value.toMap()),
      'successPolicy': ?pulumi.Input.mapOptionalInputValue<SuccessPolicyPatch, Map<String, dynamic>>(successPolicy, (value) => value.toMap()),
      'suspend': ?suspend,
  ...
  factory JobSpecPatch.fromMap(Map<String, dynamic> map) {
    return JobSpecPatch(
      ...
      backoffLimit: (() { final guardedValue = map['backoffLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      backoffLimitPerIndex: (() { final guardedValue = map['backoffLimitPerIndex']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      completions: (() { final guardedValue = map['completions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      maxFailedIndexes: (() { final guardedValue = map['maxFailedIndexes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      podFailurePolicy: (() { final guardedValue = map['podFailurePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PodFailurePolicyPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      successPolicy: (() { final guardedValue = map['successPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SuccessPolicyPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ttlSecondsAfterFinished: (() { final guardedValue = map['ttlSecondsAfterFinished']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
