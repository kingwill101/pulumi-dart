...
import 'job_scheduling_configuration_patch.dart';
...
class JobSpecPatch {
  ...
  final pulumi.Input<JobSchedulingConfigurationPatch?>? scheduling;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scheduling': ?pulumi.Input.mapOptionalInputValue<JobSchedulingConfigurationPatch, Map<String, dynamic>>(scheduling, (value) => value.toMap()),
  ...
  factory JobSpecPatch.fromMap(Map<String, dynamic> map) {
    return JobSpecPatch(
      ...
      scheduling: (() { final guardedValue = map['scheduling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobSchedulingConfigurationPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
