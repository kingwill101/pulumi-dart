...
class SelfSubjectRulesReviewAuthorizationK8sIoV1beta1 {
  ...
  factory SelfSubjectRulesReviewAuthorizationK8sIoV1beta1.fromMap(
    ...
    return SelfSubjectRulesReviewAuthorizationK8sIoV1beta1(
      ...
      spec: pulumi.Input.fromValue(
        SelfSubjectRulesReviewSpecAuthorizationK8sIoV1beta1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubjectRulesReviewStatusAuthorizationK8sIoV1beta1.fromMap(
