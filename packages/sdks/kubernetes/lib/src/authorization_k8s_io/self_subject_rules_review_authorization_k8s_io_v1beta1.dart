...
class SelfSubjectRulesReviewAuthorizationK8sIoV1beta1 {
  ...
  factory SelfSubjectRulesReviewAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return SelfSubjectRulesReviewAuthorizationK8sIoV1beta1(
      ...
      spec: (SelfSubjectRulesReviewSpecAuthorizationK8sIoV1beta1.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (SubjectRulesReviewStatusAuthorizationK8sIoV1beta1.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
