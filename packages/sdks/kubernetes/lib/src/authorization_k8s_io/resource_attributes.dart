...
class ResourceAttributes {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fieldSelector': ?pulumi.Input.mapOptionalInputValue<FieldSelectorAttributes, Map<String, dynamic>>(fieldSelector, (value) => value.toMap()),
      'group': ?group,
      'labelSelector': ?pulumi.Input.mapOptionalInputValue<LabelSelectorAttributes, Map<String, dynamic>>(labelSelector, (value) => value.toMap()),
      'name': ?name,
      'namespace': ?namespace,
      'resource': ?resource,
  ...
  factory ResourceAttributes.fromMap(Map<String, dynamic> map) {
    return ResourceAttributes(
      fieldSelector: (() { final guardedValue = map['fieldSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FieldSelectorAttributes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      group: (() { final guardedValue = map['group']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      labelSelector: (() { final guardedValue = map['labelSelector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LabelSelectorAttributes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
