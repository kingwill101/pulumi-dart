...
class ResourceAttributes {
  ...
  factory ResourceAttributes.fromMap(Map<String, dynamic> map) {
    return ResourceAttributes(
      fieldSelector: map['fieldSelector'] == null ? null : (FieldSelectorAttributes.fromMap((map['fieldSelector']! as Map).cast<String, dynamic>())).input(),
      group: map['group'] == null ? null : (map['group']! as String).input(),
      labelSelector: map['labelSelector'] == null ? null : (LabelSelectorAttributes.fromMap((map['labelSelector']! as Map).cast<String, dynamic>())).input(),
