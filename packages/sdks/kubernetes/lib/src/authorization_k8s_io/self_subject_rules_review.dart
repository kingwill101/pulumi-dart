...
class SelfSubjectRulesReview {
  ...
  factory SelfSubjectRulesReview.fromMap(Map<String, dynamic> map) {
    return SelfSubjectRulesReview(
      ...
      spec: pulumi.Input.fromValue(SelfSubjectRulesReviewSpec.fromMap((map['spec']! as Map).cast<String, dynamic>())),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubjectRulesReviewStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
