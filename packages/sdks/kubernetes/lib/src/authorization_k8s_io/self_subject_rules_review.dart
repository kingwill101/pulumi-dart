...
class SelfSubjectRulesReview {
  ...
  factory SelfSubjectRulesReview.fromMap(Map<String, dynamic> map) {
    return SelfSubjectRulesReview(
      ...
      spec: SelfSubjectRulesReviewSpec.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : SubjectRulesReviewStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
