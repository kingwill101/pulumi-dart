...
class SelfSubjectAccessReviewPatchAuthorizationK8sIoV1beta1 {
  ...
  final pulumi.Input<SelfSubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1>?
  spec;

  /// Status is filled in by the server and indicates whether the request is allowed or not
  final pulumi.Input<SubjectAccessReviewStatusPatchAuthorizationK8sIoV1beta1>?
  status;
  ...
  factory SelfSubjectAccessReviewPatchAuthorizationK8sIoV1beta1.fromMap(
    ...
    return SelfSubjectAccessReviewPatchAuthorizationK8sIoV1beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SelfSubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubjectAccessReviewStatusPatchAuthorizationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
