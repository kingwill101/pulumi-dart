...
class SubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1 {
  ...
  final pulumi.Input<NonResourceAttributesPatchAuthorizationK8sIoV1beta1>?
  nonResourceAttributes;

  /// ResourceAuthorizationAttributes describes information for a resource access request
  final pulumi.Input<ResourceAttributesPatchAuthorizationK8sIoV1beta1>?
  resourceAttributes;
  ...
  factory SubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1.fromMap(
    ...
    return SubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1(
      ...
      nonResourceAttributes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NonResourceAttributesPatchAuthorizationK8sIoV1beta1.fromMap(
      ...
      resourceAttributes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceAttributesPatchAuthorizationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
