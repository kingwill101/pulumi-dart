...
class SelfSubjectAccessReview {
  ...
  factory SelfSubjectAccessReview.fromMap(Map<String, dynamic> map) {
    return SelfSubjectAccessReview(
      ...
      spec: (SelfSubjectAccessReviewSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (SubjectAccessReviewStatus.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
