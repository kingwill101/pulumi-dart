...
class LocalSubjectAccessReviewAuthorizationK8sIoV1beta1 {
  ...
  final pulumi.Input<SubjectAccessReviewStatusAuthorizationK8sIoV1beta1>?
  status;
  ...
  factory LocalSubjectAccessReviewAuthorizationK8sIoV1beta1.fromMap(
    ...
    return LocalSubjectAccessReviewAuthorizationK8sIoV1beta1(
      ...
      spec: pulumi.Input.fromValue(
        SubjectAccessReviewSpecAuthorizationK8sIoV1beta1.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubjectAccessReviewStatusAuthorizationK8sIoV1beta1.fromMap(
