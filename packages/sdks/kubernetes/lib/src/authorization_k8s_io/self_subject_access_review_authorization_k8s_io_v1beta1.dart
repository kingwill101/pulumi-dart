...
class SelfSubjectAccessReviewAuthorizationK8sIoV1beta1 {
  ...
  const SelfSubjectAccessReviewAuthorizationK8sIoV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    required this.spec,
  ...
  factory SelfSubjectAccessReviewAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return SelfSubjectAccessReviewAuthorizationK8sIoV1beta1(
      ...
      spec: pulumi.Input.fromValue(SelfSubjectAccessReviewSpecAuthorizationK8sIoV1beta1.fromMap((map['spec']! as Map).cast<String, dynamic>())),
