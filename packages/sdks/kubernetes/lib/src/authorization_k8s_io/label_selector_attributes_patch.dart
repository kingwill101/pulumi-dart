...
class LabelSelectorAttributesPatch {
  ...
  const LabelSelectorAttributesPatch({
    this.rawSelector,
    this.requirements,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requirements': ?pulumi.Input.mapOptionalInputValue<List<LabelSelectorRequirementPatch>, List<Map<String, dynamic>>>(requirements, (value) => pulumi.Input.encodeList<LabelSelectorRequirementPatch, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory LabelSelectorAttributesPatch.fromMap(Map<String, dynamic> map) {
    return LabelSelectorAttributesPatch(
      ...
      requirements: (() { final guardedValue = map['requirements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LabelSelectorRequirementPatch>(guardedValue, (value) => LabelSelectorRequirementPatch.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
