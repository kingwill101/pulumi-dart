...
class SelfSubjectAccessReviewPatch {
  ...
  factory SelfSubjectAccessReviewPatch.fromMap(Map<String, dynamic> map) {
    return SelfSubjectAccessReviewPatch(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SelfSubjectAccessReviewSpecPatch.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
