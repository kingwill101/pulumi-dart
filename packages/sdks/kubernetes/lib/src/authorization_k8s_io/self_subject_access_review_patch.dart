...
import 'self_subject_access_review_spec_patch.dart';
...
class SelfSubjectAccessReviewPatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': ?pulumi.Input.mapOptionalInputValue<SelfSubjectAccessReviewSpecPatch, Map<String, dynamic>>(spec, (value) => value.toMap()),
      'status': ?pulumi.Input.mapOptionalInputValue<SubjectAccessReviewStatusPatch, Map<String, dynamic>>(status, (value) => value.toMap()),
    };
  }

  factory SelfSubjectAccessReviewPatch.fromMap(Map<String, dynamic> map) {
    return SelfSubjectAccessReviewPatch(
      apiVersion: map['apiVersion'] == null ? null : (map['apiVersion']! as String).input(),
      kind: map['kind'] == null ? null : (map['kind']! as String).input(),
      metadata: map['metadata'] == null ? null : (ObjectMetaPatch.fromMap((map['metadata']! as Map).cast<String, dynamic>())).input(),
      spec: map['spec'] == null ? null : (SelfSubjectAccessReviewSpecPatch.fromMap((map['spec']! as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (SubjectAccessReviewStatusPatch.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
