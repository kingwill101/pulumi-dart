...
class LocalSubjectAccessReviewPatchAuthorizationK8sIoV1beta1 {
  ...
  const LocalSubjectAccessReviewPatchAuthorizationK8sIoV1beta1({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory LocalSubjectAccessReviewPatchAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return LocalSubjectAccessReviewPatchAuthorizationK8sIoV1beta1(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
