...
class LocalSubjectAccessReviewPatchAuthorizationK8sIoV1beta1 {
  ...
  final pulumi.Input<SubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1>?
  spec;
  ...
  factory LocalSubjectAccessReviewPatchAuthorizationK8sIoV1beta1.fromMap(
    ...
    return LocalSubjectAccessReviewPatchAuthorizationK8sIoV1beta1(
      ...
      spec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubjectAccessReviewSpecPatchAuthorizationK8sIoV1beta1.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
