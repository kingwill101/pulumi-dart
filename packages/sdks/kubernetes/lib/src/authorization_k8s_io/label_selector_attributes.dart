...
import '../meta/label_selector_requirement.dart';
...
class LabelSelectorAttributes {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requirements': ?requirements == null ? null : pulumi.Input.encodeList<LabelSelectorRequirement, Map<String, dynamic>>(requirements!, (value) => value.toMap()),
    };
  }
  ...
  factory LabelSelectorAttributes.fromMap(Map<String, dynamic> map) {
    return LabelSelectorAttributes(
      ...
      requirements: map['requirements'] == null ? null : pulumi.Input.decodeList<LabelSelectorRequirement>(map['requirements'], (value) => LabelSelectorRequirement.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
