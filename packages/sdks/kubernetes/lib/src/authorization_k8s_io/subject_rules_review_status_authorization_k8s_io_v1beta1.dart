...
class SubjectRulesReviewStatusAuthorizationK8sIoV1beta1 {
  ...
  final List<NonResourceRuleAuthorizationK8sIoV1beta1> nonResourceRules;
  /// ResourceRules is the list of actions the subject is allowed to perform on resources. The list ordering isn't significant, may contain duplicates, and possibly be incomplete.
  final List<ResourceRuleAuthorizationK8sIoV1beta1> resourceRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nonResourceRules': pulumi.Input.encodeList<NonResourceRuleAuthorizationK8sIoV1beta1, Map<String, dynamic>>(nonResourceRules, (value) => value.toMap()),
      'resourceRules': pulumi.Input.encodeList<ResourceRuleAuthorizationK8sIoV1beta1, Map<String, dynamic>>(resourceRules, (value) => value.toMap()),
    };
  }
  ...
  factory SubjectRulesReviewStatusAuthorizationK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return SubjectRulesReviewStatusAuthorizationK8sIoV1beta1(
      ...
      nonResourceRules: pulumi.Input.decodeList<NonResourceRuleAuthorizationK8sIoV1beta1>(map['nonResourceRules'], (value) => NonResourceRuleAuthorizationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
      resourceRules: pulumi.Input.decodeList<ResourceRuleAuthorizationK8sIoV1beta1>(map['resourceRules'], (value) => ResourceRuleAuthorizationK8sIoV1beta1.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
