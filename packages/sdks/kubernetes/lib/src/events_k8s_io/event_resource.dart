...
class EventResource extends pulumi.CustomResource {
  ...
  EventResource(
    ...
    deprecatedSource = registerOutput<EventSource>(
      'deprecatedSource',
      decoder: (raw) {
    ...
    regarding = registerOutput<ObjectReference>(
      'regarding',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
    ...
    series = registerOutput<EventSeriesEventsK8sIoV1beta1>(
      'series',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return EventSeriesEventsK8sIoV1beta1.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
