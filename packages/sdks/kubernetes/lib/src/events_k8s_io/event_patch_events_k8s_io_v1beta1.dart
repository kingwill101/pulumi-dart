...
class EventPatchEventsK8sIoV1beta1 {
  ...
  const EventPatchEventsK8sIoV1beta1({
    this.action,
    this.apiVersion,
  ...
  factory EventPatchEventsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return EventPatchEventsK8sIoV1beta1(
      ...
      series: (() { final guardedValue = map['series']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventSeriesPatchEventsK8sIoV1beta1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
