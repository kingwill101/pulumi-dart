...
class EventPatchEventsK8sIoV1beta1 {
  ...
  /// Deprecated field assuring backward compatibility with core.v1 Event type
  final EventSourcePatch? deprecatedSource;
  ...
  final ObjectReferencePatch? regarding;
  ...
  final EventSeriesPatchEventsK8sIoV1beta1? series;
  ...
  factory EventPatchEventsK8sIoV1beta1.fromMap(Map<String, dynamic> map) {
    return EventPatchEventsK8sIoV1beta1(
      ...
      deprecatedSource: map['deprecatedSource'] == null ? null : EventSourcePatch.fromMap((map['deprecatedSource'] as Map).cast<String, dynamic>()),
      ...
      regarding: map['regarding'] == null ? null : ObjectReferencePatch.fromMap((map['regarding'] as Map).cast<String, dynamic>()),
      ...
      series: map['series'] == null ? null : EventSeriesPatchEventsK8sIoV1beta1.fromMap((map['series'] as Map).cast<String, dynamic>()),
