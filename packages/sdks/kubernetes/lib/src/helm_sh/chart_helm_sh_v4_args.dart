...
class ChartHelmShV4Args {
    ...
    return <String, dynamic>{
      ...
      'postRenderer':
          ?pulumi.Input.mapOptionalInputValue<
            PostRenderer,
            Map<String, dynamic>
          >(postRenderer, (value) => value.toMap()),
      'repositoryOpts':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ChartHelmShV4Args.fromMap(Map<String, dynamic> map) {
    return ChartHelmShV4Args(
      ...
      plainHttp: (() {
        final guardedValue = map['plainHttp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      postRenderer: (() {
        final guardedValue = map['postRenderer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PostRenderer.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      repositoryOpts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RepositoryOptsHelmShV4.fromMap(
