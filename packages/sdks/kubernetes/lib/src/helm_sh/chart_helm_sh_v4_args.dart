...
class ChartHelmShV4Args {
  ...
  ChartHelmShV4Args({
    ...
    pulumi.Output<dynamic>? keyring,
    pulumi.Output<String>? name,
    pulumi.Output<String>? namespace,
    pulumi.Output<bool>? plainHttp,
    pulumi.Output<PostRenderer>? postRenderer,
    pulumi.Output<RepositoryOptsHelmShV4>? repositoryOpts,
  ...
  factory ChartHelmShV4Args.fromMap(Map<String, dynamic> map) {
    return ChartHelmShV4Args(
      ...
      keyring: map['keyring'] == null ? null : pulumi.Output.create<dynamic>(map['keyring']),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      namespace: map['namespace'] == null ? null : pulumi.Output.create<String>(map['namespace'] as String),
      plainHttp: map['plainHttp'] == null ? null : pulumi.Output.create<bool>(map['plainHttp'] as bool),
      postRenderer: map['postRenderer'] == null ? null : pulumi.Output.create<PostRenderer>(PostRenderer.fromMap((map['postRenderer'] as Map).cast<String, dynamic>())),
      repositoryOpts: map['repositoryOpts'] == null ? null : pulumi.Output.create<RepositoryOptsHelmShV4>(RepositoryOptsHelmShV4.fromMap((map['repositoryOpts'] as Map).cast<String, dynamic>())),
