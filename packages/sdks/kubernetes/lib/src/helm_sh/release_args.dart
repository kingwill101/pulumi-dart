...
class ReleaseArgs {
  ...
  factory ReleaseArgs.fromMap(Map<String, dynamic> map) {
    return ReleaseArgs(
      allowNullValues: (() { final guardedValue = map['allowNullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      cleanupOnFail: (() { final guardedValue = map['cleanupOnFail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      createNamespace: (() { final guardedValue = map['createNamespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      disableCRDHooks: (() { final guardedValue = map['disableCRDHooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      disableOpenapiValidation: (() { final guardedValue = map['disableOpenapiValidation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      disableWebhooks: (() { final guardedValue = map['disableWebhooks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      maxHistory: (() { final guardedValue = map['maxHistory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      recreatePods: (() { final guardedValue = map['recreatePods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      renderSubchartNotes: (() { final guardedValue = map['renderSubchartNotes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
