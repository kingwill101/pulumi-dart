...
Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/kubernetes/)
Upstream repository: [https://github.com/pulumi/pulumi-kubernetes](https://github.com/pulumi/pulumi-kubernetes)
...
~~~sh
dart pub add pulumi_kubernetes
~~~
