...
class UpstreamTemplateResponse {
  ...
  factory UpstreamTemplateResponse.fromMap(Map<String, dynamic> map) {
    return UpstreamTemplateResponse(
      ...
      categoryPattern: map['categoryPattern'] == null ? null : map['categoryPattern'] as String,
      eventPattern: map['eventPattern'] == null ? null : map['eventPattern'] as String,
      hubPattern: map['hubPattern'] == null ? null : map['hubPattern'] as String,
