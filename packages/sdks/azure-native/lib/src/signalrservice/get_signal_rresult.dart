...
class GetSignalRResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'features': ?features == null ? null : pulumi.Input.encodeList<SignalRFeatureResponse, Map<String, dynamic>>(features!, (value) => value.toMap()),
      'hostName': hostName,
      ...
      'serverless': ?serverless == null ? null : serverless!.toMap(),
      ...
      'type': type,
      'upstream': ?upstream == null ? null : upstream!.toMap(),
      'version': version,
    };
  }
  ...
  factory GetSignalRResult.fromMap(Map<String, dynamic> map) {
    return GetSignalRResult(
      ...
      cors: map['cors'] == null ? null : SignalRCorsSettingsResponse.fromMap((map['cors']! as Map).cast<String, dynamic>()),
      ...
      features: map['features'] == null ? null : pulumi.Input.decodeList<SignalRFeatureResponse>(map['features']!, (value) => SignalRFeatureResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      networkACLs: map['networkACLs'] == null ? null : SignalRNetworkACLsResponse.fromMap((map['networkACLs']! as Map).cast<String, dynamic>()),
      ...
      serverless: map['serverless'] == null ? null : ServerlessSettingsResponse.fromMap((map['serverless']! as Map).cast<String, dynamic>()),
      ...
      tls: map['tls'] == null ? null : SignalRTlsSettingsResponse.fromMap((map['tls']! as Map).cast<String, dynamic>()),
      type: map['type'] as String,
      upstream: map['upstream'] == null ? null : ServerlessUpstreamSettingsResponse.fromMap((map['upstream']! as Map).cast<String, dynamic>()),
