...
class UpstreamAuthSettingsResponse {
  ...
  factory UpstreamAuthSettingsResponse.fromMap(Map<String, dynamic> map) {
    return UpstreamAuthSettingsResponse(
      managedIdentity: (() { final guardedValue = map['managedIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedIdentitySettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
