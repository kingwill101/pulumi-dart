    ...
    return <String, dynamic>{
      ...
      'features':
          ...
          >(
            features,
            (value) =>
                pulumi.Input.encodeList<SignalRFeature, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'liveTraceConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            LiveTraceConfiguration,
            Map<String, dynamic>
          >(liveTraceConfiguration, (value) => value.toMap()),
      'location': ?location,
      'networkACLs':
          ?pulumi.Input.mapOptionalInputValue<
            SignalRNetworkACLs,
      ...
      'resourceLogConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceLogConfiguration,
            Map<String, dynamic>
          >(resourceLogConfiguration, (value) => value.toMap()),
  ...
  factory SignalRArgs.fromMap(Map<String, dynamic> map) {
    return SignalRArgs(
      ...
      features: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SignalRFeature>(
            guardedValue,
            (value) =>
                SignalRFeature.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      identity: (() {
      ...
      liveTraceConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LiveTraceConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      resourceLogConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceLogConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      upstream: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServerlessUpstreamSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
