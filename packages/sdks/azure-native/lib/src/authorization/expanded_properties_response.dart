...
class ExpandedPropertiesResponse {
  ...
  ExpandedPropertiesResponse({this.principal, this.roleDefinition, this.scope});
    ...
    return ExpandedPropertiesResponse(
      principal: (() {
        ...
        return pulumi.Input.fromValue(
          ExpandedPropertiesResponsePrincipal.fromMap(
      ...
      roleDefinition: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpandedPropertiesResponseRoleDefinition.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      scope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpandedPropertiesResponseScope.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
