...
class ParameterDefinitionsValueResponseMetadata {
  ...
  const ParameterDefinitionsValueResponseMetadata({
  ...
  factory ParameterDefinitionsValueResponseMetadata.fromMap(Map<String, dynamic> map) {
    return ParameterDefinitionsValueResponseMetadata(
      assignPermissions: (() { final guardedValue = map['assignPermissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
