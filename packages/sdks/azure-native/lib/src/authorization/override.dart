...
class Override {
  ...
  Override({this.kind, this.selectors, this.value});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'selectors':
          ...
          >(
            selectors,
            (value) => pulumi.Input.encodeList<Selector, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return Override(
      ...
      selectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Selector>(
            guardedValue,
            (value) => Selector.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      value: (() {
