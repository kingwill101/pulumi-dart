...
class GetScopeAccessReviewScheduleDefinitionByIdResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'backupReviewers': ?(() {
        final guardedValue = backupReviewers;
  ...
  factory GetScopeAccessReviewScheduleDefinitionByIdResult.fromMap(
    ...
    return GetScopeAccessReviewScheduleDefinitionByIdResult(
      ...
      backupReviewers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<AccessReviewReviewerResponse>(
          guardedValue,
      ...
      instances: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<AccessReviewInstanceResponse>(
          guardedValue,
          (value) => AccessReviewInstanceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      scope: AccessReviewScopeResponse.fromMap(
