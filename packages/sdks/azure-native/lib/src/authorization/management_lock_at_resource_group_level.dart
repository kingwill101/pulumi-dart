...
/// }
///
/// resource "azure-native_authorization_managementlockatresourcegrouplevel" "managementLockAtResourceGroupLevel" {
///   level               = "ReadOnly"
///   lock_name           = "testlock"
...
class ManagementLockAtResourceGroupLevel extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ManagementLockAtResourceGroupLevel] resource.
  ManagementLockAtResourceGroupLevel.reference(String urn)
    : super(
        'azure-native:authorization:ManagementLockAtResourceGroupLevel',
