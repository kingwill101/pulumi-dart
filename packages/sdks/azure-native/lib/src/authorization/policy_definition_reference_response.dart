...
class PolicyDefinitionReferenceResponse {
  ...
  factory PolicyDefinitionReferenceResponse.fromMap(Map<String, dynamic> map) {
    return PolicyDefinitionReferenceResponse(
      ...
      effectiveDefinitionVersion: pulumi.Input.fromValue(
        map['effectiveDefinitionVersion'] as String,
      ),
      groupNames: (() {
      ...
      latestDefinitionVersion: pulumi.Input.fromValue(
        map['latestDefinitionVersion'] as String,
      ),
      parameters: (() {
        final guardedValue = map['parameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ParameterValuesValueResponse>(
            guardedValue,
