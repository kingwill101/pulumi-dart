...
/// Result data returned by getPolicyDefinition.
class GetPolicyDefinitionResult {
  ...
  /// Creates a new [GetPolicyDefinitionResult].
  ...
  const GetPolicyDefinitionResult({
  ...
  factory GetPolicyDefinitionResult.fromMap(Map<String, dynamic> map) {
