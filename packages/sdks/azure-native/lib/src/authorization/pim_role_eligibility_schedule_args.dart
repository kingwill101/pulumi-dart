...
class PimRoleEligibilityScheduleArgs {
  ...
  final pulumi.Input<RoleEligibilityScheduleRequestPropertiesScheduleInfo>?
  scheduleInfo;
  ...
  final pulumi.Input<RoleEligibilityScheduleRequestPropertiesTicketInfo>?
  ticketInfo;
    ...
    return PimRoleEligibilityScheduleArgs(
      ...
      scheduleInfo: (() {
        ...
        return pulumi.Input.fromValue(
          RoleEligibilityScheduleRequestPropertiesScheduleInfo.fromMap(
      ...
      ticketInfo: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoleEligibilityScheduleRequestPropertiesTicketInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
