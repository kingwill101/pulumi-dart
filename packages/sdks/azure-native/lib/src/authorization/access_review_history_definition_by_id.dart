...
class AccessReviewHistoryDefinitionById extends pulumi.CustomResource {
  ...
  AccessReviewHistoryDefinitionById(
    ...
    this.decisions = registerOutput<List<String>?>('decisions');
    this.displayName = registerOutput<String?>('displayName');
    this.instances = registerOutput<List<AccessReviewHistoryInstanceResponse>?>('instances');
    ...
    this.reviewHistoryPeriodEndDateTime = registerOutput<String>('reviewHistoryPeriodEndDateTime');
    this.reviewHistoryPeriodStartDateTime = registerOutput<String>('reviewHistoryPeriodStartDateTime');
    this.scopes = registerOutput<List<AccessReviewScopeResponse>?>('scopes');
