...
class AccessReviewScopeResponse {
  ...
  factory AccessReviewScopeResponse.fromMap(Map<String, dynamic> map) {
    return AccessReviewScopeResponse(
      assignmentState: pulumi.Input.fromValue(map['assignmentState'] as String),
      excludeResourceId: (() { final guardedValue = map['excludeResourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      excludeRoleDefinitionId: (() { final guardedValue = map['excludeRoleDefinitionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      expandNestedMemberships: (() { final guardedValue = map['expandNestedMemberships']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
