...
class GetScopeAccessReviewHistoryDefinitionByIdResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'instances': ?instances == null ? null : pulumi.Input.encodeList<AccessReviewHistoryInstanceResponse, Map<String, dynamic>>(instances!, (value) => value.toMap()),
      'interval': ?interval,
      'name': name,
      ...
      'scopes': ?scopes == null ? null : pulumi.Input.encodeList<AccessReviewScopeResponse, Map<String, dynamic>>(scopes!, (value) => value.toMap()),
      'status': status,
      'type': type,
  ...
  factory GetScopeAccessReviewHistoryDefinitionByIdResult.fromMap(Map<String, dynamic> map) {
    return GetScopeAccessReviewHistoryDefinitionByIdResult(
      ...
      decisions: map['decisions'] == null ? null : (map['decisions']! as List).cast<String>(),
      displayName: map['displayName'] == null ? null : map['displayName']! as String,
      id: map['id'] as String,
      instances: map['instances'] == null ? null : pulumi.Input.decodeList<AccessReviewHistoryInstanceResponse>(map['instances']!, (value) => AccessReviewHistoryInstanceResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      scopes: map['scopes'] == null ? null : pulumi.Input.decodeList<AccessReviewScopeResponse>(map['scopes']!, (value) => AccessReviewScopeResponse.fromMap((value as Map).cast<String, dynamic>())),
