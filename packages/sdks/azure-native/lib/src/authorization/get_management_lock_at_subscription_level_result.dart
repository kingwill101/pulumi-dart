...
/// Result data returned by getManagementLockAtSubscriptionLevel.
class GetManagementLockAtSubscriptionLevelResult {
  ...
  /// Creates a new [GetManagementLockAtSubscriptionLevelResult].
  ...
  const GetManagementLockAtSubscriptionLevelResult({
  ...
  factory GetManagementLockAtSubscriptionLevelResult.fromMap(Map<String, dynamic> map) {
