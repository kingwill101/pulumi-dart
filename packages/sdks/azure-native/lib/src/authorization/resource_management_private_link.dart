...
/// }
///
/// resource "azure-native_authorization_resourcemanagementprivatelink" "resourceManagementPrivateLink" {
///   location            = "eastus"
...
class ResourceManagementPrivateLink extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ResourceManagementPrivateLink] resource.
  ResourceManagementPrivateLink.reference(String urn)
    : super(
        'azure-native:authorization:ResourceManagementPrivateLink',
