...
class ScopeAccessReviewScheduleDefinitionByIdArgs {
  ...
  factory ScopeAccessReviewScheduleDefinitionByIdArgs.fromMap(Map<String, dynamic> map) {
    return ScopeAccessReviewScheduleDefinitionByIdArgs(
      ...
      recommendationLookBackDuration: (() { final guardedValue = map['recommendationLookBackDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      recommendationsEnabled: (() { final guardedValue = map['recommendationsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
