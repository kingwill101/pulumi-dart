...
class ScopeAccessReviewScheduleDefinitionByIdArgs {
  ...
  factory ScopeAccessReviewScheduleDefinitionByIdArgs.fromMap(Map<String, dynamic> map) {
    return ScopeAccessReviewScheduleDefinitionByIdArgs(
      autoApplyDecisionsEnabled: map['autoApplyDecisionsEnabled'] == null ? null : (map['autoApplyDecisionsEnabled']! as bool).input(),
      ...
      defaultDecision: map['defaultDecision'] == null ? null : (map['defaultDecision']! as String).input(),
      defaultDecisionEnabled: map['defaultDecisionEnabled'] == null ? null : (map['defaultDecisionEnabled']! as bool).input(),
      descriptionForAdmins: map['descriptionForAdmins'] == null ? null : (map['descriptionForAdmins']! as String).input(),
      descriptionForReviewers: map['descriptionForReviewers'] == null ? null : (map['descriptionForReviewers']! as String).input(),
      ...
      instanceDurationInDays: map['instanceDurationInDays'] == null ? null : (map['instanceDurationInDays']! as int).input(),
      instances: map['instances'] == null ? null : (pulumi.Input.decodeList<AccessReviewInstance>(map['instances']!, (value) => AccessReviewInstance.fromMap((value as Map).cast<String, dynamic>()))).input(),
      interval: map['interval'] == null ? null : (map['interval']! as int).input(),
      justificationRequiredOnApproval: map['justificationRequiredOnApproval'] == null ? null : (map['justificationRequiredOnApproval']! as bool).input(),
      mailNotificationsEnabled: map['mailNotificationsEnabled'] == null ? null : (map['mailNotificationsEnabled']! as bool).input(),
      range: map['range'] == null ? null : (AccessReviewRecurrenceRange.fromMap((map['range']! as Map).cast<String, dynamic>())).input(),
      recommendationLookBackDuration: map['recommendationLookBackDuration'] == null ? null : (map['recommendationLookBackDuration']! as String).input(),
      recommendationsEnabled: map['recommendationsEnabled'] == null ? null : (map['recommendationsEnabled']! as bool).input(),
      reminderNotificationsEnabled: map['reminderNotificationsEnabled'] == null ? null : (map['reminderNotificationsEnabled']! as bool).input(),
      ...
      scheduleDefinitionId: map['scheduleDefinitionId'] == null ? null : (map['scheduleDefinitionId']! as String).input(),
