...
class OverrideResponse {
  ...
  OverrideResponse({this.kind, this.selectors, this.value});
    ...
    return <String, dynamic>{
      ...
      'selectors':
          ...
          >(
            selectors,
            (value) =>
                pulumi.Input.encodeList<SelectorResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return OverrideResponse(
      ...
      selectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SelectorResponse>(
            guardedValue,
            (value) => SelectorResponse.fromMap(
