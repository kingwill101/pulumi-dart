...
class PolicyAssignmentPropertiesPolicyResponse {
  ...
  const PolicyAssignmentPropertiesPolicyResponse({
    this.id,
  ...
  factory PolicyAssignmentPropertiesPolicyResponse.fromMap(Map<String, dynamic> map) {
    return PolicyAssignmentPropertiesPolicyResponse(
