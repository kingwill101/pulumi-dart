...
/// }
///
/// resource "azure-native_authorization_policysetdefinitionatmanagementgroup" "policySetDefinitionAtManagementGroup" {
///   description         = "Policies to enforce low cost storage SKUs"
...
class PolicySetDefinitionAtManagementGroup extends pulumi.CustomResource {
  ...
  PolicySetDefinitionAtManagementGroup(
    ...
    versions = registerOutput<List<String>?>('versions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
  }

  /// Creates a typed reference to an existing [PolicySetDefinitionAtManagementGroup] resource.
  PolicySetDefinitionAtManagementGroup.reference(String urn)
    : super(
        'azure-native:authorization:PolicySetDefinitionAtManagementGroup',
