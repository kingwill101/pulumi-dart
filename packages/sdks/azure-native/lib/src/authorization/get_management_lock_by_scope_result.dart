...
/// Result data returned by getManagementLockByScope.
class GetManagementLockByScopeResult {
  ...
  /// Creates a new [GetManagementLockByScopeResult].
  ...
  factory GetManagementLockByScopeResult.fromMap(Map<String, dynamic> map) {
