...
class ScopeAccessReviewScheduleDefinitionById extends pulumi.CustomResource {
  ...
  ScopeAccessReviewScheduleDefinitionById(
    ...
    autoApplyDecisionsEnabled = registerOutput<bool?>(
      'autoApplyDecisionsEnabled',
    );
    azureApiVersion = registerOutput<String>('azureApiVersion');
    backupReviewers = registerOutput<List<Map<String, dynamic>>?>(
      'backupReviewers',
    );
    ...
    descriptionForReviewers = registerOutput<String?>(
    ...
    justificationRequiredOnApproval = registerOutput<bool?>(
      'justificationRequiredOnApproval',
    );
    mailNotificationsEnabled = registerOutput<bool?>(
    ...
    reminderNotificationsEnabled = registerOutput<bool?>(
