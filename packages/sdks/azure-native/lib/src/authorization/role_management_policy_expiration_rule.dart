...
class RoleManagementPolicyExpirationRule {
  ...
  factory RoleManagementPolicyExpirationRule.fromMap(Map<String, dynamic> map) {
    return RoleManagementPolicyExpirationRule(
      exceptionMembers: (() { final guardedValue = map['exceptionMembers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserSet>(guardedValue, (value) => UserSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
