...
class PolicyAssignmentArgs {
  ...
  PolicyAssignmentArgs({
    ...
    pulumi.Output<String>? definitionVersion,
    ...
    pulumi.Output<List<NonComplianceMessage>>? nonComplianceMessages,
    pulumi.Output<List<String>>? notScopes,
    pulumi.Output<List<Override>>? overrides,
    pulumi.Output<Map<String, ParameterValuesValue>>? parameters,
    pulumi.Output<String>? policyAssignmentName,
  ...
  factory PolicyAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return PolicyAssignmentArgs(
      ...
      definitionVersion: map['definitionVersion'] == null ? null : pulumi.Output.create<String>(map['definitionVersion'] as String),
      ...
      nonComplianceMessages: map['nonComplianceMessages'] == null ? null : pulumi.Output.create<List<NonComplianceMessage>>(pulumi.Input.decodeList<NonComplianceMessage>(map['nonComplianceMessages'], (value) => NonComplianceMessage.fromMap((value as Map).cast<String, dynamic>()))),
      notScopes: map['notScopes'] == null ? null : pulumi.Output.create<List<String>>((map['notScopes'] as List).cast<String>()),
      overrides: map['overrides'] == null ? null : pulumi.Output.create<List<Override>>(pulumi.Input.decodeList<Override>(map['overrides'], (value) => Override.fromMap((value as Map).cast<String, dynamic>()))),
      parameters: map['parameters'] == null ? null : pulumi.Output.create<Map<String, ParameterValuesValue>>(pulumi.Input.decodeMapValues<ParameterValuesValue>(map['parameters'], (value) => ParameterValuesValue.fromMap((value as Map).cast<String, dynamic>()))),
      policyAssignmentName: map['policyAssignmentName'] == null ? null : pulumi.Output.create<String>(map['policyAssignmentName'] as String),
