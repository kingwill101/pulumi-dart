...
/// }
///
/// resource "azure-native_authorization_managementlockbyscope" "managementLockByScope" {
///   level     = "ReadOnly"
///   lock_name = "testlock"
///   scope     = "subscriptions/subscriptionId"
/// }
...
class ManagementLockByScope extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ManagementLockByScope] resource.
  ManagementLockByScope.reference(String urn)
    : super(
        'azure-native:authorization:ManagementLockByScope',
