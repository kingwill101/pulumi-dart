...
class GetPolicyAssignmentResult {
  ...
  GetPolicyAssignmentResult({
    ...
    this.description,
    this.displayName,
    this.effectiveDefinitionVersion,
    String? enforcementMode,
    this.id,
    this.identity,
    this.instanceId,
    this.latestDefinitionVersion,
    this.location,
    this.metadata,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadata': ?metadata,
      'name': ?name,
      'nonComplianceMessages': ?(() { final guardedValue = nonComplianceMessages; if (guardedValue == null) return null; return pulumi.Input.encodeList<NonComplianceMessageResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'notScopes': ?notScopes,
      'overrides': ?(() { final guardedValue = overrides; if (guardedValue == null) return null; return pulumi.Input.encodeList<OverrideResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'parameters': ?(() { final guardedValue = parameters; if (guardedValue == null) return null; return pulumi.Input.encodeMapValues<ParameterValuesValueResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetPolicyAssignmentResult.fromMap(Map<String, dynamic> map) {
    return GetPolicyAssignmentResult(
      assignmentType: (() { final guardedValue = map['assignmentType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      azureApiVersion: (() { final guardedValue = map['azureApiVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      definitionVersion: (() { final guardedValue = map['definitionVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return guardedValue as String; })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      effectiveDefinitionVersion: (() { final guardedValue = map['effectiveDefinitionVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      enforcementMode: (() { final guardedValue = map['enforcementMode']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      latestDefinitionVersion: (() { final guardedValue = map['latestDefinitionVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      nonComplianceMessages: (() { final guardedValue = map['nonComplianceMessages']; if (guardedValue == null) return null; return pulumi.Input.decodeList<NonComplianceMessageResponse>(guardedValue, (value) => NonComplianceMessageResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      notScopes: (() { final guardedValue = map['notScopes']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      overrides: (() { final guardedValue = map['overrides']; if (guardedValue == null) return null; return pulumi.Input.decodeList<OverrideResponse>(guardedValue, (value) => OverrideResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.decodeMapValues<ParameterValuesValueResponse>(guardedValue, (value) => ParameterValuesValueResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
