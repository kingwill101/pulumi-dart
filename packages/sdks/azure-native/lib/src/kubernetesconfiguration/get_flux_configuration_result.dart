...
class GetFluxConfigurationResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bucket': ?bucket == null ? null : bucket!.toMap(),
      'complianceState': complianceState,
      'configurationProtectedSettings': ?configurationProtectedSettings,
      'errorMessage': errorMessage,
      'gitRepository': ?gitRepository == null ? null : gitRepository!.toMap(),
      'id': id,
      'kustomizations': ?kustomizations == null ? null : pulumi.Input.encodeMapValues<KustomizationDefinitionResponse, Map<String, dynamic>>(kustomizations!, (value) => value.toMap()),
      'name': name,
      'namespace': ?namespace,
  ...
  factory GetFluxConfigurationResult.fromMap(Map<String, dynamic> map) {
    return GetFluxConfigurationResult(
      ...
      azureBlob: map['azureBlob'] == null ? null : AzureBlobDefinitionResponse.fromMap((map['azureBlob']! as Map).cast<String, dynamic>()),
      bucket: map['bucket'] == null ? null : BucketDefinitionResponse.fromMap((map['bucket']! as Map).cast<String, dynamic>()),
      ...
      gitRepository: map['gitRepository'] == null ? null : GitRepositoryDefinitionResponse.fromMap((map['gitRepository']! as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      kustomizations: map['kustomizations'] == null ? null : pulumi.Input.decodeMapValues<KustomizationDefinitionResponse>(map['kustomizations']!, (value) => KustomizationDefinitionResponse.fromMap((value as Map).cast<String, dynamic>())),
