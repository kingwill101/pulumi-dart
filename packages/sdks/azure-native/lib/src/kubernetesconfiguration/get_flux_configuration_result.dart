...
class GetFluxConfigurationResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'kustomizations': ?(() {
        final guardedValue = kustomizations;
  ...
  factory GetFluxConfigurationResult.fromMap(Map<String, dynamic> map) {
    return GetFluxConfigurationResult(
      ...
      kustomizations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeMapValues<KustomizationDefinitionResponse>(
          guardedValue,
      ...
      statuses: pulumi.Input.decodeList<ObjectStatusDefinitionResponse>(
        map['statuses']!,
        (value) => ObjectStatusDefinitionResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      suspend: (() {
