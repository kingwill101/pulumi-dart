...
class ObjectStatusDefinitionResponse {
  ...
  factory ObjectStatusDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return ObjectStatusDefinitionResponse(
      appliedBy: (() { final guardedValue = map['appliedBy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectReferenceDefinitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      helmReleaseProperties: (() { final guardedValue = map['helmReleaseProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HelmReleasePropertiesDefinitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kind: (() { final guardedValue = map['kind']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      namespace: (() { final guardedValue = map['namespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      statusConditions: (() { final guardedValue = map['statusConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ObjectStatusConditionDefinitionResponse>(guardedValue, (value) => ObjectStatusConditionDefinitionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
