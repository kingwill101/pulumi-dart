...
class PostBuildDefinition {
  ...
  factory PostBuildDefinition.fromMap(Map<String, dynamic> map) {
    return PostBuildDefinition(
      ...
      substituteFrom: (() { final guardedValue = map['substituteFrom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubstituteFromDefinition>(guardedValue, (value) => SubstituteFromDefinition.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
