    ...
    return <String, dynamic>{
      'aksAssignedIdentity':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(aksAssignedIdentity, (value) => value.toMap()),
      ...
      'statuses':
          ...
          >(
            statuses,
            (value) =>
                pulumi.Input.encodeList<ExtensionStatus, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ExtensionArgs(
      aksAssignedIdentity: (() {
        ...
        return pulumi.Input.fromValue(
          ExtensionAksAssignedIdentity.fromMap(
      ...
      statuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExtensionStatus>(
            guardedValue,
            (value) =>
                ExtensionStatus.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      version: (() {
