...
class FluxConfigurationArgs {
  ...
  FluxConfigurationArgs({
    pulumi.Output<AzureBlobDefinition>? azureBlob,
    pulumi.Output<BucketDefinition>? bucket,
    ...
    pulumi.Output<String>? fluxConfigurationName,
    pulumi.Output<GitRepositoryDefinition>? gitRepository,
    pulumi.Output<Map<String, KustomizationDefinition>>? kustomizations,
    pulumi.Output<String>? namespace,
    pulumi.Output<String>? reconciliationWaitDuration,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? scope,
    pulumi.Output<String>? sourceKind,
    pulumi.Output<bool>? suspend,
    pulumi.Output<bool>? waitForReconciliation,
  }) :
  ...
  factory FluxConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return FluxConfigurationArgs(
      azureBlob: map['azureBlob'] == null ? null : pulumi.Output.create<AzureBlobDefinition>(AzureBlobDefinition.fromMap((map['azureBlob'] as Map).cast<String, dynamic>())),
      bucket: map['bucket'] == null ? null : pulumi.Output.create<BucketDefinition>(BucketDefinition.fromMap((map['bucket'] as Map).cast<String, dynamic>())),
      ...
      fluxConfigurationName: map['fluxConfigurationName'] == null ? null : pulumi.Output.create<String>(map['fluxConfigurationName'] as String),
      gitRepository: map['gitRepository'] == null ? null : pulumi.Output.create<GitRepositoryDefinition>(GitRepositoryDefinition.fromMap((map['gitRepository'] as Map).cast<String, dynamic>())),
      kustomizations: map['kustomizations'] == null ? null : pulumi.Output.create<Map<String, KustomizationDefinition>>(pulumi.Input.decodeMapValues<KustomizationDefinition>(map['kustomizations'], (value) => KustomizationDefinition.fromMap((value as Map).cast<String, dynamic>()))),
      namespace: map['namespace'] == null ? null : pulumi.Output.create<String>(map['namespace'] as String),
      reconciliationWaitDuration: map['reconciliationWaitDuration'] == null ? null : pulumi.Output.create<String>(map['reconciliationWaitDuration'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      scope: map['scope'] == null ? null : pulumi.Output.create<String>(map['scope'] as String),
      sourceKind: map['sourceKind'] == null ? null : pulumi.Output.create<String>(map['sourceKind'] as String),
      suspend: map['suspend'] == null ? null : pulumi.Output.create<bool>(map['suspend'] as bool),
      waitForReconciliation: map['waitForReconciliation'] == null ? null : pulumi.Output.create<bool>(map['waitForReconciliation'] as bool),
    );
  }
}
