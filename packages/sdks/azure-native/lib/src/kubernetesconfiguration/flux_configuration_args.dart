...
class FluxConfigurationArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kustomizations':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, KustomizationDefinition>,
  ...
  factory FluxConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return FluxConfigurationArgs(
      ...
      fluxConfigurationName: (() {
        final guardedValue = map['fluxConfigurationName'];
        if (guardedValue == null) return null;
      ...
      gitRepository: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GitRepositoryDefinition.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      kustomizations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<KustomizationDefinition>(
            guardedValue,
            (value) => KustomizationDefinition.fromMap(
      ...
      reconciliationWaitDuration: (() {
        final guardedValue = map['reconciliationWaitDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      sourceKind: (() {
        final guardedValue = map['sourceKind'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      suspend: (() {
      ...
      waitForReconciliation: (() {
        final guardedValue = map['waitForReconciliation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
