...
class AzureBlobDefinition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'managedIdentity': ?pulumi.Input.mapOptionalInputValue<ManagedIdentityDefinition, Map<String, dynamic>>(managedIdentity, (value) => value.toMap()),
      'sasToken': ?sasToken,
      'servicePrincipal': ?pulumi.Input.mapOptionalInputValue<ServicePrincipalDefinition, Map<String, dynamic>>(servicePrincipal, (value) => value.toMap()),
  ...
  factory AzureBlobDefinition.fromMap(Map<String, dynamic> map) {
    return AzureBlobDefinition(
      ...
      managedIdentity: (() { final guardedValue = map['managedIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedIdentityDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      servicePrincipal: (() { final guardedValue = map['servicePrincipal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServicePrincipalDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
