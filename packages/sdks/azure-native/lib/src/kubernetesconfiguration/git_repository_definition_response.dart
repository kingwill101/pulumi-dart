...
class GitRepositoryDefinitionResponse {
  ...
  final RepositoryRefDefinitionResponse? repositoryRef;
  ...
  factory GitRepositoryDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return GitRepositoryDefinitionResponse(
      ...
      repositoryRef: map['repositoryRef'] == null ? null : RepositoryRefDefinitionResponse.fromMap((map['repositoryRef'] as Map).cast<String, dynamic>()),
