...
class GetPrivateLinkScopeResult {
  ...
  final KubernetesConfigurationPrivateLinkScopePropertiesResponse? properties;
  ...
  factory GetPrivateLinkScopeResult.fromMap(Map<String, dynamic> map) {
    return GetPrivateLinkScopeResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return KubernetesConfigurationPrivateLinkScopePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
