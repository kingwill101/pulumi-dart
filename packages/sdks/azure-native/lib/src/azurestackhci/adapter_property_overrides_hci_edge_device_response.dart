...
class AdapterPropertyOverridesHciEdgeDeviceResponse {
  ...
  /// Creates a new [AdapterPropertyOverridesHciEdgeDeviceResponse].
  ...
  const AdapterPropertyOverridesHciEdgeDeviceResponse({
  ...
  factory AdapterPropertyOverridesHciEdgeDeviceResponse.fromMap(Map<String, dynamic> map) {
    return AdapterPropertyOverridesHciEdgeDeviceResponse(
