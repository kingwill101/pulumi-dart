...
class VirtualNetworkPropertiesResponseSubnets {
  ...
  final pulumi.Input<
    List<VirtualNetworkPropertiesResponseIpConfigurationReferences>
  >?
  ...
  factory VirtualNetworkPropertiesResponseSubnets.fromMap(
    ...
    return VirtualNetworkPropertiesResponseSubnets(
      ...
      ipConfigurationReferences: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VirtualNetworkPropertiesResponseIpConfigurationReferences.fromMap(
      ...
      routeTable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworkPropertiesResponseRouteTable.fromMap(
