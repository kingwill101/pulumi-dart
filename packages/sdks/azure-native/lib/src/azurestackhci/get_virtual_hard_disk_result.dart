...
class GetVirtualHardDiskResult {
  ...
  factory GetVirtualHardDiskResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualHardDiskResult(
      ...
      blockSizeBytes: (() {
        final guardedValue = map['blockSizeBytes'];
      ...
      diskFileFormat: (() {
        final guardedValue = map['diskFileFormat'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      diskSizeGB: (() {
      ...
      downloadUrl: (() {
        final guardedValue = map['downloadUrl'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      dynamic_: (() {
      ...
      logicalSectorBytes: (() {
        final guardedValue = map['logicalSectorBytes'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
      name: map['name'] as String,
      physicalSectorBytes: (() {
        final guardedValue = map['physicalSectorBytes'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
      provisioningState: map['provisioningState'] as String,
      status: VirtualHardDiskStatusResponse.fromMap(
