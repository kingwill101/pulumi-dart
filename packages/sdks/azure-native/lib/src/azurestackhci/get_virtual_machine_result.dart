...
class GetVirtualMachineResult {
  ...
  factory GetVirtualMachineResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualMachineResult(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return VirtualMachineStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
