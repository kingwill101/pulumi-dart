...
class VirtualMachinePropertiesStorageProfile {
    ...
    return <String, dynamic>{
      'dataDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachinePropertiesDataDisks>,
  ...
  factory VirtualMachinePropertiesStorageProfile.fromMap(
    ...
    return VirtualMachinePropertiesStorageProfile(
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachinePropertiesDataDisks>(
            guardedValue,
            (value) => VirtualMachinePropertiesDataDisks.fromMap(
      ...
      imageReference: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachinePropertiesImageReference.fromMap(
      ...
      osDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachinePropertiesOsDisk.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
