...
class HciRemoteSupportJobPropertiesResponse {
  ...
  final pulumi.Input<RemoteSupportJobReportedPropertiesResponse>
  reportedProperties;
  ...
  factory HciRemoteSupportJobPropertiesResponse.fromMap(
    ...
    return HciRemoteSupportJobPropertiesResponse(
      ...
      reportedProperties: pulumi.Input.fromValue(
        RemoteSupportJobReportedPropertiesResponse.fromMap(
