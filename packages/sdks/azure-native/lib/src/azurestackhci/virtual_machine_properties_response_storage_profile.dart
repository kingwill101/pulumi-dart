...
class VirtualMachinePropertiesResponseStorageProfile {
  ...
  const VirtualMachinePropertiesResponseStorageProfile({
    this.dataDisks,
    this.imageReference,
    this.osDisk,
  ...
  factory VirtualMachinePropertiesResponseStorageProfile.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePropertiesResponseStorageProfile(
      dataDisks: (() { final guardedValue = map['dataDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachinePropertiesResponseDataDisks>(guardedValue, (value) => VirtualMachinePropertiesResponseDataDisks.fromMap((value as Map).cast<String, dynamic>()))); })(),
      imageReference: (() { final guardedValue = map['imageReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachinePropertiesResponseImageReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      osDisk: (() { final guardedValue = map['osDisk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachinePropertiesResponseOsDisk.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
