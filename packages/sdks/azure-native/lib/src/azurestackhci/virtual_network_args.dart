...
class VirtualNetworkArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subnets':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworkPropertiesSubnets>,
    ...
    return VirtualNetworkArgs(
      dhcpOptions: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualNetworkPropertiesDhcpOptions.fromMap(
      ...
      subnets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworkPropertiesSubnets>(
            guardedValue,
            (value) => VirtualNetworkPropertiesSubnets.fromMap(
