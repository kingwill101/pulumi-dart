...
class MarketplaceGalleryImageStatusResponse {
  ...
  final pulumi.Input<MarketplaceGalleryImageStatusDownloadStatusResponse>?
  downloadStatus;
  ...
  final pulumi.Input<MarketplaceGalleryImageStatusProvisioningStatusResponse>?
  provisioningStatus;
  ...
  factory MarketplaceGalleryImageStatusResponse.fromMap(
    ...
    return MarketplaceGalleryImageStatusResponse(
      downloadStatus: (() {
        ...
        return pulumi.Input.fromValue(
          MarketplaceGalleryImageStatusDownloadStatusResponse.fromMap(
      ...
      provisioningStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MarketplaceGalleryImageStatusProvisioningStatusResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
