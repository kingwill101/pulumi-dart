...
class HciNetworkProfileResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hostNetwork':
          pulumi.Input.mapInputValue<HostNetworkResponse, Map<String, dynamic>>(
            hostNetwork,
            (value) => value.toMap(),
          ),
      'nicDetails':
          pulumi.Input.mapInputValue<
            List<HciNicDetailResponse>,
  ...
  factory HciNetworkProfileResponse.fromMap(Map<String, dynamic> map) {
    return HciNetworkProfileResponse(
      ...
      nicDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HciNicDetailResponse>(
          map['nicDetails']!,
          (value) => HciNicDetailResponse.fromMap(
