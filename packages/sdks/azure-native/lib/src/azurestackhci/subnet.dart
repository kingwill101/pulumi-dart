...
class Subnet {
  ...
  final pulumi.Input<List<SubnetIpConfigurationReference>>?
    ...
    return <String, dynamic>{
      ...
      'ipConfigurationReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubnetIpConfigurationReference>,
      ...
      'ipPools':
          ...
          >(
            ipPools,
            (value) => pulumi.Input.encodeList<IPPool, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return Subnet(
      ...
      ipConfigurationReferences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubnetIpConfigurationReference>(
            guardedValue,
            (value) => SubnetIpConfigurationReference.fromMap(
      ...
      ipPools: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IPPool>(
            guardedValue,
            (value) => IPPool.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
      ...
      networkSecurityGroup: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkSecurityGroupArmReference.fromMap(
