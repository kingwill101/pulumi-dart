...
class VirtualMachineInstancePropertiesSecurityProfileResponse {
  ...
  const VirtualMachineInstancePropertiesSecurityProfileResponse({
    this.enableTPM,
    this.securityType,
    this.uefiSettings,
  });
  ...
  factory VirtualMachineInstancePropertiesSecurityProfileResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineInstancePropertiesSecurityProfileResponse(
      ...
      uefiSettings: (() { final guardedValue = map['uefiSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineInstancePropertiesSecurityProfileUefiSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
