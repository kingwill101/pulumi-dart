...
class LoadBalancerRulePropertiesResponse {
  ...
  final pulumi.Input<LoadBalancerBackendAddressPoolReferenceResponse>
  backendAddressPool;
  ...
  final pulumi.Input<LoadBalancerFrontendIPConfigurationReferenceResponse>
  ...
  factory LoadBalancerRulePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerRulePropertiesResponse(
      backendAddressPool: pulumi.Input.fromValue(
        LoadBalancerBackendAddressPoolReferenceResponse.fromMap(
          (map['backendAddressPool']! as Map).cast<String, dynamic>(),
        ),
      ),
      backendPort: pulumi.Input.fromValue(map['backendPort'] as int),
      frontendIPConfiguration: pulumi.Input.fromValue(
        LoadBalancerFrontendIPConfigurationReferenceResponse.fromMap(
          (map['frontendIPConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      probe: (() {
        ...
        return pulumi.Input.fromValue(
          LoadBalancerProbeReferenceResponse.fromMap(
