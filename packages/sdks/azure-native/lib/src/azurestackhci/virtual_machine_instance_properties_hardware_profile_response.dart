...
class VirtualMachineInstancePropertiesHardwareProfileResponse {
  ...
  const VirtualMachineInstancePropertiesHardwareProfileResponse({
  ...
  factory VirtualMachineInstancePropertiesHardwareProfileResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineInstancePropertiesHardwareProfileResponse(
      dynamicMemoryConfig: (() { final guardedValue = map['dynamicMemoryConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineInstancePropertiesHardwareProfileDynamicMemoryConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      virtualMachineGPUs: (() { final guardedValue = map['virtualMachineGPUs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineInstancePropertiesHardwareProfileVirtualMachineGPUResponse>(guardedValue, (value) => VirtualMachineInstancePropertiesHardwareProfileVirtualMachineGPUResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
