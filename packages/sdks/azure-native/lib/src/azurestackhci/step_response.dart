...
class StepResponse {
  ...
  factory StepResponse.fromMap(Map<String, dynamic> map) {
    return StepResponse(
      ...
      steps: (() { final guardedValue = map['steps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StepResponse>(guardedValue, (value) => StepResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
