...
class UpdateArgs {
  ...
  final pulumi.Input<dynamic>? availabilityType;
  ...
  factory UpdateArgs.fromMap(Map<String, dynamic> map) {
    return UpdateArgs(
      ...
      availabilityType: (() { final guardedValue = map['availabilityType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      installedDate: (() { final guardedValue = map['installedDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      minSbeVersionRequired: (() { final guardedValue = map['minSbeVersionRequired']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      notifyMessage: (() { final guardedValue = map['notifyMessage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      packageSizeInMb: (() { final guardedValue = map['packageSizeInMb']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      prerequisites: (() { final guardedValue = map['prerequisites']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UpdatePrerequisite>(guardedValue, (value) => UpdatePrerequisite.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      releaseLink: (() { final guardedValue = map['releaseLink']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      updateName: (() { final guardedValue = map['updateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
