...
class VirtualMachineInstancePropertiesOsProfile {
  ...
  const VirtualMachineInstancePropertiesOsProfile({
    this.adminPassword,
    this.adminUsername,
    this.computerName,
  ...
  factory VirtualMachineInstancePropertiesOsProfile.fromMap(Map<String, dynamic> map) {
    return VirtualMachineInstancePropertiesOsProfile(
      ...
      linuxConfiguration: (() { final guardedValue = map['linuxConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineInstancePropertiesOsProfileLinuxConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      windowsConfiguration: (() { final guardedValue = map['windowsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineInstancePropertiesOsProfileWindowsConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
