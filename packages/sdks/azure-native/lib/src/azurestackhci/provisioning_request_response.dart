    ...
    return ProvisioningRequestResponse(
      ...
      deviceConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          TargetDeviceConfigurationResponse.fromMap(
      ...
      onboardingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OnboardingConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      osProfile: pulumi.Input.fromValue(
        OsProvisionProfileResponse.fromMap(
      ...
      userDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserDetailsResponse>(
            guardedValue,
            (value) => UserDetailsResponse.fromMap(
