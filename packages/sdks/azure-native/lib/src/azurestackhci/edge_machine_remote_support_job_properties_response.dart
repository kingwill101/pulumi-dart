...
class EdgeMachineRemoteSupportJobPropertiesResponse {
  ...
  final pulumi.Input<EdgeMachineRemoteSupportJobReportedPropertiesResponse>
  reportedProperties;
  ...
  factory EdgeMachineRemoteSupportJobPropertiesResponse.fromMap(
    ...
    return EdgeMachineRemoteSupportJobPropertiesResponse(
      ...
      reportedProperties: pulumi.Input.fromValue(
        EdgeMachineRemoteSupportJobReportedPropertiesResponse.fromMap(
