...
class GetNatGatewayResult {
  ...
  final NatGatewayPropertiesResponse? properties;
  ...
  factory GetNatGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetNatGatewayResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return NatGatewayPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
