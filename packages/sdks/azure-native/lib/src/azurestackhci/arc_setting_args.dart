...
class ArcSettingArgs {
    ...
    return <String, dynamic>{
      ...
      'connectivityProperties':
          ?pulumi.Input.mapOptionalInputValue<
            List<ArcConnectivityProperties>,
  ...
  factory ArcSettingArgs.fromMap(Map<String, dynamic> map) {
    return ArcSettingArgs(
      ...
      arcSettingName: (() {
        final guardedValue = map['arcSettingName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      connectivityProperties: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ArcConnectivityProperties>(
            guardedValue,
            (value) => ArcConnectivityProperties.fromMap(
