...
class PublicIPAddressArgs {
  ...
  PublicIPAddressArgs({
    ...
    pulumi.Output<PublicIPAddressProperties>? properties,
  ...
  factory PublicIPAddressArgs.fromMap(Map<String, dynamic> map) {
    return PublicIPAddressArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<PublicIPAddressProperties>(PublicIPAddressProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
