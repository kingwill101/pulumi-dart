...
class Intents {
  ...
  factory Intents.fromMap(Map<String, dynamic> map) {
    return Intents(
      ...
      adapterPropertyOverrides: (() { final guardedValue = map['adapterPropertyOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdapterPropertyOverrides.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      qosPolicyOverrides: (() { final guardedValue = map['qosPolicyOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QosPolicyOverrides.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      virtualSwitchConfigurationOverrides: (() { final guardedValue = map['virtualSwitchConfigurationOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualSwitchConfigurationOverrides.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
