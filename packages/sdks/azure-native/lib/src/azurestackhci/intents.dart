...
class Intents {
  ...
  final pulumi.Input<VirtualSwitchConfigurationOverrides>?
  ...
  factory Intents.fromMap(Map<String, dynamic> map) {
    return Intents(
      ...
      adapterPropertyOverrides: (() {
        final guardedValue = map['adapterPropertyOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AdapterPropertyOverrides.fromMap(
      ...
      overrideAdapterProperty: (() {
        final guardedValue = map['overrideAdapterProperty'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      overrideQosPolicy: (() {
        final guardedValue = map['overrideQosPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      overrideVirtualSwitchConfiguration: (() {
        final guardedValue = map['overrideVirtualSwitchConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      qosPolicyOverrides: (() {
        final guardedValue = map['qosPolicyOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          QosPolicyOverrides.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      virtualSwitchConfigurationOverrides: (() {
        final guardedValue = map['virtualSwitchConfigurationOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualSwitchConfigurationOverrides.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
