...
class GetStorageContainerResult {
  ...
  factory GetStorageContainerResult.fromMap(Map<String, dynamic> map) {
    return GetStorageContainerResult(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return StorageContainerStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
