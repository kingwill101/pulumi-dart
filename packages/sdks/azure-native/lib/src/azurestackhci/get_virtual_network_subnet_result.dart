...
class GetVirtualNetworkSubnetResult {
  ...
  const GetVirtualNetworkSubnetResult({
  ...
  factory GetVirtualNetworkSubnetResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualNetworkSubnetResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return VirtualNetworkSubnetPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
