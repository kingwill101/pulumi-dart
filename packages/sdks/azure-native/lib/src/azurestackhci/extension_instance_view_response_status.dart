...
class ExtensionInstanceViewResponseStatus {
  /// The status code.
  ...
  /// Creates a new [ExtensionInstanceViewResponseStatus].
  /// [code] The status code.
  /// [displayStatus] The short localizable label for the status.
  /// [level] The level code.
  /// [message] The detailed status message, including for alerts and error messages.
  /// [time] The time of the status.
  const ExtensionInstanceViewResponseStatus({
    this.code,
    this.displayStatus,
    this.level,
    this.message,
  ...
  factory ExtensionInstanceViewResponseStatus.fromMap(Map<String, dynamic> map) {
    return ExtensionInstanceViewResponseStatus(
