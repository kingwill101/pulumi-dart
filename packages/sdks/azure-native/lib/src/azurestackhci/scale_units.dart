...
class ScaleUnits {
  ...
  factory ScaleUnits.fromMap(Map<String, dynamic> map) {
    return ScaleUnits(
      deploymentData: pulumi.Input.fromValue(DeploymentData.fromMap((map['deploymentData']! as Map).cast<String, dynamic>())),
      sbePartnerInfo: (() { final guardedValue = map['sbePartnerInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SbePartnerInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
