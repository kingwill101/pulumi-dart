...
class ScaleUnitsResponse {
  ...
  ScaleUnitsResponse({required this.deploymentData, this.sbePartnerInfo});
    ...
    return <String, dynamic>{
      'deploymentData':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(deploymentData, (value) => value.toMap()),
      'sbePartnerInfo':
  ...
  factory ScaleUnitsResponse.fromMap(Map<String, dynamic> map) {
    return ScaleUnitsResponse(
      deploymentData: pulumi.Input.fromValue(
        DeploymentDataResponse.fromMap(
      ...
      sbePartnerInfo: (() {
        ...
        return pulumi.Input.fromValue(
          SbePartnerInfoResponse.fromMap(
