...
class VirtualMachinePropertiesSshSsh {
  ...
  final pulumi.Input<List<VirtualMachinePropertiesPublicKeysPublicKeys>>?
  publicKeys;
  ...
  VirtualMachinePropertiesSshSsh({this.publicKeys});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'publicKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachinePropertiesPublicKeysPublicKeys>,
    ...
    return VirtualMachinePropertiesSshSsh(
      publicKeys: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachinePropertiesPublicKeysPublicKeys>(
            guardedValue,
            (value) => VirtualMachinePropertiesPublicKeysPublicKeys.fromMap(
