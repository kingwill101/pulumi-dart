...
class VirtualMachinePropertiesSshSsh {
  ...
  factory VirtualMachinePropertiesSshSsh.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePropertiesSshSsh(
      publicKeys: (() { final guardedValue = map['publicKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachinePropertiesPublicKeysPublicKeys>(guardedValue, (value) => VirtualMachinePropertiesPublicKeysPublicKeys.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
