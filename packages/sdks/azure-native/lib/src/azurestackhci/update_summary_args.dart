...
class UpdateSummaryArgs {
  ...
  factory UpdateSummaryArgs.fromMap(Map<String, dynamic> map) {
    return UpdateSummaryArgs(
      ...
      currentOemVersion: (() { final guardedValue = map['currentOemVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      currentSbeVersion: (() { final guardedValue = map['currentSbeVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      hardwareModel: (() { final guardedValue = map['hardwareModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      healthCheckDate: (() { final guardedValue = map['healthCheckDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
