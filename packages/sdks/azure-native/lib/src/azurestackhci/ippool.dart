...
class IPPool {
  ...
  final pulumi.Input<dynamic>? ipPoolType;
  /// Name of the IP-Pool
  ...
  factory IPPool.fromMap(Map<String, dynamic> map) {
    return IPPool(
      ...
      ipPoolType: (() { final guardedValue = map['ipPoolType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
