...
class VirtualMachinePropertiesResponsePublicKeys {
  ...
  /// Creates a new [VirtualMachinePropertiesResponsePublicKeys].
  ...
  VirtualMachinePropertiesResponsePublicKeys({this.keyData, this.path});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'keyData': ?keyData, 'path': ?path};
  }

  factory VirtualMachinePropertiesResponsePublicKeys.fromMap(
