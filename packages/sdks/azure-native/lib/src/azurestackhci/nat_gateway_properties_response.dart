...
class NatGatewayPropertiesResponse {
  ...
  final pulumi.Input<List<PublicIPAddressArmReferenceResponse>>?
  publicIPAddresses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicIPAddresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<PublicIPAddressArmReferenceResponse>,
            List<Map<String, dynamic>>
          >(
            publicIPAddresses,
            (value) =>
      ...
      'subnets':
          pulumi.Input.mapInputValue<
            List<VirtualNetworkSubnetArmReferenceResponse>,
            List<Map<String, dynamic>>
          >(
            subnets,
            (value) =>
  ...
  factory NatGatewayPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NatGatewayPropertiesResponse(
      ...
      publicIPAddresses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PublicIPAddressArmReferenceResponse>(
            guardedValue,
            (value) => PublicIPAddressArmReferenceResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      status: pulumi.Input.fromValue(
        NatGatewayStatusResponse.fromMap(
          (map['status']! as Map).cast<String, dynamic>(),
        ),
      ),
      subnets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VirtualNetworkSubnetArmReferenceResponse>(
          map['subnets']!,
          (value) => VirtualNetworkSubnetArmReferenceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
