...
class RemoteSupportPropertiesResponse {
  ...
  final pulumi.Input<List<RemoteSupportNodeSettingsResponse>>
  remoteSupportNodeSettings;
  final pulumi.Input<List<PerNodeRemoteSupportSessionResponse>>
    ...
    return <String, dynamic>{
      ...
      'remoteSupportNodeSettings':
          pulumi.Input.mapInputValue<
            List<RemoteSupportNodeSettingsResponse>,
      ...
      'remoteSupportSessionDetails':
          pulumi.Input.mapInputValue<
            List<PerNodeRemoteSupportSessionResponse>,
            List<Map<String, dynamic>>
          >(
            remoteSupportSessionDetails,
            (value) =>
  ...
  factory RemoteSupportPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RemoteSupportPropertiesResponse(
      ...
      remoteSupportNodeSettings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RemoteSupportNodeSettingsResponse>(
          map['remoteSupportNodeSettings']!,
          (value) => RemoteSupportNodeSettingsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      remoteSupportSessionDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PerNodeRemoteSupportSessionResponse>(
          map['remoteSupportSessionDetails']!,
          (value) => PerNodeRemoteSupportSessionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      remoteSupportType: pulumi.Input.fromValue(
        map['remoteSupportType'] as String,
      ),
    );
  }
}
