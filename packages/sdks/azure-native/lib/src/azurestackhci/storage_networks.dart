...
class StorageNetworks {
  ...
  factory StorageNetworks.fromMap(Map<String, dynamic> map) {
    return StorageNetworks(
      ...
      networkAdapterName: (() {
        final guardedValue = map['networkAdapterName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      storageAdapterIPInfo: (() {
        final guardedValue = map['storageAdapterIPInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StorageAdapterIPInfo>(
            guardedValue,
            (value) => StorageAdapterIPInfo.fromMap(
