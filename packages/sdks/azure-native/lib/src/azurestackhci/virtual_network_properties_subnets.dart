...
class VirtualNetworkPropertiesSubnets {
  ...
  final pulumi.Input<List<VirtualNetworkPropertiesIpConfigurationReferences>>?
    ...
    return <String, dynamic>{
      ...
      'ipConfigurationReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworkPropertiesIpConfigurationReferences>,
  ...
  factory VirtualNetworkPropertiesSubnets.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkPropertiesSubnets(
      ...
      ipConfigurationReferences: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VirtualNetworkPropertiesIpConfigurationReferences.fromMap(
      ...
      routeTable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworkPropertiesRouteTable.fromMap(
