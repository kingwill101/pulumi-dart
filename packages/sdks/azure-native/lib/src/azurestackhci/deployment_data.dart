    ...
    return <String, dynamic>{
      ...
      'physicalNodes':
          ...
          >(
            physicalNodes,
            (value) =>
                pulumi.Input.encodeList<PhysicalNodes, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DeploymentData.fromMap(Map<String, dynamic> map) {
    return DeploymentData(
      ...
      hostNetwork: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HostNetwork.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      infrastructureNetwork: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InfrastructureNetwork>(
            guardedValue,
            (value) => InfrastructureNetwork.fromMap(
      ...
      observability: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Observability.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      optionalServices: (() {
      ...
      physicalNodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PhysicalNodes>(
            guardedValue,
            (value) =>
                PhysicalNodes.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      sdnIntegration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SdnIntegration.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      secrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EceDeploymentSecrets>(
            guardedValue,
            (value) => EceDeploymentSecrets.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      securitySettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentSecuritySettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
