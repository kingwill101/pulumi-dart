...
class VirtualMachinePropertiesResponseNetworkProfile {
  ...
  final pulumi.Input<List<VirtualMachinePropertiesResponseNetworkInterfaces>>?
  networkInterfaces;
  ...
  VirtualMachinePropertiesResponseNetworkProfile({this.networkInterfaces});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachinePropertiesResponseNetworkInterfaces>,
  ...
  factory VirtualMachinePropertiesResponseNetworkProfile.fromMap(
      ...
      networkInterfaces: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VirtualMachinePropertiesResponseNetworkInterfaces.fromMap(
