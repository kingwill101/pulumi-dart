...
class VirtualMachineInstancePropertiesNetworkProfileResponse {
  ...
  final pulumi.Input<List<NetworkInterfaceArmReferenceResponse>>?
  networkInterfaces;
    ...
    return <String, dynamic>{
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkInterfaceArmReferenceResponse>,
  ...
  factory VirtualMachineInstancePropertiesNetworkProfileResponse.fromMap(
