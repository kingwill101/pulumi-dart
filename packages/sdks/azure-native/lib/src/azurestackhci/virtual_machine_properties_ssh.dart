...
class VirtualMachinePropertiesSsh {
  ...
  const VirtualMachinePropertiesSsh({
    this.publicKeys,
  });
  ...
  factory VirtualMachinePropertiesSsh.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePropertiesSsh(
      publicKeys: (() { final guardedValue = map['publicKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachinePropertiesPublicKeys>(guardedValue, (value) => VirtualMachinePropertiesPublicKeys.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
