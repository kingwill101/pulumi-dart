...
class VirtualMachineInstancePropertiesStorageProfile {
  ...
  final pulumi.Input<VirtualMachineInstancePropertiesStorageProfileOsDisk>?
  osDisk;
    ...
    return <String, dynamic>{
      'dataDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualHardDiskArmReference>,
  ...
  factory VirtualMachineInstancePropertiesStorageProfile.fromMap(
    ...
    return VirtualMachineInstancePropertiesStorageProfile(
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualHardDiskArmReference>(
            guardedValue,
            (value) => VirtualHardDiskArmReference.fromMap(
      ...
      osDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineInstancePropertiesStorageProfileOsDisk.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
