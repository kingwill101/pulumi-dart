...
class ArcConnectivityProperties {
  ...
  factory ArcConnectivityProperties.fromMap(Map<String, dynamic> map) {
    return ArcConnectivityProperties(
      ...
      serviceConfigurations: (() { final guardedValue = map['serviceConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceConfiguration>(guardedValue, (value) => ServiceConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
