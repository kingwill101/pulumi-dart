...
class GetUpdateResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'prerequisites': ?prerequisites == null ? null : pulumi.Input.encodeList<UpdatePrerequisiteResponse, Map<String, dynamic>>(prerequisites!, (value) => value.toMap()),
  ...
  factory GetUpdateResult.fromMap(Map<String, dynamic> map) {
    return GetUpdateResult(
      ...
      prerequisites: map['prerequisites'] == null ? null : pulumi.Input.decodeList<UpdatePrerequisiteResponse>(map['prerequisites']!, (value) => UpdatePrerequisiteResponse.fromMap((value as Map).cast<String, dynamic>())),
