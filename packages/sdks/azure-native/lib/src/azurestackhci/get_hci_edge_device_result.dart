...
class GetHciEdgeDeviceResult {
  ...
  factory GetHciEdgeDeviceResult.fromMap(Map<String, dynamic> map) {
    return GetHciEdgeDeviceResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return HciEdgeDevicePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
