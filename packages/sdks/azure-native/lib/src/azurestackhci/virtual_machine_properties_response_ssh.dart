...
class VirtualMachinePropertiesResponseSsh {
  ...
  final pulumi.Input<List<VirtualMachinePropertiesResponsePublicKeys>>?
  publicKeys;
  ...
  VirtualMachinePropertiesResponseSsh({this.publicKeys});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'publicKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachinePropertiesResponsePublicKeys>,
  ...
  factory VirtualMachinePropertiesResponseSsh.fromMap(
    ...
    return VirtualMachinePropertiesResponseSsh(
      publicKeys: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachinePropertiesResponsePublicKeys>(
            guardedValue,
            (value) => VirtualMachinePropertiesResponsePublicKeys.fromMap(
