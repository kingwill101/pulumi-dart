...
class HostNetworkResponse {
  ...
  factory HostNetworkResponse.fromMap(Map<String, dynamic> map) {
    return HostNetworkResponse(
      enableStorageAutoIp: pulumi.Input.fromValue(map['enableStorageAutoIp'] as bool),
      intents: pulumi.Input.fromValue(pulumi.Input.decodeList<IntentsResponse>(map['intents']!, (value) => IntentsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      storageConnectivitySwitchless: pulumi.Input.fromValue(map['storageConnectivitySwitchless'] as bool),
      storageNetworks: pulumi.Input.fromValue(pulumi.Input.decodeList<StorageNetworksResponse>(map['storageNetworks']!, (value) => StorageNetworksResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
