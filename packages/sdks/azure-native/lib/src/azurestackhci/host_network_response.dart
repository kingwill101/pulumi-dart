...
class HostNetworkResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'intents': ?pulumi.Input.mapOptionalInputValue<List<IntentsResponse>, List<Map<String, dynamic>>>(intents, (value) => pulumi.Input.encodeList<IntentsResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'storageConnectivitySwitchless': ?storageConnectivitySwitchless,
      'storageNetworks': ?pulumi.Input.mapOptionalInputValue<List<StorageNetworksResponse>, List<Map<String, dynamic>>>(storageNetworks, (value) => pulumi.Input.encodeList<StorageNetworksResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory HostNetworkResponse.fromMap(Map<String, dynamic> map) {
    return HostNetworkResponse(
      ...
      intents: (() { final guardedValue = map['intents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IntentsResponse>(guardedValue, (value) => IntentsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      storageNetworks: (() { final guardedValue = map['storageNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StorageNetworksResponse>(guardedValue, (value) => StorageNetworksResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
