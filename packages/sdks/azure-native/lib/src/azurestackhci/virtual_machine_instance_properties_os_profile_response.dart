...
class VirtualMachineInstancePropertiesOsProfileResponse {
  ...
  factory VirtualMachineInstancePropertiesOsProfileResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineInstancePropertiesOsProfileResponse(
      ...
      linuxConfiguration: (() { final guardedValue = map['linuxConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineInstancePropertiesOsProfileLinuxConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      windowsConfiguration: (() { final guardedValue = map['windowsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineInstancePropertiesOsProfileWindowsConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
