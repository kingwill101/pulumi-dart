...
class VirtualNetworkSubnetPropertiesResponse {
  ...
  final pulumi.Input<List<VirtualNetworkSubnetIpConfigurationReferenceResponse>>
  ipConfigurations;
    ...
    return <String, dynamic>{
      ...
      'ipConfigurations':
          pulumi.Input.mapInputValue<
            List<VirtualNetworkSubnetIpConfigurationReferenceResponse>,
  ...
  factory VirtualNetworkSubnetPropertiesResponse.fromMap(
    ...
    return VirtualNetworkSubnetPropertiesResponse(
      ...
      ipConfigurations: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              VirtualNetworkSubnetIpConfigurationReferenceResponse.fromMap(
      ...
      natGateway: (() {
        ...
        return pulumi.Input.fromValue(
          NatGatewayArmReferenceResponse.fromMap(
      ...
      status: pulumi.Input.fromValue(
        VirtualNetworkSubnetStatusResponse.fromMap(
