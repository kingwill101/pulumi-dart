...
class InboundRuleProperties {
  ...
  /// Creates a new [InboundRuleProperties].
  ...
  factory InboundRuleProperties.fromMap(Map<String, dynamic> map) {
    return InboundRuleProperties(
