...
class ClusterJob extends pulumi.CustomResource {
  ...
  late final pulumi.Output<HciConfigureCvmJobPropertiesResponse> properties;
  ...
  ClusterJob(
    ...
    properties = registerOutput<HciConfigureCvmJobPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return HciConfigureCvmJobPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
