...
class LoadBalancerRuleProperties {
  ...
  final pulumi.Input<LoadBalancerBackendAddressPoolReference>
  backendAddressPool;
  ...
  final pulumi.Input<LoadBalancerFrontendIPConfigurationReference>
  ...
  factory LoadBalancerRuleProperties.fromMap(Map<String, dynamic> map) {
    return LoadBalancerRuleProperties(
      backendAddressPool: pulumi.Input.fromValue(
        LoadBalancerBackendAddressPoolReference.fromMap(
      ...
      frontendIPConfiguration: pulumi.Input.fromValue(
        LoadBalancerFrontendIPConfigurationReference.fromMap(
      ...
      probe: (() {
        ...
        return pulumi.Input.fromValue(
          LoadBalancerProbeReference.fromMap(
