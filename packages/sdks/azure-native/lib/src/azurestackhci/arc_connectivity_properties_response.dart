...
class ArcConnectivityPropertiesResponse {
  ...
  factory ArcConnectivityPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ArcConnectivityPropertiesResponse(
      ...
      serviceConfigurations: (() { final guardedValue = map['serviceConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceConfigurationResponse>(guardedValue, (value) => ServiceConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
