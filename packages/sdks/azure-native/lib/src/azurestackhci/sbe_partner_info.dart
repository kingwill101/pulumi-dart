...
class SbePartnerInfo {
  ...
  factory SbePartnerInfo.fromMap(Map<String, dynamic> map) {
    return SbePartnerInfo(
      credentialList: (() { final guardedValue = map['credentialList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SbeCredentials>(guardedValue, (value) => SbeCredentials.fromMap((value as Map).cast<String, dynamic>()))); })(),
      partnerProperties: (() { final guardedValue = map['partnerProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SbePartnerProperties>(guardedValue, (value) => SbePartnerProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sbeDeploymentInfo: (() { final guardedValue = map['sbeDeploymentInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SbeDeploymentInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
