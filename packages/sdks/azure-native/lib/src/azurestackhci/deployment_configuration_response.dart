...
class DeploymentConfigurationResponse {
  ...
  factory DeploymentConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentConfigurationResponse(
      scaleUnits: pulumi.Input.fromValue(pulumi.Input.decodeList<ScaleUnitsResponse>(map['scaleUnits']!, (value) => ScaleUnitsResponse.fromMap((value as Map).cast<String, dynamic>()))),
