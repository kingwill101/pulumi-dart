...
class DeviceConfigurationResponse {
  ...
  factory DeviceConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return DeviceConfigurationResponse(
      ...
      nicDetails: (() { final guardedValue = map['nicDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NicDetailResponse>(guardedValue, (value) => NicDetailResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
