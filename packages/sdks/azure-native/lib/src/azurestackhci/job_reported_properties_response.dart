...
class JobReportedPropertiesResponse {
  ...
  /// Creates a new [JobReportedPropertiesResponse].
  ...
  const JobReportedPropertiesResponse({
  ...
  factory JobReportedPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return JobReportedPropertiesResponse(
