...
import 'adapter_property_overrides_hci_edge_device_response.dart';
import 'qos_policy_overrides_response.dart';
import 'virtual_switch_configuration_overrides_hci_edge_device_response.dart';

/// The Intents of a cluster.
class IntentsHciEdgeDeviceResponse {
  /// Set Adapter PropertyOverrides for cluster.
  final pulumi.Input<AdapterPropertyOverridesHciEdgeDeviceResponse> adapterPropertyOverrides;
  ...
  final pulumi.Input<VirtualSwitchConfigurationOverridesHciEdgeDeviceResponse> virtualSwitchConfigurationOverrides;

  /// Creates a new [IntentsHciEdgeDeviceResponse].
  ...
  const IntentsHciEdgeDeviceResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adapterPropertyOverrides': pulumi.Input.mapInputValue<AdapterPropertyOverridesHciEdgeDeviceResponse, Map<String, dynamic>>(adapterPropertyOverrides, (value) => value.toMap()),
      ...
      'scope': scope,
      'virtualSwitchConfigurationOverrides': pulumi.Input.mapInputValue<VirtualSwitchConfigurationOverridesHciEdgeDeviceResponse, Map<String, dynamic>>(virtualSwitchConfigurationOverrides, (value) => value.toMap()),
    };
  }

  factory IntentsHciEdgeDeviceResponse.fromMap(Map<String, dynamic> map) {
    return IntentsHciEdgeDeviceResponse(
