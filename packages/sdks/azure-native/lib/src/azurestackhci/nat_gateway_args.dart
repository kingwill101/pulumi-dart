...
class NatGatewayArgs {
  ...
  factory NatGatewayArgs.fromMap(Map<String, dynamic> map) {
    return NatGatewayArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NatGatewayProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
