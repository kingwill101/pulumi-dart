...
class GetLogicalNetworkResult {
  ...
  factory GetLogicalNetworkResult.fromMap(Map<String, dynamic> map) {
    return GetLogicalNetworkResult(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return LogicalNetworkStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
