...
class GetPublicIPAddressResult {
  ...
  final PublicIPAddressPropertiesResponse? properties;
  ...
  factory GetPublicIPAddressResult.fromMap(Map<String, dynamic> map) {
    return GetPublicIPAddressResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return PublicIPAddressPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
