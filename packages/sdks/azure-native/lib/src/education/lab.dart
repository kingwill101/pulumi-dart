...
class Lab extends pulumi.CustomResource {
  ...
  Lab(
    ...
    this.budgetPerStudent = registerOutput<AmountResponse>('budgetPerStudent');
    ...
    this.invitationCode = registerOutput<String>('invitationCode');
    this.maxStudentCount = registerOutput<double>('maxStudentCount');
    this.name = registerOutput<String>('name');
    this.status = registerOutput<String>('status');
    this.systemData = registerOutput<SystemDataResponse>('systemData');
    this.totalBudget = registerOutput<AmountResponse>('totalBudget');
