...
class SecurityContactArgs {
  ...
  final pulumi.Input<SecurityContactPropertiesNotificationsByRole>?
  notificationsByRole;
    ...
    return <String, dynamic>{
      ...
      'notificationsByRole':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(notificationsByRole, (value) => value.toMap()),
      'notificationsSources':
          ?pulumi.Input.mapOptionalInputValue<
            List<NotificationsSourceAlert>,
    ...
    return SecurityContactArgs(
      ...
      notificationsByRole: (() {
        ...
        return pulumi.Input.fromValue(
          SecurityContactPropertiesNotificationsByRole.fromMap(
      ...
      notificationsSources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NotificationsSourceAlert>(
            guardedValue,
            (value) => NotificationsSourceAlert.fromMap(
      ...
      securityContactName: (() {
        final guardedValue = map['securityContactName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
