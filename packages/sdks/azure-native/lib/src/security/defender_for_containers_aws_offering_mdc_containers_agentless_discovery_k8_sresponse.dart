...
class DefenderForContainersAwsOfferingMdcContainersAgentlessDiscoveryK8SResponse {
  ...
  const DefenderForContainersAwsOfferingMdcContainersAgentlessDiscoveryK8SResponse({
    this.cloudRoleArn,
    this.enabled,
  });
  ...
  factory DefenderForContainersAwsOfferingMdcContainersAgentlessDiscoveryK8SResponse.fromMap(Map<String, dynamic> map) {
    return DefenderForContainersAwsOfferingMdcContainersAgentlessDiscoveryK8SResponse(
