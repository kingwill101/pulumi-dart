...
class JitNetworkAccessRequestPort {
  ...
  final pulumi.Input<dynamic> statusReason;
  ...
  factory JitNetworkAccessRequestPort.fromMap(Map<String, dynamic> map) {
    return JitNetworkAccessRequestPort(
      ...
      mappedPort: (() { final guardedValue = map['mappedPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      statusReason: pulumi.Input.fromValue(map['statusReason']),
    );
  }
}
