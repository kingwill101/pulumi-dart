...
import 'cspm_monitor_gcp_offering_native_cloud_connection_response.dart';
...
class CspmMonitorGcpOfferingResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nativeCloudConnection': ?pulumi.Input.mapOptionalInputValue<CspmMonitorGcpOfferingNativeCloudConnectionResponse, Map<String, dynamic>>(nativeCloudConnection, (value) => value.toMap()),
  ...
  factory CspmMonitorGcpOfferingResponse.fromMap(Map<String, dynamic> map) {
    return CspmMonitorGcpOfferingResponse(
      ...
      nativeCloudConnection: (() { final guardedValue = map['nativeCloudConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CspmMonitorGcpOfferingNativeCloudConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
