...
class DefenderCspmGcpOfferingMdcContainersImageAssessmentResponse {
  ...
  /// Creates a new [DefenderCspmGcpOfferingMdcContainersImageAssessmentResponse].
  ...
  const DefenderCspmGcpOfferingMdcContainersImageAssessmentResponse({
    this.enabled,
  ...
  factory DefenderCspmGcpOfferingMdcContainersImageAssessmentResponse.fromMap(Map<String, dynamic> map) {
    return DefenderCspmGcpOfferingMdcContainersImageAssessmentResponse(
