...
class DefenderFoDatabasesAwsOffering {
  ...
  final pulumi.Input<DefenderFoDatabasesAwsOfferingArcAutoProvisioning>?
  arcAutoProvisioning;

  /// The databases data security posture management (DSPM) configuration
  final pulumi.Input<DefenderFoDatabasesAwsOfferingDatabasesDspm>?
  databasesDspm;
    ...
    return DefenderFoDatabasesAwsOffering(
      arcAutoProvisioning: (() {
        ...
        return pulumi.Input.fromValue(
          DefenderFoDatabasesAwsOfferingArcAutoProvisioning.fromMap(
      ...
      databasesDspm: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderFoDatabasesAwsOfferingDatabasesDspm.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderFoDatabasesAwsOfferingRds.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
