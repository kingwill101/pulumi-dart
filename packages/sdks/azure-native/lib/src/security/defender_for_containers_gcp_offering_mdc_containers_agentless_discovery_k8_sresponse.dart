...
class DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse {
  ...
  /// Creates a new [DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse].
  ...
  const DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse({
    this.enabled,
  ...
  factory DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse.fromMap(Map<String, dynamic> map) {
    return DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse(
