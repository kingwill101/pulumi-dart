...
class GetDevOpsConfigurationResult {
  ...
  factory GetDevOpsConfigurationResult.fromMap(Map<String, dynamic> map) {
    return GetDevOpsConfigurationResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return DevOpsConfigurationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
