    ...
    return <String, dynamic>{
      ...
      'scopes':
          ...
          >(
            scopes,
            (value) =>
                pulumi.Input.encodeList<AutomationScope, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AutomationArgs(
      actions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutomationActionEventHub>(
            guardedValue,
            (value) => AutomationActionEventHub.fromMap(
      ...
      automationName: (() {
        final guardedValue = map['automationName'];
        if (guardedValue == null) return null;
      ...
      scopes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutomationScope>(
            guardedValue,
            (value) =>
                AutomationScope.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      sources: (() {
