...
class AutomationArgs {
  ...
  factory AutomationArgs.fromMap(Map<String, dynamic> map) {
    return AutomationArgs(
      ...
      scopes: (() { final guardedValue = map['scopes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationScope>(guardedValue, (value) => AutomationScope.fromMap((value as Map).cast<String, dynamic>()))); })(),
