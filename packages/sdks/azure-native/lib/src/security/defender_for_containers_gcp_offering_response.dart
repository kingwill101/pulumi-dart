...
class DefenderForContainersGcpOfferingResponse {
  ...
  final pulumi.Input<DefenderForContainersGcpOfferingResponseVmScanners>?
  vmScanners;
    ...
    return <String, dynamic>{
      'dataPipelineNativeCloudConnection':
          ?pulumi.Input.mapOptionalInputValue<
            DefenderForContainersGcpOfferingResponseDataPipelineNativeCloudConnection,
            Map<String, dynamic>
          >(dataPipelineNativeCloudConnection, (value) => value.toMap()),
  ...
  factory DefenderForContainersGcpOfferingResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return DefenderForContainersGcpOfferingResponse(
      dataPipelineNativeCloudConnection: (() {
        final guardedValue = map['dataPipelineNativeCloudConnection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingResponseDataPipelineNativeCloudConnection.fromMap(
      ...
      mdcContainersAgentlessDiscoveryK8s: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingResponseMdcContainersAgentlessDiscoveryK8s.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mdcContainersImageAssessment: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingResponseMdcContainersImageAssessment.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      nativeCloudConnection: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingResponseNativeCloudConnection.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      vmScanners: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingResponseVmScanners.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
