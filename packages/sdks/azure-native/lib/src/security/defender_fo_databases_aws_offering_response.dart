...
class DefenderFoDatabasesAwsOfferingResponse {
  ...
  final pulumi.Input<DefenderFoDatabasesAwsOfferingResponseArcAutoProvisioning>?
  arcAutoProvisioning;

  /// The databases data security posture management (DSPM) configuration
  final pulumi.Input<DefenderFoDatabasesAwsOfferingResponseDatabasesDspm>?
  databasesDspm;
  ...
  factory DefenderFoDatabasesAwsOfferingResponse.fromMap(
    ...
    return DefenderFoDatabasesAwsOfferingResponse(
      arcAutoProvisioning: (() {
        ...
        return pulumi.Input.fromValue(
          DefenderFoDatabasesAwsOfferingResponseArcAutoProvisioning.fromMap(
      ...
      databasesDspm: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderFoDatabasesAwsOfferingResponseDatabasesDspm.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderFoDatabasesAwsOfferingResponseRds.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
