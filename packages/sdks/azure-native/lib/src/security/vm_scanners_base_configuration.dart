...
class VmScannersBaseConfiguration {
  ...
  final pulumi.Input<dynamic>? scanningMode;
  ...
  factory VmScannersBaseConfiguration.fromMap(Map<String, dynamic> map) {
    return VmScannersBaseConfiguration(
      ...
      scanningMode: (() { final guardedValue = map['scanningMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
