...
class CustomEntityStoreAssignmentArgs {
  ...
  factory CustomEntityStoreAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return CustomEntityStoreAssignmentArgs(
      customEntityStoreAssignmentName: (() { final guardedValue = map['customEntityStoreAssignmentName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
