...
class StandardAssignmentPropertiesResponseAttestationData {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'evidence':
          ?pulumi.Input.mapOptionalInputValue<
            List<AttestationEvidenceResponse>,
  ...
  factory StandardAssignmentPropertiesResponseAttestationData.fromMap(
    ...
    return StandardAssignmentPropertiesResponseAttestationData(
      ...
      evidence: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AttestationEvidenceResponse>(
            guardedValue,
