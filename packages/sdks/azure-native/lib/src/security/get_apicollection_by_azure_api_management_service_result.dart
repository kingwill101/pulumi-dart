...
class GetAPICollectionByAzureApiManagementServiceResult {
  ...
  factory GetAPICollectionByAzureApiManagementServiceResult.fromMap(
    ...
    return GetAPICollectionByAzureApiManagementServiceResult(
      ...
      numberOfApiEndpointsWithSensitiveDataExposed:
          map['numberOfApiEndpointsWithSensitiveDataExposed'] as double,
      numberOfExternalApiEndpoints:
          map['numberOfExternalApiEndpoints'] as double,
      numberOfInactiveApiEndpoints:
          map['numberOfInactiveApiEndpoints'] as double,
      numberOfUnauthenticatedApiEndpoints:
          map['numberOfUnauthenticatedApiEndpoints'] as double,
