...
class IotSecuritySolutionArgs {
  ...
  final pulumi.Input<List<AdditionalWorkspacesProperties>>?
  ...
  final pulumi.Input<List<RecommendationConfigurationProperties>>?
    ...
    return <String, dynamic>{
      'additionalWorkspaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<AdditionalWorkspacesProperties>,
      ...
      'recommendationsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecommendationConfigurationProperties>,
            List<Map<String, dynamic>>
          >(
            recommendationsConfiguration,
            (value) =>
      ...
      'userDefinedResources':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(userDefinedResources, (value) => value.toMap()),
      'workspace': ?workspace,
    };
  }
    ...
    return IotSecuritySolutionArgs(
      additionalWorkspaces: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdditionalWorkspacesProperties>(
            guardedValue,
            (value) => AdditionalWorkspacesProperties.fromMap(
      ...
      recommendationsConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecommendationConfigurationProperties>(
            guardedValue,
            (value) => RecommendationConfigurationProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      userDefinedResources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserDefinedResourcesProperties.fromMap(
