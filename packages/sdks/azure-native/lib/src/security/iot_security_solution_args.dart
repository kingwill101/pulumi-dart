...
class IotSecuritySolutionArgs {
  ...
  factory IotSecuritySolutionArgs.fromMap(Map<String, dynamic> map) {
    return IotSecuritySolutionArgs(
      ...
      export: (() { final guardedValue = map['export']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      unmaskedIpLoggingStatus: (() { final guardedValue = map['unmaskedIpLoggingStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
