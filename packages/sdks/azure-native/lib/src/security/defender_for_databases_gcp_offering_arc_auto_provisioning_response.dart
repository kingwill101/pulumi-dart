...
class DefenderForDatabasesGcpOfferingArcAutoProvisioningResponse {
  /// Configuration for servers Arc auto provisioning for a given environment
  final pulumi.Input<ArcAutoProvisioningConfigurationResponse?>? configuration;
  /// Is arc auto provisioning enabled
  final pulumi.Input<bool?>? enabled;

  /// Creates a new [DefenderForDatabasesGcpOfferingArcAutoProvisioningResponse].
  ...
  const DefenderForDatabasesGcpOfferingArcAutoProvisioningResponse({
    this.configuration,
    this.enabled,
  });
  ...
  factory DefenderForDatabasesGcpOfferingArcAutoProvisioningResponse.fromMap(Map<String, dynamic> map) {
    return DefenderForDatabasesGcpOfferingArcAutoProvisioningResponse(
