...
class GetConnectorResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authenticationDetails': ?authenticationDetails == null ? null : authenticationDetails!.toMap(),
      'azureApiVersion': azureApiVersion,
      'hybridComputeSettings': ?hybridComputeSettings == null ? null : hybridComputeSettings!.toMap(),
      'id': id,
      'name': name,
      'type': type,
    };
