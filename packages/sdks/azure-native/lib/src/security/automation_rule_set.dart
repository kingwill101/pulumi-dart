...
class AutomationRuleSet {
  ...
  factory AutomationRuleSet.fromMap(Map<String, dynamic> map) {
    return AutomationRuleSet(
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationTriggeringRule>(guardedValue, (value) => AutomationTriggeringRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
