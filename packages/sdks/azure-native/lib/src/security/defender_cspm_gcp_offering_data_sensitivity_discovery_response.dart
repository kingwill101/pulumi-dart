...
class DefenderCspmGcpOfferingDataSensitivityDiscoveryResponse {
  ...
  /// Creates a new [DefenderCspmGcpOfferingDataSensitivityDiscoveryResponse].
  ...
  const DefenderCspmGcpOfferingDataSensitivityDiscoveryResponse({
    this.enabled,
  ...
  factory DefenderCspmGcpOfferingDataSensitivityDiscoveryResponse.fromMap(Map<String, dynamic> map) {
    return DefenderCspmGcpOfferingDataSensitivityDiscoveryResponse(
