...
class DefenderForContainersGcpOfferingNativeCloudConnectionResponse {
  ...
  /// Creates a new [DefenderForContainersGcpOfferingNativeCloudConnectionResponse].
  ...
  const DefenderForContainersGcpOfferingNativeCloudConnectionResponse({
  ...
  factory DefenderForContainersGcpOfferingNativeCloudConnectionResponse.fromMap(Map<String, dynamic> map) {
    return DefenderForContainersGcpOfferingNativeCloudConnectionResponse(
