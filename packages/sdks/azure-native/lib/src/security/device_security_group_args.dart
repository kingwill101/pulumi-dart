...
class DeviceSecurityGroupArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'timeWindowRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<TimeWindowCustomAlertRule>,
            List<Map<String, dynamic>>
          >(
            timeWindowRules,
            (value) =>
    ...
    return DeviceSecurityGroupArgs(
      allowlistRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AllowlistCustomAlertRule>(
            guardedValue,
            (value) => AllowlistCustomAlertRule.fromMap(
      ...
      denylistRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DenylistCustomAlertRule>(
            guardedValue,
            (value) => DenylistCustomAlertRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      deviceSecurityGroupName: (() {
        final guardedValue = map['deviceSecurityGroupName'];
        if (guardedValue == null) return null;
      ...
      thresholdRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ThresholdCustomAlertRule>(
            guardedValue,
            (value) => ThresholdCustomAlertRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      timeWindowRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TimeWindowCustomAlertRule>(
            guardedValue,
            (value) => TimeWindowCustomAlertRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
