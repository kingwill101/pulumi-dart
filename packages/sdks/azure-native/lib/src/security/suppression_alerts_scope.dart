...
class SuppressionAlertsScope {
  ...
  SuppressionAlertsScope({required this.allOf});
    ...
    return <String, dynamic>{
      'allOf':
          ...
          >(
            allOf,
            (value) =>
                pulumi.Input.encodeList<ScopeElement, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory SuppressionAlertsScope.fromMap(Map<String, dynamic> map) {
    return SuppressionAlertsScope(
      allOf: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ScopeElement>(
          map['allOf']!,
          (value) =>
              ScopeElement.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
