...
import 'defender_cspm_jfrog_offering_mdc_containers_image_assessment_response.dart';
...
class DefenderCspmJFrogOfferingResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mdcContainersImageAssessment': ?pulumi.Input.mapOptionalInputValue<DefenderCspmJFrogOfferingMdcContainersImageAssessmentResponse, Map<String, dynamic>>(mdcContainersImageAssessment, (value) => value.toMap()),
  ...
  factory DefenderCspmJFrogOfferingResponse.fromMap(Map<String, dynamic> map) {
    return DefenderCspmJFrogOfferingResponse(
      ...
      mdcContainersImageAssessment: (() { final guardedValue = map['mdcContainersImageAssessment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefenderCspmJFrogOfferingMdcContainersImageAssessmentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
