...
class ExtensionResponse {
  ...
  final dynamic additionalExtensionProperties;
  ...
  factory ExtensionResponse.fromMap(Map<String, dynamic> map) {
    return ExtensionResponse(
      additionalExtensionProperties: map['additionalExtensionProperties'] == null ? null : map['additionalExtensionProperties'],
      isEnabled: map['isEnabled'] as String,
