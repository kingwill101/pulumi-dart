...
class DefenderFoDatabasesAwsOfferingArcAutoProvisioningResponse {
  ...
  /// Creates a new [DefenderFoDatabasesAwsOfferingArcAutoProvisioningResponse].
  ...
  const DefenderFoDatabasesAwsOfferingArcAutoProvisioningResponse({
    this.cloudRoleArn,
    this.configuration,
    this.enabled,
  });
  ...
  factory DefenderFoDatabasesAwsOfferingArcAutoProvisioningResponse.fromMap(Map<String, dynamic> map) {
    return DefenderFoDatabasesAwsOfferingArcAutoProvisioningResponse(
