...
class Pricing extends pulumi.CustomResource {
  ...
  Pricing(
    ...
    this.enablementTime = registerOutput<String>('enablementTime');
    this.enforce = registerOutput<String?>('enforce');
    this.extensions = registerOutput<List<ExtensionResponse>?>('extensions');
    this.freeTrialRemainingTime = registerOutput<String>('freeTrialRemainingTime');
    this.inherited = registerOutput<String>('inherited');
    this.inheritedFrom = registerOutput<String>('inheritedFrom');
    this.name = registerOutput<String>('name');
    this.pricingTier = registerOutput<String>('pricingTier');
    this.replacedBy = registerOutput<List<String>>('replacedBy');
    this.resourcesCoverageStatus = registerOutput<String>('resourcesCoverageStatus');
