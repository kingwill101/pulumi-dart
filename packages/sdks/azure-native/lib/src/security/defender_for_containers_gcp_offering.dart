...
class DefenderForContainersGcpOffering {
  ...
  /// The native cloud connection configuration
  final pulumi.Input<DefenderForContainersGcpOfferingNativeCloudConnection>?
    ...
    return DefenderForContainersGcpOffering(
      dataPipelineNativeCloudConnection: (() {
        ...
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingDataPipelineNativeCloudConnection.fromMap(
      ...
      mdcContainersAgentlessDiscoveryK8s: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8s.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mdcContainersImageAssessment: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingMdcContainersImageAssessment.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      nativeCloudConnection: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingNativeCloudConnection.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      vmScanners: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderForContainersGcpOfferingVmScanners.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
