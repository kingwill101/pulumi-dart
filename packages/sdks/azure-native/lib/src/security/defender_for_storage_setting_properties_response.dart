...
class DefenderForStorageSettingPropertiesResponse {
  ...
  final pulumi.Input<SensitiveDataDiscoveryPropertiesResponse>?
    ...
    return <String, dynamic>{
      ...
      'malwareScanning':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(malwareScanning, (value) => value.toMap()),
      'overrideSubscriptionLevelSettings': ?overrideSubscriptionLevelSettings,
      'sensitiveDataDiscovery':
          ?pulumi.Input.mapOptionalInputValue<
            SensitiveDataDiscoveryPropertiesResponse,
            Map<String, dynamic>
          >(sensitiveDataDiscovery, (value) => value.toMap()),
    };
  }

  factory DefenderForStorageSettingPropertiesResponse.fromMap(
    ...
    return DefenderForStorageSettingPropertiesResponse(
      ...
      malwareScanning: (() {
        final guardedValue = map['malwareScanning'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MalwareScanningPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      overrideSubscriptionLevelSettings: (() {
        final guardedValue = map['overrideSubscriptionLevelSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sensitiveDataDiscovery: (() {
        final guardedValue = map['sensitiveDataDiscovery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SensitiveDataDiscoveryPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
