...
class SecurityAssessmentMetadataPropertiesResponse {
  ...
  final pulumi.Input<SecurityAssessmentMetadataPartnerDataResponse>?
  partnerData;
  ...
  factory SecurityAssessmentMetadataPropertiesResponse.fromMap(
    ...
    return SecurityAssessmentMetadataPropertiesResponse(
      ...
      partnerData: (() {
        ...
        return pulumi.Input.fromValue(
          SecurityAssessmentMetadataPartnerDataResponse.fromMap(
