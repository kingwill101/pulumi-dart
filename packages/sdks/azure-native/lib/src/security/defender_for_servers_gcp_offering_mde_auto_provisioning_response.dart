...
class DefenderForServersGcpOfferingMdeAutoProvisioningResponse {
  ...
  const DefenderForServersGcpOfferingMdeAutoProvisioningResponse({
    this.configuration,
    this.enabled,
  });
  ...
  factory DefenderForServersGcpOfferingMdeAutoProvisioningResponse.fromMap(Map<String, dynamic> map) {
    return DefenderForServersGcpOfferingMdeAutoProvisioningResponse(
