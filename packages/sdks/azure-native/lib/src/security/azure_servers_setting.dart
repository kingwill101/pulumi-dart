...
/// }
///
/// resource "azure-native_security_azureserverssetting" "azureServersSetting" {
///   kind              = "AzureServersSetting"
///   selected_provider = "MdeTvm"
...
class AzureServersSetting extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [AzureServersSetting] resource.
  AzureServersSetting.reference(String urn)
    : super(
        'azure-native:security:AzureServersSetting',
