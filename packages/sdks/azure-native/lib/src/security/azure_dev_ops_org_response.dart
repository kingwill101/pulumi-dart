...
class AzureDevOpsOrgResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': id,
      'name': name,
      'properties': ?pulumi.Input.mapOptionalInputValue<AzureDevOpsOrgPropertiesResponse, Map<String, dynamic>>(properties, (value) => value.toMap()),
  ...
  factory AzureDevOpsOrgResponse.fromMap(Map<String, dynamic> map) {
    return AzureDevOpsOrgResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureDevOpsOrgPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
