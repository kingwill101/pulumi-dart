...
class CustomAssessmentAutomation extends pulumi.CustomResource {
  ...
  CustomAssessmentAutomation(
    ...
    this.assessmentKey = registerOutput<String?>('assessmentKey');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.compressedQuery = registerOutput<String?>('compressedQuery');
    ...
    this.supportedCloud = registerOutput<String?>('supportedCloud');
