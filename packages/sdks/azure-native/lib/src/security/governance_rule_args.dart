...
class GovernanceRuleArgs {
  ...
  final pulumi.Input<GovernanceRuleEmailNotification>?
    ...
    return GovernanceRuleArgs(
      ...
      governanceEmailNotification: (() {
        ...
        return pulumi.Input.fromValue(
          GovernanceRuleEmailNotification.fromMap(
      ...
      ownerSource: pulumi.Input.fromValue(
        GovernanceRuleOwnerSource.fromMap(
