...
class DefenderCspmAwsOfferingVmScannersResponse {
  ...
  /// Creates a new [DefenderCspmAwsOfferingVmScannersResponse].
  /// [cloudRoleArn] The cloud role ARN in AWS for this feature
  /// [configuration] Configuration for VM scanning
  /// [enabled] Is VM scanning enabled
  const DefenderCspmAwsOfferingVmScannersResponse({
    this.cloudRoleArn,
    this.configuration,
    this.enabled,
  });
  ...
  factory DefenderCspmAwsOfferingVmScannersResponse.fromMap(Map<String, dynamic> map) {
    return DefenderCspmAwsOfferingVmScannersResponse(
