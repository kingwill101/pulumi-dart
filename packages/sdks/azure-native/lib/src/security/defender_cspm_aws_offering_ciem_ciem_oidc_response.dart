...
class DefenderCspmAwsOfferingCiemCiemOidcResponse {
  ...
  /// Creates a new [DefenderCspmAwsOfferingCiemCiemOidcResponse].
  ...
  const DefenderCspmAwsOfferingCiemCiemOidcResponse({
  ...
  factory DefenderCspmAwsOfferingCiemCiemOidcResponse.fromMap(Map<String, dynamic> map) {
    return DefenderCspmAwsOfferingCiemCiemOidcResponse(
