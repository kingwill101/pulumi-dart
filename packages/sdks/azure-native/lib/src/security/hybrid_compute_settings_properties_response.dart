...
class HybridComputeSettingsPropertiesResponse {
  ...
  factory HybridComputeSettingsPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return HybridComputeSettingsPropertiesResponse(
      autoProvision: pulumi.Input.fromValue(map['autoProvision'] as String),
      hybridComputeProvisioningState: pulumi.Input.fromValue(
        map['hybridComputeProvisioningState'] as String,
      ),
      proxyServer: (() {
        final guardedValue = map['proxyServer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProxyServerPropertiesResponse.fromMap(
      ...
      servicePrincipal: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServicePrincipalPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
