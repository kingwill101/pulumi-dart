...
class SecurityConnectorArgs {
  ...
  final pulumi.Input<dynamic>? environmentData;
  /// The multi cloud resource's cloud name.
  final pulumi.Input<dynamic>? environmentName;
  ...
  final pulumi.Input<List<dynamic>?>? offerings;
  ...
  factory SecurityConnectorArgs.fromMap(Map<String, dynamic> map) {
    return SecurityConnectorArgs(
      environmentData: (() { final guardedValue = map['environmentData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      environmentName: (() { final guardedValue = map['environmentName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      offerings: (() { final guardedValue = map['offerings']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
