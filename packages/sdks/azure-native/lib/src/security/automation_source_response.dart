...
class AutomationSourceResponse {
  ...
  AutomationSourceResponse({this.eventSource, this.ruleSets});
    ...
    return <String, dynamic>{
      ...
      'ruleSets':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutomationRuleSetResponse>,
  ...
  factory AutomationSourceResponse.fromMap(Map<String, dynamic> map) {
    return AutomationSourceResponse(
      eventSource: (() {
        final guardedValue = map['eventSource'];
      ...
      ruleSets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutomationRuleSetResponse>(
            guardedValue,
            (value) => AutomationRuleSetResponse.fromMap(
