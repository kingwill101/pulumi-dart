...
class CspmMonitorAwsOffering {
  ...
  factory CspmMonitorAwsOffering.fromMap(Map<String, dynamic> map) {
    return CspmMonitorAwsOffering(
      nativeCloudConnection: (() { final guardedValue = map['nativeCloudConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CspmMonitorAwsOfferingNativeCloudConnection.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
