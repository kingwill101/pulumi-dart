...
class DefenderCspmAwsOfferingResponseCiem {
  ...
  final pulumi.Input<DefenderCspmAwsOfferingResponseCiemDiscovery>?
  ciemDiscovery;
  ...
  DefenderCspmAwsOfferingResponseCiem({this.ciemDiscovery, this.ciemOidc});
  ...
  factory DefenderCspmAwsOfferingResponseCiem.fromMap(
    ...
    return DefenderCspmAwsOfferingResponseCiem(
      ciemDiscovery: (() {
        ...
        return pulumi.Input.fromValue(
          DefenderCspmAwsOfferingResponseCiemDiscovery.fromMap(
      ...
      ciemOidc: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefenderCspmAwsOfferingResponseCiemOidc.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
