    ...
    return <String, dynamic>{
      ...
      'components':
          ?pulumi.Input.mapOptionalInputValue<
            List<StandardComponentProperties>,
      ...
      'supportedClouds':
          ?pulumi.Input.mapOptionalInputValue<
            List<StandardSupportedClouds>,
            List<String>
          >(
            supportedClouds,
            (value) => pulumi.Input.encodeList<StandardSupportedClouds, String>(
              value,
    ...
    return StandardArgs(
      ...
      components: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StandardComponentProperties>(
            guardedValue,
            (value) => StandardComponentProperties.fromMap(
      ...
      supportedClouds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StandardSupportedClouds>(
            guardedValue,
            (value) => StandardSupportedClouds.fromValue(value as String),
          ),
        );
      })(),
      tags: (() {
