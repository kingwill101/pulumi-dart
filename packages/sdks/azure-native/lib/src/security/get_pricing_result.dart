  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'extensions': ?(() {
        ...
        return pulumi.Input.encodeList<ExtensionResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetPricingResult.fromMap(Map<String, dynamic> map) {
    return GetPricingResult(
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ExtensionResponse>(
          guardedValue,
          (value) =>
              ExtensionResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
