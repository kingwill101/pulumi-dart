...
class AzureDevOpsOrgPropertiesResponse {
  ...
  factory AzureDevOpsOrgPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AzureDevOpsOrgPropertiesResponse(
      actionableRemediation: (() { final guardedValue = map['actionableRemediation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ActionableRemediationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
