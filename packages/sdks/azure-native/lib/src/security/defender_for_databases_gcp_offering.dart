...
class DefenderForDatabasesGcpOffering {
  ...
  factory DefenderForDatabasesGcpOffering.fromMap(Map<String, dynamic> map) {
    return DefenderForDatabasesGcpOffering(
      arcAutoProvisioning: (() { final guardedValue = map['arcAutoProvisioning']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefenderForDatabasesGcpOfferingArcAutoProvisioning.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defenderForDatabasesArcAutoProvisioning: (() { final guardedValue = map['defenderForDatabasesArcAutoProvisioning']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefenderForDatabasesGcpOfferingDefenderForDatabasesArcAutoProvisioning.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
