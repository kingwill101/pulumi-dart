...
class StandardAssignmentPropertiesAttestationDataResponse {
  ...
  const StandardAssignmentPropertiesAttestationDataResponse({
  ...
  factory StandardAssignmentPropertiesAttestationDataResponse.fromMap(Map<String, dynamic> map) {
    return StandardAssignmentPropertiesAttestationDataResponse(
