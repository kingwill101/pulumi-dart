...
class DefenderForServersAwsOfferingArcAutoProvisioningResponse {
  ...
  /// Creates a new [DefenderForServersAwsOfferingArcAutoProvisioningResponse].
  ...
  const DefenderForServersAwsOfferingArcAutoProvisioningResponse({
    this.cloudRoleArn,
    this.configuration,
    this.enabled,
  });
  ...
  factory DefenderForServersAwsOfferingArcAutoProvisioningResponse.fromMap(Map<String, dynamic> map) {
    return DefenderForServersAwsOfferingArcAutoProvisioningResponse(
