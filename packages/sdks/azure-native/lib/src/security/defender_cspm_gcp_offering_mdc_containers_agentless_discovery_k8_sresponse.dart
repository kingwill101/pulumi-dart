...
class DefenderCspmGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse {
  ...
  /// Creates a new [DefenderCspmGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse].
  ...
  const DefenderCspmGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse({
    this.enabled,
  ...
  factory DefenderCspmGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse.fromMap(Map<String, dynamic> map) {
    return DefenderCspmGcpOfferingMdcContainersAgentlessDiscoveryK8SResponse(
