...
class JitNetworkAccessPolicyArgs {
  ...
  final pulumi.Input<List<JitNetworkAccessPolicyVirtualMachine>>
  virtualMachines;
  ...
  factory JitNetworkAccessPolicyArgs.fromMap(Map<String, dynamic> map) {
    return JitNetworkAccessPolicyArgs(
      ...
      jitNetworkAccessPolicyName: (() {
        final guardedValue = map['jitNetworkAccessPolicyName'];
      ...
      requests: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JitNetworkAccessRequest>(
            guardedValue,
            (value) => JitNetworkAccessRequest.fromMap(
      ...
      virtualMachines: pulumi.Input.fromValue(
        pulumi.Input.decodeList<JitNetworkAccessPolicyVirtualMachine>(
          map['virtualMachines']!,
          (value) => JitNetworkAccessPolicyVirtualMachine.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
