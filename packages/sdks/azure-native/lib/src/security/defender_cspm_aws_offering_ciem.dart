...
class DefenderCspmAwsOfferingCiem {
  ...
  factory DefenderCspmAwsOfferingCiem.fromMap(Map<String, dynamic> map) {
    return DefenderCspmAwsOfferingCiem(
      ciemDiscovery: (() { final guardedValue = map['ciemDiscovery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefenderCspmAwsOfferingCiemDiscovery.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ciemOidc: (() { final guardedValue = map['ciemOidc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefenderCspmAwsOfferingCiemOidc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
