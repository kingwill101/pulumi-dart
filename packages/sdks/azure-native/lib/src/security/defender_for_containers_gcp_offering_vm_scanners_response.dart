...
class DefenderForContainersGcpOfferingVmScannersResponse {
  /// Configuration for VM scanning
  final pulumi.Input<VmScannersBaseConfigurationResponse>? configuration;
  /// Is VM scanning enabled
  final pulumi.Input<bool>? enabled;

  /// Creates a new [DefenderForContainersGcpOfferingVmScannersResponse].
  /// [configuration] Configuration for VM scanning
  /// [enabled] Is VM scanning enabled
  const DefenderForContainersGcpOfferingVmScannersResponse({
    this.configuration,
    this.enabled,
  });
  ...
  factory DefenderForContainersGcpOfferingVmScannersResponse.fromMap(Map<String, dynamic> map) {
    return DefenderForContainersGcpOfferingVmScannersResponse(
