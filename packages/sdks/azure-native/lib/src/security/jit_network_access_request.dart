...
class JitNetworkAccessRequest {
  ...
  final pulumi.Input<List<JitNetworkAccessRequestVirtualMachine>>
  virtualMachines;
    ...
    return <String, dynamic>{
      ...
      'virtualMachines':
          pulumi.Input.mapInputValue<
            List<JitNetworkAccessRequestVirtualMachine>,
  ...
  factory JitNetworkAccessRequest.fromMap(Map<String, dynamic> map) {
    return JitNetworkAccessRequest(
      ...
      virtualMachines: pulumi.Input.fromValue(
        pulumi.Input.decodeList<JitNetworkAccessRequestVirtualMachine>(
          map['virtualMachines']!,
          (value) => JitNetworkAccessRequestVirtualMachine.fromMap(
