...
class CustomAssessmentAutomationArgs {
  ...
  const CustomAssessmentAutomationArgs({
  ...
  factory CustomAssessmentAutomationArgs.fromMap(Map<String, dynamic> map) {
    return CustomAssessmentAutomationArgs(
      compressedQuery: (() { final guardedValue = map['compressedQuery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      customAssessmentAutomationName: (() { final guardedValue = map['customAssessmentAutomationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      supportedCloud: (() { final guardedValue = map['supportedCloud']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
