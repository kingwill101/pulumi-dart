...
class CustomAssessmentAutomationArgs {
  ...
  CustomAssessmentAutomationArgs({
    pulumi.Output<String>? compressedQuery,
    pulumi.Output<String>? customAssessmentAutomationName,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<String>? remediationDescription,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? severity,
    pulumi.Output<String>? supportedCloud,
  }) :
  ...
  factory CustomAssessmentAutomationArgs.fromMap(Map<String, dynamic> map) {
    return CustomAssessmentAutomationArgs(
      compressedQuery: map['compressedQuery'] == null ? null : pulumi.Output.create<String>(map['compressedQuery'] as String),
      customAssessmentAutomationName: map['customAssessmentAutomationName'] == null ? null : pulumi.Output.create<String>(map['customAssessmentAutomationName'] as String),
      ...
      supportedCloud: map['supportedCloud'] == null ? null : pulumi.Output.create<String>(map['supportedCloud'] as String),
    );
  }
}
