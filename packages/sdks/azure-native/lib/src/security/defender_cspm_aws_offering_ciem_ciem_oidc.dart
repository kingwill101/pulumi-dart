...
class DefenderCspmAwsOfferingCiemCiemOidc {
  ...
  const DefenderCspmAwsOfferingCiemCiemOidc({
  ...
  factory DefenderCspmAwsOfferingCiemCiemOidc.fromMap(Map<String, dynamic> map) {
    return DefenderCspmAwsOfferingCiemCiemOidc(
