...
class CustomRecommendationArgs {
  ...
  final pulumi.Input<dynamic>? securityIssue;
  /// The severity to relate to the assessments generated by this Recommendation.
  ...
  CustomRecommendationArgs({
    ...
    required this.scope,
    pulumi.Input<dynamic>? securityIssue,
    pulumi.Input<dynamic>? severity,
  }) : securityIssue = securityIssue ?? pulumi.Input.fromValue('BestPractices'), severity = severity ?? pulumi.Input.fromValue('Low');
  ...
  factory CustomRecommendationArgs.fromMap(Map<String, dynamic> map) {
    return CustomRecommendationArgs(
      ...
      customRecommendationName: (() { final guardedValue = map['customRecommendationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      securityIssue: (() { final guardedValue = map['securityIssue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
