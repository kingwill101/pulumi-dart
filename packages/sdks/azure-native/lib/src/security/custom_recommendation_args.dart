...
class CustomRecommendationArgs {
  ...
  const CustomRecommendationArgs({
    this.cloudProviders,
  ...
  factory CustomRecommendationArgs.fromMap(Map<String, dynamic> map) {
    return CustomRecommendationArgs(
      ...
      securityIssue: (() { final guardedValue = map['securityIssue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
