...
class VmScannersBaseConfigurationResponse {
  ...
  const VmScannersBaseConfigurationResponse({
    this.exclusionTags,
    this.scanningMode,
  });
  ...
  factory VmScannersBaseConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return VmScannersBaseConfigurationResponse(
