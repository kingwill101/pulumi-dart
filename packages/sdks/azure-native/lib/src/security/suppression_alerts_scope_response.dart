...
class SuppressionAlertsScopeResponse {
  ...
  SuppressionAlertsScopeResponse({required this.allOf});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allOf':
          pulumi.Input.mapInputValue<
            List<ScopeElementResponse>,
  ...
  factory SuppressionAlertsScopeResponse.fromMap(Map<String, dynamic> map) {
    return SuppressionAlertsScopeResponse(
      allOf: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ScopeElementResponse>(
          map['allOf']!,
          (value) => ScopeElementResponse.fromMap(
