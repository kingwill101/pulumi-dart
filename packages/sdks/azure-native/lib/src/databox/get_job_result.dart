...
class GetJobResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deliveryInfo': ?deliveryInfo == null ? null : deliveryInfo!.toMap(),
  ...
  factory GetJobResult.fromMap(Map<String, dynamic> map) {
    return GetJobResult(
      ...
      deliveryInfo: map['deliveryInfo'] == null ? null : JobDeliveryInfoResponse.fromMap((map['deliveryInfo']! as Map).cast<String, dynamic>()),
      deliveryType: map['deliveryType'] == null ? null : map['deliveryType']! as String,
      details: map['details'] == null ? null : DataBoxCustomerDiskJobDetailsResponse.fromMap((map['details']! as Map).cast<String, dynamic>()),
