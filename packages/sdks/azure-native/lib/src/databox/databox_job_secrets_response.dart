...
class DataboxJobSecretsResponse {
  ...
  factory DataboxJobSecretsResponse.fromMap(Map<String, dynamic> map) {
    return DataboxJobSecretsResponse(
      ...
      podSecrets: (() { final guardedValue = map['podSecrets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DataBoxSecretResponse>(guardedValue, (value) => DataBoxSecretResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
