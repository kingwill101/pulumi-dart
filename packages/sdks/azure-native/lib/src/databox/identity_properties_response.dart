...
class IdentityPropertiesResponse {
  ...
  IdentityPropertiesResponse({this.type, this.userAssigned});
    ...
    return <String, dynamic>{
      ...
      'userAssigned':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(userAssigned, (value) => value.toMap()),
    };
  }
  ...
  factory IdentityPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IdentityPropertiesResponse(
      ...
      userAssigned: (() {
        final guardedValue = map['userAssigned'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserAssignedPropertiesResponse.fromMap(
