...
class DataBoxDiskJobSecretsResponse {
  ...
  factory DataBoxDiskJobSecretsResponse.fromMap(Map<String, dynamic> map) {
    return DataBoxDiskJobSecretsResponse(
      ...
      diskSecrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DiskSecretResponse>(
          map['diskSecrets']!,
          (value) => DiskSecretResponse.fromMap(
      ...
      isPasskeyUserDefined: pulumi.Input.fromValue(
        map['isPasskeyUserDefined'] as bool,
      ),
