...
class JobArgs {
  ...
  final pulumi.Input<dynamic>? deliveryType;
  ...
  final pulumi.Input<dynamic> transferType;
  ...
  JobArgs({
    this.deliveryInfo,
    pulumi.Input<dynamic>? deliveryType,
    this.details,
    this.identity,
    this.jobName,
    this.location,
  ...
  }) : deliveryType = deliveryType ?? pulumi.Input.fromValue('NonScheduled');
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      deliveryType: (() { final guardedValue = map['deliveryType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      transferType: pulumi.Input.fromValue(map['transferType']),
    );
  }
}
