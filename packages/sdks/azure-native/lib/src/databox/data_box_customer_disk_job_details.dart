...
class DataBoxCustomerDiskJobDetails {
  ...
  factory DataBoxCustomerDiskJobDetails.fromMap(Map<String, dynamic> map) {
    return DataBoxCustomerDiskJobDetails(
      ...
      importDiskDetailsCollection: (() { final guardedValue = map['importDiskDetailsCollection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ImportDiskDetails>(guardedValue, (value) => ImportDiskDetails.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      returnToCustomerPackageDetails: pulumi.Input.fromValue(PackageCarrierDetails.fromMap((map['returnToCustomerPackageDetails']! as Map).cast<String, dynamic>())),
