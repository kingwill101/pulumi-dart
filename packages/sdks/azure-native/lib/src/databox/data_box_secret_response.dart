...
class DataBoxSecretResponse {
  ...
  factory DataBoxSecretResponse.fromMap(Map<String, dynamic> map) {
    return DataBoxSecretResponse(
      accountCredentialDetails: (pulumi.Input.decodeList<AccountCredentialDetailsResponse>(map['accountCredentialDetails'], (value) => AccountCredentialDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      devicePassword: (map['devicePassword'] as String).input(),
      deviceSerialNumber: (map['deviceSerialNumber'] as String).input(),
      encodedValidationCertPubKey: (map['encodedValidationCertPubKey'] as String).input(),
      networkConfigurations: (pulumi.Input.decodeList<ApplianceNetworkConfigurationResponse>(map['networkConfigurations'], (value) => ApplianceNetworkConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
