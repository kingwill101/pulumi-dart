...
class DataBoxDiskJobDetailsResponse {
  ...
  /// Copy progress per disk.
  final pulumi.Input<List<DataBoxDiskGranularCopyLogDetailsResponse>>
  granularCopyLogDetails;

  /// Copy progress per disk.
  final pulumi.Input<List<DataBoxDiskGranularCopyProgressResponse>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'copyProgress':
          pulumi.Input.mapInputValue<
            List<DataBoxDiskCopyProgressResponse>,
            List<Map<String, dynamic>>
          >(
            copyProgress,
            (value) =>
      ...
      'granularCopyLogDetails':
          pulumi.Input.mapInputValue<
            List<DataBoxDiskGranularCopyLogDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            granularCopyLogDetails,
            (value) =>
      ...
      'granularCopyProgress':
          pulumi.Input.mapInputValue<
            List<DataBoxDiskGranularCopyProgressResponse>,
            List<Map<String, dynamic>>
          >(
            granularCopyProgress,
            (value) =>
  ...
  factory DataBoxDiskJobDetailsResponse.fromMap(Map<String, dynamic> map) {
    return DataBoxDiskJobDetailsResponse(
      ...
      copyProgress: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataBoxDiskCopyProgressResponse>(
          map['copyProgress']!,
          (value) => DataBoxDiskCopyProgressResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      disksAndSizeDetails: pulumi.Input.fromValue(
        (map['disksAndSizeDetails'] as Map).cast<String, int>(),
      ),
      ...
      granularCopyLogDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataBoxDiskGranularCopyLogDetailsResponse>(
          map['granularCopyLogDetails']!,
          (value) => DataBoxDiskGranularCopyLogDetailsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      granularCopyProgress: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataBoxDiskGranularCopyProgressResponse>(
          map['granularCopyProgress']!,
          (value) => DataBoxDiskGranularCopyProgressResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
