...
class DataBoxHeavyJobSecretsResponse {
    ...
    return <String, dynamic>{
      'cabinetPodSecrets':
          pulumi.Input.mapInputValue<
            List<DataBoxHeavySecretResponse>,
  ...
  factory DataBoxHeavyJobSecretsResponse.fromMap(Map<String, dynamic> map) {
    return DataBoxHeavyJobSecretsResponse(
      cabinetPodSecrets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataBoxHeavySecretResponse>(
          map['cabinetPodSecrets']!,
          (value) => DataBoxHeavySecretResponse.fromMap(
