...
class DataBoxCustomerDiskJobDetailsResponse {
  ...
  final pulumi.Input<List<DataBoxCustomerDiskCopyProgressResponse>>
  copyProgress;
  ...
  final pulumi.Input<DatacenterAddressInstructionResponseResponse>
  datacenterAddress;
  ...
  final pulumi.Input<Map<String, ExportDiskDetailsResponse>>
  exportDiskDetailsCollection;

  /// Contains the map of disk serial number to the disk details for import jobs.
  final pulumi.Input<Map<String, ImportDiskDetailsResponse>>?
  ...
  final pulumi.Input<LastMitigationActionOnJobResponse>
  ...
  /// Return package shipping details.
  final pulumi.Input<PackageCarrierDetailsResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'copyLogDetails':
          pulumi.Input.mapInputValue<
            List<DataBoxAccountCopyLogDetailsResponse>,
      ...
      'copyProgress':
          pulumi.Input.mapInputValue<
            List<DataBoxCustomerDiskCopyProgressResponse>,
            List<Map<String, dynamic>>
          >(
            copyProgress,
            (value) =>
      ...
      'dataExportDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataExportDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            dataExportDetails,
            (value) =>
      ...
      'dataImportDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataImportDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            dataImportDetails,
            (value) =>
      ...
      'datacenterAddress':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(datacenterAddress, (value) => value.toMap()),
      'deliverToDcPackageDetails':
          pulumi.Input.mapInputValue<
            PackageCarrierInfoResponse,
            Map<String, dynamic>
          >(deliverToDcPackageDetails, (value) => value.toMap()),
      'deliveryPackage':
          pulumi.Input.mapInputValue<
            PackageShippingDetailsResponse,
            Map<String, dynamic>
          >(deliveryPackage, (value) => value.toMap()),
      'deviceErasureDetails':
          pulumi.Input.mapInputValue<
            DeviceErasureDetailsResponse,
            Map<String, dynamic>
          >(deviceErasureDetails, (value) => value.toMap()),
      'enableManifestBackup': ?enableManifestBackup,
      'expectedDataSizeInTeraBytes': ?expectedDataSizeInTeraBytes,
      'exportDiskDetailsCollection':
          pulumi.Input.mapInputValue<
            Map<String, ExportDiskDetailsResponse>,
      ...
      'importDiskDetailsCollection':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, ImportDiskDetailsResponse>,
            Map<String, Map<String, dynamic>>
          >(
            importDiskDetailsCollection,
            (value) =>
      ...
      'lastMitigationActionOnJob':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(lastMitigationActionOnJob, (value) => value.toMap()),
      'preferences':
          ?pulumi.Input.mapOptionalInputValue<
            PreferencesResponse,
            Map<String, dynamic>
      ...
      'returnPackage':
          pulumi.Input.mapInputValue<
            PackageShippingDetailsResponse,
            Map<String, dynamic>
          >(returnPackage, (value) => value.toMap()),
      'returnToCustomerPackageDetails':
          pulumi.Input.mapInputValue<
  ...
  factory DataBoxCustomerDiskJobDetailsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return DataBoxCustomerDiskJobDetailsResponse(
      actions: pulumi.Input.fromValue((map['actions'] as List).cast<String>()),
      chainOfCustodySasKey: pulumi.Input.fromValue(
        map['chainOfCustodySasKey'] as String,
      ),
      ...
      copyLogDetails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataBoxAccountCopyLogDetailsResponse>(
          map['copyLogDetails']!,
          (value) => DataBoxAccountCopyLogDetailsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      copyProgress: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataBoxCustomerDiskCopyProgressResponse>(
          map['copyProgress']!,
          (value) => DataBoxCustomerDiskCopyProgressResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      dataExportDetails: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataExportDetailsResponse>(
            guardedValue,
            (value) => DataExportDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      dataImportDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataImportDetailsResponse>(
            guardedValue,
            (value) => DataImportDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      datacenterAddress: pulumi.Input.fromValue(
        DatacenterAddressInstructionResponseResponse.fromMap(
          (map['datacenterAddress']! as Map).cast<String, dynamic>(),
        ),
      ),
      deliverToDcPackageDetails: pulumi.Input.fromValue(
        PackageCarrierInfoResponse.fromMap(
          (map['deliverToDcPackageDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      deliveryPackage: pulumi.Input.fromValue(
        PackageShippingDetailsResponse.fromMap(
          (map['deliveryPackage']! as Map).cast<String, dynamic>(),
        ),
      ),
      deviceErasureDetails: pulumi.Input.fromValue(
        DeviceErasureDetailsResponse.fromMap(
          (map['deviceErasureDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      exportDiskDetailsCollection: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<ExportDiskDetailsResponse>(
          map['exportDiskDetailsCollection']!,
          (value) => ExportDiskDetailsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      importDiskDetailsCollection: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ImportDiskDetailsResponse>(
            guardedValue,
            (value) => ImportDiskDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      jobStages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<JobStagesResponse>(
          map['jobStages']!,
          (value) =>
              JobStagesResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      keyEncryptionKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KeyEncryptionKeyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      lastMitigationActionOnJob: pulumi.Input.fromValue(
        LastMitigationActionOnJobResponse.fromMap(
          (map['lastMitigationActionOnJob']! as Map).cast<String, dynamic>(),
        ),
      ),
      preferences: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PreferencesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      returnPackage: pulumi.Input.fromValue(
        PackageShippingDetailsResponse.fromMap(
          (map['returnPackage']! as Map).cast<String, dynamic>(),
        ),
      ),
      returnToCustomerPackageDetails: pulumi.Input.fromValue(
        PackageCarrierDetailsResponse.fromMap(
          (map['returnToCustomerPackageDetails']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      reverseShipmentLabelSasKey: pulumi.Input.fromValue(
        map['reverseShipmentLabelSasKey'] as String,
      ),
      reverseShippingDetails: (() {
        final guardedValue = map['reverseShippingDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReverseShippingDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
