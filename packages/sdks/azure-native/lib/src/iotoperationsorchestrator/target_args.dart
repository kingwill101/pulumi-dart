...
class TargetArgs {
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      ...
      topologies: (() { final guardedValue = map['topologies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TopologiesProperties>(guardedValue, (value) => TopologiesProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
