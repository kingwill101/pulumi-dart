...
class SaasResourceResponseProperties {
  ...
  factory SaasResourceResponseProperties.fromMap(Map<String, dynamic> map) {
    return SaasResourceResponseProperties(
      ...
      term: (() { final guardedValue = map['term']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SaasPropertiesResponseTerm.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
