...
class RegistryEndpointArtifactPullSecretAuthenticationResponse {
  ...
  final pulumi.Input<RegistryEndpointArtifactPullSecretSettingsResponse>
    ...
    return <String, dynamic>{
      'artifactPullSecretSettings':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(artifactPullSecretSettings, (value) => value.toMap()),
      'method': method,
    };
  }

  factory RegistryEndpointArtifactPullSecretAuthenticationResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return RegistryEndpointArtifactPullSecretAuthenticationResponse(
      artifactPullSecretSettings: pulumi.Input.fromValue(
        RegistryEndpointArtifactPullSecretSettingsResponse.fromMap(
          (map['artifactPullSecretSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
