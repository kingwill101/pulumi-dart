...
class AkriConnectorTemplateDeviceInboundEndpointTypeResponse {
    ...
    return <String, dynamic>{
      'configurationSchemaRefs':
          ?pulumi.Input.mapOptionalInputValue<
            AkriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefsResponse,
            Map<String, dynamic>
          >(configurationSchemaRefs, (value) => value.toMap()),
  ...
  factory AkriConnectorTemplateDeviceInboundEndpointTypeResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AkriConnectorTemplateDeviceInboundEndpointTypeResponse(
      configurationSchemaRefs: (() {
        final guardedValue = map['configurationSchemaRefs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorTemplateDeviceInboundEndpointConfigurationSchemaRefsResponse.fromMap(
