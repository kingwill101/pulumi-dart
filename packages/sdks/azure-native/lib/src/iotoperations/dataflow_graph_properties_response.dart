...
class DataflowGraphPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'nodeConnections':
          pulumi.Input.mapInputValue<
            List<DataflowGraphNodeConnectionResponse>,
      ...
      'nodes':
          pulumi.Input.mapInputValue<
            List<DataflowGraphDestinationNodeResponse>,
            List<Map<String, dynamic>>
          >(
            nodes,
            (value) =>
  ...
  factory DataflowGraphPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DataflowGraphPropertiesResponse(
      ...
      nodeConnections: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataflowGraphNodeConnectionResponse>(
          map['nodeConnections']!,
          (value) => DataflowGraphNodeConnectionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nodes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataflowGraphDestinationNodeResponse>(
          map['nodes']!,
          (value) => DataflowGraphDestinationNodeResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      requestDiskPersistence: (() {
        final guardedValue = map['requestDiskPersistence'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
