...
class AkriConnectorTemplateRuntimeImageConfigurationResponse {
  ...
  const AkriConnectorTemplateRuntimeImageConfigurationResponse({
  ...
  factory AkriConnectorTemplateRuntimeImageConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return AkriConnectorTemplateRuntimeImageConfigurationResponse(
      ...
      imageConfigurationSettings: pulumi.Input.fromValue(AkriConnectorTemplateRuntimeImageConfigurationSettingsResponse.fromMap((map['imageConfigurationSettings']! as Map).cast<String, dynamic>())),
