...
class GetDataflowResult {
  ...
  final DataflowPropertiesResponse? properties;
  ...
  factory GetDataflowResult.fromMap(Map<String, dynamic> map) {
    return GetDataflowResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return DataflowPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
