...
class BrokerAuthenticatorMethodsResponse {
  ...
  final pulumi.Input<BrokerAuthenticatorMethodSatResponse>?
    ...
    return <String, dynamic>{
      'customSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customSettings, (value) => value.toMap()),
      'method': method,
      'serviceAccountTokenSettings':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'x509Settings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(x509Settings, (value) => value.toMap()),
    };
  }
  ...
  factory BrokerAuthenticatorMethodsResponse.fromMap(Map<String, dynamic> map) {
    return BrokerAuthenticatorMethodsResponse(
      customSettings: (() {
        final guardedValue = map['customSettings'];
      ...
      x509Settings: (() {
        final guardedValue = map['x509Settings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
