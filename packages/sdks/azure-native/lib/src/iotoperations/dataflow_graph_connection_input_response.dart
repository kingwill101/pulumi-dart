...
class DataflowGraphConnectionInputResponse {
  ...
  DataflowGraphConnectionInputResponse({required this.name, this.schema});
  ...
  factory DataflowGraphConnectionInputResponse.fromMap(
    ...
    return DataflowGraphConnectionInputResponse(
      ...
      schema: (() {
        ...
        return pulumi.Input.fromValue(
          DataflowGraphConnectionSchemaSettingsResponse.fromMap(
