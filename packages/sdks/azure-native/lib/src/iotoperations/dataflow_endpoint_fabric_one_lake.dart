...
class DataflowEndpointFabricOneLake {
  ...
  final pulumi.Input<DataflowEndpointFabricOneLakeAuthentication>
  authentication;
  ...
  factory DataflowEndpointFabricOneLake.fromMap(Map<String, dynamic> map) {
    return DataflowEndpointFabricOneLake(
      authentication: pulumi.Input.fromValue(
        DataflowEndpointFabricOneLakeAuthentication.fromMap(
      ...
      names: pulumi.Input.fromValue(
        DataflowEndpointFabricOneLakeNames.fromMap(
