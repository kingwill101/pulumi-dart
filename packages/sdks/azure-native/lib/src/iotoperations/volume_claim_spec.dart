...
class VolumeClaimSpec {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSource': ?pulumi.Input.mapOptionalInputValue<LocalKubernetesReference, Map<String, dynamic>>(dataSource, (value) => value.toMap()),
      'dataSourceRef': ?pulumi.Input.mapOptionalInputValue<KubernetesReference, Map<String, dynamic>>(dataSourceRef, (value) => value.toMap()),
      'resources': ?pulumi.Input.mapOptionalInputValue<VolumeClaimResourceRequirements, Map<String, dynamic>>(resources, (value) => value.toMap()),
      'selector': ?pulumi.Input.mapOptionalInputValue<VolumeClaimSpecSelector, Map<String, dynamic>>(selector, (value) => value.toMap()),
  ...
  factory VolumeClaimSpec.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpec(
      ...
      dataSource: (() { final guardedValue = map['dataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocalKubernetesReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceRef: (() { final guardedValue = map['dataSourceRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimResourceRequirements.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      selector: (() { final guardedValue = map['selector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimSpecSelector.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
