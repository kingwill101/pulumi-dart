...
class VolumeClaimSpec {
  ...
  factory VolumeClaimSpec.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpec(
      ...
      dataSource: map['dataSource'] == null ? null : (LocalKubernetesReference.fromMap((map['dataSource'] as Map).cast<String, dynamic>())).input(),
      dataSourceRef: map['dataSourceRef'] == null ? null : (KubernetesReference.fromMap((map['dataSourceRef'] as Map).cast<String, dynamic>())).input(),
