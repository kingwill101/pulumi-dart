...
class DataflowEndpointFabricOneLakeResponse {
  ...
  final pulumi.Input<DataflowEndpointFabricOneLakeAuthenticationResponse>
  authentication;
  ...
  factory DataflowEndpointFabricOneLakeResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return DataflowEndpointFabricOneLakeResponse(
      authentication: pulumi.Input.fromValue(
        DataflowEndpointFabricOneLakeAuthenticationResponse.fromMap(
      ...
      names: pulumi.Input.fromValue(
        DataflowEndpointFabricOneLakeNamesResponse.fromMap(
