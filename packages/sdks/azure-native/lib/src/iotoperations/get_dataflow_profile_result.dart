...
class GetDataflowProfileResult {
  ...
  factory GetDataflowProfileResult.fromMap(Map<String, dynamic> map) {
    return GetDataflowProfileResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return DataflowProfilePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
