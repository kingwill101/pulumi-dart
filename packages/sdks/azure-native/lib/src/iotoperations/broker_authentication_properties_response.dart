...
class BrokerAuthenticationPropertiesResponse {
  ...
  final pulumi.Input<List<BrokerAuthenticatorMethodsResponse>>
    ...
    return <String, dynamic>{
      'authenticationMethods':
          pulumi.Input.mapInputValue<
            List<BrokerAuthenticatorMethodsResponse>,
  ...
  factory BrokerAuthenticationPropertiesResponse.fromMap(
