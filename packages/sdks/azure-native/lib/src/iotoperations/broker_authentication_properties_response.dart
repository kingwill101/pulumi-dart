...
class BrokerAuthenticationPropertiesResponse {
  ...
  factory BrokerAuthenticationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return BrokerAuthenticationPropertiesResponse(
      authenticationMethods: pulumi.Input.fromValue(pulumi.Input.decodeList<BrokerAuthenticatorMethodsResponse>(map['authenticationMethods']!, (value) => BrokerAuthenticatorMethodsResponse.fromMap((value as Map).cast<String, dynamic>()))),
