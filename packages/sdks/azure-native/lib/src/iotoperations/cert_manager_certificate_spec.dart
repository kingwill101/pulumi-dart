...
class CertManagerCertificateSpec {
  ...
  const CertManagerCertificateSpec({
    this.duration,
  ...
  factory CertManagerCertificateSpec.fromMap(Map<String, dynamic> map) {
    return CertManagerCertificateSpec(
      ...
      issuerRef: pulumi.Input.fromValue(CertManagerIssuerRef.fromMap((map['issuerRef']! as Map).cast<String, dynamic>())),
      privateKey: (() { final guardedValue = map['privateKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertManagerPrivateKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      san: (() { final guardedValue = map['san']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SanForCert.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
