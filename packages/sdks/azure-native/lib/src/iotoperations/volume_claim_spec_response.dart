...
class VolumeClaimSpecResponse {
  ...
  factory VolumeClaimSpecResponse.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpecResponse(
      ...
      dataSource: (() { final guardedValue = map['dataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocalKubernetesReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceRef: (() { final guardedValue = map['dataSourceRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
