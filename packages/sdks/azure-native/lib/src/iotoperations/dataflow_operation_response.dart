...
class DataflowOperationResponse {
  ...
  final pulumi.Input<DataflowBuiltInTransformationSettingsResponse>?
  builtInTransformationSettings;

  /// Destination configuration.
  final pulumi.Input<DataflowDestinationOperationSettingsResponse>?
  destinationSettings;
    ...
    return <String, dynamic>{
      'builtInTransformationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(builtInTransformationSettings, (value) => value.toMap()),
      'destinationSettings':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory DataflowOperationResponse.fromMap(Map<String, dynamic> map) {
    return DataflowOperationResponse(
      builtInTransformationSettings: (() {
        final guardedValue = map['builtInTransformationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataflowBuiltInTransformationSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      destinationSettings: (() {
        final guardedValue = map['destinationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataflowDestinationOperationSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sourceSettings: (() {
        final guardedValue = map['sourceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataflowSourceOperationSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
