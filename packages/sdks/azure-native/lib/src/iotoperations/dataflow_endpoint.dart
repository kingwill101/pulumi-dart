...
class DataflowEndpoint extends pulumi.CustomResource {
  ...
  DataflowEndpoint(
    ...
    properties = registerOutput<DataflowEndpointPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DataflowEndpointPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [DataflowEndpoint] resource.
  DataflowEndpoint.reference(String urn)
    : super(
        'azure-native:iotoperations:DataflowEndpoint',
