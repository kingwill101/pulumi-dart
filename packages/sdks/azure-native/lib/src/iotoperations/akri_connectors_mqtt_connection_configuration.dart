...
class AkriConnectorsMqttConnectionConfiguration {
  ...
  final pulumi.Input<AkriConnectorsServiceAccountAuthentication>?
  authentication;
  ...
  factory AkriConnectorsMqttConnectionConfiguration.fromMap(
    ...
    return AkriConnectorsMqttConnectionConfiguration(
      authentication: (() {
        ...
        return pulumi.Input.fromValue(
          AkriConnectorsServiceAccountAuthentication.fromMap(
      ...
      keepAliveSeconds: (() {
        final guardedValue = map['keepAliveSeconds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxInflightMessages: (() {
        final guardedValue = map['maxInflightMessages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      protocol: (() {
      ...
      sessionExpirySeconds: (() {
        final guardedValue = map['sessionExpirySeconds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      tls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TlsProperties.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
