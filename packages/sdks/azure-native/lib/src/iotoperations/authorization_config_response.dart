...
class AuthorizationConfigResponse {
  ...
  AuthorizationConfigResponse({this.cache, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthorizationRuleResponse>,
    ...
    return AuthorizationConfigResponse(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorizationRuleResponse>(
            guardedValue,
            (value) => AuthorizationRuleResponse.fromMap(
