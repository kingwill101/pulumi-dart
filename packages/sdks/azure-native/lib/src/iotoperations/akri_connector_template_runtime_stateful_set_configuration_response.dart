...
class AkriConnectorTemplateRuntimeStatefulSetConfigurationResponse {
  ...
  final pulumi.Input<AkriConnectorTemplateBucketizedAllocationResponse>?
  allocation;
  ...
  final pulumi.Input<List<AkriConnectorTemplatePersistentVolumeClaimResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'persistentVolumeClaims':
          ?pulumi.Input.mapOptionalInputValue<
            List<AkriConnectorTemplatePersistentVolumeClaimResponse>,
      ...
      'secrets':
          ?pulumi.Input.mapOptionalInputValue<
            List<AkriConnectorsSecretResponse>,
            List<Map<String, dynamic>>
          >(
            secrets,
            (value) =>
  ...
  factory AkriConnectorTemplateRuntimeStatefulSetConfigurationResponse.fromMap(
    ...
    return AkriConnectorTemplateRuntimeStatefulSetConfigurationResponse(
      ...
      allocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorTemplateBucketizedAllocationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      managedConfigurationType: pulumi.Input.fromValue(
        map['managedConfigurationType'] as String,
      ),
      persistentVolumeClaimTemplates: (() {
        final guardedValue = map['persistentVolumeClaimTemplates'];
        if (guardedValue == null) return null;
      ...
      persistentVolumeClaims: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AkriConnectorTemplatePersistentVolumeClaimResponse.fromMap(
      ...
      secrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AkriConnectorsSecretResponse>(
            guardedValue,
            (value) => AkriConnectorsSecretResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      statefulSetConfigurationSettings: pulumi.Input.fromValue(
        map['statefulSetConfigurationSettings'],
      ),
      trustSettings: (() {
        final guardedValue = map['trustSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorTemplateTrustListResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
