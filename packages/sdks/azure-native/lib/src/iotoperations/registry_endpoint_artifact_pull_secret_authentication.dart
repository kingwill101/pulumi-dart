...
class RegistryEndpointArtifactPullSecretAuthentication {
  ...
  final pulumi.Input<RegistryEndpointArtifactPullSecretSettings>
  ...
  factory RegistryEndpointArtifactPullSecretAuthentication.fromMap(
    Map<String, dynamic> map,
  ) {
    return RegistryEndpointArtifactPullSecretAuthentication(
      artifactPullSecretSettings: pulumi.Input.fromValue(
        RegistryEndpointArtifactPullSecretSettings.fromMap(
