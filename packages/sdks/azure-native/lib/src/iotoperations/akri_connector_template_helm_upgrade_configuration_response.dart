...
class AkriConnectorTemplateHelmUpgradeConfigurationResponse {
  ...
  /// Creates a new [AkriConnectorTemplateHelmUpgradeConfigurationResponse].
  ...
  const AkriConnectorTemplateHelmUpgradeConfigurationResponse({
    this.atomic,
    this.disableHooks,
    this.timeout,
    this.wait,
  ...
  factory AkriConnectorTemplateHelmUpgradeConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return AkriConnectorTemplateHelmUpgradeConfigurationResponse(
