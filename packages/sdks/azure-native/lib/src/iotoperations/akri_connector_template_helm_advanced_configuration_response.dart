...
class AkriConnectorTemplateHelmAdvancedConfigurationResponse {
  ...
  const AkriConnectorTemplateHelmAdvancedConfigurationResponse({
    this.delete,
    this.install,
    this.upgrade,
  });
  ...
  factory AkriConnectorTemplateHelmAdvancedConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return AkriConnectorTemplateHelmAdvancedConfigurationResponse(
      delete: (() { final guardedValue = map['delete']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AkriConnectorTemplateHelmDeleteConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      install: (() { final guardedValue = map['install']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AkriConnectorTemplateHelmInstallConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      upgrade: (() { final guardedValue = map['upgrade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AkriConnectorTemplateHelmUpgradeConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
