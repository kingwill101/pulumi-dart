...
class BrokerAuthenticationArgs {
  ...
  factory BrokerAuthenticationArgs.fromMap(Map<String, dynamic> map) {
    return BrokerAuthenticationArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BrokerAuthenticationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
