...
class DataflowEndpointDataLakeStorageAuthenticationResponse {
  ...
  final pulumi.Input<DataflowEndpointAuthenticationAccessTokenResponse>?
  accessTokenSettings;
    ...
    return <String, dynamic>{
      'accessTokenSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(accessTokenSettings, (value) => value.toMap()),
      'method': method,
      'systemAssignedManagedIdentitySettings':
          ?pulumi.Input.mapOptionalInputValue<
            DataflowEndpointAuthenticationSystemAssignedManagedIdentityResponse,
  ...
  factory DataflowEndpointDataLakeStorageAuthenticationResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return DataflowEndpointDataLakeStorageAuthenticationResponse(
      accessTokenSettings: (() {
        final guardedValue = map['accessTokenSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataflowEndpointAuthenticationAccessTokenResponse.fromMap(
