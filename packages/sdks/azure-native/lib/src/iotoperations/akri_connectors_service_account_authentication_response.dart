...
class AkriConnectorsServiceAccountAuthenticationResponse {
  ...
  final pulumi.Input<AkriConnectorsServiceAccountTokenSettingsResponse>
  ...
  factory AkriConnectorsServiceAccountAuthenticationResponse.fromMap(
    ...
    return AkriConnectorsServiceAccountAuthenticationResponse(
      ...
      serviceAccountTokenSettings: pulumi.Input.fromValue(
        AkriConnectorsServiceAccountTokenSettingsResponse.fromMap(
