  ...
  factory AuthorizationRule.fromMap(Map<String, dynamic> map) {
    return AuthorizationRule(
      brokerResources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BrokerResourceRule>(
          map['brokerResources']!,
          (value) => BrokerResourceRule.fromMap(
      ...
      stateStoreResources: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StateStoreResourceRule>(
            guardedValue,
            (value) => StateStoreResourceRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
