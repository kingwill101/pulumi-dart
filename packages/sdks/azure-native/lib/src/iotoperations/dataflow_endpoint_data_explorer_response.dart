...
class DataflowEndpointDataExplorerResponse {
  ...
  final pulumi.Input<DataflowEndpointDataExplorerAuthenticationResponse>
  authentication;
  ...
  factory DataflowEndpointDataExplorerResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return DataflowEndpointDataExplorerResponse(
      authentication: pulumi.Input.fromValue(
        DataflowEndpointDataExplorerAuthenticationResponse.fromMap(
