...
class GetAkriConnectorTemplateResult {
  ...
  factory GetAkriConnectorTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetAkriConnectorTemplateResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return AkriConnectorTemplatePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
