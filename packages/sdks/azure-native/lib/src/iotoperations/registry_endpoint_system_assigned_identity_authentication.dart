...
class RegistryEndpointSystemAssignedIdentityAuthentication {
  ...
  const RegistryEndpointSystemAssignedIdentityAuthentication({
  ...
  factory RegistryEndpointSystemAssignedIdentityAuthentication.fromMap(Map<String, dynamic> map) {
    return RegistryEndpointSystemAssignedIdentityAuthentication(
      ...
      systemAssignedManagedIdentitySettings: pulumi.Input.fromValue(RegistryEndpointSystemAssignedManagedIdentitySettings.fromMap((map['systemAssignedManagedIdentitySettings']! as Map).cast<String, dynamic>())),
    );
  }
}
