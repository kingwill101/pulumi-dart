...
class BrokerPropertiesResponse {
  ...
  factory BrokerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return BrokerPropertiesResponse(
      advanced: (() { final guardedValue = map['advanced']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdvancedSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cardinality: (() { final guardedValue = map['cardinality']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CardinalityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      diagnostics: (() { final guardedValue = map['diagnostics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BrokerDiagnosticsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      diskBackedMessageBuffer: (() { final guardedValue = map['diskBackedMessageBuffer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskBackedMessageBufferResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      generateResourceLimits: (() { final guardedValue = map['generateResourceLimits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GenerateResourceLimitsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
