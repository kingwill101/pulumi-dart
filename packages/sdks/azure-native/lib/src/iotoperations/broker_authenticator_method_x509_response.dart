...
class BrokerAuthenticatorMethodX509Response {
  ...
  factory BrokerAuthenticatorMethodX509Response.fromMap(Map<String, dynamic> map) {
    return BrokerAuthenticatorMethodX509Response(
      authorizationAttributes: (() { final guardedValue = map['authorizationAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<BrokerAuthenticatorMethodX509AttributesResponse>(guardedValue, (value) => BrokerAuthenticatorMethodX509AttributesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
