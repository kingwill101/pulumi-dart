...
class BrokerAuthenticatorMethodX509Response {
  ...
  final Map<String, BrokerAuthenticatorMethodX509AttributesResponse>? authorizationAttributes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authorizationAttributes': ?authorizationAttributes == null ? null : pulumi.Input.encodeMapValues<BrokerAuthenticatorMethodX509AttributesResponse, Map<String, dynamic>>(authorizationAttributes!, (value) => value.toMap()),
  ...
  factory BrokerAuthenticatorMethodX509Response.fromMap(Map<String, dynamic> map) {
    return BrokerAuthenticatorMethodX509Response(
      authorizationAttributes: map['authorizationAttributes'] == null ? null : pulumi.Input.decodeMapValues<BrokerAuthenticatorMethodX509AttributesResponse>(map['authorizationAttributes'], (value) => BrokerAuthenticatorMethodX509AttributesResponse.fromMap((value as Map).cast<String, dynamic>())),
