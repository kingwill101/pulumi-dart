...
class AkriConnectorsMqttConnectionConfigurationResponse {
  ...
  final pulumi.Input<AkriConnectorsServiceAccountAuthenticationResponse>?
  authentication;
  ...
  factory AkriConnectorsMqttConnectionConfigurationResponse.fromMap(
    ...
    return AkriConnectorsMqttConnectionConfigurationResponse(
      authentication: (() {
        ...
        return pulumi.Input.fromValue(
          AkriConnectorsServiceAccountAuthenticationResponse.fromMap(
