...
class AuthorizationRuleResponse {
    ...
    return <String, dynamic>{
      'brokerResources':
          pulumi.Input.mapInputValue<
            List<BrokerResourceRuleResponse>,
      ...
      'stateStoreResources':
          ?pulumi.Input.mapOptionalInputValue<
            List<StateStoreResourceRuleResponse>,
            List<Map<String, dynamic>>
          >(
            stateStoreResources,
            (value) =>
  ...
  factory AuthorizationRuleResponse.fromMap(Map<String, dynamic> map) {
    return AuthorizationRuleResponse(
      brokerResources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BrokerResourceRuleResponse>(
          map['brokerResources']!,
          (value) => BrokerResourceRuleResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      principals: pulumi.Input.fromValue(
        PrincipalDefinitionResponse.fromMap(
          (map['principals']! as Map).cast<String, dynamic>(),
        ),
      ),
      stateStoreResources: (() {
        final guardedValue = map['stateStoreResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StateStoreResourceRuleResponse>(
            guardedValue,
            (value) => StateStoreResourceRuleResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
