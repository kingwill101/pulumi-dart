...
class RegistryEndpointUserAssignedIdentityAuthentication {
  ...
  const RegistryEndpointUserAssignedIdentityAuthentication({
  ...
  factory RegistryEndpointUserAssignedIdentityAuthentication.fromMap(Map<String, dynamic> map) {
    return RegistryEndpointUserAssignedIdentityAuthentication(
      ...
      userAssignedManagedIdentitySettings: pulumi.Input.fromValue(RegistryEndpointUserAssignedManagedIdentitySettings.fromMap((map['userAssignedManagedIdentitySettings']! as Map).cast<String, dynamic>())),
    );
  }
}
