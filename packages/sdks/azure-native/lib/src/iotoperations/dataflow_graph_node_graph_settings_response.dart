...
class DataflowGraphNodeGraphSettingsResponse {
  ...
  final pulumi.Input<List<DataflowGraphGraphNodeConfigurationResponse>>?
  configuration;
    ...
    return <String, dynamic>{
      ...
      'configuration':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataflowGraphGraphNodeConfigurationResponse>,
  ...
  factory DataflowGraphNodeGraphSettingsResponse.fromMap(
    ...
    return DataflowGraphNodeGraphSettingsResponse(
      ...
      configuration: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataflowGraphGraphNodeConfigurationResponse>(
            guardedValue,
            (value) => DataflowGraphGraphNodeConfigurationResponse.fromMap(
