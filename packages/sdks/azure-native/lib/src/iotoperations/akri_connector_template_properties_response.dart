...
class AkriConnectorTemplatePropertiesResponse {
  ...
  final pulumi.Input<
    List<AkriConnectorTemplateDeviceInboundEndpointTypeResponse>
  >
  ...
  final pulumi.Input<AkriConnectorsMqttConnectionConfigurationResponse>?
  ...
  final pulumi.Input<AkriConnectorTemplateHelmConfigurationResponse>
    ...
    return <String, dynamic>{
      ...
      'mqttConnectionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(mqttConnectionConfiguration, (value) => value.toMap()),
      'provisioningState': provisioningState,
      'runtimeConfiguration':
          pulumi.Input.mapInputValue<
            AkriConnectorTemplateHelmConfigurationResponse,
            Map<String, dynamic>
          >(runtimeConfiguration, (value) => value.toMap()),
    };
  }

  factory AkriConnectorTemplatePropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AkriConnectorTemplatePropertiesResponse(
      aioMetadata: (() {
        final guardedValue = map['aioMetadata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorTemplateAioMetadataResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      deviceInboundEndpointTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          AkriConnectorTemplateDeviceInboundEndpointTypeResponse
        >(
          map['deviceInboundEndpointTypes']!,
          (value) =>
              AkriConnectorTemplateDeviceInboundEndpointTypeResponse.fromMap(
      ...
      diagnostics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorTemplateDiagnosticsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mqttConnectionConfiguration: (() {
        final guardedValue = map['mqttConnectionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorsMqttConnectionConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      runtimeConfiguration: pulumi.Input.fromValue(
        AkriConnectorTemplateHelmConfigurationResponse.fromMap(
