...
class AkriConnectorTemplateHelmConfigurationSettings {
  ...
  final pulumi.Input<AkriConnectorTemplateHelmAdvancedConfiguration>?
  advancedConfiguration;

  /// The registry settings for the helm chart to be used.
  final pulumi.Input<AkriConnectorTemplateHelmContainerRegistry>?
  registrySettings;
  ...
  factory AkriConnectorTemplateHelmConfigurationSettings.fromMap(
    ...
    return AkriConnectorTemplateHelmConfigurationSettings(
      advancedConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          AkriConnectorTemplateHelmAdvancedConfiguration.fromMap(
      ...
      registrySettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorTemplateHelmContainerRegistry.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
