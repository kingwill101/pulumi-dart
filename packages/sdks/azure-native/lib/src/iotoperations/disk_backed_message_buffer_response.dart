...
class DiskBackedMessageBufferResponse {
    ...
    return <String, dynamic>{
      'ephemeralVolumeClaimSpec':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(ephemeralVolumeClaimSpec, (value) => value.toMap()),
      'maxSize': maxSize,
      'persistentVolumeClaimSpec':
          ?pulumi.Input.mapOptionalInputValue<
            VolumeClaimSpecResponse,
            Map<String, dynamic>
          >(persistentVolumeClaimSpec, (value) => value.toMap()),
    };
  }
  ...
  factory DiskBackedMessageBufferResponse.fromMap(Map<String, dynamic> map) {
    return DiskBackedMessageBufferResponse(
      ephemeralVolumeClaimSpec: (() {
        final guardedValue = map['ephemeralVolumeClaimSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeClaimSpecResponse.fromMap(
      ...
      persistentVolumeClaimSpec: (() {
        final guardedValue = map['persistentVolumeClaimSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeClaimSpecResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
