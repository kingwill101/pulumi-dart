...
class AkriConnectorTemplateArgs {
  ...
  factory AkriConnectorTemplateArgs.fromMap(Map<String, dynamic> map) {
    return AkriConnectorTemplateArgs(
      akriConnectorTemplateName: (() { final guardedValue = map['akriConnectorTemplateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AkriConnectorTemplateProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
