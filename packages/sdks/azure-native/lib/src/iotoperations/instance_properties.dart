...
class InstanceProperties {
  ...
  InstanceProperties({this.description, required this.schemaRegistryRef});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'description': ?description,
      'schemaRegistryRef':
          pulumi.Input.mapInputValue<SchemaRegistryRef, Map<String, dynamic>>(
            schemaRegistryRef,
            (value) => value.toMap(),
          ),
    };
  ...
  factory InstanceProperties.fromMap(Map<String, dynamic> map) {
    return InstanceProperties(
      ...
      schemaRegistryRef: pulumi.Input.fromValue(
        SchemaRegistryRef.fromMap(
          (map['schemaRegistryRef']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
