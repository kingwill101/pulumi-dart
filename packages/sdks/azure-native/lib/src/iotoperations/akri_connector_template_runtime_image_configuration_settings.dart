    ...
    return <String, dynamic>{
      ...
      'tagDigestSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(tagDigestSettings, (value) => value.toMap()),
    };
  }

  factory AkriConnectorTemplateRuntimeImageConfigurationSettings.fromMap(
    ...
    return AkriConnectorTemplateRuntimeImageConfigurationSettings(
      ...
      registrySettings: (() {
        ...
        return pulumi.Input.fromValue(
          AkriConnectorsContainerRegistry.fromMap(
      ...
      tagDigestSettings: (() {
        final guardedValue = map['tagDigestSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AkriConnectorsDigest.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
