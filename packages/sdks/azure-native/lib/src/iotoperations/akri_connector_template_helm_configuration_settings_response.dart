...
class AkriConnectorTemplateHelmConfigurationSettingsResponse {
  ...
  factory AkriConnectorTemplateHelmConfigurationSettingsResponse.fromMap(Map<String, dynamic> map) {
    return AkriConnectorTemplateHelmConfigurationSettingsResponse(
      ...
      registrySettings: (() { final guardedValue = map['registrySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AkriConnectorTemplateHelmContainerRegistryResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
