...
class DataflowBuiltInTransformationSettingsResponse {
  ...
  final pulumi.Input<List<DataflowBuiltInTransformationDatasetResponse>>?
  datasets;
    ...
    return <String, dynamic>{
      'datasets':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataflowBuiltInTransformationDatasetResponse>,
      ...
      'filter':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataflowBuiltInTransformationFilterResponse>,
            List<Map<String, dynamic>>
          >(
            filter,
            (value) =>
      ...
      'map':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataflowBuiltInTransformationMapResponse>,
            List<Map<String, dynamic>>
          >(
            map,
            (value) =>
  ...
  factory DataflowBuiltInTransformationSettingsResponse.fromMap(
    ...
    return DataflowBuiltInTransformationSettingsResponse(
      datasets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataflowBuiltInTransformationDatasetResponse>(
            guardedValue,
            (value) => DataflowBuiltInTransformationDatasetResponse.fromMap(
      ...
      filter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataflowBuiltInTransformationFilterResponse>(
            guardedValue,
            (value) => DataflowBuiltInTransformationFilterResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      map: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataflowBuiltInTransformationMapResponse>(
            guardedValue,
            (value) => DataflowBuiltInTransformationMapResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
