...
class DataflowEndpointMqttAuthenticationResponse {
  ...
  const DataflowEndpointMqttAuthenticationResponse({
  ...
  factory DataflowEndpointMqttAuthenticationResponse.fromMap(Map<String, dynamic> map) {
    return DataflowEndpointMqttAuthenticationResponse(
      ...
      serviceAccountTokenSettings: (() { final guardedValue = map['serviceAccountTokenSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataflowEndpointAuthenticationServiceAccountTokenResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
