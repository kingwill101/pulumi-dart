...
class DataflowProfile extends pulumi.CustomResource {
  ...
  DataflowProfile(
    ...
    properties = registerOutput<DataflowProfilePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DataflowProfilePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [DataflowProfile] resource.
  DataflowProfile.reference(String urn)
    : super(
        'azure-native:iotoperations:DataflowProfile',
