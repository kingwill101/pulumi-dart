...
class BrokerAuthentication extends pulumi.CustomResource {
  ...
  BrokerAuthentication(
    ...
    properties = registerOutput<BrokerAuthenticationPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BrokerAuthenticationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
