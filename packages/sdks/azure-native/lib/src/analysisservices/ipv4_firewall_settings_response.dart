...
class IPv4FirewallSettingsResponse {
  ...
  IPv4FirewallSettingsResponse({this.enablePowerBIService, this.firewallRules});
    ...
    return IPv4FirewallSettingsResponse(
      ...
      firewallRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IPv4FirewallRuleResponse>(
            guardedValue,
            (value) => IPv4FirewallRuleResponse.fromMap(
