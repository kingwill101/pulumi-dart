...
class ServerDetailsArgs {
  ...
  factory ServerDetailsArgs.fromMap(Map<String, dynamic> map) {
    return ServerDetailsArgs(
      ...
      managedMode: (() { final guardedValue = map['managedMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      serverMonitorMode: (() { final guardedValue = map['serverMonitorMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
