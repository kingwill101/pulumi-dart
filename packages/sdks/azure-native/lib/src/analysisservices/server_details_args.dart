    ...
    return <String, dynamic>{
      'asAdministrators':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(asAdministrators, (value) => value.toMap()),
      'backupBlobContainerUri': ?backupBlobContainerUri,
      'gatewayDetails':
          ?pulumi.Input.mapOptionalInputValue<
            GatewayDetails,
            Map<String, dynamic>
          >(gatewayDetails, (value) => value.toMap()),
      'ipV4FirewallSettings':
          ?pulumi.Input.mapOptionalInputValue<
            IPv4FirewallSettings,
            Map<String, dynamic>
          >(ipV4FirewallSettings, (value) => value.toMap()),
      'location': ?location,
      'managedMode': ?managedMode,
      'querypoolConnectionMode':
          ?pulumi.Input.mapOptionalInputValue<ConnectionMode, String>(
            querypoolConnectionMode,
      ...
      'sku': pulumi.Input.mapInputValue<ResourceSku, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
      'tags': ?tags,
  ...
  factory ServerDetailsArgs.fromMap(Map<String, dynamic> map) {
    return ServerDetailsArgs(
      ...
      gatewayDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayDetails.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ipV4FirewallSettings: (() {
      ...
      querypoolConnectionMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectionMode.fromValue(guardedValue as String),
        );
      })(),
      ...
      sku: pulumi.Input.fromValue(
        ResourceSku.fromMap((map['sku']! as Map).cast<String, dynamic>()),
      ),
      tags: (() {
