...
class PatchSettingsResponse {
  ...
  factory PatchSettingsResponse.fromMap(Map<String, dynamic> map) {
    return PatchSettingsResponse(
      ...
      automaticByPlatformSettings: (() { final guardedValue = map['automaticByPlatformSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsVMGuestPatchAutomaticByPlatformSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
