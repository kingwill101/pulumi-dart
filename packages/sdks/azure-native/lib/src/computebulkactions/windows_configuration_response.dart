...
class WindowsConfigurationResponse {
  ...
  factory WindowsConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return WindowsConfigurationResponse(
      additionalUnattendContent: (() { final guardedValue = map['additionalUnattendContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AdditionalUnattendContentResponse>(guardedValue, (value) => AdditionalUnattendContentResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      patchSettings: (() { final guardedValue = map['patchSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PatchSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      winRM: (() { final guardedValue = map['winRM']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WinRMConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
