...
class LinuxConfigurationResponse {
  ...
  factory LinuxConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return LinuxConfigurationResponse(
      ...
      patchSettings: (() { final guardedValue = map['patchSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxPatchSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
