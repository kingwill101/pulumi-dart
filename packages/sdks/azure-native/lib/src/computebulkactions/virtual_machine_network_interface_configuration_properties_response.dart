...
class VirtualMachineNetworkInterfaceConfigurationPropertiesResponse {
  ...
  /// Creates a new [VirtualMachineNetworkInterfaceConfigurationPropertiesResponse].
  ...
  const VirtualMachineNetworkInterfaceConfigurationPropertiesResponse({
    this.auxiliaryMode,
    this.auxiliarySku,
    this.deleteOption,
  ...
  factory VirtualMachineNetworkInterfaceConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineNetworkInterfaceConfigurationPropertiesResponse(
