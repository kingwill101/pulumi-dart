...
class VirtualMachineExtensionProperties {
  ...
  /// Creates a new [VirtualMachineExtensionProperties].
  ...
  const VirtualMachineExtensionProperties({
  ...
  factory VirtualMachineExtensionProperties.fromMap(Map<String, dynamic> map) {
