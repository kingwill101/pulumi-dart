...
class HostEndpointSettingsResponse {
  ...
  const HostEndpointSettingsResponse({
  ...
  factory HostEndpointSettingsResponse.fromMap(Map<String, dynamic> map) {
    return HostEndpointSettingsResponse(
      inVMAccessControlProfileReferenceId: (() { final guardedValue = map['inVMAccessControlProfileReferenceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
