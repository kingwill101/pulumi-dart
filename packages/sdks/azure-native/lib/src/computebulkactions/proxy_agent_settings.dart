...
class ProxyAgentSettings {
  ...
  final pulumi.Input<bool>? addProxyAgentExtension;
  ...
  /// [addProxyAgentExtension] Specify whether to implicitly install the ProxyAgent Extension. This option is currently applicable only for Linux Os.
  ...
  factory ProxyAgentSettings.fromMap(Map<String, dynamic> map) {
    return ProxyAgentSettings(
      addProxyAgentExtension: (() { final guardedValue = map['addProxyAgentExtension']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      imds: (() { final guardedValue = map['imds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostEndpointSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      wireServer: (() { final guardedValue = map['wireServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostEndpointSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
