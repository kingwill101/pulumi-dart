...
import 'virtual_machine_network_interface_dns_settings_configuration.dart';
import 'virtual_machine_network_interface_ipconfiguration.dart';
...
class VirtualMachineNetworkInterfaceConfigurationProperties {
  ...
  /// Creates a new [VirtualMachineNetworkInterfaceConfigurationProperties].
  ...
  /// [dscpConfiguration] The DSCP configuration for the network interface.
  ...
  const VirtualMachineNetworkInterfaceConfigurationProperties({
    this.auxiliaryMode,
    this.auxiliarySku,
    this.deleteOption,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dnsSettings': ?pulumi.Input.mapOptionalInputValue<VirtualMachineNetworkInterfaceDnsSettingsConfiguration, Map<String, dynamic>>(dnsSettings, (value) => value.toMap()),
      ...
      'ipConfigurations': pulumi.Input.mapInputValue<List<VirtualMachineNetworkInterfaceIPConfiguration>, List<Map<String, dynamic>>>(ipConfigurations, (value) => pulumi.Input.encodeList<VirtualMachineNetworkInterfaceIPConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory VirtualMachineNetworkInterfaceConfigurationProperties.fromMap(Map<String, dynamic> map) {
    return VirtualMachineNetworkInterfaceConfigurationProperties(
      ...
      ipConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineNetworkInterfaceIPConfiguration>(map['ipConfigurations']!, (value) => VirtualMachineNetworkInterfaceIPConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      networkSecurityGroup: (() { final guardedValue = map['networkSecurityGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
