...
class VMAttributes {
  ...
  /// [acceleratorSupport] Specifies whether the VMSize supporting accelerator should be used to launch instances or not.
  ...
  /// [allowedVMSizes] Specifies which VMSizes should be allowed while filtering on VMAttributes. Cannot be specified together with excludedVMSizes. Maximum of 10 VM sizes allowed. Optional parameter.
  /// [architectureTypes] The VM architecture types specified as a list. Must be specified if VMAttributes are specified. Must be compatible with image used.
  /// [burstableSupport] Specifies whether the VMSize supporting burstable capability should be used to launch instances or not.
  ...
  /// [excludedVMSizes] Specifies which VMSizes should be excluded while filtering on VMAttributes. Cannot be specified together with allowedVMSizes. Maximum of 10 VM sizes allowed. Optional parameter.
  /// [hyperVGenerations] The hyperV generations specified as a list. Optional parameter.
  ...
  /// [localStorageSupport] Specifies whether the VMSize supporting local storage should be used to launch instances or not.
  ...
  /// [rdmaSupport] Specifies whether the VMSize supporting RDMA (Remote Direct Memory Access) should be used to build launch instances or not.
