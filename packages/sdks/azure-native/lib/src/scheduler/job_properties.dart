...
class JobProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'startTime': ?startTime,
      'state': ?pulumi.Input.mapOptionalInputValue<JobState, String>(state, (value) => value.wireValue),
    };
  }

  factory JobProperties.fromMap(Map<String, dynamic> map) {
    return JobProperties(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      recurrence: (() { final guardedValue = map['recurrence']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobRecurrence.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      startTime: (() { final guardedValue = map['startTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobState.fromValue(guardedValue as String)); })(),
    );
  }
}
