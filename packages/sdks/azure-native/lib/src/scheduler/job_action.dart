...
class JobAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<JobActionType, String>(
        type,
  ...
  factory JobAction.fromMap(Map<String, dynamic> map) {
    return JobAction(
      errorAction: (() {
        final guardedValue = map['errorAction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobErrorAction.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      queueMessage: (() {
      ...
      request: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpRequest.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      retryPolicy: (() {
      ...
      serviceBusQueueMessage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceBusQueueMessage.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      serviceBusTopicMessage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceBusTopicMessage.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobActionType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
