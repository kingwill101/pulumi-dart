...
class JobCollectionProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': ?pulumi.Input.mapOptionalInputValue<JobCollectionState, String>(state, (value) => value.wireValue),
    };
  }

  factory JobCollectionProperties.fromMap(Map<String, dynamic> map) {
    return JobCollectionProperties(
      quota: (() { final guardedValue = map['quota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobCollectionQuota.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobCollectionState.fromValue(guardedValue as String)); })(),
    );
  }
}
