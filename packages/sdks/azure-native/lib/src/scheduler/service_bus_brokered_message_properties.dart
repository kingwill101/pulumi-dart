...
class ServiceBusBrokeredMessageProperties {
  ...
  factory ServiceBusBrokeredMessageProperties.fromMap(
    ...
    return ServiceBusBrokeredMessageProperties(
      ...
      forcePersistence: (() {
        final guardedValue = map['forcePersistence'];
        if (guardedValue == null) return null;
      ...
      scheduledEnqueueTimeUtc: (() {
        final guardedValue = map['scheduledEnqueueTimeUtc'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sessionId: (() {
      ...
      viaPartitionKey: (() {
        final guardedValue = map['viaPartitionKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
