...
class JobRecurrenceScheduleResponse {
  ...
  final pulumi.Input<List<JobRecurrenceScheduleMonthlyOccurrenceResponse>>?
  monthlyOccurrences;
    ...
    return <String, dynamic>{
      ...
      'monthlyOccurrences':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobRecurrenceScheduleMonthlyOccurrenceResponse>,
    ...
    return JobRecurrenceScheduleResponse(
      ...
      monthlyOccurrences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<JobRecurrenceScheduleMonthlyOccurrenceResponse>(
            guardedValue,
            (value) => JobRecurrenceScheduleMonthlyOccurrenceResponse.fromMap(
