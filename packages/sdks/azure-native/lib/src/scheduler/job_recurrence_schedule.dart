...
class JobRecurrenceSchedule {
  ...
  final pulumi.Input<List<JobRecurrenceScheduleMonthlyOccurrence>>?
  monthlyOccurrences;
    ...
    return JobRecurrenceSchedule(
      ...
      monthlyOccurrences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobRecurrenceScheduleMonthlyOccurrence>(
            guardedValue,
            (value) => JobRecurrenceScheduleMonthlyOccurrence.fromMap(
