...
class GetJobCollectionResult {
  ...
  factory GetJobCollectionResult.fromMap(Map<String, dynamic> map) {
    return GetJobCollectionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return JobCollectionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
