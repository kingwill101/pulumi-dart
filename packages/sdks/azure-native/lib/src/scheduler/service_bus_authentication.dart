...
class ServiceBusAuthentication {
  ...
  const ServiceBusAuthentication({
    this.sasKey,
    this.sasKeyName,
    this.type,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<ServiceBusAuthenticationType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory ServiceBusAuthentication.fromMap(Map<String, dynamic> map) {
    return ServiceBusAuthentication(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceBusAuthenticationType.fromValue(guardedValue as String)); })(),
    );
  }
}
