...
class ServiceBusTopicMessage {
  ...
  final pulumi.Input<ServiceBusBrokeredMessageProperties>?
    ...
    return <String, dynamic>{
      ...
      'brokeredMessageProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(brokeredMessageProperties, (value) => value.toMap()),
      'customMessageProperties': ?customMessageProperties,
      'message': ?message,
      'namespace': ?namespace,
      'topicPath': ?topicPath,
      'transportType':
          ?pulumi.Input.mapOptionalInputValue<ServiceBusTransportType, String>(
            transportType,
    ...
    return ServiceBusTopicMessage(
      authentication: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceBusAuthentication.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      brokeredMessageProperties: (() {
        final guardedValue = map['brokeredMessageProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceBusBrokeredMessageProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      customMessageProperties: (() {
        final guardedValue = map['customMessageProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      topicPath: (() {
        final guardedValue = map['topicPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      transportType: (() {
        final guardedValue = map['transportType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceBusTransportType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
