...
class MHSMPrivateEndpointConnectionItemResponse {
  ...
  final pulumi.Input<MHSMPrivateLinkServiceConnectionStateResponse>?
  ...
  factory MHSMPrivateEndpointConnectionItemResponse.fromMap(
    ...
    return MHSMPrivateEndpointConnectionItemResponse(
      ...
      privateEndpoint: (() {
        ...
        return pulumi.Input.fromValue(
          MHSMPrivateEndpointResponse.fromMap(
      ...
      privateLinkServiceConnectionState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MHSMPrivateLinkServiceConnectionStateResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
