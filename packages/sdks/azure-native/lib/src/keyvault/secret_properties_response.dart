...
class SecretPropertiesResponse {
  ...
  final SecretAttributesResponse? attributes;
  /// The content type of the secret.
  final String? contentType;
  /// The URI to retrieve the current version of the secret.
  final String secretUri;
  /// The URI to retrieve the specific version of the secret.
  final String secretUriWithVersion;
  ...
  factory SecretPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SecretPropertiesResponse(
      attributes: map['attributes'] == null ? null : SecretAttributesResponse.fromMap((map['attributes'] as Map).cast<String, dynamic>()),
      contentType: map['contentType'] == null ? null : map['contentType'] as String,
      secretUri: map['secretUri'] as String,
      secretUriWithVersion: map['secretUriWithVersion'] as String,
