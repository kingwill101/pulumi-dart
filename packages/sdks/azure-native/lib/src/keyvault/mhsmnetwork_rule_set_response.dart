...
class MHSMNetworkRuleSetResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualNetworkRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<MHSMVirtualNetworkRuleResponse>,
            List<Map<String, dynamic>>
          >(
            virtualNetworkRules,
            (value) =>
    ...
    return MHSMNetworkRuleSetResponse(
      ...
      ipRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MHSMIPRuleResponse>(
            guardedValue,
            (value) => MHSMIPRuleResponse.fromMap(
      ...
      virtualNetworkRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MHSMVirtualNetworkRuleResponse>(
            guardedValue,
            (value) => MHSMVirtualNetworkRuleResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
