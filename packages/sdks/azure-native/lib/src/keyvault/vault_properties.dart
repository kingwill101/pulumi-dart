...
class VaultProperties {
  ...
  factory VaultProperties.fromMap(Map<String, dynamic> map) {
    return VaultProperties(
      accessPolicies: (() { final guardedValue = map['accessPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessPolicyEntry>(guardedValue, (value) => AccessPolicyEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
