...
/// }
///
/// resource "azure-native_keyvault_mhsmprivateendpointconnection" "mhsmPrivateEndpointConnection" {
///   name                             = "sample-mhsm"
...
class MHSMPrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [MHSMPrivateEndpointConnection] resource.
  MHSMPrivateEndpointConnection.reference(String urn)
    : super(
        'azure-native:keyvault:MHSMPrivateEndpointConnection',
