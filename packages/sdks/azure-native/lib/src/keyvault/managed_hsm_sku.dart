...
class ManagedHsmSku {
  ...
  ManagedHsmSku({required this.family, required this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'family': family,
      'name': pulumi.Input.mapInputValue<ManagedHsmSkuName, String>(
        name,
  ...
  factory ManagedHsmSku.fromMap(Map<String, dynamic> map) {
    return ManagedHsmSku(
      ...
      name: pulumi.Input.fromValue(
        ManagedHsmSkuName.fromValue(map['name']! as String),
      ),
    );
  }
}
