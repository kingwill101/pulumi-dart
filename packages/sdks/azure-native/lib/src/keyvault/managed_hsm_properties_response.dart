...
class ManagedHsmPropertiesResponse {
  ...
  final pulumi.Input<List<MHSMPrivateEndpointConnectionItemResponse>>
  ...
  final pulumi.Input<ManagedHSMSecurityDomainPropertiesResponse>
    ...
    return <String, dynamic>{
      ...
      'privateEndpointConnections':
          pulumi.Input.mapInputValue<
            List<MHSMPrivateEndpointConnectionItemResponse>,
      ...
      'regions':
          ?pulumi.Input.mapOptionalInputValue<
            List<MHSMGeoReplicatedRegionResponse>,
            List<Map<String, dynamic>>
          >(
            regions,
            (value) =>
      ...
      'securityDomainProperties':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(securityDomainProperties, (value) => value.toMap()),
  ...
  factory ManagedHsmPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ManagedHsmPropertiesResponse(
      ...
      initialAdminObjectIds: (() {
        final guardedValue = map['initialAdminObjectIds'];
        if (guardedValue == null) return null;
      ...
      networkAcls: (() {
        ...
        return pulumi.Input.fromValue(
          MHSMNetworkRuleSetResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      privateEndpointConnections: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MHSMPrivateEndpointConnectionItemResponse>(
          map['privateEndpointConnections']!,
          (value) => MHSMPrivateEndpointConnectionItemResponse.fromMap(
      ...
      regions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MHSMGeoReplicatedRegionResponse>(
            guardedValue,
            (value) => MHSMGeoReplicatedRegionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      securityDomainProperties: pulumi.Input.fromValue(
        ManagedHSMSecurityDomainPropertiesResponse.fromMap(
          (map['securityDomainProperties']! as Map).cast<String, dynamic>(),
        ),
      ),
