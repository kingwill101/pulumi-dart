...
class VaultPropertiesResponse {
  ...
  final pulumi.Input<List<PrivateEndpointConnectionItemResponse>>
    ...
    return <String, dynamic>{
      'accessPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessPolicyEntryResponse>,
      ...
      'privateEndpointConnections':
          pulumi.Input.mapInputValue<
            List<PrivateEndpointConnectionItemResponse>,
            List<Map<String, dynamic>>
          >(
            privateEndpointConnections,
            (value) =>
    ...
    return VaultPropertiesResponse(
      accessPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessPolicyEntryResponse>(
            guardedValue,
            (value) => AccessPolicyEntryResponse.fromMap(
      ...
      hsmPoolResourceId: pulumi.Input.fromValue(
        map['hsmPoolResourceId'] as String,
      ),
      networkAcls: (() {
      ...
      privateEndpointConnections: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PrivateEndpointConnectionItemResponse>(
          map['privateEndpointConnections']!,
          (value) => PrivateEndpointConnectionItemResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
