...
class MHSMPrivateEndpointConnectionArgs {
  ...
  factory MHSMPrivateEndpointConnectionArgs.fromMap(Map<String, dynamic> map) {
    return MHSMPrivateEndpointConnectionArgs(
      ...
      privateLinkServiceConnectionState: (() { final guardedValue = map['privateLinkServiceConnectionState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MHSMPrivateLinkServiceConnectionState.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
