...
class RotationPolicy {
  ...
  RotationPolicy({this.attributes, this.lifetimeActions});
    ...
    return <String, dynamic>{
      ...
      'lifetimeActions':
          ...
          >(
            lifetimeActions,
            (value) =>
                pulumi.Input.encodeList<LifetimeAction, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return RotationPolicy(
      attributes: (() {
        ...
        return pulumi.Input.fromValue(
          KeyRotationPolicyAttributes.fromMap(
      ...
      lifetimeActions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LifetimeAction>(
            guardedValue,
            (value) =>
                LifetimeAction.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
