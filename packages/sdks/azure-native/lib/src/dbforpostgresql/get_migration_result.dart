...
class GetMigrationResult {
  ...
  factory GetMigrationResult.fromMap(Map<String, dynamic> map) {
    return GetMigrationResult(
      ...
      currentStatus: MigrationStatusResponse.fromMap(
      ...
      sourceDbServerMetadata: DbServerMetadataResponse.fromMap(
        (map['sourceDbServerMetadata']! as Map).cast<String, dynamic>(),
      ),
      ...
      targetDbServerMetadata: DbServerMetadataResponse.fromMap(
        (map['targetDbServerMetadata']! as Map).cast<String, dynamic>(),
      ),
