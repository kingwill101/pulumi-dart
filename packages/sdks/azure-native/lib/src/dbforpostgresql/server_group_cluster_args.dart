...
class ServerGroupClusterArgs {
  ...
  factory ServerGroupClusterArgs.fromMap(Map<String, dynamic> map) {
    return ServerGroupClusterArgs(
      ...
      authConfig: (() { final guardedValue = map['authConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerGroupClusterAuthConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      enableShardsOnCoordinator: (() { final guardedValue = map['enableShardsOnCoordinator']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
