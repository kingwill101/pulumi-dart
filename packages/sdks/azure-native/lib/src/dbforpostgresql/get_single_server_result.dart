...
class GetSingleServerResult {
  ...
  final List<ServerPrivateEndpointConnectionResponse>
  ...
  final SingleServerSkuResponse? sku;
  ...
  factory GetSingleServerResult.fromMap(Map<String, dynamic> map) {
    return GetSingleServerResult(
      ...
      earliestRestoreDate: (() {
        final guardedValue = map['earliestRestoreDate'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      ...
      masterServerId: (() {
        final guardedValue = map['masterServerId'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      minimalTlsVersion: (() {
      ...
      privateEndpointConnections:
          pulumi.Input.decodeList<ServerPrivateEndpointConnectionResponse>(
            map['privateEndpointConnections']!,
            (value) => ServerPrivateEndpointConnectionResponse.fromMap(
      ...
      userVisibleState: (() {
        final guardedValue = map['userVisibleState'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      version: (() {
