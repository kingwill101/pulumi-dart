...
class GetSingleServerResult {
  ...
  factory GetSingleServerResult.fromMap(Map<String, dynamic> map) {
    return GetSingleServerResult(
      ...
      byokEnforcement: (() { final guardedValue = map['byokEnforcement']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return SingleServerSkuResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
