...
/// Result data returned by getAdministratorsMicrosoftEntra.
class GetAdministratorsMicrosoftEntraResult {
  ...
  /// Creates a new [GetAdministratorsMicrosoftEntraResult].
  ...
  factory GetAdministratorsMicrosoftEntraResult.fromMap(Map<String, dynamic> map) {
    return GetAdministratorsMicrosoftEntraResult(
