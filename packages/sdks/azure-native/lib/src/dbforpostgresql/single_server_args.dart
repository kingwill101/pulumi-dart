...
class SingleServerArgs {
  ...
  factory SingleServerArgs.fromMap(Map<String, dynamic> map) {
    return SingleServerArgs(
      ...
      properties: pulumi.Input.fromValue(ServerPropertiesForDefaultCreate.fromMap((map['properties']! as Map).cast<String, dynamic>())),
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SingleServerSku.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
