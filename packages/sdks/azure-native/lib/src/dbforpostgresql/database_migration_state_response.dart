...
class DatabaseMigrationStateResponse {
  ...
  factory DatabaseMigrationStateResponse.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationStateResponse(
      appliedChanges: (() {
        final guardedValue = map['appliedChanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      cdcDeleteCounter: (() {
        final guardedValue = map['cdcDeleteCounter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      cdcInsertCounter: (() {
        final guardedValue = map['cdcInsertCounter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      cdcUpdateCounter: (() {
        final guardedValue = map['cdcUpdateCounter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      databaseName: (() {
      ...
      fullLoadCompletedTables: (() {
        final guardedValue = map['fullLoadCompletedTables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      fullLoadErroredTables: (() {
        final guardedValue = map['fullLoadErroredTables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      fullLoadLoadingTables: (() {
        final guardedValue = map['fullLoadLoadingTables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      fullLoadQueuedTables: (() {
        final guardedValue = map['fullLoadQueuedTables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      incomingChanges: (() {
        final guardedValue = map['incomingChanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      latency: (() {
      ...
      migrationOperation: (() {
        final guardedValue = map['migrationOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      migrationState: (() {
