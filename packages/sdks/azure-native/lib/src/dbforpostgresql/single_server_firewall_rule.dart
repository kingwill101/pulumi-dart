...
/// }
///
/// resource "azure-native_dbforpostgresql_singleserverfirewallrule" "singleServerFirewallRule" {
...
class SingleServerFirewallRule extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SingleServerFirewallRule]. {@macro pulumi_dbforpostgresql_single_server_firewall_rule_args_doc}
