...
/// }
///
/// resource "azure-native_dbforpostgresql_backup" "backup" {
...
class BackupDbforpostgresql extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [BackupDbforpostgresql] resource.
  BackupDbforpostgresql.reference(String urn)
    : super(
        'azure-native:dbforpostgresql:Backup',
