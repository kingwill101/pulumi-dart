...
/// }
///
/// resource "azure-native_dbforpostgresql_backupsautomaticandondemand" "backupsAutomaticAndOnDemand" {
...
class BackupsAutomaticAndOnDemand extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [BackupsAutomaticAndOnDemand] resource.
  BackupsAutomaticAndOnDemand.reference(String urn)
    : super(
        'azure-native:dbforpostgresql:BackupsAutomaticAndOnDemand',
