...
class DbLevelValidationStatusResponse {
  ...
  factory DbLevelValidationStatusResponse.fromMap(Map<String, dynamic> map) {
    return DbLevelValidationStatusResponse(
      ...
      summary: (() { final guardedValue = map['summary']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ValidationSummaryItemResponse>(guardedValue, (value) => ValidationSummaryItemResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
