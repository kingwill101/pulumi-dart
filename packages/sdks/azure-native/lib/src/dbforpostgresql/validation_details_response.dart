...
class ValidationDetailsResponse {
  ...
  final pulumi.Input<List<DbLevelValidationStatusResponse>>?
  dbLevelValidationDetails;

  /// Details of server level validations.
  final pulumi.Input<List<ValidationSummaryItemResponse>>?
    ...
    return <String, dynamic>{
      'dbLevelValidationDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<DbLevelValidationStatusResponse>,
  ...
  factory ValidationDetailsResponse.fromMap(Map<String, dynamic> map) {
    return ValidationDetailsResponse(
      dbLevelValidationDetails: (() {
        final guardedValue = map['dbLevelValidationDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DbLevelValidationStatusResponse>(
            guardedValue,
            (value) => DbLevelValidationStatusResponse.fromMap(
      ...
      serverLevelValidationDetails: (() {
        final guardedValue = map['serverLevelValidationDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      validationEndTimeInUtc: (() {
        final guardedValue = map['validationEndTimeInUtc'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      validationStartTimeInUtc: (() {
        final guardedValue = map['validationStartTimeInUtc'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
