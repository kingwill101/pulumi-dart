...
class ServerPrivateEndpointConnectionPropertiesResponse {
  ...
  factory ServerPrivateEndpointConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ServerPrivateEndpointConnectionPropertiesResponse(
      ...
      privateLinkServiceConnectionState: (() { final guardedValue = map['privateLinkServiceConnectionState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerPrivateLinkServiceConnectionStatePropertyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
