...
class SingleServerServerSecurityAlertPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state':
          pulumi.Input.mapInputValue<ServerSecurityAlertPolicyState, String>(
            state,
  ...
  factory SingleServerServerSecurityAlertPolicyArgs.fromMap(
    ...
    return SingleServerServerSecurityAlertPolicyArgs(
      ...
      state: pulumi.Input.fromValue(
        ServerSecurityAlertPolicyState.fromValue(map['state']! as String),
      ),
