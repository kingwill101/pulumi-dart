...
class SingleServerServerAdministrator extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SingleServerServerAdministrator]. {@macro pulumi_dbforpostgresql_single_server_server_administrator_args_doc}
  ...
  /// Creates a typed reference to an existing [SingleServerServerAdministrator] resource.
  SingleServerServerAdministrator.reference(String urn)
    : super(
        'azure-native:dbforpostgresql:SingleServerServerAdministrator',
