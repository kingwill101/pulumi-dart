...
class LinkArgs {
  ...
  final pulumi.Input<List<ParticipantPropertyReference>>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operationType':
          ?pulumi.Input.mapOptionalInputValue<InstanceOperationType, String>(
            operationType,
            (value) => value.wireValue,
          ),
      'participantPropertyReferences':
          pulumi.Input.mapInputValue<
            List<ParticipantPropertyReference>,
            List<Map<String, dynamic>>
          >(
            participantPropertyReferences,
            (value) =>
      ...
      'sourceEntityType': pulumi.Input.mapInputValue<EntityType, String>(
        sourceEntityType,
        (value) => value.wireValue,
      ),
      'sourceEntityTypeName': sourceEntityTypeName,
      'targetEntityType': pulumi.Input.mapInputValue<EntityType, String>(
        targetEntityType,
        (value) => value.wireValue,
      ),
  ...
  factory LinkArgs.fromMap(Map<String, dynamic> map) {
    return LinkArgs(
      ...
      mappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TypePropertiesMapping>(
            guardedValue,
            (value) => TypePropertiesMapping.fromMap(
      ...
      operationType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceOperationType.fromValue(guardedValue as String),
        );
      })(),
      participantPropertyReferences: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ParticipantPropertyReference>(
          map['participantPropertyReferences']!,
          (value) => ParticipantPropertyReference.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      sourceEntityType: pulumi.Input.fromValue(
        EntityType.fromValue(map['sourceEntityType']! as String),
      ),
      sourceEntityTypeName: pulumi.Input.fromValue(
        map['sourceEntityTypeName'] as String,
      ),
      targetEntityType: pulumi.Input.fromValue(
        EntityType.fromValue(map['targetEntityType']! as String),
      ),
      targetEntityTypeName: pulumi.Input.fromValue(
        map['targetEntityTypeName'] as String,
      ),
    );
  }
}
