...
class ProfileArgs {
  ...
  ProfileArgs({
    pulumi.Output<String>? apiEntitySetName,
    pulumi.Output<Map<String, List<String>>>? attributes,
    pulumi.Output<Map<String, String>>? description,
    pulumi.Output<Map<String, String>>? displayName,
    pulumi.Output<EntityTypes>? entityType,
    pulumi.Output<List<PropertyDefinition>>? fields,
    required pulumi.Output<String> hubName,
    pulumi.Output<int>? instancesCount,
    pulumi.Output<String>? largeImage,
    pulumi.Output<Map<String, Map<String, String>>>? localizedAttributes,
    pulumi.Output<String>? mediumImage,
    pulumi.Output<String>? profileName,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? schemaItemTypeLink,
    pulumi.Output<String>? smallImage,
    pulumi.Output<List<StrongId>>? strongIds,
    pulumi.Output<String>? timestampFieldName,
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      apiEntitySetName: map['apiEntitySetName'] == null ? null : pulumi.Output.create<String>(map['apiEntitySetName'] as String),
      attributes: map['attributes'] == null ? null : pulumi.Output.create<Map<String, List<String>>>((map['attributes'] as Map).cast<String, List<String>>()),
      ...
      entityType: map['entityType'] == null ? null : pulumi.Output.create<EntityTypes>(EntityTypes.fromValue(map['entityType'] as String)),
      ...
      instancesCount: map['instancesCount'] == null ? null : pulumi.Output.create<int>(map['instancesCount'] as int),
      largeImage: map['largeImage'] == null ? null : pulumi.Output.create<String>(map['largeImage'] as String),
      localizedAttributes: map['localizedAttributes'] == null ? null : pulumi.Output.create<Map<String, Map<String, String>>>((map['localizedAttributes'] as Map).cast<String, Map<String, String>>()),
      mediumImage: map['mediumImage'] == null ? null : pulumi.Output.create<String>(map['mediumImage'] as String),
      profileName: map['profileName'] == null ? null : pulumi.Output.create<String>(map['profileName'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      schemaItemTypeLink: map['schemaItemTypeLink'] == null ? null : pulumi.Output.create<String>(map['schemaItemTypeLink'] as String),
      smallImage: map['smallImage'] == null ? null : pulumi.Output.create<String>(map['smallImage'] as String),
      strongIds: map['strongIds'] == null ? null : pulumi.Output.create<List<StrongId>>(pulumi.Input.decodeList<StrongId>(map['strongIds'], (value) => StrongId.fromMap((value as Map).cast<String, dynamic>()))),
      timestampFieldName: map['timestampFieldName'] == null ? null : pulumi.Output.create<String>(map['timestampFieldName'] as String),
