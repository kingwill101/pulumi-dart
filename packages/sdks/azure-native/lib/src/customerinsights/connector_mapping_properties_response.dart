...
class ConnectorMappingPropertiesResponse {
  ...
  final pulumi.Input<ConnectorMappingCompleteOperationResponse>
  completeOperation;
    ...
    return <String, dynamic>{
      ...
      'completeOperation':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(completeOperation, (value) => value.toMap()),
      'errorManagement':
          pulumi.Input.mapInputValue<
            ConnectorMappingErrorManagementResponse,
            Map<String, dynamic>
          >(errorManagement, (value) => value.toMap()),
      ...
      'structure':
          pulumi.Input.mapInputValue<
            List<ConnectorMappingStructureResponse>,
  ...
  factory ConnectorMappingPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectorMappingPropertiesResponse(
      availability: pulumi.Input.fromValue(
        ConnectorMappingAvailabilityResponse.fromMap(
          (map['availability']! as Map).cast<String, dynamic>(),
        ),
      ),
      completeOperation: pulumi.Input.fromValue(
        ConnectorMappingCompleteOperationResponse.fromMap(
          (map['completeOperation']! as Map).cast<String, dynamic>(),
        ),
      ),
      errorManagement: pulumi.Input.fromValue(
        ConnectorMappingErrorManagementResponse.fromMap(
          (map['errorManagement']! as Map).cast<String, dynamic>(),
        ),
      ),
      fileFilter: (() {
      ...
      format: pulumi.Input.fromValue(
        ConnectorMappingFormatResponse.fromMap(
          (map['format']! as Map).cast<String, dynamic>(),
        ),
      ),
      hasHeader: (() {
        final guardedValue = map['hasHeader'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      structure: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectorMappingStructureResponse>(
          map['structure']!,
          (value) => ConnectorMappingStructureResponse.fromMap(
