...
class PredictionDistributionDefinitionResponse {
  ...
  factory PredictionDistributionDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return PredictionDistributionDefinitionResponse(
      distributions: (() { final guardedValue = map['distributions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PredictionDistributionDefinitionResponseDistributions>(guardedValue, (value) => PredictionDistributionDefinitionResponseDistributions.fromMap((value as Map).cast<String, dynamic>()))); })(),
      totalNegatives: (() { final guardedValue = map['totalNegatives']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      totalPositives: (() { final guardedValue = map['totalPositives']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
