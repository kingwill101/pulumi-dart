...
class PredictionDistributionDefinitionResponse {
  ...
  factory PredictionDistributionDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return PredictionDistributionDefinitionResponse(
      ...
      totalNegatives: (() { final guardedValue = map['totalNegatives']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      totalPositives: (() { final guardedValue = map['totalPositives']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
    );
  }
}
