...
class RoleAssignmentArgs {
  ...
  RoleAssignmentArgs({
    ...
    pulumi.Output<ResourceSetDescription>? conflationPolicies,
    pulumi.Output<ResourceSetDescription>? connectors,
    ...
    pulumi.Output<ResourceSetDescription>? interactions,
    pulumi.Output<ResourceSetDescription>? kpis,
    pulumi.Output<ResourceSetDescription>? links,
    required pulumi.Output<List<AssignmentPrincipal>> principals,
    pulumi.Output<ResourceSetDescription>? profiles,
    pulumi.Output<ResourceSetDescription>? relationshipLinks,
    pulumi.Output<ResourceSetDescription>? relationships,
    required pulumi.Output<String> resourceGroupName,
    required pulumi.Output<RoleTypes> role,
    pulumi.Output<ResourceSetDescription>? roleAssignments,
    pulumi.Output<ResourceSetDescription>? sasPolicies,
    pulumi.Output<ResourceSetDescription>? segments,
    pulumi.Output<ResourceSetDescription>? views,
    pulumi.Output<ResourceSetDescription>? widgetTypes,
  }) :
  ...
  factory RoleAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return RoleAssignmentArgs(
      ...
      conflationPolicies: map['conflationPolicies'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['conflationPolicies'] as Map).cast<String, dynamic>())),
      connectors: map['connectors'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['connectors'] as Map).cast<String, dynamic>())),
      ...
      interactions: map['interactions'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['interactions'] as Map).cast<String, dynamic>())),
      kpis: map['kpis'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['kpis'] as Map).cast<String, dynamic>())),
      links: map['links'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['links'] as Map).cast<String, dynamic>())),
      principals: pulumi.Output.create<List<AssignmentPrincipal>>(pulumi.Input.decodeList<AssignmentPrincipal>(map['principals'], (value) => AssignmentPrincipal.fromMap((value as Map).cast<String, dynamic>()))),
      profiles: map['profiles'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['profiles'] as Map).cast<String, dynamic>())),
      relationshipLinks: map['relationshipLinks'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['relationshipLinks'] as Map).cast<String, dynamic>())),
      relationships: map['relationships'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['relationships'] as Map).cast<String, dynamic>())),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      role: pulumi.Output.create<RoleTypes>(RoleTypes.fromValue(map['role'] as String)),
      roleAssignments: map['roleAssignments'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['roleAssignments'] as Map).cast<String, dynamic>())),
      sasPolicies: map['sasPolicies'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['sasPolicies'] as Map).cast<String, dynamic>())),
      segments: map['segments'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['segments'] as Map).cast<String, dynamic>())),
      views: map['views'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['views'] as Map).cast<String, dynamic>())),
      widgetTypes: map['widgetTypes'] == null ? null : pulumi.Output.create<ResourceSetDescription>(ResourceSetDescription.fromMap((map['widgetTypes'] as Map).cast<String, dynamic>())),
    );
  }
}
