...
class RoleAssignmentArgs {
    ...
    return <String, dynamic>{
      ...
      'conflationPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(conflationPolicies, (value) => value.toMap()),
      'connectors':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceSetDescription,
            Map<String, dynamic>
          >(connectors, (value) => value.toMap()),
      ...
      'interactions':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceSetDescription,
            Map<String, dynamic>
          >(interactions, (value) => value.toMap()),
      'kpis':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceSetDescription,
            Map<String, dynamic>
          >(kpis, (value) => value.toMap()),
      'links':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceSetDescription,
            Map<String, dynamic>
      ...
      'relationshipLinks':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceSetDescription,
            Map<String, dynamic>
          >(relationshipLinks, (value) => value.toMap()),
      'relationships':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceSetDescription,
            Map<String, dynamic>
          >(relationships, (value) => value.toMap()),
      'resourceGroupName': resourceGroupName,
      'role': pulumi.Input.mapInputValue<RoleTypes, String>(
        role,
  ...
  factory RoleAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return RoleAssignmentArgs(
      assignmentName: (() {
        final guardedValue = map['assignmentName'];
      ...
      conflationPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceSetDescription.fromMap(
      ...
      principals: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AssignmentPrincipal>(
          map['principals']!,
          (value) => AssignmentPrincipal.fromMap(
