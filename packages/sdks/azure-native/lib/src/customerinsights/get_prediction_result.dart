  ...
  factory GetPredictionResult.fromMap(Map<String, dynamic> map) {
    return GetPredictionResult(
      ...
      grades: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<PredictionResponseGrades>(
          guardedValue,
          (value) => PredictionResponseGrades.fromMap(
      ...
      mappings: PredictionResponseMappings.fromMap(
      ...
      systemGeneratedEntities:
          PredictionResponseSystemGeneratedEntities.fromMap(
            (map['systemGeneratedEntities']! as Map).cast<String, dynamic>(),
          ),
