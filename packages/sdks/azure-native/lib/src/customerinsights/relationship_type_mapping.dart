...
class RelationshipTypeMapping {
  ...
  RelationshipTypeMapping({required this.fieldMappings});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fieldMappings':
          pulumi.Input.mapInputValue<
            List<RelationshipTypeFieldMapping>,
  ...
  factory RelationshipTypeMapping.fromMap(Map<String, dynamic> map) {
    return RelationshipTypeMapping(
      fieldMappings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RelationshipTypeFieldMapping>(
          map['fieldMappings']!,
          (value) => RelationshipTypeFieldMapping.fromMap(
