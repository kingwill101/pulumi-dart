...
class PropertyDefinitionResponse {
  ...
  final pulumi.Input<List<DataSourcePrecedenceResponse>>
  dataSourcePrecedenceRules;

  /// Describes valid values for an enum property.
  final pulumi.Input<List<ProfileEnumValidValuesFormatResponse>>?
  enumValidValues;
    ...
    return <String, dynamic>{
      ...
      'dataSourcePrecedenceRules':
          pulumi.Input.mapInputValue<
            List<DataSourcePrecedenceResponse>,
      ...
      'enumValidValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<ProfileEnumValidValuesFormatResponse>,
            List<Map<String, dynamic>>
          >(
            enumValidValues,
            (value) =>
  ...
  factory PropertyDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return PropertyDefinitionResponse(
      ...
      dataSourcePrecedenceRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataSourcePrecedenceResponse>(
          map['dataSourcePrecedenceRules']!,
          (value) => DataSourcePrecedenceResponse.fromMap(
      ...
      enumValidValues: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProfileEnumValidValuesFormatResponse>(
            guardedValue,
            (value) => ProfileEnumValidValuesFormatResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
