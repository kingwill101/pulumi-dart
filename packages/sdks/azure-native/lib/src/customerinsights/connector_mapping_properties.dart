...
class ConnectorMappingProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'structure':
          pulumi.Input.mapInputValue<
            List<ConnectorMappingStructure>,
  ...
  factory ConnectorMappingProperties.fromMap(Map<String, dynamic> map) {
    return ConnectorMappingProperties(
      ...
      format: pulumi.Input.fromValue(
        ConnectorMappingFormat.fromMap(
      ...
      structure: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectorMappingStructure>(
          map['structure']!,
          (value) => ConnectorMappingStructure.fromMap(
