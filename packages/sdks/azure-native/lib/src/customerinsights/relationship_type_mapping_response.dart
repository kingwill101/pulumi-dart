...
class RelationshipTypeMappingResponse {
  ...
  final List<RelationshipTypeFieldMappingResponse> fieldMappings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fieldMappings': pulumi.Input.encodeList<RelationshipTypeFieldMappingResponse, Map<String, dynamic>>(fieldMappings, (value) => value.toMap()),
    };
  }

  factory RelationshipTypeMappingResponse.fromMap(Map<String, dynamic> map) {
    return RelationshipTypeMappingResponse(
      fieldMappings: pulumi.Input.decodeList<RelationshipTypeFieldMappingResponse>(map['fieldMappings'], (value) => RelationshipTypeFieldMappingResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
