...
/// {@template pulumi_customerinsights_get_image_upload_url_for_entity_type_args_doc}
/// Arguments for getImageUploadUrlForEntityType.
/// {@endtemplate}
/// {@macro pulumi_customerinsights_get_image_upload_url_for_entity_type_args_doc}
class GetImageUploadUrlForEntityTypeArgs {
  ...
  /// Creates a new [GetImageUploadUrlForEntityTypeArgs].
  ...
  const GetImageUploadUrlForEntityTypeArgs({
    this.entityType,
    this.entityTypeName,
