...
class GetLinkResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'participantPropertyReferences': ?(() { final guardedValue = participantPropertyReferences; if (guardedValue == null) return null; return pulumi.Input.encodeList<ParticipantPropertyReferenceResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetLinkResult.fromMap(Map<String, dynamic> map) {
    return GetLinkResult(
      ...
      participantPropertyReferences: (() { final guardedValue = map['participantPropertyReferences']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ParticipantPropertyReferenceResponse>(guardedValue, (value) => ParticipantPropertyReferenceResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      sourceEntityType: (() { final guardedValue = map['sourceEntityType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      sourceEntityTypeName: (() { final guardedValue = map['sourceEntityTypeName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      targetEntityType: (() { final guardedValue = map['targetEntityType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      targetEntityTypeName: (() { final guardedValue = map['targetEntityTypeName']; if (guardedValue == null) return null; return guardedValue as String; })(),
