...
class PredictionDistributionDefinitionResponseDistributions {
  ...
  factory PredictionDistributionDefinitionResponseDistributions.fromMap(Map<String, dynamic> map) {
    return PredictionDistributionDefinitionResponseDistributions(
      negatives: (() { final guardedValue = map['negatives']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      negativesAboveThreshold: (() { final guardedValue = map['negativesAboveThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      positives: (() { final guardedValue = map['positives']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      positivesAboveThreshold: (() { final guardedValue = map['positivesAboveThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
