...
class PredictionDistributionDefinitionResponseDistributions {
  ...
  factory PredictionDistributionDefinitionResponseDistributions.fromMap(
    Map<String, dynamic> map,
  ) {
    return PredictionDistributionDefinitionResponseDistributions(
      negatives: (() {
        final guardedValue = map['negatives'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      negativesAboveThreshold: (() {
        final guardedValue = map['negativesAboveThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      positives: (() {
        final guardedValue = map['positives'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      positivesAboveThreshold: (() {
        final guardedValue = map['positivesAboveThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      scoreThreshold: (() {
