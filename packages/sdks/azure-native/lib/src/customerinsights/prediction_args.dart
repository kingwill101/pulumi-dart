...
class PredictionArgs {
  ...
  PredictionArgs({
    required pulumi.Output<bool> autoAnalyze,
    pulumi.Output<Map<String, String>>? description,
    pulumi.Output<Map<String, String>>? displayName,
    pulumi.Output<List<PredictionGrades>>? grades,
    required pulumi.Output<String> hubName,
    pulumi.Output<List<String>>? involvedInteractionTypes,
    pulumi.Output<List<String>>? involvedKpiTypes,
    pulumi.Output<List<String>>? involvedRelationships,
    required pulumi.Output<PredictionMappings> mappings,
    required pulumi.Output<String> negativeOutcomeExpression,
    required pulumi.Output<String> positiveOutcomeExpression,
    pulumi.Output<String>? predictionName,
    required pulumi.Output<String> primaryProfileType,
    required pulumi.Output<String> resourceGroupName,
    required pulumi.Output<String> scopeExpression,
    required pulumi.Output<String> scoreLabel,
  }) :
  ...
  factory PredictionArgs.fromMap(Map<String, dynamic> map) {
    return PredictionArgs(
      autoAnalyze: pulumi.Output.create<bool>(map['autoAnalyze'] as bool),
      ...
      grades: map['grades'] == null ? null : pulumi.Output.create<List<PredictionGrades>>(pulumi.Input.decodeList<PredictionGrades>(map['grades'], (value) => PredictionGrades.fromMap((value as Map).cast<String, dynamic>()))),
      hubName: pulumi.Output.create<String>(map['hubName'] as String),
      involvedInteractionTypes: map['involvedInteractionTypes'] == null ? null : pulumi.Output.create<List<String>>((map['involvedInteractionTypes'] as List).cast<String>()),
      involvedKpiTypes: map['involvedKpiTypes'] == null ? null : pulumi.Output.create<List<String>>((map['involvedKpiTypes'] as List).cast<String>()),
      involvedRelationships: map['involvedRelationships'] == null ? null : pulumi.Output.create<List<String>>((map['involvedRelationships'] as List).cast<String>()),
      mappings: pulumi.Output.create<PredictionMappings>(PredictionMappings.fromMap((map['mappings'] as Map).cast<String, dynamic>())),
      negativeOutcomeExpression: pulumi.Output.create<String>(map['negativeOutcomeExpression'] as String),
      positiveOutcomeExpression: pulumi.Output.create<String>(map['positiveOutcomeExpression'] as String),
      predictionName: map['predictionName'] == null ? null : pulumi.Output.create<String>(map['predictionName'] as String),
      primaryProfileType: pulumi.Output.create<String>(map['primaryProfileType'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      scopeExpression: pulumi.Output.create<String>(map['scopeExpression'] as String),
      scoreLabel: pulumi.Output.create<String>(map['scoreLabel'] as String),
    );
  }
}
