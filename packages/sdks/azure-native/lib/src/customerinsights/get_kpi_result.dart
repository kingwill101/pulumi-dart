...
class GetKpiResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aliases': ?aliases == null ? null : pulumi.Input.encodeList<KpiAliasResponse, Map<String, dynamic>>(aliases!, (value) => value.toMap()),
      ...
      'extracts': ?extracts == null ? null : pulumi.Input.encodeList<KpiExtractResponse, Map<String, dynamic>>(extracts!, (value) => value.toMap()),
      'filter': ?filter,
      'function': function,
      'groupBy': ?groupBy,
      ...
      'tenantId': tenantId,
      'thresHolds': ?thresHolds == null ? null : thresHolds!.toMap(),
      'type': type,
      'unit': ?unit,
    };
  }
