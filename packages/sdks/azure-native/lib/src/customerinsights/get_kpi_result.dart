...
class GetKpiResult {
  ...
  final List<KpiParticipantProfilesMetadataResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aliases': ?(() {
        final guardedValue = aliases;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<KpiAliasResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
      ...
      'groupByMetadata':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(groupByMetadata, (value) => value.toMap()),
      'id': id,
      'kpiName': kpiName,
      'name': name,
      'participantProfilesMetadata':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(participantProfilesMetadata, (value) => value.toMap()),
  ...
  factory GetKpiResult.fromMap(Map<String, dynamic> map) {
    return GetKpiResult(
      aliases: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<KpiAliasResponse>(
          guardedValue,
          (value) =>
              KpiAliasResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      extracts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<KpiExtractResponse>(
          guardedValue,
          (value) => KpiExtractResponse.fromMap(
      ...
      groupByMetadata: pulumi.Input.decodeList<KpiGroupByMetadataResponse>(
        map['groupByMetadata']!,
        (value) => KpiGroupByMetadataResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      id: map['id'] as String,
      ...
      participantProfilesMetadata:
          pulumi.Input.decodeList<KpiParticipantProfilesMetadataResponse>(
            map['participantProfilesMetadata']!,
            (value) => KpiParticipantProfilesMetadataResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
