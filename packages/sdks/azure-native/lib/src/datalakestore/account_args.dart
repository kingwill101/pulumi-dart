...
class AccountArgs {
  ...
  final pulumi.Input<List<CreateTrustedIdProviderWithAccountParameters>>?
  trustedIdProviders;

  /// The list of virtual network rules associated with this Data Lake Store account.
  final pulumi.Input<List<CreateVirtualNetworkRuleWithAccountParameters>>?
  virtualNetworkRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'encryptionState':
          ?pulumi.Input.mapOptionalInputValue<EncryptionState, String>(
            encryptionState,
      ...
      'trustedIdProviderState':
          ?pulumi.Input.mapOptionalInputValue<TrustedIdProviderState, String>(
            trustedIdProviderState,
            (value) => value.wireValue,
          ),
      'trustedIdProviders':
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      defaultGroup: (() {
        final guardedValue = map['defaultGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      encryptionConfig: (() {
      ...
      encryptionState: (() {
        final guardedValue = map['encryptionState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EncryptionState.fromValue(guardedValue as String),
        );
      })(),
      firewallAllowAzureIps: (() {
      ...
      trustedIdProviderState: (() {
        final guardedValue = map['trustedIdProviderState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TrustedIdProviderState.fromValue(guardedValue as String),
        );
      })(),
      trustedIdProviders: (() {
        final guardedValue = map['trustedIdProviders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CreateTrustedIdProviderWithAccountParameters>(
            guardedValue,
            (value) => CreateTrustedIdProviderWithAccountParameters.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      virtualNetworkRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<CreateVirtualNetworkRuleWithAccountParameters>(
            guardedValue,
            (value) => CreateVirtualNetworkRuleWithAccountParameters.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
