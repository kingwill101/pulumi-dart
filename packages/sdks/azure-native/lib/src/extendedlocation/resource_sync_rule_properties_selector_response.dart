...
class ResourceSyncRulePropertiesSelectorResponse {
  /// MatchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is 'key', the operator is 'In', and the values array contains only 'value'.
  final pulumi.Input<Map<String, String>>? matchLabels;

  /// Creates a new [ResourceSyncRulePropertiesSelectorResponse].
  ...
  const ResourceSyncRulePropertiesSelectorResponse({
    this.matchLabels,
  });
  ...
  factory ResourceSyncRulePropertiesSelectorResponse.fromMap(Map<String, dynamic> map) {
    return ResourceSyncRulePropertiesSelectorResponse(
