...
class CustomLocationArgs {
  ...
  factory CustomLocationArgs.fromMap(Map<String, dynamic> map) {
    return CustomLocationArgs(
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomLocationPropertiesAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
