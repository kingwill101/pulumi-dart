...
class GetResourceSyncRuleResult {
  ...
  factory GetResourceSyncRuleResult.fromMap(Map<String, dynamic> map) {
    return GetResourceSyncRuleResult(
      ...
      selector: (() { final guardedValue = map['selector']; if (guardedValue == null) return null; return ResourceSyncRulePropertiesResponseSelector.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
