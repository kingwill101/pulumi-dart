...
class GetCustomDomainResult {
  ...
  final CustomDomainPropertiesResponse? properties;
  ...
  factory GetCustomDomainResult.fromMap(Map<String, dynamic> map) {
    return GetCustomDomainResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return CustomDomainPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
