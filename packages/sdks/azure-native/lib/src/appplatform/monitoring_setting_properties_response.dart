...
class MonitoringSettingPropertiesResponse {
  ...
  factory MonitoringSettingPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MonitoringSettingPropertiesResponse(
      appInsightsAgentVersions: (() { final guardedValue = map['appInsightsAgentVersions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationInsightsAgentVersionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
