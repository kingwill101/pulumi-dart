...
class GatewayRouteConfigPropertiesResponse {
  ...
  factory GatewayRouteConfigPropertiesResponse.fromMap(
    ...
    return GatewayRouteConfigPropertiesResponse(
      ...
      openApi: (() {
        ...
        return pulumi.Input.fromValue(
          GatewayRouteConfigOpenApiPropertiesResponse.fromMap(
      ...
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GatewayApiRouteResponse>(
            guardedValue,
            (value) => GatewayApiRouteResponse.fromMap(
