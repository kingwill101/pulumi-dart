...
/// Result data returned by getGatewayCustomDomain.
class GetGatewayCustomDomainResult {
  ...
  /// Creates a new [GetGatewayCustomDomainResult].
  ...
  factory GetGatewayCustomDomainResult.fromMap(Map<String, dynamic> map) {
