...
class GetBuildServiceAgentPoolResult {
  ...
  factory GetBuildServiceAgentPoolResult.fromMap(Map<String, dynamic> map) {
    return GetBuildServiceAgentPoolResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return BuildServiceAgentPoolPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
