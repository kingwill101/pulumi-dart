  ...
  factory DeploymentSettingsResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentSettingsResponse(
      ...
      containerProbeSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerProbeSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      livenessProbe: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProbeResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      readinessProbe: (() {
      ...
      scale: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScaleResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      startupProbe: (() {
