...
class GetServiceRegistryResult {
  ...
  factory GetServiceRegistryResult.fromMap(Map<String, dynamic> map) {
    return GetServiceRegistryResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ServiceRegistryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
