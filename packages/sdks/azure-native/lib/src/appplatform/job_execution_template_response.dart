...
class JobExecutionTemplateResponse {
  ...
  final List<EnvVarResponse>? environmentVariables;
  /// The requested resource quantity for required CPU and Memory.
  final JobResourceRequestsResponse? resourceRequests;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'args': ?args,
      'environmentVariables': ?environmentVariables == null ? null : pulumi.Input.encodeList<EnvVarResponse, Map<String, dynamic>>(environmentVariables!, (value) => value.toMap()),
  ...
  factory JobExecutionTemplateResponse.fromMap(Map<String, dynamic> map) {
    return JobExecutionTemplateResponse(
      ...
      environmentVariables: map['environmentVariables'] == null ? null : pulumi.Input.decodeList<EnvVarResponse>(map['environmentVariables'], (value) => EnvVarResponse.fromMap((value as Map).cast<String, dynamic>())),
      resourceRequests: map['resourceRequests'] == null ? null : JobResourceRequestsResponse.fromMap((map['resourceRequests'] as Map).cast<String, dynamic>()),
    );
  }
}
