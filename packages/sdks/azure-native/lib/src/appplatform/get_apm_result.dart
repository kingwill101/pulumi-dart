...
class GetApmResult {
  ...
  factory GetApmResult.fromMap(Map<String, dynamic> map) {
    return GetApmResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ApmPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
