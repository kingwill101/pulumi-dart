...
class CustomizedAcceleratorProperties {
  ...
  final pulumi.Input<dynamic>? acceleratorType;
  ...
  factory CustomizedAcceleratorProperties.fromMap(Map<String, dynamic> map) {
    return CustomizedAcceleratorProperties(
      ...
      acceleratorType: (() { final guardedValue = map['acceleratorType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
