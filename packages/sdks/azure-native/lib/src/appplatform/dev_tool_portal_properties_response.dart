    ...
    return <String, dynamic>{
      'components':
          pulumi.Input.mapInputValue<
            List<DevToolPortalComponentResponse>,
  ...
  factory DevToolPortalPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DevToolPortalPropertiesResponse(
      components: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DevToolPortalComponentResponse>(
          map['components']!,
          (value) => DevToolPortalComponentResponse.fromMap(
      ...
      features: (() {
        ...
        return pulumi.Input.fromValue(
          DevToolPortalFeatureSettingsResponse.fromMap(
      ...
      ssoProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DevToolPortalSsoPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
