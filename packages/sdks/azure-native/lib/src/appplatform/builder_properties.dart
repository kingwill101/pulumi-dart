...
class BuilderProperties {
  ...
  factory BuilderProperties.fromMap(Map<String, dynamic> map) {
    return BuilderProperties(
      buildpackGroups: (() { final guardedValue = map['buildpackGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BuildpacksGroupProperties>(guardedValue, (value) => BuildpacksGroupProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
      stack: (() { final guardedValue = map['stack']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StackProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
