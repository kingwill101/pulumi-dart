...
class BuilderProperties {
  ...
  BuilderProperties({this.buildpackGroups, this.stack});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'buildpackGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<BuildpacksGroupProperties>,
    ...
    return BuilderProperties(
      buildpackGroups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BuildpacksGroupProperties>(
            guardedValue,
            (value) => BuildpacksGroupProperties.fromMap(
