...
class GatewayPropertiesResponse {
  ...
  final pulumi.Input<GatewayApiMetadataPropertiesResponse>?
  ...
  final pulumi.Input<GatewayPropertiesResponseEnvironmentVariables>?
  ...
  final pulumi.Input<GatewayLocalResponseCachePerInstancePropertiesResponse>?
    ...
    return <String, dynamic>{
      ...
      'apiMetadataProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(apiMetadataProperties, (value) => value.toMap()),
      'apmTypes': ?apmTypes,
      'apms':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApmReferenceResponse>,
      ...
      'corsProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(corsProperties, (value) => value.toMap()),
      'environmentVariables':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'operatorProperties':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(operatorProperties, (value) => value.toMap()),
      ...
      'responseCacheProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(responseCacheProperties, (value) => value.toMap()),
      'ssoProperties':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GatewayPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GatewayPropertiesResponse(
      ...
      apiMetadataProperties: (() {
        final guardedValue = map['apiMetadataProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayApiMetadataPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      apmTypes: (() {
        final guardedValue = map['apmTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      apms: (() {
        final guardedValue = map['apms'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApmReferenceResponse>(
            guardedValue,
            (value) => ApmReferenceResponse.fromMap(
      ...
      clientAuth: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayPropertiesResponseClientAuth.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      corsProperties: (() {
        final guardedValue = map['corsProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayCorsPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      environmentVariables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayPropertiesResponseEnvironmentVariables.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      operatorProperties: pulumi.Input.fromValue(
        GatewayOperatorPropertiesResponse.fromMap(
          (map['operatorProperties']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      resourceRequests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayResourceRequestsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      responseCacheProperties: (() {
        final guardedValue = map['responseCacheProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GatewayLocalResponseCachePerInstancePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
