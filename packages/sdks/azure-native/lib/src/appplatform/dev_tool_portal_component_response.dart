...
class DevToolPortalComponentResponse {
  ...
  factory DevToolPortalComponentResponse.fromMap(Map<String, dynamic> map) {
    return DevToolPortalComponentResponse(
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<DevToolPortalInstanceResponse>(map['instances']!, (value) => DevToolPortalInstanceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      name: pulumi.Input.fromValue(map['name'] as String),
      resourceRequests: pulumi.Input.fromValue(DevToolPortalResourceRequestsResponse.fromMap((map['resourceRequests']! as Map).cast<String, dynamic>())),
    );
  }
}
