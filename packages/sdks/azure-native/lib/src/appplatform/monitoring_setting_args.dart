...
class MonitoringSettingArgs {
  ...
  MonitoringSettingArgs({
    pulumi.Output<MonitoringSettingProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    required pulumi.Output<String> serviceName,
  }) :
      properties = pulumi.Input.asOptionalInput<MonitoringSettingProperties>(properties),
  ...
  factory MonitoringSettingArgs.fromMap(Map<String, dynamic> map) {
    return MonitoringSettingArgs(
      properties: map['properties'] == null ? null : pulumi.Output.create<MonitoringSettingProperties>(MonitoringSettingProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
