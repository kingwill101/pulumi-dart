...
class GatewayCorsPropertiesResponse {
  ...
  /// Creates a new [GatewayCorsPropertiesResponse].
  ...
  const GatewayCorsPropertiesResponse({
  ...
  factory GatewayCorsPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GatewayCorsPropertiesResponse(
