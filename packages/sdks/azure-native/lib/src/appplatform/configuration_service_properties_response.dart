...
class ConfigurationServicePropertiesResponse {
  ...
  final pulumi.Input<ConfigurationServiceResourceRequestsResponse>
  resourceRequests;
    ...
    return <String, dynamic>{
      ...
      'instances':
          pulumi.Input.mapInputValue<
            List<ConfigurationServiceInstanceResponse>,
  ...
  factory ConfigurationServicePropertiesResponse.fromMap(
    ...
    return ConfigurationServicePropertiesResponse(
      ...
      instances: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConfigurationServiceInstanceResponse>(
          map['instances']!,
          (value) => ConfigurationServiceInstanceResponse.fromMap(
      ...
      resourceRequests: pulumi.Input.fromValue(
        ConfigurationServiceResourceRequestsResponse.fromMap(
      ...
      settings: (() {
        ...
        return pulumi.Input.fromValue(
          ConfigurationServiceSettingsResponse.fromMap(
