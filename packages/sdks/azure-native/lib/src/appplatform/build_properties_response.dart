...
class BuildPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'certificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<CertificateReferenceResponse>,
            List<Map<String, dynamic>>
          >(
            certificates,
            (value) =>
      ...
      'triggeredBuildResult':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(triggeredBuildResult, (value) => value.toMap()),
    };
  }
  ...
  factory BuildPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return BuildPropertiesResponse(
      agentPool: (() {
        final guardedValue = map['agentPool'];
      ...
      certificates: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CertificateReferenceResponse>(
            guardedValue,
      ...
      resourceRequests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BuildResourceRequestsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      triggeredBuildResult: pulumi.Input.fromValue(
        TriggeredBuildResultResponse.fromMap(
          (map['triggeredBuildResult']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
