...
class DevToolPortalArgs {
  ...
  factory DevToolPortalArgs.fromMap(Map<String, dynamic> map) {
    return DevToolPortalArgs(
      devToolPortalName: (() { final guardedValue = map['devToolPortalName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DevToolPortalProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
