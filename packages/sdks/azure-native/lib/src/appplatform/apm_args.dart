...
class ApmArgs {
  ...
  factory ApmArgs.fromMap(Map<String, dynamic> map) {
    return ApmArgs(
      apmName: (() { final guardedValue = map['apmName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApmProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
