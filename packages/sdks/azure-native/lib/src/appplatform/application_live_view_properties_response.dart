...
class ApplicationLiveViewPropertiesResponse {
  ...
  factory ApplicationLiveViewPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationLiveViewPropertiesResponse(
      components: pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationLiveViewComponentResponse>(map['components']!, (value) => ApplicationLiveViewComponentResponse.fromMap((value as Map).cast<String, dynamic>()))),
