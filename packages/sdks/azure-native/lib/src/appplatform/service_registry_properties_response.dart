    ...
    return <String, dynamic>{
      'instances':
          pulumi.Input.mapInputValue<
            List<ServiceRegistryInstanceResponse>,
  ...
  factory ServiceRegistryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ServiceRegistryPropertiesResponse(
      instances: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ServiceRegistryInstanceResponse>(
          map['instances']!,
          (value) => ServiceRegistryInstanceResponse.fromMap(
      ...
      resourceRequests: pulumi.Input.fromValue(
        ServiceRegistryResourceRequestsResponse.fromMap(
