...
class ServiceRegistryPropertiesResponse {
  ...
  factory ServiceRegistryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ServiceRegistryPropertiesResponse(
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceRegistryInstanceResponse>(map['instances']!, (value) => ServiceRegistryInstanceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      resourceRequests: pulumi.Input.fromValue(ServiceRegistryResourceRequestsResponse.fromMap((map['resourceRequests']! as Map).cast<String, dynamic>())),
    );
  }
}
