...
class IngressSettingsResponse {
  ...
  final IngressSettingsResponseClientAuth? clientAuth;
  ...
  factory IngressSettingsResponse.fromMap(Map<String, dynamic> map) {
    return IngressSettingsResponse(
      ...
      clientAuth: map['clientAuth'] == null ? null : IngressSettingsResponseClientAuth.fromMap((map['clientAuth'] as Map).cast<String, dynamic>()),
