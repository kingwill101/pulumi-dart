...
class Scale {
  ...
  /// [rules] Scaling rules.
  Scale({this.maxReplicas, this.minReplicas, this.rules});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ...
          >(
            rules,
            (value) => pulumi.Input.encodeList<ScaleRule, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return Scale(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScaleRule>(
            guardedValue,
            (value) =>
                ScaleRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
