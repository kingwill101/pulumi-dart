...
class BuildpacksGroupPropertiesResponse {
  ...
  BuildpacksGroupPropertiesResponse({this.buildpacks, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'buildpacks':
          ?pulumi.Input.mapOptionalInputValue<
            List<BuildpackPropertiesResponse>,
  ...
  factory BuildpacksGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return BuildpacksGroupPropertiesResponse(
      buildpacks: (() {
        final guardedValue = map['buildpacks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BuildpackPropertiesResponse>(
            guardedValue,
            (value) => BuildpackPropertiesResponse.fromMap(
