...
class ApplicationLiveViewComponentResponse {
  ...
  factory ApplicationLiveViewComponentResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationLiveViewComponentResponse(
      instances: pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationLiveViewInstanceResponse>(map['instances']!, (value) => ApplicationLiveViewInstanceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      name: pulumi.Input.fromValue(map['name']),
      resourceRequests: pulumi.Input.fromValue(ApplicationLiveViewResourceRequestsResponse.fromMap((map['resourceRequests']! as Map).cast<String, dynamic>())),
    );
  }
}
