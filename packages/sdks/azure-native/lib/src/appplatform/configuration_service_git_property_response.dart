...
class ConfigurationServiceGitPropertyResponse {
  ...
  const ConfigurationServiceGitPropertyResponse({
    this.repositories,
  });
  ...
  factory ConfigurationServiceGitPropertyResponse.fromMap(Map<String, dynamic> map) {
    return ConfigurationServiceGitPropertyResponse(
      repositories: (() { final guardedValue = map['repositories']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConfigurationServiceGitRepositoryResponse>(guardedValue, (value) => ConfigurationServiceGitRepositoryResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
