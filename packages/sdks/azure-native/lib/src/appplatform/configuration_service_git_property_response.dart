...
class ConfigurationServiceGitPropertyResponse {
  ...
  final pulumi.Input<List<ConfigurationServiceGitRepositoryResponse>>?
  repositories;
  ...
  ConfigurationServiceGitPropertyResponse({this.repositories});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'repositories':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigurationServiceGitRepositoryResponse>,
  ...
  factory ConfigurationServiceGitPropertyResponse.fromMap(
    ...
    return ConfigurationServiceGitPropertyResponse(
      repositories: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConfigurationServiceGitRepositoryResponse>(
            guardedValue,
            (value) => ConfigurationServiceGitRepositoryResponse.fromMap(
