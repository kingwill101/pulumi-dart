...
class NetworkProfileResponse {
    ...
    return <String, dynamic>{
      ...
      'ingressConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(ingressConfig, (value) => value.toMap()),
      'outboundIPs':
  ...
  factory NetworkProfileResponse.fromMap(Map<String, dynamic> map) {
    return NetworkProfileResponse(
      ...
      appSubnetId: (() {
        final guardedValue = map['appSubnetId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ingressConfig: (() {
        final guardedValue = map['ingressConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IngressConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outboundIPs: pulumi.Input.fromValue(
        NetworkProfileResponseOutboundIPs.fromMap(
          (map['outboundIPs']! as Map).cast<String, dynamic>(),
        ),
      ),
      outboundType: (() {
      ...
      requiredTraffics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RequiredTrafficResponse>(
          map['requiredTraffics']!,
          (value) => RequiredTrafficResponse.fromMap(
      ...
      serviceRuntimeSubnetId: (() {
        final guardedValue = map['serviceRuntimeSubnetId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
