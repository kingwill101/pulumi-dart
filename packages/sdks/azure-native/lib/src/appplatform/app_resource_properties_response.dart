...
class AppResourcePropertiesResponse {
  ...
  final pulumi.Input<List<CustomPersistentDiskResourceResponse>>?
    ...
    return <String, dynamic>{
      ...
      'customPersistentDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomPersistentDiskResourceResponse>,
      ...
      'loadedCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<LoadedCertificateResponse>,
            List<Map<String, dynamic>>
          >(
            loadedCertificates,
            (value) =>
      ...
      'temporaryDisk':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(temporaryDisk, (value) => value.toMap()),
  ...
  factory AppResourcePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AppResourcePropertiesResponse(
      addonConfigs: (() {
        final guardedValue = map['addonConfigs'];
      ...
      customPersistentDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomPersistentDiskResourceResponse>(
            guardedValue,
            (value) => CustomPersistentDiskResourceResponse.fromMap(
      ...
      enableEndToEndTLS: (() {
        final guardedValue = map['enableEndToEndTLS'];
        if (guardedValue == null) return null;
      ...
      ingressSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IngressSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      loadedCertificates: (() {
        final guardedValue = map['loadedCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoadedCertificateResponse>(
            guardedValue,
            (value) => LoadedCertificateResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      persistentDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PersistentDiskResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      temporaryDisk: (() {
        final guardedValue = map['temporaryDisk'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TemporaryDiskResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      testEndpointAuthState: (() {
        final guardedValue = map['testEndpointAuthState'];
        if (guardedValue == null) return null;
