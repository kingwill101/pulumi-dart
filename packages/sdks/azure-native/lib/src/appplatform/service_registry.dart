...
/// }
///
/// resource "azure-native_appplatform_serviceregistry" "serviceRegistry" {
...
class ServiceRegistry extends pulumi.CustomResource {
  ...
  ServiceRegistry(
    ...
    properties = registerOutput<ServiceRegistryPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceRegistryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ServiceRegistry] resource.
  ServiceRegistry.reference(String urn)
    : super(
        'azure-native:appplatform:ServiceRegistry',
