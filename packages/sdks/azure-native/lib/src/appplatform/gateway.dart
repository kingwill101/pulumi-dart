...
class Gateway extends pulumi.CustomResource {
  ...
  Gateway(
    ...
    properties = registerOutput<GatewayPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GatewayPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
