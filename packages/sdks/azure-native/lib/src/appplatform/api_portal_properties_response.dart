    ...
    return <String, dynamic>{
      ...
      'instances':
          pulumi.Input.mapInputValue<
            List<ApiPortalInstanceResponse>,
  ...
  factory ApiPortalPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApiPortalPropertiesResponse(
      ...
      instances: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ApiPortalInstanceResponse>(
          map['instances']!,
          (value) => ApiPortalInstanceResponse.fromMap(
      ...
      resourceRequests: pulumi.Input.fromValue(
        ApiPortalResourceRequestsResponse.fromMap(
