...
class ClusterResourceProperties {
  ...
  final pulumi.Input<WeeklyMaintenanceScheduleConfiguration>?
    ...
    return ClusterResourceProperties(
      ...
      maintenanceScheduleConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          WeeklyMaintenanceScheduleConfiguration.fromMap(
