...
class BuildpacksGroupProperties {
  ...
  BuildpacksGroupProperties({this.buildpacks, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'buildpacks':
          ?pulumi.Input.mapOptionalInputValue<
            List<BuildpackProperties>,
    ...
    return BuildpacksGroupProperties(
      buildpacks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BuildpackProperties>(
            guardedValue,
            (value) => BuildpackProperties.fromMap(
