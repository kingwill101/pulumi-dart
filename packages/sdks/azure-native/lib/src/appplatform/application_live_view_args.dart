...
class ApplicationLiveViewArgs {
  ...
  factory ApplicationLiveViewArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationLiveViewArgs(
      applicationLiveViewName: (() { final guardedValue = map['applicationLiveViewName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
