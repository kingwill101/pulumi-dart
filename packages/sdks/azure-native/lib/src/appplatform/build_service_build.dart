...
class BuildServiceBuild extends pulumi.CustomResource {
  ...
  BuildServiceBuild(
    ...
    properties = registerOutput<BuildPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BuildPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [BuildServiceBuild] resource.
  BuildServiceBuild.reference(String urn)
    : super(
        'azure-native:appplatform:BuildServiceBuild',
