...
class JobResourceProperties {
  ...
  final pulumi.Input<List<ManagedComponentReference>>?
    ...
    return <String, dynamic>{
      'managedComponentReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedComponentReference>,
    ...
    return JobResourceProperties(
      managedComponentReferences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedComponentReference>(
            guardedValue,
            (value) => ManagedComponentReference.fromMap(
      ...
      triggerConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManualJobTriggerConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
