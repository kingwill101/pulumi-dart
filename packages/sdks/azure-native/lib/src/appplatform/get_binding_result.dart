...
class GetBindingResult {
  ...
  factory GetBindingResult.fromMap(Map<String, dynamic> map) {
    return GetBindingResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return BindingResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
