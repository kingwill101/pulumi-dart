...
class BuildServiceAgentPool extends pulumi.CustomResource {
  ...
  BuildServiceAgentPool(
    ...
    properties = registerOutput<BuildServiceAgentPoolPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BuildServiceAgentPoolPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [BuildServiceAgentPool] resource.
  BuildServiceAgentPool.reference(String urn)
    : super(
        'azure-native:appplatform:BuildServiceAgentPool',
