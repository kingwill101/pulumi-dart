    ...
    return <String, dynamic>{
      ...
      'customPersistentDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomPersistentDiskResource>,
  ...
  factory AppResourceProperties.fromMap(Map<String, dynamic> map) {
    return AppResourceProperties(
      ...
      customPersistentDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomPersistentDiskResource>(
            guardedValue,
            (value) => CustomPersistentDiskResource.fromMap(
      ...
      loadedCertificates: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoadedCertificate>(
            guardedValue,
            (value) => LoadedCertificate.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      persistentDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PersistentDisk.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      public: (() {
      ...
      temporaryDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TemporaryDisk.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      vnetAddons: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppVNetAddons.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      workloadProfileName: (() {
