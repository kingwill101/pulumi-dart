...
class AzureHybridBenefitProperties {
  ...
  final pulumi.Input<dynamic>? scomLicenseType;
  ...
  final pulumi.Input<dynamic>? windowsServerLicenseType;
  ...
  factory AzureHybridBenefitProperties.fromMap(Map<String, dynamic> map) {
    return AzureHybridBenefitProperties(
      scomLicenseType: (() { final guardedValue = map['scomLicenseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      windowsServerLicenseType: (() { final guardedValue = map['windowsServerLicenseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
