...
class MonitoringInstanceProperties {
    ...
    return <String, dynamic>{
      'azureHybridBenefit':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(azureHybridBenefit, (value) => value.toMap()),
      'databaseInstance':
          ?pulumi.Input.mapOptionalInputValue<
            DatabaseInstanceProperties,
            Map<String, dynamic>
          >(databaseInstance, (value) => value.toMap()),
      'domainController':
          ?pulumi.Input.mapOptionalInputValue<
            DomainControllerProperties,
            Map<String, dynamic>
          >(domainController, (value) => value.toMap()),
      'domainUserCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            DomainUserCredentials,
            Map<String, dynamic>
          >(domainUserCredentials, (value) => value.toMap()),
      'gmsaDetails':
          ?pulumi.Input.mapOptionalInputValue<
            GmsaDetails,
            Map<String, dynamic>
          >(gmsaDetails, (value) => value.toMap()),
  ...
  factory MonitoringInstanceProperties.fromMap(Map<String, dynamic> map) {
    return MonitoringInstanceProperties(
      azureHybridBenefit: (() {
        final guardedValue = map['azureHybridBenefit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureHybridBenefitProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      databaseInstance: (() {
        final guardedValue = map['databaseInstance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatabaseInstanceProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      domainController: (() {
        final guardedValue = map['domainController'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainControllerProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      domainUserCredentials: (() {
        final guardedValue = map['domainUserCredentials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainUserCredentials.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      gmsaDetails: (() {
        final guardedValue = map['gmsaDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GmsaDetails.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      vNetSubnetId: (() {
