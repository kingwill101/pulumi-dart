...
class IotDpsResourceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sku': pulumi.Input.mapInputValue<IotDpsSkuInfo, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
  ...
  factory IotDpsResourceArgs.fromMap(Map<String, dynamic> map) {
    return IotDpsResourceArgs(
      ...
      properties: pulumi.Input.fromValue(
        IotDpsPropertiesDescription.fromMap(
          (map['properties']! as Map).cast<String, dynamic>(),
        ),
      ),
      provisioningServiceName: (() {
        final guardedValue = map['provisioningServiceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      sku: pulumi.Input.fromValue(
        IotDpsSkuInfo.fromMap((map['sku']! as Map).cast<String, dynamic>()),
      ),
      subscriptionid: (() {
