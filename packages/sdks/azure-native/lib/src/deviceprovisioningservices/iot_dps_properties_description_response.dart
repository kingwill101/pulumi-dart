...
class IotDpsPropertiesDescriptionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'iotHubs':
          ?pulumi.Input.mapOptionalInputValue<
            List<IotHubDefinitionDescriptionResponse>,
            List<Map<String, dynamic>>
          >(
            iotHubs,
            (value) =>
  ...
  factory IotDpsPropertiesDescriptionResponse.fromMap(
    ...
    return IotDpsPropertiesDescriptionResponse(
      ...
      deviceProvisioningHostName: pulumi.Input.fromValue(
        map['deviceProvisioningHostName'] as String,
      ),
      enableDataResidency: (() {
      ...
      iotHubs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IotHubDefinitionDescriptionResponse>(
            guardedValue,
            (value) => IotHubDefinitionDescriptionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ipFilterRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpFilterRuleResponse>(
            guardedValue,
            (value) => IpFilterRuleResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceOperationsHostName: pulumi.Input.fromValue(
        map['serviceOperationsHostName'] as String,
      ),
      state: (() {
