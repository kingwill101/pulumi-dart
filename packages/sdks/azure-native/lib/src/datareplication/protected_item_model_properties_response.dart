...
class ProtectedItemModelPropertiesResponse {
  ...
  final pulumi.Input<ProtectedItemModelPropertiesResponseLastTestFailoverJob>
  lastTestFailoverJob;
    ...
    return <String, dynamic>{
      ...
      'lastFailedEnableProtectionJob':
          pulumi.Input.mapInputValue<
            ProtectedItemModelPropertiesResponseLastFailedEnableProtectionJob,
            Map<String, dynamic>
          >(lastFailedEnableProtectionJob, (value) => value.toMap()),
      'lastFailedPlannedFailoverJob':
          pulumi.Input.mapInputValue<
            ProtectedItemModelPropertiesResponseLastFailedPlannedFailoverJob,
            Map<String, dynamic>
          >(lastFailedPlannedFailoverJob, (value) => value.toMap()),
      ...
      'lastTestFailoverJob':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(lastTestFailoverJob, (value) => value.toMap()),
  ...
  factory ProtectedItemModelPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ProtectedItemModelPropertiesResponse(
      allowedJobs: pulumi.Input.fromValue(
        (map['allowedJobs'] as List).cast<String>(),
      ),
      correlationId: pulumi.Input.fromValue(map['correlationId'] as String),
      currentJob: pulumi.Input.fromValue(
        ProtectedItemModelPropertiesResponseCurrentJob.fromMap(
          (map['currentJob']! as Map).cast<String, dynamic>(),
        ),
      ),
      customProperties: pulumi.Input.fromValue(
        HyperVToAzStackHCIProtectedItemModelCustomPropertiesResponse.fromMap(
      ...
      fabricObjectName: pulumi.Input.fromValue(
        map['fabricObjectName'] as String,
      ),
      ...
      lastFailedEnableProtectionJob: pulumi.Input.fromValue(
        ProtectedItemModelPropertiesResponseLastFailedEnableProtectionJob.fromMap(
          (map['lastFailedEnableProtectionJob']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      lastFailedPlannedFailoverJob: pulumi.Input.fromValue(
        ProtectedItemModelPropertiesResponseLastFailedPlannedFailoverJob.fromMap(
          (map['lastFailedPlannedFailoverJob']! as Map).cast<String, dynamic>(),
        ),
      ),
      lastSuccessfulPlannedFailoverTime: pulumi.Input.fromValue(
        map['lastSuccessfulPlannedFailoverTime'] as String,
      ),
      lastSuccessfulTestFailoverTime: pulumi.Input.fromValue(
        map['lastSuccessfulTestFailoverTime'] as String,
      ),
      lastSuccessfulUnplannedFailoverTime: pulumi.Input.fromValue(
        map['lastSuccessfulUnplannedFailoverTime'] as String,
      ),
      lastTestFailoverJob: pulumi.Input.fromValue(
        ProtectedItemModelPropertiesResponseLastTestFailoverJob.fromMap(
          (map['lastTestFailoverJob']! as Map).cast<String, dynamic>(),
        ),
      ),
      policyName: pulumi.Input.fromValue(map['policyName'] as String),
      protectionState: pulumi.Input.fromValue(map['protectionState'] as String),
      protectionStateDescription: pulumi.Input.fromValue(
        map['protectionStateDescription'] as String,
      ),
      ...
      resynchronizationState: pulumi.Input.fromValue(
        map['resynchronizationState'] as String,
      ),
      sourceFabricProviderId: pulumi.Input.fromValue(
        map['sourceFabricProviderId'] as String,
      ),
      ...
      targetFabricProviderId: pulumi.Input.fromValue(
        map['targetFabricProviderId'] as String,
      ),
      testFailoverState: pulumi.Input.fromValue(
        map['testFailoverState'] as String,
      ),
      testFailoverStateDescription: pulumi.Input.fromValue(
        map['testFailoverStateDescription'] as String,
      ),
    );
  }
}
