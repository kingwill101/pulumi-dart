...
class DraModelResponseSystemData {
  ...
  /// Creates a new [DraModelResponseSystemData].
  ...
  const DraModelResponseSystemData({
    this.createdAt,
    this.createdBy,
    this.createdByType,
    this.lastModifiedAt,
  ...
  factory DraModelResponseSystemData.fromMap(Map<String, dynamic> map) {
    return DraModelResponseSystemData(
