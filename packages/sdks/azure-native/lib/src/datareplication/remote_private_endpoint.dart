...
class RemotePrivateEndpoint {
  ...
  factory RemotePrivateEndpoint.fromMap(Map<String, dynamic> map) {
    return RemotePrivateEndpoint(
      connectionDetails: (() { final guardedValue = map['connectionDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectionDetails>(guardedValue, (value) => ConnectionDetails.fromMap((value as Map).cast<String, dynamic>()))); })(),
