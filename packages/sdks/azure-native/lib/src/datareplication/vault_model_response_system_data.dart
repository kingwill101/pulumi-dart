...
class VaultModelResponseSystemData {
  ...
  /// Creates a new [VaultModelResponseSystemData].
  ...
  const VaultModelResponseSystemData({
    this.createdAt,
    this.createdBy,
    this.createdByType,
    this.lastModifiedAt,
  ...
  factory VaultModelResponseSystemData.fromMap(Map<String, dynamic> map) {
    return VaultModelResponseSystemData(
