...
class HyperVToAzStackHCIProtectedItemModelCustomProperties {
    ...
    return <String, dynamic>{
      ...
      'disksToInclude':
          pulumi.Input.mapInputValue<
            List<HyperVToAzStackHCIDiskInput>,
      ...
      'nicsToInclude':
          pulumi.Input.mapInputValue<
            List<HyperVToAzStackHCINicInput>,
            List<Map<String, dynamic>>
          >(
            nicsToInclude,
            (value) =>
  ...
  factory HyperVToAzStackHCIProtectedItemModelCustomProperties.fromMap(
    ...
    return HyperVToAzStackHCIProtectedItemModelCustomProperties(
      ...
      disksToInclude: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HyperVToAzStackHCIDiskInput>(
          map['disksToInclude']!,
          (value) => HyperVToAzStackHCIDiskInput.fromMap(
      ...
      nicsToInclude: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HyperVToAzStackHCINicInput>(
          map['nicsToInclude']!,
          (value) => HyperVToAzStackHCINicInput.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
