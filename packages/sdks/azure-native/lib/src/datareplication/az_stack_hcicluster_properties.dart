...
class AzStackHCIClusterProperties {
  ...
  const AzStackHCIClusterProperties({
  ...
  factory AzStackHCIClusterProperties.fromMap(Map<String, dynamic> map) {
    return AzStackHCIClusterProperties(
      ...
      storageContainers: pulumi.Input.fromValue(pulumi.Input.decodeList<StorageContainerProperties>(map['storageContainers']!, (value) => StorageContainerProperties.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
