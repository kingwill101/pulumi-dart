...
class PolicyModelProperties {
  ...
  final pulumi.Input<HyperVToAzStackHCIPolicyModelCustomProperties>
  customProperties;

  /// Creates a new [PolicyModelProperties].
  /// [customProperties] Policy model custom properties.
  PolicyModelProperties({required this.customProperties});
  ...
  factory PolicyModelProperties.fromMap(Map<String, dynamic> map) {
    return PolicyModelProperties(
      customProperties: pulumi.Input.fromValue(
        HyperVToAzStackHCIPolicyModelCustomProperties.fromMap(
