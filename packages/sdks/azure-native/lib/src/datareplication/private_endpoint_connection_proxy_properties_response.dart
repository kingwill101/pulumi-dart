...
class PrivateEndpointConnectionProxyPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'remotePrivateEndpoint': ?pulumi.Input.mapOptionalInputValue<RemotePrivateEndpointResponse, Map<String, dynamic>>(remotePrivateEndpoint, (value) => value.toMap()),
    };
  }
  ...
  factory PrivateEndpointConnectionProxyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointConnectionProxyPropertiesResponse(
      ...
      remotePrivateEndpoint: (() { final guardedValue = map['remotePrivateEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RemotePrivateEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
