...
class GetPrivateEndpointConnectionResult {
  ...
  final PrivateEndpointConnectionResponsePropertiesResponse? properties;
  ...
  factory GetPrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetPrivateEndpointConnectionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return PrivateEndpointConnectionResponsePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
