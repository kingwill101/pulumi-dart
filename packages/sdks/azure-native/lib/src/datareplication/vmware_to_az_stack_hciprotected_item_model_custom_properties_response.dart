...
class VMwareToAzStackHCIProtectedItemModelCustomPropertiesResponse {
  ...
  final pulumi.Input<ProtectedItemDynamicMemoryConfigResponse>?
  dynamicMemoryConfig;
  ...
  final pulumi.Input<List<VMwareToAzStackHCIProtectedDiskPropertiesResponse>>
  protectedDisks;

  /// Gets or sets the VM NIC details.
  final pulumi.Input<List<VMwareToAzStackHCIProtectedNicPropertiesResponse>>
  protectedNics;
    ...
    return <String, dynamic>{
      ...
      'disksToInclude':
          pulumi.Input.mapInputValue<
            List<VMwareToAzStackHCIDiskInputResponse>,
      ...
      'nicsToInclude':
          pulumi.Input.mapInputValue<
            List<VMwareToAzStackHCINicInputResponse>,
            List<Map<String, dynamic>>
          >(
            nicsToInclude,
            (value) =>
      ...
      'protectedDisks':
          pulumi.Input.mapInputValue<
            List<VMwareToAzStackHCIProtectedDiskPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            protectedDisks,
            (value) =>
      ...
      'protectedNics':
          pulumi.Input.mapInputValue<
            List<VMwareToAzStackHCIProtectedNicPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            protectedNics,
            (value) =>
  ...
  factory VMwareToAzStackHCIProtectedItemModelCustomPropertiesResponse.fromMap(
    ...
    return VMwareToAzStackHCIProtectedItemModelCustomPropertiesResponse(
      ...
      disksToInclude: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VMwareToAzStackHCIDiskInputResponse>(
          map['disksToInclude']!,
          (value) => VMwareToAzStackHCIDiskInputResponse.fromMap(
      ...
      dynamicMemoryConfig: (() {
        ...
        return pulumi.Input.fromValue(
          ProtectedItemDynamicMemoryConfigResponse.fromMap(
      ...
      failoverRecoveryPointId: pulumi.Input.fromValue(
        map['failoverRecoveryPointId'] as String,
      ),
      ...
      initialReplicationProgressPercentage: pulumi.Input.fromValue(
        map['initialReplicationProgressPercentage'] as int,
      ),
      ...
      lastReplicationUpdateTime: pulumi.Input.fromValue(
        map['lastReplicationUpdateTime'] as String,
      ),
      ...
      nicsToInclude: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VMwareToAzStackHCINicInputResponse>(
          map['nicsToInclude']!,
          (value) => VMwareToAzStackHCINicInputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      protectedDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          VMwareToAzStackHCIProtectedDiskPropertiesResponse
        >(
          map['protectedDisks']!,
          (value) => VMwareToAzStackHCIProtectedDiskPropertiesResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      protectedNics: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<VMwareToAzStackHCIProtectedNicPropertiesResponse>(
          map['protectedNics']!,
          (value) => VMwareToAzStackHCIProtectedNicPropertiesResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      sourceApplianceName: pulumi.Input.fromValue(
        map['sourceApplianceName'] as String,
      ),
      ...
      sourceMemoryInMegaBytes: pulumi.Input.fromValue(
        map['sourceMemoryInMegaBytes'] as double,
      ),
      ...
      targetApplianceName: pulumi.Input.fromValue(
        map['targetApplianceName'] as String,
      ),
      targetArcClusterCustomLocationId: pulumi.Input.fromValue(
        map['targetArcClusterCustomLocationId'] as String,
      ),
      targetAzStackHciClusterName: pulumi.Input.fromValue(
        map['targetAzStackHciClusterName'] as String,
      ),
      targetCpuCores: (() {
