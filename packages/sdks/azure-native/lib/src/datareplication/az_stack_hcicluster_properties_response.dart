...
class AzStackHCIClusterPropertiesResponse {
  ...
  final pulumi.Input<List<StorageContainerPropertiesResponse>>
  storageContainers;
    ...
    return <String, dynamic>{
      ...
      'storageContainers':
          pulumi.Input.mapInputValue<
            List<StorageContainerPropertiesResponse>,
  ...
  factory AzStackHCIClusterPropertiesResponse.fromMap(
    ...
    return AzStackHCIClusterPropertiesResponse(
      ...
      storageContainers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StorageContainerPropertiesResponse>(
          map['storageContainers']!,
          (value) => StorageContainerPropertiesResponse.fromMap(
