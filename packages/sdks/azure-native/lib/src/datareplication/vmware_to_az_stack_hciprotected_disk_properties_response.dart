...
class VMwareToAzStackHCIProtectedDiskPropertiesResponse {
  ...
  /// Creates a new [VMwareToAzStackHCIProtectedDiskPropertiesResponse].
  ...
  factory VMwareToAzStackHCIProtectedDiskPropertiesResponse.fromMap(
    ...
    return VMwareToAzStackHCIProtectedDiskPropertiesResponse(
      ...
      storageContainerLocalPath: pulumi.Input.fromValue(
        map['storageContainerLocalPath'] as String,
      ),
      testMigrateDiskName: pulumi.Input.fromValue(
        map['testMigrateDiskName'] as String,
      ),
    );
  }
}
