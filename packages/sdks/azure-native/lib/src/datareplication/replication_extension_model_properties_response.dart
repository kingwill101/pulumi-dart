...
class ReplicationExtensionModelPropertiesResponse {
  ...
  final HyperVToAzStackHCIReplicationExtensionModelCustomPropertiesResponse customProperties;
  ...
  factory ReplicationExtensionModelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationExtensionModelPropertiesResponse(
      customProperties: HyperVToAzStackHCIReplicationExtensionModelCustomPropertiesResponse.fromMap((map['customProperties'] as Map).cast<String, dynamic>()),
