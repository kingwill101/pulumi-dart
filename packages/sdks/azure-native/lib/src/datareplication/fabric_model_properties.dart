...
class FabricModelProperties {
  ...
  final AzStackHCIFabricModelCustomProperties customProperties;
  ...
  factory FabricModelProperties.fromMap(Map<String, dynamic> map) {
    return FabricModelProperties(
      customProperties: AzStackHCIFabricModelCustomProperties.fromMap((map['customProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
