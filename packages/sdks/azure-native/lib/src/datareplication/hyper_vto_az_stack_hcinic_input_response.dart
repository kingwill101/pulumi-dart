...
class HyperVToAzStackHCINicInputResponse {
  ...
  /// Creates a new [HyperVToAzStackHCINicInputResponse].
  ...
  const HyperVToAzStackHCINicInputResponse({
  ...
  factory HyperVToAzStackHCINicInputResponse.fromMap(Map<String, dynamic> map) {
    return HyperVToAzStackHCINicInputResponse(
