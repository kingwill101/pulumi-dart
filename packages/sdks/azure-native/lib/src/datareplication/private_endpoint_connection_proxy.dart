...
class PrivateEndpointConnectionProxy extends pulumi.CustomResource {
  ...
  PrivateEndpointConnectionProxy(
    ...
    properties = registerOutput<PrivateEndpointConnectionProxyPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PrivateEndpointConnectionProxyPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
