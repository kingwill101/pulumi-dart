...
import 'vmware_to_az_stack_hcidisk_input.dart';
import 'vmware_to_az_stack_hcinic_input.dart';
...
class VMwareToAzStackHCIProtectedItemModelCustomProperties {
  ...
  final List<VMwareToAzStackHCIDiskInput> disksToInclude;
  ...
  final List<VMwareToAzStackHCINicInput> nicsToInclude;
  ...
  /// Creates a new [VMwareToAzStackHCIProtectedItemModelCustomProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disksToInclude': pulumi.Input.encodeList<VMwareToAzStackHCIDiskInput, Map<String, dynamic>>(disksToInclude, (value) => value.toMap()),
      ...
      'nicsToInclude': pulumi.Input.encodeList<VMwareToAzStackHCINicInput, Map<String, dynamic>>(nicsToInclude, (value) => value.toMap()),
  ...
  factory VMwareToAzStackHCIProtectedItemModelCustomProperties.fromMap(Map<String, dynamic> map) {
    return VMwareToAzStackHCIProtectedItemModelCustomProperties(
      ...
      disksToInclude: pulumi.Input.decodeList<VMwareToAzStackHCIDiskInput>(map['disksToInclude'], (value) => VMwareToAzStackHCIDiskInput.fromMap((value as Map).cast<String, dynamic>())),
      ...
      nicsToInclude: pulumi.Input.decodeList<VMwareToAzStackHCINicInput>(map['nicsToInclude'], (value) => VMwareToAzStackHCINicInput.fromMap((value as Map).cast<String, dynamic>())),
