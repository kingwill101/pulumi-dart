...
class VMwareToAzStackHCIProtectedItemModelCustomProperties {
  ...
  factory VMwareToAzStackHCIProtectedItemModelCustomProperties.fromMap(Map<String, dynamic> map) {
    return VMwareToAzStackHCIProtectedItemModelCustomProperties(
      ...
      disksToInclude: pulumi.Input.fromValue(pulumi.Input.decodeList<VMwareToAzStackHCIDiskInput>(map['disksToInclude']!, (value) => VMwareToAzStackHCIDiskInput.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      nicsToInclude: pulumi.Input.fromValue(pulumi.Input.decodeList<VMwareToAzStackHCINicInput>(map['nicsToInclude']!, (value) => VMwareToAzStackHCINicInput.fromMap((value as Map).cast<String, dynamic>()))),
