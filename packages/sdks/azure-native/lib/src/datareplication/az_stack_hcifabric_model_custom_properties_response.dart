...
class AzStackHCIFabricModelCustomPropertiesResponse {
  ...
  factory AzStackHCIFabricModelCustomPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AzStackHCIFabricModelCustomPropertiesResponse(
      applianceName: pulumi.Input.fromValue((map['applianceName'] as List).cast<String>()),
      azStackHciSiteId: pulumi.Input.fromValue(map['azStackHciSiteId'] as String),
      cluster: pulumi.Input.fromValue(AzStackHCIClusterPropertiesResponse.fromMap((map['cluster']! as Map).cast<String, dynamic>())),
