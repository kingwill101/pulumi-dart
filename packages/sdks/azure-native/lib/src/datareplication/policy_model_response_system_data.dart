...
class PolicyModelResponseSystemData {
  ...
  /// Creates a new [PolicyModelResponseSystemData].
  ...
  const PolicyModelResponseSystemData({
    this.createdAt,
    this.createdBy,
    this.createdByType,
    this.lastModifiedAt,
  ...
  factory PolicyModelResponseSystemData.fromMap(Map<String, dynamic> map) {
    return PolicyModelResponseSystemData(
