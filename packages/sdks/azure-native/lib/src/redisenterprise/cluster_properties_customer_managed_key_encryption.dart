...
class ClusterPropertiesCustomerManagedKeyEncryption {
  ...
  final pulumi.Input<ClusterPropertiesKeyEncryptionKeyIdentity>?
  ...
  factory ClusterPropertiesCustomerManagedKeyEncryption.fromMap(
    ...
    return ClusterPropertiesCustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterPropertiesKeyEncryptionKeyIdentity.fromMap(
