...
class DatabaseArgs {
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      accessKeysAuthentication: (() { final guardedValue = map['accessKeysAuthentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      deferUpgrade: (() { final guardedValue = map['deferUpgrade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
