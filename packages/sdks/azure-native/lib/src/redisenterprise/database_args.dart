    ...
    return <String, dynamic>{
      ...
      'geoReplication':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(geoReplication, (value) => value.toMap()),
      'modules':
          ?pulumi.Input.mapOptionalInputValue<
            List<Module>,
          ...
          >(
            modules,
            (value) => pulumi.Input.encodeList<Module, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      accessKeysAuthentication: (() {
        final guardedValue = map['accessKeysAuthentication'];
      ...
      deferUpgrade: (() {
        final guardedValue = map['deferUpgrade'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      evictionPolicy: (() {
      ...
      geoReplication: (() {
        final guardedValue = map['geoReplication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatabasePropertiesGeoReplication.fromMap(
      ...
      modules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Module>(
            guardedValue,
            (value) => Module.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      persistence: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Persistence.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      port: (() {
