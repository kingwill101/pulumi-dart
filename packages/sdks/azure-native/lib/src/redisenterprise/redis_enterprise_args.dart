...
class RedisEnterpriseArgs {
  ...
  final pulumi.Input<dynamic>? highAvailability;
  ...
  factory RedisEnterpriseArgs.fromMap(Map<String, dynamic> map) {
    return RedisEnterpriseArgs(
      ...
      highAvailability: (() { final guardedValue = map['highAvailability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      publicNetworkAccess: pulumi.Input.fromValue(map['publicNetworkAccess']),
