...
class ClusterPropertiesEncryption {
  ...
  final pulumi.Input<ClusterPropertiesCustomerManagedKeyEncryption>?
  ...
  ClusterPropertiesEncryption({this.customerManagedKeyEncryption});
    ...
    return ClusterPropertiesEncryption(
      customerManagedKeyEncryption: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterPropertiesCustomerManagedKeyEncryption.fromMap(
