...
class DatabasePropertiesGeoReplication {
  ...
  DatabasePropertiesGeoReplication({this.groupNickname, this.linkedDatabases});
    ...
    return <String, dynamic>{
      ...
      'linkedDatabases':
          ...
          >(
            linkedDatabases,
            (value) =>
                pulumi.Input.encodeList<LinkedDatabase, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DatabasePropertiesGeoReplication(
      ...
      linkedDatabases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LinkedDatabase>(
            guardedValue,
            (value) =>
                LinkedDatabase.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
