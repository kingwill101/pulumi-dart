...
class ClusterPropertiesResponseEncryption {
  ...
  final pulumi.Input<ClusterPropertiesResponseCustomerManagedKeyEncryption>?
  ...
  ClusterPropertiesResponseEncryption({this.customerManagedKeyEncryption});
  ...
  factory ClusterPropertiesResponseEncryption.fromMap(
    ...
    return ClusterPropertiesResponseEncryption(
      customerManagedKeyEncryption: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterPropertiesResponseCustomerManagedKeyEncryption.fromMap(
