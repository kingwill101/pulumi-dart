...
class GetDatabaseResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'geoReplication': ?geoReplication == null ? null : geoReplication!.toMap(),
      'id': id,
      'modules': ?modules == null ? null : pulumi.Input.encodeList<ModuleResponse, Map<String, dynamic>>(modules!, (value) => value.toMap()),
      'name': name,
  ...
  factory GetDatabaseResult.fromMap(Map<String, dynamic> map) {
    return GetDatabaseResult(
      ...
      geoReplication: map['geoReplication'] == null ? null : DatabasePropertiesResponseGeoReplication.fromMap((map['geoReplication'] as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      modules: map['modules'] == null ? null : pulumi.Input.decodeList<ModuleResponse>(map['modules'], (value) => ModuleResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      persistence: map['persistence'] == null ? null : PersistenceResponse.fromMap((map['persistence'] as Map).cast<String, dynamic>()),
