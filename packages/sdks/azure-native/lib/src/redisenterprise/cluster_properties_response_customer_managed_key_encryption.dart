...
class ClusterPropertiesResponseCustomerManagedKeyEncryption {
  ...
  final pulumi.Input<ClusterPropertiesResponseKeyEncryptionKeyIdentity>?
  ...
  factory ClusterPropertiesResponseCustomerManagedKeyEncryption.fromMap(
    ...
    return ClusterPropertiesResponseCustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterPropertiesResponseKeyEncryptionKeyIdentity.fromMap(
