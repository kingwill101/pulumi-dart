    ...
    return GrafanaConfigurationsResponse(
      security: (() {
        ...
        return pulumi.Input.fromValue(
          SecurityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      smtp: (() {
        final guardedValue = map['smtp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SmtpResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      snapshots: (() {
      ...
      users: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UsersResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
