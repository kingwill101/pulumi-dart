...
class Smtp {
  ...
  final pulumi.Input<dynamic>? startTLSPolicy;
  /// User of SMTP auth
  ...
  factory Smtp.fromMap(Map<String, dynamic> map) {
    return Smtp(
      ...
      startTLSPolicy: (() { final guardedValue = map['startTLSPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
