...
class GrafanaIntegrationsResponse {
  final pulumi.Input<List<AzureMonitorWorkspaceIntegrationResponse>>?
  azureMonitorWorkspaceIntegrations;

  /// Creates a new [GrafanaIntegrationsResponse].
  /// [azureMonitorWorkspaceIntegrations] Optional.
  GrafanaIntegrationsResponse({this.azureMonitorWorkspaceIntegrations});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'azureMonitorWorkspaceIntegrations':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureMonitorWorkspaceIntegrationResponse>,
    ...
    return GrafanaIntegrationsResponse(
      azureMonitorWorkspaceIntegrations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureMonitorWorkspaceIntegrationResponse>(
            guardedValue,
            (value) => AzureMonitorWorkspaceIntegrationResponse.fromMap(
