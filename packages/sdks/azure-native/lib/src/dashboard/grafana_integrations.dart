...
class GrafanaIntegrations {
  ...
  factory GrafanaIntegrations.fromMap(Map<String, dynamic> map) {
    return GrafanaIntegrations(
      azureMonitorWorkspaceIntegrations: (() { final guardedValue = map['azureMonitorWorkspaceIntegrations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AzureMonitorWorkspaceIntegration>(guardedValue, (value) => AzureMonitorWorkspaceIntegration.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
