...
class AppServiceCertificateOrderArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': ?kind,
      'location': ?location,
      'productType': pulumi.Input.mapInputValue<CertificateProductType, String>(productType, (value) => value.wireValue),
  ...
  factory AppServiceCertificateOrderArgs.fromMap(Map<String, dynamic> map) {
    return AppServiceCertificateOrderArgs(
      ...
      certificateOrderName: (() { final guardedValue = map['certificateOrderName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
