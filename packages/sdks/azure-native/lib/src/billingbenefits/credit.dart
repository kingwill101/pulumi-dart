...
class Credit extends pulumi.CustomResource {
  ...
  Credit(
    ...
    this.breakdown = registerOutput<List<CreditBreakdownItemResponse>?>('breakdown');
    ...
    this.policies = registerOutput<CreditPoliciesResponse?>('policies');
    this.productCode = registerOutput<String?>('productCode');
    this.provisioningState = registerOutput<String>('provisioningState');
    this.reason = registerOutput<CreditReasonResponse?>('reason');
