...
class GetFreeServiceResult {
  ...
  factory GetFreeServiceResult.fromMap(Map<String, dynamic> map) {
    return GetFreeServiceResult(
      ...
      billingProfileResourceId: (() { final guardedValue = map['billingProfileResourceId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      customerResourceId: (() { final guardedValue = map['customerResourceId']; if (guardedValue == null) return null; return guardedValue as String; })(),
