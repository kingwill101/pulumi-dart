...
class EntityTypePrimaryDiscountResponse {
  ...
  final DiscountCustomPriceResponse? discountTypeProperties;
  ...
  factory EntityTypePrimaryDiscountResponse.fromMap(Map<String, dynamic> map) {
    return EntityTypePrimaryDiscountResponse(
      ...
      discountTypeProperties: map['discountTypeProperties'] == null ? null : DiscountCustomPriceResponse.fromMap((map['discountTypeProperties'] as Map).cast<String, dynamic>()),
