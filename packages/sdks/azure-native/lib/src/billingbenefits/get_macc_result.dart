...
class GetMaccResult {
  ...
  final AutomaticShortfallSuppressReasonResponse?
  ...
  factory GetMaccResult.fromMap(Map<String, dynamic> map) {
    return GetMaccResult(
      ...
      milestones: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<MaccMilestoneResponse>(
          guardedValue,
          (value) => MaccMilestoneResponse.fromMap(
