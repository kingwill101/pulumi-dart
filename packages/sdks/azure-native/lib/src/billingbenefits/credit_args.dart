...
class CreditArgs {
  ...
  factory CreditArgs.fromMap(Map<String, dynamic> map) {
    return CreditArgs(
      ...
      breakdown: (() {
        final guardedValue = map['breakdown'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CreditBreakdownItem>(
            guardedValue,
            (value) => CreditBreakdownItem.fromMap(
      ...
      creditName: (() {
        final guardedValue = map['creditName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      endAt: (() {
      ...
      policies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CreditPolicies.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      productCode: (() {
