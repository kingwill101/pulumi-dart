...
class ContributorConditionalCreditMilestoneResponse {
  ...
  const ContributorConditionalCreditMilestoneResponse({
    this.award,
    this.endAt,
    this.milestoneId,
    this.name,
  ...
  factory ContributorConditionalCreditMilestoneResponse.fromMap(Map<String, dynamic> map) {
    return ContributorConditionalCreditMilestoneResponse(
