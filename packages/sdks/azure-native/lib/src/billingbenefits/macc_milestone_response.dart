...
class MaccMilestoneResponse {
  ...
  final pulumi.Input<AutomaticShortfallSuppressReasonResponse>?
    ...
    return MaccMilestoneResponse(
      ...
      automaticShortfallSuppressReason: (() {
        ...
        return pulumi.Input.fromValue(
          AutomaticShortfallSuppressReasonResponse.fromMap(
      ...
      commitment: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriceResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      endAt: (() {
