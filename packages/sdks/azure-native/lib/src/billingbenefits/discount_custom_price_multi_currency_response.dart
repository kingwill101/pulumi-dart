...
class DiscountCustomPriceMultiCurrencyResponse {
  ...
  final pulumi.Input<PriceGuaranteePropertiesResponse>?
    ...
    return <String, dynamic>{
      ...
      'customPriceProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customPriceProperties, (value) => value.toMap()),
  ...
  factory DiscountCustomPriceMultiCurrencyResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return DiscountCustomPriceMultiCurrencyResponse(
      applyDiscountOn: pulumi.Input.fromValue(map['applyDiscountOn'] as String),
      conditions: (() {
        final guardedValue = map['conditions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConditionsItemResponse>(
            guardedValue,
            (value) => ConditionsItemResponse.fromMap(
      ...
      customPriceProperties: (() {
        final guardedValue = map['customPriceProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomPricePropertiesResponse.fromMap(
      ...
      priceGuaranteeProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PriceGuaranteePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
