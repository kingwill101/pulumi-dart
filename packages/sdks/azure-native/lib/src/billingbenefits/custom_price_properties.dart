...
class CustomPriceProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'catalogClaims': pulumi.Input.mapInputValue<List<CatalogClaimsItem>, List<Map<String, dynamic>>>(catalogClaims, (value) => pulumi.Input.encodeList<CatalogClaimsItem, Map<String, dynamic>>(value, (value) => value.toMap())),
      'catalogId': catalogId,
      'marketSetPrices': pulumi.Input.mapInputValue<List<MarketSetPricesItems>, List<Map<String, dynamic>>>(marketSetPrices, (value) => pulumi.Input.encodeList<MarketSetPricesItems, Map<String, dynamic>>(value, (value) => value.toMap())),
      'meterType': ?meterType,
      'ruleType': ruleType,
      'termUnits': ?termUnits,
    };
  ...
  factory CustomPriceProperties.fromMap(Map<String, dynamic> map) {
    return CustomPriceProperties(
      ...
      catalogClaims: pulumi.Input.fromValue(pulumi.Input.decodeList<CatalogClaimsItem>(map['catalogClaims']!, (value) => CatalogClaimsItem.fromMap((value as Map).cast<String, dynamic>()))),
      catalogId: pulumi.Input.fromValue(map['catalogId'] as String),
      marketSetPrices: pulumi.Input.fromValue(pulumi.Input.decodeList<MarketSetPricesItems>(map['marketSetPrices']!, (value) => MarketSetPricesItems.fromMap((value as Map).cast<String, dynamic>()))),
