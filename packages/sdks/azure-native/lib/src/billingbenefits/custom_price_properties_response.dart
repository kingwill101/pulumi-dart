    ...
    return <String, dynamic>{
      ...
      'catalogClaims':
          pulumi.Input.mapInputValue<
            List<CatalogClaimsItemResponse>,
      ...
      'marketSetPrices':
          pulumi.Input.mapInputValue<
            List<MarketSetPricesItemsResponse>,
            List<Map<String, dynamic>>
          >(
            marketSetPrices,
            (value) =>
  ...
  factory CustomPricePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CustomPricePropertiesResponse(
      ...
      catalogClaims: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CatalogClaimsItemResponse>(
          map['catalogClaims']!,
          (value) => CatalogClaimsItemResponse.fromMap(
      ...
      marketSetPrices: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MarketSetPricesItemsResponse>(
          map['marketSetPrices']!,
          (value) => MarketSetPricesItemsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
