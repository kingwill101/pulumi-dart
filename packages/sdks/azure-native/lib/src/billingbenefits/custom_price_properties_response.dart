...
class CustomPricePropertiesResponse {
  ...
  factory CustomPricePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CustomPricePropertiesResponse(
      ...
      catalogClaims: pulumi.Input.fromValue(pulumi.Input.decodeList<CatalogClaimsItemResponse>(map['catalogClaims']!, (value) => CatalogClaimsItemResponse.fromMap((value as Map).cast<String, dynamic>()))),
      catalogId: pulumi.Input.fromValue(map['catalogId'] as String),
      marketSetPrices: pulumi.Input.fromValue(pulumi.Input.decodeList<MarketSetPricesItemsResponse>(map['marketSetPrices']!, (value) => MarketSetPricesItemsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      meterType: (() { final guardedValue = map['meterType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ruleType: pulumi.Input.fromValue(map['ruleType'] as String),
      termUnits: (() { final guardedValue = map['termUnits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
