...
class ConditionalCreditArgs {
  ...
  ConditionalCreditArgs({
    ...
    pulumi.Output<String>? conditionalCreditName,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      conditionalCreditName = pulumi.Input.asOptionalInput<String>(conditionalCreditName),
  ...
  factory ConditionalCreditArgs.fromMap(Map<String, dynamic> map) {
    return ConditionalCreditArgs(
      ...
      conditionalCreditName: map['conditionalCreditName'] == null ? null : pulumi.Output.create<String>(map['conditionalCreditName'] as String),
