...
class GetConditionalCreditResult {
  ...
  final ContributorConditionalCreditPropertiesResponse properties;
  ...
  const GetConditionalCreditResult({
  ...
  factory GetConditionalCreditResult.fromMap(Map<String, dynamic> map) {
    return GetConditionalCreditResult(
      ...
      properties: ContributorConditionalCreditPropertiesResponse.fromMap((map['properties']! as Map).cast<String, dynamic>()),
