...
import 'contributor_conditional_credit_milestone_response.dart';

/// Properties for contributor conditional credit.
class ContributorConditionalCreditPropertiesResponse {
  ...
  const ContributorConditionalCreditPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'milestones': pulumi.Input.mapInputValue<List<ContributorConditionalCreditMilestoneResponse>, List<Map<String, dynamic>>>(milestones, (value) => pulumi.Input.encodeList<ContributorConditionalCreditMilestoneResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ContributorConditionalCreditPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ContributorConditionalCreditPropertiesResponse(
      ...
      milestones: pulumi.Input.fromValue(pulumi.Input.decodeList<ContributorConditionalCreditMilestoneResponse>(map['milestones']!, (value) => ContributorConditionalCreditMilestoneResponse.fromMap((value as Map).cast<String, dynamic>()))),
