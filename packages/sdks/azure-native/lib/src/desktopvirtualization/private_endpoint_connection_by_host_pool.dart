...
/// }
///
/// resource "azure-native_desktopvirtualization_privateendpointconnectionbyhostpool" "privateEndpointConnectionByHostPool" {
...
class PrivateEndpointConnectionByHostPool extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionByHostPool] resource.
  PrivateEndpointConnectionByHostPool.reference(String urn)
    : super(
        'azure-native:desktopvirtualization:PrivateEndpointConnectionByHostPool',
