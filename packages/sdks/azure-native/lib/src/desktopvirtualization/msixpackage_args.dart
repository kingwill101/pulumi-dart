...
class MSIXPackageArgs {
  ...
  factory MSIXPackageArgs.fromMap(Map<String, dynamic> map) {
    return MSIXPackageArgs(
      ...
      msixPackageFullName: (() {
        final guardedValue = map['msixPackageFullName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      packageApplications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MsixPackageApplications>(
            guardedValue,
            (value) => MsixPackageApplications.fromMap(
      ...
      packageDependencies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MsixPackageDependencies>(
            guardedValue,
            (value) => MsixPackageDependencies.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
