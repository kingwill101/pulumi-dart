...
/// Result data returned by getPrivateEndpointConnectionByHostPool.
class GetPrivateEndpointConnectionByHostPoolResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionByHostPoolResult].
  ...
  const GetPrivateEndpointConnectionByHostPoolResult({
  ...
  factory GetPrivateEndpointConnectionByHostPoolResult.fromMap(Map<String, dynamic> map) {
