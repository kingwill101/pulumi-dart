...
/// }
///
/// resource "azure-native_desktopvirtualization_privateendpointconnectionbyworkspace" "privateEndpointConnectionByWorkspace" {
...
class PrivateEndpointConnectionByWorkspace extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionByWorkspace] resource.
  PrivateEndpointConnectionByWorkspace.reference(String urn)
    : super(
        'azure-native:desktopvirtualization:PrivateEndpointConnectionByWorkspace',
