...
class ResourceModelWithAllowedPropertySetSku {
  ...
  /// Creates a new [ResourceModelWithAllowedPropertySetSku].
  ...
  factory ResourceModelWithAllowedPropertySetSku.fromMap(Map<String, dynamic> map) {
