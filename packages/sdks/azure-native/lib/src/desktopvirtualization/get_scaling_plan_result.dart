...
class GetScalingPlanResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostPoolReferences': ?(() {
        final guardedValue = hostPoolReferences;
  ...
  factory GetScalingPlanResult.fromMap(Map<String, dynamic> map) {
    return GetScalingPlanResult(
      ...
      hostPoolReferences: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ScalingHostPoolReferenceResponse>(
          guardedValue,
          (value) => ScalingHostPoolReferenceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hostPoolType: (() {
        final guardedValue = map['hostPoolType'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      id: map['id'] as String,
      ...
      schedules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ScalingScheduleResponse>(
          guardedValue,
          (value) => ScalingScheduleResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
