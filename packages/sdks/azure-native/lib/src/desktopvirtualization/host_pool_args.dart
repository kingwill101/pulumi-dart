...
class HostPoolArgs {
    ...
    return <String, dynamic>{
      ...
      'registrationInfo':
          ?pulumi.Input.mapOptionalInputValue<
            RegistrationInfo,
            Map<String, dynamic>
          >(registrationInfo, (value) => value.toMap()),
  ...
  factory HostPoolArgs.fromMap(Map<String, dynamic> map) {
    return HostPoolArgs(
      agentUpdate: (() {
        final guardedValue = map['agentUpdate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentUpdateProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      customRdpProperty: (() {
        final guardedValue = map['customRdpProperty'];
        if (guardedValue == null) return null;
      ...
      hostPoolName: (() {
        final guardedValue = map['hostPoolName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      maxSessionLimit: (() {
        final guardedValue = map['maxSessionLimit'];
        if (guardedValue == null) return null;
      ...
      preferredAppGroupType: pulumi.Input.fromValue(
        map['preferredAppGroupType'] as String,
      ),
      publicNetworkAccess: (() {
      ...
      registrationInfo: (() {
        final guardedValue = map['registrationInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegistrationInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      ssoClientId: (() {
        final guardedValue = map['ssoClientId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ssoClientSecretKeyVaultPath: (() {
        final guardedValue = map['ssoClientSecretKeyVaultPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ssoSecretType: (() {
        final guardedValue = map['ssoSecretType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ssoadfsAuthority: (() {
        final guardedValue = map['ssoadfsAuthority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      startVMOnConnect: (() {
      ...
      validationEnvironment: (() {
        final guardedValue = map['validationEnvironment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      vmTemplate: (() {
