...
class ScalingPlanPooledScheduleArgs {
  ...
  ScalingPlanPooledScheduleArgs({
    ...
    pulumi.Output<String>? offPeakLoadBalancingAlgorithm,
    pulumi.Output<Time>? offPeakStartTime,
    pulumi.Output<String>? peakLoadBalancingAlgorithm,
    pulumi.Output<Time>? peakStartTime,
    pulumi.Output<int>? rampDownCapacityThresholdPct,
    pulumi.Output<bool>? rampDownForceLogoffUsers,
    pulumi.Output<String>? rampDownLoadBalancingAlgorithm,
    pulumi.Output<int>? rampDownMinimumHostsPct,
    pulumi.Output<String>? rampDownNotificationMessage,
    pulumi.Output<Time>? rampDownStartTime,
    pulumi.Output<String>? rampDownStopHostsWhen,
    pulumi.Output<int>? rampDownWaitTimeMinutes,
    pulumi.Output<int>? rampUpCapacityThresholdPct,
    pulumi.Output<String>? rampUpLoadBalancingAlgorithm,
    pulumi.Output<int>? rampUpMinimumHostsPct,
  ...
  factory ScalingPlanPooledScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScalingPlanPooledScheduleArgs(
      ...
      offPeakLoadBalancingAlgorithm: map['offPeakLoadBalancingAlgorithm'] == null ? null : pulumi.Output.create<String>(map['offPeakLoadBalancingAlgorithm'] as String),
      ...
      peakLoadBalancingAlgorithm: map['peakLoadBalancingAlgorithm'] == null ? null : pulumi.Output.create<String>(map['peakLoadBalancingAlgorithm'] as String),
      ...
      rampDownCapacityThresholdPct: map['rampDownCapacityThresholdPct'] == null ? null : pulumi.Output.create<int>(map['rampDownCapacityThresholdPct'] as int),
      rampDownForceLogoffUsers: map['rampDownForceLogoffUsers'] == null ? null : pulumi.Output.create<bool>(map['rampDownForceLogoffUsers'] as bool),
      rampDownLoadBalancingAlgorithm: map['rampDownLoadBalancingAlgorithm'] == null ? null : pulumi.Output.create<String>(map['rampDownLoadBalancingAlgorithm'] as String),
      rampDownMinimumHostsPct: map['rampDownMinimumHostsPct'] == null ? null : pulumi.Output.create<int>(map['rampDownMinimumHostsPct'] as int),
      rampDownNotificationMessage: map['rampDownNotificationMessage'] == null ? null : pulumi.Output.create<String>(map['rampDownNotificationMessage'] as String),
      ...
      rampDownStopHostsWhen: map['rampDownStopHostsWhen'] == null ? null : pulumi.Output.create<String>(map['rampDownStopHostsWhen'] as String),
      rampDownWaitTimeMinutes: map['rampDownWaitTimeMinutes'] == null ? null : pulumi.Output.create<int>(map['rampDownWaitTimeMinutes'] as int),
      rampUpCapacityThresholdPct: map['rampUpCapacityThresholdPct'] == null ? null : pulumi.Output.create<int>(map['rampUpCapacityThresholdPct'] as int),
      rampUpLoadBalancingAlgorithm: map['rampUpLoadBalancingAlgorithm'] == null ? null : pulumi.Output.create<String>(map['rampUpLoadBalancingAlgorithm'] as String),
      rampUpMinimumHostsPct: map['rampUpMinimumHostsPct'] == null ? null : pulumi.Output.create<int>(map['rampUpMinimumHostsPct'] as int),
