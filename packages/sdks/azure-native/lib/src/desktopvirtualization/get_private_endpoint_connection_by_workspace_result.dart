...
/// Result data returned by getPrivateEndpointConnectionByWorkspace.
class GetPrivateEndpointConnectionByWorkspaceResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionByWorkspaceResult].
  ...
  const GetPrivateEndpointConnectionByWorkspaceResult({
  ...
  factory GetPrivateEndpointConnectionByWorkspaceResult.fromMap(Map<String, dynamic> map) {
