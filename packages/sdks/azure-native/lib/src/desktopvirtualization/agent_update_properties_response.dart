...
class AgentUpdatePropertiesResponse {
  ...
  const AgentUpdatePropertiesResponse({
  ...
  factory AgentUpdatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AgentUpdatePropertiesResponse(
      ...
      maintenanceWindows: (() { final guardedValue = map['maintenanceWindows']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MaintenanceWindowPropertiesResponse>(guardedValue, (value) => MaintenanceWindowPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
