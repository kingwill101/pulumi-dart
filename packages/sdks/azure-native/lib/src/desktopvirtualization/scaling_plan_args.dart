    ...
    return <String, dynamic>{
      ...
      'schedules':
          ...
          >(
            schedules,
            (value) =>
                pulumi.Input.encodeList<ScalingSchedule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ScalingPlanArgs(
      ...
      hostPoolReferences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScalingHostPoolReference>(
            guardedValue,
            (value) => ScalingHostPoolReference.fromMap(
      ...
      scalingPlanName: (() {
        final guardedValue = map['scalingPlanName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      schedules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScalingSchedule>(
            guardedValue,
            (value) =>
                ScalingSchedule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      sku: (() {
