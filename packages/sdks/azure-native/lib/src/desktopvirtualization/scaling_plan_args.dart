...
class ScalingPlanArgs {
  ...
  factory ScalingPlanArgs.fromMap(Map<String, dynamic> map) {
    return ScalingPlanArgs(
      ...
      scalingPlanName: (() { final guardedValue = map['scalingPlanName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      schedules: (() { final guardedValue = map['schedules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScalingSchedule>(guardedValue, (value) => ScalingSchedule.fromMap((value as Map).cast<String, dynamic>()))); })(),
