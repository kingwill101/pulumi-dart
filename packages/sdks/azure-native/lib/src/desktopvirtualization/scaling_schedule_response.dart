...
class ScalingScheduleResponse {
  ...
  factory ScalingScheduleResponse.fromMap(Map<String, dynamic> map) {
    return ScalingScheduleResponse(
      ...
      offPeakStartTime: (() { final guardedValue = map['offPeakStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      peakStartTime: (() { final guardedValue = map['peakStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rampDownStartTime: (() { final guardedValue = map['rampDownStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rampUpStartTime: (() { final guardedValue = map['rampUpStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
