...
class AppAttachPackageInfoProperties {
  ...
  final pulumi.Input<dynamic>? isPackageTimestamped;
  ...
  factory AppAttachPackageInfoProperties.fromMap(Map<String, dynamic> map) {
    return AppAttachPackageInfoProperties(
      ...
      isPackageTimestamped: (() { final guardedValue = map['isPackageTimestamped']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
