...
class GetHostPoolResult {
  ...
  const GetHostPoolResult({
    this.agentUpdate,
    this.appAttachPackageReferences,
  ...
  factory GetHostPoolResult.fromMap(Map<String, dynamic> map) {
    return GetHostPoolResult(
      ...
      appAttachPackageReferences: (() { final guardedValue = map['appAttachPackageReferences']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      ...
      maxSessionLimit: (() { final guardedValue = map['maxSessionLimit']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      ring: (() { final guardedValue = map['ring']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
