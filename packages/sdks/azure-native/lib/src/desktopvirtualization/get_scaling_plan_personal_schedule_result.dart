...
class GetScalingPlanPersonalScheduleResult {
  ...
  factory GetScalingPlanPersonalScheduleResult.fromMap(Map<String, dynamic> map) {
    return GetScalingPlanPersonalScheduleResult(
      ...
      offPeakMinutesToWaitOnDisconnect: (() { final guardedValue = map['offPeakMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return guardedValue as int; })(),
      offPeakMinutesToWaitOnLogoff: (() { final guardedValue = map['offPeakMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return guardedValue as int; })(),
      ...
      peakMinutesToWaitOnDisconnect: (() { final guardedValue = map['peakMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return guardedValue as int; })(),
      peakMinutesToWaitOnLogoff: (() { final guardedValue = map['peakMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return guardedValue as int; })(),
      ...
      rampDownMinutesToWaitOnDisconnect: (() { final guardedValue = map['rampDownMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return guardedValue as int; })(),
      rampDownMinutesToWaitOnLogoff: (() { final guardedValue = map['rampDownMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return guardedValue as int; })(),
      ...
      rampUpMinutesToWaitOnDisconnect: (() { final guardedValue = map['rampUpMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return guardedValue as int; })(),
      rampUpMinutesToWaitOnLogoff: (() { final guardedValue = map['rampUpMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return guardedValue as int; })(),
