...
class ScalingPlanPersonalScheduleArgs {
  ...
  factory ScalingPlanPersonalScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScalingPlanPersonalScheduleArgs(
      ...
      offPeakActionOnDisconnect: (() { final guardedValue = map['offPeakActionOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      offPeakActionOnLogoff: (() { final guardedValue = map['offPeakActionOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      offPeakMinutesToWaitOnDisconnect: (() { final guardedValue = map['offPeakMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      offPeakMinutesToWaitOnLogoff: (() { final guardedValue = map['offPeakMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      offPeakStartVMOnConnect: (() { final guardedValue = map['offPeakStartVMOnConnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      peakActionOnDisconnect: (() { final guardedValue = map['peakActionOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      peakActionOnLogoff: (() { final guardedValue = map['peakActionOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      peakMinutesToWaitOnDisconnect: (() { final guardedValue = map['peakMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      peakMinutesToWaitOnLogoff: (() { final guardedValue = map['peakMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      peakStartVMOnConnect: (() { final guardedValue = map['peakStartVMOnConnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rampDownActionOnDisconnect: (() { final guardedValue = map['rampDownActionOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rampDownActionOnLogoff: (() { final guardedValue = map['rampDownActionOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rampDownMinutesToWaitOnDisconnect: (() { final guardedValue = map['rampDownMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      rampDownMinutesToWaitOnLogoff: (() { final guardedValue = map['rampDownMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      rampDownStartVMOnConnect: (() { final guardedValue = map['rampDownStartVMOnConnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rampUpActionOnDisconnect: (() { final guardedValue = map['rampUpActionOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rampUpActionOnLogoff: (() { final guardedValue = map['rampUpActionOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rampUpAutoStartHosts: (() { final guardedValue = map['rampUpAutoStartHosts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rampUpMinutesToWaitOnDisconnect: (() { final guardedValue = map['rampUpMinutesToWaitOnDisconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      rampUpMinutesToWaitOnLogoff: (() { final guardedValue = map['rampUpMinutesToWaitOnLogoff']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      rampUpStartVMOnConnect: (() { final guardedValue = map['rampUpStartVMOnConnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
