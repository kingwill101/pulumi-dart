...
class ListHostPoolRegistrationTokensResult {
  ...
  ListHostPoolRegistrationTokensResult({required this.nextLink, this.value});
  ...
  factory ListHostPoolRegistrationTokensResult.fromMap(
    ...
    return ListHostPoolRegistrationTokensResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<RegistrationTokenMinimalResponse>(
          guardedValue,
          (value) => RegistrationTokenMinimalResponse.fromMap(
