...
class ListAzureDataTransferApprovedSchemasArgs {
  ...
  ListAzureDataTransferApprovedSchemasArgs({this.direction, this.pipeline});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'direction': ?direction, 'pipeline': ?pipeline};
  }

  factory ListAzureDataTransferApprovedSchemasArgs.fromMap(
