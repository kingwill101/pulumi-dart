...
class FlowPropertieslistListFlowsByPipelineResponse {
  ...
  /// [passphrase] The passphrase used for SRT streams (non-secret)
  ...
  const FlowPropertieslistListFlowsByPipelineResponse({
    this.apiFlowOptions,
    this.connection,
    this.consumerGroup,
  ...
  factory FlowPropertieslistListFlowsByPipelineResponse.fromMap(Map<String, dynamic> map) {
    return FlowPropertieslistListFlowsByPipelineResponse(
