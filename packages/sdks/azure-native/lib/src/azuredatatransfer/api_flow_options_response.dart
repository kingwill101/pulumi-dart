...
class ApiFlowOptionsResponse {
  ...
  factory ApiFlowOptionsResponse.fromMap(Map<String, dynamic> map) {
    return ApiFlowOptionsResponse(
      apiMode: (() {
        final guardedValue = map['apiMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      audienceOverride: (() {
        final guardedValue = map['audienceOverride'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cname: (() {
      ...
      identityTranslation: (() {
        final guardedValue = map['identityTranslation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      remoteCallingModeClientId: (() {
        final guardedValue = map['remoteCallingModeClientId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      remoteEndpoint: (() {
        final guardedValue = map['remoteEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      senderClientId: (() {
        final guardedValue = map['senderClientId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
