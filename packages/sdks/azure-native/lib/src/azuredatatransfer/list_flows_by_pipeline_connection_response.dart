...
class ListFlowsByPipelineConnectionResponse {
  ...
  ListFlowsByPipelineConnectionResponse({this.flows, this.id});
    ...
    return <String, dynamic>{
      'flows':
          ...
          >(
            flows,
            (value) =>
                pulumi.Input.encodeList<FlowResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ListFlowsByPipelineConnectionResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ListFlowsByPipelineConnectionResponse(
      flows: (() {
        final guardedValue = map['flows'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FlowResponse>(
            guardedValue,
            (value) =>
                FlowResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      id: (() {
