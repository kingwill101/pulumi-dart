...
class MimeFilterRuleset {
  ...
  MimeFilterRuleset({this.filters, this.type});
    ...
    return <String, dynamic>{
      'filters':
          ...
          >(
            filters,
            (value) =>
                pulumi.Input.encodeList<MimeTypeFilter, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return MimeFilterRuleset(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MimeTypeFilter>(
            guardedValue,
            (value) =>
                MimeTypeFilter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      type: (() {
