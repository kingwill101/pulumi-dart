...
class TextMatch {
  ...
  TextMatch({
    pulumi.Input<dynamic>? caseSensitivity,
    pulumi.Input<dynamic>? matchType,
    required this.text,
  ...
  factory TextMatch.fromMap(Map<String, dynamic> map) {
    return TextMatch(
      caseSensitivity: pulumi.Input.fromValue(map['caseSensitivity']),
      matchType: pulumi.Input.fromValue(map['matchType']),
