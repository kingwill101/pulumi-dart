...
class GetPipelineResult {
  ...
  final PipelinePropertiesResponse? properties;
  ...
  factory GetPipelineResult.fromMap(Map<String, dynamic> map) {
    return GetPipelineResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return PipelinePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
