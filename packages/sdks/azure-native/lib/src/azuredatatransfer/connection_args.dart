...
class ConnectionArgs {
  ...
  ConnectionArgs({
    ...
    pulumi.Output<ConnectionProperties>? properties,
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ConnectionProperties>(ConnectionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
