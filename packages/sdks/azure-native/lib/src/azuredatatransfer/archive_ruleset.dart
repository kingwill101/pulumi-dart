...
class ArchiveRuleset {
  ...
  final double? maximumCompressionRatioLimit;
  ...
  final double? maximumDepthLimit;
  ...
  final double? maximumExpansionSizeLimit;
  ...
  final double? minimumSizeForExpansion;
  ...
  factory ArchiveRuleset.fromMap(Map<String, dynamic> map) {
    return ArchiveRuleset(
      maximumCompressionRatioLimit: map['maximumCompressionRatioLimit'] == null ? null : map['maximumCompressionRatioLimit'] as double,
      maximumDepthLimit: map['maximumDepthLimit'] == null ? null : map['maximumDepthLimit'] as double,
      maximumExpansionSizeLimit: map['maximumExpansionSizeLimit'] == null ? null : map['maximumExpansionSizeLimit'] as double,
      minimumSizeForExpansion: map['minimumSizeForExpansion'] == null ? null : map['minimumSizeForExpansion'] as double,
    );
  }
}
