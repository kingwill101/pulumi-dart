...
class MimeFilterRulesetResponse {
  ...
  MimeFilterRulesetResponse({this.filters, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<MimeTypeFilterResponse>,
    ...
    return MimeFilterRulesetResponse(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MimeTypeFilterResponse>(
            guardedValue,
            (value) => MimeTypeFilterResponse.fromMap(
