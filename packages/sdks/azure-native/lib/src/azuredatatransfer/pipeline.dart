...
/// }
///
/// resource "azure-native_azuredatatransfer_pipeline" "pipeline" {
///   location      = "East US"
...
class Pipeline extends pulumi.CustomResource {
  ...
  Pipeline(
    ...
    properties = registerOutput<PipelinePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PipelinePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
