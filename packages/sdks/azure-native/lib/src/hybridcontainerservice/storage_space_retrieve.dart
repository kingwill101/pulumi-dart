...
class StorageSpaceRetrieve extends pulumi.CustomResource {
  ...
  late final pulumi.Output<StorageSpacesResponseExtendedLocation?> extendedLocation;
  ...
  StorageSpaceRetrieve(
    ...
    extendedLocation = registerOutput<StorageSpacesResponseExtendedLocation?>('extendedLocation', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return StorageSpacesResponseExtendedLocation.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    properties = registerOutput<StorageSpacesPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return StorageSpacesPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
