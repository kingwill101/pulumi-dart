  ...
  StorageSpaceRetrieve(
    ...
    extendedLocation = registerOutput<StorageSpacesResponseExtendedLocation?>(
      ...
      decoder: (raw) {
        ...
        return StorageSpacesResponseExtendedLocation.fromMap(
    ...
    properties = registerOutput<StorageSpacesPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return StorageSpacesPropertiesResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
