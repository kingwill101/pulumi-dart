...
class ProvisionedClustersResponsePropertiesResponse {
  ...
  factory ProvisionedClustersResponsePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ProvisionedClustersResponsePropertiesResponse(
      aadProfile: (() { final guardedValue = map['aadProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AADProfileResponseResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      addonProfiles: (() { final guardedValue = map['addonProfiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<AddonProfilesResponse>(guardedValue, (value) => AddonProfilesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      agentPoolProfiles: (() { final guardedValue = map['agentPoolProfiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedAgentPoolProfileResponse>(guardedValue, (value) => NamedAgentPoolProfileResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      controlPlane: (() { final guardedValue = map['controlPlane']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlPlaneProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      features: (() { final guardedValue = map['features']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProvisionedClustersCommonPropertiesResponseFeatures.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpProxyConfig: (() { final guardedValue = map['httpProxyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpProxyConfigResponseResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      status: pulumi.Input.fromValue(ProvisionedClustersCommonPropertiesResponseStatus.fromMap((map['status']! as Map).cast<String, dynamic>())),
      windowsProfile: (() { final guardedValue = map['windowsProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsProfileResponseResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
