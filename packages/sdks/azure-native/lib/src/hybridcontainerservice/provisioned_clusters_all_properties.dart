...
class ProvisionedClustersAllProperties {
  ...
  factory ProvisionedClustersAllProperties.fromMap(Map<String, dynamic> map) {
    return ProvisionedClustersAllProperties(
      ...
      addonProfiles: (() { final guardedValue = map['addonProfiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<AddonProfiles>(guardedValue, (value) => AddonProfiles.fromMap((value as Map).cast<String, dynamic>()))); })(),
      agentPoolProfiles: (() { final guardedValue = map['agentPoolProfiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamedAgentPoolProfile>(guardedValue, (value) => NamedAgentPoolProfile.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      controlPlane: (() { final guardedValue = map['controlPlane']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlPlaneProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      features: (() { final guardedValue = map['features']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProvisionedClustersCommonPropertiesFeatures.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpProxyConfig: (() { final guardedValue = map['httpProxyConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpProxyConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      windowsProfile: (() { final guardedValue = map['windowsProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
