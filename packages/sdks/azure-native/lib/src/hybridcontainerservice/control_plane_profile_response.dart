...
class ControlPlaneProfileResponse {
  ...
  final ControlPlaneEndpointProfileResponseControlPlaneEndpoint? controlPlaneEndpoint;
  ...
  factory ControlPlaneProfileResponse.fromMap(Map<String, dynamic> map) {
    return ControlPlaneProfileResponse(
      ...
      controlPlaneEndpoint: map['controlPlaneEndpoint'] == null ? null : ControlPlaneEndpointProfileResponseControlPlaneEndpoint.fromMap((map['controlPlaneEndpoint'] as Map).cast<String, dynamic>()),
