...
class ControlPlaneProfileResponse {
  ...
  final pulumi.Input<ControlPlaneEndpointProfileResponseControlPlaneEndpoint>?
    ...
    return <String, dynamic>{
      ...
      'controlPlaneEndpoint':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(controlPlaneEndpoint, (value) => value.toMap()),
      'count': ?count,
      'linuxProfile':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ControlPlaneProfileResponse.fromMap(Map<String, dynamic> map) {
    return ControlPlaneProfileResponse(
      ...
      controlPlaneEndpoint: (() {
        final guardedValue = map['controlPlaneEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ControlPlaneEndpointProfileResponseControlPlaneEndpoint.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
