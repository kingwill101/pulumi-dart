...
import 'control_plane_endpoint_profile_response_control_plane_endpoint.dart';
...
class ControlPlaneProfileResponse {
  ...
  final pulumi.Input<ControlPlaneEndpointProfileResponseControlPlaneEndpoint>? controlPlaneEndpoint;
  ...
  /// Creates a new [ControlPlaneProfileResponse].
  ...
  const ControlPlaneProfileResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'controlPlaneEndpoint': ?pulumi.Input.mapOptionalInputValue<ControlPlaneEndpointProfileResponseControlPlaneEndpoint, Map<String, dynamic>>(controlPlaneEndpoint, (value) => value.toMap()),
      'count': ?count,
  ...
  factory ControlPlaneProfileResponse.fromMap(Map<String, dynamic> map) {
    return ControlPlaneProfileResponse(
      ...
      cloudProviderProfile: (() { final guardedValue = map['cloudProviderProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudProviderProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      controlPlaneEndpoint: (() { final guardedValue = map['controlPlaneEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlPlaneEndpointProfileResponseControlPlaneEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      count: (() { final guardedValue = map['count']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      linuxProfile: (() { final guardedValue = map['linuxProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxProfilePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
