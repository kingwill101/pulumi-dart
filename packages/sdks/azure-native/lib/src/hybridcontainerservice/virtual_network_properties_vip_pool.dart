...
class VirtualNetworkPropertiesVipPool {
  ...
  factory VirtualNetworkPropertiesVipPool.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkPropertiesVipPool(
