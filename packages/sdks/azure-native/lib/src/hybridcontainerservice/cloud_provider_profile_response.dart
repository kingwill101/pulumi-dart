...
class CloudProviderProfileResponse {
  ...
  final pulumi.Input<CloudProviderProfileResponseInfraNetworkProfile>?
  infraNetworkProfile;

  /// InfraStorageProfile - List of infra storage profiles for the provisioned cluster
  final pulumi.Input<CloudProviderProfileResponseInfraStorageProfile>?
  infraStorageProfile;
    ...
    return CloudProviderProfileResponse(
      infraNetworkProfile: (() {
        ...
        return pulumi.Input.fromValue(
          CloudProviderProfileResponseInfraNetworkProfile.fromMap(
      ...
      infraStorageProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudProviderProfileResponseInfraStorageProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
