...
class VirtualNetworksPropertiesResponse {
  ...
  final pulumi.Input<VirtualNetworksPropertiesResponseInfraVnetProfile>?
  infraVnetProfile;
    ...
    return <String, dynamic>{
      ...
      'infraVnetProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(infraVnetProfile, (value) => value.toMap()),
      ...
      'vipPool':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworksPropertiesResponseVipPool>,
      ...
      'vmipPool':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworksPropertiesResponseVmipPool>,
            List<Map<String, dynamic>>
          >(
            vmipPool,
            (value) =>
  ...
  factory VirtualNetworksPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return VirtualNetworksPropertiesResponse(
      dhcpServers: pulumi.Input.fromValue(
        (map['dhcpServers'] as List).cast<String>(),
      ),
      dnsServers: (() {
      ...
      infraVnetProfile: (() {
        final guardedValue = map['infraVnetProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworksPropertiesResponseInfraVnetProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ipAddressPrefix: (() {
        final guardedValue = map['ipAddressPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      status: pulumi.Input.fromValue(
        VirtualNetworksPropertiesResponseStatus.fromMap(
          (map['status']! as Map).cast<String, dynamic>(),
        ),
      ),
      vipPool: (() {
        final guardedValue = map['vipPool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworksPropertiesResponseVipPool>(
            guardedValue,
            (value) => VirtualNetworksPropertiesResponseVipPool.fromMap(
      ...
      vmipPool: (() {
        final guardedValue = map['vmipPool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworksPropertiesResponseVmipPool>(
            guardedValue,
            (value) => VirtualNetworksPropertiesResponseVmipPool.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
