...
class StorageSpacesPropertiesStatus {
  ...
  final pulumi.Input<StorageSpacesPropertiesProvisioningStatus>?
  provisioningStatus;

  /// Creates a new [StorageSpacesPropertiesStatus].
  /// [provisioningStatus] Contains Provisioning errors
  StorageSpacesPropertiesStatus({this.provisioningStatus});
    ...
    return StorageSpacesPropertiesStatus(
      provisioningStatus: (() {
        ...
        return pulumi.Input.fromValue(
          StorageSpacesPropertiesProvisioningStatus.fromMap(
