...
class KubernetesPatchVersionsResponse {
  ...
  factory KubernetesPatchVersionsResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesPatchVersionsResponse(
      readiness: (() { final guardedValue = map['readiness']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesVersionReadinessResponse>(guardedValue, (value) => KubernetesVersionReadinessResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      upgrades: (() { final guardedValue = map['upgrades']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
