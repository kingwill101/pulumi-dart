...
class VirtualNetworksPropertiesResponseStatus {
  ...
  final pulumi.Input<VirtualNetworksPropertiesResponseProvisioningStatus>?
  provisioningStatus;

  /// Creates a new [VirtualNetworksPropertiesResponseStatus].
  /// [provisioningStatus] Contains Provisioning errors
  VirtualNetworksPropertiesResponseStatus({this.provisioningStatus});
  ...
  factory VirtualNetworksPropertiesResponseStatus.fromMap(
    ...
    return VirtualNetworksPropertiesResponseStatus(
      provisioningStatus: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualNetworksPropertiesResponseProvisioningStatus.fromMap(
