...
class StorageSpacesPropertiesResponse {
  final pulumi.Input<StorageSpacesPropertiesResponseHciStorageProfile>?
  hciStorageProfile;
  ...
  final pulumi.Input<StorageSpacesPropertiesResponseVmwareStorageProfile>?
    ...
    return StorageSpacesPropertiesResponse(
      hciStorageProfile: (() {
        ...
        return pulumi.Input.fromValue(
          StorageSpacesPropertiesResponseHciStorageProfile.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StorageSpacesPropertiesResponseStatus.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vmwareStorageProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StorageSpacesPropertiesResponseVmwareStorageProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
