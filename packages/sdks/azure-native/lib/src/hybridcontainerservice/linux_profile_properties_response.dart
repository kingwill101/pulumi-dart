...
class LinuxProfilePropertiesResponse {
  ...
  factory LinuxProfilePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LinuxProfilePropertiesResponse(
      ...
      ssh: (() { final guardedValue = map['ssh']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxProfilePropertiesResponseSsh.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
