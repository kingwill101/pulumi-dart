...
class CloudProviderProfile {
  ...
  final pulumi.Input<CloudProviderProfileInfraNetworkProfile>?
  infraNetworkProfile;

  /// InfraStorageProfile - List of infra storage profiles for the provisioned cluster
  final pulumi.Input<CloudProviderProfileInfraStorageProfile>?
  infraStorageProfile;
  ...
  CloudProviderProfile({this.infraNetworkProfile, this.infraStorageProfile});
    ...
    return <String, dynamic>{
      'infraNetworkProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(infraNetworkProfile, (value) => value.toMap()),
      'infraStorageProfile':
          ?pulumi.Input.mapOptionalInputValue<
            CloudProviderProfileInfraStorageProfile,
            Map<String, dynamic>
          >(infraStorageProfile, (value) => value.toMap()),
    };
  }
  ...
  factory CloudProviderProfile.fromMap(Map<String, dynamic> map) {
    return CloudProviderProfile(
      infraNetworkProfile: (() {
        final guardedValue = map['infraNetworkProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudProviderProfileInfraNetworkProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      infraStorageProfile: (() {
        final guardedValue = map['infraStorageProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudProviderProfileInfraStorageProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
