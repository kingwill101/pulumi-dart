...
class AgentPool extends pulumi.CustomResource {
  ...
  AgentPool(
    ...
    this.cloudProviderProfile = registerOutput<CloudProviderProfileResponse?>('cloudProviderProfile');
    this.count = registerOutput<int?>('count');
    this.extendedLocation = registerOutput<AgentPoolResponseExtendedLocation?>('extendedLocation');
    ...
    this.status = registerOutput<AgentPoolProvisioningStatusResponseStatus?>('status');
