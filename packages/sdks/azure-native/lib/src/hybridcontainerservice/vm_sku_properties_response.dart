...
class VmSkuPropertiesResponse {
  ...
  factory VmSkuPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return VmSkuPropertiesResponse(
      capabilities: pulumi.Input.fromValue(pulumi.Input.decodeList<VmSkuCapabilitiesResponse>(map['capabilities']!, (value) => VmSkuCapabilitiesResponse.fromMap((value as Map).cast<String, dynamic>()))),
