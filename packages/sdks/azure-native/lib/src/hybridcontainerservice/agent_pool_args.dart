...
class AgentPoolArgs {
  ...
  factory AgentPoolArgs.fromMap(Map<String, dynamic> map) {
    return AgentPoolArgs(
      ...
      extendedLocation: (() { final guardedValue = map['extendedLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentPoolExtendedLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentPoolProvisioningStatusStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
