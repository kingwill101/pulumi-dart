...
class GetVirtualNetworkRetrieveResult {
  ...
  factory GetVirtualNetworkRetrieveResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualNetworkRetrieveResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return VirtualNetworkPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
