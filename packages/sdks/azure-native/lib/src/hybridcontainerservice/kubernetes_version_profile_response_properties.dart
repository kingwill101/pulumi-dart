...
class KubernetesVersionProfileResponseProperties {
    ...
    return <String, dynamic>{
      ...
      'values':
          ?pulumi.Input.mapOptionalInputValue<
            List<KubernetesVersionPropertiesResponse>,
  ...
  factory KubernetesVersionProfileResponseProperties.fromMap(
    ...
    return KubernetesVersionProfileResponseProperties(
      ...
      values: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KubernetesVersionPropertiesResponse>(
            guardedValue,
            (value) => KubernetesVersionPropertiesResponse.fromMap(
