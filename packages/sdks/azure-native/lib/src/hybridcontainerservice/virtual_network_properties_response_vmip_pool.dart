...
class VirtualNetworkPropertiesResponseVmipPool {
  ...
  factory VirtualNetworkPropertiesResponseVmipPool.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkPropertiesResponseVmipPool(
