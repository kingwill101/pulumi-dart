...
class GetStorageSpaceRetrieveResult {
  ...
  factory GetStorageSpaceRetrieveResult.fromMap(Map<String, dynamic> map) {
    return GetStorageSpaceRetrieveResult(
      ...
      extendedLocation: (() { final guardedValue = map['extendedLocation']; if (guardedValue == null) return null; return StorageSpacesResponseExtendedLocation.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      id: map['id'] as String,
