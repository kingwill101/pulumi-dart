...
class VirtualNetworksPropertiesInfraVnetProfile {
  ...
  factory VirtualNetworksPropertiesInfraVnetProfile.fromMap(
    ...
    return VirtualNetworksPropertiesInfraVnetProfile(
      hci: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualNetworksPropertiesHci.fromMap(
      ...
      networkCloud: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworksPropertiesNetworkCloud.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vmware: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworksPropertiesVmware.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
