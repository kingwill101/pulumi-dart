...
class StorageSpacesPropertiesResponseStatus {
  ...
  const StorageSpacesPropertiesResponseStatus({
  ...
  factory StorageSpacesPropertiesResponseStatus.fromMap(Map<String, dynamic> map) {
    return StorageSpacesPropertiesResponseStatus(
      provisioningStatus: (() { final guardedValue = map['provisioningStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageSpacesPropertiesResponseProvisioningStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
