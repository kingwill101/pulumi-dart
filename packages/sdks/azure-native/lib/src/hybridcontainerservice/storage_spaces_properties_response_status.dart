...
class StorageSpacesPropertiesResponseStatus {
  ...
  final pulumi.Input<StorageSpacesPropertiesResponseProvisioningStatus>?
  provisioningStatus;

  /// Creates a new [StorageSpacesPropertiesResponseStatus].
  /// [provisioningStatus] Contains Provisioning errors
  StorageSpacesPropertiesResponseStatus({this.provisioningStatus});
  ...
  factory StorageSpacesPropertiesResponseStatus.fromMap(
    ...
    return StorageSpacesPropertiesResponseStatus(
      provisioningStatus: (() {
        ...
        return pulumi.Input.fromValue(
          StorageSpacesPropertiesResponseProvisioningStatus.fromMap(
