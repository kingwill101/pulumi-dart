...
class Springbootapp extends pulumi.CustomResource {
  ...
  Springbootapp(
    ...
    properties = registerOutput<SpringbootappsPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SpringbootappsPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [Springbootapp] resource.
  Springbootapp.reference(String urn)
    : super(
        'azure-native:offazurespringboot:Springbootapp',
