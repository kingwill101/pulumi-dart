...
class Springbootserver extends pulumi.CustomResource {
  ...
  Springbootserver(
    ...
    properties = registerOutput<SpringbootserversPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SpringbootserversPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [Springbootserver] resource.
  Springbootserver.reference(String urn)
    : super(
        'azure-native:offazurespringboot:Springbootserver',
