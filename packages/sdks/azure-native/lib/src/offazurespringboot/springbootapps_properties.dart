...
class SpringbootappsProperties {
  ...
  final pulumi.Input<List<SpringbootappsPropertiesApplicationConfigurations>>?
    ...
    return <String, dynamic>{
      ...
      'applicationConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<SpringbootappsPropertiesApplicationConfigurations>,
      ...
      'instances':
          ?pulumi.Input.mapOptionalInputValue<
            List<SpringbootappsPropertiesInstances>,
            List<Map<String, dynamic>>
          >(
            instances,
            (value) =>
      ...
      'miscs':
          ?pulumi.Input.mapOptionalInputValue<
            List<SpringbootappsPropertiesMiscs>,
            List<Map<String, dynamic>>
          >(
            miscs,
            (value) =>
  ...
  factory SpringbootappsProperties.fromMap(Map<String, dynamic> map) {
    return SpringbootappsProperties(
      ...
      applicationConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SpringbootappsPropertiesApplicationConfigurations.fromMap(
      ...
      instances: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SpringbootappsPropertiesInstances>(
            guardedValue,
            (value) => SpringbootappsPropertiesInstances.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      miscs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SpringbootappsPropertiesMiscs>(
            guardedValue,
            (value) => SpringbootappsPropertiesMiscs.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
