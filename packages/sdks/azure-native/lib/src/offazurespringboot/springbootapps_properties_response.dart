...
class SpringbootappsPropertiesResponse {
  ...
  factory SpringbootappsPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SpringbootappsPropertiesResponse(
      ...
      applicationConfigurations: (() { final guardedValue = map['applicationConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SpringbootappsPropertiesResponseApplicationConfigurations>(guardedValue, (value) => SpringbootappsPropertiesResponseApplicationConfigurations.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      errors: (() { final guardedValue = map['errors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ErrorResponse>(guardedValue, (value) => ErrorResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      instanceCount: (() { final guardedValue = map['instanceCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      instances: (() { final guardedValue = map['instances']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SpringbootappsPropertiesResponseInstances>(guardedValue, (value) => SpringbootappsPropertiesResponseInstances.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      miscs: (() { final guardedValue = map['miscs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SpringbootappsPropertiesResponseMiscs>(guardedValue, (value) => SpringbootappsPropertiesResponseMiscs.fromMap((value as Map).cast<String, dynamic>()))); })(),
