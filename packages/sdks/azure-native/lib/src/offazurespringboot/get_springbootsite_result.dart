...
class GetSpringbootsiteResult {
  ...
  factory GetSpringbootsiteResult.fromMap(Map<String, dynamic> map) {
    return GetSpringbootsiteResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return SpringbootsitesPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
