...
class GetSqlVirtualMachineResult {
  ...
  final ServerConfigurationsManagementSettingsResponse?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serverConfigurationsManagementSettings':
          ?serverConfigurationsManagementSettings?.toMap(),
  ...
  factory GetSqlVirtualMachineResult.fromMap(Map<String, dynamic> map) {
    return GetSqlVirtualMachineResult(
      ...
      troubleshootingStatus: TroubleshootingStatusResponse.fromMap(
        (map['troubleshootingStatus']! as Map).cast<String, dynamic>(),
      ),
