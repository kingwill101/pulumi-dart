...
class SqlVirtualMachineArgs {
  ...
  factory SqlVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return SqlVirtualMachineArgs(
      assessmentSettings: (() { final guardedValue = map['assessmentSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssessmentSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      autoBackupSettings: (() { final guardedValue = map['autoBackupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoBackupSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      autoPatchingSettings: (() { final guardedValue = map['autoPatchingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoPatchingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      virtualMachineIdentitySettings: (() { final guardedValue = map['virtualMachineIdentitySettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      virtualMachineResourceId: (() { final guardedValue = map['virtualMachineResourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      wsfcDomainCredentials: (() { final guardedValue = map['wsfcDomainCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WsfcDomainCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      wsfcStaticIp: (() { final guardedValue = map['wsfcStaticIp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
