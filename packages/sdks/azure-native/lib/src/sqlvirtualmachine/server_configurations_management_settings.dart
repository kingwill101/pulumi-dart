...
class ServerConfigurationsManagementSettings {
  ...
  final pulumi.Input<AdditionalFeaturesServerConfigurations>?
  ...
  final pulumi.Input<SqlConnectivityUpdateSettings>?
  ...
  final pulumi.Input<SqlWorkloadTypeUpdateSettings>?
  ...
  factory ServerConfigurationsManagementSettings.fromMap(
    ...
    return ServerConfigurationsManagementSettings(
      additionalFeaturesServerConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          AdditionalFeaturesServerConfigurations.fromMap(
      ...
      azureAdAuthenticationSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AADAuthenticationSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sqlConnectivityUpdateSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlConnectivityUpdateSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sqlStorageUpdateSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlStorageUpdateSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sqlWorkloadTypeUpdateSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlWorkloadTypeUpdateSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
