  ...
  factory LoadBalancerConfiguration.fromMap(Map<String, dynamic> map) {
    return LoadBalancerConfiguration(
      loadBalancerResourceId: (() {
        final guardedValue = map['loadBalancerResourceId'];
      ...
      publicIpAddressResourceId: (() {
        final guardedValue = map['publicIpAddressResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sqlVirtualMachineInstances: (() {
        final guardedValue = map['sqlVirtualMachineInstances'];
        if (guardedValue == null) return null;
