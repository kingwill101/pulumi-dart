...
class StorageConfigurationSettingsResponse {
  ...
  factory StorageConfigurationSettingsResponse.fromMap(Map<String, dynamic> map) {
    return StorageConfigurationSettingsResponse(
      ...
      sqlDataSettings: (() { final guardedValue = map['sqlDataSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SQLStorageSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sqlLogSettings: (() { final guardedValue = map['sqlLogSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SQLStorageSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sqlTempDbSettings: (() { final guardedValue = map['sqlTempDbSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SQLTempDbSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
