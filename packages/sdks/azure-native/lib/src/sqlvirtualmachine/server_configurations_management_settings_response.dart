...
class ServerConfigurationsManagementSettingsResponse {
  ...
  final pulumi.Input<AdditionalFeaturesServerConfigurationsResponse>?
  additionalFeaturesServerConfigurations;

  /// Azure AD authentication Settings.
  final pulumi.Input<AADAuthenticationSettingsResponse>?
  azureAdAuthenticationSettings;

  /// SQL connectivity type settings.
  final pulumi.Input<SqlConnectivityUpdateSettingsResponse>?
  ...
  final pulumi.Input<SqlStorageUpdateSettingsResponse>?
  sqlStorageUpdateSettings;

  /// SQL workload type settings.
  final pulumi.Input<SqlWorkloadTypeUpdateSettingsResponse>?
    ...
    return <String, dynamic>{
      'additionalFeaturesServerConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(additionalFeaturesServerConfigurations, (value) => value.toMap()),
      'azureAdAuthenticationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            AADAuthenticationSettingsResponse,
            Map<String, dynamic>
          >(azureAdAuthenticationSettings, (value) => value.toMap()),
      'sqlConnectivityUpdateSettings':
          ?pulumi.Input.mapOptionalInputValue<
            SqlConnectivityUpdateSettingsResponse,
            Map<String, dynamic>
          >(sqlConnectivityUpdateSettings, (value) => value.toMap()),
      'sqlInstanceSettings':
          ?pulumi.Input.mapOptionalInputValue<
            SQLInstanceSettingsResponse,
            Map<String, dynamic>
          >(sqlInstanceSettings, (value) => value.toMap()),
      'sqlStorageUpdateSettings':
          ?pulumi.Input.mapOptionalInputValue<
            SqlStorageUpdateSettingsResponse,
            Map<String, dynamic>
          >(sqlStorageUpdateSettings, (value) => value.toMap()),
      'sqlWorkloadTypeUpdateSettings':
          ?pulumi.Input.mapOptionalInputValue<
            SqlWorkloadTypeUpdateSettingsResponse,
            Map<String, dynamic>
          >(sqlWorkloadTypeUpdateSettings, (value) => value.toMap()),
    };
  }

  factory ServerConfigurationsManagementSettingsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ServerConfigurationsManagementSettingsResponse(
      additionalFeaturesServerConfigurations: (() {
        final guardedValue = map['additionalFeaturesServerConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AdditionalFeaturesServerConfigurationsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      azureAdAuthenticationSettings: (() {
        final guardedValue = map['azureAdAuthenticationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AADAuthenticationSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sqlConnectivityUpdateSettings: (() {
        final guardedValue = map['sqlConnectivityUpdateSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlConnectivityUpdateSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sqlInstanceSettings: (() {
        final guardedValue = map['sqlInstanceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SQLInstanceSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sqlStorageUpdateSettings: (() {
        final guardedValue = map['sqlStorageUpdateSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlStorageUpdateSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sqlWorkloadTypeUpdateSettings: (() {
        final guardedValue = map['sqlWorkloadTypeUpdateSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlWorkloadTypeUpdateSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
