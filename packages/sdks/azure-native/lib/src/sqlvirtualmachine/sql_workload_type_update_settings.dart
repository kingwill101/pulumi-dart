...
class SqlWorkloadTypeUpdateSettings {
  ...
  final pulumi.Input<dynamic>? sqlWorkloadType;
  ...
  factory SqlWorkloadTypeUpdateSettings.fromMap(Map<String, dynamic> map) {
    return SqlWorkloadTypeUpdateSettings(
      sqlWorkloadType: (() { final guardedValue = map['sqlWorkloadType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
