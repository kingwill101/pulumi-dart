...
class AgConfiguration {
  ...
  factory AgConfiguration.fromMap(Map<String, dynamic> map) {
    return AgConfiguration(
      replicas: (() { final guardedValue = map['replicas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AgReplica>(guardedValue, (value) => AgReplica.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
