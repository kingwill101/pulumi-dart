...
class AccountStatusErrorDetailsResponse {
  ...
  /// Creates a new [AccountStatusErrorDetailsResponse].
  ...
  const AccountStatusErrorDetailsResponse({
    required this.code,
  ...
  factory AccountStatusErrorDetailsResponse.fromMap(Map<String, dynamic> map) {
    return AccountStatusErrorDetailsResponse(
