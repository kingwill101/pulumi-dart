...
class GetAccountResult {
  ...
  factory GetAccountResult.fromMap(Map<String, dynamic> map) {
    return GetAccountResult(
      accountStatus: AccountPropertiesResponseAccountStatus.fromMap(
        (map['accountStatus']! as Map).cast<String, dynamic>(),
      ),
      azureApiVersion: map['azureApiVersion'] as String,
      cloudConnectors: (() {
        final guardedValue = map['cloudConnectors'];
      ...
      endpoints: AccountPropertiesResponseEndpoints.fromMap(
      ...
      managedResources: AccountPropertiesResponseManagedResources.fromMap(
        (map['managedResources']! as Map).cast<String, dynamic>(),
      ),
      managedResourcesPublicNetworkAccess: (() {
      ...
      mergeInfo: (() {
        final guardedValue = map['mergeInfo'];
        if (guardedValue == null) return null;
      ...
      systemData: TrackedResourceResponseSystemData.fromMap(
