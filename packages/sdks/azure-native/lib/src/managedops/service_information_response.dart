...
class ServiceInformationResponse {
  ...
  final pulumi.Input<GuestConfigurationInformationResponse>
  ...
  final pulumi.Input<ChangeTrackingInformationResponse>
    ...
    return <String, dynamic>{
      ...
      'azurePolicyAndMachineConfiguration':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(azurePolicyAndMachineConfiguration, (value) => value.toMap()),
      'azureUpdateManager':
          pulumi.Input.mapInputValue<
            UpdateManagerInformationResponse,
            Map<String, dynamic>
          >(azureUpdateManager, (value) => value.toMap()),
      'changeTrackingAndInventory':
          pulumi.Input.mapInputValue<
      ...
      'defenderCspm':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(defenderCspm, (value) => value.toMap()),
      'defenderForServers':
          pulumi.Input.mapInputValue<
  ...
  factory ServiceInformationResponse.fromMap(Map<String, dynamic> map) {
    return ServiceInformationResponse(
      azureMonitorInsights: pulumi.Input.fromValue(
        AzureMonitorInformationResponse.fromMap(
          (map['azureMonitorInsights']! as Map).cast<String, dynamic>(),
        ),
      ),
      azurePolicyAndMachineConfiguration: pulumi.Input.fromValue(
        GuestConfigurationInformationResponse.fromMap(
          (map['azurePolicyAndMachineConfiguration']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      azureUpdateManager: pulumi.Input.fromValue(
        UpdateManagerInformationResponse.fromMap(
          (map['azureUpdateManager']! as Map).cast<String, dynamic>(),
        ),
      ),
      changeTrackingAndInventory: pulumi.Input.fromValue(
        ChangeTrackingInformationResponse.fromMap(
          (map['changeTrackingAndInventory']! as Map).cast<String, dynamic>(),
        ),
      ),
      defenderCspm: pulumi.Input.fromValue(
        DefenderCspmInformationResponse.fromMap(
          (map['defenderCspm']! as Map).cast<String, dynamic>(),
        ),
      ),
      defenderForServers: pulumi.Input.fromValue(
        DefenderForServersInformationResponse.fromMap(
          (map['defenderForServers']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
