...
class LinuxProperties {
  ...
  final pulumi.Input<dynamic>? includedPackageClassifications;
  ...
  factory LinuxProperties.fromMap(Map<String, dynamic> map) {
    return LinuxProperties(
      ...
      includedPackageClassifications: (() { final guardedValue = map['includedPackageClassifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
