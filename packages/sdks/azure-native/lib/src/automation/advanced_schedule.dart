...
class AdvancedSchedule {
  ...
  final pulumi.Input<List<AdvancedScheduleMonthlyOccurrence>>?
  monthlyOccurrences;
  ...
  AdvancedSchedule({this.monthDays, this.monthlyOccurrences, this.weekDays});
    ...
    return AdvancedSchedule(
      ...
      monthlyOccurrences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdvancedScheduleMonthlyOccurrence>(
            guardedValue,
            (value) => AdvancedScheduleMonthlyOccurrence.fromMap(
