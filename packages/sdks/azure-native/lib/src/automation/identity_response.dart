...
class IdentityResponse {
  ...
  final pulumi.Input<Map<String, UserAssignedIdentitiesPropertiesResponse>>?
    ...
    return <String, dynamic>{
      ...
      'userAssignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, UserAssignedIdentitiesPropertiesResponse>,
    ...
    return IdentityResponse(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeMapValues<UserAssignedIdentitiesPropertiesResponse>(
            guardedValue,
            (value) => UserAssignedIdentitiesPropertiesResponse.fromMap(
