...
class WebhookArgs {
  ...
  factory WebhookArgs.fromMap(Map<String, dynamic> map) {
    return WebhookArgs(
      ...
      runbook: (() { final guardedValue = map['runbook']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RunbookAssociationProperty.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
