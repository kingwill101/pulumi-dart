...
class ListAutomationAccountDeletedRunbooksResult {
  ...
  ListAutomationAccountDeletedRunbooksResult({this.nextLink, this.value});
  ...
  factory ListAutomationAccountDeletedRunbooksResult.fromMap(
    ...
    return ListAutomationAccountDeletedRunbooksResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<DeletedRunbookResponse>(
          guardedValue,
          (value) => DeletedRunbookResponse.fromMap(
