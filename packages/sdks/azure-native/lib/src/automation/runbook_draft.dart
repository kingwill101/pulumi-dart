...
class RunbookDraft {
    ...
    return <String, dynamic>{
      ...
      'draftContentLink':
          ?pulumi.Input.mapOptionalInputValue<
            ContentLink,
            Map<String, dynamic>
          >(draftContentLink, (value) => value.toMap()),
      'inEdit': ?inEdit,
  ...
  factory RunbookDraft.fromMap(Map<String, dynamic> map) {
    return RunbookDraft(
      ...
      draftContentLink: (() {
        final guardedValue = map['draftContentLink'];
        if (guardedValue == null) return null;
      ...
      parameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<RunbookParameter>(
            guardedValue,
            (value) => RunbookParameter.fromMap(
