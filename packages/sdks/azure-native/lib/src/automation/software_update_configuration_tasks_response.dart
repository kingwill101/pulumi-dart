...
class SoftwareUpdateConfigurationTasksResponse {
  ...
  factory SoftwareUpdateConfigurationTasksResponse.fromMap(Map<String, dynamic> map) {
    return SoftwareUpdateConfigurationTasksResponse(
      postTask: (() { final guardedValue = map['postTask']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      preTask: (() { final guardedValue = map['preTask']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
