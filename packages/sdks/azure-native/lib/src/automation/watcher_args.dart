...
class WatcherArgs {
  ...
  factory WatcherArgs.fromMap(Map<String, dynamic> map) {
    return WatcherArgs(
      ...
      executionFrequencyInSeconds: (() { final guardedValue = map['executionFrequencyInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
