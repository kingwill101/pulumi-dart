...
class TargetProperties {
  ...
  TargetProperties({this.azureQueries, this.nonAzureQueries});
    ...
    return TargetProperties(
      azureQueries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureQueryProperties>(
            guardedValue,
            (value) => AzureQueryProperties.fromMap(
      ...
      nonAzureQueries: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NonAzureQueryProperties>(
            guardedValue,
            (value) => NonAzureQueryProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
