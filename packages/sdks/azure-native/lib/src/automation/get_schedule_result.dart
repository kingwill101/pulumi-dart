...
class GetScheduleResult {
  ...
  factory GetScheduleResult.fromMap(Map<String, dynamic> map) {
    return GetScheduleResult(
      ...
      expiryTimeOffsetMinutes: (() { final guardedValue = map['expiryTimeOffsetMinutes']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      ...
      nextRunOffsetMinutes: (() { final guardedValue = map['nextRunOffsetMinutes']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      startTime: (() { final guardedValue = map['startTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      startTimeOffsetMinutes: (() { final guardedValue = map['startTimeOffsetMinutes']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
