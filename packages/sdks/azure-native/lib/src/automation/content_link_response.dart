...
class ContentLinkResponse {
  ...
  factory ContentLinkResponse.fromMap(Map<String, dynamic> map) {
    return ContentLinkResponse(
      contentHash: (() { final guardedValue = map['contentHash']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContentHashResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
