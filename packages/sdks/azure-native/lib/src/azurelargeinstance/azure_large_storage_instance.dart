...
class AzureLargeStorageInstance extends pulumi.CustomResource {
  ...
  AzureLargeStorageInstance(
    ...
    azureLargeStorageInstanceUniqueIdentifier = registerOutput<String?>('azureLargeStorageInstanceUniqueIdentifier');
  ...
  /// Creates a typed reference to an existing [AzureLargeStorageInstance] resource.
  AzureLargeStorageInstance.reference(String urn)
    : super(
        'azure-native:azurelargeinstance:AzureLargeStorageInstance',
