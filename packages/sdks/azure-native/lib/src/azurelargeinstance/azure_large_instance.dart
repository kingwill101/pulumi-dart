...
/// }
///
/// resource "azure-native_azurelargeinstance_azurelargeinstance" "azureLargeInstance" {
///   azure_large_instance_id   = "23415635-4d7e-41dc-9598-8194f22c24e1"
///   azure_large_instance_name = "myALInstance"
///   hardware_profile = {
///     azure_large_instance_size = "S72"
...
class AzureLargeInstance extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [AzureLargeInstance] resource.
  AzureLargeInstance.reference(String urn)
    : super(
        'azure-native:azurelargeinstance:AzureLargeInstance',
