...
class IngestionPolicyPropertiesFormat {
  ...
  IngestionPolicyPropertiesFormat({this.ingestionSources, this.ingestionType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ingestionSources':
          ?pulumi.Input.mapOptionalInputValue<
            List<IngestionSourcesPropertiesFormat>,
    ...
    return IngestionPolicyPropertiesFormat(
      ingestionSources: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngestionSourcesPropertiesFormat>(
            guardedValue,
            (value) => IngestionSourcesPropertiesFormat.fromMap(
