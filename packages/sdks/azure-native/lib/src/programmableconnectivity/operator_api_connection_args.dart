    ...
    return <String, dynamic>{
      ...
      'configuredApplication':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(configuredApplication, (value) => value.toMap()),
      'gatewayId': gatewayId,
      'location': ?location,
      ...
      'saasProperties':
          ?pulumi.Input.mapOptionalInputValue<
            SaasProperties,
            Map<String, dynamic>
          >(saasProperties, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory OperatorApiConnectionArgs.fromMap(Map<String, dynamic> map) {
    return OperatorApiConnectionArgs(
      ...
      operatorApiConnectionName: (() {
        final guardedValue = map['operatorApiConnectionName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      operatorApiPlanId: pulumi.Input.fromValue(
        map['operatorApiPlanId'] as String,
      ),
      ...
      saasProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SaasProperties.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
