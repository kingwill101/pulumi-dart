...
class DicomServiceArgs {
  ...
  factory DicomServiceArgs.fromMap(Map<String, dynamic> map) {
    return DicomServiceArgs(
      ...
      dicomServiceName: (() { final guardedValue = map['dicomServiceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enableDataPartitions: (() { final guardedValue = map['enableDataPartitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
