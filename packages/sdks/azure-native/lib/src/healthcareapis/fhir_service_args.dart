...
class FhirServiceArgs {
  ...
  final pulumi.Input<FhirServiceAuthenticationConfiguration>?
  ...
  final pulumi.Input<ImplementationGuidesConfiguration>?
  ...
  final pulumi.Input<ResourceVersionPolicyConfiguration>?
    ...
    return <String, dynamic>{
      ...
      'implementationGuidesConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ImplementationGuidesConfiguration,
            Map<String, dynamic>
          >(implementationGuidesConfiguration, (value) => value.toMap()),
      'importConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'resourceVersionPolicyConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceVersionPolicyConfiguration,
            Map<String, dynamic>
          >(resourceVersionPolicyConfiguration, (value) => value.toMap()),
      'tags': ?tags,
    ...
    return FhirServiceArgs(
      acrConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          FhirServiceAcrConfiguration.fromMap(
      ...
      authenticationConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FhirServiceAuthenticationConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      corsConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FhirServiceCorsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      exportConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FhirServiceExportConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fhirServiceName: (() {
        final guardedValue = map['fhirServiceName'];
        if (guardedValue == null) return null;
      ...
      implementationGuidesConfiguration: (() {
        final guardedValue = map['implementationGuidesConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImplementationGuidesConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      importConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FhirServiceImportConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      resourceVersionPolicyConfiguration: (() {
        final guardedValue = map['resourceVersionPolicyConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceVersionPolicyConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
