...
class FhirServiceAuthenticationConfiguration {
  ...
  final pulumi.Input<List<SmartIdentityProviderConfiguration>>?
    ...
    return <String, dynamic>{
      ...
      'smartIdentityProviders':
          ?pulumi.Input.mapOptionalInputValue<
            List<SmartIdentityProviderConfiguration>,
  ...
  factory FhirServiceAuthenticationConfiguration.fromMap(
    ...
    return FhirServiceAuthenticationConfiguration(
      ...
      smartIdentityProviders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SmartIdentityProviderConfiguration>(
            guardedValue,
            (value) => SmartIdentityProviderConfiguration.fromMap(
