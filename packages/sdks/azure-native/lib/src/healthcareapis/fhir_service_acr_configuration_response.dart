...
class FhirServiceAcrConfigurationResponse {
  ...
  FhirServiceAcrConfigurationResponse({this.loginServers, this.ociArtifacts});
    ...
    return <String, dynamic>{
      ...
      'ociArtifacts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceOciArtifactEntryResponse>,
  ...
  factory FhirServiceAcrConfigurationResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return FhirServiceAcrConfigurationResponse(
      loginServers: (() {
        final guardedValue = map['loginServers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ociArtifacts: (() {
        final guardedValue = map['ociArtifacts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceOciArtifactEntryResponse>(
            guardedValue,
            (value) => ServiceOciArtifactEntryResponse.fromMap(
