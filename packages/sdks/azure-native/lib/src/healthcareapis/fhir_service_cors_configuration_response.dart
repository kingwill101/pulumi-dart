...
class FhirServiceCorsConfigurationResponse {
  ...
  /// Creates a new [FhirServiceCorsConfigurationResponse].
  ...
  const FhirServiceCorsConfigurationResponse({
  ...
  factory FhirServiceCorsConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return FhirServiceCorsConfigurationResponse(
