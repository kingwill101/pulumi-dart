...
/// }
///
/// resource "azure-native_healthcareapis_privateendpointconnection" "privateEndpointConnection" {
...
class PrivateEndpointConnectionHealthcareapis extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionHealthcareapis] resource.
  PrivateEndpointConnectionHealthcareapis.reference(String urn)
    : super(
        'azure-native:healthcareapis:PrivateEndpointConnection',
