...
class ServicesPropertiesResponse {
  ...
  factory ServicesPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ServicesPropertiesResponse(
      accessPolicies: (() { final guardedValue = map['accessPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceAccessPolicyEntryResponse>(guardedValue, (value) => ServiceAccessPolicyEntryResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      acrConfiguration: (() { final guardedValue = map['acrConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAcrConfigurationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      authenticationConfiguration: (() { final guardedValue = map['authenticationConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceAuthenticationConfigurationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      corsConfiguration: (() { final guardedValue = map['corsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceCorsConfigurationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cosmosDbConfiguration: (() { final guardedValue = map['cosmosDbConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceCosmosDbConfigurationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      exportConfiguration: (() { final guardedValue = map['exportConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceExportConfigurationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      importConfiguration: (() { final guardedValue = map['importConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceImportConfigurationInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
