...
class ServiceAcrConfigurationInfo {
  ...
  ServiceAcrConfigurationInfo({this.loginServers, this.ociArtifacts});
    ...
    return ServiceAcrConfigurationInfo(
      ...
      ociArtifacts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceOciArtifactEntry>(
            guardedValue,
            (value) => ServiceOciArtifactEntry.fromMap(
