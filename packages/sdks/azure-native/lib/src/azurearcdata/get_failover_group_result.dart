...
class GetFailoverGroupResult {
  ...
  final String? name;
  /// null
  final FailoverGroupPropertiesResponse? properties;
  ...
  factory GetFailoverGroupResult.fromMap(Map<String, dynamic> map) {
    return GetFailoverGroupResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return FailoverGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
