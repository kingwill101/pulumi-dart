...
class ActiveDirectoryConnectorDomainDetails {
  ...
  final pulumi.Input<dynamic>? serviceAccountProvisioning;
  ...
  ActiveDirectoryConnectorDomainDetails({
    ...
    required this.realm,
    pulumi.Input<dynamic>? serviceAccountProvisioning,
  ...
  factory ActiveDirectoryConnectorDomainDetails.fromMap(Map<String, dynamic> map) {
    return ActiveDirectoryConnectorDomainDetails(
      ...
      serviceAccountProvisioning: (() { final guardedValue = map['serviceAccountProvisioning']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
