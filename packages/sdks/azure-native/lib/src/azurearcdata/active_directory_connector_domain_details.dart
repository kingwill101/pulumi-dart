...
class ActiveDirectoryConnectorDomainDetails {
  /// null
  final ActiveDirectoryDomainControllers? domainControllers;
  ...
  factory ActiveDirectoryConnectorDomainDetails.fromMap(Map<String, dynamic> map) {
    return ActiveDirectoryConnectorDomainDetails(
      domainControllers: map['domainControllers'] == null ? null : ActiveDirectoryDomainControllers.fromMap((map['domainControllers'] as Map).cast<String, dynamic>()),
