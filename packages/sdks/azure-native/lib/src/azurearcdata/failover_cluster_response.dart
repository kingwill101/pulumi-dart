...
class FailoverClusterResponse {
    ...
    return <String, dynamic>{
      'hostIPAddresses':
          pulumi.Input.mapInputValue<
            List<HostIPAddressInformationResponse>,
  ...
  factory FailoverClusterResponse.fromMap(Map<String, dynamic> map) {
    return FailoverClusterResponse(
      hostIPAddresses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HostIPAddressInformationResponse>(
          map['hostIPAddresses']!,
          (value) => HostIPAddressInformationResponse.fromMap(
      ...
      sqlInstanceIds: pulumi.Input.fromValue(
        (map['sqlInstanceIds'] as List).cast<String>(),
      ),
    );
  }
}
