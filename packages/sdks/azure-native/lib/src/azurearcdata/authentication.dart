...
class Authentication {
  ...
  Authentication({this.mode, this.sqlServerEntraIdentity});
    ...
    return Authentication(
      ...
      sqlServerEntraIdentity: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EntraAuthentication>(
            guardedValue,
            (value) => EntraAuthentication.fromMap(
