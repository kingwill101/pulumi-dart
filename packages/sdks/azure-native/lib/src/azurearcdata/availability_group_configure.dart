...
class AvailabilityGroupConfigure {
  ...
  final pulumi.Input<dynamic>? availabilityMode;
  ...
  final pulumi.Input<dynamic>? endpointAuthenticationMode;
  ...
  final pulumi.Input<dynamic>? failoverMode;
  ...
  factory AvailabilityGroupConfigure.fromMap(Map<String, dynamic> map) {
    return AvailabilityGroupConfigure(
      availabilityMode: (() { final guardedValue = map['availabilityMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      endpointAuthenticationMode: (() { final guardedValue = map['endpointAuthenticationMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      failoverMode: (() { final guardedValue = map['failoverMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
