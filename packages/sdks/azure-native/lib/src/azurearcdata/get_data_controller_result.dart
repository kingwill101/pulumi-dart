...
class GetDataControllerResult {
  ...
  factory GetDataControllerResult.fromMap(Map<String, dynamic> map) {
    return GetDataControllerResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return DataControllerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
