...
class SqlAvailabilityGroupDatabaseReplicaResourcePropertiesResponse {
  ...
  factory SqlAvailabilityGroupDatabaseReplicaResourcePropertiesResponse.fromMap(
    ...
    return SqlAvailabilityGroupDatabaseReplicaResourcePropertiesResponse(
      ...
      databaseStateDescription: pulumi.Input.fromValue(
        map['databaseStateDescription'] as String,
      ),
      isCommitParticipant: pulumi.Input.fromValue(
        map['isCommitParticipant'] as bool,
      ),
      ...
      suspendReasonDescription: pulumi.Input.fromValue(
        map['suspendReasonDescription'] as String,
      ),
      synchronizationHealthDescription: pulumi.Input.fromValue(
        map['synchronizationHealthDescription'] as String,
      ),
      synchronizationStateDescription: pulumi.Input.fromValue(
        map['synchronizationStateDescription'] as String,
      ),
    );
  }
}
