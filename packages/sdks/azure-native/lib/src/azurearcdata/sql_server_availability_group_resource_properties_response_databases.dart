...
class SqlServerAvailabilityGroupResourcePropertiesResponseDatabases {
  ...
  final pulumi.Input<
    List<SqlAvailabilityGroupDatabaseReplicaResourcePropertiesResponse>
  >?
  value;
  ...
  factory SqlServerAvailabilityGroupResourcePropertiesResponseDatabases.fromMap(
      ...
      value: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SqlAvailabilityGroupDatabaseReplicaResourcePropertiesResponse.fromMap(
