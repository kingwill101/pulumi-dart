...
class GetSqlServerInstanceTelemetryResult {
  ...
  factory GetSqlServerInstanceTelemetryResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetSqlServerInstanceTelemetryResult(
      columns:
          pulumi.Input.decodeList<SqlServerInstanceTelemetryColumnResponse>(
            map['columns']!,
            (value) => SqlServerInstanceTelemetryColumnResponse.fromMap(
