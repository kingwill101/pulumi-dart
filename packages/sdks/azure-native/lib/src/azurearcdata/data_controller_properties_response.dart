...
class DataControllerPropertiesResponse {
  ...
  factory DataControllerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DataControllerPropertiesResponse(
      ...
      logAnalyticsWorkspaceConfig: (() { final guardedValue = map['logAnalyticsWorkspaceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogAnalyticsWorkspaceConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      logsDashboardCredential: (() { final guardedValue = map['logsDashboardCredential']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BasicLoginInformationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metricsDashboardCredential: (() { final guardedValue = map['metricsDashboardCredential']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BasicLoginInformationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      onPremiseProperty: (() { final guardedValue = map['onPremiseProperty']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnPremisePropertyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      uploadServicePrincipal: (() { final guardedValue = map['uploadServicePrincipal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UploadServicePrincipalResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      uploadWatermark: (() { final guardedValue = map['uploadWatermark']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UploadWatermarkResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
