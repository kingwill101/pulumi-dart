...
class SqlManagedInstanceProperties {
  ...
  factory SqlManagedInstanceProperties.fromMap(Map<String, dynamic> map) {
    return SqlManagedInstanceProperties(
      activeDirectoryInformation: (() { final guardedValue = map['activeDirectoryInformation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ActiveDirectoryInformation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
