...
class AvailabilityGroupInfoResponse {
  ...
  factory AvailabilityGroupInfoResponse.fromMap(Map<String, dynamic> map) {
    return AvailabilityGroupInfoResponse(
      automatedBackupPreferenceDescription: pulumi.Input.fromValue(map['automatedBackupPreferenceDescription'] as String),
      ...
      clusterTypeDescription: pulumi.Input.fromValue(map['clusterTypeDescription'] as String),
      ...
      failureConditionLevel: (() { final guardedValue = map['failureConditionLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      healthCheckTimeout: (() { final guardedValue = map['healthCheckTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      listener: (() { final guardedValue = map['listener']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlAvailabilityGroupStaticIPListenerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      primaryRecoveryHealthDescription: pulumi.Input.fromValue(map['primaryRecoveryHealthDescription'] as String),
      primaryReplica: pulumi.Input.fromValue(map['primaryReplica'] as String),
      replicationPartnerType: pulumi.Input.fromValue(map['replicationPartnerType'] as String),
      requiredSynchronizedSecondariesToCommit: (() { final guardedValue = map['requiredSynchronizedSecondariesToCommit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      secondaryRecoveryHealthDescription: pulumi.Input.fromValue(map['secondaryRecoveryHealthDescription'] as String),
