...
class ActiveDirectoryConnectorDomainDetailsResponse {
  /// null
  final pulumi.Input<ActiveDirectoryDomainControllersResponse>?
  domainControllers;
  ...
  factory ActiveDirectoryConnectorDomainDetailsResponse.fromMap(
    ...
    return ActiveDirectoryConnectorDomainDetailsResponse(
      domainControllers: (() {
        ...
        return pulumi.Input.fromValue(
          ActiveDirectoryDomainControllersResponse.fromMap(
