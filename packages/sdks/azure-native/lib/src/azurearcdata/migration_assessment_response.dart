...
class MigrationAssessmentResponse {
  ...
  final pulumi.Input<List<MigrationAssessmentResponseServerAssessments>>
  serverAssessments;
    ...
    return <String, dynamic>{
      ...
      'serverAssessments':
          pulumi.Input.mapInputValue<
            List<MigrationAssessmentResponseServerAssessments>,
      ...
      'skuRecommendationResults':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(skuRecommendationResults, (value) => value.toMap()),
    };
  }
  ...
  factory MigrationAssessmentResponse.fromMap(Map<String, dynamic> map) {
    return MigrationAssessmentResponse(
      ...
      serverAssessments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MigrationAssessmentResponseServerAssessments>(
          map['serverAssessments']!,
          (value) => MigrationAssessmentResponseServerAssessments.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      skuRecommendationResults: pulumi.Input.fromValue(
        SkuRecommendationResultsResponse.fromMap(
          (map['skuRecommendationResults']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
