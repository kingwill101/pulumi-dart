...
class K8sSchedulingOptions {
  ...
  factory K8sSchedulingOptions.fromMap(Map<String, dynamic> map) {
    return K8sSchedulingOptions(
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(K8sResourceRequirements.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
