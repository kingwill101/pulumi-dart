...
class SqlServerInstanceJobStatusResponse {
  ...
  factory SqlServerInstanceJobStatusResponse.fromMap(Map<String, dynamic> map) {
    return SqlServerInstanceJobStatusResponse(
      backgroundJob: (() { final guardedValue = map['backgroundJob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackgroundJobResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      jobException: (() { final guardedValue = map['jobException']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      sequencerActions: (() { final guardedValue = map['sequencerActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SequencerActionResponse>(guardedValue, (value) => SequencerActionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
