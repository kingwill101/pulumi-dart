...
class SqlServerAvailabilityGroupResourcePropertiesResponse {
  ...
  factory SqlServerAvailabilityGroupResourcePropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return SqlServerAvailabilityGroupResourcePropertiesResponse(
      availabilityGroupId: pulumi.Input.fromValue(
        map['availabilityGroupId'] as String,
      ),
      collectionTimestamp: pulumi.Input.fromValue(
        map['collectionTimestamp'] as String,
      ),
      databases: (() {
        final guardedValue = map['databases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlServerAvailabilityGroupResourcePropertiesResponseDatabases.fromMap(
      ...
      info: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AvailabilityGroupInfoResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      replicas: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlServerAvailabilityGroupResourcePropertiesResponseReplicas.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
