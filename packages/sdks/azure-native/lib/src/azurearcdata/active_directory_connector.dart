...
class ActiveDirectoryConnector extends pulumi.CustomResource {
  ...
  ActiveDirectoryConnector(
    ...
    properties = registerOutput<ActiveDirectoryConnectorPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ActiveDirectoryConnectorPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ActiveDirectoryConnector] resource.
  ActiveDirectoryConnector.reference(String urn)
    : super(
        'azure-native:azurearcdata:ActiveDirectoryConnector',
