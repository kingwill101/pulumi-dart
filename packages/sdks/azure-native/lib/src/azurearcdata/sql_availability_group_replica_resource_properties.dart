...
class SqlAvailabilityGroupReplicaResourceProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'configure': ?pulumi.Input.mapOptionalInputValue<AvailabilityGroupConfigure, Map<String, dynamic>>(configure, (value) => value.toMap()),
  ...
  factory SqlAvailabilityGroupReplicaResourceProperties.fromMap(Map<String, dynamic> map) {
    return SqlAvailabilityGroupReplicaResourceProperties(
      configure: (() { final guardedValue = map['configure']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AvailabilityGroupConfigure.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
