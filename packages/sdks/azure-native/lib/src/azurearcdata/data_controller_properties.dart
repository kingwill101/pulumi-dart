...
class DataControllerProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'infrastructure':
          ?pulumi.Input.mapOptionalInputValue<Infrastructure, String>(
            infrastructure,
  ...
  factory DataControllerProperties.fromMap(Map<String, dynamic> map) {
    return DataControllerProperties(
      ...
      infrastructure: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Infrastructure.fromValue(guardedValue as String),
        );
      })(),
      k8sRaw: (() {
      ...
      logAnalyticsWorkspaceConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LogAnalyticsWorkspaceConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      uploadServicePrincipal: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UploadServicePrincipal.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
