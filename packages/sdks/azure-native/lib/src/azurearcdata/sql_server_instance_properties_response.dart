...
class SqlServerInstancePropertiesResponse {
  ...
  factory SqlServerInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SqlServerInstancePropertiesResponse(
      ...
      azureDefenderStatus: pulumi.Input.fromValue(map['azureDefenderStatus'] as String),
      azureDefenderStatusLastUpdated: pulumi.Input.fromValue(map['azureDefenderStatusLastUpdated'] as String),
      ...
      clientConnection: (() { final guardedValue = map['clientConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClientConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      collation: pulumi.Input.fromValue(map['collation'] as String),
      containerResourceId: pulumi.Input.fromValue(map['containerResourceId'] as String),
      ...
      databaseMirroringEndpoint: (() { final guardedValue = map['databaseMirroringEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DBMEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dbMasterKeyExists: pulumi.Input.fromValue(map['dbMasterKeyExists'] as bool),
      ...
      failoverCluster: (() { final guardedValue = map['failoverCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FailoverClusterResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      isDigiCertPkiCertTrustConfigured: pulumi.Input.fromValue(map['isDigiCertPkiCertTrustConfigured'] as bool),
      isHadrEnabled: pulumi.Input.fromValue(map['isHadrEnabled'] as bool),
      isMicrosoftPkiCertTrustConfigured: pulumi.Input.fromValue(map['isMicrosoftPkiCertTrustConfigured'] as bool),
      ...
      traceFlags: pulumi.Input.fromValue((map['traceFlags'] as List).cast<int>()),
