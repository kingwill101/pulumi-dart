...
class K8sScheduling {
  ...
  factory K8sScheduling.fromMap(Map<String, dynamic> map) {
    return K8sScheduling(
      default_: (() { final guardedValue = map['default']; if (guardedValue == null) return null; return pulumi.Input.fromValue(K8sSchedulingOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
