...
class SqlServerDatabaseResourcePropertiesResponse {
  ...
  factory SqlServerDatabaseResourcePropertiesResponse.fromMap(
    ...
    return SqlServerDatabaseResourcePropertiesResponse(
      backupInformation: (() {
        ...
        return pulumi.Input.fromValue(
          SqlServerDatabaseResourcePropertiesResponseBackupInformation.fromMap(
      ...
      databaseOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlServerDatabaseResourcePropertiesResponseDatabaseOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      lastDatabaseUploadTime: pulumi.Input.fromValue(
        map['lastDatabaseUploadTime'] as String,
      ),
      logFileSizeMB: (() {
      ...
      migration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataBaseMigrationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
