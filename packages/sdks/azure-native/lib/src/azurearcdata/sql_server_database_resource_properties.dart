...
class SqlServerDatabaseResourceProperties {
  final pulumi.Input<SqlServerDatabaseResourcePropertiesBackupInformation>?
  backupInformation;
  ...
  final pulumi.Input<SqlServerDatabaseResourcePropertiesDatabaseOptions>?
  databaseOptions;
    ...
    return <String, dynamic>{
      'backupInformation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(backupInformation, (value) => value.toMap()),
      'backupPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            BackupPolicy,
            Map<String, dynamic>
      ...
      'databaseOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(databaseOptions, (value) => value.toMap()),
  ...
  factory SqlServerDatabaseResourceProperties.fromMap(
    Map<String, dynamic> map,
  ) {
    return SqlServerDatabaseResourceProperties(
      backupInformation: (() {
        final guardedValue = map['backupInformation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlServerDatabaseResourcePropertiesBackupInformation.fromMap(
      ...
      collationName: (() {
        final guardedValue = map['collationName'];
        if (guardedValue == null) return null;
      ...
      databaseCreationDate: (() {
        final guardedValue = map['databaseCreationDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      databaseOptions: (() {
        final guardedValue = map['databaseOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlServerDatabaseResourcePropertiesDatabaseOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      recoveryMode: (() {
        final guardedValue = map['recoveryMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      restorePointInTime: (() {
      ...
      spaceAvailableMB: (() {
        final guardedValue = map['spaceAvailableMB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      state: (() {
