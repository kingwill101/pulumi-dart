...
class SqlServerAvailabilityGroupResourcePropertiesResponseReplicas {
  ...
  final pulumi.Input<
    List<SqlAvailabilityGroupReplicaResourcePropertiesResponse>
  >?
  value;
  ...
  factory SqlServerAvailabilityGroupResourcePropertiesResponseReplicas.fromMap(
      ...
      value: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SqlAvailabilityGroupReplicaResourcePropertiesResponse.fromMap(
