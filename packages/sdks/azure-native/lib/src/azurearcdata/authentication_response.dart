...
class AuthenticationResponse {
  ...
  AuthenticationResponse({this.mode, this.sqlServerEntraIdentity});
    ...
    return <String, dynamic>{
      ...
      'sqlServerEntraIdentity':
          ?pulumi.Input.mapOptionalInputValue<
            List<EntraAuthenticationResponse>,
  ...
  factory AuthenticationResponse.fromMap(Map<String, dynamic> map) {
    return AuthenticationResponse(
      ...
      sqlServerEntraIdentity: (() {
        final guardedValue = map['sqlServerEntraIdentity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EntraAuthenticationResponse>(
            guardedValue,
            (value) => EntraAuthenticationResponse.fromMap(
