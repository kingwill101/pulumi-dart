...
class MigrationAssessmentResponseServerAssessments {
  ...
  final pulumi.Input<List<MigrationAssessmentResponseImpactedObjects>>?
  impactedObjects;
    ...
    return <String, dynamic>{
      ...
      'impactedObjects':
          ?pulumi.Input.mapOptionalInputValue<
            List<MigrationAssessmentResponseImpactedObjects>,
  ...
  factory MigrationAssessmentResponseServerAssessments.fromMap(
    ...
    return MigrationAssessmentResponseServerAssessments(
      ...
      impactedObjects: (() {
        final guardedValue = map['impactedObjects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MigrationAssessmentResponseImpactedObjects>(
            guardedValue,
            (value) => MigrationAssessmentResponseImpactedObjects.fromMap(
