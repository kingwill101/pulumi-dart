...
class FailoverGroupSpecResponse {
  ...
  factory FailoverGroupSpecResponse.fromMap(Map<String, dynamic> map) {
    return FailoverGroupSpecResponse(
      partnerMI: (() {
        final guardedValue = map['partnerMI'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      partnerMirroringCert: (() {
        final guardedValue = map['partnerMirroringCert'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      partnerMirroringURL: (() {
        final guardedValue = map['partnerMirroringURL'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      partnerSyncMode: (() {
        final guardedValue = map['partnerSyncMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      role: pulumi.Input.fromValue(map['role'] as String),
      sharedName: (() {
        final guardedValue = map['sharedName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceMI: (() {
        final guardedValue = map['sourceMI'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
