...
import 'postgres_instance_sku_tier.dart';
...
class PostgresInstanceSku {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'size': ?size,
      'tier': ?pulumi.Input.mapOptionalInputValue<PostgresInstanceSkuTier, String>(tier, (value) => value.wireValue),
    };
  }
  ...
  factory PostgresInstanceSku.fromMap(Map<String, dynamic> map) {
    return PostgresInstanceSku(
      ...
      tier: (() { final guardedValue = map['tier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PostgresInstanceSkuTier.fromValue(guardedValue as String)); })(),
    );
  }
}
