...
class K8sSettings {
  ...
  factory K8sSettings.fromMap(Map<String, dynamic> map) {
    return K8sSettings(
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(K8sNetworkSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
