...
class SqlServerAvailabilityGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SqlServerAvailabilityGroupResourcePropertiesResponse>
  properties;
  ...
  SqlServerAvailabilityGroup(
    ...
    properties =
        registerOutput<SqlServerAvailabilityGroupResourcePropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return SqlServerAvailabilityGroupResourcePropertiesResponse.fromMap(
