...
class SkuRecommendationResultsResponse {
  ...
  final pulumi.Input<SkuRecommendationResultsAzureSqlDatabaseResponse>?
  azureSqlDatabase;

  /// SKU Recommendation results for Azure SQL Managed Instance.
  final pulumi.Input<SkuRecommendationResultsAzureSqlManagedInstanceResponse>?
  azureSqlManagedInstance;

  /// SKU Recommendation results for Azure SQL Virtual Machine.
  final pulumi.Input<SkuRecommendationResultsAzureSqlVirtualMachineResponse>?
    ...
    return <String, dynamic>{
      'azureSqlDatabase':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(azureSqlDatabase, (value) => value.toMap()),
      'azureSqlManagedInstance':
          ?pulumi.Input.mapOptionalInputValue<
            SkuRecommendationResultsAzureSqlManagedInstanceResponse,
            Map<String, dynamic>
          >(azureSqlManagedInstance, (value) => value.toMap()),
      'azureSqlVirtualMachine':
          ?pulumi.Input.mapOptionalInputValue<
            SkuRecommendationResultsAzureSqlVirtualMachineResponse,
            Map<String, dynamic>
          >(azureSqlVirtualMachine, (value) => value.toMap()),
    };
  }
  ...
  factory SkuRecommendationResultsResponse.fromMap(Map<String, dynamic> map) {
    return SkuRecommendationResultsResponse(
      azureSqlDatabase: (() {
        final guardedValue = map['azureSqlDatabase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SkuRecommendationResultsAzureSqlDatabaseResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      azureSqlManagedInstance: (() {
        final guardedValue = map['azureSqlManagedInstance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SkuRecommendationResultsAzureSqlManagedInstanceResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      azureSqlVirtualMachine: (() {
        final guardedValue = map['azureSqlVirtualMachine'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SkuRecommendationResultsAzureSqlVirtualMachineResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
