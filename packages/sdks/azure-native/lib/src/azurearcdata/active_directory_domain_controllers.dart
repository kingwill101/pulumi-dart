...
class ActiveDirectoryDomainControllers {
  ...
  /// null
  final pulumi.Input<List<ActiveDirectoryDomainController>>?
    ...
    return ActiveDirectoryDomainControllers(
      primaryDomainController: (() {
        ...
        return pulumi.Input.fromValue(
          ActiveDirectoryDomainController.fromMap(
      ...
      secondaryDomainControllers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ActiveDirectoryDomainController>(
            guardedValue,
            (value) => ActiveDirectoryDomainController.fromMap(
