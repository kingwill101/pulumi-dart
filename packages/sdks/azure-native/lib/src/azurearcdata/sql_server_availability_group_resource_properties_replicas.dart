...
class SqlServerAvailabilityGroupResourcePropertiesReplicas {
  ...
  final pulumi.Input<List<SqlAvailabilityGroupReplicaResourceProperties>>?
  value;

  /// Creates a new [SqlServerAvailabilityGroupResourcePropertiesReplicas].
  /// [value] Array of Availability Group Replicas.
  SqlServerAvailabilityGroupResourcePropertiesReplicas({this.value});
  ...
  factory SqlServerAvailabilityGroupResourcePropertiesReplicas.fromMap(
    ...
    return SqlServerAvailabilityGroupResourcePropertiesReplicas(
      value: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<SqlAvailabilityGroupReplicaResourceProperties>(
            guardedValue,
            (value) => SqlAvailabilityGroupReplicaResourceProperties.fromMap(
