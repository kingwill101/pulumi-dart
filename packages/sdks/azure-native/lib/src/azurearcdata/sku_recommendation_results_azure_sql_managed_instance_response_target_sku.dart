...
class SkuRecommendationResultsAzureSqlManagedInstanceResponseTargetSku {
  ...
  factory SkuRecommendationResultsAzureSqlManagedInstanceResponseTargetSku.fromMap(
    ...
    return SkuRecommendationResultsAzureSqlManagedInstanceResponseTargetSku(
      category: (() {
        ...
        return pulumi.Input.fromValue(
          SkuRecommendationResultsAzureSqlManagedInstanceResponseCategory.fromMap(
