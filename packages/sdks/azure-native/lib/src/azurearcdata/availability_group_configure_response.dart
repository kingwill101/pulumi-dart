...
class AvailabilityGroupConfigureResponse {
  ...
  factory AvailabilityGroupConfigureResponse.fromMap(Map<String, dynamic> map) {
    return AvailabilityGroupConfigureResponse(
      ...
      availabilityModeDescription: pulumi.Input.fromValue(
        map['availabilityModeDescription'] as String,
      ),
      backupPriority: (() {
      ...
      failoverModeDescription: pulumi.Input.fromValue(
        map['failoverModeDescription'] as String,
      ),
      ...
      primaryRoleAllowConnectionsDescription: pulumi.Input.fromValue(
        map['primaryRoleAllowConnectionsDescription'] as String,
      ),
      readOnlyRoutingUrl: (() {
      ...
      replicaCreateDate: pulumi.Input.fromValue(
        map['replicaCreateDate'] as String,
      ),
      replicaModifyDate: pulumi.Input.fromValue(
        map['replicaModifyDate'] as String,
      ),
      ...
      secondaryRoleAllowConnectionsDescription: pulumi.Input.fromValue(
        map['secondaryRoleAllowConnectionsDescription'] as String,
      ),
      seedingMode: (() {
      ...
      seedingModeDescription: pulumi.Input.fromValue(
        map['seedingModeDescription'] as String,
      ),
      sessionTimeout: (() {
