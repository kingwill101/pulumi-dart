...
class SqlServerAvailabilityGroupResourcePropertiesDatabases {
  ...
  SqlServerAvailabilityGroupResourcePropertiesDatabases({this.value});
  ...
  factory SqlServerAvailabilityGroupResourcePropertiesDatabases.fromMap(
      ...
      value: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                SqlAvailabilityGroupDatabaseReplicaResourceProperties.fromMap(
