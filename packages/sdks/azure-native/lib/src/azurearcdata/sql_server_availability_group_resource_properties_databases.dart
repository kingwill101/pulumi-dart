...
class SqlServerAvailabilityGroupResourcePropertiesDatabases {
  ...
  factory SqlServerAvailabilityGroupResourcePropertiesDatabases.fromMap(Map<String, dynamic> map) {
    return SqlServerAvailabilityGroupResourcePropertiesDatabases(
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SqlAvailabilityGroupDatabaseReplicaResourceProperties>(guardedValue, (value) => SqlAvailabilityGroupDatabaseReplicaResourceProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
