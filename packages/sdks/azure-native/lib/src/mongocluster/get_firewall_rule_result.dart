...
class GetFirewallRuleResult {
  ...
  final FirewallRulePropertiesResponse? properties;
  ...
  factory GetFirewallRuleResult.fromMap(Map<String, dynamic> map) {
    return GetFirewallRuleResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return FirewallRulePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
