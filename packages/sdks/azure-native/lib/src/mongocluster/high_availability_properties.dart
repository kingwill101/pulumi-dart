...
class HighAvailabilityProperties {
  ...
  final pulumi.Input<dynamic>? targetMode;
  ...
  factory HighAvailabilityProperties.fromMap(Map<String, dynamic> map) {
    return HighAvailabilityProperties(
      targetMode: (() { final guardedValue = map['targetMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
