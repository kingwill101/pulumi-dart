...
class MongoClusterPropertiesResponse {
    ...
    return <String, dynamic>{
      'administrator':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(administrator, (value) => value.toMap()),
      'backup':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'replica':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(replica, (value) => value.toMap()),
      'serverVersion': ?serverVersion,
      'sharding':
          ?pulumi.Input.mapOptionalInputValue<
            ShardingPropertiesResponse,
            Map<String, dynamic>
          >(sharding, (value) => value.toMap()),
      'storage':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory MongoClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MongoClusterPropertiesResponse(
      administrator: (() {
        final guardedValue = map['administrator'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AdministratorPropertiesResponse.fromMap(
      ...
      backup: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackupPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      compute: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      highAvailability: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HighAvailabilityPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      infrastructureVersion: pulumi.Input.fromValue(
        map['infrastructureVersion'] as String,
      ),
      previewFeatures: (() {
      ...
      replica: pulumi.Input.fromValue(
        ReplicationPropertiesResponse.fromMap(
          (map['replica']! as Map).cast<String, dynamic>(),
        ),
      ),
      serverVersion: (() {
      ...
      sharding: (() {
        final guardedValue = map['sharding'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ShardingPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      storage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StoragePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
