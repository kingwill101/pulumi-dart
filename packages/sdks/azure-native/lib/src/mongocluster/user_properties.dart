...
class UserProperties {
  ...
  UserProperties({this.identityProvider, this.roles});
    ...
    return <String, dynamic>{
      ...
      'roles':
          ...
          >(
            roles,
            (value) =>
                pulumi.Input.encodeList<DatabaseRole, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory UserProperties.fromMap(Map<String, dynamic> map) {
    return UserProperties(
      ...
      roles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseRole>(
            guardedValue,
            (value) =>
                DatabaseRole.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
