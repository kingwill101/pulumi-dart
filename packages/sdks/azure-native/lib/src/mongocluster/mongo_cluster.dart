...
class MongoCluster extends pulumi.CustomResource {
  ...
  MongoCluster(
    ...
    properties = registerOutput<MongoClusterPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MongoClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
