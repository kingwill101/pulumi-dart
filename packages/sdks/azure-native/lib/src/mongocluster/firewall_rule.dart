...
/// }
///
/// resource "azure-native_mongocluster_firewallrule" "firewallRule" {
...
class FirewallRule extends pulumi.CustomResource {
  ...
  FirewallRule(
    ...
    properties = registerOutput<FirewallRulePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FirewallRulePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
