...
class GetMongoClusterResult {
  ...
  final MongoClusterPropertiesResponse? properties;
  ...
  factory GetMongoClusterResult.fromMap(Map<String, dynamic> map) {
    return GetMongoClusterResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return MongoClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
