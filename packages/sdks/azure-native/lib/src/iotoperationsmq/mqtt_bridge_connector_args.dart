...
class MqttBridgeConnectorArgs {
  ...
  final pulumi.Input<MqttBridgeRemoteBrokerConnectionSpec>
    ...
    return <String, dynamic>{
      ...
      'remoteBrokerConnection':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(remoteBrokerConnection, (value) => value.toMap()),
  ...
  factory MqttBridgeConnectorArgs.fromMap(Map<String, dynamic> map) {
    return MqttBridgeConnectorArgs(
      bridgeInstances: (() {
        final guardedValue = map['bridgeInstances'];
      ...
      mqttBridgeConnectorName: (() {
        final guardedValue = map['mqttBridgeConnectorName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nodeTolerations: (() {
      ...
      remoteBrokerConnection: pulumi.Input.fromValue(
        MqttBridgeRemoteBrokerConnectionSpec.fromMap(
          (map['remoteBrokerConnection']! as Map).cast<String, dynamic>(),
        ),
      ),
