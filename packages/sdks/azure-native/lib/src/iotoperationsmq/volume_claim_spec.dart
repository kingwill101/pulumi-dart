...
import 'volume_claim_data_source.dart';
import 'volume_claim_data_source_ref.dart';
...
class VolumeClaimSpec {
  ...
  final pulumi.Input<VolumeClaimDataSource>? dataSource;
  ...
  final pulumi.Input<VolumeClaimDataSourceRef>? dataSourceRef;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSource': ?pulumi.Input.mapOptionalInputValue<VolumeClaimDataSource, Map<String, dynamic>>(dataSource, (value) => value.toMap()),
      'dataSourceRef': ?pulumi.Input.mapOptionalInputValue<VolumeClaimDataSourceRef, Map<String, dynamic>>(dataSourceRef, (value) => value.toMap()),
  ...
  factory VolumeClaimSpec.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpec(
      ...
      dataSource: (() { final guardedValue = map['dataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimDataSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceRef: (() { final guardedValue = map['dataSourceRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimDataSourceRef.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
