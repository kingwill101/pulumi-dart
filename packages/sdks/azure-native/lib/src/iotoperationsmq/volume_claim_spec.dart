...
class VolumeClaimSpec {
  ...
  final VolumeClaimDataSource? dataSource;
  ...
  final VolumeClaimDataSourceRef? dataSourceRef;
  ...
  factory VolumeClaimSpec.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpec(
      ...
      dataSource: map['dataSource'] == null ? null : VolumeClaimDataSource.fromMap((map['dataSource'] as Map).cast<String, dynamic>()),
      dataSourceRef: map['dataSourceRef'] == null ? null : VolumeClaimDataSourceRef.fromMap((map['dataSourceRef'] as Map).cast<String, dynamic>()),
