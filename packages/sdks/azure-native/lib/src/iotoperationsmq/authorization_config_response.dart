...
class AuthorizationConfigResponse {
  ...
  AuthorizationConfigResponse({this.enableCache, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AuthorizationBasicRuleResponse>,
  ...
  factory AuthorizationConfigResponse.fromMap(Map<String, dynamic> map) {
    return AuthorizationConfigResponse(
      enableCache: (() {
        final guardedValue = map['enableCache'];
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorizationBasicRuleResponse>(
            guardedValue,
            (value) => AuthorizationBasicRuleResponse.fromMap(
