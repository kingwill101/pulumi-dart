...
class AuthorizationConfig {
  ...
  AuthorizationConfig({this.enableCache, this.rules});
    ...
    return AuthorizationConfig(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorizationBasicRule>(
            guardedValue,
            (value) => AuthorizationBasicRule.fromMap(
