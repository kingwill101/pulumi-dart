...
class DataLakeFabricStorageResponse {
  ...
  final pulumi.Input<DataLakeFabricStorageAuthenticationResponse>
  authentication;
  ...
  factory DataLakeFabricStorageResponse.fromMap(Map<String, dynamic> map) {
    return DataLakeFabricStorageResponse(
      authentication: pulumi.Input.fromValue(
        DataLakeFabricStorageAuthenticationResponse.fromMap(
