...
class Cardinality {
  ...
  Cardinality({required this.backendChain, required this.frontend});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backendChain':
          pulumi.Input.mapInputValue<BackendChain, Map<String, dynamic>>(
            backendChain,
            (value) => value.toMap(),
          ),
      'frontend': pulumi.Input.mapInputValue<Frontend, Map<String, dynamic>>(
        frontend,
        (value) => value.toMap(),
      ),
    };
  ...
  factory Cardinality.fromMap(Map<String, dynamic> map) {
    return Cardinality(
      backendChain: pulumi.Input.fromValue(
        BackendChain.fromMap(
          (map['backendChain']! as Map).cast<String, dynamic>(),
        ),
      ),
      frontend: pulumi.Input.fromValue(
        Frontend.fromMap((map['frontend']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
