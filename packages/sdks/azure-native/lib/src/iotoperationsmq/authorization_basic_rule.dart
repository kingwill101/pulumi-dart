...
class AuthorizationBasicRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'principals':
          pulumi.Input.mapInputValue<PrincipalDefinition, Map<String, dynamic>>(
            principals,
            (value) => value.toMap(),
          ),
    };
  ...
  factory AuthorizationBasicRule.fromMap(Map<String, dynamic> map) {
    return AuthorizationBasicRule(
      brokerResources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ResourceInfoDefinition>(
          map['brokerResources']!,
          (value) => ResourceInfoDefinition.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      principals: pulumi.Input.fromValue(
        PrincipalDefinition.fromMap(
