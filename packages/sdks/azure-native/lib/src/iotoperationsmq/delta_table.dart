...
class DeltaTable {
  ...
  DeltaTable({required this.schema, required this.tableName, this.tablePath});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'schema':
          pulumi.Input.mapInputValue<
            List<DeltaTableSchema>,
            List<Map<String, dynamic>>
          >(
            schema,
            (value) =>
                pulumi.Input.encodeList<DeltaTableSchema, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DeltaTable.fromMap(Map<String, dynamic> map) {
    return DeltaTable(
      schema: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeltaTableSchema>(
          map['schema']!,
          (value) =>
              DeltaTableSchema.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
