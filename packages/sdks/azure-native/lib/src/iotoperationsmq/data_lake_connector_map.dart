...
class DataLakeConnectorMap {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'qos': ?qos,
      'table': pulumi.Input.mapInputValue<DeltaTable, Map<String, dynamic>>(
        table,
        (value) => value.toMap(),
      ),
    };
  ...
  factory DataLakeConnectorMap.fromMap(Map<String, dynamic> map) {
    return DataLakeConnectorMap(
      allowedLatencySecs: pulumi.Input.fromValue(
        map['allowedLatencySecs'] as int,
      ),
      clientId: pulumi.Input.fromValue(map['clientId'] as String),
      maxMessagesPerBatch: pulumi.Input.fromValue(
        map['maxMessagesPerBatch'] as double,
      ),
      messagePayloadType: pulumi.Input.fromValue(
        map['messagePayloadType'] as String,
      ),
      ...
      table: pulumi.Input.fromValue(
        DeltaTable.fromMap((map['table']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
