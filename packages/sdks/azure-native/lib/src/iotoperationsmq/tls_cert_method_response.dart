...
class TlsCertMethodResponse {
  ...
  final AutomaticCertMethodResponse? automatic;
  ...
  final ManualCertMethodResponse? manual;
  ...
  factory TlsCertMethodResponse.fromMap(Map<String, dynamic> map) {
    return TlsCertMethodResponse(
      automatic: map['automatic'] == null ? null : AutomaticCertMethodResponse.fromMap((map['automatic'] as Map).cast<String, dynamic>()),
      keyVault: map['keyVault'] == null ? null : KeyVaultCertificatePropertiesResponse.fromMap((map['keyVault'] as Map).cast<String, dynamic>()),
      manual: map['manual'] == null ? null : ManualCertMethodResponse.fromMap((map['manual'] as Map).cast<String, dynamic>()),
    );
  }
}
