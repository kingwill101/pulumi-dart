  ...
  factory DataLakeFabricStorage.fromMap(Map<String, dynamic> map) {
    return DataLakeFabricStorage(
      authentication: pulumi.Input.fromValue(
        DataLakeFabricStorageAuthentication.fromMap(
      ...
      guids: (() {
        final guardedValue = map['guids'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FabricGuids.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      names: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FabricNames.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
