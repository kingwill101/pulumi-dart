...
class MqttBridgeRemoteBrokerConnectionSpecResponse {
  ...
  final pulumi.Input<MqttBridgeRemoteBrokerAuthenticationMethodsResponse>
  authentication;
  ...
  factory MqttBridgeRemoteBrokerConnectionSpecResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return MqttBridgeRemoteBrokerConnectionSpecResponse(
      authentication: pulumi.Input.fromValue(
        MqttBridgeRemoteBrokerAuthenticationMethodsResponse.fromMap(
      ...
      tls: pulumi.Input.fromValue(
        MqttBridgeRemoteBrokerConnectionTlsResponse.fromMap(
