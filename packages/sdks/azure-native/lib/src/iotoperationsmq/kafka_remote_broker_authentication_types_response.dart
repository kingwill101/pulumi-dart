...
class KafkaRemoteBrokerAuthenticationTypesResponse {
  ...
  const KafkaRemoteBrokerAuthenticationTypesResponse({
    this.sasl,
  ...
  factory KafkaRemoteBrokerAuthenticationTypesResponse.fromMap(Map<String, dynamic> map) {
    return KafkaRemoteBrokerAuthenticationTypesResponse(
      sasl: (() { final guardedValue = map['sasl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SaslRemoteBrokerBasicAuthenticationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      x509: (() { final guardedValue = map['x509']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KafkaX509AuthenticationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
