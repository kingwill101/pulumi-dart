...
class BrokerArgs {
  ...
  final pulumi.Input<DiskBackedMessageBufferSettings>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authImage':
          pulumi.Input.mapInputValue<ContainerImage, Map<String, dynamic>>(
            authImage,
            (value) => value.toMap(),
          ),
      'brokerImage':
      ...
      'brokerNodeTolerations':
          ?pulumi.Input.mapOptionalInputValue<
            NodeTolerations,
            Map<String, dynamic>
          >(brokerNodeTolerations, (value) => value.toMap()),
      'cardinality':
          ?pulumi.Input.mapOptionalInputValue<
            Cardinality,
            Map<String, dynamic>
      ...
      'diskBackedMessageBufferSettings':
          ?pulumi.Input.mapOptionalInputValue<
            DiskBackedMessageBufferSettings,
            Map<String, dynamic>
          >(diskBackedMessageBufferSettings, (value) => value.toMap()),
      ...
      'healthManagerNodeTolerations':
          ?pulumi.Input.mapOptionalInputValue<
            NodeTolerations,
            Map<String, dynamic>
          >(healthManagerNodeTolerations, (value) => value.toMap()),
      'internalCerts':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory BrokerArgs.fromMap(Map<String, dynamic> map) {
    return BrokerArgs(
      authImage: pulumi.Input.fromValue(
        ContainerImage.fromMap(
          (map['authImage']! as Map).cast<String, dynamic>(),
        ),
      ),
      brokerImage: pulumi.Input.fromValue(
        ContainerImage.fromMap(
      ...
      diskBackedMessageBufferSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiskBackedMessageBufferSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      healthManagerImage: pulumi.Input.fromValue(
        ContainerImage.fromMap(
