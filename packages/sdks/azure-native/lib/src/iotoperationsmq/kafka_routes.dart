...
class KafkaRoutes {
  ...
  factory KafkaRoutes.fromMap(Map<String, dynamic> map) {
    return KafkaRoutes(
      kafkaToMqtt: (() { final guardedValue = map['kafkaToMqtt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KafkaToMqttRoutes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mqttToKafka: (() { final guardedValue = map['mqttToKafka']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MqttToKafkaRoutes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
