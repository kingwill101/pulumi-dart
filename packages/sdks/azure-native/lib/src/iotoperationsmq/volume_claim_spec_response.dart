    ...
    return VolumeClaimSpecResponse(
      ...
      dataSource: (() {
        ...
        return pulumi.Input.fromValue(
          VolumeClaimDataSourceResponse.fromMap(
      ...
      dataSourceRef: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeClaimDataSourceRefResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeClaimResourceRequirementsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      selector: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeClaimSpecSelectorResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
