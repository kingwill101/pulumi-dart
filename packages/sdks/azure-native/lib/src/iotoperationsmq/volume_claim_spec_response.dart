...
import 'volume_claim_data_source_ref_response.dart';
import 'volume_claim_data_source_response.dart';
...
class VolumeClaimSpecResponse {
  ...
  final pulumi.Input<VolumeClaimDataSourceResponse>? dataSource;
  ...
  final pulumi.Input<VolumeClaimDataSourceRefResponse>? dataSourceRef;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSource': ?pulumi.Input.mapOptionalInputValue<VolumeClaimDataSourceResponse, Map<String, dynamic>>(dataSource, (value) => value.toMap()),
      'dataSourceRef': ?pulumi.Input.mapOptionalInputValue<VolumeClaimDataSourceRefResponse, Map<String, dynamic>>(dataSourceRef, (value) => value.toMap()),
  ...
  factory VolumeClaimSpecResponse.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpecResponse(
      ...
      dataSource: (() { final guardedValue = map['dataSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimDataSourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceRef: (() { final guardedValue = map['dataSourceRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimDataSourceRefResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimResourceRequirementsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      selector: (() { final guardedValue = map['selector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeClaimSpecSelectorResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
