...
class VolumeClaimSpecResponse {
  ...
  factory VolumeClaimSpecResponse.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpecResponse(
      ...
      dataSource: map['dataSource'] == null ? null : (VolumeClaimDataSourceResponse.fromMap((map['dataSource']! as Map).cast<String, dynamic>())).input(),
      dataSourceRef: map['dataSourceRef'] == null ? null : (VolumeClaimDataSourceRefResponse.fromMap((map['dataSourceRef']! as Map).cast<String, dynamic>())).input(),
