...
class DiagnosticServiceArgs {
  ...
  DiagnosticServiceArgs({
    pulumi.Input<int?>? dataExportFrequencySeconds,
    ...
    pulumi.Input<double?>? maxDataStorageSize,
    pulumi.Input<int?>? metricsPort,
    required this.mqName,
    this.openTelemetryTracesCollectorAddr,
    required this.resourceGroupName,
    pulumi.Input<int?>? staleDataTimeoutSeconds,
    this.tags,
  }) : dataExportFrequencySeconds = dataExportFrequencySeconds ?? pulumi.Input.fromValue(10), logFormat = logFormat ?? pulumi.Input.fromValue('json'), logLevel = logLevel ?? pulumi.Input.fromValue('info'), maxDataStorageSize = maxDataStorageSize ?? pulumi.Input.fromValue(16), metricsPort = metricsPort ?? pulumi.Input.fromValue(9600), staleDataTimeoutSeconds = staleDataTimeoutSeconds ?? pulumi.Input.fromValue(600);
  ...
  factory DiagnosticServiceArgs.fromMap(Map<String, dynamic> map) {
    return DiagnosticServiceArgs(
      dataExportFrequencySeconds: (() { final guardedValue = map['dataExportFrequencySeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      maxDataStorageSize: (() { final guardedValue = map['maxDataStorageSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      metricsPort: (() { final guardedValue = map['metricsPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      staleDataTimeoutSeconds: (() { final guardedValue = map['staleDataTimeoutSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
