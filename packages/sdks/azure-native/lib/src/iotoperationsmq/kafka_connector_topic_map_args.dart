...
class KafkaConnectorTopicMapArgs {
    ...
    return <String, dynamic>{
      ...
      'routes':
          ...
          >(
            routes,
            (value) =>
                pulumi.Input.encodeList<KafkaRoutes, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory KafkaConnectorTopicMapArgs.fromMap(Map<String, dynamic> map) {
    return KafkaConnectorTopicMapArgs(
      ...
      kafkaConnectorRef: pulumi.Input.fromValue(
        map['kafkaConnectorRef'] as String,
      ),
      location: (() {
      ...
      routes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<KafkaRoutes>(
          map['routes']!,
          (value) =>
              KafkaRoutes.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      tags: (() {
