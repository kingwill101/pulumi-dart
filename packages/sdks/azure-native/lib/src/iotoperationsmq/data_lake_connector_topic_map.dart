...
class DataLakeConnectorTopicMap extends pulumi.CustomResource {
  ...
  DataLakeConnectorTopicMap(
    ...
    mapping = registerOutput<DataLakeConnectorMapResponse>('mapping', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DataLakeConnectorMapResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [DataLakeConnectorTopicMap] resource.
  DataLakeConnectorTopicMap.reference(String urn)
    : super(
        'azure-native:iotoperationsmq:DataLakeConnectorTopicMap',
