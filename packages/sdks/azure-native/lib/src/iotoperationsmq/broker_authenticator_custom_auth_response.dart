...
class BrokerAuthenticatorCustomAuthResponse {
  ...
  const BrokerAuthenticatorCustomAuthResponse({
    required this.x509,
  });
  ...
  factory BrokerAuthenticatorCustomAuthResponse.fromMap(Map<String, dynamic> map) {
    return BrokerAuthenticatorCustomAuthResponse(
      x509: pulumi.Input.fromValue(BrokerAuthenticatorCustomAuthX509Response.fromMap((map['x509']! as Map).cast<String, dynamic>())),
    );
  }
}
