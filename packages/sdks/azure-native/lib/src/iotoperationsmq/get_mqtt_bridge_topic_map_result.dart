...
class GetMqttBridgeTopicMapResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routes': ?routes == null ? null : pulumi.Input.encodeList<MqttBridgeRoutesResponse, Map<String, dynamic>>(routes!, (value) => value.toMap()),
  ...
  factory GetMqttBridgeTopicMapResult.fromMap(Map<String, dynamic> map) {
    return GetMqttBridgeTopicMapResult(
      ...
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<MqttBridgeRoutesResponse>(map['routes'], (value) => MqttBridgeRoutesResponse.fromMap((value as Map).cast<String, dynamic>())),
