...
class GetMqttBridgeTopicMapResult {
  ...
  const GetMqttBridgeTopicMapResult({
    this.azureApiVersion,
    this.extendedLocation,
    this.id,
    this.location,
    this.mqttBridgeConnectorRef,
    this.name,
  ...
  factory GetMqttBridgeTopicMapResult.fromMap(Map<String, dynamic> map) {
    return GetMqttBridgeTopicMapResult(
      ...
      mqttBridgeConnectorRef: (() { final guardedValue = map['mqttBridgeConnectorRef']; if (guardedValue == null) return null; return guardedValue as String; })(),
