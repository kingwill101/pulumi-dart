...
class AuthorizationBasicRuleResponse {
  ...
  factory AuthorizationBasicRuleResponse.fromMap(Map<String, dynamic> map) {
    return AuthorizationBasicRuleResponse(
      brokerResources: (pulumi.Input.decodeList<ResourceInfoDefinitionResponse>(map['brokerResources'], (value) => ResourceInfoDefinitionResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
