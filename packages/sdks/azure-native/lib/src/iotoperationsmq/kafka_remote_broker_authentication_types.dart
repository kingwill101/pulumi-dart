...
class KafkaRemoteBrokerAuthenticationTypes {
  ...
  factory KafkaRemoteBrokerAuthenticationTypes.fromMap(Map<String, dynamic> map) {
    return KafkaRemoteBrokerAuthenticationTypes(
      sasl: (() { final guardedValue = map['sasl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SaslRemoteBrokerBasicAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      x509: (() { final guardedValue = map['x509']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KafkaX509Authentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
