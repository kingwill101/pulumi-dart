...
class Endpoint {
  ...
  final pulumi.Input<dynamic>? alwaysServe;
  ...
  final pulumi.Input<dynamic>? endpointMonitorStatus;
  /// The status of the endpoint. If the endpoint is Enabled, it is probed for endpoint health and is included in the traffic routing method.
  final pulumi.Input<dynamic>? endpointStatus;
  ...
  factory Endpoint.fromMap(Map<String, dynamic> map) {
    return Endpoint(
      alwaysServe: (() { final guardedValue = map['alwaysServe']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      endpointMonitorStatus: (() { final guardedValue = map['endpointMonitorStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      endpointStatus: (() { final guardedValue = map['endpointStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
