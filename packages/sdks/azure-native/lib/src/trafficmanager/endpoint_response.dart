...
class EndpointResponse {
  ...
  factory EndpointResponse.fromMap(Map<String, dynamic> map) {
    return EndpointResponse(
      ...
      customHeaders: (() { final guardedValue = map['customHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointPropertiesCustomHeadersItemResponse>(guardedValue, (value) => EndpointPropertiesCustomHeadersItemResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      minChildEndpoints: (() { final guardedValue = map['minChildEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      minChildEndpointsIPv4: (() { final guardedValue = map['minChildEndpointsIPv4']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      minChildEndpointsIPv6: (() { final guardedValue = map['minChildEndpointsIPv6']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      subnets: (() { final guardedValue = map['subnets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointPropertiesSubnetsItemResponse>(guardedValue, (value) => EndpointPropertiesSubnetsItemResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
