...
class EndpointResponse {
  ...
  final pulumi.Input<List<EndpointPropertiesCustomHeadersItemResponse>>?
  customHeaders;
    ...
    return <String, dynamic>{
      ...
      'customHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointPropertiesCustomHeadersItemResponse>,
      ...
      'subnets':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointPropertiesSubnetsItemResponse>,
            List<Map<String, dynamic>>
          >(
            subnets,
            (value) =>
    ...
    return EndpointResponse(
      ...
      customHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPropertiesCustomHeadersItemResponse>(
            guardedValue,
      ...
      subnets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPropertiesSubnetsItemResponse>(
            guardedValue,
