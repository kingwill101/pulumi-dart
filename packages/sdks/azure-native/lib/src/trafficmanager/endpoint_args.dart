    ...
    return EndpointArgs(
      ...
      customHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPropertiesCustomHeadersItem>(
            guardedValue,
            (value) => EndpointPropertiesCustomHeadersItem.fromMap(
      ...
      subnets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointPropertiesSubnetsItem>(
            guardedValue,
            (value) => EndpointPropertiesSubnetsItem.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
