...
class MonitorConfigResponse {
  ...
  final pulumi.Input<List<MonitorConfigCustomHeadersItemResponse>>?
  customHeaders;

  /// List of expected status code ranges.
  final pulumi.Input<List<MonitorConfigExpectedStatusCodeRangesItemResponse>>?
    ...
    return <String, dynamic>{
      'customHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<MonitorConfigCustomHeadersItemResponse>,
      ...
      'expectedStatusCodeRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<MonitorConfigExpectedStatusCodeRangesItemResponse>,
            List<Map<String, dynamic>>
          >(
            expectedStatusCodeRanges,
            (value) =>
    ...
    return MonitorConfigResponse(
      customHeaders: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MonitorConfigCustomHeadersItemResponse>(
            guardedValue,
            (value) => MonitorConfigCustomHeadersItemResponse.fromMap(
      ...
      expectedStatusCodeRanges: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MonitorConfigExpectedStatusCodeRangesItemResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
