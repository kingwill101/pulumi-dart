...
class GetEndpointResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customHeaders': ?customHeaders == null ? null : pulumi.Input.encodeList<EndpointPropertiesCustomHeadersItemResponse, Map<String, dynamic>>(customHeaders!, (value) => value.toMap()),
      ...
      'name': ?name,
      'priority': ?priority,
      'subnets': ?subnets == null ? null : pulumi.Input.encodeList<EndpointPropertiesSubnetsItemResponse, Map<String, dynamic>>(subnets!, (value) => value.toMap()),
      'target': ?target,
  ...
  factory GetEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointResult(
      ...
      customHeaders: map['customHeaders'] == null ? null : pulumi.Input.decodeList<EndpointPropertiesCustomHeadersItemResponse>(map['customHeaders']!, (value) => EndpointPropertiesCustomHeadersItemResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      subnets: map['subnets'] == null ? null : pulumi.Input.decodeList<EndpointPropertiesSubnetsItemResponse>(map['subnets']!, (value) => EndpointPropertiesSubnetsItemResponse.fromMap((value as Map).cast<String, dynamic>())),
