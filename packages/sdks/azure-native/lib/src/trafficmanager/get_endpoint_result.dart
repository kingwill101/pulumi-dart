...
class GetEndpointResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'priority': ?priority,
      'subnets': ?(() { final guardedValue = subnets; if (guardedValue == null) return null; return pulumi.Input.encodeList<EndpointPropertiesSubnetsItemResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'target': ?target,
