...
class GetDatastoreResult {
  ...
  /// [moName] Gets or sets the vCenter Managed Object name for the datastore.
  ...
  factory GetDatastoreResult.fromMap(Map<String, dynamic> map) {
    return GetDatastoreResult(
      ...
      capacityGB: (() { final guardedValue = map['capacityGB']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      ...
      freeSpaceGB: (() { final guardedValue = map['freeSpaceGB']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
