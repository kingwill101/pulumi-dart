...
class GetVirtualMachineTemplateResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'disks':
          pulumi.Input.encodeList<VirtualDiskResponse, Map<String, dynamic>>(
            disks,
            (value) => value.toMap(),
          ),
  ...
  factory GetVirtualMachineTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualMachineTemplateResult(
      ...
      disks: pulumi.Input.decodeList<VirtualDiskResponse>(
        map['disks']!,
        (value) =>
            VirtualDiskResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      extendedLocation: (() {
