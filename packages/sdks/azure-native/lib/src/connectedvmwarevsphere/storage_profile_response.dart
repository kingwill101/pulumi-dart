...
class StorageProfileResponse {
  ...
  factory StorageProfileResponse.fromMap(Map<String, dynamic> map) {
    return StorageProfileResponse(
      ...
      scsiControllers: pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualSCSIControllerResponse>(map['scsiControllers']!, (value) => VirtualSCSIControllerResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
