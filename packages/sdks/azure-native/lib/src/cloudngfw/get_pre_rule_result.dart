...
/// Result data returned by getPreRule.
class GetPreRuleResult {
  ...
  /// Creates a new [GetPreRuleResult].
  ...
  GetPreRuleResult({
    ...
    this.tags,
    this.type,
  }) : protocol = protocol ?? 'application-default';
  ...
  factory GetPreRuleResult.fromMap(Map<String, dynamic> map) {
