...
class ListPaloAltoNetworksCloudngfwOperationSupportInfoResult {
  ...
  factory ListPaloAltoNetworksCloudngfwOperationSupportInfoResult.fromMap(
    ...
    return ListPaloAltoNetworksCloudngfwOperationSupportInfoResult(
      ...
      accountRegistrationStatus: (() {
        final guardedValue = map['accountRegistrationStatus'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      credits: (() {
        final guardedValue = map['credits'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
      endDateForCredits: (() {
        final guardedValue = map['endDateForCredits'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      freeTrial: (() {
      ...
      hubUrl: (() {
        final guardedValue = map['hubUrl'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      monthlyCreditLeft: (() {
        final guardedValue = map['monthlyCreditLeft'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
      productSerial: (() {
      ...
      startDateForCredits: (() {
        final guardedValue = map['startDateForCredits'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      supportURL: (() {
