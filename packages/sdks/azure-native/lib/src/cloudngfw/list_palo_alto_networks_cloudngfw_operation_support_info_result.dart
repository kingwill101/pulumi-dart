...
class ListPaloAltoNetworksCloudngfwOperationSupportInfoResult {
  ...
  factory ListPaloAltoNetworksCloudngfwOperationSupportInfoResult.fromMap(Map<String, dynamic> map) {
    return ListPaloAltoNetworksCloudngfwOperationSupportInfoResult(
      ...
      credits: (() { final guardedValue = map['credits']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      monthlyCreditLeft: (() { final guardedValue = map['monthlyCreditLeft']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
