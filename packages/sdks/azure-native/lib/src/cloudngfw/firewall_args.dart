...
class FirewallArgs {
    ...
    return <String, dynamic>{
      'associatedRulestack':
          ?pulumi.Input.mapOptionalInputValue<
            RulestackDetails,
            Map<String, dynamic>
          >(associatedRulestack, (value) => value.toMap()),
      'dnsSettings':
          pulumi.Input.mapInputValue<DNSSettings, Map<String, dynamic>>(
            dnsSettings,
            (value) => value.toMap(),
          ),
      ...
      'frontEndSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<FrontendSetting>,
            List<Map<String, dynamic>>
          >(
            frontEndSettings,
            (value) =>
                pulumi.Input.encodeList<FrontendSetting, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'location': ?location,
      'marketplaceDetails':
          pulumi.Input.mapInputValue<MarketplaceDetails, Map<String, dynamic>>(
            marketplaceDetails,
            (value) => value.toMap(),
          ),
      'networkProfile':
          pulumi.Input.mapInputValue<NetworkProfile, Map<String, dynamic>>(
            networkProfile,
            (value) => value.toMap(),
          ),
      'panEtag': ?panEtag,
      'panoramaConfig':
          ?pulumi.Input.mapOptionalInputValue<
            PanoramaConfig,
            Map<String, dynamic>
          >(panoramaConfig, (value) => value.toMap()),
      'planData': pulumi.Input.mapInputValue<PlanData, Map<String, dynamic>>(
        planData,
        (value) => value.toMap(),
      ),
      ...
      'strataCloudManagerConfig':
          ?pulumi.Input.mapOptionalInputValue<
            StrataCloudManagerConfig,
            Map<String, dynamic>
          >(strataCloudManagerConfig, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      associatedRulestack: (() {
        final guardedValue = map['associatedRulestack'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RulestackDetails.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      dnsSettings: pulumi.Input.fromValue(
        DNSSettings.fromMap(
      ...
      frontEndSettings: (() {
        final guardedValue = map['frontEndSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FrontendSetting>(
            guardedValue,
            (value) =>
                FrontendSetting.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureResourceManagerManagedIdentityProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      isPanoramaManaged: (() {
        final guardedValue = map['isPanoramaManaged'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      isStrataCloudManaged: (() {
        final guardedValue = map['isStrataCloudManaged'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      marketplaceDetails: pulumi.Input.fromValue(
        MarketplaceDetails.fromMap(
          (map['marketplaceDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      networkProfile: pulumi.Input.fromValue(
        NetworkProfile.fromMap(
          (map['networkProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      panEtag: (() {
        final guardedValue = map['panEtag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      panoramaConfig: (() {
        final guardedValue = map['panoramaConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PanoramaConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      planData: pulumi.Input.fromValue(
        PlanData.fromMap((map['planData']! as Map).cast<String, dynamic>()),
      ),
      resourceGroupName: pulumi.Input.fromValue(
        map['resourceGroupName'] as String,
      ),
      strataCloudManagerConfig: (() {
        final guardedValue = map['strataCloudManagerConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StrataCloudManagerConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
