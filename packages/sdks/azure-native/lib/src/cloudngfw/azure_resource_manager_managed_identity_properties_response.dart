...
class AzureResourceManagerManagedIdentityPropertiesResponse {
  ...
  final pulumi.Input<
    Map<String, AzureResourceManagerUserAssignedIdentityResponse>
  >?
  ...
  factory AzureResourceManagerManagedIdentityPropertiesResponse.fromMap(
    ...
    return AzureResourceManagerManagedIdentityPropertiesResponse(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => AzureResourceManagerUserAssignedIdentityResponse.fromMap(
