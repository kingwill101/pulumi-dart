...
class VnetConfigurationResponse {
  ...
  factory VnetConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return VnetConfigurationResponse(
      ...
      trustSubnet: pulumi.Input.fromValue(IPAddressSpaceResponse.fromMap((map['trustSubnet']! as Map).cast<String, dynamic>())),
      unTrustSubnet: pulumi.Input.fromValue(IPAddressSpaceResponse.fromMap((map['unTrustSubnet']! as Map).cast<String, dynamic>())),
      vnet: pulumi.Input.fromValue(IPAddressSpaceResponse.fromMap((map['vnet']! as Map).cast<String, dynamic>())),
    );
  }
}
