...
class AdvSecurityObjectModelResponse {
  ...
  /// [entry] URL entry
  /// [type] type of object
  AdvSecurityObjectModelResponse({required this.entry, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entry':
          pulumi.Input.mapInputValue<
            List<NameDescriptionObjectResponse>,
  ...
  factory AdvSecurityObjectModelResponse.fromMap(Map<String, dynamic> map) {
    return AdvSecurityObjectModelResponse(
      entry: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NameDescriptionObjectResponse>(
          map['entry']!,
          (value) => NameDescriptionObjectResponse.fromMap(
