...
class GetFirewallResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'frontEndSettings': ?(() {
        final guardedValue = frontEndSettings;
  ...
  factory GetFirewallResult.fromMap(Map<String, dynamic> map) {
    return GetFirewallResult(
      ...
      frontEndSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<FrontendSettingResponse>(
          guardedValue,
          (value) => FrontendSettingResponse.fromMap(
      ...
      marketplaceDetails: MarketplaceDetailsResponse.fromMap(
      ...
      planData: PlanDataResponse.fromMap(
        (map['planData']! as Map).cast<String, dynamic>(),
      ),
