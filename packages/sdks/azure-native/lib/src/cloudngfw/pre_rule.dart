...
/// ```
class PreRule extends pulumi.CustomResource {
  /// rule action
  ...
  /// Creates a new [PreRule].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PreRule]. {@macro pulumi_cloudngfw_pre_rule_args_doc}
  ...
  /// Creates a typed reference to an existing [PreRule] resource.
  PreRule.reference(String urn)
    : super(
        'azure-native:cloudngfw:PreRule',
