...
class VwanConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vHub': pulumi.Input.mapInputValue<IPAddressSpace, Map<String, dynamic>>(
        vHub,
        (value) => value.toMap(),
      ),
    };
  ...
  factory VwanConfiguration.fromMap(Map<String, dynamic> map) {
    return VwanConfiguration(
      ...
      trustSubnet: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IPAddressSpace.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      unTrustSubnet: (() {
      ...
      vHub: pulumi.Input.fromValue(
        IPAddressSpace.fromMap((map['vHub']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
