...
class AppSeenDataResponse {
  ...
  AppSeenDataResponse({required this.appSeenList, required this.count});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appSeenList':
          pulumi.Input.mapInputValue<
            List<AppSeenInfoResponse>,
  ...
  factory AppSeenDataResponse.fromMap(Map<String, dynamic> map) {
    return AppSeenDataResponse(
      appSeenList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AppSeenInfoResponse>(
          map['appSeenList']!,
          (value) => AppSeenInfoResponse.fromMap(
