...
class VnetConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trustSubnet':
          pulumi.Input.mapInputValue<IPAddressSpace, Map<String, dynamic>>(
            trustSubnet,
            (value) => value.toMap(),
          ),
      'unTrustSubnet':
      ...
      'vnet': pulumi.Input.mapInputValue<IPAddressSpace, Map<String, dynamic>>(
        vnet,
        (value) => value.toMap(),
      ),
    };
  ...
  factory VnetConfiguration.fromMap(Map<String, dynamic> map) {
    return VnetConfiguration(
      ...
      vnet: pulumi.Input.fromValue(
        IPAddressSpace.fromMap((map['vnet']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
