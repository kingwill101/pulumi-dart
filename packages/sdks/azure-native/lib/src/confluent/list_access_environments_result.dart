...
class ListAccessEnvironmentsResult {
  ...
  ListAccessEnvironmentsResult({this.data, this.kind, this.metadata});
  ...
  factory ListAccessEnvironmentsResult.fromMap(Map<String, dynamic> map) {
    return ListAccessEnvironmentsResult(
      data: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<EnvironmentRecordResponse>(
          guardedValue,
          (value) => EnvironmentRecordResponse.fromMap(
