...
class ListAccessServiceAccountsResult {
  ...
  ListAccessServiceAccountsResult({this.data, this.kind, this.metadata});
  ...
  factory ListAccessServiceAccountsResult.fromMap(Map<String, dynamic> map) {
    return ListAccessServiceAccountsResult(
      data: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ServiceAccountRecordResponse>(
          guardedValue,
          (value) => ServiceAccountRecordResponse.fromMap(
