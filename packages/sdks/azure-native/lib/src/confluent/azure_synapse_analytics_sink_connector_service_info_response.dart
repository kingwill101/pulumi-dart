...
class AzureSynapseAnalyticsSinkConnectorServiceInfoResponse {
  ...
  const AzureSynapseAnalyticsSinkConnectorServiceInfoResponse({
  ...
  factory AzureSynapseAnalyticsSinkConnectorServiceInfoResponse.fromMap(Map<String, dynamic> map) {
    return AzureSynapseAnalyticsSinkConnectorServiceInfoResponse(
      ...
      synapseSqlDatabaseName: (() { final guardedValue = map['synapseSqlDatabaseName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      synapseSqlPassword: (() { final guardedValue = map['synapseSqlPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      synapseSqlServerName: (() { final guardedValue = map['synapseSqlServerName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      synapseSqlUser: (() { final guardedValue = map['synapseSqlUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
