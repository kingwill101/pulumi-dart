...
class ConnectorArgs {
  ...
  final pulumi.Input<AzureBlobStorageSinkConnectorServiceInfo>?
  ...
  final pulumi.Input<KafkaAzureBlobStorageSinkConnectorInfo>?
    ...
    return <String, dynamic>{
      ...
      'connectorBasicInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ConnectorInfoBase,
            Map<String, dynamic>
          >(connectorBasicInfo, (value) => value.toMap()),
      'connectorName': ?connectorName,
      'connectorServiceTypeInfo':
          ?pulumi.Input.mapOptionalInputValue<
            AzureBlobStorageSinkConnectorServiceInfo,
            Map<String, dynamic>
          >(connectorServiceTypeInfo, (value) => value.toMap()),
      ...
      'partnerConnectorInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(partnerConnectorInfo, (value) => value.toMap()),
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      connectorServiceTypeInfo: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureBlobStorageSinkConnectorServiceInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      partnerConnectorInfo: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KafkaAzureBlobStorageSinkConnectorInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
