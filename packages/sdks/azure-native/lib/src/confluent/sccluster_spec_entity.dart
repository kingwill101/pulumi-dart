...
class SCClusterSpecEntity {
  ...
  factory SCClusterSpecEntity.fromMap(Map<String, dynamic> map) {
    return SCClusterSpecEntity(
      ...
      byok: (() { final guardedValue = map['byok']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SCClusterByokEntity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cloud: (() { final guardedValue = map['cloud']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterConfigEntity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      environment: (() { final guardedValue = map['environment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SCClusterNetworkEnvironmentEntity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
