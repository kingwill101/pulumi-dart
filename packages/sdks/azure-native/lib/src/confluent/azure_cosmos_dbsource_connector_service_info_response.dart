...
class AzureCosmosDBSourceConnectorServiceInfoResponse {
  ...
  const AzureCosmosDBSourceConnectorServiceInfoResponse({
  ...
  factory AzureCosmosDBSourceConnectorServiceInfoResponse.fromMap(Map<String, dynamic> map) {
    return AzureCosmosDBSourceConnectorServiceInfoResponse(
