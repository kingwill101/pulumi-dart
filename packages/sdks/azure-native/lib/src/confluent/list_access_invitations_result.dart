...
class ListAccessInvitationsResult {
  ...
  ListAccessInvitationsResult({this.data, this.kind, this.metadata});
  ...
  factory ListAccessInvitationsResult.fromMap(Map<String, dynamic> map) {
    return ListAccessInvitationsResult(
      data: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<InvitationRecordResponse>(
          guardedValue,
          (value) => InvitationRecordResponse.fromMap(
