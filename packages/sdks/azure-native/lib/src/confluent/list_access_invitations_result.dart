...
class ListAccessInvitationsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'data': ?data == null ? null : pulumi.Input.encodeList<InvitationRecordResponse, Map<String, dynamic>>(data!, (value) => value.toMap()),
      'kind': ?kind,
  ...
  factory ListAccessInvitationsResult.fromMap(Map<String, dynamic> map) {
    return ListAccessInvitationsResult(
      data: map['data'] == null ? null : pulumi.Input.decodeList<InvitationRecordResponse>(map['data']!, (value) => InvitationRecordResponse.fromMap((value as Map).cast<String, dynamic>())),
