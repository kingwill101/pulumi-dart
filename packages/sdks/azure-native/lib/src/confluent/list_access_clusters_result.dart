...
class ListAccessClustersResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'data': ?(() { final guardedValue = data; if (guardedValue == null) return null; return pulumi.Input.encodeList<ClusterRecordResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'kind': ?kind,
  ...
  factory ListAccessClustersResult.fromMap(Map<String, dynamic> map) {
    return ListAccessClustersResult(
      data: (() { final guardedValue = map['data']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ClusterRecordResponse>(guardedValue, (value) => ClusterRecordResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
