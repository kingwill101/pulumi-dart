...
class ListAccessRoleBindingsResult {
  ...
  ListAccessRoleBindingsResult({this.data, this.kind, this.metadata});
  ...
  factory ListAccessRoleBindingsResult.fromMap(Map<String, dynamic> map) {
    return ListAccessRoleBindingsResult(
      data: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<RoleBindingRecordResponse>(
          guardedValue,
          (value) => RoleBindingRecordResponse.fromMap(
