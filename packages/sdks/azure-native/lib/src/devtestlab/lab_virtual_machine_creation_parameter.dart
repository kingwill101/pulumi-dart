...
class LabVirtualMachineCreationParameter {
  ...
  factory LabVirtualMachineCreationParameter.fromMap(Map<String, dynamic> map) {
    return LabVirtualMachineCreationParameter(
      ...
      bulkCreationParameters: (() { final guardedValue = map['bulkCreationParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BulkCreationParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
