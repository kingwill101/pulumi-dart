...
/// }
///
/// resource "azure-native_devtestlab_virtualmachineschedule" "virtualMachineSchedule" {
///   daily_recurrence = {
///     time = "1900"
///   }
///   hourly_recurrence = {
...
class VirtualMachineSchedule extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [VirtualMachineSchedule] resource.
  VirtualMachineSchedule.reference(String urn)
    : super(
        'azure-native:devtestlab:VirtualMachineSchedule',
