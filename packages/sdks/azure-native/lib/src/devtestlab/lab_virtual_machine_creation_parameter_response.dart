...
class LabVirtualMachineCreationParameterResponse {
  ...
  final pulumi.Input<List<ScheduleCreationParameterResponse>>?
  scheduleParameters;
    ...
    return <String, dynamic>{
      ...
      'artifacts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ArtifactInstallPropertiesResponse>,
      ...
      'bulkCreationParameters':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bulkCreationParameters, (value) => value.toMap()),
      'createdDate': ?createdDate,
      'customImageId': ?customImageId,
      'dataDiskParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataDiskPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            dataDiskParameters,
            (value) =>
      ...
      'scheduleParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScheduleCreationParameterResponse>,
            List<Map<String, dynamic>>
          >(
            scheduleParameters,
            (value) =>
  ...
  factory LabVirtualMachineCreationParameterResponse.fromMap(
    ...
    return LabVirtualMachineCreationParameterResponse(
      ...
      artifacts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ArtifactInstallPropertiesResponse>(
            guardedValue,
      ...
      bulkCreationParameters: (() {
        final guardedValue = map['bulkCreationParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BulkCreationParametersResponse.fromMap(
      ...
      dataDiskParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataDiskPropertiesResponse>(
            guardedValue,
      ...
      galleryImageReference: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GalleryImageReferenceResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      networkInterface: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInterfacePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      scheduleParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScheduleCreationParameterResponse>(
            guardedValue,
