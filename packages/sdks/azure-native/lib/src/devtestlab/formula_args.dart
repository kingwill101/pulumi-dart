...
class FormulaArgs {
  ...
  factory FormulaArgs.fromMap(Map<String, dynamic> map) {
    return FormulaArgs(
      ...
      formulaContent: (() { final guardedValue = map['formulaContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LabVirtualMachineCreationParameter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vm: (() { final guardedValue = map['vm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FormulaPropertiesFromVm.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
