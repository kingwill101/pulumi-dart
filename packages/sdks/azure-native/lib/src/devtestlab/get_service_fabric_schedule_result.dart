...
/// Result data returned by getServiceFabricSchedule.
class GetServiceFabricScheduleResult {
  ...
  /// Creates a new [GetServiceFabricScheduleResult].
  ...
  factory GetServiceFabricScheduleResult.fromMap(Map<String, dynamic> map) {
    return GetServiceFabricScheduleResult(
      ...
      dailyRecurrence: (() {
        ...
        return DayDetailsResponse.fromMap(
      ...
      hourlyRecurrence: (() {
        ...
        if (guardedValue == null) return null;
        return HourDetailsResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      })(),
      id: map['id'] as String,
      ...
      weeklyRecurrence: (() {
        ...
        if (guardedValue == null) return null;
        return WeekDetailsResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      })(),
    );
