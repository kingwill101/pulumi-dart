...
class EnvironmentDeploymentProperties {
  ...
  EnvironmentDeploymentProperties({this.armTemplateId, this.parameters});
    ...
    return <String, dynamic>{
      ...
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<ArmTemplateParameterProperties>,
    ...
    return EnvironmentDeploymentProperties(
      ...
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ArmTemplateParameterProperties>(
            guardedValue,
            (value) => ArmTemplateParameterProperties.fromMap(
