...
class NetworkInterfaceProperties {
  ...
  final pulumi.Input<SharedPublicIpAddressConfiguration>?
  ...
  factory NetworkInterfaceProperties.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceProperties(
      ...
      rdpAuthority: (() {
        final guardedValue = map['rdpAuthority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sharedPublicIpAddressConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          SharedPublicIpAddressConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sshAuthority: (() {
        final guardedValue = map['sshAuthority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subnetId: (() {
