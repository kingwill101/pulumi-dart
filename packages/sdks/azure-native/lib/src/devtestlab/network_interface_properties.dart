...
class NetworkInterfaceProperties {
  ...
  factory NetworkInterfaceProperties.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceProperties(
      ...
      sharedPublicIpAddressConfiguration: (() { final guardedValue = map['sharedPublicIpAddressConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SharedPublicIpAddressConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
