    ...
    return <String, dynamic>{
      ...
      'subnetOverrides':
          ...
          >(
            subnetOverrides,
            (value) =>
                pulumi.Input.encodeList<SubnetOverride, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory VirtualNetworkArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkArgs(
      ...
      subnetOverrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubnetOverride>(
            guardedValue,
            (value) =>
                SubnetOverride.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
