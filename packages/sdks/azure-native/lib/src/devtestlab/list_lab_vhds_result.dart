...
class ListLabVhdsResult {
  ...
  ListLabVhdsResult({this.nextLink, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': ?nextLink,
      'value': pulumi.Input.encodeList<LabVhdResponse, Map<String, dynamic>>(
        value,
        (value) => value.toMap(),
      ),
    };
  ...
  factory ListLabVhdsResult.fromMap(Map<String, dynamic> map) {
    return ListLabVhdsResult(
      ...
      value: pulumi.Input.decodeList<LabVhdResponse>(
        map['value']!,
        (value) =>
            LabVhdResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
