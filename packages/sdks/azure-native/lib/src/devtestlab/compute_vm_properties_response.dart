...
class ComputeVmPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'statuses':
          ?pulumi.Input.mapOptionalInputValue<
            List<ComputeVmInstanceViewStatusResponse>,
            List<Map<String, dynamic>>
          >(
            statuses,
            (value) =>
  ...
  factory ComputeVmPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ComputeVmPropertiesResponse(
      dataDiskIds: (() {
        final guardedValue = map['dataDiskIds'];
      ...
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ComputeDataDiskResponse>(
            guardedValue,
            (value) => ComputeDataDiskResponse.fromMap(
      ...
      statuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ComputeVmInstanceViewStatusResponse>(
            guardedValue,
            (value) => ComputeVmInstanceViewStatusResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
