...
class LabArgs {
  ...
  final pulumi.Input<dynamic>? environmentPermission;
  /// Extended properties of the lab used for experimental features
  final pulumi.Input<Map<String, String>?>? extendedProperties;
  /// Type of storage used by the lab. It can be either Premium or Standard. Default is Premium.
  final pulumi.Input<dynamic>? labStorageType;
  ...
  final pulumi.Input<dynamic>? premiumDataDisks;
  ...
  LabArgs({
    ...
    pulumi.Input<dynamic>? labStorageType,
    this.location,
    ...
    this.support,
    this.tags,
  }) : labStorageType = labStorageType ?? pulumi.Input.fromValue('Premium');
  ...
  factory LabArgs.fromMap(Map<String, dynamic> map) {
    return LabArgs(
      ...
      environmentPermission: (() { final guardedValue = map['environmentPermission']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      labStorageType: (() { final guardedValue = map['labStorageType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      premiumDataDisks: (() { final guardedValue = map['premiumDataDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
