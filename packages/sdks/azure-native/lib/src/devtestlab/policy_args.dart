...
class PolicyArgs {
  ...
  final pulumi.Input<dynamic>? evaluatorType;
  /// The fact data of the policy.
  final pulumi.Input<String?>? factData;
  /// The fact name of the policy (e.g. LabVmCount, LabVmSize, MaxVmsAllowedPerLab, etc.
  final pulumi.Input<dynamic>? factName;
  /// labs
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      ...
      evaluatorType: (() { final guardedValue = map['evaluatorType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      factName: (() { final guardedValue = map['factName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
