...
class ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<ValidateSyncMigrationInputSqlServerTaskInputResponse>?
  input;

  /// Task output. This is ignored if submitted.
  final pulumi.Input<
    List<ValidateSyncMigrationInputSqlServerTaskOutputResponse>
  >
  output;
  ...
  factory ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse.fromMap(
    ...
    return ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ValidateSyncMigrationInputSqlServerTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              ValidateSyncMigrationInputSqlServerTaskOutputResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
