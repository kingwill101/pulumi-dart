...
class SqlDbMigrationStatusDetailsResponse {
  ...
  factory SqlDbMigrationStatusDetailsResponse.fromMap(Map<String, dynamic> map) {
    return SqlDbMigrationStatusDetailsResponse(
      listOfCopyProgressDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<CopyProgressDetailsResponse>(map['listOfCopyProgressDetails']!, (value) => CopyProgressDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      migrationState: pulumi.Input.fromValue(map['migrationState'] as String),
      sqlDataCopyErrors: pulumi.Input.fromValue((map['sqlDataCopyErrors'] as List).cast<String>()),
    );
  }
}
