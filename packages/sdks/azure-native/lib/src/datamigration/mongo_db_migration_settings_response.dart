    ...
    return <String, dynamic>{
      ...
      'databases':
          pulumi.Input.mapInputValue<
            Map<String, MongoDbDatabaseSettingsResponse>,
  ...
  factory MongoDbMigrationSettingsResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbMigrationSettingsResponse(
      ...
      databases: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<MongoDbDatabaseSettingsResponse>(
          map['databases']!,
          (value) => MongoDbDatabaseSettingsResponse.fromMap(
      ...
      source: pulumi.Input.fromValue(
        MongoDbConnectionInfoResponse.fromMap(
      ...
      throttling: (() {
        ...
        return pulumi.Input.fromValue(
          MongoDbThrottlingSettingsResponse.fromMap(
