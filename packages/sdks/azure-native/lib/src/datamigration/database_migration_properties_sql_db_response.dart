...
class DatabaseMigrationPropertiesSqlDbResponse {
  ...
  const DatabaseMigrationPropertiesSqlDbResponse({
  ...
  factory DatabaseMigrationPropertiesSqlDbResponse.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationPropertiesSqlDbResponse(
      ...
      migrationFailureError: pulumi.Input.fromValue(ErrorInfoResponse.fromMap((map['migrationFailureError']! as Map).cast<String, dynamic>())),
      ...
      migrationStatusDetails: pulumi.Input.fromValue(SqlDbMigrationStatusDetailsResponse.fromMap((map['migrationStatusDetails']! as Map).cast<String, dynamic>())),
      offlineConfiguration: pulumi.Input.fromValue(SqlDbOfflineConfigurationResponse.fromMap((map['offlineConfiguration']! as Map).cast<String, dynamic>())),
      ...
      sourceSqlConnection: (() { final guardedValue = map['sourceSqlConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlConnectionInformationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      startedOn: pulumi.Input.fromValue(map['startedOn'] as String),
      tableList: (() { final guardedValue = map['tableList']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      targetSqlConnection: (() { final guardedValue = map['targetSqlConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlConnectionInformationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
