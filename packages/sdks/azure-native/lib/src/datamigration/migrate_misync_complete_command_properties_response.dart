...
class MigrateMISyncCompleteCommandPropertiesResponse {
  ...
  factory MigrateMISyncCompleteCommandPropertiesResponse.fromMap(
    ...
    return MigrateMISyncCompleteCommandPropertiesResponse(
      ...
      input: (() {
        ...
        return pulumi.Input.fromValue(
          MigrateMISyncCompleteCommandInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        MigrateMISyncCompleteCommandOutputResponse.fromMap(
