...
class MigrateOracleAzureDbPostgreSqlSyncDatabaseInput {
  ...
  const MigrateOracleAzureDbPostgreSqlSyncDatabaseInput({
  ...
  factory MigrateOracleAzureDbPostgreSqlSyncDatabaseInput.fromMap(Map<String, dynamic> map) {
    return MigrateOracleAzureDbPostgreSqlSyncDatabaseInput(
      caseManipulation: (() { final guardedValue = map['caseManipulation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
