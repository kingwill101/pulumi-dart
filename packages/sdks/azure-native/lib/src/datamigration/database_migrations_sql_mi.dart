...
import 'database_migration_properties_sql_mi_response.dart';
import 'database_migrations_sql_mi_args.dart';
...
class DatabaseMigrationsSqlMi extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DatabaseMigrationPropertiesSqlMiResponse> properties;
  /// Azure Resource Manager metadata containing createdBy and modifiedBy information.
  late final pulumi.Output<SystemDataResponse> systemData;
  /// The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
  late final pulumi.Output<String> type;

  /// Creates a new [DatabaseMigrationsSqlMi].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatabaseMigrationsSqlMi]. {@macro pulumi_datamigration_database_migrations_sql_mi_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DatabaseMigrationsSqlMi(
    String name, {
    DatabaseMigrationsSqlMiArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'azure-native:datamigration:DatabaseMigrationsSqlMi',
          name,
    ...
    properties = registerOutput<DatabaseMigrationPropertiesSqlMiResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DatabaseMigrationPropertiesSqlMiResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [DatabaseMigrationsSqlMi] resource.
  DatabaseMigrationsSqlMi.reference(String urn)
    : super(
        'azure-native:datamigration:DatabaseMigrationsSqlMi',
