...
class MigrateSqlServerSqlDbTaskInput {
  ...
  final pulumi.Input<List<MigrateSqlServerSqlDbDatabaseInput>>
  selectedDatabases;
    ...
    return <String, dynamic>{
      ...
      'selectedDatabases':
          pulumi.Input.mapInputValue<
            List<MigrateSqlServerSqlDbDatabaseInput>,
  ...
  factory MigrateSqlServerSqlDbTaskInput.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbTaskInput(
      ...
      selectedDatabases: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MigrateSqlServerSqlDbDatabaseInput>(
          map['selectedDatabases']!,
          (value) => MigrateSqlServerSqlDbDatabaseInput.fromMap(
      ...
      validationOptions: (() {
        ...
        return pulumi.Input.fromValue(
          MigrationValidationOptions.fromMap(
