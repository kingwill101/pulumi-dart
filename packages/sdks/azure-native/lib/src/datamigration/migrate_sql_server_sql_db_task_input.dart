...
class MigrateSqlServerSqlDbTaskInput {
  ...
  factory MigrateSqlServerSqlDbTaskInput.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbTaskInput(
      ...
      selectedDatabases: pulumi.Input.fromValue(pulumi.Input.decodeList<MigrateSqlServerSqlDbDatabaseInput>(map['selectedDatabases']!, (value) => MigrateSqlServerSqlDbDatabaseInput.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      validationOptions: (() { final guardedValue = map['validationOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrationValidationOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
