...
class MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse>?
  input;
  ...
  final pulumi.Input<
    List<MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse>
  >
  output;
  ...
  factory MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse.fromMap(
    ...
    return MigrateMySqlAzureDbForMySqlOfflineTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MigrateMySqlAzureDbForMySqlOfflineTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              MigrateMySqlAzureDbForMySqlOfflineTaskOutputDatabaseLevelResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
