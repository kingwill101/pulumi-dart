...
class MigrateMySqlAzureDbForMySqlSyncDatabaseInput {
  ...
  const MigrateMySqlAzureDbForMySqlSyncDatabaseInput({
  ...
  factory MigrateMySqlAzureDbForMySqlSyncDatabaseInput.fromMap(Map<String, dynamic> map) {
    return MigrateMySqlAzureDbForMySqlSyncDatabaseInput(
