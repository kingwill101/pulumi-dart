...
class MigrateSqlServerSqlDbSyncTaskProperties {
  ...
  /// [input] Task input
  /// [taskType] Task type.
  const MigrateSqlServerSqlDbSyncTaskProperties({
    this.clientData,
    this.input,
  ...
  factory MigrateSqlServerSqlDbSyncTaskProperties.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbSyncTaskProperties(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrateSqlServerSqlDbSyncTaskInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
