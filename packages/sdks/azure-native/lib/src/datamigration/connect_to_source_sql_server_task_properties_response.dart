...
class ConnectToSourceSqlServerTaskPropertiesResponse {
  ...
  final pulumi.Input<
    List<ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse>
  >
  output;
  ...
  factory ConnectToSourceSqlServerTaskPropertiesResponse.fromMap(
    ...
    return ConnectToSourceSqlServerTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToSourceSqlServerTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              ConnectToSourceSqlServerTaskOutputAgentJobLevelResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
