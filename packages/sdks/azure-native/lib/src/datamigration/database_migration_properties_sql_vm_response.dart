...
class DatabaseMigrationPropertiesSqlVmResponse {
  ...
  /// Creates a new [DatabaseMigrationPropertiesSqlVmResponse].
  ...
  factory DatabaseMigrationPropertiesSqlVmResponse.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationPropertiesSqlVmResponse(
      backupConfiguration: (() { final guardedValue = map['backupConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BackupConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      migrationStatusDetails: pulumi.Input.fromValue(MigrationStatusDetailsResponse.fromMap((map['migrationStatusDetails']! as Map).cast<String, dynamic>())),
      offlineConfiguration: (() { final guardedValue = map['offlineConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OfflineConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
