...
import 'connect_to_source_oracle_sync_task_input_response.dart';
import 'connect_to_source_oracle_sync_task_output_response.dart';
...
class ConnectToSourceOracleSyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<ConnectToSourceOracleSyncTaskInputResponse>? input;
  /// Task output. This is ignored if submitted.
  final pulumi.Input<List<ConnectToSourceOracleSyncTaskOutputResponse>> output;
  ...
  /// Creates a new [ConnectToSourceOracleSyncTaskPropertiesResponse].
  ...
  /// [taskType] Task type.
  const ConnectToSourceOracleSyncTaskPropertiesResponse({
    this.clientData,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<ConnectToSourceOracleSyncTaskInputResponse, Map<String, dynamic>>(input, (value) => value.toMap()),
      'output': pulumi.Input.mapInputValue<List<ConnectToSourceOracleSyncTaskOutputResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<ConnectToSourceOracleSyncTaskOutputResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }

  factory ConnectToSourceOracleSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToSourceOracleSyncTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectToSourceOracleSyncTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectToSourceOracleSyncTaskOutputResponse>(map['output']!, (value) => ConnectToSourceOracleSyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
