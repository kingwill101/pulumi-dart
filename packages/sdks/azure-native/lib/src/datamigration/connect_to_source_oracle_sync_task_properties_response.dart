...
class ConnectToSourceOracleSyncTaskPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output':
          pulumi.Input.mapInputValue<
            List<ConnectToSourceOracleSyncTaskOutputResponse>,
            List<Map<String, dynamic>>
          >(
            output,
            (value) =>
  ...
  factory ConnectToSourceOracleSyncTaskPropertiesResponse.fromMap(
    ...
    return ConnectToSourceOracleSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToSourceOracleSyncTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectToSourceOracleSyncTaskOutputResponse>(
          map['output']!,
          (value) => ConnectToSourceOracleSyncTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
