...
class ConnectToTargetSqlSqlDbSyncTaskProperties {
  ...
  /// [input] Task input
  /// [taskType] Task type.
  const ConnectToTargetSqlSqlDbSyncTaskProperties({
    this.clientData,
    this.input,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<ConnectToTargetSqlSqlDbSyncTaskInput, Map<String, dynamic>>(input, (value) => value.toMap()),
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToTargetSqlSqlDbSyncTaskProperties.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetSqlSqlDbSyncTaskProperties(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectToTargetSqlSqlDbSyncTaskInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
