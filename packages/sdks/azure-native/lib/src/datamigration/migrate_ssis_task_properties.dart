...
class MigrateSsisTaskProperties {
  ...
  factory MigrateSsisTaskProperties.fromMap(Map<String, dynamic> map) {
    return MigrateSsisTaskProperties(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrateSsisTaskInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
