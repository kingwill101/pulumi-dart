...
class MigrateMySqlAzureDbForMySqlOfflineTaskInput {
  ...
  final pulumi.Input<List<MigrateMySqlAzureDbForMySqlOfflineDatabaseInput>>
  selectedDatabases;
    ...
    return <String, dynamic>{
      ...
      'selectedDatabases':
          pulumi.Input.mapInputValue<
            List<MigrateMySqlAzureDbForMySqlOfflineDatabaseInput>,
  ...
  factory MigrateMySqlAzureDbForMySqlOfflineTaskInput.fromMap(
    ...
    return MigrateMySqlAzureDbForMySqlOfflineTaskInput(
      ...
      makeSourceServerReadOnly: (() {
        final guardedValue = map['makeSourceServerReadOnly'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      optionalAgentSettings: (() {
        final guardedValue = map['optionalAgentSettings'];
        if (guardedValue == null) return null;
      ...
      selectedDatabases: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<MigrateMySqlAzureDbForMySqlOfflineDatabaseInput>(
          map['selectedDatabases']!,
          (value) => MigrateMySqlAzureDbForMySqlOfflineDatabaseInput.fromMap(
