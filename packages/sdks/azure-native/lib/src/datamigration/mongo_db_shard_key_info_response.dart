...
class MongoDbShardKeyInfoResponse {
  ...
  MongoDbShardKeyInfoResponse({required this.fields, required this.isUnique});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fields':
          pulumi.Input.mapInputValue<
            List<MongoDbShardKeyFieldResponse>,
  ...
  factory MongoDbShardKeyInfoResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbShardKeyInfoResponse(
      fields: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MongoDbShardKeyFieldResponse>(
          map['fields']!,
          (value) => MongoDbShardKeyFieldResponse.fromMap(
