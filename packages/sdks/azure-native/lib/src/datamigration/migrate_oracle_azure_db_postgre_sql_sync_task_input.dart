...
class MigrateOracleAzureDbPostgreSqlSyncTaskInput {
  ...
  final pulumi.Input<List<MigrateOracleAzureDbPostgreSqlSyncDatabaseInput>>
  selectedDatabases;
    ...
    return <String, dynamic>{
      'selectedDatabases':
          pulumi.Input.mapInputValue<
            List<MigrateOracleAzureDbPostgreSqlSyncDatabaseInput>,
  ...
  factory MigrateOracleAzureDbPostgreSqlSyncTaskInput.fromMap(
    Map<String, dynamic> map,
  ) {
    return MigrateOracleAzureDbPostgreSqlSyncTaskInput(
      selectedDatabases: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<MigrateOracleAzureDbPostgreSqlSyncDatabaseInput>(
          map['selectedDatabases']!,
          (value) => MigrateOracleAzureDbPostgreSqlSyncDatabaseInput.fromMap(
