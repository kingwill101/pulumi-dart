...
class SqlBackupSetInfoResponse {
  ...
  factory SqlBackupSetInfoResponse.fromMap(Map<String, dynamic> map) {
    return SqlBackupSetInfoResponse(
      ...
      listOfBackupFiles: pulumi.Input.fromValue(pulumi.Input.decodeList<SqlBackupFileInfoResponse>(map['listOfBackupFiles']!, (value) => SqlBackupFileInfoResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
