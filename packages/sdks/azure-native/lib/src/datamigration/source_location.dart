...
class SourceLocation {
  ...
  SourceLocation({this.azureBlob, this.fileShare});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'azureBlob':
          ?pulumi.Input.mapOptionalInputValue<AzureBlob, Map<String, dynamic>>(
            azureBlob,
            (value) => value.toMap(),
          ),
      'fileShare':
    ...
    return SourceLocation(
      azureBlob: (() {
        ...
        return pulumi.Input.fromValue(
          AzureBlob.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      fileShare: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlFileShare.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
