...
class MongoDbMigrationProgressResponse {
  ...
  factory MongoDbMigrationProgressResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbMigrationProgressResponse(
      ...
      databases: (() { final guardedValue = map['databases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<MongoDbDatabaseProgressResponse>(guardedValue, (value) => MongoDbDatabaseProgressResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
