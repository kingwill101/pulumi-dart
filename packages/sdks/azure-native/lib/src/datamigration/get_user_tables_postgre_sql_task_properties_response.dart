...
class GetUserTablesPostgreSqlTaskPropertiesResponse {
  ...
  /// [taskType] Task type.
  const GetUserTablesPostgreSqlTaskPropertiesResponse({
    this.clientData,
  ...
  factory GetUserTablesPostgreSqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesPostgreSqlTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetUserTablesPostgreSqlTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserTablesPostgreSqlTaskOutputResponse>(map['output']!, (value) => GetUserTablesPostgreSqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
