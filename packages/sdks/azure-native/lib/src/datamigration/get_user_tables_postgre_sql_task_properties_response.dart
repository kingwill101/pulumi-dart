...
class GetUserTablesPostgreSqlTaskPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output':
          pulumi.Input.mapInputValue<
            List<GetUserTablesPostgreSqlTaskOutputResponse>,
            List<Map<String, dynamic>>
          >(
            output,
            (value) =>
  ...
  factory GetUserTablesPostgreSqlTaskPropertiesResponse.fromMap(
    ...
    return GetUserTablesPostgreSqlTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetUserTablesPostgreSqlTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUserTablesPostgreSqlTaskOutputResponse>(
          map['output']!,
          (value) => GetUserTablesPostgreSqlTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
