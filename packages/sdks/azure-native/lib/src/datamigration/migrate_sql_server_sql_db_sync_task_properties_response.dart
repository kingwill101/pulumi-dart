...
class MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
  ...
  final pulumi.Input<
    List<MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse>
  >
  output;
  ...
  factory MigrateSqlServerSqlDbSyncTaskPropertiesResponse.fromMap(
    ...
    return MigrateSqlServerSqlDbSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MigrateSqlServerSqlDbSyncTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
