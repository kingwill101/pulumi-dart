...
class MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<MigrateSqlServerSqlDbSyncTaskInputResponse>? input;
  /// Task output. This is ignored if submitted.
  final pulumi.Input<List<MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse>> output;
  ...
  /// [taskType] Task type.
  const MigrateSqlServerSqlDbSyncTaskPropertiesResponse({
    this.clientData,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<MigrateSqlServerSqlDbSyncTaskInputResponse, Map<String, dynamic>>(input, (value) => value.toMap()),
      'output': pulumi.Input.mapInputValue<List<MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory MigrateSqlServerSqlDbSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbSyncTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrateSqlServerSqlDbSyncTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse>(map['output']!, (value) => MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse.fromMap((value as Map).cast<String, dynamic>()))),
