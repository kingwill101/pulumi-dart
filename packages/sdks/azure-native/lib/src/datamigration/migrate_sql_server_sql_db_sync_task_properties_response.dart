...
class MigrateSqlServerSqlDbSyncTaskPropertiesResponse {
  ...
  factory MigrateSqlServerSqlDbSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbSyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (MigrateSqlServerSqlDbSyncTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse>(map['output'], (value) => MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
