...
import 'validate_oracle_azure_db_postgre_sql_sync_task_output_response.dart';

/// Properties for the task that validates a migration for Oracle to Azure Database for PostgreSQL for online migrations
class ValidateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
  ...
  final pulumi.Input<List<ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse>> output;
  ...
  /// Creates a new [ValidateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.mapInputValue<List<ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }

  factory ValidateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ValidateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse(
      ...
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse>(map['output']!, (value) => ValidateOracleAzureDbPostgreSqlSyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
