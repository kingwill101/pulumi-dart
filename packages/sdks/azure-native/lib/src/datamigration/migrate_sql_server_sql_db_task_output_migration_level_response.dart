...
class MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse {
  ...
  final pulumi.Input<MigrationValidationResultResponse>?
    ...
    return <String, dynamic>{
      ...
      'migrationValidationResult':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(migrationValidationResult, (value) => value.toMap()),
  ...
  factory MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse.fromMap(
    ...
    return MigrateSqlServerSqlDbTaskOutputMigrationLevelResponse(
      ...
      migrationValidationResult: (() {
        final guardedValue = map['migrationValidationResult'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MigrationValidationResultResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
