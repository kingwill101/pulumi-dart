...
class ConnectToMongoDbTaskPropertiesResponse {
  ...
  final MongoDbConnectionInfoResponse? input;
  /// An array containing a single MongoDbClusterInfo object
  final List<MongoDbClusterInfoResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<MongoDbClusterInfoResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToMongoDbTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToMongoDbTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : MongoDbConnectionInfoResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<MongoDbClusterInfoResponse>(map['output'], (value) => MongoDbClusterInfoResponse.fromMap((value as Map).cast<String, dynamic>())),
