...
class ConnectToSourceMySqlTaskProperties {
  ...
  /// [input] Task input
  /// [taskType] Task type.
  const ConnectToSourceMySqlTaskProperties({
    this.clientData,
    this.input,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<ConnectToSourceMySqlTaskInput, Map<String, dynamic>>(input, (value) => value.toMap()),
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToSourceMySqlTaskProperties.fromMap(Map<String, dynamic> map) {
    return ConnectToSourceMySqlTaskProperties(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectToSourceMySqlTaskInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
