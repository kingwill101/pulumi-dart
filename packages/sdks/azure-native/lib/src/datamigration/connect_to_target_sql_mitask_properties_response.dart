...
class ConnectToTargetSqlMITaskPropertiesResponse {
  ...
  factory ConnectToTargetSqlMITaskPropertiesResponse.fromMap(
    ...
    return ConnectToTargetSqlMITaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToTargetSqlMITaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectToTargetSqlMITaskOutputResponse>(
          map['output']!,
          (value) => ConnectToTargetSqlMITaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
