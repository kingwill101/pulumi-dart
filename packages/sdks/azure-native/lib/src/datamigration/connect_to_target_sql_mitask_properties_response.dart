...
class ConnectToTargetSqlMITaskPropertiesResponse {
  ...
  factory ConnectToTargetSqlMITaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetSqlMITaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (ConnectToTargetSqlMITaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<ConnectToTargetSqlMITaskOutputResponse>(map['output'], (value) => ConnectToTargetSqlMITaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
