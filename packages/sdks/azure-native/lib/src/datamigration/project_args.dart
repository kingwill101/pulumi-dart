...
class ProjectArgs {
    ...
    return <String, dynamic>{
      'azureAuthenticationInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(azureAuthenticationInfo, (value) => value.toMap()),
      'databasesInfo':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseInfo>,
          ...
          >(
            databasesInfo,
            (value) =>
                pulumi.Input.encodeList<DatabaseInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      azureAuthenticationInfo: (() {
        final guardedValue = map['azureAuthenticationInfo'];
      ...
      databasesInfo: (() {
        final guardedValue = map['databasesInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseInfo>(
            guardedValue,
            (value) =>
                DatabaseInfo.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      sourceConnectionInfo: (() {
        final guardedValue = map['sourceConnectionInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      targetConnectionInfo: (() {
        final guardedValue = map['targetConnectionInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MiSqlConnectionInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
