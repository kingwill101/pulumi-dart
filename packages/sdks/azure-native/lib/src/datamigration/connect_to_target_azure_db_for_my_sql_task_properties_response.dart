...
class ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
  ...
  factory ConnectToTargetAzureDbForMySqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetAzureDbForMySqlTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (ConnectToTargetAzureDbForMySqlTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<ConnectToTargetAzureDbForMySqlTaskOutputResponse>(map['output'], (value) => ConnectToTargetAzureDbForMySqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
