...
class ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
  ...
  final pulumi.Input<List<ConnectToTargetAzureDbForMySqlTaskOutputResponse>> output;
  ...
  /// [taskType] Task type.
  const ConnectToTargetAzureDbForMySqlTaskPropertiesResponse({
    this.clientData,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<ConnectToTargetAzureDbForMySqlTaskInputResponse, Map<String, dynamic>>(input, (value) => value.toMap()),
      'output': pulumi.Input.mapInputValue<List<ConnectToTargetAzureDbForMySqlTaskOutputResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<ConnectToTargetAzureDbForMySqlTaskOutputResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }

  factory ConnectToTargetAzureDbForMySqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetAzureDbForMySqlTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectToTargetAzureDbForMySqlTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectToTargetAzureDbForMySqlTaskOutputResponse>(map['output']!, (value) => ConnectToTargetAzureDbForMySqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
