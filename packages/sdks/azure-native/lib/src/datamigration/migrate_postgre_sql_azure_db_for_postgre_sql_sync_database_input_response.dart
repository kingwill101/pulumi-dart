...
class MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse {
  ...
  final pulumi.Input<
    List<MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInputResponse>
  >?
  selectedTables;
  ...
  factory MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse.fromMap(
    ...
    return MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInputResponse(
      ...
      selectedTables: (() {
        final guardedValue = map['selectedTables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInputResponse.fromMap(
