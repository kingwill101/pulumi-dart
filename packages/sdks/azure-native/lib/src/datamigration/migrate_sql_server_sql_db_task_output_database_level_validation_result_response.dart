...
class MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse {
  ...
  final pulumi.Input<DataIntegrityValidationResultResponse>
  ...
  final pulumi.Input<QueryAnalysisValidationResultResponse>
  ...
  final pulumi.Input<SchemaComparisonValidationResultResponse>
    ...
    return <String, dynamic>{
      'dataIntegrityValidationResult':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(dataIntegrityValidationResult, (value) => value.toMap()),
      'endedOn': endedOn,
      'id': id,
      ...
      'queryAnalysisValidationResult':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(queryAnalysisValidationResult, (value) => value.toMap()),
      'resultType': resultType,
      'schemaValidationResult':
          pulumi.Input.mapInputValue<
            SchemaComparisonValidationResultResponse,
            Map<String, dynamic>
          >(schemaValidationResult, (value) => value.toMap()),
  ...
  factory MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return MigrateSqlServerSqlDbTaskOutputDatabaseLevelValidationResultResponse(
      dataIntegrityValidationResult: pulumi.Input.fromValue(
        DataIntegrityValidationResultResponse.fromMap(
          (map['dataIntegrityValidationResult']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      ...
      queryAnalysisValidationResult: pulumi.Input.fromValue(
        QueryAnalysisValidationResultResponse.fromMap(
          (map['queryAnalysisValidationResult']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      resultType: pulumi.Input.fromValue(map['resultType'] as String),
      schemaValidationResult: pulumi.Input.fromValue(
        SchemaComparisonValidationResultResponse.fromMap(
          (map['schemaValidationResult']! as Map).cast<String, dynamic>(),
        ),
      ),
