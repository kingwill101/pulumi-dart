...
class ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse {
  ...
  factory ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ValidateMigrationInputSqlServerSqlMITaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (ValidateMigrationInputSqlServerSqlMITaskInputResponse.fromMap((map['input']! as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<ValidateMigrationInputSqlServerSqlMITaskOutputResponse>(map['output'], (value) => ValidateMigrationInputSqlServerSqlMITaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
