...
class BackupSetInfoResponse {
  ...
  factory BackupSetInfoResponse.fromMap(Map<String, dynamic> map) {
    return BackupSetInfoResponse(
      backupFinishedDate: (() {
        final guardedValue = map['backupFinishedDate'];
      ...
      backupStartDate: (() {
        final guardedValue = map['backupStartDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      backupType: (() {
      ...
      firstLsn: (() {
        final guardedValue = map['firstLsn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      isBackupRestored: (() {
        final guardedValue = map['isBackupRestored'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      lastLsn: (() {
        final guardedValue = map['lastLsn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastModifiedTime: (() {
      ...
      listOfBackupFiles: (() {
        final guardedValue = map['listOfBackupFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BackupFileInfoResponse>(
            guardedValue,
            (value) => BackupFileInfoResponse.fromMap(
