...
class MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse {
  ...
  /// Creates a new [MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse].
  /// [errorMessage] Error message
  /// [events] List of error events.
  /// [id] Result identifier
  /// [resultType] Result type
  const MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse({
    this.errorMessage,
    this.events,
    required this.id,
  ...
  factory MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbSyncTaskOutputDatabaseErrorResponse(
