...
class ConnectToTargetSqlMISyncTaskPropertiesResponse {
  ...
  factory ConnectToTargetSqlMISyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetSqlMISyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (ConnectToTargetSqlMISyncTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<ConnectToTargetSqlMISyncTaskOutputResponse>(map['output'], (value) => ConnectToTargetSqlMISyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
