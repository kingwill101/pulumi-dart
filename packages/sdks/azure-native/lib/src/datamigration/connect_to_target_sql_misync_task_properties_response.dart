...
class ConnectToTargetSqlMISyncTaskPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output':
          pulumi.Input.mapInputValue<
            List<ConnectToTargetSqlMISyncTaskOutputResponse>,
            List<Map<String, dynamic>>
          >(
            output,
            (value) =>
  ...
  factory ConnectToTargetSqlMISyncTaskPropertiesResponse.fromMap(
    ...
    return ConnectToTargetSqlMISyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToTargetSqlMISyncTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectToTargetSqlMISyncTaskOutputResponse>(
          map['output']!,
          (value) => ConnectToTargetSqlMISyncTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
