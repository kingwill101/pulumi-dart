...
class ConnectToTargetSqlMISyncTaskPropertiesResponse {
  ...
  /// Task input
  final ConnectToTargetSqlMISyncTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<ConnectToTargetSqlMISyncTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<ConnectToTargetSqlMISyncTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToTargetSqlMISyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetSqlMISyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : ConnectToTargetSqlMISyncTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<ConnectToTargetSqlMISyncTaskOutputResponse>(map['output'], (value) => ConnectToTargetSqlMISyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
