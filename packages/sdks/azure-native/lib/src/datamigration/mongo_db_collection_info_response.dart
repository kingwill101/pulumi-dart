...
class MongoDbCollectionInfoResponse {
  ...
  factory MongoDbCollectionInfoResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbCollectionInfoResponse(
      averageDocumentSize: pulumi.Input.fromValue(
        map['averageDocumentSize'] as double,
      ),
      ...
      isSystemCollection: pulumi.Input.fromValue(
        map['isSystemCollection'] as bool,
      ),
      ...
      shardKey: (() {
        ...
        return pulumi.Input.fromValue(
          MongoDbShardKeyInfoResponse.fromMap(
