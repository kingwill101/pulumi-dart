...
class MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse {
  ...
  /// [taskType] Task type.
  const MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse({
    this.clientData,
  ...
  factory MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateMySqlAzureDbForMySqlSyncTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrateMySqlAzureDbForMySqlSyncTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseErrorResponse>(map['output']!, (value) => MigrateMySqlAzureDbForMySqlSyncTaskOutputDatabaseErrorResponse.fromMap((value as Map).cast<String, dynamic>()))),
