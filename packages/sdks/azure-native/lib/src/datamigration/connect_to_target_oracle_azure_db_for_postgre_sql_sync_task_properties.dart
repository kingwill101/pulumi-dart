...
class ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties {
  ...
  /// Task input
  final pulumi.Input<ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskInput>?
  input;
  ...
  factory ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties.fromMap(
    ...
    return ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskProperties(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToTargetOracleAzureDbForPostgreSqlSyncTaskInput.fromMap(
