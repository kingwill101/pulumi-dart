...
/// }
///
/// resource "azure-native_datamigration_sqlmigrationservice" "sqlMigrationService" {
///   location                   = "northeurope"
...
class SqlMigrationService extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [SqlMigrationService] resource.
  SqlMigrationService.reference(String urn)
    : super(
        'azure-native:datamigration:SqlMigrationService',
