...
class MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInput {
  ...
  final pulumi.Input<
    List<MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInput>
  >?
  selectedTables;
  ...
  factory MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseInput.fromMap(
      ...
      selectedTables: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInput.fromMap(
