...
class MigrateSqlServerSqlMISyncTaskPropertiesResponse {
  ...
  factory MigrateSqlServerSqlMISyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlMISyncTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrateSqlServerSqlMISyncTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse>(map['output']!, (value) => MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse.fromMap((value as Map).cast<String, dynamic>()))),
