...
class MigrateSqlServerSqlMISyncTaskPropertiesResponse {
  ...
  final pulumi.Input<
    List<MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse>
  >
  output;
  ...
  factory MigrateSqlServerSqlMISyncTaskPropertiesResponse.fromMap(
    ...
    return MigrateSqlServerSqlMISyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MigrateSqlServerSqlMISyncTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
