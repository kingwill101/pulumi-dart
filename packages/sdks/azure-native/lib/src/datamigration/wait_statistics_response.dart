...
class WaitStatisticsResponse {
  ...
  WaitStatisticsResponse({
    this.waitCount,
    pulumi.Input<double?>? waitTimeMs,
    this.waitType,
  }) : waitTimeMs = waitTimeMs ?? pulumi.Input.fromValue(0);
  ...
  factory WaitStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return WaitStatisticsResponse(
      waitCount: (() { final guardedValue = map['waitCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      waitTimeMs: (() { final guardedValue = map['waitTimeMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
