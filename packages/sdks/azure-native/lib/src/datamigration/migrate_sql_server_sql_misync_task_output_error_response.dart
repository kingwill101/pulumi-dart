...
class MigrateSqlServerSqlMISyncTaskOutputErrorResponse {
  /// Migration error
  ...
  /// Creates a new [MigrateSqlServerSqlMISyncTaskOutputErrorResponse].
  ...
  factory MigrateSqlServerSqlMISyncTaskOutputErrorResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlMISyncTaskOutputErrorResponse(
