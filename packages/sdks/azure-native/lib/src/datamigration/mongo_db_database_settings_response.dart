...
class MongoDbDatabaseSettingsResponse {
  ...
  final pulumi.Input<Map<String, MongoDbCollectionSettingsResponse>>
  collections;
  ...
  MongoDbDatabaseSettingsResponse({required this.collections, this.targetRUs});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'collections':
          pulumi.Input.mapInputValue<
            Map<String, MongoDbCollectionSettingsResponse>,
  ...
  factory MongoDbDatabaseSettingsResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbDatabaseSettingsResponse(
      collections: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<MongoDbCollectionSettingsResponse>(
          map['collections']!,
          (value) => MongoDbCollectionSettingsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      targetRUs: (() {
        final guardedValue = map['targetRUs'];
