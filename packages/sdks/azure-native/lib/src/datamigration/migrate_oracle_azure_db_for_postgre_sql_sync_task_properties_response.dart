...
class MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse>?
  input;

  /// Task output. This is ignored if submitted.
  final pulumi.Input<
    List<MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseErrorResponse>
  >
  output;
  ...
  factory MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse.fromMap(
    ...
    return MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseErrorResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
