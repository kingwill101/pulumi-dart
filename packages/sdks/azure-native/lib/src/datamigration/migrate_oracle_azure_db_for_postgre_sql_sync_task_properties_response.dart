...
class MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse {
  ...
  factory MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateOracleAzureDbForPostgreSqlSyncTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrateOracleAzureDbPostgreSqlSyncTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseErrorResponse>(map['output']!, (value) => MigrateOracleAzureDbPostgreSqlSyncTaskOutputDatabaseErrorResponse.fromMap((value as Map).cast<String, dynamic>()))),
