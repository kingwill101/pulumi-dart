...
class ConnectToSourceMySqlTaskPropertiesResponse {
  ...
  /// Task input
  final ConnectToSourceMySqlTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<ConnectToSourceNonSqlTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<ConnectToSourceNonSqlTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToSourceMySqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToSourceMySqlTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : ConnectToSourceMySqlTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<ConnectToSourceNonSqlTaskOutputResponse>(map['output'], (value) => ConnectToSourceNonSqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
