...
class MongoDbDatabaseProgressResponse {
  ...
  final pulumi.Input<Map<String, MongoDbCollectionProgressResponse>>?
  collections;
    ...
    return <String, dynamic>{
      ...
      'collections':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, MongoDbCollectionProgressResponse>,
    ...
    return MongoDbDatabaseProgressResponse(
      ...
      collections: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<MongoDbCollectionProgressResponse>(
            guardedValue,
            (value) => MongoDbCollectionProgressResponse.fromMap(
