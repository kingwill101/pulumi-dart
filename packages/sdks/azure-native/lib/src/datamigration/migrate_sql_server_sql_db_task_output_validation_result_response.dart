...
class MigrateSqlServerSqlDbTaskOutputValidationResultResponse {
  ...
  final pulumi.Input<
    Map<String, MigrationValidationDatabaseSummaryResultResponse>
  >?
  summaryResults;
  ...
  factory MigrateSqlServerSqlDbTaskOutputValidationResultResponse.fromMap(
    ...
    return MigrateSqlServerSqlDbTaskOutputValidationResultResponse(
      ...
      summaryResults: (() {
        final guardedValue = map['summaryResults'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => MigrationValidationDatabaseSummaryResultResponse.fromMap(
