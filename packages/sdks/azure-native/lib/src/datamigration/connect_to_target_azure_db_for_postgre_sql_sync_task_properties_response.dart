...
class ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse>?
  input;
  ...
  factory ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse.fromMap(
    ...
    return ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
