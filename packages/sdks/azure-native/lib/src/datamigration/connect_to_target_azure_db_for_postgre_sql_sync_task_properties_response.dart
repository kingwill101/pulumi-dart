...
class ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse {
  ...
  factory ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetAzureDbForPostgreSqlSyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (ConnectToTargetAzureDbForPostgreSqlSyncTaskInputResponse.fromMap((map['input']! as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputResponse>(map['output'], (value) => ConnectToTargetAzureDbForPostgreSqlSyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
