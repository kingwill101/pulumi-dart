...
class ExecutionStatisticsResponse {
    ...
    return <String, dynamic>{
      ...
      'waitStats':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, WaitStatisticsResponse>,
  ...
  factory ExecutionStatisticsResponse.fromMap(Map<String, dynamic> map) {
    return ExecutionStatisticsResponse(
      cpuTimeMs: (() {
        final guardedValue = map['cpuTimeMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      elapsedTimeMs: (() {
        final guardedValue = map['elapsedTimeMs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      executionCount: (() {
        final guardedValue = map['executionCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      hasErrors: (() {
        final guardedValue = map['hasErrors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sqlErrors: (() {
        final guardedValue = map['sqlErrors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      waitStats: (() {
        final guardedValue = map['waitStats'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<WaitStatisticsResponse>(
            guardedValue,
            (value) => WaitStatisticsResponse.fromMap(
