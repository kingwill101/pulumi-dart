...
class GetUserTablesSqlSyncTaskPropertiesResponse {
  ...
  factory GetUserTablesSqlSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesSqlSyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (GetUserTablesSqlSyncTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<GetUserTablesSqlSyncTaskOutputResponse>(map['output'], (value) => GetUserTablesSqlSyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
