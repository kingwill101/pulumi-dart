...
class GetUserTablesSqlSyncTaskPropertiesResponse {
  ...
  factory GetUserTablesSqlSyncTaskPropertiesResponse.fromMap(
    ...
    return GetUserTablesSqlSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetUserTablesSqlSyncTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUserTablesSqlSyncTaskOutputResponse>(
          map['output']!,
          (value) => GetUserTablesSqlSyncTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
