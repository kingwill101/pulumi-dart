...
class BackupConfigurationResponse {
  ...
  BackupConfigurationResponse({this.sourceLocation, this.targetLocation});
    ...
    return <String, dynamic>{
      'sourceLocation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sourceLocation, (value) => value.toMap()),
      'targetLocation':
          ?pulumi.Input.mapOptionalInputValue<
            TargetLocationResponse,
            Map<String, dynamic>
          >(targetLocation, (value) => value.toMap()),
    };
  }
    ...
    return BackupConfigurationResponse(
      sourceLocation: (() {
        ...
        return pulumi.Input.fromValue(
          SourceLocationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      targetLocation: (() {
        final guardedValue = map['targetLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TargetLocationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
