...
class GetUserTablesSqlSyncTaskOutputResponse {
  ...
  factory GetUserTablesSqlSyncTaskOutputResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesSqlSyncTaskOutputResponse(
      databasesToSourceTables: (pulumi.Input.decodeMapValues<List<DatabaseTableResponse>>(map['databasesToSourceTables'], (value) => pulumi.Input.decodeList<DatabaseTableResponse>(value, (value) => DatabaseTableResponse.fromMap((value as Map).cast<String, dynamic>())))).input(),
      databasesToTargetTables: (pulumi.Input.decodeMapValues<List<DatabaseTableResponse>>(map['databasesToTargetTables'], (value) => pulumi.Input.decodeList<DatabaseTableResponse>(value, (value) => DatabaseTableResponse.fromMap((value as Map).cast<String, dynamic>())))).input(),
      tableValidationErrors: ((map['tableValidationErrors'] as Map).cast<String, List<String>>()).input(),
