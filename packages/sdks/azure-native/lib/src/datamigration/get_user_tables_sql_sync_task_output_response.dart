...
class GetUserTablesSqlSyncTaskOutputResponse {
  ...
  final pulumi.Input<Map<String, List<DatabaseTableResponse>>>
    ...
    return <String, dynamic>{
      'databasesToSourceTables':
          pulumi.Input.mapInputValue<
            Map<String, List<DatabaseTableResponse>>,
  ...
  factory GetUserTablesSqlSyncTaskOutputResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetUserTablesSqlSyncTaskOutputResponse(
      databasesToSourceTables: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<List<DatabaseTableResponse>>(
          map['databasesToSourceTables']!,
          (value) => pulumi.Input.decodeList<DatabaseTableResponse>(
            value,
      ...
      databasesToTargetTables: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<List<DatabaseTableResponse>>(
          map['databasesToTargetTables']!,
          (value) => pulumi.Input.decodeList<DatabaseTableResponse>(
            value,
            (value) => DatabaseTableResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
      ...
      tableValidationErrors: pulumi.Input.fromValue(
        (map['tableValidationErrors'] as Map).cast<String, List<String>>(),
      ),
