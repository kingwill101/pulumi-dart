...
class MigrateSqlServerSqlMITaskOutputMigrationLevelResponse {
  ...
  factory MigrateSqlServerSqlMITaskOutputMigrationLevelResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlMITaskOutputMigrationLevelResponse(
      agentJobs: pulumi.Input.fromValue((map['agentJobs'] as Map).cast<String, String>()),
      ...
      logins: pulumi.Input.fromValue((map['logins'] as Map).cast<String, String>()),
      message: pulumi.Input.fromValue(map['message'] as String),
      orphanedUsersInfo: pulumi.Input.fromValue(pulumi.Input.decodeList<OrphanedUserInfoResponse>(map['orphanedUsersInfo']!, (value) => OrphanedUserInfoResponse.fromMap((value as Map).cast<String, dynamic>()))),
      resultType: pulumi.Input.fromValue(map['resultType'] as String),
      serverRoleResults: pulumi.Input.fromValue(pulumi.Input.decodeMapValues<StartMigrationScenarioServerRoleResultResponse>(map['serverRoleResults']!, (value) => StartMigrationScenarioServerRoleResultResponse.fromMap((value as Map).cast<String, dynamic>()))),
