...
import 'migrate_ssis_task_output_migration_level_response.dart';
...
class MigrateSsisTaskPropertiesResponse {
  ...
  final pulumi.Input<List<MigrateSsisTaskOutputMigrationLevelResponse>> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.mapInputValue<List<MigrateSsisTaskOutputMigrationLevelResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<MigrateSsisTaskOutputMigrationLevelResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory MigrateSsisTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSsisTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (MigrateSsisTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<MigrateSsisTaskOutputMigrationLevelResponse>(map['output'], (value) => MigrateSsisTaskOutputMigrationLevelResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
