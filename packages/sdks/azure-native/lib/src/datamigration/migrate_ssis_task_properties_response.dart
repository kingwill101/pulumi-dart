...
class MigrateSsisTaskPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output':
          pulumi.Input.mapInputValue<
            List<MigrateSsisTaskOutputMigrationLevelResponse>,
            List<Map<String, dynamic>>
          >(
            output,
            (value) =>
  ...
  factory MigrateSsisTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSsisTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MigrateSsisTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MigrateSsisTaskOutputMigrationLevelResponse>(
          map['output']!,
          (value) => MigrateSsisTaskOutputMigrationLevelResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
