...
class MigrateSsisTaskPropertiesResponse {
  ...
  factory MigrateSsisTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSsisTaskPropertiesResponse(
      ...
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<MigrateSsisTaskOutputMigrationLevelResponse>(map['output']!, (value) => MigrateSsisTaskOutputMigrationLevelResponse.fromMap((value as Map).cast<String, dynamic>()))),
