...
class MigrateSsisTaskPropertiesResponse {
  ...
  /// Task input
  final MigrateSsisTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<MigrateSsisTaskOutputMigrationLevelResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<MigrateSsisTaskOutputMigrationLevelResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory MigrateSsisTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSsisTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : MigrateSsisTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<MigrateSsisTaskOutputMigrationLevelResponse>(map['output'], (value) => MigrateSsisTaskOutputMigrationLevelResponse.fromMap((value as Map).cast<String, dynamic>())),
