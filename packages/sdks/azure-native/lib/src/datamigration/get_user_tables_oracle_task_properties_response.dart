...
class GetUserTablesOracleTaskPropertiesResponse {
  ...
  factory GetUserTablesOracleTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesOracleTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (GetUserTablesOracleTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<GetUserTablesOracleTaskOutputResponse>(map['output'], (value) => GetUserTablesOracleTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
