...
class GetUserTablesOracleTaskPropertiesResponse {
  ...
  /// Task input
  final GetUserTablesOracleTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<GetUserTablesOracleTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<GetUserTablesOracleTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory GetUserTablesOracleTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesOracleTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : GetUserTablesOracleTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<GetUserTablesOracleTaskOutputResponse>(map['output'], (value) => GetUserTablesOracleTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
