...
class GetTdeCertificatesSqlTaskInput {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backupFileShare':
          pulumi.Input.mapInputValue<FileShare, Map<String, dynamic>>(
            backupFileShare,
            (value) => value.toMap(),
          ),
      'connectionInfo':
  ...
  factory GetTdeCertificatesSqlTaskInput.fromMap(Map<String, dynamic> map) {
    return GetTdeCertificatesSqlTaskInput(
      ...
      selectedCertificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SelectedCertificateInput>(
          map['selectedCertificates']!,
          (value) => SelectedCertificateInput.fromMap(
