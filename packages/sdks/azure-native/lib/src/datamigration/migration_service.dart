...
/// }
///
/// resource "azure-native_datamigration_migrationservice" "migrationService" {
///   location               = "northeurope"
...
class MigrationService extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [MigrationService] resource.
  MigrationService.reference(String urn)
    : super(
        'azure-native:datamigration:MigrationService',
