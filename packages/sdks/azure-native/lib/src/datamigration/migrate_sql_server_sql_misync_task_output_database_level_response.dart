...
class MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse {
  ...
  factory MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return MigrateSqlServerSqlMISyncTaskOutputDatabaseLevelResponse(
      activeBackupSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BackupSetInfoResponse>(
          map['activeBackupSets']!,
          (value) => BackupSetInfoResponse.fromMap(
