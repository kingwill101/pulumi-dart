...
class MigrationStatusDetailsResponse {
    ...
    return <String, dynamic>{
      ...
      'fullBackupSetInfo':
          pulumi.Input.mapInputValue<
            SqlBackupSetInfoResponse,
            Map<String, dynamic>
          >(fullBackupSetInfo, (value) => value.toMap()),
      ...
      'lastRestoredBackupSetInfo':
          pulumi.Input.mapInputValue<
            SqlBackupSetInfoResponse,
            Map<String, dynamic>
          >(lastRestoredBackupSetInfo, (value) => value.toMap()),
  ...
  factory MigrationStatusDetailsResponse.fromMap(Map<String, dynamic> map) {
    return MigrationStatusDetailsResponse(
      activeBackupSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SqlBackupSetInfoResponse>(
          map['activeBackupSets']!,
          (value) => SqlBackupSetInfoResponse.fromMap(
      ...
      completeRestoreErrorMessage: pulumi.Input.fromValue(
        map['completeRestoreErrorMessage'] as String,
      ),
      currentRestoringFilename: pulumi.Input.fromValue(
        map['currentRestoringFilename'] as String,
      ),
      fileUploadBlockingErrors: pulumi.Input.fromValue(
        (map['fileUploadBlockingErrors'] as List).cast<String>(),
      ),
      fullBackupSetInfo: pulumi.Input.fromValue(
        SqlBackupSetInfoResponse.fromMap(
          (map['fullBackupSetInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      invalidFiles: pulumi.Input.fromValue(
        (map['invalidFiles'] as List).cast<String>(),
      ),
      isFullBackupRestored: pulumi.Input.fromValue(
        map['isFullBackupRestored'] as bool,
      ),
      lastRestoredBackupSetInfo: pulumi.Input.fromValue(
        SqlBackupSetInfoResponse.fromMap(
          (map['lastRestoredBackupSetInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      lastRestoredFilename: pulumi.Input.fromValue(
        map['lastRestoredFilename'] as String,
      ),
      migrationState: pulumi.Input.fromValue(map['migrationState'] as String),
      pendingLogBackupsCount: pulumi.Input.fromValue(
        map['pendingLogBackupsCount'] as int,
      ),
      restoreBlockingReason: pulumi.Input.fromValue(
        map['restoreBlockingReason'] as String,
      ),
    );
  }
}
