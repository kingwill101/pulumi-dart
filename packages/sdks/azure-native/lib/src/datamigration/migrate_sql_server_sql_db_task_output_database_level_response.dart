...
class MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponse {
  ...
  factory MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbTaskOutputDatabaseLevelResponse(
      ...
      errorCount: pulumi.Input.fromValue((map['errorCount'] as num).toDouble()),
      ...
      numberOfObjects: pulumi.Input.fromValue((map['numberOfObjects'] as num).toDouble()),
      numberOfObjectsCompleted: pulumi.Input.fromValue((map['numberOfObjectsCompleted'] as num).toDouble()),
