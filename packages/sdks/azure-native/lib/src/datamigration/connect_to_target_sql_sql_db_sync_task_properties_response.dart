...
class ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output':
          pulumi.Input.mapInputValue<
            List<ConnectToTargetSqlDbTaskOutputResponse>,
            List<Map<String, dynamic>>
          >(
            output,
            (value) =>
  ...
  factory ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse.fromMap(
    ...
    return ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToTargetSqlSqlDbSyncTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectToTargetSqlDbTaskOutputResponse>(
          map['output']!,
          (value) => ConnectToTargetSqlDbTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
