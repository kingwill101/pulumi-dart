...
import 'connect_to_target_sql_sql_db_sync_task_input_response.dart';
import 'migrate_misync_complete_command_properties_response.dart';
import 'odata_error_response.dart';

/// Properties for the task that validates connection to SQL DB and target server requirements for online migration
class ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<ConnectToTargetSqlSqlDbSyncTaskInputResponse>? input;
  ...
  /// Creates a new [ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse].
  ...
  /// [taskType] Task type.
  const ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse({
    this.clientData,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<ConnectToTargetSqlSqlDbSyncTaskInputResponse, Map<String, dynamic>>(input, (value) => value.toMap()),
  ...
  factory ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetSqlSqlDbSyncTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectToTargetSqlSqlDbSyncTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectToTargetSqlDbTaskOutputResponse>(map['output']!, (value) => ConnectToTargetSqlDbTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
