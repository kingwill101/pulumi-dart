...
class MigrateSqlServerSqlDbTaskOutputErrorResponse {
  /// Migration error
  ...
  /// Creates a new [MigrateSqlServerSqlDbTaskOutputErrorResponse].
  ...
  factory MigrateSqlServerSqlDbTaskOutputErrorResponse.fromMap(Map<String, dynamic> map) {
    return MigrateSqlServerSqlDbTaskOutputErrorResponse(
