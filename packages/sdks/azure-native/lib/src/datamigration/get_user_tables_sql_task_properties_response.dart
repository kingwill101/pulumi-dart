...
class GetUserTablesSqlTaskPropertiesResponse {
  ...
  factory GetUserTablesSqlTaskPropertiesResponse.fromMap(
    ...
    return GetUserTablesSqlTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetUserTablesSqlTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUserTablesSqlTaskOutputResponse>(
          map['output']!,
          (value) => GetUserTablesSqlTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
