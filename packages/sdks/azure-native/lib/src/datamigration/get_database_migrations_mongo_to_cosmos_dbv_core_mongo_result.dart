...
class GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'collectionList': ?(() {
        final guardedValue = collectionList;
  ...
  factory GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult.fromMap(
    ...
    return GetDatabaseMigrationsMongoToCosmosDbvCoreMongoResult(
      ...
      collectionList: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<MongoMigrationCollectionResponse>(
          guardedValue,
          (value) => MongoMigrationCollectionResponse.fromMap(
      ...
      migrationFailureError: ErrorInfoResponse.fromMap(
