...
class ValidateMigrationInputSqlServerSqlMITaskOutputResponse {
  ...
  final pulumi.Input<List<ReportableExceptionResponse>>
    ...
    return <String, dynamic>{
      ...
      'databaseBackupInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(databaseBackupInfo, (value) => value.toMap()),
  ...
  factory ValidateMigrationInputSqlServerSqlMITaskOutputResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ValidateMigrationInputSqlServerSqlMITaskOutputResponse(
      backupFolderErrors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ReportableExceptionResponse>(
          map['backupFolderErrors']!,
          (value) => ReportableExceptionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      backupShareCredentialsErrors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ReportableExceptionResponse>(
          map['backupShareCredentialsErrors']!,
          (value) => ReportableExceptionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      backupStorageAccountErrors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ReportableExceptionResponse>(
          map['backupStorageAccountErrors']!,
          (value) => ReportableExceptionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ...
      databaseBackupInfo: (() {
        final guardedValue = map['databaseBackupInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatabaseBackupInfoResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      existingBackupErrors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ReportableExceptionResponse>(
          map['existingBackupErrors']!,
          (value) => ReportableExceptionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ...
      restoreDatabaseNameErrors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ReportableExceptionResponse>(
          map['restoreDatabaseNameErrors']!,
          (value) => ReportableExceptionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
