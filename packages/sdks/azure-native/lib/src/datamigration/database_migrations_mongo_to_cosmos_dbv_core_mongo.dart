...
/// }
///
/// resource "azure-native_datamigration_databasemigrationsmongotocosmosdbvcoremongo" "databaseMigrationsMongoToCosmosDbvCoreMongo" {
///   collection_list {
...
class DatabaseMigrationsMongoToCosmosDbvCoreMongo extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DatabaseMigrationsMongoToCosmosDbvCoreMongo] resource.
  DatabaseMigrationsMongoToCosmosDbvCoreMongo.reference(String urn)
    : super(
        'azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbvCoreMongo',
