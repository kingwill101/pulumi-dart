...
class DatabaseMigrationPropertiesSqlDb {
  ...
  factory DatabaseMigrationPropertiesSqlDb.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationPropertiesSqlDb(
      ...
      targetSqlConnection: (() { final guardedValue = map['targetSqlConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlConnectionInformation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
