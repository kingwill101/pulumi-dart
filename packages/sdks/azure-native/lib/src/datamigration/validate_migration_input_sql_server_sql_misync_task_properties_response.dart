...
class ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
  ...
  /// Task input
  final ValidateMigrationInputSqlServerSqlMISyncTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : ValidateMigrationInputSqlServerSqlMISyncTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse>(map['output'], (value) => ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
