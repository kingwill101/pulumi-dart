...
class ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<ValidateMigrationInputSqlServerSqlMISyncTaskInputResponse>?
  input;
  ...
  factory ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse.fromMap(
    ...
    return ValidateMigrationInputSqlServerSqlMISyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ValidateMigrationInputSqlServerSqlMISyncTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        ...
        >(
          map['output']!,
          (value) =>
              ValidateMigrationInputSqlServerSqlMISyncTaskOutputResponse.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
