...
class MongoDbDatabaseSettings {
  ...
  MongoDbDatabaseSettings({required this.collections, this.targetRUs});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'collections':
          pulumi.Input.mapInputValue<
            Map<String, MongoDbCollectionSettings>,
  ...
  factory MongoDbDatabaseSettings.fromMap(Map<String, dynamic> map) {
    return MongoDbDatabaseSettings(
      collections: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<MongoDbCollectionSettings>(
          map['collections']!,
          (value) => MongoDbCollectionSettings.fromMap(
