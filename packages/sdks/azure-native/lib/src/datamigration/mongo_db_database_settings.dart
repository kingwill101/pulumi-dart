...
import 'mongo_db_collection_settings.dart';
...
class MongoDbDatabaseSettings {
  ...
  factory MongoDbDatabaseSettings.fromMap(Map<String, dynamic> map) {
    return MongoDbDatabaseSettings(
      collections: pulumi.Input.fromValue(pulumi.Input.decodeMapValues<MongoDbCollectionSettings>(map['collections']!, (value) => MongoDbCollectionSettings.fromMap((value as Map).cast<String, dynamic>()))),
