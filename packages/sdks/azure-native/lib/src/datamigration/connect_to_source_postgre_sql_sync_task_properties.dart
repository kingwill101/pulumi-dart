...
class ConnectToSourcePostgreSqlSyncTaskProperties {
  ...
  /// [input] Task input
  /// [taskType] Task type.
  const ConnectToSourcePostgreSqlSyncTaskProperties({
    this.clientData,
    this.input,
  ...
  factory ConnectToSourcePostgreSqlSyncTaskProperties.fromMap(Map<String, dynamic> map) {
    return ConnectToSourcePostgreSqlSyncTaskProperties(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectToSourcePostgreSqlSyncTaskInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
