...
class ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
  ...
  final pulumi.Input<List<ConnectToSourcePostgreSqlSyncTaskOutputResponse>>
  output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output':
          pulumi.Input.mapInputValue<
            List<ConnectToSourcePostgreSqlSyncTaskOutputResponse>,
            List<Map<String, dynamic>>
          >(
            output,
            (value) =>
  ...
  factory ConnectToSourcePostgreSqlSyncTaskPropertiesResponse.fromMap(
    ...
    return ConnectToSourcePostgreSqlSyncTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectToSourcePostgreSqlSyncTaskInputResponse.fromMap(
      ...
      output: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<ConnectToSourcePostgreSqlSyncTaskOutputResponse>(
          map['output']!,
          (value) => ConnectToSourcePostgreSqlSyncTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
