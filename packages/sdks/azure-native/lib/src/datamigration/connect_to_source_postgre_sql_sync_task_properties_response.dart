...
class ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
  ...
  /// Task input
  final ConnectToSourcePostgreSqlSyncTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<ConnectToSourcePostgreSqlSyncTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<ConnectToSourcePostgreSqlSyncTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToSourcePostgreSqlSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToSourcePostgreSqlSyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : ConnectToSourcePostgreSqlSyncTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<ConnectToSourcePostgreSqlSyncTaskOutputResponse>(map['output'], (value) => ConnectToSourcePostgreSqlSyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
