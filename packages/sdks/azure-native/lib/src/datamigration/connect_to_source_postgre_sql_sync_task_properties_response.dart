...
import 'connect_to_source_postgre_sql_sync_task_input_response.dart';
import 'connect_to_source_postgre_sql_sync_task_output_response.dart';
import 'migrate_misync_complete_command_properties_response.dart';
import 'odata_error_response.dart';

/// Properties for the task that validates connection to PostgreSQL server and source server requirements for online migration
class ConnectToSourcePostgreSqlSyncTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<ConnectToSourcePostgreSqlSyncTaskInputResponse>? input;
  /// Task output. This is ignored if submitted.
  final pulumi.Input<List<ConnectToSourcePostgreSqlSyncTaskOutputResponse>> output;
  ...
  /// Creates a new [ConnectToSourcePostgreSqlSyncTaskPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<ConnectToSourcePostgreSqlSyncTaskInputResponse, Map<String, dynamic>>(input, (value) => value.toMap()),
      'output': pulumi.Input.mapInputValue<List<ConnectToSourcePostgreSqlSyncTaskOutputResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<ConnectToSourcePostgreSqlSyncTaskOutputResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }

  factory ConnectToSourcePostgreSqlSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToSourcePostgreSqlSyncTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectToSourcePostgreSqlSyncTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectToSourcePostgreSqlSyncTaskOutputResponse>(map['output']!, (value) => ConnectToSourcePostgreSqlSyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
