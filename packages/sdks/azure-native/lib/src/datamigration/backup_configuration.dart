...
class BackupConfiguration {
  ...
  BackupConfiguration({this.sourceLocation, this.targetLocation});
    ...
    return BackupConfiguration(
      sourceLocation: (() {
        ...
        return pulumi.Input.fromValue(
          SourceLocation.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      targetLocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TargetLocation.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
