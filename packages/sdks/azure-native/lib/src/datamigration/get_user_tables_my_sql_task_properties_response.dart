...
class GetUserTablesMySqlTaskPropertiesResponse {
  ...
  factory GetUserTablesMySqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesMySqlTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (GetUserTablesMySqlTaskInputResponse.fromMap((map['input']! as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<GetUserTablesMySqlTaskOutputResponse>(map['output'], (value) => GetUserTablesMySqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
