...
class GetUserTablesMySqlTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<GetUserTablesMySqlTaskInputResponse>? input;
  /// Task output. This is ignored if submitted.
  final pulumi.Input<List<GetUserTablesMySqlTaskOutputResponse>> output;
  ...
  /// [taskType] Task type.
  const GetUserTablesMySqlTaskPropertiesResponse({
    this.clientData,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<GetUserTablesMySqlTaskInputResponse, Map<String, dynamic>>(input, (value) => value.toMap()),
      'output': pulumi.Input.mapInputValue<List<GetUserTablesMySqlTaskOutputResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<GetUserTablesMySqlTaskOutputResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory GetUserTablesMySqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesMySqlTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetUserTablesMySqlTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserTablesMySqlTaskOutputResponse>(map['output']!, (value) => GetUserTablesMySqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
