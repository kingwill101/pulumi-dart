...
class MigrateSyncCompleteCommandPropertiesResponse {
  ...
  factory MigrateSyncCompleteCommandPropertiesResponse.fromMap(
    ...
    return MigrateSyncCompleteCommandPropertiesResponse(
      ...
      input: (() {
        ...
        return pulumi.Input.fromValue(
          MigrateSyncCompleteCommandInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        MigrateSyncCompleteCommandOutputResponse.fromMap(
