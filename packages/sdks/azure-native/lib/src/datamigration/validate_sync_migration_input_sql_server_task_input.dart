...
class ValidateSyncMigrationInputSqlServerTaskInput {
  ...
  final pulumi.Input<List<MigrateSqlServerSqlDbSyncDatabaseInput>>
  selectedDatabases;
    ...
    return <String, dynamic>{
      'selectedDatabases':
          pulumi.Input.mapInputValue<
            List<MigrateSqlServerSqlDbSyncDatabaseInput>,
  ...
  factory ValidateSyncMigrationInputSqlServerTaskInput.fromMap(
    Map<String, dynamic> map,
  ) {
    return ValidateSyncMigrationInputSqlServerTaskInput(
      selectedDatabases: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MigrateSqlServerSqlDbSyncDatabaseInput>(
          map['selectedDatabases']!,
          (value) => MigrateSqlServerSqlDbSyncDatabaseInput.fromMap(
