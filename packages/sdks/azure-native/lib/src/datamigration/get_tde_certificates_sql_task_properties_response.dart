...
class GetTdeCertificatesSqlTaskPropertiesResponse {
  ...
  /// Task input
  final GetTdeCertificatesSqlTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<GetTdeCertificatesSqlTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<GetTdeCertificatesSqlTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory GetTdeCertificatesSqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetTdeCertificatesSqlTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : GetTdeCertificatesSqlTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<GetTdeCertificatesSqlTaskOutputResponse>(map['output'], (value) => GetTdeCertificatesSqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
