...
class GetTdeCertificatesSqlTaskPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output':
          pulumi.Input.mapInputValue<
            List<GetTdeCertificatesSqlTaskOutputResponse>,
            List<Map<String, dynamic>>
          >(
            output,
            (value) =>
  ...
  factory GetTdeCertificatesSqlTaskPropertiesResponse.fromMap(
    ...
    return GetTdeCertificatesSqlTaskPropertiesResponse(
      ...
      input: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GetTdeCertificatesSqlTaskInputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      output: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTdeCertificatesSqlTaskOutputResponse>(
          map['output']!,
          (value) => GetTdeCertificatesSqlTaskOutputResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
