...
import 'get_tde_certificates_sql_task_input_response.dart';
import 'get_tde_certificates_sql_task_output_response.dart';
import 'migrate_misync_complete_command_properties_response.dart';
import 'odata_error_response.dart';

/// Properties for the task that gets TDE certificates in Base64 encoded format.
class GetTdeCertificatesSqlTaskPropertiesResponse {
  ...
  /// Task input
  final pulumi.Input<GetTdeCertificatesSqlTaskInputResponse>? input;
  /// Task output. This is ignored if submitted.
  final pulumi.Input<List<GetTdeCertificatesSqlTaskOutputResponse>> output;
  ...
  /// Creates a new [GetTdeCertificatesSqlTaskPropertiesResponse].
  ...
  /// [taskType] Task type.
  const GetTdeCertificatesSqlTaskPropertiesResponse({
    this.clientData,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'input': ?pulumi.Input.mapOptionalInputValue<GetTdeCertificatesSqlTaskInputResponse, Map<String, dynamic>>(input, (value) => value.toMap()),
      'output': pulumi.Input.mapInputValue<List<GetTdeCertificatesSqlTaskOutputResponse>, List<Map<String, dynamic>>>(output, (value) => pulumi.Input.encodeList<GetTdeCertificatesSqlTaskOutputResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'state': state,
      'taskType': taskType,
    };
  }

  factory GetTdeCertificatesSqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetTdeCertificatesSqlTaskPropertiesResponse(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetTdeCertificatesSqlTaskInputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTdeCertificatesSqlTaskOutputResponse>(map['output']!, (value) => GetTdeCertificatesSqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))),
