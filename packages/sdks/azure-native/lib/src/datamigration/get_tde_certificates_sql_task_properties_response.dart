...
class GetTdeCertificatesSqlTaskPropertiesResponse {
  ...
  factory GetTdeCertificatesSqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetTdeCertificatesSqlTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : (GetTdeCertificatesSqlTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>())).input(),
      output: (pulumi.Input.decodeList<GetTdeCertificatesSqlTaskOutputResponse>(map['output'], (value) => GetTdeCertificatesSqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
