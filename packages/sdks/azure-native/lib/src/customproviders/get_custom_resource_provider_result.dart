...
class GetCustomResourceProviderResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceTypes': ?(() {
        final guardedValue = resourceTypes;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'type': type,
      'validations': ?(() {
        final guardedValue = validations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetCustomResourceProviderResult.fromMap(Map<String, dynamic> map) {
    return GetCustomResourceProviderResult(
      actions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<CustomRPActionRouteDefinitionResponse>(
          guardedValue,
          (value) => CustomRPActionRouteDefinitionResponse.fromMap(
      ...
      resourceTypes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<CustomRPResourceTypeRouteDefinitionResponse>(
          guardedValue,
          (value) => CustomRPResourceTypeRouteDefinitionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      validations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<CustomRPValidationsResponse>(
          guardedValue,
          (value) => CustomRPValidationsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
