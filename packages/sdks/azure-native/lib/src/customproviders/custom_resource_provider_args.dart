    ...
    return CustomResourceProviderArgs(
      actions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomRPActionRouteDefinition>(
            guardedValue,
            (value) => CustomRPActionRouteDefinition.fromMap(
      ...
      resourceProviderName: (() {
        final guardedValue = map['resourceProviderName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceTypes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomRPResourceTypeRouteDefinition>(
            guardedValue,
            (value) => CustomRPResourceTypeRouteDefinition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      validations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomRPValidations>(
            guardedValue,
            (value) => CustomRPValidations.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
