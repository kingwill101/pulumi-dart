...
class PublicCloudConnectorArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsCloudProfile':
          pulumi.Input.mapInputValue<AwsCloudProfile, Map<String, dynamic>>(
            awsCloudProfile,
            (value) => value.toMap(),
          ),
      'hostType': hostType,
  ...
  factory PublicCloudConnectorArgs.fromMap(Map<String, dynamic> map) {
    return PublicCloudConnectorArgs(
      awsCloudProfile: pulumi.Input.fromValue(
        AwsCloudProfile.fromMap(
      ...
      publicCloudConnector: (() {
        final guardedValue = map['publicCloudConnector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
