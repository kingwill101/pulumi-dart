...
class GetPublicCloudConnectorResult {
  ...
  const GetPublicCloudConnectorResult({
    this.awsCloudProfile,
    this.azureApiVersion,
    this.connectorPrimaryIdentifier,
    this.hostType,
    this.id,
    this.location,
    this.name,
  ...
  factory GetPublicCloudConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetPublicCloudConnectorResult(
      awsCloudProfile: (() { final guardedValue = map['awsCloudProfile']; if (guardedValue == null) return null; return AwsCloudProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      azureApiVersion: (() { final guardedValue = map['azureApiVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      connectorPrimaryIdentifier: (() { final guardedValue = map['connectorPrimaryIdentifier']; if (guardedValue == null) return null; return guardedValue as String; })(),
