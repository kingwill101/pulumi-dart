...
class AzureResourceResponse {
  ...
  factory AzureResourceResponse.fromMap(Map<String, dynamic> map) {
    return AzureResourceResponse(
      ...
      resourceProperties: (() { final guardedValue = map['resourceProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
