...
class CreateOrUpdateDryrunParametersResponse {
  ...
  factory CreateOrUpdateDryrunParametersResponse.fromMap(
    ...
    return CreateOrUpdateDryrunParametersResponse(
      ...
      authInfo: (() {
        ...
        return pulumi.Input.fromValue(
          AccessKeyInfoBaseResponse.fromMap(
      ...
      publicNetworkSolution: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PublicNetworkSolutionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
