...
class AccessKeyInfoBase {
  ...
  final pulumi.Input<List<dynamic>?>? permissions;
  ...
  factory AccessKeyInfoBase.fromMap(Map<String, dynamic> map) {
    return AccessKeyInfoBase(
      ...
      permissions: (() { final guardedValue = map['permissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
    );
  }
}
