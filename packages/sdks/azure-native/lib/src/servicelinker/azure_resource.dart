...
class AzureResource {
  ...
  final AzureKeyVaultProperties? resourceProperties;
  ...
  factory AzureResource.fromMap(Map<String, dynamic> map) {
    return AzureResource(
      ...
      resourceProperties: map['resourceProperties'] == null ? null : AzureKeyVaultProperties.fromMap((map['resourceProperties'] as Map).cast<String, dynamic>()),
