...
class ConfigurationInfoResponse {
  ...
  final ConfigurationStoreResponse? configurationStore;
  /// Optional. A dictionary of default key name and customized key name mapping. If not specified, default key name will be used for generate configurations
  final Map<String, String>? customizedKeys;
  /// Indicates some additional properties for dapr client type
  final DaprPropertiesResponse? daprProperties;
  ...
  factory ConfigurationInfoResponse.fromMap(Map<String, dynamic> map) {
    return ConfigurationInfoResponse(
      ...
      configurationStore: map['configurationStore'] == null ? null : ConfigurationStoreResponse.fromMap((map['configurationStore'] as Map).cast<String, dynamic>()),
      customizedKeys: map['customizedKeys'] == null ? null : (map['customizedKeys'] as Map).cast<String, String>(),
      daprProperties: map['daprProperties'] == null ? null : DaprPropertiesResponse.fromMap((map['daprProperties'] as Map).cast<String, dynamic>()),
