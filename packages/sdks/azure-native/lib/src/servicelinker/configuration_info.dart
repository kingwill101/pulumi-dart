...
class ConfigurationInfo {
  ...
  factory ConfigurationInfo.fromMap(Map<String, dynamic> map) {
    return ConfigurationInfo(
      ...
      configurationStore: map['configurationStore'] == null ? null : (ConfigurationStore.fromMap((map['configurationStore'] as Map).cast<String, dynamic>())).input(),
      customizedKeys: map['customizedKeys'] == null ? null : ((map['customizedKeys'] as Map).cast<String, String>()).input(),
      daprProperties: map['daprProperties'] == null ? null : (DaprProperties.fromMap((map['daprProperties'] as Map).cast<String, dynamic>())).input(),
