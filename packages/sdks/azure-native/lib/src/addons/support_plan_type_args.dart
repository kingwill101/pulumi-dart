...
class SupportPlanTypeArgs {
  ...
  factory SupportPlanTypeArgs.fromMap(Map<String, dynamic> map) {
    return SupportPlanTypeArgs(
      planTypeName: (() { final guardedValue = map['planTypeName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
