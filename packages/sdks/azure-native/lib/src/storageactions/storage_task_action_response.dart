...
class StorageTaskActionResponse {
  ...
  StorageTaskActionResponse({this.else_, required this.if_});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'if':
          pulumi.Input.mapInputValue<IfConditionResponse, Map<String, dynamic>>(
            if_,
            (value) => value.toMap(),
          ),
    };
    ...
    return StorageTaskActionResponse(
      else_: (() {
        ...
        return pulumi.Input.fromValue(
          ElseConditionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      if_: pulumi.Input.fromValue(
        IfConditionResponse.fromMap(
          (map['if']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
