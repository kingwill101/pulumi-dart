...
class IfCondition {
  ...
  IfCondition({required this.condition, required this.operations});
  ...
  factory IfCondition.fromMap(Map<String, dynamic> map) {
    return IfCondition(
      ...
      operations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StorageTaskOperation>(
          map['operations']!,
          (value) => StorageTaskOperation.fromMap(
