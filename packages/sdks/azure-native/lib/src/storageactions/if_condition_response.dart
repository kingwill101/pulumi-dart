...
class IfConditionResponse {
  ...
  factory IfConditionResponse.fromMap(Map<String, dynamic> map) {
    return IfConditionResponse(
      ...
      operations: pulumi.Input.fromValue(pulumi.Input.decodeList<StorageTaskOperationResponse>(map['operations']!, (value) => StorageTaskOperationResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
