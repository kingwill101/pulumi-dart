...
class ConfigurationReference extends pulumi.CustomResource {
  ...
  ConfigurationReference(
    ...
    properties = registerOutput<ConfigurationReferencePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ConfigurationReferencePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ConfigurationReference] resource.
  ConfigurationReference.reference(String urn)
    : super(
        'azure-native:edge:ConfigurationReference',
