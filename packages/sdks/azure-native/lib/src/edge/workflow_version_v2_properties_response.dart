...
class WorkflowVersionV2PropertiesResponse {
  ...
  /// Creates a new [WorkflowVersionV2PropertiesResponse].
  ...
  const WorkflowVersionV2PropertiesResponse({
  ...
  factory WorkflowVersionV2PropertiesResponse.fromMap(Map<String, dynamic> map) {
    return WorkflowVersionV2PropertiesResponse(
