...
class ContextProperties {
  ...
  factory ContextProperties.fromMap(Map<String, dynamic> map) {
    return ContextProperties(
      capabilities: (pulumi.Input.decodeList<Capability>(map['capabilities'], (value) => Capability.fromMap((value as Map).cast<String, dynamic>()))).input(),
      hierarchies: (pulumi.Input.decodeList<Hierarchy>(map['hierarchies'], (value) => Hierarchy.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
