...
/// }
///
/// resource "azure-native_edge_execution" "execution" {
///   context_name   = "abcde"
...
class Execution extends pulumi.CustomResource {
  ...
  Execution(
    ...
    properties = registerOutput<ExecutionPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ExecutionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [Execution] resource.
  Execution.reference(String urn)
    : super(
        'azure-native:edge:Execution',
