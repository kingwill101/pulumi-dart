...
class SiteReferenceArgs {
  ...
  factory SiteReferenceArgs.fromMap(Map<String, dynamic> map) {
    return SiteReferenceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SiteReferenceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      siteReferenceName: (() { final guardedValue = map['siteReferenceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
