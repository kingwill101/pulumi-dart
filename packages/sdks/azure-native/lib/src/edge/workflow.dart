...
/// }
///
/// resource "azure-native_edge_workflow" "workflow" {
...
class Workflow extends pulumi.CustomResource {
  ...
  Workflow(
    ...
    properties = registerOutput<WorkflowPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WorkflowPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
