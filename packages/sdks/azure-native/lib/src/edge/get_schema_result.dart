...
class GetSchemaResult {
  ...
  final SchemaPropertiesResponse? properties;
  ...
  factory GetSchemaResult.fromMap(Map<String, dynamic> map) {
    return GetSchemaResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return SchemaPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
