...
import 'dynamic_schema_version_args.dart';
...
/// 			DynamicSchemaVersionName: pulumi.String("1.0.0"),
...
/// }
///
/// resource "azure-native_edge_dynamicschemaversion" "dynamicSchemaVersion" {
...
/// ```
class DynamicSchemaVersion extends pulumi.CustomResource {
  ...
  /// Creates a new [DynamicSchemaVersion].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DynamicSchemaVersion]. {@macro pulumi_edge_dynamic_schema_version_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DynamicSchemaVersion(
    String name, {
    DynamicSchemaVersionArgs? args,
    ...
    properties = registerOutput<SchemaVersionPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SchemaVersionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [DynamicSchemaVersion] resource.
  DynamicSchemaVersion.reference(String urn)
    : super(
        'azure-native:edge:DynamicSchemaVersion',
