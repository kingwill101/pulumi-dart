...
class ExecutionArgs {
  ...
  factory ExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ExecutionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecutionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
