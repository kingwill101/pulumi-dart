...
class GetExecutionResult {
  ...
  final ExecutionPropertiesResponse? properties;
  ...
  factory GetExecutionResult.fromMap(Map<String, dynamic> map) {
    return GetExecutionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ExecutionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
