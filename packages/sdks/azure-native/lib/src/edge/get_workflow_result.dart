...
class GetWorkflowResult {
  ...
  final WorkflowPropertiesResponse? properties;
  ...
  factory GetWorkflowResult.fromMap(Map<String, dynamic> map) {
    return GetWorkflowResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return WorkflowPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
