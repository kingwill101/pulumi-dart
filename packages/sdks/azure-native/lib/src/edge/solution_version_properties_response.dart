...
class SolutionVersionPropertiesResponse {
  ...
  factory SolutionVersionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SolutionVersionPropertiesResponse(
      ...
      externalValidationId: pulumi.Input.fromValue(
        map['externalValidationId'] as String,
      ),
      latestActionTrackingUri: pulumi.Input.fromValue(
        map['latestActionTrackingUri'] as String,
      ),
      ...
      solutionDependencies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SolutionDependencyResponse>(
          map['solutionDependencies']!,
          (value) => SolutionDependencyResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      solutionInstanceName: pulumi.Input.fromValue(
        map['solutionInstanceName'] as String,
      ),
      ...
      targetDisplayName: pulumi.Input.fromValue(
        map['targetDisplayName'] as String,
      ),
      targetLevelConfiguration: pulumi.Input.fromValue(
        map['targetLevelConfiguration'] as String,
      ),
    );
  }
}
