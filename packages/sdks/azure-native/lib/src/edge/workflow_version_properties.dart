...
class WorkflowVersionProperties {
  ...
  WorkflowVersionProperties({this.specification, required this.stageSpec});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'stageSpec':
          pulumi
              .Input.mapInputValue<List<StageSpec>, List<Map<String, dynamic>>>(
            stageSpec,
            (value) => pulumi.Input.encodeList<StageSpec, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory WorkflowVersionProperties.fromMap(Map<String, dynamic> map) {
    return WorkflowVersionProperties(
      ...
      stageSpec: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StageSpec>(
          map['stageSpec']!,
          (value) => StageSpec.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
