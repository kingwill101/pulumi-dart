...
class ConfigTemplateArgs {
  ...
  factory ConfigTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ConfigTemplateArgs(
      configTemplateName: (() { final guardedValue = map['configTemplateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigTemplateProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
