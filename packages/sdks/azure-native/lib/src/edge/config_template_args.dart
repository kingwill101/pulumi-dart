...
class ConfigTemplateArgs {
  ...
  /// [tags] Resource tags.
  ConfigTemplateArgs({
    pulumi.Output<String>? configTemplateName,
    pulumi.Output<String>? location,
    pulumi.Output<ConfigTemplateProperties>? properties,
  ...
  factory ConfigTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ConfigTemplateArgs(
      configTemplateName: map['configTemplateName'] == null ? null : pulumi.Output.create<String>(map['configTemplateName'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      properties: map['properties'] == null ? null : pulumi.Output.create<ConfigTemplateProperties>(ConfigTemplateProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
