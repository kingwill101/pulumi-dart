...
/// }
///
/// resource "azure-native_offazure_webappdiscoverysitedatasourcescontroller" "webAppDiscoverySiteDataSourcesController" {
...
class WebAppDiscoverySiteDataSourcesController extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WebAppDiscoverySiteDataSourcesController] resource.
  WebAppDiscoverySiteDataSourcesController.reference(String urn)
    : super(
        'azure-native:offazure:WebAppDiscoverySiteDataSourcesController',
