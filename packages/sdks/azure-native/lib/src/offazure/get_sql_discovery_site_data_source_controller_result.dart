...
/// Result data returned by getSqlDiscoverySiteDataSourceController.
class GetSqlDiscoverySiteDataSourceControllerResult {
  ...
  /// Creates a new [GetSqlDiscoverySiteDataSourceControllerResult].
  ...
  const GetSqlDiscoverySiteDataSourceControllerResult({
  ...
  factory GetSqlDiscoverySiteDataSourceControllerResult.fromMap(Map<String, dynamic> map) {
