...
/// }
///
/// resource "azure-native_offazure_importsitescontroller" "importSitesController" {
...
class ImportSitesController extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ImportSitesController] resource.
  ImportSitesController.reference(String urn)
    : super(
        'azure-native:offazure:ImportSitesController',
