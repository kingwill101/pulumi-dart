...
/// {@template pulumi_offazure_server_sites_controller_args_doc}
/// The set of arguments for ServerSitesController.
/// {@endtemplate}
/// {@macro pulumi_offazure_server_sites_controller_args_doc}
class ServerSitesControllerArgs {
  ...
  /// Creates a new [ServerSitesControllerArgs].
  ...
  /// [siteName] Site name
  /// [tags] Resource tags.
  const ServerSitesControllerArgs({
    this.agentDetails,
    this.applianceName,
