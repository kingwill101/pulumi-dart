...
class RegistrationDefinitionPropertiesResponse {
  ...
  factory RegistrationDefinitionPropertiesResponse.fromMap(
    ...
    return RegistrationDefinitionPropertiesResponse(
      ...
      managedByTenantName: pulumi.Input.fromValue(
        map['managedByTenantName'] as String,
      ),
      manageeTenantId: pulumi.Input.fromValue(map['manageeTenantId'] as String),
      manageeTenantName: pulumi.Input.fromValue(
        map['manageeTenantName'] as String,
      ),
