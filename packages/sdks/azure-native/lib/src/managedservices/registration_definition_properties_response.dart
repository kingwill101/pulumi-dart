...
class RegistrationDefinitionPropertiesResponse {
  ...
  factory RegistrationDefinitionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RegistrationDefinitionPropertiesResponse(
      authorizations: pulumi.Input.fromValue(pulumi.Input.decodeList<AuthorizationResponse>(map['authorizations']!, (value) => AuthorizationResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      managedByTenantName: pulumi.Input.fromValue(map['managedByTenantName'] as String),
      manageeTenantId: pulumi.Input.fromValue(map['manageeTenantId'] as String),
      manageeTenantName: pulumi.Input.fromValue(map['manageeTenantName'] as String),
