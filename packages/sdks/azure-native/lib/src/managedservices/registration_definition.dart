...
/// }
///
/// resource "azure-native_managedservices_registrationdefinition" "registrationDefinition" {
///   plan = {
///     name      = "addesai-plan"
///     product   = "test"
///     publisher = "marketplace-test"
...
class RegistrationDefinition extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [RegistrationDefinition] resource.
  RegistrationDefinition.reference(String urn)
    : super(
        'azure-native:managedservices:RegistrationDefinition',
