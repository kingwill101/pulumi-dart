...
class RegistrationAssignmentPropertiesResponseProperties {
  ...
  final pulumi.Input<List<EligibleAuthorizationResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'eligibleAuthorizations':
          ?pulumi.Input.mapOptionalInputValue<
            List<EligibleAuthorizationResponse>,
            List<Map<String, dynamic>>
          >(
            eligibleAuthorizations,
            (value) =>
  ...
  factory RegistrationAssignmentPropertiesResponseProperties.fromMap(
    ...
    return RegistrationAssignmentPropertiesResponseProperties(
      authorizations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorizationResponse>(
            guardedValue,
            (value) => AuthorizationResponse.fromMap(
      ...
      eligibleAuthorizations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EligibleAuthorizationResponse>(
            guardedValue,
            (value) => EligibleAuthorizationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      managedByTenantName: (() {
        final guardedValue = map['managedByTenantName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      manageeTenantId: (() {
        final guardedValue = map['manageeTenantId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      manageeTenantName: (() {
        final guardedValue = map['manageeTenantName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      provisioningState: (() {
      ...
      registrationDefinitionName: (() {
        final guardedValue = map['registrationDefinitionName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
