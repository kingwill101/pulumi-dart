...
class RegistrationDefinitionProperties {
    ...
    return <String, dynamic>{
      'authorizations':
          ...
          >(
            authorizations,
            (value) =>
                pulumi.Input.encodeList<Authorization, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory RegistrationDefinitionProperties.fromMap(Map<String, dynamic> map) {
    return RegistrationDefinitionProperties(
      authorizations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<Authorization>(
          map['authorizations']!,
          (value) =>
              Authorization.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      description: (() {
      ...
      eligibleAuthorizations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EligibleAuthorization>(
            guardedValue,
            (value) => EligibleAuthorization.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      managedByTenantId: pulumi.Input.fromValue(
        map['managedByTenantId'] as String,
      ),
