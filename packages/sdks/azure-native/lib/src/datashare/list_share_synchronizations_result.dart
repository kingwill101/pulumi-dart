...
class ListShareSynchronizationsResult {
  ...
  ListShareSynchronizationsResult({this.nextLink, required this.value});
  ...
  factory ListShareSynchronizationsResult.fromMap(Map<String, dynamic> map) {
    return ListShareSynchronizationsResult(
      ...
      value: pulumi.Input.decodeList<ShareSynchronizationResponse>(
        map['value']!,
        (value) => ShareSynchronizationResponse.fromMap(
