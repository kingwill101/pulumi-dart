...
/// {@template pulumi_datashare_get_blob_data_set_mapping_args_doc}
/// Arguments for getBlobDataSetMapping.
/// {@endtemplate}
/// {@macro pulumi_datashare_get_blob_data_set_mapping_args_doc}
class GetBlobDataSetMappingArgs {
  ...
  factory GetBlobDataSetMappingArgs.fromMap(Map<String, dynamic> map) {
    return GetBlobDataSetMappingArgs(
