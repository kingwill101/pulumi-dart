...
import 'adlsgen1_file_data_set_args.dart';
...
/// }
///
/// resource "azure-native_datashare_adlsgen1filedataset" "adlsGen1FileDataSet" {
...
class ADLSGen1FileDataSet extends pulumi.CustomResource {
  ...
  /// Creates a new [ADLSGen1FileDataSet].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ADLSGen1FileDataSet]. {@macro pulumi_datashare_adlsgen1_file_data_set_args_doc}
  ...
  /// Creates a typed reference to an existing [ADLSGen1FileDataSet] resource.
  ADLSGen1FileDataSet.reference(String urn)
    : super(
        'azure-native:datashare:ADLSGen1FileDataSet',
