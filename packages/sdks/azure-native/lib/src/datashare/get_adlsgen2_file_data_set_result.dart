...
/// Result data returned by getADLSGen2FileDataSet.
class GetADLSGen2FileDataSetResult {
  ...
  /// Creates a new [GetADLSGen2FileDataSetResult].
  ...
  const GetADLSGen2FileDataSetResult({
  ...
  factory GetADLSGen2FileDataSetResult.fromMap(Map<String, dynamic> map) {
