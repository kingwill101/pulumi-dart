...
/// }
///
/// resource "azure-native_datashare_scheduledsynchronizationsetting" "scheduledSynchronizationSetting" {
...
class ScheduledSynchronizationSetting extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ScheduledSynchronizationSetting] resource.
  ScheduledSynchronizationSetting.reference(String urn)
    : super(
        'azure-native:datashare:ScheduledSynchronizationSetting',
