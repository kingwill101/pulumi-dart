...
/// }
///
/// resource "azure-native_datashare_adlsgen2filesystemdataset" "adlsGen2FileSystemDataSet" {
...
class ADLSGen2FileSystemDataSet extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ADLSGen2FileSystemDataSet] resource.
  ADLSGen2FileSystemDataSet.reference(String urn)
    : super(
        'azure-native:datashare:ADLSGen2FileSystemDataSet',
