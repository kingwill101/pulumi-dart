...
class InvitationArgs {
  ...
  factory InvitationArgs.fromMap(Map<String, dynamic> map) {
    return InvitationArgs(
      ...
      invitationName: (() { final guardedValue = map['invitationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      shareName: pulumi.Input.fromValue(map['shareName'] as String),
      targetActiveDirectoryId: (() { final guardedValue = map['targetActiveDirectoryId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      targetEmail: (() { final guardedValue = map['targetEmail']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      targetObjectId: (() { final guardedValue = map['targetObjectId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
