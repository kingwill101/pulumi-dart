...
/// Result data returned by getADLSGen2FileSystemDataSetMapping.
class GetADLSGen2FileSystemDataSetMappingResult {
  ...
  /// Creates a new [GetADLSGen2FileSystemDataSetMappingResult].
  ...
  const GetADLSGen2FileSystemDataSetMappingResult({
