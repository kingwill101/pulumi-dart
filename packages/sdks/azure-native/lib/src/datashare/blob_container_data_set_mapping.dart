...
/// }
///
/// resource "azure-native_datashare_blobcontainerdatasetmapping" "blobContainerDataSetMapping" {
...
class BlobContainerDataSetMapping extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [BlobContainerDataSetMapping] resource.
  BlobContainerDataSetMapping.reference(String urn)
    : super(
        'azure-native:datashare:BlobContainerDataSetMapping',
