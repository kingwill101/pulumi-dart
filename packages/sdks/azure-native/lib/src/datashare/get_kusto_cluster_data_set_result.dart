...
/// Result data returned by getKustoClusterDataSet.
class GetKustoClusterDataSetResult {
  ...
  /// Creates a new [GetKustoClusterDataSetResult].
  ...
  factory GetKustoClusterDataSetResult.fromMap(Map<String, dynamic> map) {
