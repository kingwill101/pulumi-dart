...
import 'adlsgen2_file_data_set_mapping_args.dart';
...
/// }
///
/// resource "azure-native_datashare_adlsgen2filedatasetmapping" "adlsGen2FileDataSetMapping" {
...
class ADLSGen2FileDataSetMapping extends pulumi.CustomResource {
  ...
  /// Creates a new [ADLSGen2FileDataSetMapping].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ADLSGen2FileDataSetMapping]. {@macro pulumi_datashare_adlsgen2_file_data_set_mapping_args_doc}
  ...
  /// Creates a typed reference to an existing [ADLSGen2FileDataSetMapping] resource.
  ADLSGen2FileDataSetMapping.reference(String urn)
    : super(
        'azure-native:datashare:ADLSGen2FileDataSetMapping',
