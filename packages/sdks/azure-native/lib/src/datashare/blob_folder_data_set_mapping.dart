...
import 'blob_folder_data_set_mapping_args.dart';
...
/// }
///
/// resource "azure-native_datashare_blobfolderdatasetmapping" "blobFolderDataSetMapping" {
...
class BlobFolderDataSetMapping extends pulumi.CustomResource {
  ...
  /// Creates a new [BlobFolderDataSetMapping].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BlobFolderDataSetMapping]. {@macro pulumi_datashare_blob_folder_data_set_mapping_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BlobFolderDataSetMapping(
    String name, {
    BlobFolderDataSetMappingArgs? args,
  ...
  /// Creates a typed reference to an existing [BlobFolderDataSetMapping] resource.
  BlobFolderDataSetMapping.reference(String urn)
    : super(
        'azure-native:datashare:BlobFolderDataSetMapping',
