...
import 'blob_folder_data_set_args.dart';
...
/// }
///
/// resource "azure-native_datashare_blobfolderdataset" "blobFolderDataSet" {
...
class BlobFolderDataSet extends pulumi.CustomResource {
  ...
  /// Creates a new [BlobFolderDataSet].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BlobFolderDataSet]. {@macro pulumi_datashare_blob_folder_data_set_args_doc}
  ...
  /// Creates a typed reference to an existing [BlobFolderDataSet] resource.
  BlobFolderDataSet.reference(String urn)
    : super(
        'azure-native:datashare:BlobFolderDataSet',
