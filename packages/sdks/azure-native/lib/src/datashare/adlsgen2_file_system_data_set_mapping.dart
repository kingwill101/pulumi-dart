...
/// }
///
/// resource "azure-native_datashare_adlsgen2filesystemdatasetmapping" "adlsGen2FileSystemDataSetMapping" {
...
class ADLSGen2FileSystemDataSetMapping extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ADLSGen2FileSystemDataSetMapping] resource.
  ADLSGen2FileSystemDataSetMapping.reference(String urn)
    : super(
        'azure-native:datashare:ADLSGen2FileSystemDataSetMapping',
