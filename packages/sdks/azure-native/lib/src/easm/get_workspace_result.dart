...
class GetWorkspaceResult {
  ...
  /// [dataPlaneEndpoint] Data plane endpoint.
  ...
  factory GetWorkspaceResult.fromMap(Map<String, dynamic> map) {
    return GetWorkspaceResult(
      ...
      dataPlaneEndpoint: (() { final guardedValue = map['dataPlaneEndpoint']; if (guardedValue == null) return null; return guardedValue as String; })(),
