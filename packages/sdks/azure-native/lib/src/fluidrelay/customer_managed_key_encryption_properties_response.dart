...
class CustomerManagedKeyEncryptionPropertiesResponse {
  ...
  final CustomerManagedKeyEncryptionPropertiesResponseKeyEncryptionKeyIdentity? keyEncryptionKeyIdentity;
  ...
  factory CustomerManagedKeyEncryptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CustomerManagedKeyEncryptionPropertiesResponse(
      keyEncryptionKeyIdentity: map['keyEncryptionKeyIdentity'] == null ? null : CustomerManagedKeyEncryptionPropertiesResponseKeyEncryptionKeyIdentity.fromMap((map['keyEncryptionKeyIdentity'] as Map).cast<String, dynamic>()),
