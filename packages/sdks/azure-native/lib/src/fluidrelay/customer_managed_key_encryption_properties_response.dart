...
import 'customer_managed_key_encryption_properties_response_key_encryption_key_identity.dart';

/// All Customer-managed key encryption properties for the resource.
class CustomerManagedKeyEncryptionPropertiesResponse {
  /// All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
  final pulumi.Input<CustomerManagedKeyEncryptionPropertiesResponseKeyEncryptionKeyIdentity>? keyEncryptionKeyIdentity;
  ...
  /// Creates a new [CustomerManagedKeyEncryptionPropertiesResponse].
  ...
  /// [keyEncryptionKeyUrl] key encryption key Url, with or without a version. Ex: https://contosovault.vault.azure.net/keys/contosokek/562a4bb76b524a1493a6afe8e536ee78 or https://contosovault.vault.azure.net/keys/contosokek. Key auto rotation is enabled by providing a key uri without version. Otherwise, customer is responsible for rotating the key. The keyEncryptionKeyIdentity(either SystemAssigned or UserAssigned) should have permission to access this key url.
  const CustomerManagedKeyEncryptionPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keyEncryptionKeyIdentity': ?pulumi.Input.mapOptionalInputValue<CustomerManagedKeyEncryptionPropertiesResponseKeyEncryptionKeyIdentity, Map<String, dynamic>>(keyEncryptionKeyIdentity, (value) => value.toMap()),
  ...
  factory CustomerManagedKeyEncryptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CustomerManagedKeyEncryptionPropertiesResponse(
      keyEncryptionKeyIdentity: (() { final guardedValue = map['keyEncryptionKeyIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerManagedKeyEncryptionPropertiesResponseKeyEncryptionKeyIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
