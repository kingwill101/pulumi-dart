...
class EncryptionPropertiesResponse {
  ...
  final CustomerManagedKeyEncryptionPropertiesResponse? customerManagedKeyEncryption;
  ...
  factory EncryptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EncryptionPropertiesResponse(
      customerManagedKeyEncryption: map['customerManagedKeyEncryption'] == null ? null : CustomerManagedKeyEncryptionPropertiesResponse.fromMap((map['customerManagedKeyEncryption'] as Map).cast<String, dynamic>()),
    );
  }
}
