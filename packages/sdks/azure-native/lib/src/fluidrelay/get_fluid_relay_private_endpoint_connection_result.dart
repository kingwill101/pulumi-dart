...
/// Result data returned by getFluidRelayPrivateEndpointConnection.
class GetFluidRelayPrivateEndpointConnectionResult {
  ...
  /// Creates a new [GetFluidRelayPrivateEndpointConnectionResult].
  ...
  const GetFluidRelayPrivateEndpointConnectionResult({
  ...
  factory GetFluidRelayPrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetFluidRelayPrivateEndpointConnectionResult(
