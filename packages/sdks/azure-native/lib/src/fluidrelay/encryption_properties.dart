...
class EncryptionProperties {
  ...
  final pulumi.Input<CustomerManagedKeyEncryptionProperties>?
  ...
  EncryptionProperties({this.customerManagedKeyEncryption});
    ...
    return EncryptionProperties(
      customerManagedKeyEncryption: (() {
        ...
        return pulumi.Input.fromValue(
          CustomerManagedKeyEncryptionProperties.fromMap(
