...
class CustomerManagedKeyEncryptionProperties {
  ...
  factory CustomerManagedKeyEncryptionProperties.fromMap(Map<String, dynamic> map) {
    return CustomerManagedKeyEncryptionProperties(
      keyEncryptionKeyIdentity: (() { final guardedValue = map['keyEncryptionKeyIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerManagedKeyEncryptionPropertiesKeyEncryptionKeyIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
