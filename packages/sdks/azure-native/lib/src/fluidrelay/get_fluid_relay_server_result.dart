...
class GetFluidRelayServerResult {
  ...
  factory GetFluidRelayServerResult.fromMap(Map<String, dynamic> map) {
    return GetFluidRelayServerResult(
      ...
      fluidRelayEndpoints: (() { final guardedValue = map['fluidRelayEndpoints']; if (guardedValue == null) return null; return FluidRelayEndpointsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      frsTenantId: (() { final guardedValue = map['frsTenantId']; if (guardedValue == null) return null; return guardedValue as String; })(),
