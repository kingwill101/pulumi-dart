...
class DatasetArgs {
  ...
  factory DatasetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetArgs(
      ...
      keys: (() { final guardedValue = map['keys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<DatasetPropertyKey>(guardedValue, (value) => DatasetPropertyKey.fromMap((value as Map).cast<String, dynamic>()))); })(),
