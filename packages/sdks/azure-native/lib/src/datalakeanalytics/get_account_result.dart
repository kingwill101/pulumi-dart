...
class GetAccountResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicDataLakeStoreAccounts': ?publicDataLakeStoreAccounts == null ? null : pulumi.Input.encodeList<DataLakeStoreAccountInformationResponse, Map<String, dynamic>>(publicDataLakeStoreAccounts!, (value) => value.toMap()),
  ...
  factory GetAccountResult.fromMap(Map<String, dynamic> map) {
    return GetAccountResult(
      ...
      firewallAllowAzureIps: map['firewallAllowAzureIps'] == null ? null : map['firewallAllowAzureIps']! as String,
      ...
      firewallState: map['firewallState'] == null ? null : map['firewallState']! as String,
      ...
      newTier: map['newTier'] == null ? null : map['newTier']! as String,
      provisioningState: map['provisioningState'] as String,
      publicDataLakeStoreAccounts: map['publicDataLakeStoreAccounts'] == null ? null : pulumi.Input.decodeList<DataLakeStoreAccountInformationResponse>(map['publicDataLakeStoreAccounts']!, (value) => DataLakeStoreAccountInformationResponse.fromMap((value as Map).cast<String, dynamic>())),
