...
class GetAccountResult {
  ...
  /// The list of Data Lake Store accounts associated with this account.
  final List<DataLakeStoreAccountInformationResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'computePolicies':
          pulumi.Input.encodeList<ComputePolicyResponse, Map<String, dynamic>>(
            computePolicies,
            (value) => value.toMap(),
          ),
      ...
      'dataLakeStoreAccounts':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(dataLakeStoreAccounts, (value) => value.toMap()),
      ...
      'hiveMetastores':
          pulumi.Input.encodeList<HiveMetastoreResponse, Map<String, dynamic>>(
            hiveMetastores,
            (value) => value.toMap(),
          ),
      'id': id,
      ...
      'publicDataLakeStoreAccounts': ?(() {
        final guardedValue = publicDataLakeStoreAccounts;
  ...
  factory GetAccountResult.fromMap(Map<String, dynamic> map) {
    return GetAccountResult(
      ...
      computePolicies: pulumi.Input.decodeList<ComputePolicyResponse>(
        map['computePolicies']!,
        (value) => ComputePolicyResponse.fromMap(
      ...
      dataLakeStoreAccounts:
          pulumi.Input.decodeList<DataLakeStoreAccountInformationResponse>(
            map['dataLakeStoreAccounts']!,
            (value) => DataLakeStoreAccountInformationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      defaultDataLakeStoreAccountType:
          map['defaultDataLakeStoreAccountType'] as String,
      ...
      hiveMetastores: pulumi.Input.decodeList<HiveMetastoreResponse>(
        map['hiveMetastores']!,
        (value) => HiveMetastoreResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      id: map['id'] as String,
      ...
      publicDataLakeStoreAccounts: (() {
        final guardedValue = map['publicDataLakeStoreAccounts'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<DataLakeStoreAccountInformationResponse>(
          guardedValue,
          (value) => DataLakeStoreAccountInformationResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
      ...
      storageAccounts:
          pulumi.Input.decodeList<StorageAccountInformationResponse>(
            map['storageAccounts']!,
            (value) => StorageAccountInformationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
