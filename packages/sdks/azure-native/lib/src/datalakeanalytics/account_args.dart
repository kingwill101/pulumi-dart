...
class AccountArgs {
  ...
  AccountArgs({
    ...
    pulumi.Output<List<CreateComputePolicyWithAccountParameters>>? computePolicies,
    required pulumi.Output<List<AddDataLakeStoreWithAccountParameters>> dataLakeStoreAccounts,
    required pulumi.Output<String> defaultDataLakeStoreAccount,
    ...
    pulumi.Output<int>? maxDegreeOfParallelism,
    pulumi.Output<int>? maxDegreeOfParallelismPerJob,
    pulumi.Output<int>? maxJobCount,
    pulumi.Output<int>? minPriorityPerJob,
    pulumi.Output<TierType>? newTier,
    pulumi.Output<int>? queryStoreRetention,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<List<AddStorageAccountWithAccountParameters>>? storageAccounts,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      computePolicies: map['computePolicies'] == null ? null : pulumi.Output.create<List<CreateComputePolicyWithAccountParameters>>(pulumi.Input.decodeList<CreateComputePolicyWithAccountParameters>(map['computePolicies'], (value) => CreateComputePolicyWithAccountParameters.fromMap((value as Map).cast<String, dynamic>()))),
      dataLakeStoreAccounts: pulumi.Output.create<List<AddDataLakeStoreWithAccountParameters>>(pulumi.Input.decodeList<AddDataLakeStoreWithAccountParameters>(map['dataLakeStoreAccounts'], (value) => AddDataLakeStoreWithAccountParameters.fromMap((value as Map).cast<String, dynamic>()))),
      defaultDataLakeStoreAccount: pulumi.Output.create<String>(map['defaultDataLakeStoreAccount'] as String),
      ...
      maxDegreeOfParallelism: map['maxDegreeOfParallelism'] == null ? null : pulumi.Output.create<int>(map['maxDegreeOfParallelism'] as int),
      ...
      maxJobCount: map['maxJobCount'] == null ? null : pulumi.Output.create<int>(map['maxJobCount'] as int),
      ...
      queryStoreRetention: map['queryStoreRetention'] == null ? null : pulumi.Output.create<int>(map['queryStoreRetention'] as int),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Output.create<List<AddStorageAccountWithAccountParameters>>(pulumi.Input.decodeList<AddStorageAccountWithAccountParameters>(map['storageAccounts'], (value) => AddStorageAccountWithAccountParameters.fromMap((value as Map).cast<String, dynamic>()))),
