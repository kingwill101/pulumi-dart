...
class AccountArgs {
  ...
  final pulumi.Input<List<CreateComputePolicyWithAccountParameters>>?
  computePolicies;

  /// The list of Data Lake Store accounts associated with this account.
  final pulumi.Input<List<AddDataLakeStoreWithAccountParameters>>
  ...
  final pulumi.Input<List<CreateFirewallRuleWithAccountParameters>>?
  firewallRules;
  ...
  final pulumi.Input<List<AddStorageAccountWithAccountParameters>>?
  storageAccounts;
    ...
    return <String, dynamic>{
      ...
      'firewallAllowAzureIps':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(firewallAllowAzureIps, (value) => value.wireValue),
      'firewallRules':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'firewallState':
          ?pulumi.Input.mapOptionalInputValue<FirewallState, String>(
            firewallState,
      ...
      'newTier': ?pulumi.Input.mapOptionalInputValue<TierType, String>(
        newTier,
        (value) => value.wireValue,
      ),
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      computePolicies: (() {
        final guardedValue = map['computePolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CreateComputePolicyWithAccountParameters>(
            guardedValue,
            (value) => CreateComputePolicyWithAccountParameters.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      dataLakeStoreAccounts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AddDataLakeStoreWithAccountParameters>(
          map['dataLakeStoreAccounts']!,
          (value) => AddDataLakeStoreWithAccountParameters.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      defaultDataLakeStoreAccount: pulumi.Input.fromValue(
        map['defaultDataLakeStoreAccount'] as String,
      ),
      firewallAllowAzureIps: (() {
        final guardedValue = map['firewallAllowAzureIps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirewallAllowAzureIpsState.fromValue(guardedValue as String),
        );
      })(),
      firewallRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CreateFirewallRuleWithAccountParameters>(
            guardedValue,
            (value) => CreateFirewallRuleWithAccountParameters.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      firewallState: (() {
        final guardedValue = map['firewallState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirewallState.fromValue(guardedValue as String),
        );
      })(),
      location: (() {
      ...
      maxDegreeOfParallelism: (() {
        final guardedValue = map['maxDegreeOfParallelism'];
        if (guardedValue == null) return null;
      ...
      newTier: (() {
        final guardedValue = map['newTier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TierType.fromValue(guardedValue as String),
        );
      })(),
      queryStoreRetention: (() {
        final guardedValue = map['queryStoreRetention'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ...
      storageAccounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AddStorageAccountWithAccountParameters>(
            guardedValue,
            (value) => AddStorageAccountWithAccountParameters.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
