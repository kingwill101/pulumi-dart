...
class AddDataLakeStoreWithAccountParameters {
  ...
  AddDataLakeStoreWithAccountParameters({required this.name, this.suffix});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'name': name, 'suffix': ?suffix};
  }

  factory AddDataLakeStoreWithAccountParameters.fromMap(
