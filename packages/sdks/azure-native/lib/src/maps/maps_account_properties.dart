    ...
    return <String, dynamic>{
      ...
      'linkedResources':
          ...
          >(
            linkedResources,
            (value) =>
                pulumi.Input.encodeList<LinkedResource, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'locations':
          ?pulumi.Input.mapOptionalInputValue<
            List<MapsAccountPropertiesLocations>,
            List<Map<String, dynamic>>
          >(
            locations,
            (value) =>
  ...
  factory MapsAccountProperties.fromMap(Map<String, dynamic> map) {
    return MapsAccountProperties(
      ...
      linkedResources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LinkedResource>(
            guardedValue,
            (value) =>
                LinkedResource.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      locations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MapsAccountPropertiesLocations>(
            guardedValue,
            (value) => MapsAccountPropertiesLocations.fromMap(
