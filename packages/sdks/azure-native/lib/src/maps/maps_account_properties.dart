...
class MapsAccountProperties {
  ...
  final List<MapsAccountPropertiesLocations>? locations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'linkedResources': ?linkedResources == null ? null : pulumi.Input.encodeList<LinkedResource, Map<String, dynamic>>(linkedResources!, (value) => value.toMap()),
      'locations': ?locations == null ? null : pulumi.Input.encodeList<MapsAccountPropertiesLocations, Map<String, dynamic>>(locations!, (value) => value.toMap()),
    };
  }
  ...
  factory MapsAccountProperties.fromMap(Map<String, dynamic> map) {
    return MapsAccountProperties(
      ...
      linkedResources: map['linkedResources'] == null ? null : pulumi.Input.decodeList<LinkedResource>(map['linkedResources'], (value) => LinkedResource.fromMap((value as Map).cast<String, dynamic>())),
      locations: map['locations'] == null ? null : pulumi.Input.decodeList<MapsAccountPropertiesLocations>(map['locations'], (value) => MapsAccountPropertiesLocations.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
