...
class MapsAccountPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'locations':
          ?pulumi.Input.mapOptionalInputValue<
            List<MapsAccountPropertiesResponseLocations>,
            List<Map<String, dynamic>>
          >(
            locations,
            (value) =>
  ...
  factory MapsAccountPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MapsAccountPropertiesResponse(
      ...
      linkedResources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LinkedResourceResponse>(
            guardedValue,
            (value) => LinkedResourceResponse.fromMap(
      ...
      locations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MapsAccountPropertiesResponseLocations>(
            guardedValue,
            (value) => MapsAccountPropertiesResponseLocations.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
