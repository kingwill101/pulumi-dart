...
class EncryptionResponseCustomerManagedKeyEncryption {
  ...
  final pulumi.Input<EncryptionResponseKeyEncryptionKeyIdentity?>? keyEncryptionKeyIdentity;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keyEncryptionKeyIdentity': ?pulumi.Input.mapOptionalInputValue<EncryptionResponseKeyEncryptionKeyIdentity, Map<String, dynamic>>(keyEncryptionKeyIdentity, (value) => value.toMap()),
  ...
  factory EncryptionResponseCustomerManagedKeyEncryption.fromMap(Map<String, dynamic> map) {
    return EncryptionResponseCustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: (() { final guardedValue = map['keyEncryptionKeyIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionResponseKeyEncryptionKeyIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
