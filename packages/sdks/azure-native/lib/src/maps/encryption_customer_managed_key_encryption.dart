...
class EncryptionCustomerManagedKeyEncryption {
  ...
  factory EncryptionCustomerManagedKeyEncryption.fromMap(Map<String, dynamic> map) {
    return EncryptionCustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: (() { final guardedValue = map['keyEncryptionKeyIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionKeyEncryptionKeyIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
