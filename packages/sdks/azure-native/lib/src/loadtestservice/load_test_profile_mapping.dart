...
/// }
///
/// resource "azure-native_loadtestservice_loadtestprofilemapping" "loadTestProfileMapping" {
...
class LoadTestProfileMapping extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [LoadTestProfileMapping] resource.
  LoadTestProfileMapping.reference(String urn)
    : super(
        'azure-native:loadtestservice:LoadTestProfileMapping',
