...
/// }
///
/// resource "azure-native_loadtestservice_playwrightworkspace" "playwrightWorkspace" {
///   local_auth                = "Enabled"
///   location                  = "westus3"
...
class PlaywrightWorkspace extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PlaywrightWorkspace] resource.
  PlaywrightWorkspace.reference(String urn)
    : super(
        'azure-native:loadtestservice:PlaywrightWorkspace',
