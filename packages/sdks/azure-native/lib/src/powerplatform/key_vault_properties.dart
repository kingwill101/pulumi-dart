...
class KeyVaultProperties {
  ...
  factory KeyVaultProperties.fromMap(Map<String, dynamic> map) {
    return KeyVaultProperties(
      ...
      key: (() { final guardedValue = map['key']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
