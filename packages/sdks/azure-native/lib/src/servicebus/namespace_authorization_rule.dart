...
/// }
///
/// resource "azure-native_servicebus_namespaceauthorizationrule" "namespaceAuthorizationRule" {
...
class NamespaceAuthorizationRule extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NamespaceAuthorizationRule]. {@macro pulumi_servicebus_namespace_authorization_rule_args_doc}
