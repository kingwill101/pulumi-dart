...
/// Result data returned by listTopicKeys.
class ListTopicKeysResult {
  ...
  /// Creates a new [ListTopicKeysResult].
  ...
  factory ListTopicKeysResult.fromMap(Map<String, dynamic> map) {
