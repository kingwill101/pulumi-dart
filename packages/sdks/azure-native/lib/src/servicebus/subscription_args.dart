...
class SubscriptionArgs {
  ...
  SubscriptionArgs({
    ...
    pulumi.Output<SBClientAffineProperties>? clientAffineProperties,
    pulumi.Output<bool>? deadLetteringOnFilterEvaluationExceptions,
    ...
    pulumi.Output<bool>? isClientAffine,
  ...
  factory SubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionArgs(
      ...
      clientAffineProperties: map['clientAffineProperties'] == null ? null : pulumi.Output.create<SBClientAffineProperties>(SBClientAffineProperties.fromMap((map['clientAffineProperties'] as Map).cast<String, dynamic>())),
      deadLetteringOnFilterEvaluationExceptions: map['deadLetteringOnFilterEvaluationExceptions'] == null ? null : pulumi.Output.create<bool>(map['deadLetteringOnFilterEvaluationExceptions'] as bool),
      ...
      isClientAffine: map['isClientAffine'] == null ? null : pulumi.Output.create<bool>(map['isClientAffine'] as bool),
