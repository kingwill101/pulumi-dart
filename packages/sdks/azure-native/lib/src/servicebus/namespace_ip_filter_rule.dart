...
class NamespaceIpFilterRule extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NamespaceIpFilterRule]. {@macro pulumi_servicebus_namespace_ip_filter_rule_args_doc}
  ...
  NamespaceIpFilterRule(
    ...
    this.filterName = registerOutput<String?>('filterName');
    this.ipMask = registerOutput<String?>('ipMask');
