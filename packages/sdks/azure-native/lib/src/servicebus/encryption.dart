...
class Encryption {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keySource': ?pulumi.Input.mapOptionalInputValue<KeySource, String>(
        keySource,
    ...
    return Encryption(
      keySource: (() {
        ...
        return pulumi.Input.fromValue(
          KeySource.fromValue(guardedValue as String),
        );
      })(),
      keyVaultProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeyVaultProperties>(
            guardedValue,
            (value) => KeyVaultProperties.fromMap(
