...
class NamespaceArgs {
  ...
  final pulumi.Input<List<PrivateEndpointConnectionServicebus>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sku': ?pulumi.Input.mapOptionalInputValue<SBSku, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
      'tags': ?tags,
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      privateEndpointConnections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<PrivateEndpointConnectionServicebus>(),
        );
      })(),
      publicNetworkAccess: (() {
      ...
      sku: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SBSku.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
