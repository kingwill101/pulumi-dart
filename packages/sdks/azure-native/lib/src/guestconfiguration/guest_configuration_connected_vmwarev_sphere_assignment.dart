...
class GuestConfigurationConnectedVMwarevSphereAssignment extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [GuestConfigurationConnectedVMwarevSphereAssignment] resource.
  GuestConfigurationConnectedVMwarevSphereAssignment.reference(String urn)
    : super(
        'azure-native:guestconfiguration:GuestConfigurationConnectedVMwarevSphereAssignment',
