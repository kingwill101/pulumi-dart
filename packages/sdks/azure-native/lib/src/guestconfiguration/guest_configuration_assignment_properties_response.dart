...
class GuestConfigurationAssignmentPropertiesResponse {
  ...
  factory GuestConfigurationAssignmentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GuestConfigurationAssignmentPropertiesResponse(
      ...
      guestConfiguration: (() { final guardedValue = map['guestConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GuestConfigurationNavigationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      lastComplianceStatusChecked: pulumi.Input.fromValue(map['lastComplianceStatusChecked'] as String),
      latestAssignmentReport: (() { final guardedValue = map['latestAssignmentReport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssignmentReportResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vmssVMList: (() { final guardedValue = map['vmssVMList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VMSSVMInfoResponse>(guardedValue, (value) => VMSSVMInfoResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
