...
class AssignmentReportResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resources':
          ?pulumi.Input.mapOptionalInputValue<
            List<AssignmentReportResourceResponse>,
    ...
    return AssignmentReportResponse(
      assignment: (() {
        ...
        return pulumi.Input.fromValue(
          AssignmentInfoResponse.fromMap(
      ...
      resources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AssignmentReportResourceResponse>(
            guardedValue,
            (value) => AssignmentReportResourceResponse.fromMap(
      ...
      vm: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VMInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
