...
class GuestConfigurationNavigationResponse {
  ...
  final pulumi.Input<List<ConfigurationParameterResponse>>?
    ...
    return <String, dynamic>{
      ...
      'configurationParameter':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigurationParameterResponse>,
      ...
      'configurationSetting':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(configurationSetting, (value) => value.toMap()),
  ...
  factory GuestConfigurationNavigationResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return GuestConfigurationNavigationResponse(
      assignmentSource: pulumi.Input.fromValue(
        map['assignmentSource'] as String,
      ),
      assignmentType: (() {
      ...
      configurationParameter: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConfigurationParameterResponse>(
            guardedValue,
            (value) => ConfigurationParameterResponse.fromMap(
      ...
      configurationSetting: pulumi.Input.fromValue(
        ConfigurationSettingResponse.fromMap(
          (map['configurationSetting']! as Map).cast<String, dynamic>(),
        ),
      ),
      contentHash: (() {
