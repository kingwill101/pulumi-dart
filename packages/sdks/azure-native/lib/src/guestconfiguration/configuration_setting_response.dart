...
class ConfigurationSettingResponse {
  ...
  factory ConfigurationSettingResponse.fromMap(Map<String, dynamic> map) {
    return ConfigurationSettingResponse(
      actionAfterReboot: pulumi.Input.fromValue(
        map['actionAfterReboot'] as String,
      ),
      allowModuleOverwrite: pulumi.Input.fromValue(
        map['allowModuleOverwrite'] as bool,
      ),
      configurationMode: pulumi.Input.fromValue(
        map['configurationMode'] as String,
      ),
      configurationModeFrequencyMins: pulumi.Input.fromValue(
        map['configurationModeFrequencyMins'] as double,
      ),
      rebootIfNeeded: pulumi.Input.fromValue(map['rebootIfNeeded'] as bool),
      refreshFrequencyMins: pulumi.Input.fromValue(
        map['refreshFrequencyMins'] as double,
      ),
    );
  }
}
