...
/// }
///
/// resource "azure-native_guestconfiguration_guestconfigurationassignment" "guestConfigurationAssignment" {
...
class GuestConfigurationAssignment extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [GuestConfigurationAssignment] resource.
  GuestConfigurationAssignment.reference(String urn)
    : super(
        'azure-native:guestconfiguration:GuestConfigurationAssignment',
