...
import 'guest_configuration_assignments_vmssargs.dart';
...
/// }
///
/// resource "azure-native_guestconfiguration_guestconfigurationassignmentsvmss" "guestConfigurationAssignmentsVMSS" {
///   location = "westcentralus"
///   name     = "NotInstalledApplicationForWindows"
///   properties = {
///     context = "Azure policy"
...
class GuestConfigurationAssignmentsVMSS extends pulumi.CustomResource {
  ...
  /// Creates a new [GuestConfigurationAssignmentsVMSS].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GuestConfigurationAssignmentsVMSS]. {@macro pulumi_guestconfiguration_guest_configuration_assignments_vmssargs_doc}
  ...
  /// Creates a typed reference to an existing [GuestConfigurationAssignmentsVMSS] resource.
  GuestConfigurationAssignmentsVMSS.reference(String urn)
    : super(
        'azure-native:guestconfiguration:GuestConfigurationAssignmentsVMSS',
