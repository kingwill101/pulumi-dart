...
import 'guest_configuration_hcrpassignment_args.dart';
...
/// }
///
/// resource "azure-native_guestconfiguration_guestconfigurationhcrpassignment" "guestConfigurationHCRPAssignment" {
...
class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
  ...
  /// Creates a new [GuestConfigurationHCRPAssignment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GuestConfigurationHCRPAssignment]. {@macro pulumi_guestconfiguration_guest_configuration_hcrpassignment_args_doc}
  ...
  /// Creates a typed reference to an existing [GuestConfigurationHCRPAssignment] resource.
  GuestConfigurationHCRPAssignment.reference(String urn)
    : super(
        'azure-native:guestconfiguration:GuestConfigurationHCRPAssignment',
