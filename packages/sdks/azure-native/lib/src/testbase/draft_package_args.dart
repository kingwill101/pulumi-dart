...
class DraftPackageArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'highlightedFiles':
          ?pulumi.Input.mapOptionalInputValue<
            List<HighlightedFile>,
            List<Map<String, dynamic>>
          >(
            highlightedFiles,
            (value) =>
                pulumi.Input.encodeList<HighlightedFile, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'intuneMetadata':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(intuneMetadata, (value) => value.toMap()),
      'packageId': ?packageId,
      ...
      'tabState':
          ?pulumi.Input.mapOptionalInputValue<TabState, Map<String, dynamic>>(
            tabState,
            (value) => value.toMap(),
          ),
      'targetOSList':
  ...
  factory DraftPackageArgs.fromMap(Map<String, dynamic> map) {
    return DraftPackageArgs(
      ...
      draftPackageName: (() {
        final guardedValue = map['draftPackageName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      editPackage: (() {
      ...
      galleryApps: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryAppDefinition>(
            guardedValue,
            (value) => GalleryAppDefinition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      highlightedFiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HighlightedFile>(
            guardedValue,
            (value) =>
                HighlightedFile.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      inplaceUpgradeOSPair: (() {
      ...
      intuneMetadata: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DraftPackageIntuneAppMetadata.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      tabState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TabState.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      targetOSList: (() {
