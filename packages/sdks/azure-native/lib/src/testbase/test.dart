...
class Test {
  ...
  Test({required this.commands, this.isActive, required this.testType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'commands':
          pulumi.Input.mapInputValue<List<Command>, List<Map<String, dynamic>>>(
            commands,
            (value) => pulumi.Input.encodeList<Command, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return Test(
      commands: pulumi.Input.fromValue(
        pulumi.Input.decodeList<Command>(
          map['commands']!,
          (value) => Command.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      isActive: (() {
