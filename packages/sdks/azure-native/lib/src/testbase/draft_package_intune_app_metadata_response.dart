...
class DraftPackageIntuneAppMetadataResponse {
  ...
  final pulumi.Input<List<DraftPackageIntuneAppMetadataItemResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'intuneAppDependencies':
          ?pulumi.Input.mapOptionalInputValue<
            List<DraftPackageIntuneAppMetadataItemResponse>,
  ...
  factory DraftPackageIntuneAppMetadataResponse.fromMap(
    ...
    return DraftPackageIntuneAppMetadataResponse(
      intuneApp: (() {
        ...
        return pulumi.Input.fromValue(
          DraftPackageIntuneAppMetadataItemResponse.fromMap(
      ...
      intuneAppDependencies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DraftPackageIntuneAppMetadataItemResponse>(
            guardedValue,
            (value) => DraftPackageIntuneAppMetadataItemResponse.fromMap(
