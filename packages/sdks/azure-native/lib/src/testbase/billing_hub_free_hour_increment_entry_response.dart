...
class BillingHubFreeHourIncrementEntryResponse {
  ...
  factory BillingHubFreeHourIncrementEntryResponse.fromMap(Map<String, dynamic> map) {
    return BillingHubFreeHourIncrementEntryResponse(
      ...
      incrementalFreeHours: (() { final guardedValue = map['incrementalFreeHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      remainingFreeHours: (() { final guardedValue = map['remainingFreeHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
