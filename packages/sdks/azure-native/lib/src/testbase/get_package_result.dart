...
class GetPackageResult {
    ...
    return <String, dynamic>{
      ...
      'validationResults':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(validationResults, (value) => value.toMap()),
      'version': version,
    };
  }
  ...
  factory GetPackageResult.fromMap(Map<String, dynamic> map) {
    return GetPackageResult(
      ...
      galleryApps: pulumi.Input.decodeList<GalleryAppDefinitionResponse>(
        map['galleryApps']!,
      ...
      validationResults:
          pulumi.Input.decodeList<PackageValidationResultResponse>(
            map['validationResults']!,
            (value) => PackageValidationResultResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
