...
class NotificationEventReceiver {
  ...
  NotificationEventReceiver({this.receiverType, this.receiverValue});
    ...
    return <String, dynamic>{
      ...
      'receiverValue':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(receiverValue, (value) => value.toMap()),
    };
  }
  ...
  factory NotificationEventReceiver.fromMap(Map<String, dynamic> map) {
    return NotificationEventReceiver(
      ...
      receiverValue: (() {
        final guardedValue = map['receiverValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NotificationReceiverValue.fromMap(
