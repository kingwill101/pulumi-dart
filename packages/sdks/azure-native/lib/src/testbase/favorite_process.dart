...
/// }
///
/// resource "azure-native_testbase_favoriteprocess" "favoriteProcess" {
...
class FavoriteProcess extends pulumi.CustomResource {
  ...
  FavoriteProcess(
    ...
    actualProcessName = registerOutput<String>('actualProcessName');
  ...
  /// Creates a typed reference to an existing [FavoriteProcess] resource.
  FavoriteProcess.reference(String urn)
    : super(
        'azure-native:testbase:FavoriteProcess',
