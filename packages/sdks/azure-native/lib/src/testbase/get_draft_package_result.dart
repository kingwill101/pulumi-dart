...
class GetDraftPackageResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'firstPartyApps': ?(() {
        final guardedValue = firstPartyApps;
      ...
      'galleryApps': ?(() {
        final guardedValue = galleryApps;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'highlightedFiles': ?(() {
        final guardedValue = highlightedFiles;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'targetOSList': ?(() {
        final guardedValue = targetOSList;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'testTypes': ?testTypes,
      'tests': ?(() {
        final guardedValue = tests;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<TestResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetDraftPackageResult.fromMap(Map<String, dynamic> map) {
    return GetDraftPackageResult(
      appFileName: (() {
        final guardedValue = map['appFileName'];
        if (guardedValue == null) return null;
      ...
      editPackage: (() {
        final guardedValue = map['editPackage'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      executableLaunchCommand: (() {
        final guardedValue = map['executableLaunchCommand'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      firstPartyApps: (() {
        final guardedValue = map['firstPartyApps'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<FirstPartyAppDefinitionResponse>(
          guardedValue,
          (value) => FirstPartyAppDefinitionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      flightingRing: (() {
        final guardedValue = map['flightingRing'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      galleryApps: (() {
        final guardedValue = map['galleryApps'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GalleryAppDefinitionResponse>(
          guardedValue,
          (value) => GalleryAppDefinitionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      highlightedFiles: (() {
        final guardedValue = map['highlightedFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<HighlightedFileResponse>(
          guardedValue,
          (value) => HighlightedFileResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      inplaceUpgradeOSPair: (() {
        final guardedValue = map['inplaceUpgradeOSPair'];
        if (guardedValue == null) return null;
      ...
      intuneEnrollmentMetadata: (() {
        final guardedValue = map['intuneEnrollmentMetadata'];
        if (guardedValue == null) return null;
      ...
      intuneMetadata: (() {
        final guardedValue = map['intuneMetadata'];
        if (guardedValue == null) return null;
      ...
      packageTags: (() {
        final guardedValue = map['packageTags'];
        if (guardedValue == null) return null;
      ...
      tabState: (() {
        final guardedValue = map['tabState'];
        if (guardedValue == null) return null;
      ...
      targetOSList: (() {
        final guardedValue = map['targetOSList'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<TargetOSInfoResponse>(
          guardedValue,
          (value) => TargetOSInfoResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      testTypes: (() {
        final guardedValue = map['testTypes'];
        if (guardedValue == null) return null;
      ...
      tests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<TestResponse>(
          guardedValue,
          (value) =>
              TestResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      type: map['type'] as String,
      useAutofill: (() {
        final guardedValue = map['useAutofill'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      useSample: (() {
        final guardedValue = map['useSample'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      version: (() {
