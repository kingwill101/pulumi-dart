...
class BillingHubExecutionUsageDetailResponse {
  ...
  factory BillingHubExecutionUsageDetailResponse.fromMap(Map<String, dynamic> map) {
    return BillingHubExecutionUsageDetailResponse(
      ...
      billedCharges: (() { final guardedValue = map['billedCharges']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      usedBillableHours: (() { final guardedValue = map['usedBillableHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      usedFreeHours: (() { final guardedValue = map['usedFreeHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
