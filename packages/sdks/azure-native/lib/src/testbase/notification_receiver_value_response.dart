...
class NotificationReceiverValueResponse {
  ...
  final pulumi.Input<DistributionGroupListReceiverValueResponse>?
  distributionGroupListReceiverValue;

  /// The user object receiver value.
  final pulumi.Input<SubscriptionReceiverValueResponse>?
    ...
    return <String, dynamic>{
      'distributionGroupListReceiverValue':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(distributionGroupListReceiverValue, (value) => value.toMap()),
      'subscriptionReceiverValue':
          ?pulumi.Input.mapOptionalInputValue<
            SubscriptionReceiverValueResponse,
            Map<String, dynamic>
          >(subscriptionReceiverValue, (value) => value.toMap()),
      'userObjectReceiverValue':
          ?pulumi.Input.mapOptionalInputValue<
            UserObjectReceiverValueResponse,
            Map<String, dynamic>
          >(userObjectReceiverValue, (value) => value.toMap()),
    };
  }
  ...
  factory NotificationReceiverValueResponse.fromMap(Map<String, dynamic> map) {
    return NotificationReceiverValueResponse(
      distributionGroupListReceiverValue: (() {
        final guardedValue = map['distributionGroupListReceiverValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DistributionGroupListReceiverValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      subscriptionReceiverValue: (() {
        final guardedValue = map['subscriptionReceiverValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubscriptionReceiverValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      userObjectReceiverValue: (() {
        final guardedValue = map['userObjectReceiverValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserObjectReceiverValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
