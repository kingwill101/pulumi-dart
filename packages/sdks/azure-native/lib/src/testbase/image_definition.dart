...
/// }
///
/// resource "azure-native_testbase_imagedefinition" "imageDefinition" {
///   architecture           = "x64"
...
class ImageDefinition extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ImageDefinition] resource.
  ImageDefinition.reference(String urn)
    : super(
        'azure-native:testbase:ImageDefinition',
