...
class TestBaseAccountArgs {
  ...
  factory TestBaseAccountArgs.fromMap(Map<String, dynamic> map) {
    return TestBaseAccountArgs(
      ...
      sku: pulumi.Input.fromValue(TestBaseAccountSKU.fromMap((map['sku']! as Map).cast<String, dynamic>())),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      testBaseAccountName: (() { final guardedValue = map['testBaseAccountName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
