...
class InplaceUpgradeOSInfoResponse {
  ...
  factory InplaceUpgradeOSInfoResponse.fromMap(Map<String, dynamic> map) {
    return InplaceUpgradeOSInfoResponse(
      baselineOS: (() { final guardedValue = map['baselineOS']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OsPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
