...
class CommandResponse {
  ...
  factory CommandResponse.fromMap(Map<String, dynamic> map) {
    return CommandResponse(
      ...
      applyUpdateBefore: (() {
        final guardedValue = map['applyUpdateBefore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      enrollIntuneBefore: (() {
        final guardedValue = map['enrollIntuneBefore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      install1PAppBefore: (() {
        final guardedValue = map['install1PAppBefore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      maxRunTime: (() {
        final guardedValue = map['maxRunTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      postUpgrade: (() {
        final guardedValue = map['postUpgrade'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      preUpgrade: (() {
        final guardedValue = map['preUpgrade'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      restartAfter: (() {
        final guardedValue = map['restartAfter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      runAsInteractive: (() {
        final guardedValue = map['runAsInteractive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      runElevated: (() {
