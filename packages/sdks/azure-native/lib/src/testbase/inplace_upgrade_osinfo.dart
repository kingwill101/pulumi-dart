...
class InplaceUpgradeOSInfo {
  ...
  factory InplaceUpgradeOSInfo.fromMap(Map<String, dynamic> map) {
    return InplaceUpgradeOSInfo(
      baselineOS: (() { final guardedValue = map['baselineOS']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OsProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      targetOS: (() { final guardedValue = map['targetOS']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
