  ...
  factory TestResponse.fromMap(Map<String, dynamic> map) {
    return TestResponse(
      commands: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CommandResponse>(
          map['commands']!,
          (value) =>
      ...
      validationResultId: pulumi.Input.fromValue(
        map['validationResultId'] as String,
      ),
      validationRunStatus: pulumi.Input.fromValue(
        map['validationRunStatus'] as String,
      ),
    );
  }
}
