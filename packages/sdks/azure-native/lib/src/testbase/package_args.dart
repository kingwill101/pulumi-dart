...
class PackageArgs {
    ...
    return <String, dynamic>{
      ...
      'inplaceUpgradeOSPair':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(inplaceUpgradeOSPair, (value) => value.toMap()),
      'intuneEnrollmentMetadata':
          ?pulumi.Input.mapOptionalInputValue<
            IntuneEnrollmentMetadata,
            Map<String, dynamic>
          >(intuneEnrollmentMetadata, (value) => value.toMap()),
      'location': ?location,
      ...
      'targetOSList':
          ...
          >(
            targetOSList,
            (value) =>
                pulumi.Input.encodeList<TargetOSInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'tests':
          ...
          >(
            tests,
            (value) => pulumi.Input.encodeList<Test, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory PackageArgs.fromMap(Map<String, dynamic> map) {
    return PackageArgs(
      ...
      draftPackageId: (() {
        final guardedValue = map['draftPackageId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firstPartyApps: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirstPartyAppDefinition>(
            guardedValue,
            (value) => FirstPartyAppDefinition.fromMap(
      ...
      intuneEnrollmentMetadata: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IntuneEnrollmentMetadata.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      targetOSList: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TargetOSInfo>(
            guardedValue,
            (value) =>
                TargetOSInfo.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      tests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Test>(
            guardedValue,
            (value) => Test.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
