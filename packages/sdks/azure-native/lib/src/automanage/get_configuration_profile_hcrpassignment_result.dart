...
/// Result data returned by getConfigurationProfileHCRPAssignment.
class GetConfigurationProfileHCRPAssignmentResult {
  ...
  /// Creates a new [GetConfigurationProfileHCRPAssignmentResult].
  ...
  factory GetConfigurationProfileHCRPAssignmentResult.fromMap(Map<String, dynamic> map) {
