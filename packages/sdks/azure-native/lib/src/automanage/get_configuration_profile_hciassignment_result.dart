...
/// Result data returned by getConfigurationProfileHCIAssignment.
class GetConfigurationProfileHCIAssignmentResult {
  ...
  /// Creates a new [GetConfigurationProfileHCIAssignmentResult].
  ...
  const GetConfigurationProfileHCIAssignmentResult({
  ...
  factory GetConfigurationProfileHCIAssignmentResult.fromMap(Map<String, dynamic> map) {
    return GetConfigurationProfileHCIAssignmentResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ConfigurationProfileAssignmentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
