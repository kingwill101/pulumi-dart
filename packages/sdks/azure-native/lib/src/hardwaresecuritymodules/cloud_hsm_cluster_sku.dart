...
class CloudHsmClusterSku {
  ...
  CloudHsmClusterSku({this.capacity, required this.family, required this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'capacity': ?capacity,
      'family': family,
      'name': pulumi.Input.mapInputValue<CloudHsmClusterSkuName, String>(
        name,
  ...
  factory CloudHsmClusterSku.fromMap(Map<String, dynamic> map) {
    return CloudHsmClusterSku(
      ...
      name: pulumi.Input.fromValue(
        CloudHsmClusterSkuName.fromValue(map['name']! as String),
      ),
    );
  }
}
