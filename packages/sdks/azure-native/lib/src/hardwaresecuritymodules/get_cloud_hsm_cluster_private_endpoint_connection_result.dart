...
/// Result data returned by getCloudHsmClusterPrivateEndpointConnection.
class GetCloudHsmClusterPrivateEndpointConnectionResult {
  ...
  /// Creates a new [GetCloudHsmClusterPrivateEndpointConnectionResult].
  ...
  const GetCloudHsmClusterPrivateEndpointConnectionResult({
  ...
  factory GetCloudHsmClusterPrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
