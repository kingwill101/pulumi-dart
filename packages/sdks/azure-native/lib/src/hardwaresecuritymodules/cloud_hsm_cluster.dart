...
class CloudHsmCluster extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CloudHsmPropertiesResponse>> hsms;
  ...
  CloudHsmCluster(
    ...
    hsms = registerOutput<List<CloudHsmPropertiesResponse>>('hsms', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<CloudHsmPropertiesResponse>(guardedValue, (value) => CloudHsmPropertiesResponse.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    sku = registerOutput<CloudHsmClusterSkuResponse?>('sku', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CloudHsmClusterSkuResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [CloudHsmCluster] resource.
  CloudHsmCluster.reference(String urn)
    : super(
        'azure-native:hardwaresecuritymodules:CloudHsmCluster',
