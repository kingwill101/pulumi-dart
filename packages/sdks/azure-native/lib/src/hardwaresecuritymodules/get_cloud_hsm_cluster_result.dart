...
class GetCloudHsmClusterResult {
  ...
  factory GetCloudHsmClusterResult.fromMap(Map<String, dynamic> map) {
    return GetCloudHsmClusterResult(
      ...
      hsms: pulumi.Input.decodeList<CloudHsmPropertiesResponse>(
        map['hsms']!,
        (value) => CloudHsmPropertiesResponse.fromMap(
      ...
      sku: (() {
        ...
        if (guardedValue == null) return null;
        return CloudHsmClusterSkuResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      })(),
