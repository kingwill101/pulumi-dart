...
/// }
///
/// resource "azure-native_hardwaresecuritymodules_cloudhsmclusterprivateendpointconnection" "cloudHsmClusterPrivateEndpointConnection" {
...
class CloudHsmClusterPrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [CloudHsmClusterPrivateEndpointConnection] resource.
  CloudHsmClusterPrivateEndpointConnection.reference(String urn)
    : super(
        'azure-native:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection',
