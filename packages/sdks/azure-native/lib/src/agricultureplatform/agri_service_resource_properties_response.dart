...
class AgriServiceResourcePropertiesResponse {
  ...
  final pulumi.Input<List<DataConnectorCredentialMapResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataConnectorCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataConnectorCredentialMapResponse>,
      ...
      'installedSolutions':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstalledSolutionMapResponse>,
            List<Map<String, dynamic>>
          >(
            installedSolutions,
            (value) =>
  ...
  factory AgriServiceResourcePropertiesResponse.fromMap(
    ...
    return AgriServiceResourcePropertiesResponse(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          AgriServiceConfigResponse.fromMap(
      ...
      dataConnectorCredentials: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataConnectorCredentialMapResponse>(
            guardedValue,
            (value) => DataConnectorCredentialMapResponse.fromMap(
      ...
      installedSolutions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstalledSolutionMapResponse>(
            guardedValue,
            (value) => InstalledSolutionMapResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
