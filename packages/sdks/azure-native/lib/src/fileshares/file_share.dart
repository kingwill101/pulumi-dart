...
class FileShare extends pulumi.CustomResource {
  ...
  FileShare(
    ...
    properties = registerOutput<FileSharePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FileSharePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
