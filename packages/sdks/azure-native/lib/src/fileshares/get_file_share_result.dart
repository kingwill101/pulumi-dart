...
class GetFileShareResult {
  ...
  final FileSharePropertiesResponse? properties;
  ...
  factory GetFileShareResult.fromMap(Map<String, dynamic> map) {
    return GetFileShareResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return FileSharePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
