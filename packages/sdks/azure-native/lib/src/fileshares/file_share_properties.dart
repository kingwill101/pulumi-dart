...
class FileShareProperties {
  ...
  final pulumi.Input<dynamic>? mediaTier;
  ...
  final pulumi.Input<dynamic>? redundancy;
  ...
  factory FileShareProperties.fromMap(Map<String, dynamic> map) {
    return FileShareProperties(
      mediaTier: (() { final guardedValue = map['mediaTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      redundancy: (() { final guardedValue = map['redundancy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
