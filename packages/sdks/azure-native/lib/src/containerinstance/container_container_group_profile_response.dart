...
class ContainerContainerGroupProfileResponse {
  ...
  /// Creates a new [ContainerContainerGroupProfileResponse].
  ...
  const ContainerContainerGroupProfileResponse({
    this.command,
    this.configMap,
  ...
  factory ContainerContainerGroupProfileResponse.fromMap(Map<String, dynamic> map) {
    return ContainerContainerGroupProfileResponse(
