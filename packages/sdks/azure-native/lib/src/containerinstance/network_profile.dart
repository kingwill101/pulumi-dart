...
class NetworkProfile {
  ...
  factory NetworkProfile.fromMap(Map<String, dynamic> map) {
    return NetworkProfile(
      applicationGateway: (() { final guardedValue = map['applicationGateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationGateway.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      loadBalancer: (() { final guardedValue = map['loadBalancer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoadBalancer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
