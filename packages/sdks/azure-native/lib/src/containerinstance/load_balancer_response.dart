...
class LoadBalancerResponse {
  ...
  factory LoadBalancerResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerResponse(
      backendAddressPools: (() { final guardedValue = map['backendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LoadBalancerBackendAddressPoolResponse>(guardedValue, (value) => LoadBalancerBackendAddressPoolResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
