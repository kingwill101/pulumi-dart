...
class UpdateProfile {
  ...
  final pulumi.Input<dynamic>? updateMode;
  ...
  factory UpdateProfile.fromMap(Map<String, dynamic> map) {
    return UpdateProfile(
      ...
      updateMode: (() { final guardedValue = map['updateMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
