...
class GetCGProfileResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': ?(() { final guardedValue = containers; if (guardedValue == null) return null; return pulumi.Input.encodeList<ContainerResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetCGProfileResult.fromMap(Map<String, dynamic> map) {
    return GetCGProfileResult(
      ...
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ContainerResponse>(guardedValue, (value) => ContainerResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      registeredRevisions: (() { final guardedValue = map['registeredRevisions']; if (guardedValue == null) return null; return (guardedValue as List).cast<int>(); })(),
