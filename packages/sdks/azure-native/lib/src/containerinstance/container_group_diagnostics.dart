...
class ContainerGroupDiagnostics {
  ...
  factory ContainerGroupDiagnostics.fromMap(Map<String, dynamic> map) {
    return ContainerGroupDiagnostics(
      logAnalytics: (() { final guardedValue = map['logAnalytics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogAnalytics.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
