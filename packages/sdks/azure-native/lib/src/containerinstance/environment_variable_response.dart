...
class EnvironmentVariableResponse {
  ...
  factory EnvironmentVariableResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentVariableResponse(
      ...
      secureValueReference: (() { final guardedValue = map['secureValueReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
