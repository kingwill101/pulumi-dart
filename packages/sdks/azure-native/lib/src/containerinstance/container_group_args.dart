...
class ContainerGroupArgs {
  ...
  ContainerGroupArgs({
    ...
    pulumi.Output<StandbyPoolProfileDefinition>? standbyPoolProfile,
    pulumi.Output<List<ContainerGroupSubnetId>>? subnetIds,
    ...
    pulumi.Output<List<String>>? zones,
      ...
      containerGroupProfile = pulumi.Input.asOptionalInput<ContainerGroupProfileReferenceDefinition>(containerGroupProfile),
      ...
      dnsConfig = pulumi.Input.asOptionalInput<DnsConfiguration>(dnsConfig),
      ...
      identity = pulumi.Input.asOptionalInput<ContainerGroupIdentity>(identity),
      ...
      standbyPoolProfile = pulumi.Input.asOptionalInput<StandbyPoolProfileDefinition>(standbyPoolProfile),
      subnetIds = pulumi.Input.asOptionalInput<List<ContainerGroupSubnetId>>(subnetIds),
  ...
  factory ContainerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ContainerGroupArgs(
      ...
      containerGroupProfile: map['containerGroupProfile'] == null ? null : pulumi.Output.create<ContainerGroupProfileReferenceDefinition>(ContainerGroupProfileReferenceDefinition.fromMap((map['containerGroupProfile'] as Map).cast<String, dynamic>())),
      ...
      dnsConfig: map['dnsConfig'] == null ? null : pulumi.Output.create<DnsConfiguration>(DnsConfiguration.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : pulumi.Output.create<ContainerGroupIdentity>(ContainerGroupIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      standbyPoolProfile: map['standbyPoolProfile'] == null ? null : pulumi.Output.create<StandbyPoolProfileDefinition>(StandbyPoolProfileDefinition.fromMap((map['standbyPoolProfile'] as Map).cast<String, dynamic>())),
      subnetIds: map['subnetIds'] == null ? null : pulumi.Output.create<List<ContainerGroupSubnetId>>(pulumi.Input.decodeList<ContainerGroupSubnetId>(map['subnetIds'], (value) => ContainerGroupSubnetId.fromMap((value as Map).cast<String, dynamic>()))),
