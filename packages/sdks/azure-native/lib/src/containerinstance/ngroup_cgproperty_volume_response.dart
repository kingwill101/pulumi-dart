...
class NGroupCGPropertyVolumeResponse {
  ...
  factory NGroupCGPropertyVolumeResponse.fromMap(Map<String, dynamic> map) {
    return NGroupCGPropertyVolumeResponse(
      azureFile: (() { final guardedValue = map['azureFile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureFileVolumeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
