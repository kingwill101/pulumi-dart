...
import 'environment_variable_container_group_response.dart';
...
class InitContainerDefinitionContainerGroupResponse {
  ...
  const InitContainerDefinitionContainerGroupResponse({
    this.command,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'command': ?command,
      'environmentVariables': ?pulumi.Input.mapOptionalInputValue<List<EnvironmentVariableContainerGroupResponse>, List<Map<String, dynamic>>>(environmentVariables, (value) => pulumi.Input.encodeList<EnvironmentVariableContainerGroupResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'image': ?image,
  ...
  factory InitContainerDefinitionContainerGroupResponse.fromMap(Map<String, dynamic> map) {
    return InitContainerDefinitionContainerGroupResponse(
      ...
      environmentVariables: (() { final guardedValue = map['environmentVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnvironmentVariableContainerGroupResponse>(guardedValue, (value) => EnvironmentVariableContainerGroupResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
