...
class StorageProfile {
  ...
  /// [fileShares] Optional.
  StorageProfile({this.fileShares});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fileShares':
          ...
          >(
            fileShares,
            (value) => pulumi.Input.encodeList<FileShare, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return StorageProfile(
      fileShares: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FileShare>(
            guardedValue,
            (value) =>
                FileShare.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
