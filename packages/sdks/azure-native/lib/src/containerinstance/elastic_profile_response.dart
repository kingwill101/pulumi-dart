...
class ElasticProfileResponse {
  ...
  final pulumi.Input<ElasticProfileResponseContainerGroupNamingPolicy>?
    ...
    return <String, dynamic>{
      'containerGroupNamingPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(containerGroupNamingPolicy, (value) => value.toMap()),
  ...
  factory ElasticProfileResponse.fromMap(Map<String, dynamic> map) {
    return ElasticProfileResponse(
      containerGroupNamingPolicy: (() {
        final guardedValue = map['containerGroupNamingPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ElasticProfileResponseContainerGroupNamingPolicy.fromMap(
      ...
      maintainDesiredCount: (() {
        final guardedValue = map['maintainDesiredCount'];
        if (guardedValue == null) return null;
