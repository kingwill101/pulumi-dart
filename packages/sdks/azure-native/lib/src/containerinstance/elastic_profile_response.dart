...
class ElasticProfileResponse {
  ...
  factory ElasticProfileResponse.fromMap(Map<String, dynamic> map) {
    return ElasticProfileResponse(
      containerGroupNamingPolicy: (() { final guardedValue = map['containerGroupNamingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ElasticProfileResponseContainerGroupNamingPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
