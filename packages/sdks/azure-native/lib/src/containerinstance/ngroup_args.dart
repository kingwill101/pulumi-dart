    ...
    return <String, dynamic>{
      'containerGroupProfiles':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupProfileStub>,
      ...
      'elasticProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ElasticProfile,
            Map<String, dynamic>
          >(elasticProfile, (value) => value.toMap()),
      'identity':
          ?pulumi.Input.mapOptionalInputValue<
            NGroupIdentity,
            Map<String, dynamic>
      ...
      'updateProfile':
          ?pulumi.Input.mapOptionalInputValue<
            UpdateProfile,
            Map<String, dynamic>
          >(updateProfile, (value) => value.toMap()),
      'zones': ?zones,
    };
  }
    ...
    return NGroupArgs(
      containerGroupProfiles: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupProfileStub>(
            guardedValue,
            (value) => ContainerGroupProfileStub.fromMap(
      ...
      elasticProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ElasticProfile.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NGroupIdentity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      location: (() {
      ...
      ngroupsName: (() {
        final guardedValue = map['ngroupsName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      placementProfile: (() {
      ...
      updateProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UpdateProfile.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      zones: (() {
