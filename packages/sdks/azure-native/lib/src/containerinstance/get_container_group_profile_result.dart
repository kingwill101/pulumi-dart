...
class GetContainerGroupProfileResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': ?(() { final guardedValue = containers; if (guardedValue == null) return null; return pulumi.Input.encodeList<ContainerContainerGroupProfileResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetContainerGroupProfileResult.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupProfileResult(
      ...
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ContainerContainerGroupProfileResponse>(guardedValue, (value) => ContainerContainerGroupProfileResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
