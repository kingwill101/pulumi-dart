...
class GetContainerGroupResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containers': ?(() { final guardedValue = containers; if (guardedValue == null) return null; return pulumi.Input.encodeList<ContainerContainerGroupResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetContainerGroupResult.fromMap(Map<String, dynamic> map) {
    return GetContainerGroupResult(
      ...
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ContainerContainerGroupResponse>(guardedValue, (value) => ContainerContainerGroupResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      instanceView: (() { final guardedValue = map['instanceView']; if (guardedValue == null) return null; return ContainerGroupPropertiesResponseInstanceView.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      isCreatedFromStandbyPool: (() { final guardedValue = map['isCreatedFromStandbyPool']; if (guardedValue == null) return null; return guardedValue as bool; })(),
