...
class NGroupContainerGroupPropertiesResponse {
    ...
    return <String, dynamic>{
      'containers':
          ?pulumi.Input.mapOptionalInputValue<
            List<NGroupCGPropertyContainerResponse>,
      ...
      'volumes':
          ?pulumi.Input.mapOptionalInputValue<
            List<NGroupCGPropertyVolumeResponse>,
            List<Map<String, dynamic>>
          >(
            volumes,
            (value) =>
  ...
  factory NGroupContainerGroupPropertiesResponse.fromMap(
    ...
    return NGroupContainerGroupPropertiesResponse(
      containers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NGroupCGPropertyContainerResponse>(
            guardedValue,
            (value) => NGroupCGPropertyContainerResponse.fromMap(
      ...
      volumes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NGroupCGPropertyVolumeResponse>(
            guardedValue,
            (value) => NGroupCGPropertyVolumeResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
