...
class FileShareProperties {
  ...
  FileShareProperties({this.shareAccessTier, this.shareAccessType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'shareAccessTier':
          ?pulumi.Input.mapOptionalInputValue<AzureFileShareAccessTier, String>(
            shareAccessTier,
            (value) => value.wireValue,
          ),
      'shareAccessType':
          ?pulumi.Input.mapOptionalInputValue<AzureFileShareAccessType, String>(
            shareAccessType,
            (value) => value.wireValue,
          ),
    };
  ...
  factory FileShareProperties.fromMap(Map<String, dynamic> map) {
    return FileShareProperties(
      shareAccessTier: (() {
        final guardedValue = map['shareAccessTier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureFileShareAccessTier.fromValue(guardedValue as String),
        );
      })(),
      shareAccessType: (() {
        final guardedValue = map['shareAccessType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureFileShareAccessType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
