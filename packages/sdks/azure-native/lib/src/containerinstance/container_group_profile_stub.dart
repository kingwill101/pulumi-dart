...
class ContainerGroupProfileStub {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containerGroupProperties': ?pulumi.Input.mapOptionalInputValue<NGroupContainerGroupProperties, Map<String, dynamic>>(containerGroupProperties, (value) => value.toMap()),
      'networkProfile': ?pulumi.Input.mapOptionalInputValue<NetworkProfile, Map<String, dynamic>>(networkProfile, (value) => value.toMap()),
      'resource': ?pulumi.Input.mapOptionalInputValue<ApiEntityReference, Map<String, dynamic>>(resource, (value) => value.toMap()),
      'revision': ?revision,
  ...
  factory ContainerGroupProfileStub.fromMap(Map<String, dynamic> map) {
    return ContainerGroupProfileStub(
      containerGroupProperties: (() { final guardedValue = map['containerGroupProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NGroupContainerGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resource: (() { final guardedValue = map['resource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiEntityReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
