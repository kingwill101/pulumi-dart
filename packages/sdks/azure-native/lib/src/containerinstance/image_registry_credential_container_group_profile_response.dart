...
class ImageRegistryCredentialContainerGroupProfileResponse {
  ...
  /// Creates a new [ImageRegistryCredentialContainerGroupProfileResponse].
  ...
  const ImageRegistryCredentialContainerGroupProfileResponse({
    this.identity,
    this.identityUrl,
    this.password,
  ...
  factory ImageRegistryCredentialContainerGroupProfileResponse.fromMap(Map<String, dynamic> map) {
    return ImageRegistryCredentialContainerGroupProfileResponse(
