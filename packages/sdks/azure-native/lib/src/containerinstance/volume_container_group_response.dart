...
import 'azure_file_volume_container_group_response.dart';
import 'git_repo_volume_response.dart';

/// The properties of the volume.
class VolumeContainerGroupResponse {
  /// The Azure File volume.
  final pulumi.Input<AzureFileVolumeContainerGroupResponse?>? azureFile;
  ...
  /// Creates a new [VolumeContainerGroupResponse].
  ...
  const VolumeContainerGroupResponse({
    this.azureFile,
    this.emptyDir,
    this.gitRepo,
    required this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'azureFile': ?pulumi.Input.mapOptionalInputValue<AzureFileVolumeContainerGroupResponse, Map<String, dynamic>>(azureFile, (value) => value.toMap()),
      'emptyDir': ?emptyDir,
  ...
  factory VolumeContainerGroupResponse.fromMap(Map<String, dynamic> map) {
    return VolumeContainerGroupResponse(
      azureFile: (() { final guardedValue = map['azureFile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureFileVolumeContainerGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
