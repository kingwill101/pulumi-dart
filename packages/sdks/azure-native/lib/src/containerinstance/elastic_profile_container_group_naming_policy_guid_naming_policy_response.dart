...
class ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse {
  ...
  /// Creates a new [ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse].
  ...
  const ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse({
    this.prefix,
  });
  ...
  factory ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse.fromMap(Map<String, dynamic> map) {
    return ElasticProfileContainerGroupNamingPolicyGuidNamingPolicyResponse(
