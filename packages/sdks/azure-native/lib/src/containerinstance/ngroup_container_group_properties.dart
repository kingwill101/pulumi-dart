    ...
    return <String, dynamic>{
      'containers':
          ?pulumi.Input.mapOptionalInputValue<
            List<NGroupCGPropertyContainer>,
    ...
    return NGroupContainerGroupProperties(
      containers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NGroupCGPropertyContainer>(
            guardedValue,
            (value) => NGroupCGPropertyContainer.fromMap(
      ...
      volumes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NGroupCGPropertyVolume>(
            guardedValue,
            (value) => NGroupCGPropertyVolume.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
