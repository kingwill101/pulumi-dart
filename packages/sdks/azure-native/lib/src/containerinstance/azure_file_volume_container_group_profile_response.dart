...
class AzureFileVolumeContainerGroupProfileResponse {
  ...
  /// Creates a new [AzureFileVolumeContainerGroupProfileResponse].
  ...
  const AzureFileVolumeContainerGroupProfileResponse({
    this.readOnly,
  ...
  factory AzureFileVolumeContainerGroupProfileResponse.fromMap(Map<String, dynamic> map) {
    return AzureFileVolumeContainerGroupProfileResponse(
