...
class CGProfile extends pulumi.CustomResource {
  ...
  /// Creates a new [CGProfile].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CGProfile]. {@macro pulumi_containerinstance_cgprofile_args_doc}
  ...
  CGProfile(
    ...
    this.registeredRevisions = registerOutput<List<int>>('registeredRevisions');
    this.restartPolicy = registerOutput<String?>('restartPolicy');
    this.revision = registerOutput<int>('revision');
    this.securityContext = registerOutput<SecurityContextDefinitionResponse?>('securityContext');
    this.shutdownGracePeriod = registerOutput<String?>('shutdownGracePeriod');
    this.sku = registerOutput<String?>('sku');
    this.systemData = registerOutput<SystemDataResponse>('systemData');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.timeToLive = registerOutput<String?>('timeToLive');
    this.type = registerOutput<String>('type');
    this.useKrypton = registerOutput<bool?>('useKrypton');
