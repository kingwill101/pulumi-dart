...
class Container {
  ...
  factory Container.fromMap(Map<String, dynamic> map) {
    return Container(
      ...
      configMap: (() { final guardedValue = map['configMap']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigMap.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      livenessProbe: (() { final guardedValue = map['livenessProbe']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerProbe.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      readinessProbe: (() { final guardedValue = map['readinessProbe']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerProbe.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
