...
class UpdateProfileResponse {
  ...
  final pulumi.Input<UpdateProfileResponseRollingUpdateProfile>?
  ...
  /// [updateMode] Optional.
  UpdateProfileResponse({this.rollingUpdateProfile, this.updateMode});
    ...
    return UpdateProfileResponse(
      rollingUpdateProfile: (() {
        ...
        return pulumi.Input.fromValue(
          UpdateProfileResponseRollingUpdateProfile.fromMap(
