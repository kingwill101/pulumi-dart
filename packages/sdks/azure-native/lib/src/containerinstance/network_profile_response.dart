...
class NetworkProfileResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applicationGateway': ?pulumi.Input.mapOptionalInputValue<ApplicationGatewayResponse, Map<String, dynamic>>(applicationGateway, (value) => value.toMap()),
      'loadBalancer': ?pulumi.Input.mapOptionalInputValue<LoadBalancerResponse, Map<String, dynamic>>(loadBalancer, (value) => value.toMap()),
    };
  }

  factory NetworkProfileResponse.fromMap(Map<String, dynamic> map) {
    return NetworkProfileResponse(
      applicationGateway: (() { final guardedValue = map['applicationGateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      loadBalancer: (() { final guardedValue = map['loadBalancer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoadBalancerResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
