...
/// }
///
/// resource "azure-native_quota_groupquotasubscription" "groupQuotaSubscription" {
...
class GroupQuotaSubscription extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GroupQuotaSubscriptionIdResponseProperties> properties;
  ...
  GroupQuotaSubscription(
    ...
    properties = registerOutput<GroupQuotaSubscriptionIdResponseProperties>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GroupQuotaSubscriptionIdResponseProperties.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [GroupQuotaSubscription] resource.
  GroupQuotaSubscription.reference(String urn)
    : super(
        'azure-native:quota:GroupQuotaSubscription',
