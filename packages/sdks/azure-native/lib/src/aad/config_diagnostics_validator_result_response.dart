...
class ConfigDiagnosticsValidatorResultResponse {
  ...
  final pulumi.Input<List<ConfigDiagnosticsValidatorResultIssueResponse>>?
  issues;
    ...
    return <String, dynamic>{
      'issues':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigDiagnosticsValidatorResultIssueResponse>,
  ...
  factory ConfigDiagnosticsValidatorResultResponse.fromMap(
    ...
    return ConfigDiagnosticsValidatorResultResponse(
      issues: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ConfigDiagnosticsValidatorResultIssueResponse>(
            guardedValue,
            (value) => ConfigDiagnosticsValidatorResultIssueResponse.fromMap(
