...
class ConfigDiagnosticsValidatorResultIssueResponse {
  ...
  const ConfigDiagnosticsValidatorResultIssueResponse({
  ...
  factory ConfigDiagnosticsValidatorResultIssueResponse.fromMap(Map<String, dynamic> map) {
    return ConfigDiagnosticsValidatorResultIssueResponse(
      descriptionParams: (() { final guardedValue = map['descriptionParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
