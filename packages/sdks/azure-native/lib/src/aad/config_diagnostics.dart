...
class ConfigDiagnostics {
  ...
  ConfigDiagnostics({this.lastExecuted, this.validatorResults});
    ...
    return <String, dynamic>{
      ...
      'validatorResults':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigDiagnosticsValidatorResult>,
    ...
    return ConfigDiagnostics(
      ...
      validatorResults: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConfigDiagnosticsValidatorResult>(
            guardedValue,
            (value) => ConfigDiagnosticsValidatorResult.fromMap(
