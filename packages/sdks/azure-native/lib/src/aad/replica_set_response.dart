...
class ReplicaSetResponse {
  ...
  factory ReplicaSetResponse.fromMap(Map<String, dynamic> map) {
    return ReplicaSetResponse(
      domainControllerIpAddress: pulumi.Input.fromValue(
        (map['domainControllerIpAddress'] as List).cast<String>(),
      ),
      externalAccessIpAddress: pulumi.Input.fromValue(
        map['externalAccessIpAddress'] as String,
      ),
      healthAlerts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HealthAlertResponse>(
          map['healthAlerts']!,
          (value) => HealthAlertResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      healthLastEvaluated: pulumi.Input.fromValue(
        map['healthLastEvaluated'] as String,
      ),
      healthMonitors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HealthMonitorResponse>(
          map['healthMonitors']!,
          (value) => HealthMonitorResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
