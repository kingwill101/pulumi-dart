...
class ConfigDiagnosticsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'validatorResults': ?pulumi.Input.mapOptionalInputValue<List<ConfigDiagnosticsValidatorResultResponse>, List<Map<String, dynamic>>>(validatorResults, (value) => pulumi.Input.encodeList<ConfigDiagnosticsValidatorResultResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory ConfigDiagnosticsResponse.fromMap(Map<String, dynamic> map) {
    return ConfigDiagnosticsResponse(
      ...
      validatorResults: (() { final guardedValue = map['validatorResults']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConfigDiagnosticsValidatorResultResponse>(guardedValue, (value) => ConfigDiagnosticsValidatorResultResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
