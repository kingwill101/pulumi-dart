...
class DomainServiceArgs {
  ...
  factory DomainServiceArgs.fromMap(Map<String, dynamic> map) {
    return DomainServiceArgs(
      configDiagnostics: (() { final guardedValue = map['configDiagnostics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigDiagnostics.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      replicaSets: (() { final guardedValue = map['replicaSets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReplicaSet>(guardedValue, (value) => ReplicaSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
