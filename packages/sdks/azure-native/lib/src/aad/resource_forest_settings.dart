...
class ResourceForestSettings {
  ...
  factory ResourceForestSettings.fromMap(Map<String, dynamic> map) {
    return ResourceForestSettings(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ForestTrust>(guardedValue, (value) => ForestTrust.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
