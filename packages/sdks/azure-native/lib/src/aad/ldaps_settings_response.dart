...
class LdapsSettingsResponse {
  ...
  factory LdapsSettingsResponse.fromMap(Map<String, dynamic> map) {
    return LdapsSettingsResponse(
      certificateNotAfter: pulumi.Input.fromValue(
        map['certificateNotAfter'] as String,
      ),
      certificateThumbprint: pulumi.Input.fromValue(
        map['certificateThumbprint'] as String,
      ),
      externalAccess: (() {
        final guardedValue = map['externalAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ldaps: (() {
        final guardedValue = map['ldaps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pfxCertificate: (() {
        final guardedValue = map['pfxCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pfxCertificatePassword: (() {
        final guardedValue = map['pfxCertificatePassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
