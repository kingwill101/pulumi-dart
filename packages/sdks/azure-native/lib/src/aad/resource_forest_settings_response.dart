...
class ResourceForestSettingsResponse {
  ...
  const ResourceForestSettingsResponse({
    this.resourceForest,
    this.settings,
  });
  ...
  factory ResourceForestSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ResourceForestSettingsResponse(
      resourceForest: (() { final guardedValue = map['resourceForest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ForestTrustResponse>(guardedValue, (value) => ForestTrustResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
