...
class GitHubWorkflowProfileResponse {
  ...
  factory GitHubWorkflowProfileResponse.fromMap(Map<String, dynamic> map) {
    return GitHubWorkflowProfileResponse(
      acr: (() { final guardedValue = map['acr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ACRResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      deploymentProperties: (() { final guardedValue = map['deploymentProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      lastWorkflowRun: (() { final guardedValue = map['lastWorkflowRun']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowRunResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
