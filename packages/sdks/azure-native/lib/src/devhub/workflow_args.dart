...
class WorkflowArgs {
  ...
  WorkflowArgs({
    ...
    pulumi.Output<String>? builderVersion,
    pulumi.Output<String>? dockerfileGenerationMode,
    pulumi.Output<String>? dockerfileOutputDirectory,
    pulumi.Output<String>? generationLanguage,
    pulumi.Output<GitHubWorkflowProfile>? githubWorkflowProfile,
    pulumi.Output<String>? imageName,
    pulumi.Output<String>? imageTag,
    pulumi.Output<String>? languageVersion,
    pulumi.Output<String>? location,
    pulumi.Output<String>? manifestGenerationMode,
    pulumi.Output<String>? manifestOutputDirectory,
    pulumi.Output<String>? manifestType,
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      ...
      builderVersion: map['builderVersion'] == null ? null : pulumi.Output.create<String>(map['builderVersion'] as String),
      dockerfileGenerationMode: map['dockerfileGenerationMode'] == null ? null : pulumi.Output.create<String>(map['dockerfileGenerationMode'] as String),
      dockerfileOutputDirectory: map['dockerfileOutputDirectory'] == null ? null : pulumi.Output.create<String>(map['dockerfileOutputDirectory'] as String),
      generationLanguage: map['generationLanguage'] == null ? null : pulumi.Output.create<String>(map['generationLanguage'] as String),
      githubWorkflowProfile: map['githubWorkflowProfile'] == null ? null : pulumi.Output.create<GitHubWorkflowProfile>(GitHubWorkflowProfile.fromMap((map['githubWorkflowProfile'] as Map).cast<String, dynamic>())),
      ...
      manifestGenerationMode: map['manifestGenerationMode'] == null ? null : pulumi.Output.create<String>(map['manifestGenerationMode'] as String),
      manifestOutputDirectory: map['manifestOutputDirectory'] == null ? null : pulumi.Output.create<String>(map['manifestOutputDirectory'] as String),
      manifestType: map['manifestType'] == null ? null : pulumi.Output.create<String>(map['manifestType'] as String),
