...
class IacTemplatePropertiesResponse {
  ...
  factory IacTemplatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IacTemplatePropertiesResponse(
      ...
      templateDetails: (() { final guardedValue = map['templateDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IacTemplateDetailsResponse>(guardedValue, (value) => IacTemplateDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
