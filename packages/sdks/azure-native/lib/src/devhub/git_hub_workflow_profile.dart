...
class GitHubWorkflowProfile {
  ...
  factory GitHubWorkflowProfile.fromMap(Map<String, dynamic> map) {
    return GitHubWorkflowProfile(
      acr: (() { final guardedValue = map['acr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ACR.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      deploymentProperties: (() { final guardedValue = map['deploymentProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dockerBuildContext: (() { final guardedValue = map['dockerBuildContext']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      lastWorkflowRun: (() { final guardedValue = map['lastWorkflowRun']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowRun.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      namespace: (() { final guardedValue = map['namespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oidcCredentials: (() { final guardedValue = map['oidcCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GitHubWorkflowProfileOidcCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
