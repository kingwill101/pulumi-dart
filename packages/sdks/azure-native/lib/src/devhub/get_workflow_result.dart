...
class GetWorkflowResult {
  ...
  factory GetWorkflowResult.fromMap(Map<String, dynamic> map) {
    return GetWorkflowResult(
      ...
      builderVersion: (() { final guardedValue = map['builderVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      dockerfileGenerationMode: (() { final guardedValue = map['dockerfileGenerationMode']; if (guardedValue == null) return null; return guardedValue as String; })(),
      dockerfileOutputDirectory: (() { final guardedValue = map['dockerfileOutputDirectory']; if (guardedValue == null) return null; return guardedValue as String; })(),
      generationLanguage: (() { final guardedValue = map['generationLanguage']; if (guardedValue == null) return null; return guardedValue as String; })(),
      githubWorkflowProfile: (() { final guardedValue = map['githubWorkflowProfile']; if (guardedValue == null) return null; return GitHubWorkflowProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      manifestGenerationMode: (() { final guardedValue = map['manifestGenerationMode']; if (guardedValue == null) return null; return guardedValue as String; })(),
      manifestOutputDirectory: (() { final guardedValue = map['manifestOutputDirectory']; if (guardedValue == null) return null; return guardedValue as String; })(),
      manifestType: (() { final guardedValue = map['manifestType']; if (guardedValue == null) return null; return guardedValue as String; })(),
