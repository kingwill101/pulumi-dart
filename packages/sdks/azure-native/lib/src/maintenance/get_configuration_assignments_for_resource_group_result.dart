...
/// Result data returned by getConfigurationAssignmentsForResourceGroup.
class GetConfigurationAssignmentsForResourceGroupResult {
  ...
  /// Creates a new [GetConfigurationAssignmentsForResourceGroupResult].
  ...
  const GetConfigurationAssignmentsForResourceGroupResult({
  ...
  factory GetConfigurationAssignmentsForResourceGroupResult.fromMap(Map<String, dynamic> map) {
