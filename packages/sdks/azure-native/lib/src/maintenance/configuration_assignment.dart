...
/// }
///
/// resource "azure-native_maintenance_configurationassignment" "configurationAssignment" {
...
class ConfigurationAssignment extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ConfigurationAssignment] resource.
  ConfigurationAssignment.reference(String urn)
    : super(
        'azure-native:maintenance:ConfigurationAssignment',
