...
import 'configuration_assignments_for_subscription_args.dart';
...
/// }
///
/// resource "azure-native_maintenance_configurationassignmentsforsubscription" "configurationAssignmentsForSubscription" {
...
/// ```
class ConfigurationAssignmentsForSubscription extends pulumi.CustomResource {
  ...
  /// Creates a new [ConfigurationAssignmentsForSubscription].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConfigurationAssignmentsForSubscription]. {@macro pulumi_maintenance_configuration_assignments_for_subscription_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ConfigurationAssignmentsForSubscription(
    String name, {
    ConfigurationAssignmentsForSubscriptionArgs? args,
  ...
  /// Creates a typed reference to an existing [ConfigurationAssignmentsForSubscription] resource.
  ConfigurationAssignmentsForSubscription.reference(String urn)
    : super(
        'azure-native:maintenance:ConfigurationAssignmentsForSubscription',
