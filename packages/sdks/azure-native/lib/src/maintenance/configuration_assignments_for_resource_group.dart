...
class ConfigurationAssignmentsForResourceGroup extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ConfigurationAssignmentsForResourceGroup] resource.
  ConfigurationAssignmentsForResourceGroup.reference(String urn)
    : super(
        'azure-native:maintenance:ConfigurationAssignmentsForResourceGroup',
