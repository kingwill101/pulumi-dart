...
class MaintenanceConfigurationArgs {
  ...
  factory MaintenanceConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceConfigurationArgs(
      ...
      expirationDateTime: (() {
        final guardedValue = map['expirationDateTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      extensionProperties: (() {
        final guardedValue = map['extensionProperties'];
        if (guardedValue == null) return null;
      ...
      installPatches: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InputPatchConfiguration.fromMap(
      ...
      maintenanceScope: (() {
        final guardedValue = map['maintenanceScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      namespace: (() {
