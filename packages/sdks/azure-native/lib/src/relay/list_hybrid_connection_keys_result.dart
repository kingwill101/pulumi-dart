...
/// Result data returned by listHybridConnectionKeys.
class ListHybridConnectionKeysResult {
  ...
  /// Creates a new [ListHybridConnectionKeysResult].
  ...
  const ListHybridConnectionKeysResult({
    this.keyName,
  ...
  factory ListHybridConnectionKeysResult.fromMap(Map<String, dynamic> map) {
