...
/// }
///
/// resource "azure-native_relay_privateendpointconnection" "privateEndpointConnection" {
...
class PrivateEndpointConnectionRelay extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionRelay] resource.
  PrivateEndpointConnectionRelay.reference(String urn)
    : super(
        'azure-native:relay:PrivateEndpointConnection',
