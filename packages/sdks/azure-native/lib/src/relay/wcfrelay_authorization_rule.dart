...
/// }
///
/// resource "azure-native_relay_wcfrelayauthorizationrule" "wcfRelayAuthorizationRule" {
...
class WCFRelayAuthorizationRule extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WCFRelayAuthorizationRule] resource.
  WCFRelayAuthorizationRule.reference(String urn)
    : super(
        'azure-native:relay:WCFRelayAuthorizationRule',
