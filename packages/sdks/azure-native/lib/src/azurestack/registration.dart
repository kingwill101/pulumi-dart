...
/// }
///
/// resource "azure-native_azurestack_registration" "registration" {
///   location           = "global"
...
class Registration extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [Registration] resource.
  Registration.reference(String urn)
    : super(
        'azure-native:azurestack:Registration',
