    ...
    return <String, dynamic>{
      ...
      'compatibility':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(compatibility, (value) => value.toMap()),
      ...
      'productProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(productProperties, (value) => value.toMap()),
  ...
  factory ProductResponse.fromMap(Map<String, dynamic> map) {
    return ProductResponse(
      ...
      links: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProductLinkResponse>(
            guardedValue,
      ...
      productProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProductPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
