...
class GetProductResult {
  ...
  factory GetProductResult.fromMap(Map<String, dynamic> map) {
    return GetProductResult(
      billingPartNumber: (() { final guardedValue = map['billingPartNumber']; if (guardedValue == null) return null; return guardedValue as String; })(),
      compatibility: (() { final guardedValue = map['compatibility']; if (guardedValue == null) return null; return CompatibilityResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
