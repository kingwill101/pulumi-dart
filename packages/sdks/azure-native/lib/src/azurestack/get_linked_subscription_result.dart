...
class GetLinkedSubscriptionResult {
  ...
  factory GetLinkedSubscriptionResult.fromMap(Map<String, dynamic> map) {
    return GetLinkedSubscriptionResult(
      ...
      linkedSubscriptionId: map['linkedSubscriptionId'] == null ? null : map['linkedSubscriptionId'] as String,
      location: map['location'] as String,
      name: map['name'] as String,
      registrationResourceId: map['registrationResourceId'] == null ? null : map['registrationResourceId'] as String,
