...
class StreamingJobArgs {
  ...
  factory StreamingJobArgs.fromMap(Map<String, dynamic> map) {
    return StreamingJobArgs(
      ...
      transformation: (() { final guardedValue = map['transformation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Transformation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
