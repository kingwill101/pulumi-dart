...
class DiagnosticsResponse {
  ...
  DiagnosticsResponse({required this.conditions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<DiagnosticConditionResponse>,
  ...
  factory DiagnosticsResponse.fromMap(Map<String, dynamic> map) {
    return DiagnosticsResponse(
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DiagnosticConditionResponse>(
          map['conditions']!,
          (value) => DiagnosticConditionResponse.fromMap(
