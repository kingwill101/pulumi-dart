...
class AzureSqlReferenceInputDataSource {
  ...
  final pulumi.Input<dynamic>? refreshType;
  ...
  factory AzureSqlReferenceInputDataSource.fromMap(Map<String, dynamic> map) {
    return AzureSqlReferenceInputDataSource(
      ...
      refreshType: (() { final guardedValue = map['refreshType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
