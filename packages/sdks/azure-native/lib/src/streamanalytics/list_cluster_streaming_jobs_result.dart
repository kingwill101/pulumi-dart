...
class ListClusterStreamingJobsResult {
  ...
  ListClusterStreamingJobsResult({required this.nextLink, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': nextLink,
      'value':
          pulumi.Input.encodeList<ClusterJobResponse, Map<String, dynamic>>(
            value,
            (value) => value.toMap(),
          ),
    };
  ...
  factory ListClusterStreamingJobsResult.fromMap(Map<String, dynamic> map) {
    return ListClusterStreamingJobsResult(
      ...
      value: pulumi.Input.decodeList<ClusterJobResponse>(
        map['value']!,
        (value) =>
            ClusterJobResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
