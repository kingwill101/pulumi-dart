...
class AzureMachineLearningWebServiceInputs {
  ...
  final pulumi.Input<List<AzureMachineLearningWebServiceInputColumn>>?
  columnNames;
  ...
  AzureMachineLearningWebServiceInputs({this.columnNames, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columnNames':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureMachineLearningWebServiceInputColumn>,
  ...
  factory AzureMachineLearningWebServiceInputs.fromMap(
    ...
    return AzureMachineLearningWebServiceInputs(
      columnNames: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureMachineLearningWebServiceInputColumn>(
            guardedValue,
            (value) => AzureMachineLearningWebServiceInputColumn.fromMap(
