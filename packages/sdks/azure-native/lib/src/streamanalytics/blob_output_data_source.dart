...
class BlobOutputDataSource {
  ...
  factory BlobOutputDataSource.fromMap(Map<String, dynamic> map) {
    return BlobOutputDataSource(
      ...
      storageAccounts: (() { final guardedValue = map['storageAccounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StorageAccount>(guardedValue, (value) => StorageAccount.fromMap((value as Map).cast<String, dynamic>()))); })(),
