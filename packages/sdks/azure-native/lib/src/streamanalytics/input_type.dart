...
class InputType {
  ...
  factory InputType.fromMap(Map<String, dynamic> map) {
    return InputType(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReferenceInputProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
