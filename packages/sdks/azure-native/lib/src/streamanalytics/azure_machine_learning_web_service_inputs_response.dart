...
class AzureMachineLearningWebServiceInputsResponse {
  ...
  final pulumi.Input<List<AzureMachineLearningWebServiceInputColumnResponse>>?
  columnNames;
  ...
  AzureMachineLearningWebServiceInputsResponse({this.columnNames, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columnNames':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureMachineLearningWebServiceInputColumnResponse>,
  ...
  factory AzureMachineLearningWebServiceInputsResponse.fromMap(
      ...
      columnNames: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AzureMachineLearningWebServiceInputColumnResponse.fromMap(
