...
class AzureMachineLearningWebServiceFunctionBindingResponse {
  ...
  factory AzureMachineLearningWebServiceFunctionBindingResponse.fromMap(Map<String, dynamic> map) {
    return AzureMachineLearningWebServiceFunctionBindingResponse(
      ...
      inputs: (() { final guardedValue = map['inputs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureMachineLearningWebServiceInputsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      outputs: (() { final guardedValue = map['outputs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AzureMachineLearningWebServiceOutputColumnResponse>(guardedValue, (value) => AzureMachineLearningWebServiceOutputColumnResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
