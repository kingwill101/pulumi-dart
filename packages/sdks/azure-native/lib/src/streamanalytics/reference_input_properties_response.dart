...
class ReferenceInputPropertiesResponse {
  ...
  factory ReferenceInputPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ReferenceInputPropertiesResponse(
      ...
      datasource: (() { final guardedValue = map['datasource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureSqlReferenceInputDataSourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
