...
class AggregateFunctionPropertiesResponse {
  ...
  factory AggregateFunctionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AggregateFunctionPropertiesResponse(
      binding: (() { final guardedValue = map['binding']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureMachineLearningWebServiceFunctionBindingResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
