  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'functions': ?(() {
        ...
        return pulumi.Input.encodeList<FunctionResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
      ...
      'inputs': ?(() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<InputResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
      ...
      'outputs': ?(() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<OutputResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetStreamingJobResult.fromMap(Map<String, dynamic> map) {
    return GetStreamingJobResult(
      ...
      functions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<FunctionResponse>(
          guardedValue,
          (value) =>
              FunctionResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      id: map['id'] as String,
      identity: (() {
      ...
      inputs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<InputResponse>(
          guardedValue,
          (value) =>
      ...
      outputs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<OutputResponse>(
          guardedValue,
          (value) =>
