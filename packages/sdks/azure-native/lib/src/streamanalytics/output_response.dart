...
class OutputResponse {
  ...
  factory OutputResponse.fromMap(Map<String, dynamic> map) {
    return OutputResponse(
      datasource: (() { final guardedValue = map['datasource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureDataLakeStoreOutputDataSourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
