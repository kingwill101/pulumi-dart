...
class AzureMachineLearningWebServiceFunctionBinding {
  ...
  factory AzureMachineLearningWebServiceFunctionBinding.fromMap(
    ...
    return AzureMachineLearningWebServiceFunctionBinding(
      ...
      inputs: (() {
        ...
        return pulumi.Input.fromValue(
          AzureMachineLearningWebServiceInputs.fromMap(
      ...
      outputs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureMachineLearningWebServiceOutputColumn>(
            guardedValue,
            (value) => AzureMachineLearningWebServiceOutputColumn.fromMap(
