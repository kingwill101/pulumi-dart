...
class GetOutputResult {
  ...
  factory GetOutputResult.fromMap(Map<String, dynamic> map) {
    return GetOutputResult(
      ...
      datasource: (() { final guardedValue = map['datasource']; if (guardedValue == null) return null; return AzureDataLakeStoreOutputDataSourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      diagnostics: DiagnosticsResponse.fromMap((map['diagnostics']! as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      id: map['id'] as String,
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return guardedValue as String; })(),
      serialization: (() { final guardedValue = map['serialization']; if (guardedValue == null) return null; return AvroSerializationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      sizeWindow: (() { final guardedValue = map['sizeWindow']; if (guardedValue == null) return null; return guardedValue as int; })(),
