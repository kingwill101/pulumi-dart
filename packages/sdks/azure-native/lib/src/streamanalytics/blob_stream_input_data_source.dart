...
class BlobStreamInputDataSource {
  ...
  /// Creates a new [BlobStreamInputDataSource].
  ...
  factory BlobStreamInputDataSource.fromMap(Map<String, dynamic> map) {
    return BlobStreamInputDataSource(
      ...
      sourcePartitionCount: (() { final guardedValue = map['sourcePartitionCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
