...
class GetApplicationResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'services': ?services == null ? null : pulumi.Input.encodeList<ServiceResourceDescriptionResponse, Map<String, dynamic>>(services!, (value) => value.toMap()),
      'status': status,
  ...
  factory GetApplicationResult.fromMap(Map<String, dynamic> map) {
    return GetApplicationResult(
      ...
      diagnostics: map['diagnostics'] == null ? null : DiagnosticsDescriptionResponse.fromMap((map['diagnostics']! as Map).cast<String, dynamic>()),
      ...
      services: map['services'] == null ? null : pulumi.Input.decodeList<ServiceResourceDescriptionResponse>(map['services']!, (value) => ServiceResourceDescriptionResponse.fromMap((value as Map).cast<String, dynamic>())),
