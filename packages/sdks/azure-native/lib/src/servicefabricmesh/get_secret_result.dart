...
class GetSecretResult {
  ...
  factory GetSecretResult.fromMap(Map<String, dynamic> map) {
    return GetSecretResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return SecretResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
