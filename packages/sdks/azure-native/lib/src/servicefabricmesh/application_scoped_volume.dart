...
class ApplicationScopedVolume {
  ...
  factory ApplicationScopedVolume.fromMap(Map<String, dynamic> map) {
    return ApplicationScopedVolume(
      creationParameters: pulumi.Input.fromValue(ApplicationScopedVolumeCreationParametersServiceFabricVolumeDisk.fromMap((map['creationParameters']! as Map).cast<String, dynamic>())),
