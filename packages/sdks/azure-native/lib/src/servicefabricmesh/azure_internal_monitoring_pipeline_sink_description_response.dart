...
class AzureInternalMonitoringPipelineSinkDescriptionResponse {
  ...
  const AzureInternalMonitoringPipelineSinkDescriptionResponse({
    this.accountName,
  ...
  factory AzureInternalMonitoringPipelineSinkDescriptionResponse.fromMap(Map<String, dynamic> map) {
    return AzureInternalMonitoringPipelineSinkDescriptionResponse(
      ...
      autoKeyConfigUrl: (() { final guardedValue = map['autoKeyConfigUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      fluentdConfigUrl: (() { final guardedValue = map['fluentdConfigUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      maConfigUrl: (() { final guardedValue = map['maConfigUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
