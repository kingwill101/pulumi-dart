...
class GatewayArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinationNetwork':
          pulumi.Input.mapInputValue<NetworkRef, Map<String, dynamic>>(
            destinationNetwork,
            (value) => value.toMap(),
          ),
      ...
      'http':
          ...
          >(
            http,
            (value) =>
                pulumi.Input.encodeList<HttpConfig, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'tcp':
          ...
          >(
            tcp,
            (value) => pulumi.Input.encodeList<TcpConfig, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      destinationNetwork: pulumi.Input.fromValue(
        NetworkRef.fromMap(
          (map['destinationNetwork']! as Map).cast<String, dynamic>(),
        ),
      ),
      gatewayResourceName: (() {
        final guardedValue = map['gatewayResourceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      http: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpConfig>(
            guardedValue,
            (value) =>
                HttpConfig.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      location: (() {
      ...
      sourceNetwork: pulumi.Input.fromValue(
        NetworkRef.fromMap(
          (map['sourceNetwork']! as Map).cast<String, dynamic>(),
        ),
      ),
      tags: (() {
      ...
      tcp: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TcpConfig>(
            guardedValue,
            (value) =>
                TcpConfig.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
