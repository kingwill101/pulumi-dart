...
class NetworkRef {
  ...
  NetworkRef({this.endpointRefs, this.name});
    ...
    return <String, dynamic>{
      'endpointRefs':
          ...
          >(
            endpointRefs,
            (value) =>
                pulumi.Input.encodeList<EndpointRef, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return NetworkRef(
      endpointRefs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointRef>(
            guardedValue,
            (value) =>
                EndpointRef.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
