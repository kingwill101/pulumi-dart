...
class DiagnosticsDescriptionResponse {
  ...
  final pulumi.Input<
    List<AzureInternalMonitoringPipelineSinkDescriptionResponse>
  >?
  sinks;
  ...
  factory DiagnosticsDescriptionResponse.fromMap(Map<String, dynamic> map) {
    return DiagnosticsDescriptionResponse(
      defaultSinkRefs: (() {
        final guardedValue = map['defaultSinkRefs'];
      ...
      sinks: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AzureInternalMonitoringPipelineSinkDescriptionResponse.fromMap(
