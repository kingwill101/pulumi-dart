...
class HttpRouteMatchRuleResponse {
  ...
  HttpRouteMatchRuleResponse({this.headers, required this.path});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<HttpRouteMatchHeaderResponse>,
    ...
    return HttpRouteMatchRuleResponse(
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpRouteMatchHeaderResponse>(
            guardedValue,
            (value) => HttpRouteMatchHeaderResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      path: pulumi.Input.fromValue(
        HttpRouteMatchPathResponse.fromMap(
