  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      applicationResourceName: (() {
        final guardedValue = map['applicationResourceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      debugParams: (() {
        final guardedValue = map['debugParams'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      diagnostics: (() {
        ...
        return pulumi.Input.fromValue(
          DiagnosticsDescription.fromMap(
      ...
      services: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceResourceDescription>(
            guardedValue,
            (value) => ServiceResourceDescription.fromMap(
