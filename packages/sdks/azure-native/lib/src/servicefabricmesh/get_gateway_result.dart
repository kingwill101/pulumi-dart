...
class GetGatewayResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tags': ?tags,
      'tcp': ?(() {
        final guardedValue = tcp;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<TcpConfigResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetGatewayResult(
      ...
      destinationNetwork: NetworkRefResponse.fromMap(
        (map['destinationNetwork']! as Map).cast<String, dynamic>(),
      ),
      http: (() {
        final guardedValue = map['http'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<HttpConfigResponse>(
          guardedValue,
          (value) => HttpConfigResponse.fromMap(
      ...
      sourceNetwork: NetworkRefResponse.fromMap(
      ...
      tcp: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<TcpConfigResponse>(
          guardedValue,
          (value) =>
              TcpConfigResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
