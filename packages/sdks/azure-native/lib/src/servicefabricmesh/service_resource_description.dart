    ...
    return <String, dynamic>{
      ...
      'networkRefs':
          ...
          >(
            networkRefs,
            (value) =>
                pulumi.Input.encodeList<NetworkRef, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ServiceResourceDescription(
      autoScalingPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutoScalingPolicy>(
            guardedValue,
            (value) => AutoScalingPolicy.fromMap(
      ...
      codePackages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ContainerCodePackageProperties>(
          map['codePackages']!,
          (value) => ContainerCodePackageProperties.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      networkRefs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkRef>(
            guardedValue,
            (value) =>
                NetworkRef.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
