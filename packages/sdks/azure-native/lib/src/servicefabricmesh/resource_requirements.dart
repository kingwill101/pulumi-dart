...
class ResourceRequirements {
  ...
  ResourceRequirements({this.limits, required this.requests});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requests':
          pulumi.Input.mapInputValue<ResourceRequests, Map<String, dynamic>>(
            requests,
            (value) => value.toMap(),
          ),
    };
    ...
    return ResourceRequirements(
      limits: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceLimits.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      requests: pulumi.Input.fromValue(
        ResourceRequests.fromMap(
