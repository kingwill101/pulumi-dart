  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'settings':
          ...
          >(
            settings,
            (value) => pulumi.Input.encodeList<Setting, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'volumeRefs':
          ...
          >(
            volumeRefs,
            (value) =>
                pulumi.Input.encodeList<VolumeReference, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ContainerCodePackageProperties(
      ...
      diagnostics: (() {
        ...
        return pulumi.Input.fromValue(
          DiagnosticsRef.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      endpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointProperties>(
            guardedValue,
            (value) => EndpointProperties.fromMap(
      ...
      reliableCollectionsRefs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReliableCollectionsRef>(
            guardedValue,
            (value) => ReliableCollectionsRef.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      settings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Setting>(
            guardedValue,
            (value) => Setting.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      volumeRefs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeReference>(
            guardedValue,
            (value) =>
                VolumeReference.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      volumes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationScopedVolume>(
            guardedValue,
            (value) => ApplicationScopedVolume.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
