...
class GetNetworkResult {
  ...
  factory GetNetworkResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return NetworkResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
