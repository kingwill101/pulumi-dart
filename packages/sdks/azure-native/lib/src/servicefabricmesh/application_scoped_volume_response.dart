...
class ApplicationScopedVolumeResponse {
  ...
  factory ApplicationScopedVolumeResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationScopedVolumeResponse(
      creationParameters: (ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponse.fromMap((map['creationParameters'] as Map).cast<String, dynamic>())).input(),
