...
class ContainerCodePackagePropertiesResponse {
  ...
  const ContainerCodePackagePropertiesResponse({
    this.commands,
    this.diagnostics,
    this.endpoints,
    this.entrypoint,
  ...
  factory ContainerCodePackagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ContainerCodePackagePropertiesResponse(
      ...
      endpoints: (() { final guardedValue = map['endpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointPropertiesResponse>(guardedValue, (value) => EndpointPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      instanceView: pulumi.Input.fromValue(ContainerInstanceViewResponse.fromMap((map['instanceView']! as Map).cast<String, dynamic>())),
      labels: (() { final guardedValue = map['labels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerLabelResponse>(guardedValue, (value) => ContainerLabelResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      reliableCollectionsRefs: (() { final guardedValue = map['reliableCollectionsRefs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReliableCollectionsRefResponse>(guardedValue, (value) => ReliableCollectionsRefResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resources: pulumi.Input.fromValue(ResourceRequirementsResponse.fromMap((map['resources']! as Map).cast<String, dynamic>())),
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SettingResponse>(guardedValue, (value) => SettingResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      volumeRefs: (() { final guardedValue = map['volumeRefs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VolumeReferenceResponse>(guardedValue, (value) => VolumeReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      volumes: (() { final guardedValue = map['volumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationScopedVolumeResponse>(guardedValue, (value) => ApplicationScopedVolumeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
