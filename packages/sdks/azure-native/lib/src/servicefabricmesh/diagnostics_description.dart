...
class DiagnosticsDescription {
  ...
  final pulumi.Input<List<AzureInternalMonitoringPipelineSinkDescription>>?
  sinks;
  ...
  DiagnosticsDescription({this.defaultSinkRefs, this.enabled, this.sinks});
    ...
    return <String, dynamic>{
      ...
      'sinks':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureInternalMonitoringPipelineSinkDescription>,
    ...
    return DiagnosticsDescription(
      ...
      sinks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<AzureInternalMonitoringPipelineSinkDescription>(
            guardedValue,
            (value) => AzureInternalMonitoringPipelineSinkDescription.fromMap(
