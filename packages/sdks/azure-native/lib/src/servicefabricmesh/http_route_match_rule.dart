...
class HttpRouteMatchRule {
  ...
  HttpRouteMatchRule({this.headers, required this.path});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'path':
          pulumi.Input.mapInputValue<HttpRouteMatchPath, Map<String, dynamic>>(
            path,
            (value) => value.toMap(),
          ),
    };
    ...
    return HttpRouteMatchRule(
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpRouteMatchHeader>(
            guardedValue,
            (value) => HttpRouteMatchHeader.fromMap(
