...
class HttpHostConfig {
  ...
  HttpHostConfig({required this.name, required this.routes});
    ...
    return <String, dynamic>{
      ...
      'routes':
          ...
          >(
            routes,
            (value) =>
                pulumi.Input.encodeList<HttpRouteConfig, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory HttpHostConfig.fromMap(Map<String, dynamic> map) {
    return HttpHostConfig(
      ...
      routes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HttpRouteConfig>(
          map['routes']!,
          (value) =>
              HttpRouteConfig.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
