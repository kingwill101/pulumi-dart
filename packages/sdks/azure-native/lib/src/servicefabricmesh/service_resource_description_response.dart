...
class ServiceResourceDescriptionResponse {
  ...
  factory ServiceResourceDescriptionResponse.fromMap(Map<String, dynamic> map) {
    return ServiceResourceDescriptionResponse(
      autoScalingPolicies: (() { final guardedValue = map['autoScalingPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutoScalingPolicyResponse>(guardedValue, (value) => AutoScalingPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      codePackages: pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerCodePackagePropertiesResponse>(map['codePackages']!, (value) => ContainerCodePackagePropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      diagnostics: (() { final guardedValue = map['diagnostics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiagnosticsRefResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      healthState: pulumi.Input.fromValue(map['healthState'] as String),
      id: pulumi.Input.fromValue(map['id'] as String),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkRefs: (() { final guardedValue = map['networkRefs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkRefResponse>(guardedValue, (value) => NetworkRefResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      unhealthyEvaluation: pulumi.Input.fromValue(map['unhealthyEvaluation'] as String),
    );
  }
}
