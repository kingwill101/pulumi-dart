...
class RetentionPolicyProperties {
  ...
  RetentionPolicyProperties({this.retentionPolicies});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'retentionPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<RetentionPolicyDetails>,
    ...
    return RetentionPolicyProperties(
      retentionPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RetentionPolicyDetails>(
            guardedValue,
            (value) => RetentionPolicyDetails.fromMap(
