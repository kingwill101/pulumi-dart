...
/// {@template pulumi_durabletask_scheduler_private_endpoint_connection_args_doc}
/// The set of arguments for SchedulerPrivateEndpointConnection.
/// {@endtemplate}
/// {@macro pulumi_durabletask_scheduler_private_endpoint_connection_args_doc}
class SchedulerPrivateEndpointConnectionArgs {
  ...
  factory SchedulerPrivateEndpointConnectionArgs.fromMap(Map<String, dynamic> map) {
    return SchedulerPrivateEndpointConnectionArgs(
