...
class SchedulerProperties {
  ...
  SchedulerProperties({required this.ipAllowlist, required this.sku});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipAllowlist': ipAllowlist,
      'sku': pulumi.Input.mapInputValue<SchedulerSku, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
    };
  ...
  factory SchedulerProperties.fromMap(Map<String, dynamic> map) {
    return SchedulerProperties(
      ...
      sku: pulumi.Input.fromValue(
        SchedulerSku.fromMap((map['sku']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
