...
class SchedulerArgs {
  ...
  factory SchedulerArgs.fromMap(Map<String, dynamic> map) {
    return SchedulerArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SchedulerProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
