...
/// Result data returned by getSchedulerPrivateEndpointConnection.
class GetSchedulerPrivateEndpointConnectionResult {
  ...
  /// Creates a new [GetSchedulerPrivateEndpointConnectionResult].
  ...
  const GetSchedulerPrivateEndpointConnectionResult({
  ...
  factory GetSchedulerPrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetSchedulerPrivateEndpointConnectionResult(
