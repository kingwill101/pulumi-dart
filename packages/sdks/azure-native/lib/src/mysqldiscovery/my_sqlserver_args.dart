...
class MySQLServerArgs {
  ...
  final pulumi.Input<dynamic>? supportStatus;
  /// Resource tags
  ...
  factory MySQLServerArgs.fromMap(Map<String, dynamic> map) {
    return MySQLServerArgs(
      ...
      numberOfDatabase: (() { final guardedValue = map['numberOfDatabase']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      supportStatus: (() { final guardedValue = map['supportStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
