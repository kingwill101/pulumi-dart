  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'errors':
          ...
          >(
            errors,
            (value) => pulumi.Input.encodeList<Error, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return MySQLServerArgs(
      ...
      errors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Error>(
            guardedValue,
            (value) => Error.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      hostIp: (() {
      ...
      mysqlVersion: (() {
        final guardedValue = map['mysqlVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      numberOfDatabase: (() {
        final guardedValue = map['numberOfDatabase'];
        if (guardedValue == null) return null;
      ...
      supportEndIn: (() {
        final guardedValue = map['supportEndIn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      supportStatus: (() {
        final guardedValue = map['supportStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
