...
class GetMySQLServerResult {
  ...
  factory GetMySQLServerResult.fromMap(Map<String, dynamic> map) {
    return GetMySQLServerResult(
      ...
      numberOfDatabase: (() { final guardedValue = map['numberOfDatabase']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      portNumber: (() { final guardedValue = map['portNumber']; if (guardedValue == null) return null; return guardedValue as String; })(),
