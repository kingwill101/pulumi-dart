  ...
  factory CreationDataResponse.fromMap(Map<String, dynamic> map) {
    return CreationDataResponse(
      ...
      elasticSanResourceId: (() {
        final guardedValue = map['elasticSanResourceId'];
      ...
      galleryImageReference: (() {
        ...
        return pulumi.Input.fromValue(
          ImageDiskReferenceResponse.fromMap(
      ...
      performancePlus: (() {
        final guardedValue = map['performancePlus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      provisionedBandwidthCopySpeed: (() {
        final guardedValue = map['provisionedBandwidthCopySpeed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      securityDataUri: (() {
        final guardedValue = map['securityDataUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceResourceId: (() {
