...
class CloudServiceExtensionPropertiesResponse {
  ...
  final pulumi.Input<CloudServiceVaultAndSecretReferenceResponse>?
  ...
  factory CloudServiceExtensionPropertiesResponse.fromMap(
    ...
    return CloudServiceExtensionPropertiesResponse(
      ...
      protectedSettingsFromKeyVault: (() {
        ...
        return pulumi.Input.fromValue(
          CloudServiceVaultAndSecretReferenceResponse.fromMap(
      ...
      rolesAppliedTo: (() {
        final guardedValue = map['rolesAppliedTo'];
        if (guardedValue == null) return null;
