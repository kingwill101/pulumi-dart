...
class CloudServiceExtensionPropertiesResponse {
  ...
  final CloudServiceVaultAndSecretReferenceResponse? protectedSettingsFromKeyVault;
  /// The provisioning state, which only appears in the response.
  final String provisioningState;
  /// The name of the extension handler publisher.
  final String? publisher;
  /// Optional list of roles to apply this extension. If property is not specified or '*' is specified, extension is applied to all roles in the cloud service.
  final List<String>? rolesAppliedTo;
  ...
  factory CloudServiceExtensionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudServiceExtensionPropertiesResponse(
      ...
      protectedSettingsFromKeyVault: map['protectedSettingsFromKeyVault'] == null ? null : CloudServiceVaultAndSecretReferenceResponse.fromMap((map['protectedSettingsFromKeyVault'] as Map).cast<String, dynamic>()),
      provisioningState: map['provisioningState'] as String,
      publisher: map['publisher'] == null ? null : map['publisher'] as String,
      rolesAppliedTo: map['rolesAppliedTo'] == null ? null : (map['rolesAppliedTo'] as List).cast<String>(),
