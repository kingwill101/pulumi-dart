...
class RecommendedMachineConfiguration {
  ...
  factory RecommendedMachineConfiguration.fromMap(Map<String, dynamic> map) {
    return RecommendedMachineConfiguration(
      memory: (() { final guardedValue = map['memory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vCPUs: (() { final guardedValue = map['vCPUs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
