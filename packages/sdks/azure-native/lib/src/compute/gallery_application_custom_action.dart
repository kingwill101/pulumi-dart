    ...
    return <String, dynamic>{
      ...
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GalleryApplicationCustomActionParameter>,
    ...
    return GalleryApplicationCustomAction(
      ...
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryApplicationCustomActionParameter>(
            guardedValue,
            (value) => GalleryApplicationCustomActionParameter.fromMap(
