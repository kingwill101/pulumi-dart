...
class VirtualMachineScaleSetExtensionProfileResponse {
    ...
    return <String, dynamic>{
      'extensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachineScaleSetExtensionResponse>,
  ...
  factory VirtualMachineScaleSetExtensionProfileResponse.fromMap(
    ...
    return VirtualMachineScaleSetExtensionProfileResponse(
      extensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachineScaleSetExtensionResponse>(
            guardedValue,
            (value) => VirtualMachineScaleSetExtensionResponse.fromMap(
