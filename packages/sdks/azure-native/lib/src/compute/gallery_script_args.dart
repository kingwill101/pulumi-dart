...
class GalleryScriptArgs {
  ...
  factory GalleryScriptArgs.fromMap(Map<String, dynamic> map) {
    return GalleryScriptArgs(
      ...
      galleryScriptName: (() { final guardedValue = map['galleryScriptName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GalleryScriptProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
