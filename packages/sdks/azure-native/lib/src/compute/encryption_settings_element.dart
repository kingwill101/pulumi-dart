...
class EncryptionSettingsElement {
  ...
  factory EncryptionSettingsElement.fromMap(Map<String, dynamic> map) {
    return EncryptionSettingsElement(
      diskEncryptionKey: (() { final guardedValue = map['diskEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyVaultAndSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      keyEncryptionKey: (() { final guardedValue = map['keyEncryptionKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyVaultAndKeyReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
