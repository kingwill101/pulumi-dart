...
class WindowsConfigurationResponse {
  ...
  final pulumi.Input<List<AdditionalUnattendContentResponse>>?
    ...
    return WindowsConfigurationResponse(
      additionalUnattendContent: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdditionalUnattendContentResponse>(
            guardedValue,
            (value) => AdditionalUnattendContentResponse.fromMap(
      ...
      enableVMAgentPlatformUpdates: pulumi.Input.fromValue(
        map['enableVMAgentPlatformUpdates'] as bool,
      ),
      patchSettings: (() {
        final guardedValue = map['patchSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PatchSettingsResponse.fromMap(
      ...
      winRM: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WinRMConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
