...
class CloudServiceRoleProfileResponse {
  ...
  CloudServiceRoleProfileResponse({this.roles});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'roles':
          ?pulumi.Input.mapOptionalInputValue<
            List<CloudServiceRoleProfilePropertiesResponse>,
    ...
    return CloudServiceRoleProfileResponse(
      roles: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CloudServiceRoleProfilePropertiesResponse>(
            guardedValue,
            (value) => CloudServiceRoleProfilePropertiesResponse.fromMap(
