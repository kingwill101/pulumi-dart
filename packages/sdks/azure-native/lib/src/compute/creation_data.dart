...
class CreationData {
  ...
  final pulumi.Input<dynamic>? provisionedBandwidthCopySpeed;
  ...
  factory CreationData.fromMap(Map<String, dynamic> map) {
    return CreationData(
      ...
      provisionedBandwidthCopySpeed: (() { final guardedValue = map['provisionedBandwidthCopySpeed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
