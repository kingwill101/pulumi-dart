...
class GalleryImageVersionSafetyProfileResponse {
  ...
  final List<PolicyViolationResponse> policyViolations;
  /// Indicates whether this image has been reported as violating Microsoft's policies.
  final bool reportedForPolicyViolation;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policyViolations': pulumi.Input.encodeList<PolicyViolationResponse, Map<String, dynamic>>(policyViolations, (value) => value.toMap()),
  ...
  factory GalleryImageVersionSafetyProfileResponse.fromMap(Map<String, dynamic> map) {
    return GalleryImageVersionSafetyProfileResponse(
      ...
      policyViolations: pulumi.Input.decodeList<PolicyViolationResponse>(map['policyViolations'], (value) => PolicyViolationResponse.fromMap((value as Map).cast<String, dynamic>())),
      reportedForPolicyViolation: map['reportedForPolicyViolation'] as bool,
    );
  }
}
