...
class EncryptionSettingsCollectionResponse {
  ...
  final pulumi.Input<List<EncryptionSettingsElementResponse>>?
  encryptionSettings;
    ...
    return <String, dynamic>{
      ...
      'encryptionSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<EncryptionSettingsElementResponse>,
  ...
  factory EncryptionSettingsCollectionResponse.fromMap(
    ...
    return EncryptionSettingsCollectionResponse(
      ...
      encryptionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EncryptionSettingsElementResponse>(
            guardedValue,
            (value) => EncryptionSettingsElementResponse.fromMap(
