...
class VirtualMachineScaleSetMigrationInfoResponse {
  ...
  factory VirtualMachineScaleSetMigrationInfoResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetMigrationInfoResponse(
      defaultVirtualMachineScaleSetInfo: (DefaultVirtualMachineScaleSetInfoResponse.fromMap((map['defaultVirtualMachineScaleSetInfo'] as Map).cast<String, dynamic>())).input(),
      migrateToVirtualMachineScaleSet: (SubResourceResponse.fromMap((map['migrateToVirtualMachineScaleSet'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
