...
class VirtualMachineScaleSetMigrationInfoResponse {
  ...
  final pulumi.Input<DefaultVirtualMachineScaleSetInfoResponse> defaultVirtualMachineScaleSetInfo;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultVirtualMachineScaleSetInfo': pulumi.Input.mapInputValue<DefaultVirtualMachineScaleSetInfoResponse, Map<String, dynamic>>(defaultVirtualMachineScaleSetInfo, (value) => value.toMap()),
      'migrateToVirtualMachineScaleSet': pulumi.Input.mapInputValue<SubResourceResponse, Map<String, dynamic>>(migrateToVirtualMachineScaleSet, (value) => value.toMap()),
    };
  }
  ...
  factory VirtualMachineScaleSetMigrationInfoResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetMigrationInfoResponse(
      defaultVirtualMachineScaleSetInfo: pulumi.Input.fromValue(DefaultVirtualMachineScaleSetInfoResponse.fromMap((map['defaultVirtualMachineScaleSetInfo']! as Map).cast<String, dynamic>())),
      migrateToVirtualMachineScaleSet: pulumi.Input.fromValue(SubResourceResponse.fromMap((map['migrateToVirtualMachineScaleSet']! as Map).cast<String, dynamic>())),
    );
  }
}
