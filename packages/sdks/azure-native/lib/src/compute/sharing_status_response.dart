...
class SharingStatusResponse {
  ...
  SharingStatusResponse({required this.aggregatedState, this.summary});
    ...
    return <String, dynamic>{
      ...
      'summary':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegionalSharingStatusResponse>,
    ...
    return SharingStatusResponse(
      ...
      summary: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegionalSharingStatusResponse>(
            guardedValue,
            (value) => RegionalSharingStatusResponse.fromMap(
