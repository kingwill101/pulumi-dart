...
class VirtualMachineInstanceViewResponse {
  ...
  factory VirtualMachineInstanceViewResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineInstanceViewResponse(
      ...
      isVMInStandbyPool: pulumi.Input.fromValue(
        map['isVMInStandbyPool'] as bool,
      ),
      maintenanceRedeployStatus: (() {
      ...
      patchStatus: (() {
        final guardedValue = map['patchStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachinePatchStatusResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
