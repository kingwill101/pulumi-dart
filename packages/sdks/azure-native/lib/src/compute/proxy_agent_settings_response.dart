...
class ProxyAgentSettingsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enabled': ?enabled,
      'imds': ?pulumi.Input.mapOptionalInputValue<HostEndpointSettingsResponse, Map<String, dynamic>>(imds, (value) => value.toMap()),
      'keyIncarnationId': ?keyIncarnationId,
      'mode': ?mode,
      'wireServer': ?pulumi.Input.mapOptionalInputValue<HostEndpointSettingsResponse, Map<String, dynamic>>(wireServer, (value) => value.toMap()),
    };
  }
  ...
  factory ProxyAgentSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ProxyAgentSettingsResponse(
      ...
      imds: (() { final guardedValue = map['imds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostEndpointSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      wireServer: (() { final guardedValue = map['wireServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostEndpointSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
