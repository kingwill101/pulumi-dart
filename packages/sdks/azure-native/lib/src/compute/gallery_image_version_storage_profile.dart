...
class GalleryImageVersionStorageProfile {
  ...
  factory GalleryImageVersionStorageProfile.fromMap(Map<String, dynamic> map) {
    return GalleryImageVersionStorageProfile(
      dataDiskImages: (() { final guardedValue = map['dataDiskImages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GalleryDataDiskImage>(guardedValue, (value) => GalleryDataDiskImage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      osDiskImage: (() { final guardedValue = map['osDiskImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GalleryOSDiskImage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GalleryArtifactVersionFullSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
