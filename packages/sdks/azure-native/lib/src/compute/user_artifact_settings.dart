...
class UserArtifactSettings {
  ...
  final pulumi.Input<dynamic>? scriptBehaviorAfterReboot;
  ...
  factory UserArtifactSettings.fromMap(Map<String, dynamic> map) {
    return UserArtifactSettings(
      ...
      scriptBehaviorAfterReboot: (() { final guardedValue = map['scriptBehaviorAfterReboot']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
