...
class DedicatedHost extends pulumi.CustomResource {
  ...
  DedicatedHost(
    ...
    this.instanceView = registerOutput<DedicatedHostInstanceViewResponse>('instanceView');
    ...
    this.provisioningTime = registerOutput<String>('provisioningTime');
    this.sku = registerOutput<SkuResponse>('sku');
    this.systemData = registerOutput<SystemDataResponse>('systemData');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.timeCreated = registerOutput<String>('timeCreated');
    this.type = registerOutput<String>('type');
    this.virtualMachines = registerOutput<List<SubResourceReadOnlyResponse>>('virtualMachines');
  }
}
