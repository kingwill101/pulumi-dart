...
class GetAvailabilitySetResult {
  ...
  final VirtualMachineScaleSetMigrationInfoResponse
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualMachineScaleSetMigrationInfo': virtualMachineScaleSetMigrationInfo
          .toMap(),
      'virtualMachines': ?(() {
        final guardedValue = virtualMachines;
  ...
  factory GetAvailabilitySetResult.fromMap(Map<String, dynamic> map) {
    return GetAvailabilitySetResult(
      ...
      platformUpdateDomainCount: (() {
        final guardedValue = map['platformUpdateDomainCount'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
      ...
      statuses: pulumi.Input.decodeList<InstanceViewStatusResponse>(
        map['statuses']!,
      ...
      virtualMachineScaleSetMigrationInfo:
          VirtualMachineScaleSetMigrationInfoResponse.fromMap(
            (map['virtualMachineScaleSetMigrationInfo']! as Map)
                .cast<String, dynamic>(),
          ),
      virtualMachines: (() {
