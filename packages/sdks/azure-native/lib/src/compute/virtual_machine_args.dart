...
class VirtualMachineArgs {
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      availabilitySet: map['availabilitySet'] == null ? null : (SubResource.fromMap((map['availabilitySet']! as Map).cast<String, dynamic>())).input(),
      ...
      host: map['host'] == null ? null : (SubResource.fromMap((map['host']! as Map).cast<String, dynamic>())).input(),
      ...
      virtualMachineScaleSet: map['virtualMachineScaleSet'] == null ? null : (SubResource.fromMap((map['virtualMachineScaleSet']! as Map).cast<String, dynamic>())).input(),
