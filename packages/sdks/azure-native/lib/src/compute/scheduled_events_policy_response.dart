...
class ScheduledEventsPolicyResponse {
  ...
  final pulumi.Input<ScheduledEventsAdditionalPublishingTargetsResponse>?
    ...
    return ScheduledEventsPolicyResponse(
      scheduledEventsAdditionalPublishingTargets: (() {
        ...
        return pulumi.Input.fromValue(
          ScheduledEventsAdditionalPublishingTargetsResponse.fromMap(
      ...
      userInitiatedReboot: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserInitiatedRebootResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      userInitiatedRedeploy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserInitiatedRedeployResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
