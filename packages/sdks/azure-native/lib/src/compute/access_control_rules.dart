    ...
    return <String, dynamic>{
      'identities':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessControlRulesIdentity>,
      ...
      'privileges':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessControlRulesPrivilege>,
            List<Map<String, dynamic>>
          >(
            privileges,
            (value) =>
      ...
      'roleAssignments':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessControlRulesRoleAssignment>,
            List<Map<String, dynamic>>
          >(
            roleAssignments,
            (value) =>
    ...
    return AccessControlRules(
      identities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessControlRulesIdentity>(
            guardedValue,
            (value) => AccessControlRulesIdentity.fromMap(
      ...
      privileges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessControlRulesPrivilege>(
            guardedValue,
            (value) => AccessControlRulesPrivilege.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      roleAssignments: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessControlRulesRoleAssignment>(
            guardedValue,
            (value) => AccessControlRulesRoleAssignment.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      roles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessControlRulesRole>(
            guardedValue,
            (value) => AccessControlRulesRole.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
