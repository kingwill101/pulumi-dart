...
class RestorePointInstanceViewResponse {
  ...
  final pulumi.Input<List<DiskRestorePointInstanceViewResponse>>?
  diskRestorePoints;
  ...
  RestorePointInstanceViewResponse({this.diskRestorePoints, this.statuses});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diskRestorePoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiskRestorePointInstanceViewResponse>,
  ...
  factory RestorePointInstanceViewResponse.fromMap(Map<String, dynamic> map) {
    return RestorePointInstanceViewResponse(
      diskRestorePoints: (() {
        final guardedValue = map['diskRestorePoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiskRestorePointInstanceViewResponse>(
            guardedValue,
            (value) => DiskRestorePointInstanceViewResponse.fromMap(
