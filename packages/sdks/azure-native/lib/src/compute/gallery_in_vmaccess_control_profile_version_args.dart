...
class GalleryInVMAccessControlProfileVersionArgs {
  ...
  factory GalleryInVMAccessControlProfileVersionArgs.fromMap(
    ...
    return GalleryInVMAccessControlProfileVersionArgs(
      ...
      inVMAccessControlProfileVersionName: (() {
        final guardedValue = map['inVMAccessControlProfileVersionName'];
        if (guardedValue == null) return null;
      ...
      targetLocations: (() {
        final guardedValue = map['targetLocations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
