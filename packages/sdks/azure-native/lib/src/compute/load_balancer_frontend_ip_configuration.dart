...
class LoadBalancerFrontendIpConfiguration {
  ...
  final LoadBalancerFrontendIpConfigurationProperties properties;
  ...
  factory LoadBalancerFrontendIpConfiguration.fromMap(Map<String, dynamic> map) {
    return LoadBalancerFrontendIpConfiguration(
      ...
      properties: LoadBalancerFrontendIpConfigurationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
    );
  }
}
