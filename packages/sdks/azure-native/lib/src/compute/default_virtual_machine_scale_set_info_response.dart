...
class DefaultVirtualMachineScaleSetInfoResponse {
  ...
  factory DefaultVirtualMachineScaleSetInfoResponse.fromMap(Map<String, dynamic> map) {
    return DefaultVirtualMachineScaleSetInfoResponse(
      constrainedMaximumCapacity: (map['constrainedMaximumCapacity'] as bool).input(),
      defaultVirtualMachineScaleSet: (SubResourceResponse.fromMap((map['defaultVirtualMachineScaleSet'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
