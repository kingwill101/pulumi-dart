...
class CloudServiceExtensionProperties {
  ...
  final CloudServiceVaultAndSecretReference? protectedSettingsFromKeyVault;
  ...
  factory CloudServiceExtensionProperties.fromMap(Map<String, dynamic> map) {
    return CloudServiceExtensionProperties(
      ...
      protectedSettingsFromKeyVault: map['protectedSettingsFromKeyVault'] == null ? null : CloudServiceVaultAndSecretReference.fromMap((map['protectedSettingsFromKeyVault'] as Map).cast<String, dynamic>()),
