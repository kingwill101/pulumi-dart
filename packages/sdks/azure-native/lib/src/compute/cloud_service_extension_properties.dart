...
class CloudServiceExtensionProperties {
  ...
  factory CloudServiceExtensionProperties.fromMap(Map<String, dynamic> map) {
    return CloudServiceExtensionProperties(
      ...
      protectedSettingsFromKeyVault: (() { final guardedValue = map['protectedSettingsFromKeyVault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudServiceVaultAndSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
