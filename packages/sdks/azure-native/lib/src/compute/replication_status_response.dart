...
class ReplicationStatusResponse {
  ...
  factory ReplicationStatusResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationStatusResponse(
      ...
      summary: pulumi.Input.fromValue(pulumi.Input.decodeList<RegionalReplicationStatusResponse>(map['summary']!, (value) => RegionalReplicationStatusResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
