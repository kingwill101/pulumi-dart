...
class NetworkProfile {
  ...
  final pulumi.Input<List<VirtualMachineNetworkInterfaceConfiguration>>?
    ...
    return NetworkProfile(
      ...
      networkInterfaceConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachineNetworkInterfaceConfiguration>(
            guardedValue,
            (value) => VirtualMachineNetworkInterfaceConfiguration.fromMap(
      ...
      networkInterfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkInterfaceReference>(
            guardedValue,
            (value) => NetworkInterfaceReference.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
