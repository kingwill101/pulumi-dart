...
class UefiKeySignaturesResponse {
  ...
  factory UefiKeySignaturesResponse.fromMap(Map<String, dynamic> map) {
    return UefiKeySignaturesResponse(
      db: (() { final guardedValue = map['db']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UefiKeyResponse>(guardedValue, (value) => UefiKeyResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dbx: (() { final guardedValue = map['dbx']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UefiKeyResponse>(guardedValue, (value) => UefiKeyResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      kek: (() { final guardedValue = map['kek']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UefiKeyResponse>(guardedValue, (value) => UefiKeyResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pk: (() { final guardedValue = map['pk']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UefiKeyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
