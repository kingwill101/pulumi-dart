...
class GetProximityPlacementGroupResult {
    ...
    return <String, dynamic>{
      'availabilitySets':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(availabilitySets, (value) => value.toMap()),
      ...
      'virtualMachineScaleSets':
          pulumi.Input.encodeList<
            SubResourceWithColocationStatusResponse,
            Map<String, dynamic>
          >(virtualMachineScaleSets, (value) => value.toMap()),
      'virtualMachines':
          pulumi.Input.encodeList<
            SubResourceWithColocationStatusResponse,
            Map<String, dynamic>
  ...
  factory GetProximityPlacementGroupResult.fromMap(Map<String, dynamic> map) {
    return GetProximityPlacementGroupResult(
      availabilitySets:
          pulumi.Input.decodeList<SubResourceWithColocationStatusResponse>(
            map['availabilitySets']!,
            (value) => SubResourceWithColocationStatusResponse.fromMap(
