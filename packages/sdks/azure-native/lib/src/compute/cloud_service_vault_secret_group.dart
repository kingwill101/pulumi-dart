...
class CloudServiceVaultSecretGroup {
  ...
  CloudServiceVaultSecretGroup({this.sourceVault, this.vaultCertificates});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vaultCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<CloudServiceVaultCertificate>,
  ...
  factory CloudServiceVaultSecretGroup.fromMap(Map<String, dynamic> map) {
    return CloudServiceVaultSecretGroup(
      ...
      vaultCertificates: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CloudServiceVaultCertificate>(
            guardedValue,
            (value) => CloudServiceVaultCertificate.fromMap(
