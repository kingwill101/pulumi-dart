...
class ScaleInPolicy {
  ...
  factory ScaleInPolicy.fromMap(Map<String, dynamic> map) {
    return ScaleInPolicy(
      forceDeletion: (() { final guardedValue = map['forceDeletion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      prioritizeUnhealthyVMs: (() { final guardedValue = map['prioritizeUnhealthyVMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
