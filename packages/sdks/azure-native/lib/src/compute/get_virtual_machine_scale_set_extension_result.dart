...
/// Result data returned by getVirtualMachineScaleSetExtension.
class GetVirtualMachineScaleSetExtensionResult {
  ...
  /// Creates a new [GetVirtualMachineScaleSetExtensionResult].
  ...
  const GetVirtualMachineScaleSetExtensionResult({
