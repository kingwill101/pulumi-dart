...
class WinRMListener {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'protocol': ?pulumi.Input.mapOptionalInputValue<ProtocolTypes, String>(protocol, (value) => value.value),
    };
  }
  ...
  factory WinRMListener.fromMap(Map<String, dynamic> map) {
    return WinRMListener(
      ...
      protocol: map['protocol'] == null ? null : (ProtocolTypes.fromValue(map['protocol']! as String)).input(),
    );
  }
}
