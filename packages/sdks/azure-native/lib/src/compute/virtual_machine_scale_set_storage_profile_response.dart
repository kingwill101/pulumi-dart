...
class VirtualMachineScaleSetStorageProfileResponse {
    ...
    return <String, dynamic>{
      'dataDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachineScaleSetDataDiskResponse>,
  ...
  factory VirtualMachineScaleSetStorageProfileResponse.fromMap(
    ...
    return VirtualMachineScaleSetStorageProfileResponse(
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachineScaleSetDataDiskResponse>(
            guardedValue,
            (value) => VirtualMachineScaleSetDataDiskResponse.fromMap(
      ...
      osDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetOSDiskResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
