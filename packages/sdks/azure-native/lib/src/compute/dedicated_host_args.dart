...
class DedicatedHostArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostName': ?hostName,
      'licenseType': ?pulumi.Input.mapOptionalInputValue<DedicatedHostLicenseTypes, String>(licenseType, (value) => value.wireValue),
      'location': ?location,
  ...
  factory DedicatedHostArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedHostArgs(
      ...
      licenseType: (() { final guardedValue = map['licenseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DedicatedHostLicenseTypes.fromValue(guardedValue as String)); })(),
