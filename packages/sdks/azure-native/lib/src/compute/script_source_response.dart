...
class ScriptSourceResponse {
  ...
  ScriptSourceResponse({this.parameters, required this.scriptLink});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GalleryScriptParameterResponse>,
    ...
    return ScriptSourceResponse(
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryScriptParameterResponse>(
            guardedValue,
            (value) => GalleryScriptParameterResponse.fromMap(
