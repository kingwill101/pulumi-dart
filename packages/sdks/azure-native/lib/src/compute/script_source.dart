...
class ScriptSource {
  ...
  factory ScriptSource.fromMap(Map<String, dynamic> map) {
    return ScriptSource(
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GalleryScriptParameter>(guardedValue, (value) => GalleryScriptParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
