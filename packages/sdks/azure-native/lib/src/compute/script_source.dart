...
class ScriptSource {
  ...
  ScriptSource({this.parameters, required this.scriptLink});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GalleryScriptParameter>,
    ...
    return ScriptSource(
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryScriptParameter>(
            guardedValue,
            (value) => GalleryScriptParameter.fromMap(
