...
class VirtualMachineScaleSetVMArgs {
  ...
  VirtualMachineScaleSetVMArgs({
    ...
    pulumi.Output<VirtualMachineScaleSetVMNetworkProfileConfiguration>? networkProfileConfiguration,
    pulumi.Output<OSProfile>? osProfile,
    pulumi.Output<Plan>? plan,
    pulumi.Output<VirtualMachineScaleSetVMProtectionPolicy>? protectionPolicy,
    pulumi.Output<String>? resilientVMDeletionStatus,
  ...
  factory VirtualMachineScaleSetVMArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetVMArgs(
      ...
      networkProfileConfiguration: map['networkProfileConfiguration'] == null ? null : pulumi.Output.create<VirtualMachineScaleSetVMNetworkProfileConfiguration>(VirtualMachineScaleSetVMNetworkProfileConfiguration.fromMap((map['networkProfileConfiguration'] as Map).cast<String, dynamic>())),
      ...
      protectionPolicy: map['protectionPolicy'] == null ? null : pulumi.Output.create<VirtualMachineScaleSetVMProtectionPolicy>(VirtualMachineScaleSetVMProtectionPolicy.fromMap((map['protectionPolicy'] as Map).cast<String, dynamic>())),
      resilientVMDeletionStatus: map['resilientVMDeletionStatus'] == null ? null : pulumi.Output.create<String>(map['resilientVMDeletionStatus'] as String),
