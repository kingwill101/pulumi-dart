...
class VirtualMachineScaleSetVMArgs {
  ...
  factory VirtualMachineScaleSetVMArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetVMArgs(
      ...
      resilientVMDeletionStatus: (() { final guardedValue = map['resilientVMDeletionStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
