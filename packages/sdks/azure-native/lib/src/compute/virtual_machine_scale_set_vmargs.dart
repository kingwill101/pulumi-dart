...
class VirtualMachineScaleSetVMArgs {
  ...
  factory VirtualMachineScaleSetVMArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetVMArgs(
      ...
      networkProfileConfiguration: map['networkProfileConfiguration'] == null ? null : (VirtualMachineScaleSetVMNetworkProfileConfiguration.fromMap((map['networkProfileConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      protectionPolicy: map['protectionPolicy'] == null ? null : (VirtualMachineScaleSetVMProtectionPolicy.fromMap((map['protectionPolicy'] as Map).cast<String, dynamic>())).input(),
      resilientVMDeletionStatus: map['resilientVMDeletionStatus'] == null ? null : (map['resilientVMDeletionStatus'] as String).input(),
