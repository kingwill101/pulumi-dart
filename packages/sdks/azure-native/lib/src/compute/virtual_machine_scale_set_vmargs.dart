...
class VirtualMachineScaleSetVMArgs {
  ...
  final pulumi.Input<VirtualMachineScaleSetVMNetworkProfileConfiguration>?
  ...
  final pulumi.Input<VirtualMachineScaleSetVMProtectionPolicy>?
  protectionPolicy;
    ...
    return <String, dynamic>{
      ...
      'networkProfileConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(networkProfileConfiguration, (value) => value.toMap()),
      'osProfile':
      ...
      'protectionPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(protectionPolicy, (value) => value.toMap()),
  ...
  factory VirtualMachineScaleSetVMArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetVMArgs(
      ...
      networkProfileConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetVMNetworkProfileConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      protectionPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetVMProtectionPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
