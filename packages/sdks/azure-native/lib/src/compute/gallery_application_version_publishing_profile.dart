...
class GalleryApplicationVersionPublishingProfile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'source':
          pulumi.Input.mapInputValue<UserArtifactSource, Map<String, dynamic>>(
            source,
            (value) => value.toMap(),
          ),
  ...
  factory GalleryApplicationVersionPublishingProfile.fromMap(
    ...
    return GalleryApplicationVersionPublishingProfile(
      ...
      customActions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryApplicationCustomAction>(
            guardedValue,
            (value) => GalleryApplicationCustomAction.fromMap(
      ...
      settings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserArtifactSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      source: pulumi.Input.fromValue(
        UserArtifactSource.fromMap(
