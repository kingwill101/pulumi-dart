...
class VirtualMachineScaleSetVMExtensionArgs {
  ...
  factory VirtualMachineScaleSetVMExtensionArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetVMExtensionArgs(
      ...
      instanceView: map['instanceView'] == null ? null : (VirtualMachineExtensionInstanceView.fromMap((map['instanceView']! as Map).cast<String, dynamic>())).input(),
      ...
      vmExtensionName: map['vmExtensionName'] == null ? null : (map['vmExtensionName']! as String).input(),
