...
/// }
///
/// resource "azure-native_compute_virtualmachinescalesetvmruncommand" "virtualMachineScaleSetVMRunCommand" {
...
class VirtualMachineScaleSetVMRunCommand extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [VirtualMachineScaleSetVMRunCommand] resource.
  VirtualMachineScaleSetVMRunCommand.reference(String urn)
    : super(
        'azure-native:compute:VirtualMachineScaleSetVMRunCommand',
