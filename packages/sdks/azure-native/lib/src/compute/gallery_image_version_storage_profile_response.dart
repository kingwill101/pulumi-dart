    ...
    return <String, dynamic>{
      'dataDiskImages':
          ?pulumi.Input.mapOptionalInputValue<
            List<GalleryDataDiskImageResponse>,
    ...
    return GalleryImageVersionStorageProfileResponse(
      dataDiskImages: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryDataDiskImageResponse>(
            guardedValue,
            (value) => GalleryDataDiskImageResponse.fromMap(
      ...
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GalleryArtifactVersionFullSourceResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
