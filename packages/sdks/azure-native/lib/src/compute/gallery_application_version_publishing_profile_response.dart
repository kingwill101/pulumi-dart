...
class GalleryApplicationVersionPublishingProfileResponse {
  ...
  final pulumi.Input<List<GalleryApplicationCustomActionResponse>>?
  customActions;
  ...
  final pulumi.Input<List<GalleryTargetExtendedLocationResponse>>?
    ...
    return <String, dynamic>{
      ...
      'customActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GalleryApplicationCustomActionResponse>,
      ...
      'manageActions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(manageActions, (value) => value.toMap()),
      ...
      'targetExtendedLocations':
          ?pulumi.Input.mapOptionalInputValue<
            List<GalleryTargetExtendedLocationResponse>,
            List<Map<String, dynamic>>
          >(
            targetExtendedLocations,
            (value) =>
  ...
  factory GalleryApplicationVersionPublishingProfileResponse.fromMap(
    ...
    return GalleryApplicationVersionPublishingProfileResponse(
      ...
      customActions: (() {
        final guardedValue = map['customActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryApplicationCustomActionResponse>(
            guardedValue,
            (value) => GalleryApplicationCustomActionResponse.fromMap(
      ...
      manageActions: (() {
        final guardedValue = map['manageActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserArtifactManageResponse.fromMap(
      ...
      settings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserArtifactSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      source: pulumi.Input.fromValue(
        UserArtifactSourceResponse.fromMap(
      ...
      targetExtendedLocations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GalleryTargetExtendedLocationResponse>(
            guardedValue,
            (value) => GalleryTargetExtendedLocationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
