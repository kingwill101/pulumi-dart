    ...
    return GalleryInVMAccessControlProfileArgs(
      ...
      properties: (() {
        ...
        return pulumi.Input.fromValue(
          GalleryInVMAccessControlProfileProperties.fromMap(
