...
class VirtualMachineNetworkInterfaceConfiguration {
  ...
  final pulumi.Input<VirtualMachineNetworkInterfaceDnsSettingsConfiguration>?
  dnsSettings;
  ...
  final pulumi.Input<List<VirtualMachineNetworkInterfaceIPConfiguration>>
  ipConfigurations;
  ...
  factory VirtualMachineNetworkInterfaceConfiguration.fromMap(
    ...
    return VirtualMachineNetworkInterfaceConfiguration(
      ...
      dnsSettings: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachineNetworkInterfaceDnsSettingsConfiguration.fromMap(
      ...
      ipConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VirtualMachineNetworkInterfaceIPConfiguration>(
          map['ipConfigurations']!,
          (value) => VirtualMachineNetworkInterfaceIPConfiguration.fromMap(
