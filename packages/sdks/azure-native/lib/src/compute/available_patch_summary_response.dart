...
class AvailablePatchSummaryResponse {
  ...
  factory AvailablePatchSummaryResponse.fromMap(Map<String, dynamic> map) {
    return AvailablePatchSummaryResponse(
      assessmentActivityId: pulumi.Input.fromValue(
        map['assessmentActivityId'] as String,
      ),
      criticalAndSecurityPatchCount: pulumi.Input.fromValue(
        map['criticalAndSecurityPatchCount'] as int,
      ),
