...
class LoadBalancerConfigurationProperties {
  ...
  factory LoadBalancerConfigurationProperties.fromMap(Map<String, dynamic> map) {
    return LoadBalancerConfigurationProperties(
      frontendIpConfigurations: (pulumi.Input.decodeList<LoadBalancerFrontendIpConfiguration>(map['frontendIpConfigurations'], (value) => LoadBalancerFrontendIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
