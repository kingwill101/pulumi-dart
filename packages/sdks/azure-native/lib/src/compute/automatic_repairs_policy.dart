...
class AutomaticRepairsPolicy {
  ...
  final pulumi.Input<dynamic>? repairAction;
  ...
  factory AutomaticRepairsPolicy.fromMap(Map<String, dynamic> map) {
    return AutomaticRepairsPolicy(
      ...
      repairAction: (() { final guardedValue = map['repairAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
