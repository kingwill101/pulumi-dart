...
class LoadBalancerConfigurationPropertiesResponse {
  ...
  final pulumi.Input<List<LoadBalancerFrontendIpConfigurationResponse>>
    ...
    return <String, dynamic>{
      'frontendIpConfigurations':
          pulumi.Input.mapInputValue<
            List<LoadBalancerFrontendIpConfigurationResponse>,
  ...
  factory LoadBalancerConfigurationPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return LoadBalancerConfigurationPropertiesResponse(
      frontendIpConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<LoadBalancerFrontendIpConfigurationResponse>(
          map['frontendIpConfigurations']!,
          (value) => LoadBalancerFrontendIpConfigurationResponse.fromMap(
