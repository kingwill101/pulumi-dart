...
class LoadBalancerConfigurationPropertiesResponse {
  ...
  factory LoadBalancerConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerConfigurationPropertiesResponse(
      frontendIpConfigurations: (pulumi.Input.decodeList<LoadBalancerFrontendIpConfigurationResponse>(map['frontendIpConfigurations'], (value) => LoadBalancerFrontendIpConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
