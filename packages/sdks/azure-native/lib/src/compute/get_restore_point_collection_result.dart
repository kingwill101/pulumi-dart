...
class GetRestorePointCollectionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'restorePoints':
          pulumi.Input.encodeList<RestorePointResponse, Map<String, dynamic>>(
            restorePoints,
            (value) => value.toMap(),
          ),
      'source': ?source?.toMap(),
  ...
  factory GetRestorePointCollectionResult.fromMap(Map<String, dynamic> map) {
    return GetRestorePointCollectionResult(
      ...
      restorePoints: pulumi.Input.decodeList<RestorePointResponse>(
        map['restorePoints']!,
        (value) => RestorePointResponse.fromMap(
