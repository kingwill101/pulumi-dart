...
class VirtualMachinePublicIPAddressConfiguration {
  ...
  final pulumi.Input<VirtualMachinePublicIPAddressDnsSettingsConfiguration>?
  dnsSettings;
  ...
  factory VirtualMachinePublicIPAddressConfiguration.fromMap(
    ...
    return VirtualMachinePublicIPAddressConfiguration(
      ...
      dnsSettings: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachinePublicIPAddressDnsSettingsConfiguration.fromMap(
      ...
      ipTags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachineIpTag>(
            guardedValue,
            (value) => VirtualMachineIpTag.fromMap(
