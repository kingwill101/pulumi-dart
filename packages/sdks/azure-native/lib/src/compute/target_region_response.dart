...
class TargetRegionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalReplicaSets': ?pulumi.Input.mapOptionalInputValue<List<AdditionalReplicaSetResponse>, List<Map<String, dynamic>>>(additionalReplicaSets, (value) => pulumi.Input.encodeList<AdditionalReplicaSetResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory TargetRegionResponse.fromMap(Map<String, dynamic> map) {
    return TargetRegionResponse(
      additionalReplicaSets: (() { final guardedValue = map['additionalReplicaSets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AdditionalReplicaSetResponse>(guardedValue, (value) => AdditionalReplicaSetResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      encryption: (() { final guardedValue = map['encryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionImagesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
