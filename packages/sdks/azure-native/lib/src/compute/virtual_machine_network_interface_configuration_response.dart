...
class VirtualMachineNetworkInterfaceConfigurationResponse {
  ...
  final pulumi.Input<
    List<VirtualMachineNetworkInterfaceIPConfigurationResponse>
  >
  ipConfigurations;
  ...
  factory VirtualMachineNetworkInterfaceConfigurationResponse.fromMap(
    ...
    return VirtualMachineNetworkInterfaceConfigurationResponse(
      ...
      dnsSettings: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachineNetworkInterfaceDnsSettingsConfigurationResponse.fromMap(
      ...
      ipConfigurations: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              VirtualMachineNetworkInterfaceIPConfigurationResponse.fromMap(
