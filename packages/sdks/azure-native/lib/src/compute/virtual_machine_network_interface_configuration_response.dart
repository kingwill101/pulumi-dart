...
class VirtualMachineNetworkInterfaceConfigurationResponse {
  ...
  final VirtualMachineNetworkInterfaceDnsSettingsConfigurationResponse? dnsSettings;
  ...
  final List<VirtualMachineNetworkInterfaceIPConfigurationResponse> ipConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations': pulumi.Input.encodeList<VirtualMachineNetworkInterfaceIPConfigurationResponse, Map<String, dynamic>>(ipConfigurations, (value) => value.toMap()),
      'name': name,
  ...
  factory VirtualMachineNetworkInterfaceConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineNetworkInterfaceConfigurationResponse(
      ...
      dnsSettings: map['dnsSettings'] == null ? null : VirtualMachineNetworkInterfaceDnsSettingsConfigurationResponse.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      ...
      ipConfigurations: pulumi.Input.decodeList<VirtualMachineNetworkInterfaceIPConfigurationResponse>(map['ipConfigurations'], (value) => VirtualMachineNetworkInterfaceIPConfigurationResponse.fromMap((value as Map).cast<String, dynamic>())),
