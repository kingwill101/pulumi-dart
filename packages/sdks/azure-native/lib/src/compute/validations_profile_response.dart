...
class ValidationsProfileResponse {
  ...
  factory ValidationsProfileResponse.fromMap(Map<String, dynamic> map) {
    return ValidationsProfileResponse(
      executedValidations: (() { final guardedValue = map['executedValidations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExecutedValidationResponse>(guardedValue, (value) => ExecutedValidationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      platformAttributes: (() { final guardedValue = map['platformAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PlatformAttributeResponse>(guardedValue, (value) => PlatformAttributeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      validationEtag: (() { final guardedValue = map['validationEtag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
