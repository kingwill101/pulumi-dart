...
class NetworkProfileResponse {
  ...
  factory NetworkProfileResponse.fromMap(Map<String, dynamic> map) {
    return NetworkProfileResponse(
      ...
      networkInterfaceConfigurations: (() { final guardedValue = map['networkInterfaceConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineNetworkInterfaceConfigurationResponse>(guardedValue, (value) => VirtualMachineNetworkInterfaceConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkInterfaces: (() { final guardedValue = map['networkInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceReferenceResponse>(guardedValue, (value) => NetworkInterfaceReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
