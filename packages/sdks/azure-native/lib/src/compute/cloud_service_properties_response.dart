    ...
    return CloudServicePropertiesResponse(
      ...
      extensionProfile: (() {
        ...
        return pulumi.Input.fromValue(
          CloudServiceExtensionProfileResponse.fromMap(
      ...
      networkProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudServiceNetworkProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      osProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudServiceOsProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      roleProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudServiceRoleProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
