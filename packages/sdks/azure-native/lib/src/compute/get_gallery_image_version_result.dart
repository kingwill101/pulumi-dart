...
class GetGalleryImageVersionResult {
  ...
  factory GetGalleryImageVersionResult.fromMap(Map<String, dynamic> map) {
    return GetGalleryImageVersionResult(
      ...
      storageProfile: (() { final guardedValue = map['storageProfile']; if (guardedValue == null) return null; return GalleryImageVersionStorageProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      systemData: (() { final guardedValue = map['systemData']; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); })(),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return guardedValue as String; })(),
      validationsProfile: (() { final guardedValue = map['validationsProfile']; if (guardedValue == null) return null; return ValidationsProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
    );
  }
}
