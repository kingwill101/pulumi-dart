...
class VirtualMachineScaleSetIPConfiguration {
  ...
  factory VirtualMachineScaleSetIPConfiguration.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetIPConfiguration(
      ...
      publicIPAddressConfiguration: map['publicIPAddressConfiguration'] == null ? null : (VirtualMachineScaleSetPublicIPAddressConfiguration.fromMap((map['publicIPAddressConfiguration']! as Map).cast<String, dynamic>())).input(),
