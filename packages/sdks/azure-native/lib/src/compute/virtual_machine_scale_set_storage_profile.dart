...
class VirtualMachineScaleSetStorageProfile {
  ...
  factory VirtualMachineScaleSetStorageProfile.fromMap(
    ...
    return VirtualMachineScaleSetStorageProfile(
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachineScaleSetDataDisk>(
            guardedValue,
            (value) => VirtualMachineScaleSetDataDisk.fromMap(
      ...
      imageReference: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageReference.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      osDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetOSDisk.fromMap(
