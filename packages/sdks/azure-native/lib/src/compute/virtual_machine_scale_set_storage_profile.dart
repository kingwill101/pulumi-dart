...
class VirtualMachineScaleSetStorageProfile {
  ...
  final pulumi.Input<dynamic>? diskControllerType;
  ...
  factory VirtualMachineScaleSetStorageProfile.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetStorageProfile(
      ...
      diskControllerType: (() { final guardedValue = map['diskControllerType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
