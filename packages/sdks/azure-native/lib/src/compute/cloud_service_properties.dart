...
class CloudServiceProperties {
  ...
  factory CloudServiceProperties.fromMap(Map<String, dynamic> map) {
    return CloudServiceProperties(
      allowModelOverride: (() {
        final guardedValue = map['allowModelOverride'];
      ...
      configurationUrl: (() {
        final guardedValue = map['configurationUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      extensionProfile: (() {
        ...
        return pulumi.Input.fromValue(
          CloudServiceExtensionProfile.fromMap(
      ...
      networkProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudServiceNetworkProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      roleProfile: (() {
        final guardedValue = map['roleProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudServiceRoleProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      startCloudService: (() {
        final guardedValue = map['startCloudService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      upgradeMode: (() {
