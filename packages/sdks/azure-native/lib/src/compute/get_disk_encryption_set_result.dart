...
class GetDiskEncryptionSetResult {
    ...
    return <String, dynamic>{
      ...
      'previousKeys':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(previousKeys, (value) => value.toMap()),
  ...
  factory GetDiskEncryptionSetResult.fromMap(Map<String, dynamic> map) {
    return GetDiskEncryptionSetResult(
      ...
      autoKeyRotationError: ApiErrorResponse.fromMap(
        (map['autoKeyRotationError']! as Map).cast<String, dynamic>(),
      ),
      ...
      previousKeys: pulumi.Input.decodeList<KeyForDiskEncryptionSetResponse>(
        map['previousKeys']!,
        (value) => KeyForDiskEncryptionSetResponse.fromMap(
