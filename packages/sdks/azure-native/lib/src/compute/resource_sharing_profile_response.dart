...
class ResourceSharingProfileResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'subscriptionIds': ?pulumi.Input.mapOptionalInputValue<List<SubResourceResponse>, List<Map<String, dynamic>>>(subscriptionIds, (value) => pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory ResourceSharingProfileResponse.fromMap(Map<String, dynamic> map) {
    return ResourceSharingProfileResponse(
      subscriptionIds: (() { final guardedValue = map['subscriptionIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubResourceResponse>(guardedValue, (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
