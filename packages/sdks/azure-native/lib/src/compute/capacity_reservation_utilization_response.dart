...
class CapacityReservationUtilizationResponse {
  ...
  factory CapacityReservationUtilizationResponse.fromMap(Map<String, dynamic> map) {
    return CapacityReservationUtilizationResponse(
      currentCapacity: (map['currentCapacity'] as int).input(),
      virtualMachinesAllocated: (pulumi.Input.decodeList<SubResourceReadOnlyResponse>(map['virtualMachinesAllocated'], (value) => SubResourceReadOnlyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
