...
class ResiliencyPolicy {
  ...
  final pulumi.Input<AutomaticZoneRebalancingPolicy>?
    ...
    return <String, dynamic>{
      'automaticZoneRebalancingPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            AutomaticZoneRebalancingPolicy,
            Map<String, dynamic>
          >(automaticZoneRebalancingPolicy, (value) => value.toMap()),
      'resilientVMCreationPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ResilientVMCreationPolicy,
            Map<String, dynamic>
          >(resilientVMCreationPolicy, (value) => value.toMap()),
      'resilientVMDeletionPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ResilientVMDeletionPolicy,
            Map<String, dynamic>
          >(resilientVMDeletionPolicy, (value) => value.toMap()),
    };
  }
  ...
  factory ResiliencyPolicy.fromMap(Map<String, dynamic> map) {
    return ResiliencyPolicy(
      automaticZoneRebalancingPolicy: (() {
        final guardedValue = map['automaticZoneRebalancingPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutomaticZoneRebalancingPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resilientVMCreationPolicy: (() {
        final guardedValue = map['resilientVMCreationPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResilientVMCreationPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resilientVMDeletionPolicy: (() {
        final guardedValue = map['resilientVMDeletionPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResilientVMDeletionPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
