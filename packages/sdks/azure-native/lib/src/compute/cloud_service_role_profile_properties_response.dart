...
class CloudServiceRoleProfilePropertiesResponse {
  ...
  const CloudServiceRoleProfilePropertiesResponse({
    this.name,
    this.sku,
  });
  ...
  factory CloudServiceRoleProfilePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudServiceRoleProfilePropertiesResponse(
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudServiceRoleSkuResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
