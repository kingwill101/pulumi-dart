...
class EncryptionSettingsCollection {
  ...
  final List<EncryptionSettingsElement>? encryptionSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enabled': enabled,
      'encryptionSettings': ?encryptionSettings == null ? null : pulumi.Input.encodeList<EncryptionSettingsElement, Map<String, dynamic>>(encryptionSettings!, (value) => value.toMap()),
  ...
  factory EncryptionSettingsCollection.fromMap(Map<String, dynamic> map) {
    return EncryptionSettingsCollection(
      ...
      encryptionSettings: map['encryptionSettings'] == null ? null : pulumi.Input.decodeList<EncryptionSettingsElement>(map['encryptionSettings'], (value) => EncryptionSettingsElement.fromMap((value as Map).cast<String, dynamic>())),
