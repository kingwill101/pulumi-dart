...
class TargetRegion {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalReplicaSets': ?pulumi.Input.mapOptionalInputValue<List<AdditionalReplicaSet>, List<Map<String, dynamic>>>(additionalReplicaSets, (value) => pulumi.Input.encodeList<AdditionalReplicaSet, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory TargetRegion.fromMap(Map<String, dynamic> map) {
    return TargetRegion(
      additionalReplicaSets: (() { final guardedValue = map['additionalReplicaSets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AdditionalReplicaSet>(guardedValue, (value) => AdditionalReplicaSet.fromMap((value as Map).cast<String, dynamic>()))); })(),
