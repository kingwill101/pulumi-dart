...
class RestorePointSourceVMStorageProfile {
  ...
  RestorePointSourceVMStorageProfile({this.dataDisks, this.osDisk});
    ...
    return RestorePointSourceVMStorageProfile(
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RestorePointSourceVMDataDisk>(
            guardedValue,
            (value) => RestorePointSourceVMDataDisk.fromMap(
      ...
      osDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RestorePointSourceVMOSDisk.fromMap(
