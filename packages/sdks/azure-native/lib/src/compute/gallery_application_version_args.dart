...
class GalleryApplicationVersionArgs {
  ...
  final pulumi.Input<GalleryApplicationVersionPublishingProfile>
  publishingProfile;
  ...
  factory GalleryApplicationVersionArgs.fromMap(Map<String, dynamic> map) {
    return GalleryApplicationVersionArgs(
      galleryApplicationName: pulumi.Input.fromValue(
        map['galleryApplicationName'] as String,
      ),
      galleryApplicationVersionName: (() {
        final guardedValue = map['galleryApplicationVersionName'];
      ...
      publishingProfile: pulumi.Input.fromValue(
        GalleryApplicationVersionPublishingProfile.fromMap(
      ...
      safetyProfile: (() {
        ...
        return pulumi.Input.fromValue(
          GalleryApplicationVersionSafetyProfile.fromMap(
