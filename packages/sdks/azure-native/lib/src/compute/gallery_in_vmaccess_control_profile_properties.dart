...
class GalleryInVMAccessControlProfileProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applicableHostEndpoint': pulumi.Input.mapInputValue<EndpointTypes, String>(applicableHostEndpoint, (value) => value.wireValue),
  ...
  factory GalleryInVMAccessControlProfileProperties.fromMap(Map<String, dynamic> map) {
    return GalleryInVMAccessControlProfileProperties(
      applicableHostEndpoint: pulumi.Input.fromValue(EndpointTypes.fromValue(map['applicableHostEndpoint']! as String)),
