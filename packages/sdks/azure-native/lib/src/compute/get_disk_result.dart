...
class GetDiskResult {
  ...
  factory GetDiskResult.fromMap(Map<String, dynamic> map) {
    return GetDiskResult(
      ...
      propertyUpdatesInProgress: PropertyUpdatesInProgressResponse.fromMap(
        (map['propertyUpdatesInProgress']! as Map).cast<String, dynamic>(),
      ),
      ...
      shareInfo: pulumi.Input.decodeList<ShareInfoElementResponse>(
        map['shareInfo']!,
        (value) => ShareInfoElementResponse.fromMap(
