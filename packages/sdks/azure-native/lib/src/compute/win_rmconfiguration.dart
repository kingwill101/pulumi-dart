...
class WinRMConfiguration {
  ...
  WinRMConfiguration({this.listeners});
    ...
    return <String, dynamic>{
      'listeners':
          ...
          >(
            listeners,
            (value) =>
                pulumi.Input.encodeList<WinRMListener, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return WinRMConfiguration(
      listeners: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WinRMListener>(
            guardedValue,
            (value) =>
                WinRMListener.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
