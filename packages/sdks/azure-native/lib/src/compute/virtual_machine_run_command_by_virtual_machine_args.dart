...
class VirtualMachineRunCommandByVirtualMachineArgs {
  ...
  VirtualMachineRunCommandByVirtualMachineArgs({
    pulumi.Output<bool>? asyncExecution,
    pulumi.Output<RunCommandManagedIdentity>? errorBlobManagedIdentity,
    pulumi.Output<String>? errorBlobUri,
    pulumi.Output<String>? location,
    pulumi.Output<RunCommandManagedIdentity>? outputBlobManagedIdentity,
    pulumi.Output<String>? outputBlobUri,
    pulumi.Output<List<RunCommandInputParameter>>? parameters,
    pulumi.Output<List<RunCommandInputParameter>>? protectedParameters,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? runAsPassword,
    pulumi.Output<String>? runAsUser,
    pulumi.Output<String>? runCommandName,
    pulumi.Output<VirtualMachineRunCommandScriptSource>? source,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<int>? timeoutInSeconds,
    pulumi.Output<bool>? treatFailureAsDeploymentFailure,
  ...
  factory VirtualMachineRunCommandByVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineRunCommandByVirtualMachineArgs(
      asyncExecution: map['asyncExecution'] == null ? null : pulumi.Output.create<bool>(map['asyncExecution'] as bool),
      errorBlobManagedIdentity: map['errorBlobManagedIdentity'] == null ? null : pulumi.Output.create<RunCommandManagedIdentity>(RunCommandManagedIdentity.fromMap((map['errorBlobManagedIdentity'] as Map).cast<String, dynamic>())),
      errorBlobUri: map['errorBlobUri'] == null ? null : pulumi.Output.create<String>(map['errorBlobUri'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      outputBlobManagedIdentity: map['outputBlobManagedIdentity'] == null ? null : pulumi.Output.create<RunCommandManagedIdentity>(RunCommandManagedIdentity.fromMap((map['outputBlobManagedIdentity'] as Map).cast<String, dynamic>())),
      outputBlobUri: map['outputBlobUri'] == null ? null : pulumi.Output.create<String>(map['outputBlobUri'] as String),
      parameters: map['parameters'] == null ? null : pulumi.Output.create<List<RunCommandInputParameter>>(pulumi.Input.decodeList<RunCommandInputParameter>(map['parameters'], (value) => RunCommandInputParameter.fromMap((value as Map).cast<String, dynamic>()))),
      protectedParameters: map['protectedParameters'] == null ? null : pulumi.Output.create<List<RunCommandInputParameter>>(pulumi.Input.decodeList<RunCommandInputParameter>(map['protectedParameters'], (value) => RunCommandInputParameter.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      runCommandName: map['runCommandName'] == null ? null : pulumi.Output.create<String>(map['runCommandName'] as String),
      source: map['source'] == null ? null : pulumi.Output.create<VirtualMachineRunCommandScriptSource>(VirtualMachineRunCommandScriptSource.fromMap((map['source'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      timeoutInSeconds: map['timeoutInSeconds'] == null ? null : pulumi.Output.create<int>(map['timeoutInSeconds'] as int),
      treatFailureAsDeploymentFailure: map['treatFailureAsDeploymentFailure'] == null ? null : pulumi.Output.create<bool>(map['treatFailureAsDeploymentFailure'] as bool),
