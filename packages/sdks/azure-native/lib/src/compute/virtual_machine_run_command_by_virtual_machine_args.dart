...
class VirtualMachineRunCommandByVirtualMachineArgs {
  ...
  factory VirtualMachineRunCommandByVirtualMachineArgs.fromMap(
    ...
    return VirtualMachineRunCommandByVirtualMachineArgs(
      ...
      errorBlobManagedIdentity: (() {
        ...
        return pulumi.Input.fromValue(
          RunCommandManagedIdentity.fromMap(
      ...
      parameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RunCommandInputParameter>(
            guardedValue,
            (value) => RunCommandInputParameter.fromMap(
      ...
      runCommandName: (() {
        final guardedValue = map['runCommandName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineRunCommandScriptSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
