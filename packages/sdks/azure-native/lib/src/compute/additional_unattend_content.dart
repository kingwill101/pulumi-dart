...
class AdditionalUnattendContent {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'componentName':
          ?pulumi.Input.mapOptionalInputValue<ComponentName, String>(
            componentName,
            (value) => value.wireValue,
          ),
      'content': ?content,
      'passName': ?pulumi.Input.mapOptionalInputValue<PassName, String>(
        passName,
        (value) => value.wireValue,
      ),
      'settingName': ?pulumi.Input.mapOptionalInputValue<SettingNames, String>(
        settingName,
        (value) => value.wireValue,
      ),
    };
    ...
    return AdditionalUnattendContent(
      componentName: (() {
        ...
        return pulumi.Input.fromValue(
          ComponentName.fromValue(guardedValue as String),
        );
      })(),
      content: (() {
      ...
      passName: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PassName.fromValue(guardedValue as String),
        );
      })(),
      settingName: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SettingNames.fromValue(guardedValue as String),
        );
      })(),
    );
  }
