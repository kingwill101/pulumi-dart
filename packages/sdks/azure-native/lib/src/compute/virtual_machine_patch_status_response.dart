...
class VirtualMachinePatchStatusResponse {
  ...
  final pulumi.Input<LastPatchInstallationSummaryResponse>?
    ...
    return <String, dynamic>{
      'availablePatchSummary':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(availablePatchSummary, (value) => value.toMap()),
      ...
      'lastPatchInstallationSummary':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(lastPatchInstallationSummary, (value) => value.toMap()),
    };
  }
  ...
  factory VirtualMachinePatchStatusResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachinePatchStatusResponse(
      availablePatchSummary: (() {
        final guardedValue = map['availablePatchSummary'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AvailablePatchSummaryResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      configurationStatuses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<InstanceViewStatusResponse>(
          map['configurationStatuses']!,
      ...
      lastPatchInstallationSummary: (() {
        final guardedValue = map['lastPatchInstallationSummary'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LastPatchInstallationSummaryResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
