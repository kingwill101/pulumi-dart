...
class GalleryTargetExtendedLocationResponse {
  ...
  const GalleryTargetExtendedLocationResponse({
    this.encryption,
  ...
  factory GalleryTargetExtendedLocationResponse.fromMap(Map<String, dynamic> map) {
    return GalleryTargetExtendedLocationResponse(
      ...
      extendedLocation: (() { final guardedValue = map['extendedLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GalleryExtendedLocationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
