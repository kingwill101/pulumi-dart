...
class UpgradePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?pulumi.Input.mapOptionalInputValue<UpgradeMode, String>(mode, (value) => value.wireValue),
  ...
  factory UpgradePolicy.fromMap(Map<String, dynamic> map) {
    return UpgradePolicy(
      ...
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UpgradeMode.fromValue(guardedValue as String)); })(),
