...
class GalleryInVMAccessControlProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GalleryInVMAccessControlProfilePropertiesResponse>
  properties;
  ...
  GalleryInVMAccessControlProfile(
    ...
    properties =
        registerOutput<GalleryInVMAccessControlProfilePropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return GalleryInVMAccessControlProfilePropertiesResponse.fromMap(
