...
class VirtualMachineScaleSetVMInstanceViewResponse {
  ...
  final pulumi.Input<List<VirtualMachineExtensionInstanceViewResponse>>?
  extensions;
  ...
  final pulumi.Input<MaintenanceRedeployStatusResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'extensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachineExtensionInstanceViewResponse>,
            List<Map<String, dynamic>>
          >(
            extensions,
            (value) =>
      ...
      'maintenanceRedeployStatus':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(maintenanceRedeployStatus, (value) => value.toMap()),
      'osName': ?osName,
      'osVersion': ?osVersion,
      ...
      'vmHealth':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(vmHealth, (value) => value.toMap()),
    };
  }

  factory VirtualMachineScaleSetVMInstanceViewResponse.fromMap(
    ...
    return VirtualMachineScaleSetVMInstanceViewResponse(
      ...
      bootDiagnostics: (() {
        ...
        return pulumi.Input.fromValue(
          BootDiagnosticsInstanceViewResponse.fromMap(
      ...
      disks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiskInstanceViewResponse>(
            guardedValue,
            (value) => DiskInstanceViewResponse.fromMap(
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachineExtensionInstanceViewResponse>(
            guardedValue,
            (value) => VirtualMachineExtensionInstanceViewResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      maintenanceRedeployStatus: (() {
        final guardedValue = map['maintenanceRedeployStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MaintenanceRedeployStatusResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      platformUpdateDomain: (() {
        final guardedValue = map['platformUpdateDomain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      rdpThumbPrint: (() {
        final guardedValue = map['rdpThumbPrint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      statuses: (() {
      ...
      vmAgent: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineAgentInstanceViewResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vmHealth: pulumi.Input.fromValue(
        VirtualMachineHealthStatusResponse.fromMap(
          (map['vmHealth']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
