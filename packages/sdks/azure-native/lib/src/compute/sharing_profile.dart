...
class SharingProfile {
  ...
  SharingProfile({this.communityGalleryInfo, this.permissions});
    ...
    return <String, dynamic>{
      'communityGalleryInfo':
          ?pulumi.Input.mapOptionalInputValue<
            CommunityGalleryInfo,
            Map<String, dynamic>
          >(communityGalleryInfo, (value) => value.toMap()),
  ...
  factory SharingProfile.fromMap(Map<String, dynamic> map) {
    return SharingProfile(
      communityGalleryInfo: (() {
        final guardedValue = map['communityGalleryInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CommunityGalleryInfo.fromMap(
