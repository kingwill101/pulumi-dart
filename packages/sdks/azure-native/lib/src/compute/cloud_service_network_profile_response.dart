...
class CloudServiceNetworkProfileResponse {
  ...
  final pulumi.Input<List<LoadBalancerConfigurationResponse>>?
    ...
    return <String, dynamic>{
      'loadBalancerConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<LoadBalancerConfigurationResponse>,
    ...
    return CloudServiceNetworkProfileResponse(
      loadBalancerConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoadBalancerConfigurationResponse>(
            guardedValue,
