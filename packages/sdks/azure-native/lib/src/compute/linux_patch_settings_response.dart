...
class LinuxPatchSettingsResponse {
  ...
  const LinuxPatchSettingsResponse({
    this.assessmentMode,
  ...
  factory LinuxPatchSettingsResponse.fromMap(Map<String, dynamic> map) {
    return LinuxPatchSettingsResponse(
      ...
      automaticByPlatformSettings: (() { final guardedValue = map['automaticByPlatformSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxVMGuestPatchAutomaticByPlatformSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
