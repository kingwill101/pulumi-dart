...
class VirtualMachineNetworkInterfaceIPConfiguration {
  ...
  final pulumi.Input<VirtualMachinePublicIPAddressConfiguration>?
  ...
  factory VirtualMachineNetworkInterfaceIPConfiguration.fromMap(
    ...
    return VirtualMachineNetworkInterfaceIPConfiguration(
      ...
      publicIPAddressConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachinePublicIPAddressConfiguration.fromMap(
