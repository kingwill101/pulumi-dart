...
class CloudServiceExtensionProfileResponse {
  ...
  factory CloudServiceExtensionProfileResponse.fromMap(Map<String, dynamic> map) {
    return CloudServiceExtensionProfileResponse(
      extensions: (() { final guardedValue = map['extensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExtensionResponse>(guardedValue, (value) => ExtensionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
