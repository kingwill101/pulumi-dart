...
class GetCapacityReservationResult {
  ...
  factory GetCapacityReservationResult.fromMap(Map<String, dynamic> map) {
    return GetCapacityReservationResult(
      ...
      instanceView: (() { final guardedValue = map['instanceView']; if (guardedValue == null) return null; return CapacityReservationInstanceViewResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      reservationId: (() { final guardedValue = map['reservationId']; if (guardedValue == null) return null; return guardedValue as String; })(),
