...
class LoadBalancerFrontendIpConfigurationResponse {
  ...
  const LoadBalancerFrontendIpConfigurationResponse({
    required this.name,
  ...
  factory LoadBalancerFrontendIpConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerFrontendIpConfigurationResponse(
      ...
      properties: pulumi.Input.fromValue(LoadBalancerFrontendIpConfigurationPropertiesResponse.fromMap((map['properties']! as Map).cast<String, dynamic>())),
    );
  }
}
