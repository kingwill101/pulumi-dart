...
class LoadBalancerFrontendIpConfigurationResponse {
  ...
  final LoadBalancerFrontendIpConfigurationPropertiesResponse properties;
  ...
  factory LoadBalancerFrontendIpConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerFrontendIpConfigurationResponse(
      ...
      properties: LoadBalancerFrontendIpConfigurationPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
    );
  }
}
