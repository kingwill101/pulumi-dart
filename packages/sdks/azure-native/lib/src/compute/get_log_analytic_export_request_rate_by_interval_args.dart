...
class GetLogAnalyticExportRequestRateByIntervalArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'intervalLength': pulumi.Input.mapInputValue<IntervalInMins, String>(intervalLength, (value) => value.wireValue),
      'location': location,
      'toTime': toTime,
    };
  }
  ...
  factory GetLogAnalyticExportRequestRateByIntervalArgs.fromMap(Map<String, dynamic> map) {
    return GetLogAnalyticExportRequestRateByIntervalArgs(
      ...
      intervalLength: pulumi.Input.fromValue(IntervalInMins.fromValue(map['intervalLength']! as String)),
