...
class CloudServiceArgs {
  ...
  factory CloudServiceArgs.fromMap(Map<String, dynamic> map) {
    return CloudServiceArgs(
      cloudServiceName: (() { final guardedValue = map['cloudServiceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudServiceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
