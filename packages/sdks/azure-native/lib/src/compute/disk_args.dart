...
class DiskArgs {
  ...
  DiskArgs({
    ...
    pulumi.Output<double>? diskIOPSReadOnly,
    pulumi.Output<double>? diskIOPSReadWrite,
    pulumi.Output<double>? diskMBpsReadOnly,
    pulumi.Output<double>? diskMBpsReadWrite,
    ...
    pulumi.Output<bool>? optimizedForFrequentAttach,
  ...
  factory DiskArgs.fromMap(Map<String, dynamic> map) {
    return DiskArgs(
      ...
      diskIOPSReadOnly: map['diskIOPSReadOnly'] == null ? null : pulumi.Output.create<double>(map['diskIOPSReadOnly'] as double),
      diskIOPSReadWrite: map['diskIOPSReadWrite'] == null ? null : pulumi.Output.create<double>(map['diskIOPSReadWrite'] as double),
      diskMBpsReadOnly: map['diskMBpsReadOnly'] == null ? null : pulumi.Output.create<double>(map['diskMBpsReadOnly'] as double),
      diskMBpsReadWrite: map['diskMBpsReadWrite'] == null ? null : pulumi.Output.create<double>(map['diskMBpsReadWrite'] as double),
      ...
      optimizedForFrequentAttach: map['optimizedForFrequentAttach'] == null ? null : pulumi.Output.create<bool>(map['optimizedForFrequentAttach'] as bool),
      ...
      sku: map['sku'] == null ? null : pulumi.Output.create<DiskSku>(DiskSku.fromMap((map['sku'] as Map).cast<String, dynamic>())),
