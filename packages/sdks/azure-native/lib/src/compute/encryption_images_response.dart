...
class EncryptionImagesResponse {
  ...
  factory EncryptionImagesResponse.fromMap(Map<String, dynamic> map) {
    return EncryptionImagesResponse(
      dataDiskImages: (() { final guardedValue = map['dataDiskImages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DataDiskImageEncryptionResponse>(guardedValue, (value) => DataDiskImageEncryptionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      osDiskImage: (() { final guardedValue = map['osDiskImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OSDiskImageEncryptionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
