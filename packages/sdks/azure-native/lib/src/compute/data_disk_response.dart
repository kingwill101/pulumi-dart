...
class DataDiskResponse {
  ...
  factory DataDiskResponse.fromMap(Map<String, dynamic> map) {
    return DataDiskResponse(
      ...
      diskIOPSReadWrite: pulumi.Input.fromValue((map['diskIOPSReadWrite'] as num).toDouble()),
      diskMBpsReadWrite: pulumi.Input.fromValue((map['diskMBpsReadWrite'] as num).toDouble()),
