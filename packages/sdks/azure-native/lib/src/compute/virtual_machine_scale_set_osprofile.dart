...
class VirtualMachineScaleSetOSProfile {
  ...
  final LinuxConfiguration? linuxConfiguration;
  ...
  final List<VaultSecretGroup>? secrets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secrets': ?secrets == null ? null : pulumi.Input.encodeList<VaultSecretGroup, Map<String, dynamic>>(secrets!, (value) => value.toMap()),
  ...
  factory VirtualMachineScaleSetOSProfile.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetOSProfile(
      ...
      linuxConfiguration: map['linuxConfiguration'] == null ? null : LinuxConfiguration.fromMap((map['linuxConfiguration'] as Map).cast<String, dynamic>()),
      requireGuestProvisionSignal: map['requireGuestProvisionSignal'] == null ? null : map['requireGuestProvisionSignal'] as bool,
      secrets: map['secrets'] == null ? null : pulumi.Input.decodeList<VaultSecretGroup>(map['secrets'], (value) => VaultSecretGroup.fromMap((value as Map).cast<String, dynamic>())),
