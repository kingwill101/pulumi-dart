...
class AccessControlRulesResponse {
  ...
  factory AccessControlRulesResponse.fromMap(Map<String, dynamic> map) {
    return AccessControlRulesResponse(
      identities: (() { final guardedValue = map['identities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessControlRulesIdentityResponse>(guardedValue, (value) => AccessControlRulesIdentityResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      privileges: (() { final guardedValue = map['privileges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessControlRulesPrivilegeResponse>(guardedValue, (value) => AccessControlRulesPrivilegeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      roleAssignments: (() { final guardedValue = map['roleAssignments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessControlRulesRoleAssignmentResponse>(guardedValue, (value) => AccessControlRulesRoleAssignmentResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      roles: (() { final guardedValue = map['roles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AccessControlRulesRoleResponse>(guardedValue, (value) => AccessControlRulesRoleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
