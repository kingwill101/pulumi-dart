    ...
    return <String, dynamic>{
      ...
      'groups':
          pulumi.Input.mapInputValue<
            List<SharingProfileGroupResponse>,
    ...
    return SharingProfileResponse(
      communityGalleryInfo: (() {
        ...
        return pulumi.Input.fromValue(
          CommunityGalleryInfoResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      groups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SharingProfileGroupResponse>(
          map['groups']!,
          (value) => SharingProfileGroupResponse.fromMap(
