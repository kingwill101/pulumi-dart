...
class GetVirtualMachineScaleSetVMRunCommandResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'protectedParameters': ?(() {
        final guardedValue = protectedParameters;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
          RunCommandInputParameterResponse,
          Map<String, dynamic>
  ...
  factory GetVirtualMachineScaleSetVMRunCommandResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetVirtualMachineScaleSetVMRunCommandResult(
      asyncExecution: (() {
        final guardedValue = map['asyncExecution'];
        if (guardedValue == null) return null;
      ...
      id: map['id'] as String,
      instanceView: VirtualMachineRunCommandInstanceViewResponse.fromMap(
      ...
      parameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<RunCommandInputParameterResponse>(
          guardedValue,
          (value) => RunCommandInputParameterResponse.fromMap(
      ...
      treatFailureAsDeploymentFailure: (() {
        final guardedValue = map['treatFailureAsDeploymentFailure'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
