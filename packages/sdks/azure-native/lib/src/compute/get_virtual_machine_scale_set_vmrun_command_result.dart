...
class GetVirtualMachineScaleSetVMRunCommandResult {
  ...
  const GetVirtualMachineScaleSetVMRunCommandResult({
    this.asyncExecution,
  ...
  factory GetVirtualMachineScaleSetVMRunCommandResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualMachineScaleSetVMRunCommandResult(
      ...
      instanceView: (() { final guardedValue = map['instanceView']; if (guardedValue == null) return null; return VirtualMachineRunCommandInstanceViewResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      timeoutInSeconds: (() { final guardedValue = map['timeoutInSeconds']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
