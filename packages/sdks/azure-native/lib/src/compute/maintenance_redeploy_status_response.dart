...
class MaintenanceRedeployStatusResponse {
  ...
  factory MaintenanceRedeployStatusResponse.fromMap(Map<String, dynamic> map) {
    return MaintenanceRedeployStatusResponse(
      isCustomerInitiatedMaintenanceAllowed: (() { final guardedValue = map['isCustomerInitiatedMaintenanceAllowed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      lastOperationMessage: (() { final guardedValue = map['lastOperationMessage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      lastOperationResultCode: (() { final guardedValue = map['lastOperationResultCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maintenanceWindowEndTime: (() { final guardedValue = map['maintenanceWindowEndTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maintenanceWindowStartTime: (() { final guardedValue = map['maintenanceWindowStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      preMaintenanceWindowEndTime: (() { final guardedValue = map['preMaintenanceWindowEndTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      preMaintenanceWindowStartTime: (() { final guardedValue = map['preMaintenanceWindowStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
