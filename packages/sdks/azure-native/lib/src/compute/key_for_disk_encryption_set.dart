...
class KeyForDiskEncryptionSet {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keyUrl': keyUrl,
      'sourceVault': ?pulumi.Input.mapOptionalInputValue<SourceVault, Map<String, dynamic>>(sourceVault, (value) => value.toMap()),
    };
  }
  ...
  factory KeyForDiskEncryptionSet.fromMap(Map<String, dynamic> map) {
    return KeyForDiskEncryptionSet(
      ...
      sourceVault: (() { final guardedValue = map['sourceVault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceVault.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
