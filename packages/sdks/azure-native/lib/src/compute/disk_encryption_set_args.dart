...
class DiskEncryptionSetArgs {
  ...
  factory DiskEncryptionSetArgs.fromMap(Map<String, dynamic> map) {
    return DiskEncryptionSetArgs(
      activeKey: (() {
        final guardedValue = map['activeKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KeyForDiskEncryptionSet.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      diskEncryptionSetName: (() {
        final guardedValue = map['diskEncryptionSetName'];
        if (guardedValue == null) return null;
