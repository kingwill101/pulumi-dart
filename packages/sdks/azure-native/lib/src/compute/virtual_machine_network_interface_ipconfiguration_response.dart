...
class VirtualMachineNetworkInterfaceIPConfigurationResponse {
  ...
  final pulumi.Input<VirtualMachinePublicIPAddressConfigurationResponse>?
  ...
  factory VirtualMachineNetworkInterfaceIPConfigurationResponse.fromMap(
    ...
    return VirtualMachineNetworkInterfaceIPConfigurationResponse(
      ...
      publicIPAddressConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachinePublicIPAddressConfigurationResponse.fromMap(
