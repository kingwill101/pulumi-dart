...
class ManagedClusterIngressProfileResponse {
  ...
  final pulumi.Input<ManagedClusterIngressProfileWebAppRoutingResponse>?
  webAppRouting;
  ...
  ManagedClusterIngressProfileResponse({this.webAppRouting});
  ...
  factory ManagedClusterIngressProfileResponse.fromMap(
    ...
    return ManagedClusterIngressProfileResponse(
      webAppRouting: (() {
        ...
        return pulumi.Input.fromValue(
          ManagedClusterIngressProfileWebAppRoutingResponse.fromMap(
