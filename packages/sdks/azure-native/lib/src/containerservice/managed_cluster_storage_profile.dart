...
class ManagedClusterStorageProfile {
  ...
  factory ManagedClusterStorageProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterStorageProfile(
      blobCSIDriver: (() { final guardedValue = map['blobCSIDriver']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterStorageProfileBlobCSIDriver.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      diskCSIDriver: (() { final guardedValue = map['diskCSIDriver']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterStorageProfileDiskCSIDriver.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fileCSIDriver: (() { final guardedValue = map['fileCSIDriver']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterStorageProfileFileCSIDriver.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapshotController: (() { final guardedValue = map['snapshotController']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterStorageProfileSnapshotController.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
