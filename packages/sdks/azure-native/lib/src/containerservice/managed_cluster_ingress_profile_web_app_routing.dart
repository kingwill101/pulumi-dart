    ...
    return <String, dynamic>{
      ...
      'nginx':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(nginx, (value) => value.toMap()),
    };
  }

  factory ManagedClusterIngressProfileWebAppRouting.fromMap(
    Map<String, dynamic> map,
  ) {
    return ManagedClusterIngressProfileWebAppRouting(
      dnsZoneResourceIds: (() {
        final guardedValue = map['dnsZoneResourceIds'];
      ...
      nginx: (() {
        final guardedValue = map['nginx'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterIngressProfileNginx.fromMap(
