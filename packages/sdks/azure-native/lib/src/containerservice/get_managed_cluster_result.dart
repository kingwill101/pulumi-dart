...
class GetManagedClusterResult {
  ...
  final ManagedClusterAIToolchainOperatorProfileResponse?
  ...
  final ManagedClusterNodeResourceGroupProfileResponse?
  ...
  final ManagedClusterWorkloadAutoScalerProfileResponse?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'addonProfiles': ?(() {
        final guardedValue = addonProfiles;
      ...
      'agentPoolProfiles': ?(() {
        final guardedValue = agentPoolProfiles;
        if (guardedValue == null) return null;
      ...
      'identityProfile': ?(() {
        final guardedValue = identityProfile;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeMapValues<
      ...
      'privateLinkResources': ?(() {
        final guardedValue = privateLinkResources;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetManagedClusterResult.fromMap(Map<String, dynamic> map) {
    return GetManagedClusterResult(
      ...
      addonProfiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeMapValues<ManagedClusterAddonProfileResponse>(
          guardedValue,
      ...
      agentPoolProfiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ManagedClusterAgentPoolProfileResponse>(
          guardedValue,
          (value) => ManagedClusterAgentPoolProfileResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      powerState: PowerStateResponse.fromMap(
        (map['powerState']! as Map).cast<String, dynamic>(),
      ),
      privateFQDN: map['privateFQDN'] as String,
      privateLinkResources: (() {
        final guardedValue = map['privateLinkResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<PrivateLinkResourceResponse>(
          guardedValue,
          (value) => PrivateLinkResourceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
