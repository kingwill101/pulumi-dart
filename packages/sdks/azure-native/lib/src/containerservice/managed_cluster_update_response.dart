...
class ManagedClusterUpdateResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nodeImageSelection': ?pulumi.Input.mapOptionalInputValue<NodeImageSelectionResponse, Map<String, dynamic>>(nodeImageSelection, (value) => value.toMap()),
      'upgrade': pulumi.Input.mapInputValue<ManagedClusterUpgradeSpecResponse, Map<String, dynamic>>(upgrade, (value) => value.toMap()),
    };
  }

  factory ManagedClusterUpdateResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterUpdateResponse(
      nodeImageSelection: (() { final guardedValue = map['nodeImageSelection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeImageSelectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      upgrade: pulumi.Input.fromValue(ManagedClusterUpgradeSpecResponse.fromMap((map['upgrade']! as Map).cast<String, dynamic>())),
    );
  }
}
