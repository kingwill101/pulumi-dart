    ...
    return <String, dynamic>{
      ...
      'notAllowedDates':
          ?pulumi.Input.mapOptionalInputValue<
            List<DateSpanResponse>,
            List<Map<String, dynamic>>
          >(
            notAllowedDates,
            (value) =>
                pulumi.Input.encodeList<DateSpanResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'schedule':
          pulumi.Input.mapInputValue<ScheduleResponse, Map<String, dynamic>>(
            schedule,
            (value) => value.toMap(),
          ),
      'startDate': ?startDate,
    ...
    return MaintenanceWindowResponse(
      ...
      notAllowedDates: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DateSpanResponse>(
            guardedValue,
            (value) => DateSpanResponse.fromMap(
