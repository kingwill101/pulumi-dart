...
class GetManagedNamespaceResult {
  ...
  factory GetManagedNamespaceResult.fromMap(Map<String, dynamic> map) {
    return GetManagedNamespaceResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return NamespacePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
