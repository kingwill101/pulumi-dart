...
class MeshMembershipArgs {
  ...
  factory MeshMembershipArgs.fromMap(Map<String, dynamic> map) {
    return MeshMembershipArgs(
      ...
      meshMembershipName: (() { final guardedValue = map['meshMembershipName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MeshMembershipProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
