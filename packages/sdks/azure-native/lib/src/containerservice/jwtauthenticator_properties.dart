...
class JWTAuthenticatorProperties {
  ...
  factory JWTAuthenticatorProperties.fromMap(Map<String, dynamic> map) {
    return JWTAuthenticatorProperties(
      claimMappings: pulumi.Input.fromValue(JWTAuthenticatorClaimMappings.fromMap((map['claimMappings']! as Map).cast<String, dynamic>())),
      claimValidationRules: (() { final guardedValue = map['claimValidationRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JWTAuthenticatorValidationRule>(guardedValue, (value) => JWTAuthenticatorValidationRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      issuer: pulumi.Input.fromValue(JWTAuthenticatorIssuer.fromMap((map['issuer']! as Map).cast<String, dynamic>())),
      userValidationRules: (() { final guardedValue = map['userValidationRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JWTAuthenticatorValidationRule>(guardedValue, (value) => JWTAuthenticatorValidationRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
