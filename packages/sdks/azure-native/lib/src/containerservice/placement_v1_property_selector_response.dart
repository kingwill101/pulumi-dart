...
class PlacementV1PropertySelectorResponse {
  ...
  final pulumi.Input<List<PlacementV1PropertySelectorRequirementResponse>>
  matchExpressions;
  ...
  PlacementV1PropertySelectorResponse({required this.matchExpressions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchExpressions':
          pulumi.Input.mapInputValue<
            List<PlacementV1PropertySelectorRequirementResponse>,
  ...
  factory PlacementV1PropertySelectorResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return PlacementV1PropertySelectorResponse(
      matchExpressions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PlacementV1PropertySelectorRequirementResponse>(
          map['matchExpressions']!,
          (value) => PlacementV1PropertySelectorRequirementResponse.fromMap(
