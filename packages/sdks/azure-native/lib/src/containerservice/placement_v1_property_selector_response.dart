...
class PlacementV1PropertySelectorResponse {
  ...
  factory PlacementV1PropertySelectorResponse.fromMap(Map<String, dynamic> map) {
    return PlacementV1PropertySelectorResponse(
      matchExpressions: (pulumi.Input.decodeList<PlacementV1PropertySelectorRequirementResponse>(map['matchExpressions'], (value) => PlacementV1PropertySelectorRequirementResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
