...
class ManagedClusterPodIdentityProfile {
  ...
  final pulumi.Input<List<ManagedClusterPodIdentityException>>?
    ...
    return ManagedClusterPodIdentityProfile(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedClusterPodIdentity>(
            guardedValue,
            (value) => ManagedClusterPodIdentity.fromMap(
      ...
      userAssignedIdentityExceptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedClusterPodIdentityException>(
            guardedValue,
            (value) => ManagedClusterPodIdentityException.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
