...
class ManagedClusterAPIServerAccessProfileResponse {
  ...
  factory ManagedClusterAPIServerAccessProfileResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ManagedClusterAPIServerAccessProfileResponse(
      authorizedIPRanges: (() {
        final guardedValue = map['authorizedIPRanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      disableRunCommand: (() {
        final guardedValue = map['disableRunCommand'];
        if (guardedValue == null) return null;
      ...
      enablePrivateClusterPublicFQDN: (() {
        final guardedValue = map['enablePrivateClusterPublicFQDN'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      privateDNSZone: (() {
        final guardedValue = map['privateDNSZone'];
        if (guardedValue == null) return null;
