...
class ManagedClusterNATGatewayProfileResponse {
  ...
  final pulumi.Input<ManagedClusterManagedOutboundIPProfileResponse>?
  ...
  factory ManagedClusterNATGatewayProfileResponse.fromMap(
    ...
    return ManagedClusterNATGatewayProfileResponse(
      ...
      managedOutboundIPProfile: (() {
        ...
        return pulumi.Input.fromValue(
          ManagedClusterManagedOutboundIPProfileResponse.fromMap(
