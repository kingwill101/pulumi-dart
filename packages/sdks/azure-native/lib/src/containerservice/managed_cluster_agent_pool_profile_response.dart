...
class ManagedClusterAgentPoolProfileResponse {
  ...
  factory ManagedClusterAgentPoolProfileResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterAgentPoolProfileResponse(
      ...
      currentOrchestratorVersion: pulumi.Input.fromValue(map['currentOrchestratorVersion'] as String),
      ...
      gatewayProfile: (() { final guardedValue = map['gatewayProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentPoolGatewayProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      gpuInstanceProfile: (() { final guardedValue = map['gpuInstanceProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gpuProfile: (() { final guardedValue = map['gpuProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GPUProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      kubeletConfig: (() { final guardedValue = map['kubeletConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubeletConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      linuxOSConfig: (() { final guardedValue = map['linuxOSConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxOSConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      localDNSProfile: (() { final guardedValue = map['localDNSProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocalDNSProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      networkProfile: (() { final guardedValue = map['networkProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentPoolNetworkProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nodeImageVersion: pulumi.Input.fromValue(map['nodeImageVersion'] as String),
      ...
      podIPAllocationMode: (() { final guardedValue = map['podIPAllocationMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      powerState: (() { final guardedValue = map['powerState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PowerStateResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      scaleSetEvictionPolicy: (() { final guardedValue = map['scaleSetEvictionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      securityProfile: (() { final guardedValue = map['securityProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentPoolSecurityProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentPoolStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      virtualMachineNodesStatus: (() { final guardedValue = map['virtualMachineNodesStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineNodesResponse>(guardedValue, (value) => VirtualMachineNodesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      virtualMachinesProfile: (() { final guardedValue = map['virtualMachinesProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachinesProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      windowsProfile: (() { final guardedValue = map['windowsProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentPoolWindowsProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
