...
class ManagedClusterLoadBalancerProfile {
  ...
  final pulumi.Input<ManagedClusterLoadBalancerProfileManagedOutboundIPs>?
  managedOutboundIPs;

  /// Desired outbound IP Prefix resources for the cluster load balancer.
  final pulumi.Input<ManagedClusterLoadBalancerProfileOutboundIPPrefixes>?
  outboundIPPrefixes;
    ...
    return ManagedClusterLoadBalancerProfile(
      ...
      managedOutboundIPs: (() {
        ...
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfileManagedOutboundIPs.fromMap(
      ...
      outboundIPPrefixes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfileOutboundIPPrefixes.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outboundIPs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfileOutboundIPs.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
