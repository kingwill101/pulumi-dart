...
class NodeCustomization extends pulumi.CustomResource {
  ...
  NodeCustomization(
    ...
    properties = registerOutput<NodeCustomizationPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NodeCustomizationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
