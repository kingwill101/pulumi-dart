...
class GetDeploymentSafeguardResult {
  ...
  factory GetDeploymentSafeguardResult.fromMap(Map<String, dynamic> map) {
    return GetDeploymentSafeguardResult(
      ...
      systemExcludedNamespaces: (() { final guardedValue = map['systemExcludedNamespaces']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
