...
class PlacementV1ClusterResourcePlacementSpecResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'policy': ?pulumi.Input.mapOptionalInputValue<PlacementV1PlacementPolicyResponse, Map<String, dynamic>>(policy, (value) => value.toMap()),
    };
  }
  ...
  factory PlacementV1ClusterResourcePlacementSpecResponse.fromMap(Map<String, dynamic> map) {
    return PlacementV1ClusterResourcePlacementSpecResponse(
      policy: (() { final guardedValue = map['policy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PlacementV1PlacementPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
