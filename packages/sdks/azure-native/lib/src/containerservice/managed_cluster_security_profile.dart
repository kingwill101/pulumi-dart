...
class ManagedClusterSecurityProfile {
  ...
  final pulumi.Input<ManagedClusterSecurityProfileWorkloadIdentity>?
  workloadIdentity;
  ...
  factory ManagedClusterSecurityProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterSecurityProfile(
      ...
      defender: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterSecurityProfileDefender.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      imageCleaner: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterSecurityProfileImageCleaner.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      workloadIdentity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterSecurityProfileWorkloadIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
