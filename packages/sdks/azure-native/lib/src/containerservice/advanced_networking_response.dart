...
class AdvancedNetworkingResponse {
  ...
  AdvancedNetworkingResponse({this.enabled, this.observability, this.security});
    ...
    return AdvancedNetworkingResponse(
      ...
      observability: (() {
        ...
        return pulumi.Input.fromValue(
          AdvancedNetworkingObservabilityResponse.fromMap(
      ...
      security: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AdvancedNetworkingSecurityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
