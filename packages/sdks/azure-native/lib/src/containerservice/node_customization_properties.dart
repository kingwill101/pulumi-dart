...
class NodeCustomizationProperties {
  ...
  factory NodeCustomizationProperties.fromMap(Map<String, dynamic> map) {
    return NodeCustomizationProperties(
      ...
      customizationScripts: (() { final guardedValue = map['customizationScripts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeCustomizationScript>(guardedValue, (value) => NodeCustomizationScript.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
