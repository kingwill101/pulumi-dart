...
/// }
///
/// resource "azure-native_containerservice_fleet" "fleet" {
///   fleet_name = "fleet1"
///   hub_profile = {
///     agent_profile = {
...
class Fleet extends pulumi.CustomResource {
  ...
  Fleet(
    ...
    hubProfile = registerOutput<FleetHubProfileResponse?>('hubProfile', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FleetHubProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
