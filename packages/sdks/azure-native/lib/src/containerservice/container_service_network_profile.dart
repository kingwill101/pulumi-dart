...
class ContainerServiceNetworkProfile {
  ...
  final pulumi.Input<ManagedClusterStaticEgressGatewayProfile>?
  ...
  factory ContainerServiceNetworkProfile.fromMap(Map<String, dynamic> map) {
    return ContainerServiceNetworkProfile(
      ...
      loadBalancerProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      natGatewayProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterNATGatewayProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      staticEgressGatewayProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterStaticEgressGatewayProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
