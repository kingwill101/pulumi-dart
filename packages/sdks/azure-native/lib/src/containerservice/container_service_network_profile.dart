...
class ContainerServiceNetworkProfile {
  ...
  factory ContainerServiceNetworkProfile.fromMap(Map<String, dynamic> map) {
    return ContainerServiceNetworkProfile(
      ...
      staticEgressGatewayProfile: (() { final guardedValue = map['staticEgressGatewayProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterStaticEgressGatewayProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
