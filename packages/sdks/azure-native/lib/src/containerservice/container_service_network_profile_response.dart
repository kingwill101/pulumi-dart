...
class ContainerServiceNetworkProfileResponse {
  ...
  final pulumi.Input<ManagedClusterLoadBalancerProfileResponse>?
  loadBalancerProfile;
  ...
  final pulumi.Input<ManagedClusterNATGatewayProfileResponse>?
  natGatewayProfile;
  ...
  final pulumi.Input<ManagedClusterStaticEgressGatewayProfileResponse>?
    ...
    return <String, dynamic>{
      'advancedNetworking':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(advancedNetworking, (value) => value.toMap()),
      ...
      'natGatewayProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(natGatewayProfile, (value) => value.toMap()),
      ...
      'staticEgressGatewayProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(staticEgressGatewayProfile, (value) => value.toMap()),
    };
  }

  factory ContainerServiceNetworkProfileResponse.fromMap(
    ...
    return ContainerServiceNetworkProfileResponse(
      advancedNetworking: (() {
        ...
        return pulumi.Input.fromValue(
          AdvancedNetworkingResponse.fromMap(
      ...
      loadBalancerProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      natGatewayProfile: (() {
        final guardedValue = map['natGatewayProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterNATGatewayProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      networkDataplane: (() {
        final guardedValue = map['networkDataplane'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkMode: (() {
      ...
      staticEgressGatewayProfile: (() {
        final guardedValue = map['staticEgressGatewayProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterStaticEgressGatewayProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
