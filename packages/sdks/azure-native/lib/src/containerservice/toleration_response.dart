...
class TolerationResponse {
  ...
  /// Creates a new [TolerationResponse].
  ...
  factory TolerationResponse.fromMap(Map<String, dynamic> map) {
    return TolerationResponse(
