...
class PlacementV1ClusterSelector {
  ...
  final List<PlacementV1ClusterSelectorTerm> clusterSelectorTerms;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clusterSelectorTerms': pulumi.Input.encodeList<PlacementV1ClusterSelectorTerm, Map<String, dynamic>>(clusterSelectorTerms, (value) => value.toMap()),
    };
  }

  factory PlacementV1ClusterSelector.fromMap(Map<String, dynamic> map) {
    return PlacementV1ClusterSelector(
      clusterSelectorTerms: pulumi.Input.decodeList<PlacementV1ClusterSelectorTerm>(map['clusterSelectorTerms'], (value) => PlacementV1ClusterSelectorTerm.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
