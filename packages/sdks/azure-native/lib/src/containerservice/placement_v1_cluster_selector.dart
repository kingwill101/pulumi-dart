...
class PlacementV1ClusterSelector {
  ...
  factory PlacementV1ClusterSelector.fromMap(Map<String, dynamic> map) {
    return PlacementV1ClusterSelector(
      clusterSelectorTerms: (pulumi.Input.decodeList<PlacementV1ClusterSelectorTerm>(map['clusterSelectorTerms'], (value) => PlacementV1ClusterSelectorTerm.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
