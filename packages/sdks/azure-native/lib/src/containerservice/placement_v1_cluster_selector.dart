...
class PlacementV1ClusterSelector {
  ...
  PlacementV1ClusterSelector({required this.clusterSelectorTerms});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clusterSelectorTerms':
          pulumi.Input.mapInputValue<
            List<PlacementV1ClusterSelectorTerm>,
  ...
  factory PlacementV1ClusterSelector.fromMap(Map<String, dynamic> map) {
    return PlacementV1ClusterSelector(
      clusterSelectorTerms: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PlacementV1ClusterSelectorTerm>(
          map['clusterSelectorTerms']!,
          (value) => PlacementV1ClusterSelectorTerm.fromMap(
