...
class ManagedClusterWorkloadAutoScalerProfileResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keda': ?pulumi.Input.mapOptionalInputValue<ManagedClusterWorkloadAutoScalerProfileKedaResponse, Map<String, dynamic>>(keda, (value) => value.toMap()),
      'verticalPodAutoscaler': ?pulumi.Input.mapOptionalInputValue<ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse, Map<String, dynamic>>(verticalPodAutoscaler, (value) => value.toMap()),
    };
  }
  ...
  factory ManagedClusterWorkloadAutoScalerProfileResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterWorkloadAutoScalerProfileResponse(
      keda: (() { final guardedValue = map['keda']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterWorkloadAutoScalerProfileKedaResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      verticalPodAutoscaler: (() { final guardedValue = map['verticalPodAutoscaler']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscalerResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
