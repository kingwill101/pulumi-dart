...
class PlacementV1ClusterSelectorResponse {
  ...
  final pulumi.Input<List<PlacementV1ClusterSelectorTermResponse>>
  ...
  PlacementV1ClusterSelectorResponse({required this.clusterSelectorTerms});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clusterSelectorTerms':
          pulumi.Input.mapInputValue<
            List<PlacementV1ClusterSelectorTermResponse>,
  ...
  factory PlacementV1ClusterSelectorResponse.fromMap(Map<String, dynamic> map) {
    return PlacementV1ClusterSelectorResponse(
      clusterSelectorTerms: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PlacementV1ClusterSelectorTermResponse>(
          map['clusterSelectorTerms']!,
          (value) => PlacementV1ClusterSelectorTermResponse.fromMap(
