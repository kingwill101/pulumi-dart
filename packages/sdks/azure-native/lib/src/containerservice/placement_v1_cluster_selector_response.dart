...
class PlacementV1ClusterSelectorResponse {
  ...
  final List<PlacementV1ClusterSelectorTermResponse> clusterSelectorTerms;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clusterSelectorTerms': pulumi.Input.encodeList<PlacementV1ClusterSelectorTermResponse, Map<String, dynamic>>(clusterSelectorTerms, (value) => value.toMap()),
    };
  }

  factory PlacementV1ClusterSelectorResponse.fromMap(Map<String, dynamic> map) {
    return PlacementV1ClusterSelectorResponse(
      clusterSelectorTerms: pulumi.Input.decodeList<PlacementV1ClusterSelectorTermResponse>(map['clusterSelectorTerms'], (value) => PlacementV1ClusterSelectorTermResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
