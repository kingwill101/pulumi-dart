...
class ManagedClusterAgentPoolProfile {
  ...
  factory ManagedClusterAgentPoolProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterAgentPoolProfile(
      ...
      gatewayProfile: map['gatewayProfile'] == null ? null : (AgentPoolGatewayProfile.fromMap((map['gatewayProfile']! as Map).cast<String, dynamic>())).input(),
      gpuInstanceProfile: map['gpuInstanceProfile'] == null ? null : (map['gpuInstanceProfile']! as String).input(),
      gpuProfile: map['gpuProfile'] == null ? null : (GPUProfile.fromMap((map['gpuProfile']! as Map).cast<String, dynamic>())).input(),
      hostGroupID: map['hostGroupID'] == null ? null : (map['hostGroupID']! as String).input(),
      kubeletConfig: map['kubeletConfig'] == null ? null : (KubeletConfig.fromMap((map['kubeletConfig']! as Map).cast<String, dynamic>())).input(),
      kubeletDiskType: map['kubeletDiskType'] == null ? null : (map['kubeletDiskType']! as String).input(),
      linuxOSConfig: map['linuxOSConfig'] == null ? null : (LinuxOSConfig.fromMap((map['linuxOSConfig']! as Map).cast<String, dynamic>())).input(),
      localDNSProfile: map['localDNSProfile'] == null ? null : (LocalDNSProfile.fromMap((map['localDNSProfile']! as Map).cast<String, dynamic>())).input(),
      ...
      networkProfile: map['networkProfile'] == null ? null : (AgentPoolNetworkProfile.fromMap((map['networkProfile']! as Map).cast<String, dynamic>())).input(),
      ...
      powerState: map['powerState'] == null ? null : (PowerState.fromMap((map['powerState']! as Map).cast<String, dynamic>())).input(),
      ...
      securityProfile: map['securityProfile'] == null ? null : (AgentPoolSecurityProfile.fromMap((map['securityProfile']! as Map).cast<String, dynamic>())).input(),
      ...
      virtualMachineNodesStatus: map['virtualMachineNodesStatus'] == null ? null : (pulumi.Input.decodeList<VirtualMachineNodes>(map['virtualMachineNodesStatus']!, (value) => VirtualMachineNodes.fromMap((value as Map).cast<String, dynamic>()))).input(),
      virtualMachinesProfile: map['virtualMachinesProfile'] == null ? null : (VirtualMachinesProfile.fromMap((map['virtualMachinesProfile']! as Map).cast<String, dynamic>())).input(),
      ...
      windowsProfile: map['windowsProfile'] == null ? null : (AgentPoolWindowsProfile.fromMap((map['windowsProfile']! as Map).cast<String, dynamic>())).input(),
