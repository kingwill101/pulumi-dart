...
class MaintenanceWindow {
  ...
  final List<DateSpan>? notAllowedDates;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'notAllowedDates': ?notAllowedDates == null ? null : pulumi.Input.encodeList<DateSpan, Map<String, dynamic>>(notAllowedDates!, (value) => value.toMap()),
  ...
  factory MaintenanceWindow.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindow(
      ...
      notAllowedDates: map['notAllowedDates'] == null ? null : pulumi.Input.decodeList<DateSpan>(map['notAllowedDates'], (value) => DateSpan.fromMap((value as Map).cast<String, dynamic>())),
      schedule: Schedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
