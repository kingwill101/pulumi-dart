...
class UpdateStage {
  ...
  UpdateStage({this.afterStageWaitInSeconds, this.groups, required this.name});
    ...
    return <String, dynamic>{
      ...
      'groups':
          ...
          >(
            groups,
            (value) =>
                pulumi.Input.encodeList<UpdateGroup, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return UpdateStage(
      ...
      groups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UpdateGroup>(
            guardedValue,
            (value) =>
                UpdateGroup.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
