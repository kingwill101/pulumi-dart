...
class ManagedClusterNodeResourceGroupProfile {
  ...
  final pulumi.Input<dynamic>? restrictionLevel;
  ...
  factory ManagedClusterNodeResourceGroupProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterNodeResourceGroupProfile(
      restrictionLevel: (() { final guardedValue = map['restrictionLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
