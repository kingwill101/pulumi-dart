...
class NodeImageSelectionResponse {
  ...
  const NodeImageSelectionResponse({
  ...
  factory NodeImageSelectionResponse.fromMap(Map<String, dynamic> map) {
    return NodeImageSelectionResponse(
      customNodeImageVersions: (() { final guardedValue = map['customNodeImageVersions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeImageVersionResponse>(guardedValue, (value) => NodeImageVersionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
