...
class PropertySelectorRequirementResponse {
  ...
  /// Creates a new [PropertySelectorRequirementResponse].
  ...
  const PropertySelectorRequirementResponse({
    required this.name,
  ...
  factory PropertySelectorRequirementResponse.fromMap(Map<String, dynamic> map) {
    return PropertySelectorRequirementResponse(
