...
class ManagedClusterAzureMonitorProfileMetricsResponse {
  ...
  final ManagedClusterAzureMonitorProfileKubeStateMetricsResponse? kubeStateMetrics;
  ...
  factory ManagedClusterAzureMonitorProfileMetricsResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterAzureMonitorProfileMetricsResponse(
      ...
      kubeStateMetrics: map['kubeStateMetrics'] == null ? null : ManagedClusterAzureMonitorProfileKubeStateMetricsResponse.fromMap((map['kubeStateMetrics'] as Map).cast<String, dynamic>()),
    );
  }
}
