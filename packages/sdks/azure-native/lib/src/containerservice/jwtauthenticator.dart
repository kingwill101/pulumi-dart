...
class JWTAuthenticator extends pulumi.CustomResource {
  ...
  JWTAuthenticator(
    ...
    properties = registerOutput<JWTAuthenticatorPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return JWTAuthenticatorPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [JWTAuthenticator] resource.
  JWTAuthenticator.reference(String urn)
    : super(
        'azure-native:containerservice:JWTAuthenticator',
