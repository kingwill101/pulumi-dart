...
class LocalDNSProfile {
  ...
  }) : mode = mode ?? pulumi.Input.fromValue('Preferred');
  ...
  factory LocalDNSProfile.fromMap(Map<String, dynamic> map) {
    return LocalDNSProfile(
      kubeDNSOverrides: (() { final guardedValue = map['kubeDNSOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<LocalDNSOverride>(guardedValue, (value) => LocalDNSOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      vnetDNSOverrides: (() { final guardedValue = map['vnetDNSOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<LocalDNSOverride>(guardedValue, (value) => LocalDNSOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
