...
class GetAutoUpgradeProfileResult {
  ...
  factory GetAutoUpgradeProfileResult.fromMap(Map<String, dynamic> map) {
    return GetAutoUpgradeProfileResult(
      ...
      channel: (() { final guardedValue = map['channel']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      nodeImageSelection: (() { final guardedValue = map['nodeImageSelection']; if (guardedValue == null) return null; return AutoUpgradeNodeImageSelectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
