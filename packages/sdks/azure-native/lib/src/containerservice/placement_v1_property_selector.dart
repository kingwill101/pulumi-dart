...
class PlacementV1PropertySelector {
  ...
  factory PlacementV1PropertySelector.fromMap(Map<String, dynamic> map) {
    return PlacementV1PropertySelector(
      matchExpressions: (pulumi.Input.decodeList<PlacementV1PropertySelectorRequirement>(map['matchExpressions'], (value) => PlacementV1PropertySelectorRequirement.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
