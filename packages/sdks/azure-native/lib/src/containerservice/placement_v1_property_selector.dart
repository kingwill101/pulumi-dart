...
class PlacementV1PropertySelector {
  ...
  final pulumi.Input<List<PlacementV1PropertySelectorRequirement>>
  matchExpressions;
  ...
  PlacementV1PropertySelector({required this.matchExpressions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchExpressions':
          pulumi.Input.mapInputValue<
            List<PlacementV1PropertySelectorRequirement>,
  ...
  factory PlacementV1PropertySelector.fromMap(Map<String, dynamic> map) {
    return PlacementV1PropertySelector(
      matchExpressions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PlacementV1PropertySelectorRequirement>(
          map['matchExpressions']!,
          (value) => PlacementV1PropertySelectorRequirement.fromMap(
