...
class PlacementV1PropertySelector {
  ...
  final List<PlacementV1PropertySelectorRequirement> matchExpressions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchExpressions': pulumi.Input.encodeList<PlacementV1PropertySelectorRequirement, Map<String, dynamic>>(matchExpressions, (value) => value.toMap()),
    };
  }

  factory PlacementV1PropertySelector.fromMap(Map<String, dynamic> map) {
    return PlacementV1PropertySelector(
      matchExpressions: pulumi.Input.decodeList<PlacementV1PropertySelectorRequirement>(map['matchExpressions'], (value) => PlacementV1PropertySelectorRequirement.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
