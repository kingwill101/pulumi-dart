...
class IstioComponents {
  ...
  IstioComponents({this.egressGateways, this.ingressGateways});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'egressGateways':
          ?pulumi.Input.mapOptionalInputValue<
            List<IstioEgressGateway>,
    ...
    return IstioComponents(
      egressGateways: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IstioEgressGateway>(
            guardedValue,
            (value) => IstioEgressGateway.fromMap(
      ...
      ingressGateways: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IstioIngressGateway>(
            guardedValue,
            (value) => IstioIngressGateway.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
