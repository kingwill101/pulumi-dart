...
class ContainerServiceSshConfiguration {
  ...
  final pulumi.Input<List<ContainerServiceSshPublicKey>> publicKeys;
  ...
  factory ContainerServiceSshConfiguration.fromMap(Map<String, dynamic> map) {
    return ContainerServiceSshConfiguration(
      publicKeys: (pulumi.Input.decodeList<ContainerServiceSshPublicKey>(map['publicKeys'], (value) => ContainerServiceSshPublicKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
