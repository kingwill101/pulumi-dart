...
class JWTAuthenticatorArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'properties': pulumi.Input.mapInputValue<JWTAuthenticatorProperties, Map<String, dynamic>>(properties, (value) => value.toMap()),
  ...
  factory JWTAuthenticatorArgs.fromMap(Map<String, dynamic> map) {
    return JWTAuthenticatorArgs(
      jwtAuthenticatorName: (() { final guardedValue = map['jwtAuthenticatorName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: pulumi.Input.fromValue(JWTAuthenticatorProperties.fromMap((map['properties']! as Map).cast<String, dynamic>())),
