...
class ManagedClusterNATGatewayProfile {
  ...
  final ManagedClusterManagedOutboundIPProfile? managedOutboundIPProfile;
  ...
  factory ManagedClusterNATGatewayProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterNATGatewayProfile(
      ...
      managedOutboundIPProfile: map['managedOutboundIPProfile'] == null ? null : ManagedClusterManagedOutboundIPProfile.fromMap((map['managedOutboundIPProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
