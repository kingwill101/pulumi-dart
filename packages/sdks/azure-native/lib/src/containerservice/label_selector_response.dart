...
class LabelSelectorResponse {
  ...
  LabelSelectorResponse({this.matchExpressions, this.matchLabels});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchExpressions':
          ?pulumi.Input.mapOptionalInputValue<
            List<LabelSelectorRequirementResponse>,
    ...
    return LabelSelectorResponse(
      matchExpressions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LabelSelectorRequirementResponse>(
            guardedValue,
            (value) => LabelSelectorRequirementResponse.fromMap(
