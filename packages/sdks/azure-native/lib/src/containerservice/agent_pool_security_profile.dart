...
class AgentPoolSecurityProfile {
  ...
  final pulumi.Input<dynamic>? sshAccess;
  ...
  factory AgentPoolSecurityProfile.fromMap(Map<String, dynamic> map) {
    return AgentPoolSecurityProfile(
      ...
      sshAccess: (() { final guardedValue = map['sshAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
