...
class LoadBalancerArgs {
    ...
    return <String, dynamic>{
      ...
      'serviceLabelSelector':
          ?pulumi.Input.mapOptionalInputValue<
            LabelSelector,
            Map<String, dynamic>
          >(serviceLabelSelector, (value) => value.toMap()),
      'serviceNamespaceSelector':
          ?pulumi.Input.mapOptionalInputValue<
            LabelSelector,
            Map<String, dynamic>
          >(serviceNamespaceSelector, (value) => value.toMap()),
    };
  }
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      primaryAgentPoolName: pulumi.Input.fromValue(
        map['primaryAgentPoolName'] as String,
      ),
