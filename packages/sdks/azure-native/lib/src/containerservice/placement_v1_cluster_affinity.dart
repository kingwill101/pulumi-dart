...
class PlacementV1ClusterAffinity {
  ...
  final PlacementV1ClusterSelector? requiredDuringSchedulingIgnoredDuringExecution;
  ...
  factory PlacementV1ClusterAffinity.fromMap(Map<String, dynamic> map) {
    return PlacementV1ClusterAffinity(
      requiredDuringSchedulingIgnoredDuringExecution: map['requiredDuringSchedulingIgnoredDuringExecution'] == null ? null : PlacementV1ClusterSelector.fromMap((map['requiredDuringSchedulingIgnoredDuringExecution'] as Map).cast<String, dynamic>()),
    );
  }
}
