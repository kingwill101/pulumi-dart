...
class PlacementV1PlacementPolicyResponse {
  ...
  factory PlacementV1PlacementPolicyResponse.fromMap(Map<String, dynamic> map) {
    return PlacementV1PlacementPolicyResponse(
      affinity: (() { final guardedValue = map['affinity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PlacementV1AffinityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      tolerations: (() { final guardedValue = map['tolerations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PlacementV1TolerationResponse>(guardedValue, (value) => PlacementV1TolerationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
