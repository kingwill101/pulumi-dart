...
class JWTAuthenticatorClaimMappings {
  ...
  const JWTAuthenticatorClaimMappings({
    this.extra,
    this.groups,
    this.uid,
  ...
  factory JWTAuthenticatorClaimMappings.fromMap(Map<String, dynamic> map) {
    return JWTAuthenticatorClaimMappings(
      extra: (() { final guardedValue = map['extra']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JWTAuthenticatorExtraClaimMappingExpression>(guardedValue, (value) => JWTAuthenticatorExtraClaimMappingExpression.fromMap((value as Map).cast<String, dynamic>()))); })(),
      groups: (() { final guardedValue = map['groups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JWTAuthenticatorClaimMappingExpression.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      uid: (() { final guardedValue = map['uid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JWTAuthenticatorClaimMappingExpression.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      username: pulumi.Input.fromValue(JWTAuthenticatorClaimMappingExpression.fromMap((map['username']! as Map).cast<String, dynamic>())),
    );
  }
}
