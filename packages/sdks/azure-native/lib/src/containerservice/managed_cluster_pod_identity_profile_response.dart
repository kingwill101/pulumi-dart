...
class ManagedClusterPodIdentityProfileResponse {
  ...
  final pulumi.Input<List<ManagedClusterPodIdentityResponse>>?
  userAssignedIdentities;

  /// The pod identity exceptions to allow.
  final pulumi.Input<List<ManagedClusterPodIdentityExceptionResponse>>?
    ...
    return <String, dynamic>{
      ...
      'userAssignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedClusterPodIdentityResponse>,
      ...
      'userAssignedIdentityExceptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedClusterPodIdentityExceptionResponse>,
            List<Map<String, dynamic>>
          >(
            userAssignedIdentityExceptions,
            (value) =>
  ...
  factory ManagedClusterPodIdentityProfileResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ManagedClusterPodIdentityProfileResponse(
      allowNetworkPluginKubenet: (() {
        final guardedValue = map['allowNetworkPluginKubenet'];
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedClusterPodIdentityResponse>(
            guardedValue,
            (value) => ManagedClusterPodIdentityResponse.fromMap(
      ...
      userAssignedIdentityExceptions: (() {
        final guardedValue = map['userAssignedIdentityExceptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedClusterPodIdentityExceptionResponse>(
            guardedValue,
            (value) => ManagedClusterPodIdentityExceptionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
