...
class GetNamespaceResult {
  ...
  factory GetNamespaceResult.fromMap(Map<String, dynamic> map) {
    return GetNamespaceResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return NamespacePropertiesNamespaceResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
