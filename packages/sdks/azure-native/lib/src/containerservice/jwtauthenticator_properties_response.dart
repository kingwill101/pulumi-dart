...
class JWTAuthenticatorPropertiesResponse {
  ...
  final pulumi.Input<List<JWTAuthenticatorValidationRuleResponse>>?
    ...
    return <String, dynamic>{
      ...
      'claimValidationRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<JWTAuthenticatorValidationRuleResponse>,
  ...
  factory JWTAuthenticatorPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return JWTAuthenticatorPropertiesResponse(
      claimMappings: pulumi.Input.fromValue(
        JWTAuthenticatorClaimMappingsResponse.fromMap(
      ...
      claimValidationRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JWTAuthenticatorValidationRuleResponse>(
            guardedValue,
            (value) => JWTAuthenticatorValidationRuleResponse.fromMap(
      ...
      issuer: pulumi.Input.fromValue(
        JWTAuthenticatorIssuerResponse.fromMap(
