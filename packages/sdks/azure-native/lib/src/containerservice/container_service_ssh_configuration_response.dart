...
class ContainerServiceSshConfigurationResponse {
  ...
  final List<ContainerServiceSshPublicKeyResponse> publicKeys;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'publicKeys': pulumi.Input.encodeList<ContainerServiceSshPublicKeyResponse, Map<String, dynamic>>(publicKeys, (value) => value.toMap()),
    };
  }
  ...
  factory ContainerServiceSshConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ContainerServiceSshConfigurationResponse(
      publicKeys: pulumi.Input.decodeList<ContainerServiceSshPublicKeyResponse>(map['publicKeys'], (value) => ContainerServiceSshPublicKeyResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
