...
class ManagedClusterWindowsProfileResponse {
  ...
  const ManagedClusterWindowsProfileResponse({
    this.adminPassword,
  ...
  factory ManagedClusterWindowsProfileResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterWindowsProfileResponse(
      ...
      gmsaProfile: (() { final guardedValue = map['gmsaProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsGmsaProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
