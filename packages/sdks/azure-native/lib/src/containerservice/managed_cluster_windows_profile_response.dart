    ...
    return <String, dynamic>{
      ...
      'gmsaProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(gmsaProfile, (value) => value.toMap()),
      'licenseType': ?licenseType,
    };
  }

  factory ManagedClusterWindowsProfileResponse.fromMap(
    ...
    return ManagedClusterWindowsProfileResponse(
      ...
      enableCSIProxy: (() {
        final guardedValue = map['enableCSIProxy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      gmsaProfile: (() {
        final guardedValue = map['gmsaProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WindowsGmsaProfileResponse.fromMap(
