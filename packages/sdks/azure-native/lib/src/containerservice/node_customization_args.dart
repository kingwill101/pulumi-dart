...
class NodeCustomizationArgs {
  ...
  factory NodeCustomizationArgs.fromMap(Map<String, dynamic> map) {
    return NodeCustomizationArgs(
      ...
      nodeCustomizationName: (() { final guardedValue = map['nodeCustomizationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeCustomizationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
