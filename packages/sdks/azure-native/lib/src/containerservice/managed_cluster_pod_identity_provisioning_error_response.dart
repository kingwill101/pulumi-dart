...
class ManagedClusterPodIdentityProvisioningErrorResponse {
  ...
  const ManagedClusterPodIdentityProvisioningErrorResponse({
    this.error,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'error': ?pulumi.Input.mapOptionalInputValue<ManagedClusterPodIdentityProvisioningErrorBodyResponse, Map<String, dynamic>>(error, (value) => value.toMap()),
    };
  }
  ...
  factory ManagedClusterPodIdentityProvisioningErrorResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterPodIdentityProvisioningErrorResponse(
      error: (() { final guardedValue = map['error']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterPodIdentityProvisioningErrorBodyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
