...
class NodeCustomizationPropertiesResponse {
  ...
  factory NodeCustomizationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NodeCustomizationPropertiesResponse(
      containerImages: (() { final guardedValue = map['containerImages']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      customizationScripts: (() { final guardedValue = map['customizationScripts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NodeCustomizationScriptResponse>(guardedValue, (value) => NodeCustomizationScriptResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      identityProfile: (() { final guardedValue = map['identityProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserAssignedIdentityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
