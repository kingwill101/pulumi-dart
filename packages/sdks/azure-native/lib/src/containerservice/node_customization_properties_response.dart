...
class NodeCustomizationPropertiesResponse {
  ...
  final pulumi.Input<List<NodeCustomizationScriptResponse>>?
    ...
    return <String, dynamic>{
      ...
      'customizationScripts':
          ?pulumi.Input.mapOptionalInputValue<
            List<NodeCustomizationScriptResponse>,
      ...
      'identityProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(identityProfile, (value) => value.toMap()),
      'provisioningState': provisioningState,
      'version': version,
    };
  }

  factory NodeCustomizationPropertiesResponse.fromMap(
    ...
    return NodeCustomizationPropertiesResponse(
      ...
      customizationScripts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NodeCustomizationScriptResponse>(
            guardedValue,
            (value) => NodeCustomizationScriptResponse.fromMap(
      ...
      identityProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserAssignedIdentityResponse.fromMap(
