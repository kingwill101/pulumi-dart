...
class ManagedClusterIdentityResponse {
  ...
  factory ManagedClusterIdentityResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterIdentityResponse(
      delegatedResources: (() { final guardedValue = map['delegatedResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<DelegatedResourceResponse>(guardedValue, (value) => DelegatedResourceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      principalId: pulumi.Input.fromValue(map['principalId'] as String),
      tenantId: pulumi.Input.fromValue(map['tenantId'] as String),
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userAssignedIdentities: (() { final guardedValue = map['userAssignedIdentities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ManagedClusterIdentityResponseUserAssignedIdentities>(guardedValue, (value) => ManagedClusterIdentityResponseUserAssignedIdentities.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
