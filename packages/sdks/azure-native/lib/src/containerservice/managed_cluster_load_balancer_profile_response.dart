...
class ManagedClusterLoadBalancerProfileResponse {
  ...
  final pulumi.Input<ManagedClusterLoadBalancerProfileResponseOutboundIPs>?
  outboundIPs;
    ...
    return <String, dynamic>{
      ...
      'outboundIPPrefixes':
          ?pulumi.Input.mapOptionalInputValue<
            ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes,
            Map<String, dynamic>
          >(outboundIPPrefixes, (value) => value.toMap()),
      'outboundIPs':
          ?pulumi.Input.mapOptionalInputValue<
            ManagedClusterLoadBalancerProfileResponseOutboundIPs,
            Map<String, dynamic>
          >(outboundIPs, (value) => value.toMap()),
    };
  }

  factory ManagedClusterLoadBalancerProfileResponse.fromMap(
    ...
    return ManagedClusterLoadBalancerProfileResponse(
      ...
      enableMultipleStandardLoadBalancers: (() {
        final guardedValue = map['enableMultipleStandardLoadBalancers'];
        if (guardedValue == null) return null;
      ...
      managedOutboundIPs: (() {
        ...
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfileResponseManagedOutboundIPs.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outboundIPPrefixes: (() {
        final guardedValue = map['outboundIPPrefixes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfileResponseOutboundIPPrefixes.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outboundIPs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedClusterLoadBalancerProfileResponseOutboundIPs.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
