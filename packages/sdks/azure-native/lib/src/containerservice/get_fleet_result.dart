...
class GetFleetResult {
  ...
  factory GetFleetResult.fromMap(Map<String, dynamic> map) {
    return GetFleetResult(
      ...
      hubProfile: (() { final guardedValue = map['hubProfile']; if (guardedValue == null) return null; return FleetHubProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      id: map['id'] as String,
