...
class ManagedClusterAzureMonitorProfileMetrics {
  ...
  factory ManagedClusterAzureMonitorProfileMetrics.fromMap(Map<String, dynamic> map) {
    return ManagedClusterAzureMonitorProfileMetrics(
      ...
      kubeStateMetrics: (() { final guardedValue = map['kubeStateMetrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedClusterAzureMonitorProfileKubeStateMetrics.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
