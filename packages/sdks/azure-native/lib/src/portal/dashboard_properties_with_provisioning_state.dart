...
class DashboardPropertiesWithProvisioningState {
  ...
  DashboardPropertiesWithProvisioningState({this.lenses, this.metadata});
    ...
    return <String, dynamic>{
      'lenses':
          ...
          >(
            lenses,
            (value) =>
                pulumi.Input.encodeList<DashboardLens, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DashboardPropertiesWithProvisioningState.fromMap(
    ...
    return DashboardPropertiesWithProvisioningState(
      lenses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DashboardLens>(
            guardedValue,
            (value) =>
                DashboardLens.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      metadata: (() {
