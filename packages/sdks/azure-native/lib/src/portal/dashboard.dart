...
class Dashboard extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DashboardPropertiesWithProvisioningStateResponse>
  properties;
  ...
  Dashboard(
    ...
    properties =
        registerOutput<DashboardPropertiesWithProvisioningStateResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return DashboardPropertiesWithProvisioningStateResponse.fromMap(
