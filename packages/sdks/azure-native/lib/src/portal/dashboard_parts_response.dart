...
class DashboardPartsResponse {
  ...
  factory DashboardPartsResponse.fromMap(Map<String, dynamic> map) {
    return DashboardPartsResponse(
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DashboardPartMetadataResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      position: pulumi.Input.fromValue(DashboardPartsPositionResponse.fromMap((map['position']! as Map).cast<String, dynamic>())),
    );
  }
}
