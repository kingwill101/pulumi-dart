...
class DashboardLens {
  ...
  DashboardLens({this.metadata, required this.order, required this.parts});
    ...
    return <String, dynamic>{
      ...
      'parts':
          ...
          >(
            parts,
            (value) =>
                pulumi.Input.encodeList<DashboardParts, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DashboardLens.fromMap(Map<String, dynamic> map) {
    return DashboardLens(
      ...
      parts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DashboardParts>(
          map['parts']!,
          (value) =>
              DashboardParts.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
