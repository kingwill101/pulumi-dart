...
class ReportArgs {
  ...
  factory ReportArgs.fromMap(Map<String, dynamic> map) {
    return ReportArgs(
      ...
      resources: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceMetadata>(map['resources']!, (value) => ResourceMetadata.fromMap((value as Map).cast<String, dynamic>()))),
      storageInfo: (() { final guardedValue = map['storageInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
