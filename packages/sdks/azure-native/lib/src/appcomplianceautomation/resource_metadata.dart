...
class ResourceMetadata {
  ...
  /// Resource Origin.
  final pulumi.Input<dynamic>? resourceOrigin;
  ...
  factory ResourceMetadata.fromMap(Map<String, dynamic> map) {
    return ResourceMetadata(
      ...
      resourceOrigin: (() { final guardedValue = map['resourceOrigin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
