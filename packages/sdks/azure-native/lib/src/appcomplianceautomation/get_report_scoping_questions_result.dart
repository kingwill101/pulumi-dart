...
class GetReportScopingQuestionsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'questions': ?(() { final guardedValue = questions; if (guardedValue == null) return null; return pulumi.Input.encodeList<ScopingQuestionResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }

  factory GetReportScopingQuestionsResult.fromMap(Map<String, dynamic> map) {
    return GetReportScopingQuestionsResult(
      questions: (() { final guardedValue = map['questions']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ScopingQuestionResponse>(guardedValue, (value) => ScopingQuestionResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
