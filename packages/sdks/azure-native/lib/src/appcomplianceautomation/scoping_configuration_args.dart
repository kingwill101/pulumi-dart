...
class ScopingConfigurationArgs {
  ...
  factory ScopingConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ScopingConfigurationArgs(
      answers: (() { final guardedValue = map['answers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScopingAnswer>(guardedValue, (value) => ScopingAnswer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      reportName: pulumi.Input.fromValue(map['reportName'] as String),
      scopingConfigurationName: (() { final guardedValue = map['scopingConfigurationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
