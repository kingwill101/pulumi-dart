...
class ReportComplianceStatusResponse {
  ...
  ReportComplianceStatusResponse({required this.m365});
    ...
    return <String, dynamic>{
      'm365':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(m365, (value) => value.toMap()),
    };
  }

  factory ReportComplianceStatusResponse.fromMap(Map<String, dynamic> map) {
    return ReportComplianceStatusResponse(
      m365: pulumi.Input.fromValue(
        OverviewStatusResponse.fromMap(
          (map['m365']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
