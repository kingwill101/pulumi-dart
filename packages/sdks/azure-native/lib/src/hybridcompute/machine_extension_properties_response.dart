...
class MachineExtensionPropertiesResponse {
  ...
  factory MachineExtensionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MachineExtensionPropertiesResponse(
      ...
      instanceView: (() { final guardedValue = map['instanceView']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MachineExtensionInstanceViewResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
