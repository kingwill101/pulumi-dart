...
class GetMachineExtensionResult {
  ...
  factory GetMachineExtensionResult.fromMap(Map<String, dynamic> map) {
    return GetMachineExtensionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return MachineExtensionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
