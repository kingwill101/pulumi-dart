...
class GetMachineResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'errorDetails':
          pulumi.Input.encodeList<ErrorDetailResponse, Map<String, dynamic>>(
            errorDetails,
            (value) => value.toMap(),
          ),
      'extensions': ?(() {
  ...
  factory GetMachineResult.fromMap(Map<String, dynamic> map) {
    return GetMachineResult(
      ...
      agentConfiguration: AgentConfigurationResponse.fromMap(
        (map['agentConfiguration']! as Map).cast<String, dynamic>(),
      ),
      agentUpgrade: (() {
      ...
      cloudMetadata: (() {
        final guardedValue = map['cloudMetadata'];
        if (guardedValue == null) return null;
      ...
      errorDetails: pulumi.Input.decodeList<ErrorDetailResponse>(
        map['errorDetails']!,
        (value) =>
            ErrorDetailResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      extensions: (() {
        final guardedValue = map['extensions'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<MachineExtensionInstanceViewResponse>(
          guardedValue,
          (value) => MachineExtensionInstanceViewResponse.fromMap(
      ...
      networkProfile: NetworkProfileResponse.fromMap(
      ...
      resources: pulumi.Input.decodeList<MachineExtensionResponse>(
        map['resources']!,
        (value) => MachineExtensionResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      serviceStatuses: (() {
