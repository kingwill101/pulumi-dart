...
/// }
///
/// resource "azure-native_hybridcompute_machineextension" "machineExtension" {
...
class MachineExtension extends pulumi.CustomResource {
  ...
  MachineExtension(
    ...
    properties = registerOutput<MachineExtensionPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MachineExtensionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
