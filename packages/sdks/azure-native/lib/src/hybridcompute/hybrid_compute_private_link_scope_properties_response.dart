...
class HybridComputePrivateLinkScopePropertiesResponse {
  ...
  final pulumi.Input<List<PrivateEndpointConnectionDataModelResponse>>
    ...
    return <String, dynamic>{
      'privateEndpointConnections':
          pulumi.Input.mapInputValue<
            List<PrivateEndpointConnectionDataModelResponse>,
  ...
  factory HybridComputePrivateLinkScopePropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return HybridComputePrivateLinkScopePropertiesResponse(
      privateEndpointConnections: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PrivateEndpointConnectionDataModelResponse>(
          map['privateEndpointConnections']!,
          (value) => PrivateEndpointConnectionDataModelResponse.fromMap(
