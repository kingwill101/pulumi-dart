...
class MachineArgs {
    ...
    return <String, dynamic>{
      'agentUpgrade':
          ?pulumi.Input.mapOptionalInputValue<
            AgentUpgrade,
            Map<String, dynamic>
          >(agentUpgrade, (value) => value.toMap()),
      'clientPublicKey': ?clientPublicKey,
      'expand': ?expand,
      'extensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<MachineExtensionInstanceView>,
      ...
      'licenseProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(licenseProfile, (value) => value.toMap()),
      'location': ?location,
      'locationData':
          ?pulumi.Input.mapOptionalInputValue<
            LocationData,
      ...
      'serviceStatuses':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceStatuses,
            Map<String, dynamic>
          >(serviceStatuses, (value) => value.toMap()),
      'tags': ?tags,
      'vmId': ?vmId,
    };
  }
  ...
  factory MachineArgs.fromMap(Map<String, dynamic> map) {
    return MachineArgs(
      agentUpgrade: (() {
        final guardedValue = map['agentUpgrade'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentUpgrade.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      clientPublicKey: (() {
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MachineExtensionInstanceView>(
            guardedValue,
            (value) => MachineExtensionInstanceView.fromMap(
      ...
      licenseProfile: (() {
        final guardedValue = map['licenseProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LicenseProfileMachineInstanceView.fromMap(
      ...
      locationData: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LocationData.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      machineName: (() {
      ...
      mssqlDiscovered: (() {
        final guardedValue = map['mssqlDiscovered'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      osProfile: (() {
      ...
      parentClusterResourceId: (() {
        final guardedValue = map['parentClusterResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      serviceStatuses: (() {
        final guardedValue = map['serviceStatuses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceStatuses.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
