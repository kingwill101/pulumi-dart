...
class GetMachineRunCommandResult {
  ...
  GetMachineRunCommandResult({
    ...
    this.type,
  }) : asyncExecution = asyncExecution ?? false;
  ...
  factory GetMachineRunCommandResult.fromMap(Map<String, dynamic> map) {
    return GetMachineRunCommandResult(
      ...
      instanceView: (() { final guardedValue = map['instanceView']; if (guardedValue == null) return null; return MachineRunCommandInstanceViewResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
