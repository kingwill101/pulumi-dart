...
class NetworkInterfaceResponse {
  ...
  factory NetworkInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResponse(
      ipAddresses: (() { final guardedValue = map['ipAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IpAddressResponse>(guardedValue, (value) => IpAddressResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
