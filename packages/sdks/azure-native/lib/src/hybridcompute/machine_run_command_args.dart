...
class MachineRunCommandArgs {
  ...
  MachineRunCommandArgs({
    ...
    pulumi.Output<MachineRunCommandScriptSource>? source,
  ...
  factory MachineRunCommandArgs.fromMap(Map<String, dynamic> map) {
    return MachineRunCommandArgs(
      ...
      source: map['source'] == null ? null : pulumi.Output.create<MachineRunCommandScriptSource>(MachineRunCommandScriptSource.fromMap((map['source'] as Map).cast<String, dynamic>())),
