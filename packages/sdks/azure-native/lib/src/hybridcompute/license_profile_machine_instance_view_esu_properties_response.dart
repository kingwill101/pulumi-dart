...
class LicenseProfileMachineInstanceViewEsuPropertiesResponse {
    ...
    return <String, dynamic>{
      'assignedLicense':
          ?pulumi.Input.mapOptionalInputValue<
            LicenseResponse,
            Map<String, dynamic>
          >(assignedLicense, (value) => value.toMap()),
      ...
      'esuKeys':
          ...
          >(
            esuKeys,
            (value) =>
                pulumi.Input.encodeList<EsuKeyResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory LicenseProfileMachineInstanceViewEsuPropertiesResponse.fromMap(
    ...
    return LicenseProfileMachineInstanceViewEsuPropertiesResponse(
      assignedLicense: (() {
        ...
        return pulumi.Input.fromValue(
          LicenseResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      assignedLicenseImmutableId: pulumi.Input.fromValue(
        map['assignedLicenseImmutableId'] as String,
      ),
      ...
      esuKeys: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EsuKeyResponse>(
          map['esuKeys']!,
          (value) =>
