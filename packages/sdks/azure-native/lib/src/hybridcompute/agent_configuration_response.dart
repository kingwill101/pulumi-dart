...
class AgentConfigurationResponse {
    ...
    return <String, dynamic>{
      ...
      'extensionsAllowList':
          pulumi.Input.mapInputValue<
            List<ConfigurationExtensionResponse>,
  ...
  factory AgentConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return AgentConfigurationResponse(
      ...
      extensionsAllowList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConfigurationExtensionResponse>(
          map['extensionsAllowList']!,
          (value) => ConfigurationExtensionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      extensionsBlockList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConfigurationExtensionResponse>(
          map['extensionsBlockList']!,
          (value) => ConfigurationExtensionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      extensionsEnabled: pulumi.Input.fromValue(
        map['extensionsEnabled'] as String,
      ),
      guestConfigurationEnabled: pulumi.Input.fromValue(
        map['guestConfigurationEnabled'] as String,
      ),
      incomingConnectionsPorts: pulumi.Input.fromValue(
        (map['incomingConnectionsPorts'] as List).cast<String>(),
      ),
      proxyBypass: pulumi.Input.fromValue(
        (map['proxyBypass'] as List).cast<String>(),
      ),
