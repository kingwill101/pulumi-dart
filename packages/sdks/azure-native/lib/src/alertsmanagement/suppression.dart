...
class Suppression {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': ?status,
      'suppressionConfig':
          pulumi.Input.mapInputValue<SuppressionConfig, Map<String, dynamic>>(
            suppressionConfig,
            (value) => value.toMap(),
          ),
      'type': type,
  ...
  factory Suppression.fromMap(Map<String, dynamic> map) {
    return Suppression(
      ...
      suppressionConfig: pulumi.Input.fromValue(
        SuppressionConfig.fromMap(
          (map['suppressionConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
