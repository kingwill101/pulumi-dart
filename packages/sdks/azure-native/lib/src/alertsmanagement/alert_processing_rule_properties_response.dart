...
class AlertProcessingRulePropertiesResponse {
  ...
  factory AlertProcessingRulePropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AlertProcessingRulePropertiesResponse(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AddActionGroupsResponse>(
          map['actions']!,
          (value) => AddActionGroupsResponse.fromMap(
