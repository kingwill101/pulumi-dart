    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<AddActionGroups>,
            List<Map<String, dynamic>>
          >(
            actions,
            (value) =>
                pulumi.Input.encodeList<AddActionGroups, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AlertProcessingRuleProperties.fromMap(Map<String, dynamic> map) {
    return AlertProcessingRuleProperties(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AddActionGroups>(
          map['actions']!,
          (value) =>
              AddActionGroups.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      conditions: (() {
