...
class InvestigationMetadataResponse {
  ...
  factory InvestigationMetadataResponse.fromMap(Map<String, dynamic> map) {
    return InvestigationMetadataResponse(
      ...
      execution: pulumi.Input.fromValue(InvestigationExecutionResponse.fromMap((map['execution']! as Map).cast<String, dynamic>())),
      id: pulumi.Input.fromValue(map['id'] as String),
      runParameters: pulumi.Input.fromValue(RunParametersResponse.fromMap((map['runParameters']! as Map).cast<String, dynamic>())),
    );
  }
}
