...
class ListIssueAlertsResult {
  ...
  ListIssueAlertsResult({this.nextLink, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': ?nextLink,
      'value':
          pulumi.Input.encodeList<RelatedAlertResponse, Map<String, dynamic>>(
            value,
            (value) => value.toMap(),
          ),
    };
  ...
  factory ListIssueAlertsResult.fromMap(Map<String, dynamic> map) {
    return ListIssueAlertsResult(
      ...
      value: pulumi.Input.decodeList<RelatedAlertResponse>(
        map['value']!,
        (value) => RelatedAlertResponse.fromMap(
