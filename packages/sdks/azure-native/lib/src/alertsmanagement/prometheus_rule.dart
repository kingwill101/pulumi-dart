    ...
    return <String, dynamic>{
      'actions':
          ?pulumi.Input.mapOptionalInputValue<
            List<PrometheusRuleGroupAction>,
    ...
    return PrometheusRule(
      actions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrometheusRuleGroupAction>(
            guardedValue,
            (value) => PrometheusRuleGroupAction.fromMap(
      ...
      resolveConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PrometheusRuleResolveConfiguration.fromMap(
