    ...
    return <String, dynamic>{
      'actionGroups':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(actionGroups, (value) => value.toMap()),
      'alertRuleName': ?alertRuleName,
      'description': ?description,
      'detector': pulumi.Input.mapInputValue<Detector, Map<String, dynamic>>(
        detector,
        (value) => value.toMap(),
      ),
      'frequency': frequency,
  ...
  factory SmartDetectorAlertRuleArgs.fromMap(Map<String, dynamic> map) {
    return SmartDetectorAlertRuleArgs(
      actionGroups: pulumi.Input.fromValue(
        ActionGroupsInformation.fromMap(
      ...
      detector: pulumi.Input.fromValue(
        Detector.fromMap((map['detector']! as Map).cast<String, dynamic>()),
      ),
