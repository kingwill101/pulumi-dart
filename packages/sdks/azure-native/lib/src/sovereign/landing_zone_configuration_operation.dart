...
class LandingZoneConfigurationOperation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LandingZoneConfigurationResourcePropertiesResponse> properties;
  ...
  LandingZoneConfigurationOperation(
    ...
    properties = registerOutput<LandingZoneConfigurationResourcePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return LandingZoneConfigurationResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [LandingZoneConfigurationOperation] resource.
  LandingZoneConfigurationOperation.reference(String urn)
    : super(
        'azure-native:sovereign:LandingZoneConfigurationOperation',
