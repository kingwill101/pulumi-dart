...
class LandingZoneConfigurationResourcePropertiesResponse {
  ...
  const LandingZoneConfigurationResourcePropertiesResponse({
  ...
  factory LandingZoneConfigurationResourcePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LandingZoneConfigurationResourcePropertiesResponse(
      authoringStatus: pulumi.Input.fromValue(map['authoringStatus'] as String),
      ...
      customNamingConvention: (() { final guardedValue = map['customNamingConvention']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomNamingConventionResponse>(guardedValue, (value) => CustomNamingConventionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ddosProtectionCreationOption: pulumi.Input.fromValue(map['ddosProtectionCreationOption'] as String),
      decommissionedMgMetadata: (() { final guardedValue = map['decommissionedMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DecommissionedManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      landingZonesMgChildren: (() { final guardedValue = map['landingZonesMgChildren']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LandingZoneManagementGroupPropertiesResponse>(guardedValue, (value) => LandingZoneManagementGroupPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      landingZonesMgMetadata: (() { final guardedValue = map['landingZonesMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      managedIdentity: pulumi.Input.fromValue(ManagedIdentityPropertiesResponse.fromMap((map['managedIdentity']! as Map).cast<String, dynamic>())),
      ...
      platformConnectivityMgMetadata: (() { final guardedValue = map['platformConnectivityMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      platformIdentityMgMetadata: (() { final guardedValue = map['platformIdentityMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      platformManagementMgMetadata: (() { final guardedValue = map['platformManagementMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      platformMgChildren: (() { final guardedValue = map['platformMgChildren']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PlatformManagementGroupPropertiesResponse>(guardedValue, (value) => PlatformManagementGroupPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      platformMgMetadata: (() { final guardedValue = map['platformMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      sandboxMgMetadata: (() { final guardedValue = map['sandboxMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SandboxManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TagsResponse>(guardedValue, (value) => TagsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      topLevelMgMetadata: (() { final guardedValue = map['topLevelMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
