...
class LandingZoneConfigurationResourceProperties {
  ...
  factory LandingZoneConfigurationResourceProperties.fromMap(Map<String, dynamic> map) {
    return LandingZoneConfigurationResourceProperties(
      ...
      platformIdentityMgMetadata: (() { final guardedValue = map['platformIdentityMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      platformManagementMgMetadata: (() { final guardedValue = map['platformManagementMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      platformMgChildren: (() { final guardedValue = map['platformMgChildren']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PlatformManagementGroupProperties>(guardedValue, (value) => PlatformManagementGroupProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
      platformMgMetadata: (() { final guardedValue = map['platformMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sandboxMgMetadata: (() { final guardedValue = map['sandboxMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SandboxManagementGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Tags>(guardedValue, (value) => Tags.fromMap((value as Map).cast<String, dynamic>()))); })(),
      topLevelMgMetadata: (() { final guardedValue = map['topLevelMgMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
