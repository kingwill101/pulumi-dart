...
class LandingZoneConfigurationResourceProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customNamingConvention': ?pulumi.Input.mapOptionalInputValue<List<CustomNamingConvention>, List<Map<String, dynamic>>>(customNamingConvention, (value) => pulumi.Input.encodeList<CustomNamingConvention, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ddosProtectionCreationOption': ddosProtectionCreationOption,
      'decommissionedMgMetadata': ?pulumi.Input.mapOptionalInputValue<DecommissionedManagementGroupProperties, Map<String, dynamic>>(decommissionedMgMetadata, (value) => value.toMap()),
      ...
      'landingZonesMgChildren': ?pulumi.Input.mapOptionalInputValue<List<LandingZoneManagementGroupProperties>, List<Map<String, dynamic>>>(landingZonesMgChildren, (value) => pulumi.Input.encodeList<LandingZoneManagementGroupProperties, Map<String, dynamic>>(value, (value) => value.toMap())),
      'landingZonesMgMetadata': ?pulumi.Input.mapOptionalInputValue<ManagementGroupProperties, Map<String, dynamic>>(landingZonesMgMetadata, (value) => value.toMap()),
      'logAnalyticsWorkspaceCreationOption': logAnalyticsWorkspaceCreationOption,
      'logRetentionInDays': logRetentionInDays,
      'managedIdentity': pulumi.Input.mapInputValue<ManagedIdentityProperties, Map<String, dynamic>>(managedIdentity, (value) => value.toMap()),
      'namingConventionFormula': ?namingConventionFormula,
      'platformConnectivityMgMetadata': ?pulumi.Input.mapOptionalInputValue<ManagementGroupProperties, Map<String, dynamic>>(platformConnectivityMgMetadata, (value) => value.toMap()),
      'platformIdentityMgMetadata': ?pulumi.Input.mapOptionalInputValue<ManagementGroupProperties, Map<String, dynamic>>(platformIdentityMgMetadata, (value) => value.toMap()),
      'platformManagementMgMetadata': ?pulumi.Input.mapOptionalInputValue<ManagementGroupProperties, Map<String, dynamic>>(platformManagementMgMetadata, (value) => value.toMap()),
      'platformMgChildren': ?pulumi.Input.mapOptionalInputValue<List<PlatformManagementGroupProperties>, List<Map<String, dynamic>>>(platformMgChildren, (value) => pulumi.Input.encodeList<PlatformManagementGroupProperties, Map<String, dynamic>>(value, (value) => value.toMap())),
      'platformMgMetadata': ?pulumi.Input.mapOptionalInputValue<ManagementGroupProperties, Map<String, dynamic>>(platformMgMetadata, (value) => value.toMap()),
      'sandboxMgMetadata': ?pulumi.Input.mapOptionalInputValue<SandboxManagementGroupProperties, Map<String, dynamic>>(sandboxMgMetadata, (value) => value.toMap()),
      'tags': ?pulumi.Input.mapOptionalInputValue<List<Tags>, List<Map<String, dynamic>>>(tags, (value) => pulumi.Input.encodeList<Tags, Map<String, dynamic>>(value, (value) => value.toMap())),
      'topLevelMgMetadata': ?pulumi.Input.mapOptionalInputValue<ManagementGroupProperties, Map<String, dynamic>>(topLevelMgMetadata, (value) => value.toMap()),
    };
  }
  ...
  factory LandingZoneConfigurationResourceProperties.fromMap(Map<String, dynamic> map) {
    return LandingZoneConfigurationResourceProperties(
      ...
      customNamingConvention: map['customNamingConvention'] == null ? null : (pulumi.Input.decodeList<CustomNamingConvention>(map['customNamingConvention'], (value) => CustomNamingConvention.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ddosProtectionCreationOption: (map['ddosProtectionCreationOption'] as String).input(),
      decommissionedMgMetadata: map['decommissionedMgMetadata'] == null ? null : (DecommissionedManagementGroupProperties.fromMap((map['decommissionedMgMetadata'] as Map).cast<String, dynamic>())).input(),
      ...
      landingZonesMgChildren: map['landingZonesMgChildren'] == null ? null : (pulumi.Input.decodeList<LandingZoneManagementGroupProperties>(map['landingZonesMgChildren'], (value) => LandingZoneManagementGroupProperties.fromMap((value as Map).cast<String, dynamic>()))).input(),
      landingZonesMgMetadata: map['landingZonesMgMetadata'] == null ? null : (ManagementGroupProperties.fromMap((map['landingZonesMgMetadata'] as Map).cast<String, dynamic>())).input(),
      ...
      managedIdentity: (ManagedIdentityProperties.fromMap((map['managedIdentity'] as Map).cast<String, dynamic>())).input(),
      namingConventionFormula: map['namingConventionFormula'] == null ? null : (map['namingConventionFormula'] as String).input(),
      platformConnectivityMgMetadata: map['platformConnectivityMgMetadata'] == null ? null : (ManagementGroupProperties.fromMap((map['platformConnectivityMgMetadata'] as Map).cast<String, dynamic>())).input(),
      platformIdentityMgMetadata: map['platformIdentityMgMetadata'] == null ? null : (ManagementGroupProperties.fromMap((map['platformIdentityMgMetadata'] as Map).cast<String, dynamic>())).input(),
      platformManagementMgMetadata: map['platformManagementMgMetadata'] == null ? null : (ManagementGroupProperties.fromMap((map['platformManagementMgMetadata'] as Map).cast<String, dynamic>())).input(),
      platformMgChildren: map['platformMgChildren'] == null ? null : (pulumi.Input.decodeList<PlatformManagementGroupProperties>(map['platformMgChildren'], (value) => PlatformManagementGroupProperties.fromMap((value as Map).cast<String, dynamic>()))).input(),
      platformMgMetadata: map['platformMgMetadata'] == null ? null : (ManagementGroupProperties.fromMap((map['platformMgMetadata'] as Map).cast<String, dynamic>())).input(),
      sandboxMgMetadata: map['sandboxMgMetadata'] == null ? null : (SandboxManagementGroupProperties.fromMap((map['sandboxMgMetadata'] as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : (pulumi.Input.decodeList<Tags>(map['tags'], (value) => Tags.fromMap((value as Map).cast<String, dynamic>()))).input(),
      topLevelMgMetadata: map['topLevelMgMetadata'] == null ? null : (ManagementGroupProperties.fromMap((map['topLevelMgMetadata'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
