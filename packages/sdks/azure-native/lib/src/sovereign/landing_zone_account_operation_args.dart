...
class LandingZoneAccountOperationArgs {
  ...
  factory LandingZoneAccountOperationArgs.fromMap(Map<String, dynamic> map) {
    return LandingZoneAccountOperationArgs(
      ...
      landingZoneAccountName: (() { final guardedValue = map['landingZoneAccountName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LandingZoneAccountResourceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
