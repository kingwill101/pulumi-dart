...
class LandingZoneAccountOperationArgs {
  ...
  LandingZoneAccountOperationArgs({
    ...
    pulumi.Output<String>? landingZoneAccountName,
    pulumi.Output<String>? location,
    pulumi.Output<LandingZoneAccountResourceProperties>? properties,
  ...
  factory LandingZoneAccountOperationArgs.fromMap(Map<String, dynamic> map) {
    return LandingZoneAccountOperationArgs(
      ...
      landingZoneAccountName: map['landingZoneAccountName'] == null ? null : pulumi.Output.create<String>(map['landingZoneAccountName'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      properties: map['properties'] == null ? null : pulumi.Output.create<LandingZoneAccountResourceProperties>(LandingZoneAccountResourceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
