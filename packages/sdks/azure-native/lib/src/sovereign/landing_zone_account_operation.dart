...
class LandingZoneAccountOperation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LandingZoneAccountResourcePropertiesResponse> properties;
  ...
  LandingZoneAccountOperation(
    ...
    properties = registerOutput<LandingZoneAccountResourcePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return LandingZoneAccountResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [LandingZoneAccountOperation] resource.
  LandingZoneAccountOperation.reference(String urn)
    : super(
        'azure-native:sovereign:LandingZoneAccountOperation',
