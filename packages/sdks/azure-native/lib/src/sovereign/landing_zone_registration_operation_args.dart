...
class LandingZoneRegistrationOperationArgs {
  ...
  factory LandingZoneRegistrationOperationArgs.fromMap(Map<String, dynamic> map) {
    return LandingZoneRegistrationOperationArgs(
      ...
      landingZoneRegistrationName: (() { final guardedValue = map['landingZoneRegistrationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LandingZoneRegistrationResourceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
