...
class LandingZoneRegistrationOperation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LandingZoneRegistrationResourcePropertiesResponse> properties;
  ...
  LandingZoneRegistrationOperation(
    ...
    properties = registerOutput<LandingZoneRegistrationResourcePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return LandingZoneRegistrationResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [LandingZoneRegistrationOperation] resource.
  LandingZoneRegistrationOperation.reference(String urn)
    : super(
        'azure-native:sovereign:LandingZoneRegistrationOperation',
