...
class WatcherArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'datastore':
          ?pulumi.Input.mapOptionalInputValue<Datastore, Map<String, dynamic>>(
            datastore,
            (value) => value.toMap(),
          ),
    ...
    return WatcherArgs(
      datastore: (() {
        ...
        return pulumi.Input.fromValue(
          Datastore.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      defaultAlertRuleIdentityResourceId: (() {
        final guardedValue = map['defaultAlertRuleIdentityResourceId'];
        if (guardedValue == null) return null;
