...
class DomainArgs {
  ...
  DomainArgs({
    pulumi.Output<String>? authCode,
    pulumi.Output<bool>? autoRenew,
    required pulumi.Output<DomainPurchaseConsent> consent,
    required pulumi.Output<Contact> contactAdmin,
    required pulumi.Output<Contact> contactBilling,
    required pulumi.Output<Contact> contactRegistrant,
    required pulumi.Output<Contact> contactTech,
    pulumi.Output<DnsType>? dnsType,
    pulumi.Output<String>? dnsZoneId,
    pulumi.Output<String>? domainName,
    pulumi.Output<String>? kind,
    pulumi.Output<String>? location,
    pulumi.Output<bool>? privacy,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<DnsType>? targetDnsType,
  }) :
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      authCode: map['authCode'] == null ? null : pulumi.Output.create<String>(map['authCode'] as String),
      autoRenew: map['autoRenew'] == null ? null : pulumi.Output.create<bool>(map['autoRenew'] as bool),
      consent: pulumi.Output.create<DomainPurchaseConsent>(DomainPurchaseConsent.fromMap((map['consent'] as Map).cast<String, dynamic>())),
      contactAdmin: pulumi.Output.create<Contact>(Contact.fromMap((map['contactAdmin'] as Map).cast<String, dynamic>())),
      contactBilling: pulumi.Output.create<Contact>(Contact.fromMap((map['contactBilling'] as Map).cast<String, dynamic>())),
      contactRegistrant: pulumi.Output.create<Contact>(Contact.fromMap((map['contactRegistrant'] as Map).cast<String, dynamic>())),
      contactTech: pulumi.Output.create<Contact>(Contact.fromMap((map['contactTech'] as Map).cast<String, dynamic>())),
      dnsType: map['dnsType'] == null ? null : pulumi.Output.create<DnsType>(DnsType.fromValue(map['dnsType'] as String)),
      ...
      privacy: map['privacy'] == null ? null : pulumi.Output.create<bool>(map['privacy'] as bool),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      targetDnsType: map['targetDnsType'] == null ? null : pulumi.Output.create<DnsType>(DnsType.fromValue(map['targetDnsType'] as String)),
    );
  }
}
