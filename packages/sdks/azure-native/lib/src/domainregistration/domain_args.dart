...
class DomainArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dnsType': ?pulumi.Input.mapOptionalInputValue<DnsType, String>(dnsType, (value) => value.wireValue),
      'dnsZoneId': ?dnsZoneId,
      ...
      'tags': ?tags,
      'targetDnsType': ?pulumi.Input.mapOptionalInputValue<DnsType, String>(targetDnsType, (value) => value.wireValue),
    };
  }
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      consent: pulumi.Input.fromValue(DomainPurchaseConsent.fromMap((map['consent']! as Map).cast<String, dynamic>())),
      contactAdmin: pulumi.Input.fromValue(Contact.fromMap((map['contactAdmin']! as Map).cast<String, dynamic>())),
      contactBilling: pulumi.Input.fromValue(Contact.fromMap((map['contactBilling']! as Map).cast<String, dynamic>())),
      contactRegistrant: pulumi.Input.fromValue(Contact.fromMap((map['contactRegistrant']! as Map).cast<String, dynamic>())),
      contactTech: pulumi.Input.fromValue(Contact.fromMap((map['contactTech']! as Map).cast<String, dynamic>())),
      dnsType: (() { final guardedValue = map['dnsType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsType.fromValue(guardedValue as String)); })(),
      ...
      targetDnsType: (() { final guardedValue = map['targetDnsType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsType.fromValue(guardedValue as String)); })(),
    );
  }
}
