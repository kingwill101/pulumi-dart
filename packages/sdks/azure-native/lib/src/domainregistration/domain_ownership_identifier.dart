...
import 'domain_ownership_identifier_args.dart';
...
class DomainOwnershipIdentifier extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [DomainOwnershipIdentifier]. {@macro pulumi_domainregistration_domain_ownership_identifier_args_doc}
  ...
  /// Creates a typed reference to an existing [DomainOwnershipIdentifier] resource.
  DomainOwnershipIdentifier.reference(String urn)
    : super(
        'azure-native:domainregistration:DomainOwnershipIdentifier',
