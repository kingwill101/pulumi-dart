...
/// }
///
/// resource "azure-native_relationships_servicegroupmemberrelationship" "serviceGroupMemberRelationship" {
///   name = "sg1"
///   properties = {
...
class ServiceGroupMemberRelationship extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ServiceGroupMemberRelationshipPropertiesResponse> properties;
  ...
  ServiceGroupMemberRelationship(
    ...
    properties = registerOutput<ServiceGroupMemberRelationshipPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ServiceGroupMemberRelationshipPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ServiceGroupMemberRelationship] resource.
  ServiceGroupMemberRelationship.reference(String urn)
    : super(
        'azure-native:relationships:ServiceGroupMemberRelationship',
