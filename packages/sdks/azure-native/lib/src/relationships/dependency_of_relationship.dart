...
class DependencyOfRelationship extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DependencyOfRelationshipPropertiesResponse>
  properties;
  ...
  DependencyOfRelationship(
    ...
    properties = registerOutput<DependencyOfRelationshipPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return DependencyOfRelationshipPropertiesResponse.fromMap(
