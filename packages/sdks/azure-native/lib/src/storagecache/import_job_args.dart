...
class ImportJobArgs {
  ...
  ImportJobArgs({
    ...
    this.importPrefixes,
    this.location,
    pulumi.Input<int?>? maximumErrors,
    required this.resourceGroupName,
    this.tags,
  }) : conflictResolutionMode = conflictResolutionMode ?? pulumi.Input.fromValue('Fail'), maximumErrors = maximumErrors ?? pulumi.Input.fromValue(0);
  ...
  factory ImportJobArgs.fromMap(Map<String, dynamic> map) {
    return ImportJobArgs(
      ...
      maximumErrors: (() { final guardedValue = map['maximumErrors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
