...
class CacheSecuritySettingsResponse {
  ...
  CacheSecuritySettingsResponse({this.accessPolicies});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<NfsAccessPolicyResponse>,
    ...
    return CacheSecuritySettingsResponse(
      accessPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NfsAccessPolicyResponse>(
            guardedValue,
            (value) => NfsAccessPolicyResponse.fromMap(
