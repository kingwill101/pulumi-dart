...
class CacheUpgradeSettingsResponse {
  ...
  const CacheUpgradeSettingsResponse({
    this.scheduledTime,
  ...
  factory CacheUpgradeSettingsResponse.fromMap(Map<String, dynamic> map) {
    return CacheUpgradeSettingsResponse(
      scheduledTime: (() { final guardedValue = map['scheduledTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      upgradeScheduleEnabled: (() { final guardedValue = map['upgradeScheduleEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
