...
class GetAutoImportJobResult {
  ...
  factory GetAutoImportJobResult.fromMap(Map<String, dynamic> map) {
    return GetAutoImportJobResult(
      ...
      autoImportPrefixes: (() {
        final guardedValue = map['autoImportPrefixes'];
        if (guardedValue == null) return null;
        return (guardedValue as List).cast<String>();
      })(),
      azureApiVersion: map['azureApiVersion'] as String,
      blobSyncEvents: AutoImportJobResponseBlobSyncEvents.fromMap(
        (map['blobSyncEvents']! as Map).cast<String, dynamic>(),
      ),
      conflictResolutionMode: (() {
      ...
      enableDeletions: (() {
        final guardedValue = map['enableDeletions'];
        if (guardedValue == null) return null;
