...
class AmlFilesystem extends pulumi.CustomResource {
  ...
  AmlFilesystem(
    ...
    this.clientInfo = registerOutput<AmlFilesystemClientInfoResponse>('clientInfo');
    this.encryptionSettings = registerOutput<AmlFilesystemEncryptionSettingsResponse?>('encryptionSettings');
    this.filesystemSubnet = registerOutput<String>('filesystemSubnet');
    this.health = registerOutput<AmlFilesystemHealthResponse>('health');
    this.hsm = registerOutput<AmlFilesystemResponseHsm?>('hsm');
    this.identity = registerOutput<AmlFilesystemIdentityResponse?>('identity');
    this.location = registerOutput<String>('location');
    this.maintenanceWindow = registerOutput<AmlFilesystemResponseMaintenanceWindow>('maintenanceWindow');
    this.name = registerOutput<String>('name');
    this.provisioningState = registerOutput<String>('provisioningState');
    this.rootSquashSettings = registerOutput<AmlFilesystemRootSquashSettingsResponse?>('rootSquashSettings');
    this.sku = registerOutput<SkuNameResponse?>('sku');
    this.storageCapacityTiB = registerOutput<double>('storageCapacityTiB');
    this.systemData = registerOutput<SystemDataResponse>('systemData');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.throughputProvisionedMBps = registerOutput<int>('throughputProvisionedMBps');
