...
class AmlFilesystemResponseHsm {
  ...
  AmlFilesystemResponseHsm({required this.archiveStatus, this.settings});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'archiveStatus':
          pulumi.Input.mapInputValue<
            List<AmlFilesystemArchiveResponse>,
  ...
  factory AmlFilesystemResponseHsm.fromMap(Map<String, dynamic> map) {
    return AmlFilesystemResponseHsm(
      archiveStatus: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AmlFilesystemArchiveResponse>(
          map['archiveStatus']!,
          (value) => AmlFilesystemArchiveResponse.fromMap(
      ...
      settings: (() {
        ...
        return pulumi.Input.fromValue(
          AmlFilesystemHsmSettingsResponse.fromMap(
