...
class CacheUsernameDownloadSettings {
  ...
  final pulumi.Input<dynamic>? usernameSource;
  ...
  CacheUsernameDownloadSettings({
    ...
    this.userFileURI,
    pulumi.Input<dynamic>? usernameSource,
  ...
  factory CacheUsernameDownloadSettings.fromMap(Map<String, dynamic> map) {
    return CacheUsernameDownloadSettings(
      ...
      usernameSource: (() { final guardedValue = map['usernameSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
