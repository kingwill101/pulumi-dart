...
class NfsAccessPolicy {
  ...
  NfsAccessPolicy({required this.accessRules, required this.name});
    ...
    return <String, dynamic>{
      'accessRules':
          ...
          >(
            accessRules,
            (value) =>
                pulumi.Input.encodeList<NfsAccessRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory NfsAccessPolicy.fromMap(Map<String, dynamic> map) {
    return NfsAccessPolicy(
      accessRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NfsAccessRule>(
          map['accessRules']!,
          (value) =>
              NfsAccessRule.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
