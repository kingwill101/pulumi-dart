...
class CacheDirectorySettingsResponse {
  ...
  CacheDirectorySettingsResponse({this.activeDirectory, this.usernameDownload});
    ...
    return CacheDirectorySettingsResponse(
      activeDirectory: (() {
        ...
        return pulumi.Input.fromValue(
          CacheActiveDirectorySettingsResponse.fromMap(
      ...
      usernameDownload: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CacheUsernameDownloadSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
