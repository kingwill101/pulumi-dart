...
class AmlFilesystemArgs {
    ...
    return <String, dynamic>{
      ...
      'rootSquashSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(rootSquashSettings, (value) => value.toMap()),
  ...
  factory AmlFilesystemArgs.fromMap(Map<String, dynamic> map) {
    return AmlFilesystemArgs(
      amlFilesystemName: (() {
        final guardedValue = map['amlFilesystemName'];
      ...
      encryptionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          AmlFilesystemEncryptionSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      filesystemSubnet: pulumi.Input.fromValue(
        map['filesystemSubnet'] as String,
      ),
      hsm: (() {
        final guardedValue = map['hsm'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AmlFilesystemHsm.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      maintenanceWindow: pulumi.Input.fromValue(
        AmlFilesystemMaintenanceWindow.fromMap(
      ...
      rootSquashSettings: (() {
        final guardedValue = map['rootSquashSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AmlFilesystemRootSquashSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageCapacityTiB: pulumi.Input.fromValue(
        map['storageCapacityTiB'] as double,
      ),
      tags: (() {
