...
class AmlFilesystemHsmSettings {
  ...
  final List<String>? importPrefixesInitial;
  /// Resource ID of storage container used for logging events and errors.  Must be a separate container in the same storage account as the hydration and archive container. The resource provider must have permission to create SAS tokens on the storage account.
  final String loggingContainer;
  ...
  factory AmlFilesystemHsmSettings.fromMap(Map<String, dynamic> map) {
    return AmlFilesystemHsmSettings(
      ...
      importPrefix: map['importPrefix'] == null ? null : map['importPrefix'] as String,
      importPrefixesInitial: map['importPrefixesInitial'] == null ? null : (map['importPrefixesInitial'] as List).cast<String>(),
      loggingContainer: map['loggingContainer'] as String,
    );
  }
}
