...
class GetAutoExportJobResult {
  ...
  factory GetAutoExportJobResult.fromMap(Map<String, dynamic> map) {
    return GetAutoExportJobResult(
      adminStatus: (() {
        final guardedValue = map['adminStatus'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      autoExportPrefixes: (() {
        final guardedValue = map['autoExportPrefixes'];
        if (guardedValue == null) return null;
        return (guardedValue as List).cast<String>();
      })(),
      azureApiVersion: map['azureApiVersion'] as String,
      currentIterationFilesDiscovered:
          map['currentIterationFilesDiscovered'] as double,
      currentIterationFilesExported:
          map['currentIterationFilesExported'] as double,
      currentIterationFilesFailed: map['currentIterationFilesFailed'] as double,
      currentIterationMiBDiscovered:
          map['currentIterationMiBDiscovered'] as double,
      ...
      lastSuccessfulIterationCompletionTimeUTC:
          map['lastSuccessfulIterationCompletionTimeUTC'] as String,
