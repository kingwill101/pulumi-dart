...
class CacheIdentity {
  ...
  CacheIdentity({this.type, this.userAssignedIdentities});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'type': ?pulumi.Input.mapOptionalInputValue<CacheIdentityType, String>(
        type,
    ...
    return CacheIdentity(
      type: (() {
        ...
        return pulumi.Input.fromValue(
          CacheIdentityType.fromValue(guardedValue as String),
        );
      })(),
