...
class TargetDirectoryResultPropertiesResponse {
  ...
  factory TargetDirectoryResultPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return TargetDirectoryResultPropertiesResponse(
      destinationOwnerId: pulumi.Input.fromValue(
        map['destinationOwnerId'] as String,
      ),
      destinationTenantId: pulumi.Input.fromValue(
        map['destinationTenantId'] as String,
      ),
