...
class PutAliasRequestProperties {
  ...
  final pulumi.Input<dynamic>? workload;
  ...
  factory PutAliasRequestProperties.fromMap(Map<String, dynamic> map) {
    return PutAliasRequestProperties(
      ...
      workload: (() { final guardedValue = map['workload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
