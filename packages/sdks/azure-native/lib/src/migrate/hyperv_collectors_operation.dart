...
/// }
///
/// resource "azure-native_migrate_hypervcollectorsoperation" "hypervCollectorsOperation" {
///   agent_properties = {
///     id                 = "12f1d90f-b3fa-4926-8893-e56803a09af0"
...
class HypervCollectorsOperation extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [HypervCollectorsOperation] resource.
  HypervCollectorsOperation.reference(String urn)
    : super(
        'azure-native:migrate:HypervCollectorsOperation',
