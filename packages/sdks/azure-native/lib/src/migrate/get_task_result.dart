...
class GetTaskResult {
  ...
  final TaskPropertiesResponse? properties;
  ...
  factory GetTaskResult.fromMap(Map<String, dynamic> map) {
    return GetTaskResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return TaskPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
