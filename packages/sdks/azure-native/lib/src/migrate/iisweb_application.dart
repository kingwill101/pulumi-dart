...
class IISWebApplication {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualApplications':
          ?pulumi.Input.mapOptionalInputValue<
            List<IISVirtualApplicationDetails>,
            List<Map<String, dynamic>>
          >(
            virtualApplications,
            (value) =>
    ...
    return IISWebApplication(
      ...
      applications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IISApplicationDetails>(
            guardedValue,
            (value) => IISApplicationDetails.fromMap(
      ...
      iisWebServer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IISWebServer.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      limits: (() {
      ...
      virtualApplications: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IISVirtualApplicationDetails>(
            guardedValue,
            (value) => IISVirtualApplicationDetails.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
