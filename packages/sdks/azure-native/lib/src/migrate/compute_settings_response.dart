...
class ComputeSettingsResponse {
  ...
  final pulumi.Input<LinuxServerLicensingSettingsResponse>
  rhelLinuxServerLicensing;

  /// SQL Server licensing settings.
  final pulumi.Input<List<SqlServerLicensingSettingsResponse>>
  sqlServerLicensing;
  ...
  final pulumi.Input<VirtualizationSoftwareSettingsResponse>
  virtualizationSoftwareSettings;

  /// Windows Server licensing settings.
  final pulumi.Input<WindowsServerLicensingSettingsResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sqlServerLicensing':
          pulumi.Input.mapInputValue<
            List<SqlServerLicensingSettingsResponse>,
  ...
  factory ComputeSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ComputeSettingsResponse(
      ...
      rhelLinuxServerLicensing: pulumi.Input.fromValue(
        LinuxServerLicensingSettingsResponse.fromMap(
          (map['rhelLinuxServerLicensing']! as Map).cast<String, dynamic>(),
        ),
      ),
      sqlServerLicensing: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SqlServerLicensingSettingsResponse>(
          map['sqlServerLicensing']!,
          (value) => SqlServerLicensingSettingsResponse.fromMap(
      ...
      virtualizationSoftwareSettings: pulumi.Input.fromValue(
        VirtualizationSoftwareSettingsResponse.fromMap(
          (map['virtualizationSoftwareSettings']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      windowsServerLicensing: pulumi.Input.fromValue(
        WindowsServerLicensingSettingsResponse.fromMap(
