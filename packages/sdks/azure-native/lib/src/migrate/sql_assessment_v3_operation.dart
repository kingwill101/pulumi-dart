...
class SqlAssessmentV3Operation extends pulumi.CustomResource {
  ...
  SqlAssessmentV3Operation(
    ...
    properties = registerOutput<SqlAssessmentV3PropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SqlAssessmentV3PropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [SqlAssessmentV3Operation] resource.
  SqlAssessmentV3Operation.reference(String urn)
    : super(
        'azure-native:migrate:SqlAssessmentV3Operation',
