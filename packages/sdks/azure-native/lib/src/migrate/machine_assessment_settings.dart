...
class MachineAssessmentSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vmUptime':
          ?pulumi.Input.mapOptionalInputValue<VmUptime, Map<String, dynamic>>(
            vmUptime,
            (value) => value.toMap(),
          ),
    };
  ...
  factory MachineAssessmentSettings.fromMap(Map<String, dynamic> map) {
    return MachineAssessmentSettings(
      ...
      azureVmSecurityOptions: (() {
        final guardedValue = map['azureVmSecurityOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      billingSettings: (() {
      ...
      vmUptime: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VmUptime.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
