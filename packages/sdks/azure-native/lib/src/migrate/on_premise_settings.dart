...
class OnPremiseSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'computeSettings':
          pulumi.Input.mapInputValue<ComputeSettings, Map<String, dynamic>>(
            computeSettings,
            (value) => value.toMap(),
          ),
      'facilitySettings':
          pulumi.Input.mapInputValue<FacilitySettings, Map<String, dynamic>>(
            facilitySettings,
            (value) => value.toMap(),
          ),
      'laborSettings':
          pulumi.Input.mapInputValue<LaborSettings, Map<String, dynamic>>(
            laborSettings,
            (value) => value.toMap(),
          ),
      'managementSettings':
      ...
      'networkSettings':
          pulumi.Input.mapInputValue<NetworkSettings, Map<String, dynamic>>(
            networkSettings,
            (value) => value.toMap(),
          ),
      'securitySettings':
          pulumi.Input.mapInputValue<SecuritySettings, Map<String, dynamic>>(
            securitySettings,
            (value) => value.toMap(),
          ),
      'storageSettings':
          pulumi.Input.mapInputValue<StorageSettings, Map<String, dynamic>>(
            storageSettings,
            (value) => value.toMap(),
          ),
    };
