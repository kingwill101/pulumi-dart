...
class DiskEncryptionSetResourceSettings {
  ...
  /// Creates a new [DiskEncryptionSetResourceSettings].
  ...
  factory DiskEncryptionSetResourceSettings.fromMap(Map<String, dynamic> map) {
