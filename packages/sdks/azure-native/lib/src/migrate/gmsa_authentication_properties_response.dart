...
class GmsaAuthenticationPropertiesResponse {
  ...
  factory GmsaAuthenticationPropertiesResponse.fromMap(
    ...
    return GmsaAuthenticationPropertiesResponse(
      ...
      akvProperties: (() {
        ...
        return pulumi.Input.fromValue(
          KeyVaultSecretStorePropertiesResponse.fromMap(
      ...
      gmsaCredSpecName: pulumi.Input.fromValue(
        map['gmsaCredSpecName'] as String,
      ),
