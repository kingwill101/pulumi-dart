...
class WebAppAssessmentV2OperationArgs {
  ...
  WebAppAssessmentV2OperationArgs({
    pulumi.Output<AppSvcContainerSettings>? appSvcContainerSettings,
    pulumi.Output<AppSvcNativeSettings>? appSvcNativeSettings,
    ...
    pulumi.Output<DiscoveredEntityLightSummary>? discoveredEntityLightSummary,
  ...
  factory WebAppAssessmentV2OperationArgs.fromMap(Map<String, dynamic> map) {
    return WebAppAssessmentV2OperationArgs(
      appSvcContainerSettings: map['appSvcContainerSettings'] == null ? null : pulumi.Output.create<AppSvcContainerSettings>(AppSvcContainerSettings.fromMap((map['appSvcContainerSettings'] as Map).cast<String, dynamic>())),
      appSvcNativeSettings: map['appSvcNativeSettings'] == null ? null : pulumi.Output.create<AppSvcNativeSettings>(AppSvcNativeSettings.fromMap((map['appSvcNativeSettings'] as Map).cast<String, dynamic>())),
      ...
      discoveredEntityLightSummary: map['discoveredEntityLightSummary'] == null ? null : pulumi.Output.create<DiscoveredEntityLightSummary>(DiscoveredEntityLightSummary.fromMap((map['discoveredEntityLightSummary'] as Map).cast<String, dynamic>())),
