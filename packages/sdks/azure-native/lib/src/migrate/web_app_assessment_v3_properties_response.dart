...
class WebAppAssessmentV3PropertiesResponse {
  ...
  factory WebAppAssessmentV3PropertiesResponse.fromMap(Map<String, dynamic> map) {
    return WebAppAssessmentV3PropertiesResponse(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAppAssessmentSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
