...
class AzureArcManagementSettingsResponse {
  ...
  const AzureArcManagementSettingsResponse({
  ...
  factory AzureArcManagementSettingsResponse.fromMap(Map<String, dynamic> map) {
    return AzureArcManagementSettingsResponse(
      monitoringSettings: pulumi.Input.fromValue(AzureArcMonitoringSettingsResponse.fromMap((map['monitoringSettings']! as Map).cast<String, dynamic>())),
    );
  }
}
