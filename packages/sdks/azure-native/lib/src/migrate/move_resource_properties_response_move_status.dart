...
class MoveResourcePropertiesResponseMoveStatus {
  ...
  factory MoveResourcePropertiesResponseMoveStatus.fromMap(Map<String, dynamic> map) {
    return MoveResourcePropertiesResponseMoveStatus(
      errors: (() { final guardedValue = map['errors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MoveResourceErrorResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      jobStatus: (() { final guardedValue = map['jobStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
