...
/// }
///
/// resource "azure-native_migrate_sqlcollectoroperation" "sqlCollectorOperation" {
///   agent_properties = {
///     id = "630da710-4d44-41f7-a189-72fe3db5502b-agent"
///     spn_details = {
...
class SqlCollectorOperation extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [SqlCollectorOperation] resource.
  SqlCollectorOperation.reference(String urn)
    : super(
        'azure-native:migrate:SqlCollectorOperation',
