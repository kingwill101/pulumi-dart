...
class MoveResourceArgs {
  ...
  factory MoveResourceArgs.fromMap(Map<String, dynamic> map) {
    return MoveResourceArgs(
      ...
      moveResourceName: (() { final guardedValue = map['moveResourceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MoveResourceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
