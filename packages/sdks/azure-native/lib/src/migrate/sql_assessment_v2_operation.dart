...
class SqlAssessmentV2Operation extends pulumi.CustomResource {
  ...
  SqlAssessmentV2Operation(
    ...
    this.asyncCommitModeIntent = registerOutput<String?>('asyncCommitModeIntent');
    ...
    this.azureOfferCodeForVm = registerOutput<String?>('azureOfferCodeForVm');
    this.azureSecurityOfferingType = registerOutput<String?>('azureSecurityOfferingType');
    this.azureSqlDatabaseSettings = registerOutput<SqlDbSettingsResponse?>('azureSqlDatabaseSettings');
    this.azureSqlManagedInstanceSettings = registerOutput<SqlMiSettingsResponse?>('azureSqlManagedInstanceSettings');
    this.azureSqlVmSettings = registerOutput<SqlVmSettingsResponse?>('azureSqlVmSettings');
    ...
    this.disasterRecoveryLocation = registerOutput<String?>('disasterRecoveryLocation');
    ...
    this.enableHadrAssessment = registerOutput<bool?>('enableHadrAssessment');
    this.entityUptime = registerOutput<EntityUptimeResponse?>('entityUptime');
    this.environmentType = registerOutput<String?>('environmentType');
    this.groupType = registerOutput<String?>('groupType');
    this.isInternetAccessAvailable = registerOutput<bool?>('isInternetAccessAvailable');
    this.multiSubnetIntent = registerOutput<String?>('multiSubnetIntent');
    this.name = registerOutput<String>('name');
    this.optimizationLogic = registerOutput<String?>('optimizationLogic');
    this.osLicense = registerOutput<String?>('osLicense');
    ...
    this.reservedInstanceForVm = registerOutput<String?>('reservedInstanceForVm');
    ...
    this.sqlServerLicense = registerOutput<String?>('sqlServerLicense');
