...
class VirtualNetworkResourceSettings {
  ...
  factory VirtualNetworkResourceSettings.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkResourceSettings(
      ...
      subnets: (() { final guardedValue = map['subnets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubnetResourceSettings>(guardedValue, (value) => SubnetResourceSettings.fromMap((value as Map).cast<String, dynamic>()))); })(),
