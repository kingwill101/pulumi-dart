...
/// Result data returned by getSqlCollectorOperation.
class GetSqlCollectorOperationResult {
  ...
  /// Creates a new [GetSqlCollectorOperationResult].
  ...
  const GetSqlCollectorOperationResult({
  ...
  factory GetSqlCollectorOperationResult.fromMap(Map<String, dynamic> map) {
