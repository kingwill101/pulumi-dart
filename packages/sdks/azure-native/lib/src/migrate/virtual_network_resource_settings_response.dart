...
class VirtualNetworkResourceSettingsResponse {
  ...
  const VirtualNetworkResourceSettingsResponse({
    this.addressSpace,
    this.dnsServers,
  ...
  factory VirtualNetworkResourceSettingsResponse.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkResourceSettingsResponse(
      addressSpace: (() { final guardedValue = map['addressSpace']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      subnets: (() { final guardedValue = map['subnets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubnetResourceSettingsResponse>(guardedValue, (value) => SubnetResourceSettingsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
