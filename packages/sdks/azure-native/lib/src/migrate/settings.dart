...
class Settings {
  ...
  factory Settings.fromMap(Map<String, dynamic> map) {
    return Settings(
      azureArcSettings: (() { final guardedValue = map['azureArcSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureArcSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      azureSettings: pulumi.Input.fromValue(AzureSettings.fromMap((map['azureSettings']! as Map).cast<String, dynamic>())),
      onPremiseSettings: (() { final guardedValue = map['onPremiseSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnPremiseSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
