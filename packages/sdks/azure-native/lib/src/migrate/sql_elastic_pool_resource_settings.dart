...
class SqlElasticPoolResourceSettings {
  ...
  /// Creates a new [SqlElasticPoolResourceSettings].
  ...
  factory SqlElasticPoolResourceSettings.fromMap(Map<String, dynamic> map) {
    return SqlElasticPoolResourceSettings(
