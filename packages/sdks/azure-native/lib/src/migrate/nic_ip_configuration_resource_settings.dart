...
class NicIpConfigurationResourceSettings {
  ...
  factory NicIpConfigurationResourceSettings.fromMap(Map<String, dynamic> map) {
    return NicIpConfigurationResourceSettings(
      loadBalancerBackendAddressPools: (() { final guardedValue = map['loadBalancerBackendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LoadBalancerBackendAddressPoolReference>(guardedValue, (value) => LoadBalancerBackendAddressPoolReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      loadBalancerNatRules: (() { final guardedValue = map['loadBalancerNatRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LoadBalancerNatRuleReference>(guardedValue, (value) => LoadBalancerNatRuleReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      publicIp: (() { final guardedValue = map['publicIp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicIpReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subnet: (() { final guardedValue = map['subnet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
