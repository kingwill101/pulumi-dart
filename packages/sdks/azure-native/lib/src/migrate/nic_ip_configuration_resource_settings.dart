...
class NicIpConfigurationResourceSettings {
  ...
  final pulumi.Input<List<LoadBalancerBackendAddressPoolReference>>?
    ...
    return <String, dynamic>{
      'loadBalancerBackendAddressPools':
          ?pulumi.Input.mapOptionalInputValue<
            List<LoadBalancerBackendAddressPoolReference>,
      ...
      'loadBalancerNatRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<LoadBalancerNatRuleReference>,
            List<Map<String, dynamic>>
          >(
            loadBalancerNatRules,
            (value) =>
    ...
    return NicIpConfigurationResourceSettings(
      loadBalancerBackendAddressPools: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoadBalancerBackendAddressPoolReference>(
            guardedValue,
            (value) => LoadBalancerBackendAddressPoolReference.fromMap(
      ...
      loadBalancerNatRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoadBalancerNatRuleReference>(
            guardedValue,
            (value) => LoadBalancerNatRuleReference.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
