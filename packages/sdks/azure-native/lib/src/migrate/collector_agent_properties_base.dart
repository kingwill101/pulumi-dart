...
class CollectorAgentPropertiesBase {
  ...
  const CollectorAgentPropertiesBase({
    this.id,
  ...
  factory CollectorAgentPropertiesBase.fromMap(Map<String, dynamic> map) {
    return CollectorAgentPropertiesBase(
      ...
      spnDetails: (() { final guardedValue = map['spnDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CollectorAgentSpnPropertiesBase.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
