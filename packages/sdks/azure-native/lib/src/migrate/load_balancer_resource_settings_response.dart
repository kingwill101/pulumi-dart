...
class LoadBalancerResourceSettingsResponse {
  ...
  final pulumi.Input<List<LBBackendAddressPoolResourceSettingsResponse>>? backendAddressPools;
  /// Gets or sets the frontend IP configurations of the load balancer.
  final pulumi.Input<List<LBFrontendIPConfigurationResourceSettingsResponse>>? frontendIPConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backendAddressPools': ?pulumi.Input.mapOptionalInputValue<List<LBBackendAddressPoolResourceSettingsResponse>, List<Map<String, dynamic>>>(backendAddressPools, (value) => pulumi.Input.encodeList<LBBackendAddressPoolResourceSettingsResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'frontendIPConfigurations': ?pulumi.Input.mapOptionalInputValue<List<LBFrontendIPConfigurationResourceSettingsResponse>, List<Map<String, dynamic>>>(frontendIPConfigurations, (value) => pulumi.Input.encodeList<LBFrontendIPConfigurationResourceSettingsResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory LoadBalancerResourceSettingsResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerResourceSettingsResponse(
      backendAddressPools: (() { final guardedValue = map['backendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LBBackendAddressPoolResourceSettingsResponse>(guardedValue, (value) => LBBackendAddressPoolResourceSettingsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      frontendIPConfigurations: (() { final guardedValue = map['frontendIPConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LBFrontendIPConfigurationResourceSettingsResponse>(guardedValue, (value) => LBFrontendIPConfigurationResourceSettingsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
