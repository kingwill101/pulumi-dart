...
class LoadBalancerResourceSettingsResponse {
  ...
  final List<LBBackendAddressPoolResourceSettingsResponse>? backendAddressPools;
  /// Gets or sets the frontend IP configurations of the load balancer.
  final List<LBFrontendIPConfigurationResourceSettingsResponse>? frontendIPConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backendAddressPools': ?backendAddressPools == null ? null : pulumi.Input.encodeList<LBBackendAddressPoolResourceSettingsResponse, Map<String, dynamic>>(backendAddressPools!, (value) => value.toMap()),
      'frontendIPConfigurations': ?frontendIPConfigurations == null ? null : pulumi.Input.encodeList<LBFrontendIPConfigurationResourceSettingsResponse, Map<String, dynamic>>(frontendIPConfigurations!, (value) => value.toMap()),
  ...
  factory LoadBalancerResourceSettingsResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerResourceSettingsResponse(
      backendAddressPools: map['backendAddressPools'] == null ? null : pulumi.Input.decodeList<LBBackendAddressPoolResourceSettingsResponse>(map['backendAddressPools'], (value) => LBBackendAddressPoolResourceSettingsResponse.fromMap((value as Map).cast<String, dynamic>())),
      frontendIPConfigurations: map['frontendIPConfigurations'] == null ? null : pulumi.Input.decodeList<LBFrontendIPConfigurationResourceSettingsResponse>(map['frontendIPConfigurations'], (value) => LBFrontendIPConfigurationResourceSettingsResponse.fromMap((value as Map).cast<String, dynamic>())),
