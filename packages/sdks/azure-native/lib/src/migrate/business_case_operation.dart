...
/// }
///
/// resource "azure-native_migrate_businesscaseoperation" "businessCaseOperation" {
///   business_case_name  = "sample-business-case"
///   project_name        = "multipleto8617project"
///   resource_group_name = "rgopenapi"
///   settings = {
///     azure_arc_settings = {
///       azure_arc_state       = "Enabled"
...
///             "labor_cost_percentage": float(70),
///             "management_settings": {
///                 "monitoring_settings": {
///                     "alert_rules_count": 10,
///                     "logs_volume_in_gb": 0.5,
...
///         },
///         "azure_settings": {
///             "avs_labor_cost_percentage": float(0),
///             "business_case_type": azure_native.migrate.MigrationStrategy.OPTIMIZE_FOR_COST,
///             "comfort_factor": float(29),
///             "currency": azure_native.migrate.BusinessCaseCurrency.USD,
///             "discount_percentage": float(83),
///             "iaas_labor_cost_percentage": float(94),
///             "infrastructure_growth_rate": float(83),
///             "network_cost_percentage": float(40),
///             "paas_labor_cost_percentage": float(47),
///             "per_year_migration_completion_percentage": {
///                 "Year0": float(20),
///                 "Year1": float(30),
///                 "Year2": float(60),
...
///             "performance_data_end_time": "2023-11-08T07:10:07.764Z",
///             "performance_data_start_time": "2023-11-08T07:10:07.764Z",
///             "performance_utilization_percentile": float(4),
...
///         "on_premise_settings": {
///             "compute_settings": {
///                 "hyperthread_core_to_memory_ratio": float(12),
///                 "price": float(16),
///                 "rhel_linux_server_licensing": {
///                     "license_cost": float(9),
///                 },
///                 "sql_server_licensing": [{
///                     "license_cost": float(27),
///                     "software_assurance_cost": float(16),
///                     "version": azure_native.migrate.SqlServerLicenseType.ENTERPRISE,
///                 }],
///                 "suse_linux_server_licensing": {
///                     "license_cost": float(9),
///                 },
///                 "virtualization_software_settings": {
///                     "v_mware_cloud_foundation_license_cost": float(7),
///                 },
///                 "windows_server_licensing": {
///                     "license_cost": float(9),
///                     "licenses_per_core": 11,
///                     "software_assurance_cost": float(1),
///                 },
///             },
///             "facility_settings": {
///                 "facilities_cost_per_kwh": float(28),
///             },
///             "labor_settings": {
///                 "hourly_admin_cost": float(25),
///                 "physical_servers_per_admin": 6,
///                 "virtual_machines_per_admin": 24,
///             },
///             "management_settings": {
///                 "hyperv_virtualization_management_settings": {
///                     "license_and_support_list": [{
///                         "license_cost": float(4),
///                         "license_type": azure_native.migrate.HyperVLicenseType.STANDARD,
///                     }],
///                     "number_of_physical_cores_per_license": 2,
///                     "software_assurance_cost": float(11),
///                 },
///                 "other_management_costs_settings": {
///                     "data_protection_cost_per_server_per_year": float(18),
///                     "monitoring_cost_per_server_per_year": float(10),
///                     "patching_cost_per_server_per_year": float(18),
///                 },
///                 "third_party_management_settings": {
///                     "license_cost": float(23),
///                     "support_cost": float(9),
///                 },
///             },
///             "network_settings": {
///                 "hardware_software_cost_percentage": float(50),
///                 "maintenance_cost_percentage": float(48),
///             },
///             "security_settings": {
///                 "server_security_cost_per_server_per_year": float(14),
///                 "sql_server_security_cost_per_server_per_year": float(7),
///             },
///             "storage_settings": {
///                 "cost_per_gb_per_month": float(22),
///                 "maintainance_cost_percentage_to_acquisition_cost": float(1),
///             },
///         },
///     })
///
