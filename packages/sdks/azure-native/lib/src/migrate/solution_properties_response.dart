...
class SolutionPropertiesResponse {
  ...
  final SolutionDetailsResponse? details;
  ...
  final DatabasesSolutionSummaryResponse? summary;
  ...
  factory SolutionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SolutionPropertiesResponse(
      ...
      details: map['details'] == null ? null : SolutionDetailsResponse.fromMap((map['details'] as Map).cast<String, dynamic>()),
      goal: map['goal'] == null ? null : map['goal'] as String,
      purpose: map['purpose'] == null ? null : map['purpose'] as String,
      status: map['status'] == null ? null : map['status'] as String,
      summary: map['summary'] == null ? null : DatabasesSolutionSummaryResponse.fromMap((map['summary'] as Map).cast<String, dynamic>()),
