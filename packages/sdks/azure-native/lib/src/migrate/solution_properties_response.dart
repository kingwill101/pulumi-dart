...
class SolutionPropertiesResponse {
  ...
  factory SolutionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SolutionPropertiesResponse(
      ...
      details: (() { final guardedValue = map['details']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SolutionDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
