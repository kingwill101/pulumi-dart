...
class AvsAssessmentPropertiesV2 {
  ...
  factory AvsAssessmentPropertiesV2.fromMap(Map<String, dynamic> map) {
    return AvsAssessmentPropertiesV2(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AvsAssessmentSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
