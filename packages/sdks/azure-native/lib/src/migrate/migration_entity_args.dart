...
class MigrationEntityArgs {
  ...
  factory MigrationEntityArgs.fromMap(Map<String, dynamic> map) {
    return MigrationEntityArgs(
      migrationEntityName: (() { final guardedValue = map['migrationEntityName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      projectName: pulumi.Input.fromValue(map['projectName'] as String),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrationEntityProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
