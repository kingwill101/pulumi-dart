    ...
    return IISAKSWorkloadDeployment(
      authenticationProperties: (() {
        ...
        return pulumi.Input.fromValue(
          GmsaAuthenticationProperties.fromMap(
      ...
      buildContainerImages: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerImageProperties>(
            guardedValue,
            (value) => ContainerImageProperties.fromMap(
      ...
      clusterProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AKSDeploymentProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      containerImageProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerImageProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      deploymentSpec: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AKSDeploymentSpecification.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      monitoringProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppInsightMonitoringProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
