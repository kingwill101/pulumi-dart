...
class WorkloadDeploymentModelPropertiesResponse {
  ...
  factory WorkloadDeploymentModelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return WorkloadDeploymentModelPropertiesResponse(
      ...
      lastSuccessfulTestMigrateTime: pulumi.Input.fromValue(map['lastSuccessfulTestMigrateTime'] as String),
      migrationStatus: pulumi.Input.fromValue(map['migrationStatus'] as String),
      migrationStatusDescription: pulumi.Input.fromValue(map['migrationStatusDescription'] as String),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      status: pulumi.Input.fromValue(map['status'] as String),
      statusDescription: pulumi.Input.fromValue(map['statusDescription'] as String),
      ...
      testMigrationStatus: pulumi.Input.fromValue(map['testMigrationStatus'] as String),
      testMigrationStatusDescription: pulumi.Input.fromValue(map['testMigrationStatusDescription'] as String),
      workloadInstanceProperties: (() { final guardedValue = map['workloadInstanceProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadInstanceModelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
