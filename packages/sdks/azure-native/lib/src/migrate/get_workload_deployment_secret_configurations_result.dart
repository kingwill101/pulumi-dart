...
class GetWorkloadDeploymentSecretConfigurationsResult {
  ...
  factory GetWorkloadDeploymentSecretConfigurationsResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetWorkloadDeploymentSecretConfigurationsResult(
      id: map['id'] as String,
      name: map['name'] as String,
      properties: WorkloadDeploymentModelPropertiesResponse.fromMap(
        (map['properties']! as Map).cast<String, dynamic>(),
      ),
      systemData: WorkloadDeploymentModelResponseSystemData.fromMap(
