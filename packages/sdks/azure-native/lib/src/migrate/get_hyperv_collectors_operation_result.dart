...
/// Result data returned by getHypervCollectorsOperation.
class GetHypervCollectorsOperationResult {
  ...
  /// Creates a new [GetHypervCollectorsOperationResult].
  ...
  const GetHypervCollectorsOperationResult({
  ...
  factory GetHypervCollectorsOperationResult.fromMap(Map<String, dynamic> map) {
