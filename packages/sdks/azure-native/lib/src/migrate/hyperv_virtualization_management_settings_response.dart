...
class HypervVirtualizationManagementSettingsResponse {
  ...
  factory HypervVirtualizationManagementSettingsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return HypervVirtualizationManagementSettingsResponse(
      licenseAndSupportList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<HypervLicenseResponse>(
          map['licenseAndSupportList']!,
          (value) => HypervLicenseResponse.fromMap(
