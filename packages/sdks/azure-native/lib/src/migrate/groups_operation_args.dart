...
class GroupsOperationArgs {
  ...
  final pulumi.Input<List<dynamic>?>? supportedAssessmentTypes;
  ...
  factory GroupsOperationArgs.fromMap(Map<String, dynamic> map) {
    return GroupsOperationArgs(
      ...
      supportedAssessmentTypes: (() { final guardedValue = map['supportedAssessmentTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
    );
  }
}
