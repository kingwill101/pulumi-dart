...
class OnPremiseSettingsResponse {
  ...
  factory OnPremiseSettingsResponse.fromMap(Map<String, dynamic> map) {
    return OnPremiseSettingsResponse(
      computeSettings: pulumi.Input.fromValue(ComputeSettingsResponse.fromMap((map['computeSettings']! as Map).cast<String, dynamic>())),
      facilitySettings: pulumi.Input.fromValue(FacilitySettingsResponse.fromMap((map['facilitySettings']! as Map).cast<String, dynamic>())),
      laborSettings: pulumi.Input.fromValue(LaborSettingsResponse.fromMap((map['laborSettings']! as Map).cast<String, dynamic>())),
      managementSettings: (() { final guardedValue = map['managementSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagementSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      networkSettings: pulumi.Input.fromValue(NetworkSettingsResponse.fromMap((map['networkSettings']! as Map).cast<String, dynamic>())),
      securitySettings: pulumi.Input.fromValue(SecuritySettingsResponse.fromMap((map['securitySettings']! as Map).cast<String, dynamic>())),
      storageSettings: pulumi.Input.fromValue(StorageSettingsResponse.fromMap((map['storageSettings']! as Map).cast<String, dynamic>())),
    );
  }
}
