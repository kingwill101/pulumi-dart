...
class Binding {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cert': ?pulumi.Input.mapOptionalInputValue<Cert, Map<String, dynamic>>(
        cert,
        (value) => value.toMap(),
      ),
      'hostName': ?hostName,
    ...
    return Binding(
      cert: (() {
        ...
        return pulumi.Input.fromValue(
          Cert.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      hostName: (() {
      ...
      portMapping: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PortMapping.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      protocol: (() {
