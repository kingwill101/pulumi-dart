...
class IISWebApplicationResponse {
  ...
  final pulumi.Input<List<IISVirtualApplicationDetailsResponse>>?
  virtualApplications;
    ...
    return <String, dynamic>{
      ...
      'applications':
          ?pulumi.Input.mapOptionalInputValue<
            List<IISApplicationDetailsResponse>,
      ...
      'iisWebServer':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(iisWebServer, (value) => value.toMap()),
      'limits':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'virtualApplications':
          ?pulumi.Input.mapOptionalInputValue<
            List<IISVirtualApplicationDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            virtualApplications,
            (value) =>
    ...
    return IISWebApplicationResponse(
      ...
      applications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IISApplicationDetailsResponse>(
            guardedValue,
            (value) => IISApplicationDetailsResponse.fromMap(
      ...
      iisWebServer: (() {
        final guardedValue = map['iisWebServer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IISWebServerResponse.fromMap(
      ...
      virtualApplications: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IISVirtualApplicationDetailsResponse>(
            guardedValue,
            (value) => IISVirtualApplicationDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
