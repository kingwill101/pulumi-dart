...
/// Result data returned by getVmwareCollectorsOperation.
class GetVmwareCollectorsOperationResult {
  ...
  /// Creates a new [GetVmwareCollectorsOperationResult].
  ...
  const GetVmwareCollectorsOperationResult({
  ...
  factory GetVmwareCollectorsOperationResult.fromMap(Map<String, dynamic> map) {
