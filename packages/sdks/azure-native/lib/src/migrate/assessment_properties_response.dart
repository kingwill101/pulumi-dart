...
class AssessmentPropertiesResponse {
  ...
  factory AssessmentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AssessmentPropertiesResponse(
      ...
      monthlyBandwidthCost: pulumi.Input.fromValue((map['monthlyBandwidthCost'] as num).toDouble()),
      monthlyComputeCost: pulumi.Input.fromValue((map['monthlyComputeCost'] as num).toDouble()),
      monthlyPremiumStorageCost: pulumi.Input.fromValue((map['monthlyPremiumStorageCost'] as num).toDouble()),
      monthlyStandardSSDStorageCost: pulumi.Input.fromValue((map['monthlyStandardSSDStorageCost'] as num).toDouble()),
      monthlyStorageCost: pulumi.Input.fromValue((map['monthlyStorageCost'] as num).toDouble()),
