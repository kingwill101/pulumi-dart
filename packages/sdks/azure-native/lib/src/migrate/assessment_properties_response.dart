...
class AssessmentPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vmUptime':
          pulumi.Input.mapInputValue<VmUptimeResponse, Map<String, dynamic>>(
            vmUptime,
            (value) => value.toMap(),
          ),
    };
  ...
  factory AssessmentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AssessmentPropertiesResponse(
      ...
      eaSubscriptionId: pulumi.Input.fromValue(
        map['eaSubscriptionId'] as String,
      ),
      monthlyBandwidthCost: pulumi.Input.fromValue(
        map['monthlyBandwidthCost'] as double,
      ),
      monthlyComputeCost: pulumi.Input.fromValue(
        map['monthlyComputeCost'] as double,
      ),
      monthlyPremiumStorageCost: pulumi.Input.fromValue(
        map['monthlyPremiumStorageCost'] as double,
      ),
      monthlyStandardSSDStorageCost: pulumi.Input.fromValue(
        map['monthlyStandardSSDStorageCost'] as double,
      ),
      monthlyStorageCost: pulumi.Input.fromValue(
        map['monthlyStorageCost'] as double,
      ),
      ...
      perfDataStartTime: pulumi.Input.fromValue(
        map['perfDataStartTime'] as String,
      ),
      ...
      vmUptime: pulumi.Input.fromValue(
        VmUptimeResponse.fromMap(
          (map['vmUptime']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
