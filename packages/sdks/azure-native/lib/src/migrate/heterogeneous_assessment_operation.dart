...
class HeterogeneousAssessmentOperation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<HeterogeneousAssessmentPropertiesResponse>
  properties;
  ...
  HeterogeneousAssessmentOperation(
    ...
    properties = registerOutput<HeterogeneousAssessmentPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return HeterogeneousAssessmentPropertiesResponse.fromMap(
