...
/// }
///
/// resource "azure-native_migrate_machineassessmentsv2operation" "machineAssessmentsV2Operation" {
...
///       azure_vm_families            = ["Unknown"]
///       azure_vm_security_options    = ["TVM"]
///       billing_settings = {
...
class MachineAssessmentsV2Operation extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [MachineAssessmentsV2Operation] resource.
  MachineAssessmentsV2Operation.reference(String urn)
    : super(
        'azure-native:migrate:MachineAssessmentsV2Operation',
