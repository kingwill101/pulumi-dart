...
class MigrateAgentModelPropertiesResponse {
  ...
  final pulumi.Input<VMwareMigrateAgentModelCustomPropertiesResponse>?
  customProperties;
    ...
    return <String, dynamic>{
      'authenticationIdentity':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(authenticationIdentity, (value) => value.toMap()),
  ...
  factory MigrateAgentModelPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return MigrateAgentModelPropertiesResponse(
      authenticationIdentity: (() {
        final guardedValue = map['authenticationIdentity'];
      ...
      customProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VMwareMigrateAgentModelCustomPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
