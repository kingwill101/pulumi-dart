...
class WebAppAssessmentSettingsResponse {
  ...
  factory WebAppAssessmentSettingsResponse.fromMap(Map<String, dynamic> map) {
    return WebAppAssessmentSettingsResponse(
      appSvcContainerSettings: pulumi.Input.fromValue(AppSvcContainerSettingsResponse.fromMap((map['appSvcContainerSettings']! as Map).cast<String, dynamic>())),
      appSvcNativeSettings: pulumi.Input.fromValue(AppSvcNativeSettingsResponse.fromMap((map['appSvcNativeSettings']! as Map).cast<String, dynamic>())),
