...
class ImportCollectorArgs {
  ...
  factory ImportCollectorArgs.fromMap(Map<String, dynamic> map) {
    return ImportCollectorArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImportCollectorProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
