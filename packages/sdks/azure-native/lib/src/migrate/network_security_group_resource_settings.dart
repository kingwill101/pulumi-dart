...
class NetworkSecurityGroupResourceSettings {
    ...
    return <String, dynamic>{
      ...
      'securityRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<NsgSecurityRule>,
            List<Map<String, dynamic>>
          >(
            securityRules,
            (value) =>
                pulumi.Input.encodeList<NsgSecurityRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory NetworkSecurityGroupResourceSettings.fromMap(
    ...
    return NetworkSecurityGroupResourceSettings(
      ...
      securityRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NsgSecurityRule>(
            guardedValue,
            (value) =>
                NsgSecurityRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
