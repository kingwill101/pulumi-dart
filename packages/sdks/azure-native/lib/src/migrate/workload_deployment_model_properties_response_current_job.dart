...
class WorkloadDeploymentModelPropertiesResponseCurrentJob {
  ...
  /// Creates a new [WorkloadDeploymentModelPropertiesResponseCurrentJob].
  ...
  factory WorkloadDeploymentModelPropertiesResponseCurrentJob.fromMap(Map<String, dynamic> map) {
    return WorkloadDeploymentModelPropertiesResponseCurrentJob(
