...
class GmsaAuthenticationProperties {
  ...
  factory GmsaAuthenticationProperties.fromMap(Map<String, dynamic> map) {
    return GmsaAuthenticationProperties(
      ...
      akvProperties: (() { final guardedValue = map['akvProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyVaultSecretStoreProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
