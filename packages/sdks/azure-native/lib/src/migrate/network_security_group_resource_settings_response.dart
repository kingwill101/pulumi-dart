...
class NetworkSecurityGroupResourceSettingsResponse {
  ...
  factory NetworkSecurityGroupResourceSettingsResponse.fromMap(
    ...
    return NetworkSecurityGroupResourceSettingsResponse(
      ...
      securityRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NsgSecurityRuleResponse>(
            guardedValue,
            (value) => NsgSecurityRuleResponse.fromMap(
