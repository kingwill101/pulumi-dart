...
class Cert {
  ...
  Cert({this.certData, this.certNeeded, this.certProvided, this.secretStore});
  ...
  factory Cert.fromMap(Map<String, dynamic> map) {
    return Cert(
      certData: (() {
        final guardedValue = map['certData'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      certNeeded: (() {
        final guardedValue = map['certNeeded'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      certProvided: (() {
        final guardedValue = map['certProvided'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      secretStore: (() {
