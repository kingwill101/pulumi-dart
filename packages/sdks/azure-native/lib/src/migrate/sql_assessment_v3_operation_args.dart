...
class SqlAssessmentV3OperationArgs {
  ...
  const SqlAssessmentV3OperationArgs({
    this.assessmentName,
  ...
  factory SqlAssessmentV3OperationArgs.fromMap(Map<String, dynamic> map) {
    return SqlAssessmentV3OperationArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlAssessmentV3Properties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
