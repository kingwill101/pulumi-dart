...
/// }
///
/// resource "azure-native_migrate_privateendpointconnectioncontrollerprivateendpointconnection" "privateEndpointConnectionControllerPrivateEndpointConnection" {
...
class PrivateEndpointConnectionControllerPrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionControllerPrivateEndpointConnection] resource.
  PrivateEndpointConnectionControllerPrivateEndpointConnection.reference(String urn)
    : super(
        'azure-native:migrate:PrivateEndpointConnectionControllerPrivateEndpointConnection',
