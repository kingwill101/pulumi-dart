...
class MigrateAgentModelResponseSystemData {
  ...
  /// Creates a new [MigrateAgentModelResponseSystemData].
  ...
  const MigrateAgentModelResponseSystemData({
    this.createdAt,
    this.createdBy,
    this.createdByType,
    this.lastModifiedAt,
  ...
  factory MigrateAgentModelResponseSystemData.fromMap(Map<String, dynamic> map) {
    return MigrateAgentModelResponseSystemData(
