...
class IISAKSWorkloadDeploymentResponse {
  ...
  final pulumi.Input<GmsaAuthenticationPropertiesResponse>?
  ...
  final pulumi.Input<List<ContainerImagePropertiesResponse>>?
  ...
  final pulumi.Input<ContainerImagePropertiesResponse>?
  containerImageProperties;

  /// Gets or sets the deployment history.
  final pulumi.Input<List<DeployedResourcesPropertiesResponse>>
  deploymentHistory;
  ...
  final pulumi.Input<AppInsightMonitoringPropertiesResponse>?
    ...
    return <String, dynamic>{
      'authenticationProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(authenticationProperties, (value) => value.toMap()),
      'automationArtifactProperties':
          ?pulumi.Input.mapOptionalInputValue<
            AutomationArtifactResponse,
            Map<String, dynamic>
          >(automationArtifactProperties, (value) => value.toMap()),
      'bindings':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'buildContainerImages':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerImagePropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            buildContainerImages,
            (value) =>
      ...
      'clusterProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(clusterProperties, (value) => value.toMap()),
      'configurations':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'containerImageProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ContainerImagePropertiesResponse,
            Map<String, dynamic>
          >(containerImageProperties, (value) => value.toMap()),
      'deploymentHistory':
          pulumi.Input.mapInputValue<
            List<DeployedResourcesPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            deploymentHistory,
            (value) =>
      ...
      'deploymentSpec':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(deploymentSpec, (value) => value.toMap()),
      'directories':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'monitoringProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(monitoringProperties, (value) => value.toMap()),
      'requests':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceRequirementsResponse,
            Map<String, dynamic>
  ...
  factory IISAKSWorkloadDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return IISAKSWorkloadDeploymentResponse(
      authenticationProperties: (() {
        final guardedValue = map['authenticationProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GmsaAuthenticationPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      automationArtifactProperties: (() {
        final guardedValue = map['automationArtifactProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutomationArtifactResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      buildContainerImages: (() {
        final guardedValue = map['buildContainerImages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerImagePropertiesResponse>(
            guardedValue,
            (value) => ContainerImagePropertiesResponse.fromMap(
      ...
      clusterProperties: (() {
        final guardedValue = map['clusterProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AKSDeploymentPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      containerImageProperties: (() {
        final guardedValue = map['containerImageProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerImagePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      deploymentHistory: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeployedResourcesPropertiesResponse>(
          map['deploymentHistory']!,
          (value) => DeployedResourcesPropertiesResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      deploymentNamePrefix: (() {
        final guardedValue = map['deploymentNamePrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deploymentSpec: (() {
        final guardedValue = map['deploymentSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AKSDeploymentSpecificationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      monitoringProperties: (() {
        final guardedValue = map['monitoringProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppInsightMonitoringPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      targetPlatformIdentity: (() {
        final guardedValue = map['targetPlatformIdentity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
