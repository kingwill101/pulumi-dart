...
class WebAppAssessmentV3Properties {
  ...
  factory WebAppAssessmentV3Properties.fromMap(Map<String, dynamic> map) {
    return WebAppAssessmentV3Properties(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAppAssessmentSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
