...
class GetCompoundAssessmentOperationResult {
  ...
  factory GetCompoundAssessmentOperationResult.fromMap(Map<String, dynamic> map) {
    return GetCompoundAssessmentOperationResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return CompoundAssessmentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
