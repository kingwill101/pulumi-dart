...
class GetAvsAssessmentsOperationResult {
    ...
    return <String, dynamic>{
      ...
      'avsEstimatedExternalStorages':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(avsEstimatedExternalStorages, (value) => value.toMap()),
      'avsEstimatedNetworks':
          pulumi.Input.encodeList<
            AvsEstimatedNetworkResponse,
            Map<String, dynamic>
          >(avsEstimatedNetworks, (value) => value.toMap()),
      'avsEstimatedNodes':
          pulumi.Input.encodeList<
            AvsEstimatedNodeResponse,
            Map<String, dynamic>
          >(avsEstimatedNodes, (value) => value.toMap()),
  ...
  factory GetAvsAssessmentsOperationResult.fromMap(Map<String, dynamic> map) {
    return GetAvsAssessmentsOperationResult(
      ...
      avsEstimatedExternalStorages:
          pulumi.Input.decodeList<AvsEstimatedExternalStorageResponse>(
            map['avsEstimatedExternalStorages']!,
            (value) => AvsEstimatedExternalStorageResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      avsEstimatedNetworks:
          pulumi.Input.decodeList<AvsEstimatedNetworkResponse>(
            map['avsEstimatedNetworks']!,
            (value) => AvsEstimatedNetworkResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      avsEstimatedNodes: pulumi.Input.decodeList<AvsEstimatedNodeResponse>(
        map['avsEstimatedNodes']!,
        (value) => AvsEstimatedNodeResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
