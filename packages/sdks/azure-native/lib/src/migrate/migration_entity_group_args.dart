...
class MigrationEntityGroupArgs {
  ...
  const MigrationEntityGroupArgs({
  ...
  factory MigrationEntityGroupArgs.fromMap(Map<String, dynamic> map) {
    return MigrationEntityGroupArgs(
      migrationEntityGroupName: (() { final guardedValue = map['migrationEntityGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      projectName: pulumi.Input.fromValue(map['projectName'] as String),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MigrationEntityGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
