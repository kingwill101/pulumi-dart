...
class WorkloadInstanceModelResponseSystemData {
  ...
  /// Creates a new [WorkloadInstanceModelResponseSystemData].
  ...
  const WorkloadInstanceModelResponseSystemData({
    this.createdAt,
    this.createdBy,
    this.createdByType,
    this.lastModifiedAt,
  ...
  factory WorkloadInstanceModelResponseSystemData.fromMap(Map<String, dynamic> map) {
    return WorkloadInstanceModelResponseSystemData(
