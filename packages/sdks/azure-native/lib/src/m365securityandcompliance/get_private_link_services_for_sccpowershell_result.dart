...
/// Result data returned by getPrivateLinkServicesForSCCPowershell.
class GetPrivateLinkServicesForSCCPowershellResult {
  ...
  /// Creates a new [GetPrivateLinkServicesForSCCPowershellResult].
  ...
  factory GetPrivateLinkServicesForSCCPowershellResult.fromMap(Map<String, dynamic> map) {
