...
/// Result data returned by getPrivateLinkServicesForEDMUpload.
class GetPrivateLinkServicesForEDMUploadResult {
  ...
  /// Creates a new [GetPrivateLinkServicesForEDMUploadResult].
  ...
  factory GetPrivateLinkServicesForEDMUploadResult.fromMap(Map<String, dynamic> map) {
