...
/// }
///
/// resource "azure-native_m365securityandcompliance_privatelinkservicesforedmupload" "privateLinkServicesForEDMUpload" {
///   identity = {
///     type = "SystemAssigned"
///   }
///   kind     = "fhir-R4"
...
class PrivateLinkServicesForEDMUpload extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateLinkServicesForEDMUpload]. {@macro pulumi_m365securityandcompliance_private_link_services_for_edmupload_args_doc}
  ...
  /// Creates a typed reference to an existing [PrivateLinkServicesForEDMUpload] resource.
  PrivateLinkServicesForEDMUpload.reference(String urn)
    : super(
        'azure-native:m365securityandcompliance:PrivateLinkServicesForEDMUpload',
