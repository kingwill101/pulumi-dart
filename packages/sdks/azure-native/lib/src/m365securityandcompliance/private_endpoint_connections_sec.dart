...
/// }
///
/// resource "azure-native_m365securityandcompliance_privateendpointconnectionssec" "privateEndpointConnectionsSec" {
...
class PrivateEndpointConnectionsSec extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateEndpointConnectionsSec]. {@macro pulumi_m365securityandcompliance_private_endpoint_connections_sec_args_doc}
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionsSec] resource.
  PrivateEndpointConnectionsSec.reference(String urn)
    : super(
        'azure-native:m365securityandcompliance:PrivateEndpointConnectionsSec',
