...
/// }
///
/// resource "azure-native_m365securityandcompliance_privateendpointconnectionsforedm" "privateEndpointConnectionsForEDM" {
...
class PrivateEndpointConnectionsForEDM extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateEndpointConnectionsForEDM]. {@macro pulumi_m365securityandcompliance_private_endpoint_connections_for_edmargs_doc}
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionsForEDM] resource.
  PrivateEndpointConnectionsForEDM.reference(String urn)
    : super(
        'azure-native:m365securityandcompliance:PrivateEndpointConnectionsForEDM',
