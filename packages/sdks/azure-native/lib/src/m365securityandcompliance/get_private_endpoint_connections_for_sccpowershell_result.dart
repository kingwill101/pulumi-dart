...
/// Result data returned by getPrivateEndpointConnectionsForSCCPowershell.
class GetPrivateEndpointConnectionsForSCCPowershellResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionsForSCCPowershellResult].
  ...
  factory GetPrivateEndpointConnectionsForSCCPowershellResult.fromMap(Map<String, dynamic> map) {
