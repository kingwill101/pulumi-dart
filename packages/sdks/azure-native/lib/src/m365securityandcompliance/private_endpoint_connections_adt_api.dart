...
/// }
///
/// resource "azure-native_m365securityandcompliance_privateendpointconnectionsadtapi" "privateEndpointConnectionsAdtAPI" {
...
class PrivateEndpointConnectionsAdtAPI extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateEndpointConnectionsAdtAPI]. {@macro pulumi_m365securityandcompliance_private_endpoint_connections_adt_apiargs_doc}
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionsAdtAPI] resource.
  PrivateEndpointConnectionsAdtAPI.reference(String urn)
    : super(
        'azure-native:m365securityandcompliance:PrivateEndpointConnectionsAdtAPI',
