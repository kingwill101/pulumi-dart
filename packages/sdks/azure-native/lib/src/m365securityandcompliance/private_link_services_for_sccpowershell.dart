...
/// }
///
/// resource "azure-native_m365securityandcompliance_privatelinkservicesforsccpowershell" "privateLinkServicesForSCCPowershell" {
///   identity = {
///     type = "SystemAssigned"
///   }
///   kind     = "fhir-R4"
...
class PrivateLinkServicesForSCCPowershell extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateLinkServicesForSCCPowershell]. {@macro pulumi_m365securityandcompliance_private_link_services_for_sccpowershell_args_doc}
  ...
  /// Creates a typed reference to an existing [PrivateLinkServicesForSCCPowershell] resource.
  PrivateLinkServicesForSCCPowershell.reference(String urn)
    : super(
        'azure-native:m365securityandcompliance:PrivateLinkServicesForSCCPowershell',
