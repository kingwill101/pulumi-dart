...
/// Result data returned by getPrivateEndpointConnectionsAdtAPI.
class GetPrivateEndpointConnectionsAdtAPIResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionsAdtAPIResult].
  ...
  const GetPrivateEndpointConnectionsAdtAPIResult({
  ...
  factory GetPrivateEndpointConnectionsAdtAPIResult.fromMap(Map<String, dynamic> map) {
