...
/// Result data returned by getPrivateEndpointConnectionsComp.
class GetPrivateEndpointConnectionsCompResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionsCompResult].
  ...
  const GetPrivateEndpointConnectionsCompResult({
  ...
  factory GetPrivateEndpointConnectionsCompResult.fromMap(Map<String, dynamic> map) {
