...
class JobConfiguration {
  ...
  final pulumi.Input<JobConfigurationScheduleTriggerConfig>?
    ...
    return <String, dynamic>{
      ...
      'identitySettings':
          ...
          >(
            identitySettings,
            (value) =>
                pulumi.Input.encodeList<IdentitySettings, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return JobConfiguration(
      eventTriggerConfig: (() {
        ...
        return pulumi.Input.fromValue(
          JobConfigurationEventTriggerConfig.fromMap(
      ...
      identitySettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IdentitySettings>(
            guardedValue,
            (value) => IdentitySettings.fromMap(
      ...
      manualTriggerConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobConfigurationManualTriggerConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      registries: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegistryCredentials>(
            guardedValue,
            (value) => RegistryCredentials.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      scheduleTriggerConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobConfigurationScheduleTriggerConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
