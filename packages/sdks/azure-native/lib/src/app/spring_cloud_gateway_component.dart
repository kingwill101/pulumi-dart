...
class SpringCloudGatewayComponent {
  ...
  factory SpringCloudGatewayComponent.fromMap(Map<String, dynamic> map) {
    return SpringCloudGatewayComponent(
      ...
      springCloudGatewayRoutes: (() { final guardedValue = map['springCloudGatewayRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScgRoute>(guardedValue, (value) => ScgRoute.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
