    ...
    return <String, dynamic>{
      ...
      'customContainerTemplate':
          ?pulumi.Input.mapOptionalInputValue<
            CustomContainerTemplate,
            Map<String, dynamic>
          >(customContainerTemplate, (value) => value.toMap()),
      'dynamicPoolConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            DynamicPoolConfiguration,
            Map<String, dynamic>
          >(dynamicPoolConfiguration, (value) => value.toMap()),
      ...
      'scaleConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ScaleConfiguration,
            Map<String, dynamic>
          >(scaleConfiguration, (value) => value.toMap()),
      'secrets':
          ?pulumi.Input.mapOptionalInputValue<
            List<SessionPoolSecret>,
            List<Map<String, dynamic>>
          >(
            secrets,
            (value) =>
      ...
      'sessionNetworkConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            SessionNetworkConfiguration,
            Map<String, dynamic>
          >(sessionNetworkConfiguration, (value) => value.toMap()),
    ...
    return ContainerAppsSessionPoolArgs(
      ...
      customContainerTemplate: (() {
        ...
        return pulumi.Input.fromValue(
          CustomContainerTemplate.fromMap(
      ...
      dynamicPoolConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DynamicPoolConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      managedIdentitySettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagedIdentitySetting>(
            guardedValue,
            (value) => ManagedIdentitySetting.fromMap(
      ...
      secrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SessionPoolSecret>(
            guardedValue,
            (value) => SessionPoolSecret.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sessionNetworkConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SessionNetworkConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sessionPoolName: (() {
        final guardedValue = map['sessionPoolName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
