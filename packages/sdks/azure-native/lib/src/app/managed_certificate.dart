...
/// }
///
/// resource "azure-native_app_managedcertificate" "managedCertificate" {
...
class ManagedCertificate extends pulumi.CustomResource {
  ...
  ManagedCertificate(
    ...
    properties = registerOutput<ManagedCertificateResponseProperties>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ManagedCertificateResponseProperties.fromMap((guardedValue as Map).cast<String, dynamic>()); });
