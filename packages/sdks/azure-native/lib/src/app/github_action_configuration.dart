...
class GithubActionConfiguration {
  ...
  factory GithubActionConfiguration.fromMap(Map<String, dynamic> map) {
    return GithubActionConfiguration(
      azureCredentials: (() { final guardedValue = map['azureCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      buildEnvironmentVariables: (() { final guardedValue = map['buildEnvironmentVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnvironmentVariable>(guardedValue, (value) => EnvironmentVariable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      githubPersonalAccessToken: (() { final guardedValue = map['githubPersonalAccessToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      registryInfo: (() { final guardedValue = map['registryInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
