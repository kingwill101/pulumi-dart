...
class DaprResponse {
  ...
  factory DaprResponse.fromMap(Map<String, dynamic> map) {
    return DaprResponse(
      appHealth: (() {
        final guardedValue = map['appHealth'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DaprResponseAppHealth.fromMap(
      ...
      enableApiLogging: (() {
        final guardedValue = map['enableApiLogging'];
        if (guardedValue == null) return null;
      ...
      httpMaxRequestSize: (() {
        final guardedValue = map['httpMaxRequestSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      httpReadBufferSize: (() {
        final guardedValue = map['httpReadBufferSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      logLevel: (() {
