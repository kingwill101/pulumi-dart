...
class DiskEncryptionConfiguration {
  ...
  final pulumi.Input<DiskEncryptionConfigurationKeyVaultConfiguration>?
  ...
  DiskEncryptionConfiguration({this.keyVaultConfiguration});
    ...
    return DiskEncryptionConfiguration(
      keyVaultConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          DiskEncryptionConfigurationKeyVaultConfiguration.fromMap(
