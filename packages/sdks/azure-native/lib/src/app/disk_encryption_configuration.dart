...
class DiskEncryptionConfiguration {
  ...
  factory DiskEncryptionConfiguration.fromMap(Map<String, dynamic> map) {
    return DiskEncryptionConfiguration(
      keyVaultConfiguration: (() { final guardedValue = map['keyVaultConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskEncryptionConfigurationKeyVaultConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
