...
class ContainerAppResponsePatchingConfiguration {
  ...
  ContainerAppResponsePatchingConfiguration({this.patchingMode});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'patchingMode': ?patchingMode};
  }

  factory ContainerAppResponsePatchingConfiguration.fromMap(
