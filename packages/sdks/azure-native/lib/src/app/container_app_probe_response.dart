...
class ContainerAppProbeResponse {
  ...
  const ContainerAppProbeResponse({
  ...
  factory ContainerAppProbeResponse.fromMap(Map<String, dynamic> map) {
    return ContainerAppProbeResponse(
      ...
      httpGet: (() { final guardedValue = map['httpGet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerAppProbeResponseHttpGet.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      tcpSocket: (() { final guardedValue = map['tcpSocket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerAppProbeResponseTcpSocket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
