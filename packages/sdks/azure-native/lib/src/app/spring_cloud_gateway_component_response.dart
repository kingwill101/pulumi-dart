...
class SpringCloudGatewayComponentResponse {
  ...
  factory SpringCloudGatewayComponentResponse.fromMap(Map<String, dynamic> map) {
    return SpringCloudGatewayComponentResponse(
      ...
      springCloudGatewayRoutes: (() { final guardedValue = map['springCloudGatewayRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScgRouteResponse>(guardedValue, (value) => ScgRouteResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
