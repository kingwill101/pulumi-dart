...
class ContainerResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'probes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerAppProbeResponse>,
            List<Map<String, dynamic>>
          >(
            probes,
            (value) =>
    ...
    return ContainerResponse(
      ...
      env: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentVarResponse>(
            guardedValue,
            (value) => EnvironmentVarResponse.fromMap(
      ...
      probes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerAppProbeResponse>(
            guardedValue,
            (value) => ContainerAppProbeResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      resources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerResourcesResponse.fromMap(
