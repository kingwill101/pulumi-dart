...
class BuildConfigurationResponse {
  ...
  factory BuildConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return BuildConfigurationResponse(
      ...
      preBuildSteps: (() { final guardedValue = map['preBuildSteps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PreBuildStepResponse>(guardedValue, (value) => PreBuildStepResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
