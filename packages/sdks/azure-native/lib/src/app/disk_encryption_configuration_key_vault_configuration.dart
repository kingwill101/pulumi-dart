...
class DiskEncryptionConfigurationKeyVaultConfiguration {
  ...
  DiskEncryptionConfigurationKeyVaultConfiguration({this.auth, this.keyUrl});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auth':
          ?pulumi.Input.mapOptionalInputValue<
            DiskEncryptionConfigurationAuth,
            Map<String, dynamic>
  ...
  factory DiskEncryptionConfigurationKeyVaultConfiguration.fromMap(
    ...
    return DiskEncryptionConfigurationKeyVaultConfiguration(
      auth: (() {
        ...
        return pulumi.Input.fromValue(
          DiskEncryptionConfigurationAuth.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      keyUrl: (() {
        final guardedValue = map['keyUrl'];
        if (guardedValue == null) return null;
