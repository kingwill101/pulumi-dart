...
class GlobalValidation {
  ...
  final UnauthenticatedClientActionV2? unauthenticatedClientAction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'unauthenticatedClientAction': ?unauthenticatedClientAction == null ? null : unauthenticatedClientAction!.value,
    };
  }
  ...
  factory GlobalValidation.fromMap(Map<String, dynamic> map) {
    return GlobalValidation(
      ...
      unauthenticatedClientAction: map['unauthenticatedClientAction'] == null ? null : UnauthenticatedClientActionV2.fromValue(map['unauthenticatedClientAction'] as String),
    );
  }
}
