...
class SpringCloudEurekaComponent {
  ...
  const SpringCloudEurekaComponent({
  ...
  factory SpringCloudEurekaComponent.fromMap(Map<String, dynamic> map) {
    return SpringCloudEurekaComponent(
      ...
      configurations: (() { final guardedValue = map['configurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JavaComponentConfigurationProperty>(guardedValue, (value) => JavaComponentConfigurationProperty.fromMap((value as Map).cast<String, dynamic>()))); })(),
      scale: (() { final guardedValue = map['scale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JavaComponentPropertiesScale.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceBinds: (() { final guardedValue = map['serviceBinds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JavaComponentServiceBind>(guardedValue, (value) => JavaComponentServiceBind.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
