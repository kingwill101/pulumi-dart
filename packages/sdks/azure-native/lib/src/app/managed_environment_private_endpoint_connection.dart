...
/// }
///
/// resource "azure-native_app_managedenvironmentprivateendpointconnection" "managedEnvironmentPrivateEndpointConnection" {
...
/// ```
class ManagedEnvironmentPrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ManagedEnvironmentPrivateEndpointConnection] resource.
  ManagedEnvironmentPrivateEndpointConnection.reference(String urn)
    : super(
        'azure-native:app:ManagedEnvironmentPrivateEndpointConnection',
