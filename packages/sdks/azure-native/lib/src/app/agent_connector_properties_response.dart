...
class AgentConnectorPropertiesResponse {
  ...
  /// Creates a new [AgentConnectorPropertiesResponse].
  ...
  /// [source] Source of the data connector - "Agent" when directly stored in agent, "AgentSpace" when inherited
  const AgentConnectorPropertiesResponse({
  ...
  factory AgentConnectorPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AgentConnectorPropertiesResponse(
