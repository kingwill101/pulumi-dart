  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipSecurityRestrictions':
          ?pulumi.Input.mapOptionalInputValue<
            List<IpSecurityRestrictionRule>,
            List<Map<String, dynamic>>
          >(
            ipSecurityRestrictions,
            (value) =>
      ...
      'traffic':
          ...
          >(
            traffic,
            (value) =>
                pulumi.Input.encodeList<TrafficWeight, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return Ingress(
      additionalPortMappings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngressPortMapping>(
            guardedValue,
            (value) => IngressPortMapping.fromMap(
      ...
      ipSecurityRestrictions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpSecurityRestrictionRule>(
            guardedValue,
            (value) => IpSecurityRestrictionRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      traffic: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrafficWeight>(
            guardedValue,
            (value) =>
                TrafficWeight.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      transport: (() {
