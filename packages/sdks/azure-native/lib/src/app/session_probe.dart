...
class SessionProbe {
  ...
  factory SessionProbe.fromMap(Map<String, dynamic> map) {
    return SessionProbe(
      ...
      httpGet: (() { final guardedValue = map['httpGet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SessionProbeHttpGet.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      tcpSocket: (() { final guardedValue = map['tcpSocket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SessionProbeTcpSocket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
