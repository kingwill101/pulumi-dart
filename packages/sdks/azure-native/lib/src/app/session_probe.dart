...
class SessionProbe {
  ...
  final SessionProbeHttpGet? httpGet;
  ...
  final SessionProbeTcpSocket? tcpSocket;
  ...
  factory SessionProbe.fromMap(Map<String, dynamic> map) {
    return SessionProbe(
      ...
      httpGet: map['httpGet'] == null ? null : SessionProbeHttpGet.fromMap((map['httpGet'] as Map).cast<String, dynamic>()),
      ...
      tcpSocket: map['tcpSocket'] == null ? null : SessionProbeTcpSocket.fromMap((map['tcpSocket'] as Map).cast<String, dynamic>()),
