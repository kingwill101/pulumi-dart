...
class Configuration {
  ...
  factory Configuration.fromMap(Map<String, dynamic> map) {
    return Configuration(
      ...
      dapr: map['dapr'] == null ? null : Dapr.fromMap((map['dapr'] as Map).cast<String, dynamic>()),
      ...
      ingress: map['ingress'] == null ? null : Ingress.fromMap((map['ingress'] as Map).cast<String, dynamic>()),
      ...
      runtime: map['runtime'] == null ? null : Runtime.fromMap((map['runtime'] as Map).cast<String, dynamic>()),
      ...
      service: map['service'] == null ? null : Service.fromMap((map['service'] as Map).cast<String, dynamic>()),
