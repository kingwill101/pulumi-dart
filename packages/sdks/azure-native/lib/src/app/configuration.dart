...
class Configuration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dapr': ?pulumi.Input.mapOptionalInputValue<Dapr, Map<String, dynamic>>(
        dapr,
        (value) => value.toMap(),
      ),
      'identitySettings':
      ...
      'ingress':
          ?pulumi.Input.mapOptionalInputValue<Ingress, Map<String, dynamic>>(
            ingress,
            (value) => value.toMap(),
          ),
      ...
      'runtime':
          ?pulumi.Input.mapOptionalInputValue<Runtime, Map<String, dynamic>>(
            runtime,
            (value) => value.toMap(),
          ),
      'secrets':
      ...
      'service':
          ?pulumi.Input.mapOptionalInputValue<Service, Map<String, dynamic>>(
            service,
            (value) => value.toMap(),
          ),
    ...
    return Configuration(
      ...
      dapr: (() {
        ...
        return pulumi.Input.fromValue(
          Dapr.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      identitySettings: (() {
      ...
      ingress: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Ingress.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      runtime: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Runtime.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      secrets: (() {
      ...
      service: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Service.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      targetLabel: (() {
