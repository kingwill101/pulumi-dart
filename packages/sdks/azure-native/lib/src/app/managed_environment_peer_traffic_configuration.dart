...
class ManagedEnvironmentPeerTrafficConfiguration {
  ...
  ManagedEnvironmentPeerTrafficConfiguration({this.encryption});
  ...
  factory ManagedEnvironmentPeerTrafficConfiguration.fromMap(
    ...
    return ManagedEnvironmentPeerTrafficConfiguration(
      encryption: (() {
        ...
        return pulumi.Input.fromValue(
          ManagedEnvironmentEncryption.fromMap(
