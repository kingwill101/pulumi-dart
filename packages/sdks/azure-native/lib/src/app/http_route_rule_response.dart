...
class HttpRouteRuleResponse {
  ...
  HttpRouteRuleResponse({this.description, this.routes, this.targets});
    ...
    return HttpRouteRuleResponse(
      ...
      routes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpRouteResponse>(
            guardedValue,
            (value) => HttpRouteResponse.fromMap(
      ...
      targets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpRouteTargetResponse>(
            guardedValue,
            (value) => HttpRouteTargetResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
