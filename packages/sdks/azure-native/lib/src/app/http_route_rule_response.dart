...
class HttpRouteRuleResponse {
  ...
  factory HttpRouteRuleResponse.fromMap(Map<String, dynamic> map) {
    return HttpRouteRuleResponse(
      ...
      routes: (() { final guardedValue = map['routes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteResponse>(guardedValue, (value) => HttpRouteResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      targets: (() { final guardedValue = map['targets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HttpRouteTargetResponse>(guardedValue, (value) => HttpRouteTargetResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
