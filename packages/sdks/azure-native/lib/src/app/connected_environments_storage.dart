...
/// }
///
/// resource "azure-native_app_connectedenvironmentsstorage" "connectedEnvironmentsStorage" {
...
class ConnectedEnvironmentsStorage extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ConnectedEnvironmentsStorage] resource.
  ConnectedEnvironmentsStorage.reference(String urn)
    : super(
        'azure-native:app:ConnectedEnvironmentsStorage',
