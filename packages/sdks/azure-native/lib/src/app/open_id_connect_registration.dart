...
class OpenIdConnectRegistration {
  ...
  factory OpenIdConnectRegistration.fromMap(Map<String, dynamic> map) {
    return OpenIdConnectRegistration(
      clientCredential: (() { final guardedValue = map['clientCredential']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OpenIdConnectClientCredential.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
