...
class ConnectedEnvironmentStorageProperties {
  ...
  ConnectedEnvironmentStorageProperties({this.azureFile, this.smb});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'smb':
          ?pulumi.Input.mapOptionalInputValue<SmbStorage, Map<String, dynamic>>(
            smb,
            (value) => value.toMap(),
          ),
    };
  ...
  factory ConnectedEnvironmentStorageProperties.fromMap(
    ...
    return ConnectedEnvironmentStorageProperties(
      ...
      smb: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SmbStorage.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
