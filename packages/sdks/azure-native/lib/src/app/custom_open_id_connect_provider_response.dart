...
class CustomOpenIdConnectProviderResponse {
  ...
  factory CustomOpenIdConnectProviderResponse.fromMap(Map<String, dynamic> map) {
    return CustomOpenIdConnectProviderResponse(
      ...
      login: (() { final guardedValue = map['login']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OpenIdConnectLoginResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      registration: (() { final guardedValue = map['registration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OpenIdConnectRegistrationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
