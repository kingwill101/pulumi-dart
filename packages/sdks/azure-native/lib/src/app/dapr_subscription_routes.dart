...
class DaprSubscriptionRoutes {
  ...
  DaprSubscriptionRoutes({this.default_, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<DaprSubscriptionRouteRule>,
    ...
    return DaprSubscriptionRoutes(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DaprSubscriptionRouteRule>(
            guardedValue,
            (value) => DaprSubscriptionRouteRule.fromMap(
