...
class IncidentManagementConfigurationResponse {
  ...
  /// Creates a new [IncidentManagementConfigurationResponse].
  ...
  const IncidentManagementConfigurationResponse({
    this.connectionKey,
    this.connectionName,
    this.connectionUrl,
    this.oboUser,
  ...
  factory IncidentManagementConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return IncidentManagementConfigurationResponse(
