...
class JobConfigurationResponse {
  ...
  final pulumi.Input<JobConfigurationResponseEventTriggerConfig>?
  eventTriggerConfig;
  ...
  final pulumi.Input<JobConfigurationResponseManualTriggerConfig>?
  manualTriggerConfig;
  ...
  final pulumi.Input<JobConfigurationResponseScheduleTriggerConfig>?
    ...
    return JobConfigurationResponse(
      eventTriggerConfig: (() {
        ...
        return pulumi.Input.fromValue(
          JobConfigurationResponseEventTriggerConfig.fromMap(
      ...
      manualTriggerConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobConfigurationResponseManualTriggerConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      scheduleTriggerConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobConfigurationResponseScheduleTriggerConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
