...
class AzureStaticWebAppsResponse {
  ...
  const AzureStaticWebAppsResponse({
    this.enabled,
    this.registration,
  });
  ...
  factory AzureStaticWebAppsResponse.fromMap(Map<String, dynamic> map) {
    return AzureStaticWebAppsResponse(
      ...
      registration: (() { final guardedValue = map['registration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureStaticWebAppsRegistrationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
