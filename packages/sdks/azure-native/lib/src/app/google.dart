...
class Google {
  ...
  Google({this.enabled, this.login, this.registration, this.validation});
    ...
    return Google(
      ...
      login: (() {
        ...
        return pulumi.Input.fromValue(
          LoginScopes.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      registration: (() {
      ...
      validation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AllowedAudiencesValidation.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
