...
class DaprComponentResiliencyPolicyArgs {
  ...
  factory DaprComponentResiliencyPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DaprComponentResiliencyPolicyArgs(
      ...
      inboundPolicy: (() { final guardedValue = map['inboundPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DaprComponentResiliencyPolicyConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      outboundPolicy: (() { final guardedValue = map['outboundPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DaprComponentResiliencyPolicyConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
