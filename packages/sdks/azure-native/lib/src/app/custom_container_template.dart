...
class CustomContainerTemplate {
  ...
  factory CustomContainerTemplate.fromMap(Map<String, dynamic> map) {
    return CustomContainerTemplate(
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SessionContainer>(guardedValue, (value) => SessionContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ingress: (() { final guardedValue = map['ingress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SessionIngress.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      registryCredentials: (() { final guardedValue = map['registryCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SessionRegistryCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
