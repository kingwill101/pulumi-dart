...
class ErrorEntityResponse {
  ...
  factory ErrorEntityResponse.fromMap(Map<String, dynamic> map) {
    return ErrorEntityResponse(
      ...
      details: (() { final guardedValue = map['details']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ErrorEntityResponse>(guardedValue, (value) => ErrorEntityResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      extendedCode: (() { final guardedValue = map['extendedCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      innerErrors: (() { final guardedValue = map['innerErrors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ErrorEntityResponse>(guardedValue, (value) => ErrorEntityResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      message: (() { final guardedValue = map['message']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      messageTemplate: (() { final guardedValue = map['messageTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
