...
class GetAppResiliencyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpConnectionPool': ?httpConnectionPool == null ? null : httpConnectionPool!.toMap(),
      'httpRetryPolicy': ?httpRetryPolicy == null ? null : httpRetryPolicy!.toMap(),
      'id': id,
      'name': name,
      'systemData': systemData.toMap(),
      'tcpConnectionPool': ?tcpConnectionPool == null ? null : tcpConnectionPool!.toMap(),
      'tcpRetryPolicy': ?tcpRetryPolicy == null ? null : tcpRetryPolicy!.toMap(),
