...
class DiskEncryptionConfigurationResponse {
  ...
  factory DiskEncryptionConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return DiskEncryptionConfigurationResponse(
      keyVaultConfiguration: (() { final guardedValue = map['keyVaultConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskEncryptionConfigurationResponseKeyVaultConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
