...
class DiskEncryptionConfigurationResponse {
  ...
  final pulumi.Input<DiskEncryptionConfigurationResponseKeyVaultConfiguration>?
  ...
  DiskEncryptionConfigurationResponse({this.keyVaultConfiguration});
    ...
    return <String, dynamic>{
      'keyVaultConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(keyVaultConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory DiskEncryptionConfigurationResponse.fromMap(
    ...
    return DiskEncryptionConfigurationResponse(
      keyVaultConfiguration: (() {
        final guardedValue = map['keyVaultConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiskEncryptionConfigurationResponseKeyVaultConfiguration.fromMap(
