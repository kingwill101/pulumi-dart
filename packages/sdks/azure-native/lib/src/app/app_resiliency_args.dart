    ...
    return <String, dynamic>{
      ...
      'httpConnectionPool':
          ?pulumi.Input.mapOptionalInputValue<
            HttpConnectionPool,
            Map<String, dynamic>
          >(httpConnectionPool, (value) => value.toMap()),
      'httpRetryPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            HttpRetryPolicy,
            Map<String, dynamic>
      ...
      'tcpConnectionPool':
          ?pulumi.Input.mapOptionalInputValue<
            TcpConnectionPool,
            Map<String, dynamic>
          >(tcpConnectionPool, (value) => value.toMap()),
      'tcpRetryPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            TcpRetryPolicy,
            Map<String, dynamic>
          >(tcpRetryPolicy, (value) => value.toMap()),
      'timeoutPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            TimeoutPolicy,
            Map<String, dynamic>
  ...
  factory AppResiliencyArgs.fromMap(Map<String, dynamic> map) {
    return AppResiliencyArgs(
      ...
      tcpRetryPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TcpRetryPolicy.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      timeoutPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TimeoutPolicy.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
