...
/// }
///
/// resource "azure-native_app_connectedenvironmentscertificate" "connectedEnvironmentsCertificate" {
...
class ConnectedEnvironmentsCertificate extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ConnectedEnvironmentsCertificate] resource.
  ConnectedEnvironmentsCertificate.reference(String urn)
    : super(
        'azure-native:app:ConnectedEnvironmentsCertificate',
