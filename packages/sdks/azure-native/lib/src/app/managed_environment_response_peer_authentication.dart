...
class ManagedEnvironmentResponsePeerAuthentication {
  ...
  const ManagedEnvironmentResponsePeerAuthentication({
    this.mtls,
  });
  ...
  factory ManagedEnvironmentResponsePeerAuthentication.fromMap(Map<String, dynamic> map) {
    return ManagedEnvironmentResponsePeerAuthentication(
      mtls: (() { final guardedValue = map['mtls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MtlsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
