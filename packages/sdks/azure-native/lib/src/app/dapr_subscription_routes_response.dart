...
class DaprSubscriptionRoutesResponse {
  ...
  DaprSubscriptionRoutesResponse({this.default_, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<DaprSubscriptionRouteRuleResponse>,
    ...
    return DaprSubscriptionRoutesResponse(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DaprSubscriptionRouteRuleResponse>(
            guardedValue,
            (value) => DaprSubscriptionRouteRuleResponse.fromMap(
