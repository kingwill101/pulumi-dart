...
class DefaultAuthorizationPolicyResponse {
  ...
  final AllowedPrincipalsResponse? allowedPrincipals;
  ...
  factory DefaultAuthorizationPolicyResponse.fromMap(Map<String, dynamic> map) {
    return DefaultAuthorizationPolicyResponse(
      ...
      allowedPrincipals: map['allowedPrincipals'] == null ? null : AllowedPrincipalsResponse.fromMap((map['allowedPrincipals'] as Map).cast<String, dynamic>()),
    );
  }
}
