...
class AppleResponse {
  ...
  factory AppleResponse.fromMap(Map<String, dynamic> map) {
    return AppleResponse(
      ...
      registration: (() { final guardedValue = map['registration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppleRegistrationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
