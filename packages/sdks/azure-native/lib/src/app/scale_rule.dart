...
class ScaleRule {
  ...
  ScaleRule({this.azureQueue, this.custom, this.http, this.name, this.tcp});
    ...
    return ScaleRule(
      azureQueue: (() {
        ...
        return pulumi.Input.fromValue(
          QueueScaleRule.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      custom: (() {
      ...
      http: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpScaleRule.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      tcp: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TcpScaleRule.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
