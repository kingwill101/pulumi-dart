...
class BuildArgs {
  ...
  final pulumi.Input<ContainerRegistryWithCustomImage>?
    ...
    return <String, dynamic>{
      ...
      'destinationContainerRegistry':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(destinationContainerRegistry, (value) => value.toMap()),
    ...
    return BuildArgs(
      ...
      configuration: (() {
        ...
        return pulumi.Input.fromValue(
          BuildConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      destinationContainerRegistry: (() {
        final guardedValue = map['destinationContainerRegistry'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerRegistryWithCustomImage.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
