...
class ManagedEnvironmentsStorage extends pulumi.CustomResource {
  ...
  ManagedEnvironmentsStorage(
    ...
    properties = registerOutput<ManagedEnvironmentStorageResponseProperties>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ManagedEnvironmentStorageResponseProperties.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ManagedEnvironmentsStorage] resource.
  ManagedEnvironmentsStorage.reference(String urn)
    : super(
        'azure-native:app:ManagedEnvironmentsStorage',
