...
class IngressResponse {
  ...
  factory IngressResponse.fromMap(Map<String, dynamic> map) {
    return IngressResponse(
      additionalPortMappings: (() { final guardedValue = map['additionalPortMappings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IngressPortMappingResponse>(guardedValue, (value) => IngressPortMappingResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
