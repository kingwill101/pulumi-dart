...
class RuntimeJavaAgent {
  ...
  factory RuntimeJavaAgent.fromMap(Map<String, dynamic> map) {
    return RuntimeJavaAgent(
      ...
      logging: (() { final guardedValue = map['logging']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuntimeLogging.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
