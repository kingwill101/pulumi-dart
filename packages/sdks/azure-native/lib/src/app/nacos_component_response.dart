...
class NacosComponentResponse {
  ...
  /// Creates a new [NacosComponentResponse].
  ...
  factory NacosComponentResponse.fromMap(Map<String, dynamic> map) {
    return NacosComponentResponse(
