...
class GetManagedEnvironmentResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'appInsightsConfiguration': ?appInsightsConfiguration == null ? null : appInsightsConfiguration!.toMap(),
      'appLogsConfiguration': ?appLogsConfiguration == null ? null : appLogsConfiguration!.toMap(),
      ...
      'daprConfiguration': ?daprConfiguration == null ? null : daprConfiguration!.toMap(),
      ...
      'ingressConfiguration': ?ingressConfiguration == null ? null : ingressConfiguration!.toMap(),
      'kedaConfiguration': ?kedaConfiguration == null ? null : kedaConfiguration!.toMap(),
      'kind': ?kind,
      'location': location,
      'name': name,
      'openTelemetryConfiguration': ?openTelemetryConfiguration == null ? null : openTelemetryConfiguration!.toMap(),
      'peerAuthentication': ?peerAuthentication == null ? null : peerAuthentication!.toMap(),
      'peerTrafficConfiguration': ?peerTrafficConfiguration == null ? null : peerTrafficConfiguration!.toMap(),
      ...
      'workloadProfiles': ?workloadProfiles == null ? null : pulumi.Input.encodeList<WorkloadProfileResponse, Map<String, dynamic>>(workloadProfiles!, (value) => value.toMap()),
  ...
  factory GetManagedEnvironmentResult.fromMap(Map<String, dynamic> map) {
    return GetManagedEnvironmentResult(
      appInsightsConfiguration: map['appInsightsConfiguration'] == null ? null : AppInsightsConfigurationResponse.fromMap((map['appInsightsConfiguration']! as Map).cast<String, dynamic>()),
      ...
      daprConfiguration: map['daprConfiguration'] == null ? null : DaprConfigurationResponse.fromMap((map['daprConfiguration']! as Map).cast<String, dynamic>()),
      ...
      ingressConfiguration: map['ingressConfiguration'] == null ? null : IngressConfigurationResponse.fromMap((map['ingressConfiguration']! as Map).cast<String, dynamic>()),
      kedaConfiguration: map['kedaConfiguration'] == null ? null : KedaConfigurationResponse.fromMap((map['kedaConfiguration']! as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind']! as String,
      location: map['location'] as String,
      name: map['name'] as String,
      openTelemetryConfiguration: map['openTelemetryConfiguration'] == null ? null : OpenTelemetryConfigurationResponse.fromMap((map['openTelemetryConfiguration']! as Map).cast<String, dynamic>()),
      peerAuthentication: map['peerAuthentication'] == null ? null : ManagedEnvironmentResponsePeerAuthentication.fromMap((map['peerAuthentication']! as Map).cast<String, dynamic>()),
      peerTrafficConfiguration: map['peerTrafficConfiguration'] == null ? null : ManagedEnvironmentResponsePeerTrafficConfiguration.fromMap((map['peerTrafficConfiguration']! as Map).cast<String, dynamic>()),
      ...
      workloadProfiles: map['workloadProfiles'] == null ? null : pulumi.Input.decodeList<WorkloadProfileResponse>(map['workloadProfiles']!, (value) => WorkloadProfileResponse.fromMap((value as Map).cast<String, dynamic>())),
