...
class GetManagedEnvironmentResult {
  ...
  final ManagedEnvironmentResponsePeerTrafficConfiguration?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workloadProfiles': ?(() {
        final guardedValue = workloadProfiles;
  ...
  factory GetManagedEnvironmentResult.fromMap(Map<String, dynamic> map) {
    return GetManagedEnvironmentResult(
      ...
      daprConfiguration: (() {
        final guardedValue = map['daprConfiguration'];
        if (guardedValue == null) return null;
      ...
      kedaConfiguration: (() {
        final guardedValue = map['kedaConfiguration'];
        if (guardedValue == null) return null;
      ...
      workloadProfiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<WorkloadProfileResponse>(
          guardedValue,
          (value) => WorkloadProfileResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
