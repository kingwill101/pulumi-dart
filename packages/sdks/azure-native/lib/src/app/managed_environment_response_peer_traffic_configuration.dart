...
class ManagedEnvironmentResponsePeerTrafficConfiguration {
  ...
  const ManagedEnvironmentResponsePeerTrafficConfiguration({
    this.encryption,
  });
  ...
  factory ManagedEnvironmentResponsePeerTrafficConfiguration.fromMap(Map<String, dynamic> map) {
    return ManagedEnvironmentResponsePeerTrafficConfiguration(
      encryption: (() { final guardedValue = map['encryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedEnvironmentResponseEncryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
