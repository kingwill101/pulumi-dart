...
class HttpRouteRule {
  ...
  HttpRouteRule({this.description, this.routes, this.targets});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routes':
          ...
          >(
            routes,
            (value) => pulumi.Input.encodeList<HttpRoute, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'targets':
          ?pulumi.Input.mapOptionalInputValue<
            List<HttpRouteTarget>,
            List<Map<String, dynamic>>
          >(
            targets,
            (value) =>
                pulumi.Input.encodeList<HttpRouteTarget, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return HttpRouteRule(
      ...
      routes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpRoute>(
            guardedValue,
            (value) =>
                HttpRoute.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      targets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpRouteTarget>(
            guardedValue,
            (value) =>
                HttpRouteTarget.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
