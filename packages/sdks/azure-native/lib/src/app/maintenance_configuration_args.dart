...
class MaintenanceConfigurationArgs {
  ...
  factory MaintenanceConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceConfigurationArgs(
      ...
      scheduledEntries: pulumi.Input.fromValue(pulumi.Input.decodeList<ScheduledEntry>(map['scheduledEntries']!, (value) => ScheduledEntry.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
