...
class ManagedEnvironmentArgs {
  ...
  factory ManagedEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return ManagedEnvironmentArgs(
      appInsightsConfiguration: (() { final guardedValue = map['appInsightsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppInsightsConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      infrastructureResourceGroup: (() { final guardedValue = map['infrastructureResourceGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ingressConfiguration: (() { final guardedValue = map['ingressConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IngressConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      workloadProfiles: (() { final guardedValue = map['workloadProfiles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkloadProfile>(guardedValue, (value) => WorkloadProfile.fromMap((value as Map).cast<String, dynamic>()))); })(),
