...
class GetAgentResult {
  ...
  final AgentPropertiesResponse? properties;
  ...
  factory GetAgentResult.fromMap(Map<String, dynamic> map) {
    return GetAgentResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return AgentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
