...
class AccountArgs {
  ...
  AccountArgs({
    ...
    pulumi.Output<AccountResourceProperties>? properties,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      properties = pulumi.Input.asOptionalInput<AccountResourceProperties>(properties),
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<AccountResourceProperties>(AccountResourceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
