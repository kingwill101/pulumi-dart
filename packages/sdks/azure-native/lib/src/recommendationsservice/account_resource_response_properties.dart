...
class AccountResourceResponseProperties {
  ...
  final pulumi.Input<List<EndpointAuthenticationResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpointAuthentications':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointAuthenticationResponse>,
            List<Map<String, dynamic>>
          >(
            endpointAuthentications,
            (value) =>
  ...
  factory AccountResourceResponseProperties.fromMap(Map<String, dynamic> map) {
    return AccountResourceResponseProperties(
      ...
      endpointAuthentications: (() {
        final guardedValue = map['endpointAuthentications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointAuthenticationResponse>(
            guardedValue,
            (value) => EndpointAuthenticationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      reportsConnectionString: (() {
        final guardedValue = map['reportsConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
