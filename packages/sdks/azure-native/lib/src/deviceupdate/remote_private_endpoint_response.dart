...
class RemotePrivateEndpointResponse {
  ...
  final pulumi.Input<List<PrivateLinkServiceProxyResponse>>?
    ...
    return <String, dynamic>{
      'connectionDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConnectionDetailsResponse>,
      ...
      'privateLinkServiceProxies':
          ?pulumi.Input.mapOptionalInputValue<
            List<PrivateLinkServiceProxyResponse>,
            List<Map<String, dynamic>>
          >(
            privateLinkServiceProxies,
            (value) =>
    ...
    return RemotePrivateEndpointResponse(
      connectionDetails: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConnectionDetailsResponse>(
            guardedValue,
            (value) => ConnectionDetailsResponse.fromMap(
      ...
      privateLinkServiceProxies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateLinkServiceProxyResponse>(
            guardedValue,
            (value) => PrivateLinkServiceProxyResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
