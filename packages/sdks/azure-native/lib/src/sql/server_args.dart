...
class ServerArgs {
  ...
  final pulumi.Input<dynamic>? isIPv6Enabled;
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      ...
      isIPv6Enabled: (() { final guardedValue = map['isIPv6Enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
