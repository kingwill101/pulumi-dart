...
class JobStepArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<JobStepAction, Map<String, dynamic>>(
        action,
        (value) => value.toMap(),
      ),
      ...
      'executionOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(executionOptions, (value) => value.toMap()),
  ...
  factory JobStepArgs.fromMap(Map<String, dynamic> map) {
    return JobStepArgs(
      action: pulumi.Input.fromValue(
        JobStepAction.fromMap((map['action']! as Map).cast<String, dynamic>()),
      ),
      credential: (() {
      ...
      executionOptions: (() {
        ...
        return pulumi.Input.fromValue(
          JobStepExecutionOptions.fromMap(
      ...
      output: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobStepOutput.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      stepName: (() {
        final guardedValue = map['stepName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
