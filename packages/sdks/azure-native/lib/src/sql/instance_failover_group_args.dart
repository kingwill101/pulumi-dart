...
class InstanceFailoverGroupArgs {
  ...
  factory InstanceFailoverGroupArgs.fromMap(Map<String, dynamic> map) {
    return InstanceFailoverGroupArgs(
      ...
      managedInstancePairs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ManagedInstancePairInfo>(
          map['managedInstancePairs']!,
          (value) => ManagedInstancePairInfo.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      partnerRegions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PartnerRegionInfo>(
          map['partnerRegions']!,
          (value) =>
              PartnerRegionInfo.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      readOnlyEndpoint: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceFailoverGroupReadOnlyEndpoint.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      readWriteEndpoint: pulumi.Input.fromValue(
        InstanceFailoverGroupReadWriteEndpoint.fromMap(
