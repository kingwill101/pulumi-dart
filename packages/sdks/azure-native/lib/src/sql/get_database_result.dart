...
class GetDatabaseResult {
  ...
  const GetDatabaseResult({
    ...
    this.currentServiceObjectiveName,
    this.currentSku,
    this.databaseId,
    ...
    this.requestedServiceObjectiveName,
    this.resumedDate,
    this.secondaryType,
    this.sku,
    this.status,
  ...
  factory GetDatabaseResult.fromMap(Map<String, dynamic> map) {
    return GetDatabaseResult(
      ...
      currentServiceObjectiveName: (() { final guardedValue = map['currentServiceObjectiveName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      currentSku: (() { final guardedValue = map['currentSku']; if (guardedValue == null) return null; return SkuResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      isInfraEncryptionEnabled: (() { final guardedValue = map['isInfraEncryptionEnabled']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      ...
      maxLogSizeBytes: (() { final guardedValue = map['maxLogSizeBytes']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      ...
      pausedDate: (() { final guardedValue = map['pausedDate']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      requestedServiceObjectiveName: (() { final guardedValue = map['requestedServiceObjectiveName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      resumedDate: (() { final guardedValue = map['resumedDate']; if (guardedValue == null) return null; return guardedValue as String; })(),
