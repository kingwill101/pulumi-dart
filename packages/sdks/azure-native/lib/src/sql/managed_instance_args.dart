...
class ManagedInstanceArgs {
  ...
  final pulumi.Input<dynamic>? authenticationMetadata;
  ...
  final pulumi.Input<dynamic>? hybridSecondaryUsage;
  ...
  factory ManagedInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstanceArgs(
      ...
      authenticationMetadata: (() { final guardedValue = map['authenticationMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      databaseFormat: (() { final guardedValue = map['databaseFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      hybridSecondaryUsage: (() { final guardedValue = map['hybridSecondaryUsage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      managedInstanceCreateMode: (() { final guardedValue = map['managedInstanceCreateMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      pricingModel: (() { final guardedValue = map['pricingModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      proxyOverride: (() { final guardedValue = map['proxyOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      requestedBackupStorageRedundancy: (() { final guardedValue = map['requestedBackupStorageRedundancy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      storageIOps: (() { final guardedValue = map['storageIOps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      storageSizeInGB: (() { final guardedValue = map['storageSizeInGB']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      storageThroughputMBps: (() { final guardedValue = map['storageThroughputMBps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
