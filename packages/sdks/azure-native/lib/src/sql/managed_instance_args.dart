...
class ManagedInstanceArgs {
  ...
  factory ManagedInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstanceArgs(
      ...
      administrators: map['administrators'] == null ? null : (ManagedInstanceExternalAdministrator.fromMap((map['administrators']! as Map).cast<String, dynamic>())).input(),
      authenticationMetadata: map['authenticationMetadata'] == null ? null : (map['authenticationMetadata']! as String).input(),
      ...
      dnsZonePartner: map['dnsZonePartner'] == null ? null : (map['dnsZonePartner']! as String).input(),
      ...
      instancePoolId: map['instancePoolId'] == null ? null : (map['instancePoolId']! as String).input(),
      isGeneralPurposeV2: map['isGeneralPurposeV2'] == null ? null : (map['isGeneralPurposeV2']! as bool).input(),
      ...
      managedInstanceCreateMode: map['managedInstanceCreateMode'] == null ? null : (map['managedInstanceCreateMode']! as String).input(),
      ...
      requestedBackupStorageRedundancy: map['requestedBackupStorageRedundancy'] == null ? null : (map['requestedBackupStorageRedundancy']! as String).input(),
      resourceGroupName: (map['resourceGroupName'] as String).input(),
      restorePointInTime: map['restorePointInTime'] == null ? null : (map['restorePointInTime']! as String).input(),
      servicePrincipal: map['servicePrincipal'] == null ? null : (ServicePrincipal.fromMap((map['servicePrincipal']! as Map).cast<String, dynamic>())).input(),
      sku: map['sku'] == null ? null : (Sku.fromMap((map['sku']! as Map).cast<String, dynamic>())).input(),
      sourceManagedInstanceId: map['sourceManagedInstanceId'] == null ? null : (map['sourceManagedInstanceId']! as String).input(),
      storageIOps: map['storageIOps'] == null ? null : (map['storageIOps']! as int).input(),
      storageSizeInGB: map['storageSizeInGB'] == null ? null : (map['storageSizeInGB']! as int).input(),
      storageThroughputMBps: map['storageThroughputMBps'] == null ? null : (map['storageThroughputMBps']! as int).input(),
