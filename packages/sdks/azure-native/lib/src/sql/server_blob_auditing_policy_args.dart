...
/// {@template pulumi_sql_server_blob_auditing_policy_args_doc}
/// The set of arguments for ServerBlobAuditingPolicy.
/// {@endtemplate}
/// {@macro pulumi_sql_server_blob_auditing_policy_args_doc}
class ServerBlobAuditingPolicyArgs {
  ...
  /// For more information, see [Diagnostic Settings REST API](https://go.microsoft.com/fwlink/?linkid=2033207)
  /// or [Diagnostic Settings PowerShell](https://go.microsoft.com/fwlink/?linkid=2033043)
  final pulumi.Input<bool>? isDevopsAuditEnabled;
  ...
  /// Creates a new [ServerBlobAuditingPolicyArgs].
  ...
  const ServerBlobAuditingPolicyArgs({
  ...
  factory ServerBlobAuditingPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServerBlobAuditingPolicyArgs(
      ...
      isDevopsAuditEnabled: (() { final guardedValue = map['isDevopsAuditEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
