...
import 'database_blob_auditing_policy_args.dart';
...
/// }
///
/// resource "azure-native_sql_databaseblobauditingpolicy" "databaseBlobAuditingPolicy" {
...
class DatabaseBlobAuditingPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [DatabaseBlobAuditingPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatabaseBlobAuditingPolicy]. {@macro pulumi_sql_database_blob_auditing_policy_args_doc}
