...
class JobTarget {
  ...
  final JobTargetGroupMembershipType? membershipType;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'membershipType': ?membershipType == null ? null : membershipType!.value,
  ...
  factory JobTarget.fromMap(Map<String, dynamic> map) {
    return JobTarget(
      ...
      membershipType: map['membershipType'] == null ? null : JobTargetGroupMembershipType.fromValue(map['membershipType'] as String),
