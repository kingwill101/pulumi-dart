...
class JobAgentIdentityResponse {
  ...
  final pulumi.Input<Map<String, JobAgentUserAssignedIdentityResponse>>?
    ...
    return <String, dynamic>{
      ...
      'userAssignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, JobAgentUserAssignedIdentityResponse>,
    ...
    return JobAgentIdentityResponse(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<JobAgentUserAssignedIdentityResponse>(
            guardedValue,
            (value) => JobAgentUserAssignedIdentityResponse.fromMap(
