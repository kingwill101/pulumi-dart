...
class StartStopManagedInstanceScheduleArgs {
    ...
    return <String, dynamic>{
      ...
      'scheduleList':
          ...
          >(
            scheduleList,
            (value) =>
                pulumi.Input.encodeList<ScheduleItem, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory StartStopManagedInstanceScheduleArgs.fromMap(
    ...
    return StartStopManagedInstanceScheduleArgs(
      ...
      scheduleList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ScheduleItem>(
          map['scheduleList']!,
          (value) =>
              ScheduleItem.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      startStopScheduleName: (() {
        final guardedValue = map['startStopScheduleName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      timeZoneId: (() {
