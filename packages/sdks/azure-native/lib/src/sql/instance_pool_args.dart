...
class InstancePoolArgs {
  ...
  factory InstancePoolArgs.fromMap(Map<String, dynamic> map) {
    return InstancePoolArgs(
      instancePoolName: (() { final guardedValue = map['instancePoolName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      vCores: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['vCores'])),
    );
  }
}
