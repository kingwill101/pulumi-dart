...
class BackupShortTermRetentionPolicyArgs {
  ...
  factory BackupShortTermRetentionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BackupShortTermRetentionPolicyArgs(
      ...
      diffBackupIntervalInHours: (() { final guardedValue = map['diffBackupIntervalInHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
