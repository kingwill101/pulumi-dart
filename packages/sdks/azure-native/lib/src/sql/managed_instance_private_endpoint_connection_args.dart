...
class ManagedInstancePrivateEndpointConnectionArgs {
  ...
  const ManagedInstancePrivateEndpointConnectionArgs({
  ...
  factory ManagedInstancePrivateEndpointConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstancePrivateEndpointConnectionArgs(
      ...
      privateEndpoint: (() { final guardedValue = map['privateEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedInstancePrivateEndpointProperty.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      privateLinkServiceConnectionState: (() { final guardedValue = map['privateLinkServiceConnectionState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedInstancePrivateLinkServiceConnectionStateProperty.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
