...
class DataMaskingPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataMaskingState': pulumi.Input.mapInputValue<DataMaskingState, String>(dataMaskingState, (value) => value.wireValue),
  ...
  factory DataMaskingPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DataMaskingPolicyArgs(
      dataMaskingPolicyName: (() { final guardedValue = map['dataMaskingPolicyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataMaskingState: pulumi.Input.fromValue(DataMaskingState.fromValue(map['dataMaskingState']! as String)),
      databaseName: pulumi.Input.fromValue(map['databaseName'] as String),
      exemptPrincipals: (() { final guardedValue = map['exemptPrincipals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
