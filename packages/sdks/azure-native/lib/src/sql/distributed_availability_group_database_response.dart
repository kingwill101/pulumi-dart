...
class DistributedAvailabilityGroupDatabaseResponse {
    ...
    return <String, dynamic>{
      ...
      'partnerAuthCertValidity':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(partnerAuthCertValidity, (value) => value.toMap()),
  ...
  factory DistributedAvailabilityGroupDatabaseResponse.fromMap(
    ...
    return DistributedAvailabilityGroupDatabaseResponse(
      ...
      instanceRedoReplicationLagSeconds: pulumi.Input.fromValue(
        map['instanceRedoReplicationLagSeconds'] as int,
      ),
      instanceReplicaId: pulumi.Input.fromValue(
        map['instanceReplicaId'] as String,
      ),
      instanceSendReplicationLagSeconds: pulumi.Input.fromValue(
        map['instanceSendReplicationLagSeconds'] as int,
      ),
      ...
      lastHardenedTime: pulumi.Input.fromValue(
        map['lastHardenedTime'] as String,
      ),
      lastReceivedLsn: pulumi.Input.fromValue(map['lastReceivedLsn'] as String),
      lastReceivedTime: pulumi.Input.fromValue(
        map['lastReceivedTime'] as String,
      ),
      ...
      mostRecentLinkError: pulumi.Input.fromValue(
        map['mostRecentLinkError'] as String,
      ),
      partnerAuthCertValidity: pulumi.Input.fromValue(
        CertificateInfoResponse.fromMap(
          (map['partnerAuthCertValidity']! as Map).cast<String, dynamic>(),
        ),
      ),
      partnerReplicaId: pulumi.Input.fromValue(
        map['partnerReplicaId'] as String,
      ),
      ...
      synchronizationHealth: pulumi.Input.fromValue(
        map['synchronizationHealth'] as String,
      ),
    );
  }
}
