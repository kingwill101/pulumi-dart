...
/// }
///
/// resource "azure-native_sql_managedinstancelongtermretentionpolicy" "managedInstanceLongTermRetentionPolicy" {
///   backup_storage_access_tier = "Hot"
...
class ManagedInstanceLongTermRetentionPolicy extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ManagedInstanceLongTermRetentionPolicy] resource.
  ManagedInstanceLongTermRetentionPolicy.reference(String urn)
    : super(
        'azure-native:sql:ManagedInstanceLongTermRetentionPolicy',
