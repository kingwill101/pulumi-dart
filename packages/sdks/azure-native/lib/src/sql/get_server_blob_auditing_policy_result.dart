...
/// Result data returned by getServerBlobAuditingPolicy.
class GetServerBlobAuditingPolicyResult {
  ...
  /// Creates a new [GetServerBlobAuditingPolicyResult].
  ...
  factory GetServerBlobAuditingPolicyResult.fromMap(Map<String, dynamic> map) {
