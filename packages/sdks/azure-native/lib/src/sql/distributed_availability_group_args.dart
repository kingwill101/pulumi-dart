    ...
    return <String, dynamic>{
      'databases':
          ?pulumi.Input.mapOptionalInputValue<
            List<DistributedAvailabilityGroupDatabase>,
    ...
    return DistributedAvailabilityGroupArgs(
      databases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DistributedAvailabilityGroupDatabase>(
            guardedValue,
            (value) => DistributedAvailabilityGroupDatabase.fromMap(
      ...
      distributedAvailabilityGroupName: (() {
        final guardedValue = map['distributedAvailabilityGroupName'];
        if (guardedValue == null) return null;
