...
class DistributedAvailabilityGroupArgs {
  ...
  final pulumi.Input<dynamic>? instanceLinkRole;
  ...
  final pulumi.Input<dynamic>? seedingMode;
  ...
  factory DistributedAvailabilityGroupArgs.fromMap(Map<String, dynamic> map) {
    return DistributedAvailabilityGroupArgs(
      ...
      instanceLinkRole: (() { final guardedValue = map['instanceLinkRole']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      seedingMode: (() { final guardedValue = map['seedingMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
