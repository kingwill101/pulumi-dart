...
class JobStep extends pulumi.CustomResource {
  ...
  JobStep(
    ...
    this.action = registerOutput<JobStepActionResponse>('action');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.credential = registerOutput<String?>('credential');
    this.executionOptions = registerOutput<JobStepExecutionOptionsResponse?>('executionOptions');
    this.name = registerOutput<String>('name');
    this.output = registerOutput<JobStepOutputResponse?>('output');
    this.stepId = registerOutput<int?>('stepId');
