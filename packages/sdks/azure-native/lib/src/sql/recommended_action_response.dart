...
class RecommendedActionResponse {
  ...
  factory RecommendedActionResponse.fromMap(Map<String, dynamic> map) {
    return RecommendedActionResponse(
      ...
      errorDetails: (RecommendedActionErrorInfoResponse.fromMap((map['errorDetails'] as Map).cast<String, dynamic>())).input(),
      estimatedImpact: (pulumi.Input.decodeList<RecommendedActionImpactRecordResponse>(map['estimatedImpact'], (value) => RecommendedActionImpactRecordResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      executeActionDuration: (map['executeActionDuration'] as String).input(),
      executeActionInitiatedBy: (map['executeActionInitiatedBy'] as String).input(),
      executeActionInitiatedTime: (map['executeActionInitiatedTime'] as String).input(),
      executeActionStartTime: (map['executeActionStartTime'] as String).input(),
      id: (map['id'] as String).input(),
      implementationDetails: (RecommendedActionImplementationInfoResponse.fromMap((map['implementationDetails'] as Map).cast<String, dynamic>())).input(),
      isArchivedAction: (map['isArchivedAction'] as bool).input(),
      isExecutableAction: (map['isExecutableAction'] as bool).input(),
      isRevertableAction: (map['isRevertableAction'] as bool).input(),
      kind: (map['kind'] as String).input(),
      lastRefresh: (map['lastRefresh'] as String).input(),
      linkedObjects: ((map['linkedObjects'] as List).cast<String>()).input(),
      location: (map['location'] as String).input(),
      name: (map['name'] as String).input(),
      observedImpact: (pulumi.Input.decodeList<RecommendedActionImpactRecordResponse>(map['observedImpact'], (value) => RecommendedActionImpactRecordResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      recommendationReason: (map['recommendationReason'] as String).input(),
      revertActionDuration: (map['revertActionDuration'] as String).input(),
      revertActionInitiatedBy: (map['revertActionInitiatedBy'] as String).input(),
      revertActionInitiatedTime: (map['revertActionInitiatedTime'] as String).input(),
      revertActionStartTime: (map['revertActionStartTime'] as String).input(),
      score: (map['score'] as int).input(),
      state: (RecommendedActionStateInfoResponse.fromMap((map['state'] as Map).cast<String, dynamic>())).input(),
      timeSeries: (pulumi.Input.decodeList<RecommendedActionMetricInfoResponse>(map['timeSeries'], (value) => RecommendedActionMetricInfoResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      type: (map['type'] as String).input(),
      validSince: (map['validSince'] as String).input(),
    );
  }
}
