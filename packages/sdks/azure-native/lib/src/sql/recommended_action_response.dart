...
class RecommendedActionResponse {
  ...
  final pulumi.Input<List<RecommendedActionImpactRecordResponse>>
  estimatedImpact;
  ...
  final pulumi.Input<RecommendedActionImplementationInfoResponse>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'estimatedImpact':
          pulumi.Input.mapInputValue<
            List<RecommendedActionImpactRecordResponse>,
      ...
      'implementationDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(implementationDetails, (value) => value.toMap()),
      ...
      'timeSeries':
          pulumi.Input.mapInputValue<
            List<RecommendedActionMetricInfoResponse>,
            List<Map<String, dynamic>>
          >(
            timeSeries,
            (value) =>
  ...
  factory RecommendedActionResponse.fromMap(Map<String, dynamic> map) {
    return RecommendedActionResponse(
      ...
      errorDetails: pulumi.Input.fromValue(
        RecommendedActionErrorInfoResponse.fromMap(
          (map['errorDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      estimatedImpact: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RecommendedActionImpactRecordResponse>(
          map['estimatedImpact']!,
          (value) => RecommendedActionImpactRecordResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      executeActionDuration: pulumi.Input.fromValue(
        map['executeActionDuration'] as String,
      ),
      executeActionInitiatedBy: pulumi.Input.fromValue(
        map['executeActionInitiatedBy'] as String,
      ),
      executeActionInitiatedTime: pulumi.Input.fromValue(
        map['executeActionInitiatedTime'] as String,
      ),
      executeActionStartTime: pulumi.Input.fromValue(
        map['executeActionStartTime'] as String,
      ),
      id: pulumi.Input.fromValue(map['id'] as String),
      implementationDetails: pulumi.Input.fromValue(
        RecommendedActionImplementationInfoResponse.fromMap(
          (map['implementationDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      isArchivedAction: pulumi.Input.fromValue(map['isArchivedAction'] as bool),
      isExecutableAction: pulumi.Input.fromValue(
        map['isExecutableAction'] as bool,
      ),
      isRevertableAction: pulumi.Input.fromValue(
        map['isRevertableAction'] as bool,
      ),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      lastRefresh: pulumi.Input.fromValue(map['lastRefresh'] as String),
      linkedObjects: pulumi.Input.fromValue(
        (map['linkedObjects'] as List).cast<String>(),
      ),
      location: pulumi.Input.fromValue(map['location'] as String),
      name: pulumi.Input.fromValue(map['name'] as String),
      observedImpact: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RecommendedActionImpactRecordResponse>(
          map['observedImpact']!,
          (value) => RecommendedActionImpactRecordResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
      ...
      recommendationReason: pulumi.Input.fromValue(
        map['recommendationReason'] as String,
      ),
      revertActionDuration: pulumi.Input.fromValue(
        map['revertActionDuration'] as String,
      ),
      revertActionInitiatedBy: pulumi.Input.fromValue(
        map['revertActionInitiatedBy'] as String,
      ),
      revertActionInitiatedTime: pulumi.Input.fromValue(
        map['revertActionInitiatedTime'] as String,
      ),
      revertActionStartTime: pulumi.Input.fromValue(
        map['revertActionStartTime'] as String,
      ),
      score: pulumi.Input.fromValue(map['score'] as int),
      state: pulumi.Input.fromValue(
        RecommendedActionStateInfoResponse.fromMap(
          (map['state']! as Map).cast<String, dynamic>(),
        ),
      ),
      timeSeries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RecommendedActionMetricInfoResponse>(
          map['timeSeries']!,
          (value) => RecommendedActionMetricInfoResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
