...
class SyncGroupSchemaResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tables': ?pulumi.Input.mapOptionalInputValue<List<SyncGroupSchemaTableResponse>, List<Map<String, dynamic>>>(tables, (value) => pulumi.Input.encodeList<SyncGroupSchemaTableResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory SyncGroupSchemaResponse.fromMap(Map<String, dynamic> map) {
    return SyncGroupSchemaResponse(
      ...
      tables: (() { final guardedValue = map['tables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SyncGroupSchemaTableResponse>(guardedValue, (value) => SyncGroupSchemaTableResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
