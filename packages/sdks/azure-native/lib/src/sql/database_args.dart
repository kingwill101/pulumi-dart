...
class DatabaseArgs {
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      ...
      encryptionProtector: map['encryptionProtector'] == null ? null : (map['encryptionProtector'] as String).input(),
      encryptionProtectorAutoRotation: map['encryptionProtectorAutoRotation'] == null ? null : (map['encryptionProtectorAutoRotation'] as bool).input(),
      federatedClientId: map['federatedClientId'] == null ? null : (map['federatedClientId'] as String).input(),
      freeLimitExhaustionBehavior: map['freeLimitExhaustionBehavior'] == null ? null : (map['freeLimitExhaustionBehavior'] as String).input(),
      ...
      manualCutover: map['manualCutover'] == null ? null : (map['manualCutover'] as bool).input(),
      ...
      performCutover: map['performCutover'] == null ? null : (map['performCutover'] as bool).input(),
      preferredEnclaveType: map['preferredEnclaveType'] == null ? null : (map['preferredEnclaveType'] as String).input(),
      readScale: map['readScale'] == null ? null : (map['readScale'] as String).input(),
      recoverableDatabaseId: map['recoverableDatabaseId'] == null ? null : (map['recoverableDatabaseId'] as String).input(),
      recoveryServicesRecoveryPointId: map['recoveryServicesRecoveryPointId'] == null ? null : (map['recoveryServicesRecoveryPointId'] as String).input(),
      ...
      useFreeLimit: map['useFreeLimit'] == null ? null : (map['useFreeLimit'] as bool).input(),
