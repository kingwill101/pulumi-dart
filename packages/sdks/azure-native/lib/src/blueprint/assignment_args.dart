...
class AssignmentArgs {
  ...
  factory AssignmentArgs.fromMap(Map<String, dynamic> map) {
    return AssignmentArgs(
      ...
      locks: (() {
        final guardedValue = map['locks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AssignmentLockSettings.fromMap(
      ...
      resourceGroups: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<ResourceGroupValue>(
          map['resourceGroups']!,
          (value) => ResourceGroupValue.fromMap(
