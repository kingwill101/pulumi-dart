...
class ParameterValue {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'reference': ?pulumi.Input.mapOptionalInputValue<SecretValueReference, Map<String, dynamic>>(reference, (value) => value.toMap()),
      'value': ?value,
    };
  }
  ...
  factory ParameterValue.fromMap(Map<String, dynamic> map) {
    return ParameterValue(
      reference: (() { final guardedValue = map['reference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretValueReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
