...
class PublishedBlueprintArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceGroups':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, ResourceGroupDefinition>,
            Map<String, Map<String, dynamic>>
          >(
            resourceGroups,
            (value) =>
  ...
  factory PublishedBlueprintArgs.fromMap(Map<String, dynamic> map) {
    return PublishedBlueprintArgs(
      ...
      changeNotes: (() {
        final guardedValue = map['changeNotes'];
      ...
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ParameterDefinition>(
            guardedValue,
            (value) => ParameterDefinition.fromMap(
      ...
      resourceGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ResourceGroupDefinition>(
            guardedValue,
            (value) => ResourceGroupDefinition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      targetScope: (() {
        final guardedValue = map['targetScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      versionId: (() {
