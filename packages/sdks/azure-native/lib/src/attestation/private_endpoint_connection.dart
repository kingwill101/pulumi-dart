...
/// }
///
/// resource "azure-native_attestation_privateendpointconnection" "privateEndpointConnection" {
...
class PrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateEndpointConnection]. {@macro pulumi_attestation_private_endpoint_connection_args_doc}
