...
/// Result data returned by getExpressRouteGatewayRoutesInformation.
class GetExpressRouteGatewayRoutesInformationResult {
  ...
  /// Creates a new [GetExpressRouteGatewayRoutesInformationResult].
  ...
  const GetExpressRouteGatewayRoutesInformationResult({
  ...
  factory GetExpressRouteGatewayRoutesInformationResult.fromMap(Map<String, dynamic> map) {
