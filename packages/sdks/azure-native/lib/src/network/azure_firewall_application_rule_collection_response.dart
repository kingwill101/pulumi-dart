...
class AzureFirewallApplicationRuleCollectionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureFirewallApplicationRuleResponse>,
  ...
  factory AzureFirewallApplicationRuleCollectionResponse.fromMap(
    ...
    return AzureFirewallApplicationRuleCollectionResponse(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureFirewallApplicationRuleResponse>(
            guardedValue,
            (value) => AzureFirewallApplicationRuleResponse.fromMap(
