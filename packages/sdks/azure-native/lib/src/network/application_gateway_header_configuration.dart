...
class ApplicationGatewayHeaderConfiguration {
  ...
  final HeaderValueMatcher? headerValueMatcher;
  ...
  factory ApplicationGatewayHeaderConfiguration.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayHeaderConfiguration(
      ...
      headerValueMatcher: map['headerValueMatcher'] == null ? null : HeaderValueMatcher.fromMap((map['headerValueMatcher'] as Map).cast<String, dynamic>()),
    );
  }
}
