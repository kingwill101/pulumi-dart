...
class ManagedRulesDefinitionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'exclusions':
          ?pulumi.Input.mapOptionalInputValue<
            List<OwaspCrsExclusionEntryResponse>,
            List<Map<String, dynamic>>
          >(
            exclusions,
            (value) =>
    ...
    return ManagedRulesDefinitionResponse(
      exceptions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExceptionEntryResponse>(
            guardedValue,
            (value) => ExceptionEntryResponse.fromMap(
      ...
      exclusions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OwaspCrsExclusionEntryResponse>(
            guardedValue,
            (value) => OwaspCrsExclusionEntryResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      managedRuleSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ManagedRuleSetResponse>(
          map['managedRuleSets']!,
          (value) => ManagedRuleSetResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
