...
class ConnectivityGroupItemlistEffectiveConnectivityConfigurationResponse {
  ...
  const ConnectivityGroupItemlistEffectiveConnectivityConfigurationResponse({
  ...
  factory ConnectivityGroupItemlistEffectiveConnectivityConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ConnectivityGroupItemlistEffectiveConnectivityConfigurationResponse(
