...
class StaticRoutesConfigP2sVpnGatewayResponse {
  ...
  /// Creates a new [StaticRoutesConfigP2sVpnGatewayResponse].
  ...
  const StaticRoutesConfigP2sVpnGatewayResponse({
  ...
  factory StaticRoutesConfigP2sVpnGatewayResponse.fromMap(Map<String, dynamic> map) {
    return StaticRoutesConfigP2sVpnGatewayResponse(
