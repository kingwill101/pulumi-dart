...
import 'network_interface_ipconfiguration_service_gateway_response.dart';
...
class ApplicationGatewayBackendAddressPoolServiceGatewayResponse {
  ...
  /// Creates a new [ApplicationGatewayBackendAddressPoolServiceGatewayResponse].
  ...
  const ApplicationGatewayBackendAddressPoolServiceGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'backendIPConfigurations': pulumi.Input.mapInputValue<List<NetworkInterfaceIPConfigurationServiceGatewayResponse>, List<Map<String, dynamic>>>(backendIPConfigurations, (value) => pulumi.Input.encodeList<NetworkInterfaceIPConfigurationServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'etag': etag,
      'id': ?id,
      'name': ?name,
  ...
  factory ApplicationGatewayBackendAddressPoolServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayBackendAddressPoolServiceGatewayResponse(
      ...
      backendIPConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceIPConfigurationServiceGatewayResponse>(map['backendIPConfigurations']!, (value) => NetworkInterfaceIPConfigurationServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))),
