...
import 'vnet_route_vpn_server_configuration_response.dart';

/// Routing Configuration indicating the associated and propagated route tables for this connection.
class RoutingConfigurationVpnServerConfigurationResponse {
  ...
  final pulumi.Input<VnetRouteVpnServerConfigurationResponse?>? vnetRoutes;

  /// Creates a new [RoutingConfigurationVpnServerConfigurationResponse].
  ...
  const RoutingConfigurationVpnServerConfigurationResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRouteVpnServerConfigurationResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationVpnServerConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationVpnServerConfigurationResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteVpnServerConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
