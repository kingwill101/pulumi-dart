...
import 'static_routes_config_vpn_server_configuration_response.dart';
import 'sub_resource_response.dart';

/// List of routes that control routing from VirtualHub into a virtual network connection.
class VnetRouteVpnServerConfigurationResponse {
  ...
  final pulumi.Input<StaticRoutesConfigVpnServerConfigurationResponse?>? staticRoutesConfig;

  /// Creates a new [VnetRouteVpnServerConfigurationResponse].
  ...
  const VnetRouteVpnServerConfigurationResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'staticRoutesConfig': ?pulumi.Input.mapOptionalInputValue<StaticRoutesConfigVpnServerConfigurationResponse, Map<String, dynamic>>(staticRoutesConfig, (value) => value.toMap()),
    };
  }

  factory VnetRouteVpnServerConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return VnetRouteVpnServerConfigurationResponse(
      ...
      staticRoutesConfig: (() { final guardedValue = map['staticRoutesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StaticRoutesConfigVpnServerConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
