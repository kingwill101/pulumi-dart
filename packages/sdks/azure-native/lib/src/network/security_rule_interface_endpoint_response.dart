...
class SecurityRuleInterfaceEndpointResponse {
  ...
  /// Creates a new [SecurityRuleInterfaceEndpointResponse].
  ...
  /// [protocol] Network protocol this rule applies to. Possible values are 'Tcp', 'Udp', 'Icmp', 'Esp', and '*'.
  ...
  const SecurityRuleInterfaceEndpointResponse({
  ...
  factory SecurityRuleInterfaceEndpointResponse.fromMap(Map<String, dynamic> map) {
    return SecurityRuleInterfaceEndpointResponse(
