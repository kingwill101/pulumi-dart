...
class GetSecurityUserRuleCollectionResult {
  ...
  factory GetSecurityUserRuleCollectionResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetSecurityUserRuleCollectionResult(
      appliesToGroups: pulumi.Input.decodeList<SecurityUserGroupItemResponse>(
        map['appliesToGroups']!,
        (value) => SecurityUserGroupItemResponse.fromMap(
