...
class ListVirtualNetworkGatewayRadiusSecretsResult {
  ...
  ListVirtualNetworkGatewayRadiusSecretsResult({this.nextLink, this.value});
  ...
  factory ListVirtualNetworkGatewayRadiusSecretsResult.fromMap(
    ...
    return ListVirtualNetworkGatewayRadiusSecretsResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<RadiusAuthServerResponse>(
          guardedValue,
          (value) => RadiusAuthServerResponse.fromMap(
