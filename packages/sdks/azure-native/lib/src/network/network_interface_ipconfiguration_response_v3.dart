...
import 'application_gateway_backend_address_pool_virtual_network_appliance_response.dart';
...
class NetworkInterfaceIPConfigurationResponseV3 {
  ...
  const NetworkInterfaceIPConfigurationResponseV3({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applicationGatewayBackendAddressPools': ?pulumi.Input.mapOptionalInputValue<List<ApplicationGatewayBackendAddressPoolVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(applicationGatewayBackendAddressPools, (value) => pulumi.Input.encodeList<ApplicationGatewayBackendAddressPoolVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory NetworkInterfaceIPConfigurationResponseV3.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceIPConfigurationResponseV3(
      applicationGatewayBackendAddressPools: (() { final guardedValue = map['applicationGatewayBackendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayBackendAddressPoolVirtualNetworkApplianceResponse>(guardedValue, (value) => ApplicationGatewayBackendAddressPoolVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
