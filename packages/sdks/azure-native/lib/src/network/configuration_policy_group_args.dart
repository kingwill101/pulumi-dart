...
class ConfigurationPolicyGroupArgs {
  ...
  final pulumi.Input<List<VpnServerConfigurationPolicyGroupMember>>?
  policyMembers;
    ...
    return <String, dynamic>{
      ...
      'policyMembers':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpnServerConfigurationPolicyGroupMember>,
  ...
  factory ConfigurationPolicyGroupArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationPolicyGroupArgs(
      configurationPolicyGroupName: (() {
        final guardedValue = map['configurationPolicyGroupName'];
      ...
      policyMembers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpnServerConfigurationPolicyGroupMember>(
            guardedValue,
            (value) => VpnServerConfigurationPolicyGroupMember.fromMap(
