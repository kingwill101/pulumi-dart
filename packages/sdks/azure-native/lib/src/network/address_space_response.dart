...
class AddressSpaceResponse {
  ...
  final pulumi.Input<List<IpamPoolPrefixAllocationResponse>>?
  ...
  AddressSpaceResponse({this.addressPrefixes, this.ipamPoolPrefixAllocations});
    ...
    return <String, dynamic>{
      ...
      'ipamPoolPrefixAllocations':
          ?pulumi.Input.mapOptionalInputValue<
            List<IpamPoolPrefixAllocationResponse>,
    ...
    return AddressSpaceResponse(
      ...
      ipamPoolPrefixAllocations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpamPoolPrefixAllocationResponse>(
            guardedValue,
            (value) => IpamPoolPrefixAllocationResponse.fromMap(
