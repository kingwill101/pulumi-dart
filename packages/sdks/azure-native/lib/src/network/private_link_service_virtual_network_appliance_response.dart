...
import 'frontend_ipconfiguration_virtual_network_appliance_response.dart';
import 'network_interface_response.dart';
import 'private_endpoint_connection_virtual_network_appliance_response.dart';
...
class PrivateLinkServiceVirtualNetworkApplianceResponse {
  ...
  final pulumi.Input<List<PrivateEndpointConnectionVirtualNetworkApplianceResponse>> privateEndpointConnections;
  ...
  const PrivateLinkServiceVirtualNetworkApplianceResponse({
    this.accessMode,
    required this.alias,
    this.autoApproval,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'privateEndpointConnections': pulumi.Input.mapInputValue<List<PrivateEndpointConnectionVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(privateEndpointConnections, (value) => pulumi.Input.encodeList<PrivateEndpointConnectionVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory PrivateLinkServiceVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return PrivateLinkServiceVirtualNetworkApplianceResponse(
      ...
      loadBalancerFrontendIpConfigurations: (() { final guardedValue = map['loadBalancerFrontendIpConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FrontendIPConfigurationVirtualNetworkApplianceResponse>(guardedValue, (value) => FrontendIPConfigurationVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      privateEndpointConnections: pulumi.Input.fromValue(pulumi.Input.decodeList<PrivateEndpointConnectionVirtualNetworkApplianceResponse>(map['privateEndpointConnections']!, (value) => PrivateEndpointConnectionVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))),
