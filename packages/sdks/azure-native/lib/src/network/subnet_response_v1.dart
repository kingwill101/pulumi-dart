...
import 'ipconfiguration_profile_service_gateway_response.dart';
import 'ipconfiguration_service_gateway_response.dart';
import 'network_security_group_service_gateway_response.dart';
import 'private_endpoint_service_gateway_response.dart';
import 'resource_navigation_link_response.dart';
import 'route_table_service_gateway_response.dart';
import 'service_association_link_response.dart';
import 'service_endpoint_policy_service_gateway_response.dart';
import 'service_endpoint_properties_format_response.dart';
import 'sub_resource_response.dart';

/// Subnet in a virtual network resource.
class SubnetResponseV1 {
  ...
  final pulumi.Input<List<IPConfigurationProfileServiceGatewayResponse>> ipConfigurationProfiles;
  /// An array of references to the network interface IP configurations using subnet.
  final pulumi.Input<List<IPConfigurationServiceGatewayResponse>> ipConfigurations;
  ...
  final pulumi.Input<NetworkSecurityGroupServiceGatewayResponse>? networkSecurityGroup;
  /// Enable or Disable apply network policies on private end point in the subnet.
  final pulumi.Input<String>? privateEndpointNetworkPolicies;
  /// An array of references to private endpoints.
  final pulumi.Input<List<PrivateEndpointServiceGatewayResponse>> privateEndpoints;
  ...
  final pulumi.Input<RouteTableServiceGatewayResponse>? routeTable;
  /// An array of references to services injecting into this subnet.
  final pulumi.Input<List<ServiceAssociationLinkResponse>> serviceAssociationLinks;
  /// An array of service endpoint policies.
  final pulumi.Input<List<ServiceEndpointPolicyServiceGatewayResponse>>? serviceEndpointPolicies;
  ...
  /// Creates a new [SubnetResponseV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurationProfiles': pulumi.Input.mapInputValue<List<IPConfigurationProfileServiceGatewayResponse>, List<Map<String, dynamic>>>(ipConfigurationProfiles, (value) => pulumi.Input.encodeList<IPConfigurationProfileServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'ipConfigurations': pulumi.Input.mapInputValue<List<IPConfigurationServiceGatewayResponse>, List<Map<String, dynamic>>>(ipConfigurations, (value) => pulumi.Input.encodeList<IPConfigurationServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'networkSecurityGroup': ?pulumi.Input.mapOptionalInputValue<NetworkSecurityGroupServiceGatewayResponse, Map<String, dynamic>>(networkSecurityGroup, (value) => value.toMap()),
      'privateEndpointNetworkPolicies': ?privateEndpointNetworkPolicies,
      'privateEndpoints': pulumi.Input.mapInputValue<List<PrivateEndpointServiceGatewayResponse>, List<Map<String, dynamic>>>(privateEndpoints, (value) => pulumi.Input.encodeList<PrivateEndpointServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'routeTable': ?pulumi.Input.mapOptionalInputValue<RouteTableServiceGatewayResponse, Map<String, dynamic>>(routeTable, (value) => value.toMap()),
      ...
      'serviceEndpointPolicies': ?pulumi.Input.mapOptionalInputValue<List<ServiceEndpointPolicyServiceGatewayResponse>, List<Map<String, dynamic>>>(serviceEndpointPolicies, (value) => pulumi.Input.encodeList<ServiceEndpointPolicyServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory SubnetResponseV1.fromMap(Map<String, dynamic> map) {
    return SubnetResponseV1(
      ...
      ipConfigurationProfiles: pulumi.Input.fromValue(pulumi.Input.decodeList<IPConfigurationProfileServiceGatewayResponse>(map['ipConfigurationProfiles']!, (value) => IPConfigurationProfileServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ipConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<IPConfigurationServiceGatewayResponse>(map['ipConfigurations']!, (value) => IPConfigurationServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      networkSecurityGroup: (() { final guardedValue = map['networkSecurityGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkSecurityGroupServiceGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      privateEndpoints: pulumi.Input.fromValue(pulumi.Input.decodeList<PrivateEndpointServiceGatewayResponse>(map['privateEndpoints']!, (value) => PrivateEndpointServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      routeTable: (() { final guardedValue = map['routeTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouteTableServiceGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      serviceEndpointPolicies: (() { final guardedValue = map['serviceEndpointPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceEndpointPolicyServiceGatewayResponse>(guardedValue, (value) => ServiceEndpointPolicyServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
