...
class PrivateEndpointResponse {
  ...
  final pulumi.Input<List<CustomDnsConfigPropertiesFormatResponse>>?
  customDnsConfigs;
  ...
  final pulumi.Input<List<PrivateEndpointIPConfigurationResponse>>?
  ipConfigurations;
  ...
  final pulumi.Input<List<PrivateLinkServiceConnectionResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customDnsConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomDnsConfigPropertiesFormatResponse>,
            List<Map<String, dynamic>>
          >(
            customDnsConfigs,
            (value) =>
      ...
      'ipConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<PrivateEndpointIPConfigurationResponse>,
            List<Map<String, dynamic>>
          >(
            ipConfigurations,
            (value) =>
  ...
  factory PrivateEndpointResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointResponse(
      ...
      customDnsConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomDnsConfigPropertiesFormatResponse>(
            guardedValue,
            (value) => CustomDnsConfigPropertiesFormatResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateEndpointIPConfigurationResponse>(
            guardedValue,
            (value) => PrivateEndpointIPConfigurationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ipVersionType: (() {
        final guardedValue = map['ipVersionType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      manualPrivateLinkServiceConnections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateLinkServiceConnectionResponse>(
            guardedValue,
