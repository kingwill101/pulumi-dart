...
import 'network_interface_ipconfiguration_response_v3.dart';
import 'network_interface_tap_configuration_virtual_network_appliance_response.dart';
import 'network_security_group_response.dart';
import 'private_endpoint_virtual_network_appliance_response.dart';
import 'private_link_service_virtual_network_appliance_response.dart';
import 'sub_resource_response.dart';

/// A network interface in a resource group.
class NetworkInterfaceVirtualNetworkApplianceResponse {
  ...
  final pulumi.Input<List<NetworkInterfaceIPConfigurationResponseV3>?>? ipConfigurations;
  /// Resource location.
  ...
  final pulumi.Input<PrivateLinkServiceVirtualNetworkApplianceResponse?>? privateLinkService;
  ...
  final pulumi.Input<List<NetworkInterfaceTapConfigurationVirtualNetworkApplianceResponse>> tapConfigurations;
  /// Resource type.
  ...
  /// Creates a new [NetworkInterfaceVirtualNetworkApplianceResponse].
  ...
  const NetworkInterfaceVirtualNetworkApplianceResponse({
    this.auxiliaryMode,
    this.auxiliarySku,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'ipConfigurations': ?pulumi.Input.mapOptionalInputValue<List<NetworkInterfaceIPConfigurationResponseV3>, List<Map<String, dynamic>>>(ipConfigurations, (value) => pulumi.Input.encodeList<NetworkInterfaceIPConfigurationResponseV3, Map<String, dynamic>>(value, (value) => value.toMap())),
      'location': ?location,
      ...
      'privateLinkService': ?pulumi.Input.mapOptionalInputValue<PrivateLinkServiceVirtualNetworkApplianceResponse, Map<String, dynamic>>(privateLinkService, (value) => value.toMap()),
      'provisioningState': provisioningState,
      'resourceGuid': resourceGuid,
      'tags': ?tags,
      'tapConfigurations': pulumi.Input.mapInputValue<List<NetworkInterfaceTapConfigurationVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(tapConfigurations, (value) => pulumi.Input.encodeList<NetworkInterfaceTapConfigurationVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'type': type,
  ...
  factory NetworkInterfaceVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceVirtualNetworkApplianceResponse(
      ...
      ipConfigurations: (() { final guardedValue = map['ipConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceIPConfigurationResponseV3>(guardedValue, (value) => NetworkInterfaceIPConfigurationResponseV3.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      privateLinkService: (() { final guardedValue = map['privateLinkService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateLinkServiceVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      resourceGuid: pulumi.Input.fromValue(map['resourceGuid'] as String),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      tapConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceTapConfigurationVirtualNetworkApplianceResponse>(map['tapConfigurations']!, (value) => NetworkInterfaceTapConfigurationVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))),
