...
import 'active_default_security_user_rulelist_active_security_user_rules_response.dart';
...
class ListActiveSecurityUserRulesResult {
  ...
  final List<ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse>? value;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'skipToken': ?skipToken,
      'value': ?(() { final guardedValue = value; if (guardedValue == null) return null; return pulumi.Input.encodeList<ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory ListActiveSecurityUserRulesResult.fromMap(Map<String, dynamic> map) {
    return ListActiveSecurityUserRulesResult(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse>(guardedValue, (value) => ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
