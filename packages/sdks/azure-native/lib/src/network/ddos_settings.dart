...
class DdosSettings {
  ...
  final pulumi.Input<dynamic>? protectionMode;
  ...
  factory DdosSettings.fromMap(Map<String, dynamic> map) {
    return DdosSettings(
      ...
      protectionMode: (() { final guardedValue = map['protectionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
