...
class SubnetServiceGatewayResponse {
  ...
  /// Creates a new [SubnetServiceGatewayResponse].
  ...
  /// [type] Resource type.
  const SubnetServiceGatewayResponse({
    this.addressPrefix,
  ...
  factory SubnetServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return SubnetServiceGatewayResponse(
