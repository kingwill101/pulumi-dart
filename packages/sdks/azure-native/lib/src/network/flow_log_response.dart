...
class FlowLogResponse {
  ...
  final pulumi.Input<TrafficAnalyticsPropertiesResponse>?
    ...
    return FlowLogResponse(
      ...
      flowAnalyticsConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          TrafficAnalyticsPropertiesResponse.fromMap(
      ...
      format: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowLogFormatParametersResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      retentionPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RetentionPolicyParametersResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      targetResourceGuid: pulumi.Input.fromValue(
        map['targetResourceGuid'] as String,
      ),
