...
class ConnectionMonitorEndpoint {
  ...
  final pulumi.Input<dynamic>? coverageLevel;
  ...
  factory ConnectionMonitorEndpoint.fromMap(Map<String, dynamic> map) {
    return ConnectionMonitorEndpoint(
      ...
      coverageLevel: (() { final guardedValue = map['coverageLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
