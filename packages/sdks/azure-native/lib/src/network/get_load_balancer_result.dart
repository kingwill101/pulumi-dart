...
class GetLoadBalancerResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'inboundNatPools': ?(() {
        final guardedValue = inboundNatPools;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'inboundNatRules': ?(() {
        final guardedValue = inboundNatRules;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'name': name,
      'outboundRules': ?(() {
        final guardedValue = outboundRules;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'probes': ?(() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<ProbeResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetLoadBalancerResult.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerResult(
      ...
      backendAddressPools: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<BackendAddressPoolResponse>(
          guardedValue,
      ...
      inboundNatPools: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<InboundNatPoolResponse>(
          guardedValue,
          (value) => InboundNatPoolResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      inboundNatRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<InboundNatRuleResponse>(
          guardedValue,
      ...
      outboundRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<OutboundRuleResponse>(
          guardedValue,
          (value) => OutboundRuleResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      probes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ProbeResponse>(
          guardedValue,
          (value) =>
