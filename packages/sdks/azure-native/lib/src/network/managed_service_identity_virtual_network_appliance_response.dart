...
class ManagedServiceIdentityVirtualNetworkApplianceResponse {
  ...
  /// Creates a new [ManagedServiceIdentityVirtualNetworkApplianceResponse].
  ...
  const ManagedServiceIdentityVirtualNetworkApplianceResponse({
  ...
  factory ManagedServiceIdentityVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return ManagedServiceIdentityVirtualNetworkApplianceResponse(
