...
class NetworkInterfaceIPConfigurationResponse {
  ...
  factory NetworkInterfaceIPConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceIPConfigurationResponse(
      ...
      virtualNetworkTaps: (() { final guardedValue = map['virtualNetworkTaps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualNetworkTapResponse>(guardedValue, (value) => VirtualNetworkTapResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
