...
class NetworkInterfaceIPConfigurationResponse {
  ...
  final pulumi.Input<List<BackendAddressPoolResponse>>?
    ...
    return <String, dynamic>{
      ...
      'privateLinkConnectionProperties':
          pulumi.Input.mapInputValue<
            NetworkInterfaceIPConfigurationPrivateLinkConnectionPropertiesResponse,
            Map<String, dynamic>
          >(privateLinkConnectionProperties, (value) => value.toMap()),
      ...
      'virtualNetworkTaps':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworkTapResponse>,
            List<Map<String, dynamic>>
          >(
            virtualNetworkTaps,
            (value) =>
  ...
  factory NetworkInterfaceIPConfigurationResponse.fromMap(
    ...
    return NetworkInterfaceIPConfigurationResponse(
      ...
      privateLinkConnectionProperties: pulumi.Input.fromValue(
        NetworkInterfaceIPConfigurationPrivateLinkConnectionPropertiesResponse.fromMap(
          (map['privateLinkConnectionProperties']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      ...
      virtualNetworkTaps: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworkTapResponse>(
            guardedValue,
            (value) => VirtualNetworkTapResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
