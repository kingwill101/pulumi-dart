...
class GetBastionHostResult {
  ...
  factory GetBastionHostResult.fromMap(Map<String, dynamic> map) {
    return GetBastionHostResult(
      ...
      disableCopyPaste: (() {
        final guardedValue = map['disableCopyPaste'];
        if (guardedValue == null) return null;
      ...
      enableFileCopy: (() {
        final guardedValue = map['enableFileCopy'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableIpConnect: (() {
        final guardedValue = map['enableIpConnect'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableKerberos: (() {
      ...
      enablePrivateOnlyBastion: (() {
        final guardedValue = map['enablePrivateOnlyBastion'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableSessionRecording: (() {
        final guardedValue = map['enableSessionRecording'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableShareableLink: (() {
        final guardedValue = map['enableShareableLink'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableTunneling: (() {
        final guardedValue = map['enableTunneling'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<BastionHostIPConfigurationResponse>(
          guardedValue,
          (value) => BastionHostIPConfigurationResponse.fromMap(
