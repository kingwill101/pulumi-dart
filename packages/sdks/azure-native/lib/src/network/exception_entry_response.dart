...
class ExceptionEntryResponse {
  ...
  factory ExceptionEntryResponse.fromMap(Map<String, dynamic> map) {
    return ExceptionEntryResponse(
      exceptionManagedRuleSets: (() { final guardedValue = map['exceptionManagedRuleSets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExclusionManagedRuleSetResponse>(guardedValue, (value) => ExclusionManagedRuleSetResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
