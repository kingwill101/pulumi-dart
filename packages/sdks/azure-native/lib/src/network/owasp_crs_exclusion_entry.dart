...
class OwaspCrsExclusionEntry {
  ...
  factory OwaspCrsExclusionEntry.fromMap(Map<String, dynamic> map) {
    return OwaspCrsExclusionEntry(
      exclusionManagedRuleSets: (() {
        final guardedValue = map['exclusionManagedRuleSets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExclusionManagedRuleSet>(
            guardedValue,
            (value) => ExclusionManagedRuleSet.fromMap(
