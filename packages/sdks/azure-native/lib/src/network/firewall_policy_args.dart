...
class FirewallPolicyArgs {
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      basePolicy: (() { final guardedValue = map['basePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      explicitProxy: (() { final guardedValue = map['explicitProxy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExplicitProxy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallPolicySku.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
