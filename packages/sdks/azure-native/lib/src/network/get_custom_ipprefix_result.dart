...
class GetCustomIPPrefixResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'childCustomIpPrefixes': ?(() { final guardedValue = childCustomIpPrefixes; if (guardedValue == null) return null; return pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'cidr': ?cidr,
  ...
  factory GetCustomIPPrefixResult.fromMap(Map<String, dynamic> map) {
    return GetCustomIPPrefixResult(
      ...
      childCustomIpPrefixes: (() { final guardedValue = map['childCustomIpPrefixes']; if (guardedValue == null) return null; return pulumi.Input.decodeList<SubResourceResponse>(guardedValue, (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      failedReason: (() { final guardedValue = map['failedReason']; if (guardedValue == null) return null; return guardedValue as String; })(),
