...
class ExclusionManagedRuleSet {
  ...
  factory ExclusionManagedRuleSet.fromMap(Map<String, dynamic> map) {
    return ExclusionManagedRuleSet(
      ruleGroups: (() { final guardedValue = map['ruleGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExclusionManagedRuleGroup>(guardedValue, (value) => ExclusionManagedRuleGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
