...
class SecurityRuleNetwork extends pulumi.CustomResource {
  ...
  SecurityRuleNetwork(
    ...
    this.destinationApplicationSecurityGroups = registerOutput<List<ApplicationSecurityGroupResponse>?>('destinationApplicationSecurityGroups');
    ...
    this.sourceApplicationSecurityGroups = registerOutput<List<ApplicationSecurityGroupResponse>?>('sourceApplicationSecurityGroups');
