...
class FirewallPolicyIntrusionDetectionConfigurationResponse {
  ...
  final pulumi.Input<
    List<FirewallPolicyIntrusionDetectionSignatureSpecificationResponse>
  >?
  signatureOverrides;
  ...
  factory FirewallPolicyIntrusionDetectionConfigurationResponse.fromMap(
      ...
      bypassTrafficSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyIntrusionDetectionBypassTrafficSpecificationsResponse.fromMap(
      ...
      signatureOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyIntrusionDetectionSignatureSpecificationResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
