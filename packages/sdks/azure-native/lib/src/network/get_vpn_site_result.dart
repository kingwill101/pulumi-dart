...
class GetVpnSiteResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vpnSiteLinks': ?(() {
        final guardedValue = vpnSiteLinks;
  ...
  factory GetVpnSiteResult.fromMap(Map<String, dynamic> map) {
    return GetVpnSiteResult(
      ...
      bgpProperties: (() {
        final guardedValue = map['bgpProperties'];
        if (guardedValue == null) return null;
      ...
      deviceProperties: (() {
        final guardedValue = map['deviceProperties'];
        if (guardedValue == null) return null;
      ...
      isSecuritySite: (() {
        final guardedValue = map['isSecuritySite'];
        if (guardedValue == null) return null;
      ...
      siteKey: (() {
        final guardedValue = map['siteKey'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      tags: (() {
      ...
      vpnSiteLinks: (() {
        final guardedValue = map['vpnSiteLinks'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VpnSiteLinkResponse>(
          guardedValue,
          (value) => VpnSiteLinkResponse.fromMap(
