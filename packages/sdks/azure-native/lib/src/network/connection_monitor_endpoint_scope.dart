...
class ConnectionMonitorEndpointScope {
  ...
  ConnectionMonitorEndpointScope({this.exclude, this.include});
    ...
    return ConnectionMonitorEndpointScope(
      exclude: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConnectionMonitorEndpointScopeItem>(
            guardedValue,
            (value) => ConnectionMonitorEndpointScopeItem.fromMap(
