...
class AzureFirewallArgs {
  ...
  final pulumi.Input<List<AzureFirewallApplicationRuleCollection>>?
  applicationRuleCollections;

  /// Properties to provide a custom autoscale configuration to this azure firewall.
  final pulumi.Input<AzureFirewallAutoscaleConfiguration>?
  ...
  final pulumi.Input<List<AzureFirewallNetworkRuleCollection>>?
    ...
    return <String, dynamic>{
      ...
      'hubIPAddresses':
          ?pulumi.Input.mapOptionalInputValue<
            HubIPAddresses,
            Map<String, dynamic>
          >(hubIPAddresses, (value) => value.toMap()),
      'id': ?id,
      'ipConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory AzureFirewallArgs.fromMap(Map<String, dynamic> map) {
    return AzureFirewallArgs(
      ...
      applicationRuleCollections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureFirewallApplicationRuleCollection>(
            guardedValue,
            (value) => AzureFirewallApplicationRuleCollection.fromMap(
      ...
      autoscaleConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureFirewallAutoscaleConfiguration.fromMap(
      ...
      hubIPAddresses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HubIPAddresses.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      id: (() {
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureFirewallIPConfiguration>(
            guardedValue,
            (value) => AzureFirewallIPConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      managementIpConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureFirewallIPConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      natRuleCollections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureFirewallNatRuleCollection>(
            guardedValue,
            (value) => AzureFirewallNatRuleCollection.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      networkRuleCollections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureFirewallNetworkRuleCollection>(
            guardedValue,
            (value) => AzureFirewallNetworkRuleCollection.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
