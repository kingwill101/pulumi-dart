...
class NetworkInterfaceDnsSettingsResponse {
  ...
  factory NetworkInterfaceDnsSettingsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return NetworkInterfaceDnsSettingsResponse(
      appliedDnsServers: pulumi.Input.fromValue(
        (map['appliedDnsServers'] as List).cast<String>(),
      ),
      dnsServers: (() {
      ...
      internalDomainNameSuffix: pulumi.Input.fromValue(
        map['internalDomainNameSuffix'] as String,
      ),
