...
class VirtualNetworkPeeringVirtualNetworkResponse {
  ...
  /// Creates a new [VirtualNetworkPeeringVirtualNetworkResponse].
  ...
  const VirtualNetworkPeeringVirtualNetworkResponse({
  ...
  factory VirtualNetworkPeeringVirtualNetworkResponse.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkPeeringVirtualNetworkResponse(
