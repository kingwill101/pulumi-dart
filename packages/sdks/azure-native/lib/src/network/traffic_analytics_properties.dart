...
class TrafficAnalyticsProperties {
  /// Parameters that define the configuration of traffic analytics.
  final pulumi.Input<TrafficAnalyticsConfigurationProperties>?
  ...
  TrafficAnalyticsProperties({this.networkWatcherFlowAnalyticsConfiguration});
    ...
    return TrafficAnalyticsProperties(
      networkWatcherFlowAnalyticsConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          TrafficAnalyticsConfigurationProperties.fromMap(
