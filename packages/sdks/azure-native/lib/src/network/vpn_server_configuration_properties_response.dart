...
class VpnServerConfigurationPropertiesResponse {
  ...
  final pulumi.Input<AadAuthenticationParametersResponse>?
  aadAuthenticationParameters;

  /// List of all VpnServerConfigurationPolicyGroups.
  final pulumi.Input<List<VpnServerConfigurationPolicyGroupResponse>>?
  ...
  final pulumi.Input<List<VpnServerConfigRadiusClientRootCertificateResponse>>?
  ...
  final pulumi.Input<List<VpnServerConfigRadiusServerRootCertificateResponse>>?
  ...
  final pulumi.Input<List<VpnServerConfigVpnClientRevokedCertificateResponse>>?
  vpnClientRevokedCertificates;

  /// VPN client root certificate of VpnServerConfiguration.
  final pulumi.Input<List<VpnServerConfigVpnClientRootCertificateResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'radiusClientRootCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpnServerConfigRadiusClientRootCertificateResponse>,
            List<Map<String, dynamic>>
          >(
            radiusClientRootCertificates,
            (value) =>
      ...
      'vpnClientRevokedCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpnServerConfigVpnClientRevokedCertificateResponse>,
            List<Map<String, dynamic>>
          >(
            vpnClientRevokedCertificates,
            (value) =>
      ...
      'vpnClientRootCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpnServerConfigVpnClientRootCertificateResponse>,
            List<Map<String, dynamic>>
          >(
            vpnClientRootCertificates,
            (value) =>
  ...
  factory VpnServerConfigurationPropertiesResponse.fromMap(
    ...
    return VpnServerConfigurationPropertiesResponse(
      aadAuthenticationParameters: (() {
        ...
        return pulumi.Input.fromValue(
          AadAuthenticationParametersResponse.fromMap(
      ...
      configurationPolicyGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpnServerConfigurationPolicyGroupResponse>(
            guardedValue,
            (value) => VpnServerConfigurationPolicyGroupResponse.fromMap(
      ...
      p2SVpnGateways: pulumi.Input.fromValue(
        pulumi.Input.decodeList<P2SVpnGatewayResponse>(
          map['p2SVpnGateways']!,
          (value) => P2SVpnGatewayResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      radiusClientRootCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VpnServerConfigRadiusClientRootCertificateResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      radiusServerRootCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VpnServerConfigRadiusServerRootCertificateResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      vpnClientRevokedCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                VpnServerConfigVpnClientRevokedCertificateResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      vpnClientRootCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => VpnServerConfigVpnClientRootCertificateResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
