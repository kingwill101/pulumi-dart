...
class ConnectionMonitorOutput {
  ...
  ConnectionMonitorOutput({this.type, this.workspaceSettings});
    ...
    return <String, dynamic>{
      ...
      'workspaceSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(workspaceSettings, (value) => value.toMap()),
    };
  }
  ...
  factory ConnectionMonitorOutput.fromMap(Map<String, dynamic> map) {
    return ConnectionMonitorOutput(
      ...
      workspaceSettings: (() {
        final guardedValue = map['workspaceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectionMonitorWorkspaceSettings.fromMap(
