...
class VnetRoute {
  ...
  VnetRoute({this.staticRoutes, this.staticRoutesConfig});
    ...
    return <String, dynamic>{
      'staticRoutes':
          ...
          >(
            staticRoutes,
            (value) =>
                pulumi.Input.encodeList<StaticRoute, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'staticRoutesConfig':
          ?pulumi.Input.mapOptionalInputValue<
            StaticRoutesConfig,
            Map<String, dynamic>
          >(staticRoutesConfig, (value) => value.toMap()),
    };
  }
  ...
  factory VnetRoute.fromMap(Map<String, dynamic> map) {
    return VnetRoute(
      staticRoutes: (() {
        final guardedValue = map['staticRoutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StaticRoute>(
            guardedValue,
            (value) =>
                StaticRoute.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      staticRoutesConfig: (() {
        final guardedValue = map['staticRoutesConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StaticRoutesConfig.fromMap(
