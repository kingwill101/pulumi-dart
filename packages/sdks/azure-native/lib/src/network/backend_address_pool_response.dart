...
class BackendAddressPoolResponse {
  ...
  factory BackendAddressPoolResponse.fromMap(Map<String, dynamic> map) {
    return BackendAddressPoolResponse(
      ...
      tunnelInterfaces: (() { final guardedValue = map['tunnelInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GatewayLoadBalancerTunnelInterfaceResponse>(guardedValue, (value) => GatewayLoadBalancerTunnelInterfaceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
