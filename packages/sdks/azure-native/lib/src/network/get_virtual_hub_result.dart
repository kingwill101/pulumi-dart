...
class GetVirtualHubResult {
  ...
  final VirtualRouterAutoScaleConfigurationResponse?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualHubRouteTableV2s': ?(() {
        final guardedValue = virtualHubRouteTableV2s;
      ...
      'virtualRouterAutoScaleConfiguration':
          ?virtualRouterAutoScaleConfiguration?.toMap(),
  ...
  factory GetVirtualHubResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualHubResult(
      ...
      azureFirewall: (() {
        final guardedValue = map['azureFirewall'];
        if (guardedValue == null) return null;
        return SubResourceResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      })(),
      bgpConnections: pulumi.Input.decodeList<SubResourceResponse>(
        map['bgpConnections']!,
        (value) =>
      ...
      expressRouteGateway: (() {
        final guardedValue = map['expressRouteGateway'];
        if (guardedValue == null) return null;
        return SubResourceResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      ipConfigurations: pulumi.Input.decodeList<SubResourceResponse>(
      ...
      p2SVpnGateway: (() {
        final guardedValue = map['p2SVpnGateway'];
        if (guardedValue == null) return null;
        return SubResourceResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      preferredRoutingGateway: (() {
        final guardedValue = map['preferredRoutingGateway'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      provisioningState: map['provisioningState'] as String,
      routeMaps: pulumi.Input.decodeList<SubResourceResponse>(
        map['routeMaps']!,
        (value) =>
            SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      securityPartnerProvider: (() {
        final guardedValue = map['securityPartnerProvider'];
        if (guardedValue == null) return null;
        return SubResourceResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      virtualHubRouteTableV2s: (() {
        final guardedValue = map['virtualHubRouteTableV2s'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VirtualHubRouteTableV2Response>(
          guardedValue,
          (value) => VirtualHubRouteTableV2Response.fromMap(
      ...
      virtualRouterAutoScaleConfiguration: (() {
        final guardedValue = map['virtualRouterAutoScaleConfiguration'];
        if (guardedValue == null) return null;
      ...
      virtualWan: (() {
        final guardedValue = map['virtualWan'];
        if (guardedValue == null) return null;
        return SubResourceResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
