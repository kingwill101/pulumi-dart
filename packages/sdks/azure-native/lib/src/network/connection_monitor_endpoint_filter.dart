...
class ConnectionMonitorEndpointFilter {
  ...
  ConnectionMonitorEndpointFilter({this.items, this.type});
    ...
    return ConnectionMonitorEndpointFilter(
      items: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConnectionMonitorEndpointFilterItem>(
            guardedValue,
            (value) => ConnectionMonitorEndpointFilterItem.fromMap(
