...
class ApplicationGatewaySslProfileResponse {
  ...
  factory ApplicationGatewaySslProfileResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewaySslProfileResponse(
      clientAuthConfiguration: (() { final guardedValue = map['clientAuthConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationGatewayClientAuthConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      trustedClientCertificates: (() { final guardedValue = map['trustedClientCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubResourceResponse>(guardedValue, (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
