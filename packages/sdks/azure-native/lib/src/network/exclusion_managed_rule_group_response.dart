...
class ExclusionManagedRuleGroupResponse {
  ...
  ExclusionManagedRuleGroupResponse({required this.ruleGroupName, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ExclusionManagedRuleResponse>,
    ...
    return ExclusionManagedRuleGroupResponse(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExclusionManagedRuleResponse>(
            guardedValue,
            (value) => ExclusionManagedRuleResponse.fromMap(
