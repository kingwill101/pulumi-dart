...
class ExclusionManagedRuleGroup {
  ...
  ExclusionManagedRuleGroup({required this.ruleGroupName, this.rules});
    ...
    return ExclusionManagedRuleGroup(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExclusionManagedRule>(
            guardedValue,
            (value) => ExclusionManagedRule.fromMap(
