...
class NspAccessRule extends pulumi.CustomResource {
  ...
  /// Creates a new [NspAccessRule].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [NspAccessRule]. {@macro pulumi_network_nsp_access_rule_args_doc}
  ...
  /// Creates a typed reference to an existing [NspAccessRule] resource.
  NspAccessRule.reference(String urn)
    : super(
        'azure-native:network:NspAccessRule',
