...
/// }
///
/// resource "azure-native_network_networksecurityperimeter" "networkSecurityPerimeter" {
...
class NetworkSecurityPerimeter extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [NetworkSecurityPerimeter] resource.
  NetworkSecurityPerimeter.reference(String urn)
    : super(
        'azure-native:network:NetworkSecurityPerimeter',
