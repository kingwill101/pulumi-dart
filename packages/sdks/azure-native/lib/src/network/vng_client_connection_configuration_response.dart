...
class VngClientConnectionConfigurationResponse {
  ...
  final pulumi.Input<List<SubResourceResponse>> virtualNetworkGatewayPolicyGroups;
  ...
  const VngClientConnectionConfigurationResponse({
    required this.etag,
    this.id,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualNetworkGatewayPolicyGroups': pulumi.Input.mapInputValue<List<SubResourceResponse>, List<Map<String, dynamic>>>(virtualNetworkGatewayPolicyGroups, (value) => pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'vpnClientAddressPool': pulumi.Input.mapInputValue<AddressSpaceResponse, Map<String, dynamic>>(vpnClientAddressPool, (value) => value.toMap()),
    };
  }
  ...
  factory VngClientConnectionConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return VngClientConnectionConfigurationResponse(
      ...
      virtualNetworkGatewayPolicyGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<SubResourceResponse>(map['virtualNetworkGatewayPolicyGroups']!, (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      vpnClientAddressPool: pulumi.Input.fromValue(AddressSpaceResponse.fromMap((map['vpnClientAddressPool']! as Map).cast<String, dynamic>())),
    );
  }
}
