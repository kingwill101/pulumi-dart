...
class ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse {
  ...
  /// Creates a new [ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse].
  ...
  /// [type] Resource type.
  const ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse({
    this.description,
    required this.etag,
    this.id,
    this.name,
  ...
  factory ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse(
