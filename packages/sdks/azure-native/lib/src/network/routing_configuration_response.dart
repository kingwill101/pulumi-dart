...
class RoutingConfigurationResponse {
  ...
  factory RoutingConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
