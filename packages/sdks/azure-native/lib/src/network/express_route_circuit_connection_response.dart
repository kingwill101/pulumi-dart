...
class ExpressRouteCircuitConnectionResponse {
  ...
  factory ExpressRouteCircuitConnectionResponse.fromMap(Map<String, dynamic> map) {
    return ExpressRouteCircuitConnectionResponse(
      ...
      ipv6CircuitConnectionConfig: (() { final guardedValue = map['ipv6CircuitConnectionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ipv6CircuitConnectionConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
