...
class ExpressRouteCircuitConnectionResponse {
  ...
  final pulumi.Input<Ipv6CircuitConnectionConfigResponse>?
  ...
  factory ExpressRouteCircuitConnectionResponse.fromMap(
    ...
    return ExpressRouteCircuitConnectionResponse(
      ...
      ipv6CircuitConnectionConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Ipv6CircuitConnectionConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
