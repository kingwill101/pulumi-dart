...
class GetStaticCidrResult {
  ...
  factory GetStaticCidrResult.fromMap(Map<String, dynamic> map) {
    return GetStaticCidrResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return StaticCidrPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
