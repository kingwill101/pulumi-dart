...
class OutboundRuleResponse {
  ...
  factory OutboundRuleResponse.fromMap(Map<String, dynamic> map) {
    return OutboundRuleResponse(
      ...
      backendAddressPool: pulumi.Input.fromValue(SubResourceResponse.fromMap((map['backendAddressPool']! as Map).cast<String, dynamic>())),
      ...
      frontendIPConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<SubResourceResponse>(map['frontendIPConfigurations']!, (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()))),
