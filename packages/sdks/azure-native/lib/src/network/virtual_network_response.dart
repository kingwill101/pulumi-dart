...
class VirtualNetworkResponse {
  ...
  final pulumi.Input<List<VirtualNetworkPeeringResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualNetworkPeerings':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworkPeeringResponse>,
            List<Map<String, dynamic>>
          >(
            virtualNetworkPeerings,
            (value) =>
  ...
  factory VirtualNetworkResponse.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkResponse(
      ...
      defaultPublicNatGateway: pulumi.Input.fromValue(
        SubResourceResponse.fromMap(
          (map['defaultPublicNatGateway']! as Map).cast<String, dynamic>(),
        ),
      ),
      dhcpOptions: (() {
      ...
      flowLogs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FlowLogResponse>(
          map['flowLogs']!,
          (value) =>
      ...
      virtualNetworkPeerings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworkPeeringResponse>(
            guardedValue,
            (value) => VirtualNetworkPeeringResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
