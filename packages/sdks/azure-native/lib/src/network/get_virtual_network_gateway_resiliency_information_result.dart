...
class GetVirtualNetworkGatewayResiliencyInformationResult {
  ...
  factory GetVirtualNetworkGatewayResiliencyInformationResult.fromMap(
    ...
    return GetVirtualNetworkGatewayResiliencyInformationResult(
      components: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<ResiliencyRecommendationComponentsResponse>(
          guardedValue,
          (value) => ResiliencyRecommendationComponentsResponse.fromMap(
      ...
      maxScoreFromRecommendations: (() {
        final guardedValue = map['maxScoreFromRecommendations'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      minScoreFromRecommendations: (() {
        final guardedValue = map['minScoreFromRecommendations'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      ...
      overallScore: (() {
        final guardedValue = map['overallScore'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      scoreChange: (() {
        final guardedValue = map['scoreChange'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
    );
