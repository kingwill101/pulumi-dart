    ...
    return <String, dynamic>{
      'exceptions':
          ...
          >(
            exceptions,
            (value) =>
                pulumi.Input.encodeList<ExceptionEntry, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ManagedRulesDefinition(
      exceptions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExceptionEntry>(
            guardedValue,
            (value) =>
                ExceptionEntry.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      exclusions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OwaspCrsExclusionEntry>(
            guardedValue,
            (value) => OwaspCrsExclusionEntry.fromMap(
