    ...
    return ApplicationGatewayRewriteRule(
      actionSet: (() {
        ...
        return pulumi.Input.fromValue(
          ApplicationGatewayRewriteRuleActionSet.fromMap(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationGatewayRewriteRuleCondition>(
            guardedValue,
            (value) => ApplicationGatewayRewriteRuleCondition.fromMap(
