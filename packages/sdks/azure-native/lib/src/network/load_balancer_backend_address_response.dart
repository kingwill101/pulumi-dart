...
class LoadBalancerBackendAddressResponse {
  ...
  final pulumi.Input<List<NatRulePortMappingResponse>>
    ...
    return <String, dynamic>{
      ...
      'inboundNatRulesPortMapping':
          pulumi.Input.mapInputValue<
            List<NatRulePortMappingResponse>,
      ...
      'loadBalancerFrontendIPConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            SubResourceResponse,
            Map<String, dynamic>
          >(loadBalancerFrontendIPConfiguration, (value) => value.toMap()),
      'name': ?name,
  ...
  factory LoadBalancerBackendAddressResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerBackendAddressResponse(
      ...
      inboundNatRulesPortMapping: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NatRulePortMappingResponse>(
          map['inboundNatRulesPortMapping']!,
          (value) => NatRulePortMappingResponse.fromMap(
      ...
      loadBalancerFrontendIPConfiguration: (() {
        final guardedValue = map['loadBalancerFrontendIPConfiguration'];
        if (guardedValue == null) return null;
      ...
      networkInterfaceIPConfiguration: pulumi.Input.fromValue(
        SubResourceResponse.fromMap(
          (map['networkInterfaceIPConfiguration']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      subnet: (() {
