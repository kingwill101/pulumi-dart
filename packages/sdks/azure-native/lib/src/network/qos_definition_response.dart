...
class QosDefinitionResponse {
  ...
  factory QosDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return QosDefinitionResponse(
      destinationIpRanges: (() { final guardedValue = map['destinationIpRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<QosIpRangeResponse>(guardedValue, (value) => QosIpRangeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      destinationPortRanges: (() { final guardedValue = map['destinationPortRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<QosPortRangeResponse>(guardedValue, (value) => QosPortRangeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sourceIpRanges: (() { final guardedValue = map['sourceIpRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<QosIpRangeResponse>(guardedValue, (value) => QosIpRangeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sourcePortRanges: (() { final guardedValue = map['sourcePortRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<QosPortRangeResponse>(guardedValue, (value) => QosPortRangeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
