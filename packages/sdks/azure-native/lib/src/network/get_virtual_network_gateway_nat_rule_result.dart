...
class GetVirtualNetworkGatewayNatRuleResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': etag,
      'externalMappings': ?(() {
        final guardedValue = externalMappings;
      ...
      'id': ?id,
      'internalMappings': ?(() {
        final guardedValue = internalMappings;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
          VpnNatRuleMappingResponse,
          Map<String, dynamic>
  ...
  factory GetVirtualNetworkGatewayNatRuleResult.fromMap(
    ...
    return GetVirtualNetworkGatewayNatRuleResult(
      ...
      externalMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VpnNatRuleMappingResponse>(
          guardedValue,
