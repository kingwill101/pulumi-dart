...
class GetLoadBalancerBackendAddressPoolResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loadBalancerBackendAddresses': ?(() {
        final guardedValue = loadBalancerBackendAddresses;
      ...
      'syncMode': ?syncMode,
      'tunnelInterfaces': ?(() {
        final guardedValue = tunnelInterfaces;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetLoadBalancerBackendAddressPoolResult.fromMap(
    ...
    return GetLoadBalancerBackendAddressPoolResult(
      ...
      inboundNatRules: pulumi.Input.decodeList<SubResourceResponse>(
        map['inboundNatRules']!,
        (value) =>
      ...
      loadBalancerBackendAddresses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<LoadBalancerBackendAddressResponse>(
          guardedValue,
      ...
      loadBalancingRules: pulumi.Input.decodeList<SubResourceResponse>(
      ...
      outboundRule: SubResourceResponse.fromMap(
        (map['outboundRule']! as Map).cast<String, dynamic>(),
      ),
      outboundRules: pulumi.Input.decodeList<SubResourceResponse>(
        map['outboundRules']!,
        (value) =>
            SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ...
      tunnelInterfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<GatewayLoadBalancerTunnelInterfaceResponse>(
          guardedValue,
