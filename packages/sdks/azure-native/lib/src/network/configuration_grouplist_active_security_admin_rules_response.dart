...
class ConfigurationGrouplistActiveSecurityAdminRulesResponse {
  ...
  /// Creates a new [ConfigurationGrouplistActiveSecurityAdminRulesResponse].
  ...
  const ConfigurationGrouplistActiveSecurityAdminRulesResponse({
    this.description,
    this.id,
    this.memberType,
  ...
  factory ConfigurationGrouplistActiveSecurityAdminRulesResponse.fromMap(Map<String, dynamic> map) {
    return ConfigurationGrouplistActiveSecurityAdminRulesResponse(
