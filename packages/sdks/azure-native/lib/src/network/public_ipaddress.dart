...
class PublicIPAddress {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'natGateway':
          ?pulumi.Input.mapOptionalInputValue<NatGateway, Map<String, dynamic>>(
            natGateway,
            (value) => value.toMap(),
          ),
    ...
    return PublicIPAddress(
      ddosSettings: (() {
        ...
        return pulumi.Input.fromValue(
          DdosSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      deleteOption: (() {
      ...
      dnsSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PublicIPAddressDnsSettings.fromMap(
      ...
      natGateway: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NatGateway.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
