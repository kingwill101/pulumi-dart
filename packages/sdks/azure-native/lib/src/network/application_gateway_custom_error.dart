...
class ApplicationGatewayCustomError {
  ...
  final pulumi.Input<dynamic>? statusCode;
  ...
  factory ApplicationGatewayCustomError.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayCustomError(
      ...
      statusCode: (() { final guardedValue = map['statusCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
