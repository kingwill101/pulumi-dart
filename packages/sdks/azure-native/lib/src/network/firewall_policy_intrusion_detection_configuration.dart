...
class FirewallPolicyIntrusionDetectionConfiguration {
  ...
  final pulumi.Input<
    List<FirewallPolicyIntrusionDetectionSignatureSpecification>
  >?
  signatureOverrides;
  ...
  factory FirewallPolicyIntrusionDetectionConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return FirewallPolicyIntrusionDetectionConfiguration(
      bypassTrafficSettings: (() {
        final guardedValue = map['bypassTrafficSettings'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyIntrusionDetectionBypassTrafficSpecifications.fromMap(
      ...
      signatureOverrides: (() {
        final guardedValue = map['signatureOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            FirewallPolicyIntrusionDetectionSignatureSpecification
          >(
            guardedValue,
            (value) =>
                FirewallPolicyIntrusionDetectionSignatureSpecification.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
