...
import 'managed_service_identity_virtual_network_appliance_response.dart';
import 'retention_policy_parameters_response.dart';
import 'traffic_analytics_properties_response.dart';

/// A flow log resource.
class FlowLogVirtualNetworkApplianceResponse {
  ...
  final pulumi.Input<ManagedServiceIdentityVirtualNetworkApplianceResponse>? identity;
  /// Resource location.
  ...
  /// Creates a new [FlowLogVirtualNetworkApplianceResponse].
  ...
  /// [type] Resource type.
  const FlowLogVirtualNetworkApplianceResponse({
    this.enabled,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'identity': ?pulumi.Input.mapOptionalInputValue<ManagedServiceIdentityVirtualNetworkApplianceResponse, Map<String, dynamic>>(identity, (value) => value.toMap()),
      'location': ?location,
      'name': name,
  ...
  factory FlowLogVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return FlowLogVirtualNetworkApplianceResponse(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedServiceIdentityVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
