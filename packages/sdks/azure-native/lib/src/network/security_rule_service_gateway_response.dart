...
class SecurityRuleServiceGatewayResponse {
  ...
  /// Creates a new [SecurityRuleServiceGatewayResponse].
  ...
  /// [type] Resource type.
  const SecurityRuleServiceGatewayResponse({
  ...
  factory SecurityRuleServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return SecurityRuleServiceGatewayResponse(
