...
class StaticRoutesConfigExpressRouteGatewayResponse {
  ...
  /// Creates a new [StaticRoutesConfigExpressRouteGatewayResponse].
  ...
  const StaticRoutesConfigExpressRouteGatewayResponse({
  ...
  factory StaticRoutesConfigExpressRouteGatewayResponse.fromMap(Map<String, dynamic> map) {
    return StaticRoutesConfigExpressRouteGatewayResponse(
