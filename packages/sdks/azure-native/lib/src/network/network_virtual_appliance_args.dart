...
class NetworkVirtualApplianceArgs {
  ...
  final pulumi.Input<List<VirtualApplianceAdditionalNicProperties>>?
  additionalNics;
  ...
  final pulumi.Input<List<InternetIngressPublicIpsProperties>>?
  ...
  final pulumi.Input<NetworkVirtualAppliancePropertiesFormatNetworkProfile>?
  networkProfile;
    ...
    return <String, dynamic>{
      'additionalNics':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualApplianceAdditionalNicProperties>,
  ...
  factory NetworkVirtualApplianceArgs.fromMap(Map<String, dynamic> map) {
    return NetworkVirtualApplianceArgs(
      additionalNics: (() {
        final guardedValue = map['additionalNics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualApplianceAdditionalNicProperties>(
            guardedValue,
            (value) => VirtualApplianceAdditionalNicProperties.fromMap(
      ...
      bootStrapConfigurationBlobs: (() {
        final guardedValue = map['bootStrapConfigurationBlobs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      cloudInitConfiguration: (() {
        final guardedValue = map['cloudInitConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cloudInitConfigurationBlobs: (() {
        final guardedValue = map['cloudInitConfigurationBlobs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      delegation: (() {
      ...
      internetIngressPublicIps: (() {
        final guardedValue = map['internetIngressPublicIps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InternetIngressPublicIpsProperties>(
            guardedValue,
            (value) => InternetIngressPublicIpsProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      networkProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkVirtualAppliancePropertiesFormatNetworkProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      networkVirtualApplianceName: (() {
        final guardedValue = map['networkVirtualApplianceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nvaSku: (() {
        final guardedValue = map['nvaSku'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualApplianceSkuProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      virtualApplianceAsn: (() {
        final guardedValue = map['virtualApplianceAsn'];
        if (guardedValue == null) return null;
