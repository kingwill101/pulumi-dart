...
/// }
///
/// resource "azure-native_network_privatelinkserviceprivateendpointconnection" "privateLinkServicePrivateEndpointConnection" {
///   name               = "testPlePeConnection"
...
class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateLinkServicePrivateEndpointConnection] resource.
  PrivateLinkServicePrivateEndpointConnection.reference(String urn)
    : super(
        'azure-native:network:PrivateLinkServicePrivateEndpointConnection',
