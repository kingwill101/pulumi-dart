...
class VirtualNetworkGatewayPolicyGroupResponse {
  ...
  final pulumi.Input<List<SubResourceResponse>> vngClientConnectionConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'isDefault': isDefault,
      'name': ?name,
      'policyMembers': pulumi.Input.mapInputValue<List<VirtualNetworkGatewayPolicyGroupMemberResponse>, List<Map<String, dynamic>>>(policyMembers, (value) => pulumi.Input.encodeList<VirtualNetworkGatewayPolicyGroupMemberResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'priority': priority,
      'provisioningState': provisioningState,
      'vngClientConnectionConfigurations': pulumi.Input.mapInputValue<List<SubResourceResponse>, List<Map<String, dynamic>>>(vngClientConnectionConfigurations, (value) => pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory VirtualNetworkGatewayPolicyGroupResponse.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayPolicyGroupResponse(
      ...
      policyMembers: (pulumi.Input.decodeList<VirtualNetworkGatewayPolicyGroupMemberResponse>(map['policyMembers'], (value) => VirtualNetworkGatewayPolicyGroupMemberResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      priority: (map['priority'] as int).input(),
      provisioningState: (map['provisioningState'] as String).input(),
      vngClientConnectionConfigurations: (pulumi.Input.decodeList<SubResourceResponse>(map['vngClientConnectionConfigurations'], (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
