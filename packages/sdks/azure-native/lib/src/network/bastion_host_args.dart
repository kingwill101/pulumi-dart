...
class BastionHostArgs {
  ...
  factory BastionHostArgs.fromMap(Map<String, dynamic> map) {
    return BastionHostArgs(
      bastionHostName: (() {
        final guardedValue = map['bastionHostName'];
      ...
      ipConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BastionHostIPConfiguration>(
            guardedValue,
            (value) => BastionHostIPConfiguration.fromMap(
      ...
      networkAcls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BastionHostPropertiesFormatNetworkAcls.fromMap(
