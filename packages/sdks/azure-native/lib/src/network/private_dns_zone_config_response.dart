...
class PrivateDnsZoneConfigResponse {
  ...
  factory PrivateDnsZoneConfigResponse.fromMap(Map<String, dynamic> map) {
    return PrivateDnsZoneConfigResponse(
      ...
      recordSets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RecordSetResponse>(
          map['recordSets']!,
          (value) =>
              RecordSetResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
