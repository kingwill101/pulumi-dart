...
class SecurityUserRuleCollectionArgs {
  ...
  SecurityUserRuleCollectionArgs({
    required pulumi.Output<List<SecurityUserGroupItem>> appliesToGroups,
    ...
    pulumi.Output<String>? ruleCollectionName,
      ...
      appliesToGroups = pulumi.Input.asInput<List<SecurityUserGroupItem>>(appliesToGroups),
  ...
  factory SecurityUserRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return SecurityUserRuleCollectionArgs(
      appliesToGroups: pulumi.Output.create<List<SecurityUserGroupItem>>(pulumi.Input.decodeList<SecurityUserGroupItem>(map['appliesToGroups'], (value) => SecurityUserGroupItem.fromMap((value as Map).cast<String, dynamic>()))),
