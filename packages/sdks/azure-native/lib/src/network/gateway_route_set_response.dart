...
class GatewayRouteSetResponse {
  ...
  /// [name] Route Set name
  GatewayRouteSetResponse({this.details, this.locations, this.name});
    ...
    return GatewayRouteSetResponse(
      details: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<List<RouteSourceDetailsResponse>>(
            guardedValue,
            (value) => pulumi.Input.decodeList<RouteSourceDetailsResponse>(
              value,
              (value) => RouteSourceDetailsResponse.fromMap(
