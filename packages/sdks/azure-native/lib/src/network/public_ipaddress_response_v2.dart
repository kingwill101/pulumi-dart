...
import 'nat_gateway_virtual_network_appliance_response.dart';
...
class PublicIPAddressResponseV2 {
  ...
  final pulumi.Input<IPConfigurationVirtualNetworkApplianceResponse> ipConfiguration;
  /// The list of tags associated with the public IP address.
  final pulumi.Input<List<IpTagResponse>?>? ipTags;
  /// The linked public IP address of the public IP address resource.
  final pulumi.Input<PublicIPAddressVirtualNetworkApplianceResponse?>? linkedPublicIPAddress;
  /// Resource location.
  ...
  final pulumi.Input<NatGatewayVirtualNetworkApplianceResponse?>? natGateway;
  ...
  final pulumi.Input<PublicIPAddressVirtualNetworkApplianceResponse?>? servicePublicIPAddress;
  ...
  /// Creates a new [PublicIPAddressResponseV2].
  ...
  const PublicIPAddressResponseV2({
    this.ddosSettings,
    this.deleteOption,
    this.dnsSettings,
    required this.etag,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipAddress': ?ipAddress,
      'ipConfiguration': pulumi.Input.mapInputValue<IPConfigurationVirtualNetworkApplianceResponse, Map<String, dynamic>>(ipConfiguration, (value) => value.toMap()),
      ...
      'linkedPublicIPAddress': ?pulumi.Input.mapOptionalInputValue<PublicIPAddressVirtualNetworkApplianceResponse, Map<String, dynamic>>(linkedPublicIPAddress, (value) => value.toMap()),
      'location': ?location,
      'migrationPhase': ?migrationPhase,
      'name': name,
      'natGateway': ?pulumi.Input.mapOptionalInputValue<NatGatewayVirtualNetworkApplianceResponse, Map<String, dynamic>>(natGateway, (value) => value.toMap()),
      ...
      'servicePublicIPAddress': ?pulumi.Input.mapOptionalInputValue<PublicIPAddressVirtualNetworkApplianceResponse, Map<String, dynamic>>(servicePublicIPAddress, (value) => value.toMap()),
  ...
  factory PublicIPAddressResponseV2.fromMap(Map<String, dynamic> map) {
    return PublicIPAddressResponseV2(
      ddosSettings: (() { final guardedValue = map['ddosSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DdosSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      dnsSettings: (() { final guardedValue = map['dnsSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicIPAddressDnsSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ipConfiguration: pulumi.Input.fromValue(IPConfigurationVirtualNetworkApplianceResponse.fromMap((map['ipConfiguration']! as Map).cast<String, dynamic>())),
      ...
      linkedPublicIPAddress: (() { final guardedValue = map['linkedPublicIPAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicIPAddressVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      natGateway: (() { final guardedValue = map['natGateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NatGatewayVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      servicePublicIPAddress: (() { final guardedValue = map['servicePublicIPAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicIPAddressVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
