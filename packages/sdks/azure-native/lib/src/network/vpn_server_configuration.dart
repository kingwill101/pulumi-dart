...
class VpnServerConfiguration extends pulumi.CustomResource {
  ...
  VpnServerConfiguration(
    ...
    properties = registerOutput<VpnServerConfigurationPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return VpnServerConfigurationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
