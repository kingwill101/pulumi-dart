...
class DscpConfiguration extends pulumi.CustomResource {
  ...
  DscpConfiguration(
    ...
    associatedNetworkInterfaces = registerOutput<List<Map<String, dynamic>>>(
      'associatedNetworkInterfaces',
    );
    ...
    destinationPortRanges = registerOutput<List<Map<String, dynamic>>?>(
      'destinationPortRanges',
    );
    ...
    qosDefinitionCollection = registerOutput<List<Map<String, dynamic>>?>(
      'qosDefinitionCollection',
    );
    ...
    sourcePortRanges = registerOutput<List<Map<String, dynamic>>?>(
      'sourcePortRanges',
    );
