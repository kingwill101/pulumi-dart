...
class DscpConfiguration extends pulumi.CustomResource {
  ...
  DscpConfiguration(
    ...
    associatedNetworkInterfaces = registerOutput<List<NetworkInterfaceResponse>>('associatedNetworkInterfaces', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<NetworkInterfaceResponse>(guardedValue, (value) => NetworkInterfaceResponse.fromMap((value as Map).cast<String, dynamic>())); });
    azureApiVersion = registerOutput<String>('azureApiVersion');
    destinationIpRanges = registerOutput<List<QosIpRangeResponse>?>('destinationIpRanges', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<QosIpRangeResponse>(guardedValue, (value) => QosIpRangeResponse.fromMap((value as Map).cast<String, dynamic>())); });
    destinationPortRanges = registerOutput<List<QosPortRangeResponse>?>('destinationPortRanges', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<QosPortRangeResponse>(guardedValue, (value) => QosPortRangeResponse.fromMap((value as Map).cast<String, dynamic>())); });
    etag = registerOutput<String>('etag');
    location = registerOutput<String?>('location');
    markings = registerOutput<List<int>?>('markings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<int>(); });
    this.name = registerOutput<String>('name');
    protocol = registerOutput<String?>('protocol');
    provisioningState = registerOutput<String>('provisioningState');
    qosCollectionId = registerOutput<String>('qosCollectionId');
    qosDefinitionCollection = registerOutput<List<QosDefinitionResponse>?>('qosDefinitionCollection', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<QosDefinitionResponse>(guardedValue, (value) => QosDefinitionResponse.fromMap((value as Map).cast<String, dynamic>())); });
    resourceGuid = registerOutput<String>('resourceGuid');
    sourceIpRanges = registerOutput<List<QosIpRangeResponse>?>('sourceIpRanges', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<QosIpRangeResponse>(guardedValue, (value) => QosIpRangeResponse.fromMap((value as Map).cast<String, dynamic>())); });
    sourcePortRanges = registerOutput<List<QosPortRangeResponse>?>('sourcePortRanges', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<QosPortRangeResponse>(guardedValue, (value) => QosPortRangeResponse.fromMap((value as Map).cast<String, dynamic>())); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [DscpConfiguration] resource.
  DscpConfiguration.reference(String urn)
    : super(
        'azure-native:network:DscpConfiguration',
