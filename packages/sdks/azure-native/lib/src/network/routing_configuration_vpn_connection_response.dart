...
import 'vnet_route_vpn_connection_response.dart';

/// Routing Configuration indicating the associated and propagated route tables for this connection.
class RoutingConfigurationVpnConnectionResponse {
  ...
  final pulumi.Input<VnetRouteVpnConnectionResponse?>? vnetRoutes;

  /// Creates a new [RoutingConfigurationVpnConnectionResponse].
  ...
  const RoutingConfigurationVpnConnectionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRouteVpnConnectionResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationVpnConnectionResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationVpnConnectionResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteVpnConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
