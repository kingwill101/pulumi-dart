...
class FirewallPolicyLogAnalyticsResourcesResponse {
  ...
  final pulumi.Input<List<FirewallPolicyLogAnalyticsWorkspaceResponse>>?
  workspaces;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'workspaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyLogAnalyticsWorkspaceResponse>,
  ...
  factory FirewallPolicyLogAnalyticsResourcesResponse.fromMap(
    ...
    return FirewallPolicyLogAnalyticsResourcesResponse(
      ...
      workspaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyLogAnalyticsWorkspaceResponse>(
            guardedValue,
            (value) => FirewallPolicyLogAnalyticsWorkspaceResponse.fromMap(
