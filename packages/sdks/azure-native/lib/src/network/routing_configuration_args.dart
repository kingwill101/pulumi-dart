...
/// {@template pulumi_network_routing_configuration_args_doc}
/// The set of arguments for RoutingConfiguration.
/// {@endtemplate}
/// {@macro pulumi_network_routing_configuration_args_doc}
class RoutingConfigurationArgs {
  ...
  /// Creates a new [RoutingConfigurationArgs].
  ...
  const RoutingConfigurationArgs({
  ...
  factory RoutingConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationArgs(
