...
class O365PolicyProperties {
  ...
  factory O365PolicyProperties.fromMap(Map<String, dynamic> map) {
    return O365PolicyProperties(
      breakOutCategories: (() { final guardedValue = map['breakOutCategories']; if (guardedValue == null) return null; return pulumi.Input.fromValue(O365BreakOutCategoryPolicies.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
