...
import 'application_gateway_backend_address_pool_interface_endpoint_response.dart';
...
class NetworkInterfaceIPConfigurationResponseV1 {
  /// The reference of ApplicationGatewayBackendAddressPool resource.
  final pulumi.Input<List<ApplicationGatewayBackendAddressPoolInterfaceEndpointResponse>?>? applicationGatewayBackendAddressPools;
  ...
  /// Creates a new [NetworkInterfaceIPConfigurationResponseV1].
  ...
  const NetworkInterfaceIPConfigurationResponseV1({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applicationGatewayBackendAddressPools': ?pulumi.Input.mapOptionalInputValue<List<ApplicationGatewayBackendAddressPoolInterfaceEndpointResponse>, List<Map<String, dynamic>>>(applicationGatewayBackendAddressPools, (value) => pulumi.Input.encodeList<ApplicationGatewayBackendAddressPoolInterfaceEndpointResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory NetworkInterfaceIPConfigurationResponseV1.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceIPConfigurationResponseV1(
      applicationGatewayBackendAddressPools: (() { final guardedValue = map['applicationGatewayBackendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayBackendAddressPoolInterfaceEndpointResponse>(guardedValue, (value) => ApplicationGatewayBackendAddressPoolInterfaceEndpointResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
