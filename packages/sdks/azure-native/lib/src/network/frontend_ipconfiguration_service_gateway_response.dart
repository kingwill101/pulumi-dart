...
import 'public_ipaddress_response_v1.dart';
import 'sub_resource_response.dart';
import 'subnet_response.dart';

/// Frontend IP address of the load balancer.
class FrontendIPConfigurationServiceGatewayResponse {
  ...
  const FrontendIPConfigurationServiceGatewayResponse({
    required this.etag,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicIPAddress': ?pulumi.Input.mapOptionalInputValue<PublicIPAddressResponseV1, Map<String, dynamic>>(publicIPAddress, (value) => value.toMap()),
  ...
  factory FrontendIPConfigurationServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return FrontendIPConfigurationServiceGatewayResponse(
      ...
      publicIPAddress: (() { final guardedValue = map['publicIPAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicIPAddressResponseV1.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
