...
class FirewallPolicyTransportSecurityResponse {
  ...
  final pulumi.Input<FirewallPolicyCertificateAuthorityResponse>?
  certificateAuthority;

  /// Creates a new [FirewallPolicyTransportSecurityResponse].
  /// [certificateAuthority] The CA used for intermediate CA generation.
  FirewallPolicyTransportSecurityResponse({this.certificateAuthority});
  ...
  factory FirewallPolicyTransportSecurityResponse.fromMap(
    ...
    return FirewallPolicyTransportSecurityResponse(
      certificateAuthority: (() {
        ...
        return pulumi.Input.fromValue(
          FirewallPolicyCertificateAuthorityResponse.fromMap(
