...
class StaticRoutesConfigNetworkVirtualApplianceConnectionResponse {
  ...
  /// Creates a new [StaticRoutesConfigNetworkVirtualApplianceConnectionResponse].
  ...
  const StaticRoutesConfigNetworkVirtualApplianceConnectionResponse({
  ...
  factory StaticRoutesConfigNetworkVirtualApplianceConnectionResponse.fromMap(Map<String, dynamic> map) {
    return StaticRoutesConfigNetworkVirtualApplianceConnectionResponse(
