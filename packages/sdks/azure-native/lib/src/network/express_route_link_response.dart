...
class ExpressRouteLinkResponse {
  ...
  factory ExpressRouteLinkResponse.fromMap(Map<String, dynamic> map) {
    return ExpressRouteLinkResponse(
      ...
      macSecConfig: (() { final guardedValue = map['macSecConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExpressRouteLinkMacSecConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
