...
/// }
///
/// resource "azure-native_network_managementgroupnetworkmanagerconnection" "managementGroupNetworkManagerConnection" {
...
class ManagementGroupNetworkManagerConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ManagementGroupNetworkManagerConnection] resource.
  ManagementGroupNetworkManagerConnection.reference(String urn)
    : super(
        'azure-native:network:ManagementGroupNetworkManagerConnection',
