...
import 'ipconfiguration_virtual_network_appliance_response.dart';
import 'network_security_group_virtual_network_appliance_response.dart';
import 'private_endpoint_virtual_network_appliance_response.dart';
import 'resource_navigation_link_response.dart';
import 'route_table_virtual_network_appliance_response.dart';
import 'service_association_link_response.dart';
import 'service_endpoint_policy_virtual_network_appliance_response.dart';
import 'service_endpoint_properties_format_response.dart';
import 'sub_resource_response.dart';

/// Subnet in a virtual network resource.
class SubnetVirtualNetworkApplianceResponse {
  ...
  final pulumi.Input<List<IPConfigurationVirtualNetworkApplianceResponse>> ipConfigurations;
  ...
  final pulumi.Input<NetworkSecurityGroupVirtualNetworkApplianceResponse>? networkSecurityGroup;
  /// Enable or Disable apply network policies on private end point in the subnet.
  final pulumi.Input<String>? privateEndpointNetworkPolicies;
  /// An array of references to private endpoints.
  final pulumi.Input<List<PrivateEndpointVirtualNetworkApplianceResponse>> privateEndpoints;
  ...
  final pulumi.Input<RouteTableVirtualNetworkApplianceResponse>? routeTable;
  /// An array of references to services injecting into this subnet.
  final pulumi.Input<List<ServiceAssociationLinkResponse>> serviceAssociationLinks;
  /// An array of service endpoint policies.
  final pulumi.Input<List<ServiceEndpointPolicyVirtualNetworkApplianceResponse>>? serviceEndpointPolicies;
  ...
  /// Creates a new [SubnetVirtualNetworkApplianceResponse].
  ...
  /// [type] Resource type.
  const SubnetVirtualNetworkApplianceResponse({
    this.addressPrefix,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations': pulumi.Input.mapInputValue<List<IPConfigurationVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(ipConfigurations, (value) => pulumi.Input.encodeList<IPConfigurationVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'networkSecurityGroup': ?pulumi.Input.mapOptionalInputValue<NetworkSecurityGroupVirtualNetworkApplianceResponse, Map<String, dynamic>>(networkSecurityGroup, (value) => value.toMap()),
      'privateEndpointNetworkPolicies': ?privateEndpointNetworkPolicies,
      'privateEndpoints': pulumi.Input.mapInputValue<List<PrivateEndpointVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(privateEndpoints, (value) => pulumi.Input.encodeList<PrivateEndpointVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'routeTable': ?pulumi.Input.mapOptionalInputValue<RouteTableVirtualNetworkApplianceResponse, Map<String, dynamic>>(routeTable, (value) => value.toMap()),
      ...
      'serviceEndpointPolicies': ?pulumi.Input.mapOptionalInputValue<List<ServiceEndpointPolicyVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(serviceEndpointPolicies, (value) => pulumi.Input.encodeList<ServiceEndpointPolicyVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory SubnetVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return SubnetVirtualNetworkApplianceResponse(
      ...
      ipConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<IPConfigurationVirtualNetworkApplianceResponse>(map['ipConfigurations']!, (value) => IPConfigurationVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      networkSecurityGroup: (() { final guardedValue = map['networkSecurityGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkSecurityGroupVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      privateEndpoints: pulumi.Input.fromValue(pulumi.Input.decodeList<PrivateEndpointVirtualNetworkApplianceResponse>(map['privateEndpoints']!, (value) => PrivateEndpointVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      routeTable: (() { final guardedValue = map['routeTable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouteTableVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      serviceEndpointPolicies: (() { final guardedValue = map['serviceEndpointPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceEndpointPolicyVirtualNetworkApplianceResponse>(guardedValue, (value) => ServiceEndpointPolicyVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
