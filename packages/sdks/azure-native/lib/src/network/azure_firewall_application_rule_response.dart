...
class AzureFirewallApplicationRuleResponse {
  ...
  final pulumi.Input<List<AzureFirewallApplicationRuleProtocolResponse>>?
  protocols;
    ...
    return <String, dynamic>{
      ...
      'protocols':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureFirewallApplicationRuleProtocolResponse>,
  ...
  factory AzureFirewallApplicationRuleResponse.fromMap(
    ...
    return AzureFirewallApplicationRuleResponse(
      ...
      protocols: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureFirewallApplicationRuleProtocolResponse>(
            guardedValue,
            (value) => AzureFirewallApplicationRuleProtocolResponse.fromMap(
