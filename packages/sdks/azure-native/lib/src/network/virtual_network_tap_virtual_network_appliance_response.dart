...
class VirtualNetworkTapVirtualNetworkApplianceResponse {
  /// The reference to the private IP address on the internal Load Balancer that will receive the tap.
  final pulumi.Input<FrontendIPConfigurationVirtualNetworkApplianceResponse?>? destinationLoadBalancerFrontEndIPConfiguration;
  ...
  /// Creates a new [VirtualNetworkTapVirtualNetworkApplianceResponse].
  ...
  /// [tags] Resource tags.
  /// [type] Resource type.
  const VirtualNetworkTapVirtualNetworkApplianceResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinationLoadBalancerFrontEndIPConfiguration': ?pulumi.Input.mapOptionalInputValue<FrontendIPConfigurationVirtualNetworkApplianceResponse, Map<String, dynamic>>(destinationLoadBalancerFrontEndIPConfiguration, (value) => value.toMap()),
  ...
  factory VirtualNetworkTapVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkTapVirtualNetworkApplianceResponse(
      destinationLoadBalancerFrontEndIPConfiguration: (() { final guardedValue = map['destinationLoadBalancerFrontEndIPConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FrontendIPConfigurationVirtualNetworkApplianceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
