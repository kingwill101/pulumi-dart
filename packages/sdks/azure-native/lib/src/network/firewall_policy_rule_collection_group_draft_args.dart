...
class FirewallPolicyRuleCollectionGroupDraftArgs {
    ...
    return <String, dynamic>{
      ...
      'ruleCollections':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyFilterRuleCollection>,
  ...
  factory FirewallPolicyRuleCollectionGroupDraftArgs.fromMap(
    ...
    return FirewallPolicyRuleCollectionGroupDraftArgs(
      ...
      ruleCollections: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyFilterRuleCollection>(
            guardedValue,
            (value) => FirewallPolicyFilterRuleCollection.fromMap(
