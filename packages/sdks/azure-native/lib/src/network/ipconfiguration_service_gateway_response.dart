...
/// IP configuration.
class IPConfigurationServiceGatewayResponse {
  ...
  const IPConfigurationServiceGatewayResponse({
    required this.etag,
    this.id,
    this.name,
  ...
  factory IPConfigurationServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return IPConfigurationServiceGatewayResponse(
