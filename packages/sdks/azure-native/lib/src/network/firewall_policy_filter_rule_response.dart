...
class FirewallPolicyFilterRuleResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ruleConditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationRuleConditionResponse>,
    ...
    return FirewallPolicyFilterRuleResponse(
      action: (() {
        ...
        return pulumi.Input.fromValue(
          FirewallPolicyFilterRuleActionResponse.fromMap(
      ...
      ruleConditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationRuleConditionResponse>(
            guardedValue,
            (value) => ApplicationRuleConditionResponse.fromMap(
