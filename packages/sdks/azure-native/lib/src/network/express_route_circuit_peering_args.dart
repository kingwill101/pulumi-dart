...
class ExpressRouteCircuitPeeringArgs {
  ...
  ExpressRouteCircuitPeeringArgs({
    ...
    pulumi.Output<List<ExpressRouteCircuitConnectionNetwork>>? connections,
    ...
    pulumi.Output<SubResource>? routeFilter,
    ...
    pulumi.Output<ExpressRouteCircuitStats>? stats,
  ...
  factory ExpressRouteCircuitPeeringArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteCircuitPeeringArgs(
      ...
      connections: map['connections'] == null ? null : pulumi.Output.create<List<ExpressRouteCircuitConnectionNetwork>>((map['connections'] as List).cast<ExpressRouteCircuitConnectionNetwork>()),
      ...
      routeFilter: map['routeFilter'] == null ? null : pulumi.Output.create<SubResource>(SubResource.fromMap((map['routeFilter'] as Map).cast<String, dynamic>())),
      ...
      stats: map['stats'] == null ? null : pulumi.Output.create<ExpressRouteCircuitStats>(ExpressRouteCircuitStats.fromMap((map['stats'] as Map).cast<String, dynamic>())),
