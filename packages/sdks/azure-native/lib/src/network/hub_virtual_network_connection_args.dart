...
class HubVirtualNetworkConnectionArgs {
  ...
  factory HubVirtualNetworkConnectionArgs.fromMap(Map<String, dynamic> map) {
    return HubVirtualNetworkConnectionArgs(
      allowHubToRemoteVnetTransit: (() { final guardedValue = map['allowHubToRemoteVnetTransit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      allowRemoteVnetToUseHubVnetGateways: (() { final guardedValue = map['allowRemoteVnetToUseHubVnetGateways']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
