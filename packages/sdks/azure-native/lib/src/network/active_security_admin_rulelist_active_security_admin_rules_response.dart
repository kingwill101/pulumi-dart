...
/// Network admin rule.
class ActiveSecurityAdminRulelistActiveSecurityAdminRulesResponse {
  ...
  /// Creates a new [ActiveSecurityAdminRulelistActiveSecurityAdminRulesResponse].
  ...
  const ActiveSecurityAdminRulelistActiveSecurityAdminRulesResponse({
  ...
  factory ActiveSecurityAdminRulelistActiveSecurityAdminRulesResponse.fromMap(Map<String, dynamic> map) {
    return ActiveSecurityAdminRulelistActiveSecurityAdminRulesResponse(
