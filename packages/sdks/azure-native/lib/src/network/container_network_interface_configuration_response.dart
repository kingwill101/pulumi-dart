...
class ContainerNetworkInterfaceConfigurationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<IPConfigurationProfileResponse>,
            List<Map<String, dynamic>>
          >(
            ipConfigurations,
            (value) =>
  ...
  factory ContainerNetworkInterfaceConfigurationResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ContainerNetworkInterfaceConfigurationResponse(
      containerNetworkInterfaces: (() {
        final guardedValue = map['containerNetworkInterfaces'];
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IPConfigurationProfileResponse>(
            guardedValue,
            (value) => IPConfigurationProfileResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
