...
class ListNetworkManagerDeploymentStatusResult {
  ...
  ListNetworkManagerDeploymentStatusResult({this.skipToken, this.value});
  ...
  factory ListNetworkManagerDeploymentStatusResult.fromMap(
    ...
    return ListNetworkManagerDeploymentStatusResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NetworkManagerDeploymentStatusResponse>(
          guardedValue,
          (value) => NetworkManagerDeploymentStatusResponse.fromMap(
