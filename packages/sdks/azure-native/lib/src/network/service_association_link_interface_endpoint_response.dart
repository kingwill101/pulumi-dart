...
class ServiceAssociationLinkInterfaceEndpointResponse {
  ...
  /// Creates a new [ServiceAssociationLinkInterfaceEndpointResponse].
  ...
  /// [provisioningState] Provisioning state of the ServiceAssociationLink resource.
  const ServiceAssociationLinkInterfaceEndpointResponse({
    required this.etag,
    this.id,
    this.link,
  ...
  factory ServiceAssociationLinkInterfaceEndpointResponse.fromMap(Map<String, dynamic> map) {
    return ServiceAssociationLinkInterfaceEndpointResponse(
