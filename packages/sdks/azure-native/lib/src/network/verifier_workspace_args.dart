...
class VerifierWorkspaceArgs {
  ...
  factory VerifierWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return VerifierWorkspaceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VerifierWorkspaceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
