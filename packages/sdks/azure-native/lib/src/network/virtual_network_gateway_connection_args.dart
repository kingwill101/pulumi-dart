...
class VirtualNetworkGatewayConnectionArgs {
  ...
  VirtualNetworkGatewayConnectionArgs({
    ...
    required pulumi.Output<String> connectionType,
    pulumi.Output<int>? dpdTimeoutSeconds,
    pulumi.Output<List<SubResource>>? egressNatRules,
    pulumi.Output<bool>? enableBgp,
    pulumi.Output<bool>? enablePrivateLinkFastPath,
    pulumi.Output<bool>? expressRouteGatewayBypass,
    pulumi.Output<List<GatewayCustomBgpIpAddressIpConfiguration>>? gatewayCustomBgpIpAddresses,
    pulumi.Output<String>? id,
    pulumi.Output<List<SubResource>>? ingressNatRules,
    pulumi.Output<List<IpsecPolicy>>? ipsecPolicies,
    pulumi.Output<LocalNetworkGatewayNetwork>? localNetworkGateway2,
    pulumi.Output<String>? location,
    pulumi.Output<SubResource>? peer,
    ...
    required pulumi.Output<VirtualNetworkGatewayNetwork> virtualNetworkGateway1,
    pulumi.Output<VirtualNetworkGatewayNetwork>? virtualNetworkGateway2,
    pulumi.Output<String>? virtualNetworkGatewayConnectionName,
  }) :
  ...
  factory VirtualNetworkGatewayConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayConnectionArgs(
      ...
      connectionType: pulumi.Output.create<String>(map['connectionType'] as String),
      dpdTimeoutSeconds: map['dpdTimeoutSeconds'] == null ? null : pulumi.Output.create<int>(map['dpdTimeoutSeconds'] as int),
      egressNatRules: map['egressNatRules'] == null ? null : pulumi.Output.create<List<SubResource>>(pulumi.Input.decodeList<SubResource>(map['egressNatRules'], (value) => SubResource.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      gatewayCustomBgpIpAddresses: map['gatewayCustomBgpIpAddresses'] == null ? null : pulumi.Output.create<List<GatewayCustomBgpIpAddressIpConfiguration>>(pulumi.Input.decodeList<GatewayCustomBgpIpAddressIpConfiguration>(map['gatewayCustomBgpIpAddresses'], (value) => GatewayCustomBgpIpAddressIpConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      id: map['id'] == null ? null : pulumi.Output.create<String>(map['id'] as String),
      ingressNatRules: map['ingressNatRules'] == null ? null : pulumi.Output.create<List<SubResource>>(pulumi.Input.decodeList<SubResource>(map['ingressNatRules'], (value) => SubResource.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      localNetworkGateway2: map['localNetworkGateway2'] == null ? null : pulumi.Output.create<LocalNetworkGatewayNetwork>(map['localNetworkGateway2'] as LocalNetworkGatewayNetwork),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      peer: map['peer'] == null ? null : pulumi.Output.create<SubResource>(SubResource.fromMap((map['peer'] as Map).cast<String, dynamic>())),
      ...
      virtualNetworkGateway1: pulumi.Output.create<VirtualNetworkGatewayNetwork>(map['virtualNetworkGateway1'] as VirtualNetworkGatewayNetwork),
      virtualNetworkGateway2: map['virtualNetworkGateway2'] == null ? null : pulumi.Output.create<VirtualNetworkGatewayNetwork>(map['virtualNetworkGateway2'] as VirtualNetworkGatewayNetwork),
      virtualNetworkGatewayConnectionName: map['virtualNetworkGatewayConnectionName'] == null ? null : pulumi.Output.create<String>(map['virtualNetworkGatewayConnectionName'] as String),
    );
  }
}
