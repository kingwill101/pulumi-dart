...
import 'vnet_route_network_virtual_appliance_connection_response.dart';

/// Routing Configuration indicating the associated and propagated route tables for this connection.
class RoutingConfigurationNetworkVirtualApplianceConnectionResponse {
  ...
  final pulumi.Input<VnetRouteNetworkVirtualApplianceConnectionResponse>? vnetRoutes;

  /// Creates a new [RoutingConfigurationNetworkVirtualApplianceConnectionResponse].
  ...
  const RoutingConfigurationNetworkVirtualApplianceConnectionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRouteNetworkVirtualApplianceConnectionResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationNetworkVirtualApplianceConnectionResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationNetworkVirtualApplianceConnectionResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteNetworkVirtualApplianceConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
