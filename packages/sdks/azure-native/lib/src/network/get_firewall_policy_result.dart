...
class GetFirewallPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'transportSecurity': ?transportSecurity == null ? null : transportSecurity!.toMap(),
      'type': type,
    };
  }
  ...
  factory GetFirewallPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetFirewallPolicyResult(
      ...
      sku: map['sku'] == null ? null : FirewallPolicySkuResponse.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      ...
      transportSecurity: map['transportSecurity'] == null ? null : FirewallPolicyTransportSecurityResponse.fromMap((map['transportSecurity'] as Map).cast<String, dynamic>()),
