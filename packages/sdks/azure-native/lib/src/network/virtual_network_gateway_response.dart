...
class VirtualNetworkGatewayResponse {
  ...
  final pulumi.Input<VirtualNetworkGatewayAutoScaleConfigurationResponse>?
  ...
  final pulumi.Input<List<VirtualNetworkGatewayIPConfigurationResponse>>?
  ipConfigurations;
  ...
  final pulumi.Input<List<VirtualNetworkGatewayPolicyGroupResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworkGatewayIPConfigurationResponse>,
      ...
      'natRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworkGatewayNatRuleResponse>,
            List<Map<String, dynamic>>
          >(
            natRules,
            (value) =>
      ...
      'virtualNetworkGatewayPolicyGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNetworkGatewayPolicyGroupResponse>,
            List<Map<String, dynamic>>
          >(
            virtualNetworkGatewayPolicyGroups,
            (value) =>
    ...
    return VirtualNetworkGatewayResponse(
      ...
      autoScaleConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualNetworkGatewayAutoScaleConfigurationResponse.fromMap(
      ...
      inboundDnsForwardingEndpoint: pulumi.Input.fromValue(
        map['inboundDnsForwardingEndpoint'] as String,
      ),
      ipConfigurations: (() {
        final guardedValue = map['ipConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworkGatewayIPConfigurationResponse>(
            guardedValue,
            (value) => VirtualNetworkGatewayIPConfigurationResponse.fromMap(
      ...
      natRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworkGatewayNatRuleResponse>(
            guardedValue,
            (value) => VirtualNetworkGatewayNatRuleResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sku: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworkGatewaySkuResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      virtualNetworkGatewayPolicyGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualNetworkGatewayPolicyGroupResponse>(
            guardedValue,
            (value) => VirtualNetworkGatewayPolicyGroupResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      vpnClientConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VpnClientConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
