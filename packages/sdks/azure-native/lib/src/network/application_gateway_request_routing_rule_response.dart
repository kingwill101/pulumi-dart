...
class ApplicationGatewayRequestRoutingRuleResponse {
  ...
  factory ApplicationGatewayRequestRoutingRuleResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayRequestRoutingRuleResponse(
      ...
      httpListener: (() { final guardedValue = map['httpListener']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      urlPathMap: (() { final guardedValue = map['urlPathMap']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
