...
/// }
///
/// resource "azure-native_network_ddoscustompolicy" "ddosCustomPolicy" {
...
class DdosCustomPolicy extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DdosCustomPolicy] resource.
  DdosCustomPolicy.reference(String urn)
    : super(
        'azure-native:network:DdosCustomPolicy',
