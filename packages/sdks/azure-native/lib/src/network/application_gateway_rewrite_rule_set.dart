...
class ApplicationGatewayRewriteRuleSet {
  ...
  factory ApplicationGatewayRewriteRuleSet.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayRewriteRuleSet(
      ...
      rewriteRules: (() { final guardedValue = map['rewriteRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayRewriteRule>(guardedValue, (value) => ApplicationGatewayRewriteRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
