...
class RoutingRuleCollectionArgs {
    ...
    return <String, dynamic>{
      'appliesTo':
          pulumi.Input.mapInputValue<
            List<NetworkManagerRoutingGroupItem>,
  ...
  factory RoutingRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return RoutingRuleCollectionArgs(
      appliesTo: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NetworkManagerRoutingGroupItem>(
          map['appliesTo']!,
          (value) => NetworkManagerRoutingGroupItem.fromMap(
