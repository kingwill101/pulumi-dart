...
class VirtualNetworkTapServiceGatewayResponse {
  ...
  /// Creates a new [VirtualNetworkTapServiceGatewayResponse].
  ...
  /// [tags] Resource tags.
  /// [type] Resource type.
  const VirtualNetworkTapServiceGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinationLoadBalancerFrontEndIPConfiguration': ?pulumi.Input.mapOptionalInputValue<FrontendIPConfigurationServiceGatewayResponse, Map<String, dynamic>>(destinationLoadBalancerFrontEndIPConfiguration, (value) => value.toMap()),
  ...
  factory VirtualNetworkTapServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
