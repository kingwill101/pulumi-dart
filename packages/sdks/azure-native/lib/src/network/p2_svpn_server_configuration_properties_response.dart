...
class P2SVpnServerConfigurationPropertiesResponse {
  ...
  final pulumi.Input<
    List<P2SVpnServerConfigRadiusServerRootCertificateResponse>
  >?
  p2SVpnServerConfigRadiusServerRootCertificates;

  /// VPN client revoked certificate of P2SVpnServerConfiguration.
  final pulumi.Input<
    List<P2SVpnServerConfigVpnClientRevokedCertificateResponse>
  >?
  p2SVpnServerConfigVpnClientRevokedCertificates;

  /// VPN client root certificate of P2SVpnServerConfiguration.
  final pulumi.Input<List<P2SVpnServerConfigVpnClientRootCertificateResponse>>?
  ...
  factory P2SVpnServerConfigurationPropertiesResponse.fromMap(
    ...
    return P2SVpnServerConfigurationPropertiesResponse(
      ...
      p2SVpnGateways: pulumi.Input.fromValue(
      ...
      p2SVpnServerConfigRadiusClientRootCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                P2SVpnServerConfigRadiusClientRootCertificateResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      p2SVpnServerConfigRadiusServerRootCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                P2SVpnServerConfigRadiusServerRootCertificateResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      p2SVpnServerConfigVpnClientRevokedCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                P2SVpnServerConfigVpnClientRevokedCertificateResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      p2SVpnServerConfigVpnClientRootCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                P2SVpnServerConfigVpnClientRootCertificateResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
