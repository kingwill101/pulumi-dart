...
class VpnGatewayNatRuleResponse {
    ...
    return <String, dynamic>{
      ...
      'externalMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpnNatRuleMappingResponse>,
            List<Map<String, dynamic>>
          >(
            externalMappings,
            (value) =>
  ...
  factory VpnGatewayNatRuleResponse.fromMap(Map<String, dynamic> map) {
    return VpnGatewayNatRuleResponse(
      egressVpnSiteLinkConnections: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SubResourceResponse>(
          map['egressVpnSiteLinkConnections']!,
      ...
      externalMappings: (() {
        final guardedValue = map['externalMappings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpnNatRuleMappingResponse>(
            guardedValue,
            (value) => VpnNatRuleMappingResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ingressVpnSiteLinkConnections: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SubResourceResponse>(
          map['ingressVpnSiteLinkConnections']!,
          (value) => SubResourceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ...
      internalMappings: (() {
        final guardedValue = map['internalMappings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpnNatRuleMappingResponse>(
            guardedValue,
