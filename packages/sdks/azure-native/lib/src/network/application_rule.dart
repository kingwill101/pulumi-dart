...
class ApplicationRule {
  ...
  factory ApplicationRule.fromMap(Map<String, dynamic> map) {
    return ApplicationRule(
      ...
      httpHeadersToInsert: (() { final guardedValue = map['httpHeadersToInsert']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyHttpHeaderToInsert>(guardedValue, (value) => FirewallPolicyHttpHeaderToInsert.fromMap((value as Map).cast<String, dynamic>()))); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      protocols: (() { final guardedValue = map['protocols']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyRuleApplicationProtocol>(guardedValue, (value) => FirewallPolicyRuleApplicationProtocol.fromMap((value as Map).cast<String, dynamic>()))); })(),
