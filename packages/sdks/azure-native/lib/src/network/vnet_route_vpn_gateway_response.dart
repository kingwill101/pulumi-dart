...
import 'static_routes_config_vpn_gateway_response.dart';
import 'sub_resource_response.dart';

/// List of routes that control routing from VirtualHub into a virtual network connection.
class VnetRouteVpnGatewayResponse {
  ...
  const VnetRouteVpnGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'staticRoutesConfig': ?pulumi.Input.mapOptionalInputValue<StaticRoutesConfigVpnGatewayResponse, Map<String, dynamic>>(staticRoutesConfig, (value) => value.toMap()),
    };
  }

  factory VnetRouteVpnGatewayResponse.fromMap(Map<String, dynamic> map) {
    return VnetRouteVpnGatewayResponse(
      ...
      staticRoutesConfig: (() { final guardedValue = map['staticRoutesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StaticRoutesConfigVpnGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
