...
class SubnetResponse {
  ...
  final List<InterfaceEndpointResponse>? interfaceEndpoints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': etag,
      'id': ?id,
      'interfaceEndpoints': ?interfaceEndpoints == null ? null : pulumi.Input.encodeList<InterfaceEndpointResponse, Map<String, dynamic>>(interfaceEndpoints!, (value) => value.toMap()),
  ...
  factory SubnetResponse.fromMap(Map<String, dynamic> map) {
    return SubnetResponse(
      ...
      interfaceEndpoints: map['interfaceEndpoints'] == null ? null : pulumi.Input.decodeList<InterfaceEndpointResponse>(map['interfaceEndpoints'], (value) => InterfaceEndpointResponse.fromMap((value as Map).cast<String, dynamic>())),
