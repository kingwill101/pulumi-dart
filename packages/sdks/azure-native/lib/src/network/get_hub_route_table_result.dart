...
class GetHubRouteTableResult {
  ...
  factory GetHubRouteTableResult.fromMap(Map<String, dynamic> map) {
    return GetHubRouteTableResult(
      associatedConnections: (() { final guardedValue = map['associatedConnections']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      ...
      propagatingConnections: (() { final guardedValue = map['propagatingConnections']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
