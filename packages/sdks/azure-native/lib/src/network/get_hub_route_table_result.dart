...
class GetHubRouteTableResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routes': ?(() {
        ...
        return pulumi.Input.encodeList<HubRouteResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetHubRouteTableResult.fromMap(Map<String, dynamic> map) {
    return GetHubRouteTableResult(
      associatedConnections: (map['associatedConnections'] as List)
          .cast<String>(),
      ...
      propagatingConnections: (map['propagatingConnections'] as List)
          .cast<String>(),
      provisioningState: map['provisioningState'] as String,
      routes: (() {
        final guardedValue = map['routes'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<HubRouteResponse>(
          guardedValue,
          (value) =>
              HubRouteResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
