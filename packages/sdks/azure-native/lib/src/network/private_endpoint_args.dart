...
class PrivateEndpointArgs {
  ...
  final pulumi.Input<List<ApplicationSecurityGroupNetwork>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<PrivateEndpointIPConfiguration>,
            List<Map<String, dynamic>>
          >(
            ipConfigurations,
            (value) =>
    ...
    return PrivateEndpointArgs(
      applicationSecurityGroups: (() {
        ...
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<ApplicationSecurityGroupNetwork>(),
        );
      })(),
      customDnsConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomDnsConfigPropertiesFormat>(
            guardedValue,
            (value) => CustomDnsConfigPropertiesFormat.fromMap(
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateEndpointIPConfiguration>(
            guardedValue,
            (value) => PrivateEndpointIPConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
