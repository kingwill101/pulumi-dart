...
class StaticRoutesConfigHubVirtualNetworkConnectionResponse {
  ...
  const StaticRoutesConfigHubVirtualNetworkConnectionResponse({
  ...
  factory StaticRoutesConfigHubVirtualNetworkConnectionResponse.fromMap(Map<String, dynamic> map) {
    return StaticRoutesConfigHubVirtualNetworkConnectionResponse(
