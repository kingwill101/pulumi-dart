...
class ApplicationGatewayLoadDistributionPolicyResponse {
  ...
  /// Load Distribution Targets resource of an application gateway.
  final pulumi.Input<List<ApplicationGatewayLoadDistributionTargetResponse>>?
    ...
    return <String, dynamic>{
      ...
      'loadDistributionTargets':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationGatewayLoadDistributionTargetResponse>,
  ...
  factory ApplicationGatewayLoadDistributionPolicyResponse.fromMap(
    ...
    return ApplicationGatewayLoadDistributionPolicyResponse(
      ...
      loadDistributionTargets: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ApplicationGatewayLoadDistributionTargetResponse.fromMap(
