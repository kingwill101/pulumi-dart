...
import 'vnet_route_p2s_vpn_gateway_response.dart';
...
class RoutingConfigurationP2sVpnGatewayResponse {
  ...
  const RoutingConfigurationP2sVpnGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRouteP2sVpnGatewayResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationP2sVpnGatewayResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationP2sVpnGatewayResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteP2sVpnGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
