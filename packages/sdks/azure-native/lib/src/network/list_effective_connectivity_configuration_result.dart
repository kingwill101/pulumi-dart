...
class ListEffectiveConnectivityConfigurationResult {
  ...
  ListEffectiveConnectivityConfigurationResult({this.skipToken, this.value});
  ...
  factory ListEffectiveConnectivityConfigurationResult.fromMap(
    ...
    return ListEffectiveConnectivityConfigurationResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<EffectiveConnectivityConfigurationResponse>(
          guardedValue,
          (value) => EffectiveConnectivityConfigurationResponse.fromMap(
