...
class PrivateEndpointConnectionServiceGatewayResponse {
  ...
  /// Creates a new [PrivateEndpointConnectionServiceGatewayResponse].
  ...
  /// [type] Resource type.
  const PrivateEndpointConnectionServiceGatewayResponse({
    required this.etag,
    this.id,
  ...
  factory PrivateEndpointConnectionServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointConnectionServiceGatewayResponse(
