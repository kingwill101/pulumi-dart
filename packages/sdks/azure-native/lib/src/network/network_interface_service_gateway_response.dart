...
import 'network_interface_ipconfiguration_response_v2.dart';
import 'network_interface_tap_configuration_service_gateway_response.dart';
import 'network_security_group_response.dart';
import 'private_endpoint_service_gateway_response.dart';
import 'private_link_service_service_gateway_response.dart';
import 'sub_resource_response.dart';

/// A network interface in a resource group.
class NetworkInterfaceServiceGatewayResponse {
  ...
  final pulumi.Input<List<NetworkInterfaceIPConfigurationResponseV2>?>? ipConfigurations;
  /// Resource location.
  ...
  final pulumi.Input<PrivateEndpointServiceGatewayResponse> privateEndpoint;
  /// Privatelinkservice of the network interface resource.
  final pulumi.Input<PrivateLinkServiceServiceGatewayResponse?>? privateLinkService;
  ...
  final pulumi.Input<List<NetworkInterfaceTapConfigurationServiceGatewayResponse>> tapConfigurations;
  /// Resource type.
  ...
  /// Creates a new [NetworkInterfaceServiceGatewayResponse].
  ...
  const NetworkInterfaceServiceGatewayResponse({
    this.auxiliaryMode,
    this.auxiliarySku,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'ipConfigurations': ?pulumi.Input.mapOptionalInputValue<List<NetworkInterfaceIPConfigurationResponseV2>, List<Map<String, dynamic>>>(ipConfigurations, (value) => pulumi.Input.encodeList<NetworkInterfaceIPConfigurationResponseV2, Map<String, dynamic>>(value, (value) => value.toMap())),
      'location': ?location,
      ...
      'nicType': ?nicType,
      'primary': primary,
      'privateEndpoint': pulumi.Input.mapInputValue<PrivateEndpointServiceGatewayResponse, Map<String, dynamic>>(privateEndpoint, (value) => value.toMap()),
      'privateLinkService': ?pulumi.Input.mapOptionalInputValue<PrivateLinkServiceServiceGatewayResponse, Map<String, dynamic>>(privateLinkService, (value) => value.toMap()),
      'provisioningState': provisioningState,
      'resourceGuid': resourceGuid,
      'tags': ?tags,
      'tapConfigurations': pulumi.Input.mapInputValue<List<NetworkInterfaceTapConfigurationServiceGatewayResponse>, List<Map<String, dynamic>>>(tapConfigurations, (value) => pulumi.Input.encodeList<NetworkInterfaceTapConfigurationServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'type': type,
  ...
  factory NetworkInterfaceServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceServiceGatewayResponse(
      ...
      ipConfigurations: (() { final guardedValue = map['ipConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceIPConfigurationResponseV2>(guardedValue, (value) => NetworkInterfaceIPConfigurationResponseV2.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      privateEndpoint: pulumi.Input.fromValue(PrivateEndpointServiceGatewayResponse.fromMap((map['privateEndpoint']! as Map).cast<String, dynamic>())),
      privateLinkService: (() { final guardedValue = map['privateLinkService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateLinkServiceServiceGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      resourceGuid: pulumi.Input.fromValue(map['resourceGuid'] as String),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      tapConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceTapConfigurationServiceGatewayResponse>(map['tapConfigurations']!, (value) => NetworkInterfaceTapConfigurationServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))),
