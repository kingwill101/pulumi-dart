...
import 'public_ipaddress_service_gateway_response.dart';
import 'sub_resource_response.dart';
import 'subnet_response.dart';
import 'virtual_network_tap_service_gateway_response.dart';

/// IPConfiguration in a network interface.
class NetworkInterfaceIPConfigurationServiceGatewayResponse {
  ...
  final pulumi.Input<List<VirtualNetworkTapServiceGatewayResponse>>? virtualNetworkTaps;

  /// Creates a new [NetworkInterfaceIPConfigurationServiceGatewayResponse].
  ...
  const NetworkInterfaceIPConfigurationServiceGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicIPAddress': ?pulumi.Input.mapOptionalInputValue<PublicIPAddressServiceGatewayResponse, Map<String, dynamic>>(publicIPAddress, (value) => value.toMap()),
      'subnet': ?pulumi.Input.mapOptionalInputValue<SubnetResponse, Map<String, dynamic>>(subnet, (value) => value.toMap()),
      'type': type,
      'virtualNetworkTaps': ?pulumi.Input.mapOptionalInputValue<List<VirtualNetworkTapServiceGatewayResponse>, List<Map<String, dynamic>>>(virtualNetworkTaps, (value) => pulumi.Input.encodeList<VirtualNetworkTapServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory NetworkInterfaceIPConfigurationServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceIPConfigurationServiceGatewayResponse(
      ...
      publicIPAddress: (() { final guardedValue = map['publicIPAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicIPAddressServiceGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      virtualNetworkTaps: (() { final guardedValue = map['virtualNetworkTaps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualNetworkTapServiceGatewayResponse>(guardedValue, (value) => VirtualNetworkTapServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
