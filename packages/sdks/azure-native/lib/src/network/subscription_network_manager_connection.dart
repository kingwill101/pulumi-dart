...
import 'subscription_network_manager_connection_args.dart';
...
/// }
///
/// resource "azure-native_network_subscriptionnetworkmanagerconnection" "subscriptionNetworkManagerConnection" {
...
class SubscriptionNetworkManagerConnection extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SubscriptionNetworkManagerConnection]. {@macro pulumi_network_subscription_network_manager_connection_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SubscriptionNetworkManagerConnection(
    String name, {
    SubscriptionNetworkManagerConnectionArgs? args,
  ...
  /// Creates a typed reference to an existing [SubscriptionNetworkManagerConnection] resource.
  SubscriptionNetworkManagerConnection.reference(String urn)
    : super(
        'azure-native:network:SubscriptionNetworkManagerConnection',
