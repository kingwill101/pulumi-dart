...
class LoadBalancerArgs {
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      outboundRules: (() { final guardedValue = map['outboundRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OutboundRule>(guardedValue, (value) => OutboundRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoadBalancerSku.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
