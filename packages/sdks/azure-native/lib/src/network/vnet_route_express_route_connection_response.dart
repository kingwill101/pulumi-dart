...
import 'static_routes_config_express_route_connection_response.dart';
import 'sub_resource_response.dart';

/// List of routes that control routing from VirtualHub into a virtual network connection.
class VnetRouteExpressRouteConnectionResponse {
  ...
  final pulumi.Input<StaticRoutesConfigExpressRouteConnectionResponse?>? staticRoutesConfig;

  /// Creates a new [VnetRouteExpressRouteConnectionResponse].
  ...
  const VnetRouteExpressRouteConnectionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'staticRoutesConfig': ?pulumi.Input.mapOptionalInputValue<StaticRoutesConfigExpressRouteConnectionResponse, Map<String, dynamic>>(staticRoutesConfig, (value) => value.toMap()),
    };
  }

  factory VnetRouteExpressRouteConnectionResponse.fromMap(Map<String, dynamic> map) {
    return VnetRouteExpressRouteConnectionResponse(
      ...
      staticRoutesConfig: (() { final guardedValue = map['staticRoutesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StaticRoutesConfigExpressRouteConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
