...
class Office365PolicyPropertiesResponse {
  ...
  final BreakOutCategoryPoliciesResponse? breakOutCategories;
  ...
  factory Office365PolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Office365PolicyPropertiesResponse(
      breakOutCategories: map['breakOutCategories'] == null ? null : BreakOutCategoryPoliciesResponse.fromMap((map['breakOutCategories'] as Map).cast<String, dynamic>()),
    );
  }
}
