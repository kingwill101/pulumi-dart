...
class GetServiceEndpointPolicyResult {
  ...
  final List<ServiceEndpointPolicyDefinitionResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serviceEndpointPolicyDefinitions': ?(() {
        final guardedValue = serviceEndpointPolicyDefinitions;
  ...
  factory GetServiceEndpointPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetServiceEndpointPolicyResult(
      ...
      serviceEndpointPolicyDefinitions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ServiceEndpointPolicyDefinitionResponse>(
          guardedValue,
