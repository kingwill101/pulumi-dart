...
import 'service_endpoint_policy_definition_virtual_network_appliance_response.dart';
...
class ServiceEndpointPolicyVirtualNetworkApplianceResponse {
  ...
  /// Creates a new [ServiceEndpointPolicyVirtualNetworkApplianceResponse].
  ...
  /// [tags] Resource tags.
  /// [type] Resource type.
  const ServiceEndpointPolicyVirtualNetworkApplianceResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serviceEndpointPolicyDefinitions': ?pulumi.Input.mapOptionalInputValue<List<ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(serviceEndpointPolicyDefinitions, (value) => pulumi.Input.encodeList<ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServiceEndpointPolicyVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return ServiceEndpointPolicyVirtualNetworkApplianceResponse(
      ...
      serviceEndpointPolicyDefinitions: (() { final guardedValue = map['serviceEndpointPolicyDefinitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse>(guardedValue, (value) => ServiceEndpointPolicyDefinitionVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
