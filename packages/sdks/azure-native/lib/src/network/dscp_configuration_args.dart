    ...
    return <String, dynamic>{
      'destinationIpRanges':
          ...
          >(
            destinationIpRanges,
            (value) =>
                pulumi.Input.encodeList<QosIpRange, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'destinationPortRanges':
          ...
          >(
            destinationPortRanges,
            (value) =>
                pulumi.Input.encodeList<QosPortRange, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'qosDefinitionCollection':
          ...
          >(
            qosDefinitionCollection,
            (value) =>
                pulumi.Input.encodeList<QosDefinition, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DscpConfigurationArgs(
      destinationIpRanges: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<QosIpRange>(
            guardedValue,
            (value) =>
                QosIpRange.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      destinationPortRanges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<QosPortRange>(
            guardedValue,
            (value) =>
                QosPortRange.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      dscpConfigurationName: (() {
        final guardedValue = map['dscpConfigurationName'];
        if (guardedValue == null) return null;
      ...
      qosDefinitionCollection: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<QosDefinition>(
            guardedValue,
            (value) =>
                QosDefinition.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
