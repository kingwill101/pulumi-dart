...
class PublicIPAddressDnsSettings {
  ...
  final pulumi.Input<PublicIpAddressDnsSettingsDomainNameLabelScope>?
    ...
    return <String, dynamic>{
      ...
      'domainNameLabelScope':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(domainNameLabelScope, (value) => value.wireValue),
      'fqdn': ?fqdn,
    ...
    return PublicIPAddressDnsSettings(
      ...
      domainNameLabelScope: (() {
        ...
        return pulumi.Input.fromValue(
          PublicIpAddressDnsSettingsDomainNameLabelScope.fromValue(
