...
class ApplicationRuleResponse {
  ...
  final pulumi.Input<List<FirewallPolicyHttpHeaderToInsertResponse>>?
  httpHeadersToInsert;
  ...
  final pulumi.Input<List<FirewallPolicyRuleApplicationProtocolResponse>>?
  protocols;
    ...
    return <String, dynamic>{
      ...
      'httpHeadersToInsert':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyHttpHeaderToInsertResponse>,
      ...
      'protocols':
          ?pulumi.Input.mapOptionalInputValue<
            List<FirewallPolicyRuleApplicationProtocolResponse>,
            List<Map<String, dynamic>>
          >(
            protocols,
            (value) =>
    ...
    return ApplicationRuleResponse(
      ...
      httpHeadersToInsert: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FirewallPolicyHttpHeaderToInsertResponse>(
            guardedValue,
            (value) => FirewallPolicyHttpHeaderToInsertResponse.fromMap(
      ...
      protocols: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<FirewallPolicyRuleApplicationProtocolResponse>(
            guardedValue,
            (value) => FirewallPolicyRuleApplicationProtocolResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
