...
class ApplicationRuleResponse {
  ...
  final List<FirewallPolicyHttpHeaderToInsertResponse>? httpHeadersToInsert;
  /// Name of the rule.
  final String? name;
  /// Array of Application Protocols.
  final List<FirewallPolicyRuleApplicationProtocolResponse>? protocols;
  /// Rule Type.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fqdnTags': ?fqdnTags,
      'httpHeadersToInsert': ?httpHeadersToInsert == null ? null : pulumi.Input.encodeList<FirewallPolicyHttpHeaderToInsertResponse, Map<String, dynamic>>(httpHeadersToInsert!, (value) => value.toMap()),
      'name': ?name,
      'protocols': ?protocols == null ? null : pulumi.Input.encodeList<FirewallPolicyRuleApplicationProtocolResponse, Map<String, dynamic>>(protocols!, (value) => value.toMap()),
      'ruleType': ruleType,
  ...
  factory ApplicationRuleResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationRuleResponse(
      ...
      httpHeadersToInsert: map['httpHeadersToInsert'] == null ? null : pulumi.Input.decodeList<FirewallPolicyHttpHeaderToInsertResponse>(map['httpHeadersToInsert'], (value) => FirewallPolicyHttpHeaderToInsertResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      protocols: map['protocols'] == null ? null : pulumi.Input.decodeList<FirewallPolicyRuleApplicationProtocolResponse>(map['protocols'], (value) => FirewallPolicyRuleApplicationProtocolResponse.fromMap((value as Map).cast<String, dynamic>())),
