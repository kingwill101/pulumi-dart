...
import 'route_service_gateway_response.dart';
...
class RouteTableServiceGatewayResponse {
  ...
  /// Creates a new [RouteTableServiceGatewayResponse].
  ...
  /// [tags] Resource tags.
  /// [type] Resource type.
  const RouteTableServiceGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routes': ?pulumi.Input.mapOptionalInputValue<List<RouteServiceGatewayResponse>, List<Map<String, dynamic>>>(routes, (value) => pulumi.Input.encodeList<RouteServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory RouteTableServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return RouteTableServiceGatewayResponse(
      ...
      routes: (() { final guardedValue = map['routes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RouteServiceGatewayResponse>(guardedValue, (value) => RouteServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
