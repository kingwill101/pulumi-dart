...
class GetP2sVpnGatewayP2sVpnConnectionHealthDetailedArgs {
  ...
  factory GetP2sVpnGatewayP2sVpnConnectionHealthDetailedArgs.fromMap(Map<String, dynamic> map) {
    return GetP2sVpnGatewayP2sVpnConnectionHealthDetailedArgs(
      ...
      outputBlobSasUrl: (() { final guardedValue = map['outputBlobSasUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      vpnUserNamesFilter: (() { final guardedValue = map['vpnUserNamesFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
