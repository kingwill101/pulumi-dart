...
import 'application_gateway_backend_address_pool_service_gateway_response.dart';
...
class NetworkInterfaceIPConfigurationResponseV2 {
  /// The reference to ApplicationGatewayBackendAddressPool resource.
  final pulumi.Input<List<ApplicationGatewayBackendAddressPoolServiceGatewayResponse>>? applicationGatewayBackendAddressPools;
  ...
  /// Creates a new [NetworkInterfaceIPConfigurationResponseV2].
  ...
  const NetworkInterfaceIPConfigurationResponseV2({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applicationGatewayBackendAddressPools': ?pulumi.Input.mapOptionalInputValue<List<ApplicationGatewayBackendAddressPoolServiceGatewayResponse>, List<Map<String, dynamic>>>(applicationGatewayBackendAddressPools, (value) => pulumi.Input.encodeList<ApplicationGatewayBackendAddressPoolServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory NetworkInterfaceIPConfigurationResponseV2.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceIPConfigurationResponseV2(
      applicationGatewayBackendAddressPools: (() { final guardedValue = map['applicationGatewayBackendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayBackendAddressPoolServiceGatewayResponse>(guardedValue, (value) => ApplicationGatewayBackendAddressPoolServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
