...
class SubnetNetwork extends pulumi.CustomResource {
  ...
  SubnetNetwork(
    ...
    this.applicationGatewayIPConfigurations = registerOutput<List<ApplicationGatewayIPConfigurationResponse>?>('applicationGatewayIPConfigurations');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.defaultOutboundAccess = registerOutput<bool?>('defaultOutboundAccess');
    this.delegations = registerOutput<List<DelegationResponse>?>('delegations');
    this.etag = registerOutput<String>('etag');
    this.ipAllocations = registerOutput<List<SubResourceResponse>?>('ipAllocations');
    this.ipConfigurationProfiles = registerOutput<List<IPConfigurationProfileResponse>>('ipConfigurationProfiles');
    this.ipConfigurations = registerOutput<List<IPConfigurationResponse>>('ipConfigurations');
    this.ipamPoolPrefixAllocations = registerOutput<List<IpamPoolPrefixAllocationResponse>?>('ipamPoolPrefixAllocations');
    this.name = registerOutput<String?>('name');
    this.natGateway = registerOutput<SubResourceResponse?>('natGateway');
    this.networkSecurityGroup = registerOutput<NetworkSecurityGroupResponse?>('networkSecurityGroup');
    this.privateEndpointNetworkPolicies = registerOutput<String?>('privateEndpointNetworkPolicies');
    this.privateEndpoints = registerOutput<List<PrivateEndpointResponse>>('privateEndpoints');
    this.privateLinkServiceNetworkPolicies = registerOutput<String?>('privateLinkServiceNetworkPolicies');
    this.provisioningState = registerOutput<String>('provisioningState');
    this.purpose = registerOutput<String>('purpose');
    this.resourceNavigationLinks = registerOutput<List<ResourceNavigationLinkResponse>>('resourceNavigationLinks');
    this.routeTable = registerOutput<RouteTableResponse?>('routeTable');
    this.serviceAssociationLinks = registerOutput<List<ServiceAssociationLinkResponse>>('serviceAssociationLinks');
    this.serviceEndpointPolicies = registerOutput<List<ServiceEndpointPolicyResponse>?>('serviceEndpointPolicies');
    this.serviceEndpoints = registerOutput<List<ServiceEndpointPropertiesFormatResponse>?>('serviceEndpoints');
    this.sharingScope = registerOutput<String?>('sharingScope');
