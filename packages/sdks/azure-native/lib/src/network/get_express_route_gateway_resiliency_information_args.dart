...
/// {@template pulumi_network_get_express_route_gateway_resiliency_information_args_doc}
/// Arguments for getExpressRouteGatewayResiliencyInformation.
/// {@endtemplate}
/// {@macro pulumi_network_get_express_route_gateway_resiliency_information_args_doc}
class GetExpressRouteGatewayResiliencyInformationArgs {
  ...
  /// Creates a new [GetExpressRouteGatewayResiliencyInformationArgs].
  ...
  const GetExpressRouteGatewayResiliencyInformationArgs({
    this.attemptRefresh,
  ...
  factory GetExpressRouteGatewayResiliencyInformationArgs.fromMap(Map<String, dynamic> map) {
    return GetExpressRouteGatewayResiliencyInformationArgs(
