...
class ReachabilityAnalysisIntent extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ReachabilityAnalysisIntentPropertiesResponse> properties;
  ...
  ReachabilityAnalysisIntent(
    ...
    properties = registerOutput<ReachabilityAnalysisIntentPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ReachabilityAnalysisIntentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ReachabilityAnalysisIntent] resource.
  ReachabilityAnalysisIntent.reference(String urn)
    : super(
        'azure-native:network:ReachabilityAnalysisIntent',
