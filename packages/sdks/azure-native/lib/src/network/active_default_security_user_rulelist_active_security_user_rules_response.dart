...
class ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse {
  ...
  /// Creates a new [ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse].
  ...
  const ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse({
    this.commitTime,
  ...
  factory ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse.fromMap(Map<String, dynamic> map) {
    return ActiveDefaultSecurityUserRulelistActiveSecurityUserRulesResponse(
