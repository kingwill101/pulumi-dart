...
import 'managed_service_identity_service_gateway_response.dart';
...
class FlowLogServiceGatewayResponse {
  ...
  /// Creates a new [FlowLogServiceGatewayResponse].
  ...
  /// [type] Resource type.
  const FlowLogServiceGatewayResponse({
    this.enabled,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'identity': ?pulumi.Input.mapOptionalInputValue<ManagedServiceIdentityServiceGatewayResponse, Map<String, dynamic>>(identity, (value) => value.toMap()),
      'location': ?location,
      'name': name,
  ...
  factory FlowLogServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return FlowLogServiceGatewayResponse(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedServiceIdentityServiceGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
