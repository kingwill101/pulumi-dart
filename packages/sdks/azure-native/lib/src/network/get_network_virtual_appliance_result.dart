...
class GetNetworkVirtualApplianceResult {
  ...
  final List<InternetIngressPublicIpsPropertiesResponse>?
  ...
  final NetworkVirtualAppliancePropertiesFormatResponseNetworkProfile?
  networkProfile;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalNics': ?(() {
        final guardedValue = additionalNics;
      ...
      'internetIngressPublicIps': ?(() {
        final guardedValue = internetIngressPublicIps;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'virtualApplianceNics':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(virtualApplianceNics, (value) => value.toMap()),
  ...
  factory GetNetworkVirtualApplianceResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkVirtualApplianceResult(
      additionalNics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<VirtualApplianceAdditionalNicPropertiesResponse>(
          guardedValue,
          (value) => VirtualApplianceAdditionalNicPropertiesResponse.fromMap(
      ...
      inboundSecurityRules: pulumi.Input.decodeList<SubResourceResponse>(
        map['inboundSecurityRules']!,
        (value) =>
      ...
      internetIngressPublicIps: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<InternetIngressPublicIpsPropertiesResponse>(
          guardedValue,
          (value) => InternetIngressPublicIpsPropertiesResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      partnerManagedResource: (() {
        final guardedValue = map['partnerManagedResource'];
        if (guardedValue == null) return null;
      ...
      virtualApplianceConnections: pulumi.Input.decodeList<SubResourceResponse>(
        map['virtualApplianceConnections']!,
        (value) =>
            SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      virtualApplianceNics:
          pulumi.Input.decodeList<VirtualApplianceNicPropertiesResponse>(
            map['virtualApplianceNics']!,
            (value) => VirtualApplianceNicPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      virtualApplianceSites: pulumi.Input.decodeList<SubResourceResponse>(
        map['virtualApplianceSites']!,
        (value) =>
            SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      virtualHub: (() {
