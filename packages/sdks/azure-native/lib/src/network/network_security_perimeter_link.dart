...
import 'network_security_perimeter_link_args.dart';
...
/// }
///
/// resource "azure-native_network_networksecurityperimeterlink" "networkSecurityPerimeterLink" {
...
/// ```
class NetworkSecurityPerimeterLink extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NetworkSecurityPerimeterLink]. {@macro pulumi_network_network_security_perimeter_link_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  NetworkSecurityPerimeterLink(
    String name, {
    NetworkSecurityPerimeterLinkArgs? args,
  ...
  /// Creates a typed reference to an existing [NetworkSecurityPerimeterLink] resource.
  NetworkSecurityPerimeterLink.reference(String urn)
    : super(
        'azure-native:network:NetworkSecurityPerimeterLink',
