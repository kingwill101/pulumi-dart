...
/// }
///
/// resource "azure-native_network_networkwatcher" "networkWatcher" {
///   location             = "eastus"
...
class NetworkWatcher extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NetworkWatcher]. {@macro pulumi_network_network_watcher_args_doc}
