...
class OutboundRule {
  ...
  final List<SubResource> frontendIPConfigurations;
  /// Resource ID.
  final String? id;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'frontendIPConfigurations': pulumi.Input.encodeList<SubResource, Map<String, dynamic>>(frontendIPConfigurations, (value) => value.toMap()),
      'id': ?id,
  ...
  factory OutboundRule.fromMap(Map<String, dynamic> map) {
    return OutboundRule(
      ...
      backendAddressPool: SubResource.fromMap((map['backendAddressPool'] as Map).cast<String, dynamic>()),
      enableTcpReset: map['enableTcpReset'] == null ? null : map['enableTcpReset'] as bool,
      frontendIPConfigurations: pulumi.Input.decodeList<SubResource>(map['frontendIPConfigurations'], (value) => SubResource.fromMap((value as Map).cast<String, dynamic>())),
