...
class NatGatewayServiceGatewayResponse {
  ...
  /// Creates a new [NatGatewayServiceGatewayResponse].
  ...
  const NatGatewayServiceGatewayResponse({
    required this.etag,
    this.id,
  ...
  factory NatGatewayServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return NatGatewayServiceGatewayResponse(
