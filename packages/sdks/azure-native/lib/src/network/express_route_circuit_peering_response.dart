...
class ExpressRouteCircuitPeeringResponse {
  ...
  final pulumi.Input<Ipv6ExpressRouteCircuitPeeringConfigResponse>?
  ipv6PeeringConfig;
  ...
  final pulumi.Input<ExpressRouteCircuitPeeringConfigResponse>?
  ...
  final pulumi.Input<List<PeerExpressRouteCircuitConnectionResponse>>
  peeredConnections;
    ...
    return <String, dynamic>{
      ...
      'connections':
          ?pulumi.Input.mapOptionalInputValue<
            List<ExpressRouteCircuitConnectionResponse>,
      ...
      'expressRouteConnection':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(expressRouteConnection, (value) => value.toMap()),
      ...
      'peeredConnections':
          pulumi.Input.mapInputValue<
            List<PeerExpressRouteCircuitConnectionResponse>,
            List<Map<String, dynamic>>
          >(
            peeredConnections,
            (value) =>
    ...
    return ExpressRouteCircuitPeeringResponse(
      ...
      connections: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExpressRouteCircuitConnectionResponse>(
            guardedValue,
      ...
      expressRouteConnection: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpressRouteConnectionIdResponse.fromMap(
      ...
      ipv6PeeringConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Ipv6ExpressRouteCircuitPeeringConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      microsoftPeeringConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpressRouteCircuitPeeringConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      peeredConnections: pulumi.Input.fromValue(
      ...
      stats: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpressRouteCircuitStatsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
