...
import 'public_ipaddress_response_v2.dart';
import 'sub_resource_response.dart';
import 'subnet_response.dart';

/// Frontend IP address of the load balancer.
class FrontendIPConfigurationVirtualNetworkApplianceResponse {
  ...
  final pulumi.Input<PublicIPAddressResponseV2?>? publicIPAddress;
  ...
  /// Creates a new [FrontendIPConfigurationVirtualNetworkApplianceResponse].
  ...
  const FrontendIPConfigurationVirtualNetworkApplianceResponse({
    required this.etag,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'publicIPAddress': ?pulumi.Input.mapOptionalInputValue<PublicIPAddressResponseV2, Map<String, dynamic>>(publicIPAddress, (value) => value.toMap()),
  ...
  factory FrontendIPConfigurationVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return FrontendIPConfigurationVirtualNetworkApplianceResponse(
      ...
      publicIPAddress: (() { final guardedValue = map['publicIPAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicIPAddressResponseV2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
