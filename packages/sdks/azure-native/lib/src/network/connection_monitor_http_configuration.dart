...
class ConnectionMonitorHttpConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'requestHeaders': ?requestHeaders == null ? null : pulumi.Input.encodeList<HTTPHeader, Map<String, dynamic>>(requestHeaders!, (value) => value.toMap()),
  ...
  factory ConnectionMonitorHttpConfiguration.fromMap(Map<String, dynamic> map) {
    return ConnectionMonitorHttpConfiguration(
      ...
      requestHeaders: map['requestHeaders'] == null ? null : pulumi.Input.decodeList<HTTPHeader>(map['requestHeaders'], (value) => HTTPHeader.fromMap((value as Map).cast<String, dynamic>())),
