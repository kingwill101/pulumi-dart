...
class VirtualApplianceIPConfigurationResponse {
  ...
  final pulumi.Input<VirtualApplianceIPConfigurationPropertiesResponse>?
  properties;
  ...
  VirtualApplianceIPConfigurationResponse({this.name, this.properties});
  ...
  factory VirtualApplianceIPConfigurationResponse.fromMap(
    ...
    return VirtualApplianceIPConfigurationResponse(
      ...
      properties: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualApplianceIPConfigurationPropertiesResponse.fromMap(
