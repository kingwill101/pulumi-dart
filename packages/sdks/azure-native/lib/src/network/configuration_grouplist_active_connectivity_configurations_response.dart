...
class ConfigurationGrouplistActiveConnectivityConfigurationsResponse {
  ...
  /// Creates a new [ConfigurationGrouplistActiveConnectivityConfigurationsResponse].
  ...
  const ConfigurationGrouplistActiveConnectivityConfigurationsResponse({
    this.description,
    this.id,
    this.memberType,
  ...
  factory ConfigurationGrouplistActiveConnectivityConfigurationsResponse.fromMap(Map<String, dynamic> map) {
    return ConfigurationGrouplistActiveConnectivityConfigurationsResponse(
