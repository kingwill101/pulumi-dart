...
class ApplicationGatewayRewriteRuleActionSetResponse {
  ...
  factory ApplicationGatewayRewriteRuleActionSetResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayRewriteRuleActionSetResponse(
      requestHeaderConfigurations: (() { final guardedValue = map['requestHeaderConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayHeaderConfigurationResponse>(guardedValue, (value) => ApplicationGatewayHeaderConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      responseHeaderConfigurations: (() { final guardedValue = map['responseHeaderConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayHeaderConfigurationResponse>(guardedValue, (value) => ApplicationGatewayHeaderConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      urlConfiguration: (() { final guardedValue = map['urlConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationGatewayUrlConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
