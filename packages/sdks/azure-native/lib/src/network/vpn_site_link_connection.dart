...
class VpnSiteLinkConnection {
  ...
  factory VpnSiteLinkConnection.fromMap(Map<String, dynamic> map) {
    return VpnSiteLinkConnection(
      ...
      vpnGatewayCustomBgpAddresses: (() {
        final guardedValue = map['vpnGatewayCustomBgpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      vpnLinkConnectionMode: (() {
        final guardedValue = map['vpnLinkConnectionMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vpnSiteLink: (() {
        final guardedValue = map['vpnSiteLink'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
