...
class SubnetArgs {
  ...
  SubnetArgs({
    ...
    pulumi.Output<List<ApplicationGatewayIPConfiguration>>? applicationGatewayIPConfigurations,
    pulumi.Output<bool>? defaultOutboundAccess,
    pulumi.Output<List<Delegation>>? delegations,
    pulumi.Output<String>? id,
    pulumi.Output<List<SubResource>>? ipAllocations,
    pulumi.Output<List<IpamPoolPrefixAllocation>>? ipamPoolPrefixAllocations,
    pulumi.Output<String>? name,
    pulumi.Output<SubResource>? natGateway,
    pulumi.Output<NetworkSecurityGroupNetwork>? networkSecurityGroup,
    pulumi.Output<String>? privateEndpointNetworkPolicies,
    pulumi.Output<String>? privateLinkServiceNetworkPolicies,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<RouteTableNetwork>? routeTable,
    pulumi.Output<List<ServiceEndpointPolicyNetwork>>? serviceEndpointPolicies,
    pulumi.Output<List<ServiceEndpointPropertiesFormat>>? serviceEndpoints,
  ...
  factory SubnetArgs.fromMap(Map<String, dynamic> map) {
    return SubnetArgs(
      ...
      applicationGatewayIPConfigurations: map['applicationGatewayIPConfigurations'] == null ? null : pulumi.Output.create<List<ApplicationGatewayIPConfiguration>>(pulumi.Input.decodeList<ApplicationGatewayIPConfiguration>(map['applicationGatewayIPConfigurations'], (value) => ApplicationGatewayIPConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      defaultOutboundAccess: map['defaultOutboundAccess'] == null ? null : pulumi.Output.create<bool>(map['defaultOutboundAccess'] as bool),
      delegations: map['delegations'] == null ? null : pulumi.Output.create<List<Delegation>>(pulumi.Input.decodeList<Delegation>(map['delegations'], (value) => Delegation.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ipamPoolPrefixAllocations: map['ipamPoolPrefixAllocations'] == null ? null : pulumi.Output.create<List<IpamPoolPrefixAllocation>>(pulumi.Input.decodeList<IpamPoolPrefixAllocation>(map['ipamPoolPrefixAllocations'], (value) => IpamPoolPrefixAllocation.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      natGateway: map['natGateway'] == null ? null : pulumi.Output.create<SubResource>(SubResource.fromMap((map['natGateway'] as Map).cast<String, dynamic>())),
      ...
      privateLinkServiceNetworkPolicies: map['privateLinkServiceNetworkPolicies'] == null ? null : pulumi.Output.create<String>(map['privateLinkServiceNetworkPolicies'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      routeTable: map['routeTable'] == null ? null : pulumi.Output.create<RouteTableNetwork>(map['routeTable'] as RouteTableNetwork),
      serviceEndpointPolicies: map['serviceEndpointPolicies'] == null ? null : pulumi.Output.create<List<ServiceEndpointPolicyNetwork>>((map['serviceEndpointPolicies'] as List).cast<ServiceEndpointPolicyNetwork>()),
      serviceEndpoints: map['serviceEndpoints'] == null ? null : pulumi.Output.create<List<ServiceEndpointPropertiesFormat>>(pulumi.Input.decodeList<ServiceEndpointPropertiesFormat>(map['serviceEndpoints'], (value) => ServiceEndpointPropertiesFormat.fromMap((value as Map).cast<String, dynamic>()))),
