...
class SubnetArgs {
  ...
  final pulumi.Input<List<ServiceEndpointPolicyNetwork>>?
  ...
  factory SubnetArgs.fromMap(Map<String, dynamic> map) {
    return SubnetArgs(
      ...
      routeTable: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as RouteTableNetwork);
      })(),
      serviceEndpointPolicies: (() {
        final guardedValue = map['serviceEndpointPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<ServiceEndpointPolicyNetwork>(),
        );
      })(),
      serviceEndpoints: (() {
