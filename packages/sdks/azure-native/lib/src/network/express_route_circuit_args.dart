...
class ExpressRouteCircuitArgs {
  ...
  factory ExpressRouteCircuitArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteCircuitArgs(
      ...
      expressRoutePort: (() { final guardedValue = map['expressRoutePort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
