...
class NetworkSecurityGroup {
    ...
    return <String, dynamic>{
      'defaultSecurityRules':
          ...
          >(
            defaultSecurityRules,
            (value) =>
                pulumi.Input.encodeList<SecurityRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory NetworkSecurityGroup.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityGroup(
      defaultSecurityRules: (() {
        final guardedValue = map['defaultSecurityRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SecurityRule>(
            guardedValue,
            (value) =>
                SecurityRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      etag: (() {
