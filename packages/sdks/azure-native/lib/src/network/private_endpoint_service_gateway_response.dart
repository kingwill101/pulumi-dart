...
class PrivateEndpointServiceGatewayResponse {
  ...
  /// Creates a new [PrivateEndpointServiceGatewayResponse].
  ...
  factory PrivateEndpointServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointServiceGatewayResponse(
