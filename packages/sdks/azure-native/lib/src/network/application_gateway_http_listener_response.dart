...
class ApplicationGatewayHttpListenerResponse {
  ...
  final pulumi.Input<List<ApplicationGatewayCustomErrorResponse>>?
    ...
    return <String, dynamic>{
      'customErrorConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationGatewayCustomErrorResponse>,
      ...
      'frontendPort':
          ?pulumi.Input.mapOptionalInputValue<
            SubResourceResponse,
            Map<String, dynamic>
          >(frontendPort, (value) => value.toMap()),
      'hostName': ?hostName,
      'hostNames': ?hostNames,
      'id': ?id,
      'name': ?name,
      ...
      'sslCertificate':
          ?pulumi.Input.mapOptionalInputValue<
            SubResourceResponse,
            Map<String, dynamic>
          >(sslCertificate, (value) => value.toMap()),
      'sslProfile':
          ?pulumi.Input.mapOptionalInputValue<
            SubResourceResponse,
            Map<String, dynamic>
          >(sslProfile, (value) => value.toMap()),
      'type': type,
    };
  }

  factory ApplicationGatewayHttpListenerResponse.fromMap(
    ...
    return ApplicationGatewayHttpListenerResponse(
      customErrorConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationGatewayCustomErrorResponse>(
            guardedValue,
      ...
      requireServerNameIndication: (() {
        final guardedValue = map['requireServerNameIndication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sslCertificate: (() {
        final guardedValue = map['sslCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubResourceResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
