...
class GetWebApplicationFirewallPolicyResult {
  ...
  final List<ApplicationGatewayForContainersReferenceDefinitionResponse>
    ...
    return <String, dynamic>{
      'applicationGatewayForContainers':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(applicationGatewayForContainers, (value) => value.toMap()),
      'applicationGateways':
          pulumi.Input.encodeList<
            ApplicationGatewayResponse,
            Map<String, dynamic>
          >(applicationGateways, (value) => value.toMap()),
      'azureApiVersion': azureApiVersion,
      'customRules': ?(() {
        final guardedValue = customRules;
  ...
  factory GetWebApplicationFirewallPolicyResult.fromMap(
    ...
    return GetWebApplicationFirewallPolicyResult(
      applicationGatewayForContainers:
          pulumi.Input.decodeList<
            ApplicationGatewayForContainersReferenceDefinitionResponse
          >(
            map['applicationGatewayForContainers']!,
            (value) =>
                ApplicationGatewayForContainersReferenceDefinitionResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
      applicationGateways: pulumi.Input.decodeList<ApplicationGatewayResponse>(
        map['applicationGateways']!,
        (value) => ApplicationGatewayResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      customRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<WebApplicationFirewallCustomRuleResponse>(
          guardedValue,
          (value) => WebApplicationFirewallCustomRuleResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      etag: map['etag'] as String,
      httpListeners: pulumi.Input.decodeList<SubResourceResponse>(
        map['httpListeners']!,
        (value) =>
      ...
      managedRules: ManagedRulesDefinitionResponse.fromMap(
        (map['managedRules']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      pathBasedRules: pulumi.Input.decodeList<SubResourceResponse>(
        map['pathBasedRules']!,
        (value) =>
            SubResourceResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
