    ...
    return <String, dynamic>{
      'bgpProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bgpProperties, (value) => value.toMap()),
      'etag': etag,
      'fqdn': ?fqdn,
      'id': ?id,
      'ipAddress': ?ipAddress,
      'linkProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(linkProperties, (value) => value.toMap()),
      'name': ?name,
    ...
    return VpnSiteLinkResponse(
      bgpProperties: (() {
        ...
        return pulumi.Input.fromValue(
          VpnLinkBgpSettingsResponse.fromMap(
      ...
      linkProperties: (() {
        final guardedValue = map['linkProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VpnLinkProviderPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
