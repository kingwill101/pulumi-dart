...
class GetNetworkInterfaceResult {
    ...
    return <String, dynamic>{
      ...
      'tapConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(tapConfigurations, (value) => value.toMap()),
      'type': type,
  ...
  factory GetNetworkInterfaceResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkInterfaceResult(
      ...
      dscpConfiguration: SubResourceResponse.fromMap(
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NetworkInterfaceIPConfigurationResponse>(
          guardedValue,
      ...
      privateEndpoint: PrivateEndpointResponse.fromMap(
      ...
      virtualMachine: SubResourceResponse.fromMap(
