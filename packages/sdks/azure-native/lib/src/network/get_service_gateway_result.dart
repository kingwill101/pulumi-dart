...
class GetServiceGatewayResult {
  ...
  factory GetServiceGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetServiceGatewayResult(
      ...
      routeTargetAddress: (() { final guardedValue = map['routeTargetAddress']; if (guardedValue == null) return null; return RouteTargetAddressPropertiesFormatResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      routeTargetAddressV6: (() { final guardedValue = map['routeTargetAddressV6']; if (guardedValue == null) return null; return RouteTargetAddressPropertiesFormatResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return ServiceGatewaySkuResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      systemData: SystemDataResponse.fromMap((map['systemData']! as Map).cast<String, dynamic>()),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); })(),
      type: map['type'] as String,
      virtualNetwork: (() { final guardedValue = map['virtualNetwork']; if (guardedValue == null) return null; return VirtualNetworkResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
