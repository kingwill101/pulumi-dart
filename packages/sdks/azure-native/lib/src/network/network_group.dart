...
/// }
///
/// resource "azure-native_network_networkgroup" "networkGroup" {
///   description          = "A sample group"
...
class NetworkGroup extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [NetworkGroup] resource.
  NetworkGroup.reference(String urn)
    : super(
        'azure-native:network:NetworkGroup',
