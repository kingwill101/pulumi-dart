...
class GetSubnetResult {
  ...
  GetSubnetResult({
    ...
    this.sharingScope,
    this.type,
  }) : privateEndpointNetworkPolicies = privateEndpointNetworkPolicies ?? 'Disabled', privateLinkServiceNetworkPolicies = privateLinkServiceNetworkPolicies ?? 'Enabled';
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurationProfiles': ?(() { final guardedValue = ipConfigurationProfiles; if (guardedValue == null) return null; return pulumi.Input.encodeList<IPConfigurationProfileResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'privateEndpoints': ?(() { final guardedValue = privateEndpoints; if (guardedValue == null) return null; return pulumi.Input.encodeList<PrivateEndpointResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'privateLinkServiceNetworkPolicies': ?privateLinkServiceNetworkPolicies,
      'provisioningState': ?provisioningState,
      'purpose': ?purpose,
      'resourceNavigationLinks': ?(() { final guardedValue = resourceNavigationLinks; if (guardedValue == null) return null; return pulumi.Input.encodeList<ResourceNavigationLinkResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'routeTable': ?routeTable?.toMap(),
      'serviceAssociationLinks': ?(() { final guardedValue = serviceAssociationLinks; if (guardedValue == null) return null; return pulumi.Input.encodeList<ServiceAssociationLinkResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetSubnetResult.fromMap(Map<String, dynamic> map) {
    return GetSubnetResult(
      ...
      ipConfigurationProfiles: (() { final guardedValue = map['ipConfigurationProfiles']; if (guardedValue == null) return null; return pulumi.Input.decodeList<IPConfigurationProfileResponse>(guardedValue, (value) => IPConfigurationProfileResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      privateEndpoints: (() { final guardedValue = map['privateEndpoints']; if (guardedValue == null) return null; return pulumi.Input.decodeList<PrivateEndpointResponse>(guardedValue, (value) => PrivateEndpointResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      resourceNavigationLinks: (() { final guardedValue = map['resourceNavigationLinks']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ResourceNavigationLinkResponse>(guardedValue, (value) => ResourceNavigationLinkResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      serviceAssociationLinks: (() { final guardedValue = map['serviceAssociationLinks']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ServiceAssociationLinkResponse>(guardedValue, (value) => ServiceAssociationLinkResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
