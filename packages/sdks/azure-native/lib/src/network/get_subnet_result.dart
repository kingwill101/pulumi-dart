...
class GetSubnetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'applicationGatewayIPConfigurations': ?(() {
        final guardedValue = applicationGatewayIPConfigurations;
      ...
      'delegations': ?(() {
        final guardedValue = delegations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
          DelegationResponse,
          Map<String, dynamic>
      ...
      'ipConfigurationProfiles':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(ipConfigurationProfiles, (value) => value.toMap()),
      'ipConfigurations':
          pulumi.Input.encodeList<
      ...
      'ipamPoolPrefixAllocations': ?(() {
        final guardedValue = ipamPoolPrefixAllocations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'resourceNavigationLinks':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(resourceNavigationLinks, (value) => value.toMap()),
      'routeTable': ?routeTable?.toMap(),
      'serviceAssociationLinks':
          pulumi.Input.encodeList<
            ServiceAssociationLinkResponse,
            Map<String, dynamic>
          >(serviceAssociationLinks, (value) => value.toMap()),
      'serviceEndpointPolicies': ?(() {
        final guardedValue = serviceEndpointPolicies;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetSubnetResult.fromMap(Map<String, dynamic> map) {
    return GetSubnetResult(
      ...
      delegations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<DelegationResponse>(
          guardedValue,
      ...
      ipamPoolPrefixAllocations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<IpamPoolPrefixAllocationResponse>(
          guardedValue,
      ...
      privateEndpoints: pulumi.Input.decodeList<PrivateEndpointResponse>(
      ...
      serviceEndpointPolicies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ServiceEndpointPolicyResponse>(
          guardedValue,
      ...
      serviceEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ServiceEndpointPropertiesFormatResponse>(
          guardedValue,
