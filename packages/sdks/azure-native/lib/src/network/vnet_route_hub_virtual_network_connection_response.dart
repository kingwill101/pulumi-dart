...
import 'static_routes_config_hub_virtual_network_connection_response.dart';
import 'sub_resource_response.dart';

/// List of routes that control routing from VirtualHub into a virtual network connection.
class VnetRouteHubVirtualNetworkConnectionResponse {
  ...
  final pulumi.Input<StaticRoutesConfigHubVirtualNetworkConnectionResponse>? staticRoutesConfig;

  /// Creates a new [VnetRouteHubVirtualNetworkConnectionResponse].
  ...
  const VnetRouteHubVirtualNetworkConnectionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'staticRoutesConfig': ?pulumi.Input.mapOptionalInputValue<StaticRoutesConfigHubVirtualNetworkConnectionResponse, Map<String, dynamic>>(staticRoutesConfig, (value) => value.toMap()),
    };
  }

  factory VnetRouteHubVirtualNetworkConnectionResponse.fromMap(Map<String, dynamic> map) {
    return VnetRouteHubVirtualNetworkConnectionResponse(
      ...
      staticRoutesConfig: (() { final guardedValue = map['staticRoutesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StaticRoutesConfigHubVirtualNetworkConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
