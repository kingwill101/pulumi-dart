...
class FirewallPolicyLogAnalyticsWorkspaceResponse {
  ...
  FirewallPolicyLogAnalyticsWorkspaceResponse({this.region, this.workspaceId});
    ...
    return <String, dynamic>{
      ...
      'workspaceId':
          ?pulumi.Input.mapOptionalInputValue<
            SubResourceResponse,
            Map<String, dynamic>
          >(workspaceId, (value) => value.toMap()),
    };
  }

  factory FirewallPolicyLogAnalyticsWorkspaceResponse.fromMap(
