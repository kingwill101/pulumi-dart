...
class RouteVirtualNetworkApplianceResponse {
  ...
  /// Creates a new [RouteVirtualNetworkApplianceResponse].
  ...
  /// [type] Resource type.
  const RouteVirtualNetworkApplianceResponse({
    this.addressPrefix,
    required this.etag,
  ...
  factory RouteVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return RouteVirtualNetworkApplianceResponse(
