...
class VirtualNetworkPeeringArgs {
  ...
  factory VirtualNetworkPeeringArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkPeeringArgs(
      ...
      syncRemoteAddressSpace: (() { final guardedValue = map['syncRemoteAddressSpace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      virtualNetworkPeeringName: (() { final guardedValue = map['virtualNetworkPeeringName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
