...
class ApplicationGatewayWebApplicationFirewallConfigurationResponse {
  ...
  final pulumi.Input<List<ApplicationGatewayFirewallDisabledRuleGroupResponse>>?
  disabledRuleGroups;
  ...
  /// The exclusion list.
  final pulumi.Input<List<ApplicationGatewayFirewallExclusionResponse>>?
  exclusions;
    ...
    return <String, dynamic>{
      'disabledRuleGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationGatewayFirewallDisabledRuleGroupResponse>,
      ...
      'exclusions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationGatewayFirewallExclusionResponse>,
            List<Map<String, dynamic>>
          >(
            exclusions,
            (value) =>
  ...
  factory ApplicationGatewayWebApplicationFirewallConfigurationResponse.fromMap(
    ...
    return ApplicationGatewayWebApplicationFirewallConfigurationResponse(
      disabledRuleGroups: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ApplicationGatewayFirewallDisabledRuleGroupResponse.fromMap(
      ...
      exclusions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationGatewayFirewallExclusionResponse>(
            guardedValue,
            (value) => ApplicationGatewayFirewallExclusionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      maxRequestBodySize: (() {
        final guardedValue = map['maxRequestBodySize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
