...
import 'vnet_routeget_p2s_vpn_gateway_p2s_vpn_connection_health_response.dart';

/// Routing Configuration indicating the associated and propagated route tables for this connection.
class RoutingConfigurationgetP2sVpnGatewayP2sVpnConnectionHealthResponse {
  ...
  final pulumi.Input<VnetRoutegetP2sVpnGatewayP2sVpnConnectionHealthResponse?>? vnetRoutes;

  /// Creates a new [RoutingConfigurationgetP2sVpnGatewayP2sVpnConnectionHealthResponse].
  ...
  const RoutingConfigurationgetP2sVpnGatewayP2sVpnConnectionHealthResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRoutegetP2sVpnGatewayP2sVpnConnectionHealthResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationgetP2sVpnGatewayP2sVpnConnectionHealthResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationgetP2sVpnGatewayP2sVpnConnectionHealthResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRoutegetP2sVpnGatewayP2sVpnConnectionHealthResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
