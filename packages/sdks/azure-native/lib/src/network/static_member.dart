...
/// }
///
/// resource "azure-native_network_staticmember" "staticMember" {
...
class StaticMember extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [StaticMember] resource.
  StaticMember.reference(String urn)
    : super(
        'azure-native:network:StaticMember',
