...
class VirtualNetworkGateway {
  ...
  factory VirtualNetworkGateway.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGateway(
      ...
      natRules: map['natRules'] == null ? null : (pulumi.Input.decodeList<VirtualNetworkGatewayNatRule>(map['natRules']!, (value) => VirtualNetworkGatewayNatRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
