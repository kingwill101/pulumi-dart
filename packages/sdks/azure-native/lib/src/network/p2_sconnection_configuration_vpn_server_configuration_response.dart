...
import 'routing_configuration_vpn_server_configuration_response.dart';
import 'sub_resource_response.dart';
import 'vpn_server_configuration_policy_group_response.dart';

/// P2SConnectionConfiguration Resource.
class P2SConnectionConfigurationVpnServerConfigurationResponse {
  ...
  const P2SConnectionConfigurationVpnServerConfigurationResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routingConfiguration': ?pulumi.Input.mapOptionalInputValue<RoutingConfigurationVpnServerConfigurationResponse, Map<String, dynamic>>(routingConfiguration, (value) => value.toMap()),
  ...
  factory P2SConnectionConfigurationVpnServerConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return P2SConnectionConfigurationVpnServerConfigurationResponse(
      ...
      routingConfiguration: (() { final guardedValue = map['routingConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoutingConfigurationVpnServerConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
