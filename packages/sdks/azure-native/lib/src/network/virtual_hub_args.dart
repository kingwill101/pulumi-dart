...
class VirtualHubArgs {
  ...
  final pulumi.Input<List<VirtualHubRouteTableV2Network>>?
  ...
  final pulumi.Input<VirtualRouterAutoScaleConfiguration>?
    ...
    return <String, dynamic>{
      ...
      'azureFirewall':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(azureFirewall, (value) => value.toMap()),
      'expressRouteGateway':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(expressRouteGateway, (value) => value.toMap()),
      ...
      'p2SVpnGateway':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(p2SVpnGateway, (value) => value.toMap()),
      ...
      'securityPartnerProvider':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(securityPartnerProvider, (value) => value.toMap()),
      ...
      'virtualRouterAutoScaleConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            VirtualRouterAutoScaleConfiguration,
            Map<String, dynamic>
          >(virtualRouterAutoScaleConfiguration, (value) => value.toMap()),
      'virtualRouterIps': ?virtualRouterIps,
      'virtualWan':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(virtualWan, (value) => value.toMap()),
      'vpnGateway':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
  ...
  factory VirtualHubArgs.fromMap(Map<String, dynamic> map) {
    return VirtualHubArgs(
      ...
      virtualHubName: (() {
        final guardedValue = map['virtualHubName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      virtualHubRouteTableV2s: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<VirtualHubRouteTableV2Network>(),
        );
      })(),
      virtualRouterAsn: (() {
      ...
      virtualRouterAutoScaleConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualRouterAutoScaleConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
