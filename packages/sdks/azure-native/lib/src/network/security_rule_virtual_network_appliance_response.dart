...
class SecurityRuleVirtualNetworkApplianceResponse {
  ...
  /// Creates a new [SecurityRuleVirtualNetworkApplianceResponse].
  ...
  /// [type] Resource type.
  const SecurityRuleVirtualNetworkApplianceResponse({
  ...
  factory SecurityRuleVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return SecurityRuleVirtualNetworkApplianceResponse(
      ...
      destinationApplicationSecurityGroups: (() { final guardedValue = map['destinationApplicationSecurityGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationSecurityGroupResponse>(guardedValue, (value) => ApplicationSecurityGroupResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sourceApplicationSecurityGroups: (() { final guardedValue = map['sourceApplicationSecurityGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationSecurityGroupResponse>(guardedValue, (value) => ApplicationSecurityGroupResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
