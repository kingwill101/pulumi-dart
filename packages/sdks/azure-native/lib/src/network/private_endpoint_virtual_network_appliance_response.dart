...
class PrivateEndpointVirtualNetworkApplianceResponse {
  ...
  /// Creates a new [PrivateEndpointVirtualNetworkApplianceResponse].
  ...
  /// [tags] Resource tags.
  /// [type] Resource type.
  const PrivateEndpointVirtualNetworkApplianceResponse({
  ...
  factory PrivateEndpointVirtualNetworkApplianceResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointVirtualNetworkApplianceResponse(
