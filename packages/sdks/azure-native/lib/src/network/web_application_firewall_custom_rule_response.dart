...
class WebApplicationFirewallCustomRuleResponse {
  ...
  factory WebApplicationFirewallCustomRuleResponse.fromMap(Map<String, dynamic> map) {
    return WebApplicationFirewallCustomRuleResponse(
      ...
      groupByUserSession: (() { final guardedValue = map['groupByUserSession']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupByUserSessionResponse>(guardedValue, (value) => GroupByUserSessionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
