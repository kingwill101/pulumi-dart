...
class GetNetworkSecurityPerimeterLinkResult {
  ...
  /// Creates a new [GetNetworkSecurityPerimeterLinkResult].
  ...
  const GetNetworkSecurityPerimeterLinkResult({
    ...
    this.localOutboundProfiles,
    this.name,
    this.provisioningState,
    this.remoteInboundProfiles,
    this.remoteOutboundProfiles,
    this.remotePerimeterGuid,
  ...
  factory GetNetworkSecurityPerimeterLinkResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkSecurityPerimeterLinkResult(
      ...
      localOutboundProfiles: (() { final guardedValue = map['localOutboundProfiles']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      ...
      remoteOutboundProfiles: (() { final guardedValue = map['remoteOutboundProfiles']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      remotePerimeterGuid: (() { final guardedValue = map['remotePerimeterGuid']; if (guardedValue == null) return null; return guardedValue as String; })(),
      remotePerimeterLocation: (() { final guardedValue = map['remotePerimeterLocation']; if (guardedValue == null) return null; return guardedValue as String; })(),
