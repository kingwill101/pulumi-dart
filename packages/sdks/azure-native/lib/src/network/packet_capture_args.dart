...
class PacketCaptureArgs {
    ...
    return <String, dynamic>{
      ...
      'captureSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(captureSettings, (value) => value.toMap()),
      ...
      'target': target,
      'targetType':
          ?pulumi.Input.mapOptionalInputValue<PacketCaptureTargetType, String>(
            targetType,
  ...
  factory PacketCaptureArgs.fromMap(Map<String, dynamic> map) {
    return PacketCaptureArgs(
      ...
      packetCaptureName: (() {
        final guardedValue = map['packetCaptureName'];
        if (guardedValue == null) return null;
      ...
      scope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PacketCaptureMachineScope.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      targetType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PacketCaptureTargetType.fromValue(guardedValue as String),
        );
      })(),
      timeLimitInSeconds: (() {
