...
class GetVirtualNetworkGatewayResult {
  ...
  final VirtualNetworkGatewayAutoScaleConfigurationResponse?
  ...
  final List<VirtualNetworkGatewayPolicyGroupResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualNetworkGatewayPolicyGroups': ?(() {
        final guardedValue = virtualNetworkGatewayPolicyGroups;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetVirtualNetworkGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualNetworkGatewayResult(
      ...
      ipConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<VirtualNetworkGatewayIPConfigurationResponse>(
          guardedValue,
      ...
      natRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VirtualNetworkGatewayNatRuleResponse>(
          guardedValue,
      ...
      virtualNetworkGatewayPolicyGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<VirtualNetworkGatewayPolicyGroupResponse>(
          guardedValue,
