...
class ApplicationGatewayBackendHttpSettingsResponse {
  ...
  final pulumi.Input<ApplicationGatewayConnectionDrainingResponse>?
  connectionDraining;
  ...
  factory ApplicationGatewayBackendHttpSettingsResponse.fromMap(
    ...
    return ApplicationGatewayBackendHttpSettingsResponse(
      ...
      connectionDraining: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationGatewayConnectionDrainingResponse.fromMap(
