...
import 'ipconfiguration_profile_virtual_network_appliance_response.dart';
...
class SubnetResponseV2 {
  ...
  final pulumi.Input<List<IPConfigurationProfileVirtualNetworkApplianceResponse>> ipConfigurationProfiles;
  ...
  /// Creates a new [SubnetResponseV2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurationProfiles': pulumi.Input.mapInputValue<List<IPConfigurationProfileVirtualNetworkApplianceResponse>, List<Map<String, dynamic>>>(ipConfigurationProfiles, (value) => pulumi.Input.encodeList<IPConfigurationProfileVirtualNetworkApplianceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory SubnetResponseV2.fromMap(Map<String, dynamic> map) {
    return SubnetResponseV2(
      ...
      ipConfigurationProfiles: pulumi.Input.fromValue(pulumi.Input.decodeList<IPConfigurationProfileVirtualNetworkApplianceResponse>(map['ipConfigurationProfiles']!, (value) => IPConfigurationProfileVirtualNetworkApplianceResponse.fromMap((value as Map).cast<String, dynamic>()))),
