...
class ConnectionMonitorEndpointResponse {
  ...
  final ConnectionMonitorEndpointFilterResponse? filter;
  /// Location details is optional and only being used for 'AzureArcNetwork' type endpoints, which contains region details.
  final ConnectionMonitorEndpointLocationDetailsResponse? locationDetails;
  ...
  final ConnectionMonitorEndpointScopeResponse? scope;
  ...
  factory ConnectionMonitorEndpointResponse.fromMap(Map<String, dynamic> map) {
    return ConnectionMonitorEndpointResponse(
      ...
      filter: map['filter'] == null ? null : ConnectionMonitorEndpointFilterResponse.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      locationDetails: map['locationDetails'] == null ? null : ConnectionMonitorEndpointLocationDetailsResponse.fromMap((map['locationDetails'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      resourceId: map['resourceId'] == null ? null : map['resourceId'] as String,
      scope: map['scope'] == null ? null : ConnectionMonitorEndpointScopeResponse.fromMap((map['scope'] as Map).cast<String, dynamic>()),
