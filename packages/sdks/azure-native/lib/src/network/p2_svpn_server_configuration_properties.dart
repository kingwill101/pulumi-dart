...
class P2SVpnServerConfigurationProperties {
  ...
  final pulumi.Input<List<P2SVpnServerConfigRadiusClientRootCertificate>>?
  p2SVpnServerConfigRadiusClientRootCertificates;

  /// Radius Server root certificate of P2SVpnServerConfiguration.
  final pulumi.Input<List<P2SVpnServerConfigRadiusServerRootCertificate>>?
  p2SVpnServerConfigRadiusServerRootCertificates;

  /// VPN client revoked certificate of P2SVpnServerConfiguration.
  final pulumi.Input<List<P2SVpnServerConfigVpnClientRevokedCertificate>>?
  p2SVpnServerConfigVpnClientRevokedCertificates;

  /// VPN client root certificate of P2SVpnServerConfiguration.
  final pulumi.Input<List<P2SVpnServerConfigVpnClientRootCertificate>>?
  ...
  factory P2SVpnServerConfigurationProperties.fromMap(
    ...
    return P2SVpnServerConfigurationProperties(
      ...
      p2SVpnServerConfigRadiusClientRootCertificates: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<P2SVpnServerConfigRadiusClientRootCertificate>(
            guardedValue,
            (value) => P2SVpnServerConfigRadiusClientRootCertificate.fromMap(
      ...
      p2SVpnServerConfigRadiusServerRootCertificates: (() {
        final guardedValue =
            map['p2SVpnServerConfigRadiusServerRootCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<P2SVpnServerConfigRadiusServerRootCertificate>(
            guardedValue,
            (value) => P2SVpnServerConfigRadiusServerRootCertificate.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      p2SVpnServerConfigVpnClientRevokedCertificates: (() {
        final guardedValue =
            map['p2SVpnServerConfigVpnClientRevokedCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<P2SVpnServerConfigVpnClientRevokedCertificate>(
            guardedValue,
            (value) => P2SVpnServerConfigVpnClientRevokedCertificate.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      p2SVpnServerConfigVpnClientRootCertificates: (() {
        final guardedValue = map['p2SVpnServerConfigVpnClientRootCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<P2SVpnServerConfigVpnClientRootCertificate>(
            guardedValue,
            (value) => P2SVpnServerConfigVpnClientRootCertificate.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
