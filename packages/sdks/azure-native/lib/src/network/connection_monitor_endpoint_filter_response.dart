...
class ConnectionMonitorEndpointFilterResponse {
  ...
  ConnectionMonitorEndpointFilterResponse({this.items, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'items':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConnectionMonitorEndpointFilterItemResponse>,
  ...
  factory ConnectionMonitorEndpointFilterResponse.fromMap(
    ...
    return ConnectionMonitorEndpointFilterResponse(
      items: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConnectionMonitorEndpointFilterItemResponse>(
            guardedValue,
            (value) => ConnectionMonitorEndpointFilterItemResponse.fromMap(
