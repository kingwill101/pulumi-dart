...
/// }
///
/// resource "azure-native_network_scopeconnection" "scopeConnection" {
///   description           = "This is a scope connection to a cross tenant subscription."
...
class ScopeConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ScopeConnection] resource.
  ScopeConnection.reference(String urn)
    : super(
        'azure-native:network:ScopeConnection',
