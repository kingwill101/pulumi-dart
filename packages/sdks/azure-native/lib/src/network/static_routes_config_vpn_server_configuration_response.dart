...
class StaticRoutesConfigVpnServerConfigurationResponse {
  ...
  /// Creates a new [StaticRoutesConfigVpnServerConfigurationResponse].
  ...
  const StaticRoutesConfigVpnServerConfigurationResponse({
  ...
  factory StaticRoutesConfigVpnServerConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return StaticRoutesConfigVpnServerConfigurationResponse(
