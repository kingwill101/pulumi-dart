...
class HubPublicIPAddressesResponse {
  ...
  HubPublicIPAddressesResponse({this.addresses, this.count});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureFirewallPublicIPAddressResponse>,
    ...
    return HubPublicIPAddressesResponse(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureFirewallPublicIPAddressResponse>(
            guardedValue,
            (value) => AzureFirewallPublicIPAddressResponse.fromMap(
