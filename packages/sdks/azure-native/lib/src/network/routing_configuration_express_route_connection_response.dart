...
import 'vnet_route_express_route_connection_response.dart';

/// Routing Configuration indicating the associated and propagated route tables for this connection.
class RoutingConfigurationExpressRouteConnectionResponse {
  ...
  final pulumi.Input<VnetRouteExpressRouteConnectionResponse>? vnetRoutes;

  /// Creates a new [RoutingConfigurationExpressRouteConnectionResponse].
  ...
  const RoutingConfigurationExpressRouteConnectionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRouteExpressRouteConnectionResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationExpressRouteConnectionResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationExpressRouteConnectionResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteExpressRouteConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
