...
class ListListEffectiveVirtualNetworkByNetworkGroupResult {
  ...
  const ListListEffectiveVirtualNetworkByNetworkGroupResult({
    this.skipToken,
    this.value,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'skipToken': ?skipToken,
      'value': ?(() { final guardedValue = value; if (guardedValue == null) return null; return pulumi.Input.encodeList<EffectiveVirtualNetworkResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory ListListEffectiveVirtualNetworkByNetworkGroupResult.fromMap(Map<String, dynamic> map) {
    return ListListEffectiveVirtualNetworkByNetworkGroupResult(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.decodeList<EffectiveVirtualNetworkResponse>(guardedValue, (value) => EffectiveVirtualNetworkResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
