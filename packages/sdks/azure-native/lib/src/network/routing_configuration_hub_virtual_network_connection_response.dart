...
import 'vnet_route_hub_virtual_network_connection_response.dart';

/// Routing Configuration indicating the associated and propagated route tables for this connection.
class RoutingConfigurationHubVirtualNetworkConnectionResponse {
  ...
  final pulumi.Input<VnetRouteHubVirtualNetworkConnectionResponse>? vnetRoutes;

  /// Creates a new [RoutingConfigurationHubVirtualNetworkConnectionResponse].
  ...
  const RoutingConfigurationHubVirtualNetworkConnectionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRouteHubVirtualNetworkConnectionResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationHubVirtualNetworkConnectionResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationHubVirtualNetworkConnectionResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteHubVirtualNetworkConnectionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
