...
import 'vnet_route_express_route_gateway_response.dart';

/// Routing Configuration indicating the associated and propagated route tables for this connection.
class RoutingConfigurationExpressRouteGatewayResponse {
  ...
  final pulumi.Input<VnetRouteExpressRouteGatewayResponse?>? vnetRoutes;

  /// Creates a new [RoutingConfigurationExpressRouteGatewayResponse].
  ...
  const RoutingConfigurationExpressRouteGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vnetRoutes': ?pulumi.Input.mapOptionalInputValue<VnetRouteExpressRouteGatewayResponse, Map<String, dynamic>>(vnetRoutes, (value) => value.toMap()),
    };
  }

  factory RoutingConfigurationExpressRouteGatewayResponse.fromMap(Map<String, dynamic> map) {
    return RoutingConfigurationExpressRouteGatewayResponse(
      ...
      vnetRoutes: (() { final guardedValue = map['vnetRoutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VnetRouteExpressRouteGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
