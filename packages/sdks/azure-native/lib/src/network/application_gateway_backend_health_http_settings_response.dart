...
class ApplicationGatewayBackendHealthHttpSettingsResponse {
  ...
  factory ApplicationGatewayBackendHealthHttpSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayBackendHealthHttpSettingsResponse(
      backendHttpSettings: (() { final guardedValue = map['backendHttpSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationGatewayBackendHttpSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      servers: (() { final guardedValue = map['servers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayBackendHealthServerResponse>(guardedValue, (value) => ApplicationGatewayBackendHealthServerResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
