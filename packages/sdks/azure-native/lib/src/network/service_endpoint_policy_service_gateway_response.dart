...
import 'service_endpoint_policy_definition_service_gateway_response.dart';
import 'subnet_response.dart';

/// Service End point policy resource.
class ServiceEndpointPolicyServiceGatewayResponse {
  ...
  final pulumi.Input<List<ServiceEndpointPolicyDefinitionServiceGatewayResponse>?>? serviceEndpointPolicyDefinitions;
  ...
  /// Creates a new [ServiceEndpointPolicyServiceGatewayResponse].
  ...
  /// [tags] Resource tags.
  /// [type] Resource type.
  const ServiceEndpointPolicyServiceGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serviceEndpointPolicyDefinitions': ?pulumi.Input.mapOptionalInputValue<List<ServiceEndpointPolicyDefinitionServiceGatewayResponse>, List<Map<String, dynamic>>>(serviceEndpointPolicyDefinitions, (value) => pulumi.Input.encodeList<ServiceEndpointPolicyDefinitionServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServiceEndpointPolicyServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return ServiceEndpointPolicyServiceGatewayResponse(
      ...
      serviceEndpointPolicyDefinitions: (() { final guardedValue = map['serviceEndpointPolicyDefinitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceEndpointPolicyDefinitionServiceGatewayResponse>(guardedValue, (value) => ServiceEndpointPolicyDefinitionServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
