...
/// }
///
/// resource "azure-native_network_securityuserconfiguration" "securityUserConfiguration" {
...
class SecurityUserConfiguration extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [SecurityUserConfiguration] resource.
  SecurityUserConfiguration.reference(String urn)
    : super(
        'azure-native:network:SecurityUserConfiguration',
