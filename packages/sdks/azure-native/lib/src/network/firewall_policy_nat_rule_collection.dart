...
class FirewallPolicyNatRuleCollection {
  ...
  factory FirewallPolicyNatRuleCollection.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyNatRuleCollection(
      action: (() { final guardedValue = map['action']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirewallPolicyNatRuleCollectionAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationRule>(guardedValue, (value) => ApplicationRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
