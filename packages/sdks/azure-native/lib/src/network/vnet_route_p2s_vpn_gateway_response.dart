...
import 'static_routes_config_p2s_vpn_gateway_response.dart';
import 'sub_resource_response.dart';

/// List of routes that control routing from VirtualHub into a virtual network connection.
class VnetRouteP2sVpnGatewayResponse {
  ...
  final pulumi.Input<StaticRoutesConfigP2sVpnGatewayResponse?>? staticRoutesConfig;

  /// Creates a new [VnetRouteP2sVpnGatewayResponse].
  ...
  const VnetRouteP2sVpnGatewayResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'staticRoutesConfig': ?pulumi.Input.mapOptionalInputValue<StaticRoutesConfigP2sVpnGatewayResponse, Map<String, dynamic>>(staticRoutesConfig, (value) => value.toMap()),
    };
  }

  factory VnetRouteP2sVpnGatewayResponse.fromMap(Map<String, dynamic> map) {
    return VnetRouteP2sVpnGatewayResponse(
      ...
      staticRoutesConfig: (() { final guardedValue = map['staticRoutesConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StaticRoutesConfigP2sVpnGatewayResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
