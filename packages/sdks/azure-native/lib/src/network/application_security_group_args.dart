...
class ApplicationSecurityGroupArgs {
  ...
  ApplicationSecurityGroupArgs({
    pulumi.Output<String>? applicationSecurityGroupName,
  ...
  factory ApplicationSecurityGroupArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationSecurityGroupArgs(
      applicationSecurityGroupName: map['applicationSecurityGroupName'] == null ? null : pulumi.Output.create<String>(map['applicationSecurityGroupName'] as String),
