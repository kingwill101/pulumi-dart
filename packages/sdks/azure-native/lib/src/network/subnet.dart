...
class Subnet {
    ...
    return <String, dynamic>{
      ...
      'delegations':
          ...
          >(
            delegations,
            (value) =>
                pulumi.Input.encodeList<Delegation, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'routeTable':
          ?pulumi.Input.mapOptionalInputValue<RouteTable, Map<String, dynamic>>(
            routeTable,
            (value) => value.toMap(),
          ),
      ...
      'serviceGateway':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(serviceGateway, (value) => value.toMap()),
  ...
  factory Subnet.fromMap(Map<String, dynamic> map) {
    return Subnet(
      ...
      applicationGatewayIPConfigurations: (() {
        final guardedValue = map['applicationGatewayIPConfigurations'];
        if (guardedValue == null) return null;
      ...
      defaultOutboundAccess: (() {
        final guardedValue = map['defaultOutboundAccess'];
        if (guardedValue == null) return null;
      ...
      delegations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Delegation>(
            guardedValue,
            (value) =>
                Delegation.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      etag: (() {
      ...
      ipamPoolPrefixAllocations: (() {
        final guardedValue = map['ipamPoolPrefixAllocations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpamPoolPrefixAllocation>(
            guardedValue,
            (value) => IpamPoolPrefixAllocation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      resourceNavigationLinks: (() {
        final guardedValue = map['resourceNavigationLinks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceNavigationLink>(
            guardedValue,
            (value) => ResourceNavigationLink.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      routeTable: (() {
        final guardedValue = map['routeTable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RouteTable.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      serviceAssociationLinks: (() {
        final guardedValue = map['serviceAssociationLinks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceAssociationLink>(
            guardedValue,
            (value) => ServiceAssociationLink.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceEndpointPolicies: (() {
        final guardedValue = map['serviceEndpointPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceEndpointPolicy>(
            guardedValue,
            (value) => ServiceEndpointPolicy.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceEndpointPropertiesFormat>(
            guardedValue,
            (value) => ServiceEndpointPropertiesFormat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceGateway: (() {
        final guardedValue = map['serviceGateway'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubResource.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      ...
      sharingScope: (() {
        final guardedValue = map['sharingScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      type: (() {
