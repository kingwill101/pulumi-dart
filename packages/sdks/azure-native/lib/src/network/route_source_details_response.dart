...
class RouteSourceDetailsResponse {
  ...
  factory RouteSourceDetailsResponse.fromMap(Map<String, dynamic> map) {
    return RouteSourceDetailsResponse(
      circuit: (() { final guardedValue = map['circuit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pri: (() { final guardedValue = map['pri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sec: (() { final guardedValue = map['sec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
