...
class NetworkInterfaceIPConfiguration {
  ...
  factory NetworkInterfaceIPConfiguration.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceIPConfiguration(
      applicationGatewayBackendAddressPools: (() { final guardedValue = map['applicationGatewayBackendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayBackendAddressPool>(guardedValue, (value) => ApplicationGatewayBackendAddressPool.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      loadBalancerBackendAddressPools: (() { final guardedValue = map['loadBalancerBackendAddressPools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BackendAddressPool>(guardedValue, (value) => BackendAddressPool.fromMap((value as Map).cast<String, dynamic>()))); })(),
      loadBalancerInboundNatRules: (() { final guardedValue = map['loadBalancerInboundNatRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InboundNatRule>(guardedValue, (value) => InboundNatRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      virtualNetworkTaps: (() { final guardedValue = map['virtualNetworkTaps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualNetworkTap>(guardedValue, (value) => VirtualNetworkTap.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
