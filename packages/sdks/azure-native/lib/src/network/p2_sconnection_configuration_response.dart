...
class P2SConnectionConfigurationResponse {
  ...
  factory P2SConnectionConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return P2SConnectionConfigurationResponse(
      configurationPolicyGroupAssociations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SubResourceResponse>(
          map['configurationPolicyGroupAssociations']!,
      ...
      previousConfigurationPolicyGroupAssociations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VpnServerConfigurationPolicyGroupResponse>(
          map['previousConfigurationPolicyGroupAssociations']!,
