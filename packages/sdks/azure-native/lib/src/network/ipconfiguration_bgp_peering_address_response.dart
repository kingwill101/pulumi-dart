...
class IPConfigurationBgpPeeringAddressResponse {
  ...
  factory IPConfigurationBgpPeeringAddressResponse.fromMap(
    ...
    return IPConfigurationBgpPeeringAddressResponse(
      ...
      defaultBgpIpAddresses: pulumi.Input.fromValue(
        (map['defaultBgpIpAddresses'] as List).cast<String>(),
      ),
      ipconfigurationId: (() {
      ...
      tunnelIpAddresses: pulumi.Input.fromValue(
        (map['tunnelIpAddresses'] as List).cast<String>(),
      ),
    );
  }
}
