...
/// }
///
/// resource "azure-native_network_staticcidr" "staticCidr" {
...
class StaticCidr extends pulumi.CustomResource {
  ...
  StaticCidr(
    ...
    properties = registerOutput<StaticCidrPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return StaticCidrPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [StaticCidr] resource.
  StaticCidr.reference(String urn)
    : super(
        'azure-native:network:StaticCidr',
