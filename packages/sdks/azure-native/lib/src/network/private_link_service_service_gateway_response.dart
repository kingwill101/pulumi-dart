...
import 'frontend_ipconfiguration_service_gateway_response.dart';
import 'network_interface_response.dart';
import 'private_endpoint_connection_service_gateway_response.dart';
import 'private_link_service_ip_configuration_response.dart';
import 'private_link_service_properties_auto_approval_response.dart';
import 'private_link_service_properties_visibility_response.dart';

/// Private link service resource.
class PrivateLinkServiceServiceGatewayResponse {
  ...
  final pulumi.Input<List<FrontendIPConfigurationServiceGatewayResponse>?>? loadBalancerFrontendIpConfigurations;
  /// Resource location.
  ...
  final pulumi.Input<List<PrivateEndpointConnectionServiceGatewayResponse>> privateEndpointConnections;
  ...
  /// Creates a new [PrivateLinkServiceServiceGatewayResponse].
  ...
  const PrivateLinkServiceServiceGatewayResponse({
    this.accessMode,
    required this.alias,
    this.autoApproval,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'alias': alias,
      'autoApproval': ?pulumi.Input.mapOptionalInputValue<PrivateLinkServicePropertiesAutoApprovalResponse, Map<String, dynamic>>(autoApproval, (value) => value.toMap()),
      ...
      'loadBalancerFrontendIpConfigurations': ?pulumi.Input.mapOptionalInputValue<List<FrontendIPConfigurationServiceGatewayResponse>, List<Map<String, dynamic>>>(loadBalancerFrontendIpConfigurations, (value) => pulumi.Input.encodeList<FrontendIPConfigurationServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'location': ?location,
      'name': name,
      ...
      'privateEndpointConnections': pulumi.Input.mapInputValue<List<PrivateEndpointConnectionServiceGatewayResponse>, List<Map<String, dynamic>>>(privateEndpointConnections, (value) => pulumi.Input.encodeList<PrivateEndpointConnectionServiceGatewayResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'provisioningState': provisioningState,
      'tags': ?tags,
      'type': type,
      'visibility': ?pulumi.Input.mapOptionalInputValue<PrivateLinkServicePropertiesVisibilityResponse, Map<String, dynamic>>(visibility, (value) => value.toMap()),
    };
  }

  factory PrivateLinkServiceServiceGatewayResponse.fromMap(Map<String, dynamic> map) {
    return PrivateLinkServiceServiceGatewayResponse(
      ...
      autoApproval: (() { final guardedValue = map['autoApproval']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateLinkServicePropertiesAutoApprovalResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      loadBalancerFrontendIpConfigurations: (() { final guardedValue = map['loadBalancerFrontendIpConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FrontendIPConfigurationServiceGatewayResponse>(guardedValue, (value) => FrontendIPConfigurationServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      privateEndpointConnections: pulumi.Input.fromValue(pulumi.Input.decodeList<PrivateEndpointConnectionServiceGatewayResponse>(map['privateEndpointConnections']!, (value) => PrivateEndpointConnectionServiceGatewayResponse.fromMap((value as Map).cast<String, dynamic>()))),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      type: pulumi.Input.fromValue(map['type'] as String),
      visibility: (() { final guardedValue = map['visibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateLinkServicePropertiesVisibilityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
