...
class ApplicationGatewayUrlPathMapResponse {
  ...
  factory ApplicationGatewayUrlPathMapResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayUrlPathMapResponse(
      defaultBackendAddressPool: (() { final guardedValue = map['defaultBackendAddressPool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultBackendHttpSettings: (() { final guardedValue = map['defaultBackendHttpSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultLoadDistributionPolicy: (() { final guardedValue = map['defaultLoadDistributionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultRedirectConfiguration: (() { final guardedValue = map['defaultRedirectConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      defaultRewriteRuleSet: (() { final guardedValue = map['defaultRewriteRuleSet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      etag: pulumi.Input.fromValue(map['etag'] as String),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pathRules: (() { final guardedValue = map['pathRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGatewayPathRuleResponse>(guardedValue, (value) => ApplicationGatewayPathRuleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
