...
class AppArgs {
  ...
  AppArgs({
    ...
    pulumi.Output<NetworkRuleSets>? networkRuleSets,
    pulumi.Output<String>? publicNetworkAccess,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? resourceName,
    required pulumi.Output<AppSkuInfo> sku,
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      networkRuleSets: map['networkRuleSets'] == null ? null : pulumi.Output.create<NetworkRuleSets>(NetworkRuleSets.fromMap((map['networkRuleSets'] as Map).cast<String, dynamic>())),
      ...
      sku: pulumi.Output.create<AppSkuInfo>(AppSkuInfo.fromMap((map['sku'] as Map).cast<String, dynamic>())),
