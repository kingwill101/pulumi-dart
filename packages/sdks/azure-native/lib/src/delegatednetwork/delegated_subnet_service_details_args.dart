...
class DelegatedSubnetServiceDetailsArgs {
  ...
  factory DelegatedSubnetServiceDetailsArgs.fromMap(Map<String, dynamic> map) {
    return DelegatedSubnetServiceDetailsArgs(
      ...
      subnetDetails: (() { final guardedValue = map['subnetDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubnetDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
