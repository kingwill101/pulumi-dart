...
class ImageTemplatePropertiesResponseValidate {
    ...
    return <String, dynamic>{
      ...
      'inVMValidations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ImageTemplateFileValidatorResponse>,
  ...
  factory ImageTemplatePropertiesResponseValidate.fromMap(
    ...
    return ImageTemplatePropertiesResponseValidate(
      ...
      inVMValidations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageTemplateFileValidatorResponse>(
            guardedValue,
            (value) => ImageTemplateFileValidatorResponse.fromMap(
