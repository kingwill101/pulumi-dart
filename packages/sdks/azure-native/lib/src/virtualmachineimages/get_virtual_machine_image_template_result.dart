...
class GetVirtualMachineImageTemplateResult {
  ...
  final List<dynamic>? customize;
  /// The distribution targets where the image output needs to go to.
  final List<dynamic>? distribute;
  ...
  GetVirtualMachineImageTemplateResult({
    ...
    this.distribute,
    this.errorHandling,
    this.exactStagingResourceGroup,
    this.id,
    this.identity,
    this.lastRunStatus,
    this.location,
    ...
    this.validate,
    this.vmProfile,
  }) : buildTimeoutInMinutes = buildTimeoutInMinutes ?? 0;
  ...
  factory GetVirtualMachineImageTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualMachineImageTemplateResult(
      ...
      buildTimeoutInMinutes: (() { final guardedValue = map['buildTimeoutInMinutes']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      customize: (() { final guardedValue = map['customize']; if (guardedValue == null) return null; return (guardedValue as List).cast<dynamic>(); })(),
      distribute: (() { final guardedValue = map['distribute']; if (guardedValue == null) return null; return (guardedValue as List).cast<dynamic>(); })(),
      ...
      exactStagingResourceGroup: (() { final guardedValue = map['exactStagingResourceGroup']; if (guardedValue == null) return null; return guardedValue as String; })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return guardedValue as String; })(),
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return ImageTemplateIdentityResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      lastRunStatus: (() { final guardedValue = map['lastRunStatus']; if (guardedValue == null) return null; return ImageTemplateLastRunStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      provisioningError: (() { final guardedValue = map['provisioningError']; if (guardedValue == null) return null; return ProvisioningErrorResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      provisioningState: (() { final guardedValue = map['provisioningState']; if (guardedValue == null) return null; return guardedValue as String; })(),
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return guardedValue; })(),
