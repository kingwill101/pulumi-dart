...
class ImageTemplatePlatformImageSourceResponse {
  ...
  factory ImageTemplatePlatformImageSourceResponse.fromMap(Map<String, dynamic> map) {
    return ImageTemplatePlatformImageSourceResponse(
      ...
      planInfo: (() { final guardedValue = map['planInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PlatformImagePurchasePlanResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
