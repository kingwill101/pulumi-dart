...
class ImageTemplateSharedImageDistributorResponse {
  ...
  final pulumi.Input<dynamic>? versioning;
  ...
  ImageTemplateSharedImageDistributorResponse({
    this.artifactTags,
    pulumi.Input<bool?>? excludeFromLatest,
    ...
    required this.type,
    this.versioning,
  }) : excludeFromLatest = excludeFromLatest ?? pulumi.Input.fromValue(false);
  ...
  factory ImageTemplateSharedImageDistributorResponse.fromMap(Map<String, dynamic> map) {
    return ImageTemplateSharedImageDistributorResponse(
      ...
      versioning: (() { final guardedValue = map['versioning']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
