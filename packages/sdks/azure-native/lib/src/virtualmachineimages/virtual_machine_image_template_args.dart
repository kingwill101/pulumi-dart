...
class VirtualMachineImageTemplateArgs {
  ...
  final pulumi.Input<List<dynamic>?>? customize;
  /// The distribution targets where the image output needs to go to.
  final pulumi.Input<List<dynamic>> distribute;
  ...
  VirtualMachineImageTemplateArgs({
    this.autoRun,
    pulumi.Input<int?>? buildTimeoutInMinutes,
    this.customize,
    ...
    this.validate,
    this.vmProfile,
  }) : buildTimeoutInMinutes = buildTimeoutInMinutes ?? pulumi.Input.fromValue(0);
  ...
  factory VirtualMachineImageTemplateArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineImageTemplateArgs(
      ...
      buildTimeoutInMinutes: (() { final guardedValue = map['buildTimeoutInMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      customize: (() { final guardedValue = map['customize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      distribute: pulumi.Input.fromValue((map['distribute'] as List).cast<dynamic>()),
