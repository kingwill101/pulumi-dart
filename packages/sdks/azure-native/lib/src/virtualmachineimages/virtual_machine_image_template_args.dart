    ...
    return <String, dynamic>{
      'autoRun':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(autoRun, (value) => value.toMap()),
      'buildTimeoutInMinutes': ?buildTimeoutInMinutes,
      'customize':
          ?pulumi.Input.mapOptionalInputValue<
            List<ImageTemplateFileCustomizer>,
      ...
      'distribute':
          pulumi.Input.mapInputValue<
            List<ImageTemplateManagedImageDistributor>,
            List<Map<String, dynamic>>
          >(
            distribute,
            (value) =>
      ...
      'errorHandling':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(errorHandling, (value) => value.toMap()),
      'identity':
          pulumi.Input.mapInputValue<
  ...
  factory VirtualMachineImageTemplateArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineImageTemplateArgs(
      ...
      customize: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageTemplateFileCustomizer>(
            guardedValue,
            (value) => ImageTemplateFileCustomizer.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      distribute: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ImageTemplateManagedImageDistributor>(
          map['distribute']!,
          (value) => ImageTemplateManagedImageDistributor.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      errorHandling: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageTemplatePropertiesErrorHandling.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      identity: pulumi.Input.fromValue(
        ImageTemplateIdentity.fromMap(
          (map['identity']! as Map).cast<String, dynamic>(),
        ),
      ),
      imageTemplateName: (() {
        final guardedValue = map['imageTemplateName'];
        if (guardedValue == null) return null;
      ...
      optimize: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageTemplatePropertiesOptimize.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      source: pulumi.Input.fromValue(
        ImageTemplateManagedImageSource.fromMap(
      ...
      validate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageTemplatePropertiesValidate.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vmProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageTemplateVmProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
