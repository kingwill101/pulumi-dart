...
class VirtualMachineImageTemplateArgs {
  ...
  VirtualMachineImageTemplateArgs({
    pulumi.Output<ImageTemplateAutoRun>? autoRun,
    pulumi.Output<int>? buildTimeoutInMinutes,
    pulumi.Output<List<ImageTemplateFileCustomizer>>? customize,
    required pulumi.Output<List<ImageTemplateManagedImageDistributor>> distribute,
    pulumi.Output<ImageTemplatePropertiesErrorHandling>? errorHandling,
    required pulumi.Output<ImageTemplateIdentity> identity,
    pulumi.Output<String>? imageTemplateName,
    pulumi.Output<String>? location,
    pulumi.Output<Map<String, String>>? managedResourceTags,
    pulumi.Output<ImageTemplatePropertiesOptimize>? optimize,
    required pulumi.Output<String> resourceGroupName,
    required pulumi.Output<ImageTemplateManagedImageSource> source,
    pulumi.Output<String>? stagingResourceGroup,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<ImageTemplatePropertiesValidate>? validate,
    pulumi.Output<ImageTemplateVmProfile>? vmProfile,
  }) :
      autoRun = pulumi.Input.asOptionalInput<ImageTemplateAutoRun>(autoRun),
      buildTimeoutInMinutes = pulumi.Input.asOptionalInput<int>(buildTimeoutInMinutes),
      customize = pulumi.Input.asOptionalInput<List<ImageTemplateFileCustomizer>>(customize),
      distribute = pulumi.Input.asInput<List<ImageTemplateManagedImageDistributor>>(distribute),
      errorHandling = pulumi.Input.asOptionalInput<ImageTemplatePropertiesErrorHandling>(errorHandling),
      identity = pulumi.Input.asInput<ImageTemplateIdentity>(identity),
      imageTemplateName = pulumi.Input.asOptionalInput<String>(imageTemplateName),
      location = pulumi.Input.asOptionalInput<String>(location),
      managedResourceTags = pulumi.Input.asOptionalInput<Map<String, String>>(managedResourceTags),
      optimize = pulumi.Input.asOptionalInput<ImageTemplatePropertiesOptimize>(optimize),
      resourceGroupName = pulumi.Input.asInput<String>(resourceGroupName),
      source = pulumi.Input.asInput<ImageTemplateManagedImageSource>(source),
      stagingResourceGroup = pulumi.Input.asOptionalInput<String>(stagingResourceGroup),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      validate = pulumi.Input.asOptionalInput<ImageTemplatePropertiesValidate>(validate),
      vmProfile = pulumi.Input.asOptionalInput<ImageTemplateVmProfile>(vmProfile);
  ...
  factory VirtualMachineImageTemplateArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineImageTemplateArgs(
      autoRun: map['autoRun'] == null ? null : pulumi.Output.create<ImageTemplateAutoRun>(ImageTemplateAutoRun.fromMap((map['autoRun'] as Map).cast<String, dynamic>())),
      buildTimeoutInMinutes: map['buildTimeoutInMinutes'] == null ? null : pulumi.Output.create<int>(map['buildTimeoutInMinutes'] as int),
      customize: map['customize'] == null ? null : pulumi.Output.create<List<ImageTemplateFileCustomizer>>(pulumi.Input.decodeList<ImageTemplateFileCustomizer>(map['customize'], (value) => ImageTemplateFileCustomizer.fromMap((value as Map).cast<String, dynamic>()))),
      distribute: pulumi.Output.create<List<ImageTemplateManagedImageDistributor>>(pulumi.Input.decodeList<ImageTemplateManagedImageDistributor>(map['distribute'], (value) => ImageTemplateManagedImageDistributor.fromMap((value as Map).cast<String, dynamic>()))),
      errorHandling: map['errorHandling'] == null ? null : pulumi.Output.create<ImageTemplatePropertiesErrorHandling>(ImageTemplatePropertiesErrorHandling.fromMap((map['errorHandling'] as Map).cast<String, dynamic>())),
      identity: pulumi.Output.create<ImageTemplateIdentity>(ImageTemplateIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      imageTemplateName: map['imageTemplateName'] == null ? null : pulumi.Output.create<String>(map['imageTemplateName'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      managedResourceTags: map['managedResourceTags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['managedResourceTags'] as Map).cast<String, String>()),
      optimize: map['optimize'] == null ? null : pulumi.Output.create<ImageTemplatePropertiesOptimize>(ImageTemplatePropertiesOptimize.fromMap((map['optimize'] as Map).cast<String, dynamic>())),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      source: pulumi.Output.create<ImageTemplateManagedImageSource>(ImageTemplateManagedImageSource.fromMap((map['source'] as Map).cast<String, dynamic>())),
      stagingResourceGroup: map['stagingResourceGroup'] == null ? null : pulumi.Output.create<String>(map['stagingResourceGroup'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      validate: map['validate'] == null ? null : pulumi.Output.create<ImageTemplatePropertiesValidate>(ImageTemplatePropertiesValidate.fromMap((map['validate'] as Map).cast<String, dynamic>())),
      vmProfile: map['vmProfile'] == null ? null : pulumi.Output.create<ImageTemplateVmProfile>(ImageTemplateVmProfile.fromMap((map['vmProfile'] as Map).cast<String, dynamic>())),
    );
  }
}
