...
class ImageTemplateRestartCustomizerResponse {
  ...
  factory ImageTemplateRestartCustomizerResponse.fromMap(
    ...
    return ImageTemplateRestartCustomizerResponse(
      ...
      restartCheckCommand: (() {
        final guardedValue = map['restartCheckCommand'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      restartCommand: (() {
        final guardedValue = map['restartCommand'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      restartTimeout: (() {
        final guardedValue = map['restartTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
