...
class EvaluationRuleResponse {
  ...
  factory EvaluationRuleResponse.fromMap(Map<String, dynamic> map) {
    return EvaluationRuleResponse(
      degradedRule: (() { final guardedValue = map['degradedRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ThresholdRuleResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dynamicDetectionRule: (() { final guardedValue = map['dynamicDetectionRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DynamicDetectionRuleResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      unhealthyRule: (() { final guardedValue = map['unhealthyRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ThresholdRuleResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
