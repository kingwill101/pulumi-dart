...
class EntityAlertsResponse {
  ...
  EntityAlertsResponse({this.degraded, this.unhealthy});
    ...
    return <String, dynamic>{
      'degraded':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(degraded, (value) => value.toMap()),
      'unhealthy':
          ?pulumi.Input.mapOptionalInputValue<
            AlertConfigurationResponse,
            Map<String, dynamic>
          >(unhealthy, (value) => value.toMap()),
    };
  }
    ...
    return EntityAlertsResponse(
      degraded: (() {
        ...
        return pulumi.Input.fromValue(
          AlertConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      unhealthy: (() {
        final guardedValue = map['unhealthy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
