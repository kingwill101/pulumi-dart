...
/// }
///
/// resource "azure-native_cloudhealth_authenticationsetting" "authenticationSetting" {
...
class AuthenticationSetting extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [AuthenticationSetting] resource.
  AuthenticationSetting.reference(String urn)
    : super(
        'azure-native:cloudhealth:AuthenticationSetting',
