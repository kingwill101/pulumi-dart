...
/// }
///
/// resource "azure-native_cloudhealth_signaldefinition" "signalDefinition" {
...
class SignalDefinition extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [SignalDefinition] resource.
  SignalDefinition.reference(String urn)
    : super(
        'azure-native:cloudhealth:SignalDefinition',
