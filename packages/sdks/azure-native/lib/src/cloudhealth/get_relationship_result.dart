...
class GetRelationshipResult {
  ...
  final RelationshipPropertiesResponse? properties;
  ...
  factory GetRelationshipResult.fromMap(Map<String, dynamic> map) {
    return GetRelationshipResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return RelationshipPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
