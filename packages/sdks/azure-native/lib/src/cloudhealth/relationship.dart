...
/// }
///
/// resource "azure-native_cloudhealth_relationship" "relationship" {
...
class Relationship extends pulumi.CustomResource {
  ...
  Relationship(
    ...
    properties = registerOutput<RelationshipPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RelationshipPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
