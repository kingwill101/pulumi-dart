...
class SignalGroupResponse {
  ...
  factory SignalGroupResponse.fromMap(Map<String, dynamic> map) {
    return SignalGroupResponse(
      azureLogAnalytics: (() { final guardedValue = map['azureLogAnalytics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogAnalyticsSignalGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      azureMonitorWorkspace: (() { final guardedValue = map['azureMonitorWorkspace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureMonitorWorkspaceSignalGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      azureResource: (() { final guardedValue = map['azureResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureResourceSignalGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dependencies: (() { final guardedValue = map['dependencies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DependenciesSignalGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
