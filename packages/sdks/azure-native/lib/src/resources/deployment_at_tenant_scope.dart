...
/// }
///
/// resource "azure-native_resources_deploymentattenantscope" "deploymentAtTenantScope" {
...
class DeploymentAtTenantScope extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DeploymentAtTenantScope] resource.
  DeploymentAtTenantScope.reference(String urn)
    : super(
        'azure-native:resources:DeploymentAtTenantScope',
