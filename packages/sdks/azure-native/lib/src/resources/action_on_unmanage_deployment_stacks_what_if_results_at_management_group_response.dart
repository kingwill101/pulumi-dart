...
class ActionOnUnmanageDeploymentStacksWhatIfResultsAtManagementGroupResponse {
  ...
  const ActionOnUnmanageDeploymentStacksWhatIfResultsAtManagementGroupResponse({
  ...
  factory ActionOnUnmanageDeploymentStacksWhatIfResultsAtManagementGroupResponse.fromMap(Map<String, dynamic> map) {
    return ActionOnUnmanageDeploymentStacksWhatIfResultsAtManagementGroupResponse(
