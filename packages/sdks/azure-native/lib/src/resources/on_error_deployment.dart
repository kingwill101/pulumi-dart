...
class OnErrorDeployment {
  ...
  OnErrorDeployment({this.deploymentName, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'deploymentName': ?deploymentName,
      'type':
          ?pulumi.Input.mapOptionalInputValue<OnErrorDeploymentType, String>(
            type,
    ...
    return OnErrorDeployment(
      ...
      type: (() {
        ...
        return pulumi.Input.fromValue(
          OnErrorDeploymentType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
