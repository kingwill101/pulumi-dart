...
class DeploymentPropertiesExtendedResponse {
  ...
  factory DeploymentPropertiesExtendedResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentPropertiesExtendedResponse(
      ...
      debugSetting: pulumi.Input.fromValue(DebugSettingResponse.fromMap((map['debugSetting']! as Map).cast<String, dynamic>())),
      dependencies: pulumi.Input.fromValue(pulumi.Input.decodeList<DependencyResponse>(map['dependencies']!, (value) => DependencyResponse.fromMap((value as Map).cast<String, dynamic>()))),
      duration: pulumi.Input.fromValue(map['duration'] as String),
      error: pulumi.Input.fromValue(ErrorResponseResponse.fromMap((map['error']! as Map).cast<String, dynamic>())),
      mode: pulumi.Input.fromValue(map['mode'] as String),
      onErrorDeployment: pulumi.Input.fromValue(OnErrorDeploymentExtendedResponse.fromMap((map['onErrorDeployment']! as Map).cast<String, dynamic>())),
      outputResources: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceReferenceResponse>(map['outputResources']!, (value) => ResourceReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      outputs: pulumi.Input.fromValue(map['outputs']),
      parameters: pulumi.Input.fromValue(map['parameters']),
      parametersLink: pulumi.Input.fromValue(ParametersLinkResponse.fromMap((map['parametersLink']! as Map).cast<String, dynamic>())),
      providers: pulumi.Input.fromValue(pulumi.Input.decodeList<ProviderResponse>(map['providers']!, (value) => ProviderResponse.fromMap((value as Map).cast<String, dynamic>()))),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      templateHash: pulumi.Input.fromValue(map['templateHash'] as String),
      templateLink: pulumi.Input.fromValue(TemplateLinkResponse.fromMap((map['templateLink']! as Map).cast<String, dynamic>())),
      timestamp: pulumi.Input.fromValue(map['timestamp'] as String),
      validatedResources: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceReferenceResponse>(map['validatedResources']!, (value) => ResourceReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
