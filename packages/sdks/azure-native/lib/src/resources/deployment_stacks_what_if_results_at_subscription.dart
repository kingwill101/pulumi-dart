...
class DeploymentStacksWhatIfResultsAtSubscription extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DeploymentStacksWhatIfResultsAtSubscription] resource.
  DeploymentStacksWhatIfResultsAtSubscription.reference(String urn)
    : super(
        'azure-native:resources:DeploymentStacksWhatIfResultsAtSubscription',
