...
class GetDeploymentStackAtManagementGroupResult {
    ...
    return <String, dynamic>{
      ...
      'deletedResources':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(deletedResources, (value) => value.toMap()),
      ...
      'detachedResources':
          pulumi.Input.encodeList<
            ResourceReferenceResponse,
            Map<String, dynamic>
          >(detachedResources, (value) => value.toMap()),
      'duration': duration,
      'error': ?error?.toMap(),
      'failedResources':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(failedResources, (value) => value.toMap()),
      'id': id,
      'location': ?location,
      'name': name,
      'outputs': outputs,
  ...
  factory GetDeploymentStackAtManagementGroupResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDeploymentStackAtManagementGroupResult(
      actionOnUnmanage: ActionOnUnmanageResponse.fromMap(
      ...
      debugSetting: (() {
        ...
        if (guardedValue == null) return null;
        return DeploymentStacksDebugSettingResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      })(),
      deletedResources: pulumi.Input.decodeList<ResourceReferenceResponse>(
        map['deletedResources']!,
        (value) => ResourceReferenceResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      denySettings: DenySettingsResponse.fromMap(
      ...
      detachedResources: pulumi.Input.decodeList<ResourceReferenceResponse>(
        map['detachedResources']!,
        (value) => ResourceReferenceResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      failedResources:
          pulumi.Input.decodeList<ResourceReferenceExtendedResponse>(
            map['failedResources']!,
            (value) => ResourceReferenceExtendedResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      id: map['id'] as String,
      ...
      parameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeMapValues<DeploymentParameterResponse>(
          guardedValue,
      ...
      parametersLink: (() {
        ...
        if (guardedValue == null) return null;
        return DeploymentStacksParametersLinkResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      })(),
      provisioningState: map['provisioningState'] as String,
      resources: pulumi.Input.decodeList<ManagedResourceReferenceResponse>(
        map['resources']!,
        (value) => ManagedResourceReferenceResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
