...
class ContainerConfigurationResponse {
  ...
  ContainerConfigurationResponse({this.containerGroupName, this.subnetIds});
    ...
    return <String, dynamic>{
      ...
      'subnetIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerGroupSubnetIdResponse>,
    ...
    return ContainerConfigurationResponse(
      ...
      subnetIds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerGroupSubnetIdResponse>(
            guardedValue,
            (value) => ContainerGroupSubnetIdResponse.fromMap(
