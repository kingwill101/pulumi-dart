...
class DeploymentStacksWhatIfResultProperties {
  ...
  final pulumi.Input<Map<String, Map<String, DeploymentExtensionConfigItem>>>?
  extensionConfigs;

  /// External input definitions, used by external tooling to define expected external input values.
  final pulumi.Input<Map<String, DeploymentExternalInputDefinition>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'extensionConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, Map<String, DeploymentExtensionConfigItem>>,
            Map<String, Map<String, Map<String, dynamic>>>
          >(
            extensionConfigs,
            (value) =>
                pulumi.Input.encodeMapValues<
                  Map<String, DeploymentExtensionConfigItem>,
      ...
      'externalInputDefinitions':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeploymentExternalInputDefinition>,
            Map<String, Map<String, dynamic>>
          >(
            externalInputDefinitions,
            (value) =>
      ...
      'externalInputs':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeploymentExternalInput>,
            Map<String, Map<String, dynamic>>
          >(
            externalInputs,
            (value) =>
  ...
  factory DeploymentStacksWhatIfResultProperties.fromMap(
    ...
    return DeploymentStacksWhatIfResultProperties(
      ...
      deploymentStackResourceId: pulumi.Input.fromValue(
        map['deploymentStackResourceId'] as String,
      ),
      description: (() {
      ...
      extensionConfigs: (() {
        final guardedValue = map['extensionConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                pulumi.Input.decodeMapValues<DeploymentExtensionConfigItem>(
                  value,
                  (value) => DeploymentExtensionConfigItem.fromMap(
      ...
      externalInputDefinitions: (() {
        final guardedValue = map['externalInputDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeploymentExternalInputDefinition>(
            guardedValue,
            (value) => DeploymentExternalInputDefinition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      externalInputs: (() {
        final guardedValue = map['externalInputs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeploymentExternalInput>(
            guardedValue,
            (value) => DeploymentExternalInput.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      validationLevel: (() {
        final guardedValue = map['validationLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
