    ...
    return <String, dynamic>{
      'aliases':
          ...
          >(
            aliases,
            (value) =>
                pulumi.Input.encodeList<AliasResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'locationMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ProviderExtendedLocationResponse>,
            List<Map<String, dynamic>>
          >(
            locationMappings,
            (value) =>
    ...
    return ProviderResourceTypeResponse(
      aliases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AliasResponse>(
            guardedValue,
            (value) =>
                AliasResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      apiProfiles: pulumi.Input.fromValue(
      ...
      defaultApiVersion: pulumi.Input.fromValue(
        map['defaultApiVersion'] as String,
      ),
      locationMappings: (() {
        final guardedValue = map['locationMappings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProviderExtendedLocationResponse>(
            guardedValue,
            (value) => ProviderExtendedLocationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      zoneMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ZoneMappingResponse>(
            guardedValue,
            (value) => ZoneMappingResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
