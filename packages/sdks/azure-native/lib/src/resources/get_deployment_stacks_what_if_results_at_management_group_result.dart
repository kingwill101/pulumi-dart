...
class GetDeploymentStacksWhatIfResultsAtManagementGroupResult {
  ...
  const GetDeploymentStacksWhatIfResultsAtManagementGroupResult({
  ...
  factory GetDeploymentStacksWhatIfResultsAtManagementGroupResult.fromMap(Map<String, dynamic> map) {
    return GetDeploymentStacksWhatIfResultsAtManagementGroupResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return DeploymentStacksWhatIfResultPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
