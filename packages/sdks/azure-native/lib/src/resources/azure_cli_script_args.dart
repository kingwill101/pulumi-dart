...
class AzureCliScriptArgs {
  ...
  AzureCliScriptArgs({
    pulumi.Output<String>? arguments,
    required pulumi.Output<String> azCliVersion,
    pulumi.Output<String>? cleanupPreference,
    pulumi.Output<ContainerConfiguration>? containerSettings,
    ...
    required pulumi.Output<String> retentionInterval,
    pulumi.Output<String>? scriptContent,
    pulumi.Output<String>? scriptName,
    pulumi.Output<StorageAccountConfiguration>? storageAccountSettings,
  ...
  factory AzureCliScriptArgs.fromMap(Map<String, dynamic> map) {
    return AzureCliScriptArgs(
      arguments: map['arguments'] == null ? null : pulumi.Output.create<String>(map['arguments'] as String),
      azCliVersion: pulumi.Output.create<String>(map['azCliVersion'] as String),
      cleanupPreference: map['cleanupPreference'] == null ? null : pulumi.Output.create<String>(map['cleanupPreference'] as String),
      containerSettings: map['containerSettings'] == null ? null : pulumi.Output.create<ContainerConfiguration>(ContainerConfiguration.fromMap((map['containerSettings'] as Map).cast<String, dynamic>())),
      ...
      retentionInterval: pulumi.Output.create<String>(map['retentionInterval'] as String),
      ...
      storageAccountSettings: map['storageAccountSettings'] == null ? null : pulumi.Output.create<StorageAccountConfiguration>(StorageAccountConfiguration.fromMap((map['storageAccountSettings'] as Map).cast<String, dynamic>())),
