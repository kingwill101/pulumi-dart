...
class ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse {
  ...
  /// Creates a new [ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse].
  ...
  const ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse({
  ...
  factory ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse.fromMap(Map<String, dynamic> map) {
    return ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse(
