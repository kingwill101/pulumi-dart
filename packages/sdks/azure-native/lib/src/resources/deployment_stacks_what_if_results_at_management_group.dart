...
class DeploymentStacksWhatIfResultsAtManagementGroup extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DeploymentStacksWhatIfResultsAtManagementGroup] resource.
  DeploymentStacksWhatIfResultsAtManagementGroup.reference(String urn)
    : super(
        'azure-native:resources:DeploymentStacksWhatIfResultsAtManagementGroup',
