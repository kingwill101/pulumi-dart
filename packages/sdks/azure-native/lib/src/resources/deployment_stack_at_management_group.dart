...
import 'deployment_stack_at_management_group_args.dart';
...
/// ```
class DeploymentStackAtManagementGroup extends pulumi.CustomResource {
  ...
  /// Creates a new [DeploymentStackAtManagementGroup].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DeploymentStackAtManagementGroup]. {@macro pulumi_resources_deployment_stack_at_management_group_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DeploymentStackAtManagementGroup(
    String name, {
    DeploymentStackAtManagementGroupArgs? args,
    ...
    actionOnUnmanage = registerOutput<ActionOnUnmanageResponse>(
      ...
      decoder: (raw) {
        ...
        return ActionOnUnmanageResponse.fromMap(
    ...
    denySettings = registerOutput<DenySettingsResponse>(
      'denySettings',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return DenySettingsResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
