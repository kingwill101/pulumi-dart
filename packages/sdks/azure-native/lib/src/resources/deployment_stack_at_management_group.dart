...
/// }
///
/// resource "azure-native_resources_deploymentstackatmanagementgroup" "deploymentStackAtManagementGroup" {
///   action_on_unmanage = {
...
class DeploymentStackAtManagementGroup extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DeploymentStackAtManagementGroup] resource.
  DeploymentStackAtManagementGroup.reference(String urn)
    : super(
        'azure-native:resources:DeploymentStackAtManagementGroup',
