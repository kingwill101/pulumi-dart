...
class DeploymentExtensionResponse {
  ...
  final pulumi.Input<Map<String, DeploymentExtensionConfigItemResponse>>?
  config;
    ...
    return <String, dynamic>{
      'config':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeploymentExtensionConfigItemResponse>,
    ...
    return DeploymentExtensionResponse(
      config: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeploymentExtensionConfigItemResponse>(
            guardedValue,
            (value) => DeploymentExtensionConfigItemResponse.fromMap(
