...
class DeploymentStacksWhatIfChangeResponseDenySettingsChange {
  ...
  factory DeploymentStacksWhatIfChangeResponseDenySettingsChange.fromMap(Map<String, dynamic> map) {
    return DeploymentStacksWhatIfChangeResponseDenySettingsChange(
      after: (() { final guardedValue = map['after']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DenySettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      before: (() { final guardedValue = map['before']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DenySettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
