...
class ProviderResponse {
  ...
  factory ProviderResponse.fromMap(Map<String, dynamic> map) {
    return ProviderResponse(
      ...
      providerAuthorizationConsentState: (() { final guardedValue = map['providerAuthorizationConsentState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      registrationPolicy: pulumi.Input.fromValue(map['registrationPolicy'] as String),
      registrationState: pulumi.Input.fromValue(map['registrationState'] as String),
      resourceTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<ProviderResourceTypeResponse>(map['resourceTypes']!, (value) => ProviderResourceTypeResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
