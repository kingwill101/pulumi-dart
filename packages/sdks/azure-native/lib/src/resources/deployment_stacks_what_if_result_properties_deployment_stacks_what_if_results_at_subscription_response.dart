...
import 'action_on_unmanage_deployment_stacks_what_if_results_at_subscription_response.dart';
...
class DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtSubscriptionResponse {
  /// Defines the behavior of resources that are no longer managed after the Deployment stack is updated or deleted.
  final pulumi.Input<ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse> actionOnUnmanage;
  ...
  /// Creates a new [DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtSubscriptionResponse].
  ...
  const DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtSubscriptionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actionOnUnmanage': pulumi.Input.mapInputValue<ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse, Map<String, dynamic>>(actionOnUnmanage, (value) => value.toMap()),
  ...
  factory DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtSubscriptionResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtSubscriptionResponse(
      actionOnUnmanage: pulumi.Input.fromValue(ActionOnUnmanageDeploymentStacksWhatIfResultsAtSubscriptionResponse.fromMap((map['actionOnUnmanage']! as Map).cast<String, dynamic>())),
