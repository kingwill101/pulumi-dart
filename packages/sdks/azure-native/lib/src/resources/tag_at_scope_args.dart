...
class TagAtScopeArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'properties': pulumi.Input.mapInputValue<Tags, Map<String, dynamic>>(properties, (value) => value.toMap()),
      'scope': scope,
    };
  }
  ...
  factory TagAtScopeArgs.fromMap(Map<String, dynamic> map) {
    return TagAtScopeArgs(
      properties: pulumi.Input.fromValue(Tags.fromMap((map['properties']! as Map).cast<String, dynamic>())),
