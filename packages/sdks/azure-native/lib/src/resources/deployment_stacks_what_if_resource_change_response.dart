...
class DeploymentStacksWhatIfResourceChangeResponse {
  ...
  factory DeploymentStacksWhatIfResourceChangeResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentStacksWhatIfResourceChangeResponse(
      ...
      denyStatusChange: (() { final guardedValue = map['denyStatusChange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStacksWhatIfResourceChangeResponseDenyStatusChange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      extension: pulumi.Input.fromValue(DeploymentExtensionResponse.fromMap((map['extension']! as Map).cast<String, dynamic>())),
      id: pulumi.Input.fromValue(map['id'] as String),
      identifiers: pulumi.Input.fromValue(map['identifiers']),
      managementStatusChange: (() { final guardedValue = map['managementStatusChange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStacksWhatIfResourceChangeResponseManagementStatusChange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceConfigurationChanges: (() { final guardedValue = map['resourceConfigurationChanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStacksWhatIfResourceChangeResponseResourceConfigurationChanges.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      unsupportedReason: (() { final guardedValue = map['unsupportedReason']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
