...
class DeploymentStacksWhatIfPropertyChangeResponse {
  ...
  final List<DeploymentStacksWhatIfPropertyChangeResponse>? children;
  /// Type of change that will be made to the resource when the deployment is executed.
  final String path;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'children': ?children == null ? null : pulumi.Input.encodeList<DeploymentStacksWhatIfPropertyChangeResponse, Map<String, dynamic>>(children!, (value) => value.toMap()),
      'path': path,
    };
  }
  ...
  factory DeploymentStacksWhatIfPropertyChangeResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentStacksWhatIfPropertyChangeResponse(
      ...
      children: map['children'] == null ? null : pulumi.Input.decodeList<DeploymentStacksWhatIfPropertyChangeResponse>(map['children'], (value) => DeploymentStacksWhatIfPropertyChangeResponse.fromMap((value as Map).cast<String, dynamic>())),
