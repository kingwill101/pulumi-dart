...
class DeploymentStacksDiagnosticResponse {
  ...
  factory DeploymentStacksDiagnosticResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentStacksDiagnosticResponse(
      additionalInfo: (() { final guardedValue = map['additionalInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ErrorAdditionalInfoResponse>(guardedValue, (value) => ErrorAdditionalInfoResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
