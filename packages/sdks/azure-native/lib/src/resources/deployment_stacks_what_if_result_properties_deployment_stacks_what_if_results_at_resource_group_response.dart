...
import 'action_on_unmanage_deployment_stacks_what_if_results_at_resource_group_response.dart';
...
class DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse {
  /// Defines the behavior of resources that are no longer managed after the Deployment stack is updated or deleted.
  final pulumi.Input<ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse> actionOnUnmanage;
  ...
  /// Creates a new [DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse].
  ...
  const DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actionOnUnmanage': pulumi.Input.mapInputValue<ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse, Map<String, dynamic>>(actionOnUnmanage, (value) => value.toMap()),
  ...
  factory DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse(
      actionOnUnmanage: pulumi.Input.fromValue(ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse.fromMap((map['actionOnUnmanage']! as Map).cast<String, dynamic>())),
