...
/// Result data returned by getAzureCliScript.
class GetAzureCliScriptResult {
  ...
  /// Creates a new [GetAzureCliScriptResult].
  ...
  factory GetAzureCliScriptResult.fromMap(Map<String, dynamic> map) {
    return GetAzureCliScriptResult(
      ...
      azCliVersion: (() { final guardedValue = map['azCliVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
