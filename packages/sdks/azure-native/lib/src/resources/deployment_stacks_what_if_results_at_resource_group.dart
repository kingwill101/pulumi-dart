...
import 'deployment_stacks_what_if_result_properties_deployment_stacks_what_if_results_at_resource_group_response.dart';
...
/// }
///
/// resource "azure-native_resources_deploymentstackswhatifresultsatresourcegroup" "deploymentStacksWhatIfResultsAtResourceGroup" {
...
/// ```
class DeploymentStacksWhatIfResultsAtResourceGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse> properties;
  ...
  DeploymentStacksWhatIfResultsAtResourceGroup(
    ...
    properties = registerOutput<DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DeploymentStacksWhatIfResultPropertiesDeploymentStacksWhatIfResultsAtResourceGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [DeploymentStacksWhatIfResultsAtResourceGroup] resource.
  DeploymentStacksWhatIfResultsAtResourceGroup.reference(String urn)
    : super(
        'azure-native:resources:DeploymentStacksWhatIfResultsAtResourceGroup',
