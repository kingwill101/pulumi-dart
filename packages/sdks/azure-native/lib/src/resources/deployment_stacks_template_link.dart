...
class DeploymentStacksTemplateLink {
  ...
  /// Creates a new [DeploymentStacksTemplateLink].
  /// [contentVersion] If included, must match the ContentVersion in the template.
  /// [id] The resourceId of a Template Spec. Use either the id or uri property, but not both.
  ...
  factory DeploymentStacksTemplateLink.fromMap(Map<String, dynamic> map) {
