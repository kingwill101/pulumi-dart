    ...
    return <String, dynamic>{
      ...
      'expressionEvaluationOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ExpressionEvaluationOptions,
            Map<String, dynamic>
          >(expressionEvaluationOptions, (value) => value.toMap()),
      'mode': pulumi.Input.mapInputValue<DeploymentMode, String>(
        mode,
    ...
    return DeploymentProperties(
      debugSetting: (() {
        ...
        return pulumi.Input.fromValue(
          DebugSetting.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      expressionEvaluationOptions: (() {
        final guardedValue = map['expressionEvaluationOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExpressionEvaluationOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mode: pulumi.Input.fromValue(
        DeploymentMode.fromValue(map['mode']! as String),
      ),
      onErrorDeployment: (() {
        final guardedValue = map['onErrorDeployment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OnErrorDeployment.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      parametersLink: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParametersLink.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      template: (() {
      ...
      templateLink: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TemplateLink.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
