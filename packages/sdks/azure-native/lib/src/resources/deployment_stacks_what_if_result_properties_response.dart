...
class DeploymentStacksWhatIfResultPropertiesResponse {
    ...
    return <String, dynamic>{
      'actionOnUnmanage':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(actionOnUnmanage, (value) => value.toMap()),
      'changes':
          pulumi.Input.mapInputValue<
            DeploymentStacksWhatIfChangeResponse,
            Map<String, dynamic>
          >(changes, (value) => value.toMap()),
      ...
      'denySettings':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(denySettings, (value) => value.toMap()),
      ...
      'diagnostics':
          pulumi.Input.mapInputValue<
            List<DeploymentStacksDiagnosticResponse>,
      ...
      'parameters':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DeploymentParameterResponse>,
  ...
  factory DeploymentStacksWhatIfResultPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return DeploymentStacksWhatIfResultPropertiesResponse(
      actionOnUnmanage: pulumi.Input.fromValue(
        ActionOnUnmanageResponse.fromMap(
          (map['actionOnUnmanage']! as Map).cast<String, dynamic>(),
        ),
      ),
      changes: pulumi.Input.fromValue(
        DeploymentStacksWhatIfChangeResponse.fromMap(
          (map['changes']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      debugSetting: (() {
        ...
        return pulumi.Input.fromValue(
          DeploymentStacksDebugSettingResponse.fromMap(
      ...
      deploymentStackLastModified: pulumi.Input.fromValue(
        map['deploymentStackLastModified'] as String,
      ),
      ...
      diagnostics: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeploymentStacksDiagnosticResponse>(
          map['diagnostics']!,
          (value) => DeploymentStacksDiagnosticResponse.fromMap(
      ...
      parameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DeploymentParameterResponse>(
            guardedValue,
            (value) => DeploymentParameterResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      parametersLink: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentStacksParametersLinkResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
