...
class ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse {
  ...
  /// Creates a new [ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse].
  ...
  const ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse({
  ...
  factory ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse.fromMap(Map<String, dynamic> map) {
    return ActionOnUnmanageDeploymentStacksWhatIfResultsAtResourceGroupResponse(
