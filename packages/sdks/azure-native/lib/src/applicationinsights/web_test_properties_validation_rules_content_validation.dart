...
class WebTestPropertiesValidationRulesContentValidation {
  ...
  const WebTestPropertiesValidationRulesContentValidation({
    this.contentMatch,
    this.ignoreCase,
  ...
  factory WebTestPropertiesValidationRulesContentValidation.fromMap(Map<String, dynamic> map) {
    return WebTestPropertiesValidationRulesContentValidation(
