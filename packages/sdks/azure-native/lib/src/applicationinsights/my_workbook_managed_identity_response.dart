...
class MyWorkbookManagedIdentityResponse {
  ...
  /// Customer Managed Identity
  final pulumi.Input<MyWorkbookUserAssignedIdentitiesResponse>?
  userAssignedIdentities;

  /// Creates a new [MyWorkbookManagedIdentityResponse].
  /// [type] The identity type.
  /// [userAssignedIdentities] Customer Managed Identity
  MyWorkbookManagedIdentityResponse({this.type, this.userAssignedIdentities});
    ...
    return <String, dynamic>{
      ...
      'userAssignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(userAssignedIdentities, (value) => value.toMap()),
    };
  }
    ...
    return MyWorkbookManagedIdentityResponse(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          MyWorkbookUserAssignedIdentitiesResponse.fromMap(
