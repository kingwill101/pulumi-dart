...
class ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesResponseRuleDefinitions {
  ...
  factory ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesResponseRuleDefinitions.fromMap(
    ...
    return ApplicationInsightsComponentProactiveDetectionConfigurationPropertiesResponseRuleDefinitions(
      ...
      isEnabledByDefault: (() {
        final guardedValue = map['isEnabledByDefault'];
        if (guardedValue == null) return null;
      ...
      isInPreview: (() {
        final guardedValue = map['isInPreview'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: (() {
      ...
      supportsEmailNotifications: (() {
        final guardedValue = map['supportsEmailNotifications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
