...
class ExportConfigurationArgs {
  ...
  factory ExportConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ExportConfigurationArgs(
      destinationAccountId: (() { final guardedValue = map['destinationAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      destinationStorageLocationId: (() { final guardedValue = map['destinationStorageLocationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      destinationStorageSubscriptionId: (() { final guardedValue = map['destinationStorageSubscriptionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      isEnabled: (() { final guardedValue = map['isEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      notificationQueueEnabled: (() { final guardedValue = map['notificationQueueEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      notificationQueueUri: (() { final guardedValue = map['notificationQueueUri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
