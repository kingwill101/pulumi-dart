...
class WorkbookResourceIdentityResponse {
  ...
  /// Creates a new [WorkbookResourceIdentityResponse].
  ...
  const WorkbookResourceIdentityResponse({
  ...
  factory WorkbookResourceIdentityResponse.fromMap(Map<String, dynamic> map) {
    return WorkbookResourceIdentityResponse(
