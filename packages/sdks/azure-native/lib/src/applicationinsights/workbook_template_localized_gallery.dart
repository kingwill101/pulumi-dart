...
class WorkbookTemplateLocalizedGallery {
  ...
  const WorkbookTemplateLocalizedGallery({
    this.galleries,
    this.templateData,
  });
  ...
  factory WorkbookTemplateLocalizedGallery.fromMap(Map<String, dynamic> map) {
    return WorkbookTemplateLocalizedGallery(
      ...
      templateData: (() { final guardedValue = map['templateData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
