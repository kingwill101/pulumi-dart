...
class WorkbookTemplateArgs {
  ...
  final pulumi.Input<Map<String, List<WorkbookTemplateLocalizedGallery>>>?
  localized;
    ...
    return <String, dynamic>{
      ...
      'localized':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, List<WorkbookTemplateLocalizedGallery>>,
            Map<String, List<Map<String, dynamic>>>
          >(
            localized,
            (value) =>
                pulumi.Input.encodeMapValues<
                  List<WorkbookTemplateLocalizedGallery>,
                  List<Map<String, dynamic>>
                >(
                  value,
                  (value) =>
    ...
    return WorkbookTemplateArgs(
      ...
      localized: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<List<WorkbookTemplateLocalizedGallery>>(
            guardedValue,
            (value) =>
                pulumi.Input.decodeList<WorkbookTemplateLocalizedGallery>(
                  value,
                  (value) => WorkbookTemplateLocalizedGallery.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
                ),
          ),
