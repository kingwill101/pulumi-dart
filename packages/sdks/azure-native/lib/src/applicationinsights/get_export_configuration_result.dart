...
class GetExportConfigurationResult {
  ...
  factory GetExportConfigurationResult.fromMap(Map<String, dynamic> map) {
    return GetExportConfigurationResult(
      ...
      destinationAccountId: (() { final guardedValue = map['destinationAccountId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      destinationStorageLocationId: (() { final guardedValue = map['destinationStorageLocationId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      destinationStorageSubscriptionId: (() { final guardedValue = map['destinationStorageSubscriptionId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      destinationType: (() { final guardedValue = map['destinationType']; if (guardedValue == null) return null; return guardedValue as String; })(),
      exportId: (() { final guardedValue = map['exportId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      exportStatus: (() { final guardedValue = map['exportStatus']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      isUserEnabled: (() { final guardedValue = map['isUserEnabled']; if (guardedValue == null) return null; return guardedValue as String; })(),
      lastGapTime: (() { final guardedValue = map['lastGapTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      lastSuccessTime: (() { final guardedValue = map['lastSuccessTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      lastUserUpdate: (() { final guardedValue = map['lastUserUpdate']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      permanentErrorReason: (() { final guardedValue = map['permanentErrorReason']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      storageName: (() { final guardedValue = map['storageName']; if (guardedValue == null) return null; return guardedValue as String; })(),
