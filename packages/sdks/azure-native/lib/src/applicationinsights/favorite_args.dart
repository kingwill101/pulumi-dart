...
class FavoriteArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'favoriteType': ?pulumi.Input.mapOptionalInputValue<FavoriteType, String>(
        favoriteType,
  ...
  factory FavoriteArgs.fromMap(Map<String, dynamic> map) {
    return FavoriteArgs(
      ...
      favoriteId: (() {
        final guardedValue = map['favoriteId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      favoriteType: (() {
        final guardedValue = map['favoriteType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FavoriteType.fromValue(guardedValue as String),
        );
      })(),
      isGeneratedFromTemplate: (() {
        final guardedValue = map['isGeneratedFromTemplate'];
        if (guardedValue == null) return null;
