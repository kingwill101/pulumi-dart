...
class GetWorkbookTemplateResult {
    ...
    return <String, dynamic>{
      ...
      'galleries':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(galleries, (value) => value.toMap()),
      'id': id,
      'localized': ?(() {
        final guardedValue = localized;
  ...
  factory GetWorkbookTemplateResult.fromMap(Map<String, dynamic> map) {
    return GetWorkbookTemplateResult(
      ...
      galleries: pulumi.Input.decodeList<WorkbookTemplateGalleryResponse>(
        map['galleries']!,
      ...
      localized: (() {
        ...
        >(
          guardedValue,
          (value) =>
              pulumi.Input.decodeList<WorkbookTemplateLocalizedGalleryResponse>(
                value,
