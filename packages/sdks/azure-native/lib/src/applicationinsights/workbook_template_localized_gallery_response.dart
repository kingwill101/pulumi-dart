...
class WorkbookTemplateLocalizedGalleryResponse {
  ...
  factory WorkbookTemplateLocalizedGalleryResponse.fromMap(Map<String, dynamic> map) {
    return WorkbookTemplateLocalizedGalleryResponse(
      galleries: (() { final guardedValue = map['galleries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkbookTemplateGalleryResponse>(guardedValue, (value) => WorkbookTemplateGalleryResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
