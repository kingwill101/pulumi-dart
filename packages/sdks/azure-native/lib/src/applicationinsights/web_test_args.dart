...
class WebTestArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': ?enabled,
      'frequency': ?frequency,
      'kind': ?pulumi.Input.mapOptionalInputValue<WebTestKind, String>(
        kind,
      ...
      'webTestKind': pulumi.Input.mapInputValue<WebTestKind, String>(
        webTestKind,
        (value) => value.wireValue,
      ),
    ...
    return WebTestArgs(
      configuration: (() {
        ...
        return pulumi.Input.fromValue(
          WebTestPropertiesConfiguration.fromMap(
      ...
      kind: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WebTestKind.fromValue(guardedValue as String),
        );
      })(),
      location: (() {
      ...
      locations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<WebTestGeolocation>(
          map['locations']!,
          (value) => WebTestGeolocation.fromMap(
      ...
      request: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WebTestPropertiesRequest.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      syntheticMonitorId: pulumi.Input.fromValue(
        map['syntheticMonitorId'] as String,
      ),
      tags: (() {
      ...
      validationRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WebTestPropertiesValidationRules.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      webTestKind: pulumi.Input.fromValue(
        WebTestKind.fromValue(map['webTestKind']! as String),
      ),
      webTestName: (() {
        final guardedValue = map['webTestName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
