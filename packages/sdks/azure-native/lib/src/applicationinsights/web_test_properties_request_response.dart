...
class WebTestPropertiesRequestResponse {
  ...
  /// Creates a new [WebTestPropertiesRequestResponse].
  ...
  const WebTestPropertiesRequestResponse({
  ...
  factory WebTestPropertiesRequestResponse.fromMap(Map<String, dynamic> map) {
    return WebTestPropertiesRequestResponse(
      ...
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HeaderFieldResponse>(guardedValue, (value) => HeaderFieldResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
