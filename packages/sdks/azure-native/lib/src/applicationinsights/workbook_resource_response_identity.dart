...
class WorkbookResourceResponseIdentity {
  ...
  /// Creates a new [WorkbookResourceResponseIdentity].
  ...
  const WorkbookResourceResponseIdentity({
  ...
  factory WorkbookResourceResponseIdentity.fromMap(Map<String, dynamic> map) {
    return WorkbookResourceResponseIdentity(
