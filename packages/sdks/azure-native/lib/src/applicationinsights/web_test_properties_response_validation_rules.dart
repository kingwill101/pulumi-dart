...
class WebTestPropertiesResponseValidationRules {
  ...
  final WebTestPropertiesResponseContentValidation? contentValidation;
  ...
  factory WebTestPropertiesResponseValidationRules.fromMap(Map<String, dynamic> map) {
    return WebTestPropertiesResponseValidationRules(
      contentValidation: map['contentValidation'] == null ? null : WebTestPropertiesResponseContentValidation.fromMap((map['contentValidation'] as Map).cast<String, dynamic>()),
