...
class NamespaceAssetStatusManagementActionResponse {
  ...
  factory NamespaceAssetStatusManagementActionResponse.fromMap(Map<String, dynamic> map) {
    return NamespaceAssetStatusManagementActionResponse(
      ...
      requestMessageSchemaReference: (NamespaceMessageSchemaReferenceResponse.fromMap((map['requestMessageSchemaReference'] as Map).cast<String, dynamic>())).input(),
      responseMessageSchemaReference: (NamespaceMessageSchemaReferenceResponse.fromMap((map['responseMessageSchemaReference'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
