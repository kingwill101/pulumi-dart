...
class NamespaceDiscoveredAssetArgs {
  ...
  final pulumi.Input<List<NamespaceDiscoveredManagementGroup>>?
  managementGroups;
    ...
    return <String, dynamic>{
      ...
      'datasets':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceDiscoveredDataset>,
      ...
      'managementGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceDiscoveredManagementGroup>,
            List<Map<String, dynamic>>
          >(
            managementGroups,
            (value) =>
      ...
      'streams':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceDiscoveredStream>,
            List<Map<String, dynamic>>
          >(
            streams,
            (value) =>
    ...
    return NamespaceDiscoveredAssetArgs(
      ...
      datasets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceDiscoveredDataset>(
            guardedValue,
            (value) => NamespaceDiscoveredDataset.fromMap(
      ...
      discoveredAssetName: (() {
        final guardedValue = map['discoveredAssetName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      events: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceDiscoveredEvent>(
            guardedValue,
            (value) => NamespaceDiscoveredEvent.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      managementGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceDiscoveredManagementGroup>(
            guardedValue,
            (value) => NamespaceDiscoveredManagementGroup.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      streams: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceDiscoveredStream>(
            guardedValue,
            (value) => NamespaceDiscoveredStream.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
