...
class MessagingEndpointsResponse {
  ...
  MessagingEndpointsResponse({this.inbound, this.outbound});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inbound':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, InboundEndpointsResponse>,
    ...
    return MessagingEndpointsResponse(
      inbound: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<InboundEndpointsResponse>(
            guardedValue,
            (value) => InboundEndpointsResponse.fromMap(
      ...
      outbound: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OutboundEndpointsResponse.fromMap(
