    ...
    return <String, dynamic>{
      'dataPoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<DiscoveredDataPointResponse>,
    ...
    return DiscoveredDatasetResponse(
      dataPoints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiscoveredDataPointResponse>(
            guardedValue,
            (value) => DiscoveredDataPointResponse.fromMap(
      ...
      topic: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TopicResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
