    ...
    return <String, dynamic>{
      'datasets':
          pulumi.Input.mapInputValue<
            List<AssetStatusDatasetResponse>,
  ...
  factory AssetStatusResponse.fromMap(Map<String, dynamic> map) {
    return AssetStatusResponse(
      datasets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AssetStatusDatasetResponse>(
          map['datasets']!,
          (value) => AssetStatusDatasetResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      errors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AssetStatusErrorResponse>(
          map['errors']!,
          (value) => AssetStatusErrorResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      events: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AssetStatusEventResponse>(
          map['events']!,
          (value) => AssetStatusEventResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
