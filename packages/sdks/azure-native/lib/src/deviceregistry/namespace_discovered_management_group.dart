...
class NamespaceDiscoveredManagementGroup {
  ...
  final List<NamespaceDiscoveredManagementAction>? actions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': ?actions == null ? null : pulumi.Input.encodeList<NamespaceDiscoveredManagementAction, Map<String, dynamic>>(actions!, (value) => value.toMap()),
  ...
  factory NamespaceDiscoveredManagementGroup.fromMap(Map<String, dynamic> map) {
    return NamespaceDiscoveredManagementGroup(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<NamespaceDiscoveredManagementAction>(map['actions'], (value) => NamespaceDiscoveredManagementAction.fromMap((value as Map).cast<String, dynamic>())),
