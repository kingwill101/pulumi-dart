...
class NamespaceDiscoveredDatasetResponse {
  ...
  final pulumi.Input<List<NamespaceDiscoveredDatasetDataPointResponse>>?
  dataPoints;
    ...
    return <String, dynamic>{
      'dataPoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceDiscoveredDatasetDataPointResponse>,
    ...
    return NamespaceDiscoveredDatasetResponse(
      dataPoints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceDiscoveredDatasetDataPointResponse>(
            guardedValue,
            (value) => NamespaceDiscoveredDatasetDataPointResponse.fromMap(
