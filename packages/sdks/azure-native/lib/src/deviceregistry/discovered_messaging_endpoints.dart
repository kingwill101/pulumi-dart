...
class DiscoveredMessagingEndpoints {
  ...
  const DiscoveredMessagingEndpoints({
    this.inbound,
    this.outbound,
  });
  ...
  factory DiscoveredMessagingEndpoints.fromMap(Map<String, dynamic> map) {
    return DiscoveredMessagingEndpoints(
      inbound: (() { final guardedValue = map['inbound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<DiscoveredInboundEndpoints>(guardedValue, (value) => DiscoveredInboundEndpoints.fromMap((value as Map).cast<String, dynamic>()))); })(),
      outbound: (() { final guardedValue = map['outbound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiscoveredOutboundEndpoints.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
