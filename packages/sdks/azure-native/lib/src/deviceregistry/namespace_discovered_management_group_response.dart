...
class NamespaceDiscoveredManagementGroupResponse {
  ...
  final pulumi.Input<List<NamespaceDiscoveredManagementActionResponse>>?
  actions;
    ...
    return <String, dynamic>{
      'actions':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceDiscoveredManagementActionResponse>,
  ...
  factory NamespaceDiscoveredManagementGroupResponse.fromMap(
    ...
    return NamespaceDiscoveredManagementGroupResponse(
      actions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceDiscoveredManagementActionResponse>(
            guardedValue,
            (value) => NamespaceDiscoveredManagementActionResponse.fromMap(
