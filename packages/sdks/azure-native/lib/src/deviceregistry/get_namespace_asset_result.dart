...
class GetNamespaceAssetResult {
  ...
  final List<DatasetBrokerStateStoreDestinationResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultDatasetsDestinations': ?(() {
        final guardedValue = defaultDatasetsDestinations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'defaultEventsDestinations': ?(() {
        final guardedValue = defaultEventsDestinations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'defaultStreamsDestinations': ?(() {
        final guardedValue = defaultStreamsDestinations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetNamespaceAssetResult.fromMap(Map<String, dynamic> map) {
    return GetNamespaceAssetResult(
      ...
      datasets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NamespaceDatasetResponse>(
          guardedValue,
          (value) => NamespaceDatasetResponse.fromMap(
      ...
      defaultDatasetsDestinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<DatasetBrokerStateStoreDestinationResponse>(
          guardedValue,
          (value) => DatasetBrokerStateStoreDestinationResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      defaultEventsDestinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<EventMqttDestinationResponse>(
          guardedValue,
          (value) => EventMqttDestinationResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      defaultStreamsDestinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<StreamMqttDestinationResponse>(
          guardedValue,
          (value) => StreamMqttDestinationResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      deviceRef: DeviceRefResponse.fromMap(
        (map['deviceRef']! as Map).cast<String, dynamic>(),
      ),
      discoveredAssetRefs: (() {
      ...
      events: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NamespaceEventResponse>(
          guardedValue,
          (value) => NamespaceEventResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      managementGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ManagementGroupResponse>(
          guardedValue,
          (value) => ManagementGroupResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      status: NamespaceAssetStatusResponse.fromMap(
        (map['status']! as Map).cast<String, dynamic>(),
      ),
      streams: (() {
        final guardedValue = map['streams'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NamespaceStreamResponse>(
          guardedValue,
          (value) => NamespaceStreamResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
