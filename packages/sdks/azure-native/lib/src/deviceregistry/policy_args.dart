...
class PolicyArgs {
  ...
  /// [tags] Resource tags.
  PolicyArgs({
    pulumi.Output<CertificateConfiguration>? certificate,
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      certificate: map['certificate'] == null ? null : pulumi.Output.create<CertificateConfiguration>(CertificateConfiguration.fromMap((map['certificate'] as Map).cast<String, dynamic>())),
