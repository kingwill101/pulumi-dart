...
class NamespaceAssetArgs {
  ...
  factory NamespaceAssetArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceAssetArgs(
      ...
      datasets: (() { final guardedValue = map['datasets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceDataset>(guardedValue, (value) => NamespaceDataset.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      events: (() { final guardedValue = map['events']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceEvent>(guardedValue, (value) => NamespaceEvent.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      managementGroups: (() { final guardedValue = map['managementGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagementGroup>(guardedValue, (value) => ManagementGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      streams: (() { final guardedValue = map['streams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceStream>(guardedValue, (value) => NamespaceStream.fromMap((value as Map).cast<String, dynamic>()))); })(),
