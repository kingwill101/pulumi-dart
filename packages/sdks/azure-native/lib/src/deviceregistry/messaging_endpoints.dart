...
class MessagingEndpoints {
  ...
  factory MessagingEndpoints.fromMap(Map<String, dynamic> map) {
    return MessagingEndpoints(
      inbound: (() { final guardedValue = map['inbound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<InboundEndpoints>(guardedValue, (value) => InboundEndpoints.fromMap((value as Map).cast<String, dynamic>()))); })(),
      outbound: (() { final guardedValue = map['outbound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OutboundEndpoints.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
