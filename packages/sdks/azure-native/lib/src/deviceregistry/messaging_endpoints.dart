...
class MessagingEndpoints {
  ...
  MessagingEndpoints({this.inbound, this.outbound});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inbound':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, InboundEndpoints>,
    ...
    return MessagingEndpoints(
      inbound: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<InboundEndpoints>(
            guardedValue,
            (value) => InboundEndpoints.fromMap(
