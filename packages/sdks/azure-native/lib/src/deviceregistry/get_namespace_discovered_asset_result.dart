  ...
  factory GetNamespaceDiscoveredAssetResult.fromMap(Map<String, dynamic> map) {
    return GetNamespaceDiscoveredAssetResult(
      ...
      datasets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NamespaceDiscoveredDatasetResponse>(
          guardedValue,
          (value) => NamespaceDiscoveredDatasetResponse.fromMap(
      ...
      events: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NamespaceDiscoveredEventResponse>(
          guardedValue,
          (value) => NamespaceDiscoveredEventResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      managementGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<NamespaceDiscoveredManagementGroupResponse>(
          guardedValue,
          (value) => NamespaceDiscoveredManagementGroupResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      streams: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NamespaceDiscoveredStreamResponse>(
          guardedValue,
          (value) => NamespaceDiscoveredStreamResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
