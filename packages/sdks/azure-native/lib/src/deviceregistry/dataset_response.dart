...
class DatasetResponse {
  ...
  final List<DataPointResponse>? dataPoints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataPoints': ?dataPoints == null ? null : pulumi.Input.encodeList<DataPointResponse, Map<String, dynamic>>(dataPoints!, (value) => value.toMap()),
  ...
  factory DatasetResponse.fromMap(Map<String, dynamic> map) {
    return DatasetResponse(
      dataPoints: map['dataPoints'] == null ? null : pulumi.Input.decodeList<DataPointResponse>(map['dataPoints'], (value) => DataPointResponse.fromMap((value as Map).cast<String, dynamic>())),
