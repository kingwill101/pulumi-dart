...
class NamespaceDatasetResponse {
  ...
  final pulumi.Input<List<DatasetBrokerStateStoreDestinationResponse>>?
  destinations;
    ...
    return <String, dynamic>{
      'dataPoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<NamespaceDatasetDataPointResponse>,
      ...
      'destinations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatasetBrokerStateStoreDestinationResponse>,
            List<Map<String, dynamic>>
          >(
            destinations,
            (value) =>
  ...
  factory NamespaceDatasetResponse.fromMap(Map<String, dynamic> map) {
    return NamespaceDatasetResponse(
      dataPoints: (() {
        final guardedValue = map['dataPoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NamespaceDatasetDataPointResponse>(
            guardedValue,
            (value) => NamespaceDatasetDataPointResponse.fromMap(
      ...
      datasetConfiguration: (() {
        final guardedValue = map['datasetConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      destinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatasetBrokerStateStoreDestinationResponse>(
            guardedValue,
