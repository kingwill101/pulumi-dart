...
class GetDiscoveredAssetEndpointProfileArgs {
  ...
  factory GetDiscoveredAssetEndpointProfileArgs.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDiscoveredAssetEndpointProfileArgs(
      discoveredAssetEndpointProfileName: pulumi.Input.fromValue(
        map['discoveredAssetEndpointProfileName'] as String,
      ),
