...
class NamespaceDiscoveredDatasetDataPointResponse {
  ...
  const NamespaceDiscoveredDatasetDataPointResponse({
  ...
  factory NamespaceDiscoveredDatasetDataPointResponse.fromMap(Map<String, dynamic> map) {
    return NamespaceDiscoveredDatasetDataPointResponse(
