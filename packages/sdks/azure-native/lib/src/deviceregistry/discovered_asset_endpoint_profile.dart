...
class DiscoveredAssetEndpointProfile extends pulumi.CustomResource {
  ...
  DiscoveredAssetEndpointProfile(
    ...
    supportedAuthenticationMethods = registerOutput<List<String>?>('supportedAuthenticationMethods', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
  ...
  /// Creates a typed reference to an existing [DiscoveredAssetEndpointProfile] resource.
  DiscoveredAssetEndpointProfile.reference(String urn)
    : super(
        'azure-native:deviceregistry:DiscoveredAssetEndpointProfile',
