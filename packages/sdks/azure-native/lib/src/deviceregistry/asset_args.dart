...
class AssetArgs {
  ...
  factory AssetArgs.fromMap(Map<String, dynamic> map) {
    return AssetArgs(
      assetEndpointProfileRef: pulumi.Output.create<String>(map['assetEndpointProfileRef'] as String),
      ...
      datasets: map['datasets'] == null ? null : pulumi.Output.create<List<Dataset>>(pulumi.Input.decodeList<Dataset>(map['datasets'], (value) => Dataset.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      defaultTopic: map['defaultTopic'] == null ? null : pulumi.Output.create<Topic>(Topic.fromMap((map['defaultTopic'] as Map).cast<String, dynamic>())),
