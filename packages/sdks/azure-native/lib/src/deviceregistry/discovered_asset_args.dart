...
class DiscoveredAssetArgs {
  ...
  DiscoveredAssetArgs({
    ...
    pulumi.Output<List<DiscoveredDataset>>? datasets,
    ...
    pulumi.Output<List<DiscoveredEvent>>? events,
  ...
  factory DiscoveredAssetArgs.fromMap(Map<String, dynamic> map) {
    return DiscoveredAssetArgs(
      ...
      datasets: map['datasets'] == null ? null : pulumi.Output.create<List<DiscoveredDataset>>(pulumi.Input.decodeList<DiscoveredDataset>(map['datasets'], (value) => DiscoveredDataset.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      events: map['events'] == null ? null : pulumi.Output.create<List<DiscoveredEvent>>(pulumi.Input.decodeList<DiscoveredEvent>(map['events'], (value) => DiscoveredEvent.fromMap((value as Map).cast<String, dynamic>()))),
