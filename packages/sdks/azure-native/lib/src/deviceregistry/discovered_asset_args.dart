    ...
    return <String, dynamic>{
      ...
      'events':
          ...
          >(
            events,
            (value) =>
                pulumi.Input.encodeList<DiscoveredEvent, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DiscoveredAssetArgs(
      ...
      datasets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiscoveredDataset>(
            guardedValue,
            (value) => DiscoveredDataset.fromMap(
      ...
      events: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DiscoveredEvent>(
            guardedValue,
            (value) =>
                DiscoveredEvent.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
