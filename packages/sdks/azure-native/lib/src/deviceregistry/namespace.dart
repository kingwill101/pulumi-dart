...
class Namespace extends pulumi.CustomResource {
  ...
  Namespace(
    ...
    messaging = registerOutput<MessagingResponse?>('messaging', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MessagingResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
