...
class NamespaceAssetStatusResponse {
  ...
  factory NamespaceAssetStatusResponse.fromMap(Map<String, dynamic> map) {
    return NamespaceAssetStatusResponse(
      ...
      datasets: pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceAssetStatusDatasetResponse>(map['datasets']!, (value) => NamespaceAssetStatusDatasetResponse.fromMap((value as Map).cast<String, dynamic>()))),
      events: pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceAssetStatusEventResponse>(map['events']!, (value) => NamespaceAssetStatusEventResponse.fromMap((value as Map).cast<String, dynamic>()))),
      managementGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceAssetStatusManagementGroupResponse>(map['managementGroups']!, (value) => NamespaceAssetStatusManagementGroupResponse.fromMap((value as Map).cast<String, dynamic>()))),
      streams: pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceAssetStatusStreamResponse>(map['streams']!, (value) => NamespaceAssetStatusStreamResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
