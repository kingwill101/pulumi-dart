...
class DiscoveredMessagingEndpointsResponse {
  ...
  DiscoveredMessagingEndpointsResponse({this.inbound, this.outbound});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inbound':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DiscoveredInboundEndpointsResponse>,
  ...
  factory DiscoveredMessagingEndpointsResponse.fromMap(
    ...
    return DiscoveredMessagingEndpointsResponse(
      inbound: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DiscoveredInboundEndpointsResponse>(
            guardedValue,
            (value) => DiscoveredInboundEndpointsResponse.fromMap(
      ...
      outbound: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiscoveredOutboundEndpointsResponse.fromMap(
