...
class NamespaceDiscoveredEventResponse {
  ...
  const NamespaceDiscoveredEventResponse({
    this.dataPoints,
    this.destinations,
  ...
  factory NamespaceDiscoveredEventResponse.fromMap(Map<String, dynamic> map) {
    return NamespaceDiscoveredEventResponse(
      dataPoints: (() { final guardedValue = map['dataPoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NamespaceDiscoveredEventDataPointResponse>(guardedValue, (value) => NamespaceDiscoveredEventDataPointResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
