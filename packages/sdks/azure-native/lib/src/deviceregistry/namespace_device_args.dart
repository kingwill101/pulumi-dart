...
class NamespaceDeviceArgs {
  ...
  factory NamespaceDeviceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceDeviceArgs(
      ...
      discoveredDeviceRef: (() { final guardedValue = map['discoveredDeviceRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      endpoints: (() { final guardedValue = map['endpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MessagingEndpoints.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
