...
class NamespaceDeviceArgs {
  ...
  NamespaceDeviceArgs({
    ...
    pulumi.Output<String>? discoveredDeviceRef,
    pulumi.Output<bool>? enabled,
    pulumi.Output<MessagingEndpoints>? endpoints,
  ...
  factory NamespaceDeviceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceDeviceArgs(
      ...
      discoveredDeviceRef: map['discoveredDeviceRef'] == null ? null : pulumi.Output.create<String>(map['discoveredDeviceRef'] as String),
      enabled: map['enabled'] == null ? null : pulumi.Output.create<bool>(map['enabled'] as bool),
      endpoints: map['endpoints'] == null ? null : pulumi.Output.create<MessagingEndpoints>(MessagingEndpoints.fromMap((map['endpoints'] as Map).cast<String, dynamic>())),
