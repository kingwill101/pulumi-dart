...
class ResourceTypeRegistrationPropertiesExtensionOptions {
  ...
  final ResourceTypeExtensionOptionsResourceCreationBegin? resourceCreationBegin;
  ...
  factory ResourceTypeRegistrationPropertiesExtensionOptions.fromMap(Map<String, dynamic> map) {
    return ResourceTypeRegistrationPropertiesExtensionOptions(
      resourceCreationBegin: map['resourceCreationBegin'] == null ? null : ResourceTypeExtensionOptionsResourceCreationBegin.fromMap((map['resourceCreationBegin'] as Map).cast<String, dynamic>()),
    );
  }
}
