...
class SkuLocationInfo {
    ...
    return <String, dynamic>{
      ...
      'zoneDetails':
          ...
          >(
            zoneDetails,
            (value) =>
                pulumi.Input.encodeList<SkuZoneDetail, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory SkuLocationInfo.fromMap(Map<String, dynamic> map) {
    return SkuLocationInfo(
      ...
      zoneDetails: (() {
        final guardedValue = map['zoneDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SkuZoneDetail>(
            guardedValue,
            (value) =>
                SkuZoneDetail.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      zones: (() {
