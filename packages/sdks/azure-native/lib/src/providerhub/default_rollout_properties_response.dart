...
class DefaultRolloutPropertiesResponse {
  ...
  final pulumi.Input<DefaultRolloutPropertiesSpecificationResponse>?
  specification;
    ...
    return DefaultRolloutPropertiesResponse(
      ...
      specification: (() {
        ...
        return pulumi.Input.fromValue(
          DefaultRolloutPropertiesSpecificationResponse.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefaultRolloutPropertiesStatusResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
