    ...
    return <String, dynamic>{
      'capabilities':
          ...
          >(
            capabilities,
            (value) =>
                pulumi.Input.encodeList<SkuCapability, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'costs':
          ...
          >(
            costs,
            (value) => pulumi.Input.encodeList<SkuCost, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'locationInfo':
          ...
          >(
            locationInfo,
            (value) =>
                pulumi.Input.encodeList<SkuLocationInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return SkuSetting(
      capabilities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SkuCapability>(
            guardedValue,
            (value) =>
                SkuCapability.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      capacity: (() {
      ...
      costs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SkuCost>(
            guardedValue,
            (value) => SkuCost.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      family: (() {
      ...
      locationInfo: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SkuLocationInfo>(
            guardedValue,
            (value) =>
                SkuLocationInfo.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      locations: (() {
