...
class CustomRolloutPropertiesStatusResponse {
  ...
  factory CustomRolloutPropertiesStatusResponse.fromMap(Map<String, dynamic> map) {
    return CustomRolloutPropertiesStatusResponse(
      ...
      manifestCheckinStatus: (() { final guardedValue = map['manifestCheckinStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomRolloutStatusManifestCheckinStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
