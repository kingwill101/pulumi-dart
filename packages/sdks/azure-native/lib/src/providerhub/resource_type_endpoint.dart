    ...
    return ResourceTypeEndpoint(
      ...
      dstsConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceTypeEndpointDstsConfiguration.fromMap(
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceTypeExtension>(
            guardedValue,
            (value) => ResourceTypeExtension.fromMap(
      ...
      featuresRule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceTypeEndpointFeaturesRule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
