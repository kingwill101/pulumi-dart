...
/// }
///
/// resource "azure-native_providerhub_operationbyproviderregistration" "operationByProviderRegistration" {
...
class OperationByProviderRegistration extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [OperationByProviderRegistration] resource.
  OperationByProviderRegistration.reference(String urn)
    : super(
        'azure-native:providerhub:OperationByProviderRegistration',
