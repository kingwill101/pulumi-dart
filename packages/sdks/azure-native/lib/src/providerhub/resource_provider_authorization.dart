...
class ResourceProviderAuthorization {
  ...
  factory ResourceProviderAuthorization.fromMap(Map<String, dynamic> map) {
    return ResourceProviderAuthorization(
      allowedThirdPartyExtensions: (() { final guardedValue = map['allowedThirdPartyExtensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ThirdPartyExtension>(guardedValue, (value) => ThirdPartyExtension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      managedByAuthorization: (() { final guardedValue = map['managedByAuthorization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderAuthorizationManagedByAuthorization.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
