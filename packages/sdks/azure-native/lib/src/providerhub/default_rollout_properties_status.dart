...
class DefaultRolloutPropertiesStatus {
  ...
  final pulumi.Input<dynamic>? nextTrafficRegion;
  ...
  final pulumi.Input<dynamic>? subscriptionReregistrationResult;
  ...
  const DefaultRolloutPropertiesStatus({
  ...
  factory DefaultRolloutPropertiesStatus.fromMap(Map<String, dynamic> map) {
    return DefaultRolloutPropertiesStatus(
      ...
      manifestCheckinStatus: (() { final guardedValue = map['manifestCheckinStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultRolloutStatusManifestCheckinStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nextTrafficRegion: (() { final guardedValue = map['nextTrafficRegion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      subscriptionReregistrationResult: (() { final guardedValue = map['subscriptionReregistrationResult']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
