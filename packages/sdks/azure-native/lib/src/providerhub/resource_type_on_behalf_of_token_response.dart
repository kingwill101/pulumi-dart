...
class ResourceTypeOnBehalfOfTokenResponse {
  ...
  ResourceTypeOnBehalfOfTokenResponse({this.actionName, this.lifeTime});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'actionName': ?actionName, 'lifeTime': ?lifeTime};
  }

  factory ResourceTypeOnBehalfOfTokenResponse.fromMap(
