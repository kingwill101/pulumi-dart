...
class AuthorizedApplicationPropertiesResponse {
  ...
  factory AuthorizedApplicationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AuthorizedApplicationPropertiesResponse(
      dataAuthorizations: (() { final guardedValue = map['dataAuthorizations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationDataAuthorizationResponse>(guardedValue, (value) => ApplicationDataAuthorizationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      providerAuthorization: (() { final guardedValue = map['providerAuthorization']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationProviderAuthorizationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
