...
class ResourceProviderAuthorizationRulesResponse {
  ...
  final pulumi.Input<AsyncOperationPollingRulesResponse>?
  ...
  ResourceProviderAuthorizationRulesResponse({this.asyncOperationPollingRules});
  ...
  factory ResourceProviderAuthorizationRulesResponse.fromMap(
    ...
    return ResourceProviderAuthorizationRulesResponse(
      asyncOperationPollingRules: (() {
        ...
        return pulumi.Input.fromValue(
          AsyncOperationPollingRulesResponse.fromMap(
