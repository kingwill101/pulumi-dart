    ...
    return <String, dynamic>{
      ...
      'costs':
          ...
          >(
            costs,
            (value) =>
                pulumi.Input.encodeList<SkuCostResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory SkuSettingResponse.fromMap(Map<String, dynamic> map) {
    return SkuSettingResponse(
      ...
      capacity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SkuSettingCapacityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      costs: (() {
        final guardedValue = map['costs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SkuCostResponse>(
            guardedValue,
            (value) =>
                SkuCostResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      family: (() {
      ...
      locationInfo: (() {
        final guardedValue = map['locationInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SkuLocationInfoResponse>(
            guardedValue,
            (value) => SkuLocationInfoResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      requiredQuotaIds: (() {
        final guardedValue = map['requiredQuotaIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      size: (() {
