...
class ResourceTypeRegistrationPropertiesLegacyPolicyResponse {
  final pulumi.Input<List<LegacyDisallowedConditionResponse>>?
    ...
    return <String, dynamic>{
      'disallowedConditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<LegacyDisallowedConditionResponse>,
  ...
  factory ResourceTypeRegistrationPropertiesLegacyPolicyResponse.fromMap(
    ...
    return ResourceTypeRegistrationPropertiesLegacyPolicyResponse(
      disallowedConditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LegacyDisallowedConditionResponse>(
            guardedValue,
            (value) => LegacyDisallowedConditionResponse.fromMap(
