...
class SubscriberSettingResponse {
  ...
  SubscriberSettingResponse({this.filterRules});
  ...
  factory SubscriberSettingResponse.fromMap(Map<String, dynamic> map) {
    return SubscriberSettingResponse(
      filterRules: (() {
        final guardedValue = map['filterRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FilterRuleResponse>(
            guardedValue,
            (value) => FilterRuleResponse.fromMap(
