...
class Skus extends pulumi.CustomResource {
  ...
  Skus(String name, {SkusArgs? args, pulumi.CustomResourceOptions? options})
    : super(
    ...
    properties = registerOutput<SkuResourcePropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return SkuResourcePropertiesResponse.fromMap(
