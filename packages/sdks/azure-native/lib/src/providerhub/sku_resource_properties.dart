...
class SkuResourceProperties {
  ...
  SkuResourceProperties({required this.skuSettings});
    ...
    return <String, dynamic>{
      'skuSettings':
          ...
          >(
            skuSettings,
            (value) =>
                pulumi.Input.encodeList<SkuSetting, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory SkuResourceProperties.fromMap(Map<String, dynamic> map) {
    return SkuResourceProperties(
      skuSettings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SkuSetting>(
          map['skuSettings']!,
          (value) => SkuSetting.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
