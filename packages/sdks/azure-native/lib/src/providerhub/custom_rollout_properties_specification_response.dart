...
class CustomRolloutPropertiesSpecificationResponse {
  ...
  factory CustomRolloutPropertiesSpecificationResponse.fromMap(Map<String, dynamic> map) {
    return CustomRolloutPropertiesSpecificationResponse(
      autoProvisionConfig: (() { final guardedValue = map['autoProvisionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomRolloutSpecificationAutoProvisionConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      canary: (() { final guardedValue = map['canary']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomRolloutSpecificationCanaryResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      providerRegistration: (() { final guardedValue = map['providerRegistration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomRolloutSpecificationProviderRegistrationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
