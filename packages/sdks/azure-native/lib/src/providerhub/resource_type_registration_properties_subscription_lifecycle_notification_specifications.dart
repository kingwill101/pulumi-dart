...
class ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecifications {
  ...
  final pulumi.Input<List<SubscriptionStateOverrideAction>>?
    ...
    return <String, dynamic>{
      ...
      'subscriptionStateOverrideActions':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriptionStateOverrideAction>,
  ...
  factory ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecifications.fromMap(
    ...
    return ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecifications(
      ...
      subscriptionStateOverrideActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubscriptionStateOverrideAction>(
            guardedValue,
            (value) => SubscriptionStateOverrideAction.fromMap(
