...
class FanoutLinkedNotificationRuleResponse {
  ...
  const FanoutLinkedNotificationRuleResponse({
    this.actions,
  ...
  factory FanoutLinkedNotificationRuleResponse.fromMap(Map<String, dynamic> map) {
    return FanoutLinkedNotificationRuleResponse(
      ...
      dstsConfiguration: (() { final guardedValue = map['dstsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FanoutLinkedNotificationRuleDstsConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      endpoints: (() { final guardedValue = map['endpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceProviderEndpointResponse>(guardedValue, (value) => ResourceProviderEndpointResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
