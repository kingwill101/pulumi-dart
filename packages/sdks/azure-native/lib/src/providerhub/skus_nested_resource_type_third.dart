...
/// }
///
/// resource "azure-native_providerhub_skusnestedresourcetypethird" "skusNestedResourceTypeThird" {
...
class SkusNestedResourceTypeThird extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [SkusNestedResourceTypeThird] resource.
  SkusNestedResourceTypeThird.reference(String urn)
    : super(
        'azure-native:providerhub:SkusNestedResourceTypeThird',
