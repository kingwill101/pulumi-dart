...
/// Result data returned by getProviderRegistration.
class GetProviderRegistrationResult {
  ...
  /// Creates a new [GetProviderRegistrationResult].
  ...
  factory GetProviderRegistrationResult.fromMap(Map<String, dynamic> map) {
    return GetProviderRegistrationResult(
      azureApiVersion: (() { final guardedValue = map['azureApiVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return guardedValue as String; })(),
      kind: (() { final guardedValue = map['kind']; if (guardedValue == null) return null; return guardedValue as String; })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return guardedValue as String; })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ProviderRegistrationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
