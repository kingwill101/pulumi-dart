...
class ResourceProviderAuthorizationResponse {
  ...
  final pulumi.Input<List<ThirdPartyExtensionResponse>>?
    ...
    return <String, dynamic>{
      'allowedThirdPartyExtensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ThirdPartyExtensionResponse>,
  ...
  factory ResourceProviderAuthorizationResponse.fromMap(
    ...
    return ResourceProviderAuthorizationResponse(
      allowedThirdPartyExtensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ThirdPartyExtensionResponse>(
            guardedValue,
            (value) => ThirdPartyExtensionResponse.fromMap(
      ...
      managedByAuthorization: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceProviderAuthorizationManagedByAuthorizationResponse.fromMap(
