...
class ProviderRegistrationPropertiesResponse {
  ...
  const ProviderRegistrationPropertiesResponse({
    this.capabilities,
  ...
  factory ProviderRegistrationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ProviderRegistrationPropertiesResponse(
      capabilities: (() { final guardedValue = map['capabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceProviderCapabilitiesResponse>(guardedValue, (value) => ResourceProviderCapabilitiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      dstsConfiguration: (() { final guardedValue = map['dstsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesDstsConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      featuresRule: (() { final guardedValue = map['featuresRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesFeaturesRuleResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      globalNotificationEndpoints: (() { final guardedValue = map['globalNotificationEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceProviderEndpointResponse>(guardedValue, (value) => ResourceProviderEndpointResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      linkedNotificationRules: (() { final guardedValue = map['linkedNotificationRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FanoutLinkedNotificationRuleResponse>(guardedValue, (value) => FanoutLinkedNotificationRuleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      management: (() { final guardedValue = map['management']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesManagementResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      managementGroupGlobalNotificationEndpoints: (() { final guardedValue = map['managementGroupGlobalNotificationEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceProviderEndpointResponse>(guardedValue, (value) => ResourceProviderEndpointResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      notificationSettings: (() { final guardedValue = map['notificationSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesNotificationSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      privateResourceProviderConfiguration: (() { final guardedValue = map['privateResourceProviderConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProviderRegistrationPropertiesPrivateResourceProviderConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      providerAuthentication: (() { final guardedValue = map['providerAuthentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesProviderAuthenticationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      providerHubMetadata: (() { final guardedValue = map['providerHubMetadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProviderRegistrationPropertiesProviderHubMetadataResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      requestHeaderOptions: (() { final guardedValue = map['requestHeaderOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesRequestHeaderOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceGroupLockOptionDuringMove: (() { final guardedValue = map['resourceGroupLockOptionDuringMove']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesResourceGroupLockOptionDuringMoveResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceHydrationAccounts: (() { final guardedValue = map['resourceHydrationAccounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceHydrationAccountResponse>(guardedValue, (value) => ResourceHydrationAccountResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      responseOptions: (() { final guardedValue = map['responseOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesResponseOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serviceName: (() { final guardedValue = map['serviceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      services: (() { final guardedValue = map['services']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceProviderServiceResponse>(guardedValue, (value) => ResourceProviderServiceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      subscriptionLifecycleNotificationSpecifications: (() { final guardedValue = map['subscriptionLifecycleNotificationSpecifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProviderRegistrationPropertiesSubscriptionLifecycleNotificationSpecificationsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      templateDeploymentOptions: (() { final guardedValue = map['templateDeploymentOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceProviderManifestPropertiesTemplateDeploymentOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
