...
class SkuResourcePropertiesResponse {
  ...
  factory SkuResourcePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SkuResourcePropertiesResponse(
      ...
      skuSettings: pulumi.Input.fromValue(pulumi.Input.decodeList<SkuSettingResponse>(map['skuSettings']!, (value) => SkuSettingResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
