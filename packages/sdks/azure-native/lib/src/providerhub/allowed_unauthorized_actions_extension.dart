...
class AllowedUnauthorizedActionsExtension {
  ...
  /// [action] The action.
  /// [intent] The intent.
  AllowedUnauthorizedActionsExtension({this.action, this.intent});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'action': ?action, 'intent': ?intent};
  }

  factory AllowedUnauthorizedActionsExtension.fromMap(
