...
class DefaultRolloutPropertiesStatusResponse {
  ...
  final pulumi.Input<DefaultRolloutStatusManifestCheckinStatusResponse>?
  ...
  factory DefaultRolloutPropertiesStatusResponse.fromMap(
    ...
    return DefaultRolloutPropertiesStatusResponse(
      ...
      manifestCheckinStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefaultRolloutStatusManifestCheckinStatusResponse.fromMap(
