...
class ResourceTypeEndpointResponse {
  ...
  final pulumi.Input<ResourceTypeEndpointDstsConfigurationResponse>?
  dstsConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'extensions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceTypeExtensionResponse>,
  ...
  factory ResourceTypeEndpointResponse.fromMap(Map<String, dynamic> map) {
    return ResourceTypeEndpointResponse(
      ...
      dataBoundary: (() {
        final guardedValue = map['dataBoundary'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dstsConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceTypeEndpointDstsConfigurationResponse.fromMap(
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceTypeExtensionResponse>(
            guardedValue,
            (value) => ResourceTypeExtensionResponse.fromMap(
      ...
      featuresRule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceTypeEndpointFeaturesRuleResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
