...
class ProviderRegistrationPropertiesProviderHubMetadataResponse {
  ...
  final pulumi.Input<ProviderHubMetadataProviderAuthenticationResponse>?
  ...
  factory ProviderRegistrationPropertiesProviderHubMetadataResponse.fromMap(
    ...
    return ProviderRegistrationPropertiesProviderHubMetadataResponse(
      ...
      providerAuthentication: (() {
        ...
        return pulumi.Input.fromValue(
          ProviderHubMetadataProviderAuthenticationResponse.fromMap(
      ...
      thirdPartyProviderAuthorization: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProviderHubMetadataThirdPartyProviderAuthorizationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
