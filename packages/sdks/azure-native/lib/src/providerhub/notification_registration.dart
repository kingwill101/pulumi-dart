...
class NotificationRegistration extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NotificationRegistrationPropertiesResponse>
  properties;
  ...
  NotificationRegistration(
    ...
    properties = registerOutput<NotificationRegistrationPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return NotificationRegistrationPropertiesResponse.fromMap(
