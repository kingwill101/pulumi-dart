...
class QuotaRule {
  ...
  QuotaRule({this.locationRules, this.quotaPolicy, this.requiredFeatures});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'locationRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<LocationQuotaRule>,
  ...
  factory QuotaRule.fromMap(Map<String, dynamic> map) {
    return QuotaRule(
      locationRules: (() {
        final guardedValue = map['locationRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LocationQuotaRule>(
            guardedValue,
            (value) => LocationQuotaRule.fromMap(
      ...
      quotaPolicy: (() {
        final guardedValue = map['quotaPolicy'];
        if (guardedValue == null) return null;
