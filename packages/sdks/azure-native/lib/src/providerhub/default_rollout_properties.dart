...
class DefaultRolloutProperties {
  ...
  factory DefaultRolloutProperties.fromMap(Map<String, dynamic> map) {
    return DefaultRolloutProperties(
      specification: (() { final guardedValue = map['specification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultRolloutPropertiesSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultRolloutPropertiesStatus.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
