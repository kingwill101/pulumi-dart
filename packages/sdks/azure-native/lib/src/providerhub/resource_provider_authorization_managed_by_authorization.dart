...
class ResourceProviderAuthorizationManagedByAuthorization {
  ...
  factory ResourceProviderAuthorizationManagedByAuthorization.fromMap(
    ...
    return ResourceProviderAuthorizationManagedByAuthorization(
      additionalAuthorizations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdditionalAuthorization>(
            guardedValue,
            (value) => AdditionalAuthorization.fromMap(
