...
class ResourceTypeRegistrationPropertiesResourceManagementOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deleteDependencies':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeleteDependency>,
            List<Map<String, dynamic>>
          >(
            deleteDependencies,
            (value) =>
                pulumi.Input.encodeList<DeleteDependency, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ResourceTypeRegistrationPropertiesResourceManagementOptions.fromMap(
    ...
    return ResourceTypeRegistrationPropertiesResourceManagementOptions(
      batchProvisioningSupport: (() {
        ...
        return pulumi.Input.fromValue(
          ResourceTypeRegistrationPropertiesResourceManagementOptionsBatchProvisioningSupport.fromMap(
      ...
      deleteDependencies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeleteDependency>(
            guardedValue,
            (value) => DeleteDependency.fromMap(
      ...
      nestedProvisioningSupport: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourceTypeRegistrationPropertiesResourceManagementOptionsNestedProvisioningSupport.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
