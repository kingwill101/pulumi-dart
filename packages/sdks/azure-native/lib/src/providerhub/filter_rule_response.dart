...
class FilterRuleResponse {
  ...
  FilterRuleResponse({this.endpointInformation, this.filterQuery});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endpointInformation':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointInformationResponse>,
    ...
    return FilterRuleResponse(
      endpointInformation: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointInformationResponse>(
            guardedValue,
            (value) => EndpointInformationResponse.fromMap(
