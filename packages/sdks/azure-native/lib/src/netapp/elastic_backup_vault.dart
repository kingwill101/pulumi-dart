...
/// }
///
/// resource "azure-native_netapp_elasticbackupvault" "elasticBackupVault" {
...
class ElasticBackupVault extends pulumi.CustomResource {
  ...
  ElasticBackupVault(
    ...
    properties = registerOutput<ElasticBackupVaultPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ElasticBackupVaultPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ElasticBackupVault] resource.
  ElasticBackupVault.reference(String urn)
    : super(
        'azure-native:netapp:ElasticBackupVault',
