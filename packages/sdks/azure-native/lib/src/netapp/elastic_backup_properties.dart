...
class ElasticBackupProperties {
  ...
  final pulumi.Input<dynamic>? snapshotUsage;
  ...
  ElasticBackupProperties({
    ...
    this.label,
    pulumi.Input<dynamic>? snapshotUsage,
  }) : snapshotUsage = snapshotUsage ?? pulumi.Input.fromValue('CreateNewSnapshot');
  ...
  factory ElasticBackupProperties.fromMap(Map<String, dynamic> map) {
    return ElasticBackupProperties(
      ...
      snapshotUsage: (() { final guardedValue = map['snapshotUsage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
