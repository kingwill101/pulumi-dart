...
class CapacityPoolBucketArgs {
  ...
  factory CapacityPoolBucketArgs.fromMap(Map<String, dynamic> map) {
    return CapacityPoolBucketArgs(
      ...
      fileSystemUser: (() { final guardedValue = map['fileSystemUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileSystemUser.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      path: (() { final guardedValue = map['path']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      poolName: pulumi.Input.fromValue(map['poolName'] as String),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      server: (() { final guardedValue = map['server']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketServerProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
