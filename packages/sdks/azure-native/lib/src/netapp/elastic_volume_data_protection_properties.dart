...
class ElasticVolumeDataProtectionProperties {
  ...
  ElasticVolumeDataProtectionProperties({this.backup, this.snapshot});
  ...
  factory ElasticVolumeDataProtectionProperties.fromMap(
    ...
    return ElasticVolumeDataProtectionProperties(
      backup: (() {
        ...
        return pulumi.Input.fromValue(
          ElasticVolumeBackupProperties.fromMap(
      ...
      snapshot: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ElasticVolumeSnapshotProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
