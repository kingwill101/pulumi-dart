...
class ActiveDirectory {
  ...
  final LdapSearchScopeOpt? ldapSearchScope;
  ...
  factory ActiveDirectory.fromMap(Map<String, dynamic> map) {
    return ActiveDirectory(
      ...
      ldapSearchScope: map['ldapSearchScope'] == null ? null : LdapSearchScopeOpt.fromMap((map['ldapSearchScope'] as Map).cast<String, dynamic>()),
