...
class ActiveDirectory {
  ...
  factory ActiveDirectory.fromMap(Map<String, dynamic> map) {
    return ActiveDirectory(
      ...
      ldapSearchScope: (() { final guardedValue = map['ldapSearchScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LdapSearchScopeOpt.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
