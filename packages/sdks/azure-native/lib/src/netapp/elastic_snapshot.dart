...
/// }
///
/// resource "azure-native_netapp_elasticsnapshot" "elasticSnapshot" {
...
class ElasticSnapshot extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ElasticSnapshot] resource.
  ElasticSnapshot.reference(String urn)
    : super(
        'azure-native:netapp:ElasticSnapshot',
