    ...
    return <String, dynamic>{
      ...
      'ldapSearchScope':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(ldapSearchScope, (value) => value.toMap()),
  ...
  factory ActiveDirectoryResponse.fromMap(Map<String, dynamic> map) {
    return ActiveDirectoryResponse(
      ...
      allowLocalNfsUsersWithLdap: (() {
        final guardedValue = map['allowLocalNfsUsersWithLdap'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      backupOperators: (() {
      ...
      ldapOverTLS: (() {
        final guardedValue = map['ldapOverTLS'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ldapSearchScope: (() {
        final guardedValue = map['ldapSearchScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LdapSearchScopeOptResponse.fromMap(
      ...
      preferredServersForLdapClient: (() {
        final guardedValue = map['preferredServersForLdapClient'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      securityOperators: (() {
