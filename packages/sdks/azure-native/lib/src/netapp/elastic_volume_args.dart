...
class ElasticVolumeArgs {
  ...
  factory ElasticVolumeArgs.fromMap(Map<String, dynamic> map) {
    return ElasticVolumeArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ElasticVolumeProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
