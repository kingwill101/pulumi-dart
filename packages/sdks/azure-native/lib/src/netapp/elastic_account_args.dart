...
class ElasticAccountArgs {
  ...
  ElasticAccountArgs({
    ...
    pulumi.Output<ElasticAccountProperties>? properties,
  ...
  factory ElasticAccountArgs.fromMap(Map<String, dynamic> map) {
    return ElasticAccountArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ElasticAccountProperties>(ElasticAccountProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
