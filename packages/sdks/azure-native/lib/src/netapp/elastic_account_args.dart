...
class ElasticAccountArgs {
  ...
  factory ElasticAccountArgs.fromMap(Map<String, dynamic> map) {
    return ElasticAccountArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ElasticAccountProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
