...
class GetElasticAccountResult {
  ...
  factory GetElasticAccountResult.fromMap(Map<String, dynamic> map) {
    return GetElasticAccountResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ElasticAccountPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
