    ...
    return ElasticSnapshotPolicyProperties(
      dailySchedule: (() {
        ...
        return pulumi.Input.fromValue(
          ElasticSnapshotPolicyDailySchedule.fromMap(
      ...
      hourlySchedule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ElasticSnapshotPolicyHourlySchedule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      monthlySchedule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ElasticSnapshotPolicyMonthlySchedule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      weeklySchedule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ElasticSnapshotPolicyWeeklySchedule.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
