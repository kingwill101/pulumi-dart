...
class ElasticBackup extends pulumi.CustomResource {
  ...
  ElasticBackup(
    ...
    properties = registerOutput<ElasticBackupPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ElasticBackupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ElasticBackup] resource.
  ElasticBackup.reference(String urn)
    : super(
        'azure-native:netapp:ElasticBackup',
