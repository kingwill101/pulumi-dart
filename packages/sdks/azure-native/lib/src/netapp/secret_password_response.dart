...
class SecretPasswordResponse {
  ...
  final pulumi.Input<SecretPasswordKeyVaultPropertiesResponse>?
  keyVaultProperties;
  ...
  SecretPasswordResponse({this.identity, this.keyVaultProperties});
    ...
    return SecretPasswordResponse(
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          SecretPasswordIdentityResponse.fromMap(
      ...
      keyVaultProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretPasswordKeyVaultPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
