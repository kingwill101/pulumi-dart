    ...
    return VolumeGroupVolumeProperties(
      ...
      dataProtection: (() {
        ...
        return pulumi.Input.fromValue(
          VolumePropertiesDataProtection.fromMap(
      ...
      exportPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumePropertiesExportPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      placementRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PlacementKeyValuePairs>(
            guardedValue,
            (value) => PlacementKeyValuePairs.fromMap(
