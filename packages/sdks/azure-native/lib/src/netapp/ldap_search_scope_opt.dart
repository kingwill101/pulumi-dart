...
class LdapSearchScopeOpt {
  ...
  /// Creates a new [LdapSearchScopeOpt].
  ...
  LdapSearchScopeOpt({this.groupDN, this.groupMembershipFilter, this.userDN});
  ...
  factory LdapSearchScopeOpt.fromMap(Map<String, dynamic> map) {
    return LdapSearchScopeOpt(
      groupDN: (() {
        final guardedValue = map['groupDN'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      groupMembershipFilter: (() {
        final guardedValue = map['groupMembershipFilter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      userDN: (() {
        final guardedValue = map['userDN'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
