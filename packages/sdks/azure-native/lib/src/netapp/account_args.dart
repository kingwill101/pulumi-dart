...
class AccountArgs {
    ...
    return <String, dynamic>{
      ...
      'activeDirectories':
          ...
          >(
            activeDirectories,
            (value) =>
                pulumi.Input.encodeList<ActiveDirectory, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      activeDirectories: (() {
        final guardedValue = map['activeDirectories'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ActiveDirectory>(
            guardedValue,
            (value) =>
                ActiveDirectory.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      encryption: (() {
