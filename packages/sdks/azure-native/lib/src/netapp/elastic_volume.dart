...
class ElasticVolume extends pulumi.CustomResource {
  ...
  ElasticVolume(
    ...
    properties = registerOutput<ElasticVolumePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ElasticVolumePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [ElasticVolume] resource.
  ElasticVolume.reference(String urn)
    : super(
        'azure-native:netapp:ElasticVolume',
