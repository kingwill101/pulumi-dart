...
class GetCapacityPoolVolumeResult {
  ...
  GetCapacityPoolVolumeResult({
    this.actualThroughputMibps,
    String? avsDataStore,
    this.azureApiVersion,
    this.backupId,
    this.baremetalTenantId,
    ...
    this.networkSiblingSetId,
    this.originatingResourceId,
    this.placementRules,
    this.protocolTypes,
    this.provisionedAvailabilityZone,
    ...
    this.snapshotId,
    this.storageToNetworkProximity,
    this.subnetId,
    this.systemData,
    this.t2Network,
    this.tags,
    ...
    this.volumeType,
    this.zones,
  }) : avsDataStore = avsDataStore ?? 'Disabled', coolAccess = coolAccess ?? false, defaultGroupQuotaInKiBs = defaultGroupQuotaInKiBs ?? 0, defaultUserQuotaInKiBs = defaultUserQuotaInKiBs ?? 0, enableSubvolumes = enableSubvolumes ?? 'Disabled', encryptionKeySource = encryptionKeySource ?? 'Microsoft.NetApp', fileAccessLogs = fileAccessLogs ?? 'Disabled', isDefaultQuotaEnabled = isDefaultQuotaEnabled ?? false, isLargeVolume = isLargeVolume ?? false, kerberosEnabled = kerberosEnabled ?? false, ldapEnabled = ldapEnabled ?? false, securityStyle = securityStyle ?? 'unix', smbContinuouslyAvailable = smbContinuouslyAvailable ?? false, smbEncryption = smbEncryption ?? false, snapshotDirectoryVisible = snapshotDirectoryVisible ?? true, usageThreshold = usageThreshold ?? 1.073741824e+11;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mountTargets': ?(() { final guardedValue = mountTargets; if (guardedValue == null) return null; return pulumi.Input.encodeList<MountTargetPropertiesResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'name': ?name,
  ...
  factory GetCapacityPoolVolumeResult.fromMap(Map<String, dynamic> map) {
    return GetCapacityPoolVolumeResult(
      actualThroughputMibps: (() { final guardedValue = map['actualThroughputMibps']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      ...
      baremetalTenantId: (() { final guardedValue = map['baremetalTenantId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      cloneProgress: (() { final guardedValue = map['cloneProgress']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      coolnessPeriod: (() { final guardedValue = map['coolnessPeriod']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      dataStoreResourceId: (() { final guardedValue = map['dataStoreResourceId']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      defaultGroupQuotaInKiBs: (() { final guardedValue = map['defaultGroupQuotaInKiBs']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      defaultUserQuotaInKiBs: (() { final guardedValue = map['defaultUserQuotaInKiBs']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      ...
      effectiveNetworkFeatures: (() { final guardedValue = map['effectiveNetworkFeatures']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      fileAccessLogs: (() { final guardedValue = map['fileAccessLogs']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      maximumNumberOfFiles: (() { final guardedValue = map['maximumNumberOfFiles']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      mountTargets: (() { final guardedValue = map['mountTargets']; if (guardedValue == null) return null; return pulumi.Input.decodeList<MountTargetPropertiesResponse>(guardedValue, (value) => MountTargetPropertiesResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      networkSiblingSetId: (() { final guardedValue = map['networkSiblingSetId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      originatingResourceId: (() { final guardedValue = map['originatingResourceId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      provisionedAvailabilityZone: (() { final guardedValue = map['provisionedAvailabilityZone']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      storageToNetworkProximity: (() { final guardedValue = map['storageToNetworkProximity']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      t2Network: (() { final guardedValue = map['t2Network']; if (guardedValue == null) return null; return guardedValue as String; })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); })(),
      throughputMibps: (() { final guardedValue = map['throughputMibps']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      ...
      usageThreshold: (() { final guardedValue = map['usageThreshold']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      volumeGroupName: (() { final guardedValue = map['volumeGroupName']; if (guardedValue == null) return null; return guardedValue as String; })(),
