...
class GetCapacityPoolVolumeResult {
  ...
  factory GetCapacityPoolVolumeResult.fromMap(Map<String, dynamic> map) {
    return GetCapacityPoolVolumeResult(
      ...
      mountTargets: pulumi.Input.decodeList<MountTargetPropertiesResponse>(
        map['mountTargets']!,
      ...
      placementRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<PlacementKeyValuePairsResponse>(
          guardedValue,
