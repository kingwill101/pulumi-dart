...
class ElasticCapacityPoolPropertiesResponse {
  ...
  factory ElasticCapacityPoolPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ElasticCapacityPoolPropertiesResponse(
      activeDirectoryConfigResourceId: (() {
        final guardedValue = map['activeDirectoryConfigResourceId'];
      ...
      encryption: (() {
        ...
        return pulumi.Input.fromValue(
          ElasticEncryptionConfigurationResponse.fromMap(
      ...
      totalThroughputMibps: pulumi.Input.fromValue(
        map['totalThroughputMibps'] as double,
      ),
    );
  }
}
