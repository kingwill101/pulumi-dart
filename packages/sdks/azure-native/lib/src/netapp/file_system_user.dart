...
class FileSystemUser {
  ...
  factory FileSystemUser.fromMap(Map<String, dynamic> map) {
    return FileSystemUser(
      cifsUser: (() { final guardedValue = map['cifsUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CifsUser.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nfsUser: (() { final guardedValue = map['nfsUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NfsUser.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
