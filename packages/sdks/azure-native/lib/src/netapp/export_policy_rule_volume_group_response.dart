...
class ExportPolicyRuleVolumeGroupResponse {
  ...
  /// Creates a new [ExportPolicyRuleVolumeGroupResponse].
  ...
  factory ExportPolicyRuleVolumeGroupResponse.fromMap(Map<String, dynamic> map) {
    return ExportPolicyRuleVolumeGroupResponse(
