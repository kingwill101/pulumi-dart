...
class VolumeGroupVolumePropertiesResponse {
  ...
  factory VolumeGroupVolumePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return VolumeGroupVolumePropertiesResponse(
      ...
      dataProtection: map['dataProtection'] == null ? null : (VolumePropertiesResponseDataProtection.fromMap((map['dataProtection']! as Map).cast<String, dynamic>())).input(),
      dataStoreResourceId: ((map['dataStoreResourceId'] as List).cast<String>()).input(),
      ...
      effectiveNetworkFeatures: (map['effectiveNetworkFeatures'] as String).input(),
      ...
      exportPolicy: map['exportPolicy'] == null ? null : (VolumePropertiesResponseExportPolicy.fromMap((map['exportPolicy']! as Map).cast<String, dynamic>())).input(),
      fileAccessLogs: (map['fileAccessLogs'] as String).input(),
      ...
      mountTargets: (pulumi.Input.decodeList<MountTargetPropertiesResponse>(map['mountTargets'], (value) => MountTargetPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      networkFeatures: map['networkFeatures'] == null ? null : (map['networkFeatures']! as String).input(),
      networkSiblingSetId: (map['networkSiblingSetId'] as String).input(),
      originatingResourceId: (map['originatingResourceId'] as String).input(),
      placementRules: map['placementRules'] == null ? null : (pulumi.Input.decodeList<PlacementKeyValuePairsResponse>(map['placementRules']!, (value) => PlacementKeyValuePairsResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      protocolTypes: map['protocolTypes'] == null ? null : ((map['protocolTypes']! as List).cast<String>()).input(),
      provisionedAvailabilityZone: (map['provisionedAvailabilityZone'] as String).input(),
      ...
      storageToNetworkProximity: (map['storageToNetworkProximity'] as String).input(),
      subnetId: (map['subnetId'] as String).input(),
      t2Network: (map['t2Network'] as String).input(),
