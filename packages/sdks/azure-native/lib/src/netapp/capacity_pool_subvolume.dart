...
/// }
///
/// resource "azure-native_netapp_capacitypoolsubvolume" "capacityPoolSubvolume" {
...
class CapacityPoolSubvolume extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [CapacityPoolSubvolume] resource.
  CapacityPoolSubvolume.reference(String urn)
    : super(
        'azure-native:netapp:CapacityPoolSubvolume',
