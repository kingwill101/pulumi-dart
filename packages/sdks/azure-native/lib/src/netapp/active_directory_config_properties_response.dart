...
class ActiveDirectoryConfigPropertiesResponse {
  ...
  final SecretPasswordResponse secretPassword;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secretPassword': secretPassword.toMap(),
  ...
  factory ActiveDirectoryConfigPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ActiveDirectoryConfigPropertiesResponse(
      activeDirectoryStatus: map['activeDirectoryStatus'] as String,
      ...
      dns: map['dns'] == null ? null : (map['dns'] as List).cast<String>(),
      domain: map['domain'] as String,
      organizationalUnit: map['organizationalUnit'] == null ? null : map['organizationalUnit'] as String,
      provisioningState: map['provisioningState'] as String,
      secretPassword: SecretPasswordResponse.fromMap((map['secretPassword'] as Map).cast<String, dynamic>()),
