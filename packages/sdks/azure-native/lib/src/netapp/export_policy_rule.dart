...
class ExportPolicyRule {
  ...
  factory ExportPolicyRule.fromMap(Map<String, dynamic> map) {
    return ExportPolicyRule(
      ...
      chownMode: (() {
        final guardedValue = map['chownMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cifs: (() {
        final guardedValue = map['cifs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      hasRootAccess: (() {
        final guardedValue = map['hasRootAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kerberos5IReadOnly: (() {
        final guardedValue = map['kerberos5IReadOnly'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kerberos5IReadWrite: (() {
        final guardedValue = map['kerberos5IReadWrite'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kerberos5PReadOnly: (() {
        final guardedValue = map['kerberos5PReadOnly'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kerberos5PReadWrite: (() {
        final guardedValue = map['kerberos5PReadWrite'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kerberos5ReadOnly: (() {
        final guardedValue = map['kerberos5ReadOnly'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kerberos5ReadWrite: (() {
        final guardedValue = map['kerberos5ReadWrite'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kerberos5iReadOnly: (() {
