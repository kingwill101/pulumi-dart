...
class QuotaReportResponse {
  ...
  factory QuotaReportResponse.fromMap(Map<String, dynamic> map) {
    return QuotaReportResponse(
      isDerivedQuota: (() {
        final guardedValue = map['isDerivedQuota'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      percentageUsed: (() {
        final guardedValue = map['percentageUsed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      quotaLimitTotalInKiBs: (() {
        final guardedValue = map['quotaLimitTotalInKiBs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      quotaLimitUsedInKiBs: (() {
        final guardedValue = map['quotaLimitUsedInKiBs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      quotaTarget: (() {
