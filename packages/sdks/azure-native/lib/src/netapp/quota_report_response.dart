...
class QuotaReportResponse {
  ...
  factory QuotaReportResponse.fromMap(Map<String, dynamic> map) {
    return QuotaReportResponse(
      ...
      percentageUsed: (() { final guardedValue = map['percentageUsed']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      quotaLimitTotalInKiBs: (() { final guardedValue = map['quotaLimitTotalInKiBs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      quotaLimitUsedInKiBs: (() { final guardedValue = map['quotaLimitUsedInKiBs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
