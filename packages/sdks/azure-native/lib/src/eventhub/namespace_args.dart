...
class NamespaceArgs {
  ...
  final pulumi.Input<List<PrivateEndpointConnectionEventhub>>?
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      clusterArmId: (() {
        final guardedValue = map['clusterArmId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      disableLocalAuth: (() {
      ...
      isAutoInflateEnabled: (() {
        final guardedValue = map['isAutoInflateEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kafkaEnabled: (() {
        final guardedValue = map['kafkaEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      location: (() {
      ...
      privateEndpointConnections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<PrivateEndpointConnectionEventhub>(),
        );
      })(),
      publicNetworkAccess: (() {
