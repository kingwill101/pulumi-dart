...
class ApplicationGroupArgs {
    ...
    return <String, dynamic>{
      ...
      'policies':
          ...
          >(
            policies,
            (value) =>
                pulumi.Input.encodeList<ThrottlingPolicy, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ApplicationGroupArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationGroupArgs(
      ...
      clientAppGroupIdentifier: pulumi.Input.fromValue(
        map['clientAppGroupIdentifier'] as String,
      ),
      isEnabled: (() {
      ...
      policies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ThrottlingPolicy>(
            guardedValue,
            (value) => ThrottlingPolicy.fromMap(
