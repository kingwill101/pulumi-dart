...
class CaptureIdentity {
  ...
  CaptureIdentity({this.type, this.userAssignedIdentity});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'type': ?pulumi.Input.mapOptionalInputValue<CaptureIdentityType, String>(
        type,
    ...
    return CaptureIdentity(
      type: (() {
        ...
        return pulumi.Input.fromValue(
          CaptureIdentityType.fromValue(guardedValue as String),
        );
      })(),
