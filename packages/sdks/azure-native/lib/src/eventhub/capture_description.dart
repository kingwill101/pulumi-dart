...
class CaptureDescription {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': ?enabled,
      'encoding': ?pulumi.Input.mapOptionalInputValue<EncodingCaptureDescription, String>(encoding, (value) => value.wireValue),
  ...
  factory CaptureDescription.fromMap(Map<String, dynamic> map) {
    return CaptureDescription(
      ...
      encoding: (() { final guardedValue = map['encoding']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncodingCaptureDescription.fromValue(guardedValue as String)); })(),
