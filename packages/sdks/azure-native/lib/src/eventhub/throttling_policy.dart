...
class ThrottlingPolicy {
  ...
  final pulumi.Input<dynamic> metricId;
  ...
  /// Creates a new [ThrottlingPolicy].
  ...
  factory ThrottlingPolicy.fromMap(Map<String, dynamic> map) {
    return ThrottlingPolicy(
      metricId: pulumi.Input.fromValue(map['metricId']),
