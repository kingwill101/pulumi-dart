...
class DocumentProcessorArgs {
  ...
  factory DocumentProcessorArgs.fromMap(Map<String, dynamic> map) {
    return DocumentProcessorArgs(
      ...
      processorName: (() { final guardedValue = map['processorName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DocumentProcessorProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
