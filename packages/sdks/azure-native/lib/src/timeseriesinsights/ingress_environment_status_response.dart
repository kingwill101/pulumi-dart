...
class IngressEnvironmentStatusResponse {
  ...
  IngressEnvironmentStatusResponse({this.state, required this.stateDetails});
    ...
    return <String, dynamic>{
      ...
      'stateDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(stateDetails, (value) => value.toMap()),
    };
  }
  ...
  factory IngressEnvironmentStatusResponse.fromMap(Map<String, dynamic> map) {
    return IngressEnvironmentStatusResponse(
      ...
      stateDetails: pulumi.Input.fromValue(
        EnvironmentStateDetailsResponse.fromMap(
          (map['stateDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
