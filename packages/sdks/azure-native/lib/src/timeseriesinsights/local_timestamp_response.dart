...
class LocalTimestampResponse {
  ...
  factory LocalTimestampResponse.fromMap(Map<String, dynamic> map) {
    return LocalTimestampResponse(
      ...
      timeZoneOffset: (() { final guardedValue = map['timeZoneOffset']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocalTimestampResponseTimeZoneOffset.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
