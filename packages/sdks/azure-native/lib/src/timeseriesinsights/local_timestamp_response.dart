...
class LocalTimestampResponse {
  ...
  LocalTimestampResponse({this.format, this.timeZoneOffset});
    ...
    return <String, dynamic>{
      ...
      'timeZoneOffset':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(timeZoneOffset, (value) => value.toMap()),
    };
  }
  ...
  factory LocalTimestampResponse.fromMap(Map<String, dynamic> map) {
    return LocalTimestampResponse(
      ...
      timeZoneOffset: (() {
        final guardedValue = map['timeZoneOffset'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LocalTimestampResponseTimeZoneOffset.fromMap(
