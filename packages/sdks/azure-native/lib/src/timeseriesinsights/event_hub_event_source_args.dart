...
class EventHubEventSourceArgs {
  ...
  factory EventHubEventSourceArgs.fromMap(Map<String, dynamic> map) {
    return EventHubEventSourceArgs(
      ...
      eventSourceResourceId: pulumi.Input.fromValue(map['eventSourceResourceId'] as String),
      keyName: pulumi.Input.fromValue(map['keyName'] as String),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      localTimestamp: (() { final guardedValue = map['localTimestamp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LocalTimestamp.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
