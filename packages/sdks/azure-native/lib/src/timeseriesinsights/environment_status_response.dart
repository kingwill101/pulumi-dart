...
class EnvironmentStatusResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ingress': pulumi.Input.mapInputValue<IngressEnvironmentStatusResponse, Map<String, dynamic>>(ingress, (value) => value.toMap()),
      'warmStorage': pulumi.Input.mapInputValue<WarmStorageEnvironmentStatusResponse, Map<String, dynamic>>(warmStorage, (value) => value.toMap()),
    };
  }

  factory EnvironmentStatusResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentStatusResponse(
      ingress: pulumi.Input.fromValue(IngressEnvironmentStatusResponse.fromMap((map['ingress']! as Map).cast<String, dynamic>())),
      warmStorage: pulumi.Input.fromValue(WarmStorageEnvironmentStatusResponse.fromMap((map['warmStorage']! as Map).cast<String, dynamic>())),
    );
  }
}
