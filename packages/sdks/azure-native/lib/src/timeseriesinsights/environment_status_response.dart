...
class EnvironmentStatusResponse {
  ...
  factory EnvironmentStatusResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentStatusResponse(
      ingress: (IngressEnvironmentStatusResponse.fromMap((map['ingress'] as Map).cast<String, dynamic>())).input(),
      warmStorage: (WarmStorageEnvironmentStatusResponse.fromMap((map['warmStorage'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
