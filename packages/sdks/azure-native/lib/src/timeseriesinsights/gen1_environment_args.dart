...
class Gen1EnvironmentArgs {
  ...
  final pulumi.Input<dynamic>? storageLimitExceededBehavior;
  ...
  factory Gen1EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return Gen1EnvironmentArgs(
      ...
      storageLimitExceededBehavior: (() { final guardedValue = map['storageLimitExceededBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
