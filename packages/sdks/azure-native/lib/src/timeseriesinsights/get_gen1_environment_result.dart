...
class GetGen1EnvironmentResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionKeyProperties': ?(() {
        final guardedValue = partitionKeyProperties;
  ...
  factory GetGen1EnvironmentResult.fromMap(Map<String, dynamic> map) {
    return GetGen1EnvironmentResult(
      ...
      partitionKeyProperties: (() {
        final guardedValue = map['partitionKeyProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<TimeSeriesIdPropertyResponse>(
          guardedValue,
      ...
      storageLimitExceededBehavior: (() {
        final guardedValue = map['storageLimitExceededBehavior'];
        if (guardedValue == null) return null;
