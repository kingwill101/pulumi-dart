...
class GetGen1EnvironmentResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': location,
      'name': name,
      'partitionKeyProperties': ?partitionKeyProperties == null ? null : pulumi.Input.encodeList<TimeSeriesIdPropertyResponse, Map<String, dynamic>>(partitionKeyProperties!, (value) => value.toMap()),
  ...
  factory GetGen1EnvironmentResult.fromMap(Map<String, dynamic> map) {
    return GetGen1EnvironmentResult(
      ...
      partitionKeyProperties: map['partitionKeyProperties'] == null ? null : pulumi.Input.decodeList<TimeSeriesIdPropertyResponse>(map['partitionKeyProperties']!, (value) => TimeSeriesIdPropertyResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      storageLimitExceededBehavior: map['storageLimitExceededBehavior'] == null ? null : map['storageLimitExceededBehavior']! as String,
