    ...
    return <String, dynamic>{
      ...
      'warmStoreConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(warmStoreConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory Gen2EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return Gen2EnvironmentArgs(
      ...
      storageConfiguration: pulumi.Input.fromValue(
        Gen2StorageConfigurationInput.fromMap(
      ...
      timeSeriesIdProperties: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TimeSeriesIdProperty>(
          map['timeSeriesIdProperties']!,
          (value) => TimeSeriesIdProperty.fromMap(
      ...
      warmStoreConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WarmStoreConfigurationProperties.fromMap(
