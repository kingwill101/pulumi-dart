...
class NetworkFunctionTemplate {
  ...
  factory NetworkFunctionTemplate.fromMap(Map<String, dynamic> map) {
    return NetworkFunctionTemplate(
      networkFunctionRoleConfigurations: (() { final guardedValue = map['networkFunctionRoleConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkFunctionRoleConfiguration>(guardedValue, (value) => NetworkFunctionRoleConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
