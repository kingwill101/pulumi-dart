...
class AzureOperatorNexusNetworkFunctionTemplate {
  ...
  final pulumi.Input<
    List<AzureOperatorNexusNetworkFunctionArmTemplateApplication>
  >?
  ...
  factory AzureOperatorNexusNetworkFunctionTemplate.fromMap(
      ...
      networkFunctionApplications: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AzureOperatorNexusNetworkFunctionArmTemplateApplication.fromMap(
