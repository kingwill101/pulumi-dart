...
class ArtifactStoreArgs {
  ...
  /// [tags] Resource tags.
  ArtifactStoreArgs({
    pulumi.Output<String>? artifactStoreName,
    pulumi.Output<String>? location,
    pulumi.Output<ArtifactStorePropertiesFormat>? properties,
    required pulumi.Output<String> publisherName,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      artifactStoreName = pulumi.Input.asOptionalInput<String>(artifactStoreName),
      location = pulumi.Input.asOptionalInput<String>(location),
      properties = pulumi.Input.asOptionalInput<ArtifactStorePropertiesFormat>(properties),
  ...
  factory ArtifactStoreArgs.fromMap(Map<String, dynamic> map) {
    return ArtifactStoreArgs(
      artifactStoreName: map['artifactStoreName'] == null ? null : pulumi.Output.create<String>(map['artifactStoreName'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      properties: map['properties'] == null ? null : pulumi.Output.create<ArtifactStorePropertiesFormat>(ArtifactStorePropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>())),
