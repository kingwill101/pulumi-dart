...
/// }
///
/// resource "azure-native_hybridnetwork_publisher" "publisher" {
///   location = "eastus"
///   properties = {
///     scope = "Public"
///   }
...
class Publisher extends pulumi.CustomResource {
  ...
  Publisher(
    ...
    properties = registerOutput<PublisherPropertiesFormatResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PublisherPropertiesFormatResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [Publisher] resource.
  Publisher.reference(String urn)
    : super(
        'azure-native:hybridnetwork:Publisher',
