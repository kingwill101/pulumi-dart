...
class NetworkFunctionTemplateResponse {
  ...
  final pulumi.Input<List<NetworkFunctionRoleConfigurationResponse>>?
  ...
  NetworkFunctionTemplateResponse({this.networkFunctionRoleConfigurations});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'networkFunctionRoleConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkFunctionRoleConfigurationResponse>,
    ...
    return NetworkFunctionTemplateResponse(
      networkFunctionRoleConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkFunctionRoleConfigurationResponse>(
            guardedValue,
            (value) => NetworkFunctionRoleConfigurationResponse.fromMap(
