...
class AzureCoreVhdImageDeployMappingRuleProfileResponse {
  ...
  const AzureCoreVhdImageDeployMappingRuleProfileResponse({
  ...
  factory AzureCoreVhdImageDeployMappingRuleProfileResponse.fromMap(Map<String, dynamic> map) {
    return AzureCoreVhdImageDeployMappingRuleProfileResponse(
      ...
      vhdImageMappingRuleProfile: (() { final guardedValue = map['vhdImageMappingRuleProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VhdImageMappingRuleProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
