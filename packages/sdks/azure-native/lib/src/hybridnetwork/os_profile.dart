...
class OsProfile {
  ...
  OsProfile({
    this.adminUsername,
    this.customData,
    pulumi.Input<bool?>? customDataRequired,
    this.linuxConfiguration,
  }) : customDataRequired = customDataRequired ?? pulumi.Input.fromValue(true);
  ...
  factory OsProfile.fromMap(Map<String, dynamic> map) {
    return OsProfile(
      ...
      customDataRequired: (() { final guardedValue = map['customDataRequired']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
