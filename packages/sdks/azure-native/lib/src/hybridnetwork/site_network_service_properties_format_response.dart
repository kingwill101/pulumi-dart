...
class SiteNetworkServicePropertiesFormatResponse {
  ...
  factory SiteNetworkServicePropertiesFormatResponse.fromMap(Map<String, dynamic> map) {
    return SiteNetworkServicePropertiesFormatResponse(
      desiredStateConfigurationGroupValueReferences: (() { final guardedValue = map['desiredStateConfigurationGroupValueReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ReferencedResourceResponse>(guardedValue, (value) => ReferencedResourceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lastStateConfigurationGroupValueReferences: pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ReferencedResourceResponse>(map['lastStateConfigurationGroupValueReferences']!, (value) => ReferencedResourceResponse.fromMap((value as Map).cast<String, dynamic>()))),
      lastStateNetworkServiceDesignVersionName: pulumi.Input.fromValue(map['lastStateNetworkServiceDesignVersionName'] as String),
      managedResourceGroupConfiguration: (() { final guardedValue = map['managedResourceGroupConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedResourceGroupConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      siteReference: (() { final guardedValue = map['siteReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReferencedResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
