...
class SiteNetworkServiceArgs {
  ...
  factory SiteNetworkServiceArgs.fromMap(Map<String, dynamic> map) {
    return SiteNetworkServiceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SiteNetworkServicePropertiesFormat.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      siteNetworkServiceName: (() { final guardedValue = map['siteNetworkServiceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
