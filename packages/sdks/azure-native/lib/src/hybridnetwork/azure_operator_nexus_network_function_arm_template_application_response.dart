...
class AzureOperatorNexusNetworkFunctionArmTemplateApplicationResponse {
  ...
  const AzureOperatorNexusNetworkFunctionArmTemplateApplicationResponse({
  ...
  factory AzureOperatorNexusNetworkFunctionArmTemplateApplicationResponse.fromMap(Map<String, dynamic> map) {
    return AzureOperatorNexusNetworkFunctionArmTemplateApplicationResponse(
      artifactProfile: (() { final guardedValue = map['artifactProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureOperatorNexusArmTemplateArtifactProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      deployParametersMappingRuleProfile: (() { final guardedValue = map['deployParametersMappingRuleProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureOperatorNexusArmTemplateDeployMappingRuleProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
