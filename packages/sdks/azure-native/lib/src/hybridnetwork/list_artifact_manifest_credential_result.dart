...
class ListArtifactManifestCredentialResult {
  ...
  ListArtifactManifestCredentialResult({required this.credentialType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'credentialType': credentialType};
  }

  factory ListArtifactManifestCredentialResult.fromMap(
