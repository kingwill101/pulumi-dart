...
class NetworkServiceDesignVersionPropertiesFormat {
  ...
  final pulumi.Input<List<ArmResourceDefinitionResourceElementTemplateDetails>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nfvisFromSite':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, NfviDetails>,
            Map<String, Map<String, dynamic>>
          >(
            nfvisFromSite,
            (value) =>
                pulumi.Input.encodeMapValues<NfviDetails, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'resourceElementTemplates':
          ?pulumi.Input.mapOptionalInputValue<
            List<ArmResourceDefinitionResourceElementTemplateDetails>,
  ...
  factory NetworkServiceDesignVersionPropertiesFormat.fromMap(
    ...
    return NetworkServiceDesignVersionPropertiesFormat(
      ...
      nfvisFromSite: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<NfviDetails>(
            guardedValue,
            (value) =>
                NfviDetails.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      resourceElementTemplates: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ArmResourceDefinitionResourceElementTemplateDetails.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
