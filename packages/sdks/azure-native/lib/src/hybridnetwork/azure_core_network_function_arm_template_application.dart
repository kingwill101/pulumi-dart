...
class AzureCoreNetworkFunctionArmTemplateApplication {
  ...
  final pulumi.Input<AzureCoreArmTemplateDeployMappingRuleProfile>?
  ...
  factory AzureCoreNetworkFunctionArmTemplateApplication.fromMap(
    ...
    return AzureCoreNetworkFunctionArmTemplateApplication(
      artifactProfile: (() {
        ...
        return pulumi.Input.fromValue(
          AzureCoreArmTemplateArtifactProfile.fromMap(
      ...
      deployParametersMappingRuleProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureCoreArmTemplateDeployMappingRuleProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
