...
class PublisherArgs {
  ...
  PublisherArgs({
    ...
    pulumi.Output<PublisherPropertiesFormat>? properties,
  ...
  factory PublisherArgs.fromMap(Map<String, dynamic> map) {
    return PublisherArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<PublisherPropertiesFormat>(PublisherPropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>())),
