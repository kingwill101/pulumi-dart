...
class GetPublisherResult {
  ...
  factory GetPublisherResult.fromMap(Map<String, dynamic> map) {
    return GetPublisherResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return PublisherPropertiesFormatResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
