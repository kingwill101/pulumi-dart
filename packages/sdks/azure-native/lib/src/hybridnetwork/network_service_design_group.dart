...
/// }
///
/// resource "azure-native_hybridnetwork_networkservicedesigngroup" "networkServiceDesignGroup" {
///   location                          = "eastus"
...
class NetworkServiceDesignGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NetworkServiceDesignGroupPropertiesFormatResponse> properties;
  ...
  NetworkServiceDesignGroup(
    ...
    properties = registerOutput<NetworkServiceDesignGroupPropertiesFormatResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NetworkServiceDesignGroupPropertiesFormatResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [NetworkServiceDesignGroup] resource.
  NetworkServiceDesignGroup.reference(String urn)
    : super(
        'azure-native:hybridnetwork:NetworkServiceDesignGroup',
