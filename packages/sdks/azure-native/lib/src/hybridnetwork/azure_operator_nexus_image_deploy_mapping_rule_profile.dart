...
class AzureOperatorNexusImageDeployMappingRuleProfile {
  ...
  final ImageMappingRuleProfile? imageMappingRuleProfile;
  ...
  factory AzureOperatorNexusImageDeployMappingRuleProfile.fromMap(Map<String, dynamic> map) {
    return AzureOperatorNexusImageDeployMappingRuleProfile(
      ...
      imageMappingRuleProfile: map['imageMappingRuleProfile'] == null ? null : ImageMappingRuleProfile.fromMap((map['imageMappingRuleProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
