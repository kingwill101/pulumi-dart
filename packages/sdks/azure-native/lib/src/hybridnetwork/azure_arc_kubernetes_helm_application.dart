...
class AzureArcKubernetesHelmApplication {
  ...
  final pulumi.Input<AzureArcKubernetesDeployMappingRuleProfile>?
    ...
    return AzureArcKubernetesHelmApplication(
      artifactProfile: (() {
        ...
        return pulumi.Input.fromValue(
          AzureArcKubernetesArtifactProfile.fromMap(
      ...
      deployParametersMappingRuleProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureArcKubernetesDeployMappingRuleProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
