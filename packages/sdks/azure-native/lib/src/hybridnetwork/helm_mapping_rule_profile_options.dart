...
class HelmMappingRuleProfileOptions {
  ...
  factory HelmMappingRuleProfileOptions.fromMap(Map<String, dynamic> map) {
    return HelmMappingRuleProfileOptions(
      installOptions: (() { final guardedValue = map['installOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HelmInstallOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      upgradeOptions: (() { final guardedValue = map['upgradeOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HelmUpgradeOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
