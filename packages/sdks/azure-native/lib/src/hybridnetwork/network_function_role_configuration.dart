...
class NetworkFunctionRoleConfiguration {
  ...
  final pulumi.Input<dynamic>? virtualMachineSize;
  ...
  const NetworkFunctionRoleConfiguration({
    this.customProfile,
  ...
  factory NetworkFunctionRoleConfiguration.fromMap(Map<String, dynamic> map) {
    return NetworkFunctionRoleConfiguration(
      customProfile: (() { final guardedValue = map['customProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      virtualMachineSize: (() { final guardedValue = map['virtualMachineSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
