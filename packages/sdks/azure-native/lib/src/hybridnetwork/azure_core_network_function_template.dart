...
class AzureCoreNetworkFunctionTemplate {
  ...
  final List<AzureCoreNetworkFunctionArmTemplateApplication>? networkFunctionApplications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'networkFunctionApplications': ?networkFunctionApplications == null ? null : pulumi.Input.encodeList<AzureCoreNetworkFunctionArmTemplateApplication, Map<String, dynamic>>(networkFunctionApplications!, (value) => value.toMap()),
      'nfviType': nfviType,
    };
  }
  ...
  factory AzureCoreNetworkFunctionTemplate.fromMap(Map<String, dynamic> map) {
    return AzureCoreNetworkFunctionTemplate(
      networkFunctionApplications: map['networkFunctionApplications'] == null ? null : pulumi.Input.decodeList<AzureCoreNetworkFunctionArmTemplateApplication>(map['networkFunctionApplications'], (value) => AzureCoreNetworkFunctionArmTemplateApplication.fromMap((value as Map).cast<String, dynamic>())),
