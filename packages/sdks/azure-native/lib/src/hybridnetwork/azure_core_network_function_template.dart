...
class AzureCoreNetworkFunctionTemplate {
  ...
  factory AzureCoreNetworkFunctionTemplate.fromMap(Map<String, dynamic> map) {
    return AzureCoreNetworkFunctionTemplate(
      networkFunctionApplications: (() { final guardedValue = map['networkFunctionApplications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AzureCoreNetworkFunctionArmTemplateApplication>(guardedValue, (value) => AzureCoreNetworkFunctionArmTemplateApplication.fromMap((value as Map).cast<String, dynamic>()))); })(),
