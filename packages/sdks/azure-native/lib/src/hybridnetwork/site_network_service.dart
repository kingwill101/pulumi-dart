...
class SiteNetworkService extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SiteNetworkServicePropertiesFormatResponse>
  properties;
  ...
  SiteNetworkService(
    ...
    properties = registerOutput<SiteNetworkServicePropertiesFormatResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return SiteNetworkServicePropertiesFormatResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
