...
class ArtifactManifestPropertiesFormat {
  ...
  factory ArtifactManifestPropertiesFormat.fromMap(Map<String, dynamic> map) {
    return ArtifactManifestPropertiesFormat(
      artifacts: (() { final guardedValue = map['artifacts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManifestArtifactFormat>(guardedValue, (value) => ManifestArtifactFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
