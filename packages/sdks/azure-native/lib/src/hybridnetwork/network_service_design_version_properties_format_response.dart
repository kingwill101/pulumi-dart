...
class NetworkServiceDesignVersionPropertiesFormatResponse {
  ...
  factory NetworkServiceDesignVersionPropertiesFormatResponse.fromMap(Map<String, dynamic> map) {
    return NetworkServiceDesignVersionPropertiesFormatResponse(
      configurationGroupSchemaReferences: (() { final guardedValue = map['configurationGroupSchemaReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ReferencedResourceResponse>(guardedValue, (value) => ReferencedResourceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nfvisFromSite: (() { final guardedValue = map['nfvisFromSite']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<NfviDetailsResponse>(guardedValue, (value) => NfviDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      resourceElementTemplates: (() { final guardedValue = map['resourceElementTemplates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ArmResourceDefinitionResourceElementTemplateDetailsResponse>(guardedValue, (value) => ArmResourceDefinitionResourceElementTemplateDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
