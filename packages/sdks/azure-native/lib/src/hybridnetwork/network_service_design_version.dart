...
class NetworkServiceDesignVersion extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NetworkServiceDesignVersionPropertiesFormatResponse>
  properties;
  ...
  NetworkServiceDesignVersion(
    ...
    properties =
        registerOutput<NetworkServiceDesignVersionPropertiesFormatResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return NetworkServiceDesignVersionPropertiesFormatResponse.fromMap(
