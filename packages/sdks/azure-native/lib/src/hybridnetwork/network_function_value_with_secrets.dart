...
class NetworkFunctionValueWithSecrets {
  ...
  factory NetworkFunctionValueWithSecrets.fromMap(Map<String, dynamic> map) {
    return NetworkFunctionValueWithSecrets(
      ...
      networkFunctionDefinitionVersionResourceReference: (() { final guardedValue = map['networkFunctionDefinitionVersionResourceReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      nfviType: (() { final guardedValue = map['nfviType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      publisherScope: (() { final guardedValue = map['publisherScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
