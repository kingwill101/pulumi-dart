...
class HelmInstallOptionsResponse {
  ...
  const HelmInstallOptionsResponse({
    this.atomic,
    this.timeout,
    this.wait,
  });
  ...
  factory HelmInstallOptionsResponse.fromMap(Map<String, dynamic> map) {
    return HelmInstallOptionsResponse(
      atomic: (() { final guardedValue = map['atomic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
