...
class ListQueryKeyBySearchServiceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': nextLink,
      'value': pulumi.Input.encodeList<QueryKeyResponse, Map<String, dynamic>>(
        value,
        (value) => value.toMap(),
      ),
    };
  ...
  factory ListQueryKeyBySearchServiceResult.fromMap(Map<String, dynamic> map) {
    return ListQueryKeyBySearchServiceResult(
      ...
      value: pulumi.Input.decodeList<QueryKeyResponse>(
        map['value']!,
        (value) =>
            QueryKeyResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
