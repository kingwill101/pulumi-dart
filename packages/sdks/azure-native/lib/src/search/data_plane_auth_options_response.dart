...
class DataPlaneAuthOptionsResponse {
  ...
  DataPlaneAuthOptionsResponse({this.aadOrApiKey, this.apiKeyOnly});
  ...
  factory DataPlaneAuthOptionsResponse.fromMap(Map<String, dynamic> map) {
    return DataPlaneAuthOptionsResponse(
      aadOrApiKey: (() {
        final guardedValue = map['aadOrApiKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataPlaneAadOrApiKeyAuthOptionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      apiKeyOnly: (() {
        final guardedValue = map['apiKeyOnly'];
        if (guardedValue == null) return null;
