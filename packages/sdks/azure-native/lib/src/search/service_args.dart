...
class ServiceArgs {
    ...
    return <String, dynamic>{
      ...
      'encryptionWithCmk':
          ?pulumi.Input.mapOptionalInputValue<
            EncryptionWithCmk,
            Map<String, dynamic>
          >(encryptionWithCmk, (value) => value.toMap()),
      'endpoint': ?endpoint,
      'hostingMode': ?pulumi.Input.mapOptionalInputValue<HostingMode, String>(
        hostingMode,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      authOptions: (() {
        final guardedValue = map['authOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataPlaneAuthOptions.fromMap(
      ...
      dataExfiltrationProtections: (() {
        final guardedValue = map['dataExfiltrationProtections'];
        if (guardedValue == null) return null;
      ...
      encryptionWithCmk: (() {
        final guardedValue = map['encryptionWithCmk'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EncryptionWithCmk.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      hostingMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HostingMode.fromValue(guardedValue as String),
        );
      })(),
      identity: (() {
      ...
      searchServiceName: (() {
        final guardedValue = map['searchServiceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      semanticSearch: (() {
        final guardedValue = map['semanticSearch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sku: (() {
      ...
      upgradeAvailable: (() {
        final guardedValue = map['upgradeAvailable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
