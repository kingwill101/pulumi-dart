...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      authOptions: map['authOptions'] == null ? null : (DataPlaneAuthOptions.fromMap((map['authOptions']! as Map).cast<String, dynamic>())).input(),
      computeType: map['computeType'] == null ? null : (map['computeType']! as String).input(),
      dataExfiltrationProtections: map['dataExfiltrationProtections'] == null ? null : ((map['dataExfiltrationProtections']! as List).cast<String>()).input(),
      disableLocalAuth: map['disableLocalAuth'] == null ? null : (map['disableLocalAuth']! as bool).input(),
      encryptionWithCmk: map['encryptionWithCmk'] == null ? null : (EncryptionWithCmk.fromMap((map['encryptionWithCmk']! as Map).cast<String, dynamic>())).input(),
      endpoint: map['endpoint'] == null ? null : (map['endpoint']! as String).input(),
      hostingMode: map['hostingMode'] == null ? null : (HostingMode.fromValue(map['hostingMode']! as String)).input(),
      ...
      searchServiceName: map['searchServiceName'] == null ? null : (map['searchServiceName']! as String).input(),
      semanticSearch: map['semanticSearch'] == null ? null : (map['semanticSearch']! as String).input(),
      sku: map['sku'] == null ? null : (Sku.fromMap((map['sku']! as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      upgradeAvailable: map['upgradeAvailable'] == null ? null : (map['upgradeAvailable']! as String).input(),
    );
  }
}
