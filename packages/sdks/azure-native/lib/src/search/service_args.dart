...
class ServiceArgs {
  ...
  final pulumi.Input<List<dynamic>?>? dataExfiltrationProtections;
  ...
  ServiceArgs({
    ...
    this.endpoint,
    pulumi.Input<HostingMode?>? hostingMode,
    this.identity,
    this.location,
    this.networkRuleSet,
    pulumi.Input<int?>? partitionCount,
  ...
  }) : hostingMode = hostingMode ?? pulumi.Input.fromValue(HostingMode.fromValue('Default')), partitionCount = partitionCount ?? pulumi.Input.fromValue(1), publicNetworkAccess = publicNetworkAccess ?? pulumi.Input.fromValue('Enabled'), replicaCount = replicaCount ?? pulumi.Input.fromValue(1);
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      dataExfiltrationProtections: (() { final guardedValue = map['dataExfiltrationProtections']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      ...
      semanticSearch: (() { final guardedValue = map['semanticSearch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      upgradeAvailable: (() { final guardedValue = map['upgradeAvailable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
