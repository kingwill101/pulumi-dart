...
class CIAMTenantArgs {
    ...
    return <String, dynamic>{
      'createTenantProperties':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(createTenantProperties, (value) => value.toMap()),
      'location': ?location,
      'resourceGroupName': resourceGroupName,
      'resourceName': ?resourceName,
      'sku': pulumi.Input.mapInputValue<CIAMResourceSKU, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
      'tags': ?tags,
  ...
  factory CIAMTenantArgs.fromMap(Map<String, dynamic> map) {
    return CIAMTenantArgs(
      createTenantProperties: pulumi.Input.fromValue(
        CreateCIAMTenantProperties.fromMap(
          (map['createTenantProperties']! as Map).cast<String, dynamic>(),
        ),
      ),
      location: (() {
      ...
      sku: pulumi.Input.fromValue(
        CIAMResourceSKU.fromMap((map['sku']! as Map).cast<String, dynamic>()),
      ),
      tags: (() {
