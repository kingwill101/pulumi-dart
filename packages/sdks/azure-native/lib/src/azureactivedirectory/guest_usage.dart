...
/// }
///
/// resource "azure-native_azureactivedirectory_guestusage" "guestUsage" {
...
class GuestUsage extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [GuestUsage] resource.
  GuestUsage.reference(String urn)
    : super(
        'azure-native:azureactivedirectory:GuestUsage',
