...
class KubernetesClusterInfoResponse {
  ...
  factory KubernetesClusterInfoResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterInfoResponse(
      etcdInfo: pulumi.Input.fromValue(EtcdInfoResponse.fromMap((map['etcdInfo']! as Map).cast<String, dynamic>())),
      nodes: pulumi.Input.fromValue(pulumi.Input.decodeList<NodeInfoResponse>(map['nodes']!, (value) => NodeInfoResponse.fromMap((value as Map).cast<String, dynamic>()))),
