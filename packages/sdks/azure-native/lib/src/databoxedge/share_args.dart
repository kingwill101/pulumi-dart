    ...
    return <String, dynamic>{
      ...
      'azureContainerInfo':
          ?pulumi.Input.mapOptionalInputValue<
            AzureContainerInfo,
            Map<String, dynamic>
          >(azureContainerInfo, (value) => value.toMap()),
      'clientAccessRights':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'refreshDetails':
          ?pulumi.Input.mapOptionalInputValue<
            RefreshDetails,
            Map<String, dynamic>
          >(refreshDetails, (value) => value.toMap()),
      ...
      'userAccessRights':
          ...
          >(
            userAccessRights,
            (value) =>
                pulumi.Input.encodeList<UserAccessRight, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ShareArgs.fromMap(Map<String, dynamic> map) {
    return ShareArgs(
      ...
      clientAccessRights: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClientAccessRight>(
            guardedValue,
            (value) => ClientAccessRight.fromMap(
      ...
      monitoringStatus: pulumi.Input.fromValue(
        map['monitoringStatus'] as String,
      ),
      name: (() {
      ...
      refreshDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RefreshDetails.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      userAccessRights: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserAccessRight>(
            guardedValue,
            (value) =>
                UserAccessRight.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
