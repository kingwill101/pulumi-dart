...
class FileEventTriggerArgs {
  ...
  factory FileEventTriggerArgs.fromMap(Map<String, dynamic> map) {
    return FileEventTriggerArgs(
      customContextTag: (() { final guardedValue = map['customContextTag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deviceName: pulumi.Input.fromValue(map['deviceName'] as String),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      sinkInfo: pulumi.Input.fromValue(RoleSinkInfo.fromMap((map['sinkInfo']! as Map).cast<String, dynamic>())),
      sourceInfo: pulumi.Input.fromValue(FileSourceInfo.fromMap((map['sourceInfo']! as Map).cast<String, dynamic>())),
    );
  }
}
