...
class MetricCounter {
  ...
  factory MetricCounter.fromMap(Map<String, dynamic> map) {
    return MetricCounter(
      additionalDimensions: (() { final guardedValue = map['additionalDimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricDimension>(guardedValue, (value) => MetricDimension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dimensionFilter: (() { final guardedValue = map['dimensionFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricDimension>(guardedValue, (value) => MetricDimension.fromMap((value as Map).cast<String, dynamic>()))); })(),
