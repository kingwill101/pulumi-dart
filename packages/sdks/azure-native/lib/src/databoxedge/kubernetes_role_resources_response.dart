...
class KubernetesRoleResourcesResponse {
  ...
  factory KubernetesRoleResourcesResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesRoleResourcesResponse(
      compute: pulumi.Input.fromValue(KubernetesRoleComputeResponse.fromMap((map['compute']! as Map).cast<String, dynamic>())),
      network: pulumi.Input.fromValue(KubernetesRoleNetworkResponse.fromMap((map['network']! as Map).cast<String, dynamic>())),
      storage: (() { final guardedValue = map['storage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesRoleStorageResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
