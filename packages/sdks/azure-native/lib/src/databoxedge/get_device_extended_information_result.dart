...
class GetDeviceExtendedInformationResult {
  ...
  factory GetDeviceExtendedInformationResult.fromMap(Map<String, dynamic> map) {
    return GetDeviceExtendedInformationResult(
      channelIntegrityKeyName: map['channelIntegrityKeyName'] == null ? null : map['channelIntegrityKeyName']! as String,
      channelIntegrityKeyVersion: map['channelIntegrityKeyVersion'] == null ? null : map['channelIntegrityKeyVersion']! as String,
      clientSecretStoreId: map['clientSecretStoreId'] == null ? null : map['clientSecretStoreId']! as String,
      clientSecretStoreUrl: map['clientSecretStoreUrl'] == null ? null : map['clientSecretStoreUrl']! as String,
      ...
      encryptionKeyThumbprint: map['encryptionKeyThumbprint'] == null ? null : map['encryptionKeyThumbprint']! as String,
      ...
      id: map['id'] as String,
      keyVaultSyncStatus: map['keyVaultSyncStatus'] == null ? null : map['keyVaultSyncStatus']! as String,
