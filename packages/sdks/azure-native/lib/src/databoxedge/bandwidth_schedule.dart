...
class BandwidthSchedule extends pulumi.CustomResource {
  ...
  BandwidthSchedule(
    ...
    days = registerOutput<List<String>>('days', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
  ...
  /// Creates a typed reference to an existing [BandwidthSchedule] resource.
  BandwidthSchedule.reference(String urn)
    : super(
        'azure-native:databoxedge:BandwidthSchedule',
