...
class GetShareResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientAccessRights': ?(() { final guardedValue = clientAccessRights; if (guardedValue == null) return null; return pulumi.Input.encodeList<ClientAccessRightResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'type': ?type,
      'userAccessRights': ?(() { final guardedValue = userAccessRights; if (guardedValue == null) return null; return pulumi.Input.encodeList<UserAccessRightResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }

  factory GetShareResult.fromMap(Map<String, dynamic> map) {
    return GetShareResult(
      accessProtocol: (() { final guardedValue = map['accessProtocol']; if (guardedValue == null) return null; return guardedValue as String; })(),
      azureApiVersion: (() { final guardedValue = map['azureApiVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      azureContainerInfo: (() { final guardedValue = map['azureContainerInfo']; if (guardedValue == null) return null; return AzureContainerInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      clientAccessRights: (() { final guardedValue = map['clientAccessRights']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ClientAccessRightResponse>(guardedValue, (value) => ClientAccessRightResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      userAccessRights: (() { final guardedValue = map['userAccessRights']; if (guardedValue == null) return null; return pulumi.Input.decodeList<UserAccessRightResponse>(guardedValue, (value) => UserAccessRightResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
