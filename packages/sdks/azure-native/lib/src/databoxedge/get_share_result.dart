...
class GetShareResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'azureContainerInfo': ?azureContainerInfo == null ? null : azureContainerInfo!.toMap(),
      'clientAccessRights': ?clientAccessRights == null ? null : pulumi.Input.encodeList<ClientAccessRightResponse, Map<String, dynamic>>(clientAccessRights!, (value) => value.toMap()),
      'dataPolicy': ?dataPolicy,
      'description': ?description,
      'id': id,
      'monitoringStatus': monitoringStatus,
      'name': name,
      'refreshDetails': ?refreshDetails == null ? null : refreshDetails!.toMap(),
      'shareMappings': pulumi.Input.encodeList<MountPointMapResponse, Map<String, dynamic>>(shareMappings, (value) => value.toMap()),
      'shareStatus': shareStatus,
      'systemData': systemData.toMap(),
      'type': type,
      'userAccessRights': ?userAccessRights == null ? null : pulumi.Input.encodeList<UserAccessRightResponse, Map<String, dynamic>>(userAccessRights!, (value) => value.toMap()),
    };
  }
