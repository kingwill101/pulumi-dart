...
class EdgeProfileSubscriptionResponse {
  ...
  factory EdgeProfileSubscriptionResponse.fromMap(Map<String, dynamic> map) {
    return EdgeProfileSubscriptionResponse(
      ...
      registeredFeatures: (() { final guardedValue = map['registeredFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubscriptionRegisteredFeaturesResponse>(guardedValue, (value) => SubscriptionRegisteredFeaturesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serializedDetails: (() { final guardedValue = map['serializedDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
