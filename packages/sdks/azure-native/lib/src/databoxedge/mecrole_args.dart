...
class MECRoleArgs {
  ...
  factory MECRoleArgs.fromMap(Map<String, dynamic> map) {
    return MECRoleArgs(
      connectionString: (() { final guardedValue = map['connectionString']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AsymmetricEncryptedSecret.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      controllerEndpoint: (() { final guardedValue = map['controllerEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
