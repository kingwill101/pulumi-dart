...
class NodeInfoResponse {
  ...
  factory NodeInfoResponse.fromMap(Map<String, dynamic> map) {
    return NodeInfoResponse(
      ipConfiguration: (() { final guardedValue = map['ipConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KubernetesIPConfigurationResponse>(guardedValue, (value) => KubernetesIPConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
