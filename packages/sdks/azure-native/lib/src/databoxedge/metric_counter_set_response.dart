...
class MetricCounterSetResponse {
  ...
  MetricCounterSetResponse({required this.counters});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'counters':
          pulumi.Input.mapInputValue<
            List<MetricCounterResponse>,
  ...
  factory MetricCounterSetResponse.fromMap(Map<String, dynamic> map) {
    return MetricCounterSetResponse(
      counters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MetricCounterResponse>(
          map['counters']!,
          (value) => MetricCounterResponse.fromMap(
