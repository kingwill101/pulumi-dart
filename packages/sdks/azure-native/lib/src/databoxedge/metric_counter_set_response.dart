...
class MetricCounterSetResponse {
  ...
  const MetricCounterSetResponse({
  ...
  factory MetricCounterSetResponse.fromMap(Map<String, dynamic> map) {
    return MetricCounterSetResponse(
      counters: pulumi.Input.fromValue(pulumi.Input.decodeList<MetricCounterResponse>(map['counters']!, (value) => MetricCounterResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
