...
class GetDeviceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataResidency': ?dataResidency == null ? null : dataResidency!.toMap(),
  ...
  factory GetDeviceResult.fromMap(Map<String, dynamic> map) {
    return GetDeviceResult(
      ...
      dataResidency: map['dataResidency'] == null ? null : DataResidencyResponse.fromMap((map['dataResidency']! as Map).cast<String, dynamic>()),
