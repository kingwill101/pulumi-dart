...
class GetDeviceResult {
  ...
  const GetDeviceResult({
    ...
    this.culture,
    this.dataBoxEdgeDeviceStatus,
    this.dataResidency,
    this.description,
    this.deviceHcsVersion,
    ...
    this.identity,
    this.kind,
    this.kubernetesWorkloadProfile,
    this.location,
    this.modelDescription,
    this.name,
    this.nodeCount,
    this.resourceMoveDetails,
    this.serialNumber,
    this.sku,
    this.systemData,
    this.tags,
  ...
  factory GetDeviceResult.fromMap(Map<String, dynamic> map) {
    return GetDeviceResult(
      ...
      configuredRoleTypes: (() { final guardedValue = map['configuredRoleTypes']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      culture: (() { final guardedValue = map['culture']; if (guardedValue == null) return null; return guardedValue as String; })(),
      dataBoxEdgeDeviceStatus: (() { final guardedValue = map['dataBoxEdgeDeviceStatus']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      deviceHcsVersion: (() { final guardedValue = map['deviceHcsVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      deviceLocalCapacity: (() { final guardedValue = map['deviceLocalCapacity']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      deviceModel: (() { final guardedValue = map['deviceModel']; if (guardedValue == null) return null; return guardedValue as String; })(),
      deviceSoftwareVersion: (() { final guardedValue = map['deviceSoftwareVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      kubernetesWorkloadProfile: (() { final guardedValue = map['kubernetesWorkloadProfile']; if (guardedValue == null) return null; return guardedValue as String; })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return guardedValue as String; })(),
      modelDescription: (() { final guardedValue = map['modelDescription']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      resourceMoveDetails: (() { final guardedValue = map['resourceMoveDetails']; if (guardedValue == null) return null; return ResourceMoveDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
