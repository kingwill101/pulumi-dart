...
class SapLandscapeMonitorSidMappingResponse {
  ...
  SapLandscapeMonitorSidMappingResponse({this.name, this.topSid});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'name': ?name, 'topSid': ?topSid};
  }

  factory SapLandscapeMonitorSidMappingResponse.fromMap(
