...
class SapLandscapeMonitorPropertiesGrouping {
  ...
  SapLandscapeMonitorPropertiesGrouping({this.landscape, this.sapApplication});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'landscape':
          ?pulumi.Input.mapOptionalInputValue<
            List<SapLandscapeMonitorSidMapping>,
  ...
  factory SapLandscapeMonitorPropertiesGrouping.fromMap(
    ...
    return SapLandscapeMonitorPropertiesGrouping(
      landscape: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SapLandscapeMonitorSidMapping>(
            guardedValue,
            (value) => SapLandscapeMonitorSidMapping.fromMap(
