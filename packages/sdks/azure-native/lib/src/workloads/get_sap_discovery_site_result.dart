...
class GetSapDiscoverySiteResult {
  ...
  const GetSapDiscoverySiteResult({
  ...
  factory GetSapDiscoverySiteResult.fromMap(Map<String, dynamic> map) {
    return GetSapDiscoverySiteResult(
      ...
      errors: (() { final guardedValue = map['errors']; if (guardedValue == null) return null; return SAPMigrateErrorResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
