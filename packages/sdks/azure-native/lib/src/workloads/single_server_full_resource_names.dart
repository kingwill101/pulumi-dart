...
class SingleServerFullResourceNames {
  ...
  const SingleServerFullResourceNames({
  ...
  factory SingleServerFullResourceNames.fromMap(Map<String, dynamic> map) {
    return SingleServerFullResourceNames(
      ...
      virtualMachine: (() { final guardedValue = map['virtualMachine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineResourceNames.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
