...
class VirtualMachineResourceNames {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostName': ?hostName,
      'networkInterfaces': ?pulumi.Input.mapOptionalInputValue<List<NetworkInterfaceResourceNames>, List<Map<String, dynamic>>>(networkInterfaces, (value) => pulumi.Input.encodeList<NetworkInterfaceResourceNames, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory VirtualMachineResourceNames.fromMap(Map<String, dynamic> map) {
    return VirtualMachineResourceNames(
      ...
      networkInterfaces: (() { final guardedValue = map['networkInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaceResourceNames>(guardedValue, (value) => NetworkInterfaceResourceNames.fromMap((value as Map).cast<String, dynamic>()))); })(),
