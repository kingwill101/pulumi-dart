...
class DiskConfigurationResponse {
  ...
  final pulumi.Input<Map<String, DiskVolumeConfigurationResponse>>?
  ...
  DiskConfigurationResponse({this.diskVolumeConfigurations});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diskVolumeConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, DiskVolumeConfigurationResponse>,
    ...
    return DiskConfigurationResponse(
      diskVolumeConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<DiskVolumeConfigurationResponse>(
            guardedValue,
            (value) => DiskVolumeConfigurationResponse.fromMap(
