...
class DiskConfigurationResponse {
  ...
  factory DiskConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return DiskConfigurationResponse(
      diskVolumeConfigurations: (() { final guardedValue = map['diskVolumeConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<DiskVolumeConfigurationResponse>(guardedValue, (value) => DiskVolumeConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
