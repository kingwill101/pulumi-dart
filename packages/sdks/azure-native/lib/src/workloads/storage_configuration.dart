...
class StorageConfiguration {
  ...
  final pulumi.Input<CreateAndMountFileShareConfiguration>?
  ...
  StorageConfiguration({this.transportFileShareConfiguration});
    ...
    return <String, dynamic>{
      'transportFileShareConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(transportFileShareConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory StorageConfiguration.fromMap(Map<String, dynamic> map) {
    return StorageConfiguration(
      transportFileShareConfiguration: (() {
        final guardedValue = map['transportFileShareConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CreateAndMountFileShareConfiguration.fromMap(
