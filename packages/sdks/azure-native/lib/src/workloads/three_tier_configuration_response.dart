...
class ThreeTierConfigurationResponse {
  ...
  final pulumi.Input<HighAvailabilityConfigurationResponse>?
  ...
  factory ThreeTierConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ThreeTierConfigurationResponse(
      ...
      applicationServer: pulumi.Input.fromValue(
        ApplicationServerConfigurationResponse.fromMap(
          (map['applicationServer']! as Map).cast<String, dynamic>(),
        ),
      ),
      centralServer: pulumi.Input.fromValue(
        CentralServerConfigurationResponse.fromMap(
      ...
      customResourceNames: (() {
        ...
        return pulumi.Input.fromValue(
          ThreeTierFullResourceNamesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      databaseServer: pulumi.Input.fromValue(
        DatabaseConfigurationResponse.fromMap(
      ...
      highAvailabilityConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HighAvailabilityConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
