...
class ThreeTierConfigurationResponse {
  ...
  factory ThreeTierConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ThreeTierConfigurationResponse(
      ...
      applicationServer: pulumi.Input.fromValue(ApplicationServerConfigurationResponse.fromMap((map['applicationServer']! as Map).cast<String, dynamic>())),
      centralServer: pulumi.Input.fromValue(CentralServerConfigurationResponse.fromMap((map['centralServer']! as Map).cast<String, dynamic>())),
      customResourceNames: (() { final guardedValue = map['customResourceNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ThreeTierFullResourceNamesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      databaseServer: pulumi.Input.fromValue(DatabaseConfigurationResponse.fromMap((map['databaseServer']! as Map).cast<String, dynamic>())),
      deploymentType: pulumi.Input.fromValue(map['deploymentType'] as String),
      highAvailabilityConfig: (() { final guardedValue = map['highAvailabilityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HighAvailabilityConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageConfiguration: (() { final guardedValue = map['storageConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
