...
class ConnectorArgs {
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserAssignedServiceIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
