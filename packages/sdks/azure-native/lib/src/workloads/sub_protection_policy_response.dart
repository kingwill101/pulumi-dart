...
class SubProtectionPolicyResponse {
  ...
  factory SubProtectionPolicyResponse.fromMap(Map<String, dynamic> map) {
    return SubProtectionPolicyResponse(
      ...
      snapshotBackupAdditionalDetails: (() { final guardedValue = map['snapshotBackupAdditionalDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapshotBackupAdditionalDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
