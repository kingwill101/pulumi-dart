...
class DiskDetailsResponse {
  ...
  factory DiskDetailsResponse.fromMap(Map<String, dynamic> map) {
    return DiskDetailsResponse(
      ...
      iopsReadWrite: (() { final guardedValue = map['iopsReadWrite']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      maximumSupportedDiskCount: (() { final guardedValue = map['maximumSupportedDiskCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      mbpsReadWrite: (() { final guardedValue = map['mbpsReadWrite']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      minimumSupportedDiskCount: (() { final guardedValue = map['minimumSupportedDiskCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
