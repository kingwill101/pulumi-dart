...
class VirtualMachineResourceNamesResponse {
  ...
  final Map<String, List<String>>? dataDiskNames;
  ...
  final List<NetworkInterfaceResourceNamesResponse>? networkInterfaces;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostName': ?hostName,
      'networkInterfaces': ?networkInterfaces == null ? null : pulumi.Input.encodeList<NetworkInterfaceResourceNamesResponse, Map<String, dynamic>>(networkInterfaces!, (value) => value.toMap()),
  ...
  factory VirtualMachineResourceNamesResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineResourceNamesResponse(
      dataDiskNames: map['dataDiskNames'] == null ? null : (map['dataDiskNames'] as Map).cast<String, List<String>>(),
      hostName: map['hostName'] == null ? null : map['hostName'] as String,
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<NetworkInterfaceResourceNamesResponse>(map['networkInterfaces'], (value) => NetworkInterfaceResourceNamesResponse.fromMap((value as Map).cast<String, dynamic>())),
