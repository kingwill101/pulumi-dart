...
class VirtualMachineResourceNamesResponse {
  ...
  final pulumi.Input<List<NetworkInterfaceResourceNamesResponse>>?
  networkInterfaces;
    ...
    return <String, dynamic>{
      ...
      'networkInterfaces':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkInterfaceResourceNamesResponse>,
  ...
  factory VirtualMachineResourceNamesResponse.fromMap(
    ...
    return VirtualMachineResourceNamesResponse(
      ...
      networkInterfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkInterfaceResourceNamesResponse>(
            guardedValue,
            (value) => NetworkInterfaceResourceNamesResponse.fromMap(
