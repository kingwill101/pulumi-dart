...
/// Error definition.
class ErrorDefinitionSapDiscoverySiteResponse {
  ...
  /// Creates a new [ErrorDefinitionSapDiscoverySiteResponse].
  ...
  const ErrorDefinitionSapDiscoverySiteResponse({
    required this.code,
  ...
  factory ErrorDefinitionSapDiscoverySiteResponse.fromMap(Map<String, dynamic> map) {
    return ErrorDefinitionSapDiscoverySiteResponse(
