...
class ThreeTierFullResourceNamesResponse {
  ...
  const ThreeTierFullResourceNamesResponse({
  ...
  factory ThreeTierFullResourceNamesResponse.fromMap(Map<String, dynamic> map) {
    return ThreeTierFullResourceNamesResponse(
      applicationServer: (() { final guardedValue = map['applicationServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationServerFullResourceNamesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      centralServer: (() { final guardedValue = map['centralServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CentralServerFullResourceNamesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      databaseServer: (() { final guardedValue = map['databaseServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabaseServerFullResourceNamesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      namingPatternType: pulumi.Input.fromValue(map['namingPatternType'] as String),
      sharedStorage: (() { final guardedValue = map['sharedStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SharedStorageResourceNamesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
