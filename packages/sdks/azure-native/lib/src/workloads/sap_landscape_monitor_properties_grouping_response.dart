...
class SapLandscapeMonitorPropertiesGroupingResponse {
  ...
  final pulumi.Input<List<SapLandscapeMonitorSidMappingResponse>>?
  sapApplication;
    ...
    return <String, dynamic>{
      'landscape':
          ?pulumi.Input.mapOptionalInputValue<
            List<SapLandscapeMonitorSidMappingResponse>,
  ...
  factory SapLandscapeMonitorPropertiesGroupingResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return SapLandscapeMonitorPropertiesGroupingResponse(
      landscape: (() {
        final guardedValue = map['landscape'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SapLandscapeMonitorSidMappingResponse>(
            guardedValue,
            (value) => SapLandscapeMonitorSidMappingResponse.fromMap(
      ...
      sapApplication: (() {
        final guardedValue = map['sapApplication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SapLandscapeMonitorSidMappingResponse>(
            guardedValue,
