...
class GetSapApplicationServerInstanceResult {
  ...
  factory GetSapApplicationServerInstanceResult.fromMap(
    ...
    return GetSapApplicationServerInstanceResult(
      ...
      vmDetails: pulumi.Input.decodeList<ApplicationServerVmDetailsResponse>(
        map['vmDetails']!,
        (value) => ApplicationServerVmDetailsResponse.fromMap(
