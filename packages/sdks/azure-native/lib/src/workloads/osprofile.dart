...
class OSProfile {
  ...
  factory OSProfile.fromMap(Map<String, dynamic> map) {
    return OSProfile(
      ...
      osConfiguration: (() { final guardedValue = map['osConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
