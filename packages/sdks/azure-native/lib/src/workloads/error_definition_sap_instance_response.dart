...
/// Error definition.
class ErrorDefinitionSapInstanceResponse {
  ...
  /// Creates a new [ErrorDefinitionSapInstanceResponse].
  ...
  const ErrorDefinitionSapInstanceResponse({
    required this.code,
  ...
  factory ErrorDefinitionSapInstanceResponse.fromMap(Map<String, dynamic> map) {
    return ErrorDefinitionSapInstanceResponse(
