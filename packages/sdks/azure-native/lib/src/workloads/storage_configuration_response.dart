...
class StorageConfigurationResponse {
  ...
  final pulumi.Input<CreateAndMountFileShareConfigurationResponse>?
  ...
  StorageConfigurationResponse({this.transportFileShareConfiguration});
    ...
    return StorageConfigurationResponse(
      transportFileShareConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          CreateAndMountFileShareConfigurationResponse.fromMap(
