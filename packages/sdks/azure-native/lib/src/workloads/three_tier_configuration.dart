...
class ThreeTierConfiguration {
  ...
  factory ThreeTierConfiguration.fromMap(Map<String, dynamic> map) {
    return ThreeTierConfiguration(
      ...
      applicationServer: pulumi.Input.fromValue(ApplicationServerConfiguration.fromMap((map['applicationServer']! as Map).cast<String, dynamic>())),
      centralServer: pulumi.Input.fromValue(CentralServerConfiguration.fromMap((map['centralServer']! as Map).cast<String, dynamic>())),
      customResourceNames: (() { final guardedValue = map['customResourceNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ThreeTierFullResourceNames.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      databaseServer: pulumi.Input.fromValue(DatabaseConfiguration.fromMap((map['databaseServer']! as Map).cast<String, dynamic>())),
      deploymentType: pulumi.Input.fromValue(map['deploymentType'] as String),
      highAvailabilityConfig: (() { final guardedValue = map['highAvailabilityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HighAvailabilityConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageConfiguration: (() { final guardedValue = map['storageConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
