...
class SSLConfiguration {
  ...
  final pulumi.Input<dynamic>? sslCryptoProvider;
  ...
  factory SSLConfiguration.fromMap(Map<String, dynamic> map) {
    return SSLConfiguration(
      sslCryptoProvider: (() { final guardedValue = map['sslCryptoProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
