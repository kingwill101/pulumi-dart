...
class AppServicePlanConfigurationResponse {
  ...
  AppServicePlanConfigurationResponse({this.capacity, this.tier});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'capacity': ?capacity, 'tier': ?tier};
  }

  factory AppServicePlanConfigurationResponse.fromMap(
