...
class YearlyRetentionSchedule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'monthsOfYear': ?pulumi.Input.mapOptionalInputValue<List<MonthOfYear>, List<String>>(monthsOfYear, (value) => pulumi.Input.encodeList<MonthOfYear, String>(value, (value) => value.wireValue)),
