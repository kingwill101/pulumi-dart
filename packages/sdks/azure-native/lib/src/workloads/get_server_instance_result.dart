...
class GetServerInstanceResult {
  ...
  factory GetServerInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetServerInstanceResult(
      ...
      configurationData: ConfigurationDataResponse.fromMap(
        (map['configurationData']! as Map).cast<String, dynamic>(),
      ),
      ...
      performanceData: ExcelPerformanceDataResponse.fromMap(
        (map['performanceData']! as Map).cast<String, dynamic>(),
      ),
