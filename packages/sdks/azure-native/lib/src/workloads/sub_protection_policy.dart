...
class SubProtectionPolicy {
  ...
  factory SubProtectionPolicy.fromMap(Map<String, dynamic> map) {
    return SubProtectionPolicy(
      ...
      snapshotBackupAdditionalDetails: (() { final guardedValue = map['snapshotBackupAdditionalDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapshotBackupAdditionalDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
