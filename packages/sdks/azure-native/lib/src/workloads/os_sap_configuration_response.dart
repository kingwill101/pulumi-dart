...
class OsSapConfigurationResponse {
  ...
  OsSapConfigurationResponse({this.deployerVmPackages, this.sapFqdn});
    ...
    return <String, dynamic>{
      'deployerVmPackages':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(deployerVmPackages, (value) => value.toMap()),
      'sapFqdn': ?sapFqdn,
    };
  }
  ...
  factory OsSapConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return OsSapConfigurationResponse(
      deployerVmPackages: (() {
        final guardedValue = map['deployerVmPackages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeployerVmPackagesResponse.fromMap(
