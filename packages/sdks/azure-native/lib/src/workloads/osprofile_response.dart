...
class OSProfileResponse {
  ...
  final pulumi.Input<LinuxConfigurationResponse>? osConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osConfiguration': ?pulumi.Input.mapOptionalInputValue<LinuxConfigurationResponse, Map<String, dynamic>>(osConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory OSProfileResponse.fromMap(Map<String, dynamic> map) {
    return OSProfileResponse(
      ...
      osConfiguration: (() { final guardedValue = map['osConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
