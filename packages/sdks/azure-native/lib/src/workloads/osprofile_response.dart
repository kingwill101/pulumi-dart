...
class OSProfileResponse {
  ...
  final pulumi.Input<dynamic>? osConfiguration;
  ...
  factory OSProfileResponse.fromMap(Map<String, dynamic> map) {
    return OSProfileResponse(
      ...
      osConfiguration: (() { final guardedValue = map['osConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
