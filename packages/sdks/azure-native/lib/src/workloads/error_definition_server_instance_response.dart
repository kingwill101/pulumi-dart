...
/// Error definition.
class ErrorDefinitionServerInstanceResponse {
  ...
  /// Creates a new [ErrorDefinitionServerInstanceResponse].
  ...
  const ErrorDefinitionServerInstanceResponse({
    required this.code,
  ...
  factory ErrorDefinitionServerInstanceResponse.fromMap(Map<String, dynamic> map) {
    return ErrorDefinitionServerInstanceResponse(
