...
class GetStorageContainerResult {
  ...
  final StorageContainerPropertiesResponse? properties;
  ...
  factory GetStorageContainerResult.fromMap(Map<String, dynamic> map) {
    return GetStorageContainerResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return StorageContainerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
