...
import 'bookshelf_args.dart';
import 'bookshelf_properties_response.dart';
...
class Bookshelf extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BookshelfPropertiesResponse> properties;
  ...
  /// [args] Arguments used to configure this [Bookshelf]. {@macro pulumi_discovery_bookshelf_args_doc}
  ...
  Bookshelf(
    ...
    properties = registerOutput<BookshelfPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BookshelfPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
