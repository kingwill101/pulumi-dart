...
/// Result data returned by getBookshelfPrivateEndpointConnection.
class GetBookshelfPrivateEndpointConnectionResult {
  ...
  /// Creates a new [GetBookshelfPrivateEndpointConnectionResult].
  ...
  const GetBookshelfPrivateEndpointConnectionResult({
  ...
  factory GetBookshelfPrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetBookshelfPrivateEndpointConnectionResult(
