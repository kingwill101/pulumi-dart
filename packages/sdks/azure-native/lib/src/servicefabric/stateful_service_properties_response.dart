...
class StatefulServicePropertiesResponse {
  ...
  /// A list that describes the correlation of the service with other services.
  final pulumi.Input<List<ServicePlacementInvalidDomainPolicyResponse>>?
    ...
    return <String, dynamic>{
      'correlationScheme':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceCorrelationResponse>,
      ...
      'serviceLoadMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceLoadMetricResponse>,
            List<Map<String, dynamic>>
          >(
            serviceLoadMetrics,
            (value) =>
      ...
      'servicePlacementPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServicePlacementInvalidDomainPolicyResponse>,
            List<Map<String, dynamic>>
          >(
            servicePlacementPolicies,
            (value) =>
    ...
    return StatefulServicePropertiesResponse(
      correlationScheme: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceCorrelationResponse>(
            guardedValue,
            (value) => ServiceCorrelationResponse.fromMap(
      ...
      hasPersistedState: (() {
        final guardedValue = map['hasPersistedState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      minReplicaSetSize: (() {
        final guardedValue = map['minReplicaSetSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      partitionDescription: pulumi.Input.fromValue(
        NamedPartitionSchemeResponse.fromMap(
      ...
      quorumLossWaitDuration: (() {
        final guardedValue = map['quorumLossWaitDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      replicaRestartWaitDuration: (() {
        final guardedValue = map['replicaRestartWaitDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      scalingPolicies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScalingPolicyResponse>(
            guardedValue,
            (value) => ScalingPolicyResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceLoadMetrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceLoadMetricResponse>(
            guardedValue,
            (value) => ServiceLoadMetricResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      servicePlacementPolicies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServicePlacementInvalidDomainPolicyResponse>(
            guardedValue,
            (value) => ServicePlacementInvalidDomainPolicyResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      servicePlacementTimeLimit: (() {
        final guardedValue = map['servicePlacementTimeLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceTypeName: pulumi.Input.fromValue(map['serviceTypeName'] as String),
      standByReplicaKeepDuration: (() {
        final guardedValue = map['standByReplicaKeepDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetReplicaSetSize: (() {
        final guardedValue = map['targetReplicaSetSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
