...
class FrontendConfigurationResponse {
  ...
  factory FrontendConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return FrontendConfigurationResponse(
      applicationGatewayBackendAddressPoolId: (() {
        final guardedValue = map['applicationGatewayBackendAddressPoolId'];
      ...
      loadBalancerBackendAddressPoolId: (() {
        final guardedValue = map['loadBalancerBackendAddressPoolId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loadBalancerInboundNatPoolId: (() {
        final guardedValue = map['loadBalancerInboundNatPoolId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
