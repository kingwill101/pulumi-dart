...
class ApplicationUpgradePolicy {
  ...
  final pulumi.Input<dynamic>? upgradeMode;
  ...
  factory ApplicationUpgradePolicy.fromMap(Map<String, dynamic> map) {
    return ApplicationUpgradePolicy(
      ...
      upgradeMode: (() { final guardedValue = map['upgradeMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
