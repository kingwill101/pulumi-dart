...
class UniformInt64RangePartitionSchemeResponse {
  ...
  /// Creates a new [UniformInt64RangePartitionSchemeResponse].
  ...
  factory UniformInt64RangePartitionSchemeResponse.fromMap(
