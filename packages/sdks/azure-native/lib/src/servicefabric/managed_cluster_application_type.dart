...
/// }
///
/// resource "azure-native_servicefabric_managedclusterapplicationtype" "managedClusterApplicationType" {
...
class ManagedClusterApplicationType extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ManagedClusterApplicationType] resource.
  ManagedClusterApplicationType.reference(String urn)
    : super(
        'azure-native:servicefabric:ManagedClusterApplicationType',
