...
class ApplicationHealthPolicyResponse {
  ...
  final ServiceTypeHealthPolicyResponse? defaultServiceTypeHealthPolicy;
  ...
  final Map<String, ServiceTypeHealthPolicyResponse>? serviceTypeHealthPolicyMap;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serviceTypeHealthPolicyMap': ?serviceTypeHealthPolicyMap == null ? null : pulumi.Input.encodeMapValues<ServiceTypeHealthPolicyResponse, Map<String, dynamic>>(serviceTypeHealthPolicyMap!, (value) => value.toMap()),
    };
  }
  ...
  factory ApplicationHealthPolicyResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationHealthPolicyResponse(
      ...
      defaultServiceTypeHealthPolicy: map['defaultServiceTypeHealthPolicy'] == null ? null : ServiceTypeHealthPolicyResponse.fromMap((map['defaultServiceTypeHealthPolicy'] as Map).cast<String, dynamic>()),
      maxPercentUnhealthyDeployedApplications: map['maxPercentUnhealthyDeployedApplications'] as int,
      serviceTypeHealthPolicyMap: map['serviceTypeHealthPolicyMap'] == null ? null : pulumi.Input.decodeMapValues<ServiceTypeHealthPolicyResponse>(map['serviceTypeHealthPolicyMap'], (value) => ServiceTypeHealthPolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
