...
class ApplicationHealthPolicyResponse {
  ...
  final pulumi.Input<ServiceTypeHealthPolicyResponse>?
  ...
  final pulumi.Input<Map<String, ServiceTypeHealthPolicyResponse>>?
    ...
    return <String, dynamic>{
      ...
      'defaultServiceTypeHealthPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(defaultServiceTypeHealthPolicy, (value) => value.toMap()),
      'maxPercentUnhealthyDeployedApplications':
          maxPercentUnhealthyDeployedApplications,
      'serviceTypeHealthPolicyMap':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, ServiceTypeHealthPolicyResponse>,
  ...
  factory ApplicationHealthPolicyResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationHealthPolicyResponse(
      considerWarningAsError: pulumi.Input.fromValue(
        map['considerWarningAsError'] as bool,
      ),
      defaultServiceTypeHealthPolicy: (() {
        final guardedValue = map['defaultServiceTypeHealthPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceTypeHealthPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      maxPercentUnhealthyDeployedApplications: pulumi.Input.fromValue(
        map['maxPercentUnhealthyDeployedApplications'] as int,
      ),
      serviceTypeHealthPolicyMap: (() {
        final guardedValue = map['serviceTypeHealthPolicyMap'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ServiceTypeHealthPolicyResponse>(
            guardedValue,
            (value) => ServiceTypeHealthPolicyResponse.fromMap(
