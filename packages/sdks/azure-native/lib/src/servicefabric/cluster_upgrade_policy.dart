...
class ClusterUpgradePolicy {
  ...
  factory ClusterUpgradePolicy.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradePolicy(
      deltaHealthPolicy: (() { final guardedValue = map['deltaHealthPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterUpgradeDeltaHealthPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      healthPolicy: (() { final guardedValue = map['healthPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterHealthPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      monitoringPolicy: (() { final guardedValue = map['monitoringPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterMonitoringPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
