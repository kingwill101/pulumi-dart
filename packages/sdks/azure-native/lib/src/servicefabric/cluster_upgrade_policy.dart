    ...
    return <String, dynamic>{
      ...
      'monitoringPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(monitoringPolicy, (value) => value.toMap()),
    ...
    return ClusterUpgradePolicy(
      deltaHealthPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterUpgradeDeltaHealthPolicy.fromMap(
      ...
      healthPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterHealthPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      monitoringPolicy: (() {
        final guardedValue = map['monitoringPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterMonitoringPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
