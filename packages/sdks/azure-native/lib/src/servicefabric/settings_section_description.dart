...
class SettingsSectionDescription {
  ...
  factory SettingsSectionDescription.fromMap(Map<String, dynamic> map) {
    return SettingsSectionDescription(
      ...
      parameters: pulumi.Input.fromValue(pulumi.Input.decodeList<SettingsParameterDescription>(map['parameters']!, (value) => SettingsParameterDescription.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
