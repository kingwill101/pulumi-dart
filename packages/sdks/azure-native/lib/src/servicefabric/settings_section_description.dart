...
class SettingsSectionDescription {
  ...
  SettingsSectionDescription({required this.name, required this.parameters});
    ...
    return <String, dynamic>{
      ...
      'parameters':
          pulumi.Input.mapInputValue<
            List<SettingsParameterDescription>,
  ...
  factory SettingsSectionDescription.fromMap(Map<String, dynamic> map) {
    return SettingsSectionDescription(
      ...
      parameters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<SettingsParameterDescription>(
          map['parameters']!,
          (value) => SettingsParameterDescription.fromMap(
