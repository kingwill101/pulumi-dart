...
class ClusterUpgradePolicyResponse {
  ...
  final pulumi.Input<ClusterUpgradeDeltaHealthPolicyResponse>?
  deltaHealthPolicy;
    ...
    return ClusterUpgradePolicyResponse(
      deltaHealthPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          ClusterUpgradeDeltaHealthPolicyResponse.fromMap(
      ...
      healthPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterHealthPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      monitoringPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterMonitoringPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
