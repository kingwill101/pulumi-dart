...
class VaultSecretGroupResponse {
  ...
  factory VaultSecretGroupResponse.fromMap(Map<String, dynamic> map) {
    return VaultSecretGroupResponse(
      ...
      vaultCertificates: pulumi.Input.fromValue(pulumi.Input.decodeList<VaultCertificateResponse>(map['vaultCertificates']!, (value) => VaultCertificateResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
