...
class ManagedClusterArgs {
  ...
  factory ManagedClusterArgs.fromMap(Map<String, dynamic> map) {
    return ManagedClusterArgs(
      ...
      enableHttpGatewayExclusiveAuthMode: (() { final guardedValue = map['enableHttpGatewayExclusiveAuthMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      publicIPv6PrefixId: (() { final guardedValue = map['publicIPv6PrefixId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      serviceEndpoints: (() { final guardedValue = map['serviceEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceEndpoint>(guardedValue, (value) => ServiceEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
