...
class ApplicationUpgradePolicyResponse {
  ...
  final pulumi.Input<ApplicationHealthPolicyResponse?>? applicationHealthPolicy;
  ...
  final pulumi.Input<RollingUpgradeMonitoringPolicyResponse?>? rollingUpgradeMonitoringPolicy;
  ...
  const ApplicationUpgradePolicyResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applicationHealthPolicy': ?pulumi.Input.mapOptionalInputValue<ApplicationHealthPolicyResponse, Map<String, dynamic>>(applicationHealthPolicy, (value) => value.toMap()),
      'forceRestart': ?forceRestart,
      'instanceCloseDelayDuration': ?instanceCloseDelayDuration,
      'recreateApplication': ?recreateApplication,
      'rollingUpgradeMonitoringPolicy': ?pulumi.Input.mapOptionalInputValue<RollingUpgradeMonitoringPolicyResponse, Map<String, dynamic>>(rollingUpgradeMonitoringPolicy, (value) => value.toMap()),
  ...
  factory ApplicationUpgradePolicyResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationUpgradePolicyResponse(
      applicationHealthPolicy: (() { final guardedValue = map['applicationHealthPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationHealthPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      instanceCloseDelayDuration: (() { final guardedValue = map['instanceCloseDelayDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      rollingUpgradeMonitoringPolicy: (() { final guardedValue = map['rollingUpgradeMonitoringPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RollingUpgradeMonitoringPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      upgradeReplicaSetCheckTimeout: (() { final guardedValue = map['upgradeReplicaSetCheckTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
