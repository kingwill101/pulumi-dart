...
class ApplicationUpgradePolicyResponse {
  ...
  final pulumi.Input<RollingUpgradeMonitoringPolicyResponse>?
    ...
    return <String, dynamic>{
      'applicationHealthPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(applicationHealthPolicy, (value) => value.toMap()),
      ...
      'rollingUpgradeMonitoringPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(rollingUpgradeMonitoringPolicy, (value) => value.toMap()),
  ...
  factory ApplicationUpgradePolicyResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationUpgradePolicyResponse(
      applicationHealthPolicy: (() {
        final guardedValue = map['applicationHealthPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationHealthPolicyResponse.fromMap(
      ...
      instanceCloseDelayDuration: (() {
        final guardedValue = map['instanceCloseDelayDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      recreateApplication: (() {
        final guardedValue = map['recreateApplication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      rollingUpgradeMonitoringPolicy: (() {
        final guardedValue = map['rollingUpgradeMonitoringPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RollingUpgradeMonitoringPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
