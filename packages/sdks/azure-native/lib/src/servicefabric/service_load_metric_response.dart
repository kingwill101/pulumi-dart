...
class ServiceLoadMetricResponse {
  ...
  factory ServiceLoadMetricResponse.fromMap(Map<String, dynamic> map) {
    return ServiceLoadMetricResponse(
      defaultLoad: (() { final guardedValue = map['defaultLoad']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      primaryDefaultLoad: (() { final guardedValue = map['primaryDefaultLoad']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      secondaryDefaultLoad: (() { final guardedValue = map['secondaryDefaultLoad']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
