...
class GetNodeTypeResult {
  ...
  final List<AdditionalNetworkInterfaceConfigurationResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalDataDisks': ?(() {
        final guardedValue = additionalDataDisks;
      ...
      'additionalNetworkInterfaceConfigurations': ?(() {
        final guardedValue = additionalNetworkInterfaceConfigurations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'frontendConfigurations': ?(() {
        final guardedValue = frontendConfigurations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'name': name,
      'natConfigurations': ?(() {
        final guardedValue = natConfigurations;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'vmExtensions': ?(() {
        final guardedValue = vmExtensions;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetNodeTypeResult.fromMap(Map<String, dynamic> map) {
    return GetNodeTypeResult(
      additionalDataDisks: (() {
        final guardedValue = map['additionalDataDisks'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VmssDataDiskResponse>(
          guardedValue,
          (value) => VmssDataDiskResponse.fromMap(
      ...
      additionalNetworkInterfaceConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<AdditionalNetworkInterfaceConfigurationResponse>(
          guardedValue,
          (value) => AdditionalNetworkInterfaceConfigurationResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      applicationPorts: (() {
        final guardedValue = map['applicationPorts'];
        if (guardedValue == null) return null;
      ...
      capacities: (() {
        final guardedValue = map['capacities'];
        if (guardedValue == null) return null;
      ...
      dataDiskLetter: (() {
        final guardedValue = map['dataDiskLetter'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      dataDiskSizeGB: (() {
      ...
      dscpConfigurationId: (() {
        final guardedValue = map['dscpConfigurationId'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      ...
      enableEncryptionAtHost: (() {
        final guardedValue = map['enableEncryptionAtHost'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableNodePublicIP: (() {
      ...
      enableNodePublicIPv6: (() {
        final guardedValue = map['enableNodePublicIPv6'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableOverProvisioning: (() {
        final guardedValue = map['enableOverProvisioning'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      ephemeralPorts: (() {
        final guardedValue = map['ephemeralPorts'];
        if (guardedValue == null) return null;
        return EndpointRangeDescriptionResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      frontendConfigurations: (() {
        final guardedValue = map['frontendConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<FrontendConfigurationResponse>(
          guardedValue,
          (value) => FrontendConfigurationResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      isSpotVM: (() {
        final guardedValue = map['isSpotVM'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      isStateless: (() {
        final guardedValue = map['isStateless'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      multiplePlacementGroups: (() {
        final guardedValue = map['multiplePlacementGroups'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      name: map['name'] as String,
      natConfigurations: (() {
        final guardedValue = map['natConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NodeTypeNatConfigResponse>(
          guardedValue,
          (value) => NodeTypeNatConfigResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      placementProperties: (() {
        final guardedValue = map['placementProperties'];
        if (guardedValue == null) return null;
        return (guardedValue as Map).cast<String, String>();
      })(),
      ...
      serviceArtifactReferenceId: (() {
        final guardedValue = map['serviceArtifactReferenceId'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      sku: (() {
      ...
      spotRestoreTimeout: (() {
        final guardedValue = map['spotRestoreTimeout'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      subnetId: (() {
      ...
      useDefaultPublicLoadBalancer: (() {
        final guardedValue = map['useDefaultPublicLoadBalancer'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      useEphemeralOSDisk: (() {
        final guardedValue = map['useEphemeralOSDisk'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      useTempDataDisk: (() {
        final guardedValue = map['useTempDataDisk'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      vmExtensions: (() {
        final guardedValue = map['vmExtensions'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VMSSExtensionResponse>(
          guardedValue,
          (value) => VMSSExtensionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vmImageOffer: (() {
        final guardedValue = map['vmImageOffer'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      vmImagePlan: (() {
        final guardedValue = map['vmImagePlan'];
        if (guardedValue == null) return null;
      ...
      vmImagePublisher: (() {
        final guardedValue = map['vmImagePublisher'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      vmImageResourceId: (() {
        final guardedValue = map['vmImageResourceId'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      vmImageSku: (() {
        final guardedValue = map['vmImageSku'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      vmImageVersion: (() {
        final guardedValue = map['vmImageVersion'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      vmInstanceCount: map['vmInstanceCount'] as int,
      vmManagedIdentity: (() {
        final guardedValue = map['vmManagedIdentity'];
        if (guardedValue == null) return null;
      ...
      vmSecrets: (() {
        final guardedValue = map['vmSecrets'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VaultSecretGroupResponse>(
          guardedValue,
          (value) => VaultSecretGroupResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vmSetupActions: (() {
        final guardedValue = map['vmSetupActions'];
        if (guardedValue == null) return null;
        return (guardedValue as List).cast<String>();
      })(),
      vmSharedGalleryImageId: (() {
        final guardedValue = map['vmSharedGalleryImageId'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      vmSize: (() {
