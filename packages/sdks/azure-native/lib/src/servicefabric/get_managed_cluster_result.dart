...
class GetManagedClusterResult {
  ...
  GetManagedClusterResult({
    ...
    this.clients,
    this.clusterCertificateThumbprints,
  ...
  }) : clientConnectionPort = clientConnectionPort ?? 19000, httpGatewayConnectionPort = httpGatewayConnectionPort ?? 19080, zonalResiliency = zonalResiliency ?? false;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'applicationTypeVersionsCleanupPolicy': ?applicationTypeVersionsCleanupPolicy?.toMap(),
      'auxiliarySubnets': ?(() { final guardedValue = auxiliarySubnets; if (guardedValue == null) return null; return pulumi.Input.encodeList<SubnetResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'azureActiveDirectory': ?azureActiveDirectory?.toMap(),
      'azureApiVersion': ?azureApiVersion,
      'clientConnectionPort': ?clientConnectionPort,
      'clients': ?(() { final guardedValue = clients; if (guardedValue == null) return null; return pulumi.Input.encodeList<ClientCertificateResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'etag': ?etag,
      'fabricSettings': ?(() { final guardedValue = fabricSettings; if (guardedValue == null) return null; return pulumi.Input.encodeList<SettingsSectionDescriptionResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'fqdn': ?fqdn,
      ...
      'serviceEndpoints': ?(() { final guardedValue = serviceEndpoints; if (guardedValue == null) return null; return pulumi.Input.encodeList<ServiceEndpointResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'sku': ?sku?.toMap(),
      'subnetId': ?subnetId,
  ...
  factory GetManagedClusterResult.fromMap(Map<String, dynamic> map) {
    return GetManagedClusterResult(
      addonFeatures: (() { final guardedValue = map['addonFeatures']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      ...
      allowRdpAccess: (() { final guardedValue = map['allowRdpAccess']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      applicationTypeVersionsCleanupPolicy: (() { final guardedValue = map['applicationTypeVersionsCleanupPolicy']; if (guardedValue == null) return null; return ApplicationTypeVersionsCleanupPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      auxiliarySubnets: (() { final guardedValue = map['auxiliarySubnets']; if (guardedValue == null) return null; return pulumi.Input.decodeList<SubnetResponse>(guardedValue, (value) => SubnetResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      azureActiveDirectory: (() { final guardedValue = map['azureActiveDirectory']; if (guardedValue == null) return null; return AzureActiveDirectoryResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      azureApiVersion: (() { final guardedValue = map['azureApiVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      clientConnectionPort: (() { final guardedValue = map['clientConnectionPort']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      clients: (() { final guardedValue = map['clients']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ClientCertificateResponse>(guardedValue, (value) => ClientCertificateResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      clusterCertificateThumbprints: (() { final guardedValue = map['clusterCertificateThumbprints']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
      clusterCodeVersion: (() { final guardedValue = map['clusterCodeVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      clusterUpgradeCadence: (() { final guardedValue = map['clusterUpgradeCadence']; if (guardedValue == null) return null; return guardedValue as String; })(),
      clusterUpgradeMode: (() { final guardedValue = map['clusterUpgradeMode']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      enableAutoOSUpgrade: (() { final guardedValue = map['enableAutoOSUpgrade']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      enableHttpGatewayExclusiveAuthMode: (() { final guardedValue = map['enableHttpGatewayExclusiveAuthMode']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      enableIpv6: (() { final guardedValue = map['enableIpv6']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      enableServicePublicIP: (() { final guardedValue = map['enableServicePublicIP']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      etag: (() { final guardedValue = map['etag']; if (guardedValue == null) return null; return guardedValue as String; })(),
      fabricSettings: (() { final guardedValue = map['fabricSettings']; if (guardedValue == null) return null; return pulumi.Input.decodeList<SettingsSectionDescriptionResponse>(guardedValue, (value) => SettingsSectionDescriptionResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      fqdn: (() { final guardedValue = map['fqdn']; if (guardedValue == null) return null; return guardedValue as String; })(),
      httpGatewayConnectionPort: (() { final guardedValue = map['httpGatewayConnectionPort']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      httpGatewayTokenAuthConnectionPort: (() { final guardedValue = map['httpGatewayTokenAuthConnectionPort']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      publicIPPrefixId: (() { final guardedValue = map['publicIPPrefixId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      publicIPv6PrefixId: (() { final guardedValue = map['publicIPv6PrefixId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      serviceEndpoints: (() { final guardedValue = map['serviceEndpoints']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ServiceEndpointResponse>(guardedValue, (value) => ServiceEndpointResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      upgradeDescription: (() { final guardedValue = map['upgradeDescription']; if (guardedValue == null) return null; return ClusterUpgradePolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      useCustomVnet: (() { final guardedValue = map['useCustomVnet']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      zonalResiliency: (() { final guardedValue = map['zonalResiliency']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      zonalUpdateMode: (() { final guardedValue = map['zonalUpdateMode']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
