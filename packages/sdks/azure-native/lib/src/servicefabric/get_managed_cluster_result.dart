...
class GetManagedClusterResult {
  ...
  factory GetManagedClusterResult.fromMap(Map<String, dynamic> map) {
    return GetManagedClusterResult(
      ...
      clientConnectionPort: (() { final guardedValue = map['clientConnectionPort']; if (guardedValue == null) return null; return guardedValue as int; })(),
      ...
      httpGatewayConnectionPort: (() { final guardedValue = map['httpGatewayConnectionPort']; if (guardedValue == null) return null; return guardedValue as int; })(),
      httpGatewayTokenAuthConnectionPort: (() { final guardedValue = map['httpGatewayTokenAuthConnectionPort']; if (guardedValue == null) return null; return guardedValue as int; })(),
      id: map['id'] as String,
