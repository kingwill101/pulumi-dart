...
class ApplicationHealthPolicy {
  ...
  final pulumi.Input<Map<String, ServiceTypeHealthPolicy>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serviceTypeHealthPolicyMap':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, ServiceTypeHealthPolicy>,
    ...
    return ApplicationHealthPolicy(
      ...
      defaultServiceTypeHealthPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceTypeHealthPolicy.fromMap(
      ...
      serviceTypeHealthPolicyMap: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ServiceTypeHealthPolicy>(
            guardedValue,
            (value) => ServiceTypeHealthPolicy.fromMap(
