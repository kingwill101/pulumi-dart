...
class SettingsSectionDescriptionResponse {
  ...
  final List<SettingsParameterDescriptionResponse> parameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': name,
      'parameters': pulumi.Input.encodeList<SettingsParameterDescriptionResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory SettingsSectionDescriptionResponse.fromMap(Map<String, dynamic> map) {
    return SettingsSectionDescriptionResponse(
      ...
      parameters: pulumi.Input.decodeList<SettingsParameterDescriptionResponse>(map['parameters'], (value) => SettingsParameterDescriptionResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
