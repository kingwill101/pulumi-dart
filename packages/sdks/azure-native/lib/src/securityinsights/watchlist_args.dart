...
class WatchlistArgs {
  ...
  factory WatchlistArgs.fromMap(Map<String, dynamic> map) {
    return WatchlistArgs(
      ...
      numberOfLinesToSkip: (() { final guardedValue = map['numberOfLinesToSkip']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      watchlistAlias: (() { final guardedValue = map['watchlistAlias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      watchlistType: (() { final guardedValue = map['watchlistType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
