...
import 'aatpdata_connector_args.dart';
...
/// }
///
/// resource "azure-native_securityinsights_aatpdataconnector" "aatpDataConnector" {
...
class AATPDataConnector extends pulumi.CustomResource {
  ...
  /// Creates a new [AATPDataConnector].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AATPDataConnector]. {@macro pulumi_securityinsights_aatpdata_connector_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AATPDataConnector(
    String name, {
    AATPDataConnectorArgs? args,
  ...
  /// Creates a typed reference to an existing [AATPDataConnector] resource.
  AATPDataConnector.reference(String urn)
    : super(
        'azure-native:securityinsights:AATPDataConnector',
