...
class CustomizableConnectorUiConfigResponse {
  ...
  const CustomizableConnectorUiConfigResponse({
    this.availability,
  ...
  factory CustomizableConnectorUiConfigResponse.fromMap(Map<String, dynamic> map) {
    return CustomizableConnectorUiConfigResponse(
      availability: (() { final guardedValue = map['availability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectorDefinitionsAvailabilityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      connectivityCriteria: pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectivityCriterionResponse>(map['connectivityCriteria']!, (value) => ConnectivityCriterionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      dataTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectorDataTypeResponse>(map['dataTypes']!, (value) => ConnectorDataTypeResponse.fromMap((value as Map).cast<String, dynamic>()))),
      descriptionMarkdown: pulumi.Input.fromValue(map['descriptionMarkdown'] as String),
      graphQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<GraphQueryResponse>(map['graphQueries']!, (value) => GraphQueryResponse.fromMap((value as Map).cast<String, dynamic>()))),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instructionSteps: pulumi.Input.fromValue(pulumi.Input.decodeList<InstructionStepResponse>(map['instructionSteps']!, (value) => InstructionStepResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      permissions: pulumi.Input.fromValue(ConnectorDefinitionsPermissionsResponse.fromMap((map['permissions']! as Map).cast<String, dynamic>())),
