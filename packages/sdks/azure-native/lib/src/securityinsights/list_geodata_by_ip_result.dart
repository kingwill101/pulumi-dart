  ...
  factory ListGeodataByIpResult.fromMap(Map<String, dynamic> map) {
    return ListGeodataByIpResult(
      ...
      cityConfidenceFactor: (() {
        final guardedValue = map['cityConfidenceFactor'];
        if (guardedValue == null) return null;
      ...
      countryConfidenceFactor: (() {
        final guardedValue = map['countryConfidenceFactor'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
      ipAddr: (() {
        final guardedValue = map['ipAddr'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      ipRoutingType: (() {
        final guardedValue = map['ipRoutingType'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      latitude: (() {
      ...
      organizationType: (() {
        final guardedValue = map['organizationType'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      region: (() {
      ...
      stateCode: (() {
        final guardedValue = map['stateCode'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      stateConfidenceFactor: (() {
        final guardedValue = map['stateConfidenceFactor'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
    );
