...
class GetScheduledAlertRuleResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alertDetailsOverride': ?alertDetailsOverride == null ? null : alertDetailsOverride!.toMap(),
      ...
      'enabled': enabled,
      'entityMappings': ?entityMappings == null ? null : pulumi.Input.encodeList<EntityMappingResponse, Map<String, dynamic>>(entityMappings!, (value) => value.toMap()),
      'etag': ?etag,
      'eventGroupingSettings': ?eventGroupingSettings == null ? null : eventGroupingSettings!.toMap(),
      'id': id,
      'incidentConfiguration': ?incidentConfiguration == null ? null : incidentConfiguration!.toMap(),
      'kind': kind,
  ...
  factory GetScheduledAlertRuleResult.fromMap(Map<String, dynamic> map) {
    return GetScheduledAlertRuleResult(
      alertDetailsOverride: map['alertDetailsOverride'] == null ? null : AlertDetailsOverrideResponse.fromMap((map['alertDetailsOverride']! as Map).cast<String, dynamic>()),
      ...
      entityMappings: map['entityMappings'] == null ? null : pulumi.Input.decodeList<EntityMappingResponse>(map['entityMappings']!, (value) => EntityMappingResponse.fromMap((value as Map).cast<String, dynamic>())),
      etag: map['etag'] == null ? null : map['etag']! as String,
      eventGroupingSettings: map['eventGroupingSettings'] == null ? null : EventGroupingSettingsResponse.fromMap((map['eventGroupingSettings']! as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      incidentConfiguration: map['incidentConfiguration'] == null ? null : IncidentConfigurationResponse.fromMap((map['incidentConfiguration']! as Map).cast<String, dynamic>()),
