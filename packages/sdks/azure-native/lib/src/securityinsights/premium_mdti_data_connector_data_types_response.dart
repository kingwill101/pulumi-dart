...
class PremiumMdtiDataConnectorDataTypesResponse {
  ...
  final pulumi.Input<PremiumMdtiDataConnectorDataTypesResponseConnector>
  connector;
  ...
  PremiumMdtiDataConnectorDataTypesResponse({required this.connector});
  ...
  factory PremiumMdtiDataConnectorDataTypesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return PremiumMdtiDataConnectorDataTypesResponse(
      connector: pulumi.Input.fromValue(
        PremiumMdtiDataConnectorDataTypesResponseConnector.fromMap(
