...
class InsightsTableResultResponse {
  ...
  factory InsightsTableResultResponse.fromMap(Map<String, dynamic> map) {
    return InsightsTableResultResponse(
      ...
      rows: (() { final guardedValue = map['rows']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<List<String>>(guardedValue, (value) => (value as List).cast<String>())); })(),
    );
  }
}
