...
class InsightsTableResultResponse {
  ...
  InsightsTableResultResponse({this.columns, this.rows});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'columns':
          ?pulumi.Input.mapOptionalInputValue<
            List<InsightsTableResultResponseColumns>,
    ...
    return InsightsTableResultResponse(
      columns: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InsightsTableResultResponseColumns>(
            guardedValue,
            (value) => InsightsTableResultResponseColumns.fromMap(
