...
class PremiumMicrosoftDefenderForThreatIntelligenceArgs {
  ...
  factory PremiumMicrosoftDefenderForThreatIntelligenceArgs.fromMap(Map<String, dynamic> map) {
    return PremiumMicrosoftDefenderForThreatIntelligenceArgs(
      ...
      dataTypes: pulumi.Input.fromValue(PremiumMdtiDataConnectorDataTypes.fromMap((map['dataTypes']! as Map).cast<String, dynamic>())),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      lookbackPeriod: pulumi.Input.fromValue(map['lookbackPeriod'] as String),
      requiredSKUsPresent: (() { final guardedValue = map['requiredSKUsPresent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
