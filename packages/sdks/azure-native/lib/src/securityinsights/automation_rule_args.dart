    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<AutomationRuleAddIncidentTaskAction>,
      ...
      'triggeringLogic':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(triggeringLogic, (value) => value.toMap()),
  ...
  factory AutomationRuleArgs.fromMap(Map<String, dynamic> map) {
    return AutomationRuleArgs(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AutomationRuleAddIncidentTaskAction>(
          map['actions']!,
          (value) => AutomationRuleAddIncidentTaskAction.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      automationRuleId: (() {
        final guardedValue = map['automationRuleId'];
      ...
      triggeringLogic: pulumi.Input.fromValue(
        AutomationRuleTriggeringLogic.fromMap(
