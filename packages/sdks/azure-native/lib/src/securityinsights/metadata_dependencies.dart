...
class MetadataDependencies {
  ...
  final List<MetadataDependencies>? criteria;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentId': ?contentId,
      'criteria': ?criteria == null ? null : pulumi.Input.encodeList<MetadataDependencies, Map<String, dynamic>>(criteria!, (value) => value.toMap()),
      'kind': ?kind,
      'name': ?name,
      'operator': ?operator,
      'version': ?version,
  ...
  factory MetadataDependencies.fromMap(Map<String, dynamic> map) {
    return MetadataDependencies(
      ...
      criteria: map['criteria'] == null ? null : pulumi.Input.decodeList<MetadataDependencies>(map['criteria'], (value) => MetadataDependencies.fromMap((value as Map).cast<String, dynamic>())),
