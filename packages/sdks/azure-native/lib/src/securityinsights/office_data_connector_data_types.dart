...
class OfficeDataConnectorDataTypes {
  ...
  factory OfficeDataConnectorDataTypes.fromMap(Map<String, dynamic> map) {
    return OfficeDataConnectorDataTypes(
      exchange: (OfficeDataConnectorDataTypesExchange.fromMap((map['exchange'] as Map).cast<String, dynamic>())).input(),
      sharePoint: (OfficeDataConnectorDataTypesSharePoint.fromMap((map['sharePoint'] as Map).cast<String, dynamic>())).input(),
      teams: (OfficeDataConnectorDataTypesTeams.fromMap((map['teams'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
