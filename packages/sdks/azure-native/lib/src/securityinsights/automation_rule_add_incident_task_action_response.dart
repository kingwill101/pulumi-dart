...
class AutomationRuleAddIncidentTaskActionResponse {
  /// Describes an automation rule action to add a task to an incident.
  final pulumi.Input<AddIncidentTaskActionPropertiesResponse>?
  actionConfiguration;
  ...
  factory AutomationRuleAddIncidentTaskActionResponse.fromMap(
    ...
    return AutomationRuleAddIncidentTaskActionResponse(
      actionConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          AddIncidentTaskActionPropertiesResponse.fromMap(
