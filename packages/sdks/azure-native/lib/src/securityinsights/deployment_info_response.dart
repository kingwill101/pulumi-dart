...
class DeploymentInfoResponse {
  ...
  factory DeploymentInfoResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentInfoResponse(
      deployment: (() { final guardedValue = map['deployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
