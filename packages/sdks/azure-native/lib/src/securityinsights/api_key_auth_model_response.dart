...
class ApiKeyAuthModelResponse {
  ...
  factory ApiKeyAuthModelResponse.fromMap(Map<String, dynamic> map) {
    return ApiKeyAuthModelResponse(
      ...
      apiKeyIdentifier: (() { final guardedValue = map['apiKeyIdentifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      apiKeyName: pulumi.Input.fromValue(map['apiKeyName'] as String),
      isApiKeyInPostPayload: (() { final guardedValue = map['isApiKeyInPostPayload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
