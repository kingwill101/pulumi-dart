...
/// {@template pulumi_securityinsights_aatpdata_connector_args_doc}
/// The set of arguments for AATPDataConnector.
/// {@endtemplate}
/// {@macro pulumi_securityinsights_aatpdata_connector_args_doc}
class AATPDataConnectorArgs {
  ...
  /// Creates a new [AATPDataConnectorArgs].
  ...
  factory AATPDataConnectorArgs.fromMap(Map<String, dynamic> map) {
    return AATPDataConnectorArgs(
