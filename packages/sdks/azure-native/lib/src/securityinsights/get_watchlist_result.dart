...
class GetWatchlistResult {
  ...
  factory GetWatchlistResult.fromMap(Map<String, dynamic> map) {
    return GetWatchlistResult(
      ...
      watchlistAlias: (() { final guardedValue = map['watchlistAlias']; if (guardedValue == null) return null; return guardedValue as String; })(),
      watchlistId: (() { final guardedValue = map['watchlistId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      watchlistType: (() { final guardedValue = map['watchlistType']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
