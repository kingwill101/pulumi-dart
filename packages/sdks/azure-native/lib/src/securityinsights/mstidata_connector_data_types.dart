...
class MSTIDataConnectorDataTypes {
  ...
  final pulumi.Input<MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeed>
  ...
  MSTIDataConnectorDataTypes({required this.microsoftEmergingThreatFeed});
  ...
  factory MSTIDataConnectorDataTypes.fromMap(Map<String, dynamic> map) {
    return MSTIDataConnectorDataTypes(
      microsoftEmergingThreatFeed: pulumi.Input.fromValue(
        MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeed.fromMap(
