...
class MSTIDataConnectorDataTypes {
  ...
  factory MSTIDataConnectorDataTypes.fromMap(Map<String, dynamic> map) {
    return MSTIDataConnectorDataTypes(
      microsoftEmergingThreatFeed: (MSTIDataConnectorDataTypesMicrosoftEmergingThreatFeed.fromMap((map['microsoftEmergingThreatFeed'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
