...
class PropertyChangedConditionProperties {
  ...
  factory PropertyChangedConditionProperties.fromMap(Map<String, dynamic> map) {
    return PropertyChangedConditionProperties(
      conditionProperties: (() { final guardedValue = map['conditionProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutomationRulePropertyValuesChangedCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
