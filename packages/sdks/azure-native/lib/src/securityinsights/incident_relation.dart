...
/// }
///
/// resource "azure-native_securityinsights_incidentrelation" "incidentRelation" {
...
class IncidentRelation extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [IncidentRelation] resource.
  IncidentRelation.reference(String urn)
    : super(
        'azure-native:securityinsights:IncidentRelation',
