...
class OAuthModelResponse {
  ...
  factory OAuthModelResponse.fromMap(Map<String, dynamic> map) {
    return OAuthModelResponse(
      accessTokenPrepend: (() {
        final guardedValue = map['accessTokenPrepend'];
      ...
      authorizationEndpointHeaders: (() {
        final guardedValue = map['authorizationEndpointHeaders'];
        if (guardedValue == null) return null;
      ...
      authorizationEndpointQueryParameters: (() {
        final guardedValue = map['authorizationEndpointQueryParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      isCredentialsInHeaders: (() {
        final guardedValue = map['isCredentialsInHeaders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isJwtBearerFlow: (() {
        final guardedValue = map['isJwtBearerFlow'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      redirectUri: (() {
      ...
      tokenEndpointHeaders: (() {
        final guardedValue = map['tokenEndpointHeaders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      tokenEndpointQueryParameters: (() {
        final guardedValue = map['tokenEndpointQueryParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
