...
/// Result data returned by getMDATPDataConnector.
class GetMDATPDataConnectorResult {
  ...
  /// Creates a new [GetMDATPDataConnectorResult].
  ...
  factory GetMDATPDataConnectorResult.fromMap(Map<String, dynamic> map) {
