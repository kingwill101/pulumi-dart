...
class GetSourceControlResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': ?etag,
      'id': id,
      'lastDeploymentInfo': ?lastDeploymentInfo == null ? null : lastDeploymentInfo!.toMap(),
      'name': name,
      'repoType': repoType,
      'repository': repository.toMap(),
      'repositoryResourceInfo': ?repositoryResourceInfo == null ? null : repositoryResourceInfo!.toMap(),
