...
class ThreatIntelligenceIndicatorArgs {
  ...
  factory ThreatIntelligenceIndicatorArgs.fromMap(Map<String, dynamic> map) {
    return ThreatIntelligenceIndicatorArgs(
      ...
      createdByRef: (() { final guardedValue = map['createdByRef']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      extensions: (() { final guardedValue = map['extensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      externalReferences: (() { final guardedValue = map['externalReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ThreatIntelligenceExternalReference>(guardedValue, (value) => ThreatIntelligenceExternalReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      granularMarkings: (() { final guardedValue = map['granularMarkings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ThreatIntelligenceGranularMarkingModel>(guardedValue, (value) => ThreatIntelligenceGranularMarkingModel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      killChainPhases: (() { final guardedValue = map['killChainPhases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ThreatIntelligenceKillChainPhase>(guardedValue, (value) => ThreatIntelligenceKillChainPhase.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      parsedPattern: (() { final guardedValue = map['parsedPattern']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ThreatIntelligenceParsedPattern>(guardedValue, (value) => ThreatIntelligenceParsedPattern.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      threatIntelligenceTags: (() { final guardedValue = map['threatIntelligenceTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
