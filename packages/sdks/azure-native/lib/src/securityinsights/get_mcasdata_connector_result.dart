...
class GetMCASDataConnectorResult {
  ...
  factory GetMCASDataConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetMCASDataConnectorResult(
      ...
      dataTypes: (() { final guardedValue = map['dataTypes']; if (guardedValue == null) return null; return MCASDataConnectorDataTypesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
