...
/// }
///
/// resource "azure-native_securityinsights_sentinelonboardingstate" "sentinelOnboardingState" {
...
class SentinelOnboardingState extends pulumi.CustomResource {
  ...
  SentinelOnboardingState(
    ...
    customerManagedKey = registerOutput<bool?>('customerManagedKey');
  ...
  /// Creates a typed reference to an existing [SentinelOnboardingState] resource.
  SentinelOnboardingState.reference(String urn)
    : super(
        'azure-native:securityinsights:SentinelOnboardingState',
