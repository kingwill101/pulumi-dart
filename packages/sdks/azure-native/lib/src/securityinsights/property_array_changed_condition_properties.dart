...
class PropertyArrayChangedConditionProperties {
  final pulumi.Input<AutomationRulePropertyArrayChangedValuesCondition>?
  conditionProperties;
  ...
  factory PropertyArrayChangedConditionProperties.fromMap(
    ...
    return PropertyArrayChangedConditionProperties(
      conditionProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AutomationRulePropertyArrayChangedValuesCondition.fromMap(
