...
class ScheduledAlertRuleArgs {
  ...
  factory ScheduledAlertRuleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledAlertRuleArgs(
      alertDetailsOverride: map['alertDetailsOverride'] == null ? null : (AlertDetailsOverride.fromMap((map['alertDetailsOverride']! as Map).cast<String, dynamic>())).input(),
      ...
      entityMappings: map['entityMappings'] == null ? null : (pulumi.Input.decodeList<EntityMapping>(map['entityMappings']!, (value) => EntityMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
      eventGroupingSettings: map['eventGroupingSettings'] == null ? null : (EventGroupingSettings.fromMap((map['eventGroupingSettings']! as Map).cast<String, dynamic>())).input(),
      incidentConfiguration: map['incidentConfiguration'] == null ? null : (IncidentConfiguration.fromMap((map['incidentConfiguration']! as Map).cast<String, dynamic>())).input(),
      ...
      suppressionDuration: (map['suppressionDuration'] as String).input(),
      suppressionEnabled: (map['suppressionEnabled'] as bool).input(),
      ...
      triggerOperator: (TriggerOperator.fromValue(map['triggerOperator'] as String)).input(),
