...
class ScheduledAlertRuleArgs {
    ...
    return <String, dynamic>{
      'alertDetailsOverride':
          ?pulumi.Input.mapOptionalInputValue<
            AlertDetailsOverride,
            Map<String, dynamic>
          >(alertDetailsOverride, (value) => value.toMap()),
      ...
      'entityMappings':
          ...
          >(
            entityMappings,
            (value) =>
                pulumi.Input.encodeList<EntityMapping, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'eventGroupingSettings':
          ?pulumi.Input.mapOptionalInputValue<
            EventGroupingSettings,
            Map<String, dynamic>
          >(eventGroupingSettings, (value) => value.toMap()),
      'incidentConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            IncidentConfiguration,
            Map<String, dynamic>
          >(incidentConfiguration, (value) => value.toMap()),
      'kind': kind,
      'query': query,
      ...
      'triggerOperator': pulumi.Input.mapInputValue<TriggerOperator, String>(
        triggerOperator,
  ...
  factory ScheduledAlertRuleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledAlertRuleArgs(
      alertDetailsOverride: (() {
        final guardedValue = map['alertDetailsOverride'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AlertDetailsOverride.fromMap(
      ...
      entityMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EntityMapping>(
            guardedValue,
            (value) =>
                EntityMapping.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      eventGroupingSettings: (() {
        final guardedValue = map['eventGroupingSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventGroupingSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      incidentConfiguration: (() {
        final guardedValue = map['incidentConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IncidentConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      suppressionDuration: pulumi.Input.fromValue(
        map['suppressionDuration'] as String,
      ),
      suppressionEnabled: pulumi.Input.fromValue(
        map['suppressionEnabled'] as bool,
      ),
      tactics: (() {
      ...
      triggerOperator: pulumi.Input.fromValue(
        TriggerOperator.fromValue(map['triggerOperator']! as String),
      ),
