...
class ScheduledAlertRuleArgs {
  ...
  ScheduledAlertRuleArgs({
    pulumi.Output<AlertDetailsOverride>? alertDetailsOverride,
    ...
    pulumi.Output<List<EntityMapping>>? entityMappings,
    pulumi.Output<EventGroupingSettings>? eventGroupingSettings,
    pulumi.Output<IncidentConfiguration>? incidentConfiguration,
    required pulumi.Output<String> kind,
    required pulumi.Output<String> query,
    required pulumi.Output<String> queryFrequency,
    required pulumi.Output<String> queryPeriod,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? ruleId,
    required pulumi.Output<String> severity,
    required pulumi.Output<String> suppressionDuration,
    required pulumi.Output<bool> suppressionEnabled,
    pulumi.Output<List<String>>? tactics,
    pulumi.Output<List<String>>? techniques,
    pulumi.Output<String>? templateVersion,
    required pulumi.Output<TriggerOperator> triggerOperator,
    required pulumi.Output<int> triggerThreshold,
  ...
  factory ScheduledAlertRuleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledAlertRuleArgs(
      alertDetailsOverride: map['alertDetailsOverride'] == null ? null : pulumi.Output.create<AlertDetailsOverride>(AlertDetailsOverride.fromMap((map['alertDetailsOverride'] as Map).cast<String, dynamic>())),
      ...
      entityMappings: map['entityMappings'] == null ? null : pulumi.Output.create<List<EntityMapping>>(pulumi.Input.decodeList<EntityMapping>(map['entityMappings'], (value) => EntityMapping.fromMap((value as Map).cast<String, dynamic>()))),
      eventGroupingSettings: map['eventGroupingSettings'] == null ? null : pulumi.Output.create<EventGroupingSettings>(EventGroupingSettings.fromMap((map['eventGroupingSettings'] as Map).cast<String, dynamic>())),
      incidentConfiguration: map['incidentConfiguration'] == null ? null : pulumi.Output.create<IncidentConfiguration>(IncidentConfiguration.fromMap((map['incidentConfiguration'] as Map).cast<String, dynamic>())),
      kind: pulumi.Output.create<String>(map['kind'] as String),
      query: pulumi.Output.create<String>(map['query'] as String),
      queryFrequency: pulumi.Output.create<String>(map['queryFrequency'] as String),
      queryPeriod: pulumi.Output.create<String>(map['queryPeriod'] as String),
      ...
      suppressionDuration: pulumi.Output.create<String>(map['suppressionDuration'] as String),
      suppressionEnabled: pulumi.Output.create<bool>(map['suppressionEnabled'] as bool),
      ...
      triggerOperator: pulumi.Output.create<TriggerOperator>(TriggerOperator.fromValue(map['triggerOperator'] as String)),
      triggerThreshold: pulumi.Output.create<int>(map['triggerThreshold'] as int),
