...
class RestApiPollerRequestConfig {
  ...
  final pulumi.Input<dynamic>? httpMethod;
  ...
  const RestApiPollerRequestConfig({
  ...
  factory RestApiPollerRequestConfig.fromMap(Map<String, dynamic> map) {
    return RestApiPollerRequestConfig(
      ...
      httpMethod: (() { final guardedValue = map['httpMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      queryWindowInMin: (() { final guardedValue = map['queryWindowInMin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      rateLimitQPS: (() { final guardedValue = map['rateLimitQPS']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
