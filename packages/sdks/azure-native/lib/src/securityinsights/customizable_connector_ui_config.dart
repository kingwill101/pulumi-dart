    ...
    return <String, dynamic>{
      ...
      'graphQueries':
          ...
          >(
            graphQueries,
            (value) =>
                pulumi.Input.encodeList<GraphQuery, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'instructionSteps':
          ...
          >(
            instructionSteps,
            (value) =>
                pulumi.Input.encodeList<InstructionStep, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return CustomizableConnectorUiConfig(
      availability: (() {
        ...
        return pulumi.Input.fromValue(
          ConnectorDefinitionsAvailability.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      connectivityCriteria: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectivityCriterion>(
          map['connectivityCriteria']!,
          (value) => ConnectivityCriterion.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      dataTypes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ConnectorDataType>(
          map['dataTypes']!,
          (value) =>
              ConnectorDataType.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      ...
      graphQueries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GraphQuery>(
          map['graphQueries']!,
          (value) => GraphQuery.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      id: (() {
      ...
      instructionSteps: pulumi.Input.fromValue(
        pulumi.Input.decodeList<InstructionStep>(
          map['instructionSteps']!,
          (value) =>
              InstructionStep.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      ...
      permissions: pulumi.Input.fromValue(
        ConnectorDefinitionsPermissions.fromMap(
