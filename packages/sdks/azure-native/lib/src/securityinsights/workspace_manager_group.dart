...
/// }
///
/// resource "azure-native_securityinsights_workspacemanagergroup" "workspaceManagerGroup" {
///   description                  = "Group of all financial and banking institutions"
///   display_name                 = "Banks"
///   member_resource_names        = ["afbd324f-6c48-459c-8710-8d1e1cd03812", "f5fa104e-c0e3-4747-9182-d342dc048a9e"]
...
class WorkspaceManagerGroup extends pulumi.CustomResource {
  ...
  WorkspaceManagerGroup(
    ...
    memberResourceNames = registerOutput<List<String>>('memberResourceNames', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
    this.name = registerOutput<String>('name');
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [WorkspaceManagerGroup] resource.
  WorkspaceManagerGroup.reference(String urn)
    : super(
        'azure-native:securityinsights:WorkspaceManagerGroup',
