...
class GetActivityCustomEntityQueryResult {
  ...
  factory GetActivityCustomEntityQueryResult.fromMap(Map<String, dynamic> map) {
    return GetActivityCustomEntityQueryResult(
      ...
      entitiesFilter: (() { final guardedValue = map['entitiesFilter']; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, List<String>>(); })(),
      ...
      requiredInputFieldsSets: (() { final guardedValue = map['requiredInputFieldsSets']; if (guardedValue == null) return null; return (guardedValue as List).cast<List<String>>(); })(),
