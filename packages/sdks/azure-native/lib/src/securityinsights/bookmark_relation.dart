...
/// }
///
/// resource "azure-native_securityinsights_bookmarkrelation" "bookmarkRelation" {
...
class BookmarkRelation extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [BookmarkRelation] resource.
  BookmarkRelation.reference(String urn)
    : super(
        'azure-native:securityinsights:BookmarkRelation',
