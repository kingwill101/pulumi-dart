...
import 'aaddata_connector_args.dart';
...
/// }
///
/// resource "azure-native_securityinsights_aaddataconnector" "aadDataConnector" {
...
class AADDataConnector extends pulumi.CustomResource {
  ...
  /// Creates a new [AADDataConnector].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AADDataConnector]. {@macro pulumi_securityinsights_aaddata_connector_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AADDataConnector(
    String name, {
    AADDataConnectorArgs? args,
  ...
  /// Creates a typed reference to an existing [AADDataConnector] resource.
  AADDataConnector.reference(String urn)
    : super(
        'azure-native:securityinsights:AADDataConnector',
