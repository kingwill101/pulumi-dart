...
/// }
///
/// resource "azure-native_securityinsights_mstidataconnector" "mstiDataConnector" {
...
class MSTIDataConnector extends pulumi.CustomResource {
  ...
  MSTIDataConnector(
    ...
    dataTypes = registerOutput<MSTIDataConnectorDataTypesResponse>('dataTypes', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MSTIDataConnectorDataTypesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [MSTIDataConnector] resource.
  MSTIDataConnector.reference(String urn)
    : super(
        'azure-native:securityinsights:MSTIDataConnector',
