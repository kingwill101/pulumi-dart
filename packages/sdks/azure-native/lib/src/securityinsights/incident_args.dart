    ...
    return <String, dynamic>{
      ...
      'labels':
          ...
          >(
            labels,
            (value) =>
                pulumi.Input.encodeList<IncidentLabel, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return IncidentArgs(
      ...
      labels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IncidentLabel>(
            guardedValue,
            (value) =>
                IncidentLabel.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      lastActivityTimeUtc: (() {
