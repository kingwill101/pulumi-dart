...
class RepositoryResourceInfoResponse {
  ...
  const RepositoryResourceInfoResponse({
    required this.azureDevOpsResourceInfo,
    required this.gitHubResourceInfo,
    this.webhook,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'azureDevOpsResourceInfo': pulumi.Input.mapInputValue<AzureDevOpsResourceInfoResponse, Map<String, dynamic>>(azureDevOpsResourceInfo, (value) => value.toMap()),
      'gitHubResourceInfo': pulumi.Input.mapInputValue<GitHubResourceInfoResponse, Map<String, dynamic>>(gitHubResourceInfo, (value) => value.toMap()),
  ...
  factory RepositoryResourceInfoResponse.fromMap(Map<String, dynamic> map) {
    return RepositoryResourceInfoResponse(
      azureDevOpsResourceInfo: pulumi.Input.fromValue(AzureDevOpsResourceInfoResponse.fromMap((map['azureDevOpsResourceInfo']! as Map).cast<String, dynamic>())),
      gitHubResourceInfo: pulumi.Input.fromValue(GitHubResourceInfoResponse.fromMap((map['gitHubResourceInfo']! as Map).cast<String, dynamic>())),
