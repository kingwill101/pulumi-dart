...
class GetTIDataConnectorResult {
  ...
  factory GetTIDataConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetTIDataConnectorResult(
      ...
      dataTypes: (() { final guardedValue = map['dataTypes']; if (guardedValue == null) return null; return TIDataConnectorDataTypesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
