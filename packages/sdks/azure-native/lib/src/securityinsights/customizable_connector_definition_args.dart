...
class CustomizableConnectorDefinitionArgs {
  ...
  factory CustomizableConnectorDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return CustomizableConnectorDefinitionArgs(
      connectionsConfig: (() { final guardedValue = map['connectionsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomizableConnectionsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      connectorUiConfig: pulumi.Input.fromValue(CustomizableConnectorUiConfig.fromMap((map['connectorUiConfig']! as Map).cast<String, dynamic>())),
      createdTimeUtc: (() { final guardedValue = map['createdTimeUtc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataConnectorDefinitionName: (() { final guardedValue = map['dataConnectorDefinitionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kind: pulumi.Input.fromValue(map['kind'] as String),
      lastModifiedUtc: (() { final guardedValue = map['lastModifiedUtc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
