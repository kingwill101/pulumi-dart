...
class TemplatePropertiesResponse {
  ...
  factory TemplatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return TemplatePropertiesResponse(
      author: map['author'] == null ? null : (MetadataAuthorResponse.fromMap((map['author'] as Map).cast<String, dynamic>())).input(),
      categories: map['categories'] == null ? null : (MetadataCategoriesResponse.fromMap((map['categories'] as Map).cast<String, dynamic>())).input(),
      ...
      dependantTemplates: (pulumi.Input.decodeList<TemplatePropertiesResponse>(map['dependantTemplates'], (value) => TemplatePropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dependencies: map['dependencies'] == null ? null : (MetadataDependenciesResponse.fromMap((map['dependencies'] as Map).cast<String, dynamic>())).input(),
      ...
      isDeprecated: (map['isDeprecated'] as String).input(),
      ...
      source: (MetadataSourceResponse.fromMap((map['source'] as Map).cast<String, dynamic>())).input(),
      support: map['support'] == null ? null : (MetadataSupportResponse.fromMap((map['support'] as Map).cast<String, dynamic>())).input(),
