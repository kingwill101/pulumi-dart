    ...
    return <String, dynamic>{
      ...
      'dependantTemplates':
          pulumi.Input.mapInputValue<
            List<TemplatePropertiesResponse>,
    ...
    return TemplatePropertiesResponse(
      author: (() {
        ...
        return pulumi.Input.fromValue(
          MetadataAuthorResponse.fromMap(
      ...
      categories: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetadataCategoriesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      dependantTemplates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TemplatePropertiesResponse>(
          map['dependantTemplates']!,
          (value) => TemplatePropertiesResponse.fromMap(
      ...
      dependencies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetadataDependenciesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      source: pulumi.Input.fromValue(
        MetadataSourceResponse.fromMap(
      ...
      support: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MetadataSupportResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
