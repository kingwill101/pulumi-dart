    ...
    return <String, dynamic>{
      ...
      'lastDeploymentInfo':
          ?pulumi.Input.mapOptionalInputValue<
            DeploymentInfo,
            Map<String, dynamic>
          >(lastDeploymentInfo, (value) => value.toMap()),
      'repoType': repoType,
      'repository':
          pulumi.Input.mapInputValue<Repository, Map<String, dynamic>>(
            repository,
            (value) => value.toMap(),
          ),
      'repositoryResourceInfo':
          ?pulumi.Input.mapOptionalInputValue<
            RepositoryResourceInfo,
            Map<String, dynamic>
          >(repositoryResourceInfo, (value) => value.toMap()),
    ...
    return SourceControlArgs(
      ...
      lastDeploymentInfo: (() {
        ...
        return pulumi.Input.fromValue(
          DeploymentInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      repoType: pulumi.Input.fromValue(map['repoType'] as String),
      repository: pulumi.Input.fromValue(
        Repository.fromMap((map['repository']! as Map).cast<String, dynamic>()),
      ),
      repositoryResourceInfo: (() {
        final guardedValue = map['repositoryResourceInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RepositoryResourceInfo.fromMap(
      ...
      sourceControlId: (() {
        final guardedValue = map['sourceControlId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      version: (() {
