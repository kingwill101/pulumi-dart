...
class ConnectorDefinitionsPermissions {
  ...
  factory ConnectorDefinitionsPermissions.fromMap(Map<String, dynamic> map) {
    return ConnectorDefinitionsPermissions(
      customs: (() { final guardedValue = map['customs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomPermissionDetails>(guardedValue, (value) => CustomPermissionDetails.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      resourceProvider: (() { final guardedValue = map['resourceProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectorDefinitionsResourceProvider>(guardedValue, (value) => ConnectorDefinitionsResourceProvider.fromMap((value as Map).cast<String, dynamic>()))); })(),
