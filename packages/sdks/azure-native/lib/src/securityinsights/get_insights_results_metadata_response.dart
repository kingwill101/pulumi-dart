...
class GetInsightsResultsMetadataResponse {
  ...
  GetInsightsResultsMetadataResponse({this.errors, required this.totalCount});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'errors':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetInsightsErrorKindResponse>,
    ...
    return GetInsightsResultsMetadataResponse(
      errors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetInsightsErrorKindResponse>(
            guardedValue,
            (value) => GetInsightsErrorKindResponse.fromMap(
