    ...
    return <String, dynamic>{
      ...
      'registrant':
          ?pulumi.Input.mapOptionalInputValue<
            EnrichmentDomainWhoisContactResponse,
            Map<String, dynamic>
          >(registrant, (value) => value.toMap()),
      'tech':
          ?pulumi.Input.mapOptionalInputValue<
            EnrichmentDomainWhoisContactResponse,
            Map<String, dynamic>
          >(tech, (value) => value.toMap()),
    };
  }

  factory EnrichmentDomainWhoisContactsResponse.fromMap(
    ...
    return EnrichmentDomainWhoisContactsResponse(
      admin: (() {
        ...
        return pulumi.Input.fromValue(
          EnrichmentDomainWhoisContactResponse.fromMap(
      ...
      registrant: (() {
        final guardedValue = map['registrant'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnrichmentDomainWhoisContactResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
