...
class MSTIDataConnectorArgs {
  ...
  MSTIDataConnectorArgs({
    ...
    required pulumi.Output<MSTIDataConnectorDataTypes> dataTypes,
  ...
  factory MSTIDataConnectorArgs.fromMap(Map<String, dynamic> map) {
    return MSTIDataConnectorArgs(
      ...
      dataTypes: pulumi.Output.create<MSTIDataConnectorDataTypes>(MSTIDataConnectorDataTypes.fromMap((map['dataTypes'] as Map).cast<String, dynamic>())),
