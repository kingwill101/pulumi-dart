...
class AnomalySecurityMLAnalyticsSettingsArgs {
  ...
  final pulumi.Input<List<SecurityMLAnalyticsSettingsDataSource>>?
    ...
    return <String, dynamic>{
      ...
      'requiredDataConnectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<SecurityMLAnalyticsSettingsDataSource>,
  ...
  factory AnomalySecurityMLAnalyticsSettingsArgs.fromMap(
    ...
    return AnomalySecurityMLAnalyticsSettingsArgs(
      ...
      isDefaultSettings: pulumi.Input.fromValue(
        map['isDefaultSettings'] as bool,
      ),
      ...
      requiredDataConnectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SecurityMLAnalyticsSettingsDataSource>(
            guardedValue,
            (value) => SecurityMLAnalyticsSettingsDataSource.fromMap(
      ...
      settingsResourceName: (() {
        final guardedValue = map['settingsResourceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
