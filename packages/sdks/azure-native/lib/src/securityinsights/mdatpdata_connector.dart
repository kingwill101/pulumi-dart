...
import 'mdatpdata_connector_args.dart';
...
/// }
///
/// resource "azure-native_securityinsights_mdatpdataconnector" "mdatpDataConnector" {
...
class MDATPDataConnector extends pulumi.CustomResource {
  ...
  /// Creates a new [MDATPDataConnector].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [MDATPDataConnector]. {@macro pulumi_securityinsights_mdatpdata_connector_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MDATPDataConnector(
    String name, {
    MDATPDataConnectorArgs? args,
  ...
  /// Creates a typed reference to an existing [MDATPDataConnector] resource.
  MDATPDataConnector.reference(String urn)
    : super(
        'azure-native:securityinsights:MDATPDataConnector',
