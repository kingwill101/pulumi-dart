  ...
  factory RestApiPollerRequestConfigResponse.fromMap(Map<String, dynamic> map) {
    return RestApiPollerRequestConfigResponse(
      ...
      endTimeAttributeName: (() {
        final guardedValue = map['endTimeAttributeName'];
      ...
      queryParametersTemplate: (() {
        final guardedValue = map['queryParametersTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryTimeFormat: (() {
        final guardedValue = map['queryTimeFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryTimeIntervalAttributeName: (() {
        final guardedValue = map['queryTimeIntervalAttributeName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryTimeIntervalDelimiter: (() {
        final guardedValue = map['queryTimeIntervalDelimiter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryTimeIntervalPrepend: (() {
        final guardedValue = map['queryTimeIntervalPrepend'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryWindowInMin: (() {
        final guardedValue = map['queryWindowInMin'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      rateLimitQPS: (() {
        final guardedValue = map['rateLimitQPS'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      retryCount: (() {
      ...
      startTimeAttributeName: (() {
        final guardedValue = map['startTimeAttributeName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      timeoutInSeconds: (() {
