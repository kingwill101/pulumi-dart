...
/// }
///
/// resource "azure-native_securityinsights_workspacemanagerconfiguration" "workspaceManagerConfiguration" {
///   mode                                 = "Enabled"
...
class WorkspaceManagerConfiguration extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WorkspaceManagerConfiguration] resource.
  WorkspaceManagerConfiguration.reference(String urn)
    : super(
        'azure-native:securityinsights:WorkspaceManagerConfiguration',
