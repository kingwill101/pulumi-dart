...
class GetEntityInsightsResult {
  ...
  GetEntityInsightsResult({this.metaData, this.value});
  ...
  factory GetEntityInsightsResult.fromMap(Map<String, dynamic> map) {
    return GetEntityInsightsResult(
      metaData: (() {
        ...
        if (guardedValue == null) return null;
        return GetInsightsResultsMetadataResponse.fromMap(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<EntityInsightItemResponse>(
          guardedValue,
          (value) => EntityInsightItemResponse.fromMap(
