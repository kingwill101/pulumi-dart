...
class VmssFabricProfile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'images':
          pulumi
              .Input.mapInputValue<List<PoolImage>, List<Map<String, dynamic>>>(
            images,
            (value) => pulumi.Input.encodeList<PoolImage, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'sku': pulumi.Input.mapInputValue<DevOpsAzureSku, Map<String, dynamic>>(
        sku,
        (value) => value.toMap(),
      ),
      'storageProfile':
  ...
  factory VmssFabricProfile.fromMap(Map<String, dynamic> map) {
    return VmssFabricProfile(
      images: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PoolImage>(
          map['images']!,
          (value) => PoolImage.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      ...
      sku: pulumi.Input.fromValue(
        DevOpsAzureSku.fromMap((map['sku']! as Map).cast<String, dynamic>()),
      ),
      storageProfile: (() {
