...
class PoolImage {
  ...
  final pulumi.Input<dynamic>? ephemeralType;
  ...
  factory PoolImage.fromMap(Map<String, dynamic> map) {
    return PoolImage(
      ...
      ephemeralType: (() { final guardedValue = map['ephemeralType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
