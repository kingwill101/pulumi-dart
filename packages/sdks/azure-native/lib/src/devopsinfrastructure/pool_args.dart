...
class PoolArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agentProfile':
          pulumi.Input.mapInputValue<Stateful, Map<String, dynamic>>(
            agentProfile,
            (value) => value.toMap(),
          ),
      'devCenterProjectResourceId': devCenterProjectResourceId,
      'fabricProfile':
          pulumi.Input.mapInputValue<VmssFabricProfile, Map<String, dynamic>>(
            fabricProfile,
            (value) => value.toMap(),
          ),
      'identity':
      ...
      'organizationProfile':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(organizationProfile, (value) => value.toMap()),
      'poolName': ?poolName,
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      agentProfile: pulumi.Input.fromValue(
        Stateful.fromMap((map['agentProfile']! as Map).cast<String, dynamic>()),
      ),
      devCenterProjectResourceId: pulumi.Input.fromValue(
        map['devCenterProjectResourceId'] as String,
      ),
      fabricProfile: pulumi.Input.fromValue(
        VmssFabricProfile.fromMap(
          (map['fabricProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      identity: (() {
      ...
      maximumConcurrency: pulumi.Input.fromValue(
        map['maximumConcurrency'] as int,
      ),
      organizationProfile: pulumi.Input.fromValue(
        AzureDevOpsOrganizationProfile.fromMap(
          (map['organizationProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      poolName: (() {
