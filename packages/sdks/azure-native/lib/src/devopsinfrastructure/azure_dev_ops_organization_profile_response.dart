...
class AzureDevOpsOrganizationProfileResponse {
  ...
  const AzureDevOpsOrganizationProfileResponse({
    required this.kind,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'kind': kind,
      'organizations': pulumi.Input.mapInputValue<List<OrganizationResponse>, List<Map<String, dynamic>>>(organizations, (value) => pulumi.Input.encodeList<OrganizationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'permissionProfile': ?pulumi.Input.mapOptionalInputValue<AzureDevOpsPermissionProfileResponse, Map<String, dynamic>>(permissionProfile, (value) => value.toMap()),
    };
  }
  ...
  factory AzureDevOpsOrganizationProfileResponse.fromMap(Map<String, dynamic> map) {
    return AzureDevOpsOrganizationProfileResponse(
      ...
      organizations: pulumi.Input.fromValue(pulumi.Input.decodeList<OrganizationResponse>(map['organizations']!, (value) => OrganizationResponse.fromMap((value as Map).cast<String, dynamic>()))),
      permissionProfile: (() { final guardedValue = map['permissionProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureDevOpsPermissionProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
