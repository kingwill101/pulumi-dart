...
class AutomaticResourcePredictionsProfile {
  ...
  final pulumi.Input<dynamic>? predictionPreference;
  ...
  factory AutomaticResourcePredictionsProfile.fromMap(Map<String, dynamic> map) {
    return AutomaticResourcePredictionsProfile(
      ...
      predictionPreference: (() { final guardedValue = map['predictionPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
