  ...
  factory VmssFabricProfileResponse.fromMap(Map<String, dynamic> map) {
    return VmssFabricProfileResponse(
      images: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PoolImageResponse>(
          map['images']!,
          (value) =>
              PoolImageResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      ...
      sku: pulumi.Input.fromValue(
        DevOpsAzureSkuResponse.fromMap(
