...
class OsProfileResponse {
  ...
  final pulumi.Input<SecretsManagementSettingsResponse>?
  ...
  OsProfileResponse({this.logonType, this.secretsManagementSettings});
    ...
    return <String, dynamic>{
      ...
      'secretsManagementSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(secretsManagementSettings, (value) => value.toMap()),
    };
  }
  ...
  factory OsProfileResponse.fromMap(Map<String, dynamic> map) {
    return OsProfileResponse(
      logonType: (() {
        final guardedValue = map['logonType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      secretsManagementSettings: (() {
        final guardedValue = map['secretsManagementSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretsManagementSettingsResponse.fromMap(
