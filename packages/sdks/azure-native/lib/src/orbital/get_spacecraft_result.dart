...
class GetSpacecraftResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'links':
          pulumi.Input.encodeList<SpacecraftLinkResponse, Map<String, dynamic>>(
            links,
            (value) => value.toMap(),
          ),
      'location': location,
  ...
  factory GetSpacecraftResult.fromMap(Map<String, dynamic> map) {
    return GetSpacecraftResult(
      ...
      id: map['id'] as String,
      links: pulumi.Input.decodeList<SpacecraftLinkResponse>(
        map['links']!,
        (value) => SpacecraftLinkResponse.fromMap(
