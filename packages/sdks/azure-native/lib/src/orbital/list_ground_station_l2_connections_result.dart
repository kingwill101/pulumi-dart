...
class ListGroundStationL2ConnectionsResult {
  ...
  ListGroundStationL2ConnectionsResult({required this.nextLink, this.value});
  ...
  factory ListGroundStationL2ConnectionsResult.fromMap(
    ...
    return ListGroundStationL2ConnectionsResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ResourceIdListResultResponseValue>(
          guardedValue,
          (value) => ResourceIdListResultResponseValue.fromMap(
