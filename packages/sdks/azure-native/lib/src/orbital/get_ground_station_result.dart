...
class GetGroundStationResult {
  ...
  factory GetGroundStationResult.fromMap(Map<String, dynamic> map) {
    return GetGroundStationResult(
      altitudeMeters: (() { final guardedValue = map['altitudeMeters']; if (guardedValue == null) return null; return guardedValue as double; })(),
      ...
      id: map['id'] as String,
      latitudeDegrees: (() { final guardedValue = map['latitudeDegrees']; if (guardedValue == null) return null; return guardedValue as double; })(),
      location: map['location'] as String,
      longitudeDegrees: (() { final guardedValue = map['longitudeDegrees']; if (guardedValue == null) return null; return guardedValue as double; })(),
