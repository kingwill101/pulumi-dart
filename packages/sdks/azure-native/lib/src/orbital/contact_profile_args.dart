...
class ContactProfileArgs {
  ...
  final pulumi.Input<ContactProfilesPropertiesNetworkConfiguration>
  ...
  final pulumi.Input<List<ContactProfileThirdPartyConfiguration>>?
    ...
    return <String, dynamic>{
      'autoTrackingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AutoTrackingConfiguration,
            String
          >(autoTrackingConfiguration, (value) => value.wireValue),
      ...
      'thirdPartyConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContactProfileThirdPartyConfiguration>,
            List<Map<String, dynamic>>
          >(
            thirdPartyConfigurations,
            (value) =>
  ...
  factory ContactProfileArgs.fromMap(Map<String, dynamic> map) {
    return ContactProfileArgs(
      autoTrackingConfiguration: (() {
        final guardedValue = map['autoTrackingConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoTrackingConfiguration.fromValue(guardedValue as String),
        );
      })(),
      contactProfileName: (() {
        final guardedValue = map['contactProfileName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eventHubUri: (() {
        final guardedValue = map['eventHubUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      links: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ContactProfileLink>(
          map['links']!,
          (value) => ContactProfileLink.fromMap(
      ...
      minimumElevationDegrees: (() {
        final guardedValue = map['minimumElevationDegrees'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      minimumViableContactDuration: (() {
        final guardedValue = map['minimumViableContactDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkConfiguration: pulumi.Input.fromValue(
        ContactProfilesPropertiesNetworkConfiguration.fromMap(
      ...
      thirdPartyConfigurations: (() {
        final guardedValue = map['thirdPartyConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContactProfileThirdPartyConfiguration>(
            guardedValue,
            (value) => ContactProfileThirdPartyConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
