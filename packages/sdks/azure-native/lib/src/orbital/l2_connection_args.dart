...
class L2ConnectionArgs {
  ...
  factory L2ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return L2ConnectionArgs(
      edgeSite: pulumi.Input.fromValue(L2ConnectionsPropertiesEdgeSite.fromMap((map['edgeSite']! as Map).cast<String, dynamic>())),
      groundStation: pulumi.Input.fromValue(L2ConnectionsPropertiesGroundStation.fromMap((map['groundStation']! as Map).cast<String, dynamic>())),
      groundStationPartnerRouter: pulumi.Input.fromValue(L2ConnectionsPropertiesGroundStationPartnerRouter.fromMap((map['groundStationPartnerRouter']! as Map).cast<String, dynamic>())),
      l2ConnectionName: (() { final guardedValue = map['l2ConnectionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
