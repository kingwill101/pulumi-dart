...
class SpacecraftArgs {
  ...
  factory SpacecraftArgs.fromMap(Map<String, dynamic> map) {
    return SpacecraftArgs(
      ...
      noradId: (() { final guardedValue = map['noradId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      spacecraftName: (() { final guardedValue = map['spacecraftName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
