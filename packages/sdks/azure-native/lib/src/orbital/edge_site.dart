...
class EdgeSite extends pulumi.CustomResource {
  ...
  EdgeSite(
    ...
    globalCommunicationsSite = registerOutput<EdgeSitesPropertiesResponseGlobalCommunicationsSite>('globalCommunicationsSite', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return EdgeSitesPropertiesResponseGlobalCommunicationsSite.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [EdgeSite] resource.
  EdgeSite.reference(String urn)
    : super(
        'azure-native:orbital:EdgeSite',
