...
class EdgeSiteArgs {
  ...
  /// [tags] Resource tags.
  EdgeSiteArgs({
    pulumi.Output<String>? edgeSiteName,
    required pulumi.Output<EdgeSitesPropertiesGlobalCommunicationsSite> globalCommunicationsSite,
  ...
  factory EdgeSiteArgs.fromMap(Map<String, dynamic> map) {
    return EdgeSiteArgs(
      edgeSiteName: map['edgeSiteName'] == null ? null : pulumi.Output.create<String>(map['edgeSiteName'] as String),
      globalCommunicationsSite: pulumi.Output.create<EdgeSitesPropertiesGlobalCommunicationsSite>(EdgeSitesPropertiesGlobalCommunicationsSite.fromMap((map['globalCommunicationsSite'] as Map).cast<String, dynamic>())),
