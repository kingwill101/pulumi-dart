...
class IotHubProperties {
  ...
  final pulumi.Input<List<SharedAccessSignatureAuthorizationRule>>?
  ...
  final pulumi.Input<Map<String, MessagingEndpointProperties>>?
  messagingEndpoints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'messagingEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, MessagingEndpointProperties>,
            Map<String, Map<String, dynamic>>
          >(
            messagingEndpoints,
            (value) =>
      ...
      'storageEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, StorageEndpointProperties>,
            Map<String, Map<String, dynamic>>
          >(
            storageEndpoints,
            (value) =>
    ...
    return IotHubProperties(
      ...
      authorizationPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SharedAccessSignatureAuthorizationRule>(
            guardedValue,
            (value) => SharedAccessSignatureAuthorizationRule.fromMap(
      ...
      cloudToDevice: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudToDeviceProperties.fromMap(
      ...
      eventHubEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<EventHubProperties>(
            guardedValue,
            (value) => EventHubProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      messagingEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<MessagingEndpointProperties>(
            guardedValue,
            (value) => MessagingEndpointProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      networkRuleSets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkRuleSetProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<StorageEndpointProperties>(
            guardedValue,
            (value) => StorageEndpointProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
