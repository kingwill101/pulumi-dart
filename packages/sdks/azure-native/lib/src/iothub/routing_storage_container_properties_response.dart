...
class RoutingStorageContainerPropertiesResponse {
  ...
  /// Creates a new [RoutingStorageContainerPropertiesResponse].
  ...
  factory RoutingStorageContainerPropertiesResponse.fromMap(
