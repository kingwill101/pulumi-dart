...
class RoutingEndpoints {
  ...
  final pulumi.Input<List<RoutingCosmosDBSqlApiProperties>>?
  ...
  final pulumi.Input<List<RoutingServiceBusQueueEndpointProperties>>?
  serviceBusQueues;

  /// The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
  final pulumi.Input<List<RoutingServiceBusTopicEndpointProperties>>?
  serviceBusTopics;

  /// The list of storage container endpoints that IoT hub routes messages to, based on the routing rules.
  final pulumi.Input<List<RoutingStorageContainerProperties>>?
  storageContainers;
    ...
    return <String, dynamic>{
      'cosmosDBSqlContainers':
          ?pulumi.Input.mapOptionalInputValue<
            List<RoutingCosmosDBSqlApiProperties>,
    ...
    return RoutingEndpoints(
      cosmosDBSqlContainers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingCosmosDBSqlApiProperties>(
            guardedValue,
            (value) => RoutingCosmosDBSqlApiProperties.fromMap(
      ...
      eventHubs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingEventHubProperties>(
            guardedValue,
            (value) => RoutingEventHubProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceBusQueues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingServiceBusQueueEndpointProperties>(
            guardedValue,
            (value) => RoutingServiceBusQueueEndpointProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceBusTopics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingServiceBusTopicEndpointProperties>(
            guardedValue,
            (value) => RoutingServiceBusTopicEndpointProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      storageContainers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingStorageContainerProperties>(
            guardedValue,
            (value) => RoutingStorageContainerProperties.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
