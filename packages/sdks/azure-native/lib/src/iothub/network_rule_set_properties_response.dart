...
class NetworkRuleSetPropertiesResponse {
  ...
  factory NetworkRuleSetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkRuleSetPropertiesResponse(
      ...
      ipRules: pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkRuleSetIpRuleResponse>(map['ipRules']!, (value) => NetworkRuleSetIpRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
