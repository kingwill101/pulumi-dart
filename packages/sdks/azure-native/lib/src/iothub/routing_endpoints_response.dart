...
class RoutingEndpointsResponse {
  ...
  final pulumi.Input<List<RoutingCosmosDBSqlApiPropertiesResponse>>?
  ...
  final pulumi.Input<List<RoutingServiceBusQueueEndpointPropertiesResponse>>?
  serviceBusQueues;

  /// The list of Service Bus topic endpoints that the IoT hub routes the messages to, based on the routing rules.
  final pulumi.Input<List<RoutingServiceBusTopicEndpointPropertiesResponse>>?
  serviceBusTopics;

  /// The list of storage container endpoints that IoT hub routes messages to, based on the routing rules.
  final pulumi.Input<List<RoutingStorageContainerPropertiesResponse>>?
  storageContainers;
    ...
    return <String, dynamic>{
      'cosmosDBSqlContainers':
          ?pulumi.Input.mapOptionalInputValue<
            List<RoutingCosmosDBSqlApiPropertiesResponse>,
      ...
      'eventHubs':
          ?pulumi.Input.mapOptionalInputValue<
            List<RoutingEventHubPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            eventHubs,
            (value) =>
      ...
      'serviceBusQueues':
          ?pulumi.Input.mapOptionalInputValue<
            List<RoutingServiceBusQueueEndpointPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            serviceBusQueues,
            (value) =>
      ...
      'serviceBusTopics':
          ?pulumi.Input.mapOptionalInputValue<
            List<RoutingServiceBusTopicEndpointPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            serviceBusTopics,
            (value) =>
      ...
      'storageContainers':
          ?pulumi.Input.mapOptionalInputValue<
            List<RoutingStorageContainerPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            storageContainers,
            (value) =>
  ...
  factory RoutingEndpointsResponse.fromMap(Map<String, dynamic> map) {
    return RoutingEndpointsResponse(
      cosmosDBSqlContainers: (() {
        final guardedValue = map['cosmosDBSqlContainers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingCosmosDBSqlApiPropertiesResponse>(
            guardedValue,
            (value) => RoutingCosmosDBSqlApiPropertiesResponse.fromMap(
      ...
      eventHubs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingEventHubPropertiesResponse>(
            guardedValue,
            (value) => RoutingEventHubPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceBusQueues: (() {
        final guardedValue = map['serviceBusQueues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => RoutingServiceBusQueueEndpointPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serviceBusTopics: (() {
        final guardedValue = map['serviceBusTopics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            RoutingServiceBusTopicEndpointPropertiesResponse
          >(
            guardedValue,
            (value) => RoutingServiceBusTopicEndpointPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      storageContainers: (() {
        final guardedValue = map['storageContainers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingStorageContainerPropertiesResponse>(
            guardedValue,
            (value) => RoutingStorageContainerPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
