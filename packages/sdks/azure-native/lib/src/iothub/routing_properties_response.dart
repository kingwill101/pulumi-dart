...
class RoutingPropertiesResponse {
  ...
  factory RoutingPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RoutingPropertiesResponse(
      endpoints: (() { final guardedValue = map['endpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoutingEndpointsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      enrichments: (() { final guardedValue = map['enrichments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EnrichmentPropertiesResponse>(guardedValue, (value) => EnrichmentPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      fallbackRoute: (() { final guardedValue = map['fallbackRoute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FallbackRoutePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      routes: (() { final guardedValue = map['routes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RoutePropertiesResponse>(guardedValue, (value) => RoutePropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
