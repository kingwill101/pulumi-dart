...
class RoutingPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enrichments':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnrichmentPropertiesResponse>,
    ...
    return RoutingPropertiesResponse(
      endpoints: (() {
        ...
        return pulumi.Input.fromValue(
          RoutingEndpointsResponse.fromMap(
      ...
      enrichments: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnrichmentPropertiesResponse>(
            guardedValue,
            (value) => EnrichmentPropertiesResponse.fromMap(
      ...
      fallbackRoute: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FallbackRoutePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutePropertiesResponse>(
            guardedValue,
            (value) => RoutePropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
