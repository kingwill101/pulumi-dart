...
class IotHubPropertiesResponse {
  ...
  final pulumi.Input<List<SharedAccessSignatureAuthorizationRuleResponse>>?
  ...
  final pulumi.Input<Map<String, EventHubPropertiesResponse>>?
  eventHubEndpoints;
  ...
  final pulumi.Input<Map<String, MessagingEndpointPropertiesResponse>>?
  messagingEndpoints;
  ...
  final pulumi.Input<Map<String, StorageEndpointPropertiesResponse>>?
  storageEndpoints;
    ...
    return <String, dynamic>{
      ...
      'authorizationPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<SharedAccessSignatureAuthorizationRuleResponse>,
      ...
      'eventHubEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, EventHubPropertiesResponse>,
      ...
      'locations':
          pulumi.Input.mapInputValue<
            List<IotHubLocationDescriptionResponse>,
            List<Map<String, dynamic>>
          >(
            locations,
            (value) =>
      ...
      'messagingEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, MessagingEndpointPropertiesResponse>,
            Map<String, Map<String, dynamic>>
          >(
            messagingEndpoints,
            (value) =>
      ...
      'storageEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, StorageEndpointPropertiesResponse>,
            Map<String, Map<String, dynamic>>
          >(
            storageEndpoints,
            (value) =>
    ...
    return IotHubPropertiesResponse(
      ...
      authorizationPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<SharedAccessSignatureAuthorizationRuleResponse>(
            guardedValue,
            (value) => SharedAccessSignatureAuthorizationRuleResponse.fromMap(
      ...
      cloudToDevice: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CloudToDevicePropertiesResponse.fromMap(
      ...
      disableDeviceSAS: (() {
        final guardedValue = map['disableDeviceSAS'];
        if (guardedValue == null) return null;
      ...
      disableModuleSAS: (() {
        final guardedValue = map['disableModuleSAS'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableDataResidency: (() {
      ...
      enableFileUploadNotifications: (() {
        final guardedValue = map['enableFileUploadNotifications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      eventHubEndpoints: (() {
        final guardedValue = map['eventHubEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<EventHubPropertiesResponse>(
            guardedValue,
            (value) => EventHubPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      locations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IotHubLocationDescriptionResponse>(
          map['locations']!,
          (value) => IotHubLocationDescriptionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      messagingEndpoints: (() {
        final guardedValue = map['messagingEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<MessagingEndpointPropertiesResponse>(
            guardedValue,
            (value) => MessagingEndpointPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      networkRuleSets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkRuleSetPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      routing: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutingPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<StorageEndpointPropertiesResponse>(
            guardedValue,
            (value) => StorageEndpointPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
