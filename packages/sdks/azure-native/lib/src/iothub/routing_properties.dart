...
class RoutingProperties {
  ...
  final List<EnrichmentProperties>? enrichments;
  ...
  final FallbackRouteProperties? fallbackRoute;
  /// The list of user-provided routing rules that the IoT hub uses to route messages to built-in and custom endpoints. A maximum of 100 routing rules are allowed for paid hubs and a maximum of 5 routing rules are allowed for free hubs.
  final List<RouteProperties>? routes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enrichments': ?enrichments == null ? null : pulumi.Input.encodeList<EnrichmentProperties, Map<String, dynamic>>(enrichments!, (value) => value.toMap()),
      'fallbackRoute': ?fallbackRoute == null ? null : fallbackRoute!.toMap(),
      'routes': ?routes == null ? null : pulumi.Input.encodeList<RouteProperties, Map<String, dynamic>>(routes!, (value) => value.toMap()),
    };
  }

  factory RoutingProperties.fromMap(Map<String, dynamic> map) {
    return RoutingProperties(
      endpoints: map['endpoints'] == null ? null : RoutingEndpoints.fromMap((map['endpoints'] as Map).cast<String, dynamic>()),
      enrichments: map['enrichments'] == null ? null : pulumi.Input.decodeList<EnrichmentProperties>(map['enrichments'], (value) => EnrichmentProperties.fromMap((value as Map).cast<String, dynamic>())),
      fallbackRoute: map['fallbackRoute'] == null ? null : FallbackRouteProperties.fromMap((map['fallbackRoute'] as Map).cast<String, dynamic>()),
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<RouteProperties>(map['routes'], (value) => RouteProperties.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
