    ...
    return <String, dynamic>{
      ...
      'routes':
          ...
          >(
            routes,
            (value) =>
                pulumi.Input.encodeList<RouteProperties, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory RoutingProperties.fromMap(Map<String, dynamic> map) {
    return RoutingProperties(
      ...
      enrichments: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnrichmentProperties>(
            guardedValue,
            (value) => EnrichmentProperties.fromMap(
      ...
      fallbackRoute: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FallbackRouteProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RouteProperties>(
            guardedValue,
            (value) =>
                RouteProperties.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
