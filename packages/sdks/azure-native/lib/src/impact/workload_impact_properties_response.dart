    ...
    return WorkloadImpactPropertiesResponse(
      ...
      clientIncidentDetails: (() {
        ...
        return pulumi.Input.fromValue(
          ClientIncidentDetailsResponse.fromMap(
      ...
      errorDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ErrorDetailPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      performance: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PerformanceResponse>(
            guardedValue,
            (value) => PerformanceResponse.fromMap(
