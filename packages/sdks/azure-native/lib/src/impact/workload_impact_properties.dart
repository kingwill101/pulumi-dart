...
class WorkloadImpactProperties {
  ...
  factory WorkloadImpactProperties.fromMap(Map<String, dynamic> map) {
    return WorkloadImpactProperties(
      ...
      performance: (() { final guardedValue = map['performance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Performance>(guardedValue, (value) => Performance.fromMap((value as Map).cast<String, dynamic>()))); })(),
      startDateTime: pulumi.Input.fromValue(map['startDateTime'] as String),
      workload: (() { final guardedValue = map['workload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Workload.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
