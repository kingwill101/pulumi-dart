...
class InsightPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'category': category,
      'content':
          pulumi.Input.mapInputValue<ContentResponse, Map<String, dynamic>>(
            content,
            (value) => value.toMap(),
          ),
      'eventId': ?eventId,
  ...
  factory InsightPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return InsightPropertiesResponse(
      ...
      impact: pulumi.Input.fromValue(
        ImpactDetailsResponse.fromMap(
          (map['impact']! as Map).cast<String, dynamic>(),
        ),
      ),
