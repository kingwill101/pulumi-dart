...
class InsightProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'category': category,
      'content': pulumi.Input.mapInputValue<Content, Map<String, dynamic>>(
        content,
        (value) => value.toMap(),
      ),
      'eventId': ?eventId,
      'eventTime': ?eventTime,
      'groupId': ?groupId,
      'impact': pulumi.Input.mapInputValue<ImpactDetails, Map<String, dynamic>>(
        impact,
        (value) => value.toMap(),
      ),
  ...
  factory InsightProperties.fromMap(Map<String, dynamic> map) {
    return InsightProperties(
      additionalDetails: (() {
        final guardedValue = map['additionalDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      category: pulumi.Input.fromValue(map['category'] as String),
      content: pulumi.Input.fromValue(
        Content.fromMap((map['content']! as Map).cast<String, dynamic>()),
      ),
      eventId: (() {
      ...
      impact: pulumi.Input.fromValue(
        ImpactDetails.fromMap((map['impact']! as Map).cast<String, dynamic>()),
      ),
