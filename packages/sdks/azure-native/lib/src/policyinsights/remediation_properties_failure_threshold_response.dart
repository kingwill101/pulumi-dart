...
class RemediationPropertiesFailureThresholdResponse {
  /// A number between 0.0 to 1.0 representing the percentage failure threshold. The remediation will fail if the percentage of failed remediation operations (i.e. failed deployments) exceeds this threshold.
  final pulumi.Input<double?>? percentage;

  /// Creates a new [RemediationPropertiesFailureThresholdResponse].
  ...
  const RemediationPropertiesFailureThresholdResponse({
    this.percentage,
  });
  ...
  factory RemediationPropertiesFailureThresholdResponse.fromMap(Map<String, dynamic> map) {
    return RemediationPropertiesFailureThresholdResponse(
