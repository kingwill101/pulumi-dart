...
/// Result data returned by getRemediationAtResourceGroup.
class GetRemediationAtResourceGroupResult {
  ...
  /// Creates a new [GetRemediationAtResourceGroupResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'failureThreshold': ?failureThreshold == null ? null : failureThreshold!.toMap(),
  ...
  factory GetRemediationAtResourceGroupResult.fromMap(Map<String, dynamic> map) {
    return GetRemediationAtResourceGroupResult(
      ...
      failureThreshold: map['failureThreshold'] == null ? null : RemediationPropertiesResponseFailureThreshold.fromMap((map['failureThreshold']! as Map).cast<String, dynamic>()),
      filters: map['filters'] == null ? null : RemediationFiltersResponse.fromMap((map['filters']! as Map).cast<String, dynamic>()),
      id: map['id'] as String,
