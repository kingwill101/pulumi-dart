...
import 'attestation_at_subscription_args.dart';
...
/// }
///
/// resource "azure-native_policyinsights_attestationatsubscription" "attestationAtSubscription" {
...
class AttestationAtSubscription extends pulumi.CustomResource {
  ...
  /// Creates a new [AttestationAtSubscription].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AttestationAtSubscription]. {@macro pulumi_policyinsights_attestation_at_subscription_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AttestationAtSubscription(
    String name, {
    AttestationAtSubscriptionArgs? args,
  ...
  /// Creates a typed reference to an existing [AttestationAtSubscription] resource.
  AttestationAtSubscription.reference(String urn)
    : super(
        'azure-native:policyinsights:AttestationAtSubscription',
