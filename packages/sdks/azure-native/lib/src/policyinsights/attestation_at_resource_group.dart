...
import 'attestation_at_resource_group_args.dart';
...
class AttestationAtResourceGroup extends pulumi.CustomResource {
  ...
  /// Creates a new [AttestationAtResourceGroup].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AttestationAtResourceGroup]. {@macro pulumi_policyinsights_attestation_at_resource_group_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AttestationAtResourceGroup(
    String name, {
    AttestationAtResourceGroupArgs? args,
    ...
    this.assessmentDate = registerOutput<String?>('assessmentDate');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.comments = registerOutput<String?>('comments');
    this.complianceState = registerOutput<String?>('complianceState');
    this.evidence = registerOutput<List<AttestationEvidenceResponse>?>('evidence');
    this.expiresOn = registerOutput<String?>('expiresOn');
    this.lastComplianceStateChangeAt = registerOutput<String>('lastComplianceStateChangeAt');
