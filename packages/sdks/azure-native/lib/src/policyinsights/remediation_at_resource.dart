...
import 'remediation_at_resource_args.dart';
...
/// }
///
/// resource "azure-native_policyinsights_remediationatresource" "remediationAtResource" {
...
class RemediationAtResource extends pulumi.CustomResource {
  ...
  /// Creates a new [RemediationAtResource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RemediationAtResource]. {@macro pulumi_policyinsights_remediation_at_resource_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RemediationAtResource(
    String name, {
    RemediationAtResourceArgs? args,
  ...
  /// Creates a typed reference to an existing [RemediationAtResource] resource.
  RemediationAtResource.reference(String urn)
    : super(
        'azure-native:policyinsights:RemediationAtResource',
