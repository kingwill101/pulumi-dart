...
class AttestationAtResourceGroupArgs {
  ...
  const AttestationAtResourceGroupArgs({
    this.assessmentDate,
  ...
  factory AttestationAtResourceGroupArgs.fromMap(Map<String, dynamic> map) {
    return AttestationAtResourceGroupArgs(
      assessmentDate: (() { final guardedValue = map['assessmentDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      attestationName: (() { final guardedValue = map['attestationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
