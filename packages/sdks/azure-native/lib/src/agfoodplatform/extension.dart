...
class Extension extends pulumi.CustomResource {
  ...
  Extension(
    ...
    this.additionalApiProperties = registerOutput<Map<String, ApiPropertiesResponse>>('additionalApiProperties');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.eTag = registerOutput<String>('eTag');
    this.extensionApiDocsLink = registerOutput<String>('extensionApiDocsLink');
    this.extensionAuthLink = registerOutput<String>('extensionAuthLink');
    this.extensionCategory = registerOutput<String>('extensionCategory');
    this.extensionId = registerOutput<String>('extensionId');
    this.installedExtensionVersion = registerOutput<String>('installedExtensionVersion');
