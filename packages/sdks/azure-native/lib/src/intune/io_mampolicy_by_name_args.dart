...
class IoMAMPolicyByNameArgs {
  ...
  IoMAMPolicyByNameArgs({
    ...
    pulumi.Output<String>? fileEncryptionLevel,
  ...
  factory IoMAMPolicyByNameArgs.fromMap(Map<String, dynamic> map) {
    return IoMAMPolicyByNameArgs(
      ...
      fileEncryptionLevel: map['fileEncryptionLevel'] == null ? null : pulumi.Output.create<String>(map['fileEncryptionLevel'] as String),
      ...
      touchId: map['touchId'] == null ? null : pulumi.Output.create<String>(map['touchId'] as String),
    );
  }
}
