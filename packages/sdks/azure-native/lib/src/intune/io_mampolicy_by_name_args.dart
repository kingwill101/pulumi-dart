...
class IoMAMPolicyByNameArgs {
  ...
  factory IoMAMPolicyByNameArgs.fromMap(Map<String, dynamic> map) {
    return IoMAMPolicyByNameArgs(
      ...
      fileEncryptionLevel: map['fileEncryptionLevel'] == null ? null : (map['fileEncryptionLevel']! as String).input(),
      ...
      touchId: map['touchId'] == null ? null : (map['touchId']! as String).input(),
    );
  }
}
