...
class Workspace extends pulumi.CustomResource {
  ...
  Workspace(
    ...
    properties = registerOutput<WorkspaceResourcePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WorkspaceResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
