...
class WorkspaceArgs {
  ...
  factory WorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceResourceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
