...
/// ```
class IspCustomer extends pulumi.CustomResource {
  ...
  /// Creates a new [IspCustomer].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [IspCustomer]. {@macro pulumi_connectedcache_isp_customer_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  IspCustomer(
    String name, {
    IspCustomerArgs? args,
  ...
  /// Creates a typed reference to an existing [IspCustomer] resource.
  IspCustomer.reference(String urn)
    : super(
        'azure-native:connectedcache:IspCustomer',
