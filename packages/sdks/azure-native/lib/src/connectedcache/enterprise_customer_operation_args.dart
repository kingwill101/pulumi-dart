...
class EnterpriseCustomerOperationArgs {
  ...
  EnterpriseCustomerOperationArgs({
    ...
    pulumi.Output<CacheNodeOldResponse>? properties,
  ...
  factory EnterpriseCustomerOperationArgs.fromMap(Map<String, dynamic> map) {
    return EnterpriseCustomerOperationArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<CacheNodeOldResponse>(CacheNodeOldResponse.fromMap((map['properties'] as Map).cast<String, dynamic>())),
