...
class EnterpriseMccCacheNodesOperation extends pulumi.CustomResource {
  ...
  EnterpriseMccCacheNodesOperation(
    ...
    properties = registerOutput<CacheNodePropertyResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CacheNodePropertyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [EnterpriseMccCacheNodesOperation] resource.
  EnterpriseMccCacheNodesOperation.reference(String urn)
    : super(
        'azure-native:connectedcache:EnterpriseMccCacheNodesOperation',
