...
/// }
///
/// resource "azure-native_connectedcache_enterprisemcccustomer" "enterpriseMccCustomer" {
...
class EnterpriseMccCustomer extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [EnterpriseMccCustomer] resource.
  EnterpriseMccCustomer.reference(String urn)
    : super(
        'azure-native:connectedcache:EnterpriseMccCustomer',
