...
class MccCacheNodeIssueHistoryPropertiesResponse {
  ...
  factory MccCacheNodeIssueHistoryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MccCacheNodeIssueHistoryPropertiesResponse(
      ...
      mccIssueHistory: (() { final guardedValue = map['mccIssueHistory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MccIssueResponse>(guardedValue, (value) => MccIssueResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
