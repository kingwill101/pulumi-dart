...
class AdditionalCacheNodePropertiesResponse {
  ...
  final pulumi.Input<List<CacheNodeDriveConfigurationResponse>>?
  driveConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'driveConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            List<CacheNodeDriveConfigurationResponse>,
      ...
      'proxyUrlConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(proxyUrlConfiguration, (value) => value.toMap()),
  ...
  factory AdditionalCacheNodePropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AdditionalCacheNodePropertiesResponse(
      aggregatedStatusCode: pulumi.Input.fromValue(
        map['aggregatedStatusCode'] as int,
      ),
      aggregatedStatusDetails: pulumi.Input.fromValue(
        map['aggregatedStatusDetails'] as String,
      ),
      aggregatedStatusText: pulumi.Input.fromValue(
        map['aggregatedStatusText'] as String,
      ),
      autoUpdateAppliedVersion: pulumi.Input.fromValue(
        map['autoUpdateAppliedVersion'] as String,
      ),
      autoUpdateLastAppliedDateTime: pulumi.Input.fromValue(
        map['autoUpdateLastAppliedDateTime'] as String,
      ),
      autoUpdateLastAppliedDetails: pulumi.Input.fromValue(
        map['autoUpdateLastAppliedDetails'] as String,
      ),
      autoUpdateLastAppliedState: pulumi.Input.fromValue(
        map['autoUpdateLastAppliedState'] as String,
      ),
      autoUpdateLastTriggeredDateTime: pulumi.Input.fromValue(
        map['autoUpdateLastTriggeredDateTime'] as String,
      ),
      autoUpdateNextAvailableDateTime: pulumi.Input.fromValue(
        map['autoUpdateNextAvailableDateTime'] as String,
      ),
      autoUpdateNextAvailableVersion: pulumi.Input.fromValue(
        map['autoUpdateNextAvailableVersion'] as String,
      ),
      autoUpdateVersion: (() {
        final guardedValue = map['autoUpdateVersion'];
      ...
      bgpConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          BgpConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      cacheNodePropertiesDetailsIssuesList: (() {
        final guardedValue = map['cacheNodePropertiesDetailsIssuesList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      cacheNodeState: pulumi.Input.fromValue(map['cacheNodeState'] as int),
      cacheNodeStateDetailedText: pulumi.Input.fromValue(
        map['cacheNodeStateDetailedText'] as String,
      ),
      cacheNodeStateShortText: pulumi.Input.fromValue(
        map['cacheNodeStateShortText'] as String,
      ),
      driveConfiguration: (() {
        final guardedValue = map['driveConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CacheNodeDriveConfigurationResponse>(
            guardedValue,
            (value) => CacheNodeDriveConfigurationResponse.fromMap(
      ...
      isProxyRequired: (() {
        final guardedValue = map['isProxyRequired'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      optionalProperty1: (() {
      ...
      proxyUrlConfiguration: (() {
        final guardedValue = map['proxyUrlConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProxyUrlConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      updateCycleType: (() {
        final guardedValue = map['updateCycleType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      updateInfoDetails: (() {
        final guardedValue = map['updateInfoDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      updateRequestedDateTime: (() {
        final guardedValue = map['updateRequestedDateTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
