...
/// }
///
/// resource "azure-native_connectedcache_ispcachenodesoperation" "ispCacheNodesOperation" {
...
class IspCacheNodesOperation extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [IspCacheNodesOperation] resource.
  IspCacheNodesOperation.reference(String urn)
    : super(
        'azure-native:connectedcache:IspCacheNodesOperation',
