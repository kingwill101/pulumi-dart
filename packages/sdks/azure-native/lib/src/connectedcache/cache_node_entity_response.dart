...
class CacheNodeEntityResponse {
  ...
  factory CacheNodeEntityResponse.fromMap(Map<String, dynamic> map) {
    return CacheNodeEntityResponse(
      addressSpace: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['addressSpace'])),
      ...
      bgpAddressSpace: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['bgpAddressSpace'])),
      bgpCidrBlocksCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['bgpCidrBlocksCount'])),
      bgpCidrCsvLastUpdateTime: pulumi.Input.fromValue(map['bgpCidrCsvLastUpdateTime'] as String),
      bgpFileBytesTruncated: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['bgpFileBytesTruncated'])),
      bgpLastReportedTime: pulumi.Input.fromValue(map['bgpLastReportedTime'] as String),
      bgpNumberOfRecords: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['bgpNumberOfRecords'])),
      bgpNumberOfTimesUpdated: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['bgpNumberOfTimesUpdated'])),
      ...
      containerResyncTrigger: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['containerResyncTrigger'])),
      ...
      maxAllowableProbability: pulumi.Input.fromValue((map['maxAllowableProbability'] as num).toDouble()),
      releaseVersion: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['releaseVersion'])),
      reviewFeedback: pulumi.Input.fromValue(map['reviewFeedback'] as String),
      reviewState: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['reviewState'])),
      ...
      workerConnections: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['workerConnections'])),
