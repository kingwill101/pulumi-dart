  ...
  factory CacheNodeEntityResponse.fromMap(Map<String, dynamic> map) {
    return CacheNodeEntityResponse(
      ...
      autoUpdateRequestedDay: (() {
        final guardedValue = map['autoUpdateRequestedDay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autoUpdateRequestedTime: (() {
        final guardedValue = map['autoUpdateRequestedTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      autoUpdateRequestedWeek: (() {
        final guardedValue = map['autoUpdateRequestedWeek'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      autoUpdateRingType: (() {
        final guardedValue = map['autoUpdateRingType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bgpAddressSpace: pulumi.Input.fromValue(map['bgpAddressSpace'] as int),
      bgpCidrBlocksCount: pulumi.Input.fromValue(
        map['bgpCidrBlocksCount'] as int,
      ),
      bgpCidrCsvLastUpdateTime: pulumi.Input.fromValue(
        map['bgpCidrCsvLastUpdateTime'] as String,
      ),
      bgpFileBytesTruncated: pulumi.Input.fromValue(
        map['bgpFileBytesTruncated'] as int,
      ),
      bgpLastReportedTime: pulumi.Input.fromValue(
        map['bgpLastReportedTime'] as String,
      ),
      bgpNumberOfRecords: pulumi.Input.fromValue(
        map['bgpNumberOfRecords'] as int,
      ),
      bgpNumberOfTimesUpdated: pulumi.Input.fromValue(
        map['bgpNumberOfTimesUpdated'] as int,
      ),
      bgpReviewFeedback: pulumi.Input.fromValue(
        map['bgpReviewFeedback'] as String,
      ),
      bgpReviewState: pulumi.Input.fromValue(map['bgpReviewState'] as String),
      bgpReviewStateText: pulumi.Input.fromValue(
        map['bgpReviewStateText'] as String,
      ),
      cacheNodeId: (() {
      ...
      cacheNodeName: (() {
        final guardedValue = map['cacheNodeName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      category: pulumi.Input.fromValue(map['category'] as String),
      cidrCsv: (() {
        final guardedValue = map['cidrCsv'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      cidrCsvLastUpdateTime: pulumi.Input.fromValue(
        map['cidrCsvLastUpdateTime'] as String,
      ),
      cidrSelectionType: (() {
        final guardedValue = map['cidrSelectionType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ...
      configurationStateText: pulumi.Input.fromValue(
        map['configurationStateText'] as String,
      ),
      containerConfigurations: pulumi.Input.fromValue(
        map['containerConfigurations'] as String,
      ),
      containerResyncTrigger: pulumi.Input.fromValue(
        map['containerResyncTrigger'] as int,
      ),
      createAsyncOperationId: pulumi.Input.fromValue(
        map['createAsyncOperationId'] as String,
      ),
      customerAsn: (() {
      ...
      customerIndex: (() {
        final guardedValue = map['customerIndex'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customerName: (() {
      ...
      deleteAsyncOperationId: pulumi.Input.fromValue(
        map['deleteAsyncOperationId'] as String,
      ),
      fullyQualifiedDomainName: (() {
        final guardedValue = map['fullyQualifiedDomainName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      lastSyncWithAzureTimestamp: pulumi.Input.fromValue(
        map['lastSyncWithAzureTimestamp'] as String,
      ),
      lastUpdatedTimestamp: pulumi.Input.fromValue(
        map['lastUpdatedTimestamp'] as String,
      ),
      maxAllowableEgressInMbps: (() {
        final guardedValue = map['maxAllowableEgressInMbps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxAllowableProbability: pulumi.Input.fromValue(
        map['maxAllowableProbability'] as double,
      ),
      ...
      synchWithAzureAttemptsCount: pulumi.Input.fromValue(
        map['synchWithAzureAttemptsCount'] as int,
      ),
      workerConnections: pulumi.Input.fromValue(
        map['workerConnections'] as int,
      ),
      workerConnectionsLastUpdatedDateTime: pulumi.Input.fromValue(
        map['workerConnectionsLastUpdatedDateTime'] as String,
      ),
