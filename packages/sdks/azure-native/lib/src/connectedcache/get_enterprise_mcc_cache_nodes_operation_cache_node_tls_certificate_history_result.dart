...
class GetEnterpriseMccCacheNodesOperationCacheNodeTlsCertificateHistoryResult {
  ...
  const GetEnterpriseMccCacheNodesOperationCacheNodeTlsCertificateHistoryResult({
    this.id,
    this.location,
    this.name,
    this.properties,
  ...
  factory GetEnterpriseMccCacheNodesOperationCacheNodeTlsCertificateHistoryResult.fromMap(Map<String, dynamic> map) {
    return GetEnterpriseMccCacheNodesOperationCacheNodeTlsCertificateHistoryResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return MccCacheNodeTlsCertificatePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
