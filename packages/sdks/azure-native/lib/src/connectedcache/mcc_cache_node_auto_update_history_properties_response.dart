...
class MccCacheNodeAutoUpdateHistoryPropertiesResponse {
  ...
  final pulumi.Input<List<MccCacheNodeAutoUpdateInfoResponse>>?
  autoUpdateHistory;
    ...
    return <String, dynamic>{
      'autoUpdateHistory':
          ?pulumi.Input.mapOptionalInputValue<
            List<MccCacheNodeAutoUpdateInfoResponse>,
  ...
  factory MccCacheNodeAutoUpdateHistoryPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return MccCacheNodeAutoUpdateHistoryPropertiesResponse(
      autoUpdateHistory: (() {
        final guardedValue = map['autoUpdateHistory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MccCacheNodeAutoUpdateInfoResponse>(
            guardedValue,
            (value) => MccCacheNodeAutoUpdateInfoResponse.fromMap(
