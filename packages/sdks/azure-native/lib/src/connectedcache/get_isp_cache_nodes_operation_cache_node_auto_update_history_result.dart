...
/// Result data returned by getIspCacheNodesOperationCacheNodeAutoUpdateHistory.
class GetIspCacheNodesOperationCacheNodeAutoUpdateHistoryResult {
  ...
  /// Creates a new [GetIspCacheNodesOperationCacheNodeAutoUpdateHistoryResult].
  ...
  const GetIspCacheNodesOperationCacheNodeAutoUpdateHistoryResult({
    required this.id,
