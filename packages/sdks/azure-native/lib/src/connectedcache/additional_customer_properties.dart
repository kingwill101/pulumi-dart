...
class AdditionalCustomerProperties {
  ...
  final pulumi.Input<dynamic>? customerTransitState;
  ...
  factory AdditionalCustomerProperties.fromMap(Map<String, dynamic> map) {
    return AdditionalCustomerProperties(
      ...
      customerTransitState: (() { final guardedValue = map['customerTransitState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
