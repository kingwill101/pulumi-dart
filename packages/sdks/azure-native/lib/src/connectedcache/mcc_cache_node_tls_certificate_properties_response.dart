...
class MccCacheNodeTlsCertificatePropertiesResponse {
  ...
  factory MccCacheNodeTlsCertificatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MccCacheNodeTlsCertificatePropertiesResponse(
      ...
      tlsCertificateHistory: (() { final guardedValue = map['tlsCertificateHistory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MccCacheNodeTlsCertificateResponse>(guardedValue, (value) => MccCacheNodeTlsCertificateResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
