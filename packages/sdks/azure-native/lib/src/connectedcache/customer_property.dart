...
class CustomerProperty {
  ...
  final pulumi.Input<AdditionalCustomerProperties>?
  ...
  CustomerProperty({this.additionalCustomerProperties, this.customer});
    ...
    return CustomerProperty(
      additionalCustomerProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AdditionalCustomerProperties.fromMap(
      ...
      customer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomerEntity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
