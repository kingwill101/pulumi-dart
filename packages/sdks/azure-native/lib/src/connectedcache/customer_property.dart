...
class CustomerProperty {
  ...
  factory CustomerProperty.fromMap(Map<String, dynamic> map) {
    return CustomerProperty(
      additionalCustomerProperties: (() { final guardedValue = map['additionalCustomerProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdditionalCustomerProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      customer: (() { final guardedValue = map['customer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomerEntity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
