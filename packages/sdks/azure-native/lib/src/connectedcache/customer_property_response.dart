...
class CustomerPropertyResponse {
  ...
  final pulumi.Input<AdditionalCustomerPropertiesResponse>?
    ...
    return <String, dynamic>{
      'additionalCustomerProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(additionalCustomerProperties, (value) => value.toMap()),
      'customer':
          ?pulumi.Input.mapOptionalInputValue<
            CustomerEntityResponse,
            Map<String, dynamic>
          >(customer, (value) => value.toMap()),
      'error':
  ...
  factory CustomerPropertyResponse.fromMap(Map<String, dynamic> map) {
    return CustomerPropertyResponse(
      additionalCustomerProperties: (() {
        final guardedValue = map['additionalCustomerProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AdditionalCustomerPropertiesResponse.fromMap(
      ...
      customer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomerEntityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
