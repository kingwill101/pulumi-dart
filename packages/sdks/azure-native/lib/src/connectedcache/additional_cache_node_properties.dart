...
class AdditionalCacheNodeProperties {
  ...
  final pulumi.Input<dynamic>? isProxyRequired;
  ...
  /// Update Cycle Type
  final pulumi.Input<dynamic>? updateCycleType;
  ...
  factory AdditionalCacheNodeProperties.fromMap(Map<String, dynamic> map) {
    return AdditionalCacheNodeProperties(
      ...
      isProxyRequired: (() { final guardedValue = map['isProxyRequired']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      updateCycleType: (() { final guardedValue = map['updateCycleType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
