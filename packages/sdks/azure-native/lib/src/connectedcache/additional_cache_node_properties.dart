...
class AdditionalCacheNodeProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'driveConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            List<CacheNodeDriveConfiguration>,
  ...
  factory AdditionalCacheNodeProperties.fromMap(Map<String, dynamic> map) {
    return AdditionalCacheNodeProperties(
      ...
      driveConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CacheNodeDriveConfiguration>(
            guardedValue,
            (value) => CacheNodeDriveConfiguration.fromMap(
