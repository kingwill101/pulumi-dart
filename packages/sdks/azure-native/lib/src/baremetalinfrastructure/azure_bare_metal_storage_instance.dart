...
/// }
///
/// resource "azure-native_baremetalinfrastructure_azurebaremetalstorageinstance" "azureBareMetalStorageInstance" {
...
class AzureBareMetalStorageInstance extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [AzureBareMetalStorageInstance] resource.
  AzureBareMetalStorageInstance.reference(String urn)
    : super(
        'azure-native:baremetalinfrastructure:AzureBareMetalStorageInstance',
