...
class HardwareProfile {
  ...
  final pulumi.Input<dynamic>? azureBareMetalInstanceSize;
  ...
  factory HardwareProfile.fromMap(Map<String, dynamic> map) {
    return HardwareProfile(
      azureBareMetalInstanceSize: (() { final guardedValue = map['azureBareMetalInstanceSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
