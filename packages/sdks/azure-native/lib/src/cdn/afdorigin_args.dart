...
class AFDOriginArgs {
  ...
  final pulumi.Input<SharedPrivateLinkResourceProperties>?
    ...
    return <String, dynamic>{
      ...
      'sharedPrivateLinkResource':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sharedPrivateLinkResource, (value) => value.toMap()),
      'weight': ?weight,
    };
  }
  ...
  factory AFDOriginArgs.fromMap(Map<String, dynamic> map) {
    return AFDOriginArgs(
      ...
      originName: (() {
        final guardedValue = map['originName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      priority: (() {
      ...
      sharedPrivateLinkResource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SharedPrivateLinkResourceProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
