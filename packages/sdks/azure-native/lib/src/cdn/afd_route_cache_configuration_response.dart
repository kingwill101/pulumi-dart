...
class AfdRouteCacheConfigurationResponse {
  ...
  factory AfdRouteCacheConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return AfdRouteCacheConfigurationResponse(
      compressionSettings: (() { final guardedValue = map['compressionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CompressionSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
