...
class GetPolicyResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpointLinks': pulumi.Input.encodeList<CdnEndpointResponse, Map<String, dynamic>>(endpointLinks, (value) => value.toMap()),
      'etag': ?etag,
      ...
      'rateLimitRules': ?rateLimitRules == null ? null : rateLimitRules!.toMap(),
