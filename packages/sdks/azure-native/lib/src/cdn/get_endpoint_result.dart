...
class GetEndpointResult {
  ...
  }) : isHttpAllowed = isHttpAllowed ?? true, isHttpsAllowed = isHttpsAllowed ?? true, queryStringCachingBehavior = queryStringCachingBehavior ?? 'NotSet';

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'azureApiVersion': ?azureApiVersion,
      'contentTypesToCompress': ?contentTypesToCompress,
      'customDomains': ?(() { final guardedValue = customDomains; if (guardedValue == null) return null; return pulumi.Input.encodeList<DeepCreatedCustomDomainResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'origins': ?(() { final guardedValue = origins; if (guardedValue == null) return null; return pulumi.Input.encodeList<DeepCreatedOriginResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'probePath': ?probePath,
  ...
  factory GetEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointResult(
      ...
      customDomains: (() { final guardedValue = map['customDomains']; if (guardedValue == null) return null; return pulumi.Input.decodeList<DeepCreatedCustomDomainResponse>(guardedValue, (value) => DeepCreatedCustomDomainResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      origins: (() { final guardedValue = map['origins']; if (guardedValue == null) return null; return pulumi.Input.decodeList<DeepCreatedOriginResponse>(guardedValue, (value) => DeepCreatedOriginResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
