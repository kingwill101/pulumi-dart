...
class GetEndpointResult {
  ...
  final EndpointPropertiesUpdateParametersDeliveryPolicyResponse?
  deliveryPolicy;
  ...
  final EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLinkResponse?
    ...
    return <String, dynamic>{
      ...
      'customDomains':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(customDomains, (value) => value.toMap()),
      'defaultOriginGroup': ?defaultOriginGroup?.toMap(),
      'deliveryPolicy': ?deliveryPolicy?.toMap(),
      'geoFilters': ?(() {
        final guardedValue = geoFilters;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<GeoFilterResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
      ...
      'originGroups': ?(() {
        final guardedValue = originGroups;
        if (guardedValue == null) return null;
      ...
      'type': type,
      'urlSigningKeys': ?(() {
        final guardedValue = urlSigningKeys;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointResult(
      ...
      customDomains: pulumi.Input.decodeList<DeepCreatedCustomDomainResponse>(
        map['customDomains']!,
        (value) => DeepCreatedCustomDomainResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      defaultOriginGroup: (() {
        final guardedValue = map['defaultOriginGroup'];
        if (guardedValue == null) return null;
      ...
      geoFilters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GeoFilterResponse>(
          guardedValue,
          (value) =>
              GeoFilterResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      originGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<DeepCreatedOriginGroupResponse>(
          guardedValue,
          (value) => DeepCreatedOriginGroupResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      origins: pulumi.Input.decodeList<DeepCreatedOriginResponse>(
        map['origins']!,
        (value) => DeepCreatedOriginResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      probePath: (() {
      ...
      urlSigningKeys: (() {
        final guardedValue = map['urlSigningKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<UrlSigningKeyResponse>(
          guardedValue,
          (value) => UrlSigningKeyResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
