    ...
    return <String, dynamic>{
      'rules':
          ...
          >(
            rules,
            (value) =>
                pulumi.Input.encodeList<RateLimitRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return RateLimitRuleList(
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RateLimitRule>(
            guardedValue,
            (value) =>
                RateLimitRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
