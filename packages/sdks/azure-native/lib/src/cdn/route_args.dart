...
class RouteArgs {
  ...
  RouteArgs({
    pulumi.Output<AfdRouteCacheConfiguration>? cacheConfiguration,
    pulumi.Output<List<ActivatedResourceReference>>? customDomains,
    ...
    pulumi.Output<String>? linkToDefaultDomain,
    pulumi.Output<ResourceReference>? originGroup,
    pulumi.Output<String>? originPath,
    pulumi.Output<List<String>>? patternsToMatch,
    required pulumi.Output<String> profileName,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? routeName,
    pulumi.Output<List<ResourceReference>>? ruleSets,
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      cacheConfiguration: map['cacheConfiguration'] == null ? null : pulumi.Output.create<AfdRouteCacheConfiguration>(AfdRouteCacheConfiguration.fromMap((map['cacheConfiguration'] as Map).cast<String, dynamic>())),
      customDomains: map['customDomains'] == null ? null : pulumi.Output.create<List<ActivatedResourceReference>>(pulumi.Input.decodeList<ActivatedResourceReference>(map['customDomains'], (value) => ActivatedResourceReference.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      linkToDefaultDomain: map['linkToDefaultDomain'] == null ? null : pulumi.Output.create<String>(map['linkToDefaultDomain'] as String),
      originGroup: map['originGroup'] == null ? null : pulumi.Output.create<ResourceReference>(ResourceReference.fromMap((map['originGroup'] as Map).cast<String, dynamic>())),
      originPath: map['originPath'] == null ? null : pulumi.Output.create<String>(map['originPath'] as String),
      patternsToMatch: map['patternsToMatch'] == null ? null : pulumi.Output.create<List<String>>((map['patternsToMatch'] as List).cast<String>()),
      ...
      ruleSets: map['ruleSets'] == null ? null : pulumi.Output.create<List<ResourceReference>>(pulumi.Input.decodeList<ResourceReference>(map['ruleSets'], (value) => ResourceReference.fromMap((value as Map).cast<String, dynamic>()))),
