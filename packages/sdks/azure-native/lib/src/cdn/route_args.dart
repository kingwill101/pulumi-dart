...
class RouteArgs {
  ...
  final pulumi.Input<dynamic>? httpsRedirect;
  /// whether this route will be linked to the default endpoint domain.
  final pulumi.Input<dynamic>? linkToDefaultDomain;
  ...
  final pulumi.Input<List<dynamic>?>? supportedProtocols;
  ...
  RouteArgs({
    ...
    pulumi.Input<dynamic>? forwardingProtocol,
    pulumi.Input<dynamic>? httpsRedirect,
    pulumi.Input<dynamic>? linkToDefaultDomain,
    this.originGroup,
    this.originPath,
  ...
  }) : forwardingProtocol = forwardingProtocol ?? pulumi.Input.fromValue('MatchRequest'), httpsRedirect = httpsRedirect ?? pulumi.Input.fromValue('Disabled'), linkToDefaultDomain = linkToDefaultDomain ?? pulumi.Input.fromValue('Disabled');
  ...
  factory RouteArgs.fromMap(Map<String, dynamic> map) {
    return RouteArgs(
      ...
      httpsRedirect: (() { final guardedValue = map['httpsRedirect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      linkToDefaultDomain: (() { final guardedValue = map['linkToDefaultDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      supportedProtocols: (() { final guardedValue = map['supportedProtocols']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
    );
  }
}
