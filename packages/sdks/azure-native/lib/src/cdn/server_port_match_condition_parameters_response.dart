...
class ServerPortMatchConditionParametersResponse {
  ...
  /// Creates a new [ServerPortMatchConditionParametersResponse].
  ...
  const ServerPortMatchConditionParametersResponse({
    this.matchValues,
  ...
  factory ServerPortMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return ServerPortMatchConditionParametersResponse(
