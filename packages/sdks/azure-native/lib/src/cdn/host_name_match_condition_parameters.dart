...
class HostNameMatchConditionParameters {
  ...
  /// Creates a new [HostNameMatchConditionParameters].
  ...
  factory HostNameMatchConditionParameters.fromMap(Map<String, dynamic> map) {
    return HostNameMatchConditionParameters(
