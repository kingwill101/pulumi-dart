...
class EndpointArgs {
  ...
  final pulumi.Input<EndpointPropertiesUpdateParametersDeliveryPolicy>?
  deliveryPolicy;
    ...
    return <String, dynamic>{
      ...
      'defaultOriginGroup':
          ?pulumi.Input.mapOptionalInputValue<
            ResourceReference,
            Map<String, dynamic>
          >(defaultOriginGroup, (value) => value.toMap()),
      'deliveryPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            EndpointPropertiesUpdateParametersDeliveryPolicy,
            Map<String, dynamic>
          >(deliveryPolicy, (value) => value.toMap()),
      ...
      'geoFilters':
          ...
          >(
            geoFilters,
            (value) => pulumi.Input.encodeList<GeoFilter, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'queryStringCachingBehavior':
          ?pulumi.Input.mapOptionalInputValue<
            QueryStringCachingBehavior,
            String
          >(queryStringCachingBehavior, (value) => value.wireValue),
      ...
      'urlSigningKeys':
          ...
          >(
            urlSigningKeys,
            (value) =>
                pulumi.Input.encodeList<UrlSigningKey, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      deliveryPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointPropertiesUpdateParametersDeliveryPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      geoFilters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GeoFilter>(
            guardedValue,
            (value) =>
                GeoFilter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      originGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeepCreatedOriginGroup>(
            guardedValue,
            (value) => DeepCreatedOriginGroup.fromMap(
      ...
      origins: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeepCreatedOrigin>(
          map['origins']!,
          (value) =>
              DeepCreatedOrigin.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      probePath: (() {
      ...
      queryStringCachingBehavior: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          QueryStringCachingBehavior.fromValue(guardedValue as String),
        );
      })(),
      ...
      urlSigningKeys: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UrlSigningKey>(
            guardedValue,
            (value) =>
                UrlSigningKey.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      webApplicationFirewallPolicyLink: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
