...
class EndpointArgs {
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      defaultOriginGroup: map['defaultOriginGroup'] == null ? null : (ResourceReference.fromMap((map['defaultOriginGroup']! as Map).cast<String, dynamic>())).input(),
      deliveryPolicy: map['deliveryPolicy'] == null ? null : (EndpointPropertiesUpdateParametersDeliveryPolicy.fromMap((map['deliveryPolicy']! as Map).cast<String, dynamic>())).input(),
      endpointName: map['endpointName'] == null ? null : (map['endpointName']! as String).input(),
      geoFilters: map['geoFilters'] == null ? null : (pulumi.Input.decodeList<GeoFilter>(map['geoFilters']!, (value) => GeoFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      originGroups: map['originGroups'] == null ? null : (pulumi.Input.decodeList<DeepCreatedOriginGroup>(map['originGroups']!, (value) => DeepCreatedOriginGroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      origins: (pulumi.Input.decodeList<DeepCreatedOrigin>(map['origins'], (value) => DeepCreatedOrigin.fromMap((value as Map).cast<String, dynamic>()))).input(),
      probePath: map['probePath'] == null ? null : (map['probePath']! as String).input(),
      profileName: (map['profileName'] as String).input(),
      queryStringCachingBehavior: map['queryStringCachingBehavior'] == null ? null : (QueryStringCachingBehavior.fromValue(map['queryStringCachingBehavior']! as String)).input(),
      resourceGroupName: (map['resourceGroupName'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      urlSigningKeys: map['urlSigningKeys'] == null ? null : (pulumi.Input.decodeList<UrlSigningKey>(map['urlSigningKeys']!, (value) => UrlSigningKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      webApplicationFirewallPolicyLink: map['webApplicationFirewallPolicyLink'] == null ? null : (EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink.fromMap((map['webApplicationFirewallPolicyLink']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
