...
class RequestBodyMatchConditionParametersResponse {
  ...
  /// Creates a new [RequestBodyMatchConditionParametersResponse].
  ...
  const RequestBodyMatchConditionParametersResponse({
    this.matchValues,
  ...
  factory RequestBodyMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return RequestBodyMatchConditionParametersResponse(
