...
class SecurityPolicyWebApplicationFirewallAssociationResponse {
  ...
  const SecurityPolicyWebApplicationFirewallAssociationResponse({
    this.domains,
  ...
  factory SecurityPolicyWebApplicationFirewallAssociationResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyWebApplicationFirewallAssociationResponse(
      domains: (() { final guardedValue = map['domains']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ActivatedResourceReferenceResponse>(guardedValue, (value) => ActivatedResourceReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
