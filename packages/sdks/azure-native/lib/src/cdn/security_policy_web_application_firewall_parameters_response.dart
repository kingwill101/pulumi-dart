...
class SecurityPolicyWebApplicationFirewallParametersResponse {
  ...
  factory SecurityPolicyWebApplicationFirewallParametersResponse.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyWebApplicationFirewallParametersResponse(
      associations: (() { final guardedValue = map['associations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecurityPolicyWebApplicationFirewallAssociationResponse>(guardedValue, (value) => SecurityPolicyWebApplicationFirewallAssociationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      type: pulumi.Input.fromValue(map['type'] as String),
      wafPolicy: (() { final guardedValue = map['wafPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
