...
class UrlFileNameMatchConditionParametersResponse {
  ...
  /// Creates a new [UrlFileNameMatchConditionParametersResponse].
  ...
  const UrlFileNameMatchConditionParametersResponse({
    this.matchValues,
  ...
  factory UrlFileNameMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return UrlFileNameMatchConditionParametersResponse(
