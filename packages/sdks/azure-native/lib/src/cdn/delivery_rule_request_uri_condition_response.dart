...
class DeliveryRuleRequestUriConditionResponse {
  ...
  const DeliveryRuleRequestUriConditionResponse({
    required this.name,
  ...
  factory DeliveryRuleRequestUriConditionResponse.fromMap(Map<String, dynamic> map) {
    return DeliveryRuleRequestUriConditionResponse(
      ...
      parameters: pulumi.Input.fromValue(RequestUriMatchConditionParametersResponse.fromMap((map['parameters']! as Map).cast<String, dynamic>())),
    );
  }
}
