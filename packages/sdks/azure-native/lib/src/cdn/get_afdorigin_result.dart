...
class GetAFDOriginResult {
  ...
  GetAFDOriginResult({
    ...
    this.type,
    this.weight,
  }) : enforceCertificateNameCheck = enforceCertificateNameCheck ?? true, httpPort = httpPort ?? 80, httpsPort = httpsPort ?? 443;
  ...
  factory GetAFDOriginResult.fromMap(Map<String, dynamic> map) {
    return GetAFDOriginResult(
      ...
      azureOrigin: (() { final guardedValue = map['azureOrigin']; if (guardedValue == null) return null; return ResourceReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      enforceCertificateNameCheck: (() { final guardedValue = map['enforceCertificateNameCheck']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      ...
      originGroupName: (() { final guardedValue = map['originGroupName']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      sharedPrivateLinkResource: (() { final guardedValue = map['sharedPrivateLinkResource']; if (guardedValue == null) return null; return SharedPrivateLinkResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
