...
/// }
///
/// resource "azure-native_cdn_afdorigingroup" "afdOriginGroup" {
///   authentication = {
///     scope = "https://www.contoso.com/.default"
...
class AFDOriginGroup extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [AFDOriginGroup] resource.
  AFDOriginGroup.reference(String urn)
    : super(
        'azure-native:cdn:AFDOriginGroup',
