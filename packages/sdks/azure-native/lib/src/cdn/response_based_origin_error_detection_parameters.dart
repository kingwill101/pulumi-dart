...
class ResponseBasedOriginErrorDetectionParameters {
  ...
  final pulumi.Input<ResponseBasedDetectedErrorTypes>?
    ...
    return <String, dynamic>{
      ...
      'responseBasedDetectedErrorTypes':
          ?pulumi.Input.mapOptionalInputValue<
            ResponseBasedDetectedErrorTypes,
            String
          >(responseBasedDetectedErrorTypes, (value) => value.wireValue),
      'responseBasedFailoverThresholdPercentage':
          ?responseBasedFailoverThresholdPercentage,
    };
  }

  factory ResponseBasedOriginErrorDetectionParameters.fromMap(
    Map<String, dynamic> map,
  ) {
    return ResponseBasedOriginErrorDetectionParameters(
      httpErrorRanges: (() {
        final guardedValue = map['httpErrorRanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpErrorRangeParameters>(
            guardedValue,
            (value) => HttpErrorRangeParameters.fromMap(
      ...
      responseBasedDetectedErrorTypes: (() {
        final guardedValue = map['responseBasedDetectedErrorTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResponseBasedDetectedErrorTypes.fromValue(guardedValue as String),
        );
      })(),
      responseBasedFailoverThresholdPercentage: (() {
        final guardedValue = map['responseBasedFailoverThresholdPercentage'];
        if (guardedValue == null) return null;
