...
class ProfileLogScrubbing {
  ...
  ProfileLogScrubbing({this.scrubbingRules, this.state});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'scrubbingRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ProfileScrubbingRules>,
    ...
    return ProfileLogScrubbing(
      scrubbingRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProfileScrubbingRules>(
            guardedValue,
            (value) => ProfileScrubbingRules.fromMap(
