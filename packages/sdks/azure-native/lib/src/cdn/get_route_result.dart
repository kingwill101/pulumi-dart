...
class GetRouteResult {
  ...
  GetRouteResult({
    ...
    this.systemData,
    this.type,
  }) : forwardingProtocol = forwardingProtocol ?? 'MatchRequest', httpsRedirect = httpsRedirect ?? 'Disabled', linkToDefaultDomain = linkToDefaultDomain ?? 'Disabled';
  ...
  factory GetRouteResult.fromMap(Map<String, dynamic> map) {
    return GetRouteResult(
      ...
      endpointName: (() { final guardedValue = map['endpointName']; if (guardedValue == null) return null; return guardedValue as String; })(),
