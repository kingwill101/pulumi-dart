...
class SslProtocolMatchConditionParameters {
  ...
  /// Creates a new [SslProtocolMatchConditionParameters].
  ...
  factory SslProtocolMatchConditionParameters.fromMap(Map<String, dynamic> map) {
    return SslProtocolMatchConditionParameters(
