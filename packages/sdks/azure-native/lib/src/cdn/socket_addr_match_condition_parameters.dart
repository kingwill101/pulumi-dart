...
class SocketAddrMatchConditionParameters {
  ...
  /// Creates a new [SocketAddrMatchConditionParameters].
  ...
  factory SocketAddrMatchConditionParameters.fromMap(Map<String, dynamic> map) {
    return SocketAddrMatchConditionParameters(
