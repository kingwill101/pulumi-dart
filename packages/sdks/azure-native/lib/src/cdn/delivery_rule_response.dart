    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<DeliveryRuleCacheExpirationActionResponse>,
      ...
      'conditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<DeliveryRuleClientPortConditionResponse>,
            List<Map<String, dynamic>>
          >(
            conditions,
            (value) =>
  ...
  factory DeliveryRuleResponse.fromMap(Map<String, dynamic> map) {
    return DeliveryRuleResponse(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DeliveryRuleCacheExpirationActionResponse>(
          map['actions']!,
          (value) => DeliveryRuleCacheExpirationActionResponse.fromMap(
      ...
      conditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeliveryRuleClientPortConditionResponse>(
            guardedValue,
            (value) => DeliveryRuleClientPortConditionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
