...
class GetAFDCustomDomainResult {
  ...
  factory GetAFDCustomDomainResult.fromMap(Map<String, dynamic> map) {
    return GetAFDCustomDomainResult(
      ...
      azureDnsZone: (() {
        final guardedValue = map['azureDnsZone'];
      ...
      preValidatedCustomDomainResourceId: (() {
        final guardedValue = map['preValidatedCustomDomainResourceId'];
        if (guardedValue == null) return null;
        return ResourceReferenceResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      validationProperties: DomainValidationPropertiesResponse.fromMap(
        (map['validationProperties']! as Map).cast<String, dynamic>(),
      ),
    );
  }
}
