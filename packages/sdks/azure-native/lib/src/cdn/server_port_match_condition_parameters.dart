...
class ServerPortMatchConditionParameters {
  ...
  /// Creates a new [ServerPortMatchConditionParameters].
  /// [matchValues] The match value for the condition of the delivery rule
  /// [negateCondition] Describes if this is negate condition or not
  /// [operator] Describes operator to be matched
  /// [transforms] List of transforms
  /// [typeName] Expected value is 'DeliveryRuleServerPortConditionParameters'.
  ...
  factory ServerPortMatchConditionParameters.fromMap(Map<String, dynamic> map) {
    return ServerPortMatchConditionParameters(
