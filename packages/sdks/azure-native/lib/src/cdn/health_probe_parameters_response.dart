...
class HealthProbeParametersResponse {
  ...
  const HealthProbeParametersResponse({
  ...
  factory HealthProbeParametersResponse.fromMap(Map<String, dynamic> map) {
    return HealthProbeParametersResponse(
      probeIntervalInSeconds: (() { final guardedValue = map['probeIntervalInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      probeProtocol: (() { final guardedValue = map['probeProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      probeRequestType: (() { final guardedValue = map['probeRequestType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
