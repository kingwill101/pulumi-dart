...
class ResponseBasedOriginErrorDetectionParametersResponse {
    ...
    return <String, dynamic>{
      'httpErrorRanges':
          ?pulumi.Input.mapOptionalInputValue<
            List<HttpErrorRangeParametersResponse>,
  ...
  factory ResponseBasedOriginErrorDetectionParametersResponse.fromMap(
    ...
    return ResponseBasedOriginErrorDetectionParametersResponse(
      httpErrorRanges: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HttpErrorRangeParametersResponse>(
            guardedValue,
            (value) => HttpErrorRangeParametersResponse.fromMap(
