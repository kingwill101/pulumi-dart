...
class RequestUriMatchConditionParametersResponse {
  ...
  /// Creates a new [RequestUriMatchConditionParametersResponse].
  ...
  factory RequestUriMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return RequestUriMatchConditionParametersResponse(
