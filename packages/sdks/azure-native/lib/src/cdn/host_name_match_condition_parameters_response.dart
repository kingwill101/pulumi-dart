...
class HostNameMatchConditionParametersResponse {
  ...
  /// Creates a new [HostNameMatchConditionParametersResponse].
  ...
  const HostNameMatchConditionParametersResponse({
    this.matchValues,
  ...
  factory HostNameMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return HostNameMatchConditionParametersResponse(
