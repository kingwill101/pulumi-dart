...
class SecurityPolicyArgs {
  ...
  factory SecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return SecurityPolicyArgs(
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityPolicyWebApplicationFirewallParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
