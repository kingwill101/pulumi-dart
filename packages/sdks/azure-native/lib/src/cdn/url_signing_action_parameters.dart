...
class UrlSigningActionParameters {
  ...
  factory UrlSigningActionParameters.fromMap(Map<String, dynamic> map) {
    return UrlSigningActionParameters(
      algorithm: (() { final guardedValue = map['algorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      parameterNameOverride: (() { final guardedValue = map['parameterNameOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UrlSigningParamIdentifier>(guardedValue, (value) => UrlSigningParamIdentifier.fromMap((value as Map).cast<String, dynamic>()))); })(),
