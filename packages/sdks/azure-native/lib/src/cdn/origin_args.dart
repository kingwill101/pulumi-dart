...
class OriginArgs {
  ...
  OriginArgs({
    ...
    pulumi.Output<String>? privateLinkAlias,
    pulumi.Output<String>? privateLinkApprovalMessage,
    pulumi.Output<String>? privateLinkLocation,
  ...
  factory OriginArgs.fromMap(Map<String, dynamic> map) {
    return OriginArgs(
      ...
      privateLinkAlias: map['privateLinkAlias'] == null ? null : pulumi.Output.create<String>(map['privateLinkAlias'] as String),
      privateLinkApprovalMessage: map['privateLinkApprovalMessage'] == null ? null : pulumi.Output.create<String>(map['privateLinkApprovalMessage'] as String),
      privateLinkLocation: map['privateLinkLocation'] == null ? null : pulumi.Output.create<String>(map['privateLinkLocation'] as String),
