...
class DeepCreatedOriginGroupResponse {
  ...
  const DeepCreatedOriginGroupResponse({
  ...
  factory DeepCreatedOriginGroupResponse.fromMap(Map<String, dynamic> map) {
    return DeepCreatedOriginGroupResponse(
      healthProbeSettings: (() { final guardedValue = map['healthProbeSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HealthProbeParametersResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
