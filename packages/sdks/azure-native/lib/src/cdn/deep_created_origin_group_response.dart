...
class DeepCreatedOriginGroupResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'origins': pulumi.Input.encodeList<ResourceReferenceResponse, Map<String, dynamic>>(origins, (value) => value.toMap()),
  ...
  factory DeepCreatedOriginGroupResponse.fromMap(Map<String, dynamic> map) {
    return DeepCreatedOriginGroupResponse(
      ...
      origins: pulumi.Input.decodeList<ResourceReferenceResponse>(map['origins'], (value) => ResourceReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
