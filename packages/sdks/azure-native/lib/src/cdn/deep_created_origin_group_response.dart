...
class DeepCreatedOriginGroupResponse {
  ...
  final pulumi.Input<ResponseBasedOriginErrorDetectionParametersResponse>?
    ...
    return DeepCreatedOriginGroupResponse(
      healthProbeSettings: (() {
        ...
        return pulumi.Input.fromValue(
          HealthProbeParametersResponse.fromMap(
      ...
      responseBasedOriginErrorDetectionSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResponseBasedOriginErrorDetectionParametersResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
