...
class RequestSchemeMatchConditionParametersResponse {
  ...
  /// Creates a new [RequestSchemeMatchConditionParametersResponse].
  ...
  const RequestSchemeMatchConditionParametersResponse({
    this.matchValues,
  ...
  factory RequestSchemeMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return RequestSchemeMatchConditionParametersResponse(
