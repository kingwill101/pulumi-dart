...
class AFDDomainHttpsParameters {
  ...
  final pulumi.Input<dynamic> certificateType;
  /// cipher suite set type that will be used for Https
  final pulumi.Input<dynamic>? cipherSuiteSetType;
  ...
  factory AFDDomainHttpsParameters.fromMap(Map<String, dynamic> map) {
    return AFDDomainHttpsParameters(
      certificateType: pulumi.Input.fromValue(map['certificateType']),
      cipherSuiteSetType: (() { final guardedValue = map['cipherSuiteSetType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
