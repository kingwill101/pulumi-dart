...
class UrlSigningKey {
  ...
  UrlSigningKey({required this.keyId, required this.keySourceParameters});
    ...
    return <String, dynamic>{
      ...
      'keySourceParameters':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(keySourceParameters, (value) => value.toMap()),
    };
  }
  ...
  factory UrlSigningKey.fromMap(Map<String, dynamic> map) {
    return UrlSigningKey(
      ...
      keySourceParameters: pulumi.Input.fromValue(
        KeyVaultSigningKeyParameters.fromMap(
          (map['keySourceParameters']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
