...
class DeliveryRuleRequestHeaderConditionResponse {
  ...
  const DeliveryRuleRequestHeaderConditionResponse({
    required this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': name,
      'parameters': pulumi.Input.mapInputValue<RequestHeaderMatchConditionParametersResponse, Map<String, dynamic>>(parameters, (value) => value.toMap()),
    };
  }
  ...
  factory DeliveryRuleRequestHeaderConditionResponse.fromMap(Map<String, dynamic> map) {
    return DeliveryRuleRequestHeaderConditionResponse(
      ...
      parameters: pulumi.Input.fromValue(RequestHeaderMatchConditionParametersResponse.fromMap((map['parameters']! as Map).cast<String, dynamic>())),
    );
  }
}
