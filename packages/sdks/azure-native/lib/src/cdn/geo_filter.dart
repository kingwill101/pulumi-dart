...
class GeoFilter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': pulumi.Input.mapInputValue<GeoFilterActions, String>(action, (value) => value.wireValue),
  ...
  factory GeoFilter.fromMap(Map<String, dynamic> map) {
    return GeoFilter(
      action: pulumi.Input.fromValue(GeoFilterActions.fromValue(map['action']! as String)),
