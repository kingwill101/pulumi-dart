...
class DeliveryRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': pulumi.Input.mapInputValue<List<DeliveryRuleCacheExpirationAction>, List<Map<String, dynamic>>>(actions, (value) => pulumi.Input.encodeList<DeliveryRuleCacheExpirationAction, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DeliveryRule.fromMap(Map<String, dynamic> map) {
    return DeliveryRule(
      actions: pulumi.Input.fromValue(pulumi.Input.decodeList<DeliveryRuleCacheExpirationAction>(map['actions']!, (value) => DeliveryRuleCacheExpirationAction.fromMap((value as Map).cast<String, dynamic>()))),
