...
class OriginGroupArgs {
  ...
  factory OriginGroupArgs.fromMap(Map<String, dynamic> map) {
    return OriginGroupArgs(
      ...
      origins: (() { final guardedValue = map['origins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceReference>(guardedValue, (value) => ResourceReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
