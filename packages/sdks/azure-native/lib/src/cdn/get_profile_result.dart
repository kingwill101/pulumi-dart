...
class GetProfileResult {
  ...
  factory GetProfileResult.fromMap(Map<String, dynamic> map) {
    return GetProfileResult(
      ...
      logScrubbing: map['logScrubbing'] == null ? null : ProfileLogScrubbingResponse.fromMap((map['logScrubbing']! as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      originResponseTimeoutSeconds: map['originResponseTimeoutSeconds'] == null ? null : map['originResponseTimeoutSeconds']! as int,
