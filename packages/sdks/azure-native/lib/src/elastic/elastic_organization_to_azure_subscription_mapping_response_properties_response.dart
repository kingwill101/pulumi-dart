...
class ElasticOrganizationToAzureSubscriptionMappingResponsePropertiesResponse {
  ...
  factory ElasticOrganizationToAzureSubscriptionMappingResponsePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticOrganizationToAzureSubscriptionMappingResponsePropertiesResponse(
      ...
      elasticOrganizationId: (() { final guardedValue = map['elasticOrganizationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      elasticOrganizationName: (() { final guardedValue = map['elasticOrganizationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      marketplaceSaasInfo: pulumi.Input.fromValue(MarketplaceSaaSInfoResponse.fromMap((map['marketplaceSaasInfo']! as Map).cast<String, dynamic>())),
    );
  }
}
