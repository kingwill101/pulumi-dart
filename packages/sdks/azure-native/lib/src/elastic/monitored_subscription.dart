...
class MonitoredSubscription {
  ...
  factory MonitoredSubscription.fromMap(Map<String, dynamic> map) {
    return MonitoredSubscription(
      ...
      tagRules: (() { final guardedValue = map['tagRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MonitoringTagRulesProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
