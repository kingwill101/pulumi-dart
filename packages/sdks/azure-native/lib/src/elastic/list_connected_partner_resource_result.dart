...
class ListConnectedPartnerResourceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': ?nextLink,
      'value': ?(() { final guardedValue = value; if (guardedValue == null) return null; return pulumi.Input.encodeList<ConnectedPartnerResourcesListFormatResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory ListConnectedPartnerResourceResult.fromMap(Map<String, dynamic> map) {
    return ListConnectedPartnerResourceResult(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ConnectedPartnerResourcesListFormatResponse>(guardedValue, (value) => ConnectedPartnerResourcesListFormatResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
