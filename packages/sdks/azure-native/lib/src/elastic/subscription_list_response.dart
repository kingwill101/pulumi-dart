...
class SubscriptionListResponse {
  ...
  final pulumi.Input<List<MonitoredSubscriptionResponse>>?
    ...
    return <String, dynamic>{
      'monitoredSubscriptionList':
          ?pulumi.Input.mapOptionalInputValue<
            List<MonitoredSubscriptionResponse>,
    ...
    return SubscriptionListResponse(
      monitoredSubscriptionList: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MonitoredSubscriptionResponse>(
            guardedValue,
            (value) => MonitoredSubscriptionResponse.fromMap(
