...
class MarketplaceSaaSInfoResponse {
  ...
  final pulumi.Input<MarketplaceSaaSInfoResponseMarketplaceSubscription>?
    ...
    return <String, dynamic>{
      ...
      'marketplaceSubscription':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(marketplaceSubscription, (value) => value.toMap()),
  ...
  factory MarketplaceSaaSInfoResponse.fromMap(Map<String, dynamic> map) {
    return MarketplaceSaaSInfoResponse(
      ...
      marketplaceResourceId: (() {
        final guardedValue = map['marketplaceResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      marketplaceStatus: (() {
      ...
      marketplaceSubscription: (() {
        ...
        return pulumi.Input.fromValue(
          MarketplaceSaaSInfoResponseMarketplaceSubscription.fromMap(
