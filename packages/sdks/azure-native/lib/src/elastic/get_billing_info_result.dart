...
class GetBillingInfoResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'marketplaceSaasInfo': ?marketplaceSaasInfo == null ? null : marketplaceSaasInfo!.toMap(),
      'partnerBillingEntity': ?partnerBillingEntity == null ? null : partnerBillingEntity!.toMap(),
    };
  }
