...
/// }
///
/// resource "azure-native_securityandcompliance_privatelinkservicesform365securitycenter" "privateLinkServicesForM365SecurityCenter" {
///   identity = {
///     type = "SystemAssigned"
///   }
///   kind     = "fhir-R4"
...
class PrivateLinkServicesForM365SecurityCenter extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateLinkServicesForM365SecurityCenter]. {@macro pulumi_securityandcompliance_private_link_services_for_m365_security_center_args_doc}
  ...
  /// Creates a typed reference to an existing [PrivateLinkServicesForM365SecurityCenter] resource.
  PrivateLinkServicesForM365SecurityCenter.reference(String urn)
    : super(
        'azure-native:securityandcompliance:PrivateLinkServicesForM365SecurityCenter',
