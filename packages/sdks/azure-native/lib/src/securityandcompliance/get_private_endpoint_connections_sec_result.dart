...
/// Result data returned by getPrivateEndpointConnectionsSec.
class GetPrivateEndpointConnectionsSecResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionsSecResult].
  ...
  const GetPrivateEndpointConnectionsSecResult({
  ...
  factory GetPrivateEndpointConnectionsSecResult.fromMap(Map<String, dynamic> map) {
