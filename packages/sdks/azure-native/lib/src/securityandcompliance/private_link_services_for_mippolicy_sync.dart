...
import 'private_link_services_for_mippolicy_sync_args.dart';
...
/// }
///
/// resource "azure-native_securityandcompliance_privatelinkservicesformippolicysync" "privateLinkServicesForMIPPolicySync" {
///   identity = {
///     type = "SystemAssigned"
///   }
///   kind     = "fhir-R4"
...
class PrivateLinkServicesForMIPPolicySync extends pulumi.CustomResource {
  ...
  /// Creates a new [PrivateLinkServicesForMIPPolicySync].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PrivateLinkServicesForMIPPolicySync]. {@macro pulumi_securityandcompliance_private_link_services_for_mippolicy_sync_args_doc}
  ...
  /// Creates a typed reference to an existing [PrivateLinkServicesForMIPPolicySync] resource.
  PrivateLinkServicesForMIPPolicySync.reference(String urn)
    : super(
        'azure-native:securityandcompliance:PrivateLinkServicesForMIPPolicySync',
