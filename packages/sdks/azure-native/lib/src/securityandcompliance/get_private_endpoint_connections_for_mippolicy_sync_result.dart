...
/// Result data returned by getPrivateEndpointConnectionsForMIPPolicySync.
class GetPrivateEndpointConnectionsForMIPPolicySyncResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionsForMIPPolicySyncResult].
  ...
  const GetPrivateEndpointConnectionsForMIPPolicySyncResult({
  ...
  factory GetPrivateEndpointConnectionsForMIPPolicySyncResult.fromMap(Map<String, dynamic> map) {
