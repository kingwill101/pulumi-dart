...
/// }
///
/// resource "azure-native_securityandcompliance_privateendpointconnectionsformippolicysync" "privateEndpointConnectionsForMIPPolicySync" {
...
class PrivateEndpointConnectionsForMIPPolicySync extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionsForMIPPolicySync] resource.
  PrivateEndpointConnectionsForMIPPolicySync.reference(String urn)
    : super(
        'azure-native:securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync',
