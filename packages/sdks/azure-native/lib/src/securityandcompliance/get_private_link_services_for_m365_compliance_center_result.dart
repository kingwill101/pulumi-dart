...
/// Result data returned by getPrivateLinkServicesForM365ComplianceCenter.
class GetPrivateLinkServicesForM365ComplianceCenterResult {
  ...
  /// Creates a new [GetPrivateLinkServicesForM365ComplianceCenterResult].
  ...
  const GetPrivateLinkServicesForM365ComplianceCenterResult({
  ...
  factory GetPrivateLinkServicesForM365ComplianceCenterResult.fromMap(Map<String, dynamic> map) {
