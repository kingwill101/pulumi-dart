...
/// }
///
/// resource "azure-native_securityandcompliance_privateendpointconnectionsforsccpowershell" "privateEndpointConnectionsForSCCPowershell" {
...
class PrivateEndpointConnectionsForSCCPowershell extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionsForSCCPowershell] resource.
  PrivateEndpointConnectionsForSCCPowershell.reference(String urn)
    : super(
        'azure-native:securityandcompliance:PrivateEndpointConnectionsForSCCPowershell',
