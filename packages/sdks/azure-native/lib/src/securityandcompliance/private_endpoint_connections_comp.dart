...
import 'private_endpoint_connections_comp_args.dart';
...
/// }
///
/// resource "azure-native_securityandcompliance_privateendpointconnectionscomp" "privateEndpointConnectionsComp" {
...
class PrivateEndpointConnectionsComp extends pulumi.CustomResource {
  ...
  /// Creates a new [PrivateEndpointConnectionsComp].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PrivateEndpointConnectionsComp]. {@macro pulumi_securityandcompliance_private_endpoint_connections_comp_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  PrivateEndpointConnectionsComp(
    String name, {
    PrivateEndpointConnectionsCompArgs? args,
  ...
  /// Creates a typed reference to an existing [PrivateEndpointConnectionsComp] resource.
  PrivateEndpointConnectionsComp.reference(String urn)
    : super(
        'azure-native:securityandcompliance:PrivateEndpointConnectionsComp',
