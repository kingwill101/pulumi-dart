...
class StopSellOffersPlansNotificationsListPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'plans':
          pulumi.Input.mapInputValue<
            List<PlanNotificationDetailsResponse>,
  ...
  factory StopSellOffersPlansNotificationsListPropertiesResponse.fromMap(
    ...
    return StopSellOffersPlansNotificationsListPropertiesResponse(
      ...
      plans: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PlanNotificationDetailsResponse>(
          map['plans']!,
          (value) => PlanNotificationDetailsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      publicContext: pulumi.Input.fromValue(map['publicContext'] as bool),
      subscriptionsIds: pulumi.Input.fromValue(
        (map['subscriptionsIds'] as List).cast<String>(),
      ),
    );
  }
}
