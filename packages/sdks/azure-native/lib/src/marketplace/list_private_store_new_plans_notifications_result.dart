...
class ListPrivateStoreNewPlansNotificationsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'newPlansNotifications': ?(() { final guardedValue = newPlansNotifications; if (guardedValue == null) return null; return pulumi.Input.encodeList<NewNotificationsResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory ListPrivateStoreNewPlansNotificationsResult.fromMap(Map<String, dynamic> map) {
    return ListPrivateStoreNewPlansNotificationsResult(
      newPlansNotifications: (() { final guardedValue = map['newPlansNotifications']; if (guardedValue == null) return null; return pulumi.Input.decodeList<NewNotificationsResponse>(guardedValue, (value) => NewNotificationsResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
