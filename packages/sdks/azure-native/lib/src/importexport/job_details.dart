    ...
    return <String, dynamic>{
      ...
      'driveList':
          ...
          >(
            driveList,
            (value) =>
                pulumi.Input.encodeList<DriveStatus, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'export':
          ?pulumi.Input.mapOptionalInputValue<Export, Map<String, dynamic>>(
            export,
            (value) => value.toMap(),
          ),
    ...
    return JobDetails(
      ...
      deliveryPackage: (() {
        ...
        return pulumi.Input.fromValue(
          DeliveryPackageInformation.fromMap(
      ...
      driveList: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DriveStatus>(
            guardedValue,
            (value) =>
                DriveStatus.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      encryptionKey: (() {
      ...
      export: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Export.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      returnAddress: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReturnAddress.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      returnPackage: (() {
      ...
      returnShipping: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReturnShipping.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      shippingInformation: (() {
