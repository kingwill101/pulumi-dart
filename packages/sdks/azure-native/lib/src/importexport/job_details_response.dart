...
class JobDetailsResponse {
    ...
    return <String, dynamic>{
      ...
      'returnShipping':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(returnShipping, (value) => value.toMap()),
      'shippingInformation':
          ?pulumi.Input.mapOptionalInputValue<
            ShippingInformationResponse,
            Map<String, dynamic>
          >(shippingInformation, (value) => value.toMap()),
      'state': ?state,
  ...
  factory JobDetailsResponse.fromMap(Map<String, dynamic> map) {
    return JobDetailsResponse(
      backupDriveManifest: (() {
        final guardedValue = map['backupDriveManifest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      cancelRequested: (() {
        final guardedValue = map['cancelRequested'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      deliveryPackage: (() {
        final guardedValue = map['deliveryPackage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeliveryPackageInformationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      diagnosticsPath: (() {
        final guardedValue = map['diagnosticsPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      driveList: (() {
        final guardedValue = map['driveList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DriveStatusResponse>(
            guardedValue,
            (value) => DriveStatusResponse.fromMap(
      ...
      encryptionKey: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EncryptionKeyDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      export: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      incompleteBlobListUri: (() {
        final guardedValue = map['incompleteBlobListUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jobType: (() {
      ...
      returnAddress: (() {
        final guardedValue = map['returnAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReturnAddressResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      returnPackage: (() {
        final guardedValue = map['returnPackage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PackageInformationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      returnShipping: (() {
        final guardedValue = map['returnShipping'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReturnShippingResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      shippingInformation: (() {
        final guardedValue = map['shippingInformation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ShippingInformationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
