...
class StandbyContainerGroupPool extends pulumi.CustomResource {
  ...
  StandbyContainerGroupPool(
    ...
    containerGroupProperties = registerOutput<ContainerGroupPropertiesResponse>('containerGroupProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ContainerGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    elasticityProfile = registerOutput<StandbyContainerGroupPoolElasticityProfileResponse>('elasticityProfile', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return StandbyContainerGroupPoolElasticityProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [StandbyContainerGroupPool] resource.
  StandbyContainerGroupPool.reference(String urn)
    : super(
        'azure-native:standbypool:StandbyContainerGroupPool',
