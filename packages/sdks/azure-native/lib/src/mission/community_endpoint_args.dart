    ...
    return <String, dynamic>{
      ...
      'ruleCollection':
          pulumi.Input.mapInputValue<
            List<CommunityEndpointDestinationRule>,
  ...
  factory CommunityEndpointArgs.fromMap(Map<String, dynamic> map) {
    return CommunityEndpointArgs(
      communityEndpointName: (() {
        final guardedValue = map['communityEndpointName'];
      ...
      ruleCollection: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CommunityEndpointDestinationRule>(
          map['ruleCollection']!,
          (value) => CommunityEndpointDestinationRule.fromMap(
