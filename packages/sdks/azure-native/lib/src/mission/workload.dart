...
class Workload extends pulumi.CustomResource {
  ...
  Workload(
    ...
    resourceGroupCollection = registerOutput<List<String>?>('resourceGroupCollection', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
