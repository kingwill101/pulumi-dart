  ...
  factory EnclaveVirtualNetworkModel.fromMap(Map<String, dynamic> map) {
    return EnclaveVirtualNetworkModel(
      allowSubnetCommunication: (() {
        final guardedValue = map['allowSubnetCommunication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      customCidrRange: (() {
        final guardedValue = map['customCidrRange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkName: (() {
        final guardedValue = map['networkName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkSize: (() {
        final guardedValue = map['networkSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subnetConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubnetConfiguration>(
            guardedValue,
            (value) => SubnetConfiguration.fromMap(
