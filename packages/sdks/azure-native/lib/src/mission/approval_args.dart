...
class ApprovalArgs {
  ...
  ApprovalArgs({
    pulumi.Output<String>? approvalName,
    pulumi.Output<List<Approver>>? approvers,
    pulumi.Output<String>? createdAt,
    pulumi.Output<String>? grandparentResourceId,
    pulumi.Output<String>? parentResourceId,
    required pulumi.Output<RequestMetadata> requestMetadata,
    required pulumi.Output<String> resourceUri,
    pulumi.Output<String>? stateChangedAt,
  ...
  factory ApprovalArgs.fromMap(Map<String, dynamic> map) {
    return ApprovalArgs(
      approvalName: map['approvalName'] == null ? null : pulumi.Output.create<String>(map['approvalName'] as String),
      approvers: map['approvers'] == null ? null : pulumi.Output.create<List<Approver>>(pulumi.Input.decodeList<Approver>(map['approvers'], (value) => Approver.fromMap((value as Map).cast<String, dynamic>()))),
      createdAt: map['createdAt'] == null ? null : pulumi.Output.create<String>(map['createdAt'] as String),
      grandparentResourceId: map['grandparentResourceId'] == null ? null : pulumi.Output.create<String>(map['grandparentResourceId'] as String),
      parentResourceId: map['parentResourceId'] == null ? null : pulumi.Output.create<String>(map['parentResourceId'] as String),
      requestMetadata: pulumi.Output.create<RequestMetadata>(RequestMetadata.fromMap((map['requestMetadata'] as Map).cast<String, dynamic>())),
      resourceUri: pulumi.Output.create<String>(map['resourceUri'] as String),
      stateChangedAt: map['stateChangedAt'] == null ? null : pulumi.Output.create<String>(map['stateChangedAt'] as String),
