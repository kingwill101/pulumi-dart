...
class ApprovalArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'approvers':
          ...
          >(
            approvers,
            (value) => pulumi.Input.encodeList<Approver, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'requestMetadata':
          pulumi.Input.mapInputValue<RequestMetadata, Map<String, dynamic>>(
            requestMetadata,
            (value) => value.toMap(),
          ),
  ...
  factory ApprovalArgs.fromMap(Map<String, dynamic> map) {
    return ApprovalArgs(
      approvalName: (() {
        final guardedValue = map['approvalName'];
      ...
      approvers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Approver>(
            guardedValue,
            (value) => Approver.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      createdAt: (() {
      ...
      requestMetadata: pulumi.Input.fromValue(
        RequestMetadata.fromMap(
