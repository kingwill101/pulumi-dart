...
import 'mandatory_approver_response.dart';
...
class ApprovalSettingsResponse {
  ...
  final pulumi.Input<List<MandatoryApproverResponse>?>? mandatoryApprovers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mandatoryApprovers': ?pulumi.Input.mapOptionalInputValue<List<MandatoryApproverResponse>, List<Map<String, dynamic>>>(mandatoryApprovers, (value) => pulumi.Input.encodeList<MandatoryApproverResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ApprovalSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ApprovalSettingsResponse(
      ...
      mandatoryApprovers: (() { final guardedValue = map['mandatoryApprovers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MandatoryApproverResponse>(guardedValue, (value) => MandatoryApproverResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
