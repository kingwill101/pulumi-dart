...
class ApprovalSettingsResponse {
  ...
  factory ApprovalSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ApprovalSettingsResponse(
      ...
      mandatoryApprovers: map['mandatoryApprovers'] == null ? null : (pulumi.Input.decodeList<MandatoryApproverResponse>(map['mandatoryApprovers'], (value) => MandatoryApproverResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
