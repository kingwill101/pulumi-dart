...
class VirtualEnclaveArgs {
  ...
  factory VirtualEnclaveArgs.fromMap(Map<String, dynamic> map) {
    return VirtualEnclaveArgs(
      bastionEnabled: (() { final guardedValue = map['bastionEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      communityResourceId: pulumi.Input.fromValue(map['communityResourceId'] as String),
      enclaveDefaultSettings: (() { final guardedValue = map['enclaveDefaultSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnclaveDefaultSettingsModel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      enclaveRoleAssignments: (() { final guardedValue = map['enclaveRoleAssignments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RoleAssignmentItem>(guardedValue, (value) => RoleAssignmentItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
      enclaveVirtualNetwork: pulumi.Input.fromValue(EnclaveVirtualNetworkModel.fromMap((map['enclaveVirtualNetwork']! as Map).cast<String, dynamic>())),
      ...
      virtualEnclaveName: (() { final guardedValue = map['virtualEnclaveName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      workloadRoleAssignments: (() { final guardedValue = map['workloadRoleAssignments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RoleAssignmentItem>(guardedValue, (value) => RoleAssignmentItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
