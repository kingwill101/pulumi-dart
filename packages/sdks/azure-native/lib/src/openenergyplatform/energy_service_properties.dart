...
class EnergyServiceProperties {
  ...
  EnergyServiceProperties({this.authAppId, this.dataPartitionNames});
    ...
    return EnergyServiceProperties(
      ...
      dataPartitionNames: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataPartitionNames>(
            guardedValue,
            (value) => DataPartitionNames.fromMap(
