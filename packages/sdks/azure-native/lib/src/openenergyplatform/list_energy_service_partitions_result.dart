...
class ListEnergyServicePartitionsResult {
  ...
  ListEnergyServicePartitionsResult({this.dataPartitionInfo});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataPartitionInfo': ?(() {
        final guardedValue = dataPartitionInfo;
  ...
  factory ListEnergyServicePartitionsResult.fromMap(Map<String, dynamic> map) {
    return ListEnergyServicePartitionsResult(
      dataPartitionInfo: (() {
        final guardedValue = map['dataPartitionInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<DataPartitionPropertiesResponse>(
          guardedValue,
          (value) => DataPartitionPropertiesResponse.fromMap(
