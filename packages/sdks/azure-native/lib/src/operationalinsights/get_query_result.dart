...
class GetQueryResult {
  ...
  factory GetQueryResult.fromMap(Map<String, dynamic> map) {
    return GetQueryResult(
      ...
      related: (() { final guardedValue = map['related']; if (guardedValue == null) return null; return LogAnalyticsQueryPackQueryPropertiesResponseRelated.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      systemData: (() { final guardedValue = map['systemData']; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.decodeMapValues<List<String>>(guardedValue, (value) => (value as List).cast<String>()); })(),
