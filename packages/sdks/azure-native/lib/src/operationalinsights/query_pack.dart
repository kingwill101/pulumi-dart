...
/// }
///
/// resource "azure-native_operationalinsights_querypack" "queryPack" {
///   location            = "South Central US"
...
class QueryPack extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [QueryPack] resource.
  QueryPack.reference(String urn)
    : super(
        'azure-native:operationalinsights:QueryPack',
