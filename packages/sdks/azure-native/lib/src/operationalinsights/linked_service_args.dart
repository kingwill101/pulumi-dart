...
class LinkedServiceArgs {
  ...
  factory LinkedServiceArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceArgs(
      ...
      writeAccessResourceId: (() { final guardedValue = map['writeAccessResourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
