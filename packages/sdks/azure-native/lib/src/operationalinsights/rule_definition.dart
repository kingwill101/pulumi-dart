...
class RuleDefinition {
  ...
  factory RuleDefinition.fromMap(Map<String, dynamic> map) {
    return RuleDefinition(
      binDelay: (() { final guardedValue = map['binDelay']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      binSize: (() { final guardedValue = map['binSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
