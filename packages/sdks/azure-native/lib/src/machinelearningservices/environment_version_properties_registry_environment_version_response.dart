...
import 'inference_container_properties_registry_environment_version_response.dart';

/// Environment version details.
class EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse {
  ...
  final pulumi.Input<InferenceContainerPropertiesRegistryEnvironmentVersionResponse>? inferenceConfig;
  ...
  /// Creates a new [EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse].
  ...
  const EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse({
    this.autoRebuild,
    this.build,
    this.condaFile,
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'image': ?image,
      'inferenceConfig': ?pulumi.Input.mapOptionalInputValue<InferenceContainerPropertiesRegistryEnvironmentVersionResponse, Map<String, dynamic>>(inferenceConfig, (value) => value.toMap()),
  ...
  factory EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse(
      ...
      inferenceConfig: (() { final guardedValue = map['inferenceConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InferenceContainerPropertiesRegistryEnvironmentVersionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
