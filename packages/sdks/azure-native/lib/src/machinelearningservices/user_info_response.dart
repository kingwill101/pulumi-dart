...
class UserInfoResponse {
  ...
  factory UserInfoResponse.fromMap(Map<String, dynamic> map) {
    return UserInfoResponse(
      userAltSecId: (() { final guardedValue = map['userAltSecId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userIdp: (() { final guardedValue = map['userIdp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userIss: (() { final guardedValue = map['userIss']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      userPuId: (() { final guardedValue = map['userPuId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userTenantId: (() { final guardedValue = map['userTenantId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
