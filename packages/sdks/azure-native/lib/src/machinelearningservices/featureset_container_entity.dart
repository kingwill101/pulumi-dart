...
class FeaturesetContainerEntity extends pulumi.CustomResource {
  ...
  late final pulumi.Output<FeaturesetContainerResponse>
  featuresetContainerProperties;
  ...
  FeaturesetContainerEntity(
    ...
    featuresetContainerProperties = registerOutput<FeaturesetContainerResponse>(
      'featuresetContainerProperties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return FeaturesetContainerResponse.fromMap(
