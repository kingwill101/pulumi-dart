...
class BatchDeploymentResponse {
  ...
  final pulumi.Input<BatchPipelineComponentDeploymentConfigurationResponse>?
  ...
  factory BatchDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return BatchDeploymentResponse(
      ...
      deploymentConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BatchPipelineComponentDeploymentConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      model: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataPathAssetReferenceResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      resources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentResourceConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      retrySettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BatchRetrySettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
