...
class GetModelContainerResult {
  ...
  factory GetModelContainerResult.fromMap(Map<String, dynamic> map) {
    return GetModelContainerResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ModelContainerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
