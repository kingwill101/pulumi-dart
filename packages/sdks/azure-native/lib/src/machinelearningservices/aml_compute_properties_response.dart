...
class AmlComputePropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'nodeStateCounts':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(nodeStateCounts, (value) => value.toMap()),
      'osType': ?osType,
      ...
      'userAccountCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(userAccountCredentials, (value) => value.toMap()),
      'virtualMachineImage':
          ?pulumi.Input.mapOptionalInputValue<
            VirtualMachineImageResponse,
            Map<String, dynamic>
          >(virtualMachineImage, (value) => value.toMap()),
  ...
  factory AmlComputePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AmlComputePropertiesResponse(
      ...
      allocationStateTransitionTime: pulumi.Input.fromValue(
        map['allocationStateTransitionTime'] as String,
      ),
      ...
      isolatedNetwork: (() {
        final guardedValue = map['isolatedNetwork'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      nodeStateCounts: pulumi.Input.fromValue(
        NodeStateCountsResponse.fromMap(
          (map['nodeStateCounts']! as Map).cast<String, dynamic>(),
        ),
      ),
      osType: (() {
      ...
      remoteLoginPortPublicAccess: (() {
        final guardedValue = map['remoteLoginPortPublicAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      scaleSettings: (() {
      ...
      userAccountCredentials: (() {
        final guardedValue = map['userAccountCredentials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserAccountCredentialsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      virtualMachineImage: (() {
        final guardedValue = map['virtualMachineImage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineImageResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vmPriority: (() {
        final guardedValue = map['vmPriority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vmSize: (() {
