...
class Classification {
  ...
  final pulumi.Input<ClassificationTrainingSettings>? trainingSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trainingSettings': ?pulumi.Input.mapOptionalInputValue<ClassificationTrainingSettings, Map<String, dynamic>>(trainingSettings, (value) => value.toMap()),
  ...
  factory Classification.fromMap(Map<String, dynamic> map) {
    return Classification(
      ...
      featurizationSettings: (() { final guardedValue = map['featurizationSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TableVerticalFeaturizationSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      limitSettings: (() { final guardedValue = map['limitSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TableVerticalLimitSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nCrossValidations: (() { final guardedValue = map['nCrossValidations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoNCrossValidations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      positiveLabel: (() { final guardedValue = map['positiveLabel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      testData: (() { final guardedValue = map['testData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MLTableJobInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      trainingSettings: (() { final guardedValue = map['trainingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClassificationTrainingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
