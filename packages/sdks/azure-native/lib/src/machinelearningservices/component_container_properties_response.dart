...
class ComponentContainerPropertiesResponse {
  ...
  /// Creates a new [ComponentContainerPropertiesResponse].
  ...
  const ComponentContainerPropertiesResponse({
    this.description,
    this.isArchived,
  ...
  factory ComponentContainerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ComponentContainerPropertiesResponse(
