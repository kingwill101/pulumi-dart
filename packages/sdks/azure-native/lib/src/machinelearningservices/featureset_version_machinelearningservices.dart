...
class FeaturesetVersionMachinelearningservices extends pulumi.CustomResource {
  ...
  FeaturesetVersionMachinelearningservices(
    ...
    featuresetVersionProperties = registerOutput<FeaturesetVersionResponse>('featuresetVersionProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FeaturesetVersionResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
