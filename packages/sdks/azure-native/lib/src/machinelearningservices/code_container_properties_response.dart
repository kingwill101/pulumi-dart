...
class CodeContainerPropertiesResponse {
  ...
  /// Creates a new [CodeContainerPropertiesResponse].
  ...
  const CodeContainerPropertiesResponse({
    this.description,
    this.isArchived,
  ...
  factory CodeContainerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CodeContainerPropertiesResponse(
