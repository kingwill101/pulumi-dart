...
class GetCapacityReservationGroupResult {
  ...
  const GetCapacityReservationGroupResult({
    ...
    this.capacityReservationGroupProperties,
    this.id,
    this.identity,
    this.kind,
    this.location,
  ...
  factory GetCapacityReservationGroupResult.fromMap(Map<String, dynamic> map) {
    return GetCapacityReservationGroupResult(
      ...
      capacityReservationGroupProperties: (() { final guardedValue = map['capacityReservationGroupProperties']; if (guardedValue == null) return null; return CapacityReservationGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
