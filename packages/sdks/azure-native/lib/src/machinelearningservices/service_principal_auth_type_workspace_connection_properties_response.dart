...
class ServicePrincipalAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final WorkspaceConnectionServicePrincipalResponse? credentials;
  ...
  factory ServicePrincipalAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ServicePrincipalAuthTypeWorkspaceConnectionPropertiesResponse(
      ...
      credentials: map['credentials'] == null ? null : WorkspaceConnectionServicePrincipalResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
