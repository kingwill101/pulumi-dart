...
class MonitorNotificationSettingsResponse {
  ...
  final pulumi.Input<MonitorEmailNotificationSettingsResponse>?
  emailNotificationSettings;

  /// Creates a new [MonitorNotificationSettingsResponse].
  /// [emailNotificationSettings] The AML notification email settings.
  MonitorNotificationSettingsResponse({this.emailNotificationSettings});
  ...
  factory MonitorNotificationSettingsResponse.fromMap(
    ...
    return MonitorNotificationSettingsResponse(
      emailNotificationSettings: (() {
        ...
        return pulumi.Input.fromValue(
          MonitorEmailNotificationSettingsResponse.fromMap(
