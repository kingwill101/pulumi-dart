...
class AKSResponse {
  ...
  /// AKS properties
  final AKSSchemaResponseProperties? properties;
  ...
  factory AKSResponse.fromMap(Map<String, dynamic> map) {
    return AKSResponse(
      ...
      properties: map['properties'] == null ? null : AKSSchemaResponseProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
