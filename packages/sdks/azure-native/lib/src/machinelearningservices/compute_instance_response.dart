...
import 'compute_instance_properties_response.dart';
import 'error_response_response.dart';

/// An Azure Machine Learning compute instance.
class ComputeInstanceResponse {
  ...
  final pulumi.Input<ComputeInstancePropertiesResponse?>? properties;
  ...
  /// Creates a new [ComputeInstanceResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'properties': ?pulumi.Input.mapOptionalInputValue<ComputeInstancePropertiesResponse, Map<String, dynamic>>(properties, (value) => value.toMap()),
  ...
  factory ComputeInstanceResponse.fromMap(Map<String, dynamic> map) {
    return ComputeInstanceResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeInstancePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
