...
class FeaturesetContainerEntityArgs {
  ...
  FeaturesetContainerEntityArgs({
    required pulumi.Output<FeaturesetContainer> featuresetContainerProperties,
  ...
  factory FeaturesetContainerEntityArgs.fromMap(Map<String, dynamic> map) {
    return FeaturesetContainerEntityArgs(
      featuresetContainerProperties: pulumi.Output.create<FeaturesetContainer>(FeaturesetContainer.fromMap((map['featuresetContainerProperties'] as Map).cast<String, dynamic>())),
