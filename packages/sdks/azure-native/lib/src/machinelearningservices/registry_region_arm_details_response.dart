...
class RegistryRegionArmDetailsResponse {
  ...
  final pulumi.Input<List<StorageAccountDetailsResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'storageAccountDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<StorageAccountDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            storageAccountDetails,
            (value) =>
  ...
  factory RegistryRegionArmDetailsResponse.fromMap(Map<String, dynamic> map) {
    return RegistryRegionArmDetailsResponse(
      acrDetails: (() {
        final guardedValue = map['acrDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AcrDetailsResponse>(
            guardedValue,
            (value) => AcrDetailsResponse.fromMap(
      ...
      storageAccountDetails: (() {
        final guardedValue = map['storageAccountDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StorageAccountDetailsResponse>(
            guardedValue,
            (value) => StorageAccountDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
