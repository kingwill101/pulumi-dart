...
class FeaturesetVersionProperties {
  ...
  /// Creates a new [FeaturesetVersionProperties].
  ...
  const FeaturesetVersionProperties({
    this.description,
    this.entities,
    this.isAnonymous,
    this.isArchived,
  ...
  factory FeaturesetVersionProperties.fromMap(Map<String, dynamic> map) {
    return FeaturesetVersionProperties(
