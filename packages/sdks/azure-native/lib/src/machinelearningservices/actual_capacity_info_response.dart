...
class ActualCapacityInfoResponse {
  ...
  const ActualCapacityInfoResponse({
    this.failed,
    this.outdatedFailed,
  ...
  factory ActualCapacityInfoResponse.fromMap(Map<String, dynamic> map) {
    return ActualCapacityInfoResponse(
      ...
      outdatedFailed: (() { final guardedValue = map['outdatedFailed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      outdatedSucceeded: (() { final guardedValue = map['outdatedSucceeded']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      total: (() { final guardedValue = map['total']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
