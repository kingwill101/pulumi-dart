...
class BatchEndpointMachinelearningservices extends pulumi.CustomResource {
  ...
  BatchEndpointMachinelearningservices(
    ...
    batchEndpointProperties = registerOutput<BatchEndpointResponse>('batchEndpointProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BatchEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
