...
class DataCollector {
  ...
  final pulumi.Input<dynamic>? rollingRate;
  ...
  DataCollector({
    ...
    this.requestLogging,
    pulumi.Input<dynamic>? rollingRate,
  ...
  factory DataCollector.fromMap(Map<String, dynamic> map) {
    return DataCollector(
      ...
      rollingRate: (() { final guardedValue = map['rollingRate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
