...
class DataCollector {
  ...
  factory DataCollector.fromMap(Map<String, dynamic> map) {
    return DataCollector(
      collections: (pulumi.Input.decodeMapValues<Collection>(map['collections'], (value) => Collection.fromMap((value as Map).cast<String, dynamic>()))).input(),
      requestLogging: map['requestLogging'] == null ? null : (RequestLogging.fromMap((map['requestLogging'] as Map).cast<String, dynamic>())).input(),
