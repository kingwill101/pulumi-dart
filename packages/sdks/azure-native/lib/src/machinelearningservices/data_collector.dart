    ...
    return <String, dynamic>{
      'collections':
          ...
          >(
            collections,
            (value) =>
                pulumi.Input.encodeMapValues<Collection, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DataCollector.fromMap(Map<String, dynamic> map) {
    return DataCollector(
      collections: pulumi.Input.fromValue(
        pulumi.Input.decodeMapValues<Collection>(
          map['collections']!,
          (value) => Collection.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      requestLogging: (() {
        ...
        return pulumi.Input.fromValue(
          RequestLogging.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      rollingRate: (() {
        final guardedValue = map['rollingRate'];
        if (guardedValue == null) return null;
