...
/// }
///
/// resource "azure-native_machinelearningservices_connectionraiblocklist" "connectionRaiBlocklist" {
...
class ConnectionRaiBlocklist extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ConnectionRaiBlocklist] resource.
  ConnectionRaiBlocklist.reference(String urn)
    : super(
        'azure-native:machinelearningservices:ConnectionRaiBlocklist',
