...
class GetFeaturestoreEntityContainerEntityResult {
  ...
  final FeaturestoreEntityContainerResponse
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'featurestoreEntityContainerProperties':
          featurestoreEntityContainerProperties.toMap(),
      'id': id,
      'name': name,
  ...
  factory GetFeaturestoreEntityContainerEntityResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetFeaturestoreEntityContainerEntityResult(
      azureApiVersion: map['azureApiVersion'] as String,
      featurestoreEntityContainerProperties:
          FeaturestoreEntityContainerResponse.fromMap(
