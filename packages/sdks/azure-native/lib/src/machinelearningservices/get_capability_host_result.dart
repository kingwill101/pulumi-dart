...
class GetCapabilityHostResult {
  ...
  final CapabilityHostPropertiesResponse? properties;
  ...
  factory GetCapabilityHostResult.fromMap(Map<String, dynamic> map) {
    return GetCapabilityHostResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return CapabilityHostPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
