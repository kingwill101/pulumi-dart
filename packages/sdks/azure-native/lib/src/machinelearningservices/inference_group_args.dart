...
class InferenceGroupArgs {
  ...
  InferenceGroupArgs({
    ...
    required pulumi.Output<InferenceGroupMachinelearningservices> inferenceGroupProperties,
  ...
  factory InferenceGroupArgs.fromMap(Map<String, dynamic> map) {
    return InferenceGroupArgs(
      ...
      inferenceGroupProperties: pulumi.Output.create<InferenceGroupMachinelearningservices>(map['inferenceGroupProperties'] as InferenceGroupMachinelearningservices),
