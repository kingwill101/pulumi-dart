...
class WorkspaceArgs {
  ...
  factory WorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceArgs(
      allowPublicAccessWhenBehindVnet: (() { final guardedValue = map['allowPublicAccessWhenBehindVnet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      associatedWorkspaces: (() { final guardedValue = map['associatedWorkspaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      containerRegistry: (() { final guardedValue = map['containerRegistry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      enableDataIsolation: (() { final guardedValue = map['enableDataIsolation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableServiceSideCMKEncryption: (() { final guardedValue = map['enableServiceSideCMKEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      featureStoreSettings: (() { final guardedValue = map['featureStoreSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FeatureStoreSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      friendlyName: (() { final guardedValue = map['friendlyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      hbiWorkspace: (() { final guardedValue = map['hbiWorkspace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      hubResourceId: (() { final guardedValue = map['hubResourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedServiceIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageBuildCompute: (() { final guardedValue = map['imageBuildCompute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      keyVault: (() { final guardedValue = map['keyVault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
