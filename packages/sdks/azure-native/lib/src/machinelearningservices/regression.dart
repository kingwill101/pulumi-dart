...
class Regression {
  ...
  factory Regression.fromMap(Map<String, dynamic> map) {
    return Regression(
      ...
      trainingSettings: (() { final guardedValue = map['trainingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegressionTrainingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
