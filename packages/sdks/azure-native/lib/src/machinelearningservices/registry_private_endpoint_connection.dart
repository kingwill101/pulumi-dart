...
class RegistryPrivateEndpointConnection {
  ...
  factory RegistryPrivateEndpointConnection.fromMap(Map<String, dynamic> map) {
    return RegistryPrivateEndpointConnection(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryPrivateEndpointConnectionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
