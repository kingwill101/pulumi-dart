...
class ClassificationResponse {
  ...
  final pulumi.Input<ClassificationTrainingSettingsResponse?>? trainingSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trainingSettings': ?pulumi.Input.mapOptionalInputValue<ClassificationTrainingSettingsResponse, Map<String, dynamic>>(trainingSettings, (value) => value.toMap()),
  ...
  factory ClassificationResponse.fromMap(Map<String, dynamic> map) {
    return ClassificationResponse(
      ...
      trainingSettings: (() { final guardedValue = map['trainingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClassificationTrainingSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
