...
class KubernetesOnlineDeployment {
  ...
  factory KubernetesOnlineDeployment.fromMap(Map<String, dynamic> map) {
    return KubernetesOnlineDeployment(
      ...
      containerResourceRequirements: map['containerResourceRequirements'] == null ? null : (ContainerResourceRequirements.fromMap((map['containerResourceRequirements']! as Map).cast<String, dynamic>())).input(),
