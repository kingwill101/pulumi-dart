...
class GetFeaturesetVersionResult {
  ...
  final FeaturesetVersionPropertiesResponse? properties;
  ...
  const GetFeaturesetVersionResult({
  ...
  factory GetFeaturesetVersionResult.fromMap(Map<String, dynamic> map) {
    return GetFeaturesetVersionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return FeaturesetVersionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
