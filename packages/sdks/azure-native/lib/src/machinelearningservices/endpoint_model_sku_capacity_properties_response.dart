...
class EndpointModelSkuCapacityPropertiesResponse {
  ...
  EndpointModelSkuCapacityPropertiesResponse({this.default_, this.maximum});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'default': ?default_, 'maximum': ?maximum};
  }

  factory EndpointModelSkuCapacityPropertiesResponse.fromMap(
