...
class FeatureStoreSettings {
  ...
  factory FeatureStoreSettings.fromMap(Map<String, dynamic> map) {
    return FeatureStoreSettings(
      computeRuntime: (() { final guardedValue = map['computeRuntime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeRuntimeDto.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
