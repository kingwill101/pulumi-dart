...
class GetInferenceEndpointResult {
  ...
  const GetInferenceEndpointResult({
    this.azureApiVersion,
    this.id,
    this.identity,
    this.inferenceEndpointProperties,
    this.kind,
    this.location,
    this.name,
    this.sku,
  ...
  factory GetInferenceEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetInferenceEndpointResult(
      ...
      inferenceEndpointProperties: (() { final guardedValue = map['inferenceEndpointProperties']; if (guardedValue == null) return null; return InferenceEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
