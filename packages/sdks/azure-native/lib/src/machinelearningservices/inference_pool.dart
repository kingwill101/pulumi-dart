...
class InferencePool {
  ...
  factory InferencePool.fromMap(Map<String, dynamic> map) {
    return InferencePool(
      ...
      scaleUnitConfiguration: (() { final guardedValue = map['scaleUnitConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleUnitConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
