...
class DataCollectorResponse {
  ...
  DataCollectorResponse({
    ...
    this.requestLogging,
    pulumi.Input<String?>? rollingRate,
  }) : rollingRate = rollingRate ?? pulumi.Input.fromValue('Hour');
  ...
  factory DataCollectorResponse.fromMap(Map<String, dynamic> map) {
    return DataCollectorResponse(
      collections: pulumi.Input.fromValue(pulumi.Input.decodeMapValues<CollectionResponse>(map['collections']!, (value) => CollectionResponse.fromMap((value as Map).cast<String, dynamic>()))),
      requestLogging: (() { final guardedValue = map['requestLogging']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RequestLoggingResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
