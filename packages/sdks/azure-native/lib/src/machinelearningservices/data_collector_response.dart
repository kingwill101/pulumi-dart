...
class DataCollectorResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'collections': pulumi.Input.encodeMapValues<CollectionResponse, Map<String, dynamic>>(collections, (value) => value.toMap()),
  ...
  factory DataCollectorResponse.fromMap(Map<String, dynamic> map) {
    return DataCollectorResponse(
      collections: pulumi.Input.decodeMapValues<CollectionResponse>(map['collections'], (value) => CollectionResponse.fromMap((value as Map).cast<String, dynamic>())),
      requestLogging: map['requestLogging'] == null ? null : RequestLoggingResponse.fromMap((map['requestLogging'] as Map).cast<String, dynamic>()),
