...
import 'workspace_connection_access_key.dart';
...
class AccessKeyAuthTypeWorkspaceConnectionProperties {
  ...
  final pulumi.Input<WorkspaceConnectionAccessKey>? credentials;
  ...
  /// Creates a new [AccessKeyAuthTypeWorkspaceConnectionProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authType': authType,
      'category': ?category,
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionAccessKey, Map<String, dynamic>>(credentials, (value) => value.toMap()),
  ...
  factory AccessKeyAuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return AccessKeyAuthTypeWorkspaceConnectionProperties(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionAccessKey.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
