...
class AccessKeyAuthTypeWorkspaceConnectionProperties {
  ...
  final WorkspaceConnectionAccessKey? credentials;
  ...
  factory AccessKeyAuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return AccessKeyAuthTypeWorkspaceConnectionProperties(
      ...
      credentials: map['credentials'] == null ? null : WorkspaceConnectionAccessKey.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
