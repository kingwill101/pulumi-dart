...
class PredictionDriftMonitoringSignal {
  ...
  final pulumi.Input<List<CategoricalPredictionDriftMetricThreshold>>
  metricThresholds;
    ...
    return <String, dynamic>{
      ...
      'metricThresholds':
          pulumi.Input.mapInputValue<
            List<CategoricalPredictionDriftMetricThreshold>,
  ...
  factory PredictionDriftMonitoringSignal.fromMap(Map<String, dynamic> map) {
    return PredictionDriftMonitoringSignal(
      ...
      metricThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CategoricalPredictionDriftMetricThreshold>(
          map['metricThresholds']!,
          (value) => CategoricalPredictionDriftMetricThreshold.fromMap(
