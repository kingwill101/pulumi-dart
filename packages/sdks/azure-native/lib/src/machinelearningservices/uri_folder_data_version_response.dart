...
class UriFolderDataVersionResponse {
  ...
  /// Creates a new [UriFolderDataVersionResponse].
  ...
  const UriFolderDataVersionResponse({
  ...
  factory UriFolderDataVersionResponse.fromMap(Map<String, dynamic> map) {
    return UriFolderDataVersionResponse(
