...
class StorageAccountDetailsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'systemCreatedStorageAccount': ?pulumi.Input.mapOptionalInputValue<SystemCreatedStorageAccountResponse, Map<String, dynamic>>(systemCreatedStorageAccount, (value) => value.toMap()),
    };
  }

  factory StorageAccountDetailsResponse.fromMap(Map<String, dynamic> map) {
    return StorageAccountDetailsResponse(
      systemCreatedStorageAccount: (() { final guardedValue = map['systemCreatedStorageAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SystemCreatedStorageAccountResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
