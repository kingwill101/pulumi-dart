...
class CodeVersionProperties {
  ...
  /// Creates a new [CodeVersionProperties].
  ...
  factory CodeVersionProperties.fromMap(Map<String, dynamic> map) {
    return CodeVersionProperties(
