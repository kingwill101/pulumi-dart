...
class RegistryResponse {
  ...
  factory RegistryResponse.fromMap(Map<String, dynamic> map) {
    return RegistryResponse(
      ...
      managedResourceGroup: (() { final guardedValue = map['managedResourceGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ArmResourceIdResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      managedResourceGroupSettings: (() { final guardedValue = map['managedResourceGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedResourceGroupSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      regionDetails: (() { final guardedValue = map['regionDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistryRegionArmDetailsResponse>(guardedValue, (value) => RegistryRegionArmDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      registryPrivateEndpointConnections: (() { final guardedValue = map['registryPrivateEndpointConnections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegistryPrivateEndpointConnectionResponse>(guardedValue, (value) => RegistryPrivateEndpointConnectionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
