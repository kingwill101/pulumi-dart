...
class FeatureImportanceSettingsResponse {
  ...
  FeatureImportanceSettingsResponse({this.mode, this.targetColumn});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'mode': ?mode, 'targetColumn': ?targetColumn};
  }
  ...
  factory FeatureImportanceSettingsResponse.fromMap(Map<String, dynamic> map) {
    return FeatureImportanceSettingsResponse(
      ...
      targetColumn: (() {
        final guardedValue = map['targetColumn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
