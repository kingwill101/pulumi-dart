...
class SetupScriptsResponse {
  ...
  factory SetupScriptsResponse.fromMap(Map<String, dynamic> map) {
    return SetupScriptsResponse(
      scripts: (() { final guardedValue = map['scripts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScriptsToExecuteResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
