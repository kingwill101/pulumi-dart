...
class MachineLearningDatastoreArgs {
  ...
  factory MachineLearningDatastoreArgs.fromMap(Map<String, dynamic> map) {
    return MachineLearningDatastoreArgs(
      ...
      adlsResourceGroup: (() {
        final guardedValue = map['adlsResourceGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      adlsSubscriptionId: (() {
        final guardedValue = map['adlsSubscriptionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      authorityUrl: (() {
      ...
      includeSecret: (() {
        final guardedValue = map['includeSecret'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: (() {
      ...
      workspaceSystemAssignedIdentity: (() {
        final guardedValue = map['workspaceSystemAssignedIdentity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
