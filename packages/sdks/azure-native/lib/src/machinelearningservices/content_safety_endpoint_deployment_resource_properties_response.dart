...
class ContentSafetyEndpointDeploymentResourcePropertiesResponse {
  ...
  /// Creates a new [ContentSafetyEndpointDeploymentResourcePropertiesResponse].
  ...
  factory ContentSafetyEndpointDeploymentResourcePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ContentSafetyEndpointDeploymentResourcePropertiesResponse(
      ...
      model: pulumi.Input.fromValue(EndpointDeploymentModelResponse.fromMap((map['model']! as Map).cast<String, dynamic>())),
      ...
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CognitiveServicesSkuResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
