...
class InferenceEndpointMachinelearningservices extends pulumi.CustomResource {
  ...
  InferenceEndpointMachinelearningservices(
    ...
    inferenceEndpointProperties = registerOutput<InferenceEndpointResponse>('inferenceEndpointProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InferenceEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [InferenceEndpointMachinelearningservices] resource.
  InferenceEndpointMachinelearningservices.reference(String urn)
    : super(
        'azure-native:machinelearningservices:InferenceEndpoint',
