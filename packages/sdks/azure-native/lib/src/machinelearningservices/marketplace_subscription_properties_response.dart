...
class MarketplaceSubscriptionPropertiesResponse {
  ...
  /// Creates a new [MarketplaceSubscriptionPropertiesResponse].
  ...
  const MarketplaceSubscriptionPropertiesResponse({
  ...
  factory MarketplaceSubscriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MarketplaceSubscriptionPropertiesResponse(
