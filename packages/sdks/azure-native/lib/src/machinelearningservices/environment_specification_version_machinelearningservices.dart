...
class EnvironmentSpecificationVersionMachinelearningservices extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [EnvironmentSpecificationVersionMachinelearningservices] resource.
  EnvironmentSpecificationVersionMachinelearningservices.reference(String urn)
    : super(
        'azure-native:machinelearningservices:EnvironmentSpecificationVersion',
