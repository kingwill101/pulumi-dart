...
class RegistryPrivateEndpointConnectionPropertiesResponse {
  ...
  final pulumi.Input<RegistryPrivateLinkServiceConnectionStateResponse>?
  ...
  factory RegistryPrivateEndpointConnectionPropertiesResponse.fromMap(
    ...
    return RegistryPrivateEndpointConnectionPropertiesResponse(
      ...
      privateEndpoint: (() {
        ...
        return pulumi.Input.fromValue(
          PrivateEndpointResourceResponse.fromMap(
      ...
      registryPrivateLinkServiceConnectionState: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegistryPrivateLinkServiceConnectionStateResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
