...
class SASAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final pulumi.Input<WorkspaceConnectionSharedAccessSignatureResponse>?
  credentials;
  ...
  factory SASAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(
    ...
    return SASAuthTypeWorkspaceConnectionPropertiesResponse(
      ...
      credentials: (() {
        ...
        return pulumi.Input.fromValue(
          WorkspaceConnectionSharedAccessSignatureResponse.fromMap(
