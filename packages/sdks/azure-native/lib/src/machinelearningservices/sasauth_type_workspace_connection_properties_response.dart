...
class SASAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final pulumi.Input<WorkspaceConnectionSharedAccessSignatureResponse>? credentials;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionSharedAccessSignatureResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory SASAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SASAuthTypeWorkspaceConnectionPropertiesResponse(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionSharedAccessSignatureResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
