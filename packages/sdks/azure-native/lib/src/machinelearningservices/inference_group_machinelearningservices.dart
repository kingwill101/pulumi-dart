...
import 'inference_group_args.dart';
...
/// ```
class InferenceGroupMachinelearningservices extends pulumi.CustomResource {
  /// The Azure API version of the resource.
  late final pulumi.Output<String> azureApiVersion;
  /// Managed service identity (system assigned and/or user assigned identities)
  late final pulumi.Output<ManagedServiceIdentityResponse?> identity;
  /// [Required] Additional attributes of the entity.
  late final pulumi.Output<InferenceGroupResponse> inferenceGroupProperties;
  ...
  /// Creates a new [InferenceGroupMachinelearningservices].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InferenceGroupMachinelearningservices]. {@macro pulumi_machinelearningservices_inference_group_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  InferenceGroupMachinelearningservices(
    String name, {
    InferenceGroupArgs? args,
    ...
    inferenceGroupProperties = registerOutput<InferenceGroupResponse>('inferenceGroupProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return InferenceGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [InferenceGroupMachinelearningservices] resource.
  InferenceGroupMachinelearningservices.reference(String urn)
    : super(
        'azure-native:machinelearningservices:InferenceGroup',
