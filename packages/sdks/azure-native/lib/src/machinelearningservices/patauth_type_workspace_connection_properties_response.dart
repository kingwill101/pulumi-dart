...
class PATAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final pulumi.Input<WorkspaceConnectionPersonalAccessTokenResponse>?
  credentials;
  ...
  factory PATAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(
    ...
    return PATAuthTypeWorkspaceConnectionPropertiesResponse(
      ...
      credentials: (() {
        ...
        return pulumi.Input.fromValue(
          WorkspaceConnectionPersonalAccessTokenResponse.fromMap(
