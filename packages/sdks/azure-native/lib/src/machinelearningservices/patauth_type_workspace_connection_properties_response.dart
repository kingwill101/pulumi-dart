...
class PATAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  /// [createdByWorkspaceArmId] A type definition that refers the id to an Azure Resource Manager resource.
  ...
  const PATAuthTypeWorkspaceConnectionPropertiesResponse({
  ...
  factory PATAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return PATAuthTypeWorkspaceConnectionPropertiesResponse(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionPersonalAccessTokenResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
