...
class EndpointModelSkuPropertiesResponse {
  ...
  final pulumi.Input<List<EndpointModelSkuRateLimitPropertiesResponse>>?
  rateLimits;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rateLimits':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointModelSkuRateLimitPropertiesResponse>,
    ...
    return EndpointModelSkuPropertiesResponse(
      capacity: (() {
        ...
        return pulumi.Input.fromValue(
          EndpointModelSkuCapacityPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      connectionIds: (() {
        final guardedValue = map['connectionIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      deprecationDate: (() {
        final guardedValue = map['deprecationDate'];
        if (guardedValue == null) return null;
      ...
      rateLimits: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointModelSkuRateLimitPropertiesResponse>(
            guardedValue,
            (value) => EndpointModelSkuRateLimitPropertiesResponse.fromMap(
      ...
      usageName: (() {
        final guardedValue = map['usageName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
