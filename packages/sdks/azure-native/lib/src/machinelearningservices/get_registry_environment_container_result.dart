...
class GetRegistryEnvironmentContainerResult {
  ...
  factory GetRegistryEnvironmentContainerResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRegistryEnvironmentContainerResult(
      azureApiVersion: map['azureApiVersion'] as String,
      environmentContainerProperties: EnvironmentContainerResponse.fromMap(
        (map['environmentContainerProperties']! as Map).cast<String, dynamic>(),
      ),
      id: map['id'] as String,
