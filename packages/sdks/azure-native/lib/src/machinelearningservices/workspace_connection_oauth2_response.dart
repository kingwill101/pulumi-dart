...
class WorkspaceConnectionOAuth2Response {
  ...
  /// Creates a new [WorkspaceConnectionOAuth2Response].
  ...
  factory WorkspaceConnectionOAuth2Response.fromMap(Map<String, dynamic> map) {
    return WorkspaceConnectionOAuth2Response(
      authUrl: (() {
