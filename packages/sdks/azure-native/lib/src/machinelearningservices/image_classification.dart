...
class ImageClassification {
  ...
  final pulumi.Input<List<ImageModelDistributionSettingsClassification>>?
  searchSpace;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'limitSettings':
          pulumi.Input.mapInputValue<ImageLimitSettings, Map<String, dynamic>>(
            limitSettings,
            (value) => value.toMap(),
          ),
      ...
      'sweepSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ImageSweepSettings,
            Map<String, dynamic>
          >(sweepSettings, (value) => value.toMap()),
  ...
  factory ImageClassification.fromMap(Map<String, dynamic> map) {
    return ImageClassification(
      limitSettings: pulumi.Input.fromValue(
        ImageLimitSettings.fromMap(
          (map['limitSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      logVerbosity: (() {
      ...
      modelSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ImageModelSettingsClassification.fromMap(
      ...
      searchSpace: (() {
        final guardedValue = map['searchSpace'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageModelDistributionSettingsClassification>(
            guardedValue,
            (value) => ImageModelDistributionSettingsClassification.fromMap(
      ...
      sweepSettings: (() {
        final guardedValue = map['sweepSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageSweepSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
