...
class KubernetesOnlineDeploymentResponse {
  ...
  factory KubernetesOnlineDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesOnlineDeploymentResponse(
      ...
      containerResourceRequirements: map['containerResourceRequirements'] == null ? null : (ContainerResourceRequirementsResponse.fromMap((map['containerResourceRequirements'] as Map).cast<String, dynamic>())).input(),
