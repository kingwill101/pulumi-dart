...
class KubernetesOnlineDeploymentResponse {
  ...
  final pulumi.Input<ContainerResourceRequirementsResponse>?
    ...
    return <String, dynamic>{
      ...
      'containerResourceRequirements':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(containerResourceRequirements, (value) => value.toMap()),
      'dataCollector':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory KubernetesOnlineDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesOnlineDeploymentResponse(
      ...
      containerResourceRequirements: (() {
        final guardedValue = map['containerResourceRequirements'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerResourceRequirementsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
