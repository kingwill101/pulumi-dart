...
class KubernetesOnlineDeploymentResponse {
  ...
  final pulumi.Input<ContainerResourceRequirementsResponse?>? containerResourceRequirements;
  ...
  final pulumi.Input<dynamic>? scaleSettings;
  ...
  KubernetesOnlineDeploymentResponse({
    pulumi.Input<bool?>? appInsightsEnabled,
    this.codeConfiguration,
    this.containerResourceRequirements,
    this.dataCollector,
    this.description,
    pulumi.Input<String?>? egressPublicNetworkAccess,
    required this.endpointComputeType,
    this.environmentId,
    this.environmentVariables,
    pulumi.Input<String?>? instanceType,
    this.livenessProbe,
    this.model,
    this.modelMountPath,
    this.properties,
    ...
    this.scaleSettings,
    this.startupProbe,
  }) : appInsightsEnabled = appInsightsEnabled ?? pulumi.Input.fromValue(false), egressPublicNetworkAccess = egressPublicNetworkAccess ?? pulumi.Input.fromValue('Enabled'), instanceType = instanceType ?? pulumi.Input.fromValue('Standard_F4s_v2');
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'containerResourceRequirements': ?pulumi.Input.mapOptionalInputValue<ContainerResourceRequirementsResponse, Map<String, dynamic>>(containerResourceRequirements, (value) => value.toMap()),
  ...
  factory KubernetesOnlineDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesOnlineDeploymentResponse(
      appInsightsEnabled: (() { final guardedValue = map['appInsightsEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      containerResourceRequirements: (() { final guardedValue = map['containerResourceRequirements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerResourceRequirementsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataCollector: (() { final guardedValue = map['dataCollector']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataCollectorResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      egressPublicNetworkAccess: (() { final guardedValue = map['egressPublicNetworkAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      endpointComputeType: pulumi.Input.fromValue(map['endpointComputeType'] as String),
      ...
      modelMountPath: (() { final guardedValue = map['modelMountPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      requestSettings: (() { final guardedValue = map['requestSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnlineRequestSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scaleSettings: (() { final guardedValue = map['scaleSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
