...
class KubernetesOnlineDeploymentResponse {
  ...
  factory KubernetesOnlineDeploymentResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesOnlineDeploymentResponse(
      ...
      scaleSettings: (() { final guardedValue = map['scaleSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultScaleSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
