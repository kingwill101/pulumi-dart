...
class TableVerticalFeaturizationSettings {
  ...
  factory TableVerticalFeaturizationSettings.fromMap(Map<String, dynamic> map) {
    return TableVerticalFeaturizationSettings(
      ...
      transformerParams: map['transformerParams'] == null ? null : (pulumi.Input.decodeMapValues<List<ColumnTransformer>>(map['transformerParams'], (value) => pulumi.Input.decodeList<ColumnTransformer>(value, (value) => ColumnTransformer.fromMap((value as Map).cast<String, dynamic>())))).input(),
    );
  }
}
