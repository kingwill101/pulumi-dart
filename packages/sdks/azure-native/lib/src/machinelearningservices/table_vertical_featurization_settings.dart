...
class TableVerticalFeaturizationSettings {
    ...
    return <String, dynamic>{
      ...
      'transformerParams':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, List<ColumnTransformer>>,
            Map<String, List<Map<String, dynamic>>>
          >(
            transformerParams,
            (value) =>
                pulumi.Input.encodeMapValues<
                  List<ColumnTransformer>,
  ...
  factory TableVerticalFeaturizationSettings.fromMap(Map<String, dynamic> map) {
    return TableVerticalFeaturizationSettings(
      blockedTransformers: (() {
        final guardedValue = map['blockedTransformers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      columnNameAndTypes: (() {
        final guardedValue = map['columnNameAndTypes'];
        if (guardedValue == null) return null;
      ...
      enableDnnFeaturization: (() {
        final guardedValue = map['enableDnnFeaturization'];
        if (guardedValue == null) return null;
      ...
      transformerParams: (() {
        final guardedValue = map['transformerParams'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<List<ColumnTransformer>>(
            guardedValue,
            (value) => pulumi.Input.decodeList<ColumnTransformer>(
              value,
              (value) => ColumnTransformer.fromMap(
