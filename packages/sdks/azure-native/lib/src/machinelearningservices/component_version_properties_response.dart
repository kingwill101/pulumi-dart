...
class ComponentVersionPropertiesResponse {
  ...
  /// Creates a new [ComponentVersionPropertiesResponse].
  ...
  const ComponentVersionPropertiesResponse({
    this.componentSpec,
    this.description,
    this.isAnonymous,
    this.isArchived,
  ...
  factory ComponentVersionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ComponentVersionPropertiesResponse(
