  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secretsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, SecretConfiguration>,
            Map<String, Map<String, dynamic>>
          >(
            secretsConfiguration,
            (value) =>
    ...
    return LabelingJob(
      ...
      dataConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          LabelingDataConfiguration.fromMap(
      ...
      jobInstructions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingJobInstructions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      labelCategories: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<LabelCategory>(
            guardedValue,
            (value) =>
                LabelCategory.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      labelingJobMediaProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingJobImageProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mlAssistConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MLAssistConfigurationDisabled.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      secretsConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SecretConfiguration>(
            guardedValue,
            (value) => SecretConfiguration.fromMap(
