...
import 'batch_endpoint_properties_response.dart';
...
class BatchEndpoint extends pulumi.CustomResource {
  ...
  late final pulumi.Output<BatchEndpointPropertiesResponse> properties;
  ...
  /// [args] Arguments used to configure this [BatchEndpoint]. {@macro pulumi_machinelearningservices_batch_endpoint_args_doc}
  ...
  BatchEndpoint(
    ...
    properties = registerOutput<BatchEndpointPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BatchEndpointPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [BatchEndpoint] resource.
  BatchEndpoint.reference(String urn)
    : super(
        'azure-native:machinelearningservices:BatchEndpoint',
