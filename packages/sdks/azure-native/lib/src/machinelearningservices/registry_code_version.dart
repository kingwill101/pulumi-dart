...
/// }
///
/// resource "azure-native_machinelearningservices_registrycodeversion" "registryCodeVersion" {
///   code_name = "string"
///   properties = {
...
class RegistryCodeVersion extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [RegistryCodeVersion] resource.
  RegistryCodeVersion.reference(String urn)
    : super(
        'azure-native:machinelearningservices:RegistryCodeVersion',
