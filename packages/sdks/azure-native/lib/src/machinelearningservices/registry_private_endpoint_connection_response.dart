...
class RegistryPrivateEndpointConnectionResponse {
  ...
  factory RegistryPrivateEndpointConnectionResponse.fromMap(Map<String, dynamic> map) {
    return RegistryPrivateEndpointConnectionResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegistryPrivateEndpointConnectionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
