...
/// Result data returned by getRegistryModelContainer.
class GetRegistryModelContainerResult {
  ...
  /// Creates a new [GetRegistryModelContainerResult].
  ...
  const GetRegistryModelContainerResult({
  ...
  factory GetRegistryModelContainerResult.fromMap(Map<String, dynamic> map) {
