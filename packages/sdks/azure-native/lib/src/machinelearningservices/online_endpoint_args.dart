...
class OnlineEndpointArgs {
  ...
  OnlineEndpointArgs({
    ...
    required pulumi.Output<OnlineEndpointMachinelearningservices> onlineEndpointProperties,
  ...
  factory OnlineEndpointArgs.fromMap(Map<String, dynamic> map) {
    return OnlineEndpointArgs(
      ...
      onlineEndpointProperties: pulumi.Output.create<OnlineEndpointMachinelearningservices>(map['onlineEndpointProperties'] as OnlineEndpointMachinelearningservices),
