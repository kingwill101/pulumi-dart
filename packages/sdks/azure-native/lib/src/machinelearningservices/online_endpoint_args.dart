...
class OnlineEndpointArgs {
  ...
  final pulumi.Input<OnlineEndpointMachinelearningservices>
  ...
  factory OnlineEndpointArgs.fromMap(Map<String, dynamic> map) {
    return OnlineEndpointArgs(
      ...
      onlineEndpointProperties: pulumi.Input.fromValue(
        map['onlineEndpointProperties']
            as OnlineEndpointMachinelearningservices,
      ),
