...
class MonitorNotificationSettings {
  ...
  factory MonitorNotificationSettings.fromMap(Map<String, dynamic> map) {
    return MonitorNotificationSettings(
      emailNotificationSettings: (() { final guardedValue = map['emailNotificationSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MonitorEmailNotificationSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
