...
class ListWorkspaceStorageAccountKeysResult {
  ...
  ListWorkspaceStorageAccountKeysResult({required this.userStorageKey});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'userStorageKey': userStorageKey};
  }

  factory ListWorkspaceStorageAccountKeysResult.fromMap(
