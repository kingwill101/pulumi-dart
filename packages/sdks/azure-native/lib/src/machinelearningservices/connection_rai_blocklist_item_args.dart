...
class ConnectionRaiBlocklistItemArgs {
  ...
  const ConnectionRaiBlocklistItemArgs({
  ...
  factory ConnectionRaiBlocklistItemArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionRaiBlocklistItemArgs(
      ...
      properties: pulumi.Input.fromValue(RaiBlocklistItemProperties.fromMap((map['properties']! as Map).cast<String, dynamic>())),
      ...
      raiBlocklistItemName: (() { final guardedValue = map['raiBlocklistItemName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
