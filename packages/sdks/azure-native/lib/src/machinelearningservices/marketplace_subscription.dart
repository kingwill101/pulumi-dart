...
import 'marketplace_subscription_properties_response.dart';
...
///     {
///         Name = "string",
///         Properties = new AzureNative.MachineLearningServices.Inputs.MarketplaceSubscriptionPropertiesArgs
///         {
///             ModelId = "string",
///         },
...
/// 			Properties: &machinelearningservices.MarketplaceSubscriptionPropertiesArgs{
...
/// }
///
/// resource "azure-native_machinelearningservices_marketplacesubscription" "marketplaceSubscription" {
///   name = "string"
///   properties = {
///     model_id = "string"
///   }
...
/// import com.pulumi.azurenative.machinelearningservices.inputs.MarketplaceSubscriptionPropertiesArgs;
...
///             .name("string")
///             .properties(MarketplaceSubscriptionPropertiesArgs.builder()
///                 .modelId("string")
///                 .build())
///             .resourceGroupName("test-rg")
///             .workspaceName("my-aml-workspace")
...
class MarketplaceSubscription extends pulumi.CustomResource {
  ...
  late final pulumi.Output<MarketplaceSubscriptionPropertiesResponse> properties;
  ...
  /// [args] Arguments used to configure this [MarketplaceSubscription]. {@macro pulumi_machinelearningservices_marketplace_subscription_args_doc}
  ...
  MarketplaceSubscription(
    ...
    properties = registerOutput<MarketplaceSubscriptionPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return MarketplaceSubscriptionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [MarketplaceSubscription] resource.
  MarketplaceSubscription.reference(String urn)
    : super(
        'azure-native:machinelearningservices:MarketplaceSubscription',
