...
class OnlineEndpointMachinelearningservices extends pulumi.CustomResource {
  ...
  OnlineEndpointMachinelearningservices(
    ...
    onlineEndpointProperties = registerOutput<OnlineEndpointResponse>('onlineEndpointProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return OnlineEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
