...
class ModelContainerPropertiesResponse {
  ...
  /// Creates a new [ModelContainerPropertiesResponse].
  ...
  const ModelContainerPropertiesResponse({
    this.description,
    this.isArchived,
  ...
  factory ModelContainerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ModelContainerPropertiesResponse(
