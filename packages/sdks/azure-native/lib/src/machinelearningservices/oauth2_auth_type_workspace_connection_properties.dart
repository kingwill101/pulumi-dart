...
class OAuth2AuthTypeWorkspaceConnectionProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authType': authType,
      'category': ?category,
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionOAuth2, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory OAuth2AuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return OAuth2AuthTypeWorkspaceConnectionProperties(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionOAuth2.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
