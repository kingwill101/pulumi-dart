...
class ListComputeKeysResult {
  ...
  ListComputeKeysResult({required this.computeType});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'computeType': computeType};
  }

  factory ListComputeKeysResult.fromMap(Map<String, dynamic> map) {
    return ListComputeKeysResult(computeType: map['computeType'] as String);
  }
}
