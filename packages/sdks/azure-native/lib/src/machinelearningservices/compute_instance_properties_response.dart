...
class ComputeInstancePropertiesResponse {
  ...
  final pulumi.Input<ComputeInstanceConnectivityEndpointsResponse>
  ...
  final pulumi.Input<PersonalComputeInstanceSettingsResponse>?
    ...
    return <String, dynamic>{
      ...
      'applications':
          pulumi.Input.mapInputValue<
            List<ComputeInstanceApplicationResponse>,
      ...
      'connectivityEndpoints':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(connectivityEndpoints, (value) => value.toMap()),
      'containers':
          pulumi.Input.mapInputValue<
            List<ComputeInstanceContainerResponse>,
            List<Map<String, dynamic>>
          >(
            containers,
            (value) =>
      ...
      'dataDisks':
          pulumi.Input.mapInputValue<
            List<ComputeInstanceDataDiskResponse>,
            List<Map<String, dynamic>>
          >(
            dataDisks,
            (value) =>
      ...
      'dataMounts':
          pulumi.Input.mapInputValue<
            List<ComputeInstanceDataMountResponse>,
            List<Map<String, dynamic>>
          >(
            dataMounts,
            (value) =>
      ...
      'osImageMetadata':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(osImageMetadata, (value) => value.toMap()),
      'personalComputeInstanceSettings':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ComputeInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ComputeInstancePropertiesResponse(
      ...
      applications: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ComputeInstanceApplicationResponse>(
          map['applications']!,
          (value) => ComputeInstanceApplicationResponse.fromMap(
      ...
      connectivityEndpoints: pulumi.Input.fromValue(
        ComputeInstanceConnectivityEndpointsResponse.fromMap(
          (map['connectivityEndpoints']! as Map).cast<String, dynamic>(),
        ),
      ),
      containers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ComputeInstanceContainerResponse>(
          map['containers']!,
          (value) => ComputeInstanceContainerResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      createdBy: pulumi.Input.fromValue(
        ComputeInstanceCreatedByResponse.fromMap(
      ...
      customServices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomServiceResponse>(
            guardedValue,
            (value) => CustomServiceResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      dataDisks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ComputeInstanceDataDiskResponse>(
          map['dataDisks']!,
          (value) => ComputeInstanceDataDiskResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      dataMounts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ComputeInstanceDataMountResponse>(
          map['dataMounts']!,
          (value) => ComputeInstanceDataMountResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      lastOperation: pulumi.Input.fromValue(
        ComputeInstanceLastOperationResponse.fromMap(
          (map['lastOperation']! as Map).cast<String, dynamic>(),
        ),
      ),
      osImageMetadata: pulumi.Input.fromValue(
        ImageMetadataResponse.fromMap(
          (map['osImageMetadata']! as Map).cast<String, dynamic>(),
        ),
      ),
      personalComputeInstanceSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PersonalComputeInstanceSettingsResponse.fromMap(
      ...
      schedules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeSchedulesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sshSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComputeInstanceSshSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      versions: pulumi.Input.fromValue(
        ComputeInstanceVersionResponse.fromMap(
          (map['versions']! as Map).cast<String, dynamic>(),
        ),
      ),
      vmSize: (() {
