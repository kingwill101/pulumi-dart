...
/// }
///
/// resource "azure-native_machinelearningservices_registrymodelcontainer" "registryModelContainer" {
...
class RegistryModelContainer extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [RegistryModelContainer] resource.
  RegistryModelContainer.reference(String urn)
    : super(
        'azure-native:machinelearningservices:RegistryModelContainer',
