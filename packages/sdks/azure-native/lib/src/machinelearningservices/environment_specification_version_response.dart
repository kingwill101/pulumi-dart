...
class EnvironmentSpecificationVersionResponse {
  ...
  final pulumi.Input<InferenceContainerPropertiesResponse>?
  ...
  factory EnvironmentSpecificationVersionResponse.fromMap(
    ...
    return EnvironmentSpecificationVersionResponse(
      ...
      docker: (() {
        ...
        return pulumi.Input.fromValue(
          DockerBuildResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      environmentSpecificationType: pulumi.Input.fromValue(
        map['environmentSpecificationType'] as String,
      ),
      inferenceContainerProperties: (() {
