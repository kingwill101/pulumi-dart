...
class GetInferenceGroupResult {
  ...
  const GetInferenceGroupResult({
    this.azureApiVersion,
    this.id,
    this.identity,
    this.inferenceGroupProperties,
    this.kind,
    this.location,
    this.name,
    this.sku,
  ...
  factory GetInferenceGroupResult.fromMap(Map<String, dynamic> map) {
    return GetInferenceGroupResult(
      ...
      inferenceGroupProperties: (() { final guardedValue = map['inferenceGroupProperties']; if (guardedValue == null) return null; return InferenceGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
