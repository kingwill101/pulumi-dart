...
class ComputeSchedulesResponse {
  ...
  ComputeSchedulesResponse({this.computeStartStop});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'computeStartStop':
          ?pulumi.Input.mapOptionalInputValue<
            List<ComputeStartStopScheduleResponse>,
  ...
  factory ComputeSchedulesResponse.fromMap(Map<String, dynamic> map) {
    return ComputeSchedulesResponse(
      computeStartStop: (() {
        final guardedValue = map['computeStartStop'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ComputeStartStopScheduleResponse>(
            guardedValue,
            (value) => ComputeStartStopScheduleResponse.fromMap(
