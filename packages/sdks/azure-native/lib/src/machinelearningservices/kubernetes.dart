...
class Kubernetes {
  ...
  factory Kubernetes.fromMap(Map<String, dynamic> map) {
    return Kubernetes(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KubernetesProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
