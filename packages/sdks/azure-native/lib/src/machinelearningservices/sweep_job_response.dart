...
class SweepJobResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'objective':
          pulumi.Input.mapInputValue<ObjectiveResponse, Map<String, dynamic>>(
            objective,
            (value) => value.toMap(),
          ),
      'outputs':
  ...
  factory SweepJobResponse.fromMap(Map<String, dynamic> map) {
    return SweepJobResponse(
      ...
      limits: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SweepJobLimitsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      samplingAlgorithm: pulumi.Input.fromValue(
        BayesianSamplingAlgorithmResponse.fromMap(
      ...
      trial: pulumi.Input.fromValue(
        TrialComponentResponse.fromMap(
          (map['trial']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
