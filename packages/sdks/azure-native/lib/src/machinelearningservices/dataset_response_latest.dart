    ...
    return <String, dynamic>{
      ...
      'datasetDefinitionState':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(datasetDefinitionState, (value) => value.toMap()),
      'datasetId': datasetId,
  ...
  factory DatasetResponseLatest.fromMap(Map<String, dynamic> map) {
    return DatasetResponseLatest(
      ...
      dataPath: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetResponseDataPath.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      datasetDefinitionState: (() {
        final guardedValue = map['datasetDefinitionState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatasetStateResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      partitionFormatInPath: pulumi.Input.fromValue(
        map['partitionFormatInPath'] as bool,
      ),
      properties: (() {
      ...
      telemetryInfo: pulumi.Input.fromValue(
        (map['telemetryInfo'] as Map).cast<String, String>(),
      ),
      useDescriptionTagsFromDefinition: pulumi.Input.fromValue(
        map['useDescriptionTagsFromDefinition'] as bool,
      ),
