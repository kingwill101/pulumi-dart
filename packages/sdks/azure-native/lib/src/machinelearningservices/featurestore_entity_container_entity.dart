...
import 'featurestore_entity_container_properties_response.dart';
...
///     {
///         Name = "string",
///         Properties = new AzureNative.MachineLearningServices.Inputs.FeaturestoreEntityContainerPropertiesArgs
///         {
///             Description = "string",
///             IsArchived = false,
///             Properties =
...
/// 			Properties: &machinelearningservices.FeaturestoreEntityContainerPropertiesArgs{
...
/// }
///
/// resource "azure-native_machinelearningservices_featurestoreentitycontainerentity" "featurestoreEntityContainerEntity" {
///   name = "string"
///   properties = {
///     description = "string"
///     is_archived = false
...
/// import com.pulumi.azurenative.machinelearningservices.inputs.FeaturestoreEntityContainerPropertiesArgs;
...
///             .name("string")
///             .properties(FeaturestoreEntityContainerPropertiesArgs.builder()
///                 .description("string")
///                 .isArchived(false)
...
class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
  ...
  late final pulumi.Output<FeaturestoreEntityContainerPropertiesResponse> properties;
  ...
  FeaturestoreEntityContainerEntity(
    ...
    properties = registerOutput<FeaturestoreEntityContainerPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FeaturestoreEntityContainerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [FeaturestoreEntityContainerEntity] resource.
  FeaturestoreEntityContainerEntity.reference(String urn)
    : super(
        'azure-native:machinelearningservices:FeaturestoreEntityContainerEntity',
