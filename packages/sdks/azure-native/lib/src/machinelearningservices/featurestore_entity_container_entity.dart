...
class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
  ...
  late final pulumi.Output<FeaturestoreEntityContainerResponse>
  featurestoreEntityContainerProperties;
  ...
  FeaturestoreEntityContainerEntity(
    ...
    featurestoreEntityContainerProperties =
        registerOutput<FeaturestoreEntityContainerResponse>(
          'featurestoreEntityContainerProperties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return FeaturestoreEntityContainerResponse.fromMap(
