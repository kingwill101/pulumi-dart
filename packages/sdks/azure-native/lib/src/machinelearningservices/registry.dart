...
class Registry {
  ...
  final pulumi.Input<List<RegistryPrivateEndpointConnection>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'registryPrivateEndpointConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegistryPrivateEndpointConnection>,
            List<Map<String, dynamic>>
          >(
            registryPrivateEndpointConnections,
            (value) =>
  ...
  factory Registry.fromMap(Map<String, dynamic> map) {
    return Registry(
      ...
      regionDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegistryRegionArmDetails>(
            guardedValue,
            (value) => RegistryRegionArmDetails.fromMap(
      ...
      registryPrivateEndpointConnections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegistryPrivateEndpointConnection>(
            guardedValue,
            (value) => RegistryPrivateEndpointConnection.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
