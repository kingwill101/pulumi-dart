...
class EndpointModelPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'skus':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointModelSkuPropertiesResponse>,
  ...
  factory EndpointModelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EndpointModelPropertiesResponse(
      ...
      deprecation: (() {
        final guardedValue = map['deprecation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointModelDeprecationPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      finetuneCapabilities: (() {
        final guardedValue = map['finetuneCapabilities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      lifecycleStatus: (() {
        final guardedValue = map['lifecycleStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxCapacity: (() {
      ...
      skus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointModelSkuPropertiesResponse>(
            guardedValue,
            (value) => EndpointModelSkuPropertiesResponse.fromMap(
