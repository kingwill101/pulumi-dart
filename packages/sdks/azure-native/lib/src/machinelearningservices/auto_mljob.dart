...
class AutoMLJob {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tags': ?tags,
      'taskDetails':
          pulumi.Input.mapInputValue<Classification, Map<String, dynamic>>(
            taskDetails,
            (value) => value.toMap(),
          ),
    };
  ...
  factory AutoMLJob.fromMap(Map<String, dynamic> map) {
    return AutoMLJob(
      ...
      resources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobResourceConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      taskDetails: pulumi.Input.fromValue(
        Classification.fromMap(
          (map['taskDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
