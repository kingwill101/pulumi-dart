...
import 'workspace_connection_managed_identity_response.dart';

class ManagedIdentityAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final pulumi.Input<WorkspaceConnectionManagedIdentityResponse?>? credentials;
  ...
  /// Creates a new [ManagedIdentityAuthTypeWorkspaceConnectionPropertiesResponse].
  ...
  const ManagedIdentityAuthTypeWorkspaceConnectionPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionManagedIdentityResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory ManagedIdentityAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ManagedIdentityAuthTypeWorkspaceConnectionPropertiesResponse(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createdByWorkspaceArmId: pulumi.Input.fromValue(map['createdByWorkspaceArmId'] as String),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionManagedIdentityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
