...
/// Result data returned by getOnlineDeployment.
class GetOnlineDeploymentResult {
  ...
  /// Creates a new [GetOnlineDeploymentResult].
  ...
  factory GetOnlineDeploymentResult.fromMap(Map<String, dynamic> map) {
    return GetOnlineDeploymentResult(
      ...
      onlineDeploymentProperties: KubernetesOnlineDeploymentResponse.fromMap(
