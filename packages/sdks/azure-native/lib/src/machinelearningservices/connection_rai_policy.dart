...
import 'connection_rai_policy_args.dart';
...
/// }
///
/// resource "azure-native_machinelearningservices_connectionraipolicy" "connectionRaiPolicy" {
...
/// ```
class ConnectionRaiPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ConnectionRaiPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConnectionRaiPolicy]. {@macro pulumi_machinelearningservices_connection_rai_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ConnectionRaiPolicy(
    String name, {
    ConnectionRaiPolicyArgs? args,
  ...
  /// Creates a typed reference to an existing [ConnectionRaiPolicy] resource.
  ConnectionRaiPolicy.reference(String urn)
    : super(
        'azure-native:machinelearningservices:ConnectionRaiPolicy',
