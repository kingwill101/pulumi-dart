...
class SparkJobResponse {
  ...
  factory SparkJobResponse.fromMap(Map<String, dynamic> map) {
    return SparkJobResponse(
      ...
      entry: pulumi.Input.fromValue(SparkJobPythonEntryResponse.fromMap((map['entry']! as Map).cast<String, dynamic>())),
      ...
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SparkResourceConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
