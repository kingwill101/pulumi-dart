...
import 'workspace_connection_username_password.dart';
...
class UsernamePasswordAuthTypeWorkspaceConnectionProperties {
  ...
  final pulumi.Input<WorkspaceConnectionUsernamePassword>? credentials;
  ...
  /// Creates a new [UsernamePasswordAuthTypeWorkspaceConnectionProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authType': authType,
      'category': ?category,
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionUsernamePassword, Map<String, dynamic>>(credentials, (value) => value.toMap()),
  ...
  factory UsernamePasswordAuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return UsernamePasswordAuthTypeWorkspaceConnectionProperties(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionUsernamePassword.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
