...
class UsernamePasswordAuthTypeWorkspaceConnectionProperties {
  ...
  final WorkspaceConnectionUsernamePassword? credentials;
  ...
  factory UsernamePasswordAuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return UsernamePasswordAuthTypeWorkspaceConnectionProperties(
      ...
      credentials: map['credentials'] == null ? null : WorkspaceConnectionUsernamePassword.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
