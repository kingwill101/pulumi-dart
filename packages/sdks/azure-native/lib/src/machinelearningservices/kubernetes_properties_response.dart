...
class KubernetesPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'instanceTypes':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, InstanceTypeSchemaResponse>,
  ...
  factory KubernetesPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesPropertiesResponse(
      defaultInstanceType: (() {
        final guardedValue = map['defaultInstanceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      extensionInstanceReleaseTrain: (() {
        final guardedValue = map['extensionInstanceReleaseTrain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      extensionPrincipalId: (() {
        final guardedValue = map['extensionPrincipalId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      instanceTypes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<InstanceTypeSchemaResponse>(
            guardedValue,
            (value) => InstanceTypeSchemaResponse.fromMap(
      ...
      relayConnectionString: (() {
        final guardedValue = map['relayConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceBusConnectionString: (() {
        final guardedValue = map['serviceBusConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vcName: (() {
        final guardedValue = map['vcName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
