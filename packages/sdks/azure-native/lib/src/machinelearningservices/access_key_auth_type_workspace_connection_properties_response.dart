...
class AccessKeyAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final pulumi.Input<WorkspaceConnectionAccessKeyResponse>? credentials;
  ...
  const AccessKeyAuthTypeWorkspaceConnectionPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionAccessKeyResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory AccessKeyAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AccessKeyAuthTypeWorkspaceConnectionPropertiesResponse(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionAccessKeyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
