...
/// ```
class CapacityReservationGroupMachinelearningservices
    extends pulumi.CustomResource {
  /// The Azure API version of the resource.
  late final pulumi.Output<String> azureApiVersion;

  /// [Required] Additional attributes of the entity.
  late final pulumi.Output<CapacityReservationGroupResponse>
  ...
  CapacityReservationGroupMachinelearningservices(
    ...
    capacityReservationGroupProperties =
        registerOutput<CapacityReservationGroupResponse>(
          'capacityReservationGroupProperties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return CapacityReservationGroupResponse.fromMap(
