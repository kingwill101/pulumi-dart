...
class BatchDeploymentPropertiesResponse {
  ...
  const BatchDeploymentPropertiesResponse({
  ...
  factory BatchDeploymentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return BatchDeploymentPropertiesResponse(
      ...
      model: (() { final guardedValue = map['model']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataPathAssetReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
