...
class ListFeaturesetVersionMaterializationJobsResult {
  ...
  ListFeaturesetVersionMaterializationJobsResult({this.nextLink, this.value});
  ...
  factory ListFeaturesetVersionMaterializationJobsResult.fromMap(
    ...
    return ListFeaturesetVersionMaterializationJobsResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<FeaturesetJobResponse>(
          guardedValue,
          (value) => FeaturesetJobResponse.fromMap(
