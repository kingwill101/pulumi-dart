...
class EndpointModelSkuRateLimitRulePropertiesResponse {
  ...
  final pulumi.Input<
    List<EndpointModelSkuRateLimitRulePatternPropertiesResponse>
  >?
  matchPatterns;
  ...
  factory EndpointModelSkuRateLimitRulePropertiesResponse.fromMap(
      ...
      matchPatterns: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EndpointModelSkuRateLimitRulePatternPropertiesResponse.fromMap(
