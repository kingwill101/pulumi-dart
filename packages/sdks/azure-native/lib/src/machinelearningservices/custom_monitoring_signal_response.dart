...
class CustomMonitoringSignalResponse {
    ...
    return <String, dynamic>{
      ...
      'inputAssets':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, FixedInputDataResponse>,
      ...
      'metricThresholds':
          pulumi.Input.mapInputValue<
            List<CustomMetricThresholdResponse>,
  ...
  factory CustomMonitoringSignalResponse.fromMap(Map<String, dynamic> map) {
    return CustomMonitoringSignalResponse(
      ...
      inputAssets: (() {
        final guardedValue = map['inputAssets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<FixedInputDataResponse>(
            guardedValue,
      ...
      metricThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CustomMetricThresholdResponse>(
          map['metricThresholds']!,
          (value) => CustomMetricThresholdResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
