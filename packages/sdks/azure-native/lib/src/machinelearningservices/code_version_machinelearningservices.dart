...
class CodeVersionMachinelearningservices extends pulumi.CustomResource {
  ...
  CodeVersionMachinelearningservices(
    ...
    codeVersionProperties = registerOutput<CodeVersionResponse>('codeVersionProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CodeVersionResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
