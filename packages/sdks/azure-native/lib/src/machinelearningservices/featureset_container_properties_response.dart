...
class FeaturesetContainerPropertiesResponse {
  ...
  /// Creates a new [FeaturesetContainerPropertiesResponse].
  ...
  const FeaturesetContainerPropertiesResponse({
    this.description,
    this.isArchived,
  ...
  factory FeaturesetContainerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return FeaturesetContainerPropertiesResponse(
