...
class ImageInstanceSegmentation {
  ...
  final pulumi.Input<List<ImageModelDistributionSettingsObjectDetection>>?
  searchSpace;
  ...
  /// Creates a new [ImageInstanceSegmentation].
    ...
    return ImageInstanceSegmentation(
      ...
      modelSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ImageModelSettingsObjectDetection.fromMap(
      ...
      searchSpace: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ImageModelDistributionSettingsObjectDetection>(
            guardedValue,
            (value) => ImageModelDistributionSettingsObjectDetection.fromMap(
