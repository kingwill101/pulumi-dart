    ...
    return <String, dynamic>{
      'acrDetails':
          ...
          >(
            acrDetails,
            (value) =>
                pulumi.Input.encodeList<AcrDetails, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return RegistryRegionArmDetails(
      acrDetails: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AcrDetails>(
            guardedValue,
            (value) =>
                AcrDetails.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      location: (() {
      ...
      storageAccountDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StorageAccountDetails>(
            guardedValue,
            (value) => StorageAccountDetails.fromMap(
