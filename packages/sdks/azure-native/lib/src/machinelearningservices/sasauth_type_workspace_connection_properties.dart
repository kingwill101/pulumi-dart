...
class SASAuthTypeWorkspaceConnectionProperties {
  ...
  final pulumi.Input<WorkspaceConnectionSharedAccessSignature>? credentials;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authType': authType,
      'category': ?category,
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionSharedAccessSignature, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory SASAuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return SASAuthTypeWorkspaceConnectionProperties(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionSharedAccessSignature.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
