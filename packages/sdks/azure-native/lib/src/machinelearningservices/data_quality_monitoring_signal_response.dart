...
class DataQualityMonitoringSignalResponse {
  ...
  final List<CategoricalDataQualityMetricThresholdResponse> metricThresholds;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metricThresholds': pulumi.Input.encodeList<CategoricalDataQualityMetricThresholdResponse, Map<String, dynamic>>(metricThresholds, (value) => value.toMap()),
  ...
  factory DataQualityMonitoringSignalResponse.fromMap(Map<String, dynamic> map) {
    return DataQualityMonitoringSignalResponse(
      ...
      metricThresholds: pulumi.Input.decodeList<CategoricalDataQualityMetricThresholdResponse>(map['metricThresholds'], (value) => CategoricalDataQualityMetricThresholdResponse.fromMap((value as Map).cast<String, dynamic>())),
