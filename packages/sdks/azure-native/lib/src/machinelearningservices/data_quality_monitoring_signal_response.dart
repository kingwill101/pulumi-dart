...
class DataQualityMonitoringSignalResponse {
  ...
  final pulumi.Input<List<CategoricalDataQualityMetricThresholdResponse>>
  metricThresholds;
    ...
    return <String, dynamic>{
      ...
      'metricThresholds':
          pulumi.Input.mapInputValue<
            List<CategoricalDataQualityMetricThresholdResponse>,
  ...
  factory DataQualityMonitoringSignalResponse.fromMap(
    ...
    return DataQualityMonitoringSignalResponse(
      ...
      features: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AllFeaturesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      metricThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CategoricalDataQualityMetricThresholdResponse>(
          map['metricThresholds']!,
          (value) => CategoricalDataQualityMetricThresholdResponse.fromMap(
