...
class Databricks {
  ...
  factory Databricks.fromMap(Map<String, dynamic> map) {
    return Databricks(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatabricksProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
