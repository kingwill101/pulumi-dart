...
class CustomServiceResponse {
  ...
  final pulumi.Input<Map<String, EnvironmentVariableResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'environmentVariables':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, EnvironmentVariableResponse>,
    ...
    return CustomServiceResponse(
      docker: (() {
        ...
        return pulumi.Input.fromValue(
          DockerResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      endpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EndpointResponse>(
            guardedValue,
            (value) => EndpointResponse.fromMap(
      ...
      environmentVariables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<EnvironmentVariableResponse>(
            guardedValue,
      ...
      image: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      volumes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VolumeDefinitionResponse>(
            guardedValue,
            (value) => VolumeDefinitionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
