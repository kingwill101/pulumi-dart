...
class GetBatchEndpointResult {
  ...
  final BatchEndpointPropertiesResponse? properties;
  ...
  factory GetBatchEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetBatchEndpointResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return BatchEndpointPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
