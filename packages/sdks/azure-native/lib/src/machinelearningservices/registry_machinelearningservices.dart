...
/// ```
class RegistryMachinelearningservices extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RegistryResponse> registryProperties;
  ...
  /// Creates a new [RegistryMachinelearningservices].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegistryMachinelearningservices]. {@macro pulumi_machinelearningservices_registry_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  RegistryMachinelearningservices(
    String name, {
    RegistryArgs? args,
    ...
    registryProperties = registerOutput<RegistryResponse>('registryProperties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RegistryResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
