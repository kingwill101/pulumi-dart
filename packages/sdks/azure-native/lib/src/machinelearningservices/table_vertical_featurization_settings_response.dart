...
class TableVerticalFeaturizationSettingsResponse {
  ...
  final pulumi.Input<Map<String, List<ColumnTransformerResponse>>>?
  transformerParams;
    ...
    return <String, dynamic>{
      ...
      'transformerParams':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, List<ColumnTransformerResponse>>,
            Map<String, List<Map<String, dynamic>>>
          >(
            transformerParams,
            (value) =>
                pulumi.Input.encodeMapValues<
                  List<ColumnTransformerResponse>,
  ...
  factory TableVerticalFeaturizationSettingsResponse.fromMap(
    ...
    return TableVerticalFeaturizationSettingsResponse(
      ...
      transformerParams: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<List<ColumnTransformerResponse>>(
            guardedValue,
            (value) => pulumi.Input.decodeList<ColumnTransformerResponse>(
              value,
              (value) => ColumnTransformerResponse.fromMap(
