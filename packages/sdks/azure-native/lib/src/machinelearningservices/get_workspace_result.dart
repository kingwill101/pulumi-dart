...
class GetWorkspaceResult {
  ...
  final ServiceManagedResourcesSettingsResponse?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sharedPrivateLinkResources': ?(() {
        final guardedValue = sharedPrivateLinkResources;
  ...
  factory GetWorkspaceResult.fromMap(Map<String, dynamic> map) {
    return GetWorkspaceResult(
      ...
      notebookInfo: NotebookResourceInfoResponse.fromMap(
        (map['notebookInfo']! as Map).cast<String, dynamic>(),
      ),
      ...
      serviceProvisionedResourceGroup:
          map['serviceProvisionedResourceGroup'] as String,
      sharedPrivateLinkResources: (() {
        final guardedValue = map['sharedPrivateLinkResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<SharedPrivateLinkResourceResponse>(
          guardedValue,
