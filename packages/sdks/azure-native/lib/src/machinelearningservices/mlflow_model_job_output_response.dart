...
class MLFlowModelJobOutputResponse {
  ...
  /// Creates a new [MLFlowModelJobOutputResponse].
  ...
  factory MLFlowModelJobOutputResponse.fromMap(Map<String, dynamic> map) {
    return MLFlowModelJobOutputResponse(
