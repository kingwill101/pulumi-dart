...
class ManagedResourceGroupSettingsResponse {
  ...
  final pulumi.Input<List<ManagedResourceGroupAssignedIdentitiesResponse>>?
  assignedIdentities;
  ...
  ManagedResourceGroupSettingsResponse({this.assignedIdentities});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'assignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagedResourceGroupAssignedIdentitiesResponse>,
  ...
  factory ManagedResourceGroupSettingsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ManagedResourceGroupSettingsResponse(
      assignedIdentities: (() {
        final guardedValue = map['assignedIdentities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<ManagedResourceGroupAssignedIdentitiesResponse>(
            guardedValue,
            (value) => ManagedResourceGroupAssignedIdentitiesResponse.fromMap(
