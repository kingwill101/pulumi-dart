...
///     {
///         Name = "string",
///         Properties = new AzureNative.MachineLearningServices.Inputs.MLTableDataArgs
///         {
///             DataType = "mltable",
///             DataUri = "string",
///             Description = "string",
...
/// 			Properties: &machinelearningservices.MLTableDataArgs{
...
/// }
///
/// resource "azure-native_machinelearningservices_registrydataversion" "registryDataVersion" {
///   name = "string"
///   properties = {
///     "dataType"    = "mltable"
///     "dataUri"     = "string"
...
///             .name("string")
///             .properties(MLTableDataArgs.builder()
///                 .dataType("mltable")
///                 .dataUri("string")
///                 .description("string")
///                 .isAnonymous(false)
