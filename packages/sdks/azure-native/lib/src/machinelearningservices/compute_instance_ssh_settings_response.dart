...
class ComputeInstanceSshSettingsResponse {
  ...
  ComputeInstanceSshSettingsResponse({
    ...
    pulumi.Input<String?>? sshPublicAccess,
  }) : sshPublicAccess = sshPublicAccess ?? pulumi.Input.fromValue('Disabled');
  ...
  factory ComputeInstanceSshSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ComputeInstanceSshSettingsResponse(
      ...
      sshPort: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['sshPort'])),
