...
/// ```
class ComponentVersionMachinelearningservices extends pulumi.CustomResource {
  ...
  /// Creates a new [ComponentVersionMachinelearningservices].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ComponentVersionMachinelearningservices]. {@macro pulumi_machinelearningservices_component_version_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ComponentVersionMachinelearningservices(
    String name, {
    ...
    componentVersionProperties = registerOutput<ComponentVersionResponse>(
      'componentVersionProperties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ComponentVersionResponse.fromMap(
