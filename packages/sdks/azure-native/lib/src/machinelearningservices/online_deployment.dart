...
class OnlineDeployment extends pulumi.CustomResource {
  ...
  late final pulumi.Output<KubernetesOnlineDeploymentResponse>
  ...
  OnlineDeployment(
    ...
    onlineDeploymentProperties =
        registerOutput<KubernetesOnlineDeploymentResponse>(
          'onlineDeploymentProperties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return KubernetesOnlineDeploymentResponse.fromMap(
              (guardedValue as Map).cast<String, dynamic>(),
            );
          },
        );
