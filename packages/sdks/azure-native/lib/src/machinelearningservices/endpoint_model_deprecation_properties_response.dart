...
class EndpointModelDeprecationPropertiesResponse {
  ...
  EndpointModelDeprecationPropertiesResponse({this.fineTune, this.inference});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'fineTune': ?fineTune, 'inference': ?inference};
  }

  factory EndpointModelDeprecationPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return EndpointModelDeprecationPropertiesResponse(
      fineTune: (() {
        final guardedValue = map['fineTune'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inference: (() {
        final guardedValue = map['inference'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
