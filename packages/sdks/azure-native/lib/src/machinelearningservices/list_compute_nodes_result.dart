...
class ListComputeNodesResult {
  ...
  ListComputeNodesResult({required this.nextLink, required this.nodes});
  ...
  factory ListComputeNodesResult.fromMap(Map<String, dynamic> map) {
    return ListComputeNodesResult(
      ...
      nodes: pulumi.Input.decodeList<AmlComputeNodeInformationResponse>(
        map['nodes']!,
        (value) => AmlComputeNodeInformationResponse.fromMap(
