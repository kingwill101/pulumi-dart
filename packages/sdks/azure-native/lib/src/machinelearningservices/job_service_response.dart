...
class JobServiceResponse {
  ...
  factory JobServiceResponse.fromMap(Map<String, dynamic> map) {
    return JobServiceResponse(
      ...
      nodes: (() { final guardedValue = map['nodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllNodesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
