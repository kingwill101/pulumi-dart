...
class GetFeaturestoreEntityVersionResult {
  ...
  final FeaturestoreEntityVersionPropertiesResponse? properties;
  ...
  const GetFeaturestoreEntityVersionResult({
  ...
  factory GetFeaturestoreEntityVersionResult.fromMap(Map<String, dynamic> map) {
    return GetFeaturestoreEntityVersionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return FeaturestoreEntityVersionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
