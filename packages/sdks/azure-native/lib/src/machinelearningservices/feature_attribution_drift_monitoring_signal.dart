...
class FeatureAttributionDriftMonitoringSignal {
    ...
    return <String, dynamic>{
      ...
      'productionData':
          ...
          >(
            productionData,
            (value) =>
                pulumi.Input.encodeList<FixedInputData, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory FeatureAttributionDriftMonitoringSignal.fromMap(
    ...
    return FeatureAttributionDriftMonitoringSignal(
      ...
      metricThreshold: pulumi.Input.fromValue(
        FeatureAttributionMetricThreshold.fromMap(
      ...
      productionData: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FixedInputData>(
          map['productionData']!,
          (value) =>
              FixedInputData.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      properties: (() {
