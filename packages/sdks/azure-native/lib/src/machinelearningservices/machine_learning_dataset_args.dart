...
class MachineLearningDatasetArgs {
  ...
  factory MachineLearningDatasetArgs.fromMap(Map<String, dynamic> map) {
    return MachineLearningDatasetArgs(
      ...
      timeSeries: (() { final guardedValue = map['timeSeries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasetCreateRequestTimeSeries.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
