...
class ImageClassificationMultilabelResponse {
    ...
    return <String, dynamic>{
      ...
      'trainingData':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(trainingData, (value) => value.toMap()),
      'validationData':
          ?pulumi.Input.mapOptionalInputValue<
            MLTableJobInputResponse,
            Map<String, dynamic>
  ...
  factory ImageClassificationMultilabelResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ImageClassificationMultilabelResponse(
      limitSettings: pulumi.Input.fromValue(
        ImageLimitSettingsResponse.fromMap(
      ...
      modelSettings: (() {
        ...
        return pulumi.Input.fromValue(
          ImageModelSettingsClassificationResponse.fromMap(
      ...
      searchSpace: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ImageModelDistributionSettingsClassificationResponse.fromMap(
      ...
      sweepSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageSweepSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      trainingData: pulumi.Input.fromValue(
        MLTableJobInputResponse.fromMap(
