...
class Forecasting {
  ...
  factory Forecasting.fromMap(Map<String, dynamic> map) {
    return Forecasting(
      ...
      forecastingSettings: (() { final guardedValue = map['forecastingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForecastingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      trainingSettings: (() { final guardedValue = map['trainingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForecastingTrainingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
