...
class ImageModelSettingsObjectDetectionResponse {
  ...
  /// Creates a new [ImageModelSettingsObjectDetectionResponse].
  ...
  ImageModelSettingsObjectDetectionResponse({
    ...
    pulumi.Input<String?>? validationMetricType,
  ...
  factory ImageModelSettingsObjectDetectionResponse.fromMap(Map<String, dynamic> map) {
    return ImageModelSettingsObjectDetectionResponse(
