...
class HDInsightResponse {
  ...
  final HDInsightPropertiesResponse? properties;
  ...
  factory HDInsightResponse.fromMap(Map<String, dynamic> map) {
    return HDInsightResponse(
      ...
      properties: map['properties'] == null ? null : HDInsightPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
