...
class InferenceContainerPropertiesRegistryEnvironmentVersionResponse {
  ...
  /// Creates a new [InferenceContainerPropertiesRegistryEnvironmentVersionResponse].
  ...
  const InferenceContainerPropertiesRegistryEnvironmentVersionResponse({
    this.livenessRoute,
    this.readinessRoute,
    this.scoringRoute,
    this.startupRoute,
  ...
  factory InferenceContainerPropertiesRegistryEnvironmentVersionResponse.fromMap(Map<String, dynamic> map) {
    return InferenceContainerPropertiesRegistryEnvironmentVersionResponse(
