...
class GetOnlineEndpointResult {
  ...
  factory GetOnlineEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetOnlineEndpointResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return OnlineEndpointPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
