...
class ComputeInstanceSshSettings {
  ...
  final pulumi.Input<dynamic>? sshPublicAccess;
  ...
  ComputeInstanceSshSettings({
    this.adminPublicKey,
    pulumi.Input<dynamic>? sshPublicAccess,
  ...
  factory ComputeInstanceSshSettings.fromMap(Map<String, dynamic> map) {
    return ComputeInstanceSshSettings(
      ...
      sshPublicAccess: (() { final guardedValue = map['sshPublicAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
