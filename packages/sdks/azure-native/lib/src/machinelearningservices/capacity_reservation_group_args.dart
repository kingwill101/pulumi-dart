...
class CapacityReservationGroupArgs {
  ...
  final pulumi.Input<CapacityReservationGroupMachinelearningservices>
  ...
  factory CapacityReservationGroupArgs.fromMap(Map<String, dynamic> map) {
    return CapacityReservationGroupArgs(
      capacityReservationGroupProperties: pulumi.Input.fromValue(
        map['capacityReservationGroupProperties']
            as CapacityReservationGroupMachinelearningservices,
      ),
      groupId: (() {
