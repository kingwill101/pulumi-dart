    ...
    return VolumeDefinition(
      bind: (() {
        ...
        return pulumi.Input.fromValue(
          BindOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      consistency: (() {
      ...
      tmpfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TmpfsOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      type: (() {
      ...
      volume: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeOptions.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
