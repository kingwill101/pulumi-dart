...
class Schedule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action':
          pulumi.Input.mapInputValue<CreateMonitorAction, Map<String, dynamic>>(
            action,
            (value) => value.toMap(),
          ),
      ...
      'tags': ?tags,
      'trigger': pulumi.Input.mapInputValue<CronTrigger, Map<String, dynamic>>(
        trigger,
        (value) => value.toMap(),
      ),
    };
  ...
  factory Schedule.fromMap(Map<String, dynamic> map) {
    return Schedule(
      ...
      trigger: pulumi.Input.fromValue(
        CronTrigger.fromMap((map['trigger']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
