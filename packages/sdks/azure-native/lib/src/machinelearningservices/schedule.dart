...
///     {
///         Name = "string",
///         Properties = new AzureNative.MachineLearningServices.Inputs.SchedulePropertiesArgs
///         {
...
/// 			Properties: &machinelearningservices.SchedulePropertiesArgs{
...
/// }
///
/// resource "azure-native_machinelearningservices_schedule" "schedule" {
///   name = "string"
///   properties = {
///     action = {
///       "actionType" = "InvokeBatchEndpoint"
...
/// import com.pulumi.azurenative.machinelearningservices.inputs.SchedulePropertiesArgs;
...
///             .name("string")
///             .properties(SchedulePropertiesArgs.builder()
...
class Schedule extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SchedulePropertiesResponse> properties;
  ...
  /// [args] Arguments used to configure this [Schedule]. {@macro pulumi_machinelearningservices_schedule_args_doc}
  ...
  Schedule(
    ...
    properties = registerOutput<SchedulePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SchedulePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
