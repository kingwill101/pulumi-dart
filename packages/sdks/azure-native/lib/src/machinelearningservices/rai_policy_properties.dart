...
class RaiPolicyProperties {
  ...
  factory RaiPolicyProperties.fromMap(Map<String, dynamic> map) {
    return RaiPolicyProperties(
      ...
      completionBlocklists: (() {
        final guardedValue = map['completionBlocklists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RaiBlocklistConfig>(
            guardedValue,
            (value) => RaiBlocklistConfig.fromMap(
      ...
      contentFilters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RaiPolicyContentFilter>(
            guardedValue,
            (value) => RaiPolicyContentFilter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      promptBlocklists: (() {
        final guardedValue = map['promptBlocklists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RaiBlocklistConfig>(
            guardedValue,
