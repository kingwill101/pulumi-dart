...
class AKS {
  ...
  factory AKS.fromMap(Map<String, dynamic> map) {
    return AKS(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AKSSchemaProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
