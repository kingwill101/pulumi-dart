...
class GetRegistryComponentVersionResult {
  ...
  final ComponentVersionPropertiesResponse? properties;
  ...
  factory GetRegistryComponentVersionResult.fromMap(Map<String, dynamic> map) {
    return GetRegistryComponentVersionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ComponentVersionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
