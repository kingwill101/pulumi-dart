...
class DataDriftMonitoringSignalResponse {
  ...
  factory DataDriftMonitoringSignalResponse.fromMap(Map<String, dynamic> map) {
    return DataDriftMonitoringSignalResponse(
      ...
      metricThresholds: pulumi.Input.fromValue(pulumi.Input.decodeList<CategoricalDataDriftMetricThresholdResponse>(map['metricThresholds']!, (value) => CategoricalDataDriftMetricThresholdResponse.fromMap((value as Map).cast<String, dynamic>()))),
