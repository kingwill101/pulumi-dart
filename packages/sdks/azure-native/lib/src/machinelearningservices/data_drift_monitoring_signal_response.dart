...
class DataDriftMonitoringSignalResponse {
  ...
  final pulumi.Input<List<CategoricalDataDriftMetricThresholdResponse>>
  metricThresholds;
    ...
    return <String, dynamic>{
      ...
      'metricThresholds':
          pulumi.Input.mapInputValue<
            List<CategoricalDataDriftMetricThresholdResponse>,
  ...
  factory DataDriftMonitoringSignalResponse.fromMap(Map<String, dynamic> map) {
    return DataDriftMonitoringSignalResponse(
      ...
      metricThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CategoricalDataDriftMetricThresholdResponse>(
          map['metricThresholds']!,
          (value) => CategoricalDataDriftMetricThresholdResponse.fromMap(
