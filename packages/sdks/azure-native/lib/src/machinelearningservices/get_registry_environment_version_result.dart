...
class GetRegistryEnvironmentVersionResult {
  ...
  final EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse? properties;
  ...
  const GetRegistryEnvironmentVersionResult({
  ...
  factory GetRegistryEnvironmentVersionResult.fromMap(Map<String, dynamic> map) {
    return GetRegistryEnvironmentVersionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return EnvironmentVersionPropertiesRegistryEnvironmentVersionResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
