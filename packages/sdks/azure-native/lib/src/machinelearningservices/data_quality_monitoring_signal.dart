...
class DataQualityMonitoringSignal {
  ...
  final pulumi.Input<List<CategoricalDataQualityMetricThreshold>>
  metricThresholds;
    ...
    return <String, dynamic>{
      ...
      'metricThresholds':
          pulumi.Input.mapInputValue<
            List<CategoricalDataQualityMetricThreshold>,
  ...
  factory DataQualityMonitoringSignal.fromMap(Map<String, dynamic> map) {
    return DataQualityMonitoringSignal(
      ...
      metricThresholds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CategoricalDataQualityMetricThreshold>(
          map['metricThresholds']!,
          (value) => CategoricalDataQualityMetricThreshold.fromMap(
