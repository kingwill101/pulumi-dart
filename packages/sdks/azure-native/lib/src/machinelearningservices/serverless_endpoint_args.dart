...
class ServerlessEndpointArgs {
  ...
  final pulumi.Input<ServerlessEndpointMachinelearningservices>
  ...
  factory ServerlessEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ServerlessEndpointArgs(
      ...
      serverlessEndpointProperties: pulumi.Input.fromValue(
        map['serverlessEndpointProperties']
            as ServerlessEndpointMachinelearningservices,
      ),
      sku: (() {
