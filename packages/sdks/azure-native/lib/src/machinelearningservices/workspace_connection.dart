...
class WorkspaceConnection extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AADAuthTypeWorkspaceConnectionPropertiesResponse>
  properties;
  ...
  WorkspaceConnection(
    ...
    properties =
        registerOutput<AADAuthTypeWorkspaceConnectionPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return AADAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(
