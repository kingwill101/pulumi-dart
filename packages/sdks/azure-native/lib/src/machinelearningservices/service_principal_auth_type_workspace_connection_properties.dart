...
import 'workspace_connection_service_principal.dart';
...
class ServicePrincipalAuthTypeWorkspaceConnectionProperties {
  ...
  final pulumi.Input<WorkspaceConnectionServicePrincipal>? credentials;
  ...
  /// Creates a new [ServicePrincipalAuthTypeWorkspaceConnectionProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authType': authType,
      'category': ?category,
      'credentials': ?pulumi.Input.mapOptionalInputValue<WorkspaceConnectionServicePrincipal, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory ServicePrincipalAuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return ServicePrincipalAuthTypeWorkspaceConnectionProperties(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkspaceConnectionServicePrincipal.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
