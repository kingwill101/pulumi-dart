...
class ForecastingTrainingSettingsResponse {
  ...
  /// Creates a new [ForecastingTrainingSettingsResponse].
  ...
  factory ForecastingTrainingSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ForecastingTrainingSettingsResponse(
      ...
      stackEnsembleSettings: (() { final guardedValue = map['stackEnsembleSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StackEnsembleSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
