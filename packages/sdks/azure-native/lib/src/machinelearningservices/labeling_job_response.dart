...
class LabelingJobResponse {
  ...
  final pulumi.Input<LabelingJobImagePropertiesResponse>?
  labelingJobMediaProperties;

  /// Configuration of MLAssist feature in the job.
  final pulumi.Input<MLAssistConfigurationDisabledResponse>?
  ...
  final pulumi.Input<Map<String, SecretConfigurationResponse>>?
    ...
    return <String, dynamic>{
      ...
      'dataConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataConfiguration, (value) => value.toMap()),
      ...
      'jobInstructions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(jobInstructions, (value) => value.toMap()),
      'jobType': jobType,
      'labelCategories':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, LabelCategoryResponse>,
      ...
      'labelingJobMediaProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(labelingJobMediaProperties, (value) => value.toMap()),
      'mlAssistConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            MLAssistConfigurationDisabledResponse,
            Map<String, dynamic>
          >(mlAssistConfiguration, (value) => value.toMap()),
      'notificationSetting':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'progressMetrics':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(progressMetrics, (value) => value.toMap()),
      'projectId': projectId,
      'properties': ?properties,
      'provisioningState': provisioningState,
      'secretsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, SecretConfigurationResponse>,
            Map<String, Map<String, dynamic>>
          >(
            secretsConfiguration,
            (value) =>
  ...
  factory LabelingJobResponse.fromMap(Map<String, dynamic> map) {
    return LabelingJobResponse(
      ...
      dataConfiguration: (() {
        final guardedValue = map['dataConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingDataConfigurationResponse.fromMap(
      ...
      jobInstructions: (() {
        final guardedValue = map['jobInstructions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingJobInstructionsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      labelCategories: (() {
        final guardedValue = map['labelCategories'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<LabelCategoryResponse>(
            guardedValue,
            (value) => LabelCategoryResponse.fromMap(
      ...
      labelingJobMediaProperties: (() {
        final guardedValue = map['labelingJobMediaProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingJobImagePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mlAssistConfiguration: (() {
        final guardedValue = map['mlAssistConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MLAssistConfigurationDisabledResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      progressMetrics: pulumi.Input.fromValue(
        ProgressMetricsResponse.fromMap(
          (map['progressMetrics']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      secretsConfiguration: (() {
        final guardedValue = map['secretsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SecretConfigurationResponse>(
            guardedValue,
            (value) => SecretConfigurationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      statusMessages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StatusMessageResponse>(
          map['statusMessages']!,
          (value) => StatusMessageResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
