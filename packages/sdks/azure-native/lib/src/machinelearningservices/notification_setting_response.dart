...
class NotificationSettingResponse {
  ...
  NotificationSettingResponse({this.emailOn, this.emails, this.webhooks});
    ...
    return <String, dynamic>{
      ...
      'webhooks':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, AzureDevOpsWebhookResponse>,
    ...
    return NotificationSettingResponse(
      ...
      webhooks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<AzureDevOpsWebhookResponse>(
            guardedValue,
            (value) => AzureDevOpsWebhookResponse.fromMap(
