...
/// }
///
/// resource "azure-native_machinelearningservices_endpointdeployment" "endpointDeployment" {
...
class EndpointDeployment extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [EndpointDeployment] resource.
  EndpointDeployment.reference(String urn)
    : super(
        'azure-native:machinelearningservices:EndpointDeployment',
