...
class SynapseSpark {
  ...
  factory SynapseSpark.fromMap(Map<String, dynamic> map) {
    return SynapseSpark(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SynapseSparkProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
