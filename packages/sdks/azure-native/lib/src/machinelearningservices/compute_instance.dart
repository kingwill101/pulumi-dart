...
class ComputeInstance {
  ...
  factory ComputeInstance.fromMap(Map<String, dynamic> map) {
    return ComputeInstance(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeInstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
