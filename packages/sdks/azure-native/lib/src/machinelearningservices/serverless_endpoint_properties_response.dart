...
class ServerlessEndpointPropertiesResponse {
  ...
  /// Creates a new [ServerlessEndpointPropertiesResponse].
  ...
  /// [provisioningState] State of endpoint provisioning.
  const ServerlessEndpointPropertiesResponse({
  ...
  factory ServerlessEndpointPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ServerlessEndpointPropertiesResponse(
