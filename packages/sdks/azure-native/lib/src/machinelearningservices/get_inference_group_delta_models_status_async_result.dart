...
class GetInferenceGroupDeltaModelsStatusAsyncResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deltaModels': ?(() {
        final guardedValue = deltaModels;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeMapValues<
          List<DeltaModelCurrentStateResponse>,
  ...
  factory GetInferenceGroupDeltaModelsStatusAsyncResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetInferenceGroupDeltaModelsStatusAsyncResult(
      actualInstanceCount: (() {
        final guardedValue = map['actualInstanceCount'];
        if (guardedValue == null) return null;
      ...
      deltaModels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeMapValues<List<DeltaModelCurrentStateResponse>>(
          guardedValue,
          (value) => pulumi.Input.decodeList<DeltaModelCurrentStateResponse>(
            value,
            (value) => DeltaModelCurrentStateResponse.fromMap(
      ...
      expectedInstanceCount: (() {
        final guardedValue = map['expectedInstanceCount'];
        if (guardedValue == null) return null;
        return guardedValue as int;
      })(),
      revisionId: (() {
