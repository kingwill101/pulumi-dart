...
class BatchEndpointArgs {
  ...
  final pulumi.Input<BatchEndpointMachinelearningservices>
  ...
  factory BatchEndpointArgs.fromMap(Map<String, dynamic> map) {
    return BatchEndpointArgs(
      batchEndpointProperties: pulumi.Input.fromValue(
        map['batchEndpointProperties'] as BatchEndpointMachinelearningservices,
      ),
      endpointName: (() {
