...
class BatchEndpointArgs {
  ...
  BatchEndpointArgs({
    required pulumi.Output<BatchEndpointMachinelearningservices> batchEndpointProperties,
    ...
    required pulumi.Output<String> workspaceName,
      ...
      batchEndpointProperties = pulumi.Input.asInput<BatchEndpointMachinelearningservices>(batchEndpointProperties),
  ...
  factory BatchEndpointArgs.fromMap(Map<String, dynamic> map) {
    return BatchEndpointArgs(
      batchEndpointProperties: pulumi.Output.create<BatchEndpointMachinelearningservices>(map['batchEndpointProperties'] as BatchEndpointMachinelearningservices),
