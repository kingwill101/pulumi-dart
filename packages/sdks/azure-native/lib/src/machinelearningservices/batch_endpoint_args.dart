...
import 'batch_endpoint_properties.dart';
...
class BatchEndpointArgs {
  ...
  final pulumi.Input<BatchEndpointProperties> properties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kind': ?kind,
      'location': ?location,
      'properties': pulumi.Input.mapInputValue<BatchEndpointProperties, Map<String, dynamic>>(properties, (value) => value.toMap()),
  ...
  factory BatchEndpointArgs.fromMap(Map<String, dynamic> map) {
    return BatchEndpointArgs(
      ...
      properties: pulumi.Input.fromValue(BatchEndpointProperties.fromMap((map['properties']! as Map).cast<String, dynamic>())),
