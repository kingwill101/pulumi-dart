...
/// }
///
/// resource "azure-native_machinelearningservices_linkedworkspace" "linkedWorkspace" {
///   link_name = "link-1"
///   name      = "link-1"
///   properties = {
...
class LinkedWorkspace extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [LinkedWorkspace] resource.
  LinkedWorkspace.reference(String urn)
    : super(
        'azure-native:machinelearningservices:LinkedWorkspace',
