...
class RegistryPrivateEndpointConnectionProperties {
  ...
  final pulumi.Input<RegistryPrivateLinkServiceConnectionState>?
  ...
  factory RegistryPrivateEndpointConnectionProperties.fromMap(
    ...
    return RegistryPrivateEndpointConnectionProperties(
      ...
      privateEndpoint: (() {
        ...
        return pulumi.Input.fromValue(
          PrivateEndpointResource.fromMap(
      ...
      registryPrivateLinkServiceConnectionState: (() {
        final guardedValue = map['registryPrivateLinkServiceConnectionState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegistryPrivateLinkServiceConnectionState.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
