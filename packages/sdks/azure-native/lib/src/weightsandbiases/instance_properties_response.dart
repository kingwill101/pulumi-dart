...
class InstancePropertiesResponse {
  ...
  factory InstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return InstancePropertiesResponse(
      marketplace: pulumi.Input.fromValue(LiftrBaseMarketplaceDetailsResponse.fromMap((map['marketplace']! as Map).cast<String, dynamic>())),
      ...
      singleSignOnProperties: (() { final guardedValue = map['singleSignOnProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LiftrBaseSingleSignOnPropertiesV2Response.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      user: pulumi.Input.fromValue(LiftrBaseUserDetailsResponse.fromMap((map['user']! as Map).cast<String, dynamic>())),
    );
  }
}
