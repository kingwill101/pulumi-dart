...
class Recurrence {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schedule': pulumi.Input.mapInputValue<RecurrentSchedule, Map<String, dynamic>>(schedule, (value) => value.toMap()),
    };
  }
  ...
  factory Recurrence.fromMap(Map<String, dynamic> map) {
    return Recurrence(
      ...
      schedule: pulumi.Input.fromValue(RecurrentSchedule.fromMap((map['schedule']! as Map).cast<String, dynamic>())),
    );
  }
}
