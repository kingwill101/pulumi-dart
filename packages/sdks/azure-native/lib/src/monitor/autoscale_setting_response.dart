...
class AutoscaleSettingResponse {
  ...
  final pulumi.Input<PredictiveAutoscalePolicyResponse>?
    ...
    return <String, dynamic>{
      ...
      'notifications':
          ?pulumi.Input.mapOptionalInputValue<
            List<AutoscaleNotificationResponse>,
      ...
      'predictiveAutoscalePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(predictiveAutoscalePolicy, (value) => value.toMap()),
      'profiles':
          pulumi.Input.mapInputValue<
            List<AutoscaleProfileResponse>,
            List<Map<String, dynamic>>
          >(
            profiles,
            (value) =>
    ...
    return AutoscaleSettingResponse(
      ...
      notifications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutoscaleNotificationResponse>(
            guardedValue,
            (value) => AutoscaleNotificationResponse.fromMap(
      ...
      predictiveAutoscalePolicy: (() {
        final guardedValue = map['predictiveAutoscalePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PredictiveAutoscalePolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      profiles: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AutoscaleProfileResponse>(
          map['profiles']!,
          (value) => AutoscaleProfileResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      targetResourceUri: (() {
        final guardedValue = map['targetResourceUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
