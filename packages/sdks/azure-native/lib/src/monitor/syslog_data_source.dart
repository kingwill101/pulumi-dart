...
class SyslogDataSource {
  ...
  final pulumi.Input<List<dynamic>?>? facilityNames;
  /// The log levels to collect.
  final pulumi.Input<List<dynamic>?>? logLevels;
  ...
  factory SyslogDataSource.fromMap(Map<String, dynamic> map) {
    return SyslogDataSource(
      facilityNames: (() { final guardedValue = map['facilityNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      logLevels: (() { final guardedValue = map['logLevels']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
