...
class GetSliResult {
  ...
  factory GetSliResult.fromMap(Map<String, dynamic> map) {
    return GetSliResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return SliResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
