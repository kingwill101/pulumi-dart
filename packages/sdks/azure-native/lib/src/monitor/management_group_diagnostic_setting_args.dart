...
class ManagementGroupDiagnosticSettingArgs {
    ...
    return <String, dynamic>{
      ...
      'logs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ManagementGroupLogSettings>,
  ...
  factory ManagementGroupDiagnosticSettingArgs.fromMap(
    ...
    return ManagementGroupDiagnosticSettingArgs(
      ...
      logs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ManagementGroupLogSettings>(
            guardedValue,
            (value) => ManagementGroupLogSettings.fromMap(
