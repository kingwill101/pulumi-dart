...
import 'condition_sli_response.dart';
import 'spatial_aggregation_response.dart';
import 'temporal_aggregation_response.dart';

/// Represents a signal source used in SLIs.
class SignalSourceResponse {
  /// Filters applied to modify signal values.
  final pulumi.Input<List<ConditionSliResponse>> filters;
  /// Name of the metric.
  ...
  final pulumi.Input<SpatialAggregationResponse> spatialAggregation;
  /// Defines how measurements are aggregated over a specific time window within the same time series.
  final pulumi.Input<TemporalAggregationResponse> temporalAggregation;

  /// Creates a new [SignalSourceResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': pulumi.Input.mapInputValue<List<ConditionSliResponse>, List<Map<String, dynamic>>>(filters, (value) => pulumi.Input.encodeList<ConditionSliResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'spatialAggregation': pulumi.Input.mapInputValue<SpatialAggregationResponse, Map<String, dynamic>>(spatialAggregation, (value) => value.toMap()),
      'temporalAggregation': pulumi.Input.mapInputValue<TemporalAggregationResponse, Map<String, dynamic>>(temporalAggregation, (value) => value.toMap()),
    };
  }

  factory SignalSourceResponse.fromMap(Map<String, dynamic> map) {
    return SignalSourceResponse(
      filters: pulumi.Input.fromValue(pulumi.Input.decodeList<ConditionSliResponse>(map['filters']!, (value) => ConditionSliResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      spatialAggregation: pulumi.Input.fromValue(SpatialAggregationResponse.fromMap((map['spatialAggregation']! as Map).cast<String, dynamic>())),
      temporalAggregation: pulumi.Input.fromValue(TemporalAggregationResponse.fromMap((map['temporalAggregation']! as Map).cast<String, dynamic>())),
    );
  }
}
