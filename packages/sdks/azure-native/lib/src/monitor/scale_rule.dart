...
class ScaleRule {
  ...
  factory ScaleRule.fromMap(Map<String, dynamic> map) {
    return ScaleRule(
      metricTrigger: (MetricTrigger.fromMap((map['metricTrigger'] as Map).cast<String, dynamic>())).input(),
      scaleAction: (ScaleAction.fromMap((map['scaleAction'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
