...
class DataCollectionEndpointResponseFailoverConfiguration {
  ...
  factory DataCollectionEndpointResponseFailoverConfiguration.fromMap(Map<String, dynamic> map) {
    return DataCollectionEndpointResponseFailoverConfiguration(
      ...
      locations: (() { final guardedValue = map['locations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LocationSpecResponse>(guardedValue, (value) => LocationSpecResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
