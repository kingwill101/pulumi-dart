...
class ConditionResponse {
  ...
  factory ConditionResponse.fromMap(Map<String, dynamic> map) {
    return ConditionResponse(
      alertSensitivity: (() {
        final guardedValue = map['alertSensitivity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      criterionType: (() {
        final guardedValue = map['criterionType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dimensions: (() {
      ...
      failingPeriods: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConditionResponseFailingPeriods.fromMap(
      ...
      minRecurrenceCount: (() {
        final guardedValue = map['minRecurrenceCount'];
        if (guardedValue == null) return null;
      ...
      timeAggregation: (() {
        final guardedValue = map['timeAggregation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
