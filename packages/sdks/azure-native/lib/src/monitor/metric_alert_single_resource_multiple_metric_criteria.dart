...
class MetricAlertSingleResourceMultipleMetricCriteria {
    ...
    return <String, dynamic>{
      'allOf':
          ...
          >(
            allOf,
            (value) =>
                pulumi.Input.encodeList<MetricCriteria, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory MetricAlertSingleResourceMultipleMetricCriteria.fromMap(
    ...
    return MetricAlertSingleResourceMultipleMetricCriteria(
      allOf: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricCriteria>(
            guardedValue,
            (value) =>
                MetricCriteria.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
