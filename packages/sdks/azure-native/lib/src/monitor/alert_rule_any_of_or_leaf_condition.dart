...
class AlertRuleAnyOfOrLeafCondition {
  ...
  final List<AlertRuleLeafCondition>? anyOf;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'anyOf': ?anyOf == null ? null : pulumi.Input.encodeList<AlertRuleLeafCondition, Map<String, dynamic>>(anyOf!, (value) => value.toMap()),
  ...
  factory AlertRuleAnyOfOrLeafCondition.fromMap(Map<String, dynamic> map) {
    return AlertRuleAnyOfOrLeafCondition(
      anyOf: map['anyOf'] == null ? null : pulumi.Input.decodeList<AlertRuleLeafCondition>(map['anyOf'], (value) => AlertRuleLeafCondition.fromMap((value as Map).cast<String, dynamic>())),
