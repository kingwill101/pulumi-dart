...
class AlertRuleAnyOfOrLeafCondition {
  ...
  factory AlertRuleAnyOfOrLeafCondition.fromMap(Map<String, dynamic> map) {
    return AlertRuleAnyOfOrLeafCondition(
      anyOf: (() { final guardedValue = map['anyOf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertRuleLeafCondition>(guardedValue, (value) => AlertRuleLeafCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
