  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataFlows':
          ...
          >(
            dataFlows,
            (value) => pulumi.Input.encodeList<DataFlow, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory DataCollectionRuleArgs.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleArgs(
      ...
      dataCollectionRuleName: (() {
        final guardedValue = map['dataCollectionRuleName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataFlows: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataFlow>(
            guardedValue,
            (value) => DataFlow.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      dataSources: (() {
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataCollectionRuleResourceIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      streamDeclarations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<StreamDeclaration>(
            guardedValue,
            (value) => StreamDeclaration.fromMap(
