...
class AlertRuleAnyOfOrLeafConditionResponse {
  ...
  factory AlertRuleAnyOfOrLeafConditionResponse.fromMap(Map<String, dynamic> map) {
    return AlertRuleAnyOfOrLeafConditionResponse(
      anyOf: (() { final guardedValue = map['anyOf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertRuleLeafConditionResponse>(guardedValue, (value) => AlertRuleLeafConditionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
