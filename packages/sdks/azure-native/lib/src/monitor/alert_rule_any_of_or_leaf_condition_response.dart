...
import 'alert_rule_leaf_condition_response.dart';
...
class AlertRuleAnyOfOrLeafConditionResponse {
  ...
  final List<AlertRuleLeafConditionResponse>? anyOf;
  ...
  /// Creates a new [AlertRuleAnyOfOrLeafConditionResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'anyOf': ?anyOf == null ? null : pulumi.Input.encodeList<AlertRuleLeafConditionResponse, Map<String, dynamic>>(anyOf!, (value) => value.toMap()),
  ...
  factory AlertRuleAnyOfOrLeafConditionResponse.fromMap(Map<String, dynamic> map) {
    return AlertRuleAnyOfOrLeafConditionResponse(
      anyOf: map['anyOf'] == null ? null : pulumi.Input.decodeList<AlertRuleLeafConditionResponse>(map['anyOf'], (value) => AlertRuleLeafConditionResponse.fromMap((value as Map).cast<String, dynamic>())),
