...
class ScaleRuleResponse {
  ...
  factory ScaleRuleResponse.fromMap(Map<String, dynamic> map) {
    return ScaleRuleResponse(
      metricTrigger: (MetricTriggerResponse.fromMap((map['metricTrigger'] as Map).cast<String, dynamic>())).input(),
      scaleAction: (ScaleActionResponse.fromMap((map['scaleAction'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
