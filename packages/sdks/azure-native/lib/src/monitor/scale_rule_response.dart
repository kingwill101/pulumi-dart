...
class ScaleRuleResponse {
  ...
  ScaleRuleResponse({required this.metricTrigger, required this.scaleAction});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scaleAction':
          pulumi.Input.mapInputValue<ScaleActionResponse, Map<String, dynamic>>(
            scaleAction,
            (value) => value.toMap(),
          ),
    };
