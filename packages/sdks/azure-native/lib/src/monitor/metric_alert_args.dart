...
class MetricAlertArgs {
  ...
  MetricAlertArgs({
    ...
    required pulumi.Output<MetricAlertMultipleResourceMultipleMetricCriteria> criteria,
    ...
    pulumi.Output<String>? targetResourceRegion,
    pulumi.Output<String>? targetResourceType,
    required pulumi.Output<String> windowSize,
  }) :
      ...
      criteria = pulumi.Input.asInput<MetricAlertMultipleResourceMultipleMetricCriteria>(criteria),
      ...
      targetResourceRegion = pulumi.Input.asOptionalInput<String>(targetResourceRegion),
      targetResourceType = pulumi.Input.asOptionalInput<String>(targetResourceType),
      windowSize = pulumi.Input.asInput<String>(windowSize);
  ...
  factory MetricAlertArgs.fromMap(Map<String, dynamic> map) {
    return MetricAlertArgs(
      ...
      criteria: pulumi.Output.create<MetricAlertMultipleResourceMultipleMetricCriteria>(MetricAlertMultipleResourceMultipleMetricCriteria.fromMap((map['criteria'] as Map).cast<String, dynamic>())),
      ...
      targetResourceRegion: map['targetResourceRegion'] == null ? null : pulumi.Output.create<String>(map['targetResourceRegion'] as String),
      targetResourceType: map['targetResourceType'] == null ? null : pulumi.Output.create<String>(map['targetResourceType'] as String),
      windowSize: pulumi.Output.create<String>(map['windowSize'] as String),
    );
  }
}
