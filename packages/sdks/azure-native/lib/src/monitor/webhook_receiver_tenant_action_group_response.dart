...
/// A webhook receiver.
class WebhookReceiverTenantActionGroupResponse {
  ...
  /// Creates a new [WebhookReceiverTenantActionGroupResponse].
  ...
  const WebhookReceiverTenantActionGroupResponse({
    this.identifierUri,
    required this.name,
    this.objectId,
  ...
  factory WebhookReceiverTenantActionGroupResponse.fromMap(Map<String, dynamic> map) {
    return WebhookReceiverTenantActionGroupResponse(
