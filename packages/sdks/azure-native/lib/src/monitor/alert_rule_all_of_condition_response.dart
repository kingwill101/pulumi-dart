...
class AlertRuleAllOfConditionResponse {
  ...
  final List<AlertRuleAnyOfOrLeafConditionResponse> allOf;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'allOf': pulumi.Input.encodeList<AlertRuleAnyOfOrLeafConditionResponse, Map<String, dynamic>>(allOf, (value) => value.toMap()),
    };
  }

  factory AlertRuleAllOfConditionResponse.fromMap(Map<String, dynamic> map) {
    return AlertRuleAllOfConditionResponse(
      allOf: pulumi.Input.decodeList<AlertRuleAnyOfOrLeafConditionResponse>(map['allOf'], (value) => AlertRuleAnyOfOrLeafConditionResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
