...
class PipelineGroupProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exporters':
          pulumi
              .Input.mapInputValue<List<Exporter>, List<Map<String, dynamic>>>(
            exporters,
            (value) => pulumi.Input.encodeList<Exporter, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'processors':
          pulumi
              .Input.mapInputValue<List<Processor>, List<Map<String, dynamic>>>(
            processors,
            (value) => pulumi.Input.encodeList<Processor, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'receivers':
          pulumi
              .Input.mapInputValue<List<Receiver>, List<Map<String, dynamic>>>(
            receivers,
            (value) => pulumi.Input.encodeList<Receiver, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'replicas': ?replicas,
      'service': pulumi.Input.mapInputValue<Service, Map<String, dynamic>>(
        service,
        (value) => value.toMap(),
      ),
    };
  ...
  factory PipelineGroupProperties.fromMap(Map<String, dynamic> map) {
    return PipelineGroupProperties(
      exporters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<Exporter>(
          map['exporters']!,
          (value) => Exporter.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      networkingConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkingConfiguration>(
            guardedValue,
            (value) => NetworkingConfiguration.fromMap(
      ...
      processors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<Processor>(
          map['processors']!,
          (value) => Processor.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      receivers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<Receiver>(
          map['receivers']!,
          (value) => Receiver.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      replicas: (() {
      ...
      service: pulumi.Input.fromValue(
        Service.fromMap((map['service']! as Map).cast<String, dynamic>()),
      ),
    );
  }
}
