...
class GetDataCollectionEndpointResult {
  ...
  final DataCollectionEndpointResponseFailoverConfiguration
  ...
  factory GetDataCollectionEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetDataCollectionEndpointResult(
      ...
      configurationAccess: (() {
        final guardedValue = map['configurationAccess'];
      ...
      failoverConfiguration:
          DataCollectionEndpointResponseFailoverConfiguration.fromMap(
            (map['failoverConfiguration']! as Map).cast<String, dynamic>(),
          ),
      id: map['id'] as String,
      identity: (() {
      ...
      logsIngestion: (() {
        final guardedValue = map['logsIngestion'];
        if (guardedValue == null) return null;
        return DataCollectionEndpointResponseLogsIngestion.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      })(),
      metadata: DataCollectionEndpointResponseMetadata.fromMap(
        (map['metadata']! as Map).cast<String, dynamic>(),
      ),
      metricsIngestion: (() {
        final guardedValue = map['metricsIngestion'];
        if (guardedValue == null) return null;
      ...
      systemData: DataCollectionEndpointResourceResponseSystemData.fromMap(
