...
class GetManagementGroupDiagnosticSettingResult {
  ...
  factory GetManagementGroupDiagnosticSettingResult.fromMap(
    ...
    return GetManagementGroupDiagnosticSettingResult(
      ...
      logs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ManagementGroupLogSettingsResponse>(
          guardedValue,
          (value) => ManagementGroupLogSettingsResponse.fromMap(
