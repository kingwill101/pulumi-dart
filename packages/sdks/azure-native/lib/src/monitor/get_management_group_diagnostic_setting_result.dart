...
class GetManagementGroupDiagnosticSettingResult {
  ...
  const GetManagementGroupDiagnosticSettingResult({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'logs': ?(() { final guardedValue = logs; if (guardedValue == null) return null; return pulumi.Input.encodeList<ManagementGroupLogSettingsResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetManagementGroupDiagnosticSettingResult.fromMap(Map<String, dynamic> map) {
    return GetManagementGroupDiagnosticSettingResult(
      ...
      id: map['id'] as String,
      logs: (() { final guardedValue = map['logs']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ManagementGroupLogSettingsResponse>(guardedValue, (value) => ManagementGroupLogSettingsResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
