...
class AccessModeSettings {
  ...
  final List<AccessModeSettingsExclusion>? exclusions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exclusions': ?exclusions == null ? null : pulumi.Input.encodeList<AccessModeSettingsExclusion, Map<String, dynamic>>(exclusions!, (value) => value.toMap()),
  ...
  factory AccessModeSettings.fromMap(Map<String, dynamic> map) {
    return AccessModeSettings(
      exclusions: map['exclusions'] == null ? null : pulumi.Input.decodeList<AccessModeSettingsExclusion>(map['exclusions'], (value) => AccessModeSettingsExclusion.fromMap((value as Map).cast<String, dynamic>())),
