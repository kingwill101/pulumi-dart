...
class Service {
  ...
  Service({this.persistence, required this.pipelines});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'pipelines':
          pulumi
              .Input.mapInputValue<List<Pipeline>, List<Map<String, dynamic>>>(
            pipelines,
            (value) => pulumi.Input.encodeList<Pipeline, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return Service(
      persistence: (() {
        ...
        return pulumi.Input.fromValue(
          PersistenceConfigurations.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pipelines: pulumi.Input.fromValue(
        pulumi.Input.decodeList<Pipeline>(
          map['pipelines']!,
          (value) => Pipeline.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
