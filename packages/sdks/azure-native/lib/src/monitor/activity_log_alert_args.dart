...
class ActivityLogAlertArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions': pulumi.Input.mapInputValue<ActionList, Map<String, dynamic>>(
        actions,
        (value) => value.toMap(),
      ),
  ...
  factory ActivityLogAlertArgs.fromMap(Map<String, dynamic> map) {
    return ActivityLogAlertArgs(
      actions: pulumi.Input.fromValue(
        ActionList.fromMap((map['actions']! as Map).cast<String, dynamic>()),
      ),
      activityLogAlertName: (() {
        final guardedValue = map['activityLogAlertName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      condition: pulumi.Input.fromValue(
        AlertRuleAllOfCondition.fromMap(
