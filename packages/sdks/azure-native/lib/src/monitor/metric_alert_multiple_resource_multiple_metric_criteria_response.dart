...
class MetricAlertMultipleResourceMultipleMetricCriteriaResponse {
    ...
    return <String, dynamic>{
      'allOf':
          ?pulumi.Input.mapOptionalInputValue<
            List<DynamicMetricCriteriaResponse>,
  ...
  factory MetricAlertMultipleResourceMultipleMetricCriteriaResponse.fromMap(
    ...
    return MetricAlertMultipleResourceMultipleMetricCriteriaResponse(
      allOf: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DynamicMetricCriteriaResponse>(
            guardedValue,
            (value) => DynamicMetricCriteriaResponse.fromMap(
