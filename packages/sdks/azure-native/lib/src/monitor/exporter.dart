...
class Exporter {
  ...
  final pulumi.Input<AzureMonitorWorkspaceLogsExporter>?
    ...
    return <String, dynamic>{
      'azureMonitorWorkspaceLogs':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(azureMonitorWorkspaceLogs, (value) => value.toMap()),
      'name': name,
      'tcp':
          ?pulumi.Input.mapOptionalInputValue<
            TcpExporter,
  ...
  factory Exporter.fromMap(Map<String, dynamic> map) {
    return Exporter(
      azureMonitorWorkspaceLogs: (() {
        final guardedValue = map['azureMonitorWorkspaceLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureMonitorWorkspaceLogsExporter.fromMap(
      ...
      tcp: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TcpExporter.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
