...
class DiscoveryRuleArgs {
  ...
  final pulumi.Input<ApplicationInsightsTopologyDiscoveryRuleProperties>?
  properties;
  ...
  factory DiscoveryRuleArgs.fromMap(Map<String, dynamic> map) {
    return DiscoveryRuleArgs(
      ...
      discoveryRuleName: (() {
        final guardedValue = map['discoveryRuleName'];
      ...
      properties: (() {
        ...
        return pulumi.Input.fromValue(
          ApplicationInsightsTopologyDiscoveryRuleProperties.fromMap(
