...
class AmwAccountResponse {
  ...
  /// Creates a new [AmwAccountResponse].
  ...
  factory AmwAccountResponse.fromMap(Map<String, dynamic> map) {
    return AmwAccountResponse(
