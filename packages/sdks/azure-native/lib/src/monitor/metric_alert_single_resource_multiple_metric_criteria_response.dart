...
class MetricAlertSingleResourceMultipleMetricCriteriaResponse {
  ...
  const MetricAlertSingleResourceMultipleMetricCriteriaResponse({
    this.allOf,
  ...
  factory MetricAlertSingleResourceMultipleMetricCriteriaResponse.fromMap(Map<String, dynamic> map) {
    return MetricAlertSingleResourceMultipleMetricCriteriaResponse(
      allOf: (() { final guardedValue = map['allOf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricCriteriaResponse>(guardedValue, (value) => MetricCriteriaResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
