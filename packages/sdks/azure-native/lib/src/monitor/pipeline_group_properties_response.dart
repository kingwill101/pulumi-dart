...
class PipelineGroupPropertiesResponse {
  ...
  factory PipelineGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return PipelineGroupPropertiesResponse(
      exporters: pulumi.Input.fromValue(pulumi.Input.decodeList<ExporterResponse>(map['exporters']!, (value) => ExporterResponse.fromMap((value as Map).cast<String, dynamic>()))),
      networkingConfigurations: (() { final guardedValue = map['networkingConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkingConfigurationResponse>(guardedValue, (value) => NetworkingConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processors: pulumi.Input.fromValue(pulumi.Input.decodeList<ProcessorResponse>(map['processors']!, (value) => ProcessorResponse.fromMap((value as Map).cast<String, dynamic>()))),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      receivers: pulumi.Input.fromValue(pulumi.Input.decodeList<ReceiverResponse>(map['receivers']!, (value) => ReceiverResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      service: pulumi.Input.fromValue(ServiceResponse.fromMap((map['service']! as Map).cast<String, dynamic>())),
    );
  }
}
