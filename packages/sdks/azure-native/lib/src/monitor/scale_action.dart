...
class ScaleAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cooldown': cooldown,
      'direction': pulumi.Input.mapInputValue<ScaleDirection, String>(direction, (value) => value.wireValue),
      'type': pulumi.Input.mapInputValue<ScaleType, String>(type, (value) => value.wireValue),
      'value': ?value,
    };
  }
  ...
  factory ScaleAction.fromMap(Map<String, dynamic> map) {
    return ScaleAction(
      ...
      direction: pulumi.Input.fromValue(ScaleDirection.fromValue(map['direction']! as String)),
