...
class ScheduledQueryRuleCriteriaResponse {
  ...
  factory ScheduledQueryRuleCriteriaResponse.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRuleCriteriaResponse(
      allOf: (() { final guardedValue = map['allOf']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConditionResponse>(guardedValue, (value) => ConditionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
