...
class DynamicMetricCriteriaResponse {
  ...
  factory DynamicMetricCriteriaResponse.fromMap(Map<String, dynamic> map) {
    return DynamicMetricCriteriaResponse(
      ...
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricDimensionResponse>(guardedValue, (value) => MetricDimensionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      failingPeriods: pulumi.Input.fromValue(DynamicThresholdFailingPeriodsResponse.fromMap((map['failingPeriods']! as Map).cast<String, dynamic>())),
