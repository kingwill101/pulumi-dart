    ...
    return DynamicMetricCriteriaResponse(
      ...
      dimensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricDimensionResponse>(
            guardedValue,
            (value) => MetricDimensionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      failingPeriods: pulumi.Input.fromValue(
        DynamicThresholdFailingPeriodsResponse.fromMap(
          (map['failingPeriods']! as Map).cast<String, dynamic>(),
        ),
      ),
      ignoreDataBefore: (() {
