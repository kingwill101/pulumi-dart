...
class Condition {
  ...
  final ConditionFailingPeriods? failingPeriods;
  ...
  factory Condition.fromMap(Map<String, dynamic> map) {
    return Condition(
      ...
      failingPeriods: map['failingPeriods'] == null ? null : ConditionFailingPeriods.fromMap((map['failingPeriods'] as Map).cast<String, dynamic>()),
