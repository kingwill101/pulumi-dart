...
class DataCollectionEndpointArgs {
  ...
  DataCollectionEndpointArgs({
    pulumi.Output<String>? dataCollectionEndpointName,
    pulumi.Output<String>? description,
    pulumi.Output<DataCollectionEndpointResourceIdentity>? identity,
    pulumi.Output<String>? immutableId,
    pulumi.Output<String>? kind,
    pulumi.Output<String>? location,
    pulumi.Output<DataCollectionEndpointNetworkAcls>? networkAcls,
  ...
  factory DataCollectionEndpointArgs.fromMap(Map<String, dynamic> map) {
    return DataCollectionEndpointArgs(
      dataCollectionEndpointName: map['dataCollectionEndpointName'] == null ? null : pulumi.Output.create<String>(map['dataCollectionEndpointName'] as String),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      identity: map['identity'] == null ? null : pulumi.Output.create<DataCollectionEndpointResourceIdentity>(DataCollectionEndpointResourceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      networkAcls: map['networkAcls'] == null ? null : pulumi.Output.create<DataCollectionEndpointNetworkAcls>(DataCollectionEndpointNetworkAcls.fromMap((map['networkAcls'] as Map).cast<String, dynamic>())),
