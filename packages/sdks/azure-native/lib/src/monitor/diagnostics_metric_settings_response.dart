...
class DiagnosticsMetricSettingsResponse {
  ...
  const DiagnosticsMetricSettingsResponse({
    this.category,
  ...
  factory DiagnosticsMetricSettingsResponse.fromMap(Map<String, dynamic> map) {
    return DiagnosticsMetricSettingsResponse(
