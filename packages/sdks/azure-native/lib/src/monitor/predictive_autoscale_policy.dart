...
class PredictiveAutoscalePolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scaleMode': pulumi.Input.mapInputValue<PredictiveAutoscalePolicyScaleMode, String>(scaleMode, (value) => value.wireValue),
    };
  }
  ...
  factory PredictiveAutoscalePolicy.fromMap(Map<String, dynamic> map) {
    return PredictiveAutoscalePolicy(
      ...
      scaleMode: pulumi.Input.fromValue(PredictiveAutoscalePolicyScaleMode.fromValue(map['scaleMode']! as String)),
    );
  }
}
