    ...
    return <String, dynamic>{
      ...
      'profiles':
          ...
          >(
            profiles,
            (value) =>
                pulumi.Input.encodeList<AutoscaleProfile, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AutoscaleSettingArgs.fromMap(Map<String, dynamic> map) {
    return AutoscaleSettingArgs(
      autoscaleSettingName: (() {
        final guardedValue = map['autoscaleSettingName'];
      ...
      notifications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AutoscaleNotification>(
            guardedValue,
            (value) => AutoscaleNotification.fromMap(
      ...
      predictiveAutoscalePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PredictiveAutoscalePolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      profiles: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AutoscaleProfile>(
          map['profiles']!,
          (value) =>
              AutoscaleProfile.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
