...
class GetDataCollectionRuleAssociationResult {
  ...
  final DataCollectionRuleAssociationProxyOnlyResourceResponseSystemData
  systemData;
  ...
  factory GetDataCollectionRuleAssociationResult.fromMap(
    ...
    return GetDataCollectionRuleAssociationResult(
      ...
      id: map['id'] as String,
      metadata: DataCollectionRuleAssociationResponseMetadata.fromMap(
        (map['metadata']! as Map).cast<String, dynamic>(),
      ),
      name: map['name'] as String,
      provisioningState: map['provisioningState'] as String,
      systemData:
          DataCollectionRuleAssociationProxyOnlyResourceResponseSystemData.fromMap(
