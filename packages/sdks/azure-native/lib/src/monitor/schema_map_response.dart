...
class SchemaMapResponse {
  ...
  SchemaMapResponse({required this.recordMap, this.resourceMap, this.scopeMap});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'recordMap':
          pulumi.Input.mapInputValue<
            List<RecordMapResponse>,
      ...
      'scopeMap':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScopeMapResponse>,
            List<Map<String, dynamic>>
          >(
            scopeMap,
            (value) =>
                pulumi.Input.encodeList<ScopeMapResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory SchemaMapResponse.fromMap(Map<String, dynamic> map) {
    return SchemaMapResponse(
      recordMap: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RecordMapResponse>(
          map['recordMap']!,
          (value) =>
              RecordMapResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      resourceMap: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceMapResponse>(
            guardedValue,
            (value) => ResourceMapResponse.fromMap(
      ...
      scopeMap: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScopeMapResponse>(
            guardedValue,
            (value) => ScopeMapResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
