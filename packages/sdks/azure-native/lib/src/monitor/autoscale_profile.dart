...
class AutoscaleProfile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'capacity':
          pulumi.Input.mapInputValue<ScaleCapacity, Map<String, dynamic>>(
            capacity,
            (value) => value.toMap(),
          ),
      'fixedDate':
          ?pulumi.Input.mapOptionalInputValue<TimeWindow, Map<String, dynamic>>(
            fixedDate,
            (value) => value.toMap(),
          ),
      'name': name,
      ...
      'rules':
          pulumi
              .Input.mapInputValue<List<ScaleRule>, List<Map<String, dynamic>>>(
            rules,
    ...
    return AutoscaleProfile(
      ...
      fixedDate: (() {
        ...
        return pulumi.Input.fromValue(
          TimeWindow.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ScaleRule>(
          map['rules']!,
          (value) => ScaleRule.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
