...
class Receiver {
  ...
  factory Receiver.fromMap(Map<String, dynamic> map) {
    return Receiver(
      ...
      otlp: (() {
        final guardedValue = map['otlp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OtlpReceiver.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      syslog: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SyslogReceiver.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      udp: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UdpReceiver.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
