...
class MonitoringTagRulesProperties {
  ...
  factory MonitoringTagRulesProperties.fromMap(Map<String, dynamic> map) {
    return MonitoringTagRulesProperties(
      ...
      metricRules: (() { final guardedValue = map['metricRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricRules.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
