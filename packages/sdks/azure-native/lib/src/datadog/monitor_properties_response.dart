...
class MonitorPropertiesResponse {
  ...
  final pulumi.Input<DatadogOrganizationPropertiesResponse>?
    ...
    return <String, dynamic>{
      'datadogOrganizationProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(datadogOrganizationProperties, (value) => value.toMap()),
  ...
  factory MonitorPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MonitorPropertiesResponse(
      datadogOrganizationProperties: (() {
        final guardedValue = map['datadogOrganizationProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DatadogOrganizationPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      liftrResourceCategory: pulumi.Input.fromValue(
        map['liftrResourceCategory'] as String,
      ),
      liftrResourcePreference: pulumi.Input.fromValue(
        map['liftrResourcePreference'] as int,
      ),
