...
class ListMonitorMonitoredResourcesResult {
  ...
  ListMonitorMonitoredResourcesResult({this.nextLink, this.value});
  ...
  factory ListMonitorMonitoredResourcesResult.fromMap(
    ...
    return ListMonitorMonitoredResourcesResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<MonitoredResourceResponse>(
          guardedValue,
