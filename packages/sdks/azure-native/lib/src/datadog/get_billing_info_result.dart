...
class GetBillingInfoResult {
  ...
  factory GetBillingInfoResult.fromMap(Map<String, dynamic> map) {
    return GetBillingInfoResult(
      ...
      partnerBillingEntity: (() { final guardedValue = map['partnerBillingEntity']; if (guardedValue == null) return null; return PartnerBillingEntityResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
    );
  }
}
