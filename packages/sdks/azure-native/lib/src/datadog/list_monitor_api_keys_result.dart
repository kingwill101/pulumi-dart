...
class ListMonitorApiKeysResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': ?nextLink,
      'value': ?(() { final guardedValue = value; if (guardedValue == null) return null; return pulumi.Input.encodeList<DatadogApiKeyResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory ListMonitorApiKeysResult.fromMap(Map<String, dynamic> map) {
    return ListMonitorApiKeysResult(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.decodeList<DatadogApiKeyResponse>(guardedValue, (value) => DatadogApiKeyResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
