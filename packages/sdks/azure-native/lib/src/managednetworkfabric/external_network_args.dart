...
class ExternalNetworkArgs {
  ...
  final pulumi.Input<ExternalNetworkPropertiesOptionAProperties>?
  optionAProperties;
  ...
  factory ExternalNetworkArgs.fromMap(Map<String, dynamic> map) {
    return ExternalNetworkArgs(
      ...
      externalNetworkName: (() {
        final guardedValue = map['externalNetworkName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      importRoutePolicy: (() {
      ...
      optionAProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExternalNetworkPropertiesOptionAProperties.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
