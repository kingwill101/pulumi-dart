...
class InternalNetworkPropertiesResponseStaticRouteConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipv4Routes':
          ?pulumi.Input.mapOptionalInputValue<
            List<StaticRoutePropertiesResponse>,
  ...
  factory InternalNetworkPropertiesResponseStaticRouteConfiguration.fromMap(
    ...
    return InternalNetworkPropertiesResponseStaticRouteConfiguration(
      ...
      ipv4Routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StaticRoutePropertiesResponse>(
            guardedValue,
            (value) => StaticRoutePropertiesResponse.fromMap(
