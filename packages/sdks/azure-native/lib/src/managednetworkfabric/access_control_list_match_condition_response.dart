...
class AccessControlListMatchConditionResponse {
  ...
  final AccessControlListPortConditionResponse? portCondition;
  ...
  factory AccessControlListMatchConditionResponse.fromMap(Map<String, dynamic> map) {
    return AccessControlListMatchConditionResponse(
      ...
      portCondition: map['portCondition'] == null ? null : AccessControlListPortConditionResponse.fromMap((map['portCondition'] as Map).cast<String, dynamic>()),
