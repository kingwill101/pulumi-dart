...
class AccessControlListMatchConditionResponse {
  ...
  factory AccessControlListMatchConditionResponse.fromMap(
    ...
    return AccessControlListMatchConditionResponse(
      ...
      ipCondition: (() {
        ...
        return pulumi.Input.fromValue(
          IpMatchConditionResponse.fromMap(
      ...
      portCondition: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessControlListPortConditionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      vlanMatchCondition: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VlanMatchConditionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
