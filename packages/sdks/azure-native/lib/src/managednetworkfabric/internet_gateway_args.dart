...
class InternetGatewayArgs {
  ...
  factory InternetGatewayArgs.fromMap(Map<String, dynamic> map) {
    return InternetGatewayArgs(
      ...
      internetGatewayName: (() { final guardedValue = map['internetGatewayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      internetGatewayRuleId: (() { final guardedValue = map['internetGatewayRuleId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
