...
class NetworkToNetworkInterconnectArgs {
  ...
  final pulumi.Input<dynamic>? isManagementType;
  ...
  final pulumi.Input<dynamic>? nniType;
  ...
  final pulumi.Input<dynamic> useOptionB;
  ...
  factory NetworkToNetworkInterconnectArgs.fromMap(Map<String, dynamic> map) {
    return NetworkToNetworkInterconnectArgs(
      ...
      isManagementType: (() { final guardedValue = map['isManagementType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      nniType: (() { final guardedValue = map['nniType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      useOptionB: pulumi.Input.fromValue(map['useOptionB']),
    );
  }
}
