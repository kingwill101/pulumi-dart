...
class AggregateRouteConfiguration {
  ...
  AggregateRouteConfiguration({this.ipv4Routes, this.ipv6Routes});
    ...
    return <String, dynamic>{
      'ipv4Routes':
          ...
          >(
            ipv4Routes,
            (value) =>
                pulumi.Input.encodeList<AggregateRoute, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AggregateRouteConfiguration(
      ipv4Routes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AggregateRoute>(
            guardedValue,
            (value) =>
                AggregateRoute.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ipv6Routes: (() {
