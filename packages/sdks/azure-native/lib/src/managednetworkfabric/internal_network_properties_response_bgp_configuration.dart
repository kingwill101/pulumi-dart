...
class InternalNetworkPropertiesResponseBgpConfiguration {
  ...
  factory InternalNetworkPropertiesResponseBgpConfiguration.fromMap(
    ...
    return InternalNetworkPropertiesResponseBgpConfiguration(
      ...
      ipv4NeighborAddress: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NeighborAddressResponse>(
            guardedValue,
            (value) => NeighborAddressResponse.fromMap(
