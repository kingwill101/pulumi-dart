...
class NetworkFabricArgs {
  ...
  final pulumi.Input<ManagementNetworkConfigurationProperties>
    ...
    return <String, dynamic>{
      ...
      'managementNetworkConfiguration':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(managementNetworkConfiguration, (value) => value.toMap()),
      ...
      'terminalServerConfiguration':
          pulumi.Input.mapInputValue<
            TerminalServerConfiguration,
            Map<String, dynamic>
          >(terminalServerConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory NetworkFabricArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFabricArgs(
      ...
      managementNetworkConfiguration: pulumi.Input.fromValue(
        ManagementNetworkConfigurationProperties.fromMap(
      ...
      networkFabricName: (() {
        final guardedValue = map['networkFabricName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkFabricSku: pulumi.Input.fromValue(
        map['networkFabricSku'] as String,
      ),
      rackCount: (() {
      ...
      serverCountPerRack: pulumi.Input.fromValue(
        map['serverCountPerRack'] as int,
      ),
      tags: (() {
      ...
      terminalServerConfiguration: pulumi.Input.fromValue(
        TerminalServerConfiguration.fromMap(
