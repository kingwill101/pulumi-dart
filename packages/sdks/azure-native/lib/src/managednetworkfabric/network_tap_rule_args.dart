...
class NetworkTapRuleArgs {
  ...
  final pulumi.Input<List<NetworkTapRuleMatchConfiguration>>?
  matchConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkTapRuleMatchConfiguration>,
            List<Map<String, dynamic>>
          >(
            matchConfigurations,
            (value) =>
  ...
  factory NetworkTapRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkTapRuleArgs(
      ...
      matchConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkTapRuleMatchConfiguration>(
            guardedValue,
            (value) => NetworkTapRuleMatchConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      networkTapRuleName: (() {
        final guardedValue = map['networkTapRuleName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
