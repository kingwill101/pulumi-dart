...
class InternalNetworkArgs {
  ...
  InternalNetworkArgs({
    ...
    pulumi.Output<InternalNetworkPropertiesBgpConfiguration>? bgpConfiguration,
    pulumi.Output<List<ConnectedSubnet>>? connectedIPv4Subnets,
    pulumi.Output<List<ConnectedSubnet>>? connectedIPv6Subnets,
    ...
    pulumi.Output<String>? internalNetworkName,
    pulumi.Output<String>? isMonitoringEnabled,
    required pulumi.Output<String> l3IsolationDomainName,
    pulumi.Output<int>? mtu,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<InternalNetworkPropertiesStaticRouteConfiguration>? staticRouteConfiguration,
  ...
  factory InternalNetworkArgs.fromMap(Map<String, dynamic> map) {
    return InternalNetworkArgs(
      ...
      bgpConfiguration: map['bgpConfiguration'] == null ? null : pulumi.Output.create<InternalNetworkPropertiesBgpConfiguration>(InternalNetworkPropertiesBgpConfiguration.fromMap((map['bgpConfiguration'] as Map).cast<String, dynamic>())),
      connectedIPv4Subnets: map['connectedIPv4Subnets'] == null ? null : pulumi.Output.create<List<ConnectedSubnet>>(pulumi.Input.decodeList<ConnectedSubnet>(map['connectedIPv4Subnets'], (value) => ConnectedSubnet.fromMap((value as Map).cast<String, dynamic>()))),
      connectedIPv6Subnets: map['connectedIPv6Subnets'] == null ? null : pulumi.Output.create<List<ConnectedSubnet>>(pulumi.Input.decodeList<ConnectedSubnet>(map['connectedIPv6Subnets'], (value) => ConnectedSubnet.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      internalNetworkName: map['internalNetworkName'] == null ? null : pulumi.Output.create<String>(map['internalNetworkName'] as String),
      isMonitoringEnabled: map['isMonitoringEnabled'] == null ? null : pulumi.Output.create<String>(map['isMonitoringEnabled'] as String),
      ...
      staticRouteConfiguration: map['staticRouteConfiguration'] == null ? null : pulumi.Output.create<InternalNetworkPropertiesStaticRouteConfiguration>(InternalNetworkPropertiesStaticRouteConfiguration.fromMap((map['staticRouteConfiguration'] as Map).cast<String, dynamic>())),
