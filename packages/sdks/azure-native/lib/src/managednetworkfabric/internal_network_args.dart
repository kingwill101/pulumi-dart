...
class InternalNetworkArgs {
  ...
  factory InternalNetworkArgs.fromMap(Map<String, dynamic> map) {
    return InternalNetworkArgs(
      ...
      bgpConfiguration: (() { final guardedValue = map['bgpConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InternalNetworkPropertiesBgpConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      connectedIPv4Subnets: (() { final guardedValue = map['connectedIPv4Subnets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectedSubnet>(guardedValue, (value) => ConnectedSubnet.fromMap((value as Map).cast<String, dynamic>()))); })(),
      connectedIPv6Subnets: (() { final guardedValue = map['connectedIPv6Subnets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectedSubnet>(guardedValue, (value) => ConnectedSubnet.fromMap((value as Map).cast<String, dynamic>()))); })(),
