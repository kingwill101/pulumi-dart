...
class ConnectedSubnetRoutePolicyResponse {
  ...
  final L3ExportRoutePolicyResponse? exportRoutePolicy;
  ...
  factory ConnectedSubnetRoutePolicyResponse.fromMap(Map<String, dynamic> map) {
    return ConnectedSubnetRoutePolicyResponse(
      exportRoutePolicy: map['exportRoutePolicy'] == null ? null : L3ExportRoutePolicyResponse.fromMap((map['exportRoutePolicy'] as Map).cast<String, dynamic>()),
