...
class GetIpPrefixResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'ipPrefixRules': ?(() { final guardedValue = ipPrefixRules; if (guardedValue == null) return null; return pulumi.Input.encodeList<IpPrefixRuleResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'location': ?location,
      'name': ?name,
  ...
  factory GetIpPrefixResult.fromMap(Map<String, dynamic> map) {
    return GetIpPrefixResult(
      ...
      ipPrefixRules: (() { final guardedValue = map['ipPrefixRules']; if (guardedValue == null) return null; return pulumi.Input.decodeList<IpPrefixRuleResponse>(guardedValue, (value) => IpPrefixRuleResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
