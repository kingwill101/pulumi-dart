...
class GetIpPrefixResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'ipPrefixRules':
          pulumi.Input.encodeList<IpPrefixRuleResponse, Map<String, dynamic>>(
            ipPrefixRules,
            (value) => value.toMap(),
          ),
      'location': location,
  ...
  factory GetIpPrefixResult.fromMap(Map<String, dynamic> map) {
    return GetIpPrefixResult(
      ...
      id: map['id'] as String,
      ipPrefixRules: pulumi.Input.decodeList<IpPrefixRuleResponse>(
        map['ipPrefixRules']!,
        (value) => IpPrefixRuleResponse.fromMap(
