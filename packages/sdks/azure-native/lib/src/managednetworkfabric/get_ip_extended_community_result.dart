...
class GetIpExtendedCommunityResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'ipExtendedCommunityRules': pulumi.Input.encodeList<IpExtendedCommunityRuleResponse, Map<String, dynamic>>(ipExtendedCommunityRules, (value) => value.toMap()),
      'location': location,
      'name': name,
  ...
  factory GetIpExtendedCommunityResult.fromMap(Map<String, dynamic> map) {
    return GetIpExtendedCommunityResult(
      ...
      id: map['id'] as String,
      ipExtendedCommunityRules: pulumi.Input.decodeList<IpExtendedCommunityRuleResponse>(map['ipExtendedCommunityRules']!, (value) => IpExtendedCommunityRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
