...
class ControllerServicesResponse {
  ...
  ControllerServicesResponse({this.ipv4AddressSpaces, this.ipv6AddressSpaces});
  ...
  factory ControllerServicesResponse.fromMap(Map<String, dynamic> map) {
    return ControllerServicesResponse(
      ipv4AddressSpaces: (() {
        final guardedValue = map['ipv4AddressSpaces'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ipv6AddressSpaces: (() {
        final guardedValue = map['ipv6AddressSpaces'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
