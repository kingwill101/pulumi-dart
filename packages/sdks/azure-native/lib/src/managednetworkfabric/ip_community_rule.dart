...
class IpCommunityRule {
  ...
  final pulumi.Input<List<dynamic>?>? wellKnownCommunities;
  ...
  factory IpCommunityRule.fromMap(Map<String, dynamic> map) {
    return IpCommunityRule(
      ...
      wellKnownCommunities: (() { final guardedValue = map['wellKnownCommunities']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
    );
  }
}
