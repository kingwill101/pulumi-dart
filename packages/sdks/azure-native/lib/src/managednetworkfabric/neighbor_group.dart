...
class NeighborGroup extends pulumi.CustomResource {
  ...
  NeighborGroup(
    ...
    destination = registerOutput<NeighborGroupDestinationResponse>('destination', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NeighborGroupDestinationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    networkTapRuleIds = registerOutput<List<String>>('networkTapRuleIds', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
  ...
  /// Creates a typed reference to an existing [NeighborGroup] resource.
  NeighborGroup.reference(String urn)
    : super(
        'azure-native:managednetworkfabric:NeighborGroup',
