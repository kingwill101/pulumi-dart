...
class NetworkMonitor extends pulumi.CustomResource {
  ...
  NetworkMonitor(
    ...
    properties = registerOutput<NetworkMonitorPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return NetworkMonitorPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
