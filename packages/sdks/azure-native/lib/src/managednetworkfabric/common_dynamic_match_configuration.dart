...
class CommonDynamicMatchConfiguration {
  ...
  factory CommonDynamicMatchConfiguration.fromMap(Map<String, dynamic> map) {
    return CommonDynamicMatchConfiguration(
      ipGroups: (() { final guardedValue = map['ipGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IpGroupProperties>(guardedValue, (value) => IpGroupProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
      portGroups: (() { final guardedValue = map['portGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PortGroupProperties>(guardedValue, (value) => PortGroupProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vlanGroups: (() { final guardedValue = map['vlanGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VlanGroupProperties>(guardedValue, (value) => VlanGroupProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
