...
/// }
///
/// resource "azure-native_managednetworkfabric_ipprefix" "ipPrefix" {
///   annotation     = "annotation"
...
class IpPrefix extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<IpPrefixRuleResponse>> ipPrefixRules;
  ...
  IpPrefix(
    ...
    ipPrefixRules = registerOutput<List<IpPrefixRuleResponse>>('ipPrefixRules', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<IpPrefixRuleResponse>(guardedValue, (value) => IpPrefixRuleResponse.fromMap((value as Map).cast<String, dynamic>())); });
  ...
  /// Creates a typed reference to an existing [IpPrefix] resource.
  IpPrefix.reference(String urn)
    : super(
        'azure-native:managednetworkfabric:IpPrefix',
