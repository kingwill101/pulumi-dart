...
class VpnConfigurationProperties {
  ...
  factory VpnConfigurationProperties.fromMap(Map<String, dynamic> map) {
    return VpnConfigurationProperties(
      ...
      optionAProperties: (() { final guardedValue = map['optionAProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpnConfigurationPropertiesOptionAProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      optionBProperties: (() { final guardedValue = map['optionBProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FabricOptionBProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
