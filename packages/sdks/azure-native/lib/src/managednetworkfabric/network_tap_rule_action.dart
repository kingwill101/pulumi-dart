...
class NetworkTapRuleAction {
  ...
  final pulumi.Input<dynamic>? isTimestampEnabled;
  ...
  factory NetworkTapRuleAction.fromMap(Map<String, dynamic> map) {
    return NetworkTapRuleAction(
      ...
      isTimestampEnabled: (() { final guardedValue = map['isTimestampEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
