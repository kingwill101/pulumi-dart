...
/// Result data returned by getIpCommunity.
class GetIpCommunityResult {
  ...
  /// Creates a new [GetIpCommunityResult].
  ...
  const GetIpCommunityResult({
    this.administrativeState,
    this.annotation,
    this.azureApiVersion,
    this.configurationState,
    this.id,
    this.ipCommunityRules,
    this.location,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': ?id,
      'ipCommunityRules': ?(() { final guardedValue = ipCommunityRules; if (guardedValue == null) return null; return pulumi.Input.encodeList<IpCommunityRuleResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'location': ?location,
      'name': ?name,
  ...
  factory GetIpCommunityResult.fromMap(Map<String, dynamic> map) {
    return GetIpCommunityResult(
      ...
      ipCommunityRules: (() { final guardedValue = map['ipCommunityRules']; if (guardedValue == null) return null; return pulumi.Input.decodeList<IpCommunityRuleResponse>(guardedValue, (value) => IpCommunityRuleResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
