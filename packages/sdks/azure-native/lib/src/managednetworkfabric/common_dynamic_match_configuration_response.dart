...
class CommonDynamicMatchConfigurationResponse {
    ...
    return <String, dynamic>{
      'ipGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<IpGroupPropertiesResponse>,
      ...
      'portGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<PortGroupPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            portGroups,
            (value) =>
      ...
      'vlanGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<VlanGroupPropertiesResponse>,
            List<Map<String, dynamic>>
          >(
            vlanGroups,
            (value) =>
  ...
  factory CommonDynamicMatchConfigurationResponse.fromMap(
    ...
    return CommonDynamicMatchConfigurationResponse(
      ipGroups: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpGroupPropertiesResponse>(
            guardedValue,
            (value) => IpGroupPropertiesResponse.fromMap(
      ...
      portGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortGroupPropertiesResponse>(
            guardedValue,
            (value) => PortGroupPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      vlanGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VlanGroupPropertiesResponse>(
            guardedValue,
            (value) => VlanGroupPropertiesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
