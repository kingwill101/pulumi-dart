...
class InternalNetworkPropertiesBgpConfiguration {
    ...
    return <String, dynamic>{
      ...
      'ipv4NeighborAddress':
          ...
          >(
            ipv4NeighborAddress,
            (value) =>
                pulumi.Input.encodeList<NeighborAddress, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory InternalNetworkPropertiesBgpConfiguration.fromMap(
    Map<String, dynamic> map,
  ) {
    return InternalNetworkPropertiesBgpConfiguration(
      allowAS: (() {
        final guardedValue = map['allowAS'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      allowASOverride: (() {
        final guardedValue = map['allowASOverride'];
        if (guardedValue == null) return null;
      ...
      defaultRouteOriginate: (() {
        final guardedValue = map['defaultRouteOriginate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipv4ListenRangePrefixes: (() {
        final guardedValue = map['ipv4ListenRangePrefixes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ipv4NeighborAddress: (() {
        final guardedValue = map['ipv4NeighborAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NeighborAddress>(
            guardedValue,
            (value) =>
                NeighborAddress.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ipv6ListenRangePrefixes: (() {
        final guardedValue = map['ipv6ListenRangePrefixes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ipv6NeighborAddress: (() {
        final guardedValue = map['ipv6NeighborAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NeighborAddress>(
            guardedValue,
