    ...
    return <String, dynamic>{
      'aggregateRouteConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AggregateRouteConfiguration,
            Map<String, dynamic>
          >(aggregateRouteConfiguration, (value) => value.toMap()),
      'annotation': ?annotation,
      'connectedSubnetRoutePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ConnectedSubnetRoutePolicy,
            Map<String, dynamic>
          >(connectedSubnetRoutePolicy, (value) => value.toMap()),
    ...
    return L3IsolationDomainArgs(
      aggregateRouteConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          AggregateRouteConfiguration.fromMap(
      ...
      connectedSubnetRoutePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectedSubnetRoutePolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      l3IsolationDomainName: (() {
        final guardedValue = map['l3IsolationDomainName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
