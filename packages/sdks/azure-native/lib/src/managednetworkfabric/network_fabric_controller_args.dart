...
class NetworkFabricControllerArgs {
  ...
  final pulumi.Input<List<ExpressRouteConnectionInformation>>?
    ...
    return <String, dynamic>{
      ...
      'infrastructureExpressRouteConnections':
          ?pulumi.Input.mapOptionalInputValue<
            List<ExpressRouteConnectionInformation>,
    ...
    return NetworkFabricControllerArgs(
      ...
      infrastructureExpressRouteConnections: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExpressRouteConnectionInformation>(
            guardedValue,
            (value) => ExpressRouteConnectionInformation.fromMap(
      ...
      networkFabricControllerName: (() {
        final guardedValue = map['networkFabricControllerName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nfcSku: (() {
