...
class GetInternalNetworkResult {
  ...
  final InternalNetworkPropertiesResponseStaticRouteConfiguration?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectedIPv4Subnets': ?(() {
        final guardedValue = connectedIPv4Subnets;
      ...
      'connectedIPv6Subnets': ?(() {
        final guardedValue = connectedIPv6Subnets;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
          ConnectedSubnetResponse,
          Map<String, dynamic>
  ...
  factory GetInternalNetworkResult.fromMap(Map<String, dynamic> map) {
    return GetInternalNetworkResult(
      ...
      connectedIPv4Subnets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ConnectedSubnetResponse>(
          guardedValue,
          (value) => ConnectedSubnetResponse.fromMap(
