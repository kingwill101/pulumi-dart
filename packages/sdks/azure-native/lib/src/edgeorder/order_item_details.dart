...
class OrderItemDetails {
  ...
  final pulumi.Input<dynamic>? orderItemMode;
  /// Order item type.
  final pulumi.Input<dynamic> orderItemType;
  ...
  factory OrderItemDetails.fromMap(Map<String, dynamic> map) {
    return OrderItemDetails(
      ...
      orderItemMode: (() { final guardedValue = map['orderItemMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      orderItemType: pulumi.Input.fromValue(map['orderItemType']),
