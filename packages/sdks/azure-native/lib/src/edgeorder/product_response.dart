...
class ProductResponse {
  ...
  factory ProductResponse.fromMap(Map<String, dynamic> map) {
    return ProductResponse(
      ...
      configurations: (pulumi.Input.decodeList<ConfigurationResponse>(map['configurations'], (value) => ConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
