...
class ProductResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'configurations': pulumi.Input.mapInputValue<List<ConfigurationResponse>, List<Map<String, dynamic>>>(configurations, (value) => pulumi.Input.encodeList<ConfigurationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ProductResponse.fromMap(Map<String, dynamic> map) {
    return ProductResponse(
      ...
      configurations: pulumi.Input.fromValue(pulumi.Input.decodeList<ConfigurationResponse>(map['configurations']!, (value) => ConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))),
