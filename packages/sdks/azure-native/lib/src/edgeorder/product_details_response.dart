...
class ProductDetailsResponse {
  ...
  factory ProductDetailsResponse.fromMap(Map<String, dynamic> map) {
    return ProductDetailsResponse(
      childConfigurationDeviceDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<ConfigurationDeviceDetailsResponse>(map['childConfigurationDeviceDetails']!, (value) => ConfigurationDeviceDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      optInAdditionalConfigurations: (() { final guardedValue = map['optInAdditionalConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AdditionalConfigurationResponse>(guardedValue, (value) => AdditionalConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      parentDeviceDetails: pulumi.Input.fromValue(DeviceDetailsResponse.fromMap((map['parentDeviceDetails']! as Map).cast<String, dynamic>())),
      parentProvisioningDetails: (() { final guardedValue = map['parentProvisioningDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProvisioningDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      productDoubleEncryptionStatus: pulumi.Input.fromValue(map['productDoubleEncryptionStatus'] as String),
