...
class OrderItem extends pulumi.CustomResource {
  ...
  OrderItem(
    ...
    addressDetails = registerOutput<AddressDetailsResponse?>('addressDetails', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AddressDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    orderItemDetails = registerOutput<OrderItemDetailsResponse>('orderItemDetails', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return OrderItemDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [OrderItem] resource.
  OrderItem.reference(String urn)
    : super(
        'azure-native:edgeorder:OrderItem',
