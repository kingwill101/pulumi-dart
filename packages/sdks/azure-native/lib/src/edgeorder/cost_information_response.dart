...
class CostInformationResponse {
  ...
  factory CostInformationResponse.fromMap(Map<String, dynamic> map) {
    return CostInformationResponse(
      ...
      billingMeterDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<BillingMeterDetailsResponse>(map['billingMeterDetails']!, (value) => BillingMeterDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
