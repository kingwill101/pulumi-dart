...
class ChildConfigurationResponse {
  ...
  factory ChildConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ChildConfigurationResponse(
      ...
      childConfigurationType: pulumi.Input.fromValue(map['childConfigurationType'] as String),
      childConfigurationTypes: pulumi.Input.fromValue((map['childConfigurationTypes'] as List).cast<String>()),
      ...
      dimensions: pulumi.Input.fromValue(DimensionsResponse.fromMap((map['dimensions']! as Map).cast<String, dynamic>())),
      ...
      groupedChildConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<GroupedChildConfigurationsResponse>(map['groupedChildConfigurations']!, (value) => GroupedChildConfigurationsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      isPartOfBaseConfiguration: pulumi.Input.fromValue(map['isPartOfBaseConfiguration'] as bool),
      maximumQuantity: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['maximumQuantity'])),
      minimumQuantity: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['minimumQuantity'])),
      provisioningSupport: pulumi.Input.fromValue(map['provisioningSupport'] as String),
      specifications: pulumi.Input.fromValue(pulumi.Input.decodeList<SpecificationResponse>(map['specifications']!, (value) => SpecificationResponse.fromMap((value as Map).cast<String, dynamic>()))),
      supportedTermCommitmentDurations: pulumi.Input.fromValue((map['supportedTermCommitmentDurations'] as List).cast<String>()),
    );
  }
}
