...
class OrderItemDetailsResponse {
  ...
  final pulumi.Input<List<ResourceProviderDetailsResponse>>
    ...
    return <String, dynamic>{
      ...
      'currentStage':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(currentStage, (value) => value.toMap()),
      ...
      'forwardShippingDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(forwardShippingDetails, (value) => value.toMap()),
      'managementRpDetailsList':
          pulumi.Input.mapInputValue<
      ...
      'productDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(productDetails, (value) => value.toMap()),
  ...
  factory OrderItemDetailsResponse.fromMap(Map<String, dynamic> map) {
    return OrderItemDetailsResponse(
      cancellationReason: pulumi.Input.fromValue(
        map['cancellationReason'] as String,
      ),
      cancellationStatus: pulumi.Input.fromValue(
        map['cancellationStatus'] as String,
      ),
      currentStage: pulumi.Input.fromValue(
        StageDetailsResponse.fromMap(
          (map['currentStage']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      forwardShippingDetails: pulumi.Input.fromValue(
        ForwardShippingDetailsResponse.fromMap(
          (map['forwardShippingDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      managementRpDetailsList: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ResourceProviderDetailsResponse>(
          map['managementRpDetailsList']!,
          (value) => ResourceProviderDetailsResponse.fromMap(
      ...
      orderItemStageHistory: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StageDetailsResponse>(
          map['orderItemStageHistory']!,
          (value) => StageDetailsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      ...
      productDetails: pulumi.Input.fromValue(
        ProductDetailsResponse.fromMap(
      ...
      reverseShippingDetails: pulumi.Input.fromValue(
        ReverseShippingDetailsResponse.fromMap(
          (map['reverseShippingDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      siteDetails: (() {
