...
class ProductFamilyResponse {
  ...
  factory ProductFamilyResponse.fromMap(Map<String, dynamic> map) {
    return ProductFamilyResponse(
      ...
      productLines: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ProductLineResponse>(
          map['productLines']!,
          (value) => ProductLineResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      resourceProviderDetails: (() {
        final guardedValue = map['resourceProviderDetails'];
