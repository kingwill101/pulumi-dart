...
class ConfigurationFilter {
  ...
  factory ConfigurationFilter.fromMap(Map<String, dynamic> map) {
    return ConfigurationFilter(
      childConfigurationFilter: (() { final guardedValue = map['childConfigurationFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChildConfigurationFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      filterableProperty: (() { final guardedValue = map['filterableProperty']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterableProperty>(guardedValue, (value) => FilterableProperty.fromMap((value as Map).cast<String, dynamic>()))); })(),
