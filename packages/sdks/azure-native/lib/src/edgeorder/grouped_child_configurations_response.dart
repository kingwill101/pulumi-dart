...
class GroupedChildConfigurationsResponse {
  ...
  factory GroupedChildConfigurationsResponse.fromMap(Map<String, dynamic> map) {
    return GroupedChildConfigurationsResponse(
      categoryInformation: pulumi.Input.fromValue(CategoryInformationResponse.fromMap((map['categoryInformation']! as Map).cast<String, dynamic>())),
      childConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<ChildConfigurationResponse>(map['childConfigurations']!, (value) => ChildConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
