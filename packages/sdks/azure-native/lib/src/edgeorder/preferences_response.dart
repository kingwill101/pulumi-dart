...
class PreferencesResponse {
  ...
  final pulumi.Input<ManagementResourcePreferencesResponse>?
  managementResourcePreferences;

  /// Notification preferences.
  final pulumi.Input<List<NotificationPreferenceResponse>>?
  notificationPreferences;

  /// Preferences related to the Term commitment.
  final pulumi.Input<TermCommitmentPreferencesResponse>?
    ...
    return <String, dynamic>{
      ...
      'managementResourcePreferences':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(managementResourcePreferences, (value) => value.toMap()),
      'notificationPreferences':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'termCommitmentPreferences':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(termCommitmentPreferences, (value) => value.toMap()),
    ...
    return PreferencesResponse(
      encryptionPreferences: (() {
        ...
        return pulumi.Input.fromValue(
          EncryptionPreferencesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      managementResourcePreferences: (() {
        final guardedValue = map['managementResourcePreferences'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagementResourcePreferencesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      notificationPreferences: (() {
        final guardedValue = map['notificationPreferences'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NotificationPreferenceResponse>(
            guardedValue,
            (value) => NotificationPreferenceResponse.fromMap(
      ...
      termCommitmentPreferences: (() {
        final guardedValue = map['termCommitmentPreferences'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TermCommitmentPreferencesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      transportPreferences: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TransportPreferencesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
