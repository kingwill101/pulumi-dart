...
class BudgetFilter {
  ...
  BudgetFilter({this.and, this.dimensions, this.tags});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'and':
          ?pulumi.Input.mapOptionalInputValue<
            List<BudgetFilterProperties>,
    ...
    return BudgetFilter(
      and: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BudgetFilterProperties>(
            guardedValue,
            (value) => BudgetFilterProperties.fromMap(
