...
class ReportDefinition {
  ...
  factory ReportDefinition.fromMap(Map<String, dynamic> map) {
    return ReportDefinition(
      dataset: (() { final guardedValue = map['dataset']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportDataset.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timePeriod: (() { final guardedValue = map['timePeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportTimePeriod.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
