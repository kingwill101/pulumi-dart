...
class ReportFilterResponse {
  ...
  ReportFilterResponse({this.and, this.dimension, this.not, this.or, this.tag});
    ...
    return ReportFilterResponse(
      and: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReportFilterResponse>(
            guardedValue,
            (value) => ReportFilterResponse.fromMap(
      ...
      dimension: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReportComparisonExpressionResponse.fromMap(
