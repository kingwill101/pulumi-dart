...
/// Result data returned by getReportByResourceGroupName.
class GetReportByResourceGroupNameResult {
  ...
  /// Creates a new [GetReportByResourceGroupNameResult].
  ...
  factory GetReportByResourceGroupNameResult.fromMap(Map<String, dynamic> map) {
