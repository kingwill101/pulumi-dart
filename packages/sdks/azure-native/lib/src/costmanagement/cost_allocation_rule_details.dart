...
class CostAllocationRuleDetails {
  ...
  CostAllocationRuleDetails({this.sourceResources, this.targetResources});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'sourceResources':
          ?pulumi.Input.mapOptionalInputValue<
            List<SourceCostAllocationResource>,
      ...
      'targetResources':
          ?pulumi.Input.mapOptionalInputValue<
            List<TargetCostAllocationResource>,
            List<Map<String, dynamic>>
          >(
            targetResources,
            (value) =>
    ...
    return CostAllocationRuleDetails(
      sourceResources: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SourceCostAllocationResource>(
            guardedValue,
            (value) => SourceCostAllocationResource.fromMap(
      ...
      targetResources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TargetCostAllocationResource>(
            guardedValue,
            (value) => TargetCostAllocationResource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
