...
class ReportDefinitionResponse {
  ...
  factory ReportDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return ReportDefinitionResponse(
      dataset: (() { final guardedValue = map['dataset']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportDatasetResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timePeriod: (() { final guardedValue = map['timePeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportTimePeriodResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
