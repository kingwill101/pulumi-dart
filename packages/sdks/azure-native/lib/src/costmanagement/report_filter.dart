...
class ReportFilter {
  ...
  ReportFilter({this.and, this.dimension, this.not, this.or, this.tag});
    ...
    return <String, dynamic>{
      'and':
          ...
          >(
            and,
            (value) =>
                pulumi.Input.encodeList<ReportFilter, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ReportFilter(
      and: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReportFilter>(
            guardedValue,
            (value) =>
                ReportFilter.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      dimension: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReportComparisonExpression.fromMap(
