...
class ReportConfigFilter {
  ...
  factory ReportConfigFilter.fromMap(Map<String, dynamic> map) {
    return ReportConfigFilter(
      and: (() { final guardedValue = map['and']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReportConfigFilter>(guardedValue, (value) => ReportConfigFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportConfigComparisonExpression.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      or: (() { final guardedValue = map['or']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReportConfigFilter>(guardedValue, (value) => ReportConfigFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportConfigComparisonExpression.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
