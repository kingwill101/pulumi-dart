    ...
    return <String, dynamic>{
      'aggregation':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, ReportConfigAggregationResponse>,
      ...
      'grouping':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReportConfigGroupingResponse>,
      ...
      'sorting':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReportConfigSortingResponse>,
            List<Map<String, dynamic>>
          >(
            sorting,
            (value) =>
    ...
    return ReportConfigDatasetResponse(
      aggregation: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ReportConfigAggregationResponse>(
            guardedValue,
            (value) => ReportConfigAggregationResponse.fromMap(
      ...
      configuration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReportConfigDatasetConfigurationResponse.fromMap(
      ...
      filter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReportConfigFilterResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      grouping: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReportConfigGroupingResponse>(
            guardedValue,
            (value) => ReportConfigGroupingResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sorting: (() {
        final guardedValue = map['sorting'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReportConfigSortingResponse>(
            guardedValue,
            (value) => ReportConfigSortingResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
