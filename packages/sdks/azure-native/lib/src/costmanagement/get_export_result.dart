...
class GetExportResult {
  ...
  factory GetExportResult.fromMap(Map<String, dynamic> map) {
    return GetExportResult(
      ...
      definition: (() { final guardedValue = map['definition']; if (guardedValue == null) return null; return ExportDefinitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      deliveryInfo: (() { final guardedValue = map['deliveryInfo']; if (guardedValue == null) return null; return ExportDeliveryInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      nextRunTimeEstimate: (() { final guardedValue = map['nextRunTimeEstimate']; if (guardedValue == null) return null; return guardedValue as String; })(),
