...
/// Result data returned by getReportByBillingAccount.
class GetReportByBillingAccountResult {
  ...
  /// Creates a new [GetReportByBillingAccountResult].
  ...
  factory GetReportByBillingAccountResult.fromMap(Map<String, dynamic> map) {
