...
import 'report_by_resource_group_name_args.dart';
...
/// ```
class ReportByResourceGroupName extends pulumi.CustomResource {
  ...
  /// Creates a new [ReportByResourceGroupName].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ReportByResourceGroupName]. {@macro pulumi_costmanagement_report_by_resource_group_name_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ReportByResourceGroupName(
    String name, {
    ReportByResourceGroupNameArgs? args,
  ...
  /// Creates a typed reference to an existing [ReportByResourceGroupName] resource.
  ReportByResourceGroupName.reference(String urn)
    : super(
        'azure-native:costmanagement:ReportByResourceGroupName',
