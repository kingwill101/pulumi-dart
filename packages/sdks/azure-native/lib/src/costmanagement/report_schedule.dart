...
class ReportSchedule {
  ...
  final pulumi.Input<dynamic> recurrence;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recurrencePeriod': ?pulumi.Input.mapOptionalInputValue<ReportRecurrencePeriod, Map<String, dynamic>>(recurrencePeriod, (value) => value.toMap()),
      'status': ?status,
    };
  }
  ...
  factory ReportSchedule.fromMap(Map<String, dynamic> map) {
    return ReportSchedule(
      recurrence: pulumi.Input.fromValue(map['recurrence']),
      recurrencePeriod: (() { final guardedValue = map['recurrencePeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportRecurrencePeriod.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
