...
class ReportConfigFilterResponse {
  ...
  factory ReportConfigFilterResponse.fromMap(Map<String, dynamic> map) {
    return ReportConfigFilterResponse(
      and: (() { final guardedValue = map['and']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReportConfigFilterResponse>(guardedValue, (value) => ReportConfigFilterResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportConfigComparisonExpressionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      or: (() { final guardedValue = map['or']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReportConfigFilterResponse>(guardedValue, (value) => ReportConfigFilterResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportConfigComparisonExpressionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
