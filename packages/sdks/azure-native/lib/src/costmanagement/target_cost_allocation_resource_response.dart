...
class TargetCostAllocationResourceResponse {
    ...
    return <String, dynamic>{
      ...
      'values':
          pulumi.Input.mapInputValue<
            List<CostAllocationProportionResponse>,
  ...
  factory TargetCostAllocationResourceResponse.fromMap(
    ...
    return TargetCostAllocationResourceResponse(
      ...
      values: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CostAllocationProportionResponse>(
          map['values']!,
          (value) => CostAllocationProportionResponse.fromMap(
