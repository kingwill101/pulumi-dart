    ...
    return <String, dynamic>{
      'aggregation':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, ReportConfigAggregation>,
    ...
    return ReportConfigDataset(
      aggregation: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<ReportConfigAggregation>(
            guardedValue,
            (value) => ReportConfigAggregation.fromMap(
      ...
      configuration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReportConfigDatasetConfiguration.fromMap(
      ...
      grouping: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReportConfigGrouping>(
            guardedValue,
            (value) => ReportConfigGrouping.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sorting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReportConfigSorting>(
            guardedValue,
            (value) => ReportConfigSorting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
