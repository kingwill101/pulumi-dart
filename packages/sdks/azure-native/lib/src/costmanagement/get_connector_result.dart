...
class GetConnectorResult {
  ...
  factory GetConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetConnectorResult(
      ...
      collection: (() { final guardedValue = map['collection']; if (guardedValue == null) return null; return ConnectorCollectionInfoConnectorResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      providerAccountId: (() { final guardedValue = map['providerAccountId']; if (guardedValue == null) return null; return guardedValue as String; })(),
