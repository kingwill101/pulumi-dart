...
class ReportDataset {
  ...
  factory ReportDataset.fromMap(Map<String, dynamic> map) {
    return ReportDataset(
      aggregation: (() { final guardedValue = map['aggregation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ReportAggregation>(guardedValue, (value) => ReportAggregation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      configuration: (() { final guardedValue = map['configuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportDatasetConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReportFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      grouping: (() { final guardedValue = map['grouping']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReportGrouping>(guardedValue, (value) => ReportGrouping.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
