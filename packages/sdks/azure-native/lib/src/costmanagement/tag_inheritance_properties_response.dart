...
class TagInheritancePropertiesResponse {
  ...
  TagInheritancePropertiesResponse({required this.preferContainerTags});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'preferContainerTags': preferContainerTags};
  }

  factory TagInheritancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return TagInheritancePropertiesResponse(
      preferContainerTags: pulumi.Input.fromValue(
        map['preferContainerTags'] as bool,
      ),
    );
  }
}
