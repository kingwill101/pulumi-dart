...
class DnsDelegationsProperties {
  ...
  factory DnsDelegationsProperties.fromMap(Map<String, dynamic> map) {
    return DnsDelegationsProperties(
      delegations: (() { final guardedValue = map['delegations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DnsDelegationProperties>(guardedValue, (value) => DnsDelegationProperties.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
