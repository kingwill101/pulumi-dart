...
class PrimaryRegionPropertiesResponse {
  ...
  /// Creates a new [PrimaryRegionPropertiesResponse].
  ...
  const PrimaryRegionPropertiesResponse({
  ...
  factory PrimaryRegionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return PrimaryRegionPropertiesResponse(
