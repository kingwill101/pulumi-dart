...
class CommunicationsGateway extends pulumi.CustomResource {
  ...
  CommunicationsGateway(
    ...
    allocatedMediaAddressPrefixes = registerOutput<List<String>>('allocatedMediaAddressPrefixes');
    allocatedSignalingAddressPrefixes = registerOutput<List<String>>('allocatedSignalingAddressPrefixes');
    apiBridge = registerOutput<ApiBridgePropertiesResponse?>('apiBridge', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ApiBridgePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    autoGeneratedDomainNameLabel = registerOutput<String>('autoGeneratedDomainNameLabel');
    autoGeneratedDomainNameLabelScope = registerOutput<String?>('autoGeneratedDomainNameLabelScope');
    azureApiVersion = registerOutput<String>('azureApiVersion');
    codecs = registerOutput<List<String>>('codecs');
    connectivity = registerOutput<String>('connectivity');
    customSipHeaders = registerOutput<CustomSipHeadersPropertiesResponse?>('customSipHeaders', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomSipHeadersPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    dnsDelegations = registerOutput<DnsDelegationsPropertiesResponse?>('dnsDelegations', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DnsDelegationsPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    integratedMcpEnabled = registerOutput<bool?>('integratedMcpEnabled');
    ...
    teamsVoicemailPilotNumber = registerOutput<String?>('teamsVoicemailPilotNumber');
