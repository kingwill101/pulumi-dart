...
class CommunicationsGateway extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CustomSipHeadersPropertiesResponse?>
  customSipHeaders;
  ...
  CommunicationsGateway(
    ...
    allocatedMediaAddressPrefixes = registerOutput<List<String>>(
      'allocatedMediaAddressPrefixes',
    );
    allocatedSignalingAddressPrefixes = registerOutput<List<String>>(
      'allocatedSignalingAddressPrefixes',
    );
    apiBridge = registerOutput<ApiBridgePropertiesResponse?>('apiBridge');
    autoGeneratedDomainNameLabel = registerOutput<String>(
    ...
    customSipHeaders = registerOutput<CustomSipHeadersPropertiesResponse?>(
      'customSipHeaders',
    );
    dnsDelegations = registerOutput<DnsDelegationsPropertiesResponse?>(
      'dnsDelegations',
    );
    ...
    teamsVoicemailPilotNumber = registerOutput<String?>(
