...
class CustomSipHeadersPropertiesResponse {
  ...
  factory CustomSipHeadersPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CustomSipHeadersPropertiesResponse(
      headers: (() { final guardedValue = map['headers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomSipHeaderResponse>(guardedValue, (value) => CustomSipHeaderResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
