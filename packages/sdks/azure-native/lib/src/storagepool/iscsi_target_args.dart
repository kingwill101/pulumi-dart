...
class IscsiTargetArgs {
  ...
  factory IscsiTargetArgs.fromMap(Map<String, dynamic> map) {
    return IscsiTargetArgs(
      ...
      staticAcls: (() { final guardedValue = map['staticAcls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Acl>(guardedValue, (value) => Acl.fromMap((value as Map).cast<String, dynamic>()))); })(),
