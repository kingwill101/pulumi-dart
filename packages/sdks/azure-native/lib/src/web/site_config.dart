...
class SiteConfig {
  ...
  /// [appSettings] Application settings. This property is not returned in response to normal create and read requests since it may contain sensitive information.
  ...
  /// [connectionStrings] Connection strings. This property is not returned in response to normal create and read requests since it may contain sensitive information.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loadBalancing': ?pulumi.Input.mapOptionalInputValue<SiteLoadBalancing, String>(loadBalancing, (value) => value.wireValue),
      'localMySqlEnabled': ?localMySqlEnabled,
      'logsDirectorySizeLimit': ?logsDirectorySizeLimit,
      'managedPipelineMode': ?pulumi.Input.mapOptionalInputValue<ManagedPipelineMode, String>(managedPipelineMode, (value) => value.wireValue),
  ...
  factory SiteConfig.fromMap(Map<String, dynamic> map) {
    return SiteConfig(
      acrUseManagedIdentityCreds: (() { final guardedValue = map['acrUseManagedIdentityCreds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      acrUserManagedIdentityID: (() { final guardedValue = map['acrUserManagedIdentityID']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      apiDefinition: (() { final guardedValue = map['apiDefinition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiDefinitionInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      apiManagementConfig: (() { final guardedValue = map['apiManagementConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiManagementConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      appSettings: (() { final guardedValue = map['appSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NameValuePair>(guardedValue, (value) => NameValuePair.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      autoHealRules: (() { final guardedValue = map['autoHealRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoHealRules.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      azureStorageAccounts: (() { final guardedValue = map['azureStorageAccounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<AzureStorageInfoValue>(guardedValue, (value) => AzureStorageInfoValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      connectionStrings: (() { final guardedValue = map['connectionStrings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnStringInfo>(guardedValue, (value) => ConnStringInfo.fromMap((value as Map).cast<String, dynamic>()))); })(),
      cors: (() { final guardedValue = map['cors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CorsSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      limits: (() { final guardedValue = map['limits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SiteLimits.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
