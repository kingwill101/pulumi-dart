    ...
    return <String, dynamic>{
      ...
      'connectionStrings':
          ...
          >(
            connectionStrings,
            (value) =>
                pulumi.Input.encodeList<ConnStringInfo, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'handlerMappings':
          ...
          >(
            handlerMappings,
            (value) =>
                pulumi.Input.encodeList<HandlerMapping, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'limits':
          ?pulumi.Input.mapOptionalInputValue<SiteLimits, Map<String, dynamic>>(
            limits,
            (value) => value.toMap(),
          ),
      'linuxFxVersion': ?linuxFxVersion,
      'loadBalancing':
          ?pulumi.Input.mapOptionalInputValue<SiteLoadBalancing, String>(
            loadBalancing,
      ...
      'managedPipelineMode':
          ?pulumi.Input.mapOptionalInputValue<ManagedPipelineMode, String>(
            managedPipelineMode,
            (value) => value.wireValue,
          ),
  ...
  factory SiteConfig.fromMap(Map<String, dynamic> map) {
    return SiteConfig(
      ...
      autoHealRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoHealRules.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      autoSwapSlotName: (() {
      ...
      connectionStrings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConnStringInfo>(
            guardedValue,
            (value) =>
                ConnStringInfo.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      cors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CorsSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      defaultDocuments: (() {
      ...
      experiments: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Experiments.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ftpsState: (() {
      ...
      handlerMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HandlerMapping>(
            guardedValue,
            (value) =>
                HandlerMapping.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      healthCheckPath: (() {
      ...
      ipSecurityRestrictions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpSecurityRestriction>(
            guardedValue,
            (value) => IpSecurityRestriction.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      limits: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SiteLimits.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      linuxFxVersion: (() {
      ...
      loadBalancing: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SiteLoadBalancing.fromValue(guardedValue as String),
        );
      })(),
      localMySqlEnabled: (() {
      ...
      managedPipelineMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedPipelineMode.fromValue(guardedValue as String),
        );
      })(),
      ...
      push: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PushSettings.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      pythonVersion: (() {
      ...
      virtualApplications: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualApplication>(
            guardedValue,
            (value) => VirtualApplication.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
