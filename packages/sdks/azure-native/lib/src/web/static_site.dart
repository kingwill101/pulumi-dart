...
class StaticSite extends pulumi.CustomResource {
  ...
  StaticSite(
    ...
    databaseConnections = registerOutput<List<DatabaseConnectionOverviewResponse>>('databaseConnections', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<DatabaseConnectionOverviewResponse>(guardedValue, (value) => DatabaseConnectionOverviewResponse.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    linkedBackends = registerOutput<List<StaticSiteLinkedBackendResponse>>('linkedBackends', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<StaticSiteLinkedBackendResponse>(guardedValue, (value) => StaticSiteLinkedBackendResponse.fromMap((value as Map).cast<String, dynamic>())); });
    location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    privateEndpointConnections = registerOutput<List<ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse>>('privateEndpointConnections', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse>(guardedValue, (value) => ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    userProvidedFunctionApps = registerOutput<List<StaticSiteUserProvidedFunctionAppResponse>>('userProvidedFunctionApps', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<StaticSiteUserProvidedFunctionAppResponse>(guardedValue, (value) => StaticSiteUserProvidedFunctionAppResponse.fromMap((value as Map).cast<String, dynamic>())); });
  }
