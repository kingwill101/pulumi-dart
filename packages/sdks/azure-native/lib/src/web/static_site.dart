...
class StaticSite extends pulumi.CustomResource {
  ...
  late final pulumi.Output<StaticSiteTemplateOptionsResponse?>
  templateProperties;
  ...
  StaticSite(
    ...
    databaseConnections = registerOutput<List<Map<String, dynamic>>>(
      'databaseConnections',
    );
    ...
    linkedBackends = registerOutput<List<Map<String, dynamic>>>(
      'linkedBackends',
    );
