...
class GetAiGatewayResult {
  ...
  final AiGatewayPropertiesResponse? properties;
  ...
  factory GetAiGatewayResult.fromMap(Map<String, dynamic> map) {
    return GetAiGatewayResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return AiGatewayPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
