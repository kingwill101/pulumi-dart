...
/// }
///
/// resource "azure-native_web_staticsitedatabaseconnection" "staticSiteDatabaseConnection" {
...
class StaticSiteDatabaseConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [StaticSiteDatabaseConnection] resource.
  StaticSiteDatabaseConnection.reference(String urn)
    : super(
        'azure-native:web:StaticSiteDatabaseConnection',
