...
class ListCustomApiWsdlInterfacesResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'value': ?(() { final guardedValue = value; if (guardedValue == null) return null; return pulumi.Input.encodeList<WsdlServiceResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }

  factory ListCustomApiWsdlInterfacesResult.fromMap(Map<String, dynamic> map) {
    return ListCustomApiWsdlInterfacesResult(
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.decodeList<WsdlServiceResponse>(guardedValue, (value) => WsdlServiceResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
