...
class ListWebAppBackupStatusSecretsSlotArgs {
  ...
  factory ListWebAppBackupStatusSecretsSlotArgs.fromMap(
    ...
    return ListWebAppBackupStatusSecretsSlotArgs(
      ...
      backupSchedule: (() {
        ...
        return pulumi.Input.fromValue(
          BackupSchedule.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      databases: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseBackupSetting>(
            guardedValue,
            (value) => DatabaseBackupSetting.fromMap(
