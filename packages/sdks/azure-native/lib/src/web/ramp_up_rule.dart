...
class RampUpRule {
  ...
  factory RampUpRule.fromMap(Map<String, dynamic> map) {
    return RampUpRule(
      actionHostName: (() {
        final guardedValue = map['actionHostName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      changeDecisionCallbackUrl: (() {
        final guardedValue = map['changeDecisionCallbackUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      changeIntervalInMinutes: (() {
        final guardedValue = map['changeIntervalInMinutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      changeStep: (() {
        final guardedValue = map['changeStep'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      maxReroutePercentage: (() {
        final guardedValue = map['maxReroutePercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      minReroutePercentage: (() {
        final guardedValue = map['minReroutePercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      name: (() {
      ...
      reroutePercentage: (() {
        final guardedValue = map['reroutePercentage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
    );
