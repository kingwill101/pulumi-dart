...
import 'web_app_auth_settings_v2_slot_args.dart';
...
class WebAppAuthSettingsV2Slot extends pulumi.CustomResource {
  ...
  /// Creates a new [WebAppAuthSettingsV2Slot].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebAppAuthSettingsV2Slot]. {@macro pulumi_web_web_app_auth_settings_v2_slot_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebAppAuthSettingsV2Slot(
    String name, {
    WebAppAuthSettingsV2SlotArgs? args,
  ...
  /// Creates a typed reference to an existing [WebAppAuthSettingsV2Slot] resource.
  WebAppAuthSettingsV2Slot.reference(String urn)
    : super(
        'azure-native:web:WebAppAuthSettingsV2Slot',
