...
class ApplicationLogsConfigResponse {
  ...
  final pulumi.Input<AzureBlobStorageApplicationLogsConfigResponse>?
  azureBlobStorage;

  /// Application logs to azure table storage configuration.
  final pulumi.Input<AzureTableStorageApplicationLogsConfigResponse>?
  azureTableStorage;
    ...
    return ApplicationLogsConfigResponse(
      azureBlobStorage: (() {
        ...
        return pulumi.Input.fromValue(
          AzureBlobStorageApplicationLogsConfigResponse.fromMap(
      ...
      azureTableStorage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureTableStorageApplicationLogsConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fileSystem: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FileSystemApplicationLogsConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
