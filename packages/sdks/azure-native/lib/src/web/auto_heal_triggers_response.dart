...
class AutoHealTriggersResponse {
  ...
  final pulumi.Input<List<SlowRequestsBasedTriggerResponse>>?
  ...
  final pulumi.Input<List<StatusCodesRangeBasedTriggerResponse>>?
  statusCodesRange;
    ...
    return <String, dynamic>{
      ...
      'slowRequests':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(slowRequests, (value) => value.toMap()),
      'slowRequestsWithPath':
          ?pulumi.Input.mapOptionalInputValue<
            List<SlowRequestsBasedTriggerResponse>,
      ...
      'statusCodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatusCodesBasedTriggerResponse>,
            List<Map<String, dynamic>>
          >(
            statusCodes,
            (value) =>
      ...
      'statusCodesRange':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatusCodesRangeBasedTriggerResponse>,
            List<Map<String, dynamic>>
          >(
            statusCodesRange,
            (value) =>
  ...
  factory AutoHealTriggersResponse.fromMap(Map<String, dynamic> map) {
    return AutoHealTriggersResponse(
      privateBytesInKB: (() {
        final guardedValue = map['privateBytesInKB'];
      ...
      requests: (() {
        ...
        return pulumi.Input.fromValue(
          RequestsBasedTriggerResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      slowRequests: (() {
        final guardedValue = map['slowRequests'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlowRequestsBasedTriggerResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      slowRequestsWithPath: (() {
        final guardedValue = map['slowRequestsWithPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SlowRequestsBasedTriggerResponse>(
            guardedValue,
            (value) => SlowRequestsBasedTriggerResponse.fromMap(
      ...
      statusCodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatusCodesBasedTriggerResponse>(
            guardedValue,
            (value) => StatusCodesBasedTriggerResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      statusCodesRange: (() {
        final guardedValue = map['statusCodesRange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatusCodesRangeBasedTriggerResponse>(
            guardedValue,
            (value) => StatusCodesRangeBasedTriggerResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
