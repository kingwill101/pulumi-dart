...
import 'web_app_scm_allowed_args.dart';
...
/// }
///
/// resource "azure-native_web_webappscmallowed" "webAppScmAllowed" {
///   allow               = true
///   name                = "testSite"
...
class WebAppScmAllowed extends pulumi.CustomResource {
  ...
  /// Creates a new [WebAppScmAllowed].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebAppScmAllowed]. {@macro pulumi_web_web_app_scm_allowed_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebAppScmAllowed(
    String name, {
    WebAppScmAllowedArgs? args,
  ...
  /// Creates a typed reference to an existing [WebAppScmAllowed] resource.
  WebAppScmAllowed.reference(String urn)
    : super(
        'azure-native:web:WebAppScmAllowed',
