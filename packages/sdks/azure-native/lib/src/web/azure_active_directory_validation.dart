...
class AzureActiveDirectoryValidation {
  ...
  factory AzureActiveDirectoryValidation.fromMap(Map<String, dynamic> map) {
    return AzureActiveDirectoryValidation(
      ...
      defaultAuthorizationPolicy: (() { final guardedValue = map['defaultAuthorizationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultAuthorizationPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      jwtClaimChecks: (() { final guardedValue = map['jwtClaimChecks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JwtClaimChecks.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
