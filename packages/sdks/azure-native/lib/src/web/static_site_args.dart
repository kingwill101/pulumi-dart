...
class StaticSiteArgs {
  ...
  factory StaticSiteArgs.fromMap(Map<String, dynamic> map) {
    return StaticSiteArgs(
      allowConfigFileUpdates: map['allowConfigFileUpdates'] == null ? null : (map['allowConfigFileUpdates']! as bool).input(),
      branch: map['branch'] == null ? null : (map['branch']! as String).input(),
      buildProperties: map['buildProperties'] == null ? null : (StaticSiteBuildProperties.fromMap((map['buildProperties']! as Map).cast<String, dynamic>())).input(),
      enterpriseGradeCdnStatus: map['enterpriseGradeCdnStatus'] == null ? null : (map['enterpriseGradeCdnStatus']! as String).input(),
      ...
      stagingEnvironmentPolicy: map['stagingEnvironmentPolicy'] == null ? null : (StagingEnvironmentPolicy.fromValue(map['stagingEnvironmentPolicy']! as String)).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      templateProperties: map['templateProperties'] == null ? null : (StaticSiteTemplateOptions.fromMap((map['templateProperties']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
