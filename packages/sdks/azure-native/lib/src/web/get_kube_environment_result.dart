...
class GetKubeEnvironmentResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'arcConfiguration': ?arcConfiguration == null ? null : arcConfiguration!.toMap(),
      'azureApiVersion': azureApiVersion,
      'containerAppsConfiguration': ?containerAppsConfiguration == null ? null : containerAppsConfiguration!.toMap(),
