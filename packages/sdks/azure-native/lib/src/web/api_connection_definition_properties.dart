...
class ApiConnectionDefinitionProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'statuses':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConnectionStatusDefinition>,
    ...
    return ApiConnectionDefinitionProperties(
      api: (() {
        ...
        return pulumi.Input.fromValue(
          ApiReference.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      changedTime: (() {
      ...
      statuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConnectionStatusDefinition>(
            guardedValue,
            (value) => ConnectionStatusDefinition.fromMap(
      ...
      testLinks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApiConnectionTestLink>(
            guardedValue,
            (value) => ApiConnectionTestLink.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
