...
class AseV3NetworkingConfigurationResponse {
  ...
  factory AseV3NetworkingConfigurationResponse.fromMap(
    ...
    return AseV3NetworkingConfigurationResponse(
      ...
      externalInboundIpAddresses: pulumi.Input.fromValue(
        (map['externalInboundIpAddresses'] as List).cast<String>(),
      ),
      ftpEnabled: (() {
      ...
      internalInboundIpAddresses: pulumi.Input.fromValue(
        (map['internalInboundIpAddresses'] as List).cast<String>(),
      ),
      kind: (() {
      ...
      linuxOutboundIpAddresses: pulumi.Input.fromValue(
        (map['linuxOutboundIpAddresses'] as List).cast<String>(),
      ),
      ...
      windowsOutboundIpAddresses: pulumi.Input.fromValue(
        (map['windowsOutboundIpAddresses'] as List).cast<String>(),
      ),
    );
  }
}
