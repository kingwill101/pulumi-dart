...
class SiteDnsConfigResponse {
  ...
  factory SiteDnsConfigResponse.fromMap(Map<String, dynamic> map) {
    return SiteDnsConfigResponse(
      dnsAltServer: (() {
        final guardedValue = map['dnsAltServer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dnsLegacySortOrder: pulumi.Input.fromValue(
        map['dnsLegacySortOrder'] as bool,
      ),
      dnsMaxCacheTimeout: (() {
        final guardedValue = map['dnsMaxCacheTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      dnsRetryAttemptCount: (() {
        final guardedValue = map['dnsRetryAttemptCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      dnsRetryAttemptTimeout: (() {
        final guardedValue = map['dnsRetryAttemptTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      dnsServers: (() {
