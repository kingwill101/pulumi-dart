...
class KeyVaultReferenceWithStatus {
  ...
  factory KeyVaultReferenceWithStatus.fromMap(Map<String, dynamic> map) {
    return KeyVaultReferenceWithStatus(
