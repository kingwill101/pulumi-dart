...
class FunctionsDeploymentStorage {
  ...
  factory FunctionsDeploymentStorage.fromMap(Map<String, dynamic> map) {
    return FunctionsDeploymentStorage(
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsDeploymentAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
