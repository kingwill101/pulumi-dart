...
import 'functions_deployment_storage_authentication.dart';

/// Storage for deployed package used by the function app.
class FunctionsDeploymentStorage {
  /// Authentication method to access the storage account for deployment.
  final pulumi.Input<FunctionsDeploymentStorageAuthentication?>? authentication;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authentication': ?pulumi.Input.mapOptionalInputValue<FunctionsDeploymentStorageAuthentication, Map<String, dynamic>>(authentication, (value) => value.toMap()),
      'type': ?type,
      'value': ?value,
    };
  }
  ...
  factory FunctionsDeploymentStorage.fromMap(Map<String, dynamic> map) {
    return FunctionsDeploymentStorage(
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsDeploymentStorageAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
