  ...
  factory AutoHealTriggers.fromMap(Map<String, dynamic> map) {
    return AutoHealTriggers(
      ...
      slowRequests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SlowRequestsBasedTrigger.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      slowRequestsWithPath: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SlowRequestsBasedTrigger>(
            guardedValue,
            (value) => SlowRequestsBasedTrigger.fromMap(
      ...
      statusCodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatusCodesBasedTrigger>(
            guardedValue,
            (value) => StatusCodesBasedTrigger.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      statusCodesRange: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatusCodesRangeBasedTrigger>(
            guardedValue,
            (value) => StatusCodesRangeBasedTrigger.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
