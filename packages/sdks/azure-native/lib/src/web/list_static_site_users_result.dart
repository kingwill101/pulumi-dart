...
class ListStaticSiteUsersResult {
  ...
  ListStaticSiteUsersResult({required this.nextLink, required this.value});
  ...
  factory ListStaticSiteUsersResult.fromMap(Map<String, dynamic> map) {
    return ListStaticSiteUsersResult(
      ...
      value: pulumi.Input.decodeList<StaticSiteUserARMResourceResponse>(
        map['value']!,
        (value) => StaticSiteUserARMResourceResponse.fromMap(
