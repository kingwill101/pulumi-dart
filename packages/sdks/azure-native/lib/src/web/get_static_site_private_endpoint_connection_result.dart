...
/// Result data returned by getStaticSitePrivateEndpointConnection.
class GetStaticSitePrivateEndpointConnectionResult {
  ...
  /// Creates a new [GetStaticSitePrivateEndpointConnectionResult].
  ...
  factory GetStaticSitePrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
