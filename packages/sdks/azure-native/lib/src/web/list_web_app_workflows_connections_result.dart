...
class ListWebAppWorkflowsConnectionsResult {
  ...
  factory ListWebAppWorkflowsConnectionsResult.fromMap(Map<String, dynamic> map) {
    return ListWebAppWorkflowsConnectionsResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return WorkflowEnvelopePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
