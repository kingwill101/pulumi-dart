...
class GetWebAppPremierAddOnSlotResult {
  ...
  factory GetWebAppPremierAddOnSlotResult.fromMap(Map<String, dynamic> map) {
    return GetWebAppPremierAddOnSlotResult(
      ...
      marketplaceOffer: (() {
        final guardedValue = map['marketplaceOffer'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      marketplacePublisher: (() {
        final guardedValue = map['marketplacePublisher'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
