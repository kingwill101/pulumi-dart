...
class WorkflowEnvelopeResponseProperties {
  ...
  factory WorkflowEnvelopeResponseProperties.fromMap(Map<String, dynamic> map) {
    return WorkflowEnvelopeResponseProperties(
      files: (() { final guardedValue = map['files']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      flowState: (() { final guardedValue = map['flowState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      health: (() { final guardedValue = map['health']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkflowHealthResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
