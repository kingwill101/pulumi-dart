...
class CustomApiArgs {
  ...
  factory CustomApiArgs.fromMap(Map<String, dynamic> map) {
    return CustomApiArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomApiPropertiesDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
