...
class WorkflowEnvelopePropertiesResponse {
  ...
  const WorkflowEnvelopePropertiesResponse({
    this.files,
    this.flowState,
    this.health,
  });
  ...
  factory WorkflowEnvelopePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return WorkflowEnvelopePropertiesResponse(
