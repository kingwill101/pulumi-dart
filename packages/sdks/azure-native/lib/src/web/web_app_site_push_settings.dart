...
class WebAppSitePushSettings extends pulumi.CustomResource {
  ...
  WebAppSitePushSettings(
    ...
    this.dynamicTagsJson = registerOutput<String?>('dynamicTagsJson');
    this.isPushEnabled = registerOutput<bool>('isPushEnabled');
    this.kind = registerOutput<String?>('kind');
    this.name = registerOutput<String>('name');
    this.tagWhitelistJson = registerOutput<String?>('tagWhitelistJson');
    this.tagsRequiringAuth = registerOutput<String?>('tagsRequiringAuth');
