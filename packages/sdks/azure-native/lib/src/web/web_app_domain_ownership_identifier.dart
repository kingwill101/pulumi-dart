...
import 'web_app_domain_ownership_identifier_args.dart';
...
class WebAppDomainOwnershipIdentifier extends pulumi.CustomResource {
  ...
  /// Creates a new [WebAppDomainOwnershipIdentifier].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebAppDomainOwnershipIdentifier]. {@macro pulumi_web_web_app_domain_ownership_identifier_args_doc}
  ...
  /// Creates a typed reference to an existing [WebAppDomainOwnershipIdentifier] resource.
  WebAppDomainOwnershipIdentifier.reference(String urn)
    : super(
        'azure-native:web:WebAppDomainOwnershipIdentifier',
