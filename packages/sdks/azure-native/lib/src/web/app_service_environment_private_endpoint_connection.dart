...
/// }
///
/// resource "azure-native_web_appserviceenvironmentprivateendpointconnection" "appServiceEnvironmentPrivateEndpointConnection" {
///   name                             = "test-ase"
...
class AppServiceEnvironmentPrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [AppServiceEnvironmentPrivateEndpointConnection] resource.
  AppServiceEnvironmentPrivateEndpointConnection.reference(String urn)
    : super(
        'azure-native:web:AppServiceEnvironmentPrivateEndpointConnection',
