...
class AppServiceEnvironmentArgs {
  ...
  factory AppServiceEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return AppServiceEnvironmentArgs(
      clusterSettings: map['clusterSettings'] == null ? null : (pulumi.Input.decodeList<NameValuePair>(map['clusterSettings'], (value) => NameValuePair.fromMap((value as Map).cast<String, dynamic>()))).input(),
      customDnsSuffixConfiguration: map['customDnsSuffixConfiguration'] == null ? null : (CustomDnsSuffixConfiguration.fromMap((map['customDnsSuffixConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      frontEndScaleFactor: map['frontEndScaleFactor'] == null ? null : (map['frontEndScaleFactor'] as int).input(),
      ...
      multiSize: map['multiSize'] == null ? null : (map['multiSize'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      networkingConfiguration: map['networkingConfiguration'] == null ? null : (AseV3NetworkingConfiguration.fromMap((map['networkingConfiguration'] as Map).cast<String, dynamic>())).input(),
      resourceGroupName: (map['resourceGroupName'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      upgradePreference: map['upgradePreference'] == null ? null : (map['upgradePreference'] as String).input(),
      userWhitelistedIpRanges: map['userWhitelistedIpRanges'] == null ? null : ((map['userWhitelistedIpRanges'] as List).cast<String>()).input(),
      virtualNetwork: (VirtualNetworkProfile.fromMap((map['virtualNetwork'] as Map).cast<String, dynamic>())).input(),
