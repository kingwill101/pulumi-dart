...
class AppServiceEnvironmentArgs {
  ...
  final pulumi.Input<CustomDnsSuffixConfiguration>?
    ...
    return <String, dynamic>{
      'clusterSettings':
          ...
          >(
            clusterSettings,
            (value) =>
                pulumi.Input.encodeList<NameValuePair, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'customDnsSuffixConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            CustomDnsSuffixConfiguration,
            Map<String, dynamic>
          >(customDnsSuffixConfiguration, (value) => value.toMap()),
      ...
      'networkingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(networkingConfiguration, (value) => value.toMap()),
    ...
    return AppServiceEnvironmentArgs(
      clusterSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NameValuePair>(
            guardedValue,
            (value) =>
                NameValuePair.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      customDnsSuffixConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomDnsSuffixConfiguration.fromMap(
      ...
      networkingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AseV3NetworkingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
