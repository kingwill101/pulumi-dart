...
class FunctionsDeploymentResponseStorage {
  ...
  const FunctionsDeploymentResponseStorage({
    this.authentication,
    this.type,
    this.value,
  });
  ...
  factory FunctionsDeploymentResponseStorage.fromMap(Map<String, dynamic> map) {
    return FunctionsDeploymentResponseStorage(
      authentication: (() { final guardedValue = map['authentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsDeploymentResponseAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
