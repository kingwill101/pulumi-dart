...
class StaticSiteBuildPropertiesResponse {
  ...
  factory StaticSiteBuildPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return StaticSiteBuildPropertiesResponse(
      apiBuildCommand: (() { final guardedValue = map['apiBuildCommand']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      apiLocation: (() { final guardedValue = map['apiLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      appArtifactLocation: (() { final guardedValue = map['appArtifactLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      appBuildCommand: (() { final guardedValue = map['appBuildCommand']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      githubActionSecretNameOverride: (() { final guardedValue = map['githubActionSecretNameOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      skipGithubActionWorkflowGeneration: (() { final guardedValue = map['skipGithubActionWorkflowGeneration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
