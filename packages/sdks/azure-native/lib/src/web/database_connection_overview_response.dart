...
class DatabaseConnectionOverviewResponse {
  ...
  final pulumi.Input<
    List<StaticSiteDatabaseConnectionConfigurationFileOverviewResponse>
  >
  configurationFiles;
  ...
  factory DatabaseConnectionOverviewResponse.fromMap(Map<String, dynamic> map) {
    return DatabaseConnectionOverviewResponse(
      configurationFiles: pulumi.Input.fromValue(
      ...
      connectionIdentity: pulumi.Input.fromValue(
        map['connectionIdentity'] as String,
      ),
