...
class DatabaseConnectionOverviewResponse {
  ...
  factory DatabaseConnectionOverviewResponse.fromMap(Map<String, dynamic> map) {
    return DatabaseConnectionOverviewResponse(
      configurationFiles: (pulumi.Input.decodeList<StaticSiteDatabaseConnectionConfigurationFileOverviewResponse>(map['configurationFiles'], (value) => StaticSiteDatabaseConnectionConfigurationFileOverviewResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      connectionIdentity: (map['connectionIdentity'] as String).input(),
