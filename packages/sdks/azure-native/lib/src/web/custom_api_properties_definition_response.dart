...
class CustomApiPropertiesDefinitionResponse {
  ...
  factory CustomApiPropertiesDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return CustomApiPropertiesDefinitionResponse(
      apiDefinitions: (() { final guardedValue = map['apiDefinitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiResourceDefinitionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      backendService: (() { final guardedValue = map['backendService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiResourceBackendServiceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      connectionParameters: (() { final guardedValue = map['connectionParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ConnectionParameterResponse>(guardedValue, (value) => ConnectionParameterResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      runtimeUrls: (() { final guardedValue = map['runtimeUrls']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      swagger: (() { final guardedValue = map['swagger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      wsdlDefinition: (() { final guardedValue = map['wsdlDefinition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WsdlDefinitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
