...
class LegacyMicrosoftAccountResponse {
  ...
  factory LegacyMicrosoftAccountResponse.fromMap(Map<String, dynamic> map) {
    return LegacyMicrosoftAccountResponse(
      ...
      registration: (() { final guardedValue = map['registration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClientRegistrationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      validation: (() { final guardedValue = map['validation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllowedAudiencesValidationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
