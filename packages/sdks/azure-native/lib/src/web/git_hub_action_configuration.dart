...
class GitHubActionConfiguration {
  ...
  factory GitHubActionConfiguration.fromMap(Map<String, dynamic> map) {
    return GitHubActionConfiguration(
      codeConfiguration: (() { final guardedValue = map['codeConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GitHubActionCodeConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      containerConfiguration: (() { final guardedValue = map['containerConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GitHubActionContainerConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
