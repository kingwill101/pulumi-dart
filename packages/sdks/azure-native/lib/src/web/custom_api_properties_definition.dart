...
class CustomApiPropertiesDefinition {
  ...
  const CustomApiPropertiesDefinition({
    this.apiDefinitions,
    this.apiType,
    this.backendService,
    this.brandColor,
  ...
  factory CustomApiPropertiesDefinition.fromMap(Map<String, dynamic> map) {
    return CustomApiPropertiesDefinition(
      ...
      connectionParameters: (() { final guardedValue = map['connectionParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ConnectionParameter>(guardedValue, (value) => ConnectionParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      wsdlDefinition: (() { final guardedValue = map['wsdlDefinition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WsdlDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
