...
class OpenIdConnectClientCredential {
  ...
  OpenIdConnectClientCredential({this.clientSecretSettingName, this.method});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientSecretSettingName': ?clientSecretSettingName,
      'method':
          ?pulumi.Input.mapOptionalInputValue<ClientCredentialMethod, String>(
            method,
    ...
    return OpenIdConnectClientCredential(
      ...
      method: (() {
        ...
        return pulumi.Input.fromValue(
          ClientCredentialMethod.fromValue(guardedValue as String),
        );
      })(),
    );
  }
