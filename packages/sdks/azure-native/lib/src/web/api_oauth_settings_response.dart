...
class ApiOAuthSettingsResponse {
  ...
  factory ApiOAuthSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ApiOAuthSettingsResponse(
      ...
      customParameters: (() { final guardedValue = map['customParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ApiOAuthSettingsParameterResponse>(guardedValue, (value) => ApiOAuthSettingsParameterResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
