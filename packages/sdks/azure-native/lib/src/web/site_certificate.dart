...
/// }
///
/// resource "azure-native_web_sitecertificate" "siteCertificate" {
...
class SiteCertificate extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [SiteCertificate] resource.
  SiteCertificate.reference(String urn)
    : super(
        'azure-native:web:SiteCertificate',
