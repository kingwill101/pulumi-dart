...
import 'web_app_application_settings_slot_args.dart';
...
class WebAppApplicationSettingsSlot extends pulumi.CustomResource {
  ...
  /// Creates a new [WebAppApplicationSettingsSlot].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebAppApplicationSettingsSlot]. {@macro pulumi_web_web_app_application_settings_slot_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebAppApplicationSettingsSlot(
    String name, {
    WebAppApplicationSettingsSlotArgs? args,
  ...
  /// Creates a typed reference to an existing [WebAppApplicationSettingsSlot] resource.
  WebAppApplicationSettingsSlot.reference(String urn)
    : super(
        'azure-native:web:WebAppApplicationSettingsSlot',
