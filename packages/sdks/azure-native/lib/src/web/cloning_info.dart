  ...
  factory CloningInfo.fromMap(Map<String, dynamic> map) {
    return CloningInfo(
      appSettingsOverrides: (() {
        final guardedValue = map['appSettingsOverrides'];
      ...
      cloneCustomHostNames: (() {
        final guardedValue = map['cloneCustomHostNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      cloneSourceControl: (() {
        final guardedValue = map['cloneSourceControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      configureLoadBalancing: (() {
        final guardedValue = map['configureLoadBalancing'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      correlationId: (() {
      ...
      hostingEnvironment: (() {
        final guardedValue = map['hostingEnvironment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      overwrite: (() {
      ...
      sourceWebAppLocation: (() {
        final guardedValue = map['sourceWebAppLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trafficManagerProfileId: (() {
        final guardedValue = map['trafficManagerProfileId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trafficManagerProfileName: (() {
        final guardedValue = map['trafficManagerProfileName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
