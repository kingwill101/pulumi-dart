...
import 'custom_open_id_connect_provider_v1.dart';
...
class IdentityProvidersV1 {
  ...
  final pulumi.Input<Map<String, CustomOpenIdConnectProviderV1>>? customOpenIdConnectProviders;
  ...
  /// Creates a new [IdentityProvidersV1].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customOpenIdConnectProviders': ?pulumi.Input.mapOptionalInputValue<Map<String, CustomOpenIdConnectProviderV1>, Map<String, Map<String, dynamic>>>(customOpenIdConnectProviders, (value) => pulumi.Input.encodeMapValues<CustomOpenIdConnectProviderV1, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory IdentityProvidersV1.fromMap(Map<String, dynamic> map) {
    return IdentityProvidersV1(
      ...
      customOpenIdConnectProviders: (() { final guardedValue = map['customOpenIdConnectProviders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<CustomOpenIdConnectProviderV1>(guardedValue, (value) => CustomOpenIdConnectProviderV1.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      legacyMicrosoftAccount: (() { final guardedValue = map['legacyMicrosoftAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LegacyMicrosoftAccount.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
