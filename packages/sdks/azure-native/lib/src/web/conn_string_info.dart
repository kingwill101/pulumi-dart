...
class ConnStringInfo {
  ...
  ConnStringInfo({this.connectionString, this.name, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionString': ?connectionString,
      'name': ?name,
      'type': ?pulumi.Input.mapOptionalInputValue<ConnectionStringType, String>(
        type,
    ...
    return ConnStringInfo(
      ...
      type: (() {
        ...
        return pulumi.Input.fromValue(
          ConnectionStringType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
