...
class FunctionsScaleAndConcurrency {
    ...
    return <String, dynamic>{
      'alwaysReady':
          ?pulumi.Input.mapOptionalInputValue<
            List<FunctionsAlwaysReadyConfig>,
  ...
  factory FunctionsScaleAndConcurrency.fromMap(Map<String, dynamic> map) {
    return FunctionsScaleAndConcurrency(
      alwaysReady: (() {
        final guardedValue = map['alwaysReady'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FunctionsAlwaysReadyConfig>(
            guardedValue,
            (value) => FunctionsAlwaysReadyConfig.fromMap(
      ...
      instanceMemoryMB: (() {
        final guardedValue = map['instanceMemoryMB'];
        if (guardedValue == null) return null;
      ...
      triggers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FunctionsScaleAndConcurrencyTriggers.fromMap(
