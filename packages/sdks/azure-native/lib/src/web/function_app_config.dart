...
import 'functions_site_update_strategy.dart';
...
class FunctionAppConfig {
  ...
  final pulumi.Input<FunctionsSiteUpdateStrategy>? siteUpdateStrategy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'siteUpdateStrategy': ?pulumi.Input.mapOptionalInputValue<FunctionsSiteUpdateStrategy, Map<String, dynamic>>(siteUpdateStrategy, (value) => value.toMap()),
    };
  }

  factory FunctionAppConfig.fromMap(Map<String, dynamic> map) {
    return FunctionAppConfig(
      deployment: (() { final guardedValue = map['deployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsDeployment.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      runtime: (() { final guardedValue = map['runtime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsRuntime.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      scaleAndConcurrency: (() { final guardedValue = map['scaleAndConcurrency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsScaleAndConcurrency.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      siteUpdateStrategy: (() { final guardedValue = map['siteUpdateStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsSiteUpdateStrategy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
