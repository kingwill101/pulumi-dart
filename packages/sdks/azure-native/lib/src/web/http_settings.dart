...
class HttpSettings {
  ...
  factory HttpSettings.fromMap(Map<String, dynamic> map) {
    return HttpSettings(
      forwardProxy: (() { final guardedValue = map['forwardProxy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardProxy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      routes: (() { final guardedValue = map['routes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpSettingsRoutes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
