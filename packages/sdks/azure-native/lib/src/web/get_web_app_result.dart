...
class GetWebAppResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostNameSslStates': ?(() {
        final guardedValue = hostNameSslStates;
  ...
  factory GetWebAppResult.fromMap(Map<String, dynamic> map) {
    return GetWebAppResult(
      ...
      hostNameSslStates: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<HostNameSslStateResponse>(
          guardedValue,
          (value) => HostNameSslStateResponse.fromMap(
      ...
      slotSwapStatus: SlotSwapStatusResponse.fromMap(
        (map['slotSwapStatus']! as Map).cast<String, dynamic>(),
      ),
      ...
      trafficManagerHostNames: (map['trafficManagerHostNames'] as List)
          .cast<String>(),
