...
import 'web_app_site_push_settings_slot_args.dart';
...
class WebAppSitePushSettingsSlot extends pulumi.CustomResource {
  ...
  /// Creates a new [WebAppSitePushSettingsSlot].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebAppSitePushSettingsSlot]. {@macro pulumi_web_web_app_site_push_settings_slot_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WebAppSitePushSettingsSlot(
    String name, {
    WebAppSitePushSettingsSlotArgs? args,
  ...
  /// Creates a typed reference to an existing [WebAppSitePushSettingsSlot] resource.
  WebAppSitePushSettingsSlot.reference(String urn)
    : super(
        'azure-native:web:WebAppSitePushSettingsSlot',
