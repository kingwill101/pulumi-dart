...
class ListCustomApiWsdlInterfacesArgs {
  ...
  final pulumi.Input<dynamic>? importMethod;
  /// The location
  ...
  factory ListCustomApiWsdlInterfacesArgs.fromMap(Map<String, dynamic> map) {
    return ListCustomApiWsdlInterfacesArgs(
      ...
      importMethod: (() { final guardedValue = map['importMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
