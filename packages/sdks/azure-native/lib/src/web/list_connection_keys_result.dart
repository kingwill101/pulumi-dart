...
class ListConnectionKeysResult {
  ...
  factory ListConnectionKeysResult.fromMap(Map<String, dynamic> map) {
    return ListConnectionKeysResult(
      connectionKey: (() { final guardedValue = map['connectionKey']; if (guardedValue == null) return null; return guardedValue as String; })(),
      parameterValues: (() { final guardedValue = map['parameterValues']; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, dynamic>(); })(),
    );
  }
}
