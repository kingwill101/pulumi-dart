...
class WebAppSlotArgs {
  ...
  WebAppSlotArgs({
    ...
    pulumi.Input<bool?>? clientAffinityEnabled,
    ...
    this.httpsOnly,
    pulumi.Input<bool?>? hyperV,
    this.identity,
    this.ipMode,
    pulumi.Input<bool?>? isXenon,
    ...
    pulumi.Input<bool?>? scmSiteAlsoStopped,
    this.serverFarmId,
    this.siteConfig,
    this.slot,
    this.sshEnabled,
  ...
  }) : clientAffinityEnabled = clientAffinityEnabled ?? pulumi.Input.fromValue(false), hyperV = hyperV ?? pulumi.Input.fromValue(false), isXenon = isXenon ?? pulumi.Input.fromValue(false), scmSiteAlsoStopped = scmSiteAlsoStopped ?? pulumi.Input.fromValue(false);
  ...
  factory WebAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return WebAppSlotArgs(
      ...
      containerSize: (() { final guardedValue = map['containerSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      dailyMemoryTimeQuota: (() { final guardedValue = map['dailyMemoryTimeQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
