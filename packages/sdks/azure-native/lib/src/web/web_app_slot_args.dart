...
class WebAppSlotArgs {
  ...
  factory WebAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return WebAppSlotArgs(
      ...
      vnetBackupRestoreEnabled: (() { final guardedValue = map['vnetBackupRestoreEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
