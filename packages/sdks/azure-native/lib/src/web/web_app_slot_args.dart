...
class WebAppSlotArgs {
  ...
  WebAppSlotArgs({
    pulumi.Output<AutoGeneratedDomainNameLabelScope>? autoGeneratedDomainNameLabelScope,
    pulumi.Output<bool>? clientAffinityEnabled,
    pulumi.Output<bool>? clientCertEnabled,
    pulumi.Output<String>? clientCertExclusionPaths,
    pulumi.Output<ClientCertMode>? clientCertMode,
    pulumi.Output<CloningInfo>? cloningInfo,
    pulumi.Output<int>? containerSize,
    pulumi.Output<String>? customDomainVerificationId,
    pulumi.Output<int>? dailyMemoryTimeQuota,
    pulumi.Output<DaprConfig>? daprConfig,
    pulumi.Output<SiteDnsConfig>? dnsConfiguration,
    pulumi.Output<bool>? enabled,
    pulumi.Output<bool>? endToEndEncryptionEnabled,
    pulumi.Output<ExtendedLocation>? extendedLocation,
    pulumi.Output<FunctionAppConfig>? functionAppConfig,
    pulumi.Output<List<HostNameSslState>>? hostNameSslStates,
    pulumi.Output<bool>? hostNamesDisabled,
    ...
    pulumi.Output<RedundancyMode>? redundancyMode,
    pulumi.Output<bool>? reserved,
    pulumi.Output<ResourceConfig>? resourceConfig,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<bool>? scmSiteAlsoStopped,
    pulumi.Output<String>? serverFarmId,
    pulumi.Output<SiteConfig>? siteConfig,
    pulumi.Output<String>? slot,
    pulumi.Output<bool>? storageAccountRequired,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<String>? virtualNetworkSubnetId,
    pulumi.Output<bool>? vnetBackupRestoreEnabled,
    pulumi.Output<bool>? vnetContentShareEnabled,
    pulumi.Output<bool>? vnetImagePullEnabled,
    pulumi.Output<bool>? vnetRouteAllEnabled,
    pulumi.Output<String>? workloadProfileName,
      ...
      slot = pulumi.Input.asOptionalInput<String>(slot),
  ...
  factory WebAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return WebAppSlotArgs(
      autoGeneratedDomainNameLabelScope: map['autoGeneratedDomainNameLabelScope'] == null ? null : pulumi.Output.create<AutoGeneratedDomainNameLabelScope>(AutoGeneratedDomainNameLabelScope.fromValue(map['autoGeneratedDomainNameLabelScope'] as String)),
      ...
      clientCertExclusionPaths: map['clientCertExclusionPaths'] == null ? null : pulumi.Output.create<String>(map['clientCertExclusionPaths'] as String),
      clientCertMode: map['clientCertMode'] == null ? null : pulumi.Output.create<ClientCertMode>(ClientCertMode.fromValue(map['clientCertMode'] as String)),
      cloningInfo: map['cloningInfo'] == null ? null : pulumi.Output.create<CloningInfo>(CloningInfo.fromMap((map['cloningInfo'] as Map).cast<String, dynamic>())),
      containerSize: map['containerSize'] == null ? null : pulumi.Output.create<int>(map['containerSize'] as int),
      ...
      daprConfig: map['daprConfig'] == null ? null : pulumi.Output.create<DaprConfig>(DaprConfig.fromMap((map['daprConfig'] as Map).cast<String, dynamic>())),
      dnsConfiguration: map['dnsConfiguration'] == null ? null : pulumi.Output.create<SiteDnsConfig>(SiteDnsConfig.fromMap((map['dnsConfiguration'] as Map).cast<String, dynamic>())),
      enabled: map['enabled'] == null ? null : pulumi.Output.create<bool>(map['enabled'] as bool),
      endToEndEncryptionEnabled: map['endToEndEncryptionEnabled'] == null ? null : pulumi.Output.create<bool>(map['endToEndEncryptionEnabled'] as bool),
      extendedLocation: map['extendedLocation'] == null ? null : pulumi.Output.create<ExtendedLocation>(ExtendedLocation.fromMap((map['extendedLocation'] as Map).cast<String, dynamic>())),
      functionAppConfig: map['functionAppConfig'] == null ? null : pulumi.Output.create<FunctionAppConfig>(FunctionAppConfig.fromMap((map['functionAppConfig'] as Map).cast<String, dynamic>())),
      hostNameSslStates: map['hostNameSslStates'] == null ? null : pulumi.Output.create<List<HostNameSslState>>(pulumi.Input.decodeList<HostNameSslState>(map['hostNameSslStates'], (value) => HostNameSslState.fromMap((value as Map).cast<String, dynamic>()))),
      hostNamesDisabled: map['hostNamesDisabled'] == null ? null : pulumi.Output.create<bool>(map['hostNamesDisabled'] as bool),
      ...
      ipMode: map['ipMode'] == null ? null : pulumi.Output.create<IPMode>(IPMode.fromValue(map['ipMode'] as String)),
      ...
      redundancyMode: map['redundancyMode'] == null ? null : pulumi.Output.create<RedundancyMode>(RedundancyMode.fromValue(map['redundancyMode'] as String)),
      reserved: map['reserved'] == null ? null : pulumi.Output.create<bool>(map['reserved'] as bool),
      resourceConfig: map['resourceConfig'] == null ? null : pulumi.Output.create<ResourceConfig>(ResourceConfig.fromMap((map['resourceConfig'] as Map).cast<String, dynamic>())),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      scmSiteAlsoStopped: map['scmSiteAlsoStopped'] == null ? null : pulumi.Output.create<bool>(map['scmSiteAlsoStopped'] as bool),
      serverFarmId: map['serverFarmId'] == null ? null : pulumi.Output.create<String>(map['serverFarmId'] as String),
      siteConfig: map['siteConfig'] == null ? null : pulumi.Output.create<SiteConfig>(SiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>())),
      slot: map['slot'] == null ? null : pulumi.Output.create<String>(map['slot'] as String),
      storageAccountRequired: map['storageAccountRequired'] == null ? null : pulumi.Output.create<bool>(map['storageAccountRequired'] as bool),
      ...
      vnetBackupRestoreEnabled: map['vnetBackupRestoreEnabled'] == null ? null : pulumi.Output.create<bool>(map['vnetBackupRestoreEnabled'] as bool),
      ...
      vnetRouteAllEnabled: map['vnetRouteAllEnabled'] == null ? null : pulumi.Output.create<bool>(map['vnetRouteAllEnabled'] as bool),
