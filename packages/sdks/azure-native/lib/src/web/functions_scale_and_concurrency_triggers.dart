...
class FunctionsScaleAndConcurrencyTriggers {
  ...
  factory FunctionsScaleAndConcurrencyTriggers.fromMap(Map<String, dynamic> map) {
    return FunctionsScaleAndConcurrencyTriggers(
      http: (() { final guardedValue = map['http']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionsScaleAndConcurrencyHttp.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
