...
/// Result data returned by listWebAppAuthSettings.
class ListWebAppAuthSettingsResult {
  ...
  /// Creates a new [ListWebAppAuthSettingsResult].
  ...
  factory ListWebAppAuthSettingsResult.fromMap(Map<String, dynamic> map) {
