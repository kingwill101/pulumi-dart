...
class ApiConnectionDefinitionResponseProperties {
  ...
  const ApiConnectionDefinitionResponseProperties({
    this.api,
    this.changedTime,
    this.createdTime,
  ...
  factory ApiConnectionDefinitionResponseProperties.fromMap(Map<String, dynamic> map) {
    return ApiConnectionDefinitionResponseProperties(
      api: (() { final guardedValue = map['api']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      statuses: (() { final guardedValue = map['statuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectionStatusDefinitionResponse>(guardedValue, (value) => ConnectionStatusDefinitionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      testLinks: (() { final guardedValue = map['testLinks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApiConnectionTestLinkResponse>(guardedValue, (value) => ApiConnectionTestLinkResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
