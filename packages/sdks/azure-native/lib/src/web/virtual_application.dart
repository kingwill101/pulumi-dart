...
class VirtualApplication {
  ...
  factory VirtualApplication.fromMap(Map<String, dynamic> map) {
    return VirtualApplication(
      ...
      virtualDirectories: (() { final guardedValue = map['virtualDirectories']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualDirectory>(guardedValue, (value) => VirtualDirectory.fromMap((value as Map).cast<String, dynamic>()))); })(),
