...
/// }
///
/// resource "azure-native_web_webappprivateendpointconnection" "webAppPrivateEndpointConnection" {
///   name                             = "testSite"
...
class WebAppPrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WebAppPrivateEndpointConnection] resource.
  WebAppPrivateEndpointConnection.reference(String urn)
    : super(
        'azure-native:web:WebAppPrivateEndpointConnection',
