...
import 'web_app_source_control_args.dart';
...
class WebAppSourceControl extends pulumi.CustomResource {
  ...
  /// Creates a new [WebAppSourceControl].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebAppSourceControl]. {@macro pulumi_web_web_app_source_control_args_doc}
  ...
  WebAppSourceControl(
    ...
    deploymentRollbackEnabled = registerOutput<bool?>('deploymentRollbackEnabled');
  ...
  /// Creates a typed reference to an existing [WebAppSourceControl] resource.
  WebAppSourceControl.reference(String urn)
    : super(
        'azure-native:web:WebAppSourceControl',
