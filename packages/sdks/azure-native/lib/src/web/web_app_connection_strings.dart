...
import 'web_app_connection_strings_args.dart';
...
class WebAppConnectionStrings extends pulumi.CustomResource {
  ...
  /// Creates a new [WebAppConnectionStrings].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WebAppConnectionStrings]. {@macro pulumi_web_web_app_connection_strings_args_doc}
  ...
  /// Creates a typed reference to an existing [WebAppConnectionStrings] resource.
  WebAppConnectionStrings.reference(String urn)
    : super(
        'azure-native:web:WebAppConnectionStrings',
