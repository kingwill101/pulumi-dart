...
class OnlineExperimentationWorkspace extends pulumi.CustomResource {
  ...
  OnlineExperimentationWorkspace(
    ...
    properties = registerOutput<OnlineExperimentationWorkspacePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return OnlineExperimentationWorkspacePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    sku = registerOutput<OnlineExperimentationWorkspaceSkuResponse?>('sku', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return OnlineExperimentationWorkspaceSkuResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [OnlineExperimentationWorkspace] resource.
  OnlineExperimentationWorkspace.reference(String urn)
    : super(
        'azure-native:onlineexperimentation:OnlineExperimentationWorkspace',
