...
class OnlineExperimentationWorkspaceArgs {
  ...
  factory OnlineExperimentationWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return OnlineExperimentationWorkspaceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnlineExperimentationWorkspaceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OnlineExperimentationWorkspaceSku.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
