...
class ResourceEncryptionConfigurationResponse {
  ...
  final pulumi.Input<CustomerManagedKeyEncryptionResponse>?
  ...
  ResourceEncryptionConfigurationResponse({this.customerManagedKeyEncryption});
  ...
  factory ResourceEncryptionConfigurationResponse.fromMap(
    ...
    return ResourceEncryptionConfigurationResponse(
      customerManagedKeyEncryption: (() {
        ...
        return pulumi.Input.fromValue(
          CustomerManagedKeyEncryptionResponse.fromMap(
