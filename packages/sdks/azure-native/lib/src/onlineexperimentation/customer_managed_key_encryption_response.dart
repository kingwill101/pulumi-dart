...
class CustomerManagedKeyEncryptionResponse {
  ...
  final pulumi.Input<KeyEncryptionKeyIdentityResponse>? keyEncryptionKeyIdentity;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keyEncryptionKeyIdentity': ?pulumi.Input.mapOptionalInputValue<KeyEncryptionKeyIdentityResponse, Map<String, dynamic>>(keyEncryptionKeyIdentity, (value) => value.toMap()),
  ...
  factory CustomerManagedKeyEncryptionResponse.fromMap(Map<String, dynamic> map) {
    return CustomerManagedKeyEncryptionResponse(
      keyEncryptionKeyIdentity: (() { final guardedValue = map['keyEncryptionKeyIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyEncryptionKeyIdentityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
