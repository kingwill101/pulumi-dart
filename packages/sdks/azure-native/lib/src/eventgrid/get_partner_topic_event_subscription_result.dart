...
/// Result data returned by getPartnerTopicEventSubscription.
class GetPartnerTopicEventSubscriptionResult {
  ...
  /// Creates a new [GetPartnerTopicEventSubscriptionResult].
  ...
  const GetPartnerTopicEventSubscriptionResult({
  ...
  factory GetPartnerTopicEventSubscriptionResult.fromMap(Map<String, dynamic> map) {
