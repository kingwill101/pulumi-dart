...
/// }
///
/// resource "azure-native_eventgrid_partnertopiceventsubscription" "partnerTopicEventSubscription" {
///   destination = {
///     "endpointType" = "WebHook"
///     "endpointUrl"  = "https://requestb.in/15ksip71"
///   }
...
class PartnerTopicEventSubscription extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PartnerTopicEventSubscription] resource.
  PartnerTopicEventSubscription.reference(String urn)
    : super(
        'azure-native:eventgrid:PartnerTopicEventSubscription',
