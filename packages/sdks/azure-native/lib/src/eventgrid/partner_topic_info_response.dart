...
class PartnerTopicInfoResponse {
  ...
  factory PartnerTopicInfoResponse.fromMap(Map<String, dynamic> map) {
    return PartnerTopicInfoResponse(
      azureSubscriptionId: (() { final guardedValue = map['azureSubscriptionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eventTypeInfo: (() { final guardedValue = map['eventTypeInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventTypeInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
