...
class EventTypeInfoResponse {
  ...
  final pulumi.Input<Map<String, InlineEventPropertiesResponse>>?
  inlineEventTypes;
  ...
  EventTypeInfoResponse({this.inlineEventTypes, this.kind});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inlineEventTypes':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, InlineEventPropertiesResponse>,
  ...
  factory EventTypeInfoResponse.fromMap(Map<String, dynamic> map) {
    return EventTypeInfoResponse(
      inlineEventTypes: (() {
        final guardedValue = map['inlineEventTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<InlineEventPropertiesResponse>(
            guardedValue,
            (value) => InlineEventPropertiesResponse.fromMap(
