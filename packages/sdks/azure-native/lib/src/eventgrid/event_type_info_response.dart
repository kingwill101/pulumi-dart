...
class EventTypeInfoResponse {
  ...
  factory EventTypeInfoResponse.fromMap(Map<String, dynamic> map) {
    return EventTypeInfoResponse(
      inlineEventTypes: (() { final guardedValue = map['inlineEventTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<InlineEventPropertiesResponse>(guardedValue, (value) => InlineEventPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
