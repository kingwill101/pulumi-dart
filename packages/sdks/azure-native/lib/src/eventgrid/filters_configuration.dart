...
class FiltersConfiguration {
  ...
  FiltersConfiguration({this.filters, this.includedEventTypes});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<BoolEqualsFilter>,
            List<Map<String, dynamic>>
          >(
            filters,
            (value) =>
                pulumi.Input.encodeList<BoolEqualsFilter, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return FiltersConfiguration(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BoolEqualsFilter>(
            guardedValue,
            (value) => BoolEqualsFilter.fromMap(
