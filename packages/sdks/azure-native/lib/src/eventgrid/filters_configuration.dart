...
class FiltersConfiguration {
  ...
  final List<BoolEqualsFilter>? filters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?filters == null ? null : pulumi.Input.encodeList<BoolEqualsFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
  ...
  factory FiltersConfiguration.fromMap(Map<String, dynamic> map) {
    return FiltersConfiguration(
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<BoolEqualsFilter>(map['filters'], (value) => BoolEqualsFilter.fromMap((value as Map).cast<String, dynamic>())),
