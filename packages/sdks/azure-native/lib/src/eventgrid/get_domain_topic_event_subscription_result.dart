...
/// Result data returned by getDomainTopicEventSubscription.
class GetDomainTopicEventSubscriptionResult {
  ...
  /// Creates a new [GetDomainTopicEventSubscriptionResult].
  ...
  const GetDomainTopicEventSubscriptionResult({
  ...
  factory GetDomainTopicEventSubscriptionResult.fromMap(Map<String, dynamic> map) {
