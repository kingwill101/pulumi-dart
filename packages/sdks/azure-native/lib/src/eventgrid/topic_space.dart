...
/// }
///
/// resource "azure-native_eventgrid_topicspace" "topicSpace" {
///   namespace_name      = "exampleNamespaceName1"
///   resource_group_name = "examplerg"
///   topic_space_name    = "exampleTopicSpaceName1"
///   topic_templates     = ["filter1", "filter2"]
/// }
///
/// ```
///
...
class TopicSpace extends pulumi.CustomResource {
  ...
  TopicSpace(
    ...
    topicTemplates = registerOutput<List<String>?>('topicTemplates', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [TopicSpace] resource.
  TopicSpace.reference(String urn)
    : super(
        'azure-native:eventgrid:TopicSpace',
