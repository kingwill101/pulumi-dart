...
class RoutingEnrichmentsResponse {
  ...
  /// [dynamic_] Optional.
  /// [static] Optional.
  RoutingEnrichmentsResponse({this.dynamic_, this.static});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dynamic':
          ?pulumi.Input.mapOptionalInputValue<
            List<DynamicRoutingEnrichmentResponse>,
      ...
      'static':
          ?pulumi.Input.mapOptionalInputValue<
            List<StaticStringRoutingEnrichmentResponse>,
            List<Map<String, dynamic>>
          >(
            static,
            (value) =>
    ...
    return RoutingEnrichmentsResponse(
      dynamic_: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DynamicRoutingEnrichmentResponse>(
            guardedValue,
            (value) => DynamicRoutingEnrichmentResponse.fromMap(
      ...
      static: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StaticStringRoutingEnrichmentResponse>(
            guardedValue,
            (value) => StaticStringRoutingEnrichmentResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
