...
class DeliveryWithResourceIdentityResponse {
  ...
  DeliveryWithResourceIdentityResponse({this.destination, this.identity});
  ...
  factory DeliveryWithResourceIdentityResponse.fromMap(
    ...
    return DeliveryWithResourceIdentityResponse(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventSubscriptionIdentityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
