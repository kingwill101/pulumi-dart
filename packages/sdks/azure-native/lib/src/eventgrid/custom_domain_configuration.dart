...
class CustomDomainConfiguration {
  ...
  final pulumi.Input<dynamic>? validationState;
  ...
  factory CustomDomainConfiguration.fromMap(Map<String, dynamic> map) {
    return CustomDomainConfiguration(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomDomainIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      validationState: (() { final guardedValue = map['validationState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
