...
class EventTypeInfo {
  ...
  EventTypeInfo({this.inlineEventTypes, this.kind});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inlineEventTypes':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, InlineEventProperties>,
    ...
    return EventTypeInfo(
      inlineEventTypes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<InlineEventProperties>(
            guardedValue,
            (value) => InlineEventProperties.fromMap(
