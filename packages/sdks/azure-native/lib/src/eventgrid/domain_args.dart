...
class DomainArgs {
  ...
  DomainArgs({
    pulumi.Input<bool?>? autoCreateTopicWithFirstSubscription,
    pulumi.Input<bool?>? autoDeleteTopicWithLastSubscription,
    ...
    this.tags,
  }) : autoCreateTopicWithFirstSubscription = autoCreateTopicWithFirstSubscription ?? pulumi.Input.fromValue(true), autoDeleteTopicWithLastSubscription = autoDeleteTopicWithLastSubscription ?? pulumi.Input.fromValue(true), disableLocalAuth = disableLocalAuth ?? pulumi.Input.fromValue(false), inputSchema = inputSchema ?? pulumi.Input.fromValue('EventGridSchema'), publicNetworkAccess = publicNetworkAccess ?? pulumi.Input.fromValue('Enabled');
