...
class FiltersConfigurationResponse {
  ...
  FiltersConfigurationResponse({this.filters, this.includedEventTypes});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<BoolEqualsFilterResponse>,
    ...
    return FiltersConfigurationResponse(
      filters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BoolEqualsFilterResponse>(
            guardedValue,
            (value) => BoolEqualsFilterResponse.fromMap(
