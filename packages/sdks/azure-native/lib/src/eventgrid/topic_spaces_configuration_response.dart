    ...
    return <String, dynamic>{
      'customDomains':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomDomainConfigurationResponse>,
      ...
      'routingEnrichments':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(routingEnrichments, (value) => value.toMap()),
      'routingIdentityInfo':
          ?pulumi.Input.mapOptionalInputValue<
            RoutingIdentityInfoResponse,
            Map<String, dynamic>
          >(routingIdentityInfo, (value) => value.toMap()),
      'state': ?state,
    };
  }
    ...
    return TopicSpacesConfigurationResponse(
      customDomains: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomDomainConfigurationResponse>(
            guardedValue,
            (value) => CustomDomainConfigurationResponse.fromMap(
      ...
      maximumClientSessionsPerAuthenticationName: (() {
        final guardedValue = map['maximumClientSessionsPerAuthenticationName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maximumSessionExpiryInHours: (() {
        final guardedValue = map['maximumSessionExpiryInHours'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      routeTopicResourceId: (() {
        final guardedValue = map['routeTopicResourceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      routingEnrichments: (() {
        final guardedValue = map['routingEnrichments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutingEnrichmentsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      routingIdentityInfo: (() {
        final guardedValue = map['routingIdentityInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutingIdentityInfoResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
