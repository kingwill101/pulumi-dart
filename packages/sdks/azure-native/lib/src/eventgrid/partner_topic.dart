...
/// }
///
/// resource "azure-native_eventgrid_partnertopic" "partnerTopic" {
...
class PartnerTopic extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PartnerTopic] resource.
  PartnerTopic.reference(String urn)
    : super(
        'azure-native:eventgrid:PartnerTopic',
