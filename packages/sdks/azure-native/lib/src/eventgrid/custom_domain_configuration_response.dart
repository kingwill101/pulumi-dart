  ...
  factory CustomDomainConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return CustomDomainConfigurationResponse(
      ...
      expectedTxtRecordName: (() {
        final guardedValue = map['expectedTxtRecordName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      expectedTxtRecordValue: (() {
        final guardedValue = map['expectedTxtRecordValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      identity: (() {
        ...
        return pulumi.Input.fromValue(
          CustomDomainIdentityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      validationState: (() {
        final guardedValue = map['validationState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
