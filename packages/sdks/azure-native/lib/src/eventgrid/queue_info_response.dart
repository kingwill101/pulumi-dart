...
class QueueInfoResponse {
  ...
  final DeadLetterWithResourceIdentityResponse? deadLetterDestinationWithResourceIdentity;
  ...
  factory QueueInfoResponse.fromMap(Map<String, dynamic> map) {
    return QueueInfoResponse(
      deadLetterDestinationWithResourceIdentity: map['deadLetterDestinationWithResourceIdentity'] == null ? null : DeadLetterWithResourceIdentityResponse.fromMap((map['deadLetterDestinationWithResourceIdentity'] as Map).cast<String, dynamic>()),
