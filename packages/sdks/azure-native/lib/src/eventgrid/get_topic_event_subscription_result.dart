...
/// Result data returned by getTopicEventSubscription.
class GetTopicEventSubscriptionResult {
  ...
  /// Creates a new [GetTopicEventSubscriptionResult].
  ...
  const GetTopicEventSubscriptionResult({
  ...
  factory GetTopicEventSubscriptionResult.fromMap(Map<String, dynamic> map) {
