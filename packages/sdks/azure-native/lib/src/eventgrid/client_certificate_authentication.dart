...
class ClientCertificateAuthentication {
  ...
  final pulumi.Input<dynamic>? validationScheme;
  ...
  const ClientCertificateAuthentication({
  ...
  factory ClientCertificateAuthentication.fromMap(Map<String, dynamic> map) {
    return ClientCertificateAuthentication(
      ...
      validationScheme: (() { final guardedValue = map['validationScheme']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
