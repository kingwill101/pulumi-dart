...
class StorageQueueEventSubscriptionDestinationResponse {
  ...
  const StorageQueueEventSubscriptionDestinationResponse({
  ...
  factory StorageQueueEventSubscriptionDestinationResponse.fromMap(Map<String, dynamic> map) {
    return StorageQueueEventSubscriptionDestinationResponse(
      ...
      queueMessageTimeToLiveInSeconds: (() { final guardedValue = map['queueMessageTimeToLiveInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
