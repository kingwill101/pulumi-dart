...
class EventSubscriptionFilter {
  ...
  factory EventSubscriptionFilter.fromMap(Map<String, dynamic> map) {
    return EventSubscriptionFilter(
      advancedFilters: (() {
        final guardedValue = map['advancedFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BoolEqualsAdvancedFilter>(
            guardedValue,
            (value) => BoolEqualsAdvancedFilter.fromMap(
      ...
      enableAdvancedFilteringOnArrays: (() {
        final guardedValue = map['enableAdvancedFilteringOnArrays'];
        if (guardedValue == null) return null;
      ...
      isSubjectCaseSensitive: (() {
        final guardedValue = map['isSubjectCaseSensitive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      subjectBeginsWith: (() {
        final guardedValue = map['subjectBeginsWith'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subjectEndsWith: (() {
        final guardedValue = map['subjectEndsWith'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
