...
class IdentityInfo {
  ...
  final pulumi.Input<Map<String, UserIdentityProperties>>?
    ...
    return <String, dynamic>{
      ...
      'userAssignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, UserIdentityProperties>,
    ...
    return IdentityInfo(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<UserIdentityProperties>(
            guardedValue,
            (value) => UserIdentityProperties.fromMap(
