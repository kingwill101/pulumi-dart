...
/// Result data returned by getDomainEventSubscription.
class GetDomainEventSubscriptionResult {
  ...
  /// Creates a new [GetDomainEventSubscriptionResult].
  ...
  factory GetDomainEventSubscriptionResult.fromMap(Map<String, dynamic> map) {
