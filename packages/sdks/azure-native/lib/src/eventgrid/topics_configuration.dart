...
class TopicsConfiguration {
  ...
  TopicsConfiguration({this.customDomains});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customDomains':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomDomainConfiguration>,
    ...
    return TopicsConfiguration(
      customDomains: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomDomainConfiguration>(
            guardedValue,
            (value) => CustomDomainConfiguration.fromMap(
