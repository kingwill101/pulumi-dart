...
class NamespaceArgs {
  ...
  final pulumi.Input<List<PrivateEndpointConnectionEventgrid>>?
    ...
    return <String, dynamic>{
      ...
      'topicSpacesConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            TopicSpacesConfiguration,
            Map<String, dynamic>
          >(topicSpacesConfiguration, (value) => value.toMap()),
      'topicsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            TopicsConfiguration,
            Map<String, dynamic>
          >(topicsConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      privateEndpointConnections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<PrivateEndpointConnectionEventgrid>(),
        );
      })(),
      publicNetworkAccess: (() {
      ...
      sku: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NamespaceSku.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
      ...
      topicSpacesConfiguration: (() {
        final guardedValue = map['topicSpacesConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TopicSpacesConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      topicsConfiguration: (() {
        final guardedValue = map['topicsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TopicsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
