...
/// }
///
/// resource "azure-native_eventgrid_topiceventsubscription" "topicEventSubscription" {
///   destination = {
///     "endpointType" = "WebHook"
///     "endpointUrl"  = "https://requestb.in/15ksip71"
///   }
...
class TopicEventSubscription extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [TopicEventSubscription] resource.
  TopicEventSubscription.reference(String urn)
    : super(
        'azure-native:eventgrid:TopicEventSubscription',
