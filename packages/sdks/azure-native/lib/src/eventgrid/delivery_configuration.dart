...
class DeliveryConfiguration {
  ...
  DeliveryConfiguration({this.deliveryMode, this.push, this.queue});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'deliveryMode': ?deliveryMode,
      'push':
          ?pulumi.Input.mapOptionalInputValue<PushInfo, Map<String, dynamic>>(
            push,
            (value) => value.toMap(),
          ),
      'queue':
          ?pulumi.Input.mapOptionalInputValue<QueueInfo, Map<String, dynamic>>(
            queue,
            (value) => value.toMap(),
          ),
    };
    ...
    return DeliveryConfiguration(
      ...
      push: (() {
        ...
        return pulumi.Input.fromValue(
          PushInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      queue: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          QueueInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
