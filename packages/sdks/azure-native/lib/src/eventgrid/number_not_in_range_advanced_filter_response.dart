...
class NumberNotInRangeAdvancedFilterResponse {
  ...
  /// Creates a new [NumberNotInRangeAdvancedFilterResponse].
  /// [key] The field/property in the event based on which you want to filter.
  /// [operatorType] The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
  /// [values] The set of filter values.
  const NumberNotInRangeAdvancedFilterResponse({
    this.key,
  ...
  factory NumberNotInRangeAdvancedFilterResponse.fromMap(Map<String, dynamic> map) {
    return NumberNotInRangeAdvancedFilterResponse(
