...
/// }
///
/// resource "azure-native_eventgrid_systemtopiceventsubscription" "systemTopicEventSubscription" {
///   destination = {
///     "endpointType" = "WebHook"
///     "endpointUrl"  = "https://requestb.in/15ksip71"
///   }
...
class SystemTopicEventSubscription extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SystemTopicEventSubscription]. {@macro pulumi_eventgrid_system_topic_event_subscription_args_doc}
