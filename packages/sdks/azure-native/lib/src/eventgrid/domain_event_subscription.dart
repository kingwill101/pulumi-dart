...
import 'domain_event_subscription_args.dart';
...
/// }
///
/// resource "azure-native_eventgrid_domaineventsubscription" "domainEventSubscription" {
///   destination = {
///     "endpointType" = "WebHook"
///     "endpointUrl"  = "https://requestb.in/15ksip71"
///   }
...
class DomainEventSubscription extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [DomainEventSubscription]. {@macro pulumi_eventgrid_domain_event_subscription_args_doc}
  ...
  /// Creates a typed reference to an existing [DomainEventSubscription] resource.
  DomainEventSubscription.reference(String urn)
    : super(
        'azure-native:eventgrid:DomainEventSubscription',
