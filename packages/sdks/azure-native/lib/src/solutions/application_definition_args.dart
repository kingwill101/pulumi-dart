...
class ApplicationDefinitionArgs {
  ...
  ApplicationDefinitionArgs({
    pulumi.Output<String>? applicationDefinitionName,
    pulumi.Output<List<ApplicationDefinitionArtifact>>? artifacts,
    pulumi.Output<List<ApplicationAuthorization>>? authorizations,
    pulumi.Output<dynamic>? createUiDefinition,
    pulumi.Output<ApplicationDeploymentPolicy>? deploymentPolicy,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<bool>? isEnabled,
    pulumi.Output<String>? location,
    required pulumi.Output<ApplicationLockLevel> lockLevel,
    pulumi.Output<ApplicationPackageLockingPolicyDefinition>? lockingPolicy,
    pulumi.Output<dynamic>? mainTemplate,
    pulumi.Output<String>? managedBy,
    pulumi.Output<ApplicationManagementPolicy>? managementPolicy,
    pulumi.Output<ApplicationNotificationPolicy>? notificationPolicy,
    pulumi.Output<String>? packageFileUri,
    pulumi.Output<List<ApplicationPolicy>>? policies,
  ...
  factory ApplicationDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationDefinitionArgs(
      applicationDefinitionName: map['applicationDefinitionName'] == null ? null : pulumi.Output.create<String>(map['applicationDefinitionName'] as String),
      artifacts: map['artifacts'] == null ? null : pulumi.Output.create<List<ApplicationDefinitionArtifact>>(pulumi.Input.decodeList<ApplicationDefinitionArtifact>(map['artifacts'], (value) => ApplicationDefinitionArtifact.fromMap((value as Map).cast<String, dynamic>()))),
      authorizations: map['authorizations'] == null ? null : pulumi.Output.create<List<ApplicationAuthorization>>(pulumi.Input.decodeList<ApplicationAuthorization>(map['authorizations'], (value) => ApplicationAuthorization.fromMap((value as Map).cast<String, dynamic>()))),
      createUiDefinition: map['createUiDefinition'] == null ? null : pulumi.Output.create<dynamic>(map['createUiDefinition']),
      deploymentPolicy: map['deploymentPolicy'] == null ? null : pulumi.Output.create<ApplicationDeploymentPolicy>(ApplicationDeploymentPolicy.fromMap((map['deploymentPolicy'] as Map).cast<String, dynamic>())),
      ...
      lockLevel: pulumi.Output.create<ApplicationLockLevel>(ApplicationLockLevel.fromValue(map['lockLevel'] as String)),
      lockingPolicy: map['lockingPolicy'] == null ? null : pulumi.Output.create<ApplicationPackageLockingPolicyDefinition>(ApplicationPackageLockingPolicyDefinition.fromMap((map['lockingPolicy'] as Map).cast<String, dynamic>())),
      ...
      managementPolicy: map['managementPolicy'] == null ? null : pulumi.Output.create<ApplicationManagementPolicy>(ApplicationManagementPolicy.fromMap((map['managementPolicy'] as Map).cast<String, dynamic>())),
      notificationPolicy: map['notificationPolicy'] == null ? null : pulumi.Output.create<ApplicationNotificationPolicy>(ApplicationNotificationPolicy.fromMap((map['notificationPolicy'] as Map).cast<String, dynamic>())),
      packageFileUri: map['packageFileUri'] == null ? null : pulumi.Output.create<String>(map['packageFileUri'] as String),
      policies: map['policies'] == null ? null : pulumi.Output.create<List<ApplicationPolicy>>(pulumi.Input.decodeList<ApplicationPolicy>(map['policies'], (value) => ApplicationPolicy.fromMap((value as Map).cast<String, dynamic>()))),
