...
class GetApplicationResult {
    ...
    return <String, dynamic>{
      ...
      'authorizations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(authorizations, (value) => value.toMap()),
  ...
  factory GetApplicationResult.fromMap(Map<String, dynamic> map) {
    return GetApplicationResult(
      ...
      artifacts: pulumi.Input.decodeList<ApplicationArtifactResponse>(
        map['artifacts']!,
        (value) => ApplicationArtifactResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      authorizations: pulumi.Input.decodeList<ApplicationAuthorizationResponse>(
        map['authorizations']!,
        (value) => ApplicationAuthorizationResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      azureApiVersion: map['azureApiVersion'] as String,
      billingDetails: ApplicationBillingDetailsDefinitionResponse.fromMap(
        (map['billingDetails']! as Map).cast<String, dynamic>(),
      ),
      createdBy: ApplicationClientDetailsResponse.fromMap(
        (map['createdBy']! as Map).cast<String, dynamic>(),
      ),
      customerSupport: ApplicationPackageContactResponse.fromMap(
        (map['customerSupport']! as Map).cast<String, dynamic>(),
      ),
      id: map['id'] as String,
      identity: (() {
      ...
      jitAccessPolicy: (() {
        final guardedValue = map['jitAccessPolicy'];
        if (guardedValue == null) return null;
      ...
      managedResourceGroupId: (() {
        final guardedValue = map['managedResourceGroupId'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      ...
      supportUrls: ApplicationPackageSupportUrlsResponse.fromMap(
        (map['supportUrls']! as Map).cast<String, dynamic>(),
      ),
