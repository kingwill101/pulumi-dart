  ...
  factory GetApplicationDefinitionResult.fromMap(Map<String, dynamic> map) {
    return GetApplicationDefinitionResult(
      artifacts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ApplicationDefinitionArtifactResponse>(
          guardedValue,
          (value) => ApplicationDefinitionArtifactResponse.fromMap(
      ...
      authorizations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ApplicationAuthorizationResponse>(
          guardedValue,
      ...
      policies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ApplicationPolicyResponse>(
          guardedValue,
          (value) => ApplicationPolicyResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
