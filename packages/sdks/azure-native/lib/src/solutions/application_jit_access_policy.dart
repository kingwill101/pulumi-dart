...
class ApplicationJitAccessPolicy {
  ...
  /// JIT approval mode.
  final pulumi.Input<dynamic>? jitApprovalMode;
  /// The JIT approvers
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jitApprovers': ?pulumi.Input.mapOptionalInputValue<List<JitApproverDefinition>, List<Map<String, dynamic>>>(jitApprovers, (value) => pulumi.Input.encodeList<JitApproverDefinition, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ApplicationJitAccessPolicy.fromMap(Map<String, dynamic> map) {
    return ApplicationJitAccessPolicy(
      ...
      jitApprovalMode: (() { final guardedValue = map['jitApprovalMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      jitApprovers: (() { final guardedValue = map['jitApprovers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<JitApproverDefinition>(guardedValue, (value) => JitApproverDefinition.fromMap((value as Map).cast<String, dynamic>()))); })(),
