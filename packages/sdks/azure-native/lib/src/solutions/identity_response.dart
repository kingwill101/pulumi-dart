...
class IdentityResponse {
  ...
  final pulumi.Input<Map<String, UserAssignedResourceIdentityResponse>>?
    ...
    return <String, dynamic>{
      ...
      'userAssignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, UserAssignedResourceIdentityResponse>,
    ...
    return IdentityResponse(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<UserAssignedResourceIdentityResponse>(
            guardedValue,
            (value) => UserAssignedResourceIdentityResponse.fromMap(
