...
class ManagementGroupDetailsResponse {
  ...
  factory ManagementGroupDetailsResponse.fromMap(Map<String, dynamic> map) {
    return ManagementGroupDetailsResponse(
      managementGroupAncestors: (() { final guardedValue = map['managementGroupAncestors']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      managementGroupAncestorsChain: (() { final guardedValue = map['managementGroupAncestorsChain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagementGroupPathElementResponse>(guardedValue, (value) => ManagementGroupPathElementResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      parent: (() { final guardedValue = map['parent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParentGroupInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      path: (() { final guardedValue = map['path']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ManagementGroupPathElementResponse>(guardedValue, (value) => ManagementGroupPathElementResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
