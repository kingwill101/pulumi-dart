...
class GetServiceGroupResult {
  ...
  factory GetServiceGroupResult.fromMap(Map<String, dynamic> map) {
    return GetServiceGroupResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ServiceGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
