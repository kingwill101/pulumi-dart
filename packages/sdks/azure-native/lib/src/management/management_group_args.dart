...
class ManagementGroupArgs {
  ...
  factory ManagementGroupArgs.fromMap(Map<String, dynamic> map) {
    return ManagementGroupArgs(
      details: (() { final guardedValue = map['details']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CreateManagementGroupDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
