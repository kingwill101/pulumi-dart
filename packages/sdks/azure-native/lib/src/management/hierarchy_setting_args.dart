...
class HierarchySettingArgs {
  ...
  factory HierarchySettingArgs.fromMap(Map<String, dynamic> map) {
    return HierarchySettingArgs(
      defaultManagementGroup: (() { final guardedValue = map['defaultManagementGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      groupId: pulumi.Input.fromValue(map['groupId'] as String),
      requireAuthorizationForGroupCreation: (() { final guardedValue = map['requireAuthorizationForGroupCreation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
