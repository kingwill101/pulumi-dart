...
class CloudConnectorArgs {
  ...
  final pulumi.Input<dynamic>? cloudType;
  ...
  factory CloudConnectorArgs.fromMap(Map<String, dynamic> map) {
    return CloudConnectorArgs(
      ...
      cloudType: (() { final guardedValue = map['cloudType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
