...
class LedgerPropertiesResponse {
  ...
  final pulumi.Input<List<AADBasedSecurityPrincipalResponse>>?
  aadBasedSecurityPrincipals;

  /// Array of all cert based Security Principals.
  final pulumi.Input<List<CertBasedSecurityPrincipalResponse>>?
    ...
    return <String, dynamic>{
      'aadBasedSecurityPrincipals':
          ?pulumi.Input.mapOptionalInputValue<
            List<AADBasedSecurityPrincipalResponse>,
      ...
      'certBasedSecurityPrincipals':
          ?pulumi.Input.mapOptionalInputValue<
            List<CertBasedSecurityPrincipalResponse>,
            List<Map<String, dynamic>>
          >(
            certBasedSecurityPrincipals,
            (value) =>
    ...
    return LedgerPropertiesResponse(
      aadBasedSecurityPrincipals: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AADBasedSecurityPrincipalResponse>(
            guardedValue,
            (value) => AADBasedSecurityPrincipalResponse.fromMap(
      ...
      certBasedSecurityPrincipals: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CertBasedSecurityPrincipalResponse>(
            guardedValue,
            (value) => CertBasedSecurityPrincipalResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ledgerInternalNamespace: pulumi.Input.fromValue(
        map['ledgerInternalNamespace'] as String,
      ),
