...
class LedgerProperties {
  ...
  final pulumi.Input<List<AADBasedSecurityPrincipal>>?
  aadBasedSecurityPrincipals;

  /// Array of all cert based Security Principals.
  final pulumi.Input<List<CertBasedSecurityPrincipal>>?
    ...
    return <String, dynamic>{
      'aadBasedSecurityPrincipals':
          ?pulumi.Input.mapOptionalInputValue<
            List<AADBasedSecurityPrincipal>,
      ...
      'certBasedSecurityPrincipals':
          ?pulumi.Input.mapOptionalInputValue<
            List<CertBasedSecurityPrincipal>,
            List<Map<String, dynamic>>
          >(
            certBasedSecurityPrincipals,
            (value) =>
  ...
  factory LedgerProperties.fromMap(Map<String, dynamic> map) {
    return LedgerProperties(
      aadBasedSecurityPrincipals: (() {
        final guardedValue = map['aadBasedSecurityPrincipals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AADBasedSecurityPrincipal>(
            guardedValue,
            (value) => AADBasedSecurityPrincipal.fromMap(
      ...
      certBasedSecurityPrincipals: (() {
        final guardedValue = map['certBasedSecurityPrincipals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CertBasedSecurityPrincipal>(
            guardedValue,
            (value) => CertBasedSecurityPrincipal.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ledgerSku: (() {
        final guardedValue = map['ledgerSku'];
        if (guardedValue == null) return null;
