...
class GetLedgerResult {
  ...
  final LedgerPropertiesResponse? properties;
  ...
  factory GetLedgerResult.fromMap(Map<String, dynamic> map) {
    return GetLedgerResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return LedgerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
