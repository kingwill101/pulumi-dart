...
class MemberIdentityCertificate {
  ...
  factory MemberIdentityCertificate.fromMap(Map<String, dynamic> map) {
    return MemberIdentityCertificate(
      ...
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateTags>(guardedValue, (value) => CertificateTags.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
