...
class ManagedCCFPropertiesResponse {
  ...
  final pulumi.Input<List<MemberIdentityCertificateResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'memberIdentityCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<MemberIdentityCertificateResponse>,
    ...
    return ManagedCCFPropertiesResponse(
      ...
      deploymentType: (() {
        ...
        return pulumi.Input.fromValue(
          DeploymentTypeResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      identityServiceUri: pulumi.Input.fromValue(
        map['identityServiceUri'] as String,
      ),
      memberIdentityCertificates: (() {
        final guardedValue = map['memberIdentityCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MemberIdentityCertificateResponse>(
            guardedValue,
            (value) => MemberIdentityCertificateResponse.fromMap(
