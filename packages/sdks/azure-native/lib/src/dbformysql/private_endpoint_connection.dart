...
/// }
///
/// resource "azure-native_dbformysql_privateendpointconnection" "privateEndpointConnection" {
...
class PrivateEndpointConnection extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrivateEndpointConnection]. {@macro pulumi_dbformysql_private_endpoint_connection_args_doc}
