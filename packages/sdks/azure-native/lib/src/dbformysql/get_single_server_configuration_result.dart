...
/// Result data returned by getSingleServerConfiguration.
class GetSingleServerConfigurationResult {
  ...
  /// Creates a new [GetSingleServerConfigurationResult].
  ...
  const GetSingleServerConfigurationResult({
    this.allowedValues,
  ...
  factory GetSingleServerConfigurationResult.fromMap(Map<String, dynamic> map) {
