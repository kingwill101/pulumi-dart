...
/// }
///
/// resource "azure-native_dbformysql_singleserverdatabase" "singleServerDatabase" {
///   charset             = "utf8"
///   collation           = "utf8_general_ci"
///   database_name       = "db1"
...
class SingleServerDatabase extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SingleServerDatabase]. {@macro pulumi_dbformysql_single_server_database_args_doc}
  ...
  /// Creates a typed reference to an existing [SingleServerDatabase] resource.
  SingleServerDatabase.reference(String urn)
    : super(
        'azure-native:dbformysql:SingleServerDatabase',
