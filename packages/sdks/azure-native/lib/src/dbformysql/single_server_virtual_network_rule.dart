...
/// }
///
/// resource "azure-native_dbformysql_singleservervirtualnetworkrule" "singleServerVirtualNetworkRule" {
...
class SingleServerVirtualNetworkRule extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SingleServerVirtualNetworkRule]. {@macro pulumi_dbformysql_single_server_virtual_network_rule_args_doc}
