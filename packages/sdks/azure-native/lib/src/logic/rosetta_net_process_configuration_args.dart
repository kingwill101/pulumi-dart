...
class RosettaNetProcessConfigurationArgs {
    ...
    return <String, dynamic>{
      'activitySettings':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(activitySettings, (value) => value.toMap()),
      'description': ?description,
      'initiatorRoleSettings':
          pulumi.Input.mapInputValue<
            RosettaNetPipRoleSettings,
            Map<String, dynamic>
          >(initiatorRoleSettings, (value) => value.toMap()),
      ...
      'responderRoleSettings':
          pulumi.Input.mapInputValue<
            RosettaNetPipRoleSettings,
            Map<String, dynamic>
          >(responderRoleSettings, (value) => value.toMap()),
  ...
  factory RosettaNetProcessConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RosettaNetProcessConfigurationArgs(
      activitySettings: pulumi.Input.fromValue(
        RosettaNetPipActivitySettings.fromMap(
          (map['activitySettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      description: (() {
      ...
      initiatorRoleSettings: pulumi.Input.fromValue(
        RosettaNetPipRoleSettings.fromMap(
          (map['initiatorRoleSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      responderRoleSettings: pulumi.Input.fromValue(
        RosettaNetPipRoleSettings.fromMap(
          (map['responderRoleSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      rosettaNetProcessConfigurationName: (() {
        final guardedValue = map['rosettaNetProcessConfigurationName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
