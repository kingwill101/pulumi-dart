...
class X12ProtocolSettingsResponse {
  ...
  final pulumi.Input<X12AcknowledgementSettingsResponse>
  ...
  final pulumi.Input<List<X12DelimiterOverridesResponse>>?
    ...
    return <String, dynamic>{
      ...
      'envelopeOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<X12EnvelopeOverrideResponse>,
      ...
      'framingSettings':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(framingSettings, (value) => value.toMap()),
      'messageFilter':
          pulumi.Input.mapInputValue<
            X12MessageFilterResponse,
            Map<String, dynamic>
          >(messageFilter, (value) => value.toMap()),
      'messageFilterList':
          ?pulumi.Input.mapOptionalInputValue<
            List<X12MessageIdentifierResponse>,
            List<Map<String, dynamic>>
          >(
            messageFilterList,
            (value) =>
      ...
      'validationOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<X12ValidationOverrideResponse>,
            List<Map<String, dynamic>>
          >(
            validationOverrides,
            (value) =>
      ...
      'x12DelimiterOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<X12DelimiterOverridesResponse>,
            List<Map<String, dynamic>>
          >(
            x12DelimiterOverrides,
            (value) =>
  ...
  factory X12ProtocolSettingsResponse.fromMap(Map<String, dynamic> map) {
    return X12ProtocolSettingsResponse(
      acknowledgementSettings: pulumi.Input.fromValue(
        X12AcknowledgementSettingsResponse.fromMap(
      ...
      envelopeOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<X12EnvelopeOverrideResponse>(
            guardedValue,
            (value) => X12EnvelopeOverrideResponse.fromMap(
      ...
      messageFilterList: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<X12MessageIdentifierResponse>(
            guardedValue,
            (value) => X12MessageIdentifierResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      processingSettings: pulumi.Input.fromValue(
        X12ProcessingSettingsResponse.fromMap(
          (map['processingSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      schemaReferences: pulumi.Input.fromValue(
        pulumi.Input.decodeList<X12SchemaReferenceResponse>(
          map['schemaReferences']!,
          (value) => X12SchemaReferenceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      securitySettings: pulumi.Input.fromValue(
        X12SecuritySettingsResponse.fromMap(
      ...
      validationOverrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<X12ValidationOverrideResponse>(
            guardedValue,
            (value) => X12ValidationOverrideResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      validationSettings: pulumi.Input.fromValue(
        X12ValidationSettingsResponse.fromMap(
      ...
      x12DelimiterOverrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<X12DelimiterOverridesResponse>(
            guardedValue,
            (value) => X12DelimiterOverridesResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
