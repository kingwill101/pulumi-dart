...
class AS2ProtocolSettings {
  ...
  final pulumi.Input<AS2AcknowledgementConnectionSettings>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'envelopeSettings':
          pulumi.Input.mapInputValue<AS2EnvelopeSettings, Map<String, dynamic>>(
            envelopeSettings,
            (value) => value.toMap(),
          ),
      'errorSettings':
          pulumi.Input.mapInputValue<AS2ErrorSettings, Map<String, dynamic>>(
            errorSettings,
            (value) => value.toMap(),
          ),
      'mdnSettings':
          pulumi.Input.mapInputValue<AS2MdnSettings, Map<String, dynamic>>(
            mdnSettings,
            (value) => value.toMap(),
          ),
      ...
      'securitySettings':
          pulumi.Input.mapInputValue<AS2SecuritySettings, Map<String, dynamic>>(
            securitySettings,
            (value) => value.toMap(),
          ),
      'validationSettings':
