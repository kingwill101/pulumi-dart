...
/// Result data returned by listWorkflowTriggerCallbackUrl.
class ListWorkflowTriggerCallbackUrlResult {
  ...
  /// Creates a new [ListWorkflowTriggerCallbackUrlResult].
  ...
  const ListWorkflowTriggerCallbackUrlResult({
  ...
  factory ListWorkflowTriggerCallbackUrlResult.fromMap(Map<String, dynamic> map) {
