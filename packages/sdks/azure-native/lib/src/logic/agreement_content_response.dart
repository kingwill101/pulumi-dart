...
class AgreementContentResponse {
  ...
  const AgreementContentResponse({
    this.aS2,
    this.edifact,
    this.x12,
  });
  ...
  factory AgreementContentResponse.fromMap(Map<String, dynamic> map) {
    return AgreementContentResponse(
      aS2: (() { final guardedValue = map['aS2']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AS2AgreementContentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      edifact: (() { final guardedValue = map['edifact']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EdifactAgreementContentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      x12: (() { final guardedValue = map['x12']; if (guardedValue == null) return null; return pulumi.Input.fromValue(X12AgreementContentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
