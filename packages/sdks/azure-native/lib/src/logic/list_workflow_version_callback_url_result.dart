...
/// Result data returned by listWorkflowVersionCallbackUrl.
class ListWorkflowVersionCallbackUrlResult {
  ...
  /// Creates a new [ListWorkflowVersionCallbackUrlResult].
  ...
  factory ListWorkflowVersionCallbackUrlResult.fromMap(
