...
/// Result data returned by listIntegrationAccountMapContentCallbackUrl.
class ListIntegrationAccountMapContentCallbackUrlResult {
  ...
  /// Creates a new [ListIntegrationAccountMapContentCallbackUrlResult].
  ...
  const ListIntegrationAccountMapContentCallbackUrlResult({
  ...
  factory ListIntegrationAccountMapContentCallbackUrlResult.fromMap(Map<String, dynamic> map) {
