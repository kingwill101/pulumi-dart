...
class X12ProtocolSettings {
  ...
  factory X12ProtocolSettings.fromMap(Map<String, dynamic> map) {
    return X12ProtocolSettings(
      acknowledgementSettings: pulumi.Input.fromValue(X12AcknowledgementSettings.fromMap((map['acknowledgementSettings']! as Map).cast<String, dynamic>())),
      envelopeOverrides: (() { final guardedValue = map['envelopeOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<X12EnvelopeOverride>(guardedValue, (value) => X12EnvelopeOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
      envelopeSettings: pulumi.Input.fromValue(X12EnvelopeSettings.fromMap((map['envelopeSettings']! as Map).cast<String, dynamic>())),
      framingSettings: pulumi.Input.fromValue(X12FramingSettings.fromMap((map['framingSettings']! as Map).cast<String, dynamic>())),
      messageFilter: pulumi.Input.fromValue(X12MessageFilter.fromMap((map['messageFilter']! as Map).cast<String, dynamic>())),
      messageFilterList: (() { final guardedValue = map['messageFilterList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<X12MessageIdentifier>(guardedValue, (value) => X12MessageIdentifier.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processingSettings: pulumi.Input.fromValue(X12ProcessingSettings.fromMap((map['processingSettings']! as Map).cast<String, dynamic>())),
      schemaReferences: pulumi.Input.fromValue(pulumi.Input.decodeList<X12SchemaReference>(map['schemaReferences']!, (value) => X12SchemaReference.fromMap((value as Map).cast<String, dynamic>()))),
      securitySettings: pulumi.Input.fromValue(X12SecuritySettings.fromMap((map['securitySettings']! as Map).cast<String, dynamic>())),
      validationOverrides: (() { final guardedValue = map['validationOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<X12ValidationOverride>(guardedValue, (value) => X12ValidationOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
      validationSettings: pulumi.Input.fromValue(X12ValidationSettings.fromMap((map['validationSettings']! as Map).cast<String, dynamic>())),
      x12DelimiterOverrides: (() { final guardedValue = map['x12DelimiterOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<X12DelimiterOverrides>(guardedValue, (value) => X12DelimiterOverrides.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
