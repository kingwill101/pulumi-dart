...
class IntegrationAccountAgreementArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'agreementType': pulumi.Input.mapInputValue<AgreementType, String>(agreementType, (value) => value.wireValue),
  ...
  factory IntegrationAccountAgreementArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationAccountAgreementArgs(
      agreementName: (() { final guardedValue = map['agreementName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      agreementType: pulumi.Input.fromValue(AgreementType.fromValue(map['agreementType']! as String)),
      content: pulumi.Input.fromValue(AgreementContent.fromMap((map['content']! as Map).cast<String, dynamic>())),
      guestIdentity: pulumi.Input.fromValue(BusinessIdentity.fromMap((map['guestIdentity']! as Map).cast<String, dynamic>())),
      guestPartner: pulumi.Input.fromValue(map['guestPartner'] as String),
      hostIdentity: pulumi.Input.fromValue(BusinessIdentity.fromMap((map['hostIdentity']! as Map).cast<String, dynamic>())),
