...
class AS2ProtocolSettingsResponse {
  ...
  const AS2ProtocolSettingsResponse({
  ...
  factory AS2ProtocolSettingsResponse.fromMap(Map<String, dynamic> map) {
    return AS2ProtocolSettingsResponse(
      acknowledgementConnectionSettings: pulumi.Input.fromValue(AS2AcknowledgementConnectionSettingsResponse.fromMap((map['acknowledgementConnectionSettings']! as Map).cast<String, dynamic>())),
      envelopeSettings: pulumi.Input.fromValue(AS2EnvelopeSettingsResponse.fromMap((map['envelopeSettings']! as Map).cast<String, dynamic>())),
      errorSettings: pulumi.Input.fromValue(AS2ErrorSettingsResponse.fromMap((map['errorSettings']! as Map).cast<String, dynamic>())),
      mdnSettings: pulumi.Input.fromValue(AS2MdnSettingsResponse.fromMap((map['mdnSettings']! as Map).cast<String, dynamic>())),
      messageConnectionSettings: pulumi.Input.fromValue(AS2MessageConnectionSettingsResponse.fromMap((map['messageConnectionSettings']! as Map).cast<String, dynamic>())),
      securitySettings: pulumi.Input.fromValue(AS2SecuritySettingsResponse.fromMap((map['securitySettings']! as Map).cast<String, dynamic>())),
      validationSettings: pulumi.Input.fromValue(AS2ValidationSettingsResponse.fromMap((map['validationSettings']! as Map).cast<String, dynamic>())),
    );
  }
}
