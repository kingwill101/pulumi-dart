...
class IntegrationServiceEnvironmentPropertiesResponse {
  ...
  final pulumi.Input<FlowEndpointsConfigurationResponse>?
    ...
    return <String, dynamic>{
      ...
      'endpointsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(endpointsConfiguration, (value) => value.toMap()),
  ...
  factory IntegrationServiceEnvironmentPropertiesResponse.fromMap(
    ...
    return IntegrationServiceEnvironmentPropertiesResponse(
      encryptionConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          IntegrationServiceEnvironmenEncryptionConfigurationResponse.fromMap(
      ...
      endpointsConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowEndpointsConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
