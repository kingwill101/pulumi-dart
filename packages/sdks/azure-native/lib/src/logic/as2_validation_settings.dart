...
class AS2ValidationSettings {
  ...
  factory AS2ValidationSettings.fromMap(Map<String, dynamic> map) {
    return AS2ValidationSettings(
      checkCertificateRevocationListOnReceive: pulumi.Input.fromValue(
        map['checkCertificateRevocationListOnReceive'] as bool,
      ),
      checkCertificateRevocationListOnSend: pulumi.Input.fromValue(
        map['checkCertificateRevocationListOnSend'] as bool,
      ),
      checkDuplicateMessage: pulumi.Input.fromValue(
        map['checkDuplicateMessage'] as bool,
      ),
      ...
      interchangeDuplicatesValidityDays: pulumi.Input.fromValue(
        map['interchangeDuplicatesValidityDays'] as int,
      ),
      overrideMessageProperties: pulumi.Input.fromValue(
        map['overrideMessageProperties'] as bool,
      ),
