...
class ApiResourceMetadataResponse {
  ...
  final pulumi.Input<ApiDeploymentParameterMetadataSetResponse>?
    ...
    return ApiResourceMetadataResponse(
      ...
      deploymentParameters: (() {
        ...
        return pulumi.Input.fromValue(
          ApiDeploymentParameterMetadataSetResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hideKey: (() {
        final guardedValue = map['hideKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      provisioningState: (() {
      ...
      wsdlImportMethod: (() {
        final guardedValue = map['wsdlImportMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      wsdlService: (() {
        final guardedValue = map['wsdlService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
