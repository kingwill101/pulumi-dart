...
class GetRosettaNetProcessConfigurationResult {
  ...
  factory GetRosettaNetProcessConfigurationResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetRosettaNetProcessConfigurationResult(
      activitySettings: RosettaNetPipActivitySettingsResponse.fromMap(
      ...
      id: map['id'] as String,
      initiatorRoleSettings: RosettaNetPipRoleSettingsResponse.fromMap(
      ...
      responderRoleSettings: RosettaNetPipRoleSettingsResponse.fromMap(
