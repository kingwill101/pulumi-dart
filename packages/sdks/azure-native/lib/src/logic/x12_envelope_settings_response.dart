...
class X12EnvelopeSettingsResponse {
  ...
  factory X12EnvelopeSettingsResponse.fromMap(Map<String, dynamic> map) {
    return X12EnvelopeSettingsResponse(
      controlStandardsId: pulumi.Input.fromValue(
        map['controlStandardsId'] as int,
      ),
      controlVersionNumber: pulumi.Input.fromValue(
        map['controlVersionNumber'] as String,
      ),
      ...
      groupControlNumberLowerBound: pulumi.Input.fromValue(
        map['groupControlNumberLowerBound'] as int,
      ),
      groupControlNumberUpperBound: pulumi.Input.fromValue(
        map['groupControlNumberUpperBound'] as int,
      ),
      groupHeaderAgencyCode: pulumi.Input.fromValue(
        map['groupHeaderAgencyCode'] as String,
      ),
      groupHeaderDateFormat: pulumi.Input.fromValue(
        map['groupHeaderDateFormat'] as String,
      ),
      groupHeaderTimeFormat: pulumi.Input.fromValue(
        map['groupHeaderTimeFormat'] as String,
      ),
      groupHeaderVersion: pulumi.Input.fromValue(
        map['groupHeaderVersion'] as String,
      ),
      interchangeControlNumberLowerBound: pulumi.Input.fromValue(
        map['interchangeControlNumberLowerBound'] as int,
      ),
      interchangeControlNumberUpperBound: pulumi.Input.fromValue(
        map['interchangeControlNumberUpperBound'] as int,
      ),
      ...
      transactionSetControlNumberLowerBound: pulumi.Input.fromValue(
        map['transactionSetControlNumberLowerBound'] as int,
      ),
      ...
      transactionSetControlNumberUpperBound: pulumi.Input.fromValue(
        map['transactionSetControlNumberUpperBound'] as int,
      ),
      usageIndicator: pulumi.Input.fromValue(map['usageIndicator'] as String),
      useControlStandardsIdAsRepetitionCharacter: pulumi.Input.fromValue(
        map['useControlStandardsIdAsRepetitionCharacter'] as bool,
      ),
    );
  }
}
