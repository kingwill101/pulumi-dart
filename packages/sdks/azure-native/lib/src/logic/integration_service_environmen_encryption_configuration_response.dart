...
class IntegrationServiceEnvironmenEncryptionConfigurationResponse {
  ...
  const IntegrationServiceEnvironmenEncryptionConfigurationResponse({
  ...
  factory IntegrationServiceEnvironmenEncryptionConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return IntegrationServiceEnvironmenEncryptionConfigurationResponse(
      encryptionKeyReference: (() { final guardedValue = map['encryptionKeyReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntegrationServiceEnvironmenEncryptionKeyReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
