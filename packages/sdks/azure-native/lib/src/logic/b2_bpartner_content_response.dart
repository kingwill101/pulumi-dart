...
class B2BPartnerContentResponse {
  ...
  B2BPartnerContentResponse({this.businessIdentities});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'businessIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            List<BusinessIdentityResponse>,
    ...
    return B2BPartnerContentResponse(
      businessIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BusinessIdentityResponse>(
            guardedValue,
            (value) => BusinessIdentityResponse.fromMap(
