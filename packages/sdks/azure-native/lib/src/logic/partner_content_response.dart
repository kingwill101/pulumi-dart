...
class PartnerContentResponse {
  ...
  factory PartnerContentResponse.fromMap(Map<String, dynamic> map) {
    return PartnerContentResponse(
      b2b: (() { final guardedValue = map['b2b']; if (guardedValue == null) return null; return pulumi.Input.fromValue(B2BPartnerContentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
