...
class EdifactProtocolSettingsResponse {
  ...
  final pulumi.Input<EdifactAcknowledgementSettingsResponse>
  acknowledgementSettings;

  /// The EDIFACT delimiter override settings.
  final pulumi.Input<List<EdifactDelimiterOverrideResponse>>?
  ...
  final pulumi.Input<List<EdifactValidationOverrideResponse>>?
  validationOverrides;
    ...
    return <String, dynamic>{
      ...
      'edifactDelimiterOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<EdifactDelimiterOverrideResponse>,
      ...
      'envelopeOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<EdifactEnvelopeOverrideResponse>,
            List<Map<String, dynamic>>
          >(
            envelopeOverrides,
            (value) =>
      ...
      'messageFilterList':
          ?pulumi.Input.mapOptionalInputValue<
            List<EdifactMessageIdentifierResponse>,
            List<Map<String, dynamic>>
          >(
            messageFilterList,
            (value) =>
      ...
      'schemaReferences':
          pulumi.Input.mapInputValue<
            List<EdifactSchemaReferenceResponse>,
            List<Map<String, dynamic>>
          >(
            schemaReferences,
            (value) =>
      ...
      'validationOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<EdifactValidationOverrideResponse>,
            List<Map<String, dynamic>>
          >(
            validationOverrides,
            (value) =>
  ...
  factory EdifactProtocolSettingsResponse.fromMap(Map<String, dynamic> map) {
    return EdifactProtocolSettingsResponse(
      acknowledgementSettings: pulumi.Input.fromValue(
        EdifactAcknowledgementSettingsResponse.fromMap(
          (map['acknowledgementSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      edifactDelimiterOverrides: (() {
        final guardedValue = map['edifactDelimiterOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EdifactDelimiterOverrideResponse>(
            guardedValue,
            (value) => EdifactDelimiterOverrideResponse.fromMap(
      ...
      envelopeOverrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EdifactEnvelopeOverrideResponse>(
            guardedValue,
            (value) => EdifactEnvelopeOverrideResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      messageFilterList: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EdifactMessageIdentifierResponse>(
            guardedValue,
            (value) => EdifactMessageIdentifierResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      processingSettings: pulumi.Input.fromValue(
        EdifactProcessingSettingsResponse.fromMap(
          (map['processingSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      schemaReferences: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EdifactSchemaReferenceResponse>(
          map['schemaReferences']!,
          (value) => EdifactSchemaReferenceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      validationOverrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EdifactValidationOverrideResponse>(
            guardedValue,
            (value) => EdifactValidationOverrideResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      validationSettings: pulumi.Input.fromValue(
        EdifactValidationSettingsResponse.fromMap(
