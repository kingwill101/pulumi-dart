...
class FlowAccessControlConfigurationPolicy {
  ...
  final pulumi.Input<OpenAuthenticationAccessPolicies>?
    ...
    return <String, dynamic>{
      'allowedCallerIpAddresses':
          ...
          >(
            allowedCallerIpAddresses,
            (value) =>
                pulumi.Input.encodeList<IpAddressRange, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'openAuthenticationPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(openAuthenticationPolicies, (value) => value.toMap()),
    };
  }

  factory FlowAccessControlConfigurationPolicy.fromMap(
    Map<String, dynamic> map,
  ) {
    return FlowAccessControlConfigurationPolicy(
      allowedCallerIpAddresses: (() {
        final guardedValue = map['allowedCallerIpAddresses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpAddressRange>(
            guardedValue,
            (value) =>
                IpAddressRange.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      openAuthenticationPolicies: (() {
        final guardedValue = map['openAuthenticationPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OpenAuthenticationAccessPolicies.fromMap(
