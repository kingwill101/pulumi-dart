...
class RosettaNetPipActivitySettings {
  ...
  final pulumi.Input<RosettaNetPipAcknowledgmentOfReceiptSettings>
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'activityType':
          pulumi.Input.mapInputValue<RosettaNetPipActivityType, String>(
            activityType,
  ...
  factory RosettaNetPipActivitySettings.fromMap(Map<String, dynamic> map) {
    return RosettaNetPipActivitySettings(
      acknowledgmentOfReceiptSettings: pulumi.Input.fromValue(
        RosettaNetPipAcknowledgmentOfReceiptSettings.fromMap(
          (map['acknowledgmentOfReceiptSettings']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      activityBehavior: pulumi.Input.fromValue(
        RosettaNetPipActivityBehavior.fromMap(
          (map['activityBehavior']! as Map).cast<String, dynamic>(),
        ),
      ),
      activityType: pulumi.Input.fromValue(
        RosettaNetPipActivityType.fromValue(map['activityType']! as String),
      ),
    );
  }
}
