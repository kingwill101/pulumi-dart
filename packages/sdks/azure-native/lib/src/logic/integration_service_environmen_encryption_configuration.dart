...
class IntegrationServiceEnvironmenEncryptionConfiguration {
  ...
  final pulumi.Input<IntegrationServiceEnvironmenEncryptionKeyReference>?
  ...
  factory IntegrationServiceEnvironmenEncryptionConfiguration.fromMap(
    ...
    return IntegrationServiceEnvironmenEncryptionConfiguration(
      encryptionKeyReference: (() {
        ...
        return pulumi.Input.fromValue(
          IntegrationServiceEnvironmenEncryptionKeyReference.fromMap(
