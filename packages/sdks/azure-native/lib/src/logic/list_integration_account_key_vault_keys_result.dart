...
class ListIntegrationAccountKeyVaultKeysResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'skipToken': ?skipToken,
      'value': ?(() { final guardedValue = value; if (guardedValue == null) return null; return pulumi.Input.encodeList<KeyVaultKeyResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory ListIntegrationAccountKeyVaultKeysResult.fromMap(Map<String, dynamic> map) {
    return ListIntegrationAccountKeyVaultKeysResult(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.decodeList<KeyVaultKeyResponse>(guardedValue, (value) => KeyVaultKeyResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
