...
class ListIntegrationAccountAgreementContentCallbackUrlResult {
  ...
  const ListIntegrationAccountAgreementContentCallbackUrlResult({
    this.basePath,
    this.method,
    this.queries,
    this.relativePath,
  ...
  factory ListIntegrationAccountAgreementContentCallbackUrlResult.fromMap(Map<String, dynamic> map) {
