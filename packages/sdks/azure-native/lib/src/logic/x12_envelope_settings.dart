...
class X12EnvelopeSettings {
  ...
  final pulumi.Input<dynamic> groupHeaderDateFormat;
  /// The group header time format.
  final pulumi.Input<dynamic> groupHeaderTimeFormat;
  ...
  /// The usage indicator.
  final pulumi.Input<dynamic> usageIndicator;
  ...
  factory X12EnvelopeSettings.fromMap(Map<String, dynamic> map) {
    return X12EnvelopeSettings(
      ...
      groupHeaderDateFormat: pulumi.Input.fromValue(map['groupHeaderDateFormat']),
      groupHeaderTimeFormat: pulumi.Input.fromValue(map['groupHeaderTimeFormat']),
      ...
      usageIndicator: pulumi.Input.fromValue(map['usageIndicator']),
