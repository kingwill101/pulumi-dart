...
class GetServerEndpointResult {
  ...
  final ServerEndpointProvisioningStatusResponse?
  ...
  factory GetServerEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetServerEndpointResult(
      ...
      cloudTieringStatus: ServerEndpointCloudTieringStatusResponse.fromMap(
        (map['cloudTieringStatus']! as Map).cast<String, dynamic>(),
      ),
      friendlyName: (() {
      ...
      offlineDataTransferStorageAccountResourceId:
          map['offlineDataTransferStorageAccountResourceId'] as String,
      offlineDataTransferStorageAccountTenantId:
          map['offlineDataTransferStorageAccountTenantId'] as String,
      provisioningState: map['provisioningState'] as String,
      recallStatus: ServerEndpointRecallStatusResponse.fromMap(
        (map['recallStatus']! as Map).cast<String, dynamic>(),
      ),
      serverEndpointProvisioningStatus: (() {
        final guardedValue = map['serverEndpointProvisioningStatus'];
        if (guardedValue == null) return null;
      ...
      syncStatus: ServerEndpointSyncStatusResponse.fromMap(
