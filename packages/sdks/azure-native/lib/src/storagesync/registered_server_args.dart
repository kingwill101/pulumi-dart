...
class RegisteredServerArgs {
  ...
  factory RegisteredServerArgs.fromMap(Map<String, dynamic> map) {
    return RegisteredServerArgs(
      ...
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      serverOSVersion: (() { final guardedValue = map['serverOSVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
