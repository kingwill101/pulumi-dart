...
class ServerEndpointArgs {
  ...
  ServerEndpointArgs({
    pulumi.Output<String>? cloudTiering,
    pulumi.Output<String>? friendlyName,
    pulumi.Output<String>? initialDownloadPolicy,
    pulumi.Output<String>? initialUploadPolicy,
    pulumi.Output<String>? localCacheMode,
    pulumi.Output<String>? offlineDataTransfer,
    pulumi.Output<String>? offlineDataTransferShareName,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? serverEndpointName,
    pulumi.Output<String>? serverLocalPath,
    pulumi.Output<String>? serverResourceId,
  ...
  factory ServerEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ServerEndpointArgs(
      cloudTiering: map['cloudTiering'] == null ? null : pulumi.Output.create<String>(map['cloudTiering'] as String),
      ...
      initialUploadPolicy: map['initialUploadPolicy'] == null ? null : pulumi.Output.create<String>(map['initialUploadPolicy'] as String),
      localCacheMode: map['localCacheMode'] == null ? null : pulumi.Output.create<String>(map['localCacheMode'] as String),
      offlineDataTransfer: map['offlineDataTransfer'] == null ? null : pulumi.Output.create<String>(map['offlineDataTransfer'] as String),
      offlineDataTransferShareName: map['offlineDataTransferShareName'] == null ? null : pulumi.Output.create<String>(map['offlineDataTransferShareName'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      serverEndpointName: map['serverEndpointName'] == null ? null : pulumi.Output.create<String>(map['serverEndpointName'] as String),
      serverLocalPath: map['serverLocalPath'] == null ? null : pulumi.Output.create<String>(map['serverLocalPath'] as String),
      serverResourceId: map['serverResourceId'] == null ? null : pulumi.Output.create<String>(map['serverResourceId'] as String),
