    ...
    return PeeringPropertiesDirectResponse(
      connections: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DirectConnectionResponse>(
            guardedValue,
            (value) => DirectConnectionResponse.fromMap(
      ...
      directPeeringType: (() {
        final guardedValue = map['directPeeringType'];
        if (guardedValue == null) return null;
      ...
      useForPeeringService: pulumi.Input.fromValue(
        map['useForPeeringService'] as bool,
      ),
    );
  }
}
