...
class PeeringServiceArgs {
  ...
  factory PeeringServiceArgs.fromMap(Map<String, dynamic> map) {
    return PeeringServiceArgs(
      ...
      peeringServiceLocation: (() { final guardedValue = map['peeringServiceLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      peeringServiceName: (() { final guardedValue = map['peeringServiceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      peeringServiceProvider: (() { final guardedValue = map['peeringServiceProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      providerBackupPeeringLocation: (() { final guardedValue = map['providerBackupPeeringLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      providerPrimaryPeeringLocation: (() { final guardedValue = map['providerPrimaryPeeringLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      sku: (() { final guardedValue = map['sku']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PeeringServiceSku.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
