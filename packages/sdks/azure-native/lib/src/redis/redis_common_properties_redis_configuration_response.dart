...
class RedisCommonPropertiesRedisConfigurationResponse {
  ...
  factory RedisCommonPropertiesRedisConfigurationResponse.fromMap(
    ...
    return RedisCommonPropertiesRedisConfigurationResponse(
      ...
      preferredDataArchiveAuthMethod: pulumi.Input.fromValue(
        map['preferredDataArchiveAuthMethod'] as String,
      ),
      ...
      zonalConfiguration: pulumi.Input.fromValue(
        map['zonalConfiguration'] as String,
      ),
    );
  }
}
