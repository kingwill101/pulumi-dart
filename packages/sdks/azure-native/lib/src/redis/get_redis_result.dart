...
class GetRedisResult {
    ...
    return <String, dynamic>{
      ...
      'linkedServers':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(linkedServers, (value) => value.toMap()),
      'location': location,
  ...
  factory GetRedisResult.fromMap(Map<String, dynamic> map) {
    return GetRedisResult(
      accessKeys: RedisAccessKeysResponse.fromMap(
        (map['accessKeys']! as Map).cast<String, dynamic>(),
      ),
      azureApiVersion: map['azureApiVersion'] as String,
      disableAccessKeyAuthentication: (() {
        final guardedValue = map['disableAccessKeyAuthentication'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      enableNonSslPort: (() {
        final guardedValue = map['enableNonSslPort'];
        if (guardedValue == null) return null;
        return guardedValue as bool;
      })(),
      ...
      instances: pulumi.Input.decodeList<RedisInstanceDetailsResponse>(
        map['instances']!,
        (value) => RedisInstanceDetailsResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      linkedServers: pulumi.Input.decodeList<RedisLinkedServerResponse>(
        map['linkedServers']!,
        (value) => RedisLinkedServerResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      ...
      updateChannel: (() {
        final guardedValue = map['updateChannel'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      zonalAllocationPolicy: (() {
        final guardedValue = map['zonalAllocationPolicy'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      zones: (() {
