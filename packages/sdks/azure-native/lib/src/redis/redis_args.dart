...
class RedisArgs {
  ...
  factory RedisArgs.fromMap(Map<String, dynamic> map) {
    return RedisArgs(
      disableAccessKeyAuthentication: map['disableAccessKeyAuthentication'] == null ? null : (map['disableAccessKeyAuthentication'] as bool).input(),
      enableNonSslPort: map['enableNonSslPort'] == null ? null : (map['enableNonSslPort'] as bool).input(),
      ...
      redisConfiguration: map['redisConfiguration'] == null ? null : (RedisCommonPropertiesRedisConfiguration.fromMap((map['redisConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      updateChannel: map['updateChannel'] == null ? null : (map['updateChannel'] as String).input(),
      zonalAllocationPolicy: map['zonalAllocationPolicy'] == null ? null : (map['zonalAllocationPolicy'] as String).input(),
