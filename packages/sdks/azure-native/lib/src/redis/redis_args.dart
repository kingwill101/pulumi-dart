...
class RedisArgs {
  ...
  RedisArgs({
    pulumi.Input<bool?>? disableAccessKeyAuthentication,
    pulumi.Input<bool?>? enableNonSslPort,
    this.identity,
    this.location,
    ...
    this.zones,
  }) : disableAccessKeyAuthentication = disableAccessKeyAuthentication ?? pulumi.Input.fromValue(false), enableNonSslPort = enableNonSslPort ?? pulumi.Input.fromValue(false);
  ...
  factory RedisArgs.fromMap(Map<String, dynamic> map) {
    return RedisArgs(
      ...
      replicasPerMaster: (() { final guardedValue = map['replicasPerMaster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      replicasPerPrimary: (() { final guardedValue = map['replicasPerPrimary']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      updateChannel: (() { final guardedValue = map['updateChannel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      zonalAllocationPolicy: (() { final guardedValue = map['zonalAllocationPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
