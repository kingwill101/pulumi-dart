...
/// }
///
/// resource "azure-native_storagemover_storagemover" "storageMover" {
///   description         = "Example Storage Mover Description"
///   location            = "eastus2"
...
class StorageMover extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [StorageMover] resource.
  StorageMover.reference(String urn)
    : super(
        'azure-native:storagemover:StorageMover',
