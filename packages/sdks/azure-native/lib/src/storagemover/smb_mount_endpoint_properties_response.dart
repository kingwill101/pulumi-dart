...
class SmbMountEndpointPropertiesResponse {
  ...
  factory SmbMountEndpointPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SmbMountEndpointPropertiesResponse(
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSmbCredentialsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
