...
class UploadLimitScheduleResponse {
  ...
  final pulumi.Input<List<UploadLimitWeeklyRecurrenceResponse>>?
  weeklyRecurrences;
  ...
  UploadLimitScheduleResponse({this.weeklyRecurrences});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'weeklyRecurrences':
          ?pulumi.Input.mapOptionalInputValue<
            List<UploadLimitWeeklyRecurrenceResponse>,
    ...
    return UploadLimitScheduleResponse(
      weeklyRecurrences: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UploadLimitWeeklyRecurrenceResponse>(
            guardedValue,
            (value) => UploadLimitWeeklyRecurrenceResponse.fromMap(
