...
class Endpoint extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AzureStorageBlobContainerEndpointPropertiesResponse>
  properties;
  ...
  Endpoint(
    ...
    properties =
        registerOutput<AzureStorageBlobContainerEndpointPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return AzureStorageBlobContainerEndpointPropertiesResponse.fromMap(
