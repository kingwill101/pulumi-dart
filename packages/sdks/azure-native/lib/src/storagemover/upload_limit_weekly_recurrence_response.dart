...
class UploadLimitWeeklyRecurrenceResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'days': days,
      'endTime': pulumi.Input.mapInputValue<TimeResponse, Map<String, dynamic>>(
        endTime,
        (value) => value.toMap(),
      ),
      'limitInMbps': limitInMbps,
      'startTime':
          pulumi.Input.mapInputValue<TimeResponse, Map<String, dynamic>>(
            startTime,
            (value) => value.toMap(),
          ),
    };
  ...
  factory UploadLimitWeeklyRecurrenceResponse.fromMap(
