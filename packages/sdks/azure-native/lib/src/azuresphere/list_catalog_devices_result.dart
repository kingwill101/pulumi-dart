...
class ListCatalogDevicesResult {
  ...
  ListCatalogDevicesResult({this.nextLink, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': ?nextLink,
      'value': pulumi.Input.encodeList<DeviceResponse, Map<String, dynamic>>(
        value,
        (value) => value.toMap(),
      ),
    };
  ...
  factory ListCatalogDevicesResult.fromMap(Map<String, dynamic> map) {
    return ListCatalogDevicesResult(
      ...
      value: pulumi.Input.decodeList<DeviceResponse>(
        map['value']!,
        (value) =>
