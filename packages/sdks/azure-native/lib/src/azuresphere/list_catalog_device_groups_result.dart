...
class ListCatalogDeviceGroupsResult {
  ...
  ListCatalogDeviceGroupsResult({this.nextLink, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': ?nextLink,
      'value':
          pulumi.Input.encodeList<DeviceGroupResponse, Map<String, dynamic>>(
            value,
            (value) => value.toMap(),
          ),
    };
  ...
  factory ListCatalogDeviceGroupsResult.fromMap(Map<String, dynamic> map) {
    return ListCatalogDeviceGroupsResult(
      ...
      value: pulumi.Input.decodeList<DeviceGroupResponse>(
        map['value']!,
        (value) =>
            DeviceGroupResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
    );
  }
}
