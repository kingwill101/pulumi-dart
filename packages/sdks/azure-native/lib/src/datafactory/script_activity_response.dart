...
class ScriptActivityResponse {
  ...
  final pulumi.Input<ScriptActivityTypePropertiesResponseLogSettings>?
  logSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scripts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScriptActivityScriptBlockResponse>,
            List<Map<String, dynamic>>
          >(
            scripts,
            (value) =>
  ...
  factory ScriptActivityResponse.fromMap(Map<String, dynamic> map) {
    return ScriptActivityResponse(
      ...
      logSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScriptActivityTypePropertiesResponseLogSettings.fromMap(
      ...
      returnMultistatementResult: (() {
        final guardedValue = map['returnMultistatementResult'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      scriptBlockExecutionTimeout: (() {
        final guardedValue = map['scriptBlockExecutionTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      scripts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScriptActivityScriptBlockResponse>(
            guardedValue,
            (value) => ScriptActivityScriptBlockResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      treatDecimalAsString: (() {
        final guardedValue = map['treatDecimalAsString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
