...
class MapperAttributeMappings {
  ...
  MapperAttributeMappings({this.attributeMappings});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attributeMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<MapperAttributeMapping>,
    ...
    return MapperAttributeMappings(
      attributeMappings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MapperAttributeMapping>(
            guardedValue,
            (value) => MapperAttributeMapping.fromMap(
