...
class SSISPropertyOverrideResponse {
  ...
  SSISPropertyOverrideResponse({this.isSensitive, required this.value});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'isSensitive': ?isSensitive, 'value': value};
  }

  factory SSISPropertyOverrideResponse.fromMap(Map<String, dynamic> map) {
    return SSISPropertyOverrideResponse(
      isSensitive: (() {
        final guardedValue = map['isSensitive'];
