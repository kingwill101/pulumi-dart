...
class SqlServerTableDataset {
  ...
  /// Creates a new [SqlServerTableDataset].
  ...
  factory SqlServerTableDataset.fromMap(Map<String, dynamic> map) {
    return SqlServerTableDataset(
