...
class DrillTableDatasetResponse {
  ...
  /// Creates a new [DrillTableDatasetResponse].
  ...
  const DrillTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory DrillTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return DrillTableDatasetResponse(
