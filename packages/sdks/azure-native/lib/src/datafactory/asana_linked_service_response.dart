...
class AsanaLinkedServiceResponse {
  ...
  /// Creates a new [AsanaLinkedServiceResponse].
  ...
  const AsanaLinkedServiceResponse({
    this.annotations,
  ...
  factory AsanaLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return AsanaLinkedServiceResponse(
