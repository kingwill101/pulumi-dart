...
class AmazonS3LinkedService {
  ...
  final pulumi.Input<dynamic>? sessionToken;
  ...
  factory AmazonS3LinkedService.fromMap(Map<String, dynamic> map) {
    return AmazonS3LinkedService(
      ...
      sessionToken: (() { final guardedValue = map['sessionToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
