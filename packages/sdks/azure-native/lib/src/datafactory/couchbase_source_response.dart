...
class CouchbaseSourceResponse {
  ...
  /// Creates a new [CouchbaseSourceResponse].
  ...
  factory CouchbaseSourceResponse.fromMap(Map<String, dynamic> map) {
    return CouchbaseSourceResponse(
