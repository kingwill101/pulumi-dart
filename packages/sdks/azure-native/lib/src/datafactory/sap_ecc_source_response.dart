...
class SapEccSourceResponse {
  ...
  /// Creates a new [SapEccSourceResponse].
  ...
  factory SapEccSourceResponse.fromMap(Map<String, dynamic> map) {
    return SapEccSourceResponse(
