...
class AmazonRdsForSqlServerSource {
  ...
  factory AmazonRdsForSqlServerSource.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForSqlServerSource(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlPartitionSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
