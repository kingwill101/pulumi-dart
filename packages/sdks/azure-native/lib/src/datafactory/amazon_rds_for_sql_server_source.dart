...
class AmazonRdsForSqlServerSource {
  ...
  final SqlPartitionSettings? partitionSettings;
  ...
  factory AmazonRdsForSqlServerSource.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForSqlServerSource(
      ...
      partitionSettings: map['partitionSettings'] == null ? null : SqlPartitionSettings.fromMap((map['partitionSettings'] as Map).cast<String, dynamic>()),
