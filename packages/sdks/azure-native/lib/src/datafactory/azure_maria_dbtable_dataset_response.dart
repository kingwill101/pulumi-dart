...
class AzureMariaDBTableDatasetResponse {
  ...
  /// Creates a new [AzureMariaDBTableDatasetResponse].
  ...
  const AzureMariaDBTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory AzureMariaDBTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AzureMariaDBTableDatasetResponse(
