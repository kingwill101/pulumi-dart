...
class SsisProjectResponse {
    ...
    return <String, dynamic>{
      ...
      'environmentRefs':
          ?pulumi.Input.mapOptionalInputValue<
            List<SsisEnvironmentReferenceResponse>,
  ...
  factory SsisProjectResponse.fromMap(Map<String, dynamic> map) {
    return SsisProjectResponse(
      ...
      environmentRefs: (() {
        final guardedValue = map['environmentRefs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SsisEnvironmentReferenceResponse>(
            guardedValue,
            (value) => SsisEnvironmentReferenceResponse.fromMap(
