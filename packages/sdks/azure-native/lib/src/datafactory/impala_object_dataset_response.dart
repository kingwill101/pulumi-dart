...
class ImpalaObjectDatasetResponse {
  ...
  /// Creates a new [ImpalaObjectDatasetResponse].
  ...
  const ImpalaObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory ImpalaObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ImpalaObjectDatasetResponse(
