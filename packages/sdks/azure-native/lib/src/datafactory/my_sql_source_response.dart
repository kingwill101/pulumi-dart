...
class MySqlSourceResponse {
  ...
  /// Creates a new [MySqlSourceResponse].
  ...
  factory MySqlSourceResponse.fromMap(Map<String, dynamic> map) {
    return MySqlSourceResponse(
