...
class GreenplumTableDataset {
  ...
  /// Creates a new [GreenplumTableDataset].
  ...
  factory GreenplumTableDataset.fromMap(Map<String, dynamic> map) {
    return GreenplumTableDataset(
