...
class IcebergSinkResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<IcebergWriteSettingsResponse, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory IcebergSinkResponse.fromMap(Map<String, dynamic> map) {
    return IcebergSinkResponse(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IcebergWriteSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
