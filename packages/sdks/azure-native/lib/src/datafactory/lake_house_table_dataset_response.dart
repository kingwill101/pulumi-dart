...
class LakeHouseTableDatasetResponse {
  ...
  /// Creates a new [LakeHouseTableDatasetResponse].
  ...
  const LakeHouseTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory LakeHouseTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return LakeHouseTableDatasetResponse(
