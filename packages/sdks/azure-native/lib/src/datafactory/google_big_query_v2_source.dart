...
class GoogleBigQueryV2Source {
  ...
  /// Creates a new [GoogleBigQueryV2Source].
  ...
  factory GoogleBigQueryV2Source.fromMap(Map<String, dynamic> map) {
    return GoogleBigQueryV2Source(
