...
class DynamicsAXResourceDatasetResponse {
  ...
  /// Creates a new [DynamicsAXResourceDatasetResponse].
  ...
  const DynamicsAXResourceDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory DynamicsAXResourceDatasetResponse.fromMap(Map<String, dynamic> map) {
    return DynamicsAXResourceDatasetResponse(
