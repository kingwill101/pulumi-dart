...
class CosmosDbLinkedServiceResponse {
  ...
  const CosmosDbLinkedServiceResponse({
  ...
  factory CosmosDbLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return CosmosDbLinkedServiceResponse(
      accountEndpoint: (() { final guardedValue = map['accountEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
