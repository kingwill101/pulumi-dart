...
class ServiceNowV2SourceResponse {
  ...
  const ServiceNowV2SourceResponse({
  ...
  factory ServiceNowV2SourceResponse.fromMap(Map<String, dynamic> map) {
    return ServiceNowV2SourceResponse(
      ...
      expression: (() { final guardedValue = map['expression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExpressionV2Response.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
