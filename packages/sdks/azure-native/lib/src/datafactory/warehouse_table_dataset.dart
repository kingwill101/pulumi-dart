...
class WarehouseTableDataset {
  ...
  /// Creates a new [WarehouseTableDataset].
  ...
  factory WarehouseTableDataset.fromMap(Map<String, dynamic> map) {
    return WarehouseTableDataset(
