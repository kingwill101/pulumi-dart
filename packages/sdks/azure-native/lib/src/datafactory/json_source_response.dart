...
import 'json_read_settings_response.dart';

/// A copy activity Json source.
class JsonSourceResponse {
  /// Specifies the additional columns to be added to source data. Type: array of objects(AdditionalColumns) (or Expression with resultType array of objects).
  final pulumi.Input<dynamic>? additionalColumns;
  /// If true, disable data store metrics collection. Default is false. Type: boolean (or Expression with resultType boolean).
  final pulumi.Input<dynamic>? disableMetricsCollection;
  /// Json format settings.
  final pulumi.Input<JsonReadSettingsResponse>? formatSettings;
  ...
  /// Creates a new [JsonSourceResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<JsonReadSettingsResponse, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory JsonSourceResponse.fromMap(Map<String, dynamic> map) {
    return JsonSourceResponse(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JsonReadSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
