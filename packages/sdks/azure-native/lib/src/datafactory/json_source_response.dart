...
class JsonSourceResponse {
  ...
  final JsonReadSettingsResponse? formatSettings;
  ...
  factory JsonSourceResponse.fromMap(Map<String, dynamic> map) {
    return JsonSourceResponse(
      ...
      formatSettings: map['formatSettings'] == null ? null : JsonReadSettingsResponse.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
