...
class InformixSinkResponse {
  ...
  /// Creates a new [InformixSinkResponse].
  ...
  factory InformixSinkResponse.fromMap(Map<String, dynamic> map) {
    return InformixSinkResponse(
