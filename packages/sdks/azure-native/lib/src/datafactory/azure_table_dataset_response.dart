...
class AzureTableDatasetResponse {
  ...
  /// Creates a new [AzureTableDatasetResponse].
  ...
  factory AzureTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AzureTableDatasetResponse(
      ...
      tableName: pulumi.Input.fromValue(map['tableName']),
