...
class AzureDatabricksDeltaLakeSourceResponse {
  ...
  const AzureDatabricksDeltaLakeSourceResponse({
  ...
  factory AzureDatabricksDeltaLakeSourceResponse.fromMap(Map<String, dynamic> map) {
    return AzureDatabricksDeltaLakeSourceResponse(
      ...
      exportSettings: (() { final guardedValue = map['exportSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureDatabricksDeltaLakeExportCommandResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
