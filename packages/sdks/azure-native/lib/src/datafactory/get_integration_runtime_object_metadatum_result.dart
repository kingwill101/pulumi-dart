...
class GetIntegrationRuntimeObjectMetadatumResult {
  ...
  GetIntegrationRuntimeObjectMetadatumResult({this.nextLink, this.value});
  ...
  factory GetIntegrationRuntimeObjectMetadatumResult.fromMap(
    ...
    return GetIntegrationRuntimeObjectMetadatumResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<SsisEnvironmentResponse>(
          guardedValue,
          (value) => SsisEnvironmentResponse.fromMap(
