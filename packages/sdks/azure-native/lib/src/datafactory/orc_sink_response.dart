...
class OrcSinkResponse {
  ...
  /// ORC format settings.
  final pulumi.Input<OrcWriteSettingsResponse>? formatSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<OrcWriteSettingsResponse, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory OrcSinkResponse.fromMap(Map<String, dynamic> map) {
    return OrcSinkResponse(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrcWriteSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
