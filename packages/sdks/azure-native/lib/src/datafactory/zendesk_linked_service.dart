...
class ZendeskLinkedService {
  ...
  factory ZendeskLinkedService.fromMap(Map<String, dynamic> map) {
    return ZendeskLinkedService(
      ...
      apiToken: (() { final guardedValue = map['apiToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
