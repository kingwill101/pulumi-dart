...
class RelationalTableDatasetResponse {
  ...
  /// Creates a new [RelationalTableDatasetResponse].
  ...
  factory RelationalTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return RelationalTableDatasetResponse(
      annotations: (() {
