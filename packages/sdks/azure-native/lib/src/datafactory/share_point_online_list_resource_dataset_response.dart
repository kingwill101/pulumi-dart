...
class SharePointOnlineListResourceDatasetResponse {
  ...
  const SharePointOnlineListResourceDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SharePointOnlineListResourceDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SharePointOnlineListResourceDatasetResponse(
      ...
      listName: (() { final guardedValue = map['listName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
