...
class SalesforceMarketingCloudSourceResponse {
  ...
  /// Creates a new [SalesforceMarketingCloudSourceResponse].
  ...
  const SalesforceMarketingCloudSourceResponse({
  ...
  factory SalesforceMarketingCloudSourceResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceMarketingCloudSourceResponse(
