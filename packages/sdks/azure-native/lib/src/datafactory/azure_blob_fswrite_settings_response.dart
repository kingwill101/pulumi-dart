...
class AzureBlobFSWriteSettingsResponse {
  ...
  /// Creates a new [AzureBlobFSWriteSettingsResponse].
  ...
  const AzureBlobFSWriteSettingsResponse({
    this.blockSizeInMB,
    this.copyBehavior,
  ...
  factory AzureBlobFSWriteSettingsResponse.fromMap(Map<String, dynamic> map) {
    return AzureBlobFSWriteSettingsResponse(
