...
class AzureSqlDatabaseLinkedService {
  ...
  final SqlAlwaysEncryptedProperties? alwaysEncryptedSettings;
  ...
  factory AzureSqlDatabaseLinkedService.fromMap(Map<String, dynamic> map) {
    return AzureSqlDatabaseLinkedService(
      alwaysEncryptedSettings: map['alwaysEncryptedSettings'] == null ? null : SqlAlwaysEncryptedProperties.fromMap((map['alwaysEncryptedSettings'] as Map).cast<String, dynamic>()),
