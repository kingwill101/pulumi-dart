...
class AzureSqlDatabaseLinkedService {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'alwaysEncryptedSettings': ?pulumi.Input.mapOptionalInputValue<SqlAlwaysEncryptedProperties, Map<String, dynamic>>(alwaysEncryptedSettings, (value) => value.toMap()),
  ...
  factory AzureSqlDatabaseLinkedService.fromMap(Map<String, dynamic> map) {
    return AzureSqlDatabaseLinkedService(
      alwaysEncryptedSettings: map['alwaysEncryptedSettings'] == null ? null : (SqlAlwaysEncryptedProperties.fromMap((map['alwaysEncryptedSettings'] as Map).cast<String, dynamic>())).input(),
