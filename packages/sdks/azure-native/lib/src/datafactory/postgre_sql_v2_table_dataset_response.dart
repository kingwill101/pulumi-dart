...
class PostgreSqlV2TableDatasetResponse {
  ...
  /// Creates a new [PostgreSqlV2TableDatasetResponse].
  ...
  const PostgreSqlV2TableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory PostgreSqlV2TableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return PostgreSqlV2TableDatasetResponse(
