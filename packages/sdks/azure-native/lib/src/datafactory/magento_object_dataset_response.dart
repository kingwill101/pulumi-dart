...
class MagentoObjectDatasetResponse {
  ...
  /// Creates a new [MagentoObjectDatasetResponse].
  ...
  const MagentoObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory MagentoObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return MagentoObjectDatasetResponse(
