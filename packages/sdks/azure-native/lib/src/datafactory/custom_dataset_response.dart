...
class CustomDatasetResponse {
  ...
  /// Creates a new [CustomDatasetResponse].
  ...
  factory CustomDatasetResponse.fromMap(Map<String, dynamic> map) {
    return CustomDatasetResponse(
