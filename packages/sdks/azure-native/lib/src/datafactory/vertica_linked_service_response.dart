...
class VerticaLinkedServiceResponse {
  ...
  /// Creates a new [VerticaLinkedServiceResponse].
  ...
  factory VerticaLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return VerticaLinkedServiceResponse(
      ...
      pwd: (() { final guardedValue = map['pwd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
