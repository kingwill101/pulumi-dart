...
class EloquaSourceResponse {
  ...
  /// Creates a new [EloquaSourceResponse].
  ...
  factory EloquaSourceResponse.fromMap(Map<String, dynamic> map) {
    return EloquaSourceResponse(
