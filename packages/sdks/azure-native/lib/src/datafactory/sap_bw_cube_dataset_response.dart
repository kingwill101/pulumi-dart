...
class SapBwCubeDatasetResponse {
  ...
  /// Creates a new [SapBwCubeDatasetResponse].
  ...
  const SapBwCubeDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SapBwCubeDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SapBwCubeDatasetResponse(
