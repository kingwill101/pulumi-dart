...
class VerticaSourceResponse {
  ...
  /// Creates a new [VerticaSourceResponse].
  ...
  factory VerticaSourceResponse.fromMap(Map<String, dynamic> map) {
    return VerticaSourceResponse(
