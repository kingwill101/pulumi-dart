...
class AzureTableSinkResponse {
  ...
  factory AzureTableSinkResponse.fromMap(Map<String, dynamic> map) {
    return AzureTableSinkResponse(
      azureTableDefaultPartitionKeyValue: (() { final guardedValue = map['azureTableDefaultPartitionKeyValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      azureTableInsertType: (() { final guardedValue = map['azureTableInsertType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      azureTablePartitionKeyName: (() { final guardedValue = map['azureTablePartitionKeyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      azureTableRowKeyName: (() { final guardedValue = map['azureTableRowKeyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
