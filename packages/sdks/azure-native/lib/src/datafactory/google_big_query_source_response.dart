...
class GoogleBigQuerySourceResponse {
  ...
  /// Creates a new [GoogleBigQuerySourceResponse].
  ...
  const GoogleBigQuerySourceResponse({
  ...
  factory GoogleBigQuerySourceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleBigQuerySourceResponse(
