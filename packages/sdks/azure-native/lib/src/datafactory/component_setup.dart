...
class ComponentSetup {
  ...
  factory ComponentSetup.fromMap(Map<String, dynamic> map) {
    return ComponentSetup(
      ...
      licenseKey: (() { final guardedValue = map['licenseKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
