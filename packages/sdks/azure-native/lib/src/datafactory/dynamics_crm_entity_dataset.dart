...
class DynamicsCrmEntityDataset {
  ...
  /// Creates a new [DynamicsCrmEntityDataset].
  ...
  factory DynamicsCrmEntityDataset.fromMap(Map<String, dynamic> map) {
    return DynamicsCrmEntityDataset(
