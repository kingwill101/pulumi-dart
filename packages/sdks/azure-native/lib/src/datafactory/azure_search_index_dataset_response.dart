...
class AzureSearchIndexDatasetResponse {
  ...
  final pulumi.Input<dynamic> indexName;
  ...
  /// Creates a new [AzureSearchIndexDatasetResponse].
  ...
  const AzureSearchIndexDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory AzureSearchIndexDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AzureSearchIndexDatasetResponse(
      ...
      indexName: pulumi.Input.fromValue(map['indexName']),
