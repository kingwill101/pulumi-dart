...
class WarehouseSourceResponse {
  ...
  /// Creates a new [WarehouseSourceResponse].
  ...
  factory WarehouseSourceResponse.fromMap(Map<String, dynamic> map) {
    return WarehouseSourceResponse(
      additionalColumns: (() {
