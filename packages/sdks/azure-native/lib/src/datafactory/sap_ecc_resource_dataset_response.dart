...
class SapEccResourceDatasetResponse {
  ...
  /// Creates a new [SapEccResourceDatasetResponse].
  ...
  const SapEccResourceDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SapEccResourceDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SapEccResourceDatasetResponse(
