...
class SnowflakeV2SourceResponse {
  ...
  const SnowflakeV2SourceResponse({
  ...
  factory SnowflakeV2SourceResponse.fromMap(Map<String, dynamic> map) {
    return SnowflakeV2SourceResponse(
      ...
      exportSettings: pulumi.Input.fromValue(SnowflakeExportCopyCommandResponse.fromMap((map['exportSettings']! as Map).cast<String, dynamic>())),
