...
class FilterActivity {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': pulumi.Input.mapInputValue<Expression, Map<String, dynamic>>(
        condition,
        (value) => value.toMap(),
      ),
      'dependsOn':
      ...
      'items': pulumi.Input.mapInputValue<Expression, Map<String, dynamic>>(
        items,
        (value) => value.toMap(),
      ),
      'name': name,
  ...
  factory FilterActivity.fromMap(Map<String, dynamic> map) {
    return FilterActivity(
      condition: pulumi.Input.fromValue(
        Expression.fromMap((map['condition']! as Map).cast<String, dynamic>()),
      ),
      dependsOn: (() {
      ...
      items: pulumi.Input.fromValue(
        Expression.fromMap((map['items']! as Map).cast<String, dynamic>()),
      ),
