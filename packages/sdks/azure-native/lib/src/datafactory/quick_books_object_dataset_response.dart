...
class QuickBooksObjectDatasetResponse {
  ...
  /// Creates a new [QuickBooksObjectDatasetResponse].
  ...
  const QuickBooksObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory QuickBooksObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return QuickBooksObjectDatasetResponse(
