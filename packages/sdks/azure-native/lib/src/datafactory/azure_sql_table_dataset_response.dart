...
class AzureSqlTableDatasetResponse {
  ...
  /// Creates a new [AzureSqlTableDatasetResponse].
  ...
  const AzureSqlTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory AzureSqlTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AzureSqlTableDatasetResponse(
