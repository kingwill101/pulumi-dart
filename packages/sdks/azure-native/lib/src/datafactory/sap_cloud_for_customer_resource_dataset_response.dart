...
class SapCloudForCustomerResourceDatasetResponse {
  ...
  /// Creates a new [SapCloudForCustomerResourceDatasetResponse].
  ...
  const SapCloudForCustomerResourceDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SapCloudForCustomerResourceDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SapCloudForCustomerResourceDatasetResponse(
