...
class XeroSourceResponse {
  ...
  /// Creates a new [XeroSourceResponse].
  ...
  factory XeroSourceResponse.fromMap(Map<String, dynamic> map) {
    return XeroSourceResponse(
