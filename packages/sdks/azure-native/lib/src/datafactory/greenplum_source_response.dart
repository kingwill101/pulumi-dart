...
class GreenplumSourceResponse {
  ...
  /// Creates a new [GreenplumSourceResponse].
  ...
  factory GreenplumSourceResponse.fromMap(Map<String, dynamic> map) {
    return GreenplumSourceResponse(
