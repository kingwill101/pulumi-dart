...
class GoogleAdWordsLinkedService {
  ...
  factory GoogleAdWordsLinkedService.fromMap(Map<String, dynamic> map) {
    return GoogleAdWordsLinkedService(
      ...
      developerToken: (() { final guardedValue = map['developerToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
