...
class GoogleAdWordsLinkedService {
  ...
  final AzureKeyVaultSecretReference? developerToken;
  ...
  factory GoogleAdWordsLinkedService.fromMap(Map<String, dynamic> map) {
    return GoogleAdWordsLinkedService(
      ...
      developerToken: map['developerToken'] == null ? null : AzureKeyVaultSecretReference.fromMap((map['developerToken'] as Map).cast<String, dynamic>()),
