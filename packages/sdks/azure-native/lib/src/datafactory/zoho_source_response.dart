...
class ZohoSourceResponse {
  ...
  /// Creates a new [ZohoSourceResponse].
  ...
  factory ZohoSourceResponse.fromMap(Map<String, dynamic> map) {
    return ZohoSourceResponse(
