...
class MySqlTableDatasetResponse {
  ...
  /// Creates a new [MySqlTableDatasetResponse].
  ...
  const MySqlTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory MySqlTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return MySqlTableDatasetResponse(
