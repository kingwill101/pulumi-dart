...
class IntegrationRuntimeSsisCatalogInfo {
  ...
  final pulumi.Input<dynamic>? catalogPricingTier;
  ...
  factory IntegrationRuntimeSsisCatalogInfo.fromMap(Map<String, dynamic> map) {
    return IntegrationRuntimeSsisCatalogInfo(
      catalogAdminPassword: (() { final guardedValue = map['catalogAdminPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecureString.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      catalogPricingTier: (() { final guardedValue = map['catalogPricingTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
