...
class SybaseSourceResponse {
  ...
  /// Creates a new [SybaseSourceResponse].
  ...
  factory SybaseSourceResponse.fromMap(Map<String, dynamic> map) {
    return SybaseSourceResponse(
