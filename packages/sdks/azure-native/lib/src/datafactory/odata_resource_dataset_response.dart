...
class ODataResourceDatasetResponse {
  ...
  /// Creates a new [ODataResourceDatasetResponse].
  ...
  const ODataResourceDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory ODataResourceDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ODataResourceDatasetResponse(
