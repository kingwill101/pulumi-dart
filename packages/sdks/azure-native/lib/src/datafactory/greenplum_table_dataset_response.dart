...
class GreenplumTableDatasetResponse {
  ...
  /// Creates a new [GreenplumTableDatasetResponse].
  ...
  factory GreenplumTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return GreenplumTableDatasetResponse(
