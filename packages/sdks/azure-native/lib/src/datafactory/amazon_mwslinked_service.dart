...
class AmazonMWSLinkedService {
  ...
  final AzureKeyVaultSecretReference? mwsAuthToken;
  /// Parameters for linked service.
  final Map<String, ParameterSpecification>? parameters;
  /// The secret key used to access data.
  final AzureKeyVaultSecretReference? secretKey;
  ...
  factory AmazonMWSLinkedService.fromMap(Map<String, dynamic> map) {
    return AmazonMWSLinkedService(
      ...
      mwsAuthToken: map['mwsAuthToken'] == null ? null : AzureKeyVaultSecretReference.fromMap((map['mwsAuthToken'] as Map).cast<String, dynamic>()),
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeMapValues<ParameterSpecification>(map['parameters'], (value) => ParameterSpecification.fromMap((value as Map).cast<String, dynamic>())),
      secretKey: map['secretKey'] == null ? null : AzureKeyVaultSecretReference.fromMap((map['secretKey'] as Map).cast<String, dynamic>()),
