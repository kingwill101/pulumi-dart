...
class HBaseObjectDatasetResponse {
  ...
  /// Creates a new [HBaseObjectDatasetResponse].
  ...
  const HBaseObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory HBaseObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return HBaseObjectDatasetResponse(
