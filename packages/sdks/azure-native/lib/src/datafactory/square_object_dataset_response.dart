...
class SquareObjectDatasetResponse {
  ...
  /// Creates a new [SquareObjectDatasetResponse].
  ...
  const SquareObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SquareObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SquareObjectDatasetResponse(
