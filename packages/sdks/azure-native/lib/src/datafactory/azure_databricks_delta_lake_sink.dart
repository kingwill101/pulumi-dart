...
class AzureDatabricksDeltaLakeSink {
  ...
  final pulumi.Input<AzureDatabricksDeltaLakeImportCommand>? importSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'importSettings': ?pulumi.Input.mapOptionalInputValue<AzureDatabricksDeltaLakeImportCommand, Map<String, dynamic>>(importSettings, (value) => value.toMap()),
  ...
  factory AzureDatabricksDeltaLakeSink.fromMap(Map<String, dynamic> map) {
    return AzureDatabricksDeltaLakeSink(
      ...
      importSettings: (() { final guardedValue = map['importSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureDatabricksDeltaLakeImportCommand.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
