...
class SqlDWSink {
    ...
    return <String, dynamic>{
      ...
      'polyBaseSettings':
          ?pulumi.Input.mapOptionalInputValue<
            PolybaseSettings,
            Map<String, dynamic>
          >(polyBaseSettings, (value) => value.toMap()),
  ...
  factory SqlDWSink.fromMap(Map<String, dynamic> map) {
    return SqlDWSink(
      ...
      allowPolyBase: (() {
        final guardedValue = map['allowPolyBase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      copyCommandSettings: (() {
      ...
      polyBaseSettings: (() {
        final guardedValue = map['polyBaseSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PolybaseSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
