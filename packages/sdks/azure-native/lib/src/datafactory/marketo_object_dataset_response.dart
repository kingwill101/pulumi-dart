...
class MarketoObjectDatasetResponse {
  ...
  /// Creates a new [MarketoObjectDatasetResponse].
  ...
  const MarketoObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory MarketoObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return MarketoObjectDatasetResponse(
