...
class PrestoObjectDatasetResponse {
  ...
  /// Creates a new [PrestoObjectDatasetResponse].
  ...
  factory PrestoObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return PrestoObjectDatasetResponse(
