...
class XmlSource {
  ...
  /// Xml format settings.
  final pulumi.Input<XmlReadSettings>? formatSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<XmlReadSettings, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory XmlSource.fromMap(Map<String, dynamic> map) {
    return XmlSource(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(XmlReadSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
