...
class InformixTableDatasetResponse {
  ...
  /// Creates a new [InformixTableDatasetResponse].
  ...
  factory InformixTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return InformixTableDatasetResponse(
