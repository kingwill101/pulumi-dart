...
class MicrosoftAccessTableDatasetResponse {
  ...
  /// Creates a new [MicrosoftAccessTableDatasetResponse].
  ...
  const MicrosoftAccessTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory MicrosoftAccessTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return MicrosoftAccessTableDatasetResponse(
