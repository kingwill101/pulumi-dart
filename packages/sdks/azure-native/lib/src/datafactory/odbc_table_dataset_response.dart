...
class OdbcTableDatasetResponse {
  ...
  /// Creates a new [OdbcTableDatasetResponse].
  ...
  const OdbcTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory OdbcTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return OdbcTableDatasetResponse(
