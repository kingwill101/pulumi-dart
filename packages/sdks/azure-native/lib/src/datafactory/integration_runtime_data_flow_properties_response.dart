...
class IntegrationRuntimeDataFlowPropertiesResponse {
  ...
  final pulumi.Input<
    List<IntegrationRuntimeDataFlowPropertiesResponseCustomProperties>
  >?
  customProperties;
  ...
  factory IntegrationRuntimeDataFlowPropertiesResponse.fromMap(
      ...
      customProperties: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                IntegrationRuntimeDataFlowPropertiesResponseCustomProperties.fromMap(
