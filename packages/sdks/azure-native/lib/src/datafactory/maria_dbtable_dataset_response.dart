...
class MariaDBTableDatasetResponse {
  ...
  /// Creates a new [MariaDBTableDatasetResponse].
  ...
  const MariaDBTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory MariaDBTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return MariaDBTableDatasetResponse(
