...
class SSISPackageLocationResponse {
  ...
  final pulumi.Input<SSISAccessCredentialResponse>?
    ...
    return <String, dynamic>{
      ...
      'configurationAccessCredential':
          ?pulumi.Input.mapOptionalInputValue<
            SSISAccessCredentialResponse,
            Map<String, dynamic>
          >(configurationAccessCredential, (value) => value.toMap()),
      ...
      'packagePassword':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(packagePassword, (value) => value.toMap()),
  ...
  factory SSISPackageLocationResponse.fromMap(Map<String, dynamic> map) {
    return SSISPackageLocationResponse(
      ...
      childPackages: (() {
        final guardedValue = map['childPackages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SSISChildPackageResponse>(
            guardedValue,
            (value) => SSISChildPackageResponse.fromMap(
      ...
      configurationAccessCredential: (() {
        final guardedValue = map['configurationAccessCredential'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSISAccessCredentialResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      configurationPath: (() {
        final guardedValue = map['configurationPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      packageContent: (() {
        final guardedValue = map['packageContent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      ...
      packagePassword: (() {
        final guardedValue = map['packagePassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
