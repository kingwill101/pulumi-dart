...
class SSISPackageLocationResponse {
  ...
  factory SSISPackageLocationResponse.fromMap(Map<String, dynamic> map) {
    return SSISPackageLocationResponse(
      ...
      packagePassword: (() { final guardedValue = map['packagePassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
