...
class AzurePostgreSqlSourceResponse {
  ...
  /// Creates a new [AzurePostgreSqlSourceResponse].
  ...
  const AzurePostgreSqlSourceResponse({
  ...
  factory AzurePostgreSqlSourceResponse.fromMap(Map<String, dynamic> map) {
    return AzurePostgreSqlSourceResponse(
