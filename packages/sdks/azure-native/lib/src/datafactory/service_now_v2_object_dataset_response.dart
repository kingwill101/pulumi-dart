...
class ServiceNowV2ObjectDatasetResponse {
  ...
  /// Creates a new [ServiceNowV2ObjectDatasetResponse].
  ...
  const ServiceNowV2ObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory ServiceNowV2ObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ServiceNowV2ObjectDatasetResponse(
