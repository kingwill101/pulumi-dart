...
/// Netezza dataset.
class NetezzaTableDatasetResponse {
  ...
  /// Creates a new [NetezzaTableDatasetResponse].
  ...
  const NetezzaTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory NetezzaTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return NetezzaTableDatasetResponse(
