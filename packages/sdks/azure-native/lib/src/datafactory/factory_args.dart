...
class FactoryArgs {
  ...
  final pulumi.Input<Map<String, GlobalParameterSpecification>>?
  globalParameters;
    ...
    return <String, dynamic>{
      ...
      'purviewConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            PurviewConfiguration,
            Map<String, dynamic>
          >(purviewConfiguration, (value) => value.toMap()),
      'repoConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FactoryGitHubConfiguration,
            Map<String, dynamic>
          >(repoConfiguration, (value) => value.toMap()),
  ...
  factory FactoryArgs.fromMap(Map<String, dynamic> map) {
    return FactoryArgs(
      ...
      factoryName: (() {
        final guardedValue = map['factoryName'];
        if (guardedValue == null) return null;
