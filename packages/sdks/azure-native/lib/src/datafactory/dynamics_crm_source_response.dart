...
class DynamicsCrmSourceResponse {
  ...
  /// Creates a new [DynamicsCrmSourceResponse].
  ...
  const DynamicsCrmSourceResponse({
  ...
  factory DynamicsCrmSourceResponse.fromMap(Map<String, dynamic> map) {
    return DynamicsCrmSourceResponse(
