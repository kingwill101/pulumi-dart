...
class DynamicsCrmEntityDatasetResponse {
  ...
  /// Creates a new [DynamicsCrmEntityDatasetResponse].
  ...
  const DynamicsCrmEntityDatasetResponse({
    this.annotations,
    this.description,
    this.entityName,
    this.folder,
  ...
  factory DynamicsCrmEntityDatasetResponse.fromMap(Map<String, dynamic> map) {
    return DynamicsCrmEntityDatasetResponse(
      annotations: (() { final guardedValue = map['annotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      entityName: (() { final guardedValue = map['entityName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
