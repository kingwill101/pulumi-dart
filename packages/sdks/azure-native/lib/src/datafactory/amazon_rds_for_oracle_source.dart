...
class AmazonRdsForOracleSource {
  ...
  final AmazonRdsForOraclePartitionSettings? partitionSettings;
  ...
  factory AmazonRdsForOracleSource.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForOracleSource(
      ...
      partitionSettings: map['partitionSettings'] == null ? null : AmazonRdsForOraclePartitionSettings.fromMap((map['partitionSettings'] as Map).cast<String, dynamic>()),
