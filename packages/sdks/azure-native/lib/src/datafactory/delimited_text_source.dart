...
class DelimitedTextSource {
  ...
  final pulumi.Input<DelimitedTextReadSettings>? formatSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<DelimitedTextReadSettings, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory DelimitedTextSource.fromMap(Map<String, dynamic> map) {
    return DelimitedTextSource(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DelimitedTextReadSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
