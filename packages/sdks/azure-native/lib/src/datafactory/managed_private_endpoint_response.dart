...
class ManagedPrivateEndpointResponse {
  ...
  final ConnectionStatePropertiesResponse? connectionState;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionState': ?connectionState == null ? null : connectionState!.toMap(),
      'fqdns': ?fqdns,
      'groupId': ?groupId,
  ...
  factory ManagedPrivateEndpointResponse.fromMap(Map<String, dynamic> map) {
    return ManagedPrivateEndpointResponse(
      connectionState: map['connectionState'] == null ? null : ConnectionStatePropertiesResponse.fromMap((map['connectionState'] as Map).cast<String, dynamic>()),
