...
class ParquetSink {
  ...
  final ParquetWriteSettings? formatSettings;
  ...
  factory ParquetSink.fromMap(Map<String, dynamic> map) {
    return ParquetSink(
      ...
      formatSettings: map['formatSettings'] == null ? null : ParquetWriteSettings.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
