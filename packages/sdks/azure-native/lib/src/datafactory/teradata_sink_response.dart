...
class TeradataSinkResponse {
  ...
  factory TeradataSinkResponse.fromMap(Map<String, dynamic> map) {
    return TeradataSinkResponse(
      ...
      importSettings: (() { final guardedValue = map['importSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TeradataImportCommandResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
