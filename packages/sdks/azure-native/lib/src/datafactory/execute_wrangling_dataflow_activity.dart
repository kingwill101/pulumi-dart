...
class ExecuteWranglingDataflowActivity {
  ...
  factory ExecuteWranglingDataflowActivity.fromMap(Map<String, dynamic> map) {
    return ExecuteWranglingDataflowActivity(
      ...
      queries: map['queries'] == null ? null : (pulumi.Input.decodeList<PowerQuerySinkMapping>(map['queries'], (value) => PowerQuerySinkMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
      runConcurrently: map['runConcurrently'] == null ? null : (map['runConcurrently']).input(),
      sinks: map['sinks'] == null ? null : (pulumi.Input.decodeMapValues<PowerQuerySink>(map['sinks'], (value) => PowerQuerySink.fromMap((value as Map).cast<String, dynamic>()))).input(),
