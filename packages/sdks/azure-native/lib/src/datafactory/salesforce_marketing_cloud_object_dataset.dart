...
class SalesforceMarketingCloudObjectDataset {
  ...
  /// Creates a new [SalesforceMarketingCloudObjectDataset].
  ...
  factory SalesforceMarketingCloudObjectDataset.fromMap(Map<String, dynamic> map) {
    return SalesforceMarketingCloudObjectDataset(
