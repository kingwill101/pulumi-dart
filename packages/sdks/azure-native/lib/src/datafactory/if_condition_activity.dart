...
class IfConditionActivity {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'expression':
          pulumi.Input.mapInputValue<Expression, Map<String, dynamic>>(
            expression,
            (value) => value.toMap(),
          ),
      'ifFalseActivities':
  ...
  factory IfConditionActivity.fromMap(Map<String, dynamic> map) {
    return IfConditionActivity(
      ...
      expression: pulumi.Input.fromValue(
        Expression.fromMap((map['expression']! as Map).cast<String, dynamic>()),
      ),
      ifFalseActivities: (() {
        final guardedValue = map['ifFalseActivities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ifTrueActivities: (() {
        final guardedValue = map['ifTrueActivities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AppendVariableActivity>(
            guardedValue,
