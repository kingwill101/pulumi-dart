...
class Db2TableDatasetResponse {
  ...
  /// Creates a new [Db2TableDatasetResponse].
  ...
  factory Db2TableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return Db2TableDatasetResponse(
