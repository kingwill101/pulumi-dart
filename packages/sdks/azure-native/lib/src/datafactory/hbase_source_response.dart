...
class HBaseSourceResponse {
  ...
  /// Creates a new [HBaseSourceResponse].
  ...
  factory HBaseSourceResponse.fromMap(Map<String, dynamic> map) {
    return HBaseSourceResponse(
