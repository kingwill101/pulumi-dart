...
class ConcurSourceResponse {
  ...
  /// Creates a new [ConcurSourceResponse].
  ...
  factory ConcurSourceResponse.fromMap(Map<String, dynamic> map) {
    return ConcurSourceResponse(
