...
class SapTableResourceDatasetResponse {
  ...
  /// Creates a new [SapTableResourceDatasetResponse].
  ...
  factory SapTableResourceDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SapTableResourceDatasetResponse(
