...
class MicrosoftAccessSource {
  ...
  /// Creates a new [MicrosoftAccessSource].
  ...
  factory MicrosoftAccessSource.fromMap(Map<String, dynamic> map) {
    return MicrosoftAccessSource(
