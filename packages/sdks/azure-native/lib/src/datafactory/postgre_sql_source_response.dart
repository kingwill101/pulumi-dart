...
class PostgreSqlSourceResponse {
  ...
  /// Creates a new [PostgreSqlSourceResponse].
  ...
  const PostgreSqlSourceResponse({
  ...
  factory PostgreSqlSourceResponse.fromMap(Map<String, dynamic> map) {
    return PostgreSqlSourceResponse(
