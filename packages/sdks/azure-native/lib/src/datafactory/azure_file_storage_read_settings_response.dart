...
class AzureFileStorageReadSettingsResponse {
  ...
  /// Creates a new [AzureFileStorageReadSettingsResponse].
  ...
  const AzureFileStorageReadSettingsResponse({
  ...
  factory AzureFileStorageReadSettingsResponse.fromMap(Map<String, dynamic> map) {
    return AzureFileStorageReadSettingsResponse(
