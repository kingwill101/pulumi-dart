...
class SalesforceServiceCloudSourceResponse {
  ...
  /// Creates a new [SalesforceServiceCloudSourceResponse].
  ...
  const SalesforceServiceCloudSourceResponse({
  ...
  factory SalesforceServiceCloudSourceResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceServiceCloudSourceResponse(
      ...
      readBehavior: (() { final guardedValue = map['readBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
