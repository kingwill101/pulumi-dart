...
class DWCopyCommandSettingsResponse {
  ...
  DWCopyCommandSettingsResponse({this.additionalOptions, this.defaultValues});
    ...
    return <String, dynamic>{
      ...
      'defaultValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<DWCopyCommandDefaultValueResponse>,
  ...
  factory DWCopyCommandSettingsResponse.fromMap(Map<String, dynamic> map) {
    return DWCopyCommandSettingsResponse(
      ...
      defaultValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DWCopyCommandDefaultValueResponse>(
            guardedValue,
            (value) => DWCopyCommandDefaultValueResponse.fromMap(
