...
class ImpalaSourceResponse {
  ...
  /// Creates a new [ImpalaSourceResponse].
  ...
  factory ImpalaSourceResponse.fromMap(Map<String, dynamic> map) {
    return ImpalaSourceResponse(
