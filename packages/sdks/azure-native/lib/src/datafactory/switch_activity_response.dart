...
class SwitchActivityResponse {
  ...
  factory SwitchActivityResponse.fromMap(Map<String, dynamic> map) {
    return SwitchActivityResponse(
      ...
      defaultActivities: (() { final guardedValue = map['defaultActivities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppendVariableActivityResponse>(guardedValue, (value) => AppendVariableActivityResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
