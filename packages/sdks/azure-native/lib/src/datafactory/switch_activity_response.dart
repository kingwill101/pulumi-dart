    ...
    return SwitchActivityResponse(
      cases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SwitchCaseResponse>(
            guardedValue,
            (value) => SwitchCaseResponse.fromMap(
      ...
      on: pulumi.Input.fromValue(
        ExpressionResponse.fromMap((map['on']! as Map).cast<String, dynamic>()),
      ),
      onInactiveMarkAs: (() {
