...
class CustomActivityResponse {
  ...
  factory CustomActivityResponse.fromMap(Map<String, dynamic> map) {
    return CustomActivityResponse(
      ...
      referenceObjects: (() { final guardedValue = map['referenceObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomActivityReferenceObjectResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceLinkedService: (() { final guardedValue = map['resourceLinkedService']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinkedServiceReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
