...
class AzureQueueSinkResponse {
  ...
  /// Creates a new [AzureQueueSinkResponse].
  ...
  factory AzureQueueSinkResponse.fromMap(Map<String, dynamic> map) {
    return AzureQueueSinkResponse(
