...
class QuickBooksSourceResponse {
  ...
  /// Creates a new [QuickBooksSourceResponse].
  ...
  const QuickBooksSourceResponse({
  ...
  factory QuickBooksSourceResponse.fromMap(Map<String, dynamic> map) {
    return QuickBooksSourceResponse(
