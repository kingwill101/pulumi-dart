...
class ExcelSourceResponse {
  ...
  /// Creates a new [ExcelSourceResponse].
  ...
  factory ExcelSourceResponse.fromMap(Map<String, dynamic> map) {
    return ExcelSourceResponse(
