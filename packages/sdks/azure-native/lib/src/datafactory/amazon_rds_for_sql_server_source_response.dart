...
class AmazonRdsForSqlServerSourceResponse {
  ...
  /// Creates a new [AmazonRdsForSqlServerSourceResponse].
  ...
  factory AmazonRdsForSqlServerSourceResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AmazonRdsForSqlServerSourceResponse(
      additionalColumns: (() {
      ...
      isolationLevel: (() {
        final guardedValue = map['isolationLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      ...
      partitionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          SqlPartitionSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      produceAdditionalTypes: (() {
        final guardedValue = map['produceAdditionalTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      queryTimeout: (() {
      ...
      sqlReaderQuery: (() {
        final guardedValue = map['sqlReaderQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      sqlReaderStoredProcedureName: (() {
        final guardedValue = map['sqlReaderStoredProcedureName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
