...
class SapTableSourceResponse {
  ...
  factory SapTableSourceResponse.fromMap(Map<String, dynamic> map) {
    return SapTableSourceResponse(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SapTablePartitionSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
