...
class AmazonMWSSourceResponse {
  ...
  /// Creates a new [AmazonMWSSourceResponse].
  ...
  factory AmazonMWSSourceResponse.fromMap(Map<String, dynamic> map) {
    return AmazonMWSSourceResponse(
