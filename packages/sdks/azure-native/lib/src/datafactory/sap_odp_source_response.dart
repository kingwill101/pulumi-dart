...
class SapOdpSourceResponse {
  ...
  factory SapOdpSourceResponse.fromMap(Map<String, dynamic> map) {
    return SapOdpSourceResponse(
      ...
      extractionMode: (() { final guardedValue = map['extractionMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      projection: (() { final guardedValue = map['projection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      selection: (() { final guardedValue = map['selection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      subscriberProcess: (() { final guardedValue = map['subscriberProcess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
