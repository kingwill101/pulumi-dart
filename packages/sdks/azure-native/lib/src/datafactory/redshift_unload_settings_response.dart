...
class RedshiftUnloadSettingsResponse {
  ...
  final LinkedServiceReferenceResponse s3LinkedServiceName;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      's3LinkedServiceName': s3LinkedServiceName.toMap(),
    };
  }
  ...
  factory RedshiftUnloadSettingsResponse.fromMap(Map<String, dynamic> map) {
    return RedshiftUnloadSettingsResponse(
      ...
      s3LinkedServiceName: LinkedServiceReferenceResponse.fromMap((map['s3LinkedServiceName'] as Map).cast<String, dynamic>()),
    );
  }
}
