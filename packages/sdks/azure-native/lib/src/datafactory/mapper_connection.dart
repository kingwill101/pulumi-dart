...
class MapperConnection {
  ...
  final pulumi.Input<List<MapperDslConnectorProperties>>?
    ...
    return <String, dynamic>{
      'commonDslConnectorProperties':
          ?pulumi.Input.mapOptionalInputValue<
            List<MapperDslConnectorProperties>,
    ...
    return MapperConnection(
      commonDslConnectorProperties: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MapperDslConnectorProperties>(
            guardedValue,
            (value) => MapperDslConnectorProperties.fromMap(
