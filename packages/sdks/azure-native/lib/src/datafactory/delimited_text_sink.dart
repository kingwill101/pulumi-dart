...
import 'delimited_text_write_settings.dart';

/// A copy activity DelimitedText sink.
class DelimitedTextSink {
  /// If true, disable data store metrics collection. Default is false. Type: boolean (or Expression with resultType boolean).
  final pulumi.Input<dynamic>? disableMetricsCollection;
  /// DelimitedText format settings.
  final pulumi.Input<DelimitedTextWriteSettings>? formatSettings;
  ...
  /// Creates a new [DelimitedTextSink].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<DelimitedTextWriteSettings, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory DelimitedTextSink.fromMap(Map<String, dynamic> map) {
    return DelimitedTextSink(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DelimitedTextWriteSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
