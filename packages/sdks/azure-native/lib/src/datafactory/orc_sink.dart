...
class OrcSink {
  ...
  /// ORC format settings.
  final OrcWriteSettings? formatSettings;
  ...
  factory OrcSink.fromMap(Map<String, dynamic> map) {
    return OrcSink(
      ...
      formatSettings: map['formatSettings'] == null ? null : OrcWriteSettings.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
