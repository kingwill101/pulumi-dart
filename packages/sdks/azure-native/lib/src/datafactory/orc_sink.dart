...
class OrcSink {
  ...
  factory OrcSink.fromMap(Map<String, dynamic> map) {
    return OrcSink(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrcWriteSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
