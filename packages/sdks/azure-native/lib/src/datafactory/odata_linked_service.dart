...
class ODataLinkedService {
  ...
  final pulumi.Input<dynamic>? aadServicePrincipalCredentialType;
  ...
  factory ODataLinkedService.fromMap(Map<String, dynamic> map) {
    return ODataLinkedService(
      ...
      aadServicePrincipalCredentialType: (() { final guardedValue = map['aadServicePrincipalCredentialType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
