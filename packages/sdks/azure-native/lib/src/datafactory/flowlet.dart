    ...
    return <String, dynamic>{
      ...
      'sinks':
          ...
          >(
            sinks,
            (value) =>
                pulumi.Input.encodeList<DataFlowSink, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'sources':
          ...
          >(
            sources,
            (value) =>
                pulumi.Input.encodeList<DataFlowSource, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'transformations':
          ...
          >(
            transformations_,
            (value) =>
                pulumi.Input.encodeList<Transformation, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return Flowlet(
      ...
      folder: (() {
        ...
        return pulumi.Input.fromValue(
          DataFlowFolder.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      script: (() {
      ...
      sinks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataFlowSink>(
            guardedValue,
            (value) =>
                DataFlowSink.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      sources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataFlowSource>(
            guardedValue,
            (value) =>
                DataFlowSource.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      transformations_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Transformation>(
            guardedValue,
            (value) =>
                Transformation.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
