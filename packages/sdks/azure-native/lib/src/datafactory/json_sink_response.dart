...
import 'json_write_settings_response.dart';

/// A copy activity Json sink.
class JsonSinkResponse {
  /// If true, disable data store metrics collection. Default is false. Type: boolean (or Expression with resultType boolean).
  final pulumi.Input<dynamic>? disableMetricsCollection;
  /// Json format settings.
  final pulumi.Input<JsonWriteSettingsResponse?>? formatSettings;
  ...
  /// Creates a new [JsonSinkResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<JsonWriteSettingsResponse, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory JsonSinkResponse.fromMap(Map<String, dynamic> map) {
    return JsonSinkResponse(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JsonWriteSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
