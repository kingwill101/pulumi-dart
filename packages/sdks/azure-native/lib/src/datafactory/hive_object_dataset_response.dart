...
/// Hive Server dataset.
class HiveObjectDatasetResponse {
  ...
  /// Creates a new [HiveObjectDatasetResponse].
  ...
  const HiveObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory HiveObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return HiveObjectDatasetResponse(
