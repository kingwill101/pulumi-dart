...
class HubspotSourceResponse {
  ...
  /// Creates a new [HubspotSourceResponse].
  ...
  factory HubspotSourceResponse.fromMap(Map<String, dynamic> map) {
    return HubspotSourceResponse(
