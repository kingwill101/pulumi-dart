...
class PaypalSourceResponse {
  ...
  /// Creates a new [PaypalSourceResponse].
  ...
  factory PaypalSourceResponse.fromMap(Map<String, dynamic> map) {
    return PaypalSourceResponse(
