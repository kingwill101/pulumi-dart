...
class AzureMLBatchExecutionActivityResponse {
  ...
  final pulumi.Input<Map<String, AzureMLWebServiceFileResponse>>?
  webServiceInputs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'webServiceInputs':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, AzureMLWebServiceFileResponse>,
  ...
  factory AzureMLBatchExecutionActivityResponse.fromMap(
    ...
    return AzureMLBatchExecutionActivityResponse(
      ...
      webServiceInputs: (() {
        final guardedValue = map['webServiceInputs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<AzureMLWebServiceFileResponse>(
            guardedValue,
            (value) => AzureMLWebServiceFileResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      webServiceOutputs: (() {
        final guardedValue = map['webServiceOutputs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<AzureMLWebServiceFileResponse>(
            guardedValue,
