...
class AzureDataExplorerSourceResponse {
  ...
  final pulumi.Input<dynamic>? noTruncation;
  ...
  /// Creates a new [AzureDataExplorerSourceResponse].
  ...
  const AzureDataExplorerSourceResponse({
  ...
  factory AzureDataExplorerSourceResponse.fromMap(Map<String, dynamic> map) {
    return AzureDataExplorerSourceResponse(
      ...
      noTruncation: (() { final guardedValue = map['noTruncation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      query: pulumi.Input.fromValue(map['query']),
