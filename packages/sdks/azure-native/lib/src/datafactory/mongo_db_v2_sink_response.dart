...
class MongoDbV2SinkResponse {
  ...
  /// Creates a new [MongoDbV2SinkResponse].
  ...
  factory MongoDbV2SinkResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbV2SinkResponse(
