...
class CommonDataServiceForAppsSink {
  ...
  factory CommonDataServiceForAppsSink.fromMap(Map<String, dynamic> map) {
    return CommonDataServiceForAppsSink(
      alternateKeyName: (() { final guardedValue = map['alternateKeyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      bypassBusinessLogicExecution: (() { final guardedValue = map['bypassBusinessLogicExecution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      bypassPowerAutomateFlows: (() { final guardedValue = map['bypassPowerAutomateFlows']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
