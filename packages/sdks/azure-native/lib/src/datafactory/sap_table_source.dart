  ...
  factory SapTableSource.fromMap(Map<String, dynamic> map) {
    return SapTableSource(
      ...
      customRfcReadTableFunctionModule: (() {
        final guardedValue = map['customRfcReadTableFunctionModule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      ...
      partitionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          SapTablePartitionSettings.fromMap(
      ...
      rfcTableFields: (() {
        final guardedValue = map['rfcTableFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      rfcTableOptions: (() {
        final guardedValue = map['rfcTableOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      rowCount: (() {
        final guardedValue = map['rowCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      rowSkips: (() {
        final guardedValue = map['rowSkips'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      sapDataColumnDelimiter: (() {
        final guardedValue = map['sapDataColumnDelimiter'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      sourceRetryCount: (() {
