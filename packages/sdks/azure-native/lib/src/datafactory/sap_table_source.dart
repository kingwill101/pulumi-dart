...
class SapTableSource {
  ...
  final SapTablePartitionSettings? partitionSettings;
  ...
  factory SapTableSource.fromMap(Map<String, dynamic> map) {
    return SapTableSource(
      ...
      partitionSettings: map['partitionSettings'] == null ? null : SapTablePartitionSettings.fromMap((map['partitionSettings'] as Map).cast<String, dynamic>()),
