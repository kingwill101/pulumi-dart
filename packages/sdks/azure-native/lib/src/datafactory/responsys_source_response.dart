...
class ResponsysSourceResponse {
  ...
  /// Creates a new [ResponsysSourceResponse].
  ...
  factory ResponsysSourceResponse.fromMap(Map<String, dynamic> map) {
    return ResponsysSourceResponse(
