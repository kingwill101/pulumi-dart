...
class GoogleSheetsLinkedServiceResponse {
  ...
  /// Creates a new [GoogleSheetsLinkedServiceResponse].
  /// [annotations] List of tags that can be used for describing the linked service.
  /// [apiToken] The api token for the GoogleSheets source.
  ...
  factory GoogleSheetsLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleSheetsLinkedServiceResponse(
      annotations: (() { final guardedValue = map['annotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      apiToken: pulumi.Input.fromValue(AzureKeyVaultSecretReferenceResponse.fromMap((map['apiToken']! as Map).cast<String, dynamic>())),
