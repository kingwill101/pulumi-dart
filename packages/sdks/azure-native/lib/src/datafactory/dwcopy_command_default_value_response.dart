...
class DWCopyCommandDefaultValueResponse {
  ...
  const DWCopyCommandDefaultValueResponse({
    this.columnName,
    this.defaultValue,
  });
  ...
  factory DWCopyCommandDefaultValueResponse.fromMap(Map<String, dynamic> map) {
    return DWCopyCommandDefaultValueResponse(
      columnName: (() { final guardedValue = map['columnName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
