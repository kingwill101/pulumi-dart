...
import 'teradata_import_command.dart';
...
class TeradataSink {
  ...
  final pulumi.Input<TeradataImportCommand>? importSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'importSettings': ?pulumi.Input.mapOptionalInputValue<TeradataImportCommand, Map<String, dynamic>>(importSettings, (value) => value.toMap()),
  ...
  factory TeradataSink.fromMap(Map<String, dynamic> map) {
    return TeradataSink(
      ...
      importSettings: (() { final guardedValue = map['importSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TeradataImportCommand.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
