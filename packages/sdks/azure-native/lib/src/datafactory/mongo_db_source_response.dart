...
class MongoDbSourceResponse {
  ...
  /// Creates a new [MongoDbSourceResponse].
  ...
  factory MongoDbSourceResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbSourceResponse(
