...
class InformixLinkedServiceResponse {
  ...
  /// Creates a new [InformixLinkedServiceResponse].
  ...
  factory InformixLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return InformixLinkedServiceResponse(
