...
class ExecuteSSISPackageActivity {
  ...
  final pulumi.Input<Map<String, Map<String, SSISExecutionParameter>>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'packageConnectionManagers':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, Map<String, SSISExecutionParameter>>,
            Map<String, Map<String, Map<String, dynamic>>>
          >(
            packageConnectionManagers,
            (value) =>
                pulumi.Input.encodeMapValues<
                  Map<String, SSISExecutionParameter>,
      ...
      'packageLocation':
          pulumi.Input.mapInputValue<SSISPackageLocation, Map<String, dynamic>>(
            packageLocation,
            (value) => value.toMap(),
          ),
      'packageParameters':
      ...
      'propertyOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, SSISPropertyOverride>,
            Map<String, Map<String, dynamic>>
          >(
            propertyOverrides,
            (value) =>
  ...
  factory ExecuteSSISPackageActivity.fromMap(Map<String, dynamic> map) {
    return ExecuteSSISPackageActivity(
      ...
      executionCredential: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSISExecutionCredential.fromMap(
      ...
      packageConnectionManagers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<Map<String, SSISExecutionParameter>>(
            guardedValue,
            (value) => pulumi.Input.decodeMapValues<SSISExecutionParameter>(
              value,
              (value) => SSISExecutionParameter.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
            ),
          ),
      ...
      packageParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SSISExecutionParameter>(
            guardedValue,
            (value) => SSISExecutionParameter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
      ...
      propertyOverrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SSISPropertyOverride>(
            guardedValue,
            (value) => SSISPropertyOverride.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
