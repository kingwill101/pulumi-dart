...
class EloquaObjectDatasetResponse {
  ...
  /// Creates a new [EloquaObjectDatasetResponse].
  ...
  const EloquaObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory EloquaObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return EloquaObjectDatasetResponse(
