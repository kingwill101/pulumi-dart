...
class SalesforceServiceCloudLinkedServiceResponse {
  ...
  final pulumi.Input<dynamic>? securityToken;
  ...
  const SalesforceServiceCloudLinkedServiceResponse({
    this.annotations,
    this.apiVersion,
    this.connectVia,
    this.description,
  ...
  factory SalesforceServiceCloudLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceServiceCloudLinkedServiceResponse(
      ...
      securityToken: (() { final guardedValue = map['securityToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
