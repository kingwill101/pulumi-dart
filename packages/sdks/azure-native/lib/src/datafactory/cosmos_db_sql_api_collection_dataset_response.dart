...
class CosmosDbSqlApiCollectionDatasetResponse {
  ...
  /// Creates a new [CosmosDbSqlApiCollectionDatasetResponse].
  ...
  const CosmosDbSqlApiCollectionDatasetResponse({
    this.annotations,
  ...
  factory CosmosDbSqlApiCollectionDatasetResponse.fromMap(Map<String, dynamic> map) {
    return CosmosDbSqlApiCollectionDatasetResponse(
