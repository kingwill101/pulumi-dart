...
class FileServerReadSettingsResponse {
  ...
  /// Creates a new [FileServerReadSettingsResponse].
  ...
  factory FileServerReadSettingsResponse.fromMap(Map<String, dynamic> map) {
    return FileServerReadSettingsResponse(
