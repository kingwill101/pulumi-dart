...
class SnowflakeLinkedServiceResponse {
  ...
  /// Creates a new [SnowflakeLinkedServiceResponse].
  ...
  const SnowflakeLinkedServiceResponse({
    this.annotations,
    this.connectVia,
  ...
  factory SnowflakeLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SnowflakeLinkedServiceResponse(
