...
class FactoryGitHubConfiguration {
  ...
  factory FactoryGitHubConfiguration.fromMap(Map<String, dynamic> map) {
    return FactoryGitHubConfiguration(
      ...
      clientSecret: (() { final guardedValue = map['clientSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GitHubClientSecret.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
