...
class SparkSourceResponse {
  ...
  /// Creates a new [SparkSourceResponse].
  ...
  factory SparkSourceResponse.fromMap(Map<String, dynamic> map) {
    return SparkSourceResponse(
