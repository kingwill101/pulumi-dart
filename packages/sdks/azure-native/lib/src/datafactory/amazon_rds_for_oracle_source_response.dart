...
import 'amazon_rds_for_oracle_partition_settings_response.dart';

/// A copy activity AmazonRdsForOracle source.
class AmazonRdsForOracleSourceResponse {
  ...
  /// Creates a new [AmazonRdsForOracleSourceResponse].
  ...
  const AmazonRdsForOracleSourceResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionSettings': ?pulumi.Input.mapOptionalInputValue<AmazonRdsForOraclePartitionSettingsResponse, Map<String, dynamic>>(partitionSettings, (value) => value.toMap()),
  ...
  factory AmazonRdsForOracleSourceResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForOracleSourceResponse(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AmazonRdsForOraclePartitionSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
