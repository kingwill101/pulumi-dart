...
class AmazonRdsForOracleSourceResponse {
  ...
  final pulumi.Input<AmazonRdsForOraclePartitionSettingsResponse>?
  partitionSettings;
  ...
  factory AmazonRdsForOracleSourceResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForOracleSourceResponse(
      ...
      numberPrecision: (() {
        final guardedValue = map['numberPrecision'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      numberScale: (() {
        final guardedValue = map['numberScale'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      oracleReaderQuery: (() {
        final guardedValue = map['oracleReaderQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      partitionOption: (() {
      ...
      partitionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          AmazonRdsForOraclePartitionSettingsResponse.fromMap(
