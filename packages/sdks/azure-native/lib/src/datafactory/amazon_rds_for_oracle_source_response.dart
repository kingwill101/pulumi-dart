...
class AmazonRdsForOracleSourceResponse {
  ...
  factory AmazonRdsForOracleSourceResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForOracleSourceResponse(
      ...
      partitionSettings: map['partitionSettings'] == null ? null : (AmazonRdsForOraclePartitionSettingsResponse.fromMap((map['partitionSettings']! as Map).cast<String, dynamic>())).input(),
