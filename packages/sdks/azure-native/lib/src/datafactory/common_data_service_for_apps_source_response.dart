...
class CommonDataServiceForAppsSourceResponse {
  ...
  /// Creates a new [CommonDataServiceForAppsSourceResponse].
  ...
  const CommonDataServiceForAppsSourceResponse({
  ...
  factory CommonDataServiceForAppsSourceResponse.fromMap(Map<String, dynamic> map) {
    return CommonDataServiceForAppsSourceResponse(
