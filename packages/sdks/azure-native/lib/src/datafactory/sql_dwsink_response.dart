...
class SqlDWSinkResponse {
  ...
  factory SqlDWSinkResponse.fromMap(Map<String, dynamic> map) {
    return SqlDWSinkResponse(
      ...
      polyBaseSettings: map['polyBaseSettings'] == null ? null : (PolybaseSettingsResponse.fromMap((map['polyBaseSettings']! as Map).cast<String, dynamic>())).input(),
      ...
      upsertSettings: map['upsertSettings'] == null ? null : (SqlDWUpsertSettingsResponse.fromMap((map['upsertSettings']! as Map).cast<String, dynamic>())).input(),
