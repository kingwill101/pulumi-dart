...
class AzureSqlDWTableDataset {
  ...
  /// Creates a new [AzureSqlDWTableDataset].
  ...
  factory AzureSqlDWTableDataset.fromMap(Map<String, dynamic> map) {
    return AzureSqlDWTableDataset(
