...
class GoogleBigQueryV2LinkedService {
  ...
  factory GoogleBigQueryV2LinkedService.fromMap(Map<String, dynamic> map) {
    return GoogleBigQueryV2LinkedService(
      ...
      keyFileContent: (() { final guardedValue = map['keyFileContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
