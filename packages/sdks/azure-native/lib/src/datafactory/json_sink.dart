...
class JsonSink {
  ...
  final JsonWriteSettings? formatSettings;
  ...
  factory JsonSink.fromMap(Map<String, dynamic> map) {
    return JsonSink(
      ...
      formatSettings: map['formatSettings'] == null ? null : JsonWriteSettings.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
