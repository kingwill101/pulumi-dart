...
class DynamicsLinkedServiceResponse {
  ...
  /// Creates a new [DynamicsLinkedServiceResponse].
  ...
  factory DynamicsLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return DynamicsLinkedServiceResponse(
