...
class SalesforceMarketingCloudObjectDatasetResponse {
  ...
  /// Creates a new [SalesforceMarketingCloudObjectDatasetResponse].
  ...
  const SalesforceMarketingCloudObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SalesforceMarketingCloudObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceMarketingCloudObjectDatasetResponse(
