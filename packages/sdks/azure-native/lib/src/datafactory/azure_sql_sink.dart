...
class AzureSqlSink {
  ...
  factory AzureSqlSink.fromMap(Map<String, dynamic> map) {
    return AzureSqlSink(
      ...
      upsertSettings: (() { final guardedValue = map['upsertSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SqlUpsertSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
