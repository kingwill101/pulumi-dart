...
class GoogleAdWordsObjectDatasetResponse {
  ...
  /// Creates a new [GoogleAdWordsObjectDatasetResponse].
  ...
  const GoogleAdWordsObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory GoogleAdWordsObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return GoogleAdWordsObjectDatasetResponse(
