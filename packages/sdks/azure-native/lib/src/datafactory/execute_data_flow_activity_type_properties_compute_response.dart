...
class ExecuteDataFlowActivityTypePropertiesComputeResponse {
  ...
  /// Creates a new [ExecuteDataFlowActivityTypePropertiesComputeResponse].
  ...
  const ExecuteDataFlowActivityTypePropertiesComputeResponse({
    this.computeType,
    this.coreCount,
  });
  ...
  factory ExecuteDataFlowActivityTypePropertiesComputeResponse.fromMap(Map<String, dynamic> map) {
    return ExecuteDataFlowActivityTypePropertiesComputeResponse(
