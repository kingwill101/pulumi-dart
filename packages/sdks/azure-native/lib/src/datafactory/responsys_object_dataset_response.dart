...
/// Responsys dataset.
class ResponsysObjectDatasetResponse {
  ...
  /// Creates a new [ResponsysObjectDatasetResponse].
  ...
  const ResponsysObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory ResponsysObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ResponsysObjectDatasetResponse(
