...
class MagentoSourceResponse {
  ...
  /// Creates a new [MagentoSourceResponse].
  ...
  factory MagentoSourceResponse.fromMap(Map<String, dynamic> map) {
    return MagentoSourceResponse(
