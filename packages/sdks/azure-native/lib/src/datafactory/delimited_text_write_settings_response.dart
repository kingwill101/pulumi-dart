...
class DelimitedTextWriteSettingsResponse {
  ...
  const DelimitedTextWriteSettingsResponse({
  ...
  factory DelimitedTextWriteSettingsResponse.fromMap(Map<String, dynamic> map) {
    return DelimitedTextWriteSettingsResponse(
      ...
      quoteAllText: (() { final guardedValue = map['quoteAllText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
