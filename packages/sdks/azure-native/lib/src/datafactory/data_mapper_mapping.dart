...
class DataMapperMapping {
  ...
  factory DataMapperMapping.fromMap(Map<String, dynamic> map) {
    return DataMapperMapping(
      attributeMappingInfo: (() { final guardedValue = map['attributeMappingInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MapperAttributeMappings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sourceConnectionReference: (() { final guardedValue = map['sourceConnectionReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MapperConnectionReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
