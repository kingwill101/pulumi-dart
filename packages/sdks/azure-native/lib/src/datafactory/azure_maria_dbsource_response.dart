...
class AzureMariaDBSourceResponse {
  ...
  /// Creates a new [AzureMariaDBSourceResponse].
  ...
  const AzureMariaDBSourceResponse({
  ...
  factory AzureMariaDBSourceResponse.fromMap(Map<String, dynamic> map) {
    return AzureMariaDBSourceResponse(
