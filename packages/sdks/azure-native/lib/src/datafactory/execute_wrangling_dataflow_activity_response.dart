...
class ExecuteWranglingDataflowActivityResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'queries':
          ?pulumi.Input.mapOptionalInputValue<
            List<PowerQuerySinkMappingResponse>,
            List<Map<String, dynamic>>
          >(
            queries,
            (value) =>
      ...
      'sinks':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, PowerQuerySinkResponse>,
  ...
  factory ExecuteWranglingDataflowActivityResponse.fromMap(
    ...
    return ExecuteWranglingDataflowActivityResponse(
      ...
      queries: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PowerQuerySinkMappingResponse>(
            guardedValue,
            (value) => PowerQuerySinkMappingResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sinks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<PowerQuerySinkResponse>(
            guardedValue,
            (value) => PowerQuerySinkResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
