...
class MongoDbAtlasSourceResponse {
  ...
  final MongoDbCursorMethodsPropertiesResponse? cursorMethods;
  ...
  factory MongoDbAtlasSourceResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbAtlasSourceResponse(
      ...
      cursorMethods: map['cursorMethods'] == null ? null : MongoDbCursorMethodsPropertiesResponse.fromMap((map['cursorMethods'] as Map).cast<String, dynamic>()),
