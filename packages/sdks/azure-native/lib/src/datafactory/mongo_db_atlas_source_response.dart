...
class MongoDbAtlasSourceResponse {
  ...
  /// Creates a new [MongoDbAtlasSourceResponse].
  ...
  const MongoDbAtlasSourceResponse({
  ...
  factory MongoDbAtlasSourceResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbAtlasSourceResponse(
      ...
      cursorMethods: (() { final guardedValue = map['cursorMethods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MongoDbCursorMethodsPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
