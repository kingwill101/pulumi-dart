...
class SqlServerTableDatasetResponse {
  ...
  /// Creates a new [SqlServerTableDatasetResponse].
  ...
  const SqlServerTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SqlServerTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SqlServerTableDatasetResponse(
