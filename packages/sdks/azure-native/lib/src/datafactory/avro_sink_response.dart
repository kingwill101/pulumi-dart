...
class AvroSinkResponse {
  ...
  final pulumi.Input<AvroWriteSettingsResponse>? formatSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<AvroWriteSettingsResponse, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory AvroSinkResponse.fromMap(Map<String, dynamic> map) {
    return AvroSinkResponse(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AvroWriteSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
