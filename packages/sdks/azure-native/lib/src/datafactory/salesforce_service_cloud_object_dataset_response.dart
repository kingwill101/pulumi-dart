...
class SalesforceServiceCloudObjectDatasetResponse {
  ...
  /// Creates a new [SalesforceServiceCloudObjectDatasetResponse].
  ...
  const SalesforceServiceCloudObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SalesforceServiceCloudObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceServiceCloudObjectDatasetResponse(
