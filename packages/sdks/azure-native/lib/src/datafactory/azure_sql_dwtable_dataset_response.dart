...
class AzureSqlDWTableDatasetResponse {
  ...
  /// Creates a new [AzureSqlDWTableDatasetResponse].
  ...
  const AzureSqlDWTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory AzureSqlDWTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AzureSqlDWTableDatasetResponse(
