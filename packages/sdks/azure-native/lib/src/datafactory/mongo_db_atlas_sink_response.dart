...
class MongoDbAtlasSinkResponse {
  ...
  /// Creates a new [MongoDbAtlasSinkResponse].
  ...
  const MongoDbAtlasSinkResponse({
  ...
  factory MongoDbAtlasSinkResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbAtlasSinkResponse(
