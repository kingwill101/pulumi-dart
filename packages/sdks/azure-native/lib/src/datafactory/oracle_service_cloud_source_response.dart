...
class OracleServiceCloudSourceResponse {
  ...
  /// Creates a new [OracleServiceCloudSourceResponse].
  ...
  const OracleServiceCloudSourceResponse({
  ...
  factory OracleServiceCloudSourceResponse.fromMap(Map<String, dynamic> map) {
    return OracleServiceCloudSourceResponse(
