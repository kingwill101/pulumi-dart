...
class AmazonRdsForOracleTableDatasetResponse {
  ...
  /// Creates a new [AmazonRdsForOracleTableDatasetResponse].
  ...
  const AmazonRdsForOracleTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory AmazonRdsForOracleTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForOracleTableDatasetResponse(
