...
class MapperTargetConnectionsInfoResponse {
  ...
  factory MapperTargetConnectionsInfoResponse.fromMap(Map<String, dynamic> map) {
    return MapperTargetConnectionsInfoResponse(
      ...
      dataMapperMappings: (() { final guardedValue = map['dataMapperMappings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DataMapperMappingResponse>(guardedValue, (value) => DataMapperMappingResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      targetEntities: (() { final guardedValue = map['targetEntities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MapperTableResponse>(guardedValue, (value) => MapperTableResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
