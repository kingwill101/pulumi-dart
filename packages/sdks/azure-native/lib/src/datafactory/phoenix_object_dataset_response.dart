...
class PhoenixObjectDatasetResponse {
  ...
  /// Creates a new [PhoenixObjectDatasetResponse].
  ...
  factory PhoenixObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return PhoenixObjectDatasetResponse(
