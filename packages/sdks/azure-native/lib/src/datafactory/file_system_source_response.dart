...
class FileSystemSourceResponse {
  ...
  /// Creates a new [FileSystemSourceResponse].
  ...
  const FileSystemSourceResponse({
  ...
  factory FileSystemSourceResponse.fromMap(Map<String, dynamic> map) {
    return FileSystemSourceResponse(
