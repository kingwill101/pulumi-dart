...
class CouchbaseTableDatasetResponse {
  ...
  /// Creates a new [CouchbaseTableDatasetResponse].
  ...
  const CouchbaseTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory CouchbaseTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return CouchbaseTableDatasetResponse(
