...
class MapperSourceConnectionsInfoResponse {
  ...
  MapperSourceConnectionsInfoResponse({this.connection, this.sourceEntities});
  ...
  factory MapperSourceConnectionsInfoResponse.fromMap(
    ...
    return MapperSourceConnectionsInfoResponse(
      ...
      sourceEntities: (() {
        final guardedValue = map['sourceEntities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
