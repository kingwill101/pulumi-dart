...
class GoogleCloudStorageReadSettings {
  ...
  /// Creates a new [GoogleCloudStorageReadSettings].
  ...
  factory GoogleCloudStorageReadSettings.fromMap(Map<String, dynamic> map) {
    return GoogleCloudStorageReadSettings(
