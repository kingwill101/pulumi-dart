...
class GoogleAdWordsSourceResponse {
  ...
  /// Creates a new [GoogleAdWordsSourceResponse].
  ...
  const GoogleAdWordsSourceResponse({
  ...
  factory GoogleAdWordsSourceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleAdWordsSourceResponse(
