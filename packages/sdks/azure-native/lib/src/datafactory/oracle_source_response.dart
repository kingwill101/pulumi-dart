...
class OracleSourceResponse {
  ...
  factory OracleSourceResponse.fromMap(Map<String, dynamic> map) {
    return OracleSourceResponse(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OraclePartitionSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
