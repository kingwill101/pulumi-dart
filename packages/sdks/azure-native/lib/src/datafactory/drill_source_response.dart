...
class DrillSourceResponse {
  ...
  /// Creates a new [DrillSourceResponse].
  ...
  factory DrillSourceResponse.fromMap(Map<String, dynamic> map) {
    return DrillSourceResponse(
