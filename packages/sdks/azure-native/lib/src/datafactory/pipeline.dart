...
class Pipeline extends pulumi.CustomResource {
  ...
  Pipeline(
    ...
    folder = registerOutput<PipelineResponseFolder?>('folder', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return PipelineResponseFolder.fromMap((guardedValue as Map).cast<String, dynamic>()); });
