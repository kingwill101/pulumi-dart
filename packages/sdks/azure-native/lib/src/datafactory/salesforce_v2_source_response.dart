...
class SalesforceV2SourceResponse {
  ...
  /// Creates a new [SalesforceV2SourceResponse].
  ...
  const SalesforceV2SourceResponse({
  ...
  factory SalesforceV2SourceResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceV2SourceResponse(
