...
class PipelinePolicyResponse {
  ...
  final pulumi.Input<PipelineElapsedTimeMetricPolicyResponse>?
  elapsedTimeMetric;

  /// Creates a new [PipelinePolicyResponse].
  /// [elapsedTimeMetric] Pipeline ElapsedTime Metric Policy.
  PipelinePolicyResponse({this.elapsedTimeMetric});
    ...
    return PipelinePolicyResponse(
      elapsedTimeMetric: (() {
        ...
        return pulumi.Input.fromValue(
          PipelineElapsedTimeMetricPolicyResponse.fromMap(
