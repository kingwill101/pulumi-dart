...
class AzureMySqlTableDatasetResponse {
  ...
  /// Creates a new [AzureMySqlTableDatasetResponse].
  ...
  const AzureMySqlTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory AzureMySqlTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AzureMySqlTableDatasetResponse(
