...
class MarketoSourceResponse {
  ...
  /// Creates a new [MarketoSourceResponse].
  ...
  factory MarketoSourceResponse.fromMap(Map<String, dynamic> map) {
    return MarketoSourceResponse(
