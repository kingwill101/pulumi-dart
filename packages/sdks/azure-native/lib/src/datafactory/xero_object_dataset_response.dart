...
class XeroObjectDatasetResponse {
  ...
  /// Creates a new [XeroObjectDatasetResponse].
  ...
  const XeroObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory XeroObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return XeroObjectDatasetResponse(
