...
class SalesforceServiceCloudV2LinkedService {
  ...
  factory SalesforceServiceCloudV2LinkedService.fromMap(Map<String, dynamic> map) {
    return SalesforceServiceCloudV2LinkedService(
