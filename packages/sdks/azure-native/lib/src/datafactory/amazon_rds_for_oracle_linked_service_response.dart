...
class AmazonRdsForOracleLinkedServiceResponse {
  ...
  /// Creates a new [AmazonRdsForOracleLinkedServiceResponse].
  ...
  factory AmazonRdsForOracleLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForOracleLinkedServiceResponse(
