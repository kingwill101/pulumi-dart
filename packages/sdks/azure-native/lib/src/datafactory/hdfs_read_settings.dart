...
class HdfsReadSettings {
  ...
  factory HdfsReadSettings.fromMap(Map<String, dynamic> map) {
    return HdfsReadSettings(
      ...
      distcpSettings: (() { final guardedValue = map['distcpSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DistcpSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
