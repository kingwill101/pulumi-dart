...
class PostgreSqlV2SourceResponse {
  ...
  /// Creates a new [PostgreSqlV2SourceResponse].
  ...
  const PostgreSqlV2SourceResponse({
  ...
  factory PostgreSqlV2SourceResponse.fromMap(Map<String, dynamic> map) {
    return PostgreSqlV2SourceResponse(
