...
class SSISPackageLocation {
  ...
  factory SSISPackageLocation.fromMap(Map<String, dynamic> map) {
    return SSISPackageLocation(
      ...
      packagePassword: (() { final guardedValue = map['packagePassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
