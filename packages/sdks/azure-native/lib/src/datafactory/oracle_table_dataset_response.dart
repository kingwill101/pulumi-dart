...
class OracleTableDatasetResponse {
  ...
  /// Creates a new [OracleTableDatasetResponse].
  ...
  factory OracleTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return OracleTableDatasetResponse(
