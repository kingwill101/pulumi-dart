...
class WarehouseSink {
  ...
  factory WarehouseSink.fromMap(Map<String, dynamic> map) {
    return WarehouseSink(
      ...
      copyCommandSettings: (() { final guardedValue = map['copyCommandSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DWCopyCommandSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
