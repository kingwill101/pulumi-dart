...
class AmazonRedshiftSource {
  ...
  factory AmazonRedshiftSource.fromMap(Map<String, dynamic> map) {
    return AmazonRedshiftSource(
      ...
      redshiftUnloadSettings: (() { final guardedValue = map['redshiftUnloadSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RedshiftUnloadSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
