...
class OracleSource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionSettings': ?pulumi.Input.mapOptionalInputValue<OraclePartitionSettings, Map<String, dynamic>>(partitionSettings, (value) => value.toMap()),
  ...
  factory OracleSource.fromMap(Map<String, dynamic> map) {
    return OracleSource(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OraclePartitionSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
