...
class SalesforceSourceResponse {
  ...
  /// Creates a new [SalesforceSourceResponse].
  ...
  const SalesforceSourceResponse({
  ...
  factory SalesforceSourceResponse.fromMap(Map<String, dynamic> map) {
