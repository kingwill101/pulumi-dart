...
class MongoDbAtlasCollectionDatasetResponse {
  ...
  /// Creates a new [MongoDbAtlasCollectionDatasetResponse].
  ...
  const MongoDbAtlasCollectionDatasetResponse({
    this.annotations,
  ...
  factory MongoDbAtlasCollectionDatasetResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbAtlasCollectionDatasetResponse(
