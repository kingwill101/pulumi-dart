...
class AzureBlobStorageReadSettingsResponse {
  ...
  /// Creates a new [AzureBlobStorageReadSettingsResponse].
  ...
  const AzureBlobStorageReadSettingsResponse({
  ...
  factory AzureBlobStorageReadSettingsResponse.fromMap(Map<String, dynamic> map) {
    return AzureBlobStorageReadSettingsResponse(
