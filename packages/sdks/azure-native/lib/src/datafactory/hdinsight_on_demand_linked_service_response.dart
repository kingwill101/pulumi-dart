...
class HDInsightOnDemandLinkedServiceResponse {
  ...
  factory HDInsightOnDemandLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return HDInsightOnDemandLinkedServiceResponse(
      additionalLinkedServiceNames: map['additionalLinkedServiceNames'] == null ? null : (pulumi.Input.decodeList<LinkedServiceReferenceResponse>(map['additionalLinkedServiceNames']!, (value) => LinkedServiceReferenceResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      annotations: map['annotations'] == null ? null : ((map['annotations']! as List).cast<dynamic>()).input(),
      clusterNamePrefix: map['clusterNamePrefix'] == null ? null : (map['clusterNamePrefix']!).input(),
      clusterPassword: map['clusterPassword'] == null ? null : (AzureKeyVaultSecretReferenceResponse.fromMap((map['clusterPassword']! as Map).cast<String, dynamic>())).input(),
      ...
      clusterSshPassword: map['clusterSshPassword'] == null ? null : (AzureKeyVaultSecretReferenceResponse.fromMap((map['clusterSshPassword']! as Map).cast<String, dynamic>())).input(),
