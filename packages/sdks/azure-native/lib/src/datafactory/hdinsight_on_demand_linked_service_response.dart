...
class HDInsightOnDemandLinkedServiceResponse {
  ...
  final pulumi.Input<List<LinkedServiceReferenceResponse>>?
    ...
    return <String, dynamic>{
      ...
      'clusterPassword':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(clusterPassword, (value) => value.toMap()),
      ...
      'clusterSshPassword':
          ?pulumi.Input.mapOptionalInputValue<
            AzureKeyVaultSecretReferenceResponse,
            Map<String, dynamic>
          >(clusterSshPassword, (value) => value.toMap()),
      ...
      'hcatalogLinkedServiceName':
          ?pulumi.Input.mapOptionalInputValue<
            LinkedServiceReferenceResponse,
            Map<String, dynamic>
          >(hcatalogLinkedServiceName, (value) => value.toMap()),
  ...
  factory HDInsightOnDemandLinkedServiceResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return HDInsightOnDemandLinkedServiceResponse(
      additionalLinkedServiceNames: (() {
        final guardedValue = map['additionalLinkedServiceNames'];
      ...
      clusterNamePrefix: (() {
        final guardedValue = map['clusterNamePrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      clusterPassword: (() {
        final guardedValue = map['clusterPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      clusterResourceGroupAuthType: (() {
        final guardedValue = map['clusterResourceGroupAuthType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clusterSize: pulumi.Input.fromValue(map['clusterSize']),
      clusterSshPassword: (() {
        final guardedValue = map['clusterSshPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureKeyVaultSecretReferenceResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      clusterSshUserName: (() {
        final guardedValue = map['clusterSshUserName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      clusterType: (() {
      ...
      clusterUserName: (() {
        final guardedValue = map['clusterUserName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      connectVia: (() {
      ...
      coreConfiguration: (() {
        final guardedValue = map['coreConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      credential: (() {
      ...
      dataNodeSize: (() {
        final guardedValue = map['dataNodeSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      description: (() {
      ...
      hBaseConfiguration: (() {
        final guardedValue = map['hBaseConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      hcatalogLinkedServiceName: (() {
        final guardedValue = map['hcatalogLinkedServiceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      hdfsConfiguration: (() {
        final guardedValue = map['hdfsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      headNodeSize: (() {
        final guardedValue = map['headNodeSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      hiveConfiguration: (() {
        final guardedValue = map['hiveConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      ...
      mapReduceConfiguration: (() {
        final guardedValue = map['mapReduceConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      oozieConfiguration: (() {
        final guardedValue = map['oozieConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      parameters: (() {
      ...
      scriptActions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScriptActionResponse>(
            guardedValue,
            (value) => ScriptActionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      stormConfiguration: (() {
        final guardedValue = map['stormConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      subnetName: (() {
      ...
      yarnConfiguration: (() {
        final guardedValue = map['yarnConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      zookeeperNodeSize: (() {
        final guardedValue = map['zookeeperNodeSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
    );
