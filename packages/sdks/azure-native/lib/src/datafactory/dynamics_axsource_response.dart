...
class DynamicsAXSourceResponse {
  ...
  /// Creates a new [DynamicsAXSourceResponse].
  ...
  const DynamicsAXSourceResponse({
  ...
  factory DynamicsAXSourceResponse.fromMap(Map<String, dynamic> map) {
    return DynamicsAXSourceResponse(
