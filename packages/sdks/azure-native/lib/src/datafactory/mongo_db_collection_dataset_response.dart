...
class MongoDbCollectionDatasetResponse {
  ...
  /// Creates a new [MongoDbCollectionDatasetResponse].
  ...
  const MongoDbCollectionDatasetResponse({
    this.annotations,
  ...
  factory MongoDbCollectionDatasetResponse.fromMap(Map<String, dynamic> map) {
    return MongoDbCollectionDatasetResponse(
