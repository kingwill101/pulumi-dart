...
class HubspotObjectDatasetResponse {
  ...
  /// Creates a new [HubspotObjectDatasetResponse].
  ...
  const HubspotObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory HubspotObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return HubspotObjectDatasetResponse(
