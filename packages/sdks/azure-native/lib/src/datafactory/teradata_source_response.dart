...
import 'teradata_partition_settings_response.dart';

/// A copy activity Teradata source.
class TeradataSourceResponse {
  ...
  /// Creates a new [TeradataSourceResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionSettings': ?pulumi.Input.mapOptionalInputValue<TeradataPartitionSettingsResponse, Map<String, dynamic>>(partitionSettings, (value) => value.toMap()),
      'query': ?query,
  ...
  factory TeradataSourceResponse.fromMap(Map<String, dynamic> map) {
    return TeradataSourceResponse(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TeradataPartitionSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
