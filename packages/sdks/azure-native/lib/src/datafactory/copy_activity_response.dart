...
class CopyActivityResponse {
  ...
  final pulumi.Input<RedirectIncompatibleRowSettingsResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sink':
          pulumi.Input.mapInputValue<AvroSinkResponse, Map<String, dynamic>>(
            sink,
            (value) => value.toMap(),
          ),
      'skipErrorFile':
  ...
  factory CopyActivityResponse.fromMap(Map<String, dynamic> map) {
    return CopyActivityResponse(
      ...
      logStorageSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LogStorageSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      redirectIncompatibleRowSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RedirectIncompatibleRowSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sink: pulumi.Input.fromValue(
        AvroSinkResponse.fromMap((map['sink']! as Map).cast<String, dynamic>()),
      ),
      skipErrorFile: (() {
        final guardedValue = map['skipErrorFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SkipErrorFileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      source: pulumi.Input.fromValue(
        AmazonMWSSourceResponse.fromMap(
      ...
      stagingSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StagingSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
