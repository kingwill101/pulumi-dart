...
/// Vertica dataset.
class VerticaTableDatasetResponse {
  ...
  /// Creates a new [VerticaTableDatasetResponse].
  ...
  factory VerticaTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return VerticaTableDatasetResponse(
      annotations: (() {
