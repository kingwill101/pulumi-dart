...
class AzureDataLakeStoreSink {
  ...
  final pulumi.Input<dynamic>? enableAdlsSingleFileParallel;
  ...
  factory AzureDataLakeStoreSink.fromMap(Map<String, dynamic> map) {
    return AzureDataLakeStoreSink(
      ...
      enableAdlsSingleFileParallel: (() { final guardedValue = map['enableAdlsSingleFileParallel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
