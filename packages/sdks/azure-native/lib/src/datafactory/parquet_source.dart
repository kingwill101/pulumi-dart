...
class ParquetSource {
  ...
  factory ParquetSource.fromMap(Map<String, dynamic> map) {
    return ParquetSource(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ParquetReadSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
