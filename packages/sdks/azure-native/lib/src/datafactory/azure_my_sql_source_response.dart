...
class AzureMySqlSourceResponse {
  ...
  /// Creates a new [AzureMySqlSourceResponse].
  ...
  const AzureMySqlSourceResponse({
  ...
  factory AzureMySqlSourceResponse.fromMap(Map<String, dynamic> map) {
    return AzureMySqlSourceResponse(
