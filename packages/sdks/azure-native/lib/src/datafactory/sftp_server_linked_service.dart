...
class SftpServerLinkedService {
  ...
  factory SftpServerLinkedService.fromMap(Map<String, dynamic> map) {
    return SftpServerLinkedService(
      ...
      passPhrase: (() { final guardedValue = map['passPhrase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      privateKeyContent: (() { final guardedValue = map['privateKeyContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
