...
class AsanaLinkedService {
  ...
  /// Creates a new [AsanaLinkedService].
  /// [annotations] List of tags that can be used for describing the linked service.
  /// [apiToken] The api token for the Asana source.
  ...
  factory AsanaLinkedService.fromMap(Map<String, dynamic> map) {
    return AsanaLinkedService(
      annotations: (() { final guardedValue = map['annotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      apiToken: pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((map['apiToken']! as Map).cast<String, dynamic>())),
