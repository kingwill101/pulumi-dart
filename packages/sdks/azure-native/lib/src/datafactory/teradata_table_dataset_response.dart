...
class TeradataTableDatasetResponse {
  ...
  /// Creates a new [TeradataTableDatasetResponse].
  ...
  const TeradataTableDatasetResponse({
    this.annotations,
    this.database,
    this.description,
    this.folder,
  ...
  factory TeradataTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return TeradataTableDatasetResponse(
