...
class SnowflakeV2DatasetResponse {
  ...
  /// Creates a new [SnowflakeV2DatasetResponse].
  ...
  factory SnowflakeV2DatasetResponse.fromMap(Map<String, dynamic> map) {
    return SnowflakeV2DatasetResponse(
