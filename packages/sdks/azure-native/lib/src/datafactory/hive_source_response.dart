...
class HiveSourceResponse {
  ...
  /// Creates a new [HiveSourceResponse].
  ...
  factory HiveSourceResponse.fromMap(Map<String, dynamic> map) {
    return HiveSourceResponse(
