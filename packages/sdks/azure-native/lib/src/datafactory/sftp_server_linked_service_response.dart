...
class SftpServerLinkedServiceResponse {
  ...
  const SftpServerLinkedServiceResponse({
    this.annotations,
  ...
  factory SftpServerLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SftpServerLinkedServiceResponse(
      ...
      hostKeyFingerprint: (() { final guardedValue = map['hostKeyFingerprint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ParameterSpecificationResponse>(guardedValue, (value) => ParameterSpecificationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      passPhrase: (() { final guardedValue = map['passPhrase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      privateKeyContent: (() { final guardedValue = map['privateKeyContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      privateKeyPath: (() { final guardedValue = map['privateKeyPath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      skipHostKeyValidation: (() { final guardedValue = map['skipHostKeyValidation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
