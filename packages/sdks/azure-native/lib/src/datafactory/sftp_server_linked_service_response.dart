...
class SftpServerLinkedServiceResponse {
  ...
  final pulumi.Input<dynamic>? passPhrase;
  ...
  final pulumi.Input<dynamic>? privateKeyContent;
  ...
  factory SftpServerLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SftpServerLinkedServiceResponse(
      ...
      passPhrase: (() { final guardedValue = map['passPhrase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      privateKeyContent: (() { final guardedValue = map['privateKeyContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
