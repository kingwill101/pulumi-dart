...
class SftpServerLinkedServiceResponse {
  ...
  final AzureKeyVaultSecretReferenceResponse? passPhrase;
  ...
  final AzureKeyVaultSecretReferenceResponse? privateKeyContent;
  ...
  factory SftpServerLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SftpServerLinkedServiceResponse(
      ...
      passPhrase: map['passPhrase'] == null ? null : AzureKeyVaultSecretReferenceResponse.fromMap((map['passPhrase'] as Map).cast<String, dynamic>()),
      ...
      privateKeyContent: map['privateKeyContent'] == null ? null : AzureKeyVaultSecretReferenceResponse.fromMap((map['privateKeyContent'] as Map).cast<String, dynamic>()),
