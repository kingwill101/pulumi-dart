...
class OracleServiceCloudObjectDatasetResponse {
  ...
  /// Creates a new [OracleServiceCloudObjectDatasetResponse].
  ...
  const OracleServiceCloudObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory OracleServiceCloudObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return OracleServiceCloudObjectDatasetResponse(
