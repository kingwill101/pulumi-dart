...
class CosmosDbMongoDbApiLinkedServiceResponse {
  ...
  const CosmosDbMongoDbApiLinkedServiceResponse({
    this.annotations,
    this.connectVia,
  ...
  factory CosmosDbMongoDbApiLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return CosmosDbMongoDbApiLinkedServiceResponse(
      ...
      isServerVersionAbove32: (() { final guardedValue = map['isServerVersionAbove32']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
