...
class AzureDatabricksLinkedServiceResponse {
  ...
  factory AzureDatabricksLinkedServiceResponse.fromMap(
    ...
    return AzureDatabricksLinkedServiceResponse(
      ...
      dataSecurityMode: (() {
        final guardedValue = map['dataSecurityMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      description: (() {
      ...
      newClusterCustomTags: (() {
        final guardedValue = map['newClusterCustomTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      newClusterDriverNodeType: (() {
        final guardedValue = map['newClusterDriverNodeType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      newClusterEnableElasticDisk: (() {
        final guardedValue = map['newClusterEnableElasticDisk'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      newClusterInitScripts: (() {
        final guardedValue = map['newClusterInitScripts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      newClusterLogDestination: (() {
        final guardedValue = map['newClusterLogDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      newClusterNodeType: (() {
        final guardedValue = map['newClusterNodeType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      newClusterNumOfWorker: (() {
        final guardedValue = map['newClusterNumOfWorker'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      newClusterSparkConf: (() {
        final guardedValue = map['newClusterSparkConf'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      newClusterSparkEnvVars: (() {
        final guardedValue = map['newClusterSparkEnvVars'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      newClusterVersion: (() {
        final guardedValue = map['newClusterVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      parameters: (() {
