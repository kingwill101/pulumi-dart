...
class TeradataSource {
  ...
  factory TeradataSource.fromMap(Map<String, dynamic> map) {
    return TeradataSource(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TeradataPartitionSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
