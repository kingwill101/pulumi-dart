...
class TeradataSource {
  ...
  final TeradataPartitionSettings? partitionSettings;
  ...
  factory TeradataSource.fromMap(Map<String, dynamic> map) {
    return TeradataSource(
      ...
      partitionSettings: map['partitionSettings'] == null ? null : TeradataPartitionSettings.fromMap((map['partitionSettings'] as Map).cast<String, dynamic>()),
