...
class SalesforceServiceCloudV2SinkResponse {
  ...
  /// Creates a new [SalesforceServiceCloudV2SinkResponse].
  ...
  const SalesforceServiceCloudV2SinkResponse({
  ...
  factory SalesforceServiceCloudV2SinkResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceServiceCloudV2SinkResponse(
