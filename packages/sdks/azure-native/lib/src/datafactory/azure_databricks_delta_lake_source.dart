...
class AzureDatabricksDeltaLakeSource {
  ...
  factory AzureDatabricksDeltaLakeSource.fromMap(Map<String, dynamic> map) {
    return AzureDatabricksDeltaLakeSource(
      ...
      exportSettings: (() { final guardedValue = map['exportSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureDatabricksDeltaLakeExportCommand.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
