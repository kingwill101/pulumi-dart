...
class HDInsightOnDemandLinkedService {
  ...
  factory HDInsightOnDemandLinkedService.fromMap(Map<String, dynamic> map) {
    return HDInsightOnDemandLinkedService(
      additionalLinkedServiceNames: (() { final guardedValue = map['additionalLinkedServiceNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LinkedServiceReference>(guardedValue, (value) => LinkedServiceReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      clusterPassword: (() { final guardedValue = map['clusterPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      clusterSshPassword: (() { final guardedValue = map['clusterSshPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
