...
class HDInsightOnDemandLinkedService {
  ...
  final List<LinkedServiceReference>? additionalLinkedServiceNames;
  /// List of tags that can be used for describing the linked service.
  final List<dynamic>? annotations;
  /// The prefix of cluster name, postfix will be distinct with timestamp. Type: string (or Expression with resultType string).
  final dynamic clusterNamePrefix;
  /// The password to access the cluster.
  final AzureKeyVaultSecretReference? clusterPassword;
  ...
  final AzureKeyVaultSecretReference? clusterSshPassword;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalLinkedServiceNames': ?additionalLinkedServiceNames == null ? null : pulumi.Input.encodeList<LinkedServiceReference, Map<String, dynamic>>(additionalLinkedServiceNames!, (value) => value.toMap()),
  ...
  factory HDInsightOnDemandLinkedService.fromMap(Map<String, dynamic> map) {
    return HDInsightOnDemandLinkedService(
      additionalLinkedServiceNames: map['additionalLinkedServiceNames'] == null ? null : pulumi.Input.decodeList<LinkedServiceReference>(map['additionalLinkedServiceNames'], (value) => LinkedServiceReference.fromMap((value as Map).cast<String, dynamic>())),
      annotations: map['annotations'] == null ? null : (map['annotations'] as List).cast<dynamic>(),
      clusterNamePrefix: map['clusterNamePrefix'] == null ? null : map['clusterNamePrefix'],
      clusterPassword: map['clusterPassword'] == null ? null : AzureKeyVaultSecretReference.fromMap((map['clusterPassword'] as Map).cast<String, dynamic>()),
      ...
      clusterSshPassword: map['clusterSshPassword'] == null ? null : AzureKeyVaultSecretReference.fromMap((map['clusterSshPassword'] as Map).cast<String, dynamic>()),
