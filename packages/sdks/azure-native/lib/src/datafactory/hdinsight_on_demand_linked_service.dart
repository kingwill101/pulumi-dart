...
class HDInsightOnDemandLinkedService {
  ...
  final pulumi.Input<dynamic>? clusterResourceGroupAuthType;
  ...
  factory HDInsightOnDemandLinkedService.fromMap(Map<String, dynamic> map) {
    return HDInsightOnDemandLinkedService(
      ...
      clusterResourceGroupAuthType: (() { final guardedValue = map['clusterResourceGroupAuthType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
