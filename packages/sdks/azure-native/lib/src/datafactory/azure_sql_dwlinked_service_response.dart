...
class AzureSqlDWLinkedServiceResponse {
  ...
  /// Creates a new [AzureSqlDWLinkedServiceResponse].
  ...
  const AzureSqlDWLinkedServiceResponse({
    this.annotations,
  ...
  factory AzureSqlDWLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return AzureSqlDWLinkedServiceResponse(
