...
class DynamicsSourceResponse {
  ...
  /// Creates a new [DynamicsSourceResponse].
  ...
  factory DynamicsSourceResponse.fromMap(Map<String, dynamic> map) {
    return DynamicsSourceResponse(
