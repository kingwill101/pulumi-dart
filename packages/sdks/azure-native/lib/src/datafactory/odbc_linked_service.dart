...
class OdbcLinkedService {
  ...
  final AzureKeyVaultSecretReference? credential;
  ...
  factory OdbcLinkedService.fromMap(Map<String, dynamic> map) {
    return OdbcLinkedService(
      ...
      credential: map['credential'] == null ? null : AzureKeyVaultSecretReference.fromMap((map['credential'] as Map).cast<String, dynamic>()),
