...
class SalesforceLinkedServiceResponse {
  ...
  /// Creates a new [SalesforceLinkedServiceResponse].
  ...
  factory SalesforceLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SalesforceLinkedServiceResponse(
