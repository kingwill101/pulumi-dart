...
class JsonSource {
  ...
  final pulumi.Input<JsonReadSettings>? formatSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<JsonReadSettings, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory JsonSource.fromMap(Map<String, dynamic> map) {
    return JsonSource(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JsonReadSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
