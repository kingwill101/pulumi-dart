...
class SynapseSparkJobDefinitionActivityResponse {
  ...
  final SynapseSparkJobReferenceResponse sparkJob;
  /// Activity state. This is an optional property and if not provided, the state will be Active by default.
  final String? state;
  /// The name of the big data pool which will be used to execute the spark batch job, which will override the 'targetBigDataPool' of the spark job definition you provide.
  final BigDataPoolParametrizationReferenceResponse? targetBigDataPool;
  ...
  factory SynapseSparkJobDefinitionActivityResponse.fromMap(Map<String, dynamic> map) {
    return SynapseSparkJobDefinitionActivityResponse(
      ...
      sparkJob: SynapseSparkJobReferenceResponse.fromMap((map['sparkJob'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : map['state'] as String,
      targetBigDataPool: map['targetBigDataPool'] == null ? null : BigDataPoolParametrizationReferenceResponse.fromMap((map['targetBigDataPool'] as Map).cast<String, dynamic>()),
