...
class SynapseSparkJobDefinitionActivityResponse {
  ...
  final pulumi.Input<BigDataPoolParametrizationReferenceResponse>?
  targetBigDataPool;
  ...
  factory SynapseSparkJobDefinitionActivityResponse.fromMap(
    ...
    return SynapseSparkJobDefinitionActivityResponse(
      ...
      sparkJob: pulumi.Input.fromValue(
        SynapseSparkJobReferenceResponse.fromMap(
