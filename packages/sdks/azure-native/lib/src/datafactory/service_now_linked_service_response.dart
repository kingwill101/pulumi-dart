...
class ServiceNowLinkedServiceResponse {
  ...
  /// Creates a new [ServiceNowLinkedServiceResponse].
  ...
  factory ServiceNowLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return ServiceNowLinkedServiceResponse(
