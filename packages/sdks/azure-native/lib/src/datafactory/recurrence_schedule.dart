...
class RecurrenceSchedule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'weekDays': ?pulumi.Input.mapOptionalInputValue<List<DaysOfWeek>, List<String>>(weekDays, (value) => pulumi.Input.encodeList<DaysOfWeek, String>(value, (value) => value.wireValue)),
    };
  }
  ...
  factory RecurrenceSchedule.fromMap(Map<String, dynamic> map) {
    return RecurrenceSchedule(
      ...
      monthlyOccurrences: (() { final guardedValue = map['monthlyOccurrences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RecurrenceScheduleOccurrence>(guardedValue, (value) => RecurrenceScheduleOccurrence.fromMap((value as Map).cast<String, dynamic>()))); })(),
      weekDays: (() { final guardedValue = map['weekDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DaysOfWeek>(guardedValue, (value) => DaysOfWeek.fromValue(value as String))); })(),
    );
  }
}
