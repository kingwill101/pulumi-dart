...
class SquareSourceResponse {
  ...
  /// Creates a new [SquareSourceResponse].
  ...
  factory SquareSourceResponse.fromMap(Map<String, dynamic> map) {
    return SquareSourceResponse(
