...
class ServiceNowObjectDatasetResponse {
  ...
  /// Creates a new [ServiceNowObjectDatasetResponse].
  ...
  const ServiceNowObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory ServiceNowObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ServiceNowObjectDatasetResponse(
