...
class DelimitedTextSinkResponse {
  ...
  final pulumi.Input<DelimitedTextWriteSettingsResponse?>? formatSettings;
  ...
  const DelimitedTextSinkResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'formatSettings': ?pulumi.Input.mapOptionalInputValue<DelimitedTextWriteSettingsResponse, Map<String, dynamic>>(formatSettings, (value) => value.toMap()),
  ...
  factory DelimitedTextSinkResponse.fromMap(Map<String, dynamic> map) {
    return DelimitedTextSinkResponse(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DelimitedTextWriteSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
