...
class CosmosDbMongoDbApiSourceResponse {
  ...
  /// Creates a new [CosmosDbMongoDbApiSourceResponse].
  ...
  const CosmosDbMongoDbApiSourceResponse({
  ...
  factory CosmosDbMongoDbApiSourceResponse.fromMap(Map<String, dynamic> map) {
    return CosmosDbMongoDbApiSourceResponse(
