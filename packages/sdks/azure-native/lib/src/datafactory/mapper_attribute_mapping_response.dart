...
class MapperAttributeMappingResponse {
  ...
  final pulumi.Input<List<MapperAttributeReferenceResponse>>?
  attributeReferences;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'attributeReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<MapperAttributeReferenceResponse>,
    ...
    return MapperAttributeMappingResponse(
      attributeReference: (() {
        ...
        return pulumi.Input.fromValue(
          MapperAttributeReferenceResponse.fromMap(
      ...
      attributeReferences: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MapperAttributeReferenceResponse>(
            guardedValue,
            (value) => MapperAttributeReferenceResponse.fromMap(
