...
class IcebergDatasetResponse {
  ...
  /// Creates a new [IcebergDatasetResponse].
  ...
  factory IcebergDatasetResponse.fromMap(Map<String, dynamic> map) {
    return IcebergDatasetResponse(
