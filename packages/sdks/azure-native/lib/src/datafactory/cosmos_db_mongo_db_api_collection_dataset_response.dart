...
class CosmosDbMongoDbApiCollectionDatasetResponse {
  ...
  /// Creates a new [CosmosDbMongoDbApiCollectionDatasetResponse].
  ...
  const CosmosDbMongoDbApiCollectionDatasetResponse({
    this.annotations,
  ...
  factory CosmosDbMongoDbApiCollectionDatasetResponse.fromMap(Map<String, dynamic> map) {
    return CosmosDbMongoDbApiCollectionDatasetResponse(
