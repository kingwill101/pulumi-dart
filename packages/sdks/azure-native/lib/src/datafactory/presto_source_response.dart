...
class PrestoSourceResponse {
  ...
  /// Creates a new [PrestoSourceResponse].
  ...
  factory PrestoSourceResponse.fromMap(Map<String, dynamic> map) {
    return PrestoSourceResponse(
