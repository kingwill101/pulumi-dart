...
class Db2SourceResponse {
  ...
  /// Creates a new [Db2SourceResponse].
  ...
  factory Db2SourceResponse.fromMap(Map<String, dynamic> map) {
    return Db2SourceResponse(
