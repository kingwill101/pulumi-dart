...
class ScriptActivity {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'scripts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScriptActivityScriptBlock>,
            List<Map<String, dynamic>>
          >(
            scripts,
            (value) =>
  ...
  factory ScriptActivity.fromMap(Map<String, dynamic> map) {
    return ScriptActivity(
      ...
      logSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScriptActivityTypePropertiesLogSettings.fromMap(
      ...
      scripts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScriptActivityScriptBlock>(
            guardedValue,
            (value) => ScriptActivityScriptBlock.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
