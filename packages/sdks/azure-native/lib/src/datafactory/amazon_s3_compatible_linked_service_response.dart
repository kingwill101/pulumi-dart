...
class AmazonS3CompatibleLinkedServiceResponse {
  ...
  const AmazonS3CompatibleLinkedServiceResponse({
    this.accessKeyId,
    this.annotations,
    this.connectVia,
    this.description,
  ...
  factory AmazonS3CompatibleLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return AmazonS3CompatibleLinkedServiceResponse(
      ...
      forcePathStyle: (() { final guardedValue = map['forcePathStyle']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
