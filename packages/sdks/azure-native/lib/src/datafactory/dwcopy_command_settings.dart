...
class DWCopyCommandSettings {
  ...
  final List<DWCopyCommandDefaultValue>? defaultValues;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultValues': ?defaultValues == null ? null : pulumi.Input.encodeList<DWCopyCommandDefaultValue, Map<String, dynamic>>(defaultValues!, (value) => value.toMap()),
    };
  }
  ...
  factory DWCopyCommandSettings.fromMap(Map<String, dynamic> map) {
    return DWCopyCommandSettings(
      ...
      defaultValues: map['defaultValues'] == null ? null : pulumi.Input.decodeList<DWCopyCommandDefaultValue>(map['defaultValues'], (value) => DWCopyCommandDefaultValue.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
