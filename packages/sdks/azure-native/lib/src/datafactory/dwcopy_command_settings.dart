...
class DWCopyCommandSettings {
  ...
  DWCopyCommandSettings({this.additionalOptions, this.defaultValues});
  ...
  factory DWCopyCommandSettings.fromMap(Map<String, dynamic> map) {
    return DWCopyCommandSettings(
      ...
      defaultValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DWCopyCommandDefaultValue>(
            guardedValue,
            (value) => DWCopyCommandDefaultValue.fromMap(
