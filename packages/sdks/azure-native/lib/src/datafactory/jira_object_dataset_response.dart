...
class JiraObjectDatasetResponse {
  ...
  /// Creates a new [JiraObjectDatasetResponse].
  ...
  const JiraObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory JiraObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return JiraObjectDatasetResponse(
