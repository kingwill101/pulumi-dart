...
class IntegrationRuntimeSsisPropertiesResponse {
  ...
  final pulumi.Input<List<AzPowerShellSetupResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'expressCustomSetupProperties':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzPowerShellSetupResponse>,
  ...
  factory IntegrationRuntimeSsisPropertiesResponse.fromMap(
    ...
    return IntegrationRuntimeSsisPropertiesResponse(
      ...
      expressCustomSetupProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzPowerShellSetupResponse>(
            guardedValue,
            (value) => AzPowerShellSetupResponse.fromMap(
      ...
      packageStores: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PackageStoreResponse>(
            guardedValue,
            (value) => PackageStoreResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
