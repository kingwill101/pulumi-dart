...
class GoogleBigQueryV2SourceResponse {
  ...
  /// Creates a new [GoogleBigQueryV2SourceResponse].
  ...
  const GoogleBigQueryV2SourceResponse({
  ...
  factory GoogleBigQueryV2SourceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleBigQueryV2SourceResponse(
