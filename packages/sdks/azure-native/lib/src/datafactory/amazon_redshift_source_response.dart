...
class AmazonRedshiftSourceResponse {
  ...
  const AmazonRedshiftSourceResponse({
  ...
  factory AmazonRedshiftSourceResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRedshiftSourceResponse(
      ...
      redshiftUnloadSettings: (() { final guardedValue = map['redshiftUnloadSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RedshiftUnloadSettingsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
