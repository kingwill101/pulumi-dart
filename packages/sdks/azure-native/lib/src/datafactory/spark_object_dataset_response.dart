...
class SparkObjectDatasetResponse {
  ...
  /// Creates a new [SparkObjectDatasetResponse].
  ...
  factory SparkObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SparkObjectDatasetResponse(
