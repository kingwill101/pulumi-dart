...
class PhoenixSourceResponse {
  ...
  /// Creates a new [PhoenixSourceResponse].
  ...
  factory PhoenixSourceResponse.fromMap(Map<String, dynamic> map) {
    return PhoenixSourceResponse(
