...
class DynamicsCrmSinkResponse {
  ...
  /// Creates a new [DynamicsCrmSinkResponse].
  ...
  factory DynamicsCrmSinkResponse.fromMap(Map<String, dynamic> map) {
    return DynamicsCrmSinkResponse(
