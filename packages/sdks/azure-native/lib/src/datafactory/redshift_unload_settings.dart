...
class RedshiftUnloadSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      's3LinkedServiceName': pulumi.Input.mapInputValue<LinkedServiceReference, Map<String, dynamic>>(s3LinkedServiceName, (value) => value.toMap()),
    };
  }
  ...
  factory RedshiftUnloadSettings.fromMap(Map<String, dynamic> map) {
    return RedshiftUnloadSettings(
      ...
      s3LinkedServiceName: pulumi.Input.fromValue(LinkedServiceReference.fromMap((map['s3LinkedServiceName']! as Map).cast<String, dynamic>())),
    );
  }
}
