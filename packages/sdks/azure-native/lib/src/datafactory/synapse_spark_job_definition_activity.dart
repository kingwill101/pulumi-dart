...
class SynapseSparkJobDefinitionActivity {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sparkJob': pulumi.Input.mapInputValue<SynapseSparkJobReference, Map<String, dynamic>>(sparkJob, (value) => value.toMap()),
      'state': ?state,
      'targetBigDataPool': ?pulumi.Input.mapOptionalInputValue<BigDataPoolParametrizationReference, Map<String, dynamic>>(targetBigDataPool, (value) => value.toMap()),
  ...
  factory SynapseSparkJobDefinitionActivity.fromMap(Map<String, dynamic> map) {
    return SynapseSparkJobDefinitionActivity(
      ...
      sparkJob: (SynapseSparkJobReference.fromMap((map['sparkJob'] as Map).cast<String, dynamic>())).input(),
      state: map['state'] == null ? null : (map['state'] as String).input(),
      targetBigDataPool: map['targetBigDataPool'] == null ? null : (BigDataPoolParametrizationReference.fromMap((map['targetBigDataPool'] as Map).cast<String, dynamic>())).input(),
