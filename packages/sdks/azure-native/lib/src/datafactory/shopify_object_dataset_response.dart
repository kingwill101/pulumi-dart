...
class ShopifyObjectDatasetResponse {
  ...
  /// Creates a new [ShopifyObjectDatasetResponse].
  ...
  const ShopifyObjectDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory ShopifyObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ShopifyObjectDatasetResponse(
