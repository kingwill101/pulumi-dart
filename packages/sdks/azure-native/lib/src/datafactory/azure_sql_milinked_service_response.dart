...
class AzureSqlMILinkedServiceResponse {
  /// Sql always encrypted properties.
  final pulumi.Input<SqlAlwaysEncryptedPropertiesResponse>?
  ...
  /// Creates a new [AzureSqlMILinkedServiceResponse].
  ...
  factory AzureSqlMILinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return AzureSqlMILinkedServiceResponse(
      alwaysEncryptedSettings: (() {
        final guardedValue = map['alwaysEncryptedSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SqlAlwaysEncryptedPropertiesResponse.fromMap(
