...
class InformixSourceResponse {
  ...
  /// Creates a new [InformixSourceResponse].
  ...
  factory InformixSourceResponse.fromMap(Map<String, dynamic> map) {
    return InformixSourceResponse(
