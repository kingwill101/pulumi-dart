...
class ResponsysLinkedServiceResponse {
  ...
  /// Creates a new [ResponsysLinkedServiceResponse].
  ...
  const ResponsysLinkedServiceResponse({
    this.annotations,
  ...
  factory ResponsysLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return ResponsysLinkedServiceResponse(
