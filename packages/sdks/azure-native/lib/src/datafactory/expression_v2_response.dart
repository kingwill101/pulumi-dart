...
class ExpressionV2Response {
  ...
  ExpressionV2Response({this.operands, this.operators, this.type, this.value});
  ...
  factory ExpressionV2Response.fromMap(Map<String, dynamic> map) {
    return ExpressionV2Response(
      operands: (() {
        final guardedValue = map['operands'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExpressionV2Response>(
            guardedValue,
            (value) => ExpressionV2Response.fromMap(
      ...
      operators: (() {
        final guardedValue = map['operators'];
        if (guardedValue == null) return null;
