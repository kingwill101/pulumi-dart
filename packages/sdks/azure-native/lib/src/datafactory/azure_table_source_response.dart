...
class AzureTableSourceResponse {
  ...
  const AzureTableSourceResponse({
  ...
  factory AzureTableSourceResponse.fromMap(Map<String, dynamic> map) {
    return AzureTableSourceResponse(
      ...
      azureTableSourceIgnoreTableNotFound: (() { final guardedValue = map['azureTableSourceIgnoreTableNotFound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      azureTableSourceQuery: (() { final guardedValue = map['azureTableSourceQuery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
