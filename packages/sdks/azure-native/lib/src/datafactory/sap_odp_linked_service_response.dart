...
class SapOdpLinkedServiceResponse {
  ...
  factory SapOdpLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SapOdpLinkedServiceResponse(
      ...
      subscriberName: map['subscriberName'] == null ? null : (map['subscriberName']!).input(),
      ...
      x509CertificatePath: map['x509CertificatePath'] == null ? null : (map['x509CertificatePath']!).input(),
    );
  }
}
