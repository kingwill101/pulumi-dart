...
class SapOdpLinkedServiceResponse {
  ...
  final pulumi.Input<dynamic>? subscriberName;
  ...
  /// Creates a new [SapOdpLinkedServiceResponse].
  ...
  factory SapOdpLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SapOdpLinkedServiceResponse(
      ...
      language: (() { final guardedValue = map['language']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      logonGroup: (() { final guardedValue = map['logonGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      sncMyName: (() { final guardedValue = map['sncMyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      sncPartnerName: (() { final guardedValue = map['sncPartnerName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      sncQop: (() { final guardedValue = map['sncQop']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      subscriberName: (() { final guardedValue = map['subscriberName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      systemId: (() { final guardedValue = map['systemId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      systemNumber: (() { final guardedValue = map['systemNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      x509CertificatePath: (() { final guardedValue = map['x509CertificatePath']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
