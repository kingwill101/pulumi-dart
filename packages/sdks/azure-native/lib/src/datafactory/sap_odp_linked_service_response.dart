...
class SapOdpLinkedServiceResponse {
  ...
  factory SapOdpLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return SapOdpLinkedServiceResponse(
      ...
      sncLibraryPath: (() {
        final guardedValue = map['sncLibraryPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      sncMode: (() {
        final guardedValue = map['sncMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      sncMyName: (() {
        final guardedValue = map['sncMyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      sncPartnerName: (() {
        final guardedValue = map['sncPartnerName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      sncQop: (() {
        final guardedValue = map['sncQop'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      subscriberName: (() {
        final guardedValue = map['subscriberName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      systemId: (() {
      ...
      x509CertificatePath: (() {
        final guardedValue = map['x509CertificatePath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
    );
