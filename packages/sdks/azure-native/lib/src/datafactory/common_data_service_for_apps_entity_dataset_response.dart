...
class CommonDataServiceForAppsEntityDatasetResponse {
  ...
  /// Creates a new [CommonDataServiceForAppsEntityDatasetResponse].
  ...
  const CommonDataServiceForAppsEntityDatasetResponse({
    this.annotations,
    this.description,
    this.entityName,
    this.folder,
  ...
  factory CommonDataServiceForAppsEntityDatasetResponse.fromMap(Map<String, dynamic> map) {
    return CommonDataServiceForAppsEntityDatasetResponse(
