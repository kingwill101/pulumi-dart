...
class AzureFileStorageWriteSettingsResponse {
  ...
  /// Creates a new [AzureFileStorageWriteSettingsResponse].
  ...
  factory AzureFileStorageWriteSettingsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AzureFileStorageWriteSettingsResponse(
      copyBehavior: (() {
      ...
      metadata: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetadataItemResponse>(
            guardedValue,
            (value) => MetadataItemResponse.fromMap(
