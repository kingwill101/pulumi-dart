...
class SSISLogLocationResponse {
    ...
    return <String, dynamic>{
      'accessCredential':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(accessCredential, (value) => value.toMap()),
      'logPath': logPath,
  ...
  factory SSISLogLocationResponse.fromMap(Map<String, dynamic> map) {
    return SSISLogLocationResponse(
      accessCredential: (() {
        final guardedValue = map['accessCredential'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSISAccessCredentialResponse.fromMap(
      ...
      logRefreshInterval: (() {
        final guardedValue = map['logRefreshInterval'];
        if (guardedValue == null) return null;
