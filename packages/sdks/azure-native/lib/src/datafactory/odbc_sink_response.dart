...
class OdbcSinkResponse {
  ...
  /// Creates a new [OdbcSinkResponse].
  ...
  factory OdbcSinkResponse.fromMap(Map<String, dynamic> map) {
    return OdbcSinkResponse(
