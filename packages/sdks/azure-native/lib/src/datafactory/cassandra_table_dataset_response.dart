...
class CassandraTableDatasetResponse {
  ...
  /// Creates a new [CassandraTableDatasetResponse].
  ...
  factory CassandraTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return CassandraTableDatasetResponse(
      ...
      keyspace: (() { final guardedValue = map['keyspace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
