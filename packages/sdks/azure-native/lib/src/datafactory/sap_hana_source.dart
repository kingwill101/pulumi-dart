...
class SapHanaSource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'partitionSettings': ?pulumi.Input.mapOptionalInputValue<SapHanaPartitionSettings, Map<String, dynamic>>(partitionSettings, (value) => value.toMap()),
      'query': ?query,
  ...
  factory SapHanaSource.fromMap(Map<String, dynamic> map) {
    return SapHanaSource(
      ...
      partitionSettings: (() { final guardedValue = map['partitionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SapHanaPartitionSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
