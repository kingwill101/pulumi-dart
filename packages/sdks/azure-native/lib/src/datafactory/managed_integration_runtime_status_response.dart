...
class ManagedIntegrationRuntimeStatusResponse {
  ...
  final pulumi.Input<ManagedIntegrationRuntimeOperationResultResponse>
  lastOperation;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodes':
          pulumi.Input.mapInputValue<
            List<ManagedIntegrationRuntimeNodeResponse>,
      ...
      'otherErrors':
          pulumi.Input.mapInputValue<
            List<ManagedIntegrationRuntimeErrorResponse>,
            List<Map<String, dynamic>>
          >(
            otherErrors,
            (value) =>
  ...
  factory ManagedIntegrationRuntimeStatusResponse.fromMap(
    ...
    return ManagedIntegrationRuntimeStatusResponse(
      ...
      lastOperation: pulumi.Input.fromValue(
        ManagedIntegrationRuntimeOperationResultResponse.fromMap(
          (map['lastOperation']! as Map).cast<String, dynamic>(),
        ),
      ),
      nodes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ManagedIntegrationRuntimeNodeResponse>(
          map['nodes']!,
          (value) => ManagedIntegrationRuntimeNodeResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      otherErrors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ManagedIntegrationRuntimeErrorResponse>(
          map['otherErrors']!,
          (value) => ManagedIntegrationRuntimeErrorResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
