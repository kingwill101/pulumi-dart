...
class ExecuteSSISPackageActivityResponse {
  ...
  final pulumi.Input<Map<String, Map<String, SSISExecutionParameterResponse>>>?
  ...
  final pulumi.Input<Map<String, SSISExecutionParameterResponse>>?
  packageParameters;
  ...
  final pulumi.Input<Map<String, SSISPropertyOverrideResponse>>?
  propertyOverrides;
    ...
    return <String, dynamic>{
      ...
      'executionCredential':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(executionCredential, (value) => value.toMap()),
      'linkedServiceName':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'logLocation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(logLocation, (value) => value.toMap()),
      'loggingLevel': ?loggingLevel,
      'name': name,
      'onInactiveMarkAs': ?onInactiveMarkAs,
      'packageConnectionManagers':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, Map<String, SSISExecutionParameterResponse>>,
            Map<String, Map<String, Map<String, dynamic>>>
          >(
            packageConnectionManagers,
            (value) =>
                pulumi.Input.encodeMapValues<
                  Map<String, SSISExecutionParameterResponse>,
      ...
      'packageLocation':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(packageLocation, (value) => value.toMap()),
      'packageParameters':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, SSISExecutionParameterResponse>,
            Map<String, Map<String, dynamic>>
      ...
      'propertyOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, SSISPropertyOverrideResponse>,
            Map<String, Map<String, dynamic>>
          >(
            propertyOverrides,
            (value) =>
  ...
  factory ExecuteSSISPackageActivityResponse.fromMap(Map<String, dynamic> map) {
    return ExecuteSSISPackageActivityResponse(
      connectVia: pulumi.Input.fromValue(
        IntegrationRuntimeReferenceResponse.fromMap(
          (map['connectVia']! as Map).cast<String, dynamic>(),
        ),
      ),
      dependsOn: (() {
      ...
      environmentPath: (() {
        final guardedValue = map['environmentPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      executionCredential: (() {
        final guardedValue = map['executionCredential'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSISExecutionCredentialResponse.fromMap(
      ...
      logLocation: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSISLogLocationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      packageConnectionManagers: (() {
        final guardedValue = map['packageConnectionManagers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                pulumi.Input.decodeMapValues<SSISExecutionParameterResponse>(
                  value,
                  (value) => SSISExecutionParameterResponse.fromMap(
                    (value as Map).cast<String, dynamic>(),
                  ),
                ),
          ),
      ...
      packageLocation: pulumi.Input.fromValue(
        SSISPackageLocationResponse.fromMap(
          (map['packageLocation']! as Map).cast<String, dynamic>(),
        ),
      ),
      packageParameters: (() {
        final guardedValue = map['packageParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SSISExecutionParameterResponse>(
            guardedValue,
      ...
      projectConnectionManagers: (() {
        final guardedValue = map['projectConnectionManagers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<
            Map<String, SSISExecutionParameterResponse>
      ...
      projectParameters: (() {
        final guardedValue = map['projectParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SSISExecutionParameterResponse>(
            guardedValue,
      ...
      propertyOverrides: (() {
        final guardedValue = map['propertyOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SSISPropertyOverrideResponse>(
            guardedValue,
            (value) => SSISPropertyOverrideResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
