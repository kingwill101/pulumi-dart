...
class QuickBooksLinkedServiceResponse {
  ...
  factory QuickBooksLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return QuickBooksLinkedServiceResponse(
      ...
      accessTokenSecret: (() { final guardedValue = map['accessTokenSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      consumerSecret: (() { final guardedValue = map['consumerSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureKeyVaultSecretReferenceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
