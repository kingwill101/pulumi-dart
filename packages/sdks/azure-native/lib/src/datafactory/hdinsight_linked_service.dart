...
class HDInsightLinkedService {
  ...
  final pulumi.Input<dynamic>? clusterAuthType;
  ...
  factory HDInsightLinkedService.fromMap(Map<String, dynamic> map) {
    return HDInsightLinkedService(
      ...
      clusterAuthType: (() { final guardedValue = map['clusterAuthType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
