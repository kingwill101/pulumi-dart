...
class HDInsightStreamingActivityResponse {
    ...
    return <String, dynamic>{
      ...
      'fileLinkedService':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(fileLinkedService, (value) => value.toMap()),
      'filePaths': filePaths,
  ...
  factory HDInsightStreamingActivityResponse.fromMap(Map<String, dynamic> map) {
    return HDInsightStreamingActivityResponse(
      ...
      commandEnvironment: (() {
        final guardedValue = map['commandEnvironment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>());
      })(),
      defines: (() {
      ...
      fileLinkedService: (() {
        final guardedValue = map['fileLinkedService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      filePaths: pulumi.Input.fromValue(
        (map['filePaths'] as List).cast<dynamic>(),
      ),
      getDebugInfo: (() {
