...
class AvroSink {
  ...
  factory AvroSink.fromMap(Map<String, dynamic> map) {
    return AvroSink(
      ...
      formatSettings: (() { final guardedValue = map['formatSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AvroWriteSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
