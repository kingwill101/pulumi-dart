...
class GoogleAdWordsLinkedServiceResponse {
  ...
  final pulumi.Input<dynamic>? developerToken;
  ...
  factory GoogleAdWordsLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return GoogleAdWordsLinkedServiceResponse(
      ...
      developerToken: (() { final guardedValue = map['developerToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
