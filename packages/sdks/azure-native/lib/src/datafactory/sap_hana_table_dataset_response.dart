...
class SapHanaTableDatasetResponse {
  ...
  /// Creates a new [SapHanaTableDatasetResponse].
  ...
  const SapHanaTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory SapHanaTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SapHanaTableDatasetResponse(
