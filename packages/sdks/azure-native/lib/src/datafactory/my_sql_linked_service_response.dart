...
class MySqlLinkedServiceResponse {
  ...
  factory MySqlLinkedServiceResponse.fromMap(Map<String, dynamic> map) {
    return MySqlLinkedServiceResponse(
      allowZeroDateTime: (() { final guardedValue = map['allowZeroDateTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      convertZeroDateTime: (() { final guardedValue = map['convertZeroDateTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      guidFormat: (() { final guardedValue = map['guidFormat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      sslCert: (() { final guardedValue = map['sslCert']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      treatTinyAsBoolean: (() { final guardedValue = map['treatTinyAsBoolean']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
