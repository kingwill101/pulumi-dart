...
class MicrosoftAccessSourceResponse {
  ...
  /// Creates a new [MicrosoftAccessSourceResponse].
  ...
  const MicrosoftAccessSourceResponse({
  ...
  factory MicrosoftAccessSourceResponse.fromMap(Map<String, dynamic> map) {
    return MicrosoftAccessSourceResponse(
