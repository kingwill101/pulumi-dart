...
class AzureDatabricksLinkedService {
  ...
  factory AzureDatabricksLinkedService.fromMap(Map<String, dynamic> map) {
    return AzureDatabricksLinkedService(
      ...
      dataSecurityMode: map['dataSecurityMode'] == null ? null : (map['dataSecurityMode']!).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      domain: (map['domain']).input(),
      encryptedCredential: map['encryptedCredential'] == null ? null : (map['encryptedCredential']! as String).input(),
      existingClusterId: map['existingClusterId'] == null ? null : (map['existingClusterId']!).input(),
      instancePoolId: map['instancePoolId'] == null ? null : (map['instancePoolId']!).input(),
      newClusterCustomTags: map['newClusterCustomTags'] == null ? null : ((map['newClusterCustomTags']! as Map).cast<String, dynamic>()).input(),
      newClusterDriverNodeType: map['newClusterDriverNodeType'] == null ? null : (map['newClusterDriverNodeType']!).input(),
      newClusterEnableElasticDisk: map['newClusterEnableElasticDisk'] == null ? null : (map['newClusterEnableElasticDisk']!).input(),
      newClusterInitScripts: map['newClusterInitScripts'] == null ? null : (map['newClusterInitScripts']!).input(),
      newClusterLogDestination: map['newClusterLogDestination'] == null ? null : (map['newClusterLogDestination']!).input(),
      newClusterNodeType: map['newClusterNodeType'] == null ? null : (map['newClusterNodeType']!).input(),
      newClusterNumOfWorker: map['newClusterNumOfWorker'] == null ? null : (map['newClusterNumOfWorker']!).input(),
      newClusterSparkConf: map['newClusterSparkConf'] == null ? null : ((map['newClusterSparkConf']! as Map).cast<String, dynamic>()).input(),
      newClusterSparkEnvVars: map['newClusterSparkEnvVars'] == null ? null : ((map['newClusterSparkEnvVars']! as Map).cast<String, dynamic>()).input(),
      newClusterVersion: map['newClusterVersion'] == null ? null : (map['newClusterVersion']!).input(),
      parameters: map['parameters'] == null ? null : (pulumi.Input.decodeMapValues<ParameterSpecification>(map['parameters']!, (value) => ParameterSpecification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      policyId: map['policyId'] == null ? null : (map['policyId']!).input(),
