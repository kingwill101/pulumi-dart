...
class ScriptActivityTypePropertiesLogSettingsResponse {
  ...
  const ScriptActivityTypePropertiesLogSettingsResponse({
  ...
  factory ScriptActivityTypePropertiesLogSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ScriptActivityTypePropertiesLogSettingsResponse(
