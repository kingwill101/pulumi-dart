...
class AzureDataExplorerTableDatasetResponse {
  ...
  /// Creates a new [AzureDataExplorerTableDatasetResponse].
  ...
  const AzureDataExplorerTableDatasetResponse({
    this.annotations,
    this.description,
    this.folder,
  ...
  factory AzureDataExplorerTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AzureDataExplorerTableDatasetResponse(
