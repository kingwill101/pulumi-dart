...
class TumblingWindowTrigger {
  ...
  final pulumi.Input<List<SelfDependencyTumblingWindowTriggerReference>>?
  dependsOn;
    ...
    return <String, dynamic>{
      ...
      'dependsOn':
          ?pulumi.Input.mapOptionalInputValue<
            List<SelfDependencyTumblingWindowTriggerReference>,
    ...
    return TumblingWindowTrigger(
      ...
      dependsOn: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SelfDependencyTumblingWindowTriggerReference>(
            guardedValue,
            (value) => SelfDependencyTumblingWindowTriggerReference.fromMap(
