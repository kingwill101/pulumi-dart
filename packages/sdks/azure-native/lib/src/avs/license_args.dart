...
class LicenseArgs {
  ...
  factory LicenseArgs.fromMap(Map<String, dynamic> map) {
    return LicenseArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VmwareFirewallLicenseProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
