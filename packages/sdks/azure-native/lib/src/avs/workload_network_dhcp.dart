...
class WorkloadNetworkDhcp extends pulumi.CustomResource {
  ...
  WorkloadNetworkDhcp(
    ...
    properties = registerOutput<WorkloadNetworkDhcpRelayResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WorkloadNetworkDhcpRelayResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
