...
class GlobalReachConnectionArgs {
  ...
  factory GlobalReachConnectionArgs.fromMap(Map<String, dynamic> map) {
    return GlobalReachConnectionArgs(
      ...
      globalReachConnectionName: (() { final guardedValue = map['globalReachConnectionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      peerExpressRouteCircuit: (() { final guardedValue = map['peerExpressRouteCircuit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
