...
class ScriptExecutionArgs {
  ...
  /// credentials
  final pulumi.Input<List<dynamic>?>? hiddenParameters;
  ...
  factory ScriptExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ScriptExecutionArgs(
      ...
      hiddenParameters: (() { final guardedValue = map['hiddenParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
