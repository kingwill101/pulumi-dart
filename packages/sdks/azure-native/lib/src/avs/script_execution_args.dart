...
class ScriptExecutionArgs {
  ...
  factory ScriptExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ScriptExecutionArgs(
      ...
      hiddenParameters: (() { final guardedValue = map['hiddenParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PSCredentialExecutionParameter>(guardedValue, (value) => PSCredentialExecutionParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      namedOutputs: (() { final guardedValue = map['namedOutputs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      output: (() { final guardedValue = map['output']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PSCredentialExecutionParameter>(guardedValue, (value) => PSCredentialExecutionParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      scriptCmdletId: (() { final guardedValue = map['scriptCmdletId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scriptExecutionName: (() { final guardedValue = map['scriptExecutionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
