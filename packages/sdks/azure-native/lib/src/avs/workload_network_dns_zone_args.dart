...
class WorkloadNetworkDnsZoneArgs {
  ...
  factory WorkloadNetworkDnsZoneArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadNetworkDnsZoneArgs(
      ...
      dnsServerIps: (() { final guardedValue = map['dnsServerIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      dnsServices: (() { final guardedValue = map['dnsServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      domain: (() { final guardedValue = map['domain']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
