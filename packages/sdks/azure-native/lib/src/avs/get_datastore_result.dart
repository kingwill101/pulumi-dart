...
class GetDatastoreResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskPoolVolume': ?diskPoolVolume == null ? null : diskPoolVolume!.toMap(),
      'elasticSanVolume': ?elasticSanVolume == null ? null : elasticSanVolume!.toMap(),
      'id': id,
      'name': name,
      'netAppVolume': ?netAppVolume == null ? null : netAppVolume!.toMap(),
