...
/// }
///
/// resource "azure-native_avs_addon" "addon" {
///   addon_name         = "arc"
...
class Addon extends pulumi.CustomResource {
  ...
  Addon(
    ...
    properties = registerOutput<AddonArcPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AddonArcPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
