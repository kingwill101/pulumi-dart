...
class GetGlobalReachConnectionArgs {
  ...
  GetGlobalReachConnectionArgs({
    required pulumi.Output<String> globalReachConnectionName,
    required pulumi.Output<String> privateCloudName,
    required pulumi.Output<String> resourceGroupName,
  }) :
      globalReachConnectionName = pulumi.Input.asInput<String>(globalReachConnectionName),
  ...
  factory GetGlobalReachConnectionArgs.fromMap(Map<String, dynamic> map) {
    return GetGlobalReachConnectionArgs(
      globalReachConnectionName: pulumi.Output.create<String>(map['globalReachConnectionName'] as String),
