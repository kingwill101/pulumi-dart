...
class EnhancedSecurityComplianceDefinitionResponse {
  ...
  final pulumi.Input<AutomaticClusterUpdateDefinitionResponse>?
  automaticClusterUpdate;

  /// Status of Compliance Security Profile feature.
  final pulumi.Input<ComplianceSecurityProfileDefinitionResponse>?
  complianceSecurityProfile;

  /// Status of Enhanced Security Monitoring feature.
  final pulumi.Input<EnhancedSecurityMonitoringDefinitionResponse>?
    ...
    return <String, dynamic>{
      'automaticClusterUpdate':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(automaticClusterUpdate, (value) => value.toMap()),
      'complianceSecurityProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ComplianceSecurityProfileDefinitionResponse,
            Map<String, dynamic>
          >(complianceSecurityProfile, (value) => value.toMap()),
      'enhancedSecurityMonitoring':
          ?pulumi.Input.mapOptionalInputValue<
            EnhancedSecurityMonitoringDefinitionResponse,
            Map<String, dynamic>
          >(enhancedSecurityMonitoring, (value) => value.toMap()),
    };
  }

  factory EnhancedSecurityComplianceDefinitionResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return EnhancedSecurityComplianceDefinitionResponse(
      automaticClusterUpdate: (() {
        final guardedValue = map['automaticClusterUpdate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutomaticClusterUpdateDefinitionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      complianceSecurityProfile: (() {
        final guardedValue = map['complianceSecurityProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComplianceSecurityProfileDefinitionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      enhancedSecurityMonitoring: (() {
        final guardedValue = map['enhancedSecurityMonitoring'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnhancedSecurityMonitoringDefinitionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
