...
class GetWorkspaceResult {
  ...
  final EnhancedSecurityComplianceDefinitionResponse?
  ...
  factory GetWorkspaceResult.fromMap(Map<String, dynamic> map) {
    return GetWorkspaceResult(
      ...
      authorizations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<WorkspaceProviderAuthorizationResponse>(
          guardedValue,
          (value) => WorkspaceProviderAuthorizationResponse.fromMap(
      ...
      managedDiskIdentity: (() {
        final guardedValue = map['managedDiskIdentity'];
        if (guardedValue == null) return null;
      ...
      storageAccountIdentity: (() {
        final guardedValue = map['storageAccountIdentity'];
        if (guardedValue == null) return null;
        return ManagedIdentityConfigurationResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
