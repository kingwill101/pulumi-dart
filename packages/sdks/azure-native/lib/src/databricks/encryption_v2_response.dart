...
import 'encryption_v2_key_vault_properties_response.dart';
...
class EncryptionV2Response {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keySource': keySource,
      'keyVaultProperties': ?pulumi.Input.mapOptionalInputValue<EncryptionV2KeyVaultPropertiesResponse, Map<String, dynamic>>(keyVaultProperties, (value) => value.toMap()),
    };
  }
  ...
  factory EncryptionV2Response.fromMap(Map<String, dynamic> map) {
    return EncryptionV2Response(
      ...
      keyVaultProperties: (() { final guardedValue = map['keyVaultProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionV2KeyVaultPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
