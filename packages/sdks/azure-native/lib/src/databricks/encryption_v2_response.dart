...
class EncryptionV2Response {
  ...
  final pulumi.Input<EncryptionV2ResponseKeyVaultProperties>? keyVaultProperties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'keySource': keySource,
      'keyVaultProperties': ?pulumi.Input.mapOptionalInputValue<EncryptionV2ResponseKeyVaultProperties, Map<String, dynamic>>(keyVaultProperties, (value) => value.toMap()),
    };
  }
  ...
  factory EncryptionV2Response.fromMap(Map<String, dynamic> map) {
    return EncryptionV2Response(
      ...
      keyVaultProperties: (() { final guardedValue = map['keyVaultProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionV2ResponseKeyVaultProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
