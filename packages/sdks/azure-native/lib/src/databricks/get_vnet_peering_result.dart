...
class GetVNetPeeringResult {
  ...
  final VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork?
  ...
  /// The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
  final VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork
  ...
  factory GetVNetPeeringResult.fromMap(Map<String, dynamic> map) {
    return GetVNetPeeringResult(
      ...
      databricksAddressSpace: (() {
        final guardedValue = map['databricksAddressSpace'];
        if (guardedValue == null) return null;
      ...
      databricksVirtualNetwork: (() {
        final guardedValue = map['databricksVirtualNetwork'];
        if (guardedValue == null) return null;
      ...
      remoteVirtualNetwork:
          VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork.fromMap(
            (map['remoteVirtualNetwork']! as Map).cast<String, dynamic>(),
          ),
