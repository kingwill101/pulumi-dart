...
class EnhancedSecurityComplianceDefinition {
  ...
  final pulumi.Input<ComplianceSecurityProfileDefinition>?
  complianceSecurityProfile;

  /// Status of Enhanced Security Monitoring feature.
  final pulumi.Input<EnhancedSecurityMonitoringDefinition>?
  ...
  factory EnhancedSecurityComplianceDefinition.fromMap(
    ...
    return EnhancedSecurityComplianceDefinition(
      automaticClusterUpdate: (() {
        ...
        return pulumi.Input.fromValue(
          AutomaticClusterUpdateDefinition.fromMap(
      ...
      complianceSecurityProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ComplianceSecurityProfileDefinition.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      enhancedSecurityMonitoring: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnhancedSecurityMonitoringDefinition.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
