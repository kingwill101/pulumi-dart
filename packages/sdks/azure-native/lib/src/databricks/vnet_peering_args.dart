...
class VNetPeeringArgs {
  ...
  /// The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
  final pulumi.Input<VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetwork>
    ...
    return <String, dynamic>{
      ...
      'databricksAddressSpace':
          ?pulumi.Input.mapOptionalInputValue<
            AddressSpace,
            Map<String, dynamic>
          >(databricksAddressSpace, (value) => value.toMap()),
      'databricksVirtualNetwork':
          ?pulumi.Input.mapOptionalInputValue<
            VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetwork,
            Map<String, dynamic>
          >(databricksVirtualNetwork, (value) => value.toMap()),
  ...
  factory VNetPeeringArgs.fromMap(Map<String, dynamic> map) {
    return VNetPeeringArgs(
      ...
      databricksVirtualNetwork: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetwork.fromMap(
      ...
      remoteVirtualNetwork: pulumi.Input.fromValue(
        VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetwork.fromMap(
