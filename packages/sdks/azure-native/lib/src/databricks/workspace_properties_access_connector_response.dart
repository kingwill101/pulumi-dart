...
class WorkspacePropertiesAccessConnectorResponse {
  ...
  const WorkspacePropertiesAccessConnectorResponse({
    required this.id,
  ...
  factory WorkspacePropertiesAccessConnectorResponse.fromMap(Map<String, dynamic> map) {
    return WorkspacePropertiesAccessConnectorResponse(
