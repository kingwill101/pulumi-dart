...
class GetAccessConnectorResult {
  ...
  factory GetAccessConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetAccessConnectorResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return AccessConnectorPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
