...
class WorkspaceCustomParametersResponse {
  ...
  final pulumi.Input<WorkspaceCustomStringParameterResponse>?
  ...
  final pulumi.Input<WorkspaceNoPublicIPBooleanParameterResponse>?
  enableNoPublicIp;
  ...
  final pulumi.Input<WorkspaceCustomBooleanParameterResponse>?
  prepareEncryption;
    ...
    return WorkspaceCustomParametersResponse(
      amlWorkspaceId: (() {
        ...
        return pulumi.Input.fromValue(
          WorkspaceCustomStringParameterResponse.fromMap(
      ...
      enableNoPublicIp: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkspaceNoPublicIPBooleanParameterResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      encryption: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkspaceEncryptionParameterResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      prepareEncryption: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkspaceCustomBooleanParameterResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      resourceTags: pulumi.Input.fromValue(
        WorkspaceCustomObjectParameterResponse.fromMap(
          (map['resourceTags']! as Map).cast<String, dynamic>(),
        ),
      ),
      storageAccountName: (() {
