...
class ComplianceSecurityProfileDefinition {
  ...
  final pulumi.Input<List<dynamic>?>? complianceStandards;
  ...
  factory ComplianceSecurityProfileDefinition.fromMap(Map<String, dynamic> map) {
    return ComplianceSecurityProfileDefinition(
      complianceStandards: (() { final guardedValue = map['complianceStandards']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
