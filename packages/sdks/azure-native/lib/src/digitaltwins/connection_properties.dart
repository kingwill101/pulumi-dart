...
class ConnectionProperties {
  ...
  final pulumi.Input<ConnectionPropertiesPrivateLinkServiceConnectionState>?
  ...
  ConnectionProperties({this.groupIds, this.privateLinkServiceConnectionState});
    ...
    return ConnectionProperties(
      ...
      privateLinkServiceConnectionState: (() {
        ...
        return pulumi.Input.fromValue(
          ConnectionPropertiesPrivateLinkServiceConnectionState.fromMap(
