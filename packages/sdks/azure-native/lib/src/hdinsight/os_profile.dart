...
class OsProfile {
  ...
  factory OsProfile.fromMap(Map<String, dynamic> map) {
    return OsProfile(
      linuxOperatingSystemProfile: (() { final guardedValue = map['linuxOperatingSystemProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxOperatingSystemProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
