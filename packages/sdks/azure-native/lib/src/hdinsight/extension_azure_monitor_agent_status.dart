...
import 'extension_azure_monitor_agent_status_args.dart';
...
/// }
///
/// resource "azure-native_hdinsight_extensionazuremonitoragentstatus" "extensionAzureMonitorAgentStatus" {
...
/// ```
class ExtensionAzureMonitorAgentStatus extends pulumi.CustomResource {
  ...
  /// Creates a new [ExtensionAzureMonitorAgentStatus].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ExtensionAzureMonitorAgentStatus]. {@macro pulumi_hdinsight_extension_azure_monitor_agent_status_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ExtensionAzureMonitorAgentStatus(
    String name, {
    ExtensionAzureMonitorAgentStatusArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'azure-native:hdinsight:ExtensionAzureMonitorAgentStatus',
          name,
  ...
  /// Creates a typed reference to an existing [ExtensionAzureMonitorAgentStatus] resource.
  ExtensionAzureMonitorAgentStatus.reference(String urn)
    : super(
        'azure-native:hdinsight:ExtensionAzureMonitorAgentStatus',
