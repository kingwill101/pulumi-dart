  ...
  factory NetworkPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkPropertiesResponse(
      outboundDependenciesManagedType: (() {
        final guardedValue = map['outboundDependenciesManagedType'];
      ...
      publicIpTag: (() {
        final guardedValue = map['publicIpTag'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IpTagResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      resourceProviderConnection: (() {
        final guardedValue = map['resourceProviderConnection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
