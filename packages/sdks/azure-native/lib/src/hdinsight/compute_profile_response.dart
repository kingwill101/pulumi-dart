...
class ComputeProfileResponse {
  ...
  factory ComputeProfileResponse.fromMap(Map<String, dynamic> map) {
    return ComputeProfileResponse(
      roles: (() { final guardedValue = map['roles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RoleResponse>(guardedValue, (value) => RoleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
