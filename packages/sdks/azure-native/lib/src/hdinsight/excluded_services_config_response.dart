...
class ExcludedServicesConfigResponse {
  ...
  factory ExcludedServicesConfigResponse.fromMap(Map<String, dynamic> map) {
    return ExcludedServicesConfigResponse(
      excludedServicesConfigId: (() { final guardedValue = map['excludedServicesConfigId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      excludedServicesList: (() { final guardedValue = map['excludedServicesList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
