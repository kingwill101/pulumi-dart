...
class Application extends pulumi.CustomResource {
  ...
  Application(
    ...
    properties = registerOutput<ApplicationPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ApplicationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
