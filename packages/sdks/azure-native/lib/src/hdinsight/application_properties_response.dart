...
class ApplicationPropertiesResponse {
  ...
  factory ApplicationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationPropertiesResponse(
      applicationState: pulumi.Input.fromValue(map['applicationState'] as String),
      ...
      httpsEndpoints: (() { final guardedValue = map['httpsEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGetHttpsEndpointResponse>(guardedValue, (value) => ApplicationGetHttpsEndpointResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      installScriptActions: (() { final guardedValue = map['installScriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuntimeScriptActionResponse>(guardedValue, (value) => RuntimeScriptActionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      marketplaceIdentifier: pulumi.Input.fromValue(map['marketplaceIdentifier'] as String),
      ...
      sshEndpoints: (() { final guardedValue = map['sshEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGetEndpointResponse>(guardedValue, (value) => ApplicationGetEndpointResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      uninstallScriptActions: (() { final guardedValue = map['uninstallScriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuntimeScriptActionResponse>(guardedValue, (value) => RuntimeScriptActionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
