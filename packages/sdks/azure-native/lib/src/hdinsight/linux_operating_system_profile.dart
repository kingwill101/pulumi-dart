...
class LinuxOperatingSystemProfile {
  ...
  factory LinuxOperatingSystemProfile.fromMap(Map<String, dynamic> map) {
    return LinuxOperatingSystemProfile(
      ...
      sshProfile: (() { final guardedValue = map['sshProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SshProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
