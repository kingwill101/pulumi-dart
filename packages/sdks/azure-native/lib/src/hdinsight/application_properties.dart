...
class ApplicationProperties {
  ...
  factory ApplicationProperties.fromMap(Map<String, dynamic> map) {
    return ApplicationProperties(
      ...
      errors: (() { final guardedValue = map['errors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Errors>(guardedValue, (value) => Errors.fromMap((value as Map).cast<String, dynamic>()))); })(),
      httpsEndpoints: (() { final guardedValue = map['httpsEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGetHttpsEndpoint>(guardedValue, (value) => ApplicationGetHttpsEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      installScriptActions: (() { final guardedValue = map['installScriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuntimeScriptAction>(guardedValue, (value) => RuntimeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sshEndpoints: (() { final guardedValue = map['sshEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationGetEndpoint>(guardedValue, (value) => ApplicationGetEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      uninstallScriptActions: (() { final guardedValue = map['uninstallScriptActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RuntimeScriptAction>(guardedValue, (value) => RuntimeScriptAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
