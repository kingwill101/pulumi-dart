...
/// }
///
/// resource "azure-native_dnsresolver_dnsresolverpolicyvirtualnetworklink" "dnsResolverPolicyVirtualNetworkLink" {
...
class DnsResolverPolicyVirtualNetworkLink extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DnsResolverPolicyVirtualNetworkLink] resource.
  DnsResolverPolicyVirtualNetworkLink.reference(String urn)
    : super(
        'azure-native:dnsresolver:DnsResolverPolicyVirtualNetworkLink',
