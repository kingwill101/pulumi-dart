...
class GetDnsForwardingRulesetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dnsResolverOutboundEndpoints': pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(dnsResolverOutboundEndpoints, (value) => value.toMap()),
      'etag': etag,
      'id': id,
      'location': location,
      'name': name,
  ...
  factory GetDnsForwardingRulesetResult.fromMap(Map<String, dynamic> map) {
    return GetDnsForwardingRulesetResult(
      ...
      dnsResolverOutboundEndpoints: pulumi.Input.decodeList<SubResourceResponse>(map['dnsResolverOutboundEndpoints']!, (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>())),
