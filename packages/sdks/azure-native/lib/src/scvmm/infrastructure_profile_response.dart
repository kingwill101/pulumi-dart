  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lastRestoredVMCheckpoint':
          pulumi.Input.mapInputValue<CheckpointResponse, Map<String, dynamic>>(
            lastRestoredVMCheckpoint,
            (value) => value.toMap(),
          ),
    ...
    return InfrastructureProfileResponse(
      ...
      checkpoints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CheckpointResponse>(
            guardedValue,
      ...
      lastRestoredVMCheckpoint: pulumi.Input.fromValue(
        CheckpointResponse.fromMap(
