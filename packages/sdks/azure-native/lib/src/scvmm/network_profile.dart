...
class NetworkProfile {
  ...
  factory NetworkProfile.fromMap(Map<String, dynamic> map) {
    return NetworkProfile(
      networkInterfaces: (() { final guardedValue = map['networkInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfaces>(guardedValue, (value) => NetworkInterfaces.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
