...
class NetworkProfileResponse {
  ...
  factory NetworkProfileResponse.fromMap(Map<String, dynamic> map) {
    return NetworkProfileResponse(
      networkInterfaces: (() { final guardedValue = map['networkInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInterfacesResponse>(guardedValue, (value) => NetworkInterfacesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
