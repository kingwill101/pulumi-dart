...
class NetworkInterfaces {
  ...
  final pulumi.Input<dynamic>? ipv4AddressType;
  /// Gets or sets the ipv6 address type.
  final pulumi.Input<dynamic>? ipv6AddressType;
  /// Gets or sets the nic MAC address.
  final pulumi.Input<String?>? macAddress;
  /// Gets or sets the mac address type.
  final pulumi.Input<dynamic>? macAddressType;
  ...
  factory NetworkInterfaces.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaces(
      ipv4AddressType: (() { final guardedValue = map['ipv4AddressType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ipv6AddressType: (() { final guardedValue = map['ipv6AddressType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      macAddressType: (() { final guardedValue = map['macAddressType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
