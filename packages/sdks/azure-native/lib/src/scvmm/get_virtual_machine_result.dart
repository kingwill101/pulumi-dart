...
class GetVirtualMachineResult {
  ...
  final List<VirtualMachinePropertiesResponseAvailabilitySets>?
  availabilitySets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'availabilitySets': ?(() {
        final guardedValue = availabilitySets;
      ...
      'checkpoints': ?(() {
        final guardedValue = checkpoints;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
          CheckpointResponse,
          Map<String, dynamic>
  ...
  factory GetVirtualMachineResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualMachineResult(
      availabilitySets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi
            .Input.decodeList<VirtualMachinePropertiesResponseAvailabilitySets>(
          guardedValue,
          (value) => VirtualMachinePropertiesResponseAvailabilitySets.fromMap(
      ...
      checkpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<CheckpointResponse>(
          guardedValue,
          (value) => CheckpointResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      guestAgentProfile: (() {
        final guardedValue = map['guestAgentProfile'];
        if (guardedValue == null) return null;
      ...
      lastRestoredVMCheckpoint: CheckpointResponse.fromMap(
        (map['lastRestoredVMCheckpoint']! as Map).cast<String, dynamic>(),
      ),
