...
class VirtualDiskResponse {
  ...
  factory VirtualDiskResponse.fromMap(Map<String, dynamic> map) {
    return VirtualDiskResponse(
      ...
      maxDiskSizeGB: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['maxDiskSizeGB'])),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      storageQoSPolicy: (() { final guardedValue = map['storageQoSPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageQoSPolicyDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
