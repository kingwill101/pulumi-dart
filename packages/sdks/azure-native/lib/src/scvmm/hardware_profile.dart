...
class HardwareProfile {
  ...
  final pulumi.Input<dynamic>? dynamicMemoryEnabled;
  ...
  final pulumi.Input<dynamic>? limitCpuForMigration;
  ...
  factory HardwareProfile.fromMap(Map<String, dynamic> map) {
    return HardwareProfile(
      ...
      dynamicMemoryEnabled: (() { final guardedValue = map['dynamicMemoryEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      limitCpuForMigration: (() { final guardedValue = map['limitCpuForMigration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
