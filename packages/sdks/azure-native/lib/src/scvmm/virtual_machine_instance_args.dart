...
class VirtualMachineInstanceArgs {
  ...
  factory VirtualMachineInstanceArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineInstanceArgs(
      availabilitySets: (() { final guardedValue = map['availabilitySets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineInstancePropertiesAvailabilitySets>(guardedValue, (value) => VirtualMachineInstancePropertiesAvailabilitySets.fromMap((value as Map).cast<String, dynamic>()))); })(),
