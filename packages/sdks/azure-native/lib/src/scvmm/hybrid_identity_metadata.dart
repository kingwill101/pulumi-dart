...
/// }
///
/// resource "azure-native_scvmm_hybrididentitymetadata" "hybridIdentityMetadata" {
...
class HybridIdentityMetadata extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [HybridIdentityMetadata] resource.
  HybridIdentityMetadata.reference(String urn)
    : super(
        'azure-native:scvmm:HybridIdentityMetadata',
