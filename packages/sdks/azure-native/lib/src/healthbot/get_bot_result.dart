...
class GetBotResult {
  ...
  factory GetBotResult.fromMap(Map<String, dynamic> map) {
    return GetBotResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return HealthBotPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
