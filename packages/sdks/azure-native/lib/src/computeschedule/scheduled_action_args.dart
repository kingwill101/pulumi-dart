...
class ScheduledActionArgs {
  ...
  ScheduledActionArgs({
    ...
    pulumi.Output<ScheduledActionProperties>? properties,
  ...
  factory ScheduledActionArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledActionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ScheduledActionProperties>(ScheduledActionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
