...
class GetScheduledActionResult {
  ...
  final ScheduledActionPropertiesResponse? properties;
  ...
  factory GetScheduledActionResult.fromMap(Map<String, dynamic> map) {
    return GetScheduledActionResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ScheduledActionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
