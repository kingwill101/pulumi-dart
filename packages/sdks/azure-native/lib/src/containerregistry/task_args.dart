...
class TaskArgs {
  ...
  TaskArgs({
    pulumi.Output<AgentProperties>? agentConfiguration,
    ...
    pulumi.Output<PlatformProperties>? platform,
    required pulumi.Output<String> registryName,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<String>? status,
    pulumi.Output<DockerBuildStep>? step,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<String>? taskName,
    pulumi.Output<int>? timeout,
    pulumi.Output<TriggerProperties>? trigger,
  }) :
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      agentConfiguration: map['agentConfiguration'] == null ? null : pulumi.Output.create<AgentProperties>(AgentProperties.fromMap((map['agentConfiguration'] as Map).cast<String, dynamic>())),
      ...
      platform: map['platform'] == null ? null : pulumi.Output.create<PlatformProperties>(PlatformProperties.fromMap((map['platform'] as Map).cast<String, dynamic>())),
      registryName: pulumi.Output.create<String>(map['registryName'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      status: map['status'] == null ? null : pulumi.Output.create<String>(map['status'] as String),
      step: map['step'] == null ? null : pulumi.Output.create<DockerBuildStep>(DockerBuildStep.fromMap((map['step'] as Map).cast<String, dynamic>())),
      ...
      trigger: map['trigger'] == null ? null : pulumi.Output.create<TriggerProperties>(TriggerProperties.fromMap((map['trigger'] as Map).cast<String, dynamic>())),
    );
  }
}
