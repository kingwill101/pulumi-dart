...
class TaskRunRequest {
  ...
  factory TaskRunRequest.fromMap(Map<String, dynamic> map) {
    return TaskRunRequest(
      ...
      overrideTaskStepProperties: (() { final guardedValue = map['overrideTaskStepProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OverrideTaskStepProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
