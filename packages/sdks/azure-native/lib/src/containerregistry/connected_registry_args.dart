    ...
    return <String, dynamic>{
      ...
      'garbageCollection':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(garbageCollection, (value) => value.toMap()),
      'logging':
          ?pulumi.Input.mapOptionalInputValue<
            LoggingProperties,
            Map<String, dynamic>
      ...
      'parent':
          pulumi.Input.mapInputValue<ParentProperties, Map<String, dynamic>>(
            parent,
            (value) => value.toMap(),
          ),
  ...
  factory ConnectedRegistryArgs.fromMap(Map<String, dynamic> map) {
    return ConnectedRegistryArgs(
      ...
      connectedRegistryName: (() {
        final guardedValue = map['connectedRegistryName'];
        if (guardedValue == null) return null;
      ...
      garbageCollection: (() {
        ...
        return pulumi.Input.fromValue(
          GarbageCollectionProperties.fromMap(
      ...
      parent: pulumi.Input.fromValue(
        ParentProperties.fromMap(
