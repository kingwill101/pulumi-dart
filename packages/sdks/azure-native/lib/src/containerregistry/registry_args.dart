...
class RegistryArgs {
  ...
  RegistryArgs({
    pulumi.Output<bool>? adminUserEnabled,
    ...
    pulumi.Output<String>? networkRuleBypassOptions,
    pulumi.Output<NetworkRuleSet>? networkRuleSet,
    pulumi.Output<Policies>? policies,
  ...
  factory RegistryArgs.fromMap(Map<String, dynamic> map) {
    return RegistryArgs(
      adminUserEnabled: map['adminUserEnabled'] == null ? null : pulumi.Output.create<bool>(map['adminUserEnabled'] as bool),
      ...
      networkRuleBypassOptions: map['networkRuleBypassOptions'] == null ? null : pulumi.Output.create<String>(map['networkRuleBypassOptions'] as String),
      ...
      policies: map['policies'] == null ? null : pulumi.Output.create<Policies>(Policies.fromMap((map['policies'] as Map).cast<String, dynamic>())),
