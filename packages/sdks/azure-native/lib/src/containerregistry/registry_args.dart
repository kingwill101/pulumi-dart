...
class RegistryArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policies':
          ?pulumi.Input.mapOptionalInputValue<Policies, Map<String, dynamic>>(
            policies,
            (value) => value.toMap(),
          ),
  ...
  factory RegistryArgs.fromMap(Map<String, dynamic> map) {
    return RegistryArgs(
      adminUserEnabled: (() {
        final guardedValue = map['adminUserEnabled'];
      ...
      networkRuleBypassOptions: (() {
        final guardedValue = map['networkRuleBypassOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      networkRuleSet: (() {
      ...
      policies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Policies.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      publicNetworkAccess: (() {
