...
class CredentialsResponse {
  ...
  final pulumi.Input<Map<String, CustomRegistryCredentialsResponse>>?
  customRegistries;
  ...
  CredentialsResponse({this.customRegistries, this.sourceRegistry});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customRegistries':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, CustomRegistryCredentialsResponse>,
    ...
    return CredentialsResponse(
      customRegistries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<CustomRegistryCredentialsResponse>(
            guardedValue,
            (value) => CustomRegistryCredentialsResponse.fromMap(
      ...
      sourceRegistry: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourceRegistryCredentialsResponse.fromMap(
