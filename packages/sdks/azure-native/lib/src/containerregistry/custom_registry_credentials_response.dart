...
class CustomRegistryCredentialsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'identity': ?identity,
      'password': ?pulumi.Input.mapOptionalInputValue<SecretObjectResponse, Map<String, dynamic>>(password, (value) => value.toMap()),
      'userName': ?pulumi.Input.mapOptionalInputValue<SecretObjectResponse, Map<String, dynamic>>(userName, (value) => value.toMap()),
    };
  }
  ...
  factory CustomRegistryCredentialsResponse.fromMap(Map<String, dynamic> map) {
    return CustomRegistryCredentialsResponse(
      ...
      password: (() { final guardedValue = map['password']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretObjectResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      userName: (() { final guardedValue = map['userName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretObjectResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
