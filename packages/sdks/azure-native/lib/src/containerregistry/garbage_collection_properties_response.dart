...
class GarbageCollectionPropertiesResponse {
  ...
  GarbageCollectionPropertiesResponse({this.enabled, this.schedule});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'enabled': ?enabled, 'schedule': ?schedule};
  }

  factory GarbageCollectionPropertiesResponse.fromMap(
