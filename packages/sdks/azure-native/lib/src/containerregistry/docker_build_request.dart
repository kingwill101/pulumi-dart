...
class DockerBuildRequest {
  ...
  DockerBuildRequest({
    ...
    pulumi.Input<bool?>? isPushEnabled,
    this.logTemplate,
    pulumi.Input<bool?>? noCache,
    required this.platform,
    this.sourceLocation,
    this.target,
    pulumi.Input<int?>? timeout,
    required this.type,
  }) : isArchiveEnabled = isArchiveEnabled ?? pulumi.Input.fromValue(false), isPushEnabled = isPushEnabled ?? pulumi.Input.fromValue(true), noCache = noCache ?? pulumi.Input.fromValue(false), timeout = timeout ?? pulumi.Input.fromValue(3600);
