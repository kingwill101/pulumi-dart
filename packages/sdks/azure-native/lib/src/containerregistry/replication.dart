...
/// }
///
/// resource "azure-native_containerregistry_replication" "replication" {
///   location            = "eastus"
...
class Replication extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [Replication] resource.
  Replication.reference(String urn)
    : super(
        'azure-native:containerregistry:Replication',
