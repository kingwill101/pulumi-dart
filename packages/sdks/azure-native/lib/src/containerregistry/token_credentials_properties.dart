...
class TokenCredentialsProperties {
  ...
  /// [passwords] Optional.
  TokenCredentialsProperties({this.certificates, this.passwords});
    ...
    return <String, dynamic>{
      'certificates':
          ...
          >(
            certificates,
            (value) =>
                pulumi.Input.encodeList<TokenCertificate, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'passwords':
          ...
          >(
            passwords,
            (value) =>
                pulumi.Input.encodeList<TokenPassword, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return TokenCredentialsProperties(
      certificates: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TokenCertificate>(
            guardedValue,
            (value) => TokenCertificate.fromMap(
      ...
      passwords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TokenPassword>(
            guardedValue,
            (value) =>
                TokenPassword.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
