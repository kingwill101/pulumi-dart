...
class IdentityPropertiesResponse {
  ...
  final pulumi.Input<Map<String, UserIdentityPropertiesResponse>>?
    ...
    return <String, dynamic>{
      ...
      'userAssignedIdentities':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, UserIdentityPropertiesResponse>,
    ...
    return IdentityPropertiesResponse(
      ...
      userAssignedIdentities: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<UserIdentityPropertiesResponse>(
            guardedValue,
            (value) => UserIdentityPropertiesResponse.fromMap(
