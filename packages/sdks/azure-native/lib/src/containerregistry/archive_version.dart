...
/// }
///
/// resource "azure-native_containerregistry_archiveversion" "archiveVersion" {
...
class ArchiveVersion extends pulumi.CustomResource {
  ...
  ArchiveVersion(
    ...
    archiveVersionErrorMessage = registerOutput<String?>('archiveVersionErrorMessage');
  ...
  /// Creates a typed reference to an existing [ArchiveVersion] resource.
  ArchiveVersion.reference(String urn)
    : super(
        'azure-native:containerregistry:ArchiveVersion',
