...
class Credentials {
  ...
  Credentials({this.customRegistries, this.sourceRegistry});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customRegistries':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, CustomRegistryCredentials>,
      ...
      'sourceRegistry':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sourceRegistry, (value) => value.toMap()),
    };
  }
    ...
    return Credentials(
      customRegistries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<CustomRegistryCredentials>(
            guardedValue,
            (value) => CustomRegistryCredentials.fromMap(
      ...
      sourceRegistry: (() {
        final guardedValue = map['sourceRegistry'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourceRegistryCredentials.fromMap(
