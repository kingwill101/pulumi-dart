...
/// }
///
/// resource "azure-native_containerregistry_exportpipeline" "exportPipeline" {
...
class ExportPipeline extends pulumi.CustomResource {
  ...
  ExportPipeline(
    ...
    this.options = registerOutput<List<String>?>('options', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
  ...
  /// Creates a typed reference to an existing [ExportPipeline] resource.
  ExportPipeline.reference(String urn)
    : super(
        'azure-native:containerregistry:ExportPipeline',
