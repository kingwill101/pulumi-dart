...
class ListRunLogSasUrlResult {
  ...
  factory ListRunLogSasUrlResult.fromMap(Map<String, dynamic> map) {
    return ListRunLogSasUrlResult(
      logArtifactLink: (() { final guardedValue = map['logArtifactLink']; if (guardedValue == null) return null; return guardedValue as String; })(),
      logLink: (() { final guardedValue = map['logLink']; if (guardedValue == null) return null; return guardedValue as String; })(),
    );
  }
}
