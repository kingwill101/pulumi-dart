...
class PoliciesResponse {
  ...
  final pulumi.Input<AzureADAuthenticationAsArmPolicyResponse>?
    ...
    return <String, dynamic>{
      'azureADAuthenticationAsArmPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(azureADAuthenticationAsArmPolicy, (value) => value.toMap()),
      'exportPolicy':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'quarantinePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(quarantinePolicy, (value) => value.toMap()),
      'retentionPolicy':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory PoliciesResponse.fromMap(Map<String, dynamic> map) {
    return PoliciesResponse(
      azureADAuthenticationAsArmPolicy: (() {
        final guardedValue = map['azureADAuthenticationAsArmPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureADAuthenticationAsArmPolicyResponse.fromMap(
      ...
      exportPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      quarantinePolicy: (() {
        final guardedValue = map['quarantinePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          QuarantinePolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      softDeletePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SoftDeletePolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      trustPolicy: (() {
        final guardedValue = map['trustPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TrustPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
