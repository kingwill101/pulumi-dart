...
class GetConnectedRegistryResult {
  ...
  factory GetConnectedRegistryResult.fromMap(Map<String, dynamic> map) {
    return GetConnectedRegistryResult(
      activation: ActivationPropertiesResponse.fromMap(
        (map['activation']! as Map).cast<String, dynamic>(),
      ),
      azureApiVersion: map['azureApiVersion'] as String,
      clientTokenIds: (() {
        final guardedValue = map['clientTokenIds'];
        if (guardedValue == null) return null;
        return (guardedValue as List).cast<String>();
      })(),
      connectionState: map['connectionState'] as String,
      garbageCollection: (() {
        final guardedValue = map['garbageCollection'];
        if (guardedValue == null) return null;
      ...
      notificationsList: (() {
        final guardedValue = map['notificationsList'];
        if (guardedValue == null) return null;
        return (guardedValue as List).cast<String>();
      })(),
      parent: ParentPropertiesResponse.fromMap(
        (map['parent']! as Map).cast<String, dynamic>(),
      ),
      provisioningState: map['provisioningState'] as String,
      statusDetails: pulumi.Input.decodeList<StatusDetailPropertiesResponse>(
        map['statusDetails']!,
        (value) => StatusDetailPropertiesResponse.fromMap(
