...
class GetConnectedRegistryResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'garbageCollection': ?garbageCollection == null ? null : garbageCollection!.toMap(),
      'id': id,
      'lastActivityTime': lastActivityTime,
      'logging': ?logging == null ? null : logging!.toMap(),
      'loginServer': ?loginServer == null ? null : loginServer!.toMap(),
      'mode': mode,
      'name': name,
  ...
  factory GetConnectedRegistryResult.fromMap(Map<String, dynamic> map) {
    return GetConnectedRegistryResult(
      ...
      clientTokenIds: map['clientTokenIds'] == null ? null : (map['clientTokenIds']! as List).cast<String>(),
      connectionState: map['connectionState'] as String,
      garbageCollection: map['garbageCollection'] == null ? null : GarbageCollectionPropertiesResponse.fromMap((map['garbageCollection']! as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      lastActivityTime: map['lastActivityTime'] as String,
      logging: map['logging'] == null ? null : LoggingPropertiesResponse.fromMap((map['logging']! as Map).cast<String, dynamic>()),
      loginServer: map['loginServer'] == null ? null : LoginServerPropertiesResponse.fromMap((map['loginServer']! as Map).cast<String, dynamic>()),
      mode: map['mode'] as String,
      name: map['name'] as String,
      notificationsList: map['notificationsList'] == null ? null : (map['notificationsList']! as List).cast<String>(),
