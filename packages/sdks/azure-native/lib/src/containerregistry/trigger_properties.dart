...
class TriggerProperties {
  ...
  factory TriggerProperties.fromMap(Map<String, dynamic> map) {
    return TriggerProperties(
      baseImageTrigger: (() { final guardedValue = map['baseImageTrigger']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BaseImageTrigger.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sourceTriggers: (() { final guardedValue = map['sourceTriggers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SourceTrigger>(guardedValue, (value) => SourceTrigger.fromMap((value as Map).cast<String, dynamic>()))); })(),
      timerTriggers: (() { final guardedValue = map['timerTriggers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TimerTrigger>(guardedValue, (value) => TimerTrigger.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
