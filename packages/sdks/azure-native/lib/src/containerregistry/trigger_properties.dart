    ...
    return <String, dynamic>{
      ...
      'sourceTriggers':
          ...
          >(
            sourceTriggers,
            (value) =>
                pulumi.Input.encodeList<SourceTrigger, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'timerTriggers':
          ...
          >(
            timerTriggers,
            (value) =>
                pulumi.Input.encodeList<TimerTrigger, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory TriggerProperties.fromMap(Map<String, dynamic> map) {
    return TriggerProperties(
      ...
      sourceTriggers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SourceTrigger>(
            guardedValue,
            (value) =>
                SourceTrigger.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      timerTriggers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TimerTrigger>(
            guardedValue,
            (value) =>
                TimerTrigger.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
