...
class EventResponse {
  ...
  /// [id] The event ID.
  EventResponse({this.eventRequestMessage, this.eventResponseMessage, this.id});
    ...
    return <String, dynamic>{
      'eventRequestMessage':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(eventRequestMessage, (value) => value.toMap()),
      'eventResponseMessage':
          ?pulumi.Input.mapOptionalInputValue<
            EventResponseMessageResponse,
            Map<String, dynamic>
          >(eventResponseMessage, (value) => value.toMap()),
      'id': ?id,
    };
  }
  ...
  factory EventResponse.fromMap(Map<String, dynamic> map) {
    return EventResponse(
      eventRequestMessage: (() {
        final guardedValue = map['eventRequestMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventRequestMessageResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      eventResponseMessage: (() {
        final guardedValue = map['eventResponseMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventResponseMessageResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
