...
class LoginServerPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': host,
      'tls': pulumi.Input.mapInputValue<TlsPropertiesResponse, Map<String, dynamic>>(tls, (value) => value.toMap()),
    };
  }
  ...
  factory LoginServerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LoginServerPropertiesResponse(
      ...
      tls: pulumi.Input.fromValue(TlsPropertiesResponse.fromMap((map['tls']! as Map).cast<String, dynamic>())),
    );
  }
}
