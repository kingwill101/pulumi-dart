...
import 'aws_app_sync_graphql_api_properties.dart';

/// Definition of AppSyncGraphqlApi
class AppSyncGraphqlApiProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsAppSyncGraphqlApiProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [AppSyncGraphqlApiProperties].
  ...
  const AppSyncGraphqlApiProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsAppSyncGraphqlApiProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory AppSyncGraphqlApiProperties.fromMap(Map<String, dynamic> map) {
    return AppSyncGraphqlApiProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsAppSyncGraphqlApiProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
