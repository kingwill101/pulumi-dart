...
class AppSyncGraphqlApiProperties {
  ...
  /// AWS Properties
  final AwsAppSyncGraphqlApiProperties? awsProperties;
  /// AWS Region
  ...
  factory AppSyncGraphqlApiProperties.fromMap(Map<String, dynamic> map) {
    return AppSyncGraphqlApiProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsAppSyncGraphqlApiProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
