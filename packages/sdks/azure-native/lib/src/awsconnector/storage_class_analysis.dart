...
class StorageClassAnalysis {
  ...
  StorageClassAnalysis({this.dataExport});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataExport':
          ?pulumi.Input.mapOptionalInputValue<DataExport, Map<String, dynamic>>(
            dataExport,
            (value) => value.toMap(),
          ),
    };
    ...
    return StorageClassAnalysis(
      dataExport: (() {
        ...
        return pulumi.Input.fromValue(
          DataExport.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
