...
import 'aws_dax_cluster_properties.dart';

/// Definition of DaxCluster
class DaxClusterProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsDaxClusterProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [DaxClusterProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsDaxClusterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory DaxClusterProperties.fromMap(Map<String, dynamic> map) {
    return DaxClusterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsDaxClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
