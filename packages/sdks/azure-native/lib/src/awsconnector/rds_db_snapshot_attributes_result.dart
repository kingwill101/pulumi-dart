...
/// }
///
/// resource "azure-native_awsconnector_rdsdbsnapshotattributesresult" "rdsDbSnapshotAttributesResult" {
///   location = "luzcqukssqazokzghltlzp"
///   name     = "Replace this value with a string matching RegExp ^(z=.{0,259}[^zs.]$)(z!.*[zzzzzzzz])"
///   properties = {
///     arn            = "wctkioaluqun"
...
class RdsDbSnapshotAttributesResult extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RdsDBSnapshotAttributesResultPropertiesResponse> properties;
  ...
  RdsDbSnapshotAttributesResult(
    ...
    properties = registerOutput<RdsDBSnapshotAttributesResultPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RdsDBSnapshotAttributesResultPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [RdsDbSnapshotAttributesResult] resource.
  RdsDbSnapshotAttributesResult.reference(String urn)
    : super(
        'azure-native:awsconnector:RdsDbSnapshotAttributesResult',
