...
class AdvancedFieldSelector {
  ...
  factory AdvancedFieldSelector.fromMap(Map<String, dynamic> map) {
    return AdvancedFieldSelector(
      endsWith: (() { final guardedValue = map['endsWith']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      notEndsWith: (() { final guardedValue = map['notEndsWith']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      notStartsWith: (() { final guardedValue = map['notStartsWith']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      startsWith: (() { final guardedValue = map['startsWith']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
