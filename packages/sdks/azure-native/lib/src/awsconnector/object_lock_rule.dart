...
class ObjectLockRule {
  ...
  factory ObjectLockRule.fromMap(Map<String, dynamic> map) {
    return ObjectLockRule(
      defaultRetention: (() { final guardedValue = map['defaultRetention']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultRetention.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
