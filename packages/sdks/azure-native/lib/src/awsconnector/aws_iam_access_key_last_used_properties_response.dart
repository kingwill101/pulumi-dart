...
class AwsIamAccessKeyLastUsedPropertiesResponse {
  ...
  /// Creates a new [AwsIamAccessKeyLastUsedPropertiesResponse].
  ...
  const AwsIamAccessKeyLastUsedPropertiesResponse({
    this.lastUsedDate,
    this.region,
    this.serviceName,
  });
  ...
  factory AwsIamAccessKeyLastUsedPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsIamAccessKeyLastUsedPropertiesResponse(
