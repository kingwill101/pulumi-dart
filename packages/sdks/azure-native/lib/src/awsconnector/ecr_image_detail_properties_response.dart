...
import 'aws_ecr_image_detail_properties_response.dart';

/// Definition of EcrImageDetail
class EcrImageDetailPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcrImageDetailPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcrImageDetailPropertiesResponse].
  ...
  const EcrImageDetailPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcrImageDetailPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcrImageDetailPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcrImageDetailPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcrImageDetailPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
