...
class EcrImageDetailPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEcrImageDetailPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory EcrImageDetailPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcrImageDetailPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcrImageDetailPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
