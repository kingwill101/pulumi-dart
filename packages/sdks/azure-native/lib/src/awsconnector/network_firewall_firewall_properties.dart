...
import 'aws_network_firewall_firewall_properties.dart';

/// Definition of NetworkFirewallFirewall
class NetworkFirewallFirewallProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsNetworkFirewallFirewallProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [NetworkFirewallFirewallProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsNetworkFirewallFirewallProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory NetworkFirewallFirewallProperties.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallFirewallProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsNetworkFirewallFirewallProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
