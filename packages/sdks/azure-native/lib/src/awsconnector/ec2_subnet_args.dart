...
class Ec2SubnetArgs {
  ...
  factory Ec2SubnetArgs.fromMap(Map<String, dynamic> map) {
    return Ec2SubnetArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2SubnetProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
