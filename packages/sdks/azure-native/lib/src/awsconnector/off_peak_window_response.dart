...
class OffPeakWindowResponse {
  ...
  const OffPeakWindowResponse({
    this.windowStartTime,
  });

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'windowStartTime': ?pulumi.Input.mapOptionalInputValue<WindowStartTimeResponse, Map<String, dynamic>>(windowStartTime, (value) => value.toMap()),
    };
  }

  factory OffPeakWindowResponse.fromMap(Map<String, dynamic> map) {
    return OffPeakWindowResponse(
      windowStartTime: (() { final guardedValue = map['windowStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowStartTimeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
