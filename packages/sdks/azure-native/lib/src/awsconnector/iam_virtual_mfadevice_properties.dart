...
import 'aws_iam_virtual_mfadevice_properties.dart';

/// Definition of IamVirtualMFADevice
class IamVirtualMFADeviceProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamVirtualMFADeviceProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamVirtualMFADeviceProperties].
  ...
  const IamVirtualMFADeviceProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamVirtualMFADeviceProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamVirtualMFADeviceProperties.fromMap(Map<String, dynamic> map) {
    return IamVirtualMFADeviceProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamVirtualMFADeviceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
