...
class IamVirtualMFADeviceProperties {
  ...
  /// AWS Properties
  final AwsIamVirtualMFADeviceProperties? awsProperties;
  /// AWS Region
  ...
  factory IamVirtualMFADeviceProperties.fromMap(Map<String, dynamic> map) {
    return IamVirtualMFADeviceProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamVirtualMFADeviceProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
