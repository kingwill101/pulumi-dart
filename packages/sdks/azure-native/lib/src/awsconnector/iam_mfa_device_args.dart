...
class IamMfaDeviceArgs {
  ...
  IamMfaDeviceArgs({
    ...
    pulumi.Output<IamMFADeviceProperties>? properties,
  ...
  factory IamMfaDeviceArgs.fromMap(Map<String, dynamic> map) {
    return IamMfaDeviceArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<IamMFADeviceProperties>(IamMFADeviceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
