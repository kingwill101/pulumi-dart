...
class IamMfaDeviceArgs {
  ...
  factory IamMfaDeviceArgs.fromMap(Map<String, dynamic> map) {
    return IamMfaDeviceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamMFADeviceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
