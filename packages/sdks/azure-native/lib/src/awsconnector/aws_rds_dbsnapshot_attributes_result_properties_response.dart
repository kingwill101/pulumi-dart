...
class AwsRdsDBSnapshotAttributesResultPropertiesResponse {
    ...
    return <String, dynamic>{
      'dbSnapshotAttributes':
          ?pulumi.Input.mapOptionalInputValue<
            List<DBSnapshotAttributeResponse>,
  ...
  factory AwsRdsDBSnapshotAttributesResultPropertiesResponse.fromMap(
    ...
    return AwsRdsDBSnapshotAttributesResultPropertiesResponse(
      dbSnapshotAttributes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DBSnapshotAttributeResponse>(
            guardedValue,
            (value) => DBSnapshotAttributeResponse.fromMap(
