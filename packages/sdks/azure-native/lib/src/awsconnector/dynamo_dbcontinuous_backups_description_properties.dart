...
class DynamoDBContinuousBackupsDescriptionProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsDynamoDBContinuousBackupsDescriptionProperties>?
  awsProperties;
  ...
  factory DynamoDBContinuousBackupsDescriptionProperties.fromMap(
    ...
    return DynamoDBContinuousBackupsDescriptionProperties(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsDynamoDBContinuousBackupsDescriptionProperties.fromMap(
