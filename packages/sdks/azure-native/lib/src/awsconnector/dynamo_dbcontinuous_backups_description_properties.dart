...
class DynamoDBContinuousBackupsDescriptionProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsDynamoDBContinuousBackupsDescriptionProperties>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsDynamoDBContinuousBackupsDescriptionProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory DynamoDBContinuousBackupsDescriptionProperties.fromMap(Map<String, dynamic> map) {
    return DynamoDBContinuousBackupsDescriptionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsDynamoDBContinuousBackupsDescriptionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
