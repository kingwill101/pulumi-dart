...
class LightsailInstanceArgs {
  ...
  factory LightsailInstanceArgs.fromMap(Map<String, dynamic> map) {
    return LightsailInstanceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LightsailInstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
