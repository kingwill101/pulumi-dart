...
class LightsailInstanceArgs {
  ...
  LightsailInstanceArgs({
    ...
    pulumi.Output<LightsailInstanceProperties>? properties,
  ...
  factory LightsailInstanceArgs.fromMap(Map<String, dynamic> map) {
    return LightsailInstanceArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<LightsailInstanceProperties>(LightsailInstanceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
