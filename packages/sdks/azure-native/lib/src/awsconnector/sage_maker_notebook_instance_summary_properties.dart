...
class SageMakerNotebookInstanceSummaryProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSageMakerNotebookInstanceSummaryProperties>?
  awsProperties;
  ...
  factory SageMakerNotebookInstanceSummaryProperties.fromMap(
    ...
    return SageMakerNotebookInstanceSummaryProperties(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsSageMakerNotebookInstanceSummaryProperties.fromMap(
