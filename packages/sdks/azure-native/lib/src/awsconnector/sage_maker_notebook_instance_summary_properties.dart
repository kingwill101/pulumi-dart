...
class SageMakerNotebookInstanceSummaryProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSageMakerNotebookInstanceSummaryProperties>? awsProperties;
  /// AWS Region
  ...
  const SageMakerNotebookInstanceSummaryProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSageMakerNotebookInstanceSummaryProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SageMakerNotebookInstanceSummaryProperties.fromMap(Map<String, dynamic> map) {
    return SageMakerNotebookInstanceSummaryProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSageMakerNotebookInstanceSummaryProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
