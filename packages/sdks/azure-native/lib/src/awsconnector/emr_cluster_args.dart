...
class EmrClusterArgs {
  ...
  factory EmrClusterArgs.fromMap(Map<String, dynamic> map) {
    return EmrClusterArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EmrClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
