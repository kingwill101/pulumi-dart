...
class EmrClusterArgs {
  ...
  EmrClusterArgs({
    ...
    pulumi.Output<EmrClusterProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<EmrClusterProperties>(properties),
  ...
  factory EmrClusterArgs.fromMap(Map<String, dynamic> map) {
    return EmrClusterArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<EmrClusterProperties>(EmrClusterProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
