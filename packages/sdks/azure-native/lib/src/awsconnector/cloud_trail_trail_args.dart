...
class CloudTrailTrailArgs {
  ...
  CloudTrailTrailArgs({
    ...
    pulumi.Output<CloudTrailTrailProperties>? properties,
  ...
  factory CloudTrailTrailArgs.fromMap(Map<String, dynamic> map) {
    return CloudTrailTrailArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<CloudTrailTrailProperties>(CloudTrailTrailProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
