...
import 'aws_logs_log_stream_properties_response.dart';

/// Definition of LogsLogStream
class LogsLogStreamPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLogsLogStreamPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LogsLogStreamPropertiesResponse].
  ...
  const LogsLogStreamPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsLogStreamPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsLogStreamPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LogsLogStreamPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsLogStreamPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
