...
class LogsLogStreamPropertiesResponse {
  ...
  /// AWS Properties
  final AwsLogsLogStreamPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory LogsLogStreamPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LogsLogStreamPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLogsLogStreamPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
