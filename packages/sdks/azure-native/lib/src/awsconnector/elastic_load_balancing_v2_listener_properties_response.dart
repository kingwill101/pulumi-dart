...
import 'aws_elastic_load_balancing_v2_listener_properties_response.dart';

/// Definition of ElasticLoadBalancingV2Listener
class ElasticLoadBalancingV2ListenerPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsElasticLoadBalancingV2ListenerPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticLoadBalancingV2ListenerPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticLoadBalancingV2ListenerPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticLoadBalancingV2ListenerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2ListenerPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticLoadBalancingV2ListenerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
