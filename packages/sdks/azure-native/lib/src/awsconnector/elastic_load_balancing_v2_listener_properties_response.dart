...
class ElasticLoadBalancingV2ListenerPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticLoadBalancingV2ListenerPropertiesResponse>?
  awsProperties;
  ...
  factory ElasticLoadBalancingV2ListenerPropertiesResponse.fromMap(
    ...
    return ElasticLoadBalancingV2ListenerPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsElasticLoadBalancingV2ListenerPropertiesResponse.fromMap(
