...
class AwsEmrClusterProperties {
  ...
  final InstanceCollectionTypeEnumValue? instanceCollectionType;
  ...
  final RepoUpgradeOnBootEnumValue? repoUpgradeOnBoot;
  ...
  final ScaleDownBehaviorEnumValue? scaleDownBehavior;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'applications': ?applications == null ? null : pulumi.Input.encodeList<Application, Map<String, dynamic>>(applications!, (value) => value.toMap()),
      ...
      'placementGroups': ?placementGroups == null ? null : pulumi.Input.encodeList<PlacementGroupConfig, Map<String, dynamic>>(placementGroups!, (value) => value.toMap()),
  ...
  factory AwsEmrClusterProperties.fromMap(Map<String, dynamic> map) {
    return AwsEmrClusterProperties(
      applications: map['applications'] == null ? null : pulumi.Input.decodeList<Application>(map['applications'], (value) => Application.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ec2InstanceAttributes: map['ec2InstanceAttributes'] == null ? null : Ec2InstanceAttributes.fromMap((map['ec2InstanceAttributes'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      instanceCollectionType: map['instanceCollectionType'] == null ? null : InstanceCollectionTypeEnumValue.fromMap((map['instanceCollectionType'] as Map).cast<String, dynamic>()),
      kerberosAttributes: map['kerberosAttributes'] == null ? null : KerberosAttributes.fromMap((map['kerberosAttributes'] as Map).cast<String, dynamic>()),
      ...
      placementGroups: map['placementGroups'] == null ? null : pulumi.Input.decodeList<PlacementGroupConfig>(map['placementGroups'], (value) => PlacementGroupConfig.fromMap((value as Map).cast<String, dynamic>())),
      releaseLabel: map['releaseLabel'] == null ? null : map['releaseLabel'] as String,
      repoUpgradeOnBoot: map['repoUpgradeOnBoot'] == null ? null : RepoUpgradeOnBootEnumValue.fromMap((map['repoUpgradeOnBoot'] as Map).cast<String, dynamic>()),
      ...
      scaleDownBehavior: map['scaleDownBehavior'] == null ? null : ScaleDownBehaviorEnumValue.fromMap((map['scaleDownBehavior'] as Map).cast<String, dynamic>()),
      ...
      status: map['status'] == null ? null : EmrClusterStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
