...
import 'container_definition_response.dart';
import 'ephemeral_storage_response.dart';
import 'inference_accelerator_response.dart';
import 'proxy_configuration_response.dart';
import 'runtime_platform_response.dart';
import 'tag_response.dart';
import 'task_definition_placement_constraint_response.dart';
import 'volume_response.dart';

/// Definition of awsEcsTaskDefinition
class AwsEcsTaskDefinitionPropertiesResponse {
  /// A list of container definitions in JSON format that describe the different containers that make up your task. For more information about container definition parameters and defaults, see [Amazon ECS Task Definitions](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_defintions.html) in the *Amazon Elastic Container Service Developer Guide*.
  final pulumi.Input<List<ContainerDefinitionResponse>>? containerDefinitions;
  ...
  final pulumi.Input<List<InferenceAcceleratorResponse>>? inferenceAccelerators;
  ...
  final pulumi.Input<List<TaskDefinitionPlacementConstraintResponse>>?
  ...
  final pulumi.Input<ProxyConfigurationResponse>? proxyConfiguration;
  ...
  final pulumi.Input<RuntimePlatformResponse>? runtimePlatform;
  ...
  /// Creates a new [AwsEcsTaskDefinitionPropertiesResponse].
  ...
  /// [memory] The amount (in MiB) of memory used by the task. If your tasks runs on Amazon EC2 instances, you must specify either a task-level memory value or a container-level memory value. This field is optional and any value can be used. If a task-level memory value is specified, the container-level memory value is optional. For more information regarding container-level memory and memory reservation, see [ContainerDefinition](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_ContainerDefinition.html). If your tasks runs on FARGATElong, this field is required. You must use one of the following values. The value you choose determines your range of valid values for the ``cpu`` parameter.  +  512 (0.5 GB), 1024 (1 GB), 2048 (2 GB) - Available ``cpu`` values: 256 (.25 vCPU)  +  1024 (1 GB), 2048 (2 GB), 3072 (3 GB), 4096 (4 GB) - Available ``cpu`` values: 512 (.5 vCPU)  +  2048 (2 GB), 3072 (3 GB), 4096 (4 GB), 5120 (5 GB), 6144 (6 GB), 7168 (7 GB), 8192 (8 GB) - Available ``cpu`` values: 1024 (1 vCPU)  +  Between 4096 (4 GB) and 16384 (16 GB) in increments of 1024 (1 GB) - Available ``cpu`` values: 2048 (2 vCPU)  +  Between 8192 (8 GB) and 30720 (30 GB) in increments of 1024 (1 GB) - Available ``cpu`` values: 4096 (4 vCPU)  +  Between 16 GB and 60 GB in 4 GB increments - Available ``cpu`` values: 8192 (8 vCPU) This option requires Linux platform ``1.4.0`` or later.  +  Between 32GB and 120 GB in 8 GB increments - Available ``cpu`` values: 16384 (16 vCPU) This option requires Linux platform ``1.4.0`` or later.
  ...
  /// [placementConstraints] An array of placement constraint objects to use for tasks.  This parameter isn't supported for tasks run on FARGATElong.
  /// [proxyConfiguration] The configuration details for the App Mesh proxy. Your Amazon ECS container instances require at least version 1.26.0 of the container agent and at least version 1.26.0-1 of the ``ecs-init`` package to use a proxy configuration. If your container instances are launched from the Amazon ECS optimized AMI version ``20190301`` or later, they contain the required versions of the container agent and ``ecs-init``. For more information, see [Amazon ECS-optimized Linux AMI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html) in the *Amazon Elastic Container Service Developer Guide*. The configuration details for the App Mesh proxy. For tasks that use the EC2 launch type, the container instances require at least version 1.26.0 of the container agent and at least version 1.26.0-1 of the ``ecs-init`` package to use a proxy configuration. If your container instances are launched from the Amazon ECS optimized AMI version ``20190301`` or later, then they contain the required versions of the container agent and ``ecs-init``. For more information, see [Amazon ECS-optimized Linux AMI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html)
  /// [requiresCompatibilities] The task launch types the task definition was validated against. The valid values are ``EC2``, ``FARGATE``, and ``EXTERNAL``. For more information, see [Amazon ECS launch types](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html) in the *Amazon Elastic Container Service Developer Guide*.
  /// [runtimePlatform] The operating system that your tasks definitions run on. A platform family is specified only for tasks using the Fargate launch type.  When you specify a task definition in a service, this value must match the ``runtimePlatform`` value of the service. Information about the platform for the Amazon ECS service or task. For more information about ``RuntimePlatform``, see [RuntimePlatform](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_definition_parameters.html#runtime-platform) in the *Amazon Elastic Container Service Developer Guide*.
    ...
    return <String, dynamic>{
      'containerDefinitions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerDefinitionResponse>,
      ...
      'inferenceAccelerators':
          ?pulumi.Input.mapOptionalInputValue<
            List<InferenceAcceleratorResponse>,
            List<Map<String, dynamic>>
          >(
            inferenceAccelerators,
            (value) =>
      ...
      'placementConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<TaskDefinitionPlacementConstraintResponse>,
            List<Map<String, dynamic>>
          >(
            placementConstraints,
            (value) =>
  ...
  factory AwsEcsTaskDefinitionPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AwsEcsTaskDefinitionPropertiesResponse(
      containerDefinitions: (() {
        final guardedValue = map['containerDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerDefinitionResponse>(
            guardedValue,
            (value) => ContainerDefinitionResponse.fromMap(
      ...
      ephemeralStorage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EphemeralStorageResponse.fromMap(
      ...
      inferenceAccelerators: (() {
        final guardedValue = map['inferenceAccelerators'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InferenceAcceleratorResponse>(
            guardedValue,
            (value) => InferenceAcceleratorResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      placementConstraints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TaskDefinitionPlacementConstraintResponse>(
            guardedValue,
            (value) => TaskDefinitionPlacementConstraintResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      proxyConfiguration: (() {
        final guardedValue = map['proxyConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProxyConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      requiresCompatibilities: (() {
        final guardedValue = map['requiresCompatibilities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      runtimePlatform: (() {
        final guardedValue = map['runtimePlatform'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuntimePlatformResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      taskDefinitionArn: (() {
        final guardedValue = map['taskDefinitionArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      taskRoleArn: (() {
