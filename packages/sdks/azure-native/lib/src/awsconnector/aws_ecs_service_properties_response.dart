...
import 'deployment_controller_response.dart';
import 'load_balancer_response.dart';
import 'network_configuration_response.dart';
import 'placement_constraint_response.dart';
import 'placement_strategy_response.dart';
import 'service_connect_configuration_response.dart';
import 'service_registry_response.dart';
import 'service_volume_configuration_response.dart';
import 'tag_response.dart';

/// Definition of awsEcsService
class AwsEcsServicePropertiesResponse {
  /// The capacity provider strategy to use for the service. If a ``capacityProviderStrategy`` is specified, the ``launchType`` parameter must be omitted. If no ``capacityProviderStrategy`` or ``launchType`` is specified, the ``defaultCapacityProviderStrategy`` for the cluster is used. A capacity provider strategy may contain a maximum of 6 capacity providers.
  final pulumi.Input<List<CapacityProviderStrategyItemResponse>>? capacityProviderStrategy;
  ...
  final pulumi.Input<DeploymentConfigurationResponse>? deploymentConfiguration;
  ...
  final pulumi.Input<DeploymentControllerResponse>? deploymentController;
  ...
  final pulumi.Input<List<LoadBalancerResponse>>? loadBalancers;
  /// Property name
  ...
  final pulumi.Input<List<PlacementConstraintResponse>>? placementConstraints;
  /// The placement strategy objects to use for tasks in your service. You can specify a maximum of 5 strategy rules for each service.
  final pulumi.Input<List<PlacementStrategyResponse>>? placementStrategies;
  ...
  final pulumi.Input<ServiceConnectConfigurationResponse>? serviceConnectConfiguration;
  ...
  final pulumi.Input<List<ServiceRegistryResponse>>? serviceRegistries;
  ...
  final pulumi.Input<List<ServiceVolumeConfigurationResponse>>? volumeConfigurations;

  /// Creates a new [AwsEcsServicePropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'capacityProviderStrategy': ?pulumi.Input.mapOptionalInputValue<List<CapacityProviderStrategyItemResponse>, List<Map<String, dynamic>>>(capacityProviderStrategy, (value) => pulumi.Input.encodeList<CapacityProviderStrategyItemResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cluster': ?cluster,
      'deploymentConfiguration': ?pulumi.Input.mapOptionalInputValue<DeploymentConfigurationResponse, Map<String, dynamic>>(deploymentConfiguration, (value) => value.toMap()),
      'deploymentController': ?pulumi.Input.mapOptionalInputValue<DeploymentControllerResponse, Map<String, dynamic>>(deploymentController, (value) => value.toMap()),
      'desiredCount': ?desiredCount,
      'enableECSManagedTags': ?enableECSManagedTags,
      'enableExecuteCommand': ?enableExecuteCommand,
      'healthCheckGracePeriodSeconds': ?healthCheckGracePeriodSeconds,
      'launchType': ?launchType,
      'loadBalancers': ?pulumi.Input.mapOptionalInputValue<List<LoadBalancerResponse>, List<Map<String, dynamic>>>(loadBalancers, (value) => pulumi.Input.encodeList<LoadBalancerResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      ...
      'placementConstraints': ?pulumi.Input.mapOptionalInputValue<List<PlacementConstraintResponse>, List<Map<String, dynamic>>>(placementConstraints, (value) => pulumi.Input.encodeList<PlacementConstraintResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'placementStrategies': ?pulumi.Input.mapOptionalInputValue<List<PlacementStrategyResponse>, List<Map<String, dynamic>>>(placementStrategies, (value) => pulumi.Input.encodeList<PlacementStrategyResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'platformVersion': ?platformVersion,
      'propagateTags': ?propagateTags,
      'role': ?role,
      'schedulingStrategy': ?schedulingStrategy,
      'serviceArn': ?serviceArn,
      'serviceConnectConfiguration': ?pulumi.Input.mapOptionalInputValue<ServiceConnectConfigurationResponse, Map<String, dynamic>>(serviceConnectConfiguration, (value) => value.toMap()),
      'serviceName': ?serviceName,
      'serviceRegistries': ?pulumi.Input.mapOptionalInputValue<List<ServiceRegistryResponse>, List<Map<String, dynamic>>>(serviceRegistries, (value) => pulumi.Input.encodeList<ServiceRegistryResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'tags': ?pulumi.Input.mapOptionalInputValue<List<TagResponse>, List<Map<String, dynamic>>>(tags, (value) => pulumi.Input.encodeList<TagResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'taskDefinition': ?taskDefinition,
      'volumeConfigurations': ?pulumi.Input.mapOptionalInputValue<List<ServiceVolumeConfigurationResponse>, List<Map<String, dynamic>>>(volumeConfigurations, (value) => pulumi.Input.encodeList<ServiceVolumeConfigurationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory AwsEcsServicePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEcsServicePropertiesResponse(
      capacityProviderStrategy: map['capacityProviderStrategy'] == null ? null : (pulumi.Input.decodeList<CapacityProviderStrategyItemResponse>(map['capacityProviderStrategy']!, (value) => CapacityProviderStrategyItemResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cluster: map['cluster'] == null ? null : (map['cluster']! as String).input(),
      deploymentConfiguration: map['deploymentConfiguration'] == null ? null : (DeploymentConfigurationResponse.fromMap((map['deploymentConfiguration']! as Map).cast<String, dynamic>())).input(),
      deploymentController: map['deploymentController'] == null ? null : (DeploymentControllerResponse.fromMap((map['deploymentController']! as Map).cast<String, dynamic>())).input(),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : (pulumi.Input.decodeList<LoadBalancerResponse>(map['loadBalancers']!, (value) => LoadBalancerResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      placementConstraints: map['placementConstraints'] == null ? null : (pulumi.Input.decodeList<PlacementConstraintResponse>(map['placementConstraints']!, (value) => PlacementConstraintResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      placementStrategies: map['placementStrategies'] == null ? null : (pulumi.Input.decodeList<PlacementStrategyResponse>(map['placementStrategies']!, (value) => PlacementStrategyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      serviceConnectConfiguration: map['serviceConnectConfiguration'] == null ? null : (ServiceConnectConfigurationResponse.fromMap((map['serviceConnectConfiguration']! as Map).cast<String, dynamic>())).input(),
      serviceName: map['serviceName'] == null ? null : (map['serviceName']! as String).input(),
      serviceRegistries: map['serviceRegistries'] == null ? null : (pulumi.Input.decodeList<ServiceRegistryResponse>(map['serviceRegistries']!, (value) => ServiceRegistryResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      volumeConfigurations: map['volumeConfigurations'] == null ? null : (pulumi.Input.decodeList<ServiceVolumeConfigurationResponse>(map['volumeConfigurations']!, (value) => ServiceVolumeConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
