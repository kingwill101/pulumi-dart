...
class LambdaConfigurationResponse {
  ...
  const LambdaConfigurationResponse({
    this.event,
    this.filter,
    this.function,
  });
  ...
  factory LambdaConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return LambdaConfigurationResponse(
      ...
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotificationFilterResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
