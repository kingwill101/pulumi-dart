...
class EcsServiceProperties {
  ...
  /// AWS Properties
  final AwsEcsServiceProperties? awsProperties;
  /// AWS Region
  ...
  factory EcsServiceProperties.fromMap(Map<String, dynamic> map) {
    return EcsServiceProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcsServiceProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
