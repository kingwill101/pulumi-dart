...
import 'aws_ecs_service_properties.dart';

/// Definition of EcsService
class EcsServiceProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcsServiceProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcsServiceProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcsServiceProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcsServiceProperties.fromMap(Map<String, dynamic> map) {
    return EcsServiceProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcsServiceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
