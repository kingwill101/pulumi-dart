  ...
  factory AwsEc2ImageProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2ImageProperties(
      ...
      blockDeviceMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BlockDeviceMapping>(
            guardedValue,
            (value) => BlockDeviceMapping.fromMap(
      ...
      imageType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageTypeValuesEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      imdsSupport: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImdsSupportValuesEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      tpmSupport: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TpmSupportValuesEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
