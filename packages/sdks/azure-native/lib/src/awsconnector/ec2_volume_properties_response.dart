...
class Ec2VolumePropertiesResponse {
  ...
  const Ec2VolumePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2VolumePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2VolumePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2VolumePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2VolumePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
