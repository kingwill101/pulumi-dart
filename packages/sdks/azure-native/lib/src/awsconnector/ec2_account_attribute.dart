...
/// }
///
/// resource "azure-native_awsconnector_ec2accountattribute" "ec2AccountAttribute" {
///   location = "mxywielgbokfdxxwuudnbwzjcf"
///   name     = "Replace this value with a string matching RegExp ^(z=.{0,259}[^zs.]$)(z!.*[zzzzzzzz])"
///   properties = {
///     arn            = "ttwi"
...
class Ec2AccountAttribute extends pulumi.CustomResource {
  ...
  Ec2AccountAttribute(
    ...
    properties = registerOutput<Ec2AccountAttributePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return Ec2AccountAttributePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [Ec2AccountAttribute] resource.
  Ec2AccountAttribute.reference(String urn)
    : super(
        'azure-native:awsconnector:Ec2AccountAttribute',
