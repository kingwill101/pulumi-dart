...
class ConfigServiceConfigurationRecorderStatusProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsConfigServiceConfigurationRecorderStatusProperties>?
  awsProperties;
  ...
  factory ConfigServiceConfigurationRecorderStatusProperties.fromMap(
    ...
    return ConfigServiceConfigurationRecorderStatusProperties(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsConfigServiceConfigurationRecorderStatusProperties.fromMap(
