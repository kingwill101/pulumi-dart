...
import 'aws_config_service_configuration_recorder_status_properties.dart';

/// Definition of ConfigServiceConfigurationRecorderStatus
class ConfigServiceConfigurationRecorderStatusProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsConfigServiceConfigurationRecorderStatusProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ConfigServiceConfigurationRecorderStatusProperties].
  ...
  const ConfigServiceConfigurationRecorderStatusProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsConfigServiceConfigurationRecorderStatusProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ConfigServiceConfigurationRecorderStatusProperties.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderStatusProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsConfigServiceConfigurationRecorderStatusProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
