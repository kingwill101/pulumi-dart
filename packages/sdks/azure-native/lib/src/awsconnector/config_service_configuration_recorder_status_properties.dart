...
class ConfigServiceConfigurationRecorderStatusProperties {
  ...
  /// AWS Properties
  final AwsConfigServiceConfigurationRecorderStatusProperties? awsProperties;
  /// AWS Region
  ...
  factory ConfigServiceConfigurationRecorderStatusProperties.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderStatusProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsConfigServiceConfigurationRecorderStatusProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
