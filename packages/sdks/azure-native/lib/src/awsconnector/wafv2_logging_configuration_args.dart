...
class Wafv2LoggingConfigurationArgs {
  ...
  factory Wafv2LoggingConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return Wafv2LoggingConfigurationArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Wafv2LoggingConfigurationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
