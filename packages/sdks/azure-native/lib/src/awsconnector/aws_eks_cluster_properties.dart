    ...
    return <String, dynamic>{
      ...
      'encryptionConfig':
          ...
          >(
            encryptionConfig,
            (value) =>
                pulumi.Input.encodeList<EncryptionConfig, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsEksClusterProperties.fromMap(Map<String, dynamic> map) {
    return AwsEksClusterProperties(
      ...
      certificateAuthority: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Certificate.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      clientRequestToken: (() {
      ...
      connectorConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConnectorConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      encryptionConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EncryptionConfig>(
            guardedValue,
            (value) => EncryptionConfig.fromMap(
      ...
      health: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterHealth.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      id: (() {
      ...
      kubernetesNetworkConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KubernetesNetworkConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterStatusEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
