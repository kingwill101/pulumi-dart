...
class FileSystemProtection {
  ...
  final String? replicationOverwriteProtection;
  ...
  factory FileSystemProtection.fromMap(Map<String, dynamic> map) {
    return FileSystemProtection(
      replicationOverwriteProtection: map['replicationOverwriteProtection'] == null ? null : map['replicationOverwriteProtection'] as String,
    );
  }
}
