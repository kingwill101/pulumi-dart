...
class FileSystemProtection {
  ...
  final pulumi.Input<dynamic>? replicationOverwriteProtection;
  ...
  factory FileSystemProtection.fromMap(Map<String, dynamic> map) {
    return FileSystemProtection(
      replicationOverwriteProtection: (() { final guardedValue = map['replicationOverwriteProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
