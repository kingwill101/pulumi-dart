...
class AwsAppSyncGraphqlApiProperties {
  ...
  factory AwsAppSyncGraphqlApiProperties.fromMap(Map<String, dynamic> map) {
    return AwsAppSyncGraphqlApiProperties(
      additionalAuthenticationProviders: (() { final guardedValue = map['additionalAuthenticationProviders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AdditionalAuthenticationProvider>(guardedValue, (value) => AdditionalAuthenticationProvider.fromMap((value as Map).cast<String, dynamic>()))); })(),
      apiId: (() { final guardedValue = map['apiId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      apiType: (() { final guardedValue = map['apiType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GraphQLApiTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      enhancedMetricsConfig: (() { final guardedValue = map['enhancedMetricsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnhancedMetricsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      introspectionConfig: (() { final guardedValue = map['introspectionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GraphQLApiIntrospectionConfigEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      queryDepthLimit: (() { final guardedValue = map['queryDepthLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      resolverCountLimit: (() { final guardedValue = map['resolverCountLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      userPoolConfig: (() { final guardedValue = map['userPoolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserPoolConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      visibility: (() { final guardedValue = map['visibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GraphQLApiVisibilityEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
