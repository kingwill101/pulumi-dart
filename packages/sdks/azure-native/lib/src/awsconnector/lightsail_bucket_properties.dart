...
class LightsailBucketProperties {
  ...
  /// AWS Properties
  final AwsLightsailBucketProperties? awsProperties;
  /// AWS Region
  ...
  factory LightsailBucketProperties.fromMap(Map<String, dynamic> map) {
    return LightsailBucketProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLightsailBucketProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
