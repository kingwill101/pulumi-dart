...
import 'aws_lightsail_bucket_properties.dart';

/// Definition of LightsailBucket
class LightsailBucketProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLightsailBucketProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LightsailBucketProperties].
  ...
  const LightsailBucketProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLightsailBucketProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LightsailBucketProperties.fromMap(Map<String, dynamic> map) {
    return LightsailBucketProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLightsailBucketProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
