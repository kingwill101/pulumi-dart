...
class ElasticLoadBalancingv2TargetHealthDescription extends pulumi.CustomResource {
  ...
  ElasticLoadBalancingv2TargetHealthDescription(
    ...
    properties = registerOutput<ElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ElasticLoadBalancingv2TargetHealthDescription] resource.
  ElasticLoadBalancingv2TargetHealthDescription.reference(String urn)
    : super(
        'azure-native:awsconnector:ElasticLoadBalancingv2TargetHealthDescription',
