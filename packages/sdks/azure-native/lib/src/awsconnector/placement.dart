...
import 'tenancy_enum_value.dart';
...
class Placement {
  ...
  final pulumi.Input<TenancyEnumValue?>? tenancy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tenancy': ?pulumi.Input.mapOptionalInputValue<TenancyEnumValue, Map<String, dynamic>>(tenancy, (value) => value.toMap()),
    };
  }
  ...
  factory Placement.fromMap(Map<String, dynamic> map) {
    return Placement(
      ...
      partitionNumber: (() { final guardedValue = map['partitionNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      tenancy: (() { final guardedValue = map['tenancy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TenancyEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
