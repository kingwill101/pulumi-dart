...
class Route53HostedZoneArgs {
  ...
  factory Route53HostedZoneArgs.fromMap(Map<String, dynamic> map) {
    return Route53HostedZoneArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Route53HostedZoneProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
