...
import 'deployment_alarms_response.dart';
import 'deployment_circuit_breaker_response.dart';
...
class DeploymentConfigurationResponse {
  ...
  final pulumi.Input<DeploymentAlarmsResponse>? alarms;
  ...
  final pulumi.Input<DeploymentCircuitBreakerResponse>?
    ...
    return DeploymentConfigurationResponse(
      alarms: (() {
        ...
        return pulumi.Input.fromValue(
          DeploymentAlarmsResponse.fromMap(
      ...
      deploymentCircuitBreaker: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentCircuitBreakerResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
