    ...
    return <String, dynamic>{
      ...
      'clusterSettings':
          ...
          >(
            clusterSettings,
            (value) =>
                pulumi.Input.encodeList<ClusterSettings, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AwsEcsClusterProperties(
      ...
      clusterSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterSettings>(
            guardedValue,
            (value) =>
                ClusterSettings.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      configuration: (() {
      ...
      defaultCapacityProviderStrategy: (() {
        final guardedValue = map['defaultCapacityProviderStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      serviceConnectDefaults: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConnectDefaults.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
