...
class RoutingRuleResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'redirectRule': ?pulumi.Input.mapOptionalInputValue<RedirectRuleResponse, Map<String, dynamic>>(redirectRule, (value) => value.toMap()),
      'routingRuleCondition': ?pulumi.Input.mapOptionalInputValue<RoutingRuleConditionResponse, Map<String, dynamic>>(routingRuleCondition, (value) => value.toMap()),
    };
  }

  factory RoutingRuleResponse.fromMap(Map<String, dynamic> map) {
    return RoutingRuleResponse(
      redirectRule: (() { final guardedValue = map['redirectRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RedirectRuleResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      routingRuleCondition: (() { final guardedValue = map['routingRuleCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoutingRuleConditionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
