...
class ApplicationResourceLifecycleConfigResponse {
  ...
  final pulumi.Input<ApplicationVersionLifecycleConfigResponse>?
    ...
    return <String, dynamic>{
      ...
      'versionLifecycleConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(versionLifecycleConfig, (value) => value.toMap()),
    };
  }

  factory ApplicationResourceLifecycleConfigResponse.fromMap(
    ...
    return ApplicationResourceLifecycleConfigResponse(
      ...
      versionLifecycleConfig: (() {
        final guardedValue = map['versionLifecycleConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationVersionLifecycleConfigResponse.fromMap(
