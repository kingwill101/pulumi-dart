...
class LogsLogStreamArgs {
  ...
  factory LogsLogStreamArgs.fromMap(Map<String, dynamic> map) {
    return LogsLogStreamArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogsLogStreamProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
