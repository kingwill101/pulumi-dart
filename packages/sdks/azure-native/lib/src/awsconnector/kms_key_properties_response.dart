...
import 'aws_kms_key_properties_response.dart';

/// Definition of KmsKey
class KmsKeyPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsKmsKeyPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [KmsKeyPropertiesResponse].
  ...
  const KmsKeyPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsKmsKeyPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory KmsKeyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return KmsKeyPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsKmsKeyPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
