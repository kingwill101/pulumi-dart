...
class KmsKeyPropertiesResponse {
  ...
  /// AWS Properties
  final AwsKmsKeyPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory KmsKeyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return KmsKeyPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsKmsKeyPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
