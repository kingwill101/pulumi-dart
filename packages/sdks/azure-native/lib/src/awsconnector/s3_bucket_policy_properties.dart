...
class S3BucketPolicyProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsS3BucketPolicyProperties>? awsProperties;
  /// AWS Region
  ...
  const S3BucketPolicyProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3BucketPolicyProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3BucketPolicyProperties.fromMap(Map<String, dynamic> map) {
    return S3BucketPolicyProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3BucketPolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
