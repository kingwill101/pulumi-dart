...
class IamPasswordPolicyArgs {
  ...
  factory IamPasswordPolicyArgs.fromMap(Map<String, dynamic> map) {
    return IamPasswordPolicyArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamPasswordPolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
