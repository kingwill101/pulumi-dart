...
class EnvironmentVariableResponse {
  ...
  factory EnvironmentVariableResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentVariableResponse(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EnvironmentVariableTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
