...
import 'aws_rds_dbsnapshot_properties.dart';

/// Definition of RdsDBSnapshot
class RdsDBSnapshotProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsDBSnapshotProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsDBSnapshotProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsDBSnapshotProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsDBSnapshotProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBSnapshotProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
