    ...
    return RuleGroup(
      referenceSets: (() {
        ...
        return pulumi.Input.fromValue(
          ReferenceSets.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ruleVariables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuleVariables.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      rulesSource: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RulesSource.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      statefulRuleOptions: (() {
