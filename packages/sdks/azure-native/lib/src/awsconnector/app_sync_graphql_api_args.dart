...
class AppSyncGraphqlApiArgs {
  ...
  AppSyncGraphqlApiArgs({
    ...
    pulumi.Output<AppSyncGraphqlApiProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<AppSyncGraphqlApiProperties>(properties),
  ...
  factory AppSyncGraphqlApiArgs.fromMap(Map<String, dynamic> map) {
    return AppSyncGraphqlApiArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<AppSyncGraphqlApiProperties>(AppSyncGraphqlApiProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
