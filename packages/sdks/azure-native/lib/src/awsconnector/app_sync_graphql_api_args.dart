...
class AppSyncGraphqlApiArgs {
  ...
  factory AppSyncGraphqlApiArgs.fromMap(Map<String, dynamic> map) {
    return AppSyncGraphqlApiArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppSyncGraphqlApiProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
