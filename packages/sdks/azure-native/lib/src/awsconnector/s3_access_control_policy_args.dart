...
class S3AccessControlPolicyArgs {
  ...
  S3AccessControlPolicyArgs({
    ...
    pulumi.Output<S3AccessControlPolicyProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<S3AccessControlPolicyProperties>(properties),
  ...
  factory S3AccessControlPolicyArgs.fromMap(Map<String, dynamic> map) {
    return S3AccessControlPolicyArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<S3AccessControlPolicyProperties>(S3AccessControlPolicyProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
