...
class OpenSearchDomainStatusArgs {
  ...
  OpenSearchDomainStatusArgs({
    ...
    pulumi.Output<OpenSearchDomainStatusProperties>? properties,
  ...
  factory OpenSearchDomainStatusArgs.fromMap(Map<String, dynamic> map) {
    return OpenSearchDomainStatusArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<OpenSearchDomainStatusProperties>(OpenSearchDomainStatusProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
