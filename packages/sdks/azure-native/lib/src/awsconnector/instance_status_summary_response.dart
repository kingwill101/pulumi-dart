...
class InstanceStatusSummaryResponse {
  ...
  factory InstanceStatusSummaryResponse.fromMap(Map<String, dynamic> map) {
    return InstanceStatusSummaryResponse(
      details: (() { final guardedValue = map['details']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceStatusDetailsResponse>(guardedValue, (value) => InstanceStatusDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SummaryStatusEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
