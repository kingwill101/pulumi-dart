...
import 'aws_lambda_function_code_location_properties.dart';

/// Definition of LambdaFunctionCodeLocation
class LambdaFunctionCodeLocationProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLambdaFunctionCodeLocationProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LambdaFunctionCodeLocationProperties].
  ...
  const LambdaFunctionCodeLocationProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLambdaFunctionCodeLocationProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LambdaFunctionCodeLocationProperties.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionCodeLocationProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLambdaFunctionCodeLocationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
