...
class IntelligentTieringConfigurationResponse {
  ...
  const IntelligentTieringConfigurationResponse({
    this.id,
    this.prefix,
    this.status,
    this.tagFilters,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tierings': ?pulumi.Input.mapOptionalInputValue<List<TieringResponse>, List<Map<String, dynamic>>>(tierings, (value) => pulumi.Input.encodeList<TieringResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory IntelligentTieringConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return IntelligentTieringConfigurationResponse(
      ...
      tierings: (() { final guardedValue = map['tierings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TieringResponse>(guardedValue, (value) => TieringResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
