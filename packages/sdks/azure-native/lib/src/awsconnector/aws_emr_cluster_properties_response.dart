...
class AwsEmrClusterPropertiesResponse {
  ...
  const AwsEmrClusterPropertiesResponse({
    this.applications,
  ...
  factory AwsEmrClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEmrClusterPropertiesResponse(
      applications: (() { final guardedValue = map['applications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationResponse>(guardedValue, (value) => ApplicationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ebsRootVolumeIops: (() { final guardedValue = map['ebsRootVolumeIops']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      ebsRootVolumeThroughput: (() { final guardedValue = map['ebsRootVolumeThroughput']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ec2InstanceAttributes: (() { final guardedValue = map['ec2InstanceAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2InstanceAttributesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instanceCollectionType: (() { final guardedValue = map['instanceCollectionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceCollectionTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kerberosAttributes: (() { final guardedValue = map['kerberosAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KerberosAttributesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      normalizedInstanceHours: (() { final guardedValue = map['normalizedInstanceHours']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      placementGroups: (() { final guardedValue = map['placementGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PlacementGroupConfigResponse>(guardedValue, (value) => PlacementGroupConfigResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      repoUpgradeOnBoot: (() { final guardedValue = map['repoUpgradeOnBoot']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepoUpgradeOnBootEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      scaleDownBehavior: (() { final guardedValue = map['scaleDownBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScaleDownBehaviorEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EmrClusterStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
