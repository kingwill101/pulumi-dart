...
class Ec2VpcArgs {
  ...
  factory Ec2VpcArgs.fromMap(Map<String, dynamic> map) {
    return Ec2VpcArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2VpcProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
