...
import 'aws_s3_access_point_properties.dart';

/// Definition of S3AccessPoint
class S3AccessPointProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsS3AccessPointProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3AccessPointProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3AccessPointProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3AccessPointProperties.fromMap(Map<String, dynamic> map) {
    return S3AccessPointProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3AccessPointProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
