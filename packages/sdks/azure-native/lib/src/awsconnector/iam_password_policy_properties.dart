...
class IamPasswordPolicyProperties {
  ...
  /// AWS Properties
  final AwsIamPasswordPolicyProperties? awsProperties;
  /// AWS Region
  ...
  factory IamPasswordPolicyProperties.fromMap(Map<String, dynamic> map) {
    return IamPasswordPolicyProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamPasswordPolicyProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
