...
class IamPasswordPolicyProperties {
  ...
  const IamPasswordPolicyProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory IamPasswordPolicyProperties.fromMap(Map<String, dynamic> map) {
    return IamPasswordPolicyProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamPasswordPolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
