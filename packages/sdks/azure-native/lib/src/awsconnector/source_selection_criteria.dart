...
class SourceSelectionCriteria {
  ...
  factory SourceSelectionCriteria.fromMap(Map<String, dynamic> map) {
    return SourceSelectionCriteria(
      replicaModifications: (() { final guardedValue = map['replicaModifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicaModifications.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sseKmsEncryptedObjects: (() { final guardedValue = map['sseKmsEncryptedObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SseKmsEncryptedObjects.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
