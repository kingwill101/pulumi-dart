...
import 'aws_iam_instance_profile_properties_response.dart';

/// Definition of IamInstanceProfile
class IamInstanceProfilePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamInstanceProfilePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamInstanceProfilePropertiesResponse].
  ...
  const IamInstanceProfilePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamInstanceProfilePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamInstanceProfilePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamInstanceProfilePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamInstanceProfilePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
