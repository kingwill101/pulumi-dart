...
class AwsIamGroupPropertiesResponse {
  /// Property arn
  final String? arn;
  ...
  /// Creates a new [AwsIamGroupPropertiesResponse].
  /// [arn] Property arn
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'path': ?path,
      'policies': ?policies == null ? null : pulumi.Input.encodeList<PolicyResponse, Map<String, dynamic>>(policies!, (value) => value.toMap()),
    };
  }
  ...
  factory AwsIamGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsIamGroupPropertiesResponse(
      ...
      policies: map['policies'] == null ? null : pulumi.Input.decodeList<PolicyResponse>(map['policies'], (value) => PolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
