    ...
    return <String, dynamic>{
      ...
      'policies':
          ...
          >(
            policies,
            (value) =>
                pulumi.Input.encodeList<PolicyResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AwsIamGroupPropertiesResponse(
      ...
      policies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyResponse>(
            guardedValue,
            (value) =>
                PolicyResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
