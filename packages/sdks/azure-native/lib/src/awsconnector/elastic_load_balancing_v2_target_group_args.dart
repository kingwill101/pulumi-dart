...
class ElasticLoadBalancingV2TargetGroupArgs {
  ...
  ElasticLoadBalancingV2TargetGroupArgs({
    ...
    pulumi.Output<ElasticLoadBalancingV2TargetGroupProperties>? properties,
  ...
  factory ElasticLoadBalancingV2TargetGroupArgs.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2TargetGroupArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ElasticLoadBalancingV2TargetGroupProperties>(ElasticLoadBalancingV2TargetGroupProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
