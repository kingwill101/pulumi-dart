...
class AwsGuardDutyDetectorPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'features':
          ?pulumi.Input.mapOptionalInputValue<
            List<CFNFeatureConfigurationResponse>,
      ...
      'tags':
          ?pulumi.Input.mapOptionalInputValue<
            List<TagItemResponse>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
                pulumi.Input.encodeList<TagItemResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsGuardDutyDetectorPropertiesResponse.fromMap(
    ...
    return AwsGuardDutyDetectorPropertiesResponse(
      dataSources: (() {
        ...
        return pulumi.Input.fromValue(
          CFNDataSourceConfigurationsResponse.fromMap(
      ...
      features: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CFNFeatureConfigurationResponse>(
            guardedValue,
            (value) => CFNFeatureConfigurationResponse.fromMap(
      ...
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TagItemResponse>(
            guardedValue,
            (value) =>
                TagItemResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
