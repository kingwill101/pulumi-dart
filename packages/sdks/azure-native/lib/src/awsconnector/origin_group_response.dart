...
class OriginGroupResponse {
  ...
  OriginGroupResponse({this.failoverCriteria, this.id, this.members});
  ...
  factory OriginGroupResponse.fromMap(Map<String, dynamic> map) {
    return OriginGroupResponse(
      failoverCriteria: (() {
        final guardedValue = map['failoverCriteria'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OriginGroupFailoverCriteriaResponse.fromMap(
      ...
      members: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OriginGroupMembersResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
