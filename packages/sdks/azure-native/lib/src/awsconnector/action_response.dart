...
class ActionResponse {
  ...
  final pulumi.Input<AuthenticateCognitoConfigResponse>?
    ...
    return <String, dynamic>{
      'authenticateCognitoConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(authenticateCognitoConfig, (value) => value.toMap()),
      'authenticateOidcConfig':
          ?pulumi.Input.mapOptionalInputValue<
            AuthenticateOidcConfigResponse,
            Map<String, dynamic>
          >(authenticateOidcConfig, (value) => value.toMap()),
      'fixedResponseConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'forwardConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(forwardConfig, (value) => value.toMap()),
      'order': ?order,
      'redirectConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ActionResponse.fromMap(Map<String, dynamic> map) {
    return ActionResponse(
      authenticateCognitoConfig: (() {
        final guardedValue = map['authenticateCognitoConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthenticateCognitoConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      authenticateOidcConfig: (() {
        final guardedValue = map['authenticateOidcConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthenticateOidcConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fixedResponseConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FixedResponseConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      forwardConfig: (() {
        final guardedValue = map['forwardConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ForwardConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      redirectConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RedirectConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
