...
class CodeBuildSourceCredentialsInfoProperties {
  ...
  /// AWS Properties
  final AwsCodeBuildSourceCredentialsInfoProperties? awsProperties;
  /// AWS Region
  ...
  factory CodeBuildSourceCredentialsInfoProperties.fromMap(Map<String, dynamic> map) {
    return CodeBuildSourceCredentialsInfoProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCodeBuildSourceCredentialsInfoProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
