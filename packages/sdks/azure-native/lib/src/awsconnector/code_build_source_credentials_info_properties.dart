...
class CodeBuildSourceCredentialsInfoProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsCodeBuildSourceCredentialsInfoProperties>?
  awsProperties;
  ...
  factory CodeBuildSourceCredentialsInfoProperties.fromMap(
    ...
    return CodeBuildSourceCredentialsInfoProperties(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsCodeBuildSourceCredentialsInfoProperties.fromMap(
