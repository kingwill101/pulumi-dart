...
import 'aws_code_build_source_credentials_info_properties.dart';

/// Definition of CodeBuildSourceCredentialsInfo
class CodeBuildSourceCredentialsInfoProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCodeBuildSourceCredentialsInfoProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CodeBuildSourceCredentialsInfoProperties].
  ...
  const CodeBuildSourceCredentialsInfoProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCodeBuildSourceCredentialsInfoProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CodeBuildSourceCredentialsInfoProperties.fromMap(Map<String, dynamic> map) {
    return CodeBuildSourceCredentialsInfoProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCodeBuildSourceCredentialsInfoProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
