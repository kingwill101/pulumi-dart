...
class AwsMacie2JobSummaryPropertiesResponse {
  ...
  const AwsMacie2JobSummaryPropertiesResponse({
    this.bucketCriteria,
  ...
  factory AwsMacie2JobSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsMacie2JobSummaryPropertiesResponse(
      bucketCriteria: (() { final guardedValue = map['bucketCriteria']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3BucketCriteriaForJobResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      bucketDefinitions: (() { final guardedValue = map['bucketDefinitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<S3BucketDefinitionForJobResponse>(guardedValue, (value) => S3BucketDefinitionForJobResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      jobStatus: (() { final guardedValue = map['jobStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobStatusEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      jobType: (() { final guardedValue = map['jobType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      lastRunErrorStatus: (() { final guardedValue = map['lastRunErrorStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LastRunErrorStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userPausedDetails: (() { final guardedValue = map['userPausedDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserPausedDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
