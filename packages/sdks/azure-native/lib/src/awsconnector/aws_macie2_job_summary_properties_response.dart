    ...
    return <String, dynamic>{
      'bucketCriteria':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bucketCriteria, (value) => value.toMap()),
      'bucketDefinitions':
          ?pulumi.Input.mapOptionalInputValue<
            List<S3BucketDefinitionForJobResponse>,
      ...
      'jobType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(jobType, (value) => value.toMap()),
      'lastRunErrorStatus':
          ?pulumi.Input.mapOptionalInputValue<
            LastRunErrorStatusResponse,
            Map<String, dynamic>
          >(lastRunErrorStatus, (value) => value.toMap()),
      'name': ?name,
      'userPausedDetails':
          ?pulumi.Input.mapOptionalInputValue<
            UserPausedDetailsResponse,
            Map<String, dynamic>
          >(userPausedDetails, (value) => value.toMap()),
    };
  }

  factory AwsMacie2JobSummaryPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AwsMacie2JobSummaryPropertiesResponse(
      bucketCriteria: (() {
        final guardedValue = map['bucketCriteria'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          S3BucketCriteriaForJobResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      bucketDefinitions: (() {
        final guardedValue = map['bucketDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<S3BucketDefinitionForJobResponse>(
            guardedValue,
            (value) => S3BucketDefinitionForJobResponse.fromMap(
      ...
      jobStatus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobStatusEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      jobType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          JobTypeEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      lastRunErrorStatus: (() {
        final guardedValue = map['lastRunErrorStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LastRunErrorStatusResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      userPausedDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserPausedDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
