...
class AwsMacie2JobSummaryPropertiesResponse {
  ...
  final S3BucketCriteriaForJobResponse? bucketCriteria;
  ...
  final List<S3BucketDefinitionForJobResponse>? bucketDefinitions;
  ...
  final JobStatusEnumValueResponse? jobStatus;
  ...
  final JobTypeEnumValueResponse? jobType;
  ...
  final LastRunErrorStatusResponse? lastRunErrorStatus;
  ...
  final UserPausedDetailsResponse? userPausedDetails;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bucketDefinitions': ?bucketDefinitions == null ? null : pulumi.Input.encodeList<S3BucketDefinitionForJobResponse, Map<String, dynamic>>(bucketDefinitions!, (value) => value.toMap()),
      'createdAt': ?createdAt,
      'jobId': ?jobId,
  ...
  factory AwsMacie2JobSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsMacie2JobSummaryPropertiesResponse(
      bucketCriteria: map['bucketCriteria'] == null ? null : S3BucketCriteriaForJobResponse.fromMap((map['bucketCriteria'] as Map).cast<String, dynamic>()),
      bucketDefinitions: map['bucketDefinitions'] == null ? null : pulumi.Input.decodeList<S3BucketDefinitionForJobResponse>(map['bucketDefinitions'], (value) => S3BucketDefinitionForJobResponse.fromMap((value as Map).cast<String, dynamic>())),
      createdAt: map['createdAt'] == null ? null : map['createdAt'] as String,
      jobId: map['jobId'] == null ? null : map['jobId'] as String,
      jobStatus: map['jobStatus'] == null ? null : JobStatusEnumValueResponse.fromMap((map['jobStatus'] as Map).cast<String, dynamic>()),
      jobType: map['jobType'] == null ? null : JobTypeEnumValueResponse.fromMap((map['jobType'] as Map).cast<String, dynamic>()),
      lastRunErrorStatus: map['lastRunErrorStatus'] == null ? null : LastRunErrorStatusResponse.fromMap((map['lastRunErrorStatus'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      userPausedDetails: map['userPausedDetails'] == null ? null : UserPausedDetailsResponse.fromMap((map['userPausedDetails'] as Map).cast<String, dynamic>()),
    );
  }
}
