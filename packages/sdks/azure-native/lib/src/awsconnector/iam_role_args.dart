...
class IamRoleArgs {
  ...
  factory IamRoleArgs.fromMap(Map<String, dynamic> map) {
    return IamRoleArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamRoleProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
