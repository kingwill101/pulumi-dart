...
class Ec2NetworkAclArgs {
  ...
  factory Ec2NetworkAclArgs.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkAclArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2NetworkAclProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
