...
class EcrImageDetailArgs {
  ...
  EcrImageDetailArgs({
    ...
    pulumi.Output<EcrImageDetailProperties>? properties,
  ...
  factory EcrImageDetailArgs.fromMap(Map<String, dynamic> map) {
    return EcrImageDetailArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<EcrImageDetailProperties>(EcrImageDetailProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
