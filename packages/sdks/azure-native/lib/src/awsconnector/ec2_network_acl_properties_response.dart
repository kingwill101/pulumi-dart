...
import 'aws_ec2_network_acl_properties_response.dart';

/// Definition of Ec2NetworkAcl
class Ec2NetworkAclPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2NetworkAclPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2NetworkAclPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2NetworkAclPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2NetworkAclPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkAclPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2NetworkAclPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
