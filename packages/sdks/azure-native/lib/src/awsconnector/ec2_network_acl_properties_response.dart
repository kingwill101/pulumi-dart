...
class Ec2NetworkAclPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2NetworkAclPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2NetworkAclPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkAclPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2NetworkAclPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
