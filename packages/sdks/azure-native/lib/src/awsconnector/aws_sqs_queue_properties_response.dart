...
class AwsSqsQueuePropertiesResponse {
  ...
  factory AwsSqsQueuePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsSqsQueuePropertiesResponse(
      ...
      deduplicationScope: map['deduplicationScope'] == null ? null : (map['deduplicationScope'] as String).input(),
      delaySeconds: map['delaySeconds'] == null ? null : (map['delaySeconds'] as int).input(),
      fifoQueue: map['fifoQueue'] == null ? null : (map['fifoQueue'] as bool).input(),
      fifoThroughputLimit: map['fifoThroughputLimit'] == null ? null : (map['fifoThroughputLimit'] as String).input(),
      ...
      receiveMessageWaitTimeSeconds: map['receiveMessageWaitTimeSeconds'] == null ? null : (map['receiveMessageWaitTimeSeconds'] as int).input(),
      redriveAllowPolicy: map['redriveAllowPolicy'] == null ? null : (map['redriveAllowPolicy']).input(),
      redrivePolicy: map['redrivePolicy'] == null ? null : (map['redrivePolicy']).input(),
      sqsManagedSseEnabled: map['sqsManagedSseEnabled'] == null ? null : (map['sqsManagedSseEnabled'] as bool).input(),
