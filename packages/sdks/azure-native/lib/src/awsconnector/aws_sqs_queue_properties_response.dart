...
class AwsSqsQueuePropertiesResponse {
  ...
  factory AwsSqsQueuePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsSqsQueuePropertiesResponse(
      ...
      receiveMessageWaitTimeSeconds: (() { final guardedValue = map['receiveMessageWaitTimeSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
