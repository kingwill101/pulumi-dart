...
class AwsSqsQueuePropertiesResponse {
  /// Property arn
  ...
  final pulumi.Input<int?>? receiveMessageWaitTimeSeconds;
  ...
  final pulumi.Input<dynamic>? redriveAllowPolicy;
  ...
  final pulumi.Input<dynamic>? redrivePolicy;
  ...
  /// Creates a new [AwsSqsQueuePropertiesResponse].
  /// [arn] Property arn
  ...
  const AwsSqsQueuePropertiesResponse({
    this.arn,
  ...
  factory AwsSqsQueuePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsSqsQueuePropertiesResponse(
      ...
      deduplicationScope: (() { final guardedValue = map['deduplicationScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      delaySeconds: (() { final guardedValue = map['delaySeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      fifoQueue: (() { final guardedValue = map['fifoQueue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      fifoThroughputLimit: (() { final guardedValue = map['fifoThroughputLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      maximumMessageSize: (() { final guardedValue = map['maximumMessageSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      messageRetentionPeriod: (() { final guardedValue = map['messageRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      receiveMessageWaitTimeSeconds: (() { final guardedValue = map['receiveMessageWaitTimeSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      redriveAllowPolicy: (() { final guardedValue = map['redriveAllowPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      redrivePolicy: (() { final guardedValue = map['redrivePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      sqsManagedSseEnabled: (() { final guardedValue = map['sqsManagedSseEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      visibilityTimeout: (() { final guardedValue = map['visibilityTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
    );
  }
}
