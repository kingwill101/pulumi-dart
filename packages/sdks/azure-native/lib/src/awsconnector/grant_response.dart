...
class GrantResponse {
  ...
  factory GrantResponse.fromMap(Map<String, dynamic> map) {
    return GrantResponse(
      grantee: (() { final guardedValue = map['grantee']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GranteeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      permission: (() { final guardedValue = map['permission']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PermissionEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
