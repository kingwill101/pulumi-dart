...
class IamInstanceProfileArgs {
  ...
  factory IamInstanceProfileArgs.fromMap(Map<String, dynamic> map) {
    return IamInstanceProfileArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamInstanceProfileProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
