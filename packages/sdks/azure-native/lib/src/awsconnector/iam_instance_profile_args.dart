...
class IamInstanceProfileArgs {
  ...
  IamInstanceProfileArgs({
    ...
    pulumi.Output<IamInstanceProfileProperties>? properties,
  ...
  factory IamInstanceProfileArgs.fromMap(Map<String, dynamic> map) {
    return IamInstanceProfileArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<IamInstanceProfileProperties>(IamInstanceProfileProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
