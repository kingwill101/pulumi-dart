...
class AwsEc2AddressProperties {
  ...
  factory AwsEc2AddressProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2AddressProperties(
      ...
      domain: (() { final guardedValue = map['domain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
