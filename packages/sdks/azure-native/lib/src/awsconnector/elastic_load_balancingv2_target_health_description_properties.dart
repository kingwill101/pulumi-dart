...
import 'aws_elastic_load_balancingv2_target_health_description_properties.dart';
...
class ElasticLoadBalancingv2TargetHealthDescriptionProperties {
  ...
  const ElasticLoadBalancingv2TargetHealthDescriptionProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticLoadBalancingv2TargetHealthDescriptionProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticLoadBalancingv2TargetHealthDescriptionProperties.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingv2TargetHealthDescriptionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticLoadBalancingv2TargetHealthDescriptionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
