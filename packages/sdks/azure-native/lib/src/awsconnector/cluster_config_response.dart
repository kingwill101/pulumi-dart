...
class ClusterConfigResponse {
  ...
  final pulumi.Input<OpenSearchPartitionInstanceTypeEnumValueResponse>?
  dedicatedMasterType;
  ...
  final pulumi.Input<OpenSearchWarmPartitionInstanceTypeEnumValueResponse>?
  warmType;
    ...
    return ClusterConfigResponse(
      coldStorageOptions: (() {
        ...
        return pulumi.Input.fromValue(
          ColdStorageOptionsResponse.fromMap(
      ...
      dedicatedMasterType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OpenSearchPartitionInstanceTypeEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      warmType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OpenSearchWarmPartitionInstanceTypeEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      zoneAwarenessConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ZoneAwarenessConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
