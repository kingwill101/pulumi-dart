...
class AwsSageMakerNotebookInstanceSummaryPropertiesResponse {
  ...
  final pulumi.Input<NotebookInstanceStatusEnumValueResponse>?
    ...
    return <String, dynamic>{
      ...
      'notebookInstanceStatus':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(notebookInstanceStatus, (value) => value.toMap()),
      'url': ?url,
    };
  }

  factory AwsSageMakerNotebookInstanceSummaryPropertiesResponse.fromMap(
    ...
    return AwsSageMakerNotebookInstanceSummaryPropertiesResponse(
      ...
      notebookInstanceArn: (() {
        final guardedValue = map['notebookInstanceArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      notebookInstanceLifecycleConfigName: (() {
        final guardedValue = map['notebookInstanceLifecycleConfigName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      notebookInstanceName: (() {
        final guardedValue = map['notebookInstanceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      notebookInstanceStatus: (() {
        final guardedValue = map['notebookInstanceStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NotebookInstanceStatusEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
