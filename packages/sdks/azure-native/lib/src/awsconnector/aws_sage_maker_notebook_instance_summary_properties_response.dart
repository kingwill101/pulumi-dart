...
class AwsSageMakerNotebookInstanceSummaryPropertiesResponse {
  ...
  const AwsSageMakerNotebookInstanceSummaryPropertiesResponse({
  ...
  factory AwsSageMakerNotebookInstanceSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsSageMakerNotebookInstanceSummaryPropertiesResponse(
      ...
      notebookInstanceStatus: (() { final guardedValue = map['notebookInstanceStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotebookInstanceStatusEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
