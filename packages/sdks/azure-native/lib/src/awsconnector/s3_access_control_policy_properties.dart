...
import 'aws_s3_access_control_policy_properties.dart';

/// Definition of S3AccessControlPolicy
class S3AccessControlPolicyProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsS3AccessControlPolicyProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3AccessControlPolicyProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3AccessControlPolicyProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3AccessControlPolicyProperties.fromMap(Map<String, dynamic> map) {
    return S3AccessControlPolicyProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3AccessControlPolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
