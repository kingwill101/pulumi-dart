...
class S3AccessControlPolicyProperties {
  ...
  /// AWS Properties
  final AwsS3AccessControlPolicyProperties? awsProperties;
  /// AWS Region
  ...
  factory S3AccessControlPolicyProperties.fromMap(Map<String, dynamic> map) {
    return S3AccessControlPolicyProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3AccessControlPolicyProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
