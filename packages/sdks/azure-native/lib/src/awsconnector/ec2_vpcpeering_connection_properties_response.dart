...
class Ec2VPCPeeringConnectionPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEc2VPCPeeringConnectionPropertiesResponse>?
  awsProperties;
  ...
  factory Ec2VPCPeeringConnectionPropertiesResponse.fromMap(
    ...
    return Ec2VPCPeeringConnectionPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsEc2VPCPeeringConnectionPropertiesResponse.fromMap(
