...
import 'aws_ec2_instance_status_properties.dart';

/// Definition of Ec2InstanceStatus
class Ec2InstanceStatusProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2InstanceStatusProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2InstanceStatusProperties].
  ...
  const Ec2InstanceStatusProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2InstanceStatusProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2InstanceStatusProperties.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceStatusProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2InstanceStatusProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
