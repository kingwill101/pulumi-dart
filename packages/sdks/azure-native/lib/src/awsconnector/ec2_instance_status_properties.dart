...
class Ec2InstanceStatusProperties {
  ...
  /// AWS Properties
  final AwsEc2InstanceStatusProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2InstanceStatusProperties.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceStatusProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2InstanceStatusProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
