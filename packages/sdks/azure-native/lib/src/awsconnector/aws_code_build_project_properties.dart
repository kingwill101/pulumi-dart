...
class AwsCodeBuildProjectProperties {
  ...
  const AwsCodeBuildProjectProperties({
    this.arn,
    this.artifacts,
    this.badge,
  ...
  factory AwsCodeBuildProjectProperties.fromMap(Map<String, dynamic> map) {
    return AwsCodeBuildProjectProperties(
      ...
      badge: (() { final guardedValue = map['badge']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectBadge.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      logsConfig: (() { final guardedValue = map['logsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      projectVisibility: (() { final guardedValue = map['projectVisibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectVisibilityTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      secondaryArtifacts: (() { final guardedValue = map['secondaryArtifacts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProjectArtifacts>(guardedValue, (value) => ProjectArtifacts.fromMap((value as Map).cast<String, dynamic>()))); })(),
      secondarySourceVersions: (() { final guardedValue = map['secondarySourceVersions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProjectSourceVersion>(guardedValue, (value) => ProjectSourceVersion.fromMap((value as Map).cast<String, dynamic>()))); })(),
      secondarySources: (() { final guardedValue = map['secondarySources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProjectSource>(guardedValue, (value) => ProjectSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
