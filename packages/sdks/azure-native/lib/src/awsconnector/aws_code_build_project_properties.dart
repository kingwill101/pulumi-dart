...
class AwsCodeBuildProjectProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logsConfig':
          ?pulumi.Input.mapOptionalInputValue<LogsConfig, Map<String, dynamic>>(
            logsConfig,
            (value) => value.toMap(),
          ),
      'name': ?name,
      ...
      'secondaryArtifacts':
          ...
          >(
            secondaryArtifacts,
            (value) =>
                pulumi.Input.encodeList<ProjectArtifacts, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'secondarySources':
          ...
          >(
            secondarySources,
            (value) =>
                pulumi.Input.encodeList<ProjectSource, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'vpcConfig':
          ?pulumi.Input.mapOptionalInputValue<VpcConfig, Map<String, dynamic>>(
            vpcConfig,
            (value) => value.toMap(),
          ),
      'webhook':
  ...
  factory AwsCodeBuildProjectProperties.fromMap(Map<String, dynamic> map) {
    return AwsCodeBuildProjectProperties(
      ...
      badge: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProjectBadge.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      buildBatchConfig: (() {
      ...
      cache: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProjectCache.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      logsConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LogsConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      projectVisibility: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProjectVisibilityTypeEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      secondaryArtifacts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProjectArtifacts>(
            guardedValue,
            (value) => ProjectArtifacts.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      secondarySourceVersions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProjectSourceVersion>(
            guardedValue,
            (value) => ProjectSourceVersion.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      secondarySources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProjectSource>(
            guardedValue,
            (value) =>
                ProjectSource.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      serviceRole: (() {
      ...
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProjectSource.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sourceVersion: (() {
      ...
      vpcConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      webhook: (() {
