...
class SsmInstanceInformationProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSsmInstanceInformationProperties>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSsmInstanceInformationProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SsmInstanceInformationProperties.fromMap(Map<String, dynamic> map) {
    return SsmInstanceInformationProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSsmInstanceInformationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
