...
class SnsSubscriptionArgs {
  ...
  SnsSubscriptionArgs({
    ...
    pulumi.Output<SnsSubscriptionProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<SnsSubscriptionProperties>(properties),
  ...
  factory SnsSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SnsSubscriptionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<SnsSubscriptionProperties>(SnsSubscriptionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
