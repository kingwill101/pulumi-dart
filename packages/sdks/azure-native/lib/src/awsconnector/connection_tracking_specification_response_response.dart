...
class ConnectionTrackingSpecificationResponseResponse {
  ...
  ConnectionTrackingSpecificationResponseResponse({
    pulumi.Input<int?>? tcpEstablishedTimeout,
    pulumi.Input<int?>? udpStreamTimeout,
    pulumi.Input<int?>? udpTimeout,
  }) : tcpEstablishedTimeout = tcpEstablishedTimeout ?? pulumi.Input.fromValue(432000), udpStreamTimeout = udpStreamTimeout ?? pulumi.Input.fromValue(180), udpTimeout = udpTimeout ?? pulumi.Input.fromValue(30);
