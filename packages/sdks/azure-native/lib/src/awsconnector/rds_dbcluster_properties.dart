...
import 'aws_rds_dbcluster_properties.dart';

/// Definition of RdsDBCluster
class RdsDBClusterProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsDBClusterProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsDBClusterProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsDBClusterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsDBClusterProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBClusterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
