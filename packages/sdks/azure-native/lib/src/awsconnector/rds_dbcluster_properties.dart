...
class RdsDBClusterProperties {
  ...
  /// AWS Properties
  final AwsRdsDBClusterProperties? awsProperties;
  /// AWS Region
  ...
  factory RdsDBClusterProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBClusterProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBClusterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
