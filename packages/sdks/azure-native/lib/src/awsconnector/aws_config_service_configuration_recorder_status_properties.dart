...
class AwsConfigServiceConfigurationRecorderStatusProperties {
  ...
  factory AwsConfigServiceConfigurationRecorderStatusProperties.fromMap(
    Map<String, dynamic> map,
  ) {
    return AwsConfigServiceConfigurationRecorderStatusProperties(
      lastErrorCode: (() {
        final guardedValue = map['lastErrorCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastErrorMessage: (() {
        final guardedValue = map['lastErrorMessage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastStartTime: (() {
        final guardedValue = map['lastStartTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastStatus: (() {
        ...
        return pulumi.Input.fromValue(
          RecorderStatusEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      lastStatusChangeTime: (() {
        final guardedValue = map['lastStatusChangeTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastStopTime: (() {
        final guardedValue = map['lastStopTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
