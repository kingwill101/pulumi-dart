...
class ApiGatewayStageArgs {
  ...
  factory ApiGatewayStageArgs.fromMap(Map<String, dynamic> map) {
    return ApiGatewayStageArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiGatewayStageProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
