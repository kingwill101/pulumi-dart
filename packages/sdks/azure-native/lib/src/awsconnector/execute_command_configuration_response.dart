...
class ExecuteCommandConfigurationResponse {
  ...
  const ExecuteCommandConfigurationResponse({
    this.kmsKeyId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'kmsKeyId': ?kmsKeyId,
      'logConfiguration': ?pulumi.Input.mapOptionalInputValue<ExecuteCommandLogConfigurationResponse, Map<String, dynamic>>(logConfiguration, (value) => value.toMap()),
      'logging': ?logging,
    };
  }

  factory ExecuteCommandConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ExecuteCommandConfigurationResponse(
      kmsKeyId: (() { final guardedValue = map['kmsKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      logConfiguration: (() { final guardedValue = map['logConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecuteCommandLogConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
