...
class ExecuteCommandConfigurationResponse {
  ...
  final ExecuteCommandLogConfigurationResponse? logConfiguration;
  ...
  factory ExecuteCommandConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ExecuteCommandConfigurationResponse(
      ...
      logConfiguration: map['logConfiguration'] == null ? null : ExecuteCommandLogConfigurationResponse.fromMap((map['logConfiguration'] as Map).cast<String, dynamic>()),
