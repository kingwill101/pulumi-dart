...
import 'aws_route53_hosted_zone_properties_response.dart';

/// Definition of Route53HostedZone
class Route53HostedZonePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRoute53HostedZonePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Route53HostedZonePropertiesResponse].
  ...
  const Route53HostedZonePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRoute53HostedZonePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Route53HostedZonePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Route53HostedZonePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRoute53HostedZonePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
