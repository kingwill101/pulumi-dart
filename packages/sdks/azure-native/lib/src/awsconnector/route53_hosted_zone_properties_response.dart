...
class Route53HostedZonePropertiesResponse {
  ...
  /// AWS Properties
  final AwsRoute53HostedZonePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Route53HostedZonePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Route53HostedZonePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRoute53HostedZonePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
