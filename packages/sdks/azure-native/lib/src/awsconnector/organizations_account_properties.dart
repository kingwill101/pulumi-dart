...
import 'aws_organizations_account_properties.dart';

/// Definition of OrganizationsAccount
class OrganizationsAccountProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsOrganizationsAccountProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [OrganizationsAccountProperties].
  ...
  const OrganizationsAccountProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsOrganizationsAccountProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory OrganizationsAccountProperties.fromMap(Map<String, dynamic> map) {
    return OrganizationsAccountProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsOrganizationsAccountProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
