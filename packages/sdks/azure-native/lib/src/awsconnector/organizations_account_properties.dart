...
class OrganizationsAccountProperties {
  ...
  /// AWS Properties
  final AwsOrganizationsAccountProperties? awsProperties;
  /// AWS Region
  ...
  factory OrganizationsAccountProperties.fromMap(Map<String, dynamic> map) {
    return OrganizationsAccountProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsOrganizationsAccountProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
