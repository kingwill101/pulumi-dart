...
class MixedInstancesPolicy {
  ...
  MixedInstancesPolicy({this.instancesDistribution, this.launchTemplate});
    ...
    return <String, dynamic>{
      'instancesDistribution':
          ?pulumi.Input.mapOptionalInputValue<
            InstancesDistribution,
            Map<String, dynamic>
          >(instancesDistribution, (value) => value.toMap()),
      'launchTemplate':
          ?pulumi.Input.mapOptionalInputValue<
            LaunchTemplate,
            Map<String, dynamic>
  ...
  factory MixedInstancesPolicy.fromMap(Map<String, dynamic> map) {
    return MixedInstancesPolicy(
      instancesDistribution: (() {
        final guardedValue = map['instancesDistribution'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstancesDistribution.fromMap(
      ...
      launchTemplate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LaunchTemplate.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
