...
class Volume {
  ...
  final FSxWindowsFileServerVolumeConfiguration? fSxWindowsFileServerVolumeConfiguration;
  ...
  factory Volume.fromMap(Map<String, dynamic> map) {
    return Volume(
      ...
      dockerVolumeConfiguration: map['dockerVolumeConfiguration'] == null ? null : DockerVolumeConfiguration.fromMap((map['dockerVolumeConfiguration'] as Map).cast<String, dynamic>()),
      efsVolumeConfiguration: map['efsVolumeConfiguration'] == null ? null : EFSVolumeConfiguration.fromMap((map['efsVolumeConfiguration'] as Map).cast<String, dynamic>()),
      fSxWindowsFileServerVolumeConfiguration: map['fSxWindowsFileServerVolumeConfiguration'] == null ? null : FSxWindowsFileServerVolumeConfiguration.fromMap((map['fSxWindowsFileServerVolumeConfiguration'] as Map).cast<String, dynamic>()),
      host: map['host'] == null ? null : HostVolumeProperties.fromMap((map['host'] as Map).cast<String, dynamic>()),
