...
import 'docker_volume_configuration.dart';
import 'efsvolume_configuration.dart';
import 'fsx_windows_file_server_volume_configuration.dart';
import 'host_volume_properties.dart';
...
class Volume {
  ...
  final pulumi.Input<DockerVolumeConfiguration>? dockerVolumeConfiguration;
  ...
  final pulumi.Input<EFSVolumeConfiguration>? efsVolumeConfiguration;
  ...
  final pulumi.Input<FSxWindowsFileServerVolumeConfiguration>? fSxWindowsFileServerVolumeConfiguration;
  ...
  final pulumi.Input<HostVolumeProperties>? host;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dockerVolumeConfiguration': ?pulumi.Input.mapOptionalInputValue<DockerVolumeConfiguration, Map<String, dynamic>>(dockerVolumeConfiguration, (value) => value.toMap()),
      'efsVolumeConfiguration': ?pulumi.Input.mapOptionalInputValue<EFSVolumeConfiguration, Map<String, dynamic>>(efsVolumeConfiguration, (value) => value.toMap()),
      'fSxWindowsFileServerVolumeConfiguration': ?pulumi.Input.mapOptionalInputValue<FSxWindowsFileServerVolumeConfiguration, Map<String, dynamic>>(fSxWindowsFileServerVolumeConfiguration, (value) => value.toMap()),
      'host': ?pulumi.Input.mapOptionalInputValue<HostVolumeProperties, Map<String, dynamic>>(host, (value) => value.toMap()),
      'name': ?name,
    };
  }
  ...
  factory Volume.fromMap(Map<String, dynamic> map) {
    return Volume(
      ...
      dockerVolumeConfiguration: (() { final guardedValue = map['dockerVolumeConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DockerVolumeConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      efsVolumeConfiguration: (() { final guardedValue = map['efsVolumeConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EFSVolumeConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fSxWindowsFileServerVolumeConfiguration: (() { final guardedValue = map['fSxWindowsFileServerVolumeConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FSxWindowsFileServerVolumeConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostVolumeProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
