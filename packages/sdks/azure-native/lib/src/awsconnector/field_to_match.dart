...
class FieldToMatch {
  ...
  factory FieldToMatch.fromMap(Map<String, dynamic> map) {
    return FieldToMatch(
      ...
      singleHeader: (() { final guardedValue = map['singleHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SingleHeaderModelProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
