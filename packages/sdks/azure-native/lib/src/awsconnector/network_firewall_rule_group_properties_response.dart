...
class NetworkFirewallRuleGroupPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsNetworkFirewallRuleGroupPropertiesResponse>?
  awsProperties;
  ...
  factory NetworkFirewallRuleGroupPropertiesResponse.fromMap(
    ...
    return NetworkFirewallRuleGroupPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsNetworkFirewallRuleGroupPropertiesResponse.fromMap(
