...
import 'aws_network_firewall_rule_group_properties_response.dart';

/// Definition of NetworkFirewallRuleGroup
class NetworkFirewallRuleGroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsNetworkFirewallRuleGroupPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [NetworkFirewallRuleGroupPropertiesResponse].
  ...
  const NetworkFirewallRuleGroupPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsNetworkFirewallRuleGroupPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory NetworkFirewallRuleGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallRuleGroupPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsNetworkFirewallRuleGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
