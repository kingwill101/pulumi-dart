...
class LogConfigurationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logDriver': ?logDriver,
      'options': ?options,
      'secretOptions': ?pulumi.Input.mapOptionalInputValue<List<SecretResponse>, List<Map<String, dynamic>>>(secretOptions, (value) => pulumi.Input.encodeList<SecretResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory LogConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return LogConfigurationResponse(
      ...
      secretOptions: (() { final guardedValue = map['secretOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecretResponse>(guardedValue, (value) => SecretResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
