...
class LogConfigurationResponse {
  ...
  final List<SecretResponse>? secretOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logDriver': ?logDriver,
      'options': ?options,
      'secretOptions': ?secretOptions == null ? null : pulumi.Input.encodeList<SecretResponse, Map<String, dynamic>>(secretOptions!, (value) => value.toMap()),
    };
  }
  ...
  factory LogConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return LogConfigurationResponse(
      ...
      secretOptions: map['secretOptions'] == null ? null : pulumi.Input.decodeList<SecretResponse>(map['secretOptions'], (value) => SecretResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
