...
import 'aws_ec2_security_group_properties.dart';
...
class Ec2SecurityGroupProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEc2SecurityGroupProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2SecurityGroupProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2SecurityGroupProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2SecurityGroupProperties.fromMap(Map<String, dynamic> map) {
    return Ec2SecurityGroupProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2SecurityGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
