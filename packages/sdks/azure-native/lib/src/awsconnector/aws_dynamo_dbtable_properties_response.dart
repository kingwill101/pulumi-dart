...
class AwsDynamoDBTablePropertiesResponse {
  ...
  const AwsDynamoDBTablePropertiesResponse({
    this.arn,
  ...
  factory AwsDynamoDBTablePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsDynamoDBTablePropertiesResponse(
      ...
      attributeDefinitions: (() { final guardedValue = map['attributeDefinitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AttributeDefinitionResponse>(guardedValue, (value) => AttributeDefinitionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      globalSecondaryIndexes: (() { final guardedValue = map['globalSecondaryIndexes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GlobalSecondaryIndexResponse>(guardedValue, (value) => GlobalSecondaryIndexResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      importSourceSpecification: (() { final guardedValue = map['importSourceSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImportSourceSpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      kinesisStreamSpecification: (() { final guardedValue = map['kinesisStreamSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KinesisStreamSpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      localSecondaryIndexes: (() { final guardedValue = map['localSecondaryIndexes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LocalSecondaryIndexResponse>(guardedValue, (value) => LocalSecondaryIndexResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pointInTimeRecoverySpecification: (() { final guardedValue = map['pointInTimeRecoverySpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PointInTimeRecoverySpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourcePolicy: (() { final guardedValue = map['resourcePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sseSpecification: (() { final guardedValue = map['sseSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SSESpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      streamSpecification: (() { final guardedValue = map['streamSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamSpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      timeToLiveSpecification: (() { final guardedValue = map['timeToLiveSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeToLiveSpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
