...
import 'aws_kms_key_properties.dart';

/// Definition of KmsKey
class KmsKeyProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsKmsKeyProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [KmsKeyProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsKmsKeyProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory KmsKeyProperties.fromMap(Map<String, dynamic> map) {
    return KmsKeyProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsKmsKeyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
