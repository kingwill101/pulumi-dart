...
class CodeBuildSourceCredentialsInfoArgs {
  ...
  /// [tags] Resource tags.
  const CodeBuildSourceCredentialsInfoArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory CodeBuildSourceCredentialsInfoArgs.fromMap(Map<String, dynamic> map) {
    return CodeBuildSourceCredentialsInfoArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CodeBuildSourceCredentialsInfoProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
