...
class CodeBuildSourceCredentialsInfoArgs {
  ...
  CodeBuildSourceCredentialsInfoArgs({
    ...
    pulumi.Output<CodeBuildSourceCredentialsInfoProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<CodeBuildSourceCredentialsInfoProperties>(properties),
  ...
  factory CodeBuildSourceCredentialsInfoArgs.fromMap(Map<String, dynamic> map) {
    return CodeBuildSourceCredentialsInfoArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<CodeBuildSourceCredentialsInfoProperties>(CodeBuildSourceCredentialsInfoProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
