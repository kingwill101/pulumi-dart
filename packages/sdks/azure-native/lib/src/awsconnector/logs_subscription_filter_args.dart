...
class LogsSubscriptionFilterArgs {
  ...
  /// [tags] Resource tags.
  const LogsSubscriptionFilterArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory LogsSubscriptionFilterArgs.fromMap(Map<String, dynamic> map) {
    return LogsSubscriptionFilterArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogsSubscriptionFilterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
