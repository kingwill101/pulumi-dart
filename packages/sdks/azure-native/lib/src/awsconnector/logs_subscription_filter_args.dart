...
class LogsSubscriptionFilterArgs {
  ...
  LogsSubscriptionFilterArgs({
    ...
    pulumi.Output<LogsSubscriptionFilterProperties>? properties,
  ...
  factory LogsSubscriptionFilterArgs.fromMap(Map<String, dynamic> map) {
    return LogsSubscriptionFilterArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<LogsSubscriptionFilterProperties>(LogsSubscriptionFilterProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
