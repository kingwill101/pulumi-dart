...
class CloudFormationStackSetArgs {
  ...
  /// [tags] Resource tags.
  const CloudFormationStackSetArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory CloudFormationStackSetArgs.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackSetArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudFormationStackSetProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
