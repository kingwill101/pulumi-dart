...
class CloudFormationStackSetArgs {
  ...
  CloudFormationStackSetArgs({
    ...
    pulumi.Output<CloudFormationStackSetProperties>? properties,
  ...
  factory CloudFormationStackSetArgs.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackSetArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<CloudFormationStackSetProperties>(CloudFormationStackSetProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
