  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taints':
          ...
          >(
            taints,
            (value) => pulumi.Input.encodeList<Taint, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory AwsEksNodegroupProperties.fromMap(Map<String, dynamic> map) {
    return AwsEksNodegroupProperties(
      ...
      launchTemplate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LaunchTemplateSpecification.fromMap(
      ...
      remoteAccess: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RemoteAccess.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      scalingConfig: (() {
      ...
      updateConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UpdateConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      version: (() {
