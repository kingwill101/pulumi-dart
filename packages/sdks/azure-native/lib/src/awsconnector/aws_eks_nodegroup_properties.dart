...
class AwsEksNodegroupProperties {
  ...
  factory AwsEksNodegroupProperties.fromMap(Map<String, dynamic> map) {
    return AwsEksNodegroupProperties(
      ...
      launchTemplate: (() { final guardedValue = map['launchTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LaunchTemplateSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      remoteAccess: (() { final guardedValue = map['remoteAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RemoteAccess.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      updateConfig: (() { final guardedValue = map['updateConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UpdateConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
