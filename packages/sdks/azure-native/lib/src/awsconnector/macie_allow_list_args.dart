...
class MacieAllowListArgs {
  ...
  factory MacieAllowListArgs.fromMap(Map<String, dynamic> map) {
    return MacieAllowListArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MacieAllowListProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
