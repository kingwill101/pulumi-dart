...
class MacieAllowListArgs {
  ...
  MacieAllowListArgs({
    ...
    pulumi.Output<MacieAllowListProperties>? properties,
  ...
  factory MacieAllowListArgs.fromMap(Map<String, dynamic> map) {
    return MacieAllowListArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<MacieAllowListProperties>(MacieAllowListProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
