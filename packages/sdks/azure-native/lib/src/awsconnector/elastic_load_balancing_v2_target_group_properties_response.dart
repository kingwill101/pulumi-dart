...
class ElasticLoadBalancingV2TargetGroupPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticLoadBalancingV2TargetGroupPropertiesResponse>?
  awsProperties;
  ...
  factory ElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap(
    ...
    return ElasticLoadBalancingV2TargetGroupPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap(
