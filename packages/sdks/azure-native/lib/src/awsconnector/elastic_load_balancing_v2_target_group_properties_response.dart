...
import 'aws_elastic_load_balancing_v2_target_group_properties_response.dart';

/// Definition of ElasticLoadBalancingV2TargetGroup
class ElasticLoadBalancingV2TargetGroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsElasticLoadBalancingV2TargetGroupPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticLoadBalancingV2TargetGroupPropertiesResponse].
  ...
  const ElasticLoadBalancingV2TargetGroupPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticLoadBalancingV2TargetGroupPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2TargetGroupPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
