...
class ElasticLoadBalancingV2TargetGroupPropertiesResponse {
  ...
  /// AWS Properties
  final AwsElasticLoadBalancingV2TargetGroupPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory ElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2TargetGroupPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
