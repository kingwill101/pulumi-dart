    ...
    return <String, dynamic>{
      ...
      'events':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceStatusEventResponse>,
      ...
      'instanceState':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(instanceState, (value) => value.toMap()),
      'instanceStatus':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceStatusSummaryResponse,
            Map<String, dynamic>
          >(instanceStatus, (value) => value.toMap()),
      'outpostArn': ?outpostArn,
      'systemStatus':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceStatusSummaryResponse,
            Map<String, dynamic>
          >(systemStatus, (value) => value.toMap()),
    };
  }

  factory AwsEc2InstanceStatusPropertiesResponse.fromMap(
    ...
    return AwsEc2InstanceStatusPropertiesResponse(
      ...
      events: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceStatusEventResponse>(
            guardedValue,
            (value) => InstanceStatusEventResponse.fromMap(
      ...
      instanceStatus: (() {
        final guardedValue = map['instanceStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceStatusSummaryResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      systemStatus: (() {
        final guardedValue = map['systemStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceStatusSummaryResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
