...
import 'aws_ec2_account_attribute_properties_response.dart';

/// Definition of Ec2AccountAttribute
class Ec2AccountAttributePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2AccountAttributePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2AccountAttributePropertiesResponse].
  ...
  const Ec2AccountAttributePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2AccountAttributePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2AccountAttributePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2AccountAttributePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2AccountAttributePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
