...
class RegistryCredentialResponse {
  ...
  final pulumi.Input<CredentialProviderTypeEnumValueResponse>?
  credentialProvider;
  ...
  RegistryCredentialResponse({this.credential, this.credentialProvider});
    ...
    return <String, dynamic>{
      ...
      'credentialProvider':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(credentialProvider, (value) => value.toMap()),
    };
  }
  ...
  factory RegistryCredentialResponse.fromMap(Map<String, dynamic> map) {
    return RegistryCredentialResponse(
      ...
      credentialProvider: (() {
        final guardedValue = map['credentialProvider'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CredentialProviderTypeEnumValueResponse.fromMap(
