...
class LogsLogGroupProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsLogsLogGroupProperties?>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsLogGroupProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsLogGroupProperties.fromMap(Map<String, dynamic> map) {
    return LogsLogGroupProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsLogGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
