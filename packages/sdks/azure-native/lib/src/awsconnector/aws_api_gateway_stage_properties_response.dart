...
class AwsApiGatewayStagePropertiesResponse {
  ...
  final pulumi.Input<AccessLogSettingResponse?>? accessLogSetting;
  ...
  final pulumi.Input<CanarySettingResponse?>? canarySetting;
  ...
  final pulumi.Input<List<MethodSettingResponse>?>? methodSettings;
  ...
  const AwsApiGatewayStagePropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessLogSetting': ?pulumi.Input.mapOptionalInputValue<AccessLogSettingResponse, Map<String, dynamic>>(accessLogSetting, (value) => value.toMap()),
      'cacheClusterEnabled': ?cacheClusterEnabled,
      'cacheClusterSize': ?cacheClusterSize,
      'canarySetting': ?pulumi.Input.mapOptionalInputValue<CanarySettingResponse, Map<String, dynamic>>(canarySetting, (value) => value.toMap()),
      'clientCertificateId': ?clientCertificateId,
      'deploymentId': ?deploymentId,
      'description': ?description,
      'documentationVersion': ?documentationVersion,
      'methodSettings': ?pulumi.Input.mapOptionalInputValue<List<MethodSettingResponse>, List<Map<String, dynamic>>>(methodSettings, (value) => pulumi.Input.encodeList<MethodSettingResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'restApiId': ?restApiId,
      'stageName': ?stageName,
  ...
  factory AwsApiGatewayStagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsApiGatewayStagePropertiesResponse(
      accessLogSetting: (() { final guardedValue = map['accessLogSetting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessLogSettingResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      canarySetting: (() { final guardedValue = map['canarySetting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CanarySettingResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      methodSettings: (() { final guardedValue = map['methodSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MethodSettingResponse>(guardedValue, (value) => MethodSettingResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
