...
class AwsApiGatewayStagePropertiesResponse {
    ...
    return <String, dynamic>{
      'accessLogSetting':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(accessLogSetting, (value) => value.toMap()),
      ...
      'canarySetting':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(canarySetting, (value) => value.toMap()),
  ...
  factory AwsApiGatewayStagePropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AwsApiGatewayStagePropertiesResponse(
      accessLogSetting: (() {
        final guardedValue = map['accessLogSetting'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessLogSettingResponse.fromMap(
      ...
      canarySetting: (() {
        final guardedValue = map['canarySetting'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CanarySettingResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      methodSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MethodSettingResponse>(
            guardedValue,
            (value) => MethodSettingResponse.fromMap(
      ...
      tracingEnabled: (() {
        final guardedValue = map['tracingEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      variables: (() {
