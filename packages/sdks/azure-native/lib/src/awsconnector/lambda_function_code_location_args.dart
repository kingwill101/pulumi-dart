...
class LambdaFunctionCodeLocationArgs {
  ...
  /// [tags] Resource tags.
  const LambdaFunctionCodeLocationArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory LambdaFunctionCodeLocationArgs.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionCodeLocationArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LambdaFunctionCodeLocationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
