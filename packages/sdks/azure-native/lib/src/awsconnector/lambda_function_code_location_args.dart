...
class LambdaFunctionCodeLocationArgs {
  ...
  LambdaFunctionCodeLocationArgs({
    ...
    pulumi.Output<LambdaFunctionCodeLocationProperties>? properties,
  ...
  factory LambdaFunctionCodeLocationArgs.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionCodeLocationArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<LambdaFunctionCodeLocationProperties>(LambdaFunctionCodeLocationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
