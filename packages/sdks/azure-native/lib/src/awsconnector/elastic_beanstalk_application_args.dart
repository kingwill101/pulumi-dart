...
class ElasticBeanstalkApplicationArgs {
  ...
  ElasticBeanstalkApplicationArgs({
    ...
    pulumi.Output<ElasticBeanstalkApplicationProperties>? properties,
  ...
  factory ElasticBeanstalkApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkApplicationArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ElasticBeanstalkApplicationProperties>(ElasticBeanstalkApplicationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
