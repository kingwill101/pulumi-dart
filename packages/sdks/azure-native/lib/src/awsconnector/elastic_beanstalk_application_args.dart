...
class ElasticBeanstalkApplicationArgs {
  ...
  /// [tags] Resource tags.
  const ElasticBeanstalkApplicationArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory ElasticBeanstalkApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkApplicationArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ElasticBeanstalkApplicationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
