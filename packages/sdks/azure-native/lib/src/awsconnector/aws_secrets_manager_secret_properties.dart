...
class AwsSecretsManagerSecretProperties {
  ...
  final pulumi.Input<GenerateSecretString>? generateSecretString;
  /// Property id
  ...
  final pulumi.Input<List<ReplicaRegion>>? replicaRegions;
  ...
  const AwsSecretsManagerSecretProperties({
    this.description,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'generateSecretString': ?pulumi.Input.mapOptionalInputValue<GenerateSecretString, Map<String, dynamic>>(generateSecretString, (value) => value.toMap()),
      'id': ?id,
      'kmsKeyId': ?kmsKeyId,
      'name': ?name,
      'replicaRegions': ?pulumi.Input.mapOptionalInputValue<List<ReplicaRegion>, List<Map<String, dynamic>>>(replicaRegions, (value) => pulumi.Input.encodeList<ReplicaRegion, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AwsSecretsManagerSecretProperties.fromMap(Map<String, dynamic> map) {
    return AwsSecretsManagerSecretProperties(
      ...
      generateSecretString: (() { final guardedValue = map['generateSecretString']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GenerateSecretString.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kmsKeyId: (() { final guardedValue = map['kmsKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replicaRegions: (() { final guardedValue = map['replicaRegions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ReplicaRegion>(guardedValue, (value) => ReplicaRegion.fromMap((value as Map).cast<String, dynamic>()))); })(),
