    ...
    return <String, dynamic>{
      ...
      'replicaRegions':
          ...
          >(
            replicaRegions,
            (value) =>
                pulumi.Input.encodeList<ReplicaRegion, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsSecretsManagerSecretProperties.fromMap(Map<String, dynamic> map) {
    return AwsSecretsManagerSecretProperties(
      ...
      replicaRegions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicaRegion>(
            guardedValue,
            (value) =>
                ReplicaRegion.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      secretString: (() {
