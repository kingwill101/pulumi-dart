...
class AwsLightsailBucketProperties {
  ...
  const AwsLightsailBucketProperties({
  ...
  factory AwsLightsailBucketProperties.fromMap(Map<String, dynamic> map) {
    return AwsLightsailBucketProperties(
      ...
      accessRules: (() { final guardedValue = map['accessRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessRules.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
