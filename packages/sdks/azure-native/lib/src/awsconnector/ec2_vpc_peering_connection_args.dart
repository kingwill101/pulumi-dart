...
class Ec2VpcPeeringConnectionArgs {
  ...
  /// [tags] Resource tags.
  const Ec2VpcPeeringConnectionArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory Ec2VpcPeeringConnectionArgs.fromMap(Map<String, dynamic> map) {
    return Ec2VpcPeeringConnectionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2VPCPeeringConnectionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
