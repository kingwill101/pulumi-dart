...
class Ec2VpcPeeringConnectionArgs {
  ...
  Ec2VpcPeeringConnectionArgs({
    ...
    pulumi.Output<Ec2VPCPeeringConnectionProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<Ec2VPCPeeringConnectionProperties>(properties),
  ...
  factory Ec2VpcPeeringConnectionArgs.fromMap(Map<String, dynamic> map) {
    return Ec2VpcPeeringConnectionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Ec2VPCPeeringConnectionProperties>(Ec2VPCPeeringConnectionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
