...
class ProxyConfigurationResponse {
  ...
  final pulumi.Input<List<KeyValuePairResponse>>? proxyConfigurationProperties;
  ...
  const ProxyConfigurationResponse({
    this.containerName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'proxyConfigurationProperties': ?pulumi.Input.mapOptionalInputValue<List<KeyValuePairResponse>, List<Map<String, dynamic>>>(proxyConfigurationProperties, (value) => pulumi.Input.encodeList<KeyValuePairResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'type': ?type,
    };
  }
  ...
  factory ProxyConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ProxyConfigurationResponse(
      ...
      proxyConfigurationProperties: (() { final guardedValue = map['proxyConfigurationProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KeyValuePairResponse>(guardedValue, (value) => KeyValuePairResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
