...
class EfsFileSystemArgs {
  ...
  factory EfsFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return EfsFileSystemArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EfsFileSystemProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
