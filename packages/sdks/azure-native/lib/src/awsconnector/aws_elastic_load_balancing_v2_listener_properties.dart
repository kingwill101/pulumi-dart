...
class AwsElasticLoadBalancingV2ListenerProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultActions':
          ?pulumi.Input.mapOptionalInputValue<List<Action>, List<String>>(
            defaultActions,
            (value) => pulumi.Input.encodeList<Action, String>(
              value,
  ...
  factory AwsElasticLoadBalancingV2ListenerProperties.fromMap(
      ...
      defaultActions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Action>(
            guardedValue,
            (value) => Action.fromValue(value as String),
          ),
        );
      })(),
      listenerArn: (() {
