    ...
    return AwsEcsClusterPropertiesResponse(
      ...
      clusterSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterSettingsResponse>(
            guardedValue,
            (value) => ClusterSettingsResponse.fromMap(
      ...
      configuration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterConfigurationResponse.fromMap(
      ...
      serviceConnectDefaults: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConnectDefaultsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
