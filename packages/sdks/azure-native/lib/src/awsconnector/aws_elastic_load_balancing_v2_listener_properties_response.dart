...
class AwsElasticLoadBalancingV2ListenerPropertiesResponse {
  ...
  factory AwsElasticLoadBalancingV2ListenerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsElasticLoadBalancingV2ListenerPropertiesResponse(
      ...
      certificates: (() { final guardedValue = map['certificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateResponse>(guardedValue, (value) => CertificateResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
