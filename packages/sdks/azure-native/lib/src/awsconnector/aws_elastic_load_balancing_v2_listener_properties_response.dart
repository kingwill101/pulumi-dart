...
import 'certificate_elastic_load_balancing_v2_listener_response.dart';
...
class AwsElasticLoadBalancingV2ListenerPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'certificates': ?pulumi.Input.mapOptionalInputValue<List<CertificateElasticLoadBalancingV2ListenerResponse>, List<Map<String, dynamic>>>(certificates, (value) => pulumi.Input.encodeList<CertificateElasticLoadBalancingV2ListenerResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AwsElasticLoadBalancingV2ListenerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsElasticLoadBalancingV2ListenerPropertiesResponse(
      ...
      certificates: (() { final guardedValue = map['certificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateElasticLoadBalancingV2ListenerResponse>(guardedValue, (value) => CertificateElasticLoadBalancingV2ListenerResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      defaultActions: (() { final guardedValue = map['defaultActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ActionResponse>(guardedValue, (value) => ActionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
