...
class InstanceNetworkInterfaceResponse {
  ...
  factory InstanceNetworkInterfaceResponse.fromMap(Map<String, dynamic> map) {
    return InstanceNetworkInterfaceResponse(
      association: (() { final guardedValue = map['association']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceNetworkInterfaceAssociationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      attachment: (() { final guardedValue = map['attachment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceNetworkInterfaceAttachmentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      connectionTrackingConfiguration: (() { final guardedValue = map['connectionTrackingConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionTrackingSpecificationResponseResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      groups: (() { final guardedValue = map['groups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupIdentifierResponse>(guardedValue, (value) => GroupIdentifierResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ipv4Prefixes: (() { final guardedValue = map['ipv4Prefixes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceIpv4PrefixResponse>(guardedValue, (value) => InstanceIpv4PrefixResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ipv6Prefixes: (() { final guardedValue = map['ipv6Prefixes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceIpv6PrefixResponse>(guardedValue, (value) => InstanceIpv6PrefixResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      privateIpAddresses: (() { final guardedValue = map['privateIpAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InstancePrivateIpAddressResponse>(guardedValue, (value) => InstancePrivateIpAddressResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkInterfaceStatusEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
