...
import 'aws_dax_cluster_properties_response.dart';

/// Definition of DaxCluster
class DaxClusterPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsDaxClusterPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [DaxClusterPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsDaxClusterPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory DaxClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DaxClusterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsDaxClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
