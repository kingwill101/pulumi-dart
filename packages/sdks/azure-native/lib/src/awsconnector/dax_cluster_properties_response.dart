...
class DaxClusterPropertiesResponse {
  ...
  /// AWS Properties
  final AwsDaxClusterPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory DaxClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DaxClusterPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsDaxClusterPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
