...
import 'aws_logs_metric_filter_properties_response.dart';

/// Definition of LogsMetricFilter
class LogsMetricFilterPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLogsMetricFilterPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LogsMetricFilterPropertiesResponse].
  ...
  const LogsMetricFilterPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsMetricFilterPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsMetricFilterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LogsMetricFilterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsMetricFilterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
