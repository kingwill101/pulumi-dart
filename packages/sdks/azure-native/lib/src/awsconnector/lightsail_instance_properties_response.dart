...
import 'aws_lightsail_instance_properties_response.dart';

/// Definition of LightsailInstance
class LightsailInstancePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLightsailInstancePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LightsailInstancePropertiesResponse].
  ...
  const LightsailInstancePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLightsailInstancePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LightsailInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LightsailInstancePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLightsailInstancePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
