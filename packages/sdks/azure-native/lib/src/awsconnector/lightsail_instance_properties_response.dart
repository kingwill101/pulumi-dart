...
class LightsailInstancePropertiesResponse {
  ...
  /// AWS Properties
  final AwsLightsailInstancePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory LightsailInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LightsailInstancePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLightsailInstancePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
