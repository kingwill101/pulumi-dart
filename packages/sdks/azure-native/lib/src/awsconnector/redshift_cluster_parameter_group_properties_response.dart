...
class RedshiftClusterParameterGroupPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsRedshiftClusterParameterGroupPropertiesResponse>?
  awsProperties;
  ...
  factory RedshiftClusterParameterGroupPropertiesResponse.fromMap(
    ...
    return RedshiftClusterParameterGroupPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsRedshiftClusterParameterGroupPropertiesResponse.fromMap(
