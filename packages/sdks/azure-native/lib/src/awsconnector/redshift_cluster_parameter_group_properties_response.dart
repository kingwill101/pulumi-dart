...
import 'aws_redshift_cluster_parameter_group_properties_response.dart';

/// Definition of RedshiftClusterParameterGroup
class RedshiftClusterParameterGroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRedshiftClusterParameterGroupPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RedshiftClusterParameterGroupPropertiesResponse].
  ...
  const RedshiftClusterParameterGroupPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRedshiftClusterParameterGroupPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RedshiftClusterParameterGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterParameterGroupPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRedshiftClusterParameterGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
