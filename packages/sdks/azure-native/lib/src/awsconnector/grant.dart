...
class Grant {
  ...
  factory Grant.fromMap(Map<String, dynamic> map) {
    return Grant(
      grantee: (() { final guardedValue = map['grantee']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Grantee.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      permission: (() { final guardedValue = map['permission']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PermissionEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
