...
class Route53DomainsDomainSummaryArgs {
  ...
  Route53DomainsDomainSummaryArgs({
    ...
    pulumi.Output<Route53DomainsDomainSummaryProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<Route53DomainsDomainSummaryProperties>(properties),
  ...
  factory Route53DomainsDomainSummaryArgs.fromMap(Map<String, dynamic> map) {
    return Route53DomainsDomainSummaryArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Route53DomainsDomainSummaryProperties>(Route53DomainsDomainSummaryProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
