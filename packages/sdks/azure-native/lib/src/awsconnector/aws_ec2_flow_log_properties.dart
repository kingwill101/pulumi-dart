...
import 'destination_options_model_properties.dart';
import 'tag.dart';
...
class AwsEc2FlowLogProperties {
  ...
  final pulumi.Input<dynamic>? logDestinationType;
  ...
  final pulumi.Input<dynamic>? trafficType;
  ...
  factory AwsEc2FlowLogProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2FlowLogProperties(
      ...
      destinationOptions: (() { final guardedValue = map['destinationOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DestinationOptionsModelProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      logDestinationType: (() { final guardedValue = map['logDestinationType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      trafficType: (() { final guardedValue = map['trafficType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
