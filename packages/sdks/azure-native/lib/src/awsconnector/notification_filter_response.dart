...
class NotificationFilterResponse {
  ...
  final S3KeyFilterResponse? s3Key;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      's3Key': ?s3Key == null ? null : s3Key!.toMap(),
    };
  }

  factory NotificationFilterResponse.fromMap(Map<String, dynamic> map) {
    return NotificationFilterResponse(
      s3Key: map['s3Key'] == null ? null : S3KeyFilterResponse.fromMap((map['s3Key'] as Map).cast<String, dynamic>()),
    );
  }
}
