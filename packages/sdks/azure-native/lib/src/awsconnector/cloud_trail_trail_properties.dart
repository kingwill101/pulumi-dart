...
class CloudTrailTrailProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsCloudTrailTrailProperties>? awsProperties;
  /// AWS Region
  ...
  const CloudTrailTrailProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudTrailTrailProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudTrailTrailProperties.fromMap(Map<String, dynamic> map) {
    return CloudTrailTrailProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudTrailTrailProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
