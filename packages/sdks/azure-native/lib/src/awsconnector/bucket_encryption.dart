...
class BucketEncryption {
  ...
  final pulumi.Input<List<ServerSideEncryptionRule>>?
  ...
  BucketEncryption({this.serverSideEncryptionConfiguration});
    ...
    return BucketEncryption(
      serverSideEncryptionConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerSideEncryptionRule>(
            guardedValue,
            (value) => ServerSideEncryptionRule.fromMap(
