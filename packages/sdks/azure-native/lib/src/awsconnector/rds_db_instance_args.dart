...
class RdsDbInstanceArgs {
  ...
  factory RdsDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbInstanceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RdsDBInstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
