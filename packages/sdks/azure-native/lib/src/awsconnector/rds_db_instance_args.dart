...
class RdsDbInstanceArgs {
  ...
  RdsDbInstanceArgs({
    ...
    pulumi.Output<RdsDBInstanceProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<RdsDBInstanceProperties>(properties),
  ...
  factory RdsDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbInstanceArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<RdsDBInstanceProperties>(RdsDBInstanceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
