...
class CustomActionResponse {
  ...
  factory CustomActionResponse.fromMap(Map<String, dynamic> map) {
    return CustomActionResponse(
      actionDefinition: (() { final guardedValue = map['actionDefinition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ActionDefinitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
