...
class CodeBuildProjectPropertiesResponse {
  ...
  /// AWS Properties
  final AwsCodeBuildProjectPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory CodeBuildProjectPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CodeBuildProjectPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCodeBuildProjectPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
