...
import 'aws_code_build_project_properties_response.dart';

/// Definition of CodeBuildProject
class CodeBuildProjectPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCodeBuildProjectPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CodeBuildProjectPropertiesResponse].
  ...
  const CodeBuildProjectPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCodeBuildProjectPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CodeBuildProjectPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CodeBuildProjectPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCodeBuildProjectPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
