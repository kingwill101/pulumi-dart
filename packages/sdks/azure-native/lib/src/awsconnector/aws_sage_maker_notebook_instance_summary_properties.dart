...
class AwsSageMakerNotebookInstanceSummaryProperties {
  ...
  final NotebookInstanceStatusEnumValue? notebookInstanceStatus;
  ...
  factory AwsSageMakerNotebookInstanceSummaryProperties.fromMap(Map<String, dynamic> map) {
    return AwsSageMakerNotebookInstanceSummaryProperties(
      ...
      notebookInstanceStatus: map['notebookInstanceStatus'] == null ? null : NotebookInstanceStatusEnumValue.fromMap((map['notebookInstanceStatus'] as Map).cast<String, dynamic>()),
