...
class Route53ResourceRecordSetArgs {
  ...
  factory Route53ResourceRecordSetArgs.fromMap(Map<String, dynamic> map) {
    return Route53ResourceRecordSetArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Route53ResourceRecordSetProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
