...
class EventSelectorResponse {
  ...
  factory EventSelectorResponse.fromMap(Map<String, dynamic> map) {
    return EventSelectorResponse(
      dataResources: (() {
        final guardedValue = map['dataResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataResourceResponse>(
            guardedValue,
            (value) => DataResourceResponse.fromMap(
      ...
      excludeManagementEventSources: (() {
        final guardedValue = map['excludeManagementEventSources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      includeManagementEvents: (() {
        final guardedValue = map['includeManagementEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      readWriteType: (() {
        final guardedValue = map['readWriteType'];
        if (guardedValue == null) return null;
