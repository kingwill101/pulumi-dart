...
class ReplicationRule {
  ...
  factory ReplicationRule.fromMap(Map<String, dynamic> map) {
    return ReplicationRule(
      deleteMarkerReplication: (() { final guardedValue = map['deleteMarkerReplication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeleteMarkerReplication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      destination: (() { final guardedValue = map['destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationDestination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationRuleFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      prefix: (() { final guardedValue = map['prefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      priority: (() { final guardedValue = map['priority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      sourceSelectionCriteria: (() { final guardedValue = map['sourceSelectionCriteria']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceSelectionCriteria.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
