...
class AwsLightsailInstanceProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addOns': ?addOns == null ? null : pulumi.Input.encodeList<AddOn, Map<String, dynamic>>(addOns!, (value) => value.toMap()),
  ...
  factory AwsLightsailInstanceProperties.fromMap(Map<String, dynamic> map) {
    return AwsLightsailInstanceProperties(
      addOns: map['addOns'] == null ? null : pulumi.Input.decodeList<AddOn>(map['addOns'], (value) => AddOn.fromMap((value as Map).cast<String, dynamic>())),
      ...
      hardware: map['hardware'] == null ? null : Hardware.fromMap((map['hardware'] as Map).cast<String, dynamic>()),
      ...
      location: map['location'] == null ? null : Location.fromMap((map['location'] as Map).cast<String, dynamic>()),
      networking: map['networking'] == null ? null : Networking.fromMap((map['networking'] as Map).cast<String, dynamic>()),
      ...
      state: map['state'] == null ? null : State.fromMap((map['state'] as Map).cast<String, dynamic>()),
