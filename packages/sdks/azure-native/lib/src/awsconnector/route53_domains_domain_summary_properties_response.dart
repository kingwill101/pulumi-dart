...
class Route53DomainsDomainSummaryPropertiesResponse {
  ...
  /// AWS Properties
  final AwsRoute53DomainsDomainSummaryPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Route53DomainsDomainSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Route53DomainsDomainSummaryPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRoute53DomainsDomainSummaryPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
