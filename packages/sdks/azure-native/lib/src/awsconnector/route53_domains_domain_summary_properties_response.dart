...
class Route53DomainsDomainSummaryPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsRoute53DomainsDomainSummaryPropertiesResponse>?
  awsProperties;
  ...
  factory Route53DomainsDomainSummaryPropertiesResponse.fromMap(
    ...
    return Route53DomainsDomainSummaryPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsRoute53DomainsDomainSummaryPropertiesResponse.fromMap(
