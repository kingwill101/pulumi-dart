...
import 'aws_route53_domains_domain_summary_properties_response.dart';

/// Definition of Route53DomainsDomainSummary
class Route53DomainsDomainSummaryPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRoute53DomainsDomainSummaryPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Route53DomainsDomainSummaryPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRoute53DomainsDomainSummaryPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Route53DomainsDomainSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Route53DomainsDomainSummaryPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRoute53DomainsDomainSummaryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
