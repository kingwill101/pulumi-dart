...
class Wafv2LoggingConfiguration extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Wafv2LoggingConfigurationPropertiesResponse>
  properties;
  ...
  Wafv2LoggingConfiguration(
    ...
    properties = registerOutput<Wafv2LoggingConfigurationPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return Wafv2LoggingConfigurationPropertiesResponse.fromMap(
