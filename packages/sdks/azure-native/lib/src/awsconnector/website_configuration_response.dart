...
class WebsiteConfigurationResponse {
  ...
  factory WebsiteConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return WebsiteConfigurationResponse(
      ...
      redirectAllRequestsTo: (() { final guardedValue = map['redirectAllRequestsTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RedirectAllRequestsToResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      routingRules: (() { final guardedValue = map['routingRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RoutingRuleResponse>(guardedValue, (value) => RoutingRuleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
