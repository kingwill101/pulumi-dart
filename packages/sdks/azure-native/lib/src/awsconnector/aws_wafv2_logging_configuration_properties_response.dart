...
class AwsWafv2LoggingConfigurationPropertiesResponse {
  ...
  factory AwsWafv2LoggingConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsWafv2LoggingConfigurationPropertiesResponse(
      ...
      loggingFilter: (() { final guardedValue = map['loggingFilter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoggingFilterModelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      redactedFields: (() { final guardedValue = map['redactedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FieldToMatchResponse>(guardedValue, (value) => FieldToMatchResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
