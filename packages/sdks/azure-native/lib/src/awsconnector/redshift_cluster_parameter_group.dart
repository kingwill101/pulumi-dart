...
class RedshiftClusterParameterGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RedshiftClusterParameterGroupPropertiesResponse>
  properties;
  ...
  RedshiftClusterParameterGroup(
    ...
    properties =
        registerOutput<RedshiftClusterParameterGroupPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return RedshiftClusterParameterGroupPropertiesResponse.fromMap(
