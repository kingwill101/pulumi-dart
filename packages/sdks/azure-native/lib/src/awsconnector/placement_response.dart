...
class PlacementResponse {
  ...
  factory PlacementResponse.fromMap(Map<String, dynamic> map) {
    return PlacementResponse(
      ...
      tenancy: (() { final guardedValue = map['tenancy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TenancyEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
