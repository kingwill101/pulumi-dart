...
class ProjectBuildBatchConfigResponse {
  ...
  final BatchReportModeTypeEnumValueResponse? batchReportMode;
  ...
  final BatchRestrictionsResponse? restrictions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'batchReportMode': ?batchReportMode == null ? null : batchReportMode!.toMap(),
  ...
  factory ProjectBuildBatchConfigResponse.fromMap(Map<String, dynamic> map) {
    return ProjectBuildBatchConfigResponse(
      batchReportMode: map['batchReportMode'] == null ? null : BatchReportModeTypeEnumValueResponse.fromMap((map['batchReportMode'] as Map).cast<String, dynamic>()),
      combineArtifacts: map['combineArtifacts'] == null ? null : map['combineArtifacts'] as bool,
      restrictions: map['restrictions'] == null ? null : BatchRestrictionsResponse.fromMap((map['restrictions'] as Map).cast<String, dynamic>()),
