...
class InstanceMetadataOptionsResponse {
  ...
  factory InstanceMetadataOptionsResponse.fromMap(Map<String, dynamic> map) {
    return InstanceMetadataOptionsResponse(
      httpEndpoint: (() { final guardedValue = map['httpEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataEndpointStateEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpProtocolIpv6: (() { final guardedValue = map['httpProtocolIpv6']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataProtocolStateEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpTokens: (() { final guardedValue = map['httpTokens']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpTokensStateEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      instanceMetadataTags: (() { final guardedValue = map['instanceMetadataTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataTagsStateEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataOptionsStateEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
