...
class InstanceMetadataOptionsResponse {
  ...
  final InstanceMetadataEndpointStateEnumValue? httpEndpoint;
  ...
  final InstanceMetadataProtocolStateEnumValue? httpProtocolIpv6;
  ...
  final HttpTokensStateEnumValue? httpTokens;
  ...
  final InstanceMetadataTagsStateEnumValue? instanceMetadataTags;
  ...
  final InstanceMetadataOptionsStateEnumValue? state;
  ...
  factory InstanceMetadataOptionsResponse.fromMap(Map<String, dynamic> map) {
    return InstanceMetadataOptionsResponse(
      httpEndpoint: map['httpEndpoint'] == null ? null : InstanceMetadataEndpointStateEnumValue.fromMap((map['httpEndpoint'] as Map).cast<String, dynamic>()),
      httpProtocolIpv6: map['httpProtocolIpv6'] == null ? null : InstanceMetadataProtocolStateEnumValue.fromMap((map['httpProtocolIpv6'] as Map).cast<String, dynamic>()),
      httpPutResponseHopLimit: map['httpPutResponseHopLimit'] == null ? null : map['httpPutResponseHopLimit'] as int,
      httpTokens: map['httpTokens'] == null ? null : HttpTokensStateEnumValue.fromMap((map['httpTokens'] as Map).cast<String, dynamic>()),
      instanceMetadataTags: map['instanceMetadataTags'] == null ? null : InstanceMetadataTagsStateEnumValue.fromMap((map['instanceMetadataTags'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : InstanceMetadataOptionsStateEnumValue.fromMap((map['state'] as Map).cast<String, dynamic>()),
    );
  }
}
