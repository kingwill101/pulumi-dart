    ...
    return InstanceMetadataOptionsResponse(
      httpEndpoint: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceMetadataEndpointStateEnumValue.fromMap(
      ...
      httpProtocolIpv6: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceMetadataProtocolStateEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      httpTokens: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HttpTokensStateEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      instanceMetadataTags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceMetadataTagsStateEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceMetadataOptionsStateEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
