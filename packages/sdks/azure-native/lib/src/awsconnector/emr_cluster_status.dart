    ...
    return <String, dynamic>{
      'errorDetails':
          ...
          >(
            errorDetails,
            (value) =>
                pulumi.Input.encodeList<ErrorDetail, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return EmrClusterStatus(
      errorDetails: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ErrorDetail>(
            guardedValue,
            (value) =>
                ErrorDetail.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      state: (() {
      ...
      stateChangeReason: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterStateChangeReason.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
