...
class SageMakerNotebookInstanceSummaryPropertiesResponse {
  ...
  factory SageMakerNotebookInstanceSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SageMakerNotebookInstanceSummaryPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : (AwsSageMakerNotebookInstanceSummaryPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>())).input(),
