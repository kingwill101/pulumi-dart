...
class SageMakerNotebookInstanceSummaryPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSageMakerNotebookInstanceSummaryPropertiesResponse>?
  awsProperties;
  ...
  factory SageMakerNotebookInstanceSummaryPropertiesResponse.fromMap(
    ...
    return SageMakerNotebookInstanceSummaryPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsSageMakerNotebookInstanceSummaryPropertiesResponse.fromMap(
