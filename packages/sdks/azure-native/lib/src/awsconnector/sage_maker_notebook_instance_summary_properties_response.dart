...
import 'aws_sage_maker_notebook_instance_summary_properties_response.dart';

/// Definition of SageMakerNotebookInstanceSummary
class SageMakerNotebookInstanceSummaryPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSageMakerNotebookInstanceSummaryPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SageMakerNotebookInstanceSummaryPropertiesResponse].
  ...
  const SageMakerNotebookInstanceSummaryPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSageMakerNotebookInstanceSummaryPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SageMakerNotebookInstanceSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SageMakerNotebookInstanceSummaryPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSageMakerNotebookInstanceSummaryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
