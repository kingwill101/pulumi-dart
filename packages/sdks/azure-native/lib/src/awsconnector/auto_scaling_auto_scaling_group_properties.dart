...
import 'aws_auto_scaling_auto_scaling_group_properties.dart';

/// Definition of AutoScalingAutoScalingGroup
class AutoScalingAutoScalingGroupProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsAutoScalingAutoScalingGroupProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [AutoScalingAutoScalingGroupProperties].
  ...
  const AutoScalingAutoScalingGroupProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsAutoScalingAutoScalingGroupProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory AutoScalingAutoScalingGroupProperties.fromMap(Map<String, dynamic> map) {
    return AutoScalingAutoScalingGroupProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsAutoScalingAutoScalingGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
