...
class AwsAccessAnalyzerAnalyzerProperties {
    ...
    return <String, dynamic>{
      ...
      'archiveRules':
          ...
          >(
            archiveRules,
            (value) =>
                pulumi.Input.encodeList<ArchiveRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsAccessAnalyzerAnalyzerProperties.fromMap(
    ...
    return AwsAccessAnalyzerAnalyzerProperties(
      analyzerConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          UnusedAccessConfiguration.fromMap(
      ...
      archiveRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ArchiveRule>(
            guardedValue,
            (value) =>
                ArchiveRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      arn: (() {
