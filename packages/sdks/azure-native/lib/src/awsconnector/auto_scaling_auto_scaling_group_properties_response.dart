...
import 'aws_auto_scaling_auto_scaling_group_properties_response.dart';

/// Definition of AutoScalingAutoScalingGroup
class AutoScalingAutoScalingGroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsAutoScalingAutoScalingGroupPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [AutoScalingAutoScalingGroupPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsAutoScalingAutoScalingGroupPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory AutoScalingAutoScalingGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AutoScalingAutoScalingGroupPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsAutoScalingAutoScalingGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
