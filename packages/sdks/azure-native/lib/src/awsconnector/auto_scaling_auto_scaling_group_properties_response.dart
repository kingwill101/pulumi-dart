...
class AutoScalingAutoScalingGroupPropertiesResponse {
  ...
  /// AWS Properties
  final AwsAutoScalingAutoScalingGroupPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory AutoScalingAutoScalingGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AutoScalingAutoScalingGroupPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsAutoScalingAutoScalingGroupPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
