...
class AutoScalingAutoScalingGroupPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsAutoScalingAutoScalingGroupPropertiesResponse>?
  awsProperties;
  ...
  factory AutoScalingAutoScalingGroupPropertiesResponse.fromMap(
    ...
    return AutoScalingAutoScalingGroupPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsAutoScalingAutoScalingGroupPropertiesResponse.fromMap(
