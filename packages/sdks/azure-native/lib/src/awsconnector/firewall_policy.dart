...
class FirewallPolicy {
  ...
  factory FirewallPolicy.fromMap(Map<String, dynamic> map) {
    return FirewallPolicy(
      policyVariables: (() { final guardedValue = map['policyVariables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleVariablesModel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      statefulEngineOptions: (() { final guardedValue = map['statefulEngineOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StatefulEngineOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      statefulRuleGroupReferences: (() { final guardedValue = map['statefulRuleGroupReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StatefulRuleGroupReference>(guardedValue, (value) => StatefulRuleGroupReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      statelessCustomActions: (() { final guardedValue = map['statelessCustomActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomAction>(guardedValue, (value) => CustomAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      statelessRuleGroupReferences: (() { final guardedValue = map['statelessRuleGroupReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StatelessRuleGroupReference>(guardedValue, (value) => StatelessRuleGroupReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
