...
class IamServerCertificateArgs {
  ...
  /// [tags] Resource tags.
  const IamServerCertificateArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory IamServerCertificateArgs.fromMap(Map<String, dynamic> map) {
    return IamServerCertificateArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamServerCertificateProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
