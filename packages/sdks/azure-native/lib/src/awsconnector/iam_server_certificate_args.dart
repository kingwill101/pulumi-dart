...
class IamServerCertificateArgs {
  ...
  IamServerCertificateArgs({
    ...
    pulumi.Output<IamServerCertificateProperties>? properties,
  ...
  factory IamServerCertificateArgs.fromMap(Map<String, dynamic> map) {
    return IamServerCertificateArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<IamServerCertificateProperties>(IamServerCertificateProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
