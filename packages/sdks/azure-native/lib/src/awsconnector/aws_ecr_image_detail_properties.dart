...
class AwsEcrImageDetailProperties {
  ...
  factory AwsEcrImageDetailProperties.fromMap(Map<String, dynamic> map) {
    return AwsEcrImageDetailProperties(
      ...
      imageScanFindingsSummary: map['imageScanFindingsSummary'] == null ? null : (ImageScanFindingsSummary.fromMap((map['imageScanFindingsSummary'] as Map).cast<String, dynamic>())).input(),
      imageScanStatus: map['imageScanStatus'] == null ? null : (ImageScanStatus.fromMap((map['imageScanStatus'] as Map).cast<String, dynamic>())).input(),
