...
class AwsEc2NetworkInterfacePropertiesResponse {
  ...
  final pulumi.Input<ConnectionTrackingSpecificationResponse>? connectionTrackingSpecification;
  ...
  final pulumi.Input<List<PrivateIpAddressSpecificationResponse>>? privateIpAddresses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionTrackingSpecification': ?pulumi.Input.mapOptionalInputValue<ConnectionTrackingSpecificationResponse, Map<String, dynamic>>(connectionTrackingSpecification, (value) => value.toMap()),
      ...
      'privateIpAddresses': ?pulumi.Input.mapOptionalInputValue<List<PrivateIpAddressSpecificationResponse>, List<Map<String, dynamic>>>(privateIpAddresses, (value) => pulumi.Input.encodeList<PrivateIpAddressSpecificationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AwsEc2NetworkInterfacePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2NetworkInterfacePropertiesResponse(
      connectionTrackingSpecification: map['connectionTrackingSpecification'] == null ? null : (ConnectionTrackingSpecificationResponse.fromMap((map['connectionTrackingSpecification']! as Map).cast<String, dynamic>())).input(),
      ...
      ipv4Prefixes: map['ipv4Prefixes'] == null ? null : (pulumi.Input.decodeList<Ipv4PrefixSpecificationResponse>(map['ipv4Prefixes']!, (value) => Ipv4PrefixSpecificationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      ipv6Prefixes: map['ipv6Prefixes'] == null ? null : (pulumi.Input.decodeList<Ipv6PrefixSpecificationResponse>(map['ipv6Prefixes']!, (value) => Ipv6PrefixSpecificationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      privateIpAddresses: map['privateIpAddresses'] == null ? null : (pulumi.Input.decodeList<PrivateIpAddressSpecificationResponse>(map['privateIpAddresses']!, (value) => PrivateIpAddressSpecificationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
