...
class AwsEc2NetworkInterfacePropertiesResponse {
  ...
  const AwsEc2NetworkInterfacePropertiesResponse({
  ...
  factory AwsEc2NetworkInterfacePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2NetworkInterfacePropertiesResponse(
      connectionTrackingSpecification: (() { final guardedValue = map['connectionTrackingSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionTrackingSpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      privateIpAddresses: (() { final guardedValue = map['privateIpAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PrivateIpAddressSpecificationResponse>(guardedValue, (value) => PrivateIpAddressSpecificationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
