...
class AwsS3AccessControlPolicyPropertiesResponse {
  ...
  AwsS3AccessControlPolicyPropertiesResponse({this.grants, this.owner});
    ...
    return <String, dynamic>{
      'grants':
          ...
          >(
            grants,
            (value) =>
                pulumi.Input.encodeList<GrantResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsS3AccessControlPolicyPropertiesResponse.fromMap(
    ...
    return AwsS3AccessControlPolicyPropertiesResponse(
      grants: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GrantResponse>(
            guardedValue,
            (value) =>
                GrantResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      owner: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OwnerResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
