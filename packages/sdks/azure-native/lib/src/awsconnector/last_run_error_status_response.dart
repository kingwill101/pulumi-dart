...
class LastRunErrorStatusResponse {
  ...
  const LastRunErrorStatusResponse({
    this.code,
  });
  ...
  factory LastRunErrorStatusResponse.fromMap(Map<String, dynamic> map) {
    return LastRunErrorStatusResponse(
      code: (() { final guardedValue = map['code']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LastRunErrorStatusCodeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
