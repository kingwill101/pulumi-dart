...
class LastRunErrorStatusResponse {
  ...
  final LastRunErrorStatusCodeEnumValueResponse? code;
  ...
  factory LastRunErrorStatusResponse.fromMap(Map<String, dynamic> map) {
    return LastRunErrorStatusResponse(
      code: map['code'] == null ? null : LastRunErrorStatusCodeEnumValueResponse.fromMap((map['code'] as Map).cast<String, dynamic>()),
    );
  }
}
