...
class AwsElasticLoadBalancingV2TargetGroupProperties {
  ...
  const AwsElasticLoadBalancingV2TargetGroupProperties({
  ...
  factory AwsElasticLoadBalancingV2TargetGroupProperties.fromMap(Map<String, dynamic> map) {
    return AwsElasticLoadBalancingV2TargetGroupProperties(
      ...
      targetGroupAttributes: (() { final guardedValue = map['targetGroupAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TargetGroupAttribute>(guardedValue, (value) => TargetGroupAttribute.fromMap((value as Map).cast<String, dynamic>()))); })(),
