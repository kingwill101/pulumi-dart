...
class AwsElasticLoadBalancingV2TargetGroupProperties {
  ...
  /// The attributes.
  final List<TargetGroupAttribute>? targetGroupAttributes;
  ...
  /// The targets.
  final List<TargetDescription>? targets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetGroupAttributes': ?targetGroupAttributes == null ? null : pulumi.Input.encodeList<TargetGroupAttribute, Map<String, dynamic>>(targetGroupAttributes!, (value) => value.toMap()),
      'targetGroupFullName': ?targetGroupFullName,
      'targetGroupName': ?targetGroupName,
      'targetType': ?targetType,
      'targets': ?targets == null ? null : pulumi.Input.encodeList<TargetDescription, Map<String, dynamic>>(targets!, (value) => value.toMap()),
  ...
  factory AwsElasticLoadBalancingV2TargetGroupProperties.fromMap(Map<String, dynamic> map) {
    return AwsElasticLoadBalancingV2TargetGroupProperties(
      ...
      matcher: map['matcher'] == null ? null : Matcher.fromMap((map['matcher'] as Map).cast<String, dynamic>()),
      ...
      targetGroupAttributes: map['targetGroupAttributes'] == null ? null : pulumi.Input.decodeList<TargetGroupAttribute>(map['targetGroupAttributes'], (value) => TargetGroupAttribute.fromMap((value as Map).cast<String, dynamic>())),
      ...
      targets: map['targets'] == null ? null : pulumi.Input.decodeList<TargetDescription>(map['targets'], (value) => TargetDescription.fromMap((value as Map).cast<String, dynamic>())),
