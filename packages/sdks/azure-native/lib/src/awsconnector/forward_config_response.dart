...
class ForwardConfigResponse {
  ...
  factory ForwardConfigResponse.fromMap(Map<String, dynamic> map) {
    return ForwardConfigResponse(
      targetGroupStickinessConfig: (() { final guardedValue = map['targetGroupStickinessConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetGroupStickinessConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      targetGroups: (() { final guardedValue = map['targetGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TargetGroupTupleResponse>(guardedValue, (value) => TargetGroupTupleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
