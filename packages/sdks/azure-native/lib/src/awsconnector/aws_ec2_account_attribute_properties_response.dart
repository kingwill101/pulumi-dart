...
class AwsEc2AccountAttributePropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'attributeValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccountAttributeValueResponse>,
  ...
  factory AwsEc2AccountAttributePropertiesResponse.fromMap(
    ...
    return AwsEc2AccountAttributePropertiesResponse(
      ...
      attributeValues: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountAttributeValueResponse>(
            guardedValue,
            (value) => AccountAttributeValueResponse.fromMap(
