...
class GlobalSecondaryIndexResponse {
  ...
  final pulumi.Input<ContributorInsightsSpecificationResponse>?
    ...
    return GlobalSecondaryIndexResponse(
      contributorInsightsSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          ContributorInsightsSpecificationResponse.fromMap(
      ...
      keySchema: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeySchemaResponse>(
            guardedValue,
            (value) => KeySchemaResponse.fromMap(
      ...
      provisionedThroughput: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProvisionedThroughputResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
