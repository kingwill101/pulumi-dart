...
class RdsExportTaskArgs {
  ...
  factory RdsExportTaskArgs.fromMap(Map<String, dynamic> map) {
    return RdsExportTaskArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RdsExportTaskProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
