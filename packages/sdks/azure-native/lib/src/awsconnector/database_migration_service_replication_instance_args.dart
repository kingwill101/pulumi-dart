...
class DatabaseMigrationServiceReplicationInstanceArgs {
  ...
  final pulumi.Input<DatabaseMigrationServiceReplicationInstanceProperties>?
  properties;
  ...
  factory DatabaseMigrationServiceReplicationInstanceArgs.fromMap(
    ...
    return DatabaseMigrationServiceReplicationInstanceArgs(
      ...
      properties: (() {
        ...
        return pulumi.Input.fromValue(
          DatabaseMigrationServiceReplicationInstanceProperties.fromMap(
