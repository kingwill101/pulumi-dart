...
class CloudFrontDistribution extends pulumi.CustomResource {
  ...
  CloudFrontDistribution(
    ...
    properties = registerOutput<CloudFrontDistributionPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CloudFrontDistributionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [CloudFrontDistribution] resource.
  CloudFrontDistribution.reference(String urn)
    : super(
        'azure-native:awsconnector:CloudFrontDistribution',
