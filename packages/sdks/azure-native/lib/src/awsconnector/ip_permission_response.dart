    ...
    return IpPermissionResponse(
      ...
      ipRanges: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpRangeResponse>(
            guardedValue,
            (value) =>
      ...
      ipv6Ranges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Ipv6RangeResponse>(
            guardedValue,
            (value) => Ipv6RangeResponse.fromMap(
      ...
      prefixListIds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrefixListIdResponse>(
            guardedValue,
            (value) => PrefixListIdResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      userIdGroupPairs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserIdGroupPairResponse>(
            guardedValue,
            (value) => UserIdGroupPairResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
