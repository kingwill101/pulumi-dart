...
import 'dbinstance_role_response.dart';
import 'master_user_secret_response.dart';
import 'processor_feature_response.dart';
import 'rds_db_instance_endpoint_response.dart';
import 'tag_response.dart';

/// Definition of awsRdsDBInstance
class AwsRdsDBInstancePropertiesResponse {
  ...
  final pulumi.Input<List<DBInstanceRoleResponse>>? associatedRoles;
  ...
  final pulumi.Input<CertificateDetailsResponse>? certificateDetails;
  ...
  final pulumi.Input<RdsDbInstanceEndpointResponse>? endpoint;
  ...
  /// Creates a new [AwsRdsDBInstancePropertiesResponse].
  ...
  factory AwsRdsDBInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBInstancePropertiesResponse(
      allocatedStorage: (() {
      ...
      associatedRoles: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DBInstanceRoleResponse>(
            guardedValue,
            (value) => DBInstanceRoleResponse.fromMap(
      ...
      certificateDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CertificateDetailsResponse.fromMap(
      ...
      endpoint: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RdsDbInstanceEndpointResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
