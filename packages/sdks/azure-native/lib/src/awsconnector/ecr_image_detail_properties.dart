...
import 'aws_ecr_image_detail_properties.dart';

/// Definition of EcrImageDetail
class EcrImageDetailProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcrImageDetailProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcrImageDetailProperties].
  ...
  const EcrImageDetailProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcrImageDetailProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcrImageDetailProperties.fromMap(Map<String, dynamic> map) {
    return EcrImageDetailProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcrImageDetailProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
