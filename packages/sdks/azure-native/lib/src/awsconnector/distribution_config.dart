...
import 'cache_behavior.dart';
import 'custom_error_response.dart';
import 'default_cache_behavior.dart';
import 'legacy_custom_origin.dart';
import 'legacy_s3_origin.dart';
import 'logging.dart';
import 'origin.dart';
import 'origin_groups.dart';
import 'restrictions.dart';
import 'viewer_certificate.dart';
...
class DistributionConfig {
  ...
  final List<CacheBehavior>? cacheBehaviors;
  /// Property cnamEs
  ...
  final List<CustomErrorResponse>? customErrorResponses;
  /// Property customOrigin
  final LegacyCustomOrigin? customOrigin;
  ...
  /// Creates a new [DistributionConfig].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aliases': ?aliases,
      'cacheBehaviors': ?cacheBehaviors == null ? null : pulumi.Input.encodeList<CacheBehavior, Map<String, dynamic>>(cacheBehaviors!, (value) => value.toMap()),
      'cnamEs': ?cnamEs,
      'comment': ?comment,
      'continuousDeploymentPolicyId': ?continuousDeploymentPolicyId,
      'customErrorResponses': ?customErrorResponses == null ? null : pulumi.Input.encodeList<CustomErrorResponse, Map<String, dynamic>>(customErrorResponses!, (value) => value.toMap()),
      ...
      'origins': ?origins == null ? null : pulumi.Input.encodeList<Origin, String>(origins!, (value) => value.value),
  ...
  factory DistributionConfig.fromMap(Map<String, dynamic> map) {
    return DistributionConfig(
      ...
      cacheBehaviors: map['cacheBehaviors'] == null ? null : pulumi.Input.decodeList<CacheBehavior>(map['cacheBehaviors'], (value) => CacheBehavior.fromMap((value as Map).cast<String, dynamic>())),
      ...
      customErrorResponses: map['customErrorResponses'] == null ? null : pulumi.Input.decodeList<CustomErrorResponse>(map['customErrorResponses'], (value) => CustomErrorResponse.fromMap((value as Map).cast<String, dynamic>())),
      customOrigin: map['customOrigin'] == null ? null : LegacyCustomOrigin.fromMap((map['customOrigin'] as Map).cast<String, dynamic>()),
      defaultCacheBehavior: map['defaultCacheBehavior'] == null ? null : DefaultCacheBehavior.fromMap((map['defaultCacheBehavior'] as Map).cast<String, dynamic>()),
      ...
      originGroups: map['originGroups'] == null ? null : OriginGroups.fromMap((map['originGroups'] as Map).cast<String, dynamic>()),
      origins: map['origins'] == null ? null : pulumi.Input.decodeList<Origin>(map['origins'], (value) => Origin.fromValue(value as String)),
      priceClass: map['priceClass'] == null ? null : map['priceClass'] as String,
      restrictions: map['restrictions'] == null ? null : Restrictions.fromMap((map['restrictions'] as Map).cast<String, dynamic>()),
      s3Origin: map['s3Origin'] == null ? null : LegacyS3Origin.fromMap((map['s3Origin'] as Map).cast<String, dynamic>()),
      staging: map['staging'] == null ? null : map['staging'] as bool,
      viewerCertificate: map['viewerCertificate'] == null ? null : ViewerCertificate.fromMap((map['viewerCertificate'] as Map).cast<String, dynamic>()),
