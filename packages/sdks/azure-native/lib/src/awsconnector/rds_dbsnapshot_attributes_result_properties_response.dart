...
class RdsDBSnapshotAttributesResultPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsRdsDBSnapshotAttributesResultPropertiesResponse>?
  awsProperties;
  ...
  factory RdsDBSnapshotAttributesResultPropertiesResponse.fromMap(
    ...
    return RdsDBSnapshotAttributesResultPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsRdsDBSnapshotAttributesResultPropertiesResponse.fromMap(
