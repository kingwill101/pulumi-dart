...
import 'aws_rds_dbsnapshot_attributes_result_properties_response.dart';

/// Definition of RdsDBSnapshotAttributesResult
class RdsDBSnapshotAttributesResultPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsDBSnapshotAttributesResultPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsDBSnapshotAttributesResultPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsDBSnapshotAttributesResultPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsDBSnapshotAttributesResultPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotAttributesResultPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBSnapshotAttributesResultPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
