...
class SsmResourceComplianceSummaryItemArgs {
  ...
  /// [tags] Resource tags.
  const SsmResourceComplianceSummaryItemArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory SsmResourceComplianceSummaryItemArgs.fromMap(Map<String, dynamic> map) {
    return SsmResourceComplianceSummaryItemArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SsmResourceComplianceSummaryItemProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
