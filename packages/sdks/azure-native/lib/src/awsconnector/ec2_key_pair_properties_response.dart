...
import 'aws_ec2_key_pair_properties_response.dart';

/// Definition of Ec2KeyPair
class Ec2KeyPairPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2KeyPairPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2KeyPairPropertiesResponse].
  ...
  const Ec2KeyPairPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2KeyPairPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2KeyPairPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2KeyPairPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2KeyPairPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
