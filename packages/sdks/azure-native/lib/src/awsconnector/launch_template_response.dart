...
class LaunchTemplateResponse {
  ...
  final pulumi.Input<LaunchTemplateSpecificationResponse>?
  ...
  LaunchTemplateResponse({this.launchTemplateSpecification, this.overrides});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'overrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<LaunchTemplateOverridesResponse>,
  ...
  factory LaunchTemplateResponse.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateResponse(
      ...
      overrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LaunchTemplateOverridesResponse>(
            guardedValue,
            (value) => LaunchTemplateOverridesResponse.fromMap(
