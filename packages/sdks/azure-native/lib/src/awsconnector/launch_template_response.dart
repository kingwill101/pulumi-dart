...
class LaunchTemplateResponse {
  ...
  final pulumi.Input<LaunchTemplateSpecificationResponse>? launchTemplateSpecification;
  /// Any properties that you specify override the same properties in the launch template.
  final pulumi.Input<List<LaunchTemplateOverridesResponse>>? overrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'launchTemplateSpecification': ?pulumi.Input.mapOptionalInputValue<LaunchTemplateSpecificationResponse, Map<String, dynamic>>(launchTemplateSpecification, (value) => value.toMap()),
      'overrides': ?pulumi.Input.mapOptionalInputValue<List<LaunchTemplateOverridesResponse>, List<Map<String, dynamic>>>(overrides, (value) => pulumi.Input.encodeList<LaunchTemplateOverridesResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory LaunchTemplateResponse.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateResponse(
      launchTemplateSpecification: (() { final guardedValue = map['launchTemplateSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LaunchTemplateSpecificationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      overrides: (() { final guardedValue = map['overrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LaunchTemplateOverridesResponse>(guardedValue, (value) => LaunchTemplateOverridesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
