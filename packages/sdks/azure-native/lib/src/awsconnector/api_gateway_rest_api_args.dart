...
class ApiGatewayRestApiArgs {
  ...
  ApiGatewayRestApiArgs({
    ...
    pulumi.Output<ApiGatewayRestApiProperties>? properties,
  ...
  factory ApiGatewayRestApiArgs.fromMap(Map<String, dynamic> map) {
    return ApiGatewayRestApiArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ApiGatewayRestApiProperties>(ApiGatewayRestApiProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
