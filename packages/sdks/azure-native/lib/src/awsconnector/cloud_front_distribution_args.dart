...
class CloudFrontDistributionArgs {
  ...
  /// [tags] Resource tags.
  const CloudFrontDistributionArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory CloudFrontDistributionArgs.fromMap(Map<String, dynamic> map) {
    return CloudFrontDistributionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudFrontDistributionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
