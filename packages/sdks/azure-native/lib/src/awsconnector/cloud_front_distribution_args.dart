...
class CloudFrontDistributionArgs {
  ...
  CloudFrontDistributionArgs({
    ...
    pulumi.Output<CloudFrontDistributionProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<CloudFrontDistributionProperties>(properties),
  ...
  factory CloudFrontDistributionArgs.fromMap(Map<String, dynamic> map) {
    return CloudFrontDistributionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<CloudFrontDistributionProperties>(CloudFrontDistributionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
