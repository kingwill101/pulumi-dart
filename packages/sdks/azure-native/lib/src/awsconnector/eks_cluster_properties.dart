...
class EksClusterProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEksClusterProperties>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEksClusterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EksClusterProperties.fromMap(Map<String, dynamic> map) {
    return EksClusterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEksClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
