...
/// }
///
/// resource "azure-native_awsconnector_elasticbeanstalkapplication" "elasticBeanstalkApplication" {
///   location = "iiedtydxzeyayiwanytnqwn"
///   name     = "Replace this value with a string matching RegExp ^(z=.{0,259}[^zs.]$)(z!.*[zzzzzzzz])"
///   properties = {
///     arn            = "yautrhxbrmk"
...
class ElasticBeanstalkApplication extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ElasticBeanstalkApplicationPropertiesResponse> properties;
  ...
  ElasticBeanstalkApplication(
    ...
    properties = registerOutput<ElasticBeanstalkApplicationPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ElasticBeanstalkApplicationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ElasticBeanstalkApplication] resource.
  ElasticBeanstalkApplication.reference(String urn)
    : super(
        'azure-native:awsconnector:ElasticBeanstalkApplication',
