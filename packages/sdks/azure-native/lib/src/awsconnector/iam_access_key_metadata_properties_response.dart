...
import 'aws_iam_access_key_metadata_properties_response.dart';

/// Definition of IamAccessKeyMetadata
class IamAccessKeyMetadataPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamAccessKeyMetadataPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamAccessKeyMetadataPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamAccessKeyMetadataPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamAccessKeyMetadataPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyMetadataPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamAccessKeyMetadataPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
