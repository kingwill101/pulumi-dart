...
class IamAccessKeyMetadataPropertiesResponse {
  ...
  /// AWS Properties
  final AwsIamAccessKeyMetadataPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory IamAccessKeyMetadataPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyMetadataPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamAccessKeyMetadataPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
