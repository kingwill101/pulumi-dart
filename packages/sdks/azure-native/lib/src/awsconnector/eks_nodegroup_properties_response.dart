...
import 'aws_eks_nodegroup_properties_response.dart';

/// Definition of EksNodegroup
class EksNodegroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEksNodegroupPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EksNodegroupPropertiesResponse].
  ...
  const EksNodegroupPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEksNodegroupPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EksNodegroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EksNodegroupPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEksNodegroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
