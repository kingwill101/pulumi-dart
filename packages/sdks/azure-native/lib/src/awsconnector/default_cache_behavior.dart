...
import 'forwarded_values.dart';
import 'function_association.dart';
import 'lambda_function_association.dart';
...
class DefaultCacheBehavior {
  ...
  final pulumi.Input<ForwardedValues>? forwardedValues;

  /// A list of CloudFront functions that are associated with this cache behavior. CloudFront functions must be published to the ``LIVE`` stage to associate them with a cache behavior.
  final pulumi.Input<List<FunctionAssociation>>? functionAssociations;

  /// A complex type that contains zero or more Lambda@Edge function associations for a cache behavior.
  final pulumi.Input<List<LambdaFunctionAssociation>>?
  ...
  /// Creates a new [DefaultCacheBehavior].
  ...
  factory DefaultCacheBehavior.fromMap(Map<String, dynamic> map) {
    return DefaultCacheBehavior(
      ...
      functionAssociations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FunctionAssociation>(
            guardedValue,
            (value) => FunctionAssociation.fromMap(
      ...
      lambdaFunctionAssociations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LambdaFunctionAssociation>(
            guardedValue,
            (value) => LambdaFunctionAssociation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
