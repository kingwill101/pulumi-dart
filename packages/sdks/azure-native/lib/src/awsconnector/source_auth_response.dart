...
class SourceAuthResponse {
  ...
  factory SourceAuthResponse.fromMap(Map<String, dynamic> map) {
    return SourceAuthResponse(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceAuthTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
