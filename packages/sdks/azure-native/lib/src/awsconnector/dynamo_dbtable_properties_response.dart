...
import 'aws_dynamo_dbtable_properties_response.dart';

/// Definition of DynamoDBTable
class DynamoDBTablePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsDynamoDBTablePropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [DynamoDBTablePropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsDynamoDBTablePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory DynamoDBTablePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DynamoDBTablePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsDynamoDBTablePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
