...
class LambdaFunctionCodeLocationPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsLambdaFunctionCodeLocationPropertiesResponse>?
  awsProperties;
  ...
  factory LambdaFunctionCodeLocationPropertiesResponse.fromMap(
    ...
    return LambdaFunctionCodeLocationPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsLambdaFunctionCodeLocationPropertiesResponse.fromMap(
