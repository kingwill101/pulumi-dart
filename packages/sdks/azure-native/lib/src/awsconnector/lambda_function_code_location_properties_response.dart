...
import 'aws_lambda_function_code_location_properties_response.dart';

/// Definition of LambdaFunctionCodeLocation
class LambdaFunctionCodeLocationPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLambdaFunctionCodeLocationPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LambdaFunctionCodeLocationPropertiesResponse].
  ...
  const LambdaFunctionCodeLocationPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLambdaFunctionCodeLocationPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LambdaFunctionCodeLocationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionCodeLocationPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLambdaFunctionCodeLocationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
