...
class LambdaFunctionCodeLocationPropertiesResponse {
  ...
  /// AWS Properties
  final AwsLambdaFunctionCodeLocationPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory LambdaFunctionCodeLocationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionCodeLocationPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLambdaFunctionCodeLocationPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
