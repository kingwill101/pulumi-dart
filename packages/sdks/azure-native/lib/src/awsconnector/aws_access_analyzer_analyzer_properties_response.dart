...
class AwsAccessAnalyzerAnalyzerPropertiesResponse {
    ...
    return <String, dynamic>{
      'analyzerConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(analyzerConfiguration, (value) => value.toMap()),
      'analyzerName': ?analyzerName,
      'archiveRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<ArchiveRuleResponse>,
  ...
  factory AwsAccessAnalyzerAnalyzerPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AwsAccessAnalyzerAnalyzerPropertiesResponse(
      analyzerConfiguration: (() {
        final guardedValue = map['analyzerConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UnusedAccessConfigurationResponse.fromMap(
      ...
      archiveRules: (() {
        final guardedValue = map['archiveRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ArchiveRuleResponse>(
            guardedValue,
            (value) => ArchiveRuleResponse.fromMap(
