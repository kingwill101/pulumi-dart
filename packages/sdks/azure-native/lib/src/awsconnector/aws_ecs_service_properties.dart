...
class AwsEcsServiceProperties {
  ...
  final pulumi.Input<List<CapacityProviderStrategyItem>>? capacityProviderStrategy;
  ...
  final pulumi.Input<DeploymentController>? deploymentController;
  ...
  final pulumi.Input<List<LoadBalancer>>? loadBalancers;
  /// Property name
  ...
  final pulumi.Input<List<PlacementConstraint>>? placementConstraints;
  /// The placement strategy objects to use for tasks in your service. You can specify a maximum of 5 strategy rules for each service.
  final pulumi.Input<List<PlacementStrategy>>? placementStrategies;
  ...
  final pulumi.Input<ServiceConnectConfiguration>? serviceConnectConfiguration;
  ...
  final pulumi.Input<List<ServiceRegistry>>? serviceRegistries;
  ...
  final pulumi.Input<List<ServiceVolumeConfiguration>>? volumeConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'capacityProviderStrategy': ?pulumi.Input.mapOptionalInputValue<List<CapacityProviderStrategyItem>, List<Map<String, dynamic>>>(capacityProviderStrategy, (value) => pulumi.Input.encodeList<CapacityProviderStrategyItem, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cluster': ?cluster,
      ...
      'deploymentController': ?pulumi.Input.mapOptionalInputValue<DeploymentController, Map<String, dynamic>>(deploymentController, (value) => value.toMap()),
      'desiredCount': ?desiredCount,
      'enableECSManagedTags': ?enableECSManagedTags,
      'enableExecuteCommand': ?enableExecuteCommand,
      'healthCheckGracePeriodSeconds': ?healthCheckGracePeriodSeconds,
      'launchType': ?launchType,
      'loadBalancers': ?pulumi.Input.mapOptionalInputValue<List<LoadBalancer>, List<Map<String, dynamic>>>(loadBalancers, (value) => pulumi.Input.encodeList<LoadBalancer, Map<String, dynamic>>(value, (value) => value.toMap())),
      'name': ?name,
      ...
      'placementConstraints': ?pulumi.Input.mapOptionalInputValue<List<PlacementConstraint>, List<Map<String, dynamic>>>(placementConstraints, (value) => pulumi.Input.encodeList<PlacementConstraint, Map<String, dynamic>>(value, (value) => value.toMap())),
      'placementStrategies': ?pulumi.Input.mapOptionalInputValue<List<PlacementStrategy>, List<Map<String, dynamic>>>(placementStrategies, (value) => pulumi.Input.encodeList<PlacementStrategy, Map<String, dynamic>>(value, (value) => value.toMap())),
      'platformVersion': ?platformVersion,
      'propagateTags': ?propagateTags,
      'role': ?role,
      'schedulingStrategy': ?schedulingStrategy,
      'serviceArn': ?serviceArn,
      'serviceConnectConfiguration': ?pulumi.Input.mapOptionalInputValue<ServiceConnectConfiguration, Map<String, dynamic>>(serviceConnectConfiguration, (value) => value.toMap()),
      'serviceName': ?serviceName,
      'serviceRegistries': ?pulumi.Input.mapOptionalInputValue<List<ServiceRegistry>, List<Map<String, dynamic>>>(serviceRegistries, (value) => pulumi.Input.encodeList<ServiceRegistry, Map<String, dynamic>>(value, (value) => value.toMap())),
      'tags': ?pulumi.Input.mapOptionalInputValue<List<Tag>, List<Map<String, dynamic>>>(tags, (value) => pulumi.Input.encodeList<Tag, Map<String, dynamic>>(value, (value) => value.toMap())),
      'taskDefinition': ?taskDefinition,
      'volumeConfigurations': ?pulumi.Input.mapOptionalInputValue<List<ServiceVolumeConfiguration>, List<Map<String, dynamic>>>(volumeConfigurations, (value) => pulumi.Input.encodeList<ServiceVolumeConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory AwsEcsServiceProperties.fromMap(Map<String, dynamic> map) {
    return AwsEcsServiceProperties(
      capacityProviderStrategy: map['capacityProviderStrategy'] == null ? null : (pulumi.Input.decodeList<CapacityProviderStrategyItem>(map['capacityProviderStrategy']!, (value) => CapacityProviderStrategyItem.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      deploymentController: map['deploymentController'] == null ? null : (DeploymentController.fromMap((map['deploymentController']! as Map).cast<String, dynamic>())).input(),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : (pulumi.Input.decodeList<LoadBalancer>(map['loadBalancers']!, (value) => LoadBalancer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      placementConstraints: map['placementConstraints'] == null ? null : (pulumi.Input.decodeList<PlacementConstraint>(map['placementConstraints']!, (value) => PlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      placementStrategies: map['placementStrategies'] == null ? null : (pulumi.Input.decodeList<PlacementStrategy>(map['placementStrategies']!, (value) => PlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      serviceConnectConfiguration: map['serviceConnectConfiguration'] == null ? null : (ServiceConnectConfiguration.fromMap((map['serviceConnectConfiguration']! as Map).cast<String, dynamic>())).input(),
      serviceName: map['serviceName'] == null ? null : (map['serviceName']! as String).input(),
      serviceRegistries: map['serviceRegistries'] == null ? null : (pulumi.Input.decodeList<ServiceRegistry>(map['serviceRegistries']!, (value) => ServiceRegistry.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tags: map['tags'] == null ? null : (pulumi.Input.decodeList<Tag>(map['tags']!, (value) => Tag.fromMap((value as Map).cast<String, dynamic>()))).input(),
      taskDefinition: map['taskDefinition'] == null ? null : (map['taskDefinition']! as String).input(),
      volumeConfigurations: map['volumeConfigurations'] == null ? null : (pulumi.Input.decodeList<ServiceVolumeConfiguration>(map['volumeConfigurations']!, (value) => ServiceVolumeConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
