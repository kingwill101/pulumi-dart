...
class SnsTopicProperties {
  ...
  factory SnsTopicProperties.fromMap(Map<String, dynamic> map) {
    return SnsTopicProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSnsTopicProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
