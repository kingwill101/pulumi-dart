...
class OrganizationsOrganization extends pulumi.CustomResource {
  ...
  late final pulumi.Output<OrganizationsOrganizationPropertiesResponse>
  properties;
  ...
  OrganizationsOrganization(
    ...
    properties = registerOutput<OrganizationsOrganizationPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return OrganizationsOrganizationPropertiesResponse.fromMap(
