...
import 'aws_iam_instance_profile_properties.dart';

/// Definition of IamInstanceProfile
class IamInstanceProfileProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamInstanceProfileProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamInstanceProfileProperties].
  ...
  const IamInstanceProfileProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamInstanceProfileProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamInstanceProfileProperties.fromMap(Map<String, dynamic> map) {
    return IamInstanceProfileProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamInstanceProfileProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
