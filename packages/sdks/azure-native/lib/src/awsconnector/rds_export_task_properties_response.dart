...
import 'aws_rds_export_task_properties_response.dart';

/// Definition of RdsExportTask
class RdsExportTaskPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsExportTaskPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsExportTaskPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsExportTaskPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsExportTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsExportTaskPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsExportTaskPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
