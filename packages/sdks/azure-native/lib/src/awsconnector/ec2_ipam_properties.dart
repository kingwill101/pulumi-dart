...
import 'aws_ec2_ipam_properties.dart';

/// Definition of Ec2Ipam
class Ec2IpamProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2IpamProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2IpamProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2IpamProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2IpamProperties.fromMap(Map<String, dynamic> map) {
    return Ec2IpamProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2IpamProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
