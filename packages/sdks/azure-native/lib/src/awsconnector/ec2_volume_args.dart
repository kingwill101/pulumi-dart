...
class Ec2VolumeArgs {
  ...
  Ec2VolumeArgs({
    ...
    pulumi.Output<Ec2VolumeProperties>? properties,
  ...
  factory Ec2VolumeArgs.fromMap(Map<String, dynamic> map) {
    return Ec2VolumeArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Ec2VolumeProperties>(Ec2VolumeProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
