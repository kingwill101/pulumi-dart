...
class Ec2VolumeArgs {
  ...
  factory Ec2VolumeArgs.fromMap(Map<String, dynamic> map) {
    return Ec2VolumeArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2VolumeProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
