...
import 'aws_ec2_route_table_properties.dart';

/// Definition of Ec2RouteTable
class Ec2RouteTableProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2RouteTableProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2RouteTableProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2RouteTableProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2RouteTableProperties.fromMap(Map<String, dynamic> map) {
    return Ec2RouteTableProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2RouteTableProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
