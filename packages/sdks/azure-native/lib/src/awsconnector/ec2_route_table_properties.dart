...
class Ec2RouteTableProperties {
  ...
  /// AWS Properties
  final AwsEc2RouteTableProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2RouteTableProperties.fromMap(Map<String, dynamic> map) {
    return Ec2RouteTableProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2RouteTableProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
