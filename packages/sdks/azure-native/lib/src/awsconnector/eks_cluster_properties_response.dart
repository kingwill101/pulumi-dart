...
import 'aws_eks_cluster_properties_response.dart';

/// Definition of EksCluster
class EksClusterPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEksClusterPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EksClusterPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEksClusterPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EksClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EksClusterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEksClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
