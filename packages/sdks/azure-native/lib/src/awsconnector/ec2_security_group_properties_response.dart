...
import 'aws_ec2_security_group_properties_response.dart';

/// Definition of Ec2SecurityGroup
class Ec2SecurityGroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2SecurityGroupPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2SecurityGroupPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2SecurityGroupPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2SecurityGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2SecurityGroupPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2SecurityGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
