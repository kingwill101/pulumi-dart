...
import 'aws_logs_log_stream_properties.dart';

/// Definition of LogsLogStream
class LogsLogStreamProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLogsLogStreamProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LogsLogStreamProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsLogStreamProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsLogStreamProperties.fromMap(Map<String, dynamic> map) {
    return LogsLogStreamProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsLogStreamProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
