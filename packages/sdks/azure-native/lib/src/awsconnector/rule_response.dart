...
import 'abort_incomplete_multipart_upload_response.dart';
import 'noncurrent_version_expiration_response.dart';
import 'noncurrent_version_transition_response.dart';
import 'tag_filter_response.dart';
import 'transition_response.dart';
...
class RuleResponse {
  ...
  final pulumi.Input<AbortIncompleteMultipartUploadResponse>? abortIncompleteMultipartUpload;
  ...
  final pulumi.Input<NoncurrentVersionExpirationResponse>? noncurrentVersionExpiration;
  ...
  final pulumi.Input<NoncurrentVersionTransitionResponse>? noncurrentVersionTransition;
  /// For buckets with versioning enabled (or suspended), one or more transition rules that specify when non-current objects transition to a specified storage class. If you specify a transition and expiration time, the expiration time must be later than the transition time. If you specify this property, don't specify the ``NoncurrentVersionTransition`` property.
  final pulumi.Input<List<NoncurrentVersionTransitionResponse>>? noncurrentVersionTransitions;
  ...
  final pulumi.Input<TransitionResponse>? transition;
  /// One or more transition rules that specify when an object transitions to a specified storage class. If you specify an expiration and transition time, you must use the same time unit for both properties (either in days or by date). The expiration time must also be later than the transition time. If you specify this property, don't specify the ``Transition`` property.
  final pulumi.Input<List<TransitionResponse>>? transitions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'abortIncompleteMultipartUpload': ?pulumi.Input.mapOptionalInputValue<AbortIncompleteMultipartUploadResponse, Map<String, dynamic>>(abortIncompleteMultipartUpload, (value) => value.toMap()),
      'expirationDate': ?expirationDate,
      'expirationInDays': ?expirationInDays,
      'expiredObjectDeleteMarker': ?expiredObjectDeleteMarker,
      'id': ?id,
      'noncurrentVersionExpiration': ?pulumi.Input.mapOptionalInputValue<NoncurrentVersionExpirationResponse, Map<String, dynamic>>(noncurrentVersionExpiration, (value) => value.toMap()),
      'noncurrentVersionExpirationInDays': ?noncurrentVersionExpirationInDays,
      'noncurrentVersionTransition': ?pulumi.Input.mapOptionalInputValue<NoncurrentVersionTransitionResponse, Map<String, dynamic>>(noncurrentVersionTransition, (value) => value.toMap()),
      'noncurrentVersionTransitions': ?pulumi.Input.mapOptionalInputValue<List<NoncurrentVersionTransitionResponse>, List<Map<String, dynamic>>>(noncurrentVersionTransitions, (value) => pulumi.Input.encodeList<NoncurrentVersionTransitionResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'transition': ?pulumi.Input.mapOptionalInputValue<TransitionResponse, Map<String, dynamic>>(transition, (value) => value.toMap()),
      'transitions': ?pulumi.Input.mapOptionalInputValue<List<TransitionResponse>, List<Map<String, dynamic>>>(transitions, (value) => pulumi.Input.encodeList<TransitionResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory RuleResponse.fromMap(Map<String, dynamic> map) {
    return RuleResponse(
      abortIncompleteMultipartUpload: (() { final guardedValue = map['abortIncompleteMultipartUpload']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AbortIncompleteMultipartUploadResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      noncurrentVersionExpiration: (() { final guardedValue = map['noncurrentVersionExpiration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NoncurrentVersionExpirationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      noncurrentVersionTransition: (() { final guardedValue = map['noncurrentVersionTransition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NoncurrentVersionTransitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      noncurrentVersionTransitions: (() { final guardedValue = map['noncurrentVersionTransitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NoncurrentVersionTransitionResponse>(guardedValue, (value) => NoncurrentVersionTransitionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      transition: (() { final guardedValue = map['transition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TransitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      transitions: (() { final guardedValue = map['transitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TransitionResponse>(guardedValue, (value) => TransitionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
