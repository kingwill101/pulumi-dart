...
import 'aws_open_search_domain_status_properties_response.dart';
...
class OpenSearchDomainStatusPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsOpenSearchDomainStatusPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory OpenSearchDomainStatusPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return OpenSearchDomainStatusPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsOpenSearchDomainStatusPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
