...
class OpenSearchDomainStatusPropertiesResponse {
  ...
  /// AWS Properties
  final AwsOpenSearchDomainStatusPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory OpenSearchDomainStatusPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return OpenSearchDomainStatusPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsOpenSearchDomainStatusPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
