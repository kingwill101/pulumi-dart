...
class OpenSearchDomainStatusPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsOpenSearchDomainStatusPropertiesResponse>?
  awsProperties;
  ...
  factory OpenSearchDomainStatusPropertiesResponse.fromMap(
    ...
    return OpenSearchDomainStatusPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsOpenSearchDomainStatusPropertiesResponse.fromMap(
