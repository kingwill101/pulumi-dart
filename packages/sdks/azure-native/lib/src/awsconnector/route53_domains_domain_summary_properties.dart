...
class Route53DomainsDomainSummaryProperties {
  ...
  /// AWS Properties
  final AwsRoute53DomainsDomainSummaryProperties? awsProperties;
  /// AWS Region
  ...
  factory Route53DomainsDomainSummaryProperties.fromMap(Map<String, dynamic> map) {
    return Route53DomainsDomainSummaryProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRoute53DomainsDomainSummaryProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
