...
import 'aws_route53_domains_domain_summary_properties.dart';

/// Definition of Route53DomainsDomainSummary
class Route53DomainsDomainSummaryProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRoute53DomainsDomainSummaryProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Route53DomainsDomainSummaryProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRoute53DomainsDomainSummaryProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Route53DomainsDomainSummaryProperties.fromMap(Map<String, dynamic> map) {
    return Route53DomainsDomainSummaryProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRoute53DomainsDomainSummaryProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
