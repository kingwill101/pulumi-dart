...
import 'compute_type_enum_value.dart';
import 'environment_type_enum_value.dart';
import 'environment_variable.dart';
import 'image_pull_credentials_type_enum_value.dart';
import 'project_fleet.dart';
...
class ProjectEnvironment {
  ...
  final pulumi.Input<ComputeTypeEnumValue>? computeType;
  ...
  final pulumi.Input<ProjectFleet>? fleet;
  ...
  final pulumi.Input<ImagePullCredentialsTypeEnumValue>?
  ...
  final pulumi.Input<RegistryCredential>? registryCredential;
  ...
  final pulumi.Input<EnvironmentTypeEnumValue>? type;
  ...
  /// [environmentVariables] &lt;p&gt;A set of environment variables to make available to builds for this build project.&lt;/p&gt;
  /// [fleet] &lt;p&gt;A ProjectFleet object to use for this build project.&lt;/p&gt;
  ...
  /// [privilegedMode] &lt;p&gt;Enables running the Docker daemon inside a Docker container. Set to true only if the build project is used to build Docker images. Otherwise, a build that attempts to interact with the Docker daemon fails. The default setting is &lt;code&gt;false&lt;/code&gt;.&lt;/p&gt; &lt;p&gt;You can initialize the Docker daemon during the install phase of your build by adding one of the following sets of commands to the install phase of your buildspec file:&lt;/p&gt; &lt;p&gt;If the operating system's base image is Ubuntu Linux:&lt;/p&gt; &lt;p&gt; &lt;code&gt;- nohup /usr/local/bin/dockerd --host=unix:///var/run/docker.sock --host=tcp://0.0.0.0:2375 --storage-driver=overlay&amp;&lt;/code&gt; &lt;/p&gt; &lt;p&gt; &lt;code&gt;- timeout 15 sh -c 'until docker info; do echo .; sleep 1; done'&lt;/code&gt; &lt;/p&gt; &lt;p&gt;If the operating system's base image is Alpine Linux and the previous command does not work, add the &lt;code&gt;-t&lt;/code&gt; argument to &lt;code&gt;timeout&lt;/code&gt;:&lt;/p&gt; &lt;p&gt; &lt;code&gt;- nohup /usr/local/bin/dockerd --host=unix:///var/run/docker.sock --host=tcp://0.0.0.0:2375 --storage-driver=overlay&amp;&lt;/code&gt; &lt;/p&gt; &lt;p&gt; &lt;code&gt;- timeout -t 15 sh -c 'until docker info; do echo .; sleep 1; done'&lt;/code&gt; &lt;/p&gt;
  /// [registryCredential] &lt;p&gt; The credentials for access to a private registry.&lt;/p&gt;
    ...
    return <String, dynamic>{
      ...
      'imagePullCredentialsType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(imagePullCredentialsType, (value) => value.toMap()),
  ...
  factory ProjectEnvironment.fromMap(Map<String, dynamic> map) {
    return ProjectEnvironment(
      ...
      fleet: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProjectFleet.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      image: (() {
      ...
      imagePullCredentialsType: (() {
        final guardedValue = map['imagePullCredentialsType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImagePullCredentialsTypeEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      privilegedMode: (() {
        final guardedValue = map['privilegedMode'];
        if (guardedValue == null) return null;
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnvironmentTypeEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
