...
class Ec2SubnetPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2SubnetPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2SubnetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2SubnetPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2SubnetPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
