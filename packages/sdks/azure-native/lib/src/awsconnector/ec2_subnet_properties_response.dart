...
import 'aws_ec2_subnet_properties_response.dart';

/// Definition of Ec2Subnet
class Ec2SubnetPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2SubnetPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2SubnetPropertiesResponse].
  ...
  const Ec2SubnetPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2SubnetPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2SubnetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2SubnetPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2SubnetPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
