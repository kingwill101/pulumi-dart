...
class ProjectBuildBatchConfig {
  ...
  factory ProjectBuildBatchConfig.fromMap(Map<String, dynamic> map) {
    return ProjectBuildBatchConfig(
      batchReportMode: (() { final guardedValue = map['batchReportMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BatchReportModeTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      restrictions: (() { final guardedValue = map['restrictions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BatchRestrictions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
