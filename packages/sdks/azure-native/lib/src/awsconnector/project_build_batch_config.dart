...
class ProjectBuildBatchConfig {
  ...
  final BatchReportModeTypeEnumValue? batchReportMode;
  ...
  factory ProjectBuildBatchConfig.fromMap(Map<String, dynamic> map) {
    return ProjectBuildBatchConfig(
      batchReportMode: map['batchReportMode'] == null ? null : BatchReportModeTypeEnumValue.fromMap((map['batchReportMode'] as Map).cast<String, dynamic>()),
      combineArtifacts: map['combineArtifacts'] == null ? null : map['combineArtifacts'] as bool,
      restrictions: map['restrictions'] == null ? null : BatchRestrictions.fromMap((map['restrictions'] as Map).cast<String, dynamic>()),
