...
class ClusterStateChangeReasonResponse {
  ...
  const ClusterStateChangeReasonResponse({
    this.code,
    this.message,
  });
  ...
  factory ClusterStateChangeReasonResponse.fromMap(Map<String, dynamic> map) {
    return ClusterStateChangeReasonResponse(
      code: (() { final guardedValue = map['code']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterStateChangeReasonCodeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
