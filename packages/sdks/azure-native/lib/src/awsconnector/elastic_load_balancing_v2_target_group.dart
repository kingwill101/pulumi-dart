...
class ElasticLoadBalancingV2TargetGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ElasticLoadBalancingV2TargetGroupPropertiesResponse>
  properties;
  ...
  ElasticLoadBalancingV2TargetGroup(
    ...
    properties =
        registerOutput<ElasticLoadBalancingV2TargetGroupPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return ElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap(
