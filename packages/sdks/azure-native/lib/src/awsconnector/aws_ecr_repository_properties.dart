...
import 'image_scanning_configuration.dart';
import 'lifecycle_policy.dart';
import 'tag.dart';

/// Definition of awsEcrRepository
class AwsEcrRepositoryProperties {
  /// Property arn
  ...
  final pulumi.Input<ImageScanningConfiguration?>? imageScanningConfiguration;
  /// The tag mutability setting for the repository. If this parameter is omitted, the default setting of ``MUTABLE`` will be used which will allow image tags to be overwritten. If ``IMMUTABLE`` is specified, all image tags within the repository will be immutable which will prevent them from being overwritten.
  final pulumi.Input<dynamic>? imageTagMutability;
  ...
  /// Creates a new [AwsEcrRepositoryProperties].
  /// [arn] Property arn
  ...
  const AwsEcrRepositoryProperties({
    this.arn,
    this.emptyOnDelete,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'imageScanningConfiguration': ?pulumi.Input.mapOptionalInputValue<ImageScanningConfiguration, Map<String, dynamic>>(imageScanningConfiguration, (value) => value.toMap()),
  ...
  factory AwsEcrRepositoryProperties.fromMap(Map<String, dynamic> map) {
    return AwsEcrRepositoryProperties(
      ...
      imageScanningConfiguration: (() { final guardedValue = map['imageScanningConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageScanningConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageTagMutability: (() { final guardedValue = map['imageTagMutability']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
