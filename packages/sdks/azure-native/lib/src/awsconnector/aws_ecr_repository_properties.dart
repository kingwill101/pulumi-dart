...
class AwsEcrRepositoryProperties {
    ...
    return <String, dynamic>{
      ...
      'lifecyclePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            LifecyclePolicy,
            Map<String, dynamic>
          >(lifecyclePolicy, (value) => value.toMap()),
  ...
  factory AwsEcrRepositoryProperties.fromMap(Map<String, dynamic> map) {
    return AwsEcrRepositoryProperties(
      ...
      emptyOnDelete: (() {
        final guardedValue = map['emptyOnDelete'];
        if (guardedValue == null) return null;
      ...
      imageScanningConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageScanningConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      imageTagMutability: (() {
        final guardedValue = map['imageTagMutability'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lifecyclePolicy: (() {
        final guardedValue = map['lifecyclePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      repositoryPolicyText: (() {
        final guardedValue = map['repositoryPolicyText'];
        if (guardedValue == null) return null;
