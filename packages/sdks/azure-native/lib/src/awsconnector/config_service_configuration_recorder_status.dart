...
class ConfigServiceConfigurationRecorderStatus extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ConfigServiceConfigurationRecorderStatus] resource.
  ConfigServiceConfigurationRecorderStatus.reference(String urn)
    : super(
        'azure-native:awsconnector:ConfigServiceConfigurationRecorderStatus',
