...
import 'aws_iam_access_key_last_used_properties.dart';

/// Definition of IamAccessKeyLastUsed
class IamAccessKeyLastUsedProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamAccessKeyLastUsedProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamAccessKeyLastUsedProperties].
  ...
  const IamAccessKeyLastUsedProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamAccessKeyLastUsedProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamAccessKeyLastUsedProperties.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyLastUsedProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamAccessKeyLastUsedProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
