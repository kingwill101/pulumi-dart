...
class IamAccessKeyLastUsedProperties {
  ...
  /// AWS Properties
  final AwsIamAccessKeyLastUsedProperties? awsProperties;
  /// AWS Region
  ...
  factory IamAccessKeyLastUsedProperties.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyLastUsedProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamAccessKeyLastUsedProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
