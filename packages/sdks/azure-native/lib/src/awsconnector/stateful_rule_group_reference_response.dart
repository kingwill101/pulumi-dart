...
class StatefulRuleGroupReferenceResponse {
  ...
  const StatefulRuleGroupReferenceResponse({
    this.override,
    this.priority,
    this.resourceArn,
  });
  ...
  factory StatefulRuleGroupReferenceResponse.fromMap(Map<String, dynamic> map) {
    return StatefulRuleGroupReferenceResponse(
      override: (() { final guardedValue = map['override']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StatefulRuleGroupOverrideResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
