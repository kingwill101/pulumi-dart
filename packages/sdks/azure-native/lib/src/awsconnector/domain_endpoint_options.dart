...
class DomainEndpointOptions {
  ...
  factory DomainEndpointOptions.fromMap(Map<String, dynamic> map) {
    return DomainEndpointOptions(
      ...
      tlsSecurityPolicy: (() { final guardedValue = map['tlsSecurityPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TLSSecurityPolicyEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
