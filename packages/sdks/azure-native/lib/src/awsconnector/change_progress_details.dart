...
class ChangeProgressDetails {
  ...
  factory ChangeProgressDetails.fromMap(Map<String, dynamic> map) {
    return ChangeProgressDetails(
      ...
      configChangeStatus: (() { final guardedValue = map['configChangeStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigChangeStatusEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      initiatedBy: (() { final guardedValue = map['initiatedBy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InitiatedByEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
