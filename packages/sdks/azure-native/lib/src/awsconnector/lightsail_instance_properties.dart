...
import 'aws_lightsail_instance_properties.dart';

/// Definition of LightsailInstance
class LightsailInstanceProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLightsailInstanceProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LightsailInstanceProperties].
  ...
  const LightsailInstanceProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLightsailInstanceProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LightsailInstanceProperties.fromMap(Map<String, dynamic> map) {
    return LightsailInstanceProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLightsailInstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
