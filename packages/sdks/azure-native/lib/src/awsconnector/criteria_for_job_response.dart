...
class CriteriaForJobResponse {
  ...
  factory CriteriaForJobResponse.fromMap(Map<String, dynamic> map) {
    return CriteriaForJobResponse(
      simpleCriterion: (() { final guardedValue = map['simpleCriterion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SimpleCriterionForJobResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tagCriterion: (() { final guardedValue = map['tagCriterion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TagCriterionForJobResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
