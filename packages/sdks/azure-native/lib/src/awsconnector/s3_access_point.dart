...
/// }
///
/// resource "azure-native_awsconnector_s3accesspoint" "s3AccessPoint" {
///   location = "azmnzomeh"
///   name     = "Replace this value with a string matching RegExp ^(z=.{0,259}[^zs.]$)(z!.*[zzzzzzzz])"
///   properties = {
///     arn            = "dputejthukqrofpuygrkatazvamcge"
...
class S3AccessPoint extends pulumi.CustomResource {
  ...
  S3AccessPoint(
    ...
    properties = registerOutput<S3AccessPointPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return S3AccessPointPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [S3AccessPoint] resource.
  S3AccessPoint.reference(String urn)
    : super(
        'azure-native:awsconnector:S3AccessPoint',
