...
class FirewallPolicyResponse {
  ...
  final pulumi.Input<List<StatefulRuleGroupReferenceResponse>>?
  ...
  final pulumi.Input<List<StatelessRuleGroupReferenceResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'statefulRuleGroupReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatefulRuleGroupReferenceResponse>,
      ...
      'statelessRuleGroupReferences':
          ?pulumi.Input.mapOptionalInputValue<
            List<StatelessRuleGroupReferenceResponse>,
            List<Map<String, dynamic>>
          >(
            statelessRuleGroupReferences,
            (value) =>
    ...
    return FirewallPolicyResponse(
      policyVariables: (() {
        ...
        return pulumi.Input.fromValue(
          RuleVariablesModelResponse.fromMap(
      ...
      statefulEngineOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StatefulEngineOptionsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      statefulRuleGroupReferences: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatefulRuleGroupReferenceResponse>(
            guardedValue,
            (value) => StatefulRuleGroupReferenceResponse.fromMap(
      ...
      statelessCustomActions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomActionResponse>(
            guardedValue,
            (value) => CustomActionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      statelessRuleGroupReferences: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatelessRuleGroupReferenceResponse>(
            guardedValue,
            (value) => StatelessRuleGroupReferenceResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
