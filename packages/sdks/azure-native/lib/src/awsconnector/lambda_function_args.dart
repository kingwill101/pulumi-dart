...
class LambdaFunctionArgs {
  ...
  factory LambdaFunctionArgs.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LambdaFunctionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
