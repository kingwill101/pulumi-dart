...
class LambdaFunctionArgs {
  ...
  LambdaFunctionArgs({
    ...
    pulumi.Output<LambdaFunctionProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<LambdaFunctionProperties>(properties),
  ...
  factory LambdaFunctionArgs.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<LambdaFunctionProperties>(LambdaFunctionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
