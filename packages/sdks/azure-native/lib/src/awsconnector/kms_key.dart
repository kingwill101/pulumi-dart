...
class KmsKey extends pulumi.CustomResource {
  ...
  KmsKey(String name, {KmsKeyArgs? args, pulumi.CustomResourceOptions? options})
    : super(
    ...
    properties = registerOutput<KmsKeyPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return KmsKeyPropertiesResponse.fromMap(
