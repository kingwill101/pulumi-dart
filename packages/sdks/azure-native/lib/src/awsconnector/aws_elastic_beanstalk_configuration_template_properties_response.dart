...
class AwsElasticBeanstalkConfigurationTemplatePropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'optionSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ConfigurationOptionSettingResponse>,
  ...
  factory AwsElasticBeanstalkConfigurationTemplatePropertiesResponse.fromMap(
    ...
    return AwsElasticBeanstalkConfigurationTemplatePropertiesResponse(
      ...
      optionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConfigurationOptionSettingResponse>(
            guardedValue,
            (value) => ConfigurationOptionSettingResponse.fromMap(
      ...
      sourceConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourceConfigurationResponse.fromMap(
