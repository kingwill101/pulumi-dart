...
import 'configuration_option_setting_response.dart';
...
class AwsElasticBeanstalkConfigurationTemplatePropertiesResponse {
  ...
  const AwsElasticBeanstalkConfigurationTemplatePropertiesResponse({
  ...
  factory AwsElasticBeanstalkConfigurationTemplatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsElasticBeanstalkConfigurationTemplatePropertiesResponse(
      ...
      optionSettings: (() { final guardedValue = map['optionSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConfigurationOptionSettingResponse>(guardedValue, (value) => ConfigurationOptionSettingResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sourceConfiguration: (() { final guardedValue = map['sourceConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
