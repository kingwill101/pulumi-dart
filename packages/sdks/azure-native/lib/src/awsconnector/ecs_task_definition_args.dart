...
class EcsTaskDefinitionArgs {
  ...
  factory EcsTaskDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return EcsTaskDefinitionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EcsTaskDefinitionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
