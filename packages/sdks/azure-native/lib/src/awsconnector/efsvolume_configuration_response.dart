...
class EFSVolumeConfigurationResponse {
  ...
  /// Creates a new [EFSVolumeConfigurationResponse].
  ...
  const EFSVolumeConfigurationResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authorizationConfig': ?pulumi.Input.mapOptionalInputValue<AuthorizationConfigResponse, Map<String, dynamic>>(authorizationConfig, (value) => value.toMap()),
  ...
  factory EFSVolumeConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return EFSVolumeConfigurationResponse(
      authorizationConfig: (() { final guardedValue = map['authorizationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuthorizationConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
