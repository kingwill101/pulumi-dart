...
import 'build_status_config_response.dart';
import 'git_submodules_config_response.dart';
import 'source_auth_response.dart';
import 'source_type_enum_value_response.dart';

/// Definition of ProjectSource
class ProjectSourceResponse {
  ...
  final pulumi.Input<SourceAuthResponse>? auth;
  ...
  final pulumi.Input<BuildStatusConfigResponse>? buildStatusConfig;
  ...
  final pulumi.Input<GitSubmodulesConfigResponse>? gitSubmodulesConfig;
  ...
  final pulumi.Input<SourceTypeEnumValueResponse>? type;

  /// Creates a new [ProjectSourceResponse].
  /// [auth] &lt;p&gt;Information about the authorization settings for CodeBuild to access the source code to be built.&lt;/p&gt; &lt;p&gt;This information is for the CodeBuild console's use only. Your code should not get or set this information directly.&lt;/p&gt;
  /// [buildStatusConfig] &lt;p&gt;Contains information that defines how the build project reports the build status to the source provider. This option is only used when the source provider is &lt;code&gt;GITHUB&lt;/code&gt;, &lt;code&gt;GITHUB_ENTERPRISE&lt;/code&gt;, or &lt;code&gt;BITBUCKET&lt;/code&gt;.&lt;/p&gt;
  ...
  /// [gitCloneDepth] &lt;p&gt;Information about the Git clone depth for the build project.&lt;/p&gt;
  /// [gitSubmodulesConfig] &lt;p&gt; Information about the Git submodules configuration for the build project. &lt;/p&gt;
  /// [insecureSsl] &lt;p&gt;Enable this flag to ignore SSL warnings while connecting to the project source code.&lt;/p&gt;
  ...
  /// [sourceIdentifier] &lt;p&gt;An identifier for this project source. The identifier can only contain alphanumeric characters and underscores, and must be less than 128 characters in length. &lt;/p&gt;
  ...
  factory ProjectSourceResponse.fromMap(Map<String, dynamic> map) {
    return ProjectSourceResponse(
      ...
      buildStatusConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BuildStatusConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      gitSubmodulesConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GitSubmodulesConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
