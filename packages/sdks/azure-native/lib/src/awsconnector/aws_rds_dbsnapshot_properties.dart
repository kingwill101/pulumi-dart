...
class AwsRdsDBSnapshotProperties {
  ...
  /// Property tagList
  final pulumi.Input<List<Tag>?>? tagList;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': ?port,
      'processorFeatures': ?pulumi.Input.mapOptionalInputValue<List<ProcessorFeature>, List<Map<String, dynamic>>>(processorFeatures, (value) => pulumi.Input.encodeList<ProcessorFeature, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'tagList': ?pulumi.Input.mapOptionalInputValue<List<Tag>, List<Map<String, dynamic>>>(tagList, (value) => pulumi.Input.encodeList<Tag, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AwsRdsDBSnapshotProperties.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBSnapshotProperties(
      ...
      processorFeatures: (() { final guardedValue = map['processorFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProcessorFeature>(guardedValue, (value) => ProcessorFeature.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tagList: (() { final guardedValue = map['tagList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Tag>(guardedValue, (value) => Tag.fromMap((value as Map).cast<String, dynamic>()))); })(),
