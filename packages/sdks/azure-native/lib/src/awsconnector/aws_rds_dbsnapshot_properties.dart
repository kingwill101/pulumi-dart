...
class AwsRdsDBSnapshotProperties {
  ...
  factory AwsRdsDBSnapshotProperties.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBSnapshotProperties(
      ...
      processorFeatures: map['processorFeatures'] == null ? null : (pulumi.Input.decodeList<ProcessorFeature>(map['processorFeatures']!, (value) => ProcessorFeature.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      tagList: map['tagList'] == null ? null : (pulumi.Input.decodeList<Tag>(map['tagList']!, (value) => Tag.fromMap((value as Map).cast<String, dynamic>()))).input(),
