...
class ProjectFileSystemLocationResponse {
  ...
  const ProjectFileSystemLocationResponse({
    this.identifier,
    this.location,
    this.mountOptions,
    this.mountPoint,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'type': ?pulumi.Input.mapOptionalInputValue<FileSystemTypeEnumValueResponse, Map<String, dynamic>>(type, (value) => value.toMap()),
    };
  }
  ...
  factory ProjectFileSystemLocationResponse.fromMap(Map<String, dynamic> map) {
    return ProjectFileSystemLocationResponse(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileSystemTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
