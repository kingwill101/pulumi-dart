...
import 'aws_logs_subscription_filter_properties.dart';

/// Definition of LogsSubscriptionFilter
class LogsSubscriptionFilterProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLogsSubscriptionFilterProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LogsSubscriptionFilterProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsSubscriptionFilterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsSubscriptionFilterProperties.fromMap(Map<String, dynamic> map) {
    return LogsSubscriptionFilterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsSubscriptionFilterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
