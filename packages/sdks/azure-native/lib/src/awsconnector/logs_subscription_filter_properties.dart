...
class LogsSubscriptionFilterProperties {
  ...
  /// AWS Properties
  final AwsLogsSubscriptionFilterProperties? awsProperties;
  /// AWS Region
  ...
  factory LogsSubscriptionFilterProperties.fromMap(Map<String, dynamic> map) {
    return LogsSubscriptionFilterProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLogsSubscriptionFilterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
