...
class AwsCloudFormationStackSetProperties {
    ...
    return <String, dynamic>{
      ...
      'stackInstancesGroup':
          ...
          >(
            stackInstancesGroup,
            (value) =>
                pulumi.Input.encodeList<StackInstances, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsCloudFormationStackSetProperties.fromMap(
    ...
    return AwsCloudFormationStackSetProperties(
      ...
      autoDeployment: (() {
        ...
        return pulumi.Input.fromValue(
          AutoDeployment.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      callAs: (() {
      ...
      managedExecution: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ActiveModel.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      operationPreferences: (() {
      ...
      stackInstancesGroup: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackInstances>(
            guardedValue,
            (value) =>
                StackInstances.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      stackSetId: (() {
