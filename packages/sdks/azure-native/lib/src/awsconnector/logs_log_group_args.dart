...
class LogsLogGroupArgs {
  ...
  factory LogsLogGroupArgs.fromMap(Map<String, dynamic> map) {
    return LogsLogGroupArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogsLogGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
