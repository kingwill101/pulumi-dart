...
class EcsServiceArgs {
  ...
  EcsServiceArgs({
    ...
    pulumi.Output<EcsServiceProperties>? properties,
  ...
  factory EcsServiceArgs.fromMap(Map<String, dynamic> map) {
    return EcsServiceArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<EcsServiceProperties>(EcsServiceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
