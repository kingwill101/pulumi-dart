...
class EcsServiceArgs {
  ...
  factory EcsServiceArgs.fromMap(Map<String, dynamic> map) {
    return EcsServiceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EcsServiceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
