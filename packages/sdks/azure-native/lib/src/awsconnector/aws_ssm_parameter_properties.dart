...
class AwsSsmParameterProperties {
  ...
  /// Creates a new [AwsSsmParameterProperties].
  ...
  const AwsSsmParameterProperties({
    this.allowedPattern,
    this.dataType,
    this.description,
    this.name,
  ...
  factory AwsSsmParameterProperties.fromMap(Map<String, dynamic> map) {
    return AwsSsmParameterProperties(
