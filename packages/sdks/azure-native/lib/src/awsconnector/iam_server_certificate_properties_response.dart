...
import 'aws_iam_server_certificate_properties_response.dart';

/// Definition of IamServerCertificate
class IamServerCertificatePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamServerCertificatePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamServerCertificatePropertiesResponse].
  ...
  const IamServerCertificatePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamServerCertificatePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamServerCertificatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamServerCertificatePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamServerCertificatePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
