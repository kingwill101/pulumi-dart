...
class IamServerCertificatePropertiesResponse {
  ...
  /// AWS Properties
  final AwsIamServerCertificatePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory IamServerCertificatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamServerCertificatePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamServerCertificatePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
