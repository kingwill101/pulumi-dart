...
import 'aws_rds_dbinstance_properties.dart';

/// Definition of RdsDBInstance
class RdsDBInstanceProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsDBInstanceProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsDBInstanceProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsDBInstanceProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsDBInstanceProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBInstanceProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBInstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
