...
class Ec2InstanceStatusArgs {
  ...
  Ec2InstanceStatusArgs({
    ...
    pulumi.Output<Ec2InstanceStatusProperties>? properties,
  ...
  factory Ec2InstanceStatusArgs.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceStatusArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Ec2InstanceStatusProperties>(Ec2InstanceStatusProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
