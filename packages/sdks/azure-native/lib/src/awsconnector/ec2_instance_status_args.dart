...
class Ec2InstanceStatusArgs {
  ...
  factory Ec2InstanceStatusArgs.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceStatusArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2InstanceStatusProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
