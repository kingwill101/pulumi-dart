...
class NetworkFirewallFirewall extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NetworkFirewallFirewallPropertiesResponse>
  properties;
  ...
  NetworkFirewallFirewall(
    ...
    properties = registerOutput<NetworkFirewallFirewallPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return NetworkFirewallFirewallPropertiesResponse.fromMap(
