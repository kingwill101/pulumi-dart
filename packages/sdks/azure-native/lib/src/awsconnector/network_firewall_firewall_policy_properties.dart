...
class NetworkFirewallFirewallPolicyProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsNetworkFirewallFirewallPolicyProperties>? awsProperties;
  /// AWS Region
  ...
  const NetworkFirewallFirewallPolicyProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsNetworkFirewallFirewallPolicyProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory NetworkFirewallFirewallPolicyProperties.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallFirewallPolicyProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsNetworkFirewallFirewallPolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
