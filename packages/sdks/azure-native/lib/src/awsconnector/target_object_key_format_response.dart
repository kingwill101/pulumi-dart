...
class TargetObjectKeyFormatResponse {
  ...
  const TargetObjectKeyFormatResponse({
  ...
  factory TargetObjectKeyFormatResponse.fromMap(Map<String, dynamic> map) {
    return TargetObjectKeyFormatResponse(
      partitionedPrefix: (() { final guardedValue = map['partitionedPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PartitionedPrefixResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
