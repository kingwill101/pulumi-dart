...
class TargetObjectKeyFormatResponse {
  ...
  TargetObjectKeyFormatResponse({this.partitionedPrefix, this.simplePrefix});
    ...
    return <String, dynamic>{
      'partitionedPrefix':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(partitionedPrefix, (value) => value.toMap()),
  ...
  factory TargetObjectKeyFormatResponse.fromMap(Map<String, dynamic> map) {
    return TargetObjectKeyFormatResponse(
      partitionedPrefix: (() {
        final guardedValue = map['partitionedPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PartitionedPrefixResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      simplePrefix: (() {
        final guardedValue = map['simplePrefix'];
        if (guardedValue == null) return null;
