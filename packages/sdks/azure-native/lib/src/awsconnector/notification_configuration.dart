    ...
    return NotificationConfiguration(
      eventBridgeConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          EventBridgeConfiguration.fromMap(
      ...
      lambdaConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LambdaConfiguration>(
            guardedValue,
            (value) => LambdaConfiguration.fromMap(
      ...
      queueConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<QueueConfiguration>(
            guardedValue,
            (value) => QueueConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      topicConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TopicConfiguration>(
            guardedValue,
            (value) => TopicConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
