...
class AwsEc2AccountAttributeProperties {
  ...
  AwsEc2AccountAttributeProperties({this.attributeName, this.attributeValues});
    ...
    return AwsEc2AccountAttributeProperties(
      ...
      attributeValues: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccountAttributeValue>(
            guardedValue,
            (value) => AccountAttributeValue.fromMap(
