...
class Ec2NetworkInterfaceArgs {
  ...
  factory Ec2NetworkInterfaceArgs.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkInterfaceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2NetworkInterfaceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
