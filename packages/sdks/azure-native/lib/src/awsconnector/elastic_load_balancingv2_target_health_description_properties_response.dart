...
class ElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
