...
import 'certificate_status_enum_value.dart';
import 'certificate_type_enum_value.dart';
import 'key_algorithm_enum_value.dart';
import 'renewal_eligibility_enum_value.dart';

/// Definition of awsAcmCertificateSummary
class AwsAcmCertificateSummaryProperties {
  ...
  final pulumi.Input<List<dynamic>?>? extendedKeyUsages;
  ...
  final pulumi.Input<KeyAlgorithmEnumValue?>? keyAlgorithm;
  ...
  final pulumi.Input<List<dynamic>?>? keyUsages;
  ...
  final pulumi.Input<RenewalEligibilityEnumValue?>? renewalEligibility;
  ...
  final pulumi.Input<CertificateStatusEnumValue?>? status;
  ...
  final pulumi.Input<CertificateTypeEnumValue?>? type;

  /// Creates a new [AwsAcmCertificateSummaryProperties].
  ...
  const AwsAcmCertificateSummaryProperties({
    this.certificateArn,
    this.createdAt,
    this.domainName,
    this.exported,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inUse': ?inUse,
      'issuedAt': ?issuedAt,
      'keyAlgorithm': ?pulumi.Input.mapOptionalInputValue<KeyAlgorithmEnumValue, Map<String, dynamic>>(keyAlgorithm, (value) => value.toMap()),
      'keyUsages': ?keyUsages,
      'notAfter': ?notAfter,
      'notBefore': ?notBefore,
      'renewalEligibility': ?pulumi.Input.mapOptionalInputValue<RenewalEligibilityEnumValue, Map<String, dynamic>>(renewalEligibility, (value) => value.toMap()),
      'revokedAt': ?revokedAt,
      'status': ?pulumi.Input.mapOptionalInputValue<CertificateStatusEnumValue, Map<String, dynamic>>(status, (value) => value.toMap()),
      'subjectAlternativeNameSummaries': ?subjectAlternativeNameSummaries,
      'type': ?pulumi.Input.mapOptionalInputValue<CertificateTypeEnumValue, Map<String, dynamic>>(type, (value) => value.toMap()),
    };
  }

  factory AwsAcmCertificateSummaryProperties.fromMap(Map<String, dynamic> map) {
    return AwsAcmCertificateSummaryProperties(
      ...
      extendedKeyUsages: (() { final guardedValue = map['extendedKeyUsages']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      ...
      keyAlgorithm: (() { final guardedValue = map['keyAlgorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KeyAlgorithmEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      keyUsages: (() { final guardedValue = map['keyUsages']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      ...
      renewalEligibility: (() { final guardedValue = map['renewalEligibility']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RenewalEligibilityEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateStatusEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
