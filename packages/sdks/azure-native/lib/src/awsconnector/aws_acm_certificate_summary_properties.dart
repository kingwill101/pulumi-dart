...
class AwsAcmCertificateSummaryProperties {
  ...
  factory AwsAcmCertificateSummaryProperties.fromMap(Map<String, dynamic> map) {
    return AwsAcmCertificateSummaryProperties(
      ...
      keyAlgorithm: map['keyAlgorithm'] == null ? null : (KeyAlgorithmEnumValue.fromMap((map['keyAlgorithm'] as Map).cast<String, dynamic>())).input(),
      ...
      renewalEligibility: map['renewalEligibility'] == null ? null : (RenewalEligibilityEnumValue.fromMap((map['renewalEligibility'] as Map).cast<String, dynamic>())).input(),
      revokedAt: map['revokedAt'] == null ? null : (map['revokedAt'] as String).input(),
      status: map['status'] == null ? null : (CertificateStatusEnumValue.fromMap((map['status'] as Map).cast<String, dynamic>())).input(),
      ...
      type: map['type'] == null ? null : (CertificateTypeEnumValue.fromMap((map['type'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
