...
import 'deployment_status_enum_value.dart';
...
class ServiceSoftwareOptions {
  ...
  final pulumi.Input<DeploymentStatusEnumValue>? updateStatus;

  /// Creates a new [ServiceSoftwareOptions].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'updateStatus': ?pulumi.Input.mapOptionalInputValue<DeploymentStatusEnumValue, Map<String, dynamic>>(updateStatus, (value) => value.toMap()),
    };
  }
  ...
  factory ServiceSoftwareOptions.fromMap(Map<String, dynamic> map) {
    return ServiceSoftwareOptions(
      ...
      updateStatus: (() { final guardedValue = map['updateStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentStatusEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
