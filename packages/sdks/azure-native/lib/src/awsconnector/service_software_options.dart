...
class ServiceSoftwareOptions {
  ...
  final DeploymentStatusEnumValue? updateStatus;
  ...
  factory ServiceSoftwareOptions.fromMap(Map<String, dynamic> map) {
    return ServiceSoftwareOptions(
      ...
      updateStatus: map['updateStatus'] == null ? null : DeploymentStatusEnumValue.fromMap((map['updateStatus'] as Map).cast<String, dynamic>()),
    );
  }
}
