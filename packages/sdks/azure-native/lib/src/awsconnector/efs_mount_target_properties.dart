...
import 'aws_efs_mount_target_properties.dart';

/// Definition of EfsMountTarget
class EfsMountTargetProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEfsMountTargetProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EfsMountTargetProperties].
  ...
  const EfsMountTargetProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEfsMountTargetProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EfsMountTargetProperties.fromMap(Map<String, dynamic> map) {
    return EfsMountTargetProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEfsMountTargetProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
