...
import 'aws_ec2_instance_status_properties_response.dart';

/// Definition of Ec2InstanceStatus
class Ec2InstanceStatusPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2InstanceStatusPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2InstanceStatusPropertiesResponse].
  ...
  const Ec2InstanceStatusPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2InstanceStatusPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2InstanceStatusPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceStatusPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2InstanceStatusPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
