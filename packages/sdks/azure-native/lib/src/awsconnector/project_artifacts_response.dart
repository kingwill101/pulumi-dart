    ...
    return ProjectArtifactsResponse(
      ...
      bucketOwnerAccess: (() {
        ...
        return pulumi.Input.fromValue(
          BucketOwnerAccessEnumValueResponse.fromMap(
      ...
      namespaceType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ArtifactNamespaceEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      packaging: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ArtifactPackagingEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ArtifactsTypeEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
