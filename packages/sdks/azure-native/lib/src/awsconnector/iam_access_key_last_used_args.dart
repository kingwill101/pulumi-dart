...
class IamAccessKeyLastUsedArgs {
  ...
  IamAccessKeyLastUsedArgs({
    ...
    pulumi.Output<IamAccessKeyLastUsedProperties>? properties,
  ...
  factory IamAccessKeyLastUsedArgs.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyLastUsedArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<IamAccessKeyLastUsedProperties>(IamAccessKeyLastUsedProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
