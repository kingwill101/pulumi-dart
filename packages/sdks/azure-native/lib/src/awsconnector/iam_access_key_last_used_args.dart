...
class IamAccessKeyLastUsedArgs {
  ...
  /// [tags] Resource tags.
  const IamAccessKeyLastUsedArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory IamAccessKeyLastUsedArgs.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyLastUsedArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamAccessKeyLastUsedProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
