...
class LaunchTemplate {
  ...
  factory LaunchTemplate.fromMap(Map<String, dynamic> map) {
    return LaunchTemplate(
      launchTemplateSpecification: (() { final guardedValue = map['launchTemplateSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LaunchTemplateSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      overrides: (() { final guardedValue = map['overrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LaunchTemplateOverrides>(guardedValue, (value) => LaunchTemplateOverrides.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
