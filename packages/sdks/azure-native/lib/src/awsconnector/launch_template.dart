...
class LaunchTemplate {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'overrides': ?overrides == null ? null : pulumi.Input.encodeList<LaunchTemplateOverrides, Map<String, dynamic>>(overrides!, (value) => value.toMap()),
    };
  }

  factory LaunchTemplate.fromMap(Map<String, dynamic> map) {
    return LaunchTemplate(
      launchTemplateSpecification: map['launchTemplateSpecification'] == null ? null : LaunchTemplateSpecification.fromMap((map['launchTemplateSpecification'] as Map).cast<String, dynamic>()),
      overrides: map['overrides'] == null ? null : pulumi.Input.decodeList<LaunchTemplateOverrides>(map['overrides'], (value) => LaunchTemplateOverrides.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
