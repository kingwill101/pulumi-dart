...
class LogsSubscriptionFilterPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsLogsSubscriptionFilterPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsSubscriptionFilterPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsSubscriptionFilterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LogsSubscriptionFilterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsSubscriptionFilterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
