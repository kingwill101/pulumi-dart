...
class LogsSubscriptionFilterPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsLogsSubscriptionFilterPropertiesResponse>?
  awsProperties;
  ...
  factory LogsSubscriptionFilterPropertiesResponse.fromMap(
    ...
    return LogsSubscriptionFilterPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsLogsSubscriptionFilterPropertiesResponse.fromMap(
