...
class RdsEventSubscriptionArgs {
  ...
  RdsEventSubscriptionArgs({
    ...
    pulumi.Output<RdsEventSubscriptionProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<RdsEventSubscriptionProperties>(properties),
  ...
  factory RdsEventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return RdsEventSubscriptionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<RdsEventSubscriptionProperties>(RdsEventSubscriptionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
