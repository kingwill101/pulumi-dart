...
class NetworkFirewallFirewallPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsNetworkFirewallFirewallPropertiesResponse>?
  awsProperties;
  ...
  factory NetworkFirewallFirewallPropertiesResponse.fromMap(
    ...
    return NetworkFirewallFirewallPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsNetworkFirewallFirewallPropertiesResponse.fromMap(
