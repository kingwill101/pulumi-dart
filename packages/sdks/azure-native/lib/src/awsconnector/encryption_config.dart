...
class EncryptionConfig {
  ...
  EncryptionConfig({this.provider, this.resources});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'provider':
          ?pulumi.Input.mapOptionalInputValue<Provider, Map<String, dynamic>>(
            provider,
            (value) => value.toMap(),
          ),
      'resources': ?resources,
    ...
    return EncryptionConfig(
      provider: (() {
        ...
        return pulumi.Input.fromValue(
          Provider.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      resources: (() {
