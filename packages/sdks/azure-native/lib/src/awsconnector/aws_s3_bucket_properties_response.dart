...
class AwsS3BucketPropertiesResponse {
  ...
  final AccelerateConfigurationResponse? accelerateConfiguration;
  ...
  final List<AnalyticsConfigurationResponse>? analyticsConfigurations;
  ...
  final BucketEncryptionResponse? bucketEncryption;
  ...
  final List<IntelligentTieringConfigurationResponse>? intelligentTieringConfigurations;
  /// Specifies the inventory configuration for an Amazon S3 bucket. For more information, see [GET Bucket inventory](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketGETInventoryConfig.html) in the *Amazon S3 API Reference*.
  final List<InventoryConfigurationResponse>? inventoryConfigurations;
  ...
  final LoggingConfigurationResponse? loggingConfiguration;
  /// Specifies a metrics configuration for the CloudWatch request metrics (specified by the metrics configuration ID) from an Amazon S3 bucket. If you're updating an existing metrics configuration, note that this is a full replacement of the existing metrics configuration. If you don't include the elements you want to keep, they are erased. For more information, see [PutBucketMetricsConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTMetricConfiguration.html).
  final List<MetricsConfigurationResponse>? metricsConfigurations;
  ...
  final NotificationConfigurationResponse? notificationConfiguration;
  ...
  final ObjectLockConfigurationResponse? objectLockConfiguration;
  ...
  final OwnershipControlsResponse? ownershipControls;
  ...
  final ReplicationConfigurationResponse? replicationConfiguration;
  ...
  final VersioningConfigurationResponse? versioningConfiguration;
  ...
  final WebsiteConfigurationResponse? websiteConfiguration;
  /// Property websiteURL
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'analyticsConfigurations': ?analyticsConfigurations == null ? null : pulumi.Input.encodeList<AnalyticsConfigurationResponse, Map<String, dynamic>>(analyticsConfigurations!, (value) => value.toMap()),
      'arn': ?arn,
      ...
      'intelligentTieringConfigurations': ?intelligentTieringConfigurations == null ? null : pulumi.Input.encodeList<IntelligentTieringConfigurationResponse, Map<String, dynamic>>(intelligentTieringConfigurations!, (value) => value.toMap()),
      'inventoryConfigurations': ?inventoryConfigurations == null ? null : pulumi.Input.encodeList<InventoryConfigurationResponse, Map<String, dynamic>>(inventoryConfigurations!, (value) => value.toMap()),
      ...
      'metricsConfigurations': ?metricsConfigurations == null ? null : pulumi.Input.encodeList<MetricsConfigurationResponse, Map<String, dynamic>>(metricsConfigurations!, (value) => value.toMap()),
  ...
  factory AwsS3BucketPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsS3BucketPropertiesResponse(
      accelerateConfiguration: map['accelerateConfiguration'] == null ? null : AccelerateConfigurationResponse.fromMap((map['accelerateConfiguration'] as Map).cast<String, dynamic>()),
      accessControl: map['accessControl'] == null ? null : map['accessControl'] as String,
      analyticsConfigurations: map['analyticsConfigurations'] == null ? null : pulumi.Input.decodeList<AnalyticsConfigurationResponse>(map['analyticsConfigurations'], (value) => AnalyticsConfigurationResponse.fromMap((value as Map).cast<String, dynamic>())),
      arn: map['arn'] == null ? null : map['arn'] as String,
      bucketEncryption: map['bucketEncryption'] == null ? null : BucketEncryptionResponse.fromMap((map['bucketEncryption'] as Map).cast<String, dynamic>()),
      ...
      intelligentTieringConfigurations: map['intelligentTieringConfigurations'] == null ? null : pulumi.Input.decodeList<IntelligentTieringConfigurationResponse>(map['intelligentTieringConfigurations'], (value) => IntelligentTieringConfigurationResponse.fromMap((value as Map).cast<String, dynamic>())),
      inventoryConfigurations: map['inventoryConfigurations'] == null ? null : pulumi.Input.decodeList<InventoryConfigurationResponse>(map['inventoryConfigurations'], (value) => InventoryConfigurationResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      loggingConfiguration: map['loggingConfiguration'] == null ? null : LoggingConfigurationResponse.fromMap((map['loggingConfiguration'] as Map).cast<String, dynamic>()),
      metricsConfigurations: map['metricsConfigurations'] == null ? null : pulumi.Input.decodeList<MetricsConfigurationResponse>(map['metricsConfigurations'], (value) => MetricsConfigurationResponse.fromMap((value as Map).cast<String, dynamic>())),
      notificationConfiguration: map['notificationConfiguration'] == null ? null : NotificationConfigurationResponse.fromMap((map['notificationConfiguration'] as Map).cast<String, dynamic>()),
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : ObjectLockConfigurationResponse.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>()),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : map['objectLockEnabled'] as bool,
      ownershipControls: map['ownershipControls'] == null ? null : OwnershipControlsResponse.fromMap((map['ownershipControls'] as Map).cast<String, dynamic>()),
      ...
      replicationConfiguration: map['replicationConfiguration'] == null ? null : ReplicationConfigurationResponse.fromMap((map['replicationConfiguration'] as Map).cast<String, dynamic>()),
      ...
      versioningConfiguration: map['versioningConfiguration'] == null ? null : VersioningConfigurationResponse.fromMap((map['versioningConfiguration'] as Map).cast<String, dynamic>()),
      websiteConfiguration: map['websiteConfiguration'] == null ? null : WebsiteConfigurationResponse.fromMap((map['websiteConfiguration'] as Map).cast<String, dynamic>()),
