...
import 'accelerate_configuration_response.dart';
import 'analytics_configuration_response.dart';
import 'bucket_encryption_response.dart';
import 'cors_configuration_response.dart';
import 'intelligent_tiering_configuration_response.dart';
import 'inventory_configuration_response.dart';
import 'lifecycle_configuration_response.dart';
import 'logging_configuration_response.dart';
import 'metrics_configuration_response.dart';
import 'notification_configuration_response.dart';
...
class AwsS3BucketPropertiesResponse {
  ...
  final pulumi.Input<AccelerateConfigurationResponse>? accelerateConfiguration;
  ...
  final pulumi.Input<List<AnalyticsConfigurationResponse>>? analyticsConfigurations;
  ...
  final pulumi.Input<BucketEncryptionResponse>? bucketEncryption;
  ...
  final pulumi.Input<CorsConfigurationResponse>? corsConfiguration;
  /// Property domainName
  final pulumi.Input<String>? domainName;
  /// Property dualStackDomainName
  final pulumi.Input<String>? dualStackDomainName;
  /// Defines how Amazon S3 handles Intelligent-Tiering storage.
  final pulumi.Input<List<IntelligentTieringConfigurationResponse>>? intelligentTieringConfigurations;
  /// Specifies the inventory configuration for an Amazon S3 bucket. For more information, see [GET Bucket inventory](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketGETInventoryConfig.html) in the *Amazon S3 API Reference*.
  final pulumi.Input<List<InventoryConfigurationResponse>>? inventoryConfigurations;
  ...
  final pulumi.Input<LoggingConfigurationResponse>? loggingConfiguration;
  /// Specifies a metrics configuration for the CloudWatch request metrics (specified by the metrics configuration ID) from an Amazon S3 bucket. If you're updating an existing metrics configuration, note that this is a full replacement of the existing metrics configuration. If you don't include the elements you want to keep, they are erased. For more information, see [PutBucketMetricsConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTMetricConfiguration.html).
  final pulumi.Input<List<MetricsConfigurationResponse>>? metricsConfigurations;
  ...
  final pulumi.Input<NotificationConfigurationResponse>? notificationConfiguration;
  ...
  final pulumi.Input<ObjectLockConfigurationResponse>? objectLockConfiguration;
  ...
  final pulumi.Input<OwnershipControlsResponse>? ownershipControls;
  ...
  final pulumi.Input<VersioningConfigurationResponse>? versioningConfiguration;
  ...
  final pulumi.Input<WebsiteConfigurationResponse>? websiteConfiguration;
  /// Property websiteURL
  final pulumi.Input<String>? websiteURL;

  /// Creates a new [AwsS3BucketPropertiesResponse].
  ...
  const AwsS3BucketPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerateConfiguration': ?pulumi.Input.mapOptionalInputValue<AccelerateConfigurationResponse, Map<String, dynamic>>(accelerateConfiguration, (value) => value.toMap()),
      'accessControl': ?accessControl,
      'analyticsConfigurations': ?pulumi.Input.mapOptionalInputValue<List<AnalyticsConfigurationResponse>, List<Map<String, dynamic>>>(analyticsConfigurations, (value) => pulumi.Input.encodeList<AnalyticsConfigurationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'arn': ?arn,
      'bucketEncryption': ?pulumi.Input.mapOptionalInputValue<BucketEncryptionResponse, Map<String, dynamic>>(bucketEncryption, (value) => value.toMap()),
      'bucketName': ?bucketName,
      'corsConfiguration': ?pulumi.Input.mapOptionalInputValue<CorsConfigurationResponse, Map<String, dynamic>>(corsConfiguration, (value) => value.toMap()),
      'domainName': ?domainName,
      'dualStackDomainName': ?dualStackDomainName,
      'intelligentTieringConfigurations': ?pulumi.Input.mapOptionalInputValue<List<IntelligentTieringConfigurationResponse>, List<Map<String, dynamic>>>(intelligentTieringConfigurations, (value) => pulumi.Input.encodeList<IntelligentTieringConfigurationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'inventoryConfigurations': ?pulumi.Input.mapOptionalInputValue<List<InventoryConfigurationResponse>, List<Map<String, dynamic>>>(inventoryConfigurations, (value) => pulumi.Input.encodeList<InventoryConfigurationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'loggingConfiguration': ?pulumi.Input.mapOptionalInputValue<LoggingConfigurationResponse, Map<String, dynamic>>(loggingConfiguration, (value) => value.toMap()),
      'metricsConfigurations': ?pulumi.Input.mapOptionalInputValue<List<MetricsConfigurationResponse>, List<Map<String, dynamic>>>(metricsConfigurations, (value) => pulumi.Input.encodeList<MetricsConfigurationResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'notificationConfiguration': ?pulumi.Input.mapOptionalInputValue<NotificationConfigurationResponse, Map<String, dynamic>>(notificationConfiguration, (value) => value.toMap()),
      'objectLockConfiguration': ?pulumi.Input.mapOptionalInputValue<ObjectLockConfigurationResponse, Map<String, dynamic>>(objectLockConfiguration, (value) => value.toMap()),
  ...
  factory AwsS3BucketPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsS3BucketPropertiesResponse(
      accelerateConfiguration: (() { final guardedValue = map['accelerateConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccelerateConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      accessControl: (() { final guardedValue = map['accessControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      analyticsConfigurations: (() { final guardedValue = map['analyticsConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AnalyticsConfigurationResponse>(guardedValue, (value) => AnalyticsConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      arn: (() { final guardedValue = map['arn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bucketEncryption: (() { final guardedValue = map['bucketEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketEncryptionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      corsConfiguration: (() { final guardedValue = map['corsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CorsConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      domainName: (() { final guardedValue = map['domainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dualStackDomainName: (() { final guardedValue = map['dualStackDomainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      intelligentTieringConfigurations: (() { final guardedValue = map['intelligentTieringConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IntelligentTieringConfigurationResponse>(guardedValue, (value) => IntelligentTieringConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      inventoryConfigurations: (() { final guardedValue = map['inventoryConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InventoryConfigurationResponse>(guardedValue, (value) => InventoryConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lifecycleConfiguration: (() { final guardedValue = map['lifecycleConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LifecycleConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      loggingConfiguration: (() { final guardedValue = map['loggingConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoggingConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metricsConfigurations: (() { final guardedValue = map['metricsConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricsConfigurationResponse>(guardedValue, (value) => MetricsConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      notificationConfiguration: (() { final guardedValue = map['notificationConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotificationConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      objectLockConfiguration: (() { final guardedValue = map['objectLockConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectLockConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
