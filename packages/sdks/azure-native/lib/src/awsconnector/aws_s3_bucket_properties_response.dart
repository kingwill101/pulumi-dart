...
class AwsS3BucketPropertiesResponse {
  ...
  factory AwsS3BucketPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsS3BucketPropertiesResponse(
      accelerateConfiguration: map['accelerateConfiguration'] == null ? null : (AccelerateConfigurationResponse.fromMap((map['accelerateConfiguration'] as Map).cast<String, dynamic>())).input(),
      accessControl: map['accessControl'] == null ? null : (map['accessControl'] as String).input(),
      analyticsConfigurations: map['analyticsConfigurations'] == null ? null : (pulumi.Input.decodeList<AnalyticsConfigurationResponse>(map['analyticsConfigurations'], (value) => AnalyticsConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      arn: map['arn'] == null ? null : (map['arn'] as String).input(),
      bucketEncryption: map['bucketEncryption'] == null ? null : (BucketEncryptionResponse.fromMap((map['bucketEncryption'] as Map).cast<String, dynamic>())).input(),
      bucketName: map['bucketName'] == null ? null : (map['bucketName'] as String).input(),
      corsConfiguration: map['corsConfiguration'] == null ? null : (CorsConfigurationResponse.fromMap((map['corsConfiguration'] as Map).cast<String, dynamic>())).input(),
      domainName: map['domainName'] == null ? null : (map['domainName'] as String).input(),
      dualStackDomainName: map['dualStackDomainName'] == null ? null : (map['dualStackDomainName'] as String).input(),
      intelligentTieringConfigurations: map['intelligentTieringConfigurations'] == null ? null : (pulumi.Input.decodeList<IntelligentTieringConfigurationResponse>(map['intelligentTieringConfigurations'], (value) => IntelligentTieringConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      inventoryConfigurations: map['inventoryConfigurations'] == null ? null : (pulumi.Input.decodeList<InventoryConfigurationResponse>(map['inventoryConfigurations'], (value) => InventoryConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      loggingConfiguration: map['loggingConfiguration'] == null ? null : (LoggingConfigurationResponse.fromMap((map['loggingConfiguration'] as Map).cast<String, dynamic>())).input(),
      metricsConfigurations: map['metricsConfigurations'] == null ? null : (pulumi.Input.decodeList<MetricsConfigurationResponse>(map['metricsConfigurations'], (value) => MetricsConfigurationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      notificationConfiguration: map['notificationConfiguration'] == null ? null : (NotificationConfigurationResponse.fromMap((map['notificationConfiguration'] as Map).cast<String, dynamic>())).input(),
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : (ObjectLockConfigurationResponse.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>())).input(),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : (map['objectLockEnabled'] as bool).input(),
      ownershipControls: map['ownershipControls'] == null ? null : (OwnershipControlsResponse.fromMap((map['ownershipControls'] as Map).cast<String, dynamic>())).input(),
      ...
      replicationConfiguration: map['replicationConfiguration'] == null ? null : (ReplicationConfigurationResponse.fromMap((map['replicationConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      versioningConfiguration: map['versioningConfiguration'] == null ? null : (VersioningConfigurationResponse.fromMap((map['versioningConfiguration'] as Map).cast<String, dynamic>())).input(),
      websiteConfiguration: map['websiteConfiguration'] == null ? null : (WebsiteConfigurationResponse.fromMap((map['websiteConfiguration'] as Map).cast<String, dynamic>())).input(),
