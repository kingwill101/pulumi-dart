...
class NetworkFirewallRuleGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NetworkFirewallRuleGroupPropertiesResponse>
  properties;
  ...
  NetworkFirewallRuleGroup(
    ...
    properties = registerOutput<NetworkFirewallRuleGroupPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return NetworkFirewallRuleGroupPropertiesResponse.fromMap(
