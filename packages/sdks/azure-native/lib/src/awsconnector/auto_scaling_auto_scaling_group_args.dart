...
class AutoScalingAutoScalingGroupArgs {
  ...
  AutoScalingAutoScalingGroupArgs({
    ...
    pulumi.Output<AutoScalingAutoScalingGroupProperties>? properties,
  ...
  factory AutoScalingAutoScalingGroupArgs.fromMap(Map<String, dynamic> map) {
    return AutoScalingAutoScalingGroupArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<AutoScalingAutoScalingGroupProperties>(AutoScalingAutoScalingGroupProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
