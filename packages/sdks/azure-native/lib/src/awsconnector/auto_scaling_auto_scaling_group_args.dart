...
class AutoScalingAutoScalingGroupArgs {
  ...
  /// [tags] Resource tags.
  const AutoScalingAutoScalingGroupArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory AutoScalingAutoScalingGroupArgs.fromMap(Map<String, dynamic> map) {
    return AutoScalingAutoScalingGroupArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoScalingAutoScalingGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
