...
import 'aws_cloud_trail_trail_properties_response.dart';

/// Definition of CloudTrailTrail
class CloudTrailTrailPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCloudTrailTrailPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudTrailTrailPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudTrailTrailPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudTrailTrailPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudTrailTrailPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudTrailTrailPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
