...
class AwsEksClusterPropertiesResponse {
  ...
  factory AwsEksClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEksClusterPropertiesResponse(
      accessConfig: map['accessConfig'] == null ? null : (AccessConfigResponseResponse.fromMap((map['accessConfig']! as Map).cast<String, dynamic>())).input(),
      arn: map['arn'] == null ? null : (map['arn']! as String).input(),
      certificateAuthority: map['certificateAuthority'] == null ? null : (CertificateResponse.fromMap((map['certificateAuthority']! as Map).cast<String, dynamic>())).input(),
      clientRequestToken: map['clientRequestToken'] == null ? null : (map['clientRequestToken']! as String).input(),
      connectorConfig: map['connectorConfig'] == null ? null : (ConnectorConfigResponseResponse.fromMap((map['connectorConfig']! as Map).cast<String, dynamic>())).input(),
      createdAt: map['createdAt'] == null ? null : (map['createdAt']! as String).input(),
      encryptionConfig: map['encryptionConfig'] == null ? null : (pulumi.Input.decodeList<EncryptionConfigResponse>(map['encryptionConfig']!, (value) => EncryptionConfigResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      endpoint: map['endpoint'] == null ? null : (map['endpoint']! as String).input(),
      health: map['health'] == null ? null : (ClusterHealthResponse.fromMap((map['health']! as Map).cast<String, dynamic>())).input(),
      id: map['id'] == null ? null : (map['id']! as String).input(),
      identity: map['identity'] == null ? null : (IdentityResponse.fromMap((map['identity']! as Map).cast<String, dynamic>())).input(),
      kubernetesNetworkConfig: map['kubernetesNetworkConfig'] == null ? null : (KubernetesNetworkConfigResponseResponse.fromMap((map['kubernetesNetworkConfig']! as Map).cast<String, dynamic>())).input(),
      logging: map['logging'] == null ? null : (LoggingResponse.fromMap((map['logging']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      outpostConfig: map['outpostConfig'] == null ? null : (OutpostConfigResponseResponse.fromMap((map['outpostConfig']! as Map).cast<String, dynamic>())).input(),
      platformVersion: map['platformVersion'] == null ? null : (map['platformVersion']! as String).input(),
      resourcesVpcConfig: map['resourcesVpcConfig'] == null ? null : (VpcConfigResponseResponse.fromMap((map['resourcesVpcConfig']! as Map).cast<String, dynamic>())).input(),
      roleArn: map['roleArn'] == null ? null : (map['roleArn']! as String).input(),
      status: map['status'] == null ? null : (ClusterStatusEnumValueResponse.fromMap((map['status']! as Map).cast<String, dynamic>())).input(),
