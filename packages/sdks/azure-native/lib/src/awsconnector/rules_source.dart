...
class RulesSource {
  ...
  final pulumi.Input<StatelessRulesAndCustomActions>?
    ...
    return <String, dynamic>{
      ...
      'statefulRules':
          ...
          >(
            statefulRules,
            (value) =>
                pulumi.Input.encodeList<StatefulRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory RulesSource.fromMap(Map<String, dynamic> map) {
    return RulesSource(
      ...
      statefulRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatefulRule>(
            guardedValue,
            (value) =>
                StatefulRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      statelessRulesAndCustomActions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StatelessRulesAndCustomActions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
