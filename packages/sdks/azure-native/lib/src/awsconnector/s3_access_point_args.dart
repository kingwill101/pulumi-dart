...
class S3AccessPointArgs {
  ...
  factory S3AccessPointArgs.fromMap(Map<String, dynamic> map) {
    return S3AccessPointArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3AccessPointProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
