...
class S3AccessPointArgs {
  ...
  S3AccessPointArgs({
    ...
    pulumi.Output<S3AccessPointProperties>? properties,
  ...
  factory S3AccessPointArgs.fromMap(Map<String, dynamic> map) {
    return S3AccessPointArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<S3AccessPointProperties>(S3AccessPointProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
