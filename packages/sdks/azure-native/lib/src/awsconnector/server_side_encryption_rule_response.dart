...
class ServerSideEncryptionRuleResponse {
  ...
  final ServerSideEncryptionByDefaultResponse? serverSideEncryptionByDefault;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serverSideEncryptionByDefault': ?serverSideEncryptionByDefault == null ? null : serverSideEncryptionByDefault!.toMap(),
    };
  }
  ...
  factory ServerSideEncryptionRuleResponse.fromMap(Map<String, dynamic> map) {
    return ServerSideEncryptionRuleResponse(
      ...
      serverSideEncryptionByDefault: map['serverSideEncryptionByDefault'] == null ? null : ServerSideEncryptionByDefaultResponse.fromMap((map['serverSideEncryptionByDefault'] as Map).cast<String, dynamic>()),
    );
  }
}
