...
import 'server_side_encryption_by_default_response.dart';

/// Definition of ServerSideEncryptionRule
class ServerSideEncryptionRuleResponse {
  ...
  final pulumi.Input<ServerSideEncryptionByDefaultResponse?>? serverSideEncryptionByDefault;

  /// Creates a new [ServerSideEncryptionRuleResponse].
  ...
  const ServerSideEncryptionRuleResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'serverSideEncryptionByDefault': ?pulumi.Input.mapOptionalInputValue<ServerSideEncryptionByDefaultResponse, Map<String, dynamic>>(serverSideEncryptionByDefault, (value) => value.toMap()),
    };
  }
  ...
  factory ServerSideEncryptionRuleResponse.fromMap(Map<String, dynamic> map) {
    return ServerSideEncryptionRuleResponse(
      ...
      serverSideEncryptionByDefault: (() { final guardedValue = map['serverSideEncryptionByDefault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerSideEncryptionByDefaultResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
