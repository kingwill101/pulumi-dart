...
class ServerSideEncryptionRuleResponse {
  ...
  final pulumi.Input<ServerSideEncryptionByDefaultResponse>?
    ...
    return <String, dynamic>{
      ...
      'serverSideEncryptionByDefault':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(serverSideEncryptionByDefault, (value) => value.toMap()),
    };
  }
  ...
  factory ServerSideEncryptionRuleResponse.fromMap(Map<String, dynamic> map) {
    return ServerSideEncryptionRuleResponse(
      ...
      serverSideEncryptionByDefault: (() {
        final guardedValue = map['serverSideEncryptionByDefault'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServerSideEncryptionByDefaultResponse.fromMap(
