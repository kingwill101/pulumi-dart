...
class DomainEndpointOptionsResponse {
  ...
  factory DomainEndpointOptionsResponse.fromMap(Map<String, dynamic> map) {
    return DomainEndpointOptionsResponse(
      ...
      tlsSecurityPolicy: (() { final guardedValue = map['tlsSecurityPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TLSSecurityPolicyEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
