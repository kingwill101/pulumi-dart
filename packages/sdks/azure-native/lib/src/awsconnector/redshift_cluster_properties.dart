...
class RedshiftClusterProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRedshiftClusterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RedshiftClusterProperties.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRedshiftClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
