...
class RedshiftClusterProperties {
  ...
  /// AWS Properties
  final AwsRedshiftClusterProperties? awsProperties;
  /// AWS Region
  ...
  factory RedshiftClusterProperties.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRedshiftClusterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
