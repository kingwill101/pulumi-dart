...
import 'aws_wafv2_logging_configuration_properties_response.dart';

/// Definition of Wafv2LoggingConfiguration
class Wafv2LoggingConfigurationPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsWafv2LoggingConfigurationPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Wafv2LoggingConfigurationPropertiesResponse].
  ...
  const Wafv2LoggingConfigurationPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsWafv2LoggingConfigurationPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Wafv2LoggingConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Wafv2LoggingConfigurationPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsWafv2LoggingConfigurationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
