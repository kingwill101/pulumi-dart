...
class Wafv2LoggingConfigurationPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsWafv2LoggingConfigurationPropertiesResponse>?
  awsProperties;
  ...
  factory Wafv2LoggingConfigurationPropertiesResponse.fromMap(
    ...
    return Wafv2LoggingConfigurationPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsWafv2LoggingConfigurationPropertiesResponse.fromMap(
