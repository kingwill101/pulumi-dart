...
class Wafv2LoggingConfigurationPropertiesResponse {
  ...
  /// AWS Properties
  final AwsWafv2LoggingConfigurationPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Wafv2LoggingConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Wafv2LoggingConfigurationPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsWafv2LoggingConfigurationPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
