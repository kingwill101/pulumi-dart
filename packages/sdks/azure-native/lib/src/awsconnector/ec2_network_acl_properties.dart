...
import 'aws_ec2_network_acl_properties.dart';

/// Definition of Ec2NetworkAcl
class Ec2NetworkAclProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2NetworkAclProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2NetworkAclProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2NetworkAclProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2NetworkAclProperties.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkAclProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2NetworkAclProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
