...
class Ec2NetworkAclProperties {
  ...
  /// AWS Properties
  final AwsEc2NetworkAclProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2NetworkAclProperties.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkAclProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2NetworkAclProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
