...
class ElasticLoadBalancingv2TargetHealthDescriptionArgs {
  ...
  /// [tags] Resource tags.
  const ElasticLoadBalancingv2TargetHealthDescriptionArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory ElasticLoadBalancingv2TargetHealthDescriptionArgs.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingv2TargetHealthDescriptionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ElasticLoadBalancingv2TargetHealthDescriptionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
