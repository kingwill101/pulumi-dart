...
class AwsRdsDBClusterProperties {
  ...
  AwsRdsDBClusterProperties({
    ...
    pulumi.Input<int?>? backupRetentionPeriod,
    this.copyTagsToSnapshot,
    this.databaseName,
    this.dbClusterArn,
    this.dbClusterIdentifier,
    this.dbClusterInstanceClass,
    pulumi.Input<String?>? dbClusterParameterGroupName,
    ...
    this.restoreToTime,
    pulumi.Input<String?>? restoreType,
  ...
  }) : backupRetentionPeriod = backupRetentionPeriod ?? pulumi.Input.fromValue(1), dbClusterParameterGroupName = dbClusterParameterGroupName ?? pulumi.Input.fromValue('default.aurora5.6'), restoreType = restoreType ?? pulumi.Input.fromValue('full-copy');
