...
class AwsRdsDBClusterProperties {
  ...
  factory AwsRdsDBClusterProperties.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBClusterProperties(
      ...
      associatedRoles: map['associatedRoles'] == null ? null : (pulumi.Input.decodeList<DBClusterRole>(map['associatedRoles']!, (value) => DBClusterRole.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      dbClusterResourceId: map['dbClusterResourceId'] == null ? null : (map['dbClusterResourceId']! as String).input(),
      ...
      enableCloudwatchLogsExports: map['enableCloudwatchLogsExports'] == null ? null : ((map['enableCloudwatchLogsExports']! as List).cast<String>()).input(),
      ...
      enableIAMDatabaseAuthentication: map['enableIAMDatabaseAuthentication'] == null ? null : (map['enableIAMDatabaseAuthentication']! as bool).input(),
      endpoint: map['endpoint'] == null ? null : (RdsDbClusterEndpoint.fromMap((map['endpoint']! as Map).cast<String, dynamic>())).input(),
      ...
      masterUserSecret: map['masterUserSecret'] == null ? null : (MasterUserSecret.fromMap((map['masterUserSecret']! as Map).cast<String, dynamic>())).input(),
      ...
      readEndpoint: map['readEndpoint'] == null ? null : (ReadEndpoint.fromMap((map['readEndpoint']! as Map).cast<String, dynamic>())).input(),
      ...
      scalingConfiguration: map['scalingConfiguration'] == null ? null : (ScalingConfiguration.fromMap((map['scalingConfiguration']! as Map).cast<String, dynamic>())).input(),
      serverlessV2ScalingConfiguration: map['serverlessV2ScalingConfiguration'] == null ? null : (ServerlessV2ScalingConfiguration.fromMap((map['serverlessV2ScalingConfiguration']! as Map).cast<String, dynamic>())).input(),
