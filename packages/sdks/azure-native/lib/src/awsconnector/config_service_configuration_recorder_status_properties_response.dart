...
import 'aws_config_service_configuration_recorder_status_properties_response.dart';
...
class ConfigServiceConfigurationRecorderStatusPropertiesResponse {
  ...
  /// Creates a new [ConfigServiceConfigurationRecorderStatusPropertiesResponse].
  ...
  const ConfigServiceConfigurationRecorderStatusPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory ConfigServiceConfigurationRecorderStatusPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderStatusPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsConfigServiceConfigurationRecorderStatusPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
