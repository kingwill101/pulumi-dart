...
class TagCriterionForJob {
  ...
  TagCriterionForJob({this.comparator, this.tagValues});
    ...
    return TagCriterionForJob(
      comparator: (() {
        ...
        return pulumi.Input.fromValue(
          JobComparatorEnumValue.fromMap(
      ...
      tagValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TagCriterionPairForJob>(
            guardedValue,
            (value) => TagCriterionPairForJob.fromMap(
