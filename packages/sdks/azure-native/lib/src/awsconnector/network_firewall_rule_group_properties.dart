...
import 'aws_network_firewall_rule_group_properties.dart';

/// Definition of NetworkFirewallRuleGroup
class NetworkFirewallRuleGroupProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsNetworkFirewallRuleGroupProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [NetworkFirewallRuleGroupProperties].
  ...
  const NetworkFirewallRuleGroupProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsNetworkFirewallRuleGroupProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory NetworkFirewallRuleGroupProperties.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallRuleGroupProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsNetworkFirewallRuleGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
