...
class NetworkFirewallRuleGroupProperties {
  ...
  /// AWS Properties
  final AwsNetworkFirewallRuleGroupProperties? awsProperties;
  /// AWS Region
  ...
  factory NetworkFirewallRuleGroupProperties.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallRuleGroupProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsNetworkFirewallRuleGroupProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
