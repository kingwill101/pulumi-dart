...
class WafWebACLSummaryProperties {
  ...
  /// AWS Properties
  final AwsWafWebACLSummaryProperties? awsProperties;
  /// AWS Region
  ...
  factory WafWebACLSummaryProperties.fromMap(Map<String, dynamic> map) {
    return WafWebACLSummaryProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsWafWebACLSummaryProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
