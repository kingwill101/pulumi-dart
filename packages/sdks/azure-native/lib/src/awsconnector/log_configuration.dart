...
class LogConfiguration {
  ...
  final pulumi.Input<List<Secret>?>? secretOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logDriver': ?logDriver,
      'options': ?options,
      'secretOptions': ?pulumi.Input.mapOptionalInputValue<List<Secret>, List<Map<String, dynamic>>>(secretOptions, (value) => pulumi.Input.encodeList<Secret, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory LogConfiguration.fromMap(Map<String, dynamic> map) {
    return LogConfiguration(
      ...
      secretOptions: (() { final guardedValue = map['secretOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Secret>(guardedValue, (value) => Secret.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
