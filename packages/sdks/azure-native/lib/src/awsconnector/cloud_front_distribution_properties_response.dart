...
class CloudFrontDistributionPropertiesResponse {
  ...
  /// AWS Properties
  final AwsCloudFrontDistributionPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory CloudFrontDistributionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudFrontDistributionPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudFrontDistributionPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
