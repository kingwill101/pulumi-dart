...
import 'aws_cloud_front_distribution_properties_response.dart';

/// Definition of CloudFrontDistribution
class CloudFrontDistributionPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCloudFrontDistributionPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudFrontDistributionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudFrontDistributionPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudFrontDistributionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudFrontDistributionPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudFrontDistributionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
