...
class CloudFrontDistributionPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsCloudFrontDistributionPropertiesResponse>?
  awsProperties;
  ...
  factory CloudFrontDistributionPropertiesResponse.fromMap(
    ...
    return CloudFrontDistributionPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsCloudFrontDistributionPropertiesResponse.fromMap(
