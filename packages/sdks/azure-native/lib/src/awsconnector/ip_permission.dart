...
class IpPermission {
  ...
  factory IpPermission.fromMap(Map<String, dynamic> map) {
    return IpPermission(
      ...
      ipRanges: (() { final guardedValue = map['ipRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IpRange>(guardedValue, (value) => IpRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ipv6Ranges: (() { final guardedValue = map['ipv6Ranges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Ipv6Range>(guardedValue, (value) => Ipv6Range.fromMap((value as Map).cast<String, dynamic>()))); })(),
      prefixListIds: (() { final guardedValue = map['prefixListIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PrefixListId>(guardedValue, (value) => PrefixListId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      toPort: (() { final guardedValue = map['toPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      userIdGroupPairs: (() { final guardedValue = map['userIdGroupPairs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserIdGroupPair>(guardedValue, (value) => UserIdGroupPair.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
