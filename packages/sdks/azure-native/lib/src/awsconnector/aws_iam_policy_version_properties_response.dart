...
class AwsIamPolicyVersionPropertiesResponse {
  ...
  const AwsIamPolicyVersionPropertiesResponse({
    this.createDate,
    this.document,
  ...
  factory AwsIamPolicyVersionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsIamPolicyVersionPropertiesResponse(
