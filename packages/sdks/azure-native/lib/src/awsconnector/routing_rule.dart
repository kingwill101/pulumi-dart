...
class RoutingRule {
  ...
  factory RoutingRule.fromMap(Map<String, dynamic> map) {
    return RoutingRule(
      redirectRule: (() { final guardedValue = map['redirectRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RedirectRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      routingRuleCondition: (() { final guardedValue = map['routingRuleCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoutingRuleCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
