...
class RoutingRule {
  ...
  final RoutingRuleCondition? routingRuleCondition;
  ...
  factory RoutingRule.fromMap(Map<String, dynamic> map) {
    return RoutingRule(
      redirectRule: map['redirectRule'] == null ? null : RedirectRule.fromMap((map['redirectRule'] as Map).cast<String, dynamic>()),
      routingRuleCondition: map['routingRuleCondition'] == null ? null : RoutingRuleCondition.fromMap((map['routingRuleCondition'] as Map).cast<String, dynamic>()),
    );
  }
}
