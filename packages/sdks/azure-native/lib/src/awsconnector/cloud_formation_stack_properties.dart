...
import 'aws_cloud_formation_stack_properties.dart';

/// Definition of CloudFormationStack
class CloudFormationStackProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCloudFormationStackProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudFormationStackProperties].
  ...
  const CloudFormationStackProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudFormationStackProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudFormationStackProperties.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudFormationStackProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
