...
class AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse {
  ...
  const AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse({
  ...
  factory AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse(
      ...
      pendingModifiedValues: (() { final guardedValue = map['pendingModifiedValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationPendingModifiedValuesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      replicationSubnetGroup: (() { final guardedValue = map['replicationSubnetGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationSubnetGroupResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vpcSecurityGroups: (() { final guardedValue = map['vpcSecurityGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VpcSecurityGroupMembershipResponse>(guardedValue, (value) => VpcSecurityGroupMembershipResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
