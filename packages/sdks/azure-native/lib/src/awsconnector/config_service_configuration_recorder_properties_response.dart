...
class ConfigServiceConfigurationRecorderPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsConfigServiceConfigurationRecorderPropertiesResponse>?
  awsProperties;
  ...
  factory ConfigServiceConfigurationRecorderPropertiesResponse.fromMap(
    ...
    return ConfigServiceConfigurationRecorderPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsConfigServiceConfigurationRecorderPropertiesResponse.fromMap(
