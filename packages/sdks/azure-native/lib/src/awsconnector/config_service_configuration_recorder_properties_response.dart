...
import 'aws_config_service_configuration_recorder_properties_response.dart';

/// Definition of ConfigServiceConfigurationRecorder
class ConfigServiceConfigurationRecorderPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsConfigServiceConfigurationRecorderPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ConfigServiceConfigurationRecorderPropertiesResponse].
  ...
  const ConfigServiceConfigurationRecorderPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsConfigServiceConfigurationRecorderPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ConfigServiceConfigurationRecorderPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsConfigServiceConfigurationRecorderPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
