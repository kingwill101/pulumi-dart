...
import 'load_balancer_attribute_response.dart';
import 'subnet_mapping_response.dart';
...
class AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse {
  ...
  const AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loadBalancerAttributes': ?pulumi.Input.mapOptionalInputValue<List<LoadBalancerAttributeResponse>, List<Map<String, dynamic>>>(loadBalancerAttributes, (value) => pulumi.Input.encodeList<LoadBalancerAttributeResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'loadBalancerFullName': ?loadBalancerFullName,
      'loadBalancerName': ?loadBalancerName,
      'name': ?name,
      'scheme': ?scheme,
      'securityGroups': ?securityGroups,
      'subnetMappings': ?pulumi.Input.mapOptionalInputValue<List<SubnetMappingResponse>, List<Map<String, dynamic>>>(subnetMappings, (value) => pulumi.Input.encodeList<SubnetMappingResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'subnets': ?subnets,
  ...
  factory AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse(
      canonicalHostedZoneID: (() { final guardedValue = map['canonicalHostedZoneID']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      loadBalancerAttributes: (() { final guardedValue = map['loadBalancerAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LoadBalancerAttributeResponse>(guardedValue, (value) => LoadBalancerAttributeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      loadBalancerFullName: (() { final guardedValue = map['loadBalancerFullName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      subnetMappings: (() { final guardedValue = map['subnetMappings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubnetMappingResponse>(guardedValue, (value) => SubnetMappingResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
