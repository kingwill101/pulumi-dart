...
class AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse {
  ...
  final pulumi.Input<List<LoadBalancerAttributeResponse>>?
    ...
    return <String, dynamic>{
      ...
      'loadBalancerAttributes':
          ?pulumi.Input.mapOptionalInputValue<
            List<LoadBalancerAttributeResponse>,
  ...
  factory AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse(
      canonicalHostedZoneID: (() {
        final guardedValue = map['canonicalHostedZoneID'];
      ...
      loadBalancerAttributes: (() {
        final guardedValue = map['loadBalancerAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoadBalancerAttributeResponse>(
            guardedValue,
            (value) => LoadBalancerAttributeResponse.fromMap(
      ...
      loadBalancerFullName: (() {
        final guardedValue = map['loadBalancerFullName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loadBalancerName: (() {
      ...
      subnetMappings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubnetMappingResponse>(
            guardedValue,
            (value) => SubnetMappingResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
