...
class AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse {
  ...
  final List<LoadBalancerAttributeResponse>? loadBalancerAttributes;
  ...
  final List<SubnetMappingResponse>? subnetMappings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'loadBalancerAttributes': ?loadBalancerAttributes == null ? null : pulumi.Input.encodeList<LoadBalancerAttributeResponse, Map<String, dynamic>>(loadBalancerAttributes!, (value) => value.toMap()),
      'loadBalancerFullName': ?loadBalancerFullName,
      'loadBalancerName': ?loadBalancerName,
      'name': ?name,
      'scheme': ?scheme,
      'securityGroups': ?securityGroups,
      'subnetMappings': ?subnetMappings == null ? null : pulumi.Input.encodeList<SubnetMappingResponse, Map<String, dynamic>>(subnetMappings!, (value) => value.toMap()),
      'subnets': ?subnets,
  ...
  factory AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse(
      ...
      loadBalancerAttributes: map['loadBalancerAttributes'] == null ? null : pulumi.Input.decodeList<LoadBalancerAttributeResponse>(map['loadBalancerAttributes'], (value) => LoadBalancerAttributeResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      subnetMappings: map['subnetMappings'] == null ? null : pulumi.Input.decodeList<SubnetMappingResponse>(map['subnetMappings'], (value) => SubnetMappingResponse.fromMap((value as Map).cast<String, dynamic>())),
