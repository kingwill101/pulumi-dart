...
class CodeBuildProjectProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsCodeBuildProjectProperties>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCodeBuildProjectProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CodeBuildProjectProperties.fromMap(Map<String, dynamic> map) {
    return CodeBuildProjectProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCodeBuildProjectProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
