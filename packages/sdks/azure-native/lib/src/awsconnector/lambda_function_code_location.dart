...
class LambdaFunctionCodeLocation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<LambdaFunctionCodeLocationPropertiesResponse>
  properties;
  ...
  LambdaFunctionCodeLocation(
    ...
    properties = registerOutput<LambdaFunctionCodeLocationPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return LambdaFunctionCodeLocationPropertiesResponse.fromMap(
