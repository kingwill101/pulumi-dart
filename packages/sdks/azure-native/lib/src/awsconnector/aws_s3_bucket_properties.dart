...
class AwsS3BucketProperties {
  ...
  factory AwsS3BucketProperties.fromMap(Map<String, dynamic> map) {
    return AwsS3BucketProperties(
      accelerateConfiguration: map['accelerateConfiguration'] == null ? null : (AccelerateConfiguration.fromMap((map['accelerateConfiguration']! as Map).cast<String, dynamic>())).input(),
      accessControl: map['accessControl'] == null ? null : (map['accessControl']! as String).input(),
      analyticsConfigurations: map['analyticsConfigurations'] == null ? null : (pulumi.Input.decodeList<AnalyticsConfiguration>(map['analyticsConfigurations']!, (value) => AnalyticsConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      arn: map['arn'] == null ? null : (map['arn']! as String).input(),
      bucketEncryption: map['bucketEncryption'] == null ? null : (BucketEncryption.fromMap((map['bucketEncryption']! as Map).cast<String, dynamic>())).input(),
      ...
      intelligentTieringConfigurations: map['intelligentTieringConfigurations'] == null ? null : (pulumi.Input.decodeList<IntelligentTieringConfiguration>(map['intelligentTieringConfigurations']!, (value) => IntelligentTieringConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      inventoryConfigurations: map['inventoryConfigurations'] == null ? null : (pulumi.Input.decodeList<InventoryConfiguration>(map['inventoryConfigurations']!, (value) => InventoryConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      loggingConfiguration: map['loggingConfiguration'] == null ? null : (LoggingConfiguration.fromMap((map['loggingConfiguration']! as Map).cast<String, dynamic>())).input(),
      metricsConfigurations: map['metricsConfigurations'] == null ? null : (pulumi.Input.decodeList<MetricsConfiguration>(map['metricsConfigurations']!, (value) => MetricsConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      notificationConfiguration: map['notificationConfiguration'] == null ? null : (NotificationConfiguration.fromMap((map['notificationConfiguration']! as Map).cast<String, dynamic>())).input(),
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : (ObjectLockConfiguration.fromMap((map['objectLockConfiguration']! as Map).cast<String, dynamic>())).input(),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : (map['objectLockEnabled']! as bool).input(),
      ownershipControls: map['ownershipControls'] == null ? null : (OwnershipControls.fromMap((map['ownershipControls']! as Map).cast<String, dynamic>())).input(),
      ...
      versioningConfiguration: map['versioningConfiguration'] == null ? null : (VersioningConfiguration.fromMap((map['versioningConfiguration']! as Map).cast<String, dynamic>())).input(),
      websiteConfiguration: map['websiteConfiguration'] == null ? null : (WebsiteConfiguration.fromMap((map['websiteConfiguration']! as Map).cast<String, dynamic>())).input(),
