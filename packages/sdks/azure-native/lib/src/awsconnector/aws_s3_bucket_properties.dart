...
class AwsS3BucketProperties {
  ...
  final pulumi.Input<dynamic>? accessControl;
  ...
  final pulumi.Input<List<IntelligentTieringConfiguration>?>? intelligentTieringConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accelerateConfiguration': ?pulumi.Input.mapOptionalInputValue<AccelerateConfiguration, Map<String, dynamic>>(accelerateConfiguration, (value) => value.toMap()),
      'accessControl': ?accessControl,
      'analyticsConfigurations': ?pulumi.Input.mapOptionalInputValue<List<AnalyticsConfiguration>, List<Map<String, dynamic>>>(analyticsConfigurations, (value) => pulumi.Input.encodeList<AnalyticsConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
      'arn': ?arn,
      'bucketEncryption': ?pulumi.Input.mapOptionalInputValue<BucketEncryption, Map<String, dynamic>>(bucketEncryption, (value) => value.toMap()),
      ...
      'intelligentTieringConfigurations': ?pulumi.Input.mapOptionalInputValue<List<IntelligentTieringConfiguration>, List<Map<String, dynamic>>>(intelligentTieringConfigurations, (value) => pulumi.Input.encodeList<IntelligentTieringConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
      'inventoryConfigurations': ?pulumi.Input.mapOptionalInputValue<List<InventoryConfiguration>, List<Map<String, dynamic>>>(inventoryConfigurations, (value) => pulumi.Input.encodeList<InventoryConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'loggingConfiguration': ?pulumi.Input.mapOptionalInputValue<LoggingConfiguration, Map<String, dynamic>>(loggingConfiguration, (value) => value.toMap()),
      'metricsConfigurations': ?pulumi.Input.mapOptionalInputValue<List<MetricsConfiguration>, List<Map<String, dynamic>>>(metricsConfigurations, (value) => pulumi.Input.encodeList<MetricsConfiguration, Map<String, dynamic>>(value, (value) => value.toMap())),
      'notificationConfiguration': ?pulumi.Input.mapOptionalInputValue<NotificationConfiguration, Map<String, dynamic>>(notificationConfiguration, (value) => value.toMap()),
      'objectLockConfiguration': ?pulumi.Input.mapOptionalInputValue<ObjectLockConfiguration, Map<String, dynamic>>(objectLockConfiguration, (value) => value.toMap()),
      'objectLockEnabled': ?objectLockEnabled,
      'ownershipControls': ?pulumi.Input.mapOptionalInputValue<OwnershipControls, Map<String, dynamic>>(ownershipControls, (value) => value.toMap()),
      ...
      'versioningConfiguration': ?pulumi.Input.mapOptionalInputValue<VersioningConfiguration, Map<String, dynamic>>(versioningConfiguration, (value) => value.toMap()),
      'websiteConfiguration': ?pulumi.Input.mapOptionalInputValue<WebsiteConfiguration, Map<String, dynamic>>(websiteConfiguration, (value) => value.toMap()),
  ...
  factory AwsS3BucketProperties.fromMap(Map<String, dynamic> map) {
    return AwsS3BucketProperties(
      accelerateConfiguration: (() { final guardedValue = map['accelerateConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccelerateConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      accessControl: (() { final guardedValue = map['accessControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      analyticsConfigurations: (() { final guardedValue = map['analyticsConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AnalyticsConfiguration>(guardedValue, (value) => AnalyticsConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      arn: (() { final guardedValue = map['arn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bucketEncryption: (() { final guardedValue = map['bucketEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketEncryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      corsConfiguration: (() { final guardedValue = map['corsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CorsConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      intelligentTieringConfigurations: (() { final guardedValue = map['intelligentTieringConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IntelligentTieringConfiguration>(guardedValue, (value) => IntelligentTieringConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      inventoryConfigurations: (() { final guardedValue = map['inventoryConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InventoryConfiguration>(guardedValue, (value) => InventoryConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      loggingConfiguration: (() { final guardedValue = map['loggingConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoggingConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metricsConfigurations: (() { final guardedValue = map['metricsConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricsConfiguration>(guardedValue, (value) => MetricsConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      notificationConfiguration: (() { final guardedValue = map['notificationConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NotificationConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      objectLockConfiguration: (() { final guardedValue = map['objectLockConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectLockConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ownershipControls: (() { final guardedValue = map['ownershipControls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OwnershipControls.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      versioningConfiguration: (() { final guardedValue = map['versioningConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VersioningConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      websiteConfiguration: (() { final guardedValue = map['websiteConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebsiteConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
