...
class AddOn {
  ...
  factory AddOn.fromMap(Map<String, dynamic> map) {
    return AddOn(
      ...
      autoSnapshotAddOnRequest: map['autoSnapshotAddOnRequest'] == null ? null : (AutoSnapshotAddOn.fromMap((map['autoSnapshotAddOnRequest'] as Map).cast<String, dynamic>())).input(),
