...
class Macie2JobSummaryProperties {
  ...
  /// AWS Properties
  final AwsMacie2JobSummaryProperties? awsProperties;
  /// AWS Region
  ...
  factory Macie2JobSummaryProperties.fromMap(Map<String, dynamic> map) {
    return Macie2JobSummaryProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsMacie2JobSummaryProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
