...
class AwsSsmResourceComplianceSummaryItemProperties {
  ...
  const AwsSsmResourceComplianceSummaryItemProperties({
    this.complianceType,
  ...
  factory AwsSsmResourceComplianceSummaryItemProperties.fromMap(Map<String, dynamic> map) {
    return AwsSsmResourceComplianceSummaryItemProperties(
      ...
      compliantSummary: (() { final guardedValue = map['compliantSummary']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CompliantSummary.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      executionSummary: (() { final guardedValue = map['executionSummary']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComplianceExecutionSummary.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nonCompliantSummary: (() { final guardedValue = map['nonCompliantSummary']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NonCompliantSummary.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      overallSeverity: (() { final guardedValue = map['overallSeverity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComplianceSeverityEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceId: (() { final guardedValue = map['resourceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceType: (() { final guardedValue = map['resourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComplianceStatusEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
