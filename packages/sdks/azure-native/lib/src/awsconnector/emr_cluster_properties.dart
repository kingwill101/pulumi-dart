...
import 'aws_emr_cluster_properties.dart';

/// Definition of EmrCluster
class EmrClusterProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEmrClusterProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EmrClusterProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEmrClusterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EmrClusterProperties.fromMap(Map<String, dynamic> map) {
    return EmrClusterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEmrClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
