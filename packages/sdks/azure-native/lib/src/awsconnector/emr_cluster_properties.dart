...
class EmrClusterProperties {
  ...
  /// AWS Properties
  final AwsEmrClusterProperties? awsProperties;
  /// AWS Region
  ...
  factory EmrClusterProperties.fromMap(Map<String, dynamic> map) {
    return EmrClusterProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEmrClusterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
