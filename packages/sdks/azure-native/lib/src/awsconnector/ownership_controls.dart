...
class OwnershipControls {
  ...
  factory OwnershipControls.fromMap(Map<String, dynamic> map) {
    return OwnershipControls(
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OwnershipControlsRule>(guardedValue, (value) => OwnershipControlsRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
