...
class PlacementGroupConfigResponse {
  ...
  final pulumi.Input<PlacementGroupStrategyEnumValueResponse>?
  placementStrategy;
  ...
  PlacementGroupConfigResponse({this.instanceRole, this.placementStrategy});
    ...
    return PlacementGroupConfigResponse(
      instanceRole: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceRoleTypeEnumValueResponse.fromMap(
      ...
      placementStrategy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PlacementGroupStrategyEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
