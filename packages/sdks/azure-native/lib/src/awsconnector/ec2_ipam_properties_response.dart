...
class Ec2IpamPropertiesResponse {
  ...
  const Ec2IpamPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory Ec2IpamPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2IpamPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2IpamPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
