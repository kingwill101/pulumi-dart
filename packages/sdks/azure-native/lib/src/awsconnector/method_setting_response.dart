...
class MethodSettingResponse {
  ...
  factory MethodSettingResponse.fromMap(Map<String, dynamic> map) {
    return MethodSettingResponse(
      ...
      cacheTtlInSeconds: (() { final guardedValue = map['cacheTtlInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      throttlingRateLimit: (() { final guardedValue = map['throttlingRateLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
