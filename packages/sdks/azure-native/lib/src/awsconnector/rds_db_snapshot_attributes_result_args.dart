...
class RdsDbSnapshotAttributesResultArgs {
  ...
  RdsDbSnapshotAttributesResultArgs({
    ...
    pulumi.Output<RdsDBSnapshotAttributesResultProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<RdsDBSnapshotAttributesResultProperties>(properties),
  ...
  factory RdsDbSnapshotAttributesResultArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbSnapshotAttributesResultArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<RdsDBSnapshotAttributesResultProperties>(RdsDBSnapshotAttributesResultProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
