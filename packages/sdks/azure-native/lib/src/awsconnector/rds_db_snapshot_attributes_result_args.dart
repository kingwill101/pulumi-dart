...
class RdsDbSnapshotAttributesResultArgs {
  ...
  /// [tags] Resource tags.
  const RdsDbSnapshotAttributesResultArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory RdsDbSnapshotAttributesResultArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbSnapshotAttributesResultArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RdsDBSnapshotAttributesResultProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
