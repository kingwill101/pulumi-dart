...
class Restrictions {
  ...
  factory Restrictions.fromMap(Map<String, dynamic> map) {
    return Restrictions(
      geoRestriction: (() { final guardedValue = map['geoRestriction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GeoRestriction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
