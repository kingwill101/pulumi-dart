...
class EcrRepositoryProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEcrRepositoryProperties>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcrRepositoryProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcrRepositoryProperties.fromMap(Map<String, dynamic> map) {
    return EcrRepositoryProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcrRepositoryProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
