...
import 'aws_ec2_instance_properties.dart';
...
class Ec2InstanceProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEc2InstanceProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2InstanceProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2InstanceProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2InstanceProperties.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2InstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
