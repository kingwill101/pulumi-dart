...
class AwsElasticBeanstalkApplicationPropertiesResponse {
  ...
  final pulumi.Input<ApplicationResourceLifecycleConfigResponse>?
  ...
  factory AwsElasticBeanstalkApplicationPropertiesResponse.fromMap(
    ...
    return AwsElasticBeanstalkApplicationPropertiesResponse(
      ...
      resourceLifecycleConfig: (() {
        ...
        return pulumi.Input.fromValue(
          ApplicationResourceLifecycleConfigResponse.fromMap(
