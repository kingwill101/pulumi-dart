...
import 'aws_secrets_manager_resource_policy_properties.dart';

/// Definition of SecretsManagerResourcePolicy
class SecretsManagerResourcePolicyProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSecretsManagerResourcePolicyProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SecretsManagerResourcePolicyProperties].
  ...
  const SecretsManagerResourcePolicyProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSecretsManagerResourcePolicyProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SecretsManagerResourcePolicyProperties.fromMap(Map<String, dynamic> map) {
    return SecretsManagerResourcePolicyProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSecretsManagerResourcePolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
