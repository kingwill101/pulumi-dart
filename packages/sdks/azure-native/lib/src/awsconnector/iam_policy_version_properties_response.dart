...
import 'aws_iam_policy_version_properties_response.dart';

/// Definition of IamPolicyVersion
class IamPolicyVersionPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamPolicyVersionPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamPolicyVersionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamPolicyVersionPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamPolicyVersionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamPolicyVersionPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamPolicyVersionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
