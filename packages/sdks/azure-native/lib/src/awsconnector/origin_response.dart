...
class OriginResponse {
    ...
    return <String, dynamic>{
      ...
      'customOriginConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customOriginConfig, (value) => value.toMap()),
      'domainName': ?domainName,
      'id': ?id,
      'originAccessControlId': ?originAccessControlId,
      'originCustomHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<OriginCustomHeaderResponse>,
      ...
      'originShield':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(originShield, (value) => value.toMap()),
      's3OriginConfig':
          ?pulumi.Input.mapOptionalInputValue<
            S3OriginConfigResponse,
            Map<String, dynamic>
          >(s3OriginConfig, (value) => value.toMap()),
    };
  }
  ...
  factory OriginResponse.fromMap(Map<String, dynamic> map) {
    return OriginResponse(
      connectionAttempts: (() {
        final guardedValue = map['connectionAttempts'];
      ...
      customOriginConfig: (() {
        final guardedValue = map['customOriginConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CustomOriginConfigResponse.fromMap(
      ...
      originAccessControlId: (() {
        final guardedValue = map['originAccessControlId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      originCustomHeaders: (() {
        final guardedValue = map['originCustomHeaders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OriginCustomHeaderResponse>(
            guardedValue,
            (value) => OriginCustomHeaderResponse.fromMap(
      ...
      originShield: (() {
        final guardedValue = map['originShield'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OriginShieldResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      s3OriginConfig: (() {
        final guardedValue = map['s3OriginConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          S3OriginConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
