...
class OriginResponse {
  ...
  factory OriginResponse.fromMap(Map<String, dynamic> map) {
    return OriginResponse(
      ...
      customOriginConfig: (() { final guardedValue = map['customOriginConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomOriginConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      originCustomHeaders: (() { final guardedValue = map['originCustomHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OriginCustomHeaderResponse>(guardedValue, (value) => OriginCustomHeaderResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      originShield: (() { final guardedValue = map['originShield']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OriginShieldResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      s3OriginConfig: (() { final guardedValue = map['s3OriginConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3OriginConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
