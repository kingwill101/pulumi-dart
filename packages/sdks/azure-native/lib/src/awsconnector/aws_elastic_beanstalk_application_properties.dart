...
class AwsElasticBeanstalkApplicationProperties {
  ...
  factory AwsElasticBeanstalkApplicationProperties.fromMap(Map<String, dynamic> map) {
    return AwsElasticBeanstalkApplicationProperties(
      ...
      resourceLifecycleConfig: (() { final guardedValue = map['resourceLifecycleConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationResourceLifecycleConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
