...
import 'inference_accelerator.dart';
...
class AwsEcsTaskDefinitionProperties {
  /// A list of container definitions in JSON format that describe the different containers that make up your task. For more information about container definition parameters and defaults, see [Amazon ECS Task Definitions](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_defintions.html) in the *Amazon Elastic Container Service Developer Guide*.
  final pulumi.Input<List<ContainerDefinition>>? containerDefinitions;
  ...
  final pulumi.Input<List<InferenceAccelerator>>? inferenceAccelerators;
  ...
  final pulumi.Input<ProxyConfiguration>? proxyConfiguration;
  ...
  final pulumi.Input<RuntimePlatform>? runtimePlatform;
  ...
  /// Creates a new [AwsEcsTaskDefinitionProperties].
  ...
  factory AwsEcsTaskDefinitionProperties.fromMap(Map<String, dynamic> map) {
    return AwsEcsTaskDefinitionProperties(
      containerDefinitions: (() {
        final guardedValue = map['containerDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerDefinition>(
            guardedValue,
            (value) => ContainerDefinition.fromMap(
      ...
      inferenceAccelerators: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InferenceAccelerator>(
            guardedValue,
            (value) => InferenceAccelerator.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
