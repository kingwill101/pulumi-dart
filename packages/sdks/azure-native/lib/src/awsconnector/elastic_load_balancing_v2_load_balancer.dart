...
class ElasticLoadBalancingV2LoadBalancer extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ElasticLoadBalancingV2LoadBalancerPropertiesResponse>
  properties;
  ...
  ElasticLoadBalancingV2LoadBalancer(
    ...
    properties =
        registerOutput<ElasticLoadBalancingV2LoadBalancerPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return ElasticLoadBalancingV2LoadBalancerPropertiesResponse.fromMap(
