...
class BuildStatusConfigResponse {
  ...
  /// Creates a new [BuildStatusConfigResponse].
  ...
  BuildStatusConfigResponse({this.context, this.targetUrl});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'context': ?context, 'targetUrl': ?targetUrl};
  }

  factory BuildStatusConfigResponse.fromMap(Map<String, dynamic> map) {
    return BuildStatusConfigResponse(
      context: (() {
