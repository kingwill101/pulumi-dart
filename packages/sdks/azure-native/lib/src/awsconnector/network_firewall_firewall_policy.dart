...
class NetworkFirewallFirewallPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<NetworkFirewallFirewallPolicyPropertiesResponse>
  properties;
  ...
  NetworkFirewallFirewallPolicy(
    ...
    properties =
        registerOutput<NetworkFirewallFirewallPolicyPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return NetworkFirewallFirewallPolicyPropertiesResponse.fromMap(
