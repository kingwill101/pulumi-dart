...
class ServiceManagedEBSVolumeConfiguration {
  ...
  factory ServiceManagedEBSVolumeConfiguration.fromMap(
    ...
    return ServiceManagedEBSVolumeConfiguration(
      ...
      sizeInGiB: (() {
        final guardedValue = map['sizeInGiB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      snapshotId: (() {
      ...
      tagSpecifications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EBSTagSpecification>(
            guardedValue,
            (value) => EBSTagSpecification.fromMap(
