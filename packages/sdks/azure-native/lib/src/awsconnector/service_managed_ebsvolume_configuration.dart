...
import 'ebstag_specification.dart';
...
class ServiceManagedEBSVolumeConfiguration {
  ...
  final pulumi.Input<List<EBSTagSpecification>>? tagSpecifications;
  ...
  /// Creates a new [ServiceManagedEBSVolumeConfiguration].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tagSpecifications': ?pulumi.Input.mapOptionalInputValue<List<EBSTagSpecification>, List<Map<String, dynamic>>>(tagSpecifications, (value) => pulumi.Input.encodeList<EBSTagSpecification, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ServiceManagedEBSVolumeConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceManagedEBSVolumeConfiguration(
      ...
      tagSpecifications: (() { final guardedValue = map['tagSpecifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EBSTagSpecification>(guardedValue, (value) => EBSTagSpecification.fromMap((value as Map).cast<String, dynamic>()))); })(),
