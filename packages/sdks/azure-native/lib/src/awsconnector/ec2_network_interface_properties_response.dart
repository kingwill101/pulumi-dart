...
import 'aws_ec2_network_interface_properties_response.dart';

/// Definition of Ec2NetworkInterface
class Ec2NetworkInterfacePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2NetworkInterfacePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2NetworkInterfacePropertiesResponse].
  ...
  const Ec2NetworkInterfacePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2NetworkInterfacePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2NetworkInterfacePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkInterfacePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2NetworkInterfacePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
