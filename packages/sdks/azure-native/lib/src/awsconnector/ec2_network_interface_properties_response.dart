...
class Ec2NetworkInterfacePropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2NetworkInterfacePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2NetworkInterfacePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkInterfacePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2NetworkInterfacePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
