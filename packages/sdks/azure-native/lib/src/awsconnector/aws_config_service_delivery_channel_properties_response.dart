...
class AwsConfigServiceDeliveryChannelPropertiesResponse {
  ...
  factory AwsConfigServiceDeliveryChannelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsConfigServiceDeliveryChannelPropertiesResponse(
      configSnapshotDeliveryProperties: (() { final guardedValue = map['configSnapshotDeliveryProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigSnapshotDeliveryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
