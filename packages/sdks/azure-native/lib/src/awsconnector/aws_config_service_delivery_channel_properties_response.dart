...
class AwsConfigServiceDeliveryChannelPropertiesResponse {
  ...
  final pulumi.Input<ConfigSnapshotDeliveryPropertiesResponse>?
    ...
    return <String, dynamic>{
      'configSnapshotDeliveryProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(configSnapshotDeliveryProperties, (value) => value.toMap()),
      'name': ?name,
  ...
  factory AwsConfigServiceDeliveryChannelPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AwsConfigServiceDeliveryChannelPropertiesResponse(
      configSnapshotDeliveryProperties: (() {
        final guardedValue = map['configSnapshotDeliveryProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigSnapshotDeliveryPropertiesResponse.fromMap(
      ...
      s3KmsKeyArn: (() {
        final guardedValue = map['s3KmsKeyArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      snsTopicARN: (() {
