...
class DynamoDbTableArgs {
  ...
  DynamoDbTableArgs({
    ...
    pulumi.Output<DynamoDBTableProperties>? properties,
  ...
  factory DynamoDbTableArgs.fromMap(Map<String, dynamic> map) {
    return DynamoDbTableArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<DynamoDBTableProperties>(DynamoDBTableProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
