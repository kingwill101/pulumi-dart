...
import 'aws_redshift_cluster_properties_response.dart';

/// Definition of RedshiftCluster
class RedshiftClusterPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRedshiftClusterPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RedshiftClusterPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRedshiftClusterPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RedshiftClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRedshiftClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
