...
class AwsIamInstanceProfileProperties {
  /// Property arn
  ...
  /// Creates a new [AwsIamInstanceProfileProperties].
  /// [arn] Property arn
  ...
  const AwsIamInstanceProfileProperties({
    this.arn,
  ...
  factory AwsIamInstanceProfileProperties.fromMap(Map<String, dynamic> map) {
    return AwsIamInstanceProfileProperties(
