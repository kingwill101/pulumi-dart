...
class ConfigServiceConfigurationRecorder extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ConfigServiceConfigurationRecorderPropertiesResponse>
  properties;
  ...
  ConfigServiceConfigurationRecorder(
    ...
    properties =
        registerOutput<ConfigServiceConfigurationRecorderPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return ConfigServiceConfigurationRecorderPropertiesResponse.fromMap(
