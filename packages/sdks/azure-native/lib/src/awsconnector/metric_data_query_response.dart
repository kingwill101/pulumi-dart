...
class MetricDataQueryResponse {
  ...
  factory MetricDataQueryResponse.fromMap(Map<String, dynamic> map) {
    return MetricDataQueryResponse(
      ...
      metricStat: (() { final guardedValue = map['metricStat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MetricStatResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
