...
class ApiGatewayStagePropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsApiGatewayStagePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  const ApiGatewayStagePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsApiGatewayStagePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ApiGatewayStagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApiGatewayStagePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsApiGatewayStagePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
