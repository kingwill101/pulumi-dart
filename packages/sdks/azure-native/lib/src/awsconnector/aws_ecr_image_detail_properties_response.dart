...
class AwsEcrImageDetailPropertiesResponse {
  ...
  const AwsEcrImageDetailPropertiesResponse({
  ...
  factory AwsEcrImageDetailPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEcrImageDetailPropertiesResponse(
      ...
      imageScanFindingsSummary: (() { final guardedValue = map['imageScanFindingsSummary']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageScanFindingsSummaryResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageScanStatus: (() { final guardedValue = map['imageScanStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageScanStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageSizeInBytes: (() { final guardedValue = map['imageSizeInBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
