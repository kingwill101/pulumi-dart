...
class AwsEcrImageDetailPropertiesResponse {
  ...
  final ImageScanFindingsSummaryResponse? imageScanFindingsSummary;
  /// <p>The current state of the scan.</p>
  final ImageScanStatusResponse? imageScanStatus;
  ...
  factory AwsEcrImageDetailPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEcrImageDetailPropertiesResponse(
      ...
      imageScanFindingsSummary: map['imageScanFindingsSummary'] == null ? null : ImageScanFindingsSummaryResponse.fromMap((map['imageScanFindingsSummary'] as Map).cast<String, dynamic>()),
      imageScanStatus: map['imageScanStatus'] == null ? null : ImageScanStatusResponse.fromMap((map['imageScanStatus'] as Map).cast<String, dynamic>()),
