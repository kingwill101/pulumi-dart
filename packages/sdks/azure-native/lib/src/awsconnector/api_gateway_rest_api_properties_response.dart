...
import 'aws_api_gateway_rest_api_properties_response.dart';

/// Definition of ApiGatewayRestApi
class ApiGatewayRestApiPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsApiGatewayRestApiPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ApiGatewayRestApiPropertiesResponse].
  ...
  const ApiGatewayRestApiPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsApiGatewayRestApiPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ApiGatewayRestApiPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApiGatewayRestApiPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsApiGatewayRestApiPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
