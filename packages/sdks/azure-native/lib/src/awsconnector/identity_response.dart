...
class IdentityResponse {
  ...
  factory IdentityResponse.fromMap(Map<String, dynamic> map) {
    return IdentityResponse(
      oidc: (() { final guardedValue = map['oidc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OIDCResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
