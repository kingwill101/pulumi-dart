...
import 'aws_ecs_task_definition_properties_response.dart';

/// Definition of EcsTaskDefinition
class EcsTaskDefinitionPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcsTaskDefinitionPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcsTaskDefinitionPropertiesResponse].
  ...
  const EcsTaskDefinitionPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcsTaskDefinitionPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcsTaskDefinitionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcsTaskDefinitionPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcsTaskDefinitionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
