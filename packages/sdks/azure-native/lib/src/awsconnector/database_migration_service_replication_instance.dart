...
class DatabaseMigrationServiceReplicationInstance extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DatabaseMigrationServiceReplicationInstance] resource.
  DatabaseMigrationServiceReplicationInstance.reference(String urn)
    : super(
        'azure-native:awsconnector:DatabaseMigrationServiceReplicationInstance',
