...
import 'cache_type_enum_value_response.dart';

/// Definition of ProjectCache
class ProjectCacheResponse {
  ...
  final pulumi.Input<CacheTypeEnumValueResponse>? type;

  /// Creates a new [ProjectCacheResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'location': ?location,
      'modes': ?modes,
      'type': ?pulumi.Input.mapOptionalInputValue<CacheTypeEnumValueResponse, Map<String, dynamic>>(type, (value) => value.toMap()),
    };
  }
  ...
  factory ProjectCacheResponse.fromMap(Map<String, dynamic> map) {
    return ProjectCacheResponse(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
