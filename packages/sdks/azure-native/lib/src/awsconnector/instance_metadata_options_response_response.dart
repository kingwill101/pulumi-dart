...
class InstanceMetadataOptionsResponseResponse {
  ...
  final pulumi.Input<InstanceMetadataEndpointStateEnumValueResponse>? httpEndpoint;
  ...
  final pulumi.Input<InstanceMetadataProtocolStateEnumValueResponse>? httpProtocolIpv6;
  ...
  final pulumi.Input<InstanceMetadataTagsStateEnumValueResponse>? instanceMetadataTags;
  ...
  const InstanceMetadataOptionsResponseResponse({
    this.httpEndpoint,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpEndpoint': ?pulumi.Input.mapOptionalInputValue<InstanceMetadataEndpointStateEnumValueResponse, Map<String, dynamic>>(httpEndpoint, (value) => value.toMap()),
      'httpProtocolIpv6': ?pulumi.Input.mapOptionalInputValue<InstanceMetadataProtocolStateEnumValueResponse, Map<String, dynamic>>(httpProtocolIpv6, (value) => value.toMap()),
      'httpPutResponseHopLimit': ?httpPutResponseHopLimit,
      'httpTokens': ?pulumi.Input.mapOptionalInputValue<HttpTokensStateEnumValueResponse, Map<String, dynamic>>(httpTokens, (value) => value.toMap()),
      'instanceMetadataTags': ?pulumi.Input.mapOptionalInputValue<InstanceMetadataTagsStateEnumValueResponse, Map<String, dynamic>>(instanceMetadataTags, (value) => value.toMap()),
      'state': ?pulumi.Input.mapOptionalInputValue<InstanceMetadataOptionsStateEnumValueResponse, Map<String, dynamic>>(state, (value) => value.toMap()),
    };
  }
  ...
  factory InstanceMetadataOptionsResponseResponse.fromMap(Map<String, dynamic> map) {
    return InstanceMetadataOptionsResponseResponse(
      httpEndpoint: (() { final guardedValue = map['httpEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataEndpointStateEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpProtocolIpv6: (() { final guardedValue = map['httpProtocolIpv6']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataProtocolStateEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      httpTokens: (() { final guardedValue = map['httpTokens']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HttpTokensStateEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      instanceMetadataTags: (() { final guardedValue = map['instanceMetadataTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataTagsStateEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceMetadataOptionsStateEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
