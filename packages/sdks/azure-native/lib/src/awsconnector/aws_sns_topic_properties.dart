...
class AwsSnsTopicProperties {
    ...
    return <String, dynamic>{
      ...
      'deliveryStatusLogging':
          ...
          >(
            deliveryStatusLogging,
            (value) =>
                pulumi.Input.encodeList<LoggingConfig, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'subscription':
          ...
          >(
            subscription,
            (value) =>
                pulumi.Input.encodeList<Subscription, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsSnsTopicProperties.fromMap(Map<String, dynamic> map) {
    return AwsSnsTopicProperties(
      archivePolicy: (() {
        final guardedValue = map['archivePolicy'];
      ...
      dataProtectionPolicy: (() {
        final guardedValue = map['dataProtectionPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      deliveryStatusLogging: (() {
        final guardedValue = map['deliveryStatusLogging'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoggingConfig>(
            guardedValue,
            (value) =>
                LoggingConfig.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      displayName: (() {
      ...
      fifoTopic: (() {
        final guardedValue = map['fifoTopic'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kmsMasterKeyId: (() {
      ...
      signatureVersion: (() {
        final guardedValue = map['signatureVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subscription: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Subscription>(
            guardedValue,
            (value) =>
                Subscription.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
