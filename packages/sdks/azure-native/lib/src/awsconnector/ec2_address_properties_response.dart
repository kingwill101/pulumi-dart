...
import 'aws_ec2_address_properties_response.dart';

/// Definition of Ec2Address
class Ec2AddressPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2AddressPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2AddressPropertiesResponse].
  ...
  const Ec2AddressPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2AddressPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2AddressPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2AddressPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2AddressPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
