...
class Webhook {
  ...
  factory Webhook.fromMap(Map<String, dynamic> map) {
    return Webhook(
      ...
      buildType: (() { final guardedValue = map['buildType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebhookBuildTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      filterGroups: (() { final guardedValue = map['filterGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterGroup>(guardedValue, (value) => FilterGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
