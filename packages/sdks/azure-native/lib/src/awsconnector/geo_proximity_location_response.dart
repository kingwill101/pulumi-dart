...
class GeoProximityLocationResponse {
  ...
  final pulumi.Input<CoordinatesResponse>? coordinates;
  ...
  const GeoProximityLocationResponse({
    this.awsRegion,
    this.bias,
    this.coordinates,
    this.localZoneGroup,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'awsRegion': ?awsRegion,
      'bias': ?bias,
      'coordinates': ?pulumi.Input.mapOptionalInputValue<CoordinatesResponse, Map<String, dynamic>>(coordinates, (value) => value.toMap()),
  ...
  factory GeoProximityLocationResponse.fromMap(Map<String, dynamic> map) {
    return GeoProximityLocationResponse(
      ...
      coordinates: (() { final guardedValue = map['coordinates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CoordinatesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
