...
class LightsailBucketArgs {
  ...
  LightsailBucketArgs({
    ...
    pulumi.Output<LightsailBucketProperties>? properties,
  ...
  factory LightsailBucketArgs.fromMap(Map<String, dynamic> map) {
    return LightsailBucketArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<LightsailBucketProperties>(LightsailBucketProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
