...
class AwsOrganizationsOrganizationPropertiesResponse {
  ...
  factory AwsOrganizationsOrganizationPropertiesResponse.fromMap(
    ...
    return AwsOrganizationsOrganizationPropertiesResponse(
      ...
      managementAccountArn: (() {
        final guardedValue = map['managementAccountArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      managementAccountEmail: (() {
        final guardedValue = map['managementAccountEmail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      managementAccountId: (() {
        final guardedValue = map['managementAccountId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rootId: (() {
