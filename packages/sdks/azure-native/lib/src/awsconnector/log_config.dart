...
class LogConfig {
  ...
  factory LogConfig.fromMap(Map<String, dynamic> map) {
    return LogConfig(
      ...
      fieldLogLevel: (() { final guardedValue = map['fieldLogLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FieldLogLevelEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
