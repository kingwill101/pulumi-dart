...
class AwsEc2SnapshotPropertiesResponse {
  ...
  final pulumi.Input<SSETypeEnumValueResponse?>? sseType;
  /// &lt;p&gt;The time stamp when the snapshot was initiated.&lt;/p&gt;
  final pulumi.Input<String?>? startTime;
  /// &lt;p&gt;The snapshot state.&lt;/p&gt;
  final pulumi.Input<SnapshotStateEnumValueResponse?>? state;
  ...
  final pulumi.Input<StorageTierEnumValueResponse?>? storageTier;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sseType': ?pulumi.Input.mapOptionalInputValue<SSETypeEnumValueResponse, Map<String, dynamic>>(sseType, (value) => value.toMap()),
      'startTime': ?startTime,
      'state': ?pulumi.Input.mapOptionalInputValue<SnapshotStateEnumValueResponse, Map<String, dynamic>>(state, (value) => value.toMap()),
      'stateMessage': ?stateMessage,
      'storageTier': ?pulumi.Input.mapOptionalInputValue<StorageTierEnumValueResponse, Map<String, dynamic>>(storageTier, (value) => value.toMap()),
  ...
  factory AwsEc2SnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2SnapshotPropertiesResponse(
      ...
      sseType: (() { final guardedValue = map['sseType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SSETypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      startTime: (() { final guardedValue = map['startTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapshotStateEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      storageTier: (() { final guardedValue = map['storageTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StorageTierEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      volumeSize: (() { final guardedValue = map['volumeSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
    );
  }
}
