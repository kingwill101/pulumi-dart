...
class AwsEc2SnapshotPropertiesResponse {
  ...
  factory AwsEc2SnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2SnapshotPropertiesResponse(
      ...
      restoreExpiryTime: (() {
        final guardedValue = map['restoreExpiryTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      snapshotId: (() {
      ...
      sseType: (() {
        final guardedValue = map['sseType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSETypeEnumValueResponse.fromMap(
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SnapshotStateEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageTier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StorageTierEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
