...
class AwsEc2SnapshotPropertiesResponse {
  ...
  factory AwsEc2SnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2SnapshotPropertiesResponse(
      ...
      sseType: map['sseType'] == null ? null : (SSETypeEnumValueResponse.fromMap((map['sseType'] as Map).cast<String, dynamic>())).input(),
      startTime: map['startTime'] == null ? null : (map['startTime'] as String).input(),
      state: map['state'] == null ? null : (SnapshotStateEnumValueResponse.fromMap((map['state'] as Map).cast<String, dynamic>())).input(),
      stateMessage: map['stateMessage'] == null ? null : (map['stateMessage'] as String).input(),
      storageTier: map['storageTier'] == null ? null : (StorageTierEnumValueResponse.fromMap((map['storageTier'] as Map).cast<String, dynamic>())).input(),
