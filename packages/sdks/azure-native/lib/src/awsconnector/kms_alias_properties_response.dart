...
class KmsAliasPropertiesResponse {
  ...
  /// AWS Properties
  final AwsKmsAliasPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory KmsAliasPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return KmsAliasPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsKmsAliasPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
