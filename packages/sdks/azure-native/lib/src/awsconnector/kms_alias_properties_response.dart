...
import 'aws_kms_alias_properties_response.dart';

/// Definition of KmsAlias
class KmsAliasPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsKmsAliasPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [KmsAliasPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsKmsAliasPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory KmsAliasPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return KmsAliasPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsKmsAliasPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
