...
class S3BucketCriteriaForJobResponse {
  ...
  const S3BucketCriteriaForJobResponse({
    this.excludes,
    this.includes,
  });
  ...
  factory S3BucketCriteriaForJobResponse.fromMap(Map<String, dynamic> map) {
    return S3BucketCriteriaForJobResponse(
      excludes: (() { final guardedValue = map['excludes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CriteriaBlockForJobResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      includes: (() { final guardedValue = map['includes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CriteriaBlockForJobResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
