...
class AwsNetworkFirewallRuleGroupPropertiesResponse {
  ...
  factory AwsNetworkFirewallRuleGroupPropertiesResponse.fromMap(
    ...
    return AwsNetworkFirewallRuleGroupPropertiesResponse(
      ...
      ruleGroup: (() {
        ...
        return pulumi.Input.fromValue(
          RuleGroupResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ruleGroupArn: (() {
        final guardedValue = map['ruleGroupArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ruleGroupId: (() {
        final guardedValue = map['ruleGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ruleGroupName: (() {
