    ...
    return <String, dynamic>{
      ...
      'fileSystemProtection':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(fileSystemProtection, (value) => value.toMap()),
      'fileSystemTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<ElasticFileSystemTagResponse>,
  ...
  factory AwsEfsFileSystemPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEfsFileSystemPropertiesResponse(
      ...
      availabilityZoneName: (() {
        final guardedValue = map['availabilityZoneName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      backupPolicy: (() {
      ...
      fileSystemPolicy: (() {
        final guardedValue = map['fileSystemPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue);
      })(),
      fileSystemProtection: (() {
        final guardedValue = map['fileSystemProtection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FileSystemProtectionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fileSystemTags: (() {
        final guardedValue = map['fileSystemTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ElasticFileSystemTagResponse>(
            guardedValue,
            (value) => ElasticFileSystemTagResponse.fromMap(
      ...
      lifecyclePolicies: (() {
        final guardedValue = map['lifecyclePolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      performanceMode: (() {
        final guardedValue = map['performanceMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      provisionedThroughputInMibps: (() {
        final guardedValue = map['provisionedThroughputInMibps'];
        if (guardedValue == null) return null;
