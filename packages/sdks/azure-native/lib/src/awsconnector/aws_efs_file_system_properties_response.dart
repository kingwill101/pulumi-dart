...
class AwsEfsFileSystemPropertiesResponse {
  ...
  final pulumi.Input<FileSystemProtectionResponse>? fileSystemProtection;
  /// Use to create one or more tags associated with the file system. Each tag is a user-defined key-value pair. Name your file system on creation by including a ``'Key':'Name','Value':'{value}'`` key-value pair. Each key must be unique. For more information, see [Tagging resources](https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) in the *General Reference Guide*.
  final pulumi.Input<List<ElasticFileSystemTagResponse>>? fileSystemTags;
  ...
  factory AwsEfsFileSystemPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEfsFileSystemPropertiesResponse(
      ...
      fileSystemProtection: map['fileSystemProtection'] == null ? null : (FileSystemProtectionResponse.fromMap((map['fileSystemProtection']! as Map).cast<String, dynamic>())).input(),
      fileSystemTags: map['fileSystemTags'] == null ? null : (pulumi.Input.decodeList<ElasticFileSystemTagResponse>(map['fileSystemTags']!, (value) => ElasticFileSystemTagResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      kmsKeyId: map['kmsKeyId'] == null ? null : (map['kmsKeyId']! as String).input(),
      lifecyclePolicies: map['lifecyclePolicies'] == null ? null : (pulumi.Input.decodeList<LifecyclePolicyResponse>(map['lifecyclePolicies']!, (value) => LifecyclePolicyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
