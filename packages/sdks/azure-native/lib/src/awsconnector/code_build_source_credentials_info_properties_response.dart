...
class CodeBuildSourceCredentialsInfoPropertiesResponse {
  ...
  /// AWS Properties
  final AwsCodeBuildSourceCredentialsInfoPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory CodeBuildSourceCredentialsInfoPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CodeBuildSourceCredentialsInfoPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCodeBuildSourceCredentialsInfoPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
