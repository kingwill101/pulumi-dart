...
class CodeBuildSourceCredentialsInfoPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsCodeBuildSourceCredentialsInfoPropertiesResponse>?
  awsProperties;
  ...
  factory CodeBuildSourceCredentialsInfoPropertiesResponse.fromMap(
    ...
    return CodeBuildSourceCredentialsInfoPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsCodeBuildSourceCredentialsInfoPropertiesResponse.fromMap(
