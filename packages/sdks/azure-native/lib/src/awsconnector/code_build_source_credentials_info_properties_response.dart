...
import 'aws_code_build_source_credentials_info_properties_response.dart';

/// Definition of CodeBuildSourceCredentialsInfo
class CodeBuildSourceCredentialsInfoPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCodeBuildSourceCredentialsInfoPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CodeBuildSourceCredentialsInfoPropertiesResponse].
  ...
  const CodeBuildSourceCredentialsInfoPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCodeBuildSourceCredentialsInfoPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CodeBuildSourceCredentialsInfoPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CodeBuildSourceCredentialsInfoPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCodeBuildSourceCredentialsInfoPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
