...
class Ec2VpcPeeringConnection extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Ec2VPCPeeringConnectionPropertiesResponse>
  properties;
  ...
  Ec2VpcPeeringConnection(
    ...
    properties = registerOutput<Ec2VPCPeeringConnectionPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return Ec2VPCPeeringConnectionPropertiesResponse.fromMap(
