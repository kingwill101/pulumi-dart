...
import 'aws_iam_role_properties.dart';

/// Definition of IamRole
class IamRoleProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamRoleProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamRoleProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamRoleProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamRoleProperties.fromMap(Map<String, dynamic> map) {
    return IamRoleProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamRoleProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
