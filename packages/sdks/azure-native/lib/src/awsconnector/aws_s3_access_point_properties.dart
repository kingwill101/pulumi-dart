...
class AwsS3AccessPointProperties {
  ...
  final pulumi.Input<dynamic>? networkOrigin;
  ...
  const AwsS3AccessPointProperties({
    this.alias,
    this.arn,
    this.bucket,
  ...
  factory AwsS3AccessPointProperties.fromMap(Map<String, dynamic> map) {
    return AwsS3AccessPointProperties(
      ...
      networkOrigin: (() { final guardedValue = map['networkOrigin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
