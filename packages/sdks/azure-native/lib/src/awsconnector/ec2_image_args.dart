...
class Ec2ImageArgs {
  ...
  factory Ec2ImageArgs.fromMap(Map<String, dynamic> map) {
    return Ec2ImageArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2ImageProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
