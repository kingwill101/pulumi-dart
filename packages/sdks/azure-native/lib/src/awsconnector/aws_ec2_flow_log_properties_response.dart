...
class AwsEc2FlowLogPropertiesResponse {
  ...
  factory AwsEc2FlowLogPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2FlowLogPropertiesResponse(
      ...
      destinationOptions: map['destinationOptions'] == null ? null : (DestinationOptionsModelPropertiesResponse.fromMap((map['destinationOptions']! as Map).cast<String, dynamic>())).input(),
