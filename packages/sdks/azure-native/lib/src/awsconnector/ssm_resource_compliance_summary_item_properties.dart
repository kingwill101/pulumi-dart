...
class SsmResourceComplianceSummaryItemProperties {
  ...
  /// AWS Properties
  final AwsSsmResourceComplianceSummaryItemProperties? awsProperties;
  /// AWS Region
  ...
  factory SsmResourceComplianceSummaryItemProperties.fromMap(Map<String, dynamic> map) {
    return SsmResourceComplianceSummaryItemProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSsmResourceComplianceSummaryItemProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
