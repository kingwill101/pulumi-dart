...
import 'aws_ssm_resource_compliance_summary_item_properties.dart';
...
class SsmResourceComplianceSummaryItemProperties {
  ...
  /// Creates a new [SsmResourceComplianceSummaryItemProperties].
  ...
  const SsmResourceComplianceSummaryItemProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory SsmResourceComplianceSummaryItemProperties.fromMap(Map<String, dynamic> map) {
    return SsmResourceComplianceSummaryItemProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSsmResourceComplianceSummaryItemProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
