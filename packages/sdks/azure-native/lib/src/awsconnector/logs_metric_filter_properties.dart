...
class LogsMetricFilterProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsLogsMetricFilterProperties>? awsProperties;
  /// AWS Region
  ...
  const LogsMetricFilterProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsMetricFilterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsMetricFilterProperties.fromMap(Map<String, dynamic> map) {
    return LogsMetricFilterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsMetricFilterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
