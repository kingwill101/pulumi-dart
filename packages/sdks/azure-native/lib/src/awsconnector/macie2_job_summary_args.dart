...
class Macie2JobSummaryArgs {
  ...
  factory Macie2JobSummaryArgs.fromMap(Map<String, dynamic> map) {
    return Macie2JobSummaryArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Macie2JobSummaryProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
