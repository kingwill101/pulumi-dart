...
class Macie2JobSummaryArgs {
  ...
  Macie2JobSummaryArgs({
    ...
    pulumi.Output<Macie2JobSummaryProperties>? properties,
  ...
  factory Macie2JobSummaryArgs.fromMap(Map<String, dynamic> map) {
    return Macie2JobSummaryArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Macie2JobSummaryProperties>(Macie2JobSummaryProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
