    ...
    return <String, dynamic>{
      ...
      'methodSettings':
          ...
          >(
            methodSettings,
            (value) =>
                pulumi.Input.encodeList<MethodSetting, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsApiGatewayStageProperties.fromMap(Map<String, dynamic> map) {
    return AwsApiGatewayStageProperties(
      ...
      canarySetting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CanarySetting.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      clientCertificateId: (() {
      ...
      methodSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MethodSetting>(
            guardedValue,
            (value) =>
                MethodSetting.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      restApiId: (() {
