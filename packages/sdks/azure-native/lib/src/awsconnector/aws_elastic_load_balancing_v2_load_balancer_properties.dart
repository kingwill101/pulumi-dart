...
class AwsElasticLoadBalancingV2LoadBalancerProperties {
  ...
  factory AwsElasticLoadBalancingV2LoadBalancerProperties.fromMap(Map<String, dynamic> map) {
    return AwsElasticLoadBalancingV2LoadBalancerProperties(
      ...
      loadBalancerAttributes: (() { final guardedValue = map['loadBalancerAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LoadBalancerAttribute>(guardedValue, (value) => LoadBalancerAttribute.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      subnetMappings: (() { final guardedValue = map['subnetMappings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubnetMapping>(guardedValue, (value) => SubnetMapping.fromMap((value as Map).cast<String, dynamic>()))); })(),
