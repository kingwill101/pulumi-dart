...
class CloudWatchAlarmPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudWatchAlarmPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudWatchAlarmPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudWatchAlarmPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudWatchAlarmPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
