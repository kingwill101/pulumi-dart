...
class InstanceStatusEvent {
  ...
  factory InstanceStatusEvent.fromMap(Map<String, dynamic> map) {
    return InstanceStatusEvent(
      code: (() { final guardedValue = map['code']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventCodeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
