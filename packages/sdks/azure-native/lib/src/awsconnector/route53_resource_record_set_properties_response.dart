...
import 'aws_route53_resource_record_set_properties_response.dart';

/// Definition of Route53ResourceRecordSet
class Route53ResourceRecordSetPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRoute53ResourceRecordSetPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Route53ResourceRecordSetPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRoute53ResourceRecordSetPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Route53ResourceRecordSetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Route53ResourceRecordSetPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRoute53ResourceRecordSetPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
