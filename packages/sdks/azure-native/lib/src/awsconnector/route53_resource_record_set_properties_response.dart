...
class Route53ResourceRecordSetPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsRoute53ResourceRecordSetPropertiesResponse>?
  awsProperties;
  ...
  factory Route53ResourceRecordSetPropertiesResponse.fromMap(
    ...
    return Route53ResourceRecordSetPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsRoute53ResourceRecordSetPropertiesResponse.fromMap(
