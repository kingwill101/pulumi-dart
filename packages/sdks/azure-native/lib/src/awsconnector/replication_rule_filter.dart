...
class ReplicationRuleFilter {
  ...
  ReplicationRuleFilter({this.and, this.prefix, this.tagFilter});
    ...
    return <String, dynamic>{
      'and':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(and, (value) => value.toMap()),
      'prefix': ?prefix,
      'tagFilter':
          ?pulumi.Input.mapOptionalInputValue<TagFilter, Map<String, dynamic>>(
            tagFilter,
            (value) => value.toMap(),
          ),
    };
    ...
    return ReplicationRuleFilter(
      and: (() {
        ...
        return pulumi.Input.fromValue(
          ReplicationRuleAndOperator.fromMap(
      ...
      tagFilter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TagFilter.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
