...
import 'aws_ssm_instance_information_properties_response.dart';

/// Definition of SsmInstanceInformation
class SsmInstanceInformationPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSsmInstanceInformationPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SsmInstanceInformationPropertiesResponse].
  ...
  const SsmInstanceInformationPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSsmInstanceInformationPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SsmInstanceInformationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SsmInstanceInformationPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSsmInstanceInformationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
