...
class SsmInstanceInformationPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSsmInstanceInformationPropertiesResponse>?
  awsProperties;
  ...
  factory SsmInstanceInformationPropertiesResponse.fromMap(
    ...
    return SsmInstanceInformationPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsSsmInstanceInformationPropertiesResponse.fromMap(
