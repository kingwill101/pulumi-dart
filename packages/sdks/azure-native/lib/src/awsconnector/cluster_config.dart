...
class ClusterConfig {
  ...
  final OpenSearchPartitionInstanceTypeEnumValue? dedicatedMasterType;
  ...
  final OpenSearchPartitionInstanceTypeEnumValue? instanceType;
  ...
  final OpenSearchWarmPartitionInstanceTypeEnumValue? warmType;
  ...
  factory ClusterConfig.fromMap(Map<String, dynamic> map) {
    return ClusterConfig(
      coldStorageOptions: map['coldStorageOptions'] == null ? null : ColdStorageOptions.fromMap((map['coldStorageOptions'] as Map).cast<String, dynamic>()),
      ...
      dedicatedMasterType: map['dedicatedMasterType'] == null ? null : OpenSearchPartitionInstanceTypeEnumValue.fromMap((map['dedicatedMasterType'] as Map).cast<String, dynamic>()),
      instanceCount: map['instanceCount'] == null ? null : map['instanceCount'] as int,
      instanceType: map['instanceType'] == null ? null : OpenSearchPartitionInstanceTypeEnumValue.fromMap((map['instanceType'] as Map).cast<String, dynamic>()),
      ...
      warmType: map['warmType'] == null ? null : OpenSearchWarmPartitionInstanceTypeEnumValue.fromMap((map['warmType'] as Map).cast<String, dynamic>()),
      zoneAwarenessConfig: map['zoneAwarenessConfig'] == null ? null : ZoneAwarenessConfig.fromMap((map['zoneAwarenessConfig'] as Map).cast<String, dynamic>()),
