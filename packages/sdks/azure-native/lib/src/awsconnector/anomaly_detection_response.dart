...
class AnomalyDetectionResponse {
  ...
  final pulumi.Input<MitigationInEffectEnumEnumValueResponse>?
  mitigationInEffect;
  ...
  AnomalyDetectionResponse({this.mitigationInEffect, this.result});
    ...
    return AnomalyDetectionResponse(
      mitigationInEffect: (() {
        ...
        return pulumi.Input.fromValue(
          MitigationInEffectEnumEnumValueResponse.fromMap(
      ...
      result: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AnomalyResultEnumEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
