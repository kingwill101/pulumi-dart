...
import 'aws_rds_dbinstance_properties_response.dart';

/// Definition of RdsDBInstance
class RdsDBInstancePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsDBInstancePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsDBInstancePropertiesResponse].
  ...
  const RdsDBInstancePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsDBInstancePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsDBInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBInstancePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBInstancePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
