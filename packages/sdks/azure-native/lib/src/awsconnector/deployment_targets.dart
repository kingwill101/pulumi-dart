...
class DeploymentTargets {
  ...
  final pulumi.Input<dynamic>? accountFilterType;
  ...
  factory DeploymentTargets.fromMap(Map<String, dynamic> map) {
    return DeploymentTargets(
      accountFilterType: (() { final guardedValue = map['accountFilterType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
