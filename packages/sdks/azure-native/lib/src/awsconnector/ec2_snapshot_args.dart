...
class Ec2SnapshotArgs {
  ...
  Ec2SnapshotArgs({
    ...
    pulumi.Output<Ec2SnapshotProperties>? properties,
  ...
  factory Ec2SnapshotArgs.fromMap(Map<String, dynamic> map) {
    return Ec2SnapshotArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Ec2SnapshotProperties>(Ec2SnapshotProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
