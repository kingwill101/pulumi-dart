...
class DynamoDbContinuousBackupsDescriptionArgs {
  ...
  /// [tags] Resource tags.
  const DynamoDbContinuousBackupsDescriptionArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory DynamoDbContinuousBackupsDescriptionArgs.fromMap(Map<String, dynamic> map) {
    return DynamoDbContinuousBackupsDescriptionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DynamoDBContinuousBackupsDescriptionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
