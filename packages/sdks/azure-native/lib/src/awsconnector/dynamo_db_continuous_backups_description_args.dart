...
class DynamoDbContinuousBackupsDescriptionArgs {
  ...
  DynamoDbContinuousBackupsDescriptionArgs({
    ...
    pulumi.Output<DynamoDBContinuousBackupsDescriptionProperties>? properties,
  ...
  factory DynamoDbContinuousBackupsDescriptionArgs.fromMap(Map<String, dynamic> map) {
    return DynamoDbContinuousBackupsDescriptionArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<DynamoDBContinuousBackupsDescriptionProperties>(DynamoDBContinuousBackupsDescriptionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
