...
class ReplicationDestination {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessControlTranslation': ?pulumi.Input.mapOptionalInputValue<AccessControlTranslation, Map<String, dynamic>>(accessControlTranslation, (value) => value.toMap()),
      'account': ?account,
      ...
      'region': ?region,
      'replicationTime': ?pulumi.Input.mapOptionalInputValue<ReplicationTime, Map<String, dynamic>>(replicationTime, (value) => value.toMap()),
  ...
  factory ReplicationDestination.fromMap(Map<String, dynamic> map) {
    return ReplicationDestination(
      accessControlTranslation: map['accessControlTranslation'] == null ? null : (AccessControlTranslation.fromMap((map['accessControlTranslation']! as Map).cast<String, dynamic>())).input(),
      ...
      replicationTime: map['replicationTime'] == null ? null : (ReplicationTime.fromMap((map['replicationTime']! as Map).cast<String, dynamic>())).input(),
