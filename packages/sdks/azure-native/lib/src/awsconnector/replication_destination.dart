...
class ReplicationDestination {
  ...
  factory ReplicationDestination.fromMap(Map<String, dynamic> map) {
    return ReplicationDestination(
      accessControlTranslation: (() { final guardedValue = map['accessControlTranslation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessControlTranslation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
