...
import 'aws_organizations_organization_properties.dart';

/// Definition of OrganizationsOrganization
class OrganizationsOrganizationProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsOrganizationsOrganizationProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [OrganizationsOrganizationProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsOrganizationsOrganizationProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory OrganizationsOrganizationProperties.fromMap(Map<String, dynamic> map) {
    return OrganizationsOrganizationProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsOrganizationsOrganizationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
