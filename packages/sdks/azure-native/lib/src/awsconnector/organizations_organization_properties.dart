...
class OrganizationsOrganizationProperties {
  ...
  /// AWS Properties
  final AwsOrganizationsOrganizationProperties? awsProperties;
  /// AWS Region
  ...
  factory OrganizationsOrganizationProperties.fromMap(Map<String, dynamic> map) {
    return OrganizationsOrganizationProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsOrganizationsOrganizationProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
