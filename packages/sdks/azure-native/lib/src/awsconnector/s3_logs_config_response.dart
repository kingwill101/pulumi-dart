...
class S3LogsConfigResponse {
  ...
  factory S3LogsConfigResponse.fromMap(Map<String, dynamic> map) {
    return S3LogsConfigResponse(
      bucketOwnerAccess: (() { final guardedValue = map['bucketOwnerAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketOwnerAccessEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
