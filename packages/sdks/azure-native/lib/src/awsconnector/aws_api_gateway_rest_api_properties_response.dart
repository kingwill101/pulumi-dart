...
class AwsApiGatewayRestApiPropertiesResponse {
  ...
  final S3LocationResponse? bodyS3Location;
  ...
  factory AwsApiGatewayRestApiPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsApiGatewayRestApiPropertiesResponse(
      ...
      bodyS3Location: map['bodyS3Location'] == null ? null : S3LocationResponse.fromMap((map['bodyS3Location'] as Map).cast<String, dynamic>()),
      ...
      endpointConfiguration: map['endpointConfiguration'] == null ? null : EndpointConfigurationResponse.fromMap((map['endpointConfiguration'] as Map).cast<String, dynamic>()),
