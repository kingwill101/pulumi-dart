...
class Ec2Vpc extends pulumi.CustomResource {
  ...
  Ec2Vpc(String name, {Ec2VpcArgs? args, pulumi.CustomResourceOptions? options})
    : super(
    ...
    properties = registerOutput<Ec2VpcPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return Ec2VpcPropertiesResponse.fromMap(
