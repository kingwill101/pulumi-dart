...
class MacieAllowListPropertiesResponse {
  ...
  /// AWS Properties
  final AwsMacieAllowListPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory MacieAllowListPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MacieAllowListPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsMacieAllowListPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
