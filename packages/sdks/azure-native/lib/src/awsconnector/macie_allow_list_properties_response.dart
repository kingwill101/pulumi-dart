...
import 'aws_macie_allow_list_properties_response.dart';

/// Definition of MacieAllowList
class MacieAllowListPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsMacieAllowListPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [MacieAllowListPropertiesResponse].
  ...
  const MacieAllowListPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsMacieAllowListPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory MacieAllowListPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MacieAllowListPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsMacieAllowListPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
