...
class ReplicationConfigurationResponse {
  ...
  final List<ReplicationDestinationResponse>? destinations;
  ...
  final List<ReplicationRuleResponse>? rules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinations': ?destinations == null ? null : pulumi.Input.encodeList<ReplicationDestinationResponse, Map<String, dynamic>>(destinations!, (value) => value.toMap()),
      'role': ?role,
      'rules': ?rules == null ? null : pulumi.Input.encodeList<ReplicationRuleResponse, Map<String, dynamic>>(rules!, (value) => value.toMap()),
    };
  }

  factory ReplicationConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigurationResponse(
      destinations: map['destinations'] == null ? null : pulumi.Input.decodeList<ReplicationDestinationResponse>(map['destinations'], (value) => ReplicationDestinationResponse.fromMap((value as Map).cast<String, dynamic>())),
      role: map['role'] == null ? null : map['role'] as String,
      rules: map['rules'] == null ? null : pulumi.Input.decodeList<ReplicationRuleResponse>(map['rules'], (value) => ReplicationRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
