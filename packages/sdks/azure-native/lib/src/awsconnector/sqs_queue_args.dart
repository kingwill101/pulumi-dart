...
class SqsQueueArgs {
  ...
  SqsQueueArgs({
    ...
    pulumi.Output<SqsQueueProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<SqsQueueProperties>(properties),
  ...
  factory SqsQueueArgs.fromMap(Map<String, dynamic> map) {
    return SqsQueueArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<SqsQueueProperties>(SqsQueueProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
