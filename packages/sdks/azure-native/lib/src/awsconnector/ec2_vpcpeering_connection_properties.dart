...
class Ec2VPCPeeringConnectionProperties {
  ...
  /// AWS Properties
  final AwsEc2VPCPeeringConnectionProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2VPCPeeringConnectionProperties.fromMap(Map<String, dynamic> map) {
    return Ec2VPCPeeringConnectionProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2VPCPeeringConnectionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
