...
import 'aws_ec2_vpcpeering_connection_properties.dart';

/// Definition of Ec2VPCPeeringConnection
class Ec2VPCPeeringConnectionProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2VPCPeeringConnectionProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2VPCPeeringConnectionProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2VPCPeeringConnectionProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2VPCPeeringConnectionProperties.fromMap(Map<String, dynamic> map) {
    return Ec2VPCPeeringConnectionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2VPCPeeringConnectionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
