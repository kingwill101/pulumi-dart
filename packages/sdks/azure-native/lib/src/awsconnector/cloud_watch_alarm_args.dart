...
class CloudWatchAlarmArgs {
  ...
  factory CloudWatchAlarmArgs.fromMap(Map<String, dynamic> map) {
    return CloudWatchAlarmArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudWatchAlarmProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
