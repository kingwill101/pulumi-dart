...
class OriginGroupMembersResponse {
  ...
  OriginGroupMembersResponse({this.items, this.quantity});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'items':
          ?pulumi.Input.mapOptionalInputValue<
            List<OriginGroupMemberResponse>,
    ...
    return OriginGroupMembersResponse(
      items: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OriginGroupMemberResponse>(
            guardedValue,
            (value) => OriginGroupMemberResponse.fromMap(
