...
class InstanceStatusSummary {
  ...
  InstanceStatusSummary({this.details, this.status});
    ...
    return InstanceStatusSummary(
      details: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InstanceStatusDetails>(
            guardedValue,
            (value) => InstanceStatusDetails.fromMap(
      ...
      status: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SummaryStatusEnumValue.fromMap(
