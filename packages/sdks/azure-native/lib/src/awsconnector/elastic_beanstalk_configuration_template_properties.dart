...
import 'aws_elastic_beanstalk_configuration_template_properties.dart';

/// Definition of ElasticBeanstalkConfigurationTemplate
class ElasticBeanstalkConfigurationTemplateProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkConfigurationTemplateProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticBeanstalkConfigurationTemplateProperties].
  ...
  const ElasticBeanstalkConfigurationTemplateProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticBeanstalkConfigurationTemplateProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticBeanstalkConfigurationTemplateProperties.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkConfigurationTemplateProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticBeanstalkConfigurationTemplateProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
