...
import 'aws_s3_access_control_policy_properties_response.dart';

/// Definition of S3AccessControlPolicy
class S3AccessControlPolicyPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsS3AccessControlPolicyPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3AccessControlPolicyPropertiesResponse].
  ...
  const S3AccessControlPolicyPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3AccessControlPolicyPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3AccessControlPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3AccessControlPolicyPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3AccessControlPolicyPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
