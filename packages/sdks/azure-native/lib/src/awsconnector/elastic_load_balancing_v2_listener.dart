...
class ElasticLoadBalancingV2Listener extends pulumi.CustomResource {
  ...
  ElasticLoadBalancingV2Listener(
    ...
    properties = registerOutput<ElasticLoadBalancingV2ListenerPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ElasticLoadBalancingV2ListenerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ElasticLoadBalancingV2Listener] resource.
  ElasticLoadBalancingV2Listener.reference(String urn)
    : super(
        'azure-native:awsconnector:ElasticLoadBalancingV2Listener',
