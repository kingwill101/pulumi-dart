...
class ElasticLoadBalancingV2Listener extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ElasticLoadBalancingV2ListenerPropertiesResponse>
  properties;
  ...
  ElasticLoadBalancingV2Listener(
    ...
    properties =
        registerOutput<ElasticLoadBalancingV2ListenerPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return ElasticLoadBalancingV2ListenerPropertiesResponse.fromMap(
