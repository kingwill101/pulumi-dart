...
import 'aws_api_gateway_stage_properties.dart';

/// Definition of ApiGatewayStage
class ApiGatewayStageProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsApiGatewayStageProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ApiGatewayStageProperties].
  ...
  const ApiGatewayStageProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsApiGatewayStageProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ApiGatewayStageProperties.fromMap(Map<String, dynamic> map) {
    return ApiGatewayStageProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsApiGatewayStageProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
