...
class RuntimeManagementConfig {
  ...
  final pulumi.Input<dynamic>? updateRuntimeOn;
  ...
  factory RuntimeManagementConfig.fromMap(Map<String, dynamic> map) {
    return RuntimeManagementConfig(
      ...
      updateRuntimeOn: (() { final guardedValue = map['updateRuntimeOn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
