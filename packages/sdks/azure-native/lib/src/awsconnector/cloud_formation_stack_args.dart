...
class CloudFormationStackArgs {
  ...
  CloudFormationStackArgs({
    ...
    pulumi.Output<CloudFormationStackProperties>? properties,
  ...
  factory CloudFormationStackArgs.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<CloudFormationStackProperties>(CloudFormationStackProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
