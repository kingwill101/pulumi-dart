...
class Route53DomainsDomainSummary extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Route53DomainsDomainSummaryPropertiesResponse>
  properties;
  ...
  Route53DomainsDomainSummary(
    ...
    properties = registerOutput<Route53DomainsDomainSummaryPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return Route53DomainsDomainSummaryPropertiesResponse.fromMap(
