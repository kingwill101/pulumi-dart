...
class RedshiftClusterParameterGroupArgs {
  ...
  RedshiftClusterParameterGroupArgs({
    ...
    pulumi.Output<RedshiftClusterParameterGroupProperties>? properties,
  ...
  factory RedshiftClusterParameterGroupArgs.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterParameterGroupArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<RedshiftClusterParameterGroupProperties>(RedshiftClusterParameterGroupProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
