...
class RdsDBSnapshotAttributesResultProperties {
  ...
  /// AWS Properties
  final AwsRdsDBSnapshotAttributesResultProperties? awsProperties;
  /// AWS Region
  ...
  factory RdsDBSnapshotAttributesResultProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotAttributesResultProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBSnapshotAttributesResultProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
