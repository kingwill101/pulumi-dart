...
import 'aws_rds_dbsnapshot_attributes_result_properties.dart';

/// Definition of RdsDBSnapshotAttributesResult
class RdsDBSnapshotAttributesResultProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsDBSnapshotAttributesResultProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsDBSnapshotAttributesResultProperties].
  ...
  const RdsDBSnapshotAttributesResultProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsDBSnapshotAttributesResultProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsDBSnapshotAttributesResultProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotAttributesResultProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBSnapshotAttributesResultProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
