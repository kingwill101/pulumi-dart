...
class RdsEventSubscriptionPropertiesResponse {
  ...
  /// AWS Properties
  final AwsRdsEventSubscriptionPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory RdsEventSubscriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsEventSubscriptionPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsEventSubscriptionPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
