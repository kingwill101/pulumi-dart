...
import 'aws_rds_event_subscription_properties_response.dart';

/// Definition of RdsEventSubscription
class RdsEventSubscriptionPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsEventSubscriptionPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsEventSubscriptionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsEventSubscriptionPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsEventSubscriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsEventSubscriptionPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsEventSubscriptionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
