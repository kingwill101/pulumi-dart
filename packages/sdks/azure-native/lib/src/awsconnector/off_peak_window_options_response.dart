...
class OffPeakWindowOptionsResponse {
  ...
  const OffPeakWindowOptionsResponse({
    this.enabled,
    this.offPeakWindow,
  });
  ...
  factory OffPeakWindowOptionsResponse.fromMap(Map<String, dynamic> map) {
    return OffPeakWindowOptionsResponse(
      ...
      offPeakWindow: (() { final guardedValue = map['offPeakWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OffPeakWindowResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
