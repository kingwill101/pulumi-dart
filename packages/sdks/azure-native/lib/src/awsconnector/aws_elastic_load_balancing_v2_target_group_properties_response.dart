...
class AwsElasticLoadBalancingV2TargetGroupPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetGroupAttributes':
          ?pulumi.Input.mapOptionalInputValue<
            List<TargetGroupAttributeResponse>,
            List<Map<String, dynamic>>
          >(
            targetGroupAttributes,
            (value) =>
      ...
      'targets':
          ?pulumi.Input.mapOptionalInputValue<
            List<TargetDescriptionResponse>,
            List<Map<String, dynamic>>
          >(
            targets,
            (value) =>
  ...
  factory AwsElasticLoadBalancingV2TargetGroupPropertiesResponse.fromMap(
    ...
    return AwsElasticLoadBalancingV2TargetGroupPropertiesResponse(
      ...
      targetGroupAttributes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TargetGroupAttributeResponse>(
            guardedValue,
            (value) => TargetGroupAttributeResponse.fromMap(
      ...
      targets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TargetDescriptionResponse>(
            guardedValue,
            (value) => TargetDescriptionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
