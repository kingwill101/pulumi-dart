...
class DaxClusterArgs {
  ...
  DaxClusterArgs({
    ...
    pulumi.Output<DaxClusterProperties>? properties,
  ...
  factory DaxClusterArgs.fromMap(Map<String, dynamic> map) {
    return DaxClusterArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<DaxClusterProperties>(DaxClusterProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
