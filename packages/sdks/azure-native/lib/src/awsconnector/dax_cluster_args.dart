...
class DaxClusterArgs {
  ...
  factory DaxClusterArgs.fromMap(Map<String, dynamic> map) {
    return DaxClusterArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DaxClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
