...
import 'aws_iam_server_certificate_properties.dart';

/// Definition of IamServerCertificate
class IamServerCertificateProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamServerCertificateProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamServerCertificateProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamServerCertificateProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamServerCertificateProperties.fromMap(Map<String, dynamic> map) {
    return IamServerCertificateProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamServerCertificateProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
