...
class VolumeResponse {
  ...
  final pulumi.Input<DockerVolumeConfigurationResponse>?
  ...
  final pulumi.Input<FSxWindowsFileServerVolumeConfigurationResponse>?
    ...
    return <String, dynamic>{
      ...
      'dockerVolumeConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dockerVolumeConfiguration, (value) => value.toMap()),
      'efsVolumeConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            EFSVolumeConfigurationResponse,
            Map<String, dynamic>
          >(efsVolumeConfiguration, (value) => value.toMap()),
      'fSxWindowsFileServerVolumeConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FSxWindowsFileServerVolumeConfigurationResponse,
            Map<String, dynamic>
          >(fSxWindowsFileServerVolumeConfiguration, (value) => value.toMap()),
      'host':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory VolumeResponse.fromMap(Map<String, dynamic> map) {
    return VolumeResponse(
      configuredAtLaunch: (() {
        final guardedValue = map['configuredAtLaunch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      dockerVolumeConfiguration: (() {
        final guardedValue = map['dockerVolumeConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DockerVolumeConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      efsVolumeConfiguration: (() {
        final guardedValue = map['efsVolumeConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EFSVolumeConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fSxWindowsFileServerVolumeConfiguration: (() {
        final guardedValue = map['fSxWindowsFileServerVolumeConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FSxWindowsFileServerVolumeConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      host: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HostVolumePropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
