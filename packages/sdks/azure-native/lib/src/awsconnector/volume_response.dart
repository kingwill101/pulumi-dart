...
class VolumeResponse {
  ...
  final DockerVolumeConfigurationResponse? dockerVolumeConfiguration;
  ...
  final EFSVolumeConfigurationResponse? efsVolumeConfiguration;
  ...
  final FSxWindowsFileServerVolumeConfigurationResponse? fSxWindowsFileServerVolumeConfiguration;
  ...
  final HostVolumePropertiesResponse? host;
  ...
  factory VolumeResponse.fromMap(Map<String, dynamic> map) {
    return VolumeResponse(
      configuredAtLaunch: map['configuredAtLaunch'] == null ? null : map['configuredAtLaunch'] as bool,
      dockerVolumeConfiguration: map['dockerVolumeConfiguration'] == null ? null : DockerVolumeConfigurationResponse.fromMap((map['dockerVolumeConfiguration'] as Map).cast<String, dynamic>()),
      efsVolumeConfiguration: map['efsVolumeConfiguration'] == null ? null : EFSVolumeConfigurationResponse.fromMap((map['efsVolumeConfiguration'] as Map).cast<String, dynamic>()),
      fSxWindowsFileServerVolumeConfiguration: map['fSxWindowsFileServerVolumeConfiguration'] == null ? null : FSxWindowsFileServerVolumeConfigurationResponse.fromMap((map['fSxWindowsFileServerVolumeConfiguration'] as Map).cast<String, dynamic>()),
      host: map['host'] == null ? null : HostVolumePropertiesResponse.fromMap((map['host'] as Map).cast<String, dynamic>()),
