...
class ExecuteCommandConfiguration {
  ...
  const ExecuteCommandConfiguration({
    this.kmsKeyId,
  ...
  factory ExecuteCommandConfiguration.fromMap(Map<String, dynamic> map) {
    return ExecuteCommandConfiguration(
      ...
      logConfiguration: (() { final guardedValue = map['logConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExecuteCommandLogConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
