...
class AwsKmsKeyPropertiesResponse {
  /// Property arn
  ...
  /// Creates a new [AwsKmsKeyPropertiesResponse].
  /// [arn] Property arn
  ...
  factory AwsKmsKeyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsKmsKeyPropertiesResponse(
      arn: (() {
