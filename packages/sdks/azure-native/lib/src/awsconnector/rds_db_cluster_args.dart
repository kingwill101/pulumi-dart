...
class RdsDbClusterArgs {
  ...
  RdsDbClusterArgs({
    ...
    pulumi.Output<RdsDBClusterProperties>? properties,
  ...
  factory RdsDbClusterArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbClusterArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<RdsDBClusterProperties>(RdsDBClusterProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
