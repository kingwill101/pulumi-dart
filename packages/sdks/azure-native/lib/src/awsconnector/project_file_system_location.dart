...
class ProjectFileSystemLocation {
  ...
  factory ProjectFileSystemLocation.fromMap(Map<String, dynamic> map) {
    return ProjectFileSystemLocation(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileSystemTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
