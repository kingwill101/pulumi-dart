...
class ServiceManagedEBSVolumeConfigurationResponse {
  ...
  factory ServiceManagedEBSVolumeConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ServiceManagedEBSVolumeConfigurationResponse(
      ...
      tagSpecifications: map['tagSpecifications'] == null ? null : (pulumi.Input.decodeList<EBSTagSpecificationResponse>(map['tagSpecifications'], (value) => EBSTagSpecificationResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
