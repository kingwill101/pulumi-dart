...
class ServiceManagedEBSVolumeConfigurationResponse {
    ...
    return <String, dynamic>{
      ...
      'tagSpecifications':
          ?pulumi.Input.mapOptionalInputValue<
            List<EBSTagSpecificationResponse>,
  ...
  factory ServiceManagedEBSVolumeConfigurationResponse.fromMap(
    ...
    return ServiceManagedEBSVolumeConfigurationResponse(
      ...
      tagSpecifications: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EBSTagSpecificationResponse>(
            guardedValue,
            (value) => EBSTagSpecificationResponse.fromMap(
