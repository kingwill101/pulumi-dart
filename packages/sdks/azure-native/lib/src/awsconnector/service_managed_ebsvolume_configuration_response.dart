...
class ServiceManagedEBSVolumeConfigurationResponse {
  ...
  final List<EBSTagSpecificationResponse>? tagSpecifications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tagSpecifications': ?tagSpecifications == null ? null : pulumi.Input.encodeList<EBSTagSpecificationResponse, Map<String, dynamic>>(tagSpecifications!, (value) => value.toMap()),
  ...
  factory ServiceManagedEBSVolumeConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ServiceManagedEBSVolumeConfigurationResponse(
      ...
      tagSpecifications: map['tagSpecifications'] == null ? null : pulumi.Input.decodeList<EBSTagSpecificationResponse>(map['tagSpecifications'], (value) => EBSTagSpecificationResponse.fromMap((value as Map).cast<String, dynamic>())),
