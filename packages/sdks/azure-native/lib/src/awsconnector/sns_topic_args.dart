...
class SnsTopicArgs {
  ...
  SnsTopicArgs({
    ...
    pulumi.Output<SnsTopicProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<SnsTopicProperties>(properties),
  ...
  factory SnsTopicArgs.fromMap(Map<String, dynamic> map) {
    return SnsTopicArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<SnsTopicProperties>(SnsTopicProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
