...
class SnsTopicArgs {
  ...
  factory SnsTopicArgs.fromMap(Map<String, dynamic> map) {
    return SnsTopicArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnsTopicProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
