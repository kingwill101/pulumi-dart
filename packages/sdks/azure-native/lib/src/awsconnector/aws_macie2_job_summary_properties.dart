    ...
    return AwsMacie2JobSummaryProperties(
      bucketCriteria: (() {
        ...
        return pulumi.Input.fromValue(
          S3BucketCriteriaForJob.fromMap(
      ...
      bucketDefinitions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<S3BucketDefinitionForJob>(
            guardedValue,
            (value) => S3BucketDefinitionForJob.fromMap(
