...
class EcsTaskDefinitionProperties {
  ...
  /// AWS Properties
  final AwsEcsTaskDefinitionProperties? awsProperties;
  /// AWS Region
  ...
  factory EcsTaskDefinitionProperties.fromMap(Map<String, dynamic> map) {
    return EcsTaskDefinitionProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcsTaskDefinitionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
