...
import 'aws_ecs_task_definition_properties.dart';

/// Definition of EcsTaskDefinition
class EcsTaskDefinitionProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcsTaskDefinitionProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcsTaskDefinitionProperties].
  ...
  const EcsTaskDefinitionProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcsTaskDefinitionProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcsTaskDefinitionProperties.fromMap(Map<String, dynamic> map) {
    return EcsTaskDefinitionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcsTaskDefinitionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
