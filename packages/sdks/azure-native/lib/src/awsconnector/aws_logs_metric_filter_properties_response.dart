...
class AwsLogsMetricFilterPropertiesResponse {
  ...
  final List<MetricTransformationResponse>? metricTransformations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metricTransformations': ?metricTransformations == null ? null : pulumi.Input.encodeList<MetricTransformationResponse, Map<String, dynamic>>(metricTransformations!, (value) => value.toMap()),
    };
  }
  ...
  factory AwsLogsMetricFilterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsLogsMetricFilterPropertiesResponse(
      ...
      metricTransformations: map['metricTransformations'] == null ? null : pulumi.Input.decodeList<MetricTransformationResponse>(map['metricTransformations'], (value) => MetricTransformationResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
