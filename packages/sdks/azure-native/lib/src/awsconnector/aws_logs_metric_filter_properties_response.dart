...
class AwsLogsMetricFilterPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'metricTransformations':
          ?pulumi.Input.mapOptionalInputValue<
            List<MetricTransformationResponse>,
  ...
  factory AwsLogsMetricFilterPropertiesResponse.fromMap(
    ...
    return AwsLogsMetricFilterPropertiesResponse(
      ...
      metricTransformations: (() {
        final guardedValue = map['metricTransformations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricTransformationResponse>(
            guardedValue,
            (value) => MetricTransformationResponse.fromMap(
