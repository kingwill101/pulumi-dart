...
class Grantee {
  ...
  factory Grantee.fromMap(Map<String, dynamic> map) {
    return Grantee(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
