...
class EcsClusterArgs {
  ...
  factory EcsClusterArgs.fromMap(Map<String, dynamic> map) {
    return EcsClusterArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EcsClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
