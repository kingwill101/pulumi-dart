...
class EcsClusterArgs {
  ...
  EcsClusterArgs({
    ...
    pulumi.Output<EcsClusterProperties>? properties,
  ...
  factory EcsClusterArgs.fromMap(Map<String, dynamic> map) {
    return EcsClusterArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<EcsClusterProperties>(EcsClusterProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
