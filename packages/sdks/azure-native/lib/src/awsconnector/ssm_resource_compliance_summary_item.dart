...
class SsmResourceComplianceSummaryItem extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SsmResourceComplianceSummaryItemPropertiesResponse>
  properties;
  ...
  SsmResourceComplianceSummaryItem(
    ...
    properties =
        registerOutput<SsmResourceComplianceSummaryItemPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return SsmResourceComplianceSummaryItemPropertiesResponse.fromMap(
