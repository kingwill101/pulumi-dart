...
class ClusterHealth {
  ...
  factory ClusterHealth.fromMap(Map<String, dynamic> map) {
    return ClusterHealth(
      issues: (() { final guardedValue = map['issues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterIssue>(guardedValue, (value) => ClusterIssue.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
