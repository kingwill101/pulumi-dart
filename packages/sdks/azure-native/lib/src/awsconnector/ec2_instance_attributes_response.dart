...
class Ec2InstanceAttributesResponse {
  ...
  factory Ec2InstanceAttributesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceAttributesResponse(
      additionalMasterSecurityGroups: map['additionalMasterSecurityGroups'] == null ? null : (map['additionalMasterSecurityGroups'] as List).cast<String>(),
      additionalSlaveSecurityGroups: map['additionalSlaveSecurityGroups'] == null ? null : (map['additionalSlaveSecurityGroups'] as List).cast<String>(),
      ec2AvailabilityZone: map['ec2AvailabilityZone'] == null ? null : map['ec2AvailabilityZone'] as String,
      ec2KeyName: map['ec2KeyName'] == null ? null : map['ec2KeyName'] as String,
      ec2SubnetId: map['ec2SubnetId'] == null ? null : map['ec2SubnetId'] as String,
      emrManagedMasterSecurityGroup: map['emrManagedMasterSecurityGroup'] == null ? null : map['emrManagedMasterSecurityGroup'] as String,
      emrManagedSlaveSecurityGroup: map['emrManagedSlaveSecurityGroup'] == null ? null : map['emrManagedSlaveSecurityGroup'] as String,
      iamInstanceProfile: map['iamInstanceProfile'] == null ? null : map['iamInstanceProfile'] as String,
      requestedEc2AvailabilityZones: map['requestedEc2AvailabilityZones'] == null ? null : (map['requestedEc2AvailabilityZones'] as List).cast<String>(),
      requestedEc2SubnetIds: map['requestedEc2SubnetIds'] == null ? null : (map['requestedEc2SubnetIds'] as List).cast<String>(),
      serviceAccessSecurityGroup: map['serviceAccessSecurityGroup'] == null ? null : map['serviceAccessSecurityGroup'] as String,
    );
  }
}
