  ...
  factory Ec2InstanceAttributesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceAttributesResponse(
      additionalMasterSecurityGroups: (() {
        final guardedValue = map['additionalMasterSecurityGroups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      additionalSlaveSecurityGroups: (() {
        final guardedValue = map['additionalSlaveSecurityGroups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ec2AvailabilityZone: (() {
        final guardedValue = map['ec2AvailabilityZone'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ec2KeyName: (() {
        final guardedValue = map['ec2KeyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ec2SubnetId: (() {
        final guardedValue = map['ec2SubnetId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emrManagedMasterSecurityGroup: (() {
        final guardedValue = map['emrManagedMasterSecurityGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emrManagedSlaveSecurityGroup: (() {
        final guardedValue = map['emrManagedSlaveSecurityGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      iamInstanceProfile: (() {
      ...
      requestedEc2AvailabilityZones: (() {
        final guardedValue = map['requestedEc2AvailabilityZones'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      requestedEc2SubnetIds: (() {
        final guardedValue = map['requestedEc2SubnetIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      serviceAccessSecurityGroup: (() {
        final guardedValue = map['serviceAccessSecurityGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
