...
class AcmCertificateSummaryPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsAcmCertificateSummaryPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  const AcmCertificateSummaryPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsAcmCertificateSummaryPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory AcmCertificateSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AcmCertificateSummaryPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsAcmCertificateSummaryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
