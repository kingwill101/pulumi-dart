...
class CpuOptionsResponse {
  ...
  factory CpuOptionsResponse.fromMap(Map<String, dynamic> map) {
    return CpuOptionsResponse(
      amdSevSnp: (() { final guardedValue = map['amdSevSnp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AmdSevSnpSpecificationEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
