...
class CpuOptionsResponse {
  ...
  final AmdSevSnpSpecificationEnumValueResponse? amdSevSnp;
  ...
  factory CpuOptionsResponse.fromMap(Map<String, dynamic> map) {
    return CpuOptionsResponse(
      amdSevSnp: map['amdSevSnp'] == null ? null : AmdSevSnpSpecificationEnumValueResponse.fromMap((map['amdSevSnp'] as Map).cast<String, dynamic>()),
