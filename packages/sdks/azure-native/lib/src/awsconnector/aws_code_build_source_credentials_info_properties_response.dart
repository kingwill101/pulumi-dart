    ...
    return <String, dynamic>{
      ...
      'serverType':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(serverType, (value) => value.toMap()),
    };
  }

  factory AwsCodeBuildSourceCredentialsInfoPropertiesResponse.fromMap(
    ...
    return AwsCodeBuildSourceCredentialsInfoPropertiesResponse(
      ...
      authType: (() {
        ...
        return pulumi.Input.fromValue(
          AuthTypeEnumValueResponse.fromMap(
      ...
      serverType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServerTypeEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
