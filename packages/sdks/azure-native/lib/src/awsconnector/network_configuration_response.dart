...
class NetworkConfigurationResponse {
  ...
  factory NetworkConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return NetworkConfigurationResponse(
      awsvpcConfiguration: (() { final guardedValue = map['awsvpcConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsVpcConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
