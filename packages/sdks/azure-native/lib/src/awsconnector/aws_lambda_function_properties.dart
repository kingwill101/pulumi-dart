...
class AwsLambdaFunctionProperties {
  ...
  final pulumi.Input<List<dynamic>?>? architectures;
  /// Property arn
  ...
  final pulumi.Input<dynamic>? packageType;
  ...
  const AwsLambdaFunctionProperties({
    this.architectures,
    this.arn,
    this.code,
  ...
  factory AwsLambdaFunctionProperties.fromMap(Map<String, dynamic> map) {
    return AwsLambdaFunctionProperties(
      architectures: (() { final guardedValue = map['architectures']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      arn: (() { final guardedValue = map['arn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      code: (() { final guardedValue = map['code']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Code.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      deadLetterConfig: (() { final guardedValue = map['deadLetterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeadLetterConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ephemeralStorage: (() { final guardedValue = map['ephemeralStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EphemeralStorage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fileSystemConfigs: (() { final guardedValue = map['fileSystemConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FileSystemConfig>(guardedValue, (value) => FileSystemConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      imageConfig: (() { final guardedValue = map['imageConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      packageType: (() { final guardedValue = map['packageType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      runtimeManagementConfig: (() { final guardedValue = map['runtimeManagementConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuntimeManagementConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapStart: (() { final guardedValue = map['snapStart']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapStart.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapStartResponse: (() { final guardedValue = map['snapStartResponse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapStartResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      tracingConfig: (() { final guardedValue = map['tracingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TracingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vpcConfig: (() { final guardedValue = map['vpcConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
