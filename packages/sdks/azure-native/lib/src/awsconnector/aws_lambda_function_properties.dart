...
class AwsLambdaFunctionProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'arn': ?arn,
      'code': ?pulumi.Input.mapOptionalInputValue<Code, Map<String, dynamic>>(
        code,
        (value) => value.toMap(),
      ),
      ...
      'fileSystemConfigs':
          ...
          >(
            fileSystemConfigs,
            (value) =>
                pulumi.Input.encodeList<FileSystemConfig, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'snapStart':
          ?pulumi.Input.mapOptionalInputValue<SnapStart, Map<String, dynamic>>(
            snapStart,
            (value) => value.toMap(),
          ),
      'snapStartResponse':
    ...
    return AwsLambdaFunctionProperties(
      ...
      code: (() {
        ...
        return pulumi.Input.fromValue(
          Code.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      fileSystemConfigs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FileSystemConfig>(
            guardedValue,
            (value) => FileSystemConfig.fromMap(
      ...
      runtimeManagementConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuntimeManagementConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      snapStart: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SnapStart.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      snapStartResponse: (() {
      ...
      tracingConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TracingConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      vpcConfig: (() {
