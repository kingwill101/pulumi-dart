...
class EcrRepositoryPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEcrRepositoryPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory EcrRepositoryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcrRepositoryPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcrRepositoryPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
