  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tmpfs':
          ...
          >(
            tmpfs,
            (value) => pulumi.Input.encodeList<Tmpfs, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory LinuxParameters.fromMap(Map<String, dynamic> map) {
    return LinuxParameters(
      ...
      tmpfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Tmpfs>(
            guardedValue,
            (value) => Tmpfs.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
