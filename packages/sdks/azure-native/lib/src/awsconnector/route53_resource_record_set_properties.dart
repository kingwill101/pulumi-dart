...
import 'aws_route53_resource_record_set_properties.dart';

/// Definition of Route53ResourceRecordSet
class Route53ResourceRecordSetProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRoute53ResourceRecordSetProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Route53ResourceRecordSetProperties].
  ...
  const Route53ResourceRecordSetProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRoute53ResourceRecordSetProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Route53ResourceRecordSetProperties.fromMap(Map<String, dynamic> map) {
    return Route53ResourceRecordSetProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRoute53ResourceRecordSetProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
