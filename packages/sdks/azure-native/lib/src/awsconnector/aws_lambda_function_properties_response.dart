...
class AwsLambdaFunctionPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'runtimeManagementConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(runtimeManagementConfig, (value) => value.toMap()),
      'snapStart':
          ?pulumi.Input.mapOptionalInputValue<
            SnapStartResponse,
            Map<String, dynamic>
      ...
      'snapStartResponse':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(snapStartResponse, (value) => value.toMap()),
      'tags':
          ?pulumi.Input.mapOptionalInputValue<
            List<TagResponse>,
            List<Map<String, dynamic>>
  ...
  factory AwsLambdaFunctionPropertiesResponse.fromMap(
    ...
    return AwsLambdaFunctionPropertiesResponse(
      ...
      code: (() {
        ...
        return pulumi.Input.fromValue(
          CodeResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      deadLetterConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeadLetterConfigResponse.fromMap(
      ...
      fileSystemConfigs: (() {
        final guardedValue = map['fileSystemConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FileSystemConfigResponse>(
            guardedValue,
            (value) => FileSystemConfigResponse.fromMap(
      ...
      runtimeManagementConfig: (() {
        final guardedValue = map['runtimeManagementConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuntimeManagementConfigResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      snapStart: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SnapStartResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      snapStartResponse: (() {
        final guardedValue = map['snapStartResponse'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SnapStartResponseResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
