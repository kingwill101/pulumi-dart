...
class AwsVpcConfiguration {
  ...
  final pulumi.Input<dynamic>? assignPublicIp;
  ...
  factory AwsVpcConfiguration.fromMap(Map<String, dynamic> map) {
    return AwsVpcConfiguration(
      assignPublicIp: (() { final guardedValue = map['assignPublicIp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
