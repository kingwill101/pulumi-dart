...
import 'aws_cloud_front_distribution_properties.dart';

/// Definition of CloudFrontDistribution
class CloudFrontDistributionProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCloudFrontDistributionProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudFrontDistributionProperties].
  ...
  const CloudFrontDistributionProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudFrontDistributionProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudFrontDistributionProperties.fromMap(Map<String, dynamic> map) {
    return CloudFrontDistributionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudFrontDistributionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
