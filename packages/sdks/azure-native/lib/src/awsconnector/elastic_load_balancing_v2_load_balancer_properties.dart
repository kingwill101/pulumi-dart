...
class ElasticLoadBalancingV2LoadBalancerProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticLoadBalancingV2LoadBalancerProperties>?
  awsProperties;
  ...
  factory ElasticLoadBalancingV2LoadBalancerProperties.fromMap(
    ...
    return ElasticLoadBalancingV2LoadBalancerProperties(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsElasticLoadBalancingV2LoadBalancerProperties.fromMap(
