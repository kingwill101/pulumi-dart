...
class ElasticLoadBalancingV2LoadBalancerProperties {
  ...
  /// AWS Properties
  final AwsElasticLoadBalancingV2LoadBalancerProperties? awsProperties;
  /// AWS Region
  ...
  factory ElasticLoadBalancingV2LoadBalancerProperties.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2LoadBalancerProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticLoadBalancingV2LoadBalancerProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
