...
class ElasticLoadBalancingV2LoadBalancerProperties {
  ...
  const ElasticLoadBalancingV2LoadBalancerProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory ElasticLoadBalancingV2LoadBalancerProperties.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2LoadBalancerProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticLoadBalancingV2LoadBalancerProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
