    ...
    return <String, dynamic>{
      ...
      'devices':
          ...
          >(
            devices,
            (value) =>
                pulumi.Input.encodeList<DeviceResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'tmpfs':
          ...
          >(
            tmpfs,
            (value) =>
                pulumi.Input.encodeList<TmpfsResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return LinuxParametersResponse(
      capabilities: (() {
        ...
        return pulumi.Input.fromValue(
          KernelCapabilitiesResponse.fromMap(
      ...
      devices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceResponse>(
            guardedValue,
            (value) =>
                DeviceResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      initProcessEnabled: (() {
        final guardedValue = map['initProcessEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      maxSwap: (() {
        final guardedValue = map['maxSwap'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sharedMemorySize: (() {
        final guardedValue = map['sharedMemorySize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      swappiness: (() {
        final guardedValue = map['swappiness'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      tmpfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TmpfsResponse>(
            guardedValue,
            (value) =>
                TmpfsResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
