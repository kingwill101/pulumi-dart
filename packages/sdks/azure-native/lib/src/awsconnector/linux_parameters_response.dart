...
class LinuxParametersResponse {
  ...
  final pulumi.Input<KernelCapabilitiesResponse>? capabilities;
  ...
  final pulumi.Input<List<DeviceResponse>>? devices;
  ...
  final pulumi.Input<List<TmpfsResponse>>? tmpfs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'capabilities': ?pulumi.Input.mapOptionalInputValue<KernelCapabilitiesResponse, Map<String, dynamic>>(capabilities, (value) => value.toMap()),
      'devices': ?pulumi.Input.mapOptionalInputValue<List<DeviceResponse>, List<Map<String, dynamic>>>(devices, (value) => pulumi.Input.encodeList<DeviceResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'initProcessEnabled': ?initProcessEnabled,
      'maxSwap': ?maxSwap,
      'sharedMemorySize': ?sharedMemorySize,
      'swappiness': ?swappiness,
      'tmpfs': ?pulumi.Input.mapOptionalInputValue<List<TmpfsResponse>, List<Map<String, dynamic>>>(tmpfs, (value) => pulumi.Input.encodeList<TmpfsResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory LinuxParametersResponse.fromMap(Map<String, dynamic> map) {
    return LinuxParametersResponse(
      capabilities: (() { final guardedValue = map['capabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KernelCapabilitiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      devices: (() { final guardedValue = map['devices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeviceResponse>(guardedValue, (value) => DeviceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tmpfs: (() { final guardedValue = map['tmpfs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TmpfsResponse>(guardedValue, (value) => TmpfsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
