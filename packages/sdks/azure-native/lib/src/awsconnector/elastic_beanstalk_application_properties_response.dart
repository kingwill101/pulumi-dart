...
class ElasticBeanstalkApplicationPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkApplicationPropertiesResponse>?
  awsProperties;
  ...
  factory ElasticBeanstalkApplicationPropertiesResponse.fromMap(
    ...
    return ElasticBeanstalkApplicationPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsElasticBeanstalkApplicationPropertiesResponse.fromMap(
