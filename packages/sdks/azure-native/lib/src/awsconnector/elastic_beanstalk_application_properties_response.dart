...
class ElasticBeanstalkApplicationPropertiesResponse {
  ...
  /// AWS Properties
  final AwsElasticBeanstalkApplicationPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory ElasticBeanstalkApplicationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkApplicationPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticBeanstalkApplicationPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
