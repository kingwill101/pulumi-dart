...
import 'aws_elastic_beanstalk_application_properties_response.dart';

/// Definition of ElasticBeanstalkApplication
class ElasticBeanstalkApplicationPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkApplicationPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticBeanstalkApplicationPropertiesResponse].
  ...
  const ElasticBeanstalkApplicationPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticBeanstalkApplicationPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticBeanstalkApplicationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkApplicationPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticBeanstalkApplicationPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
