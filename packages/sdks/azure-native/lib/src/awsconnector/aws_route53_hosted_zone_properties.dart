...
import 'hosted_zone_tag.dart';
import 'query_logging_config.dart';
import 'vpc.dart';

/// Definition of awsRoute53HostedZone
class AwsRoute53HostedZoneProperties {
  ...
  final pulumi.Input<HostedZoneConfig>? hostedZoneConfig;
  ...
  final pulumi.Input<List<HostedZoneTag>>? hostedZoneTags;
  ...
  final pulumi.Input<QueryLoggingConfig>? queryLoggingConfig;
  ...
  final pulumi.Input<List<VPC>>? vpCs;

  /// Creates a new [AwsRoute53HostedZoneProperties].
    ...
    return <String, dynamic>{
      ...
      'hostedZoneTags':
          ...
          >(
            hostedZoneTags,
            (value) =>
                pulumi.Input.encodeList<HostedZoneTag, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'vpCs':
          ...
          >(
            vpCs,
            (value) => pulumi.Input.encodeList<VPC, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
  ...
  factory AwsRoute53HostedZoneProperties.fromMap(Map<String, dynamic> map) {
    return AwsRoute53HostedZoneProperties(
      hostedZoneConfig: (() {
        final guardedValue = map['hostedZoneConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          HostedZoneConfig.fromMap(
      ...
      hostedZoneTags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<HostedZoneTag>(
            guardedValue,
            (value) =>
                HostedZoneTag.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      id: (() {
      ...
      vpCs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VPC>(
            guardedValue,
            (value) => VPC.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
