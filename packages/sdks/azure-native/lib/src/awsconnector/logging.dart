...
class Logging {
  ...
  Logging({this.bucket, this.clusterLogging, this.includeCookies, this.prefix});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterLogging':
          ...
          >(
            clusterLogging,
            (value) => pulumi.Input.encodeList<LogSetup, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return Logging(
      ...
      clusterLogging: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LogSetup>(
            guardedValue,
            (value) => LogSetup.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      includeCookies: (() {
