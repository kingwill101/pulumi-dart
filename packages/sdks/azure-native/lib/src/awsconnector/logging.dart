...
class Logging {
  ...
  factory Logging.fromMap(Map<String, dynamic> map) {
    return Logging(
      ...
      clusterLogging: (() { final guardedValue = map['clusterLogging']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LogSetup>(guardedValue, (value) => LogSetup.fromMap((value as Map).cast<String, dynamic>()))); })(),
