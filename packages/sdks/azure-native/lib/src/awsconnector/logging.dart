...
class Logging {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bucket': ?bucket,
      'clusterLogging': ?clusterLogging == null ? null : pulumi.Input.encodeList<LogSetup, Map<String, dynamic>>(clusterLogging!, (value) => value.toMap()),
  ...
  factory Logging.fromMap(Map<String, dynamic> map) {
    return Logging(
      ...
      clusterLogging: map['clusterLogging'] == null ? null : pulumi.Input.decodeList<LogSetup>(map['clusterLogging'], (value) => LogSetup.fromMap((value as Map).cast<String, dynamic>())),
