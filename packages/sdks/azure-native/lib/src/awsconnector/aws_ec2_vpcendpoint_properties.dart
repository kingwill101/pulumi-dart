...
class AwsEc2VPCEndpointProperties {
  ...
  final pulumi.Input<dynamic>? vpcEndpointType;
  /// The ID of the VPC.
  ...
  const AwsEc2VPCEndpointProperties({
  ...
  factory AwsEc2VPCEndpointProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2VPCEndpointProperties(
      ...
      vpcEndpointType: (() { final guardedValue = map['vpcEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
