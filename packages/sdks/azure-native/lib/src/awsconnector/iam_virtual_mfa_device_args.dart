...
class IamVirtualMfaDeviceArgs {
  ...
  IamVirtualMfaDeviceArgs({
    ...
    pulumi.Output<IamVirtualMFADeviceProperties>? properties,
  ...
  factory IamVirtualMfaDeviceArgs.fromMap(Map<String, dynamic> map) {
    return IamVirtualMfaDeviceArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<IamVirtualMFADeviceProperties>(IamVirtualMFADeviceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
