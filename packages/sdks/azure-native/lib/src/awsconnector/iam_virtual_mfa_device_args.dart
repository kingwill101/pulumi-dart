...
class IamVirtualMfaDeviceArgs {
  ...
  factory IamVirtualMfaDeviceArgs.fromMap(Map<String, dynamic> map) {
    return IamVirtualMfaDeviceArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamVirtualMFADeviceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
