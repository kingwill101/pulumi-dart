...
class AwsApiGatewayRestApiProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'body': ?body,
      'bodyS3Location':
          ?pulumi.Input.mapOptionalInputValue<S3Location, Map<String, dynamic>>(
            bodyS3Location,
            (value) => value.toMap(),
          ),
      'cloneFrom': ?cloneFrom,
  ...
  factory AwsApiGatewayRestApiProperties.fromMap(Map<String, dynamic> map) {
    return AwsApiGatewayRestApiProperties(
      apiKeySourceType: (() {
        final guardedValue = map['apiKeySourceType'];
      ...
      bodyS3Location: (() {
        final guardedValue = map['bodyS3Location'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          S3Location.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      cloneFrom: (() {
        final guardedValue = map['cloneFrom'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
