...
class AwsApiGatewayRestApiProperties {
  ...
  final pulumi.Input<S3Location?>? bodyS3Location;
  ...
  final pulumi.Input<EndpointConfiguration?>? endpointConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'body': ?body,
      'bodyS3Location': ?pulumi.Input.mapOptionalInputValue<S3Location, Map<String, dynamic>>(bodyS3Location, (value) => value.toMap()),
      'cloneFrom': ?cloneFrom,
      'description': ?description,
      'disableExecuteApiEndpoint': ?disableExecuteApiEndpoint,
      'endpointConfiguration': ?pulumi.Input.mapOptionalInputValue<EndpointConfiguration, Map<String, dynamic>>(endpointConfiguration, (value) => value.toMap()),
  ...
  factory AwsApiGatewayRestApiProperties.fromMap(Map<String, dynamic> map) {
    return AwsApiGatewayRestApiProperties(
      ...
      bodyS3Location: (() { final guardedValue = map['bodyS3Location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3Location.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      endpointConfiguration: (() { final guardedValue = map['endpointConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      minimumCompressionSize: (() { final guardedValue = map['minimumCompressionSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
