...
class AwsApiGatewayRestApiProperties {
  ...
  factory AwsApiGatewayRestApiProperties.fromMap(Map<String, dynamic> map) {
    return AwsApiGatewayRestApiProperties(
      ...
      bodyS3Location: map['bodyS3Location'] == null ? null : (S3Location.fromMap((map['bodyS3Location'] as Map).cast<String, dynamic>())).input(),
      ...
      endpointConfiguration: map['endpointConfiguration'] == null ? null : (EndpointConfiguration.fromMap((map['endpointConfiguration'] as Map).cast<String, dynamic>())).input(),
