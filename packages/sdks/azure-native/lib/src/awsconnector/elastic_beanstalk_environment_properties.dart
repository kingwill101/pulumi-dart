...
class ElasticBeanstalkEnvironmentProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkEnvironmentProperties>? awsProperties;
  /// AWS Region
  ...
  const ElasticBeanstalkEnvironmentProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticBeanstalkEnvironmentProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticBeanstalkEnvironmentProperties.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkEnvironmentProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticBeanstalkEnvironmentProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
