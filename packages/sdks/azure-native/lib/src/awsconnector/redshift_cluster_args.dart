...
class RedshiftClusterArgs {
  ...
  RedshiftClusterArgs({
    ...
    pulumi.Output<RedshiftClusterProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<RedshiftClusterProperties>(properties),
  ...
  factory RedshiftClusterArgs.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<RedshiftClusterProperties>(RedshiftClusterProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
