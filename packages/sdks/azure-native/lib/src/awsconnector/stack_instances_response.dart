...
class StackInstancesResponse {
  ...
  factory StackInstancesResponse.fromMap(Map<String, dynamic> map) {
    return StackInstancesResponse(
      deploymentTargets: (() { final guardedValue = map['deploymentTargets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentTargetsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      parameterOverrides: (() { final guardedValue = map['parameterOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ParameterResponse>(guardedValue, (value) => ParameterResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
