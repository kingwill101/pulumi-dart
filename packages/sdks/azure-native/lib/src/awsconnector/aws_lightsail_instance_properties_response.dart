...
class AwsLightsailInstancePropertiesResponse {
    ...
    return <String, dynamic>{
      'addOns':
          ...
          >(
            addOns,
            (value) =>
                pulumi.Input.encodeList<AddOnResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsLightsailInstancePropertiesResponse.fromMap(
    ...
    return AwsLightsailInstancePropertiesResponse(
      addOns: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AddOnResponse>(
            guardedValue,
            (value) =>
                AddOnResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      availabilityZone: (() {
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StateResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      supportCode: (() {
