...
import 'aws_logs_log_group_properties_response.dart';

/// Definition of LogsLogGroup
class LogsLogGroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLogsLogGroupPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LogsLogGroupPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLogsLogGroupPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LogsLogGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LogsLogGroupPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogsLogGroupPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
