...
class SsmParameterPropertiesResponse {
  ...
  /// AWS Properties
  final AwsSsmParameterPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory SsmParameterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SsmParameterPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSsmParameterPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
