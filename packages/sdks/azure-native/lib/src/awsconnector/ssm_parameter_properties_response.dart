...
import 'aws_ssm_parameter_properties_response.dart';

/// Definition of SsmParameter
class SsmParameterPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSsmParameterPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SsmParameterPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSsmParameterPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SsmParameterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SsmParameterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSsmParameterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
