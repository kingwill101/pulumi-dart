...
class EksNodegroupProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEksNodegroupProperties?>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEksNodegroupProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EksNodegroupProperties.fromMap(Map<String, dynamic> map) {
    return EksNodegroupProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEksNodegroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
