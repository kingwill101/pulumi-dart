...
import 'dbcluster_role_response.dart';
import 'master_user_secret_response.dart';
import 'rds_db_cluster_endpoint_response.dart';
import 'read_endpoint_response.dart';
import 'scaling_configuration_response.dart';
import 'serverless_v2_scaling_configuration_response.dart';
import 'tag_response.dart';

/// Definition of awsRdsDBCluster
class AwsRdsDBClusterPropertiesResponse {
  /// The amount of storage in gibibytes (GiB) to allocate to each DB instance in the Multi-AZ DB cluster.
  final pulumi.Input<int>? allocatedStorage;
  /// Provides a list of the AWS Identity and Access Management (IAM) roles that are associated with the DB cluster. IAM roles that are associated with a DB cluster grant permission for the DB cluster to access other AWS services on your behalf.
  final pulumi.Input<List<DBClusterRoleResponse>>? associatedRoles;
  ...
  /// Property endpoint
  final pulumi.Input<RdsDbClusterEndpointResponse>? endpoint;
  ...
  final pulumi.Input<MasterUserSecretResponse>? masterUserSecret;
  ...
  final pulumi.Input<ReadEndpointResponse>? readEndpoint;
  ...
  final pulumi.Input<ScalingConfigurationResponse>? scalingConfiguration;
  ...
  final pulumi.Input<ServerlessV2ScalingConfigurationResponse>? serverlessV2ScalingConfiguration;
  ...
  /// Creates a new [AwsRdsDBClusterPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'associatedRoles': ?pulumi.Input.mapOptionalInputValue<List<DBClusterRoleResponse>, List<Map<String, dynamic>>>(associatedRoles, (value) => pulumi.Input.encodeList<DBClusterRoleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'endpoint': ?pulumi.Input.mapOptionalInputValue<RdsDbClusterEndpointResponse, Map<String, dynamic>>(endpoint, (value) => value.toMap()),
      'engine': ?engine,
      ...
      'masterUserSecret': ?pulumi.Input.mapOptionalInputValue<MasterUserSecretResponse, Map<String, dynamic>>(masterUserSecret, (value) => value.toMap()),
      ...
      'readEndpoint': ?pulumi.Input.mapOptionalInputValue<ReadEndpointResponse, Map<String, dynamic>>(readEndpoint, (value) => value.toMap()),
      'replicationSourceIdentifier': ?replicationSourceIdentifier,
      'restoreToTime': ?restoreToTime,
      'restoreType': ?restoreType,
      'scalingConfiguration': ?pulumi.Input.mapOptionalInputValue<ScalingConfigurationResponse, Map<String, dynamic>>(scalingConfiguration, (value) => value.toMap()),
      'serverlessV2ScalingConfiguration': ?pulumi.Input.mapOptionalInputValue<ServerlessV2ScalingConfigurationResponse, Map<String, dynamic>>(serverlessV2ScalingConfiguration, (value) => value.toMap()),
  ...
  factory AwsRdsDBClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBClusterPropertiesResponse(
      ...
      associatedRoles: (() { final guardedValue = map['associatedRoles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DBClusterRoleResponse>(guardedValue, (value) => DBClusterRoleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      endpoint: (() { final guardedValue = map['endpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RdsDbClusterEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      masterUserSecret: (() { final guardedValue = map['masterUserSecret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MasterUserSecretResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      readEndpoint: (() { final guardedValue = map['readEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReadEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      scalingConfiguration: (() { final guardedValue = map['scalingConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScalingConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serverlessV2ScalingConfiguration: (() { final guardedValue = map['serverlessV2ScalingConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServerlessV2ScalingConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
