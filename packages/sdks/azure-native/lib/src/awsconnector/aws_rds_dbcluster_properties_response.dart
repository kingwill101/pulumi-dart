...
class AwsRdsDBClusterPropertiesResponse {
  ...
  final pulumi.Input<ServerlessV2ScalingConfigurationResponse>?
    ...
    return AwsRdsDBClusterPropertiesResponse(
      ...
      associatedRoles: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DBClusterRoleResponse>(
            guardedValue,
            (value) => DBClusterRoleResponse.fromMap(
      ...
      endpoint: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RdsDbClusterEndpointResponse.fromMap(
      ...
      masterUserSecret: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MasterUserSecretResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      scalingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScalingConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      serverlessV2ScalingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServerlessV2ScalingConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
