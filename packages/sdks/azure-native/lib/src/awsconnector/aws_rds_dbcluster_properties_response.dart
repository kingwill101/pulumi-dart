...
class AwsRdsDBClusterPropertiesResponse {
  ...
  factory AwsRdsDBClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBClusterPropertiesResponse(
      ...
      associatedRoles: map['associatedRoles'] == null ? null : (pulumi.Input.decodeList<DBClusterRoleResponse>(map['associatedRoles'], (value) => DBClusterRoleResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      endpoint: map['endpoint'] == null ? null : (RdsDbClusterEndpointResponse.fromMap((map['endpoint'] as Map).cast<String, dynamic>())).input(),
      ...
      masterUserSecret: map['masterUserSecret'] == null ? null : (MasterUserSecretResponse.fromMap((map['masterUserSecret'] as Map).cast<String, dynamic>())).input(),
      ...
      readEndpoint: map['readEndpoint'] == null ? null : (ReadEndpointResponse.fromMap((map['readEndpoint'] as Map).cast<String, dynamic>())).input(),
      ...
      scalingConfiguration: map['scalingConfiguration'] == null ? null : (ScalingConfigurationResponse.fromMap((map['scalingConfiguration'] as Map).cast<String, dynamic>())).input(),
      serverlessV2ScalingConfiguration: map['serverlessV2ScalingConfiguration'] == null ? null : (ServerlessV2ScalingConfigurationResponse.fromMap((map['serverlessV2ScalingConfiguration'] as Map).cast<String, dynamic>())).input(),
