...
class IamGroupProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsIamGroupProperties>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamGroupProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamGroupProperties.fromMap(Map<String, dynamic> map) {
    return IamGroupProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
