...
class ConfigServiceDeliveryChannel extends pulumi.CustomResource {
  ...
  ConfigServiceDeliveryChannel(
    ...
    properties = registerOutput<ConfigServiceDeliveryChannelPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ConfigServiceDeliveryChannelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ConfigServiceDeliveryChannel] resource.
  ConfigServiceDeliveryChannel.reference(String urn)
    : super(
        'azure-native:awsconnector:ConfigServiceDeliveryChannel',
