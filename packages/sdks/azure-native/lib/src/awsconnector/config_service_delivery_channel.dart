...
class ConfigServiceDeliveryChannel extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ConfigServiceDeliveryChannelPropertiesResponse>
  properties;
  ...
  ConfigServiceDeliveryChannel(
    ...
    properties = registerOutput<ConfigServiceDeliveryChannelPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ConfigServiceDeliveryChannelPropertiesResponse.fromMap(
