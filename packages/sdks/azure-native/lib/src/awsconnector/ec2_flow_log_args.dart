...
class Ec2FlowLogArgs {
  ...
  Ec2FlowLogArgs({
    ...
    pulumi.Output<Ec2FlowLogProperties>? properties,
  ...
  factory Ec2FlowLogArgs.fromMap(Map<String, dynamic> map) {
    return Ec2FlowLogArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Ec2FlowLogProperties>(Ec2FlowLogProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
