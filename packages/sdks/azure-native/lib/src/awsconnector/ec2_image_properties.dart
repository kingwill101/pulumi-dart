...
class Ec2ImageProperties {
  ...
  /// AWS Properties
  final AwsEc2ImageProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2ImageProperties.fromMap(Map<String, dynamic> map) {
    return Ec2ImageProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2ImageProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
