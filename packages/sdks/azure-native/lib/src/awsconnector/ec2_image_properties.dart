...
import 'aws_ec2_image_properties.dart';

/// Definition of Ec2Image
class Ec2ImageProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2ImageProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2ImageProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2ImageProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2ImageProperties.fromMap(Map<String, dynamic> map) {
    return Ec2ImageProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2ImageProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
