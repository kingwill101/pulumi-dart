...
class OutpostConfigResponseResponse {
  ...
  factory OutpostConfigResponseResponse.fromMap(Map<String, dynamic> map) {
    return OutpostConfigResponseResponse(
      ...
      controlPlanePlacement: (() { final guardedValue = map['controlPlanePlacement']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlPlanePlacementResponseResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
