...
import 'aws_open_search_domain_status_properties.dart';

/// Definition of OpenSearchDomainStatus
class OpenSearchDomainStatusProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsOpenSearchDomainStatusProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [OpenSearchDomainStatusProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsOpenSearchDomainStatusProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory OpenSearchDomainStatusProperties.fromMap(Map<String, dynamic> map) {
    return OpenSearchDomainStatusProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsOpenSearchDomainStatusProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
