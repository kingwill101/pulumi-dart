...
class OpenSearchDomainStatusProperties {
  ...
  /// AWS Properties
  final AwsOpenSearchDomainStatusProperties? awsProperties;
  /// AWS Region
  ...
  factory OpenSearchDomainStatusProperties.fromMap(Map<String, dynamic> map) {
    return OpenSearchDomainStatusProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsOpenSearchDomainStatusProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
