...
class AwsRdsDBSnapshotPropertiesResponse {
  ...
  const AwsRdsDBSnapshotPropertiesResponse({
  ...
  factory AwsRdsDBSnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBSnapshotPropertiesResponse(
      ...
      multiTenant: (() { final guardedValue = map['multiTenant']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      originalSnapshotCreateTime: (() { final guardedValue = map['originalSnapshotCreateTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      processorFeatures: (() { final guardedValue = map['processorFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProcessorFeatureResponse>(guardedValue, (value) => ProcessorFeatureResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      snapshotCreateTime: (() { final guardedValue = map['snapshotCreateTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      snapshotDatabaseTime: (() { final guardedValue = map['snapshotDatabaseTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      snapshotTarget: (() { final guardedValue = map['snapshotTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      tagList: (() { final guardedValue = map['tagList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TagResponse>(guardedValue, (value) => TagResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      tdeCredentialArn: (() { final guardedValue = map['tdeCredentialArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
