...
class CapacityReservationSpecificationResponse {
  ...
  const CapacityReservationSpecificationResponse({
  ...
  factory CapacityReservationSpecificationResponse.fromMap(Map<String, dynamic> map) {
    return CapacityReservationSpecificationResponse(
      capacityReservationPreference: (() { final guardedValue = map['capacityReservationPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityReservationPreferenceEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      capacityReservationTarget: (() { final guardedValue = map['capacityReservationTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityReservationTargetResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
