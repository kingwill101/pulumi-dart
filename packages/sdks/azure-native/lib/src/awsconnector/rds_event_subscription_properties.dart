...
class RdsEventSubscriptionProperties {
  ...
  /// AWS Properties
  final AwsRdsEventSubscriptionProperties? awsProperties;
  /// AWS Region
  ...
  factory RdsEventSubscriptionProperties.fromMap(Map<String, dynamic> map) {
    return RdsEventSubscriptionProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsEventSubscriptionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
