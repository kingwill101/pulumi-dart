...
class RdsEventSubscriptionProperties {
  ...
  const RdsEventSubscriptionProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory RdsEventSubscriptionProperties.fromMap(Map<String, dynamic> map) {
    return RdsEventSubscriptionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsEventSubscriptionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
