...
import 'aws_s3_control_multi_region_access_point_policy_document_properties_response.dart';

/// Definition of S3ControlMultiRegionAccessPointPolicyDocument
class S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsS3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse].
  ...
  const S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
