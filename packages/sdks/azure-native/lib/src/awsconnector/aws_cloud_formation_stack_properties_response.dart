...
class AwsCloudFormationStackPropertiesResponse {
  ...
  const AwsCloudFormationStackPropertiesResponse({
    this.capabilities,
    this.changeSetId,
    this.creationTime,
    this.description,
  ...
  factory AwsCloudFormationStackPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsCloudFormationStackPropertiesResponse(
      ...
      outputs: (() { final guardedValue = map['outputs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OutputResponse>(guardedValue, (value) => OutputResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      stackStatus: (() { final guardedValue = map['stackStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
