...
import 'aws_ec2_image_properties_response.dart';

/// Definition of Ec2Image
class Ec2ImagePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2ImagePropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2ImagePropertiesResponse].
  ...
  const Ec2ImagePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2ImagePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2ImagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2ImagePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2ImagePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
