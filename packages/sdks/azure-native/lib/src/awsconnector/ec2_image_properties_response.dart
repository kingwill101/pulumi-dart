...
class Ec2ImagePropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2ImagePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2ImagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2ImagePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2ImagePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
