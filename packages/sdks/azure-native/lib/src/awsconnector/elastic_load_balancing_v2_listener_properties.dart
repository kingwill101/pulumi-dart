...
class ElasticLoadBalancingV2ListenerProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticLoadBalancingV2ListenerProperties>?
  awsProperties;
  ...
  factory ElasticLoadBalancingV2ListenerProperties.fromMap(
    ...
    return ElasticLoadBalancingV2ListenerProperties(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsElasticLoadBalancingV2ListenerProperties.fromMap(
