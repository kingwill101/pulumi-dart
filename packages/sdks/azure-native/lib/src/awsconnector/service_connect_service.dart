...
class ServiceConnectService {
  ...
  factory ServiceConnectService.fromMap(Map<String, dynamic> map) {
    return ServiceConnectService(
      clientAliases: (() { final guardedValue = map['clientAliases']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceConnectClientAlias>(guardedValue, (value) => ServiceConnectClientAlias.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      timeout: (() { final guardedValue = map['timeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeoutConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tls: (() { final guardedValue = map['tls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceConnectTlsConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
