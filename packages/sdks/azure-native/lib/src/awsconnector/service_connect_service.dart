    ...
    return ServiceConnectService(
      clientAliases: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceConnectClientAlias>(
            guardedValue,
            (value) => ServiceConnectClientAlias.fromMap(
      ...
      tls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConnectTlsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
