...
import 'build_status_config.dart';
import 'git_submodules_config.dart';
...
class ProjectSource {
  ...
  final pulumi.Input<SourceAuth>? auth;
  ...
  final pulumi.Input<BuildStatusConfig>? buildStatusConfig;
  ...
  final pulumi.Input<GitSubmodulesConfig>? gitSubmodulesConfig;
  ...
  final pulumi.Input<SourceTypeEnumValue>? type;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'auth':
          ?pulumi.Input.mapOptionalInputValue<SourceAuth, Map<String, dynamic>>(
            auth,
            (value) => value.toMap(),
          ),
      'buildStatusConfig':
    ...
    return ProjectSource(
      auth: (() {
        ...
        return pulumi.Input.fromValue(
          SourceAuth.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      buildStatusConfig: (() {
