...
import 'aws_s3_access_point_properties_response.dart';

/// Definition of S3AccessPoint
class S3AccessPointPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsS3AccessPointPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3AccessPointPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3AccessPointPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3AccessPointPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3AccessPointPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3AccessPointPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
