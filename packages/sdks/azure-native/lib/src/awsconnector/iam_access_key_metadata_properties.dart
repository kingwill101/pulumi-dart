...
class IamAccessKeyMetadataProperties {
  ...
  const IamAccessKeyMetadataProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory IamAccessKeyMetadataProperties.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyMetadataProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamAccessKeyMetadataProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
