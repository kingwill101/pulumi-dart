...
import 'aws_ecs_cluster_properties.dart';

/// Definition of EcsCluster
class EcsClusterProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcsClusterProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcsClusterProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcsClusterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcsClusterProperties.fromMap(Map<String, dynamic> map) {
    return EcsClusterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcsClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
