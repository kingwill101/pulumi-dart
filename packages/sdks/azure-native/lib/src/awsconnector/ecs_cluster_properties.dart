...
class EcsClusterProperties {
  ...
  /// AWS Properties
  final AwsEcsClusterProperties? awsProperties;
  /// AWS Region
  ...
  factory EcsClusterProperties.fromMap(Map<String, dynamic> map) {
    return EcsClusterProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcsClusterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
