...
import 'aws_secrets_manager_resource_policy_properties_response.dart';

/// Definition of SecretsManagerResourcePolicy
class SecretsManagerResourcePolicyPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSecretsManagerResourcePolicyPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SecretsManagerResourcePolicyPropertiesResponse].
  ...
  const SecretsManagerResourcePolicyPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSecretsManagerResourcePolicyPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SecretsManagerResourcePolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SecretsManagerResourcePolicyPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSecretsManagerResourcePolicyPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
