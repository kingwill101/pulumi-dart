...
class SecretsManagerResourcePolicyPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSecretsManagerResourcePolicyPropertiesResponse>?
  awsProperties;
  ...
  factory SecretsManagerResourcePolicyPropertiesResponse.fromMap(
    ...
    return SecretsManagerResourcePolicyPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsSecretsManagerResourcePolicyPropertiesResponse.fromMap(
