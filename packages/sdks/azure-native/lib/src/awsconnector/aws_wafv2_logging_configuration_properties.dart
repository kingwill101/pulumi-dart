...
class AwsWafv2LoggingConfigurationProperties {
    ...
    return <String, dynamic>{
      ...
      'redactedFields':
          ...
          >(
            redactedFields,
            (value) =>
                pulumi.Input.encodeList<FieldToMatch, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsWafv2LoggingConfigurationProperties.fromMap(
    ...
    return AwsWafv2LoggingConfigurationProperties(
      ...
      loggingFilter: (() {
        ...
        return pulumi.Input.fromValue(
          LoggingFilterModelProperties.fromMap(
      ...
      redactedFields: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FieldToMatch>(
            guardedValue,
            (value) =>
                FieldToMatch.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      resourceArn: (() {
