...
import 'aws_s3_bucket_properties.dart';
...
class S3BucketProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsS3BucketProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3BucketProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3BucketProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3BucketProperties.fromMap(Map<String, dynamic> map) {
    return S3BucketProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3BucketProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
