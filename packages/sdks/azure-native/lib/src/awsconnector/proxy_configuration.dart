...
class ProxyConfiguration {
  ...
  factory ProxyConfiguration.fromMap(Map<String, dynamic> map) {
    return ProxyConfiguration(
      ...
      proxyConfigurationProperties: (() { final guardedValue = map['proxyConfigurationProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<KeyValuePair>(guardedValue, (value) => KeyValuePair.fromMap((value as Map).cast<String, dynamic>()))); })(),
