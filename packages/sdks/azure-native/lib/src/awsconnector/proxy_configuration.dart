...
class ProxyConfiguration {
  ...
  final List<KeyValuePair>? proxyConfigurationProperties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'proxyConfigurationProperties': ?proxyConfigurationProperties == null ? null : pulumi.Input.encodeList<KeyValuePair, Map<String, dynamic>>(proxyConfigurationProperties!, (value) => value.toMap()),
      'type': ?type,
    };
  }
  ...
  factory ProxyConfiguration.fromMap(Map<String, dynamic> map) {
    return ProxyConfiguration(
      ...
      proxyConfigurationProperties: map['proxyConfigurationProperties'] == null ? null : pulumi.Input.decodeList<KeyValuePair>(map['proxyConfigurationProperties'], (value) => KeyValuePair.fromMap((value as Map).cast<String, dynamic>())),
