...
class Ec2AccountAttributeArgs {
  ...
  Ec2AccountAttributeArgs({
    ...
    pulumi.Output<Ec2AccountAttributeProperties>? properties,
  ...
  factory Ec2AccountAttributeArgs.fromMap(Map<String, dynamic> map) {
    return Ec2AccountAttributeArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Ec2AccountAttributeProperties>(Ec2AccountAttributeProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
