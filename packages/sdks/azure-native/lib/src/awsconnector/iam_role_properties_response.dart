...
import 'aws_iam_role_properties_response.dart';

/// Definition of IamRole
class IamRolePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamRolePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamRolePropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamRolePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamRolePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamRolePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamRolePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
