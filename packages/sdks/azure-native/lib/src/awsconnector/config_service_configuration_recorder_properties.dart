...
class ConfigServiceConfigurationRecorderProperties {
  ...
  /// AWS Properties
  final AwsConfigServiceConfigurationRecorderProperties? awsProperties;
  /// AWS Region
  ...
  factory ConfigServiceConfigurationRecorderProperties.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsConfigServiceConfigurationRecorderProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
