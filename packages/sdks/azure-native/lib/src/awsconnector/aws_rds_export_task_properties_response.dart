...
class AwsRdsExportTaskPropertiesResponse {
  ...
  factory AwsRdsExportTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRdsExportTaskPropertiesResponse(
      ...
      sourceType: (() { final guardedValue = map['sourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ExportSourceTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
