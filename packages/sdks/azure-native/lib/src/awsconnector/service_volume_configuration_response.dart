...
class ServiceVolumeConfigurationResponse {
  ...
  final pulumi.Input<ServiceManagedEBSVolumeConfigurationResponse>? managedEBSVolume;
  ...
  const ServiceVolumeConfigurationResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'managedEBSVolume': ?pulumi.Input.mapOptionalInputValue<ServiceManagedEBSVolumeConfigurationResponse, Map<String, dynamic>>(managedEBSVolume, (value) => value.toMap()),
      'name': ?name,
    };
  }
  ...
  factory ServiceVolumeConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ServiceVolumeConfigurationResponse(
      managedEBSVolume: (() { final guardedValue = map['managedEBSVolume']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceManagedEBSVolumeConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
