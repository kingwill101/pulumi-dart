...
class ServiceVolumeConfigurationResponse {
  ...
  final pulumi.Input<ServiceManagedEBSVolumeConfigurationResponse>?
  managedEBSVolume;
  ...
  ServiceVolumeConfigurationResponse({this.managedEBSVolume, this.name});
  ...
  factory ServiceVolumeConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ServiceVolumeConfigurationResponse(
      managedEBSVolume: (() {
        final guardedValue = map['managedEBSVolume'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceManagedEBSVolumeConfigurationResponse.fromMap(
