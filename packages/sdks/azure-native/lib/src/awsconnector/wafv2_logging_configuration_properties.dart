...
class Wafv2LoggingConfigurationProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsWafv2LoggingConfigurationProperties>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsWafv2LoggingConfigurationProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Wafv2LoggingConfigurationProperties.fromMap(Map<String, dynamic> map) {
    return Wafv2LoggingConfigurationProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsWafv2LoggingConfigurationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
