...
import 'aws_lambda_function_properties.dart';
...
class LambdaFunctionProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsLambdaFunctionProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LambdaFunctionProperties].
  ...
  const LambdaFunctionProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLambdaFunctionProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LambdaFunctionProperties.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLambdaFunctionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
