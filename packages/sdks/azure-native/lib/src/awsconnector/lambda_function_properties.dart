...
class LambdaFunctionProperties {
  ...
  /// AWS Properties
  final AwsLambdaFunctionProperties? awsProperties;
  /// AWS Region
  ...
  factory LambdaFunctionProperties.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLambdaFunctionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
