...
import 'aws_kms_alias_properties.dart';

/// Definition of KmsAlias
class KmsAliasProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsKmsAliasProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [KmsAliasProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsKmsAliasProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory KmsAliasProperties.fromMap(Map<String, dynamic> map) {
    return KmsAliasProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsKmsAliasProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
