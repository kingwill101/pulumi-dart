...
class ConfigServiceConfigurationRecorderStatusArgs {
  ...
  ConfigServiceConfigurationRecorderStatusArgs({
    ...
    pulumi.Output<ConfigServiceConfigurationRecorderStatusProperties>? properties,
  ...
  factory ConfigServiceConfigurationRecorderStatusArgs.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderStatusArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ConfigServiceConfigurationRecorderStatusProperties>(ConfigServiceConfigurationRecorderStatusProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
