...
class NetworkFirewallFirewallPolicyPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsNetworkFirewallFirewallPolicyPropertiesResponse>?
  awsProperties;
  ...
  factory NetworkFirewallFirewallPolicyPropertiesResponse.fromMap(
    ...
    return NetworkFirewallFirewallPolicyPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsNetworkFirewallFirewallPolicyPropertiesResponse.fromMap(
