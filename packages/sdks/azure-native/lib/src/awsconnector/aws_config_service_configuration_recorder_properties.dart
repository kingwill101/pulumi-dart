...
class AwsConfigServiceConfigurationRecorderProperties {
  ...
  factory AwsConfigServiceConfigurationRecorderProperties.fromMap(
    ...
    return AwsConfigServiceConfigurationRecorderProperties(
      ...
      recordingGroup: (() {
        ...
        return pulumi.Input.fromValue(
          RecordingGroup.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      recordingMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RecordingMode.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      roleARN: (() {
