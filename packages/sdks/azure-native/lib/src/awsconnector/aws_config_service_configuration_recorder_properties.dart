...
class AwsConfigServiceConfigurationRecorderProperties {
  ...
  final pulumi.Input<RecordingGroup>? recordingGroup;
  ...
  final pulumi.Input<RecordingMode>? recordingMode;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': ?name,
      'recordingGroup': ?pulumi.Input.mapOptionalInputValue<RecordingGroup, Map<String, dynamic>>(recordingGroup, (value) => value.toMap()),
      'recordingMode': ?pulumi.Input.mapOptionalInputValue<RecordingMode, Map<String, dynamic>>(recordingMode, (value) => value.toMap()),
      'roleARN': ?roleARN,
    };
  }
