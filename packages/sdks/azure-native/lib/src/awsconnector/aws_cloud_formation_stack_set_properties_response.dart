...
class AwsCloudFormationStackSetPropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'autoDeployment': ?pulumi.Input.mapOptionalInputValue<AutoDeploymentResponse, Map<String, dynamic>>(autoDeployment, (value) => value.toMap()),
      'callAs': ?callAs,
      'capabilities': ?capabilities,
      'description': ?description,
      'executionRoleName': ?executionRoleName,
      'managedExecution': ?pulumi.Input.mapOptionalInputValue<ActiveModelResponse, Map<String, dynamic>>(managedExecution, (value) => value.toMap()),
      'operationPreferences': ?pulumi.Input.mapOptionalInputValue<OperationPreferencesResponse, Map<String, dynamic>>(operationPreferences, (value) => value.toMap()),
      ...
      'stackInstancesGroup': ?pulumi.Input.mapOptionalInputValue<List<StackInstancesResponse>, List<Map<String, dynamic>>>(stackInstancesGroup, (value) => pulumi.Input.encodeList<StackInstancesResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AwsCloudFormationStackSetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsCloudFormationStackSetPropertiesResponse(
      ...
      autoDeployment: (() { final guardedValue = map['autoDeployment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoDeploymentResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      managedExecution: (() { final guardedValue = map['managedExecution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ActiveModelResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      operationPreferences: (() { final guardedValue = map['operationPreferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OperationPreferencesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      stackInstancesGroup: (() { final guardedValue = map['stackInstancesGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StackInstancesResponse>(guardedValue, (value) => StackInstancesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
