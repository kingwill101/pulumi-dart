...
class AwsEc2SecurityGroupPropertiesResponse {
  ...
  factory AwsEc2SecurityGroupPropertiesResponse.fromMap(
    ...
    return AwsEc2SecurityGroupPropertiesResponse(
      ...
      ipPermissions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IpPermissionResponse>(
            guardedValue,
            (value) => IpPermissionResponse.fromMap(
