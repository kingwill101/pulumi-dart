...
import 'aws_ecs_service_properties_response.dart';

/// Definition of EcsService
class EcsServicePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcsServicePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcsServicePropertiesResponse].
  ...
  const EcsServicePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcsServicePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcsServicePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcsServicePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcsServicePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
