...
class FirelensConfigurationResponse {
  ...
  /// Creates a new [FirelensConfigurationResponse].
  ...
  FirelensConfigurationResponse({this.options, this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'options': ?options, 'type': ?type};
  }

  factory FirelensConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return FirelensConfigurationResponse(
      options: (() {
