...
class OrganizationsAccountPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsOrganizationsAccountPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  const OrganizationsAccountPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsOrganizationsAccountPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory OrganizationsAccountPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return OrganizationsAccountPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsOrganizationsAccountPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
