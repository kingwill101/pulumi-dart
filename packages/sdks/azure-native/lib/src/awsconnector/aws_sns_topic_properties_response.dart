...
class AwsSnsTopicPropertiesResponse {
  ...
  final pulumi.Input<List<SubscriptionResponse>>? subscription;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subscription': ?pulumi.Input.mapOptionalInputValue<List<SubscriptionResponse>, List<Map<String, dynamic>>>(subscription, (value) => pulumi.Input.encodeList<SubscriptionResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory AwsSnsTopicPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsSnsTopicPropertiesResponse(
      ...
      subscription: (() { final guardedValue = map['subscription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SubscriptionResponse>(guardedValue, (value) => SubscriptionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
