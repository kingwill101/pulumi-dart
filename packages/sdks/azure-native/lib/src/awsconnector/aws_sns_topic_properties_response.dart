    ...
    return AwsSnsTopicPropertiesResponse(
      ...
      deliveryStatusLogging: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LoggingConfigResponse>(
            guardedValue,
            (value) => LoggingConfigResponse.fromMap(
      ...
      subscription: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SubscriptionResponse>(
            guardedValue,
            (value) => SubscriptionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
