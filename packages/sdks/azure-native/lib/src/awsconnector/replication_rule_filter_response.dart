...
class ReplicationRuleFilterResponse {
  ...
  ReplicationRuleFilterResponse({this.and, this.prefix, this.tagFilter});
    ...
    return ReplicationRuleFilterResponse(
      and: (() {
        ...
        return pulumi.Input.fromValue(
          ReplicationRuleAndOperatorResponse.fromMap(
