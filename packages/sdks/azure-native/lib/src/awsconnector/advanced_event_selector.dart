...
class AdvancedEventSelector {
  ...
  factory AdvancedEventSelector.fromMap(Map<String, dynamic> map) {
    return AdvancedEventSelector(
      fieldSelectors: (() { final guardedValue = map['fieldSelectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AdvancedFieldSelector>(guardedValue, (value) => AdvancedFieldSelector.fromMap((value as Map).cast<String, dynamic>()))); })(),
