...
class RecordingMode {
  ...
  RecordingMode({this.recordingFrequency, this.recordingModeOverrides});
    ...
    return RecordingMode(
      recordingFrequency: (() {
        ...
        return pulumi.Input.fromValue(
          RecordingFrequencyEnumValue.fromMap(
      ...
      recordingModeOverrides: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecordingModeOverride>(
            guardedValue,
            (value) => RecordingModeOverride.fromMap(
