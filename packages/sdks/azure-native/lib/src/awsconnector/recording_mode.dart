...
class RecordingMode {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recordingModeOverrides': ?recordingModeOverrides == null ? null : pulumi.Input.encodeList<RecordingModeOverride, Map<String, dynamic>>(recordingModeOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory RecordingMode.fromMap(Map<String, dynamic> map) {
    return RecordingMode(
      ...
      recordingModeOverrides: map['recordingModeOverrides'] == null ? null : pulumi.Input.decodeList<RecordingModeOverride>(map['recordingModeOverrides'], (value) => RecordingModeOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
