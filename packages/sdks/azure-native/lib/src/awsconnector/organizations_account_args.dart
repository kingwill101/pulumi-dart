...
class OrganizationsAccountArgs {
  ...
  OrganizationsAccountArgs({
    ...
    pulumi.Output<OrganizationsAccountProperties>? properties,
  ...
  factory OrganizationsAccountArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationsAccountArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<OrganizationsAccountProperties>(OrganizationsAccountProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
