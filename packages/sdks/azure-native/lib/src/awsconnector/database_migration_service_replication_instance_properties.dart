...
class DatabaseMigrationServiceReplicationInstanceProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsDatabaseMigrationServiceReplicationInstanceProperties>?
  awsProperties;
  ...
  factory DatabaseMigrationServiceReplicationInstanceProperties.fromMap(
    ...
    return DatabaseMigrationServiceReplicationInstanceProperties(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsDatabaseMigrationServiceReplicationInstanceProperties.fromMap(
