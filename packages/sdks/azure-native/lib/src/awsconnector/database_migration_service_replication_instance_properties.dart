...
import 'aws_database_migration_service_replication_instance_properties.dart';

/// Definition of DatabaseMigrationServiceReplicationInstance
class DatabaseMigrationServiceReplicationInstanceProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsDatabaseMigrationServiceReplicationInstanceProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [DatabaseMigrationServiceReplicationInstanceProperties].
  ...
  const DatabaseMigrationServiceReplicationInstanceProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsDatabaseMigrationServiceReplicationInstanceProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory DatabaseMigrationServiceReplicationInstanceProperties.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationServiceReplicationInstanceProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsDatabaseMigrationServiceReplicationInstanceProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
