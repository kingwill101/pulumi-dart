...
class AwsDatabaseMigrationServiceReplicationInstanceProperties {
  ...
  factory AwsDatabaseMigrationServiceReplicationInstanceProperties.fromMap(
    ...
    return AwsDatabaseMigrationServiceReplicationInstanceProperties(
      ...
      pendingModifiedValues: (() {
        ...
        return pulumi.Input.fromValue(
          ReplicationPendingModifiedValues.fromMap(
      ...
      replicationSubnetGroup: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReplicationSubnetGroup.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      vpcSecurityGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpcSecurityGroupMembership>(
            guardedValue,
            (value) => VpcSecurityGroupMembership.fromMap(
