...
class AutoScalingAutoScalingGroup extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AutoScalingAutoScalingGroupPropertiesResponse>
  properties;
  ...
  AutoScalingAutoScalingGroup(
    ...
    properties = registerOutput<AutoScalingAutoScalingGroupPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return AutoScalingAutoScalingGroupPropertiesResponse.fromMap(
