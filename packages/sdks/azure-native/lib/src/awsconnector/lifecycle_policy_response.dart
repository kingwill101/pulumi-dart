...
class LifecyclePolicyResponse {
  ...
  factory LifecyclePolicyResponse.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyResponse(
      lifecyclePolicyText: (() {
        final guardedValue = map['lifecyclePolicyText'];
      ...
      transitionToArchive: (() {
        final guardedValue = map['transitionToArchive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      transitionToIA: (() {
        final guardedValue = map['transitionToIA'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      transitionToPrimaryStorageClass: (() {
        final guardedValue = map['transitionToPrimaryStorageClass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
