...
class AwsConfigServiceConfigurationRecorderPropertiesResponse {
  ...
  final RecordingGroupResponse? recordingGroup;
  ...
  final RecordingModeResponse? recordingMode;
  ...
  factory AwsConfigServiceConfigurationRecorderPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsConfigServiceConfigurationRecorderPropertiesResponse(
      ...
      recordingGroup: map['recordingGroup'] == null ? null : RecordingGroupResponse.fromMap((map['recordingGroup'] as Map).cast<String, dynamic>()),
      recordingMode: map['recordingMode'] == null ? null : RecordingModeResponse.fromMap((map['recordingMode'] as Map).cast<String, dynamic>()),
