...
class LocalSecondaryIndex {
  ...
  LocalSecondaryIndex({this.indexName, this.keySchema, this.projection});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'projection':
          ?pulumi.Input.mapOptionalInputValue<Projection, Map<String, dynamic>>(
            projection,
            (value) => value.toMap(),
          ),
    };
  ...
  factory LocalSecondaryIndex.fromMap(Map<String, dynamic> map) {
    return LocalSecondaryIndex(
      ...
      projection: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Projection.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
