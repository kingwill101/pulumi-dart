  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tags':
          ...
          >(
            tags,
            (value) => pulumi.Input.encodeList<TagItem, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return AwsGuardDutyDetectorProperties(
      dataSources: (() {
        ...
        return pulumi.Input.fromValue(
          CFNDataSourceConfigurations.fromMap(
      ...
      features: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CFNFeatureConfiguration>(
            guardedValue,
            (value) => CFNFeatureConfiguration.fromMap(
      ...
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TagItem>(
            guardedValue,
            (value) => TagItem.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
