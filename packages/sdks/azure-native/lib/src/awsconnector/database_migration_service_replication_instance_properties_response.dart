...
class DatabaseMigrationServiceReplicationInstancePropertiesResponse {
  ...
  /// AWS Properties
  final AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory DatabaseMigrationServiceReplicationInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationServiceReplicationInstancePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
