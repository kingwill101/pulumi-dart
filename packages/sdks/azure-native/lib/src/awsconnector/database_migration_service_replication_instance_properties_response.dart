...
import 'aws_database_migration_service_replication_instance_properties_response.dart';
...
class DatabaseMigrationServiceReplicationInstancePropertiesResponse {
  ...
  const DatabaseMigrationServiceReplicationInstancePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory DatabaseMigrationServiceReplicationInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationServiceReplicationInstancePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsDatabaseMigrationServiceReplicationInstancePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
