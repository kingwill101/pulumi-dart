...
class SqsQueueProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSqsQueueProperties?>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSqsQueueProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SqsQueueProperties.fromMap(Map<String, dynamic> map) {
    return SqsQueueProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSqsQueueProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
