...
import 'aws_ecs_cluster_properties_response.dart';

/// Definition of EcsCluster
class EcsClusterPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEcsClusterPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcsClusterPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEcsClusterPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory EcsClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcsClusterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEcsClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
