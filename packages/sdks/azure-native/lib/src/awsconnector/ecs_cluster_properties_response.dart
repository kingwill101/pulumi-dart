...
class EcsClusterPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEcsClusterPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory EcsClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcsClusterPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcsClusterPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
