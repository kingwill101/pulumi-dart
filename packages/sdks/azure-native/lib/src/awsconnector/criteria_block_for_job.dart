    ...
    return <String, dynamic>{
      'and':
          ...
          >(
            and,
            (value) =>
                pulumi.Input.encodeList<CriteriaForJob, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return CriteriaBlockForJob(
      and: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CriteriaForJob>(
            guardedValue,
            (value) =>
                CriteriaForJob.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
