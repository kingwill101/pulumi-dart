...
class IamAccessKeyMetadataInfoArgs {
  ...
  /// [tags] Resource tags.
  const IamAccessKeyMetadataInfoArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory IamAccessKeyMetadataInfoArgs.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyMetadataInfoArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamAccessKeyMetadataProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
