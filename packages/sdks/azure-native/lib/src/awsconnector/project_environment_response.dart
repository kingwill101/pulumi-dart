...
import 'compute_type_enum_value_response.dart';
import 'environment_type_enum_value_response.dart';
import 'environment_variable_response.dart';
import 'image_pull_credentials_type_enum_value_response.dart';
import 'project_fleet_response.dart';
...
class ProjectEnvironmentResponse {
  ...
  final pulumi.Input<ImagePullCredentialsTypeEnumValueResponse>?
    ...
    return ProjectEnvironmentResponse(
      ...
      computeType: (() {
        ...
        return pulumi.Input.fromValue(
          ComputeTypeEnumValueResponse.fromMap(
      ...
      imagePullCredentialsType: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImagePullCredentialsTypeEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      registryCredential: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RegistryCredentialResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnvironmentTypeEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
