...
class MetricStat {
  ...
  final pulumi.Input<Metric>? metric;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metric': ?pulumi.Input.mapOptionalInputValue<Metric, Map<String, dynamic>>(metric, (value) => value.toMap()),
      'period': ?period,
      'stat': ?stat,
      'unit': ?unit,
    };
  ...
  factory MetricStat.fromMap(Map<String, dynamic> map) {
    return MetricStat(
      metric: (() { final guardedValue = map['metric']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Metric.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
