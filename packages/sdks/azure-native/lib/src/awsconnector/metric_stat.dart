...
class MetricStat {
  ...
  MetricStat({this.metric, this.period, this.stat, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'metric':
          ?pulumi.Input.mapOptionalInputValue<Metric, Map<String, dynamic>>(
            metric,
            (value) => value.toMap(),
          ),
      'period': ?period,
    ...
    return MetricStat(
      metric: (() {
        ...
        return pulumi.Input.fromValue(
          Metric.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      period: (() {
