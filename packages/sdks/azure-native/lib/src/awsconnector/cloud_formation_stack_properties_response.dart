...
class CloudFormationStackPropertiesResponse {
  ...
  /// AWS Properties
  final AwsCloudFormationStackPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory CloudFormationStackPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudFormationStackPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
