...
import 'aws_cloud_formation_stack_properties_response.dart';

/// Definition of CloudFormationStack
class CloudFormationStackPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCloudFormationStackPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudFormationStackPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudFormationStackPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudFormationStackPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudFormationStackPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
