...
class SsmParameterProperties {
  ...
  /// AWS Properties
  final AwsSsmParameterProperties? awsProperties;
  /// AWS Region
  ...
  factory SsmParameterProperties.fromMap(Map<String, dynamic> map) {
    return SsmParameterProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSsmParameterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
