...
import 'aws_ssm_parameter_properties.dart';
...
class SsmParameterProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSsmParameterProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SsmParameterProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSsmParameterProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SsmParameterProperties.fromMap(Map<String, dynamic> map) {
    return SsmParameterProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSsmParameterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
