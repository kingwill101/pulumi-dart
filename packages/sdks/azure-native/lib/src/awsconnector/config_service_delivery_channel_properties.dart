...
import 'aws_config_service_delivery_channel_properties.dart';

/// Definition of ConfigServiceDeliveryChannel
class ConfigServiceDeliveryChannelProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsConfigServiceDeliveryChannelProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ConfigServiceDeliveryChannelProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsConfigServiceDeliveryChannelProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ConfigServiceDeliveryChannelProperties.fromMap(Map<String, dynamic> map) {
    return ConfigServiceDeliveryChannelProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsConfigServiceDeliveryChannelProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
