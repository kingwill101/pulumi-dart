...
class AwsCodeBuildProjectPropertiesResponse {
  ...
  factory AwsCodeBuildProjectPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsCodeBuildProjectPropertiesResponse(
      ...
      concurrentBuildLimit: (() { final guardedValue = map['concurrentBuildLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      queuedTimeoutInMinutes: (() { final guardedValue = map['queuedTimeoutInMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
