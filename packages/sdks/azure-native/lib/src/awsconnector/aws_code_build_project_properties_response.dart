...
class AwsCodeBuildProjectPropertiesResponse {
  ...
  final ProjectArtifactsResponse? artifacts;
  /// <p>Information about the build badge for the build project.</p>
  final ProjectBadgeResponse? badge;
  /// <p>A <a>ProjectBuildBatchConfig</a> object that defines the batch build options for the project.</p>
  final ProjectBuildBatchConfigResponse? buildBatchConfig;
  /// <p>Information about the cache for the build project.</p>
  final ProjectCacheResponse? cache;
  ...
  final ProjectEnvironmentResponse? environment;
  /// <p> An array of <code>ProjectFileSystemLocation</code> objects for a CodeBuild build project. A <code>ProjectFileSystemLocation</code> object specifies the <code>identifier</code>, <code>location</code>, <code>mountOptions</code>, <code>mountPoint</code>, and <code>type</code> of a file system created using Amazon Elastic File System. </p>
  final List<ProjectFileSystemLocationResponse>? fileSystemLocations;
  ...
  final LogsConfigResponse? logsConfig;
  /// <p>The name of the build project.</p>
  final String? name;
  /// Property projectVisibility
  final ProjectVisibilityTypeEnumValueResponse? projectVisibility;
  ...
  final List<ProjectArtifactsResponse>? secondaryArtifacts;
  ...
  final List<ProjectSourceVersionResponse>? secondarySourceVersions;
  /// <p>An array of <code>ProjectSource</code> objects. </p>
  final List<ProjectSourceResponse>? secondarySources;
  ...
  final ProjectSourceResponse? source;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileSystemLocations': ?fileSystemLocations == null ? null : pulumi.Input.encodeList<ProjectFileSystemLocationResponse, Map<String, dynamic>>(fileSystemLocations!, (value) => value.toMap()),
      ...
      'secondaryArtifacts': ?secondaryArtifacts == null ? null : pulumi.Input.encodeList<ProjectArtifactsResponse, Map<String, dynamic>>(secondaryArtifacts!, (value) => value.toMap()),
      'secondarySourceVersions': ?secondarySourceVersions == null ? null : pulumi.Input.encodeList<ProjectSourceVersionResponse, Map<String, dynamic>>(secondarySourceVersions!, (value) => value.toMap()),
      'secondarySources': ?secondarySources == null ? null : pulumi.Input.encodeList<ProjectSourceResponse, Map<String, dynamic>>(secondarySources!, (value) => value.toMap()),
  ...
  factory AwsCodeBuildProjectPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsCodeBuildProjectPropertiesResponse(
      ...
      artifacts: map['artifacts'] == null ? null : ProjectArtifactsResponse.fromMap((map['artifacts'] as Map).cast<String, dynamic>()),
      badge: map['badge'] == null ? null : ProjectBadgeResponse.fromMap((map['badge'] as Map).cast<String, dynamic>()),
      buildBatchConfig: map['buildBatchConfig'] == null ? null : ProjectBuildBatchConfigResponse.fromMap((map['buildBatchConfig'] as Map).cast<String, dynamic>()),
      cache: map['cache'] == null ? null : ProjectCacheResponse.fromMap((map['cache'] as Map).cast<String, dynamic>()),
      ...
      environment: map['environment'] == null ? null : ProjectEnvironmentResponse.fromMap((map['environment'] as Map).cast<String, dynamic>()),
      fileSystemLocations: map['fileSystemLocations'] == null ? null : pulumi.Input.decodeList<ProjectFileSystemLocationResponse>(map['fileSystemLocations'], (value) => ProjectFileSystemLocationResponse.fromMap((value as Map).cast<String, dynamic>())),
      lastModified: map['lastModified'] == null ? null : map['lastModified'] as String,
      logsConfig: map['logsConfig'] == null ? null : LogsConfigResponse.fromMap((map['logsConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      projectVisibility: map['projectVisibility'] == null ? null : ProjectVisibilityTypeEnumValueResponse.fromMap((map['projectVisibility'] as Map).cast<String, dynamic>()),
      ...
      secondaryArtifacts: map['secondaryArtifacts'] == null ? null : pulumi.Input.decodeList<ProjectArtifactsResponse>(map['secondaryArtifacts'], (value) => ProjectArtifactsResponse.fromMap((value as Map).cast<String, dynamic>())),
      secondarySourceVersions: map['secondarySourceVersions'] == null ? null : pulumi.Input.decodeList<ProjectSourceVersionResponse>(map['secondarySourceVersions'], (value) => ProjectSourceVersionResponse.fromMap((value as Map).cast<String, dynamic>())),
      secondarySources: map['secondarySources'] == null ? null : pulumi.Input.decodeList<ProjectSourceResponse>(map['secondarySources'], (value) => ProjectSourceResponse.fromMap((value as Map).cast<String, dynamic>())),
      serviceRole: map['serviceRole'] == null ? null : map['serviceRole'] as String,
      source: map['source'] == null ? null : ProjectSourceResponse.fromMap((map['source'] as Map).cast<String, dynamic>()),
      ...
      webhook: map['webhook'] == null ? null : WebhookResponse.fromMap((map['webhook'] as Map).cast<String, dynamic>()),
    );
  }
}
