...
import 'aws_ec2_snapshot_properties.dart';

/// Definition of Ec2Snapshot
class Ec2SnapshotProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2SnapshotProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2SnapshotProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2SnapshotProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2SnapshotProperties.fromMap(Map<String, dynamic> map) {
    return Ec2SnapshotProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2SnapshotProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
