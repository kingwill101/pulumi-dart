...
class Ec2SnapshotProperties {
  ...
  /// AWS Properties
  final AwsEc2SnapshotProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2SnapshotProperties.fromMap(Map<String, dynamic> map) {
    return Ec2SnapshotProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2SnapshotProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
