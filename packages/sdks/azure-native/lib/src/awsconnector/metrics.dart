...
class Metrics {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'eventThreshold': ?pulumi.Input.mapOptionalInputValue<ReplicationTimeValue, Map<String, dynamic>>(eventThreshold, (value) => value.toMap()),
      'status': ?status,
    };
  }
  ...
  factory Metrics.fromMap(Map<String, dynamic> map) {
    return Metrics(
      eventThreshold: (() { final guardedValue = map['eventThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationTimeValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
