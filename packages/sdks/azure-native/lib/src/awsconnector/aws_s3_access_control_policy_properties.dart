...
class AwsS3AccessControlPolicyProperties {
  ...
  AwsS3AccessControlPolicyProperties({this.grants, this.owner});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'grants':
          ...
          >(
            grants,
            (value) => pulumi.Input.encodeList<Grant, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'owner': ?pulumi.Input.mapOptionalInputValue<Owner, Map<String, dynamic>>(
        owner,
        (value) => value.toMap(),
      ),
    };
    ...
    return AwsS3AccessControlPolicyProperties(
      grants: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Grant>(
            guardedValue,
            (value) => Grant.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      owner: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          Owner.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
