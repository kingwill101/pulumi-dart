...
import 'aws_ec2_subnet_properties.dart';

/// Definition of Ec2Subnet
class Ec2SubnetProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2SubnetProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2SubnetProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2SubnetProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2SubnetProperties.fromMap(Map<String, dynamic> map) {
    return Ec2SubnetProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2SubnetProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
