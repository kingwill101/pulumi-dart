...
class Ec2SubnetProperties {
  ...
  /// AWS Properties
  final AwsEc2SubnetProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2SubnetProperties.fromMap(Map<String, dynamic> map) {
    return Ec2SubnetProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2SubnetProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
