...
class WafWebAclSummaryArgs {
  ...
  WafWebAclSummaryArgs({
    ...
    pulumi.Output<WafWebACLSummaryProperties>? properties,
  ...
  factory WafWebAclSummaryArgs.fromMap(Map<String, dynamic> map) {
    return WafWebAclSummaryArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<WafWebACLSummaryProperties>(WafWebACLSummaryProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
