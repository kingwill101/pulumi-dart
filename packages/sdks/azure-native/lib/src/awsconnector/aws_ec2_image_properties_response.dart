...
import 'block_device_mapping_response.dart';
...
import 'image_state_enum_value_response.dart';
import 'image_type_values_enum_value_response.dart';
import 'imds_support_values_enum_value_response.dart';
import 'platform_values_enum_value_response.dart';
import 'product_code_response.dart';
import 'state_reason_response.dart';
import 'tag_response.dart';
import 'tpm_support_values_enum_value_response.dart';
...
class AwsEc2ImagePropertiesResponse {
  ...
  final List<BlockDeviceMappingResponse>? blockDeviceMappings;
  ...
  final ImageTypeValuesEnumValueResponse? imageType;
  ...
  final ImdsSupportValuesEnumValueResponse? imdsSupport;
  ...
  final ImageStateEnumValueResponse? state;
  ...
  final TpmSupportValuesEnumValueResponse? tpmSupport;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'blockDeviceMappings': ?blockDeviceMappings == null ? null : pulumi.Input.encodeList<BlockDeviceMappingResponse, Map<String, dynamic>>(blockDeviceMappings!, (value) => value.toMap()),
  ...
  factory AwsEc2ImagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2ImagePropertiesResponse(
      ...
      blockDeviceMappings: map['blockDeviceMappings'] == null ? null : pulumi.Input.decodeList<BlockDeviceMappingResponse>(map['blockDeviceMappings'], (value) => BlockDeviceMappingResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      imageType: map['imageType'] == null ? null : ImageTypeValuesEnumValueResponse.fromMap((map['imageType'] as Map).cast<String, dynamic>()),
      imdsSupport: map['imdsSupport'] == null ? null : ImdsSupportValuesEnumValueResponse.fromMap((map['imdsSupport'] as Map).cast<String, dynamic>()),
      ...
      state: map['state'] == null ? null : ImageStateEnumValueResponse.fromMap((map['state'] as Map).cast<String, dynamic>()),
      ...
      tpmSupport: map['tpmSupport'] == null ? null : TpmSupportValuesEnumValueResponse.fromMap((map['tpmSupport'] as Map).cast<String, dynamic>()),
