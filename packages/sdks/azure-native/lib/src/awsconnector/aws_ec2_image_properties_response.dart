...
class AwsEc2ImagePropertiesResponse {
  ...
  const AwsEc2ImagePropertiesResponse({
    this.architecture,
  ...
  factory AwsEc2ImagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEc2ImagePropertiesResponse(
      ...
      blockDeviceMappings: (() { final guardedValue = map['blockDeviceMappings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BlockDeviceMappingResponse>(guardedValue, (value) => BlockDeviceMappingResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      imageType: (() { final guardedValue = map['imageType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageTypeValuesEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imdsSupport: (() { final guardedValue = map['imdsSupport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImdsSupportValuesEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      state: (() { final guardedValue = map['state']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageStateEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      tpmSupport: (() { final guardedValue = map['tpmSupport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TpmSupportValuesEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
