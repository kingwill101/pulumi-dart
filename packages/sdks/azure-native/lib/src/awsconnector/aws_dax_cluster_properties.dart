...
class AwsDaxClusterProperties {
  ...
  final pulumi.Input<ClusterEndpointEncryptionTypeEnumValue>?
  ...
  final pulumi.Input<DaxClusterNotificationConfiguration>?
    ...
    return <String, dynamic>{
      ...
      'clusterDiscoveryEndpoint':
          ?pulumi.Input.mapOptionalInputValue<
            DaxClusterEndpoint,
            Map<String, dynamic>
          >(clusterDiscoveryEndpoint, (value) => value.toMap()),
      'clusterEndpointEncryptionType':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterEndpointEncryptionTypeEnumValue,
            Map<String, dynamic>
          >(clusterEndpointEncryptionType, (value) => value.toMap()),
      ...
      'nodes':
          ...
          >(
            nodes,
            (value) => pulumi.Input.encodeList<Node, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'parameterGroup':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(parameterGroup, (value) => value.toMap()),
      ...
      'sseDescription':
          ?pulumi.Input.mapOptionalInputValue<
            SSEDescription,
            Map<String, dynamic>
          >(sseDescription, (value) => value.toMap()),
      'status': ?status,
  ...
  factory AwsDaxClusterProperties.fromMap(Map<String, dynamic> map) {
    return AwsDaxClusterProperties(
      activeNodes: (() {
        final guardedValue = map['activeNodes'];
      ...
      clusterDiscoveryEndpoint: (() {
        final guardedValue = map['clusterDiscoveryEndpoint'];
        if (guardedValue == null) return null;
      ...
      clusterEndpointEncryptionType: (() {
        final guardedValue = map['clusterEndpointEncryptionType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterEndpointEncryptionTypeEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      nodeIdsToRemove: (() {
        final guardedValue = map['nodeIdsToRemove'];
        if (guardedValue == null) return null;
      ...
      nodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Node>(
            guardedValue,
            (value) => Node.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      notificationConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DaxClusterNotificationConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      parameterGroup: (() {
        final guardedValue = map['parameterGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ParameterGroupStatus.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      securityGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SecurityGroupMembership>(
            guardedValue,
            (value) => SecurityGroupMembership.fromMap(
      ...
      sseDescription: (() {
        final guardedValue = map['sseDescription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SSEDescription.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      status: (() {
      ...
      subnetGroup: (() {
        final guardedValue = map['subnetGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      totalNodes: (() {
        final guardedValue = map['totalNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
