...
class OwnershipControlsResponse {
  ...
  OwnershipControlsResponse({this.rules});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<OwnershipControlsRuleResponse>,
    ...
    return OwnershipControlsResponse(
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OwnershipControlsRuleResponse>(
            guardedValue,
            (value) => OwnershipControlsRuleResponse.fromMap(
