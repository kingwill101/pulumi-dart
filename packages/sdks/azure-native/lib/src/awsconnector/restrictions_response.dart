...
class RestrictionsResponse {
  ...
  final pulumi.Input<GeoRestrictionResponse>? geoRestriction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'geoRestriction': ?pulumi.Input.mapOptionalInputValue<GeoRestrictionResponse, Map<String, dynamic>>(geoRestriction, (value) => value.toMap()),
    };
  }

  factory RestrictionsResponse.fromMap(Map<String, dynamic> map) {
    return RestrictionsResponse(
      geoRestriction: (() { final guardedValue = map['geoRestriction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GeoRestrictionResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
