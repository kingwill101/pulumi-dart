...
class ElasticBeanstalkEnvironmentPropertiesResponse {
  ...
  /// AWS Properties
  final AwsElasticBeanstalkEnvironmentPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory ElasticBeanstalkEnvironmentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkEnvironmentPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticBeanstalkEnvironmentPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
