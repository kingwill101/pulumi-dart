...
class ElasticBeanstalkEnvironmentPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkEnvironmentPropertiesResponse>?
  awsProperties;
  ...
  factory ElasticBeanstalkEnvironmentPropertiesResponse.fromMap(
    ...
    return ElasticBeanstalkEnvironmentPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsElasticBeanstalkEnvironmentPropertiesResponse.fromMap(
