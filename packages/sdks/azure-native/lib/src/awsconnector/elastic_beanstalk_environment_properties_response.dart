...
import 'aws_elastic_beanstalk_environment_properties_response.dart';

/// Definition of ElasticBeanstalkEnvironment
class ElasticBeanstalkEnvironmentPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkEnvironmentPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticBeanstalkEnvironmentPropertiesResponse].
  ...
  const ElasticBeanstalkEnvironmentPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticBeanstalkEnvironmentPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticBeanstalkEnvironmentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkEnvironmentPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticBeanstalkEnvironmentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
