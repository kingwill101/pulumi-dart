...
/// }
///
/// resource "azure-native_awsconnector_rdsdbinstance" "rdsDbInstance" {
///   location = "pktn"
///   name     = "Replace this value with a string matching RegExp ^(z=.{0,259}[^zs.]$)(z!.*[zzzzzzzz])"
///   properties = {
///     arn            = "ikxozbmzhxy"
...
class RdsDbInstance extends pulumi.CustomResource {
  ...
  RdsDbInstance(
    ...
    properties = registerOutput<RdsDBInstancePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RdsDBInstancePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [RdsDbInstance] resource.
  RdsDbInstance.reference(String urn)
    : super(
        'azure-native:awsconnector:RdsDbInstance',
