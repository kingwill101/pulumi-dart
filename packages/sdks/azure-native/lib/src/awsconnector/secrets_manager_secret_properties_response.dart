...
class SecretsManagerSecretPropertiesResponse {
  ...
  /// AWS Properties
  final AwsSecretsManagerSecretPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory SecretsManagerSecretPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SecretsManagerSecretPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSecretsManagerSecretPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
