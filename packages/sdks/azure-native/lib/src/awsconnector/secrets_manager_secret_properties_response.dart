...
import 'aws_secrets_manager_secret_properties_response.dart';

/// Definition of SecretsManagerSecret
class SecretsManagerSecretPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSecretsManagerSecretPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SecretsManagerSecretPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSecretsManagerSecretPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SecretsManagerSecretPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SecretsManagerSecretPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSecretsManagerSecretPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
