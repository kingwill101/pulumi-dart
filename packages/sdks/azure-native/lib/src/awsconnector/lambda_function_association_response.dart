...
class LambdaFunctionAssociationResponse {
  ...
  /// Creates a new [LambdaFunctionAssociationResponse].
  ...
  factory LambdaFunctionAssociationResponse.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionAssociationResponse(
      eventType: (() {
      ...
      lambdaFunctionARN: (() {
        final guardedValue = map['lambdaFunctionARN'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
