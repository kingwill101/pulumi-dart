...
class RdsExportTaskProperties {
  ...
  /// AWS Properties
  final AwsRdsExportTaskProperties? awsProperties;
  /// AWS Region
  ...
  factory RdsExportTaskProperties.fromMap(Map<String, dynamic> map) {
    return RdsExportTaskProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsExportTaskProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
