...
import 'aws_rds_export_task_properties.dart';

/// Definition of RdsExportTask
class RdsExportTaskProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsExportTaskProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsExportTaskProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsExportTaskProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsExportTaskProperties.fromMap(Map<String, dynamic> map) {
    return RdsExportTaskProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsExportTaskProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
