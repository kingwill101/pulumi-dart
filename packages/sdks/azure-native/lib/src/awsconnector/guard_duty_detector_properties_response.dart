...
class GuardDutyDetectorPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsGuardDutyDetectorPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  const GuardDutyDetectorPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsGuardDutyDetectorPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory GuardDutyDetectorPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GuardDutyDetectorPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsGuardDutyDetectorPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
