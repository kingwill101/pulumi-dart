...
import 'aws_lightsail_bucket_properties_response.dart';

/// Definition of LightsailBucket
class LightsailBucketPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsLightsailBucketPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LightsailBucketPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsLightsailBucketPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory LightsailBucketPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LightsailBucketPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLightsailBucketPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
