...
class LightsailBucketPropertiesResponse {
  ...
  /// AWS Properties
  final AwsLightsailBucketPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory LightsailBucketPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LightsailBucketPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLightsailBucketPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
