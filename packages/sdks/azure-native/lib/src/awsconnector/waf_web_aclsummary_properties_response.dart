...
import 'aws_waf_web_aclsummary_properties_response.dart';

/// Definition of WafWebACLSummary
class WafWebACLSummaryPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsWafWebACLSummaryPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [WafWebACLSummaryPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsWafWebACLSummaryPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory WafWebACLSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return WafWebACLSummaryPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsWafWebACLSummaryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
