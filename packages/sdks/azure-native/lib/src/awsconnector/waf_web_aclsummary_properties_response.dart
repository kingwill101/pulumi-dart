...
class WafWebACLSummaryPropertiesResponse {
  ...
  /// AWS Properties
  final AwsWafWebACLSummaryPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory WafWebACLSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return WafWebACLSummaryPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsWafWebACLSummaryPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
