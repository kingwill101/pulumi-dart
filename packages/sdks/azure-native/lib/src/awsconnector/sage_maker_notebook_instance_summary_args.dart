...
class SageMakerNotebookInstanceSummaryArgs {
  ...
  /// [tags] Resource tags.
  const SageMakerNotebookInstanceSummaryArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory SageMakerNotebookInstanceSummaryArgs.fromMap(Map<String, dynamic> map) {
    return SageMakerNotebookInstanceSummaryArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SageMakerNotebookInstanceSummaryProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
