...
class AdditionalAuthenticationProviderResponse {
  ...
  const AdditionalAuthenticationProviderResponse({
  ...
  factory AdditionalAuthenticationProviderResponse.fromMap(Map<String, dynamic> map) {
    return AdditionalAuthenticationProviderResponse(
      ...
      userPoolConfig: (() { final guardedValue = map['userPoolConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CognitoUserPoolConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
