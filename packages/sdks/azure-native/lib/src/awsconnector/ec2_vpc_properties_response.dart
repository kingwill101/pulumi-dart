...
import 'aws_ec2_vpc_properties_response.dart';

/// Definition of Ec2Vpc
class Ec2VpcPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2VpcPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2VpcPropertiesResponse].
  ...
  const Ec2VpcPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2VpcPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2VpcPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2VpcPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2VpcPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
