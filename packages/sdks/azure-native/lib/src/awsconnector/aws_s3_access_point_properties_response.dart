...
class AwsS3AccessPointPropertiesResponse {
  ...
  const AwsS3AccessPointPropertiesResponse({
    this.alias,
    this.arn,
    this.bucket,
  ...
  factory AwsS3AccessPointPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsS3AccessPointPropertiesResponse(
      ...
      vpcConfiguration: (() { final guardedValue = map['vpcConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VpcConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
