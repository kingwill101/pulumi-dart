...
class AwsEc2NetworkInterfaceProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipv4Prefixes': ?ipv4Prefixes == null ? null : pulumi.Input.encodeList<Ipv4PrefixSpecification, Map<String, dynamic>>(ipv4Prefixes!, (value) => value.toMap()),
      ...
      'ipv6Prefixes': ?ipv6Prefixes == null ? null : pulumi.Input.encodeList<Ipv6PrefixSpecification, Map<String, dynamic>>(ipv6Prefixes!, (value) => value.toMap()),
      'primaryIpv6Address': ?primaryIpv6Address,
      'primaryPrivateIpAddress': ?primaryPrivateIpAddress,
      'privateIpAddress': ?privateIpAddress,
      'privateIpAddresses': ?privateIpAddresses == null ? null : pulumi.Input.encodeList<PrivateIpAddressSpecification, Map<String, dynamic>>(privateIpAddresses!, (value) => value.toMap()),
  ...
  factory AwsEc2NetworkInterfaceProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2NetworkInterfaceProperties(
      connectionTrackingSpecification: map['connectionTrackingSpecification'] == null ? null : ConnectionTrackingSpecification.fromMap((map['connectionTrackingSpecification'] as Map).cast<String, dynamic>()),
      ...
      ipv4Prefixes: map['ipv4Prefixes'] == null ? null : pulumi.Input.decodeList<Ipv4PrefixSpecification>(map['ipv4Prefixes'], (value) => Ipv4PrefixSpecification.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ipv6Prefixes: map['ipv6Prefixes'] == null ? null : pulumi.Input.decodeList<Ipv6PrefixSpecification>(map['ipv6Prefixes'], (value) => Ipv6PrefixSpecification.fromMap((value as Map).cast<String, dynamic>())),
      ...
      privateIpAddresses: map['privateIpAddresses'] == null ? null : pulumi.Input.decodeList<PrivateIpAddressSpecification>(map['privateIpAddresses'], (value) => PrivateIpAddressSpecification.fromMap((value as Map).cast<String, dynamic>())),
