...
class AwsEc2NetworkInterfaceProperties {
  ...
  factory AwsEc2NetworkInterfaceProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2NetworkInterfaceProperties(
      connectionTrackingSpecification: map['connectionTrackingSpecification'] == null ? null : (ConnectionTrackingSpecification.fromMap((map['connectionTrackingSpecification'] as Map).cast<String, dynamic>())).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      enablePrimaryIpv6: map['enablePrimaryIpv6'] == null ? null : (map['enablePrimaryIpv6'] as bool).input(),
      groupSet: map['groupSet'] == null ? null : ((map['groupSet'] as List).cast<String>()).input(),
      ...
      ipv4Prefixes: map['ipv4Prefixes'] == null ? null : (pulumi.Input.decodeList<Ipv4PrefixSpecification>(map['ipv4Prefixes'], (value) => Ipv4PrefixSpecification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      ipv6Prefixes: map['ipv6Prefixes'] == null ? null : (pulumi.Input.decodeList<Ipv6PrefixSpecification>(map['ipv6Prefixes'], (value) => Ipv6PrefixSpecification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      primaryIpv6Address: map['primaryIpv6Address'] == null ? null : (map['primaryIpv6Address'] as String).input(),
      primaryPrivateIpAddress: map['primaryPrivateIpAddress'] == null ? null : (map['primaryPrivateIpAddress'] as String).input(),
      privateIpAddress: map['privateIpAddress'] == null ? null : (map['privateIpAddress'] as String).input(),
      privateIpAddresses: map['privateIpAddresses'] == null ? null : (pulumi.Input.decodeList<PrivateIpAddressSpecification>(map['privateIpAddresses'], (value) => PrivateIpAddressSpecification.fromMap((value as Map).cast<String, dynamic>()))).input(),
