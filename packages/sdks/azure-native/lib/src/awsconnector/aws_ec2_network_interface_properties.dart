...
class AwsEc2NetworkInterfaceProperties {
  ...
  final pulumi.Input<ConnectionTrackingSpecification>?
    ...
    return AwsEc2NetworkInterfaceProperties(
      connectionTrackingSpecification: (() {
        ...
        return pulumi.Input.fromValue(
          ConnectionTrackingSpecification.fromMap(
      ...
      ipv4Prefixes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Ipv4PrefixSpecification>(
            guardedValue,
            (value) => Ipv4PrefixSpecification.fromMap(
      ...
      ipv6Prefixes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Ipv6PrefixSpecification>(
            guardedValue,
            (value) => Ipv6PrefixSpecification.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      privateIpAddresses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PrivateIpAddressSpecification>(
            guardedValue,
            (value) => PrivateIpAddressSpecification.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
