...
class AwsDynamoDBTableProperties {
  ...
  final pulumi.Input<ContributorInsightsSpecification>?
  ...
  final pulumi.Input<PointInTimeRecoverySpecification>?
    ...
    return <String, dynamic>{
      ...
      'contributorInsightsSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            ContributorInsightsSpecification,
            Map<String, dynamic>
          >(contributorInsightsSpecification, (value) => value.toMap()),
      ...
      'importSourceSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            ImportSourceSpecification,
            Map<String, dynamic>
          >(importSourceSpecification, (value) => value.toMap()),
      'keySchema':
          ?pulumi.Input.mapOptionalInputValue<
            List<KeySchema>,
            List<Map<String, dynamic>>
          >(
            keySchema,
            (value) => pulumi.Input.encodeList<KeySchema, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'kinesisStreamSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            KinesisStreamSpecification,
            Map<String, dynamic>
          >(kinesisStreamSpecification, (value) => value.toMap()),
      ...
      'pointInTimeRecoverySpecification':
          ?pulumi.Input.mapOptionalInputValue<
            PointInTimeRecoverySpecification,
            Map<String, dynamic>
          >(pointInTimeRecoverySpecification, (value) => value.toMap()),
      ...
      'resourcePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ResourcePolicy,
            Map<String, dynamic>
          >(resourcePolicy, (value) => value.toMap()),
      'sseSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            SSESpecification,
            Map<String, dynamic>
      ...
      'streamSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            StreamSpecification,
            Map<String, dynamic>
          >(streamSpecification, (value) => value.toMap()),
      ...
      'timeToLiveSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            TimeToLiveSpecification,
            Map<String, dynamic>
          >(timeToLiveSpecification, (value) => value.toMap()),
    };
  }
  ...
  factory AwsDynamoDBTableProperties.fromMap(Map<String, dynamic> map) {
    return AwsDynamoDBTableProperties(
      ...
      attributeDefinitions: (() {
        final guardedValue = map['attributeDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AttributeDefinition>(
            guardedValue,
            (value) => AttributeDefinition.fromMap(
      ...
      contributorInsightsSpecification: (() {
        final guardedValue = map['contributorInsightsSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContributorInsightsSpecification.fromMap(
      ...
      globalSecondaryIndexes: (() {
        final guardedValue = map['globalSecondaryIndexes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GlobalSecondaryIndex>(
            guardedValue,
            (value) => GlobalSecondaryIndex.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      importSourceSpecification: (() {
        final guardedValue = map['importSourceSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImportSourceSpecification.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      keySchema: (() {
        final guardedValue = map['keySchema'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeySchema>(
            guardedValue,
            (value) =>
                KeySchema.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      kinesisStreamSpecification: (() {
        final guardedValue = map['kinesisStreamSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KinesisStreamSpecification.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      localSecondaryIndexes: (() {
        final guardedValue = map['localSecondaryIndexes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LocalSecondaryIndex>(
            guardedValue,
            (value) => LocalSecondaryIndex.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      pointInTimeRecoverySpecification: (() {
        final guardedValue = map['pointInTimeRecoverySpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PointInTimeRecoverySpecification.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      resourcePolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ResourcePolicy.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sseSpecification: (() {
      ...
      streamSpecification: (() {
        final guardedValue = map['streamSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StreamSpecification.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      tableClass: (() {
        final guardedValue = map['tableClass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tableName: (() {
      ...
      timeToLiveSpecification: (() {
        final guardedValue = map['timeToLiveSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TimeToLiveSpecification.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
