...
class AwsDynamoDBTableProperties {
  ...
  factory AwsDynamoDBTableProperties.fromMap(Map<String, dynamic> map) {
    return AwsDynamoDBTableProperties(
      ...
      attributeDefinitions: map['attributeDefinitions'] == null ? null : (pulumi.Input.decodeList<AttributeDefinition>(map['attributeDefinitions']!, (value) => AttributeDefinition.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      globalSecondaryIndexes: map['globalSecondaryIndexes'] == null ? null : (pulumi.Input.decodeList<GlobalSecondaryIndex>(map['globalSecondaryIndexes']!, (value) => GlobalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>()))).input(),
      importSourceSpecification: map['importSourceSpecification'] == null ? null : (ImportSourceSpecification.fromMap((map['importSourceSpecification']! as Map).cast<String, dynamic>())).input(),
      ...
      kinesisStreamSpecification: map['kinesisStreamSpecification'] == null ? null : (KinesisStreamSpecification.fromMap((map['kinesisStreamSpecification']! as Map).cast<String, dynamic>())).input(),
      localSecondaryIndexes: map['localSecondaryIndexes'] == null ? null : (pulumi.Input.decodeList<LocalSecondaryIndex>(map['localSecondaryIndexes']!, (value) => LocalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>()))).input(),
      pointInTimeRecoverySpecification: map['pointInTimeRecoverySpecification'] == null ? null : (PointInTimeRecoverySpecification.fromMap((map['pointInTimeRecoverySpecification']! as Map).cast<String, dynamic>())).input(),
      ...
      sseSpecification: map['sseSpecification'] == null ? null : (SSESpecification.fromMap((map['sseSpecification']! as Map).cast<String, dynamic>())).input(),
      streamArn: map['streamArn'] == null ? null : (map['streamArn']! as String).input(),
      streamSpecification: map['streamSpecification'] == null ? null : (StreamSpecification.fromMap((map['streamSpecification']! as Map).cast<String, dynamic>())).input(),
      tableClass: map['tableClass'] == null ? null : (map['tableClass']! as String).input(),
      tableName: map['tableName'] == null ? null : (map['tableName']! as String).input(),
      tags: map['tags'] == null ? null : (pulumi.Input.decodeList<Tag>(map['tags']!, (value) => Tag.fromMap((value as Map).cast<String, dynamic>()))).input(),
      timeToLiveSpecification: map['timeToLiveSpecification'] == null ? null : (TimeToLiveSpecification.fromMap((map['timeToLiveSpecification']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
