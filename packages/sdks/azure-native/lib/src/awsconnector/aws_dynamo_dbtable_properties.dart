...
class AwsDynamoDBTableProperties {
  ...
  final ContributorInsightsSpecification? contributorInsightsSpecification;
  ...
  final ImportSourceSpecification? importSourceSpecification;
  /// Specifies the attributes that make up the primary key for the table. The attributes in the ``KeySchema`` property must also be defined in the ``AttributeDefinitions`` property.
  final List<KeySchema>? keySchema;
  ...
  final KinesisStreamSpecification? kinesisStreamSpecification;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arn': ?arn,
      'attributeDefinitions': ?attributeDefinitions == null ? null : pulumi.Input.encodeList<AttributeDefinition, Map<String, dynamic>>(attributeDefinitions!, (value) => value.toMap()),
      ...
      'globalSecondaryIndexes': ?globalSecondaryIndexes == null ? null : pulumi.Input.encodeList<GlobalSecondaryIndex, Map<String, dynamic>>(globalSecondaryIndexes!, (value) => value.toMap()),
      'importSourceSpecification': ?importSourceSpecification == null ? null : importSourceSpecification!.toMap(),
      'keySchema': ?keySchema == null ? null : pulumi.Input.encodeList<KeySchema, Map<String, dynamic>>(keySchema!, (value) => value.toMap()),
      'kinesisStreamSpecification': ?kinesisStreamSpecification == null ? null : kinesisStreamSpecification!.toMap(),
      'localSecondaryIndexes': ?localSecondaryIndexes == null ? null : pulumi.Input.encodeList<LocalSecondaryIndex, Map<String, dynamic>>(localSecondaryIndexes!, (value) => value.toMap()),
  ...
  factory AwsDynamoDBTableProperties.fromMap(Map<String, dynamic> map) {
    return AwsDynamoDBTableProperties(
      ...
      attributeDefinitions: map['attributeDefinitions'] == null ? null : pulumi.Input.decodeList<AttributeDefinition>(map['attributeDefinitions'], (value) => AttributeDefinition.fromMap((value as Map).cast<String, dynamic>())),
      billingMode: map['billingMode'] == null ? null : map['billingMode'] as String,
      contributorInsightsSpecification: map['contributorInsightsSpecification'] == null ? null : ContributorInsightsSpecification.fromMap((map['contributorInsightsSpecification'] as Map).cast<String, dynamic>()),
      deletionProtectionEnabled: map['deletionProtectionEnabled'] == null ? null : map['deletionProtectionEnabled'] as bool,
      globalSecondaryIndexes: map['globalSecondaryIndexes'] == null ? null : pulumi.Input.decodeList<GlobalSecondaryIndex>(map['globalSecondaryIndexes'], (value) => GlobalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>())),
      importSourceSpecification: map['importSourceSpecification'] == null ? null : ImportSourceSpecification.fromMap((map['importSourceSpecification'] as Map).cast<String, dynamic>()),
      keySchema: map['keySchema'] == null ? null : pulumi.Input.decodeList<KeySchema>(map['keySchema'], (value) => KeySchema.fromMap((value as Map).cast<String, dynamic>())),
      kinesisStreamSpecification: map['kinesisStreamSpecification'] == null ? null : KinesisStreamSpecification.fromMap((map['kinesisStreamSpecification'] as Map).cast<String, dynamic>()),
      localSecondaryIndexes: map['localSecondaryIndexes'] == null ? null : pulumi.Input.decodeList<LocalSecondaryIndex>(map['localSecondaryIndexes'], (value) => LocalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>())),
      pointInTimeRecoverySpecification: map['pointInTimeRecoverySpecification'] == null ? null : PointInTimeRecoverySpecification.fromMap((map['pointInTimeRecoverySpecification'] as Map).cast<String, dynamic>()),
      provisionedThroughput: map['provisionedThroughput'] == null ? null : ProvisionedThroughput.fromMap((map['provisionedThroughput'] as Map).cast<String, dynamic>()),
      resourcePolicy: map['resourcePolicy'] == null ? null : ResourcePolicy.fromMap((map['resourcePolicy'] as Map).cast<String, dynamic>()),
      sseSpecification: map['sseSpecification'] == null ? null : SSESpecification.fromMap((map['sseSpecification'] as Map).cast<String, dynamic>()),
      streamArn: map['streamArn'] == null ? null : map['streamArn'] as String,
      streamSpecification: map['streamSpecification'] == null ? null : StreamSpecification.fromMap((map['streamSpecification'] as Map).cast<String, dynamic>()),
      ...
      timeToLiveSpecification: map['timeToLiveSpecification'] == null ? null : TimeToLiveSpecification.fromMap((map['timeToLiveSpecification'] as Map).cast<String, dynamic>()),
    );
  }
}
