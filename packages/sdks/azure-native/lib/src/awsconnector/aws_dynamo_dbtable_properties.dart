...
import 'global_secondary_index.dart';
import 'import_source_specification.dart';
import 'key_schema.dart';
import 'kinesis_stream_specification.dart';
import 'local_secondary_index.dart';
import 'point_in_time_recovery_specification.dart';
import 'provisioned_throughput.dart';
import 'resource_policy.dart';
import 'ssespecification.dart';
import 'stream_specification.dart';
import 'tag.dart';
import 'time_to_live_specification.dart';

/// Definition of awsDynamoDBTable
class AwsDynamoDBTableProperties {
  /// Property arn
  ...
  final pulumi.Input<List<AttributeDefinition>?>? attributeDefinitions;
  ...
  final pulumi.Input<List<GlobalSecondaryIndex>?>? globalSecondaryIndexes;
  ...
  final pulumi.Input<ImportSourceSpecification?>? importSourceSpecification;
  ...
  final pulumi.Input<KinesisStreamSpecification?>? kinesisStreamSpecification;
  /// Local secondary indexes to be created on the table. You can create up to 5 local secondary indexes. Each index is scoped to a given hash key value. The size of each hash key can be up to 10 gigabytes.
  final pulumi.Input<List<LocalSecondaryIndex>?>? localSecondaryIndexes;
  /// The settings used to enable point in time recovery. The settings used to enable point in time recovery.
  final pulumi.Input<PointInTimeRecoverySpecification?>? pointInTimeRecoverySpecification;
  ...
  final pulumi.Input<StreamSpecification?>? streamSpecification;
  ...
  final pulumi.Input<TimeToLiveSpecification?>? timeToLiveSpecification;

  /// Creates a new [AwsDynamoDBTableProperties].
  /// [arn] Property arn
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arn': ?arn,
      'attributeDefinitions': ?pulumi.Input.mapOptionalInputValue<List<AttributeDefinition>, List<Map<String, dynamic>>>(attributeDefinitions, (value) => pulumi.Input.encodeList<AttributeDefinition, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'globalSecondaryIndexes': ?pulumi.Input.mapOptionalInputValue<List<GlobalSecondaryIndex>, List<Map<String, dynamic>>>(globalSecondaryIndexes, (value) => pulumi.Input.encodeList<GlobalSecondaryIndex, Map<String, dynamic>>(value, (value) => value.toMap())),
      'importSourceSpecification': ?pulumi.Input.mapOptionalInputValue<ImportSourceSpecification, Map<String, dynamic>>(importSourceSpecification, (value) => value.toMap()),
      ...
      'kinesisStreamSpecification': ?pulumi.Input.mapOptionalInputValue<KinesisStreamSpecification, Map<String, dynamic>>(kinesisStreamSpecification, (value) => value.toMap()),
      'localSecondaryIndexes': ?pulumi.Input.mapOptionalInputValue<List<LocalSecondaryIndex>, List<Map<String, dynamic>>>(localSecondaryIndexes, (value) => pulumi.Input.encodeList<LocalSecondaryIndex, Map<String, dynamic>>(value, (value) => value.toMap())),
      'pointInTimeRecoverySpecification': ?pulumi.Input.mapOptionalInputValue<PointInTimeRecoverySpecification, Map<String, dynamic>>(pointInTimeRecoverySpecification, (value) => value.toMap()),
      ...
      'resourcePolicy': ?pulumi.Input.mapOptionalInputValue<ResourcePolicy, Map<String, dynamic>>(resourcePolicy, (value) => value.toMap()),
      'sseSpecification': ?pulumi.Input.mapOptionalInputValue<SSESpecification, Map<String, dynamic>>(sseSpecification, (value) => value.toMap()),
      'streamArn': ?streamArn,
      'streamSpecification': ?pulumi.Input.mapOptionalInputValue<StreamSpecification, Map<String, dynamic>>(streamSpecification, (value) => value.toMap()),
      'tableClass': ?tableClass,
      'tableName': ?tableName,
      'tags': ?pulumi.Input.mapOptionalInputValue<List<Tag>, List<Map<String, dynamic>>>(tags, (value) => pulumi.Input.encodeList<Tag, Map<String, dynamic>>(value, (value) => value.toMap())),
      'timeToLiveSpecification': ?pulumi.Input.mapOptionalInputValue<TimeToLiveSpecification, Map<String, dynamic>>(timeToLiveSpecification, (value) => value.toMap()),
    };
  }

  factory AwsDynamoDBTableProperties.fromMap(Map<String, dynamic> map) {
    return AwsDynamoDBTableProperties(
      arn: (() { final guardedValue = map['arn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      attributeDefinitions: (() { final guardedValue = map['attributeDefinitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AttributeDefinition>(guardedValue, (value) => AttributeDefinition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      globalSecondaryIndexes: (() { final guardedValue = map['globalSecondaryIndexes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GlobalSecondaryIndex>(guardedValue, (value) => GlobalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>()))); })(),
      importSourceSpecification: (() { final guardedValue = map['importSourceSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImportSourceSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      kinesisStreamSpecification: (() { final guardedValue = map['kinesisStreamSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KinesisStreamSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      localSecondaryIndexes: (() { final guardedValue = map['localSecondaryIndexes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LocalSecondaryIndex>(guardedValue, (value) => LocalSecondaryIndex.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pointInTimeRecoverySpecification: (() { final guardedValue = map['pointInTimeRecoverySpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PointInTimeRecoverySpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourcePolicy: (() { final guardedValue = map['resourcePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sseSpecification: (() { final guardedValue = map['sseSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SSESpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      streamSpecification: (() { final guardedValue = map['streamSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      timeToLiveSpecification: (() { final guardedValue = map['timeToLiveSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TimeToLiveSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
