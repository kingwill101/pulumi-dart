...
import 'aws_ec2_instance_properties_response.dart';

/// Definition of Ec2Instance
class Ec2InstancePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2InstancePropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2InstancePropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2InstancePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2InstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2InstancePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2InstancePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
