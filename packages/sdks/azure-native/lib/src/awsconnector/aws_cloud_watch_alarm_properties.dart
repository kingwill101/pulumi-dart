...
class AwsCloudWatchAlarmProperties {
  ...
  factory AwsCloudWatchAlarmProperties.fromMap(Map<String, dynamic> map) {
    return AwsCloudWatchAlarmProperties(
      ...
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricDataQuery>(guardedValue, (value) => MetricDataQuery.fromMap((value as Map).cast<String, dynamic>()))); })(),
