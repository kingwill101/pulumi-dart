...
class AwsEc2VolumeProperties {
  ...
  /// Creates a new [AwsEc2VolumeProperties].
  ...
  factory AwsEc2VolumeProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2VolumeProperties(
      autoEnableIO: (() { final guardedValue = map['autoEnableIO']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
