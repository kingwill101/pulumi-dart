...
class SecretsManagerResourcePolicyArgs {
  ...
  /// [tags] Resource tags.
  const SecretsManagerResourcePolicyArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory SecretsManagerResourcePolicyArgs.fromMap(Map<String, dynamic> map) {
    return SecretsManagerResourcePolicyArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretsManagerResourcePolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
