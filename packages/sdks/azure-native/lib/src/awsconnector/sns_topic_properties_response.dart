...
import 'aws_sns_topic_properties_response.dart';

/// Definition of SnsTopic
class SnsTopicPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSnsTopicPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SnsTopicPropertiesResponse].
  ...
  const SnsTopicPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSnsTopicPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SnsTopicPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SnsTopicPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSnsTopicPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
