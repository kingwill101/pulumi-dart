...
class AwsS3ControlMultiRegionAccessPointPolicyDocumentProperties {
  ...
  factory AwsS3ControlMultiRegionAccessPointPolicyDocumentProperties.fromMap(
    ...
    return AwsS3ControlMultiRegionAccessPointPolicyDocumentProperties(
      established: (() {
        ...
        return pulumi.Input.fromValue(
          EstablishedMultiRegionAccessPointPolicy.fromMap(
      ...
      proposed: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProposedMultiRegionAccessPointPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
