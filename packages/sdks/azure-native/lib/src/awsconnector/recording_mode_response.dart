...
class RecordingModeResponse {
  ...
  final List<RecordingModeOverrideResponse>? recordingModeOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recordingModeOverrides': ?recordingModeOverrides == null ? null : pulumi.Input.encodeList<RecordingModeOverrideResponse, Map<String, dynamic>>(recordingModeOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory RecordingModeResponse.fromMap(Map<String, dynamic> map) {
    return RecordingModeResponse(
      ...
      recordingModeOverrides: map['recordingModeOverrides'] == null ? null : pulumi.Input.decodeList<RecordingModeOverrideResponse>(map['recordingModeOverrides'], (value) => RecordingModeOverrideResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
