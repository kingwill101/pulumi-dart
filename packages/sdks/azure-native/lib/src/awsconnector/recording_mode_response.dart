...
class RecordingModeResponse {
  ...
  final pulumi.Input<List<RecordingModeOverrideResponse>>?
  ...
  RecordingModeResponse({this.recordingFrequency, this.recordingModeOverrides});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'recordingModeOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecordingModeOverrideResponse>,
  ...
  factory RecordingModeResponse.fromMap(Map<String, dynamic> map) {
    return RecordingModeResponse(
      ...
      recordingModeOverrides: (() {
        final guardedValue = map['recordingModeOverrides'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecordingModeOverrideResponse>(
            guardedValue,
            (value) => RecordingModeOverrideResponse.fromMap(
