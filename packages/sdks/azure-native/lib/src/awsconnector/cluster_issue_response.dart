...
class ClusterIssueResponse {
  ...
  factory ClusterIssueResponse.fromMap(Map<String, dynamic> map) {
    return ClusterIssueResponse(
      code: (() { final guardedValue = map['code']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterIssueCodeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
