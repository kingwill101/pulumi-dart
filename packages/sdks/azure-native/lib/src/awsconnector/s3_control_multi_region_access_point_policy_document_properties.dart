...
class S3ControlMultiRegionAccessPointPolicyDocumentProperties {
  ...
  /// AWS Properties
  final AwsS3ControlMultiRegionAccessPointPolicyDocumentProperties? awsProperties;
  /// AWS Region
  ...
  factory S3ControlMultiRegionAccessPointPolicyDocumentProperties.fromMap(Map<String, dynamic> map) {
    return S3ControlMultiRegionAccessPointPolicyDocumentProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3ControlMultiRegionAccessPointPolicyDocumentProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
