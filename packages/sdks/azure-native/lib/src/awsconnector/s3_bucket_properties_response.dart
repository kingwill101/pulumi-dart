...
import 'aws_s3_bucket_properties_response.dart';

/// Definition of S3Bucket
class S3BucketPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsS3BucketPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3BucketPropertiesResponse].
  ...
  const S3BucketPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3BucketPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3BucketPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3BucketPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3BucketPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
