...
class StatefulRule {
  ...
  StatefulRule({this.action, this.header, this.ruleOptions});
    ...
    return <String, dynamic>{
      ...
      'ruleOptions':
          ...
          >(
            ruleOptions,
            (value) =>
                pulumi.Input.encodeList<RuleOption, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory StatefulRule.fromMap(Map<String, dynamic> map) {
    return StatefulRule(
      ...
      ruleOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleOption>(
            guardedValue,
            (value) =>
                RuleOption.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
