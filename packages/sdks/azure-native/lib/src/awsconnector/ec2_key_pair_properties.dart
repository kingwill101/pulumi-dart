...
class Ec2KeyPairProperties {
  ...
  factory Ec2KeyPairProperties.fromMap(Map<String, dynamic> map) {
    return Ec2KeyPairProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2KeyPairProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
