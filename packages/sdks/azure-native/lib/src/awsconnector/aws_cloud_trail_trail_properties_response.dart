...
class AwsCloudTrailTrailPropertiesResponse {
  ...
  final List<AdvancedEventSelectorResponse>? advancedEventSelectors;
  /// Property arn
  final String? arn;
  ...
  final List<EventSelectorResponse>? eventSelectors;
  /// Specifies whether the trail is publishing events from global services such as IAM to the log files.
  final bool? includeGlobalServiceEvents;
  /// Lets you enable Insights event logging by specifying the Insights selectors that you want to enable on an existing trail.
  final List<InsightSelectorResponse>? insightSelectors;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advancedEventSelectors': ?advancedEventSelectors == null ? null : pulumi.Input.encodeList<AdvancedEventSelectorResponse, Map<String, dynamic>>(advancedEventSelectors!, (value) => value.toMap()),
      'arn': ?arn,
      'cloudWatchLogsLogGroupArn': ?cloudWatchLogsLogGroupArn,
      'cloudWatchLogsRoleArn': ?cloudWatchLogsRoleArn,
      'enableLogFileValidation': ?enableLogFileValidation,
      'eventSelectors': ?eventSelectors == null ? null : pulumi.Input.encodeList<EventSelectorResponse, Map<String, dynamic>>(eventSelectors!, (value) => value.toMap()),
      'includeGlobalServiceEvents': ?includeGlobalServiceEvents,
      'insightSelectors': ?insightSelectors == null ? null : pulumi.Input.encodeList<InsightSelectorResponse, Map<String, dynamic>>(insightSelectors!, (value) => value.toMap()),
      'isLogging': ?isLogging,
  ...
  factory AwsCloudTrailTrailPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsCloudTrailTrailPropertiesResponse(
      advancedEventSelectors: map['advancedEventSelectors'] == null ? null : pulumi.Input.decodeList<AdvancedEventSelectorResponse>(map['advancedEventSelectors'], (value) => AdvancedEventSelectorResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      eventSelectors: map['eventSelectors'] == null ? null : pulumi.Input.decodeList<EventSelectorResponse>(map['eventSelectors'], (value) => EventSelectorResponse.fromMap((value as Map).cast<String, dynamic>())),
      includeGlobalServiceEvents: map['includeGlobalServiceEvents'] == null ? null : map['includeGlobalServiceEvents'] as bool,
      insightSelectors: map['insightSelectors'] == null ? null : pulumi.Input.decodeList<InsightSelectorResponse>(map['insightSelectors'], (value) => InsightSelectorResponse.fromMap((value as Map).cast<String, dynamic>())),
