...
class AwsCloudTrailTrailPropertiesResponse {
  ...
  final pulumi.Input<List<AdvancedEventSelectorResponse>>?
    ...
    return <String, dynamic>{
      'advancedEventSelectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<AdvancedEventSelectorResponse>,
  ...
  factory AwsCloudTrailTrailPropertiesResponse.fromMap(
    ...
    return AwsCloudTrailTrailPropertiesResponse(
      advancedEventSelectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdvancedEventSelectorResponse>(
            guardedValue,
            (value) => AdvancedEventSelectorResponse.fromMap(
      ...
      cloudWatchLogsRoleArn: (() {
        final guardedValue = map['cloudWatchLogsRoleArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      eventSelectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventSelectorResponse>(
            guardedValue,
            (value) => EventSelectorResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      insightSelectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InsightSelectorResponse>(
            guardedValue,
            (value) => InsightSelectorResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      isLogging: (() {
        final guardedValue = map['isLogging'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isMultiRegionTrail: (() {
