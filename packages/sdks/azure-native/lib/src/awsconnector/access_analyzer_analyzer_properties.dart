...
class AccessAnalyzerAnalyzerProperties {
  ...
  /// AWS Properties
  final AwsAccessAnalyzerAnalyzerProperties? awsProperties;
  /// AWS Region
  ...
  factory AccessAnalyzerAnalyzerProperties.fromMap(Map<String, dynamic> map) {
    return AccessAnalyzerAnalyzerProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsAccessAnalyzerAnalyzerProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
