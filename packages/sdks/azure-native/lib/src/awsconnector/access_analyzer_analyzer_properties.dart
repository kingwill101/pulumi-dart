...
import 'aws_access_analyzer_analyzer_properties.dart';

/// Definition of AccessAnalyzerAnalyzer
class AccessAnalyzerAnalyzerProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsAccessAnalyzerAnalyzerProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [AccessAnalyzerAnalyzerProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsAccessAnalyzerAnalyzerProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory AccessAnalyzerAnalyzerProperties.fromMap(Map<String, dynamic> map) {
    return AccessAnalyzerAnalyzerProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsAccessAnalyzerAnalyzerProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
