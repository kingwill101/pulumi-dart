...
import 'aws_macie_allow_list_properties.dart';

/// Definition of MacieAllowList
class MacieAllowListProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsMacieAllowListProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [MacieAllowListProperties].
  ...
  const MacieAllowListProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsMacieAllowListProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory MacieAllowListProperties.fromMap(Map<String, dynamic> map) {
    return MacieAllowListProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsMacieAllowListProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
