...
class MacieAllowListProperties {
  ...
  /// AWS Properties
  final AwsMacieAllowListProperties? awsProperties;
  /// AWS Region
  ...
  factory MacieAllowListProperties.fromMap(Map<String, dynamic> map) {
    return MacieAllowListProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsMacieAllowListProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
