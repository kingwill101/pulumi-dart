...
class RuleVariablesResponse {
  ...
  RuleVariablesResponse({this.ipSets, this.portSets});
  ...
  factory RuleVariablesResponse.fromMap(Map<String, dynamic> map) {
    return RuleVariablesResponse(
      ...
      portSets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<PortSetResponse>(
            guardedValue,
            (value) =>
                PortSetResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
