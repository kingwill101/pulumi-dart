...
class AwsNetworkFirewallRuleGroupProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ruleGroup':
          ?pulumi.Input.mapOptionalInputValue<RuleGroup, Map<String, dynamic>>(
            ruleGroup,
            (value) => value.toMap(),
          ),
  ...
  factory AwsNetworkFirewallRuleGroupProperties.fromMap(
    ...
    return AwsNetworkFirewallRuleGroupProperties(
      ...
      ruleGroup: (() {
        ...
        return pulumi.Input.fromValue(
          RuleGroup.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ruleGroupArn: (() {
