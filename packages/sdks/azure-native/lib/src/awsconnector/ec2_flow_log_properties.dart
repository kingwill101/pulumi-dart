...
import 'aws_ec2_flow_log_properties.dart';

/// Definition of Ec2FlowLog
class Ec2FlowLogProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2FlowLogProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2FlowLogProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2FlowLogProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2FlowLogProperties.fromMap(Map<String, dynamic> map) {
    return Ec2FlowLogProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2FlowLogProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
