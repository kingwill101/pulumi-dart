...
class Route53ResourceRecordSet extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Route53ResourceRecordSetPropertiesResponse>
  properties;
  ...
  Route53ResourceRecordSet(
    ...
    properties = registerOutput<Route53ResourceRecordSetPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return Route53ResourceRecordSetPropertiesResponse.fromMap(
