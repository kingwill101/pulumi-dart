...
/// }
///
/// resource "azure-native_awsconnector_route53resourcerecordset" "route53ResourceRecordSet" {
///   location = "fjdvlwthtamvmempnqmew"
///   name     = "Replace this value with a string matching RegExp ^(z=.{0,259}[^zs.]$)(z!.*[zzzzzzzz])"
///   properties = {
///     arn            = "bvuvtjvkmzr"
...
class Route53ResourceRecordSet extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [Route53ResourceRecordSet] resource.
  Route53ResourceRecordSet.reference(String urn)
    : super(
        'azure-native:awsconnector:Route53ResourceRecordSet',
