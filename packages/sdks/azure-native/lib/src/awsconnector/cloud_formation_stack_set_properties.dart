...
import 'aws_cloud_formation_stack_set_properties.dart';

/// Definition of CloudFormationStackSet
class CloudFormationStackSetProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCloudFormationStackSetProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudFormationStackSetProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudFormationStackSetProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudFormationStackSetProperties.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackSetProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudFormationStackSetProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
