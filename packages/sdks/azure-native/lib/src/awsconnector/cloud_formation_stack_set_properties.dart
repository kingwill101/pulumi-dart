...
class CloudFormationStackSetProperties {
  ...
  /// AWS Properties
  final AwsCloudFormationStackSetProperties? awsProperties;
  /// AWS Region
  ...
  factory CloudFormationStackSetProperties.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackSetProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudFormationStackSetProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
