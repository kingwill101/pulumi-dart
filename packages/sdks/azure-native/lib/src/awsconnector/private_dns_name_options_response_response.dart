...
class PrivateDnsNameOptionsResponseResponse {
  ...
  const PrivateDnsNameOptionsResponseResponse({
  ...
  factory PrivateDnsNameOptionsResponseResponse.fromMap(Map<String, dynamic> map) {
    return PrivateDnsNameOptionsResponseResponse(
      ...
      hostnameType: (() { final guardedValue = map['hostnameType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HostnameTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
