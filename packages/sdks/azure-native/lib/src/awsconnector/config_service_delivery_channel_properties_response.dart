...
class ConfigServiceDeliveryChannelPropertiesResponse {
  ...
  factory ConfigServiceDeliveryChannelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConfigServiceDeliveryChannelPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : (AwsConfigServiceDeliveryChannelPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>())).input(),
