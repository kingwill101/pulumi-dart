...
class ConfigServiceDeliveryChannelPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsConfigServiceDeliveryChannelPropertiesResponse>?
  awsProperties;
  ...
  factory ConfigServiceDeliveryChannelPropertiesResponse.fromMap(
    ...
    return ConfigServiceDeliveryChannelPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsConfigServiceDeliveryChannelPropertiesResponse.fromMap(
