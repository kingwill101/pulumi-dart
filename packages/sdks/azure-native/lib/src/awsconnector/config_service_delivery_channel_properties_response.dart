...
import 'aws_config_service_delivery_channel_properties_response.dart';

/// Definition of ConfigServiceDeliveryChannel
class ConfigServiceDeliveryChannelPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsConfigServiceDeliveryChannelPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ConfigServiceDeliveryChannelPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsConfigServiceDeliveryChannelPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ConfigServiceDeliveryChannelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConfigServiceDeliveryChannelPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsConfigServiceDeliveryChannelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
