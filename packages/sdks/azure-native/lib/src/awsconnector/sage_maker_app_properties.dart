...
import 'aws_sage_maker_app_properties.dart';

/// Definition of SageMakerApp
class SageMakerAppProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSageMakerAppProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SageMakerAppProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSageMakerAppProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SageMakerAppProperties.fromMap(Map<String, dynamic> map) {
    return SageMakerAppProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSageMakerAppProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
