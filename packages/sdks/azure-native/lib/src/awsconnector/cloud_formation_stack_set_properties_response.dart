...
import 'aws_cloud_formation_stack_set_properties_response.dart';

/// Definition of CloudFormationStackSet
class CloudFormationStackSetPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsCloudFormationStackSetPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudFormationStackSetPropertiesResponse].
  ...
  const CloudFormationStackSetPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsCloudFormationStackSetPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory CloudFormationStackSetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackSetPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsCloudFormationStackSetPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
