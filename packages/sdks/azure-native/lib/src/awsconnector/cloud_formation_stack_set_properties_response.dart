...
class CloudFormationStackSetPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsCloudFormationStackSetPropertiesResponse>?
  awsProperties;
  ...
  factory CloudFormationStackSetPropertiesResponse.fromMap(
    ...
    return CloudFormationStackSetPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsCloudFormationStackSetPropertiesResponse.fromMap(
