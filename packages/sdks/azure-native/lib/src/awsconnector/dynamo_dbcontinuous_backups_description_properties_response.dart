...
class DynamoDBContinuousBackupsDescriptionPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsDynamoDBContinuousBackupsDescriptionPropertiesResponse>?
  awsProperties;
  ...
  factory DynamoDBContinuousBackupsDescriptionPropertiesResponse.fromMap(
    ...
    return DynamoDBContinuousBackupsDescriptionPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsDynamoDBContinuousBackupsDescriptionPropertiesResponse.fromMap(
