...
class DynamoDBContinuousBackupsDescriptionPropertiesResponse {
  ...
  factory DynamoDBContinuousBackupsDescriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DynamoDBContinuousBackupsDescriptionPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : (AwsDynamoDBContinuousBackupsDescriptionPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>())).input(),
