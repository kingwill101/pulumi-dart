...
import 'aws_dynamo_dbcontinuous_backups_description_properties_response.dart';

/// Definition of DynamoDBContinuousBackupsDescription
class DynamoDBContinuousBackupsDescriptionPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsDynamoDBContinuousBackupsDescriptionPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [DynamoDBContinuousBackupsDescriptionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsDynamoDBContinuousBackupsDescriptionPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory DynamoDBContinuousBackupsDescriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DynamoDBContinuousBackupsDescriptionPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsDynamoDBContinuousBackupsDescriptionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
