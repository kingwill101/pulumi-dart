...
class IamGroupArgs {
  ...
  factory IamGroupArgs.fromMap(Map<String, dynamic> map) {
    return IamGroupArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IamGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
