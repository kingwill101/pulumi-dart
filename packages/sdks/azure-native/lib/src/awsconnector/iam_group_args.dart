...
class IamGroupArgs {
  ...
  IamGroupArgs({
    ...
    pulumi.Output<IamGroupProperties>? properties,
  ...
  factory IamGroupArgs.fromMap(Map<String, dynamic> map) {
    return IamGroupArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<IamGroupProperties>(IamGroupProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
