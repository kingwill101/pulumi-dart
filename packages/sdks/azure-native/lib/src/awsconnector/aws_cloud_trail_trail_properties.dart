...
class AwsCloudTrailTrailProperties {
  ...
  final pulumi.Input<List<AdvancedEventSelector>?>? advancedEventSelectors;
  /// Property arn
  ...
  final pulumi.Input<List<EventSelector>?>? eventSelectors;
  /// Specifies whether the trail is publishing events from global services such as IAM to the log files.
  final pulumi.Input<bool?>? includeGlobalServiceEvents;
  /// Lets you enable Insights event logging by specifying the Insights selectors that you want to enable on an existing trail.
  final pulumi.Input<List<InsightSelector>?>? insightSelectors;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'advancedEventSelectors': ?pulumi.Input.mapOptionalInputValue<List<AdvancedEventSelector>, List<Map<String, dynamic>>>(advancedEventSelectors, (value) => pulumi.Input.encodeList<AdvancedEventSelector, Map<String, dynamic>>(value, (value) => value.toMap())),
      'arn': ?arn,
      'cloudWatchLogsLogGroupArn': ?cloudWatchLogsLogGroupArn,
      'cloudWatchLogsRoleArn': ?cloudWatchLogsRoleArn,
      'enableLogFileValidation': ?enableLogFileValidation,
      'eventSelectors': ?pulumi.Input.mapOptionalInputValue<List<EventSelector>, List<Map<String, dynamic>>>(eventSelectors, (value) => pulumi.Input.encodeList<EventSelector, Map<String, dynamic>>(value, (value) => value.toMap())),
      'includeGlobalServiceEvents': ?includeGlobalServiceEvents,
      'insightSelectors': ?pulumi.Input.mapOptionalInputValue<List<InsightSelector>, List<Map<String, dynamic>>>(insightSelectors, (value) => pulumi.Input.encodeList<InsightSelector, Map<String, dynamic>>(value, (value) => value.toMap())),
      'isLogging': ?isLogging,
  ...
  factory AwsCloudTrailTrailProperties.fromMap(Map<String, dynamic> map) {
    return AwsCloudTrailTrailProperties(
      advancedEventSelectors: (() { final guardedValue = map['advancedEventSelectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AdvancedEventSelector>(guardedValue, (value) => AdvancedEventSelector.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      eventSelectors: (() { final guardedValue = map['eventSelectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventSelector>(guardedValue, (value) => EventSelector.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      insightSelectors: (() { final guardedValue = map['insightSelectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightSelector>(guardedValue, (value) => InsightSelector.fromMap((value as Map).cast<String, dynamic>()))); })(),
