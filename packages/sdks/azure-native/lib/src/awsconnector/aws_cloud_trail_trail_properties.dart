    ...
    return <String, dynamic>{
      ...
      'eventSelectors':
          ...
          >(
            eventSelectors,
            (value) =>
                pulumi.Input.encodeList<EventSelector, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'insightSelectors':
          ...
          >(
            insightSelectors,
            (value) =>
                pulumi.Input.encodeList<InsightSelector, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return AwsCloudTrailTrailProperties(
      advancedEventSelectors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AdvancedEventSelector>(
            guardedValue,
            (value) => AdvancedEventSelector.fromMap(
      ...
      eventSelectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventSelector>(
            guardedValue,
            (value) =>
                EventSelector.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      insightSelectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InsightSelector>(
            guardedValue,
            (value) =>
                InsightSelector.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      isLogging: (() {
