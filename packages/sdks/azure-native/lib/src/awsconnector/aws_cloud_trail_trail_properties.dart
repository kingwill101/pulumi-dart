...
class AwsCloudTrailTrailProperties {
  ...
  factory AwsCloudTrailTrailProperties.fromMap(Map<String, dynamic> map) {
    return AwsCloudTrailTrailProperties(
      advancedEventSelectors: map['advancedEventSelectors'] == null ? null : (pulumi.Input.decodeList<AdvancedEventSelector>(map['advancedEventSelectors']!, (value) => AdvancedEventSelector.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      eventSelectors: map['eventSelectors'] == null ? null : (pulumi.Input.decodeList<EventSelector>(map['eventSelectors']!, (value) => EventSelector.fromMap((value as Map).cast<String, dynamic>()))).input(),
      includeGlobalServiceEvents: map['includeGlobalServiceEvents'] == null ? null : (map['includeGlobalServiceEvents']! as bool).input(),
      insightSelectors: map['insightSelectors'] == null ? null : (pulumi.Input.decodeList<InsightSelector>(map['insightSelectors']!, (value) => InsightSelector.fromMap((value as Map).cast<String, dynamic>()))).input(),
