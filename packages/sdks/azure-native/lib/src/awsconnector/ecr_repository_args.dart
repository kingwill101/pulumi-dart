...
class EcrRepositoryArgs {
  ...
  EcrRepositoryArgs({
    ...
    pulumi.Output<EcrRepositoryProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<EcrRepositoryProperties>(properties),
  ...
  factory EcrRepositoryArgs.fromMap(Map<String, dynamic> map) {
    return EcrRepositoryArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<EcrRepositoryProperties>(EcrRepositoryProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
