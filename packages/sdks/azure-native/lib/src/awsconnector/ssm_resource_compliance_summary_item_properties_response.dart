...
class SsmResourceComplianceSummaryItemPropertiesResponse {
  ...
  /// AWS Properties
  final AwsSsmResourceComplianceSummaryItemPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory SsmResourceComplianceSummaryItemPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SsmResourceComplianceSummaryItemPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSsmResourceComplianceSummaryItemPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
