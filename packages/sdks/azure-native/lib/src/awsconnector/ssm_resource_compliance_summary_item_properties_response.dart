...
class SsmResourceComplianceSummaryItemPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsSsmResourceComplianceSummaryItemPropertiesResponse>?
  awsProperties;
  ...
  factory SsmResourceComplianceSummaryItemPropertiesResponse.fromMap(
    ...
    return SsmResourceComplianceSummaryItemPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsSsmResourceComplianceSummaryItemPropertiesResponse.fromMap(
