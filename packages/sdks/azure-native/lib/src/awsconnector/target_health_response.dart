...
class TargetHealthResponse {
  ...
  TargetHealthResponse({this.description, this.reason, this.state});
    ...
    return TargetHealthResponse(
      ...
      reason: (() {
        ...
        return pulumi.Input.fromValue(
          TargetHealthReasonEnumEnumValueResponse.fromMap(
      ...
      state: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TargetHealthStateEnumEnumValueResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
