...
class ReplicationRuleResponse {
  ...
  final pulumi.Input<ReplicationDestinationResponse>? destination;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destination': ?pulumi.Input.mapOptionalInputValue<ReplicationDestinationResponse, Map<String, dynamic>>(destination, (value) => value.toMap()),
  ...
  factory ReplicationRuleResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationRuleResponse(
      ...
      destination: (() { final guardedValue = map['destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationDestinationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
