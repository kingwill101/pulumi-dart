...
import 'delete_marker_replication_response.dart';
import 'replication_destination_s3_bucket_response.dart';
import 'replication_rule_filter_response.dart';
import 'source_selection_criteria_response.dart';

/// Definition of ReplicationRule
class ReplicationRuleResponse {
  ...
  final pulumi.Input<DeleteMarkerReplicationResponse>? deleteMarkerReplication;
  ...
  final pulumi.Input<ReplicationDestinationS3BucketResponse>? destination;
  ...
  final pulumi.Input<ReplicationRuleFilterResponse>? filter;
  ...
  final pulumi.Input<SourceSelectionCriteriaResponse>? sourceSelectionCriteria;
  /// Specifies whether the rule is enabled.
  final pulumi.Input<String>? status;

  /// Creates a new [ReplicationRuleResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'deleteMarkerReplication': ?pulumi.Input.mapOptionalInputValue<DeleteMarkerReplicationResponse, Map<String, dynamic>>(deleteMarkerReplication, (value) => value.toMap()),
      'destination': ?pulumi.Input.mapOptionalInputValue<ReplicationDestinationS3BucketResponse, Map<String, dynamic>>(destination, (value) => value.toMap()),
      'filter': ?pulumi.Input.mapOptionalInputValue<ReplicationRuleFilterResponse, Map<String, dynamic>>(filter, (value) => value.toMap()),
      'id': ?id,
      'prefix': ?prefix,
      'priority': ?priority,
      'sourceSelectionCriteria': ?pulumi.Input.mapOptionalInputValue<SourceSelectionCriteriaResponse, Map<String, dynamic>>(sourceSelectionCriteria, (value) => value.toMap()),
      'status': ?status,
    };
  }
  ...
  factory ReplicationRuleResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationRuleResponse(
      deleteMarkerReplication: (() { final guardedValue = map['deleteMarkerReplication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeleteMarkerReplicationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      destination: (() { final guardedValue = map['destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationDestinationS3BucketResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationRuleFilterResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      prefix: (() { final guardedValue = map['prefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      priority: (() { final guardedValue = map['priority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      sourceSelectionCriteria: (() { final guardedValue = map['sourceSelectionCriteria']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceSelectionCriteriaResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
