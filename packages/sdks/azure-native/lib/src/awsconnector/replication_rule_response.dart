...
class ReplicationRuleResponse {
    ...
    return <String, dynamic>{
      'deleteMarkerReplication':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(deleteMarkerReplication, (value) => value.toMap()),
      'destination':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ReplicationRuleResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationRuleResponse(
      deleteMarkerReplication: (() {
        final guardedValue = map['deleteMarkerReplication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeleteMarkerReplicationResponse.fromMap(
      ...
      destination: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReplicationDestinationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      filter: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ReplicationRuleFilterResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sourceSelectionCriteria: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourceSelectionCriteriaResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
