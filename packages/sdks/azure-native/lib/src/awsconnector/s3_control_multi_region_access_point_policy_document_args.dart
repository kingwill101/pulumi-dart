...
class S3ControlMultiRegionAccessPointPolicyDocumentArgs {
  ...
  S3ControlMultiRegionAccessPointPolicyDocumentArgs({
    ...
    pulumi.Output<S3ControlMultiRegionAccessPointPolicyDocumentProperties>? properties,
  ...
  factory S3ControlMultiRegionAccessPointPolicyDocumentArgs.fromMap(Map<String, dynamic> map) {
    return S3ControlMultiRegionAccessPointPolicyDocumentArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<S3ControlMultiRegionAccessPointPolicyDocumentProperties>(S3ControlMultiRegionAccessPointPolicyDocumentProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
