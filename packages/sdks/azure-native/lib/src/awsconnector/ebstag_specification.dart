...
class EBSTagSpecification {
  ...
  final pulumi.Input<dynamic>? propagateTags;
  ...
  factory EBSTagSpecification.fromMap(Map<String, dynamic> map) {
    return EBSTagSpecification(
      propagateTags: (() { final guardedValue = map['propagateTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
