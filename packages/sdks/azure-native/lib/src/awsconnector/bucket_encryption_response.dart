...
class BucketEncryptionResponse {
  ...
  final pulumi.Input<List<ServerSideEncryptionRuleResponse>>?
  ...
  BucketEncryptionResponse({this.serverSideEncryptionConfiguration});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'serverSideEncryptionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServerSideEncryptionRuleResponse>,
    ...
    return BucketEncryptionResponse(
      serverSideEncryptionConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerSideEncryptionRuleResponse>(
            guardedValue,
            (value) => ServerSideEncryptionRuleResponse.fromMap(
