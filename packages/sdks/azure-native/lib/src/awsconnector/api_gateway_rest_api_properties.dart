...
class ApiGatewayRestApiProperties {
  ...
  /// AWS Properties
  final AwsApiGatewayRestApiProperties? awsProperties;
  /// AWS Region
  ...
  factory ApiGatewayRestApiProperties.fromMap(Map<String, dynamic> map) {
    return ApiGatewayRestApiProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsApiGatewayRestApiProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
