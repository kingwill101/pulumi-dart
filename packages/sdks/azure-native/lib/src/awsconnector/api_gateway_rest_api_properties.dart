...
import 'aws_api_gateway_rest_api_properties.dart';
...
class ApiGatewayRestApiProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsApiGatewayRestApiProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ApiGatewayRestApiProperties].
  ...
  const ApiGatewayRestApiProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsApiGatewayRestApiProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ApiGatewayRestApiProperties.fromMap(Map<String, dynamic> map) {
    return ApiGatewayRestApiProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsApiGatewayRestApiProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
