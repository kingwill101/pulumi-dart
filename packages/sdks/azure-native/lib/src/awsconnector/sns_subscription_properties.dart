...
class SnsSubscriptionProperties {
  ...
  /// AWS Properties
  final AwsSnsSubscriptionProperties? awsProperties;
  /// AWS Region
  ...
  factory SnsSubscriptionProperties.fromMap(Map<String, dynamic> map) {
    return SnsSubscriptionProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSnsSubscriptionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
