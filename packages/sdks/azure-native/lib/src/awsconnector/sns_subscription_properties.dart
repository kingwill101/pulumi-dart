...
class SnsSubscriptionProperties {
  ...
  const SnsSubscriptionProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory SnsSubscriptionProperties.fromMap(Map<String, dynamic> map) {
    return SnsSubscriptionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSnsSubscriptionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
