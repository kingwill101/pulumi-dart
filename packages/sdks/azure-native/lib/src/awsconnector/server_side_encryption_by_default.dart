...
class ServerSideEncryptionByDefault {
  ...
  final pulumi.Input<dynamic>? sseAlgorithm;

  /// Creates a new [ServerSideEncryptionByDefault].
  ...
  factory ServerSideEncryptionByDefault.fromMap(Map<String, dynamic> map) {
    return ServerSideEncryptionByDefault(
      ...
      sseAlgorithm: (() { final guardedValue = map['sseAlgorithm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
