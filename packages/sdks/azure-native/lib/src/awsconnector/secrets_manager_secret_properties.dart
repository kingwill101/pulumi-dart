...
class SecretsManagerSecretProperties {
  ...
  /// AWS Properties
  final AwsSecretsManagerSecretProperties? awsProperties;
  /// AWS Region
  ...
  factory SecretsManagerSecretProperties.fromMap(Map<String, dynamic> map) {
    return SecretsManagerSecretProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSecretsManagerSecretProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
