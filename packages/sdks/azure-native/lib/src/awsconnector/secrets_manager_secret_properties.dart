...
import 'aws_secrets_manager_secret_properties.dart';

/// Definition of SecretsManagerSecret
class SecretsManagerSecretProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSecretsManagerSecretProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SecretsManagerSecretProperties].
  ...
  const SecretsManagerSecretProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSecretsManagerSecretProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SecretsManagerSecretProperties.fromMap(Map<String, dynamic> map) {
    return SecretsManagerSecretProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSecretsManagerSecretProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
