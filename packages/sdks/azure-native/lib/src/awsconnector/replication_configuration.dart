...
class ReplicationConfiguration {
  ...
  ReplicationConfiguration({this.destinations, this.role, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ...
          >(
            rules,
            (value) =>
                pulumi.Input.encodeList<ReplicationRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ReplicationConfiguration(
      destinations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicationDestination>(
            guardedValue,
            (value) => ReplicationDestination.fromMap(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicationRule>(
            guardedValue,
            (value) =>
                ReplicationRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
