...
class StatelessRulesAndCustomActions {
  ...
  StatelessRulesAndCustomActions({this.customActions, this.statelessRules});
    ...
    return <String, dynamic>{
      ...
      'statelessRules':
          ...
          >(
            statelessRules,
            (value) =>
                pulumi.Input.encodeList<StatelessRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory StatelessRulesAndCustomActions.fromMap(Map<String, dynamic> map) {
    return StatelessRulesAndCustomActions(
      ...
      statelessRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatelessRule>(
            guardedValue,
            (value) =>
                StatelessRule.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
