...
class StatelessRulesAndCustomActionsResponse {
  ...
  factory StatelessRulesAndCustomActionsResponse.fromMap(
    ...
    return StatelessRulesAndCustomActionsResponse(
      ...
      statelessRules: (() {
        final guardedValue = map['statelessRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StatelessRuleResponse>(
            guardedValue,
            (value) => StatelessRuleResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
