...
class AccessAnalyzerAnalyzerArgs {
  ...
  /// [tags] Resource tags.
  const AccessAnalyzerAnalyzerArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory AccessAnalyzerAnalyzerArgs.fromMap(Map<String, dynamic> map) {
    return AccessAnalyzerAnalyzerArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessAnalyzerAnalyzerProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
