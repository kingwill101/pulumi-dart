...
class AccessAnalyzerAnalyzerArgs {
  ...
  AccessAnalyzerAnalyzerArgs({
    ...
    pulumi.Output<AccessAnalyzerAnalyzerProperties>? properties,
  ...
  factory AccessAnalyzerAnalyzerArgs.fromMap(Map<String, dynamic> map) {
    return AccessAnalyzerAnalyzerArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<AccessAnalyzerAnalyzerProperties>(AccessAnalyzerAnalyzerProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
