...
import 'aws_guard_duty_detector_properties.dart';

/// Definition of GuardDutyDetector
class GuardDutyDetectorProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsGuardDutyDetectorProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [GuardDutyDetectorProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsGuardDutyDetectorProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory GuardDutyDetectorProperties.fromMap(Map<String, dynamic> map) {
    return GuardDutyDetectorProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsGuardDutyDetectorProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
