  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'destinationPorts':
          ...
          >(
            destinationPorts,
            (value) => pulumi.Input.encodeList<PortRange, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'destinations':
          ...
          >(
            destinations,
            (value) => pulumi.Input.encodeList<Address, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'tcpFlags':
          ...
          >(
            tcpFlags,
            (value) =>
                pulumi.Input.encodeList<TCPFlagField, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return MatchAttributes(
      destinationPorts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortRange>(
            guardedValue,
            (value) =>
                PortRange.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      destinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Address>(
            guardedValue,
            (value) => Address.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      protocols: (() {
      ...
      tcpFlags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TCPFlagField>(
            guardedValue,
            (value) =>
                TCPFlagField.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
