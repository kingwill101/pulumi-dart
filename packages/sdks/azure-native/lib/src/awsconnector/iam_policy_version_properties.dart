...
import 'aws_iam_policy_version_properties.dart';

/// Definition of IamPolicyVersion
class IamPolicyVersionProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsIamPolicyVersionProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamPolicyVersionProperties].
  ...
  const IamPolicyVersionProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsIamPolicyVersionProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory IamPolicyVersionProperties.fromMap(Map<String, dynamic> map) {
    return IamPolicyVersionProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsIamPolicyVersionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
