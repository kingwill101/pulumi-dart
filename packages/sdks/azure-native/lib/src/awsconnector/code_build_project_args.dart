...
class CodeBuildProjectArgs {
  ...
  factory CodeBuildProjectArgs.fromMap(Map<String, dynamic> map) {
    return CodeBuildProjectArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CodeBuildProjectProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
