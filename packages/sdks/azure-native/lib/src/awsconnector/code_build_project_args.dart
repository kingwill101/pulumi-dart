...
class CodeBuildProjectArgs {
  ...
  CodeBuildProjectArgs({
    ...
    pulumi.Output<CodeBuildProjectProperties>? properties,
  ...
  factory CodeBuildProjectArgs.fromMap(Map<String, dynamic> map) {
    return CodeBuildProjectArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<CodeBuildProjectProperties>(CodeBuildProjectProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
