...
class EksNodegroupArgs {
  ...
  factory EksNodegroupArgs.fromMap(Map<String, dynamic> map) {
    return EksNodegroupArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EksNodegroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
