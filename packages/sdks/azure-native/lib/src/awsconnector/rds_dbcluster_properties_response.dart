...
class RdsDBClusterPropertiesResponse {
  ...
  const RdsDBClusterPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory RdsDBClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBClusterPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
