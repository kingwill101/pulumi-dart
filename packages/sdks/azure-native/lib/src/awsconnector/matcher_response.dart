...
class MatcherResponse {
  ...
  MatcherResponse({this.grpcCode, this.httpCode});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'grpcCode': ?grpcCode, 'httpCode': ?httpCode};
  }

  factory MatcherResponse.fromMap(Map<String, dynamic> map) {
    return MatcherResponse(
      grpcCode: (() {
        final guardedValue = map['grpcCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      httpCode: (() {
        final guardedValue = map['httpCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
