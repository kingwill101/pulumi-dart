...
class RdsDbSnapshotArgs {
  ...
  factory RdsDbSnapshotArgs.fromMap(Map<String, dynamic> map) {
    return RdsDbSnapshotArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RdsDBSnapshotProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
