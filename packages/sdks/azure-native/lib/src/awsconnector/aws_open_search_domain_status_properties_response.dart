...
class AwsOpenSearchDomainStatusPropertiesResponse {
  ...
  factory AwsOpenSearchDomainStatusPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsOpenSearchDomainStatusPropertiesResponse(
      ...
      advancedSecurityOptions: (() { final guardedValue = map['advancedSecurityOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdvancedSecurityOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      arn: (() { final guardedValue = map['arn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      autoTuneOptions: (() { final guardedValue = map['autoTuneOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoTuneOptionsOutputResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      changeProgressDetails: (() { final guardedValue = map['changeProgressDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChangeProgressDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      clusterConfig: (() { final guardedValue = map['clusterConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cognitoOptions: (() { final guardedValue = map['cognitoOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CognitoOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      domainEndpointOptions: (() { final guardedValue = map['domainEndpointOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainEndpointOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      domainProcessingStatus: (() { final guardedValue = map['domainProcessingStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainProcessingStatusTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ebsOptions: (() { final guardedValue = map['ebsOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EBSOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      encryptionAtRestOptions: (() { final guardedValue = map['encryptionAtRestOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionAtRestOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      ipAddressType: (() { final guardedValue = map['ipAddressType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IPAddressTypeEnumValueResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      logPublishingOptions: (() { final guardedValue = map['logPublishingOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<LogPublishingOptionResponse>(guardedValue, (value) => LogPublishingOptionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      modifyingProperties: (() { final guardedValue = map['modifyingProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ModifyingPropertiesResponse>(guardedValue, (value) => ModifyingPropertiesResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      nodeToNodeEncryptionOptions: (() { final guardedValue = map['nodeToNodeEncryptionOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodeToNodeEncryptionOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      offPeakWindowOptions: (() { final guardedValue = map['offPeakWindowOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OffPeakWindowOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      serviceSoftwareOptions: (() { final guardedValue = map['serviceSoftwareOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceSoftwareOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapshotOptions: (() { final guardedValue = map['snapshotOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapshotOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      softwareUpdateOptions: (() { final guardedValue = map['softwareUpdateOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SoftwareUpdateOptionsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vpcOptions: (() { final guardedValue = map['vpcOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VPCDerivedInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
