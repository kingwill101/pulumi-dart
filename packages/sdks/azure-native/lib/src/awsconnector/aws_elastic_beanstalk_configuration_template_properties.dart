...
class AwsElasticBeanstalkConfigurationTemplateProperties {
  ...
  factory AwsElasticBeanstalkConfigurationTemplateProperties.fromMap(
    ...
    return AwsElasticBeanstalkConfigurationTemplateProperties(
      ...
      optionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ConfigurationOptionSetting>(
            guardedValue,
            (value) => ConfigurationOptionSetting.fromMap(
      ...
      sourceConfiguration: (() {
        final guardedValue = map['sourceConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SourceConfiguration.fromMap(
