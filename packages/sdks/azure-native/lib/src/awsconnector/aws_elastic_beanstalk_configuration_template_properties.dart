...
class AwsElasticBeanstalkConfigurationTemplateProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'optionSettings': ?optionSettings == null ? null : pulumi.Input.encodeList<ConfigurationOptionSetting, Map<String, dynamic>>(optionSettings!, (value) => value.toMap()),
  ...
  factory AwsElasticBeanstalkConfigurationTemplateProperties.fromMap(Map<String, dynamic> map) {
    return AwsElasticBeanstalkConfigurationTemplateProperties(
      ...
      optionSettings: map['optionSettings'] == null ? null : pulumi.Input.decodeList<ConfigurationOptionSetting>(map['optionSettings'], (value) => ConfigurationOptionSetting.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceConfiguration: map['sourceConfiguration'] == null ? null : SourceConfiguration.fromMap((map['sourceConfiguration'] as Map).cast<String, dynamic>()),
