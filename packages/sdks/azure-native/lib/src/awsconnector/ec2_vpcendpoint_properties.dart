...
class Ec2VPCEndpointProperties {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEc2VPCEndpointProperties>? awsProperties;
  /// AWS Region
  ...
  const Ec2VPCEndpointProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2VPCEndpointProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2VPCEndpointProperties.fromMap(Map<String, dynamic> map) {
    return Ec2VPCEndpointProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2VPCEndpointProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
