...
class AwsLogsLogGroupProperties {
  ...
  final pulumi.Input<dynamic>? logGroupClass;
  ...
  AwsLogsLogGroupProperties({
    ...
    this.kmsKeyId,
    pulumi.Input<dynamic>? logGroupClass,
    this.logGroupName,
    this.retentionInDays,
    this.tags,
  }) : logGroupClass = logGroupClass ?? pulumi.Input.fromValue('STANDARD');
  ...
  factory AwsLogsLogGroupProperties.fromMap(Map<String, dynamic> map) {
    return AwsLogsLogGroupProperties(
      ...
      logGroupClass: (() { final guardedValue = map['logGroupClass']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
