  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customErrorResponses':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomErrorResponseResponse>,
            List<Map<String, dynamic>>
          >(
            customErrorResponses,
            (value) =>
      ...
      'origins':
          ...
          >(
            origins,
            (value) =>
                pulumi.Input.encodeList<OriginResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DistributionConfigResponse(
      ...
      cacheBehaviors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CacheBehaviorResponse>(
            guardedValue,
            (value) => CacheBehaviorResponse.fromMap(
      ...
      customErrorResponses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomErrorResponseResponse>(
            guardedValue,
            (value) => CustomErrorResponseResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      customOrigin: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LegacyCustomOriginResponse.fromMap(
      ...
      defaultCacheBehavior: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefaultCacheBehaviorResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      origins: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OriginResponse>(
            guardedValue,
            (value) =>
                OriginResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      priceClass: (() {
      ...
      s3Origin: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LegacyS3OriginResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      viewerCertificate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ViewerCertificateResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
