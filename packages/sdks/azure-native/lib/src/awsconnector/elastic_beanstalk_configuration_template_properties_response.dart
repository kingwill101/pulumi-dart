...
class ElasticBeanstalkConfigurationTemplatePropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkConfigurationTemplatePropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticBeanstalkConfigurationTemplatePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticBeanstalkConfigurationTemplatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkConfigurationTemplatePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticBeanstalkConfigurationTemplatePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
