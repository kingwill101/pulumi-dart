...
class AwsRedshiftClusterPropertiesResponse {
  ...
  factory AwsRedshiftClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRedshiftClusterPropertiesResponse(
      ...
      endpoint: map['endpoint'] == null ? null : (RedshiftClusterEndpointResponse.fromMap((map['endpoint']! as Map).cast<String, dynamic>())).input(),
      ...
      loggingProperties: map['loggingProperties'] == null ? null : (LoggingPropertiesResponse.fromMap((map['loggingProperties']! as Map).cast<String, dynamic>())).input(),
