...
class AwsRedshiftClusterPropertiesResponse {
  ...
  /// Property endpoint
  final pulumi.Input<RedshiftClusterEndpointResponse?>? endpoint;
  ...
  final pulumi.Input<LoggingPropertiesResponse?>? loggingProperties;
  ...
  const AwsRedshiftClusterPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'elasticIp': ?elasticIp,
      'encrypted': ?encrypted,
      'endpoint': ?pulumi.Input.mapOptionalInputValue<RedshiftClusterEndpointResponse, Map<String, dynamic>>(endpoint, (value) => value.toMap()),
      'enhancedVpcRouting': ?enhancedVpcRouting,
      'hsmClientCertificateIdentifier': ?hsmClientCertificateIdentifier,
      'hsmConfigurationIdentifier': ?hsmConfigurationIdentifier,
      'iamRoles': ?iamRoles,
      'kmsKeyId': ?kmsKeyId,
      'loggingProperties': ?pulumi.Input.mapOptionalInputValue<LoggingPropertiesResponse, Map<String, dynamic>>(loggingProperties, (value) => value.toMap()),
  ...
  factory AwsRedshiftClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRedshiftClusterPropertiesResponse(
      ...
      deferMaintenanceDuration: (() { final guardedValue = map['deferMaintenanceDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      endpoint: (() { final guardedValue = map['endpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RedshiftClusterEndpointResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      loggingProperties: (() { final guardedValue = map['loggingProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LoggingPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      snapshotCopyRetentionPeriod: (() { final guardedValue = map['snapshotCopyRetentionPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
