...
class CFNDataSourceConfigurationsResponse {
  ...
  final pulumi.Input<CFNMalwareProtectionConfigurationResponse>?
  malwareProtection;
  ...
  factory CFNDataSourceConfigurationsResponse.fromMap(
    ...
    return CFNDataSourceConfigurationsResponse(
      kubernetes: (() {
        ...
        return pulumi.Input.fromValue(
          CFNKubernetesConfigurationResponse.fromMap(
      ...
      malwareProtection: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CFNMalwareProtectionConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      s3Logs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CFNS3LogsConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
