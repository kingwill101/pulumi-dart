...
class EksClusterArgs {
  ...
  factory EksClusterArgs.fromMap(Map<String, dynamic> map) {
    return EksClusterArgs(
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EksClusterProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
