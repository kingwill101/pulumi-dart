...
class AwsEksNodegroupPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'taints':
          ...
          >(
            taints,
            (value) =>
                pulumi.Input.encodeList<TaintResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AwsEksNodegroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEksNodegroupPropertiesResponse(
      ...
      forceUpdateEnabled: (() {
        final guardedValue = map['forceUpdateEnabled'];
        if (guardedValue == null) return null;
      ...
      launchTemplate: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LaunchTemplateSpecificationResponse.fromMap(
      ...
      taints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TaintResponse>(
            guardedValue,
            (value) =>
                TaintResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      updateConfig: (() {
