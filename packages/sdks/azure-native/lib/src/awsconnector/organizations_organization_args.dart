...
class OrganizationsOrganizationArgs {
  ...
  /// [tags] Resource tags.
  const OrganizationsOrganizationArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory OrganizationsOrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationsOrganizationArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationsOrganizationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
