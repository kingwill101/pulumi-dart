...
class OrganizationsOrganizationArgs {
  ...
  OrganizationsOrganizationArgs({
    ...
    pulumi.Output<OrganizationsOrganizationProperties>? properties,
  ...
  factory OrganizationsOrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationsOrganizationArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<OrganizationsOrganizationProperties>(OrganizationsOrganizationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
