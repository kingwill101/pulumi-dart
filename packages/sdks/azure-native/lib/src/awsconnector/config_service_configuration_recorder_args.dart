...
class ConfigServiceConfigurationRecorderArgs {
  ...
  /// [tags] Resource tags.
  const ConfigServiceConfigurationRecorderArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory ConfigServiceConfigurationRecorderArgs.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigServiceConfigurationRecorderProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
