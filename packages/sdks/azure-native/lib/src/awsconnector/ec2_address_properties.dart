...
class Ec2AddressProperties {
  ...
  /// AWS Properties
  final AwsEc2AddressProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2AddressProperties.fromMap(Map<String, dynamic> map) {
    return Ec2AddressProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2AddressProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
