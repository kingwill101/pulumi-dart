...
import 'aws_ec2_address_properties.dart';

/// Definition of Ec2Address
class Ec2AddressProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2AddressProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2AddressProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2AddressProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2AddressProperties.fromMap(Map<String, dynamic> map) {
    return Ec2AddressProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2AddressProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
