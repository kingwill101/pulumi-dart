...
class CookiesResponse {
  ...
  factory CookiesResponse.fromMap(Map<String, dynamic> map) {
    return CookiesResponse(
      forward: map['forward'] == null ? null : map['forward'] as String,
      whitelistedNames: map['whitelistedNames'] == null ? null : (map['whitelistedNames'] as List).cast<String>(),
    );
  }
}
