...
class Ec2SecurityGroupArgs {
  ...
  Ec2SecurityGroupArgs({
    ...
    pulumi.Output<Ec2SecurityGroupProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<Ec2SecurityGroupProperties>(properties),
  ...
  factory Ec2SecurityGroupArgs.fromMap(Map<String, dynamic> map) {
    return Ec2SecurityGroupArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<Ec2SecurityGroupProperties>(Ec2SecurityGroupProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
