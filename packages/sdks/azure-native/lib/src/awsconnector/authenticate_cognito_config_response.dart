...
class AuthenticateCognitoConfigResponse {
  ...
  factory AuthenticateCognitoConfigResponse.fromMap(Map<String, dynamic> map) {
    return AuthenticateCognitoConfigResponse(
      ...
      userPoolArn: (() { final guardedValue = map['userPoolArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userPoolClientId: (() { final guardedValue = map['userPoolClientId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      userPoolDomain: (() { final guardedValue = map['userPoolDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
