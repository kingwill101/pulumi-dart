...
class SqsQueuePropertiesResponse {
  ...
  /// AWS Properties
  final AwsSqsQueuePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory SqsQueuePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SqsQueuePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSqsQueuePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
