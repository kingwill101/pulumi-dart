...
import 'aws_sqs_queue_properties_response.dart';

/// Definition of SqsQueue
class SqsQueuePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSqsQueuePropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SqsQueuePropertiesResponse].
  ...
  const SqsQueuePropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSqsQueuePropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SqsQueuePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SqsQueuePropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSqsQueuePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
