...
class AwsSecretsManagerSecretPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'generateSecretString':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(generateSecretString, (value) => value.toMap()),
      'id': ?id,
      'kmsKeyId': ?kmsKeyId,
      'name': ?name,
      'replicaRegions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReplicaRegionResponse>,
  ...
  factory AwsSecretsManagerSecretPropertiesResponse.fromMap(
    ...
    return AwsSecretsManagerSecretPropertiesResponse(
      ...
      generateSecretString: (() {
        final guardedValue = map['generateSecretString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GenerateSecretStringResponse.fromMap(
      ...
      replicaRegions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReplicaRegionResponse>(
            guardedValue,
            (value) => ReplicaRegionResponse.fromMap(
