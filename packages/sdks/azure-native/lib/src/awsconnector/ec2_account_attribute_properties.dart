...
class Ec2AccountAttributeProperties {
  ...
  /// AWS Properties
  final AwsEc2AccountAttributeProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2AccountAttributeProperties.fromMap(Map<String, dynamic> map) {
    return Ec2AccountAttributeProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2AccountAttributeProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
