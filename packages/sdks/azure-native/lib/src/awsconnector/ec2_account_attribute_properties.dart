...
import 'aws_ec2_account_attribute_properties.dart';

/// Definition of Ec2AccountAttribute
class Ec2AccountAttributeProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2AccountAttributeProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2AccountAttributeProperties].
  ...
  const Ec2AccountAttributeProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2AccountAttributeProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2AccountAttributeProperties.fromMap(Map<String, dynamic> map) {
    return Ec2AccountAttributeProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2AccountAttributeProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
