...
class EfsFileSystemProperties {
  ...
  factory EfsFileSystemProperties.fromMap(Map<String, dynamic> map) {
    return EfsFileSystemProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEfsFileSystemProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
