...
class S3LogsConfig {
  ...
  factory S3LogsConfig.fromMap(Map<String, dynamic> map) {
    return S3LogsConfig(
      ...
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LogsConfigStatusTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
