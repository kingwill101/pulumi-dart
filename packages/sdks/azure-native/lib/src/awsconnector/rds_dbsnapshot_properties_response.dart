...
import 'aws_rds_dbsnapshot_properties_response.dart';

/// Definition of RdsDBSnapshot
class RdsDBSnapshotPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRdsDBSnapshotPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RdsDBSnapshotPropertiesResponse].
  ...
  const RdsDBSnapshotPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRdsDBSnapshotPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RdsDBSnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRdsDBSnapshotPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
