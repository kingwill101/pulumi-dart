...
class RdsDBSnapshotPropertiesResponse {
  ...
  /// AWS Properties
  final AwsRdsDBSnapshotPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory RdsDBSnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBSnapshotPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
