...
class AcmCertificateSummaryProperties {
  ...
  /// AWS Properties
  final AwsAcmCertificateSummaryProperties? awsProperties;
  /// AWS Region
  ...
  factory AcmCertificateSummaryProperties.fromMap(Map<String, dynamic> map) {
    return AcmCertificateSummaryProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsAcmCertificateSummaryProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
