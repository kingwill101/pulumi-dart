...
import 'aws_acm_certificate_summary_properties.dart';

/// Definition of AcmCertificateSummary
class AcmCertificateSummaryProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsAcmCertificateSummaryProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [AcmCertificateSummaryProperties].
  ...
  const AcmCertificateSummaryProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsAcmCertificateSummaryProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory AcmCertificateSummaryProperties.fromMap(Map<String, dynamic> map) {
    return AcmCertificateSummaryProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsAcmCertificateSummaryProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
