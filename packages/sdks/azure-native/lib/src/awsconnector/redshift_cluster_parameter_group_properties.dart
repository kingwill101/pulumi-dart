...
import 'aws_redshift_cluster_parameter_group_properties.dart';

/// Definition of RedshiftClusterParameterGroup
class RedshiftClusterParameterGroupProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRedshiftClusterParameterGroupProperties?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [RedshiftClusterParameterGroupProperties].
  ...
  const RedshiftClusterParameterGroupProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRedshiftClusterParameterGroupProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory RedshiftClusterParameterGroupProperties.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterParameterGroupProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRedshiftClusterParameterGroupProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
