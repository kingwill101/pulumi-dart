...
class RedshiftClusterParameterGroupProperties {
  ...
  /// AWS Properties
  final AwsRedshiftClusterParameterGroupProperties? awsProperties;
  /// AWS Region
  ...
  factory RedshiftClusterParameterGroupProperties.fromMap(Map<String, dynamic> map) {
    return RedshiftClusterParameterGroupProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRedshiftClusterParameterGroupProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
