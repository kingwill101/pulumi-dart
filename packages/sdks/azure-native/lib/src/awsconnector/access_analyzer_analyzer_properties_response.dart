...
class AccessAnalyzerAnalyzerPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsAccessAnalyzerAnalyzerPropertiesResponse>?
  awsProperties;
  ...
  factory AccessAnalyzerAnalyzerPropertiesResponse.fromMap(
    ...
    return AccessAnalyzerAnalyzerPropertiesResponse(
      ...
      awsProperties: (() {
        ...
        return pulumi.Input.fromValue(
          AwsAccessAnalyzerAnalyzerPropertiesResponse.fromMap(
