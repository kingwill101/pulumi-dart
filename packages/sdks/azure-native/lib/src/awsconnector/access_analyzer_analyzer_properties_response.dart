...
class AccessAnalyzerAnalyzerPropertiesResponse {
  ...
  const AccessAnalyzerAnalyzerPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  factory AccessAnalyzerAnalyzerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AccessAnalyzerAnalyzerPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsAccessAnalyzerAnalyzerPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
