...
import 'private_dns_name_options_on_launch_model_properties.dart';
import 'tag.dart';
...
class AwsEc2SubnetProperties {
  ...
  factory AwsEc2SubnetProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2SubnetProperties(
      ...
      privateDnsNameOptionsOnLaunch: (() { final guardedValue = map['privateDnsNameOptionsOnLaunch']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateDnsNameOptionsOnLaunchModelProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
