...
import 'aws_elastic_load_balancing_v2_load_balancer_properties_response.dart';
...
class ElasticLoadBalancingV2LoadBalancerPropertiesResponse {
  ...
  /// AWS Properties
  final AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticLoadBalancingV2LoadBalancerPropertiesResponse].
  ...
  factory ElasticLoadBalancingV2LoadBalancerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2LoadBalancerPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticLoadBalancingV2LoadBalancerPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
