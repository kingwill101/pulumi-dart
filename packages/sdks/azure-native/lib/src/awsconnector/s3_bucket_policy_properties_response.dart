...
import 'aws_s3_bucket_policy_properties_response.dart';

/// Definition of S3BucketPolicy
class S3BucketPolicyPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsS3BucketPolicyPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [S3BucketPolicyPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsS3BucketPolicyPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory S3BucketPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3BucketPolicyPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsS3BucketPolicyPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
