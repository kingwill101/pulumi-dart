...
class S3BucketPolicyPropertiesResponse {
  ...
  /// AWS Properties
  final AwsS3BucketPolicyPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory S3BucketPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3BucketPolicyPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3BucketPolicyPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
