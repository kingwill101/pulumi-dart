...
class BlockDeviceMappingResponse {
  ...
  final pulumi.Input<EbsBlockDeviceResponse>? ebs;
  ...
  const BlockDeviceMappingResponse({
    this.deviceName,
    this.ebs,
    this.noDevice,
    this.virtualName,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ebs': ?pulumi.Input.mapOptionalInputValue<EbsBlockDeviceResponse, Map<String, dynamic>>(ebs, (value) => value.toMap()),
      'noDevice': ?noDevice,
  ...
  factory BlockDeviceMappingResponse.fromMap(Map<String, dynamic> map) {
    return BlockDeviceMappingResponse(
      ...
      ebs: (() { final guardedValue = map['ebs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EbsBlockDeviceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
