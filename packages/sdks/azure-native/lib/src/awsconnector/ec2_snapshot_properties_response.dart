...
class Ec2SnapshotPropertiesResponse {
  ...
  /// AWS Properties
  final pulumi.Input<AwsEc2SnapshotPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  const Ec2SnapshotPropertiesResponse({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2SnapshotPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2SnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2SnapshotPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2SnapshotPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
