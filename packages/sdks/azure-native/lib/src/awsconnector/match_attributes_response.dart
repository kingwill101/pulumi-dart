    ...
    return <String, dynamic>{
      ...
      'destinations':
          ...
          >(
            destinations,
            (value) =>
                pulumi.Input.encodeList<AddressResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return MatchAttributesResponse(
      destinationPorts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PortRangeResponse>(
            guardedValue,
            (value) => PortRangeResponse.fromMap(
      ...
      destinations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AddressResponse>(
            guardedValue,
            (value) =>
                AddressResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      protocols: (() {
      ...
      tcpFlags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TCPFlagFieldResponse>(
            guardedValue,
            (value) => TCPFlagFieldResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
