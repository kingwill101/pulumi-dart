...
import 'ip_family_enum_value.dart';
...
class KubernetesNetworkConfigResponse {
  ...
  const KubernetesNetworkConfigResponse({
    this.ipFamily,
  ...
  factory KubernetesNetworkConfigResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesNetworkConfigResponse(
      ipFamily: (() { final guardedValue = map['ipFamily']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IpFamilyEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
