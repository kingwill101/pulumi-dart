...
class AwsElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse {
  ...
  factory AwsElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse.fromMap(
    ...
    return AwsElasticLoadBalancingv2TargetHealthDescriptionPropertiesResponse(
      anomalyDetection: (() {
        ...
        return pulumi.Input.fromValue(
          AnomalyDetectionResponse.fromMap(
      ...
      target: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TargetDescriptionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
