...
class ServiceConnectServiceResponse {
    ...
    return <String, dynamic>{
      'clientAliases':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceConnectClientAliasResponse>,
  ...
  factory ServiceConnectServiceResponse.fromMap(Map<String, dynamic> map) {
    return ServiceConnectServiceResponse(
      clientAliases: (() {
        final guardedValue = map['clientAliases'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceConnectClientAliasResponse>(
            guardedValue,
            (value) => ServiceConnectClientAliasResponse.fromMap(
      ...
      timeout: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TimeoutConfigurationResponse.fromMap(
      ...
      tls: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConnectTlsConfigurationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
