...
class CodeBuildSourceCredentialsInfo extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CodeBuildSourceCredentialsInfoPropertiesResponse>
  properties;
  ...
  CodeBuildSourceCredentialsInfo(
    ...
    properties =
        registerOutput<CodeBuildSourceCredentialsInfoPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return CodeBuildSourceCredentialsInfoPropertiesResponse.fromMap(
