...
class SecretsManagerSecretArgs {
  ...
  /// [tags] Resource tags.
  const SecretsManagerSecretArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory SecretsManagerSecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretsManagerSecretArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretsManagerSecretProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
