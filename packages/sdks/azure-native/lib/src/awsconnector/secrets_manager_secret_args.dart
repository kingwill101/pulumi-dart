...
class SecretsManagerSecretArgs {
  ...
  SecretsManagerSecretArgs({
    ...
    pulumi.Output<SecretsManagerSecretProperties>? properties,
  ...
  factory SecretsManagerSecretArgs.fromMap(Map<String, dynamic> map) {
    return SecretsManagerSecretArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<SecretsManagerSecretProperties>(SecretsManagerSecretProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
