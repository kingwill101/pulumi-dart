...
class AwsElasticBeanstalkEnvironmentPropertiesResponse {
  ...
  factory AwsElasticBeanstalkEnvironmentPropertiesResponse.fromMap(
    ...
    return AwsElasticBeanstalkEnvironmentPropertiesResponse(
      ...
      optionSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OptionSettingResponse>(
            guardedValue,
            (value) => OptionSettingResponse.fromMap(
      ...
      tier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TierResponse.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      versionLabel: (() {
