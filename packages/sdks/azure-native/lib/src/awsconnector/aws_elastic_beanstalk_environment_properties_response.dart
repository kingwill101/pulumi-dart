...
class AwsElasticBeanstalkEnvironmentPropertiesResponse {
  ...
  factory AwsElasticBeanstalkEnvironmentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsElasticBeanstalkEnvironmentPropertiesResponse(
      ...
      optionSettings: map['optionSettings'] == null ? null : (pulumi.Input.decodeList<OptionSettingResponse>(map['optionSettings'], (value) => OptionSettingResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      tier: map['tier'] == null ? null : (TierResponse.fromMap((map['tier'] as Map).cast<String, dynamic>())).input(),
