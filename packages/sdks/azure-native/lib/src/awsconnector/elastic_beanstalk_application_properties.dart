...
class ElasticBeanstalkApplicationProperties {
  ...
  /// AWS Properties
  final AwsElasticBeanstalkApplicationProperties? awsProperties;
  /// AWS Region
  ...
  factory ElasticBeanstalkApplicationProperties.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkApplicationProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticBeanstalkApplicationProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
