...
import 'aws_elastic_beanstalk_application_properties.dart';

/// Definition of ElasticBeanstalkApplication
class ElasticBeanstalkApplicationProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsElasticBeanstalkApplicationProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticBeanstalkApplicationProperties].
  ...
  const ElasticBeanstalkApplicationProperties({
    this.arn,
    this.awsAccountId,
    this.awsProperties,
    this.awsRegion,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsElasticBeanstalkApplicationProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory ElasticBeanstalkApplicationProperties.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkApplicationProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsElasticBeanstalkApplicationProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
