...
class AwsIamRoleProperties {
  ...
  /// Creates a new [AwsIamRoleProperties].
  /// [arn] Property arn
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policies': ?pulumi.Input.mapOptionalInputValue<List<Policy>, List<Map<String, dynamic>>>(policies, (value) => pulumi.Input.encodeList<Policy, Map<String, dynamic>>(value, (value) => value.toMap())),
      'roleId': ?roleId,
      'roleName': ?roleName,
  ...
  factory AwsIamRoleProperties.fromMap(Map<String, dynamic> map) {
    return AwsIamRoleProperties(
      ...
      policies: (() { final guardedValue = map['policies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<Policy>(guardedValue, (value) => Policy.fromMap((value as Map).cast<String, dynamic>()))); })(),
