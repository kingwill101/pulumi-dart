...
class LogsConfigResponse {
  ...
  factory LogsConfigResponse.fromMap(Map<String, dynamic> map) {
    return LogsConfigResponse(
      cloudWatchLogs: (() { final guardedValue = map['cloudWatchLogs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CloudWatchLogsConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      s3Logs: (() { final guardedValue = map['s3Logs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3LogsConfigResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
