...
class AwsCloudWatchAlarmPropertiesResponse {
  ...
  factory AwsCloudWatchAlarmPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsCloudWatchAlarmPropertiesResponse(
      ...
      metrics: map['metrics'] == null ? null : (pulumi.Input.decodeList<MetricDataQueryResponse>(map['metrics'], (value) => MetricDataQueryResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
