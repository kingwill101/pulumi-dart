...
class AwsCloudWatchAlarmPropertiesResponse {
  ...
  factory AwsCloudWatchAlarmPropertiesResponse.fromMap(
    ...
    return AwsCloudWatchAlarmPropertiesResponse(
      ...
      dimensions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DimensionResponse>(
            guardedValue,
      ...
      metrics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MetricDataQueryResponse>(
            guardedValue,
            (value) => MetricDataQueryResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
