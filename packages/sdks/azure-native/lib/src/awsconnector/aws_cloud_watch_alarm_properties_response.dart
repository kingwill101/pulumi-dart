...
import 'metric_data_query_response.dart';
import 'tag_response.dart';

/// Definition of awsCloudWatchAlarm
class AwsCloudWatchAlarmPropertiesResponse {
  ...
  final pulumi.Input<List<MetricDataQueryResponse>?>? metrics;
  ...
  /// Creates a new [AwsCloudWatchAlarmPropertiesResponse].
  ...
  AwsCloudWatchAlarmPropertiesResponse({
    pulumi.Input<bool?>? actionsEnabled,
    this.alarmActions,
    ...
    this.unit,
  }) : actionsEnabled = actionsEnabled ?? pulumi.Input.fromValue(true);
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics': ?pulumi.Input.mapOptionalInputValue<List<MetricDataQueryResponse>, List<Map<String, dynamic>>>(metrics, (value) => pulumi.Input.encodeList<MetricDataQueryResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'namespace': ?namespace,
      'okActions': ?okActions,
      'period': ?period,
      'statistic': ?statistic,
  ...
  factory AwsCloudWatchAlarmPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsCloudWatchAlarmPropertiesResponse(
      ...
      evaluateLowSampleCountPercentile: (() { final guardedValue = map['evaluateLowSampleCountPercentile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MetricDataQueryResponse>(guardedValue, (value) => MetricDataQueryResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
