...
import 'samloptions_output.dart';
...
class AdvancedSecurityOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'samlOptions': ?pulumi.Input.mapOptionalInputValue<SAMLOptionsOutput, Map<String, dynamic>>(samlOptions, (value) => value.toMap()),
    };
  }

  factory AdvancedSecurityOptions.fromMap(Map<String, dynamic> map) {
    return AdvancedSecurityOptions(
      ...
      samlOptions: (() { final guardedValue = map['samlOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SAMLOptionsOutput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
