...
class ReplicationDestinationResponse {
  ...
  final AccessControlTranslationResponse? accessControlTranslation;
  ...
  final ReplicationTimeResponse? replicationTime;
  ...
  factory ReplicationDestinationResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationDestinationResponse(
      accessControlTranslation: map['accessControlTranslation'] == null ? null : AccessControlTranslationResponse.fromMap((map['accessControlTranslation'] as Map).cast<String, dynamic>()),
      ...
      replicationTime: map['replicationTime'] == null ? null : ReplicationTimeResponse.fromMap((map['replicationTime'] as Map).cast<String, dynamic>()),
