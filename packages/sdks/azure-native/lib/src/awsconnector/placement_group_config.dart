...
class PlacementGroupConfig {
  ...
  PlacementGroupConfig({this.instanceRole, this.placementStrategy});
    ...
    return <String, dynamic>{
      'instanceRole':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(instanceRole, (value) => value.toMap()),
      'placementStrategy':
          ?pulumi.Input.mapOptionalInputValue<
            PlacementGroupStrategyEnumValue,
            Map<String, dynamic>
          >(placementStrategy, (value) => value.toMap()),
    };
  }
  ...
  factory PlacementGroupConfig.fromMap(Map<String, dynamic> map) {
    return PlacementGroupConfig(
      instanceRole: (() {
        final guardedValue = map['instanceRole'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InstanceRoleTypeEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      placementStrategy: (() {
        final guardedValue = map['placementStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PlacementGroupStrategyEnumValue.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
