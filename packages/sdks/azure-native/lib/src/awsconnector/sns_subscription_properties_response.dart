...
import 'aws_sns_subscription_properties_response.dart';

/// Definition of SnsSubscription
class SnsSubscriptionPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsSnsSubscriptionPropertiesResponse>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SnsSubscriptionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsSnsSubscriptionPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory SnsSubscriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SnsSubscriptionPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsSnsSubscriptionPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
