...
class SnsSubscriptionPropertiesResponse {
  ...
  /// AWS Properties
  final AwsSnsSubscriptionPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory SnsSubscriptionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SnsSubscriptionPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSnsSubscriptionPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
