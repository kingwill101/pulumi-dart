...
class AwsSsmInstanceInformationProperties {
  ...
  const AwsSsmInstanceInformationProperties({
    this.activationId,
    this.agentVersion,
  ...
  factory AwsSsmInstanceInformationProperties.fromMap(Map<String, dynamic> map) {
    return AwsSsmInstanceInformationProperties(
      ...
      associationOverview: (() { final guardedValue = map['associationOverview']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InstanceAggregatedAssociationOverview.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      pingStatus: (() { final guardedValue = map['pingStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PingStatusEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      platformType: (() { final guardedValue = map['platformType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PlatformTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      resourceType: (() { final guardedValue = map['resourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sourceType: (() { final guardedValue = map['sourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SourceTypeEnumValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
