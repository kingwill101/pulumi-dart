...
class AwsSsmInstanceInformationProperties {
  ...
  final pulumi.Input<InstanceAggregatedAssociationOverview>?
  associationOverview;
  ...
  factory AwsSsmInstanceInformationProperties.fromMap(
    ...
    return AwsSsmInstanceInformationProperties(
      ...
      associationOverview: (() {
        ...
        return pulumi.Input.fromValue(
          InstanceAggregatedAssociationOverview.fromMap(
