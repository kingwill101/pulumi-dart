...
class Ec2VPCEndpointPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2VPCEndpointPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2VPCEndpointPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2VPCEndpointPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2VPCEndpointPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
