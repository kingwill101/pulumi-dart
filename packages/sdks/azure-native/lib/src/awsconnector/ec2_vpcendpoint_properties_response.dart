...
import 'aws_ec2_vpcendpoint_properties_response.dart';

/// Definition of Ec2VPCEndpoint
class Ec2VPCEndpointPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String?>? arn;
  /// AWS Account ID
  final pulumi.Input<String?>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsEc2VPCEndpointPropertiesResponse?>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2VPCEndpointPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsEc2VPCEndpointPropertiesResponse, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Ec2VPCEndpointPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2VPCEndpointPropertiesResponse(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsEc2VPCEndpointPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
