...
class Route53HostedZoneProperties {
  ...
  /// AWS Properties
  final AwsRoute53HostedZoneProperties? awsProperties;
  /// AWS Region
  ...
  factory Route53HostedZoneProperties.fromMap(Map<String, dynamic> map) {
    return Route53HostedZoneProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRoute53HostedZoneProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
