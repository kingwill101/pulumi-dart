...
import 'aws_route53_hosted_zone_properties.dart';

/// Definition of Route53HostedZone
class Route53HostedZoneProperties {
  /// Amazon Resource Name (ARN)
  final pulumi.Input<String>? arn;
  /// AWS Account ID
  final pulumi.Input<String>? awsAccountId;
  /// AWS Properties
  final pulumi.Input<AwsRoute53HostedZoneProperties>? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Route53HostedZoneProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'awsProperties': ?pulumi.Input.mapOptionalInputValue<AwsRoute53HostedZoneProperties, Map<String, dynamic>>(awsProperties, (value) => value.toMap()),
      'awsRegion': ?awsRegion,
  ...
  factory Route53HostedZoneProperties.fromMap(Map<String, dynamic> map) {
    return Route53HostedZoneProperties(
      ...
      awsProperties: (() { final guardedValue = map['awsProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsRoute53HostedZoneProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
