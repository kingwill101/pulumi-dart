...
class Ec2VpcEndpointArgs {
  ...
  factory Ec2VpcEndpointArgs.fromMap(Map<String, dynamic> map) {
    return Ec2VpcEndpointArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2VPCEndpointProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
