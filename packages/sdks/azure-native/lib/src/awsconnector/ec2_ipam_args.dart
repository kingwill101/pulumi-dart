...
class Ec2IpamArgs {
  ...
  factory Ec2IpamArgs.fromMap(Map<String, dynamic> map) {
    return Ec2IpamArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Ec2IpamProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
