...
class SageMakerNotebookInstanceSummary extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SageMakerNotebookInstanceSummaryPropertiesResponse>
  properties;
  ...
  SageMakerNotebookInstanceSummary(
    ...
    properties =
        registerOutput<SageMakerNotebookInstanceSummaryPropertiesResponse>(
          'properties',
          decoder: (raw) {
            final guardedValue = raw;
            if (guardedValue == null) return null;
            return SageMakerNotebookInstanceSummaryPropertiesResponse.fromMap(
