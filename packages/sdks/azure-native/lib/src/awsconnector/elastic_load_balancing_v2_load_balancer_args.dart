...
class ElasticLoadBalancingV2LoadBalancerArgs {
  ...
  ElasticLoadBalancingV2LoadBalancerArgs({
    ...
    pulumi.Output<ElasticLoadBalancingV2LoadBalancerProperties>? properties,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<ElasticLoadBalancingV2LoadBalancerProperties>(properties),
  ...
  factory ElasticLoadBalancingV2LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2LoadBalancerArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Output.create<ElasticLoadBalancingV2LoadBalancerProperties>(ElasticLoadBalancingV2LoadBalancerProperties.fromMap((map['properties'] as Map).cast<String, dynamic>())),
