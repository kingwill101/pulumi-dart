...
class ElasticLoadBalancingV2LoadBalancerArgs {
  ...
  /// [tags] Resource tags.
  const ElasticLoadBalancingV2LoadBalancerArgs({
    this.location,
    this.name,
    this.properties,
  ...
  factory ElasticLoadBalancingV2LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2LoadBalancerArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ElasticLoadBalancingV2LoadBalancerProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
