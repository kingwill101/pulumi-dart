...
class Criteria {
  ...
  Criteria({this.regex, this.s3WordsList});
  ...
  factory Criteria.fromMap(Map<String, dynamic> map) {
    return Criteria(
      ...
      s3WordsList: (() {
        final guardedValue = map['s3WordsList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          S3WordsList.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
