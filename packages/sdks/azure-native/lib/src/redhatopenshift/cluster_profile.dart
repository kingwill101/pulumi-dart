...
class ClusterProfile {
  ...
  final pulumi.Input<dynamic>? fipsValidatedModules;
  ...
  factory ClusterProfile.fromMap(Map<String, dynamic> map) {
    return ClusterProfile(
      ...
      fipsValidatedModules: (() { final guardedValue = map['fipsValidatedModules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
