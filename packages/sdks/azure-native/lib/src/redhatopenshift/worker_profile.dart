...
class WorkerProfile {
  ...
  final pulumi.Input<dynamic>? encryptionAtHost;
  ...
  factory WorkerProfile.fromMap(Map<String, dynamic> map) {
    return WorkerProfile(
      ...
      encryptionAtHost: (() { final guardedValue = map['encryptionAtHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
