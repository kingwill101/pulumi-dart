    ...
    return <String, dynamic>{
      ...
      'ingressProfiles':
          ...
          >(
            ingressProfiles,
            (value) =>
                pulumi.Input.encodeList<IngressProfile, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'masterProfile':
          ?pulumi.Input.mapOptionalInputValue<
            MasterProfile,
            Map<String, dynamic>
          >(masterProfile, (value) => value.toMap()),
      'networkProfile':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkProfile,
            Map<String, dynamic>
      ...
      'workerProfiles':
          ...
          >(
            workerProfiles,
            (value) =>
                pulumi.Input.encodeList<WorkerProfile, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory OpenShiftClusterArgs.fromMap(Map<String, dynamic> map) {
    return OpenShiftClusterArgs(
      ...
      clusterProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterProfile.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ingressProfiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IngressProfile>(
            guardedValue,
            (value) =>
                IngressProfile.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      location: (() {
      ...
      masterProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MasterProfile.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      networkProfile: (() {
      ...
      servicePrincipalProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServicePrincipalProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      workerProfiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkerProfile>(
            guardedValue,
            (value) =>
                WorkerProfile.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
