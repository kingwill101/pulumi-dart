...
class LoadBalancerProfile {
  ...
  factory LoadBalancerProfile.fromMap(Map<String, dynamic> map) {
    return LoadBalancerProfile(
      managedOutboundIps: (() { final guardedValue = map['managedOutboundIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ManagedOutboundIPs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
