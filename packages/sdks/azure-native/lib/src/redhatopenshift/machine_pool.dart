...
/// }
///
/// resource "azure-native_redhatopenshift_machinepool" "machinePool" {
...
class MachinePool extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [MachinePool] resource.
  MachinePool.reference(String urn)
    : super(
        'azure-native:redhatopenshift:MachinePool',
