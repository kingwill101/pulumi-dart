...
class NetworkProfile {
  ...
  final pulumi.Input<dynamic>? preconfiguredNSG;
  ...
  factory NetworkProfile.fromMap(Map<String, dynamic> map) {
    return NetworkProfile(
      ...
      preconfiguredNSG: (() { final guardedValue = map['preconfiguredNSG']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
