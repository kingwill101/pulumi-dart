...
/// Result data returned by getMachinePool.
class GetMachinePoolResult {
  ...
  /// Creates a new [GetMachinePoolResult].
  ...
  factory GetMachinePoolResult.fromMap(Map<String, dynamic> map) {
