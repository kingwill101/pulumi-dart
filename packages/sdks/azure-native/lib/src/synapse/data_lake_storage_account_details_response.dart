...
class DataLakeStorageAccountDetailsResponse {
  ...
  const DataLakeStorageAccountDetailsResponse({
    this.accountUrl,
  ...
  factory DataLakeStorageAccountDetailsResponse.fromMap(Map<String, dynamic> map) {
    return DataLakeStorageAccountDetailsResponse(
      ...
      createManagedPrivateEndpoint: (() { final guardedValue = map['createManagedPrivateEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
