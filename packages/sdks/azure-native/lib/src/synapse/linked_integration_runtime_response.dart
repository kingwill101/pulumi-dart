...
class LinkedIntegrationRuntimeResponse {
  ...
  /// [dataFactoryLocation] The location of the workspace for which the linked integration runtime belong to.
  /// [dataFactoryName] The name of the workspace for which the linked integration runtime belong to.
  ...
  factory LinkedIntegrationRuntimeResponse.fromMap(Map<String, dynamic> map) {
    return LinkedIntegrationRuntimeResponse(
      ...
      dataFactoryLocation: pulumi.Input.fromValue(
        map['dataFactoryLocation'] as String,
      ),
