...
/// }
///
/// resource "azure-native_synapse_iothubdataconnection" "iotHubDataConnection" {
...
class IotHubDataConnection extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [IotHubDataConnection]. {@macro pulumi_synapse_iot_hub_data_connection_args_doc}
