...
class GetWorkspaceResult {
  ...
  GetWorkspaceResult({
    ...
    this.workspaceUID,
  }) : publicNetworkAccess = publicNetworkAccess ?? 'Enabled', trustedServiceBypassEnabled = trustedServiceBypassEnabled ?? false;
  ...
  factory GetWorkspaceResult.fromMap(Map<String, dynamic> map) {
    return GetWorkspaceResult(
      adlaResourceId: (() { final guardedValue = map['adlaResourceId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      extraProperties: (() { final guardedValue = map['extraProperties']; if (guardedValue == null) return null; return guardedValue; })(),
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, dynamic>(); })(),
