...
class WorkspaceArgs {
  ...
  final pulumi.Input<ManagedVirtualNetworkSettings>?
  managedVirtualNetworkSettings;

  /// Private endpoint connections to the workspace
  /// These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
  final pulumi.Input<List<PrivateEndpointConnectionSynapse>>?
  ...
  final pulumi.Input<WorkspaceRepositoryConfiguration>?
    ...
    return <String, dynamic>{
      ...
      'cspWorkspaceAdminProperties':
          ?pulumi.Input.mapOptionalInputValue<
            CspWorkspaceAdminProperties,
            Map<String, dynamic>
          >(cspWorkspaceAdminProperties, (value) => value.toMap()),
      'defaultDataLakeStorage':
          ?pulumi.Input.mapOptionalInputValue<
            DataLakeStorageAccountDetails,
            Map<String, dynamic>
          >(defaultDataLakeStorage, (value) => value.toMap()),
      'encryption':
          ?pulumi.Input.mapOptionalInputValue<
            EncryptionDetails,
            Map<String, dynamic>
      ...
      'managedVirtualNetworkSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ManagedVirtualNetworkSettings,
            Map<String, dynamic>
          >(managedVirtualNetworkSettings, (value) => value.toMap()),
      ...
      'workspaceRepositoryConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            WorkspaceRepositoryConfiguration,
            Map<String, dynamic>
          >(workspaceRepositoryConfiguration, (value) => value.toMap()),
    };
  }
    ...
    return WorkspaceArgs(
      ...
      cspWorkspaceAdminProperties: (() {
        ...
        return pulumi.Input.fromValue(
          CspWorkspaceAdminProperties.fromMap(
      ...
      defaultDataLakeStorage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataLakeStorageAccountDetails.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      managedVirtualNetworkSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagedVirtualNetworkSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      privateEndpointConnections: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as List).cast<PrivateEndpointConnectionSynapse>(),
        );
      })(),
      publicNetworkAccess: (() {
      ...
      workspaceRepositoryConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkspaceRepositoryConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
