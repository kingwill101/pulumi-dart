...
class EncryptionDetailsResponse {
  ...
  EncryptionDetailsResponse({this.cmk, required this.doubleEncryptionEnabled});
    ...
    return EncryptionDetailsResponse(
      cmk: (() {
        ...
        return pulumi.Input.fromValue(
          CustomerManagedKeyDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      doubleEncryptionEnabled: pulumi.Input.fromValue(
        map['doubleEncryptionEnabled'] as bool,
      ),
    );
  }
}
