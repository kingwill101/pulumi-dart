...
/// {@template pulumi_synapse_kusto_pool_database_principal_assignment_args_doc}
/// The set of arguments for KustoPoolDatabasePrincipalAssignment.
/// {@endtemplate}
/// {@macro pulumi_synapse_kusto_pool_database_principal_assignment_args_doc}
class KustoPoolDatabasePrincipalAssignmentArgs {
  ...
  /// Creates a new [KustoPoolDatabasePrincipalAssignmentArgs].
  ...
  factory KustoPoolDatabasePrincipalAssignmentArgs.fromMap(Map<String, dynamic> map) {
