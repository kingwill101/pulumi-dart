...
class ManagedVirtualNetworkSettingsResponse {
  ...
  const ManagedVirtualNetworkSettingsResponse({
  ...
  factory ManagedVirtualNetworkSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ManagedVirtualNetworkSettingsResponse(
      allowedAadTenantIdsForLinking: (() { final guardedValue = map['allowedAadTenantIdsForLinking']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      linkedAccessCheckOnTargetResource: (() { final guardedValue = map['linkedAccessCheckOnTargetResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      preventDataExfiltration: (() { final guardedValue = map['preventDataExfiltration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
