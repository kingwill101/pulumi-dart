...
/// Result data returned by getKustoPoolDatabasePrincipalAssignment.
class GetKustoPoolDatabasePrincipalAssignmentResult {
  ...
  /// Creates a new [GetKustoPoolDatabasePrincipalAssignmentResult].
  ...
  factory GetKustoPoolDatabasePrincipalAssignmentResult.fromMap(Map<String, dynamic> map) {
    return GetKustoPoolDatabasePrincipalAssignmentResult(
      aadObjectId: (() { final guardedValue = map['aadObjectId']; if (guardedValue == null) return null; return guardedValue as String; })(),
