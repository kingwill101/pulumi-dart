    ...
    return <String, dynamic>{
      ...
      'objectSecretMapping':
          pulumi.Input.mapInputValue<
            List<KubernetesSecretObjectMapping>,
  ...
  factory SecretSyncArgs.fromMap(Map<String, dynamic> map) {
    return SecretSyncArgs(
      ...
      forceSynchronization: (() {
        final guardedValue = map['forceSynchronization'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kubernetesSecretType: pulumi.Input.fromValue(
        map['kubernetesSecretType'] as String,
      ),
      location: (() {
      ...
      objectSecretMapping: pulumi.Input.fromValue(
        pulumi.Input.decodeList<KubernetesSecretObjectMapping>(
          map['objectSecretMapping']!,
          (value) => KubernetesSecretObjectMapping.fromMap(
      ...
      secretProviderClassName: pulumi.Input.fromValue(
        map['secretProviderClassName'] as String,
      ),
      secretSyncName: (() {
        final guardedValue = map['secretSyncName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
