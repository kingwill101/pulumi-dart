...
class GetSecretSyncResult {
    ...
    return <String, dynamic>{
      ...
      'objectSecretMapping':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(objectSecretMapping, (value) => value.toMap()),
  ...
  factory GetSecretSyncResult.fromMap(Map<String, dynamic> map) {
    return GetSecretSyncResult(
      ...
      objectSecretMapping:
          pulumi.Input.decodeList<KubernetesSecretObjectMappingResponse>(
            map['objectSecretMapping']!,
            (value) => KubernetesSecretObjectMappingResponse.fromMap(
      ...
      status: SecretSyncStatusResponse.fromMap(
