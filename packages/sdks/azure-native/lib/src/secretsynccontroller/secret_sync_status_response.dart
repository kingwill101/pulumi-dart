...
class SecretSyncStatusResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions': pulumi.Input.encodeList<SecretSyncConditionResponse, Map<String, dynamic>>(conditions, (value) => value.toMap()),
  ...
  factory SecretSyncStatusResponse.fromMap(Map<String, dynamic> map) {
    return SecretSyncStatusResponse(
      conditions: pulumi.Input.decodeList<SecretSyncConditionResponse>(map['conditions'], (value) => SecretSyncConditionResponse.fromMap((value as Map).cast<String, dynamic>())),
      lastSuccessfulSyncTime: map['lastSuccessfulSyncTime'] as String,
    );
  }
}
