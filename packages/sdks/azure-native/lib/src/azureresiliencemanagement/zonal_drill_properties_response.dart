...
class ZonalDrillPropertiesResponse {
  ...
  final pulumi.Input<String> vmsPresent;

  /// Creates a new [ZonalDrillPropertiesResponse].
  ...
  /// [vmsPresent] An indication whether a VM is included in this Zonal Drill. If not, RO is not needed.
  const ZonalDrillPropertiesResponse({
  ...
  factory ZonalDrillPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ZonalDrillPropertiesResponse(
      ...
      vmsPresent: pulumi.Input.fromValue(map['vmsPresent'] as String),
    );
  }
}
