...
class AssetPropertiesOfDrillResponse {
  ...
  /// Creates a new [AssetPropertiesOfDrillResponse].
  ...
  const AssetPropertiesOfDrillResponse({
  ...
  factory AssetPropertiesOfDrillResponse.fromMap(Map<String, dynamic> map) {
    return AssetPropertiesOfDrillResponse(
