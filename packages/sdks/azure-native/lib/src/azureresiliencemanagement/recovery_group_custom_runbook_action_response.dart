...
class RecoveryGroupCustomRunbookActionResponse {
  ...
  final pulumi.Input<AssociatedIdentityResponse?>? associatedIdentity;
  ...
  /// Creates a new [RecoveryGroupCustomRunbookActionResponse].
  ...
  const RecoveryGroupCustomRunbookActionResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'associatedIdentity': ?pulumi.Input.mapOptionalInputValue<AssociatedIdentityResponse, Map<String, dynamic>>(associatedIdentity, (value) => value.toMap()),
  ...
  factory RecoveryGroupCustomRunbookActionResponse.fromMap(Map<String, dynamic> map) {
    return RecoveryGroupCustomRunbookActionResponse(
      ...
      associatedIdentity: (() { final guardedValue = map['associatedIdentity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AssociatedIdentityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
