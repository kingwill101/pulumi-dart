...
/// Result data returned by getRecoveryPlan.
class GetRecoveryPlanResult {
  ...
  /// Creates a new [GetRecoveryPlanResult].
  ...
  factory GetRecoveryPlanResult.fromMap(Map<String, dynamic> map) {
