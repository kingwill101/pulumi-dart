...
class MdsResourcePropertiesResponse {
  ...
  final pulumi.Input<List<DenyAssignmentExclusionResponse>>?
  ...
  final pulumi.Input<ManagedOnBehalfOfConfigurationResponse>
  ...
  final pulumi.Input<UserManagedOpenAIProfileResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'adxProfile':
          pulumi.Input.mapInputValue<AdxProfileResponse, Map<String, dynamic>>(
            adxProfile,
            (value) => value.toMap(),
          ),
      'aksAdminGroupId': ?aksAdminGroupId,
      'aksProfile':
          pulumi.Input.mapInputValue<AksProfileResponse, Map<String, dynamic>>(
            aksProfile,
            (value) => value.toMap(),
          ),
      'cmkProfile':
          ?pulumi.Input.mapOptionalInputValue<
            CmkProfileResponse,
            Map<String, dynamic>
          >(cmkProfile, (value) => value.toMap()),
      'databaseProfile':
          pulumi.Input.mapInputValue<
            DatabaseProfileResponse,
            Map<String, dynamic>
          >(databaseProfile, (value) => value.toMap()),
      'denyAssignmentExclusions':
          ?pulumi.Input.mapOptionalInputValue<
            List<DenyAssignmentExclusionResponse>,
      ...
      'eventHubProfile':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(eventHubProfile, (value) => value.toMap()),
      'fabricProfile':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'functionAppProfile':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(functionAppProfile, (value) => value.toMap()),
      'managedOnBehalfOfConfiguration':
          pulumi.Input.mapInputValue<
            ManagedOnBehalfOfConfigurationResponse,
            Map<String, dynamic>
          >(managedOnBehalfOfConfiguration, (value) => value.toMap()),
      'managedResourceGroupConfiguration':
          pulumi.Input.mapInputValue<
      ...
      'monitoringProfile':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(monitoringProfile, (value) => value.toMap()),
      'openAIProfile':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'redisProfile':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(redisProfile, (value) => value.toMap()),
  ...
  factory MdsResourcePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MdsResourcePropertiesResponse(
      ...
      adxProfile: pulumi.Input.fromValue(
        AdxProfileResponse.fromMap(
          (map['adxProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      aksAdminGroupId: (() {
      ...
      aksProfile: pulumi.Input.fromValue(
        AksProfileResponse.fromMap(
          (map['aksProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      cmkProfile: (() {
        ...
        return pulumi.Input.fromValue(
          CmkProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      databaseProfile: pulumi.Input.fromValue(
        DatabaseProfileResponse.fromMap(
          (map['databaseProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      denyAssignmentExclusions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DenyAssignmentExclusionResponse>(
            guardedValue,
            (value) => DenyAssignmentExclusionResponse.fromMap(
      ...
      eventHubProfile: pulumi.Input.fromValue(
        EventHubProfileResponse.fromMap(
          (map['eventHubProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      fabricProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FabricProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      functionAppProfile: pulumi.Input.fromValue(
        FunctionAppProfileResponse.fromMap(
          (map['functionAppProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      managedOnBehalfOfConfiguration: pulumi.Input.fromValue(
        ManagedOnBehalfOfConfigurationResponse.fromMap(
          (map['managedOnBehalfOfConfiguration']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      managedResourceGroupConfiguration: pulumi.Input.fromValue(
        ManagedResourceGroupConfigurationResponse.fromMap(
          (map['managedResourceGroupConfiguration']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      monitoringProfile: pulumi.Input.fromValue(
        MonitoringProfileResponse.fromMap(
          (map['monitoringProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      openAIProfile: (() {
      ...
      redisProfile: pulumi.Input.fromValue(
        RedisProfileResponse.fromMap(
          (map['redisProfile']! as Map).cast<String, dynamic>(),
        ),
      ),
      redundancyState: (() {
      ...
      userManagedOpenAIProfile: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserManagedOpenAIProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
