...
class ListManufacturingDataServiceAvailableVersionsResult {
  ...
  ListManufacturingDataServiceAvailableVersionsResult({required this.versions});
  ...
  factory ListManufacturingDataServiceAvailableVersionsResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return ListManufacturingDataServiceAvailableVersionsResult(
      versions: pulumi.Input.decodeList<ApplicationVersionResponse>(
        map['versions']!,
        (value) => ApplicationVersionResponse.fromMap(
