...
class GetManufacturingDataServiceResult {
  ...
  const GetManufacturingDataServiceResult({
  ...
  factory GetManufacturingDataServiceResult.fromMap(Map<String, dynamic> map) {
    return GetManufacturingDataServiceResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return MdsResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
