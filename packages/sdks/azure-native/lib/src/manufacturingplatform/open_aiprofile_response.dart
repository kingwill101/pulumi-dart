...
class OpenAIProfileResponse {
  ...
  factory OpenAIProfileResponse.fromMap(Map<String, dynamic> map) {
    return OpenAIProfileResponse(
      embeddingModelCapacity: (() { final guardedValue = map['embeddingModelCapacity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      gptModelCapacity: (() { final guardedValue = map['gptModelCapacity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
