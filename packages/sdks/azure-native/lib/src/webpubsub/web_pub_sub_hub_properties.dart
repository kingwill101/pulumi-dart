    ...
    return <String, dynamic>{
      ...
      'eventHandlers':
          ...
          >(
            eventHandlers,
            (value) =>
                pulumi.Input.encodeList<EventHandler, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'eventListeners':
          ...
          >(
            eventListeners,
            (value) =>
                pulumi.Input.encodeList<EventListener, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return WebPubSubHubProperties(
      ...
      eventHandlers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventHandler>(
            guardedValue,
            (value) =>
                EventHandler.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      eventListeners: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventListener>(
            guardedValue,
            (value) =>
                EventListener.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      webSocketKeepAliveIntervalInSeconds: (() {
