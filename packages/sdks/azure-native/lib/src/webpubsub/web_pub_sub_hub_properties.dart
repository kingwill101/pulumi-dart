...
class WebPubSubHubProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'eventHandlers': ?eventHandlers == null ? null : pulumi.Input.encodeList<EventHandler, Map<String, dynamic>>(eventHandlers!, (value) => value.toMap()),
      'eventListeners': ?eventListeners == null ? null : pulumi.Input.encodeList<EventListener, Map<String, dynamic>>(eventListeners!, (value) => value.toMap()),
  ...
  factory WebPubSubHubProperties.fromMap(Map<String, dynamic> map) {
    return WebPubSubHubProperties(
      ...
      eventHandlers: map['eventHandlers'] == null ? null : pulumi.Input.decodeList<EventHandler>(map['eventHandlers'], (value) => EventHandler.fromMap((value as Map).cast<String, dynamic>())),
      eventListeners: map['eventListeners'] == null ? null : pulumi.Input.decodeList<EventListener>(map['eventListeners'], (value) => EventListener.fromMap((value as Map).cast<String, dynamic>())),
