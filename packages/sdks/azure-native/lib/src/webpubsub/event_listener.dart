...
class EventListener {
  ...
  EventListener({required this.endpoint, required this.filter});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endpoint':
          pulumi.Input.mapInputValue<EventHubEndpoint, Map<String, dynamic>>(
            endpoint,
            (value) => value.toMap(),
          ),
      'filter':
          pulumi.Input.mapInputValue<EventNameFilter, Map<String, dynamic>>(
            filter,
            (value) => value.toMap(),
          ),
    };
