...
/// {@template pulumi_webpubsub_web_pub_sub_custom_certificate_args_doc}
/// The set of arguments for WebPubSubCustomCertificate.
/// {@endtemplate}
/// {@macro pulumi_webpubsub_web_pub_sub_custom_certificate_args_doc}
class WebPubSubCustomCertificateArgs {
  ...
  /// Creates a new [WebPubSubCustomCertificateArgs].
  ...
  factory WebPubSubCustomCertificateArgs.fromMap(Map<String, dynamic> map) {
    return WebPubSubCustomCertificateArgs(
