...
class EventListenerResponse {
  ...
  factory EventListenerResponse.fromMap(Map<String, dynamic> map) {
    return EventListenerResponse(
      endpoint: pulumi.Input.fromValue(EventHubEndpointResponse.fromMap((map['endpoint']! as Map).cast<String, dynamic>())),
      filter: pulumi.Input.fromValue(EventNameFilterResponse.fromMap((map['filter']! as Map).cast<String, dynamic>())),
    );
  }
}
