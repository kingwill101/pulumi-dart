...
class WebPubSubHub extends pulumi.CustomResource {
  ...
  WebPubSubHub(
    ...
    properties = registerOutput<WebPubSubHubPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return WebPubSubHubPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [WebPubSubHub] resource.
  WebPubSubHub.reference(String urn)
    : super(
        'azure-native:webpubsub:WebPubSubHub',
