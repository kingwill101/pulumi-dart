...
/// }
///
/// resource "azure-native_webpubsub_webpubsubreplica" "webPubSubReplica" {
///   location            = "eastus"
...
class WebPubSubReplica extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WebPubSubReplica] resource.
  WebPubSubReplica.reference(String urn)
    : super(
        'azure-native:webpubsub:WebPubSubReplica',
