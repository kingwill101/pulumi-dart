...
class WebPubSubArgs {
  ...
  factory WebPubSubArgs.fromMap(Map<String, dynamic> map) {
    return WebPubSubArgs(
      ...
      networkACLs: map['networkACLs'] == null ? null : (WebPubSubNetworkACLs.fromMap((map['networkACLs']! as Map).cast<String, dynamic>())).input(),
      ...
      socketIO: map['socketIO'] == null ? null : (WebPubSubSocketIOSettings.fromMap((map['socketIO']! as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      tls: map['tls'] == null ? null : (WebPubSubTlsSettings.fromMap((map['tls']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
