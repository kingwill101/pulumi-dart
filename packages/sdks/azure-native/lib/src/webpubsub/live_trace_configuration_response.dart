...
class LiveTraceConfigurationResponse {
  ...
  LiveTraceConfigurationResponse({this.categories, this.enabled});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'categories':
          ?pulumi.Input.mapOptionalInputValue<
            List<LiveTraceCategoryResponse>,
    ...
    return LiveTraceConfigurationResponse(
      categories: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LiveTraceCategoryResponse>(
            guardedValue,
            (value) => LiveTraceCategoryResponse.fromMap(
