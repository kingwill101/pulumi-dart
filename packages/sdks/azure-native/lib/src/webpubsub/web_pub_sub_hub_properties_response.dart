  ...
  factory WebPubSubHubPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return WebPubSubHubPropertiesResponse(
      anonymousConnectPolicy: (() {
        final guardedValue = map['anonymousConnectPolicy'];
      ...
      eventHandlers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventHandlerResponse>(
            guardedValue,
            (value) => EventHandlerResponse.fromMap(
      ...
      eventListeners: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventListenerResponse>(
            guardedValue,
            (value) => EventListenerResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      webSocketKeepAliveIntervalInSeconds: (() {
        final guardedValue = map['webSocketKeepAliveIntervalInSeconds'];
        if (guardedValue == null) return null;
