...
class GetApplicationResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tags': ?tags,
      'trackingDataStores': ?trackingDataStores == null ? null : pulumi.Input.encodeMapValues<TrackingDataStoreResponse, Map<String, dynamic>>(trackingDataStores!, (value) => value.toMap()),
      'type': type,
    };
  }
