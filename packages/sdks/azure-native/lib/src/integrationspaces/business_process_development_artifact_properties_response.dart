...
class BusinessProcessDevelopmentArtifactPropertiesResponse {
  ...
  final pulumi.Input<Map<String, BusinessProcessMappingItemResponse>>?
  businessProcessMapping;

  /// The business process stages.
  final pulumi.Input<Map<String, BusinessProcessStageResponse>>?
  ...
  final pulumi.Input<Map<String, TrackingProfileDefinitionResponse>>?
  trackingProfiles;
    ...
    return <String, dynamic>{
      'businessProcessMapping':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, BusinessProcessMappingItemResponse>,
      ...
      'businessProcessStages':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, BusinessProcessStageResponse>,
            Map<String, Map<String, dynamic>>
          >(
            businessProcessStages,
            (value) =>
      ...
      'trackingProfiles':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, TrackingProfileDefinitionResponse>,
            Map<String, Map<String, dynamic>>
          >(
            trackingProfiles,
            (value) =>
  ...
  factory BusinessProcessDevelopmentArtifactPropertiesResponse.fromMap(
    ...
    return BusinessProcessDevelopmentArtifactPropertiesResponse(
      businessProcessMapping: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<BusinessProcessMappingItemResponse>(
            guardedValue,
      ...
      businessProcessStages: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<BusinessProcessStageResponse>(
            guardedValue,
      ...
      identifier: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BusinessProcessIdentifierResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      trackingProfiles: (() {
        final guardedValue = map['trackingProfiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<TrackingProfileDefinitionResponse>(
            guardedValue,
            (value) => TrackingProfileDefinitionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
