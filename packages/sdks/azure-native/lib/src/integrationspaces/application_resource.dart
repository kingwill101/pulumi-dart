...
/// }
///
/// resource "azure-native_integrationspaces_applicationresource" "applicationResource" {
...
class ApplicationResource extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ApplicationResource] resource.
  ApplicationResource.reference(String urn)
    : super(
        'azure-native:integrationspaces:ApplicationResource',
