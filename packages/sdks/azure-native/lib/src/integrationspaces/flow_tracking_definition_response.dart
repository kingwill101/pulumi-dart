...
class FlowTrackingDefinitionResponse {
  ...
  factory FlowTrackingDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return FlowTrackingDefinitionResponse(
      correlationContext: (() { final guardedValue = map['correlationContext']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TrackingCorrelationContextResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      events: (() { final guardedValue = map['events']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<TrackingEventDefinitionResponse>(guardedValue, (value) => TrackingEventDefinitionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
