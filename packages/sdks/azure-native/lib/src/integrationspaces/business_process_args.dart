...
class BusinessProcessArgs {
  ...
  factory BusinessProcessArgs.fromMap(Map<String, dynamic> map) {
    return BusinessProcessArgs(
      ...
      businessProcessMapping: (() { final guardedValue = map['businessProcessMapping']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<BusinessProcessMappingItem>(guardedValue, (value) => BusinessProcessMappingItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
      businessProcessName: (() { final guardedValue = map['businessProcessName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      businessProcessStages: (() { final guardedValue = map['businessProcessStages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<BusinessProcessStage>(guardedValue, (value) => BusinessProcessStage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      identifier: (() { final guardedValue = map['identifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BusinessProcessIdentifier.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      trackingDataStoreReferenceName: (() { final guardedValue = map['trackingDataStoreReferenceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
