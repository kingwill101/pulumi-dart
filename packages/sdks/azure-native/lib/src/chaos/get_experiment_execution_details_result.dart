...
class GetExperimentExecutionDetailsResult {
  ...
  final ExperimentExecutionDetailsPropertiesResponseRunInformation
  runInformation;
  ...
  factory GetExperimentExecutionDetailsResult.fromMap(
    ...
    return GetExperimentExecutionDetailsResult(
      ...
      runInformation:
          ExperimentExecutionDetailsPropertiesResponseRunInformation.fromMap(
            (map['runInformation']! as Map).cast<String, dynamic>(),
          ),
