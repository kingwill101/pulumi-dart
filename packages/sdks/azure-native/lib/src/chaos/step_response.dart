...
class StepResponse {
  ...
  StepResponse({required this.branches, required this.name});
    ...
    return <String, dynamic>{
      'branches':
          ...
          >(
            branches,
            (value) =>
                pulumi.Input.encodeList<BranchResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory StepResponse.fromMap(Map<String, dynamic> map) {
    return StepResponse(
      branches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BranchResponse>(
          map['branches']!,
          (value) =>
              BranchResponse.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
