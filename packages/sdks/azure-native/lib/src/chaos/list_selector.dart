    ...
    return <String, dynamic>{
      ...
      'targets':
          ...
          >(
            targets,
            (value) =>
                pulumi.Input.encodeList<TargetReference, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ListSelector.fromMap(Map<String, dynamic> map) {
    return ListSelector(
      ...
      targets: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TargetReference>(
          map['targets']!,
          (value) =>
              TargetReference.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
