...
class ExperimentPropertiesResponse {
  ...
  final pulumi.Input<CustomerDataStoragePropertiesResponse>?
  customerDataStorage;
    ...
    return ExperimentPropertiesResponse(
      customerDataStorage: (() {
        ...
        return pulumi.Input.fromValue(
          CustomerDataStoragePropertiesResponse.fromMap(
      ...
      selectors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ListSelectorResponse>(
          map['selectors']!,
          (value) => ListSelectorResponse.fromMap(
