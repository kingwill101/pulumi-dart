...
class BranchResponse {
  ...
  BranchResponse({required this.actions, required this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<ContinuousActionResponse>,
  ...
  factory BranchResponse.fromMap(Map<String, dynamic> map) {
    return BranchResponse(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ContinuousActionResponse>(
          map['actions']!,
          (value) => ContinuousActionResponse.fromMap(
