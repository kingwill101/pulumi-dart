...
/// }
///
/// resource "azure-native_chaos_privateaccess" "privateAccess" {
///   location            = "centraluseuap"
...
class PrivateAccess extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [PrivateAccess] resource.
  PrivateAccess.reference(String urn)
    : super(
        'azure-native:chaos:PrivateAccess',
