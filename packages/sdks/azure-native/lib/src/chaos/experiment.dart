...
class Experiment extends pulumi.CustomResource {
  ...
  Experiment(
    ...
    identity = registerOutput<ExperimentIdentityResponse?>(
      'identity',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ExperimentIdentityResponse.fromMap(
    ...
    properties = registerOutput<ExperimentPropertiesResponse>(
      'properties',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return ExperimentPropertiesResponse.fromMap(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      },
    );
