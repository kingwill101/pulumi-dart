...
/// }
///
/// resource "azure-native_chaos_capability" "capability" {
...
class Capability extends pulumi.CustomResource {
  ...
  Capability(
    ...
    properties = registerOutput<CapabilityPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CapabilityPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
