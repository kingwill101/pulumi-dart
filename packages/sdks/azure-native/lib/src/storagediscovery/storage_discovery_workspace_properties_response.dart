...
class StorageDiscoveryWorkspacePropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'scopes':
          pulumi.Input.mapInputValue<
            List<StorageDiscoveryScopeResponse>,
  ...
  factory StorageDiscoveryWorkspacePropertiesResponse.fromMap(
    ...
    return StorageDiscoveryWorkspacePropertiesResponse(
      ...
      scopes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StorageDiscoveryScopeResponse>(
          map['scopes']!,
          (value) => StorageDiscoveryScopeResponse.fromMap(
      ...
      workspaceRoots: pulumi.Input.fromValue(
        (map['workspaceRoots'] as List).cast<String>(),
      ),
    );
  }
}
