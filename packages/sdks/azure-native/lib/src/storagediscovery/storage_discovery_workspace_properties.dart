...
class StorageDiscoveryWorkspaceProperties {
  ...
  factory StorageDiscoveryWorkspaceProperties.fromMap(
    ...
    return StorageDiscoveryWorkspaceProperties(
      ...
      scopes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StorageDiscoveryScope>(
          map['scopes']!,
          (value) => StorageDiscoveryScope.fromMap(
