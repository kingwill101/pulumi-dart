...
class ConnectedClusterArgs {
  ...
  ConnectedClusterArgs({
    pulumi.Output<AadProfile>? aadProfile,
    required pulumi.Output<String> agentPublicKeyCertificate,
    pulumi.Output<ArcAgentProfile>? arcAgentProfile,
    pulumi.Output<String>? azureHybridBenefit,
    pulumi.Output<String>? clusterName,
    pulumi.Output<String>? distribution,
    pulumi.Output<String>? distributionVersion,
    required pulumi.Output<ConnectedClusterIdentity> identity,
    pulumi.Output<String>? infrastructure,
    pulumi.Output<String>? kind,
    pulumi.Output<String>? location,
    pulumi.Output<String>? privateLinkScopeResourceId,
    pulumi.Output<String>? privateLinkState,
  ...
  factory ConnectedClusterArgs.fromMap(Map<String, dynamic> map) {
    return ConnectedClusterArgs(
      aadProfile: map['aadProfile'] == null ? null : pulumi.Output.create<AadProfile>(AadProfile.fromMap((map['aadProfile'] as Map).cast<String, dynamic>())),
      agentPublicKeyCertificate: pulumi.Output.create<String>(map['agentPublicKeyCertificate'] as String),
      arcAgentProfile: map['arcAgentProfile'] == null ? null : pulumi.Output.create<ArcAgentProfile>(ArcAgentProfile.fromMap((map['arcAgentProfile'] as Map).cast<String, dynamic>())),
      azureHybridBenefit: map['azureHybridBenefit'] == null ? null : pulumi.Output.create<String>(map['azureHybridBenefit'] as String),
      clusterName: map['clusterName'] == null ? null : pulumi.Output.create<String>(map['clusterName'] as String),
      distribution: map['distribution'] == null ? null : pulumi.Output.create<String>(map['distribution'] as String),
      distributionVersion: map['distributionVersion'] == null ? null : pulumi.Output.create<String>(map['distributionVersion'] as String),
      identity: pulumi.Output.create<ConnectedClusterIdentity>(ConnectedClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ...
      privateLinkState: map['privateLinkState'] == null ? null : pulumi.Output.create<String>(map['privateLinkState'] as String),
