...
class ArcAgentProfile {
    ...
    return <String, dynamic>{
      ...
      'systemComponents':
          ...
          >(
            systemComponents,
            (value) =>
                pulumi.Input.encodeList<SystemComponent, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ArcAgentProfile.fromMap(Map<String, dynamic> map) {
    return ArcAgentProfile(
      ...
      desiredAgentVersion: (() {
        final guardedValue = map['desiredAgentVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      systemComponents: (() {
        final guardedValue = map['systemComponents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SystemComponent>(
            guardedValue,
            (value) =>
                SystemComponent.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
