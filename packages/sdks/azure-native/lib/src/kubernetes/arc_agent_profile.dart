...
class ArcAgentProfile {
  ...
  final pulumi.Input<dynamic>? agentAutoUpgrade;
  ...
  ArcAgentProfile({
    pulumi.Input<dynamic>? agentAutoUpgrade,
  ...
  factory ArcAgentProfile.fromMap(Map<String, dynamic> map) {
    return ArcAgentProfile(
      agentAutoUpgrade: (() { final guardedValue = map['agentAutoUpgrade']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
