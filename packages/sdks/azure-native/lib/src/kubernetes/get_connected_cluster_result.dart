...
class GetConnectedClusterResult {
  ...
  factory GetConnectedClusterResult.fromMap(Map<String, dynamic> map) {
    return GetConnectedClusterResult(
      ...
      distributionVersion: (() {
        final guardedValue = map['distributionVersion'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      id: map['id'] as String,
      identity: ConnectedClusterIdentityResponse.fromMap(
      ...
      managedIdentityCertificateExpirationTime:
          map['managedIdentityCertificateExpirationTime'] as String,
      miscellaneousProperties: (map['miscellaneousProperties'] as Map)
          .cast<String, String>(),
      ...
      privateLinkState: (() {
        final guardedValue = map['privateLinkState'];
        if (guardedValue == null) return null;
        return guardedValue as String;
      })(),
      provisioningState: (() {
