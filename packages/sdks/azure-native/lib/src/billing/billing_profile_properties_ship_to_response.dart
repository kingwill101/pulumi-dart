...
class BillingProfilePropertiesShipToResponse {
  /// Address line 1.
  ...
  /// Creates a new [BillingProfilePropertiesShipToResponse].
  ...
  const BillingProfilePropertiesShipToResponse({
  ...
  factory BillingProfilePropertiesShipToResponse.fromMap(Map<String, dynamic> map) {
    return BillingProfilePropertiesShipToResponse(
