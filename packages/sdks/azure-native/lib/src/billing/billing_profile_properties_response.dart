...
class BillingProfilePropertiesResponse {
  ...
  factory BillingProfilePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return BillingProfilePropertiesResponse(
      billTo: (() { final guardedValue = map['billTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesResponseBillTo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      currentPaymentTerm: (() { final guardedValue = map['currentPaymentTerm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesResponseCurrentPaymentTerm.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      indirectRelationshipInfo: (() { final guardedValue = map['indirectRelationshipInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesResponseIndirectRelationshipInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      shipTo: (() { final guardedValue = map['shipTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesResponseShipTo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      soldTo: (() { final guardedValue = map['soldTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesResponseSoldTo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
