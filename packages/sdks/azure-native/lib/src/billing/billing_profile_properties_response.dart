...
import 'billing_profile_properties_bill_to_response.dart';
import 'billing_profile_properties_current_payment_term_response.dart';
import 'billing_profile_properties_indirect_relationship_info_response.dart';
import 'billing_profile_properties_ship_to_response.dart';
import 'billing_profile_properties_sold_to_response.dart';
...
class BillingProfilePropertiesResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'billTo': ?pulumi.Input.mapOptionalInputValue<BillingProfilePropertiesBillToResponse, Map<String, dynamic>>(billTo, (value) => value.toMap()),
      'billingRelationshipType': billingRelationshipType,
      'currency': currency,
      'currentPaymentTerm': ?pulumi.Input.mapOptionalInputValue<BillingProfilePropertiesCurrentPaymentTermResponse, Map<String, dynamic>>(currentPaymentTerm, (value) => value.toMap()),
      ...
      'indirectRelationshipInfo': ?pulumi.Input.mapOptionalInputValue<BillingProfilePropertiesIndirectRelationshipInfoResponse, Map<String, dynamic>>(indirectRelationshipInfo, (value) => value.toMap()),
      ...
      'shipTo': ?pulumi.Input.mapOptionalInputValue<BillingProfilePropertiesShipToResponse, Map<String, dynamic>>(shipTo, (value) => value.toMap()),
      'soldTo': ?pulumi.Input.mapOptionalInputValue<BillingProfilePropertiesSoldToResponse, Map<String, dynamic>>(soldTo, (value) => value.toMap()),
  ...
  factory BillingProfilePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return BillingProfilePropertiesResponse(
      billTo: (() { final guardedValue = map['billTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesBillToResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      billingRelationshipType: pulumi.Input.fromValue(map['billingRelationshipType'] as String),
      currency: pulumi.Input.fromValue(map['currency'] as String),
      currentPaymentTerm: (() { final guardedValue = map['currentPaymentTerm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesCurrentPaymentTermResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      shipTo: (() { final guardedValue = map['shipTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesShipToResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      soldTo: (() { final guardedValue = map['soldTo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BillingProfilePropertiesSoldToResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spendingLimit: pulumi.Input.fromValue(map['spendingLimit'] as String),
      spendingLimitDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<SpendingLimitDetailsResponse>(map['spendingLimitDetails']!, (value) => SpendingLimitDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      targetClouds: pulumi.Input.fromValue((map['targetClouds'] as List).cast<String>()),
    );
  }
}
