...
class BillingProfilePropertiesSoldToResponse {
  /// Address line 1.
  ...
  /// Creates a new [BillingProfilePropertiesSoldToResponse].
  ...
  const BillingProfilePropertiesSoldToResponse({
  ...
  factory BillingProfilePropertiesSoldToResponse.fromMap(Map<String, dynamic> map) {
    return BillingProfilePropertiesSoldToResponse(
