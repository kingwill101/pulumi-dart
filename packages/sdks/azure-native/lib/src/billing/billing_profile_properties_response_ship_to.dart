...
class BillingProfilePropertiesResponseShipTo {
  /// Address line 1.
  ...
  /// Creates a new [BillingProfilePropertiesResponseShipTo].
  ...
  const BillingProfilePropertiesResponseShipTo({
  ...
  factory BillingProfilePropertiesResponseShipTo.fromMap(Map<String, dynamic> map) {
    return BillingProfilePropertiesResponseShipTo(
