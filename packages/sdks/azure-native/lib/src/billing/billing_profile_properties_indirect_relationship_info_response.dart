...
class BillingProfilePropertiesIndirectRelationshipInfoResponse {
  ...
  /// Creates a new [BillingProfilePropertiesIndirectRelationshipInfoResponse].
  ...
  const BillingProfilePropertiesIndirectRelationshipInfoResponse({
  ...
  factory BillingProfilePropertiesIndirectRelationshipInfoResponse.fromMap(Map<String, dynamic> map) {
    return BillingProfilePropertiesIndirectRelationshipInfoResponse(
