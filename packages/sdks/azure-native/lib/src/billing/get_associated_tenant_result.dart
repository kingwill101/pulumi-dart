...
class GetAssociatedTenantResult {
  ...
  const GetAssociatedTenantResult({
  ...
  factory GetAssociatedTenantResult.fromMap(Map<String, dynamic> map) {
    return GetAssociatedTenantResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return AssociatedTenantPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
