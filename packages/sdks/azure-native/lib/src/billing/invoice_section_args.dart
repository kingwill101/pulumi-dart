...
class InvoiceSectionArgs {
  ...
  factory InvoiceSectionArgs.fromMap(Map<String, dynamic> map) {
    return InvoiceSectionArgs(
      ...
      invoiceSectionName: (() { final guardedValue = map['invoiceSectionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InvoiceSectionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
