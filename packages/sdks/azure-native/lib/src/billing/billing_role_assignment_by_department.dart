...
/// }
///
/// resource "azure-native_billing_billingroleassignmentbydepartment" "billingRoleAssignmentByDepartment" {
...
class BillingRoleAssignmentByDepartment extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [BillingRoleAssignmentByDepartment] resource.
  BillingRoleAssignmentByDepartment.reference(String urn)
    : super(
        'azure-native:billing:BillingRoleAssignmentByDepartment',
