...
import 'billing_role_assignment_by_enrollment_account_args.dart';
...
/// }
///
/// resource "azure-native_billing_billingroleassignmentbyenrollmentaccount" "billingRoleAssignmentByEnrollmentAccount" {
...
class BillingRoleAssignmentByEnrollmentAccount extends pulumi.CustomResource {
  ...
  /// Creates a new [BillingRoleAssignmentByEnrollmentAccount].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BillingRoleAssignmentByEnrollmentAccount]. {@macro pulumi_billing_billing_role_assignment_by_enrollment_account_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BillingRoleAssignmentByEnrollmentAccount(
    String name, {
    BillingRoleAssignmentByEnrollmentAccountArgs? args,
  ...
  /// Creates a typed reference to an existing [BillingRoleAssignmentByEnrollmentAccount] resource.
  BillingRoleAssignmentByEnrollmentAccount.reference(String urn)
    : super(
        'azure-native:billing:BillingRoleAssignmentByEnrollmentAccount',
