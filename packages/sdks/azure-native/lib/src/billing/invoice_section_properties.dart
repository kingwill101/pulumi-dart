...
class InvoiceSectionProperties {
  ...
  final pulumi.Input<dynamic>? reasonCode;
  ...
  factory InvoiceSectionProperties.fromMap(Map<String, dynamic> map) {
    return InvoiceSectionProperties(
      ...
      reasonCode: (() { final guardedValue = map['reasonCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
