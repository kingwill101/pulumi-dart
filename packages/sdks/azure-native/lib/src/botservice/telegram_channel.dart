...
class TelegramChannel {
  ...
  factory TelegramChannel.fromMap(Map<String, dynamic> map) {
    return TelegramChannel(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TelegramChannelProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
