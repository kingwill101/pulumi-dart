...
class FacebookChannelPropertiesResponse {
  ...
  factory FacebookChannelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return FacebookChannelPropertiesResponse(
      ...
      pages: (() { final guardedValue = map['pages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FacebookPageResponse>(guardedValue, (value) => FacebookPageResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
