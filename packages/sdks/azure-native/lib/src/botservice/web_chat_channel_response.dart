...
class WebChatChannelResponse {
  ...
  factory WebChatChannelResponse.fromMap(Map<String, dynamic> map) {
    return WebChatChannelResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebChatChannelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
