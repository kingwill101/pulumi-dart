...
class MsTeamsChannelPropertiesResponse {
  ...
  /// Creates a new [MsTeamsChannelPropertiesResponse].
  ...
  const MsTeamsChannelPropertiesResponse({
    this.acceptedTerms,
    this.callingWebhook,
  ...
  factory MsTeamsChannelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MsTeamsChannelPropertiesResponse(
