...
class DirectLineChannel {
  ...
  factory DirectLineChannel.fromMap(Map<String, dynamic> map) {
    return DirectLineChannel(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DirectLineChannelProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
