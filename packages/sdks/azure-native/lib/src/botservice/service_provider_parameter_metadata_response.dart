...
class ServiceProviderParameterMetadataResponse {
  ...
  final pulumi.Input<ServiceProviderParameterMetadataConstraintsResponse>?
  constraints;

  /// Creates a new [ServiceProviderParameterMetadataResponse].
  /// [constraints] the constraints of the bot meta data.
  ServiceProviderParameterMetadataResponse({this.constraints});
  ...
  factory ServiceProviderParameterMetadataResponse.fromMap(
    ...
    return ServiceProviderParameterMetadataResponse(
      constraints: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceProviderParameterMetadataConstraintsResponse.fromMap(
