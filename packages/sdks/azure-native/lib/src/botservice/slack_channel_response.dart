...
class SlackChannelResponse {
  ...
  factory SlackChannelResponse.fromMap(Map<String, dynamic> map) {
    return SlackChannelResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlackChannelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
