...
class NetworkSecurityPerimeterConfigurationPropertiesResponse {
  ...
  factory NetworkSecurityPerimeterConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityPerimeterConfigurationPropertiesResponse(
      networkSecurityPerimeter: pulumi.Input.fromValue(NetworkSecurityPerimeterResponse.fromMap((map['networkSecurityPerimeter']! as Map).cast<String, dynamic>())),
      profile: pulumi.Input.fromValue(ProfileResponse.fromMap((map['profile']! as Map).cast<String, dynamic>())),
      provisioningIssues: (() { final guardedValue = map['provisioningIssues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProvisioningIssueResponse>(guardedValue, (value) => ProvisioningIssueResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      provisioningState: (() { final guardedValue = map['provisioningState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceAssociation: pulumi.Input.fromValue(ResourceAssociationResponse.fromMap((map['resourceAssociation']! as Map).cast<String, dynamic>())),
    );
  }
}
