...
class KikChannelResponse {
  ...
  factory KikChannelResponse.fromMap(Map<String, dynamic> map) {
    return KikChannelResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(KikChannelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
