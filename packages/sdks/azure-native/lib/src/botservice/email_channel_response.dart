...
class EmailChannelResponse {
  ...
  final EmailChannelPropertiesResponse? properties;
  ...
  factory EmailChannelResponse.fromMap(Map<String, dynamic> map) {
    return EmailChannelResponse(
      ...
      properties: map['properties'] == null ? null : EmailChannelPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
