...
class MsTeamsChannelResponse {
  ...
  factory MsTeamsChannelResponse.fromMap(Map<String, dynamic> map) {
    return MsTeamsChannelResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MsTeamsChannelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
