...
class LineChannelProperties {
  ...
  LineChannelProperties({required this.lineRegistrations});
    ...
    return <String, dynamic>{
      'lineRegistrations':
          ...
          >(
            lineRegistrations,
            (value) =>
                pulumi.Input.encodeList<LineRegistration, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory LineChannelProperties.fromMap(Map<String, dynamic> map) {
    return LineChannelProperties(
      lineRegistrations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<LineRegistration>(
          map['lineRegistrations']!,
          (value) =>
              LineRegistration.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
