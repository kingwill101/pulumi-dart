...
class LineChannelProperties {
  ...
  factory LineChannelProperties.fromMap(Map<String, dynamic> map) {
    return LineChannelProperties(
      lineRegistrations: (pulumi.Input.decodeList<LineRegistration>(map['lineRegistrations'], (value) => LineRegistration.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
