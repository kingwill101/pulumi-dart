    ...
    return <String, dynamic>{
      ...
      'sites':
          ...
          >(
            sites,
            (value) =>
                pulumi.Input.encodeList<DirectLineSite, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DirectLineChannelProperties(
      ...
      sites: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DirectLineSite>(
            guardedValue,
            (value) =>
                DirectLineSite.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
