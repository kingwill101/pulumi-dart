...
class EmailChannelPropertiesResponse {
  ...
  const EmailChannelPropertiesResponse({
    this.authMethod,
  ...
  factory EmailChannelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EmailChannelPropertiesResponse(
      authMethod: (() { final guardedValue = map['authMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
