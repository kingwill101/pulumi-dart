...
class BotConnectionArgs {
  ...
  factory BotConnectionArgs.fromMap(Map<String, dynamic> map) {
    return BotConnectionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionSettingProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
