...
class NspAccessRulePropertiesResponse {
  ...
  final pulumi.Input<List<NetworkSecurityPerimeterResponse>>
  ...
  final pulumi.Input<List<NspAccessRulePropertiesSubscriptionsItemResponse>>?
  subscriptions;
    ...
    return <String, dynamic>{
      ...
      'networkSecurityPerimeters':
          pulumi.Input.mapInputValue<
            List<NetworkSecurityPerimeterResponse>,
      ...
      'subscriptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<NspAccessRulePropertiesSubscriptionsItemResponse>,
            List<Map<String, dynamic>>
          >(
            subscriptions,
            (value) =>
  ...
  factory NspAccessRulePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NspAccessRulePropertiesResponse(
      ...
      networkSecurityPerimeters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NetworkSecurityPerimeterResponse>(
          map['networkSecurityPerimeters']!,
          (value) => NetworkSecurityPerimeterResponse.fromMap(
      ...
      subscriptions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => NspAccessRulePropertiesSubscriptionsItemResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
