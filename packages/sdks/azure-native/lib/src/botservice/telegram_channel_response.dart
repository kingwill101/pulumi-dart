...
class TelegramChannelResponse {
  ...
  factory TelegramChannelResponse.fromMap(Map<String, dynamic> map) {
    return TelegramChannelResponse(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TelegramChannelPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
