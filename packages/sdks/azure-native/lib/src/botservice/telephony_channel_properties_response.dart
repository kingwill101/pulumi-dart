...
class TelephonyChannelPropertiesResponse {
  ...
  final pulumi.Input<List<TelephonyChannelResourceApiConfigurationResponse>>?
  apiConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'phoneNumbers':
          ?pulumi.Input.mapOptionalInputValue<
            List<TelephonyPhoneNumbersResponse>,
            List<Map<String, dynamic>>
          >(
            phoneNumbers,
            (value) =>
    ...
    return TelephonyChannelPropertiesResponse(
      apiConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => TelephonyChannelResourceApiConfigurationResponse.fromMap(
      ...
      phoneNumbers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TelephonyPhoneNumbersResponse>(
            guardedValue,
            (value) => TelephonyPhoneNumbersResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
