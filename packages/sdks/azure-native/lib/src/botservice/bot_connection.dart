...
class BotConnection extends pulumi.CustomResource {
  ...
  BotConnection(
    ...
    properties = registerOutput<ConnectionSettingPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ConnectionSettingPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [BotConnection] resource.
  BotConnection.reference(String urn)
    : super(
        'azure-native:botservice:BotConnection',
