...
class LabPlanArgs {
    ...
    return <String, dynamic>{
      ...
      'defaultAutoShutdownProfile':
          ?pulumi.Input.mapOptionalInputValue<
            AutoShutdownProfile,
            Map<String, dynamic>
          >(defaultAutoShutdownProfile, (value) => value.toMap()),
      'defaultConnectionProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ConnectionProfile,
            Map<String, dynamic>
          >(defaultConnectionProfile, (value) => value.toMap()),
      'defaultNetworkProfile':
          ?pulumi.Input.mapOptionalInputValue<
            LabPlanNetworkProfile,
            Map<String, dynamic>
          >(defaultNetworkProfile, (value) => value.toMap()),
      'identity':
  ...
  factory LabPlanArgs.fromMap(Map<String, dynamic> map) {
    return LabPlanArgs(
      ...
      defaultAutoShutdownProfile: (() {
        final guardedValue = map['defaultAutoShutdownProfile'];
        if (guardedValue == null) return null;
      ...
      defaultConnectionProfile: (() {
        final guardedValue = map['defaultConnectionProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      defaultNetworkProfile: (() {
        final guardedValue = map['defaultNetworkProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabPlanNetworkProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      labPlanName: (() {
        final guardedValue = map['labPlanName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      linkedLmsInstance: (() {
        final guardedValue = map['linkedLmsInstance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      sharedGalleryId: (() {
        final guardedValue = map['sharedGalleryId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      supportInfo: (() {
        final guardedValue = map['supportInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SupportInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
