...
class GetLabResult {
  ...
  factory GetLabResult.fromMap(Map<String, dynamic> map) {
    return GetLabResult(
      autoShutdownProfile: (() { final guardedValue = map['autoShutdownProfile']; if (guardedValue == null) return null; return AutoShutdownProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      azureApiVersion: (() { final guardedValue = map['azureApiVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      connectionProfile: (() { final guardedValue = map['connectionProfile']; if (guardedValue == null) return null; return ConnectionProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return guardedValue as String; })(),
      id: (() { final guardedValue = map['id']; if (guardedValue == null) return null; return guardedValue as String; })(),
      labPlanId: (() { final guardedValue = map['labPlanId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return guardedValue as String; })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return guardedValue as String; })(),
      networkProfile: (() { final guardedValue = map['networkProfile']; if (guardedValue == null) return null; return LabNetworkProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      rosterProfile: (() { final guardedValue = map['rosterProfile']; if (guardedValue == null) return null; return RosterProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      virtualMachineProfile: (() { final guardedValue = map['virtualMachineProfile']; if (guardedValue == null) return null; return VirtualMachineProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
    );
  }
}
