...
class AutoShutdownProfileResponse {
  ...
  final String? shutdownOnDisconnect;
  /// Whether a VM will get shutdown when it has idled for a period of time.
  final String? shutdownOnIdle;
  /// Whether a VM will get shutdown when it hasn't been connected to after a period of time.
  final String? shutdownWhenNotConnected;
  ...
  factory AutoShutdownProfileResponse.fromMap(Map<String, dynamic> map) {
    return AutoShutdownProfileResponse(
      ...
      shutdownOnDisconnect: map['shutdownOnDisconnect'] == null ? null : map['shutdownOnDisconnect'] as String,
      shutdownOnIdle: map['shutdownOnIdle'] == null ? null : map['shutdownOnIdle'] as String,
      shutdownWhenNotConnected: map['shutdownWhenNotConnected'] == null ? null : map['shutdownWhenNotConnected'] as String,
    );
  }
}
