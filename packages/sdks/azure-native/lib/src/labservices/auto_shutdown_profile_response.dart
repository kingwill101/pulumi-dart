...
class AutoShutdownProfileResponse {
  ...
  AutoShutdownProfileResponse({
    ...
    this.idleDelay,
    this.noConnectDelay,
    pulumi.Input<String?>? shutdownOnDisconnect,
    pulumi.Input<String?>? shutdownOnIdle,
    pulumi.Input<String?>? shutdownWhenNotConnected,
  }) : shutdownOnDisconnect = shutdownOnDisconnect ?? pulumi.Input.fromValue('Disabled'), shutdownOnIdle = shutdownOnIdle ?? pulumi.Input.fromValue('None'), shutdownWhenNotConnected = shutdownWhenNotConnected ?? pulumi.Input.fromValue('Disabled');
