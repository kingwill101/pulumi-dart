...
class SecurityProfileResponse {
  ...
  factory SecurityProfileResponse.fromMap(Map<String, dynamic> map) {
    return SecurityProfileResponse(
      openAccess: (() { final guardedValue = map['openAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      registrationCode: pulumi.Input.fromValue(map['registrationCode'] as String),
    );
  }
}
