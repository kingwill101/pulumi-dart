...
class VirtualMachineArgs {
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      resourcePool: (() { final guardedValue = map['resourcePool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourcePool.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vSphereNetworks: (() { final guardedValue = map['vSphereNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
