...
/// }
///
/// resource "azure-native_cosmosdb_mongodbresourcemongodbcollection" "mongoDBResourceMongoDBCollection" {
///   account_name    = "ddb1"
...
class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [MongoDBResourceMongoDBCollection] resource.
  MongoDBResourceMongoDBCollection.reference(String urn)
    : super(
        'azure-native:cosmosdb:MongoDBResourceMongoDBCollection',
