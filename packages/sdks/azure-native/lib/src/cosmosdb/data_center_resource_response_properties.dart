...
class DataCenterResourceResponseProperties {
  ...
  final pulumi.Input<AuthenticationMethodLdapPropertiesResponse>?
    ...
    return <String, dynamic>{
      'authenticationMethodLdapProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(authenticationMethodLdapProperties, (value) => value.toMap()),
  ...
  factory DataCenterResourceResponseProperties.fromMap(
    Map<String, dynamic> map,
  ) {
    return DataCenterResourceResponseProperties(
      authenticationMethodLdapProperties: (() {
        final guardedValue = map['authenticationMethodLdapProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthenticationMethodLdapPropertiesResponse.fromMap(
      ...
      base64EncodedCassandraYamlFragment: (() {
        final guardedValue = map['base64EncodedCassandraYamlFragment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataCenterLocation: (() {
        final guardedValue = map['dataCenterLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deallocated: (() {
      ...
      privateEndpointIpAddress: (() {
        final guardedValue = map['privateEndpointIpAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      provisionError: (() {
