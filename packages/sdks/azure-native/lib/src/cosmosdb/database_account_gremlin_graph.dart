...
/// }
///
/// resource "azure-native_cosmosdb_databaseaccountgremlingraph" "databaseAccountGremlinGraph" {
///   account_name  = "ddb1"
...
class DatabaseAccountGremlinGraph extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DatabaseAccountGremlinGraph] resource.
  DatabaseAccountGremlinGraph.reference(String urn)
    : super(
        'azure-native:cosmosdb:DatabaseAccountGremlinGraph',
