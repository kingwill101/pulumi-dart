...
/// }
///
/// resource "azure-native_cosmosdb_cassandraresourcecassandraroledefinition" "cassandraResourceCassandraRoleDefinition" {
...
///   permissions {
///     data_actions     = ["Microsoft.DocumentDB/databaseAccounts/cassandraDatabases/containers/entities/create", "Microsoft.DocumentDB/databaseAccounts/cassandraDatabases/containers/entities/read"]
///     not_data_actions = []
///   }
...
class CassandraResourceCassandraRoleDefinition extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [CassandraResourceCassandraRoleDefinition] resource.
  CassandraResourceCassandraRoleDefinition.reference(String urn)
    : super(
        'azure-native:cosmosdb:CassandraResourceCassandraRoleDefinition',
