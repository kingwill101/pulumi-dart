...
class AccountKeyMetadataResponse {
  ...
  AccountKeyMetadataResponse({required this.generationTime});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'generationTime': generationTime};
  }

  factory AccountKeyMetadataResponse.fromMap(Map<String, dynamic> map) {
    return AccountKeyMetadataResponse(
      generationTime: pulumi.Input.fromValue(map['generationTime'] as String),
    );
  }
}
