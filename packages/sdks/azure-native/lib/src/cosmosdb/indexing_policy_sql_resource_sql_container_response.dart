...
class IndexingPolicySqlResourceSqlContainerResponse {
  ...
  /// Creates a new [IndexingPolicySqlResourceSqlContainerResponse].
  ...
  const IndexingPolicySqlResourceSqlContainerResponse({
    this.automatic,
  ...
  factory IndexingPolicySqlResourceSqlContainerResponse.fromMap(Map<String, dynamic> map) {
    return IndexingPolicySqlResourceSqlContainerResponse(
