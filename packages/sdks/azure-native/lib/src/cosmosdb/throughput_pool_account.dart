...
/// }
///
/// resource "azure-native_cosmosdb_throughputpoolaccount" "throughputPoolAccount" {
...
class ThroughputPoolAccount extends pulumi.CustomResource {
  ...
  ThroughputPoolAccount(
    ...
    accountResourceIdentifier = registerOutput<String?>('accountResourceIdentifier');
  ...
  /// Creates a typed reference to an existing [ThroughputPoolAccount] resource.
  ThroughputPoolAccount.reference(String urn)
    : super(
        'azure-native:cosmosdb:ThroughputPoolAccount',
