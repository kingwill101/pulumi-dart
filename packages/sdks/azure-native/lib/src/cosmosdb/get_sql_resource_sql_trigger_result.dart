...
class GetSqlResourceSqlTriggerResult {
  ...
  const GetSqlResourceSqlTriggerResult({
  ...
  factory GetSqlResourceSqlTriggerResult.fromMap(Map<String, dynamic> map) {
    return GetSqlResourceSqlTriggerResult(
      ...
      resource: (() { final guardedValue = map['resource']; if (guardedValue == null) return null; return SqlTriggerGetPropertiesResponseResource.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
