...
class SqlContainerGetPropertiesResponseOptions {
  ...
  factory SqlContainerGetPropertiesResponseOptions.fromMap(Map<String, dynamic> map) {
    return SqlContainerGetPropertiesResponseOptions(
