...
class DatabaseAccountSqlContainer extends pulumi.CustomResource {
  ...
  DatabaseAccountSqlContainer(
    ...
    this.conflictResolutionPolicy = registerOutput<ConflictResolutionPolicyResponse?>('conflictResolutionPolicy');
    this.defaultTtl = registerOutput<int?>('defaultTtl');
    this.etag = registerOutput<String?>('etag');
    this.indexingPolicy = registerOutput<IndexingPolicyResponse?>('indexingPolicy');
    this.location = registerOutput<String?>('location');
    this.name = registerOutput<String>('name');
    this.partitionKey = registerOutput<ContainerPartitionKeyResponse?>('partitionKey');
    this.rid = registerOutput<String?>('rid');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.ts = registerOutput<dynamic>('ts');
    this.type = registerOutput<String>('type');
    this.uniqueKeyPolicy = registerOutput<UniqueKeyPolicyResponse?>('uniqueKeyPolicy');
  }
}
