...
class MongoMIResourceMongoMIRoleDefinitionArgs {
  ...
  const MongoMIResourceMongoMIRoleDefinitionArgs({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'roleName': ?roleName,
      'type': ?pulumi.Input.mapOptionalInputValue<RoleDefinitionType, String>(type, (value) => value.wireValue),
    };
  }
  ...
  factory MongoMIResourceMongoMIRoleDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return MongoMIResourceMongoMIRoleDefinitionArgs(
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RoleDefinitionType.fromValue(guardedValue as String)); })(),
    );
  }
}
