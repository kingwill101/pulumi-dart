...
/// Result data returned by getGremlinResourceGremlinRoleDefinition.
class GetGremlinResourceGremlinRoleDefinitionResult {
  ...
  /// Creates a new [GetGremlinResourceGremlinRoleDefinitionResult].
  ...
  const GetGremlinResourceGremlinRoleDefinitionResult({
  ...
  factory GetGremlinResourceGremlinRoleDefinitionResult.fromMap(Map<String, dynamic> map) {
