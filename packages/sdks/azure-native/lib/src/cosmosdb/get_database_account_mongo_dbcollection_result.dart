...
class GetDatabaseAccountMongoDBCollectionResult {
  ...
  factory GetDatabaseAccountMongoDBCollectionResult.fromMap(
    ...
    return GetDatabaseAccountMongoDBCollectionResult(
      ...
      indexes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<MongoIndexResponse>(
          guardedValue,
          (value) => MongoIndexResponse.fromMap(
