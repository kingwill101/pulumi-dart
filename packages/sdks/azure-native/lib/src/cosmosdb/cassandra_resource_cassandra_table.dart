...
class CassandraResourceCassandraTable extends pulumi.CustomResource {
  ...
  late final pulumi.Output<CassandraTableGetPropertiesResponseResource?> resource;
  ...
  CassandraResourceCassandraTable(
    ...
    this.options = registerOutput<CassandraTableGetPropertiesResponseOptions?>('options');
    this.resource = registerOutput<CassandraTableGetPropertiesResponseResource?>('resource');
