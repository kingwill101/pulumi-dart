...
import 'gremlin_database_get_properties_response_options.dart';
import 'gremlin_database_get_properties_response_resource.dart';
import 'gremlin_resource_gremlin_database_args.dart';
...
/// }
///
/// resource "azure-native_cosmosdb_gremlinresourcegremlindatabase" "gremlinResourceGremlinDatabase" {
///   account_name  = "ddb1"
...
class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
  ...
  late final pulumi.Output<GremlinDatabaseGetPropertiesResponseOptions?> options;
  late final pulumi.Output<GremlinDatabaseGetPropertiesResponseResource?> resource;
  /// Tags are a list of key-value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key no greater than 128 characters and value no greater than 256 characters. For example, the default experience for a template type is set with "defaultExperience": "Cassandra". Current "defaultExperience" values also include "Table", "Graph", "DocumentDB", and "MongoDB".
  late final pulumi.Output<Map<String, String>?> tags;
  /// The type of Azure resource.
  late final pulumi.Output<String> type;

  /// Creates a new [GremlinResourceGremlinDatabase].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GremlinResourceGremlinDatabase]. {@macro pulumi_cosmosdb_gremlin_resource_gremlin_database_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GremlinResourceGremlinDatabase(
    String name, {
    GremlinResourceGremlinDatabaseArgs? args,
    ...
    this.options = registerOutput<GremlinDatabaseGetPropertiesResponseOptions?>('options', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GremlinDatabaseGetPropertiesResponseOptions.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    resource = registerOutput<GremlinDatabaseGetPropertiesResponseResource?>('resource', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GremlinDatabaseGetPropertiesResponseResource.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [GremlinResourceGremlinDatabase] resource.
  GremlinResourceGremlinDatabase.reference(String urn)
    : super(
        'azure-native:cosmosdb:GremlinResourceGremlinDatabase',
