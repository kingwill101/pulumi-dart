...
class GetTableResourceTableResult {
  ...
  factory GetTableResourceTableResult.fromMap(Map<String, dynamic> map) {
    return GetTableResourceTableResult(
      ...
      options: map['options'] == null ? null : TableGetPropertiesResponseOptions.fromMap((map['options']! as Map).cast<String, dynamic>()),
      resource: map['resource'] == null ? null : TableGetPropertiesResponseResource.fromMap((map['resource']! as Map).cast<String, dynamic>()),
