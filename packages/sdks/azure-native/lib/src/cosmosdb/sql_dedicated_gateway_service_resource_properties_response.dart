...
class SqlDedicatedGatewayServiceResourcePropertiesResponse {
  ...
  final pulumi.Input<List<SqlDedicatedGatewayRegionalServiceResourceResponse>>
  locations;
    ...
    return <String, dynamic>{
      ...
      'locations':
          pulumi.Input.mapInputValue<
            List<SqlDedicatedGatewayRegionalServiceResourceResponse>,
  ...
  factory SqlDedicatedGatewayServiceResourcePropertiesResponse.fromMap(
    ...
    return SqlDedicatedGatewayServiceResourcePropertiesResponse(
      ...
      locations: pulumi.Input.fromValue(
        ...
        >(
          map['locations']!,
          (value) => SqlDedicatedGatewayRegionalServiceResourceResponse.fromMap(
      ...
      sqlDedicatedGatewayEndpoint: (() {
        final guardedValue = map['sqlDedicatedGatewayEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
