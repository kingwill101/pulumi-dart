...
class GetCassandraClusterResult {
  ...
  factory GetCassandraClusterResult.fromMap(Map<String, dynamic> map) {
    return GetCassandraClusterResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ClusterResourceResponseProperties.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
