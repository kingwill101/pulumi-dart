...
import 'database_account_sql_database_args.dart';
...
/// }
///
/// resource "azure-native_cosmosdb_databaseaccountsqldatabase" "databaseAccountSqlDatabase" {
///   account_name  = "ddb1"
...
class DatabaseAccountSqlDatabase extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String?> colls;
  ...
  late final pulumi.Output<String?> users;

  /// Creates a new [DatabaseAccountSqlDatabase].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DatabaseAccountSqlDatabase]. {@macro pulumi_cosmosdb_database_account_sql_database_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DatabaseAccountSqlDatabase(
    String name, {
    DatabaseAccountSqlDatabaseArgs? args,
    ...
    colls = registerOutput<String?>('colls');
    ...
    users = registerOutput<String?>('users');
  }

  /// Creates a typed reference to an existing [DatabaseAccountSqlDatabase] resource.
  DatabaseAccountSqlDatabase.reference(String urn)
    : super(
        'azure-native:cosmosdb:DatabaseAccountSqlDatabase',
