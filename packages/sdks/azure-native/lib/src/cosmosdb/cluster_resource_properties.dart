  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'externalSeedNodes':
          ...
          >(
            externalSeedNodes,
            (value) => pulumi.Input.encodeList<SeedNode, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'nodeSku': ?nodeSku,
      'prometheusEndpoint':
          ?pulumi.Input.mapOptionalInputValue<SeedNode, Map<String, dynamic>>(
            prometheusEndpoint,
            (value) => value.toMap(),
          ),
      'provisionError':
  ...
  factory ClusterResourceProperties.fromMap(Map<String, dynamic> map) {
    return ClusterResourceProperties(
      ...
      externalSeedNodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SeedNode>(
            guardedValue,
            (value) => SeedNode.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      hoursBetweenBackups: (() {
      ...
      initialCassandraAdminPassword: (() {
        final guardedValue = map['initialCassandraAdminPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nodeCount: (() {
      ...
      prometheusEndpoint: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SeedNode.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      provisionError: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CassandraError.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      provisioningState: (() {
      ...
      restoreFromBackupId: (() {
        final guardedValue = map['restoreFromBackupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subnetId: (() {
