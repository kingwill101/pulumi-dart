...
class SqlResourceSqlStoredProcedureArgs {
  ...
  const SqlResourceSqlStoredProcedureArgs({
  ...
  factory SqlResourceSqlStoredProcedureArgs.fromMap(Map<String, dynamic> map) {
    return SqlResourceSqlStoredProcedureArgs(
      ...
      resource: pulumi.Input.fromValue(SqlStoredProcedureResource.fromMap((map['resource']! as Map).cast<String, dynamic>())),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      storedProcedureName: (() { final guardedValue = map['storedProcedureName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
