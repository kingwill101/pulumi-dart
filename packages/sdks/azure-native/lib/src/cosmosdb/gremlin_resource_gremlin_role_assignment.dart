...
import 'gremlin_resource_gremlin_role_assignment_args.dart';
...
/// }
///
/// resource "azure-native_cosmosdb_gremlinresourcegremlinroleassignment" "gremlinResourceGremlinRoleAssignment" {
...
class GremlinResourceGremlinRoleAssignment extends pulumi.CustomResource {
  ...
  /// Creates a new [GremlinResourceGremlinRoleAssignment].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GremlinResourceGremlinRoleAssignment]. {@macro pulumi_cosmosdb_gremlin_resource_gremlin_role_assignment_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GremlinResourceGremlinRoleAssignment(
    String name, {
    GremlinResourceGremlinRoleAssignmentArgs? args,
  ...
  /// Creates a typed reference to an existing [GremlinResourceGremlinRoleAssignment] resource.
  GremlinResourceGremlinRoleAssignment.reference(String urn)
    : super(
        'azure-native:cosmosdb:GremlinResourceGremlinRoleAssignment',
