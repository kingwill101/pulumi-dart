...
class RestoreParametersResponse {
  ...
  const RestoreParametersResponse({
  ...
  factory RestoreParametersResponse.fromMap(Map<String, dynamic> map) {
    return RestoreParametersResponse(
      databasesToRestore: (() { final guardedValue = map['databasesToRestore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DatabaseRestoreResourceResponse>(guardedValue, (value) => DatabaseRestoreResourceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      gremlinDatabasesToRestore: (() { final guardedValue = map['gremlinDatabasesToRestore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GremlinDatabaseRestoreResourceResponse>(guardedValue, (value) => GremlinDatabaseRestoreResourceResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
