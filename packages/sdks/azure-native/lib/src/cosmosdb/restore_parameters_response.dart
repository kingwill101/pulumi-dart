...
class RestoreParametersResponse {
  ...
  final pulumi.Input<List<GremlinDatabaseRestoreResourceResponse>>?
    ...
    return <String, dynamic>{
      'databasesToRestore':
          ?pulumi.Input.mapOptionalInputValue<
            List<DatabaseRestoreResourceResponse>,
      ...
      'gremlinDatabasesToRestore':
          ?pulumi.Input.mapOptionalInputValue<
            List<GremlinDatabaseRestoreResourceResponse>,
            List<Map<String, dynamic>>
          >(
            gremlinDatabasesToRestore,
            (value) =>
    ...
    return RestoreParametersResponse(
      databasesToRestore: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseRestoreResourceResponse>(
            guardedValue,
            (value) => DatabaseRestoreResourceResponse.fromMap(
      ...
      gremlinDatabasesToRestore: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GremlinDatabaseRestoreResourceResponse>(
            guardedValue,
            (value) => GremlinDatabaseRestoreResourceResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
