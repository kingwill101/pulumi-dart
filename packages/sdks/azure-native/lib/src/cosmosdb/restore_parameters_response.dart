...
class RestoreParametersResponse {
  ...
  final List<DatabaseRestoreResourceResponse>? databasesToRestore;
  /// List of specific gremlin databases available for restore.
  final List<GremlinDatabaseRestoreResourceResponse>? gremlinDatabasesToRestore;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'databasesToRestore': ?databasesToRestore == null ? null : pulumi.Input.encodeList<DatabaseRestoreResourceResponse, Map<String, dynamic>>(databasesToRestore!, (value) => value.toMap()),
      'gremlinDatabasesToRestore': ?gremlinDatabasesToRestore == null ? null : pulumi.Input.encodeList<GremlinDatabaseRestoreResourceResponse, Map<String, dynamic>>(gremlinDatabasesToRestore!, (value) => value.toMap()),
  ...
  factory RestoreParametersResponse.fromMap(Map<String, dynamic> map) {
    return RestoreParametersResponse(
      databasesToRestore: map['databasesToRestore'] == null ? null : pulumi.Input.decodeList<DatabaseRestoreResourceResponse>(map['databasesToRestore'], (value) => DatabaseRestoreResourceResponse.fromMap((value as Map).cast<String, dynamic>())),
      gremlinDatabasesToRestore: map['gremlinDatabasesToRestore'] == null ? null : pulumi.Input.decodeList<GremlinDatabaseRestoreResourceResponse>(map['gremlinDatabasesToRestore'], (value) => GremlinDatabaseRestoreResourceResponse.fromMap((value as Map).cast<String, dynamic>())),
