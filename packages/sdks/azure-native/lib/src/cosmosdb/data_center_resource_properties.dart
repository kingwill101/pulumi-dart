...
class DataCenterResourceProperties {
  ...
  factory DataCenterResourceProperties.fromMap(Map<String, dynamic> map) {
    return DataCenterResourceProperties(
      authenticationMethodLdapProperties: (() { final guardedValue = map['authenticationMethodLdapProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AuthenticationMethodLdapProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
