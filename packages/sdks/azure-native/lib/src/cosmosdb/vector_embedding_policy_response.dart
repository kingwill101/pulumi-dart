...
class VectorEmbeddingPolicyResponse {
  ...
  VectorEmbeddingPolicyResponse({this.vectorEmbeddings});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'vectorEmbeddings':
          ?pulumi.Input.mapOptionalInputValue<
            List<VectorEmbeddingResponse>,
    ...
    return VectorEmbeddingPolicyResponse(
      vectorEmbeddings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VectorEmbeddingResponse>(
            guardedValue,
            (value) => VectorEmbeddingResponse.fromMap(
