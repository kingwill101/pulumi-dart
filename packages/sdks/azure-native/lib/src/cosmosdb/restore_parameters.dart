...
class RestoreParameters {
  ...
  final pulumi.Input<List<GremlinDatabaseRestoreResource>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gremlinDatabasesToRestore':
          ?pulumi.Input.mapOptionalInputValue<
            List<GremlinDatabaseRestoreResource>,
            List<Map<String, dynamic>>
          >(
            gremlinDatabasesToRestore,
            (value) =>
  ...
  factory RestoreParameters.fromMap(Map<String, dynamic> map) {
    return RestoreParameters(
      databasesToRestore: (() {
        final guardedValue = map['databasesToRestore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DatabaseRestoreResource>(
            guardedValue,
            (value) => DatabaseRestoreResource.fromMap(
      ...
      gremlinDatabasesToRestore: (() {
        final guardedValue = map['gremlinDatabasesToRestore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GremlinDatabaseRestoreResource>(
            guardedValue,
            (value) => GremlinDatabaseRestoreResource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      restoreMode: (() {
        final guardedValue = map['restoreMode'];
        if (guardedValue == null) return null;
      ...
      sourceBackupLocation: (() {
        final guardedValue = map['sourceBackupLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tablesToRestore: (() {
        final guardedValue = map['tablesToRestore'];
        if (guardedValue == null) return null;
