...
/// Result data returned by getDatabaseAccountSqlContainer.
class GetDatabaseAccountSqlContainerResult {
  ...
  /// Creates a new [GetDatabaseAccountSqlContainerResult].
  ...
  const GetDatabaseAccountSqlContainerResult({
  ...
  factory GetDatabaseAccountSqlContainerResult.fromMap(Map<String, dynamic> map) {
