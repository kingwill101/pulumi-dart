...
class DatabaseAccountArgs {
  ...
  final pulumi.Input<dynamic>? backupPolicy;
  ...
  final pulumi.Input<dynamic>? connectorOffer;
  ...
  final pulumi.Input<dynamic>? defaultPriorityLevel;
  ...
  }) : createMode = createMode ?? pulumi.Input.fromValue('Default'), kind = kind ?? pulumi.Input.fromValue('GlobalDocumentDB');
  ...
  factory DatabaseAccountArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseAccountArgs(
      ...
      backupPolicy: (() { final guardedValue = map['backupPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      connectorOffer: (() { final guardedValue = map['connectorOffer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      defaultPriorityLevel: (() { final guardedValue = map['defaultPriorityLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
