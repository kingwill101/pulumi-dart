...
class DatabaseAccountArgs {
  ...
  DatabaseAccountArgs({
    ...
    pulumi.Output<AnalyticalStorageConfiguration>? analyticalStorageConfiguration,
    pulumi.Output<ApiProperties>? apiProperties,
    pulumi.Output<ContinuousModeBackupPolicy>? backupPolicy,
    pulumi.Output<List<Capability>>? capabilities,
    pulumi.Output<Capacity>? capacity,
    pulumi.Output<String>? connectorOffer,
    pulumi.Output<ConsistencyPolicy>? consistencyPolicy,
    pulumi.Output<List<CorsPolicy>>? cors,
    pulumi.Output<String>? createMode,
    pulumi.Output<String>? customerManagedKeyStatus,
    required pulumi.Output<DatabaseAccountOfferType> databaseAccountOfferType,
    pulumi.Output<String>? defaultIdentity,
    pulumi.Output<String>? defaultPriorityLevel,
    pulumi.Output<bool>? disableKeyBasedMetadataWriteAccess,
    pulumi.Output<bool>? disableLocalAuth,
    pulumi.Output<bool>? enableAnalyticalStorage,
    pulumi.Output<bool>? enableAutomaticFailover,
    pulumi.Output<bool>? enableBurstCapacity,
    pulumi.Output<bool>? enableCassandraConnector,
    pulumi.Output<bool>? enableFreeTier,
    pulumi.Output<bool>? enableMultipleWriteLocations,
    pulumi.Output<bool>? enablePartitionMerge,
    pulumi.Output<bool>? enablePerRegionPerPartitionAutoscale,
    pulumi.Output<bool>? enablePriorityBasedExecution,
    pulumi.Output<ManagedServiceIdentity>? identity,
    pulumi.Output<List<IpAddressOrRange>>? ipRules,
    pulumi.Output<bool>? isVirtualNetworkFilterEnabled,
    pulumi.Output<String>? keyVaultKeyUri,
    pulumi.Output<String>? kind,
    pulumi.Output<String>? location,
    required pulumi.Output<List<Location>> locations,
    pulumi.Output<String>? minimalTlsVersion,
    pulumi.Output<NetworkAclBypass>? networkAclBypass,
    pulumi.Output<List<String>>? networkAclBypassResourceIds,
    pulumi.Output<String>? publicNetworkAccess,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<RestoreParameters>? restoreParameters,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<VirtualNetworkRule>>? virtualNetworkRules,
  }) :
  ...
  factory DatabaseAccountArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseAccountArgs(
      ...
      analyticalStorageConfiguration: map['analyticalStorageConfiguration'] == null ? null : pulumi.Output.create<AnalyticalStorageConfiguration>(AnalyticalStorageConfiguration.fromMap((map['analyticalStorageConfiguration'] as Map).cast<String, dynamic>())),
      apiProperties: map['apiProperties'] == null ? null : pulumi.Output.create<ApiProperties>(ApiProperties.fromMap((map['apiProperties'] as Map).cast<String, dynamic>())),
      backupPolicy: map['backupPolicy'] == null ? null : pulumi.Output.create<ContinuousModeBackupPolicy>(ContinuousModeBackupPolicy.fromMap((map['backupPolicy'] as Map).cast<String, dynamic>())),
      capabilities: map['capabilities'] == null ? null : pulumi.Output.create<List<Capability>>(pulumi.Input.decodeList<Capability>(map['capabilities'], (value) => Capability.fromMap((value as Map).cast<String, dynamic>()))),
      capacity: map['capacity'] == null ? null : pulumi.Output.create<Capacity>(Capacity.fromMap((map['capacity'] as Map).cast<String, dynamic>())),
      connectorOffer: map['connectorOffer'] == null ? null : pulumi.Output.create<String>(map['connectorOffer'] as String),
      consistencyPolicy: map['consistencyPolicy'] == null ? null : pulumi.Output.create<ConsistencyPolicy>(ConsistencyPolicy.fromMap((map['consistencyPolicy'] as Map).cast<String, dynamic>())),
      cors: map['cors'] == null ? null : pulumi.Output.create<List<CorsPolicy>>(pulumi.Input.decodeList<CorsPolicy>(map['cors'], (value) => CorsPolicy.fromMap((value as Map).cast<String, dynamic>()))),
      createMode: map['createMode'] == null ? null : pulumi.Output.create<String>(map['createMode'] as String),
      customerManagedKeyStatus: map['customerManagedKeyStatus'] == null ? null : pulumi.Output.create<String>(map['customerManagedKeyStatus'] as String),
      databaseAccountOfferType: pulumi.Output.create<DatabaseAccountOfferType>(DatabaseAccountOfferType.fromValue(map['databaseAccountOfferType'] as String)),
      defaultIdentity: map['defaultIdentity'] == null ? null : pulumi.Output.create<String>(map['defaultIdentity'] as String),
      defaultPriorityLevel: map['defaultPriorityLevel'] == null ? null : pulumi.Output.create<String>(map['defaultPriorityLevel'] as String),
      disableKeyBasedMetadataWriteAccess: map['disableKeyBasedMetadataWriteAccess'] == null ? null : pulumi.Output.create<bool>(map['disableKeyBasedMetadataWriteAccess'] as bool),
      disableLocalAuth: map['disableLocalAuth'] == null ? null : pulumi.Output.create<bool>(map['disableLocalAuth'] as bool),
      enableAnalyticalStorage: map['enableAnalyticalStorage'] == null ? null : pulumi.Output.create<bool>(map['enableAnalyticalStorage'] as bool),
      enableAutomaticFailover: map['enableAutomaticFailover'] == null ? null : pulumi.Output.create<bool>(map['enableAutomaticFailover'] as bool),
      enableBurstCapacity: map['enableBurstCapacity'] == null ? null : pulumi.Output.create<bool>(map['enableBurstCapacity'] as bool),
      enableCassandraConnector: map['enableCassandraConnector'] == null ? null : pulumi.Output.create<bool>(map['enableCassandraConnector'] as bool),
      enableFreeTier: map['enableFreeTier'] == null ? null : pulumi.Output.create<bool>(map['enableFreeTier'] as bool),
      enableMultipleWriteLocations: map['enableMultipleWriteLocations'] == null ? null : pulumi.Output.create<bool>(map['enableMultipleWriteLocations'] as bool),
      enablePartitionMerge: map['enablePartitionMerge'] == null ? null : pulumi.Output.create<bool>(map['enablePartitionMerge'] as bool),
      enablePerRegionPerPartitionAutoscale: map['enablePerRegionPerPartitionAutoscale'] == null ? null : pulumi.Output.create<bool>(map['enablePerRegionPerPartitionAutoscale'] as bool),
      enablePriorityBasedExecution: map['enablePriorityBasedExecution'] == null ? null : pulumi.Output.create<bool>(map['enablePriorityBasedExecution'] as bool),
      identity: map['identity'] == null ? null : pulumi.Output.create<ManagedServiceIdentity>(ManagedServiceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>())),
      ipRules: map['ipRules'] == null ? null : pulumi.Output.create<List<IpAddressOrRange>>(pulumi.Input.decodeList<IpAddressOrRange>(map['ipRules'], (value) => IpAddressOrRange.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      keyVaultKeyUri: map['keyVaultKeyUri'] == null ? null : pulumi.Output.create<String>(map['keyVaultKeyUri'] as String),
      kind: map['kind'] == null ? null : pulumi.Output.create<String>(map['kind'] as String),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      locations: pulumi.Output.create<List<Location>>(pulumi.Input.decodeList<Location>(map['locations'], (value) => Location.fromMap((value as Map).cast<String, dynamic>()))),
      minimalTlsVersion: map['minimalTlsVersion'] == null ? null : pulumi.Output.create<String>(map['minimalTlsVersion'] as String),
      networkAclBypass: map['networkAclBypass'] == null ? null : pulumi.Output.create<NetworkAclBypass>(NetworkAclBypass.fromValue(map['networkAclBypass'] as String)),
      networkAclBypassResourceIds: map['networkAclBypassResourceIds'] == null ? null : pulumi.Output.create<List<String>>((map['networkAclBypassResourceIds'] as List).cast<String>()),
      ...
      restoreParameters: map['restoreParameters'] == null ? null : pulumi.Output.create<RestoreParameters>(RestoreParameters.fromMap((map['restoreParameters'] as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      virtualNetworkRules: map['virtualNetworkRules'] == null ? null : pulumi.Output.create<List<VirtualNetworkRule>>(pulumi.Input.decodeList<VirtualNetworkRule>(map['virtualNetworkRules'], (value) => VirtualNetworkRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
