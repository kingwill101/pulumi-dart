...
class CassandraKeyspaceGetPropertiesResponseOptions {
  /// Specifies the Autoscale settings.
  final pulumi.Input<AutoscaleSettingsResponse?>? autoscaleSettings;
  /// Value of the Cosmos DB resource throughput or autoscaleSettings. Use the ThroughputSetting resource when retrieving offer details.
  final pulumi.Input<int?>? throughput;

  /// Creates a new [CassandraKeyspaceGetPropertiesResponseOptions].
  ...
  const CassandraKeyspaceGetPropertiesResponseOptions({
  ...
  factory CassandraKeyspaceGetPropertiesResponseOptions.fromMap(Map<String, dynamic> map) {
    return CassandraKeyspaceGetPropertiesResponseOptions(
