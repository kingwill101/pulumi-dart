...
/// }
///
/// resource "azure-native_cosmosdb_databaseaccountmongodbdatabase" "databaseAccountMongoDBDatabase" {
///   account_name  = "ddb1"
...
class DatabaseAccountMongoDBDatabase extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [DatabaseAccountMongoDBDatabase] resource.
  DatabaseAccountMongoDBDatabase.reference(String urn)
    : super(
        'azure-native:cosmosdb:DatabaseAccountMongoDBDatabase',
