...
class ClusterResourceResponsePropertiesV1 {
  ...
  factory ClusterResourceResponsePropertiesV1.fromMap(Map<String, dynamic> map) {
    return ClusterResourceResponsePropertiesV1(
      ...
      endPoints: pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterResourceResponseEndPoints>(map['endPoints']!, (value) => ClusterResourceResponseEndPoints.fromMap((value as Map).cast<String, dynamic>()))),
