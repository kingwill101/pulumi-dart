...
class ContainerPartitionKeyGremlinResourceGremlinGraphResponse {
  ...
  /// Creates a new [ContainerPartitionKeyGremlinResourceGremlinGraphResponse].
  ...
  const ContainerPartitionKeyGremlinResourceGremlinGraphResponse({
    this.kind,
    this.paths,
  ...
  factory ContainerPartitionKeyGremlinResourceGremlinGraphResponse.fromMap(Map<String, dynamic> map) {
    return ContainerPartitionKeyGremlinResourceGremlinGraphResponse(
