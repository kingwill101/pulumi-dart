...
/// }
///
/// resource "azure-native_cosmosdb_cassandraresourcecassandraroleassignment" "cassandraResourceCassandraRoleAssignment" {
...
class CassandraResourceCassandraRoleAssignment extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [CassandraResourceCassandraRoleAssignment] resource.
  CassandraResourceCassandraRoleAssignment.reference(String urn)
    : super(
        'azure-native:cosmosdb:CassandraResourceCassandraRoleAssignment',
