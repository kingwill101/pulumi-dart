...
/// }
///
/// resource "azure-native_cosmosdb_sqlresourcesqltrigger" "sqlResourceSqlTrigger" {
///   account_name   = "ddb1"
...
class SqlResourceSqlTrigger extends pulumi.CustomResource {
  ...
  SqlResourceSqlTrigger(
    ...
    resource = registerOutput<SqlTriggerGetPropertiesResponseResource?>('resource', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SqlTriggerGetPropertiesResponseResource.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [SqlResourceSqlTrigger] resource.
  SqlResourceSqlTrigger.reference(String urn)
    : super(
        'azure-native:cosmosdb:SqlResourceSqlTrigger',
