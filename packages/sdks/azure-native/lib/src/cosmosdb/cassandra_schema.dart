...
class CassandraSchema {
  ...
  CassandraSchema({this.clusterKeys, this.columns, this.partitionKeys});
    ...
    return <String, dynamic>{
      'clusterKeys':
          ...
          >(
            clusterKeys,
            (value) =>
                pulumi.Input.encodeList<ClusterKey, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return CassandraSchema(
      clusterKeys: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterKey>(
            guardedValue,
            (value) =>
                ClusterKey.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      columns: (() {
      ...
      partitionKeys: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CassandraPartitionKey>(
            guardedValue,
            (value) => CassandraPartitionKey.fromMap(
