...
class GetMongoDBResourceMongoRoleDefinitionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'privileges': ?(() {
        final guardedValue = privileges;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<PrivilegeResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetMongoDBResourceMongoRoleDefinitionResult.fromMap(
    ...
    return GetMongoDBResourceMongoRoleDefinitionResult(
      ...
      privileges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<PrivilegeResponse>(
          guardedValue,
          (value) =>
              PrivilegeResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      roleName: (() {
