...
class SqlResourceSqlDatabase extends pulumi.CustomResource {
  ...
  SqlResourceSqlDatabase(
    ...
    this.options = registerOutput<SqlDatabaseGetPropertiesResponseOptions?>('options');
    this.resource = registerOutput<SqlDatabaseGetPropertiesResponseResource?>('resource');
