...
/// }
///
/// resource "azure-native_cosmosdb_cassandraresourcecassandraview" "cassandraResourceCassandraView" {
///   account_name  = "ddb1"
...
class CassandraResourceCassandraView extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [CassandraResourceCassandraView] resource.
  CassandraResourceCassandraView.reference(String urn)
    : super(
        'azure-native:cosmosdb:CassandraResourceCassandraView',
