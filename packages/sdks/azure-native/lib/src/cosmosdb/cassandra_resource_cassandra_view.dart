...
class CassandraResourceCassandraView extends pulumi.CustomResource {
  ...
  CassandraResourceCassandraView(
    ...
    this.options = registerOutput<CassandraViewGetPropertiesResponseOptions?>('options');
    this.resource = registerOutput<CassandraViewGetPropertiesResponseResource?>('resource');
