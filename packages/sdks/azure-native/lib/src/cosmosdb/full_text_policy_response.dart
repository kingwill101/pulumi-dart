...
class FullTextPolicyResponse {
  ...
  FullTextPolicyResponse({this.defaultLanguage, this.fullTextPaths});
    ...
    return FullTextPolicyResponse(
      ...
      fullTextPaths: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FullTextPathResponse>(
            guardedValue,
            (value) => FullTextPathResponse.fromMap(
