...
class GetMongoDBResourceMongoDBCollectionResult {
  ...
  factory GetMongoDBResourceMongoDBCollectionResult.fromMap(Map<String, dynamic> map) {
    return GetMongoDBResourceMongoDBCollectionResult(
      ...
      options: map['options'] == null ? null : MongoDBCollectionGetPropertiesResponseOptions.fromMap((map['options'] as Map).cast<String, dynamic>()),
      resource: map['resource'] == null ? null : MongoDBCollectionGetPropertiesResponseResource.fromMap((map['resource'] as Map).cast<String, dynamic>()),
