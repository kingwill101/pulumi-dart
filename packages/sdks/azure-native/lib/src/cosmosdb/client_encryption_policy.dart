...
class ClientEncryptionPolicy {
  ...
  final List<ClientEncryptionIncludedPath> includedPaths;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'includedPaths': pulumi.Input.encodeList<ClientEncryptionIncludedPath, Map<String, dynamic>>(includedPaths, (value) => value.toMap()),
  ...
  factory ClientEncryptionPolicy.fromMap(Map<String, dynamic> map) {
    return ClientEncryptionPolicy(
      includedPaths: pulumi.Input.decodeList<ClientEncryptionIncludedPath>(map['includedPaths'], (value) => ClientEncryptionIncludedPath.fromMap((value as Map).cast<String, dynamic>())),
