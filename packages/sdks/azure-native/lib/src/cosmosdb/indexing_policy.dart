...
class IndexingPolicy {
  ...
  factory IndexingPolicy.fromMap(Map<String, dynamic> map) {
    return IndexingPolicy(
      ...
      compositeIndexes: (() { final guardedValue = map['compositeIndexes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<List<CompositePath>>(guardedValue, (value) => pulumi.Input.decodeList<CompositePath>(value, (value) => CompositePath.fromMap((value as Map).cast<String, dynamic>())))); })(),
