...
/// }
///
/// resource "azure-native_cosmosdb_mongoclusterfirewallrule" "mongoClusterFirewallRule" {
...
class MongoClusterFirewallRule extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [MongoClusterFirewallRule] resource.
  MongoClusterFirewallRule.reference(String urn)
    : super(
        'azure-native:cosmosdb:MongoClusterFirewallRule',
