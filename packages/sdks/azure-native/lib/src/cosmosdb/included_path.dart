...
class IncludedPath {
  ...
  IncludedPath({this.indexes, this.path});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'indexes':
          ...
          >(
            indexes,
            (value) => pulumi.Input.encodeList<Indexes, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return IncludedPath(
      indexes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Indexes>(
            guardedValue,
            (value) => Indexes.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      path: (() {
