...
import 'table_resource_table_role_definition_args.dart';
...
/// ```
class TableResourceTableRoleDefinition extends pulumi.CustomResource {
  ...
  /// Creates a new [TableResourceTableRoleDefinition].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TableResourceTableRoleDefinition]. {@macro pulumi_cosmosdb_table_resource_table_role_definition_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TableResourceTableRoleDefinition(
    String name, {
    TableResourceTableRoleDefinitionArgs? args,
    pulumi.CustomResourceOptions? options,
  }) : super(
          'azure-native:cosmosdb:TableResourceTableRoleDefinition',
          name,
  ...
  /// Creates a typed reference to an existing [TableResourceTableRoleDefinition] resource.
  TableResourceTableRoleDefinition.reference(String urn)
    : super(
        'azure-native:cosmosdb:TableResourceTableRoleDefinition',
