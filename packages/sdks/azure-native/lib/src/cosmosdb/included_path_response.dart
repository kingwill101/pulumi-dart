...
class IncludedPathResponse {
  ...
  IncludedPathResponse({this.indexes, this.path});
    ...
    return <String, dynamic>{
      'indexes':
          ...
          >(
            indexes,
            (value) =>
                pulumi.Input.encodeList<IndexesResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return IncludedPathResponse(
      indexes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IndexesResponse>(
            guardedValue,
            (value) =>
                IndexesResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      path: (() {
