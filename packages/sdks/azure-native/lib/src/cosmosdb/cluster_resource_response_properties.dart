...
class ClusterResourceResponseProperties {
  ...
  factory ClusterResourceResponseProperties.fromMap(Map<String, dynamic> map) {
    return ClusterResourceResponseProperties(
      ...
      clientCertificates: (() { final guardedValue = map['clientCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateResponse>(guardedValue, (value) => CertificateResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      externalGossipCertificates: (() { final guardedValue = map['externalGossipCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateResponse>(guardedValue, (value) => CertificateResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      externalSeedNodes: (() { final guardedValue = map['externalSeedNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SeedNodeResponse>(guardedValue, (value) => SeedNodeResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      gossipCertificates: pulumi.Input.fromValue(pulumi.Input.decodeList<CertificateResponse>(map['gossipCertificates']!, (value) => CertificateResponse.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      prometheusEndpoint: (() { final guardedValue = map['prometheusEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SeedNodeResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
