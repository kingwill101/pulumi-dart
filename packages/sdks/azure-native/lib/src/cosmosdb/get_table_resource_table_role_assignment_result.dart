...
/// Result data returned by getTableResourceTableRoleAssignment.
class GetTableResourceTableRoleAssignmentResult {
  ...
  /// Creates a new [GetTableResourceTableRoleAssignmentResult].
  ...
  const GetTableResourceTableRoleAssignmentResult({
  ...
  factory GetTableResourceTableRoleAssignmentResult.fromMap(Map<String, dynamic> map) {
