    ...
    return <String, dynamic>{
      ...
      'compositeIndexes':
          ?pulumi.Input.mapOptionalInputValue<
            List<List<CompositePathResponse>>,
            List<List<Map<String, dynamic>>>
          >(
            compositeIndexes,
            (value) =>
                pulumi.Input.encodeList<
                  List<CompositePathResponse>,
      ...
      'fullTextIndexes':
          ?pulumi.Input.mapOptionalInputValue<
            List<FullTextIndexPathResponse>,
            List<Map<String, dynamic>>
          >(
            fullTextIndexes,
            (value) =>
    ...
    return IndexingPolicyResponse(
      ...
      compositeIndexes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<List<CompositePathResponse>>(
            guardedValue,
            (value) => pulumi.Input.decodeList<CompositePathResponse>(
              value,
              (value) => CompositePathResponse.fromMap(
      ...
      excludedPaths: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ExcludedPathResponse>(
            guardedValue,
            (value) => ExcludedPathResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      fullTextIndexes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FullTextIndexPathResponse>(
            guardedValue,
            (value) => FullTextIndexPathResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      includedPaths: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IncludedPathResponse>(
            guardedValue,
            (value) => IncludedPathResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      spatialIndexes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SpatialSpecResponse>(
            guardedValue,
            (value) => SpatialSpecResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      vectorIndexes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VectorIndexResponse>(
            guardedValue,
            (value) => VectorIndexResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
