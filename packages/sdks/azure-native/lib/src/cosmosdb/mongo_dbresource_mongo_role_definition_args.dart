...
class MongoDBResourceMongoRoleDefinitionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'privileges':
          ...
          >(
            privileges,
            (value) => pulumi.Input.encodeList<Privilege, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'type':
          ?pulumi.Input.mapOptionalInputValue<MongoRoleDefinitionType, String>(
            type,
  ...
  factory MongoDBResourceMongoRoleDefinitionArgs.fromMap(
    ...
    return MongoDBResourceMongoRoleDefinitionArgs(
      ...
      mongoRoleDefinitionId: (() {
        final guardedValue = map['mongoRoleDefinitionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privileges: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<Privilege>(
            guardedValue,
            (value) =>
                Privilege.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      type: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MongoRoleDefinitionType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
