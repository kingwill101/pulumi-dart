...
class VectorIndex {
  ...
  factory VectorIndex.fromMap(Map<String, dynamic> map) {
    return VectorIndex(
      indexingSearchListSize: (() { final guardedValue = map['indexingSearchListSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      path: pulumi.Input.fromValue(map['path'] as String),
      quantizationByteSize: (() { final guardedValue = map['quantizationByteSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
