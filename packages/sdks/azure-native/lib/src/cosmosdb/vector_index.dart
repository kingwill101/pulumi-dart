...
class VectorIndex {
  ...
  VectorIndex({
    pulumi.Input<double?>? indexingSearchListSize,
    required this.path,
    this.quantizationByteSize,
    required this.type,
    this.vectorIndexShardKey,
  }) : indexingSearchListSize = indexingSearchListSize ?? pulumi.Input.fromValue(100);
  ...
  factory VectorIndex.fromMap(Map<String, dynamic> map) {
    return VectorIndex(
      indexingSearchListSize: (() { final guardedValue = map['indexingSearchListSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      path: pulumi.Input.fromValue(map['path'] as String),
      quantizationByteSize: (() { final guardedValue = map['quantizationByteSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      type: pulumi.Input.fromValue(map['type']),
      vectorIndexShardKey: (() { final guardedValue = map['vectorIndexShardKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
