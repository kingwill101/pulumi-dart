...
class SqlContainerResource {
  ...
  factory SqlContainerResource.fromMap(Map<String, dynamic> map) {
    return SqlContainerResource(
      ...
      vectorEmbeddingPolicy: (() { final guardedValue = map['vectorEmbeddingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VectorEmbeddingPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
