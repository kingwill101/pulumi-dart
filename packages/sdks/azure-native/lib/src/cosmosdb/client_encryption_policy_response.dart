...
class ClientEncryptionPolicyResponse {
  ...
  factory ClientEncryptionPolicyResponse.fromMap(Map<String, dynamic> map) {
    return ClientEncryptionPolicyResponse(
      includedPaths: (pulumi.Input.decodeList<ClientEncryptionIncludedPathResponse>(map['includedPaths'], (value) => ClientEncryptionIncludedPathResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
