...
class ClientEncryptionPolicyResponse {
    ...
    return <String, dynamic>{
      'includedPaths':
          pulumi.Input.mapInputValue<
            List<ClientEncryptionIncludedPathResponse>,
  ...
  factory ClientEncryptionPolicyResponse.fromMap(Map<String, dynamic> map) {
    return ClientEncryptionPolicyResponse(
      includedPaths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ClientEncryptionIncludedPathResponse>(
          map['includedPaths']!,
          (value) => ClientEncryptionIncludedPathResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      policyFormatVersion: pulumi.Input.fromValue(
        map['policyFormatVersion'] as int,
      ),
    );
  }
}
