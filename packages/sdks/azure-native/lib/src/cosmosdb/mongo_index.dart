...
class MongoIndex {
  ...
  factory MongoIndex.fromMap(Map<String, dynamic> map) {
    return MongoIndex(
      key: (() { final guardedValue = map['key']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MongoIndexKeys.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      options: (() { final guardedValue = map['options']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MongoIndexOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
