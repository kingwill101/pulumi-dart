...
/// }
///
/// resource "azure-native_cosmosdb_sqlresourcesqlstoredprocedure" "sqlResourceSqlStoredProcedure" {
///   account_name   = "ddb1"
...
class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
  ...
  SqlResourceSqlStoredProcedure(
    ...
    resource = registerOutput<SqlStoredProcedureGetPropertiesResponseResource?>('resource', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SqlStoredProcedureGetPropertiesResponseResource.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [SqlResourceSqlStoredProcedure] resource.
  SqlResourceSqlStoredProcedure.reference(String urn)
    : super(
        'azure-native:cosmosdb:SqlResourceSqlStoredProcedure',
