...
/// }
///
/// resource "azure-native_cosmosdb_gremlinresourcegremlingraph" "gremlinResourceGremlinGraph" {
///   account_name  = "ddb1"
...
class GremlinResourceGremlinGraph extends pulumi.CustomResource {
  ...
  GremlinResourceGremlinGraph(
    ...
    this.options = registerOutput<GremlinGraphGetPropertiesResponseOptions?>('options', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GremlinGraphGetPropertiesResponseOptions.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    resource = registerOutput<GremlinGraphGetPropertiesResponseResource?>('resource', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return GremlinGraphGetPropertiesResponseResource.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [GremlinResourceGremlinGraph] resource.
  GremlinResourceGremlinGraph.reference(String urn)
    : super(
        'azure-native:cosmosdb:GremlinResourceGremlinGraph',
