...
class GremlinResourceGremlinGraph extends pulumi.CustomResource {
  ...
  GremlinResourceGremlinGraph(
    ...
    this.options = registerOutput<GremlinGraphGetPropertiesResponseOptions?>('options');
    this.resource = registerOutput<GremlinGraphGetPropertiesResponseResource?>('resource');
