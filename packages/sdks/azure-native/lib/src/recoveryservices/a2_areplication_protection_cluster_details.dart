...
class A2AReplicationProtectionClusterDetails {
  ...
  factory A2AReplicationProtectionClusterDetails.fromMap(Map<String, dynamic> map) {
    return A2AReplicationProtectionClusterDetails(
      ...
      initialPrimaryExtendedLocation: map['initialPrimaryExtendedLocation'] == null ? null : (ExtendedLocation.fromMap((map['initialPrimaryExtendedLocation'] as Map).cast<String, dynamic>())).input(),
      ...
      initialRecoveryExtendedLocation: map['initialRecoveryExtendedLocation'] == null ? null : (ExtendedLocation.fromMap((map['initialRecoveryExtendedLocation'] as Map).cast<String, dynamic>())).input(),
