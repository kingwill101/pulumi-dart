...
class VaultPropertiesResponseRedundancySettings {
  ...
  factory VaultPropertiesResponseRedundancySettings.fromMap(
    Map<String, dynamic> map,
  ) {
    return VaultPropertiesResponseRedundancySettings(
      crossRegionRestore: (() {
        final guardedValue = map['crossRegionRestore'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      standardTierStorageRedundancy: (() {
        final guardedValue = map['standardTierStorageRedundancy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
