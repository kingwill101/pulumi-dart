...
class ReprotectAgentDetailsResponse {
  ...
  factory ReprotectAgentDetailsResponse.fromMap(Map<String, dynamic> map) {
    return ReprotectAgentDetailsResponse(
      accessibleDatastores: pulumi.Input.fromValue(
        (map['accessibleDatastores'] as List).cast<String>(),
      ),
      ...
      lastDiscoveryInUtc: pulumi.Input.fromValue(
        map['lastDiscoveryInUtc'] as String,
      ),
