...
class A2ASharedDiskReplicationDetails {
  ...
  final pulumi.Input<List<A2AProtectedManagedDiskDetails>>?
    ...
    return <String, dynamic>{
      ...
      'protectedManagedDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<A2AProtectedManagedDiskDetails>,
      ...
      'unprotectedDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<A2AUnprotectedDiskDetails>,
            List<Map<String, dynamic>>
          >(
            unprotectedDisks,
            (value) =>
    ...
    return A2ASharedDiskReplicationDetails(
      ...
      protectedManagedDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AProtectedManagedDiskDetails>(
            guardedValue,
            (value) => A2AProtectedManagedDiskDetails.fromMap(
      ...
      unprotectedDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AUnprotectedDiskDetails>(
            guardedValue,
            (value) => A2AUnprotectedDiskDetails.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
