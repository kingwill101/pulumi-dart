...
class DailyRetentionFormatResponse {
  ...
  DailyRetentionFormatResponse({this.daysOfTheMonth});
    ...
    return <String, dynamic>{
      'daysOfTheMonth':
          ...
          >(
            daysOfTheMonth,
            (value) =>
                pulumi.Input.encodeList<DayResponse, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DailyRetentionFormatResponse.fromMap(Map<String, dynamic> map) {
    return DailyRetentionFormatResponse(
      daysOfTheMonth: (() {
        final guardedValue = map['daysOfTheMonth'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DayResponse>(
            guardedValue,
            (value) =>
                DayResponse.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
