...
class NetworkMappingPropertiesResponse {
  ...
  factory NetworkMappingPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkMappingPropertiesResponse(
      ...
      recoveryFabricArmId: (() { final guardedValue = map['recoveryFabricArmId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      recoveryNetworkFriendlyName: (() { final guardedValue = map['recoveryNetworkFriendlyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      recoveryNetworkId: (() { final guardedValue = map['recoveryNetworkId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
