...
class InMageRcmReplicationDetailsResponse {
  ...
  final pulumi.Input<List<InMageRcmAgentUpgradeBlockingErrorDetailsResponse>>?
  ...
  final pulumi.Input<InMageRcmDiscoveredProtectedVmDetailsResponse>?
  discoveredVmDetails;
  ...
  final pulumi.Input<List<InMageRcmLastAgentUpgradeErrorDetailsResponse>>?
  ...
  final pulumi.Input<InMageRcmMobilityAgentDetailsResponse>?
  ...
  final pulumi.Input<List<InMageRcmProtectedDiskDetailsResponse>>?
  protectedDisks;
  ...
  final pulumi.Input<List<UserCreatedResourceTagResponse>>?
  ...
  final pulumi.Input<List<InMageRcmUnProtectedDiskDetailsResponse>>?
  unprotectedDisks;
    ...
    return <String, dynamic>{
      ...
      'agentUpgradeBlockingErrorDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageRcmAgentUpgradeBlockingErrorDetailsResponse>,
      ...
      'discoveredVmDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(discoveredVmDetails, (value) => value.toMap()),
      ...
      'lastAgentUpgradeErrorDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageRcmLastAgentUpgradeErrorDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            lastAgentUpgradeErrorDetails,
            (value) =>
      ...
      'mobilityAgentDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(mobilityAgentDetails, (value) => value.toMap()),
      ...
      'unprotectedDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageRcmUnProtectedDiskDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            unprotectedDisks,
            (value) =>
      ...
      'vmNics':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageRcmNicDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            vmNics,
            (value) =>
  ...
  factory InMageRcmReplicationDetailsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return InMageRcmReplicationDetailsResponse(
      agentUpgradeAttemptToVersion: pulumi.Input.fromValue(
        map['agentUpgradeAttemptToVersion'] as String,
      ),
      agentUpgradeBlockingErrorDetails: (() {
        final guardedValue = map['agentUpgradeBlockingErrorDetails'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                InMageRcmAgentUpgradeBlockingErrorDetailsResponse.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      })(),
      agentUpgradeJobId: pulumi.Input.fromValue(
        map['agentUpgradeJobId'] as String,
      ),
      agentUpgradeState: pulumi.Input.fromValue(
        map['agentUpgradeState'] as String,
      ),
      allocatedMemoryInMB: pulumi.Input.fromValue(
        map['allocatedMemoryInMB'] as double,
      ),
      discoveredVmDetails: (() {
        final guardedValue = map['discoveredVmDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InMageRcmDiscoveredProtectedVmDetailsResponse.fromMap(
      ...
      initialReplicationProcessedBytes: pulumi.Input.fromValue(
        map['initialReplicationProcessedBytes'] as double,
      ),
      initialReplicationProgressHealth: pulumi.Input.fromValue(
        map['initialReplicationProgressHealth'] as String,
      ),
      initialReplicationProgressPercentage: pulumi.Input.fromValue(
        map['initialReplicationProgressPercentage'] as int,
      ),
      initialReplicationTransferredBytes: pulumi.Input.fromValue(
        map['initialReplicationTransferredBytes'] as double,
      ),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      internalIdentifier: pulumi.Input.fromValue(
        map['internalIdentifier'] as String,
      ),
      isAgentRegistrationSuccessfulAfterFailover: pulumi.Input.fromValue(
        map['isAgentRegistrationSuccessfulAfterFailover'] as bool,
      ),
      isLastUpgradeSuccessful: pulumi.Input.fromValue(
        map['isLastUpgradeSuccessful'] as String,
      ),
      lastAgentUpgradeErrorDetails: (() {
        final guardedValue = map['lastAgentUpgradeErrorDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<InMageRcmLastAgentUpgradeErrorDetailsResponse>(
            guardedValue,
            (value) => InMageRcmLastAgentUpgradeErrorDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      lastAgentUpgradeType: pulumi.Input.fromValue(
        map['lastAgentUpgradeType'] as String,
      ),
      ...
      lastRpoCalculatedTime: pulumi.Input.fromValue(
        map['lastRpoCalculatedTime'] as String,
      ),
      lastRpoInSeconds: pulumi.Input.fromValue(
        map['lastRpoInSeconds'] as double,
      ),
      licenseType: (() {
      ...
      mobilityAgentDetails: (() {
        final guardedValue = map['mobilityAgentDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InMageRcmMobilityAgentDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      primaryNicIpAddress: pulumi.Input.fromValue(
        map['primaryNicIpAddress'] as String,
      ),
      processServerId: pulumi.Input.fromValue(map['processServerId'] as String),
      processServerName: pulumi.Input.fromValue(
        map['processServerName'] as String,
      ),
      processorCoreCount: pulumi.Input.fromValue(
        map['processorCoreCount'] as int,
      ),
      protectedDisks: (() {
        final guardedValue = map['protectedDisks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InMageRcmProtectedDiskDetailsResponse>(
            guardedValue,
            (value) => InMageRcmProtectedDiskDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      resyncProcessedBytes: pulumi.Input.fromValue(
        map['resyncProcessedBytes'] as double,
      ),
      resyncProgressHealth: pulumi.Input.fromValue(
        map['resyncProgressHealth'] as String,
      ),
      ...
      resyncTransferredBytes: pulumi.Input.fromValue(
        map['resyncTransferredBytes'] as double,
      ),
      ...
      seedManagedDiskTags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserCreatedResourceTagResponse>(
            guardedValue,
            (value) => UserCreatedResourceTagResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      unprotectedDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InMageRcmUnProtectedDiskDetailsResponse>(
            guardedValue,
            (value) => InMageRcmUnProtectedDiskDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      vmNics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InMageRcmNicDetailsResponse>(
            guardedValue,
            (value) => InMageRcmNicDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
