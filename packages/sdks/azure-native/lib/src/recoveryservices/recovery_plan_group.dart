...
class RecoveryPlanGroup {
  ...
  final pulumi.Input<List<RecoveryPlanProtectedItem>>?
  ...
  factory RecoveryPlanGroup.fromMap(Map<String, dynamic> map) {
    return RecoveryPlanGroup(
      endGroupActions: (() {
        final guardedValue = map['endGroupActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecoveryPlanAction>(
            guardedValue,
            (value) => RecoveryPlanAction.fromMap(
      ...
      replicationProtectedItems: (() {
        final guardedValue = map['replicationProtectedItems'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecoveryPlanProtectedItem>(
            guardedValue,
            (value) => RecoveryPlanProtectedItem.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      startGroupActions: (() {
        final guardedValue = map['startGroupActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecoveryPlanAction>(
            guardedValue,
