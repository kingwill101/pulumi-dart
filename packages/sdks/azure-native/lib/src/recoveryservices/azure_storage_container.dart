...
class AzureStorageContainer {
  ...
  final pulumi.Input<dynamic>? acquireStorageAccountLock;
  ...
  factory AzureStorageContainer.fromMap(Map<String, dynamic> map) {
    return AzureStorageContainer(
      acquireStorageAccountLock: (() { final guardedValue = map['acquireStorageAccountLock']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      storageAccountVersion: (() { final guardedValue = map['storageAccountVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
