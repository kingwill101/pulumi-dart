...
class DPMProtectedItemResponse {
  ...
  final DPMProtectedItemExtendedInfoResponse? extendedInfo;
  ...
  factory DPMProtectedItemResponse.fromMap(Map<String, dynamic> map) {
    return DPMProtectedItemResponse(
      ...
      extendedInfo: map['extendedInfo'] == null ? null : DPMProtectedItemExtendedInfoResponse.fromMap((map['extendedInfo'] as Map).cast<String, dynamic>()),
