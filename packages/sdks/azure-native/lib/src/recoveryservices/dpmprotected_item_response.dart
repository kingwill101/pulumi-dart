...
class DPMProtectedItemResponse {
  ...
  factory DPMProtectedItemResponse.fromMap(Map<String, dynamic> map) {
    return DPMProtectedItemResponse(
      ...
      extendedInfo: (() { final guardedValue = map['extendedInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DPMProtectedItemExtendedInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
