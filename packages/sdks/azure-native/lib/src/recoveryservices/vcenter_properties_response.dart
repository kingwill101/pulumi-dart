...
class VCenterPropertiesResponse {
  ...
  factory VCenterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return VCenterPropertiesResponse(
      discoveryStatus: (() { final guardedValue = map['discoveryStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      fabricArmResourceName: (() { final guardedValue = map['fabricArmResourceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      infrastructureId: (() { final guardedValue = map['infrastructureId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      internalId: (() { final guardedValue = map['internalId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
