...
class GetReplicationNetworkMappingResult {
  ...
  factory GetReplicationNetworkMappingResult.fromMap(Map<String, dynamic> map) {
    return GetReplicationNetworkMappingResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return NetworkMappingPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
