...
class AzureSqlProtectedItemResponse {
  ...
  factory AzureSqlProtectedItemResponse.fromMap(Map<String, dynamic> map) {
    return AzureSqlProtectedItemResponse(
      ...
      extendedInfo: (() { final guardedValue = map['extendedInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureSqlProtectedItemExtendedInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
