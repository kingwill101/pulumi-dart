...
class MigrationItemPropertiesResponse {
  ...
  final pulumi.Input<List<CriticalJobHistoryDetailsResponse>>
  criticalJobHistory;
  ...
  final pulumi.Input<VMwareCbtMigrationDetailsResponse>?
    ...
    return <String, dynamic>{
      ...
      'criticalJobHistory':
          pulumi.Input.mapInputValue<
            List<CriticalJobHistoryDetailsResponse>,
  ...
  factory MigrationItemPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrationItemPropertiesResponse(
      ...
      criticalJobHistory: pulumi.Input.fromValue(
        pulumi.Input.decodeList<CriticalJobHistoryDetailsResponse>(
          map['criticalJobHistory']!,
          (value) => CriticalJobHistoryDetailsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      currentJob: pulumi.Input.fromValue(
        CurrentJobDetailsResponse.fromMap(
          (map['currentJob']! as Map).cast<String, dynamic>(),
        ),
      ),
      eventCorrelationId: pulumi.Input.fromValue(
        map['eventCorrelationId'] as String,
      ),
      ...
      lastMigrationStatus: pulumi.Input.fromValue(
        map['lastMigrationStatus'] as String,
      ),
      lastMigrationTime: pulumi.Input.fromValue(
        map['lastMigrationTime'] as String,
      ),
      lastTestMigrationStatus: pulumi.Input.fromValue(
        map['lastTestMigrationStatus'] as String,
      ),
      lastTestMigrationTime: pulumi.Input.fromValue(
        map['lastTestMigrationTime'] as String,
      ),
      ...
      migrationStateDescription: pulumi.Input.fromValue(
        map['migrationStateDescription'] as String,
      ),
      policyFriendlyName: pulumi.Input.fromValue(
        map['policyFriendlyName'] as String,
      ),
      ...
      providerSpecificDetails: (() {
        ...
        return pulumi.Input.fromValue(
          VMwareCbtMigrationDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      recoveryServicesProviderId: pulumi.Input.fromValue(
        map['recoveryServicesProviderId'] as String,
      ),
      replicationStatus: pulumi.Input.fromValue(
        map['replicationStatus'] as String,
      ),
      testMigrateState: pulumi.Input.fromValue(
        map['testMigrateState'] as String,
      ),
      testMigrateStateDescription: pulumi.Input.fromValue(
        map['testMigrateStateDescription'] as String,
      ),
    );
  }
}
