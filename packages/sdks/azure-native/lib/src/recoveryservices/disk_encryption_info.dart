...
class DiskEncryptionInfo {
  ...
  DiskEncryptionInfo({this.diskEncryptionKeyInfo, this.keyEncryptionKeyInfo});
    ...
    return <String, dynamic>{
      'diskEncryptionKeyInfo':
          ?pulumi.Input.mapOptionalInputValue<
            DiskEncryptionKeyInfo,
            Map<String, dynamic>
          >(diskEncryptionKeyInfo, (value) => value.toMap()),
      'keyEncryptionKeyInfo':
          ?pulumi.Input.mapOptionalInputValue<
            KeyEncryptionKeyInfo,
            Map<String, dynamic>
          >(keyEncryptionKeyInfo, (value) => value.toMap()),
    };
  }
  ...
  factory DiskEncryptionInfo.fromMap(Map<String, dynamic> map) {
    return DiskEncryptionInfo(
      diskEncryptionKeyInfo: (() {
        final guardedValue = map['diskEncryptionKeyInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiskEncryptionKeyInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      keyEncryptionKeyInfo: (() {
        final guardedValue = map['keyEncryptionKeyInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KeyEncryptionKeyInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
