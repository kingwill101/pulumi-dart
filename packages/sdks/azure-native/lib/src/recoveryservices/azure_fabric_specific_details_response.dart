...
class AzureFabricSpecificDetailsResponse {
  ...
  final pulumi.Input<List<A2AExtendedLocationDetailsResponse>>?
  extendedLocations;
  ...
  final pulumi.Input<List<A2AFabricSpecificLocationDetailsResponse>>?
  locationDetails;
    ...
    return <String, dynamic>{
      ...
      'extendedLocations':
          ?pulumi.Input.mapOptionalInputValue<
            List<A2AExtendedLocationDetailsResponse>,
      ...
      'locationDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<A2AFabricSpecificLocationDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            locationDetails,
            (value) =>
  ...
  factory AzureFabricSpecificDetailsResponse.fromMap(Map<String, dynamic> map) {
    return AzureFabricSpecificDetailsResponse(
      containerIds: (() {
        final guardedValue = map['containerIds'];
      ...
      extendedLocations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AExtendedLocationDetailsResponse>(
            guardedValue,
            (value) => A2AExtendedLocationDetailsResponse.fromMap(
      ...
      locationDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AFabricSpecificLocationDetailsResponse>(
            guardedValue,
            (value) => A2AFabricSpecificLocationDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      zones: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AZoneDetailsResponse>(
            guardedValue,
            (value) => A2AZoneDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
