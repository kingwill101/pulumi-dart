...
class HyperVSiteDetailsResponse {
  ...
  factory HyperVSiteDetailsResponse.fromMap(Map<String, dynamic> map) {
    return HyperVSiteDetailsResponse(
      hyperVHosts: (() { final guardedValue = map['hyperVHosts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HyperVHostDetailsResponse>(guardedValue, (value) => HyperVHostDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
