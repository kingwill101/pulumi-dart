...
class ProtectionContainerMappingPropertiesResponse {
  ...
  factory ProtectionContainerMappingPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ProtectionContainerMappingPropertiesResponse(
      ...
      providerSpecificDetails: (() { final guardedValue = map['providerSpecificDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(A2AProtectionContainerMappingDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
