...
class ProtectionContainerMappingPropertiesResponse {
  ...
  final pulumi.Input<A2AProtectionContainerMappingDetailsResponse>?
  ...
  factory ProtectionContainerMappingPropertiesResponse.fromMap(
    ...
    return ProtectionContainerMappingPropertiesResponse(
      ...
      providerSpecificDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          A2AProtectionContainerMappingDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sourceFabricFriendlyName: (() {
        final guardedValue = map['sourceFabricFriendlyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceProtectionContainerFriendlyName: (() {
        final guardedValue = map['sourceProtectionContainerFriendlyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      state: (() {
      ...
      targetFabricFriendlyName: (() {
        final guardedValue = map['targetFabricFriendlyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetProtectionContainerFriendlyName: (() {
        final guardedValue = map['targetProtectionContainerFriendlyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetProtectionContainerId: (() {
        final guardedValue = map['targetProtectionContainerId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
