...
class SharedDiskReplicationItemPropertiesResponse {
  ...
  final pulumi.Input<A2ASharedDiskReplicationDetailsResponse>?
    ...
    return <String, dynamic>{
      ...
      'sharedDiskProviderSpecificDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sharedDiskProviderSpecificDetails, (value) => value.toMap()),
      'testFailoverState': ?testFailoverState,
    };
  }

  factory SharedDiskReplicationItemPropertiesResponse.fromMap(
    ...
    return SharedDiskReplicationItemPropertiesResponse(
      ...
      sharedDiskProviderSpecificDetails: (() {
        final guardedValue = map['sharedDiskProviderSpecificDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          A2ASharedDiskReplicationDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
