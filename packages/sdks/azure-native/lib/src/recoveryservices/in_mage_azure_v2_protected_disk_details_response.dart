...
class InMageAzureV2ProtectedDiskDetailsResponse {
  ...
  factory InMageAzureV2ProtectedDiskDetailsResponse.fromMap(Map<String, dynamic> map) {
    return InMageAzureV2ProtectedDiskDetailsResponse(
      ...
      fileSystemCapacityInBytes: (() { final guardedValue = map['fileSystemCapacityInBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      psDataInMegaBytes: (() { final guardedValue = map['psDataInMegaBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      resyncDurationInSeconds: (() { final guardedValue = map['resyncDurationInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      resyncLast15MinutesTransferredBytes: (() { final guardedValue = map['resyncLast15MinutesTransferredBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      resyncProcessedBytes: (() { final guardedValue = map['resyncProcessedBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      resyncTotalTransferredBytes: (() { final guardedValue = map['resyncTotalTransferredBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      secondsToTakeSwitchProvider: (() { final guardedValue = map['secondsToTakeSwitchProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      sourceDataInMegaBytes: (() { final guardedValue = map['sourceDataInMegaBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      targetDataInMegaBytes: (() { final guardedValue = map['targetDataInMegaBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
    );
  }
}
