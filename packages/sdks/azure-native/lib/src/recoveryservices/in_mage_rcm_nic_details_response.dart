...
class InMageRcmNicDetailsResponse {
  ...
  factory InMageRcmNicDetailsResponse.fromMap(Map<String, dynamic> map) {
    return InMageRcmNicDetailsResponse(
      ...
      isSelectedForFailover: (() { final guardedValue = map['isSelectedForFailover']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      sourceSubnetName: pulumi.Input.fromValue(map['sourceSubnetName'] as String),
