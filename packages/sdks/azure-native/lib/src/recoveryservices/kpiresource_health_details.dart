...
class KPIResourceHealthDetails {
  ...
  final pulumi.Input<dynamic>? resourceHealthStatus;
  ...
  factory KPIResourceHealthDetails.fromMap(Map<String, dynamic> map) {
    return KPIResourceHealthDetails(
      resourceHealthStatus: (() { final guardedValue = map['resourceHealthStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
