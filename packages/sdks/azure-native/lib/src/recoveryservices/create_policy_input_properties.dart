...
class CreatePolicyInputProperties {
  ...
  final pulumi.Input<A2ACrossClusterMigrationPolicyCreationInput>?
  providerSpecificInput;

  /// Creates a new [CreatePolicyInputProperties].
  /// [providerSpecificInput] The ReplicationProviderSettings.
  CreatePolicyInputProperties({this.providerSpecificInput});
    ...
    return <String, dynamic>{
      'providerSpecificInput':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(providerSpecificInput, (value) => value.toMap()),
    };
  }
    ...
    return CreatePolicyInputProperties(
      providerSpecificInput: (() {
        ...
        return pulumi.Input.fromValue(
          A2ACrossClusterMigrationPolicyCreationInput.fromMap(
