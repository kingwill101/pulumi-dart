...
class AzureToAzureVmSyncedConfigDetailsResponse {
  ...
  AzureToAzureVmSyncedConfigDetailsResponse({this.inputEndpoints, this.tags});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inputEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<InputEndpointResponse>,
  ...
  factory AzureToAzureVmSyncedConfigDetailsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return AzureToAzureVmSyncedConfigDetailsResponse(
      inputEndpoints: (() {
        final guardedValue = map['inputEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InputEndpointResponse>(
            guardedValue,
            (value) => InputEndpointResponse.fromMap(
