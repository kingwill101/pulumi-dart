...
class ReplicationProtectionClusterPropertiesResponse {
  ...
  final pulumi.Input<List<RegisteredClusterNodesResponse>>?
  ...
  final pulumi.Input<A2AReplicationProtectionClusterDetailsResponse>?
  ...
  final pulumi.Input<SharedDiskReplicationItemPropertiesResponse>?
    ...
    return <String, dynamic>{
      ...
      'clusterRegisteredNodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<RegisteredClusterNodesResponse>,
  ...
  factory ReplicationProtectionClusterPropertiesResponse.fromMap(
    ...
    return ReplicationProtectionClusterPropertiesResponse(
      ...
      clusterRegisteredNodes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegisteredClusterNodesResponse>(
            guardedValue,
            (value) => RegisteredClusterNodesResponse.fromMap(
      ...
      providerSpecificDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          A2AReplicationProtectionClusterDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sharedDiskProperties: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SharedDiskReplicationItemPropertiesResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
