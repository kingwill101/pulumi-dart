...
class HyperVReplicaAzurePolicyInput {
  ...
  factory HyperVReplicaAzurePolicyInput.fromMap(Map<String, dynamic> map) {
    return HyperVReplicaAzurePolicyInput(
      ...
      recoveryPointHistoryDuration: (() { final guardedValue = map['recoveryPointHistoryDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
