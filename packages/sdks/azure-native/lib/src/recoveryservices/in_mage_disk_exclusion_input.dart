...
class InMageDiskExclusionInput {
  ...
  factory InMageDiskExclusionInput.fromMap(Map<String, dynamic> map) {
    return InMageDiskExclusionInput(
      diskSignatureOptions: (() { final guardedValue = map['diskSignatureOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InMageDiskSignatureExclusionOptions>(guardedValue, (value) => InMageDiskSignatureExclusionOptions.fromMap((value as Map).cast<String, dynamic>()))); })(),
      volumeOptions: (() { final guardedValue = map['volumeOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InMageVolumeExclusionOptions>(guardedValue, (value) => InMageVolumeExclusionOptions.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
