...
class InMageDiskExclusionInput {
  ...
  final pulumi.Input<List<InMageDiskSignatureExclusionOptions>>?
  ...
  InMageDiskExclusionInput({this.diskSignatureOptions, this.volumeOptions});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'diskSignatureOptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageDiskSignatureExclusionOptions>,
      ...
      'volumeOptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageVolumeExclusionOptions>,
            List<Map<String, dynamic>>
          >(
            volumeOptions,
            (value) =>
  ...
  factory InMageDiskExclusionInput.fromMap(Map<String, dynamic> map) {
    return InMageDiskExclusionInput(
      diskSignatureOptions: (() {
        final guardedValue = map['diskSignatureOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InMageDiskSignatureExclusionOptions>(
            guardedValue,
            (value) => InMageDiskSignatureExclusionOptions.fromMap(
      ...
      volumeOptions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InMageVolumeExclusionOptions>(
            guardedValue,
            (value) => InMageVolumeExclusionOptions.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
