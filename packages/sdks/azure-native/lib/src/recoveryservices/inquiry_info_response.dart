...
class InquiryInfoResponse {
  ...
  InquiryInfoResponse({this.errorDetail, this.inquiryDetails, this.status});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inquiryDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadInquiryDetailsResponse>,
  ...
  factory InquiryInfoResponse.fromMap(Map<String, dynamic> map) {
    return InquiryInfoResponse(
      ...
      inquiryDetails: (() {
        final guardedValue = map['inquiryDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkloadInquiryDetailsResponse>(
            guardedValue,
            (value) => WorkloadInquiryDetailsResponse.fromMap(
