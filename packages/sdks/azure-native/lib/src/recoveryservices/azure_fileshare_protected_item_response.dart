...
class AzureFileshareProtectedItemResponse {
  ...
  final pulumi.Input<AzureFileshareProtectedItemExtendedInfoResponse>?
  extendedInfo;
  ...
  factory AzureFileshareProtectedItemResponse.fromMap(
    ...
    return AzureFileshareProtectedItemResponse(
      ...
      extendedInfo: (() {
        ...
        return pulumi.Input.fromValue(
          AzureFileshareProtectedItemExtendedInfoResponse.fromMap(
