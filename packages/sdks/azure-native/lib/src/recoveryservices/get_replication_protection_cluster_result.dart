...
class GetReplicationProtectionClusterResult {
  ...
  factory GetReplicationProtectionClusterResult.fromMap(Map<String, dynamic> map) {
    return GetReplicationProtectionClusterResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return ReplicationProtectionClusterPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
