...
class InMageProtectedDiskDetailsResponse {
  ...
  factory InMageProtectedDiskDetailsResponse.fromMap(Map<String, dynamic> map) {
    return InMageProtectedDiskDetailsResponse(
      ...
      psDataInMB: (() { final guardedValue = map['psDataInMB']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      sourceDataInMB: (() { final guardedValue = map['sourceDataInMB']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      targetDataInMB: (() { final guardedValue = map['targetDataInMB']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
