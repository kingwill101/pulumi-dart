...
class GenericProtectedItemResponse {
  ...
  const GenericProtectedItemResponse({
  ...
  factory GenericProtectedItemResponse.fromMap(Map<String, dynamic> map) {
    return GenericProtectedItemResponse(
      ...
      protectedItemId: (() { final guardedValue = map['protectedItemId']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
