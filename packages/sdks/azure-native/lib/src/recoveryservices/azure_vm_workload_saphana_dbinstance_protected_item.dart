...
class AzureVmWorkloadSAPHanaDBInstanceProtectedItem {
  ...
  /// Creates a new [AzureVmWorkloadSAPHanaDBInstanceProtectedItem].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kpisHealths':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, KPIResourceHealthDetails>,
  ...
  factory AzureVmWorkloadSAPHanaDBInstanceProtectedItem.fromMap(
    Map<String, dynamic> map,
  ) {
    return AzureVmWorkloadSAPHanaDBInstanceProtectedItem(
      backupSetName: (() {
      ...
      extendedInfo: (() {
        ...
        return pulumi.Input.fromValue(
          AzureVmWorkloadProtectedItemExtendedInfo.fromMap(
      ...
      kpisHealths: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<KPIResourceHealthDetails>(
            guardedValue,
            (value) => KPIResourceHealthDetails.fromMap(
      ...
      nodesList: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DistributedNodesInfo>(
            guardedValue,
            (value) => DistributedNodesInfo.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
