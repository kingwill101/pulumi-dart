...
class AzureVmWorkloadSAPHanaDBInstanceProtectedItem {
  ...
  final pulumi.Input<dynamic>? lastBackupStatus;
  ...
  final pulumi.Input<dynamic>? protectedItemHealthStatus;
  /// backup item type.
  ...
  factory AzureVmWorkloadSAPHanaDBInstanceProtectedItem.fromMap(Map<String, dynamic> map) {
    return AzureVmWorkloadSAPHanaDBInstanceProtectedItem(
      ...
      lastBackupStatus: (() { final guardedValue = map['lastBackupStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      protectedItemHealthStatus: (() { final guardedValue = map['protectedItemHealthStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
