...
class InMageRcmFailbackReplicationDetailsResponse {
  ...
  final pulumi.Input<InMageRcmFailbackDiscoveredProtectedVmDetailsResponse>?
  discoveredVmDetails;
  ...
  final pulumi.Input<InMageRcmFailbackMobilityAgentDetailsResponse>?
  ...
  final pulumi.Input<List<InMageRcmFailbackProtectedDiskDetailsResponse>>?
  protectedDisks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vmNics':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageRcmFailbackNicDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            vmNics,
            (value) =>
  ...
  factory InMageRcmFailbackReplicationDetailsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return InMageRcmFailbackReplicationDetailsResponse(
      azureVirtualMachineId: pulumi.Input.fromValue(
        map['azureVirtualMachineId'] as String,
      ),
      discoveredVmDetails: (() {
        final guardedValue = map['discoveredVmDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InMageRcmFailbackDiscoveredProtectedVmDetailsResponse.fromMap(
      ...
      lastPlannedFailoverStartTime: pulumi.Input.fromValue(
        map['lastPlannedFailoverStartTime'] as String,
      ),
      lastPlannedFailoverStatus: pulumi.Input.fromValue(
        map['lastPlannedFailoverStatus'] as String,
      ),
      lastUsedPolicyFriendlyName: pulumi.Input.fromValue(
        map['lastUsedPolicyFriendlyName'] as String,
      ),
      lastUsedPolicyId: pulumi.Input.fromValue(
        map['lastUsedPolicyId'] as String,
      ),
      ...
      mobilityAgentDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InMageRcmFailbackMobilityAgentDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      protectedDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<InMageRcmFailbackProtectedDiskDetailsResponse>(
            guardedValue,
            (value) => InMageRcmFailbackProtectedDiskDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      reprotectAgentId: pulumi.Input.fromValue(
        map['reprotectAgentId'] as String,
      ),
      reprotectAgentName: pulumi.Input.fromValue(
        map['reprotectAgentName'] as String,
      ),
      ...
      targetDataStoreName: pulumi.Input.fromValue(
        map['targetDataStoreName'] as String,
      ),
      ...
      vmNics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InMageRcmFailbackNicDetailsResponse>(
            guardedValue,
            (value) => InMageRcmFailbackNicDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
