...
class ApplianceMonitoringDetailsResponse {
  ...
  final pulumi.Input<List<DataStoreUtilizationDetailsResponse>>
  datastoreSnapshot;
    ...
    return <String, dynamic>{
      'cpuDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(cpuDetails, (value) => value.toMap()),
      'datastoreSnapshot':
          pulumi.Input.mapInputValue<
            List<DataStoreUtilizationDetailsResponse>,
      ...
      'disksReplicationDetails':
          pulumi.Input.mapInputValue<
            ApplianceResourceDetailsResponse,
            Map<String, dynamic>
          >(disksReplicationDetails, (value) => value.toMap()),
      'esxiNfcBuffer':
          pulumi.Input.mapInputValue<
            ApplianceResourceDetailsResponse,
            Map<String, dynamic>
          >(esxiNfcBuffer, (value) => value.toMap()),
      'networkBandwidth':
          pulumi.Input.mapInputValue<
            ApplianceResourceDetailsResponse,
            Map<String, dynamic>
          >(networkBandwidth, (value) => value.toMap()),
      'ramDetails':
          pulumi.Input.mapInputValue<
            ApplianceResourceDetailsResponse,
            Map<String, dynamic>
          >(ramDetails, (value) => value.toMap()),
    };
  }

  factory ApplianceMonitoringDetailsResponse.fromMap(Map<String, dynamic> map) {
    return ApplianceMonitoringDetailsResponse(
      cpuDetails: pulumi.Input.fromValue(
        ApplianceResourceDetailsResponse.fromMap(
          (map['cpuDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      datastoreSnapshot: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DataStoreUtilizationDetailsResponse>(
          map['datastoreSnapshot']!,
          (value) => DataStoreUtilizationDetailsResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      disksReplicationDetails: pulumi.Input.fromValue(
        ApplianceResourceDetailsResponse.fromMap(
          (map['disksReplicationDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      esxiNfcBuffer: pulumi.Input.fromValue(
        ApplianceResourceDetailsResponse.fromMap(
          (map['esxiNfcBuffer']! as Map).cast<String, dynamic>(),
        ),
      ),
      networkBandwidth: pulumi.Input.fromValue(
        ApplianceResourceDetailsResponse.fromMap(
          (map['networkBandwidth']! as Map).cast<String, dynamic>(),
        ),
      ),
      ramDetails: pulumi.Input.fromValue(
        ApplianceResourceDetailsResponse.fromMap(
          (map['ramDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
