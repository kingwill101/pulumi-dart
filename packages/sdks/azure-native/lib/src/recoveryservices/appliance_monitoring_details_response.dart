...
class ApplianceMonitoringDetailsResponse {
  ...
  factory ApplianceMonitoringDetailsResponse.fromMap(Map<String, dynamic> map) {
    return ApplianceMonitoringDetailsResponse(
      cpuDetails: (ApplianceResourceDetailsResponse.fromMap((map['cpuDetails'] as Map).cast<String, dynamic>())).input(),
      datastoreSnapshot: (pulumi.Input.decodeList<DataStoreUtilizationDetailsResponse>(map['datastoreSnapshot'], (value) => DataStoreUtilizationDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      disksReplicationDetails: (ApplianceResourceDetailsResponse.fromMap((map['disksReplicationDetails'] as Map).cast<String, dynamic>())).input(),
      esxiNfcBuffer: (ApplianceResourceDetailsResponse.fromMap((map['esxiNfcBuffer'] as Map).cast<String, dynamic>())).input(),
      networkBandwidth: (ApplianceResourceDetailsResponse.fromMap((map['networkBandwidth'] as Map).cast<String, dynamic>())).input(),
      ramDetails: (ApplianceResourceDetailsResponse.fromMap((map['ramDetails'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
