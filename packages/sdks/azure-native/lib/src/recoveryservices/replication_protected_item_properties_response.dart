...
class ReplicationProtectedItemPropertiesResponse {
  ...
  factory ReplicationProtectedItemPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationProtectedItemPropertiesResponse(
      ...
      eventCorrelationId: (() { final guardedValue = map['eventCorrelationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      failoverHealth: (() { final guardedValue = map['failoverHealth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      recoveryServicesProviderId: (() { final guardedValue = map['recoveryServicesProviderId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      switchProviderState: (() { final guardedValue = map['switchProviderState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      switchProviderStateDescription: (() { final guardedValue = map['switchProviderStateDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
