...
class AzureRecoveryServiceVaultProtectionIntentResponse {
  ...
  /// Creates a new [AzureRecoveryServiceVaultProtectionIntentResponse].
  ...
  factory AzureRecoveryServiceVaultProtectionIntentResponse.fromMap(Map<String, dynamic> map) {
    return AzureRecoveryServiceVaultProtectionIntentResponse(
