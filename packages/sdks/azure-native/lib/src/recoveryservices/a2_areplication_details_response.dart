...
class A2AReplicationDetailsResponse {
  ...
  final pulumi.Input<List<A2AProtectedManagedDiskDetailsResponse>>?
  ...
  final pulumi.Input<AzureToAzureVmSyncedConfigDetailsResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'protectedDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<A2AProtectedDiskDetailsResponse>,
      ...
      'unprotectedDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<A2AUnprotectedDiskDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            unprotectedDisks,
            (value) =>
      ...
      'vmSyncedConfigDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(vmSyncedConfigDetails, (value) => value.toMap()),
    };
  }

  factory A2AReplicationDetailsResponse.fromMap(Map<String, dynamic> map) {
    return A2AReplicationDetailsResponse(
      agentCertificateExpiryDate: pulumi.Input.fromValue(
        map['agentCertificateExpiryDate'] as String,
      ),
      agentExpiryDate: (() {
      ...
      churnOptionSelected: pulumi.Input.fromValue(
        map['churnOptionSelected'] as String,
      ),
      fabricObjectId: (() {
      ...
      initialPrimaryFabricLocation: pulumi.Input.fromValue(
        map['initialPrimaryFabricLocation'] as String,
      ),
      initialPrimaryZone: pulumi.Input.fromValue(
        map['initialPrimaryZone'] as String,
      ),
      initialRecoveryExtendedLocation: (() {
      ...
      initialRecoveryFabricLocation: pulumi.Input.fromValue(
        map['initialRecoveryFabricLocation'] as String,
      ),
      initialRecoveryZone: pulumi.Input.fromValue(
        map['initialRecoveryZone'] as String,
      ),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      isClusterInfraReady: (() {
        final guardedValue = map['isClusterInfraReady'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isReplicationAgentCertificateUpdateRequired: (() {
        final guardedValue = map['isReplicationAgentCertificateUpdateRequired'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isReplicationAgentUpdateRequired: (() {
        final guardedValue = map['isReplicationAgentUpdateRequired'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      lastHeartbeat: (() {
      ...
      lifecycleId: (() {
        final guardedValue = map['lifecycleId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      managementId: (() {
        final guardedValue = map['managementId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      monitoringJobType: (() {
        final guardedValue = map['monitoringJobType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      monitoringPercentageCompletion: (() {
        final guardedValue = map['monitoringPercentageCompletion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      multiVmGroupCreateOption: (() {
        final guardedValue = map['multiVmGroupCreateOption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multiVmGroupId: (() {
      ...
      primaryAvailabilityZone: (() {
        final guardedValue = map['primaryAvailabilityZone'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      primaryExtendedLocation: (() {
      ...
      protectedDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AProtectedDiskDetailsResponse>(
            guardedValue,
            (value) => A2AProtectedDiskDetailsResponse.fromMap(
      ...
      protectedManagedDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AProtectedManagedDiskDetailsResponse>(
            guardedValue,
            (value) => A2AProtectedManagedDiskDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      recoveryAvailabilitySet: (() {
        final guardedValue = map['recoveryAvailabilitySet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      recoveryAzureGeneration: pulumi.Input.fromValue(
        map['recoveryAzureGeneration'] as String,
      ),
      ...
      recoveryCloudService: (() {
        final guardedValue = map['recoveryCloudService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      recoveryExtendedLocation: (() {
      ...
      recoveryFabricObjectId: (() {
        final guardedValue = map['recoveryFabricObjectId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      testFailoverRecoveryFabricObjectId: (() {
        final guardedValue = map['testFailoverRecoveryFabricObjectId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tfoAzureVMName: (() {
        final guardedValue = map['tfoAzureVMName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      unprotectedDisks: (() {
        final guardedValue = map['unprotectedDisks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2AUnprotectedDiskDetailsResponse>(
            guardedValue,
            (value) => A2AUnprotectedDiskDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      vmEncryptionType: pulumi.Input.fromValue(
        map['vmEncryptionType'] as String,
      ),
      vmNics: (() {
      ...
      vmSyncedConfigDetails: (() {
        final guardedValue = map['vmSyncedConfigDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureToAzureVmSyncedConfigDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
