    ...
    return <String, dynamic>{
      ...
      'marsAgentVersionDetails':
          ?pulumi.Input.mapOptionalInputValue<
            VersionDetailsResponse,
            Map<String, dynamic>
          >(marsAgentVersionDetails, (value) => value.toMap()),
      'name': ?name,
      'osType': ?osType,
      'osVersion': ?osVersion,
      'retentionVolumes':
  ...
  factory MasterTargetServerResponse.fromMap(Map<String, dynamic> map) {
    return MasterTargetServerResponse(
      ...
      dataStores: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataStoreResponse>(
            guardedValue,
            (value) => DataStoreResponse.fromMap(
      ...
      marsAgentExpiryDate: (() {
        final guardedValue = map['marsAgentExpiryDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      marsAgentVersion: (() {
        final guardedValue = map['marsAgentVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      marsAgentVersionDetails: (() {
        final guardedValue = map['marsAgentVersionDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VersionDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      retentionVolumes: (() {
        final guardedValue = map['retentionVolumes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RetentionVolumeResponse>(
            guardedValue,
            (value) => RetentionVolumeResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
