...
class AzureIaaSComputeVMContainerResponse {
  ...
  /// Creates a new [AzureIaaSComputeVMContainerResponse].
  ...
  const AzureIaaSComputeVMContainerResponse({
  ...
  factory AzureIaaSComputeVMContainerResponse.fromMap(Map<String, dynamic> map) {
    return AzureIaaSComputeVMContainerResponse(
