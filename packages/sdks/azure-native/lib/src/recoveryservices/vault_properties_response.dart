...
class VaultPropertiesResponse {
  ...
  final pulumi.Input<List<PrivateEndpointConnectionVaultPropertiesResponse>>
  ...
  final pulumi.Input<VaultPropertiesResponseRedundancySettings>?
  redundancySettings;
    ...
    return <String, dynamic>{
      ...
      'moveDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(moveDetails, (value) => value.toMap()),
      'moveState': moveState,
      'privateEndpointConnections':
          pulumi.Input.mapInputValue<
            List<PrivateEndpointConnectionVaultPropertiesResponse>,
      ...
      'upgradeDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(upgradeDetails, (value) => value.toMap()),
    };
  }

  factory VaultPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return VaultPropertiesResponse(
      backupStorageVersion: pulumi.Input.fromValue(
        map['backupStorageVersion'] as String,
      ),
      ...
      encryption: (() {
        ...
        return pulumi.Input.fromValue(
          VaultPropertiesResponseEncryption.fromMap(
      ...
      moveDetails: (() {
        final guardedValue = map['moveDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VaultPropertiesResponseMoveDetails.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      privateEndpointConnections: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<PrivateEndpointConnectionVaultPropertiesResponse>(
          map['privateEndpointConnections']!,
          (value) => PrivateEndpointConnectionVaultPropertiesResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      privateEndpointStateForBackup: pulumi.Input.fromValue(
        map['privateEndpointStateForBackup'] as String,
      ),
      privateEndpointStateForSiteRecovery: pulumi.Input.fromValue(
        map['privateEndpointStateForSiteRecovery'] as String,
      ),
      ...
      redundancySettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VaultPropertiesResponseRedundancySettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      restoreSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RestoreSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      upgradeDetails: (() {
        final guardedValue = map['upgradeDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UpgradeDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
