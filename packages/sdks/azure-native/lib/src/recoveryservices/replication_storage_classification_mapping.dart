...
/// }
///
/// resource "azure-native_recoveryservices_replicationstorageclassificationmapping" "replicationStorageClassificationMapping" {
...
class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [ReplicationStorageClassificationMapping] resource.
  ReplicationStorageClassificationMapping.reference(String urn)
    : super(
        'azure-native:recoveryservices:ReplicationStorageClassificationMapping',
