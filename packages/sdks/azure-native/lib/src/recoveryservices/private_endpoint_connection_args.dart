...
class PrivateEndpointConnectionArgs {
  ...
  final pulumi.Input<PrivateEndpointConnection?>? properties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'properties': ?pulumi.Input.mapOptionalInputValue<PrivateEndpointConnection, Map<String, dynamic>>(properties, (value) => value.toMap()),
  ...
  factory PrivateEndpointConnectionArgs.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointConnectionArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PrivateEndpointConnection.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
