...
class A2AEnableProtectionInput {
  ...
  factory A2AEnableProtectionInput.fromMap(Map<String, dynamic> map) {
    return A2AEnableProtectionInput(
      ...
      recoveryAzureNetworkId: (() { final guardedValue = map['recoveryAzureNetworkId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      recoveryCloudServiceId: (() { final guardedValue = map['recoveryCloudServiceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      vmDisks: (() { final guardedValue = map['vmDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<A2AVmDiskInputDetails>(guardedValue, (value) => A2AVmDiskInputDetails.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vmManagedDisks: (() { final guardedValue = map['vmManagedDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<A2AVmManagedDiskInputDetails>(guardedValue, (value) => A2AVmManagedDiskInputDetails.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
