...
class OSDetailsResponse {
  ...
  factory OSDetailsResponse.fromMap(Map<String, dynamic> map) {
    return OSDetailsResponse(
      oSMajorVersion: (() { final guardedValue = map['oSMajorVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oSMinorVersion: (() { final guardedValue = map['oSMinorVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      osEdition: (() { final guardedValue = map['osEdition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
