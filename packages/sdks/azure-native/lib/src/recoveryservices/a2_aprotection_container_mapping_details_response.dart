...
class A2AProtectionContainerMappingDetailsResponse {
  ...
  factory A2AProtectionContainerMappingDetailsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return A2AProtectionContainerMappingDetailsResponse(
      agentAutoUpdateStatus: (() {
        final guardedValue = map['agentAutoUpdateStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      automationAccountArmId: (() {
        final guardedValue = map['automationAccountArmId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      automationAccountAuthenticationType: (() {
        final guardedValue = map['automationAccountAuthenticationType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      jobScheduleName: (() {
        final guardedValue = map['jobScheduleName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      scheduleName: (() {
