...
class InMageReplicationDetailsResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'protectedDisks':
          ?pulumi.Input.mapOptionalInputValue<
            List<InMageProtectedDiskDetailsResponse>,
  ...
  factory InMageReplicationDetailsResponse.fromMap(Map<String, dynamic> map) {
    return InMageReplicationDetailsResponse(
      activeSiteType: (() {
        final guardedValue = map['activeSiteType'];
      ...
      agentDetails: (() {
        ...
        return pulumi.Input.fromValue(
          InMageAgentDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      azureStorageAccountId: (() {
        final guardedValue = map['azureStorageAccountId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      consistencyPoints: (() {
        final guardedValue = map['consistencyPoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      protectedDisks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InMageProtectedDiskDetailsResponse>(
            guardedValue,
            (value) => InMageProtectedDiskDetailsResponse.fromMap(
      ...
      rebootAfterUpdateStatus: (() {
        final guardedValue = map['rebootAfterUpdateStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      replicaId: (() {
      ...
      retentionWindowEnd: (() {
        final guardedValue = map['retentionWindowEnd'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      retentionWindowStart: (() {
        final guardedValue = map['retentionWindowStart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rpoInSeconds: (() {
