...
class VMwareDetailsResponse {
  ...
  factory VMwareDetailsResponse.fromMap(Map<String, dynamic> map) {
    return VMwareDetailsResponse(
      agentCount: (() { final guardedValue = map['agentCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      databaseServerLoad: (() { final guardedValue = map['databaseServerLoad']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      databaseServerLoadStatus: (() { final guardedValue = map['databaseServerLoadStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      masterTargetServers: (() { final guardedValue = map['masterTargetServers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MasterTargetServerResponse>(guardedValue, (value) => MasterTargetServerResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      processServerCount: (() { final guardedValue = map['processServerCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      processServers: (() { final guardedValue = map['processServers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProcessServerResponse>(guardedValue, (value) => ProcessServerResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      protectedServers: (() { final guardedValue = map['protectedServers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      psTemplateVersion: (() { final guardedValue = map['psTemplateVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
