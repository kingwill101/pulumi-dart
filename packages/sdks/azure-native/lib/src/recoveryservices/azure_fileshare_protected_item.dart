...
class AzureFileshareProtectedItem {
  ...
  final AzureFileshareProtectedItemExtendedInfo? extendedInfo;
  ...
  factory AzureFileshareProtectedItem.fromMap(Map<String, dynamic> map) {
    return AzureFileshareProtectedItem(
      ...
      extendedInfo: map['extendedInfo'] == null ? null : AzureFileshareProtectedItemExtendedInfo.fromMap((map['extendedInfo'] as Map).cast<String, dynamic>()),
