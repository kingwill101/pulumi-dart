...
class MabFileFolderProtectedItemResponse {
  ...
  final pulumi.Input<MabFileFolderProtectedItemExtendedInfoResponse>?
  extendedInfo;
  ...
  factory MabFileFolderProtectedItemResponse.fromMap(Map<String, dynamic> map) {
    return MabFileFolderProtectedItemResponse(
      ...
      deferredDeleteSyncTimeInUTC: (() {
        final guardedValue = map['deferredDeleteSyncTimeInUTC'];
        if (guardedValue == null) return null;
      ...
      extendedInfo: (() {
        ...
        return pulumi.Input.fromValue(
          MabFileFolderProtectedItemExtendedInfoResponse.fromMap(
