...
class RecoveryPlanPropertiesResponse {
  ...
  final pulumi.Input<List<RecoveryPlanA2ADetailsResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'groups':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecoveryPlanGroupResponse>,
      ...
      'providerSpecificDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecoveryPlanA2ADetailsResponse>,
            List<Map<String, dynamic>>
          >(
            providerSpecificDetails,
            (value) =>
  ...
  factory RecoveryPlanPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RecoveryPlanPropertiesResponse(
      ...
      currentScenarioStatus: (() {
        final guardedValue = map['currentScenarioStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      currentScenarioStatusDescription: (() {
        final guardedValue = map['currentScenarioStatusDescription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      groups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecoveryPlanGroupResponse>(
            guardedValue,
            (value) => RecoveryPlanGroupResponse.fromMap(
      ...
      lastPlannedFailoverTime: (() {
        final guardedValue = map['lastPlannedFailoverTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastTestFailoverTime: (() {
        final guardedValue = map['lastTestFailoverTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastUnplannedFailoverTime: (() {
        final guardedValue = map['lastUnplannedFailoverTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      primaryFabricId: (() {
        final guardedValue = map['primaryFabricId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      providerSpecificDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RecoveryPlanA2ADetailsResponse>(
            guardedValue,
            (value) => RecoveryPlanA2ADetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      replicationProviders: (() {
        final guardedValue = map['replicationProviders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
