...
class VMNicDetailsResponse {
  ...
  factory VMNicDetailsResponse.fromMap(Map<String, dynamic> map) {
    return VMNicDetailsResponse(
      enableAcceleratedNetworkingOnRecovery: (() {
        final guardedValue = map['enableAcceleratedNetworkingOnRecovery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableAcceleratedNetworkingOnTfo: (() {
        final guardedValue = map['enableAcceleratedNetworkingOnTfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ipConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IPConfigDetailsResponse>(
            guardedValue,
            (value) => IPConfigDetailsResponse.fromMap(
      ...
      recoveryNetworkSecurityGroupId: (() {
        final guardedValue = map['recoveryNetworkSecurityGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      recoveryNicName: (() {
        final guardedValue = map['recoveryNicName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      recoveryNicResourceGroupName: (() {
        final guardedValue = map['recoveryNicResourceGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      recoveryVMNetworkId: (() {
        final guardedValue = map['recoveryVMNetworkId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      replicaNicId: (() {
        final guardedValue = map['replicaNicId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reuseExistingNic: (() {
        final guardedValue = map['reuseExistingNic'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      selectionType: (() {
        final guardedValue = map['selectionType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceNicArmId: (() {
        final guardedValue = map['sourceNicArmId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetNicName: (() {
      ...
      tfoNetworkSecurityGroupId: (() {
        final guardedValue = map['tfoNetworkSecurityGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tfoRecoveryNicName: (() {
        final guardedValue = map['tfoRecoveryNicName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tfoRecoveryNicResourceGroupName: (() {
        final guardedValue = map['tfoRecoveryNicResourceGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tfoReuseExistingNic: (() {
        final guardedValue = map['tfoReuseExistingNic'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      tfoVMNetworkId: (() {
        final guardedValue = map['tfoVMNetworkId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vMNetworkName: (() {
        final guardedValue = map['vMNetworkName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
