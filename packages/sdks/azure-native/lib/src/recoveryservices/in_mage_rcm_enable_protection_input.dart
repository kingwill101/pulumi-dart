...
class InMageRcmEnableProtectionInput {
  ...
  factory InMageRcmEnableProtectionInput.fromMap(Map<String, dynamic> map) {
    return InMageRcmEnableProtectionInput(
      disksDefault: (() { final guardedValue = map['disksDefault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InMageRcmDisksDefaultInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      targetManagedDiskTags: (() { final guardedValue = map['targetManagedDiskTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserCreatedResourceTag>(guardedValue, (value) => UserCreatedResourceTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      targetNicTags: (() { final guardedValue = map['targetNicTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserCreatedResourceTag>(guardedValue, (value) => UserCreatedResourceTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      targetVmTags: (() { final guardedValue = map['targetVmTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserCreatedResourceTag>(guardedValue, (value) => UserCreatedResourceTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
