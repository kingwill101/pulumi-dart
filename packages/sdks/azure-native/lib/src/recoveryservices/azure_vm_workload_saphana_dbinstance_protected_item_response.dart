...
class AzureVmWorkloadSAPHanaDBInstanceProtectedItemResponse {
  ...
  /// Creates a new [AzureVmWorkloadSAPHanaDBInstanceProtectedItemResponse].
  ...
  const AzureVmWorkloadSAPHanaDBInstanceProtectedItemResponse({
  ...
  factory AzureVmWorkloadSAPHanaDBInstanceProtectedItemResponse.fromMap(Map<String, dynamic> map) {
    return AzureVmWorkloadSAPHanaDBInstanceProtectedItemResponse(
