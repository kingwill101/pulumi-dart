...
class DpmContainerResponse {
  ...
  final DPMContainerExtendedInfoResponse? extendedInfo;
  ...
  factory DpmContainerResponse.fromMap(Map<String, dynamic> map) {
    return DpmContainerResponse(
      ...
      extendedInfo: map['extendedInfo'] == null ? null : DPMContainerExtendedInfoResponse.fromMap((map['extendedInfo'] as Map).cast<String, dynamic>()),
