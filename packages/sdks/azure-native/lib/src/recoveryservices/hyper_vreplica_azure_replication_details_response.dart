...
class HyperVReplicaAzureReplicationDetailsResponse {
  ...
  factory HyperVReplicaAzureReplicationDetailsResponse.fromMap(Map<String, dynamic> map) {
    return HyperVReplicaAzureReplicationDetailsResponse(
      ...
      initialReplicationDetails: (() { final guardedValue = map['initialReplicationDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InitialReplicationDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      lastRecoveryPointReceived: pulumi.Input.fromValue(map['lastRecoveryPointReceived'] as String),
      lastReplicatedTime: (() { final guardedValue = map['lastReplicatedTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      oSDetails: (() { final guardedValue = map['oSDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OSDetailsResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      protectedManagedDisks: (() { final guardedValue = map['protectedManagedDisks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HyperVReplicaAzureManagedDiskDetailsResponse>(guardedValue, (value) => HyperVReplicaAzureManagedDiskDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
