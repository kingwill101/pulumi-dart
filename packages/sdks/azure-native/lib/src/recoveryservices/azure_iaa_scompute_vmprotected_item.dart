...
class AzureIaaSComputeVMProtectedItem {
  ...
  /// Creates a new [AzureIaaSComputeVMProtectedItem].
  ...
  factory AzureIaaSComputeVMProtectedItem.fromMap(Map<String, dynamic> map) {
    return AzureIaaSComputeVMProtectedItem(
      ...
      extendedInfo: (() {
        ...
        return pulumi.Input.fromValue(
          AzureIaaSVMProtectedItemExtendedInfo.fromMap(
