...
class AzureWorkloadContainerExtendedInfo {
  ...
  factory AzureWorkloadContainerExtendedInfo.fromMap(Map<String, dynamic> map) {
    return AzureWorkloadContainerExtendedInfo(
      hostServerName: (() {
        final guardedValue = map['hostServerName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inquiryInfo: (() {
        final guardedValue = map['inquiryInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InquiryInfo.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      nodesList: (() {
