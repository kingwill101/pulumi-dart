...
class InquiryInfo {
  ...
  InquiryInfo({this.inquiryDetails, this.status});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inquiryDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadInquiryDetails>,
    ...
    return InquiryInfo(
      inquiryDetails: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkloadInquiryDetails>(
            guardedValue,
            (value) => WorkloadInquiryDetails.fromMap(
