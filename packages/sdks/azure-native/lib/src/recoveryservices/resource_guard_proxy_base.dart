...
class ResourceGuardProxyBase {
  ...
  final pulumi.Input<List<ResourceGuardOperationDetail>>?
    ...
    return <String, dynamic>{
      ...
      'resourceGuardOperationDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<ResourceGuardOperationDetail>,
    ...
    return ResourceGuardProxyBase(
      ...
      resourceGuardOperationDetails: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceGuardOperationDetail>(
            guardedValue,
            (value) => ResourceGuardOperationDetail.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      resourceGuardResourceId: pulumi.Input.fromValue(
        map['resourceGuardResourceId'] as String,
      ),
    );
  }
}
