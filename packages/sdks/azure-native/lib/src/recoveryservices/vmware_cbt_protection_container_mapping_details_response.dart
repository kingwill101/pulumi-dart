...
class VMwareCbtProtectionContainerMappingDetailsResponse {
  ...
  factory VMwareCbtProtectionContainerMappingDetailsResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return VMwareCbtProtectionContainerMappingDetailsResponse(
      excludedSkus: (() {
        final guardedValue = map['excludedSkus'];
      ...
      roleSizeToNicCountMap: pulumi.Input.fromValue(
        (map['roleSizeToNicCountMap'] as Map).cast<String, int>(),
      ),
      serviceBusConnectionStringSecretName: pulumi.Input.fromValue(
        map['serviceBusConnectionStringSecretName'] as String,
      ),
      storageAccountId: pulumi.Input.fromValue(
        map['storageAccountId'] as String,
      ),
      storageAccountSasSecretName: pulumi.Input.fromValue(
        map['storageAccountSasSecretName'] as String,
      ),
