...
class FabricPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'encryptionDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(encryptionDetails, (value) => value.toMap()),
      ...
      'rolloverEncryptionDetails':
          ?pulumi.Input.mapOptionalInputValue<
            EncryptionDetailsResponse,
            Map<String, dynamic>
          >(rolloverEncryptionDetails, (value) => value.toMap()),
    };
  }
  ...
  factory FabricPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return FabricPropertiesResponse(
      bcdrState: (() {
        final guardedValue = map['bcdrState'];
      ...
      customDetails: (() {
        ...
        return pulumi.Input.fromValue(
          AzureFabricSpecificDetailsResponse.fromMap(
      ...
      encryptionDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EncryptionDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      internalIdentifier: (() {
        final guardedValue = map['internalIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rolloverEncryptionDetails: (() {
        final guardedValue = map['rolloverEncryptionDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EncryptionDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
