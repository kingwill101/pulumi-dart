...
import 'private_endpoint_vault_response.dart';
...
class VaultPrivateEndpointConnectionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groupIds': ?groupIds,
      'privateEndpoint': pulumi.Input.mapInputValue<PrivateEndpointVaultResponse, Map<String, dynamic>>(privateEndpoint, (value) => value.toMap()),
  ...
  factory VaultPrivateEndpointConnectionResponse.fromMap(Map<String, dynamic> map) {
    return VaultPrivateEndpointConnectionResponse(
      ...
      privateEndpoint: pulumi.Input.fromValue(PrivateEndpointVaultResponse.fromMap((map['privateEndpoint']! as Map).cast<String, dynamic>())),
      privateLinkServiceConnectionState: pulumi.Input.fromValue(VaultPrivateLinkServiceConnectionStateResponse.fromMap((map['privateLinkServiceConnectionState']! as Map).cast<String, dynamic>())),
