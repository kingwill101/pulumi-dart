...
class HealthError {
    ...
    return <String, dynamic>{
      ...
      'innerHealthErrors':
          ...
          >(
            innerHealthErrors,
            (value) =>
                pulumi.Input.encodeList<InnerHealthError, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory HealthError.fromMap(Map<String, dynamic> map) {
    return HealthError(
      ...
      innerHealthErrors: (() {
        final guardedValue = map['innerHealthErrors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InnerHealthError>(
            guardedValue,
            (value) => InnerHealthError.fromMap(
