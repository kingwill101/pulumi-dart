...
class HealthError {
  ...
  factory HealthError.fromMap(Map<String, dynamic> map) {
    return HealthError(
      ...
      innerHealthErrors: (() { final guardedValue = map['innerHealthErrors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InnerHealthError>(guardedValue, (value) => InnerHealthError.fromMap((value as Map).cast<String, dynamic>()))); })(),
