...
class A2ASharedDiskReplicationDetailsResponse {
  ...
  /// The IR Errors.
  final pulumi.Input<List<A2ASharedDiskIRErrorDetailsResponse>>?
  sharedDiskIRErrors;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sharedDiskIRErrors':
          ?pulumi.Input.mapOptionalInputValue<
            List<A2ASharedDiskIRErrorDetailsResponse>,
            List<Map<String, dynamic>>
          >(
            sharedDiskIRErrors,
            (value) =>
  ...
  factory A2ASharedDiskReplicationDetailsResponse.fromMap(
    ...
    return A2ASharedDiskReplicationDetailsResponse(
      ...
      sharedDiskIRErrors: (() {
        final guardedValue = map['sharedDiskIRErrors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<A2ASharedDiskIRErrorDetailsResponse>(
            guardedValue,
            (value) => A2ASharedDiskIRErrorDetailsResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
