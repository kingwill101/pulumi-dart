...
class WeeklyRetentionFormat {
  ...
  WeeklyRetentionFormat({this.daysOfTheWeek, this.weeksOfTheMonth});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'weeksOfTheMonth':
          ?pulumi.Input.mapOptionalInputValue<List<WeekOfMonth>, List<String>>(
            weeksOfTheMonth,
            (value) => pulumi.Input.encodeList<WeekOfMonth, String>(
              value,
              (value) => value.wireValue,
            ),
          ),
  ...
  factory WeeklyRetentionFormat.fromMap(Map<String, dynamic> map) {
    return WeeklyRetentionFormat(
      ...
      weeksOfTheMonth: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WeekOfMonth>(
            guardedValue,
            (value) => WeekOfMonth.fromValue(value as String),
          ),
        );
      })(),
    );
