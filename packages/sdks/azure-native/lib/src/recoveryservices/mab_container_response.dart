...
class MabContainerResponse {
  ...
  final MabContainerExtendedInfoResponse? extendedInfo;
  /// Friendly name of the container.
  final String? friendlyName;
  /// Status of health of the container.
  final String? healthStatus;
  /// Health details on this mab container.
  final List<MABContainerHealthDetailsResponse>? mabContainerHealthDetails;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mabContainerHealthDetails': ?mabContainerHealthDetails == null ? null : pulumi.Input.encodeList<MABContainerHealthDetailsResponse, Map<String, dynamic>>(mabContainerHealthDetails!, (value) => value.toMap()),
  ...
  factory MabContainerResponse.fromMap(Map<String, dynamic> map) {
    return MabContainerResponse(
      ...
      extendedInfo: map['extendedInfo'] == null ? null : MabContainerExtendedInfoResponse.fromMap((map['extendedInfo'] as Map).cast<String, dynamic>()),
      ...
      mabContainerHealthDetails: map['mabContainerHealthDetails'] == null ? null : pulumi.Input.decodeList<MABContainerHealthDetailsResponse>(map['mabContainerHealthDetails'], (value) => MABContainerHealthDetailsResponse.fromMap((value as Map).cast<String, dynamic>())),
