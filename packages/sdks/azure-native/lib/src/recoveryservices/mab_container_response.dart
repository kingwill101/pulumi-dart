...
class MabContainerResponse {
  ...
  factory MabContainerResponse.fromMap(Map<String, dynamic> map) {
    return MabContainerResponse(
      ...
      containerId: (() { final guardedValue = map['containerId']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      containerType: pulumi.Input.fromValue(map['containerType'] as String),
      extendedInfo: (() { final guardedValue = map['extendedInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MabContainerExtendedInfoResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      mabContainerHealthDetails: (() { final guardedValue = map['mabContainerHealthDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MABContainerHealthDetailsResponse>(guardedValue, (value) => MABContainerHealthDetailsResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
