...
class MabContainerResponse {
  ...
  final pulumi.Input<List<MABContainerHealthDetailsResponse>>?
  ...
  factory MabContainerResponse.fromMap(Map<String, dynamic> map) {
    return MabContainerResponse(
      ...
      canReRegister: (() {
        final guardedValue = map['canReRegister'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      containerHealthState: (() {
        final guardedValue = map['containerHealthState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      containerId: (() {
      ...
      extendedInfo: (() {
        ...
        return pulumi.Input.fromValue(
          MabContainerExtendedInfoResponse.fromMap(
      ...
      mabContainerHealthDetails: (() {
        final guardedValue = map['mabContainerHealthDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MABContainerHealthDetailsResponse>(
            guardedValue,
            (value) => MABContainerHealthDetailsResponse.fromMap(
