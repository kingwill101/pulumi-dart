...
class ApiSourceArgs {
    ...
    return <String, dynamic>{
      ...
      'azureApiManagementSource':
          ?pulumi.Input.mapOptionalInputValue<
            AzureApiManagementSource,
            Map<String, dynamic>
          >(azureApiManagementSource, (value) => value.toMap()),
  ...
  factory ApiSourceArgs.fromMap(Map<String, dynamic> map) {
    return ApiSourceArgs(
      apiSourceName: (() {
        final guardedValue = map['apiSourceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      azureApiManagementSource: (() {
        final guardedValue = map['azureApiManagementSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AzureApiManagementSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      importSpecification: (() {
        final guardedValue = map['importSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      targetEnvironmentId: (() {
        final guardedValue = map['targetEnvironmentId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      targetLifecycleStage: (() {
        final guardedValue = map['targetLifecycleStage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
