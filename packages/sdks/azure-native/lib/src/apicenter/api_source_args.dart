...
class ApiSourceArgs {
  ...
  factory ApiSourceArgs.fromMap(Map<String, dynamic> map) {
    return ApiSourceArgs(
      ...
      importSpecification: (() { final guardedValue = map['importSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      targetLifecycleStage: (() { final guardedValue = map['targetLifecycleStage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
