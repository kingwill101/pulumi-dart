  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aRecords':
          ...
          >(
            aRecords,
            (value) => pulumi.Input.encodeList<ARecord, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'aaaaRecords':
          ...
          >(
            aaaaRecords,
            (value) =>
                pulumi.Input.encodeList<AaaaRecord, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'mxRecords':
          ...
          >(
            mxRecords,
            (value) => pulumi.Input.encodeList<MxRecord, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'ptrRecords':
          ...
          >(
            ptrRecords,
            (value) => pulumi.Input.encodeList<PtrRecord, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'soaRecord':
          ?pulumi.Input.mapOptionalInputValue<SoaRecord, Map<String, dynamic>>(
            soaRecord,
            (value) => value.toMap(),
          ),
      'srvRecords':
          ...
          >(
            srvRecords,
            (value) => pulumi.Input.encodeList<SrvRecord, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'txtRecords':
          ...
          >(
            txtRecords,
            (value) => pulumi.Input.encodeList<TxtRecord, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
    ...
    return PrivateRecordSetArgs(
      aRecords: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ARecord>(
            guardedValue,
            (value) => ARecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      aaaaRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AaaaRecord>(
            guardedValue,
            (value) =>
                AaaaRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      cnameRecord: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CnameRecord.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      metadata: (() {
      ...
      mxRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MxRecord>(
            guardedValue,
            (value) => MxRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      ptrRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PtrRecord>(
            guardedValue,
            (value) =>
                PtrRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      recordType: pulumi.Input.fromValue(map['recordType'] as String),
      relativeRecordSetName: (() {
        final guardedValue = map['relativeRecordSetName'];
        if (guardedValue == null) return null;
      ...
      soaRecord: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SoaRecord.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      srvRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SrvRecord>(
            guardedValue,
            (value) =>
                SrvRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ttl: (() {
      ...
      txtRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TxtRecord>(
            guardedValue,
            (value) =>
                TxtRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
