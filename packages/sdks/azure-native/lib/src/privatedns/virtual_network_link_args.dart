...
class VirtualNetworkLinkArgs {
  ...
  final pulumi.Input<dynamic>? resolutionPolicy;
  ...
  factory VirtualNetworkLinkArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkLinkArgs(
      ...
      resolutionPolicy: (() { final guardedValue = map['resolutionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
