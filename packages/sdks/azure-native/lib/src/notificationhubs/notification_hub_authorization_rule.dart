...
/// }
///
/// resource "azure-native_notificationhubs_notificationhubauthorizationrule" "notificationHubAuthorizationRule" {
...
class NotificationHubAuthorizationRule extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [NotificationHubAuthorizationRule] resource.
  NotificationHubAuthorizationRule.reference(String urn)
    : super(
        'azure-native:notificationhubs:NotificationHubAuthorizationRule',
