...
class NetworkAcls {
  ...
  factory NetworkAcls.fromMap(Map<String, dynamic> map) {
    return NetworkAcls(
      ...
      publicNetworkRule: (() { final guardedValue = map['publicNetworkRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicInternetAuthorizationRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
