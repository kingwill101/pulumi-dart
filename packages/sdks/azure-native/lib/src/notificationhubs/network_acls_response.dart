...
class NetworkAclsResponse {
  ...
  factory NetworkAclsResponse.fromMap(Map<String, dynamic> map) {
    return NetworkAclsResponse(
      ...
      publicNetworkRule: (() { final guardedValue = map['publicNetworkRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PublicInternetAuthorizationRuleResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
