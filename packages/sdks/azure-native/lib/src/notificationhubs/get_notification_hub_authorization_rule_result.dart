...
/// Result data returned by getNotificationHubAuthorizationRule.
class GetNotificationHubAuthorizationRuleResult {
  ...
  /// Creates a new [GetNotificationHubAuthorizationRuleResult].
  ...
  const GetNotificationHubAuthorizationRuleResult({
