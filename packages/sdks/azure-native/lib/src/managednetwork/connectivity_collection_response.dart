...
class ConnectivityCollectionResponse {
  ...
  factory ConnectivityCollectionResponse.fromMap(Map<String, dynamic> map) {
    return ConnectivityCollectionResponse(
      groups: (pulumi.Input.decodeList<ManagedNetworkGroupResponse>(map['groups'], (value) => ManagedNetworkGroupResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      peerings: (pulumi.Input.decodeList<ManagedNetworkPeeringPolicyResponse>(map['peerings'], (value) => ManagedNetworkPeeringPolicyResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
