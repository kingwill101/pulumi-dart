    ...
    return <String, dynamic>{
      'groups':
          pulumi.Input.mapInputValue<
            List<ManagedNetworkGroupResponse>,
      ...
      'peerings':
          pulumi.Input.mapInputValue<
            List<ManagedNetworkPeeringPolicyResponse>,
            List<Map<String, dynamic>>
          >(
            peerings,
            (value) =>
  ...
  factory ConnectivityCollectionResponse.fromMap(Map<String, dynamic> map) {
    return ConnectivityCollectionResponse(
      groups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ManagedNetworkGroupResponse>(
          map['groups']!,
          (value) => ManagedNetworkGroupResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      peerings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ManagedNetworkPeeringPolicyResponse>(
          map['peerings']!,
          (value) => ManagedNetworkPeeringPolicyResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
