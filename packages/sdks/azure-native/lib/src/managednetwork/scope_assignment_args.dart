...
class ScopeAssignmentArgs {
  ...
  factory ScopeAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return ScopeAssignmentArgs(
      assignedManagedNetwork: (() { final guardedValue = map['assignedManagedNetwork']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scope: pulumi.Input.fromValue(map['scope'] as String),
      scopeAssignmentName: (() { final guardedValue = map['scopeAssignmentName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
