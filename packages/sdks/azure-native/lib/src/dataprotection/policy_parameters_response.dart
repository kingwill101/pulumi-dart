...
class PolicyParametersResponse {
  ...
  final pulumi.Input<List<BlobBackupDatasourceParametersResponse>>?
  backupDatasourceParametersList;

  /// Gets or sets the DataStore Parameters
  final pulumi.Input<List<AzureOperationalStoreParametersResponse>>?
    ...
    return <String, dynamic>{
      'backupDatasourceParametersList':
          ?pulumi.Input.mapOptionalInputValue<
            List<BlobBackupDatasourceParametersResponse>,
      ...
      'dataStoreParametersList':
          ?pulumi.Input.mapOptionalInputValue<
            List<AzureOperationalStoreParametersResponse>,
            List<Map<String, dynamic>>
          >(
            dataStoreParametersList,
            (value) =>
  ...
  factory PolicyParametersResponse.fromMap(Map<String, dynamic> map) {
    return PolicyParametersResponse(
      backupDatasourceParametersList: (() {
        final guardedValue = map['backupDatasourceParametersList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BlobBackupDatasourceParametersResponse>(
            guardedValue,
            (value) => BlobBackupDatasourceParametersResponse.fromMap(
      ...
      dataStoreParametersList: (() {
        final guardedValue = map['dataStoreParametersList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AzureOperationalStoreParametersResponse>(
            guardedValue,
            (value) => AzureOperationalStoreParametersResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
