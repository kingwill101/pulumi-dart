...
class BackupInstanceResponse {
  ...
  final pulumi.Input<SecretStoreBasedAuthCredentialsResponse>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataSourceInfo':
          pulumi.Input.mapInputValue<DatasourceResponse, Map<String, dynamic>>(
            dataSourceInfo,
            (value) => value.toMap(),
          ),
      'dataSourceSetInfo':
      ...
      'policyInfo':
          pulumi.Input.mapInputValue<PolicyInfoResponse, Map<String, dynamic>>(
            policyInfo,
            (value) => value.toMap(),
          ),
      'protectionErrorDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(protectionErrorDetails, (value) => value.toMap()),
      'protectionStatus':
          pulumi.Input.mapInputValue<
            ProtectionStatusDetailsResponse,
            Map<String, dynamic>
          >(protectionStatus, (value) => value.toMap()),
  ...
  factory BackupInstanceResponse.fromMap(Map<String, dynamic> map) {
    return BackupInstanceResponse(
      currentProtectionState: pulumi.Input.fromValue(
        map['currentProtectionState'] as String,
      ),
      dataSourceInfo: pulumi.Input.fromValue(
        DatasourceResponse.fromMap(
      ...
      datasourceAuthCredentials: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretStoreBasedAuthCredentialsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      identityDetails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IdentityDetailsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      policyInfo: pulumi.Input.fromValue(
        PolicyInfoResponse.fromMap(
          (map['policyInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
      protectionErrorDetails: pulumi.Input.fromValue(
        UserFacingErrorResponse.fromMap(
          (map['protectionErrorDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      protectionStatus: pulumi.Input.fromValue(
        ProtectionStatusDetailsResponse.fromMap(
          (map['protectionStatus']! as Map).cast<String, dynamic>(),
        ),
      ),
