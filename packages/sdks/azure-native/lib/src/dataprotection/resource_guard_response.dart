...
class ResourceGuardResponse {
  ...
  factory ResourceGuardResponse.fromMap(Map<String, dynamic> map) {
    return ResourceGuardResponse(
      allowAutoApprovals: pulumi.Input.fromValue(map['allowAutoApprovals'] as bool),
      description: pulumi.Input.fromValue(map['description'] as String),
      provisioningState: pulumi.Input.fromValue(map['provisioningState'] as String),
      resourceGuardOperations: pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceGuardOperationResponse>(map['resourceGuardOperations']!, (value) => ResourceGuardOperationResponse.fromMap((value as Map).cast<String, dynamic>()))),
