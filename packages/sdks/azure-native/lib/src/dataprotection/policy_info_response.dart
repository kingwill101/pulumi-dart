...
class PolicyInfoResponse {
  ...
  factory PolicyInfoResponse.fromMap(Map<String, dynamic> map) {
    return PolicyInfoResponse(
      ...
      policyParameters: (() { final guardedValue = map['policyParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyParametersResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
