...
class ScheduleBasedTriggerContextResponse {
  ...
  const ScheduleBasedTriggerContextResponse({
  ...
  factory ScheduleBasedTriggerContextResponse.fromMap(Map<String, dynamic> map) {
    return ScheduleBasedTriggerContextResponse(
      ...
      schedule: pulumi.Input.fromValue(BackupScheduleResponse.fromMap((map['schedule']! as Map).cast<String, dynamic>())),
      taggingCriteria: pulumi.Input.fromValue(pulumi.Input.decodeList<TaggingCriteriaResponse>(map['taggingCriteria']!, (value) => TaggingCriteriaResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
