...
class FeatureSettingsResponse {
  final pulumi.Input<CrossRegionRestoreSettingsResponse>?
  crossRegionRestoreSettings;

  /// CrossSubscriptionRestore Settings
  final pulumi.Input<CrossSubscriptionRestoreSettingsResponse>?
    ...
    return FeatureSettingsResponse(
      crossRegionRestoreSettings: (() {
        ...
        return pulumi.Input.fromValue(
          CrossRegionRestoreSettingsResponse.fromMap(
      ...
      crossSubscriptionRestoreSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CrossSubscriptionRestoreSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
