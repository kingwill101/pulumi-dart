    ...
    return <String, dynamic>{
      ...
      'storageSettings':
          ...
          >(
            storageSettings,
            (value) =>
                pulumi.Input.encodeList<StorageSetting, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory BackupVault.fromMap(Map<String, dynamic> map) {
    return BackupVault(
      ...
      storageSettings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StorageSetting>(
          map['storageSettings']!,
          (value) =>
              StorageSetting.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
    );
  }
