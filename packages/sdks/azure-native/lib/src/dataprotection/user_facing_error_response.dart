    ...
    return UserFacingErrorResponse(
      ...
      details: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserFacingErrorResponse>(
            guardedValue,
            (value) => UserFacingErrorResponse.fromMap(
      ...
      isRetryable: (() {
        final guardedValue = map['isRetryable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isUserError: (() {
        final guardedValue = map['isUserError'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      message: (() {
