...
class BackupInstance {
  ...
  factory BackupInstance.fromMap(Map<String, dynamic> map) {
    return BackupInstance(
      dataSourceInfo: pulumi.Input.fromValue(Datasource.fromMap((map['dataSourceInfo']! as Map).cast<String, dynamic>())),
      dataSourceSetInfo: (() { final guardedValue = map['dataSourceSetInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DatasourceSet.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      datasourceAuthCredentials: (() { final guardedValue = map['datasourceAuthCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecretStoreBasedAuthCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      friendlyName: (() { final guardedValue = map['friendlyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      identityDetails: (() { final guardedValue = map['identityDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IdentityDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
