...
class Datasource {
  ...
  final DefaultResourceProperties? resourceProperties;
  ...
  factory Datasource.fromMap(Map<String, dynamic> map) {
    return Datasource(
      ...
      resourceProperties: map['resourceProperties'] == null ? null : DefaultResourceProperties.fromMap((map['resourceProperties'] as Map).cast<String, dynamic>()),
