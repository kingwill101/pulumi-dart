...
class SourceLifeCycleResponse {
  ...
  final pulumi.Input<List<TargetCopySettingResponse>>?
    ...
    return <String, dynamic>{
      'deleteAfter':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(deleteAfter, (value) => value.toMap()),
      'sourceDataStore':
          pulumi.Input.mapInputValue<
            DataStoreInfoBaseResponse,
            Map<String, dynamic>
          >(sourceDataStore, (value) => value.toMap()),
      'targetDataStoreCopySettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<TargetCopySettingResponse>,
  ...
  factory SourceLifeCycleResponse.fromMap(Map<String, dynamic> map) {
    return SourceLifeCycleResponse(
      deleteAfter: pulumi.Input.fromValue(
        AbsoluteDeleteOptionResponse.fromMap(
          (map['deleteAfter']! as Map).cast<String, dynamic>(),
        ),
      ),
      sourceDataStore: pulumi.Input.fromValue(
        DataStoreInfoBaseResponse.fromMap(
          (map['sourceDataStore']! as Map).cast<String, dynamic>(),
        ),
      ),
      targetDataStoreCopySettings: (() {
        final guardedValue = map['targetDataStoreCopySettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TargetCopySettingResponse>(
            guardedValue,
            (value) => TargetCopySettingResponse.fromMap(
