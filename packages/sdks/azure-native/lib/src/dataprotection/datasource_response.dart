...
class DatasourceResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceProperties': ?pulumi.Input.mapOptionalInputValue<DefaultResourcePropertiesResponse, Map<String, dynamic>>(resourceProperties, (value) => value.toMap()),
  ...
  factory DatasourceResponse.fromMap(Map<String, dynamic> map) {
    return DatasourceResponse(
      ...
      resourceProperties: (() { final guardedValue = map['resourceProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultResourcePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
