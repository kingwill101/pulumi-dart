...
/// }
///
/// resource "azure-native_dataprotection_resourceguard" "resourceGuard" {
///   location             = "WestUS"
...
class ResourceGuardDataprotection extends pulumi.CustomResource {
  ...
  ResourceGuardDataprotection(
    ...
    properties = registerOutput<ResourceGuardResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ResourceGuardResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [ResourceGuardDataprotection] resource.
  ResourceGuardDataprotection.reference(String urn)
    : super(
        'azure-native:dataprotection:ResourceGuard',
