    ...
    return <String, dynamic>{
      'criteria':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScheduleBasedBackupCriteriaResponse>,
    ...
    return TaggingCriteriaResponse(
      criteria: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScheduleBasedBackupCriteriaResponse>(
            guardedValue,
            (value) => ScheduleBasedBackupCriteriaResponse.fromMap(
      ...
      tagInfo: pulumi.Input.fromValue(
        RetentionTagResponse.fromMap(
          (map['tagInfo']! as Map).cast<String, dynamic>(),
        ),
      ),
