...
class BackupVaultResponse {
    ...
    return <String, dynamic>{
      ...
      'resourceMoveDetails':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(resourceMoveDetails, (value) => value.toMap()),
  ...
  factory BackupVaultResponse.fromMap(Map<String, dynamic> map) {
    return BackupVaultResponse(
      bcdrSecurityLevel: pulumi.Input.fromValue(
        map['bcdrSecurityLevel'] as String,
      ),
      featureSettings: (() {
        final guardedValue = map['featureSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FeatureSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      isVaultProtectedByResourceGuard: pulumi.Input.fromValue(
        map['isVaultProtectedByResourceGuard'] as bool,
      ),
      monitoringSettings: (() {
        final guardedValue = map['monitoringSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MonitoringSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      replicatedRegions: (() {
        final guardedValue = map['replicatedRegions'];
        if (guardedValue == null) return null;
      ...
      resourceMoveDetails: pulumi.Input.fromValue(
        ResourceMoveDetailsResponse.fromMap(
          (map['resourceMoveDetails']! as Map).cast<String, dynamic>(),
        ),
      ),
      resourceMoveState: pulumi.Input.fromValue(
        map['resourceMoveState'] as String,
      ),
      ...
      storageSettings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<StorageSettingResponse>(
          map['storageSettings']!,
          (value) => StorageSettingResponse.fromMap(
