...
class GetZoneResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'registrationVirtualNetworks': ?registrationVirtualNetworks == null ? null : pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(registrationVirtualNetworks!, (value) => value.toMap()),
      'resolutionVirtualNetworks': ?resolutionVirtualNetworks == null ? null : pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(resolutionVirtualNetworks!, (value) => value.toMap()),
