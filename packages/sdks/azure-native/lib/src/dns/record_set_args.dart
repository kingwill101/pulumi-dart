  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'caaRecords':
          ...
          >(
            caaRecords,
            (value) => pulumi.Input.encodeList<CaaRecord, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'naptrRecords':
          ...
          >(
            naptrRecords,
            (value) =>
                pulumi.Input.encodeList<NaptrRecord, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'nsRecords':
          ...
          >(
            nsRecords,
            (value) => pulumi.Input.encodeList<NsRecord, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'tlsaRecords':
          ...
          >(
            tlsaRecords,
            (value) =>
                pulumi.Input.encodeList<TlsaRecord, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'trafficManagementProfile':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(trafficManagementProfile, (value) => value.toMap()),
      'ttl': ?ttl,
      'txtRecords':
          ?pulumi.Input.mapOptionalInputValue<
            List<TxtRecord>,
  ...
  factory RecordSetArgs.fromMap(Map<String, dynamic> map) {
    return RecordSetArgs(
      ...
      caaRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CaaRecord>(
            guardedValue,
            (value) =>
                CaaRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      cnameRecord: (() {
      ...
      naptrRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NaptrRecord>(
            guardedValue,
            (value) =>
                NaptrRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      nsRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NsRecord>(
            guardedValue,
            (value) => NsRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ptrRecords: (() {
      ...
      tlsaRecords: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TlsaRecord>(
            guardedValue,
            (value) =>
                TlsaRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      trafficManagementProfile: (() {
