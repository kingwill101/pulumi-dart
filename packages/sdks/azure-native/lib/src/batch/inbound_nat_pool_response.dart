...
class InboundNatPoolResponse {
  ...
  final List<NetworkSecurityGroupRuleResponse>? networkSecurityGroupRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'networkSecurityGroupRules': ?networkSecurityGroupRules == null ? null : pulumi.Input.encodeList<NetworkSecurityGroupRuleResponse, Map<String, dynamic>>(networkSecurityGroupRules!, (value) => value.toMap()),
      'protocol': protocol,
    };
  }
  ...
  factory InboundNatPoolResponse.fromMap(Map<String, dynamic> map) {
    return InboundNatPoolResponse(
      ...
      networkSecurityGroupRules: map['networkSecurityGroupRules'] == null ? null : pulumi.Input.decodeList<NetworkSecurityGroupRuleResponse>(map['networkSecurityGroupRules'], (value) => NetworkSecurityGroupRuleResponse.fromMap((value as Map).cast<String, dynamic>())),
