...
class InboundNatPoolResponse {
  ...
  final pulumi.Input<List<NetworkSecurityGroupRuleResponse>>? networkSecurityGroupRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'networkSecurityGroupRules': ?pulumi.Input.mapOptionalInputValue<List<NetworkSecurityGroupRuleResponse>, List<Map<String, dynamic>>>(networkSecurityGroupRules, (value) => pulumi.Input.encodeList<NetworkSecurityGroupRuleResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      'protocol': protocol,
    };
  }
  ...
  factory InboundNatPoolResponse.fromMap(Map<String, dynamic> map) {
    return InboundNatPoolResponse(
      ...
      networkSecurityGroupRules: (() { final guardedValue = map['networkSecurityGroupRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkSecurityGroupRuleResponse>(guardedValue, (value) => NetworkSecurityGroupRuleResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
