...
class PoolArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'interNodeCommunication': ?pulumi.Input.mapOptionalInputValue<InterNodeCommunicationState, String>(interNodeCommunication, (value) => value.wireValue),
      ...
      'tags': ?tags,
      'targetNodeCommunicationMode': ?pulumi.Input.mapOptionalInputValue<NodeCommunicationMode, String>(targetNodeCommunicationMode, (value) => value.wireValue),
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      applicationLicenses: (() { final guardedValue = map['applicationLicenses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      applicationPackages: (() { final guardedValue = map['applicationPackages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationPackageReference>(guardedValue, (value) => ApplicationPackageReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      deploymentConfiguration: (() { final guardedValue = map['deploymentConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      displayName: (() { final guardedValue = map['displayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BatchPoolIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      interNodeCommunication: (() { final guardedValue = map['interNodeCommunication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InterNodeCommunicationState.fromValue(guardedValue as String)); })(),
      ...
      mountConfiguration: (() { final guardedValue = map['mountConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MountConfiguration>(guardedValue, (value) => MountConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      startTask: (() { final guardedValue = map['startTask']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StartTask.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
