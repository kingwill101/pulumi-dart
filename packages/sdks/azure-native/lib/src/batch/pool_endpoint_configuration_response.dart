...
class PoolEndpointConfigurationResponse {
  ...
  factory PoolEndpointConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return PoolEndpointConfigurationResponse(
      inboundNatPools: (pulumi.Input.decodeList<InboundNatPoolResponse>(map['inboundNatPools'], (value) => InboundNatPoolResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
