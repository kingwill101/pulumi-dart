...
class PoolEndpointConfigurationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inboundNatPools': pulumi.Input.encodeList<InboundNatPoolResponse, Map<String, dynamic>>(inboundNatPools, (value) => value.toMap()),
    };
  }

  factory PoolEndpointConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return PoolEndpointConfigurationResponse(
      inboundNatPools: pulumi.Input.decodeList<InboundNatPoolResponse>(map['inboundNatPools'], (value) => InboundNatPoolResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
