...
class EndpointAccessProfile {
  ...
  EndpointAccessProfile({required this.defaultAction, this.ipRules});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultAction':
          pulumi.Input.mapInputValue<EndpointAccessDefaultAction, String>(
            defaultAction,
  ...
  factory EndpointAccessProfile.fromMap(Map<String, dynamic> map) {
    return EndpointAccessProfile(
      defaultAction: pulumi.Input.fromValue(
        EndpointAccessDefaultAction.fromValue(map['defaultAction']! as String),
      ),
      ipRules: (() {
