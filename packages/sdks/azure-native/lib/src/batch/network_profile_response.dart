...
class NetworkProfileResponse {
  ...
  NetworkProfileResponse({this.accountAccess, this.nodeManagementAccess});
    ...
    return <String, dynamic>{
      'accountAccess':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(accountAccess, (value) => value.toMap()),
      'nodeManagementAccess':
          ?pulumi.Input.mapOptionalInputValue<
            EndpointAccessProfileResponse,
            Map<String, dynamic>
          >(nodeManagementAccess, (value) => value.toMap()),
    };
  }
    ...
    return NetworkProfileResponse(
      accountAccess: (() {
        ...
        return pulumi.Input.fromValue(
          EndpointAccessProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      nodeManagementAccess: (() {
        final guardedValue = map['nodeManagementAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointAccessProfileResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
