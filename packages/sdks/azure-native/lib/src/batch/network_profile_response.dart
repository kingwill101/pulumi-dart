...
class NetworkProfileResponse {
  ...
  factory NetworkProfileResponse.fromMap(Map<String, dynamic> map) {
    return NetworkProfileResponse(
      accountAccess: (() { final guardedValue = map['accountAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointAccessProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nodeManagementAccess: (() { final guardedValue = map['nodeManagementAccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointAccessProfileResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
