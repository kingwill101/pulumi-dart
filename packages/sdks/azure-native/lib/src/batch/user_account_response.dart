...
class UserAccountResponse {
  ...
  factory UserAccountResponse.fromMap(Map<String, dynamic> map) {
    return UserAccountResponse(
      ...
      linuxUserConfiguration: (() { final guardedValue = map['linuxUserConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinuxUserConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      password: pulumi.Input.fromValue(map['password'] as String),
      windowsUserConfiguration: (() { final guardedValue = map['windowsUserConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WindowsUserConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
