...
class ResourceFile {
  ...
  factory ResourceFile.fromMap(Map<String, dynamic> map) {
    return ResourceFile(
      ...
      identityReference: (() { final guardedValue = map['identityReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeNodeIdentityReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
