...
class GetBatchAccountResult {
  ...
  final List<VirtualMachineFamilyCoreQuotaResponse>
    ...
    return <String, dynamic>{
      ...
      'dedicatedCoreQuotaPerVMFamily':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(dedicatedCoreQuotaPerVMFamily, (value) => value.toMap()),
  ...
  factory GetBatchAccountResult.fromMap(Map<String, dynamic> map) {
    return GetBatchAccountResult(
      ...
      allowedAuthenticationModes: (map['allowedAuthenticationModes'] as List)
          .cast<String>(),
      autoStorage: AutoStoragePropertiesResponse.fromMap(
        (map['autoStorage']! as Map).cast<String, dynamic>(),
      ),
      azureApiVersion: map['azureApiVersion'] as String,
      dedicatedCoreQuota: map['dedicatedCoreQuota'] as int,
      dedicatedCoreQuotaPerVMFamily:
          pulumi.Input.decodeList<VirtualMachineFamilyCoreQuotaResponse>(
            map['dedicatedCoreQuotaPerVMFamily']!,
            (value) => VirtualMachineFamilyCoreQuotaResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      dedicatedCoreQuotaPerVMFamilyEnforced:
          map['dedicatedCoreQuotaPerVMFamilyEnforced'] as bool,
      encryption: EncryptionPropertiesResponse.fromMap(
      ...
      keyVaultReference: KeyVaultReferenceResponse.fromMap(
        (map['keyVaultReference']! as Map).cast<String, dynamic>(),
      ),
