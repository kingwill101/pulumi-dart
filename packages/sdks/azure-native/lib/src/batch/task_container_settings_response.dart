...
class TaskContainerSettingsResponse {
  ...
  final pulumi.Input<List<ContainerHostBatchBindMountEntryResponse>>?
    ...
    return <String, dynamic>{
      'containerHostBatchBindMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerHostBatchBindMountEntryResponse>,
  ...
  factory TaskContainerSettingsResponse.fromMap(Map<String, dynamic> map) {
    return TaskContainerSettingsResponse(
      containerHostBatchBindMounts: (() {
        final guardedValue = map['containerHostBatchBindMounts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerHostBatchBindMountEntryResponse>(
            guardedValue,
            (value) => ContainerHostBatchBindMountEntryResponse.fromMap(
      ...
      containerRunOptions: (() {
        final guardedValue = map['containerRunOptions'];
        if (guardedValue == null) return null;
      ...
      registry: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerRegistryResponse.fromMap(
