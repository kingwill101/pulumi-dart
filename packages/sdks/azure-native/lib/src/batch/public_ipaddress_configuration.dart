...
class PublicIPAddressConfiguration {
  ...
  PublicIPAddressConfiguration({this.ipAddressIds, this.provision});
    ...
    return <String, dynamic>{
      ...
      'provision':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(provision, (value) => value.wireValue),
    };
  }
    ...
    return PublicIPAddressConfiguration(
      ...
      provision: (() {
        ...
        return pulumi.Input.fromValue(
          IPAddressProvisioningType.fromValue(guardedValue as String),
        );
      })(),
    );
  }
