...
class PublicIPAddressConfiguration {
  ...
  final IPAddressProvisioningType? provision;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'provision': ?provision == null ? null : provision!.value,
    };
  }
  ...
  factory PublicIPAddressConfiguration.fromMap(Map<String, dynamic> map) {
    return PublicIPAddressConfiguration(
      ...
      provision: map['provision'] == null ? null : IPAddressProvisioningType.fromValue(map['provision'] as String),
    );
  }
}
