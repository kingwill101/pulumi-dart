...
class GetPoolResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'applicationPackages': ?(() {
        final guardedValue = applicationPackages;
      ...
      'mountConfiguration': ?(() {
        final guardedValue = mountConfiguration;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'userAccounts': ?(() {
        final guardedValue = userAccounts;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
          UserAccountResponse,
          Map<String, dynamic>
  ...
  factory GetPoolResult.fromMap(Map<String, dynamic> map) {
    return GetPoolResult(
      ...
      applicationPackages: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ApplicationPackageReferenceResponse>(
          guardedValue,
          (value) => ApplicationPackageReferenceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      autoScaleRun: AutoScaleRunResponse.fromMap(
        (map['autoScaleRun']! as Map).cast<String, dynamic>(),
      ),
      azureApiVersion: map['azureApiVersion'] as String,
      certificates: (() {
        final guardedValue = map['certificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<CertificateReferenceResponse>(
          guardedValue,
          (value) => CertificateReferenceResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      currentNodeCommunicationMode:
          map['currentNodeCommunicationMode'] as String,
      ...
      metadata: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<MetadataItemResponse>(
          guardedValue,
      ...
      mountConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<MountConfigurationResponse>(
          guardedValue,
          (value) => MountConfigurationResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      provisioningStateTransitionTime:
          map['provisioningStateTransitionTime'] as String,
      resizeOperationStatus: ResizeOperationStatusResponse.fromMap(
        (map['resizeOperationStatus']! as Map).cast<String, dynamic>(),
      ),
      resourceTags: (() {
      ...
      userAccounts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<UserAccountResponse>(
          guardedValue,
          (value) => UserAccountResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
