...
class GetPoolResult {
  ...
  GetPoolResult({
    ...
    this.certificates,
    this.creationTime,
    this.currentDedicatedNodes,
    this.currentLowPriorityNodes,
    this.currentNodeCommunicationMode,
    ...
    this.userAccounts,
    this.vmSize,
  }) : taskSlotsPerNode = taskSlotsPerNode ?? 1;
  ...
  factory GetPoolResult.fromMap(Map<String, dynamic> map) {
    return GetPoolResult(
      allocationState: (() { final guardedValue = map['allocationState']; if (guardedValue == null) return null; return guardedValue as String; })(),
      allocationStateTransitionTime: (() { final guardedValue = map['allocationStateTransitionTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      autoScaleRun: (() { final guardedValue = map['autoScaleRun']; if (guardedValue == null) return null; return AutoScaleRunResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      currentDedicatedNodes: (() { final guardedValue = map['currentDedicatedNodes']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      currentLowPriorityNodes: (() { final guardedValue = map['currentLowPriorityNodes']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      currentNodeCommunicationMode: (() { final guardedValue = map['currentNodeCommunicationMode']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      provisioningStateTransitionTime: (() { final guardedValue = map['provisioningStateTransitionTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      resizeOperationStatus: (() { final guardedValue = map['resizeOperationStatus']; if (guardedValue == null) return null; return ResizeOperationStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      taskSlotsPerNode: (() { final guardedValue = map['taskSlotsPerNode']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
