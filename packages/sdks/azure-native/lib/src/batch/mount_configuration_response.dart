...
class MountConfigurationResponse {
  ...
  factory MountConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return MountConfigurationResponse(
      azureBlobFileSystemConfiguration: (() { final guardedValue = map['azureBlobFileSystemConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureBlobFileSystemConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      azureFileShareConfiguration: (() { final guardedValue = map['azureFileShareConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AzureFileShareConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cifsMountConfiguration: (() { final guardedValue = map['cifsMountConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CIFSMountConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      nfsMountConfiguration: (() { final guardedValue = map['nfsMountConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NFSMountConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
