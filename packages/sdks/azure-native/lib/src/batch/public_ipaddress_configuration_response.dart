...
class PublicIPAddressConfigurationResponse {
  ...
  PublicIPAddressConfigurationResponse({this.ipAddressIds, this.provision});
  ...
  factory PublicIPAddressConfigurationResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return PublicIPAddressConfigurationResponse(
      ipAddressIds: (() {
        final guardedValue = map['ipAddressIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      provision: (() {
        final guardedValue = map['provision'];
        if (guardedValue == null) return null;
