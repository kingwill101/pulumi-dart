...
class TaskContainerSettings {
  ...
  final pulumi.Input<List<ContainerHostBatchBindMountEntry>>?
    ...
    return <String, dynamic>{
      'containerHostBatchBindMounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContainerHostBatchBindMountEntry>,
      ...
      'workingDirectory':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            String
          >(workingDirectory, (value) => value.wireValue),
    };
  }
    ...
    return TaskContainerSettings(
      containerHostBatchBindMounts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ContainerHostBatchBindMountEntry>(
            guardedValue,
            (value) => ContainerHostBatchBindMountEntry.fromMap(
      ...
      workingDirectory: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ContainerWorkingDirectory.fromValue(guardedValue as String),
        );
      })(),
    );
  }
