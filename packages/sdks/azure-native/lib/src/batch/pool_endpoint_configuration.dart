...
class PoolEndpointConfiguration {
  ...
  final List<InboundNatPool> inboundNatPools;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inboundNatPools': pulumi.Input.encodeList<InboundNatPool, Map<String, dynamic>>(inboundNatPools, (value) => value.toMap()),
    };
  }

  factory PoolEndpointConfiguration.fromMap(Map<String, dynamic> map) {
    return PoolEndpointConfiguration(
      inboundNatPools: pulumi.Input.decodeList<InboundNatPool>(map['inboundNatPools'], (value) => InboundNatPool.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
