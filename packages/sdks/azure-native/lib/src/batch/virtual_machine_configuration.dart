  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataDisks':
          ...
          >(
            dataDisks,
            (value) => pulumi.Input.encodeList<DataDisk, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'extensions':
          ...
          >(
            extensions,
            (value) =>
                pulumi.Input.encodeList<VMExtension, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'osDisk':
          ?pulumi.Input.mapOptionalInputValue<OSDisk, Map<String, dynamic>>(
            osDisk,
            (value) => value.toMap(),
          ),
      'securityProfile':
  ...
  factory VirtualMachineConfiguration.fromMap(Map<String, dynamic> map) {
    return VirtualMachineConfiguration(
      ...
      dataDisks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataDisk>(
            guardedValue,
            (value) => DataDisk.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      diskEncryptionConfiguration: (() {
      ...
      extensions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VMExtension>(
            guardedValue,
            (value) =>
                VMExtension.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      nodePlacementConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NodePlacementConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      osDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OSDisk.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      securityProfile: (() {
