  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'allowedAuthenticationModes':
          ...
          >(
            allowedAuthenticationModes,
            (value) => pulumi.Input.encodeList<AuthenticationMode, String>(
              value,
      ...
      'poolAllocationMode':
          ?pulumi.Input.mapOptionalInputValue<PoolAllocationMode, String>(
            poolAllocationMode,
            (value) => value.wireValue,
          ),
      'publicNetworkAccess':
          ?pulumi.Input.mapOptionalInputValue<PublicNetworkAccessType, String>(
            publicNetworkAccess,
            (value) => value.wireValue,
          ),
    ...
    return BatchAccountArgs(
      ...
      allowedAuthenticationModes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthenticationMode>(
            guardedValue,
            (value) => AuthenticationMode.fromValue(value as String),
          ),
        );
      })(),
      autoStorage: (() {
        final guardedValue = map['autoStorage'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoStorageBaseProperties.fromMap(
      ...
      poolAllocationMode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolAllocationMode.fromValue(guardedValue as String),
        );
      })(),
      publicNetworkAccess: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PublicNetworkAccessType.fromValue(guardedValue as String),
        );
      })(),
