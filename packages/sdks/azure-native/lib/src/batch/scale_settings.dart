...
class ScaleSettings {
  ...
  final AutoScaleSettings? autoScale;
  /// This property and autoScale are mutually exclusive and one of the properties must be specified.
  final FixedScaleSettings? fixedScale;
  ...
  factory ScaleSettings.fromMap(Map<String, dynamic> map) {
    return ScaleSettings(
      autoScale: map['autoScale'] == null ? null : AutoScaleSettings.fromMap((map['autoScale'] as Map).cast<String, dynamic>()),
      fixedScale: map['fixedScale'] == null ? null : FixedScaleSettings.fromMap((map['fixedScale'] as Map).cast<String, dynamic>()),
    );
  }
}
