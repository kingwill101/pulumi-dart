...
class NetworkSecurityGroupRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'access':
          pulumi.Input.mapInputValue<NetworkSecurityGroupRuleAccess, String>(
            access,
  ...
  factory NetworkSecurityGroupRule.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityGroupRule(
      access: pulumi.Input.fromValue(
        NetworkSecurityGroupRuleAccess.fromValue(map['access']! as String),
      ),
