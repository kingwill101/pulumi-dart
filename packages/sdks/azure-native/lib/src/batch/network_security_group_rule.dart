...
class NetworkSecurityGroupRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'access': pulumi.Input.mapInputValue<NetworkSecurityGroupRuleAccess, String>(access, (value) => value.value),
      'priority': priority,
  ...
  factory NetworkSecurityGroupRule.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityGroupRule(
      access: (NetworkSecurityGroupRuleAccess.fromValue(map['access'] as String)).input(),
