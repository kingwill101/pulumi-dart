...
class NetworkConfiguration {
  ...
  final pulumi.Input<PublicIPAddressConfiguration>?
    ...
    return <String, dynamic>{
      'dynamicVnetAssignmentScope':
          ?pulumi.Input.mapOptionalInputValue<
            DynamicVNetAssignmentScope,
            String
          >(dynamicVnetAssignmentScope, (value) => value.wireValue),
    ...
    return NetworkConfiguration(
      dynamicVnetAssignmentScope: (() {
        ...
        return pulumi.Input.fromValue(
          DynamicVNetAssignmentScope.fromValue(guardedValue as String),
        );
      })(),
      ...
      endpointConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolEndpointConfiguration.fromMap(
      ...
      publicIPAddressConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PublicIPAddressConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
