...
class NetworkConfiguration {
  ...
  NetworkConfiguration({
    pulumi.Input<DynamicVNetAssignmentScope?>? dynamicVnetAssignmentScope,
    this.enableAcceleratedNetworking,
    this.endpointConfiguration,
    this.publicIPAddressConfiguration,
    this.subnetId,
  }) : dynamicVnetAssignmentScope = dynamicVnetAssignmentScope ?? pulumi.Input.fromValue(DynamicVNetAssignmentScope.fromValue('none'));
