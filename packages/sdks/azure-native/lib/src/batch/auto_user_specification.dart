...
class AutoUserSpecification {
  ...
  AutoUserSpecification({this.elevationLevel, this.scope});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'elevationLevel':
          ?pulumi.Input.mapOptionalInputValue<ElevationLevel, String>(
            elevationLevel,
            (value) => value.wireValue,
          ),
      'scope': ?pulumi.Input.mapOptionalInputValue<AutoUserScope, String>(
        scope,
        (value) => value.wireValue,
      ),
    };
    ...
    return AutoUserSpecification(
      elevationLevel: (() {
        ...
        return pulumi.Input.fromValue(
          ElevationLevel.fromValue(guardedValue as String),
        );
      })(),
      scope: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AutoUserScope.fromValue(guardedValue as String),
        );
      })(),
    );
  }
