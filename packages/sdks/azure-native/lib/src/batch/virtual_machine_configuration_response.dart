...
class VirtualMachineConfigurationResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containerConfiguration': ?pulumi.Input.mapOptionalInputValue<ContainerConfigurationResponse, Map<String, dynamic>>(containerConfiguration, (value) => value.toMap()),
      ...
      'diskEncryptionConfiguration': ?pulumi.Input.mapOptionalInputValue<DiskEncryptionConfigurationResponse, Map<String, dynamic>>(diskEncryptionConfiguration, (value) => value.toMap()),
      'extensions': ?pulumi.Input.mapOptionalInputValue<List<VMExtensionResponse>, List<Map<String, dynamic>>>(extensions, (value) => pulumi.Input.encodeList<VMExtensionResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'nodePlacementConfiguration': ?pulumi.Input.mapOptionalInputValue<NodePlacementConfigurationResponse, Map<String, dynamic>>(nodePlacementConfiguration, (value) => value.toMap()),
  ...
  factory VirtualMachineConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineConfigurationResponse(
      containerConfiguration: (() { final guardedValue = map['containerConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      diskEncryptionConfiguration: (() { final guardedValue = map['diskEncryptionConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DiskEncryptionConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      extensions: (() { final guardedValue = map['extensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VMExtensionResponse>(guardedValue, (value) => VMExtensionResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      nodePlacementConfiguration: (() { final guardedValue = map['nodePlacementConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NodePlacementConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
