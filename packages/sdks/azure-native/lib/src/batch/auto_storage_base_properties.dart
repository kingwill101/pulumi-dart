...
class AutoStorageBaseProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authenticationMode': ?pulumi.Input.mapOptionalInputValue<AutoStorageAuthenticationMode, String>(authenticationMode, (value) => value.wireValue),
  ...
  factory AutoStorageBaseProperties.fromMap(Map<String, dynamic> map) {
    return AutoStorageBaseProperties(
      authenticationMode: (() { final guardedValue = map['authenticationMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutoStorageAuthenticationMode.fromValue(guardedValue as String)); })(),
      nodeIdentityReference: (() { final guardedValue = map['nodeIdentityReference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ComputeNodeIdentityReference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
