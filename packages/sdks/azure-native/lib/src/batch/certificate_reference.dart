...
class CertificateReference {
  ...
  final CertificateStoreLocation? storeLocation;
  ...
  final List<CertificateVisibility>? visibility;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': id,
      'storeLocation': ?storeLocation == null ? null : storeLocation!.value,
      'storeName': ?storeName,
      'visibility': ?visibility == null ? null : pulumi.Input.encodeList<CertificateVisibility, String>(visibility!, (value) => value.value),
    };
  }
  ...
  factory CertificateReference.fromMap(Map<String, dynamic> map) {
    return CertificateReference(
      id: map['id'] as String,
      storeLocation: map['storeLocation'] == null ? null : CertificateStoreLocation.fromValue(map['storeLocation'] as String),
      storeName: map['storeName'] == null ? null : map['storeName'] as String,
      visibility: map['visibility'] == null ? null : pulumi.Input.decodeList<CertificateVisibility>(map['visibility'], (value) => CertificateVisibility.fromValue(value as String)),
    );
  }
}
