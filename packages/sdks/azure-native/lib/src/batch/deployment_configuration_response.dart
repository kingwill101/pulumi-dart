...
class DeploymentConfigurationResponse {
  ...
  factory DeploymentConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentConfigurationResponse(
      virtualMachineConfiguration: (() { final guardedValue = map['virtualMachineConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualMachineConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
