    ...
    return <String, dynamic>{
      ...
      'resourceFiles':
          ...
          >(
            resourceFiles,
            (value) =>
                pulumi.Input.encodeList<ResourceFile, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory StartTask.fromMap(Map<String, dynamic> map) {
    return StartTask(
      ...
      resourceFiles: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceFile>(
            guardedValue,
            (value) =>
                ResourceFile.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      userIdentity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserIdentity.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      waitForSuccess: (() {
