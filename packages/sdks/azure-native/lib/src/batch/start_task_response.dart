    ...
    return <String, dynamic>{
      ...
      'containerSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(containerSettings, (value) => value.toMap()),
      'environmentSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnvironmentSettingResponse>,
      ...
      'userIdentity':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(userIdentity, (value) => value.toMap()),
    ...
    return StartTaskResponse(
      ...
      containerSettings: (() {
        ...
        return pulumi.Input.fromValue(
          TaskContainerSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      environmentSettings: (() {
        final guardedValue = map['environmentSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentSettingResponse>(
            guardedValue,
            (value) => EnvironmentSettingResponse.fromMap(
      ...
      maxTaskRetryCount: (() {
        final guardedValue = map['maxTaskRetryCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      resourceFiles: (() {
        final guardedValue = map['resourceFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceFileResponse>(
            guardedValue,
            (value) => ResourceFileResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      userIdentity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserIdentityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      waitForSuccess: (() {
        final guardedValue = map['waitForSuccess'];
        if (guardedValue == null) return null;
