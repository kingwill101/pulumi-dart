...
class StartTaskResponse {
  ...
  StartTaskResponse({
    ...
    pulumi.Input<int?>? maxTaskRetryCount,
    this.resourceFiles,
    this.userIdentity,
    this.waitForSuccess,
  }) : maxTaskRetryCount = maxTaskRetryCount ?? pulumi.Input.fromValue(0);
  ...
  factory StartTaskResponse.fromMap(Map<String, dynamic> map) {
    return StartTaskResponse(
      ...
      maxTaskRetryCount: (() { final guardedValue = map['maxTaskRetryCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
