...
class ListConfigurationStoreKeysResult {
  ...
  ListConfigurationStoreKeysResult({this.nextLink, this.value});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'value': ?(() {
        ...
        return pulumi.Input.encodeList<ApiKeyResponse, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory ListConfigurationStoreKeysResult.fromMap(Map<String, dynamic> map) {
    return ListConfigurationStoreKeysResult(
      ...
      value: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<ApiKeyResponse>(
          guardedValue,
          (value) =>
              ApiKeyResponse.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
