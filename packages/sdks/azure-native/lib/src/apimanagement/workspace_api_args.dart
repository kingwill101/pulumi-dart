...
class WorkspaceApiArgs {
  ...
  WorkspaceApiArgs({
    ...
    pulumi.Output<String>? apiRevision,
    pulumi.Output<String>? apiRevisionDescription,
    pulumi.Output<String>? apiType,
    pulumi.Output<String>? apiVersion,
    pulumi.Output<String>? apiVersionDescription,
    pulumi.Output<ApiVersionSetContractDetails>? apiVersionSet,
    pulumi.Output<String>? apiVersionSetId,
    pulumi.Output<AuthenticationSettingsContract>? authenticationSettings,
    pulumi.Output<ApiContactInformation>? contact,
    pulumi.Output<String>? description,
    pulumi.Output<String>? displayName,
    pulumi.Output<String>? format,
    pulumi.Output<bool>? isCurrent,
    pulumi.Output<ApiLicenseInformation>? license,
    required pulumi.Output<String> path,
    pulumi.Output<List<String>>? protocols,
    required pulumi.Output<String> resourceGroupName,
    required pulumi.Output<String> serviceName,
    pulumi.Output<String>? serviceUrl,
    pulumi.Output<String>? soapApiType,
    pulumi.Output<String>? sourceApiId,
    pulumi.Output<SubscriptionKeyParameterNamesContract>? subscriptionKeyParameterNames,
    pulumi.Output<bool>? subscriptionRequired,
    pulumi.Output<String>? termsOfServiceUrl,
    pulumi.Output<String>? translateRequiredQueryParametersConduct,
    pulumi.Output<String>? value,
    required pulumi.Output<String> workspaceId,
    pulumi.Output<ApiCreateOrUpdatePropertiesWsdlSelector>? wsdlSelector,
  }) :
  ...
  factory WorkspaceApiArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceApiArgs(
      ...
      apiRevision: map['apiRevision'] == null ? null : pulumi.Output.create<String>(map['apiRevision'] as String),
      apiRevisionDescription: map['apiRevisionDescription'] == null ? null : pulumi.Output.create<String>(map['apiRevisionDescription'] as String),
      apiType: map['apiType'] == null ? null : pulumi.Output.create<String>(map['apiType'] as String),
      apiVersion: map['apiVersion'] == null ? null : pulumi.Output.create<String>(map['apiVersion'] as String),
      apiVersionDescription: map['apiVersionDescription'] == null ? null : pulumi.Output.create<String>(map['apiVersionDescription'] as String),
      apiVersionSet: map['apiVersionSet'] == null ? null : pulumi.Output.create<ApiVersionSetContractDetails>(ApiVersionSetContractDetails.fromMap((map['apiVersionSet'] as Map).cast<String, dynamic>())),
      apiVersionSetId: map['apiVersionSetId'] == null ? null : pulumi.Output.create<String>(map['apiVersionSetId'] as String),
      authenticationSettings: map['authenticationSettings'] == null ? null : pulumi.Output.create<AuthenticationSettingsContract>(AuthenticationSettingsContract.fromMap((map['authenticationSettings'] as Map).cast<String, dynamic>())),
      contact: map['contact'] == null ? null : pulumi.Output.create<ApiContactInformation>(ApiContactInformation.fromMap((map['contact'] as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      displayName: map['displayName'] == null ? null : pulumi.Output.create<String>(map['displayName'] as String),
      format: map['format'] == null ? null : pulumi.Output.create<String>(map['format'] as String),
      isCurrent: map['isCurrent'] == null ? null : pulumi.Output.create<bool>(map['isCurrent'] as bool),
      license: map['license'] == null ? null : pulumi.Output.create<ApiLicenseInformation>(ApiLicenseInformation.fromMap((map['license'] as Map).cast<String, dynamic>())),
      ...
      soapApiType: map['soapApiType'] == null ? null : pulumi.Output.create<String>(map['soapApiType'] as String),
      sourceApiId: map['sourceApiId'] == null ? null : pulumi.Output.create<String>(map['sourceApiId'] as String),
      subscriptionKeyParameterNames: map['subscriptionKeyParameterNames'] == null ? null : pulumi.Output.create<SubscriptionKeyParameterNamesContract>(SubscriptionKeyParameterNamesContract.fromMap((map['subscriptionKeyParameterNames'] as Map).cast<String, dynamic>())),
      ...
      translateRequiredQueryParametersConduct: map['translateRequiredQueryParametersConduct'] == null ? null : pulumi.Output.create<String>(map['translateRequiredQueryParametersConduct'] as String),
      value: map['value'] == null ? null : pulumi.Output.create<String>(map['value'] as String),
      workspaceId: pulumi.Output.create<String>(map['workspaceId'] as String),
      wsdlSelector: map['wsdlSelector'] == null ? null : pulumi.Output.create<ApiCreateOrUpdatePropertiesWsdlSelector>(ApiCreateOrUpdatePropertiesWsdlSelector.fromMap((map['wsdlSelector'] as Map).cast<String, dynamic>())),
    );
  }
}
