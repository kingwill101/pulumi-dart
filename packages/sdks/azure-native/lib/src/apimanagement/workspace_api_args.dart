...
class WorkspaceApiArgs {
  ...
  final pulumi.Input<SubscriptionKeyParameterNamesContract>?
    ...
    return <String, dynamic>{
      ...
      'apiVersionSet':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(apiVersionSet, (value) => value.toMap()),
      'apiVersionSetId': ?apiVersionSetId,
      'authenticationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            AuthenticationSettingsContract,
            Map<String, dynamic>
          >(authenticationSettings, (value) => value.toMap()),
      'contact':
          ?pulumi.Input.mapOptionalInputValue<
            ApiContactInformation,
            Map<String, dynamic>
          >(contact, (value) => value.toMap()),
      ...
      'wsdlSelector':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(wsdlSelector, (value) => value.toMap()),
    };
  }
  ...
  factory WorkspaceApiArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceApiArgs(
      ...
      apiRevision: (() {
        final guardedValue = map['apiRevision'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      apiRevisionDescription: (() {
        final guardedValue = map['apiRevisionDescription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      apiType: (() {
      ...
      apiVersionDescription: (() {
        final guardedValue = map['apiVersionDescription'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      apiVersionSet: (() {
        final guardedValue = map['apiVersionSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApiVersionSetContractDetails.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      apiVersionSetId: (() {
        final guardedValue = map['apiVersionSetId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      authenticationSettings: (() {
        final guardedValue = map['authenticationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AuthenticationSettingsContract.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      soapApiType: (() {
        final guardedValue = map['soapApiType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceApiId: (() {
      ...
      subscriptionKeyParameterNames: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubscriptionKeyParameterNamesContract.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      translateRequiredQueryParametersConduct: (() {
        final guardedValue = map['translateRequiredQueryParametersConduct'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      value: (() {
      ...
      wsdlSelector: (() {
        final guardedValue = map['wsdlSelector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApiCreateOrUpdatePropertiesWsdlSelector.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
