...
import 'workspace_tag_product_link_args.dart';
...
/// 			ProductId:         pulumi.String("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/products/product1"),
...
/// }
///
/// resource "azure-native_apimanagement_workspacetagproductlink" "workspaceTagProductLink" {
///   product_id          = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/products/product1"
...
/// ```
class WorkspaceTagProductLink extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkspaceTagProductLink].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkspaceTagProductLink]. {@macro pulumi_apimanagement_workspace_tag_product_link_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkspaceTagProductLink(
    String name, {
    WorkspaceTagProductLinkArgs? args,
  ...
  /// Creates a typed reference to an existing [WorkspaceTagProductLink] resource.
  WorkspaceTagProductLink.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceTagProductLink',
