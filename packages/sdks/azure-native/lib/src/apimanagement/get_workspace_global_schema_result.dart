...
/// Result data returned by getWorkspaceGlobalSchema.
class GetWorkspaceGlobalSchemaResult {
  ...
  /// Creates a new [GetWorkspaceGlobalSchemaResult].
  ...
  factory GetWorkspaceGlobalSchemaResult.fromMap(Map<String, dynamic> map) {
