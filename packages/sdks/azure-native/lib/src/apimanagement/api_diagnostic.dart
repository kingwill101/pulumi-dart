...
/// }
///
/// resource "azure-native_apimanagement_apidiagnostic" "apiDiagnostic" {
...
class ApiDiagnostic extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ApiDiagnostic]. {@macro pulumi_apimanagement_api_diagnostic_args_doc}
