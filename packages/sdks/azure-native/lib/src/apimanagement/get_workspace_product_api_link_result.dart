...
/// Result data returned by getWorkspaceProductApiLink.
class GetWorkspaceProductApiLinkResult {
  ...
  factory GetWorkspaceProductApiLinkResult.fromMap(Map<String, dynamic> map) {
