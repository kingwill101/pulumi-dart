...
/// }
///
/// resource "azure-native_apimanagement_workspaceapidiagnostic" "workspaceApiDiagnostic" {
...
class WorkspaceApiDiagnostic extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WorkspaceApiDiagnostic] resource.
  WorkspaceApiDiagnostic.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceApiDiagnostic',
