...
/// {@template pulumi_apimanagement_subscription_args_doc}
/// The set of arguments for Subscription.
/// {@endtemplate}
/// {@macro pulumi_apimanagement_subscription_args_doc}
class SubscriptionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sid': ?sid,
      'state': ?pulumi.Input.mapOptionalInputValue<SubscriptionState, String>(
        state,
    ...
    return SubscriptionArgs(
      ...
      state: (() {
        ...
        return pulumi.Input.fromValue(
          SubscriptionState.fromValue(guardedValue as String),
        );
      })(),
    );
  }
