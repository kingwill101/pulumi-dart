...
/// Result data returned by getWorkspaceApiOperationPolicy.
class GetWorkspaceApiOperationPolicyResult {
  ...
  /// Creates a new [GetWorkspaceApiOperationPolicyResult].
  ...
  const GetWorkspaceApiOperationPolicyResult({
  ...
  factory GetWorkspaceApiOperationPolicyResult.fromMap(Map<String, dynamic> map) {
