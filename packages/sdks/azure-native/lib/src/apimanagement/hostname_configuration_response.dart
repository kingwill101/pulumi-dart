...
class HostnameConfigurationResponse {
  ...
  HostnameConfigurationResponse({
    ...
    pulumi.Input<bool?>? defaultSslBinding,
    this.encodedCertificate,
    required this.hostName,
    this.identityClientId,
    this.keyVaultId,
    pulumi.Input<bool?>? negotiateClientCertificate,
    required this.type,
  }) : defaultSslBinding = defaultSslBinding ?? pulumi.Input.fromValue(false), negotiateClientCertificate = negotiateClientCertificate ?? pulumi.Input.fromValue(false);
