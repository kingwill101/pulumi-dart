...
/// Result data returned by getGraphQLApiResolverPolicy.
class GetGraphQLApiResolverPolicyResult {
  ...
  /// Creates a new [GetGraphQLApiResolverPolicyResult].
  ...
  const GetGraphQLApiResolverPolicyResult({
  ...
  factory GetGraphQLApiResolverPolicyResult.fromMap(Map<String, dynamic> map) {
