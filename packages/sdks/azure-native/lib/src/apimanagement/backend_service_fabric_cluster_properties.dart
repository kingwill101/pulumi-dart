...
class BackendServiceFabricClusterProperties {
  ...
  factory BackendServiceFabricClusterProperties.fromMap(Map<String, dynamic> map) {
    return BackendServiceFabricClusterProperties(
      ...
      serverX509Names: (() { final guardedValue = map['serverX509Names']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<X509CertificateName>(guardedValue, (value) => X509CertificateName.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
