...
class PolicyRestrictionArgs {
  ...
  final pulumi.Input<dynamic>? requireBase;
  ...
  PolicyRestrictionArgs({
    ...
    pulumi.Input<dynamic>? requireBase,
    required this.resourceGroupName,
    this.scope,
    required this.serviceName,
  }) : requireBase = requireBase ?? pulumi.Input.fromValue('false');
  ...
  factory PolicyRestrictionArgs.fromMap(Map<String, dynamic> map) {
    return PolicyRestrictionArgs(
      ...
      requireBase: (() { final guardedValue = map['requireBase']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
