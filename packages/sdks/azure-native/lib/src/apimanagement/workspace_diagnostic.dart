...
/// }
///
/// resource "azure-native_apimanagement_workspacediagnostic" "workspaceDiagnostic" {
...
class WorkspaceDiagnostic extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WorkspaceDiagnostic] resource.
  WorkspaceDiagnostic.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceDiagnostic',
