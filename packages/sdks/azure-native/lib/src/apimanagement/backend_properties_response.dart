...
class BackendPropertiesResponse {
  ...
  final pulumi.Input<BackendServiceFabricClusterPropertiesResponse>?
  serviceFabricCluster;

  /// Creates a new [BackendPropertiesResponse].
  /// [serviceFabricCluster] Backend Service Fabric Cluster Properties
  BackendPropertiesResponse({this.serviceFabricCluster});
    ...
    return BackendPropertiesResponse(
      serviceFabricCluster: (() {
        ...
        return pulumi.Input.fromValue(
          BackendServiceFabricClusterPropertiesResponse.fromMap(
