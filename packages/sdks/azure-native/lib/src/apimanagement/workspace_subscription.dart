...
import 'workspace_subscription_args.dart';
...
class WorkspaceSubscription extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkspaceSubscription].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkspaceSubscription]. {@macro pulumi_apimanagement_workspace_subscription_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkspaceSubscription(
    String name, {
    WorkspaceSubscriptionArgs? args,
  ...
  /// Creates a typed reference to an existing [WorkspaceSubscription] resource.
  WorkspaceSubscription.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceSubscription',
