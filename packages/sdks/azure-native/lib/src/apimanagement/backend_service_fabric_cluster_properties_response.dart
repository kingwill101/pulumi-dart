...
class BackendServiceFabricClusterPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'serverX509Names':
          ?pulumi.Input.mapOptionalInputValue<
            List<X509CertificateNameResponse>,
  ...
  factory BackendServiceFabricClusterPropertiesResponse.fromMap(
    ...
    return BackendServiceFabricClusterPropertiesResponse(
      ...
      serverX509Names: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<X509CertificateNameResponse>(
            guardedValue,
            (value) => X509CertificateNameResponse.fromMap(
