...
class RepresentationContractResponse {
  ...
  const RepresentationContractResponse({
  ...
  factory RepresentationContractResponse.fromMap(Map<String, dynamic> map) {
    return RepresentationContractResponse(
      ...
      examples: (() { final guardedValue = map['examples']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<ParameterExampleContractResponse>(guardedValue, (value) => ParameterExampleContractResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      formParameters: (() { final guardedValue = map['formParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ParameterContractResponse>(guardedValue, (value) => ParameterContractResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
