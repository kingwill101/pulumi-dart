...
/// }
///
/// resource "azure-native_apimanagement_notificationrecipientemail" "notificationRecipientEmail" {
///   email               = "foobar@live.com"
...
class NotificationRecipientEmail extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NotificationRecipientEmail]. {@macro pulumi_apimanagement_notification_recipient_email_args_doc}
