...
import 'workspace_product_args.dart';
...
/// ```
class WorkspaceProduct extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkspaceProduct].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkspaceProduct]. {@macro pulumi_apimanagement_workspace_product_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkspaceProduct(
    String name, {
    WorkspaceProductArgs? args,
    ...
    this.approvalRequired = registerOutput<bool?>('approvalRequired');
    ...
    this.subscriptionsLimit = registerOutput<int?>('subscriptionsLimit');
    this.terms = registerOutput<String?>('terms');
