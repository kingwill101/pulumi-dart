...
import 'workspace_tag_api_link_args.dart';
...
/// }
///
/// resource "azure-native_apimanagement_workspacetagapilink" "workspaceTagApiLink" {
...
/// ```
class WorkspaceTagApiLink extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkspaceTagApiLink].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkspaceTagApiLink]. {@macro pulumi_apimanagement_workspace_tag_api_link_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkspaceTagApiLink(
    String name, {
    WorkspaceTagApiLinkArgs? args,
  ...
  /// Creates a typed reference to an existing [WorkspaceTagApiLink] resource.
  WorkspaceTagApiLink.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceTagApiLink',
