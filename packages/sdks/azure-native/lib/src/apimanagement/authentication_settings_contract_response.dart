...
class AuthenticationSettingsContractResponse {
  ...
  final pulumi.Input<List<OAuth2AuthenticationSettingsContractResponse>>?
  ...
  final pulumi.Input<List<OpenIdAuthenticationSettingsContractResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oAuth2AuthenticationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<OAuth2AuthenticationSettingsContractResponse>,
      ...
      'openid':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(openid, (value) => value.toMap()),
      'openidAuthenticationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<OpenIdAuthenticationSettingsContractResponse>,
            List<Map<String, dynamic>>
          >(
            openidAuthenticationSettings,
            (value) =>
  ...
  factory AuthenticationSettingsContractResponse.fromMap(
    ...
    return AuthenticationSettingsContractResponse(
      oAuth2: (() {
        ...
        return pulumi.Input.fromValue(
          OAuth2AuthenticationSettingsContractResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      oAuth2AuthenticationSettings: (() {
        final guardedValue = map['oAuth2AuthenticationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OAuth2AuthenticationSettingsContractResponse>(
            guardedValue,
            (value) => OAuth2AuthenticationSettingsContractResponse.fromMap(
      ...
      openid: (() {
        final guardedValue = map['openid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OpenIdAuthenticationSettingsContractResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      openidAuthenticationSettings: (() {
        final guardedValue = map['openidAuthenticationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OpenIdAuthenticationSettingsContractResponse>(
            guardedValue,
            (value) => OpenIdAuthenticationSettingsContractResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
