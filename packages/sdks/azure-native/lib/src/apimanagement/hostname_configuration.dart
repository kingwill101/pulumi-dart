...
class HostnameConfiguration {
  ...
  /// Certificate Source.
  final pulumi.Input<dynamic>? certificateSource;
  /// Certificate Status.
  final pulumi.Input<dynamic>? certificateStatus;
  ...
  factory HostnameConfiguration.fromMap(Map<String, dynamic> map) {
    return HostnameConfiguration(
      ...
      certificateSource: (() { final guardedValue = map['certificateSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      certificateStatus: (() { final guardedValue = map['certificateStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
