...
/// Result data returned by getPrivateEndpointConnectionByName.
class GetPrivateEndpointConnectionByNameResult {
  ...
  /// Creates a new [GetPrivateEndpointConnectionByNameResult].
  ...
  const GetPrivateEndpointConnectionByNameResult({
