...
/// }
///
/// resource "azure-native_apimanagement_productwiki" "productWiki" {
///   documents {
...
class ProductWiki extends pulumi.CustomResource {
  ...
  /// Creates a new [ProductWiki].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProductWiki]. {@macro pulumi_apimanagement_product_wiki_args_doc}
  ...
  /// Creates a typed reference to an existing [ProductWiki] resource.
  ProductWiki.reference(String urn)
    : super(
        'azure-native:apimanagement:ProductWiki',
