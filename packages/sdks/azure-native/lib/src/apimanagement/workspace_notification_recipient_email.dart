...
/// }
///
/// resource "azure-native_apimanagement_workspacenotificationrecipientemail" "workspaceNotificationRecipientEmail" {
///   email               = "foobar@live.com"
...
class WorkspaceNotificationRecipientEmail extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WorkspaceNotificationRecipientEmail] resource.
  WorkspaceNotificationRecipientEmail.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceNotificationRecipientEmail',
