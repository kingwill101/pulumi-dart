...
class BackendBaseParametersPool {
  ...
  BackendBaseParametersPool({this.services});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'services':
          ?pulumi.Input.mapOptionalInputValue<
            List<BackendPoolItem>,
            List<Map<String, dynamic>>
          >(
            services,
            (value) =>
                pulumi.Input.encodeList<BackendPoolItem, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return BackendBaseParametersPool(
      services: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BackendPoolItem>(
            guardedValue,
            (value) =>
                BackendPoolItem.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
