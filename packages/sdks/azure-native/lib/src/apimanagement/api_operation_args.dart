...
class ApiOperationArgs {
  ...
  factory ApiOperationArgs.fromMap(Map<String, dynamic> map) {
    return ApiOperationArgs(
      ...
      request: (() { final guardedValue = map['request']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RequestContract.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      responses: (() { final guardedValue = map['responses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResponseContract>(guardedValue, (value) => ResponseContract.fromMap((value as Map).cast<String, dynamic>()))); })(),
      serviceName: pulumi.Input.fromValue(map['serviceName'] as String),
      templateParameters: (() { final guardedValue = map['templateParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ParameterContract>(guardedValue, (value) => ParameterContract.fromMap((value as Map).cast<String, dynamic>()))); })(),
