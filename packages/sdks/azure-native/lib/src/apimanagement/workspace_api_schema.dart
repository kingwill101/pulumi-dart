...
import 'workspace_api_schema_args.dart';
...
/// }
///
/// resource "azure-native_apimanagement_workspaceapischema" "workspaceApiSchema" {
...
class WorkspaceApiSchema extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkspaceApiSchema].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkspaceApiSchema]. {@macro pulumi_apimanagement_workspace_api_schema_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkspaceApiSchema(
    String name, {
    WorkspaceApiSchemaArgs? args,
  ...
  /// Creates a typed reference to an existing [WorkspaceApiSchema] resource.
  WorkspaceApiSchema.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceApiSchema',
