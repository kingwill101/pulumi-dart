...
class GatewayHostnameBindingKeyVaultResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lastStatus': ?pulumi.Input.mapOptionalInputValue<GatewayHostnameBindingKeyVaultLastStatusResponse, Map<String, dynamic>>(lastStatus, (value) => value.toMap()),
      'secretId': secretId,
    };
  }
  ...
  factory GatewayHostnameBindingKeyVaultResponse.fromMap(Map<String, dynamic> map) {
    return GatewayHostnameBindingKeyVaultResponse(
      ...
      lastStatus: (() { final guardedValue = map['lastStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GatewayHostnameBindingKeyVaultLastStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
