...
class WorkspaceBackendArgs {
    ...
    return <String, dynamic>{
      ...
      'circuitBreaker':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(circuitBreaker, (value) => value.toMap()),
      'credentials':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory WorkspaceBackendArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceBackendArgs(
      backendId: (() {
        final guardedValue = map['backendId'];
      ...
      credentials: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendCredentialsContract.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      pool: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BackendBaseParametersPool.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
