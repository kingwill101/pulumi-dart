...
class WorkspaceBackendArgs {
  ...
  WorkspaceBackendArgs({
    ...
    pulumi.Output<BackendBaseParametersPool>? pool,
  ...
  factory WorkspaceBackendArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceBackendArgs(
      ...
      pool: map['pool'] == null ? null : pulumi.Output.create<BackendBaseParametersPool>(BackendBaseParametersPool.fromMap((map['pool'] as Map).cast<String, dynamic>())),
