...
/// }
///
/// resource "azure-native_apimanagement_workspacegroup" "workspaceGroup" {
...
class WorkspaceGroup extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [WorkspaceGroup] resource.
  WorkspaceGroup.reference(String urn)
    : super(
        'azure-native:apimanagement:WorkspaceGroup',
