...
class GetAuthorizationServerResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tokenBodyParameters': ?(() {
        final guardedValue = tokenBodyParameters;
  ...
  factory GetAuthorizationServerResult.fromMap(Map<String, dynamic> map) {
    return GetAuthorizationServerResult(
      ...
      tokenBodyParameters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<TokenBodyParameterContractResponse>(
          guardedValue,
          (value) => TokenBodyParameterContractResponse.fromMap(
