...
/// }
///
/// resource "azure-native_apimanagement_apimanagementservice" "apiManagementService" {
...
///         {
///             Capacity = 1,
///             Name = AzureNative.ApiManagement.SkuType.StandardV2,
///         },
///         Tags =
///         {
///             { "tag1", "value1" },
...
/// 			Sku: &apimanagement.ApiManagementServiceSkuPropertiesArgs{
/// 				Capacity: pulumi.Int(1),
/// 				Name:     pulumi.String(apimanagement.SkuTypeStandardV2),
/// 			},
/// 			Tags: pulumi.StringMap{
/// 				"tag1": pulumi.String("value1"),
/// 				"tag2": pulumi.String("value2"),
...
///     sku: {
///         capacity: 1,
///         name: azure_native.apimanagement.SkuType.StandardV2,
///     },
///     tags: {
///         tag1: "value1",
///         tag2: "value2",
...
///     sku={
///         "capacity": 1,
///         "name": azure_native.apimanagement.SkuType.STANDARD_V2,
///     },
///     tags={
///         "tag1": "value1",
///         "tag2": "value2",
...
///     var apiManagementService = new AzureNative.ApiManagement.ApiManagementService("apiManagementService", new()
///     {
///         DeveloperPortalStatus = AzureNative.ApiManagement.DeveloperPortalStatus.Enabled,
///         Location = "South Central US",
///         PublisherEmail = "foo@contoso.com",
///         PublisherName = "foo",
///         ResourceGroupName = "rg1",
...
/// 	pulumi.Run(func(ctx *pulumi.Context) error {
/// 		_, err := apimanagement.NewApiManagementService(ctx, "apiManagementService", &apimanagement.ApiManagementServiceArgs{
/// 			DeveloperPortalStatus: pulumi.String(apimanagement.DeveloperPortalStatusEnabled),
/// 			Location:              pulumi.String("South Central US"),
/// 			PublisherEmail:        pulumi.String("foo@contoso.com"),
/// 			PublisherName:         pulumi.String("foo"),
/// 			ResourceGroupName:     pulumi.String("rg1"),
...
///
/// const apiManagementService = new azure_native.apimanagement.ApiManagementService("apiManagementService", {
///     developerPortalStatus: azure_native.apimanagement.DeveloperPortalStatus.Enabled,
///     location: "South Central US",
///     publisherEmail: "foo@contoso.com",
///     publisherName: "foo",
///     resourceGroupName: "rg1",
...
///
/// api_management_service = azure_native.apimanagement.ApiManagementService("apiManagementService",
///     developer_portal_status=azure_native.apimanagement.DeveloperPortalStatus.ENABLED,
///     location="South Central US",
///     publisher_email="foo@contoso.com",
///     publisher_name="foo",
///     resource_group_name="rg1",
...
///             UserAssignedIdentities =
///             {
///                 { "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/apimService1", null },
///             },
///         },
///         Location = "West US",
///         PublisherEmail = "apim@autorestsdk.com",
...
/// 				Type: pulumi.String(apimanagement.ApimIdentityTypeUserAssigned),
/// 				UserAssignedIdentities: apimanagement.UserIdentityPropertiesMap{
/// 					"/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/apimService1": &apimanagement.UserIdentityPropertiesArgs{},
/// 				},
/// 			},
/// 			Location:          pulumi.String("West US"),
/// 			PublisherEmail:    pulumi.String("apim@autorestsdk.com"),
...
///             .identity(ApiManagementServiceIdentityArgs.builder()
///                 .type("UserAssigned")
///                 .userAssignedIdentities(Map.of("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/apimService1", UserIdentityPropertiesArgs.builder()
///                     .build()))
///                 .build())
///             .location("West US")
///             .publisherEmail("apim@autorestsdk.com")
...
///     var apiManagementService = new AzureNative.ApiManagement.ApiManagementService("apiManagementService", new()
///     {
///         ConfigurationApi = new AzureNative.ApiManagement.Inputs.ConfigurationApiArgs
///         {
///             LegacyApi = AzureNative.ApiManagement.LegacyApiState.Disabled,
///         },
///         Location = "Central US",
///         PublisherEmail = "apim@autorestsdk.com",
///         PublisherName = "autorestsdk",
...
/// 	pulumi.Run(func(ctx *pulumi.Context) error {
/// 		_, err := apimanagement.NewApiManagementService(ctx, "apiManagementService", &apimanagement.ApiManagementServiceArgs{
/// 			ConfigurationApi: &apimanagement.ConfigurationApiArgs{
/// 				LegacyApi: pulumi.String(apimanagement.LegacyApiStateDisabled),
/// 			},
/// 			Location:          pulumi.String("Central US"),
/// 			PublisherEmail:    pulumi.String("apim@autorestsdk.com"),
/// 			PublisherName:     pulumi.String("autorestsdk"),
...
/// import com.pulumi.azurenative.apimanagement.ApiManagementService;
/// import com.pulumi.azurenative.apimanagement.ApiManagementServiceArgs;
/// import com.pulumi.azurenative.apimanagement.inputs.ConfigurationApiArgs;
/// import com.pulumi.azurenative.apimanagement.inputs.ApiManagementServiceSkuPropertiesArgs;
/// import java.util.ArrayList;
/// import java.util.Arrays;
/// import java.util.Map;
...
///     public static void stack(Context ctx) {
///         var apiManagementService = new ApiManagementService("apiManagementService", ApiManagementServiceArgs.builder()
///             .configurationApi(ConfigurationApiArgs.builder()
///                 .legacyApi("Disabled")
///                 .build())
///             .location("Central US")
///             .publisherEmail("apim@autorestsdk.com")
...
/// const apiManagementService = new azure_native.apimanagement.ApiManagementService("apiManagementService", {
///     configurationApi: {
///         legacyApi: azure_native.apimanagement.LegacyApiState.Disabled,
///     },
///     location: "Central US",
///     publisherEmail: "apim@autorestsdk.com",
///     publisherName: "autorestsdk",
...
/// api_management_service = azure_native.apimanagement.ApiManagementService("apiManagementService",
///     configuration_api={
///         "legacy_api": azure_native.apimanagement.LegacyApiState.DISABLED,
///     },
///     location="Central US",
///     publisher_email="apim@autorestsdk.com",
///     publisher_name="autorestsdk",
...
class ApiManagementService extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String?> developerPortalStatus;
  ...
  late final pulumi.Output<String?> legacyPortalStatus;
  /// Resource location.
