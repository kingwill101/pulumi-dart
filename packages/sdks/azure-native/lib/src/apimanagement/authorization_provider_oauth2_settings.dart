...
class AuthorizationProviderOAuth2Settings {
  ...
  AuthorizationProviderOAuth2Settings({this.grantTypes, this.redirectUrl});
  ...
  factory AuthorizationProviderOAuth2Settings.fromMap(
    ...
    return AuthorizationProviderOAuth2Settings(
      grantTypes: (() {
        ...
        return pulumi.Input.fromValue(
          AuthorizationProviderOAuth2GrantTypes.fromMap(
