...
class AuthorizationServerArgs {
  ...
  factory AuthorizationServerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationServerArgs(
      ...
      authorizationMethods: map['authorizationMethods'] == null ? null : (pulumi.Input.decodeList<AuthorizationMethod>(map['authorizationMethods'], (value) => AuthorizationMethod.fromValue(value as String))).input(),
      authsid: map['authsid'] == null ? null : (map['authsid'] as String).input(),
      ...
      clientAuthenticationMethod: map['clientAuthenticationMethod'] == null ? null : ((map['clientAuthenticationMethod'] as List).cast<String>()).input(),
      clientId: (map['clientId'] as String).input(),
      clientRegistrationEndpoint: (map['clientRegistrationEndpoint'] as String).input(),
      clientSecret: map['clientSecret'] == null ? null : (map['clientSecret'] as String).input(),
      defaultScope: map['defaultScope'] == null ? null : (map['defaultScope'] as String).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      displayName: (map['displayName'] as String).input(),
      grantTypes: ((map['grantTypes'] as List).cast<String>()).input(),
      ...
      tokenBodyParameters: map['tokenBodyParameters'] == null ? null : (pulumi.Input.decodeList<TokenBodyParameterContract>(map['tokenBodyParameters'], (value) => TokenBodyParameterContract.fromMap((value as Map).cast<String, dynamic>()))).input(),
