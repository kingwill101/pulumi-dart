...
class AuthorizationServerArgs {
  ...
  final pulumi.Input<List<dynamic>?>? clientAuthenticationMethod;
  ...
  final pulumi.Input<List<dynamic>> grantTypes;
  ...
  factory AuthorizationServerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationServerArgs(
      ...
      clientAuthenticationMethod: (() { final guardedValue = map['clientAuthenticationMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
      ...
      grantTypes: pulumi.Input.fromValue((map['grantTypes'] as List).cast<dynamic>()),
