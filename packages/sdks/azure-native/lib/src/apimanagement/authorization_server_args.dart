...
class AuthorizationServerArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authorizationMethods':
          ...
          >(
            authorizationMethods,
            (value) => pulumi.Input.encodeList<AuthorizationMethod, String>(
              value,
      ...
      'tokenBodyParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<TokenBodyParameterContract>,
  ...
  factory AuthorizationServerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationServerArgs(
      ...
      authorizationMethods: (() {
        final guardedValue = map['authorizationMethods'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AuthorizationMethod>(
            guardedValue,
            (value) => AuthorizationMethod.fromValue(value as String),
          ),
        );
      })(),
      authsid: (() {
        final guardedValue = map['authsid'];
        if (guardedValue == null) return null;
      ...
      clientAuthenticationMethod: (() {
        final guardedValue = map['clientAuthenticationMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      clientId: pulumi.Input.fromValue(map['clientId'] as String),
      clientRegistrationEndpoint: pulumi.Input.fromValue(
        map['clientRegistrationEndpoint'] as String,
      ),
      clientSecret: (() {
      ...
      defaultScope: (() {
        final guardedValue = map['defaultScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      grantTypes: pulumi.Input.fromValue(
        (map['grantTypes'] as List).cast<String>(),
      ),
      ...
      supportState: (() {
        final guardedValue = map['supportState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      tokenBodyParameters: (() {
        final guardedValue = map['tokenBodyParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TokenBodyParameterContract>(
            guardedValue,
            (value) => TokenBodyParameterContract.fromMap(
