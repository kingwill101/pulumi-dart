...
class DataMaskingResponse {
  ...
  DataMaskingResponse({this.headers, this.queryParams});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataMaskingEntityResponse>,
    ...
    return DataMaskingResponse(
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataMaskingEntityResponse>(
            guardedValue,
            (value) => DataMaskingEntityResponse.fromMap(
