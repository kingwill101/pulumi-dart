...
/// Result data returned by getWorkspaceApiPolicy.
class GetWorkspaceApiPolicyResult {
  ...
  /// Creates a new [GetWorkspaceApiPolicyResult].
  ...
  const GetWorkspaceApiPolicyResult({
  ...
  factory GetWorkspaceApiPolicyResult.fromMap(Map<String, dynamic> map) {
