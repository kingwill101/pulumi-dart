...
/// }
///
/// resource "azure-native_apimanagement_tagbyoperation" "tagByOperation" {
...
class TagByOperation extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [TagByOperation] resource.
  TagByOperation.reference(String urn)
    : super(
        'azure-native:apimanagement:TagByOperation',
