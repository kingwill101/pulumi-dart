...
class AuthenticationSettingsContract {
  ...
  final pulumi.Input<List<OAuth2AuthenticationSettingsContract>>?
  ...
  final pulumi.Input<List<OpenIdAuthenticationSettingsContract>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oAuth2AuthenticationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<OAuth2AuthenticationSettingsContract>,
      ...
      'openidAuthenticationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<OpenIdAuthenticationSettingsContract>,
            List<Map<String, dynamic>>
          >(
            openidAuthenticationSettings,
            (value) =>
    ...
    return AuthenticationSettingsContract(
      oAuth2: (() {
        ...
        return pulumi.Input.fromValue(
          OAuth2AuthenticationSettingsContract.fromMap(
      ...
      oAuth2AuthenticationSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OAuth2AuthenticationSettingsContract>(
            guardedValue,
            (value) => OAuth2AuthenticationSettingsContract.fromMap(
      ...
      openid: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OpenIdAuthenticationSettingsContract.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      openidAuthenticationSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OpenIdAuthenticationSettingsContract>(
            guardedValue,
            (value) => OpenIdAuthenticationSettingsContract.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
