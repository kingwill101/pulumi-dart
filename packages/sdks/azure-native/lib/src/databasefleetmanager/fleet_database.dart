...
class FleetDatabase extends pulumi.CustomResource {
  ...
  FleetDatabase(
    ...
    properties = registerOutput<FleetDatabasePropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return FleetDatabasePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [FleetDatabase] resource.
  FleetDatabase.reference(String urn)
    : super(
        'azure-native:databasefleetmanager:FleetDatabase',
