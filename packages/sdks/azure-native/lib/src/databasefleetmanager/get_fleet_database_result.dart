...
class GetFleetDatabaseResult {
  ...
  factory GetFleetDatabaseResult.fromMap(Map<String, dynamic> map) {
    return GetFleetDatabaseResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return FleetDatabasePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
