...
class GetFleetspaceResult {
  ...
  final FleetspacePropertiesResponse? properties;
  ...
  factory GetFleetspaceResult.fromMap(Map<String, dynamic> map) {
    return GetFleetspaceResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return FleetspacePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
