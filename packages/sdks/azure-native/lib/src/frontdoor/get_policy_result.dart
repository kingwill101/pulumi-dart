...
class GetPolicyResult {
    ...
    return <String, dynamic>{
      ...
      'frontendEndpointLinks':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(frontendEndpointLinks, (value) => value.toMap()),
      'id': id,
      'location': ?location,
      ...
      'routingRuleLinks':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(routingRuleLinks, (value) => value.toMap()),
      'securityPolicyLinks':
          pulumi.Input.encodeList<
            SecurityPolicyLinkResponse,
            Map<String, dynamic>
          >(securityPolicyLinks, (value) => value.toMap()),
      'sku': ?sku?.toMap(),
      'tags': ?tags,
      'type': type,
    };
  ...
  factory GetPolicyResult.fromMap(Map<String, dynamic> map) {
    return GetPolicyResult(
      ...
      frontendEndpointLinks:
          pulumi.Input.decodeList<FrontendEndpointLinkResponse>(
            map['frontendEndpointLinks']!,
            (value) => FrontendEndpointLinkResponse.fromMap(
      ...
      routingRuleLinks: pulumi.Input.decodeList<RoutingRuleLinkResponse>(
        map['routingRuleLinks']!,
        (value) => RoutingRuleLinkResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      securityPolicyLinks: pulumi.Input.decodeList<SecurityPolicyLinkResponse>(
        map['securityPolicyLinks']!,
        (value) => SecurityPolicyLinkResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      sku: (() {
