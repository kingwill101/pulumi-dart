...
class RoutingRule {
  ...
  final pulumi.Input<List<dynamic>?>? acceptedProtocols;
  ...
  factory RoutingRule.fromMap(Map<String, dynamic> map) {
    return RoutingRule(
      acceptedProtocols: (() { final guardedValue = map['acceptedProtocols']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
