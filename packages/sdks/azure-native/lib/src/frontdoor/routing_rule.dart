...
class RoutingRule {
    ...
    return <String, dynamic>{
      ...
      'routeConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(routeConfiguration, (value) => value.toMap()),
      'rulesEngine':
          ?pulumi.Input.mapOptionalInputValue<
            SubResource,
            Map<String, dynamic>
          >(rulesEngine, (value) => value.toMap()),
      'webApplicationFirewallPolicyLink':
          ?pulumi.Input.mapOptionalInputValue<
            RoutingRuleUpdateParametersWebApplicationFirewallPolicyLink,
            Map<String, dynamic>
  ...
  factory RoutingRule.fromMap(Map<String, dynamic> map) {
    return RoutingRule(
      acceptedProtocols: (() {
        final guardedValue = map['acceptedProtocols'];
      ...
      routeConfiguration: (() {
        final guardedValue = map['routeConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rulesEngine: (() {
        final guardedValue = map['rulesEngine'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      webApplicationFirewallPolicyLink: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RoutingRuleUpdateParametersWebApplicationFirewallPolicyLink.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
