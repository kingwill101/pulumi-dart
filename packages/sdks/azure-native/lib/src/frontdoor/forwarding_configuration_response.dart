...
class ForwardingConfigurationResponse {
  ...
  const ForwardingConfigurationResponse({
    this.backendPool,
  ...
  factory ForwardingConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return ForwardingConfigurationResponse(
      backendPool: (() { final guardedValue = map['backendPool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubResourceResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cacheConfiguration: (() { final guardedValue = map['cacheConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheConfigurationResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
