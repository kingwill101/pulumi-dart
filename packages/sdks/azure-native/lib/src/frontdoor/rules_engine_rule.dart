...
class RulesEngineRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action':
          pulumi.Input.mapInputValue<RulesEngineAction, Map<String, dynamic>>(
            action,
            (value) => value.toMap(),
          ),
      'matchConditions':
          ?pulumi.Input.mapOptionalInputValue<
            List<RulesEngineMatchCondition>,
    ...
    return RulesEngineRule(
      ...
      matchConditions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RulesEngineMatchCondition>(
            guardedValue,
            (value) => RulesEngineMatchCondition.fromMap(
      ...
      matchProcessingBehavior: (() {
        final guardedValue = map['matchProcessingBehavior'];
        if (guardedValue == null) return null;
