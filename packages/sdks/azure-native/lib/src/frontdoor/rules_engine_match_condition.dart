...
class RulesEngineMatchCondition {
  ...
  /// Match Variable
  final pulumi.Input<dynamic> rulesEngineMatchVariable;
  /// Describes operator to apply to the match condition.
  final pulumi.Input<dynamic> rulesEngineOperator;
  ...
  factory RulesEngineMatchCondition.fromMap(Map<String, dynamic> map) {
    return RulesEngineMatchCondition(
      ...
      rulesEngineMatchValue: pulumi.Input.fromValue((map['rulesEngineMatchValue'] as List).cast<String>()),
      rulesEngineMatchVariable: pulumi.Input.fromValue(map['rulesEngineMatchVariable']),
      rulesEngineOperator: pulumi.Input.fromValue(map['rulesEngineOperator']),
