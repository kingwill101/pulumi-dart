...
class RulesEngineMatchCondition {
  ...
  factory RulesEngineMatchCondition.fromMap(Map<String, dynamic> map) {
    return RulesEngineMatchCondition(
      ...
      rulesEngineMatchVariable: pulumi.Input.fromValue(map['rulesEngineMatchVariable'] as String),
      rulesEngineOperator: pulumi.Input.fromValue(map['rulesEngineOperator'] as String),
