...
class GetFrontDoorResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'backendPools': ?(() {
        final guardedValue = backendPools;
      ...
      'frontendEndpoints': ?(() {
        final guardedValue = frontendEndpoints;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'healthProbeSettings': ?(() {
        final guardedValue = healthProbeSettings;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'loadBalancingSettings': ?(() {
        final guardedValue = loadBalancingSettings;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'rulesEngines':
          pulumi.Input.encodeList<RulesEngineResponse, Map<String, dynamic>>(
            rulesEngines,
            (value) => value.toMap(),
          ),
      'tags': ?tags,
  ...
  factory GetFrontDoorResult.fromMap(Map<String, dynamic> map) {
    return GetFrontDoorResult(
      ...
      backendPools: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<BackendPoolResponse>(
          guardedValue,
          (value) => BackendPoolResponse.fromMap(
      ...
      frontendEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<FrontendEndpointResponse>(
          guardedValue,
          (value) => FrontendEndpointResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      healthProbeSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<HealthProbeSettingsModelResponse>(
          guardedValue,
          (value) => HealthProbeSettingsModelResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      loadBalancingSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<LoadBalancingSettingsModelResponse>(
          guardedValue,
          (value) => LoadBalancingSettingsModelResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      routingRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<RoutingRuleResponse>(
          guardedValue,
      ...
      rulesEngines: pulumi.Input.decodeList<RulesEngineResponse>(
        map['rulesEngines']!,
        (value) =>
            RulesEngineResponse.fromMap((value as Map).cast<String, dynamic>()),
      ),
      tags: (() {
