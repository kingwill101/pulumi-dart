...
class RulesEngineAction {
  ...
  factory RulesEngineAction.fromMap(Map<String, dynamic> map) {
    return RulesEngineAction(
      requestHeaderActions: (() { final guardedValue = map['requestHeaderActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HeaderAction>(guardedValue, (value) => HeaderAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      responseHeaderActions: (() { final guardedValue = map['responseHeaderActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<HeaderAction>(guardedValue, (value) => HeaderAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      routeConfigurationOverride: (() { final guardedValue = map['routeConfigurationOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ForwardingConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
