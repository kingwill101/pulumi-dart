...
class PolicySettings {
  ...
  final pulumi.Input<List<WebApplicationFirewallScrubbingRules>>?
  scrubbingRules;
    ...
    return <String, dynamic>{
      ...
      'scrubbingRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<WebApplicationFirewallScrubbingRules>,
  ...
  factory PolicySettings.fromMap(Map<String, dynamic> map) {
    return PolicySettings(
      ...
      javascriptChallengeExpirationInMinutes: (() {
        final guardedValue = map['javascriptChallengeExpirationInMinutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      mode: (() {
      ...
      scrubbingRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WebApplicationFirewallScrubbingRules>(
            guardedValue,
            (value) => WebApplicationFirewallScrubbingRules.fromMap(
