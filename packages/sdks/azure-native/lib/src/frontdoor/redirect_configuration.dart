...
class RedirectConfiguration {
  ...
  final pulumi.Input<dynamic>? redirectProtocol;
  ...
  factory RedirectConfiguration.fromMap(Map<String, dynamic> map) {
    return RedirectConfiguration(
      ...
      redirectProtocol: (() { final guardedValue = map['redirectProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
