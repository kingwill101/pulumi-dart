...
class HealthProbeSettingsModel {
  ...
  final pulumi.Input<dynamic>? healthProbeMethod;
  /// Resource ID.
  ...
  HealthProbeSettingsModel({
    this.enabledState,
    pulumi.Input<dynamic>? healthProbeMethod,
    this.id,
  ...
  factory HealthProbeSettingsModel.fromMap(Map<String, dynamic> map) {
    return HealthProbeSettingsModel(
      ...
      healthProbeMethod: (() { final guardedValue = map['healthProbeMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
