...
class BlobContainerImmutabilityPolicyArgs {
  ...
  BlobContainerImmutabilityPolicyArgs({
    ...
    pulumi.Output<bool>? allowProtectedAppendWrites,
    pulumi.Output<bool>? allowProtectedAppendWritesAll,
    required pulumi.Output<String> containerName,
    pulumi.Output<int>? immutabilityPeriodSinceCreationInDays,
    pulumi.Output<String>? immutabilityPolicyName,
  ...
  factory BlobContainerImmutabilityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BlobContainerImmutabilityPolicyArgs(
      ...
      allowProtectedAppendWrites: map['allowProtectedAppendWrites'] == null ? null : pulumi.Output.create<bool>(map['allowProtectedAppendWrites'] as bool),
      ...
      immutabilityPeriodSinceCreationInDays: map['immutabilityPeriodSinceCreationInDays'] == null ? null : pulumi.Output.create<int>(map['immutabilityPeriodSinceCreationInDays'] as int),
      immutabilityPolicyName: map['immutabilityPolicyName'] == null ? null : pulumi.Output.create<String>(map['immutabilityPolicyName'] as String),
