...
class EncryptionResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'services': ?pulumi.Input.mapOptionalInputValue<EncryptionServicesResponse, Map<String, dynamic>>(services, (value) => value.toMap()),
    };
  }
  ...
  factory EncryptionResponse.fromMap(Map<String, dynamic> map) {
    return EncryptionResponse(
      ...
      services: (() { final guardedValue = map['services']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EncryptionServicesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
