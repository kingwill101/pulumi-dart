...
class BlobArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessTier': ?pulumi.Input.mapOptionalInputValue<BlobAccessTier, String>(accessTier, (value) => value.wireValue),
      ...
      'source': ?source,
      'type': ?pulumi.Input.mapOptionalInputValue<BlobType, String>(type, (value) => value.wireValue),
    };
  }

  factory BlobArgs.fromMap(Map<String, dynamic> map) {
    return BlobArgs(
      accessTier: (() { final guardedValue = map['accessTier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BlobAccessTier.fromValue(guardedValue as String)); })(),
      ...
      type: (() { final guardedValue = map['type']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BlobType.fromValue(guardedValue as String)); })(),
    );
  }
}
