...
class StorageAccountArgs {
  ...
  factory StorageAccountArgs.fromMap(Map<String, dynamic> map) {
    return StorageAccountArgs(
      ...
      largeFileSharesState: (() { final guardedValue = map['largeFileSharesState']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
