...
class GetStorageAccountResult {
  ...
  final AzureFilesIdentityBasedAuthenticationResponse?
  ...
  final StorageAccountSkuConversionStatusResponse?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'azureFilesIdentityBasedAuthentication':
          ?azureFilesIdentityBasedAuthentication?.toMap(),
  ...
  factory GetStorageAccountResult.fromMap(Map<String, dynamic> map) {
    return GetStorageAccountResult(
      ...
      blobRestoreStatus: BlobRestoreStatusResponse.fromMap(
        (map['blobRestoreStatus']! as Map).cast<String, dynamic>(),
      ),
      ...
      geoReplicationStats: GeoReplicationStatsResponse.fromMap(
        (map['geoReplicationStats']! as Map).cast<String, dynamic>(),
      ),
      id: map['id'] as String,
      identity: (() {
      ...
      keyCreationTime: KeyCreationTimeResponse.fromMap(
        (map['keyCreationTime']! as Map).cast<String, dynamic>(),
      ),
      keyPolicy: KeyPolicyResponse.fromMap(
        (map['keyPolicy']! as Map).cast<String, dynamic>(),
      ),
      ...
      networkRuleSet: NetworkRuleSetResponse.fromMap(
        (map['networkRuleSet']! as Map).cast<String, dynamic>(),
      ),
      primaryEndpoints: EndpointsResponse.fromMap(
        (map['primaryEndpoints']! as Map).cast<String, dynamic>(),
      ),
      ...
      sasPolicy: SasPolicyResponse.fromMap(
        (map['sasPolicy']! as Map).cast<String, dynamic>(),
      ),
      secondaryEndpoints: EndpointsResponse.fromMap(
        (map['secondaryEndpoints']! as Map).cast<String, dynamic>(),
      ),
      ...
      storageAccountSkuConversionStatus: (() {
        final guardedValue = map['storageAccountSkuConversionStatus'];
        if (guardedValue == null) return null;
