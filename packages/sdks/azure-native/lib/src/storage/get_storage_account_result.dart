...
class GetStorageAccountResult {
  ...
  const GetStorageAccountResult({
    this.accessTier,
    this.accountMigrationInProgress,
    ...
    this.isSftpEnabled,
    this.isSkuConversionBlocked,
    this.keyCreationTime,
    this.keyPolicy,
    this.kind,
    this.largeFileSharesState,
    this.lastGeoFailoverTime,
    this.location,
    ...
    this.sku,
    this.statusOfPrimary,
    this.statusOfSecondary,
  ...
  factory GetStorageAccountResult.fromMap(Map<String, dynamic> map) {
    return GetStorageAccountResult(
      ...
      accountMigrationInProgress: (() { final guardedValue = map['accountMigrationInProgress']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      ...
      blobRestoreStatus: (() { final guardedValue = map['blobRestoreStatus']; if (guardedValue == null) return null; return BlobRestoreStatusResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      creationTime: (() { final guardedValue = map['creationTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      customDomain: (() { final guardedValue = map['customDomain']; if (guardedValue == null) return null; return CustomDomainResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      failoverInProgress: (() { final guardedValue = map['failoverInProgress']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      geoReplicationStats: (() { final guardedValue = map['geoReplicationStats']; if (guardedValue == null) return null; return GeoReplicationStatsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      isSkuConversionBlocked: (() { final guardedValue = map['isSkuConversionBlocked']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      keyCreationTime: (() { final guardedValue = map['keyCreationTime']; if (guardedValue == null) return null; return KeyCreationTimeResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      keyPolicy: (() { final guardedValue = map['keyPolicy']; if (guardedValue == null) return null; return KeyPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      lastGeoFailoverTime: (() { final guardedValue = map['lastGeoFailoverTime']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      primaryEndpoints: (() { final guardedValue = map['primaryEndpoints']; if (guardedValue == null) return null; return EndpointsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      sasPolicy: (() { final guardedValue = map['sasPolicy']; if (guardedValue == null) return null; return SasPolicyResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      secondaryEndpoints: (() { final guardedValue = map['secondaryEndpoints']; if (guardedValue == null) return null; return EndpointsResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      statusOfPrimary: (() { final guardedValue = map['statusOfPrimary']; if (guardedValue == null) return null; return guardedValue as String; })(),
      statusOfSecondary: (() { final guardedValue = map['statusOfSecondary']; if (guardedValue == null) return null; return guardedValue as String; })(),
