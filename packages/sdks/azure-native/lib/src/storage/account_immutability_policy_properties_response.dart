...
class AccountImmutabilityPolicyPropertiesResponse {
  ...
  /// Creates a new [AccountImmutabilityPolicyPropertiesResponse].
  ...
  factory AccountImmutabilityPolicyPropertiesResponse.fromMap(
