    ...
    return <String, dynamic>{
      ...
      'permissionScopes':
          ...
          >(
            permissionScopes,
            (value) =>
                pulumi.Input.encodeList<PermissionScope, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return LocalUserArgs(
      ...
      permissionScopes: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PermissionScope>(
            guardedValue,
            (value) =>
                PermissionScope.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
