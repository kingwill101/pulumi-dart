    ...
    return <String, dynamic>{
      ...
      'tierToArchive':
          ?pulumi.Input.mapOptionalInputValue<
            DateAfterModificationResponse,
            Map<String, dynamic>
          >(tierToArchive, (value) => value.toMap()),
      'tierToCold':
          ?pulumi.Input.mapOptionalInputValue<
            DateAfterModificationResponse,
            Map<String, dynamic>
          >(tierToCold, (value) => value.toMap()),
      'tierToCool':
          ?pulumi.Input.mapOptionalInputValue<
            DateAfterModificationResponse,
            Map<String, dynamic>
          >(tierToCool, (value) => value.toMap()),
      'tierToHot':
          ?pulumi.Input.mapOptionalInputValue<
            DateAfterModificationResponse,
            Map<String, dynamic>
          >(tierToHot, (value) => value.toMap()),
    };
  }
    ...
    return ManagementPolicyBaseBlobResponse(
      delete: (() {
        ...
        return pulumi.Input.fromValue(
          DateAfterModificationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      enableAutoTierToHotFromCool: (() {
        final guardedValue = map['enableAutoTierToHotFromCool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      tierToArchive: (() {
        final guardedValue = map['tierToArchive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DateAfterModificationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      tierToCold: (() {
        final guardedValue = map['tierToCold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DateAfterModificationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      tierToCool: (() {
        final guardedValue = map['tierToCool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DateAfterModificationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      tierToHot: (() {
        final guardedValue = map['tierToHot'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DateAfterModificationResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
