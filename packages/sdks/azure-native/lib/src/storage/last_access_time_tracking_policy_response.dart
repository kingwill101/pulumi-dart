...
class LastAccessTimeTrackingPolicyResponse {
  ...
  const LastAccessTimeTrackingPolicyResponse({
    this.blobType,
  ...
  factory LastAccessTimeTrackingPolicyResponse.fromMap(Map<String, dynamic> map) {
    return LastAccessTimeTrackingPolicyResponse(
      blobType: (() { final guardedValue = map['blobType']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      enable: pulumi.Input.fromValue(map['enable'] as bool),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      trackingGranularityInDays: (() { final guardedValue = map['trackingGranularityInDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
    );
  }
}
