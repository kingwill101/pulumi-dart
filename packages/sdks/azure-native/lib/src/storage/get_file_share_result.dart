...
class GetFileShareResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'etag': etag,
      'fileSharePaidBursting': ?fileSharePaidBursting == null ? null : fileSharePaidBursting!.toMap(),
      'id': id,
      ...
      'signedIdentifiers': ?signedIdentifiers == null ? null : pulumi.Input.encodeList<SignedIdentifierResponse, Map<String, dynamic>>(signedIdentifiers!, (value) => value.toMap()),
  ...
  factory GetFileShareResult.fromMap(Map<String, dynamic> map) {
    return GetFileShareResult(
      ...
      enabledProtocols: map['enabledProtocols'] == null ? null : map['enabledProtocols']! as String,
      etag: map['etag'] as String,
      fileSharePaidBursting: map['fileSharePaidBursting'] == null ? null : FileSharePropertiesResponseFileSharePaidBursting.fromMap((map['fileSharePaidBursting']! as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      ...
      provisionedBandwidthMibps: map['provisionedBandwidthMibps'] == null ? null : map['provisionedBandwidthMibps']! as int,
      ...
      shareQuota: map['shareQuota'] == null ? null : map['shareQuota']! as int,
      shareUsageBytes: map['shareUsageBytes'] as double,
      signedIdentifiers: map['signedIdentifiers'] == null ? null : pulumi.Input.decodeList<SignedIdentifierResponse>(map['signedIdentifiers']!, (value) => SignedIdentifierResponse.fromMap((value as Map).cast<String, dynamic>())),
