...
class ManagedIdentityAuthProperties {
  ...
  /// Creates a new [ManagedIdentityAuthProperties].
  ...
  const ManagedIdentityAuthProperties({
  ...
  factory ManagedIdentityAuthProperties.fromMap(Map<String, dynamic> map) {
    return ManagedIdentityAuthProperties(
