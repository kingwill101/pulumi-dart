...
class BlobInventoryPolicyDefinitionResponse {
  ...
  const BlobInventoryPolicyDefinitionResponse({
    this.filters,
  ...
  factory BlobInventoryPolicyDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return BlobInventoryPolicyDefinitionResponse(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BlobInventoryPolicyFilterResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
