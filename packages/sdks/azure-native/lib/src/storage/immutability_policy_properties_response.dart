...
class ImmutabilityPolicyPropertiesResponse {
  ...
  factory ImmutabilityPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ImmutabilityPolicyPropertiesResponse(
      ...
      updateHistory: pulumi.Input.fromValue(pulumi.Input.decodeList<UpdateHistoryPropertyResponse>(map['updateHistory']!, (value) => UpdateHistoryPropertyResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
