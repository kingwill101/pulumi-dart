...
class SmbSetting {
  ...
  factory SmbSetting.fromMap(Map<String, dynamic> map) {
    return SmbSetting(
      ...
      multichannel: (() { final guardedValue = map['multichannel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Multichannel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
