...
class GetStorageTaskAssignmentResult {
  ...
  factory GetStorageTaskAssignmentResult.fromMap(Map<String, dynamic> map) {
    return GetStorageTaskAssignmentResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return StorageTaskAssignmentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
