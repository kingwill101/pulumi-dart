...
class LocalUser extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<PermissionScopeResponse>?> permissionScopes;
  /// A unique Security Identifier that is generated by the server.
  late final pulumi.Output<String> sid;
  /// Optional, local user ssh authorized keys for SFTP.
  late final pulumi.Output<List<SshPublicKeyResponse>?> sshAuthorizedKeys;
  ...
  LocalUser(
    ...
    extendedGroups = registerOutput<List<int>?>('extendedGroups', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<int>(); });
    ...
    permissionScopes = registerOutput<List<PermissionScopeResponse>?>('permissionScopes', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<PermissionScopeResponse>(guardedValue, (value) => PermissionScopeResponse.fromMap((value as Map).cast<String, dynamic>())); });
    sid = registerOutput<String>('sid');
    sshAuthorizedKeys = registerOutput<List<SshPublicKeyResponse>?>('sshAuthorizedKeys', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<SshPublicKeyResponse>(guardedValue, (value) => SshPublicKeyResponse.fromMap((value as Map).cast<String, dynamic>())); });
