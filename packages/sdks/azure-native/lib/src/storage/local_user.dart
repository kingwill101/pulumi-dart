...
class LocalUser extends pulumi.CustomResource {
  ...
  LocalUser(
    ...
    this.allowAclAuthorization = registerOutput<bool?>('allowAclAuthorization');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.extendedGroups = registerOutput<List<int>?>('extendedGroups');
    this.groupId = registerOutput<int?>('groupId');
    this.hasSharedKey = registerOutput<bool?>('hasSharedKey');
    this.hasSshKey = registerOutput<bool?>('hasSshKey');
    this.hasSshPassword = registerOutput<bool?>('hasSshPassword');
    this.homeDirectory = registerOutput<String?>('homeDirectory');
    this.isNFSv3Enabled = registerOutput<bool?>('isNFSv3Enabled');
    this.name = registerOutput<String>('name');
    this.permissionScopes = registerOutput<List<PermissionScopeResponse>?>('permissionScopes');
    this.sid = registerOutput<String>('sid');
    this.sshAuthorizedKeys = registerOutput<List<SshPublicKeyResponse>?>('sshAuthorizedKeys');
    this.systemData = registerOutput<SystemDataResponse>('systemData');
    this.type = registerOutput<String>('type');
    this.userId = registerOutput<int>('userId');
  }
}
