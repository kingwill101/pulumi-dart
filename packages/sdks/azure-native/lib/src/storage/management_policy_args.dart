...
class ManagementPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policy': pulumi.Input.mapInputValue<ManagementPolicySchema, Map<String, dynamic>>(policy, (value) => value.toMap()),
  ...
  factory ManagementPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ManagementPolicyArgs(
      ...
      managementPolicyName: (() { final guardedValue = map['managementPolicyName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      policy: pulumi.Input.fromValue(ManagementPolicySchema.fromMap((map['policy']! as Map).cast<String, dynamic>())),
