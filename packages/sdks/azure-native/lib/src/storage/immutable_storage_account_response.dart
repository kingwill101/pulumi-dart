...
class ImmutableStorageAccountResponse {
  ...
  final pulumi.Input<AccountImmutabilityPolicyPropertiesResponse>?
  immutabilityPolicy;
  ...
  ImmutableStorageAccountResponse({this.enabled, this.immutabilityPolicy});
    ...
    return ImmutableStorageAccountResponse(
      ...
      immutabilityPolicy: (() {
        ...
        return pulumi.Input.fromValue(
          AccountImmutabilityPolicyPropertiesResponse.fromMap(
