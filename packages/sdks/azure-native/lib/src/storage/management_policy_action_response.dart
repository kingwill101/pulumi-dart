...
class ManagementPolicyActionResponse {
  ...
  ManagementPolicyActionResponse({this.baseBlob, this.snapshot, this.version});
    ...
    return ManagementPolicyActionResponse(
      baseBlob: (() {
        ...
        return pulumi.Input.fromValue(
          ManagementPolicyBaseBlobResponse.fromMap(
      ...
      snapshot: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagementPolicySnapShotResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      version: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ManagementPolicyVersionResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
