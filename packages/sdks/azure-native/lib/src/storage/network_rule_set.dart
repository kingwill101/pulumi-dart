...
class NetworkRuleSet {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bypass': ?bypass,
      'defaultAction': pulumi.Input.mapInputValue<DefaultAction, String>(
        defaultAction,
  ...
  factory NetworkRuleSet.fromMap(Map<String, dynamic> map) {
    return NetworkRuleSet(
      ...
      defaultAction: pulumi.Input.fromValue(
        DefaultAction.fromValue(map['defaultAction']! as String),
      ),
      ipRules: (() {
      ...
      resourceAccessRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ResourceAccessRule>(
            guardedValue,
            (value) => ResourceAccessRule.fromMap(
