...
class DateAfterModificationResponse {
  ...
  /// Creates a new [DateAfterModificationResponse].
  ...
  const DateAfterModificationResponse({
  ...
  factory DateAfterModificationResponse.fromMap(Map<String, dynamic> map) {
    return DateAfterModificationResponse(
      daysAfterCreationGreaterThan: (() { final guardedValue = map['daysAfterCreationGreaterThan']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      daysAfterLastAccessTimeGreaterThan: (() { final guardedValue = map['daysAfterLastAccessTimeGreaterThan']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      daysAfterModificationGreaterThan: (() { final guardedValue = map['daysAfterModificationGreaterThan']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
