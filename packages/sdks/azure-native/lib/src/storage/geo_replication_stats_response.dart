...
class GeoReplicationStatsResponse {
  ...
  factory GeoReplicationStatsResponse.fromMap(Map<String, dynamic> map) {
    return GeoReplicationStatsResponse(
      canFailover: map['canFailover'] as bool,
      canPlannedFailover: map['canPlannedFailover'] as bool,
      lastSyncTime: map['lastSyncTime'] as String,
      postFailoverRedundancy: map['postFailoverRedundancy'] as String,
      postPlannedFailoverRedundancy: map['postPlannedFailoverRedundancy'] as String,
