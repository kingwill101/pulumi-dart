...
class GeoReplicationStatsResponse {
  ...
  factory GeoReplicationStatsResponse.fromMap(Map<String, dynamic> map) {
    return GeoReplicationStatsResponse(
      canFailover: pulumi.Input.fromValue(map['canFailover'] as bool),
      canPlannedFailover: pulumi.Input.fromValue(map['canPlannedFailover'] as bool),
      lastSyncTime: pulumi.Input.fromValue(map['lastSyncTime'] as String),
      postFailoverRedundancy: pulumi.Input.fromValue(map['postFailoverRedundancy'] as String),
      postPlannedFailoverRedundancy: pulumi.Input.fromValue(map['postPlannedFailoverRedundancy'] as String),
