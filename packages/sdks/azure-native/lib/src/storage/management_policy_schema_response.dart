...
class ManagementPolicySchemaResponse {
  ...
  const ManagementPolicySchemaResponse({
    required this.rules,
  });
  ...
  factory ManagementPolicySchemaResponse.fromMap(Map<String, dynamic> map) {
    return ManagementPolicySchemaResponse(
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<ManagementPolicyRuleResponse>(map['rules']!, (value) => ManagementPolicyRuleResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
