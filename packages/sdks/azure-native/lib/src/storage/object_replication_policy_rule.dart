...
class ObjectReplicationPolicyRule {
  ...
  factory ObjectReplicationPolicyRule.fromMap(Map<String, dynamic> map) {
    return ObjectReplicationPolicyRule(
      ...
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObjectReplicationPolicyFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
