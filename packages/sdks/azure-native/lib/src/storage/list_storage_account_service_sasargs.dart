...
class ListStorageAccountServiceSASArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'protocols': ?pulumi.Input.mapOptionalInputValue<HttpProtocol, String>(protocols, (value) => value.wireValue),
      'resource': ?resource,
  ...
  factory ListStorageAccountServiceSASArgs.fromMap(Map<String, dynamic> map) {
    return ListStorageAccountServiceSASArgs(
      ...
      canonicalizedResource: pulumi.Input.fromValue(map['canonicalizedResource'] as String),
      ...
      partitionKeyEnd: (() { final guardedValue = map['partitionKeyEnd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      partitionKeyStart: (() { final guardedValue = map['partitionKeyStart']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      rowKeyEnd: (() { final guardedValue = map['rowKeyEnd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rowKeyStart: (() { final guardedValue = map['rowKeyStart']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sharedAccessExpiryTime: (() { final guardedValue = map['sharedAccessExpiryTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
