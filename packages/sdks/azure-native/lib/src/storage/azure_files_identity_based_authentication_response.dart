...
class AzureFilesIdentityBasedAuthenticationResponse {
  ...
  const AzureFilesIdentityBasedAuthenticationResponse({
  ...
  factory AzureFilesIdentityBasedAuthenticationResponse.fromMap(Map<String, dynamic> map) {
    return AzureFilesIdentityBasedAuthenticationResponse(
      activeDirectoryProperties: (() { final guardedValue = map['activeDirectoryProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ActiveDirectoryPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
