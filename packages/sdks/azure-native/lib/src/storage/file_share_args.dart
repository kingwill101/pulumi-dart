...
class FileShareArgs {
  ...
  final pulumi.Input<dynamic>? enabledProtocols;
  ...
  factory FileShareArgs.fromMap(Map<String, dynamic> map) {
    return FileShareArgs(
      ...
      enabledProtocols: (() { final guardedValue = map['enabledProtocols']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      expand: (() { final guardedValue = map['expand']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      fileSharePaidBursting: (() { final guardedValue = map['fileSharePaidBursting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FileSharePropertiesFileSharePaidBursting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metadata: (() { final guardedValue = map['metadata']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      provisionedBandwidthMibps: (() { final guardedValue = map['provisionedBandwidthMibps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      provisionedIops: (() { final guardedValue = map['provisionedIops']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      shareQuota: (() { final guardedValue = map['shareQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      signedIdentifiers: (() { final guardedValue = map['signedIdentifiers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SignedIdentifier>(guardedValue, (value) => SignedIdentifier.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
