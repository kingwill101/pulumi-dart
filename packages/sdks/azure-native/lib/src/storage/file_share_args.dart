...
class FileShareArgs {
  ...
  factory FileShareArgs.fromMap(Map<String, dynamic> map) {
    return FileShareArgs(
      ...
      enabledProtocols: (() { final guardedValue = map['enabledProtocols']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      provisionedBandwidthMibps: (() { final guardedValue = map['provisionedBandwidthMibps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      shareQuota: (() { final guardedValue = map['shareQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
