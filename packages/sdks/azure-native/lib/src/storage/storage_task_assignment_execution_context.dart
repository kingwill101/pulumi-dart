...
class StorageTaskAssignmentExecutionContext {
  ...
  StorageTaskAssignmentExecutionContext({this.target, required this.trigger});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trigger':
          pulumi.Input.mapInputValue<ExecutionTrigger, Map<String, dynamic>>(
            trigger,
            (value) => value.toMap(),
          ),
    };
  ...
  factory StorageTaskAssignmentExecutionContext.fromMap(
    ...
    return StorageTaskAssignmentExecutionContext(
      target: (() {
        ...
        return pulumi.Input.fromValue(
          ExecutionTarget.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      trigger: pulumi.Input.fromValue(
        ExecutionTrigger.fromMap(
