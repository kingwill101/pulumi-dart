...
class StorageTaskReportPropertiesResponse {
  ...
  factory StorageTaskReportPropertiesResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return StorageTaskReportPropertiesResponse(
      finishTime: pulumi.Input.fromValue(map['finishTime'] as String),
      objectFailedCount: pulumi.Input.fromValue(
        map['objectFailedCount'] as String,
      ),
      objectsOperatedOnCount: pulumi.Input.fromValue(
        map['objectsOperatedOnCount'] as String,
      ),
      objectsSucceededCount: pulumi.Input.fromValue(
        map['objectsSucceededCount'] as String,
      ),
      objectsTargetedCount: pulumi.Input.fromValue(
        map['objectsTargetedCount'] as String,
      ),
      ...
      summaryReportPath: pulumi.Input.fromValue(
        map['summaryReportPath'] as String,
      ),
      taskAssignmentId: pulumi.Input.fromValue(
        map['taskAssignmentId'] as String,
      ),
