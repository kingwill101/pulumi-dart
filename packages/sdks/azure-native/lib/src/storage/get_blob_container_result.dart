...
class GetBlobContainerResult {
  ...
  factory GetBlobContainerResult.fromMap(Map<String, dynamic> map) {
    return GetBlobContainerResult(
      ...
      id: map['id'] as String,
      immutabilityPolicy: ImmutabilityPolicyPropertiesResponse.fromMap(
        (map['immutabilityPolicy']! as Map).cast<String, dynamic>(),
      ),
      ...
      legalHold: LegalHoldPropertiesResponse.fromMap(
        (map['legalHold']! as Map).cast<String, dynamic>(),
      ),
      metadata: (() {
