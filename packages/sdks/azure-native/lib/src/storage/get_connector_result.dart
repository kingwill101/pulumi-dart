...
class GetConnectorResult {
  ...
  final StorageConnectorPropertiesResponse? properties;
  ...
  factory GetConnectorResult.fromMap(Map<String, dynamic> map) {
    return GetConnectorResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return StorageConnectorPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
