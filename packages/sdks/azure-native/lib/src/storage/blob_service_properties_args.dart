...
class BlobServicePropertiesArgs {
  ...
  factory BlobServicePropertiesArgs.fromMap(Map<String, dynamic> map) {
    return BlobServicePropertiesArgs(
      ...
      automaticSnapshotPolicyEnabled: (() { final guardedValue = map['automaticSnapshotPolicyEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      blobServicesName: (() { final guardedValue = map['blobServicesName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      changeFeed: (() { final guardedValue = map['changeFeed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChangeFeed.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      containerDeleteRetentionPolicy: (() { final guardedValue = map['containerDeleteRetentionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeleteRetentionPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      deleteRetentionPolicy: (() { final guardedValue = map['deleteRetentionPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeleteRetentionPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      isVersioningEnabled: (() { final guardedValue = map['isVersioningEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      lastAccessTimeTrackingPolicy: (() { final guardedValue = map['lastAccessTimeTrackingPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LastAccessTimeTrackingPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      restorePolicy: (() { final guardedValue = map['restorePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RestorePolicyProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
