...
class FileServicePropertiesArgs {
    ...
    return <String, dynamic>{
      ...
      'shareDeleteRetentionPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(shareDeleteRetentionPolicy, (value) => value.toMap()),
    };
  }
  ...
  factory FileServicePropertiesArgs.fromMap(Map<String, dynamic> map) {
    return FileServicePropertiesArgs(
      ...
      fileServicesName: (() {
        final guardedValue = map['fileServicesName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      protocolSettings: (() {
        final guardedValue = map['protocolSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProtocolSettings.fromMap(
      ...
      shareDeleteRetentionPolicy: (() {
        final guardedValue = map['shareDeleteRetentionPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
