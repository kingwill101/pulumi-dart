...
class BlobContainerArgs {
  ...
  final pulumi.Input<ImmutableStorageWithVersioning>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metadata': ?metadata,
      'publicAccess': ?pulumi.Input.mapOptionalInputValue<PublicAccess, String>(
        publicAccess,
  ...
  factory BlobContainerArgs.fromMap(Map<String, dynamic> map) {
    return BlobContainerArgs(
      ...
      denyEncryptionScopeOverride: (() {
        final guardedValue = map['denyEncryptionScopeOverride'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableNfsV3AllSquash: (() {
        final guardedValue = map['enableNfsV3AllSquash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableNfsV3RootSquash: (() {
        final guardedValue = map['enableNfsV3RootSquash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      immutableStorageWithVersioning: (() {
        ...
        return pulumi.Input.fromValue(
          ImmutableStorageWithVersioning.fromMap(
      ...
      publicAccess: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PublicAccess.fromValue(guardedValue as String),
        );
      })(),
