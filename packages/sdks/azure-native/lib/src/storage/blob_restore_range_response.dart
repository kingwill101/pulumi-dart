...
class BlobRestoreRangeResponse {
  ...
  BlobRestoreRangeResponse({required this.endRange, required this.startRange});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'endRange': endRange, 'startRange': startRange};
  }

  factory BlobRestoreRangeResponse.fromMap(Map<String, dynamic> map) {
    return BlobRestoreRangeResponse(
      endRange: pulumi.Input.fromValue(map['endRange'] as String),
      startRange: pulumi.Input.fromValue(map['startRange'] as String),
    );
  }
}
