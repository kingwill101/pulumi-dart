...
class ProjectArgs {
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      catalogSettings: (() { final guardedValue = map['catalogSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProjectCatalogSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
