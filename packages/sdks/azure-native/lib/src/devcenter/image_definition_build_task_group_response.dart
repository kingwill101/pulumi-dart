...
class ImageDefinitionBuildTaskGroupResponse {
  ...
  factory ImageDefinitionBuildTaskGroupResponse.fromMap(Map<String, dynamic> map) {
    return ImageDefinitionBuildTaskGroupResponse(
      ...
      tasks: pulumi.Input.fromValue(pulumi.Input.decodeList<ImageDefinitionBuildTaskResponse>(map['tasks']!, (value) => ImageDefinitionBuildTaskResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
