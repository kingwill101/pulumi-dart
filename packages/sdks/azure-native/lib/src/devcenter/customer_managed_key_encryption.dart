...
class CustomerManagedKeyEncryption {
  ...
  factory CustomerManagedKeyEncryption.fromMap(Map<String, dynamic> map) {
    return CustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: map['keyEncryptionKeyIdentity'] == null ? null : (CustomerManagedKeyEncryptionKeyEncryptionKeyIdentity.fromMap((map['keyEncryptionKeyIdentity'] as Map).cast<String, dynamic>())).input(),
