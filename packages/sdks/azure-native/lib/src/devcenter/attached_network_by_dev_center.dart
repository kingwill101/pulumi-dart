...
/// }
///
/// resource "azure-native_devcenter_attachednetworkbydevcenter" "attachedNetworkByDevCenter" {
...
class AttachedNetworkByDevCenter extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [AttachedNetworkByDevCenter] resource.
  AttachedNetworkByDevCenter.reference(String urn)
    : super(
        'azure-native:devcenter:AttachedNetworkByDevCenter',
