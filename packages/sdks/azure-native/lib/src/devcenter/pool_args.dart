...
class PoolArgs {
  ...
  final pulumi.Input<dynamic> localAdministrator;
  ...
  final pulumi.Input<dynamic>? singleSignOnStatus;
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      localAdministrator: pulumi.Input.fromValue(map['localAdministrator']),
      ...
      singleSignOnStatus: (() { final guardedValue = map['singleSignOnStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
