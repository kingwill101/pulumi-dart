...
class ProjectCatalogSettings {
  ...
  final pulumi.Input<List<dynamic>?>? catalogItemSyncTypes;
  ...
  factory ProjectCatalogSettings.fromMap(Map<String, dynamic> map) {
    return ProjectCatalogSettings(
      catalogItemSyncTypes: (() { final guardedValue = map['catalogItemSyncTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<dynamic>()); })(),
    );
  }
}
