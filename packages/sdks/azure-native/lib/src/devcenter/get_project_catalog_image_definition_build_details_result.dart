...
class GetProjectCatalogImageDefinitionBuildDetailsResult {
  ...
  factory GetProjectCatalogImageDefinitionBuildDetailsResult.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetProjectCatalogImageDefinitionBuildDetailsResult(
      endTime: map['endTime'] as String,
      errorDetails: ImageCreationErrorDetailsResponse.fromMap(
      ...
      taskGroups:
          pulumi.Input.decodeList<ImageDefinitionBuildTaskGroupResponse>(
            map['taskGroups']!,
            (value) => ImageDefinitionBuildTaskGroupResponse.fromMap(
