...
class NetworkConnectionArgs {
  ...
  factory NetworkConnectionArgs.fromMap(Map<String, dynamic> map) {
    return NetworkConnectionArgs(
      ...
      networkConnectionName: (() { final guardedValue = map['networkConnectionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      networkingResourceGroupName: (() { final guardedValue = map['networkingResourceGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
