...
class ScriptArgs {
  ...
  final pulumi.Input<dynamic>? principalPermissionsAction;
  ...
  final pulumi.Input<dynamic>? scriptLevel;
  ...
  ScriptArgs({
    ...
    pulumi.Input<bool?>? continueOnErrors,
  ...
  }) : continueOnErrors = continueOnErrors ?? pulumi.Input.fromValue(false);
  ...
  factory ScriptArgs.fromMap(Map<String, dynamic> map) {
    return ScriptArgs(
      ...
      principalPermissionsAction: (() { final guardedValue = map['principalPermissionsAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      scriptLevel: (() { final guardedValue = map['scriptLevel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
