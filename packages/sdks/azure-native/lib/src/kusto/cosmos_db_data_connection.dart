...
class CosmosDbDataConnection extends pulumi.CustomResource {
  ...
  CosmosDbDataConnection(
    ...
    this.cosmosDbAccountResourceId = registerOutput<String>('cosmosDbAccountResourceId');
    this.cosmosDbContainer = registerOutput<String>('cosmosDbContainer');
    this.cosmosDbDatabase = registerOutput<String>('cosmosDbDatabase');
