...
/// Result data returned by getClusterPrincipalAssignment.
class GetClusterPrincipalAssignmentResult {
  ...
  /// Creates a new [GetClusterPrincipalAssignmentResult].
  ...
  factory GetClusterPrincipalAssignmentResult.fromMap(Map<String, dynamic> map) {
