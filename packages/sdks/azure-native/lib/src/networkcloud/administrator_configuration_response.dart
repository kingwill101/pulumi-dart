...
class AdministratorConfigurationResponse {
  ...
  const AdministratorConfigurationResponse({
    this.adminUsername,
    this.sshPublicKeys,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sshPublicKeys': ?pulumi.Input.mapOptionalInputValue<List<SshPublicKeyResponse>, List<Map<String, dynamic>>>(sshPublicKeys, (value) => pulumi.Input.encodeList<SshPublicKeyResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory AdministratorConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return AdministratorConfigurationResponse(
      ...
      sshPublicKeys: (() { final guardedValue = map['sshPublicKeys']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SshPublicKeyResponse>(guardedValue, (value) => SshPublicKeyResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
