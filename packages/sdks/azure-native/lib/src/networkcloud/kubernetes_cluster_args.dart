...
class KubernetesClusterArgs {
  ...
  final pulumi.Input<ControlPlaneNodeConfiguration>
  ...
  final pulumi.Input<List<InitialAgentPoolConfiguration>>
    ...
    return <String, dynamic>{
      'aadConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AadConfiguration,
            Map<String, dynamic>
          >(aadConfiguration, (value) => value.toMap()),
      ...
      'controlPlaneNodeConfiguration':
          pulumi.Input.mapInputValue<
            ControlPlaneNodeConfiguration,
            Map<String, dynamic>
          >(controlPlaneNodeConfiguration, (value) => value.toMap()),
      'extendedLocation':
      ...
      'initialAgentPoolConfigurations':
          pulumi.Input.mapInputValue<
            List<InitialAgentPoolConfiguration>,
  ...
  factory KubernetesClusterArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterArgs(
      aadConfiguration: (() {
        final guardedValue = map['aadConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AadConfiguration.fromMap(
      ...
      controlPlaneNodeConfiguration: pulumi.Input.fromValue(
        ControlPlaneNodeConfiguration.fromMap(
          (map['controlPlaneNodeConfiguration']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      ...
      initialAgentPoolConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<InitialAgentPoolConfiguration>(
          map['initialAgentPoolConfigurations']!,
          (value) => InitialAgentPoolConfiguration.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      kubernetesClusterName: (() {
        final guardedValue = map['kubernetesClusterName'];
        if (guardedValue == null) return null;
