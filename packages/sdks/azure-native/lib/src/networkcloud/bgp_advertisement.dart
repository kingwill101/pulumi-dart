...
class BgpAdvertisement {
  ...
  final pulumi.Input<dynamic>? advertiseToFabric;
  ...
  BgpAdvertisement({
    pulumi.Input<dynamic>? advertiseToFabric,
    this.communities,
    required this.ipAddressPools,
    this.peers,
  }) : advertiseToFabric = advertiseToFabric ?? pulumi.Input.fromValue('True');
  ...
  factory BgpAdvertisement.fromMap(Map<String, dynamic> map) {
    return BgpAdvertisement(
      advertiseToFabric: (() { final guardedValue = map['advertiseToFabric']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
