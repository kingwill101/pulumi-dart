...
class ClusterAvailableUpgradeVersionResponse {
  ...
  factory ClusterAvailableUpgradeVersionResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return ClusterAvailableUpgradeVersionResponse(
      controlImpact: pulumi.Input.fromValue(map['controlImpact'] as String),
      expectedDuration: pulumi.Input.fromValue(
        map['expectedDuration'] as String,
      ),
      impactDescription: pulumi.Input.fromValue(
        map['impactDescription'] as String,
      ),
