...
class ClusterSecretArchive {
  ...
  final pulumi.Input<dynamic>? useKeyVault;
  ...
  ClusterSecretArchive({
    ...
    pulumi.Input<dynamic>? useKeyVault,
  ...
  factory ClusterSecretArchive.fromMap(Map<String, dynamic> map) {
    return ClusterSecretArchive(
      ...
      useKeyVault: (() { final guardedValue = map['useKeyVault']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
