...
class InitialAgentPoolConfiguration {
  ...
  final List<KubernetesLabel>? labels;
  ...
  final List<KubernetesLabel>? taints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'count': count,
      'labels': ?labels == null ? null : pulumi.Input.encodeList<KubernetesLabel, Map<String, dynamic>>(labels!, (value) => value.toMap()),
      'mode': mode,
      'name': name,
      'taints': ?taints == null ? null : pulumi.Input.encodeList<KubernetesLabel, Map<String, dynamic>>(taints!, (value) => value.toMap()),
