...
class VirtualMachineArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudServicesNetworkAttachment':
          pulumi.Input.mapInputValue<NetworkAttachment, Map<String, dynamic>>(
            cloudServicesNetworkAttachment,
            (value) => value.toMap(),
          ),
      'consoleExtendedLocation':
          ?pulumi.Input.mapOptionalInputValue<
            ExtendedLocation,
            Map<String, dynamic>
          >(consoleExtendedLocation, (value) => value.toMap()),
      'cpuCores': cpuCores,
      'extendedLocation':
      ...
      'placementHints':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualMachinePlacementHint>,
            List<Map<String, dynamic>>
          >(
            placementHints,
            (value) =>
      ...
      'storageProfile':
          pulumi.Input.mapInputValue<StorageProfile, Map<String, dynamic>>(
            storageProfile,
            (value) => value.toMap(),
          ),
      'tags': ?tags,
      ...
      'vmImageRepositoryCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(vmImageRepositoryCredentials, (value) => value.toMap()),
    };
  }
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      bootMethod: (() {
        final guardedValue = map['bootMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cloudServicesNetworkAttachment: pulumi.Input.fromValue(
        NetworkAttachment.fromMap(
          (map['cloudServicesNetworkAttachment']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      consoleExtendedLocation: (() {
        final guardedValue = map['consoleExtendedLocation'];
        if (guardedValue == null) return null;
      ...
      isolateEmulatorThread: (() {
        final guardedValue = map['isolateEmulatorThread'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
      ...
      networkAttachments: (() {
        final guardedValue = map['networkAttachments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkAttachment>(
            guardedValue,
            (value) => NetworkAttachment.fromMap(
      ...
      placementHints: (() {
        final guardedValue = map['placementHints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VirtualMachinePlacementHint>(
            guardedValue,
            (value) => VirtualMachinePlacementHint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      virtioInterface: (() {
        final guardedValue = map['virtioInterface'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      virtualMachineName: (() {
      ...
      vmDeviceModel: (() {
        final guardedValue = map['vmDeviceModel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vmImage: pulumi.Input.fromValue(map['vmImage'] as String),
      vmImageRepositoryCredentials: (() {
        final guardedValue = map['vmImageRepositoryCredentials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ImageRepositoryCredentials.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
