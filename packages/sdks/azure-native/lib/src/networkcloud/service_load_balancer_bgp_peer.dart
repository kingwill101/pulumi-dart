...
class ServiceLoadBalancerBgpPeer {
  ...
  factory ServiceLoadBalancerBgpPeer.fromMap(Map<String, dynamic> map) {
    return ServiceLoadBalancerBgpPeer(
      bfdEnabled: (() {
        final guardedValue = map['bfdEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bgpMultiHop: (() {
        final guardedValue = map['bgpMultiHop'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      holdTime: (() {
        final guardedValue = map['holdTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      keepAliveTime: (() {
        final guardedValue = map['keepAliveTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      myAsn: (() {
        final guardedValue = map['myAsn'];
        if (guardedValue == null) return null;
      ...
      peerPort: (() {
        final guardedValue = map['peerPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
    );
