  ...
  factory ClusterCapacityResponse.fromMap(Map<String, dynamic> map) {
    return ClusterCapacityResponse(
      availableApplianceStorageGB: (() {
        final guardedValue = map['availableApplianceStorageGB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      availableCoreCount: (() {
        final guardedValue = map['availableCoreCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      availableHostStorageGB: (() {
        final guardedValue = map['availableHostStorageGB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      availableMemoryGB: (() {
        final guardedValue = map['availableMemoryGB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      totalApplianceStorageGB: (() {
        final guardedValue = map['totalApplianceStorageGB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      totalCoreCount: (() {
        final guardedValue = map['totalCoreCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      totalHostStorageGB: (() {
        final guardedValue = map['totalHostStorageGB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      totalMemoryGB: (() {
        final guardedValue = map['totalMemoryGB'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
    );
