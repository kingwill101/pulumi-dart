...
class BgpServiceLoadBalancerConfigurationResponse {
  ...
  factory BgpServiceLoadBalancerConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return BgpServiceLoadBalancerConfigurationResponse(
      bgpAdvertisements: (() { final guardedValue = map['bgpAdvertisements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BgpAdvertisementResponse>(guardedValue, (value) => BgpAdvertisementResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
      bgpPeers: (() { final guardedValue = map['bgpPeers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceLoadBalancerBgpPeerResponse>(guardedValue, (value) => ServiceLoadBalancerBgpPeerResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
