...
class KubernetesClusterNodeResponse {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkAttachments':
          pulumi.Input.mapInputValue<
            List<NetworkAttachmentResponse>,
            List<Map<String, dynamic>>
          >(
            networkAttachments,
            (value) =>
  ...
  factory KubernetesClusterNodeResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterNodeResponse(
      ...
      bareMetalMachineId: pulumi.Input.fromValue(
        map['bareMetalMachineId'] as String,
      ),
      ...
      labels: pulumi.Input.fromValue(
        pulumi.Input.decodeList<KubernetesLabelResponse>(
          map['labels']!,
          (value) => KubernetesLabelResponse.fromMap(
      ...
      networkAttachments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<NetworkAttachmentResponse>(
          map['networkAttachments']!,
