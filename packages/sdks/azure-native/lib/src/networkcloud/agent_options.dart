...
class AgentOptions {
  ...
  final pulumi.Input<dynamic>? hugepagesSize;
  ...
  AgentOptions({
    ...
    pulumi.Input<dynamic>? hugepagesSize,
  ...
  factory AgentOptions.fromMap(Map<String, dynamic> map) {
    return AgentOptions(
      ...
      hugepagesSize: (() { final guardedValue = map['hugepagesSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
    );
  }
}
