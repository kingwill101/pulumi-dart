...
class AccessBridgeSecurityRule {
  ...
  /// Creates a new [AccessBridgeSecurityRule].
  ...
  const AccessBridgeSecurityRule({
    this.description,
  ...
  factory AccessBridgeSecurityRule.fromMap(Map<String, dynamic> map) {
    return AccessBridgeSecurityRule(
