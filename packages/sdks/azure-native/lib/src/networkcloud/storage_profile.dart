...
class StorageProfile {
  ...
  StorageProfile({required this.osDisk, this.volumeAttachments});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'osDisk': pulumi.Input.mapInputValue<OsDisk, Map<String, dynamic>>(
        osDisk,
        (value) => value.toMap(),
      ),
  ...
  factory StorageProfile.fromMap(Map<String, dynamic> map) {
    return StorageProfile(
      osDisk: pulumi.Input.fromValue(
        OsDisk.fromMap((map['osDisk']! as Map).cast<String, dynamic>()),
      ),
      volumeAttachments: (() {
