...
class GetKubernetesClusterFeatureResult {
  ...
  factory GetKubernetesClusterFeatureResult.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterFeatureResult(
      availabilityLifecycle: (() { final guardedValue = map['availabilityLifecycle']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      required: (() { final guardedValue = map['required']; if (guardedValue == null) return null; return guardedValue as String; })(),
