  ...
  factory L3NetworkArgs.fromMap(Map<String, dynamic> map) {
    return L3NetworkArgs(
      ...
      hybridAksIpamEnabled: (() {
        final guardedValue = map['hybridAksIpamEnabled'];
      ...
      ipAllocationType: (() {
        final guardedValue = map['ipAllocationType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipv4ConnectedPrefix: (() {
        final guardedValue = map['ipv4ConnectedPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipv6ConnectedPrefix: (() {
        final guardedValue = map['ipv6ConnectedPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      l3IsolationDomainId: pulumi.Input.fromValue(
        map['l3IsolationDomainId'] as String,
      ),
      l3NetworkName: (() {
        final guardedValue = map['l3NetworkName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      location: (() {
