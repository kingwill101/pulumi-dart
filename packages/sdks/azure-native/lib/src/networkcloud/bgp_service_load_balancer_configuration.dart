...
class BgpServiceLoadBalancerConfiguration {
    ...
    return <String, dynamic>{
      'bgpAdvertisements':
          ...
          >(
            bgpAdvertisements,
            (value) =>
                pulumi.Input.encodeList<BgpAdvertisement, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'bgpPeers':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceLoadBalancerBgpPeer>,
            List<Map<String, dynamic>>
          >(
            bgpPeers,
            (value) =>
  ...
  factory BgpServiceLoadBalancerConfiguration.fromMap(
    ...
    return BgpServiceLoadBalancerConfiguration(
      bgpAdvertisements: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BgpAdvertisement>(
            guardedValue,
            (value) => BgpAdvertisement.fromMap(
      ...
      bgpPeers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceLoadBalancerBgpPeer>(
            guardedValue,
            (value) => ServiceLoadBalancerBgpPeer.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
