...
class BareMetalMachineConfigurationDataResponse {
    ...
    return <String, dynamic>{
      ...
      'bmcCredentials':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(bmcCredentials, (value) => value.toMap()),
  ...
  factory BareMetalMachineConfigurationDataResponse.fromMap(
    Map<String, dynamic> map,
  ) {
    return BareMetalMachineConfigurationDataResponse(
      bmcConnectionString: pulumi.Input.fromValue(
        map['bmcConnectionString'] as String,
      ),
      bmcCredentials: pulumi.Input.fromValue(
        AdministrativeCredentialsResponse.fromMap(
      ...
      machineDetails: (() {
        final guardedValue = map['machineDetails'];
