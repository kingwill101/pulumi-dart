...
class ClusterArgs {
  ...
  final pulumi.Input<RuntimeProtectionConfiguration>?
  ...
  final pulumi.Input<VulnerabilityScanningSettings>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'aggregatorOrSingleRackDefinition':
          pulumi.Input.mapInputValue<RackDefinition, Map<String, dynamic>>(
            aggregatorOrSingleRackDefinition,
            (value) => value.toMap(),
          ),
      'analyticsOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            AnalyticsOutputSettings,
            Map<String, dynamic>
          >(analyticsOutputSettings, (value) => value.toMap()),
      ...
      'clusterServicePrincipal':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(clusterServicePrincipal, (value) => value.toMap()),
      ...
      'commandOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            CommandOutputSettings,
            Map<String, dynamic>
          >(commandOutputSettings, (value) => value.toMap()),
      'computeDeploymentThreshold':
          ?pulumi.Input.mapOptionalInputValue<
            ValidationThreshold,
            Map<String, dynamic>
          >(computeDeploymentThreshold, (value) => value.toMap()),
      'computeRackDefinitions':
          ...
          >(
            computeRackDefinitions,
            (value) =>
                pulumi.Input.encodeList<RackDefinition, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'runtimeProtectionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            RuntimeProtectionConfiguration,
            Map<String, dynamic>
          >(runtimeProtectionConfiguration, (value) => value.toMap()),
      'secretArchive':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterSecretArchive,
            Map<String, dynamic>
          >(secretArchive, (value) => value.toMap()),
      'secretArchiveSettings':
          ?pulumi.Input.mapOptionalInputValue<
            SecretArchiveSettings,
            Map<String, dynamic>
          >(secretArchiveSettings, (value) => value.toMap()),
      'tags': ?tags,
      'updateStrategy':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterUpdateStrategy,
            Map<String, dynamic>
          >(updateStrategy, (value) => value.toMap()),
      'vulnerabilityScanningSettings':
          ?pulumi.Input.mapOptionalInputValue<
            VulnerabilityScanningSettings,
            Map<String, dynamic>
          >(vulnerabilityScanningSettings, (value) => value.toMap()),
    };
  }

  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      aggregatorOrSingleRackDefinition: pulumi.Input.fromValue(
        RackDefinition.fromMap(
          (map['aggregatorOrSingleRackDefinition']! as Map)
              .cast<String, dynamic>(),
        ),
      ),
      analyticsOutputSettings: (() {
        final guardedValue = map['analyticsOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AnalyticsOutputSettings.fromMap(
      ...
      clusterServicePrincipal: (() {
        final guardedValue = map['clusterServicePrincipal'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServicePrincipalInformation.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      commandOutputSettings: (() {
        final guardedValue = map['commandOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CommandOutputSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      computeDeploymentThreshold: (() {
        final guardedValue = map['computeDeploymentThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ValidationThreshold.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      computeRackDefinitions: (() {
        final guardedValue = map['computeRackDefinitions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RackDefinition>(
            guardedValue,
            (value) =>
                RackDefinition.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ...
      runtimeProtectionConfiguration: (() {
        final guardedValue = map['runtimeProtectionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RuntimeProtectionConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      secretArchive: (() {
        final guardedValue = map['secretArchive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterSecretArchive.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      secretArchiveSettings: (() {
        final guardedValue = map['secretArchiveSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SecretArchiveSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      updateStrategy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClusterUpdateStrategy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vulnerabilityScanningSettings: (() {
        final guardedValue = map['vulnerabilityScanningSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VulnerabilityScanningSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
