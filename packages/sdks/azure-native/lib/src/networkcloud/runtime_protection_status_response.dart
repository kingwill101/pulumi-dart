...
class RuntimeProtectionStatusResponse {
  ...
  factory RuntimeProtectionStatusResponse.fromMap(Map<String, dynamic> map) {
    return RuntimeProtectionStatusResponse(
      definitionsLastUpdated: pulumi.Input.fromValue(
        map['definitionsLastUpdated'] as String,
      ),
      definitionsVersion: pulumi.Input.fromValue(
        map['definitionsVersion'] as String,
      ),
      scanCompletedTime: pulumi.Input.fromValue(
        map['scanCompletedTime'] as String,
      ),
      scanScheduledTime: pulumi.Input.fromValue(
        map['scanScheduledTime'] as String,
      ),
