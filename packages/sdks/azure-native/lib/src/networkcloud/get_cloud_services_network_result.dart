...
class GetCloudServicesNetworkResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalEgressEndpoints': ?additionalEgressEndpoints == null ? null : pulumi.Input.encodeList<EgressEndpointResponse, Map<String, dynamic>>(additionalEgressEndpoints!, (value) => value.toMap()),
