...
class GetCloudServicesNetworkResult {
  ...
  }) : enableDefaultEgressEndpoints = enableDefaultEgressEndpoints ?? 'True';
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabledEgressEndpoints': ?(() { final guardedValue = enabledEgressEndpoints; if (guardedValue == null) return null; return pulumi.Input.encodeList<EgressEndpointResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'etag': ?etag,
  ...
  factory GetCloudServicesNetworkResult.fromMap(Map<String, dynamic> map) {
    return GetCloudServicesNetworkResult(
      ...
      enabledEgressEndpoints: (() { final guardedValue = map['enabledEgressEndpoints']; if (guardedValue == null) return null; return pulumi.Input.decodeList<EgressEndpointResponse>(guardedValue, (value) => EgressEndpointResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
