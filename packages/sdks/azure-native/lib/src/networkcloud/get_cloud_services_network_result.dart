  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalEgressEndpoints': ?(() {
        final guardedValue = additionalEgressEndpoints;
      ...
      'enabledEgressEndpoints':
          pulumi.Input.encodeList<EgressEndpointResponse, Map<String, dynamic>>(
            enabledEgressEndpoints,
            (value) => value.toMap(),
          ),
      'etag': etag,
  ...
  factory GetCloudServicesNetworkResult.fromMap(Map<String, dynamic> map) {
    return GetCloudServicesNetworkResult(
      additionalEgressEndpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<EgressEndpointResponse>(
          guardedValue,
          (value) => EgressEndpointResponse.fromMap(
      ...
      enabledEgressEndpoints: pulumi.Input.decodeList<EgressEndpointResponse>(
        map['enabledEgressEndpoints']!,
        (value) => EgressEndpointResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
