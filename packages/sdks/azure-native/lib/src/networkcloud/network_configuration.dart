...
class NetworkConfiguration {
  ...
  final pulumi.Input<BgpServiceLoadBalancerConfiguration>?
  ...
  final pulumi.Input<L2ServiceLoadBalancerConfiguration>?
  ...
  factory NetworkConfiguration.fromMap(Map<String, dynamic> map) {
    return NetworkConfiguration(
      ...
      bgpServiceLoadBalancerConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BgpServiceLoadBalancerConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      l2ServiceLoadBalancerConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          L2ServiceLoadBalancerConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
