...
class AgentPoolArgs {
  ...
  AgentPoolArgs({
    ...
    pulumi.Output<AgentOptions>? agentOptions,
    pulumi.Output<String>? agentPoolName,
    pulumi.Output<AttachedNetworkConfiguration>? attachedNetworkConfiguration,
    pulumi.Output<List<String>>? availabilityZones,
    required pulumi.Output<double> count,
    pulumi.Output<ExtendedLocation>? extendedLocation,
    required pulumi.Output<String> kubernetesClusterName,
    pulumi.Output<List<KubernetesLabel>>? labels,
    pulumi.Output<String>? location,
    required pulumi.Output<String> mode,
    required pulumi.Output<String> resourceGroupName,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<KubernetesLabel>>? taints,
    pulumi.Output<AgentPoolUpgradeSettings>? upgradeSettings,
    required pulumi.Output<String> vmSkuName,
  }) :
  ...
  factory AgentPoolArgs.fromMap(Map<String, dynamic> map) {
    return AgentPoolArgs(
      ...
      agentOptions: map['agentOptions'] == null ? null : pulumi.Output.create<AgentOptions>(AgentOptions.fromMap((map['agentOptions'] as Map).cast<String, dynamic>())),
      agentPoolName: map['agentPoolName'] == null ? null : pulumi.Output.create<String>(map['agentPoolName'] as String),
      attachedNetworkConfiguration: map['attachedNetworkConfiguration'] == null ? null : pulumi.Output.create<AttachedNetworkConfiguration>(AttachedNetworkConfiguration.fromMap((map['attachedNetworkConfiguration'] as Map).cast<String, dynamic>())),
      ...
      count: pulumi.Output.create<double>(map['count'] as double),
      extendedLocation: map['extendedLocation'] == null ? null : pulumi.Output.create<ExtendedLocation>(ExtendedLocation.fromMap((map['extendedLocation'] as Map).cast<String, dynamic>())),
      kubernetesClusterName: pulumi.Output.create<String>(map['kubernetesClusterName'] as String),
      labels: map['labels'] == null ? null : pulumi.Output.create<List<KubernetesLabel>>(pulumi.Input.decodeList<KubernetesLabel>(map['labels'], (value) => KubernetesLabel.fromMap((value as Map).cast<String, dynamic>()))),
      location: map['location'] == null ? null : pulumi.Output.create<String>(map['location'] as String),
      mode: pulumi.Output.create<String>(map['mode'] as String),
      resourceGroupName: pulumi.Output.create<String>(map['resourceGroupName'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      taints: map['taints'] == null ? null : pulumi.Output.create<List<KubernetesLabel>>(pulumi.Input.decodeList<KubernetesLabel>(map['taints'], (value) => KubernetesLabel.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      vmSkuName: pulumi.Output.create<String>(map['vmSkuName'] as String),
    );
  }
}
