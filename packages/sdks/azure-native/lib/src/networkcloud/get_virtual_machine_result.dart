...
class GetVirtualMachineResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'networkAttachments': ?(() {
        final guardedValue = networkAttachments;
      ...
      'placementHints': ?(() {
        final guardedValue = placementHints;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
      ...
      'sshPublicKeys': ?(() {
        final guardedValue = sshPublicKeys;
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<
  ...
  factory GetVirtualMachineResult.fromMap(Map<String, dynamic> map) {
    return GetVirtualMachineResult(
      ...
      cloudServicesNetworkAttachment: NetworkAttachmentResponse.fromMap(
        (map['cloudServicesNetworkAttachment']! as Map).cast<String, dynamic>(),
      ),
      ...
      networkAttachments: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<NetworkAttachmentResponse>(
          guardedValue,
          (value) => NetworkAttachmentResponse.fromMap(
      ...
      placementHints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<VirtualMachinePlacementHintResponse>(
          guardedValue,
          (value) => VirtualMachinePlacementHintResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      storageProfile: StorageProfileResponse.fromMap(
