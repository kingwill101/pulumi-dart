...
class RackDefinition {
  ...
  final pulumi.Input<List<BareMetalMachineConfigurationData>>?
  ...
  final pulumi.Input<List<StorageApplianceConfigurationData>>?
    ...
    return RackDefinition(
      ...
      bareMetalMachineConfigurationData: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BareMetalMachineConfigurationData>(
            guardedValue,
      ...
      storageApplianceConfigurationData: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StorageApplianceConfigurationData>(
            guardedValue,
            (value) => StorageApplianceConfigurationData.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
