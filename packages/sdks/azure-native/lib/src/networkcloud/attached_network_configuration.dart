...
class AttachedNetworkConfiguration {
  ...
  final pulumi.Input<List<TrunkedNetworkAttachmentConfiguration>>?
  trunkedNetworks;
    ...
    return <String, dynamic>{
      'l2Networks':
          ?pulumi.Input.mapOptionalInputValue<
            List<L2NetworkAttachmentConfiguration>,
      ...
      'l3Networks':
          ?pulumi.Input.mapOptionalInputValue<
            List<L3NetworkAttachmentConfiguration>,
            List<Map<String, dynamic>>
          >(
            l3Networks,
            (value) =>
      ...
      'trunkedNetworks':
          ?pulumi.Input.mapOptionalInputValue<
            List<TrunkedNetworkAttachmentConfiguration>,
            List<Map<String, dynamic>>
          >(
            trunkedNetworks,
            (value) =>
    ...
    return AttachedNetworkConfiguration(
      l2Networks: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<L2NetworkAttachmentConfiguration>(
            guardedValue,
            (value) => L2NetworkAttachmentConfiguration.fromMap(
      ...
      l3Networks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<L3NetworkAttachmentConfiguration>(
            guardedValue,
            (value) => L3NetworkAttachmentConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      trunkedNetworks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrunkedNetworkAttachmentConfiguration>(
            guardedValue,
            (value) => TrunkedNetworkAttachmentConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
