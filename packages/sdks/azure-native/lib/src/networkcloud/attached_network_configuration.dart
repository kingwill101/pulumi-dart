...
class AttachedNetworkConfiguration {
  ...
  factory AttachedNetworkConfiguration.fromMap(Map<String, dynamic> map) {
    return AttachedNetworkConfiguration(
      l2Networks: (() { final guardedValue = map['l2Networks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<L2NetworkAttachmentConfiguration>(guardedValue, (value) => L2NetworkAttachmentConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      l3Networks: (() { final guardedValue = map['l3Networks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<L3NetworkAttachmentConfiguration>(guardedValue, (value) => L3NetworkAttachmentConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      trunkedNetworks: (() { final guardedValue = map['trunkedNetworks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TrunkedNetworkAttachmentConfiguration>(guardedValue, (value) => TrunkedNetworkAttachmentConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
