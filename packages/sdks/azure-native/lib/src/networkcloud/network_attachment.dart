...
class NetworkAttachment {
  ...
  final pulumi.Input<dynamic>? defaultGateway;
  ...
  factory NetworkAttachment.fromMap(Map<String, dynamic> map) {
    return NetworkAttachment(
      ...
      defaultGateway: (() { final guardedValue = map['defaultGateway']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ipAllocationMethod: pulumi.Input.fromValue(map['ipAllocationMethod']),
