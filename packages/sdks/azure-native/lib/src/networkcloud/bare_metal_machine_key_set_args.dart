...
class BareMetalMachineKeySetArgs {
  ...
  factory BareMetalMachineKeySetArgs.fromMap(Map<String, dynamic> map) {
    return BareMetalMachineKeySetArgs(
      ...
      bareMetalMachineKeySetName: (() { final guardedValue = map['bareMetalMachineKeySetName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      jumpHostsAllowed: pulumi.Input.fromValue((map['jumpHostsAllowed'] as List).cast<String>()),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      osGroupName: (() { final guardedValue = map['osGroupName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
