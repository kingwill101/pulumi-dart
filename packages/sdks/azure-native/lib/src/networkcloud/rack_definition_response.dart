...
class RackDefinitionResponse {
  ...
  final pulumi.Input<List<BareMetalMachineConfigurationDataResponse>>?
  ...
  final pulumi.Input<List<StorageApplianceConfigurationDataResponse>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'storageApplianceConfigurationData':
          ?pulumi.Input.mapOptionalInputValue<
            List<StorageApplianceConfigurationDataResponse>,
            List<Map<String, dynamic>>
          >(
            storageApplianceConfigurationData,
            (value) =>
  ...
  factory RackDefinitionResponse.fromMap(Map<String, dynamic> map) {
    return RackDefinitionResponse(
      ...
      bareMetalMachineConfigurationData: (() {
        final guardedValue = map['bareMetalMachineConfigurationData'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BareMetalMachineConfigurationDataResponse>(
            guardedValue,
            (value) => BareMetalMachineConfigurationDataResponse.fromMap(
      ...
      rackLocation: (() {
        final guardedValue = map['rackLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      storageApplianceConfigurationData: (() {
        final guardedValue = map['storageApplianceConfigurationData'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StorageApplianceConfigurationDataResponse>(
            guardedValue,
            (value) => StorageApplianceConfigurationDataResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
