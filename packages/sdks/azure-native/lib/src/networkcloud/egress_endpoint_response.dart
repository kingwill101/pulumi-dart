...
class EgressEndpointResponse {
  ...
  EgressEndpointResponse({required this.category, required this.endpoints});
    ...
    return <String, dynamic>{
      ...
      'endpoints':
          pulumi.Input.mapInputValue<
            List<EndpointDependencyResponse>,
  ...
  factory EgressEndpointResponse.fromMap(Map<String, dynamic> map) {
    return EgressEndpointResponse(
      ...
      endpoints: pulumi.Input.fromValue(
        pulumi.Input.decodeList<EndpointDependencyResponse>(
          map['endpoints']!,
          (value) => EndpointDependencyResponse.fromMap(
