...
class CloudServicesNetworkArgs {
  ...
  factory CloudServicesNetworkArgs.fromMap(Map<String, dynamic> map) {
    return CloudServicesNetworkArgs(
      ...
      enableDefaultEgressEndpoints: (() { final guardedValue = map['enableDefaultEgressEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
