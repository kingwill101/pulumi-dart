...
class GetClusterResult {
  ...
  const GetClusterResult({
    this.aggregatorOrSingleRackDefinition,
    this.analyticsOutputSettings,
    this.analyticsWorkspaceId,
    this.availableUpgradeVersions,
    this.azureApiVersion,
    this.clusterCapacity,
    this.clusterConnectionStatus,
    this.clusterExtendedLocation,
    this.clusterLocation,
    this.clusterManagerConnectionStatus,
    ...
    this.hybridAksExtendedLocation,
    this.id,
    this.identity,
    this.location,
    this.managedResourceGroupConfiguration,
    this.manualActionCount,
    this.name,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'availableUpgradeVersions': ?(() { final guardedValue = availableUpgradeVersions; if (guardedValue == null) return null; return pulumi.Input.encodeList<ClusterAvailableUpgradeVersionResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
  ...
  factory GetClusterResult.fromMap(Map<String, dynamic> map) {
    return GetClusterResult(
      aggregatorOrSingleRackDefinition: (() { final guardedValue = map['aggregatorOrSingleRackDefinition']; if (guardedValue == null) return null; return RackDefinitionResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      availableUpgradeVersions: (() { final guardedValue = map['availableUpgradeVersions']; if (guardedValue == null) return null; return pulumi.Input.decodeList<ClusterAvailableUpgradeVersionResponse>(guardedValue, (value) => ClusterAvailableUpgradeVersionResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
      azureApiVersion: (() { final guardedValue = map['azureApiVersion']; if (guardedValue == null) return null; return guardedValue as String; })(),
      clusterCapacity: (() { final guardedValue = map['clusterCapacity']; if (guardedValue == null) return null; return ClusterCapacityResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      clusterConnectionStatus: (() { final guardedValue = map['clusterConnectionStatus']; if (guardedValue == null) return null; return guardedValue as String; })(),
      clusterExtendedLocation: (() { final guardedValue = map['clusterExtendedLocation']; if (guardedValue == null) return null; return ExtendedLocationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      clusterLocation: (() { final guardedValue = map['clusterLocation']; if (guardedValue == null) return null; return guardedValue as String; })(),
      clusterManagerConnectionStatus: (() { final guardedValue = map['clusterManagerConnectionStatus']; if (guardedValue == null) return null; return guardedValue as String; })(),
      clusterManagerId: (() { final guardedValue = map['clusterManagerId']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      hybridAksExtendedLocation: (() { final guardedValue = map['hybridAksExtendedLocation']; if (guardedValue == null) return null; return ExtendedLocationResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
      ...
      manualActionCount: (() { final guardedValue = map['manualActionCount']; if (guardedValue == null) return null; return (guardedValue as num).toDouble(); })(),
      ...
      supportExpiryDate: (() { final guardedValue = map['supportExpiryDate']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      workloadResourceIds: (() { final guardedValue = map['workloadResourceIds']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
    );
  }
}
