...
class GetClusterResult {
    ...
    return <String, dynamic>{
      ...
      'availableUpgradeVersions':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(availableUpgradeVersions, (value) => value.toMap()),
      ...
      'computeRackDefinitions': ?(() {
        final guardedValue = computeRackDefinitions;
  ...
  factory GetClusterResult.fromMap(Map<String, dynamic> map) {
    return GetClusterResult(
      aggregatorOrSingleRackDefinition: RackDefinitionResponse.fromMap(
      ...
      availableUpgradeVersions:
          pulumi.Input.decodeList<ClusterAvailableUpgradeVersionResponse>(
            map['availableUpgradeVersions']!,
            (value) => ClusterAvailableUpgradeVersionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      azureApiVersion: map['azureApiVersion'] as String,
      clusterCapacity: ClusterCapacityResponse.fromMap(
        (map['clusterCapacity']! as Map).cast<String, dynamic>(),
      ),
      clusterConnectionStatus: map['clusterConnectionStatus'] as String,
      clusterExtendedLocation: ExtendedLocationResponse.fromMap(
        (map['clusterExtendedLocation']! as Map).cast<String, dynamic>(),
      ),
      clusterLocation: (() {
      ...
      clusterManagerConnectionStatus:
          map['clusterManagerConnectionStatus'] as String,
      ...
      computeRackDefinitions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<RackDefinitionResponse>(
          guardedValue,
          (value) => RackDefinitionResponse.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      hybridAksExtendedLocation: ExtendedLocationResponse.fromMap(
        (map['hybridAksExtendedLocation']! as Map).cast<String, dynamic>(),
      ),
      id: map['id'] as String,
      identity: (() {
