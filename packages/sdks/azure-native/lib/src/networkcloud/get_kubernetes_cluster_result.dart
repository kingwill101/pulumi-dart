...
class GetKubernetesClusterResult {
  ...
  final List<InitialAgentPoolConfigurationResponse>
    ...
    return <String, dynamic>{
      ...
      'availableUpgrades':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(availableUpgrades, (value) => value.toMap()),
      ...
      'featureStatuses':
          pulumi.Input.encodeList<FeatureStatusResponse, Map<String, dynamic>>(
            featureStatuses,
            (value) => value.toMap(),
          ),
      'id': id,
      'initialAgentPoolConfigurations':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(initialAgentPoolConfigurations, (value) => value.toMap()),
  ...
  factory GetKubernetesClusterResult.fromMap(Map<String, dynamic> map) {
    return GetKubernetesClusterResult(
      ...
      availableUpgrades: pulumi.Input.decodeList<AvailableUpgradeResponse>(
        map['availableUpgrades']!,
        (value) => AvailableUpgradeResponse.fromMap(
      ...
      controlPlaneKubernetesVersion:
          map['controlPlaneKubernetesVersion'] as String,
      controlPlaneNodeConfiguration:
          ControlPlaneNodeConfigurationResponse.fromMap(
      ...
      featureStatuses: pulumi.Input.decodeList<FeatureStatusResponse>(
        map['featureStatuses']!,
        (value) => FeatureStatusResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      id: map['id'] as String,
      initialAgentPoolConfigurations:
          pulumi.Input.decodeList<InitialAgentPoolConfigurationResponse>(
            map['initialAgentPoolConfigurations']!,
            (value) => InitialAgentPoolConfigurationResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
      ...
      networkConfiguration: NetworkConfigurationResponse.fromMap(
        (map['networkConfiguration']! as Map).cast<String, dynamic>(),
      ),
      nodes: pulumi.Input.decodeList<KubernetesClusterNodeResponse>(
        map['nodes']!,
        (value) => KubernetesClusterNodeResponse.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
