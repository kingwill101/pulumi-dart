...
class GetFleetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vmSizesProfile':
          pulumi.Input.encodeList<VmSizeProfileResponse, Map<String, dynamic>>(
            vmSizesProfile,
            (value) => value.toMap(),
          ),
      'zones': ?zones,
  ...
  factory GetFleetResult.fromMap(Map<String, dynamic> map) {
    return GetFleetResult(
      ...
      computeProfile: ComputeProfileResponse.fromMap(
      ...
      vmSizesProfile: pulumi.Input.decodeList<VmSizeProfileResponse>(
        map['vmSizesProfile']!,
        (value) => VmSizeProfileResponse.fromMap(
