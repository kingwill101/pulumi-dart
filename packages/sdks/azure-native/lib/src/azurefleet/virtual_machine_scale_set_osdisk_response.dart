...
class VirtualMachineScaleSetOSDiskResponse {
  ...
  final pulumi.Input<VirtualMachineScaleSetManagedDiskParametersResponse>?
  managedDisk;
  ...
  /// [createOption] Specifies how the virtual machines in the scale set should be created. The only
  /// [deleteOption] Specifies whether OS Disk should be deleted or detached upon VMSS Flex deletion
    ...
    return <String, dynamic>{
      ...
      'diffDiskSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(diffDiskSettings, (value) => value.toMap()),
  ...
  factory VirtualMachineScaleSetOSDiskResponse.fromMap(
    ...
    return VirtualMachineScaleSetOSDiskResponse(
      ...
      diffDiskSettings: (() {
        final guardedValue = map['diffDiskSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DiffDiskSettingsResponse.fromMap(
      ...
      image: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualHardDiskResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      managedDisk: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetManagedDiskParametersResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      vhdContainers: (() {
        final guardedValue = map['vhdContainers'];
        if (guardedValue == null) return null;
