...
class VirtualMachineScaleSetNetworkConfigurationProperties {
  ...
  final pulumi.Input<VirtualMachineScaleSetNetworkConfigurationDnsSettings>?
  dnsSettings;
  ...
  final pulumi.Input<List<VirtualMachineScaleSetIPConfiguration>>
  ipConfigurations;
  ...
  factory VirtualMachineScaleSetNetworkConfigurationProperties.fromMap(
    ...
    return VirtualMachineScaleSetNetworkConfigurationProperties(
      ...
      dnsSettings: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetNetworkConfigurationDnsSettings.fromMap(
      ...
      ipConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<VirtualMachineScaleSetIPConfiguration>(
          map['ipConfigurations']!,
          (value) => VirtualMachineScaleSetIPConfiguration.fromMap(
