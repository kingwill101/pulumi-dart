...
import 'virtual_machine_scale_set_ipconfiguration.dart';
import 'virtual_machine_scale_set_network_configuration_dns_settings.dart';
...
class VirtualMachineScaleSetNetworkConfigurationProperties {
  ...
  factory VirtualMachineScaleSetNetworkConfigurationProperties.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetNetworkConfigurationProperties(
      ...
      ipConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineScaleSetIPConfiguration>(map['ipConfigurations']!, (value) => VirtualMachineScaleSetIPConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
