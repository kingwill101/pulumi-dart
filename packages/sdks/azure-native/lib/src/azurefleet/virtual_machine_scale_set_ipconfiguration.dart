...
class VirtualMachineScaleSetIPConfiguration {
  ...
  /// Describes a virtual machine scale set network profile's IP configuration
  /// properties.
  final pulumi.Input<VirtualMachineScaleSetIPConfigurationProperties>?
  properties;
  ...
  VirtualMachineScaleSetIPConfiguration({required this.name, this.properties});
    ...
    return VirtualMachineScaleSetIPConfiguration(
      ...
      properties: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetIPConfigurationProperties.fromMap(
