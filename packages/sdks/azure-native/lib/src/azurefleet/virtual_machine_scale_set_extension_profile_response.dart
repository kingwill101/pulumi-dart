...
class VirtualMachineScaleSetExtensionProfileResponse {
  ...
  final List<VirtualMachineScaleSetExtensionResponse>? extensions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'extensions': ?extensions == null ? null : pulumi.Input.encodeList<VirtualMachineScaleSetExtensionResponse, Map<String, dynamic>>(extensions!, (value) => value.toMap()),
  ...
  factory VirtualMachineScaleSetExtensionProfileResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetExtensionProfileResponse(
      extensions: map['extensions'] == null ? null : pulumi.Input.decodeList<VirtualMachineScaleSetExtensionResponse>(map['extensions'], (value) => VirtualMachineScaleSetExtensionResponse.fromMap((value as Map).cast<String, dynamic>())),
