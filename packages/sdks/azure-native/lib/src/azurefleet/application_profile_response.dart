...
class ApplicationProfileResponse {
  ...
  factory ApplicationProfileResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationProfileResponse(
      galleryApplications: (() { final guardedValue = map['galleryApplications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VMGalleryApplicationResponse>(guardedValue, (value) => VMGalleryApplicationResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
