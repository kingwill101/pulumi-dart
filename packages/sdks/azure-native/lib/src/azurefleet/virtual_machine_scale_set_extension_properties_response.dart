...
class VirtualMachineScaleSetExtensionPropertiesResponse {
  ...
  /// Creates a new [VirtualMachineScaleSetExtensionPropertiesResponse].
  ...
  const VirtualMachineScaleSetExtensionPropertiesResponse({
