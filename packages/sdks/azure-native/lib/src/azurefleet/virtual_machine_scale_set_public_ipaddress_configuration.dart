...
class VirtualMachineScaleSetPublicIPAddressConfiguration {
  ...
  /// Describes a virtual machines scale set IP Configuration's PublicIPAddress
  /// configuration
  final VirtualMachineScaleSetPublicIPAddressConfigurationProperties? properties;
  ...
  factory VirtualMachineScaleSetPublicIPAddressConfiguration.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetPublicIPAddressConfiguration(
      ...
      properties: map['properties'] == null ? null : VirtualMachineScaleSetPublicIPAddressConfigurationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
