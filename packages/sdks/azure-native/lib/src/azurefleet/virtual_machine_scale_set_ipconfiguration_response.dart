...
class VirtualMachineScaleSetIPConfigurationResponse {
  ...
  /// Describes a virtual machine scale set network profile's IP configuration
  /// properties.
  final pulumi.Input<VirtualMachineScaleSetIPConfigurationPropertiesResponse>?
  properties;
  ...
  factory VirtualMachineScaleSetIPConfigurationResponse.fromMap(
    ...
    return VirtualMachineScaleSetIPConfigurationResponse(
      ...
      properties: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualMachineScaleSetIPConfigurationPropertiesResponse.fromMap(
