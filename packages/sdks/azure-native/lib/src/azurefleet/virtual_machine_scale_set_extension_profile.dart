...
class VirtualMachineScaleSetExtensionProfile {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'extensions': ?pulumi.Input.mapOptionalInputValue<List<VirtualMachineScaleSetExtension>, List<Map<String, dynamic>>>(extensions, (value) => pulumi.Input.encodeList<VirtualMachineScaleSetExtension, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory VirtualMachineScaleSetExtensionProfile.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetExtensionProfile(
      extensions: (() { final guardedValue = map['extensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VirtualMachineScaleSetExtension>(guardedValue, (value) => VirtualMachineScaleSetExtension.fromMap((value as Map).cast<String, dynamic>()))); })(),
