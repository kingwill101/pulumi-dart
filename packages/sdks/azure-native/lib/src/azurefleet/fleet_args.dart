...
class FleetArgs {
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      additionalLocationsProfile: (() { final guardedValue = map['additionalLocationsProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AdditionalLocationsProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      regularPriorityProfile: (() { final guardedValue = map['regularPriorityProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RegularPriorityProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resourceGroupName: pulumi.Input.fromValue(map['resourceGroupName'] as String),
      spotPriorityProfile: (() { final guardedValue = map['spotPriorityProfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SpotPriorityProfile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vmSizesProfile: pulumi.Input.fromValue(pulumi.Input.decodeList<VmSizeProfile>(map['vmSizesProfile']!, (value) => VmSizeProfile.fromMap((value as Map).cast<String, dynamic>()))),
