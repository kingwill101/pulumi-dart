...
class VaultSecretGroup {
  ...
  factory VaultSecretGroup.fromMap(Map<String, dynamic> map) {
    return VaultSecretGroup(
      ...
      vaultCertificates: (() { final guardedValue = map['vaultCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VaultCertificate>(guardedValue, (value) => VaultCertificate.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
