...
class RaiToolLabelPropertiesResponse {
  ...
  final pulumi.Input<List<RaiToolLabelPropertiesResponseProjectScopes>>?
  projectScopes;
    ...
    return <String, dynamic>{
      'accountScope':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(accountScope, (value) => value.toMap()),
      'projectScopes':
          ?pulumi.Input.mapOptionalInputValue<
            List<RaiToolLabelPropertiesResponseProjectScopes>,
  ...
  factory RaiToolLabelPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RaiToolLabelPropertiesResponse(
      accountScope: (() {
        final guardedValue = map['accountScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RaiToolLabelPropertiesResponseAccountScope.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      projectScopes: (() {
        final guardedValue = map['projectScopes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RaiToolLabelPropertiesResponseProjectScopes>(
            guardedValue,
            (value) => RaiToolLabelPropertiesResponseProjectScopes.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      toolConnectionName: pulumi.Input.fromValue(
        map['toolConnectionName'] as String,
      ),
    );
  }
}
