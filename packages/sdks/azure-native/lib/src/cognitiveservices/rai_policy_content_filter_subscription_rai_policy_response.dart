...
class RaiPolicyContentFilterSubscriptionRaiPolicyResponse {
  ...
  const RaiPolicyContentFilterSubscriptionRaiPolicyResponse({
    this.action,
    this.blocking,
    this.enabled,
    this.name,
  ...
  factory RaiPolicyContentFilterSubscriptionRaiPolicyResponse.fromMap(Map<String, dynamic> map) {
    return RaiPolicyContentFilterSubscriptionRaiPolicyResponse(
