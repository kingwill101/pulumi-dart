...
/// }
///
/// resource "azure-native_cognitiveservices_commitmentplan" "commitmentPlan" {
...
class CommitmentPlan extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [CommitmentPlan] resource.
  CommitmentPlan.reference(String urn)
    : super(
        'azure-native:cognitiveservices:CommitmentPlan',
