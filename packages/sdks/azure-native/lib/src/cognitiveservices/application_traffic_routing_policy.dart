...
class ApplicationTrafficRoutingPolicy {
  ...
  ApplicationTrafficRoutingPolicy({this.protocol, this.rules});
    ...
    return ApplicationTrafficRoutingPolicy(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrafficRoutingRule>(
            guardedValue,
            (value) => TrafficRoutingRule.fromMap(
