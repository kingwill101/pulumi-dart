...
class RaiPolicyPropertiesResponse {
  ...
  factory RaiPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RaiPolicyPropertiesResponse(
      ...
      customTopics: (() { final guardedValue = map['customTopics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CustomTopicConfigResponse>(guardedValue, (value) => CustomTopicConfigResponse.fromMap((value as Map).cast<String, dynamic>()))); })(),
