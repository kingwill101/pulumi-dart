...
class RaiToolLabelArgs {
  ...
  factory RaiToolLabelArgs.fromMap(Map<String, dynamic> map) {
    return RaiToolLabelArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RaiToolLabelProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      raiToolConnectionName: (() { final guardedValue = map['raiToolConnectionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
