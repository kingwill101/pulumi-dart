...
class SASAuthTypeConnectionProperties {
  ...
  final pulumi.Input<ConnectionSharedAccessSignature>? credentials;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authType': authType,
      'category': ?category,
      'credentials': ?pulumi.Input.mapOptionalInputValue<ConnectionSharedAccessSignature, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory SASAuthTypeConnectionProperties.fromMap(Map<String, dynamic> map) {
    return SASAuthTypeConnectionProperties(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionSharedAccessSignature.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
