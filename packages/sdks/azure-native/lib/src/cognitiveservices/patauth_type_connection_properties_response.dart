...
import 'connection_personal_access_token_response.dart';

class PATAuthTypeConnectionPropertiesResponse {
  ...
  final pulumi.Input<ConnectionPersonalAccessTokenResponse>? credentials;
  ...
  /// Creates a new [PATAuthTypeConnectionPropertiesResponse].
  ...
  const PATAuthTypeConnectionPropertiesResponse({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<ConnectionPersonalAccessTokenResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory PATAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return PATAuthTypeConnectionPropertiesResponse(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createdByWorkspaceArmId: pulumi.Input.fromValue(map['createdByWorkspaceArmId'] as String),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionPersonalAccessTokenResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
