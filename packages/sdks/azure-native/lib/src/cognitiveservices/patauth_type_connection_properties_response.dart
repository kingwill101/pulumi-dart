...
class PATAuthTypeConnectionPropertiesResponse {
  ...
  final ConnectionPersonalAccessTokenResponse? credentials;
  final String? error;
  ...
  factory PATAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return PATAuthTypeConnectionPropertiesResponse(
      ...
      credentials: map['credentials'] == null ? null : ConnectionPersonalAccessTokenResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
