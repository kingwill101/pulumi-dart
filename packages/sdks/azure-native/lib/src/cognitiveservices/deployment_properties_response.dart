    ...
    return DeploymentPropertiesResponse(
      ...
      capacitySettings: (() {
        ...
        return pulumi.Input.fromValue(
          DeploymentCapacitySettingsResponse.fromMap(
      ...
      dynamicThrottlingEnabled: pulumi.Input.fromValue(
        map['dynamicThrottlingEnabled'] as bool,
      ),
      model: (() {
        final guardedValue = map['model'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentModelResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      scaleSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DeploymentScaleSettingsResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
