...
class RaiBlocklistItemArgs {
  ...
  factory RaiBlocklistItemArgs.fromMap(Map<String, dynamic> map) {
    return RaiBlocklistItemArgs(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RaiBlocklistItemProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
