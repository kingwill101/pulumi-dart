...
class SASAuthTypeConnectionPropertiesResponse {
  ...
  final ConnectionSharedAccessSignatureResponse? credentials;
  final String? error;
  ...
  factory SASAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SASAuthTypeConnectionPropertiesResponse(
      ...
      credentials: map['credentials'] == null ? null : ConnectionSharedAccessSignatureResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
