...
import 'connection_shared_access_signature_response.dart';

class SASAuthTypeConnectionPropertiesResponse {
  ...
  final pulumi.Input<ConnectionSharedAccessSignatureResponse>? credentials;
  ...
  /// Creates a new [SASAuthTypeConnectionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<ConnectionSharedAccessSignatureResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory SASAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SASAuthTypeConnectionPropertiesResponse(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createdByWorkspaceArmId: pulumi.Input.fromValue(map['createdByWorkspaceArmId'] as String),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionSharedAccessSignatureResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
