...
/// }
///
/// resource "azure-native_cognitiveservices_raitopic" "raiTopic" {
...
class RaiTopic extends pulumi.CustomResource {
  ...
  RaiTopic(
    ...
    properties = registerOutput<RaiTopicPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RaiTopicPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    systemData = registerOutput<SystemDataResponse>('systemData', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return SystemDataResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    tags = registerOutput<Map<String, String>?>('tags', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
    type = registerOutput<String>('type');
  }

  /// Creates a typed reference to an existing [RaiTopic] resource.
  RaiTopic.reference(String urn)
    : super(
        'azure-native:cognitiveservices:RaiTopic',
