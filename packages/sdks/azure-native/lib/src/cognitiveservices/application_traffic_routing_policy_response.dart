...
class ApplicationTrafficRoutingPolicyResponse {
  ...
  ApplicationTrafficRoutingPolicyResponse({this.protocol, this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<TrafficRoutingRuleResponse>,
  ...
  factory ApplicationTrafficRoutingPolicyResponse.fromMap(
    ...
    return ApplicationTrafficRoutingPolicyResponse(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TrafficRoutingRuleResponse>(
            guardedValue,
            (value) => TrafficRoutingRuleResponse.fromMap(
