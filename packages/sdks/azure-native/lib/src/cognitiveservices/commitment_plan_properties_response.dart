...
class CommitmentPlanPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'last':
          pulumi.Input.mapInputValue<
            CommitmentPeriodResponse,
            Map<String, dynamic>
          >(last, (value) => value.toMap()),
      'next':
          ?pulumi.Input.mapOptionalInputValue<
            CommitmentPeriodResponse,
            Map<String, dynamic>
          >(next, (value) => value.toMap()),
      'planType': ?planType,
  ...
  factory CommitmentPlanPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CommitmentPlanPropertiesResponse(
      ...
      commitmentPlanGuid: (() {
        final guardedValue = map['commitmentPlanGuid'];
        if (guardedValue == null) return null;
      ...
      current: (() {
        ...
        return pulumi.Input.fromValue(
          CommitmentPeriodResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hostingModel: (() {
        final guardedValue = map['hostingModel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      last: pulumi.Input.fromValue(
        CommitmentPeriodResponse.fromMap(
          (map['last']! as Map).cast<String, dynamic>(),
        ),
      ),
      next: (() {
      ...
      provisioningIssues: pulumi.Input.fromValue(
        (map['provisioningIssues'] as List).cast<String>(),
      ),
