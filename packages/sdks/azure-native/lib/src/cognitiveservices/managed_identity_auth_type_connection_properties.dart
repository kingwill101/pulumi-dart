...
class ManagedIdentityAuthTypeConnectionProperties {
  ...
  factory ManagedIdentityAuthTypeConnectionProperties.fromMap(Map<String, dynamic> map) {
    return ManagedIdentityAuthTypeConnectionProperties(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionManagedIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
