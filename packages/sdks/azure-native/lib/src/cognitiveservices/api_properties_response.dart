  ...
  factory ApiPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApiPropertiesResponse(
      ...
      eventHubConnectionString: (() {
        final guardedValue = map['eventHubConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      qnaAzureSearchEndpointId: (() {
        final guardedValue = map['qnaAzureSearchEndpointId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      qnaAzureSearchEndpointKey: (() {
        final guardedValue = map['qnaAzureSearchEndpointKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      qnaRuntimeEndpoint: (() {
      ...
      statisticsEnabled: (() {
        final guardedValue = map['statisticsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      storageAccountConnectionString: (() {
        final guardedValue = map['storageAccountConnectionString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      superUser: (() {
      ...
      websiteName: (() {
        final guardedValue = map['websiteName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
