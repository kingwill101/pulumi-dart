...
class DeploymentType extends pulumi.CustomResource {
  ...
  DeploymentType(
    ...
    properties = registerOutput<DeploymentPropertiesResponse>('properties', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DeploymentPropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); });
