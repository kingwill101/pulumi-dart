...
import 'connection_account_key_response.dart';

/// This connection type covers the account key connection for Azure storage
class AccountKeyAuthTypeConnectionPropertiesResponse {
  ...
  /// Creates a new [AccountKeyAuthTypeConnectionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<ConnectionAccountKeyResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory AccountKeyAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AccountKeyAuthTypeConnectionPropertiesResponse(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createdByWorkspaceArmId: pulumi.Input.fromValue(map['createdByWorkspaceArmId'] as String),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionAccountKeyResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
