...
class AgenticApplicationResponse {
  ...
  final pulumi.Input<ChannelsBuiltInAuthorizationPolicyResponse>?
  authorizationPolicy;
  ...
  final pulumi.Input<ApplicationTrafficRoutingPolicyResponse>?
    ...
    return <String, dynamic>{
      'agentIdentityBlueprint':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(agentIdentityBlueprint, (value) => value.toMap()),
      'agents':
          ?pulumi.Input.mapOptionalInputValue<
            List<AgentReferenceResponse>,
      ...
      'authorizationPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(authorizationPolicy, (value) => value.toMap()),
      'baseUrl': ?baseUrl,
      'defaultInstanceIdentity':
          ?pulumi.Input.mapOptionalInputValue<
            AssignedIdentityResponse,
            Map<String, dynamic>
          >(defaultInstanceIdentity, (value) => value.toMap()),
      ...
      'trafficRoutingPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(trafficRoutingPolicy, (value) => value.toMap()),
    };
  }
  ...
  factory AgenticApplicationResponse.fromMap(Map<String, dynamic> map) {
    return AgenticApplicationResponse(
      agentIdentityBlueprint: (() {
        final guardedValue = map['agentIdentityBlueprint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AssignedIdentityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      agents: (() {
        final guardedValue = map['agents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AgentReferenceResponse>(
            guardedValue,
            (value) => AgentReferenceResponse.fromMap(
      ...
      authorizationPolicy: (() {
        final guardedValue = map['authorizationPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ChannelsBuiltInAuthorizationPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      defaultInstanceIdentity: (() {
        final guardedValue = map['defaultInstanceIdentity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AssignedIdentityResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      trafficRoutingPolicy: (() {
        final guardedValue = map['trafficRoutingPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationTrafficRoutingPolicyResponse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
