...
class UsernamePasswordAuthTypeConnectionPropertiesResponse {
  ...
  final ConnectionUsernamePasswordResponse? credentials;
  final String? error;
  ...
  factory UsernamePasswordAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return UsernamePasswordAuthTypeConnectionPropertiesResponse(
      ...
      credentials: map['credentials'] == null ? null : ConnectionUsernamePasswordResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
