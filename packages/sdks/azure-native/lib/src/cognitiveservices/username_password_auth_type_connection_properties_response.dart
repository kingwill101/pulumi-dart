...
import 'connection_username_password_response.dart';

class UsernamePasswordAuthTypeConnectionPropertiesResponse {
  ...
  final pulumi.Input<ConnectionUsernamePasswordResponse>? credentials;
  ...
  /// Creates a new [UsernamePasswordAuthTypeConnectionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<ConnectionUsernamePasswordResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory UsernamePasswordAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return UsernamePasswordAuthTypeConnectionPropertiesResponse(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createdByWorkspaceArmId: pulumi.Input.fromValue(map['createdByWorkspaceArmId'] as String),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionUsernamePasswordResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
