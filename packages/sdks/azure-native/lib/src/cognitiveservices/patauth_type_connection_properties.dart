...
class PATAuthTypeConnectionProperties {
  ...
  final ConnectionPersonalAccessToken? credentials;
  final String? error;
  ...
  factory PATAuthTypeConnectionProperties.fromMap(Map<String, dynamic> map) {
    return PATAuthTypeConnectionProperties(
      ...
      credentials: map['credentials'] == null ? null : ConnectionPersonalAccessToken.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
