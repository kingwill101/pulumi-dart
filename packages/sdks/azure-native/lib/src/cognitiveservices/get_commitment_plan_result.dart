...
/// Result data returned by getCommitmentPlan.
class GetCommitmentPlanResult {
  ...
  /// Creates a new [GetCommitmentPlanResult].
  ...
  factory GetCommitmentPlanResult.fromMap(Map<String, dynamic> map) {
    return GetCommitmentPlanResult(
      ...
      properties: CommitmentPlanPropertiesResponse.fromMap(
