...
class UsernamePasswordAuthTypeConnectionProperties {
  ...
  final pulumi.Input<ConnectionUsernamePassword?>? credentials;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authType': authType,
      'category': ?category,
      'credentials': ?pulumi.Input.mapOptionalInputValue<ConnectionUsernamePassword, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory UsernamePasswordAuthTypeConnectionProperties.fromMap(Map<String, dynamic> map) {
    return UsernamePasswordAuthTypeConnectionProperties(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionUsernamePassword.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
