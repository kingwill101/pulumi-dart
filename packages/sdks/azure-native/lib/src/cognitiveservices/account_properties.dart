...
class AccountProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'userOwnedStorage':
          ?pulumi.Input.mapOptionalInputValue<
            List<UserOwnedStorage>,
            List<Map<String, dynamic>>
          >(
            userOwnedStorage,
            (value) =>
                pulumi.Input.encodeList<UserOwnedStorage, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AccountProperties.fromMap(Map<String, dynamic> map) {
    return AccountProperties(
      ...
      userOwnedStorage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserOwnedStorage>(
            guardedValue,
            (value) => UserOwnedStorage.fromMap(
