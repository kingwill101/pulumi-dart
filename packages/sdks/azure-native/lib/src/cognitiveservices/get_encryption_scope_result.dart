...
class GetEncryptionScopeResult {
  ...
  final EncryptionScopePropertiesResponse? properties;
  ...
  factory GetEncryptionScopeResult.fromMap(Map<String, dynamic> map) {
    return GetEncryptionScopeResult(
      ...
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return EncryptionScopePropertiesResponse.fromMap((guardedValue as Map).cast<String, dynamic>()); })(),
