...
/// }
///
/// resource "azure-native_cognitiveservices_raiblocklistitem" "raiBlocklistItem" {
...
class RaiBlocklistItem extends pulumi.CustomResource {
  ...
  /// Creates a typed reference to an existing [RaiBlocklistItem] resource.
  RaiBlocklistItem.reference(String urn)
    : super(
        'azure-native:cognitiveservices:RaiBlocklistItem',
