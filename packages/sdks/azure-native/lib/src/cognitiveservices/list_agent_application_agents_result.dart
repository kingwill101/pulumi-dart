...
class ListAgentApplicationAgentsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': ?nextLink,
      'value': ?(() { final guardedValue = value; if (guardedValue == null) return null; return pulumi.Input.encodeList<AgentReferenceResourceResponse, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory ListAgentApplicationAgentsResult.fromMap(Map<String, dynamic> map) {
    return ListAgentApplicationAgentsResult(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.decodeList<AgentReferenceResourceResponse>(guardedValue, (value) => AgentReferenceResourceResponse.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
