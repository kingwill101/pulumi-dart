    ...
    return <String, dynamic>{
      'agents':
          ?pulumi.Input.mapOptionalInputValue<
            List<VersionedAgentReferenceResponse>,
      ...
      'protocols':
          ?pulumi.Input.mapOptionalInputValue<
            List<AgentProtocolVersionResponse>,
            List<Map<String, dynamic>>
          >(
            protocols,
            (value) =>
    ...
    return HostedAgentDeploymentResponse(
      agents: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VersionedAgentReferenceResponse>(
            guardedValue,
            (value) => VersionedAgentReferenceResponse.fromMap(
      ...
      protocols: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AgentProtocolVersionResponse>(
            guardedValue,
            (value) => AgentProtocolVersionResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
