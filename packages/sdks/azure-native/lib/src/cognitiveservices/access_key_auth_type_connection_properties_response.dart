...
class AccessKeyAuthTypeConnectionPropertiesResponse {
  ...
  final ConnectionAccessKeyResponse? credentials;
  final String? error;
  ...
  factory AccessKeyAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AccessKeyAuthTypeConnectionPropertiesResponse(
      ...
      credentials: map['credentials'] == null ? null : ConnectionAccessKeyResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
