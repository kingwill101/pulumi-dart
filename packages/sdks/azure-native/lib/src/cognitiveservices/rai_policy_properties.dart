  ...
  factory RaiPolicyProperties.fromMap(Map<String, dynamic> map) {
    return RaiPolicyProperties(
      ...
      customBlocklists: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomBlocklistConfig>(
            guardedValue,
            (value) => CustomBlocklistConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      customTopics: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomTopicConfig>(
            guardedValue,
            (value) => CustomTopicConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      safetyProviders: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SafetyProviderConfig>(
            guardedValue,
            (value) => SafetyProviderConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
