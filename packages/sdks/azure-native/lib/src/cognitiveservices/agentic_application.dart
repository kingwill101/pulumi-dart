    ...
    return <String, dynamic>{
      ...
      'agents':
          ...
          >(
            agents,
            (value) =>
                pulumi.Input.encodeList<AgentReference, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AgenticApplication.fromMap(Map<String, dynamic> map) {
    return AgenticApplication(
      ...
      agents: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AgentReference>(
            guardedValue,
            (value) =>
                AgentReference.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      authorizationPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ChannelsBuiltInAuthorizationPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      trafficRoutingPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationTrafficRoutingPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
