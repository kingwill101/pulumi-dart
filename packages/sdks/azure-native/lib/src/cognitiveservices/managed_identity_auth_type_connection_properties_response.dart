...
import 'connection_managed_identity_response.dart';

class ManagedIdentityAuthTypeConnectionPropertiesResponse {
  ...
  final pulumi.Input<ConnectionManagedIdentityResponse>? credentials;
  ...
  /// Creates a new [ManagedIdentityAuthTypeConnectionPropertiesResponse].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'credentials': ?pulumi.Input.mapOptionalInputValue<ConnectionManagedIdentityResponse, Map<String, dynamic>>(credentials, (value) => value.toMap()),
      'error': ?error,
  ...
  factory ManagedIdentityAuthTypeConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ManagedIdentityAuthTypeConnectionPropertiesResponse(
      authType: pulumi.Input.fromValue(map['authType'] as String),
      category: (() { final guardedValue = map['category']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      createdByWorkspaceArmId: pulumi.Input.fromValue(map['createdByWorkspaceArmId'] as String),
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionManagedIdentityResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
