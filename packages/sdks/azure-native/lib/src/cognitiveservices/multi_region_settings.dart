...
class MultiRegionSettings {
  ...
  MultiRegionSettings({this.regions, this.routingMethod});
    ...
    return <String, dynamic>{
      'regions':
          ...
          >(
            regions,
            (value) =>
                pulumi.Input.encodeList<RegionSetting, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return MultiRegionSettings(
      regions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RegionSetting>(
            guardedValue,
            (value) =>
                RegionSetting.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      routingMethod: (() {
