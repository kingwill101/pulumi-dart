...
class PrivateEndpointOutboundRuleDestinationResponse {
  ...
  const PrivateEndpointOutboundRuleDestinationResponse({
  ...
  factory PrivateEndpointOutboundRuleDestinationResponse.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointOutboundRuleDestinationResponse(
