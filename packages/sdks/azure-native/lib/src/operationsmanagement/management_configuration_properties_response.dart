...
class ManagementConfigurationPropertiesResponse {
  ...
  factory ManagementConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ManagementConfigurationPropertiesResponse(
      ...
      parameters: pulumi.Input.fromValue(pulumi.Input.decodeList<ArmTemplateParameterResponse>(map['parameters']!, (value) => ArmTemplateParameterResponse.fromMap((value as Map).cast<String, dynamic>()))),
