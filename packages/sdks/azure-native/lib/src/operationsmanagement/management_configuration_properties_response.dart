...
class ManagementConfigurationPropertiesResponse {
    ...
    return <String, dynamic>{
      ...
      'parameters':
          pulumi.Input.mapInputValue<
            List<ArmTemplateParameterResponse>,
  ...
  factory ManagementConfigurationPropertiesResponse.fromMap(
    ...
    return ManagementConfigurationPropertiesResponse(
      ...
      parameters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ArmTemplateParameterResponse>(
          map['parameters']!,
          (value) => ArmTemplateParameterResponse.fromMap(
