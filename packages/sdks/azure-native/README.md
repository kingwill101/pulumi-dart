...
Provider documentation: [Pulumi Registry](https://www.pulumi.com/registry/packages/azure-native/)
Upstream repository: [https://github.com/pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native)
...
~~~sh
dart pub add pulumi_azure_native
~~~
...
dependencies:
  pulumi_azure_native:
    git:
      ...
      path: packages/sdks/azure-native
      ref: master
~~~
