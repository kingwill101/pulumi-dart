...
class ApplicationLoadBalancerArgs {
  ...
  ApplicationLoadBalancerArgs({
    ...
    pulumi.Output<DefaultSecurityGroup>? defaultSecurityGroup,
    ...
    pulumi.Output<String>? xffHeaderProcessingMode,
      ...
      defaultSecurityGroup = pulumi.Input.asOptionalInput<DefaultSecurityGroup>(defaultSecurityGroup),
  ...
  factory ApplicationLoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationLoadBalancerArgs(
      ...
      defaultSecurityGroup: map['defaultSecurityGroup'] == null ? null : pulumi.Output.create<DefaultSecurityGroup>(DefaultSecurityGroup.fromMap((map['defaultSecurityGroup'] as Map).cast<String, dynamic>())),
