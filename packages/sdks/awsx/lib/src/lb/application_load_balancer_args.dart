...
class ApplicationLoadBalancerArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'defaultSecurityGroup': ?pulumi.Input.mapOptionalInputValue<DefaultSecurityGroup, Map<String, dynamic>>(defaultSecurityGroup, (value) => value.toMap()),
  ...
  factory ApplicationLoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationLoadBalancerArgs(
      accessLogs: map['accessLogs'] == null ? null : (pulumi_aws_lb.LoadBalancerAccessLogs.fromMap((map['accessLogs']! as Map).cast<String, dynamic>())).input(),
      clientKeepAlive: map['clientKeepAlive'] == null ? null : (map['clientKeepAlive']! as int).input(),
      connectionLogs: map['connectionLogs'] == null ? null : (pulumi_aws_lb.LoadBalancerConnectionLogs.fromMap((map['connectionLogs']! as Map).cast<String, dynamic>())).input(),
      customerOwnedIpv4Pool: map['customerOwnedIpv4Pool'] == null ? null : (map['customerOwnedIpv4Pool']! as String).input(),
      defaultSecurityGroup: map['defaultSecurityGroup'] == null ? null : (DefaultSecurityGroup.fromMap((map['defaultSecurityGroup']! as Map).cast<String, dynamic>())).input(),
      defaultTargetGroup: map['defaultTargetGroup'] == null ? null : (TargetGroup.fromMap((map['defaultTargetGroup']! as Map).cast<String, dynamic>())).input(),
      defaultTargetGroupPort: map['defaultTargetGroupPort'] == null ? null : (map['defaultTargetGroupPort']! as int).input(),
      ...
      healthCheckLogs: map['healthCheckLogs'] == null ? null : (pulumi_aws_lb.LoadBalancerHealthCheckLogs.fromMap((map['healthCheckLogs']! as Map).cast<String, dynamic>())).input(),
      ...
      ipamPools: map['ipamPools'] == null ? null : (pulumi_aws_lb.LoadBalancerIpamPools.fromMap((map['ipamPools']! as Map).cast<String, dynamic>())).input(),
      listener: map['listener'] == null ? null : (Listener.fromMap((map['listener']! as Map).cast<String, dynamic>())).input(),
      listeners: map['listeners'] == null ? null : (pulumi.Input.decodeList<Listener>(map['listeners']!, (value) => Listener.fromMap((value as Map).cast<String, dynamic>()))).input(),
      minimumLoadBalancerCapacity: map['minimumLoadBalancerCapacity'] == null ? null : (pulumi_aws_lb.LoadBalancerMinimumLoadBalancerCapacity.fromMap((map['minimumLoadBalancerCapacity']! as Map).cast<String, dynamic>())).input(),
      ...
      subnetMappings: map['subnetMappings'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_lb.LoadBalancerSubnetMapping>(map['subnetMappings']!, (value) => pulumi_aws_lb.LoadBalancerSubnetMapping.fromMap((value as Map).cast<String, dynamic>()))).input(),
      subnets: map['subnets'] == null ? null : ((map['subnets']! as List).cast<pulumi_aws_ec2.Subnet>()).input(),
