...
class ApplicationLoadBalancerArgs {
  ...
  factory ApplicationLoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationLoadBalancerArgs(
      ...
      defaultSecurityGroup: (() { final guardedValue = map['defaultSecurityGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultSecurityGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      defaultTargetGroupPort: (() { final guardedValue = map['defaultTargetGroupPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
