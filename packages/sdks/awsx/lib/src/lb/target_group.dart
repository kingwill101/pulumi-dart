...
class TargetGroup {
  ...
  factory TargetGroup.fromMap(Map<String, dynamic> map) {
    return TargetGroup(
      connectionTermination: map['connectionTermination'] == null ? null : (map['connectionTermination']! as bool).input(),
      deregistrationDelay: map['deregistrationDelay'] == null ? null : (map['deregistrationDelay']! as int).input(),
      healthCheck: map['healthCheck'] == null ? null : (pulumi_aws_lb.TargetGroupHealthCheck.fromMap((map['healthCheck']! as Map).cast<String, dynamic>())).input(),
      ipAddressType: map['ipAddressType'] == null ? null : (map['ipAddressType']! as String).input(),
      lambdaMultiValueHeadersEnabled: map['lambdaMultiValueHeadersEnabled'] == null ? null : (map['lambdaMultiValueHeadersEnabled']! as bool).input(),
      loadBalancingAlgorithmType: map['loadBalancingAlgorithmType'] == null ? null : (map['loadBalancingAlgorithmType']! as String).input(),
      loadBalancingAnomalyMitigation: map['loadBalancingAnomalyMitigation'] == null ? null : (map['loadBalancingAnomalyMitigation']! as String).input(),
      loadBalancingCrossZoneEnabled: map['loadBalancingCrossZoneEnabled'] == null ? null : (map['loadBalancingCrossZoneEnabled']! as String).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      namePrefix: map['namePrefix'] == null ? null : (map['namePrefix']! as String).input(),
      port: map['port'] == null ? null : (map['port']! as int).input(),
      preserveClientIp: map['preserveClientIp'] == null ? null : (map['preserveClientIp']! as String).input(),
      protocol: map['protocol'] == null ? null : (map['protocol']! as String).input(),
      protocolVersion: map['protocolVersion'] == null ? null : (map['protocolVersion']! as String).input(),
      proxyProtocolV2: map['proxyProtocolV2'] == null ? null : (map['proxyProtocolV2']! as bool).input(),
      region: map['region'] == null ? null : (map['region']! as String).input(),
      slowStart: map['slowStart'] == null ? null : (map['slowStart']! as int).input(),
      stickiness: map['stickiness'] == null ? null : (pulumi_aws_lb.TargetGroupStickiness.fromMap((map['stickiness']! as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags']! as Map).cast<String, String>()).input(),
      targetControlPort: map['targetControlPort'] == null ? null : (map['targetControlPort']! as int).input(),
      targetFailovers: map['targetFailovers'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_lb.TargetGroupTargetFailover>(map['targetFailovers']!, (value) => pulumi_aws_lb.TargetGroupTargetFailover.fromMap((value as Map).cast<String, dynamic>()))).input(),
      targetGroupHealth: map['targetGroupHealth'] == null ? null : (pulumi_aws_lb.TargetGroupTargetGroupHealth.fromMap((map['targetGroupHealth']! as Map).cast<String, dynamic>())).input(),
      targetHealthStates: map['targetHealthStates'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_lb.TargetGroupTargetHealthState>(map['targetHealthStates']!, (value) => pulumi_aws_lb.TargetGroupTargetHealthState.fromMap((value as Map).cast<String, dynamic>()))).input(),
