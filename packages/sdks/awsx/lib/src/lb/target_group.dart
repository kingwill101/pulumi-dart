...
class TargetGroup {
  ...
  final pulumi.Input<List<pulumi_aws_lb.TargetGroupTargetFailover>>?
  targetFailovers;

  /// Target health requirements block. See target_group_health for more information.
  final pulumi.Input<pulumi_aws_lb.TargetGroupTargetGroupHealth>?
  targetGroupHealth;

  /// Target health state block. Only applicable for Network Load Balancer target groups when `protocol` is `TCP` or `TLS`. See target_health_state for more information.
  final pulumi.Input<List<pulumi_aws_lb.TargetGroupTargetHealthState>>?
  targetHealthStates;
    ...
    return <String, dynamic>{
      ...
      'healthCheck':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_lb.TargetGroupHealthCheck,
            Map<String, dynamic>
      ...
      'stickiness':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_lb.TargetGroupStickiness,
            Map<String, dynamic>
      ...
      'targetFailovers':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_lb.TargetGroupTargetFailover>,
      ...
      'targetGroupHealth':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_lb.TargetGroupTargetGroupHealth,
            Map<String, dynamic>
          >(targetGroupHealth, (value) => value.toMap()),
      'targetHealthStates':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_lb.TargetGroupTargetHealthState>,
            List<Map<String, dynamic>>
          >(
            targetHealthStates,
            (value) =>
