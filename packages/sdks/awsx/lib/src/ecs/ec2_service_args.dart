...
class EC2ServiceArgs {
  ...
  EC2ServiceArgs({
    ...
    pulumi.Output<List<pulumi_aws_ecs.ServiceCapacityProviderStrategy>>? capacityProviderStrategies,
    ...
    pulumi.Output<List<pulumi_aws_ecs.ServiceOrderedPlacementStrategy>>? orderedPlacementStrategies,
    ...
    pulumi.Output<EC2ServiceTaskDefinition>? taskDefinitionArgs,
    ...
    pulumi.Output<List<pulumi_aws_ecs.ServiceVpcLatticeConfiguration>>? vpcLatticeConfigurations,
      ...
      capacityProviderStrategies = pulumi.Input.asOptionalInput<List<pulumi_aws_ecs.ServiceCapacityProviderStrategy>>(capacityProviderStrategies),
      ...
      orderedPlacementStrategies = pulumi.Input.asOptionalInput<List<pulumi_aws_ecs.ServiceOrderedPlacementStrategy>>(orderedPlacementStrategies),
      ...
      taskDefinitionArgs = pulumi.Input.asOptionalInput<EC2ServiceTaskDefinition>(taskDefinitionArgs),
  ...
  factory EC2ServiceArgs.fromMap(Map<String, dynamic> map) {
    return EC2ServiceArgs(
      ...
      orderedPlacementStrategies: map['orderedPlacementStrategies'] == null ? null : pulumi.Output.create<List<pulumi_aws_ecs.ServiceOrderedPlacementStrategy>>(pulumi.Input.decodeList<pulumi_aws_ecs.ServiceOrderedPlacementStrategy>(map['orderedPlacementStrategies'], (value) => pulumi_aws_ecs.ServiceOrderedPlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      taskDefinitionArgs: map['taskDefinitionArgs'] == null ? null : pulumi.Output.create<EC2ServiceTaskDefinition>(EC2ServiceTaskDefinition.fromMap((map['taskDefinitionArgs'] as Map).cast<String, dynamic>())),
