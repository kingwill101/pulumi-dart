...
class EC2ServiceArgs {
  ...
  factory EC2ServiceArgs.fromMap(Map<String, dynamic> map) {
    return EC2ServiceArgs(
      ...
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_ecs.ServiceCapacityProviderStrategy>(map['capacityProviderStrategies']!, (value) => pulumi_aws_ecs.ServiceCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      orderedPlacementStrategies: map['orderedPlacementStrategies'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_ecs.ServiceOrderedPlacementStrategy>(map['orderedPlacementStrategies']!, (value) => pulumi_aws_ecs.ServiceOrderedPlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      taskDefinitionArgs: map['taskDefinitionArgs'] == null ? null : (EC2ServiceTaskDefinition.fromMap((map['taskDefinitionArgs']! as Map).cast<String, dynamic>())).input(),
