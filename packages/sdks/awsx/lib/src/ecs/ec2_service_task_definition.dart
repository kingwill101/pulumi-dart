...
class EC2ServiceTaskDefinition {
  ...
  const EC2ServiceTaskDefinition({
    this.container,
    this.containers,
    this.cpu,
  ...
  factory EC2ServiceTaskDefinition.fromMap(Map<String, dynamic> map) {
    return EC2ServiceTaskDefinition(
      container: (() { final guardedValue = map['container']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TaskDefinitionContainerDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<TaskDefinitionContainerDefinition>(guardedValue, (value) => TaskDefinitionContainerDefinition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ephemeralStorage: (() { final guardedValue = map['ephemeralStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi_aws_ecs.TaskDefinitionEphemeralStorage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      executionRole: (() { final guardedValue = map['executionRole']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultRoleWithPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      logGroup: (() { final guardedValue = map['logGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultLogGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      placementConstraints: (() { final guardedValue = map['placementConstraints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<pulumi_aws_ecs.TaskDefinitionPlacementConstraint>(guardedValue, (value) => pulumi_aws_ecs.TaskDefinitionPlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      proxyConfiguration: (() { final guardedValue = map['proxyConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi_aws_ecs.TaskDefinitionProxyConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      runtimePlatform: (() { final guardedValue = map['runtimePlatform']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi_aws_ecs.TaskDefinitionRuntimePlatform.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      taskRole: (() { final guardedValue = map['taskRole']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DefaultRoleWithPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      volumes: (() { final guardedValue = map['volumes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<pulumi_aws_ecs.TaskDefinitionVolume>(guardedValue, (value) => pulumi_aws_ecs.TaskDefinitionVolume.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
