...
class EC2ServiceTaskDefinition {
  ...
  final pulumi.Input<pulumi_aws_ecs.TaskDefinitionEphemeralStorage>?
  ephemeralStorage;
  ...
  final pulumi.Input<List<pulumi_aws_ecs.TaskDefinitionPlacementConstraint>>?
  placementConstraints;

  /// Configuration block for the App Mesh proxy. Detailed below.
  final pulumi.Input<pulumi_aws_ecs.TaskDefinitionProxyConfiguration>?
  proxyConfiguration;
  ...
  final pulumi.Input<pulumi_aws_ecs.TaskDefinitionRuntimePlatform>?
  runtimePlatform;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ephemeralStorage':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_ecs.TaskDefinitionEphemeralStorage,
            Map<String, dynamic>
      ...
      'executionRole':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(executionRole, (value) => value.toMap()),
      'family': ?family,
      'ipcMode': ?ipcMode,
      'logGroup':
          ?pulumi.Input.mapOptionalInputValue<
            DefaultLogGroup,
            Map<String, dynamic>
          >(logGroup, (value) => value.toMap()),
      'memory': ?memory,
      'networkMode': ?networkMode,
      'pidMode': ?pidMode,
      'placementConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_ecs.TaskDefinitionPlacementConstraint>,
            List<Map<String, dynamic>>
          >(
            placementConstraints,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_ecs.TaskDefinitionPlacementConstraint,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'proxyConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_ecs.TaskDefinitionProxyConfiguration,
            Map<String, dynamic>
          >(proxyConfiguration, (value) => value.toMap()),
      'region': ?region,
      'runtimePlatform':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_ecs.TaskDefinitionRuntimePlatform,
            Map<String, dynamic>
      ...
      'taskRole':
          ?pulumi.Input.mapOptionalInputValue<
            DefaultRoleWithPolicy,
            Map<String, dynamic>
          >(taskRole, (value) => value.toMap()),
      'trackLatest': ?trackLatest,
      'volumes':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_ecs.TaskDefinitionVolume>,
            List<Map<String, dynamic>>
          >(
            volumes,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_ecs.TaskDefinitionVolume,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    };
  ...
  factory EC2ServiceTaskDefinition.fromMap(Map<String, dynamic> map) {
    return EC2ServiceTaskDefinition(
      ...
      enableFaultInjection: (() {
        final guardedValue = map['enableFaultInjection'];
        if (guardedValue == null) return null;
      ...
      ephemeralStorage: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_ecs.TaskDefinitionEphemeralStorage.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      placementConstraints: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => pulumi_aws_ecs.TaskDefinitionPlacementConstraint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      proxyConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_ecs.TaskDefinitionProxyConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      runtimePlatform: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_ecs.TaskDefinitionRuntimePlatform.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      taskRole: (() {
        final guardedValue = map['taskRole'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DefaultRoleWithPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
      ...
      trackLatest: (() {
        final guardedValue = map['trackLatest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      volumes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<pulumi_aws_ecs.TaskDefinitionVolume>(
            guardedValue,
            (value) => pulumi_aws_ecs.TaskDefinitionVolume.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
