...
class FargateTaskDefinitionArgs {
  ...
  FargateTaskDefinitionArgs({
    pulumi.Output<TaskDefinitionContainerDefinition>? container,
    pulumi.Output<Map<String, TaskDefinitionContainerDefinition>>? containers,
    pulumi.Output<String>? cpu,
    pulumi.Output<bool>? enableFaultInjection,
    pulumi.Output<pulumi_aws_ecs.TaskDefinitionEphemeralStorage>? ephemeralStorage,
    pulumi.Output<DefaultRoleWithPolicy>? executionRole,
    pulumi.Output<String>? family,
    pulumi.Output<String>? ipcMode,
    pulumi.Output<DefaultLogGroup>? logGroup,
    pulumi.Output<String>? memory,
    pulumi.Output<String>? pidMode,
    pulumi.Output<List<pulumi_aws_ecs.TaskDefinitionPlacementConstraint>>? placementConstraints,
    pulumi.Output<pulumi_aws_ecs.TaskDefinitionProxyConfiguration>? proxyConfiguration,
    pulumi.Output<String>? region,
    pulumi.Output<pulumi_aws_ecs.TaskDefinitionRuntimePlatform>? runtimePlatform,
    pulumi.Output<bool>? skipDestroy,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<DefaultRoleWithPolicy>? taskRole,
    pulumi.Output<bool>? trackLatest,
    pulumi.Output<List<pulumi_aws_ecs.TaskDefinitionVolume>>? volumes,
  }) :
  ...
  factory FargateTaskDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return FargateTaskDefinitionArgs(
      container: map['container'] == null ? null : pulumi.Output.create<TaskDefinitionContainerDefinition>(TaskDefinitionContainerDefinition.fromMap((map['container'] as Map).cast<String, dynamic>())),
      containers: map['containers'] == null ? null : pulumi.Output.create<Map<String, TaskDefinitionContainerDefinition>>(pulumi.Input.decodeMapValues<TaskDefinitionContainerDefinition>(map['containers'], (value) => TaskDefinitionContainerDefinition.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      ephemeralStorage: map['ephemeralStorage'] == null ? null : pulumi.Output.create<pulumi_aws_ecs.TaskDefinitionEphemeralStorage>(pulumi_aws_ecs.TaskDefinitionEphemeralStorage.fromMap((map['ephemeralStorage'] as Map).cast<String, dynamic>())),
      executionRole: map['executionRole'] == null ? null : pulumi.Output.create<DefaultRoleWithPolicy>(DefaultRoleWithPolicy.fromMap((map['executionRole'] as Map).cast<String, dynamic>())),
      ...
      logGroup: map['logGroup'] == null ? null : pulumi.Output.create<DefaultLogGroup>(DefaultLogGroup.fromMap((map['logGroup'] as Map).cast<String, dynamic>())),
      ...
      placementConstraints: map['placementConstraints'] == null ? null : pulumi.Output.create<List<pulumi_aws_ecs.TaskDefinitionPlacementConstraint>>(pulumi.Input.decodeList<pulumi_aws_ecs.TaskDefinitionPlacementConstraint>(map['placementConstraints'], (value) => pulumi_aws_ecs.TaskDefinitionPlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))),
      proxyConfiguration: map['proxyConfiguration'] == null ? null : pulumi.Output.create<pulumi_aws_ecs.TaskDefinitionProxyConfiguration>(pulumi_aws_ecs.TaskDefinitionProxyConfiguration.fromMap((map['proxyConfiguration'] as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      runtimePlatform: map['runtimePlatform'] == null ? null : pulumi.Output.create<pulumi_aws_ecs.TaskDefinitionRuntimePlatform>(pulumi_aws_ecs.TaskDefinitionRuntimePlatform.fromMap((map['runtimePlatform'] as Map).cast<String, dynamic>())),
      skipDestroy: map['skipDestroy'] == null ? null : pulumi.Output.create<bool>(map['skipDestroy'] as bool),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      taskRole: map['taskRole'] == null ? null : pulumi.Output.create<DefaultRoleWithPolicy>(DefaultRoleWithPolicy.fromMap((map['taskRole'] as Map).cast<String, dynamic>())),
      trackLatest: map['trackLatest'] == null ? null : pulumi.Output.create<bool>(map['trackLatest'] as bool),
      volumes: map['volumes'] == null ? null : pulumi.Output.create<List<pulumi_aws_ecs.TaskDefinitionVolume>>(pulumi.Input.decodeList<pulumi_aws_ecs.TaskDefinitionVolume>(map['volumes'], (value) => pulumi_aws_ecs.TaskDefinitionVolume.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
