...
class FargateServiceArgs {
  ...
  factory FargateServiceArgs.fromMap(Map<String, dynamic> map) {
    return FargateServiceArgs(
      ...
      taskDefinitionArgs: (() { final guardedValue = map['taskDefinitionArgs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FargateServiceTaskDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
