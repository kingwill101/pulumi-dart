  ...
  factory VpcArgs.fromMap(Map<String, dynamic> map) {
    return VpcArgs(
      ...
      availabilityZoneCidrMask: (() {
        final guardedValue = map['availabilityZoneCidrMask'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      availabilityZoneNames: (() {
        final guardedValue = map['availabilityZoneNames'];
        if (guardedValue == null) return null;
      ...
      numberOfAvailabilityZones: (() {
        final guardedValue = map['numberOfAvailabilityZones'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      region: (() {
      ...
      subnetSpecs: (() {
        final guardedValue = map['subnetSpecs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      subnetStrategy: (() {
        final guardedValue = map['subnetStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          SubnetAllocationStrategy.fromValue(guardedValue as String),
        );
      })(),
      tags: (() {
      ...
      vpcEndpointSpecs: (() {
        final guardedValue = map['vpcEndpointSpecs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpcEndpointSpec>(
            guardedValue,
            (value) =>
                VpcEndpointSpec.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
