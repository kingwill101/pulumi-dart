...
class VpcArgs {
  ...
  factory VpcArgs.fromMap(Map<String, dynamic> map) {
    return VpcArgs(
      ...
      availabilityZoneCidrMask: (() { final guardedValue = map['availabilityZoneCidrMask']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      numberOfAvailabilityZones: (() { final guardedValue = map['numberOfAvailabilityZones']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
