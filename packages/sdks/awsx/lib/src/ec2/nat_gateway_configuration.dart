...
class NatGatewayConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'strategy': pulumi.Input.mapInputValue<NatGatewayStrategy, String>(
        strategy,
  ...
  factory NatGatewayConfiguration.fromMap(Map<String, dynamic> map) {
    return NatGatewayConfiguration(
      elasticIpAllocationIds: (() {
        final guardedValue = map['elasticIpAllocationIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      strategy: pulumi.Input.fromValue(
        NatGatewayStrategy.fromValue(map['strategy']! as String),
      ),
    );
  }
}
