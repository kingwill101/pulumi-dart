...
class LifecyclePolicyRule {
  ...
  factory LifecyclePolicyRule.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyRule(
      ...
      maximumAgeLimit: (() { final guardedValue = map['maximumAgeLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      maximumNumberOfImages: (() { final guardedValue = map['maximumNumberOfImages']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
