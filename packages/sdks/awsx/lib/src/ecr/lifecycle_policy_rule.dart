...
class LifecyclePolicyRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tagStatus': pulumi.Input.mapInputValue<LifecycleTagStatus, String>(
        tagStatus,
  ...
  factory LifecyclePolicyRule.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyRule(
      ...
      maximumAgeLimit: (() {
        final guardedValue = map['maximumAgeLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      maximumNumberOfImages: (() {
        final guardedValue = map['maximumNumberOfImages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      tagPrefixList: (() {
      ...
      tagStatus: pulumi.Input.fromValue(
        LifecycleTagStatus.fromValue(map['tagStatus']! as String),
      ),
    );
  }
}
