...
class RepositoryArgs {
  ...
  final pulumi.Input<List<pulumi_aws_ecr.RepositoryEncryptionConfiguration>>?
  ...
  final pulumi.Input<pulumi_aws_ecr.RepositoryImageScanningConfiguration>?
  ...
  final pulumi.Input<
    List<pulumi_aws_ecr.RepositoryImageTagMutabilityExclusionFilter>
  >?
    ...
    return <String, dynamic>{
      'encryptionConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_ecr.RepositoryEncryptionConfiguration>,
            List<Map<String, dynamic>>
          >(
            encryptionConfigurations,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_ecr.RepositoryEncryptionConfiguration,
                  Map<String, dynamic>
      ...
      'imageScanningConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            pulumi_aws_ecr.RepositoryImageScanningConfiguration,
            Map<String, dynamic>
      ...
      'imageTagMutabilityExclusionFilters':
          ...
          >(
            ...
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_ecr.RepositoryImageTagMutabilityExclusionFilter,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'lifecyclePolicy':
    ...
    return RepositoryArgs(
      encryptionConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => pulumi_aws_ecr.RepositoryEncryptionConfiguration.fromMap(
      ...
      imageScanningConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi_aws_ecr.RepositoryImageScanningConfiguration.fromMap(
