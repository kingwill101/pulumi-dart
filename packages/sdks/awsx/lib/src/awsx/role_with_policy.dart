...
class RoleWithPolicy {
  ...
  factory RoleWithPolicy.fromMap(Map<String, dynamic> map) {
    return RoleWithPolicy(
      ...
      inlinePolicies: (() { final guardedValue = map['inlinePolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<pulumi_aws_iam.RoleInlinePolicy>(guardedValue, (value) => pulumi_aws_iam.RoleInlinePolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
