...
class RoleWithPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'inlinePolicies': ?inlinePolicies == null ? null : pulumi.Input.encodeList<pulumi_aws_iam.RoleInlinePolicy, Map<String, dynamic>>(inlinePolicies!, (value) => value.toMap()),
  ...
  factory RoleWithPolicy.fromMap(Map<String, dynamic> map) {
    return RoleWithPolicy(
      ...
      inlinePolicies: map['inlinePolicies'] == null ? null : pulumi.Input.decodeList<pulumi_aws_iam.RoleInlinePolicy>(map['inlinePolicies'], (value) => pulumi_aws_iam.RoleInlinePolicy.fromMap((value as Map).cast<String, dynamic>())),
