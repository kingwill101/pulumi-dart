...
class RequiredBucket {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'args': ?pulumi.Input.mapOptionalInputValue<Bucket, Map<String, dynamic>>(
        args,
        (value) => value.toMap(),
      ),
      'existing':
    ...
    return RequiredBucket(
      args: (() {
        ...
        return pulumi.Input.fromValue(
          Bucket.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      existing: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExistingBucket.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
