...
class Bucket {
  ...
  final List<pulumi_aws_s3.BucketCorsRule>? corsRules;
  ...
  final List<pulumi_aws_s3.BucketGrant>? grants;
  ...
  final List<pulumi_aws_s3.BucketLifecycleRule>? lifecycleRules;
  ...
  final pulumi_aws_s3.BucketLogging? logging;
  ...
  final pulumi_aws_s3.BucketObjectLockConfiguration? objectLockConfiguration;
  ...
  final pulumi_aws_s3.BucketReplicationConfiguration? replicationConfiguration;
  ...
  final pulumi_aws_s3.BucketServerSideEncryptionConfiguration? serverSideEncryptionConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'corsRules': ?corsRules == null ? null : pulumi.Input.encodeList<pulumi_aws_s3.BucketCorsRule, Map<String, dynamic>>(corsRules!, (value) => value.toMap()),
      'forceDestroy': ?forceDestroy,
      'grants': ?grants == null ? null : pulumi.Input.encodeList<pulumi_aws_s3.BucketGrant, Map<String, dynamic>>(grants!, (value) => value.toMap()),
      'lifecycleRules': ?lifecycleRules == null ? null : pulumi.Input.encodeList<pulumi_aws_s3.BucketLifecycleRule, Map<String, dynamic>>(lifecycleRules!, (value) => value.toMap()),
      ...
      'serverSideEncryptionConfiguration': ?serverSideEncryptionConfiguration == null ? null : serverSideEncryptionConfiguration!.toMap(),
      'tags': ?tags,
  ...
  factory Bucket.fromMap(Map<String, dynamic> map) {
    return Bucket(
      ...
      corsRules: map['corsRules'] == null ? null : pulumi.Input.decodeList<pulumi_aws_s3.BucketCorsRule>(map['corsRules'], (value) => pulumi_aws_s3.BucketCorsRule.fromMap((value as Map).cast<String, dynamic>())),
      forceDestroy: map['forceDestroy'] == null ? null : map['forceDestroy'] as bool,
      grants: map['grants'] == null ? null : pulumi.Input.decodeList<pulumi_aws_s3.BucketGrant>(map['grants'], (value) => pulumi_aws_s3.BucketGrant.fromMap((value as Map).cast<String, dynamic>())),
      lifecycleRules: map['lifecycleRules'] == null ? null : pulumi.Input.decodeList<pulumi_aws_s3.BucketLifecycleRule>(map['lifecycleRules'], (value) => pulumi_aws_s3.BucketLifecycleRule.fromMap((value as Map).cast<String, dynamic>())),
      logging: map['logging'] == null ? null : pulumi_aws_s3.BucketLogging.fromMap((map['logging'] as Map).cast<String, dynamic>()),
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : pulumi_aws_s3.BucketObjectLockConfiguration.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>()),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : map['objectLockEnabled'] as bool,
      policy: map['policy'] == null ? null : map['policy'] as String,
      region: map['region'] == null ? null : map['region'] as String,
      replicationConfiguration: map['replicationConfiguration'] == null ? null : pulumi_aws_s3.BucketReplicationConfiguration.fromMap((map['replicationConfiguration'] as Map).cast<String, dynamic>()),
      requestPayer: map['requestPayer'] == null ? null : map['requestPayer'] as String,
      serverSideEncryptionConfiguration: map['serverSideEncryptionConfiguration'] == null ? null : pulumi_aws_s3.BucketServerSideEncryptionConfiguration.fromMap((map['serverSideEncryptionConfiguration'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      versioning: map['versioning'] == null ? null : pulumi_aws_s3.BucketVersioning.fromMap((map['versioning'] as Map).cast<String, dynamic>()),
      website: map['website'] == null ? null : pulumi_aws_s3.BucketWebsite.fromMap((map['website'] as Map).cast<String, dynamic>()),
    );
  }
}
