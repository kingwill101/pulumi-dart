...
class Bucket {
  ...
  factory Bucket.fromMap(Map<String, dynamic> map) {
    return Bucket(
      ...
      corsRules: map['corsRules'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_s3.BucketCorsRule>(map['corsRules'], (value) => pulumi_aws_s3.BucketCorsRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      forceDestroy: map['forceDestroy'] == null ? null : (map['forceDestroy'] as bool).input(),
      grants: map['grants'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_s3.BucketGrant>(map['grants'], (value) => pulumi_aws_s3.BucketGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      lifecycleRules: map['lifecycleRules'] == null ? null : (pulumi.Input.decodeList<pulumi_aws_s3.BucketLifecycleRule>(map['lifecycleRules'], (value) => pulumi_aws_s3.BucketLifecycleRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      logging: map['logging'] == null ? null : (pulumi_aws_s3.BucketLogging.fromMap((map['logging'] as Map).cast<String, dynamic>())).input(),
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : (pulumi_aws_s3.BucketObjectLockConfiguration.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>())).input(),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : (map['objectLockEnabled'] as bool).input(),
      policy: map['policy'] == null ? null : (map['policy'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      replicationConfiguration: map['replicationConfiguration'] == null ? null : (pulumi_aws_s3.BucketReplicationConfiguration.fromMap((map['replicationConfiguration'] as Map).cast<String, dynamic>())).input(),
      requestPayer: map['requestPayer'] == null ? null : (map['requestPayer'] as String).input(),
      serverSideEncryptionConfiguration: map['serverSideEncryptionConfiguration'] == null ? null : (pulumi_aws_s3.BucketServerSideEncryptionConfiguration.fromMap((map['serverSideEncryptionConfiguration'] as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      versioning: map['versioning'] == null ? null : (pulumi_aws_s3.BucketVersioning.fromMap((map['versioning'] as Map).cast<String, dynamic>())).input(),
      website: map['website'] == null ? null : (pulumi_aws_s3.BucketWebsite.fromMap((map['website'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
