...
class DefaultSecurityGroup {
  ...
  factory DefaultSecurityGroup.fromMap(Map<String, dynamic> map) {
    return DefaultSecurityGroup(
      args: (() { final guardedValue = map['args']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SecurityGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
