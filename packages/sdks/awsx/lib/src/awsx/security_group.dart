...
class SecurityGroup {
  ...
  factory SecurityGroup.fromMap(Map<String, dynamic> map) {
    return SecurityGroup(
      ...
      egress: (() { final guardedValue = map['egress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<pulumi_aws_ec2.SecurityGroupEgress>(guardedValue, (value) => pulumi_aws_ec2.SecurityGroupEgress.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ingress: (() { final guardedValue = map['ingress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<pulumi_aws_ec2.SecurityGroupIngress>(guardedValue, (value) => pulumi_aws_ec2.SecurityGroupIngress.fromMap((value as Map).cast<String, dynamic>()))); })(),
