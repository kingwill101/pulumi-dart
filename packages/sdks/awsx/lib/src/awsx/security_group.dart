    ...
    return <String, dynamic>{
      ...
      'egress':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_ec2.SecurityGroupEgress>,
            List<Map<String, dynamic>>
          >(
            egress,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_ec2.SecurityGroupEgress,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'ingress':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_ec2.SecurityGroupIngress>,
            List<Map<String, dynamic>>
          >(
            ingress,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_ec2.SecurityGroupIngress,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      'name': ?name,
    ...
    return SecurityGroup(
      ...
      egress: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<pulumi_aws_ec2.SecurityGroupEgress>(
            guardedValue,
            (value) => pulumi_aws_ec2.SecurityGroupEgress.fromMap(
      ...
      ingress: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<pulumi_aws_ec2.SecurityGroupIngress>(
            guardedValue,
            (value) => pulumi_aws_ec2.SecurityGroupIngress.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      revokeRulesOnDelete: (() {
        final guardedValue = map['revokeRulesOnDelete'];
        if (guardedValue == null) return null;
