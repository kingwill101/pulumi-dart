...
class TrailArgs {
  ...
  final pulumi.Input<List<pulumi_aws_cloudtrail.TrailAdvancedEventSelector>>?
  ...
  final pulumi.Input<List<pulumi_aws_cloudtrail.TrailEventSelector>>?
  eventSelectors;
  ...
  final pulumi.Input<List<pulumi_aws_cloudtrail.TrailInsightSelector>>?
  insightSelectors;
    ...
    return <String, dynamic>{
      'advancedEventSelectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_cloudtrail.TrailAdvancedEventSelector>,
            List<Map<String, dynamic>>
          >(
            advancedEventSelectors,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_cloudtrail.TrailAdvancedEventSelector,
                  Map<String, dynamic>
      ...
      'cloudWatchLogsGroup':
          ?pulumi.Input.mapOptionalInputValue<
            OptionalLogGroup,
            Map<String, dynamic>
          >(cloudWatchLogsGroup, (value) => value.toMap()),
      'enableLogFileValidation': ?enableLogFileValidation,
      'enableLogging': ?enableLogging,
      'eventSelectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_cloudtrail.TrailEventSelector>,
            List<Map<String, dynamic>>
          >(
            eventSelectors,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_cloudtrail.TrailEventSelector,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
      ...
      'insightSelectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<pulumi_aws_cloudtrail.TrailInsightSelector>,
            List<Map<String, dynamic>>
          >(
            insightSelectors,
            (value) =>
                pulumi.Input.encodeList<
                  pulumi_aws_cloudtrail.TrailInsightSelector,
                  Map<String, dynamic>
                >(value, (value) => value.toMap()),
          ),
    ...
    return TrailArgs(
      advancedEventSelectors: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => pulumi_aws_cloudtrail.TrailAdvancedEventSelector.fromMap(
      ...
      cloudWatchLogsGroup: (() {
        final guardedValue = map['cloudWatchLogsGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      enableLogFileValidation: (() {
        final guardedValue = map['enableLogFileValidation'];
        if (guardedValue == null) return null;
      ...
      eventSelectors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<pulumi_aws_cloudtrail.TrailEventSelector>(
            guardedValue,
            (value) => pulumi_aws_cloudtrail.TrailEventSelector.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      includeGlobalServiceEvents: (() {
        final guardedValue = map['includeGlobalServiceEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      insightSelectors: (() {
        final guardedValue = map['insightSelectors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<pulumi_aws_cloudtrail.TrailInsightSelector>(
            guardedValue,
            (value) => pulumi_aws_cloudtrail.TrailInsightSelector.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      isMultiRegionTrail: (() {
        final guardedValue = map['isMultiRegionTrail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      isOrganizationTrail: (() {
      ...
      s3Bucket: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RequiredBucket.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      s3KeyPrefix: (() {
      ...
      snsTopicName: (() {
        final guardedValue = map['snsTopicName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
