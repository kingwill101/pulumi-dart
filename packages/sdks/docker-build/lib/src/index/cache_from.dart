  ...
  factory CacheFrom.fromMap(Map<String, dynamic> map) {
    return CacheFrom(
      ...
      gha: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CacheFromGitHubActions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      local: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CacheFromLocal.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      raw: (() {
      ...
      s3: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CacheFromS3.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
