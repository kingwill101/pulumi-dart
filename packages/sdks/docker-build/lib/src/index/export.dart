...
class Export {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'oci':
          ?pulumi.Input.mapOptionalInputValue<ExportOCI, Map<String, dynamic>>(
            oci,
            (value) => value.toMap(),
          ),
      'raw': ?raw,
      ...
      'tar':
          ?pulumi.Input.mapOptionalInputValue<ExportTar, Map<String, dynamic>>(
            tar,
            (value) => value.toMap(),
          ),
    };
  ...
  factory Export.fromMap(Map<String, dynamic> map) {
    return Export(
      cacheonly: (() {
        final guardedValue = map['cacheonly'];
      ...
      docker: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportDocker.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      image: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportImage.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      local: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportLocal.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      oci: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportOCI.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      raw: (() {
      ...
      registry: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportRegistry.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tar: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ExportTar.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
