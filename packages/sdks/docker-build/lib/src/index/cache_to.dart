...
class CacheTo {
  ...
  factory CacheTo.fromMap(Map<String, dynamic> map) {
    return CacheTo(
      azblob: (() { final guardedValue = map['azblob']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheToAzureBlob.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      disabled: (() { final guardedValue = map['disabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      gha: (() { final guardedValue = map['gha']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheToGitHubActions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      inline: (() { final guardedValue = map['inline']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      local: (() { final guardedValue = map['local']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheToLocal.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      raw: (() { final guardedValue = map['raw']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      registry: (() { final guardedValue = map['registry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheToRegistry.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      s3: (() { final guardedValue = map['s3']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CacheToS3.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
