...
class BuildContext {
  ...
  factory BuildContext.fromMap(Map<String, dynamic> map) {
    return BuildContext(
      ...
      named: (() { final guardedValue = map['named']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<Context>(guardedValue, (value) => Context.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
