...
import 'group_policies_exclusive_state.dart';
...
/// }
///
/// resource "aws_iam_grouppoliciesexclusive" "example" {
///   group_name   = exampleAwsIamGroup.name
///   policy_names = [exampleAwsIamGroupPolicy.name]
/// }
/// ```
/// ```java
...
class GroupPoliciesExclusive extends pulumi.CustomResource {
  ...
  static GroupPoliciesExclusive get(
    String name,
    pulumi.Input<String> id, {
    GroupPoliciesExclusiveState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return GroupPoliciesExclusive._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [GroupPoliciesExclusive] resource.
  GroupPoliciesExclusive.reference(String urn)
    : super(
        'aws:iam/groupPoliciesExclusive:GroupPoliciesExclusive',
