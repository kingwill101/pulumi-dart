...
class ServiceSpecificCredential extends pulumi.CustomResource {
  ...
  ServiceSpecificCredential(
    ...
    this.serviceCredentialAlias = registerOutput<String>('serviceCredentialAlias');
    this.serviceCredentialSecret = registerOutput<String>('serviceCredentialSecret');
    this.serviceName = registerOutput<String>('serviceName');
    this.servicePassword = registerOutput<String>('servicePassword');
    this.serviceSpecificCredentialId = registerOutput<String>('serviceSpecificCredentialId');
