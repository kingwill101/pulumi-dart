...
import 'group_policy_attachments_exclusive_state.dart';
...
/// }
///
/// resource "aws_iam_grouppolicyattachmentsexclusive" "example" {
///   group_name  = exampleAwsIamGroup.name
...
class GroupPolicyAttachmentsExclusive extends pulumi.CustomResource {
  ...
  static GroupPolicyAttachmentsExclusive get(
    String name,
    pulumi.Input<String> id, {
    GroupPolicyAttachmentsExclusiveState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return GroupPolicyAttachmentsExclusive._get(
      name,
      state: state?.toMap(),
  ...
  GroupPolicyAttachmentsExclusive._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [GroupPolicyAttachmentsExclusive] resource.
  GroupPolicyAttachmentsExclusive.reference(String urn)
    : super(
        'aws:iam/groupPolicyAttachmentsExclusive:GroupPolicyAttachmentsExclusive',
