...
import 'user_policies_exclusive_state.dart';
...
class UserPoliciesExclusive extends pulumi.CustomResource {
  ...
  /// Gets an existing [UserPoliciesExclusive] resource's state with the given [name] and [id].
  static UserPoliciesExclusive get(
    String name,
