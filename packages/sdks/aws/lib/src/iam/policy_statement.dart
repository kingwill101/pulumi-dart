...
class PolicyStatement {
  ...
  factory PolicyStatement.fromMap(Map<String, dynamic> map) {
    return PolicyStatement(
      ...
      notAction: (() { final guardedValue = map['NotAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      notPrincipal: (() { final guardedValue = map['NotPrincipal']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      notResource: (() { final guardedValue = map['NotResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
