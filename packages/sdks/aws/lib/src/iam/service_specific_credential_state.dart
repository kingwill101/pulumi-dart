...
class ServiceSpecificCredentialState {
  ...
  const ServiceSpecificCredentialState({
    this.createDate,
  ...
  factory ServiceSpecificCredentialState.fromMap(Map<String, dynamic> map) {
    return ServiceSpecificCredentialState(
      ...
      servicePassword: (() { final guardedValue = map['servicePassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serviceSpecificCredentialId: (() { final guardedValue = map['serviceSpecificCredentialId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      serviceUserName: (() { final guardedValue = map['serviceUserName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
