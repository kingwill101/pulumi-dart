...
class GetPrincipalPolicySimulationResult {
  ...
  final List<GetPrincipalPolicySimulationResultMatchedStatement> matchedStatements;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchedStatements': pulumi.Input.encodeList<GetPrincipalPolicySimulationResultMatchedStatement, Map<String, dynamic>>(matchedStatements, (value) => value.toMap()),
  ...
  factory GetPrincipalPolicySimulationResult.fromMap(Map<String, dynamic> map) {
    return GetPrincipalPolicySimulationResult(
      ...
      matchedStatements: pulumi.Input.decodeList<GetPrincipalPolicySimulationResultMatchedStatement>(map['matchedStatements'], (value) => GetPrincipalPolicySimulationResultMatchedStatement.fromMap((value as Map).cast<String, dynamic>())),
