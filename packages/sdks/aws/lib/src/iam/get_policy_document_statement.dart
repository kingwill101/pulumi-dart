...
class GetPolicyDocumentStatement {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'notPrincipals': ?notPrincipals == null ? null : pulumi.Input.encodeList<GetPolicyDocumentStatementNotPrincipal, Map<String, dynamic>>(notPrincipals!, (value) => value.toMap()),
  ...
  factory GetPolicyDocumentStatement.fromMap(Map<String, dynamic> map) {
    return GetPolicyDocumentStatement(
      ...
      notPrincipals: map['notPrincipals'] == null ? null : pulumi.Input.decodeList<GetPolicyDocumentStatementNotPrincipal>(map['notPrincipals'], (value) => GetPolicyDocumentStatementNotPrincipal.fromMap((value as Map).cast<String, dynamic>())),
