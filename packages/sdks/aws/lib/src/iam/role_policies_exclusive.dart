...
import 'role_policies_exclusive_state.dart';
...
class RolePoliciesExclusive extends pulumi.CustomResource {
  ...
  /// Gets an existing [RolePoliciesExclusive] resource's state with the given [name] and [id].
  static RolePoliciesExclusive get(
    String name,
