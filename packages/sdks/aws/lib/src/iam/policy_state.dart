...
class PolicyState {
  ...
  factory PolicyState.fromMap(Map<String, dynamic> map) {
    return PolicyState(
      ...
      attachmentCount: (() { final guardedValue = map['attachmentCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      delayAfterPolicyCreationInMs: (() { final guardedValue = map['delayAfterPolicyCreationInMs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
