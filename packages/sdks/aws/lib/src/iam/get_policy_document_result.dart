...
class GetPolicyDocumentResult {
  ...
  factory GetPolicyDocumentResult.fromMap(Map<String, dynamic> map) {
    return GetPolicyDocumentResult(
      ...
      sourceJson: (() { final guardedValue = map['sourceJson']; if (guardedValue == null) return null; return guardedValue as String; })(),
      sourcePolicyDocuments: (() { final guardedValue = map['sourcePolicyDocuments']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
