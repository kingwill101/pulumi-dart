...
class TopicState {
  ...
  factory TopicState.fromMap(Map<String, dynamic> map) {
    return TopicState(
      applicationFailureFeedbackRoleArn: map['applicationFailureFeedbackRoleArn'] == null ? null : ((map['applicationFailureFeedbackRoleArn'] as String).input()).input(),
      applicationSuccessFeedbackRoleArn: map['applicationSuccessFeedbackRoleArn'] == null ? null : ((map['applicationSuccessFeedbackRoleArn'] as String).input()).input(),
      applicationSuccessFeedbackSampleRate: map['applicationSuccessFeedbackSampleRate'] == null ? null : ((map['applicationSuccessFeedbackSampleRate'] as int).input()).input(),
      archivePolicy: map['archivePolicy'] == null ? null : ((map['archivePolicy'] as String).input()).input(),
      arn: map['arn'] == null ? null : ((map['arn'] as String).input()).input(),
      beginningArchiveTime: map['beginningArchiveTime'] == null ? null : ((map['beginningArchiveTime'] as String).input()).input(),
      contentBasedDeduplication: map['contentBasedDeduplication'] == null ? null : ((map['contentBasedDeduplication'] as bool).input()).input(),
      ...
      fifoThroughputScope: map['fifoThroughputScope'] == null ? null : ((map['fifoThroughputScope'] as String).input()).input(),
      fifoTopic: map['fifoTopic'] == null ? null : ((map['fifoTopic'] as bool).input()).input(),
      firehoseFailureFeedbackRoleArn: map['firehoseFailureFeedbackRoleArn'] == null ? null : ((map['firehoseFailureFeedbackRoleArn'] as String).input()).input(),
      firehoseSuccessFeedbackRoleArn: map['firehoseSuccessFeedbackRoleArn'] == null ? null : ((map['firehoseSuccessFeedbackRoleArn'] as String).input()).input(),
      firehoseSuccessFeedbackSampleRate: map['firehoseSuccessFeedbackSampleRate'] == null ? null : ((map['firehoseSuccessFeedbackSampleRate'] as int).input()).input(),
      httpFailureFeedbackRoleArn: map['httpFailureFeedbackRoleArn'] == null ? null : ((map['httpFailureFeedbackRoleArn'] as String).input()).input(),
      httpSuccessFeedbackRoleArn: map['httpSuccessFeedbackRoleArn'] == null ? null : ((map['httpSuccessFeedbackRoleArn'] as String).input()).input(),
      httpSuccessFeedbackSampleRate: map['httpSuccessFeedbackSampleRate'] == null ? null : ((map['httpSuccessFeedbackSampleRate'] as int).input()).input(),
      kmsMasterKeyId: map['kmsMasterKeyId'] == null ? null : ((map['kmsMasterKeyId'] as String).input()).input(),
      lambdaFailureFeedbackRoleArn: map['lambdaFailureFeedbackRoleArn'] == null ? null : ((map['lambdaFailureFeedbackRoleArn'] as String).input()).input(),
      lambdaSuccessFeedbackRoleArn: map['lambdaSuccessFeedbackRoleArn'] == null ? null : ((map['lambdaSuccessFeedbackRoleArn'] as String).input()).input(),
      lambdaSuccessFeedbackSampleRate: map['lambdaSuccessFeedbackSampleRate'] == null ? null : ((map['lambdaSuccessFeedbackSampleRate'] as int).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      namePrefix: map['namePrefix'] == null ? null : ((map['namePrefix'] as String).input()).input(),
      owner: map['owner'] == null ? null : ((map['owner'] as String).input()).input(),
      policy: map['policy'] == null ? null : ((map['policy'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      signatureVersion: map['signatureVersion'] == null ? null : ((map['signatureVersion'] as int).input()).input(),
      sqsFailureFeedbackRoleArn: map['sqsFailureFeedbackRoleArn'] == null ? null : ((map['sqsFailureFeedbackRoleArn'] as String).input()).input(),
      sqsSuccessFeedbackRoleArn: map['sqsSuccessFeedbackRoleArn'] == null ? null : ((map['sqsSuccessFeedbackRoleArn'] as String).input()).input(),
      sqsSuccessFeedbackSampleRate: map['sqsSuccessFeedbackSampleRate'] == null ? null : ((map['sqsSuccessFeedbackSampleRate'] as int).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      tracingConfig: map['tracingConfig'] == null ? null : ((map['tracingConfig'] as String).input()).input(),
    );
  }
}
