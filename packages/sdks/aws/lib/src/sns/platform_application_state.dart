...
class PlatformApplicationState {
  ...
  const PlatformApplicationState({
  ...
  factory PlatformApplicationState.fromMap(Map<String, dynamic> map) {
    return PlatformApplicationState(
      ...
      platformCredential: (() { final guardedValue = map['platformCredential']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
