...
class SmsPreferencesArgs {
  ...
  factory SmsPreferencesArgs.fromMap(Map<String, dynamic> map) {
    return SmsPreferencesArgs(
      ...
      defaultSmsType: (() {
        final guardedValue = map['defaultSmsType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deliveryStatusIamRoleArn: (() {
        final guardedValue = map['deliveryStatusIamRoleArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deliveryStatusSuccessSamplingRate: (() {
        final guardedValue = map['deliveryStatusSuccessSamplingRate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      monthlySpendLimit: (() {
        final guardedValue = map['monthlySpendLimit'];
        if (guardedValue == null) return null;
      ...
      usageReportS3Bucket: (() {
        final guardedValue = map['usageReportS3Bucket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
