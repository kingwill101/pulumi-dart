...
class Topic extends pulumi.CustomResource {
  ...
  Topic(String name, {TopicArgs? args, pulumi.CustomResourceOptions? options})
    ...
    applicationFailureFeedbackRoleArn = registerOutput<String?>(
      'applicationFailureFeedbackRoleArn',
    );
    applicationSuccessFeedbackRoleArn = registerOutput<String?>(
      'applicationSuccessFeedbackRoleArn',
    );
    applicationSuccessFeedbackSampleRate = registerOutput<int?>(
    ...
    contentBasedDeduplication = registerOutput<bool?>(
    ...
    firehoseFailureFeedbackRoleArn = registerOutput<String?>(
      'firehoseFailureFeedbackRoleArn',
    );
    firehoseSuccessFeedbackRoleArn = registerOutput<String?>(
      'firehoseSuccessFeedbackRoleArn',
    );
    firehoseSuccessFeedbackSampleRate = registerOutput<int?>(
      'firehoseSuccessFeedbackSampleRate',
    );
    httpFailureFeedbackRoleArn = registerOutput<String?>(
      'httpFailureFeedbackRoleArn',
    );
    httpSuccessFeedbackRoleArn = registerOutput<String?>(
      'httpSuccessFeedbackRoleArn',
    );
    httpSuccessFeedbackSampleRate = registerOutput<int?>(
      'httpSuccessFeedbackSampleRate',
    );
    kmsMasterKeyId = registerOutput<String?>('kmsMasterKeyId');
    lambdaFailureFeedbackRoleArn = registerOutput<String?>(
      'lambdaFailureFeedbackRoleArn',
    );
    lambdaSuccessFeedbackRoleArn = registerOutput<String?>(
      'lambdaSuccessFeedbackRoleArn',
    );
    lambdaSuccessFeedbackSampleRate = registerOutput<int?>(
    ...
    sqsFailureFeedbackRoleArn = registerOutput<String?>(
      'sqsFailureFeedbackRoleArn',
    );
    sqsSuccessFeedbackRoleArn = registerOutput<String?>(
      'sqsSuccessFeedbackRoleArn',
    );
    sqsSuccessFeedbackSampleRate = registerOutput<int?>(
