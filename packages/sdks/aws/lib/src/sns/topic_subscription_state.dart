...
class TopicSubscriptionState {
  ...
  factory TopicSubscriptionState.fromMap(Map<String, dynamic> map) {
    return TopicSubscriptionState(
      ...
      confirmationWasAuthenticated: map['confirmationWasAuthenticated'] == null ? null : (map['confirmationWasAuthenticated'] as bool).input(),
      ...
      pendingConfirmation: map['pendingConfirmation'] == null ? null : (map['pendingConfirmation'] as bool).input(),
