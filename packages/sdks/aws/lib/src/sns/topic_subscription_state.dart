...
class TopicSubscriptionState {
  ...
  factory TopicSubscriptionState.fromMap(Map<String, dynamic> map) {
    return TopicSubscriptionState(
      ...
      filterPolicy: (() { final guardedValue = map['filterPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      filterPolicyScope: (() { final guardedValue = map['filterPolicyScope']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      pendingConfirmation: (() { final guardedValue = map['pendingConfirmation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      protocol: (() { final guardedValue = map['protocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rawMessageDelivery: (() { final guardedValue = map['rawMessageDelivery']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
