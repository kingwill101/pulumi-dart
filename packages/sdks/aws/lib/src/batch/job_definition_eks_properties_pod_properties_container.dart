...
class JobDefinitionEksPropertiesPodPropertiesContainer {
  ...
  final pulumi.Input<List<JobDefinitionEksPropertiesPodPropertiesContainerEnv>>?
  envs;
  ...
  final pulumi.Input<JobDefinitionEksPropertiesPodPropertiesContainerResources>?
  resources;
  ...
  final pulumi.Input<
    List<JobDefinitionEksPropertiesPodPropertiesContainerVolumeMount>
  >?
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'envs':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobDefinitionEksPropertiesPodPropertiesContainerEnv>,
