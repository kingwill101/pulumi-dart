...
class ComputeEnvironmentComputeResources {
  ...
  factory ComputeEnvironmentComputeResources.fromMap(Map<String, dynamic> map) {
    return ComputeEnvironmentComputeResources(
      ...
      bidPercentage: (() { final guardedValue = map['bidPercentage']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      desiredVcpus: (() { final guardedValue = map['desiredVcpus']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      maxVcpus: pulumi.Input.fromValue((map['maxVcpus'] as num).toInt()),
      minVcpus: (() { final guardedValue = map['minVcpus']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
