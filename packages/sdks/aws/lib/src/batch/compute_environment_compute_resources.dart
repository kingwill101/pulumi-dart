...
class ComputeEnvironmentComputeResources {
  ...
  factory ComputeEnvironmentComputeResources.fromMap(Map<String, dynamic> map) {
    return ComputeEnvironmentComputeResources(
      ...
      bidPercentage: map['bidPercentage'] == null ? null : ((map['bidPercentage'] as int).input()).input(),
      desiredVcpus: map['desiredVcpus'] == null ? null : ((map['desiredVcpus'] as int).input()).input(),
      ec2Configurations: map['ec2Configurations'] == null ? null : ((pulumi.Input.decodeList<ComputeEnvironmentComputeResourcesEc2Configuration>(map['ec2Configurations']!, (value) => ComputeEnvironmentComputeResourcesEc2Configuration.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ec2KeyPair: map['ec2KeyPair'] == null ? null : ((map['ec2KeyPair'] as String).input()).input(),
      imageId: map['imageId'] == null ? null : ((map['imageId'] as String).input()).input(),
      instanceRole: map['instanceRole'] == null ? null : ((map['instanceRole'] as String).input()).input(),
      instanceTypes: map['instanceTypes'] == null ? null : (((map['instanceTypes'] as List).cast<String>()).input()).input(),
      launchTemplate: map['launchTemplate'] == null ? null : ((ComputeEnvironmentComputeResourcesLaunchTemplate.fromMap((map['launchTemplate']! as Map).cast<String, dynamic>())).input()).input(),
      maxVcpus: (map['maxVcpus'] as int).input(),
      minVcpus: map['minVcpus'] == null ? null : ((map['minVcpus'] as int).input()).input(),
      ...
      spotIamFleetRole: map['spotIamFleetRole'] == null ? null : ((map['spotIamFleetRole'] as String).input()).input(),
