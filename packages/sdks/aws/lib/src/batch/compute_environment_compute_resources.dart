...
class ComputeEnvironmentComputeResources {
  ...
  factory ComputeEnvironmentComputeResources.fromMap(Map<String, dynamic> map) {
    return ComputeEnvironmentComputeResources(
      ...
      bidPercentage: map['bidPercentage'] == null ? null : (map['bidPercentage'] as int).input(),
      desiredVcpus: map['desiredVcpus'] == null ? null : (map['desiredVcpus'] as int).input(),
      ec2Configurations: map['ec2Configurations'] == null ? null : (pulumi.Input.decodeList<ComputeEnvironmentComputeResourcesEc2Configuration>(map['ec2Configurations'], (value) => ComputeEnvironmentComputeResourcesEc2Configuration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ec2KeyPair: map['ec2KeyPair'] == null ? null : (map['ec2KeyPair'] as String).input(),
      ...
      launchTemplate: map['launchTemplate'] == null ? null : (ComputeEnvironmentComputeResourcesLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>())).input(),
      maxVcpus: (map['maxVcpus'] as int).input(),
      minVcpus: map['minVcpus'] == null ? null : (map['minVcpus'] as int).input(),
      placementGroup: map['placementGroup'] == null ? null : (map['placementGroup'] as String).input(),
      securityGroupIds: map['securityGroupIds'] == null ? null : ((map['securityGroupIds'] as List).cast<String>()).input(),
      spotIamFleetRole: map['spotIamFleetRole'] == null ? null : (map['spotIamFleetRole'] as String).input(),
