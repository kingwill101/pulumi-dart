...
class GetJobDefinitionNodeProperty {
  ...
  final pulumi.Input<List<GetJobDefinitionNodePropertyNodeRangeProperty>>
  nodeRangeProperties;
    ...
    return <String, dynamic>{
      ...
      'nodeRangeProperties':
          pulumi.Input.mapInputValue<
            List<GetJobDefinitionNodePropertyNodeRangeProperty>,
  ...
  factory GetJobDefinitionNodeProperty.fromMap(Map<String, dynamic> map) {
    return GetJobDefinitionNodeProperty(
      mainNode: pulumi.Input.fromValue(map['mainNode'] as int),
      nodeRangeProperties: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobDefinitionNodePropertyNodeRangeProperty>(
