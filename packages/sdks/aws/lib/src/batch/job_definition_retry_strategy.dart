...
class JobDefinitionRetryStrategy {
  ...
  final pulumi.Input<List<JobDefinitionRetryStrategyEvaluateOnExit>>?
  evaluateOnExits;
  ...
  JobDefinitionRetryStrategy({this.attempts, this.evaluateOnExits});
    ...
    return <String, dynamic>{
      ...
      'evaluateOnExits':
          ?pulumi.Input.mapOptionalInputValue<
            List<JobDefinitionRetryStrategyEvaluateOnExit>,
  ...
  factory JobDefinitionRetryStrategy.fromMap(Map<String, dynamic> map) {
    return JobDefinitionRetryStrategy(
      ...
      evaluateOnExits: (() {
        final guardedValue = map['evaluateOnExits'];
        if (guardedValue == null) return null;
