...
class JobQueueTimeouts {
  ...
  /// Creates a new [JobQueueTimeouts].
  ...
  JobQueueTimeouts({this.create, this.delete, this.update});
  ...
  factory JobQueueTimeouts.fromMap(Map<String, dynamic> map) {
    return JobQueueTimeouts(
      create: (() {
