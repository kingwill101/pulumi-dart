...
class GetJobDefinitionEksPropertyPodProperty {
  ...
  final pulumi.Input<List<GetJobDefinitionEksPropertyPodPropertyContainer>>
  containers;
  ...
  final pulumi.Input<
    List<GetJobDefinitionEksPropertyPodPropertyImagePullSecret>
  >
  imagePullSecrets;

  /// Containers which run before application containers, always runs to completion, and must complete successfully before the next container starts. These containers are registered with the Amazon EKS Connector agent and persists the registration information in the Kubernetes backend data store. See containers below.
  final pulumi.Input<List<GetJobDefinitionEksPropertyPodPropertyInitContainer>>
  initContainers;

  /// Metadata about the Kubernetes pod.
  final pulumi.Input<List<GetJobDefinitionEksPropertyPodPropertyMetadata>>
  metadatas;
  ...
  final pulumi.Input<List<GetJobDefinitionEksPropertyPodPropertyVolume>>
  volumes;
    ...
    return <String, dynamic>{
      'containers':
          pulumi.Input.mapInputValue<
            List<GetJobDefinitionEksPropertyPodPropertyContainer>,
      ...
      'initContainers':
          pulumi.Input.mapInputValue<
            List<GetJobDefinitionEksPropertyPodPropertyInitContainer>,
            List<Map<String, dynamic>>
          >(
            initContainers,
            (value) =>
      ...
      'metadatas':
          pulumi.Input.mapInputValue<
            List<GetJobDefinitionEksPropertyPodPropertyMetadata>,
            List<Map<String, dynamic>>
          >(
            metadatas,
            (value) =>
      ...
      'volumes':
          pulumi.Input.mapInputValue<
            List<GetJobDefinitionEksPropertyPodPropertyVolume>,
            List<Map<String, dynamic>>
          >(
            volumes,
            (value) =>
  ...
  factory GetJobDefinitionEksPropertyPodProperty.fromMap(
    ...
    return GetJobDefinitionEksPropertyPodProperty(
      containers: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetJobDefinitionEksPropertyPodPropertyContainer>(
          map['containers']!,
      ...
      imagePullSecrets: pulumi.Input.fromValue(
      ...
      metadatas: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyMetadata>(
          map['metadatas']!,
      ...
      shareProcessNamespace: pulumi.Input.fromValue(
