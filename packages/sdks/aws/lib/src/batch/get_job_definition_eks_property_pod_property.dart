...
class GetJobDefinitionEksPropertyPodProperty {
  ...
  final List<GetJobDefinitionEksPropertyPodPropertyImagePullSecret> imagePullSecrets;
  /// Containers which run before application containers, always runs to completion, and must complete successfully before the next container starts. These containers are registered with the Amazon EKS Connector agent and persists the registration information in the Kubernetes backend data store. See containers below.
  final List<GetJobDefinitionEksPropertyPodPropertyInitContainer> initContainers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'containers': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyContainer, Map<String, dynamic>>(containers, (value) => value.toMap()),
      'dnsPolicy': dnsPolicy,
      'hostNetwork': hostNetwork,
      'imagePullSecrets': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyImagePullSecret, Map<String, dynamic>>(imagePullSecrets, (value) => value.toMap()),
      'initContainers': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyInitContainer, Map<String, dynamic>>(initContainers, (value) => value.toMap()),
      'metadatas': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyMetadata, Map<String, dynamic>>(metadatas, (value) => value.toMap()),
      'serviceAccountName': serviceAccountName,
      'shareProcessNamespace': shareProcessNamespace,
      'volumes': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyVolume, Map<String, dynamic>>(volumes, (value) => value.toMap()),
    };
  }
  ...
  factory GetJobDefinitionEksPropertyPodProperty.fromMap(Map<String, dynamic> map) {
    return GetJobDefinitionEksPropertyPodProperty(
      containers: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyContainer>(map['containers'], (value) => GetJobDefinitionEksPropertyPodPropertyContainer.fromMap((value as Map).cast<String, dynamic>())),
      dnsPolicy: map['dnsPolicy'] as String,
      hostNetwork: map['hostNetwork'] as bool,
      imagePullSecrets: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyImagePullSecret>(map['imagePullSecrets'], (value) => GetJobDefinitionEksPropertyPodPropertyImagePullSecret.fromMap((value as Map).cast<String, dynamic>())),
      initContainers: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyInitContainer>(map['initContainers'], (value) => GetJobDefinitionEksPropertyPodPropertyInitContainer.fromMap((value as Map).cast<String, dynamic>())),
      metadatas: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyMetadata>(map['metadatas'], (value) => GetJobDefinitionEksPropertyPodPropertyMetadata.fromMap((value as Map).cast<String, dynamic>())),
      serviceAccountName: map['serviceAccountName'] as String,
      shareProcessNamespace: map['shareProcessNamespace'] as bool,
      volumes: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyVolume>(map['volumes'], (value) => GetJobDefinitionEksPropertyPodPropertyVolume.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
