...
class GetJobDefinitionEksPropertyPodProperty {
  ...
  /// [imagePullSecrets] List of Kubernetes secret resources. See `imagePullSecrets` below.
  /// [initContainers] Containers which run before application containers, always runs to completion, and must complete successfully before the next container starts. These containers are registered with the Amazon EKS Connector agent and persists the registration information in the Kubernetes backend data store. See `initContainers` below.
  /// [metadatas] Metadata about the Kubernetes pod. See `metadata` below.
  ...
  factory GetJobDefinitionEksPropertyPodProperty.fromMap(Map<String, dynamic> map) {
    return GetJobDefinitionEksPropertyPodProperty(
      containers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyContainer>(map['containers']!, (value) => GetJobDefinitionEksPropertyPodPropertyContainer.fromMap((value as Map).cast<String, dynamic>()))),
      dnsPolicy: pulumi.Input.fromValue(map['dnsPolicy'] as String),
      hostNetwork: pulumi.Input.fromValue(map['hostNetwork'] as bool),
      imagePullSecrets: pulumi.Input.fromValue(pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyImagePullSecret>(map['imagePullSecrets']!, (value) => GetJobDefinitionEksPropertyPodPropertyImagePullSecret.fromMap((value as Map).cast<String, dynamic>()))),
      initContainers: pulumi.Input.fromValue(pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyInitContainer>(map['initContainers']!, (value) => GetJobDefinitionEksPropertyPodPropertyInitContainer.fromMap((value as Map).cast<String, dynamic>()))),
      metadatas: pulumi.Input.fromValue(pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyMetadata>(map['metadatas']!, (value) => GetJobDefinitionEksPropertyPodPropertyMetadata.fromMap((value as Map).cast<String, dynamic>()))),
      serviceAccountName: pulumi.Input.fromValue(map['serviceAccountName'] as String),
      shareProcessNamespace: pulumi.Input.fromValue(map['shareProcessNamespace'] as bool),
      volumes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyVolume>(map['volumes']!, (value) => GetJobDefinitionEksPropertyPodPropertyVolume.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
