...
class JobDefinitionEksProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'podProperties': pulumi.Input.mapInputValue<JobDefinitionEksPropertiesPodProperties, Map<String, dynamic>>(podProperties, (value) => value.toMap()),
    };
  }

  factory JobDefinitionEksProperties.fromMap(Map<String, dynamic> map) {
    return JobDefinitionEksProperties(
      podProperties: pulumi.Input.fromValue(JobDefinitionEksPropertiesPodProperties.fromMap((map['podProperties']! as Map).cast<String, dynamic>())),
    );
  }
}
