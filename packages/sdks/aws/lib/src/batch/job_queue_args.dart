...
class JobQueueArgs {
  ...
  factory JobQueueArgs.fromMap(Map<String, dynamic> map) {
    return JobQueueArgs(
      computeEnvironmentOrders: (() {
        final guardedValue = map['computeEnvironmentOrders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobQueueComputeEnvironmentOrder>(
            guardedValue,
            (value) => JobQueueComputeEnvironmentOrder.fromMap(
      ...
      jobStateTimeLimitActions: (() {
        final guardedValue = map['jobStateTimeLimitActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<JobQueueJobStateTimeLimitAction>(
            guardedValue,
            (value) => JobQueueJobStateTimeLimitAction.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      schedulingPolicyArn: (() {
        final guardedValue = map['schedulingPolicyArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
