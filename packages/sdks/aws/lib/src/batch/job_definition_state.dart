...
class JobDefinitionState {
  ...
  factory JobDefinitionState.fromMap(Map<String, dynamic> map) {
    return JobDefinitionState(
      ...
      arnPrefix: (() {
        final guardedValue = map['arnPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      containerProperties: (() {
        final guardedValue = map['containerProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deregisterOnNewRevision: (() {
        final guardedValue = map['deregisterOnNewRevision'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ecsProperties: (() {
        final guardedValue = map['ecsProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      eksProperties: (() {
        final guardedValue = map['eksProperties'];
        if (guardedValue == null) return null;
      ...
      nodeProperties: (() {
        final guardedValue = map['nodeProperties'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parameters: (() {
      ...
      platformCapabilities: (() {
        final guardedValue = map['platformCapabilities'];
        if (guardedValue == null) return null;
      ...
      schedulingPriority: (() {
        final guardedValue = map['schedulingPriority'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      tags: (() {
