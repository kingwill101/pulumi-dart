...
class JobDefinitionState {
  ...
  factory JobDefinitionState.fromMap(Map<String, dynamic> map) {
    return JobDefinitionState(
      ...
      arnPrefix: map['arnPrefix'] == null ? null : ((map['arnPrefix'] as String).input()).input(),
      containerProperties: map['containerProperties'] == null ? null : ((map['containerProperties'] as String).input()).input(),
      deregisterOnNewRevision: map['deregisterOnNewRevision'] == null ? null : ((map['deregisterOnNewRevision'] as bool).input()).input(),
      ecsProperties: map['ecsProperties'] == null ? null : ((map['ecsProperties'] as String).input()).input(),
      eksProperties: map['eksProperties'] == null ? null : ((JobDefinitionEksProperties.fromMap((map['eksProperties']! as Map).cast<String, dynamic>())).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      nodeProperties: map['nodeProperties'] == null ? null : ((map['nodeProperties'] as String).input()).input(),
      parameters: map['parameters'] == null ? null : (((map['parameters'] as Map).cast<String, String>()).input()).input(),
      platformCapabilities: map['platformCapabilities'] == null ? null : (((map['platformCapabilities'] as List).cast<String>()).input()).input(),
      propagateTags: map['propagateTags'] == null ? null : ((map['propagateTags'] as bool).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      retryStrategy: map['retryStrategy'] == null ? null : ((JobDefinitionRetryStrategy.fromMap((map['retryStrategy']! as Map).cast<String, dynamic>())).input()).input(),
      revision: map['revision'] == null ? null : ((map['revision'] as int).input()).input(),
      schedulingPriority: map['schedulingPriority'] == null ? null : ((map['schedulingPriority'] as int).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      timeout: map['timeout'] == null ? null : ((JobDefinitionTimeout.fromMap((map['timeout']! as Map).cast<String, dynamic>())).input()).input(),
