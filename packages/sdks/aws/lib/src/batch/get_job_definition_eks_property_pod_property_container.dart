...
class GetJobDefinitionEksPropertyPodPropertyContainer {
  ...
  final List<GetJobDefinitionEksPropertyPodPropertyContainerSecurityContext> securityContexts;
  /// The volume mounts for the container.
  final List<GetJobDefinitionEksPropertyPodPropertyContainerVolumeMount> volumeMounts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'args': args,
      'commands': commands,
      'envs': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyContainerEnv, Map<String, dynamic>>(envs, (value) => value.toMap()),
      'image': image,
      'imagePullPolicy': imagePullPolicy,
      'name': name,
      'resources': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyContainerResource, Map<String, dynamic>>(resources, (value) => value.toMap()),
      'securityContexts': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyContainerSecurityContext, Map<String, dynamic>>(securityContexts, (value) => value.toMap()),
      'volumeMounts': pulumi.Input.encodeList<GetJobDefinitionEksPropertyPodPropertyContainerVolumeMount, Map<String, dynamic>>(volumeMounts, (value) => value.toMap()),
    };
  }
  ...
  factory GetJobDefinitionEksPropertyPodPropertyContainer.fromMap(Map<String, dynamic> map) {
    return GetJobDefinitionEksPropertyPodPropertyContainer(
      ...
      envs: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyContainerEnv>(map['envs'], (value) => GetJobDefinitionEksPropertyPodPropertyContainerEnv.fromMap((value as Map).cast<String, dynamic>())),
      image: map['image'] as String,
      imagePullPolicy: map['imagePullPolicy'] as String,
      name: map['name'] as String,
      resources: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyContainerResource>(map['resources'], (value) => GetJobDefinitionEksPropertyPodPropertyContainerResource.fromMap((value as Map).cast<String, dynamic>())),
      securityContexts: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyContainerSecurityContext>(map['securityContexts'], (value) => GetJobDefinitionEksPropertyPodPropertyContainerSecurityContext.fromMap((value as Map).cast<String, dynamic>())),
      volumeMounts: pulumi.Input.decodeList<GetJobDefinitionEksPropertyPodPropertyContainerVolumeMount>(map['volumeMounts'], (value) => GetJobDefinitionEksPropertyPodPropertyContainerVolumeMount.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
