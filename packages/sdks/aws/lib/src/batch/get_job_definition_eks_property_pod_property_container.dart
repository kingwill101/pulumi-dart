...
class GetJobDefinitionEksPropertyPodPropertyContainer {
  ...
  final pulumi.Input<List<GetJobDefinitionEksPropertyPodPropertyContainerEnv>>
  envs;
  ...
  final pulumi.Input<
    List<GetJobDefinitionEksPropertyPodPropertyContainerSecurityContext>
  >
  securityContexts;

  /// The volume mounts for the container.
  final pulumi.Input<
    List<GetJobDefinitionEksPropertyPodPropertyContainerVolumeMount>
  >
  volumeMounts;
    ...
    return <String, dynamic>{
      ...
      'envs':
          pulumi.Input.mapInputValue<
            List<GetJobDefinitionEksPropertyPodPropertyContainerEnv>,
