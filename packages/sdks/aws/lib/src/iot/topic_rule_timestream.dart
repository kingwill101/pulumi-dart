...
class TopicRuleTimestream {
  ...
  factory TopicRuleTimestream.fromMap(Map<String, dynamic> map) {
    return TopicRuleTimestream(
      ...
      dimensions: pulumi.Input.fromValue(pulumi.Input.decodeList<TopicRuleTimestreamDimension>(map['dimensions']!, (value) => TopicRuleTimestreamDimension.fromMap((value as Map).cast<String, dynamic>()))),
      roleArn: pulumi.Input.fromValue(map['roleArn'] as String),
      tableName: pulumi.Input.fromValue(map['tableName'] as String),
      timestamp: (() { final guardedValue = map['timestamp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TopicRuleTimestreamTimestamp.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
