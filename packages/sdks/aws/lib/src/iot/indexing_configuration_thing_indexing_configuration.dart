...
class IndexingConfigurationThingIndexingConfiguration {
  ...
  final pulumi.Input<IndexingConfigurationThingIndexingConfigurationFilter>?
  filter;

  /// Contains fields that are indexed and whose types are already known by the Fleet Indexing service. See below.
  final pulumi.Input<
    List<IndexingConfigurationThingIndexingConfigurationManagedField>
  >?
  managedFields;
  ...
  factory IndexingConfigurationThingIndexingConfiguration.fromMap(
    ...
    return IndexingConfigurationThingIndexingConfiguration(
      customFields: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                IndexingConfigurationThingIndexingConfigurationCustomField.fromMap(
      ...
      deviceDefenderIndexingMode: (() {
        final guardedValue = map['deviceDefenderIndexingMode'];
        if (guardedValue == null) return null;
      ...
      managedFields: (() {
        final guardedValue = map['managedFields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            IndexingConfigurationThingIndexingConfigurationManagedField
          >(
            guardedValue,
            (value) =>
                IndexingConfigurationThingIndexingConfigurationManagedField.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      namedShadowIndexingMode: (() {
        final guardedValue = map['namedShadowIndexingMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      thingConnectivityIndexingMode: (() {
        final guardedValue = map['thingConnectivityIndexingMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      thingIndexingMode: pulumi.Input.fromValue(
        map['thingIndexingMode'] as String,
      ),
    );
  }
}
