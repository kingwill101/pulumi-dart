...
class EventConfigurationsState {
  ...
  factory EventConfigurationsState.fromMap(Map<String, dynamic> map) {
    return EventConfigurationsState(
      eventConfigurations: (() { final guardedValue = map['eventConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, bool>()); })(),
