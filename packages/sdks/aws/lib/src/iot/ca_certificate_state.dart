...
class CaCertificateState {
  ...
  factory CaCertificateState.fromMap(Map<String, dynamic> map) {
    return CaCertificateState(
      ...
      allowAutoRegistration: (() { final guardedValue = map['allowAutoRegistration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      customerVersion: (() { final guardedValue = map['customerVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      validities: (() { final guardedValue = map['validities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CaCertificateValidity>(guardedValue, (value) => CaCertificateValidity.fromMap((value as Map).cast<String, dynamic>()))); })(),
