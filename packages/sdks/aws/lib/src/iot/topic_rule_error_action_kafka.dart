...
class TopicRuleErrorActionKafka {
  ...
  factory TopicRuleErrorActionKafka.fromMap(Map<String, dynamic> map) {
    return TopicRuleErrorActionKafka(
      ...
      headers: map['headers'] == null ? null : ((pulumi.Input.decodeList<TopicRuleErrorActionKafkaHeader>(map['headers']!, (value) => TopicRuleErrorActionKafkaHeader.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
