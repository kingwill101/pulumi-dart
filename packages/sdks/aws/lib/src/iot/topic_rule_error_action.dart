...
class TopicRuleErrorAction {
    ...
    return <String, dynamic>{
      'cloudwatchAlarm':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cloudwatchAlarm, (value) => value.toMap()),
      'cloudwatchLogs':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'cloudwatchMetric':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cloudwatchMetric, (value) => value.toMap()),
      'dynamodb':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'iotAnalytics':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(iotAnalytics, (value) => value.toMap()),
      'iotEvents':
          ?pulumi.Input.mapOptionalInputValue<
            TopicRuleErrorActionIotEvents,
            Map<String, dynamic>
          >(iotEvents, (value) => value.toMap()),
      'kafka':
          ?pulumi.Input.mapOptionalInputValue<
            TopicRuleErrorActionKafka,
            Map<String, dynamic>
          >(kafka, (value) => value.toMap()),
      'kinesis':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'stepFunctions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(stepFunctions, (value) => value.toMap()),
      'timestream':
          ?pulumi.Input.mapOptionalInputValue<
            TopicRuleErrorActionTimestream,
            Map<String, dynamic>
          >(timestream, (value) => value.toMap()),
    };
  }
  ...
  factory TopicRuleErrorAction.fromMap(Map<String, dynamic> map) {
    return TopicRuleErrorAction(
      cloudwatchAlarm: (() {
        final guardedValue = map['cloudwatchAlarm'];
      ...
      cloudwatchMetric: (() {
        final guardedValue = map['cloudwatchMetric'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dynamodbv2: (() {
        final guardedValue = map['dynamodbv2'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      iotAnalytics: (() {
        final guardedValue = map['iotAnalytics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      iotEvents: (() {
        final guardedValue = map['iotEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      republish: (() {
        final guardedValue = map['republish'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      stepFunctions: (() {
        final guardedValue = map['stepFunctions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      timestream: (() {
        final guardedValue = map['timestream'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
