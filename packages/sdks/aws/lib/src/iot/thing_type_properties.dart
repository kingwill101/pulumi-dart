...
class ThingTypeProperties {
  ...
  factory ThingTypeProperties.fromMap(Map<String, dynamic> map) {
    return ThingTypeProperties(
      ...
      searchableAttributes: (() { final guardedValue = map['searchableAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
