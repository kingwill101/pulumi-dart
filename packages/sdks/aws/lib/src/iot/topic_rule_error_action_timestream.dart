...
class TopicRuleErrorActionTimestream {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dimensions': pulumi.Input.encodeList<TopicRuleErrorActionTimestreamDimension, Map<String, dynamic>>(dimensions, (value) => value.toMap()),
      'roleArn': roleArn,
      'tableName': tableName,
  ...
  factory TopicRuleErrorActionTimestream.fromMap(Map<String, dynamic> map) {
    return TopicRuleErrorActionTimestream(
      ...
      dimensions: pulumi.Input.decodeList<TopicRuleErrorActionTimestreamDimension>(map['dimensions'], (value) => TopicRuleErrorActionTimestreamDimension.fromMap((value as Map).cast<String, dynamic>())),
      roleArn: map['roleArn'] as String,
      tableName: map['tableName'] as String,
      timestamp: map['timestamp'] == null ? null : TopicRuleErrorActionTimestreamTimestamp.fromMap((map['timestamp'] as Map).cast<String, dynamic>()),
    );
  }
}
