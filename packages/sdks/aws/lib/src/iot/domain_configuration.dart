...
import 'domain_configuration_state.dart';
...
class DomainConfiguration extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DomainConfigurationAuthorizerConfig?>
  authorizerConfig;
  ...
  DomainConfiguration(
    ...
    serverCertificateArns = registerOutput<List<String>?>(
      'serverCertificateArns',
    );
  ...
  /// Gets an existing [DomainConfiguration] resource's state with the given [name] and [id].
  static DomainConfiguration get(
    String name,
