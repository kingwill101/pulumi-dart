...
import 'provisioning_template_state.dart';
...
class ProvisioningTemplate extends pulumi.CustomResource {
  ...
  ProvisioningTemplate(
    ...
    this.preProvisioningHook = registerOutput<ProvisioningTemplatePreProvisioningHook?>('preProvisioningHook');
  ...
  /// Gets an existing [ProvisioningTemplate] resource's state with the given [name] and [id].
  static ProvisioningTemplate get(
    String name,
