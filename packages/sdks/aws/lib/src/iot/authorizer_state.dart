  ...
  factory AuthorizerState.fromMap(Map<String, dynamic> map) {
    return AuthorizerState(
      ...
      authorizerFunctionArn: (() {
        final guardedValue = map['authorizerFunctionArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      enableCachingForHttp: (() {
        final guardedValue = map['enableCachingForHttp'];
        if (guardedValue == null) return null;
      ...
      signingDisabled: (() {
        final guardedValue = map['signingDisabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      status: (() {
      ...
      tokenKeyName: (() {
        final guardedValue = map['tokenKeyName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tokenSigningPublicKeys: (() {
        final guardedValue = map['tokenSigningPublicKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
