...
class TopicRuleState {
  ...
  factory TopicRuleState.fromMap(Map<String, dynamic> map) {
    return TopicRuleState(
      ...
      cloudwatchAlarms: map['cloudwatchAlarms'] == null ? null : ((pulumi.Input.decodeList<TopicRuleCloudwatchAlarm>(map['cloudwatchAlarms']!, (value) => TopicRuleCloudwatchAlarm.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      cloudwatchLogs: map['cloudwatchLogs'] == null ? null : ((pulumi.Input.decodeList<TopicRuleCloudwatchLog>(map['cloudwatchLogs']!, (value) => TopicRuleCloudwatchLog.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      cloudwatchMetrics: map['cloudwatchMetrics'] == null ? null : ((pulumi.Input.decodeList<TopicRuleCloudwatchMetric>(map['cloudwatchMetrics']!, (value) => TopicRuleCloudwatchMetric.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      dynamodbs: map['dynamodbs'] == null ? null : ((pulumi.Input.decodeList<TopicRuleDynamodb>(map['dynamodbs']!, (value) => TopicRuleDynamodb.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      dynamodbv2s: map['dynamodbv2s'] == null ? null : ((pulumi.Input.decodeList<TopicRuleDynamodbv2>(map['dynamodbv2s']!, (value) => TopicRuleDynamodbv2.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      elasticsearch: map['elasticsearch'] == null ? null : ((pulumi.Input.decodeList<TopicRuleElasticsearch>(map['elasticsearch']!, (value) => TopicRuleElasticsearch.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      enabled: map['enabled'] == null ? null : ((map['enabled'] as bool).input()).input(),
      errorAction: map['errorAction'] == null ? null : ((TopicRuleErrorAction.fromMap((map['errorAction']! as Map).cast<String, dynamic>())).input()).input(),
      firehoses: map['firehoses'] == null ? null : ((pulumi.Input.decodeList<TopicRuleFirehose>(map['firehoses']!, (value) => TopicRuleFirehose.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      https: map['https'] == null ? null : ((pulumi.Input.decodeList<TopicRuleHttp>(map['https']!, (value) => TopicRuleHttp.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      iotAnalytics: map['iotAnalytics'] == null ? null : ((pulumi.Input.decodeList<TopicRuleIotAnalytic>(map['iotAnalytics']!, (value) => TopicRuleIotAnalytic.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      iotEvents: map['iotEvents'] == null ? null : ((pulumi.Input.decodeList<TopicRuleIotEvent>(map['iotEvents']!, (value) => TopicRuleIotEvent.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      kafkas: map['kafkas'] == null ? null : ((pulumi.Input.decodeList<TopicRuleKafka>(map['kafkas']!, (value) => TopicRuleKafka.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      kineses: map['kineses'] == null ? null : ((pulumi.Input.decodeList<TopicRuleKinesis>(map['kineses']!, (value) => TopicRuleKinesis.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      lambdas: map['lambdas'] == null ? null : ((pulumi.Input.decodeList<TopicRuleLambda>(map['lambdas']!, (value) => TopicRuleLambda.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      republishes: map['republishes'] == null ? null : ((pulumi.Input.decodeList<TopicRuleRepublish>(map['republishes']!, (value) => TopicRuleRepublish.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      s3: map['s3'] == null ? null : ((pulumi.Input.decodeList<TopicRuleS3>(map['s3']!, (value) => TopicRuleS3.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      sns: map['sns'] == null ? null : ((pulumi.Input.decodeList<TopicRuleSns>(map['sns']!, (value) => TopicRuleSns.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      sql: map['sql'] == null ? null : ((map['sql'] as String).input()).input(),
      sqlVersion: map['sqlVersion'] == null ? null : ((map['sqlVersion'] as String).input()).input(),
      sqs: map['sqs'] == null ? null : ((pulumi.Input.decodeList<TopicRuleSqs>(map['sqs']!, (value) => TopicRuleSqs.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      stepFunctions: map['stepFunctions'] == null ? null : ((pulumi.Input.decodeList<TopicRuleStepFunction>(map['stepFunctions']!, (value) => TopicRuleStepFunction.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      timestreams: map['timestreams'] == null ? null : ((pulumi.Input.decodeList<TopicRuleTimestream>(map['timestreams']!, (value) => TopicRuleTimestream.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
