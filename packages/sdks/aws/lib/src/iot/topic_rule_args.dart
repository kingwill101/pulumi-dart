...
class TopicRuleArgs {
  ...
  factory TopicRuleArgs.fromMap(Map<String, dynamic> map) {
    return TopicRuleArgs(
      cloudwatchAlarms: (() {
        final guardedValue = map['cloudwatchAlarms'];
      ...
      dynamodbs: (() {
        final guardedValue = map['dynamodbs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dynamodbv2s: (() {
        final guardedValue = map['dynamodbv2s'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      firehoses: (() {
        final guardedValue = map['firehoses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kafkas: (() {
        final guardedValue = map['kafkas'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TopicRuleKafka>(
            guardedValue,
            (value) =>
                TopicRuleKafka.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      kineses: (() {
        final guardedValue = map['kineses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lambdas: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TopicRuleLambda>(
            guardedValue,
            (value) =>
                TopicRuleLambda.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
      ...
      republishes: (() {
        final guardedValue = map['republishes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      timestreams: (() {
        final guardedValue = map['timestreams'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
