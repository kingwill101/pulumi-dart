...
class ThingPrincipalAttachmentState {
  ...
  const ThingPrincipalAttachmentState({
    this.principal,
    this.region,
    this.thing,
  ...
  factory ThingPrincipalAttachmentState.fromMap(Map<String, dynamic> map) {
    return ThingPrincipalAttachmentState(
      ...
      thing: (() { final guardedValue = map['thing']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
