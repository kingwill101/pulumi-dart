...
class DataIntegrationState {
  ...
  factory DataIntegrationState.fromMap(Map<String, dynamic> map) {
    return DataIntegrationState(
      ...
      scheduleConfig: (() { final guardedValue = map['scheduleConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataIntegrationScheduleConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
