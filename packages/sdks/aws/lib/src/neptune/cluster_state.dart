...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      neptuneClusterParameterGroupName: map['neptuneClusterParameterGroupName'] == null ? null : (map['neptuneClusterParameterGroupName'] as String).input(),
      neptuneInstanceParameterGroupName: map['neptuneInstanceParameterGroupName'] == null ? null : (map['neptuneInstanceParameterGroupName'] as String).input(),
      neptuneSubnetGroupName: map['neptuneSubnetGroupName'] == null ? null : (map['neptuneSubnetGroupName'] as String).input(),
      ...
      readerEndpoint: map['readerEndpoint'] == null ? null : (map['readerEndpoint'] as String).input(),
