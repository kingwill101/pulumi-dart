  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      neptuneClusterParameterGroupName: (() {
        final guardedValue = map['neptuneClusterParameterGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      neptuneInstanceParameterGroupName: (() {
        final guardedValue = map['neptuneInstanceParameterGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      neptuneSubnetGroupName: (() {
        final guardedValue = map['neptuneSubnetGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      port: (() {
