...
class ScheduledQuery extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ScheduledQueryTargetConfiguration> targetConfiguration;
  late final pulumi.Output<ScheduledQueryTimeouts?> timeouts;

  /// Creates a new [ScheduledQuery].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ScheduledQuery]. {@macro pulumi_timestreamquery_scheduled_query_scheduled_query_args_doc}
  ...
  ScheduledQuery(
    ...
    this.errorReportConfiguration = registerOutput<ScheduledQueryErrorReportConfiguration>('errorReportConfiguration');
    this.executionRoleArn = registerOutput<String>('executionRoleArn');
    this.kmsKeyId = registerOutput<String?>('kmsKeyId');
    this.lastRunSummaries = registerOutput<List<ScheduledQueryLastRunSummary>?>('lastRunSummaries');
    this.name = registerOutput<String>('name');
    this.nextInvocationTime = registerOutput<String>('nextInvocationTime');
    this.notificationConfiguration = registerOutput<ScheduledQueryNotificationConfiguration>('notificationConfiguration');
    this.previousInvocationTime = registerOutput<String>('previousInvocationTime');
    this.queryString = registerOutput<String>('queryString');
    this.recentlyFailedRuns = registerOutput<List<ScheduledQueryRecentlyFailedRun>?>('recentlyFailedRuns');
    this.region = registerOutput<String>('region');
    this.scheduleConfiguration = registerOutput<ScheduledQueryScheduleConfiguration>('scheduleConfiguration');
    this.state = registerOutput<String>('state');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.targetConfiguration = registerOutput<ScheduledQueryTargetConfiguration>('targetConfiguration');
