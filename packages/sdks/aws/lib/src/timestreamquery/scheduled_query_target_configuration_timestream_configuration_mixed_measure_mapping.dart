...
class ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMapping {
  ...
  final List<ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMappingMultiMeasureAttributeMapping>? multiMeasureAttributeMappings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'multiMeasureAttributeMappings': ?multiMeasureAttributeMappings == null ? null : pulumi.Input.encodeList<ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMappingMultiMeasureAttributeMapping, Map<String, dynamic>>(multiMeasureAttributeMappings!, (value) => value.toMap()),
  ...
  factory ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMapping.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryTargetConfigurationTimestreamConfigurationMixedMeasureMapping(
      measureName: map['measureName'] == null ? null : map['measureName'] as String,
      ...
      sourceColumn: map['sourceColumn'] == null ? null : map['sourceColumn'] as String,
      targetMeasureName: map['targetMeasureName'] == null ? null : map['targetMeasureName'] as String,
    );
  }
}
