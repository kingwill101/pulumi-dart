...
class BranchState {
  ...
  factory BranchState.fromMap(Map<String, dynamic> map) {
    return BranchState(
      ...
      associatedResources: map['associatedResources'] == null ? null : (((map['associatedResources'] as List).cast<String>()).input()).input(),
      ...
      customDomains: map['customDomains'] == null ? null : (((map['customDomains'] as List).cast<String>()).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      destinationBranch: map['destinationBranch'] == null ? null : ((map['destinationBranch'] as String).input()).input(),
      ...
      sourceBranch: map['sourceBranch'] == null ? null : ((map['sourceBranch'] as String).input()).input(),
