...
class AppState {
  ...
  /// [autoBranchCreationConfig] Automated branch creation configuration for an Amplify app. See `autoBranchCreationConfig` Block for details.
  ...
  /// [cacheConfig] Cache configuration for the Amplify app. See `cacheConfig` Block for details.
  ...
  /// [customRules] Custom rewrite and redirect rules for an Amplify app. See `customRule` Block for details.
  ...
  /// [jobConfig] Used to configure the [Amplify Application build instance compute type](https://docs.aws.amazon.com/amplify/latest/APIReference/API_JobConfig.html#amplify-Type-JobConfig-buildComputeType). See `jobConfig` Block for details.
  ...
  /// [productionBranches] Describes the information about a production branch for an Amplify app. A `productionBranch` block is documented below.
  ...
  factory AppState.fromMap(Map<String, dynamic> map) {
    return AppState(
      ...
      autoBranchCreationConfig: (() { final guardedValue = map['autoBranchCreationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppAutoBranchCreationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      autoBranchCreationPatterns: (() { final guardedValue = map['autoBranchCreationPatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      cacheConfig: (() { final guardedValue = map['cacheConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppCacheConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      computeRoleArn: (() { final guardedValue = map['computeRoleArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      customRules: (() { final guardedValue = map['customRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppCustomRule>(guardedValue, (value) => AppCustomRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      enableAutoBranchCreation: (() { final guardedValue = map['enableAutoBranchCreation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      enableBranchAutoBuild: (() { final guardedValue = map['enableBranchAutoBuild']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableBranchAutoDeletion: (() { final guardedValue = map['enableBranchAutoDeletion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      jobConfig: (() { final guardedValue = map['jobConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppJobConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oauthToken: (() { final guardedValue = map['oauthToken']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      productionBranches: (() { final guardedValue = map['productionBranches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AppProductionBranch>(guardedValue, (value) => AppProductionBranch.fromMap((value as Map).cast<String, dynamic>()))); })(),
