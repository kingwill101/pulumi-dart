...
class AppState {
  ...
  factory AppState.fromMap(Map<String, dynamic> map) {
    return AppState(
      ...
      productionBranches: map['productionBranches'] == null ? null : (pulumi.Input.decodeList<AppProductionBranch>(map['productionBranches'], (value) => AppProductionBranch.fromMap((value as Map).cast<String, dynamic>()))).input(),
