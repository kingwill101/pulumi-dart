...
class AppState {
  ...
  factory AppState.fromMap(Map<String, dynamic> map) {
    return AppState(
      ...
      autoBranchCreationConfig: map['autoBranchCreationConfig'] == null ? null : ((AppAutoBranchCreationConfig.fromMap((map['autoBranchCreationConfig']! as Map).cast<String, dynamic>())).input()).input(),
      autoBranchCreationPatterns: map['autoBranchCreationPatterns'] == null ? null : (((map['autoBranchCreationPatterns'] as List).cast<String>()).input()).input(),
      ...
      cacheConfig: map['cacheConfig'] == null ? null : ((AppCacheConfig.fromMap((map['cacheConfig']! as Map).cast<String, dynamic>())).input()).input(),
      computeRoleArn: map['computeRoleArn'] == null ? null : ((map['computeRoleArn'] as String).input()).input(),
      customHeaders: map['customHeaders'] == null ? null : ((map['customHeaders'] as String).input()).input(),
      customRules: map['customRules'] == null ? null : ((pulumi.Input.decodeList<AppCustomRule>(map['customRules']!, (value) => AppCustomRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      defaultDomain: map['defaultDomain'] == null ? null : ((map['defaultDomain'] as String).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      enableAutoBranchCreation: map['enableAutoBranchCreation'] == null ? null : ((map['enableAutoBranchCreation'] as bool).input()).input(),
      enableBasicAuth: map['enableBasicAuth'] == null ? null : ((map['enableBasicAuth'] as bool).input()).input(),
      enableBranchAutoBuild: map['enableBranchAutoBuild'] == null ? null : ((map['enableBranchAutoBuild'] as bool).input()).input(),
      enableBranchAutoDeletion: map['enableBranchAutoDeletion'] == null ? null : ((map['enableBranchAutoDeletion'] as bool).input()).input(),
      ...
      jobConfig: map['jobConfig'] == null ? null : ((AppJobConfig.fromMap((map['jobConfig']! as Map).cast<String, dynamic>())).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      oauthToken: map['oauthToken'] == null ? null : ((map['oauthToken'] as String).input()).input(),
      platform: map['platform'] == null ? null : ((map['platform'] as String).input()).input(),
      productionBranches: map['productionBranches'] == null ? null : ((pulumi.Input.decodeList<AppProductionBranch>(map['productionBranches']!, (value) => AppProductionBranch.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
