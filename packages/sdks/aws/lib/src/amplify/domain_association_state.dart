...
class DomainAssociationState {
  ...
  factory DomainAssociationState.fromMap(Map<String, dynamic> map) {
    return DomainAssociationState(
      ...
      certificateSettings: (() {
        final guardedValue = map['certificateSettings'];
        if (guardedValue == null) return null;
      ...
      enableAutoSubDomain: (() {
        final guardedValue = map['enableAutoSubDomain'];
        if (guardedValue == null) return null;
      ...
      subDomains: (() {
        final guardedValue = map['subDomains'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainAssociationSubDomain>(
            guardedValue,
