...
class AppMonitorState {
  ...
  /// [arn] ARN specifying the app monitor.
  ...
  factory AppMonitorState.fromMap(Map<String, dynamic> map) {
    return AppMonitorState(
      ...
      appMonitorId: (() { final guardedValue = map['appMonitorId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      cwLogGroup: (() { final guardedValue = map['cwLogGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
