...
class AppMonitorState {
    ...
    return <String, dynamic>{
      'appMonitorConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(appMonitorConfiguration, (value) => value.toMap()),
      ...
      'customEvents':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customEvents, (value) => value.toMap()),
  ...
  factory AppMonitorState.fromMap(Map<String, dynamic> map) {
    return AppMonitorState(
      appMonitorConfiguration: (() {
        final guardedValue = map['appMonitorConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppMonitorAppMonitorConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      appMonitorId: (() {
        final guardedValue = map['appMonitorId'];
        if (guardedValue == null) return null;
      ...
      customEvents: (() {
        final guardedValue = map['customEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AppMonitorCustomEvents.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      cwLogEnabled: (() {
        final guardedValue = map['cwLogEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      cwLogGroup: (() {
        final guardedValue = map['cwLogGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      domain: (() {
      ...
      domainLists: (() {
        final guardedValue = map['domainLists'];
        if (guardedValue == null) return null;
