...
class GetWorkgroupEndpointVpcEndpoint {
  ...
  factory GetWorkgroupEndpointVpcEndpoint.fromMap(Map<String, dynamic> map) {
    return GetWorkgroupEndpointVpcEndpoint(
      networkInterfaces: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWorkgroupEndpointVpcEndpointNetworkInterface>(map['networkInterfaces']!, (value) => GetWorkgroupEndpointVpcEndpointNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
