...
class WorkgroupState {
  ...
  factory WorkgroupState.fromMap(Map<String, dynamic> map) {
    return WorkgroupState(
      ...
      endpoints: map['endpoints'] == null ? null : (pulumi.Input.decodeList<WorkgroupEndpoint>(map['endpoints'], (value) => WorkgroupEndpoint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      workgroupId: map['workgroupId'] == null ? null : (map['workgroupId'] as String).input(),
