...
class ReportDefinition extends pulumi.CustomResource {
  ...
  ReportDefinition(
    ...
    this.additionalArtifacts = registerOutput<List<String>?>('additionalArtifacts');
    this.additionalSchemaElements = registerOutput<List<String>>('additionalSchemaElements');
