...
class ReportDefinitionState {
  ...
  factory ReportDefinitionState.fromMap(Map<String, dynamic> map) {
    return ReportDefinitionState(
      additionalArtifacts: (() {
        final guardedValue = map['additionalArtifacts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      additionalSchemaElements: (() {
        final guardedValue = map['additionalSchemaElements'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      arn: (() {
      ...
      refreshClosedReports: (() {
        final guardedValue = map['refreshClosedReports'];
        if (guardedValue == null) return null;
      ...
      reportVersioning: (() {
        final guardedValue = map['reportVersioning'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      s3Bucket: (() {
