...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      encryptionDetails: (() { final guardedValue = map['encryptionDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterEncryptionDetail>(guardedValue, (value) => ClusterEncryptionDetail.fromMap((value as Map).cast<String, dynamic>()))); })(),
