...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    this.encryptionDetails = registerOutput<List<ClusterEncryptionDetail>>('encryptionDetails');
    this.forceDestroy = registerOutput<bool>('forceDestroy');
    this.identifier = registerOutput<String>('identifier');
    this.kmsEncryptionKey = registerOutput<String>('kmsEncryptionKey');
    this.multiRegionProperties = registerOutput<ClusterMultiRegionProperties?>('multiRegionProperties');
