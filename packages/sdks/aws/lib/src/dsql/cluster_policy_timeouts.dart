...
class ClusterPolicyTimeouts {
  ...
  /// Creates a new [ClusterPolicyTimeouts].
  ...
  factory ClusterPolicyTimeouts.fromMap(Map<String, dynamic> map) {
    return ClusterPolicyTimeouts(
