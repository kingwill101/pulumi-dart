...
class LifecyclePolicyPolicyDetailsScheduleCreateRuleScripts {
  ...
  factory LifecyclePolicyPolicyDetailsScheduleCreateRuleScripts.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyPolicyDetailsScheduleCreateRuleScripts(
      executeOperationOnScriptFailure: map['executeOperationOnScriptFailure'] == null ? null : map['executeOperationOnScriptFailure'] as bool,
      executionHandler: map['executionHandler'] as String,
      executionHandlerService: map['executionHandlerService'] == null ? null : map['executionHandlerService'] as String,
      executionTimeout: map['executionTimeout'] == null ? null : map['executionTimeout'] as int,
      maximumRetryCount: map['maximumRetryCount'] == null ? null : map['maximumRetryCount'] as int,
