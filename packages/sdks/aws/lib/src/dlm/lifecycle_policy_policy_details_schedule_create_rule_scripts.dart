  ...
  factory LifecyclePolicyPolicyDetailsScheduleCreateRuleScripts.fromMap(
    ...
    return LifecyclePolicyPolicyDetailsScheduleCreateRuleScripts(
      executeOperationOnScriptFailure: (() {
        final guardedValue = map['executeOperationOnScriptFailure'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      executionHandler: pulumi.Input.fromValue(
        map['executionHandler'] as String,
      ),
      executionHandlerService: (() {
        final guardedValue = map['executionHandlerService'];
        if (guardedValue == null) return null;
      ...
      maximumRetryCount: (() {
        final guardedValue = map['maximumRetryCount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      stages: (() {
