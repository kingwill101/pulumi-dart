...
class LifecyclePolicyPolicyDetails {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schedules':
          ?pulumi.Input.mapOptionalInputValue<
            List<LifecyclePolicyPolicyDetailsSchedule>,
  ...
  factory LifecyclePolicyPolicyDetails.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyPolicyDetails(
      ...
      createInterval: (() {
        final guardedValue = map['createInterval'];
        if (guardedValue == null) return null;
      ...
      extendDeletion: (() {
        final guardedValue = map['extendDeletion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      parameters: (() {
      ...
      policyLanguage: (() {
        final guardedValue = map['policyLanguage'];
        if (guardedValue == null) return null;
      ...
      resourceLocations: (() {
        final guardedValue = map['resourceLocations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceType: (() {
      ...
      retainInterval: (() {
        final guardedValue = map['retainInterval'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      schedules: (() {
