...
class LifecyclePolicyPolicyDetailsSchedule {
  ...
  final pulumi.Input<LifecyclePolicyPolicyDetailsScheduleArchiveRule>?
  archiveRule;
  ...
  final pulumi.Input<
    List<LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRule>
  >?
  crossRegionCopyRules;
  final pulumi.Input<LifecyclePolicyPolicyDetailsScheduleDeprecateRule>?
  deprecateRule;

  /// See the `fast_restore_rule` block. Max of 1 per schedule.
  final pulumi.Input<LifecyclePolicyPolicyDetailsScheduleFastRestoreRule>?
  fastRestoreRule;
    ...
    return <String, dynamic>{
      'archiveRule':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(archiveRule, (value) => value.toMap()),
      'copyTags': ?copyTags,
      'createRule':
          pulumi.Input.mapInputValue<
            LifecyclePolicyPolicyDetailsScheduleCreateRule,
            Map<String, dynamic>
          >(createRule, (value) => value.toMap()),
      'crossRegionCopyRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRule>,
      ...
      'fastRestoreRule':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(fastRestoreRule, (value) => value.toMap()),
      'name': name,
      'retainRule':
          pulumi.Input.mapInputValue<
  ...
  factory LifecyclePolicyPolicyDetailsSchedule.fromMap(
    ...
    return LifecyclePolicyPolicyDetailsSchedule(
      archiveRule: (() {
        final guardedValue = map['archiveRule'];
      ...
      createRule: pulumi.Input.fromValue(
        LifecyclePolicyPolicyDetailsScheduleCreateRule.fromMap(
          (map['createRule']! as Map).cast<String, dynamic>(),
        ),
      ),
      crossRegionCopyRules: (() {
        final guardedValue = map['crossRegionCopyRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fastRestoreRule: (() {
        final guardedValue = map['fastRestoreRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      retainRule: pulumi.Input.fromValue(
        LifecyclePolicyPolicyDetailsScheduleRetainRule.fromMap(
          (map['retainRule']! as Map).cast<String, dynamic>(),
        ),
      ),
      shareRule: (() {
        final guardedValue = map['shareRule'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      tagsToAdd: (() {
        final guardedValue = map['tagsToAdd'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      variableTags: (() {
        final guardedValue = map['variableTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
