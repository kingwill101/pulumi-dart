...
class AssessmentScope {
  ...
  factory AssessmentScope.fromMap(Map<String, dynamic> map) {
    return AssessmentScope(
      awsAccounts: (() { final guardedValue = map['awsAccounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AssessmentScopeAwsAccount>(guardedValue, (value) => AssessmentScopeAwsAccount.fromMap((value as Map).cast<String, dynamic>()))); })(),
      awsServices: (() { final guardedValue = map['awsServices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AssessmentScopeAwsService>(guardedValue, (value) => AssessmentScopeAwsService.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
