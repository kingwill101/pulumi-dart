...
class ControlControlMappingSource {
  ...
  factory ControlControlMappingSource.fromMap(Map<String, dynamic> map) {
    return ControlControlMappingSource(
      sourceDescription: (() { final guardedValue = map['sourceDescription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sourceFrequency: (() { final guardedValue = map['sourceFrequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      sourceKeyword: (() { final guardedValue = map['sourceKeyword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ControlControlMappingSourceSourceKeyword.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      troubleshootingText: (() { final guardedValue = map['troubleshootingText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
