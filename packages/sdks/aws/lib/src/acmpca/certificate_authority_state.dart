...
class CertificateAuthorityState {
  ...
  factory CertificateAuthorityState.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityState(
      ...
      certificateAuthorityConfiguration: (() {
        final guardedValue = map['certificateAuthorityConfiguration'];
        if (guardedValue == null) return null;
      ...
      keyStorageSecurityStandard: (() {
        final guardedValue = map['keyStorageSecurityStandard'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      notAfter: (() {
      ...
      permanentDeletionTimeInDays: (() {
        final guardedValue = map['permanentDeletionTimeInDays'];
        if (guardedValue == null) return null;
      ...
      revocationConfiguration: (() {
        final guardedValue = map['revocationConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      usageMode: (() {
        final guardedValue = map['usageMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
