...
class CertificateAuthorityState {
  ...
  factory CertificateAuthorityState.fromMap(Map<String, dynamic> map) {
    return CertificateAuthorityState(
      ...
      certificateAuthorityConfiguration: map['certificateAuthorityConfiguration'] == null ? null : ((CertificateAuthorityCertificateAuthorityConfiguration.fromMap((map['certificateAuthorityConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      serial: map['serial'] == null ? null : ((map['serial'] as String).input()).input(),
