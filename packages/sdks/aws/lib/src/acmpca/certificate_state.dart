...
class CertificateState {
  ...
  factory CertificateState.fromMap(Map<String, dynamic> map) {
    return CertificateState(
      ...
      validity: (() { final guardedValue = map['validity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CertificateValidity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
