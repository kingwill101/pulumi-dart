...
class CertificateAuthorityRevocationConfiguration {
    ...
    return <String, dynamic>{
      'crlConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            CertificateAuthorityRevocationConfigurationCrlConfiguration,
            Map<String, dynamic>
          >(crlConfiguration, (value) => value.toMap()),
      'ocspConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            CertificateAuthorityRevocationConfigurationOcspConfiguration,
            Map<String, dynamic>
          >(ocspConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory CertificateAuthorityRevocationConfiguration.fromMap(
    ...
    return CertificateAuthorityRevocationConfiguration(
      crlConfiguration: (() {
        final guardedValue = map['crlConfiguration'];
      ...
      ocspConfiguration: (() {
        final guardedValue = map['ocspConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CertificateAuthorityRevocationConfigurationOcspConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
