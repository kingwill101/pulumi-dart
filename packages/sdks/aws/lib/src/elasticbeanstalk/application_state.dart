...
class ApplicationState {
  ...
  factory ApplicationState.fromMap(Map<String, dynamic> map) {
    return ApplicationState(
      appversionLifecycle: map['appversionLifecycle'] == null ? null : ((ApplicationAppversionLifecycle.fromMap((map['appversionLifecycle']! as Map).cast<String, dynamic>())).input()).input(),
