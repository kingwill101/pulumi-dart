...
class EnvironmentState {
  ...
  factory EnvironmentState.fromMap(Map<String, dynamic> map) {
    return EnvironmentState(
      allSettings: map['allSettings'] == null ? null : ((pulumi.Input.decodeList<EnvironmentAllSetting>(map['allSettings']!, (value) => EnvironmentAllSetting.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      cname: map['cname'] == null ? null : ((map['cname'] as String).input()).input(),
      ...
      launchConfigurations: map['launchConfigurations'] == null ? null : (((map['launchConfigurations'] as List).cast<String>()).input()).input(),
      ...
      queues: map['queues'] == null ? null : (((map['queues'] as List).cast<String>()).input()).input(),
