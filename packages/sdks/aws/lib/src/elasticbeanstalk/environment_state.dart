    ...
    return EnvironmentState(
      allSettings: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentAllSetting>(
            guardedValue,
            (value) => EnvironmentAllSetting.fromMap(
      ...
      launchConfigurations: (() {
        final guardedValue = map['launchConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      loadBalancers: (() {
      ...
      waitForReadyTimeout: (() {
        final guardedValue = map['waitForReadyTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
