...
class SelectionCondition {
    ...
    return <String, dynamic>{
      'stringEquals':
          ?pulumi.Input.mapOptionalInputValue<
            List<SelectionConditionStringEqual>,
      ...
      'stringLikes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SelectionConditionStringLike>,
            List<Map<String, dynamic>>
          >(
            stringLikes,
            (value) =>
      ...
      'stringNotEquals':
          ?pulumi.Input.mapOptionalInputValue<
            List<SelectionConditionStringNotEqual>,
            List<Map<String, dynamic>>
          >(
            stringNotEquals,
            (value) =>
      ...
      'stringNotLikes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SelectionConditionStringNotLike>,
            List<Map<String, dynamic>>
          >(
            stringNotLikes,
            (value) =>
  ...
  factory SelectionCondition.fromMap(Map<String, dynamic> map) {
    return SelectionCondition(
      stringEquals: (() {
        final guardedValue = map['stringEquals'];
      ...
      stringLikes: (() {
        final guardedValue = map['stringLikes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      stringNotEquals: (() {
        final guardedValue = map['stringNotEquals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      stringNotLikes: (() {
        final guardedValue = map['stringNotLikes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
