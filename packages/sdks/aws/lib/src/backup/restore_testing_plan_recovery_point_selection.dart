...
class RestoreTestingPlanRecoveryPointSelection {
  ...
  factory RestoreTestingPlanRecoveryPointSelection.fromMap(
    ...
    return RestoreTestingPlanRecoveryPointSelection(
      ...
      excludeVaults: (() {
        final guardedValue = map['excludeVaults'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      includeVaults: pulumi.Input.fromValue(
        (map['includeVaults'] as List).cast<String>(),
      ),
      recoveryPointTypes: pulumi.Input.fromValue(
        (map['recoveryPointTypes'] as List).cast<String>(),
      ),
      selectionWindowDays: (() {
        final guardedValue = map['selectionWindowDays'];
        if (guardedValue == null) return null;
