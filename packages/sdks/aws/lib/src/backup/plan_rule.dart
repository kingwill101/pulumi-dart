...
class PlanRule {
  ...
  factory PlanRule.fromMap(Map<String, dynamic> map) {
    return PlanRule(
      completionWindow: (() {
        final guardedValue = map['completionWindow'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      copyActions: (() {
        final guardedValue = map['copyActions'];
        if (guardedValue == null) return null;
      ...
      enableContinuousBackup: (() {
        final guardedValue = map['enableContinuousBackup'];
        if (guardedValue == null) return null;
      ...
      scanActions: (() {
        final guardedValue = map['scanActions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      startWindow: (() {
        final guardedValue = map['startWindow'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      targetLogicallyAirGappedBackupVaultArn: (() {
        final guardedValue = map['targetLogicallyAirGappedBackupVaultArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
