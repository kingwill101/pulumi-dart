...
class RegionSettingsArgs {
  ...
  RegionSettingsArgs({
    ...
    required pulumi.Output<Map<String, bool>> resourceTypeOptInPreference,
  }) :
      region = pulumi.Input.asOptionalInput<String>(region),
      resourceTypeManagementPreference = pulumi.Input.asOptionalInput<Map<String, bool>>(resourceTypeManagementPreference),
      resourceTypeOptInPreference = pulumi.Input.asInput<Map<String, bool>>(resourceTypeOptInPreference);
  ...
  factory RegionSettingsArgs.fromMap(Map<String, dynamic> map) {
    return RegionSettingsArgs(
      ...
      resourceTypeOptInPreference: pulumi.Output.create<Map<String, bool>>((map['resourceTypeOptInPreference'] as Map).cast<String, bool>()),
    );
  }
}
