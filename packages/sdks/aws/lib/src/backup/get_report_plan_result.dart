...
class GetReportPlanResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'region': region,
      'reportDeliveryChannels': pulumi.Input.encodeList<GetReportPlanReportDeliveryChannel, Map<String, dynamic>>(reportDeliveryChannels, (value) => value.toMap()),
      'reportSettings': pulumi.Input.encodeList<GetReportPlanReportSetting, Map<String, dynamic>>(reportSettings, (value) => value.toMap()),
      'tags': tags,
    };
  }
