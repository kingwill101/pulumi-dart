...
class ReportPlan extends pulumi.CustomResource {
  ...
  ReportPlan(
    ...
    this.reportDeliveryChannel = registerOutput<ReportPlanReportDeliveryChannel>('reportDeliveryChannel');
    this.reportSetting = registerOutput<ReportPlanReportSetting>('reportSetting');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
  }

  /// Gets an existing [ReportPlan] resource's state with the given [name] and [id].
  static ReportPlan get(
    String name,
