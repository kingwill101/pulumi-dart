...
class FrameworkState {
  ...
  factory FrameworkState.fromMap(Map<String, dynamic> map) {
    return FrameworkState(
      ...
      controls: (() { final guardedValue = map['controls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FrameworkControl>(guardedValue, (value) => FrameworkControl.fromMap((value as Map).cast<String, dynamic>()))); })(),
