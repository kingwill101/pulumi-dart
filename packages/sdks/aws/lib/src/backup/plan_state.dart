...
class PlanState {
  ...
  factory PlanState.fromMap(Map<String, dynamic> map) {
    return PlanState(
      advancedBackupSettings: (() {
        final guardedValue = map['advancedBackupSettings'];
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PlanRule>(
            guardedValue,
      ...
      scanSettings: (() {
        final guardedValue = map['scanSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PlanScanSetting>(
            guardedValue,
            (value) =>
                PlanScanSetting.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
