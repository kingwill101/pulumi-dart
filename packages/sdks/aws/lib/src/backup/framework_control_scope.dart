...
class FrameworkControlScope {
  ...
  factory FrameworkControlScope.fromMap(Map<String, dynamic> map) {
    return FrameworkControlScope(
      complianceResourceIds: (() { final guardedValue = map['complianceResourceIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      complianceResourceTypes: (() { final guardedValue = map['complianceResourceTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
