...
class SigningProfile extends pulumi.CustomResource {
  ...
  SigningProfile(
    ...
    this.revocationRecords = registerOutput<List<SigningProfileRevocationRecord>>('revocationRecords');
    this.signatureValidityPeriod = registerOutput<SigningProfileSignatureValidityPeriod>('signatureValidityPeriod');
    this.signingMaterial = registerOutput<SigningProfileSigningMaterial>('signingMaterial');
    this.signingParameters = registerOutput<Map<String, String>?>('signingParameters');
