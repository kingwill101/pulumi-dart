...
class SigningProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<SigningProfileRevocationRecord>> revocationRecords;
  ...
  SigningProfile(
    ...
    revocationRecords = registerOutput<List<SigningProfileRevocationRecord>>('revocationRecords', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<SigningProfileRevocationRecord>(guardedValue, (value) => SigningProfileRevocationRecord.fromMap((value as Map).cast<String, dynamic>())); });
    ...
    signingParameters = registerOutput<Map<String, String>?>('signingParameters', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as Map).cast<String, String>(); });
  ...
  /// Creates a typed reference to an existing [SigningProfile] resource.
  SigningProfile.reference(String urn)
    : super(
        'aws:signer/signingProfile:SigningProfile',
