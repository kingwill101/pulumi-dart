...
class SigningJobArgs {
  ...
  factory SigningJobArgs.fromMap(Map<String, dynamic> map) {
    return SigningJobArgs(
      destination: pulumi.Input.fromValue(SigningJobDestination.fromMap((map['destination']! as Map).cast<String, dynamic>())),
      ...
      source: pulumi.Input.fromValue(SigningJobSource.fromMap((map['source']! as Map).cast<String, dynamic>())),
    );
  }
}
