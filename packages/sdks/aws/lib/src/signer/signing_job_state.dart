...
class SigningJobState {
  ...
  factory SigningJobState.fromMap(Map<String, dynamic> map) {
    return SigningJobState(
      ...
      destination: map['destination'] == null ? null : (SigningJobDestination.fromMap((map['destination'] as Map).cast<String, dynamic>())).input(),
      ...
      jobInvoker: map['jobInvoker'] == null ? null : (map['jobInvoker'] as String).input(),
      jobOwner: map['jobOwner'] == null ? null : (map['jobOwner'] as String).input(),
      ...
      requestedBy: map['requestedBy'] == null ? null : (map['requestedBy'] as String).input(),
      revocationRecords: map['revocationRecords'] == null ? null : (pulumi.Input.decodeList<SigningJobRevocationRecord>(map['revocationRecords'], (value) => SigningJobRevocationRecord.fromMap((value as Map).cast<String, dynamic>()))).input(),
      signatureExpiresAt: map['signatureExpiresAt'] == null ? null : (map['signatureExpiresAt'] as String).input(),
      signedObjects: map['signedObjects'] == null ? null : (pulumi.Input.decodeList<SigningJobSignedObject>(map['signedObjects'], (value) => SigningJobSignedObject.fromMap((value as Map).cast<String, dynamic>()))).input(),
      source: map['source'] == null ? null : (SigningJobSource.fromMap((map['source'] as Map).cast<String, dynamic>())).input(),
