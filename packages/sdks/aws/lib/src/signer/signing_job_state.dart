...
class SigningJobState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'revocationRecords':
          ?pulumi.Input.mapOptionalInputValue<
            List<SigningJobRevocationRecord>,
  ...
  factory SigningJobState.fromMap(Map<String, dynamic> map) {
    return SigningJobState(
      ...
      jobInvoker: (() {
        final guardedValue = map['jobInvoker'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jobOwner: (() {
        final guardedValue = map['jobOwner'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      platformDisplayName: (() {
        final guardedValue = map['platformDisplayName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      platformId: (() {
        final guardedValue = map['platformId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      profileName: (() {
      ...
      requestedBy: (() {
        final guardedValue = map['requestedBy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      revocationRecords: (() {
        final guardedValue = map['revocationRecords'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SigningJobRevocationRecord>(
            guardedValue,
            (value) => SigningJobRevocationRecord.fromMap(
      ...
      signatureExpiresAt: (() {
        final guardedValue = map['signatureExpiresAt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signedObjects: (() {
        final guardedValue = map['signedObjects'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SigningJobSignedObject>(
            guardedValue,
            (value) => SigningJobSignedObject.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
