...
class GetSigningJobSource {
  ...
  factory GetSigningJobSource.fromMap(Map<String, dynamic> map) {
    return GetSigningJobSource(
      s3s: pulumi.Input.fromValue(pulumi.Input.decodeList<GetSigningJobSourceS3>(map['s3s']!, (value) => GetSigningJobSourceS3.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
