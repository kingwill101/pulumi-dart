...
class GetSigningJobResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'revocationRecords': pulumi.Input.encodeList<GetSigningJobRevocationRecord, Map<String, dynamic>>(revocationRecords, (value) => value.toMap()),
      'signatureExpiresAt': signatureExpiresAt,
      'signedObjects': pulumi.Input.encodeList<GetSigningJobSignedObject, Map<String, dynamic>>(signedObjects, (value) => value.toMap()),
      'sources': pulumi.Input.encodeList<GetSigningJobSource, Map<String, dynamic>>(sources, (value) => value.toMap()),
      'status': status,
