...
class LaunchScheduledSplitsConfigStep {
  ...
  final pulumi.Input<List<LaunchScheduledSplitsConfigStepSegmentOverride>>?
  segmentOverrides;
    ...
    return <String, dynamic>{
      ...
      'segmentOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<LaunchScheduledSplitsConfigStepSegmentOverride>,
  ...
  factory LaunchScheduledSplitsConfigStep.fromMap(Map<String, dynamic> map) {
    return LaunchScheduledSplitsConfigStep(
      groupWeights: pulumi.Input.fromValue(
        (map['groupWeights'] as Map).cast<String, int>(),
      ),
      segmentOverrides: (() {
        final guardedValue = map['segmentOverrides'];
