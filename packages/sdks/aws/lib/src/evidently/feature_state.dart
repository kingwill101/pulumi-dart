...
class FeatureState {
  ...
  factory FeatureState.fromMap(Map<String, dynamic> map) {
    return FeatureState(
      ...
      defaultVariation: (() {
        final guardedValue = map['defaultVariation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      entityOverrides: (() {
        final guardedValue = map['entityOverrides'];
        if (guardedValue == null) return null;
      ...
      evaluationRules: (() {
        final guardedValue = map['evaluationRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FeatureEvaluationRule>(
            guardedValue,
            (value) => FeatureEvaluationRule.fromMap(
      ...
      evaluationStrategy: (() {
        final guardedValue = map['evaluationStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastUpdatedTime: (() {
      ...
      variations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FeatureVariation>(
            guardedValue,
            (value) => FeatureVariation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
