...
class LaunchState {
  ...
  factory LaunchState.fromMap(Map<String, dynamic> map) {
    return LaunchState(
      ...
      executions: (() { final guardedValue = map['executions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LaunchExecution>(guardedValue, (value) => LaunchExecution.fromMap((value as Map).cast<String, dynamic>()))); })(),
      groups: (() { final guardedValue = map['groups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LaunchGroup>(guardedValue, (value) => LaunchGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
