...
class LaunchState {
  ...
  factory LaunchState.fromMap(Map<String, dynamic> map) {
    return LaunchState(
      ...
      executions: map['executions'] == null ? null : (pulumi.Input.decodeList<LaunchExecution>(map['executions'], (value) => LaunchExecution.fromMap((value as Map).cast<String, dynamic>()))).input(),
      groups: map['groups'] == null ? null : (pulumi.Input.decodeList<LaunchGroup>(map['groups'], (value) => LaunchGroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
