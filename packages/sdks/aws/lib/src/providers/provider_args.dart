...
class ProviderArgs {
  ...
  final pulumi.Input<ProviderAssumeRoleWithWebIdentity>?
    ...
    return <String, dynamic>{
      ...
      'assumeRoleWithWebIdentity':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(assumeRoleWithWebIdentity, (value) => value.toMap()),
      'assumeRoles':
          ?pulumi.Input.mapOptionalInputValue<
            List<ProviderAssumeRole>,
  ...
  factory ProviderArgs.fromMap(Map<String, dynamic> map) {
    return ProviderArgs(
      ...
      allowedAccountIds: (() {
        final guardedValue = map['allowedAccountIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      assumeRoleWithWebIdentity: (() {
        final guardedValue = map['assumeRoleWithWebIdentity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProviderAssumeRoleWithWebIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      assumeRoles: (() {
        final guardedValue = map['assumeRoles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProviderAssumeRole>(
            guardedValue,
            (value) => ProviderAssumeRole.fromMap(
      ...
      customCaBundle: (() {
        final guardedValue = map['customCaBundle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      defaultTags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProviderDefaultTags.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ec2MetadataServiceEndpoint: (() {
        final guardedValue = map['ec2MetadataServiceEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ec2MetadataServiceEndpointMode: (() {
        final guardedValue = map['ec2MetadataServiceEndpointMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      endpoints: (() {
      ...
      forbiddenAccountIds: (() {
        final guardedValue = map['forbiddenAccountIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      httpProxy: (() {
      ...
      ignoreTags: (() {
        final guardedValue = map['ignoreTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ProviderIgnoreTags.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      s3UsEast1RegionalEndpoint: (() {
        final guardedValue = map['s3UsEast1RegionalEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      s3UsePathStyle: (() {
        final guardedValue = map['s3UsePathStyle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      secretKey: (() {
      ...
      sharedConfigFiles: (() {
        final guardedValue = map['sharedConfigFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      sharedCredentialsFiles: (() {
        final guardedValue = map['sharedCredentialsFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      skipCredentialsValidation: (() {
        final guardedValue = map['skipCredentialsValidation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      skipMetadataApiCheck: (() {
        final guardedValue = map['skipMetadataApiCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      skipRequestingAccountId: (() {
        final guardedValue = map['skipRequestingAccountId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      stsRegion: (() {
        final guardedValue = map['stsRegion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tagPolicyCompliance: (() {
        final guardedValue = map['tagPolicyCompliance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      token: (() {
      ...
      tokenBucketRateLimiterCapacity: (() {
        final guardedValue = map['tokenBucketRateLimiterCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      useDualstackEndpoint: (() {
        final guardedValue = map['useDualstackEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      useFipsEndpoint: (() {
        final guardedValue = map['useFipsEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      userAgents: (() {
