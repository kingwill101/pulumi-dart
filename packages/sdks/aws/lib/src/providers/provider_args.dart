...
class ProviderArgs {
  ...
  factory ProviderArgs.fromMap(Map<String, dynamic> map) {
    return ProviderArgs(
      ...
      allowedAccountIds: map['allowedAccountIds'] == null ? null : ((map['allowedAccountIds'] as List).cast<String>()).input(),
      assumeRoleWithWebIdentity: map['assumeRoleWithWebIdentity'] == null ? null : (ProviderAssumeRoleWithWebIdentity.fromMap((map['assumeRoleWithWebIdentity'] as Map).cast<String, dynamic>())).input(),
      assumeRoles: map['assumeRoles'] == null ? null : (pulumi.Input.decodeList<ProviderAssumeRole>(map['assumeRoles'], (value) => ProviderAssumeRole.fromMap((value as Map).cast<String, dynamic>()))).input(),
      customCaBundle: map['customCaBundle'] == null ? null : (map['customCaBundle'] as String).input(),
      defaultTags: map['defaultTags'] == null ? null : (ProviderDefaultTags.fromMap((map['defaultTags'] as Map).cast<String, dynamic>())).input(),
      ec2MetadataServiceEndpoint: map['ec2MetadataServiceEndpoint'] == null ? null : (map['ec2MetadataServiceEndpoint'] as String).input(),
      ec2MetadataServiceEndpointMode: map['ec2MetadataServiceEndpointMode'] == null ? null : (map['ec2MetadataServiceEndpointMode'] as String).input(),
      ...
      forbiddenAccountIds: map['forbiddenAccountIds'] == null ? null : ((map['forbiddenAccountIds'] as List).cast<String>()).input(),
      ...
      ignoreTags: map['ignoreTags'] == null ? null : (ProviderIgnoreTags.fromMap((map['ignoreTags'] as Map).cast<String, dynamic>())).input(),
      ...
      s3UsEast1RegionalEndpoint: map['s3UsEast1RegionalEndpoint'] == null ? null : (map['s3UsEast1RegionalEndpoint'] as String).input(),
      s3UsePathStyle: map['s3UsePathStyle'] == null ? null : (map['s3UsePathStyle'] as bool).input(),
      secretKey: map['secretKey'] == null ? null : (map['secretKey'] as String).input(),
      sharedConfigFiles: map['sharedConfigFiles'] == null ? null : ((map['sharedConfigFiles'] as List).cast<String>()).input(),
      sharedCredentialsFiles: map['sharedCredentialsFiles'] == null ? null : ((map['sharedCredentialsFiles'] as List).cast<String>()).input(),
      skipCredentialsValidation: map['skipCredentialsValidation'] == null ? null : (map['skipCredentialsValidation'] as bool).input(),
      skipMetadataApiCheck: map['skipMetadataApiCheck'] == null ? null : (map['skipMetadataApiCheck'] as bool).input(),
      skipRegionValidation: map['skipRegionValidation'] == null ? null : (map['skipRegionValidation'] as bool).input(),
      skipRequestingAccountId: map['skipRequestingAccountId'] == null ? null : (map['skipRequestingAccountId'] as bool).input(),
      stsRegion: map['stsRegion'] == null ? null : (map['stsRegion'] as String).input(),
      tagPolicyCompliance: map['tagPolicyCompliance'] == null ? null : (map['tagPolicyCompliance'] as String).input(),
      token: map['token'] == null ? null : (map['token'] as String).input(),
      tokenBucketRateLimiterCapacity: map['tokenBucketRateLimiterCapacity'] == null ? null : (map['tokenBucketRateLimiterCapacity'] as int).input(),
      useDualstackEndpoint: map['useDualstackEndpoint'] == null ? null : (map['useDualstackEndpoint'] as bool).input(),
      useFipsEndpoint: map['useFipsEndpoint'] == null ? null : (map['useFipsEndpoint'] as bool).input(),
