...
class ZonalAutoshiftConfigurationState {
  ...
  const ZonalAutoshiftConfigurationState({
    this.allowedWindows,
    this.blockedDates,
    this.blockedWindows,
    this.blockingAlarms,
  ...
  factory ZonalAutoshiftConfigurationState.fromMap(Map<String, dynamic> map) {
    return ZonalAutoshiftConfigurationState(
      ...
      zonalAutoshiftStatus: (() { final guardedValue = map['zonalAutoshiftStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
