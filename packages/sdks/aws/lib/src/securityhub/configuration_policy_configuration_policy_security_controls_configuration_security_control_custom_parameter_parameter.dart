    ...
    return <String, dynamic>{
      'bool':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterBool,
            Map<String, dynamic>
          >(bool_, (value) => value.toMap()),
      'double':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterDouble,
            Map<String, dynamic>
          >(double_, (value) => value.toMap()),
      'enum':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterEnum,
            Map<String, dynamic>
          >(enum_, (value) => value.toMap()),
      'enumList':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterEnumList,
            Map<String, dynamic>
          >(enumList, (value) => value.toMap()),
      'int':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterInt,
            Map<String, dynamic>
          >(int_, (value) => value.toMap()),
      'intList':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterIntList,
            Map<String, dynamic>
          >(intList, (value) => value.toMap()),
      'name': name,
      'string':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterString,
            Map<String, dynamic>
          >(string_, (value) => value.toMap()),
      'stringList':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterStringList,
            Map<String, dynamic>
          >(stringList, (value) => value.toMap()),
      'valueType': valueType,
    };
  }
    ...
    return ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameter(
      bool_: (() {
        ...
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterBool.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      double_: (() {
        final guardedValue = map['double'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterDouble.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      enum_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterEnum.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      enumList: (() {
        final guardedValue = map['enumList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterEnumList.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      int_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterInt.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      intList: (() {
        final guardedValue = map['intList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterIntList.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      string_: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterString.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      stringList: (() {
        final guardedValue = map['stringList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameterStringList.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
