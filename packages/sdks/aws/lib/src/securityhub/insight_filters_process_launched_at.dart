...
import 'insight_filters_process_launched_at_date_range.dart';

class InsightFiltersProcessLaunchedAt {
  /// A configuration block of the date range for the date filter. See dateRange below for more details.
  final pulumi.Input<InsightFiltersProcessLaunchedAtDateRange?>? dateRange;
  ...
  /// Creates a new [InsightFiltersProcessLaunchedAt].
  ...
  const InsightFiltersProcessLaunchedAt({
    this.dateRange,
    this.end,
    this.start,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dateRange': ?pulumi.Input.mapOptionalInputValue<InsightFiltersProcessLaunchedAtDateRange, Map<String, dynamic>>(dateRange, (value) => value.toMap()),
      'end': ?end,
      'start': ?start,
    };
  }
  ...
  factory InsightFiltersProcessLaunchedAt.fromMap(Map<String, dynamic> map) {
    return InsightFiltersProcessLaunchedAt(
      dateRange: (() { final guardedValue = map['dateRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InsightFiltersProcessLaunchedAtDateRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
