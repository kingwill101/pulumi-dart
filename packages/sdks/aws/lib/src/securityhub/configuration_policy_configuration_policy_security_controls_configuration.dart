  ...
  factory ConfigurationPolicyConfigurationPolicySecurityControlsConfiguration.fromMap(
    ...
    return ConfigurationPolicyConfigurationPolicySecurityControlsConfiguration(
      disabledControlIdentifiers: (() {
        final guardedValue = map['disabledControlIdentifiers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      enabledControlIdentifiers: (() {
        final guardedValue = map['enabledControlIdentifiers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      securityControlCustomParameters: (() {
        final guardedValue = map['securityControlCustomParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameter.fromMap(
