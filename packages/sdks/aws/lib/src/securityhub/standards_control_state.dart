  ...
  factory StandardsControlState.fromMap(Map<String, dynamic> map) {
    return StandardsControlState(
      ...
      controlStatusUpdatedAt: (() {
        final guardedValue = map['controlStatusUpdatedAt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      relatedRequirements: (() {
        final guardedValue = map['relatedRequirements'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      remediationUrl: (() {
        final guardedValue = map['remediationUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      severityRating: (() {
        final guardedValue = map['severityRating'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      standardsControlArn: (() {
        final guardedValue = map['standardsControlArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      title: (() {
