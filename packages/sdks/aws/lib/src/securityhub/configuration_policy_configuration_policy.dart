...
class ConfigurationPolicyConfigurationPolicy {
  ...
  factory ConfigurationPolicyConfigurationPolicy.fromMap(Map<String, dynamic> map) {
    return ConfigurationPolicyConfigurationPolicy(
      enabledStandardArns: (() { final guardedValue = map['enabledStandardArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      securityControlsConfiguration: (() { final guardedValue = map['securityControlsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigurationPolicyConfigurationPolicySecurityControlsConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
