...
class AutomationRuleV2ActionFindingFieldsUpdate {
  ...
  factory AutomationRuleV2ActionFindingFieldsUpdate.fromMap(Map<String, dynamic> map) {
    return AutomationRuleV2ActionFindingFieldsUpdate(
      ...
      severityId: (() { final guardedValue = map['severityId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      statusId: (() { final guardedValue = map['statusId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
