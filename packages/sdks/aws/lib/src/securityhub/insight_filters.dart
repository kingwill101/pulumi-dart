...
class InsightFilters {
  ...
  factory InsightFilters.fromMap(Map<String, dynamic> map) {
    return InsightFilters(
      awsAccountIds: map['awsAccountIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersAwsAccountId>(map['awsAccountIds']!, (value) => InsightFiltersAwsAccountId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      companyNames: map['companyNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersCompanyName>(map['companyNames']!, (value) => InsightFiltersCompanyName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      complianceStatuses: map['complianceStatuses'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersComplianceStatus>(map['complianceStatuses']!, (value) => InsightFiltersComplianceStatus.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      confidences: map['confidences'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersConfidence>(map['confidences']!, (value) => InsightFiltersConfidence.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      createdAts: map['createdAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersCreatedAt>(map['createdAts']!, (value) => InsightFiltersCreatedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      criticalities: map['criticalities'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersCriticality>(map['criticalities']!, (value) => InsightFiltersCriticality.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      descriptions: map['descriptions'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersDescription>(map['descriptions']!, (value) => InsightFiltersDescription.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      findingProviderFieldsConfidences: map['findingProviderFieldsConfidences'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsConfidence>(map['findingProviderFieldsConfidences']!, (value) => InsightFiltersFindingProviderFieldsConfidence.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      findingProviderFieldsCriticalities: map['findingProviderFieldsCriticalities'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsCriticality>(map['findingProviderFieldsCriticalities']!, (value) => InsightFiltersFindingProviderFieldsCriticality.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      findingProviderFieldsRelatedFindingsProductArns: map['findingProviderFieldsRelatedFindingsProductArns'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsRelatedFindingsProductArn>(map['findingProviderFieldsRelatedFindingsProductArns']!, (value) => InsightFiltersFindingProviderFieldsRelatedFindingsProductArn.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      findingProviderFieldsSeverityLabels: map['findingProviderFieldsSeverityLabels'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsSeverityLabel>(map['findingProviderFieldsSeverityLabels']!, (value) => InsightFiltersFindingProviderFieldsSeverityLabel.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      findingProviderFieldsTypes: map['findingProviderFieldsTypes'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsType>(map['findingProviderFieldsTypes']!, (value) => InsightFiltersFindingProviderFieldsType.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      firstObservedAts: map['firstObservedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersFirstObservedAt>(map['firstObservedAts']!, (value) => InsightFiltersFirstObservedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      generatorIds: map['generatorIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersGeneratorId>(map['generatorIds']!, (value) => InsightFiltersGeneratorId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ids: map['ids'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersId>(map['ids']!, (value) => InsightFiltersId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      keywords: map['keywords'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersKeyword>(map['keywords']!, (value) => InsightFiltersKeyword.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      lastObservedAts: map['lastObservedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersLastObservedAt>(map['lastObservedAts']!, (value) => InsightFiltersLastObservedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      malwareNames: map['malwareNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersMalwareName>(map['malwareNames']!, (value) => InsightFiltersMalwareName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      malwarePaths: map['malwarePaths'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersMalwarePath>(map['malwarePaths']!, (value) => InsightFiltersMalwarePath.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      malwareStates: map['malwareStates'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersMalwareState>(map['malwareStates']!, (value) => InsightFiltersMalwareState.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      malwareTypes: map['malwareTypes'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersMalwareType>(map['malwareTypes']!, (value) => InsightFiltersMalwareType.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkDestinationDomains: map['networkDestinationDomains'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkDestinationDomain>(map['networkDestinationDomains']!, (value) => InsightFiltersNetworkDestinationDomain.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkDestinationIpv4s: map['networkDestinationIpv4s'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkDestinationIpv4>(map['networkDestinationIpv4s']!, (value) => InsightFiltersNetworkDestinationIpv4.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkDestinationIpv6s: map['networkDestinationIpv6s'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkDestinationIpv6>(map['networkDestinationIpv6s']!, (value) => InsightFiltersNetworkDestinationIpv6.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkDestinationPorts: map['networkDestinationPorts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkDestinationPort>(map['networkDestinationPorts']!, (value) => InsightFiltersNetworkDestinationPort.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkDirections: map['networkDirections'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkDirection>(map['networkDirections']!, (value) => InsightFiltersNetworkDirection.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkProtocols: map['networkProtocols'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkProtocol>(map['networkProtocols']!, (value) => InsightFiltersNetworkProtocol.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkSourceDomains: map['networkSourceDomains'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkSourceDomain>(map['networkSourceDomains']!, (value) => InsightFiltersNetworkSourceDomain.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkSourceIpv4s: map['networkSourceIpv4s'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkSourceIpv4>(map['networkSourceIpv4s']!, (value) => InsightFiltersNetworkSourceIpv4.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkSourceIpv6s: map['networkSourceIpv6s'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkSourceIpv6>(map['networkSourceIpv6s']!, (value) => InsightFiltersNetworkSourceIpv6.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkSourceMacs: map['networkSourceMacs'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkSourceMac>(map['networkSourceMacs']!, (value) => InsightFiltersNetworkSourceMac.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkSourcePorts: map['networkSourcePorts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNetworkSourcePort>(map['networkSourcePorts']!, (value) => InsightFiltersNetworkSourcePort.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      noteTexts: map['noteTexts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNoteText>(map['noteTexts']!, (value) => InsightFiltersNoteText.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      noteUpdatedAts: map['noteUpdatedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNoteUpdatedAt>(map['noteUpdatedAts']!, (value) => InsightFiltersNoteUpdatedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      noteUpdatedBies: map['noteUpdatedBies'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersNoteUpdatedBy>(map['noteUpdatedBies']!, (value) => InsightFiltersNoteUpdatedBy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      processLaunchedAts: map['processLaunchedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProcessLaunchedAt>(map['processLaunchedAts']!, (value) => InsightFiltersProcessLaunchedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      processNames: map['processNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProcessName>(map['processNames']!, (value) => InsightFiltersProcessName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      processParentPids: map['processParentPids'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProcessParentPid>(map['processParentPids']!, (value) => InsightFiltersProcessParentPid.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      processPaths: map['processPaths'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProcessPath>(map['processPaths']!, (value) => InsightFiltersProcessPath.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      processPids: map['processPids'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProcessPid>(map['processPids']!, (value) => InsightFiltersProcessPid.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      processTerminatedAts: map['processTerminatedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProcessTerminatedAt>(map['processTerminatedAts']!, (value) => InsightFiltersProcessTerminatedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      productArns: map['productArns'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProductArn>(map['productArns']!, (value) => InsightFiltersProductArn.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      productFields: map['productFields'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProductField>(map['productFields']!, (value) => InsightFiltersProductField.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      productNames: map['productNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersProductName>(map['productNames']!, (value) => InsightFiltersProductName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      recommendationTexts: map['recommendationTexts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersRecommendationText>(map['recommendationTexts']!, (value) => InsightFiltersRecommendationText.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      recordStates: map['recordStates'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersRecordState>(map['recordStates']!, (value) => InsightFiltersRecordState.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      relatedFindingsIds: map['relatedFindingsIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersRelatedFindingsId>(map['relatedFindingsIds']!, (value) => InsightFiltersRelatedFindingsId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      relatedFindingsProductArns: map['relatedFindingsProductArns'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersRelatedFindingsProductArn>(map['relatedFindingsProductArns']!, (value) => InsightFiltersRelatedFindingsProductArn.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      resourceAwsEc2InstanceImageIds: map['resourceAwsEc2InstanceImageIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceImageId>(map['resourceAwsEc2InstanceImageIds']!, (value) => InsightFiltersResourceAwsEc2InstanceImageId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsEc2InstanceIpv4Addresses: map['resourceAwsEc2InstanceIpv4Addresses'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceIpv4Address>(map['resourceAwsEc2InstanceIpv4Addresses']!, (value) => InsightFiltersResourceAwsEc2InstanceIpv4Address.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsEc2InstanceIpv6Addresses: map['resourceAwsEc2InstanceIpv6Addresses'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceIpv6Address>(map['resourceAwsEc2InstanceIpv6Addresses']!, (value) => InsightFiltersResourceAwsEc2InstanceIpv6Address.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsEc2InstanceKeyNames: map['resourceAwsEc2InstanceKeyNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceKeyName>(map['resourceAwsEc2InstanceKeyNames']!, (value) => InsightFiltersResourceAwsEc2InstanceKeyName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsEc2InstanceLaunchedAts: map['resourceAwsEc2InstanceLaunchedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceLaunchedAt>(map['resourceAwsEc2InstanceLaunchedAts']!, (value) => InsightFiltersResourceAwsEc2InstanceLaunchedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsEc2InstanceSubnetIds: map['resourceAwsEc2InstanceSubnetIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceSubnetId>(map['resourceAwsEc2InstanceSubnetIds']!, (value) => InsightFiltersResourceAwsEc2InstanceSubnetId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsEc2InstanceTypes: map['resourceAwsEc2InstanceTypes'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceType>(map['resourceAwsEc2InstanceTypes']!, (value) => InsightFiltersResourceAwsEc2InstanceType.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsEc2InstanceVpcIds: map['resourceAwsEc2InstanceVpcIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceVpcId>(map['resourceAwsEc2InstanceVpcIds']!, (value) => InsightFiltersResourceAwsEc2InstanceVpcId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsIamAccessKeyCreatedAts: map['resourceAwsIamAccessKeyCreatedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsIamAccessKeyCreatedAt>(map['resourceAwsIamAccessKeyCreatedAts']!, (value) => InsightFiltersResourceAwsIamAccessKeyCreatedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsIamAccessKeyStatuses: map['resourceAwsIamAccessKeyStatuses'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsIamAccessKeyStatus>(map['resourceAwsIamAccessKeyStatuses']!, (value) => InsightFiltersResourceAwsIamAccessKeyStatus.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsIamAccessKeyUserNames: map['resourceAwsIamAccessKeyUserNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsIamAccessKeyUserName>(map['resourceAwsIamAccessKeyUserNames']!, (value) => InsightFiltersResourceAwsIamAccessKeyUserName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsS3BucketOwnerIds: map['resourceAwsS3BucketOwnerIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsS3BucketOwnerId>(map['resourceAwsS3BucketOwnerIds']!, (value) => InsightFiltersResourceAwsS3BucketOwnerId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceAwsS3BucketOwnerNames: map['resourceAwsS3BucketOwnerNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceAwsS3BucketOwnerName>(map['resourceAwsS3BucketOwnerNames']!, (value) => InsightFiltersResourceAwsS3BucketOwnerName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceContainerImageIds: map['resourceContainerImageIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceContainerImageId>(map['resourceContainerImageIds']!, (value) => InsightFiltersResourceContainerImageId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceContainerImageNames: map['resourceContainerImageNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceContainerImageName>(map['resourceContainerImageNames']!, (value) => InsightFiltersResourceContainerImageName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceContainerLaunchedAts: map['resourceContainerLaunchedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceContainerLaunchedAt>(map['resourceContainerLaunchedAts']!, (value) => InsightFiltersResourceContainerLaunchedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceContainerNames: map['resourceContainerNames'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceContainerName>(map['resourceContainerNames']!, (value) => InsightFiltersResourceContainerName.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceDetailsOthers: map['resourceDetailsOthers'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceDetailsOther>(map['resourceDetailsOthers']!, (value) => InsightFiltersResourceDetailsOther.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceIds: map['resourceIds'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceId>(map['resourceIds']!, (value) => InsightFiltersResourceId.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourcePartitions: map['resourcePartitions'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourcePartition>(map['resourcePartitions']!, (value) => InsightFiltersResourcePartition.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceRegions: map['resourceRegions'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceRegion>(map['resourceRegions']!, (value) => InsightFiltersResourceRegion.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceTags: map['resourceTags'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceTag>(map['resourceTags']!, (value) => InsightFiltersResourceTag.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      resourceTypes: map['resourceTypes'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersResourceType>(map['resourceTypes']!, (value) => InsightFiltersResourceType.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      severityLabels: map['severityLabels'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersSeverityLabel>(map['severityLabels']!, (value) => InsightFiltersSeverityLabel.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      sourceUrls: map['sourceUrls'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersSourceUrl>(map['sourceUrls']!, (value) => InsightFiltersSourceUrl.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      threatIntelIndicatorCategories: map['threatIntelIndicatorCategories'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorCategory>(map['threatIntelIndicatorCategories']!, (value) => InsightFiltersThreatIntelIndicatorCategory.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      threatIntelIndicatorLastObservedAts: map['threatIntelIndicatorLastObservedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorLastObservedAt>(map['threatIntelIndicatorLastObservedAts']!, (value) => InsightFiltersThreatIntelIndicatorLastObservedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      threatIntelIndicatorSourceUrls: map['threatIntelIndicatorSourceUrls'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorSourceUrl>(map['threatIntelIndicatorSourceUrls']!, (value) => InsightFiltersThreatIntelIndicatorSourceUrl.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      threatIntelIndicatorSources: map['threatIntelIndicatorSources'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorSource>(map['threatIntelIndicatorSources']!, (value) => InsightFiltersThreatIntelIndicatorSource.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      threatIntelIndicatorTypes: map['threatIntelIndicatorTypes'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorType>(map['threatIntelIndicatorTypes']!, (value) => InsightFiltersThreatIntelIndicatorType.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      threatIntelIndicatorValues: map['threatIntelIndicatorValues'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorValue>(map['threatIntelIndicatorValues']!, (value) => InsightFiltersThreatIntelIndicatorValue.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      titles: map['titles'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersTitle>(map['titles']!, (value) => InsightFiltersTitle.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      types: map['types'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersType>(map['types']!, (value) => InsightFiltersType.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      updatedAts: map['updatedAts'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersUpdatedAt>(map['updatedAts']!, (value) => InsightFiltersUpdatedAt.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      userDefinedValues: map['userDefinedValues'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersUserDefinedValue>(map['userDefinedValues']!, (value) => InsightFiltersUserDefinedValue.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      verificationStates: map['verificationStates'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersVerificationState>(map['verificationStates']!, (value) => InsightFiltersVerificationState.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      workflowStatuses: map['workflowStatuses'] == null ? null : ((pulumi.Input.decodeList<InsightFiltersWorkflowStatus>(map['workflowStatuses']!, (value) => InsightFiltersWorkflowStatus.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
