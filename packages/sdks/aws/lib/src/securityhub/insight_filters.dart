...
class InsightFilters {
  ...
  factory InsightFilters.fromMap(Map<String, dynamic> map) {
    return InsightFilters(
      ...
      criticalities: (() { final guardedValue = map['criticalities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersCriticality>(guardedValue, (value) => InsightFiltersCriticality.fromMap((value as Map).cast<String, dynamic>()))); })(),
      descriptions: (() { final guardedValue = map['descriptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersDescription>(guardedValue, (value) => InsightFiltersDescription.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingProviderFieldsConfidences: (() { final guardedValue = map['findingProviderFieldsConfidences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsConfidence>(guardedValue, (value) => InsightFiltersFindingProviderFieldsConfidence.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingProviderFieldsCriticalities: (() { final guardedValue = map['findingProviderFieldsCriticalities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsCriticality>(guardedValue, (value) => InsightFiltersFindingProviderFieldsCriticality.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingProviderFieldsRelatedFindingsIds: (() { final guardedValue = map['findingProviderFieldsRelatedFindingsIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsRelatedFindingsId>(guardedValue, (value) => InsightFiltersFindingProviderFieldsRelatedFindingsId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingProviderFieldsRelatedFindingsProductArns: (() { final guardedValue = map['findingProviderFieldsRelatedFindingsProductArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsRelatedFindingsProductArn>(guardedValue, (value) => InsightFiltersFindingProviderFieldsRelatedFindingsProductArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingProviderFieldsSeverityLabels: (() { final guardedValue = map['findingProviderFieldsSeverityLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsSeverityLabel>(guardedValue, (value) => InsightFiltersFindingProviderFieldsSeverityLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingProviderFieldsSeverityOriginals: (() { final guardedValue = map['findingProviderFieldsSeverityOriginals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsSeverityOriginal>(guardedValue, (value) => InsightFiltersFindingProviderFieldsSeverityOriginal.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingProviderFieldsTypes: (() { final guardedValue = map['findingProviderFieldsTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFindingProviderFieldsType>(guardedValue, (value) => InsightFiltersFindingProviderFieldsType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      firstObservedAts: (() { final guardedValue = map['firstObservedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersFirstObservedAt>(guardedValue, (value) => InsightFiltersFirstObservedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      generatorIds: (() { final guardedValue = map['generatorIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersGeneratorId>(guardedValue, (value) => InsightFiltersGeneratorId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ids: (() { final guardedValue = map['ids']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersId>(guardedValue, (value) => InsightFiltersId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      keywords: (() { final guardedValue = map['keywords']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersKeyword>(guardedValue, (value) => InsightFiltersKeyword.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lastObservedAts: (() { final guardedValue = map['lastObservedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersLastObservedAt>(guardedValue, (value) => InsightFiltersLastObservedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      malwareNames: (() { final guardedValue = map['malwareNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersMalwareName>(guardedValue, (value) => InsightFiltersMalwareName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      malwarePaths: (() { final guardedValue = map['malwarePaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersMalwarePath>(guardedValue, (value) => InsightFiltersMalwarePath.fromMap((value as Map).cast<String, dynamic>()))); })(),
      malwareStates: (() { final guardedValue = map['malwareStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersMalwareState>(guardedValue, (value) => InsightFiltersMalwareState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      malwareTypes: (() { final guardedValue = map['malwareTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersMalwareType>(guardedValue, (value) => InsightFiltersMalwareType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkDestinationDomains: (() { final guardedValue = map['networkDestinationDomains']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkDestinationDomain>(guardedValue, (value) => InsightFiltersNetworkDestinationDomain.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkDestinationIpv4s: (() { final guardedValue = map['networkDestinationIpv4s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkDestinationIpv4>(guardedValue, (value) => InsightFiltersNetworkDestinationIpv4.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkDestinationIpv6s: (() { final guardedValue = map['networkDestinationIpv6s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkDestinationIpv6>(guardedValue, (value) => InsightFiltersNetworkDestinationIpv6.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkDestinationPorts: (() { final guardedValue = map['networkDestinationPorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkDestinationPort>(guardedValue, (value) => InsightFiltersNetworkDestinationPort.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkDirections: (() { final guardedValue = map['networkDirections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkDirection>(guardedValue, (value) => InsightFiltersNetworkDirection.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkProtocols: (() { final guardedValue = map['networkProtocols']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkProtocol>(guardedValue, (value) => InsightFiltersNetworkProtocol.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkSourceDomains: (() { final guardedValue = map['networkSourceDomains']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkSourceDomain>(guardedValue, (value) => InsightFiltersNetworkSourceDomain.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkSourceIpv4s: (() { final guardedValue = map['networkSourceIpv4s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkSourceIpv4>(guardedValue, (value) => InsightFiltersNetworkSourceIpv4.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkSourceIpv6s: (() { final guardedValue = map['networkSourceIpv6s']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkSourceIpv6>(guardedValue, (value) => InsightFiltersNetworkSourceIpv6.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkSourceMacs: (() { final guardedValue = map['networkSourceMacs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkSourceMac>(guardedValue, (value) => InsightFiltersNetworkSourceMac.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkSourcePorts: (() { final guardedValue = map['networkSourcePorts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNetworkSourcePort>(guardedValue, (value) => InsightFiltersNetworkSourcePort.fromMap((value as Map).cast<String, dynamic>()))); })(),
      noteTexts: (() { final guardedValue = map['noteTexts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNoteText>(guardedValue, (value) => InsightFiltersNoteText.fromMap((value as Map).cast<String, dynamic>()))); })(),
      noteUpdatedAts: (() { final guardedValue = map['noteUpdatedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNoteUpdatedAt>(guardedValue, (value) => InsightFiltersNoteUpdatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      noteUpdatedBies: (() { final guardedValue = map['noteUpdatedBies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersNoteUpdatedBy>(guardedValue, (value) => InsightFiltersNoteUpdatedBy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processLaunchedAts: (() { final guardedValue = map['processLaunchedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProcessLaunchedAt>(guardedValue, (value) => InsightFiltersProcessLaunchedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processNames: (() { final guardedValue = map['processNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProcessName>(guardedValue, (value) => InsightFiltersProcessName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processParentPids: (() { final guardedValue = map['processParentPids']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProcessParentPid>(guardedValue, (value) => InsightFiltersProcessParentPid.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processPaths: (() { final guardedValue = map['processPaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProcessPath>(guardedValue, (value) => InsightFiltersProcessPath.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processPids: (() { final guardedValue = map['processPids']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProcessPid>(guardedValue, (value) => InsightFiltersProcessPid.fromMap((value as Map).cast<String, dynamic>()))); })(),
      processTerminatedAts: (() { final guardedValue = map['processTerminatedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProcessTerminatedAt>(guardedValue, (value) => InsightFiltersProcessTerminatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      productArns: (() { final guardedValue = map['productArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProductArn>(guardedValue, (value) => InsightFiltersProductArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      productFields: (() { final guardedValue = map['productFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProductField>(guardedValue, (value) => InsightFiltersProductField.fromMap((value as Map).cast<String, dynamic>()))); })(),
      productNames: (() { final guardedValue = map['productNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersProductName>(guardedValue, (value) => InsightFiltersProductName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      recommendationTexts: (() { final guardedValue = map['recommendationTexts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersRecommendationText>(guardedValue, (value) => InsightFiltersRecommendationText.fromMap((value as Map).cast<String, dynamic>()))); })(),
      recordStates: (() { final guardedValue = map['recordStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersRecordState>(guardedValue, (value) => InsightFiltersRecordState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      relatedFindingsIds: (() { final guardedValue = map['relatedFindingsIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersRelatedFindingsId>(guardedValue, (value) => InsightFiltersRelatedFindingsId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      relatedFindingsProductArns: (() { final guardedValue = map['relatedFindingsProductArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersRelatedFindingsProductArn>(guardedValue, (value) => InsightFiltersRelatedFindingsProductArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceIamInstanceProfileArns: (() { final guardedValue = map['resourceAwsEc2InstanceIamInstanceProfileArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceImageIds: (() { final guardedValue = map['resourceAwsEc2InstanceImageIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceImageId>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceImageId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceIpv4Addresses: (() { final guardedValue = map['resourceAwsEc2InstanceIpv4Addresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceIpv4Address>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceIpv4Address.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceIpv6Addresses: (() { final guardedValue = map['resourceAwsEc2InstanceIpv6Addresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceIpv6Address>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceIpv6Address.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceKeyNames: (() { final guardedValue = map['resourceAwsEc2InstanceKeyNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceKeyName>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceKeyName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceLaunchedAts: (() { final guardedValue = map['resourceAwsEc2InstanceLaunchedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceLaunchedAt>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceLaunchedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceSubnetIds: (() { final guardedValue = map['resourceAwsEc2InstanceSubnetIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceSubnetId>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceSubnetId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceTypes: (() { final guardedValue = map['resourceAwsEc2InstanceTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceType>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsEc2InstanceVpcIds: (() { final guardedValue = map['resourceAwsEc2InstanceVpcIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsEc2InstanceVpcId>(guardedValue, (value) => InsightFiltersResourceAwsEc2InstanceVpcId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsIamAccessKeyCreatedAts: (() { final guardedValue = map['resourceAwsIamAccessKeyCreatedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsIamAccessKeyCreatedAt>(guardedValue, (value) => InsightFiltersResourceAwsIamAccessKeyCreatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsIamAccessKeyStatuses: (() { final guardedValue = map['resourceAwsIamAccessKeyStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsIamAccessKeyStatus>(guardedValue, (value) => InsightFiltersResourceAwsIamAccessKeyStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsIamAccessKeyUserNames: (() { final guardedValue = map['resourceAwsIamAccessKeyUserNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsIamAccessKeyUserName>(guardedValue, (value) => InsightFiltersResourceAwsIamAccessKeyUserName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsS3BucketOwnerIds: (() { final guardedValue = map['resourceAwsS3BucketOwnerIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsS3BucketOwnerId>(guardedValue, (value) => InsightFiltersResourceAwsS3BucketOwnerId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceAwsS3BucketOwnerNames: (() { final guardedValue = map['resourceAwsS3BucketOwnerNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceAwsS3BucketOwnerName>(guardedValue, (value) => InsightFiltersResourceAwsS3BucketOwnerName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceContainerImageIds: (() { final guardedValue = map['resourceContainerImageIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceContainerImageId>(guardedValue, (value) => InsightFiltersResourceContainerImageId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceContainerImageNames: (() { final guardedValue = map['resourceContainerImageNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceContainerImageName>(guardedValue, (value) => InsightFiltersResourceContainerImageName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceContainerLaunchedAts: (() { final guardedValue = map['resourceContainerLaunchedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceContainerLaunchedAt>(guardedValue, (value) => InsightFiltersResourceContainerLaunchedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceContainerNames: (() { final guardedValue = map['resourceContainerNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceContainerName>(guardedValue, (value) => InsightFiltersResourceContainerName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceDetailsOthers: (() { final guardedValue = map['resourceDetailsOthers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceDetailsOther>(guardedValue, (value) => InsightFiltersResourceDetailsOther.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceIds: (() { final guardedValue = map['resourceIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceId>(guardedValue, (value) => InsightFiltersResourceId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourcePartitions: (() { final guardedValue = map['resourcePartitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourcePartition>(guardedValue, (value) => InsightFiltersResourcePartition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceRegions: (() { final guardedValue = map['resourceRegions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceRegion>(guardedValue, (value) => InsightFiltersResourceRegion.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceTags: (() { final guardedValue = map['resourceTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceTag>(guardedValue, (value) => InsightFiltersResourceTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceTypes: (() { final guardedValue = map['resourceTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersResourceType>(guardedValue, (value) => InsightFiltersResourceType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      severityLabels: (() { final guardedValue = map['severityLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersSeverityLabel>(guardedValue, (value) => InsightFiltersSeverityLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sourceUrls: (() { final guardedValue = map['sourceUrls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersSourceUrl>(guardedValue, (value) => InsightFiltersSourceUrl.fromMap((value as Map).cast<String, dynamic>()))); })(),
      threatIntelIndicatorCategories: (() { final guardedValue = map['threatIntelIndicatorCategories']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorCategory>(guardedValue, (value) => InsightFiltersThreatIntelIndicatorCategory.fromMap((value as Map).cast<String, dynamic>()))); })(),
      threatIntelIndicatorLastObservedAts: (() { final guardedValue = map['threatIntelIndicatorLastObservedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorLastObservedAt>(guardedValue, (value) => InsightFiltersThreatIntelIndicatorLastObservedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      threatIntelIndicatorSourceUrls: (() { final guardedValue = map['threatIntelIndicatorSourceUrls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorSourceUrl>(guardedValue, (value) => InsightFiltersThreatIntelIndicatorSourceUrl.fromMap((value as Map).cast<String, dynamic>()))); })(),
      threatIntelIndicatorSources: (() { final guardedValue = map['threatIntelIndicatorSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorSource>(guardedValue, (value) => InsightFiltersThreatIntelIndicatorSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      threatIntelIndicatorTypes: (() { final guardedValue = map['threatIntelIndicatorTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorType>(guardedValue, (value) => InsightFiltersThreatIntelIndicatorType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      threatIntelIndicatorValues: (() { final guardedValue = map['threatIntelIndicatorValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersThreatIntelIndicatorValue>(guardedValue, (value) => InsightFiltersThreatIntelIndicatorValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      titles: (() { final guardedValue = map['titles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersTitle>(guardedValue, (value) => InsightFiltersTitle.fromMap((value as Map).cast<String, dynamic>()))); })(),
      types: (() { final guardedValue = map['types']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersType>(guardedValue, (value) => InsightFiltersType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      updatedAts: (() { final guardedValue = map['updatedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersUpdatedAt>(guardedValue, (value) => InsightFiltersUpdatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      userDefinedValues: (() { final guardedValue = map['userDefinedValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersUserDefinedValue>(guardedValue, (value) => InsightFiltersUserDefinedValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      verificationStates: (() { final guardedValue = map['verificationStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersVerificationState>(guardedValue, (value) => InsightFiltersVerificationState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      workflowStatuses: (() { final guardedValue = map['workflowStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<InsightFiltersWorkflowStatus>(guardedValue, (value) => InsightFiltersWorkflowStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
