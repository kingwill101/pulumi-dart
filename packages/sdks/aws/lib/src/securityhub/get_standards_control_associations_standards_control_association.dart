...
class GetStandardsControlAssociationsStandardsControlAssociation {
  ...
  factory GetStandardsControlAssociationsStandardsControlAssociation.fromMap(
    ...
    return GetStandardsControlAssociationsStandardsControlAssociation(
      ...
      relatedRequirements: pulumi.Input.fromValue(
        (map['relatedRequirements'] as List).cast<String>(),
      ),
      securityControlArn: pulumi.Input.fromValue(
        map['securityControlArn'] as String,
      ),
      ...
      standardsControlDescription: pulumi.Input.fromValue(
        map['standardsControlDescription'] as String,
      ),
      standardsControlTitle: pulumi.Input.fromValue(
        map['standardsControlTitle'] as String,
      ),
