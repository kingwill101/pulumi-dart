...
class AutomationRuleCriteriaLastObservedAt {
  ...
  const AutomationRuleCriteriaLastObservedAt({
    this.dateRange,
    this.end,
    this.start,
  });
  ...
  factory AutomationRuleCriteriaLastObservedAt.fromMap(Map<String, dynamic> map) {
    return AutomationRuleCriteriaLastObservedAt(
      dateRange: (() { final guardedValue = map['dateRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutomationRuleCriteriaLastObservedAtDateRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
