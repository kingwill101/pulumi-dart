...
class FindingAggregatorState {
  ...
  FindingAggregatorState({
    pulumi.Output<String>? linkingMode,
    pulumi.Output<String>? region,
    pulumi.Output<List<String>>? specifiedRegions,
  }) :
      linkingMode = pulumi.Input.asOptionalInput<String>(linkingMode),
  ...
  factory FindingAggregatorState.fromMap(Map<String, dynamic> map) {
    return FindingAggregatorState(
      linkingMode: map['linkingMode'] == null ? null : pulumi.Output.create<String>(map['linkingMode'] as String),
