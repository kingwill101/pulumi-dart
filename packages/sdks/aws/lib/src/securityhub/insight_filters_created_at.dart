...
class InsightFiltersCreatedAt {
  ...
  factory InsightFiltersCreatedAt.fromMap(Map<String, dynamic> map) {
    return InsightFiltersCreatedAt(
      dateRange: (() { final guardedValue = map['dateRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InsightFiltersCreatedAtDateRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
