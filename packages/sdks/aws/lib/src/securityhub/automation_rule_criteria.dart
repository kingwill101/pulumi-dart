...
class AutomationRuleCriteria {
  ...
  factory AutomationRuleCriteria.fromMap(Map<String, dynamic> map) {
    return AutomationRuleCriteria(
      awsAccountIds: (() { final guardedValue = map['awsAccountIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaAwsAccountId>(guardedValue, (value) => AutomationRuleCriteriaAwsAccountId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      awsAccountNames: (() { final guardedValue = map['awsAccountNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaAwsAccountName>(guardedValue, (value) => AutomationRuleCriteriaAwsAccountName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      companyNames: (() { final guardedValue = map['companyNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaCompanyName>(guardedValue, (value) => AutomationRuleCriteriaCompanyName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      complianceAssociatedStandardsIds: (() { final guardedValue = map['complianceAssociatedStandardsIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaComplianceAssociatedStandardsId>(guardedValue, (value) => AutomationRuleCriteriaComplianceAssociatedStandardsId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      complianceSecurityControlIds: (() { final guardedValue = map['complianceSecurityControlIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaComplianceSecurityControlId>(guardedValue, (value) => AutomationRuleCriteriaComplianceSecurityControlId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      complianceStatuses: (() { final guardedValue = map['complianceStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaComplianceStatus>(guardedValue, (value) => AutomationRuleCriteriaComplianceStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      confidences: (() { final guardedValue = map['confidences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaConfidence>(guardedValue, (value) => AutomationRuleCriteriaConfidence.fromMap((value as Map).cast<String, dynamic>()))); })(),
      createdAts: (() { final guardedValue = map['createdAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaCreatedAt>(guardedValue, (value) => AutomationRuleCriteriaCreatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      criticalities: (() { final guardedValue = map['criticalities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaCriticality>(guardedValue, (value) => AutomationRuleCriteriaCriticality.fromMap((value as Map).cast<String, dynamic>()))); })(),
      descriptions: (() { final guardedValue = map['descriptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaDescription>(guardedValue, (value) => AutomationRuleCriteriaDescription.fromMap((value as Map).cast<String, dynamic>()))); })(),
      firstObservedAts: (() { final guardedValue = map['firstObservedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaFirstObservedAt>(guardedValue, (value) => AutomationRuleCriteriaFirstObservedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      generatorIds: (() { final guardedValue = map['generatorIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaGeneratorId>(guardedValue, (value) => AutomationRuleCriteriaGeneratorId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ids: (() { final guardedValue = map['ids']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaId>(guardedValue, (value) => AutomationRuleCriteriaId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lastObservedAts: (() { final guardedValue = map['lastObservedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaLastObservedAt>(guardedValue, (value) => AutomationRuleCriteriaLastObservedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      noteTexts: (() { final guardedValue = map['noteTexts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaNoteText>(guardedValue, (value) => AutomationRuleCriteriaNoteText.fromMap((value as Map).cast<String, dynamic>()))); })(),
      noteUpdatedAts: (() { final guardedValue = map['noteUpdatedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaNoteUpdatedAt>(guardedValue, (value) => AutomationRuleCriteriaNoteUpdatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      noteUpdatedBies: (() { final guardedValue = map['noteUpdatedBies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaNoteUpdatedBy>(guardedValue, (value) => AutomationRuleCriteriaNoteUpdatedBy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      productArns: (() { final guardedValue = map['productArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaProductArn>(guardedValue, (value) => AutomationRuleCriteriaProductArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      productNames: (() { final guardedValue = map['productNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaProductName>(guardedValue, (value) => AutomationRuleCriteriaProductName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      recordStates: (() { final guardedValue = map['recordStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaRecordState>(guardedValue, (value) => AutomationRuleCriteriaRecordState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      relatedFindingsIds: (() { final guardedValue = map['relatedFindingsIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaRelatedFindingsId>(guardedValue, (value) => AutomationRuleCriteriaRelatedFindingsId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      relatedFindingsProductArns: (() { final guardedValue = map['relatedFindingsProductArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaRelatedFindingsProductArn>(guardedValue, (value) => AutomationRuleCriteriaRelatedFindingsProductArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceApplicationArns: (() { final guardedValue = map['resourceApplicationArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourceApplicationArn>(guardedValue, (value) => AutomationRuleCriteriaResourceApplicationArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceApplicationNames: (() { final guardedValue = map['resourceApplicationNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourceApplicationName>(guardedValue, (value) => AutomationRuleCriteriaResourceApplicationName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceDetailsOthers: (() { final guardedValue = map['resourceDetailsOthers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourceDetailsOther>(guardedValue, (value) => AutomationRuleCriteriaResourceDetailsOther.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceIds: (() { final guardedValue = map['resourceIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourceId>(guardedValue, (value) => AutomationRuleCriteriaResourceId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourcePartitions: (() { final guardedValue = map['resourcePartitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourcePartition>(guardedValue, (value) => AutomationRuleCriteriaResourcePartition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceRegions: (() { final guardedValue = map['resourceRegions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourceRegion>(guardedValue, (value) => AutomationRuleCriteriaResourceRegion.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceTags: (() { final guardedValue = map['resourceTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourceTag>(guardedValue, (value) => AutomationRuleCriteriaResourceTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceTypes: (() { final guardedValue = map['resourceTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaResourceType>(guardedValue, (value) => AutomationRuleCriteriaResourceType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      severityLabels: (() { final guardedValue = map['severityLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaSeverityLabel>(guardedValue, (value) => AutomationRuleCriteriaSeverityLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sourceUrls: (() { final guardedValue = map['sourceUrls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaSourceUrl>(guardedValue, (value) => AutomationRuleCriteriaSourceUrl.fromMap((value as Map).cast<String, dynamic>()))); })(),
      titles: (() { final guardedValue = map['titles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaTitle>(guardedValue, (value) => AutomationRuleCriteriaTitle.fromMap((value as Map).cast<String, dynamic>()))); })(),
      types: (() { final guardedValue = map['types']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaType>(guardedValue, (value) => AutomationRuleCriteriaType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      updatedAts: (() { final guardedValue = map['updatedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaUpdatedAt>(guardedValue, (value) => AutomationRuleCriteriaUpdatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      userDefinedFields: (() { final guardedValue = map['userDefinedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaUserDefinedField>(guardedValue, (value) => AutomationRuleCriteriaUserDefinedField.fromMap((value as Map).cast<String, dynamic>()))); })(),
      verificationStates: (() { final guardedValue = map['verificationStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaVerificationState>(guardedValue, (value) => AutomationRuleCriteriaVerificationState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      workflowStatuses: (() { final guardedValue = map['workflowStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AutomationRuleCriteriaWorkflowStatus>(guardedValue, (value) => AutomationRuleCriteriaWorkflowStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
