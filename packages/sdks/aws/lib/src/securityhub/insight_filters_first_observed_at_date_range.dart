...
class InsightFiltersFirstObservedAtDateRange {
  ...
  factory InsightFiltersFirstObservedAtDateRange.fromMap(Map<String, dynamic> map) {
    return InsightFiltersFirstObservedAtDateRange(
