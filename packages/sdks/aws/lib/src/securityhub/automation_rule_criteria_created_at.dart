...
class AutomationRuleCriteriaCreatedAt {
  ...
  const AutomationRuleCriteriaCreatedAt({
    this.dateRange,
    this.end,
    this.start,
  });
  ...
  factory AutomationRuleCriteriaCreatedAt.fromMap(Map<String, dynamic> map) {
    return AutomationRuleCriteriaCreatedAt(
      dateRange: (() { final guardedValue = map['dateRange']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AutomationRuleCriteriaCreatedAtDateRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
