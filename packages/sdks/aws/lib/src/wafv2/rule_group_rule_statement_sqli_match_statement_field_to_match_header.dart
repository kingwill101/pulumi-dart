...
class RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader {
  ...
  final pulumi.Input<RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern> matchPattern;
  ...
  const RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPattern': pulumi.Input.mapInputValue<RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern, Map<String, dynamic>>(matchPattern, (value) => value.toMap()),
  ...
  factory RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader(
      matchPattern: pulumi.Input.fromValue(RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern']! as Map).cast<String, dynamic>())),
