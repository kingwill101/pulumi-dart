...
class WebAclRuleTimeouts {
  ...
  /// Creates a new [WebAclRuleTimeouts].
  ...
  factory WebAclRuleTimeouts.fromMap(Map<String, dynamic> map) {
    return WebAclRuleTimeouts(
