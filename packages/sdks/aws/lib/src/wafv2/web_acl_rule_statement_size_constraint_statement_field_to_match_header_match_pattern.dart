...
class WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern {
  ...
  /// Creates a new [WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern].
  ...
  const WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern({
    this.all,
  ...
  factory WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern(
