...
class WebAclRuleStatementSqliMatchStatementFieldToMatchCookies {
  ...
  final List<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPatterns': pulumi.Input.encodeList<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern, Map<String, dynamic>>(matchPatterns, (value) => value.toMap()),
  ...
  factory WebAclRuleStatementSqliMatchStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementSqliMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.decodeList<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns'], (value) => WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>())),
