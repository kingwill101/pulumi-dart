...
class WebAclRuleStatementSqliMatchStatementFieldToMatchCookies {
  ...
  final pulumi.Input<List<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>> matchPatterns;
  ...
  const WebAclRuleStatementSqliMatchStatementFieldToMatchCookies({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPatterns': pulumi.Input.mapInputValue<List<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>, List<Map<String, dynamic>>>(matchPatterns, (value) => pulumi.Input.encodeList<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory WebAclRuleStatementSqliMatchStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementSqliMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(pulumi.Input.decodeList<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns']!, (value) => WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>()))),
