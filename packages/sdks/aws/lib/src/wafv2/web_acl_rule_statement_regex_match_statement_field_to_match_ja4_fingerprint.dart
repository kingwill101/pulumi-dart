...
class WebAclRuleStatementRegexMatchStatementFieldToMatchJa4Fingerprint {
  ...
  const WebAclRuleStatementRegexMatchStatementFieldToMatchJa4Fingerprint({
  ...
  factory WebAclRuleStatementRegexMatchStatementFieldToMatchJa4Fingerprint.fromMap(Map<String, dynamic> map) {
