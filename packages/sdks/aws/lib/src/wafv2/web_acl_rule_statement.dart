...
class WebAclRuleStatement {
  ...
  final pulumi.Input<WebAclRuleStatementIpSetReferenceStatement>?
  ...
  final pulumi.Input<WebAclRuleStatementLabelMatchStatement>?
  labelMatchStatement;
  ...
  final pulumi.Input<WebAclRuleStatementManagedRuleGroupStatement>?
  ...
  final pulumi.Input<WebAclRuleStatementRegexMatchStatement>?
  regexMatchStatement;
  ...
  final pulumi.Input<WebAclRuleStatementRegexPatternSetReferenceStatement>?
  ...
  final pulumi.Input<WebAclRuleStatementRuleGroupReferenceStatement>?
  ...
  final pulumi.Input<WebAclRuleStatementSizeConstraintStatement>?
    ...
    return <String, dynamic>{
      ...
      'managedRuleGroupStatement':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(managedRuleGroupStatement, (value) => value.toMap()),
      'notStatement':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'ruleGroupReferenceStatement':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(ruleGroupReferenceStatement, (value) => value.toMap()),
      'sizeConstraintStatement':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory WebAclRuleStatement.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatement(
      ...
      managedRuleGroupStatement: (() {
        final guardedValue = map['managedRuleGroupStatement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ruleGroupReferenceStatement: (() {
        final guardedValue = map['ruleGroupReferenceStatement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
