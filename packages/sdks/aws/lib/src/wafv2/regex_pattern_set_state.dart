...
class RegexPatternSetState {
  ...
  /// [tags] An array of key:value pairs to associate with the resource. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
  ...
  factory RegexPatternSetState.fromMap(Map<String, dynamic> map) {
    return RegexPatternSetState(
      ...
      regularExpressions: (() { final guardedValue = map['regularExpressions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RegexPatternSetRegularExpression>(guardedValue, (value) => RegexPatternSetRegularExpression.fromMap((value as Map).cast<String, dynamic>()))); })(),
