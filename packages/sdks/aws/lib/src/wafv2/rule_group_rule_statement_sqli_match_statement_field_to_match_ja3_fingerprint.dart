...
class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint {
  ...
  /// Creates a new [RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint].
  ...
  const RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint({
  ...
  factory RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint.fromMap(Map<String, dynamic> map) {
