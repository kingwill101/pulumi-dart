...
class RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader {
  ...
  final pulumi.Input<RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern> matchPattern;
  ...
  const RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPattern': pulumi.Input.mapInputValue<RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern, Map<String, dynamic>>(matchPattern, (value) => value.toMap()),
  ...
  factory RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader(
      matchPattern: pulumi.Input.fromValue(RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern']! as Map).cast<String, dynamic>())),
