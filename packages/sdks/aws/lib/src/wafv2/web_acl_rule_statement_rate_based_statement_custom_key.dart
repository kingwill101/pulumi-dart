...
class WebAclRuleStatementRateBasedStatementCustomKey {
  ...
  final pulumi.Input<WebAclRuleStatementRateBasedStatementCustomKeyCookie>?
  cookie;
  ...
  final pulumi.Input<WebAclRuleStatementRateBasedStatementCustomKeyHeader>?
  header;
  ...
  final pulumi.Input<WebAclRuleStatementRateBasedStatementCustomKeyQueryString>?
  queryString;

  /// Use the request's URI path as an aggregate key. See RateLimit `uri_path` below for details.
  final pulumi.Input<WebAclRuleStatementRateBasedStatementCustomKeyUriPath>?
  uriPath;
