...
class WebAclRuleStatementManagedRuleGroupStatement {
  ...
  factory WebAclRuleStatementManagedRuleGroupStatement.fromMap(
    ...
    return WebAclRuleStatementManagedRuleGroupStatement(
      managedRuleGroupConfigs: (() {
        final guardedValue = map['managedRuleGroupConfigs'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfig.fromMap(
      ...
      ruleActionOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                WebAclRuleStatementManagedRuleGroupStatementRuleActionOverride.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      scopeDownStatement: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WebAclRuleStatementManagedRuleGroupStatementScopeDownStatement.fromMap(
