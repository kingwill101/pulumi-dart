...
class WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverride {
  ...
  const WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverride({
    this.actionToUse,
    required this.name,
  });
  ...
  factory WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverride.fromMap(Map<String, dynamic> map) {
    return WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverride(
      actionToUse: (() { final guardedValue = map['actionToUse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
