...
import 'rule_group_rule_statement_size_constraint_statement_field_to_match_cookies_match_pattern.dart';
...
class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies {
  ...
  final pulumi.Input<List<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern>> matchPatterns;
  ...
  /// Creates a new [RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies].
  ...
  const RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPatterns': pulumi.Input.mapInputValue<List<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern>, List<Map<String, dynamic>>>(matchPatterns, (value) => pulumi.Input.encodeList<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(pulumi.Input.decodeList<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns']!, (value) => RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>()))),
