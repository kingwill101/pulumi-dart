...
class WebAclRuleStatementGeoMatchStatement {
  ...
  final WebAclRuleStatementGeoMatchStatementForwardedIpConfig? forwardedIpConfig;
  ...
  factory WebAclRuleStatementGeoMatchStatement.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementGeoMatchStatement(
      ...
      forwardedIpConfig: map['forwardedIpConfig'] == null ? null : WebAclRuleStatementGeoMatchStatementForwardedIpConfig.fromMap((map['forwardedIpConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
