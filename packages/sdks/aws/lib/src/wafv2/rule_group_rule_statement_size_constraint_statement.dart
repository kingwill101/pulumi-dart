...
import 'rule_group_rule_statement_size_constraint_statement_pre_parse_text_transformation.dart';
...
class RuleGroupRuleStatementSizeConstraintStatement {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'preParseTextTransformations': ?pulumi.Input.mapOptionalInputValue<List<RuleGroupRuleStatementSizeConstraintStatementPreParseTextTransformation>, List<Map<String, dynamic>>>(preParseTextTransformations, (value) => pulumi.Input.encodeList<RuleGroupRuleStatementSizeConstraintStatementPreParseTextTransformation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'size': size,
