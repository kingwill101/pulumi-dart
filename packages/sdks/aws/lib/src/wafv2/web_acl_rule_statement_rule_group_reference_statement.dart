...
class WebAclRuleStatementRuleGroupReferenceStatement {
  ...
  final List<WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverride>? ruleActionOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arn': arn,
      'ruleActionOverrides': ?ruleActionOverrides == null ? null : pulumi.Input.encodeList<WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverride, Map<String, dynamic>>(ruleActionOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory WebAclRuleStatementRuleGroupReferenceStatement.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementRuleGroupReferenceStatement(
      ...
      ruleActionOverrides: map['ruleActionOverrides'] == null ? null : pulumi.Input.decodeList<WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverride>(map['ruleActionOverrides'], (value) => WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
