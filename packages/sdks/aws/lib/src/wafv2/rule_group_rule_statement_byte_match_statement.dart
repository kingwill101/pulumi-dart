...
class RuleGroupRuleStatementByteMatchStatement {
  ...
  final pulumi.Input<RuleGroupRuleStatementByteMatchStatementFieldToMatch>?
  fieldToMatch;
  ...
  final pulumi.Input<
    List<RuleGroupRuleStatementByteMatchStatementTextTransformation>
  >
  textTransformations;
    ...
    return RuleGroupRuleStatementByteMatchStatement(
      ...
      textTransformations: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              RuleGroupRuleStatementByteMatchStatementTextTransformation.fromMap(
