    ...
    return <String, dynamic>{
      ...
      'overrideAction':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(overrideAction, (value) => value.toMap()),
      'priority': priority,
      'ruleLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<WebAclRuleRuleLabel>,
      ...
      'statement':
          pulumi.Input.mapInputValue<WebAclRuleStatement, Map<String, dynamic>>(
            statement,
            (value) => value.toMap(),
          ),
      'visibilityConfig':
