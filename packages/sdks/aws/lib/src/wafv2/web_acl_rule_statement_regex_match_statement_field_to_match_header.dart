...
class WebAclRuleStatementRegexMatchStatementFieldToMatchHeader {
  ...
  final WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern matchPattern;
  ...
  factory WebAclRuleStatementRegexMatchStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementRegexMatchStatementFieldToMatchHeader(
      matchPattern: WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern'] as Map).cast<String, dynamic>()),
