...
class WebAclRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation {
  ...
  const WebAclRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation({
  ...
  factory WebAclRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation.fromMap(Map<String, dynamic> map) {
