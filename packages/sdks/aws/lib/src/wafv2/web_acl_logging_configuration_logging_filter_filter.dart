...
class WebAclLoggingConfigurationLoggingFilterFilter {
  ...
  factory WebAclLoggingConfigurationLoggingFilterFilter.fromMap(Map<String, dynamic> map) {
    return WebAclLoggingConfigurationLoggingFilterFilter(
      ...
      conditions: pulumi.Input.fromValue(pulumi.Input.decodeList<WebAclLoggingConfigurationLoggingFilterFilterCondition>(map['conditions']!, (value) => WebAclLoggingConfigurationLoggingFilterFilterCondition.fromMap((value as Map).cast<String, dynamic>()))),
