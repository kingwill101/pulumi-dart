...
class RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern {
  ...
  /// Creates a new [RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern].
  ...
  const RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern({
    this.all,
  ...
  factory RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern(
