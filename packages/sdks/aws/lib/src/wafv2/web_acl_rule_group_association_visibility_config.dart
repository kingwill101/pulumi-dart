...
class WebAclRuleGroupAssociationVisibilityConfig {
  ...
  /// Creates a new [WebAclRuleGroupAssociationVisibilityConfig].
  ...
  /// [metricName] Friendly name of the CloudWatch metric. The name can contain only alphanumeric characters (A-Z, a-z, 0-9) hyphen(-) and underscore (\_), with length from one to 128 characters. It can't contain whitespace or metric names reserved for AWS WAF, for example `All` and `Default_Action`.
  ...
  const WebAclRuleGroupAssociationVisibilityConfig({
  ...
  factory WebAclRuleGroupAssociationVisibilityConfig.fromMap(Map<String, dynamic> map) {
    return WebAclRuleGroupAssociationVisibilityConfig(
