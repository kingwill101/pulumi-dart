...
class WebAclAssociationConfigRequestBody {
  ...
  final pulumi.Input<WebAclAssociationConfigRequestBodyAppRunnerService>?
  appRunnerService;
  ...
  final pulumi.Input<WebAclAssociationConfigRequestBodyCognitoUserPool>?
  cognitoUserPool;
  ...
  final pulumi.Input<WebAclAssociationConfigRequestBodyVerifiedAccessInstance>?
    ...
    return <String, dynamic>{
      ...
      'appRunnerService':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(appRunnerService, (value) => value.toMap()),
      'cloudfront':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'cognitoUserPool':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cognitoUserPool, (value) => value.toMap()),
      'verifiedAccessInstance':
          ?pulumi.Input.mapOptionalInputValue<
            WebAclAssociationConfigRequestBodyVerifiedAccessInstance,
            Map<String, dynamic>
          >(verifiedAccessInstance, (value) => value.toMap()),
    };
  }
  ...
  factory WebAclAssociationConfigRequestBody.fromMap(Map<String, dynamic> map) {
    return WebAclAssociationConfigRequestBody(
      ...
      appRunnerService: (() {
        final guardedValue = map['appRunnerService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      cognitoUserPool: (() {
        final guardedValue = map['cognitoUserPool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      verifiedAccessInstance: (() {
        final guardedValue = map['verifiedAccessInstance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
