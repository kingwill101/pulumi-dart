...
class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies {
  ...
  factory WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies.fromMap(
    ...
    return WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(
        ...
        >(
          map['matchPatterns']!,
          (value) =>
              WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern.fromMap(
