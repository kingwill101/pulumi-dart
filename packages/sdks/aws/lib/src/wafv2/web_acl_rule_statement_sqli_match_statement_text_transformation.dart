...
class WebAclRuleStatementSqliMatchStatementTextTransformation {
  ...
  /// Creates a new [WebAclRuleStatementSqliMatchStatementTextTransformation].
  ...
  const WebAclRuleStatementSqliMatchStatementTextTransformation({
  ...
  factory WebAclRuleStatementSqliMatchStatementTextTransformation.fromMap(Map<String, dynamic> map) {
