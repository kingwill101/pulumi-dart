...
class RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation {
  ...
  /// Creates a new [RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation].
  ...
  const RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation({
  ...
  factory RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation(
