...
class GetManagedRuleGroupRuleActionBlock {
  final pulumi.Input<List<GetManagedRuleGroupRuleActionBlockCustomResponse>>
  customResponses;
    ...
    return <String, dynamic>{
      'customResponses':
          pulumi.Input.mapInputValue<
            List<GetManagedRuleGroupRuleActionBlockCustomResponse>,
  ...
  factory GetManagedRuleGroupRuleActionBlock.fromMap(Map<String, dynamic> map) {
    return GetManagedRuleGroupRuleActionBlock(
      customResponses: pulumi.Input.fromValue(
        pulumi
