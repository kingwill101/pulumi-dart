...
class WebAclRuleStatementByteMatchStatementFieldToMatch {
  ...
  final pulumi.Input<WebAclRuleStatementByteMatchStatementFieldToMatchBody>?
  body;

  /// Inspect the cookies in the web request. See `cookies` below for details.
  final pulumi.Input<WebAclRuleStatementByteMatchStatementFieldToMatchCookies>?
  cookies;

  /// Inspect a string containing the list of the request's header names, ordered as they appear in the web request that AWS WAF receives for inspection. See `header_order` below for details.
  final pulumi.Input<
    List<WebAclRuleStatementByteMatchStatementFieldToMatchHeaderOrder>
  >?
  headerOrders;

  /// Inspect the request headers. See `headers` below for details.
  final pulumi.Input<
    List<WebAclRuleStatementByteMatchStatementFieldToMatchHeader>
  >?
  headers;
  ...
  final pulumi.Input<WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody>?
  jsonBody;
