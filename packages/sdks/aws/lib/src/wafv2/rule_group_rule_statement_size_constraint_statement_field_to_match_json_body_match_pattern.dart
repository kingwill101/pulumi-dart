...
class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern {
  ...
  factory RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern(
