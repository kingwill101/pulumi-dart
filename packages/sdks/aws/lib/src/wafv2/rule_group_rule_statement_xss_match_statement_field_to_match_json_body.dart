...
class RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody {
  ...
  final pulumi.Input<RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
  ...
  const RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchPattern': pulumi.Input.mapInputValue<RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern, Map<String, dynamic>>(matchPattern, (value) => value.toMap()),
  ...
  factory RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody(
      ...
      matchPattern: pulumi.Input.fromValue(RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern.fromMap((map['matchPattern']! as Map).cast<String, dynamic>())),
