...
class WebAclRuleActionCountCustomRequestHandlingInsertHeader {
  ...
  /// [name] Header name.
  /// [value] Header value.
  const WebAclRuleActionCountCustomRequestHandlingInsertHeader({
    required this.name,
    required this.value,
  });
  ...
  factory WebAclRuleActionCountCustomRequestHandlingInsertHeader.fromMap(Map<String, dynamic> map) {
