...
class GetManagedRuleGroupRule {
  ...
  factory GetManagedRuleGroupRule.fromMap(Map<String, dynamic> map) {
    return GetManagedRuleGroupRule(
      actions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetManagedRuleGroupRuleAction>(map['actions']!, (value) => GetManagedRuleGroupRuleAction.fromMap((value as Map).cast<String, dynamic>()))),
