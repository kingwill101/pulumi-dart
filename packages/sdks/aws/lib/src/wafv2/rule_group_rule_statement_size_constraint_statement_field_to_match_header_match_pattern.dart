...
class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern {
  ...
  const RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern({
    this.all,
  ...
  factory RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern.fromMap(Map<String, dynamic> map) {
