...
class RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern {
  ...
  /// Creates a new [RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern].
  ...
  const RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern({
    this.all,
  ...
  factory RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern(
