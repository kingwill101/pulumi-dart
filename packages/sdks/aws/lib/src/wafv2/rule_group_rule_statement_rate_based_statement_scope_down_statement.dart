...
class RuleGroupRuleStatementRateBasedStatementScopeDownStatement {
  ...
  factory RuleGroupRuleStatementRateBasedStatementScopeDownStatement.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRateBasedStatementScopeDownStatement(
      andStatement: map['andStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementAndStatement.fromMap((map['andStatement']! as Map).cast<String, dynamic>())).input()).input(),
      asnMatchStatement: map['asnMatchStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementAsnMatchStatement.fromMap((map['asnMatchStatement']! as Map).cast<String, dynamic>())).input()).input(),
      byteMatchStatement: map['byteMatchStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementByteMatchStatement.fromMap((map['byteMatchStatement']! as Map).cast<String, dynamic>())).input()).input(),
      geoMatchStatement: map['geoMatchStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement.fromMap((map['geoMatchStatement']! as Map).cast<String, dynamic>())).input()).input(),
      ipSetReferenceStatement: map['ipSetReferenceStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatement.fromMap((map['ipSetReferenceStatement']! as Map).cast<String, dynamic>())).input()).input(),
      labelMatchStatement: map['labelMatchStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementLabelMatchStatement.fromMap((map['labelMatchStatement']! as Map).cast<String, dynamic>())).input()).input(),
      notStatement: map['notStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementNotStatement.fromMap((map['notStatement']! as Map).cast<String, dynamic>())).input()).input(),
      orStatement: map['orStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementOrStatement.fromMap((map['orStatement']! as Map).cast<String, dynamic>())).input()).input(),
      regexMatchStatement: map['regexMatchStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatement.fromMap((map['regexMatchStatement']! as Map).cast<String, dynamic>())).input()).input(),
      regexPatternSetReferenceStatement: map['regexPatternSetReferenceStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexPatternSetReferenceStatement.fromMap((map['regexPatternSetReferenceStatement']! as Map).cast<String, dynamic>())).input()).input(),
      sizeConstraintStatement: map['sizeConstraintStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatement.fromMap((map['sizeConstraintStatement']! as Map).cast<String, dynamic>())).input()).input(),
      sqliMatchStatement: map['sqliMatchStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementSqliMatchStatement.fromMap((map['sqliMatchStatement']! as Map).cast<String, dynamic>())).input()).input(),
      xssMatchStatement: map['xssMatchStatement'] == null ? null : ((RuleGroupRuleStatementRateBasedStatementScopeDownStatementXssMatchStatement.fromMap((map['xssMatchStatement']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
