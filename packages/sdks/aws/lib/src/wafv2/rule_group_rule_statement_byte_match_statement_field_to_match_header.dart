...
class RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader {
  ...
  final RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern matchPattern;
  ...
  factory RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader(
      matchPattern: RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern'] as Map).cast<String, dynamic>()),
