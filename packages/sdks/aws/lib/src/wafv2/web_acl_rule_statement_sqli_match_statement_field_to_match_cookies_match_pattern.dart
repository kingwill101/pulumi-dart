...
class WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern {
  ...
  /// Creates a new [WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern].
  /// [all] An empty configuration block that is used for inspecting all headers.
  /// [excludedCookies] Optional.
  /// [includedCookies] Optional.
  const WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern({
    this.all,
