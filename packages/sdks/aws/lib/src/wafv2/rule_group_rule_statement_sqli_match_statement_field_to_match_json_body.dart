...
class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody {
  ...
  final pulumi.Input<RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
  ...
  const RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchPattern': pulumi.Input.mapInputValue<RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern, Map<String, dynamic>>(matchPattern, (value) => value.toMap()),
      'matchScope': matchScope,
      'oversizeHandling': ?oversizeHandling,
    };
  }

  factory RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody(
      ...
      matchPattern: pulumi.Input.fromValue(RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern.fromMap((map['matchPattern']! as Map).cast<String, dynamic>())),
