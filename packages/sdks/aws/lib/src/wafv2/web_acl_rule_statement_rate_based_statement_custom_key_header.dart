...
class WebAclRuleStatementRateBasedStatementCustomKeyHeader {
  ...
  final pulumi.Input<
    List<WebAclRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation>
  >
  textTransformations;
    ...
    return WebAclRuleStatementRateBasedStatementCustomKeyHeader(
      ...
      textTransformations: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              WebAclRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation.fromMap(
