...
class WebAclRuleStatementSqliMatchStatementFieldToMatch {
  ...
  final pulumi.Input<WebAclRuleStatementSqliMatchStatementFieldToMatchBody>?
  body;

  /// Inspect the cookies in the web request. See `cookies` below for details.
  final pulumi.Input<WebAclRuleStatementSqliMatchStatementFieldToMatchCookies>?
  cookies;

  /// Inspect a string containing the list of the request's header names, ordered as they appear in the web request that AWS WAF receives for inspection. See `header_order` below for details.
  final pulumi.Input<
    List<WebAclRuleStatementSqliMatchStatementFieldToMatchHeaderOrder>
  >?
  headerOrders;

  /// Inspect the request headers. See `headers` below for details.
  final pulumi.Input<
    List<WebAclRuleStatementSqliMatchStatementFieldToMatchHeader>
  >?
  headers;
  ...
  final pulumi.Input<WebAclRuleStatementSqliMatchStatementFieldToMatchJsonBody>?
  jsonBody;
