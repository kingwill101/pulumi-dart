...
class WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader {
  ...
  /// Creates a new [WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader].
  ...
  const WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader({
    required this.name,
    required this.value,
  });
  ...
  factory WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader.fromMap(Map<String, dynamic> map) {
    return WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader(
