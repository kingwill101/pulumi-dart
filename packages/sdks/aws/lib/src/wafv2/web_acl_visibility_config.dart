...
class WebAclVisibilityConfig {
  ...
  /// Creates a new [WebAclVisibilityConfig].
  ...
  factory WebAclVisibilityConfig.fromMap(Map<String, dynamic> map) {
    return WebAclVisibilityConfig(
      cloudwatchMetricsEnabled: (map['cloudwatchMetricsEnabled'] as bool).input(),
      metricName: (map['metricName'] as String).input(),
      sampledRequestsEnabled: (map['sampledRequestsEnabled'] as bool).input(),
    );
  }
}
