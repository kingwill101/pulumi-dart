...
class WebAclRuleStatementByteMatchStatementFieldToMatchJa3Fingerprint {
  ...
  const WebAclRuleStatementByteMatchStatementFieldToMatchJa3Fingerprint({
  ...
  factory WebAclRuleStatementByteMatchStatementFieldToMatchJa3Fingerprint.fromMap(Map<String, dynamic> map) {
