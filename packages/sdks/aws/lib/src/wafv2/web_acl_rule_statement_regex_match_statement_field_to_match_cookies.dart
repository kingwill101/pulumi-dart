...
class WebAclRuleStatementRegexMatchStatementFieldToMatchCookies {
  ...
  factory WebAclRuleStatementRegexMatchStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementRegexMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(pulumi.Input.decodeList<WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns']!, (value) => WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>()))),
