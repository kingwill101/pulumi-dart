...
class RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies {
  ...
  factory RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies.fromMap(
    ...
    return RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(
        ...
        >(
          map['matchPatterns']!,
          (value) =>
              RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern.fromMap(
