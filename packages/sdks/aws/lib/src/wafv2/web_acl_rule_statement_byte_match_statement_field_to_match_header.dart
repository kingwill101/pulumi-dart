...
class WebAclRuleStatementByteMatchStatementFieldToMatchHeader {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPattern': pulumi.Input.mapInputValue<WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern, Map<String, dynamic>>(matchPattern, (value) => value.toMap()),
  ...
  factory WebAclRuleStatementByteMatchStatementFieldToMatchHeader.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementByteMatchStatementFieldToMatchHeader(
      matchPattern: pulumi.Input.fromValue(WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern.fromMap((map['matchPattern']! as Map).cast<String, dynamic>())),
