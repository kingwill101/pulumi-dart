...
class RuleGroup extends pulumi.CustomResource {
  ...
  RuleGroup(
    ...
    this.customResponseBodies = registerOutput<List<RuleGroupCustomResponseBody>?>('customResponseBodies');
    ...
    this.visibilityConfig = registerOutput<RuleGroupVisibilityConfig>('visibilityConfig');
  }
