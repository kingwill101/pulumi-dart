...
class WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUse {
  ...
  factory WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUse.fromMap(Map<String, dynamic> map) {
    return WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUse(
      allow: map['allow'] == null ? null : ((WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseAllow.fromMap((map['allow']! as Map).cast<String, dynamic>())).input()).input(),
      block: map['block'] == null ? null : ((WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseBlock.fromMap((map['block']! as Map).cast<String, dynamic>())).input()).input(),
      captcha: map['captcha'] == null ? null : ((WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseCaptcha.fromMap((map['captcha']! as Map).cast<String, dynamic>())).input()).input(),
      challenge: map['challenge'] == null ? null : ((WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseChallenge.fromMap((map['challenge']! as Map).cast<String, dynamic>())).input()).input(),
      count: map['count'] == null ? null : ((WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseCount.fromMap((map['count']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
