...
class RuleGroupRuleStatementSqliMatchStatementTextTransformation {
  ...
  /// Creates a new [RuleGroupRuleStatementSqliMatchStatementTextTransformation].
  ...
  const RuleGroupRuleStatementSqliMatchStatementTextTransformation({
  ...
  factory RuleGroupRuleStatementSqliMatchStatementTextTransformation.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSqliMatchStatementTextTransformation(
