...
class WebAclRuleStatementRateBasedStatementCustomKeyCookie {
  ...
  final pulumi.Input<
    List<WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformation>
  >
  textTransformations;
    ...
    return WebAclRuleStatementRateBasedStatementCustomKeyCookie(
      ...
      textTransformations: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformation.fromMap(
