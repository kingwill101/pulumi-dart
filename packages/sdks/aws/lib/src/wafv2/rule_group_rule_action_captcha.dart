...
class RuleGroupRuleActionCaptcha {
  ...
  factory RuleGroupRuleActionCaptcha.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleActionCaptcha(
      customRequestHandling: (() { final guardedValue = map['customRequestHandling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleGroupRuleActionCaptchaCustomRequestHandling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
