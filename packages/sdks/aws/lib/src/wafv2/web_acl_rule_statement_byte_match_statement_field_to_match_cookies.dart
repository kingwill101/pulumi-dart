...
import 'web_acl_rule_statement_byte_match_statement_field_to_match_cookies_match_pattern.dart';
...
class WebAclRuleStatementByteMatchStatementFieldToMatchCookies {
  ...
  final pulumi.Input<List<WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern>> matchPatterns;
  ...
  /// Creates a new [WebAclRuleStatementByteMatchStatementFieldToMatchCookies].
  ...
  const WebAclRuleStatementByteMatchStatementFieldToMatchCookies({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPatterns': pulumi.Input.mapInputValue<List<WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern>, List<Map<String, dynamic>>>(matchPatterns, (value) => pulumi.Input.encodeList<WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory WebAclRuleStatementByteMatchStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementByteMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(pulumi.Input.decodeList<WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns']!, (value) => WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>()))),
