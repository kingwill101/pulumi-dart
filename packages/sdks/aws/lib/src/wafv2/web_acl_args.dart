...
class WebAclArgs {
  ...
  WebAclArgs({
    ...
    required pulumi.Output<WebAclVisibilityConfig> visibilityConfig,
  }) :
      ...
      visibilityConfig = pulumi.Input.asInput<WebAclVisibilityConfig>(visibilityConfig);
  ...
  factory WebAclArgs.fromMap(Map<String, dynamic> map) {
    return WebAclArgs(
      ...
      visibilityConfig: pulumi.Output.create<WebAclVisibilityConfig>(WebAclVisibilityConfig.fromMap((map['visibilityConfig'] as Map).cast<String, dynamic>())),
    );
  }
}
