...
class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody {
  ...
  final pulumi.Input<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
  ...
  const RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchPattern': pulumi.Input.mapInputValue<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern, Map<String, dynamic>>(matchPattern, (value) => value.toMap()),
      'matchScope': matchScope,
      'oversizeHandling': ?oversizeHandling,
    };
  }

  factory RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody(
      ...
      matchPattern: pulumi.Input.fromValue(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern.fromMap((map['matchPattern']! as Map).cast<String, dynamic>())),
