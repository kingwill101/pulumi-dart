...
class WebAclLoggingConfigurationLoggingFilter {
  ...
  factory WebAclLoggingConfigurationLoggingFilter.fromMap(Map<String, dynamic> map) {
    return WebAclLoggingConfigurationLoggingFilter(
      ...
      filters: pulumi.Input.fromValue(pulumi.Input.decodeList<WebAclLoggingConfigurationLoggingFilterFilter>(map['filters']!, (value) => WebAclLoggingConfigurationLoggingFilterFilter.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
