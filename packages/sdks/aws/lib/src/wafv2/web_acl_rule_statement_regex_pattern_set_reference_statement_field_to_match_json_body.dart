...
import 'web_acl_rule_statement_regex_pattern_set_reference_statement_field_to_match_json_body_match_pattern.dart';
...
class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody {
  ...
  final pulumi.Input<WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPattern?>? matchPattern;
  ...
  /// Creates a new [WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody].
  ...
  const WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchPattern': ?pulumi.Input.mapOptionalInputValue<WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPattern, Map<String, dynamic>>(matchPattern, (value) => value.toMap()),
      'matchScope': matchScope,
      'oversizeHandling': ?oversizeHandling,
    };
  }

  factory WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody.fromMap(Map<String, dynamic> map) {
    return WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody(
      ...
      matchPattern: (() { final guardedValue = map['matchPattern']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPattern.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
