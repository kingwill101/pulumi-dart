...
class WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUse {
  ...
  factory WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUse.fromMap(Map<String, dynamic> map) {
    return WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUse(
      allow: map['allow'] == null ? null : ((WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUseAllow.fromMap((map['allow']! as Map).cast<String, dynamic>())).input()).input(),
      block: map['block'] == null ? null : ((WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUseBlock.fromMap((map['block']! as Map).cast<String, dynamic>())).input()).input(),
      captcha: map['captcha'] == null ? null : ((WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUseCaptcha.fromMap((map['captcha']! as Map).cast<String, dynamic>())).input()).input(),
      challenge: map['challenge'] == null ? null : ((WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUseChallenge.fromMap((map['challenge']! as Map).cast<String, dynamic>())).input()).input(),
      count: map['count'] == null ? null : ((WebAclRuleGroupAssociationManagedRuleGroupRuleActionOverrideActionToUseCount.fromMap((map['count']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
