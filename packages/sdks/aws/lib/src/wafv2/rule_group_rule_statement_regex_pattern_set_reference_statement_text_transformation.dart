...
class RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformation {
  ...
  /// Creates a new [RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformation].
  ...
  const RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformation({
  ...
  factory RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformation.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformation(
