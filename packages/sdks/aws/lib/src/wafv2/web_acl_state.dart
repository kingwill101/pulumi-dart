...
class WebAclState {
  ...
  factory WebAclState.fromMap(Map<String, dynamic> map) {
    return WebAclState(
      applicationIntegrationUrl: (() { final guardedValue = map['applicationIntegrationUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      defaultAction: (() { final guardedValue = map['defaultAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAclDefaultAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      visibilityConfig: (() { final guardedValue = map['visibilityConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAclVisibilityConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
