...
class WebAclState {
  ...
  factory WebAclState.fromMap(Map<String, dynamic> map) {
    return WebAclState(
      applicationIntegrationUrl: map['applicationIntegrationUrl'] == null ? null : ((map['applicationIntegrationUrl'] as String).input()).input(),
      ...
      visibilityConfig: map['visibilityConfig'] == null ? null : ((WebAclVisibilityConfig.fromMap((map['visibilityConfig']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
