...
class RuleGroupRuleStatementGeoMatchStatement {
  ...
  final RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig? forwardedIpConfig;
  ...
  factory RuleGroupRuleStatementGeoMatchStatement.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementGeoMatchStatement(
      ...
      forwardedIpConfig: map['forwardedIpConfig'] == null ? null : RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig.fromMap((map['forwardedIpConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
