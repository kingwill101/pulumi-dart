...
class RuleGroupRuleStatementGeoMatchStatement {
  ...
  final pulumi.Input<RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig>? forwardedIpConfig;
  ...
  const RuleGroupRuleStatementGeoMatchStatement({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'forwardedIpConfig': ?pulumi.Input.mapOptionalInputValue<RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig, Map<String, dynamic>>(forwardedIpConfig, (value) => value.toMap()),
    };
  }
  ...
  factory RuleGroupRuleStatementGeoMatchStatement.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementGeoMatchStatement(
      ...
      forwardedIpConfig: (() { final guardedValue = map['forwardedIpConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleGroupRuleStatementGeoMatchStatementForwardedIpConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
