...
class RuleGroupRuleStatementIpSetReferenceStatement {
  ...
  final RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig? ipSetForwardedIpConfig;
  ...
  factory RuleGroupRuleStatementIpSetReferenceStatement.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementIpSetReferenceStatement(
      ...
      ipSetForwardedIpConfig: map['ipSetForwardedIpConfig'] == null ? null : RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig.fromMap((map['ipSetForwardedIpConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
