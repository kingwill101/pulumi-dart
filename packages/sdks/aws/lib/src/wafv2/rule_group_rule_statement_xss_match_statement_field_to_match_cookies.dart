...
import 'rule_group_rule_statement_xss_match_statement_field_to_match_cookies_match_pattern.dart';

class RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies {
  ...
  final pulumi.Input<List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern>> matchPatterns;
  ...
  /// Creates a new [RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies].
  ...
  const RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matchPatterns': pulumi.Input.mapInputValue<List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern>, List<Map<String, dynamic>>>(matchPatterns, (value) => pulumi.Input.encodeList<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern, Map<String, dynamic>>(value, (value) => value.toMap())),
      'matchScope': matchScope,
      'oversizeHandling': oversizeHandling,
    };
  }

  factory RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(pulumi.Input.decodeList<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern>(map['matchPatterns']!, (value) => RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern.fromMap((value as Map).cast<String, dynamic>()))),
