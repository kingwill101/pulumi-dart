...
class RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies {
  ...
  final pulumi.Input<
    List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern>
  >
  matchPatterns;
  ...
  factory RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies.fromMap(
    ...
    return RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies(
      matchPatterns: pulumi.Input.fromValue(
        ...
        >(
          map['matchPatterns']!,
          (value) =>
              RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern.fromMap(
