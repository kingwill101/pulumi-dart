...
class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa4Fingerprint {
  ...
  /// Creates a new [RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa4Fingerprint].
  ...
  const RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa4Fingerprint({
  ...
  factory RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa4Fingerprint.fromMap(Map<String, dynamic> map) {
