...
class RuleGroupRuleStatementXssMatchStatementFieldToMatch {
  ...
  final pulumi.Input<RuleGroupRuleStatementXssMatchStatementFieldToMatchBody>?
  body;
  ...
  final pulumi.Input<
    List<RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderOrder>
  >?
  headerOrders;

  /// Inspect the request headers. See Headers below for details.
  final pulumi.Input<
    List<RuleGroupRuleStatementXssMatchStatementFieldToMatchHeader>
  >?
  headers;
