...
class WebAclRuleStatementRegexPatternSetReferenceStatementTextTransformation {
  ...
  const WebAclRuleStatementRegexPatternSetReferenceStatementTextTransformation({
  ...
  factory WebAclRuleStatementRegexPatternSetReferenceStatementTextTransformation.fromMap(Map<String, dynamic> map) {
