...
class RuleGroupRuleStatementRateBasedStatementCustomKeyHeader {
  ...
  const RuleGroupRuleStatementRateBasedStatementCustomKeyHeader({
    required this.name,
  ...
  factory RuleGroupRuleStatementRateBasedStatementCustomKeyHeader.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRateBasedStatementCustomKeyHeader(
      ...
      textTransformations: pulumi.Input.fromValue(pulumi.Input.decodeList<RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation>(map['textTransformations']!, (value) => RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
