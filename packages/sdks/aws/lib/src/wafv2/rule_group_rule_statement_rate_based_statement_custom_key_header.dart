...
class RuleGroupRuleStatementRateBasedStatementCustomKeyHeader {
  ...
  factory RuleGroupRuleStatementRateBasedStatementCustomKeyHeader.fromMap(
    ...
    return RuleGroupRuleStatementRateBasedStatementCustomKeyHeader(
      ...
      textTransformations: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation.fromMap(
