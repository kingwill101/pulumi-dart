...
class RuleGroupRuleStatementSqliMatchStatementFieldToMatchUriFragment {
  ...
  const RuleGroupRuleStatementSqliMatchStatementFieldToMatchUriFragment({
  ...
  factory RuleGroupRuleStatementSqliMatchStatementFieldToMatchUriFragment.fromMap(Map<String, dynamic> map) {
