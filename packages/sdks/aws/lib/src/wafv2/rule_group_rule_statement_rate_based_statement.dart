...
class RuleGroupRuleStatementRateBasedStatement {
  ...
  final RuleGroupRuleStatementRateBasedStatementForwardedIpConfig? forwardedIpConfig;
  ...
  final RuleGroupRuleStatementRateBasedStatementScopeDownStatement? scopeDownStatement;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customKeys': ?customKeys == null ? null : pulumi.Input.encodeList<RuleGroupRuleStatementRateBasedStatementCustomKey, Map<String, dynamic>>(customKeys!, (value) => value.toMap()),
  ...
  factory RuleGroupRuleStatementRateBasedStatement.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleStatementRateBasedStatement(
      aggregateKeyType: map['aggregateKeyType'] == null ? null : map['aggregateKeyType'] as String,
      customKeys: map['customKeys'] == null ? null : pulumi.Input.decodeList<RuleGroupRuleStatementRateBasedStatementCustomKey>(map['customKeys'], (value) => RuleGroupRuleStatementRateBasedStatementCustomKey.fromMap((value as Map).cast<String, dynamic>())),
      evaluationWindowSec: map['evaluationWindowSec'] == null ? null : map['evaluationWindowSec'] as int,
      forwardedIpConfig: map['forwardedIpConfig'] == null ? null : RuleGroupRuleStatementRateBasedStatementForwardedIpConfig.fromMap((map['forwardedIpConfig'] as Map).cast<String, dynamic>()),
      limit: map['limit'] as int,
      scopeDownStatement: map['scopeDownStatement'] == null ? null : RuleGroupRuleStatementRateBasedStatementScopeDownStatement.fromMap((map['scopeDownStatement'] as Map).cast<String, dynamic>()),
    );
  }
}
