...
class RuleGroupRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'priority': priority,
      'ruleLabels': ?ruleLabels == null ? null : pulumi.Input.encodeList<RuleGroupRuleRuleLabel, Map<String, dynamic>>(ruleLabels!, (value) => value.toMap()),
  ...
  factory RuleGroupRule.fromMap(Map<String, dynamic> map) {
    return RuleGroupRule(
      action: RuleGroupRuleAction.fromMap((map['action'] as Map).cast<String, dynamic>()),
      captchaConfig: map['captchaConfig'] == null ? null : RuleGroupRuleCaptchaConfig.fromMap((map['captchaConfig'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      priority: map['priority'] as int,
      ruleLabels: map['ruleLabels'] == null ? null : pulumi.Input.decodeList<RuleGroupRuleRuleLabel>(map['ruleLabels'], (value) => RuleGroupRuleRuleLabel.fromMap((value as Map).cast<String, dynamic>())),
      statement: RuleGroupRuleStatement.fromMap((map['statement'] as Map).cast<String, dynamic>()),
      visibilityConfig: RuleGroupRuleVisibilityConfig.fromMap((map['visibilityConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
