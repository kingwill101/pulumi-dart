...
class RuleGroupRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action':
          pulumi.Input.mapInputValue<RuleGroupRuleAction, Map<String, dynamic>>(
            action,
            (value) => value.toMap(),
          ),
      'captchaConfig':
  ...
  factory RuleGroupRule.fromMap(Map<String, dynamic> map) {
    return RuleGroupRule(
      ...
      ruleLabels: (() {
        final guardedValue = map['ruleLabels'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      statement: pulumi.Input.fromValue(
        RuleGroupRuleStatement.fromMap(
          (map['statement']! as Map).cast<String, dynamic>(),
        ),
      ),
      visibilityConfig: pulumi.Input.fromValue(
        RuleGroupRuleVisibilityConfig.fromMap(
