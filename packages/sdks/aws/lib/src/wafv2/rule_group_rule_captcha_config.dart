...
class RuleGroupRuleCaptchaConfig {
  ...
  factory RuleGroupRuleCaptchaConfig.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleCaptchaConfig(
      immunityTimeProperty: (() { final guardedValue = map['immunityTimeProperty']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleGroupRuleCaptchaConfigImmunityTimeProperty.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
