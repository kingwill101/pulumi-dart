  ...
  factory DocumentClassifierArgs.fromMap(Map<String, dynamic> map) {
    return DocumentClassifierArgs(
      ...
      inputDataConfig: pulumi.Input.fromValue(
        DocumentClassifierInputDataConfig.fromMap(
      ...
      modelKmsKeyId: (() {
        final guardedValue = map['modelKmsKeyId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      outputDataConfig: (() {
        final guardedValue = map['outputDataConfig'];
        if (guardedValue == null) return null;
      ...
      versionNamePrefix: (() {
        final guardedValue = map['versionNamePrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      volumeKmsKeyId: (() {
