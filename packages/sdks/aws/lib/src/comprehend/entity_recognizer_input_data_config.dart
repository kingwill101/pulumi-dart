...
class EntityRecognizerInputDataConfig {
  ...
  factory EntityRecognizerInputDataConfig.fromMap(Map<String, dynamic> map) {
    return EntityRecognizerInputDataConfig(
      annotations: (() { final guardedValue = map['annotations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntityRecognizerInputDataConfigAnnotations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      augmentedManifests: (() { final guardedValue = map['augmentedManifests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EntityRecognizerInputDataConfigAugmentedManifest>(guardedValue, (value) => EntityRecognizerInputDataConfigAugmentedManifest.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      documents: (() { final guardedValue = map['documents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntityRecognizerInputDataConfigDocuments.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      entityList: (() { final guardedValue = map['entityList']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EntityRecognizerInputDataConfigEntityList.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      entityTypes: pulumi.Input.fromValue(pulumi.Input.decodeList<EntityRecognizerInputDataConfigEntityType>(map['entityTypes']!, (value) => EntityRecognizerInputDataConfigEntityType.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
