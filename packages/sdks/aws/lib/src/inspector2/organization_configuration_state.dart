...
class OrganizationConfigurationState {
  ...
  factory OrganizationConfigurationState.fromMap(Map<String, dynamic> map) {
    return OrganizationConfigurationState(
      autoEnable: (() { final guardedValue = map['autoEnable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OrganizationConfigurationAutoEnable.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maxAccountLimitReached: (() { final guardedValue = map['maxAccountLimitReached']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
