...
class FilterFilterCriteria {
  ...
  factory FilterFilterCriteria.fromMap(Map<String, dynamic> map) {
    return FilterFilterCriteria(
      awsAccountIds: (() { final guardedValue = map['awsAccountIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaAwsAccountId>(guardedValue, (value) => FilterFilterCriteriaAwsAccountId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      codeRepositoryProjectNames: (() { final guardedValue = map['codeRepositoryProjectNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaCodeRepositoryProjectName>(guardedValue, (value) => FilterFilterCriteriaCodeRepositoryProjectName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      codeRepositoryProviderTypes: (() { final guardedValue = map['codeRepositoryProviderTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaCodeRepositoryProviderType>(guardedValue, (value) => FilterFilterCriteriaCodeRepositoryProviderType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      codeVulnerabilityDetectorNames: (() { final guardedValue = map['codeVulnerabilityDetectorNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaCodeVulnerabilityDetectorName>(guardedValue, (value) => FilterFilterCriteriaCodeVulnerabilityDetectorName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      codeVulnerabilityDetectorTags: (() { final guardedValue = map['codeVulnerabilityDetectorTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaCodeVulnerabilityDetectorTag>(guardedValue, (value) => FilterFilterCriteriaCodeVulnerabilityDetectorTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      codeVulnerabilityFilePaths: (() { final guardedValue = map['codeVulnerabilityFilePaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaCodeVulnerabilityFilePath>(guardedValue, (value) => FilterFilterCriteriaCodeVulnerabilityFilePath.fromMap((value as Map).cast<String, dynamic>()))); })(),
      componentIds: (() { final guardedValue = map['componentIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaComponentId>(guardedValue, (value) => FilterFilterCriteriaComponentId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      componentTypes: (() { final guardedValue = map['componentTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaComponentType>(guardedValue, (value) => FilterFilterCriteriaComponentType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ec2InstanceImageIds: (() { final guardedValue = map['ec2InstanceImageIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEc2InstanceImageId>(guardedValue, (value) => FilterFilterCriteriaEc2InstanceImageId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ec2InstanceSubnetIds: (() { final guardedValue = map['ec2InstanceSubnetIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEc2InstanceSubnetId>(guardedValue, (value) => FilterFilterCriteriaEc2InstanceSubnetId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ec2InstanceVpcIds: (() { final guardedValue = map['ec2InstanceVpcIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEc2InstanceVpcId>(guardedValue, (value) => FilterFilterCriteriaEc2InstanceVpcId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImageArchitectures: (() { final guardedValue = map['ecrImageArchitectures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImageArchitecture>(guardedValue, (value) => FilterFilterCriteriaEcrImageArchitecture.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImageHashes: (() { final guardedValue = map['ecrImageHashes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImageHash>(guardedValue, (value) => FilterFilterCriteriaEcrImageHash.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImageInUseCounts: (() { final guardedValue = map['ecrImageInUseCounts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImageInUseCount>(guardedValue, (value) => FilterFilterCriteriaEcrImageInUseCount.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImageLastInUseAts: (() { final guardedValue = map['ecrImageLastInUseAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImageLastInUseAt>(guardedValue, (value) => FilterFilterCriteriaEcrImageLastInUseAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImagePushedAts: (() { final guardedValue = map['ecrImagePushedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImagePushedAt>(guardedValue, (value) => FilterFilterCriteriaEcrImagePushedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImageRegistries: (() { final guardedValue = map['ecrImageRegistries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImageRegistry>(guardedValue, (value) => FilterFilterCriteriaEcrImageRegistry.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImageRepositoryNames: (() { final guardedValue = map['ecrImageRepositoryNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImageRepositoryName>(guardedValue, (value) => FilterFilterCriteriaEcrImageRepositoryName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ecrImageTags: (() { final guardedValue = map['ecrImageTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEcrImageTag>(guardedValue, (value) => FilterFilterCriteriaEcrImageTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      epssScores: (() { final guardedValue = map['epssScores']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaEpssScore>(guardedValue, (value) => FilterFilterCriteriaEpssScore.fromMap((value as Map).cast<String, dynamic>()))); })(),
      exploitAvailables: (() { final guardedValue = map['exploitAvailables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaExploitAvailable>(guardedValue, (value) => FilterFilterCriteriaExploitAvailable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingArns: (() { final guardedValue = map['findingArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaFindingArn>(guardedValue, (value) => FilterFilterCriteriaFindingArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingStatuses: (() { final guardedValue = map['findingStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaFindingStatus>(guardedValue, (value) => FilterFilterCriteriaFindingStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      findingTypes: (() { final guardedValue = map['findingTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaFindingType>(guardedValue, (value) => FilterFilterCriteriaFindingType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      firstObservedAts: (() { final guardedValue = map['firstObservedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaFirstObservedAt>(guardedValue, (value) => FilterFilterCriteriaFirstObservedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      fixAvailables: (() { final guardedValue = map['fixAvailables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaFixAvailable>(guardedValue, (value) => FilterFilterCriteriaFixAvailable.fromMap((value as Map).cast<String, dynamic>()))); })(),
      inspectorScores: (() { final guardedValue = map['inspectorScores']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaInspectorScore>(guardedValue, (value) => FilterFilterCriteriaInspectorScore.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lambdaFunctionExecutionRoleArns: (() { final guardedValue = map['lambdaFunctionExecutionRoleArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaLambdaFunctionExecutionRoleArn>(guardedValue, (value) => FilterFilterCriteriaLambdaFunctionExecutionRoleArn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lambdaFunctionLastModifiedAts: (() { final guardedValue = map['lambdaFunctionLastModifiedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaLambdaFunctionLastModifiedAt>(guardedValue, (value) => FilterFilterCriteriaLambdaFunctionLastModifiedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lambdaFunctionLayers: (() { final guardedValue = map['lambdaFunctionLayers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaLambdaFunctionLayer>(guardedValue, (value) => FilterFilterCriteriaLambdaFunctionLayer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lambdaFunctionNames: (() { final guardedValue = map['lambdaFunctionNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaLambdaFunctionName>(guardedValue, (value) => FilterFilterCriteriaLambdaFunctionName.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lambdaFunctionRuntimes: (() { final guardedValue = map['lambdaFunctionRuntimes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaLambdaFunctionRuntime>(guardedValue, (value) => FilterFilterCriteriaLambdaFunctionRuntime.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lastObservedAts: (() { final guardedValue = map['lastObservedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaLastObservedAt>(guardedValue, (value) => FilterFilterCriteriaLastObservedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkProtocols: (() { final guardedValue = map['networkProtocols']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaNetworkProtocol>(guardedValue, (value) => FilterFilterCriteriaNetworkProtocol.fromMap((value as Map).cast<String, dynamic>()))); })(),
      portRanges: (() { final guardedValue = map['portRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaPortRange>(guardedValue, (value) => FilterFilterCriteriaPortRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      relatedVulnerabilities: (() { final guardedValue = map['relatedVulnerabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaRelatedVulnerability>(guardedValue, (value) => FilterFilterCriteriaRelatedVulnerability.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceIds: (() { final guardedValue = map['resourceIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaResourceId>(guardedValue, (value) => FilterFilterCriteriaResourceId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceTags: (() { final guardedValue = map['resourceTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaResourceTag>(guardedValue, (value) => FilterFilterCriteriaResourceTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      resourceTypes: (() { final guardedValue = map['resourceTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaResourceType>(guardedValue, (value) => FilterFilterCriteriaResourceType.fromMap((value as Map).cast<String, dynamic>()))); })(),
      severities: (() { final guardedValue = map['severities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaSeverity>(guardedValue, (value) => FilterFilterCriteriaSeverity.fromMap((value as Map).cast<String, dynamic>()))); })(),
      titles: (() { final guardedValue = map['titles']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaTitle>(guardedValue, (value) => FilterFilterCriteriaTitle.fromMap((value as Map).cast<String, dynamic>()))); })(),
      updatedAts: (() { final guardedValue = map['updatedAts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaUpdatedAt>(guardedValue, (value) => FilterFilterCriteriaUpdatedAt.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vendorSeverities: (() { final guardedValue = map['vendorSeverities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaVendorSeverity>(guardedValue, (value) => FilterFilterCriteriaVendorSeverity.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vulnerabilityIds: (() { final guardedValue = map['vulnerabilityIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaVulnerabilityId>(guardedValue, (value) => FilterFilterCriteriaVulnerabilityId.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vulnerabilitySources: (() { final guardedValue = map['vulnerabilitySources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaVulnerabilitySource>(guardedValue, (value) => FilterFilterCriteriaVulnerabilitySource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vulnerablePackages: (() { final guardedValue = map['vulnerablePackages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FilterFilterCriteriaVulnerablePackage>(guardedValue, (value) => FilterFilterCriteriaVulnerablePackage.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
