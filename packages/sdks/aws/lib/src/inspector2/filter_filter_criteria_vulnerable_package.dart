...
class FilterFilterCriteriaVulnerablePackage {
  ...
  final pulumi.Input<FilterFilterCriteriaVulnerablePackageArchitecture>?
  architecture;
  ...
  final pulumi.Input<FilterFilterCriteriaVulnerablePackageSourceLambdaLayerArn>?
  sourceLambdaLayerArn;

  /// (Optional) The source layer hash of the package. Documented below.
  final pulumi.Input<FilterFilterCriteriaVulnerablePackageSourceLayerHash>?
  sourceLayerHash;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'epoches':
          ?pulumi.Input.mapOptionalInputValue<
            List<FilterFilterCriteriaVulnerablePackageEpoch>,
  ...
  factory FilterFilterCriteriaVulnerablePackage.fromMap(
    ...
    return FilterFilterCriteriaVulnerablePackage(
      ...
      epoches: (() {
        final guardedValue = map['epoches'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceLambdaLayerArn: (() {
        final guardedValue = map['sourceLambdaLayerArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceLayerHash: (() {
        final guardedValue = map['sourceLayerHash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
