...
class FilterState {
  ...
  factory FilterState.fromMap(Map<String, dynamic> map) {
    return FilterState(
      ...
      filterCriterias: map['filterCriterias'] == null ? null : (pulumi.Input.decodeList<FilterFilterCriteria>(map['filterCriterias'], (value) => FilterFilterCriteria.fromMap((value as Map).cast<String, dynamic>()))).input(),
