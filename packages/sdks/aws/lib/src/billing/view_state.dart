...
class ViewState {
  ...
  factory ViewState.fromMap(Map<String, dynamic> map) {
    return ViewState(
      ...
      viewDefinitionLastUpdatedAt: (() { final guardedValue = map['viewDefinitionLastUpdatedAt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
