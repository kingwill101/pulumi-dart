...
class PortfolioShareArgs {
  ...
  factory PortfolioShareArgs.fromMap(Map<String, dynamic> map) {
    return PortfolioShareArgs(
      ...
      sharePrincipals: (() { final guardedValue = map['sharePrincipals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      shareTagOptions: (() { final guardedValue = map['shareTagOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      type: pulumi.Input.fromValue(map['type'] as String),
      waitForAcceptance: (() { final guardedValue = map['waitForAcceptance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
