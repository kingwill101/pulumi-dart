...
import 'tag_option_resource_association_state.dart';
...
/// }
///
/// resource "aws_servicecatalog_tagoptionresourceassociation" "example" {
///   resource_id   = "prod-dnigbtea24ste"
///   tag_option_id = "tag-pjtvyakdlyo3m"
/// }
/// ```
...
class TagOptionResourceAssociation extends pulumi.CustomResource {
  ...
  static TagOptionResourceAssociation get(
    String name,
  ...
  TagOptionResourceAssociation._get(
    String name, {
