...
class GetPortfolioConstraintsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'details': ?(() { final guardedValue = details; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetPortfolioConstraintsDetail, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': ?id,
  ...
  factory GetPortfolioConstraintsResult.fromMap(Map<String, dynamic> map) {
    return GetPortfolioConstraintsResult(
      ...
      details: (() { final guardedValue = map['details']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetPortfolioConstraintsDetail>(guardedValue, (value) => GetPortfolioConstraintsDetail.fromMap((value as Map).cast<String, dynamic>())); })(),
