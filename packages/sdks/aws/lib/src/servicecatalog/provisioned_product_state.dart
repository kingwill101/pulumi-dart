...
class ProvisionedProductState {
  ...
  factory ProvisionedProductState.fromMap(Map<String, dynamic> map) {
    return ProvisionedProductState(
      ...
      cloudwatchDashboardNames: map['cloudwatchDashboardNames'] == null ? null : (((map['cloudwatchDashboardNames'] as List).cast<String>()).input()).input(),
      ...
      lastProvisioningRecordId: map['lastProvisioningRecordId'] == null ? null : ((map['lastProvisioningRecordId'] as String).input()).input(),
      lastRecordId: map['lastRecordId'] == null ? null : ((map['lastRecordId'] as String).input()).input(),
      lastSuccessfulProvisioningRecordId: map['lastSuccessfulProvisioningRecordId'] == null ? null : ((map['lastSuccessfulProvisioningRecordId'] as String).input()).input(),
      launchRoleArn: map['launchRoleArn'] == null ? null : ((map['launchRoleArn'] as String).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      notificationArns: map['notificationArns'] == null ? null : (((map['notificationArns'] as List).cast<String>()).input()).input(),
      outputs: map['outputs'] == null ? null : ((pulumi.Input.decodeList<ProvisionedProductOutput>(map['outputs']!, (value) => ProvisionedProductOutput.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
