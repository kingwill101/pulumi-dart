...
class FlowDestinationFlowConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinationConnectorProperties': pulumi.Input.mapInputValue<FlowDestinationFlowConfigDestinationConnectorProperties, Map<String, dynamic>>(destinationConnectorProperties, (value) => value.toMap()),
    };
  }
