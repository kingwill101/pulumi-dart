...
class FlowTask {
  ...
  factory FlowTask.fromMap(Map<String, dynamic> map) {
    return FlowTask(
      connectorOperators: (() { final guardedValue = map['connectorOperators']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FlowTaskConnectorOperator>(guardedValue, (value) => FlowTaskConnectorOperator.fromMap((value as Map).cast<String, dynamic>()))); })(),
      destinationField: (() { final guardedValue = map['destinationField']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sourceFields: (() { final guardedValue = map['sourceFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      taskProperties: (() { final guardedValue = map['taskProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
