...
class FlowTask {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectorOperators': ?connectorOperators == null ? null : pulumi.Input.encodeList<FlowTaskConnectorOperator, Map<String, dynamic>>(connectorOperators!, (value) => value.toMap()),
  ...
  factory FlowTask.fromMap(Map<String, dynamic> map) {
    return FlowTask(
      connectorOperators: map['connectorOperators'] == null ? null : pulumi.Input.decodeList<FlowTaskConnectorOperator>(map['connectorOperators'], (value) => FlowTaskConnectorOperator.fromMap((value as Map).cast<String, dynamic>())),
      destinationField: map['destinationField'] == null ? null : map['destinationField'] as String,
      sourceFields: map['sourceFields'] == null ? null : (map['sourceFields'] as List).cast<String>(),
      taskProperties: map['taskProperties'] == null ? null : (map['taskProperties'] as Map).cast<String, String>(),
