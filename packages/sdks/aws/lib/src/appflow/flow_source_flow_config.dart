...
class FlowSourceFlowConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'incrementalPullConfig': ?incrementalPullConfig == null ? null : incrementalPullConfig!.toMap(),
      'sourceConnectorProperties': sourceConnectorProperties.toMap(),
    };
  }
  ...
  factory FlowSourceFlowConfig.fromMap(Map<String, dynamic> map) {
    return FlowSourceFlowConfig(
      ...
      connectorProfileName: map['connectorProfileName'] == null ? null : map['connectorProfileName'] as String,
      connectorType: map['connectorType'] as String,
      incrementalPullConfig: map['incrementalPullConfig'] == null ? null : FlowSourceFlowConfigIncrementalPullConfig.fromMap((map['incrementalPullConfig'] as Map).cast<String, dynamic>()),
      sourceConnectorProperties: FlowSourceFlowConfigSourceConnectorProperties.fromMap((map['sourceConnectorProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
