...
class FlowSourceFlowConfig {
  ...
  final pulumi.Input<FlowSourceFlowConfigIncrementalPullConfig>?
  incrementalPullConfig;

  /// Information that is required to query a particular source connector. See Source Connector Properties for details.
  final pulumi.Input<FlowSourceFlowConfigSourceConnectorProperties>
    ...
    return <String, dynamic>{
      ...
      'incrementalPullConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(incrementalPullConfig, (value) => value.toMap()),
      'sourceConnectorProperties':
          pulumi.Input.mapInputValue<
            FlowSourceFlowConfigSourceConnectorProperties,
            Map<String, dynamic>
          >(sourceConnectorProperties, (value) => value.toMap()),
    };
  }
  ...
  factory FlowSourceFlowConfig.fromMap(Map<String, dynamic> map) {
    return FlowSourceFlowConfig(
      ...
      incrementalPullConfig: (() {
        final guardedValue = map['incrementalPullConfig'];
        if (guardedValue == null) return null;
      ...
      sourceConnectorProperties: pulumi.Input.fromValue(
        FlowSourceFlowConfigSourceConnectorProperties.fromMap(
          (map['sourceConnectorProperties']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
