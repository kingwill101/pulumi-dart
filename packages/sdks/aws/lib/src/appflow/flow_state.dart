...
class FlowState {
  ...
  factory FlowState.fromMap(Map<String, dynamic> map) {
    return FlowState(
      ...
      destinationFlowConfigs: (() {
        final guardedValue = map['destinationFlowConfigs'];
        if (guardedValue == null) return null;
      ...
      flowStatus: (() {
        final guardedValue = map['flowStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kmsArn: (() {
        final guardedValue = map['kmsArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      metadataCatalogConfig: (() {
        final guardedValue = map['metadataCatalogConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceFlowConfig: (() {
        final guardedValue = map['sourceFlowConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowSourceFlowConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      tasks: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FlowTask>(
            guardedValue,
