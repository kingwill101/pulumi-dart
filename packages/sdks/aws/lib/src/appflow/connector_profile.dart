...
import 'connector_profile_state.dart';
...
class ConnectorProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ConnectorProfileConnectorProfileConfig> connectorProfileConfig;
  ...
  /// Creates a new [ConnectorProfile].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ConnectorProfile]. {@macro pulumi_appflow_connector_profile_connector_profile_args_doc}
  ...
  ConnectorProfile(
    ...
    this.connectorProfileConfig = registerOutput<ConnectorProfileConnectorProfileConfig>('connectorProfileConfig');
  ...
  /// Gets an existing [ConnectorProfile] resource's state with the given [name] and [id].
  static ConnectorProfile get(
    String name,
