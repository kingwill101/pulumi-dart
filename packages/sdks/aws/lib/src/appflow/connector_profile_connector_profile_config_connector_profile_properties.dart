...
class ConnectorProfileConnectorProfileConfigConnectorProfileProperties {
  ...
  factory ConnectorProfileConnectorProfileConfigConnectorProfileProperties.fromMap(Map<String, dynamic> map) {
    return ConnectorProfileConnectorProfileConfigConnectorProfileProperties(
      amplitude: map['amplitude'] == null ? null : (((map['amplitude'] as Map).cast<String, dynamic>()).input()).input(),
      customConnector: map['customConnector'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesCustomConnector.fromMap((map['customConnector']! as Map).cast<String, dynamic>())).input()).input(),
      datadog: map['datadog'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesDatadog.fromMap((map['datadog']! as Map).cast<String, dynamic>())).input()).input(),
      dynatrace: map['dynatrace'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesDynatrace.fromMap((map['dynatrace']! as Map).cast<String, dynamic>())).input()).input(),
      googleAnalytics: map['googleAnalytics'] == null ? null : (((map['googleAnalytics'] as Map).cast<String, dynamic>()).input()).input(),
      honeycode: map['honeycode'] == null ? null : (((map['honeycode'] as Map).cast<String, dynamic>()).input()).input(),
      inforNexus: map['inforNexus'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesInforNexus.fromMap((map['inforNexus']! as Map).cast<String, dynamic>())).input()).input(),
      marketo: map['marketo'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesMarketo.fromMap((map['marketo']! as Map).cast<String, dynamic>())).input()).input(),
      redshift: map['redshift'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesRedshift.fromMap((map['redshift']! as Map).cast<String, dynamic>())).input()).input(),
      salesforce: map['salesforce'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSalesforce.fromMap((map['salesforce']! as Map).cast<String, dynamic>())).input()).input(),
      sapoData: map['sapoData'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoData.fromMap((map['sapoData']! as Map).cast<String, dynamic>())).input()).input(),
      serviceNow: map['serviceNow'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesServiceNow.fromMap((map['serviceNow']! as Map).cast<String, dynamic>())).input()).input(),
      singular: map['singular'] == null ? null : (((map['singular'] as Map).cast<String, dynamic>()).input()).input(),
      slack: map['slack'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSlack.fromMap((map['slack']! as Map).cast<String, dynamic>())).input()).input(),
      snowflake: map['snowflake'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSnowflake.fromMap((map['snowflake']! as Map).cast<String, dynamic>())).input()).input(),
      trendmicro: map['trendmicro'] == null ? null : (((map['trendmicro'] as Map).cast<String, dynamic>()).input()).input(),
      veeva: map['veeva'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesVeeva.fromMap((map['veeva']! as Map).cast<String, dynamic>())).input()).input(),
      zendesk: map['zendesk'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesZendesk.fromMap((map['zendesk']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
