...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentials {
  ...
  factory ConnectorProfileConnectorProfileConfigConnectorProfileCredentials.fromMap(Map<String, dynamic> map) {
    return ConnectorProfileConnectorProfileConfigConnectorProfileCredentials(
      amplitude: map['amplitude'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsAmplitude.fromMap((map['amplitude']! as Map).cast<String, dynamic>())).input()).input(),
      customConnector: map['customConnector'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnector.fromMap((map['customConnector']! as Map).cast<String, dynamic>())).input()).input(),
      datadog: map['datadog'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsDatadog.fromMap((map['datadog']! as Map).cast<String, dynamic>())).input()).input(),
      dynatrace: map['dynatrace'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsDynatrace.fromMap((map['dynatrace']! as Map).cast<String, dynamic>())).input()).input(),
      googleAnalytics: map['googleAnalytics'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsGoogleAnalytics.fromMap((map['googleAnalytics']! as Map).cast<String, dynamic>())).input()).input(),
      honeycode: map['honeycode'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsHoneycode.fromMap((map['honeycode']! as Map).cast<String, dynamic>())).input()).input(),
      inforNexus: map['inforNexus'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsInforNexus.fromMap((map['inforNexus']! as Map).cast<String, dynamic>())).input()).input(),
      marketo: map['marketo'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsMarketo.fromMap((map['marketo']! as Map).cast<String, dynamic>())).input()).input(),
      redshift: map['redshift'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsRedshift.fromMap((map['redshift']! as Map).cast<String, dynamic>())).input()).input(),
      salesforce: map['salesforce'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforce.fromMap((map['salesforce']! as Map).cast<String, dynamic>())).input()).input(),
      sapoData: map['sapoData'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSapoData.fromMap((map['sapoData']! as Map).cast<String, dynamic>())).input()).input(),
      serviceNow: map['serviceNow'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsServiceNow.fromMap((map['serviceNow']! as Map).cast<String, dynamic>())).input()).input(),
      singular: map['singular'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSingular.fromMap((map['singular']! as Map).cast<String, dynamic>())).input()).input(),
      slack: map['slack'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSlack.fromMap((map['slack']! as Map).cast<String, dynamic>())).input()).input(),
      snowflake: map['snowflake'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSnowflake.fromMap((map['snowflake']! as Map).cast<String, dynamic>())).input()).input(),
      trendmicro: map['trendmicro'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsTrendmicro.fromMap((map['trendmicro']! as Map).cast<String, dynamic>())).input()).input(),
      veeva: map['veeva'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsVeeva.fromMap((map['veeva']! as Map).cast<String, dynamic>())).input()).input(),
      zendesk: map['zendesk'] == null ? null : ((ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendesk.fromMap((map['zendesk']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
