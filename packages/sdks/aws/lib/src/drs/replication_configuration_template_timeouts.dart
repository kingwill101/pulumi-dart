...
class ReplicationConfigurationTemplateTimeouts {
  ...
  /// Creates a new [ReplicationConfigurationTemplateTimeouts].
  ...
  const ReplicationConfigurationTemplateTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory ReplicationConfigurationTemplateTimeouts.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigurationTemplateTimeouts(
