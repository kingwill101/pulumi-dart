...
class ReplicationConfigurationTemplate extends pulumi.CustomResource {
  ...
  ReplicationConfigurationTemplate(
    ...
    this.associateDefaultSecurityGroup = registerOutput<bool>('associateDefaultSecurityGroup');
    ...
    this.defaultLargeStagingDiskType = registerOutput<String>('defaultLargeStagingDiskType');
    this.ebsEncryption = registerOutput<String>('ebsEncryption');
    this.ebsEncryptionKeyArn = registerOutput<String?>('ebsEncryptionKeyArn');
    this.pitPolicies = registerOutput<List<ReplicationConfigurationTemplatePitPolicy>?>('pitPolicies');
    this.region = registerOutput<String>('region');
    this.replicationServerInstanceType = registerOutput<String>('replicationServerInstanceType');
    this.replicationServersSecurityGroupsIds = registerOutput<List<String>>('replicationServersSecurityGroupsIds');
    this.stagingAreaSubnetId = registerOutput<String>('stagingAreaSubnetId');
    this.stagingAreaTags = registerOutput<Map<String, String>>('stagingAreaTags');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.timeouts = registerOutput<ReplicationConfigurationTemplateTimeouts?>('timeouts');
    this.useDedicatedReplicationServer = registerOutput<bool>('useDedicatedReplicationServer');
  }

  /// Gets an existing [ReplicationConfigurationTemplate] resource's state with the given [name] and [id].
  static ReplicationConfigurationTemplate get(
    String name,
  ...
  ReplicationConfigurationTemplate._get(
    String name, {
