...
class ReplicationConfigurationTemplateState {
  ...
  factory ReplicationConfigurationTemplateState.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigurationTemplateState(
      ...
      bandwidthThrottling: (() { final guardedValue = map['bandwidthThrottling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      ebsEncryption: (() { final guardedValue = map['ebsEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      replicationServerInstanceType: (() { final guardedValue = map['replicationServerInstanceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replicationServersSecurityGroupsIds: (() { final guardedValue = map['replicationServersSecurityGroupsIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      stagingAreaSubnetId: (() { final guardedValue = map['stagingAreaSubnetId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      stagingAreaTags: (() { final guardedValue = map['stagingAreaTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      ...
      useDedicatedReplicationServer: (() { final guardedValue = map['useDedicatedReplicationServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
