...
class ReplicationConfigurationTemplateState {
  ...
  factory ReplicationConfigurationTemplateState.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigurationTemplateState(
      ...
      associateDefaultSecurityGroup: map['associateDefaultSecurityGroup'] == null ? null : ((map['associateDefaultSecurityGroup'] as bool).input()).input(),
      autoReplicateNewDisks: map['autoReplicateNewDisks'] == null ? null : ((map['autoReplicateNewDisks'] as bool).input()).input(),
      bandwidthThrottling: map['bandwidthThrottling'] == null ? null : ((map['bandwidthThrottling'] as int).input()).input(),
      createPublicIp: map['createPublicIp'] == null ? null : ((map['createPublicIp'] as bool).input()).input(),
      dataPlaneRouting: map['dataPlaneRouting'] == null ? null : ((map['dataPlaneRouting'] as String).input()).input(),
      defaultLargeStagingDiskType: map['defaultLargeStagingDiskType'] == null ? null : ((map['defaultLargeStagingDiskType'] as String).input()).input(),
      ebsEncryption: map['ebsEncryption'] == null ? null : ((map['ebsEncryption'] as String).input()).input(),
      ...
      replicationServerInstanceType: map['replicationServerInstanceType'] == null ? null : ((map['replicationServerInstanceType'] as String).input()).input(),
      replicationServersSecurityGroupsIds: map['replicationServersSecurityGroupsIds'] == null ? null : (((map['replicationServersSecurityGroupsIds'] as List).cast<String>()).input()).input(),
      stagingAreaSubnetId: map['stagingAreaSubnetId'] == null ? null : ((map['stagingAreaSubnetId'] as String).input()).input(),
      stagingAreaTags: map['stagingAreaTags'] == null ? null : (((map['stagingAreaTags'] as Map).cast<String, String>()).input()).input(),
      ...
      useDedicatedReplicationServer: map['useDedicatedReplicationServer'] == null ? null : ((map['useDedicatedReplicationServer'] as bool).input()).input(),
    );
  }
}
