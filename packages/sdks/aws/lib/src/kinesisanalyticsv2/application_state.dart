...
class ApplicationState {
  ...
  factory ApplicationState.fromMap(Map<String, dynamic> map) {
    return ApplicationState(
      ...
      lastUpdateTimestamp: map['lastUpdateTimestamp'] == null ? null : (map['lastUpdateTimestamp'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      runtimeEnvironment: map['runtimeEnvironment'] == null ? null : (map['runtimeEnvironment'] as String).input(),
      serviceExecutionRole: map['serviceExecutionRole'] == null ? null : (map['serviceExecutionRole'] as String).input(),
      startApplication: map['startApplication'] == null ? null : (map['startApplication'] as bool).input(),
      status: map['status'] == null ? null : (map['status'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      versionId: map['versionId'] == null ? null : (map['versionId'] as int).input(),
    );
  }
}
