...
class ApplicationArgs {
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      ...
      runtimeEnvironment: pulumi.Input.fromValue(map['runtimeEnvironment'] as String),
      serviceExecutionRole: pulumi.Input.fromValue(map['serviceExecutionRole'] as String),
