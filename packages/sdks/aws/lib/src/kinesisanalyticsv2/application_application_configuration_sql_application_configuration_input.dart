...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInput {
    ...
    return <String, dynamic>{
      ...
      'inputParallelism':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputParallelism,
            Map<String, dynamic>
          >(inputParallelism, (value) => value.toMap()),
      'inputProcessingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputProcessingConfiguration,
            Map<String, dynamic>
          >(inputProcessingConfiguration, (value) => value.toMap()),
      'inputSchema':
      ...
      'kinesisFirehoseInput':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationApplicationConfigurationSqlApplicationConfigurationInputKinesisFirehoseInput,
            Map<String, dynamic>
          >(kinesisFirehoseInput, (value) => value.toMap()),
      'kinesisStreamsInput':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationApplicationConfigurationSqlApplicationConfigurationInputKinesisStreamsInput,
            Map<String, dynamic>
          >(kinesisStreamsInput, (value) => value.toMap()),
  ...
  factory ApplicationApplicationConfigurationSqlApplicationConfigurationInput.fromMap(
    ...
    return ApplicationApplicationConfigurationSqlApplicationConfigurationInput(
      inAppStreamNames: (() {
        final guardedValue = map['inAppStreamNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      inputId: (() {
        final guardedValue = map['inputId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inputParallelism: (() {
        final guardedValue = map['inputParallelism'];
        if (guardedValue == null) return null;
      ...
      inputProcessingConfiguration: (() {
        final guardedValue = map['inputProcessingConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      inputStartingPositionConfigurations: (() {
        final guardedValue = map['inputStartingPositionConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kinesisFirehoseInput: (() {
        final guardedValue = map['kinesisFirehoseInput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kinesisStreamsInput: (() {
        final guardedValue = map['kinesisStreamsInput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
