...
class ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent {
  ...
  factory ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent.fromMap(Map<String, dynamic> map) {
    return ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent(
      s3ContentLocation: (() { final guardedValue = map['s3ContentLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentS3ContentLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      textContent: (() { final guardedValue = map['textContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
