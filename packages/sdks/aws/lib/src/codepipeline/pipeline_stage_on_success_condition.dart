...
class PipelineStageOnSuccessCondition {
  ...
  final pulumi.Input<List<PipelineStageOnSuccessConditionRule>> rules;
  ...
  const PipelineStageOnSuccessCondition({
    this.result,
    required this.rules,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'result': ?result,
      'rules': pulumi.Input.mapInputValue<List<PipelineStageOnSuccessConditionRule>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<PipelineStageOnSuccessConditionRule, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory PipelineStageOnSuccessCondition.fromMap(Map<String, dynamic> map) {
    return PipelineStageOnSuccessCondition(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<PipelineStageOnSuccessConditionRule>(map['rules']!, (value) => PipelineStageOnSuccessConditionRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
