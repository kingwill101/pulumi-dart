...
class PipelineStageOnSuccessConditionRule {
  ...
  final pulumi.Input<PipelineStageOnSuccessConditionRuleRuleTypeId> ruleTypeId;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': ?region,
      'roleArn': ?roleArn,
      'ruleTypeId': pulumi.Input.mapInputValue<PipelineStageOnSuccessConditionRuleRuleTypeId, Map<String, dynamic>>(ruleTypeId, (value) => value.toMap()),
      'timeoutInMinutes': ?timeoutInMinutes,
    };
  }

  factory PipelineStageOnSuccessConditionRule.fromMap(Map<String, dynamic> map) {
    return PipelineStageOnSuccessConditionRule(
      ...
      ruleTypeId: pulumi.Input.fromValue(PipelineStageOnSuccessConditionRuleRuleTypeId.fromMap((map['ruleTypeId']! as Map).cast<String, dynamic>())),
      timeoutInMinutes: (() { final guardedValue = map['timeoutInMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
