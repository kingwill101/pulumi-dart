...
class PipelineStageBeforeEntryCondition {
  ...
  PipelineStageBeforeEntryCondition({this.result, required this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<PipelineStageBeforeEntryConditionRule>,
  ...
  factory PipelineStageBeforeEntryCondition.fromMap(Map<String, dynamic> map) {
    return PipelineStageBeforeEntryCondition(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PipelineStageBeforeEntryConditionRule>(
          map['rules']!,
