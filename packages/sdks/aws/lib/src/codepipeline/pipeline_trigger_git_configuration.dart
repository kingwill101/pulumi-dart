...
class PipelineTriggerGitConfiguration {
  ...
  final pulumi.Input<List<PipelineTriggerGitConfigurationPullRequest>>?
  pullRequests;
    ...
    return <String, dynamic>{
      'pullRequests':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipelineTriggerGitConfigurationPullRequest>,
      ...
      'pushes':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipelineTriggerGitConfigurationPush>,
            List<Map<String, dynamic>>
          >(
            pushes,
            (value) =>
  ...
  factory PipelineTriggerGitConfiguration.fromMap(Map<String, dynamic> map) {
    return PipelineTriggerGitConfiguration(
      pullRequests: (() {
        final guardedValue = map['pullRequests'];
      ...
      sourceActionName: pulumi.Input.fromValue(
