...
class PipelineTriggerGitConfigurationPullRequest {
  ...
  factory PipelineTriggerGitConfigurationPullRequest.fromMap(Map<String, dynamic> map) {
    return PipelineTriggerGitConfigurationPullRequest(
      branches: (() { final guardedValue = map['branches']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PipelineTriggerGitConfigurationPullRequestBranches.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      filePaths: (() { final guardedValue = map['filePaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PipelineTriggerGitConfigurationPullRequestFilePaths.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
