...
class PipelineState {
  ...
  factory PipelineState.fromMap(Map<String, dynamic> map) {
    return PipelineState(
      ...
      artifactStores: (() {
        final guardedValue = map['artifactStores'];
        if (guardedValue == null) return null;
      ...
      triggerAlls: (() {
        final guardedValue = map['triggerAlls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PipelineTriggerAll>(
            guardedValue,
            (value) => PipelineTriggerAll.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
