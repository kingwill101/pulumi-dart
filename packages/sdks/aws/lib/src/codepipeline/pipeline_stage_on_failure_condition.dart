...
class PipelineStageOnFailureCondition {
  ...
  const PipelineStageOnFailureCondition({
    this.result,
    required this.rules,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'result': ?result,
      'rules': pulumi.Input.mapInputValue<List<PipelineStageOnFailureConditionRule>, List<Map<String, dynamic>>>(rules, (value) => pulumi.Input.encodeList<PipelineStageOnFailureConditionRule, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory PipelineStageOnFailureCondition.fromMap(Map<String, dynamic> map) {
    return PipelineStageOnFailureCondition(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<PipelineStageOnFailureConditionRule>(map['rules']!, (value) => PipelineStageOnFailureConditionRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
