...
class PipelineTriggerAllGitConfigurationPullRequest {
  ...
  final pulumi.Input<List<PipelineTriggerAllGitConfigurationPullRequestBranch>>?
  branches;
  ...
  final pulumi.Input<
    List<PipelineTriggerAllGitConfigurationPullRequestFilePath>
  >?
  filePaths;
    ...
    return <String, dynamic>{
      'branches':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipelineTriggerAllGitConfigurationPullRequestBranch>,
