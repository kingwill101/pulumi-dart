...
class PipelineTriggerAll {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gitConfigurations': ?gitConfigurations == null ? null : pulumi.Input.encodeList<PipelineTriggerAllGitConfiguration, Map<String, dynamic>>(gitConfigurations!, (value) => value.toMap()),
  ...
  factory PipelineTriggerAll.fromMap(Map<String, dynamic> map) {
    return PipelineTriggerAll(
      gitConfigurations: map['gitConfigurations'] == null ? null : pulumi.Input.decodeList<PipelineTriggerAllGitConfiguration>(map['gitConfigurations'], (value) => PipelineTriggerAllGitConfiguration.fromMap((value as Map).cast<String, dynamic>())),
