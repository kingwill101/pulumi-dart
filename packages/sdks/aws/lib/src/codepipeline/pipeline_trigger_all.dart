...
class PipelineTriggerAll {
  ...
  factory PipelineTriggerAll.fromMap(Map<String, dynamic> map) {
    return PipelineTriggerAll(
      gitConfigurations: (() { final guardedValue = map['gitConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PipelineTriggerAllGitConfiguration>(guardedValue, (value) => PipelineTriggerAllGitConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
