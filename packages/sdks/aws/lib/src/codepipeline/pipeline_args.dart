...
class PipelineArgs {
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      artifactStores: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PipelineArtifactStore>(
          map['artifactStores']!,
      ...
      pipelineType: (() {
        final guardedValue = map['pipelineType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      stages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<PipelineStage>(
          map['stages']!,
          (value) =>
      ...
      triggers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PipelineTrigger>(
            guardedValue,
            (value) =>
                PipelineTrigger.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      variables: (() {
