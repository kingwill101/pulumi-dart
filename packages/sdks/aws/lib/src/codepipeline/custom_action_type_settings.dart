...
class CustomActionTypeSettings {
  ...
  factory CustomActionTypeSettings.fromMap(Map<String, dynamic> map) {
    return CustomActionTypeSettings(
      entityUrlTemplate: (() {
        final guardedValue = map['entityUrlTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      executionUrlTemplate: (() {
        final guardedValue = map['executionUrlTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      revisionUrlTemplate: (() {
        final guardedValue = map['revisionUrlTemplate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      thirdPartyConfigurationUrl: (() {
        final guardedValue = map['thirdPartyConfigurationUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
