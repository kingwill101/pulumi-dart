...
class PipelineTriggerAllGitConfiguration {
  ...
  final pulumi.Input<List<PipelineTriggerAllGitConfigurationPullRequest>>?
  pullRequests;
    ...
    return <String, dynamic>{
      'pullRequests':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipelineTriggerAllGitConfigurationPullRequest>,
      ...
      'pushes':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipelineTriggerAllGitConfigurationPush>,
            List<Map<String, dynamic>>
          >(
            pushes,
            (value) =>
  ...
  factory PipelineTriggerAllGitConfiguration.fromMap(Map<String, dynamic> map) {
    return PipelineTriggerAllGitConfiguration(
      ...
      sourceActionName: (() {
        final guardedValue = map['sourceActionName'];
        if (guardedValue == null) return null;
