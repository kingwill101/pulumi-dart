...
class GetImageImageScanningConfiguration {
  ...
  final pulumi.Input<List<GetImageImageScanningConfigurationEcrConfiguration>>
  ecrConfigurations;
    ...
    return <String, dynamic>{
      'ecrConfigurations':
          pulumi.Input.mapInputValue<
            List<GetImageImageScanningConfigurationEcrConfiguration>,
  ...
  factory GetImageImageScanningConfiguration.fromMap(Map<String, dynamic> map) {
    return GetImageImageScanningConfiguration(
      ecrConfigurations: pulumi.Input.fromValue(
      ...
      imageScanningEnabled: pulumi.Input.fromValue(
