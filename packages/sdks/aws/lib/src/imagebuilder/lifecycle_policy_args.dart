...
class LifecyclePolicyArgs {
  ...
  factory LifecyclePolicyArgs.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicyArgs(
      ...
      policyDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<LifecyclePolicyPolicyDetail>(map['policyDetails']!, (value) => LifecyclePolicyPolicyDetail.fromMap((value as Map).cast<String, dynamic>()))),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceSelection: pulumi.Input.fromValue(LifecyclePolicyResourceSelection.fromMap((map['resourceSelection']! as Map).cast<String, dynamic>())),
