...
class DistributionConfigurationDistribution {
  ...
  final pulumi.Input<
    List<DistributionConfigurationDistributionSsmParameterConfiguration>
  >?
    ...
    return <String, dynamic>{
      'amiDistributionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            DistributionConfigurationDistributionAmiDistributionConfiguration,
            Map<String, dynamic>
          >(amiDistributionConfiguration, (value) => value.toMap()),
      'containerDistributionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            DistributionConfigurationDistributionContainerDistributionConfiguration,
            Map<String, dynamic>
          >(containerDistributionConfiguration, (value) => value.toMap()),
      'fastLaunchConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DistributionConfigurationDistributionFastLaunchConfiguration>,
      ...
      's3ExportConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            DistributionConfigurationDistributionS3ExportConfiguration,
            Map<String, dynamic>
          >(s3ExportConfiguration, (value) => value.toMap()),
      'ssmParameterConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<
  ...
  factory DistributionConfigurationDistribution.fromMap(
    ...
    return DistributionConfigurationDistribution(
      amiDistributionConfiguration: (() {
        final guardedValue = map['amiDistributionConfiguration'];
      ...
      containerDistributionConfiguration: (() {
        final guardedValue = map['containerDistributionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fastLaunchConfigurations: (() {
        final guardedValue = map['fastLaunchConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      launchTemplateConfigurations: (() {
        final guardedValue = map['launchTemplateConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            DistributionConfigurationDistributionLaunchTemplateConfiguration
      ...
      licenseConfigurationArns: (() {
        final guardedValue = map['licenseConfigurationArns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      region: pulumi.Input.fromValue(map['region'] as String),
      s3ExportConfiguration: (() {
        final guardedValue = map['s3ExportConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ssmParameterConfigurations: (() {
        final guardedValue = map['ssmParameterConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            DistributionConfigurationDistributionSsmParameterConfiguration
