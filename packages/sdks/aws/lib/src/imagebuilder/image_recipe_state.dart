...
class ImageRecipeState {
  ...
  factory ImageRecipeState.fromMap(Map<String, dynamic> map) {
    return ImageRecipeState(
      ...
      components: map['components'] == null ? null : (pulumi.Input.decodeList<ImageRecipeComponent>(map['components'], (value) => ImageRecipeComponent.fromMap((value as Map).cast<String, dynamic>()))).input(),
