...
class ImageRecipeState {
  ...
  factory ImageRecipeState.fromMap(Map<String, dynamic> map) {
    return ImageRecipeState(
      ...
      components: (() { final guardedValue = map['components']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImageRecipeComponent>(guardedValue, (value) => ImageRecipeComponent.fromMap((value as Map).cast<String, dynamic>()))); })(),
