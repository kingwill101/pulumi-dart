...
class GetContainerRecipeInstanceConfiguration {
  ...
  factory GetContainerRecipeInstanceConfiguration.fromMap(Map<String, dynamic> map) {
    return GetContainerRecipeInstanceConfiguration(
      blockDeviceMappings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContainerRecipeInstanceConfigurationBlockDeviceMapping>(map['blockDeviceMappings']!, (value) => GetContainerRecipeInstanceConfigurationBlockDeviceMapping.fromMap((value as Map).cast<String, dynamic>()))),
