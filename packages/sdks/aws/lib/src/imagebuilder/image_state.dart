...
class ImageState {
  ...
  factory ImageState.fromMap(Map<String, dynamic> map) {
    return ImageState(
      ...
      infrastructureConfigurationArn: map['infrastructureConfigurationArn'] == null ? null : (map['infrastructureConfigurationArn'] as String).input(),
      ...
      outputResources: map['outputResources'] == null ? null : (pulumi.Input.decodeList<ImageOutputResource>(map['outputResources'], (value) => ImageOutputResource.fromMap((value as Map).cast<String, dynamic>()))).input(),
