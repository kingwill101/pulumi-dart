...
class ImageState {
  ...
  factory ImageState.fromMap(Map<String, dynamic> map) {
    return ImageState(
      ...
      outputResources: (() {
        final guardedValue = map['outputResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageOutputResource>(
            guardedValue,
            (value) => ImageOutputResource.fromMap(
      ...
      workflows: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ImageWorkflow>(
            guardedValue,
            (value) =>
                ImageWorkflow.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
