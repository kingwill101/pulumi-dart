...
class ImageOutputResource {
  ...
  factory ImageOutputResource.fromMap(Map<String, dynamic> map) {
    return ImageOutputResource(
      amis: (() { final guardedValue = map['amis']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImageOutputResourceAmi>(guardedValue, (value) => ImageOutputResourceAmi.fromMap((value as Map).cast<String, dynamic>()))); })(),
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ImageOutputResourceContainer>(guardedValue, (value) => ImageOutputResourceContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
