...
class ContainerRecipeState {
  ...
  factory ContainerRecipeState.fromMap(Map<String, dynamic> map) {
    return ContainerRecipeState(
      ...
      components: map['components'] == null ? null : ((pulumi.Input.decodeList<ContainerRecipeComponent>(map['components']!, (value) => ContainerRecipeComponent.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      containerType: map['containerType'] == null ? null : ((map['containerType'] as String).input()).input(),
      ...
      targetRepository: map['targetRepository'] == null ? null : ((ContainerRecipeTargetRepository.fromMap((map['targetRepository']! as Map).cast<String, dynamic>())).input()).input(),
