...
class ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs {
  ...
  /// Creates a new [ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs].
  ...
  const ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs({
  ...
  factory ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs.fromMap(Map<String, dynamic> map) {
    return ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs(
