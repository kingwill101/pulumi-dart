...
class DistributionConfigurationState {
  ...
  /// [tags] Key-value map of resource tags for the distribution configuration. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
  /// [tagsAll] A map of tags assigned to the resource, including those inherited from the provider `defaultTags` configuration block.
  const DistributionConfigurationState({
    this.arn,
    this.dateCreated,
    this.dateUpdated,
    this.description,
