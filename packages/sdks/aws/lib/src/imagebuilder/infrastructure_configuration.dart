...
class InfrastructureConfiguration extends pulumi.CustomResource {
  ...
  InfrastructureConfiguration(
    ...
    this.instanceMetadataOptions = registerOutput<InfrastructureConfigurationInstanceMetadataOptions?>('instanceMetadataOptions');
    ...
    this.logging = registerOutput<InfrastructureConfigurationLogging?>('logging');
    this.name = registerOutput<String>('name');
    this.placement = registerOutput<InfrastructureConfigurationPlacement?>('placement');
    ...
    this.terminateInstanceOnFailure = registerOutput<bool?>('terminateInstanceOnFailure');
  }
