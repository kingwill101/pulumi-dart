...
class GetDistributionConfigurationsArgs {
  ...
  GetDistributionConfigurationsArgs({
    pulumi.Output<List<GetDistributionConfigurationsFilter>>? filters,
  ...
  factory GetDistributionConfigurationsArgs.fromMap(Map<String, dynamic> map) {
    return GetDistributionConfigurationsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetDistributionConfigurationsFilter>>(pulumi.Input.decodeList<GetDistributionConfigurationsFilter>(map['filters'], (value) => GetDistributionConfigurationsFilter.fromMap((value as Map).cast<String, dynamic>()))),
