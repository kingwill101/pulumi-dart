...
class DistributionConfigurationDistributionFastLaunchConfiguration {
  ...
  final DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate? launchTemplate;
  ...
  final DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration? snapshotConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'snapshotConfiguration': ?snapshotConfiguration == null ? null : snapshotConfiguration!.toMap(),
    };
  }
  ...
  factory DistributionConfigurationDistributionFastLaunchConfiguration.fromMap(Map<String, dynamic> map) {
    return DistributionConfigurationDistributionFastLaunchConfiguration(
      ...
      launchTemplate: map['launchTemplate'] == null ? null : DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>()),
      maxParallelLaunches: map['maxParallelLaunches'] == null ? null : map['maxParallelLaunches'] as int,
      snapshotConfiguration: map['snapshotConfiguration'] == null ? null : DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration.fromMap((map['snapshotConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
