...
class GetImageOutputResource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'amis': pulumi.Input.encodeList<GetImageOutputResourceAmi, Map<String, dynamic>>(amis, (value) => value.toMap()),
      'containers': pulumi.Input.encodeList<GetImageOutputResourceContainer, Map<String, dynamic>>(containers, (value) => value.toMap()),
    };
  }

  factory GetImageOutputResource.fromMap(Map<String, dynamic> map) {
    return GetImageOutputResource(
      amis: pulumi.Input.decodeList<GetImageOutputResourceAmi>(map['amis'], (value) => GetImageOutputResourceAmi.fromMap((value as Map).cast<String, dynamic>())),
      containers: pulumi.Input.decodeList<GetImageOutputResourceContainer>(map['containers'], (value) => GetImageOutputResourceContainer.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
