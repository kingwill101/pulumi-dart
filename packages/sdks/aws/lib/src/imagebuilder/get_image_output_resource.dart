...
class GetImageOutputResource {
  ...
  GetImageOutputResource({required this.amis, required this.containers});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'amis':
          pulumi.Input.mapInputValue<
            List<GetImageOutputResourceAmi>,
      ...
      'containers':
          pulumi.Input.mapInputValue<
            List<GetImageOutputResourceContainer>,
            List<Map<String, dynamic>>
          >(
            containers,
            (value) =>
  ...
  factory GetImageOutputResource.fromMap(Map<String, dynamic> map) {
    return GetImageOutputResource(
      amis: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetImageOutputResourceAmi>(
          map['amis']!,
      ...
      containers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetImageOutputResourceContainer>(
          map['containers']!,
