...
class ImagePipelineState {
  ...
  ImagePipelineState({
    ...
    pulumi.Output<String>? dateLastRun,
    pulumi.Output<String>? dateNextRun,
    ...
    pulumi.Output<List<ImagePipelineWorkflow>>? workflows,
      ...
      dateLastRun = pulumi.Input.asOptionalInput<String>(dateLastRun),
      dateNextRun = pulumi.Input.asOptionalInput<String>(dateNextRun),
  ...
  factory ImagePipelineState.fromMap(Map<String, dynamic> map) {
    return ImagePipelineState(
      ...
      dateLastRun: map['dateLastRun'] == null ? null : pulumi.Output.create<String>(map['dateLastRun'] as String),
      dateNextRun: map['dateNextRun'] == null ? null : pulumi.Output.create<String>(map['dateNextRun'] as String),
