...
class GetInfrastructureConfigurationsArgs {
  ...
  factory GetInfrastructureConfigurationsArgs.fromMap(Map<String, dynamic> map) {
    return GetInfrastructureConfigurationsArgs(
      filters: map['filters'] == null ? null : ((pulumi.Input.decodeList<GetInfrastructureConfigurationsFilter>(map['filters']!, (value) => GetInfrastructureConfigurationsFilter.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
