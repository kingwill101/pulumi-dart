  ...
  factory ContainerRecipeArgs.fromMap(Map<String, dynamic> map) {
    return ContainerRecipeArgs(
      components: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ContainerRecipeComponent>(
          map['components']!,
      ...
      dockerfileTemplateData: (() {
        final guardedValue = map['dockerfileTemplateData'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dockerfileTemplateUri: (() {
        final guardedValue = map['dockerfileTemplateUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      instanceConfiguration: (() {
      ...
      platformOverride: (() {
        final guardedValue = map['platformOverride'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      targetRepository: pulumi.Input.fromValue(
        ContainerRecipeTargetRepository.fromMap(
