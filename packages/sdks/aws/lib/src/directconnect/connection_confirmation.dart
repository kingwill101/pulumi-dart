...
import 'connection_confirmation_state.dart';
...
/// }
///
/// resource "aws_directconnect_connectionconfirmation" "confirmation" {
...
class ConnectionConfirmation extends pulumi.CustomResource {
  ...
  /// Gets an existing [ConnectionConfirmation] resource's state with the given [name] and [id].
  static ConnectionConfirmation get(
    String name,
    pulumi.Input<String> id, {
    ConnectionConfirmationState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ConnectionConfirmation._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ConnectionConfirmation] resource.
  ConnectionConfirmation.reference(String urn)
    : super(
        'aws:directconnect/connectionConfirmation:ConnectionConfirmation',
