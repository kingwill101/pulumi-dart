...
class ConnectionState {
  ...
  factory ConnectionState.fromMap(Map<String, dynamic> map) {
    return ConnectionState(
      ...
      macsecCapable: map['macsecCapable'] == null ? null : (map['macsecCapable'] as bool).input(),
      ...
      portEncryptionStatus: map['portEncryptionStatus'] == null ? null : (map['portEncryptionStatus'] as String).input(),
