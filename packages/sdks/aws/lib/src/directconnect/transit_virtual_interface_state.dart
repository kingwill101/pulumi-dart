...
class TransitVirtualInterfaceState {
  ...
  /// Creates a new [TransitVirtualInterfaceState].
  ...
  factory TransitVirtualInterfaceState.fromMap(Map<String, dynamic> map) {
    return TransitVirtualInterfaceState(
      addressFamily: (() {
