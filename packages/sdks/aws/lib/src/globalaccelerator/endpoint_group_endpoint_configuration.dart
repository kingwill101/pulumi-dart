...
class EndpointGroupEndpointConfiguration {
  ...
  factory EndpointGroupEndpointConfiguration.fromMap(Map<String, dynamic> map) {
    return EndpointGroupEndpointConfiguration(
      attachmentArn: map['attachmentArn'] == null ? null : map['attachmentArn'] as String,
      clientIpPreservationEnabled: map['clientIpPreservationEnabled'] == null ? null : map['clientIpPreservationEnabled'] as bool,
