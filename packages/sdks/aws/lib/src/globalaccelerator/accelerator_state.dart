...
class AcceleratorState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipSets':
          ?pulumi.Input.mapOptionalInputValue<
            List<AcceleratorIpSet>,
            List<Map<String, dynamic>>
          >(
            ipSets,
            (value) =>
                pulumi.Input.encodeList<AcceleratorIpSet, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory AcceleratorState.fromMap(Map<String, dynamic> map) {
    return AcceleratorState(
      ...
      dualStackDnsName: (() {
        final guardedValue = map['dualStackDnsName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      enabled: (() {
      ...
      ipSets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AcceleratorIpSet>(
            guardedValue,
            (value) => AcceleratorIpSet.fromMap(
