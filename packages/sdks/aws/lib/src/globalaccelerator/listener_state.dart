...
class ListenerState {
  ...
  factory ListenerState.fromMap(Map<String, dynamic> map) {
    return ListenerState(
      ...
      portRanges: (() { final guardedValue = map['portRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ListenerPortRange>(guardedValue, (value) => ListenerPortRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
