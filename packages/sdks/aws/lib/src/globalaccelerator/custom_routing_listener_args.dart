...
class CustomRoutingListenerArgs {
  ...
  factory CustomRoutingListenerArgs.fromMap(Map<String, dynamic> map) {
    return CustomRoutingListenerArgs(
      ...
      portRanges: pulumi.Input.fromValue(pulumi.Input.decodeList<CustomRoutingListenerPortRange>(map['portRanges']!, (value) => CustomRoutingListenerPortRange.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
