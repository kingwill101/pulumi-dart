...
class LocationHdfsArgs {
  ...
  LocationHdfsArgs({
    ...
    required pulumi.Output<List<LocationHdfsNameNode>> nameNodes,
  ...
  factory LocationHdfsArgs.fromMap(Map<String, dynamic> map) {
    return LocationHdfsArgs(
      ...
      nameNodes: pulumi.Output.create<List<LocationHdfsNameNode>>(pulumi.Input.decodeList<LocationHdfsNameNode>(map['nameNodes'], (value) => LocationHdfsNameNode.fromMap((value as Map).cast<String, dynamic>()))),
