...
class LocationHdfsQopConfiguration {
  ...
  const LocationHdfsQopConfiguration({
  ...
  factory LocationHdfsQopConfiguration.fromMap(Map<String, dynamic> map) {
    return LocationHdfsQopConfiguration(
      dataTransferProtection: (() { final guardedValue = map['dataTransferProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rpcProtection: (() { final guardedValue = map['rpcProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
