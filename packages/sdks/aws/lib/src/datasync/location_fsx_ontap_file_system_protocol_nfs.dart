...
class LocationFsxOntapFileSystemProtocolNfs {
  ...
  final pulumi.Input<LocationFsxOntapFileSystemProtocolNfsMountOptions> mountOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'mountOptions': pulumi.Input.mapInputValue<LocationFsxOntapFileSystemProtocolNfsMountOptions, Map<String, dynamic>>(mountOptions, (value) => value.toMap()),
    };
  }

  factory LocationFsxOntapFileSystemProtocolNfs.fromMap(Map<String, dynamic> map) {
    return LocationFsxOntapFileSystemProtocolNfs(
      mountOptions: pulumi.Input.fromValue(LocationFsxOntapFileSystemProtocolNfsMountOptions.fromMap((map['mountOptions']! as Map).cast<String, dynamic>())),
    );
  }
}
