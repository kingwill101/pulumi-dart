...
class TaskTaskReportConfig {
    ...
    return <String, dynamic>{
      ...
      'reportOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(reportOverrides, (value) => value.toMap()),
      's3Destination':
  ...
  factory TaskTaskReportConfig.fromMap(Map<String, dynamic> map) {
    return TaskTaskReportConfig(
      ...
      reportLevel: (() {
        final guardedValue = map['reportLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      reportOverrides: (() {
        final guardedValue = map['reportOverrides'];
        if (guardedValue == null) return null;
      ...
      s3Destination: pulumi.Input.fromValue(
        TaskTaskReportConfigS3Destination.fromMap(
          (map['s3Destination']! as Map).cast<String, dynamic>(),
        ),
      ),
      s3ObjectVersioning: (() {
        final guardedValue = map['s3ObjectVersioning'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
