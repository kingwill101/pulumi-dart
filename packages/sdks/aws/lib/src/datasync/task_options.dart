...
class TaskOptions {
  ...
  factory TaskOptions.fromMap(Map<String, dynamic> map) {
    return TaskOptions(
      atime: (() {
        final guardedValue = map['atime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      bytesPerSecond: (() {
        final guardedValue = map['bytesPerSecond'];
        if (guardedValue == null) return null;
      ...
      mtime: (() {
        final guardedValue = map['mtime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      objectTags: (() {
        final guardedValue = map['objectTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      overwriteMode: (() {
        final guardedValue = map['overwriteMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      posixPermissions: (() {
        final guardedValue = map['posixPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      preserveDeletedFiles: (() {
        final guardedValue = map['preserveDeletedFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      preserveDevices: (() {
        final guardedValue = map['preserveDevices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      securityDescriptorCopyFlags: (() {
        final guardedValue = map['securityDescriptorCopyFlags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      taskQueueing: (() {
        final guardedValue = map['taskQueueing'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      transferMode: (() {
        final guardedValue = map['transferMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      uid: (() {
      ...
      verifyMode: (() {
        final guardedValue = map['verifyMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
