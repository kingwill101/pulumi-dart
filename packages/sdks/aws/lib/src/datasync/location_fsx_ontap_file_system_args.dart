...
class LocationFsxOntapFileSystemArgs {
  ...
  const LocationFsxOntapFileSystemArgs({
  ...
  factory LocationFsxOntapFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return LocationFsxOntapFileSystemArgs(
      protocol: pulumi.Input.fromValue(LocationFsxOntapFileSystemProtocol.fromMap((map['protocol']! as Map).cast<String, dynamic>())),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      securityGroupArns: pulumi.Input.fromValue((map['securityGroupArns'] as List).cast<String>()),
      storageVirtualMachineArn: pulumi.Input.fromValue(map['storageVirtualMachineArn'] as String),
