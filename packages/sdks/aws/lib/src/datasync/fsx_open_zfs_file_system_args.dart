...
class FsxOpenZfsFileSystemArgs {
  ...
  /// [fsxFilesystemArn] ARN for the FSx for OpenZfs file system.
  ...
  /// [securityGroupArns] ARNs of the security groups that are to use to configure the FSx for openzfs file system.
