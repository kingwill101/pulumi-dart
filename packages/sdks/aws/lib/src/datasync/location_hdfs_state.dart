...
class LocationHdfsState {
  ...
  /// [kerberosKeytabBase64] Use instead of `kerberosKeytab` to pass base64-encoded binary data directly. If `KERBEROS` is specified for `authenticationType`, this parameter (or `kerberosKeytab`) is required.
  /// [kerberosKrb5Conf] The krb5.conf file that contains the Kerberos configuration information. Use `kerberosKrb5ConfBase64` instead whenever the value is not a valid UTF-8 string. If `KERBEROS` is specified for `authenticationType`, this parameter (or `kerberosKrb5ConfBase64`) is required.
  /// [kerberosKrb5ConfBase64] Use instead of `kerberosKrb5Conf` to pass base64-encoded binary data directly. If `KERBEROS` is specified for `authenticationType`, this parameter (or `kerberosKrb5Conf`) is required.
  ...
  factory LocationHdfsState.fromMap(Map<String, dynamic> map) {
    return LocationHdfsState(
      ...
      nameNodes: (() { final guardedValue = map['nameNodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LocationHdfsNameNode>(guardedValue, (value) => LocationHdfsNameNode.fromMap((value as Map).cast<String, dynamic>()))); })(),
