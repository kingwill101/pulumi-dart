...
class LocationHdfsState {
  ...
  factory LocationHdfsState.fromMap(Map<String, dynamic> map) {
    return LocationHdfsState(
      ...
      blockSize: map['blockSize'] == null ? null : ((map['blockSize'] as int).input()).input(),
      kerberosKeytab: map['kerberosKeytab'] == null ? null : ((map['kerberosKeytab'] as String).input()).input(),
      kerberosKeytabBase64: map['kerberosKeytabBase64'] == null ? null : ((map['kerberosKeytabBase64'] as String).input()).input(),
      kerberosKrb5Conf: map['kerberosKrb5Conf'] == null ? null : ((map['kerberosKrb5Conf'] as String).input()).input(),
      kerberosKrb5ConfBase64: map['kerberosKrb5ConfBase64'] == null ? null : ((map['kerberosKrb5ConfBase64'] as String).input()).input(),
      kerberosPrincipal: map['kerberosPrincipal'] == null ? null : ((map['kerberosPrincipal'] as String).input()).input(),
      kmsKeyProviderUri: map['kmsKeyProviderUri'] == null ? null : ((map['kmsKeyProviderUri'] as String).input()).input(),
      nameNodes: map['nameNodes'] == null ? null : ((pulumi.Input.decodeList<LocationHdfsNameNode>(map['nameNodes']!, (value) => LocationHdfsNameNode.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      qopConfiguration: map['qopConfiguration'] == null ? null : ((LocationHdfsQopConfiguration.fromMap((map['qopConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      replicationFactor: map['replicationFactor'] == null ? null : ((map['replicationFactor'] as int).input()).input(),
      simpleUser: map['simpleUser'] == null ? null : ((map['simpleUser'] as String).input()).input(),
