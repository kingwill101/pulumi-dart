...
class TaskArgs {
  ...
  factory TaskArgs.fromMap(Map<String, dynamic> map) {
    return TaskArgs(
      ...
      destinationLocationArn: pulumi.Input.fromValue(map['destinationLocationArn'] as String),
      ...
      sourceLocationArn: pulumi.Input.fromValue(map['sourceLocationArn'] as String),
