  ...
  factory EndpointMysqlSettings.fromMap(Map<String, dynamic> map) {
    return EndpointMysqlSettings(
      ...
      cleanSourceMetadataOnMismatch: (() {
        final guardedValue = map['cleanSourceMetadataOnMismatch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      eventsPollInterval: (() {
        final guardedValue = map['eventsPollInterval'];
        if (guardedValue == null) return null;
      ...
      parallelLoadThreads: (() {
        final guardedValue = map['parallelLoadThreads'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      serverTimezone: (() {
        final guardedValue = map['serverTimezone'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      targetDbType: (() {
        final guardedValue = map['targetDbType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
