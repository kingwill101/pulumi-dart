...
import 'replication_instance_state.dart';
...
class ReplicationInstance extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String?> dnsNameServers;
  ...
  late final pulumi.Output<String> replicationInstanceId;
  /// A list of the private IP addresses of the replication instance.
  late final pulumi.Output<List<String>> replicationInstancePrivateIps;
  ...
  /// Creates a new [ReplicationInstance].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ReplicationInstance]. {@macro pulumi_dms_replication_instance_replication_instance_args_doc}
  ...
  ReplicationInstance(
    ...
    this.kerberosAuthenticationSettings = registerOutput<ReplicationInstanceKerberosAuthenticationSettings?>('kerberosAuthenticationSettings');
    ...
    this.replicationInstanceClass = registerOutput<String>('replicationInstanceClass');
    this.replicationInstanceId = registerOutput<String>('replicationInstanceId');
    this.replicationInstancePrivateIps = registerOutput<List<String>>('replicationInstancePrivateIps');
    this.replicationInstancePublicIps = registerOutput<List<String>>('replicationInstancePublicIps');
  ...
  static ReplicationInstance get(
    String name,
