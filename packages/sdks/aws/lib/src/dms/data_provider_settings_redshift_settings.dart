...
class DataProviderSettingsRedshiftSettings {
  ...
  /// Creates a new [DataProviderSettingsRedshiftSettings].
  /// [databaseName] Database name on the Amazon Redshift data provider.
  /// [port] Port of the Amazon Redshift server. Valid values are between `1` and `65535`.
  ...
  /// [serverName] Hostname of the Amazon Redshift server.
  const DataProviderSettingsRedshiftSettings({
    this.databaseName,
    this.port,
  ...
  factory DataProviderSettingsRedshiftSettings.fromMap(Map<String, dynamic> map) {
    return DataProviderSettingsRedshiftSettings(
