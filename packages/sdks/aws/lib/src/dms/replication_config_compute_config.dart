...
class ReplicationConfigComputeConfig {
  ...
  factory ReplicationConfigComputeConfig.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigComputeConfig(
      ...
      maxCapacityUnits: (() { final guardedValue = map['maxCapacityUnits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      minCapacityUnits: (() { final guardedValue = map['minCapacityUnits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
