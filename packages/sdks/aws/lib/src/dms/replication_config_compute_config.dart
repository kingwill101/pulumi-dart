...
class ReplicationConfigComputeConfig {
  ...
  factory ReplicationConfigComputeConfig.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigComputeConfig(
      ...
      maxCapacityUnits: map['maxCapacityUnits'] == null ? null : map['maxCapacityUnits'] as int,
      minCapacityUnits: map['minCapacityUnits'] == null ? null : map['minCapacityUnits'] as int,
