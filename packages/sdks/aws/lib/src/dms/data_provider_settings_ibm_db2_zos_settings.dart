...
class DataProviderSettingsIbmDb2ZosSettings {
  ...
  /// Creates a new [DataProviderSettingsIbmDb2ZosSettings].
  /// [certificateArn] ARN of the DMS certificate used for the SSL connection.
  /// [databaseName] Database name on the IBM DB2 for z/OS data provider.
  /// [port] Port of the IBM DB2 for z/OS server. Valid values are between `1` and `65535`.
  ...
  /// [serverName] Hostname of the IBM DB2 for z/OS server.
  /// [sslMode] SSL mode for the connection. Valid values: `none` and `verify-ca`. Defaults to `none`.
  const DataProviderSettingsIbmDb2ZosSettings({
    this.certificateArn,
    this.databaseName,
    this.port,
  ...
  factory DataProviderSettingsIbmDb2ZosSettings.fromMap(Map<String, dynamic> map) {
    return DataProviderSettingsIbmDb2ZosSettings(
