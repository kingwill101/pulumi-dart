...
import 'replication_task_state.dart';
...
class ReplicationTask extends pulumi.CustomResource {
  ...
  /// Gets an existing [ReplicationTask] resource's state with the given [name] and [id].
  static ReplicationTask get(
    String name,
