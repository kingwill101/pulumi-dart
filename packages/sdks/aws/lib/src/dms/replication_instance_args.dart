...
class ReplicationInstanceArgs {
  ...
  factory ReplicationInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationInstanceArgs(
      ...
      replicationInstanceClass: pulumi.Input.fromValue(map['replicationInstanceClass'] as String),
      replicationInstanceId: pulumi.Input.fromValue(map['replicationInstanceId'] as String),
