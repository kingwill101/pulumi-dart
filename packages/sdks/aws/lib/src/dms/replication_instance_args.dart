...
class ReplicationInstanceArgs {
  ...
  ReplicationInstanceArgs({
    ...
    required pulumi.Output<String> replicationInstanceClass,
    required pulumi.Output<String> replicationInstanceId,
  ...
  factory ReplicationInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationInstanceArgs(
      ...
      replicationInstanceClass: pulumi.Output.create<String>(map['replicationInstanceClass'] as String),
      replicationInstanceId: pulumi.Output.create<String>(map['replicationInstanceId'] as String),
