...
class ReplicationTaskArgs {
  ...
  factory ReplicationTaskArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationTaskArgs(
      cdcStartPosition: (() {
        final guardedValue = map['cdcStartPosition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cdcStartTime: (() {
        final guardedValue = map['cdcStartTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      replicationInstanceArn: pulumi.Input.fromValue(
        map['replicationInstanceArn'] as String,
      ),
      replicationTaskId: pulumi.Input.fromValue(
        map['replicationTaskId'] as String,
      ),
      replicationTaskSettings: (() {
        final guardedValue = map['replicationTaskSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceIdentifier: (() {
      ...
      sourceEndpointArn: pulumi.Input.fromValue(
        map['sourceEndpointArn'] as String,
      ),
      startReplicationTask: (() {
        final guardedValue = map['startReplicationTask'];
        if (guardedValue == null) return null;
      ...
      targetEndpointArn: pulumi.Input.fromValue(
        map['targetEndpointArn'] as String,
      ),
    );
  }
}
