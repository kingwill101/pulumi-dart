...
class S3EndpointState {
  ...
  factory S3EndpointState.fromMap(Map<String, dynamic> map) {
    return S3EndpointState(
      ...
      endpointArn: map['endpointArn'] == null ? null : ((map['endpointArn'] as String).input()).input(),
      ...
      engineDisplayName: map['engineDisplayName'] == null ? null : ((map['engineDisplayName'] as String).input()).input(),
