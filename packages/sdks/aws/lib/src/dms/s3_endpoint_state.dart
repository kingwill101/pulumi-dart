...
class S3EndpointState {
  ...
  factory S3EndpointState.fromMap(Map<String, dynamic> map) {
    return S3EndpointState(
      ...
      engineDisplayName: (() { final guardedValue = map['engineDisplayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
