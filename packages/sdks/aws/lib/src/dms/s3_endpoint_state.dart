...
class S3EndpointState {
  ...
  final pulumi.Input<String>? engineDisplayName;
  ...
  /// [externalId] Can be used for cross-account validation. Use it in another account with `aws.dms.S3Endpoint` to create the endpoint cross-account.
  ...
  S3EndpointState({
    ...
    pulumi.Output<String>? endpointArn,
    pulumi.Output<String>? endpointId,
    pulumi.Output<String>? endpointType,
    pulumi.Output<String>? engineDisplayName,
    ...
    pulumi.Output<String>? serviceAccessRoleArn,
    ...
    pulumi.Output<bool>? useTaskStartTimeForFullLoadTimestamp,
      ...
      endpointArn = pulumi.Input.asOptionalInput<String>(endpointArn),
      endpointId = pulumi.Input.asOptionalInput<String>(endpointId),
      endpointType = pulumi.Input.asOptionalInput<String>(endpointType),
      engineDisplayName = pulumi.Input.asOptionalInput<String>(engineDisplayName),
      ...
      serviceAccessRoleArn = pulumi.Input.asOptionalInput<String>(serviceAccessRoleArn),
  ...
  factory S3EndpointState.fromMap(Map<String, dynamic> map) {
    return S3EndpointState(
      ...
      endpointArn: map['endpointArn'] == null ? null : pulumi.Output.create<String>(map['endpointArn'] as String),
      ...
      engineDisplayName: map['engineDisplayName'] == null ? null : pulumi.Output.create<String>(map['engineDisplayName'] as String),
      ...
      serviceAccessRoleArn: map['serviceAccessRoleArn'] == null ? null : pulumi.Output.create<String>(map['serviceAccessRoleArn'] as String),
