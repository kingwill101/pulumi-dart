...
class MigrationProjectTimeouts {
  ...
  const MigrationProjectTimeouts({
    this.create,
  });
  ...
  factory MigrationProjectTimeouts.fromMap(Map<String, dynamic> map) {
    return MigrationProjectTimeouts(
