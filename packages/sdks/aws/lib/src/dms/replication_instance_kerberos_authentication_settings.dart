...
class ReplicationInstanceKerberosAuthenticationSettings {
  ...
  factory ReplicationInstanceKerberosAuthenticationSettings.fromMap(
    ...
    return ReplicationInstanceKerberosAuthenticationSettings(
      keyCacheSecretIamArn: pulumi.Input.fromValue(
        map['keyCacheSecretIamArn'] as String,
      ),
      keyCacheSecretId: pulumi.Input.fromValue(
        map['keyCacheSecretId'] as String,
      ),
      krb5FileContents: pulumi.Input.fromValue(
        map['krb5FileContents'] as String,
      ),
    );
  }
}
