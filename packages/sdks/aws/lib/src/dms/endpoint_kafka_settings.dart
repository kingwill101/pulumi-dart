...
class EndpointKafkaSettings {
  ...
  factory EndpointKafkaSettings.fromMap(Map<String, dynamic> map) {
    return EndpointKafkaSettings(
      ...
      noHexPrefix: map['noHexPrefix'] == null ? null : map['noHexPrefix'] as bool,
      partitionIncludeSchemaTable: map['partitionIncludeSchemaTable'] == null ? null : map['partitionIncludeSchemaTable'] as bool,
      saslMechanism: map['saslMechanism'] == null ? null : map['saslMechanism'] as String,
      saslPassword: map['saslPassword'] == null ? null : map['saslPassword'] as String,
      saslUsername: map['saslUsername'] == null ? null : map['saslUsername'] as String,
      securityProtocol: map['securityProtocol'] == null ? null : map['securityProtocol'] as String,
      sslCaCertificateArn: map['sslCaCertificateArn'] == null ? null : map['sslCaCertificateArn'] as String,
      sslClientCertificateArn: map['sslClientCertificateArn'] == null ? null : map['sslClientCertificateArn'] as String,
      sslClientKeyArn: map['sslClientKeyArn'] == null ? null : map['sslClientKeyArn'] as String,
      sslClientKeyPassword: map['sslClientKeyPassword'] == null ? null : map['sslClientKeyPassword'] as String,
