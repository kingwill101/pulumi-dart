...
class EndpointKafkaSettings {
  ...
  factory EndpointKafkaSettings.fromMap(Map<String, dynamic> map) {
    return EndpointKafkaSettings(
      ...
      messageMaxBytes: map['messageMaxBytes'] == null ? null : ((map['messageMaxBytes'] as int).input()).input(),
      noHexPrefix: map['noHexPrefix'] == null ? null : ((map['noHexPrefix'] as bool).input()).input(),
      ...
      saslMechanism: map['saslMechanism'] == null ? null : ((map['saslMechanism'] as String).input()).input(),
      saslPassword: map['saslPassword'] == null ? null : ((map['saslPassword'] as String).input()).input(),
      saslUsername: map['saslUsername'] == null ? null : ((map['saslUsername'] as String).input()).input(),
      securityProtocol: map['securityProtocol'] == null ? null : ((map['securityProtocol'] as String).input()).input(),
      sslCaCertificateArn: map['sslCaCertificateArn'] == null ? null : ((map['sslCaCertificateArn'] as String).input()).input(),
      sslClientCertificateArn: map['sslClientCertificateArn'] == null ? null : ((map['sslClientCertificateArn'] as String).input()).input(),
      sslClientKeyArn: map['sslClientKeyArn'] == null ? null : ((map['sslClientKeyArn'] as String).input()).input(),
      sslClientKeyPassword: map['sslClientKeyPassword'] == null ? null : ((map['sslClientKeyPassword'] as String).input()).input(),
