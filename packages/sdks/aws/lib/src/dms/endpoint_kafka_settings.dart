...
class EndpointKafkaSettings {
  ...
  factory EndpointKafkaSettings.fromMap(Map<String, dynamic> map) {
    return EndpointKafkaSettings(
      ...
      messageMaxBytes: (() {
        final guardedValue = map['messageMaxBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      noHexPrefix: (() {
        final guardedValue = map['noHexPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      saslMechanism: (() {
        final guardedValue = map['saslMechanism'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      saslPassword: (() {
        final guardedValue = map['saslPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      saslUsername: (() {
        final guardedValue = map['saslUsername'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      securityProtocol: (() {
        final guardedValue = map['securityProtocol'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sslCaCertificateArn: (() {
      ...
      sslClientCertificateArn: (() {
        final guardedValue = map['sslClientCertificateArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sslClientKeyArn: (() {
        final guardedValue = map['sslClientKeyArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sslClientKeyPassword: (() {
        final guardedValue = map['sslClientKeyPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      topic: (() {
