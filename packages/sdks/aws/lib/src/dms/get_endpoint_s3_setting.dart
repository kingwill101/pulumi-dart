...
class GetEndpointS3Setting {
  ...
  factory GetEndpointS3Setting.fromMap(Map<String, dynamic> map) {
    return GetEndpointS3Setting(
      ...
      cdcMaxBatchInterval: pulumi.Input.fromValue((map['cdcMaxBatchInterval'] as num).toInt()),
      cdcMinFileSize: pulumi.Input.fromValue((map['cdcMinFileSize'] as num).toInt()),
      ...
      dataPageSize: pulumi.Input.fromValue((map['dataPageSize'] as num).toInt()),
      ...
      dictPageSizeLimit: pulumi.Input.fromValue((map['dictPageSizeLimit'] as num).toInt()),
      ...
      ignoreHeaderRows: pulumi.Input.fromValue((map['ignoreHeaderRows'] as num).toInt()),
      ignoreHeadersRow: pulumi.Input.fromValue((map['ignoreHeadersRow'] as num).toInt()),
      includeOpForFullLoad: pulumi.Input.fromValue(map['includeOpForFullLoad'] as bool),
      maxFileSize: pulumi.Input.fromValue((map['maxFileSize'] as num).toInt()),
      ...
      rowGroupLength: pulumi.Input.fromValue((map['rowGroupLength'] as num).toInt()),
