...
class EndpointOracleSettings {
  ...
  factory EndpointOracleSettings.fromMap(Map<String, dynamic> map) {
    return EndpointOracleSettings(
      accessAlternateDirectly: map['accessAlternateDirectly'] == null ? null : map['accessAlternateDirectly'] as bool,
      addSupplementalLogging: map['addSupplementalLogging'] == null ? null : map['addSupplementalLogging'] as bool,
      additionalArchivedLogDestId: map['additionalArchivedLogDestId'] == null ? null : map['additionalArchivedLogDestId'] as int,
      allowSelectedNestedTables: map['allowSelectedNestedTables'] == null ? null : map['allowSelectedNestedTables'] as bool,
      archivedLogDestId: map['archivedLogDestId'] == null ? null : map['archivedLogDestId'] as int,
      archivedLogsOnly: map['archivedLogsOnly'] == null ? null : map['archivedLogsOnly'] as bool,
      asmPassword: map['asmPassword'] == null ? null : map['asmPassword'] as String,
      ...
      charLengthSemantics: map['charLengthSemantics'] == null ? null : map['charLengthSemantics'] as String,
      convertTimestampWithZoneToUtc: map['convertTimestampWithZoneToUtc'] == null ? null : map['convertTimestampWithZoneToUtc'] as bool,
      directPathNoLog: map['directPathNoLog'] == null ? null : map['directPathNoLog'] as bool,
      directPathParallelLoad: map['directPathParallelLoad'] == null ? null : map['directPathParallelLoad'] as bool,
      enableHomogenousTablespace: map['enableHomogenousTablespace'] == null ? null : map['enableHomogenousTablespace'] as bool,
      extraArchivedLogDestIds: map['extraArchivedLogDestIds'] == null ? null : (map['extraArchivedLogDestIds'] as List).cast<int>(),
      failTaskOnLobTruncation: map['failTaskOnLobTruncation'] == null ? null : map['failTaskOnLobTruncation'] as bool,
      numberDatatypeScale: map['numberDatatypeScale'] == null ? null : map['numberDatatypeScale'] as int,
      openTransactionWindow: map['openTransactionWindow'] == null ? null : map['openTransactionWindow'] as int,
      oraclePathPrefix: map['oraclePathPrefix'] == null ? null : map['oraclePathPrefix'] as String,
      parallelAsmReadThreads: map['parallelAsmReadThreads'] == null ? null : map['parallelAsmReadThreads'] as int,
      readAheadBlocks: map['readAheadBlocks'] == null ? null : map['readAheadBlocks'] as int,
      readTableSpaceName: map['readTableSpaceName'] == null ? null : map['readTableSpaceName'] as bool,
      replacePathPrefix: map['replacePathPrefix'] == null ? null : map['replacePathPrefix'] as bool,
      retryInterval: map['retryInterval'] == null ? null : map['retryInterval'] as int,
      secretsManagerOracleAsmAccessRoleArn: map['secretsManagerOracleAsmAccessRoleArn'] == null ? null : map['secretsManagerOracleAsmAccessRoleArn'] as String,
      secretsManagerOracleAsmSecretId: map['secretsManagerOracleAsmSecretId'] == null ? null : map['secretsManagerOracleAsmSecretId'] as String,
      securityDbEncryption: map['securityDbEncryption'] == null ? null : map['securityDbEncryption'] as String,
      securityDbEncryptionName: map['securityDbEncryptionName'] == null ? null : map['securityDbEncryptionName'] as String,
      spatialDataOptionToGeoJsonFunctionName: map['spatialDataOptionToGeoJsonFunctionName'] == null ? null : map['spatialDataOptionToGeoJsonFunctionName'] as String,
      standbyDelayTime: map['standbyDelayTime'] == null ? null : map['standbyDelayTime'] as int,
      trimSpaceInChar: map['trimSpaceInChar'] == null ? null : map['trimSpaceInChar'] as bool,
      useAlternateFolderForOnline: map['useAlternateFolderForOnline'] == null ? null : map['useAlternateFolderForOnline'] as bool,
      useBfile: map['useBfile'] == null ? null : map['useBfile'] as bool,
      useDirectPathFullLoad: map['useDirectPathFullLoad'] == null ? null : map['useDirectPathFullLoad'] as bool,
      useLogminerReader: map['useLogminerReader'] == null ? null : map['useLogminerReader'] as bool,
      usePathPrefix: map['usePathPrefix'] == null ? null : map['usePathPrefix'] as String,
    );
  }
}
