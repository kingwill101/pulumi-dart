...
class EndpointOracleSettings {
  ...
  factory EndpointOracleSettings.fromMap(Map<String, dynamic> map) {
    return EndpointOracleSettings(
      ...
      additionalArchivedLogDestId: (() { final guardedValue = map['additionalArchivedLogDestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      archivedLogDestId: (() { final guardedValue = map['archivedLogDestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      numberDatatypeScale: (() { final guardedValue = map['numberDatatypeScale']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      openTransactionWindow: (() { final guardedValue = map['openTransactionWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      parallelAsmReadThreads: (() { final guardedValue = map['parallelAsmReadThreads']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      readAheadBlocks: (() { final guardedValue = map['readAheadBlocks']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      standbyDelayTime: (() { final guardedValue = map['standbyDelayTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
