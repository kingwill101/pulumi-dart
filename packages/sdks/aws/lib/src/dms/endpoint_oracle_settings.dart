...
class EndpointOracleSettings {
  ...
  factory EndpointOracleSettings.fromMap(Map<String, dynamic> map) {
    return EndpointOracleSettings(
      ...
      additionalArchivedLogDestId: (() { final guardedValue = map['additionalArchivedLogDestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      archivedLogDestId: (() { final guardedValue = map['archivedLogDestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      numberDatatypeScale: (() { final guardedValue = map['numberDatatypeScale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      openTransactionWindow: (() { final guardedValue = map['openTransactionWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      parallelAsmReadThreads: (() { final guardedValue = map['parallelAsmReadThreads']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      readAheadBlocks: (() { final guardedValue = map['readAheadBlocks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      standbyDelayTime: (() { final guardedValue = map['standbyDelayTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
