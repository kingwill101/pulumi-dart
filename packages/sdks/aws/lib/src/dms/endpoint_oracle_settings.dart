...
class EndpointOracleSettings {
  ...
  factory EndpointOracleSettings.fromMap(Map<String, dynamic> map) {
    return EndpointOracleSettings(
      accessAlternateDirectly: map['accessAlternateDirectly'] == null ? null : (map['accessAlternateDirectly'] as bool).input(),
      addSupplementalLogging: map['addSupplementalLogging'] == null ? null : (map['addSupplementalLogging'] as bool).input(),
      additionalArchivedLogDestId: map['additionalArchivedLogDestId'] == null ? null : (map['additionalArchivedLogDestId'] as int).input(),
      allowSelectedNestedTables: map['allowSelectedNestedTables'] == null ? null : (map['allowSelectedNestedTables'] as bool).input(),
      archivedLogDestId: map['archivedLogDestId'] == null ? null : (map['archivedLogDestId'] as int).input(),
      archivedLogsOnly: map['archivedLogsOnly'] == null ? null : (map['archivedLogsOnly'] as bool).input(),
      asmPassword: map['asmPassword'] == null ? null : (map['asmPassword'] as String).input(),
      asmServer: map['asmServer'] == null ? null : (map['asmServer'] as String).input(),
      asmUser: map['asmUser'] == null ? null : (map['asmUser'] as String).input(),
      authenticationMethod: map['authenticationMethod'] == null ? null : (map['authenticationMethod'] as String).input(),
      charLengthSemantics: map['charLengthSemantics'] == null ? null : (map['charLengthSemantics'] as String).input(),
      convertTimestampWithZoneToUtc: map['convertTimestampWithZoneToUtc'] == null ? null : (map['convertTimestampWithZoneToUtc'] as bool).input(),
      directPathNoLog: map['directPathNoLog'] == null ? null : (map['directPathNoLog'] as bool).input(),
      directPathParallelLoad: map['directPathParallelLoad'] == null ? null : (map['directPathParallelLoad'] as bool).input(),
      enableHomogenousTablespace: map['enableHomogenousTablespace'] == null ? null : (map['enableHomogenousTablespace'] as bool).input(),
      extraArchivedLogDestIds: map['extraArchivedLogDestIds'] == null ? null : ((map['extraArchivedLogDestIds'] as List).cast<int>()).input(),
      failTaskOnLobTruncation: map['failTaskOnLobTruncation'] == null ? null : (map['failTaskOnLobTruncation'] as bool).input(),
      numberDatatypeScale: map['numberDatatypeScale'] == null ? null : (map['numberDatatypeScale'] as int).input(),
      openTransactionWindow: map['openTransactionWindow'] == null ? null : (map['openTransactionWindow'] as int).input(),
      oraclePathPrefix: map['oraclePathPrefix'] == null ? null : (map['oraclePathPrefix'] as String).input(),
      parallelAsmReadThreads: map['parallelAsmReadThreads'] == null ? null : (map['parallelAsmReadThreads'] as int).input(),
      readAheadBlocks: map['readAheadBlocks'] == null ? null : (map['readAheadBlocks'] as int).input(),
      readTableSpaceName: map['readTableSpaceName'] == null ? null : (map['readTableSpaceName'] as bool).input(),
      replacePathPrefix: map['replacePathPrefix'] == null ? null : (map['replacePathPrefix'] as bool).input(),
      retryInterval: map['retryInterval'] == null ? null : (map['retryInterval'] as int).input(),
      secretsManagerOracleAsmAccessRoleArn: map['secretsManagerOracleAsmAccessRoleArn'] == null ? null : (map['secretsManagerOracleAsmAccessRoleArn'] as String).input(),
      secretsManagerOracleAsmSecretId: map['secretsManagerOracleAsmSecretId'] == null ? null : (map['secretsManagerOracleAsmSecretId'] as String).input(),
      securityDbEncryption: map['securityDbEncryption'] == null ? null : (map['securityDbEncryption'] as String).input(),
      securityDbEncryptionName: map['securityDbEncryptionName'] == null ? null : (map['securityDbEncryptionName'] as String).input(),
      spatialDataOptionToGeoJsonFunctionName: map['spatialDataOptionToGeoJsonFunctionName'] == null ? null : (map['spatialDataOptionToGeoJsonFunctionName'] as String).input(),
      standbyDelayTime: map['standbyDelayTime'] == null ? null : (map['standbyDelayTime'] as int).input(),
      trimSpaceInChar: map['trimSpaceInChar'] == null ? null : (map['trimSpaceInChar'] as bool).input(),
      useAlternateFolderForOnline: map['useAlternateFolderForOnline'] == null ? null : (map['useAlternateFolderForOnline'] as bool).input(),
      useBfile: map['useBfile'] == null ? null : (map['useBfile'] as bool).input(),
      useDirectPathFullLoad: map['useDirectPathFullLoad'] == null ? null : (map['useDirectPathFullLoad'] as bool).input(),
      useLogminerReader: map['useLogminerReader'] == null ? null : (map['useLogminerReader'] as bool).input(),
      usePathPrefix: map['usePathPrefix'] == null ? null : (map['usePathPrefix'] as String).input(),
    );
  }
}
