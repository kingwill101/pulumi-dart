...
class EndpointOracleSettings {
  ...
  factory EndpointOracleSettings.fromMap(Map<String, dynamic> map) {
    return EndpointOracleSettings(
      accessAlternateDirectly: (() { final guardedValue = map['accessAlternateDirectly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      addSupplementalLogging: (() { final guardedValue = map['addSupplementalLogging']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      additionalArchivedLogDestId: (() { final guardedValue = map['additionalArchivedLogDestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      allowSelectedNestedTables: (() { final guardedValue = map['allowSelectedNestedTables']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      archivedLogDestId: (() { final guardedValue = map['archivedLogDestId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      archivedLogsOnly: (() { final guardedValue = map['archivedLogsOnly']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      asmPassword: (() { final guardedValue = map['asmPassword']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      asmUser: (() { final guardedValue = map['asmUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      charLengthSemantics: (() { final guardedValue = map['charLengthSemantics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      convertTimestampWithZoneToUtc: (() { final guardedValue = map['convertTimestampWithZoneToUtc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      directPathNoLog: (() { final guardedValue = map['directPathNoLog']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      directPathParallelLoad: (() { final guardedValue = map['directPathParallelLoad']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      enableHomogenousTablespace: (() { final guardedValue = map['enableHomogenousTablespace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      extraArchivedLogDestIds: (() { final guardedValue = map['extraArchivedLogDestIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<int>()); })(),
      failTaskOnLobTruncation: (() { final guardedValue = map['failTaskOnLobTruncation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      numberDatatypeScale: (() { final guardedValue = map['numberDatatypeScale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      openTransactionWindow: (() { final guardedValue = map['openTransactionWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      oraclePathPrefix: (() { final guardedValue = map['oraclePathPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      parallelAsmReadThreads: (() { final guardedValue = map['parallelAsmReadThreads']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      readAheadBlocks: (() { final guardedValue = map['readAheadBlocks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      readTableSpaceName: (() { final guardedValue = map['readTableSpaceName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      replacePathPrefix: (() { final guardedValue = map['replacePathPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      securityDbEncryption: (() { final guardedValue = map['securityDbEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      securityDbEncryptionName: (() { final guardedValue = map['securityDbEncryptionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      spatialDataOptionToGeoJsonFunctionName: (() { final guardedValue = map['spatialDataOptionToGeoJsonFunctionName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      standbyDelayTime: (() { final guardedValue = map['standbyDelayTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      trimSpaceInChar: (() { final guardedValue = map['trimSpaceInChar']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      useAlternateFolderForOnline: (() { final guardedValue = map['useAlternateFolderForOnline']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      useBfile: (() { final guardedValue = map['useBfile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      useDirectPathFullLoad: (() { final guardedValue = map['useDirectPathFullLoad']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      useLogminerReader: (() { final guardedValue = map['useLogminerReader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      usePathPrefix: (() { final guardedValue = map['usePathPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
