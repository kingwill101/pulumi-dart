...
class EndpointRedshiftSettings {
  ...
  /// [serverSideEncryptionKmsKeyId] ARN or Id of KMS Key to use when `encryptionMode` is `SSE_KMS`.
  /// [serviceAccessRoleArn] ARN of the IAM Role with permissions to read from or write to the S3 Bucket for intermediate storage.
  const EndpointRedshiftSettings({
    this.bucketFolder,
    this.bucketName,
    this.encryptionMode,
