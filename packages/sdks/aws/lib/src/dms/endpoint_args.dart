...
class EndpointArgs {
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      elasticsearchSettings: map['elasticsearchSettings'] == null ? null : (EndpointElasticsearchSettings.fromMap((map['elasticsearchSettings'] as Map).cast<String, dynamic>())).input(),
      endpointId: (map['endpointId'] as String).input(),
      endpointType: (map['endpointType'] as String).input(),
      engineName: (map['engineName'] as String).input(),
      extraConnectionAttributes: map['extraConnectionAttributes'] == null ? null : (map['extraConnectionAttributes'] as String).input(),
      kafkaSettings: map['kafkaSettings'] == null ? null : (EndpointKafkaSettings.fromMap((map['kafkaSettings'] as Map).cast<String, dynamic>())).input(),
      kinesisSettings: map['kinesisSettings'] == null ? null : (EndpointKinesisSettings.fromMap((map['kinesisSettings'] as Map).cast<String, dynamic>())).input(),
      kmsKeyArn: map['kmsKeyArn'] == null ? null : (map['kmsKeyArn'] as String).input(),
      mongodbSettings: map['mongodbSettings'] == null ? null : (EndpointMongodbSettings.fromMap((map['mongodbSettings'] as Map).cast<String, dynamic>())).input(),
      mysqlSettings: map['mysqlSettings'] == null ? null : (EndpointMysqlSettings.fromMap((map['mysqlSettings'] as Map).cast<String, dynamic>())).input(),
      oracleSettings: map['oracleSettings'] == null ? null : (EndpointOracleSettings.fromMap((map['oracleSettings'] as Map).cast<String, dynamic>())).input(),
      password: map['password'] == null ? null : (map['password'] as String).input(),
      pauseReplicationTasks: map['pauseReplicationTasks'] == null ? null : (map['pauseReplicationTasks'] as bool).input(),
      port: map['port'] == null ? null : (map['port'] as int).input(),
      postgresSettings: map['postgresSettings'] == null ? null : (EndpointPostgresSettings.fromMap((map['postgresSettings'] as Map).cast<String, dynamic>())).input(),
      redisSettings: map['redisSettings'] == null ? null : (EndpointRedisSettings.fromMap((map['redisSettings'] as Map).cast<String, dynamic>())).input(),
      redshiftSettings: map['redshiftSettings'] == null ? null : (EndpointRedshiftSettings.fromMap((map['redshiftSettings'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      secretsManagerAccessRoleArn: map['secretsManagerAccessRoleArn'] == null ? null : (map['secretsManagerAccessRoleArn'] as String).input(),
      ...
      serviceAccessRole: map['serviceAccessRole'] == null ? null : (map['serviceAccessRole'] as String).input(),
