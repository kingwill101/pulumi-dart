...
class GetEndpointMysqlSetting {
  ...
  factory GetEndpointMysqlSetting.fromMap(Map<String, dynamic> map) {
    return GetEndpointMysqlSetting(
      ...
      eventsPollInterval: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['eventsPollInterval'])),
      executeTimeout: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['executeTimeout'])),
      ...
      parallelLoadThreads: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['parallelLoadThreads'])),
