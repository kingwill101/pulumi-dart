...
class GetEndpointMysqlSetting {
  ...
  factory GetEndpointMysqlSetting.fromMap(Map<String, dynamic> map) {
    return GetEndpointMysqlSetting(
      ...
      eventsPollInterval: pulumi.Input.fromValue((map['eventsPollInterval'] as num).toInt()),
      executeTimeout: pulumi.Input.fromValue((map['executeTimeout'] as num).toInt()),
      maxFileSize: pulumi.Input.fromValue((map['maxFileSize'] as num).toInt()),
      parallelLoadThreads: pulumi.Input.fromValue((map['parallelLoadThreads'] as num).toInt()),
