...
class S3EndpointArgs {
  ...
  S3EndpointArgs({
    pulumi.Output<bool>? addColumnName,
    pulumi.Output<bool>? addTrailingPaddingCharacter,
    pulumi.Output<String>? bucketFolder,
    required pulumi.Output<String> bucketName,
    pulumi.Output<String>? cannedAclForObjects,
    pulumi.Output<bool>? cdcInsertsAndUpdates,
    pulumi.Output<bool>? cdcInsertsOnly,
    pulumi.Output<int>? cdcMaxBatchInterval,
    pulumi.Output<int>? cdcMinFileSize,
    pulumi.Output<String>? cdcPath,
    pulumi.Output<String>? certificateArn,
    pulumi.Output<String>? compressionType,
    pulumi.Output<String>? csvDelimiter,
    pulumi.Output<String>? csvNoSupValue,
    pulumi.Output<String>? csvNullValue,
    pulumi.Output<String>? csvRowDelimiter,
    pulumi.Output<String>? dataFormat,
    pulumi.Output<int>? dataPageSize,
    pulumi.Output<String>? datePartitionDelimiter,
    pulumi.Output<bool>? datePartitionEnabled,
    pulumi.Output<String>? datePartitionSequence,
    pulumi.Output<String>? datePartitionTimezone,
    pulumi.Output<bool>? detachTargetOnLobLookupFailureParquet,
    pulumi.Output<int>? dictPageSizeLimit,
    pulumi.Output<bool>? enableStatistics,
    ...
    pulumi.Output<String>? externalTableDefinition,
    pulumi.Output<bool>? glueCatalogGeneration,
    pulumi.Output<int>? ignoreHeaderRows,
    pulumi.Output<bool>? includeOpForFullLoad,
    pulumi.Output<String>? kmsKeyArn,
    pulumi.Output<int>? maxFileSize,
    pulumi.Output<bool>? parquetTimestampInMillisecond,
    pulumi.Output<String>? parquetVersion,
    pulumi.Output<bool>? preserveTransactions,
    pulumi.Output<String>? region,
    pulumi.Output<bool>? rfc4180,
    pulumi.Output<int>? rowGroupLength,
    pulumi.Output<String>? serverSideEncryptionKmsKeyId,
    required pulumi.Output<String> serviceAccessRoleArn,
    pulumi.Output<String>? sslMode,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<String>? timestampColumnName,
    pulumi.Output<bool>? useCsvNoSupValue,
    pulumi.Output<bool>? useTaskStartTimeForFullLoadTimestamp,
  }) :
      addColumnName = pulumi.Input.asOptionalInput<bool>(addColumnName),
      addTrailingPaddingCharacter = pulumi.Input.asOptionalInput<bool>(addTrailingPaddingCharacter),
      bucketFolder = pulumi.Input.asOptionalInput<String>(bucketFolder),
      bucketName = pulumi.Input.asInput<String>(bucketName),
      cannedAclForObjects = pulumi.Input.asOptionalInput<String>(cannedAclForObjects),
      cdcInsertsAndUpdates = pulumi.Input.asOptionalInput<bool>(cdcInsertsAndUpdates),
      cdcInsertsOnly = pulumi.Input.asOptionalInput<bool>(cdcInsertsOnly),
      cdcMaxBatchInterval = pulumi.Input.asOptionalInput<int>(cdcMaxBatchInterval),
      ...
      datePartitionDelimiter = pulumi.Input.asOptionalInput<String>(datePartitionDelimiter),
      datePartitionEnabled = pulumi.Input.asOptionalInput<bool>(datePartitionEnabled),
      datePartitionSequence = pulumi.Input.asOptionalInput<String>(datePartitionSequence),
      datePartitionTimezone = pulumi.Input.asOptionalInput<String>(datePartitionTimezone),
      detachTargetOnLobLookupFailureParquet = pulumi.Input.asOptionalInput<bool>(detachTargetOnLobLookupFailureParquet),
      dictPageSizeLimit = pulumi.Input.asOptionalInput<int>(dictPageSizeLimit),
      ...
      externalTableDefinition = pulumi.Input.asOptionalInput<String>(externalTableDefinition),
      glueCatalogGeneration = pulumi.Input.asOptionalInput<bool>(glueCatalogGeneration),
      ignoreHeaderRows = pulumi.Input.asOptionalInput<int>(ignoreHeaderRows),
      includeOpForFullLoad = pulumi.Input.asOptionalInput<bool>(includeOpForFullLoad),
      kmsKeyArn = pulumi.Input.asOptionalInput<String>(kmsKeyArn),
      maxFileSize = pulumi.Input.asOptionalInput<int>(maxFileSize),
      parquetTimestampInMillisecond = pulumi.Input.asOptionalInput<bool>(parquetTimestampInMillisecond),
      parquetVersion = pulumi.Input.asOptionalInput<String>(parquetVersion),
      preserveTransactions = pulumi.Input.asOptionalInput<bool>(preserveTransactions),
      region = pulumi.Input.asOptionalInput<String>(region),
      rfc4180 = pulumi.Input.asOptionalInput<bool>(rfc4180),
      rowGroupLength = pulumi.Input.asOptionalInput<int>(rowGroupLength),
      serverSideEncryptionKmsKeyId = pulumi.Input.asOptionalInput<String>(serverSideEncryptionKmsKeyId),
      serviceAccessRoleArn = pulumi.Input.asInput<String>(serviceAccessRoleArn),
      sslMode = pulumi.Input.asOptionalInput<String>(sslMode),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      timestampColumnName = pulumi.Input.asOptionalInput<String>(timestampColumnName),
      useCsvNoSupValue = pulumi.Input.asOptionalInput<bool>(useCsvNoSupValue),
      useTaskStartTimeForFullLoadTimestamp = pulumi.Input.asOptionalInput<bool>(useTaskStartTimeForFullLoadTimestamp);
  ...
  factory S3EndpointArgs.fromMap(Map<String, dynamic> map) {
    return S3EndpointArgs(
      addColumnName: map['addColumnName'] == null ? null : pulumi.Output.create<bool>(map['addColumnName'] as bool),
      addTrailingPaddingCharacter: map['addTrailingPaddingCharacter'] == null ? null : pulumi.Output.create<bool>(map['addTrailingPaddingCharacter'] as bool),
      bucketFolder: map['bucketFolder'] == null ? null : pulumi.Output.create<String>(map['bucketFolder'] as String),
      bucketName: pulumi.Output.create<String>(map['bucketName'] as String),
      cannedAclForObjects: map['cannedAclForObjects'] == null ? null : pulumi.Output.create<String>(map['cannedAclForObjects'] as String),
      cdcInsertsAndUpdates: map['cdcInsertsAndUpdates'] == null ? null : pulumi.Output.create<bool>(map['cdcInsertsAndUpdates'] as bool),
      cdcInsertsOnly: map['cdcInsertsOnly'] == null ? null : pulumi.Output.create<bool>(map['cdcInsertsOnly'] as bool),
      cdcMaxBatchInterval: map['cdcMaxBatchInterval'] == null ? null : pulumi.Output.create<int>(map['cdcMaxBatchInterval'] as int),
      cdcMinFileSize: map['cdcMinFileSize'] == null ? null : pulumi.Output.create<int>(map['cdcMinFileSize'] as int),
      cdcPath: map['cdcPath'] == null ? null : pulumi.Output.create<String>(map['cdcPath'] as String),
      certificateArn: map['certificateArn'] == null ? null : pulumi.Output.create<String>(map['certificateArn'] as String),
      compressionType: map['compressionType'] == null ? null : pulumi.Output.create<String>(map['compressionType'] as String),
      csvDelimiter: map['csvDelimiter'] == null ? null : pulumi.Output.create<String>(map['csvDelimiter'] as String),
      csvNoSupValue: map['csvNoSupValue'] == null ? null : pulumi.Output.create<String>(map['csvNoSupValue'] as String),
      csvNullValue: map['csvNullValue'] == null ? null : pulumi.Output.create<String>(map['csvNullValue'] as String),
      csvRowDelimiter: map['csvRowDelimiter'] == null ? null : pulumi.Output.create<String>(map['csvRowDelimiter'] as String),
      dataFormat: map['dataFormat'] == null ? null : pulumi.Output.create<String>(map['dataFormat'] as String),
      dataPageSize: map['dataPageSize'] == null ? null : pulumi.Output.create<int>(map['dataPageSize'] as int),
      datePartitionDelimiter: map['datePartitionDelimiter'] == null ? null : pulumi.Output.create<String>(map['datePartitionDelimiter'] as String),
      datePartitionEnabled: map['datePartitionEnabled'] == null ? null : pulumi.Output.create<bool>(map['datePartitionEnabled'] as bool),
      datePartitionSequence: map['datePartitionSequence'] == null ? null : pulumi.Output.create<String>(map['datePartitionSequence'] as String),
      datePartitionTimezone: map['datePartitionTimezone'] == null ? null : pulumi.Output.create<String>(map['datePartitionTimezone'] as String),
      detachTargetOnLobLookupFailureParquet: map['detachTargetOnLobLookupFailureParquet'] == null ? null : pulumi.Output.create<bool>(map['detachTargetOnLobLookupFailureParquet'] as bool),
      dictPageSizeLimit: map['dictPageSizeLimit'] == null ? null : pulumi.Output.create<int>(map['dictPageSizeLimit'] as int),
      enableStatistics: map['enableStatistics'] == null ? null : pulumi.Output.create<bool>(map['enableStatistics'] as bool),
      ...
      externalTableDefinition: map['externalTableDefinition'] == null ? null : pulumi.Output.create<String>(map['externalTableDefinition'] as String),
      glueCatalogGeneration: map['glueCatalogGeneration'] == null ? null : pulumi.Output.create<bool>(map['glueCatalogGeneration'] as bool),
      ignoreHeaderRows: map['ignoreHeaderRows'] == null ? null : pulumi.Output.create<int>(map['ignoreHeaderRows'] as int),
      includeOpForFullLoad: map['includeOpForFullLoad'] == null ? null : pulumi.Output.create<bool>(map['includeOpForFullLoad'] as bool),
      kmsKeyArn: map['kmsKeyArn'] == null ? null : pulumi.Output.create<String>(map['kmsKeyArn'] as String),
      maxFileSize: map['maxFileSize'] == null ? null : pulumi.Output.create<int>(map['maxFileSize'] as int),
      parquetTimestampInMillisecond: map['parquetTimestampInMillisecond'] == null ? null : pulumi.Output.create<bool>(map['parquetTimestampInMillisecond'] as bool),
      parquetVersion: map['parquetVersion'] == null ? null : pulumi.Output.create<String>(map['parquetVersion'] as String),
      preserveTransactions: map['preserveTransactions'] == null ? null : pulumi.Output.create<bool>(map['preserveTransactions'] as bool),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      rfc4180: map['rfc4180'] == null ? null : pulumi.Output.create<bool>(map['rfc4180'] as bool),
      rowGroupLength: map['rowGroupLength'] == null ? null : pulumi.Output.create<int>(map['rowGroupLength'] as int),
      serverSideEncryptionKmsKeyId: map['serverSideEncryptionKmsKeyId'] == null ? null : pulumi.Output.create<String>(map['serverSideEncryptionKmsKeyId'] as String),
      serviceAccessRoleArn: pulumi.Output.create<String>(map['serviceAccessRoleArn'] as String),
      sslMode: map['sslMode'] == null ? null : pulumi.Output.create<String>(map['sslMode'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      timestampColumnName: map['timestampColumnName'] == null ? null : pulumi.Output.create<String>(map['timestampColumnName'] as String),
      useCsvNoSupValue: map['useCsvNoSupValue'] == null ? null : pulumi.Output.create<bool>(map['useCsvNoSupValue'] as bool),
      useTaskStartTimeForFullLoadTimestamp: map['useTaskStartTimeForFullLoadTimestamp'] == null ? null : pulumi.Output.create<bool>(map['useTaskStartTimeForFullLoadTimestamp'] as bool),
    );
  }
}
