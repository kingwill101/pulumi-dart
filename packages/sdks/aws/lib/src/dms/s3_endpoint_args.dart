...
class S3EndpointArgs {
  ...
  factory S3EndpointArgs.fromMap(Map<String, dynamic> map) {
    return S3EndpointArgs(
      addColumnName: map['addColumnName'] == null ? null : ((map['addColumnName'] as bool).input()).input(),
      addTrailingPaddingCharacter: map['addTrailingPaddingCharacter'] == null ? null : ((map['addTrailingPaddingCharacter'] as bool).input()).input(),
      bucketFolder: map['bucketFolder'] == null ? null : ((map['bucketFolder'] as String).input()).input(),
      bucketName: (map['bucketName'] as String).input(),
      cannedAclForObjects: map['cannedAclForObjects'] == null ? null : ((map['cannedAclForObjects'] as String).input()).input(),
      cdcInsertsAndUpdates: map['cdcInsertsAndUpdates'] == null ? null : ((map['cdcInsertsAndUpdates'] as bool).input()).input(),
      cdcInsertsOnly: map['cdcInsertsOnly'] == null ? null : ((map['cdcInsertsOnly'] as bool).input()).input(),
      cdcMaxBatchInterval: map['cdcMaxBatchInterval'] == null ? null : ((map['cdcMaxBatchInterval'] as int).input()).input(),
      cdcMinFileSize: map['cdcMinFileSize'] == null ? null : ((map['cdcMinFileSize'] as int).input()).input(),
      cdcPath: map['cdcPath'] == null ? null : ((map['cdcPath'] as String).input()).input(),
      certificateArn: map['certificateArn'] == null ? null : ((map['certificateArn'] as String).input()).input(),
      compressionType: map['compressionType'] == null ? null : ((map['compressionType'] as String).input()).input(),
      csvDelimiter: map['csvDelimiter'] == null ? null : ((map['csvDelimiter'] as String).input()).input(),
      csvNoSupValue: map['csvNoSupValue'] == null ? null : ((map['csvNoSupValue'] as String).input()).input(),
      csvNullValue: map['csvNullValue'] == null ? null : ((map['csvNullValue'] as String).input()).input(),
      csvRowDelimiter: map['csvRowDelimiter'] == null ? null : ((map['csvRowDelimiter'] as String).input()).input(),
      dataFormat: map['dataFormat'] == null ? null : ((map['dataFormat'] as String).input()).input(),
      dataPageSize: map['dataPageSize'] == null ? null : ((map['dataPageSize'] as int).input()).input(),
      datePartitionDelimiter: map['datePartitionDelimiter'] == null ? null : ((map['datePartitionDelimiter'] as String).input()).input(),
      datePartitionEnabled: map['datePartitionEnabled'] == null ? null : ((map['datePartitionEnabled'] as bool).input()).input(),
      datePartitionSequence: map['datePartitionSequence'] == null ? null : ((map['datePartitionSequence'] as String).input()).input(),
      datePartitionTimezone: map['datePartitionTimezone'] == null ? null : ((map['datePartitionTimezone'] as String).input()).input(),
      detachTargetOnLobLookupFailureParquet: map['detachTargetOnLobLookupFailureParquet'] == null ? null : ((map['detachTargetOnLobLookupFailureParquet'] as bool).input()).input(),
      dictPageSizeLimit: map['dictPageSizeLimit'] == null ? null : ((map['dictPageSizeLimit'] as int).input()).input(),
      enableStatistics: map['enableStatistics'] == null ? null : ((map['enableStatistics'] as bool).input()).input(),
      ...
      externalTableDefinition: map['externalTableDefinition'] == null ? null : ((map['externalTableDefinition'] as String).input()).input(),
      glueCatalogGeneration: map['glueCatalogGeneration'] == null ? null : ((map['glueCatalogGeneration'] as bool).input()).input(),
      ignoreHeaderRows: map['ignoreHeaderRows'] == null ? null : ((map['ignoreHeaderRows'] as int).input()).input(),
      includeOpForFullLoad: map['includeOpForFullLoad'] == null ? null : ((map['includeOpForFullLoad'] as bool).input()).input(),
      ...
      parquetTimestampInMillisecond: map['parquetTimestampInMillisecond'] == null ? null : ((map['parquetTimestampInMillisecond'] as bool).input()).input(),
      parquetVersion: map['parquetVersion'] == null ? null : ((map['parquetVersion'] as String).input()).input(),
      preserveTransactions: map['preserveTransactions'] == null ? null : ((map['preserveTransactions'] as bool).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      rfc4180: map['rfc4180'] == null ? null : ((map['rfc4180'] as bool).input()).input(),
      rowGroupLength: map['rowGroupLength'] == null ? null : ((map['rowGroupLength'] as int).input()).input(),
      ...
      sslMode: map['sslMode'] == null ? null : ((map['sslMode'] as String).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      timestampColumnName: map['timestampColumnName'] == null ? null : ((map['timestampColumnName'] as String).input()).input(),
      useCsvNoSupValue: map['useCsvNoSupValue'] == null ? null : ((map['useCsvNoSupValue'] as bool).input()).input(),
      useTaskStartTimeForFullLoadTimestamp: map['useTaskStartTimeForFullLoadTimestamp'] == null ? null : ((map['useTaskStartTimeForFullLoadTimestamp'] as bool).input()).input(),
    );
  }
}
