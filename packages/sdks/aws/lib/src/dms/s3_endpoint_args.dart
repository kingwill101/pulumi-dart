...
class S3EndpointArgs {
  ...
  factory S3EndpointArgs.fromMap(Map<String, dynamic> map) {
    return S3EndpointArgs(
      addColumnName: map['addColumnName'] == null ? null : (map['addColumnName'] as bool).input(),
      addTrailingPaddingCharacter: map['addTrailingPaddingCharacter'] == null ? null : (map['addTrailingPaddingCharacter'] as bool).input(),
      bucketFolder: map['bucketFolder'] == null ? null : (map['bucketFolder'] as String).input(),
      bucketName: (map['bucketName'] as String).input(),
      cannedAclForObjects: map['cannedAclForObjects'] == null ? null : (map['cannedAclForObjects'] as String).input(),
      cdcInsertsAndUpdates: map['cdcInsertsAndUpdates'] == null ? null : (map['cdcInsertsAndUpdates'] as bool).input(),
      cdcInsertsOnly: map['cdcInsertsOnly'] == null ? null : (map['cdcInsertsOnly'] as bool).input(),
      cdcMaxBatchInterval: map['cdcMaxBatchInterval'] == null ? null : (map['cdcMaxBatchInterval'] as int).input(),
      cdcMinFileSize: map['cdcMinFileSize'] == null ? null : (map['cdcMinFileSize'] as int).input(),
      cdcPath: map['cdcPath'] == null ? null : (map['cdcPath'] as String).input(),
      ...
      csvNoSupValue: map['csvNoSupValue'] == null ? null : (map['csvNoSupValue'] as String).input(),
      csvNullValue: map['csvNullValue'] == null ? null : (map['csvNullValue'] as String).input(),
      csvRowDelimiter: map['csvRowDelimiter'] == null ? null : (map['csvRowDelimiter'] as String).input(),
      dataFormat: map['dataFormat'] == null ? null : (map['dataFormat'] as String).input(),
      dataPageSize: map['dataPageSize'] == null ? null : (map['dataPageSize'] as int).input(),
      datePartitionDelimiter: map['datePartitionDelimiter'] == null ? null : (map['datePartitionDelimiter'] as String).input(),
      datePartitionEnabled: map['datePartitionEnabled'] == null ? null : (map['datePartitionEnabled'] as bool).input(),
      datePartitionSequence: map['datePartitionSequence'] == null ? null : (map['datePartitionSequence'] as String).input(),
      datePartitionTimezone: map['datePartitionTimezone'] == null ? null : (map['datePartitionTimezone'] as String).input(),
      detachTargetOnLobLookupFailureParquet: map['detachTargetOnLobLookupFailureParquet'] == null ? null : (map['detachTargetOnLobLookupFailureParquet'] as bool).input(),
      dictPageSizeLimit: map['dictPageSizeLimit'] == null ? null : (map['dictPageSizeLimit'] as int).input(),
      enableStatistics: map['enableStatistics'] == null ? null : (map['enableStatistics'] as bool).input(),
      ...
      externalTableDefinition: map['externalTableDefinition'] == null ? null : (map['externalTableDefinition'] as String).input(),
      glueCatalogGeneration: map['glueCatalogGeneration'] == null ? null : (map['glueCatalogGeneration'] as bool).input(),
      ignoreHeaderRows: map['ignoreHeaderRows'] == null ? null : (map['ignoreHeaderRows'] as int).input(),
      includeOpForFullLoad: map['includeOpForFullLoad'] == null ? null : (map['includeOpForFullLoad'] as bool).input(),
      kmsKeyArn: map['kmsKeyArn'] == null ? null : (map['kmsKeyArn'] as String).input(),
      maxFileSize: map['maxFileSize'] == null ? null : (map['maxFileSize'] as int).input(),
      parquetTimestampInMillisecond: map['parquetTimestampInMillisecond'] == null ? null : (map['parquetTimestampInMillisecond'] as bool).input(),
      parquetVersion: map['parquetVersion'] == null ? null : (map['parquetVersion'] as String).input(),
      preserveTransactions: map['preserveTransactions'] == null ? null : (map['preserveTransactions'] as bool).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      rfc4180: map['rfc4180'] == null ? null : (map['rfc4180'] as bool).input(),
      rowGroupLength: map['rowGroupLength'] == null ? null : (map['rowGroupLength'] as int).input(),
      ...
      timestampColumnName: map['timestampColumnName'] == null ? null : (map['timestampColumnName'] as String).input(),
      useCsvNoSupValue: map['useCsvNoSupValue'] == null ? null : (map['useCsvNoSupValue'] as bool).input(),
      useTaskStartTimeForFullLoadTimestamp: map['useTaskStartTimeForFullLoadTimestamp'] == null ? null : (map['useTaskStartTimeForFullLoadTimestamp'] as bool).input(),
    );
  }
}
