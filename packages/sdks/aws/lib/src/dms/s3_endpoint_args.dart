...
class S3EndpointArgs {
  ...
  factory S3EndpointArgs.fromMap(Map<String, dynamic> map) {
    return S3EndpointArgs(
      ...
      cdcMaxBatchInterval: (() { final guardedValue = map['cdcMaxBatchInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      cdcMinFileSize: (() { final guardedValue = map['cdcMinFileSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      dataPageSize: (() { final guardedValue = map['dataPageSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      dictPageSizeLimit: (() { final guardedValue = map['dictPageSizeLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      ignoreHeaderRows: (() { final guardedValue = map['ignoreHeaderRows']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      rowGroupLength: (() { final guardedValue = map['rowGroupLength']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
