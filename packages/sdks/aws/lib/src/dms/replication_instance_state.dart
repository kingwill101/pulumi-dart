...
class ReplicationInstanceState {
  ...
  factory ReplicationInstanceState.fromMap(Map<String, dynamic> map) {
    return ReplicationInstanceState(
      ...
      replicationInstanceClass: map['replicationInstanceClass'] == null ? null : ((map['replicationInstanceClass'] as String).input()).input(),
      replicationInstanceId: map['replicationInstanceId'] == null ? null : ((map['replicationInstanceId'] as String).input()).input(),
      replicationInstancePrivateIps: map['replicationInstancePrivateIps'] == null ? null : (((map['replicationInstancePrivateIps'] as List).cast<String>()).input()).input(),
      replicationInstancePublicIps: map['replicationInstancePublicIps'] == null ? null : (((map['replicationInstancePublicIps'] as List).cast<String>()).input()).input(),
