...
class ReplicationInstanceState {
  ...
  const ReplicationInstanceState({
  ...
  factory ReplicationInstanceState.fromMap(Map<String, dynamic> map) {
    return ReplicationInstanceState(
      ...
      kerberosAuthenticationSettings: (() { final guardedValue = map['kerberosAuthenticationSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ReplicationInstanceKerberosAuthenticationSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      replicationInstanceId: (() { final guardedValue = map['replicationInstanceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replicationInstancePrivateIps: (() { final guardedValue = map['replicationInstancePrivateIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      replicationInstancePublicIps: (() { final guardedValue = map['replicationInstancePublicIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
