...
class DataProviderSettingsMariaDbSettings {
  ...
  /// Creates a new [DataProviderSettingsMariaDbSettings].
  /// [certificateArn] ARN of the DMS certificate used for the SSL connection.
  /// [port] Port of the MariaDB server. Valid values are between `1` and `65535`.
  ...
  factory DataProviderSettingsMariaDbSettings.fromMap(Map<String, dynamic> map) {
    return DataProviderSettingsMariaDbSettings(
