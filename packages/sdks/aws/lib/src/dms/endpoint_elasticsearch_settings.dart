...
class EndpointElasticsearchSettings {
  ...
  factory EndpointElasticsearchSettings.fromMap(Map<String, dynamic> map) {
    return EndpointElasticsearchSettings(
      ...
      errorRetryDuration: (() { final guardedValue = map['errorRetryDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      fullLoadErrorPercentage: (() { final guardedValue = map['fullLoadErrorPercentage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
