...
class EndpointPostgresSettings {
  ...
  factory EndpointPostgresSettings.fromMap(Map<String, dynamic> map) {
    return EndpointPostgresSettings(
      afterConnectScript: (() {
        final guardedValue = map['afterConnectScript'];
      ...
      babelfishDatabaseName: (() {
        final guardedValue = map['babelfishDatabaseName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      captureDdls: (() {
        final guardedValue = map['captureDdls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      databaseMode: (() {
        final guardedValue = map['databaseMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ddlArtifactsSchema: (() {
        final guardedValue = map['ddlArtifactsSchema'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      executeTimeout: (() {
        final guardedValue = map['executeTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      failTasksOnLobTruncation: (() {
        final guardedValue = map['failTasksOnLobTruncation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      heartbeatEnable: (() {
        final guardedValue = map['heartbeatEnable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      heartbeatFrequency: (() {
        final guardedValue = map['heartbeatFrequency'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      heartbeatSchema: (() {
        final guardedValue = map['heartbeatSchema'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mapBooleanAsBoolean: (() {
        final guardedValue = map['mapBooleanAsBoolean'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      mapJsonbAsClob: (() {
        final guardedValue = map['mapJsonbAsClob'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      mapLongVarcharAs: (() {
        final guardedValue = map['mapLongVarcharAs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxFileSize: (() {
