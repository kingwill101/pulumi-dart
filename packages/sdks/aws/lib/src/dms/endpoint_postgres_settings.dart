...
class EndpointPostgresSettings {
  ...
  factory EndpointPostgresSettings.fromMap(Map<String, dynamic> map) {
    return EndpointPostgresSettings(
      ...
      babelfishDatabaseName: map['babelfishDatabaseName'] == null ? null : ((map['babelfishDatabaseName'] as String).input()).input(),
      captureDdls: map['captureDdls'] == null ? null : ((map['captureDdls'] as bool).input()).input(),
      databaseMode: map['databaseMode'] == null ? null : ((map['databaseMode'] as String).input()).input(),
      ddlArtifactsSchema: map['ddlArtifactsSchema'] == null ? null : ((map['ddlArtifactsSchema'] as String).input()).input(),
      executeTimeout: map['executeTimeout'] == null ? null : ((map['executeTimeout'] as int).input()).input(),
      failTasksOnLobTruncation: map['failTasksOnLobTruncation'] == null ? null : ((map['failTasksOnLobTruncation'] as bool).input()).input(),
      heartbeatEnable: map['heartbeatEnable'] == null ? null : ((map['heartbeatEnable'] as bool).input()).input(),
      heartbeatFrequency: map['heartbeatFrequency'] == null ? null : ((map['heartbeatFrequency'] as int).input()).input(),
      heartbeatSchema: map['heartbeatSchema'] == null ? null : ((map['heartbeatSchema'] as String).input()).input(),
      mapBooleanAsBoolean: map['mapBooleanAsBoolean'] == null ? null : ((map['mapBooleanAsBoolean'] as bool).input()).input(),
      mapJsonbAsClob: map['mapJsonbAsClob'] == null ? null : ((map['mapJsonbAsClob'] as bool).input()).input(),
      mapLongVarcharAs: map['mapLongVarcharAs'] == null ? null : ((map['mapLongVarcharAs'] as String).input()).input(),
      maxFileSize: map['maxFileSize'] == null ? null : ((map['maxFileSize'] as int).input()).input(),
      pluginName: map['pluginName'] == null ? null : ((map['pluginName'] as String).input()).input(),
      serviceAccessRoleArn: map['serviceAccessRoleArn'] == null ? null : ((map['serviceAccessRoleArn'] as String).input()).input(),
      slotName: map['slotName'] == null ? null : ((map['slotName'] as String).input()).input(),
    );
  }
}
