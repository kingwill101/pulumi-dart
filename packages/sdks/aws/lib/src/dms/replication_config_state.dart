...
class ReplicationConfigState {
  ...
  factory ReplicationConfigState.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigState(
      ...
      computeConfig: map['computeConfig'] == null ? null : ((ReplicationConfigComputeConfig.fromMap((map['computeConfig']! as Map).cast<String, dynamic>())).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      replicationConfigIdentifier: map['replicationConfigIdentifier'] == null ? null : ((map['replicationConfigIdentifier'] as String).input()).input(),
      replicationSettings: map['replicationSettings'] == null ? null : ((map['replicationSettings'] as String).input()).input(),
      replicationType: map['replicationType'] == null ? null : ((map['replicationType'] as String).input()).input(),
      ...
      startReplication: map['startReplication'] == null ? null : ((map['startReplication'] as bool).input()).input(),
      supplementalSettings: map['supplementalSettings'] == null ? null : ((map['supplementalSettings'] as String).input()).input(),
