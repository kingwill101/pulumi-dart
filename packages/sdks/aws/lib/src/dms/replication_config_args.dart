...
class ReplicationConfigArgs {
  ...
  factory ReplicationConfigArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationConfigArgs(
      computeConfig: pulumi.Input.fromValue(ReplicationConfigComputeConfig.fromMap((map['computeConfig']! as Map).cast<String, dynamic>())),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replicationConfigIdentifier: pulumi.Input.fromValue(map['replicationConfigIdentifier'] as String),
