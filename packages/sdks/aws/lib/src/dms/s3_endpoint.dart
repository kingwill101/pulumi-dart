...
class S3Endpoint extends pulumi.CustomResource {
  ...
  S3Endpoint(
    ...
    addTrailingPaddingCharacter = registerOutput<bool?>(
    ...
    detachTargetOnLobLookupFailureParquet = registerOutput<bool?>(
    ...
    externalTableDefinition = registerOutput<String?>(
    ...
    parquetTimestampInMillisecond = registerOutput<bool?>(
    ...
    serverSideEncryptionKmsKeyId = registerOutput<String?>(
    ...
    useTaskStartTimeForFullLoadTimestamp = registerOutput<bool?>(
