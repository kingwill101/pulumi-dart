...
class DataProviderSettingsMysqlSettings {
  ...
  /// Creates a new [DataProviderSettingsMysqlSettings].
  /// [certificateArn] ARN of the DMS certificate used for the SSL connection.
  /// [port] Port of the MySQL server. Valid values are between `1` and `65535`.
  ...
  factory DataProviderSettingsMysqlSettings.fromMap(Map<String, dynamic> map) {
    return DataProviderSettingsMysqlSettings(
