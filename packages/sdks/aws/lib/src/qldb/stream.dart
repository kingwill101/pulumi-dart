...
class Stream extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Stream]. {@macro pulumi_qldb_stream_stream_args_doc}
  ...
  Stream(
    ...
    this.kinesisConfiguration = registerOutput<StreamKinesisConfiguration>('kinesisConfiguration');
