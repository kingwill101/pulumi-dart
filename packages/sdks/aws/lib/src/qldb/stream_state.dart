...
class StreamState {
  ...
  factory StreamState.fromMap(Map<String, dynamic> map) {
    return StreamState(
      ...
      exclusiveEndTime: (() {
        final guardedValue = map['exclusiveEndTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inclusiveStartTime: (() {
        final guardedValue = map['inclusiveStartTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kinesisConfiguration: (() {
        final guardedValue = map['kinesisConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StreamKinesisConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ledgerName: (() {
        final guardedValue = map['ledgerName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
