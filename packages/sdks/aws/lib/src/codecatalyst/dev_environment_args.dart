...
class DevEnvironmentArgs {
  ...
  factory DevEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return DevEnvironmentArgs(
      ...
      ides: pulumi.Input.fromValue(
        DevEnvironmentIdes.fromMap(
          (map['ides']! as Map).cast<String, dynamic>(),
        ),
      ),
      inactivityTimeoutMinutes: (() {
        final guardedValue = map['inactivityTimeoutMinutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      persistentStorage: pulumi.Input.fromValue(
        DevEnvironmentPersistentStorage.fromMap(
