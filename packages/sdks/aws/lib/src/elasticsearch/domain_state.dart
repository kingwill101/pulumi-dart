...
class DomainState {
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      elasticsearchVersion: map['elasticsearchVersion'] == null ? null : ((map['elasticsearchVersion'] as String).input()).input(),
      ...
      kibanaEndpoint: map['kibanaEndpoint'] == null ? null : ((map['kibanaEndpoint'] as String).input()).input(),
