...
class GetDomainAutoTuneOptionMaintenanceSchedule {
  ...
  final pulumi.Input<List<GetDomainAutoTuneOptionMaintenanceScheduleDuration>>
  durations;
    ...
    return <String, dynamic>{
      ...
      'durations':
          pulumi.Input.mapInputValue<
            List<GetDomainAutoTuneOptionMaintenanceScheduleDuration>,
  ...
  factory GetDomainAutoTuneOptionMaintenanceSchedule.fromMap(
    ...
    return GetDomainAutoTuneOptionMaintenanceSchedule(
      ...
      durations: pulumi.Input.fromValue(
