...
class IntegrationArgs {
  ...
  factory IntegrationArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationArgs(
      cacheKeyParameters: (() {
        final guardedValue = map['cacheKeyParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      cacheNamespace: (() {
        final guardedValue = map['cacheNamespace'];
        if (guardedValue == null) return null;
      ...
      integrationHttpMethod: (() {
        final guardedValue = map['integrationHttpMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      integrationTarget: (() {
        final guardedValue = map['integrationTarget'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      passthroughBehavior: (() {
      ...
      responseTransferMode: (() {
        final guardedValue = map['responseTransferMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
