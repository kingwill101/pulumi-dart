...
class IntegrationArgs {
  ...
  factory IntegrationArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationArgs(
      cacheKeyParameters: map['cacheKeyParameters'] == null ? null : ((map['cacheKeyParameters'] as List).cast<String>()).input(),
      ...
      integrationHttpMethod: map['integrationHttpMethod'] == null ? null : (map['integrationHttpMethod'] as String).input(),
      integrationTarget: map['integrationTarget'] == null ? null : (map['integrationTarget'] as String).input(),
      ...
      responseTransferMode: map['responseTransferMode'] == null ? null : (map['responseTransferMode'] as String).input(),
