...
class IntegrationTlsConfig {
  ...
  final pulumi.Input<bool>? insecureSkipVerification;
  ...
  factory IntegrationTlsConfig.fromMap(Map<String, dynamic> map) {
    return IntegrationTlsConfig(
      insecureSkipVerification: (() { final guardedValue = map['insecureSkipVerification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
