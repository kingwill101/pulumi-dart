  ...
  factory AuthorizerState.fromMap(Map<String, dynamic> map) {
    return AuthorizerState(
      ...
      authorizerCredentials: (() {
        final guardedValue = map['authorizerCredentials'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      identitySource: (() {
        final guardedValue = map['identitySource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      identityValidationExpression: (() {
        final guardedValue = map['identityValidationExpression'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      providerArns: (() {
        final guardedValue = map['providerArns'];
        if (guardedValue == null) return null;
