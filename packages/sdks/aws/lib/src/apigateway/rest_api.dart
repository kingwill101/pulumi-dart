...
class RestApi extends pulumi.CustomResource {
  ...
  RestApi(
    ...
    this.endpointConfiguration = registerOutput<RestApiEndpointConfiguration>('endpointConfiguration');
    this.executionArn = registerOutput<String>('executionArn');
    this.failOnWarnings = registerOutput<bool?>('failOnWarnings');
    this.minimumCompressionSize = registerOutput<String>('minimumCompressionSize');
