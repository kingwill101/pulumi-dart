...
class DomainNameAccessAssociationState {
  ...
  const DomainNameAccessAssociationState({
  ...
  factory DomainNameAccessAssociationState.fromMap(Map<String, dynamic> map) {
    return DomainNameAccessAssociationState(
      accessAssociationSource: (() { final guardedValue = map['accessAssociationSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      accessAssociationSourceType: (() { final guardedValue = map['accessAssociationSourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      arn: (() { final guardedValue = map['arn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      domainNameArn: (() { final guardedValue = map['domainNameArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
