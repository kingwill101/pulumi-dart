...
class DomainNameState {
  ...
  /// [certificateBody] Certificate issued for the domain name being registered, in PEM format. Only valid for `EDGE` endpoint configuration type. Conflicts with `certificateArn`, `regionalCertificateArn`, and `regionalCertificateName`.
  /// [certificateChain] Certificate for the CA that issued the certificate, along with any intermediate CA certificates required to create an unbroken chain to a certificate trusted by the intended API clients. Only valid for `EDGE` endpoint configuration type. Conflicts with `certificateArn`, `regionalCertificateArn`, and `regionalCertificateName`.
  /// [certificateName] Unique name to use when registering this certificate as an IAM server certificate. Conflicts with `certificateArn`, `regionalCertificateArn`, and `regionalCertificateName`. Required if `certificateArn` is not set.
  /// [certificatePrivateKey] Private key associated with the domain certificate given in `certificateBody`. Only valid for `EDGE` endpoint configuration type. Conflicts with `certificateArn`, `regionalCertificateArn`, and `regionalCertificateName`.
  ...
  factory DomainNameState.fromMap(Map<String, dynamic> map) {
    return DomainNameState(
      ...
      certificatePrivateKey: (() { final guardedValue = map['certificatePrivateKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      certificateUploadDate: (() { final guardedValue = map['certificateUploadDate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudfrontDomainName: (() { final guardedValue = map['cloudfrontDomainName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      cloudfrontZoneId: (() { final guardedValue = map['cloudfrontZoneId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      endpointConfiguration: (() { final guardedValue = map['endpointConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainNameEndpointConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      regionalCertificateArn: (() { final guardedValue = map['regionalCertificateArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      regionalCertificateName: (() { final guardedValue = map['regionalCertificateName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      regionalZoneId: (() { final guardedValue = map['regionalZoneId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
