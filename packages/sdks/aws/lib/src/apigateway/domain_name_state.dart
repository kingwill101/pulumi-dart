...
class DomainNameState {
  ...
  factory DomainNameState.fromMap(Map<String, dynamic> map) {
    return DomainNameState(
      ...
      certificateUploadDate: map['certificateUploadDate'] == null ? null : ((map['certificateUploadDate'] as String).input()).input(),
      cloudfrontDomainName: map['cloudfrontDomainName'] == null ? null : ((map['cloudfrontDomainName'] as String).input()).input(),
      cloudfrontZoneId: map['cloudfrontZoneId'] == null ? null : ((map['cloudfrontZoneId'] as String).input()).input(),
      ...
      regionalDomainName: map['regionalDomainName'] == null ? null : ((map['regionalDomainName'] as String).input()).input(),
      regionalZoneId: map['regionalZoneId'] == null ? null : ((map['regionalZoneId'] as String).input()).input(),
