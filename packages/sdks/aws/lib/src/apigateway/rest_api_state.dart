...
class RestApiState {
  ...
  factory RestApiState.fromMap(Map<String, dynamic> map) {
    return RestApiState(
      apiKeySource: map['apiKeySource'] == null ? null : ((map['apiKeySource'] as String).input()).input(),
      arn: map['arn'] == null ? null : ((map['arn'] as String).input()).input(),
      binaryMediaTypes: map['binaryMediaTypes'] == null ? null : (((map['binaryMediaTypes'] as List).cast<String>()).input()).input(),
      ...
      endpointConfiguration: map['endpointConfiguration'] == null ? null : ((RestApiEndpointConfiguration.fromMap((map['endpointConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      minimumCompressionSize: map['minimumCompressionSize'] == null ? null : ((map['minimumCompressionSize'] as String).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      parameters: map['parameters'] == null ? null : (((map['parameters'] as Map).cast<String, String>()).input()).input(),
      policy: map['policy'] == null ? null : ((map['policy'] as String).input()).input(),
      putRestApiMode: map['putRestApiMode'] == null ? null : ((map['putRestApiMode'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      rootResourceId: map['rootResourceId'] == null ? null : ((map['rootResourceId'] as String).input()).input(),
