...
class MaintenanceWindowTaskState {
  ...
  factory MaintenanceWindowTaskState.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowTaskState(
      ...
      taskArn: (() { final guardedValue = map['taskArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      windowTaskId: (() { final guardedValue = map['windowTaskId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
