...
class MaintenanceWindowTaskState {
  ...
  factory MaintenanceWindowTaskState.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowTaskState(
      ...
      taskArn: map['taskArn'] == null ? null : ((map['taskArn'] as String).input()).input(),
      ...
      taskType: map['taskType'] == null ? null : ((map['taskType'] as String).input()).input(),
      windowId: map['windowId'] == null ? null : ((map['windowId'] as String).input()).input(),
      windowTaskId: map['windowTaskId'] == null ? null : ((map['windowTaskId'] as String).input()).input(),
    );
  }
}
