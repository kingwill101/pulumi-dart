    ...
    return MaintenanceWindowTaskTaskInvocationParametersRunCommandParameters(
      cloudwatchConfig: (() {
        ...
        return pulumi.Input.fromValue(
          MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfig.fromMap(
      ...
      documentHash: (() {
        final guardedValue = map['documentHash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      documentHashType: (() {
        final guardedValue = map['documentHashType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      documentVersion: (() {
        final guardedValue = map['documentVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      notificationConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outputS3Bucket: (() {
        final guardedValue = map['outputS3Bucket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      outputS3KeyPrefix: (() {
        final guardedValue = map['outputS3KeyPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parameters: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameter.fromMap(
