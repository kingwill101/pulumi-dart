...
class GetContactsRotationRecurrence {
  final pulumi.Input<List<GetContactsRotationRecurrenceDailySetting>>
  dailySettings;
  final pulumi.Input<List<GetContactsRotationRecurrenceMonthlySetting>>
  monthlySettings;
  final pulumi.Input<int> numberOfOnCalls;
  final pulumi.Input<int> recurrenceMultiplier;
  final pulumi.Input<List<GetContactsRotationRecurrenceShiftCoverage>>
  shiftCoverages;
  final pulumi.Input<List<GetContactsRotationRecurrenceWeeklySetting>>
  weeklySettings;
    ...
    return <String, dynamic>{
      'dailySettings':
          pulumi.Input.mapInputValue<
            List<GetContactsRotationRecurrenceDailySetting>,
      ...
      'monthlySettings':
          pulumi.Input.mapInputValue<
            List<GetContactsRotationRecurrenceMonthlySetting>,
            List<Map<String, dynamic>>
          >(
            monthlySettings,
            (value) =>
      ...
      'shiftCoverages':
          pulumi.Input.mapInputValue<
            List<GetContactsRotationRecurrenceShiftCoverage>,
            List<Map<String, dynamic>>
          >(
            shiftCoverages,
            (value) =>
      ...
      'weeklySettings':
          pulumi.Input.mapInputValue<
            List<GetContactsRotationRecurrenceWeeklySetting>,
            List<Map<String, dynamic>>
          >(
            weeklySettings,
            (value) =>
  ...
  factory GetContactsRotationRecurrence.fromMap(Map<String, dynamic> map) {
    return GetContactsRotationRecurrence(
      dailySettings: pulumi.Input.fromValue(
      ...
      monthlySettings: pulumi.Input.fromValue(
      ...
      numberOfOnCalls: pulumi.Input.fromValue(map['numberOfOnCalls'] as int),
      recurrenceMultiplier: pulumi.Input.fromValue(
        map['recurrenceMultiplier'] as int,
      ),
      shiftCoverages: pulumi.Input.fromValue(
      ...
      weeklySettings: pulumi.Input.fromValue(
