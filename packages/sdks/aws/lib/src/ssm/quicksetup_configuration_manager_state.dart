...
class QuicksetupConfigurationManagerState {
  ...
  /// [statusSummaries] A summary of the state of the configuration manager. This includes deployment statuses, association statuses, drift statuses, health checks, and more. See `statusSummaries` below.
  /// [tags] Map of tags assigned to the resource. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
  /// [tagsAll] Map of tags assigned to the resource, including those inherited from the provider `defaultTags` configuration block.
  /// [timeouts] Optional.
  const QuicksetupConfigurationManagerState({
  ...
  factory QuicksetupConfigurationManagerState.fromMap(Map<String, dynamic> map) {
    return QuicksetupConfigurationManagerState(
      configurationDefinition: (() { final guardedValue = map['configurationDefinition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QuicksetupConfigurationManagerConfigurationDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      managerArn: (() { final guardedValue = map['managerArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      statusSummaries: (() { final guardedValue = map['statusSummaries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<QuicksetupConfigurationManagerStatusSummary>(guardedValue, (value) => QuicksetupConfigurationManagerStatusSummary.fromMap((value as Map).cast<String, dynamic>()))); })(),
