...
class ResourceDataSyncState {
  ...
  factory ResourceDataSyncState.fromMap(Map<String, dynamic> map) {
    return ResourceDataSyncState(
      ...
      s3Destination: (() { final guardedValue = map['s3Destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceDataSyncS3Destination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
