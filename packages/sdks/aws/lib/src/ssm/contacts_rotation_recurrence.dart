...
class ContactsRotationRecurrence {
  final pulumi.Input<List<ContactsRotationRecurrenceDailySetting>>?
  dailySettings;

  /// (Optional) Information about on-call rotations that recur monthly. See Monthly Settings for more details.
  final pulumi.Input<List<ContactsRotationRecurrenceMonthlySetting>>?
  monthlySettings;
  ...
  final pulumi.Input<List<ContactsRotationRecurrenceShiftCoverage>>?
  shiftCoverages;

  /// (Optional) Information about on-call rotations that recur weekly. See Weekly Settings for more details.
  final pulumi.Input<List<ContactsRotationRecurrenceWeeklySetting>>?
  weeklySettings;
    ...
    return <String, dynamic>{
      'dailySettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContactsRotationRecurrenceDailySetting>,
      ...
      'monthlySettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContactsRotationRecurrenceMonthlySetting>,
            List<Map<String, dynamic>>
          >(
            monthlySettings,
            (value) =>
      ...
      'shiftCoverages':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContactsRotationRecurrenceShiftCoverage>,
            List<Map<String, dynamic>>
          >(
            shiftCoverages,
            (value) =>
      ...
      'weeklySettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ContactsRotationRecurrenceWeeklySetting>,
            List<Map<String, dynamic>>
          >(
            weeklySettings,
            (value) =>
  ...
  factory ContactsRotationRecurrence.fromMap(Map<String, dynamic> map) {
    return ContactsRotationRecurrence(
      dailySettings: (() {
        final guardedValue = map['dailySettings'];
      ...
      monthlySettings: (() {
        final guardedValue = map['monthlySettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      shiftCoverages: (() {
        final guardedValue = map['shiftCoverages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      weeklySettings: (() {
        final guardedValue = map['weeklySettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
