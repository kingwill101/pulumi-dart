...
class ResourceDataSyncArgs {
  ...
  ResourceDataSyncArgs({
    ...
    required pulumi.Output<ResourceDataSyncS3Destination> s3Destination,
  }) :
  ...
  factory ResourceDataSyncArgs.fromMap(Map<String, dynamic> map) {
    return ResourceDataSyncArgs(
      ...
      s3Destination: pulumi.Output.create<ResourceDataSyncS3Destination>(ResourceDataSyncS3Destination.fromMap((map['s3Destination'] as Map).cast<String, dynamic>())),
    );
  }
}
