...
class PatchGroupState {
  ...
  factory PatchGroupState.fromMap(Map<String, dynamic> map) {
    return PatchGroupState(
      ...
      patchGroup: (() { final guardedValue = map['patchGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
