...
class PatchBaselineApprovalRule {
    ...
    return <String, dynamic>{
      ...
      'patchFilters':
          pulumi.Input.mapInputValue<
            List<PatchBaselineApprovalRulePatchFilter>,
  ...
  factory PatchBaselineApprovalRule.fromMap(Map<String, dynamic> map) {
    return PatchBaselineApprovalRule(
      approveAfterDays: (() {
        final guardedValue = map['approveAfterDays'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      approveUntilDate: (() {
        final guardedValue = map['approveUntilDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      complianceLevel: (() {
        final guardedValue = map['complianceLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      enableNonSecurity: (() {
        final guardedValue = map['enableNonSecurity'];
        if (guardedValue == null) return null;
