...
class ContactsRotationRecurrenceShiftCoverageCoverageTime {
  ...
  factory ContactsRotationRecurrenceShiftCoverageCoverageTime.fromMap(Map<String, dynamic> map) {
    return ContactsRotationRecurrenceShiftCoverageCoverageTime(
      end: (() { final guardedValue = map['end']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContactsRotationRecurrenceShiftCoverageCoverageTimeEnd.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      start: (() { final guardedValue = map['start']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContactsRotationRecurrenceShiftCoverageCoverageTimeStart.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
