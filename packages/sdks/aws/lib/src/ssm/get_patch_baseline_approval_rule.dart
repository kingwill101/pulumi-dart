...
class GetPatchBaselineApprovalRule {
  ...
  final pulumi.Input<List<GetPatchBaselineApprovalRulePatchFilter>>
  patchFilters;
    ...
    return <String, dynamic>{
      ...
      'patchFilters':
          pulumi.Input.mapInputValue<
            List<GetPatchBaselineApprovalRulePatchFilter>,
