...
class MaintenanceWindowTargetArgs {
  ...
  const MaintenanceWindowTargetArgs({
    this.description,
    this.name,
  ...
  factory MaintenanceWindowTargetArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowTargetArgs(
      ...
      targets: pulumi.Input.fromValue(pulumi.Input.decodeList<MaintenanceWindowTargetTarget>(map['targets']!, (value) => MaintenanceWindowTargetTarget.fromMap((value as Map).cast<String, dynamic>()))),
