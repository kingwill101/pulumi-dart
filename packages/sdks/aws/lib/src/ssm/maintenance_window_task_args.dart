...
class MaintenanceWindowTaskArgs {
  ...
  factory MaintenanceWindowTaskArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceWindowTaskArgs(
      cutoffBehavior: (() { final guardedValue = map['cutoffBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      targets: (() { final guardedValue = map['targets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MaintenanceWindowTaskTarget>(guardedValue, (value) => MaintenanceWindowTaskTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
      taskArn: pulumi.Input.fromValue(map['taskArn'] as String),
      taskInvocationParameters: (() { final guardedValue = map['taskInvocationParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MaintenanceWindowTaskTaskInvocationParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
