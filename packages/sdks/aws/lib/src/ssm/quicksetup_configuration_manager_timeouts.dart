...
class QuicksetupConfigurationManagerTimeouts {
  ...
  /// Creates a new [QuicksetupConfigurationManagerTimeouts].
  ...
  const QuicksetupConfigurationManagerTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory QuicksetupConfigurationManagerTimeouts.fromMap(Map<String, dynamic> map) {
