...
class QuicksetupConfigurationManager extends pulumi.CustomResource {
  ...
  QuicksetupConfigurationManager(
    ...
    this.configurationDefinition = registerOutput<QuicksetupConfigurationManagerConfigurationDefinition>('configurationDefinition');
    this.description = registerOutput<String>('description');
    this.managerArn = registerOutput<String>('managerArn');
    this.name = registerOutput<String>('name');
    this.region = registerOutput<String>('region');
    this.statusSummaries = registerOutput<List<QuicksetupConfigurationManagerStatusSummary>>('statusSummaries');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.timeouts = registerOutput<QuicksetupConfigurationManagerTimeouts?>('timeouts');
  }
