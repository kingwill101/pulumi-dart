...
class AssociationState {
    ...
    return <String, dynamic>{
      ...
      'outputLocation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(outputLocation, (value) => value.toMap()),
  ...
  factory AssociationState.fromMap(Map<String, dynamic> map) {
    return AssociationState(
      applyOnlyAtCronInterval: (() {
        final guardedValue = map['applyOnlyAtCronInterval'];
      ...
      automationTargetParameterName: (() {
        final guardedValue = map['automationTargetParameterName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      calendarNames: (() {
        final guardedValue = map['calendarNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      complianceSeverity: (() {
        final guardedValue = map['complianceSeverity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      documentVersion: (() {
      ...
      outputLocation: (() {
        ...
        return pulumi.Input.fromValue(
          AssociationOutputLocation.fromMap(
      ...
      syncCompliance: (() {
        final guardedValue = map['syncCompliance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
      ...
      targets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AssociationTarget>(
            guardedValue,
            (value) => AssociationTarget.fromMap(
      ...
      waitForSuccessTimeoutSeconds: (() {
        final guardedValue = map['waitForSuccessTimeoutSeconds'];
        if (guardedValue == null) return null;
