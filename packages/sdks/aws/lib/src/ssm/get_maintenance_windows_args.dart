...
class GetMaintenanceWindowsArgs {
  ...
  GetMaintenanceWindowsArgs({
    pulumi.Output<List<GetMaintenanceWindowsFilter>>? filters,
  ...
  factory GetMaintenanceWindowsArgs.fromMap(Map<String, dynamic> map) {
    return GetMaintenanceWindowsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetMaintenanceWindowsFilter>>(pulumi.Input.decodeList<GetMaintenanceWindowsFilter>(map['filters'], (value) => GetMaintenanceWindowsFilter.fromMap((value as Map).cast<String, dynamic>()))),
