...
class AssociationArgs {
  ...
  factory AssociationArgs.fromMap(Map<String, dynamic> map) {
    return AssociationArgs(
      applyOnlyAtCronInterval: map['applyOnlyAtCronInterval'] == null ? null : (map['applyOnlyAtCronInterval'] as bool).input(),
      associationName: map['associationName'] == null ? null : (map['associationName'] as String).input(),
      automationTargetParameterName: map['automationTargetParameterName'] == null ? null : (map['automationTargetParameterName'] as String).input(),
      calendarNames: map['calendarNames'] == null ? null : ((map['calendarNames'] as List).cast<String>()).input(),
      complianceSeverity: map['complianceSeverity'] == null ? null : (map['complianceSeverity'] as String).input(),
      ...
      outputLocation: map['outputLocation'] == null ? null : (AssociationOutputLocation.fromMap((map['outputLocation'] as Map).cast<String, dynamic>())).input(),
      parameters: map['parameters'] == null ? null : ((map['parameters'] as Map).cast<String, String>()).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      scheduleExpression: map['scheduleExpression'] == null ? null : (map['scheduleExpression'] as String).input(),
      syncCompliance: map['syncCompliance'] == null ? null : (map['syncCompliance'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      targets: map['targets'] == null ? null : (pulumi.Input.decodeList<AssociationTarget>(map['targets'], (value) => AssociationTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      waitForSuccessTimeoutSeconds: map['waitForSuccessTimeoutSeconds'] == null ? null : (map['waitForSuccessTimeoutSeconds'] as int).input(),
    );
  }
}
