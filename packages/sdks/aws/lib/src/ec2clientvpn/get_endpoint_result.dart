  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?(() {
        ...
        return pulumi.Input.encodeList<GetEndpointFilter, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetEndpointResult.fromMap(Map<String, dynamic> map) {
    return GetEndpointResult(
      ...
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetEndpointFilter>(
          guardedValue,
          (value) =>
              GetEndpointFilter.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      id: map['id'] as String,
