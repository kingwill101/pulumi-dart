...
class EndpointArgs {
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      authenticationOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointAuthenticationOption>(map['authenticationOptions']!, (value) => EndpointAuthenticationOption.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      connectionLogOptions: pulumi.Input.fromValue(EndpointConnectionLogOptions.fromMap((map['connectionLogOptions']! as Map).cast<String, dynamic>())),
