...
class EndpointAuthenticationOption {
  ...
  factory EndpointAuthenticationOption.fromMap(Map<String, dynamic> map) {
    return EndpointAuthenticationOption(
      ...
      rootCertificateChainArn: map['rootCertificateChainArn'] == null ? null : map['rootCertificateChainArn'] as String,
      samlProviderArn: map['samlProviderArn'] == null ? null : map['samlProviderArn'] as String,
      selfServiceSamlProviderArn: map['selfServiceSamlProviderArn'] == null ? null : map['selfServiceSamlProviderArn'] as String,
