...
class EndpointState {
  ...
  factory EndpointState.fromMap(Map<String, dynamic> map) {
    return EndpointState(
      ...
      authenticationOptions: map['authenticationOptions'] == null ? null : ((pulumi.Input.decodeList<EndpointAuthenticationOption>(map['authenticationOptions']!, (value) => EndpointAuthenticationOption.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      connectionLogOptions: map['connectionLogOptions'] == null ? null : ((EndpointConnectionLogOptions.fromMap((map['connectionLogOptions']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      selfServicePortalUrl: map['selfServicePortalUrl'] == null ? null : ((map['selfServicePortalUrl'] as String).input()).input(),
      serverCertificateArn: map['serverCertificateArn'] == null ? null : ((map['serverCertificateArn'] as String).input()).input(),
