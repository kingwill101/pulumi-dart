...
class EndpointState {
  ...
  factory EndpointState.fromMap(Map<String, dynamic> map) {
    return EndpointState(
      ...
      authenticationOptions: (() {
        final guardedValue = map['authenticationOptions'];
        if (guardedValue == null) return null;
      ...
      connectionLogOptions: (() {
        final guardedValue = map['connectionLogOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      selfServicePortalUrl: (() {
        final guardedValue = map['selfServicePortalUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serverCertificateArn: (() {
        final guardedValue = map['serverCertificateArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sessionTimeoutHours: (() {
