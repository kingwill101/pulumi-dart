...
import 'channel_group_state.dart';
...
/// }
///
/// resource "aws_mediapackagev2_channelgroup" "example" {
///   name        = "example"
///   description = "channel group for example channels"
/// }
/// ```
...
class ChannelGroup extends pulumi.CustomResource {
  ...
  static ChannelGroup get(
    String name,
    pulumi.Input<String> id, {
    ChannelGroupState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ChannelGroup._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ChannelGroup] resource.
  ChannelGroup.reference(String urn)
    : super(
        'aws:mediapackagev2/channelGroup:ChannelGroup',
