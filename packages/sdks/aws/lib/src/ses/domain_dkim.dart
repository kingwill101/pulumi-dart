...
class DomainDkim extends pulumi.CustomResource {
  ...
  static DomainDkim get(
    String name,
    pulumi.Input<String> id, {
    DomainDkimState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DomainDkim._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DomainDkim] resource.
  DomainDkim.reference(String urn)
    : super(
        'aws:ses/domainDkim:DomainDkim',
