...
class EventDestinationArgs {
  ...
  /// [matchingTypes] List of matching types. May be any of `"send"`, `"reject"`, `"bounce"`, `"complaint"`, `"delivery"`, `"open"`, `"click"`, or `"renderingFailure"`.
  /// [name] Name of the event destination
