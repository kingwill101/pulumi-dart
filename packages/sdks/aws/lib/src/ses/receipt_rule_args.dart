...
class ReceiptRuleArgs {
  ...
  ReceiptRuleArgs({
    pulumi.Output<List<ReceiptRuleAddHeaderAction>>? addHeaderActions,
    pulumi.Output<String>? after,
    pulumi.Output<List<ReceiptRuleBounceAction>>? bounceActions,
    pulumi.Output<bool>? enabled,
    pulumi.Output<List<ReceiptRuleLambdaAction>>? lambdaActions,
    pulumi.Output<String>? name,
    pulumi.Output<List<String>>? recipients,
    pulumi.Output<String>? region,
    required pulumi.Output<String> ruleSetName,
    pulumi.Output<List<ReceiptRuleS3Action>>? s3Actions,
    pulumi.Output<bool>? scanEnabled,
    pulumi.Output<List<ReceiptRuleSnsAction>>? snsActions,
    pulumi.Output<List<ReceiptRuleStopAction>>? stopActions,
    pulumi.Output<String>? tlsPolicy,
    pulumi.Output<List<ReceiptRuleWorkmailAction>>? workmailActions,
  }) :
      addHeaderActions = pulumi.Input.asOptionalInput<List<ReceiptRuleAddHeaderAction>>(addHeaderActions),
      after = pulumi.Input.asOptionalInput<String>(after),
      bounceActions = pulumi.Input.asOptionalInput<List<ReceiptRuleBounceAction>>(bounceActions),
      enabled = pulumi.Input.asOptionalInput<bool>(enabled),
      lambdaActions = pulumi.Input.asOptionalInput<List<ReceiptRuleLambdaAction>>(lambdaActions),
      ...
      s3Actions = pulumi.Input.asOptionalInput<List<ReceiptRuleS3Action>>(s3Actions),
      scanEnabled = pulumi.Input.asOptionalInput<bool>(scanEnabled),
      snsActions = pulumi.Input.asOptionalInput<List<ReceiptRuleSnsAction>>(snsActions),
      stopActions = pulumi.Input.asOptionalInput<List<ReceiptRuleStopAction>>(stopActions),
      tlsPolicy = pulumi.Input.asOptionalInput<String>(tlsPolicy),
      workmailActions = pulumi.Input.asOptionalInput<List<ReceiptRuleWorkmailAction>>(workmailActions);
  ...
  factory ReceiptRuleArgs.fromMap(Map<String, dynamic> map) {
    return ReceiptRuleArgs(
      addHeaderActions: map['addHeaderActions'] == null ? null : pulumi.Output.create<List<ReceiptRuleAddHeaderAction>>(pulumi.Input.decodeList<ReceiptRuleAddHeaderAction>(map['addHeaderActions'], (value) => ReceiptRuleAddHeaderAction.fromMap((value as Map).cast<String, dynamic>()))),
      after: map['after'] == null ? null : pulumi.Output.create<String>(map['after'] as String),
      bounceActions: map['bounceActions'] == null ? null : pulumi.Output.create<List<ReceiptRuleBounceAction>>(pulumi.Input.decodeList<ReceiptRuleBounceAction>(map['bounceActions'], (value) => ReceiptRuleBounceAction.fromMap((value as Map).cast<String, dynamic>()))),
      enabled: map['enabled'] == null ? null : pulumi.Output.create<bool>(map['enabled'] as bool),
      lambdaActions: map['lambdaActions'] == null ? null : pulumi.Output.create<List<ReceiptRuleLambdaAction>>(pulumi.Input.decodeList<ReceiptRuleLambdaAction>(map['lambdaActions'], (value) => ReceiptRuleLambdaAction.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      recipients: map['recipients'] == null ? null : pulumi.Output.create<List<String>>((map['recipients'] as List).cast<String>()),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      ruleSetName: pulumi.Output.create<String>(map['ruleSetName'] as String),
      s3Actions: map['s3Actions'] == null ? null : pulumi.Output.create<List<ReceiptRuleS3Action>>(pulumi.Input.decodeList<ReceiptRuleS3Action>(map['s3Actions'], (value) => ReceiptRuleS3Action.fromMap((value as Map).cast<String, dynamic>()))),
      scanEnabled: map['scanEnabled'] == null ? null : pulumi.Output.create<bool>(map['scanEnabled'] as bool),
      snsActions: map['snsActions'] == null ? null : pulumi.Output.create<List<ReceiptRuleSnsAction>>(pulumi.Input.decodeList<ReceiptRuleSnsAction>(map['snsActions'], (value) => ReceiptRuleSnsAction.fromMap((value as Map).cast<String, dynamic>()))),
      stopActions: map['stopActions'] == null ? null : pulumi.Output.create<List<ReceiptRuleStopAction>>(pulumi.Input.decodeList<ReceiptRuleStopAction>(map['stopActions'], (value) => ReceiptRuleStopAction.fromMap((value as Map).cast<String, dynamic>()))),
      tlsPolicy: map['tlsPolicy'] == null ? null : pulumi.Output.create<String>(map['tlsPolicy'] as String),
      workmailActions: map['workmailActions'] == null ? null : pulumi.Output.create<List<ReceiptRuleWorkmailAction>>(pulumi.Input.decodeList<ReceiptRuleWorkmailAction>(map['workmailActions'], (value) => ReceiptRuleWorkmailAction.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
