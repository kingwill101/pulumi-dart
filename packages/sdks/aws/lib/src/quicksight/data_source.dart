...
class DataSource extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DataSourceCredentials?> credentials;
  ...
  late final pulumi.Output<DataSourceVpcConnectionProperties?> vpcConnectionProperties;

  /// Creates a new [DataSource].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DataSource]. {@macro pulumi_quicksight_data_source_data_source_args_doc}
  ...
  DataSource(
    ...
    this.permissions = registerOutput<List<DataSourcePermission>?>('permissions');
    this.region = registerOutput<String>('region');
    this.sslProperties = registerOutput<DataSourceSslProperties>('sslProperties');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.type = registerOutput<String>('type');
    this.vpcConnectionProperties = registerOutput<DataSourceVpcConnectionProperties?>('vpcConnectionProperties');
  }
