...
class DataSetColumnGroup {
  ...
  factory DataSetColumnGroup.fromMap(Map<String, dynamic> map) {
    return DataSetColumnGroup(
      geoSpatialColumnGroup: (() { final guardedValue = map['geoSpatialColumnGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSetColumnGroupGeoSpatialColumnGroup.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
