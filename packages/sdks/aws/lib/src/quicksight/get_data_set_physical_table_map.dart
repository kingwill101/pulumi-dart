...
class GetDataSetPhysicalTableMap {
  ...
  final pulumi.Input<List<GetDataSetPhysicalTableMapRelationalTable>>
  relationalTables;
    ...
    return <String, dynamic>{
      'customSqls':
          pulumi.Input.mapInputValue<
            List<GetDataSetPhysicalTableMapCustomSql>,
      ...
      'relationalTables':
          pulumi.Input.mapInputValue<
            List<GetDataSetPhysicalTableMapRelationalTable>,
            List<Map<String, dynamic>>
          >(
            relationalTables,
            (value) =>
      ...
      's3Sources':
          pulumi.Input.mapInputValue<
            List<GetDataSetPhysicalTableMapS3Source>,
            List<Map<String, dynamic>>
          >(
            s3Sources,
            (value) =>
  ...
  factory GetDataSetPhysicalTableMap.fromMap(Map<String, dynamic> map) {
    return GetDataSetPhysicalTableMap(
      customSqls: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataSetPhysicalTableMapCustomSql>(
          map['customSqls']!,
      ...
      relationalTables: pulumi.Input.fromValue(
      ...
      s3Sources: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataSetPhysicalTableMapS3Source>(
          map['s3Sources']!,
