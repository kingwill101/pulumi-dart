...
class GetDataSetColumnGroup {
  ...
  factory GetDataSetColumnGroup.fromMap(Map<String, dynamic> map) {
    return GetDataSetColumnGroup(
      geoSpatialColumnGroups: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataSetColumnGroupGeoSpatialColumnGroup>(map['geoSpatialColumnGroups']!, (value) => GetDataSetColumnGroupGeoSpatialColumnGroup.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
