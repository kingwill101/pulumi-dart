...
class GetDataSetColumnGroup {
  final pulumi.Input<List<GetDataSetColumnGroupGeoSpatialColumnGroup>>
    ...
    return <String, dynamic>{
      'geoSpatialColumnGroups':
          pulumi.Input.mapInputValue<
            List<GetDataSetColumnGroupGeoSpatialColumnGroup>,
  ...
  factory GetDataSetColumnGroup.fromMap(Map<String, dynamic> map) {
    return GetDataSetColumnGroup(
      geoSpatialColumnGroups: pulumi.Input.fromValue(
