...
import 'folder_membership_state.dart';
...
class FolderMembership extends pulumi.CustomResource {
  ...
  /// Gets an existing [FolderMembership] resource's state with the given [name] and [id].
  static FolderMembership get(
    String name,
