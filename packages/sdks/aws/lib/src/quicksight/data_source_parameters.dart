...
class DataSourceParameters {
  ...
  final pulumi.Input<DataSourceParametersAmazonElasticsearch>?
  amazonElasticsearch;
    ...
    return <String, dynamic>{
      'amazonElasticsearch':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(amazonElasticsearch, (value) => value.toMap()),
      'athena':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceParametersAthena,
            Map<String, dynamic>
          >(athena, (value) => value.toMap()),
      'aurora':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceParametersAurora,
            Map<String, dynamic>
          >(aurora, (value) => value.toMap()),
      'auroraPostgresql':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceParametersAuroraPostgresql,
            Map<String, dynamic>
          >(auroraPostgresql, (value) => value.toMap()),
      'awsIotAnalytics':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceParametersAwsIotAnalytics,
            Map<String, dynamic>
          >(awsIotAnalytics, (value) => value.toMap()),
      'databricks':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceParametersDatabricks,
            Map<String, dynamic>
          >(databricks, (value) => value.toMap()),
      'jira':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceParametersJira,
            Map<String, dynamic>
          >(jira, (value) => value.toMap()),
      'mariaDb':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'sqlServer':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sqlServer, (value) => value.toMap()),
      'teradata':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceParametersTeradata,
            Map<String, dynamic>
          >(teradata, (value) => value.toMap()),
      'twitter':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory DataSourceParameters.fromMap(Map<String, dynamic> map) {
    return DataSourceParameters(
      amazonElasticsearch: (() {
        final guardedValue = map['amazonElasticsearch'];
      ...
      auroraPostgresql: (() {
        final guardedValue = map['auroraPostgresql'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      awsIotAnalytics: (() {
        final guardedValue = map['awsIotAnalytics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      databricks: (() {
        final guardedValue = map['databricks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sqlServer: (() {
        final guardedValue = map['sqlServer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      teradata: (() {
        final guardedValue = map['teradata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
