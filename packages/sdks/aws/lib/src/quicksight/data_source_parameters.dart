...
class DataSourceParameters {
  ...
  factory DataSourceParameters.fromMap(Map<String, dynamic> map) {
    return DataSourceParameters(
      amazonElasticsearch: map['amazonElasticsearch'] == null ? null : ((DataSourceParametersAmazonElasticsearch.fromMap((map['amazonElasticsearch']! as Map).cast<String, dynamic>())).input()).input(),
      athena: map['athena'] == null ? null : ((DataSourceParametersAthena.fromMap((map['athena']! as Map).cast<String, dynamic>())).input()).input(),
      aurora: map['aurora'] == null ? null : ((DataSourceParametersAurora.fromMap((map['aurora']! as Map).cast<String, dynamic>())).input()).input(),
      auroraPostgresql: map['auroraPostgresql'] == null ? null : ((DataSourceParametersAuroraPostgresql.fromMap((map['auroraPostgresql']! as Map).cast<String, dynamic>())).input()).input(),
      awsIotAnalytics: map['awsIotAnalytics'] == null ? null : ((DataSourceParametersAwsIotAnalytics.fromMap((map['awsIotAnalytics']! as Map).cast<String, dynamic>())).input()).input(),
      databricks: map['databricks'] == null ? null : ((DataSourceParametersDatabricks.fromMap((map['databricks']! as Map).cast<String, dynamic>())).input()).input(),
      jira: map['jira'] == null ? null : ((DataSourceParametersJira.fromMap((map['jira']! as Map).cast<String, dynamic>())).input()).input(),
      mariaDb: map['mariaDb'] == null ? null : ((DataSourceParametersMariaDb.fromMap((map['mariaDb']! as Map).cast<String, dynamic>())).input()).input(),
      mysql: map['mysql'] == null ? null : ((DataSourceParametersMysql.fromMap((map['mysql']! as Map).cast<String, dynamic>())).input()).input(),
      oracle: map['oracle'] == null ? null : ((DataSourceParametersOracle.fromMap((map['oracle']! as Map).cast<String, dynamic>())).input()).input(),
      postgresql: map['postgresql'] == null ? null : ((DataSourceParametersPostgresql.fromMap((map['postgresql']! as Map).cast<String, dynamic>())).input()).input(),
      presto: map['presto'] == null ? null : ((DataSourceParametersPresto.fromMap((map['presto']! as Map).cast<String, dynamic>())).input()).input(),
      rds: map['rds'] == null ? null : ((DataSourceParametersRds.fromMap((map['rds']! as Map).cast<String, dynamic>())).input()).input(),
      redshift: map['redshift'] == null ? null : ((DataSourceParametersRedshift.fromMap((map['redshift']! as Map).cast<String, dynamic>())).input()).input(),
      s3: map['s3'] == null ? null : ((DataSourceParametersS3.fromMap((map['s3']! as Map).cast<String, dynamic>())).input()).input(),
      serviceNow: map['serviceNow'] == null ? null : ((DataSourceParametersServiceNow.fromMap((map['serviceNow']! as Map).cast<String, dynamic>())).input()).input(),
      snowflake: map['snowflake'] == null ? null : ((DataSourceParametersSnowflake.fromMap((map['snowflake']! as Map).cast<String, dynamic>())).input()).input(),
      spark: map['spark'] == null ? null : ((DataSourceParametersSpark.fromMap((map['spark']! as Map).cast<String, dynamic>())).input()).input(),
      sqlServer: map['sqlServer'] == null ? null : ((DataSourceParametersSqlServer.fromMap((map['sqlServer']! as Map).cast<String, dynamic>())).input()).input(),
      teradata: map['teradata'] == null ? null : ((DataSourceParametersTeradata.fromMap((map['teradata']! as Map).cast<String, dynamic>())).input()).input(),
      twitter: map['twitter'] == null ? null : ((DataSourceParametersTwitter.fromMap((map['twitter']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
