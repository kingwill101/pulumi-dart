...
class GetDataSetLogicalTableMapDataTransformTagColumnOperation {
  ...
  factory GetDataSetLogicalTableMapDataTransformTagColumnOperation.fromMap(Map<String, dynamic> map) {
    return GetDataSetLogicalTableMapDataTransformTagColumnOperation(
      ...
      tags: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataSetLogicalTableMapDataTransformTagColumnOperationTag>(map['tags']!, (value) => GetDataSetLogicalTableMapDataTransformTagColumnOperationTag.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
