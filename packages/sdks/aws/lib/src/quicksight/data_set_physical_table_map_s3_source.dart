...
class DataSetPhysicalTableMapS3Source {
  ...
  final pulumi.Input<List<DataSetPhysicalTableMapS3SourceInputColumn>>
  inputColumns;

  /// Information about the format for the S3 source file or files. See upload_settings.
  final pulumi.Input<DataSetPhysicalTableMapS3SourceUploadSettings>
  uploadSettings;
    ...
    return <String, dynamic>{
      ...
      'inputColumns':
          pulumi.Input.mapInputValue<
            List<DataSetPhysicalTableMapS3SourceInputColumn>,
  ...
  factory DataSetPhysicalTableMapS3Source.fromMap(Map<String, dynamic> map) {
    return DataSetPhysicalTableMapS3Source(
      ...
      uploadSettings: pulumi.Input.fromValue(
        DataSetPhysicalTableMapS3SourceUploadSettings.fromMap(
