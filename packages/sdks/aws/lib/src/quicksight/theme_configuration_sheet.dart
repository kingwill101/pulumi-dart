...
class ThemeConfigurationSheet {
  ...
  factory ThemeConfigurationSheet.fromMap(Map<String, dynamic> map) {
    return ThemeConfigurationSheet(
      tile: (() { final guardedValue = map['tile']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ThemeConfigurationSheetTile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tileLayout: (() { final guardedValue = map['tileLayout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ThemeConfigurationSheetTileLayout.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
