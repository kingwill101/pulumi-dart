...
class GetThemeConfigurationTypography {
  ...
  const GetThemeConfigurationTypography({
  ...
  factory GetThemeConfigurationTypography.fromMap(Map<String, dynamic> map) {
    return GetThemeConfigurationTypography(
      fontFamilies: pulumi.Input.fromValue(pulumi.Input.decodeList<GetThemeConfigurationTypographyFontFamily>(map['fontFamilies']!, (value) => GetThemeConfigurationTypographyFontFamily.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
