...
class ThemeConfiguration {
    ...
    return <String, dynamic>{
      'dataColorPalette':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataColorPalette, (value) => value.toMap()),
      'sheet':
          ?pulumi.Input.mapOptionalInputValue<
            ThemeConfigurationSheet,
            Map<String, dynamic>
          >(sheet, (value) => value.toMap()),
      'typography':
          ?pulumi.Input.mapOptionalInputValue<
            ThemeConfigurationTypography,
            Map<String, dynamic>
          >(typography, (value) => value.toMap()),
      'uiColorPalette':
          ?pulumi.Input.mapOptionalInputValue<
            ThemeConfigurationUiColorPalette,
            Map<String, dynamic>
          >(uiColorPalette, (value) => value.toMap()),
    };
  }
  ...
  factory ThemeConfiguration.fromMap(Map<String, dynamic> map) {
    return ThemeConfiguration(
      dataColorPalette: (() {
        final guardedValue = map['dataColorPalette'];
      ...
      typography: (() {
        final guardedValue = map['typography'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      uiColorPalette: (() {
        final guardedValue = map['uiColorPalette'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
