...
class DataSetLogicalTableMapDataTransform {
  ...
  final pulumi.Input<DataSetLogicalTableMapDataTransformCreateColumnsOperation>?
  createColumnsOperation;

  /// An operation that filters rows based on some condition. See filter_operation.
  final pulumi.Input<DataSetLogicalTableMapDataTransformFilterOperation>?
  filterOperation;
  ...
  final pulumi.Input<DataSetLogicalTableMapDataTransformProjectOperation>?
  projectOperation;

  /// An operation that renames a column. See rename_column_operation.
  final pulumi.Input<DataSetLogicalTableMapDataTransformRenameColumnOperation>?
  renameColumnOperation;

  /// An operation that tags a column with additional information. See tag_column_operation.
  final pulumi.Input<DataSetLogicalTableMapDataTransformTagColumnOperation>?
  tagColumnOperation;

  /// A transform operation that removes tags associated with a column. See untag_column_operation.
  final pulumi.Input<DataSetLogicalTableMapDataTransformUntagColumnOperation>?
  ...
  factory DataSetLogicalTableMapDataTransform.fromMap(
    ...
    return DataSetLogicalTableMapDataTransform(
      castColumnTypeOperation: (() {
        final guardedValue = map['castColumnTypeOperation'];
      ...
      createColumnsOperation: (() {
        final guardedValue = map['createColumnsOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      filterOperation: (() {
        final guardedValue = map['filterOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      projectOperation: (() {
        final guardedValue = map['projectOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      renameColumnOperation: (() {
        final guardedValue = map['renameColumnOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      tagColumnOperation: (() {
        final guardedValue = map['tagColumnOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      untagColumnOperation: (() {
        final guardedValue = map['untagColumnOperation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
