...
class GetDataSetLogicalTableMapDataTransform {
  final pulumi.Input<
    List<GetDataSetLogicalTableMapDataTransformCastColumnTypeOperation>
  >
  castColumnTypeOperations;
  final pulumi.Input<
    List<GetDataSetLogicalTableMapDataTransformCreateColumnsOperation>
  >
  createColumnsOperations;
  final pulumi.Input<
    List<GetDataSetLogicalTableMapDataTransformFilterOperation>
  >
  filterOperations;
  final pulumi.Input<
    List<GetDataSetLogicalTableMapDataTransformProjectOperation>
  >
  projectOperations;
  final pulumi.Input<
    List<GetDataSetLogicalTableMapDataTransformRenameColumnOperation>
  >
  renameColumnOperations;
  final pulumi.Input<
    List<GetDataSetLogicalTableMapDataTransformTagColumnOperation>
  >
  tagColumnOperations;
  final pulumi.Input<
    List<GetDataSetLogicalTableMapDataTransformUntagColumnOperation>
  >
  ...
  factory GetDataSetLogicalTableMapDataTransform.fromMap(
    ...
    return GetDataSetLogicalTableMapDataTransform(
      castColumnTypeOperations: pulumi.Input.fromValue(
      ...
      createColumnsOperations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataSetLogicalTableMapDataTransformCreateColumnsOperation
        >(
      ...
      filterOperations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataSetLogicalTableMapDataTransformFilterOperation
        >(
      ...
      projectOperations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataSetLogicalTableMapDataTransformProjectOperation
        >(
      ...
      renameColumnOperations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataSetLogicalTableMapDataTransformRenameColumnOperation
        >(
      ...
      tagColumnOperations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataSetLogicalTableMapDataTransformTagColumnOperation
        >(
      ...
      untagColumnOperations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetDataSetLogicalTableMapDataTransformUntagColumnOperation
        >(
