...
class AnalysisParameters {
  ...
  final pulumi.Input<List<AnalysisParametersDateTimeParameter>>?
  dateTimeParameters;
  ...
  final pulumi.Input<List<AnalysisParametersDecimalParameter>>?
  decimalParameters;
  ...
  final pulumi.Input<List<AnalysisParametersIntegerParameter>>?
  integerParameters;
    ...
    return <String, dynamic>{
      'dateTimeParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<AnalysisParametersDateTimeParameter>,
      ...
      'decimalParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<AnalysisParametersDecimalParameter>,
            List<Map<String, dynamic>>
          >(
            decimalParameters,
            (value) =>
      ...
      'integerParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<AnalysisParametersIntegerParameter>,
            List<Map<String, dynamic>>
          >(
            integerParameters,
            (value) =>
      ...
      'stringParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<AnalysisParametersStringParameter>,
            List<Map<String, dynamic>>
          >(
            stringParameters,
            (value) =>
