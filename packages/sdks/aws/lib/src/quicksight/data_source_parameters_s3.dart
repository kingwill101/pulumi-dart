...
class DataSourceParametersS3 {
  ...
  final pulumi.Input<DataSourceParametersS3ManifestFileLocation>
  ...
  DataSourceParametersS3({required this.manifestFileLocation, this.roleArn});
    ...
    return <String, dynamic>{
      'manifestFileLocation':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(manifestFileLocation, (value) => value.toMap()),
      'roleArn': ?roleArn,
    };
  }
  ...
  factory DataSourceParametersS3.fromMap(Map<String, dynamic> map) {
    return DataSourceParametersS3(
      manifestFileLocation: pulumi.Input.fromValue(
        DataSourceParametersS3ManifestFileLocation.fromMap(
