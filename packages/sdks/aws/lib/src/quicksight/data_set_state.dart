...
class DataSetState {
  ...
  factory DataSetState.fromMap(Map<String, dynamic> map) {
    return DataSetState(
      ...
      importMode: (() { final guardedValue = map['importMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      outputColumns: (() { final guardedValue = map['outputColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DataSetOutputColumn>(guardedValue, (value) => DataSetOutputColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
