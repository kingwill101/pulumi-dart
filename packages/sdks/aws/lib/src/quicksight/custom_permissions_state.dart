...
class CustomPermissionsState {
  ...
  factory CustomPermissionsState.fromMap(Map<String, dynamic> map) {
    return CustomPermissionsState(
      ...
      capabilities: (() { final guardedValue = map['capabilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CustomPermissionsCapabilities.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
