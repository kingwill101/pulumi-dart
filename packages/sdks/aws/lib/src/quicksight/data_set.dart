...
class DataSet extends pulumi.CustomResource {
  ...
  DataSet(
    ...
    this.columnGroups = registerOutput<List<DataSetColumnGroup>?>('columnGroups');
    this.columnLevelPermissionRules = registerOutput<List<DataSetColumnLevelPermissionRule>?>('columnLevelPermissionRules');
    this.dataSetId = registerOutput<String>('dataSetId');
    this.dataSetUsageConfiguration = registerOutput<DataSetDataSetUsageConfiguration>('dataSetUsageConfiguration');
    this.fieldFolders = registerOutput<List<DataSetFieldFolder>?>('fieldFolders');
    this.importMode = registerOutput<String>('importMode');
    this.logicalTableMaps = registerOutput<List<DataSetLogicalTableMap>>('logicalTableMaps');
    this.name = registerOutput<String>('name');
    this.outputColumns = registerOutput<List<DataSetOutputColumn>>('outputColumns');
    this.permissions = registerOutput<List<DataSetPermission>?>('permissions');
    this.physicalTableMaps = registerOutput<List<DataSetPhysicalTableMap>?>('physicalTableMaps');
    this.refreshProperties = registerOutput<DataSetRefreshProperties?>('refreshProperties');
    this.region = registerOutput<String>('region');
    this.rowLevelPermissionDataSet = registerOutput<DataSetRowLevelPermissionDataSet?>('rowLevelPermissionDataSet');
    this.rowLevelPermissionTagConfiguration = registerOutput<DataSetRowLevelPermissionTagConfiguration?>('rowLevelPermissionTagConfiguration');
