...
class AccountSubscriptionState {
  ...
  factory AccountSubscriptionState.fromMap(Map<String, dynamic> map) {
    return AccountSubscriptionState(
      ...
      accountSubscriptionStatus: map['accountSubscriptionStatus'] == null ? null : (map['accountSubscriptionStatus'] as String).input(),
      activeDirectoryName: map['activeDirectoryName'] == null ? null : (map['activeDirectoryName'] as String).input(),
      adminGroups: map['adminGroups'] == null ? null : ((map['adminGroups'] as List).cast<String>()).input(),
      adminProGroups: map['adminProGroups'] == null ? null : ((map['adminProGroups'] as List).cast<String>()).input(),
      authenticationMethod: map['authenticationMethod'] == null ? null : (map['authenticationMethod'] as String).input(),
      authorGroups: map['authorGroups'] == null ? null : ((map['authorGroups'] as List).cast<String>()).input(),
      authorProGroups: map['authorProGroups'] == null ? null : ((map['authorProGroups'] as List).cast<String>()).input(),
      awsAccountId: map['awsAccountId'] == null ? null : (map['awsAccountId'] as String).input(),
      contactNumber: map['contactNumber'] == null ? null : (map['contactNumber'] as String).input(),
      ...
      readerGroups: map['readerGroups'] == null ? null : ((map['readerGroups'] as List).cast<String>()).input(),
      readerProGroups: map['readerProGroups'] == null ? null : ((map['readerProGroups'] as List).cast<String>()).input(),
