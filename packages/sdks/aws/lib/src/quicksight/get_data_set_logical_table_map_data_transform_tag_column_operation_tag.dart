...
class GetDataSetLogicalTableMapDataTransformTagColumnOperationTag {
  ...
  const GetDataSetLogicalTableMapDataTransformTagColumnOperationTag({
  ...
  factory GetDataSetLogicalTableMapDataTransformTagColumnOperationTag.fromMap(Map<String, dynamic> map) {
    return GetDataSetLogicalTableMapDataTransformTagColumnOperationTag(
      columnDescriptions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataSetLogicalTableMapDataTransformTagColumnOperationTagColumnDescription>(map['columnDescriptions']!, (value) => GetDataSetLogicalTableMapDataTransformTagColumnOperationTagColumnDescription.fromMap((value as Map).cast<String, dynamic>()))),
      columnGeographicRole: pulumi.Input.fromValue(map['columnGeographicRole'] as String),
    );
  }
}
