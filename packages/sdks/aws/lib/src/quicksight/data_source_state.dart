...
class DataSourceState {
  ...
  factory DataSourceState.fromMap(Map<String, dynamic> map) {
    return DataSourceState(
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
