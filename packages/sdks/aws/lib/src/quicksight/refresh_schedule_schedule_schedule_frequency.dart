...
class RefreshScheduleScheduleScheduleFrequency {
  ...
  final pulumi.Input<RefreshScheduleScheduleScheduleFrequencyRefreshOnDay>?
  refreshOnDay;
    ...
    return <String, dynamic>{
      ...
      'refreshOnDay':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(refreshOnDay, (value) => value.toMap()),
  ...
  factory RefreshScheduleScheduleScheduleFrequency.fromMap(
    ...
    return RefreshScheduleScheduleScheduleFrequency(
      ...
      refreshOnDay: (() {
        final guardedValue = map['refreshOnDay'];
      ...
      timeOfTheDay: (() {
        final guardedValue = map['timeOfTheDay'];
        if (guardedValue == null) return null;
