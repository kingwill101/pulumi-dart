...
class IamPolicyAssignmentState {
  ...
  factory IamPolicyAssignmentState.fromMap(Map<String, dynamic> map) {
    return IamPolicyAssignmentState(
      assignmentId: map['assignmentId'] == null ? null : ((map['assignmentId'] as String).input()).input(),
      assignmentName: map['assignmentName'] == null ? null : ((map['assignmentName'] as String).input()).input(),
      assignmentStatus: map['assignmentStatus'] == null ? null : ((map['assignmentStatus'] as String).input()).input(),
