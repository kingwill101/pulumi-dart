...
class DashboardSourceEntitySourceTemplate {
  ...
  final pulumi.Input<List<DashboardSourceEntitySourceTemplateDataSetReference>>
  dataSetReferences;
    ...
    return <String, dynamic>{
      ...
      'dataSetReferences':
          pulumi.Input.mapInputValue<
            List<DashboardSourceEntitySourceTemplateDataSetReference>,
  ...
  factory DashboardSourceEntitySourceTemplate.fromMap(
    ...
    return DashboardSourceEntitySourceTemplate(
      ...
      dataSetReferences: pulumi.Input.fromValue(
