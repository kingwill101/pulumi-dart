...
class DashboardSourceEntitySourceTemplate {
  ...
  const DashboardSourceEntitySourceTemplate({
    required this.arn,
  ...
  factory DashboardSourceEntitySourceTemplate.fromMap(Map<String, dynamic> map) {
    return DashboardSourceEntitySourceTemplate(
      ...
      dataSetReferences: pulumi.Input.fromValue(pulumi.Input.decodeList<DashboardSourceEntitySourceTemplateDataSetReference>(map['dataSetReferences']!, (value) => DashboardSourceEntitySourceTemplateDataSetReference.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
