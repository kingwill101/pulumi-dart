...
class DataSetRowLevelPermissionTagConfiguration {
  ...
  final pulumi.Input<List<DataSetRowLevelPermissionTagConfigurationTagRule>>
  tagRules;
    ...
    return <String, dynamic>{
      ...
      'tagRules':
          pulumi.Input.mapInputValue<
            List<DataSetRowLevelPermissionTagConfigurationTagRule>,
    ...
    return DataSetRowLevelPermissionTagConfiguration(
      ...
      tagRules: pulumi.Input.fromValue(
        pulumi
          ...
          map['tagRules']!,
          (value) => DataSetRowLevelPermissionTagConfigurationTagRule.fromMap(
