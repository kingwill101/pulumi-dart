...
class ThemeConfigurationSheetTileLayout {
  ...
  ThemeConfigurationSheetTileLayout({this.gutter, this.margin});
    ...
    return <String, dynamic>{
      'gutter':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(gutter, (value) => value.toMap()),
      'margin':
          ?pulumi.Input.mapOptionalInputValue<
            ThemeConfigurationSheetTileLayoutMargin,
            Map<String, dynamic>
          >(margin, (value) => value.toMap()),
    };
  }
