...
class CustomPermissionsCapabilities {
  ...
  factory CustomPermissionsCapabilities.fromMap(Map<String, dynamic> map) {
    return CustomPermissionsCapabilities(
      addOrRunAnomalyDetectionForAnalyses: map['addOrRunAnomalyDetectionForAnalyses'] == null ? null : ((map['addOrRunAnomalyDetectionForAnalyses'] as String).input()).input(),
      createAndUpdateDashboardEmailReports: map['createAndUpdateDashboardEmailReports'] == null ? null : ((map['createAndUpdateDashboardEmailReports'] as String).input()).input(),
      createAndUpdateDataSources: map['createAndUpdateDataSources'] == null ? null : ((map['createAndUpdateDataSources'] as String).input()).input(),
      createAndUpdateDatasets: map['createAndUpdateDatasets'] == null ? null : ((map['createAndUpdateDatasets'] as String).input()).input(),
      createAndUpdateThemes: map['createAndUpdateThemes'] == null ? null : ((map['createAndUpdateThemes'] as String).input()).input(),
      createAndUpdateThresholdAlerts: map['createAndUpdateThresholdAlerts'] == null ? null : ((map['createAndUpdateThresholdAlerts'] as String).input()).input(),
      createSharedFolders: map['createSharedFolders'] == null ? null : ((map['createSharedFolders'] as String).input()).input(),
      createSpiceDataset: map['createSpiceDataset'] == null ? null : ((map['createSpiceDataset'] as String).input()).input(),
      exportToCsv: map['exportToCsv'] == null ? null : ((map['exportToCsv'] as String).input()).input(),
      exportToCsvInScheduledReports: map['exportToCsvInScheduledReports'] == null ? null : ((map['exportToCsvInScheduledReports'] as String).input()).input(),
      exportToExcel: map['exportToExcel'] == null ? null : ((map['exportToExcel'] as String).input()).input(),
      exportToExcelInScheduledReports: map['exportToExcelInScheduledReports'] == null ? null : ((map['exportToExcelInScheduledReports'] as String).input()).input(),
      exportToPdf: map['exportToPdf'] == null ? null : ((map['exportToPdf'] as String).input()).input(),
      exportToPdfInScheduledReports: map['exportToPdfInScheduledReports'] == null ? null : ((map['exportToPdfInScheduledReports'] as String).input()).input(),
      includeContentInScheduledReportsEmail: map['includeContentInScheduledReportsEmail'] == null ? null : ((map['includeContentInScheduledReportsEmail'] as String).input()).input(),
      printReports: map['printReports'] == null ? null : ((map['printReports'] as String).input()).input(),
      renameSharedFolders: map['renameSharedFolders'] == null ? null : ((map['renameSharedFolders'] as String).input()).input(),
      shareAnalyses: map['shareAnalyses'] == null ? null : ((map['shareAnalyses'] as String).input()).input(),
      shareDashboards: map['shareDashboards'] == null ? null : ((map['shareDashboards'] as String).input()).input(),
      shareDataSources: map['shareDataSources'] == null ? null : ((map['shareDataSources'] as String).input()).input(),
      shareDatasets: map['shareDatasets'] == null ? null : ((map['shareDatasets'] as String).input()).input(),
      subscribeDashboardEmailReports: map['subscribeDashboardEmailReports'] == null ? null : ((map['subscribeDashboardEmailReports'] as String).input()).input(),
      viewAccountSpiceCapacity: map['viewAccountSpiceCapacity'] == null ? null : ((map['viewAccountSpiceCapacity'] as String).input()).input(),
    );
  }
}
