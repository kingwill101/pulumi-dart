...
class KeyRegistration extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [KeyRegistration]. {@macro pulumi_quicksight_key_registration_key_registration_args_doc}
  ...
  static KeyRegistration get(
    String name,
    pulumi.Input<String> id, {
    KeyRegistrationState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return KeyRegistration._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [KeyRegistration] resource.
  KeyRegistration.reference(String urn)
    : super(
        'aws:quicksight/keyRegistration:KeyRegistration',
