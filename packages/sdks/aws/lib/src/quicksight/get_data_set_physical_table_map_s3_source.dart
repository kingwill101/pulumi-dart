...
class GetDataSetPhysicalTableMapS3Source {
  ...
  final pulumi.Input<List<GetDataSetPhysicalTableMapS3SourceInputColumn>>
  inputColumns;
  final pulumi.Input<List<GetDataSetPhysicalTableMapS3SourceUploadSetting>>
  uploadSettings;
    ...
    return <String, dynamic>{
      ...
      'inputColumns':
          pulumi.Input.mapInputValue<
            List<GetDataSetPhysicalTableMapS3SourceInputColumn>,
      ...
      'uploadSettings':
          pulumi.Input.mapInputValue<
            List<GetDataSetPhysicalTableMapS3SourceUploadSetting>,
            List<Map<String, dynamic>>
          >(
            uploadSettings,
            (value) =>
  ...
  factory GetDataSetPhysicalTableMapS3Source.fromMap(Map<String, dynamic> map) {
    return GetDataSetPhysicalTableMapS3Source(
      ...
      inputColumns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDataSetPhysicalTableMapS3SourceInputColumn>(
          map['inputColumns']!,
      ...
      uploadSettings: pulumi.Input.fromValue(
        pulumi
