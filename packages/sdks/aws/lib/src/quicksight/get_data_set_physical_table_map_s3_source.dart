...
class GetDataSetPhysicalTableMapS3Source {
  ...
  factory GetDataSetPhysicalTableMapS3Source.fromMap(Map<String, dynamic> map) {
    return GetDataSetPhysicalTableMapS3Source(
      ...
      inputColumns: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataSetPhysicalTableMapS3SourceInputColumn>(map['inputColumns']!, (value) => GetDataSetPhysicalTableMapS3SourceInputColumn.fromMap((value as Map).cast<String, dynamic>()))),
      uploadSettings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataSetPhysicalTableMapS3SourceUploadSetting>(map['uploadSettings']!, (value) => GetDataSetPhysicalTableMapS3SourceUploadSetting.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
