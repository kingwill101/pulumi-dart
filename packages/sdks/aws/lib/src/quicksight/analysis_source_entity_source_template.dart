...
class AnalysisSourceEntitySourceTemplate {
  ...
  final List<AnalysisSourceEntitySourceTemplateDataSetReference> dataSetReferences;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arn': arn,
      'dataSetReferences': pulumi.Input.encodeList<AnalysisSourceEntitySourceTemplateDataSetReference, Map<String, dynamic>>(dataSetReferences, (value) => value.toMap()),
    };
  }
  ...
  factory AnalysisSourceEntitySourceTemplate.fromMap(Map<String, dynamic> map) {
    return AnalysisSourceEntitySourceTemplate(
      ...
      dataSetReferences: pulumi.Input.decodeList<AnalysisSourceEntitySourceTemplateDataSetReference>(map['dataSetReferences'], (value) => AnalysisSourceEntitySourceTemplateDataSetReference.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
