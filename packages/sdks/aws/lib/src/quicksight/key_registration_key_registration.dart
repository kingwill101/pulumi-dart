...
class KeyRegistrationKeyRegistration {
  ...
  KeyRegistrationKeyRegistration({this.defaultKey, required this.keyArn});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'defaultKey': ?defaultKey, 'keyArn': keyArn};
  }

  factory KeyRegistrationKeyRegistration.fromMap(Map<String, dynamic> map) {
    return KeyRegistrationKeyRegistration(
      defaultKey: (() {
        final guardedValue = map['defaultKey'];
