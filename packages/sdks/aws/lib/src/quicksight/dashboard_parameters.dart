...
class DashboardParameters {
  ...
  final pulumi.Input<List<DashboardParametersDateTimeParameter>>?
  dateTimeParameters;
  ...
  final pulumi.Input<List<DashboardParametersDecimalParameter>>?
  decimalParameters;
  ...
  final pulumi.Input<List<DashboardParametersIntegerParameter>>?
  integerParameters;
  ...
  final pulumi.Input<List<DashboardParametersStringParameter>>?
  stringParameters;
    ...
    return <String, dynamic>{
      'dateTimeParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DashboardParametersDateTimeParameter>,
      ...
      'decimalParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DashboardParametersDecimalParameter>,
            List<Map<String, dynamic>>
          >(
            decimalParameters,
            (value) =>
      ...
      'integerParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DashboardParametersIntegerParameter>,
            List<Map<String, dynamic>>
          >(
            integerParameters,
            (value) =>
      ...
      'stringParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<DashboardParametersStringParameter>,
            List<Map<String, dynamic>>
          >(
            stringParameters,
            (value) =>
  ...
  factory DashboardParameters.fromMap(Map<String, dynamic> map) {
    return DashboardParameters(
      dateTimeParameters: (() {
        final guardedValue = map['dateTimeParameters'];
      ...
      decimalParameters: (() {
        final guardedValue = map['decimalParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      integerParameters: (() {
        final guardedValue = map['integerParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      stringParameters: (() {
        final guardedValue = map['stringParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
