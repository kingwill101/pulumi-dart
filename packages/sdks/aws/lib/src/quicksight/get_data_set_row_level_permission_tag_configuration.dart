...
class GetDataSetRowLevelPermissionTagConfiguration {
  ...
  factory GetDataSetRowLevelPermissionTagConfiguration.fromMap(Map<String, dynamic> map) {
    return GetDataSetRowLevelPermissionTagConfiguration(
      ...
      tagRules: pulumi.Input.fromValue(pulumi.Input.decodeList<GetDataSetRowLevelPermissionTagConfigurationTagRule>(map['tagRules']!, (value) => GetDataSetRowLevelPermissionTagConfigurationTagRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
