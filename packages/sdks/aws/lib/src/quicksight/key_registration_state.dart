...
class KeyRegistrationState {
  ...
  KeyRegistrationState({this.awsAccountId, this.keyRegistrations, this.region});
    ...
    return <String, dynamic>{
      ...
      'keyRegistrations':
          ?pulumi.Input.mapOptionalInputValue<
            List<KeyRegistrationKeyRegistration>,
  ...
  factory KeyRegistrationState.fromMap(Map<String, dynamic> map) {
    return KeyRegistrationState(
      ...
      keyRegistrations: (() {
        final guardedValue = map['keyRegistrations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KeyRegistrationKeyRegistration>(
            guardedValue,
