...
class DataSourceArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'parameters': pulumi.Input.mapInputValue<DataSourceParameters, Map<String, dynamic>>(parameters, (value) => value.toMap()),
  ...
  factory DataSourceArgs.fromMap(Map<String, dynamic> map) {
    return DataSourceArgs(
      ...
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceCredentials.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceId: pulumi.Input.fromValue(map['dataSourceId'] as String),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      parameters: pulumi.Input.fromValue(DataSourceParameters.fromMap((map['parameters']! as Map).cast<String, dynamic>())),
      permissions: (() { final guardedValue = map['permissions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DataSourcePermission>(guardedValue, (value) => DataSourcePermission.fromMap((value as Map).cast<String, dynamic>()))); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sslProperties: (() { final guardedValue = map['sslProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceSslProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      type: pulumi.Input.fromValue(map['type'] as String),
      vpcConnectionProperties: (() { final guardedValue = map['vpcConnectionProperties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceVpcConnectionProperties.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
