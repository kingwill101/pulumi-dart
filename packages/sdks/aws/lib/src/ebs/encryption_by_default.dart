...
import 'encryption_by_default_state.dart';
...
class EncryptionByDefault extends pulumi.CustomResource {
  ...
  /// Creates a new [EncryptionByDefault].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EncryptionByDefault]. {@macro pulumi_ebs_encryption_by_default_encryption_by_default_args_doc}
  ...
  static EncryptionByDefault get(
    String name,
