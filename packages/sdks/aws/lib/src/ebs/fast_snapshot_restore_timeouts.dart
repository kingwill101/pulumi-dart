...
class FastSnapshotRestoreTimeouts {
  ...
  /// Creates a new [FastSnapshotRestoreTimeouts].
  ...
  FastSnapshotRestoreTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory FastSnapshotRestoreTimeouts.fromMap(Map<String, dynamic> map) {
    return FastSnapshotRestoreTimeouts(
      create: (() {
