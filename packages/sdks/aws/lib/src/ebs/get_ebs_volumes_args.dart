...
class GetEbsVolumesArgs {
  ...
  GetEbsVolumesArgs({
    pulumi.Output<List<GetEbsVolumesFilter>>? filters,
  ...
  factory GetEbsVolumesArgs.fromMap(Map<String, dynamic> map) {
    return GetEbsVolumesArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetEbsVolumesFilter>>(pulumi.Input.decodeList<GetEbsVolumesFilter>(map['filters'], (value) => GetEbsVolumesFilter.fromMap((value as Map).cast<String, dynamic>()))),
