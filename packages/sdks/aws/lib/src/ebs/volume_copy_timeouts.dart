...
class VolumeCopyTimeouts {
  ...
  /// Creates a new [VolumeCopyTimeouts].
  ...
  factory VolumeCopyTimeouts.fromMap(Map<String, dynamic> map) {
    return VolumeCopyTimeouts(
