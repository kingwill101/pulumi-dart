...
class SnapshotImportState {
  ...
  factory SnapshotImportState.fromMap(Map<String, dynamic> map) {
    return SnapshotImportState(
      ...
      diskContainer: (() { final guardedValue = map['diskContainer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SnapshotImportDiskContainer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
