...
import 'snapshot_block_public_access_state.dart';
...
/// }
///
/// resource "aws_ebs_snapshotblockpublicaccess" "example" {
///   state = "block-all-sharing"
/// }
/// ```
/// ```java
...
class SnapshotBlockPublicAccess extends pulumi.CustomResource {
  ...
  static SnapshotBlockPublicAccess get(
    String name,
  ...
  SnapshotBlockPublicAccess._get(
    String name, {
