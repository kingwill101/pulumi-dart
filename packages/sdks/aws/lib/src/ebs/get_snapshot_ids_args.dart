...
class GetSnapshotIdsArgs {
  ...
  factory GetSnapshotIdsArgs.fromMap(Map<String, dynamic> map) {
    return GetSnapshotIdsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetSnapshotIdsFilter>(guardedValue, (value) => GetSnapshotIdsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      restorableByUserIds: (() { final guardedValue = map['restorableByUserIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
