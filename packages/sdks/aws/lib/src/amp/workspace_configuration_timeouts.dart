...
class WorkspaceConfigurationTimeouts {
  ...
  /// Creates a new [WorkspaceConfigurationTimeouts].
  ...
  WorkspaceConfigurationTimeouts({this.create, this.update});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'update': ?update};
  }

  factory WorkspaceConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return WorkspaceConfigurationTimeouts(
      create: (() {
