...
class ScraperArgs {
    ...
    return <String, dynamic>{
      ...
      'roleConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(roleConfiguration, (value) => value.toMap()),
  ...
  factory ScraperArgs.fromMap(Map<String, dynamic> map) {
    return ScraperArgs(
      ...
      roleConfiguration: (() {
        final guardedValue = map['roleConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScraperRoleConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      scrapeConfiguration: pulumi.Input.fromValue(
        map['scrapeConfiguration'] as String,
      ),
      source: (() {
        final guardedValue = map['source'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScraperSource.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      tags: (() {
