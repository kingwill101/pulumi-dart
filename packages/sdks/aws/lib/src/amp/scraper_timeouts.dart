...
class ScraperTimeouts {
  ...
  ScraperTimeouts({this.create, this.delete, this.update});
  ...
  factory ScraperTimeouts.fromMap(Map<String, dynamic> map) {
    return ScraperTimeouts(
      create: (() {
