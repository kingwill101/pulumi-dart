...
class ScraperLoggingConfigurationTimeouts {
  ...
  /// Creates a new [ScraperLoggingConfigurationTimeouts].
  ...
  const ScraperLoggingConfigurationTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory ScraperLoggingConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return ScraperLoggingConfigurationTimeouts(
