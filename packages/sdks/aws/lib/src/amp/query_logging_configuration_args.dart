...
class QueryLoggingConfigurationArgs {
  ...
  factory QueryLoggingConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return QueryLoggingConfigurationArgs(
      destinations: pulumi.Input.fromValue(pulumi.Input.decodeList<QueryLoggingConfigurationDestination>(map['destinations']!, (value) => QueryLoggingConfigurationDestination.fromMap((value as Map).cast<String, dynamic>()))),
