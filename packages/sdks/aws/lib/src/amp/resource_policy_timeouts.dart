...
class ResourcePolicyTimeouts {
  ...
  /// Creates a new [ResourcePolicyTimeouts].
  ...
  ResourcePolicyTimeouts({this.create, this.delete, this.update});
  ...
  factory ResourcePolicyTimeouts.fromMap(Map<String, dynamic> map) {
    return ResourcePolicyTimeouts(
      create: (() {
