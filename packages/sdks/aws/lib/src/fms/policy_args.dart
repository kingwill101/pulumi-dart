...
class PolicyArgs {
  ...
  PolicyArgs({
    ...
    required pulumi.Output<bool> excludeResourceTags,
    ...
    required pulumi.Output<PolicySecurityServicePolicyData> securityServicePolicyData,
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      ...
      excludeResourceTags: pulumi.Output.create<bool>(map['excludeResourceTags'] as bool),
      ...
      securityServicePolicyData: pulumi.Output.create<PolicySecurityServicePolicyData>(PolicySecurityServicePolicyData.fromMap((map['securityServicePolicyData'] as Map).cast<String, dynamic>())),
