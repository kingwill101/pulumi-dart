...
class PolicyState {
  ...
  factory PolicyState.fromMap(Map<String, dynamic> map) {
    return PolicyState(
      ...
      excludeResourceTags: map['excludeResourceTags'] == null ? null : ((map['excludeResourceTags'] as bool).input()).input(),
      ...
      policyUpdateToken: map['policyUpdateToken'] == null ? null : ((map['policyUpdateToken'] as String).input()).input(),
      ...
      securityServicePolicyData: map['securityServicePolicyData'] == null ? null : ((PolicySecurityServicePolicyData.fromMap((map['securityServicePolicyData']! as Map).cast<String, dynamic>())).input()).input(),
