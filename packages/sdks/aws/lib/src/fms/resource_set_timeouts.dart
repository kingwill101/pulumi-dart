...
class ResourceSetTimeouts {
  ...
  /// Creates a new [ResourceSetTimeouts].
  ...
  ResourceSetTimeouts({this.create, this.delete, this.update});
  ...
  factory ResourceSetTimeouts.fromMap(Map<String, dynamic> map) {
    return ResourceSetTimeouts(
      create: (() {
