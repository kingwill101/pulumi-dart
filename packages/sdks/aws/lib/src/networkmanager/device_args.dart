...
class DeviceArgs {
  ...
  factory DeviceArgs.fromMap(Map<String, dynamic> map) {
    return DeviceArgs(
      awsLocation: (() { final guardedValue = map['awsLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceAwsLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      globalNetworkId: pulumi.Input.fromValue(map['globalNetworkId'] as String),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeviceLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
