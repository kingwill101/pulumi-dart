    ...
    return GetCoreNetworkPolicyDocumentArgs(
      attachmentPolicies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentAttachmentPolicy>(
            guardedValue,
      ...
      coreNetworkConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetCoreNetworkPolicyDocumentCoreNetworkConfiguration
        >(
      ...
      segments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentSegment>(
          map['segments']!,
