...
class GetCoreNetworkPolicyDocumentArgs {
  ...
  /// [attachmentPolicies] In a core network, all attachments use the block argument `attachmentPolicies` section to map an attachment to a segment. Instead of manually associating a segment to each attachment, attachments use tags, and then the tags are used to associate the attachment to the specified segment. Detailed below.
  ...
  /// [segmentActions] A block argument, `segmentActions` define how routing works between segments. By default, attachments can only communicate with other attachments in the same segment. Detailed below.
  ...
  factory GetCoreNetworkPolicyDocumentArgs.fromMap(Map<String, dynamic> map) {
    return GetCoreNetworkPolicyDocumentArgs(
      attachmentPolicies: (() { final guardedValue = map['attachmentPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentAttachmentPolicy>(guardedValue, (value) => GetCoreNetworkPolicyDocumentAttachmentPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      attachmentRoutingPolicyRules: (() { final guardedValue = map['attachmentRoutingPolicyRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRule>(guardedValue, (value) => GetCoreNetworkPolicyDocumentAttachmentRoutingPolicyRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      coreNetworkConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentCoreNetworkConfiguration>(map['coreNetworkConfigurations']!, (value) => GetCoreNetworkPolicyDocumentCoreNetworkConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      networkFunctionGroups: (() { final guardedValue = map['networkFunctionGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentNetworkFunctionGroup>(guardedValue, (value) => GetCoreNetworkPolicyDocumentNetworkFunctionGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
      routingPolicies: (() { final guardedValue = map['routingPolicies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentRoutingPolicy>(guardedValue, (value) => GetCoreNetworkPolicyDocumentRoutingPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      segmentActions: (() { final guardedValue = map['segmentActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentSegmentAction>(guardedValue, (value) => GetCoreNetworkPolicyDocumentSegmentAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      segments: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentSegment>(map['segments']!, (value) => GetCoreNetworkPolicyDocumentSegment.fromMap((value as Map).cast<String, dynamic>()))),
