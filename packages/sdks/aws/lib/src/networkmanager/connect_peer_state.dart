...
class ConnectPeerState {
  ...
  factory ConnectPeerState.fromMap(Map<String, dynamic> map) {
    return ConnectPeerState(
      ...
      configurations: (() { final guardedValue = map['configurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectPeerConfiguration>(guardedValue, (value) => ConnectPeerConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      connectAttachmentId: (() { final guardedValue = map['connectAttachmentId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      connectPeerId: (() { final guardedValue = map['connectPeerId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
