...
class LinkState {
  ...
  factory LinkState.fromMap(Map<String, dynamic> map) {
    return LinkState(
      ...
      bandwidth: (() { final guardedValue = map['bandwidth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinkBandwidth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
