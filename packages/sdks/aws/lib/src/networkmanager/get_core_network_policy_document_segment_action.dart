...
class GetCoreNetworkPolicyDocumentSegmentAction {
  ...
  final pulumi.Input<GetCoreNetworkPolicyDocumentSegmentActionWhenSentTo>?
  whenSentTo;
    ...
    return <String, dynamic>{
      ...
      'edgeLocationAssociation':
          ?pulumi.Input.mapOptionalInputValue<
            GetCoreNetworkPolicyDocumentSegmentActionEdgeLocationAssociation,
            Map<String, dynamic>
          >(edgeLocationAssociation, (value) => value.toMap()),
      'mode': ?mode,
  ...
  factory GetCoreNetworkPolicyDocumentSegmentAction.fromMap(
    ...
    return GetCoreNetworkPolicyDocumentSegmentAction(
      ...
      edgeLocationAssociation: (() {
        final guardedValue = map['edgeLocationAssociation'];
        if (guardedValue == null) return null;
      ...
      routingPolicyNames: (() {
        final guardedValue = map['routingPolicyNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      segment: pulumi.Input.fromValue(map['segment'] as String),
      shareWithExcepts: (() {
        final guardedValue = map['shareWithExcepts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      shareWiths: (() {
        final guardedValue = map['shareWiths'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      via: (() {
        final guardedValue = map['via'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      whenSentTo: (() {
        final guardedValue = map['whenSentTo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
