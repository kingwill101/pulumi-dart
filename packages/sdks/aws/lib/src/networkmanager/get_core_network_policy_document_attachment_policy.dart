...
class GetCoreNetworkPolicyDocumentAttachmentPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditions': pulumi.Input.encodeList<GetCoreNetworkPolicyDocumentAttachmentPolicyCondition, Map<String, dynamic>>(conditions, (value) => value.toMap()),
  ...
  factory GetCoreNetworkPolicyDocumentAttachmentPolicy.fromMap(Map<String, dynamic> map) {
    return GetCoreNetworkPolicyDocumentAttachmentPolicy(
      action: GetCoreNetworkPolicyDocumentAttachmentPolicyAction.fromMap((map['action'] as Map).cast<String, dynamic>()),
      conditionLogic: map['conditionLogic'] == null ? null : map['conditionLogic'] as String,
      conditions: pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentAttachmentPolicyCondition>(map['conditions'], (value) => GetCoreNetworkPolicyDocumentAttachmentPolicyCondition.fromMap((value as Map).cast<String, dynamic>())),
