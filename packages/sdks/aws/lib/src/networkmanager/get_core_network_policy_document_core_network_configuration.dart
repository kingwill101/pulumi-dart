...
class GetCoreNetworkPolicyDocumentCoreNetworkConfiguration {
  ...
  final pulumi.Input<
    List<GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation>
  >
  edgeLocations;
  ...
  factory GetCoreNetworkPolicyDocumentCoreNetworkConfiguration.fromMap(
    ...
    return GetCoreNetworkPolicyDocumentCoreNetworkConfiguration(
      asnRanges: pulumi.Input.fromValue(
        (map['asnRanges'] as List).cast<String>(),
      ),
      dnsSupport: (() {
      ...
      edgeLocations: pulumi.Input.fromValue(
        ...
        >(
          map['edgeLocations']!,
          (value) =>
              GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation.fromMap(
