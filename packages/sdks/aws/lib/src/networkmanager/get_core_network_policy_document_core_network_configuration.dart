...
class GetCoreNetworkPolicyDocumentCoreNetworkConfiguration {
  ...
  final pulumi.Input<List<String>> asnRanges;
  ...
  final pulumi.Input<List<GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation>> edgeLocations;
  ...
  final pulumi.Input<bool>? vpnEcmpSupport;
  ...
  const GetCoreNetworkPolicyDocumentCoreNetworkConfiguration({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'edgeLocations': pulumi.Input.mapInputValue<List<GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation>, List<Map<String, dynamic>>>(edgeLocations, (value) => pulumi.Input.encodeList<GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetCoreNetworkPolicyDocumentCoreNetworkConfiguration.fromMap(Map<String, dynamic> map) {
    return GetCoreNetworkPolicyDocumentCoreNetworkConfiguration(
      asnRanges: pulumi.Input.fromValue((map['asnRanges'] as List).cast<String>()),
      ...
      edgeLocations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation>(map['edgeLocations']!, (value) => GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      vpnEcmpSupport: (() { final guardedValue = map['vpnEcmpSupport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
