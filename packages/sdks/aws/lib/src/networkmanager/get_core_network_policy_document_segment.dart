...
class GetCoreNetworkPolicyDocumentSegment {
  ...
  factory GetCoreNetworkPolicyDocumentSegment.fromMap(
    ...
    return GetCoreNetworkPolicyDocumentSegment(
      allowFilters: (() {
        final guardedValue = map['allowFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      denyFilters: (() {
        final guardedValue = map['denyFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      description: (() {
      ...
      isolateAttachments: (() {
        final guardedValue = map['isolateAttachments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      requireAttachmentAcceptance: (() {
        final guardedValue = map['requireAttachmentAcceptance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
