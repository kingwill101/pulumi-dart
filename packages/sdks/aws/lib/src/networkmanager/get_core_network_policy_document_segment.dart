...
class GetCoreNetworkPolicyDocumentSegment {
  ...
  /// [edgeLocations] A list of strings of AWS Region names. Allows you to define a more restrictive set of Regions for a segment. The edge location must be a subset of the locations that are defined for `edgeLocations` in the `coreNetworkConfiguration`.
  ...
  factory GetCoreNetworkPolicyDocumentSegment.fromMap(Map<String, dynamic> map) {
    return GetCoreNetworkPolicyDocumentSegment(
      allowFilters: (() { final guardedValue = map['allowFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      denyFilters: (() { final guardedValue = map['denyFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      isolateAttachments: (() { final guardedValue = map['isolateAttachments']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      requireAttachmentAcceptance: (() { final guardedValue = map['requireAttachmentAcceptance']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
