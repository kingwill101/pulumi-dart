...
class GetCoreNetworkPolicyDocumentAttachmentPolicyAction {
  ...
  factory GetCoreNetworkPolicyDocumentAttachmentPolicyAction.fromMap(Map<String, dynamic> map) {
    return GetCoreNetworkPolicyDocumentAttachmentPolicyAction(
      addToNetworkFunctionGroup: map['addToNetworkFunctionGroup'] == null ? null : map['addToNetworkFunctionGroup'] as String,
      associationMethod: map['associationMethod'] == null ? null : map['associationMethod'] as String,
      requireAcceptance: map['requireAcceptance'] == null ? null : map['requireAcceptance'] as bool,
      segment: map['segment'] == null ? null : map['segment'] as String,
      tagValueOfKey: map['tagValueOfKey'] == null ? null : map['tagValueOfKey'] as String,
    );
  }
}
