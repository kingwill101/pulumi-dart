  ...
  factory GetCoreNetworkPolicyDocumentAttachmentPolicyAction.fromMap(
    ...
    return GetCoreNetworkPolicyDocumentAttachmentPolicyAction(
      addToNetworkFunctionGroup: (() {
        final guardedValue = map['addToNetworkFunctionGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      associationMethod: (() {
        final guardedValue = map['associationMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      requireAcceptance: (() {
        final guardedValue = map['requireAcceptance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      segment: (() {
        final guardedValue = map['segment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tagValueOfKey: (() {
        final guardedValue = map['tagValueOfKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
