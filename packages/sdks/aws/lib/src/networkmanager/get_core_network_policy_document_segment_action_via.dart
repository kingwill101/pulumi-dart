...
class GetCoreNetworkPolicyDocumentSegmentActionVia {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'withEdgeOverrides': ?pulumi.Input.mapOptionalInputValue<List<GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverride>, List<Map<String, dynamic>>>(withEdgeOverrides, (value) => pulumi.Input.encodeList<GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverride, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetCoreNetworkPolicyDocumentSegmentActionVia.fromMap(Map<String, dynamic> map) {
    return GetCoreNetworkPolicyDocumentSegmentActionVia(
      networkFunctionGroups: (() { final guardedValue = map['networkFunctionGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      withEdgeOverrides: (() { final guardedValue = map['withEdgeOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverride>(guardedValue, (value) => GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
