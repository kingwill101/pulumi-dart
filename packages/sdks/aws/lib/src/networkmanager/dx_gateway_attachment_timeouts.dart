...
class DxGatewayAttachmentTimeouts {
  ...
  /// Creates a new [DxGatewayAttachmentTimeouts].
  ...
  DxGatewayAttachmentTimeouts({this.create, this.delete, this.update});
  ...
  factory DxGatewayAttachmentTimeouts.fromMap(Map<String, dynamic> map) {
    return DxGatewayAttachmentTimeouts(
      create: (() {
