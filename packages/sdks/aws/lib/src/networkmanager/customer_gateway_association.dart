...
import 'customer_gateway_association_state.dart';
...
class CustomerGatewayAssociation extends pulumi.CustomResource {
  ...
  /// Creates a new [CustomerGatewayAssociation].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CustomerGatewayAssociation]. {@macro pulumi_networkmanager_customer_gateway_association_customer_gateway_association_args_doc}
  ...
  static CustomerGatewayAssociation get(
    String name,
  ...
  CustomerGatewayAssociation._get(
    String name, {
