  ...
  factory KeySigningKeyState.fromMap(Map<String, dynamic> map) {
    return KeySigningKeyState(
      digestAlgorithmMnemonic: (() {
        final guardedValue = map['digestAlgorithmMnemonic'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      digestAlgorithmType: (() {
        final guardedValue = map['digestAlgorithmType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      digestValue: (() {
        final guardedValue = map['digestValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dnskeyRecord: (() {
        final guardedValue = map['dnskeyRecord'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dsRecord: (() {
        final guardedValue = map['dsRecord'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      flag: (() {
      ...
      keyManagementServiceArn: (() {
        final guardedValue = map['keyManagementServiceArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      keyTag: (() {
      ...
      signingAlgorithmMnemonic: (() {
        final guardedValue = map['signingAlgorithmMnemonic'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signingAlgorithmType: (() {
        final guardedValue = map['signingAlgorithmType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      status: (() {
