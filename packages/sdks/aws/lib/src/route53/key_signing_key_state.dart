...
class KeySigningKeyState {
  ...
  factory KeySigningKeyState.fromMap(Map<String, dynamic> map) {
    return KeySigningKeyState(
      ...
      digestAlgorithmType: (() { final guardedValue = map['digestAlgorithmType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      signingAlgorithmType: (() { final guardedValue = map['signingAlgorithmType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
