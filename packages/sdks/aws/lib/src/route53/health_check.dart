...
class HealthCheck extends pulumi.CustomResource {
  ...
  HealthCheck(
    ...
    this.cloudwatchAlarmRegion = registerOutput<String?>('cloudwatchAlarmRegion');
    ...
    this.insufficientDataHealthStatus = registerOutput<String?>('insufficientDataHealthStatus');
