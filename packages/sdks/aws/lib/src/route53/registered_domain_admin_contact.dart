...
class RegisteredDomainAdminContact {
  ...
  /// Creates a new [RegisteredDomainAdminContact].
  ...
  const RegisteredDomainAdminContact({
    this.addressLine1,
    this.addressLine2,
    this.city,
    this.contactType,
  ...
  factory RegisteredDomainAdminContact.fromMap(Map<String, dynamic> map) {
    return RegisteredDomainAdminContact(
