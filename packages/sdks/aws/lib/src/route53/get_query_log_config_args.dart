...
class GetQueryLogConfigArgs {
  ...
  factory GetQueryLogConfigArgs.fromMap(Map<String, dynamic> map) {
    return GetQueryLogConfigArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetQueryLogConfigFilter>(guardedValue, (value) => GetQueryLogConfigFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
