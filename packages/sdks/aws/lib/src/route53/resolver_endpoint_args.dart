...
class ResolverEndpointArgs {
  ...
  factory ResolverEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ResolverEndpointArgs(
      ...
      ipAddresses: pulumi.Input.fromValue(pulumi.Input.decodeList<ResolverEndpointIpAddress>(map['ipAddresses']!, (value) => ResolverEndpointIpAddress.fromMap((value as Map).cast<String, dynamic>()))),
