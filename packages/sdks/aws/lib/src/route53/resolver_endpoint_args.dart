  ...
  factory ResolverEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ResolverEndpointArgs(
      ...
      ipAddresses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ResolverEndpointIpAddress>(
          map['ipAddresses']!,
      ...
      resolverEndpointType: (() {
        final guardedValue = map['resolverEndpointType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rniEnhancedMetricsEnabled: (() {
        final guardedValue = map['rniEnhancedMetricsEnabled'];
        if (guardedValue == null) return null;
      ...
      targetNameServerMetricsEnabled: (() {
        final guardedValue = map['targetNameServerMetricsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
