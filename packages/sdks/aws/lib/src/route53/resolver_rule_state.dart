...
class ResolverRuleState {
  ...
  factory ResolverRuleState.fromMap(Map<String, dynamic> map) {
    return ResolverRuleState(
      ...
      targetIps: (() { final guardedValue = map['targetIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResolverRuleTargetIp>(guardedValue, (value) => ResolverRuleTargetIp.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
