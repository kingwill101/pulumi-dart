...
import 'resolver_firewall_rule_group_association_state.dart';
...
class ResolverFirewallRuleGroupAssociation extends pulumi.CustomResource {
  ...
  /// Gets an existing [ResolverFirewallRuleGroupAssociation] resource's state with the given [name] and [id].
  static ResolverFirewallRuleGroupAssociation get(
    String name,
  ...
  ResolverFirewallRuleGroupAssociation._get(
    String name, {
