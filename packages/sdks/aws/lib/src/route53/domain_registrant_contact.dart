...
class DomainRegistrantContact {
  ...
  factory DomainRegistrantContact.fromMap(Map<String, dynamic> map) {
    return DomainRegistrantContact(
      ...
      extraParams: map['extraParams'] == null ? null : (pulumi.Input.decodeList<DomainRegistrantContactExtraParam>(map['extraParams'], (value) => DomainRegistrantContactExtraParam.fromMap((value as Map).cast<String, dynamic>()))).input(),
