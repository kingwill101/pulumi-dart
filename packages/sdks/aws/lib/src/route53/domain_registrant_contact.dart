...
import 'domain_registrant_contact_extra_param.dart';
...
class DomainRegistrantContact {
  ...
  final List<DomainRegistrantContactExtraParam>? extraParams;
  ...
  /// Creates a new [DomainRegistrantContact].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'email': ?email,
      'extraParams': ?extraParams == null ? null : pulumi.Input.encodeList<DomainRegistrantContactExtraParam, Map<String, dynamic>>(extraParams!, (value) => value.toMap()),
      'fax': ?fax,
      'firstName': ?firstName,
      'lastName': ?lastName,
  ...
  factory DomainRegistrantContact.fromMap(Map<String, dynamic> map) {
    return DomainRegistrantContact(
      ...
      extraParams: map['extraParams'] == null ? null : pulumi.Input.decodeList<DomainRegistrantContactExtraParam>(map['extraParams'], (value) => DomainRegistrantContactExtraParam.fromMap((value as Map).cast<String, dynamic>())),
