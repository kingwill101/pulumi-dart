...
class DomainRegistrantContact {
  ...
  factory DomainRegistrantContact.fromMap(Map<String, dynamic> map) {
    return DomainRegistrantContact(
      ...
      extraParams: (() { final guardedValue = map['extraParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainRegistrantContactExtraParam>(guardedValue, (value) => DomainRegistrantContactExtraParam.fromMap((value as Map).cast<String, dynamic>()))); })(),
