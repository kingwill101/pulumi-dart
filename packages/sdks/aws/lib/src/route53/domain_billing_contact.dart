...
class DomainBillingContact {
  ...
  factory DomainBillingContact.fromMap(Map<String, dynamic> map) {
    return DomainBillingContact(
      ...
      addressLine2: pulumi.Input.fromValue(map['addressLine2'] as String),
      city: pulumi.Input.fromValue(map['city'] as String),
      contactType: pulumi.Input.fromValue(map['contactType'] as String),
      countryCode: pulumi.Input.fromValue(map['countryCode'] as String),
      email: pulumi.Input.fromValue(map['email'] as String),
      extraParams: pulumi.Input.fromValue(pulumi.Input.decodeList<DomainBillingContactExtraParam>(map['extraParams']!, (value) => DomainBillingContactExtraParam.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      zipCode: pulumi.Input.fromValue(map['zipCode'] as String),
    );
  }
}
