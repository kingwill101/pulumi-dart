...
class GetResolverFirewallRulesFirewallRule {
  ...
  factory GetResolverFirewallRulesFirewallRule.fromMap(
    ...
    return GetResolverFirewallRulesFirewallRule(
      ...
      blockOverrideDnsType: pulumi.Input.fromValue(
        map['blockOverrideDnsType'] as String,
      ),
      blockOverrideDomain: pulumi.Input.fromValue(
      ...
      creatorRequestId: pulumi.Input.fromValue(
        map['creatorRequestId'] as String,
      ),
      dnsThreatProtection: pulumi.Input.fromValue(
        map['dnsThreatProtection'] as String,
      ),
      firewallDomainListId: pulumi.Input.fromValue(
        map['firewallDomainListId'] as String,
      ),
      firewallDomainRedirectionAction: pulumi.Input.fromValue(
        map['firewallDomainRedirectionAction'] as String,
      ),
      firewallRuleGroupId: pulumi.Input.fromValue(
        map['firewallRuleGroupId'] as String,
      ),
      firewallThreatProtectionId: pulumi.Input.fromValue(
        map['firewallThreatProtectionId'] as String,
      ),
