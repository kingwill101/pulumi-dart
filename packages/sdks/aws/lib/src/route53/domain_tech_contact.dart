...
import 'domain_tech_contact_extra_param.dart';
...
class DomainTechContact {
  ...
  final pulumi.Input<List<DomainTechContactExtraParam>?>? extraParams;
  ...
  /// Creates a new [DomainTechContact].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'email': ?email,
      'extraParams': ?pulumi.Input.mapOptionalInputValue<List<DomainTechContactExtraParam>, List<Map<String, dynamic>>>(extraParams, (value) => pulumi.Input.encodeList<DomainTechContactExtraParam, Map<String, dynamic>>(value, (value) => value.toMap())),
      'fax': ?fax,
      'firstName': ?firstName,
      'lastName': ?lastName,
  ...
  factory DomainTechContact.fromMap(Map<String, dynamic> map) {
    return DomainTechContact(
      ...
      contactType: (() { final guardedValue = map['contactType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      extraParams: (() { final guardedValue = map['extraParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainTechContactExtraParam>(guardedValue, (value) => DomainTechContactExtraParam.fromMap((value as Map).cast<String, dynamic>()))); })(),
