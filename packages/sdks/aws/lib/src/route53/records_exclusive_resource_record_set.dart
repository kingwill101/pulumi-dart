...
class RecordsExclusiveResourceRecordSet {
  ...
  factory RecordsExclusiveResourceRecordSet.fromMap(Map<String, dynamic> map) {
    return RecordsExclusiveResourceRecordSet(
      aliasTarget: (() { final guardedValue = map['aliasTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecordsExclusiveResourceRecordSetAliasTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cidrRoutingConfig: (() { final guardedValue = map['cidrRoutingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecordsExclusiveResourceRecordSetCidrRoutingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      geolocation: (() { final guardedValue = map['geolocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecordsExclusiveResourceRecordSetGeolocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      geoproximityLocation: (() { final guardedValue = map['geoproximityLocation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RecordsExclusiveResourceRecordSetGeoproximityLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      multiValueAnswer: (() { final guardedValue = map['multiValueAnswer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
