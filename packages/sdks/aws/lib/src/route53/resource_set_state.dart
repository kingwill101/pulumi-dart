...
class ResourceSetState {
  ...
  factory ResourceSetState.fromMap(Map<String, dynamic> map) {
    return ResourceSetState(
      ...
      resourceSetType: (() { final guardedValue = map['resourceSetType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resources: (() { final guardedValue = map['resources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceSetResource>(guardedValue, (value) => ResourceSetResource.fromMap((value as Map).cast<String, dynamic>()))); })(),
