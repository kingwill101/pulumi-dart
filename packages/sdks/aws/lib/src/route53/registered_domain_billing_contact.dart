...
class RegisteredDomainBillingContact {
  ...
  /// Creates a new [RegisteredDomainBillingContact].
  ...
  const RegisteredDomainBillingContact({
    this.addressLine1,
    this.addressLine2,
    this.city,
    this.contactType,
  ...
  factory RegisteredDomainBillingContact.fromMap(Map<String, dynamic> map) {
    return RegisteredDomainBillingContact(
      ...
      extraParams: (() { final guardedValue = map['extraParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
