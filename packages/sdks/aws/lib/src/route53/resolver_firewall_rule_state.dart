  ...
  factory ResolverFirewallRuleState.fromMap(Map<String, dynamic> map) {
    return ResolverFirewallRuleState(
      ...
      blockOverrideDnsType: (() {
        final guardedValue = map['blockOverrideDnsType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      blockOverrideDomain: (() {
        final guardedValue = map['blockOverrideDomain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      blockOverrideTtl: (() {
        final guardedValue = map['blockOverrideTtl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      blockResponse: (() {
        final guardedValue = map['blockResponse'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      confidenceThreshold: (() {
      ...
      dnsThreatProtection: (() {
        final guardedValue = map['dnsThreatProtection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firewallDomainListId: (() {
        final guardedValue = map['firewallDomainListId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firewallDomainRedirectionAction: (() {
        final guardedValue = map['firewallDomainRedirectionAction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firewallRuleGroupId: (() {
        final guardedValue = map['firewallRuleGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firewallThreatProtectionId: (() {
        final guardedValue = map['firewallThreatProtectionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
