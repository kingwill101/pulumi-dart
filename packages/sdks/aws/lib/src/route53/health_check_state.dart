...
class HealthCheckState {
  ...
  HealthCheckState({
    ...
    pulumi.Output<int>? childHealthThreshold,
    pulumi.Output<List<String>>? childHealthchecks,
    pulumi.Output<String>? cloudwatchAlarmName,
    pulumi.Output<String>? cloudwatchAlarmRegion,
    pulumi.Output<bool>? disabled,
    pulumi.Output<bool>? enableSni,
    pulumi.Output<int>? failureThreshold,
    pulumi.Output<String>? fqdn,
    pulumi.Output<String>? insufficientDataHealthStatus,
    pulumi.Output<bool>? invertHealthcheck,
    pulumi.Output<String>? ipAddress,
    pulumi.Output<bool>? measureLatency,
    pulumi.Output<int>? port,
    pulumi.Output<String>? referenceName,
    pulumi.Output<List<String>>? regions,
    pulumi.Output<int>? requestInterval,
    pulumi.Output<String>? resourcePath,
    pulumi.Output<String>? routingControlArn,
    ...
    pulumi.Output<String>? type,
      ...
      childHealthThreshold = pulumi.Input.asOptionalInput<int>(childHealthThreshold),
      childHealthchecks = pulumi.Input.asOptionalInput<List<String>>(childHealthchecks),
      cloudwatchAlarmName = pulumi.Input.asOptionalInput<String>(cloudwatchAlarmName),
      cloudwatchAlarmRegion = pulumi.Input.asOptionalInput<String>(cloudwatchAlarmRegion),
      ...
      insufficientDataHealthStatus = pulumi.Input.asOptionalInput<String>(insufficientDataHealthStatus),
      invertHealthcheck = pulumi.Input.asOptionalInput<bool>(invertHealthcheck),
      ...
      routingControlArn = pulumi.Input.asOptionalInput<String>(routingControlArn),
  ...
  factory HealthCheckState.fromMap(Map<String, dynamic> map) {
    return HealthCheckState(
      ...
      childHealthThreshold: map['childHealthThreshold'] == null ? null : pulumi.Output.create<int>(map['childHealthThreshold'] as int),
      childHealthchecks: map['childHealthchecks'] == null ? null : pulumi.Output.create<List<String>>((map['childHealthchecks'] as List).cast<String>()),
      cloudwatchAlarmName: map['cloudwatchAlarmName'] == null ? null : pulumi.Output.create<String>(map['cloudwatchAlarmName'] as String),
      cloudwatchAlarmRegion: map['cloudwatchAlarmRegion'] == null ? null : pulumi.Output.create<String>(map['cloudwatchAlarmRegion'] as String),
      disabled: map['disabled'] == null ? null : pulumi.Output.create<bool>(map['disabled'] as bool),
      enableSni: map['enableSni'] == null ? null : pulumi.Output.create<bool>(map['enableSni'] as bool),
      failureThreshold: map['failureThreshold'] == null ? null : pulumi.Output.create<int>(map['failureThreshold'] as int),
      fqdn: map['fqdn'] == null ? null : pulumi.Output.create<String>(map['fqdn'] as String),
      insufficientDataHealthStatus: map['insufficientDataHealthStatus'] == null ? null : pulumi.Output.create<String>(map['insufficientDataHealthStatus'] as String),
      invertHealthcheck: map['invertHealthcheck'] == null ? null : pulumi.Output.create<bool>(map['invertHealthcheck'] as bool),
      ipAddress: map['ipAddress'] == null ? null : pulumi.Output.create<String>(map['ipAddress'] as String),
      measureLatency: map['measureLatency'] == null ? null : pulumi.Output.create<bool>(map['measureLatency'] as bool),
      ...
      requestInterval: map['requestInterval'] == null ? null : pulumi.Output.create<int>(map['requestInterval'] as int),
      resourcePath: map['resourcePath'] == null ? null : pulumi.Output.create<String>(map['resourcePath'] as String),
      routingControlArn: map['routingControlArn'] == null ? null : pulumi.Output.create<String>(map['routingControlArn'] as String),
