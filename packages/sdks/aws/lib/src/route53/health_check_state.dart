...
class HealthCheckState {
  ...
  factory HealthCheckState.fromMap(Map<String, dynamic> map) {
    return HealthCheckState(
      ...
      childHealthThreshold: (() { final guardedValue = map['childHealthThreshold']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      requestInterval: (() { final guardedValue = map['requestInterval']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
