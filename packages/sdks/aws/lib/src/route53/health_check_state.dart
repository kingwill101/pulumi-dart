...
class HealthCheckState {
  ...
  factory HealthCheckState.fromMap(Map<String, dynamic> map) {
    return HealthCheckState(
      ...
      childHealthThreshold: map['childHealthThreshold'] == null ? null : ((map['childHealthThreshold'] as int).input()).input(),
      childHealthchecks: map['childHealthchecks'] == null ? null : (((map['childHealthchecks'] as List).cast<String>()).input()).input(),
      cloudwatchAlarmName: map['cloudwatchAlarmName'] == null ? null : ((map['cloudwatchAlarmName'] as String).input()).input(),
      cloudwatchAlarmRegion: map['cloudwatchAlarmRegion'] == null ? null : ((map['cloudwatchAlarmRegion'] as String).input()).input(),
      disabled: map['disabled'] == null ? null : ((map['disabled'] as bool).input()).input(),
      enableSni: map['enableSni'] == null ? null : ((map['enableSni'] as bool).input()).input(),
      failureThreshold: map['failureThreshold'] == null ? null : ((map['failureThreshold'] as int).input()).input(),
      fqdn: map['fqdn'] == null ? null : ((map['fqdn'] as String).input()).input(),
      insufficientDataHealthStatus: map['insufficientDataHealthStatus'] == null ? null : ((map['insufficientDataHealthStatus'] as String).input()).input(),
      invertHealthcheck: map['invertHealthcheck'] == null ? null : ((map['invertHealthcheck'] as bool).input()).input(),
      ipAddress: map['ipAddress'] == null ? null : ((map['ipAddress'] as String).input()).input(),
      measureLatency: map['measureLatency'] == null ? null : ((map['measureLatency'] as bool).input()).input(),
      ...
      requestInterval: map['requestInterval'] == null ? null : ((map['requestInterval'] as int).input()).input(),
      resourcePath: map['resourcePath'] == null ? null : ((map['resourcePath'] as String).input()).input(),
      routingControlArn: map['routingControlArn'] == null ? null : ((map['routingControlArn'] as String).input()).input(),
