...
class HealthCheckState {
  ...
  factory HealthCheckState.fromMap(Map<String, dynamic> map) {
    return HealthCheckState(
      ...
      childHealthThreshold: map['childHealthThreshold'] == null ? null : (map['childHealthThreshold'] as int).input(),
      childHealthchecks: map['childHealthchecks'] == null ? null : ((map['childHealthchecks'] as List).cast<String>()).input(),
      cloudwatchAlarmName: map['cloudwatchAlarmName'] == null ? null : (map['cloudwatchAlarmName'] as String).input(),
      cloudwatchAlarmRegion: map['cloudwatchAlarmRegion'] == null ? null : (map['cloudwatchAlarmRegion'] as String).input(),
      disabled: map['disabled'] == null ? null : (map['disabled'] as bool).input(),
      enableSni: map['enableSni'] == null ? null : (map['enableSni'] as bool).input(),
      failureThreshold: map['failureThreshold'] == null ? null : (map['failureThreshold'] as int).input(),
      fqdn: map['fqdn'] == null ? null : (map['fqdn'] as String).input(),
      insufficientDataHealthStatus: map['insufficientDataHealthStatus'] == null ? null : (map['insufficientDataHealthStatus'] as String).input(),
      invertHealthcheck: map['invertHealthcheck'] == null ? null : (map['invertHealthcheck'] as bool).input(),
      ipAddress: map['ipAddress'] == null ? null : (map['ipAddress'] as String).input(),
      measureLatency: map['measureLatency'] == null ? null : (map['measureLatency'] as bool).input(),
      port: map['port'] == null ? null : (map['port'] as int).input(),
      referenceName: map['referenceName'] == null ? null : (map['referenceName'] as String).input(),
      regions: map['regions'] == null ? null : ((map['regions'] as List).cast<String>()).input(),
      requestInterval: map['requestInterval'] == null ? null : (map['requestInterval'] as int).input(),
      resourcePath: map['resourcePath'] == null ? null : (map['resourcePath'] as String).input(),
      routingControlArn: map['routingControlArn'] == null ? null : (map['routingControlArn'] as String).input(),
