...
class GetTrafficPolicyDocumentRule {
  ...
  final pulumi.Input<List<GetTrafficPolicyDocumentRuleGeoProximityLocation>>?
    ...
    return <String, dynamic>{
      'geoProximityLocations':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetTrafficPolicyDocumentRuleGeoProximityLocation>,
      ...
      'items':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetTrafficPolicyDocumentRuleItem>,
            List<Map<String, dynamic>>
          >(
            items,
            (value) =>
      ...
      'locations':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetTrafficPolicyDocumentRuleLocation>,
            List<Map<String, dynamic>>
          >(
            locations,
            (value) =>
      ...
      'regions':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetTrafficPolicyDocumentRuleRegion>,
            List<Map<String, dynamic>>
          >(
            regions,
            (value) =>
  ...
  factory GetTrafficPolicyDocumentRule.fromMap(Map<String, dynamic> map) {
    return GetTrafficPolicyDocumentRule(
      geoProximityLocations: (() {
        final guardedValue = map['geoProximityLocations'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GetTrafficPolicyDocumentRuleGeoProximityLocation.fromMap(
