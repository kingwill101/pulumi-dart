...
class DomainAdminContact {
  ...
  factory DomainAdminContact.fromMap(Map<String, dynamic> map) {
    return DomainAdminContact(
      ...
      extraParams: map['extraParams'] == null ? null : ((pulumi.Input.decodeList<DomainAdminContactExtraParam>(map['extraParams']!, (value) => DomainAdminContactExtraParam.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
