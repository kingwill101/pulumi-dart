...
class DomainAdminContact {
  ...
  final pulumi.Input<List<DomainAdminContactExtraParam>>? extraParams;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'email': ?email,
      'extraParams': ?pulumi.Input.mapOptionalInputValue<List<DomainAdminContactExtraParam>, List<Map<String, dynamic>>>(extraParams, (value) => pulumi.Input.encodeList<DomainAdminContactExtraParam, Map<String, dynamic>>(value, (value) => value.toMap())),
      'fax': ?fax,
      'firstName': ?firstName,
      'lastName': ?lastName,
  ...
  factory DomainAdminContact.fromMap(Map<String, dynamic> map) {
    return DomainAdminContact(
      ...
      extraParams: (() { final guardedValue = map['extraParams']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainAdminContactExtraParam>(guardedValue, (value) => DomainAdminContactExtraParam.fromMap((value as Map).cast<String, dynamic>()))); })(),
