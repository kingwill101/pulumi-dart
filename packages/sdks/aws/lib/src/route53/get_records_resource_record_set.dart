...
class GetRecordsResourceRecordSet {
  ...
  factory GetRecordsResourceRecordSet.fromMap(Map<String, dynamic> map) {
    return GetRecordsResourceRecordSet(
      aliasTarget: pulumi.Input.fromValue(GetRecordsResourceRecordSetAliasTarget.fromMap((map['aliasTarget']! as Map).cast<String, dynamic>())),
      cidrRoutingConfig: pulumi.Input.fromValue(GetRecordsResourceRecordSetCidrRoutingConfig.fromMap((map['cidrRoutingConfig']! as Map).cast<String, dynamic>())),
      failover: pulumi.Input.fromValue(map['failover'] as String),
      geolocation: pulumi.Input.fromValue(GetRecordsResourceRecordSetGeolocation.fromMap((map['geolocation']! as Map).cast<String, dynamic>())),
      geoproximityLocation: pulumi.Input.fromValue(GetRecordsResourceRecordSetGeoproximityLocation.fromMap((map['geoproximityLocation']! as Map).cast<String, dynamic>())),
