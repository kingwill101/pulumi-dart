...
class RecordState {
  ...
  factory RecordState.fromMap(Map<String, dynamic> map) {
    return RecordState(
      aliases: map['aliases'] == null ? null : ((pulumi.Input.decodeList<RecordAlias>(map['aliases']!, (value) => RecordAlias.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      allowOverwrite: map['allowOverwrite'] == null ? null : ((map['allowOverwrite'] as bool).input()).input(),
      cidrRoutingPolicy: map['cidrRoutingPolicy'] == null ? null : ((RecordCidrRoutingPolicy.fromMap((map['cidrRoutingPolicy']! as Map).cast<String, dynamic>())).input()).input(),
      failoverRoutingPolicies: map['failoverRoutingPolicies'] == null ? null : ((pulumi.Input.decodeList<RecordFailoverRoutingPolicy>(map['failoverRoutingPolicies']!, (value) => RecordFailoverRoutingPolicy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      fqdn: map['fqdn'] == null ? null : ((map['fqdn'] as String).input()).input(),
      geolocationRoutingPolicies: map['geolocationRoutingPolicies'] == null ? null : ((pulumi.Input.decodeList<RecordGeolocationRoutingPolicy>(map['geolocationRoutingPolicies']!, (value) => RecordGeolocationRoutingPolicy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      geoproximityRoutingPolicy: map['geoproximityRoutingPolicy'] == null ? null : ((RecordGeoproximityRoutingPolicy.fromMap((map['geoproximityRoutingPolicy']! as Map).cast<String, dynamic>())).input()).input(),
      healthCheckId: map['healthCheckId'] == null ? null : ((map['healthCheckId'] as String).input()).input(),
      latencyRoutingPolicies: map['latencyRoutingPolicies'] == null ? null : ((pulumi.Input.decodeList<RecordLatencyRoutingPolicy>(map['latencyRoutingPolicies']!, (value) => RecordLatencyRoutingPolicy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      multivalueAnswerRoutingPolicy: map['multivalueAnswerRoutingPolicy'] == null ? null : ((map['multivalueAnswerRoutingPolicy'] as bool).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      records: map['records'] == null ? null : (((map['records'] as List).cast<String>()).input()).input(),
      ...
      weightedRoutingPolicies: map['weightedRoutingPolicies'] == null ? null : ((pulumi.Input.decodeList<RecordWeightedRoutingPolicy>(map['weightedRoutingPolicies']!, (value) => RecordWeightedRoutingPolicy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
