...
class BudgetFilterExpressionAndDimensions {
  ...
  /// Creates a new [BudgetFilterExpressionAndDimensions].
  ...
  const BudgetFilterExpressionAndDimensions({
    required this.key,
    this.matchOptions,
  ...
  factory BudgetFilterExpressionAndDimensions.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndDimensions(
