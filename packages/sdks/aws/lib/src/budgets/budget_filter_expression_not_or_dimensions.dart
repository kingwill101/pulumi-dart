...
class BudgetFilterExpressionNotOrDimensions {
  ...
  /// Creates a new [BudgetFilterExpressionNotOrDimensions].
  ...
  const BudgetFilterExpressionNotOrDimensions({
    required this.key,
    this.matchOptions,
  ...
  factory BudgetFilterExpressionNotOrDimensions.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionNotOrDimensions(
