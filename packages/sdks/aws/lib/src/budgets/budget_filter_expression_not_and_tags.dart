...
class BudgetFilterExpressionNotAndTags {
  ...
  /// Creates a new [BudgetFilterExpressionNotAndTags].
  ...
  BudgetFilterExpressionNotAndTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionNotAndTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionNotAndTags(
      key: (() {
