...
class BudgetFilterExpressionAndTags {
  ...
  /// Creates a new [BudgetFilterExpressionAndTags].
  ...
  BudgetFilterExpressionAndTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionAndTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndTags(
      key: (() {
