...
class BudgetFilterExpressionOrNotCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionOrNotCostCategories].
  ...
  const BudgetFilterExpressionOrNotCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionOrNotCostCategories.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionOrNotCostCategories(
