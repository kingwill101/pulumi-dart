...
class BudgetFilterExpressionAndOrCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionAndOrCostCategories].
  ...
  const BudgetFilterExpressionAndOrCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionAndOrCostCategories.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndOrCostCategories(
