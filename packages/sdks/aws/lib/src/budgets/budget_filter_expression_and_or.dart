...
class BudgetFilterExpressionAndOr {
  ...
  const BudgetFilterExpressionAndOr({
    this.costCategories,
    this.dimensions,
    this.tags,
  });
  ...
  factory BudgetFilterExpressionAndOr.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndOr(
      costCategories: (() { final guardedValue = map['costCategories']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BudgetFilterExpressionAndOrCostCategories.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dimensions: (() { final guardedValue = map['dimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BudgetFilterExpressionAndOrDimensions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BudgetFilterExpressionAndOrTags.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
