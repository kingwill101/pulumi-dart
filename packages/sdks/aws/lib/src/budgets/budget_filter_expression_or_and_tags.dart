...
class BudgetFilterExpressionOrAndTags {
  ...
  /// Creates a new [BudgetFilterExpressionOrAndTags].
  ...
  BudgetFilterExpressionOrAndTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionOrAndTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionOrAndTags(
      key: (() {
