...
class BudgetFilterExpressionTags {
  ...
  /// Creates a new [BudgetFilterExpressionTags].
  ...
  BudgetFilterExpressionTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionTags(
      key: (() {
