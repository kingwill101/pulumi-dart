...
class BudgetFilterExpressionOrOrDimensions {
  ...
  /// Creates a new [BudgetFilterExpressionOrOrDimensions].
  ...
  const BudgetFilterExpressionOrOrDimensions({
    required this.key,
    this.matchOptions,
  ...
  factory BudgetFilterExpressionOrOrDimensions.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionOrOrDimensions(
