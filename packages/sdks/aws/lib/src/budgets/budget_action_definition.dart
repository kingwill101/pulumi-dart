...
class BudgetActionDefinition {
  ...
  final pulumi.Input<BudgetActionDefinitionIamActionDefinition>?
  iamActionDefinition;

  /// The service control policies (SCPs) action definition details. See SCP Action Definition.
  final pulumi.Input<BudgetActionDefinitionScpActionDefinition>?
  scpActionDefinition;

  /// The AWS Systems Manager (SSM) action definition details. See SSM Action Definition.
  final pulumi.Input<BudgetActionDefinitionSsmActionDefinition>?
  ssmActionDefinition;
    ...
    return <String, dynamic>{
      'iamActionDefinition':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(iamActionDefinition, (value) => value.toMap()),
      'scpActionDefinition':
          ?pulumi.Input.mapOptionalInputValue<
            BudgetActionDefinitionScpActionDefinition,
            Map<String, dynamic>
          >(scpActionDefinition, (value) => value.toMap()),
      'ssmActionDefinition':
          ?pulumi.Input.mapOptionalInputValue<
            BudgetActionDefinitionSsmActionDefinition,
            Map<String, dynamic>
          >(ssmActionDefinition, (value) => value.toMap()),
    };
  }
  ...
  factory BudgetActionDefinition.fromMap(Map<String, dynamic> map) {
    return BudgetActionDefinition(
      iamActionDefinition: (() {
        final guardedValue = map['iamActionDefinition'];
      ...
      scpActionDefinition: (() {
        final guardedValue = map['scpActionDefinition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ssmActionDefinition: (() {
        final guardedValue = map['ssmActionDefinition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
