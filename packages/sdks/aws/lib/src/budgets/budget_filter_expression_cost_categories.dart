...
class BudgetFilterExpressionCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionCostCategories].
  ...
  const BudgetFilterExpressionCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionCostCategories.fromMap(Map<String, dynamic> map) {
