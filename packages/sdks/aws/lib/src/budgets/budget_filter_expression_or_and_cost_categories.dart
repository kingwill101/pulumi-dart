...
class BudgetFilterExpressionOrAndCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionOrAndCostCategories].
  ...
  const BudgetFilterExpressionOrAndCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionOrAndCostCategories.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionOrAndCostCategories(
