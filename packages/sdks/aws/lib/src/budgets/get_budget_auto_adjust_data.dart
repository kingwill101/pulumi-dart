...
class GetBudgetAutoAdjustData {
  ...
  final pulumi.Input<List<GetBudgetAutoAdjustDataHistoricalOption>>
  historicalOptions;
    ...
    return <String, dynamic>{
      ...
      'historicalOptions':
          pulumi.Input.mapInputValue<
            List<GetBudgetAutoAdjustDataHistoricalOption>,
  ...
  factory GetBudgetAutoAdjustData.fromMap(Map<String, dynamic> map) {
    return GetBudgetAutoAdjustData(
      ...
      historicalOptions: pulumi.Input.fromValue(
      ...
      lastAutoAdjustTime: pulumi.Input.fromValue(
