...
class BudgetFilterExpressionAndAndDimensions {
  ...
  /// Creates a new [BudgetFilterExpressionAndAndDimensions].
  ...
  const BudgetFilterExpressionAndAndDimensions({
    required this.key,
    this.matchOptions,
  ...
  factory BudgetFilterExpressionAndAndDimensions.fromMap(Map<String, dynamic> map) {
