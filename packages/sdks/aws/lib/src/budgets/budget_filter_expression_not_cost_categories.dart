...
class BudgetFilterExpressionNotCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionNotCostCategories].
  ...
  const BudgetFilterExpressionNotCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionNotCostCategories.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionNotCostCategories(
