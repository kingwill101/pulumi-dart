...
class GetBudgetNotification {
  ...
  factory GetBudgetNotification.fromMap(Map<String, dynamic> map) {
    return GetBudgetNotification(
      ...
      subscriberEmailAddresses: ((map['subscriberEmailAddresses'] as List).cast<String>()).input(),
      subscriberSnsTopicArns: ((map['subscriberSnsTopicArns'] as List).cast<String>()).input(),
