...
class BudgetFilterExpressionOrOrTags {
  ...
  /// Creates a new [BudgetFilterExpressionOrOrTags].
  ...
  BudgetFilterExpressionOrOrTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionOrOrTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionOrOrTags(
      key: (() {
