...
class BudgetFilterExpressionOrCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionOrCostCategories].
  ...
  const BudgetFilterExpressionOrCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionOrCostCategories.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionOrCostCategories(
