...
class BudgetFilterExpressionNotOrTags {
  ...
  /// Creates a new [BudgetFilterExpressionNotOrTags].
  ...
  BudgetFilterExpressionNotOrTags({this.key, this.matchOptions, this.values});
  ...
  factory BudgetFilterExpressionNotOrTags.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionNotOrTags(
      key: (() {
