...
class BudgetFilterExpressionDimensions {
  ...
  /// Creates a new [BudgetFilterExpressionDimensions].
  ...
  const BudgetFilterExpressionDimensions({
    required this.key,
    this.matchOptions,
  ...
  factory BudgetFilterExpressionDimensions.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionDimensions(
