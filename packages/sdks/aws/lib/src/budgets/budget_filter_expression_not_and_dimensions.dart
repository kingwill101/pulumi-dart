...
class BudgetFilterExpressionNotAndDimensions {
  ...
  const BudgetFilterExpressionNotAndDimensions({
    required this.key,
    this.matchOptions,
  ...
  factory BudgetFilterExpressionNotAndDimensions.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionNotAndDimensions(
