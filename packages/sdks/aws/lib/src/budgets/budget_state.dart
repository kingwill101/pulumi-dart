...
class BudgetState {
  ...
  BudgetState({
    ...
    pulumi.Output<BudgetAutoAdjustData>? autoAdjustData,
    pulumi.Output<String>? billingViewArn,
    pulumi.Output<String>? budgetType,
    pulumi.Output<List<BudgetCostFilter>>? costFilters,
    pulumi.Output<BudgetCostTypes>? costTypes,
    pulumi.Output<BudgetFilterExpression>? filterExpression,
    pulumi.Output<String>? limitAmount,
    pulumi.Output<String>? limitUnit,
    pulumi.Output<String>? name,
    pulumi.Output<String>? namePrefix,
    pulumi.Output<List<BudgetNotification>>? notifications,
    pulumi.Output<List<BudgetPlannedLimit>>? plannedLimits,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<Map<String, String>>? tagsAll,
    pulumi.Output<String>? timePeriodEnd,
    pulumi.Output<String>? timePeriodStart,
    pulumi.Output<String>? timeUnit,
  }) :
      accountId = pulumi.Input.asOptionalInput<String>(accountId),
      arn = pulumi.Input.asOptionalInput<String>(arn),
      autoAdjustData = pulumi.Input.asOptionalInput<BudgetAutoAdjustData>(autoAdjustData),
      billingViewArn = pulumi.Input.asOptionalInput<String>(billingViewArn),
      budgetType = pulumi.Input.asOptionalInput<String>(budgetType),
      costFilters = pulumi.Input.asOptionalInput<List<BudgetCostFilter>>(costFilters),
      costTypes = pulumi.Input.asOptionalInput<BudgetCostTypes>(costTypes),
      filterExpression = pulumi.Input.asOptionalInput<BudgetFilterExpression>(filterExpression),
      ...
      notifications = pulumi.Input.asOptionalInput<List<BudgetNotification>>(notifications),
      plannedLimits = pulumi.Input.asOptionalInput<List<BudgetPlannedLimit>>(plannedLimits),
  ...
  factory BudgetState.fromMap(Map<String, dynamic> map) {
    return BudgetState(
      ...
      autoAdjustData: map['autoAdjustData'] == null ? null : pulumi.Output.create<BudgetAutoAdjustData>(BudgetAutoAdjustData.fromMap((map['autoAdjustData'] as Map).cast<String, dynamic>())),
      billingViewArn: map['billingViewArn'] == null ? null : pulumi.Output.create<String>(map['billingViewArn'] as String),
      budgetType: map['budgetType'] == null ? null : pulumi.Output.create<String>(map['budgetType'] as String),
      costFilters: map['costFilters'] == null ? null : pulumi.Output.create<List<BudgetCostFilter>>(pulumi.Input.decodeList<BudgetCostFilter>(map['costFilters'], (value) => BudgetCostFilter.fromMap((value as Map).cast<String, dynamic>()))),
      costTypes: map['costTypes'] == null ? null : pulumi.Output.create<BudgetCostTypes>(BudgetCostTypes.fromMap((map['costTypes'] as Map).cast<String, dynamic>())),
      filterExpression: map['filterExpression'] == null ? null : pulumi.Output.create<BudgetFilterExpression>(BudgetFilterExpression.fromMap((map['filterExpression'] as Map).cast<String, dynamic>())),
      limitAmount: map['limitAmount'] == null ? null : pulumi.Output.create<String>(map['limitAmount'] as String),
      limitUnit: map['limitUnit'] == null ? null : pulumi.Output.create<String>(map['limitUnit'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      namePrefix: map['namePrefix'] == null ? null : pulumi.Output.create<String>(map['namePrefix'] as String),
      notifications: map['notifications'] == null ? null : pulumi.Output.create<List<BudgetNotification>>(pulumi.Input.decodeList<BudgetNotification>(map['notifications'], (value) => BudgetNotification.fromMap((value as Map).cast<String, dynamic>()))),
      plannedLimits: map['plannedLimits'] == null ? null : pulumi.Output.create<List<BudgetPlannedLimit>>(pulumi.Input.decodeList<BudgetPlannedLimit>(map['plannedLimits'], (value) => BudgetPlannedLimit.fromMap((value as Map).cast<String, dynamic>()))),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      tagsAll: map['tagsAll'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tagsAll'] as Map).cast<String, String>()),
      timePeriodEnd: map['timePeriodEnd'] == null ? null : pulumi.Output.create<String>(map['timePeriodEnd'] as String),
      timePeriodStart: map['timePeriodStart'] == null ? null : pulumi.Output.create<String>(map['timePeriodStart'] as String),
