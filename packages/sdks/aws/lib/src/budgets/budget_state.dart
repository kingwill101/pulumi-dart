...
class BudgetState {
  ...
  factory BudgetState.fromMap(Map<String, dynamic> map) {
    return BudgetState(
      ...
      autoAdjustData: map['autoAdjustData'] == null ? null : (BudgetAutoAdjustData.fromMap((map['autoAdjustData'] as Map).cast<String, dynamic>())).input(),
      billingViewArn: map['billingViewArn'] == null ? null : (map['billingViewArn'] as String).input(),
      budgetType: map['budgetType'] == null ? null : (map['budgetType'] as String).input(),
      costFilters: map['costFilters'] == null ? null : (pulumi.Input.decodeList<BudgetCostFilter>(map['costFilters'], (value) => BudgetCostFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      costTypes: map['costTypes'] == null ? null : (BudgetCostTypes.fromMap((map['costTypes'] as Map).cast<String, dynamic>())).input(),
      filterExpression: map['filterExpression'] == null ? null : (BudgetFilterExpression.fromMap((map['filterExpression'] as Map).cast<String, dynamic>())).input(),
      limitAmount: map['limitAmount'] == null ? null : (map['limitAmount'] as String).input(),
      limitUnit: map['limitUnit'] == null ? null : (map['limitUnit'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      namePrefix: map['namePrefix'] == null ? null : (map['namePrefix'] as String).input(),
      notifications: map['notifications'] == null ? null : (pulumi.Input.decodeList<BudgetNotification>(map['notifications'], (value) => BudgetNotification.fromMap((value as Map).cast<String, dynamic>()))).input(),
      plannedLimits: map['plannedLimits'] == null ? null : (pulumi.Input.decodeList<BudgetPlannedLimit>(map['plannedLimits'], (value) => BudgetPlannedLimit.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      timePeriodEnd: map['timePeriodEnd'] == null ? null : (map['timePeriodEnd'] as String).input(),
      timePeriodStart: map['timePeriodStart'] == null ? null : (map['timePeriodStart'] as String).input(),
