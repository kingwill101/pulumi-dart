...
class BudgetFilterExpressionNotOrCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionNotOrCostCategories].
  ...
  const BudgetFilterExpressionNotOrCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionNotOrCostCategories.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionNotOrCostCategories(
