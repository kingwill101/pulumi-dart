...
class BudgetFilterExpressionAndAndCostCategories {
  ...
  /// Creates a new [BudgetFilterExpressionAndAndCostCategories].
  ...
  const BudgetFilterExpressionAndAndCostCategories({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory BudgetFilterExpressionAndAndCostCategories.fromMap(Map<String, dynamic> map) {
