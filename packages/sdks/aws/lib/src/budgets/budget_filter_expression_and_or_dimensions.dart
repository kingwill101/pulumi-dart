...
class BudgetFilterExpressionAndOrDimensions {
  ...
  /// Creates a new [BudgetFilterExpressionAndOrDimensions].
  ...
  const BudgetFilterExpressionAndOrDimensions({
    required this.key,
    this.matchOptions,
  ...
  factory BudgetFilterExpressionAndOrDimensions.fromMap(Map<String, dynamic> map) {
    return BudgetFilterExpressionAndOrDimensions(
