...
class Smsvoicev2PoolTimeouts {
  ...
  /// Creates a new [Smsvoicev2PoolTimeouts].
  ...
  factory Smsvoicev2PoolTimeouts.fromMap(Map<String, dynamic> map) {
    return Smsvoicev2PoolTimeouts(
