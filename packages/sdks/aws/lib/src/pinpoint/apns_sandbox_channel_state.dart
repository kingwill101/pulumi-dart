...
class ApnsSandboxChannelState {
  ...
  /// Creates a new [ApnsSandboxChannelState].
  ...
  factory ApnsSandboxChannelState.fromMap(Map<String, dynamic> map) {
    return ApnsSandboxChannelState(
