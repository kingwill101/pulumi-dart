    ...
    return <String, dynamic>{
      ...
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<EmailTemplateEmailTemplateHeader>,
  ...
  factory EmailTemplateEmailTemplate.fromMap(Map<String, dynamic> map) {
    return EmailTemplateEmailTemplate(
      defaultSubstitutions: (() {
        final guardedValue = map['defaultSubstitutions'];
      ...
      htmlPart: (() {
        final guardedValue = map['htmlPart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      recommenderId: (() {
        final guardedValue = map['recommenderId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subject: (() {
      ...
      textPart: (() {
        final guardedValue = map['textPart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
