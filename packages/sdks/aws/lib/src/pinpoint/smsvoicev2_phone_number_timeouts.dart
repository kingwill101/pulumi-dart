...
class Smsvoicev2PhoneNumberTimeouts {
  ...
  /// Creates a new [Smsvoicev2PhoneNumberTimeouts].
  ...
  Smsvoicev2PhoneNumberTimeouts({this.create, this.delete, this.update});
  ...
  factory Smsvoicev2PhoneNumberTimeouts.fromMap(Map<String, dynamic> map) {
    return Smsvoicev2PhoneNumberTimeouts(
      create: (() {
