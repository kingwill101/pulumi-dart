...
class Smsvoicev2PoolState {
  ...
  /// Creates a new [Smsvoicev2PoolState].
  /// [arn] ARN of the pool.
  ...
  factory Smsvoicev2PoolState.fromMap(Map<String, dynamic> map) {
    return Smsvoicev2PoolState(
      ...
      originationIdentities: (() { final guardedValue = map['originationIdentities']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
