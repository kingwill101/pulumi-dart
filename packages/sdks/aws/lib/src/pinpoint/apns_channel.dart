...
import 'apns_channel_state.dart';
...
/// }
///
/// resource "aws_pinpoint_apnschannel" "apns" {
...
class ApnsChannel extends pulumi.CustomResource {
  ...
  /// Creates a new [ApnsChannel].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApnsChannel]. {@macro pulumi_pinpoint_apns_channel_apns_channel_args_doc}
  ...
  /// Gets an existing [ApnsChannel] resource's state with the given [name] and [id].
  static ApnsChannel get(
    String name,
    pulumi.Input<String> id, {
    ApnsChannelState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ApnsChannel._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ApnsChannel] resource.
  ApnsChannel.reference(String urn)
    : super(
        'aws:pinpoint/apnsChannel:ApnsChannel',
