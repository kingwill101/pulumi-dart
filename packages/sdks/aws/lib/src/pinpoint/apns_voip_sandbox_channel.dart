...
import 'apns_voip_sandbox_channel_args.dart';
import 'apns_voip_sandbox_channel_state.dart';
...
/// }
///
/// resource "aws_pinpoint_apnsvoipsandboxchannel" "apns_voip_sandbox" {
...
class ApnsVoipSandboxChannel extends pulumi.CustomResource {
  ...
  /// Creates a new [ApnsVoipSandboxChannel].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApnsVoipSandboxChannel]. {@macro pulumi_pinpoint_apns_voip_sandbox_channel_apns_voip_sandbox_channel_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ApnsVoipSandboxChannel(
    String name, {
    ApnsVoipSandboxChannelArgs? args,
  ...
  /// Gets an existing [ApnsVoipSandboxChannel] resource's state with the given [name] and [id].
  static ApnsVoipSandboxChannel get(
    String name,
    pulumi.Input<String> id, {
    ApnsVoipSandboxChannelState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ApnsVoipSandboxChannel._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ApnsVoipSandboxChannel] resource.
  ApnsVoipSandboxChannel.reference(String urn)
    : super(
        'aws:pinpoint/apnsVoipSandboxChannel:ApnsVoipSandboxChannel',
