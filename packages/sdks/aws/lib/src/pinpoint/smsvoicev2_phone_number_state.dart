...
class Smsvoicev2PhoneNumberState {
  ...
  factory Smsvoicev2PhoneNumberState.fromMap(Map<String, dynamic> map) {
    return Smsvoicev2PhoneNumberState(
      ...
      isoCountryCode: map['isoCountryCode'] == null ? null : (map['isoCountryCode'] as String).input(),
      messageType: map['messageType'] == null ? null : (map['messageType'] as String).input(),
      monthlyLeasingPrice: map['monthlyLeasingPrice'] == null ? null : (map['monthlyLeasingPrice'] as String).input(),
      numberCapabilities: map['numberCapabilities'] == null ? null : ((map['numberCapabilities'] as List).cast<String>()).input(),
      numberType: map['numberType'] == null ? null : (map['numberType'] as String).input(),
