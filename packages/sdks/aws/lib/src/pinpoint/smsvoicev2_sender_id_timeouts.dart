...
class Smsvoicev2SenderIdTimeouts {
  ...
  /// Creates a new [Smsvoicev2SenderIdTimeouts].
  ...
  const Smsvoicev2SenderIdTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory Smsvoicev2SenderIdTimeouts.fromMap(Map<String, dynamic> map) {
    return Smsvoicev2SenderIdTimeouts(
