...
class GetResourcesResourceTagMappingList {
  ...
  factory GetResourcesResourceTagMappingList.fromMap(Map<String, dynamic> map) {
    return GetResourcesResourceTagMappingList(
      complianceDetails: pulumi.Input.fromValue(pulumi.Input.decodeList<GetResourcesResourceTagMappingListComplianceDetail>(map['complianceDetails']!, (value) => GetResourcesResourceTagMappingListComplianceDetail.fromMap((value as Map).cast<String, dynamic>()))),
