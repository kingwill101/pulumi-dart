...
class GetResourcesResourceTagMappingList {
  ...
  final pulumi.Input<List<GetResourcesResourceTagMappingListComplianceDetail>>
  complianceDetails;
    ...
    return <String, dynamic>{
      'complianceDetails':
          pulumi.Input.mapInputValue<
            List<GetResourcesResourceTagMappingListComplianceDetail>,
  ...
  factory GetResourcesResourceTagMappingList.fromMap(Map<String, dynamic> map) {
    return GetResourcesResourceTagMappingList(
      complianceDetails: pulumi.Input.fromValue(
