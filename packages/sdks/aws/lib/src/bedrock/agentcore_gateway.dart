...
class AgentcoreGateway extends pulumi.CustomResource {
  ...
  AgentcoreGateway(
    ...
    this.authorizerConfiguration = registerOutput<AgentcoreGatewayAuthorizerConfiguration?>('authorizerConfiguration');
    ...
    this.interceptorConfigurations = registerOutput<List<AgentcoreGatewayInterceptorConfiguration>?>('interceptorConfigurations');
    this.kmsKeyArn = registerOutput<String?>('kmsKeyArn');
    this.name = registerOutput<String>('name');
    this.protocolConfiguration = registerOutput<AgentcoreGatewayProtocolConfiguration?>('protocolConfiguration');
    ...
    this.workloadIdentityDetails = registerOutput<List<AgentcoreGatewayWorkloadIdentityDetail>>('workloadIdentityDetails');
  }
