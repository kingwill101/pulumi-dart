...
class AgentcoreMemoryStrategy extends pulumi.CustomResource {
  ...
  AgentcoreMemoryStrategy(
    ...
    this.configuration = registerOutput<AgentcoreMemoryStrategyConfiguration?>('configuration');
    this.description = registerOutput<String?>('description');
    this.memoryExecutionRoleArn = registerOutput<String?>('memoryExecutionRoleArn');
    ...
    this.timeouts = registerOutput<AgentcoreMemoryStrategyTimeouts?>('timeouts');
