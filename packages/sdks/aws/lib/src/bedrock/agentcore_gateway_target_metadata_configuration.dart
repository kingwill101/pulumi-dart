...
class AgentcoreGatewayTargetMetadataConfiguration {
  ...
  /// [allowedQueryParameters] Set of URL query parameters that are allowed to be propagated from incoming gateway URL to the target. Maximum of 10 parameters.
  /// [allowedRequestHeaders] Set of HTTP headers that are allowed to be propagated from incoming client requests to the target. Maximum of 10 headers.
  /// [allowedResponseHeaders] Set of HTTP headers that are allowed to be propagated from the target response back to the client. Maximum of 10 headers.
