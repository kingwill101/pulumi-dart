...
class GuardrailState {
  ...
  GuardrailState({
    pulumi.Output<String>? blockedInputMessaging,
    pulumi.Output<String>? blockedOutputsMessaging,
    ...
    pulumi.Output<GuardrailWordPolicyConfig>? wordPolicyConfig,
      ...
      blockedInputMessaging = pulumi.Input.asOptionalInput<String>(blockedInputMessaging),
      blockedOutputsMessaging = pulumi.Input.asOptionalInput<String>(blockedOutputsMessaging),
  ...
  factory GuardrailState.fromMap(Map<String, dynamic> map) {
    return GuardrailState(
      blockedInputMessaging: map['blockedInputMessaging'] == null ? null : pulumi.Output.create<String>(map['blockedInputMessaging'] as String),
      blockedOutputsMessaging: map['blockedOutputsMessaging'] == null ? null : pulumi.Output.create<String>(map['blockedOutputsMessaging'] as String),
