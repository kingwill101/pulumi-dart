...
class GuardrailState {
  ...
  factory GuardrailState.fromMap(Map<String, dynamic> map) {
    return GuardrailState(
      blockedInputMessaging: map['blockedInputMessaging'] == null ? null : (map['blockedInputMessaging'] as String).input(),
      blockedOutputsMessaging: map['blockedOutputsMessaging'] == null ? null : (map['blockedOutputsMessaging'] as String).input(),
