...
class AgentcoreCodeInterpreterArgs {
  ...
  /// [timeouts] Optional.
  const AgentcoreCodeInterpreterArgs({
    this.certificates,
    this.description,
  ...
  factory AgentcoreCodeInterpreterArgs.fromMap(Map<String, dynamic> map) {
    return AgentcoreCodeInterpreterArgs(
      ...
      networkConfiguration: pulumi.Input.fromValue(AgentcoreCodeInterpreterNetworkConfiguration.fromMap((map['networkConfiguration']! as Map).cast<String, dynamic>())),
