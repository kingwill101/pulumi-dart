...
class AgentFlowDefinition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connections': ?connections == null ? null : pulumi.Input.encodeList<AgentFlowDefinitionConnection, Map<String, dynamic>>(connections!, (value) => value.toMap()),
      'nodes': ?nodes == null ? null : pulumi.Input.encodeList<AgentFlowDefinitionNode, Map<String, dynamic>>(nodes!, (value) => value.toMap()),
    };
  }

  factory AgentFlowDefinition.fromMap(Map<String, dynamic> map) {
    return AgentFlowDefinition(
      connections: map['connections'] == null ? null : pulumi.Input.decodeList<AgentFlowDefinitionConnection>(map['connections'], (value) => AgentFlowDefinitionConnection.fromMap((value as Map).cast<String, dynamic>())),
      nodes: map['nodes'] == null ? null : pulumi.Input.decodeList<AgentFlowDefinitionNode>(map['nodes'], (value) => AgentFlowDefinitionNode.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
