...
class GuardrailWordPolicyConfig {
  ...
  final pulumi.Input<List<GuardrailWordPolicyConfigManagedWordListsConfig>>?
    ...
    return <String, dynamic>{
      'managedWordListsConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GuardrailWordPolicyConfigManagedWordListsConfig>,
      ...
      'wordsConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GuardrailWordPolicyConfigWordsConfig>,
            List<Map<String, dynamic>>
          >(
            wordsConfigs,
            (value) =>
  ...
  factory GuardrailWordPolicyConfig.fromMap(Map<String, dynamic> map) {
    return GuardrailWordPolicyConfig(
      managedWordListsConfigs: (() {
        final guardedValue = map['managedWordListsConfigs'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GuardrailWordPolicyConfigManagedWordListsConfig.fromMap(
      ...
      wordsConfigs: (() {
        final guardedValue = map['wordsConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
