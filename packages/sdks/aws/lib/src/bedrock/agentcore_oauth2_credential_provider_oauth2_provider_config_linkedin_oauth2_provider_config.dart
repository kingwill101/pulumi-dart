...
import 'agentcore_oauth2_credential_provider_oauth2_provider_config_linkedin_oauth2_provider_config_client_secret_config.dart';
import 'agentcore_oauth2_credential_provider_oauth2_provider_config_linkedin_oauth2_provider_config_oauth_discovery.dart';

class AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfig {
  ...
  final pulumi.Input<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfig?>? clientSecretConfig;
  ...
  final pulumi.Input<List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscovery>?>? oauthDiscoveries;

  /// Creates a new [AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfig].
  ...
  const AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientSecretConfig': ?pulumi.Input.mapOptionalInputValue<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfig, Map<String, dynamic>>(clientSecretConfig, (value) => value.toMap()),
      'clientSecretSource': ?clientSecretSource,
      'clientSecretWo': ?clientSecretWo,
      'oauthDiscoveries': ?pulumi.Input.mapOptionalInputValue<List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscovery>, List<Map<String, dynamic>>>(oauthDiscoveries, (value) => pulumi.Input.encodeList<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscovery, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfig.fromMap(Map<String, dynamic> map) {
    return AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfig(
      ...
      clientSecretConfig: (() { final guardedValue = map['clientSecretConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      oauthDiscoveries: (() { final guardedValue = map['oauthDiscoveries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscovery>(guardedValue, (value) => AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscovery.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
