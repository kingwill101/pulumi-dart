...
class AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayload {
  ...
  /// [inputSchema] Schema for the tool's input. See `schemaDefinition` Block below.
  /// [name] Name of the tool.
  /// [outputSchema] Schema for the tool's output. See `schemaDefinition` Block below.
  ...
  factory AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayload.fromMap(Map<String, dynamic> map) {
    return AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayload(
      ...
      inputSchema: pulumi.Input.fromValue(AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadInputSchema.fromMap((map['inputSchema']! as Map).cast<String, dynamic>())),
      name: pulumi.Input.fromValue(map['name'] as String),
      outputSchema: (() { final guardedValue = map['outputSchema']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentcoreGatewayTargetTargetConfigurationMcpLambdaToolSchemaInlinePayloadOutputSchema.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
