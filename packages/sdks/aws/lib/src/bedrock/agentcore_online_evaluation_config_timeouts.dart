...
class AgentcoreOnlineEvaluationConfigTimeouts {
  ...
  /// Creates a new [AgentcoreOnlineEvaluationConfigTimeouts].
  ...
  const AgentcoreOnlineEvaluationConfigTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory AgentcoreOnlineEvaluationConfigTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreOnlineEvaluationConfigTimeouts(
