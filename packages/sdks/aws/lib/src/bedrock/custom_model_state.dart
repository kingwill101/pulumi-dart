...
class CustomModelState {
  ...
  factory CustomModelState.fromMap(Map<String, dynamic> map) {
    return CustomModelState(
      baseModelIdentifier: map['baseModelIdentifier'] == null ? null : ((map['baseModelIdentifier'] as String).input()).input(),
      customModelArn: map['customModelArn'] == null ? null : ((map['customModelArn'] as String).input()).input(),
      customModelKmsKeyId: map['customModelKmsKeyId'] == null ? null : ((map['customModelKmsKeyId'] as String).input()).input(),
      customModelName: map['customModelName'] == null ? null : ((map['customModelName'] as String).input()).input(),
      customizationType: map['customizationType'] == null ? null : ((map['customizationType'] as String).input()).input(),
      hyperparameters: map['hyperparameters'] == null ? null : (((map['hyperparameters'] as Map).cast<String, String>()).input()).input(),
      jobArn: map['jobArn'] == null ? null : ((map['jobArn'] as String).input()).input(),
      ...
      outputDataConfig: map['outputDataConfig'] == null ? null : ((CustomModelOutputDataConfig.fromMap((map['outputDataConfig']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      trainingDataConfig: map['trainingDataConfig'] == null ? null : ((CustomModelTrainingDataConfig.fromMap((map['trainingDataConfig']! as Map).cast<String, dynamic>())).input()).input(),
      trainingMetrics: map['trainingMetrics'] == null ? null : ((pulumi.Input.decodeList<CustomModelTrainingMetric>(map['trainingMetrics']!, (value) => CustomModelTrainingMetric.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      validationMetrics: map['validationMetrics'] == null ? null : ((pulumi.Input.decodeList<CustomModelValidationMetric>(map['validationMetrics']!, (value) => CustomModelValidationMetric.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
