...
class CustomModelState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'trainingMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomModelTrainingMetric>,
      ...
      'validationMetrics':
          ?pulumi.Input.mapOptionalInputValue<
            List<CustomModelValidationMetric>,
            List<Map<String, dynamic>>
          >(
            validationMetrics,
            (value) =>
  ...
  factory CustomModelState.fromMap(Map<String, dynamic> map) {
    return CustomModelState(
      baseModelIdentifier: (() {
        final guardedValue = map['baseModelIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customModelArn: (() {
        final guardedValue = map['customModelArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customModelKmsKeyId: (() {
      ...
      customModelName: (() {
        final guardedValue = map['customModelName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customizationType: (() {
      ...
      trainingDataConfig: (() {
        final guardedValue = map['trainingDataConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      trainingMetrics: (() {
        final guardedValue = map['trainingMetrics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomModelTrainingMetric>(
            guardedValue,
            (value) => CustomModelTrainingMetric.fromMap(
      ...
      validationMetrics: (() {
        final guardedValue = map['validationMetrics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CustomModelValidationMetric>(
            guardedValue,
            (value) => CustomModelValidationMetric.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
