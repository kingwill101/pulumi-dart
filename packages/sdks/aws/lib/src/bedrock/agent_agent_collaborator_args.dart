...
class AgentAgentCollaboratorArgs {
    ...
    return <String, dynamic>{
      'agentDescriptor':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(agentDescriptor, (value) => value.toMap()),
      'agentId': agentId,
  ...
  factory AgentAgentCollaboratorArgs.fromMap(Map<String, dynamic> map) {
    return AgentAgentCollaboratorArgs(
      agentDescriptor: pulumi.Input.fromValue(
        AgentAgentCollaboratorAgentDescriptor.fromMap(
      ...
      collaborationInstruction: pulumi.Input.fromValue(
        map['collaborationInstruction'] as String,
      ),
      collaboratorName: pulumi.Input.fromValue(
        map['collaboratorName'] as String,
      ),
      prepareAgent: (() {
      ...
      relayConversationHistory: (() {
        final guardedValue = map['relayConversationHistory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      timeouts: (() {
