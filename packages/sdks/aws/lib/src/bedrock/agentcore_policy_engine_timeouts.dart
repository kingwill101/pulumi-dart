...
class AgentcorePolicyEngineTimeouts {
  ...
  /// Creates a new [AgentcorePolicyEngineTimeouts].
  ...
  const AgentcorePolicyEngineTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory AgentcorePolicyEngineTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcorePolicyEngineTimeouts(
