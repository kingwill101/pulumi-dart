...
class AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfiguration {
    ...
    return <String, dynamic>{
      ...
      'embeddingModelConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationEmbeddingModelConfiguration,
            Map<String, dynamic>
          >(embeddingModelConfiguration, (value) => value.toMap()),
      'supplementalDataStorageConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfiguration,
            Map<String, dynamic>
          >(supplementalDataStorageConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfiguration.fromMap(
    ...
    return AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfiguration(
      embeddingModelArn: pulumi.Input.fromValue(
        map['embeddingModelArn'] as String,
      ),
      embeddingModelConfiguration: (() {
        final guardedValue = map['embeddingModelConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationEmbeddingModelConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      supplementalDataStorageConfiguration: (() {
        final guardedValue = map['supplementalDataStorageConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseKnowledgeBaseConfigurationVectorKnowledgeBaseConfigurationSupplementalDataStorageConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
