...
class AgentcoreMemoryStrategyConfiguration {
  ...
  final pulumi.Input<AgentcoreMemoryStrategyConfigurationConsolidation>?
  consolidation;
  ...
  final pulumi.Input<AgentcoreMemoryStrategyConfigurationExtraction>?
  extraction;
  ...
  factory AgentcoreMemoryStrategyConfiguration.fromMap(
    ...
    return AgentcoreMemoryStrategyConfiguration(
      ...
      extraction: (() {
        final guardedValue = map['extraction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
