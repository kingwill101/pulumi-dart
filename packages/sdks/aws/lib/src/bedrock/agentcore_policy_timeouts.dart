...
class AgentcorePolicyTimeouts {
  ...
  /// Creates a new [AgentcorePolicyTimeouts].
  ...
  factory AgentcorePolicyTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcorePolicyTimeouts(
