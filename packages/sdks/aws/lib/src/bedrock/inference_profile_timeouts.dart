...
class InferenceProfileTimeouts {
  ...
  /// Creates a new [InferenceProfileTimeouts].
  ...
  InferenceProfileTimeouts({this.create, this.delete, this.update});
  ...
  factory InferenceProfileTimeouts.fromMap(Map<String, dynamic> map) {
    return InferenceProfileTimeouts(
      create: (() {
