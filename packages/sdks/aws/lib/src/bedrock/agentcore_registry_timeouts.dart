...
class AgentcoreRegistryTimeouts {
  ...
  /// Creates a new [AgentcoreRegistryTimeouts].
  ...
  const AgentcoreRegistryTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory AgentcoreRegistryTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreRegistryTimeouts(
