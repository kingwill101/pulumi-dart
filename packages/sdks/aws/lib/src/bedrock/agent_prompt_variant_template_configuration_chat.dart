...
class AgentPromptVariantTemplateConfigurationChat {
  ...
  final pulumi.Input<List<AgentPromptVariantTemplateConfigurationChatMessage>>
  messages;
  ...
  final pulumi.Input<List<AgentPromptVariantTemplateConfigurationChatSystem>>?
  systems;
    ...
    return <String, dynamic>{
      ...
      'messages':
          pulumi.Input.mapInputValue<
            List<AgentPromptVariantTemplateConfigurationChatMessage>,
            List<Map<String, dynamic>>
          >(
            messages,
            (value) =>
      ...
      'systems':
          ?pulumi.Input.mapOptionalInputValue<
            List<AgentPromptVariantTemplateConfigurationChatSystem>,
            List<Map<String, dynamic>>
          >(
            systems,
            (value) =>
