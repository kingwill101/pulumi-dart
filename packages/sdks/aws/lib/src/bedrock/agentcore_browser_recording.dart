...
class AgentcoreBrowserRecording {
  ...
  /// [s3Location] S3 location where browser session recordings are stored. See `s3Location` below.
  ...
  factory AgentcoreBrowserRecording.fromMap(Map<String, dynamic> map) {
    return AgentcoreBrowserRecording(
      ...
      s3Location: (() { final guardedValue = map['s3Location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentcoreBrowserRecordingS3Location.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
