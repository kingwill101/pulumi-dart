...
class AgentKnowledgeBaseTimeouts {
  ...
  /// Creates a new [AgentKnowledgeBaseTimeouts].
  ...
  AgentKnowledgeBaseTimeouts({this.create, this.delete, this.update});
  ...
  factory AgentKnowledgeBaseTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentKnowledgeBaseTimeouts(
      create: (() {
