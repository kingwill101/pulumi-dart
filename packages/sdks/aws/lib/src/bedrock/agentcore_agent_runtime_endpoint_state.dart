...
class AgentcoreAgentRuntimeEndpointState {
  ...
  factory AgentcoreAgentRuntimeEndpointState.fromMap(Map<String, dynamic> map) {
    return AgentcoreAgentRuntimeEndpointState(
      agentRuntimeArn: (() {
        final guardedValue = map['agentRuntimeArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      agentRuntimeEndpointArn: (() {
        final guardedValue = map['agentRuntimeEndpointArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      agentRuntimeId: (() {
        final guardedValue = map['agentRuntimeId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      agentRuntimeVersion: (() {
        final guardedValue = map['agentRuntimeVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
