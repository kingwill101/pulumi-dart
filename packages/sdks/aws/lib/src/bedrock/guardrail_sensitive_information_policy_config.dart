...
class GuardrailSensitiveInformationPolicyConfig {
  ...
  final pulumi.Input<
    List<GuardrailSensitiveInformationPolicyConfigPiiEntitiesConfig>
  >?
  piiEntitiesConfigs;

  /// List of regex. See Regexes Config for more information.
  final pulumi.Input<
    List<GuardrailSensitiveInformationPolicyConfigRegexesConfig>
  >?
  regexesConfigs;
  ...
  factory GuardrailSensitiveInformationPolicyConfig.fromMap(
    ...
    return GuardrailSensitiveInformationPolicyConfig(
      piiEntitiesConfigs: (() {
        final guardedValue = map['piiEntitiesConfigs'];
      ...
      regexesConfigs: (() {
        final guardedValue = map['regexesConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            GuardrailSensitiveInformationPolicyConfigRegexesConfig
