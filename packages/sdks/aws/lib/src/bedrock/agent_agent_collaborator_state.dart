...
class AgentAgentCollaboratorState {
  ...
  factory AgentAgentCollaboratorState.fromMap(Map<String, dynamic> map) {
    return AgentAgentCollaboratorState(
      agentDescriptor: (() {
        final guardedValue = map['agentDescriptor'];
      ...
      collaborationInstruction: (() {
        final guardedValue = map['collaborationInstruction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      collaboratorId: (() {
        final guardedValue = map['collaboratorId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      collaboratorName: (() {
        final guardedValue = map['collaboratorName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      prepareAgent: (() {
