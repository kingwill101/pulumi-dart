...
class CustomModelValidationDataConfig {
  ...
  factory CustomModelValidationDataConfig.fromMap(Map<String, dynamic> map) {
    return CustomModelValidationDataConfig(
      validators: pulumi.Input.fromValue(pulumi.Input.decodeList<CustomModelValidationDataConfigValidator>(map['validators']!, (value) => CustomModelValidationDataConfigValidator.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
