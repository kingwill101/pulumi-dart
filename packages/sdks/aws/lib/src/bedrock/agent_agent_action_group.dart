...
import 'agent_agent_action_group_state.dart';
...
class AgentAgentActionGroup extends pulumi.CustomResource {
  ...
  AgentAgentActionGroup(
    ...
    this.actionGroupExecutor = registerOutput<AgentAgentActionGroupActionGroupExecutor?>('actionGroupExecutor');
    ...
    this.apiSchema = registerOutput<AgentAgentActionGroupApiSchema?>('apiSchema');
    this.description = registerOutput<String?>('description');
    this.functionSchema = registerOutput<AgentAgentActionGroupFunctionSchema?>('functionSchema');
    this.parentActionGroupSignature = registerOutput<String?>('parentActionGroupSignature');
    this.prepareAgent = registerOutput<bool>('prepareAgent');
    this.region = registerOutput<String>('region');
    this.skipResourceInUseCheck = registerOutput<bool>('skipResourceInUseCheck');
  ...
  static AgentAgentActionGroup get(
    String name,
