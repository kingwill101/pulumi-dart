...
class CustomModelArgs {
  ...
  factory CustomModelArgs.fromMap(Map<String, dynamic> map) {
    return CustomModelArgs(
      baseModelIdentifier: pulumi.Input.fromValue(map['baseModelIdentifier'] as String),
      ...
      outputDataConfig: pulumi.Input.fromValue(CustomModelOutputDataConfig.fromMap((map['outputDataConfig']! as Map).cast<String, dynamic>())),
      ...
      trainingDataConfig: pulumi.Input.fromValue(CustomModelTrainingDataConfig.fromMap((map['trainingDataConfig']! as Map).cast<String, dynamic>())),
