...
class EvaluationJobTimeouts {
  ...
  /// Creates a new [EvaluationJobTimeouts].
  ...
  factory EvaluationJobTimeouts.fromMap(Map<String, dynamic> map) {
    return EvaluationJobTimeouts(
