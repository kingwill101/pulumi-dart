...
class AgentcoreGatewayTimeouts {
  ...
  /// Creates a new [AgentcoreGatewayTimeouts].
  ...
  AgentcoreGatewayTimeouts({this.create, this.delete, this.update});
  ...
  factory AgentcoreGatewayTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreGatewayTimeouts(
      create: (() {
