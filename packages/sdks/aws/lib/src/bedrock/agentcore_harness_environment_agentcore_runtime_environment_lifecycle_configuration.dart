...
class AgentcoreHarnessEnvironmentAgentcoreRuntimeEnvironmentLifecycleConfiguration {
  ...
  /// Creates a new [AgentcoreHarnessEnvironmentAgentcoreRuntimeEnvironmentLifecycleConfiguration].
  /// [idleRuntimeSessionTimeout] Timeout in seconds for idle sessions.
  /// [maxLifetime] Maximum lifetime of the instance in seconds.
  const AgentcoreHarnessEnvironmentAgentcoreRuntimeEnvironmentLifecycleConfiguration({
  ...
  factory AgentcoreHarnessEnvironmentAgentcoreRuntimeEnvironmentLifecycleConfiguration.fromMap(Map<String, dynamic> map) {
    return AgentcoreHarnessEnvironmentAgentcoreRuntimeEnvironmentLifecycleConfiguration(
