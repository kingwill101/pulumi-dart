...
class AgentcoreBrowserTimeouts {
  ...
  /// Creates a new [AgentcoreBrowserTimeouts].
  ...
  AgentcoreBrowserTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory AgentcoreBrowserTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreBrowserTimeouts(
      create: (() {
