...
class AgentKnowledgeBaseStorageConfiguration {
  ...
  final pulumi.Input<AgentKnowledgeBaseStorageConfigurationRdsConfiguration>?
  rdsConfiguration;
    ...
    return <String, dynamic>{
      'mongoDbAtlasConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationMongoDbAtlasConfiguration,
            Map<String, dynamic>
          >(mongoDbAtlasConfiguration, (value) => value.toMap()),
      'neptuneAnalyticsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationNeptuneAnalyticsConfiguration,
            Map<String, dynamic>
          >(neptuneAnalyticsConfiguration, (value) => value.toMap()),
      'opensearchManagedClusterConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationOpensearchManagedClusterConfiguration,
            Map<String, dynamic>
          >(opensearchManagedClusterConfiguration, (value) => value.toMap()),
      'opensearchServerlessConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationOpensearchServerlessConfiguration,
            Map<String, dynamic>
      ...
      'pineconeConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationPineconeConfiguration,
            Map<String, dynamic>
          >(pineconeConfiguration, (value) => value.toMap()),
      'rdsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationRdsConfiguration,
            Map<String, dynamic>
          >(rdsConfiguration, (value) => value.toMap()),
      'redisEnterpriseCloudConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationRedisEnterpriseCloudConfiguration,
            Map<String, dynamic>
          >(redisEnterpriseCloudConfiguration, (value) => value.toMap()),
      's3VectorsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentKnowledgeBaseStorageConfigurationS3VectorsConfiguration,
            Map<String, dynamic>
          >(s3VectorsConfiguration, (value) => value.toMap()),
      'type': type,
    };
  }
  ...
  factory AgentKnowledgeBaseStorageConfiguration.fromMap(
    ...
    return AgentKnowledgeBaseStorageConfiguration(
      mongoDbAtlasConfiguration: (() {
        final guardedValue = map['mongoDbAtlasConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseStorageConfigurationMongoDbAtlasConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      neptuneAnalyticsConfiguration: (() {
        final guardedValue = map['neptuneAnalyticsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseStorageConfigurationNeptuneAnalyticsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      opensearchManagedClusterConfiguration: (() {
        final guardedValue = map['opensearchManagedClusterConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseStorageConfigurationOpensearchManagedClusterConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      opensearchServerlessConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseStorageConfigurationOpensearchServerlessConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pineconeConfiguration: (() {
        final guardedValue = map['pineconeConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rdsConfiguration: (() {
        final guardedValue = map['rdsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      redisEnterpriseCloudConfiguration: (() {
        final guardedValue = map['redisEnterpriseCloudConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseStorageConfigurationRedisEnterpriseCloudConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      s3VectorsConfiguration: (() {
        final guardedValue = map['s3VectorsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentKnowledgeBaseStorageConfigurationS3VectorsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
