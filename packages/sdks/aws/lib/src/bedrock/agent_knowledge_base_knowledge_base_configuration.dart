...
import 'agent_knowledge_base_knowledge_base_configuration_managed_knowledge_base_configuration.dart';
...
class AgentKnowledgeBaseKnowledgeBaseConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'managedKnowledgeBaseConfiguration': ?pulumi.Input.mapOptionalInputValue<AgentKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfiguration, Map<String, dynamic>>(managedKnowledgeBaseConfiguration, (value) => value.toMap()),
  ...
  factory AgentKnowledgeBaseKnowledgeBaseConfiguration.fromMap(Map<String, dynamic> map) {
    return AgentKnowledgeBaseKnowledgeBaseConfiguration(
      ...
      managedKnowledgeBaseConfiguration: (() { final guardedValue = map['managedKnowledgeBaseConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentKnowledgeBaseKnowledgeBaseConfigurationManagedKnowledgeBaseConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
