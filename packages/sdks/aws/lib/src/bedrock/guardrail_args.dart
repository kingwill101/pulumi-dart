...
class GuardrailArgs {
  ...
  factory GuardrailArgs.fromMap(Map<String, dynamic> map) {
    return GuardrailArgs(
      blockedInputMessaging: pulumi.Input.fromValue(
        map['blockedInputMessaging'] as String,
      ),
      blockedOutputsMessaging: pulumi.Input.fromValue(
        map['blockedOutputsMessaging'] as String,
      ),
      contentPolicyConfig: (() {
