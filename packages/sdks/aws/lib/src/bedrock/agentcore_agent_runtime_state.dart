...
class AgentcoreAgentRuntimeState {
  ...
  final pulumi.Input<List<AgentcoreAgentRuntimeWorkloadIdentityDetail>>?
  ...
  factory AgentcoreAgentRuntimeState.fromMap(Map<String, dynamic> map) {
    return AgentcoreAgentRuntimeState(
      ...
      agentRuntimeArtifact: (() {
        final guardedValue = map['agentRuntimeArtifact'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentcoreAgentRuntimeAgentRuntimeArtifact.fromMap(
      ...
      agentRuntimeName: (() {
        final guardedValue = map['agentRuntimeName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      agentRuntimeVersion: (() {
      ...
      lifecycleConfigurations: (() {
        final guardedValue = map['lifecycleConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AgentcoreAgentRuntimeLifecycleConfiguration>(
            guardedValue,
      ...
      networkConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentcoreAgentRuntimeNetworkConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      requestHeaderConfiguration: (() {
        final guardedValue = map['requestHeaderConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      workloadIdentityDetails: (() {
        final guardedValue = map['workloadIdentityDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AgentcoreAgentRuntimeWorkloadIdentityDetail>(
            guardedValue,
            (value) => AgentcoreAgentRuntimeWorkloadIdentityDetail.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
