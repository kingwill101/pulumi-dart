...
class AgentcoreAgentRuntimeState {
  ...
  factory AgentcoreAgentRuntimeState.fromMap(Map<String, dynamic> map) {
    return AgentcoreAgentRuntimeState(
      ...
      agentRuntimeArtifact: map['agentRuntimeArtifact'] == null ? null : (AgentcoreAgentRuntimeAgentRuntimeArtifact.fromMap((map['agentRuntimeArtifact'] as Map).cast<String, dynamic>())).input(),
      agentRuntimeId: map['agentRuntimeId'] == null ? null : (map['agentRuntimeId'] as String).input(),
      agentRuntimeName: map['agentRuntimeName'] == null ? null : (map['agentRuntimeName'] as String).input(),
      ...
      networkConfiguration: map['networkConfiguration'] == null ? null : (AgentcoreAgentRuntimeNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      workloadIdentityDetails: map['workloadIdentityDetails'] == null ? null : (pulumi.Input.decodeList<AgentcoreAgentRuntimeWorkloadIdentityDetail>(map['workloadIdentityDetails'], (value) => AgentcoreAgentRuntimeWorkloadIdentityDetail.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
