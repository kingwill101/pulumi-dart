...
class AgentcoreAgentRuntimeFilesystemConfigurationS3FilesAccessPoint {
  ...
  /// Creates a new [AgentcoreAgentRuntimeFilesystemConfigurationS3FilesAccessPoint].
  ...
  const AgentcoreAgentRuntimeFilesystemConfigurationS3FilesAccessPoint({
  ...
  factory AgentcoreAgentRuntimeFilesystemConfigurationS3FilesAccessPoint.fromMap(Map<String, dynamic> map) {
    return AgentcoreAgentRuntimeFilesystemConfigurationS3FilesAccessPoint(
