...
class AgentcoreOauth2CredentialProviderState {
  ...
  final pulumi.Input<List<AgentcoreOauth2CredentialProviderClientSecretArn>>?
  clientSecretArns;
  ...
  factory AgentcoreOauth2CredentialProviderState.fromMap(
    Map<String, dynamic> map,
  ) {
    return AgentcoreOauth2CredentialProviderState(
      clientSecretArns: (() {
        final guardedValue = map['clientSecretArns'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => AgentcoreOauth2CredentialProviderClientSecretArn.fromMap(
      ...
      credentialProviderVendor: (() {
        final guardedValue = map['credentialProviderVendor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
