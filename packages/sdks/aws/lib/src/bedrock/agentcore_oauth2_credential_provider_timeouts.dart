...
class AgentcoreOauth2CredentialProviderTimeouts {
  ...
  /// Creates a new [AgentcoreOauth2CredentialProviderTimeouts].
  ...
  const AgentcoreOauth2CredentialProviderTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory AgentcoreOauth2CredentialProviderTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreOauth2CredentialProviderTimeouts(
