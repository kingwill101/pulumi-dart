...
class AgentcoreApiKeyCredentialProviderState {
  ...
  final pulumi.Input<List<AgentcoreApiKeyCredentialProviderApiKeySecretArn>>?
  apiKeySecretArns;
  ...
  factory AgentcoreApiKeyCredentialProviderState.fromMap(
    ...
    return AgentcoreApiKeyCredentialProviderState(
      ...
      apiKeySecretArns: (() {
        final guardedValue = map['apiKeySecretArns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => AgentcoreApiKeyCredentialProviderApiKeySecretArn.fromMap(
      ...
      credentialProviderArn: (() {
        final guardedValue = map['credentialProviderArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
