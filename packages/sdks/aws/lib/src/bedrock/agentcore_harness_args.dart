...
class AgentcoreHarnessArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'systemPrompts': pulumi.Input.mapInputValue<List<AgentcoreHarnessSystemPrompt>, List<Map<String, dynamic>>>(systemPrompts, (value) => pulumi.Input.encodeList<AgentcoreHarnessSystemPrompt, Map<String, dynamic>>(value, (value) => value.toMap())),
      'tags': ?tags,
  ...
  factory AgentcoreHarnessArgs.fromMap(Map<String, dynamic> map) {
    return AgentcoreHarnessArgs(
      ...
      systemPrompts: pulumi.Input.fromValue(pulumi.Input.decodeList<AgentcoreHarnessSystemPrompt>(map['systemPrompts']!, (value) => AgentcoreHarnessSystemPrompt.fromMap((value as Map).cast<String, dynamic>()))),
