...
class GuardrailContentPolicyConfig {
  ...
  final pulumi.Input<List<GuardrailContentPolicyConfigFiltersConfig>>?
  filtersConfigs;
  ...
  GuardrailContentPolicyConfig({this.filtersConfigs, this.tierConfigs});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filtersConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GuardrailContentPolicyConfigFiltersConfig>,
      ...
      'tierConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GuardrailContentPolicyConfigTierConfig>,
            List<Map<String, dynamic>>
          >(
            tierConfigs,
            (value) =>
  ...
  factory GuardrailContentPolicyConfig.fromMap(Map<String, dynamic> map) {
    return GuardrailContentPolicyConfig(
      filtersConfigs: (() {
        final guardedValue = map['filtersConfigs'];
