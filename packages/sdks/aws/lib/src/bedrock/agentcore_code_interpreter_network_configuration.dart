...
class AgentcoreCodeInterpreterNetworkConfiguration {
  ...
  factory AgentcoreCodeInterpreterNetworkConfiguration.fromMap(Map<String, dynamic> map) {
    return AgentcoreCodeInterpreterNetworkConfiguration(
      ...
      vpcConfig: (() { final guardedValue = map['vpcConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentcoreCodeInterpreterNetworkConfigurationVpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
