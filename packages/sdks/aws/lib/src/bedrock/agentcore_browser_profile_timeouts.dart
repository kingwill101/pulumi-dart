...
class AgentcoreBrowserProfileTimeouts {
  ...
  /// Creates a new [AgentcoreBrowserProfileTimeouts].
  ...
  const AgentcoreBrowserProfileTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory AgentcoreBrowserProfileTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreBrowserProfileTimeouts(
