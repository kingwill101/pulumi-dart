...
class AgentAgentState {
  ...
  factory AgentAgentState.fromMap(Map<String, dynamic> map) {
    return AgentAgentState(
      agentArn: map['agentArn'] == null ? null : (map['agentArn'] as String).input(),
      ...
      agentResourceRoleArn: map['agentResourceRoleArn'] == null ? null : (map['agentResourceRoleArn'] as String).input(),
      ...
      foundationModel: map['foundationModel'] == null ? null : (map['foundationModel'] as String).input(),
      ...
      preparedAt: map['preparedAt'] == null ? null : (map['preparedAt'] as String).input(),
