...
class AgentAgentState {
  ...
  factory AgentAgentState.fromMap(Map<String, dynamic> map) {
    return AgentAgentState(
      agentArn: (() { final guardedValue = map['agentArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      agentResourceRoleArn: (() { final guardedValue = map['agentResourceRoleArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      foundationModel: (() { final guardedValue = map['foundationModel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      preparedAt: (() { final guardedValue = map['preparedAt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
