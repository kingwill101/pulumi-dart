...
class AgentcoreEvaluatorTimeouts {
  ...
  /// Creates a new [AgentcoreEvaluatorTimeouts].
  ...
  const AgentcoreEvaluatorTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory AgentcoreEvaluatorTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreEvaluatorTimeouts(
