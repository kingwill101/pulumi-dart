...
class AgentcoreGatewayState {
  ...
  factory AgentcoreGatewayState.fromMap(Map<String, dynamic> map) {
    return AgentcoreGatewayState(
      ...
      gatewayUrl: map['gatewayUrl'] == null ? null : ((map['gatewayUrl'] as String).input()).input(),
      ...
      workloadIdentityDetails: map['workloadIdentityDetails'] == null ? null : ((pulumi.Input.decodeList<AgentcoreGatewayWorkloadIdentityDetail>(map['workloadIdentityDetails']!, (value) => AgentcoreGatewayWorkloadIdentityDetail.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
