...
class AgentFlowTimeouts {
  ...
  /// Creates a new [AgentFlowTimeouts].
  ...
  AgentFlowTimeouts({this.create, this.delete, this.update});
  ...
  factory AgentFlowTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentFlowTimeouts(
      create: (() {
