...
class AgentcoreCodeInterpreterTimeouts {
  ...
  /// Creates a new [AgentcoreCodeInterpreterTimeouts].
  ...
  AgentcoreCodeInterpreterTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory AgentcoreCodeInterpreterTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreCodeInterpreterTimeouts(
      create: (() {
