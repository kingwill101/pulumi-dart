...
import 'agentcore_oauth2_credential_provider_oauth2_provider_config_slack_oauth2_provider_config_client_secret_config.dart';
import 'agentcore_oauth2_credential_provider_oauth2_provider_config_slack_oauth2_provider_config_oauth_discovery.dart';
...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig {
  ...
  final pulumi.Input<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigClientSecretConfig?>? clientSecretConfig;
  ...
  const AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientSecretConfig': ?pulumi.Input.mapOptionalInputValue<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigClientSecretConfig, Map<String, dynamic>>(clientSecretConfig, (value) => value.toMap()),
  ...
  factory AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig.fromMap(Map<String, dynamic> map) {
    return AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig(
      ...
      clientSecretConfig: (() { final guardedValue = map['clientSecretConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigClientSecretConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
