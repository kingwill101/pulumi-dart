...
class AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig {
  ...
  factory AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig.fromMap(Map<String, dynamic> map) {
    return AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfig(
      ...
      oauthDiscoveries: map['oauthDiscoveries'] == null ? null : (pulumi.Input.decodeList<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigOauthDiscovery>(map['oauthDiscoveries'], (value) => AgentcoreOauth2CredentialProviderOauth2ProviderConfigSlackOauth2ProviderConfigOauthDiscovery.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
