...
class AgentcoreHarnessTimeouts {
  ...
  /// Creates a new [AgentcoreHarnessTimeouts].
  ...
  const AgentcoreHarnessTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory AgentcoreHarnessTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreHarnessTimeouts(
