...
class AgentFlowDefinitionNodeConfigurationPrompt {
    ...
    return <String, dynamic>{
      'guardrailConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentFlowDefinitionNodeConfigurationPromptGuardrailConfiguration,
            Map<String, dynamic>
          >(guardrailConfiguration, (value) => value.toMap()),
      'sourceConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            AgentFlowDefinitionNodeConfigurationPromptSourceConfiguration,
            Map<String, dynamic>
  ...
  factory AgentFlowDefinitionNodeConfigurationPrompt.fromMap(
    ...
    return AgentFlowDefinitionNodeConfigurationPrompt(
      guardrailConfiguration: (() {
        final guardedValue = map['guardrailConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentFlowDefinitionNodeConfigurationPromptGuardrailConfiguration.fromMap(
      ...
      sourceConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AgentFlowDefinitionNodeConfigurationPromptSourceConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
