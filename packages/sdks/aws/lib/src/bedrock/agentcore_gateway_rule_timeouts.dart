...
class AgentcoreGatewayRuleTimeouts {
  ...
  /// Creates a new [AgentcoreGatewayRuleTimeouts].
  ...
  const AgentcoreGatewayRuleTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory AgentcoreGatewayRuleTimeouts.fromMap(Map<String, dynamic> map) {
    return AgentcoreGatewayRuleTimeouts(
