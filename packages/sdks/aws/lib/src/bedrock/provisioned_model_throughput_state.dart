...
class ProvisionedModelThroughputState {
  ...
  factory ProvisionedModelThroughputState.fromMap(Map<String, dynamic> map) {
    return ProvisionedModelThroughputState(
      ...
      modelUnits: (() { final guardedValue = map['modelUnits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProvisionedModelThroughputTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
