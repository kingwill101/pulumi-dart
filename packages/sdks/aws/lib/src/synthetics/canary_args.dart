...
class CanaryArgs {
  ...
  CanaryArgs({
    ...
    required pulumi.Output<String> artifactS3Location,
    ...
    required pulumi.Output<CanarySchedule> schedule,
    ...
    pulumi.Output<String>? zipFile,
      ...
      artifactS3Location = pulumi.Input.asInput<String>(artifactS3Location),
      ...
      schedule = pulumi.Input.asInput<CanarySchedule>(schedule),
  ...
  factory CanaryArgs.fromMap(Map<String, dynamic> map) {
    return CanaryArgs(
      ...
      artifactS3Location: pulumi.Output.create<String>(map['artifactS3Location'] as String),
      ...
      schedule: pulumi.Output.create<CanarySchedule>(CanarySchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>())),
