...
class CanaryArgs {
  ...
  factory CanaryArgs.fromMap(Map<String, dynamic> map) {
    return CanaryArgs(
      artifactConfig: map['artifactConfig'] == null ? null : ((CanaryArtifactConfig.fromMap((map['artifactConfig']! as Map).cast<String, dynamic>())).input()).input(),
      artifactS3Location: (map['artifactS3Location'] as String).input(),
      deleteLambda: map['deleteLambda'] == null ? null : ((map['deleteLambda'] as bool).input()).input(),
      executionRoleArn: (map['executionRoleArn'] as String).input(),
      failureRetentionPeriod: map['failureRetentionPeriod'] == null ? null : ((map['failureRetentionPeriod'] as int).input()).input(),
      handler: (map['handler'] as String).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      runConfig: map['runConfig'] == null ? null : ((CanaryRunConfig.fromMap((map['runConfig']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      s3Version: map['s3Version'] == null ? null : ((map['s3Version'] as String).input()).input(),
      schedule: (CanarySchedule.fromMap((map['schedule']! as Map).cast<String, dynamic>())).input(),
      startCanary: map['startCanary'] == null ? null : ((map['startCanary'] as bool).input()).input(),
      successRetentionPeriod: map['successRetentionPeriod'] == null ? null : ((map['successRetentionPeriod'] as int).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      vpcConfig: map['vpcConfig'] == null ? null : ((CanaryVpcConfig.fromMap((map['vpcConfig']! as Map).cast<String, dynamic>())).input()).input(),
