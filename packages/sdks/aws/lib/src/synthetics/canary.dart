...
class Canary extends pulumi.CustomResource {
  ...
  Canary(
    ...
    this.artifactConfig = registerOutput<CanaryArtifactConfig?>('artifactConfig');
    ...
    this.failureRetentionPeriod = registerOutput<int?>('failureRetentionPeriod');
    ...
    this.successRetentionPeriod = registerOutput<int?>('successRetentionPeriod');
