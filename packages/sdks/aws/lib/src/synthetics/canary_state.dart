...
class CanaryState {
    ...
    return <String, dynamic>{
      ...
      'timelines':
          ...
          >(
            timelines,
            (value) =>
                pulumi.Input.encodeList<CanaryTimeline, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory CanaryState.fromMap(Map<String, dynamic> map) {
    return CanaryState(
      ...
      artifactS3Location: (() {
        final guardedValue = map['artifactS3Location'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deleteLambda: (() {
      ...
      engineArn: (() {
        final guardedValue = map['engineArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      executionRoleArn: (() {
      ...
      schedule: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CanarySchedule.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      sourceLocationArn: (() {
        final guardedValue = map['sourceLocationArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      startCanary: (() {
      ...
      timelines: (() {
        final guardedValue = map['timelines'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CanaryTimeline>(
            guardedValue,
            (value) =>
                CanaryTimeline.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      vpcConfig: (() {
