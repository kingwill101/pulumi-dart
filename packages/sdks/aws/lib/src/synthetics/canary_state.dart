...
class CanaryState {
  ...
  factory CanaryState.fromMap(Map<String, dynamic> map) {
    return CanaryState(
      ...
      artifactS3Location: map['artifactS3Location'] == null ? null : ((map['artifactS3Location'] as String).input()).input(),
      deleteLambda: map['deleteLambda'] == null ? null : ((map['deleteLambda'] as bool).input()).input(),
      engineArn: map['engineArn'] == null ? null : ((map['engineArn'] as String).input()).input(),
      ...
      runtimeVersion: map['runtimeVersion'] == null ? null : ((map['runtimeVersion'] as String).input()).input(),
      ...
      schedule: map['schedule'] == null ? null : ((CanarySchedule.fromMap((map['schedule']! as Map).cast<String, dynamic>())).input()).input(),
      sourceLocationArn: map['sourceLocationArn'] == null ? null : ((map['sourceLocationArn'] as String).input()).input(),
      ...
      timelines: map['timelines'] == null ? null : ((pulumi.Input.decodeList<CanaryTimeline>(map['timelines']!, (value) => CanaryTimeline.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
