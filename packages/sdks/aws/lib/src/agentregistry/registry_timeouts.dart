...
class RegistryTimeouts {
  ...
  /// Creates a new [RegistryTimeouts].
  ...
  factory RegistryTimeouts.fromMap(Map<String, dynamic> map) {
    return RegistryTimeouts(
