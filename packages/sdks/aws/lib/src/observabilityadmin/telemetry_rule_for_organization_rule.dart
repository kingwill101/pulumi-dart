...
import 'telemetry_rule_for_organization_rule_destination_configuration.dart';
...
class TelemetryRuleForOrganizationRule {
  ...
  factory TelemetryRuleForOrganizationRule.fromMap(Map<String, dynamic> map) {
    return TelemetryRuleForOrganizationRule(
      ...
      destinationConfiguration: (() { final guardedValue = map['destinationConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TelemetryRuleForOrganizationRuleDestinationConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
