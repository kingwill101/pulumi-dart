...
class S3TableIntegrationTimeouts {
  ...
  /// Creates a new [S3TableIntegrationTimeouts].
  ...
  const S3TableIntegrationTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory S3TableIntegrationTimeouts.fromMap(Map<String, dynamic> map) {
    return S3TableIntegrationTimeouts(
