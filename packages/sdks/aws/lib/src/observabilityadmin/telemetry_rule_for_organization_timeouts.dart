...
class TelemetryRuleForOrganizationTimeouts {
  ...
  /// Creates a new [TelemetryRuleForOrganizationTimeouts].
  ...
  const TelemetryRuleForOrganizationTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory TelemetryRuleForOrganizationTimeouts.fromMap(Map<String, dynamic> map) {
    return TelemetryRuleForOrganizationTimeouts(
