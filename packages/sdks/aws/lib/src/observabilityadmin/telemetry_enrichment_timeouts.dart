...
class TelemetryEnrichmentTimeouts {
  ...
  /// Creates a new [TelemetryEnrichmentTimeouts].
  ...
  const TelemetryEnrichmentTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory TelemetryEnrichmentTimeouts.fromMap(Map<String, dynamic> map) {
    return TelemetryEnrichmentTimeouts(
