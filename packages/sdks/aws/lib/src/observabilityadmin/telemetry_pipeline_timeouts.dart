...
class TelemetryPipelineTimeouts {
  ...
  /// Creates a new [TelemetryPipelineTimeouts].
  ...
  const TelemetryPipelineTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory TelemetryPipelineTimeouts.fromMap(Map<String, dynamic> map) {
    return TelemetryPipelineTimeouts(
