...
class TelemetryEvaluationForOrganizationTimeouts {
  ...
  /// Creates a new [TelemetryEvaluationForOrganizationTimeouts].
  ...
  const TelemetryEvaluationForOrganizationTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory TelemetryEvaluationForOrganizationTimeouts.fromMap(Map<String, dynamic> map) {
    return TelemetryEvaluationForOrganizationTimeouts(
