...
class TelemetryEvaluationTimeouts {
  ...
  /// Creates a new [TelemetryEvaluationTimeouts].
  ...
  const TelemetryEvaluationTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory TelemetryEvaluationTimeouts.fromMap(Map<String, dynamic> map) {
    return TelemetryEvaluationTimeouts(
