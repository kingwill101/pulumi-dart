...
class TelemetryRuleTimeouts {
  ...
  /// Creates a new [TelemetryRuleTimeouts].
  ...
  factory TelemetryRuleTimeouts.fromMap(Map<String, dynamic> map) {
    return TelemetryRuleTimeouts(
