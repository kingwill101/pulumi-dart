...
class StateMachineEncryptionConfiguration {
  ...
  factory StateMachineEncryptionConfiguration.fromMap(Map<String, dynamic> map) {
    return StateMachineEncryptionConfiguration(
      kmsDataKeyReusePeriodSeconds: (() { final guardedValue = map['kmsDataKeyReusePeriodSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
