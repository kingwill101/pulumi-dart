...
class StateMachine extends pulumi.CustomResource {
  ...
  StateMachine(
    ...
    this.encryptionConfiguration = registerOutput<StateMachineEncryptionConfiguration>('encryptionConfiguration');
    this.loggingConfiguration = registerOutput<StateMachineLoggingConfiguration>('loggingConfiguration');
    ...
    this.stateMachineVersionArn = registerOutput<String>('stateMachineVersionArn');
    this.status = registerOutput<String>('status');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.tracingConfiguration = registerOutput<StateMachineTracingConfiguration>('tracingConfiguration');
