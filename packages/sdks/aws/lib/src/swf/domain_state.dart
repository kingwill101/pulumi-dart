...
class DomainState {
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      workflowExecutionRetentionPeriodInDays: map['workflowExecutionRetentionPeriodInDays'] == null ? null : ((map['workflowExecutionRetentionPeriodInDays'] as String).input()).input(),
    );
  }
}
