...
class DomainState {
  ...
  DomainState({
    ...
    pulumi.Output<String>? workflowExecutionRetentionPeriodInDays,
  }) :
      ...
      workflowExecutionRetentionPeriodInDays = pulumi.Input.asOptionalInput<String>(workflowExecutionRetentionPeriodInDays);
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      workflowExecutionRetentionPeriodInDays: map['workflowExecutionRetentionPeriodInDays'] == null ? null : pulumi.Output.create<String>(map['workflowExecutionRetentionPeriodInDays'] as String),
    );
  }
}
