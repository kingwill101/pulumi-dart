...
class WorkspaceState {
  ...
  factory WorkspaceState.fromMap(Map<String, dynamic> map) {
    return WorkspaceState(
      accountAccessType: map['accountAccessType'] == null ? null : ((map['accountAccessType'] as String).input()).input(),
      arn: map['arn'] == null ? null : ((map['arn'] as String).input()).input(),
      authenticationProviders: map['authenticationProviders'] == null ? null : (((map['authenticationProviders'] as List).cast<String>()).input()).input(),
      ...
      permissionType: map['permissionType'] == null ? null : ((map['permissionType'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      roleArn: map['roleArn'] == null ? null : ((map['roleArn'] as String).input()).input(),
      samlConfigurationStatus: map['samlConfigurationStatus'] == null ? null : ((map['samlConfigurationStatus'] as String).input()).input(),
