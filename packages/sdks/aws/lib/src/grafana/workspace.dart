...
class Workspace extends pulumi.CustomResource {
  ...
  Workspace(
    ...
    this.authenticationProviders = registerOutput<List<String>>('authenticationProviders');
    ...
    this.networkAccessControl = registerOutput<WorkspaceNetworkAccessControl?>('networkAccessControl');
    this.notificationDestinations = registerOutput<List<String>?>('notificationDestinations');
    this.organizationRoleName = registerOutput<String?>('organizationRoleName');
    this.organizationalUnits = registerOutput<List<String>?>('organizationalUnits');
    this.permissionType = registerOutput<String>('permissionType');
    this.region = registerOutput<String>('region');
    this.roleArn = registerOutput<String?>('roleArn');
    this.samlConfigurationStatus = registerOutput<String>('samlConfigurationStatus');
    this.stackSetName = registerOutput<String?>('stackSetName');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.vpcConfiguration = registerOutput<WorkspaceVpcConfiguration?>('vpcConfiguration');
  }
