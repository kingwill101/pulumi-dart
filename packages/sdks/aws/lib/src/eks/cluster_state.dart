...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      accessConfig: (() { final guardedValue = map['accessConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterAccessConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      certificateAuthority: (() { final guardedValue = map['certificateAuthority']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterCertificateAuthority.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      controlPlaneScalingConfig: (() { final guardedValue = map['controlPlaneScalingConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterControlPlaneScalingConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      createdAt: (() { final guardedValue = map['createdAt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      defaultAddonsToRemoves: (() { final guardedValue = map['defaultAddonsToRemoves']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      remoteNetworkConfig: (() { final guardedValue = map['remoteNetworkConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterRemoteNetworkConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      roleArn: (() { final guardedValue = map['roleArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      status: (() { final guardedValue = map['status']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      storageConfig: (() { final guardedValue = map['storageConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterStorageConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vpcConfig: (() { final guardedValue = map['vpcConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterVpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      zonalShiftConfig: (() { final guardedValue = map['zonalShiftConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterZonalShiftConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
