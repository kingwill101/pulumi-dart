...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      certificateAuthority: map['certificateAuthority'] == null ? null : ((ClusterCertificateAuthority.fromMap((map['certificateAuthority']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      identities: map['identities'] == null ? null : ((pulumi.Input.decodeList<ClusterIdentity>(map['identities']!, (value) => ClusterIdentity.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      vpcConfig: map['vpcConfig'] == null ? null : ((ClusterVpcConfig.fromMap((map['vpcConfig']! as Map).cast<String, dynamic>())).input()).input(),
