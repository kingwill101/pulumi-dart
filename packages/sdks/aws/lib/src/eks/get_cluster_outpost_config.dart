...
class GetClusterOutpostConfig {
  ...
  final pulumi.Input<List<GetClusterOutpostConfigControlPlanePlacement>>
    ...
    return <String, dynamic>{
      ...
      'controlPlanePlacements':
          pulumi.Input.mapInputValue<
            List<GetClusterOutpostConfigControlPlanePlacement>,
  ...
  factory GetClusterOutpostConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterOutpostConfig(
      ...
      controlPlanePlacements: pulumi.Input.fromValue(
