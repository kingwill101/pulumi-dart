...
class NodeGroupState {
  ...
  factory NodeGroupState.fromMap(Map<String, dynamic> map) {
    return NodeGroupState(
      ...
      nodeRoleArn: map['nodeRoleArn'] == null ? null : ((map['nodeRoleArn'] as String).input()).input(),
      ...
      resources: map['resources'] == null ? null : ((pulumi.Input.decodeList<NodeGroupResource>(map['resources']!, (value) => NodeGroupResource.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      scalingConfig: map['scalingConfig'] == null ? null : ((NodeGroupScalingConfig.fromMap((map['scalingConfig']! as Map).cast<String, dynamic>())).input()).input(),
