...
class ClusterKubernetesNetworkConfig {
  ...
  final ClusterKubernetesNetworkConfigElasticLoadBalancing? elasticLoadBalancing;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'elasticLoadBalancing': ?elasticLoadBalancing == null ? null : elasticLoadBalancing!.toMap(),
      'ipFamily': ?ipFamily,
  ...
  factory ClusterKubernetesNetworkConfig.fromMap(Map<String, dynamic> map) {
    return ClusterKubernetesNetworkConfig(
      elasticLoadBalancing: map['elasticLoadBalancing'] == null ? null : ClusterKubernetesNetworkConfigElasticLoadBalancing.fromMap((map['elasticLoadBalancing'] as Map).cast<String, dynamic>()),
