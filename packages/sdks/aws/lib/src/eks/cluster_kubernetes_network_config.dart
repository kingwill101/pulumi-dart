...
class ClusterKubernetesNetworkConfig {
  ...
  final pulumi.Input<ClusterKubernetesNetworkConfigElasticLoadBalancing>?
    ...
    return <String, dynamic>{
      'elasticLoadBalancing':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(elasticLoadBalancing, (value) => value.toMap()),
      'ipFamily': ?ipFamily,
  ...
  factory ClusterKubernetesNetworkConfig.fromMap(Map<String, dynamic> map) {
    return ClusterKubernetesNetworkConfig(
      elasticLoadBalancing: (() {
        final guardedValue = map['elasticLoadBalancing'];
