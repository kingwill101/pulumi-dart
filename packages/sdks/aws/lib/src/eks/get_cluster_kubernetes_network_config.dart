...
class GetClusterKubernetesNetworkConfig {
  ...
  final List<GetClusterKubernetesNetworkConfigElasticLoadBalancing> elasticLoadBalancings;
  /// `ipv4` or `ipv6`.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'elasticLoadBalancings': pulumi.Input.encodeList<GetClusterKubernetesNetworkConfigElasticLoadBalancing, Map<String, dynamic>>(elasticLoadBalancings, (value) => value.toMap()),
      'ipFamily': ipFamily,
  ...
  factory GetClusterKubernetesNetworkConfig.fromMap(Map<String, dynamic> map) {
    return GetClusterKubernetesNetworkConfig(
      elasticLoadBalancings: pulumi.Input.decodeList<GetClusterKubernetesNetworkConfigElasticLoadBalancing>(map['elasticLoadBalancings'], (value) => GetClusterKubernetesNetworkConfigElasticLoadBalancing.fromMap((value as Map).cast<String, dynamic>())),
