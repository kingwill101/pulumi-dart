...
class ClusterRemoteNetworkConfig {
  ...
  final pulumi.Input<ClusterRemoteNetworkConfigRemoteNodeNetworks>
  remoteNodeNetworks;

  /// Configuration block with remote pod network configuration for EKS Hybrid Nodes. Detailed below.
  final pulumi.Input<ClusterRemoteNetworkConfigRemotePodNetworks>?
  remotePodNetworks;
  ...
  factory ClusterRemoteNetworkConfig.fromMap(Map<String, dynamic> map) {
    return ClusterRemoteNetworkConfig(
      remoteNodeNetworks: pulumi.Input.fromValue(
        ClusterRemoteNetworkConfigRemoteNodeNetworks.fromMap(
          (map['remoteNodeNetworks']! as Map).cast<String, dynamic>(),
        ),
      ),
      remotePodNetworks: (() {
        final guardedValue = map['remotePodNetworks'];
