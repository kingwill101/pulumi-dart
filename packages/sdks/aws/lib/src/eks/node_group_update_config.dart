...
class NodeGroupUpdateConfig {
  ...
  factory NodeGroupUpdateConfig.fromMap(Map<String, dynamic> map) {
    return NodeGroupUpdateConfig(
      ...
      maxUnavailablePercentage: (() { final guardedValue = map['maxUnavailablePercentage']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
