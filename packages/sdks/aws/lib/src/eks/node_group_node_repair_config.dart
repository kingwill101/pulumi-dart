...
class NodeGroupNodeRepairConfig {
  ...
  final List<NodeGroupNodeRepairConfigNodeRepairConfigOverride>? nodeRepairConfigOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeRepairConfigOverrides': ?nodeRepairConfigOverrides == null ? null : pulumi.Input.encodeList<NodeGroupNodeRepairConfigNodeRepairConfigOverride, Map<String, dynamic>>(nodeRepairConfigOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory NodeGroupNodeRepairConfig.fromMap(Map<String, dynamic> map) {
    return NodeGroupNodeRepairConfig(
      ...
      maxParallelNodesRepairedCount: map['maxParallelNodesRepairedCount'] == null ? null : map['maxParallelNodesRepairedCount'] as int,
      maxParallelNodesRepairedPercentage: map['maxParallelNodesRepairedPercentage'] == null ? null : map['maxParallelNodesRepairedPercentage'] as int,
      maxUnhealthyNodeThresholdCount: map['maxUnhealthyNodeThresholdCount'] == null ? null : map['maxUnhealthyNodeThresholdCount'] as int,
      maxUnhealthyNodeThresholdPercentage: map['maxUnhealthyNodeThresholdPercentage'] == null ? null : map['maxUnhealthyNodeThresholdPercentage'] as int,
      nodeRepairConfigOverrides: map['nodeRepairConfigOverrides'] == null ? null : pulumi.Input.decodeList<NodeGroupNodeRepairConfigNodeRepairConfigOverride>(map['nodeRepairConfigOverrides'], (value) => NodeGroupNodeRepairConfigNodeRepairConfigOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
