...
class FargateProfileArgs {
  ...
  factory FargateProfileArgs.fromMap(Map<String, dynamic> map) {
    return FargateProfileArgs(
      ...
      fargateProfileName: (() {
        final guardedValue = map['fargateProfileName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      podExecutionRoleArn: pulumi.Input.fromValue(
        map['podExecutionRoleArn'] as String,
      ),
      region: (() {
      ...
      selectors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FargateProfileSelector>(
          map['selectors']!,
          (value) => FargateProfileSelector.fromMap(
