...
class CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements {
  ...
  factory CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements.fromMap(Map<String, dynamic> map) {
    return CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements(
      acceleratorCount: map['acceleratorCount'] == null ? null : ((CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorCount.fromMap((map['acceleratorCount']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      acceleratorTotalMemoryMib: map['acceleratorTotalMemoryMib'] == null ? null : ((CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib.fromMap((map['acceleratorTotalMemoryMib']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      baselineEbsBandwidthMbps: map['baselineEbsBandwidthMbps'] == null ? null : ((CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps.fromMap((map['baselineEbsBandwidthMbps']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      memoryGibPerVcpu: map['memoryGibPerVcpu'] == null ? null : ((CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsMemoryGibPerVcpu.fromMap((map['memoryGibPerVcpu']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      networkBandwidthGbps: map['networkBandwidthGbps'] == null ? null : ((CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkBandwidthGbps.fromMap((map['networkBandwidthGbps']! as Map).cast<String, dynamic>())).input()).input(),
      networkInterfaceCount: map['networkInterfaceCount'] == null ? null : ((CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsNetworkInterfaceCount.fromMap((map['networkInterfaceCount']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      totalLocalStorageGb: map['totalLocalStorageGb'] == null ? null : ((CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirementsTotalLocalStorageGb.fromMap((map['totalLocalStorageGb']! as Map).cast<String, dynamic>())).input()).input(),
