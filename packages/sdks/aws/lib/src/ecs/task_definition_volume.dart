...
class TaskDefinitionVolume {
  ...
  final pulumi.Input<TaskDefinitionVolumeDockerVolumeConfiguration>?
  dockerVolumeConfiguration;

  /// Configuration block for an EFS volume. Detailed below.
  final pulumi.Input<TaskDefinitionVolumeEfsVolumeConfiguration>?
  ...
  factory TaskDefinitionVolume.fromMap(Map<String, dynamic> map) {
    return TaskDefinitionVolume(
      configureAtLaunch: (() {
        final guardedValue = map['configureAtLaunch'];
      ...
      fsxWindowsFileServerVolumeConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
