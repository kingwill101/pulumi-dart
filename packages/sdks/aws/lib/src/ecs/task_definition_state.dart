...
class TaskDefinitionState {
  ...
  factory TaskDefinitionState.fromMap(Map<String, dynamic> map) {
    return TaskDefinitionState(
      ...
      arnWithoutRevision: map['arnWithoutRevision'] == null ? null : (map['arnWithoutRevision'] as String).input(),
      containerDefinitions: map['containerDefinitions'] == null ? null : (map['containerDefinitions'] as String).input(),
      ...
      ephemeralStorage: map['ephemeralStorage'] == null ? null : (TaskDefinitionEphemeralStorage.fromMap((map['ephemeralStorage'] as Map).cast<String, dynamic>())).input(),
      ...
      placementConstraints: map['placementConstraints'] == null ? null : (pulumi.Input.decodeList<TaskDefinitionPlacementConstraint>(map['placementConstraints'], (value) => TaskDefinitionPlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      proxyConfiguration: map['proxyConfiguration'] == null ? null : (TaskDefinitionProxyConfiguration.fromMap((map['proxyConfiguration'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      requiresCompatibilities: map['requiresCompatibilities'] == null ? null : ((map['requiresCompatibilities'] as List).cast<String>()).input(),
      revision: map['revision'] == null ? null : (map['revision'] as int).input(),
      runtimePlatform: map['runtimePlatform'] == null ? null : (TaskDefinitionRuntimePlatform.fromMap((map['runtimePlatform'] as Map).cast<String, dynamic>())).input(),
      ...
      volumes: map['volumes'] == null ? null : (pulumi.Input.decodeList<TaskDefinitionVolume>(map['volumes'], (value) => TaskDefinitionVolume.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
