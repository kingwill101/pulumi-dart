...
class TaskDefinitionState {
  ...
  factory TaskDefinitionState.fromMap(Map<String, dynamic> map) {
    return TaskDefinitionState(
      ...
      arnWithoutRevision: map['arnWithoutRevision'] == null ? null : ((map['arnWithoutRevision'] as String).input()).input(),
      containerDefinitions: map['containerDefinitions'] == null ? null : ((map['containerDefinitions'] as String).input()).input(),
      cpu: map['cpu'] == null ? null : ((map['cpu'] as String).input()).input(),
      enableFaultInjection: map['enableFaultInjection'] == null ? null : ((map['enableFaultInjection'] as bool).input()).input(),
      ephemeralStorage: map['ephemeralStorage'] == null ? null : ((TaskDefinitionEphemeralStorage.fromMap((map['ephemeralStorage']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      ipcMode: map['ipcMode'] == null ? null : ((map['ipcMode'] as String).input()).input(),
      memory: map['memory'] == null ? null : ((map['memory'] as String).input()).input(),
      networkMode: map['networkMode'] == null ? null : ((map['networkMode'] as String).input()).input(),
      pidMode: map['pidMode'] == null ? null : ((map['pidMode'] as String).input()).input(),
      placementConstraints: map['placementConstraints'] == null ? null : ((pulumi.Input.decodeList<TaskDefinitionPlacementConstraint>(map['placementConstraints']!, (value) => TaskDefinitionPlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      proxyConfiguration: map['proxyConfiguration'] == null ? null : ((TaskDefinitionProxyConfiguration.fromMap((map['proxyConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      requiresCompatibilities: map['requiresCompatibilities'] == null ? null : (((map['requiresCompatibilities'] as List).cast<String>()).input()).input(),
      revision: map['revision'] == null ? null : ((map['revision'] as int).input()).input(),
      runtimePlatform: map['runtimePlatform'] == null ? null : ((TaskDefinitionRuntimePlatform.fromMap((map['runtimePlatform']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      trackLatest: map['trackLatest'] == null ? null : ((map['trackLatest'] as bool).input()).input(),
      volumes: map['volumes'] == null ? null : ((pulumi.Input.decodeList<TaskDefinitionVolume>(map['volumes']!, (value) => TaskDefinitionVolume.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
