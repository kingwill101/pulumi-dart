...
class TaskDefinitionState {
  ...
  TaskDefinitionState({
    ...
    pulumi.Output<String>? arnWithoutRevision,
    pulumi.Output<String>? containerDefinitions,
    ...
    pulumi.Output<List<TaskDefinitionVolume>>? volumes,
      ...
      arnWithoutRevision = pulumi.Input.asOptionalInput<String>(arnWithoutRevision),
      containerDefinitions = pulumi.Input.asOptionalInput<String>(containerDefinitions),
  ...
  factory TaskDefinitionState.fromMap(Map<String, dynamic> map) {
    return TaskDefinitionState(
      ...
      arnWithoutRevision: map['arnWithoutRevision'] == null ? null : pulumi.Output.create<String>(map['arnWithoutRevision'] as String),
      containerDefinitions: map['containerDefinitions'] == null ? null : pulumi.Output.create<String>(map['containerDefinitions'] as String),
