...
class CapacityProviderState {
  ...
  /// [autoScalingGroupProvider] Configuration block for the provider for the ECS auto scaling group. Detailed below. Exactly one of `autoScalingGroupProvider` or `managedInstancesProvider` must be specified.
  /// [cluster] Name of the ECS cluster. Required when using `managedInstancesProvider`. Must not be set when using `autoScalingGroupProvider`.
  /// [managedInstancesProvider] Configuration block for the managed instances provider. Detailed below. Exactly one of `autoScalingGroupProvider` or `managedInstancesProvider` must be specified.
  ...
  factory CapacityProviderState.fromMap(Map<String, dynamic> map) {
    return CapacityProviderState(
      ...
      autoScalingGroupProvider: (() { final guardedValue = map['autoScalingGroupProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityProviderAutoScalingGroupProvider.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      managedInstancesProvider: (() { final guardedValue = map['managedInstancesProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityProviderManagedInstancesProvider.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
