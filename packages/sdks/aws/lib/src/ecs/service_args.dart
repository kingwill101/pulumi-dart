...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      alarms: map['alarms'] == null ? null : (ServiceAlarms.fromMap((map['alarms'] as Map).cast<String, dynamic>())).input(),
      availabilityZoneRebalancing: map['availabilityZoneRebalancing'] == null ? null : (map['availabilityZoneRebalancing'] as String).input(),
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : (pulumi.Input.decodeList<ServiceCapacityProviderStrategy>(map['capacityProviderStrategies'], (value) => ServiceCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      cluster: map['cluster'] == null ? null : (map['cluster'] as String).input(),
      deploymentCircuitBreaker: map['deploymentCircuitBreaker'] == null ? null : (ServiceDeploymentCircuitBreaker.fromMap((map['deploymentCircuitBreaker'] as Map).cast<String, dynamic>())).input(),
      deploymentConfiguration: map['deploymentConfiguration'] == null ? null : (ServiceDeploymentConfiguration.fromMap((map['deploymentConfiguration'] as Map).cast<String, dynamic>())).input(),
      deploymentController: map['deploymentController'] == null ? null : (ServiceDeploymentController.fromMap((map['deploymentController'] as Map).cast<String, dynamic>())).input(),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : (pulumi.Input.decodeList<ServiceLoadBalancer>(map['loadBalancers'], (value) => ServiceLoadBalancer.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      orderedPlacementStrategies: map['orderedPlacementStrategies'] == null ? null : (pulumi.Input.decodeList<ServiceOrderedPlacementStrategy>(map['orderedPlacementStrategies'], (value) => ServiceOrderedPlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      placementConstraints: map['placementConstraints'] == null ? null : (pulumi.Input.decodeList<ServicePlacementConstraint>(map['placementConstraints'], (value) => ServicePlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      serviceConnectConfiguration: map['serviceConnectConfiguration'] == null ? null : (ServiceServiceConnectConfiguration.fromMap((map['serviceConnectConfiguration'] as Map).cast<String, dynamic>())).input(),
      serviceRegistries: map['serviceRegistries'] == null ? null : (ServiceServiceRegistries.fromMap((map['serviceRegistries'] as Map).cast<String, dynamic>())).input(),
      ...
      volumeConfiguration: map['volumeConfiguration'] == null ? null : (ServiceVolumeConfiguration.fromMap((map['volumeConfiguration'] as Map).cast<String, dynamic>())).input(),
      vpcLatticeConfigurations: map['vpcLatticeConfigurations'] == null ? null : (pulumi.Input.decodeList<ServiceVpcLatticeConfiguration>(map['vpcLatticeConfigurations'], (value) => ServiceVpcLatticeConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
