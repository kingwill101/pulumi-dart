...
class ServiceArgs {
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      alarms: map['alarms'] == null ? null : ((ServiceAlarms.fromMap((map['alarms']! as Map).cast<String, dynamic>())).input()).input(),
      availabilityZoneRebalancing: map['availabilityZoneRebalancing'] == null ? null : ((map['availabilityZoneRebalancing'] as String).input()).input(),
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : ((pulumi.Input.decodeList<ServiceCapacityProviderStrategy>(map['capacityProviderStrategies']!, (value) => ServiceCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      cluster: map['cluster'] == null ? null : ((map['cluster'] as String).input()).input(),
      deploymentCircuitBreaker: map['deploymentCircuitBreaker'] == null ? null : ((ServiceDeploymentCircuitBreaker.fromMap((map['deploymentCircuitBreaker']! as Map).cast<String, dynamic>())).input()).input(),
      deploymentConfiguration: map['deploymentConfiguration'] == null ? null : ((ServiceDeploymentConfiguration.fromMap((map['deploymentConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      deploymentController: map['deploymentController'] == null ? null : ((ServiceDeploymentController.fromMap((map['deploymentController']! as Map).cast<String, dynamic>())).input()).input(),
      deploymentMaximumPercent: map['deploymentMaximumPercent'] == null ? null : ((map['deploymentMaximumPercent'] as int).input()).input(),
      deploymentMinimumHealthyPercent: map['deploymentMinimumHealthyPercent'] == null ? null : ((map['deploymentMinimumHealthyPercent'] as int).input()).input(),
      ...
      forceNewDeployment: map['forceNewDeployment'] == null ? null : ((map['forceNewDeployment'] as bool).input()).input(),
      healthCheckGracePeriodSeconds: map['healthCheckGracePeriodSeconds'] == null ? null : ((map['healthCheckGracePeriodSeconds'] as int).input()).input(),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : ((pulumi.Input.decodeList<ServiceLoadBalancer>(map['loadBalancers']!, (value) => ServiceLoadBalancer.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      orderedPlacementStrategies: map['orderedPlacementStrategies'] == null ? null : ((pulumi.Input.decodeList<ServiceOrderedPlacementStrategy>(map['orderedPlacementStrategies']!, (value) => ServiceOrderedPlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      placementConstraints: map['placementConstraints'] == null ? null : ((pulumi.Input.decodeList<ServicePlacementConstraint>(map['placementConstraints']!, (value) => ServicePlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      schedulingStrategy: map['schedulingStrategy'] == null ? null : ((map['schedulingStrategy'] as String).input()).input(),
      serviceConnectConfiguration: map['serviceConnectConfiguration'] == null ? null : ((ServiceServiceConnectConfiguration.fromMap((map['serviceConnectConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      serviceRegistries: map['serviceRegistries'] == null ? null : ((ServiceServiceRegistries.fromMap((map['serviceRegistries']! as Map).cast<String, dynamic>())).input()).input(),
      sigintRollback: map['sigintRollback'] == null ? null : ((map['sigintRollback'] as bool).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      taskDefinition: map['taskDefinition'] == null ? null : ((map['taskDefinition'] as String).input()).input(),
      triggers: map['triggers'] == null ? null : (((map['triggers'] as Map).cast<String, String>()).input()).input(),
      volumeConfiguration: map['volumeConfiguration'] == null ? null : ((ServiceVolumeConfiguration.fromMap((map['volumeConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      vpcLatticeConfigurations: map['vpcLatticeConfigurations'] == null ? null : ((pulumi.Input.decodeList<ServiceVpcLatticeConfiguration>(map['vpcLatticeConfigurations']!, (value) => ServiceVpcLatticeConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
