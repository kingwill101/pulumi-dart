...
class GetTaskExecutionOverridesContainerOverride {
  ...
  final List<GetTaskExecutionOverridesContainerOverrideEnvironment>? environments;
  ...
  final List<GetTaskExecutionOverridesContainerOverrideResourceRequirement>? resourceRequirements;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'commands': ?commands,
      'cpu': ?cpu,
      'environments': ?environments == null ? null : pulumi.Input.encodeList<GetTaskExecutionOverridesContainerOverrideEnvironment, Map<String, dynamic>>(environments!, (value) => value.toMap()),
      'memory': ?memory,
      'memoryReservation': ?memoryReservation,
      'name': name,
      'resourceRequirements': ?resourceRequirements == null ? null : pulumi.Input.encodeList<GetTaskExecutionOverridesContainerOverrideResourceRequirement, Map<String, dynamic>>(resourceRequirements!, (value) => value.toMap()),
    };
  }
  ...
  factory GetTaskExecutionOverridesContainerOverride.fromMap(Map<String, dynamic> map) {
    return GetTaskExecutionOverridesContainerOverride(
      ...
      environments: map['environments'] == null ? null : pulumi.Input.decodeList<GetTaskExecutionOverridesContainerOverrideEnvironment>(map['environments'], (value) => GetTaskExecutionOverridesContainerOverrideEnvironment.fromMap((value as Map).cast<String, dynamic>())),
      ...
      resourceRequirements: map['resourceRequirements'] == null ? null : pulumi.Input.decodeList<GetTaskExecutionOverridesContainerOverrideResourceRequirement>(map['resourceRequirements'], (value) => GetTaskExecutionOverridesContainerOverrideResourceRequirement.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
