...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    this.availabilityZoneRebalancing = registerOutput<String>('availabilityZoneRebalancing');
    this.capacityProviderStrategies = registerOutput<List<ServiceCapacityProviderStrategy>?>('capacityProviderStrategies');
    this.cluster = registerOutput<String>('cluster');
    this.deploymentCircuitBreaker = registerOutput<ServiceDeploymentCircuitBreaker?>('deploymentCircuitBreaker');
    this.deploymentConfiguration = registerOutput<ServiceDeploymentConfiguration>('deploymentConfiguration');
    this.deploymentController = registerOutput<ServiceDeploymentController?>('deploymentController');
    this.deploymentMaximumPercent = registerOutput<int?>('deploymentMaximumPercent');
    this.deploymentMinimumHealthyPercent = registerOutput<int?>('deploymentMinimumHealthyPercent');
    ...
    this.healthCheckGracePeriodSeconds = registerOutput<int?>('healthCheckGracePeriodSeconds');
    this.iamRole = registerOutput<String>('iamRole');
    this.launchType = registerOutput<String>('launchType');
    this.loadBalancers = registerOutput<List<ServiceLoadBalancer>?>('loadBalancers');
    this.name = registerOutput<String>('name');
    this.networkConfiguration = registerOutput<ServiceNetworkConfiguration?>('networkConfiguration');
    this.orderedPlacementStrategies = registerOutput<List<ServiceOrderedPlacementStrategy>?>('orderedPlacementStrategies');
    this.placementConstraints = registerOutput<List<ServicePlacementConstraint>?>('placementConstraints');
    ...
    this.serviceConnectConfiguration = registerOutput<ServiceServiceConnectConfiguration?>('serviceConnectConfiguration');
    this.serviceRegistries = registerOutput<ServiceServiceRegistries?>('serviceRegistries');
    ...
    this.volumeConfiguration = registerOutput<ServiceVolumeConfiguration?>('volumeConfiguration');
    this.vpcLatticeConfigurations = registerOutput<List<ServiceVpcLatticeConfiguration>?>('vpcLatticeConfigurations');
