...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    capacityProviderStrategies = registerOutput<List<Map<String, dynamic>>?>(
      'capacityProviderStrategies',
    );
    ...
    healthCheckGracePeriodSeconds = registerOutput<int?>(
    ...
    placementConstraints = registerOutput<List<Map<String, dynamic>>?>(
      'placementConstraints',
    );
