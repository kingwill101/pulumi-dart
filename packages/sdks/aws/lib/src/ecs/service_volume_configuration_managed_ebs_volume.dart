...
class ServiceVolumeConfigurationManagedEbsVolume {
  ...
  final List<ServiceVolumeConfigurationManagedEbsVolumeTagSpecification>? tagSpecifications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tagSpecifications': ?tagSpecifications == null ? null : pulumi.Input.encodeList<ServiceVolumeConfigurationManagedEbsVolumeTagSpecification, Map<String, dynamic>>(tagSpecifications!, (value) => value.toMap()),
  ...
  factory ServiceVolumeConfigurationManagedEbsVolume.fromMap(Map<String, dynamic> map) {
    return ServiceVolumeConfigurationManagedEbsVolume(
      ...
      tagSpecifications: map['tagSpecifications'] == null ? null : pulumi.Input.decodeList<ServiceVolumeConfigurationManagedEbsVolumeTagSpecification>(map['tagSpecifications'], (value) => ServiceVolumeConfigurationManagedEbsVolumeTagSpecification.fromMap((value as Map).cast<String, dynamic>())),
