...
class CapacityProviderManagedInstancesProviderInstanceLaunchTemplate {
  ...
  final CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements? instanceRequirements;
  ...
  final CapacityProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfiguration networkConfiguration;
  ...
  final CapacityProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfiguration? storageConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'instanceRequirements': ?instanceRequirements == null ? null : instanceRequirements!.toMap(),
  ...
  factory CapacityProviderManagedInstancesProviderInstanceLaunchTemplate.fromMap(Map<String, dynamic> map) {
    return CapacityProviderManagedInstancesProviderInstanceLaunchTemplate(
      capacityOptionType: map['capacityOptionType'] == null ? null : map['capacityOptionType'] as String,
      ec2InstanceProfileArn: map['ec2InstanceProfileArn'] as String,
      instanceRequirements: map['instanceRequirements'] == null ? null : CapacityProviderManagedInstancesProviderInstanceLaunchTemplateInstanceRequirements.fromMap((map['instanceRequirements'] as Map).cast<String, dynamic>()),
      monitoring: map['monitoring'] == null ? null : map['monitoring'] as String,
      networkConfiguration: CapacityProviderManagedInstancesProviderInstanceLaunchTemplateNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      storageConfiguration: map['storageConfiguration'] == null ? null : CapacityProviderManagedInstancesProviderInstanceLaunchTemplateStorageConfiguration.fromMap((map['storageConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
