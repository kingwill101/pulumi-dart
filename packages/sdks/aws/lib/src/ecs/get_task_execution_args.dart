...
class GetTaskExecutionArgs {
  ...
  factory GetTaskExecutionArgs.fromMap(Map<String, dynamic> map) {
    return GetTaskExecutionArgs(
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : (pulumi.Input.decodeList<GetTaskExecutionCapacityProviderStrategy>(map['capacityProviderStrategies'], (value) => GetTaskExecutionCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      networkConfiguration: map['networkConfiguration'] == null ? null : (GetTaskExecutionNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>())).input(),
      overrides: map['overrides'] == null ? null : (GetTaskExecutionOverrides.fromMap((map['overrides'] as Map).cast<String, dynamic>())).input(),
      placementConstraints: map['placementConstraints'] == null ? null : (pulumi.Input.decodeList<GetTaskExecutionPlacementConstraint>(map['placementConstraints'], (value) => GetTaskExecutionPlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      placementStrategies: map['placementStrategies'] == null ? null : (pulumi.Input.decodeList<GetTaskExecutionPlacementStrategy>(map['placementStrategies'], (value) => GetTaskExecutionPlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      startedBy: map['startedBy'] == null ? null : (map['startedBy'] as String).input(),
