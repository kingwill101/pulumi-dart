...
class GetTaskExecutionArgs {
  ...
  GetTaskExecutionArgs({
    pulumi.Output<List<GetTaskExecutionCapacityProviderStrategy>>? capacityProviderStrategies,
    ...
    pulumi.Output<GetTaskExecutionNetworkConfiguration>? networkConfiguration,
    pulumi.Output<GetTaskExecutionOverrides>? overrides,
    pulumi.Output<List<GetTaskExecutionPlacementConstraint>>? placementConstraints,
    pulumi.Output<List<GetTaskExecutionPlacementStrategy>>? placementStrategies,
    pulumi.Output<String>? platformVersion,
    pulumi.Output<String>? propagateTags,
    pulumi.Output<String>? referenceId,
    pulumi.Output<String>? region,
    pulumi.Output<String>? startedBy,
  ...
  factory GetTaskExecutionArgs.fromMap(Map<String, dynamic> map) {
    return GetTaskExecutionArgs(
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : pulumi.Output.create<List<GetTaskExecutionCapacityProviderStrategy>>(pulumi.Input.decodeList<GetTaskExecutionCapacityProviderStrategy>(map['capacityProviderStrategies'], (value) => GetTaskExecutionCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      networkConfiguration: map['networkConfiguration'] == null ? null : pulumi.Output.create<GetTaskExecutionNetworkConfiguration>(GetTaskExecutionNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>())),
      overrides: map['overrides'] == null ? null : pulumi.Output.create<GetTaskExecutionOverrides>(GetTaskExecutionOverrides.fromMap((map['overrides'] as Map).cast<String, dynamic>())),
      placementConstraints: map['placementConstraints'] == null ? null : pulumi.Output.create<List<GetTaskExecutionPlacementConstraint>>(pulumi.Input.decodeList<GetTaskExecutionPlacementConstraint>(map['placementConstraints'], (value) => GetTaskExecutionPlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))),
      placementStrategies: map['placementStrategies'] == null ? null : pulumi.Output.create<List<GetTaskExecutionPlacementStrategy>>(pulumi.Input.decodeList<GetTaskExecutionPlacementStrategy>(map['placementStrategies'], (value) => GetTaskExecutionPlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      startedBy: map['startedBy'] == null ? null : pulumi.Output.create<String>(map['startedBy'] as String),
