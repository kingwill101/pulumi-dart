...
class ServiceDeploymentConfiguration {
  ...
  final pulumi.Input<ServiceDeploymentConfigurationCanaryConfiguration>?
  canaryConfiguration;

  /// Configuration block for lifecycle hooks that are invoked during deployments. See below.
  final pulumi.Input<List<ServiceDeploymentConfigurationLifecycleHook>>?
  lifecycleHooks;

  /// Configuration block for linear deployment strategy. Required when `strategy` is set to `LINEAR`. See below.
  final pulumi.Input<ServiceDeploymentConfigurationLinearConfiguration>?
  linearConfiguration;
    ...
    return <String, dynamic>{
      ...
      'canaryConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(canaryConfiguration, (value) => value.toMap()),
      'lifecycleHooks':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceDeploymentConfigurationLifecycleHook>,
      ...
      'linearConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(linearConfiguration, (value) => value.toMap()),
      'strategy': ?strategy,
    };
  }
  ...
  factory ServiceDeploymentConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceDeploymentConfiguration(
      bakeTimeInMinutes: (() {
        final guardedValue = map['bakeTimeInMinutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      canaryConfiguration: (() {
        final guardedValue = map['canaryConfiguration'];
        if (guardedValue == null) return null;
      ...
      lifecycleHooks: (() {
        final guardedValue = map['lifecycleHooks'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceDeploymentConfigurationLifecycleHook>(
            guardedValue,
      ...
      linearConfiguration: (() {
        final guardedValue = map['linearConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
