...
class ServiceServiceConnectConfigurationLogConfiguration {
  ...
  factory ServiceServiceConnectConfigurationLogConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceServiceConnectConfigurationLogConfiguration(
      ...
      secretOptions: (() { final guardedValue = map['secretOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceServiceConnectConfigurationLogConfigurationSecretOption>(guardedValue, (value) => ServiceServiceConnectConfigurationLogConfigurationSecretOption.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
