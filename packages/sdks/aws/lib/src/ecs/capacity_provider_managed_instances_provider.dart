...
import 'capacity_provider_managed_instances_provider_auto_repair_configuration.dart';
...
class CapacityProviderManagedInstancesProvider {
  ...
  final pulumi.Input<CapacityProviderManagedInstancesProviderAutoRepairConfiguration?>? autoRepairConfiguration;
  ...
  /// [autoRepairConfiguration] Configuration block for the auto repair configuration. Detailed below.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoRepairConfiguration': ?pulumi.Input.mapOptionalInputValue<CapacityProviderManagedInstancesProviderAutoRepairConfiguration, Map<String, dynamic>>(autoRepairConfiguration, (value) => value.toMap()),
  ...
  factory CapacityProviderManagedInstancesProvider.fromMap(Map<String, dynamic> map) {
    return CapacityProviderManagedInstancesProvider(
      autoRepairConfiguration: (() { final guardedValue = map['autoRepairConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityProviderManagedInstancesProviderAutoRepairConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
