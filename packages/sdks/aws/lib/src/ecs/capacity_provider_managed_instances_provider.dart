...
class CapacityProviderManagedInstancesProvider {
    ...
    return <String, dynamic>{
      'infrastructureOptimization':
          ?pulumi.Input.mapOptionalInputValue<
            CapacityProviderManagedInstancesProviderInfrastructureOptimization,
            Map<String, dynamic>
          >(infrastructureOptimization, (value) => value.toMap()),
      'infrastructureRoleArn': infrastructureRoleArn,
      'instanceLaunchTemplate':
          pulumi.Input.mapInputValue<
            CapacityProviderManagedInstancesProviderInstanceLaunchTemplate,
            Map<String, dynamic>
          >(instanceLaunchTemplate, (value) => value.toMap()),
  ...
  factory CapacityProviderManagedInstancesProvider.fromMap(
    ...
    return CapacityProviderManagedInstancesProvider(
      infrastructureOptimization: (() {
        final guardedValue = map['infrastructureOptimization'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          CapacityProviderManagedInstancesProviderInfrastructureOptimization.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      infrastructureRoleArn: pulumi.Input.fromValue(
        map['infrastructureRoleArn'] as String,
      ),
      instanceLaunchTemplate: pulumi.Input.fromValue(
        CapacityProviderManagedInstancesProviderInstanceLaunchTemplate.fromMap(
          (map['instanceLaunchTemplate']! as Map).cast<String, dynamic>(),
        ),
      ),
      propagateTags: (() {
