...
class ExpressGatewayServiceState {
  ...
  factory ExpressGatewayServiceState.fromMap(Map<String, dynamic> map) {
    return ExpressGatewayServiceState(
      ...
      currentDeployment: map['currentDeployment'] == null ? null : (map['currentDeployment'] as String).input(),
      ...
      infrastructureRoleArn: map['infrastructureRoleArn'] == null ? null : (map['infrastructureRoleArn'] as String).input(),
      ingressPaths: map['ingressPaths'] == null ? null : (pulumi.Input.decodeList<ExpressGatewayServiceIngressPath>(map['ingressPaths'], (value) => ExpressGatewayServiceIngressPath.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      primaryContainer: map['primaryContainer'] == null ? null : (ExpressGatewayServicePrimaryContainer.fromMap((map['primaryContainer'] as Map).cast<String, dynamic>())).input(),
      ...
      serviceRevisionArn: map['serviceRevisionArn'] == null ? null : (map['serviceRevisionArn'] as String).input(),
