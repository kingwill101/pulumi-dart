...
class ServiceDeploymentConfigurationCanaryConfiguration {
  ...
  factory ServiceDeploymentConfigurationCanaryConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceDeploymentConfigurationCanaryConfiguration(
      canaryBakeTimeInMinutes: (() { final guardedValue = map['canaryBakeTimeInMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      canaryPercent: (() { final guardedValue = map['canaryPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
