...
class ExpressGatewayServicePrimaryContainer {
  ...
  factory ExpressGatewayServicePrimaryContainer.fromMap(Map<String, dynamic> map) {
    return ExpressGatewayServicePrimaryContainer(
      ...
      secrets: (() { final guardedValue = map['secrets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExpressGatewayServicePrimaryContainerSecret>(guardedValue, (value) => ExpressGatewayServicePrimaryContainerSecret.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
