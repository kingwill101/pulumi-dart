...
class Cluster extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [Cluster]. {@macro pulumi_ecs_cluster_cluster_args_doc}
  ...
  Cluster(
    ...
    this.serviceConnectDefaults = registerOutput<ClusterServiceConnectDefaults?>('serviceConnectDefaults');
