...
class TaskSet extends pulumi.CustomResource {
  ...
  TaskSet(
    ...
    this.capacityProviderStrategies = registerOutput<List<TaskSetCapacityProviderStrategy>?>('capacityProviderStrategies');
    ...
    this.loadBalancers = registerOutput<List<TaskSetLoadBalancer>?>('loadBalancers');
    this.networkConfiguration = registerOutput<TaskSetNetworkConfiguration?>('networkConfiguration');
    this.platformVersion = registerOutput<String>('platformVersion');
    this.region = registerOutput<String>('region');
    this.scale = registerOutput<TaskSetScale>('scale');
    this.service = registerOutput<String>('service');
    this.serviceRegistries = registerOutput<TaskSetServiceRegistries?>('serviceRegistries');
    ...
    this.waitUntilStableTimeout = registerOutput<String?>('waitUntilStableTimeout');
  }

  /// Gets an existing [TaskSet] resource's state with the given [name] and [id].
  static TaskSet get(
    String name,
