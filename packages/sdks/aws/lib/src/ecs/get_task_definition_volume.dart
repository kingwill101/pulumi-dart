...
class GetTaskDefinitionVolume {
  ...
  final List<GetTaskDefinitionVolumeDockerVolumeConfiguration> dockerVolumeConfigurations;
  /// Configuration block for an EFS volume. Detailed below.
  final List<GetTaskDefinitionVolumeEfsVolumeConfiguration> efsVolumeConfigurations;
  /// Configuration block for an FSX Windows File Server volume. Detailed below.
  final List<GetTaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration> fsxWindowsFileServerVolumeConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dockerVolumeConfigurations': pulumi.Input.encodeList<GetTaskDefinitionVolumeDockerVolumeConfiguration, Map<String, dynamic>>(dockerVolumeConfigurations, (value) => value.toMap()),
      'efsVolumeConfigurations': pulumi.Input.encodeList<GetTaskDefinitionVolumeEfsVolumeConfiguration, Map<String, dynamic>>(efsVolumeConfigurations, (value) => value.toMap()),
      'fsxWindowsFileServerVolumeConfigurations': pulumi.Input.encodeList<GetTaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration, Map<String, dynamic>>(fsxWindowsFileServerVolumeConfigurations, (value) => value.toMap()),
      'hostPath': hostPath,
      'name': name,
    };
  }
  ...
  factory GetTaskDefinitionVolume.fromMap(Map<String, dynamic> map) {
    return GetTaskDefinitionVolume(
      ...
      dockerVolumeConfigurations: pulumi.Input.decodeList<GetTaskDefinitionVolumeDockerVolumeConfiguration>(map['dockerVolumeConfigurations'], (value) => GetTaskDefinitionVolumeDockerVolumeConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      efsVolumeConfigurations: pulumi.Input.decodeList<GetTaskDefinitionVolumeEfsVolumeConfiguration>(map['efsVolumeConfigurations'], (value) => GetTaskDefinitionVolumeEfsVolumeConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      fsxWindowsFileServerVolumeConfigurations: pulumi.Input.decodeList<GetTaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration>(map['fsxWindowsFileServerVolumeConfigurations'], (value) => GetTaskDefinitionVolumeFsxWindowsFileServerVolumeConfiguration.fromMap((value as Map).cast<String, dynamic>())),
