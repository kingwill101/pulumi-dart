...
class TaskSetState {
  ...
  factory TaskSetState.fromMap(Map<String, dynamic> map) {
    return TaskSetState(
      ...
      stabilityStatus: map['stabilityStatus'] == null ? null : ((map['stabilityStatus'] as String).input()).input(),
      ...
      taskSetId: map['taskSetId'] == null ? null : ((map['taskSetId'] as String).input()).input(),
