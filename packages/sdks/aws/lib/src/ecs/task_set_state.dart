...
class TaskSetState {
  ...
  TaskSetState({
    ...
    pulumi.Output<List<TaskSetCapacityProviderStrategy>>? capacityProviderStrategies,
    pulumi.Output<String>? cluster,
    pulumi.Output<String>? externalId,
    pulumi.Output<bool>? forceDelete,
    pulumi.Output<String>? launchType,
    pulumi.Output<List<TaskSetLoadBalancer>>? loadBalancers,
    pulumi.Output<TaskSetNetworkConfiguration>? networkConfiguration,
    pulumi.Output<String>? platformVersion,
    pulumi.Output<String>? region,
    pulumi.Output<TaskSetScale>? scale,
    pulumi.Output<String>? service,
    pulumi.Output<TaskSetServiceRegistries>? serviceRegistries,
    pulumi.Output<String>? stabilityStatus,
    pulumi.Output<String>? status,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<Map<String, String>>? tagsAll,
    pulumi.Output<String>? taskDefinition,
    pulumi.Output<String>? taskSetId,
    pulumi.Output<bool>? waitUntilStable,
    pulumi.Output<String>? waitUntilStableTimeout,
  }) :
      arn = pulumi.Input.asOptionalInput<String>(arn),
      capacityProviderStrategies = pulumi.Input.asOptionalInput<List<TaskSetCapacityProviderStrategy>>(capacityProviderStrategies),
      ...
      loadBalancers = pulumi.Input.asOptionalInput<List<TaskSetLoadBalancer>>(loadBalancers),
      networkConfiguration = pulumi.Input.asOptionalInput<TaskSetNetworkConfiguration>(networkConfiguration),
      ...
      serviceRegistries = pulumi.Input.asOptionalInput<TaskSetServiceRegistries>(serviceRegistries),
      stabilityStatus = pulumi.Input.asOptionalInput<String>(stabilityStatus),
      status = pulumi.Input.asOptionalInput<String>(status),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      tagsAll = pulumi.Input.asOptionalInput<Map<String, String>>(tagsAll),
      taskDefinition = pulumi.Input.asOptionalInput<String>(taskDefinition),
      taskSetId = pulumi.Input.asOptionalInput<String>(taskSetId),
      waitUntilStable = pulumi.Input.asOptionalInput<bool>(waitUntilStable),
      waitUntilStableTimeout = pulumi.Input.asOptionalInput<String>(waitUntilStableTimeout);
  ...
  factory TaskSetState.fromMap(Map<String, dynamic> map) {
    return TaskSetState(
      ...
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : pulumi.Output.create<List<TaskSetCapacityProviderStrategy>>(pulumi.Input.decodeList<TaskSetCapacityProviderStrategy>(map['capacityProviderStrategies'], (value) => TaskSetCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : pulumi.Output.create<List<TaskSetLoadBalancer>>(pulumi.Input.decodeList<TaskSetLoadBalancer>(map['loadBalancers'], (value) => TaskSetLoadBalancer.fromMap((value as Map).cast<String, dynamic>()))),
      networkConfiguration: map['networkConfiguration'] == null ? null : pulumi.Output.create<TaskSetNetworkConfiguration>(TaskSetNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>())),
      platformVersion: map['platformVersion'] == null ? null : pulumi.Output.create<String>(map['platformVersion'] as String),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      scale: map['scale'] == null ? null : pulumi.Output.create<TaskSetScale>(TaskSetScale.fromMap((map['scale'] as Map).cast<String, dynamic>())),
      service: map['service'] == null ? null : pulumi.Output.create<String>(map['service'] as String),
      serviceRegistries: map['serviceRegistries'] == null ? null : pulumi.Output.create<TaskSetServiceRegistries>(TaskSetServiceRegistries.fromMap((map['serviceRegistries'] as Map).cast<String, dynamic>())),
      stabilityStatus: map['stabilityStatus'] == null ? null : pulumi.Output.create<String>(map['stabilityStatus'] as String),
      ...
      taskSetId: map['taskSetId'] == null ? null : pulumi.Output.create<String>(map['taskSetId'] as String),
      waitUntilStable: map['waitUntilStable'] == null ? null : pulumi.Output.create<bool>(map['waitUntilStable'] as bool),
      waitUntilStableTimeout: map['waitUntilStableTimeout'] == null ? null : pulumi.Output.create<String>(map['waitUntilStableTimeout'] as String),
    );
  }
}
