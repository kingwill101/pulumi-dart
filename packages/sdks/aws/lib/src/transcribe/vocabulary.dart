...
class Vocabulary extends pulumi.CustomResource {
  ...
  Vocabulary(
    ...
    phrases = registerOutput<List<String>?>('phrases', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
