...
class MedicalVocabularyArgs {
  ...
  /// [languageCode] Language code you selected for your medical vocabulary. US English (en-US) is the only language supported with Amazon Transcribe Medical.
  /// [region] Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
  /// [tags] Map of tags to assign to the MedicalVocabulary. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
  /// [vocabularyFileUri] Amazon S3 location (URI) of the text file that contains your custom medical vocabulary.
  /// [vocabularyName] Name of the Medical Vocabulary.
  ...
  factory MedicalVocabularyArgs.fromMap(Map<String, dynamic> map) {
    return MedicalVocabularyArgs(
      ...
      vocabularyFileUri: pulumi.Input.fromValue(map['vocabularyFileUri'] as String),
