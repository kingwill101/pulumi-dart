...
class EnvironmentState {
  ...
  factory EnvironmentState.fromMap(Map<String, dynamic> map) {
    return EnvironmentState(
      ...
      maxWebservers: (() { final guardedValue = map['maxWebservers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      minWebservers: (() { final guardedValue = map['minWebservers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      minWorkers: (() { final guardedValue = map['minWorkers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      schedulers: (() { final guardedValue = map['schedulers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
