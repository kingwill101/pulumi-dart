  ...
  factory EnvironmentState.fromMap(Map<String, dynamic> map) {
    return EnvironmentState(
      airflowConfigurationOptions: (() {
        final guardedValue = map['airflowConfigurationOptions'];
      ...
      airflowVersion: (() {
        final guardedValue = map['airflowVersion'];
        if (guardedValue == null) return null;
      ...
      dagS3Path: (() {
        final guardedValue = map['dagS3Path'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      databaseVpcEndpointService: (() {
        final guardedValue = map['databaseVpcEndpointService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      endpointManagement: (() {
        final guardedValue = map['endpointManagement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      environmentClass: (() {
        final guardedValue = map['environmentClass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      executionRoleArn: (() {
      ...
      lastUpdateds: (() {
        final guardedValue = map['lastUpdateds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentLastUpdated>(
            guardedValue,
            (value) => EnvironmentLastUpdated.fromMap(
      ...
      maxWebservers: (() {
        final guardedValue = map['maxWebservers'];
        if (guardedValue == null) return null;
      ...
      minWebservers: (() {
        final guardedValue = map['minWebservers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minWorkers: (() {
        final guardedValue = map['minWorkers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      name: (() {
      ...
      networkConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EnvironmentNetworkConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pluginsS3ObjectVersion: (() {
        final guardedValue = map['pluginsS3ObjectVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pluginsS3Path: (() {
        final guardedValue = map['pluginsS3Path'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      requirementsS3ObjectVersion: (() {
        final guardedValue = map['requirementsS3ObjectVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      requirementsS3Path: (() {
        final guardedValue = map['requirementsS3Path'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      schedulers: (() {
        final guardedValue = map['schedulers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      serviceRoleArn: (() {
      ...
      sourceBucketArn: (() {
        final guardedValue = map['sourceBucketArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      startupScriptS3ObjectVersion: (() {
        final guardedValue = map['startupScriptS3ObjectVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      startupScriptS3Path: (() {
        final guardedValue = map['startupScriptS3Path'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      status: (() {
      ...
      webserverAccessMode: (() {
        final guardedValue = map['webserverAccessMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      webserverUrl: (() {
        final guardedValue = map['webserverUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      webserverVpcEndpointService: (() {
        final guardedValue = map['webserverVpcEndpointService'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      workerReplacementStrategy: (() {
        final guardedValue = map['workerReplacementStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
