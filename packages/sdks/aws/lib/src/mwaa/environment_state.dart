...
class EnvironmentState {
  ...
  factory EnvironmentState.fromMap(Map<String, dynamic> map) {
    return EnvironmentState(
      airflowConfigurationOptions: map['airflowConfigurationOptions'] == null ? null : (((map['airflowConfigurationOptions'] as Map).cast<String, String>()).input()).input(),
      airflowVersion: map['airflowVersion'] == null ? null : ((map['airflowVersion'] as String).input()).input(),
      arn: map['arn'] == null ? null : ((map['arn'] as String).input()).input(),
      createdAt: map['createdAt'] == null ? null : ((map['createdAt'] as String).input()).input(),
      dagS3Path: map['dagS3Path'] == null ? null : ((map['dagS3Path'] as String).input()).input(),
      databaseVpcEndpointService: map['databaseVpcEndpointService'] == null ? null : ((map['databaseVpcEndpointService'] as String).input()).input(),
      endpointManagement: map['endpointManagement'] == null ? null : ((map['endpointManagement'] as String).input()).input(),
      environmentClass: map['environmentClass'] == null ? null : ((map['environmentClass'] as String).input()).input(),
      ...
      lastUpdateds: map['lastUpdateds'] == null ? null : ((pulumi.Input.decodeList<EnvironmentLastUpdated>(map['lastUpdateds']!, (value) => EnvironmentLastUpdated.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      loggingConfiguration: map['loggingConfiguration'] == null ? null : ((EnvironmentLoggingConfiguration.fromMap((map['loggingConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      maxWebservers: map['maxWebservers'] == null ? null : ((map['maxWebservers'] as int).input()).input(),
      maxWorkers: map['maxWorkers'] == null ? null : ((map['maxWorkers'] as int).input()).input(),
      minWebservers: map['minWebservers'] == null ? null : ((map['minWebservers'] as int).input()).input(),
      minWorkers: map['minWorkers'] == null ? null : ((map['minWorkers'] as int).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      networkConfiguration: map['networkConfiguration'] == null ? null : ((EnvironmentNetworkConfiguration.fromMap((map['networkConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      pluginsS3ObjectVersion: map['pluginsS3ObjectVersion'] == null ? null : ((map['pluginsS3ObjectVersion'] as String).input()).input(),
      pluginsS3Path: map['pluginsS3Path'] == null ? null : ((map['pluginsS3Path'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      requirementsS3ObjectVersion: map['requirementsS3ObjectVersion'] == null ? null : ((map['requirementsS3ObjectVersion'] as String).input()).input(),
      requirementsS3Path: map['requirementsS3Path'] == null ? null : ((map['requirementsS3Path'] as String).input()).input(),
      schedulers: map['schedulers'] == null ? null : ((map['schedulers'] as int).input()).input(),
      serviceRoleArn: map['serviceRoleArn'] == null ? null : ((map['serviceRoleArn'] as String).input()).input(),
      sourceBucketArn: map['sourceBucketArn'] == null ? null : ((map['sourceBucketArn'] as String).input()).input(),
      startupScriptS3ObjectVersion: map['startupScriptS3ObjectVersion'] == null ? null : ((map['startupScriptS3ObjectVersion'] as String).input()).input(),
      startupScriptS3Path: map['startupScriptS3Path'] == null ? null : ((map['startupScriptS3Path'] as String).input()).input(),
      status: map['status'] == null ? null : ((map['status'] as String).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      webserverAccessMode: map['webserverAccessMode'] == null ? null : ((map['webserverAccessMode'] as String).input()).input(),
      webserverUrl: map['webserverUrl'] == null ? null : ((map['webserverUrl'] as String).input()).input(),
      webserverVpcEndpointService: map['webserverVpcEndpointService'] == null ? null : ((map['webserverVpcEndpointService'] as String).input()).input(),
      ...
      workerReplacementStrategy: map['workerReplacementStrategy'] == null ? null : ((map['workerReplacementStrategy'] as String).input()).input(),
    );
  }
}
