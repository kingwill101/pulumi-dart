...
class EnvironmentLoggingConfiguration {
  ...
  final pulumi.Input<EnvironmentLoggingConfigurationDagProcessingLogs>?
  dagProcessingLogs;

  /// Log configuration options for the schedulers. See Module logging configuration for more information. Disabled by default.
  final pulumi.Input<EnvironmentLoggingConfigurationSchedulerLogs>?
  schedulerLogs;
  ...
  final pulumi.Input<EnvironmentLoggingConfigurationWebserverLogs>?
  webserverLogs;
  ...
  factory EnvironmentLoggingConfiguration.fromMap(Map<String, dynamic> map) {
    return EnvironmentLoggingConfiguration(
      dagProcessingLogs: (() {
        final guardedValue = map['dagProcessingLogs'];
      ...
      schedulerLogs: (() {
        final guardedValue = map['schedulerLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      taskLogs: (() {
        final guardedValue = map['taskLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      webserverLogs: (() {
        final guardedValue = map['webserverLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      workerLogs: (() {
        final guardedValue = map['workerLogs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
