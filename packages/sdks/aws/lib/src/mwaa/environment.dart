...
class Environment extends pulumi.CustomResource {
  ...
  Environment(
    ...
    airflowConfigurationOptions = registerOutput<Map<String, String>?>(
      'airflowConfigurationOptions',
    );
    ...
    databaseVpcEndpointService = registerOutput<String>(
    ...
    requirementsS3ObjectVersion = registerOutput<String>(
    ...
    startupScriptS3ObjectVersion = registerOutput<String>(
    ...
    webserverVpcEndpointService = registerOutput<String>(
      'webserverVpcEndpointService',
    );
    weeklyMaintenanceWindowStart = registerOutput<String>(
      'weeklyMaintenanceWindowStart',
    );
    workerReplacementStrategy = registerOutput<String>(
