...
class EnvironmentArgs {
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      ...
      dagS3Path: (map['dagS3Path'] as String).input(),
      ...
      networkConfiguration: (EnvironmentNetworkConfiguration.fromMap((map['networkConfiguration']! as Map).cast<String, dynamic>())).input(),
      ...
      sourceBucketArn: (map['sourceBucketArn'] as String).input(),
