...
class RouteCalculationState {
  ...
  factory RouteCalculationState.fromMap(Map<String, dynamic> map) {
    return RouteCalculationState(
      calculatorArn: (() { final guardedValue = map['calculatorArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      calculatorName: (() { final guardedValue = map['calculatorName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
