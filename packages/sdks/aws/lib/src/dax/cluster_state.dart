...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      nodes: map['nodes'] == null ? null : ((pulumi.Input.decodeList<ClusterNode>(map['nodes']!, (value) => ClusterNode.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      replicationFactor: map['replicationFactor'] == null ? null : ((map['replicationFactor'] as int).input()).input(),
