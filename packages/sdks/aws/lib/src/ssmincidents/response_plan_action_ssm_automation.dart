...
class ResponsePlanActionSsmAutomation {
  ...
  const ResponsePlanActionSsmAutomation({
  ...
  factory ResponsePlanActionSsmAutomation.fromMap(Map<String, dynamic> map) {
    return ResponsePlanActionSsmAutomation(
      ...
      dynamicParameters: (() { final guardedValue = map['dynamicParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResponsePlanActionSsmAutomationParameter>(guardedValue, (value) => ResponsePlanActionSsmAutomationParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      roleArn: pulumi.Input.fromValue(map['roleArn'] as String),
      targetAccount: (() { final guardedValue = map['targetAccount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
