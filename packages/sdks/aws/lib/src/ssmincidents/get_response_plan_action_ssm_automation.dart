...
class GetResponsePlanActionSsmAutomation {
  ...
  final pulumi.Input<List<GetResponsePlanActionSsmAutomationParameter>>
  parameters;
    ...
    return <String, dynamic>{
      ...
      'parameters':
          pulumi.Input.mapInputValue<
            List<GetResponsePlanActionSsmAutomationParameter>,
  ...
  factory GetResponsePlanActionSsmAutomation.fromMap(Map<String, dynamic> map) {
    return GetResponsePlanActionSsmAutomation(
      ...
      dynamicParameters: pulumi.Input.fromValue(
