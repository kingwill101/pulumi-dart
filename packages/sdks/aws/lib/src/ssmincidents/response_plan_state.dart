...
class ResponsePlanState {
  ...
  ResponsePlanState({
    ...
    pulumi.Output<ResponsePlanIncidentTemplate>? incidentTemplate,
    ...
    pulumi.Output<Map<String, String>>? tagsAll,
      ...
      incidentTemplate = pulumi.Input.asOptionalInput<ResponsePlanIncidentTemplate>(incidentTemplate),
  ...
  factory ResponsePlanState.fromMap(Map<String, dynamic> map) {
    return ResponsePlanState(
      ...
      incidentTemplate: map['incidentTemplate'] == null ? null : pulumi.Output.create<ResponsePlanIncidentTemplate>(ResponsePlanIncidentTemplate.fromMap((map['incidentTemplate'] as Map).cast<String, dynamic>())),
