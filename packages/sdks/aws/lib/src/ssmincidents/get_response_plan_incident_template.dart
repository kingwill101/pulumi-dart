...
class GetResponsePlanIncidentTemplate {
  ...
  final pulumi.Input<List<GetResponsePlanIncidentTemplateNotificationTarget>>
  notificationTargets;
    ...
    return <String, dynamic>{
      ...
      'notificationTargets':
          pulumi.Input.mapInputValue<
            List<GetResponsePlanIncidentTemplateNotificationTarget>,
  ...
  factory GetResponsePlanIncidentTemplate.fromMap(Map<String, dynamic> map) {
    return GetResponsePlanIncidentTemplate(
      ...
      incidentTags: pulumi.Input.fromValue(
        (map['incidentTags'] as Map).cast<String, String>(),
      ),
      notificationTargets: pulumi.Input.fromValue(
