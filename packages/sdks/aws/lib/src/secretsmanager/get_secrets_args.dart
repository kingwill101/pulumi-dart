...
class GetSecretsArgs {
  ...
  factory GetSecretsArgs.fromMap(Map<String, dynamic> map) {
    return GetSecretsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecretsFilter>(guardedValue, (value) => GetSecretsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
