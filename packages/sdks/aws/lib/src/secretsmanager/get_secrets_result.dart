  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?(() {
        ...
        return pulumi.Input.encodeList<GetSecretsFilter, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetSecretsResult.fromMap(Map<String, dynamic> map) {
    return GetSecretsResult(
      ...
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetSecretsFilter>(
          guardedValue,
          (value) =>
              GetSecretsFilter.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      id: map['id'] as String,
