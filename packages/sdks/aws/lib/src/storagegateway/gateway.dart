...
class Gateway extends pulumi.CustomResource {
  ...
  Gateway(
    ...
    averageDownloadRateLimitInBitsPerSec = registerOutput<int?>(
      'averageDownloadRateLimitInBitsPerSec',
    );
    averageUploadRateLimitInBitsPerSec = registerOutput<int?>(
    ...
    gatewayNetworkInterfaces = registerOutput<List<Map<String, dynamic>>>(
