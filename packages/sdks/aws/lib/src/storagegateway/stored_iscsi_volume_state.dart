...
class StoredIscsiVolumeState {
  ...
  factory StoredIscsiVolumeState.fromMap(Map<String, dynamic> map) {
    return StoredIscsiVolumeState(
      ...
      lunNumber: map['lunNumber'] == null ? null : (map['lunNumber'] as int).input(),
      networkInterfaceId: map['networkInterfaceId'] == null ? null : (map['networkInterfaceId'] as String).input(),
      networkInterfacePort: map['networkInterfacePort'] == null ? null : (map['networkInterfacePort'] as int).input(),
      preserveExistingData: map['preserveExistingData'] == null ? null : (map['preserveExistingData'] as bool).input(),
      ...
      volumeAttachmentStatus: map['volumeAttachmentStatus'] == null ? null : (map['volumeAttachmentStatus'] as String).input(),
      volumeId: map['volumeId'] == null ? null : (map['volumeId'] as String).input(),
      volumeSizeInBytes: map['volumeSizeInBytes'] == null ? null : (map['volumeSizeInBytes'] as int).input(),
      volumeStatus: map['volumeStatus'] == null ? null : (map['volumeStatus'] as String).input(),
