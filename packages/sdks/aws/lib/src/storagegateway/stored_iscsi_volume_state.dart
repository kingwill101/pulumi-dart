...
class StoredIscsiVolumeState {
  ...
  factory StoredIscsiVolumeState.fromMap(Map<String, dynamic> map) {
    return StoredIscsiVolumeState(
      ...
      lunNumber: (() { final guardedValue = map['lunNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      networkInterfacePort: (() { final guardedValue = map['networkInterfacePort']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      volumeSizeInBytes: (() { final guardedValue = map['volumeSizeInBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
