...
class StoredIscsiVolumeState {
  ...
  /// [kmsKey] ARN of the AWS KMS key used for Amazon S3 server side encryption. This value can only be set when `kmsEncrypted` is `true`.
  ...
  /// [targetArn] Target ARN, e.g., `arn:aws:storagegateway:us-east-1:123456789012:gateway/sgw-12345678/target/iqn.1997-05.com.amazon:TargetName`.
  ...
  factory StoredIscsiVolumeState.fromMap(Map<String, dynamic> map) {
    return StoredIscsiVolumeState(
      ...
      lunNumber: (() { final guardedValue = map['lunNumber']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      networkInterfacePort: (() { final guardedValue = map['networkInterfacePort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      preserveExistingData: (() { final guardedValue = map['preserveExistingData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      volumeAttachmentStatus: (() { final guardedValue = map['volumeAttachmentStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      volumeSizeInBytes: (() { final guardedValue = map['volumeSizeInBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      volumeStatus: (() { final guardedValue = map['volumeStatus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
