...
class SmbFileShareState {
  ...
  factory SmbFileShareState.fromMap(Map<String, dynamic> map) {
    return SmbFileShareState(
      accessBasedEnumeration: map['accessBasedEnumeration'] == null ? null : ((map['accessBasedEnumeration'] as bool).input()).input(),
      adminUserLists: map['adminUserLists'] == null ? null : (((map['adminUserLists'] as List).cast<String>()).input()).input(),
      ...
      cacheAttributes: map['cacheAttributes'] == null ? null : ((SmbFileShareCacheAttributes.fromMap((map['cacheAttributes']! as Map).cast<String, dynamic>())).input()).input(),
      caseSensitivity: map['caseSensitivity'] == null ? null : ((map['caseSensitivity'] as String).input()).input(),
      defaultStorageClass: map['defaultStorageClass'] == null ? null : ((map['defaultStorageClass'] as String).input()).input(),
      fileShareName: map['fileShareName'] == null ? null : ((map['fileShareName'] as String).input()).input(),
      fileshareId: map['fileshareId'] == null ? null : ((map['fileshareId'] as String).input()).input(),
      gatewayArn: map['gatewayArn'] == null ? null : ((map['gatewayArn'] as String).input()).input(),
      guessMimeTypeEnabled: map['guessMimeTypeEnabled'] == null ? null : ((map['guessMimeTypeEnabled'] as bool).input()).input(),
      invalidUserLists: map['invalidUserLists'] == null ? null : (((map['invalidUserLists'] as List).cast<String>()).input()).input(),
      ...
      notificationPolicy: map['notificationPolicy'] == null ? null : ((map['notificationPolicy'] as String).input()).input(),
      objectAcl: map['objectAcl'] == null ? null : ((map['objectAcl'] as String).input()).input(),
      oplocksEnabled: map['oplocksEnabled'] == null ? null : ((map['oplocksEnabled'] as bool).input()).input(),
      ...
      requesterPays: map['requesterPays'] == null ? null : ((map['requesterPays'] as bool).input()).input(),
      roleArn: map['roleArn'] == null ? null : ((map['roleArn'] as String).input()).input(),
      smbAclEnabled: map['smbAclEnabled'] == null ? null : ((map['smbAclEnabled'] as bool).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      validUserLists: map['validUserLists'] == null ? null : (((map['validUserLists'] as List).cast<String>()).input()).input(),
      vpcEndpointDnsName: map['vpcEndpointDnsName'] == null ? null : ((map['vpcEndpointDnsName'] as String).input()).input(),
    );
  }
}
