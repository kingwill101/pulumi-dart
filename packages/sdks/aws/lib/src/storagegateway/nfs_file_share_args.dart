...
class NfsFileShareArgs {
  ...
  /// [auditDestinationArn] ARN of the storage used for audit logs.
  ...
  /// [gatewayArn] ARN of the file gateway.
  ...
  /// [kmsKeyArn] ARN for KMS key used for Amazon S3 server side encryption. This value can only be set when `kmsEncrypted` is true.
  ...
  factory NfsFileShareArgs.fromMap(Map<String, dynamic> map) {
    return NfsFileShareArgs(
      ...
      clientLists: pulumi.Input.fromValue((map['clientLists'] as List).cast<String>()),
