...
class NfsFileShareArgs {
  ...
  factory NfsFileShareArgs.fromMap(Map<String, dynamic> map) {
    return NfsFileShareArgs(
      ...
      cacheAttributes: map['cacheAttributes'] == null ? null : ((NfsFileShareCacheAttributes.fromMap((map['cacheAttributes']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      nfsFileShareDefaults: map['nfsFileShareDefaults'] == null ? null : ((NfsFileShareNfsFileShareDefaults.fromMap((map['nfsFileShareDefaults']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      squash: map['squash'] == null ? null : ((map['squash'] as String).input()).input(),
