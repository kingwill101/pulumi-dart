...
class CachesIscsiVolumeState {
  ...
  CachesIscsiVolumeState({
    ...
    pulumi.Output<String>? volumeArn,
    ...
    pulumi.Output<int>? volumeSizeInBytes,
      ...
      volumeArn = pulumi.Input.asOptionalInput<String>(volumeArn),
  ...
  factory CachesIscsiVolumeState.fromMap(Map<String, dynamic> map) {
    return CachesIscsiVolumeState(
      ...
      volumeArn: map['volumeArn'] == null ? null : pulumi.Output.create<String>(map['volumeArn'] as String),
