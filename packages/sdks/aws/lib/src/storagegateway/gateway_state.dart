...
class GatewayState {
  ...
  /// [cloudwatchLogGroupArn] ARN of the Amazon CloudWatch log group to use to monitor and log events in the gateway.
  ...
  factory GatewayState.fromMap(Map<String, dynamic> map) {
    return GatewayState(
      ...
      gatewayNetworkInterfaces: (() { final guardedValue = map['gatewayNetworkInterfaces']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GatewayGatewayNetworkInterface>(guardedValue, (value) => GatewayGatewayNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))); })(),
      gatewayTimezone: (() { final guardedValue = map['gatewayTimezone']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      hostEnvironment: (() { final guardedValue = map['hostEnvironment']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
