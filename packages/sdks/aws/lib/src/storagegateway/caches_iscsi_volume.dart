...
import 'caches_iscsi_volume_state.dart';
...
class CachesIscsiVolume extends pulumi.CustomResource {
  ...
  /// Gets an existing [CachesIscsiVolume] resource's state with the given [name] and [id].
  static CachesIscsiVolume get(
    String name,
