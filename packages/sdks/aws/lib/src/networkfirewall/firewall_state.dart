...
class FirewallState {
  ...
  factory FirewallState.fromMap(Map<String, dynamic> map) {
    return FirewallState(
      ...
      firewallStatuses: (() { final guardedValue = map['firewallStatuses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallFirewallStatus>(guardedValue, (value) => FirewallFirewallStatus.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      transitGatewayOwnerAccountId: (() { final guardedValue = map['transitGatewayOwnerAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
