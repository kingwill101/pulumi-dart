...
class FirewallState {
  ...
  factory FirewallState.fromMap(Map<String, dynamic> map) {
    return FirewallState(
      ...
      firewallStatuses: map['firewallStatuses'] == null ? null : (pulumi.Input.decodeList<FirewallFirewallStatus>(map['firewallStatuses'], (value) => FirewallFirewallStatus.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      transitGatewayOwnerAccountId: map['transitGatewayOwnerAccountId'] == null ? null : (map['transitGatewayOwnerAccountId'] as String).input(),
