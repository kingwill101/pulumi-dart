...
class RuleGroupRuleGroupRuleVariables {
  ...
  RuleGroupRuleGroupRuleVariables({this.ipSets, this.portSets});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipSets':
          ?pulumi.Input.mapOptionalInputValue<
            List<RuleGroupRuleGroupRuleVariablesIpSet>,
      ...
      'portSets':
          ?pulumi.Input.mapOptionalInputValue<
            List<RuleGroupRuleGroupRuleVariablesPortSet>,
            List<Map<String, dynamic>>
          >(
            portSets,
            (value) =>
    ...
    return RuleGroupRuleGroupRuleVariables(
      ipSets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleGroupRuleGroupRuleVariablesIpSet>(
            guardedValue,
      ...
      portSets: (() {
        final guardedValue = map['portSets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleGroupRuleGroupRuleVariablesPortSet>(
            guardedValue,
