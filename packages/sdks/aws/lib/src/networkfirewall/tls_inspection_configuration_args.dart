...
class TlsInspectionConfigurationArgs {
  ...
  factory TlsInspectionConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return TlsInspectionConfigurationArgs(
      ...
      tlsInspectionConfiguration: pulumi.Input.fromValue(TlsInspectionConfigurationTlsInspectionConfiguration.fromMap((map['tlsInspectionConfiguration']! as Map).cast<String, dynamic>())),
    );
  }
}
