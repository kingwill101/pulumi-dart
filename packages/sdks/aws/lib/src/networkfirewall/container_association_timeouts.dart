...
class ContainerAssociationTimeouts {
  ...
  /// Creates a new [ContainerAssociationTimeouts].
  ...
  const ContainerAssociationTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory ContainerAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return ContainerAssociationTimeouts(
