...
class FirewallFirewallStatus {
  ...
  factory FirewallFirewallStatus.fromMap(Map<String, dynamic> map) {
    return FirewallFirewallStatus(
      syncStates: (() { final guardedValue = map['syncStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallFirewallStatusSyncState>(guardedValue, (value) => FirewallFirewallStatusSyncState.fromMap((value as Map).cast<String, dynamic>()))); })(),
      transitGatewayAttachmentSyncStates: (() { final guardedValue = map['transitGatewayAttachmentSyncStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallFirewallStatusTransitGatewayAttachmentSyncState>(guardedValue, (value) => FirewallFirewallStatusTransitGatewayAttachmentSyncState.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
