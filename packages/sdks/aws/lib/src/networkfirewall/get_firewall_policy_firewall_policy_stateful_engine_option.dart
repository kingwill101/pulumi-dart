...
class GetFirewallPolicyFirewallPolicyStatefulEngineOption {
  ...
  factory GetFirewallPolicyFirewallPolicyStatefulEngineOption.fromMap(Map<String, dynamic> map) {
    return GetFirewallPolicyFirewallPolicyStatefulEngineOption(
      flowTimeouts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFirewallPolicyFirewallPolicyStatefulEngineOptionFlowTimeout>(map['flowTimeouts']!, (value) => GetFirewallPolicyFirewallPolicyStatefulEngineOptionFlowTimeout.fromMap((value as Map).cast<String, dynamic>()))),
      ruleOrder: pulumi.Input.fromValue(map['ruleOrder'] as String),
      streamExceptionPolicy: pulumi.Input.fromValue(map['streamExceptionPolicy'] as String),
    );
  }
}
