...
class GetFirewallFirewallStatus {
  ...
  final pulumi.Input<List<GetFirewallFirewallStatusCapacityUsageSummary>>
  ...
  final pulumi.Input<
    List<GetFirewallFirewallStatusTransitGatewayAttachmentSyncState>
  >
    ...
    return <String, dynamic>{
      'capacityUsageSummaries':
          pulumi.Input.mapInputValue<
            List<GetFirewallFirewallStatusCapacityUsageSummary>,
      ...
      'syncStates':
          pulumi.Input.mapInputValue<
            List<GetFirewallFirewallStatusSyncState>,
            List<Map<String, dynamic>>
          >(
            syncStates,
            (value) =>
  ...
  factory GetFirewallFirewallStatus.fromMap(Map<String, dynamic> map) {
    return GetFirewallFirewallStatus(
      capacityUsageSummaries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFirewallFirewallStatusCapacityUsageSummary>(
      ...
      configurationSyncStateSummary: pulumi.Input.fromValue(
        map['configurationSyncStateSummary'] as String,
      ),
      status: pulumi.Input.fromValue(map['status'] as String),
      syncStates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetFirewallFirewallStatusSyncState>(
          map['syncStates']!,
      ...
      transitGatewayAttachmentSyncStates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetFirewallFirewallStatusTransitGatewayAttachmentSyncState
        >(
          map['transitGatewayAttachmentSyncStates']!,
          (value) =>
              GetFirewallFirewallStatusTransitGatewayAttachmentSyncState.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
