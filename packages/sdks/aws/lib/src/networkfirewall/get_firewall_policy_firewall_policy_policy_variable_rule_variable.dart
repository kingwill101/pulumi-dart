...
class GetFirewallPolicyFirewallPolicyPolicyVariableRuleVariable {
  final List<GetFirewallPolicyFirewallPolicyPolicyVariableRuleVariableIpSet> ipSets;
  final String key;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ipSets': pulumi.Input.encodeList<GetFirewallPolicyFirewallPolicyPolicyVariableRuleVariableIpSet, Map<String, dynamic>>(ipSets, (value) => value.toMap()),
      'key': key,
    };
  }
  ...
  factory GetFirewallPolicyFirewallPolicyPolicyVariableRuleVariable.fromMap(Map<String, dynamic> map) {
    return GetFirewallPolicyFirewallPolicyPolicyVariableRuleVariable(
      ipSets: pulumi.Input.decodeList<GetFirewallPolicyFirewallPolicyPolicyVariableRuleVariableIpSet>(map['ipSets'], (value) => GetFirewallPolicyFirewallPolicyPolicyVariableRuleVariableIpSet.fromMap((value as Map).cast<String, dynamic>())),
