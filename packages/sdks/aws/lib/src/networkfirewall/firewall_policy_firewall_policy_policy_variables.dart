...
class FirewallPolicyFirewallPolicyPolicyVariables {
  final pulumi.Input<
    List<FirewallPolicyFirewallPolicyPolicyVariablesRuleVariable>
  >?
  ruleVariables;

  /// Creates a new [FirewallPolicyFirewallPolicyPolicyVariables].
  /// [ruleVariables] Optional.
  FirewallPolicyFirewallPolicyPolicyVariables({this.ruleVariables});
      ...
      ruleVariables: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirewallPolicyFirewallPolicyPolicyVariablesRuleVariable.fromMap(
