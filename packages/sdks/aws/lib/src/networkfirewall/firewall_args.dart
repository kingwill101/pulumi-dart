  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      availabilityZoneChangeProtection: (() {
        final guardedValue = map['availabilityZoneChangeProtection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      availabilityZoneMappings: (() {
        final guardedValue = map['availabilityZoneMappings'];
        if (guardedValue == null) return null;
      ...
      enabledAnalysisTypes: (() {
        final guardedValue = map['enabledAnalysisTypes'];
        if (guardedValue == null) return null;
      ...
      firewallPolicyArn: pulumi.Input.fromValue(
        map['firewallPolicyArn'] as String,
      ),
