...
class GetFirewallPolicyFirewallPolicyStatelessCustomAction {
  ...
  factory GetFirewallPolicyFirewallPolicyStatelessCustomAction.fromMap(Map<String, dynamic> map) {
    return GetFirewallPolicyFirewallPolicyStatelessCustomAction(
      actionDefinitions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetFirewallPolicyFirewallPolicyStatelessCustomActionActionDefinition>(map['actionDefinitions']!, (value) => GetFirewallPolicyFirewallPolicyStatelessCustomActionActionDefinition.fromMap((value as Map).cast<String, dynamic>()))),
