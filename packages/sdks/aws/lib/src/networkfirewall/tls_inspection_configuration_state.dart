...
class TlsInspectionConfigurationState {
  ...
  final pulumi.Input<List<TlsInspectionConfigurationCertificateAuthority>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'certificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<TlsInspectionConfigurationCertificate>,
            List<Map<String, dynamic>>
          >(
            certificates,
            (value) =>
  ...
  factory TlsInspectionConfigurationState.fromMap(Map<String, dynamic> map) {
    return TlsInspectionConfigurationState(
      ...
      certificateAuthorities: (() {
        final guardedValue = map['certificateAuthorities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<TlsInspectionConfigurationCertificateAuthority>(
            guardedValue,
            (value) => TlsInspectionConfigurationCertificateAuthority.fromMap(
      ...
      certificates: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<TlsInspectionConfigurationCertificate>(
            guardedValue,
            (value) => TlsInspectionConfigurationCertificate.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      numberOfAssociations: (() {
        final guardedValue = map['numberOfAssociations'];
        if (guardedValue == null) return null;
      ...
      tlsInspectionConfiguration: (() {
        final guardedValue = map['tlsInspectionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      tlsInspectionConfigurationId: (() {
        final guardedValue = map['tlsInspectionConfigurationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      updateToken: (() {
