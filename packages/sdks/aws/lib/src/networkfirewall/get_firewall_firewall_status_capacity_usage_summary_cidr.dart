...
class GetFirewallFirewallStatusCapacityUsageSummaryCidr {
  ...
  final pulumi.Input<
    List<GetFirewallFirewallStatusCapacityUsageSummaryCidrIpSetReference>
  >
  ipSetReferences;
  ...
  factory GetFirewallFirewallStatusCapacityUsageSummaryCidr.fromMap(
    ...
    return GetFirewallFirewallStatusCapacityUsageSummaryCidr(
      availableCidrCount: pulumi.Input.fromValue(
        map['availableCidrCount'] as int,
      ),
      ipSetReferences: pulumi.Input.fromValue(
      ...
      utilizedCidrCount: pulumi.Input.fromValue(
        map['utilizedCidrCount'] as int,
      ),
    );
  }
}
