...
class RuleGroupRuleGroupRulesSourceStatefulRule {
  ...
  final pulumi.Input<RuleGroupRuleGroupRulesSourceStatefulRuleHeader> header;
  /// Set of configuration blocks containing additional settings for a stateful rule. See Rule Option below for details.
  final pulumi.Input<List<RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption>> ruleOptions;
  ...
  const RuleGroupRuleGroupRulesSourceStatefulRule({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action,
      'header': pulumi.Input.mapInputValue<RuleGroupRuleGroupRulesSourceStatefulRuleHeader, Map<String, dynamic>>(header, (value) => value.toMap()),
      'ruleOptions': pulumi.Input.mapInputValue<List<RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption>, List<Map<String, dynamic>>>(ruleOptions, (value) => pulumi.Input.encodeList<RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory RuleGroupRuleGroupRulesSourceStatefulRule.fromMap(Map<String, dynamic> map) {
    return RuleGroupRuleGroupRulesSourceStatefulRule(
      ...
      header: pulumi.Input.fromValue(RuleGroupRuleGroupRulesSourceStatefulRuleHeader.fromMap((map['header']! as Map).cast<String, dynamic>())),
      ruleOptions: pulumi.Input.fromValue(pulumi.Input.decodeList<RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption>(map['ruleOptions']!, (value) => RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
