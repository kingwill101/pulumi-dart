...
class RuleGroupRuleGroupRulesSourceStatefulRule {
  ...
  final pulumi.Input<List<RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption>>
  ruleOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ruleOptions':
          pulumi.Input.mapInputValue<
            List<RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption>,
  ...
  factory RuleGroupRuleGroupRulesSourceStatefulRule.fromMap(
    ...
    return RuleGroupRuleGroupRulesSourceStatefulRule(
      ...
      header: pulumi.Input.fromValue(
        RuleGroupRuleGroupRulesSourceStatefulRuleHeader.fromMap(
          (map['header']! as Map).cast<String, dynamic>(),
        ),
      ),
      ruleOptions: pulumi.Input.fromValue(
