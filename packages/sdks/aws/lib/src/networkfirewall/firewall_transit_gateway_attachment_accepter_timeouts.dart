...
class FirewallTransitGatewayAttachmentAccepterTimeouts {
  ...
  /// Creates a new [FirewallTransitGatewayAttachmentAccepterTimeouts].
  ...
  const FirewallTransitGatewayAttachmentAccepterTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory FirewallTransitGatewayAttachmentAccepterTimeouts.fromMap(Map<String, dynamic> map) {
