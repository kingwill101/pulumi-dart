...
class FirewallPolicyFirewallPolicy {
  ...
  factory FirewallPolicyFirewallPolicy.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyFirewallPolicy(
      ...
      statefulRuleGroupReferences: (() { final guardedValue = map['statefulRuleGroupReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyFirewallPolicyStatefulRuleGroupReference>(guardedValue, (value) => FirewallPolicyFirewallPolicyStatefulRuleGroupReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
      statelessCustomActions: (() { final guardedValue = map['statelessCustomActions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyFirewallPolicyStatelessCustomAction>(guardedValue, (value) => FirewallPolicyFirewallPolicyStatelessCustomAction.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      statelessRuleGroupReferences: (() { final guardedValue = map['statelessRuleGroupReferences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirewallPolicyFirewallPolicyStatelessRuleGroupReference>(guardedValue, (value) => FirewallPolicyFirewallPolicyStatelessRuleGroupReference.fromMap((value as Map).cast<String, dynamic>()))); })(),
