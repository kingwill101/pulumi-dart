...
class WebAclLoggingConfigurationRedactedFields {
  ...
  final pulumi.Input<List<WebAclLoggingConfigurationRedactedFieldsFieldToMatch>>
  fieldToMatches;
  ...
  WebAclLoggingConfigurationRedactedFields({required this.fieldToMatches});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fieldToMatches':
          pulumi.Input.mapInputValue<
            List<WebAclLoggingConfigurationRedactedFieldsFieldToMatch>,
  ...
  factory WebAclLoggingConfigurationRedactedFields.fromMap(
    ...
    return WebAclLoggingConfigurationRedactedFields(
      fieldToMatches: pulumi.Input.fromValue(
