...
class WebAclLoggingConfiguration {
  ...
  /// [logDestination] ARN of Kinesis Firehose Delivery Stream
  ...
  factory WebAclLoggingConfiguration.fromMap(Map<String, dynamic> map) {
    return WebAclLoggingConfiguration(
      ...
      redactedFields: (() { final guardedValue = map['redactedFields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAclLoggingConfigurationRedactedFields.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
