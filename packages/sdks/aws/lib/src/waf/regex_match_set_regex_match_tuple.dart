...
class RegexMatchSetRegexMatchTuple {
  ...
  factory RegexMatchSetRegexMatchTuple.fromMap(Map<String, dynamic> map) {
    return RegexMatchSetRegexMatchTuple(
      fieldToMatch: pulumi.Input.fromValue(RegexMatchSetRegexMatchTupleFieldToMatch.fromMap((map['fieldToMatch']! as Map).cast<String, dynamic>())),
      regexPatternSetId: pulumi.Input.fromValue(map['regexPatternSetId'] as String),
