...
import 'domain_permissions_state.dart';
...
class DomainPermissions extends pulumi.CustomResource {
  ...
  /// Gets an existing [DomainPermissions] resource's state with the given [name] and [id].
  static DomainPermissions get(
    String name,
