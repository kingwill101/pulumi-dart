...
class GetOrganizationalUnitChildAccountsResult {
  ...
  /// [parentId] Optional.
  const GetOrganizationalUnitChildAccountsResult({
    this.accounts,
    this.id,
    this.parentId,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accounts': ?(() { final guardedValue = accounts; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetOrganizationalUnitChildAccountsAccount, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'id': ?id,
      'parentId': ?parentId,
    };
  }
  ...
  factory GetOrganizationalUnitChildAccountsResult.fromMap(Map<String, dynamic> map) {
    return GetOrganizationalUnitChildAccountsResult(
      accounts: (() { final guardedValue = map['accounts']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetOrganizationalUnitChildAccountsAccount>(guardedValue, (value) => GetOrganizationalUnitChildAccountsAccount.fromMap((value as Map).cast<String, dynamic>())); })(),
