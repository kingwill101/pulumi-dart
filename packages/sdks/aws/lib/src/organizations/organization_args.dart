  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      awsServiceAccessPrincipals: (() {
        final guardedValue = map['awsServiceAccessPrincipals'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      enabledPolicyTypes: (() {
        final guardedValue = map['enabledPolicyTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      featureSet: (() {
        final guardedValue = map['featureSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      returnOrganizationOnly: (() {
        final guardedValue = map['returnOrganizationOnly'];
        if (guardedValue == null) return null;
