...
class AccountState {
  ...
  factory AccountState.fromMap(Map<String, dynamic> map) {
    return AccountState(
      ...
      closeOnDeletion: (() {
        final guardedValue = map['closeOnDeletion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      createGovcloud: (() {
        final guardedValue = map['createGovcloud'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      email: (() {
      ...
      govcloudId: (() {
        final guardedValue = map['govcloudId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      iamUserAccessToBilling: (() {
        final guardedValue = map['iamUserAccessToBilling'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      joinedMethod: (() {
