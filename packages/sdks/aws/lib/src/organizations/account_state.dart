...
class AccountState {
  ...
  AccountState({
    ...
    pulumi.Output<String>? govcloudId,
    ...
    pulumi.Output<Map<String, String>>? tagsAll,
      ...
      govcloudId = pulumi.Input.asOptionalInput<String>(govcloudId),
  ...
  factory AccountState.fromMap(Map<String, dynamic> map) {
    return AccountState(
      ...
      govcloudId: map['govcloudId'] == null ? null : pulumi.Output.create<String>(map['govcloudId'] as String),
