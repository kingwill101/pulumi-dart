...
class OrganizationState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nonMasterAccounts':
          ?pulumi.Input.mapOptionalInputValue<
            List<OrganizationNonMasterAccount>,
            List<Map<String, dynamic>>
          >(
            nonMasterAccounts,
            (value) =>
      ...
      'roots':
          ?pulumi.Input.mapOptionalInputValue<
            List<OrganizationRoot>,
            List<Map<String, dynamic>>
          >(
            roots,
            (value) =>
                pulumi.Input.encodeList<OrganizationRoot, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return OrganizationState(
      accounts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OrganizationAccount>(
            guardedValue,
            (value) => OrganizationAccount.fromMap(
      ...
      masterAccountArn: (() {
        final guardedValue = map['masterAccountArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      masterAccountEmail: (() {
        final guardedValue = map['masterAccountEmail'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      masterAccountId: (() {
      ...
      nonMasterAccounts: (() {
        final guardedValue = map['nonMasterAccounts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OrganizationNonMasterAccount>(
            guardedValue,
            (value) => OrganizationNonMasterAccount.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      roots: (() {
        final guardedValue = map['roots'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OrganizationRoot>(
            guardedValue,
            (value) => OrganizationRoot.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
