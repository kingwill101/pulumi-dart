...
class ResourceConfigurationState {
  ...
  factory ResourceConfigurationState.fromMap(Map<String, dynamic> map) {
    return ResourceConfigurationState(
      ...
      domainVerificationArn: map['domainVerificationArn'] == null ? null : (map['domainVerificationArn'] as String).input(),
      domainVerificationId: map['domainVerificationId'] == null ? null : (map['domainVerificationId'] as String).input(),
      domainVerificationStatus: map['domainVerificationStatus'] == null ? null : (map['domainVerificationStatus'] as String).input(),
