...
import 'service_network_vpc_association_state.dart';
...
class ServiceNetworkVpcAssociation extends pulumi.CustomResource {
  ...
  ServiceNetworkVpcAssociation(
    ...
    this.dnsOptions = registerOutput<ServiceNetworkVpcAssociationDnsOptions?>('dnsOptions');
  ...
  /// Gets an existing [ServiceNetworkVpcAssociation] resource's state with the given [name] and [id].
  static ServiceNetworkVpcAssociation get(
    String name,
  ...
  ServiceNetworkVpcAssociation._get(
    String name, {
