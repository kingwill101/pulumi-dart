...
class ListenerRuleMatchHttpMatch {
  ...
  final pulumi.Input<List<ListenerRuleMatchHttpMatchHeaderMatch>>?
  headerMatches;
    ...
    return <String, dynamic>{
      'headerMatches':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListenerRuleMatchHttpMatchHeaderMatch>,
  ...
  factory ListenerRuleMatchHttpMatch.fromMap(Map<String, dynamic> map) {
    return ListenerRuleMatchHttpMatch(
      ...
      pathMatch: (() {
        final guardedValue = map['pathMatch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
