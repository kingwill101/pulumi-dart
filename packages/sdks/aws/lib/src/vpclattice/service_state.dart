    ...
    return <String, dynamic>{
      ...
      'dnsEntries':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceDnsEntry>,
            List<Map<String, dynamic>>
          >(
            dnsEntries,
            (value) =>
                pulumi.Input.encodeList<ServiceDnsEntry, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ServiceState(
      ...
      dnsEntries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceDnsEntry>(
            guardedValue,
            (value) =>
                ServiceDnsEntry.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
