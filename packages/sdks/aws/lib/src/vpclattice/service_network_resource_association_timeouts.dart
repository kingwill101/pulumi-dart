...
class ServiceNetworkResourceAssociationTimeouts {
  ...
  /// Creates a new [ServiceNetworkResourceAssociationTimeouts].
  ...
  const ServiceNetworkResourceAssociationTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory ServiceNetworkResourceAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return ServiceNetworkResourceAssociationTimeouts(
