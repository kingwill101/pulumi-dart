...
class ResourceGatewayTimeouts {
  ...
  /// Creates a new [ResourceGatewayTimeouts].
  ...
  ResourceGatewayTimeouts({this.create, this.delete, this.update});
  ...
  factory ResourceGatewayTimeouts.fromMap(Map<String, dynamic> map) {
    return ResourceGatewayTimeouts(
      create: (() {
