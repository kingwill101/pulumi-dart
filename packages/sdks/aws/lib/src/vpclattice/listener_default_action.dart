...
class ListenerDefaultAction {
  ...
  factory ListenerDefaultAction.fromMap(Map<String, dynamic> map) {
    return ListenerDefaultAction(
      ...
      forwards: (() { final guardedValue = map['forwards']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ListenerDefaultActionForward>(guardedValue, (value) => ListenerDefaultActionForward.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
