...
class ServiceNetworkResourceAssociationState {
  ...
  final pulumi.Input<List<ServiceNetworkResourceAssociationDnsEntry>>?
  dnsEntries;
    ...
    return <String, dynamic>{
      ...
      'dnsEntries':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceNetworkResourceAssociationDnsEntry>,
  ...
  factory ServiceNetworkResourceAssociationState.fromMap(
    ...
    return ServiceNetworkResourceAssociationState(
      ...
      dnsEntries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceNetworkResourceAssociationDnsEntry>(
            guardedValue,
            (value) => ServiceNetworkResourceAssociationDnsEntry.fromMap(
      ...
      resourceConfigurationIdentifier: (() {
        final guardedValue = map['resourceConfigurationIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
