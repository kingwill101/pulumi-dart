...
class UserPoolClientState {
  ...
  factory UserPoolClientState.fromMap(Map<String, dynamic> map) {
    return UserPoolClientState(
      accessTokenValidity: map['accessTokenValidity'] == null ? null : (map['accessTokenValidity'] as int).input(),
      allowedOauthFlows: map['allowedOauthFlows'] == null ? null : ((map['allowedOauthFlows'] as List).cast<String>()).input(),
      allowedOauthFlowsUserPoolClient: map['allowedOauthFlowsUserPoolClient'] == null ? null : (map['allowedOauthFlowsUserPoolClient'] as bool).input(),
      allowedOauthScopes: map['allowedOauthScopes'] == null ? null : ((map['allowedOauthScopes'] as List).cast<String>()).input(),
      analyticsConfiguration: map['analyticsConfiguration'] == null ? null : (UserPoolClientAnalyticsConfiguration.fromMap((map['analyticsConfiguration'] as Map).cast<String, dynamic>())).input(),
      authSessionValidity: map['authSessionValidity'] == null ? null : (map['authSessionValidity'] as int).input(),
      callbackUrls: map['callbackUrls'] == null ? null : ((map['callbackUrls'] as List).cast<String>()).input(),
      clientSecret: map['clientSecret'] == null ? null : (map['clientSecret'] as String).input(),
      defaultRedirectUri: map['defaultRedirectUri'] == null ? null : (map['defaultRedirectUri'] as String).input(),
      enablePropagateAdditionalUserContextData: map['enablePropagateAdditionalUserContextData'] == null ? null : (map['enablePropagateAdditionalUserContextData'] as bool).input(),
      enableTokenRevocation: map['enableTokenRevocation'] == null ? null : (map['enableTokenRevocation'] as bool).input(),
      explicitAuthFlows: map['explicitAuthFlows'] == null ? null : ((map['explicitAuthFlows'] as List).cast<String>()).input(),
      generateSecret: map['generateSecret'] == null ? null : (map['generateSecret'] as bool).input(),
      idTokenValidity: map['idTokenValidity'] == null ? null : (map['idTokenValidity'] as int).input(),
      logoutUrls: map['logoutUrls'] == null ? null : ((map['logoutUrls'] as List).cast<String>()).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      preventUserExistenceErrors: map['preventUserExistenceErrors'] == null ? null : (map['preventUserExistenceErrors'] as String).input(),
      readAttributes: map['readAttributes'] == null ? null : ((map['readAttributes'] as List).cast<String>()).input(),
      refreshTokenRotation: map['refreshTokenRotation'] == null ? null : (UserPoolClientRefreshTokenRotation.fromMap((map['refreshTokenRotation'] as Map).cast<String, dynamic>())).input(),
      refreshTokenValidity: map['refreshTokenValidity'] == null ? null : (map['refreshTokenValidity'] as int).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      supportedIdentityProviders: map['supportedIdentityProviders'] == null ? null : ((map['supportedIdentityProviders'] as List).cast<String>()).input(),
      tokenValidityUnits: map['tokenValidityUnits'] == null ? null : (UserPoolClientTokenValidityUnits.fromMap((map['tokenValidityUnits'] as Map).cast<String, dynamic>())).input(),
      userPoolId: map['userPoolId'] == null ? null : (map['userPoolId'] as String).input(),
      writeAttributes: map['writeAttributes'] == null ? null : ((map['writeAttributes'] as List).cast<String>()).input(),
    );
  }
}
