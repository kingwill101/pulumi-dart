...
class UserPoolEmailConfiguration {
  ...
  factory UserPoolEmailConfiguration.fromMap(Map<String, dynamic> map) {
    return UserPoolEmailConfiguration(
      configurationSet: (() {
        final guardedValue = map['configurationSet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emailSendingAccount: (() {
        final guardedValue = map['emailSendingAccount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fromEmailAddress: (() {
        final guardedValue = map['fromEmailAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      replyToEmailAddress: (() {
        final guardedValue = map['replyToEmailAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceArn: (() {
