...
class RiskConfigurationRiskExceptionConfiguration {
  ...
  factory RiskConfigurationRiskExceptionConfiguration.fromMap(Map<String, dynamic> map) {
    return RiskConfigurationRiskExceptionConfiguration(
      blockedIpRangeLists: (() { final guardedValue = map['blockedIpRangeLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      skippedIpRangeLists: (() { final guardedValue = map['skippedIpRangeLists']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
