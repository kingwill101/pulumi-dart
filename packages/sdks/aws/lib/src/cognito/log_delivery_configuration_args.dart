...
class LogDeliveryConfigurationArgs {
  ...
  factory LogDeliveryConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return LogDeliveryConfigurationArgs(
      logConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<LogDeliveryConfigurationLogConfiguration>(map['logConfigurations']!, (value) => LogDeliveryConfigurationLogConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
