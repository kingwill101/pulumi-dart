...
class RiskConfigurationState {
  ...
  factory RiskConfigurationState.fromMap(Map<String, dynamic> map) {
    return RiskConfigurationState(
      accountTakeoverRiskConfiguration: (() {
        final guardedValue = map['accountTakeoverRiskConfiguration'];
      ...
      compromisedCredentialsRiskConfiguration: (() {
        final guardedValue = map['compromisedCredentialsRiskConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      riskExceptionConfiguration: (() {
        final guardedValue = map['riskExceptionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
