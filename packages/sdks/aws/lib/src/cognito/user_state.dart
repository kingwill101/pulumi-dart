...
class UserState {
  ...
  factory UserState.fromMap(Map<String, dynamic> map) {
    return UserState(
      ...
      mfaSettingLists: map['mfaSettingLists'] == null ? null : (((map['mfaSettingLists'] as List).cast<String>()).input()).input(),
      password: map['password'] == null ? null : ((map['password'] as String).input()).input(),
      preferredMfaSetting: map['preferredMfaSetting'] == null ? null : ((map['preferredMfaSetting'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      status: map['status'] == null ? null : ((map['status'] as String).input()).input(),
      sub: map['sub'] == null ? null : ((map['sub'] as String).input()).input(),
