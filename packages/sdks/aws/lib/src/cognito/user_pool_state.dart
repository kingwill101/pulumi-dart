...
class UserPoolState {
  ...
  factory UserPoolState.fromMap(Map<String, dynamic> map) {
    return UserPoolState(
      ...
      customDomain: map['customDomain'] == null ? null : ((map['customDomain'] as String).input()).input(),
      ...
      estimatedNumberOfUsers: map['estimatedNumberOfUsers'] == null ? null : ((map['estimatedNumberOfUsers'] as int).input()).input(),
