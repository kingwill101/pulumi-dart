...
class UserPoolState {
  ...
  UserPoolState({
    ...
    pulumi.Output<int>? estimatedNumberOfUsers,
    ...
    pulumi.Output<UserPoolWebAuthnConfiguration>? webAuthnConfiguration,
      ...
      estimatedNumberOfUsers = pulumi.Input.asOptionalInput<int>(estimatedNumberOfUsers),
  ...
  factory UserPoolState.fromMap(Map<String, dynamic> map) {
    return UserPoolState(
      ...
      estimatedNumberOfUsers: map['estimatedNumberOfUsers'] == null ? null : pulumi.Output.create<int>(map['estimatedNumberOfUsers'] as int),
