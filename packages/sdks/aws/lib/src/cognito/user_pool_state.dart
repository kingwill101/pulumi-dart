...
class UserPoolState {
  ...
  factory UserPoolState.fromMap(Map<String, dynamic> map) {
    return UserPoolState(
      accountRecoverySetting: map['accountRecoverySetting'] == null ? null : (UserPoolAccountRecoverySetting.fromMap((map['accountRecoverySetting'] as Map).cast<String, dynamic>())).input(),
      adminCreateUserConfig: map['adminCreateUserConfig'] == null ? null : (UserPoolAdminCreateUserConfig.fromMap((map['adminCreateUserConfig'] as Map).cast<String, dynamic>())).input(),
      aliasAttributes: map['aliasAttributes'] == null ? null : ((map['aliasAttributes'] as List).cast<String>()).input(),
      arn: map['arn'] == null ? null : (map['arn'] as String).input(),
      autoVerifiedAttributes: map['autoVerifiedAttributes'] == null ? null : ((map['autoVerifiedAttributes'] as List).cast<String>()).input(),
      ...
      deviceConfiguration: map['deviceConfiguration'] == null ? null : (UserPoolDeviceConfiguration.fromMap((map['deviceConfiguration'] as Map).cast<String, dynamic>())).input(),
      domain: map['domain'] == null ? null : (map['domain'] as String).input(),
      emailConfiguration: map['emailConfiguration'] == null ? null : (UserPoolEmailConfiguration.fromMap((map['emailConfiguration'] as Map).cast<String, dynamic>())).input(),
      emailMfaConfiguration: map['emailMfaConfiguration'] == null ? null : (UserPoolEmailMfaConfiguration.fromMap((map['emailMfaConfiguration'] as Map).cast<String, dynamic>())).input(),
      emailVerificationMessage: map['emailVerificationMessage'] == null ? null : (map['emailVerificationMessage'] as String).input(),
      emailVerificationSubject: map['emailVerificationSubject'] == null ? null : (map['emailVerificationSubject'] as String).input(),
      endpoint: map['endpoint'] == null ? null : (map['endpoint'] as String).input(),
      estimatedNumberOfUsers: map['estimatedNumberOfUsers'] == null ? null : (map['estimatedNumberOfUsers'] as int).input(),
      lambdaConfig: map['lambdaConfig'] == null ? null : (UserPoolLambdaConfig.fromMap((map['lambdaConfig'] as Map).cast<String, dynamic>())).input(),
      lastModifiedDate: map['lastModifiedDate'] == null ? null : (map['lastModifiedDate'] as String).input(),
      mfaConfiguration: map['mfaConfiguration'] == null ? null : (map['mfaConfiguration'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      passwordPolicy: map['passwordPolicy'] == null ? null : (UserPoolPasswordPolicy.fromMap((map['passwordPolicy'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      schemas: map['schemas'] == null ? null : (pulumi.Input.decodeList<UserPoolSchema>(map['schemas'], (value) => UserPoolSchema.fromMap((value as Map).cast<String, dynamic>()))).input(),
      signInPolicy: map['signInPolicy'] == null ? null : (UserPoolSignInPolicy.fromMap((map['signInPolicy'] as Map).cast<String, dynamic>())).input(),
      smsAuthenticationMessage: map['smsAuthenticationMessage'] == null ? null : (map['smsAuthenticationMessage'] as String).input(),
      smsConfiguration: map['smsConfiguration'] == null ? null : (UserPoolSmsConfiguration.fromMap((map['smsConfiguration'] as Map).cast<String, dynamic>())).input(),
      smsVerificationMessage: map['smsVerificationMessage'] == null ? null : (map['smsVerificationMessage'] as String).input(),
      softwareTokenMfaConfiguration: map['softwareTokenMfaConfiguration'] == null ? null : (UserPoolSoftwareTokenMfaConfiguration.fromMap((map['softwareTokenMfaConfiguration'] as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      userAttributeUpdateSettings: map['userAttributeUpdateSettings'] == null ? null : (UserPoolUserAttributeUpdateSettings.fromMap((map['userAttributeUpdateSettings'] as Map).cast<String, dynamic>())).input(),
      userPoolAddOns: map['userPoolAddOns'] == null ? null : (UserPoolUserPoolAddOns.fromMap((map['userPoolAddOns'] as Map).cast<String, dynamic>())).input(),
      userPoolTier: map['userPoolTier'] == null ? null : (map['userPoolTier'] as String).input(),
      usernameAttributes: map['usernameAttributes'] == null ? null : ((map['usernameAttributes'] as List).cast<String>()).input(),
      usernameConfiguration: map['usernameConfiguration'] == null ? null : (UserPoolUsernameConfiguration.fromMap((map['usernameConfiguration'] as Map).cast<String, dynamic>())).input(),
      verificationMessageTemplate: map['verificationMessageTemplate'] == null ? null : (UserPoolVerificationMessageTemplate.fromMap((map['verificationMessageTemplate'] as Map).cast<String, dynamic>())).input(),
      webAuthnConfiguration: map['webAuthnConfiguration'] == null ? null : (UserPoolWebAuthnConfiguration.fromMap((map['webAuthnConfiguration'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
