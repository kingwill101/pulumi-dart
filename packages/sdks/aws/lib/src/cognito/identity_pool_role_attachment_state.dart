...
class IdentityPoolRoleAttachmentState {
  ...
  const IdentityPoolRoleAttachmentState({
    this.identityPoolId,
    this.region,
    this.roleMappings,
    this.roles,
  ...
  factory IdentityPoolRoleAttachmentState.fromMap(Map<String, dynamic> map) {
    return IdentityPoolRoleAttachmentState(
      ...
      roles: (() { final guardedValue = map['roles']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
    );
  }
}
