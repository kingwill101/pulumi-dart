...
class IdentityPoolRoleAttachmentRoleMapping {
  ...
  final pulumi.Input<List<IdentityPoolRoleAttachmentRoleMappingMappingRule>>?
  mappingRules;
    ...
    return <String, dynamic>{
      ...
      'mappingRules':
          ?pulumi.Input.mapOptionalInputValue<
            List<IdentityPoolRoleAttachmentRoleMappingMappingRule>,
  ...
  factory IdentityPoolRoleAttachmentRoleMapping.fromMap(
    ...
    return IdentityPoolRoleAttachmentRoleMapping(
      ambiguousRoleResolution: (() {
        final guardedValue = map['ambiguousRoleResolution'];
      ...
      mappingRules: (() {
        final guardedValue = map['mappingRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => IdentityPoolRoleAttachmentRoleMappingMappingRule.fromMap(
