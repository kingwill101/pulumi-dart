...
class ManagedUserPoolClient extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ManagedUserPoolClientRefreshTokenRotation?> refreshTokenRotation;
  ...
  ManagedUserPoolClient(
    ...
    this.allowedOauthFlowsUserPoolClient = registerOutput<bool>('allowedOauthFlowsUserPoolClient');
    this.allowedOauthScopes = registerOutput<List<String>>('allowedOauthScopes');
    this.analyticsConfiguration = registerOutput<ManagedUserPoolClientAnalyticsConfiguration?>('analyticsConfiguration');
    ...
    this.enablePropagateAdditionalUserContextData = registerOutput<bool>('enablePropagateAdditionalUserContextData');
    ...
    this.preventUserExistenceErrors = registerOutput<String>('preventUserExistenceErrors');
    this.readAttributes = registerOutput<List<String>>('readAttributes');
    this.refreshTokenRotation = registerOutput<ManagedUserPoolClientRefreshTokenRotation?>('refreshTokenRotation');
    this.refreshTokenValidity = registerOutput<int>('refreshTokenValidity');
    this.region = registerOutput<String>('region');
    this.supportedIdentityProviders = registerOutput<List<String>>('supportedIdentityProviders');
    this.tokenValidityUnits = registerOutput<ManagedUserPoolClientTokenValidityUnits?>('tokenValidityUnits');
