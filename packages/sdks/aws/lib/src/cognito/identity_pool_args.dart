...
class IdentityPoolArgs {
  ...
  factory IdentityPoolArgs.fromMap(Map<String, dynamic> map) {
    return IdentityPoolArgs(
      allowClassicFlow: (() {
        final guardedValue = map['allowClassicFlow'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      allowUnauthenticatedIdentities: (() {
        final guardedValue = map['allowUnauthenticatedIdentities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      cognitoIdentityProviders: (() {
        final guardedValue = map['cognitoIdentityProviders'];
        if (guardedValue == null) return null;
      ...
      developerProviderName: (() {
        final guardedValue = map['developerProviderName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      identityPoolName: pulumi.Input.fromValue(
        map['identityPoolName'] as String,
      ),
      openidConnectProviderArns: (() {
        final guardedValue = map['openidConnectProviderArns'];
        if (guardedValue == null) return null;
      ...
      samlProviderArns: (() {
        final guardedValue = map['samlProviderArns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      supportedLoginProviders: (() {
        final guardedValue = map['supportedLoginProviders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
