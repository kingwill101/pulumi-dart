...
class GetUserPoolUserPoolAddOn {
  ...
  factory GetUserPoolUserPoolAddOn.fromMap(Map<String, dynamic> map) {
    return GetUserPoolUserPoolAddOn(
      advancedSecurityAdditionalFlows: pulumi.Input.fromValue(pulumi.Input.decodeList<GetUserPoolUserPoolAddOnAdvancedSecurityAdditionalFlow>(map['advancedSecurityAdditionalFlows']!, (value) => GetUserPoolUserPoolAddOnAdvancedSecurityAdditionalFlow.fromMap((value as Map).cast<String, dynamic>()))),
