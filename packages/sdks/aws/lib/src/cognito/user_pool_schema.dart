...
class UserPoolSchema {
  ...
  final pulumi.Input<UserPoolSchemaNumberAttributeConstraints>?
  ...
  final pulumi.Input<UserPoolSchemaStringAttributeConstraints>?
  ...
  factory UserPoolSchema.fromMap(Map<String, dynamic> map) {
    return UserPoolSchema(
      ...
      developerOnlyAttribute: (() {
        final guardedValue = map['developerOnlyAttribute'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      mutable: (() {
        final guardedValue = map['mutable'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      numberAttributeConstraints: (() {
        final guardedValue = map['numberAttributeConstraints'];
        if (guardedValue == null) return null;
      ...
      stringAttributeConstraints: (() {
        final guardedValue = map['stringAttributeConstraints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
