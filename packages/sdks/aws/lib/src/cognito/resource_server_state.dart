...
class ResourceServerState {
  ...
  factory ResourceServerState.fromMap(Map<String, dynamic> map) {
    return ResourceServerState(
      ...
      scopeIdentifiers: (() { final guardedValue = map['scopeIdentifiers']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
