...
class GetUserPoolAdminCreateUserConfig {
  ...
  final pulumi.Input<
    List<GetUserPoolAdminCreateUserConfigInviteMessageTemplate>
  >
  ...
  factory GetUserPoolAdminCreateUserConfig.fromMap(Map<String, dynamic> map) {
    return GetUserPoolAdminCreateUserConfig(
      allowAdminCreateUserOnly: pulumi.Input.fromValue(
        map['allowAdminCreateUserOnly'] as bool,
      ),
      inviteMessageTemplates: pulumi.Input.fromValue(
      ...
      unusedAccountValidityDays: pulumi.Input.fromValue(
        map['unusedAccountValidityDays'] as int,
      ),
    );
  }
}
