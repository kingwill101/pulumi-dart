...
class UserPoolPasswordPolicy {
  ...
  factory UserPoolPasswordPolicy.fromMap(Map<String, dynamic> map) {
    return UserPoolPasswordPolicy(
      minimumLength: (() {
        final guardedValue = map['minimumLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      passwordHistorySize: (() {
        final guardedValue = map['passwordHistorySize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      requireLowercase: (() {
        final guardedValue = map['requireLowercase'];
        if (guardedValue == null) return null;
      ...
      requireUppercase: (() {
        final guardedValue = map['requireUppercase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      temporaryPasswordValidityDays: (() {
        final guardedValue = map['temporaryPasswordValidityDays'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
