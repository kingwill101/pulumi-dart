...
class LogDeliveryConfigurationLogConfiguration {
  ...
  final pulumi.Input<LogDeliveryConfigurationLogConfigurationS3Configuration>?
  s3Configuration;
    ...
    return <String, dynamic>{
      ...
      'firehoseConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            LogDeliveryConfigurationLogConfigurationFirehoseConfiguration,
            Map<String, dynamic>
          >(firehoseConfiguration, (value) => value.toMap()),
      'logLevel': logLevel,
      's3Configuration':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory LogDeliveryConfigurationLogConfiguration.fromMap(
    ...
    return LogDeliveryConfigurationLogConfiguration(
      ...
      firehoseConfiguration: (() {
        final guardedValue = map['firehoseConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
