...
class GetUserPoolResult {
  ...
  factory GetUserPoolResult.fromMap(Map<String, dynamic> map) {
    return GetUserPoolResult(
      ...
      estimatedNumberOfUsers: (() { final guardedValue = map['estimatedNumberOfUsers']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
