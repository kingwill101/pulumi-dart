...
class ManagedUserPoolClientState {
  ...
  factory ManagedUserPoolClientState.fromMap(Map<String, dynamic> map) {
    return ManagedUserPoolClientState(
      ...
      analyticsConfiguration: map['analyticsConfiguration'] == null ? null : ((ManagedUserPoolClientAnalyticsConfiguration.fromMap((map['analyticsConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      namePattern: map['namePattern'] == null ? null : ((map['namePattern'] as String).input()).input(),
      ...
      refreshTokenRotation: map['refreshTokenRotation'] == null ? null : ((ManagedUserPoolClientRefreshTokenRotation.fromMap((map['refreshTokenRotation']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      tokenValidityUnits: map['tokenValidityUnits'] == null ? null : ((ManagedUserPoolClientTokenValidityUnits.fromMap((map['tokenValidityUnits']! as Map).cast<String, dynamic>())).input()).input(),
