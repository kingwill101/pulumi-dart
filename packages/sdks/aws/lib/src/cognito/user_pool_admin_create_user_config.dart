...
class UserPoolAdminCreateUserConfig {
  ...
  final pulumi.Input<UserPoolAdminCreateUserConfigInviteMessageTemplate>?
    ...
    return <String, dynamic>{
      ...
      'inviteMessageTemplate':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(inviteMessageTemplate, (value) => value.toMap()),
    };
  }
  ...
  factory UserPoolAdminCreateUserConfig.fromMap(Map<String, dynamic> map) {
    return UserPoolAdminCreateUserConfig(
      allowAdminCreateUserOnly: (() {
        final guardedValue = map['allowAdminCreateUserOnly'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      inviteMessageTemplate: (() {
        final guardedValue = map['inviteMessageTemplate'];
        if (guardedValue == null) return null;
