...
class RiskConfigurationAccountTakeoverRiskConfiguration {
  ...
  factory RiskConfigurationAccountTakeoverRiskConfiguration.fromMap(Map<String, dynamic> map) {
    return RiskConfigurationAccountTakeoverRiskConfiguration(
      actions: pulumi.Input.fromValue(RiskConfigurationAccountTakeoverRiskConfigurationActions.fromMap((map['actions']! as Map).cast<String, dynamic>())),
      notifyConfiguration: (() { final guardedValue = map['notifyConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
