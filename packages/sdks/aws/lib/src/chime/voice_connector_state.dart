...
class VoiceConnectorState {
  ...
  factory VoiceConnectorState.fromMap(Map<String, dynamic> map) {
    return VoiceConnectorState(
      ...
      outboundHostName: (() { final guardedValue = map['outboundHostName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      requireEncryption: (() { final guardedValue = map['requireEncryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
