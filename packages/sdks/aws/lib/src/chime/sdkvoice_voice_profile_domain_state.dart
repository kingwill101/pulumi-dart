...
class SdkvoiceVoiceProfileDomainState {
  ...
  factory SdkvoiceVoiceProfileDomainState.fromMap(Map<String, dynamic> map) {
    return SdkvoiceVoiceProfileDomainState(
      ...
      serverSideEncryptionConfiguration: map['serverSideEncryptionConfiguration'] == null ? null : ((SdkvoiceVoiceProfileDomainServerSideEncryptionConfiguration.fromMap((map['serverSideEncryptionConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
