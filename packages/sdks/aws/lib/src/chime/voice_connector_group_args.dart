...
class VoiceConnectorGroupArgs {
  ...
  VoiceConnectorGroupArgs({
    pulumi.Output<List<VoiceConnectorGroupConnector>>? connectors,
  ...
  factory VoiceConnectorGroupArgs.fromMap(Map<String, dynamic> map) {
    return VoiceConnectorGroupArgs(
      connectors: map['connectors'] == null ? null : pulumi.Output.create<List<VoiceConnectorGroupConnector>>(pulumi.Input.decodeList<VoiceConnectorGroupConnector>(map['connectors'], (value) => VoiceConnectorGroupConnector.fromMap((value as Map).cast<String, dynamic>()))),
