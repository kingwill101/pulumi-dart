...
class VoiceConnectorGroupArgs {
  ...
  factory VoiceConnectorGroupArgs.fromMap(Map<String, dynamic> map) {
    return VoiceConnectorGroupArgs(
      connectors: (() { final guardedValue = map['connectors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VoiceConnectorGroupConnector>(guardedValue, (value) => VoiceConnectorGroupConnector.fromMap((value as Map).cast<String, dynamic>()))); })(),
