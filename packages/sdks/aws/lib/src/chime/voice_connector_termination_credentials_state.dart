...
class VoiceConnectorTerminationCredentialsState {
  ...
  factory VoiceConnectorTerminationCredentialsState.fromMap(Map<String, dynamic> map) {
    return VoiceConnectorTerminationCredentialsState(
      credentials: (() { final guardedValue = map['credentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<VoiceConnectorTerminationCredentialsCredential>(guardedValue, (value) => VoiceConnectorTerminationCredentialsCredential.fromMap((value as Map).cast<String, dynamic>()))); })(),
