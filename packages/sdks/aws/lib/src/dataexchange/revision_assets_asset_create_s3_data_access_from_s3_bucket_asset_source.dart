...
class RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSource {
  ...
  final List<RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceKmsKeysToGrant>? kmsKeysToGrants;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'keys': ?keys,
      'kmsKeysToGrants': ?kmsKeysToGrants == null ? null : pulumi.Input.encodeList<RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceKmsKeysToGrant, Map<String, dynamic>>(kmsKeysToGrants!, (value) => value.toMap()),
    };
  }
  ...
  factory RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSource.fromMap(Map<String, dynamic> map) {
    return RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSource(
      ...
      kmsKeysToGrants: map['kmsKeysToGrants'] == null ? null : pulumi.Input.decodeList<RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceKmsKeysToGrant>(map['kmsKeysToGrants'], (value) => RevisionAssetsAssetCreateS3DataAccessFromS3BucketAssetSourceKmsKeysToGrant.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
