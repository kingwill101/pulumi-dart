...
class RevisionAssetsAsset {
  ...
  final pulumi.Input<RevisionAssetsAssetCreateS3DataAccessFromS3Bucket>?
  ...
  final pulumi.Input<RevisionAssetsAssetImportAssetsFromSignedUrl>?
    ...
    return <String, dynamic>{
      ...
      'createS3DataAccessFromS3Bucket':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(createS3DataAccessFromS3Bucket, (value) => value.toMap()),
      'createdAt': ?createdAt,
      'id': ?id,
      'importAssetsFromS3':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(importAssetsFromS3, (value) => value.toMap()),
      'importAssetsFromSignedUrl':
          ?pulumi.Input.mapOptionalInputValue<
            RevisionAssetsAssetImportAssetsFromSignedUrl,
            Map<String, dynamic>
          >(importAssetsFromSignedUrl, (value) => value.toMap()),
      'name': ?name,
      'updatedAt': ?updatedAt,
    };
  }
  ...
  factory RevisionAssetsAsset.fromMap(Map<String, dynamic> map) {
    return RevisionAssetsAsset(
      ...
      createS3DataAccessFromS3Bucket: (() {
        final guardedValue = map['createS3DataAccessFromS3Bucket'];
        if (guardedValue == null) return null;
      ...
      importAssetsFromS3: (() {
        final guardedValue = map['importAssetsFromS3'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      importAssetsFromSignedUrl: (() {
        final guardedValue = map['importAssetsFromSignedUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
