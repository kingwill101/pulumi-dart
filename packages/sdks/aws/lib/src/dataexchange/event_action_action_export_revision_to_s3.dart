...
class EventActionActionExportRevisionToS3 {
  ...
  factory EventActionActionExportRevisionToS3.fromMap(Map<String, dynamic> map) {
    return EventActionActionExportRevisionToS3(
      encryption: (() { final guardedValue = map['encryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventActionActionExportRevisionToS3Encryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      revisionDestination: pulumi.Input.fromValue(EventActionActionExportRevisionToS3RevisionDestination.fromMap((map['revisionDestination']! as Map).cast<String, dynamic>())),
    );
  }
}
