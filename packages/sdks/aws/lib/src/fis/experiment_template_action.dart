...
class ExperimentTemplateAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': name,
      'parameters': ?parameters == null ? null : pulumi.Input.encodeList<ExperimentTemplateActionParameter, Map<String, dynamic>>(parameters!, (value) => value.toMap()),
  ...
  factory ExperimentTemplateAction.fromMap(Map<String, dynamic> map) {
    return ExperimentTemplateAction(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeList<ExperimentTemplateActionParameter>(map['parameters'], (value) => ExperimentTemplateActionParameter.fromMap((value as Map).cast<String, dynamic>())),
      startAfters: map['startAfters'] == null ? null : (map['startAfters'] as List).cast<String>(),
      target: map['target'] == null ? null : ExperimentTemplateActionTarget.fromMap((map['target'] as Map).cast<String, dynamic>()),
    );
  }
}
