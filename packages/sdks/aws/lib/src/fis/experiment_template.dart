...
class ExperimentTemplate extends pulumi.CustomResource {
  ...
  ExperimentTemplate(
    ...
    this.experimentOptions = registerOutput<ExperimentTemplateExperimentOptions>('experimentOptions');
    this.experimentReportConfiguration = registerOutput<ExperimentTemplateExperimentReportConfiguration?>('experimentReportConfiguration');
    this.logConfiguration = registerOutput<ExperimentTemplateLogConfiguration?>('logConfiguration');
    this.region = registerOutput<String>('region');
    this.roleArn = registerOutput<String>('roleArn');
    this.stopConditions = registerOutput<List<ExperimentTemplateStopCondition>>('stopConditions');
