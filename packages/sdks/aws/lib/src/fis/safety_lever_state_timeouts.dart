...
class SafetyLeverStateTimeouts {
  ...
  const SafetyLeverStateTimeouts({
    this.create,
    this.update,
  });
  ...
  factory SafetyLeverStateTimeouts.fromMap(Map<String, dynamic> map) {
    return SafetyLeverStateTimeouts(
