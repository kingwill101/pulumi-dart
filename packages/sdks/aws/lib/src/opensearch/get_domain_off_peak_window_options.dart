...
class GetDomainOffPeakWindowOptions {
  ...
  final pulumi.Input<List<GetDomainOffPeakWindowOptionsOffPeakWindow>>
  offPeakWindows;
    ...
    return <String, dynamic>{
      ...
      'offPeakWindows':
          pulumi.Input.mapInputValue<
            List<GetDomainOffPeakWindowOptionsOffPeakWindow>,
  ...
  factory GetDomainOffPeakWindowOptions.fromMap(Map<String, dynamic> map) {
    return GetDomainOffPeakWindowOptions(
      ...
      offPeakWindows: pulumi.Input.fromValue(
