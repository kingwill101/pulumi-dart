...
class DomainArgs {
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      accessPolicies: map['accessPolicies'] == null ? null : ((map['accessPolicies'] as String).input()).input(),
      advancedOptions: map['advancedOptions'] == null ? null : (((map['advancedOptions'] as Map).cast<String, String>()).input()).input(),
      advancedSecurityOptions: map['advancedSecurityOptions'] == null ? null : ((DomainAdvancedSecurityOptions.fromMap((map['advancedSecurityOptions']! as Map).cast<String, dynamic>())).input()).input(),
      aimlOptions: map['aimlOptions'] == null ? null : ((DomainAimlOptions.fromMap((map['aimlOptions']! as Map).cast<String, dynamic>())).input()).input(),
      autoTuneOptions: map['autoTuneOptions'] == null ? null : ((DomainAutoTuneOptions.fromMap((map['autoTuneOptions']! as Map).cast<String, dynamic>())).input()).input(),
      clusterConfig: map['clusterConfig'] == null ? null : ((DomainClusterConfig.fromMap((map['clusterConfig']! as Map).cast<String, dynamic>())).input()).input(),
      cognitoOptions: map['cognitoOptions'] == null ? null : ((DomainCognitoOptions.fromMap((map['cognitoOptions']! as Map).cast<String, dynamic>())).input()).input(),
      domainEndpointOptions: map['domainEndpointOptions'] == null ? null : ((DomainDomainEndpointOptions.fromMap((map['domainEndpointOptions']! as Map).cast<String, dynamic>())).input()).input(),
      domainName: map['domainName'] == null ? null : ((map['domainName'] as String).input()).input(),
      ebsOptions: map['ebsOptions'] == null ? null : ((DomainEbsOptions.fromMap((map['ebsOptions']! as Map).cast<String, dynamic>())).input()).input(),
      encryptAtRest: map['encryptAtRest'] == null ? null : ((DomainEncryptAtRest.fromMap((map['encryptAtRest']! as Map).cast<String, dynamic>())).input()).input(),
      engineVersion: map['engineVersion'] == null ? null : ((map['engineVersion'] as String).input()).input(),
      identityCenterOptions: map['identityCenterOptions'] == null ? null : ((DomainIdentityCenterOptions.fromMap((map['identityCenterOptions']! as Map).cast<String, dynamic>())).input()).input(),
      ipAddressType: map['ipAddressType'] == null ? null : ((map['ipAddressType'] as String).input()).input(),
      logPublishingOptions: map['logPublishingOptions'] == null ? null : ((pulumi.Input.decodeList<DomainLogPublishingOption>(map['logPublishingOptions']!, (value) => DomainLogPublishingOption.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      nodeToNodeEncryption: map['nodeToNodeEncryption'] == null ? null : ((DomainNodeToNodeEncryption.fromMap((map['nodeToNodeEncryption']! as Map).cast<String, dynamic>())).input()).input(),
      offPeakWindowOptions: map['offPeakWindowOptions'] == null ? null : ((DomainOffPeakWindowOptions.fromMap((map['offPeakWindowOptions']! as Map).cast<String, dynamic>())).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      snapshotOptions: map['snapshotOptions'] == null ? null : ((DomainSnapshotOptions.fromMap((map['snapshotOptions']! as Map).cast<String, dynamic>())).input()).input(),
      softwareUpdateOptions: map['softwareUpdateOptions'] == null ? null : ((DomainSoftwareUpdateOptions.fromMap((map['softwareUpdateOptions']! as Map).cast<String, dynamic>())).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      vpcOptions: map['vpcOptions'] == null ? null : ((DomainVpcOptions.fromMap((map['vpcOptions']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
