...
class DomainArgs {
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      aimlOptions: (() {
        final guardedValue = map['aimlOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      encryptAtRest: (() {
        final guardedValue = map['encryptAtRest'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      identityCenterOptions: (() {
        final guardedValue = map['identityCenterOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      nodeToNodeEncryption: (() {
        final guardedValue = map['nodeToNodeEncryption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
