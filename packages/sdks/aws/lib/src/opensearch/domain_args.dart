...
class DomainArgs {
  ...
  DomainArgs({
    ...
    pulumi.Output<DomainAimlOptions>? aimlOptions,
    ...
    pulumi.Output<DomainIdentityCenterOptions>? identityCenterOptions,
    ...
    pulumi.Output<DomainOffPeakWindowOptions>? offPeakWindowOptions,
    pulumi.Output<String>? region,
    pulumi.Output<DomainSnapshotOptions>? snapshotOptions,
    pulumi.Output<DomainSoftwareUpdateOptions>? softwareUpdateOptions,
    ...
    pulumi.Output<DomainVpcOptions>? vpcOptions,
      ...
      aimlOptions = pulumi.Input.asOptionalInput<DomainAimlOptions>(aimlOptions),
      ...
      identityCenterOptions = pulumi.Input.asOptionalInput<DomainIdentityCenterOptions>(identityCenterOptions),
      ...
      offPeakWindowOptions = pulumi.Input.asOptionalInput<DomainOffPeakWindowOptions>(offPeakWindowOptions),
      region = pulumi.Input.asOptionalInput<String>(region),
      snapshotOptions = pulumi.Input.asOptionalInput<DomainSnapshotOptions>(snapshotOptions),
      softwareUpdateOptions = pulumi.Input.asOptionalInput<DomainSoftwareUpdateOptions>(softwareUpdateOptions),
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      ...
      aimlOptions: map['aimlOptions'] == null ? null : pulumi.Output.create<DomainAimlOptions>(DomainAimlOptions.fromMap((map['aimlOptions'] as Map).cast<String, dynamic>())),
      ...
      identityCenterOptions: map['identityCenterOptions'] == null ? null : pulumi.Output.create<DomainIdentityCenterOptions>(DomainIdentityCenterOptions.fromMap((map['identityCenterOptions'] as Map).cast<String, dynamic>())),
      ...
      offPeakWindowOptions: map['offPeakWindowOptions'] == null ? null : pulumi.Output.create<DomainOffPeakWindowOptions>(DomainOffPeakWindowOptions.fromMap((map['offPeakWindowOptions'] as Map).cast<String, dynamic>())),
      ...
      softwareUpdateOptions: map['softwareUpdateOptions'] == null ? null : pulumi.Output.create<DomainSoftwareUpdateOptions>(DomainSoftwareUpdateOptions.fromMap((map['softwareUpdateOptions'] as Map).cast<String, dynamic>())),
