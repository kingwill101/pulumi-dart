...
class DomainClusterConfig {
  ...
  factory DomainClusterConfig.fromMap(Map<String, dynamic> map) {
    return DomainClusterConfig(
      ...
      multiAzWithStandbyEnabled: map['multiAzWithStandbyEnabled'] == null ? null : ((map['multiAzWithStandbyEnabled'] as bool).input()).input(),
      nodeOptions: map['nodeOptions'] == null ? null : ((pulumi.Input.decodeList<DomainClusterConfigNodeOption>(map['nodeOptions']!, (value) => DomainClusterConfigNodeOption.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
