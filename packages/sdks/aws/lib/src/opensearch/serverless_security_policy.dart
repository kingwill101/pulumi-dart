...
import 'serverless_security_policy_state.dart';
...
class ServerlessSecurityPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [ServerlessSecurityPolicy] resource's state with the given [name] and [id].
  static ServerlessSecurityPolicy get(
    String name,
