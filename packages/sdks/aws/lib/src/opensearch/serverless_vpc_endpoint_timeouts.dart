...
class ServerlessVpcEndpointTimeouts {
  ...
  /// Creates a new [ServerlessVpcEndpointTimeouts].
  ...
  ServerlessVpcEndpointTimeouts({this.create, this.delete, this.update});
  ...
  factory ServerlessVpcEndpointTimeouts.fromMap(Map<String, dynamic> map) {
