...
class OutboundConnectionConnectionProperties {
  ...
  final pulumi.Input<OutboundConnectionConnectionPropertiesCrossClusterSearch>?
  crossClusterSearch;
    ...
    return <String, dynamic>{
      'crossClusterSearch':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(crossClusterSearch, (value) => value.toMap()),
      'endpoint': ?endpoint,
    };
  }
  ...
  factory OutboundConnectionConnectionProperties.fromMap(
    ...
    return OutboundConnectionConnectionProperties(
      crossClusterSearch: (() {
        final guardedValue = map['crossClusterSearch'];
