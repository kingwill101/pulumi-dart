...
class OutboundConnectionState {
  ...
  factory OutboundConnectionState.fromMap(Map<String, dynamic> map) {
    return OutboundConnectionState(
      ...
      connectionAlias: (() { final guardedValue = map['connectionAlias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      localDomainInfo: (() { final guardedValue = map['localDomainInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OutboundConnectionLocalDomainInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      remoteDomainInfo: (() { final guardedValue = map['remoteDomainInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OutboundConnectionRemoteDomainInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
