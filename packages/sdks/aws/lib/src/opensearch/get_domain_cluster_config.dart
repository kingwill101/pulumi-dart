...
class GetDomainClusterConfig {
  ...
  final pulumi.Input<List<GetDomainClusterConfigColdStorageOption>>
  coldStorageOptions;
  ...
  final pulumi.Input<List<GetDomainClusterConfigZoneAwarenessConfig>>
    ...
    return <String, dynamic>{
      'coldStorageOptions':
          pulumi.Input.mapInputValue<
            List<GetDomainClusterConfigColdStorageOption>,
      ...
      'nodeOptions':
          pulumi.Input.mapInputValue<
            List<GetDomainClusterConfigNodeOption>,
            List<Map<String, dynamic>>
          >(
            nodeOptions,
            (value) =>
      ...
      'zoneAwarenessConfigs':
          pulumi.Input.mapInputValue<
            List<GetDomainClusterConfigZoneAwarenessConfig>,
            List<Map<String, dynamic>>
          >(
            zoneAwarenessConfigs,
            (value) =>
  ...
  factory GetDomainClusterConfig.fromMap(Map<String, dynamic> map) {
    return GetDomainClusterConfig(
      coldStorageOptions: pulumi.Input.fromValue(
      ...
      dedicatedMasterCount: pulumi.Input.fromValue(
        map['dedicatedMasterCount'] as int,
      ),
      dedicatedMasterEnabled: pulumi.Input.fromValue(
        map['dedicatedMasterEnabled'] as bool,
      ),
      dedicatedMasterType: pulumi.Input.fromValue(
        map['dedicatedMasterType'] as String,
      ),
      instanceCount: pulumi.Input.fromValue(map['instanceCount'] as int),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      multiAzWithStandbyEnabled: pulumi.Input.fromValue(
        map['multiAzWithStandbyEnabled'] as bool,
      ),
      nodeOptions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDomainClusterConfigNodeOption>(
          map['nodeOptions']!,
      ...
      zoneAwarenessConfigs: pulumi.Input.fromValue(
      ...
      zoneAwarenessEnabled: pulumi.Input.fromValue(
