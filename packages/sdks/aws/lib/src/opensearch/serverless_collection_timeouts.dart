...
class ServerlessCollectionTimeouts {
  ...
  /// Creates a new [ServerlessCollectionTimeouts].
  ...
  ServerlessCollectionTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory ServerlessCollectionTimeouts.fromMap(Map<String, dynamic> map) {
    return ServerlessCollectionTimeouts(
      create: (() {
