...
class DomainState {
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      dashboardEndpointV2: map['dashboardEndpointV2'] == null ? null : ((map['dashboardEndpointV2'] as String).input()).input(),
      ...
      domainEndpointV2HostedZoneId: map['domainEndpointV2HostedZoneId'] == null ? null : ((map['domainEndpointV2HostedZoneId'] as String).input()).input(),
      ...
      endpointV2: map['endpointV2'] == null ? null : ((map['endpointV2'] as String).input()).input(),
