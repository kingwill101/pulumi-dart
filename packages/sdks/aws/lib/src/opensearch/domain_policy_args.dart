...
/// {@template pulumi_opensearch_domain_policy_domain_policy_args_doc}
/// The set of arguments for DomainPolicy.
/// {@endtemplate}
/// {@macro pulumi_opensearch_domain_policy_domain_policy_args_doc}
class DomainPolicyArgs {
  ...
  DomainPolicyArgs({
    required pulumi.Output<String> accessPolicies,
  ...
  factory DomainPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DomainPolicyArgs(
      accessPolicies: pulumi.Output.create<String>(map['accessPolicies'] as String),
