...
class DomainAimlOptions {
  ...
  factory DomainAimlOptions.fromMap(Map<String, dynamic> map) {
    return DomainAimlOptions(
      naturalLanguageQueryGenerationOptions: (() { final guardedValue = map['naturalLanguageQueryGenerationOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainAimlOptionsNaturalLanguageQueryGenerationOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      s3VectorsEngine: (() { final guardedValue = map['s3VectorsEngine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainAimlOptionsS3VectorsEngine.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      serverlessVectorAcceleration: (() { final guardedValue = map['serverlessVectorAcceleration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainAimlOptionsServerlessVectorAcceleration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
