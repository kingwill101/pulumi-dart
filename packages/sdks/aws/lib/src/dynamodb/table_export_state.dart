...
class TableExportState {
  ...
  factory TableExportState.fromMap(Map<String, dynamic> map) {
    return TableExportState(
      ...
      billedSizeInBytes: map['billedSizeInBytes'] == null ? null : ((map['billedSizeInBytes'] as int).input()).input(),
      ...
      exportStatus: map['exportStatus'] == null ? null : ((map['exportStatus'] as String).input()).input(),
      ...
      itemCount: map['itemCount'] == null ? null : ((map['itemCount'] as int).input()).input(),
      manifestFilesS3Key: map['manifestFilesS3Key'] == null ? null : ((map['manifestFilesS3Key'] as String).input()).input(),
