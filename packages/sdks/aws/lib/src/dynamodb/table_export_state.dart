...
class TableExportState {
  ...
  factory TableExportState.fromMap(Map<String, dynamic> map) {
    return TableExportState(
      ...
      billedSizeInBytes: (() {
        final guardedValue = map['billedSizeInBytes'];
        if (guardedValue == null) return null;
      ...
      exportFormat: (() {
        final guardedValue = map['exportFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      exportStatus: (() {
        final guardedValue = map['exportStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      exportTime: (() {
        final guardedValue = map['exportTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      exportType: (() {
        final guardedValue = map['exportType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      incrementalExportSpecification: (() {
        final guardedValue = map['incrementalExportSpecification'];
        if (guardedValue == null) return null;
      ...
      manifestFilesS3Key: (() {
        final guardedValue = map['manifestFilesS3Key'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      s3SseAlgorithm: (() {
        final guardedValue = map['s3SseAlgorithm'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      s3SseKmsKeyId: (() {
        final guardedValue = map['s3SseKmsKeyId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      startTime: (() {
