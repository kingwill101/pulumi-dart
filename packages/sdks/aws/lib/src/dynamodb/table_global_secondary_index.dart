...
class TableGlobalSecondaryIndex {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hashKey': ?hashKey,
      'keySchemas': ?keySchemas == null ? null : pulumi.Input.encodeList<TableGlobalSecondaryIndexKeySchema, Map<String, dynamic>>(keySchemas!, (value) => value.toMap()),
      'name': name,
      'nonKeyAttributes': ?nonKeyAttributes,
      'onDemandThroughput': ?onDemandThroughput == null ? null : onDemandThroughput!.toMap(),
      'projectionType': projectionType,
      'rangeKey': ?rangeKey,
      'readCapacity': ?readCapacity,
      'warmThroughput': ?warmThroughput == null ? null : warmThroughput!.toMap(),
  ...
  factory TableGlobalSecondaryIndex.fromMap(Map<String, dynamic> map) {
    return TableGlobalSecondaryIndex(
      ...
      keySchemas: map['keySchemas'] == null ? null : pulumi.Input.decodeList<TableGlobalSecondaryIndexKeySchema>(map['keySchemas'], (value) => TableGlobalSecondaryIndexKeySchema.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      nonKeyAttributes: map['nonKeyAttributes'] == null ? null : (map['nonKeyAttributes'] as List).cast<String>(),
      onDemandThroughput: map['onDemandThroughput'] == null ? null : TableGlobalSecondaryIndexOnDemandThroughput.fromMap((map['onDemandThroughput'] as Map).cast<String, dynamic>()),
      projectionType: map['projectionType'] as String,
      rangeKey: map['rangeKey'] == null ? null : map['rangeKey'] as String,
      readCapacity: map['readCapacity'] == null ? null : map['readCapacity'] as int,
      warmThroughput: map['warmThroughput'] == null ? null : TableGlobalSecondaryIndexWarmThroughput.fromMap((map['warmThroughput'] as Map).cast<String, dynamic>()),
      writeCapacity: map['writeCapacity'] == null ? null : map['writeCapacity'] as int,
    );
  }
}
