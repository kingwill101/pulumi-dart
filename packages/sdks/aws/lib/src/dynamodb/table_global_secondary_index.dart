...
class TableGlobalSecondaryIndex {
  ...
  final pulumi.Input<TableGlobalSecondaryIndexOnDemandThroughput>?
  onDemandThroughput;
    ...
    return <String, dynamic>{
      ...
      'keySchemas':
          ?pulumi.Input.mapOptionalInputValue<
            List<TableGlobalSecondaryIndexKeySchema>,
      ...
      'onDemandThroughput':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(onDemandThroughput, (value) => value.toMap()),
      ...
      'warmThroughput':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(warmThroughput, (value) => value.toMap()),
  ...
  factory TableGlobalSecondaryIndex.fromMap(Map<String, dynamic> map) {
    return TableGlobalSecondaryIndex(
      ...
      keySchemas: (() {
        final guardedValue = map['keySchemas'];
        if (guardedValue == null) return null;
      ...
      onDemandThroughput: (() {
        final guardedValue = map['onDemandThroughput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      readCapacity: (() {
        final guardedValue = map['readCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      warmThroughput: (() {
        final guardedValue = map['warmThroughput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      writeCapacity: (() {
        final guardedValue = map['writeCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
