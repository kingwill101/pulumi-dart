...
class TableState {
  ...
  TableState({
    ...
    pulumi.Output<String>? streamLabel,
    ...
    pulumi.Output<int>? writeCapacity,
      ...
      streamLabel = pulumi.Input.asOptionalInput<String>(streamLabel),
  ...
  factory TableState.fromMap(Map<String, dynamic> map) {
    return TableState(
      ...
      streamLabel: map['streamLabel'] == null ? null : pulumi.Output.create<String>(map['streamLabel'] as String),
