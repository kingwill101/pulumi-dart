...
class GetTableGlobalSecondaryIndex {
  ...
  final pulumi.Input<List<GetTableGlobalSecondaryIndexOnDemandThroughput>>
  onDemandThroughputs;
  final pulumi.Input<String> projectionType;
  final pulumi.Input<String> rangeKey;
  final pulumi.Input<int> readCapacity;
  final pulumi.Input<List<GetTableGlobalSecondaryIndexWarmThroughput>>
  warmThroughputs;
    ...
    return <String, dynamic>{
      ...
      'keySchemas':
          pulumi.Input.mapInputValue<
            List<GetTableGlobalSecondaryIndexKeySchema>,
      ...
      'onDemandThroughputs':
          pulumi.Input.mapInputValue<
            List<GetTableGlobalSecondaryIndexOnDemandThroughput>,
            List<Map<String, dynamic>>
          >(
            onDemandThroughputs,
            (value) =>
      ...
      'warmThroughputs':
          pulumi.Input.mapInputValue<
            List<GetTableGlobalSecondaryIndexWarmThroughput>,
            List<Map<String, dynamic>>
          >(
            warmThroughputs,
            (value) =>
  ...
  factory GetTableGlobalSecondaryIndex.fromMap(Map<String, dynamic> map) {
    return GetTableGlobalSecondaryIndex(
      ...
      keySchemas: pulumi.Input.fromValue(
      ...
      onDemandThroughputs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetTableGlobalSecondaryIndexOnDemandThroughput>(
      ...
      warmThroughputs: pulumi.Input.fromValue(
