...
class GlobalSecondaryIndexTimeouts {
  ...
  /// Creates a new [GlobalSecondaryIndexTimeouts].
  ...
  GlobalSecondaryIndexTimeouts({this.create, this.delete, this.update});
  ...
  factory GlobalSecondaryIndexTimeouts.fromMap(Map<String, dynamic> map) {
    return GlobalSecondaryIndexTimeouts(
      create: (() {
