...
class GetCloudExadataInfrastructureMaintenanceWindow {
  ...
  final pulumi.Input<
    List<GetCloudExadataInfrastructureMaintenanceWindowDaysOfWeek>
  >
  daysOfWeeks;
  ...
  final pulumi.Input<List<GetCloudExadataInfrastructureMaintenanceWindowMonth>>
  months;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'months':
          pulumi.Input.mapInputValue<
            List<GetCloudExadataInfrastructureMaintenanceWindowMonth>,
            List<Map<String, dynamic>>
          >(
            months,
            (value) =>
