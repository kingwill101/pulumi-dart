...
class CloudExadataInfrastructure extends pulumi.CustomResource {
  ...
  CloudExadataInfrastructure(
    ...
    this.availableStorageSizeInGbs = registerOutput<int>('availableStorageSizeInGbs');
    ...
    this.customerContactsToSendToOcis = registerOutput<List<CloudExadataInfrastructureCustomerContactsToSendToOci>?>('customerContactsToSendToOcis');
    ...
    this.maintenanceWindow = registerOutput<CloudExadataInfrastructureMaintenanceWindow>('maintenanceWindow');
    this.maxCpuCount = registerOutput<int>('maxCpuCount');
    this.maxDataStorageInTbs = registerOutput<double>('maxDataStorageInTbs');
    this.maxDbNodeStorageSizeInGbs = registerOutput<int>('maxDbNodeStorageSizeInGbs');
    this.maxMemoryInGbs = registerOutput<int>('maxMemoryInGbs');
    this.memorySizeInGbs = registerOutput<int>('memorySizeInGbs');
    this.monthlyDbServerVersion = registerOutput<String>('monthlyDbServerVersion');
    this.monthlyStorageServerVersion = registerOutput<String>('monthlyStorageServerVersion');
    ...
    this.timeouts = registerOutput<CloudExadataInfrastructureTimeouts?>('timeouts');
