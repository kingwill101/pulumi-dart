...
class CloudVmClusterTimeouts {
  ...
  /// Creates a new [CloudVmClusterTimeouts].
  ...
  CloudVmClusterTimeouts({this.create, this.delete, this.update});
  ...
  factory CloudVmClusterTimeouts.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterTimeouts(
      create: (() {
