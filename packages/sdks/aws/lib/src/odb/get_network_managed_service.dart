...
class GetNetworkManagedService {
  ...
  final pulumi.Input<List<GetNetworkManagedServiceManagedS3BackupAccess>>
  ...
  final pulumi.Input<List<GetNetworkManagedServiceServiceNetworkEndpoint>>
    ...
    return <String, dynamic>{
      'kmsAccesses':
          pulumi.Input.mapInputValue<
            List<GetNetworkManagedServiceKmsAccess>,
      ...
      'managedS3BackupAccesses':
          pulumi.Input.mapInputValue<
            List<GetNetworkManagedServiceManagedS3BackupAccess>,
            List<Map<String, dynamic>>
          >(
            managedS3BackupAccesses,
            (value) =>
      ...
      's3Accesses':
          pulumi.Input.mapInputValue<
            List<GetNetworkManagedServiceS3Access>,
            List<Map<String, dynamic>>
          >(
            s3Accesses,
            (value) =>
      ...
      'serviceNetworkEndpoints':
          pulumi.Input.mapInputValue<
            List<GetNetworkManagedServiceServiceNetworkEndpoint>,
            List<Map<String, dynamic>>
          >(
            serviceNetworkEndpoints,
            (value) =>
      ...
      'stsAccesses':
          pulumi.Input.mapInputValue<
            List<GetNetworkManagedServiceStsAccess>,
            List<Map<String, dynamic>>
          >(
            stsAccesses,
            (value) =>
      ...
      'zeroTlAccesses':
          pulumi.Input.mapInputValue<
            List<GetNetworkManagedServiceZeroTlAccess>,
            List<Map<String, dynamic>>
          >(
            zeroTlAccesses,
            (value) =>
  ...
  factory GetNetworkManagedService.fromMap(Map<String, dynamic> map) {
    return GetNetworkManagedService(
      kmsAccesses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNetworkManagedServiceKmsAccess>(
          map['kmsAccesses']!,
      ...
      managedS3BackupAccesses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNetworkManagedServiceManagedS3BackupAccess>(
      ...
      s3Accesses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNetworkManagedServiceS3Access>(
          map['s3Accesses']!,
      ...
      serviceNetworkEndpoints: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNetworkManagedServiceServiceNetworkEndpoint>(
      ...
      stsAccesses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetNetworkManagedServiceStsAccess>(
          map['stsAccesses']!,
      ...
      zeroTlAccesses: pulumi.Input.fromValue(
