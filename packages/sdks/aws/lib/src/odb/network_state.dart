...
class NetworkState {
  ...
  factory NetworkState.fromMap(Map<String, dynamic> map) {
    return NetworkState(
      ...
      clientSubnetCidr: map['clientSubnetCidr'] == null ? null : (map['clientSubnetCidr'] as String).input(),
      ...
      managedServices: map['managedServices'] == null ? null : (pulumi.Input.decodeList<NetworkManagedService>(map['managedServices'], (value) => NetworkManagedService.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ociDnsForwardingConfigs: map['ociDnsForwardingConfigs'] == null ? null : (pulumi.Input.decodeList<NetworkOciDnsForwardingConfig>(map['ociDnsForwardingConfigs'], (value) => NetworkOciDnsForwardingConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ociNetworkAnchorId: map['ociNetworkAnchorId'] == null ? null : (map['ociNetworkAnchorId'] as String).input(),
      ociNetworkAnchorUrl: map['ociNetworkAnchorUrl'] == null ? null : (map['ociNetworkAnchorUrl'] as String).input(),
      ociResourceAnchorName: map['ociResourceAnchorName'] == null ? null : (map['ociResourceAnchorName'] as String).input(),
      ociVcnId: map['ociVcnId'] == null ? null : (map['ociVcnId'] as String).input(),
      ociVcnUrl: map['ociVcnUrl'] == null ? null : (map['ociVcnUrl'] as String).input(),
      peeredCidrs: map['peeredCidrs'] == null ? null : ((map['peeredCidrs'] as List).cast<String>()).input(),
      percentProgress: map['percentProgress'] == null ? null : (map['percentProgress'] as double).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      s3Access: map['s3Access'] == null ? null : (map['s3Access'] as String).input(),
      ...
      zeroEtlAccess: map['zeroEtlAccess'] == null ? null : (map['zeroEtlAccess'] as String).input(),
    );
  }
}
