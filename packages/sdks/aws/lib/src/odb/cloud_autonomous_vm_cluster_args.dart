...
class CloudAutonomousVmClusterArgs {
  ...
  factory CloudAutonomousVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudAutonomousVmClusterArgs(
      autonomousDataStorageSizeInTbs: pulumi.Input.fromValue(map['autonomousDataStorageSizeInTbs'] as double),
      ...
      cpuCoreCountPerNode: pulumi.Input.fromValue(map['cpuCoreCountPerNode'] as int),
      ...
      memoryPerOracleComputeUnitInGbs: pulumi.Input.fromValue(map['memoryPerOracleComputeUnitInGbs'] as int),
      ...
      scanListenerPortNonTls: pulumi.Input.fromValue(map['scanListenerPortNonTls'] as int),
      scanListenerPortTls: pulumi.Input.fromValue(map['scanListenerPortTls'] as int),
      ...
      totalContainerDatabases: pulumi.Input.fromValue(map['totalContainerDatabases'] as int),
    );
  }
}
