...
class CloudAutonomousVmClusterArgs {
  ...
  CloudAutonomousVmClusterArgs({
    required pulumi.Output<double> autonomousDataStorageSizeInTbs,
    pulumi.Output<String>? cloudExadataInfrastructureArn,
    pulumi.Output<String>? cloudExadataInfrastructureId,
    required pulumi.Output<int> cpuCoreCountPerNode,
    ...
    required pulumi.Output<CloudAutonomousVmClusterMaintenanceWindow> maintenanceWindow,
    required pulumi.Output<int> memoryPerOracleComputeUnitInGbs,
    pulumi.Output<String>? odbNetworkArn,
    pulumi.Output<String>? odbNetworkId,
    pulumi.Output<String>? region,
    required pulumi.Output<int> scanListenerPortNonTls,
    required pulumi.Output<int> scanListenerPortTls,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<String>? timeZone,
    pulumi.Output<CloudAutonomousVmClusterTimeouts>? timeouts,
    required pulumi.Output<int> totalContainerDatabases,
  }) :
      autonomousDataStorageSizeInTbs = pulumi.Input.asInput<double>(autonomousDataStorageSizeInTbs),
      ...
      maintenanceWindow = pulumi.Input.asInput<CloudAutonomousVmClusterMaintenanceWindow>(maintenanceWindow),
      memoryPerOracleComputeUnitInGbs = pulumi.Input.asInput<int>(memoryPerOracleComputeUnitInGbs),
      ...
      scanListenerPortNonTls = pulumi.Input.asInput<int>(scanListenerPortNonTls),
      ...
      totalContainerDatabases = pulumi.Input.asInput<int>(totalContainerDatabases);
  ...
  factory CloudAutonomousVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudAutonomousVmClusterArgs(
      autonomousDataStorageSizeInTbs: pulumi.Output.create<double>(map['autonomousDataStorageSizeInTbs'] as double),
      ...
      cpuCoreCountPerNode: pulumi.Output.create<int>(map['cpuCoreCountPerNode'] as int),
      ...
      maintenanceWindow: pulumi.Output.create<CloudAutonomousVmClusterMaintenanceWindow>(CloudAutonomousVmClusterMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())),
      memoryPerOracleComputeUnitInGbs: pulumi.Output.create<int>(map['memoryPerOracleComputeUnitInGbs'] as int),
      ...
      scanListenerPortNonTls: pulumi.Output.create<int>(map['scanListenerPortNonTls'] as int),
      scanListenerPortTls: pulumi.Output.create<int>(map['scanListenerPortTls'] as int),
      ...
      totalContainerDatabases: pulumi.Output.create<int>(map['totalContainerDatabases'] as int),
    );
  }
}
