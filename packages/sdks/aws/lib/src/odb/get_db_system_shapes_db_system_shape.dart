...
class GetDbSystemShapesDbSystemShape {
  ...
  factory GetDbSystemShapesDbSystemShape.fromMap(Map<String, dynamic> map) {
    return GetDbSystemShapesDbSystemShape(
      availableCoreCount: pulumi.Input.fromValue((map['availableCoreCount'] as num).toInt()),
      availableCoreCountPerNode: pulumi.Input.fromValue((map['availableCoreCountPerNode'] as num).toInt()),
      availableDataStorageInTbs: pulumi.Input.fromValue((map['availableDataStorageInTbs'] as num).toInt()),
      availableDataStoragePerServerInTbs: pulumi.Input.fromValue((map['availableDataStoragePerServerInTbs'] as num).toInt()),
      availableDbNodePerNodeInGbs: pulumi.Input.fromValue((map['availableDbNodePerNodeInGbs'] as num).toInt()),
      availableDbNodeStorageInGbs: pulumi.Input.fromValue((map['availableDbNodeStorageInGbs'] as num).toInt()),
      availableMemoryInGbs: pulumi.Input.fromValue((map['availableMemoryInGbs'] as num).toInt()),
      availableMemoryPerNodeInGbs: pulumi.Input.fromValue((map['availableMemoryPerNodeInGbs'] as num).toInt()),
      coreCountIncrement: pulumi.Input.fromValue((map['coreCountIncrement'] as num).toInt()),
      maxStorageCount: pulumi.Input.fromValue((map['maxStorageCount'] as num).toInt()),
      maximumNodeCount: pulumi.Input.fromValue((map['maximumNodeCount'] as num).toInt()),
      minCoreCountPerNode: pulumi.Input.fromValue((map['minCoreCountPerNode'] as num).toInt()),
      minDataStorageInTbs: pulumi.Input.fromValue((map['minDataStorageInTbs'] as num).toInt()),
      minDbNodeStoragePerNodeInGbs: pulumi.Input.fromValue((map['minDbNodeStoragePerNodeInGbs'] as num).toInt()),
      minMemoryPerNodeInGbs: pulumi.Input.fromValue((map['minMemoryPerNodeInGbs'] as num).toInt()),
      minStorageCount: pulumi.Input.fromValue((map['minStorageCount'] as num).toInt()),
      minimumCoreCount: pulumi.Input.fromValue((map['minimumCoreCount'] as num).toInt()),
      minimumNodeCount: pulumi.Input.fromValue((map['minimumNodeCount'] as num).toInt()),
      name: pulumi.Input.fromValue(map['name'] as String),
      runtimeMinimumCoreCount: pulumi.Input.fromValue((map['runtimeMinimumCoreCount'] as num).toInt()),
