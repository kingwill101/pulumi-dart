...
class GetDbSystemShapesDbSystemShape {
  ...
  factory GetDbSystemShapesDbSystemShape.fromMap(Map<String, dynamic> map) {
    return GetDbSystemShapesDbSystemShape(
      availableCoreCount: pulumi.Input.fromValue(
        map['availableCoreCount'] as int,
      ),
      availableCoreCountPerNode: pulumi.Input.fromValue(
        map['availableCoreCountPerNode'] as int,
      ),
      availableDataStorageInTbs: pulumi.Input.fromValue(
        map['availableDataStorageInTbs'] as int,
      ),
      availableDataStoragePerServerInTbs: pulumi.Input.fromValue(
        map['availableDataStoragePerServerInTbs'] as int,
      ),
      availableDbNodePerNodeInGbs: pulumi.Input.fromValue(
        map['availableDbNodePerNodeInGbs'] as int,
      ),
      availableDbNodeStorageInGbs: pulumi.Input.fromValue(
        map['availableDbNodeStorageInGbs'] as int,
      ),
      availableMemoryInGbs: pulumi.Input.fromValue(
        map['availableMemoryInGbs'] as int,
      ),
      availableMemoryPerNodeInGbs: pulumi.Input.fromValue(
        map['availableMemoryPerNodeInGbs'] as int,
      ),
      coreCountIncrement: pulumi.Input.fromValue(
        map['coreCountIncrement'] as int,
      ),
      ...
      minCoreCountPerNode: pulumi.Input.fromValue(
        map['minCoreCountPerNode'] as int,
      ),
      minDataStorageInTbs: pulumi.Input.fromValue(
        map['minDataStorageInTbs'] as int,
      ),
      minDbNodeStoragePerNodeInGbs: pulumi.Input.fromValue(
        map['minDbNodeStoragePerNodeInGbs'] as int,
      ),
      minMemoryPerNodeInGbs: pulumi.Input.fromValue(
        map['minMemoryPerNodeInGbs'] as int,
      ),
      ...
      runtimeMinimumCoreCount: pulumi.Input.fromValue(
        map['runtimeMinimumCoreCount'] as int,
      ),
