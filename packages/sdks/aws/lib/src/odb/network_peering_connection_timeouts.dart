...
class NetworkPeeringConnectionTimeouts {
  ...
  /// Creates a new [NetworkPeeringConnectionTimeouts].
  ...
  NetworkPeeringConnectionTimeouts({this.create, this.delete, this.update});
  ...
  factory NetworkPeeringConnectionTimeouts.fromMap(Map<String, dynamic> map) {
    return NetworkPeeringConnectionTimeouts(
      create: (() {
