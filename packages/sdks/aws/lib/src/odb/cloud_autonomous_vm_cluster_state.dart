...
class CloudAutonomousVmClusterState {
  ...
  factory CloudAutonomousVmClusterState.fromMap(Map<String, dynamic> map) {
    return CloudAutonomousVmClusterState(
      ...
      autonomousDataStoragePercentage: map['autonomousDataStoragePercentage'] == null ? null : (map['autonomousDataStoragePercentage'] as double).input(),
      autonomousDataStorageSizeInTbs: map['autonomousDataStorageSizeInTbs'] == null ? null : (map['autonomousDataStorageSizeInTbs'] as double).input(),
      availableAutonomousDataStorageSizeInTbs: map['availableAutonomousDataStorageSizeInTbs'] == null ? null : (map['availableAutonomousDataStorageSizeInTbs'] as double).input(),
      availableContainerDatabases: map['availableContainerDatabases'] == null ? null : (map['availableContainerDatabases'] as int).input(),
      availableCpus: map['availableCpus'] == null ? null : (map['availableCpus'] as double).input(),
      ...
      cpuCoreCountPerNode: map['cpuCoreCountPerNode'] == null ? null : (map['cpuCoreCountPerNode'] as int).input(),
      cpuPercentage: map['cpuPercentage'] == null ? null : (map['cpuPercentage'] as double).input(),
      createdAt: map['createdAt'] == null ? null : (map['createdAt'] as String).input(),
      dataStorageSizeInGbs: map['dataStorageSizeInGbs'] == null ? null : (map['dataStorageSizeInGbs'] as double).input(),
      dataStorageSizeInTbs: map['dataStorageSizeInTbs'] == null ? null : (map['dataStorageSizeInTbs'] as double).input(),
      dbServers: map['dbServers'] == null ? null : ((map['dbServers'] as List).cast<String>()).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      displayName: map['displayName'] == null ? null : (map['displayName'] as String).input(),
      domain: map['domain'] == null ? null : (map['domain'] as String).input(),
      exadataStorageInTbsLowestScaledValue: map['exadataStorageInTbsLowestScaledValue'] == null ? null : (map['exadataStorageInTbsLowestScaledValue'] as double).input(),
      ...
      maintenanceWindow: map['maintenanceWindow'] == null ? null : (CloudAutonomousVmClusterMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>())).input(),
      maxAcdsLowestScaledValue: map['maxAcdsLowestScaledValue'] == null ? null : (map['maxAcdsLowestScaledValue'] as int).input(),
      memoryPerOracleComputeUnitInGbs: map['memoryPerOracleComputeUnitInGbs'] == null ? null : (map['memoryPerOracleComputeUnitInGbs'] as int).input(),
      memorySizeInGbs: map['memorySizeInGbs'] == null ? null : (map['memorySizeInGbs'] as int).input(),
      nodeCount: map['nodeCount'] == null ? null : (map['nodeCount'] as int).input(),
      nonProvisionableAutonomousContainerDatabases: map['nonProvisionableAutonomousContainerDatabases'] == null ? null : (map['nonProvisionableAutonomousContainerDatabases'] as int).input(),
      ...
      odbNodeStorageSizeInGbs: map['odbNodeStorageSizeInGbs'] == null ? null : (map['odbNodeStorageSizeInGbs'] as int).input(),
      percentProgress: map['percentProgress'] == null ? null : (map['percentProgress'] as double).input(),
      provisionableAutonomousContainerDatabases: map['provisionableAutonomousContainerDatabases'] == null ? null : (map['provisionableAutonomousContainerDatabases'] as int).input(),
      provisionedAutonomousContainerDatabases: map['provisionedAutonomousContainerDatabases'] == null ? null : (map['provisionedAutonomousContainerDatabases'] as int).input(),
      provisionedCpus: map['provisionedCpus'] == null ? null : (map['provisionedCpus'] as double).input(),
      reclaimableCpus: map['reclaimableCpus'] == null ? null : (map['reclaimableCpus'] as double).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      reservedCpus: map['reservedCpus'] == null ? null : (map['reservedCpus'] as double).input(),
      scanListenerPortNonTls: map['scanListenerPortNonTls'] == null ? null : (map['scanListenerPortNonTls'] as int).input(),
      scanListenerPortTls: map['scanListenerPortTls'] == null ? null : (map['scanListenerPortTls'] as int).input(),
      ...
      timeDatabaseSslCertificateExpires: map['timeDatabaseSslCertificateExpires'] == null ? null : (map['timeDatabaseSslCertificateExpires'] as String).input(),
      timeOrdsCertificateExpires: map['timeOrdsCertificateExpires'] == null ? null : (map['timeOrdsCertificateExpires'] as String).input(),
      ...
      totalContainerDatabases: map['totalContainerDatabases'] == null ? null : (map['totalContainerDatabases'] as int).input(),
    );
  }
}
