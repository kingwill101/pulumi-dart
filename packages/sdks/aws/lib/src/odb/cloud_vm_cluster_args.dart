...
class CloudVmClusterArgs {
  ...
  CloudVmClusterArgs({
    ...
    required pulumi.Output<CloudVmClusterDataCollectionOptions> dataCollectionOptions,
    required pulumi.Output<double> dataStorageSizeInTbs,
    ...
    required pulumi.Output<String> hostnamePrefix,
    ...
    pulumi.Output<String>? timezone,
      ...
      dataCollectionOptions = pulumi.Input.asInput<CloudVmClusterDataCollectionOptions>(dataCollectionOptions),
      dataStorageSizeInTbs = pulumi.Input.asInput<double>(dataStorageSizeInTbs),
  ...
  factory CloudVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterArgs(
      ...
      dataCollectionOptions: pulumi.Output.create<CloudVmClusterDataCollectionOptions>(CloudVmClusterDataCollectionOptions.fromMap((map['dataCollectionOptions'] as Map).cast<String, dynamic>())),
      dataStorageSizeInTbs: pulumi.Output.create<double>(map['dataStorageSizeInTbs'] as double),
      ...
      hostnamePrefix: pulumi.Output.create<String>(map['hostnamePrefix'] as String),
