...
class GetDbServersDbServer {
  ...
  final pulumi.Input<List<GetDbServersDbServerDbServerPatchingDetail>>
    ...
    return <String, dynamic>{
      ...
      'dbServerPatchingDetails':
          pulumi.Input.mapInputValue<
            List<GetDbServersDbServerDbServerPatchingDetail>,
  ...
  factory GetDbServersDbServer.fromMap(Map<String, dynamic> map) {
    return GetDbServersDbServer(
      autonomousVirtualMachineIds: pulumi.Input.fromValue(
      ...
      dbServerPatchingDetails: pulumi.Input.fromValue(
