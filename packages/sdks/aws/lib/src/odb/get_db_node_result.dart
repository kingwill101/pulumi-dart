...
class GetDbNodeResult {
  ...
  factory GetDbNodeResult.fromMap(Map<String, dynamic> map) {
    return GetDbNodeResult(
      ...
      dbStorageSizeInGbs: (() { final guardedValue = map['dbStorageSizeInGbs']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      softwareStorageSizeInGbs: (() { final guardedValue = map['softwareStorageSizeInGbs']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      totalCpuCoreCount: (() { final guardedValue = map['totalCpuCoreCount']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
