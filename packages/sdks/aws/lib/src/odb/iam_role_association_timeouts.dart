...
class IamRoleAssociationTimeouts {
  ...
  /// Creates a new [IamRoleAssociationTimeouts].
  ...
  const IamRoleAssociationTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory IamRoleAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return IamRoleAssociationTimeouts(
