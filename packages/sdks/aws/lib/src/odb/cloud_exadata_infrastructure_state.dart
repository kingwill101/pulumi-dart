...
class CloudExadataInfrastructureState {
  ...
  factory CloudExadataInfrastructureState.fromMap(Map<String, dynamic> map) {
    return CloudExadataInfrastructureState(
      activatedStorageCount: map['activatedStorageCount'] == null ? null : ((map['activatedStorageCount'] as int).input()).input(),
      additionalStorageCount: map['additionalStorageCount'] == null ? null : ((map['additionalStorageCount'] as int).input()).input(),
      ...
      availableStorageSizeInGbs: map['availableStorageSizeInGbs'] == null ? null : ((map['availableStorageSizeInGbs'] as int).input()).input(),
      ...
      dbServerVersion: map['dbServerVersion'] == null ? null : ((map['dbServerVersion'] as String).input()).input(),
      displayName: map['displayName'] == null ? null : ((map['displayName'] as String).input()).input(),
      lastMaintenanceRunId: map['lastMaintenanceRunId'] == null ? null : ((map['lastMaintenanceRunId'] as String).input()).input(),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : ((CloudExadataInfrastructureMaintenanceWindow.fromMap((map['maintenanceWindow']! as Map).cast<String, dynamic>())).input()).input(),
      maxCpuCount: map['maxCpuCount'] == null ? null : ((map['maxCpuCount'] as int).input()).input(),
      maxDataStorageInTbs: map['maxDataStorageInTbs'] == null ? null : ((map['maxDataStorageInTbs'] as double).input()).input(),
      maxDbNodeStorageSizeInGbs: map['maxDbNodeStorageSizeInGbs'] == null ? null : ((map['maxDbNodeStorageSizeInGbs'] as int).input()).input(),
      maxMemoryInGbs: map['maxMemoryInGbs'] == null ? null : ((map['maxMemoryInGbs'] as int).input()).input(),
      memorySizeInGbs: map['memorySizeInGbs'] == null ? null : ((map['memorySizeInGbs'] as int).input()).input(),
      monthlyDbServerVersion: map['monthlyDbServerVersion'] == null ? null : ((map['monthlyDbServerVersion'] as String).input()).input(),
      monthlyStorageServerVersion: map['monthlyStorageServerVersion'] == null ? null : ((map['monthlyStorageServerVersion'] as String).input()).input(),
      nextMaintenanceRunId: map['nextMaintenanceRunId'] == null ? null : ((map['nextMaintenanceRunId'] as String).input()).input(),
      ...
      storageServerVersion: map['storageServerVersion'] == null ? null : ((map['storageServerVersion'] as String).input()).input(),
      ...
      totalStorageSizeInGbs: map['totalStorageSizeInGbs'] == null ? null : ((map['totalStorageSizeInGbs'] as int).input()).input(),
    );
  }
}
