...
class CloudVmClusterState {
  ...
  factory CloudVmClusterState.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterState(
      ...
      dataCollectionOptions: map['dataCollectionOptions'] == null ? null : (CloudVmClusterDataCollectionOptions.fromMap((map['dataCollectionOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      giVersionComputed: map['giVersionComputed'] == null ? null : (map['giVersionComputed'] as String).input(),
      hostnamePrefix: map['hostnamePrefix'] == null ? null : (map['hostnamePrefix'] as String).input(),
      hostnamePrefixComputed: map['hostnamePrefixComputed'] == null ? null : (map['hostnamePrefixComputed'] as String).input(),
      iormConfigCaches: map['iormConfigCaches'] == null ? null : (pulumi.Input.decodeList<CloudVmClusterIormConfigCache>(map['iormConfigCaches'], (value) => CloudVmClusterIormConfigCache.fromMap((value as Map).cast<String, dynamic>()))).input(),
      isLocalBackupEnabled: map['isLocalBackupEnabled'] == null ? null : (map['isLocalBackupEnabled'] as bool).input(),
      isSparseDiskgroupEnabled: map['isSparseDiskgroupEnabled'] == null ? null : (map['isSparseDiskgroupEnabled'] as bool).input(),
      lastUpdateHistoryEntryId: map['lastUpdateHistoryEntryId'] == null ? null : (map['lastUpdateHistoryEntryId'] as String).input(),
      ...
      scanDnsName: map['scanDnsName'] == null ? null : (map['scanDnsName'] as String).input(),
      ...
      storageSizeInGbs: map['storageSizeInGbs'] == null ? null : (map['storageSizeInGbs'] as int).input(),
      systemVersion: map['systemVersion'] == null ? null : (map['systemVersion'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      timeouts: map['timeouts'] == null ? null : (CloudVmClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())).input(),
      timezone: map['timezone'] == null ? null : (map['timezone'] as String).input(),
      vipIds: map['vipIds'] == null ? null : ((map['vipIds'] as List).cast<String>()).input(),
    );
  }
}
