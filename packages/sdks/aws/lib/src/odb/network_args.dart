...
class NetworkArgs {
  ...
  factory NetworkArgs.fromMap(Map<String, dynamic> map) {
    return NetworkArgs(
      ...
      defaultDnsPrefix: map['defaultDnsPrefix'] == null ? null : (map['defaultDnsPrefix'] as String).input(),
      deleteAssociatedResources: map['deleteAssociatedResources'] == null ? null : (map['deleteAssociatedResources'] as bool).input(),
      displayName: (map['displayName'] as String).input(),
      kmsAccess: map['kmsAccess'] == null ? null : (map['kmsAccess'] as String).input(),
      kmsPolicyDocument: map['kmsPolicyDocument'] == null ? null : (map['kmsPolicyDocument'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      s3Access: (map['s3Access'] as String).input(),
      s3PolicyDocument: map['s3PolicyDocument'] == null ? null : (map['s3PolicyDocument'] as String).input(),
      stsAccess: map['stsAccess'] == null ? null : (map['stsAccess'] as String).input(),
      stsPolicyDocument: map['stsPolicyDocument'] == null ? null : (map['stsPolicyDocument'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      timeouts: map['timeouts'] == null ? null : (NetworkTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())).input(),
