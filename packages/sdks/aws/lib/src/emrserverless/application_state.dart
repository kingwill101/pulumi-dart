...
class ApplicationState {
  ...
  factory ApplicationState.fromMap(Map<String, dynamic> map) {
    return ApplicationState(
      ...
      autoStartConfiguration: map['autoStartConfiguration'] == null ? null : (ApplicationAutoStartConfiguration.fromMap((map['autoStartConfiguration'] as Map).cast<String, dynamic>())).input(),
      autoStopConfiguration: map['autoStopConfiguration'] == null ? null : (ApplicationAutoStopConfiguration.fromMap((map['autoStopConfiguration'] as Map).cast<String, dynamic>())).input(),
      imageConfiguration: map['imageConfiguration'] == null ? null : (ApplicationImageConfiguration.fromMap((map['imageConfiguration'] as Map).cast<String, dynamic>())).input(),
      initialCapacities: map['initialCapacities'] == null ? null : (pulumi.Input.decodeList<ApplicationInitialCapacity>(map['initialCapacities'], (value) => ApplicationInitialCapacity.fromMap((value as Map).cast<String, dynamic>()))).input(),
      interactiveConfiguration: map['interactiveConfiguration'] == null ? null : (ApplicationInteractiveConfiguration.fromMap((map['interactiveConfiguration'] as Map).cast<String, dynamic>())).input(),
      maximumCapacity: map['maximumCapacity'] == null ? null : (ApplicationMaximumCapacity.fromMap((map['maximumCapacity'] as Map).cast<String, dynamic>())).input(),
      monitoringConfiguration: map['monitoringConfiguration'] == null ? null : (ApplicationMonitoringConfiguration.fromMap((map['monitoringConfiguration'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      networkConfiguration: map['networkConfiguration'] == null ? null : (ApplicationNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      releaseLabel: map['releaseLabel'] == null ? null : (map['releaseLabel'] as String).input(),
      runtimeConfigurations: map['runtimeConfigurations'] == null ? null : (pulumi.Input.decodeList<ApplicationRuntimeConfiguration>(map['runtimeConfigurations'], (value) => ApplicationRuntimeConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      schedulerConfiguration: map['schedulerConfiguration'] == null ? null : (ApplicationSchedulerConfiguration.fromMap((map['schedulerConfiguration'] as Map).cast<String, dynamic>())).input(),
