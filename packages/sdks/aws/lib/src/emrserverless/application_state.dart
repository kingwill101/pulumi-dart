...
class ApplicationState {
    ...
    return <String, dynamic>{
      ...
      'autoStartConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(autoStartConfiguration, (value) => value.toMap()),
      'autoStopConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationAutoStopConfiguration,
            Map<String, dynamic>
          >(autoStopConfiguration, (value) => value.toMap()),
      'imageConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'initialCapacities':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationInitialCapacity>,
      ...
      'interactiveConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(interactiveConfiguration, (value) => value.toMap()),
      'maximumCapacity':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationMaximumCapacity,
            Map<String, dynamic>
          >(maximumCapacity, (value) => value.toMap()),
      'monitoringConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ApplicationMonitoringConfiguration,
            Map<String, dynamic>
          >(monitoringConfiguration, (value) => value.toMap()),
      'name': ?name,
      ...
      'schedulerConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(schedulerConfiguration, (value) => value.toMap()),
      'tags': ?tags,
      'tagsAll': ?tagsAll,
      'type': ?type,
    };
  ...
  factory ApplicationState.fromMap(Map<String, dynamic> map) {
    return ApplicationState(
      ...
      autoStartConfiguration: (() {
        final guardedValue = map['autoStartConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationAutoStartConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      autoStopConfiguration: (() {
        final guardedValue = map['autoStopConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationAutoStopConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      imageConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationImageConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      initialCapacities: (() {
        final guardedValue = map['initialCapacities'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationInitialCapacity>(
            guardedValue,
            (value) => ApplicationInitialCapacity.fromMap(
      ...
      interactiveConfiguration: (() {
        final guardedValue = map['interactiveConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationInteractiveConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      maximumCapacity: (() {
        final guardedValue = map['maximumCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationMaximumCapacity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      monitoringConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationMonitoringConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      networkConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationNetworkConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      runtimeConfigurations: (() {
        final guardedValue = map['runtimeConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationRuntimeConfiguration>(
            guardedValue,
            (value) => ApplicationRuntimeConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      schedulerConfiguration: (() {
        final guardedValue = map['schedulerConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ApplicationSchedulerConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
