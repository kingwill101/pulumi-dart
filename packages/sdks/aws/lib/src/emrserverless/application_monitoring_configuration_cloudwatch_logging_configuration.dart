...
class ApplicationMonitoringConfigurationCloudwatchLoggingConfiguration {
  ...
  final List<ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationLogType>? logTypes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'logTypes': ?logTypes == null ? null : pulumi.Input.encodeList<ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationLogType, Map<String, dynamic>>(logTypes!, (value) => value.toMap()),
    };
  }
  ...
  factory ApplicationMonitoringConfigurationCloudwatchLoggingConfiguration.fromMap(Map<String, dynamic> map) {
    return ApplicationMonitoringConfigurationCloudwatchLoggingConfiguration(
      ...
      logTypes: map['logTypes'] == null ? null : pulumi.Input.decodeList<ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationLogType>(map['logTypes'], (value) => ApplicationMonitoringConfigurationCloudwatchLoggingConfigurationLogType.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
