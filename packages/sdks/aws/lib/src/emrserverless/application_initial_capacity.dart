...
class ApplicationInitialCapacity {
  ...
  final pulumi.Input<ApplicationInitialCapacityInitialCapacityConfig>?
    ...
    return <String, dynamic>{
      'initialCapacityConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(initialCapacityConfig, (value) => value.toMap()),
  ...
  factory ApplicationInitialCapacity.fromMap(Map<String, dynamic> map) {
    return ApplicationInitialCapacity(
      initialCapacityConfig: (() {
        final guardedValue = map['initialCapacityConfig'];
      ...
      initialCapacityType: pulumi.Input.fromValue(
        map['initialCapacityType'] as String,
      ),
    );
  }
}
