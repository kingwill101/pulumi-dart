...
class PlanWorkflowStep {
  ...
  factory PlanWorkflowStep.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStep(
      arcRoutingControlConfigs: map['arcRoutingControlConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepArcRoutingControlConfig>(map['arcRoutingControlConfigs']!, (value) => PlanWorkflowStepArcRoutingControlConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      customActionLambdaConfigs: map['customActionLambdaConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepCustomActionLambdaConfig>(map['customActionLambdaConfigs']!, (value) => PlanWorkflowStepCustomActionLambdaConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      documentDbConfigs: map['documentDbConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepDocumentDbConfig>(map['documentDbConfigs']!, (value) => PlanWorkflowStepDocumentDbConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ec2AsgCapacityIncreaseConfigs: map['ec2AsgCapacityIncreaseConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepEc2AsgCapacityIncreaseConfig>(map['ec2AsgCapacityIncreaseConfigs']!, (value) => PlanWorkflowStepEc2AsgCapacityIncreaseConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ecsCapacityIncreaseConfigs: map['ecsCapacityIncreaseConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepEcsCapacityIncreaseConfig>(map['ecsCapacityIncreaseConfigs']!, (value) => PlanWorkflowStepEcsCapacityIncreaseConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      eksResourceScalingConfigs: map['eksResourceScalingConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepEksResourceScalingConfig>(map['eksResourceScalingConfigs']!, (value) => PlanWorkflowStepEksResourceScalingConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      executionApprovalConfigs: map['executionApprovalConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepExecutionApprovalConfig>(map['executionApprovalConfigs']!, (value) => PlanWorkflowStepExecutionApprovalConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      executionBlockType: (map['executionBlockType'] as String).input(),
      globalAuroraConfigs: map['globalAuroraConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepGlobalAuroraConfig>(map['globalAuroraConfigs']!, (value) => PlanWorkflowStepGlobalAuroraConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      name: (map['name'] as String).input(),
      parallelConfigs: map['parallelConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfig>(map['parallelConfigs']!, (value) => PlanWorkflowStepParallelConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      regionSwitchPlanConfigs: map['regionSwitchPlanConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepRegionSwitchPlanConfig>(map['regionSwitchPlanConfigs']!, (value) => PlanWorkflowStepRegionSwitchPlanConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      route53HealthCheckConfigs: map['route53HealthCheckConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepRoute53HealthCheckConfig>(map['route53HealthCheckConfigs']!, (value) => PlanWorkflowStepRoute53HealthCheckConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
