...
class PlanWorkflowStepGlobalAuroraConfig {
  ...
  factory PlanWorkflowStepGlobalAuroraConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepGlobalAuroraConfig(
      ...
      ungracefuls: (() { final guardedValue = map['ungracefuls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PlanWorkflowStepGlobalAuroraConfigUngraceful>(guardedValue, (value) => PlanWorkflowStepGlobalAuroraConfigUngraceful.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
