...
class PlanWorkflowStepParallelConfigStepAuroraProvisionedScalingConfig {
  ...
  /// Creates a new [PlanWorkflowStepParallelConfigStepAuroraProvisionedScalingConfig].
  ...
  const PlanWorkflowStepParallelConfigStepAuroraProvisionedScalingConfig({
  ...
  factory PlanWorkflowStepParallelConfigStepAuroraProvisionedScalingConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepParallelConfigStepAuroraProvisionedScalingConfig(
