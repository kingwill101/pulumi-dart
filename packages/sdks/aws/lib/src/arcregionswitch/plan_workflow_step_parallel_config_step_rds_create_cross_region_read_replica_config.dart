...
class PlanWorkflowStepParallelConfigStepRdsCreateCrossRegionReadReplicaConfig {
  ...
  const PlanWorkflowStepParallelConfigStepRdsCreateCrossRegionReadReplicaConfig({
  ...
  factory PlanWorkflowStepParallelConfigStepRdsCreateCrossRegionReadReplicaConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepParallelConfigStepRdsCreateCrossRegionReadReplicaConfig(
