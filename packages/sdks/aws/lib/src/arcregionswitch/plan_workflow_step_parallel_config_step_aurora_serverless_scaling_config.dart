...
class PlanWorkflowStepParallelConfigStepAuroraServerlessScalingConfig {
  ...
  /// Creates a new [PlanWorkflowStepParallelConfigStepAuroraServerlessScalingConfig].
  ...
  const PlanWorkflowStepParallelConfigStepAuroraServerlessScalingConfig({
  ...
  factory PlanWorkflowStepParallelConfigStepAuroraServerlessScalingConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepParallelConfigStepAuroraServerlessScalingConfig(
      ...
      targetPercent: (() { final guardedValue = map['targetPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
