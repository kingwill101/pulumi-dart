...
class PlanWorkflowStepEcsCapacityIncreaseConfig {
  ...
  final pulumi.Input<List<PlanWorkflowStepEcsCapacityIncreaseConfigService>>?
  services;
  ...
  final pulumi.Input<PlanWorkflowStepEcsCapacityIncreaseConfigUngraceful>?
  ungraceful;
    ...
    return <String, dynamic>{
      ...
      'services':
          ?pulumi.Input.mapOptionalInputValue<
            List<PlanWorkflowStepEcsCapacityIncreaseConfigService>,
    ...
    return PlanWorkflowStepEcsCapacityIncreaseConfig(
      ...
      services: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => PlanWorkflowStepEcsCapacityIncreaseConfigService.fromMap(
