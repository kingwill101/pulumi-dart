...
class PlanWorkflowStepEcsCapacityIncreaseConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'services': ?services == null ? null : pulumi.Input.encodeList<PlanWorkflowStepEcsCapacityIncreaseConfigService, Map<String, dynamic>>(services!, (value) => value.toMap()),
  ...
  factory PlanWorkflowStepEcsCapacityIncreaseConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepEcsCapacityIncreaseConfig(
      ...
      services: map['services'] == null ? null : pulumi.Input.decodeList<PlanWorkflowStepEcsCapacityIncreaseConfigService>(map['services'], (value) => PlanWorkflowStepEcsCapacityIncreaseConfigService.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ungraceful: map['ungraceful'] == null ? null : PlanWorkflowStepEcsCapacityIncreaseConfigUngraceful.fromMap((map['ungraceful'] as Map).cast<String, dynamic>()),
    );
  }
}
