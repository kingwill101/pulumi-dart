...
class PlanWorkflowStepRdsPromoteReadReplicaConfig {
  ...
  /// Creates a new [PlanWorkflowStepRdsPromoteReadReplicaConfig].
  ...
  const PlanWorkflowStepRdsPromoteReadReplicaConfig({
  ...
  factory PlanWorkflowStepRdsPromoteReadReplicaConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepRdsPromoteReadReplicaConfig(
