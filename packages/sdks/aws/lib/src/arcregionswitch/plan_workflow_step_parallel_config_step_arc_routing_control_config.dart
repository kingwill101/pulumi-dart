...
class PlanWorkflowStepParallelConfigStepArcRoutingControlConfig {
  ...
  final List<PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControl>? regionAndRoutingControls;
  /// Timeout in minutes.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'regionAndRoutingControls': ?regionAndRoutingControls == null ? null : pulumi.Input.encodeList<PlanWorkflowStepParallelConfigStepArcRoutingControlConfigRegionAndRoutingControl, Map<String, dynamic>>(regionAndRoutingControls!, (value) => value.toMap()),
