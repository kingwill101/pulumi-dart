...
class PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig {
  ...
  factory PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig(
      ...
      recordSets: map['recordSets'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigRecordSet>(map['recordSets']!, (value) => PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfigRecordSet.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
