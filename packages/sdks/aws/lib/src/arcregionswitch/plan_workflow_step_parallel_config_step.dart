...
class PlanWorkflowStepParallelConfigStep {
  ...
  final pulumi.Input<
    List<PlanWorkflowStepParallelConfigStepArcRoutingControlConfig>
  >?
  arcRoutingControlConfigs;

  /// Configuration for Lambda function execution. See Custom Action Lambda Config below.
  final pulumi.Input<
    List<PlanWorkflowStepParallelConfigStepCustomActionLambdaConfig>
  >?
  ...
  final pulumi.Input<
    List<PlanWorkflowStepParallelConfigStepGlobalAuroraConfig>
  >?
  globalAuroraConfigs;
  ...
  final pulumi.Input<
    List<PlanWorkflowStepParallelConfigStepRegionSwitchPlanConfig>
  >?
  regionSwitchPlanConfigs;

  /// Configuration for Route53 health check operations. See Route53 Health Check Config below.
  final pulumi.Input<
    List<PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig>
  >?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'documentDbConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<PlanWorkflowStepParallelConfigStepDocumentDbConfig>,
            List<Map<String, dynamic>>
          >(
            documentDbConfigs,
            (value) =>
      ...
      arcRoutingControlConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepArcRoutingControlConfig.fromMap(
      ...
      customActionLambdaConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepCustomActionLambdaConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      ec2AsgCapacityIncreaseConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      ecsCapacityIncreaseConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      eksResourceScalingConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepEksResourceScalingConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      executionApprovalConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepExecutionApprovalConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      regionSwitchPlanConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepRegionSwitchPlanConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      route53HealthCheckConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
