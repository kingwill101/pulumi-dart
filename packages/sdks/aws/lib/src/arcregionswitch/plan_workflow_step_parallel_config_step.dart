...
class PlanWorkflowStepParallelConfigStep {
  ...
  factory PlanWorkflowStepParallelConfigStep.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepParallelConfigStep(
      arcRoutingControlConfigs: map['arcRoutingControlConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepArcRoutingControlConfig>(map['arcRoutingControlConfigs']!, (value) => PlanWorkflowStepParallelConfigStepArcRoutingControlConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      customActionLambdaConfigs: map['customActionLambdaConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepCustomActionLambdaConfig>(map['customActionLambdaConfigs']!, (value) => PlanWorkflowStepParallelConfigStepCustomActionLambdaConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      documentDbConfigs: map['documentDbConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepDocumentDbConfig>(map['documentDbConfigs']!, (value) => PlanWorkflowStepParallelConfigStepDocumentDbConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ec2AsgCapacityIncreaseConfigs: map['ec2AsgCapacityIncreaseConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfig>(map['ec2AsgCapacityIncreaseConfigs']!, (value) => PlanWorkflowStepParallelConfigStepEc2AsgCapacityIncreaseConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ecsCapacityIncreaseConfigs: map['ecsCapacityIncreaseConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfig>(map['ecsCapacityIncreaseConfigs']!, (value) => PlanWorkflowStepParallelConfigStepEcsCapacityIncreaseConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      eksResourceScalingConfigs: map['eksResourceScalingConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepEksResourceScalingConfig>(map['eksResourceScalingConfigs']!, (value) => PlanWorkflowStepParallelConfigStepEksResourceScalingConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      executionApprovalConfigs: map['executionApprovalConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepExecutionApprovalConfig>(map['executionApprovalConfigs']!, (value) => PlanWorkflowStepParallelConfigStepExecutionApprovalConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      executionBlockType: (map['executionBlockType'] as String).input(),
      globalAuroraConfigs: map['globalAuroraConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepGlobalAuroraConfig>(map['globalAuroraConfigs']!, (value) => PlanWorkflowStepParallelConfigStepGlobalAuroraConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      name: (map['name'] as String).input(),
      regionSwitchPlanConfigs: map['regionSwitchPlanConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepRegionSwitchPlanConfig>(map['regionSwitchPlanConfigs']!, (value) => PlanWorkflowStepParallelConfigStepRegionSwitchPlanConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      route53HealthCheckConfigs: map['route53HealthCheckConfigs'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig>(map['route53HealthCheckConfigs']!, (value) => PlanWorkflowStepParallelConfigStepRoute53HealthCheckConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
