...
import 'plan_workflow_step_parallel_config_step_neptune_global_database_config_ungraceful.dart';

class PlanWorkflowStepParallelConfigStepNeptuneGlobalDatabaseConfig {
  ...
  const PlanWorkflowStepParallelConfigStepNeptuneGlobalDatabaseConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ungracefuls': ?pulumi.Input.mapOptionalInputValue<List<PlanWorkflowStepParallelConfigStepNeptuneGlobalDatabaseConfigUngraceful>, List<Map<String, dynamic>>>(ungracefuls, (value) => pulumi.Input.encodeList<PlanWorkflowStepParallelConfigStepNeptuneGlobalDatabaseConfigUngraceful, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory PlanWorkflowStepParallelConfigStepNeptuneGlobalDatabaseConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepParallelConfigStepNeptuneGlobalDatabaseConfig(
