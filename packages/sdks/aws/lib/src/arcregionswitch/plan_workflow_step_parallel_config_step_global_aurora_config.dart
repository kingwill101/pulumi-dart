...
class PlanWorkflowStepParallelConfigStepGlobalAuroraConfig {
  ...
  factory PlanWorkflowStepParallelConfigStepGlobalAuroraConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepParallelConfigStepGlobalAuroraConfig(
      ...
      ungracefuls: map['ungracefuls'] == null ? null : ((pulumi.Input.decodeList<PlanWorkflowStepParallelConfigStepGlobalAuroraConfigUngraceful>(map['ungracefuls']!, (value) => PlanWorkflowStepParallelConfigStepGlobalAuroraConfigUngraceful.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
