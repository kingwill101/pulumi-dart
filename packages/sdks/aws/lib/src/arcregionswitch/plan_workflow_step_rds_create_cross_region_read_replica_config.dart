...
class PlanWorkflowStepRdsCreateCrossRegionReadReplicaConfig {
  ...
  /// Creates a new [PlanWorkflowStepRdsCreateCrossRegionReadReplicaConfig].
  ...
  const PlanWorkflowStepRdsCreateCrossRegionReadReplicaConfig({
  ...
  factory PlanWorkflowStepRdsCreateCrossRegionReadReplicaConfig.fromMap(Map<String, dynamic> map) {
    return PlanWorkflowStepRdsCreateCrossRegionReadReplicaConfig(
