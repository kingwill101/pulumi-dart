...
import 'assessment_target_state.dart';
...
class AssessmentTarget extends pulumi.CustomResource {
  ...
  /// Gets an existing [AssessmentTarget] resource's state with the given [name] and [id].
  static AssessmentTarget get(
    String name,
