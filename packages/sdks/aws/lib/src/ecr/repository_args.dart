    ...
    return RepositoryArgs(
      encryptionConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RepositoryEncryptionConfiguration>(
            guardedValue,
            (value) => RepositoryEncryptionConfiguration.fromMap(
      ...
      imageScanningConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          RepositoryImageScanningConfiguration.fromMap(
      ...
      imageTagMutabilityExclusionFilters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RepositoryImageTagMutabilityExclusionFilter>(
            guardedValue,
            (value) => RepositoryImageTagMutabilityExclusionFilter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
