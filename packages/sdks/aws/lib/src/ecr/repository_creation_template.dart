...
class RepositoryCreationTemplate extends pulumi.CustomResource {
  ...
  RepositoryCreationTemplate(
    ...
    this.encryptionConfigurations = registerOutput<List<RepositoryCreationTemplateEncryptionConfiguration>?>('encryptionConfigurations');
    this.imageTagMutability = registerOutput<String?>('imageTagMutability');
    this.imageTagMutabilityExclusionFilters = registerOutput<List<RepositoryCreationTemplateImageTagMutabilityExclusionFilter>?>('imageTagMutabilityExclusionFilters');
