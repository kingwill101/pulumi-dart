...
import 'pull_time_update_exclusion_state.dart';
...
class PullTimeUpdateExclusion extends pulumi.CustomResource {
  ...
  /// Creates a new [PullTimeUpdateExclusion].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PullTimeUpdateExclusion]. {@macro pulumi_ecr_pull_time_update_exclusion_pull_time_update_exclusion_args_doc}
  ...
  static PullTimeUpdateExclusion get(
    String name,
