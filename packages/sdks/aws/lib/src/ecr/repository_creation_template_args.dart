...
class RepositoryCreationTemplateArgs {
  ...
  factory RepositoryCreationTemplateArgs.fromMap(Map<String, dynamic> map) {
    return RepositoryCreationTemplateArgs(
      appliedFors: pulumi.Input.fromValue(
        (map['appliedFors'] as List).cast<String>(),
      ),
      customRoleArn: (() {
        final guardedValue = map['customRoleArn'];
      ...
      encryptionConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                RepositoryCreationTemplateEncryptionConfiguration.fromMap(
      ...
      imageTagMutabilityExclusionFilters: (() {
        final guardedValue = map['imageTagMutabilityExclusionFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            RepositoryCreationTemplateImageTagMutabilityExclusionFilter
          >(
            guardedValue,
            (value) =>
                RepositoryCreationTemplateImageTagMutabilityExclusionFilter.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      repositoryPolicy: (() {
        final guardedValue = map['repositoryPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      resourceTags: (() {
