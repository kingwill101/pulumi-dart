...
class PullThroughCacheRuleArgs {
  ...
  PullThroughCacheRuleArgs({
    ...
    required pulumi.Output<String> ecrRepositoryPrefix,
    pulumi.Output<String>? region,
    required pulumi.Output<String> upstreamRegistryUrl,
  ...
  factory PullThroughCacheRuleArgs.fromMap(Map<String, dynamic> map) {
    return PullThroughCacheRuleArgs(
      ...
      ecrRepositoryPrefix: pulumi.Output.create<String>(map['ecrRepositoryPrefix'] as String),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      upstreamRegistryUrl: pulumi.Output.create<String>(map['upstreamRegistryUrl'] as String),
