...
class PullThroughCacheRuleArgs {
  ...
  factory PullThroughCacheRuleArgs.fromMap(Map<String, dynamic> map) {
    return PullThroughCacheRuleArgs(
      credentialArn: (() {
        final guardedValue = map['credentialArn'];
      ...
      ecrRepositoryPrefix: pulumi.Input.fromValue(
        map['ecrRepositoryPrefix'] as String,
      ),
      region: (() {
      ...
      upstreamRegistryUrl: pulumi.Input.fromValue(
        map['upstreamRegistryUrl'] as String,
      ),
      upstreamRepositoryPrefix: (() {
        final guardedValue = map['upstreamRepositoryPrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
