...
class LifecyclePolicySelection {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'countType': pulumi.Input.mapInputValue<LifecyclePolicyCountType, String>(countType, (value) => value.wireValue),
      'countUnit': ?countUnit,
      'tagPrefixList': ?tagPrefixList,
      'tagStatus': pulumi.Input.mapInputValue<LifecyclePolicyTagStatus, String>(tagStatus, (value) => value.wireValue),
    };
  }
  ...
  factory LifecyclePolicySelection.fromMap(Map<String, dynamic> map) {
    return LifecyclePolicySelection(
      ...
      countType: pulumi.Input.fromValue(LifecyclePolicyCountType.fromValue(map['countType']! as String)),
      ...
      tagStatus: pulumi.Input.fromValue(LifecyclePolicyTagStatus.fromValue(map['tagStatus']! as String)),
    );
  }
}
