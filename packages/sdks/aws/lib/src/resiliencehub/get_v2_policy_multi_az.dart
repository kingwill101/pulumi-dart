...
class GetV2PolicyMultiAz {
  ...
  /// Creates a new [GetV2PolicyMultiAz].
  ...
  factory GetV2PolicyMultiAz.fromMap(Map<String, dynamic> map) {
    return GetV2PolicyMultiAz(
