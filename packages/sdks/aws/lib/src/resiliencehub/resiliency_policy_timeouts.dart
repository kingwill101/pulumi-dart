...
class ResiliencyPolicyTimeouts {
  ...
  /// Creates a new [ResiliencyPolicyTimeouts].
  ...
  ResiliencyPolicyTimeouts({this.create, this.delete, this.update});
  ...
  factory ResiliencyPolicyTimeouts.fromMap(Map<String, dynamic> map) {
    return ResiliencyPolicyTimeouts(
      create: (() {
