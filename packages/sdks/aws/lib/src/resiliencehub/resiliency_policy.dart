...
import 'resiliency_policy_state.dart';
...
class ResiliencyPolicy extends pulumi.CustomResource {
  ...
  ResiliencyPolicy(
    ...
    this.dataLocationConstraint = registerOutput<String>('dataLocationConstraint');
