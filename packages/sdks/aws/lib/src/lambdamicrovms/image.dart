...
class Image extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ImageCodeArtifact> codeArtifact;
  /// CPU configuration for the MicroVM. See `cpuConfiguration` Block below.
  late final pulumi.Output<List<ImageCpuConfiguration>?> cpuConfigurations;
  ...
  /// [args] Arguments used to configure this [Image]. {@macro pulumi_lambdamicrovms_image_image_args_doc}
  ...
  Image(
    ...
    pulumi.CustomResourceOptions? options,
          ...
          'aws:lambdamicrovms/image:Image',
          name,
    ...
    codeArtifact = registerOutput<ImageCodeArtifact>('codeArtifact', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ImageCodeArtifact.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    cpuConfigurations = registerOutput<List<ImageCpuConfiguration>?>('cpuConfigurations', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ImageCpuConfiguration>(guardedValue, (value) => ImageCpuConfiguration.fromMap((value as Map).cast<String, dynamic>())); });
