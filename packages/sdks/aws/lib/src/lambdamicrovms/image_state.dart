...
class ImageState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'codeArtifact': ?pulumi.Input.mapOptionalInputValue<ImageCodeArtifact, Map<String, dynamic>>(codeArtifact, (value) => value.toMap()),
  ...
  factory ImageState.fromMap(Map<String, dynamic> map) {
    return ImageState(
      ...
      codeArtifact: (() { final guardedValue = map['codeArtifact']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ImageCodeArtifact.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
