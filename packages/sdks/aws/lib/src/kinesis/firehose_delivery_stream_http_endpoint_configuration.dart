    ...
    return <String, dynamic>{
      ...
      'requestConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfiguration,
            Map<String, dynamic>
          >(requestConfiguration, (value) => value.toMap()),
      ...
      'secretsManagerConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamHttpEndpointConfigurationSecretsManagerConfiguration,
            Map<String, dynamic>
          >(secretsManagerConfiguration, (value) => value.toMap()),
      'url': url,
    };
  }
    ...
    return FirehoseDeliveryStreamHttpEndpointConfiguration(
      ...
      cloudwatchLoggingOptions: (() {
        ...
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptions.fromMap(
      ...
      processingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      requestConfiguration: (() {
        final guardedValue = map['requestConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      s3Configuration: pulumi.Input.fromValue(
        FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration.fromMap(
          (map['s3Configuration']! as Map).cast<String, dynamic>(),
        ),
      ),
      secretsManagerConfiguration: (() {
        final guardedValue = map['secretsManagerConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamHttpEndpointConfigurationSecretsManagerConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
