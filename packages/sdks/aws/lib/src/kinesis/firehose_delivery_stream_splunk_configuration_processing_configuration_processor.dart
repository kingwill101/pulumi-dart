...
class FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor {
  ...
  const FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor({
    this.parameters,
    required this.type,
  });
  ...
  factory FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor(
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter>(guardedValue, (value) => FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
