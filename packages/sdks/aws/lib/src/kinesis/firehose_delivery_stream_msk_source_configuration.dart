...
class FirehoseDeliveryStreamMskSourceConfiguration {
  ...
  factory FirehoseDeliveryStreamMskSourceConfiguration.fromMap(
    ...
    return FirehoseDeliveryStreamMskSourceConfiguration(
      authenticationConfiguration: pulumi.Input.fromValue(
        FirehoseDeliveryStreamMskSourceConfigurationAuthenticationConfiguration.fromMap(
          (map['authenticationConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      mskClusterArn: pulumi.Input.fromValue(map['mskClusterArn'] as String),
      readFromTimestamp: (() {
        final guardedValue = map['readFromTimestamp'];
