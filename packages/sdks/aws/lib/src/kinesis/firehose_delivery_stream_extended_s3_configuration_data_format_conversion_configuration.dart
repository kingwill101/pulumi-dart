...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration {
  ...
  /// [inputFormatConfiguration] Specifies the deserializer that you want Kinesis Data Firehose to use to convert the format of your data from JSON. See `inputFormatConfiguration` block below for details.
  /// [outputFormatConfiguration] Specifies the serializer that you want Kinesis Data Firehose to use to convert the format of your data to the Parquet or ORC format. See `outputFormatConfiguration` block below for details.
  /// [schemaConfiguration] Specifies the AWS Glue Data Catalog table that contains the column information. See `schemaConfiguration` block below for details.
  const FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration({
    this.enabled,
  ...
  factory FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration(
      ...
      inputFormatConfiguration: pulumi.Input.fromValue(FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfiguration.fromMap((map['inputFormatConfiguration']! as Map).cast<String, dynamic>())),
      outputFormatConfiguration: pulumi.Input.fromValue(FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfiguration.fromMap((map['outputFormatConfiguration']! as Map).cast<String, dynamic>())),
      schemaConfiguration: pulumi.Input.fromValue(FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationSchemaConfiguration.fromMap((map['schemaConfiguration']! as Map).cast<String, dynamic>())),
    );
  }
}
