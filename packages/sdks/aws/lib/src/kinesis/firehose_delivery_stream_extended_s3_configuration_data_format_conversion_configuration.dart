...
class FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration {
    ...
    return <String, dynamic>{
      ...
      'inputFormatConfiguration':
          pulumi.Input.mapInputValue<
            FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfiguration,
            Map<String, dynamic>
          >(inputFormatConfiguration, (value) => value.toMap()),
      'outputFormatConfiguration':
          pulumi.Input.mapInputValue<
            FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfiguration,
            Map<String, dynamic>
          >(outputFormatConfiguration, (value) => value.toMap()),
      'schemaConfiguration':
          pulumi.Input.mapInputValue<
            FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationSchemaConfiguration,
            Map<String, dynamic>
          >(schemaConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration.fromMap(
    ...
    return FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration(
      ...
      inputFormatConfiguration: pulumi.Input.fromValue(
        FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationInputFormatConfiguration.fromMap(
          (map['inputFormatConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      outputFormatConfiguration: pulumi.Input.fromValue(
        FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfiguration.fromMap(
          (map['outputFormatConfiguration']! as Map).cast<String, dynamic>(),
        ),
      ),
      schemaConfiguration: pulumi.Input.fromValue(
        FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationSchemaConfiguration.fromMap(
