...
class FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions {
  ...
  const FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions({
    this.enabled,
    this.logGroupName,
    this.logStreamName,
  });
  ...
  factory FirehoseDeliveryStreamOpensearchserverlessConfigurationCloudwatchLoggingOptions.fromMap(Map<String, dynamic> map) {
