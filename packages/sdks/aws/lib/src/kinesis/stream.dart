...
class Stream extends pulumi.CustomResource {
  ...
  Stream(
    ...
    this.enforceConsumerDeletion = registerOutput<bool?>('enforceConsumerDeletion');
    ...
    this.streamModeDetails = registerOutput<StreamStreamModeDetails>('streamModeDetails');
