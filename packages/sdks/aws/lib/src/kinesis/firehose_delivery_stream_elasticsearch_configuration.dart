...
class FirehoseDeliveryStreamElasticsearchConfiguration {
  ...
  final FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  final FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfiguration? processingConfiguration;
  ...
  final FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration s3Configuration;
  ...
  factory FirehoseDeliveryStreamElasticsearchConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamElasticsearchConfiguration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
      ...
      processingConfiguration: map['processingConfiguration'] == null ? null : FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      ...
      s3Configuration: FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration.fromMap((map['s3Configuration'] as Map).cast<String, dynamic>()),
      typeName: map['typeName'] == null ? null : map['typeName'] as String,
      vpcConfig: map['vpcConfig'] == null ? null : FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
