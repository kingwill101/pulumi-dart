  ...
  factory StreamState.fromMap(Map<String, dynamic> map) {
    return StreamState(
      ...
      enforceConsumerDeletion: (() {
        final guardedValue = map['enforceConsumerDeletion'];
        if (guardedValue == null) return null;
      ...
      maxRecordSizeInKib: (() {
        final guardedValue = map['maxRecordSizeInKib'];
        if (guardedValue == null) return null;
      ...
      shardLevelMetrics: (() {
        final guardedValue = map['shardLevelMetrics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      streamModeDetails: (() {
        final guardedValue = map['streamModeDetails'];
        if (guardedValue == null) return null;
