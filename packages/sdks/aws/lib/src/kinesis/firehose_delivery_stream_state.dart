...
class FirehoseDeliveryStreamState {
  ...
  factory FirehoseDeliveryStreamState.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamState(
      ...
      elasticsearchConfiguration: map['elasticsearchConfiguration'] == null ? null : (FirehoseDeliveryStreamElasticsearchConfiguration.fromMap((map['elasticsearchConfiguration'] as Map).cast<String, dynamic>())).input(),
      extendedS3Configuration: map['extendedS3Configuration'] == null ? null : (FirehoseDeliveryStreamExtendedS3Configuration.fromMap((map['extendedS3Configuration'] as Map).cast<String, dynamic>())).input(),
      httpEndpointConfiguration: map['httpEndpointConfiguration'] == null ? null : (FirehoseDeliveryStreamHttpEndpointConfiguration.fromMap((map['httpEndpointConfiguration'] as Map).cast<String, dynamic>())).input(),
      icebergConfiguration: map['icebergConfiguration'] == null ? null : (FirehoseDeliveryStreamIcebergConfiguration.fromMap((map['icebergConfiguration'] as Map).cast<String, dynamic>())).input(),
      kinesisSourceConfiguration: map['kinesisSourceConfiguration'] == null ? null : (FirehoseDeliveryStreamKinesisSourceConfiguration.fromMap((map['kinesisSourceConfiguration'] as Map).cast<String, dynamic>())).input(),
      mskSourceConfiguration: map['mskSourceConfiguration'] == null ? null : (FirehoseDeliveryStreamMskSourceConfiguration.fromMap((map['mskSourceConfiguration'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      opensearchConfiguration: map['opensearchConfiguration'] == null ? null : (FirehoseDeliveryStreamOpensearchConfiguration.fromMap((map['opensearchConfiguration'] as Map).cast<String, dynamic>())).input(),
      opensearchserverlessConfiguration: map['opensearchserverlessConfiguration'] == null ? null : (FirehoseDeliveryStreamOpensearchserverlessConfiguration.fromMap((map['opensearchserverlessConfiguration'] as Map).cast<String, dynamic>())).input(),
      redshiftConfiguration: map['redshiftConfiguration'] == null ? null : (FirehoseDeliveryStreamRedshiftConfiguration.fromMap((map['redshiftConfiguration'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      serverSideEncryption: map['serverSideEncryption'] == null ? null : (FirehoseDeliveryStreamServerSideEncryption.fromMap((map['serverSideEncryption'] as Map).cast<String, dynamic>())).input(),
      snowflakeConfiguration: map['snowflakeConfiguration'] == null ? null : (FirehoseDeliveryStreamSnowflakeConfiguration.fromMap((map['snowflakeConfiguration'] as Map).cast<String, dynamic>())).input(),
      splunkConfiguration: map['splunkConfiguration'] == null ? null : (FirehoseDeliveryStreamSplunkConfiguration.fromMap((map['splunkConfiguration'] as Map).cast<String, dynamic>())).input(),
