...
class FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter {
  ...
  /// Creates a new [FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter].
  ...
  const FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter({
  ...
  factory FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter(
