...
class FirehoseDeliveryStreamIcebergConfiguration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamIcebergConfigurationS3Configuration>
  s3Configuration;
  ...
  factory FirehoseDeliveryStreamIcebergConfiguration.fromMap(
    ...
    return FirehoseDeliveryStreamIcebergConfiguration(
      appendOnly: (() {
        final guardedValue = map['appendOnly'];
      ...
      cloudwatchLoggingOptions: (() {
        ...
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamIcebergConfigurationCloudwatchLoggingOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      destinationTableConfigurations: (() {
        final guardedValue = map['destinationTableConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                FirehoseDeliveryStreamIcebergConfigurationDestinationTableConfiguration.fromMap(
      ...
      processingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamIcebergConfigurationProcessingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
