...
class FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration {
  ...
  /// Creates a new [FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration].
  ...
  const FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration({
    this.enabled,
    this.roleArn,
    this.secretArn,
  });
