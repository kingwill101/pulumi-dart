...
class FirehoseDeliveryStreamOpensearchserverlessConfiguration {
  ...
  /// [roleArn] ARN of the IAM role to be assumed by Kinesis Data Firehose for calling the Serverless offering for Amazon OpenSearch Service Configuration API and for indexing documents.  The pattern needs to be `arn:.*`.
