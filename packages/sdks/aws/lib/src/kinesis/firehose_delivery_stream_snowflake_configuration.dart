...
class FirehoseDeliveryStreamSnowflakeConfiguration {
    ...
    return <String, dynamic>{
      ...
      'snowflakeRoleConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamSnowflakeConfigurationSnowflakeRoleConfiguration,
            Map<String, dynamic>
          >(snowflakeRoleConfiguration, (value) => value.toMap()),
      'snowflakeVpcConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamSnowflakeConfigurationSnowflakeVpcConfiguration,
            Map<String, dynamic>
          >(snowflakeVpcConfiguration, (value) => value.toMap()),
      'table': table,
      'user': ?user,
    };
  }
  ...
  factory FirehoseDeliveryStreamSnowflakeConfiguration.fromMap(
    ...
    return FirehoseDeliveryStreamSnowflakeConfiguration(
      ...
      contentColumnName: (() {
        final guardedValue = map['contentColumnName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataLoadingOption: (() {
        final guardedValue = map['dataLoadingOption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      database: pulumi.Input.fromValue(map['database'] as String),
      keyPassphrase: (() {
        final guardedValue = map['keyPassphrase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      metadataColumnName: (() {
        final guardedValue = map['metadataColumnName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateKey: (() {
      ...
      snowflakeRoleConfiguration: (() {
        final guardedValue = map['snowflakeRoleConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      snowflakeVpcConfiguration: (() {
        final guardedValue = map['snowflakeVpcConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
