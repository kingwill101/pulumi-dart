...
class FirehoseDeliveryStreamRedshiftConfiguration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamRedshiftConfigurationS3Configuration>
  s3Configuration;
  final pulumi.Input<
  ...
  factory FirehoseDeliveryStreamRedshiftConfiguration.fromMap(
    ...
    return FirehoseDeliveryStreamRedshiftConfiguration(
      ...
      copyOptions: (() {
        final guardedValue = map['copyOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataTableColumns: (() {
        final guardedValue = map['dataTableColumns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
