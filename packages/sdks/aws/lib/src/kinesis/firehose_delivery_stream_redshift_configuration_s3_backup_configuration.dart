...
class FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions>? cloudwatchLoggingOptions;
  ...
  /// [roleArn] Required.
  const FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudwatchLoggingOptions': ?pulumi.Input.mapOptionalInputValue<FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions, Map<String, dynamic>>(cloudwatchLoggingOptions, (value) => value.toMap()),
  ...
  factory FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration(
      ...
      cloudwatchLoggingOptions: (() { final guardedValue = map['cloudwatchLoggingOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
