...
class FirehoseDeliveryStreamSplunkConfigurationS3Configuration {
  ...
  final FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  factory FirehoseDeliveryStreamSplunkConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamSplunkConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
