...
class FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfiguration {
  ...
  final pulumi.Input<List<FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfigurationProcessor>>? processors;
  ...
  const FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfiguration({
    this.enabled,
    this.processors,
  });
  ...
  factory FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfiguration(
      ...
      processors: (() { final guardedValue = map['processors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfigurationProcessor>(guardedValue, (value) => FirehoseDeliveryStreamSnowflakeConfigurationProcessingConfigurationProcessor.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
