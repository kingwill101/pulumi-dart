...
class FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration {
  ...
  factory FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration.fromMap(
    ...
    return FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: (() {
        ...
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap(
