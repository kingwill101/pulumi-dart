...
import 'firehose_delivery_stream_snowflake_configuration_s3_configuration_cloudwatch_logging_options.dart';

class FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions?>? cloudwatchLoggingOptions;
  ...
  /// Creates a new [FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration].
  ...
  const FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudwatchLoggingOptions': ?pulumi.Input.mapOptionalInputValue<FirehoseDeliveryStreamSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions, Map<String, dynamic>>(cloudwatchLoggingOptions, (value) => value.toMap()),
  ...
  factory FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: (() { final guardedValue = map['cloudwatchLoggingOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirehoseDeliveryStreamSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
