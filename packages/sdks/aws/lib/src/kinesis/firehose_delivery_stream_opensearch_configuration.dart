...
class FirehoseDeliveryStreamOpensearchConfiguration {
  ...
  /// [documentIdOptions] The method for setting up document ID. See [`documentIdOptions` block] below for details.
  ...
  /// [vpcConfig] The VPC configuration for the delivery stream to connect to OpenSearch associated with the VPC. See `vpcConfig` block below for details.
