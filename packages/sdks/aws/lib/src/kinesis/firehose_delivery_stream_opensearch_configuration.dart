...
class FirehoseDeliveryStreamOpensearchConfiguration {
  ...
  factory FirehoseDeliveryStreamOpensearchConfiguration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamOpensearchConfiguration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : ((FirehoseDeliveryStreamOpensearchConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions']! as Map).cast<String, dynamic>())).input()).input(),
      clusterEndpoint: map['clusterEndpoint'] == null ? null : ((map['clusterEndpoint'] as String).input()).input(),
      documentIdOptions: map['documentIdOptions'] == null ? null : ((FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions.fromMap((map['documentIdOptions']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      processingConfiguration: map['processingConfiguration'] == null ? null : ((FirehoseDeliveryStreamOpensearchConfigurationProcessingConfiguration.fromMap((map['processingConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      vpcConfig: map['vpcConfig'] == null ? null : ((FirehoseDeliveryStreamOpensearchConfigurationVpcConfig.fromMap((map['vpcConfig']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
