...
class FirehoseDeliveryStreamOpensearchConfiguration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamOpensearchConfigurationVpcConfig>?
  vpcConfig;
    ...
    return <String, dynamic>{
      ...
      'documentIdOptions':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions,
            Map<String, dynamic>
          >(documentIdOptions, (value) => value.toMap()),
      'domainArn': ?domainArn,
      'indexName': indexName,
    ...
    return FirehoseDeliveryStreamOpensearchConfiguration(
      ...
      cloudwatchLoggingOptions: (() {
        ...
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamOpensearchConfigurationCloudwatchLoggingOptions.fromMap(
      ...
      documentIdOptions: (() {
        final guardedValue = map['documentIdOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      processingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamOpensearchConfigurationProcessingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
