...
class AnalyticsApplicationInputsSchema {
  ...
  final pulumi.Input<List<AnalyticsApplicationInputsSchemaRecordColumn>>
  recordColumns;
    ...
    return <String, dynamic>{
      'recordColumns':
          pulumi.Input.mapInputValue<
            List<AnalyticsApplicationInputsSchemaRecordColumn>,
  ...
  factory AnalyticsApplicationInputsSchema.fromMap(Map<String, dynamic> map) {
    return AnalyticsApplicationInputsSchema(
      ...
      recordFormat: pulumi.Input.fromValue(
        AnalyticsApplicationInputsSchemaRecordFormat.fromMap(
