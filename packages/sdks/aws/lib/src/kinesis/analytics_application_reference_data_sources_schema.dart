...
class AnalyticsApplicationReferenceDataSourcesSchema {
  ...
  final pulumi.Input<
    List<AnalyticsApplicationReferenceDataSourcesSchemaRecordColumn>
  >
  recordColumns;
  ...
  final pulumi.Input<AnalyticsApplicationReferenceDataSourcesSchemaRecordFormat>
  recordFormat;
    ...
    return AnalyticsApplicationReferenceDataSourcesSchema(
      recordColumns: pulumi.Input.fromValue(
        ...
        >(
          map['recordColumns']!,
          (value) =>
              AnalyticsApplicationReferenceDataSourcesSchemaRecordColumn.fromMap(
