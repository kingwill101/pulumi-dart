...
class FirehoseDeliveryStreamExtendedS3Configuration {
    ...
    return <String, dynamic>{
      ...
      'dataFormatConversionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration,
            Map<String, dynamic>
          >(dataFormatConversionConfiguration, (value) => value.toMap()),
      'dynamicPartitioningConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration,
            Map<String, dynamic>
          >(dynamicPartitioningConfiguration, (value) => value.toMap()),
      ...
      's3BackupConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration,
            Map<String, dynamic>
          >(s3BackupConfiguration, (value) => value.toMap()),
  ...
  factory FirehoseDeliveryStreamExtendedS3Configuration.fromMap(
    ...
    return FirehoseDeliveryStreamExtendedS3Configuration(
      ...
      customTimeZone: (() {
        final guardedValue = map['customTimeZone'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataFormatConversionConfiguration: (() {
        final guardedValue = map['dataFormatConversionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dynamicPartitioningConfiguration: (() {
        final guardedValue = map['dynamicPartitioningConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fileExtension: (() {
        final guardedValue = map['fileExtension'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kmsKeyArn: (() {
      ...
      s3BackupConfiguration: (() {
        final guardedValue = map['s3BackupConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
