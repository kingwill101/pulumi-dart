...
class FirehoseDeliveryStreamExtendedS3Configuration {
  ...
  factory FirehoseDeliveryStreamExtendedS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamExtendedS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : ((FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions']! as Map).cast<String, dynamic>())).input()).input(),
      compressionFormat: map['compressionFormat'] == null ? null : ((map['compressionFormat'] as String).input()).input(),
      customTimeZone: map['customTimeZone'] == null ? null : ((map['customTimeZone'] as String).input()).input(),
      dataFormatConversionConfiguration: map['dataFormatConversionConfiguration'] == null ? null : ((FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfiguration.fromMap((map['dataFormatConversionConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      dynamicPartitioningConfiguration: map['dynamicPartitioningConfiguration'] == null ? null : ((FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration.fromMap((map['dynamicPartitioningConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      errorOutputPrefix: map['errorOutputPrefix'] == null ? null : ((map['errorOutputPrefix'] as String).input()).input(),
      fileExtension: map['fileExtension'] == null ? null : ((map['fileExtension'] as String).input()).input(),
      ...
      processingConfiguration: map['processingConfiguration'] == null ? null : ((FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfiguration.fromMap((map['processingConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      roleArn: (map['roleArn'] as String).input(),
      s3BackupConfiguration: map['s3BackupConfiguration'] == null ? null : ((FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.fromMap((map['s3BackupConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
