...
class FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration {
  ...
  final FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptions? cloudwatchLoggingOptions;
  ...
  factory FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: map['cloudwatchLoggingOptions'] == null ? null : FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap((map['cloudwatchLoggingOptions'] as Map).cast<String, dynamic>()),
