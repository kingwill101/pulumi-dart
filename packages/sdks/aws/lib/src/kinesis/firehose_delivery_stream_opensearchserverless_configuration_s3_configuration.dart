...
class FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration {
  ...
  factory FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration.fromMap(
    ...
    return FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: (() {
        ...
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap(
