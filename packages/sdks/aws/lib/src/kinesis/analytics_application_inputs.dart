...
class AnalyticsApplicationInputs {
  ...
  final AnalyticsApplicationInputsProcessingConfiguration? processingConfiguration;
  /// The Schema format of the data in the streaming source. See Source Schema below for more details.
  final AnalyticsApplicationInputsSchema schema;
  /// The point at which the application starts processing records from the streaming source.
  /// See Starting Position Configuration below for more details.
  final List<AnalyticsApplicationInputsStartingPositionConfiguration>? startingPositionConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'schema': schema.toMap(),
      'startingPositionConfigurations': ?startingPositionConfigurations == null ? null : pulumi.Input.encodeList<AnalyticsApplicationInputsStartingPositionConfiguration, Map<String, dynamic>>(startingPositionConfigurations!, (value) => value.toMap()),
  ...
  factory AnalyticsApplicationInputs.fromMap(Map<String, dynamic> map) {
    return AnalyticsApplicationInputs(
      ...
      kinesisFirehose: map['kinesisFirehose'] == null ? null : AnalyticsApplicationInputsKinesisFirehose.fromMap((map['kinesisFirehose'] as Map).cast<String, dynamic>()),
      kinesisStream: map['kinesisStream'] == null ? null : AnalyticsApplicationInputsKinesisStream.fromMap((map['kinesisStream'] as Map).cast<String, dynamic>()),
      namePrefix: map['namePrefix'] as String,
      parallelism: map['parallelism'] == null ? null : AnalyticsApplicationInputsParallelism.fromMap((map['parallelism'] as Map).cast<String, dynamic>()),
      processingConfiguration: map['processingConfiguration'] == null ? null : AnalyticsApplicationInputsProcessingConfiguration.fromMap((map['processingConfiguration'] as Map).cast<String, dynamic>()),
      schema: AnalyticsApplicationInputsSchema.fromMap((map['schema'] as Map).cast<String, dynamic>()),
      startingPositionConfigurations: map['startingPositionConfigurations'] == null ? null : pulumi.Input.decodeList<AnalyticsApplicationInputsStartingPositionConfiguration>(map['startingPositionConfigurations'], (value) => AnalyticsApplicationInputsStartingPositionConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      streamNames: map['streamNames'] == null ? null : (map['streamNames'] as List).cast<String>(),
    );
  }
}
