...
import 'firehose_delivery_stream_http_endpoint_configuration_s3_configuration_cloudwatch_logging_options.dart';
...
class FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptions?>? cloudwatchLoggingOptions;
  ...
  /// Creates a new [FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration].
  ...
  const FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudwatchLoggingOptions': ?pulumi.Input.mapOptionalInputValue<FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptions, Map<String, dynamic>>(cloudwatchLoggingOptions, (value) => value.toMap()),
  ...
  factory FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: (() { final guardedValue = map['cloudwatchLoggingOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
