...
import 'firehose_delivery_stream_opensearch_configuration_s3_configuration_cloudwatch_logging_options.dart';
...
class FirehoseDeliveryStreamOpensearchConfigurationS3Configuration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions?>? cloudwatchLoggingOptions;
  ...
  /// Creates a new [FirehoseDeliveryStreamOpensearchConfigurationS3Configuration].
  ...
  const FirehoseDeliveryStreamOpensearchConfigurationS3Configuration({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'cloudwatchLoggingOptions': ?pulumi.Input.mapOptionalInputValue<FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions, Map<String, dynamic>>(cloudwatchLoggingOptions, (value) => value.toMap()),
  ...
  factory FirehoseDeliveryStreamOpensearchConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return FirehoseDeliveryStreamOpensearchConfigurationS3Configuration(
      ...
      cloudwatchLoggingOptions: (() { final guardedValue = map['cloudwatchLoggingOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
