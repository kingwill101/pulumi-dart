...
class FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter {
  ...
  /// Creates a new [FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter].
  ...
  const FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter({
  ...
  factory FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter.fromMap(Map<String, dynamic> map) {
