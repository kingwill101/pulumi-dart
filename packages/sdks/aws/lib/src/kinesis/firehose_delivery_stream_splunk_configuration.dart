...
class FirehoseDeliveryStreamSplunkConfiguration {
  ...
  final pulumi.Input<FirehoseDeliveryStreamSplunkConfigurationS3Configuration>
  s3Configuration;
  final pulumi.Input<
    ...
    return FirehoseDeliveryStreamSplunkConfiguration(
      ...
      cloudwatchLoggingOptions: (() {
        ...
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hecAcknowledgmentTimeout: (() {
        final guardedValue = map['hecAcknowledgmentTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      hecEndpoint: pulumi.Input.fromValue(map['hecEndpoint'] as String),
      hecEndpointType: (() {
        final guardedValue = map['hecEndpointType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hecToken: (() {
        final guardedValue = map['hecToken'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      processingConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamSplunkConfigurationProcessingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      secretsManagerConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
