...
class GetIndexIndexStatistic {
  ...
  final pulumi.Input<List<GetIndexIndexStatisticTextDocumentStatistic>>
    ...
    return <String, dynamic>{
      'faqStatistics':
          pulumi.Input.mapInputValue<
            List<GetIndexIndexStatisticFaqStatistic>,
      ...
      'textDocumentStatistics':
          pulumi.Input.mapInputValue<
            List<GetIndexIndexStatisticTextDocumentStatistic>,
            List<Map<String, dynamic>>
          >(
            textDocumentStatistics,
            (value) =>
  ...
  factory GetIndexIndexStatistic.fromMap(Map<String, dynamic> map) {
    return GetIndexIndexStatistic(
      faqStatistics: pulumi.Input.fromValue(
      ...
      textDocumentStatistics: pulumi.Input.fromValue(
