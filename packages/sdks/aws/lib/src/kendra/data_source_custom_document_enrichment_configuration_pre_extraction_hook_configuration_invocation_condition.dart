...
class DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition {
  ...
  final pulumi.Input<DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue>? conditionOnValue;
  ...
  const DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'conditionOnValue': ?pulumi.Input.mapOptionalInputValue<DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue, Map<String, dynamic>>(conditionOnValue, (value) => value.toMap()),
      'operator': operator,
    };
  }
  ...
  factory DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition.fromMap(Map<String, dynamic> map) {
    return DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition(
      ...
      conditionOnValue: (() { final guardedValue = map['conditionOnValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
