...
class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration {
  ...
  const DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration({
  ...
  factory DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration.fromMap(Map<String, dynamic> map) {
    return DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration(
      invocationCondition: (() { final guardedValue = map['invocationCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
