...
class DataSourceConfigurationWebCrawlerConfigurationUrls {
  ...
  final DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration? seedUrlConfiguration;
  ...
  final DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfiguration? siteMapsConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seedUrlConfiguration': ?seedUrlConfiguration == null ? null : seedUrlConfiguration!.toMap(),
      'siteMapsConfiguration': ?siteMapsConfiguration == null ? null : siteMapsConfiguration!.toMap(),
    };
  }
  ...
  factory DataSourceConfigurationWebCrawlerConfigurationUrls.fromMap(Map<String, dynamic> map) {
    return DataSourceConfigurationWebCrawlerConfigurationUrls(
      seedUrlConfiguration: map['seedUrlConfiguration'] == null ? null : DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration.fromMap((map['seedUrlConfiguration'] as Map).cast<String, dynamic>()),
      siteMapsConfiguration: map['siteMapsConfiguration'] == null ? null : DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfiguration.fromMap((map['siteMapsConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
