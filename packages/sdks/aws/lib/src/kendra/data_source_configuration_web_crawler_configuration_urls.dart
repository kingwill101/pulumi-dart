...
class DataSourceConfigurationWebCrawlerConfigurationUrls {
  ...
  factory DataSourceConfigurationWebCrawlerConfigurationUrls.fromMap(Map<String, dynamic> map) {
    return DataSourceConfigurationWebCrawlerConfigurationUrls(
      seedUrlConfiguration: (() { final guardedValue = map['seedUrlConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      siteMapsConfiguration: (() { final guardedValue = map['siteMapsConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
