...
class ExperienceState {
  ...
  factory ExperienceState.fromMap(Map<String, dynamic> map) {
    return ExperienceState(
      ...
      endpoints: (() { final guardedValue = map['endpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExperienceEndpoint>(guardedValue, (value) => ExperienceEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      experienceId: (() { final guardedValue = map['experienceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
