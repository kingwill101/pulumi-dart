...
class ExperienceConfiguration {
  ...
  final ExperienceConfigurationContentSourceConfiguration? contentSourceConfiguration;
  /// The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below.
  final ExperienceConfigurationUserIdentityConfiguration? userIdentityConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentSourceConfiguration': ?contentSourceConfiguration == null ? null : contentSourceConfiguration!.toMap(),
      'userIdentityConfiguration': ?userIdentityConfiguration == null ? null : userIdentityConfiguration!.toMap(),
    };
  }

  factory ExperienceConfiguration.fromMap(Map<String, dynamic> map) {
    return ExperienceConfiguration(
      contentSourceConfiguration: map['contentSourceConfiguration'] == null ? null : ExperienceConfigurationContentSourceConfiguration.fromMap((map['contentSourceConfiguration'] as Map).cast<String, dynamic>()),
      userIdentityConfiguration: map['userIdentityConfiguration'] == null ? null : ExperienceConfigurationUserIdentityConfiguration.fromMap((map['userIdentityConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
