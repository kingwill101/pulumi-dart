...
class ExperienceConfiguration {
  ...
  final pulumi.Input<ExperienceConfigurationContentSourceConfiguration>?
  contentSourceConfiguration;

  /// The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below.
  final pulumi.Input<ExperienceConfigurationUserIdentityConfiguration>?
    ...
    return <String, dynamic>{
      'contentSourceConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(contentSourceConfiguration, (value) => value.toMap()),
      'userIdentityConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ExperienceConfigurationUserIdentityConfiguration,
            Map<String, dynamic>
          >(userIdentityConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory ExperienceConfiguration.fromMap(Map<String, dynamic> map) {
    return ExperienceConfiguration(
      contentSourceConfiguration: (() {
        final guardedValue = map['contentSourceConfiguration'];
      ...
      userIdentityConfiguration: (() {
        final guardedValue = map['userIdentityConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
