...
class GetQuerySuggestionsBlockListResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': region,
      'roleArn': roleArn,
      'sourceS3Paths': pulumi.Input.encodeList<GetQuerySuggestionsBlockListSourceS3Path, Map<String, dynamic>>(sourceS3Paths, (value) => value.toMap()),
      'status': status,
      'tags': tags,
      'updatedAt': updatedAt,
    };
  ...
  factory GetQuerySuggestionsBlockListResult.fromMap(Map<String, dynamic> map) {
    return GetQuerySuggestionsBlockListResult(
      ...
      sourceS3Paths: pulumi.Input.decodeList<GetQuerySuggestionsBlockListSourceS3Path>(map['sourceS3Paths']!, (value) => GetQuerySuggestionsBlockListSourceS3Path.fromMap((value as Map).cast<String, dynamic>())),
