...
class IndexUserTokenConfigurations {
  ...
  final pulumi.Input<IndexUserTokenConfigurationsJsonTokenTypeConfiguration>?
  jsonTokenTypeConfiguration;

  /// A block that specifies the information about the JWT token type configuration. Detailed below.
  final pulumi.Input<IndexUserTokenConfigurationsJwtTokenTypeConfiguration>?
    ...
    return <String, dynamic>{
      'jsonTokenTypeConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(jsonTokenTypeConfiguration, (value) => value.toMap()),
      'jwtTokenTypeConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            IndexUserTokenConfigurationsJwtTokenTypeConfiguration,
            Map<String, dynamic>
          >(jwtTokenTypeConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory IndexUserTokenConfigurations.fromMap(Map<String, dynamic> map) {
    return IndexUserTokenConfigurations(
      jsonTokenTypeConfiguration: (() {
        final guardedValue = map['jsonTokenTypeConfiguration'];
      ...
      jwtTokenTypeConfiguration: (() {
        final guardedValue = map['jwtTokenTypeConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
