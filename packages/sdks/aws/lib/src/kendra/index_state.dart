...
class IndexState {
  ...
  factory IndexState.fromMap(Map<String, dynamic> map) {
    return IndexState(
      ...
      indexStatistics: (() { final guardedValue = map['indexStatistics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<IndexIndexStatistic>(guardedValue, (value) => IndexIndexStatistic.fromMap((value as Map).cast<String, dynamic>()))); })(),
