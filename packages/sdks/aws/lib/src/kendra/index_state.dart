...
class IndexState {
  ...
  factory IndexState.fromMap(Map<String, dynamic> map) {
    return IndexState(
      ...
      indexStatistics: map['indexStatistics'] == null ? null : (pulumi.Input.decodeList<IndexIndexStatistic>(map['indexStatistics'], (value) => IndexIndexStatistic.fromMap((value as Map).cast<String, dynamic>()))).input(),
