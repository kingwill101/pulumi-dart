...
class DataSourceConfigurationWebCrawlerConfiguration {
  ...
  final DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration? authenticationConfiguration;
  ...
  final DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration? proxyConfiguration;
  ...
  factory DataSourceConfigurationWebCrawlerConfiguration.fromMap(Map<String, dynamic> map) {
    return DataSourceConfigurationWebCrawlerConfiguration(
      authenticationConfiguration: map['authenticationConfiguration'] == null ? null : DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration.fromMap((map['authenticationConfiguration'] as Map).cast<String, dynamic>()),
      crawlDepth: map['crawlDepth'] == null ? null : map['crawlDepth'] as int,
      maxContentSizePerPageInMegaBytes: map['maxContentSizePerPageInMegaBytes'] == null ? null : map['maxContentSizePerPageInMegaBytes'] as double,
      maxLinksPerPage: map['maxLinksPerPage'] == null ? null : map['maxLinksPerPage'] as int,
      maxUrlsPerMinuteCrawlRate: map['maxUrlsPerMinuteCrawlRate'] == null ? null : map['maxUrlsPerMinuteCrawlRate'] as int,
      proxyConfiguration: map['proxyConfiguration'] == null ? null : DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration.fromMap((map['proxyConfiguration'] as Map).cast<String, dynamic>()),
      urlExclusionPatterns: map['urlExclusionPatterns'] == null ? null : (map['urlExclusionPatterns'] as List).cast<String>(),
      urlInclusionPatterns: map['urlInclusionPatterns'] == null ? null : (map['urlInclusionPatterns'] as List).cast<String>(),
      urls: DataSourceConfigurationWebCrawlerConfigurationUrls.fromMap((map['urls'] as Map).cast<String, dynamic>()),
    );
  }
}
