...
class DataSourceConfigurationWebCrawlerConfiguration {
  ...
  const DataSourceConfigurationWebCrawlerConfiguration({
  ...
  factory DataSourceConfigurationWebCrawlerConfiguration.fromMap(Map<String, dynamic> map) {
    return DataSourceConfigurationWebCrawlerConfiguration(
      authenticationConfiguration: (() { final guardedValue = map['authenticationConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      crawlDepth: (() { final guardedValue = map['crawlDepth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      maxContentSizePerPageInMegaBytes: (() { final guardedValue = map['maxContentSizePerPageInMegaBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      maxLinksPerPage: (() { final guardedValue = map['maxLinksPerPage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      maxUrlsPerMinuteCrawlRate: (() { final guardedValue = map['maxUrlsPerMinuteCrawlRate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      proxyConfiguration: (() { final guardedValue = map['proxyConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      urlExclusionPatterns: (() { final guardedValue = map['urlExclusionPatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      urlInclusionPatterns: (() { final guardedValue = map['urlInclusionPatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      urls: pulumi.Input.fromValue(DataSourceConfigurationWebCrawlerConfigurationUrls.fromMap((map['urls']! as Map).cast<String, dynamic>())),
    );
  }
}
