...
class DataSourceConfigurationWebCrawlerConfiguration {
  ...
  factory DataSourceConfigurationWebCrawlerConfiguration.fromMap(Map<String, dynamic> map) {
    return DataSourceConfigurationWebCrawlerConfiguration(
      ...
      crawlDepth: (() { final guardedValue = map['crawlDepth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxContentSizePerPageInMegaBytes: (() { final guardedValue = map['maxContentSizePerPageInMegaBytes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      maxLinksPerPage: (() { final guardedValue = map['maxLinksPerPage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxUrlsPerMinuteCrawlRate: (() { final guardedValue = map['maxUrlsPerMinuteCrawlRate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
