...
class GetIndexDocumentMetadataConfigurationUpdate {
  ...
  factory GetIndexDocumentMetadataConfigurationUpdate.fromMap(Map<String, dynamic> map) {
    return GetIndexDocumentMetadataConfigurationUpdate(
      ...
      relevances: pulumi.Input.fromValue(pulumi.Input.decodeList<GetIndexDocumentMetadataConfigurationUpdateRelevance>(map['relevances']!, (value) => GetIndexDocumentMetadataConfigurationUpdateRelevance.fromMap((value as Map).cast<String, dynamic>()))),
      searches: pulumi.Input.fromValue(pulumi.Input.decodeList<GetIndexDocumentMetadataConfigurationUpdateSearch>(map['searches']!, (value) => GetIndexDocumentMetadataConfigurationUpdateSearch.fromMap((value as Map).cast<String, dynamic>()))),
