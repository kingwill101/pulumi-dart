...
class DataSourceConfigurationS3Configuration {
  ...
  factory DataSourceConfigurationS3Configuration.fromMap(Map<String, dynamic> map) {
    return DataSourceConfigurationS3Configuration(
      accessControlListConfiguration: (() { final guardedValue = map['accessControlListConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceConfigurationS3ConfigurationAccessControlListConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      bucketName: pulumi.Input.fromValue(map['bucketName'] as String),
      documentsMetadataConfiguration: (() { final guardedValue = map['documentsMetadataConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceConfigurationS3ConfigurationDocumentsMetadataConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      exclusionPatterns: (() { final guardedValue = map['exclusionPatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      inclusionPatterns: (() { final guardedValue = map['inclusionPatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
