...
class IndexIndexStatistic {
  ...
  final pulumi.Input<List<IndexIndexStatisticTextDocumentStatistic>>?
    ...
    return <String, dynamic>{
      'faqStatistics':
          ?pulumi.Input.mapOptionalInputValue<
            List<IndexIndexStatisticFaqStatistic>,
      ...
      'textDocumentStatistics':
          ?pulumi.Input.mapOptionalInputValue<
            List<IndexIndexStatisticTextDocumentStatistic>,
            List<Map<String, dynamic>>
          >(
            textDocumentStatistics,
            (value) =>
  ...
  factory IndexIndexStatistic.fromMap(Map<String, dynamic> map) {
    return IndexIndexStatistic(
      faqStatistics: (() {
        final guardedValue = map['faqStatistics'];
      ...
      textDocumentStatistics: (() {
        final guardedValue = map['textDocumentStatistics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
