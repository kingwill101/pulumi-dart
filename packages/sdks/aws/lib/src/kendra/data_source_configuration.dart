...
class DataSourceConfiguration {
  ...
  final pulumi.Input<DataSourceConfigurationTemplateConfiguration>?
  templateConfiguration;

  /// A block that provides the configuration information required for Amazon Kendra Web Crawler. Detailed below.
  final pulumi.Input<DataSourceConfigurationWebCrawlerConfiguration>?
    ...
    return <String, dynamic>{
      ...
      'webCrawlerConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(webCrawlerConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory DataSourceConfiguration.fromMap(Map<String, dynamic> map) {
    return DataSourceConfiguration(
      ...
      webCrawlerConfiguration: (() {
        final guardedValue = map['webCrawlerConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
