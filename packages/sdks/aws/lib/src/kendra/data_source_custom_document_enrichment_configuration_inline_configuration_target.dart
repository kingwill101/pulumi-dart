...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget {
  ...
  final pulumi.Input<DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue>? targetDocumentAttributeValue;
  ...
  const DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetDocumentAttributeValue': ?pulumi.Input.mapOptionalInputValue<DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue, Map<String, dynamic>>(targetDocumentAttributeValue, (value) => value.toMap()),
      'targetDocumentAttributeValueDeletion': ?targetDocumentAttributeValueDeletion,
    };
  }

  factory DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget.fromMap(Map<String, dynamic> map) {
    return DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget(
      targetDocumentAttributeKey: (() { final guardedValue = map['targetDocumentAttributeKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      targetDocumentAttributeValue: (() { final guardedValue = map['targetDocumentAttributeValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      targetDocumentAttributeValueDeletion: (() { final guardedValue = map['targetDocumentAttributeValueDeletion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
