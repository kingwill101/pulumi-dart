...
class DataSourceCustomDocumentEnrichmentConfiguration {
  ...
  final List<DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration>? inlineConfigurations;
  ...
  final DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration? postExtractionHookConfiguration;
  /// Configuration information for invoking a Lambda function in AWS Lambda on the original or raw documents before extracting their metadata and text. You can use a Lambda function to apply advanced logic for creating, modifying, or deleting document metadata and content. For more information, see [Advanced data manipulation](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#advanced-data-manipulation). Detailed below.
  final DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration? preExtractionHookConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inlineConfigurations': ?inlineConfigurations == null ? null : pulumi.Input.encodeList<DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration, Map<String, dynamic>>(inlineConfigurations!, (value) => value.toMap()),
      'postExtractionHookConfiguration': ?postExtractionHookConfiguration == null ? null : postExtractionHookConfiguration!.toMap(),
      'preExtractionHookConfiguration': ?preExtractionHookConfiguration == null ? null : preExtractionHookConfiguration!.toMap(),
      'roleArn': ?roleArn,
    };
  }
  ...
  factory DataSourceCustomDocumentEnrichmentConfiguration.fromMap(Map<String, dynamic> map) {
    return DataSourceCustomDocumentEnrichmentConfiguration(
      inlineConfigurations: map['inlineConfigurations'] == null ? null : pulumi.Input.decodeList<DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration>(map['inlineConfigurations'], (value) => DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      postExtractionHookConfiguration: map['postExtractionHookConfiguration'] == null ? null : DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration.fromMap((map['postExtractionHookConfiguration'] as Map).cast<String, dynamic>()),
      preExtractionHookConfiguration: map['preExtractionHookConfiguration'] == null ? null : DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration.fromMap((map['preExtractionHookConfiguration'] as Map).cast<String, dynamic>()),
