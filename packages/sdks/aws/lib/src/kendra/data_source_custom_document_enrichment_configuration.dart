...
class DataSourceCustomDocumentEnrichmentConfiguration {
  ...
  final pulumi.Input<
    List<DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration>
  >?
    ...
    return <String, dynamic>{
      ...
      'postExtractionHookConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration,
            Map<String, dynamic>
          >(postExtractionHookConfiguration, (value) => value.toMap()),
      'preExtractionHookConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration,
            Map<String, dynamic>
          >(preExtractionHookConfiguration, (value) => value.toMap()),
      'roleArn': ?roleArn,
    };
  }
  ...
  factory DataSourceCustomDocumentEnrichmentConfiguration.fromMap(
    ...
    return DataSourceCustomDocumentEnrichmentConfiguration(
      inlineConfigurations: (() {
        final guardedValue = map['inlineConfigurations'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration.fromMap(
      ...
      postExtractionHookConfiguration: (() {
        final guardedValue = map['postExtractionHookConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      preExtractionHookConfiguration: (() {
        final guardedValue = map['preExtractionHookConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
