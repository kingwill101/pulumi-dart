...
class IndexCapacityUnits {
  ...
  IndexCapacityUnits({this.queryCapacityUnits, this.storageCapacityUnits});
  ...
  factory IndexCapacityUnits.fromMap(Map<String, dynamic> map) {
    return IndexCapacityUnits(
      queryCapacityUnits: (() {
        final guardedValue = map['queryCapacityUnits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      storageCapacityUnits: (() {
        final guardedValue = map['storageCapacityUnits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
