...
class DistributionArgs {
  ...
  DistributionArgs({
    ...
    required pulumi.Output<List<DistributionOrigin>> origins,
    pulumi.Output<String>? priceClass,
    required pulumi.Output<DistributionRestrictions> restrictions,
    pulumi.Output<bool>? retainOnDelete,
    pulumi.Output<bool>? staging,
    pulumi.Output<Map<String, String>>? tags,
    required pulumi.Output<DistributionViewerCertificate> viewerCertificate,
  ...
  factory DistributionArgs.fromMap(Map<String, dynamic> map) {
    return DistributionArgs(
      ...
      origins: pulumi.Output.create<List<DistributionOrigin>>(pulumi.Input.decodeList<DistributionOrigin>(map['origins'], (value) => DistributionOrigin.fromMap((value as Map).cast<String, dynamic>()))),
      priceClass: map['priceClass'] == null ? null : pulumi.Output.create<String>(map['priceClass'] as String),
      restrictions: pulumi.Output.create<DistributionRestrictions>(DistributionRestrictions.fromMap((map['restrictions'] as Map).cast<String, dynamic>())),
      ...
      viewerCertificate: pulumi.Output.create<DistributionViewerCertificate>(DistributionViewerCertificate.fromMap((map['viewerCertificate'] as Map).cast<String, dynamic>())),
