...
class DistributionArgs {
    ...
    return <String, dynamic>{
      ...
      'connectionFunctionAssociation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(connectionFunctionAssociation, (value) => value.toMap()),
      ...
      'viewerMtlsConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(viewerMtlsConfig, (value) => value.toMap()),
  ...
  factory DistributionArgs.fromMap(Map<String, dynamic> map) {
    return DistributionArgs(
      ...
      connectionFunctionAssociation: (() {
        final guardedValue = map['connectionFunctionAssociation'];
        if (guardedValue == null) return null;
      ...
      defaultCacheBehavior: pulumi.Input.fromValue(
        DistributionDefaultCacheBehavior.fromMap(
      ...
      isIpv6Enabled: (() {
        final guardedValue = map['isIpv6Enabled'];
        if (guardedValue == null) return null;
      ...
      orderedCacheBehaviors: (() {
        final guardedValue = map['orderedCacheBehaviors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      origins: pulumi.Input.fromValue(
        pulumi.Input.decodeList<DistributionOrigin>(
          map['origins']!,
      ...
      restrictions: pulumi.Input.fromValue(
        DistributionRestrictions.fromMap(
          (map['restrictions']! as Map).cast<String, dynamic>(),
        ),
      ),
      retainOnDelete: (() {
        final guardedValue = map['retainOnDelete'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      staging: (() {
      ...
      viewerCertificate: pulumi.Input.fromValue(
        DistributionViewerCertificate.fromMap(
          (map['viewerCertificate']! as Map).cast<String, dynamic>(),
        ),
      ),
      viewerMtlsConfig: (() {
        final guardedValue = map['viewerMtlsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
