...
class DistributionArgs {
  ...
  factory DistributionArgs.fromMap(Map<String, dynamic> map) {
    return DistributionArgs(
      ...
      connectionFunctionAssociation: map['connectionFunctionAssociation'] == null ? null : (DistributionConnectionFunctionAssociation.fromMap((map['connectionFunctionAssociation'] as Map).cast<String, dynamic>())).input(),
      continuousDeploymentPolicyId: map['continuousDeploymentPolicyId'] == null ? null : (map['continuousDeploymentPolicyId'] as String).input(),
      customErrorResponses: map['customErrorResponses'] == null ? null : (pulumi.Input.decodeList<DistributionCustomErrorResponse>(map['customErrorResponses'], (value) => DistributionCustomErrorResponse.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      isIpv6Enabled: map['isIpv6Enabled'] == null ? null : (map['isIpv6Enabled'] as bool).input(),
      loggingConfig: map['loggingConfig'] == null ? null : (DistributionLoggingConfig.fromMap((map['loggingConfig'] as Map).cast<String, dynamic>())).input(),
      orderedCacheBehaviors: map['orderedCacheBehaviors'] == null ? null : (pulumi.Input.decodeList<DistributionOrderedCacheBehavior>(map['orderedCacheBehaviors'], (value) => DistributionOrderedCacheBehavior.fromMap((value as Map).cast<String, dynamic>()))).input(),
      originGroups: map['originGroups'] == null ? null : (pulumi.Input.decodeList<DistributionOriginGroup>(map['originGroups'], (value) => DistributionOriginGroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
      origins: (pulumi.Input.decodeList<DistributionOrigin>(map['origins'], (value) => DistributionOrigin.fromMap((value as Map).cast<String, dynamic>()))).input(),
      priceClass: map['priceClass'] == null ? null : (map['priceClass'] as String).input(),
      restrictions: (DistributionRestrictions.fromMap((map['restrictions'] as Map).cast<String, dynamic>())).input(),
      retainOnDelete: map['retainOnDelete'] == null ? null : (map['retainOnDelete'] as bool).input(),
      staging: map['staging'] == null ? null : (map['staging'] as bool).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      viewerCertificate: (DistributionViewerCertificate.fromMap((map['viewerCertificate'] as Map).cast<String, dynamic>())).input(),
      viewerMtlsConfig: map['viewerMtlsConfig'] == null ? null : (DistributionViewerMtlsConfig.fromMap((map['viewerMtlsConfig'] as Map).cast<String, dynamic>())).input(),
