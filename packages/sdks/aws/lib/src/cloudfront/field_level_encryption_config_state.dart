...
class FieldLevelEncryptionConfigState {
    ...
    return <String, dynamic>{
      ...
      'queryArgProfileConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(queryArgProfileConfig, (value) => value.toMap()),
    };
  }
  ...
  factory FieldLevelEncryptionConfigState.fromMap(Map<String, dynamic> map) {
    return FieldLevelEncryptionConfigState(
      ...
      callerReference: (() {
        final guardedValue = map['callerReference'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      comment: (() {
      ...
      contentTypeProfileConfig: (() {
        final guardedValue = map['contentTypeProfileConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FieldLevelEncryptionConfigContentTypeProfileConfig.fromMap(
      ...
      queryArgProfileConfig: (() {
        final guardedValue = map['queryArgProfileConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FieldLevelEncryptionConfigQueryArgProfileConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
