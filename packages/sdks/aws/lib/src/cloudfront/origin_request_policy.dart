...
class OriginRequestPolicy extends pulumi.CustomResource {
  ...
  OriginRequestPolicy(
    ...
    this.cookiesConfig = registerOutput<OriginRequestPolicyCookiesConfig>('cookiesConfig');
    this.etag = registerOutput<String>('etag');
    this.headersConfig = registerOutput<OriginRequestPolicyHeadersConfig>('headersConfig');
    this.name = registerOutput<String>('name');
    this.queryStringsConfig = registerOutput<OriginRequestPolicyQueryStringsConfig>('queryStringsConfig');
  }
