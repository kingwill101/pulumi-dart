...
class FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfiles {
  ...
  factory FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfiles.fromMap(Map<String, dynamic> map) {
    return FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfiles(
      items: (() { final guardedValue = map['items']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItem>(guardedValue, (value) => FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItem.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
