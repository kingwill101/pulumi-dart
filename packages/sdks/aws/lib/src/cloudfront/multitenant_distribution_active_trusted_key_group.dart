...
class MultitenantDistributionActiveTrustedKeyGroup {
  ...
  final pulumi.Input<List<MultitenantDistributionActiveTrustedKeyGroupItem>>?
  items;
  ...
  MultitenantDistributionActiveTrustedKeyGroup({this.enabled, this.items});
    ...
    return <String, dynamic>{
      ...
      'items':
          ?pulumi.Input.mapOptionalInputValue<
            List<MultitenantDistributionActiveTrustedKeyGroupItem>,
    ...
    return MultitenantDistributionActiveTrustedKeyGroup(
      ...
      items: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => MultitenantDistributionActiveTrustedKeyGroupItem.fromMap(
