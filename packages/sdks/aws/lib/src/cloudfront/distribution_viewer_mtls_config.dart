...
class DistributionViewerMtlsConfig {
  ...
  final pulumi.Input<DistributionViewerMtlsConfigTrustStoreConfig>?
  trustStoreConfig;
  ...
  DistributionViewerMtlsConfig({this.mode, this.trustStoreConfig});
    ...
    return <String, dynamic>{
      ...
      'trustStoreConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(trustStoreConfig, (value) => value.toMap()),
    };
  }
  ...
  factory DistributionViewerMtlsConfig.fromMap(Map<String, dynamic> map) {
    return DistributionViewerMtlsConfig(
      ...
      trustStoreConfig: (() {
        final guardedValue = map['trustStoreConfig'];
        if (guardedValue == null) return null;
