...
class MonitoringSubscriptionState {
  ...
  factory MonitoringSubscriptionState.fromMap(Map<String, dynamic> map) {
    return MonitoringSubscriptionState(
      ...
      monitoringSubscription: (() { final guardedValue = map['monitoringSubscription']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MonitoringSubscriptionMonitoringSubscription.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
