...
class GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfig {
  ...
  final pulumi.Input<List<GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigQueryString>> queryStrings;
  ...
  const GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfig({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'queryStrings': pulumi.Input.mapInputValue<List<GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigQueryString>, List<Map<String, dynamic>>>(queryStrings, (value) => pulumi.Input.encodeList<GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigQueryString, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfig.fromMap(Map<String, dynamic> map) {
    return GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfig(
      ...
      queryStrings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigQueryString>(map['queryStrings']!, (value) => GetCachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigQueryString.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
