...
class GetDistributionTenantCustomization {
  final pulumi.Input<List<GetDistributionTenantCustomizationCertificate>>
  certificates;
  final pulumi.Input<List<GetDistributionTenantCustomizationGeoRestriction>>
  geoRestrictions;
    ...
    return <String, dynamic>{
      'certificates':
          pulumi.Input.mapInputValue<
            List<GetDistributionTenantCustomizationCertificate>,
      ...
      'geoRestrictions':
          pulumi.Input.mapInputValue<
            List<GetDistributionTenantCustomizationGeoRestriction>,
            List<Map<String, dynamic>>
          >(
            geoRestrictions,
            (value) =>
      ...
      'webAcls':
          pulumi.Input.mapInputValue<
            List<GetDistributionTenantCustomizationWebAcl>,
            List<Map<String, dynamic>>
          >(
            webAcls,
            (value) =>
  ...
  factory GetDistributionTenantCustomization.fromMap(Map<String, dynamic> map) {
    return GetDistributionTenantCustomization(
      certificates: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDistributionTenantCustomizationCertificate>(
          map['certificates']!,
      ...
      geoRestrictions: pulumi.Input.fromValue(
        pulumi
      ...
      webAcls: pulumi.Input.fromValue(
