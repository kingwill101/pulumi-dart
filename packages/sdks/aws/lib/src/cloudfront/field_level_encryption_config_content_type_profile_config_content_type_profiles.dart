...
class FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles {
  final List<FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItem> items;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'items': pulumi.Input.encodeList<FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItem, Map<String, dynamic>>(items, (value) => value.toMap()),
    };
  }
  ...
  factory FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles.fromMap(Map<String, dynamic> map) {
    return FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles(
      items: pulumi.Input.decodeList<FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItem>(map['items'], (value) => FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItem.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
