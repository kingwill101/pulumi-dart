...
class OriginRequestPolicyState {
    ...
    return <String, dynamic>{
      ...
      'cookiesConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cookiesConfig, (value) => value.toMap()),
      'etag': ?etag,
      'headersConfig':
          ?pulumi.Input.mapOptionalInputValue<
            OriginRequestPolicyHeadersConfig,
            Map<String, dynamic>
          >(headersConfig, (value) => value.toMap()),
      'name': ?name,
      'queryStringsConfig':
          ?pulumi.Input.mapOptionalInputValue<
            OriginRequestPolicyQueryStringsConfig,
            Map<String, dynamic>
          >(queryStringsConfig, (value) => value.toMap()),
    };
  }
  ...
  factory OriginRequestPolicyState.fromMap(Map<String, dynamic> map) {
    return OriginRequestPolicyState(
      ...
      cookiesConfig: (() {
        final guardedValue = map['cookiesConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OriginRequestPolicyCookiesConfig.fromMap(
      ...
      headersConfig: (() {
        final guardedValue = map['headersConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OriginRequestPolicyHeadersConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      queryStringsConfig: (() {
        final guardedValue = map['queryStringsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OriginRequestPolicyQueryStringsConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
