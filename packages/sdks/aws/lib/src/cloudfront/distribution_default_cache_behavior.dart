...
import 'distribution_default_cache_behavior_forwarded_values.dart';
import 'distribution_default_cache_behavior_function_association.dart';
import 'distribution_default_cache_behavior_grpc_config.dart';
import 'distribution_default_cache_behavior_lambda_function_association.dart';
...
class DistributionDefaultCacheBehavior {
  ...
  final pulumi.Input<DistributionDefaultCacheBehaviorForwardedValues>? forwardedValues;
  /// A config block that triggers a cloudfront function with specific actions (maximum 2).
  final pulumi.Input<List<DistributionDefaultCacheBehaviorFunctionAssociation>>? functionAssociations;
  /// A config block that sets the grpc config.
  final pulumi.Input<DistributionDefaultCacheBehaviorGrpcConfig>? grpcConfig;
  /// A config block that triggers a lambda function with specific actions (maximum 4).
  final pulumi.Input<List<DistributionDefaultCacheBehaviorLambdaFunctionAssociation>>? lambdaFunctionAssociations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'forwardedValues': ?pulumi.Input.mapOptionalInputValue<DistributionDefaultCacheBehaviorForwardedValues, Map<String, dynamic>>(forwardedValues, (value) => value.toMap()),
      'functionAssociations': ?pulumi.Input.mapOptionalInputValue<List<DistributionDefaultCacheBehaviorFunctionAssociation>, List<Map<String, dynamic>>>(functionAssociations, (value) => pulumi.Input.encodeList<DistributionDefaultCacheBehaviorFunctionAssociation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'grpcConfig': ?pulumi.Input.mapOptionalInputValue<DistributionDefaultCacheBehaviorGrpcConfig, Map<String, dynamic>>(grpcConfig, (value) => value.toMap()),
      'lambdaFunctionAssociations': ?pulumi.Input.mapOptionalInputValue<List<DistributionDefaultCacheBehaviorLambdaFunctionAssociation>, List<Map<String, dynamic>>>(lambdaFunctionAssociations, (value) => pulumi.Input.encodeList<DistributionDefaultCacheBehaviorLambdaFunctionAssociation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'maxTtl': ?maxTtl,
      'minTtl': ?minTtl,
  ...
  factory DistributionDefaultCacheBehavior.fromMap(Map<String, dynamic> map) {
    return DistributionDefaultCacheBehavior(
      ...
      forwardedValues: map['forwardedValues'] == null ? null : ((DistributionDefaultCacheBehaviorForwardedValues.fromMap((map['forwardedValues']! as Map).cast<String, dynamic>())).input()).input(),
      functionAssociations: map['functionAssociations'] == null ? null : ((pulumi.Input.decodeList<DistributionDefaultCacheBehaviorFunctionAssociation>(map['functionAssociations']!, (value) => DistributionDefaultCacheBehaviorFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      grpcConfig: map['grpcConfig'] == null ? null : ((DistributionDefaultCacheBehaviorGrpcConfig.fromMap((map['grpcConfig']! as Map).cast<String, dynamic>())).input()).input(),
      lambdaFunctionAssociations: map['lambdaFunctionAssociations'] == null ? null : ((pulumi.Input.decodeList<DistributionDefaultCacheBehaviorLambdaFunctionAssociation>(map['lambdaFunctionAssociations']!, (value) => DistributionDefaultCacheBehaviorLambdaFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      smoothStreaming: map['smoothStreaming'] == null ? null : ((map['smoothStreaming'] as bool).input()).input(),
      targetOriginId: (map['targetOriginId'] as String).input(),
      trustedKeyGroups: map['trustedKeyGroups'] == null ? null : (((map['trustedKeyGroups'] as List).cast<String>()).input()).input(),
      trustedSigners: map['trustedSigners'] == null ? null : (((map['trustedSigners'] as List).cast<String>()).input()).input(),
