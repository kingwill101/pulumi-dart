...
class DistributionDefaultCacheBehavior {
  ...
  factory DistributionDefaultCacheBehavior.fromMap(Map<String, dynamic> map) {
    return DistributionDefaultCacheBehavior(
      ...
      forwardedValues: map['forwardedValues'] == null ? null : (DistributionDefaultCacheBehaviorForwardedValues.fromMap((map['forwardedValues'] as Map).cast<String, dynamic>())).input(),
      functionAssociations: map['functionAssociations'] == null ? null : (pulumi.Input.decodeList<DistributionDefaultCacheBehaviorFunctionAssociation>(map['functionAssociations'], (value) => DistributionDefaultCacheBehaviorFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      grpcConfig: map['grpcConfig'] == null ? null : (DistributionDefaultCacheBehaviorGrpcConfig.fromMap((map['grpcConfig'] as Map).cast<String, dynamic>())).input(),
      lambdaFunctionAssociations: map['lambdaFunctionAssociations'] == null ? null : (pulumi.Input.decodeList<DistributionDefaultCacheBehaviorLambdaFunctionAssociation>(map['lambdaFunctionAssociations'], (value) => DistributionDefaultCacheBehaviorLambdaFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))).input(),
