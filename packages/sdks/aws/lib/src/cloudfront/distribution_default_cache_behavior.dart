...
class DistributionDefaultCacheBehavior {
  ...
  final pulumi.Input<DistributionDefaultCacheBehaviorForwardedValues>?
  forwardedValues;

  /// A config block that triggers a cloudfront function with specific actions (maximum 2).
  final pulumi.Input<List<DistributionDefaultCacheBehaviorFunctionAssociation>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'functionAssociations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DistributionDefaultCacheBehaviorFunctionAssociation>,
      ...
      lambdaFunctionAssociations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DistributionDefaultCacheBehaviorLambdaFunctionAssociation.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
