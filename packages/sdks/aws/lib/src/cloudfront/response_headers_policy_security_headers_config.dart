...
class ResponseHeadersPolicySecurityHeadersConfig {
  ...
  factory ResponseHeadersPolicySecurityHeadersConfig.fromMap(Map<String, dynamic> map) {
    return ResponseHeadersPolicySecurityHeadersConfig(
      contentSecurityPolicy: (() { final guardedValue = map['contentSecurityPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      contentTypeOptions: (() { final guardedValue = map['contentTypeOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResponseHeadersPolicySecurityHeadersConfigContentTypeOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      frameOptions: (() { final guardedValue = map['frameOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResponseHeadersPolicySecurityHeadersConfigFrameOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      referrerPolicy: (() { final guardedValue = map['referrerPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResponseHeadersPolicySecurityHeadersConfigReferrerPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      strictTransportSecurity: (() { final guardedValue = map['strictTransportSecurity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      xssProtection: (() { final guardedValue = map['xssProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResponseHeadersPolicySecurityHeadersConfigXssProtection.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
