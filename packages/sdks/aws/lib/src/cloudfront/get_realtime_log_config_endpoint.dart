...
class GetRealtimeLogConfigEndpoint {
  ...
  const GetRealtimeLogConfigEndpoint({
  ...
  factory GetRealtimeLogConfigEndpoint.fromMap(Map<String, dynamic> map) {
    return GetRealtimeLogConfigEndpoint(
      kinesisStreamConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRealtimeLogConfigEndpointKinesisStreamConfig>(map['kinesisStreamConfigs']!, (value) => GetRealtimeLogConfigEndpointKinesisStreamConfig.fromMap((value as Map).cast<String, dynamic>()))),
