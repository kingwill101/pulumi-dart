...
class MultitenantDistributionDefaultCacheBehavior {
  ...
  const MultitenantDistributionDefaultCacheBehavior({
  ...
  factory MultitenantDistributionDefaultCacheBehavior.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionDefaultCacheBehavior(
      allowedMethods: pulumi.Input.fromValue(MultitenantDistributionDefaultCacheBehaviorAllowedMethods.fromMap((map['allowedMethods']! as Map).cast<String, dynamic>())),
      ...
      functionAssociations: (() { final guardedValue = map['functionAssociations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MultitenantDistributionDefaultCacheBehaviorFunctionAssociation>(guardedValue, (value) => MultitenantDistributionDefaultCacheBehaviorFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      lambdaFunctionAssociations: (() { final guardedValue = map['lambdaFunctionAssociations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MultitenantDistributionDefaultCacheBehaviorLambdaFunctionAssociation>(guardedValue, (value) => MultitenantDistributionDefaultCacheBehaviorLambdaFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      trustedKeyGroups: (() { final guardedValue = map['trustedKeyGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultitenantDistributionDefaultCacheBehaviorTrustedKeyGroups.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
