...
class MultitenantDistributionDefaultCacheBehavior {
  ...
  final pulumi.Input<MultitenantDistributionDefaultCacheBehaviorAllowedMethods>
  allowedMethods;
  ...
  final pulumi.Input<
    List<MultitenantDistributionDefaultCacheBehaviorFunctionAssociation>
  >?
    ...
    return <String, dynamic>{
      'allowedMethods':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(allowedMethods, (value) => value.toMap()),
      ...
      'trustedKeyGroups':
          ?pulumi.Input.mapOptionalInputValue<
            MultitenantDistributionDefaultCacheBehaviorTrustedKeyGroups,
            Map<String, dynamic>
          >(trustedKeyGroups, (value) => value.toMap()),
  ...
  factory MultitenantDistributionDefaultCacheBehavior.fromMap(
    ...
    return MultitenantDistributionDefaultCacheBehavior(
      ...
      functionAssociations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MultitenantDistributionDefaultCacheBehaviorFunctionAssociation.fromMap(
      ...
      lambdaFunctionAssociations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MultitenantDistributionDefaultCacheBehaviorLambdaFunctionAssociation.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      viewerProtocolPolicy: pulumi.Input.fromValue(
        map['viewerProtocolPolicy'] as String,
      ),
    );
  }
}
