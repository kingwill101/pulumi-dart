...
class DistributionOrderedCacheBehavior {
  ...
  final pulumi.Input<DistributionOrderedCacheBehaviorForwardedValues>?
  forwardedValues;

  /// A config block that triggers a cloudfront function with specific actions (maximum 2).
  final pulumi.Input<List<DistributionOrderedCacheBehaviorFunctionAssociation>>?
  ...
  final pulumi.Input<
    List<DistributionOrderedCacheBehaviorLambdaFunctionAssociation>
  >?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'functionAssociations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DistributionOrderedCacheBehaviorFunctionAssociation>,
      ...
      lambdaFunctionAssociations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DistributionOrderedCacheBehaviorLambdaFunctionAssociation.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
