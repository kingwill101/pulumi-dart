...
class DistributionOrderedCacheBehavior {
  ...
  factory DistributionOrderedCacheBehavior.fromMap(Map<String, dynamic> map) {
    return DistributionOrderedCacheBehavior(
      ...
      forwardedValues: map['forwardedValues'] == null ? null : ((DistributionOrderedCacheBehaviorForwardedValues.fromMap((map['forwardedValues']! as Map).cast<String, dynamic>())).input()).input(),
      functionAssociations: map['functionAssociations'] == null ? null : ((pulumi.Input.decodeList<DistributionOrderedCacheBehaviorFunctionAssociation>(map['functionAssociations']!, (value) => DistributionOrderedCacheBehaviorFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      grpcConfig: map['grpcConfig'] == null ? null : ((DistributionOrderedCacheBehaviorGrpcConfig.fromMap((map['grpcConfig']! as Map).cast<String, dynamic>())).input()).input(),
      lambdaFunctionAssociations: map['lambdaFunctionAssociations'] == null ? null : ((pulumi.Input.decodeList<DistributionOrderedCacheBehaviorLambdaFunctionAssociation>(map['lambdaFunctionAssociations']!, (value) => DistributionOrderedCacheBehaviorLambdaFunctionAssociation.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
