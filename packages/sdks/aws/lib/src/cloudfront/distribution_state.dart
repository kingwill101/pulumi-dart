  ...
  factory DistributionState.fromMap(Map<String, dynamic> map) {
    return DistributionState(
      ...
      inProgressValidationBatches: (() {
        final guardedValue = map['inProgressValidationBatches'];
        if (guardedValue == null) return null;
      ...
      loggingV1Enabled: (() {
        final guardedValue = map['loggingV1Enabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      orderedCacheBehaviors: (() {
      ...
      trustedKeyGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DistributionTrustedKeyGroup>(
            guardedValue,
            (value) => DistributionTrustedKeyGroup.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      trustedSigners: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DistributionTrustedSigner>(
            guardedValue,
            (value) => DistributionTrustedSigner.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
