...
class DistributionState {
  ...
  factory DistributionState.fromMap(Map<String, dynamic> map) {
    return DistributionState(
      ...
      defaultCacheBehavior: map['defaultCacheBehavior'] == null ? null : (DistributionDefaultCacheBehavior.fromMap((map['defaultCacheBehavior'] as Map).cast<String, dynamic>())).input(),
      ...
      inProgressValidationBatches: map['inProgressValidationBatches'] == null ? null : (map['inProgressValidationBatches'] as int).input(),
      ...
      loggingV1Enabled: map['loggingV1Enabled'] == null ? null : (map['loggingV1Enabled'] as bool).input(),
      ...
      origins: map['origins'] == null ? null : (pulumi.Input.decodeList<DistributionOrigin>(map['origins'], (value) => DistributionOrigin.fromMap((value as Map).cast<String, dynamic>()))).input(),
      priceClass: map['priceClass'] == null ? null : (map['priceClass'] as String).input(),
      restrictions: map['restrictions'] == null ? null : (DistributionRestrictions.fromMap((map['restrictions'] as Map).cast<String, dynamic>())).input(),
      ...
      trustedKeyGroups: map['trustedKeyGroups'] == null ? null : (pulumi.Input.decodeList<DistributionTrustedKeyGroup>(map['trustedKeyGroups'], (value) => DistributionTrustedKeyGroup.fromMap((value as Map).cast<String, dynamic>()))).input(),
      trustedSigners: map['trustedSigners'] == null ? null : (pulumi.Input.decodeList<DistributionTrustedSigner>(map['trustedSigners'], (value) => DistributionTrustedSigner.fromMap((value as Map).cast<String, dynamic>()))).input(),
      viewerCertificate: map['viewerCertificate'] == null ? null : (DistributionViewerCertificate.fromMap((map['viewerCertificate'] as Map).cast<String, dynamic>())).input(),
