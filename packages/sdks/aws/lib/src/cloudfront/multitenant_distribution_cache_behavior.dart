...
class MultitenantDistributionCacheBehavior {
  ...
  final pulumi.Input<MultitenantDistributionCacheBehaviorAllowedMethods>
  allowedMethods;
  ...
  final pulumi.Input<
    List<MultitenantDistributionCacheBehaviorFunctionAssociation>
  >?
  functionAssociations;

  /// Configuration block for Lambda@Edge associations. See Lambda Function Association below.
  final pulumi.Input<
    List<MultitenantDistributionCacheBehaviorLambdaFunctionAssociation>
  >?
  ...
  final pulumi.Input<MultitenantDistributionCacheBehaviorTrustedKeyGroups>?
  trustedKeyGroups;
