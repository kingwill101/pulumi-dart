...
class MultitenantDistributionTenantConfigParameterDefinitionDefinition {
  ...
  factory MultitenantDistributionTenantConfigParameterDefinitionDefinition.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionTenantConfigParameterDefinitionDefinition(
      stringSchemas: (() { final guardedValue = map['stringSchemas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MultitenantDistributionTenantConfigParameterDefinitionDefinitionStringSchema>(guardedValue, (value) => MultitenantDistributionTenantConfigParameterDefinitionDefinitionStringSchema.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
