...
class DistributionOriginGroup {
  ...
  factory DistributionOriginGroup.fromMap(Map<String, dynamic> map) {
    return DistributionOriginGroup(
      failoverCriteria: pulumi.Input.fromValue(DistributionOriginGroupFailoverCriteria.fromMap((map['failoverCriteria']! as Map).cast<String, dynamic>())),
      members: pulumi.Input.fromValue(pulumi.Input.decodeList<DistributionOriginGroupMember>(map['members']!, (value) => DistributionOriginGroupMember.fromMap((value as Map).cast<String, dynamic>()))),
