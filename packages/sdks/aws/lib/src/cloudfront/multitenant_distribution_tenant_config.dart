...
class MultitenantDistributionTenantConfig {
  ...
  final pulumi.Input<
    List<MultitenantDistributionTenantConfigParameterDefinition>
  >?
  ...
  MultitenantDistributionTenantConfig({this.parameterDefinitions});
  ...
  factory MultitenantDistributionTenantConfig.fromMap(
    ...
    return MultitenantDistributionTenantConfig(
      parameterDefinitions: (() {
        final guardedValue = map['parameterDefinitions'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                MultitenantDistributionTenantConfigParameterDefinition.fromMap(
