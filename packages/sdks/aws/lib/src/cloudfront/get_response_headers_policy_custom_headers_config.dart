...
class GetResponseHeadersPolicyCustomHeadersConfig {
  final pulumi.Input<List<GetResponseHeadersPolicyCustomHeadersConfigItem>>
  items;
    ...
    return <String, dynamic>{
      'items':
          pulumi.Input.mapInputValue<
            List<GetResponseHeadersPolicyCustomHeadersConfigItem>,
  ...
  factory GetResponseHeadersPolicyCustomHeadersConfig.fromMap(
    ...
    return GetResponseHeadersPolicyCustomHeadersConfig(
      items: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetResponseHeadersPolicyCustomHeadersConfigItem>(
          map['items']!,
