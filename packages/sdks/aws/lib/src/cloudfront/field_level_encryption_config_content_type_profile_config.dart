...
class FieldLevelEncryptionConfigContentTypeProfileConfig {
  ...
  final pulumi.Input<FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles> contentTypeProfiles;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'contentTypeProfiles': pulumi.Input.mapInputValue<FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles, Map<String, dynamic>>(contentTypeProfiles, (value) => value.toMap()),
  ...
  factory FieldLevelEncryptionConfigContentTypeProfileConfig.fromMap(Map<String, dynamic> map) {
    return FieldLevelEncryptionConfigContentTypeProfileConfig(
      contentTypeProfiles: pulumi.Input.fromValue(FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles.fromMap((map['contentTypeProfiles']! as Map).cast<String, dynamic>())),
      forwardWhenContentTypeIsUnknown: pulumi.Input.fromValue(map['forwardWhenContentTypeIsUnknown'] as bool),
    );
  }
}
