...
class DistributionOrderedCacheBehaviorForwardedValues {
  ...
  final pulumi.Input<DistributionOrderedCacheBehaviorForwardedValuesCookies>
  cookies;
  ...
  factory DistributionOrderedCacheBehaviorForwardedValues.fromMap(
    ...
    return DistributionOrderedCacheBehaviorForwardedValues(
      cookies: pulumi.Input.fromValue(
        DistributionOrderedCacheBehaviorForwardedValuesCookies.fromMap(
      ...
      queryStringCacheKeys: (() {
        final guardedValue = map['queryStringCacheKeys'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
