...
class MultitenantDistributionState {
  ...
  factory MultitenantDistributionState.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionState(
      ...
      defaultCacheBehavior: map['defaultCacheBehavior'] == null ? null : ((MultitenantDistributionDefaultCacheBehavior.fromMap((map['defaultCacheBehavior']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      inProgressInvalidationBatches: map['inProgressInvalidationBatches'] == null ? null : ((map['inProgressInvalidationBatches'] as int).input()).input(),
      ...
      tenantConfig: map['tenantConfig'] == null ? null : ((MultitenantDistributionTenantConfig.fromMap((map['tenantConfig']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      viewerCertificate: map['viewerCertificate'] == null ? null : ((MultitenantDistributionViewerCertificate.fromMap((map['viewerCertificate']! as Map).cast<String, dynamic>())).input()).input(),
