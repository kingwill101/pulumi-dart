...
class MultitenantDistributionTimeouts {
  ...
  /// Creates a new [MultitenantDistributionTimeouts].
  ...
  MultitenantDistributionTimeouts({this.create, this.delete, this.update});
  ...
  factory MultitenantDistributionTimeouts.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionTimeouts(
      create: (() {
