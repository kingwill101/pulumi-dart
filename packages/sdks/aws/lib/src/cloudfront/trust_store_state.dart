...
class TrustStoreState {
  ...
  factory TrustStoreState.fromMap(Map<String, dynamic> map) {
    return TrustStoreState(
      ...
      numberOfCaCertificates: (() { final guardedValue = map['numberOfCaCertificates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
