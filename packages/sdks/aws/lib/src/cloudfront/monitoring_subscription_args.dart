...
class MonitoringSubscriptionArgs {
  ...
  factory MonitoringSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return MonitoringSubscriptionArgs(
      ...
      monitoringSubscription: pulumi.Input.fromValue(MonitoringSubscriptionMonitoringSubscription.fromMap((map['monitoringSubscription']! as Map).cast<String, dynamic>())),
    );
  }
}
