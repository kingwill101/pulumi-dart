...
class TrustStoreTimeouts {
  ...
  /// Creates a new [TrustStoreTimeouts].
  ...
  TrustStoreTimeouts({this.create, this.delete, this.update});
  ...
  factory TrustStoreTimeouts.fromMap(Map<String, dynamic> map) {
    return TrustStoreTimeouts(
      create: (() {
