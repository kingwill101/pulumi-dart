...
class OriginRequestPolicyArgs {
  ...
  factory OriginRequestPolicyArgs.fromMap(Map<String, dynamic> map) {
    return OriginRequestPolicyArgs(
      ...
      cookiesConfig: pulumi.Input.fromValue(OriginRequestPolicyCookiesConfig.fromMap((map['cookiesConfig']! as Map).cast<String, dynamic>())),
      headersConfig: pulumi.Input.fromValue(OriginRequestPolicyHeadersConfig.fromMap((map['headersConfig']! as Map).cast<String, dynamic>())),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      queryStringsConfig: pulumi.Input.fromValue(OriginRequestPolicyQueryStringsConfig.fromMap((map['queryStringsConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
