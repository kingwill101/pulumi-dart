...
class ConnectionFunctionState {
  ...
  factory ConnectionFunctionState.fromMap(Map<String, dynamic> map) {
    return ConnectionFunctionState(
      connectionFunctionArn: (() { final guardedValue = map['connectionFunctionArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      connectionFunctionCode: (() { final guardedValue = map['connectionFunctionCode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      connectionFunctionConfig: (() { final guardedValue = map['connectionFunctionConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectionFunctionConnectionFunctionConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
