...
class GetResponseHeadersPolicyRemoveHeadersConfig {
  final pulumi.Input<List<GetResponseHeadersPolicyRemoveHeadersConfigItem>>
  items;
    ...
    return <String, dynamic>{
      'items':
          pulumi.Input.mapInputValue<
            List<GetResponseHeadersPolicyRemoveHeadersConfigItem>,
  ...
  factory GetResponseHeadersPolicyRemoveHeadersConfig.fromMap(
    ...
    return GetResponseHeadersPolicyRemoveHeadersConfig(
      items: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetResponseHeadersPolicyRemoveHeadersConfigItem>(
          map['items']!,
