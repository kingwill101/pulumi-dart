...
class MultitenantDistributionOrigin {
  ...
  final pulumi.Input<List<MultitenantDistributionOriginCustomHeader>>?
  customHeaders;

  /// CloudFront origin access identity to associate with the origin. See Custom Origin Config below.
  final pulumi.Input<List<MultitenantDistributionOriginCustomOriginConfig>>?
  customOriginConfigs;
  ...
  final pulumi.Input<List<MultitenantDistributionOriginOriginShield>>?
  originShields;
  ...
  final pulumi.Input<List<MultitenantDistributionOriginVpcOriginConfig>>?
  vpcOriginConfigs;
    ...
    return <String, dynamic>{
      ...
      'customHeaders':
          ?pulumi.Input.mapOptionalInputValue<
            List<MultitenantDistributionOriginCustomHeader>,
      ...
      'customOriginConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<MultitenantDistributionOriginCustomOriginConfig>,
            List<Map<String, dynamic>>
          >(
            customOriginConfigs,
            (value) =>
      ...
      'originShields':
          ?pulumi.Input.mapOptionalInputValue<
            List<MultitenantDistributionOriginOriginShield>,
            List<Map<String, dynamic>>
          >(
            originShields,
            (value) =>
      ...
      'vpcOriginConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<MultitenantDistributionOriginVpcOriginConfig>,
            List<Map<String, dynamic>>
          >(
            vpcOriginConfigs,
            (value) =>
  ...
  factory MultitenantDistributionOrigin.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionOrigin(
      ...
      customOriginConfigs: (() {
        final guardedValue = map['customOriginConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => MultitenantDistributionOriginCustomOriginConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      originShields: (() {
        final guardedValue = map['originShields'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      responseCompletionTimeout: (() {
        final guardedValue = map['responseCompletionTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      vpcOriginConfigs: (() {
        final guardedValue = map['vpcOriginConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MultitenantDistributionOriginVpcOriginConfig>(
            guardedValue,
