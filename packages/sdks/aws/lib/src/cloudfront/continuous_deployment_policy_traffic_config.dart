...
class ContinuousDeploymentPolicyTrafficConfig {
  ...
  final pulumi.Input<ContinuousDeploymentPolicyTrafficConfigSingleHeaderConfig>?
  singleHeaderConfig;

  /// Contains the percentage of traffic to send to the staging distribution. See `single_weight_config`.
  final pulumi.Input<ContinuousDeploymentPolicyTrafficConfigSingleWeightConfig>?
  singleWeightConfig;
    ...
    return <String, dynamic>{
      'singleHeaderConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(singleHeaderConfig, (value) => value.toMap()),
      'singleWeightConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ContinuousDeploymentPolicyTrafficConfigSingleWeightConfig,
            Map<String, dynamic>
          >(singleWeightConfig, (value) => value.toMap()),
      'type': type,
    };
  }
  ...
  factory ContinuousDeploymentPolicyTrafficConfig.fromMap(
    ...
    return ContinuousDeploymentPolicyTrafficConfig(
      singleHeaderConfig: (() {
        final guardedValue = map['singleHeaderConfig'];
      ...
      singleWeightConfig: (() {
        final guardedValue = map['singleWeightConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
