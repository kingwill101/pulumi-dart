...
class MultitenantDistributionArgs {
  ...
  factory MultitenantDistributionArgs.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionArgs(
      ...
      defaultCacheBehavior: pulumi.Input.fromValue(MultitenantDistributionDefaultCacheBehavior.fromMap((map['defaultCacheBehavior']! as Map).cast<String, dynamic>())),
      ...
      tenantConfig: pulumi.Input.fromValue(MultitenantDistributionTenantConfig.fromMap((map['tenantConfig']! as Map).cast<String, dynamic>())),
      ...
      viewerCertificate: pulumi.Input.fromValue(MultitenantDistributionViewerCertificate.fromMap((map['viewerCertificate']! as Map).cast<String, dynamic>())),
