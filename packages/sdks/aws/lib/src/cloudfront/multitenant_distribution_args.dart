...
class MultitenantDistributionArgs {
  ...
  MultitenantDistributionArgs({
    ...
    required pulumi.Output<String> comment,
    pulumi.Output<List<MultitenantDistributionCustomErrorResponse>>? customErrorResponses,
    required pulumi.Output<MultitenantDistributionDefaultCacheBehavior> defaultCacheBehavior,
    ...
    required pulumi.Output<MultitenantDistributionTenantConfig> tenantConfig,
    pulumi.Output<MultitenantDistributionTimeouts>? timeouts,
    required pulumi.Output<MultitenantDistributionViewerCertificate> viewerCertificate,
  ...
  factory MultitenantDistributionArgs.fromMap(Map<String, dynamic> map) {
    return MultitenantDistributionArgs(
      ...
      comment: pulumi.Output.create<String>(map['comment'] as String),
      ...
      defaultCacheBehavior: pulumi.Output.create<MultitenantDistributionDefaultCacheBehavior>(MultitenantDistributionDefaultCacheBehavior.fromMap((map['defaultCacheBehavior'] as Map).cast<String, dynamic>())),
      ...
      tenantConfig: pulumi.Output.create<MultitenantDistributionTenantConfig>(MultitenantDistributionTenantConfig.fromMap((map['tenantConfig'] as Map).cast<String, dynamic>())),
      ...
      viewerCertificate: pulumi.Output.create<MultitenantDistributionViewerCertificate>(MultitenantDistributionViewerCertificate.fromMap((map['viewerCertificate'] as Map).cast<String, dynamic>())),
