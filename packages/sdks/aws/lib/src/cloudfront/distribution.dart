...
class Distribution extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<Map<String, dynamic>>> trustedSigners;
  ...
  Distribution(
    ...
    orderedCacheBehaviors = registerOutput<List<Map<String, dynamic>>?>('orderedCacheBehaviors');
    ...
    trustedKeyGroups = registerOutput<List<Map<String, dynamic>>>('trustedKeyGroups');
    trustedSigners = registerOutput<List<Map<String, dynamic>>>('trustedSigners');
