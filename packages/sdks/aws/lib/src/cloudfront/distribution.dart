...
class Distribution extends pulumi.CustomResource {
  ...
  Distribution(
    ...
    this.connectionFunctionAssociation = registerOutput<DistributionConnectionFunctionAssociation?>('connectionFunctionAssociation');
    this.continuousDeploymentPolicyId = registerOutput<String>('continuousDeploymentPolicyId');
    this.customErrorResponses = registerOutput<List<DistributionCustomErrorResponse>?>('customErrorResponses');
    this.defaultCacheBehavior = registerOutput<DistributionDefaultCacheBehavior>('defaultCacheBehavior');
    ...
    this.inProgressValidationBatches = registerOutput<int>('inProgressValidationBatches');
    this.isIpv6Enabled = registerOutput<bool?>('isIpv6Enabled');
    this.lastModifiedTime = registerOutput<String>('lastModifiedTime');
    this.loggingConfig = registerOutput<DistributionLoggingConfig?>('loggingConfig');
    this.loggingV1Enabled = registerOutput<bool>('loggingV1Enabled');
    this.orderedCacheBehaviors = registerOutput<List<DistributionOrderedCacheBehavior>?>('orderedCacheBehaviors');
    this.originGroups = registerOutput<List<DistributionOriginGroup>?>('originGroups');
    this.origins = registerOutput<List<DistributionOrigin>>('origins');
    this.priceClass = registerOutput<String?>('priceClass');
    this.restrictions = registerOutput<DistributionRestrictions>('restrictions');
    ...
    this.trustedKeyGroups = registerOutput<List<DistributionTrustedKeyGroup>>('trustedKeyGroups');
    this.trustedSigners = registerOutput<List<DistributionTrustedSigner>>('trustedSigners');
    this.viewerCertificate = registerOutput<DistributionViewerCertificate>('viewerCertificate');
    this.viewerMtlsConfig = registerOutput<DistributionViewerMtlsConfig?>('viewerMtlsConfig');
