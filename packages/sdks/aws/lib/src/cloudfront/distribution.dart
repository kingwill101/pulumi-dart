...
class Distribution extends pulumi.CustomResource {
  ...
  Distribution(
    ...
    inProgressValidationBatches = registerOutput<int>(
    ...
    trustedKeyGroups = registerOutput<List<Map<String, dynamic>>>(
      'trustedKeyGroups',
    );
    trustedSigners = registerOutput<List<Map<String, dynamic>>>(
      'trustedSigners',
    );
