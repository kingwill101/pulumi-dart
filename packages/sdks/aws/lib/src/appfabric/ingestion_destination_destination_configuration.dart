...
class IngestionDestinationDestinationConfiguration {
  ...
  final pulumi.Input<IngestionDestinationDestinationConfigurationAuditLog>
  auditLog;
  ...
  IngestionDestinationDestinationConfiguration({required this.auditLog});
  ...
  factory IngestionDestinationDestinationConfiguration.fromMap(
    ...
    return IngestionDestinationDestinationConfiguration(
      auditLog: pulumi.Input.fromValue(
        IngestionDestinationDestinationConfigurationAuditLog.fromMap(
