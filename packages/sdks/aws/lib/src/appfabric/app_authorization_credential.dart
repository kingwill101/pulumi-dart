...
class AppAuthorizationCredential {
  ...
  final pulumi.Input<List<AppAuthorizationCredentialApiKeyCredential>>?
  apiKeyCredentials;

  /// Contains OAuth2 client credential information.
  final pulumi.Input<AppAuthorizationCredentialOauth2Credential>?
  oauth2Credential;
  ...
  AppAuthorizationCredential({this.apiKeyCredentials, this.oauth2Credential});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiKeyCredentials':
          ?pulumi.Input.mapOptionalInputValue<
            List<AppAuthorizationCredentialApiKeyCredential>,
      ...
      'oauth2Credential':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(oauth2Credential, (value) => value.toMap()),
    };
  }
  ...
  factory AppAuthorizationCredential.fromMap(Map<String, dynamic> map) {
    return AppAuthorizationCredential(
      apiKeyCredentials: (() {
        final guardedValue = map['apiKeyCredentials'];
      ...
      oauth2Credential: (() {
        final guardedValue = map['oauth2Credential'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
