...
class GetTagsFilterOrDimension {
  ...
  /// Creates a new [GetTagsFilterOrDimension].
  ...
  GetTagsFilterOrDimension({this.key, this.matchOptions, this.values});
  ...
  factory GetTagsFilterOrDimension.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterOrDimension(
      key: (() {
