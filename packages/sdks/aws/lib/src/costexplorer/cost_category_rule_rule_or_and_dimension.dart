...
class CostCategoryRuleRuleOrAndDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleOrAndDimension].
  ...
  const CostCategoryRuleRuleOrAndDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleOrAndDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrAndDimension(
