...
class GetCostCategoryRuleRuleAndCostCategory {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndCostCategory(
