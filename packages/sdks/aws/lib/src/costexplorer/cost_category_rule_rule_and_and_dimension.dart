...
class CostCategoryRuleRuleAndAndDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleAndAndDimension].
  ...
  const CostCategoryRuleRuleAndAndDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleAndAndDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndAndDimension(
