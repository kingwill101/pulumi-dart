...
class AnomalySubscriptionThresholdExpressionDimension {
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionDimension].
  ...
  const AnomalySubscriptionThresholdExpressionDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionDimension.fromMap(Map<String, dynamic> map) {
