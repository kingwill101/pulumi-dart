...
class GetCostCategoryRuleRuleNotTag {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotTag].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleNotTag({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleNotTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotTag(
