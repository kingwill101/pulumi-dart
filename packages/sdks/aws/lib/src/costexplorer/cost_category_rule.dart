...
class CostCategoryRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inheritedValue': ?inheritedValue == null ? null : inheritedValue!.toMap(),
  ...
  factory CostCategoryRule.fromMap(Map<String, dynamic> map) {
    return CostCategoryRule(
      inheritedValue: map['inheritedValue'] == null ? null : CostCategoryRuleInheritedValue.fromMap((map['inheritedValue'] as Map).cast<String, dynamic>()),
      rule: map['rule'] == null ? null : CostCategoryRuleRule.fromMap((map['rule'] as Map).cast<String, dynamic>()),
