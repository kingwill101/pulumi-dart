...
class CostCategoryRuleRuleNotOrTags {
  /// Key for the tag.
  ...
  /// Creates a new [CostCategoryRuleRuleNotOrTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleNotOrTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleNotOrTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotOrTags(
      key: (() {
