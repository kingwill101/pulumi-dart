...
class AnomalySubscriptionArgs {
  ...
  factory AnomalySubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionArgs(
      ...
      monitorArnLists: pulumi.Input.fromValue(
        (map['monitorArnLists'] as List).cast<String>(),
      ),
      name: (() {
      ...
      subscribers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AnomalySubscriptionSubscriber>(
          map['subscribers']!,
      ...
      thresholdExpression: (() {
        final guardedValue = map['thresholdExpression'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
