...
class GetCostCategoryRuleRuleOrDimension {
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleOrDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleOrDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrDimension(
