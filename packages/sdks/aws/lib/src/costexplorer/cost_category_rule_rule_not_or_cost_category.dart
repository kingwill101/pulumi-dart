...
class CostCategoryRuleRuleNotOrCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleNotOrCostCategory].
  ...
  const CostCategoryRuleRuleNotOrCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleNotOrCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotOrCostCategory(
