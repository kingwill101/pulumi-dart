...
class GetCostCategoryRuleRuleAndOrDimension {
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndOrDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndOrDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndOrDimension.fromMap(Map<String, dynamic> map) {
