...
class GetCostCategoryRuleRuleNotAndCostCategory {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotAndCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleNotAndCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleNotAndCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotAndCostCategory(
      key: pulumi.Input.fromValue(map['key'] as String),
      matchOptions: pulumi.Input.fromValue((map['matchOptions'] as List).cast<String>()),
