...
class GetTagsFilterNot {
  ...
  factory GetTagsFilterNot.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterNot(
      costCategory: map['costCategory'] == null ? null : (GetTagsFilterNotCostCategory.fromMap((map['costCategory'] as Map).cast<String, dynamic>())).input(),
      dimension: map['dimension'] == null ? null : (GetTagsFilterNotDimension.fromMap((map['dimension'] as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : (GetTagsFilterNotTags.fromMap((map['tags'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
