...
class AnomalySubscriptionThresholdExpressionCostCategory {
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionCostCategory].
  ...
  const AnomalySubscriptionThresholdExpressionCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionCostCategory.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionCostCategory(
