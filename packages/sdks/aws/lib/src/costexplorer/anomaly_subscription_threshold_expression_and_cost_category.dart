...
class AnomalySubscriptionThresholdExpressionAndCostCategory {
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionAndCostCategory].
  ...
  const AnomalySubscriptionThresholdExpressionAndCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionAndCostCategory.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionAndCostCategory(
