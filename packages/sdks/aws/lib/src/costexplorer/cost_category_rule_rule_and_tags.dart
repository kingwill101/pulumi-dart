...
class CostCategoryRuleRuleAndTags {
  ...
  /// Creates a new [CostCategoryRuleRuleAndTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleAndTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleAndTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndTags(
      key: (() {
