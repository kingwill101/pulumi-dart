...
class GetCostCategoryRuleRuleOrOrDimension {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrOrDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleOrOrDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleOrOrDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrOrDimension(
