...
class GetCostCategoryRuleRuleOrNotCostCategory {
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrNotCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleOrNotCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleOrNotCostCategory.fromMap(Map<String, dynamic> map) {
