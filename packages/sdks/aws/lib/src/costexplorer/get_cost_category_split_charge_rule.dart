...
class GetCostCategorySplitChargeRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'method': method,
      'parameters': pulumi.Input.encodeList<GetCostCategorySplitChargeRuleParameter, Map<String, dynamic>>(parameters, (value) => value.toMap()),
      'source': source,
      'targets': targets,
    };
  }
  ...
  factory GetCostCategorySplitChargeRule.fromMap(Map<String, dynamic> map) {
    return GetCostCategorySplitChargeRule(
      ...
      parameters: pulumi.Input.decodeList<GetCostCategorySplitChargeRuleParameter>(map['parameters'], (value) => GetCostCategorySplitChargeRuleParameter.fromMap((value as Map).cast<String, dynamic>())),
