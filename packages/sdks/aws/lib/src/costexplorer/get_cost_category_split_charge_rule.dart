...
class GetCostCategorySplitChargeRule {
  ...
  final pulumi.Input<List<GetCostCategorySplitChargeRuleParameter>> parameters;
  ...
  const GetCostCategorySplitChargeRule({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'method': method,
      'parameters': pulumi.Input.mapInputValue<List<GetCostCategorySplitChargeRuleParameter>, List<Map<String, dynamic>>>(parameters, (value) => pulumi.Input.encodeList<GetCostCategorySplitChargeRuleParameter, Map<String, dynamic>>(value, (value) => value.toMap())),
      'source': source,
      'targets': targets,
    };
  }
  ...
  factory GetCostCategorySplitChargeRule.fromMap(Map<String, dynamic> map) {
    return GetCostCategorySplitChargeRule(
      ...
      parameters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategorySplitChargeRuleParameter>(map['parameters']!, (value) => GetCostCategorySplitChargeRuleParameter.fromMap((value as Map).cast<String, dynamic>()))),
