...
class GetTagsFilterDimension {
  ...
  /// Creates a new [GetTagsFilterDimension].
  ...
  GetTagsFilterDimension({this.key, this.matchOptions, this.values});
  ...
  factory GetTagsFilterDimension.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterDimension(
      key: (() {
