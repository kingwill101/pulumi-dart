...
class GetCostCategoryRuleRuleNotDimension {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleNotDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleNotDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotDimension(
