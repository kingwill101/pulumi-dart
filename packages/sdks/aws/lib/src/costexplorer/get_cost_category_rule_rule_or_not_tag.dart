...
class GetCostCategoryRuleRuleOrNotTag {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrNotTag].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleOrNotTag({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleOrNotTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrNotTag(
