...
class GetCostCategoryRuleRuleAndOrCostCategory {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndOrCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndOrCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndOrCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndOrCostCategory(
