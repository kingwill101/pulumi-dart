...
class CostCategoryRuleRuleNotCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleNotCostCategory].
  ...
  const CostCategoryRuleRuleNotCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleNotCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotCostCategory(
