...
class GetCostCategoryRuleRuleOr {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleOrCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'ands':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrAnd>,
      ...
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrCostCategory>,
            List<Map<String, dynamic>>
          >(
            costCategories,
            (value) =>
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'nots':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrNot>,
            List<Map<String, dynamic>>
          >(
            nots,
            (value) =>
      ...
      'ors':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrOr>,
            List<Map<String, dynamic>>
          >(
            ors,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleOr.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOr(
      ands: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleOrAnd>(
          map['ands']!,
      ...
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleOrDimension>(
          map['dimensions']!,
      ...
      nots: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleOrNot>(
          map['nots']!,
      ...
      ors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleOrOr>(
          map['ors']!,
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleOrTag>(
          map['tags']!,
