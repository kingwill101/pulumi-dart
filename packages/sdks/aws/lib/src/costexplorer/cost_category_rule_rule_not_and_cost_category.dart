...
class CostCategoryRuleRuleNotAndCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleNotAndCostCategory].
  ...
  const CostCategoryRuleRuleNotAndCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleNotAndCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotAndCostCategory(
