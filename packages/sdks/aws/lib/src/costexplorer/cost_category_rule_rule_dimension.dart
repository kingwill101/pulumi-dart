...
class CostCategoryRuleRuleDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleDimension].
  ...
  CostCategoryRuleRuleDimension({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleDimension(
      key: (() {
