...
class GetCostCategoryRuleRuleNot {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleNotCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'ands':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotAnd>,
      ...
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotCostCategory>,
            List<Map<String, dynamic>>
          >(
            costCategories,
            (value) =>
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'nots':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotNot>,
            List<Map<String, dynamic>>
          >(
            nots,
            (value) =>
      ...
      'ors':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotOr>,
            List<Map<String, dynamic>>
          >(
            ors,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleNot.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNot(
      ands: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotAnd>(
          map['ands']!,
      ...
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotDimension>(
          map['dimensions']!,
      ...
      nots: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotNot>(
          map['nots']!,
      ...
      ors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotOr>(
          map['ors']!,
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotTag>(
          map['tags']!,
