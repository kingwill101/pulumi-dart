...
class GetCostCategoryRuleRuleOrNot {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleOrNotCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrNotCostCategory>,
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrNotDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOrNotTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleOrNot.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrNot(
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleOrNotTag>(
          map['tags']!,
