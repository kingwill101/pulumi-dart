...
class GetCostCategoryRule {
    ...
    return <String, dynamic>{
      'inheritedValues':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleInheritedValue>,
  ...
  factory GetCostCategoryRule.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRule(
      inheritedValues: pulumi.Input.fromValue(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRule>(
          map['rules']!,
