...
class AnomalySubscriptionThresholdExpressionAnd {
  ...
  factory AnomalySubscriptionThresholdExpressionAnd.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionAnd(
      costCategory: map['costCategory'] == null ? null : AnomalySubscriptionThresholdExpressionAndCostCategory.fromMap((map['costCategory'] as Map).cast<String, dynamic>()),
      dimension: map['dimension'] == null ? null : AnomalySubscriptionThresholdExpressionAndDimension.fromMap((map['dimension'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : AnomalySubscriptionThresholdExpressionAndTags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
    );
  }
}
