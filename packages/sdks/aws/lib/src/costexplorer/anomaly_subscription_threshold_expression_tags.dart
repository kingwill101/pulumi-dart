...
class AnomalySubscriptionThresholdExpressionTags {
  /// Key for the tag.
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionTags].
  /// [key] Key for the tag.
  ...
  const AnomalySubscriptionThresholdExpressionTags({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionTags.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionTags(
