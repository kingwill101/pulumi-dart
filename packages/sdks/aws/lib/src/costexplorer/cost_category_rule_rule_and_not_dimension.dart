...
class CostCategoryRuleRuleAndNotDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleAndNotDimension].
  ...
  const CostCategoryRuleRuleAndNotDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleAndNotDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndNotDimension(
