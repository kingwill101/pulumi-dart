...
class GetCostCategoryRuleRuleAndAndTag {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndAndTag].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndAndTag({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndAndTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndAndTag(
