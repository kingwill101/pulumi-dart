...
class AnomalySubscriptionThresholdExpressionAndDimension {
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionAndDimension].
  ...
  const AnomalySubscriptionThresholdExpressionAndDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionAndDimension.fromMap(Map<String, dynamic> map) {
