...
class CostCategoryRuleRuleOrNotCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleOrNotCostCategory].
  ...
  const CostCategoryRuleRuleOrNotCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleOrNotCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrNotCostCategory(
