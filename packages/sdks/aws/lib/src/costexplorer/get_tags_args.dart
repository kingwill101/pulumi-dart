...
class GetTagsArgs {
  ...
  factory GetTagsArgs.fromMap(Map<String, dynamic> map) {
    return GetTagsArgs(
      filter: (() { final guardedValue = map['filter']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetTagsFilter.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sortBies: (() { final guardedValue = map['sortBies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetTagsSortBy>(guardedValue, (value) => GetTagsSortBy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      timePeriod: pulumi.Input.fromValue(GetTagsTimePeriod.fromMap((map['timePeriod']! as Map).cast<String, dynamic>())),
    );
  }
}
