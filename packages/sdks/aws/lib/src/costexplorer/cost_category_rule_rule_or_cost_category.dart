...
class CostCategoryRuleRuleOrCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleOrCostCategory].
  ...
  const CostCategoryRuleRuleOrCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleOrCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrCostCategory(
