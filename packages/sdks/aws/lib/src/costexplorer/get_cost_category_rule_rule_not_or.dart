...
class GetCostCategoryRuleRuleNotOr {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleNotOrCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotOrCostCategory>,
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotOrDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotOrTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleNotOr.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotOr(
      costCategories: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotOrCostCategory>(
          map['costCategories']!,
      ...
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotOrDimension>(
          map['dimensions']!,
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotOrTag>(
          map['tags']!,
