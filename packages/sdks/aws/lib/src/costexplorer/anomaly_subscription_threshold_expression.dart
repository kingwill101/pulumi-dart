...
class AnomalySubscriptionThresholdExpression {
  ...
  final pulumi.Input<AnomalySubscriptionThresholdExpressionCostCategory>?
  costCategory;

  /// Configuration block for the specific Dimension to use for.
  final pulumi.Input<AnomalySubscriptionThresholdExpressionDimension>?
  dimension;
    ...
    return <String, dynamic>{
      'ands':
          ?pulumi.Input.mapOptionalInputValue<
            List<AnomalySubscriptionThresholdExpressionAnd>,
      ...
      'ors':
          ?pulumi.Input.mapOptionalInputValue<
            List<AnomalySubscriptionThresholdExpressionOr>,
            List<Map<String, dynamic>>
          >(
            ors,
            (value) =>
