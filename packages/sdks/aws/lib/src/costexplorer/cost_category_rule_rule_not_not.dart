...
class CostCategoryRuleRuleNotNot {
  ...
  factory CostCategoryRuleRuleNotNot.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotNot(
      costCategory: map['costCategory'] == null ? null : CostCategoryRuleRuleNotNotCostCategory.fromMap((map['costCategory'] as Map).cast<String, dynamic>()),
      dimension: map['dimension'] == null ? null : CostCategoryRuleRuleNotNotDimension.fromMap((map['dimension'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : CostCategoryRuleRuleNotNotTags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
    );
  }
}
