...
class GetCostCategoryRuleRuleNotNotDimension {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotNotDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleNotNotDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleNotNotDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotNotDimension(
