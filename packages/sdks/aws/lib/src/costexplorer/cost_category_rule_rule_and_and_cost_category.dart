...
class CostCategoryRuleRuleAndAndCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleAndAndCostCategory].
  ...
  const CostCategoryRuleRuleAndAndCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleAndAndCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndAndCostCategory(
