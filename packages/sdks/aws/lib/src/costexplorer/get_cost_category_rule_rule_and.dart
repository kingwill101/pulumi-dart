...
class GetCostCategoryRuleRuleAnd {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleAndCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'ands':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndAnd>,
      ...
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndCostCategory>,
            List<Map<String, dynamic>>
          >(
            costCategories,
            (value) =>
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'nots':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndNot>,
            List<Map<String, dynamic>>
          >(
            nots,
            (value) =>
      ...
      'ors':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndOr>,
            List<Map<String, dynamic>>
          >(
            ors,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleAnd.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAnd(
      ands: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleAndAnd>(
          map['ands']!,
      ...
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleAndDimension>(
          map['dimensions']!,
      ...
      nots: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleAndNot>(
          map['nots']!,
      ...
      ors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleAndOr>(
          map['ors']!,
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleAndTag>(
          map['tags']!,
