...
class GetCostCategoryRuleRuleAnd {
  ...
  factory GetCostCategoryRuleRuleAnd.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAnd(
      ands: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleAndAnd>(map['ands']!, (value) => GetCostCategoryRuleRuleAndAnd.fromMap((value as Map).cast<String, dynamic>()))),
      costCategories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleAndCostCategory>(map['costCategories']!, (value) => GetCostCategoryRuleRuleAndCostCategory.fromMap((value as Map).cast<String, dynamic>()))),
      dimensions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleAndDimension>(map['dimensions']!, (value) => GetCostCategoryRuleRuleAndDimension.fromMap((value as Map).cast<String, dynamic>()))),
      nots: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleAndNot>(map['nots']!, (value) => GetCostCategoryRuleRuleAndNot.fromMap((value as Map).cast<String, dynamic>()))),
      ors: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleAndOr>(map['ors']!, (value) => GetCostCategoryRuleRuleAndOr.fromMap((value as Map).cast<String, dynamic>()))),
      tags: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleAndTag>(map['tags']!, (value) => GetCostCategoryRuleRuleAndTag.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
