...
class GetCostCategoryRuleRuleNotAndDimension {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotAndDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleNotAndDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleNotAndDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotAndDimension(
