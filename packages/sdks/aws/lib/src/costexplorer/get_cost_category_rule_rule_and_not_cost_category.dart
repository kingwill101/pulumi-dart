...
class GetCostCategoryRuleRuleAndNotCostCategory {
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndNotCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndNotCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndNotCostCategory.fromMap(Map<String, dynamic> map) {
