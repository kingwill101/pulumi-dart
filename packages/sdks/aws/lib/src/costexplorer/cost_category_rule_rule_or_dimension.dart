...
class CostCategoryRuleRuleOrDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleOrDimension].
  ...
  CostCategoryRuleRuleOrDimension({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleOrDimension.fromMap(Map<String, dynamic> map) {
