...
class CostCategoryRuleRuleOrAnd {
  ...
  factory CostCategoryRuleRuleOrAnd.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrAnd(
      costCategory: (() { final guardedValue = map['costCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CostCategoryRuleRuleOrAndCostCategory.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dimension: (() { final guardedValue = map['dimension']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CostCategoryRuleRuleOrAndDimension.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CostCategoryRuleRuleOrAndTags.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
