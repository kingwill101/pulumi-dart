...
class CostCategoryRuleRuleOrAnd {
  ...
  factory CostCategoryRuleRuleOrAnd.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrAnd(
      costCategory: map['costCategory'] == null ? null : (CostCategoryRuleRuleOrAndCostCategory.fromMap((map['costCategory'] as Map).cast<String, dynamic>())).input(),
      dimension: map['dimension'] == null ? null : (CostCategoryRuleRuleOrAndDimension.fromMap((map['dimension'] as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : (CostCategoryRuleRuleOrAndTags.fromMap((map['tags'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
