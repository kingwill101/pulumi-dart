...
class GetCostCategoryRuleRuleAndNotDimension {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndNotDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndNotDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndNotDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndNotDimension(
