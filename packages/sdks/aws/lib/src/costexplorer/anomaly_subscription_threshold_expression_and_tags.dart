...
class AnomalySubscriptionThresholdExpressionAndTags {
  /// Key for the tag.
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionAndTags].
  /// [key] Key for the tag.
  ...
  const AnomalySubscriptionThresholdExpressionAndTags({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionAndTags.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionAndTags(
