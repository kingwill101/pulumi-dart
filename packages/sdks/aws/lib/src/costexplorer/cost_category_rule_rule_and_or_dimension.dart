...
class CostCategoryRuleRuleAndOrDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleAndOrDimension].
  ...
  const CostCategoryRuleRuleAndOrDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleAndOrDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndOrDimension(
