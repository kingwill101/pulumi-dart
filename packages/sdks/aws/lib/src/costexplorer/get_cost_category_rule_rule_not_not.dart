...
class GetCostCategoryRuleRuleNotNot {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleNotNotCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotNotCostCategory>,
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotNotDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotNotTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleNotNot.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotNot(
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotNotTag>(
          map['tags']!,
