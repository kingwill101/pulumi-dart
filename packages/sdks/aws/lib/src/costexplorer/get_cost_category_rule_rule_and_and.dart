...
class GetCostCategoryRuleRuleAndAnd {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleAndAndCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndAndCostCategory>,
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndAndDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAndAndTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleAndAnd.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndAnd(
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleAndAndTag>(
          map['tags']!,
