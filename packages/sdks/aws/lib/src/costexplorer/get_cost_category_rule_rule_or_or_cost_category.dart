...
class GetCostCategoryRuleRuleOrOrCostCategory {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrOrCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleOrOrCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleOrOrCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrOrCostCategory(
