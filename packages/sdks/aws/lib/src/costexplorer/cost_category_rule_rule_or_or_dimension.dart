...
class CostCategoryRuleRuleOrOrDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleOrOrDimension].
  ...
  CostCategoryRuleRuleOrOrDimension({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleOrOrDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrOrDimension(
      key: (() {
