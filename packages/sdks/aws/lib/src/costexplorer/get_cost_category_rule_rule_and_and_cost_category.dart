...
class GetCostCategoryRuleRuleAndAndCostCategory {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndAndCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndAndCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndAndCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndAndCostCategory(
