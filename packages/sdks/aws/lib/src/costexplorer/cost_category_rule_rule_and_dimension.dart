...
class CostCategoryRuleRuleAndDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleAndDimension].
  ...
  CostCategoryRuleRuleAndDimension({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleAndDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndDimension(
      key: (() {
