...
class CostCategoryRuleRuleOrOr {
  ...
  const CostCategoryRuleRuleOrOr({
    this.costCategory,
    this.dimension,
    this.tags,
  });
  ...
  factory CostCategoryRuleRuleOrOr.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrOr(
      costCategory: (() { final guardedValue = map['costCategory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CostCategoryRuleRuleOrOrCostCategory.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dimension: (() { final guardedValue = map['dimension']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CostCategoryRuleRuleOrOrDimension.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CostCategoryRuleRuleOrOrTags.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
