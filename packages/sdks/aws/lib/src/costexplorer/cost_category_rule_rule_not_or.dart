...
class CostCategoryRuleRuleNotOr {
  ...
  factory CostCategoryRuleRuleNotOr.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotOr(
      costCategory: map['costCategory'] == null ? null : CostCategoryRuleRuleNotOrCostCategory.fromMap((map['costCategory'] as Map).cast<String, dynamic>()),
      dimension: map['dimension'] == null ? null : CostCategoryRuleRuleNotOrDimension.fromMap((map['dimension'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : CostCategoryRuleRuleNotOrTags.fromMap((map['tags'] as Map).cast<String, dynamic>()),
    );
  }
}
