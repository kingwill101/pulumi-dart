...
class AnomalySubscriptionThresholdExpressionNotCostCategory {
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionNotCostCategory].
  ...
  const AnomalySubscriptionThresholdExpressionNotCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionNotCostCategory.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionNotCostCategory(
