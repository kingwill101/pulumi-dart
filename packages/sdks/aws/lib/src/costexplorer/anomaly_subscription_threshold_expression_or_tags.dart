...
class AnomalySubscriptionThresholdExpressionOrTags {
  /// Key for the tag.
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionOrTags].
  /// [key] Key for the tag.
  ...
  const AnomalySubscriptionThresholdExpressionOrTags({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionOrTags.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionOrTags(
