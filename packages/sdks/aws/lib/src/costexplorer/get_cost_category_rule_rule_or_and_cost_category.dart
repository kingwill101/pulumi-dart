...
class GetCostCategoryRuleRuleOrAndCostCategory {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrAndCostCategory].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleOrAndCostCategory({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleOrAndCostCategory.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrAndCostCategory(
