...
class AnomalySubscriptionThresholdExpressionOrDimension {
  ...
  /// Creates a new [AnomalySubscriptionThresholdExpressionOrDimension].
  ...
  const AnomalySubscriptionThresholdExpressionOrDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory AnomalySubscriptionThresholdExpressionOrDimension.fromMap(Map<String, dynamic> map) {
    return AnomalySubscriptionThresholdExpressionOrDimension(
