    ...
    return <String, dynamic>{
      'ands':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleAnd>,
      ...
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleCostCategory>,
            List<Map<String, dynamic>>
          >(
            costCategories,
            (value) =>
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'nots':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNot>,
            List<Map<String, dynamic>>
          >(
            nots,
            (value) =>
      ...
      'ors':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleOr>,
            List<Map<String, dynamic>>
          >(
            ors,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRule.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRule(
      ands: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleAnd>(
          map['ands']!,
      ...
      dimensions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleDimension>(
          map['dimensions']!,
      ...
      nots: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNot>(
          map['nots']!,
      ...
      ors: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleOr>(
          map['ors']!,
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleTag>(
          map['tags']!,
