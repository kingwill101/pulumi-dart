...
class GetCostCategoryRuleRuleAndOrTag {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndOrTag].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndOrTag({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndOrTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndOrTag(
