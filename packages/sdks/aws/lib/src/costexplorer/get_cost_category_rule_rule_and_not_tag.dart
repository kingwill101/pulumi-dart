...
class GetCostCategoryRuleRuleAndNotTag {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndNotTag].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndNotTag({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndNotTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndNotTag(
