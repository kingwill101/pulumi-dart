...
class GetCostCategoryRuleRuleNotOrTag {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleNotOrTag].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleNotOrTag({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleNotOrTag.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotOrTag(
