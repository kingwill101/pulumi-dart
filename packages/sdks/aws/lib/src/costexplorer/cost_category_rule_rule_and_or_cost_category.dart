...
class CostCategoryRuleRuleAndOrCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleAndOrCostCategory].
  ...
  const CostCategoryRuleRuleAndOrCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleAndOrCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndOrCostCategory(
