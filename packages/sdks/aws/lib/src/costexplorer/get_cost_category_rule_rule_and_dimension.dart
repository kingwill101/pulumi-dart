...
class GetCostCategoryRuleRuleAndDimension {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleAndDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleAndDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleAndDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleAndDimension(
