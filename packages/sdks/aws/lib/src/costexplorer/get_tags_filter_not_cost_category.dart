...
class GetTagsFilterNotCostCategory {
  ...
  /// Creates a new [GetTagsFilterNotCostCategory].
  ...
  GetTagsFilterNotCostCategory({this.key, this.matchOptions, this.values});
  ...
  factory GetTagsFilterNotCostCategory.fromMap(Map<String, dynamic> map) {
    return GetTagsFilterNotCostCategory(
      key: (() {
