...
class CostCategoryRuleRuleNotOrDimension {
  ...
  /// Creates a new [CostCategoryRuleRuleNotOrDimension].
  ...
  const CostCategoryRuleRuleNotOrDimension({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleNotOrDimension.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotOrDimension(
