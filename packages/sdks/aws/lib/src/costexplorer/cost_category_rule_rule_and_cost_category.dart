...
class CostCategoryRuleRuleAndCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleAndCostCategory].
  ...
  const CostCategoryRuleRuleAndCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleAndCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleAndCostCategory(
