...
class GetCostCategoryRuleRuleNotAnd {
  ...
  const GetCostCategoryRuleRuleNotAnd({
  ...
  factory GetCostCategoryRuleRuleNotAnd.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotAnd(
      costCategories: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleNotAndCostCategory>(map['costCategories']!, (value) => GetCostCategoryRuleRuleNotAndCostCategory.fromMap((value as Map).cast<String, dynamic>()))),
      dimensions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleNotAndDimension>(map['dimensions']!, (value) => GetCostCategoryRuleRuleNotAndDimension.fromMap((value as Map).cast<String, dynamic>()))),
      tags: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCostCategoryRuleRuleNotAndTag>(map['tags']!, (value) => GetCostCategoryRuleRuleNotAndTag.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
