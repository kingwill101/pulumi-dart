...
class GetCostCategoryRuleRuleNotAnd {
  ...
  final pulumi.Input<List<GetCostCategoryRuleRuleNotAndCostCategory>>
  costCategories;
    ...
    return <String, dynamic>{
      'costCategories':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotAndCostCategory>,
      ...
      'dimensions':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotAndDimension>,
            List<Map<String, dynamic>>
          >(
            dimensions,
            (value) =>
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetCostCategoryRuleRuleNotAndTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetCostCategoryRuleRuleNotAnd.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleNotAnd(
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCostCategoryRuleRuleNotAndTag>(
          map['tags']!,
