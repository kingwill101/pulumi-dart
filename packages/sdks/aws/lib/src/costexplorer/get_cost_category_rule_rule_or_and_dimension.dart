...
class GetCostCategoryRuleRuleOrAndDimension {
  /// Key for the tag.
  ...
  /// Creates a new [GetCostCategoryRuleRuleOrAndDimension].
  /// [key] Key for the tag.
  ...
  const GetCostCategoryRuleRuleOrAndDimension({
    required this.key,
  ...
  factory GetCostCategoryRuleRuleOrAndDimension.fromMap(Map<String, dynamic> map) {
    return GetCostCategoryRuleRuleOrAndDimension(
