...
class CostCategoryRuleRuleNotNotTags {
  /// Key for the tag.
  ...
  /// Creates a new [CostCategoryRuleRuleNotNotTags].
  /// [key] Key for the tag.
  ...
  CostCategoryRuleRuleNotNotTags({this.key, this.matchOptions, this.values});
  ...
  factory CostCategoryRuleRuleNotNotTags.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleNotNotTags(
      key: (() {
