...
class CostCategoryRuleRuleOrAndCostCategory {
  ...
  /// Creates a new [CostCategoryRuleRuleOrAndCostCategory].
  ...
  const CostCategoryRuleRuleOrAndCostCategory({
    this.key,
    this.matchOptions,
    this.values,
  });
  ...
  factory CostCategoryRuleRuleOrAndCostCategory.fromMap(Map<String, dynamic> map) {
    return CostCategoryRuleRuleOrAndCostCategory(
