...
class ScheduleTargetEcsParameters {
  ...
  final pulumi.Input<List<ScheduleTargetEcsParametersCapacityProviderStrategy>>?
  ...
  final pulumi.Input<ScheduleTargetEcsParametersNetworkConfiguration>?
  networkConfiguration;

  /// A set of up to 10 placement constraints to use for the task. Detailed below.
  final pulumi.Input<List<ScheduleTargetEcsParametersPlacementConstraint>>?
  placementConstraints;

  /// A set of up to 5 placement strategies. Detailed below.
  final pulumi.Input<List<ScheduleTargetEcsParametersPlacementStrategy>>?
  placementStrategies;
    ...
    return <String, dynamic>{
      'capacityProviderStrategies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScheduleTargetEcsParametersCapacityProviderStrategy>,
      ...
      'placementConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScheduleTargetEcsParametersPlacementConstraint>,
            List<Map<String, dynamic>>
          >(
            placementConstraints,
            (value) =>
      ...
      'placementStrategies':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScheduleTargetEcsParametersPlacementStrategy>,
            List<Map<String, dynamic>>
          >(
            placementStrategies,
            (value) =>
  ...
  factory ScheduleTargetEcsParameters.fromMap(Map<String, dynamic> map) {
    return ScheduleTargetEcsParameters(
      ...
      placementStrategies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScheduleTargetEcsParametersPlacementStrategy>(
            guardedValue,
      ...
      taskDefinitionArn: pulumi.Input.fromValue(
        map['taskDefinitionArn'] as String,
      ),
    );
  }
}
