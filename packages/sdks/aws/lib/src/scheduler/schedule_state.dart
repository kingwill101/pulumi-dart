  ...
  factory ScheduleState.fromMap(Map<String, dynamic> map) {
    return ScheduleState(
      actionAfterCompletion: (() {
        final guardedValue = map['actionAfterCompletion'];
      ...
      flexibleTimeWindow: (() {
        final guardedValue = map['flexibleTimeWindow'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScheduleFlexibleTimeWindow.fromMap(
      ...
      target: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScheduleTarget.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
