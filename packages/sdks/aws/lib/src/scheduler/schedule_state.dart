...
class ScheduleState {
  ...
  factory ScheduleState.fromMap(Map<String, dynamic> map) {
    return ScheduleState(
      ...
      flexibleTimeWindow: (() { final guardedValue = map['flexibleTimeWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduleFlexibleTimeWindow.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduleTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
