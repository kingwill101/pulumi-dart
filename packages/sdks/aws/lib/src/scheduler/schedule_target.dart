...
class ScheduleTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'eventbridgeParameters': ?eventbridgeParameters == null ? null : eventbridgeParameters!.toMap(),
      'input': ?input,
      'kinesisParameters': ?kinesisParameters == null ? null : kinesisParameters!.toMap(),
  ...
  factory ScheduleTarget.fromMap(Map<String, dynamic> map) {
    return ScheduleTarget(
      ...
      deadLetterConfig: map['deadLetterConfig'] == null ? null : ScheduleTargetDeadLetterConfig.fromMap((map['deadLetterConfig'] as Map).cast<String, dynamic>()),
      ecsParameters: map['ecsParameters'] == null ? null : ScheduleTargetEcsParameters.fromMap((map['ecsParameters'] as Map).cast<String, dynamic>()),
      eventbridgeParameters: map['eventbridgeParameters'] == null ? null : ScheduleTargetEventbridgeParameters.fromMap((map['eventbridgeParameters'] as Map).cast<String, dynamic>()),
      input: map['input'] == null ? null : map['input'] as String,
      kinesisParameters: map['kinesisParameters'] == null ? null : ScheduleTargetKinesisParameters.fromMap((map['kinesisParameters'] as Map).cast<String, dynamic>()),
      retryPolicy: map['retryPolicy'] == null ? null : ScheduleTargetRetryPolicy.fromMap((map['retryPolicy'] as Map).cast<String, dynamic>()),
      roleArn: map['roleArn'] as String,
      sagemakerPipelineParameters: map['sagemakerPipelineParameters'] == null ? null : ScheduleTargetSagemakerPipelineParameters.fromMap((map['sagemakerPipelineParameters'] as Map).cast<String, dynamic>()),
      sqsParameters: map['sqsParameters'] == null ? null : ScheduleTargetSqsParameters.fromMap((map['sqsParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
