...
class ScheduleTargetSagemakerPipelineParameters {
  ...
  factory ScheduleTargetSagemakerPipelineParameters.fromMap(Map<String, dynamic> map) {
    return ScheduleTargetSagemakerPipelineParameters(
      pipelineParameters: (() { final guardedValue = map['pipelineParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ScheduleTargetSagemakerPipelineParametersPipelineParameter>(guardedValue, (value) => ScheduleTargetSagemakerPipelineParametersPipelineParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
