...
class GetServiceDnsConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dnsRecords': pulumi.Input.encodeList<GetServiceDnsConfigDnsRecord, Map<String, dynamic>>(dnsRecords, (value) => value.toMap()),
  ...
  factory GetServiceDnsConfig.fromMap(Map<String, dynamic> map) {
    return GetServiceDnsConfig(
      dnsRecords: pulumi.Input.decodeList<GetServiceDnsConfigDnsRecord>(map['dnsRecords'], (value) => GetServiceDnsConfigDnsRecord.fromMap((value as Map).cast<String, dynamic>())),
