...
class HttpNamespaceState {
  ...
  factory HttpNamespaceState.fromMap(Map<String, dynamic> map) {
    return HttpNamespaceState(
      ...
      httpName: (() { final guardedValue = map['httpName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
