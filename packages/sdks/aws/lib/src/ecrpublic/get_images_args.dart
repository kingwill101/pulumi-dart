...
class GetImagesArgs {
  ...
  factory GetImagesArgs.fromMap(Map<String, dynamic> map) {
    return GetImagesArgs(
      imageIds: (() { final guardedValue = map['imageIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetImagesImageId>(guardedValue, (value) => GetImagesImageId.fromMap((value as Map).cast<String, dynamic>()))); })(),
