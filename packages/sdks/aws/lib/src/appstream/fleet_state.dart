...
class FleetState {
  ...
  factory FleetState.fromMap(Map<String, dynamic> map) {
    return FleetState(
      ...
      computeCapacity: map['computeCapacity'] == null ? null : ((FleetComputeCapacity.fromMap((map['computeCapacity']! as Map).cast<String, dynamic>())).input()).input(),
      createdTime: map['createdTime'] == null ? null : ((map['createdTime'] as String).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      disconnectTimeoutInSeconds: map['disconnectTimeoutInSeconds'] == null ? null : ((map['disconnectTimeoutInSeconds'] as int).input()).input(),
      displayName: map['displayName'] == null ? null : ((map['displayName'] as String).input()).input(),
      domainJoinInfo: map['domainJoinInfo'] == null ? null : ((FleetDomainJoinInfo.fromMap((map['domainJoinInfo']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      idleDisconnectTimeoutInSeconds: map['idleDisconnectTimeoutInSeconds'] == null ? null : ((map['idleDisconnectTimeoutInSeconds'] as int).input()).input(),
      ...
      maxSessionsPerInstance: map['maxSessionsPerInstance'] == null ? null : ((map['maxSessionsPerInstance'] as int).input()).input(),
      maxUserDurationInSeconds: map['maxUserDurationInSeconds'] == null ? null : ((map['maxUserDurationInSeconds'] as int).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      state: map['state'] == null ? null : ((map['state'] as String).input()).input(),
      streamView: map['streamView'] == null ? null : ((map['streamView'] as String).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      vpcConfig: map['vpcConfig'] == null ? null : ((FleetVpcConfig.fromMap((map['vpcConfig']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
