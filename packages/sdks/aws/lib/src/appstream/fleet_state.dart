...
class FleetState {
  ...
  FleetState({
    ...
    pulumi.Output<FleetComputeCapacity>? computeCapacity,
    ...
    pulumi.Output<FleetVpcConfig>? vpcConfig,
      ...
      computeCapacity = pulumi.Input.asOptionalInput<FleetComputeCapacity>(computeCapacity),
  ...
  factory FleetState.fromMap(Map<String, dynamic> map) {
    return FleetState(
      ...
      computeCapacity: map['computeCapacity'] == null ? null : pulumi.Output.create<FleetComputeCapacity>(FleetComputeCapacity.fromMap((map['computeCapacity'] as Map).cast<String, dynamic>())),
