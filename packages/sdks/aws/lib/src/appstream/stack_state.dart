    ...
    return <String, dynamic>{
      ...
      'streamingExperienceSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(streamingExperienceSettings, (value) => value.toMap()),
      'tags': ?tags,
      'tagsAll': ?tagsAll,
      'userSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<StackUserSetting>,
            List<Map<String, dynamic>>
          >(
            userSettings,
            (value) =>
    ...
    return StackState(
      accessEndpoints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackAccessEndpoint>(
            guardedValue,
            (value) => StackAccessEndpoint.fromMap(
      ...
      applicationSettings: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StackApplicationSettings.fromMap(
      ...
      embedHostDomains: (() {
        final guardedValue = map['embedHostDomains'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      feedbackUrl: (() {
        final guardedValue = map['feedbackUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      storageConnectors: (() {
        final guardedValue = map['storageConnectors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackStorageConnector>(
            guardedValue,
            (value) => StackStorageConnector.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      streamingExperienceSettings: (() {
        final guardedValue = map['streamingExperienceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          StackStreamingExperienceSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      userSettings: (() {
        final guardedValue = map['userSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackUserSetting>(
            guardedValue,
            (value) => StackUserSetting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
