...
class Stack extends pulumi.CustomResource {
  ...
  Stack(
    ...
    this.accessEndpoints = registerOutput<List<StackAccessEndpoint>>('accessEndpoints');
    this.applicationSettings = registerOutput<StackApplicationSettings>('applicationSettings');
    ...
    this.storageConnectors = registerOutput<List<StackStorageConnector>>('storageConnectors');
    this.streamingExperienceSettings = registerOutput<StackStreamingExperienceSettings>('streamingExperienceSettings');
