...
class GetImageApplication {
    ...
    return <String, dynamic>{
      ...
      'iconS3Locations':
          pulumi.Input.mapInputValue<
            List<GetImageApplicationIconS3Location>,
  ...
  factory GetImageApplication.fromMap(Map<String, dynamic> map) {
    return GetImageApplication(
      ...
      iconS3Locations: pulumi.Input.fromValue(
      ...
      instanceFamilies: pulumi.Input.fromValue(
        (map['instanceFamilies'] as List).cast<String>(),
      ),
      launchParameters: pulumi.Input.fromValue(
        map['launchParameters'] as String,
      ),
