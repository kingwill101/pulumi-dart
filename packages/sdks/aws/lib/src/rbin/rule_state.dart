...
class RuleState {
    ...
    return <String, dynamic>{
      ...
      'lockConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(lockConfiguration, (value) => value.toMap()),
      'lockEndTime': ?lockEndTime,
      'lockState': ?lockState,
      'region': ?region,
      'resourceTags':
          ?pulumi.Input.mapOptionalInputValue<
            List<RuleResourceTag>,
            List<Map<String, dynamic>>
          >(
            resourceTags,
            (value) =>
  ...
  factory RuleState.fromMap(Map<String, dynamic> map) {
    return RuleState(
      ...
      excludeResourceTags: (() {
        final guardedValue = map['excludeResourceTags'];
        if (guardedValue == null) return null;
      ...
      lockConfiguration: (() {
        final guardedValue = map['lockConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lockEndTime: (() {
        final guardedValue = map['lockEndTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lockState: (() {
        final guardedValue = map['lockState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      resourceTags: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RuleResourceTag>(
            guardedValue,
            (value) =>
                RuleResourceTag.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      resourceType: (() {
