...
class AccountSuppressionAttributesState {
  ...
  /// [suppressedReasons] Reasons that email addresses are automatically added to the suppression list for your account. Valid values: `COMPLAINT`, `BOUNCE`.
  const AccountSuppressionAttributesState({
    this.region,
