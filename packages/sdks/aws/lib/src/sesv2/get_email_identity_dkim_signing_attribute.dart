...
class GetEmailIdentityDkimSigningAttribute {
  ...
  /// [domainSigningPrivateKey] [Bring Your Own DKIM] Private key used to generate DKIM signatures.
  /// [domainSigningSelector] [Bring Your Own DKIM] Selector added to the DNS configuration for the domain.
  ...
  /// [signingAttributesOrigin] String that indicates how DKIM was configured for the identity. `AWS_SES` indicates that DKIM was configured for the identity by using Easy DKIM. `EXTERNAL` indicates that DKIM was configured for the identity by using Bring Your Own DKIM (BYODKIM).
  ...
  const GetEmailIdentityDkimSigningAttribute({
  ...
  factory GetEmailIdentityDkimSigningAttribute.fromMap(Map<String, dynamic> map) {
    return GetEmailIdentityDkimSigningAttribute(
      currentSigningKeyLength: pulumi.Input.fromValue(map['currentSigningKeyLength'] as String),
      domainSigningPrivateKey: pulumi.Input.fromValue(map['domainSigningPrivateKey'] as String),
      domainSigningSelector: pulumi.Input.fromValue(map['domainSigningSelector'] as String),
      lastKeyGenerationTimestamp: pulumi.Input.fromValue(map['lastKeyGenerationTimestamp'] as String),
      nextSigningKeyLength: pulumi.Input.fromValue(map['nextSigningKeyLength'] as String),
      signingAttributesOrigin: pulumi.Input.fromValue(map['signingAttributesOrigin'] as String),
