...
class MultiRegionEndpointTimeouts {
  ...
  /// Creates a new [MultiRegionEndpointTimeouts].
  ...
  const MultiRegionEndpointTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory MultiRegionEndpointTimeouts.fromMap(Map<String, dynamic> map) {
    return MultiRegionEndpointTimeouts(
