...
class EmailIdentityDkimSigningAttributes {
  ...
  /// [currentSigningKeyLength] [Easy DKIM] Key length of the DKIM key pair in use.
  /// [domainSigningPrivateKey] [Bring Your Own DKIM] Private key used to generate a DKIM signature. The private key must use 1024 or 2048-bit RSA encryption, and must be encoded using base64 encoding.
  /// [domainSigningSelector] [Bring Your Own DKIM] String used to identify a public key in the DNS configuration for a domain.
  /// [lastKeyGenerationTimestamp] [Easy DKIM] Last time a key pair was generated for this identity.
  /// [nextSigningKeyLength] [Easy DKIM] Key length of the future DKIM key pair to be generated. This can be changed at most once per day. Valid values: `RSA_1024_BIT`, `RSA_2048_BIT`.
  /// [signingAttributesOrigin] How DKIM was configured for the identity. `AWS_SES` indicates that DKIM was configured for the identity by using Easy DKIM. `EXTERNAL` indicates that DKIM was configured for the identity by using Bring Your Own DKIM (BYODKIM).
