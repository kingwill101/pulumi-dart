  ...
  factory EmailIdentityDkimSigningAttributes.fromMap(Map<String, dynamic> map) {
    return EmailIdentityDkimSigningAttributes(
      currentSigningKeyLength: (() {
        final guardedValue = map['currentSigningKeyLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      domainSigningPrivateKey: (() {
        final guardedValue = map['domainSigningPrivateKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      domainSigningSelector: (() {
        final guardedValue = map['domainSigningSelector'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lastKeyGenerationTimestamp: (() {
        final guardedValue = map['lastKeyGenerationTimestamp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nextSigningKeyLength: (() {
        final guardedValue = map['nextSigningKeyLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signingAttributesOrigin: (() {
        final guardedValue = map['signingAttributesOrigin'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      status: (() {
