...
class ConfigurationSetVdmOptions {
  ...
  final pulumi.Input<ConfigurationSetVdmOptionsDashboardOptions>?
  dashboardOptions;
  ...
  final pulumi.Input<ConfigurationSetVdmOptionsGuardianOptions>?
  guardianOptions;
  ...
  factory ConfigurationSetVdmOptions.fromMap(Map<String, dynamic> map) {
    return ConfigurationSetVdmOptions(
      dashboardOptions: (() {
        final guardedValue = map['dashboardOptions'];
      ...
      guardianOptions: (() {
        final guardedValue = map['guardianOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
