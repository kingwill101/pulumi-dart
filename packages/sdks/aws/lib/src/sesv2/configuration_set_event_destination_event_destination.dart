...
class ConfigurationSetEventDestinationEventDestination {
    ...
    return <String, dynamic>{
      'cloudWatchDestination':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationSetEventDestinationEventDestinationCloudWatchDestination,
            Map<String, dynamic>
          >(cloudWatchDestination, (value) => value.toMap()),
      'enabled': ?enabled,
      'eventBridgeDestination':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationSetEventDestinationEventDestinationEventBridgeDestination,
            Map<String, dynamic>
          >(eventBridgeDestination, (value) => value.toMap()),
      'kinesisFirehoseDestination':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationSetEventDestinationEventDestinationKinesisFirehoseDestination,
            Map<String, dynamic>
          >(kinesisFirehoseDestination, (value) => value.toMap()),
      'matchingEventTypes': matchingEventTypes,
      'pinpointDestination':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationSetEventDestinationEventDestinationPinpointDestination,
            Map<String, dynamic>
          >(pinpointDestination, (value) => value.toMap()),
      'snsDestination':
          ?pulumi.Input.mapOptionalInputValue<
            ConfigurationSetEventDestinationEventDestinationSnsDestination,
            Map<String, dynamic>
  ...
  factory ConfigurationSetEventDestinationEventDestination.fromMap(
    ...
    return ConfigurationSetEventDestinationEventDestination(
      cloudWatchDestination: (() {
        final guardedValue = map['cloudWatchDestination'];
      ...
      eventBridgeDestination: (() {
        final guardedValue = map['eventBridgeDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kinesisFirehoseDestination: (() {
        final guardedValue = map['kinesisFirehoseDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      matchingEventTypes: pulumi.Input.fromValue(
        (map['matchingEventTypes'] as List).cast<String>(),
      ),
      pinpointDestination: (() {
        final guardedValue = map['pinpointDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
