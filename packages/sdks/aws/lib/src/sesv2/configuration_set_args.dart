...
class ConfigurationSetArgs {
  ...
  factory ConfigurationSetArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationSetArgs(
      ...
      reputationOptions: (() { final guardedValue = map['reputationOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigurationSetReputationOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sendingOptions: (() { final guardedValue = map['sendingOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigurationSetSendingOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      suppressionOptions: (() { final guardedValue = map['suppressionOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigurationSetSuppressionOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vdmOptions: (() { final guardedValue = map['vdmOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConfigurationSetVdmOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
