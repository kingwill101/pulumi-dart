...
import 'account_suppression_attributes_state.dart';
...
/// }
///
/// resource "aws_sesv2_accountsuppressionattributes" "example" {
...
class AccountSuppressionAttributes extends pulumi.CustomResource {
  ...
  static AccountSuppressionAttributes get(
    String name,
  ...
  AccountSuppressionAttributes._get(
    String name, {
