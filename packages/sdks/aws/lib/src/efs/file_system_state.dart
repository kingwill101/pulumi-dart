...
class FileSystemState {
  ...
  factory FileSystemState.fromMap(Map<String, dynamic> map) {
    return FileSystemState(
      ...
      numberOfMountTargets: map['numberOfMountTargets'] == null ? null : (map['numberOfMountTargets'] as int).input(),
      ...
      sizeInBytes: map['sizeInBytes'] == null ? null : (pulumi.Input.decodeList<FileSystemSizeInByte>(map['sizeInBytes'], (value) => FileSystemSizeInByte.fromMap((value as Map).cast<String, dynamic>()))).input(),
