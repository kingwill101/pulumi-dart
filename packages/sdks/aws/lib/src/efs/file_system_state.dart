  ...
  factory FileSystemState.fromMap(Map<String, dynamic> map) {
    return FileSystemState(
      ...
      numberOfMountTargets: (() {
        final guardedValue = map['numberOfMountTargets'];
        if (guardedValue == null) return null;
      ...
      protection: (() {
        final guardedValue = map['protection'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sizeInBytes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FileSystemSizeInByte>(
            guardedValue,
            (value) => FileSystemSizeInByte.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
