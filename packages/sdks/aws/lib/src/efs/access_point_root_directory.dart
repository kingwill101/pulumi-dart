...
class AccessPointRootDirectory {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'creationInfo': ?pulumi.Input.mapOptionalInputValue<AccessPointRootDirectoryCreationInfo, Map<String, dynamic>>(creationInfo, (value) => value.toMap()),
      'path': ?path,
    };
  }
  ...
  factory AccessPointRootDirectory.fromMap(Map<String, dynamic> map) {
    return AccessPointRootDirectory(
      creationInfo: (() { final guardedValue = map['creationInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AccessPointRootDirectoryCreationInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
