    ...
    return ReplicationConfigurationState(
      ...
      destination: (() {
        ...
        return pulumi.Input.fromValue(
          ReplicationConfigurationDestination.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      originalSourceFileSystemArn: (() {
        final guardedValue = map['originalSourceFileSystemArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      sourceFileSystemArn: (() {
        final guardedValue = map['sourceFileSystemArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceFileSystemId: (() {
        final guardedValue = map['sourceFileSystemId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourceFileSystemRegion: (() {
        final guardedValue = map['sourceFileSystemRegion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
