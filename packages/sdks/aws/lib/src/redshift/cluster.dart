...
class Cluster extends pulumi.CustomResource {
  ...
  Cluster(
    ...
    automatedSnapshotRetentionPeriod = registerOutput<int?>(
      'automatedSnapshotRetentionPeriod',
    );
    availabilityZone = registerOutput<String>('availabilityZone');
    availabilityZoneRelocationEnabled = registerOutput<bool?>(
    ...
    clusterParameterGroupName = registerOutput<String>(
    ...
    masterPasswordSecretKmsKeyId = registerOutput<String>(
    ...
    snapshotClusterIdentifier = registerOutput<String?>(
