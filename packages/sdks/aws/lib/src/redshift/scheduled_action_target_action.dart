...
class ScheduledActionTargetAction {
  ...
  factory ScheduledActionTargetAction.fromMap(Map<String, dynamic> map) {
    return ScheduledActionTargetAction(
      pauseCluster: (() { final guardedValue = map['pauseCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduledActionTargetActionPauseCluster.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resizeCluster: (() { final guardedValue = map['resizeCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduledActionTargetActionResizeCluster.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      resumeCluster: (() { final guardedValue = map['resumeCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScheduledActionTargetActionResumeCluster.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
