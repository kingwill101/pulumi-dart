...
class ScheduledAction extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ScheduledAction]. {@macro pulumi_redshift_scheduled_action_scheduled_action_args_doc}
  ...
  ScheduledAction(
    ...
    this.targetAction = registerOutput<ScheduledActionTargetAction>('targetAction');
  }
