...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      clusterNodes: map['clusterNodes'] == null ? null : (pulumi.Input.decodeList<ClusterClusterNode>(map['clusterNodes'], (value) => ClusterClusterNode.fromMap((value as Map).cast<String, dynamic>()))).input(),
      clusterParameterGroupName: map['clusterParameterGroupName'] == null ? null : (map['clusterParameterGroupName'] as String).input(),
      clusterPublicKey: map['clusterPublicKey'] == null ? null : (map['clusterPublicKey'] as String).input(),
      clusterRevisionNumber: map['clusterRevisionNumber'] == null ? null : (map['clusterRevisionNumber'] as String).input(),
