...
class ClusterState {
  ...
  ClusterState({
    ...
    pulumi.Output<String>? clusterNamespaceArn,
    pulumi.Output<List<ClusterClusterNode>>? clusterNodes,
    pulumi.Output<String>? clusterParameterGroupName,
    pulumi.Output<String>? clusterPublicKey,
    pulumi.Output<String>? clusterRevisionNumber,
    ...
    pulumi.Output<String>? masterPasswordSecretArn,
    ...
    pulumi.Output<List<String>>? vpcSecurityGroupIds,
      ...
      clusterNamespaceArn = pulumi.Input.asOptionalInput<String>(clusterNamespaceArn),
      clusterNodes = pulumi.Input.asOptionalInput<List<ClusterClusterNode>>(clusterNodes),
      clusterParameterGroupName = pulumi.Input.asOptionalInput<String>(clusterParameterGroupName),
      clusterPublicKey = pulumi.Input.asOptionalInput<String>(clusterPublicKey),
      clusterRevisionNumber = pulumi.Input.asOptionalInput<String>(clusterRevisionNumber),
      ...
      masterPasswordSecretArn = pulumi.Input.asOptionalInput<String>(masterPasswordSecretArn),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterNodes': ?pulumi.Input.mapOptionalInputValue<List<ClusterClusterNode>, List<Map<String, dynamic>>>(clusterNodes, (value) => pulumi.Input.encodeList<ClusterClusterNode, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      clusterNamespaceArn: map['clusterNamespaceArn'] == null ? null : pulumi.Output.create<String>(map['clusterNamespaceArn'] as String),
      clusterNodes: map['clusterNodes'] == null ? null : pulumi.Output.create<List<ClusterClusterNode>>(pulumi.Input.decodeList<ClusterClusterNode>(map['clusterNodes'], (value) => ClusterClusterNode.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      clusterPublicKey: map['clusterPublicKey'] == null ? null : pulumi.Output.create<String>(map['clusterPublicKey'] as String),
      clusterRevisionNumber: map['clusterRevisionNumber'] == null ? null : pulumi.Output.create<String>(map['clusterRevisionNumber'] as String),
      ...
      masterPasswordSecretArn: map['masterPasswordSecretArn'] == null ? null : pulumi.Output.create<String>(map['masterPasswordSecretArn'] as String),
