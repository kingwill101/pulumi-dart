...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      clusterNamespaceArn: map['clusterNamespaceArn'] == null ? null : ((map['clusterNamespaceArn'] as String).input()).input(),
      clusterNodes: map['clusterNodes'] == null ? null : ((pulumi.Input.decodeList<ClusterClusterNode>(map['clusterNodes']!, (value) => ClusterClusterNode.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      clusterParameterGroupName: map['clusterParameterGroupName'] == null ? null : ((map['clusterParameterGroupName'] as String).input()).input(),
      clusterPublicKey: map['clusterPublicKey'] == null ? null : ((map['clusterPublicKey'] as String).input()).input(),
      clusterRevisionNumber: map['clusterRevisionNumber'] == null ? null : ((map['clusterRevisionNumber'] as String).input()).input(),
      ...
      masterPasswordSecretArn: map['masterPasswordSecretArn'] == null ? null : ((map['masterPasswordSecretArn'] as String).input()).input(),
