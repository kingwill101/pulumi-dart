...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      clusterNodes: (() {
        final guardedValue = map['clusterNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterClusterNode>(
            guardedValue,
            (value) => ClusterClusterNode.fromMap(
      ...
      clusterPublicKey: (() {
        final guardedValue = map['clusterPublicKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clusterRevisionNumber: (() {
        final guardedValue = map['clusterRevisionNumber'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
