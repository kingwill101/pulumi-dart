...
class ClusterArgs {
  ...
  ClusterArgs({
    pulumi.Output<bool>? allowVersionUpgrade,
    pulumi.Output<bool>? applyImmediately,
    pulumi.Output<String>? aquaConfigurationStatus,
    pulumi.Output<int>? automatedSnapshotRetentionPeriod,
    pulumi.Output<String>? availabilityZone,
    pulumi.Output<bool>? availabilityZoneRelocationEnabled,
    required pulumi.Output<String> clusterIdentifier,
    pulumi.Output<String>? clusterParameterGroupName,
    pulumi.Output<String>? clusterSubnetGroupName,
    ...
    pulumi.Output<String>? elasticIp,
    ...
    pulumi.Output<String>? maintenanceTrackName,
    pulumi.Output<bool>? manageMasterPassword,
    pulumi.Output<int>? manualSnapshotRetentionPeriod,
    pulumi.Output<String>? masterPassword,
    pulumi.Output<String>? masterPasswordSecretKmsKeyId,
    ...
    pulumi.Output<String>? snapshotArn,
    pulumi.Output<String>? snapshotClusterIdentifier,
    pulumi.Output<String>? snapshotIdentifier,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<List<String>>? vpcSecurityGroupIds,
  }) :
      allowVersionUpgrade = pulumi.Input.asOptionalInput<bool>(allowVersionUpgrade),
      applyImmediately = pulumi.Input.asOptionalInput<bool>(applyImmediately),
      aquaConfigurationStatus = pulumi.Input.asOptionalInput<String>(aquaConfigurationStatus),
      automatedSnapshotRetentionPeriod = pulumi.Input.asOptionalInput<int>(automatedSnapshotRetentionPeriod),
      availabilityZone = pulumi.Input.asOptionalInput<String>(availabilityZone),
      availabilityZoneRelocationEnabled = pulumi.Input.asOptionalInput<bool>(availabilityZoneRelocationEnabled),
      clusterIdentifier = pulumi.Input.asInput<String>(clusterIdentifier),
      clusterParameterGroupName = pulumi.Input.asOptionalInput<String>(clusterParameterGroupName),
      clusterSubnetGroupName = pulumi.Input.asOptionalInput<String>(clusterSubnetGroupName),
      ...
      maintenanceTrackName = pulumi.Input.asOptionalInput<String>(maintenanceTrackName),
      manageMasterPassword = pulumi.Input.asOptionalInput<bool>(manageMasterPassword),
      ...
      masterPasswordSecretKmsKeyId = pulumi.Input.asOptionalInput<String>(masterPasswordSecretKmsKeyId),
      ...
      snapshotClusterIdentifier = pulumi.Input.asOptionalInput<String>(snapshotClusterIdentifier),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      allowVersionUpgrade: map['allowVersionUpgrade'] == null ? null : pulumi.Output.create<bool>(map['allowVersionUpgrade'] as bool),
      applyImmediately: map['applyImmediately'] == null ? null : pulumi.Output.create<bool>(map['applyImmediately'] as bool),
      aquaConfigurationStatus: map['aquaConfigurationStatus'] == null ? null : pulumi.Output.create<String>(map['aquaConfigurationStatus'] as String),
      automatedSnapshotRetentionPeriod: map['automatedSnapshotRetentionPeriod'] == null ? null : pulumi.Output.create<int>(map['automatedSnapshotRetentionPeriod'] as int),
      availabilityZone: map['availabilityZone'] == null ? null : pulumi.Output.create<String>(map['availabilityZone'] as String),
      availabilityZoneRelocationEnabled: map['availabilityZoneRelocationEnabled'] == null ? null : pulumi.Output.create<bool>(map['availabilityZoneRelocationEnabled'] as bool),
      clusterIdentifier: pulumi.Output.create<String>(map['clusterIdentifier'] as String),
      clusterParameterGroupName: map['clusterParameterGroupName'] == null ? null : pulumi.Output.create<String>(map['clusterParameterGroupName'] as String),
      clusterSubnetGroupName: map['clusterSubnetGroupName'] == null ? null : pulumi.Output.create<String>(map['clusterSubnetGroupName'] as String),
      ...
      elasticIp: map['elasticIp'] == null ? null : pulumi.Output.create<String>(map['elasticIp'] as String),
      ...
      maintenanceTrackName: map['maintenanceTrackName'] == null ? null : pulumi.Output.create<String>(map['maintenanceTrackName'] as String),
      manageMasterPassword: map['manageMasterPassword'] == null ? null : pulumi.Output.create<bool>(map['manageMasterPassword'] as bool),
      ...
      masterPasswordSecretKmsKeyId: map['masterPasswordSecretKmsKeyId'] == null ? null : pulumi.Output.create<String>(map['masterPasswordSecretKmsKeyId'] as String),
      ...
      snapshotArn: map['snapshotArn'] == null ? null : pulumi.Output.create<String>(map['snapshotArn'] as String),
      snapshotClusterIdentifier: map['snapshotClusterIdentifier'] == null ? null : pulumi.Output.create<String>(map['snapshotClusterIdentifier'] as String),
