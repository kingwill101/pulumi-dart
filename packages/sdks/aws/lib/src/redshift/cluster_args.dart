...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      allowVersionUpgrade: map['allowVersionUpgrade'] == null ? null : ((map['allowVersionUpgrade'] as bool).input()).input(),
      applyImmediately: map['applyImmediately'] == null ? null : ((map['applyImmediately'] as bool).input()).input(),
      aquaConfigurationStatus: map['aquaConfigurationStatus'] == null ? null : ((map['aquaConfigurationStatus'] as String).input()).input(),
      automatedSnapshotRetentionPeriod: map['automatedSnapshotRetentionPeriod'] == null ? null : ((map['automatedSnapshotRetentionPeriod'] as int).input()).input(),
      availabilityZone: map['availabilityZone'] == null ? null : ((map['availabilityZone'] as String).input()).input(),
      availabilityZoneRelocationEnabled: map['availabilityZoneRelocationEnabled'] == null ? null : ((map['availabilityZoneRelocationEnabled'] as bool).input()).input(),
      clusterIdentifier: (map['clusterIdentifier'] as String).input(),
      clusterParameterGroupName: map['clusterParameterGroupName'] == null ? null : ((map['clusterParameterGroupName'] as String).input()).input(),
      clusterSubnetGroupName: map['clusterSubnetGroupName'] == null ? null : ((map['clusterSubnetGroupName'] as String).input()).input(),
      ...
      elasticIp: map['elasticIp'] == null ? null : ((map['elasticIp'] as String).input()).input(),
      ...
      maintenanceTrackName: map['maintenanceTrackName'] == null ? null : ((map['maintenanceTrackName'] as String).input()).input(),
      manageMasterPassword: map['manageMasterPassword'] == null ? null : ((map['manageMasterPassword'] as bool).input()).input(),
      ...
      masterPasswordSecretKmsKeyId: map['masterPasswordSecretKmsKeyId'] == null ? null : ((map['masterPasswordSecretKmsKeyId'] as String).input()).input(),
      ...
      snapshotArn: map['snapshotArn'] == null ? null : ((map['snapshotArn'] as String).input()).input(),
      snapshotClusterIdentifier: map['snapshotClusterIdentifier'] == null ? null : ((map['snapshotClusterIdentifier'] as String).input()).input(),
