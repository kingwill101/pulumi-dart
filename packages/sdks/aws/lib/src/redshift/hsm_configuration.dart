...
class HsmConfiguration extends pulumi.CustomResource {
  ...
  HsmConfiguration(
    ...
    this.hsmConfigurationIdentifier = registerOutput<String>('hsmConfigurationIdentifier');
    ...
    this.hsmServerPublicCertificate = registerOutput<String>('hsmServerPublicCertificate');
