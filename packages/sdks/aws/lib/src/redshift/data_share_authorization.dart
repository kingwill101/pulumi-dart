...
import 'data_share_authorization_state.dart';
...
class DataShareAuthorization extends pulumi.CustomResource {
  ...
  /// Gets an existing [DataShareAuthorization] resource's state with the given [name] and [id].
  static DataShareAuthorization get(
    String name,
    pulumi.Input<String> id, {
    DataShareAuthorizationState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DataShareAuthorization._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DataShareAuthorization] resource.
  DataShareAuthorization.reference(String urn)
    : super(
        'aws:redshift/dataShareAuthorization:DataShareAuthorization',
