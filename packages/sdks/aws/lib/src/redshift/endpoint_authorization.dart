...
import 'endpoint_authorization_state.dart';
...
/// }
///
/// resource "aws_redshift_endpointauthorization" "example" {
///   account            = "01234567910"
...
class EndpointAuthorization extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [EndpointAuthorization]. {@macro pulumi_redshift_endpoint_authorization_endpoint_authorization_args_doc}
  ...
  static EndpointAuthorization get(
    String name,
