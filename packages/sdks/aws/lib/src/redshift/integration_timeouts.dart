...
class IntegrationTimeouts {
  ...
  /// Creates a new [IntegrationTimeouts].
  ...
  IntegrationTimeouts({this.create, this.delete, this.update});
  ...
  factory IntegrationTimeouts.fromMap(Map<String, dynamic> map) {
