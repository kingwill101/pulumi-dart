...
class PipelineArgs {
    ...
    return <String, dynamic>{
      'bufferOptions':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bufferOptions, (value) => value.toMap()),
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      bufferOptions: (() {
        final guardedValue = map['bufferOptions'];
      ...
      pipelineConfigurationBody: pulumi.Input.fromValue(
        map['pipelineConfigurationBody'] as String,
      ),
      pipelineName: pulumi.Input.fromValue(map['pipelineName'] as String),
      pipelineRoleArn: (() {
        final guardedValue = map['pipelineRoleArn'];
        if (guardedValue == null) return null;
