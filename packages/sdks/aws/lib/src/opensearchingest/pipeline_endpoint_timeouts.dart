...
class PipelineEndpointTimeouts {
  ...
  /// Creates a new [PipelineEndpointTimeouts].
  ...
  const PipelineEndpointTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory PipelineEndpointTimeouts.fromMap(Map<String, dynamic> map) {
    return PipelineEndpointTimeouts(
