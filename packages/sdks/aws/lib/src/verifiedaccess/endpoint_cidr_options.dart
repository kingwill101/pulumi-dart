...
class EndpointCidrOptions {
  ...
  factory EndpointCidrOptions.fromMap(Map<String, dynamic> map) {
    return EndpointCidrOptions(
      ...
      portRanges: pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointCidrOptionsPortRange>(map['portRanges']!, (value) => EndpointCidrOptionsPortRange.fromMap((value as Map).cast<String, dynamic>()))),
