...
class InstanceLoggingConfigurationAccessLogs {
  ...
  final InstanceLoggingConfigurationAccessLogsKinesisDataFirehose? kinesisDataFirehose;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kinesisDataFirehose': ?kinesisDataFirehose == null ? null : kinesisDataFirehose!.toMap(),
  ...
  factory InstanceLoggingConfigurationAccessLogs.fromMap(Map<String, dynamic> map) {
    return InstanceLoggingConfigurationAccessLogs(
      cloudwatchLogs: map['cloudwatchLogs'] == null ? null : InstanceLoggingConfigurationAccessLogsCloudwatchLogs.fromMap((map['cloudwatchLogs'] as Map).cast<String, dynamic>()),
      includeTrustContext: map['includeTrustContext'] == null ? null : map['includeTrustContext'] as bool,
      kinesisDataFirehose: map['kinesisDataFirehose'] == null ? null : InstanceLoggingConfigurationAccessLogsKinesisDataFirehose.fromMap((map['kinesisDataFirehose'] as Map).cast<String, dynamic>()),
      logVersion: map['logVersion'] == null ? null : map['logVersion'] as String,
      s3: map['s3'] == null ? null : InstanceLoggingConfigurationAccessLogsS3.fromMap((map['s3'] as Map).cast<String, dynamic>()),
    );
  }
}
