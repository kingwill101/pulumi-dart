...
class InstanceLoggingConfigurationAccessLogs {
  ...
  final pulumi.Input<InstanceLoggingConfigurationAccessLogsCloudwatchLogs>?
  cloudwatchLogs;
  ...
  final pulumi.Input<InstanceLoggingConfigurationAccessLogsKinesisDataFirehose>?
  kinesisDataFirehose;
    ...
    return <String, dynamic>{
      ...
      'kinesisDataFirehose':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(kinesisDataFirehose, (value) => value.toMap()),
  ...
  factory InstanceLoggingConfigurationAccessLogs.fromMap(
    ...
    return InstanceLoggingConfigurationAccessLogs(
      ...
      includeTrustContext: (() {
        final guardedValue = map['includeTrustContext'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      kinesisDataFirehose: (() {
        final guardedValue = map['kinesisDataFirehose'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      logVersion: (() {
        final guardedValue = map['logVersion'];
        if (guardedValue == null) return null;
