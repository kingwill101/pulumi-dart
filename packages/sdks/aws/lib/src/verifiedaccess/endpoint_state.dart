...
class EndpointState {
  ...
  factory EndpointState.fromMap(Map<String, dynamic> map) {
    return EndpointState(
      applicationDomain: map['applicationDomain'] == null ? null : (map['applicationDomain'] as String).input(),
      attachmentType: map['attachmentType'] == null ? null : (map['attachmentType'] as String).input(),
      cidrOptions: map['cidrOptions'] == null ? null : (EndpointCidrOptions.fromMap((map['cidrOptions'] as Map).cast<String, dynamic>())).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      deviceValidationDomain: map['deviceValidationDomain'] == null ? null : (map['deviceValidationDomain'] as String).input(),
      domainCertificateArn: map['domainCertificateArn'] == null ? null : (map['domainCertificateArn'] as String).input(),
      endpointDomain: map['endpointDomain'] == null ? null : (map['endpointDomain'] as String).input(),
      endpointDomainPrefix: map['endpointDomainPrefix'] == null ? null : (map['endpointDomainPrefix'] as String).input(),
      endpointType: map['endpointType'] == null ? null : (map['endpointType'] as String).input(),
      loadBalancerOptions: map['loadBalancerOptions'] == null ? null : (EndpointLoadBalancerOptions.fromMap((map['loadBalancerOptions'] as Map).cast<String, dynamic>())).input(),
      networkInterfaceOptions: map['networkInterfaceOptions'] == null ? null : (EndpointNetworkInterfaceOptions.fromMap((map['networkInterfaceOptions'] as Map).cast<String, dynamic>())).input(),
      policyDocument: map['policyDocument'] == null ? null : (map['policyDocument'] as String).input(),
      rdsOptions: map['rdsOptions'] == null ? null : (EndpointRdsOptions.fromMap((map['rdsOptions'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      securityGroupIds: map['securityGroupIds'] == null ? null : ((map['securityGroupIds'] as List).cast<String>()).input(),
      sseSpecification: map['sseSpecification'] == null ? null : (EndpointSseSpecification.fromMap((map['sseSpecification'] as Map).cast<String, dynamic>())).input(),
