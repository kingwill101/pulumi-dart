...
class ScalingPlanState {
  ...
  factory ScalingPlanState.fromMap(Map<String, dynamic> map) {
    return ScalingPlanState(
      applicationSource: (() { final guardedValue = map['applicationSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ScalingPlanApplicationSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      scalingPlanVersion: (() { final guardedValue = map['scalingPlanVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
    );
  }
}
