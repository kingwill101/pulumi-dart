...
class ScalingPlanState {
  ...
  factory ScalingPlanState.fromMap(Map<String, dynamic> map) {
    return ScalingPlanState(
      applicationSource: (() {
        final guardedValue = map['applicationSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ScalingPlanApplicationSource.fromMap(
      ...
      scalingInstructions: (() {
        final guardedValue = map['scalingInstructions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      scalingPlanVersion: (() {
        final guardedValue = map['scalingPlanVersion'];
        if (guardedValue == null) return null;
