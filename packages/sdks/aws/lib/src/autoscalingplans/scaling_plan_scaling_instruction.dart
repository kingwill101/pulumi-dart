...
class ScalingPlanScalingInstruction {
  ...
  factory ScalingPlanScalingInstruction.fromMap(Map<String, dynamic> map) {
    return ScalingPlanScalingInstruction(
      ...
      maxCapacity: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['maxCapacity'])),
      ...
      scheduledActionBufferTime: (() { final guardedValue = map['scheduledActionBufferTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
