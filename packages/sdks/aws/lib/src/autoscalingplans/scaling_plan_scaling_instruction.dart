...
class ScalingPlanScalingInstruction {
  ...
  factory ScalingPlanScalingInstruction.fromMap(Map<String, dynamic> map) {
    return ScalingPlanScalingInstruction(
      ...
      predictiveScalingMaxCapacityBuffer: (() { final guardedValue = map['predictiveScalingMaxCapacityBuffer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      scheduledActionBufferTime: (() { final guardedValue = map['scheduledActionBufferTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
