...
class TargetGroup extends pulumi.CustomResource {
  ...
  TargetGroup(
    ...
    loadBalancingAlgorithmType = registerOutput<String>(
      'loadBalancingAlgorithmType',
    );
    loadBalancingAnomalyMitigation = registerOutput<String>(
      'loadBalancingAnomalyMitigation',
    );
    loadBalancingCrossZoneEnabled = registerOutput<String>(
    ...
    targetFailovers = registerOutput<List<Map<String, dynamic>>>(
      'targetFailovers',
    );
