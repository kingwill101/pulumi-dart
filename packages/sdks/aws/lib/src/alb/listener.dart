...
class Listener extends pulumi.CustomResource {
  ...
  Listener(
    ...
    routingHttpRequestXAmznMtlsClientcertHeaderName = registerOutput<String>(
      'routingHttpRequestXAmznMtlsClientcertHeaderName',
    );
    routingHttpRequestXAmznMtlsClientcertIssuerHeaderName =
    ...
    routingHttpRequestXAmznTlsCipherSuiteHeaderName = registerOutput<String>(
      'routingHttpRequestXAmznTlsCipherSuiteHeaderName',
    );
    routingHttpRequestXAmznTlsVersionHeaderName = registerOutput<String>(
    ...
    routingHttpResponseAccessControlMaxAgeHeaderValue = registerOutput<String>(
      'routingHttpResponseAccessControlMaxAgeHeaderValue',
    );
    routingHttpResponseContentSecurityPolicyHeaderValue =
        registerOutput<String>(
    ...
    routingHttpResponseServerEnabled = registerOutput<bool>(
    ...
    routingHttpResponseXContentTypeOptionsHeaderValue = registerOutput<String>(
      'routingHttpResponseXContentTypeOptionsHeaderValue',
    );
    routingHttpResponseXFrameOptionsHeaderValue = registerOutput<String>(
