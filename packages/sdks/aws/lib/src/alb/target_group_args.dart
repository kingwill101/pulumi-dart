...
class TargetGroupArgs {
  ...
  factory TargetGroupArgs.fromMap(Map<String, dynamic> map) {
    return TargetGroupArgs(
      ...
      deregistrationDelay: (() { final guardedValue = map['deregistrationDelay']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      slowStart: (() { final guardedValue = map['slowStart']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      targetControlPort: (() { final guardedValue = map['targetControlPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
