...
class TargetGroupArgs {
  ...
  factory TargetGroupArgs.fromMap(Map<String, dynamic> map) {
    return TargetGroupArgs(
      ...
      healthCheck: (() { final guardedValue = map['healthCheck']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetGroupHealthCheck.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      stickiness: (() { final guardedValue = map['stickiness']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetGroupStickiness.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      targetFailovers: (() { final guardedValue = map['targetFailovers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TargetGroupTargetFailover>(guardedValue, (value) => TargetGroupTargetFailover.fromMap((value as Map).cast<String, dynamic>()))); })(),
      targetGroupHealth: (() { final guardedValue = map['targetGroupHealth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetGroupTargetGroupHealth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      targetHealthStates: (() { final guardedValue = map['targetHealthStates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<TargetGroupTargetHealthState>(guardedValue, (value) => TargetGroupTargetHealthState.fromMap((value as Map).cast<String, dynamic>()))); })(),
