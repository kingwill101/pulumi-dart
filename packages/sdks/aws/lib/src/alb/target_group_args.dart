...
class TargetGroupArgs {
  ...
  factory TargetGroupArgs.fromMap(Map<String, dynamic> map) {
    return TargetGroupArgs(
      ...
      healthCheck: map['healthCheck'] == null ? null : (TargetGroupHealthCheck.fromMap((map['healthCheck'] as Map).cast<String, dynamic>())).input(),
      ...
      stickiness: map['stickiness'] == null ? null : (TargetGroupStickiness.fromMap((map['stickiness'] as Map).cast<String, dynamic>())).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      targetControlPort: map['targetControlPort'] == null ? null : (map['targetControlPort'] as int).input(),
      targetFailovers: map['targetFailovers'] == null ? null : (pulumi.Input.decodeList<TargetGroupTargetFailover>(map['targetFailovers'], (value) => TargetGroupTargetFailover.fromMap((value as Map).cast<String, dynamic>()))).input(),
      targetGroupHealth: map['targetGroupHealth'] == null ? null : (TargetGroupTargetGroupHealth.fromMap((map['targetGroupHealth'] as Map).cast<String, dynamic>())).input(),
      targetHealthStates: map['targetHealthStates'] == null ? null : (pulumi.Input.decodeList<TargetGroupTargetHealthState>(map['targetHealthStates'], (value) => TargetGroupTargetHealthState.fromMap((value as Map).cast<String, dynamic>()))).input(),
