...
class LoadBalancerArgs {
  ...
  LoadBalancerArgs({
    ...
    pulumi.Output<LoadBalancerConnectionLogs>? connectionLogs,
    ...
    pulumi.Output<LoadBalancerHealthCheckLogs>? healthCheckLogs,
    pulumi.Output<int>? idleTimeout,
    pulumi.Output<bool>? internal,
    pulumi.Output<String>? ipAddressType,
    pulumi.Output<LoadBalancerIpamPools>? ipamPools,
    pulumi.Output<LoadBalancerType>? loadBalancerType,
    pulumi.Output<LoadBalancerMinimumLoadBalancerCapacity>? minimumLoadBalancerCapacity,
    ...
    pulumi.Output<List<LoadBalancerSubnetMapping>>? subnetMappings,
    ...
    pulumi.Output<String>? xffHeaderProcessingMode,
      ...
      connectionLogs = pulumi.Input.asOptionalInput<LoadBalancerConnectionLogs>(connectionLogs),
      ...
      healthCheckLogs = pulumi.Input.asOptionalInput<LoadBalancerHealthCheckLogs>(healthCheckLogs),
      ...
      ipamPools = pulumi.Input.asOptionalInput<LoadBalancerIpamPools>(ipamPools),
      loadBalancerType = pulumi.Input.asOptionalInput<LoadBalancerType>(loadBalancerType),
      minimumLoadBalancerCapacity = pulumi.Input.asOptionalInput<LoadBalancerMinimumLoadBalancerCapacity>(minimumLoadBalancerCapacity),
      ...
      subnetMappings = pulumi.Input.asOptionalInput<List<LoadBalancerSubnetMapping>>(subnetMappings),
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      connectionLogs: map['connectionLogs'] == null ? null : pulumi.Output.create<LoadBalancerConnectionLogs>(LoadBalancerConnectionLogs.fromMap((map['connectionLogs'] as Map).cast<String, dynamic>())),
      ...
      healthCheckLogs: map['healthCheckLogs'] == null ? null : pulumi.Output.create<LoadBalancerHealthCheckLogs>(LoadBalancerHealthCheckLogs.fromMap((map['healthCheckLogs'] as Map).cast<String, dynamic>())),
      ...
      ipamPools: map['ipamPools'] == null ? null : pulumi.Output.create<LoadBalancerIpamPools>(LoadBalancerIpamPools.fromMap((map['ipamPools'] as Map).cast<String, dynamic>())),
      loadBalancerType: map['loadBalancerType'] == null ? null : pulumi.Output.create<LoadBalancerType>(LoadBalancerType.fromValue(map['loadBalancerType'] as String)),
      minimumLoadBalancerCapacity: map['minimumLoadBalancerCapacity'] == null ? null : pulumi.Output.create<LoadBalancerMinimumLoadBalancerCapacity>(LoadBalancerMinimumLoadBalancerCapacity.fromMap((map['minimumLoadBalancerCapacity'] as Map).cast<String, dynamic>())),
      ...
      subnetMappings: map['subnetMappings'] == null ? null : pulumi.Output.create<List<LoadBalancerSubnetMapping>>(pulumi.Input.decodeList<LoadBalancerSubnetMapping>(map['subnetMappings'], (value) => LoadBalancerSubnetMapping.fromMap((value as Map).cast<String, dynamic>()))),
