...
class LoadBalancerArgs {
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      accessLogs: map['accessLogs'] == null ? null : ((LoadBalancerAccessLogs.fromMap((map['accessLogs']! as Map).cast<String, dynamic>())).input()).input(),
      clientKeepAlive: map['clientKeepAlive'] == null ? null : ((map['clientKeepAlive'] as int).input()).input(),
      connectionLogs: map['connectionLogs'] == null ? null : ((LoadBalancerConnectionLogs.fromMap((map['connectionLogs']! as Map).cast<String, dynamic>())).input()).input(),
      customerOwnedIpv4Pool: map['customerOwnedIpv4Pool'] == null ? null : ((map['customerOwnedIpv4Pool'] as String).input()).input(),
      desyncMitigationMode: map['desyncMitigationMode'] == null ? null : ((map['desyncMitigationMode'] as String).input()).input(),
      dnsRecordClientRoutingPolicy: map['dnsRecordClientRoutingPolicy'] == null ? null : ((map['dnsRecordClientRoutingPolicy'] as String).input()).input(),
      dropInvalidHeaderFields: map['dropInvalidHeaderFields'] == null ? null : ((map['dropInvalidHeaderFields'] as bool).input()).input(),
      enableCrossZoneLoadBalancing: map['enableCrossZoneLoadBalancing'] == null ? null : ((map['enableCrossZoneLoadBalancing'] as bool).input()).input(),
      enableDeletionProtection: map['enableDeletionProtection'] == null ? null : ((map['enableDeletionProtection'] as bool).input()).input(),
      enableHttp2: map['enableHttp2'] == null ? null : ((map['enableHttp2'] as bool).input()).input(),
      enableTlsVersionAndCipherSuiteHeaders: map['enableTlsVersionAndCipherSuiteHeaders'] == null ? null : ((map['enableTlsVersionAndCipherSuiteHeaders'] as bool).input()).input(),
      enableWafFailOpen: map['enableWafFailOpen'] == null ? null : ((map['enableWafFailOpen'] as bool).input()).input(),
      enableXffClientPort: map['enableXffClientPort'] == null ? null : ((map['enableXffClientPort'] as bool).input()).input(),
      enableZonalShift: map['enableZonalShift'] == null ? null : ((map['enableZonalShift'] as bool).input()).input(),
      enforceSecurityGroupInboundRulesOnPrivateLinkTraffic: map['enforceSecurityGroupInboundRulesOnPrivateLinkTraffic'] == null ? null : ((map['enforceSecurityGroupInboundRulesOnPrivateLinkTraffic'] as String).input()).input(),
      healthCheckLogs: map['healthCheckLogs'] == null ? null : ((LoadBalancerHealthCheckLogs.fromMap((map['healthCheckLogs']! as Map).cast<String, dynamic>())).input()).input(),
      idleTimeout: map['idleTimeout'] == null ? null : ((map['idleTimeout'] as int).input()).input(),
      internal: map['internal'] == null ? null : ((map['internal'] as bool).input()).input(),
      ipAddressType: map['ipAddressType'] == null ? null : ((map['ipAddressType'] as String).input()).input(),
      ipamPools: map['ipamPools'] == null ? null : ((LoadBalancerIpamPools.fromMap((map['ipamPools']! as Map).cast<String, dynamic>())).input()).input(),
      loadBalancerType: map['loadBalancerType'] == null ? null : ((LoadBalancerType.fromValue(map['loadBalancerType']! as String)).input()).input(),
      minimumLoadBalancerCapacity: map['minimumLoadBalancerCapacity'] == null ? null : ((LoadBalancerMinimumLoadBalancerCapacity.fromMap((map['minimumLoadBalancerCapacity']! as Map).cast<String, dynamic>())).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      namePrefix: map['namePrefix'] == null ? null : ((map['namePrefix'] as String).input()).input(),
      preserveHostHeader: map['preserveHostHeader'] == null ? null : ((map['preserveHostHeader'] as bool).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      secondaryIpsAutoAssignedPerSubnet: map['secondaryIpsAutoAssignedPerSubnet'] == null ? null : ((map['secondaryIpsAutoAssignedPerSubnet'] as int).input()).input(),
      securityGroups: map['securityGroups'] == null ? null : (((map['securityGroups'] as List).cast<String>()).input()).input(),
      subnetMappings: map['subnetMappings'] == null ? null : ((pulumi.Input.decodeList<LoadBalancerSubnetMapping>(map['subnetMappings']!, (value) => LoadBalancerSubnetMapping.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      subnets: map['subnets'] == null ? null : (((map['subnets'] as List).cast<String>()).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      xffHeaderProcessingMode: map['xffHeaderProcessingMode'] == null ? null : ((map['xffHeaderProcessingMode'] as String).input()).input(),
    );
  }
}
