...
class TargetGroupTargetGroupHealth {
  ...
  factory TargetGroupTargetGroupHealth.fromMap(Map<String, dynamic> map) {
    return TargetGroupTargetGroupHealth(
      dnsFailover: (() { final guardedValue = map['dnsFailover']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetGroupTargetGroupHealthDnsFailover.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      unhealthyStateRouting: (() { final guardedValue = map['unhealthyStateRouting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TargetGroupTargetGroupHealthUnhealthyStateRouting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
