...
class GetListenerDefaultActionForward {
  final pulumi.Input<List<GetListenerDefaultActionForwardStickiness>>
  stickinesses;
  final pulumi.Input<List<GetListenerDefaultActionForwardTargetGroup>>
  targetGroups;
    ...
    return <String, dynamic>{
      'stickinesses':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionForwardStickiness>,
      ...
      'targetGroups':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionForwardTargetGroup>,
            List<Map<String, dynamic>>
          >(
            targetGroups,
            (value) =>
  ...
  factory GetListenerDefaultActionForward.fromMap(Map<String, dynamic> map) {
    return GetListenerDefaultActionForward(
      stickinesses: pulumi.Input.fromValue(
      ...
      targetGroups: pulumi.Input.fromValue(
