...
class GetListenerDefaultActionForward {
  ...
  factory GetListenerDefaultActionForward.fromMap(Map<String, dynamic> map) {
    return GetListenerDefaultActionForward(
      stickinesses: pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerDefaultActionForwardStickiness>(map['stickinesses']!, (value) => GetListenerDefaultActionForwardStickiness.fromMap((value as Map).cast<String, dynamic>()))),
