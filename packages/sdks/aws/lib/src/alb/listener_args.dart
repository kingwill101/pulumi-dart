...
class ListenerArgs {
  ...
  factory ListenerArgs.fromMap(Map<String, dynamic> map) {
    return ListenerArgs(
      ...
      mutualAuthentication: map['mutualAuthentication'] == null ? null : (ListenerMutualAuthentication.fromMap((map['mutualAuthentication'] as Map).cast<String, dynamic>())).input(),
