...
class ListenerRuleActionForward {
  ...
  factory ListenerRuleActionForward.fromMap(Map<String, dynamic> map) {
    return ListenerRuleActionForward(
      stickiness: (() { final guardedValue = map['stickiness']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ListenerRuleActionForwardStickiness.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
