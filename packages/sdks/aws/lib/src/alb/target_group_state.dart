...
class TargetGroupState {
  ...
  TargetGroupState({
    ...
    pulumi.Output<List<String>>? loadBalancerArns,
    ...
    pulumi.Output<String>? vpcId,
      ...
      loadBalancerArns = pulumi.Input.asOptionalInput<List<String>>(loadBalancerArns),
  ...
  factory TargetGroupState.fromMap(Map<String, dynamic> map) {
    return TargetGroupState(
      ...
      loadBalancerArns: map['loadBalancerArns'] == null ? null : pulumi.Output.create<List<String>>((map['loadBalancerArns'] as List).cast<String>()),
