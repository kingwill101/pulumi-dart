...
class LoadBalancer extends pulumi.CustomResource {
  ...
  LoadBalancer(
    ...
    dnsRecordClientRoutingPolicy = registerOutput<String?>(
      'dnsRecordClientRoutingPolicy',
    );
    dropInvalidHeaderFields = registerOutput<bool?>('dropInvalidHeaderFields');
    enableCrossZoneLoadBalancing = registerOutput<bool?>(
      'enableCrossZoneLoadBalancing',
    );
    enableDeletionProtection = registerOutput<bool?>(
      'enableDeletionProtection',
    );
    enableHttp2 = registerOutput<bool?>('enableHttp2');
    enableTlsVersionAndCipherSuiteHeaders = registerOutput<bool?>(
    ...
    loadBalancerType = registerOutput<LoadBalancerType?>(
      'loadBalancerType',
      decoder: (raw) {
        final guardedValue = raw;
        if (guardedValue == null) return null;
        return LoadBalancerType.fromValue(guardedValue as String);
      },
    );
    minimumLoadBalancerCapacity =
    ...
    secondaryIpsAutoAssignedPerSubnet = registerOutput<int>(
    ...
    xffHeaderProcessingMode = registerOutput<String?>(
