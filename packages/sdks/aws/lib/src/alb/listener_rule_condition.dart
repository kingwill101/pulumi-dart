...
class ListenerRuleCondition {
    ...
    return <String, dynamic>{
      'hostHeader':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(hostHeader, (value) => value.toMap()),
      'httpHeader':
          ?pulumi.Input.mapOptionalInputValue<
            ListenerRuleConditionHttpHeader,
            Map<String, dynamic>
          >(httpHeader, (value) => value.toMap()),
      'httpRequestMethod':
          ?pulumi.Input.mapOptionalInputValue<
            ListenerRuleConditionHttpRequestMethod,
            Map<String, dynamic>
          >(httpRequestMethod, (value) => value.toMap()),
      'pathPattern':
          ?pulumi.Input.mapOptionalInputValue<
            ListenerRuleConditionPathPattern,
            Map<String, dynamic>
          >(pathPattern, (value) => value.toMap()),
      'queryStrings':
          ?pulumi.Input.mapOptionalInputValue<
            List<ListenerRuleConditionQueryString>,
  ...
  factory ListenerRuleCondition.fromMap(Map<String, dynamic> map) {
    return ListenerRuleCondition(
      hostHeader: (() {
        final guardedValue = map['hostHeader'];
      ...
      httpRequestMethod: (() {
        final guardedValue = map['httpRequestMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
