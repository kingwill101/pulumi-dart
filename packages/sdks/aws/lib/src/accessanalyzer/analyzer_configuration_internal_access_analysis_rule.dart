...
class AnalyzerConfigurationInternalAccessAnalysisRule {
  ...
  final pulumi.Input<
    List<AnalyzerConfigurationInternalAccessAnalysisRuleInclusion>
  >?
  inclusions;
  ...
  AnalyzerConfigurationInternalAccessAnalysisRule({this.inclusions});
  ...
  factory AnalyzerConfigurationInternalAccessAnalysisRule.fromMap(
    ...
    return AnalyzerConfigurationInternalAccessAnalysisRule(
      inclusions: (() {
        final guardedValue = map['inclusions'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                AnalyzerConfigurationInternalAccessAnalysisRuleInclusion.fromMap(
