...
class ArchiveRuleState {
  ...
  factory ArchiveRuleState.fromMap(Map<String, dynamic> map) {
    return ArchiveRuleState(
      ...
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ArchiveRuleFilter>(guardedValue, (value) => ArchiveRuleFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
