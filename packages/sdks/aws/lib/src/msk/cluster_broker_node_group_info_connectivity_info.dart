...
class ClusterBrokerNodeGroupInfoConnectivityInfo {
  ...
  final pulumi.Input<ClusterBrokerNodeGroupInfoConnectivityInfoPublicAccess>?
  publicAccess;

  /// VPC connectivity access control for brokers. See connectivity_info vpc_connectivity Argument Reference below.
  final pulumi.Input<ClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivity>?
  vpcConnectivity;
    ...
    return <String, dynamic>{
      'publicAccess':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(publicAccess, (value) => value.toMap()),
      'vpcConnectivity':
          ?pulumi.Input.mapOptionalInputValue<
            ClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivity,
            Map<String, dynamic>
          >(vpcConnectivity, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterBrokerNodeGroupInfoConnectivityInfo.fromMap(
    ...
    return ClusterBrokerNodeGroupInfoConnectivityInfo(
      ...
      vpcConnectivity: (() {
        final guardedValue = map['vpcConnectivity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
