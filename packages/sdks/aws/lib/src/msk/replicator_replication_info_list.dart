...
class ReplicatorReplicationInfoList {
  ...
  final List<ReplicatorReplicationInfoListConsumerGroupReplication> consumerGroupReplications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'consumerGroupReplications': pulumi.Input.encodeList<ReplicatorReplicationInfoListConsumerGroupReplication, Map<String, dynamic>>(consumerGroupReplications, (value) => value.toMap()),
      'sourceKafkaClusterAlias': ?sourceKafkaClusterAlias,
      'sourceKafkaClusterArn': sourceKafkaClusterArn,
      'targetCompressionType': targetCompressionType,
      'targetKafkaClusterAlias': ?targetKafkaClusterAlias,
      'targetKafkaClusterArn': targetKafkaClusterArn,
      'topicReplications': pulumi.Input.encodeList<ReplicatorReplicationInfoListTopicReplication, Map<String, dynamic>>(topicReplications, (value) => value.toMap()),
    };
  }

  factory ReplicatorReplicationInfoList.fromMap(Map<String, dynamic> map) {
    return ReplicatorReplicationInfoList(
      consumerGroupReplications: pulumi.Input.decodeList<ReplicatorReplicationInfoListConsumerGroupReplication>(map['consumerGroupReplications'], (value) => ReplicatorReplicationInfoListConsumerGroupReplication.fromMap((value as Map).cast<String, dynamic>())),
      sourceKafkaClusterAlias: map['sourceKafkaClusterAlias'] == null ? null : map['sourceKafkaClusterAlias'] as String,
      sourceKafkaClusterArn: map['sourceKafkaClusterArn'] as String,
      targetCompressionType: map['targetCompressionType'] as String,
      targetKafkaClusterAlias: map['targetKafkaClusterAlias'] == null ? null : map['targetKafkaClusterAlias'] as String,
      targetKafkaClusterArn: map['targetKafkaClusterArn'] as String,
      topicReplications: pulumi.Input.decodeList<ReplicatorReplicationInfoListTopicReplication>(map['topicReplications'], (value) => ReplicatorReplicationInfoListTopicReplication.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
