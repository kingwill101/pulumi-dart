...
class ClusterEncryptionInfo {
  ...
  final pulumi.Input<ClusterEncryptionInfoEncryptionInTransit>?
  encryptionInTransit;
    ...
    return <String, dynamic>{
      ...
      'encryptionInTransit':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(encryptionInTransit, (value) => value.toMap()),
    };
  }
  ...
  factory ClusterEncryptionInfo.fromMap(Map<String, dynamic> map) {
    return ClusterEncryptionInfo(
      encryptionAtRestKmsKeyArn: (() {
        final guardedValue = map['encryptionAtRestKmsKeyArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      encryptionInTransit: (() {
        final guardedValue = map['encryptionInTransit'];
        if (guardedValue == null) return null;
