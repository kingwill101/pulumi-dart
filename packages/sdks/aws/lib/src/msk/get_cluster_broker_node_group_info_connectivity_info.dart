...
class GetClusterBrokerNodeGroupInfoConnectivityInfo {
  final pulumi.Input<
    List<GetClusterBrokerNodeGroupInfoConnectivityInfoPublicAccess>
  >
  publicAccesses;
  final pulumi.Input<
    List<GetClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivity>
  >
  vpcConnectivities;
  ...
  factory GetClusterBrokerNodeGroupInfoConnectivityInfo.fromMap(
    ...
    return GetClusterBrokerNodeGroupInfoConnectivityInfo(
      publicAccesses: pulumi.Input.fromValue(
      ...
      vpcConnectivities: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivity
        >(
          map['vpcConnectivities']!,
          (value) =>
              GetClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivity.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
