...
class ReplicatorKafkaCluster {
    ...
    return <String, dynamic>{
      'amazonMskCluster':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(amazonMskCluster, (value) => value.toMap()),
      'vpcConfig':
          pulumi.Input.mapInputValue<
  ...
  factory ReplicatorKafkaCluster.fromMap(Map<String, dynamic> map) {
    return ReplicatorKafkaCluster(
      amazonMskCluster: pulumi.Input.fromValue(
        ReplicatorKafkaClusterAmazonMskCluster.fromMap(
          (map['amazonMskCluster']! as Map).cast<String, dynamic>(),
        ),
      ),
      vpcConfig: pulumi.Input.fromValue(
        ReplicatorKafkaClusterVpcConfig.fromMap(
