...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      bootstrapBrokers: map['bootstrapBrokers'] == null ? null : ((map['bootstrapBrokers'] as String).input()).input(),
      bootstrapBrokersPublicSaslIam: map['bootstrapBrokersPublicSaslIam'] == null ? null : ((map['bootstrapBrokersPublicSaslIam'] as String).input()).input(),
      bootstrapBrokersPublicSaslScram: map['bootstrapBrokersPublicSaslScram'] == null ? null : ((map['bootstrapBrokersPublicSaslScram'] as String).input()).input(),
      bootstrapBrokersPublicTls: map['bootstrapBrokersPublicTls'] == null ? null : ((map['bootstrapBrokersPublicTls'] as String).input()).input(),
      bootstrapBrokersSaslIam: map['bootstrapBrokersSaslIam'] == null ? null : ((map['bootstrapBrokersSaslIam'] as String).input()).input(),
      bootstrapBrokersSaslScram: map['bootstrapBrokersSaslScram'] == null ? null : ((map['bootstrapBrokersSaslScram'] as String).input()).input(),
      bootstrapBrokersTls: map['bootstrapBrokersTls'] == null ? null : ((map['bootstrapBrokersTls'] as String).input()).input(),
      bootstrapBrokersVpcConnectivitySaslIam: map['bootstrapBrokersVpcConnectivitySaslIam'] == null ? null : ((map['bootstrapBrokersVpcConnectivitySaslIam'] as String).input()).input(),
      bootstrapBrokersVpcConnectivitySaslScram: map['bootstrapBrokersVpcConnectivitySaslScram'] == null ? null : ((map['bootstrapBrokersVpcConnectivitySaslScram'] as String).input()).input(),
      bootstrapBrokersVpcConnectivityTls: map['bootstrapBrokersVpcConnectivityTls'] == null ? null : ((map['bootstrapBrokersVpcConnectivityTls'] as String).input()).input(),
      brokerNodeGroupInfo: map['brokerNodeGroupInfo'] == null ? null : ((ClusterBrokerNodeGroupInfo.fromMap((map['brokerNodeGroupInfo']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      kafkaVersion: map['kafkaVersion'] == null ? null : ((map['kafkaVersion'] as String).input()).input(),
      loggingInfo: map['loggingInfo'] == null ? null : ((ClusterLoggingInfo.fromMap((map['loggingInfo']! as Map).cast<String, dynamic>())).input()).input(),
      numberOfBrokerNodes: map['numberOfBrokerNodes'] == null ? null : ((map['numberOfBrokerNodes'] as int).input()).input(),
      ...
      zookeeperConnectString: map['zookeeperConnectString'] == null ? null : ((map['zookeeperConnectString'] as String).input()).input(),
      zookeeperConnectStringTls: map['zookeeperConnectStringTls'] == null ? null : ((map['zookeeperConnectStringTls'] as String).input()).input(),
    );
  }
}
