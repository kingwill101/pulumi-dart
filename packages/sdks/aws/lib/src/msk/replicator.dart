...
class Replicator extends pulumi.CustomResource {
  ...
  Replicator(
    ...
    this.kafkaClusters = registerOutput<List<ReplicatorKafkaCluster>>('kafkaClusters');
    this.region = registerOutput<String>('region');
    this.replicationInfoList = registerOutput<ReplicatorReplicationInfoList>('replicationInfoList');
