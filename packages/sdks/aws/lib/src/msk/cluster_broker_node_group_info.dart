...
class ClusterBrokerNodeGroupInfo {
  ...
  /// [connectivityInfo] Information about the cluster access configuration. See brokerNodeGroupInfo connectivity_info Argument Reference below. For security reasons, you can't turn on public access while creating an MSK cluster. However, you can update an existing cluster to make it publicly accessible. You can also create a new cluster and then update it to make it publicly accessible ([documentation](https://docs.aws.amazon.com/msk/latest/developerguide/public-access.html)).
  ...
  /// [storageInfo] A block that contains information about storage volumes attached to MSK broker nodes. See brokerNodeGroupInfo storage_info Argument Reference below. This block must not be specified when an Express instance type is specified for `instanceType`.
  ...
  factory ClusterBrokerNodeGroupInfo.fromMap(Map<String, dynamic> map) {
    return ClusterBrokerNodeGroupInfo(
      azDistribution: (() { final guardedValue = map['azDistribution']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      clientSubnets: pulumi.Input.fromValue((map['clientSubnets'] as List).cast<String>()),
      connectivityInfo: (() { final guardedValue = map['connectivityInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterBrokerNodeGroupInfoConnectivityInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      instanceType: pulumi.Input.fromValue(map['instanceType'] as String),
      securityGroups: pulumi.Input.fromValue((map['securityGroups'] as List).cast<String>()),
      storageInfo: (() { final guardedValue = map['storageInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClusterBrokerNodeGroupInfoStorageInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
