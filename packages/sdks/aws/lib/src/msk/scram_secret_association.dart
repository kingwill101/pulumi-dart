...
import 'scram_secret_association_state.dart';
...
class ScramSecretAssociation extends pulumi.CustomResource {
  ...
  /// Creates a new [ScramSecretAssociation].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ScramSecretAssociation]. {@macro pulumi_msk_scram_secret_association_scram_secret_association_args_doc}
  ...
  static ScramSecretAssociation get(
    String name,
