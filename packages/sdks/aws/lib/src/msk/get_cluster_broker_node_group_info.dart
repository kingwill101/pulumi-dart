...
class GetClusterBrokerNodeGroupInfo {
  ...
  final pulumi.Input<List<GetClusterBrokerNodeGroupInfoConnectivityInfo>>
  connectivityInfos;
  final pulumi.Input<String> instanceType;
  final pulumi.Input<List<String>> securityGroups;
  final pulumi.Input<List<GetClusterBrokerNodeGroupInfoStorageInfo>>
  storageInfos;
    ...
    return <String, dynamic>{
      ...
      'connectivityInfos':
          pulumi.Input.mapInputValue<
            List<GetClusterBrokerNodeGroupInfoConnectivityInfo>,
      ...
      'storageInfos':
          pulumi.Input.mapInputValue<
            List<GetClusterBrokerNodeGroupInfoStorageInfo>,
            List<Map<String, dynamic>>
          >(
            storageInfos,
            (value) =>
  ...
  factory GetClusterBrokerNodeGroupInfo.fromMap(Map<String, dynamic> map) {
    return GetClusterBrokerNodeGroupInfo(
      ...
      connectivityInfos: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetClusterBrokerNodeGroupInfoConnectivityInfo>(
      ...
      storageInfos: pulumi.Input.fromValue(
