...
import 'principal_association_state.dart';
...
class PrincipalAssociation extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [PrincipalAssociation]. {@macro pulumi_ram_principal_association_principal_association_args_doc}
  ...
  static PrincipalAssociation get(
    String name,
