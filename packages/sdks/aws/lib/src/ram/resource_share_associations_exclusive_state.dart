...
class ResourceShareAssociationsExclusiveState {
  ...
  /// [resourceArns] Set of Amazon Resource Names (ARNs) of resources to associate with the resource share. Resources not configured in this argument will be removed.
  /// [resourceShareArn] Amazon Resource Name (ARN) of the resource share. Changing this value forces creation of a new resource.
  ...
  const ResourceShareAssociationsExclusiveState({
    this.principals,
    this.region,
    this.resourceArns,
