...
class WorkflowOnExceptionStepDecryptStepDetails {
  ...
  factory WorkflowOnExceptionStepDecryptStepDetails.fromMap(Map<String, dynamic> map) {
    return WorkflowOnExceptionStepDecryptStepDetails(
      destinationFileLocation: map['destinationFileLocation'] == null ? null : ((WorkflowOnExceptionStepDecryptStepDetailsDestinationFileLocation.fromMap((map['destinationFileLocation']! as Map).cast<String, dynamic>())).input()).input(),
