...
class WorkflowOnExceptionStepTagStepDetails {
  ...
  const WorkflowOnExceptionStepTagStepDetails({
    this.name,
  ...
  factory WorkflowOnExceptionStepTagStepDetails.fromMap(Map<String, dynamic> map) {
    return WorkflowOnExceptionStepTagStepDetails(
      ...
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkflowOnExceptionStepTagStepDetailsTag>(guardedValue, (value) => WorkflowOnExceptionStepTagStepDetailsTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
