...
class WebAppArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'identityProviderDetails': pulumi.Input.mapInputValue<WebAppIdentityProviderDetails, Map<String, dynamic>>(identityProviderDetails, (value) => value.toMap()),
      'region': ?region,
      'tags': ?tags,
  ...
  factory WebAppArgs.fromMap(Map<String, dynamic> map) {
    return WebAppArgs(
      ...
      endpointDetails: (() { final guardedValue = map['endpointDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAppEndpointDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      identityProviderDetails: pulumi.Input.fromValue(WebAppIdentityProviderDetails.fromMap((map['identityProviderDetails']! as Map).cast<String, dynamic>())),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      webAppEndpointPolicy: (() { final guardedValue = map['webAppEndpointPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      webAppUnits: (() { final guardedValue = map['webAppUnits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WebAppWebAppUnit>(guardedValue, (value) => WebAppWebAppUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
