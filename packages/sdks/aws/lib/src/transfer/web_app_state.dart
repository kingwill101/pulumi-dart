...
class WebAppState {
  ...
  /// [webAppId] ID of the Web App resource.
  ...
  factory WebAppState.fromMap(Map<String, dynamic> map) {
    return WebAppState(
      ...
      identityProviderDetails: (() { final guardedValue = map['identityProviderDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAppIdentityProviderDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
