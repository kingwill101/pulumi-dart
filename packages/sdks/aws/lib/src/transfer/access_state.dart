...
class AccessState {
    ...
    return <String, dynamic>{
      ...
      'homeDirectoryMappings':
          ?pulumi.Input.mapOptionalInputValue<
            List<AccessHomeDirectoryMapping>,
  ...
  factory AccessState.fromMap(Map<String, dynamic> map) {
    return AccessState(
      ...
      homeDirectoryMappings: (() {
        final guardedValue = map['homeDirectoryMappings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AccessHomeDirectoryMapping>(
            guardedValue,
            (value) => AccessHomeDirectoryMapping.fromMap(
      ...
      homeDirectoryType: (() {
        final guardedValue = map['homeDirectoryType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      policy: (() {
      ...
      posixProfile: (() {
        final guardedValue = map['posixProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          AccessPosixProfile.fromMap(
