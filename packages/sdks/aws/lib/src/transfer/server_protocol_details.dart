...
class ServerProtocolDetails {
  ...
  factory ServerProtocolDetails.fromMap(Map<String, dynamic> map) {
    return ServerProtocolDetails(
      as2Transports: (() {
        final guardedValue = map['as2Transports'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      passiveIp: (() {
        final guardedValue = map['passiveIp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      setStatOption: (() {
        final guardedValue = map['setStatOption'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tlsSessionResumptionMode: (() {
        final guardedValue = map['tlsSessionResumptionMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
