...
class ConnectorArgs {
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      connectorConfiguration: pulumi.Input.fromValue(
      ...
      plugins: pulumi.Input.fromValue(
