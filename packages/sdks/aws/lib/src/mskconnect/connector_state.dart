...
class ConnectorState {
  ...
  factory ConnectorState.fromMap(Map<String, dynamic> map) {
    return ConnectorState(
      ...
      capacity: map['capacity'] == null ? null : (ConnectorCapacity.fromMap((map['capacity'] as Map).cast<String, dynamic>())).input(),
      connectorConfiguration: map['connectorConfiguration'] == null ? null : ((map['connectorConfiguration'] as Map).cast<String, String>()).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      kafkaCluster: map['kafkaCluster'] == null ? null : (ConnectorKafkaCluster.fromMap((map['kafkaCluster'] as Map).cast<String, dynamic>())).input(),
      kafkaClusterClientAuthentication: map['kafkaClusterClientAuthentication'] == null ? null : (ConnectorKafkaClusterClientAuthentication.fromMap((map['kafkaClusterClientAuthentication'] as Map).cast<String, dynamic>())).input(),
      kafkaClusterEncryptionInTransit: map['kafkaClusterEncryptionInTransit'] == null ? null : (ConnectorKafkaClusterEncryptionInTransit.fromMap((map['kafkaClusterEncryptionInTransit'] as Map).cast<String, dynamic>())).input(),
      kafkaconnectVersion: map['kafkaconnectVersion'] == null ? null : (map['kafkaconnectVersion'] as String).input(),
      ...
      plugins: map['plugins'] == null ? null : (pulumi.Input.decodeList<ConnectorPlugin>(map['plugins'], (value) => ConnectorPlugin.fromMap((value as Map).cast<String, dynamic>()))).input(),
