...
class ConnectorState {
  ...
  factory ConnectorState.fromMap(Map<String, dynamic> map) {
    return ConnectorState(
      ...
      capacity: (() { final guardedValue = map['capacity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectorCapacity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      connectorConfiguration: (() { final guardedValue = map['connectorConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      kafkaCluster: (() { final guardedValue = map['kafkaCluster']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectorKafkaCluster.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kafkaClusterClientAuthentication: (() { final guardedValue = map['kafkaClusterClientAuthentication']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectorKafkaClusterClientAuthentication.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kafkaClusterEncryptionInTransit: (() { final guardedValue = map['kafkaClusterEncryptionInTransit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ConnectorKafkaClusterEncryptionInTransit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kafkaconnectVersion: (() { final guardedValue = map['kafkaconnectVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      plugins: (() { final guardedValue = map['plugins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConnectorPlugin>(guardedValue, (value) => ConnectorPlugin.fromMap((value as Map).cast<String, dynamic>()))); })(),
