...
class ConnectorKafkaCluster {
  ...
  final pulumi.Input<ConnectorKafkaClusterApacheKafkaCluster>
  apacheKafkaCluster;
    ...
    return <String, dynamic>{
      'apacheKafkaCluster':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(apacheKafkaCluster, (value) => value.toMap()),
    };
  }

  factory ConnectorKafkaCluster.fromMap(Map<String, dynamic> map) {
    return ConnectorKafkaCluster(
      apacheKafkaCluster: pulumi.Input.fromValue(
        ConnectorKafkaClusterApacheKafkaCluster.fromMap(
