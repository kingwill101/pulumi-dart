...
import 'worker_configuration_state.dart';
...
class WorkerConfiguration extends pulumi.CustomResource {
  ...
  WorkerConfiguration(
    ...
    this.propertiesFileContent = registerOutput<String>('propertiesFileContent');
  ...
  static WorkerConfiguration get(
    String name,
