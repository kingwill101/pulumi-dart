...
class CertificateState {
  ...
  factory CertificateState.fromMap(Map<String, dynamic> map) {
    return CertificateState(
      ...
      pendingRenewal: map['pendingRenewal'] == null ? null : (map['pendingRenewal'] as bool).input(),
      privateKey: map['privateKey'] == null ? null : (map['privateKey'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      renewalEligibility: map['renewalEligibility'] == null ? null : (map['renewalEligibility'] as String).input(),
      renewalSummaries: map['renewalSummaries'] == null ? null : (pulumi.Input.decodeList<CertificateRenewalSummary>(map['renewalSummaries'], (value) => CertificateRenewalSummary.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      validationEmails: map['validationEmails'] == null ? null : ((map['validationEmails'] as List).cast<String>()).input(),
