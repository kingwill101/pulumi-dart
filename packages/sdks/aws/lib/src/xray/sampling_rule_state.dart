...
class SamplingRuleState {
  ...
  factory SamplingRuleState.fromMap(Map<String, dynamic> map) {
    return SamplingRuleState(
      ...
      fixedRate: (() { final guardedValue = map['fixedRate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      reservoirSize: (() { final guardedValue = map['reservoirSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
