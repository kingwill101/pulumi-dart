...
class TraceSegmentDestinationTimeouts {
  ...
  const TraceSegmentDestinationTimeouts({
    this.create,
    this.update,
  });
  ...
  factory TraceSegmentDestinationTimeouts.fromMap(Map<String, dynamic> map) {
    return TraceSegmentDestinationTimeouts(
