...
class RadiusSettingsArgs {
  ...
  factory RadiusSettingsArgs.fromMap(Map<String, dynamic> map) {
    return RadiusSettingsArgs(
      authenticationProtocol: pulumi.Input.fromValue(
        map['authenticationProtocol'] as String,
      ),
      ...
      radiusServers: pulumi.Input.fromValue(
        (map['radiusServers'] as List).cast<String>(),
      ),
      ...
      useSameUsername: (() {
        final guardedValue = map['useSameUsername'];
        if (guardedValue == null) return null;
