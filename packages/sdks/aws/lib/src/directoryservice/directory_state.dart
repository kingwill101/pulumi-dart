...
class DirectoryState {
  ...
  factory DirectoryState.fromMap(Map<String, dynamic> map) {
    return DirectoryState(
      accessUrl: map['accessUrl'] == null ? null : (map['accessUrl'] as String).input(),
      ...
      dnsIpAddresses: map['dnsIpAddresses'] == null ? null : ((map['dnsIpAddresses'] as List).cast<String>()).input(),
