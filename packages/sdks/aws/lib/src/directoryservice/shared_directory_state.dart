...
class SharedDirectoryState {
  ...
  factory SharedDirectoryState.fromMap(Map<String, dynamic> map) {
    return SharedDirectoryState(
      ...
      sharedDirectoryId: (() { final guardedValue = map['sharedDirectoryId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SharedDirectoryTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
