...
class RadiusSettingsState {
  ...
  factory RadiusSettingsState.fromMap(Map<String, dynamic> map) {
    return RadiusSettingsState(
      ...
      radiusPort: (() { final guardedValue = map['radiusPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      radiusRetries: (() { final guardedValue = map['radiusRetries']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      radiusTimeout: (() { final guardedValue = map['radiusTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
