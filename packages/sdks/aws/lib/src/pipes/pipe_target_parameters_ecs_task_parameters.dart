...
class PipeTargetParametersEcsTaskParameters {
  ...
  factory PipeTargetParametersEcsTaskParameters.fromMap(Map<String, dynamic> map) {
    return PipeTargetParametersEcsTaskParameters(
      capacityProviderStrategies: map['capacityProviderStrategies'] == null ? null : ((pulumi.Input.decodeList<PipeTargetParametersEcsTaskParametersCapacityProviderStrategy>(map['capacityProviderStrategies']!, (value) => PipeTargetParametersEcsTaskParametersCapacityProviderStrategy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      networkConfiguration: map['networkConfiguration'] == null ? null : ((PipeTargetParametersEcsTaskParametersNetworkConfiguration.fromMap((map['networkConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      overrides: map['overrides'] == null ? null : ((PipeTargetParametersEcsTaskParametersOverrides.fromMap((map['overrides']! as Map).cast<String, dynamic>())).input()).input(),
      placementConstraints: map['placementConstraints'] == null ? null : ((pulumi.Input.decodeList<PipeTargetParametersEcsTaskParametersPlacementConstraint>(map['placementConstraints']!, (value) => PipeTargetParametersEcsTaskParametersPlacementConstraint.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      placementStrategies: map['placementStrategies'] == null ? null : ((pulumi.Input.decodeList<PipeTargetParametersEcsTaskParametersPlacementStrategy>(map['placementStrategies']!, (value) => PipeTargetParametersEcsTaskParametersPlacementStrategy.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
