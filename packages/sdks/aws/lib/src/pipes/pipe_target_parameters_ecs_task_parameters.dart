...
class PipeTargetParametersEcsTaskParameters {
  ...
  final pulumi.Input<PipeTargetParametersEcsTaskParametersNetworkConfiguration>?
  ...
  final pulumi.Input<
    List<PipeTargetParametersEcsTaskParametersPlacementConstraint>
  >?
  ...
  final pulumi.Input<
    List<PipeTargetParametersEcsTaskParametersPlacementStrategy>
  >?
  placementStrategies;
      ...
      capacityProviderStrategies: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PipeTargetParametersEcsTaskParametersCapacityProviderStrategy.fromMap(
      ...
      placementConstraints: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PipeTargetParametersEcsTaskParametersPlacementConstraint.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      placementStrategies: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                PipeTargetParametersEcsTaskParametersPlacementStrategy.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
