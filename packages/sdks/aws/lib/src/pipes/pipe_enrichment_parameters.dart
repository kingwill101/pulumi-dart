...
class PipeEnrichmentParameters {
  ...
  final pulumi.Input<PipeEnrichmentParametersHttpParameters>? httpParameters;
  ...
  const PipeEnrichmentParameters({
    this.httpParameters,
    this.inputTemplate,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'httpParameters': ?pulumi.Input.mapOptionalInputValue<PipeEnrichmentParametersHttpParameters, Map<String, dynamic>>(httpParameters, (value) => value.toMap()),
  ...
  factory PipeEnrichmentParameters.fromMap(Map<String, dynamic> map) {
    return PipeEnrichmentParameters(
      httpParameters: (() { final guardedValue = map['httpParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PipeEnrichmentParametersHttpParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
