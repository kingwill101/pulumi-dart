...
class PipeTargetParameters {
  ...
  final pulumi.Input<PipeTargetParametersBatchJobParameters>?
  batchJobParameters;

  /// The parameters for using an CloudWatch Logs log stream as a target. Detailed below.
  final pulumi.Input<PipeTargetParametersCloudwatchLogsParameters>?
  ...
  final pulumi.Input<PipeTargetParametersEventbridgeEventBusParameters>?
  ...
  final pulumi.Input<PipeTargetParametersKinesisStreamParameters>?
  kinesisStreamParameters;

  /// The parameters for using a Lambda function as a target. Detailed below.
  final pulumi.Input<PipeTargetParametersLambdaFunctionParameters>?
  ...
  final pulumi.Input<PipeTargetParametersRedshiftDataParameters>?
  redshiftDataParameters;

  /// The parameters for using a SageMaker AI pipeline as a target. Detailed below.
  final pulumi.Input<PipeTargetParametersSagemakerPipelineParameters>?
  sagemakerPipelineParameters;

  /// The parameters for using a Amazon SQS stream as a target. Detailed below.
  final pulumi.Input<PipeTargetParametersSqsQueueParameters>?
  sqsQueueParameters;

  /// The parameters for using a Step Functions state machine as a target. Detailed below.
  final pulumi.Input<PipeTargetParametersStepFunctionStateMachineParameters>?
    ...
    return <String, dynamic>{
      'batchJobParameters':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(batchJobParameters, (value) => value.toMap()),
      'cloudwatchLogsParameters':
          ?pulumi.Input.mapOptionalInputValue<
            PipeTargetParametersCloudwatchLogsParameters,
            Map<String, dynamic>
          >(cloudwatchLogsParameters, (value) => value.toMap()),
      'ecsTaskParameters':
          ?pulumi.Input.mapOptionalInputValue<
            PipeTargetParametersEcsTaskParameters,
            Map<String, dynamic>
          >(ecsTaskParameters, (value) => value.toMap()),
      'eventbridgeEventBusParameters':
          ?pulumi.Input.mapOptionalInputValue<
            PipeTargetParametersEventbridgeEventBusParameters,
            Map<String, dynamic>
          >(eventbridgeEventBusParameters, (value) => value.toMap()),
      'httpParameters':
          ?pulumi.Input.mapOptionalInputValue<
            PipeTargetParametersHttpParameters,
            Map<String, dynamic>
          >(httpParameters, (value) => value.toMap()),
      ...
      'lambdaFunctionParameters':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(lambdaFunctionParameters, (value) => value.toMap()),
      'redshiftDataParameters':
          ?pulumi.Input.mapOptionalInputValue<
            PipeTargetParametersRedshiftDataParameters,
            Map<String, dynamic>
          >(redshiftDataParameters, (value) => value.toMap()),
      'sagemakerPipelineParameters':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'stepFunctionStateMachineParameters':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(stepFunctionStateMachineParameters, (value) => value.toMap()),
    };
  }
  ...
  factory PipeTargetParameters.fromMap(Map<String, dynamic> map) {
    return PipeTargetParameters(
      batchJobParameters: (() {
        final guardedValue = map['batchJobParameters'];
      ...
      cloudwatchLogsParameters: (() {
        final guardedValue = map['cloudwatchLogsParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      ecsTaskParameters: (() {
        final guardedValue = map['ecsTaskParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      eventbridgeEventBusParameters: (() {
        final guardedValue = map['eventbridgeEventBusParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      httpParameters: (() {
        final guardedValue = map['httpParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      inputTemplate: (() {
        final guardedValue = map['inputTemplate'];
        if (guardedValue == null) return null;
      ...
      lambdaFunctionParameters: (() {
        final guardedValue = map['lambdaFunctionParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      redshiftDataParameters: (() {
        final guardedValue = map['redshiftDataParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      stepFunctionStateMachineParameters: (() {
        final guardedValue = map['stepFunctionStateMachineParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
