...
class PipeTargetParametersBatchJobParameters {
  ...
  final pulumi.Input<PipeTargetParametersBatchJobParametersArrayProperties>?
  arrayProperties;

  /// The overrides that are sent to a container. Detailed below.
  final pulumi.Input<PipeTargetParametersBatchJobParametersContainerOverrides>?
  containerOverrides;
  ...
  final pulumi.Input<List<PipeTargetParametersBatchJobParametersDependsOn>>?
  dependsOns;
  ...
  final pulumi.Input<PipeTargetParametersBatchJobParametersRetryStrategy>?
  retryStrategy;
    ...
    return <String, dynamic>{
      'arrayProperties':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(arrayProperties, (value) => value.toMap()),
      'containerOverrides':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'dependsOns':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipeTargetParametersBatchJobParametersDependsOn>,
  ...
  factory PipeTargetParametersBatchJobParameters.fromMap(
    ...
    return PipeTargetParametersBatchJobParameters(
      arrayProperties: (() {
        final guardedValue = map['arrayProperties'];
      ...
      dependsOns: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => PipeTargetParametersBatchJobParametersDependsOn.fromMap(
