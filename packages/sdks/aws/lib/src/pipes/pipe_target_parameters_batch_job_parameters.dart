...
class PipeTargetParametersBatchJobParameters {
  ...
  /// [jobDefinition] Job definition used by this job. This value can be one of name, name:revision, or the ARN for the job definition. If name is specified without a revision then the latest active revision is used.
