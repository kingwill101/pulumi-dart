...
class GetSecurityGroupRuleArgs {
  ...
  factory GetSecurityGroupRuleArgs.fromMap(Map<String, dynamic> map) {
    return GetSecurityGroupRuleArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetSecurityGroupRuleFilter>(guardedValue, (value) => GetSecurityGroupRuleFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
