...
class RouteServerArgs {
  ...
  factory RouteServerArgs.fromMap(Map<String, dynamic> map) {
    return RouteServerArgs(
      amazonSideAsn: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['amazonSideAsn'])),
      ...
      persistRoutesDuration: (() { final guardedValue = map['persistRoutesDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
