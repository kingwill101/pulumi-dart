...
class GetEndpointAssociationsAssociation {
  ...
  factory GetEndpointAssociationsAssociation.fromMap(Map<String, dynamic> map) {
    return GetEndpointAssociationsAssociation(
      associatedResourceAccessibility: pulumi.Input.fromValue(map['associatedResourceAccessibility'] as String),
      associatedResourceArn: pulumi.Input.fromValue(map['associatedResourceArn'] as String),
      dnsEntries: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEndpointAssociationsAssociationDnsEntry>(map['dnsEntries']!, (value) => GetEndpointAssociationsAssociationDnsEntry.fromMap((value as Map).cast<String, dynamic>()))),
      id: pulumi.Input.fromValue(map['id'] as String),
      privateDnsEntries: pulumi.Input.fromValue(pulumi.Input.decodeList<GetEndpointAssociationsAssociationPrivateDnsEntry>(map['privateDnsEntries']!, (value) => GetEndpointAssociationsAssociationPrivateDnsEntry.fromMap((value as Map).cast<String, dynamic>()))),
      resourceConfigurationGroupArn: pulumi.Input.fromValue(map['resourceConfigurationGroupArn'] as String),
