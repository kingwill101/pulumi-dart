...
class RouteServerTimeouts {
  ...
  /// Creates a new [RouteServerTimeouts].
  ...
  RouteServerTimeouts({this.create, this.delete, this.update});
  ...
  factory RouteServerTimeouts.fromMap(Map<String, dynamic> map) {
    return RouteServerTimeouts(
      create: (() {
