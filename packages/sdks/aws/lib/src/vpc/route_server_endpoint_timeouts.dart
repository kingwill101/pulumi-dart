...
class RouteServerEndpointTimeouts {
  ...
  /// Creates a new [RouteServerEndpointTimeouts].
  ...
  RouteServerEndpointTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory RouteServerEndpointTimeouts.fromMap(Map<String, dynamic> map) {
    return RouteServerEndpointTimeouts(
      create: (() {
