...
class GetSecurityGroupRulesArgs {
  ...
  GetSecurityGroupRulesArgs({
    pulumi.Output<List<GetSecurityGroupRulesFilter>>? filters,
    pulumi.Output<String>? region,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      filters = pulumi.Input.asOptionalInput<List<GetSecurityGroupRulesFilter>>(filters),
  ...
  factory GetSecurityGroupRulesArgs.fromMap(Map<String, dynamic> map) {
    return GetSecurityGroupRulesArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetSecurityGroupRulesFilter>>(pulumi.Input.decodeList<GetSecurityGroupRulesFilter>(map['filters'], (value) => GetSecurityGroupRulesFilter.fromMap((value as Map).cast<String, dynamic>()))),
