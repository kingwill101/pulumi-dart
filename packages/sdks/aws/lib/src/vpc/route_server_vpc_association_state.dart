...
class RouteServerVpcAssociationState {
  ...
  const RouteServerVpcAssociationState({
    this.region,
    this.routeServerId,
    this.timeouts,
    this.vpcId,
  ...
  factory RouteServerVpcAssociationState.fromMap(Map<String, dynamic> map) {
    return RouteServerVpcAssociationState(
      ...
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouteServerVpcAssociationTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
