...
class GetVoicesArgs {
  ...
  factory GetVoicesArgs.fromMap(Map<String, dynamic> map) {
    return GetVoicesArgs(
      ...
      includeAdditionalLanguageCodes: (() { final guardedValue = map['includeAdditionalLanguageCodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      voices: (() { final guardedValue = map['voices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVoicesVoice>(guardedValue, (value) => GetVoicesVoice.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
