...
class DeploymentGroupEc2TagSet {
  ...
  factory DeploymentGroupEc2TagSet.fromMap(Map<String, dynamic> map) {
    return DeploymentGroupEc2TagSet(
      ec2TagFilters: (() { final guardedValue = map['ec2TagFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DeploymentGroupEc2TagSetEc2TagFilter>(guardedValue, (value) => DeploymentGroupEc2TagSetEc2TagFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
