...
class DeploymentGroupState {
  ...
  factory DeploymentGroupState.fromMap(Map<String, dynamic> map) {
    return DeploymentGroupState(
      ...
      deploymentGroupId: map['deploymentGroupId'] == null ? null : ((map['deploymentGroupId'] as String).input()).input(),
      deploymentGroupName: map['deploymentGroupName'] == null ? null : ((map['deploymentGroupName'] as String).input()).input(),
