...
class DeploymentGroupState {
  ...
  factory DeploymentGroupState.fromMap(Map<String, dynamic> map) {
    return DeploymentGroupState(
      alarmConfiguration: map['alarmConfiguration'] == null ? null : (DeploymentGroupAlarmConfiguration.fromMap((map['alarmConfiguration'] as Map).cast<String, dynamic>())).input(),
      appName: map['appName'] == null ? null : (map['appName'] as String).input(),
      arn: map['arn'] == null ? null : (map['arn'] as String).input(),
      autoRollbackConfiguration: map['autoRollbackConfiguration'] == null ? null : (DeploymentGroupAutoRollbackConfiguration.fromMap((map['autoRollbackConfiguration'] as Map).cast<String, dynamic>())).input(),
      autoscalingGroups: map['autoscalingGroups'] == null ? null : ((map['autoscalingGroups'] as List).cast<String>()).input(),
      blueGreenDeploymentConfig: map['blueGreenDeploymentConfig'] == null ? null : (DeploymentGroupBlueGreenDeploymentConfig.fromMap((map['blueGreenDeploymentConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      deploymentGroupId: map['deploymentGroupId'] == null ? null : (map['deploymentGroupId'] as String).input(),
      deploymentGroupName: map['deploymentGroupName'] == null ? null : (map['deploymentGroupName'] as String).input(),
      deploymentStyle: map['deploymentStyle'] == null ? null : (DeploymentGroupDeploymentStyle.fromMap((map['deploymentStyle'] as Map).cast<String, dynamic>())).input(),
      ec2TagFilters: map['ec2TagFilters'] == null ? null : (pulumi.Input.decodeList<DeploymentGroupEc2TagFilter>(map['ec2TagFilters'], (value) => DeploymentGroupEc2TagFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ec2TagSets: map['ec2TagSets'] == null ? null : (pulumi.Input.decodeList<DeploymentGroupEc2TagSet>(map['ec2TagSets'], (value) => DeploymentGroupEc2TagSet.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ecsService: map['ecsService'] == null ? null : (DeploymentGroupEcsService.fromMap((map['ecsService'] as Map).cast<String, dynamic>())).input(),
      loadBalancerInfo: map['loadBalancerInfo'] == null ? null : (DeploymentGroupLoadBalancerInfo.fromMap((map['loadBalancerInfo'] as Map).cast<String, dynamic>())).input(),
      onPremisesInstanceTagFilters: map['onPremisesInstanceTagFilters'] == null ? null : (pulumi.Input.decodeList<DeploymentGroupOnPremisesInstanceTagFilter>(map['onPremisesInstanceTagFilters'], (value) => DeploymentGroupOnPremisesInstanceTagFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      outdatedInstancesStrategy: map['outdatedInstancesStrategy'] == null ? null : (map['outdatedInstancesStrategy'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      serviceRoleArn: map['serviceRoleArn'] == null ? null : (map['serviceRoleArn'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      terminationHookEnabled: map['terminationHookEnabled'] == null ? null : (map['terminationHookEnabled'] as bool).input(),
      triggerConfigurations: map['triggerConfigurations'] == null ? null : (pulumi.Input.decodeList<DeploymentGroupTriggerConfiguration>(map['triggerConfigurations'], (value) => DeploymentGroupTriggerConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
