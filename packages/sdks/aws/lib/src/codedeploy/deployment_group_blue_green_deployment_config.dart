...
class DeploymentGroupBlueGreenDeploymentConfig {
  ...
  factory DeploymentGroupBlueGreenDeploymentConfig.fromMap(Map<String, dynamic> map) {
    return DeploymentGroupBlueGreenDeploymentConfig(
      deploymentReadyOption: (() { final guardedValue = map['deploymentReadyOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      greenFleetProvisioningOption: (() { final guardedValue = map['greenFleetProvisioningOption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      terminateBlueInstancesOnDeploymentSuccess: (() { final guardedValue = map['terminateBlueInstancesOnDeploymentSuccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccess.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
