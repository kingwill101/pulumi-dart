...
class DeploymentGroupArgs {
  ...
  DeploymentGroupArgs({
    ...
    required pulumi.Output<String> deploymentGroupName,
    ...
    required pulumi.Output<String> serviceRoleArn,
  ...
  factory DeploymentGroupArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentGroupArgs(
      ...
      deploymentGroupName: pulumi.Output.create<String>(map['deploymentGroupName'] as String),
      ...
      serviceRoleArn: pulumi.Output.create<String>(map['serviceRoleArn'] as String),
