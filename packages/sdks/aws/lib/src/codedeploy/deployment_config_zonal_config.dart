...
class DeploymentConfigZonalConfig {
  ...
  factory DeploymentConfigZonalConfig.fromMap(Map<String, dynamic> map) {
    return DeploymentConfigZonalConfig(
      firstZoneMonitorDurationInSeconds: (() { final guardedValue = map['firstZoneMonitorDurationInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      monitorDurationInSeconds: (() { final guardedValue = map['monitorDurationInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
    );
  }
}
