...
class DeploymentConfigZonalConfig {
  ...
  final DeploymentConfigZonalConfigMinimumHealthyHostsPerZone? minimumHealthyHostsPerZone;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'minimumHealthyHostsPerZone': ?minimumHealthyHostsPerZone == null ? null : minimumHealthyHostsPerZone!.toMap(),
  ...
  factory DeploymentConfigZonalConfig.fromMap(Map<String, dynamic> map) {
    return DeploymentConfigZonalConfig(
      firstZoneMonitorDurationInSeconds: map['firstZoneMonitorDurationInSeconds'] == null ? null : map['firstZoneMonitorDurationInSeconds'] as int,
      minimumHealthyHostsPerZone: map['minimumHealthyHostsPerZone'] == null ? null : DeploymentConfigZonalConfigMinimumHealthyHostsPerZone.fromMap((map['minimumHealthyHostsPerZone'] as Map).cast<String, dynamic>()),
      monitorDurationInSeconds: map['monitorDurationInSeconds'] == null ? null : map['monitorDurationInSeconds'] as int,
    );
  }
}
