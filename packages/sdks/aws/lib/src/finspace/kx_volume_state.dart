...
class KxVolumeState {
  ...
  factory KxVolumeState.fromMap(Map<String, dynamic> map) {
    return KxVolumeState(
      ...
      attachedClusters: (() {
        final guardedValue = map['attachedClusters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<KxVolumeAttachedCluster>(
            guardedValue,
            (value) => KxVolumeAttachedCluster.fromMap(
