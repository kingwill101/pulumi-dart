...
class KxClusterArgs {
  ...
  factory KxClusterArgs.fromMap(Map<String, dynamic> map) {
    return KxClusterArgs(
      autoScalingConfiguration: (() {
        final guardedValue = map['autoScalingConfiguration'];
      ...
      cacheStorageConfigurations: (() {
        final guardedValue = map['cacheStorageConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      capacityConfiguration: (() {
        final guardedValue = map['capacityConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      code: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          KxClusterCode.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ...
      initializationScript: (() {
        final guardedValue = map['initializationScript'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      savedownStorageConfiguration: (() {
        final guardedValue = map['savedownStorageConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      scalingGroupConfiguration: (() {
        final guardedValue = map['scalingGroupConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      tickerplantLogConfigurations: (() {
        final guardedValue = map['tickerplantLogConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      vpcConfiguration: pulumi.Input.fromValue(
        KxClusterVpcConfiguration.fromMap(
