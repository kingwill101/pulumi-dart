...
class KxClusterArgs {
  ...
  KxClusterArgs({
    ...
    required pulumi.Output<KxClusterVpcConfiguration> vpcConfiguration,
  }) :
  ...
  factory KxClusterArgs.fromMap(Map<String, dynamic> map) {
    return KxClusterArgs(
      ...
      vpcConfiguration: pulumi.Output.create<KxClusterVpcConfiguration>(KxClusterVpcConfiguration.fromMap((map['vpcConfiguration'] as Map).cast<String, dynamic>())),
    );
  }
}
