...
class KxClusterState {
  ...
  factory KxClusterState.fromMap(Map<String, dynamic> map) {
    return KxClusterState(
      ...
      autoScalingConfiguration: map['autoScalingConfiguration'] == null ? null : (KxClusterAutoScalingConfiguration.fromMap((map['autoScalingConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      cacheStorageConfigurations: map['cacheStorageConfigurations'] == null ? null : (pulumi.Input.decodeList<KxClusterCacheStorageConfiguration>(map['cacheStorageConfigurations'], (value) => KxClusterCacheStorageConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      capacityConfiguration: map['capacityConfiguration'] == null ? null : (KxClusterCapacityConfiguration.fromMap((map['capacityConfiguration'] as Map).cast<String, dynamic>())).input(),
      code: map['code'] == null ? null : (KxClusterCode.fromMap((map['code'] as Map).cast<String, dynamic>())).input(),
      commandLineArguments: map['commandLineArguments'] == null ? null : ((map['commandLineArguments'] as Map).cast<String, String>()).input(),
      createdTimestamp: map['createdTimestamp'] == null ? null : (map['createdTimestamp'] as String).input(),
      databases: map['databases'] == null ? null : (pulumi.Input.decodeList<KxClusterDatabase>(map['databases'], (value) => KxClusterDatabase.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      environmentId: map['environmentId'] == null ? null : (map['environmentId'] as String).input(),
      executionRole: map['executionRole'] == null ? null : (map['executionRole'] as String).input(),
      initializationScript: map['initializationScript'] == null ? null : (map['initializationScript'] as String).input(),
      ...
      savedownStorageConfiguration: map['savedownStorageConfiguration'] == null ? null : (KxClusterSavedownStorageConfiguration.fromMap((map['savedownStorageConfiguration'] as Map).cast<String, dynamic>())).input(),
      scalingGroupConfiguration: map['scalingGroupConfiguration'] == null ? null : (KxClusterScalingGroupConfiguration.fromMap((map['scalingGroupConfiguration'] as Map).cast<String, dynamic>())).input(),
      status: map['status'] == null ? null : (map['status'] as String).input(),
      statusReason: map['statusReason'] == null ? null : (map['statusReason'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      tickerplantLogConfigurations: map['tickerplantLogConfigurations'] == null ? null : (pulumi.Input.decodeList<KxClusterTickerplantLogConfiguration>(map['tickerplantLogConfigurations'], (value) => KxClusterTickerplantLogConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      type: map['type'] == null ? null : (map['type'] as String).input(),
      vpcConfiguration: map['vpcConfiguration'] == null ? null : (KxClusterVpcConfiguration.fromMap((map['vpcConfiguration'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
