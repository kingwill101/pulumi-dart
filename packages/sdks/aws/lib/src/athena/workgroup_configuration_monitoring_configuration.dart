    ...
    return <String, dynamic>{
      ...
      'managedLoggingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfiguration,
            Map<String, dynamic>
          >(managedLoggingConfiguration, (value) => value.toMap()),
      's3LoggingConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            WorkgroupConfigurationMonitoringConfigurationS3LoggingConfiguration,
            Map<String, dynamic>
          >(s3LoggingConfiguration, (value) => value.toMap()),
    };
  }
    ...
    return WorkgroupConfigurationMonitoringConfiguration(
      cloudWatchLoggingConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      managedLoggingConfiguration: (() {
        final guardedValue = map['managedLoggingConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      s3LoggingConfiguration: (() {
        final guardedValue = map['s3LoggingConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkgroupConfigurationMonitoringConfigurationS3LoggingConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
