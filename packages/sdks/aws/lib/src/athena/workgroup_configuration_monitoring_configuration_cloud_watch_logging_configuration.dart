...
class WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfiguration {
  ...
  factory WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfiguration.fromMap(Map<String, dynamic> map) {
    return WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfiguration(
      ...
      logTypes: (() { final guardedValue = map['logTypes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogType>(guardedValue, (value) => WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogType.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
