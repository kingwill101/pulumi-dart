...
class Database extends pulumi.CustomResource {
  ...
  Database(
    ...
    this.aclConfiguration = registerOutput<DatabaseAclConfiguration?>('aclConfiguration');
    this.bucket = registerOutput<String?>('bucket');
    this.comment = registerOutput<String?>('comment');
    this.encryptionConfiguration = registerOutput<DatabaseEncryptionConfiguration?>('encryptionConfiguration');
