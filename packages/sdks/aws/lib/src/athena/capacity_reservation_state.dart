...
class CapacityReservationState {
  ...
  factory CapacityReservationState.fromMap(Map<String, dynamic> map) {
    return CapacityReservationState(
      allocatedDpus: (() { final guardedValue = map['allocatedDpus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      targetDpus: (() { final guardedValue = map['targetDpus']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
