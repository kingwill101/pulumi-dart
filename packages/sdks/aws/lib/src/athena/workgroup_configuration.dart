...
class WorkgroupConfiguration {
  ...
  final pulumi.Input<WorkgroupConfigurationIdentityCenterConfiguration>?
  identityCenterConfiguration;

  /// Configuration block for storing results in Athena owned storage. See Managed Query Results Configuration below.
  final pulumi.Input<WorkgroupConfigurationManagedQueryResultsConfiguration>?
  ...
  final pulumi.Input<WorkgroupConfigurationMonitoringConfiguration>?
  ...
  final pulumi.Input<WorkgroupConfigurationResultConfiguration>?
  resultConfiguration;
    ...
    return <String, dynamic>{
      ...
      'customerContentEncryptionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            WorkgroupConfigurationCustomerContentEncryptionConfiguration,
            Map<String, dynamic>
          >(customerContentEncryptionConfiguration, (value) => value.toMap()),
      ...
      'engineVersion':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(engineVersion, (value) => value.toMap()),
      'executionRole': ?executionRole,
      'identityCenterConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            WorkgroupConfigurationIdentityCenterConfiguration,
            Map<String, dynamic>
          >(identityCenterConfiguration, (value) => value.toMap()),
      'managedQueryResultsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            WorkgroupConfigurationManagedQueryResultsConfiguration,
            Map<String, dynamic>
          >(managedQueryResultsConfiguration, (value) => value.toMap()),
      'monitoringConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'resultConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(resultConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory WorkgroupConfiguration.fromMap(Map<String, dynamic> map) {
    return WorkgroupConfiguration(
      bytesScannedCutoffPerQuery: (() {
        final guardedValue = map['bytesScannedCutoffPerQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      customerContentEncryptionConfiguration: (() {
        final guardedValue = map['customerContentEncryptionConfiguration'];
        if (guardedValue == null) return null;
      ...
      enableMinimumEncryptionConfiguration: (() {
        final guardedValue = map['enableMinimumEncryptionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enforceWorkgroupConfiguration: (() {
        final guardedValue = map['enforceWorkgroupConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      engineVersion: (() {
      ...
      identityCenterConfiguration: (() {
        final guardedValue = map['identityCenterConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      managedQueryResultsConfiguration: (() {
        final guardedValue = map['managedQueryResultsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      publishCloudwatchMetricsEnabled: (() {
        final guardedValue = map['publishCloudwatchMetricsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      requesterPaysEnabled: (() {
        final guardedValue = map['requesterPaysEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      resultConfiguration: (() {
        final guardedValue = map['resultConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
