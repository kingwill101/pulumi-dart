...
class PolicyPredictiveScalingConfiguration {
  ...
  factory PolicyPredictiveScalingConfiguration.fromMap(Map<String, dynamic> map) {
    return PolicyPredictiveScalingConfiguration(
      ...
      maxCapacityBuffer: (() { final guardedValue = map['maxCapacityBuffer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      metricSpecification: pulumi.Input.fromValue(PolicyPredictiveScalingConfigurationMetricSpecification.fromMap((map['metricSpecification']! as Map).cast<String, dynamic>())),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      schedulingBufferTime: (() { final guardedValue = map['schedulingBufferTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
