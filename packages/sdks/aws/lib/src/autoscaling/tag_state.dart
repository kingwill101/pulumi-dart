...
class TagState {
  ...
  TagState({this.autoscalingGroupName, this.region, this.tag});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoscalingGroupName': ?autoscalingGroupName,
      'region': ?region,
      'tag': ?pulumi.Input.mapOptionalInputValue<TagTag, Map<String, dynamic>>(
        tag,
        (value) => value.toMap(),
      ),
    };
    ...
    return TagState(
      ...
      tag: (() {
        ...
        return pulumi.Input.fromValue(
          TagTag.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
