...
class GetGroupMixedInstancesPolicyLaunchTemplate {
  ...
  final pulumi.Input<
    List<GetGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification>
  >
  launchTemplateSpecifications;

  /// List of properties overriding the same properties in the launch template.
  final pulumi.Input<List<GetGroupMixedInstancesPolicyLaunchTemplateOverride>>
  overrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'overrides':
          pulumi.Input.mapInputValue<
            List<GetGroupMixedInstancesPolicyLaunchTemplateOverride>,
            List<Map<String, dynamic>>
          >(
            overrides,
            (value) =>
