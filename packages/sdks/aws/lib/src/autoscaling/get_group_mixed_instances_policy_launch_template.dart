...
class GetGroupMixedInstancesPolicyLaunchTemplate {
  ...
  factory GetGroupMixedInstancesPolicyLaunchTemplate.fromMap(Map<String, dynamic> map) {
    return GetGroupMixedInstancesPolicyLaunchTemplate(
      launchTemplateSpecifications: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification>(map['launchTemplateSpecifications']!, (value) => GetGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification.fromMap((value as Map).cast<String, dynamic>()))),
      overrides: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGroupMixedInstancesPolicyLaunchTemplateOverride>(map['overrides']!, (value) => GetGroupMixedInstancesPolicyLaunchTemplateOverride.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
