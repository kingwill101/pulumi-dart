    ...
    return GroupMixedInstancesPolicyLaunchTemplateOverride(
      instanceRequirements: (() {
        ...
        return pulumi.Input.fromValue(
          GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements.fromMap(
      ...
      launchTemplateSpecification: (() {
        final guardedValue = map['launchTemplateSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecification.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
