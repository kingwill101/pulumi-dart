...
class GroupInstanceRefresh {
  ...
  /// [triggers] Set of additional property names that will trigger an Instance Refresh. A refresh will always be triggered by a change in any of `launchConfiguration`, `launchTemplate`, or `mixedInstancesPolicy`.
  const GroupInstanceRefresh({
    this.preferences,
