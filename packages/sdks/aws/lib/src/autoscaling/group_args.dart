...
class GroupArgs {
  ...
  GroupArgs({
    pulumi.Output<GroupAvailabilityZoneDistribution>? availabilityZoneDistribution,
    pulumi.Output<List<String>>? availabilityZones,
    pulumi.Output<bool>? capacityRebalance,
    pulumi.Output<GroupCapacityReservationSpecification>? capacityReservationSpecification,
    pulumi.Output<String>? context,
    pulumi.Output<int>? defaultCooldown,
    pulumi.Output<int>? defaultInstanceWarmup,
    pulumi.Output<int>? desiredCapacity,
    pulumi.Output<String>? desiredCapacityType,
    pulumi.Output<List<Metric>>? enabledMetrics,
    pulumi.Output<bool>? forceDelete,
    pulumi.Output<bool>? forceDeleteWarmPool,
    pulumi.Output<int>? healthCheckGracePeriod,
    pulumi.Output<String>? healthCheckType,
    pulumi.Output<bool>? ignoreFailedScalingActivities,
    pulumi.Output<List<GroupInitialLifecycleHook>>? initialLifecycleHooks,
    pulumi.Output<GroupInstanceMaintenancePolicy>? instanceMaintenancePolicy,
    pulumi.Output<GroupInstanceRefresh>? instanceRefresh,
    pulumi.Output<String>? launchConfiguration,
    pulumi.Output<GroupLaunchTemplate>? launchTemplate,
    pulumi.Output<List<String>>? loadBalancers,
    pulumi.Output<int>? maxInstanceLifetime,
    required pulumi.Output<int> maxSize,
    pulumi.Output<String>? metricsGranularity,
    pulumi.Output<int>? minElbCapacity,
    required pulumi.Output<int> minSize,
    pulumi.Output<GroupMixedInstancesPolicy>? mixedInstancesPolicy,
    pulumi.Output<String>? name,
    pulumi.Output<String>? namePrefix,
    pulumi.Output<String>? placementGroup,
    pulumi.Output<bool>? protectFromScaleIn,
    pulumi.Output<String>? region,
    pulumi.Output<String>? serviceLinkedRoleArn,
    pulumi.Output<List<String>>? suspendedProcesses,
    pulumi.Output<List<GroupTag>>? tags,
    pulumi.Output<List<String>>? targetGroupArns,
    pulumi.Output<List<String>>? terminationPolicies,
    pulumi.Output<List<GroupTrafficSource>>? trafficSources,
    pulumi.Output<List<String>>? vpcZoneIdentifiers,
    pulumi.Output<String>? waitForCapacityTimeout,
    pulumi.Output<int>? waitForElbCapacity,
    pulumi.Output<GroupWarmPool>? warmPool,
  }) :
      availabilityZoneDistribution = pulumi.Input.asOptionalInput<GroupAvailabilityZoneDistribution>(availabilityZoneDistribution),
      availabilityZones = pulumi.Input.asOptionalInput<List<String>>(availabilityZones),
      capacityRebalance = pulumi.Input.asOptionalInput<bool>(capacityRebalance),
      capacityReservationSpecification = pulumi.Input.asOptionalInput<GroupCapacityReservationSpecification>(capacityReservationSpecification),
      context = pulumi.Input.asOptionalInput<String>(context),
      defaultCooldown = pulumi.Input.asOptionalInput<int>(defaultCooldown),
      defaultInstanceWarmup = pulumi.Input.asOptionalInput<int>(defaultInstanceWarmup),
      desiredCapacity = pulumi.Input.asOptionalInput<int>(desiredCapacity),
      desiredCapacityType = pulumi.Input.asOptionalInput<String>(desiredCapacityType),
      enabledMetrics = pulumi.Input.asOptionalInput<List<Metric>>(enabledMetrics),
      forceDelete = pulumi.Input.asOptionalInput<bool>(forceDelete),
      forceDeleteWarmPool = pulumi.Input.asOptionalInput<bool>(forceDeleteWarmPool),
      healthCheckGracePeriod = pulumi.Input.asOptionalInput<int>(healthCheckGracePeriod),
      healthCheckType = pulumi.Input.asOptionalInput<String>(healthCheckType),
      ignoreFailedScalingActivities = pulumi.Input.asOptionalInput<bool>(ignoreFailedScalingActivities),
      initialLifecycleHooks = pulumi.Input.asOptionalInput<List<GroupInitialLifecycleHook>>(initialLifecycleHooks),
      instanceMaintenancePolicy = pulumi.Input.asOptionalInput<GroupInstanceMaintenancePolicy>(instanceMaintenancePolicy),
      instanceRefresh = pulumi.Input.asOptionalInput<GroupInstanceRefresh>(instanceRefresh),
      launchConfiguration = pulumi.Input.asOptionalInput<String>(launchConfiguration),
      launchTemplate = pulumi.Input.asOptionalInput<GroupLaunchTemplate>(launchTemplate),
      ...
      metricsGranularity = pulumi.Input.asOptionalInput<String>(metricsGranularity),
      minElbCapacity = pulumi.Input.asOptionalInput<int>(minElbCapacity),
      minSize = pulumi.Input.asInput<int>(minSize),
      mixedInstancesPolicy = pulumi.Input.asOptionalInput<GroupMixedInstancesPolicy>(mixedInstancesPolicy),
      name = pulumi.Input.asOptionalInput<String>(name),
      namePrefix = pulumi.Input.asOptionalInput<String>(namePrefix),
      placementGroup = pulumi.Input.asOptionalInput<String>(placementGroup),
      protectFromScaleIn = pulumi.Input.asOptionalInput<bool>(protectFromScaleIn),
      region = pulumi.Input.asOptionalInput<String>(region),
      serviceLinkedRoleArn = pulumi.Input.asOptionalInput<String>(serviceLinkedRoleArn),
      suspendedProcesses = pulumi.Input.asOptionalInput<List<String>>(suspendedProcesses),
      tags = pulumi.Input.asOptionalInput<List<GroupTag>>(tags),
      targetGroupArns = pulumi.Input.asOptionalInput<List<String>>(targetGroupArns),
      terminationPolicies = pulumi.Input.asOptionalInput<List<String>>(terminationPolicies),
      trafficSources = pulumi.Input.asOptionalInput<List<GroupTrafficSource>>(trafficSources),
      vpcZoneIdentifiers = pulumi.Input.asOptionalInput<List<String>>(vpcZoneIdentifiers),
      waitForCapacityTimeout = pulumi.Input.asOptionalInput<String>(waitForCapacityTimeout),
      waitForElbCapacity = pulumi.Input.asOptionalInput<int>(waitForElbCapacity),
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      availabilityZoneDistribution: map['availabilityZoneDistribution'] == null ? null : pulumi.Output.create<GroupAvailabilityZoneDistribution>(GroupAvailabilityZoneDistribution.fromMap((map['availabilityZoneDistribution'] as Map).cast<String, dynamic>())),
      ...
      capacityRebalance: map['capacityRebalance'] == null ? null : pulumi.Output.create<bool>(map['capacityRebalance'] as bool),
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : pulumi.Output.create<GroupCapacityReservationSpecification>(GroupCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>())),
      ...
      defaultInstanceWarmup: map['defaultInstanceWarmup'] == null ? null : pulumi.Output.create<int>(map['defaultInstanceWarmup'] as int),
      desiredCapacity: map['desiredCapacity'] == null ? null : pulumi.Output.create<int>(map['desiredCapacity'] as int),
      desiredCapacityType: map['desiredCapacityType'] == null ? null : pulumi.Output.create<String>(map['desiredCapacityType'] as String),
      enabledMetrics: map['enabledMetrics'] == null ? null : pulumi.Output.create<List<Metric>>(pulumi.Input.decodeList<Metric>(map['enabledMetrics'], (value) => Metric.fromValue(value as String))),
      forceDelete: map['forceDelete'] == null ? null : pulumi.Output.create<bool>(map['forceDelete'] as bool),
      forceDeleteWarmPool: map['forceDeleteWarmPool'] == null ? null : pulumi.Output.create<bool>(map['forceDeleteWarmPool'] as bool),
      healthCheckGracePeriod: map['healthCheckGracePeriod'] == null ? null : pulumi.Output.create<int>(map['healthCheckGracePeriod'] as int),
      healthCheckType: map['healthCheckType'] == null ? null : pulumi.Output.create<String>(map['healthCheckType'] as String),
      ignoreFailedScalingActivities: map['ignoreFailedScalingActivities'] == null ? null : pulumi.Output.create<bool>(map['ignoreFailedScalingActivities'] as bool),
      initialLifecycleHooks: map['initialLifecycleHooks'] == null ? null : pulumi.Output.create<List<GroupInitialLifecycleHook>>(pulumi.Input.decodeList<GroupInitialLifecycleHook>(map['initialLifecycleHooks'], (value) => GroupInitialLifecycleHook.fromMap((value as Map).cast<String, dynamic>()))),
      instanceMaintenancePolicy: map['instanceMaintenancePolicy'] == null ? null : pulumi.Output.create<GroupInstanceMaintenancePolicy>(GroupInstanceMaintenancePolicy.fromMap((map['instanceMaintenancePolicy'] as Map).cast<String, dynamic>())),
      instanceRefresh: map['instanceRefresh'] == null ? null : pulumi.Output.create<GroupInstanceRefresh>(GroupInstanceRefresh.fromMap((map['instanceRefresh'] as Map).cast<String, dynamic>())),
      launchConfiguration: map['launchConfiguration'] == null ? null : pulumi.Output.create<String>(map['launchConfiguration'] as String),
      launchTemplate: map['launchTemplate'] == null ? null : pulumi.Output.create<GroupLaunchTemplate>(GroupLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>())),
      ...
      metricsGranularity: map['metricsGranularity'] == null ? null : pulumi.Output.create<String>(map['metricsGranularity'] as String),
      minElbCapacity: map['minElbCapacity'] == null ? null : pulumi.Output.create<int>(map['minElbCapacity'] as int),
      minSize: pulumi.Output.create<int>(map['minSize'] as int),
      mixedInstancesPolicy: map['mixedInstancesPolicy'] == null ? null : pulumi.Output.create<GroupMixedInstancesPolicy>(GroupMixedInstancesPolicy.fromMap((map['mixedInstancesPolicy'] as Map).cast<String, dynamic>())),
      ...
      protectFromScaleIn: map['protectFromScaleIn'] == null ? null : pulumi.Output.create<bool>(map['protectFromScaleIn'] as bool),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      serviceLinkedRoleArn: map['serviceLinkedRoleArn'] == null ? null : pulumi.Output.create<String>(map['serviceLinkedRoleArn'] as String),
      suspendedProcesses: map['suspendedProcesses'] == null ? null : pulumi.Output.create<List<String>>((map['suspendedProcesses'] as List).cast<String>()),
      tags: map['tags'] == null ? null : pulumi.Output.create<List<GroupTag>>(pulumi.Input.decodeList<GroupTag>(map['tags'], (value) => GroupTag.fromMap((value as Map).cast<String, dynamic>()))),
      targetGroupArns: map['targetGroupArns'] == null ? null : pulumi.Output.create<List<String>>((map['targetGroupArns'] as List).cast<String>()),
      terminationPolicies: map['terminationPolicies'] == null ? null : pulumi.Output.create<List<String>>((map['terminationPolicies'] as List).cast<String>()),
      trafficSources: map['trafficSources'] == null ? null : pulumi.Output.create<List<GroupTrafficSource>>(pulumi.Input.decodeList<GroupTrafficSource>(map['trafficSources'], (value) => GroupTrafficSource.fromMap((value as Map).cast<String, dynamic>()))),
      vpcZoneIdentifiers: map['vpcZoneIdentifiers'] == null ? null : pulumi.Output.create<List<String>>((map['vpcZoneIdentifiers'] as List).cast<String>()),
      waitForCapacityTimeout: map['waitForCapacityTimeout'] == null ? null : pulumi.Output.create<String>(map['waitForCapacityTimeout'] as String),
      waitForElbCapacity: map['waitForElbCapacity'] == null ? null : pulumi.Output.create<int>(map['waitForElbCapacity'] as int),
      warmPool: map['warmPool'] == null ? null : pulumi.Output.create<GroupWarmPool>(GroupWarmPool.fromMap((map['warmPool'] as Map).cast<String, dynamic>())),
    );
  }
}
