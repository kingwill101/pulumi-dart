...
class GroupArgs {
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      availabilityZoneDistribution: map['availabilityZoneDistribution'] == null ? null : (GroupAvailabilityZoneDistribution.fromMap((map['availabilityZoneDistribution'] as Map).cast<String, dynamic>())).input(),
      availabilityZones: map['availabilityZones'] == null ? null : ((map['availabilityZones'] as List).cast<String>()).input(),
      capacityRebalance: map['capacityRebalance'] == null ? null : (map['capacityRebalance'] as bool).input(),
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : (GroupCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>())).input(),
      ...
      defaultInstanceWarmup: map['defaultInstanceWarmup'] == null ? null : (map['defaultInstanceWarmup'] as int).input(),
      desiredCapacity: map['desiredCapacity'] == null ? null : (map['desiredCapacity'] as int).input(),
      desiredCapacityType: map['desiredCapacityType'] == null ? null : (map['desiredCapacityType'] as String).input(),
      enabledMetrics: map['enabledMetrics'] == null ? null : (pulumi.Input.decodeList<Metric>(map['enabledMetrics'], (value) => Metric.fromValue(value as String))).input(),
      forceDelete: map['forceDelete'] == null ? null : (map['forceDelete'] as bool).input(),
      forceDeleteWarmPool: map['forceDeleteWarmPool'] == null ? null : (map['forceDeleteWarmPool'] as bool).input(),
      healthCheckGracePeriod: map['healthCheckGracePeriod'] == null ? null : (map['healthCheckGracePeriod'] as int).input(),
      healthCheckType: map['healthCheckType'] == null ? null : (map['healthCheckType'] as String).input(),
      ignoreFailedScalingActivities: map['ignoreFailedScalingActivities'] == null ? null : (map['ignoreFailedScalingActivities'] as bool).input(),
      initialLifecycleHooks: map['initialLifecycleHooks'] == null ? null : (pulumi.Input.decodeList<GroupInitialLifecycleHook>(map['initialLifecycleHooks'], (value) => GroupInitialLifecycleHook.fromMap((value as Map).cast<String, dynamic>()))).input(),
      instanceMaintenancePolicy: map['instanceMaintenancePolicy'] == null ? null : (GroupInstanceMaintenancePolicy.fromMap((map['instanceMaintenancePolicy'] as Map).cast<String, dynamic>())).input(),
      instanceRefresh: map['instanceRefresh'] == null ? null : (GroupInstanceRefresh.fromMap((map['instanceRefresh'] as Map).cast<String, dynamic>())).input(),
      launchConfiguration: map['launchConfiguration'] == null ? null : (map['launchConfiguration'] as String).input(),
      launchTemplate: map['launchTemplate'] == null ? null : (GroupLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>())).input(),
      ...
      metricsGranularity: map['metricsGranularity'] == null ? null : (map['metricsGranularity'] as String).input(),
      minElbCapacity: map['minElbCapacity'] == null ? null : (map['minElbCapacity'] as int).input(),
      minSize: (map['minSize'] as int).input(),
      mixedInstancesPolicy: map['mixedInstancesPolicy'] == null ? null : (GroupMixedInstancesPolicy.fromMap((map['mixedInstancesPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      serviceLinkedRoleArn: map['serviceLinkedRoleArn'] == null ? null : (map['serviceLinkedRoleArn'] as String).input(),
      suspendedProcesses: map['suspendedProcesses'] == null ? null : ((map['suspendedProcesses'] as List).cast<String>()).input(),
      tags: map['tags'] == null ? null : (pulumi.Input.decodeList<GroupTag>(map['tags'], (value) => GroupTag.fromMap((value as Map).cast<String, dynamic>()))).input(),
      targetGroupArns: map['targetGroupArns'] == null ? null : ((map['targetGroupArns'] as List).cast<String>()).input(),
      terminationPolicies: map['terminationPolicies'] == null ? null : ((map['terminationPolicies'] as List).cast<String>()).input(),
      trafficSources: map['trafficSources'] == null ? null : (pulumi.Input.decodeList<GroupTrafficSource>(map['trafficSources'], (value) => GroupTrafficSource.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vpcZoneIdentifiers: map['vpcZoneIdentifiers'] == null ? null : ((map['vpcZoneIdentifiers'] as List).cast<String>()).input(),
      waitForCapacityTimeout: map['waitForCapacityTimeout'] == null ? null : (map['waitForCapacityTimeout'] as String).input(),
      waitForElbCapacity: map['waitForElbCapacity'] == null ? null : (map['waitForElbCapacity'] as int).input(),
      warmPool: map['warmPool'] == null ? null : (GroupWarmPool.fromMap((map['warmPool'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
