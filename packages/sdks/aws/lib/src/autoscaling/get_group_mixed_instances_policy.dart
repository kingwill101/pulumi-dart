...
class GetGroupMixedInstancesPolicy {
  ...
  factory GetGroupMixedInstancesPolicy.fromMap(Map<String, dynamic> map) {
    return GetGroupMixedInstancesPolicy(
      instancesDistributions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGroupMixedInstancesPolicyInstancesDistribution>(map['instancesDistributions']!, (value) => GetGroupMixedInstancesPolicyInstancesDistribution.fromMap((value as Map).cast<String, dynamic>()))),
      launchTemplates: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGroupMixedInstancesPolicyLaunchTemplate>(map['launchTemplates']!, (value) => GetGroupMixedInstancesPolicyLaunchTemplate.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
