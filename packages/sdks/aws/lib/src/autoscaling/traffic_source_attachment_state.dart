...
class TrafficSourceAttachmentState {
  ...
  const TrafficSourceAttachmentState({
  ...
  factory TrafficSourceAttachmentState.fromMap(Map<String, dynamic> map) {
    return TrafficSourceAttachmentState(
      ...
      trafficSource: (() { final guardedValue = map['trafficSource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TrafficSourceAttachmentTrafficSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
