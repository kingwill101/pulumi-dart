...
class GroupMixedInstancesPolicyLaunchTemplate {
  ...
  factory GroupMixedInstancesPolicyLaunchTemplate.fromMap(Map<String, dynamic> map) {
    return GroupMixedInstancesPolicyLaunchTemplate(
      launchTemplateSpecification: pulumi.Input.fromValue(GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification.fromMap((map['launchTemplateSpecification']! as Map).cast<String, dynamic>())),
      overrides: (() { final guardedValue = map['overrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GroupMixedInstancesPolicyLaunchTemplateOverride>(guardedValue, (value) => GroupMixedInstancesPolicyLaunchTemplateOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
