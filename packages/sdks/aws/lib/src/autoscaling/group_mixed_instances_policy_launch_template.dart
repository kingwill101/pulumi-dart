...
class GroupMixedInstancesPolicyLaunchTemplate {
  ...
  final pulumi.Input<List<GroupMixedInstancesPolicyLaunchTemplateOverride>>?
  overrides;
    ...
    return <String, dynamic>{
      'launchTemplateSpecification':
          pulumi.Input.mapInputValue<
            GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification,
            Map<String, dynamic>
          >(launchTemplateSpecification, (value) => value.toMap()),
      'overrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<GroupMixedInstancesPolicyLaunchTemplateOverride>,
  ...
  factory GroupMixedInstancesPolicyLaunchTemplate.fromMap(
    ...
    return GroupMixedInstancesPolicyLaunchTemplate(
      launchTemplateSpecification: pulumi.Input.fromValue(
        GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification.fromMap(
      ...
      overrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GroupMixedInstancesPolicyLaunchTemplateOverride.fromMap(
