...
class GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirement {
  ...
  factory GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirement.fromMap(Map<String, dynamic> map) {
    return GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirement(
      ...
      maxSpotPriceAsPercentageOfOptimalOnDemandPrice: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['maxSpotPriceAsPercentageOfOptimalOnDemandPrice'])),
      ...
      onDemandMaxPricePercentageOverLowestPrice: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['onDemandMaxPricePercentageOverLowestPrice'])),
      requireHibernateSupport: pulumi.Input.fromValue(map['requireHibernateSupport'] as bool),
      spotMaxPricePercentageOverLowestPrice: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['spotMaxPricePercentageOverLowestPrice'])),
