...
class GroupState {
  ...
  GroupState({
    ...
    pulumi.Output<int>? predictedCapacity,
    ...
    pulumi.Output<int>? warmPoolSize,
  }) :
      ...
      predictedCapacity = pulumi.Input.asOptionalInput<int>(predictedCapacity),
      ...
      warmPoolSize = pulumi.Input.asOptionalInput<int>(warmPoolSize);
  ...
  factory GroupState.fromMap(Map<String, dynamic> map) {
    return GroupState(
      ...
      predictedCapacity: map['predictedCapacity'] == null ? null : pulumi.Output.create<int>(map['predictedCapacity'] as int),
      ...
      warmPoolSize: map['warmPoolSize'] == null ? null : pulumi.Output.create<int>(map['warmPoolSize'] as int),
    );
  }
}
