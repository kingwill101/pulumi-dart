...
class GroupState {
  ...
  factory GroupState.fromMap(Map<String, dynamic> map) {
    return GroupState(
      ...
      predictedCapacity: (() { final guardedValue = map['predictedCapacity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      warmPoolSize: (() { final guardedValue = map['warmPoolSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
