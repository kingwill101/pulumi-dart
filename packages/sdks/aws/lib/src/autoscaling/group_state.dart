...
class GroupState {
  ...
  factory GroupState.fromMap(Map<String, dynamic> map) {
    return GroupState(
      ...
      predictedCapacity: map['predictedCapacity'] == null ? null : (map['predictedCapacity'] as int).input(),
      ...
      warmPoolSize: map['warmPoolSize'] == null ? null : (map['warmPoolSize'] as int).input(),
    );
  }
}
