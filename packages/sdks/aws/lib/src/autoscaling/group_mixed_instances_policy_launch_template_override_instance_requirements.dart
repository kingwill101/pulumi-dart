...
class GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements {
  ...
  factory GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements.fromMap(Map<String, dynamic> map) {
    return GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements(
      acceleratorCount: map['acceleratorCount'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsAcceleratorCount.fromMap((map['acceleratorCount'] as Map).cast<String, dynamic>())).input(),
      ...
      acceleratorTotalMemoryMib: map['acceleratorTotalMemoryMib'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsAcceleratorTotalMemoryMib.fromMap((map['acceleratorTotalMemoryMib'] as Map).cast<String, dynamic>())).input(),
      ...
      baselineEbsBandwidthMbps: map['baselineEbsBandwidthMbps'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsBaselineEbsBandwidthMbps.fromMap((map['baselineEbsBandwidthMbps'] as Map).cast<String, dynamic>())).input(),
      ...
      memoryGibPerVcpu: map['memoryGibPerVcpu'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryGibPerVcpu.fromMap((map['memoryGibPerVcpu'] as Map).cast<String, dynamic>())).input(),
      memoryMib: map['memoryMib'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryMib.fromMap((map['memoryMib'] as Map).cast<String, dynamic>())).input(),
      networkBandwidthGbps: map['networkBandwidthGbps'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsNetworkBandwidthGbps.fromMap((map['networkBandwidthGbps'] as Map).cast<String, dynamic>())).input(),
      networkInterfaceCount: map['networkInterfaceCount'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsNetworkInterfaceCount.fromMap((map['networkInterfaceCount'] as Map).cast<String, dynamic>())).input(),
      ...
      totalLocalStorageGb: map['totalLocalStorageGb'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsTotalLocalStorageGb.fromMap((map['totalLocalStorageGb'] as Map).cast<String, dynamic>())).input(),
      vcpuCount: map['vcpuCount'] == null ? null : (GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsVcpuCount.fromMap((map['vcpuCount'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
