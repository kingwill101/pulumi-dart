...
class GroupInstanceRefreshPreferences {
  ...
  final pulumi.Input<GroupInstanceRefreshPreferencesAlarmSpecification>?
  alarmSpecification;
    ...
    return <String, dynamic>{
      'alarmSpecification':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(alarmSpecification, (value) => value.toMap()),
  ...
  factory GroupInstanceRefreshPreferences.fromMap(Map<String, dynamic> map) {
    return GroupInstanceRefreshPreferences(
      alarmSpecification: (() {
        final guardedValue = map['alarmSpecification'];
      ...
      autoRollback: (() {
        final guardedValue = map['autoRollback'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      checkpointDelay: (() {
        final guardedValue = map['checkpointDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      checkpointPercentages: (() {
        final guardedValue = map['checkpointPercentages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<int>());
      })(),
      instanceWarmup: (() {
        final guardedValue = map['instanceWarmup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      scaleInProtectedInstances: (() {
        final guardedValue = map['scaleInProtectedInstances'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      skipMatching: (() {
      ...
      standbyInstances: (() {
        final guardedValue = map['standbyInstances'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
