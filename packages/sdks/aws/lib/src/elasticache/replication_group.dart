...
class ReplicationGroup extends pulumi.CustomResource {
  ...
  ReplicationGroup(
    ...
    this.atRestEncryptionEnabled = registerOutput<bool>('atRestEncryptionEnabled');
    this.authToken = registerOutput<String?>('authToken');
    this.authTokenUpdateStrategy = registerOutput<String?>('authTokenUpdateStrategy');
    ...
    this.configurationEndpointAddress = registerOutput<String>('configurationEndpointAddress');
    ...
    this.globalReplicationGroupId = registerOutput<String>('globalReplicationGroupId');
    this.ipDiscovery = registerOutput<String>('ipDiscovery');
    this.kmsKeyId = registerOutput<String?>('kmsKeyId');
    this.logDeliveryConfigurations = registerOutput<List<ReplicationGroupLogDeliveryConfiguration>?>('logDeliveryConfigurations');
    ...
    this.nodeGroupConfigurations = registerOutput<List<ReplicationGroupNodeGroupConfiguration>>('nodeGroupConfigurations');
    ...
    this.preferredCacheClusterAzs = registerOutput<List<String>?>('preferredCacheClusterAzs');
    this.primaryEndpointAddress = registerOutput<String>('primaryEndpointAddress');
    this.readerEndpointAddress = registerOutput<String>('readerEndpointAddress');
