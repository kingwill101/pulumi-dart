...
class ReplicationGroup extends pulumi.CustomResource {
  ...
  ReplicationGroup(
    ...
    authTokenUpdateStrategy = registerOutput<String?>(
    ...
    configurationEndpointAddress = registerOutput<String>(
    ...
    globalReplicationGroupId = registerOutput<String>(
      'globalReplicationGroupId',
    );
    ipDiscovery = registerOutput<String>('ipDiscovery');
    kmsKeyId = registerOutput<String?>('kmsKeyId');
    logDeliveryConfigurations = registerOutput<List<Map<String, dynamic>>?>(
      'logDeliveryConfigurations',
    );
    ...
    nodeGroupConfigurations = registerOutput<List<Map<String, dynamic>>>(
      'nodeGroupConfigurations',
    );
    ...
    preferredCacheClusterAzs = registerOutput<List<String>?>(
      'preferredCacheClusterAzs',
    );
