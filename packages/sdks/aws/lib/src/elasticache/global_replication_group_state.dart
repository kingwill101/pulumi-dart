...
class GlobalReplicationGroupState {
  ...
  GlobalReplicationGroupState({
    ...
    pulumi.Output<bool>? authTokenEnabled,
    ...
    pulumi.Output<List<GlobalReplicationGroupGlobalNodeGroup>>? globalNodeGroups,
    pulumi.Output<String>? globalReplicationGroupDescription,
    pulumi.Output<String>? globalReplicationGroupId,
    pulumi.Output<String>? globalReplicationGroupIdSuffix,
    pulumi.Output<int>? numNodeGroups,
    pulumi.Output<String>? parameterGroupName,
    pulumi.Output<String>? primaryReplicationGroupId,
    ...
    pulumi.Output<bool>? transitEncryptionEnabled,
      ...
      authTokenEnabled = pulumi.Input.asOptionalInput<bool>(authTokenEnabled),
      ...
      globalNodeGroups = pulumi.Input.asOptionalInput<List<GlobalReplicationGroupGlobalNodeGroup>>(globalNodeGroups),
      ...
      globalReplicationGroupIdSuffix = pulumi.Input.asOptionalInput<String>(globalReplicationGroupIdSuffix),
      ...
      primaryReplicationGroupId = pulumi.Input.asOptionalInput<String>(primaryReplicationGroupId),
  ...
  factory GlobalReplicationGroupState.fromMap(Map<String, dynamic> map) {
    return GlobalReplicationGroupState(
      ...
      authTokenEnabled: map['authTokenEnabled'] == null ? null : pulumi.Output.create<bool>(map['authTokenEnabled'] as bool),
      ...
      globalNodeGroups: map['globalNodeGroups'] == null ? null : pulumi.Output.create<List<GlobalReplicationGroupGlobalNodeGroup>>(pulumi.Input.decodeList<GlobalReplicationGroupGlobalNodeGroup>(map['globalNodeGroups'], (value) => GlobalReplicationGroupGlobalNodeGroup.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      globalReplicationGroupIdSuffix: map['globalReplicationGroupIdSuffix'] == null ? null : pulumi.Output.create<String>(map['globalReplicationGroupIdSuffix'] as String),
      ...
      primaryReplicationGroupId: map['primaryReplicationGroupId'] == null ? null : pulumi.Output.create<String>(map['primaryReplicationGroupId'] as String),
