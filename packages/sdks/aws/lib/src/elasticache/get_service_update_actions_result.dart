...
class GetServiceUpdateActionsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'updateActions': ?(() { final guardedValue = updateActions; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetServiceUpdateActionsUpdateAction, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
    };
  }
  ...
  factory GetServiceUpdateActionsResult.fromMap(Map<String, dynamic> map) {
    return GetServiceUpdateActionsResult(
      ...
      updateActions: (() { final guardedValue = map['updateActions']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetServiceUpdateActionsUpdateAction>(guardedValue, (value) => GetServiceUpdateActionsUpdateAction.fromMap((value as Map).cast<String, dynamic>())); })(),
    );
  }
}
