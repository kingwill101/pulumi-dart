...
class ServerlessCacheCacheUsageLimits {
  ...
  final pulumi.Input<List<ServerlessCacheCacheUsageLimitsEcpuPerSecond>>?
  ecpuPerSeconds;
  ...
  ServerlessCacheCacheUsageLimits({this.dataStorage, this.ecpuPerSeconds});
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ecpuPerSeconds':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServerlessCacheCacheUsageLimitsEcpuPerSecond>,
  ...
  factory ServerlessCacheCacheUsageLimits.fromMap(Map<String, dynamic> map) {
    return ServerlessCacheCacheUsageLimits(
      dataStorage: (() {
        final guardedValue = map['dataStorage'];
      ...
      ecpuPerSeconds: (() {
        final guardedValue = map['ecpuPerSeconds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerlessCacheCacheUsageLimitsEcpuPerSecond>(
            guardedValue,
