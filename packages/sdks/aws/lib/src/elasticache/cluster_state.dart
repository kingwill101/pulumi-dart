...
class ClusterState {
    ...
    return <String, dynamic>{
      ...
      'cacheNodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterCacheNode>,
            List<Map<String, dynamic>>
          >(
            cacheNodes,
            (value) =>
                pulumi.Input.encodeList<ClusterCacheNode, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      cacheNodes: (() {
        final guardedValue = map['cacheNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterCacheNode>(
            guardedValue,
            (value) => ClusterCacheNode.fromMap(
      ...
      clusterAddress: (() {
        final guardedValue = map['clusterAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clusterId: (() {
      ...
      configurationEndpoint: (() {
        final guardedValue = map['configurationEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      engine: (() {
      ...
      numCacheNodes: (() {
        final guardedValue = map['numCacheNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      outpostMode: (() {
        final guardedValue = map['outpostMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      parameterGroupName: (() {
      ...
      preferredAvailabilityZones: (() {
        final guardedValue = map['preferredAvailabilityZones'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      preferredOutpostArn: (() {
        final guardedValue = map['preferredOutpostArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
