...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      autoMinorVersionUpgrade: map['autoMinorVersionUpgrade'] == null ? null : (map['autoMinorVersionUpgrade'] as String).input(),
      availabilityZone: map['availabilityZone'] == null ? null : (map['availabilityZone'] as String).input(),
      azMode: map['azMode'] == null ? null : (map['azMode'] as String).input(),
      cacheNodes: map['cacheNodes'] == null ? null : (pulumi.Input.decodeList<ClusterCacheNode>(map['cacheNodes'], (value) => ClusterCacheNode.fromMap((value as Map).cast<String, dynamic>()))).input(),
      clusterAddress: map['clusterAddress'] == null ? null : (map['clusterAddress'] as String).input(),
      clusterId: map['clusterId'] == null ? null : (map['clusterId'] as String).input(),
      configurationEndpoint: map['configurationEndpoint'] == null ? null : (map['configurationEndpoint'] as String).input(),
      ...
      ipDiscovery: map['ipDiscovery'] == null ? null : (map['ipDiscovery'] as String).input(),
      logDeliveryConfigurations: map['logDeliveryConfigurations'] == null ? null : (pulumi.Input.decodeList<ClusterLogDeliveryConfiguration>(map['logDeliveryConfigurations'], (value) => ClusterLogDeliveryConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      numCacheNodes: map['numCacheNodes'] == null ? null : (map['numCacheNodes'] as int).input(),
      outpostMode: map['outpostMode'] == null ? null : (map['outpostMode'] as String).input(),
      parameterGroupName: map['parameterGroupName'] == null ? null : (map['parameterGroupName'] as String).input(),
      port: map['port'] == null ? null : (map['port'] as int).input(),
      preferredAvailabilityZones: map['preferredAvailabilityZones'] == null ? null : ((map['preferredAvailabilityZones'] as List).cast<String>()).input(),
      preferredOutpostArn: map['preferredOutpostArn'] == null ? null : (map['preferredOutpostArn'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      replicationGroupId: map['replicationGroupId'] == null ? null : (map['replicationGroupId'] as String).input(),
      securityGroupIds: map['securityGroupIds'] == null ? null : ((map['securityGroupIds'] as List).cast<String>()).input(),
      snapshotArns: map['snapshotArns'] == null ? null : (map['snapshotArns'] as String).input(),
