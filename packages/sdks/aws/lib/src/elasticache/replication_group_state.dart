...
class ReplicationGroupState {
  ...
  factory ReplicationGroupState.fromMap(Map<String, dynamic> map) {
    return ReplicationGroupState(
      ...
      configurationEndpointAddress: map['configurationEndpointAddress'] == null ? null : ((map['configurationEndpointAddress'] as String).input()).input(),
      ...
      memberClusters: map['memberClusters'] == null ? null : (((map['memberClusters'] as List).cast<String>()).input()).input(),
      ...
      primaryEndpointAddress: map['primaryEndpointAddress'] == null ? null : ((map['primaryEndpointAddress'] as String).input()).input(),
      readerEndpointAddress: map['readerEndpointAddress'] == null ? null : ((map['readerEndpointAddress'] as String).input()).input(),
