...
class ReplicationGroupState {
  ...
  factory ReplicationGroupState.fromMap(Map<String, dynamic> map) {
    return ReplicationGroupState(
      ...
      authTokenUpdateStrategy: map['authTokenUpdateStrategy'] == null ? null : (map['authTokenUpdateStrategy'] as String).input(),
      ...
      configurationEndpointAddress: map['configurationEndpointAddress'] == null ? null : (map['configurationEndpointAddress'] as String).input(),
      dataTieringEnabled: map['dataTieringEnabled'] == null ? null : (map['dataTieringEnabled'] as bool).input(),
      ...
      logDeliveryConfigurations: map['logDeliveryConfigurations'] == null ? null : (pulumi.Input.decodeList<ReplicationGroupLogDeliveryConfiguration>(map['logDeliveryConfigurations'], (value) => ReplicationGroupLogDeliveryConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      maintenanceWindow: map['maintenanceWindow'] == null ? null : (map['maintenanceWindow'] as String).input(),
      memberClusters: map['memberClusters'] == null ? null : ((map['memberClusters'] as List).cast<String>()).input(),
      multiAzEnabled: map['multiAzEnabled'] == null ? null : (map['multiAzEnabled'] as bool).input(),
      networkType: map['networkType'] == null ? null : (map['networkType'] as String).input(),
      nodeGroupConfigurations: map['nodeGroupConfigurations'] == null ? null : (pulumi.Input.decodeList<ReplicationGroupNodeGroupConfiguration>(map['nodeGroupConfigurations'], (value) => ReplicationGroupNodeGroupConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      numCacheClusters: map['numCacheClusters'] == null ? null : (map['numCacheClusters'] as int).input(),
      ...
      preferredCacheClusterAzs: map['preferredCacheClusterAzs'] == null ? null : ((map['preferredCacheClusterAzs'] as List).cast<String>()).input(),
      primaryEndpointAddress: map['primaryEndpointAddress'] == null ? null : (map['primaryEndpointAddress'] as String).input(),
      readerEndpointAddress: map['readerEndpointAddress'] == null ? null : (map['readerEndpointAddress'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      replicasPerNodeGroup: map['replicasPerNodeGroup'] == null ? null : (map['replicasPerNodeGroup'] as int).input(),
      ...
      userGroupIds: map['userGroupIds'] == null ? null : ((map['userGroupIds'] as List).cast<String>()).input(),
    );
  }
}
