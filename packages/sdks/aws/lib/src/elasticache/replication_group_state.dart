  ...
  factory ReplicationGroupState.fromMap(Map<String, dynamic> map) {
    return ReplicationGroupState(
      ...
      configurationEndpointAddress: (() {
        final guardedValue = map['configurationEndpointAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataTieringEnabled: (() {
      ...
      memberClusters: (() {
        final guardedValue = map['memberClusters'];
        if (guardedValue == null) return null;
      ...
      primaryEndpointAddress: (() {
        final guardedValue = map['primaryEndpointAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      readerEndpointAddress: (() {
        final guardedValue = map['readerEndpointAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
