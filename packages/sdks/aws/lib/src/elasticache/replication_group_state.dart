...
class ReplicationGroupState {
  ...
  final pulumi.Input<int?>? authTokenWoVersion;
  ...
  /// [securityGroupIds] IDs of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in a VPC.
  /// [securityGroupNames] Names of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in a VPC.
  ...
  factory ReplicationGroupState.fromMap(Map<String, dynamic> map) {
    return ReplicationGroupState(
      ...
      authTokenWoVersion: (() { final guardedValue = map['authTokenWoVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      configurationEndpointAddress: (() { final guardedValue = map['configurationEndpointAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      memberClusters: (() { final guardedValue = map['memberClusters']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      numCacheClusters: (() { final guardedValue = map['numCacheClusters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      primaryEndpointAddress: (() { final guardedValue = map['primaryEndpointAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      readerEndpointAddress: (() { final guardedValue = map['readerEndpointAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      replicasPerNodeGroup: (() { final guardedValue = map['replicasPerNodeGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
