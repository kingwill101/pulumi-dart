...
class GlobalReplicationGroup extends pulumi.CustomResource {
  ...
  GlobalReplicationGroup(
    ...
    this.globalNodeGroups = registerOutput<List<GlobalReplicationGroupGlobalNodeGroup>>('globalNodeGroups');
    this.globalReplicationGroupDescription = registerOutput<String?>('globalReplicationGroupDescription');
    this.globalReplicationGroupId = registerOutput<String>('globalReplicationGroupId');
    this.globalReplicationGroupIdSuffix = registerOutput<String>('globalReplicationGroupIdSuffix');
    this.numNodeGroups = registerOutput<int>('numNodeGroups');
    this.parameterGroupName = registerOutput<String?>('parameterGroupName');
    this.primaryReplicationGroupId = registerOutput<String>('primaryReplicationGroupId');
