...
class ServerlessCacheTimeouts {
  ...
  /// Creates a new [ServerlessCacheTimeouts].
  ...
  ServerlessCacheTimeouts({this.create, this.delete, this.update});
  ...
  factory ServerlessCacheTimeouts.fromMap(Map<String, dynamic> map) {
    return ServerlessCacheTimeouts(
      create: (() {
