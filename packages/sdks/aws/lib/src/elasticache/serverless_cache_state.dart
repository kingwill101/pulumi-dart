...
class ServerlessCacheState {
  ...
  factory ServerlessCacheState.fromMap(Map<String, dynamic> map) {
    return ServerlessCacheState(
      ...
      endpoints: map['endpoints'] == null ? null : (pulumi.Input.decodeList<ServerlessCacheEndpoint>(map['endpoints'], (value) => ServerlessCacheEndpoint.fromMap((value as Map).cast<String, dynamic>()))).input(),
      engine: map['engine'] == null ? null : (map['engine'] as String).input(),
      fullEngineVersion: map['fullEngineVersion'] == null ? null : (map['fullEngineVersion'] as String).input(),
      kmsKeyId: map['kmsKeyId'] == null ? null : (map['kmsKeyId'] as String).input(),
      majorEngineVersion: map['majorEngineVersion'] == null ? null : (map['majorEngineVersion'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      readerEndpoints: map['readerEndpoints'] == null ? null : (pulumi.Input.decodeList<ServerlessCacheReaderEndpoint>(map['readerEndpoints'], (value) => ServerlessCacheReaderEndpoint.fromMap((value as Map).cast<String, dynamic>()))).input(),
