...
class ServerlessCacheState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'readerEndpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServerlessCacheReaderEndpoint>,
            List<Map<String, dynamic>>
          >(
            readerEndpoints,
            (value) =>
  ...
  factory ServerlessCacheState.fromMap(Map<String, dynamic> map) {
    return ServerlessCacheState(
      ...
      cacheUsageLimits: (() {
        final guardedValue = map['cacheUsageLimits'];
        if (guardedValue == null) return null;
      ...
      dailySnapshotTime: (() {
        final guardedValue = map['dailySnapshotTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      endpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerlessCacheEndpoint>(
            guardedValue,
            (value) => ServerlessCacheEndpoint.fromMap(
      ...
      fullEngineVersion: (() {
        final guardedValue = map['fullEngineVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kmsKeyId: (() {
      ...
      majorEngineVersion: (() {
        final guardedValue = map['majorEngineVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      readerEndpoints: (() {
        final guardedValue = map['readerEndpoints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServerlessCacheReaderEndpoint>(
            guardedValue,
            (value) => ServerlessCacheReaderEndpoint.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      snapshotArnsToRestores: (() {
        final guardedValue = map['snapshotArnsToRestores'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
