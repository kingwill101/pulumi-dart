...
class GetServerlessCacheCacheUsageLimits {
  ...
  final pulumi.Input<GetServerlessCacheCacheUsageLimitsEcpuPerSecond> ecpuPerSecond;
  ...
  /// [ecpuPerSecond] The configured number of ElastiCache Processing Units (ECPU) the cache can consume per second. See `ecpuPerSecond` Block for details.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataStorage': pulumi.Input.mapInputValue<GetServerlessCacheCacheUsageLimitsDataStorage, Map<String, dynamic>>(dataStorage, (value) => value.toMap()),
      'ecpuPerSecond': pulumi.Input.mapInputValue<GetServerlessCacheCacheUsageLimitsEcpuPerSecond, Map<String, dynamic>>(ecpuPerSecond, (value) => value.toMap()),
    };
  }

  factory GetServerlessCacheCacheUsageLimits.fromMap(Map<String, dynamic> map) {
    return GetServerlessCacheCacheUsageLimits(
      dataStorage: pulumi.Input.fromValue(GetServerlessCacheCacheUsageLimitsDataStorage.fromMap((map['dataStorage']! as Map).cast<String, dynamic>())),
      ecpuPerSecond: pulumi.Input.fromValue(GetServerlessCacheCacheUsageLimitsEcpuPerSecond.fromMap((map['ecpuPerSecond']! as Map).cast<String, dynamic>())),
    );
  }
}
