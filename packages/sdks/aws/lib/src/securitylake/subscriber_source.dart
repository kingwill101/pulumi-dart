...
class SubscriberSource {
  ...
  /// [awsLogSourceResource] Amazon Security Lake supports log and event collection for natively supported AWS services. See `awsLogSourceResource` Block below.
  /// [customLogSourceResource] Amazon Security Lake supports custom source types. See `customLogSourceResource` Block below.
  ...
  factory SubscriberSource.fromMap(Map<String, dynamic> map) {
    return SubscriberSource(
      awsLogSourceResource: (() { final guardedValue = map['awsLogSourceResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubscriberSourceAwsLogSourceResource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      customLogSourceResource: (() { final guardedValue = map['customLogSourceResource']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SubscriberSourceCustomLogSourceResource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
