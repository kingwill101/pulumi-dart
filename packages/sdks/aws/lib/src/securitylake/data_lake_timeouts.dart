...
class DataLakeTimeouts {
  ...
  /// Creates a new [DataLakeTimeouts].
  ...
  DataLakeTimeouts({this.create, this.delete, this.update});
  ...
  factory DataLakeTimeouts.fromMap(Map<String, dynamic> map) {
    return DataLakeTimeouts(
      create: (() {
