...
class DataLakeConfiguration {
  ...
  final pulumi.Input<List<DataLakeConfigurationEncryptionConfiguration>>?
  encryptionConfigurations;

  /// Provides lifecycle details of Amazon Security Lake object.
  final pulumi.Input<DataLakeConfigurationLifecycleConfiguration>?
  ...
  final pulumi.Input<DataLakeConfigurationReplicationConfiguration>?
    ...
    return <String, dynamic>{
      'encryptionConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataLakeConfigurationEncryptionConfiguration>,
    ...
    return DataLakeConfiguration(
      encryptionConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataLakeConfigurationEncryptionConfiguration>(
            guardedValue,
