...
class SubscriberSourceCustomLogSourceResource {
  ...
  final pulumi.Input<List<SubscriberSourceCustomLogSourceResourceAttribute>>?
  attributes;

  /// The details of the log provider for the third-party custom source. See `provider` Block below.
  final pulumi.Input<List<SubscriberSourceCustomLogSourceResourceProvider>>?
  providers;
    ...
    return <String, dynamic>{
      'attributes':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriberSourceCustomLogSourceResourceAttribute>,
      ...
      'providers':
          ?pulumi.Input.mapOptionalInputValue<
            List<SubscriberSourceCustomLogSourceResourceProvider>,
            List<Map<String, dynamic>>
          >(
            providers,
            (value) =>
    ...
    return SubscriberSourceCustomLogSourceResource(
      attributes: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => SubscriberSourceCustomLogSourceResourceAttribute.fromMap(
      ...
      providers: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => SubscriberSourceCustomLogSourceResourceProvider.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
