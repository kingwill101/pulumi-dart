...
class Subscriber extends pulumi.CustomResource {
  ...
  Subscriber(
    ...
    this.subscriberDescription = registerOutput<String?>('subscriberDescription');
    this.subscriberEndpoint = registerOutput<String>('subscriberEndpoint');
    this.subscriberIdentity = registerOutput<SubscriberSubscriberIdentity>('subscriberIdentity');
