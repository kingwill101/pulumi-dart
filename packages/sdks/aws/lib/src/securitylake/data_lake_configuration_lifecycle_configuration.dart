...
class DataLakeConfigurationLifecycleConfiguration {
  ...
  factory DataLakeConfigurationLifecycleConfiguration.fromMap(Map<String, dynamic> map) {
    return DataLakeConfigurationLifecycleConfiguration(
      expiration: (() { final guardedValue = map['expiration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DataLakeConfigurationLifecycleConfigurationExpiration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      transitions: (() { final guardedValue = map['transitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DataLakeConfigurationLifecycleConfigurationTransition>(guardedValue, (value) => DataLakeConfigurationLifecycleConfigurationTransition.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
