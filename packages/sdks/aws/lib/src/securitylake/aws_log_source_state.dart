...
class AwsLogSourceState {
  ...
  factory AwsLogSourceState.fromMap(Map<String, dynamic> map) {
    return AwsLogSourceState(
      ...
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AwsLogSourceSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
