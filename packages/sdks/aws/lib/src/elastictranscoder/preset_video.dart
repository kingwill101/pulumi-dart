...
class PresetVideo {
  ...
  factory PresetVideo.fromMap(Map<String, dynamic> map) {
    return PresetVideo(
      ...
      displayAspectRatio: (() {
        final guardedValue = map['displayAspectRatio'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fixedGop: (() {
        final guardedValue = map['fixedGop'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      frameRate: (() {
        final guardedValue = map['frameRate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      keyframesMaxDist: (() {
        final guardedValue = map['keyframesMaxDist'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxFrameRate: (() {
        final guardedValue = map['maxFrameRate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxHeight: (() {
