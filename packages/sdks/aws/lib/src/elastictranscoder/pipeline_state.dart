...
class PipelineState {
  ...
  factory PipelineState.fromMap(Map<String, dynamic> map) {
    return PipelineState(
      ...
      awsKmsKeyArn: (() {
        final guardedValue = map['awsKmsKeyArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      contentConfig: (() {
      ...
      contentConfigPermissions: (() {
        final guardedValue = map['contentConfigPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      inputBucket: (() {
        final guardedValue = map['inputBucket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      outputBucket: (() {
        final guardedValue = map['outputBucket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      thumbnailConfig: (() {
        final guardedValue = map['thumbnailConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      thumbnailConfigPermissions: (() {
        final guardedValue = map['thumbnailConfigPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
