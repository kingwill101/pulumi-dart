...
class RepositoryAssociationState {
  ...
  factory RepositoryAssociationState.fromMap(Map<String, dynamic> map) {
    return RepositoryAssociationState(
      ...
      repository: (() { final guardedValue = map['repository']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepositoryAssociationRepository.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      s3RepositoryDetails: (() { final guardedValue = map['s3RepositoryDetails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RepositoryAssociationS3RepositoryDetail>(guardedValue, (value) => RepositoryAssociationS3RepositoryDetail.fromMap((value as Map).cast<String, dynamic>()))); })(),
