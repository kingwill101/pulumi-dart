...
class RepositoryAssociationRepository {
  ...
  factory RepositoryAssociationRepository.fromMap(Map<String, dynamic> map) {
    return RepositoryAssociationRepository(
      bitbucket: (() { final guardedValue = map['bitbucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepositoryAssociationRepositoryBitbucket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      codecommit: (() { final guardedValue = map['codecommit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepositoryAssociationRepositoryCodecommit.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      githubEnterpriseServer: (() { final guardedValue = map['githubEnterpriseServer']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepositoryAssociationRepositoryGithubEnterpriseServer.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      s3Bucket: (() { final guardedValue = map['s3Bucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RepositoryAssociationRepositoryS3Bucket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
