...
class MembershipState {
  ...
  factory MembershipState.fromMap(Map<String, dynamic> map) {
    return MembershipState(
      ...
      collaborationArn: (() { final guardedValue = map['collaborationArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      collaborationCreatorAccountId: (() { final guardedValue = map['collaborationCreatorAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      collaborationCreatorDisplayName: (() { final guardedValue = map['collaborationCreatorDisplayName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      collaborationId: (() { final guardedValue = map['collaborationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      collaborationName: (() { final guardedValue = map['collaborationName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      memberAbilities: (() { final guardedValue = map['memberAbilities']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
