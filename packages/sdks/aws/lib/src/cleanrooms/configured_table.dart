...
import 'configured_table_state.dart';
...
class ConfiguredTable extends pulumi.CustomResource {
  ...
  /// Gets an existing [ConfiguredTable] resource's state with the given [name] and [id].
  static ConfiguredTable get(
    String name,
