...
class GetPlanStageTarget {
  final pulumi.Input<List<GetPlanStageTargetChannelTargetInfo>>
  channelTargetInfos;
  final pulumi.Input<List<GetPlanStageTargetContactTargetInfo>>
  contactTargetInfos;
    ...
    return <String, dynamic>{
      'channelTargetInfos':
          pulumi.Input.mapInputValue<
            List<GetPlanStageTargetChannelTargetInfo>,
      ...
      'contactTargetInfos':
          pulumi.Input.mapInputValue<
            List<GetPlanStageTargetContactTargetInfo>,
            List<Map<String, dynamic>>
          >(
            contactTargetInfos,
            (value) =>
  ...
  factory GetPlanStageTarget.fromMap(Map<String, dynamic> map) {
    return GetPlanStageTarget(
      channelTargetInfos: pulumi.Input.fromValue(
      ...
      contactTargetInfos: pulumi.Input.fromValue(
