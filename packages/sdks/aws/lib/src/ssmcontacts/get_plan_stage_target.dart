...
class GetPlanStageTarget {
  ...
  factory GetPlanStageTarget.fromMap(Map<String, dynamic> map) {
    return GetPlanStageTarget(
      channelTargetInfos: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPlanStageTargetChannelTargetInfo>(map['channelTargetInfos']!, (value) => GetPlanStageTargetChannelTargetInfo.fromMap((value as Map).cast<String, dynamic>()))),
      contactTargetInfos: pulumi.Input.fromValue(pulumi.Input.decodeList<GetPlanStageTargetContactTargetInfo>(map['contactTargetInfos']!, (value) => GetPlanStageTargetContactTargetInfo.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
