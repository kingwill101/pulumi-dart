...
class PlanStageTarget {
  ...
  PlanStageTarget({this.channelTargetInfo, this.contactTargetInfo});
    ...
    return <String, dynamic>{
      'channelTargetInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(channelTargetInfo, (value) => value.toMap()),
      'contactTargetInfo':
          ?pulumi.Input.mapOptionalInputValue<
            PlanStageTargetContactTargetInfo,
            Map<String, dynamic>
          >(contactTargetInfo, (value) => value.toMap()),
    };
  }
  ...
  factory PlanStageTarget.fromMap(Map<String, dynamic> map) {
    return PlanStageTarget(
      channelTargetInfo: (() {
        final guardedValue = map['channelTargetInfo'];
      ...
      contactTargetInfo: (() {
        final guardedValue = map['contactTargetInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
