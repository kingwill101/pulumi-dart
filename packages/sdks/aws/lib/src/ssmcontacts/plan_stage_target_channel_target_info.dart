...
class PlanStageTargetChannelTargetInfo {
  ...
  factory PlanStageTargetChannelTargetInfo.fromMap(Map<String, dynamic> map) {
    return PlanStageTargetChannelTargetInfo(
      ...
      retryIntervalInMinutes: (() { final guardedValue = map['retryIntervalInMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
    );
  }
}
