...
class UserProfileDetail {
  ...
  factory UserProfileDetail.fromMap(Map<String, dynamic> map) {
    return UserProfileDetail(
      iams: pulumi.Input.fromValue(
        pulumi.Input.decodeList<UserProfileDetailIam>(
          map['iams']!,
      ...
      ssos: pulumi.Input.fromValue(
        pulumi.Input.decodeList<UserProfileDetailSso>(
          map['ssos']!,
