...
class UserProfileDetail {
  ...
  factory UserProfileDetail.fromMap(Map<String, dynamic> map) {
    return UserProfileDetail(
      iams: pulumi.Input.fromValue(pulumi.Input.decodeList<UserProfileDetailIam>(map['iams']!, (value) => UserProfileDetailIam.fromMap((value as Map).cast<String, dynamic>()))),
      ssos: pulumi.Input.fromValue(pulumi.Input.decodeList<UserProfileDetailSso>(map['ssos']!, (value) => UserProfileDetailSso.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
