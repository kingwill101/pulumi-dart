...
class GlossaryTermArgs {
    ...
    return <String, dynamic>{
      ...
      'termRelations':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(termRelations, (value) => value.toMap()),
      'timeouts':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory GlossaryTermArgs.fromMap(Map<String, dynamic> map) {
    return GlossaryTermArgs(
      ...
      glossaryIdentifier: pulumi.Input.fromValue(
        map['glossaryIdentifier'] as String,
      ),
      longDescription: (() {
      ...
      termRelations: (() {
        final guardedValue = map['termRelations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GlossaryTermTermRelations.fromMap(
