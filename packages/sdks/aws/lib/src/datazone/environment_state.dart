...
class EnvironmentState {
  ...
  factory EnvironmentState.fromMap(Map<String, dynamic> map) {
    return EnvironmentState(
      ...
      lastDeployments: map['lastDeployments'] == null ? null : ((pulumi.Input.decodeList<EnvironmentLastDeployment>(map['lastDeployments']!, (value) => EnvironmentLastDeployment.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      profileIdentifier: map['profileIdentifier'] == null ? null : ((map['profileIdentifier'] as String).input()).input(),
      projectIdentifier: map['projectIdentifier'] == null ? null : ((map['projectIdentifier'] as String).input()).input(),
      providerEnvironment: map['providerEnvironment'] == null ? null : ((map['providerEnvironment'] as String).input()).input(),
      provisionedResources: map['provisionedResources'] == null ? null : ((pulumi.Input.decodeList<EnvironmentProvisionedResource>(map['provisionedResources']!, (value) => EnvironmentProvisionedResource.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
