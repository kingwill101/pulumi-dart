...
class EnvironmentState {
  ...
  final pulumi.Input<List<EnvironmentProvisionedResource>>?
    ...
    return <String, dynamic>{
      ...
      'lastDeployments':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnvironmentLastDeployment>,
      ...
      'provisionedResources':
          ?pulumi.Input.mapOptionalInputValue<
            List<EnvironmentProvisionedResource>,
            List<Map<String, dynamic>>
          >(
            provisionedResources,
            (value) =>
  ...
  factory EnvironmentState.fromMap(Map<String, dynamic> map) {
    return EnvironmentState(
      accountIdentifier: (() {
        final guardedValue = map['accountIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      accountRegion: (() {
        final guardedValue = map['accountRegion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      blueprintIdentifier: (() {
        final guardedValue = map['blueprintIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      createdAt: (() {
      ...
      glossaryTerms: (() {
        final guardedValue = map['glossaryTerms'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      lastDeployments: (() {
        final guardedValue = map['lastDeployments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentLastDeployment>(
            guardedValue,
            (value) => EnvironmentLastDeployment.fromMap(
      ...
      profileIdentifier: (() {
        final guardedValue = map['profileIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      projectIdentifier: (() {
      ...
      providerEnvironment: (() {
        final guardedValue = map['providerEnvironment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      provisionedResources: (() {
        final guardedValue = map['provisionedResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EnvironmentProvisionedResource>(
            guardedValue,
            (value) => EnvironmentProvisionedResource.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
