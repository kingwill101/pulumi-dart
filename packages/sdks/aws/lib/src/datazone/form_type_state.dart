...
class FormTypeState {
  ...
  factory FormTypeState.fromMap(Map<String, dynamic> map) {
    return FormTypeState(
      ...
      imports: (() { final guardedValue = map['imports']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FormTypeImport>(guardedValue, (value) => FormTypeImport.fromMap((value as Map).cast<String, dynamic>()))); })(),
      model: (() { final guardedValue = map['model']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FormTypeModel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      originDomainId: (() { final guardedValue = map['originDomainId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      originProjectId: (() { final guardedValue = map['originProjectId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
