...
class DomainState {
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      domainExecutionRole: map['domainExecutionRole'] == null ? null : ((map['domainExecutionRole'] as String).input()).input(),
      ...
      portalUrl: map['portalUrl'] == null ? null : ((map['portalUrl'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      rootDomainUnitId: map['rootDomainUnitId'] == null ? null : ((map['rootDomainUnitId'] as String).input()).input(),
