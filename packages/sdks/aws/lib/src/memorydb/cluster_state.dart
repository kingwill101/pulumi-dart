...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      aclName: map['aclName'] == null ? null : ((map['aclName'] as String).input()).input(),
      ...
      enginePatchVersion: map['enginePatchVersion'] == null ? null : ((map['enginePatchVersion'] as String).input()).input(),
      ...
      shards: map['shards'] == null ? null : ((pulumi.Input.decodeList<ClusterShard>(map['shards']!, (value) => ClusterShard.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
