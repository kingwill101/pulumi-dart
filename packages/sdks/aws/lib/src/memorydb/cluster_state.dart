...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      enginePatchVersion: map['enginePatchVersion'] == null ? null : (map['enginePatchVersion'] as String).input(),
      ...
      shards: map['shards'] == null ? null : (pulumi.Input.decodeList<ClusterShard>(map['shards'], (value) => ClusterShard.fromMap((value as Map).cast<String, dynamic>()))).input(),
