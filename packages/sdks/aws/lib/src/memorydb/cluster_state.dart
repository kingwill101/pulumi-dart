...
class ClusterState {
    ...
    return <String, dynamic>{
      ...
      'shards':
          ...
          >(
            shards,
            (value) =>
                pulumi.Input.encodeList<ClusterShard, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      enginePatchVersion: (() {
        final guardedValue = map['enginePatchVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      engineVersion: (() {
      ...
      shards: (() {
        final guardedValue = map['shards'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterShard>(
            guardedValue,
            (value) =>
                ClusterShard.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      snapshotArns: (() {
