...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      dataTiering: map['dataTiering'] == null ? null : (map['dataTiering'] as bool).input(),
      ...
      numReplicasPerShard: map['numReplicasPerShard'] == null ? null : (map['numReplicasPerShard'] as int).input(),
      ...
      snapshotArns: map['snapshotArns'] == null ? null : ((map['snapshotArns'] as List).cast<String>()).input(),
