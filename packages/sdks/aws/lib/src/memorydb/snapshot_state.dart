...
class SnapshotState {
  ...
  factory SnapshotState.fromMap(Map<String, dynamic> map) {
    return SnapshotState(
      ...
      clusterConfigurations: (() { final guardedValue = map['clusterConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SnapshotClusterConfiguration>(guardedValue, (value) => SnapshotClusterConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
