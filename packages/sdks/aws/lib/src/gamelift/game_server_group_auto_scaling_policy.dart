...
class GameServerGroupAutoScalingPolicy {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'targetTrackingConfiguration': pulumi.Input.mapInputValue<GameServerGroupAutoScalingPolicyTargetTrackingConfiguration, Map<String, dynamic>>(targetTrackingConfiguration, (value) => value.toMap()),
    };
  }
