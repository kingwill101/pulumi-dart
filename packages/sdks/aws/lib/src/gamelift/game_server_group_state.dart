...
class GameServerGroupState {
  ...
  GameServerGroupState({
    ...
    pulumi.Output<String>? autoScalingGroupArn,
    pulumi.Output<GameServerGroupAutoScalingPolicy>? autoScalingPolicy,
    pulumi.Output<String>? balancingStrategy,
    pulumi.Output<String>? gameServerGroupName,
    pulumi.Output<String>? gameServerProtectionPolicy,
    pulumi.Output<List<GameServerGroupInstanceDefinition>>? instanceDefinitions,
    pulumi.Output<GameServerGroupLaunchTemplate>? launchTemplate,
    ...
    pulumi.Output<List<String>>? vpcSubnets,
      ...
      autoScalingGroupArn = pulumi.Input.asOptionalInput<String>(autoScalingGroupArn),
      ...
      gameServerGroupName = pulumi.Input.asOptionalInput<String>(gameServerGroupName),
      gameServerProtectionPolicy = pulumi.Input.asOptionalInput<String>(gameServerProtectionPolicy),
      instanceDefinitions = pulumi.Input.asOptionalInput<List<GameServerGroupInstanceDefinition>>(instanceDefinitions),
      launchTemplate = pulumi.Input.asOptionalInput<GameServerGroupLaunchTemplate>(launchTemplate),
  ...
  factory GameServerGroupState.fromMap(Map<String, dynamic> map) {
    return GameServerGroupState(
      ...
      autoScalingGroupArn: map['autoScalingGroupArn'] == null ? null : pulumi.Output.create<String>(map['autoScalingGroupArn'] as String),
      ...
      gameServerGroupName: map['gameServerGroupName'] == null ? null : pulumi.Output.create<String>(map['gameServerGroupName'] as String),
      ...
      instanceDefinitions: map['instanceDefinitions'] == null ? null : pulumi.Output.create<List<GameServerGroupInstanceDefinition>>(pulumi.Input.decodeList<GameServerGroupInstanceDefinition>(map['instanceDefinitions'], (value) => GameServerGroupInstanceDefinition.fromMap((value as Map).cast<String, dynamic>()))),
      launchTemplate: map['launchTemplate'] == null ? null : pulumi.Output.create<GameServerGroupLaunchTemplate>(GameServerGroupLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>())),
