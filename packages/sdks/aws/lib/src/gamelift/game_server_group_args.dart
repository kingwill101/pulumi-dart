...
class GameServerGroupArgs {
  ...
  factory GameServerGroupArgs.fromMap(Map<String, dynamic> map) {
    return GameServerGroupArgs(
      ...
      gameServerGroupName: pulumi.Input.fromValue(map['gameServerGroupName'] as String),
      ...
      instanceDefinitions: pulumi.Input.fromValue(pulumi.Input.decodeList<GameServerGroupInstanceDefinition>(map['instanceDefinitions']!, (value) => GameServerGroupInstanceDefinition.fromMap((value as Map).cast<String, dynamic>()))),
      launchTemplate: pulumi.Input.fromValue(GameServerGroupLaunchTemplate.fromMap((map['launchTemplate']! as Map).cast<String, dynamic>())),
