...
class FleetRuntimeConfiguration {
  ...
  final pulumi.Input<List<FleetRuntimeConfigurationServerProcess>>?
  serverProcesses;
    ...
    return <String, dynamic>{
      ...
      'serverProcesses':
          ?pulumi.Input.mapOptionalInputValue<
            List<FleetRuntimeConfigurationServerProcess>,
  ...
  factory FleetRuntimeConfiguration.fromMap(Map<String, dynamic> map) {
    return FleetRuntimeConfiguration(
      gameSessionActivationTimeoutSeconds: (() {
        final guardedValue = map['gameSessionActivationTimeoutSeconds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxConcurrentGameSessionActivations: (() {
        final guardedValue = map['maxConcurrentGameSessionActivations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      serverProcesses: (() {
        final guardedValue = map['serverProcesses'];
        if (guardedValue == null) return null;
