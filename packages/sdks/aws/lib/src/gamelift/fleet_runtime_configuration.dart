...
class FleetRuntimeConfiguration {
  ...
  factory FleetRuntimeConfiguration.fromMap(Map<String, dynamic> map) {
    return FleetRuntimeConfiguration(
      gameSessionActivationTimeoutSeconds: (() { final guardedValue = map['gameSessionActivationTimeoutSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      maxConcurrentGameSessionActivations: (() { final guardedValue = map['maxConcurrentGameSessionActivations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
