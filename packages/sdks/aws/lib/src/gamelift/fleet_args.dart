...
class FleetArgs {
    ...
    return <String, dynamic>{
      ...
      'certificateConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(certificateConfiguration, (value) => value.toMap()),
      'description': ?description,
      'ec2InboundPermissions':
          ?pulumi.Input.mapOptionalInputValue<
            List<FleetEc2InboundPermission>,
      ...
      'resourceCreationLimitPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(resourceCreationLimitPolicy, (value) => value.toMap()),
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      certificateConfiguration: (() {
        final guardedValue = map['certificateConfiguration'];
        if (guardedValue == null) return null;
      ...
      ec2InboundPermissions: (() {
        final guardedValue = map['ec2InboundPermissions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      instanceRoleArn: (() {
        final guardedValue = map['instanceRoleArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      metricGroups: (() {
        final guardedValue = map['metricGroups'];
        if (guardedValue == null) return null;
      ...
      newGameSessionProtectionPolicy: (() {
        final guardedValue = map['newGameSessionProtectionPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      resourceCreationLimitPolicy: (() {
        final guardedValue = map['resourceCreationLimitPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      runtimeConfiguration: (() {
        final guardedValue = map['runtimeConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      scriptId: (() {
        final guardedValue = map['scriptId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
