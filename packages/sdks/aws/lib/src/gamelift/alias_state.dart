...
class AliasState {
  ...
  factory AliasState.fromMap(Map<String, dynamic> map) {
    return AliasState(
      ...
      routingStrategy: (() { final guardedValue = map['routingStrategy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AliasRoutingStrategy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
