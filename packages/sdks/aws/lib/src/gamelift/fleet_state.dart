...
class FleetState {
  ...
  factory FleetState.fromMap(Map<String, dynamic> map) {
    return FleetState(
      ...
      buildArn: map['buildArn'] == null ? null : (map['buildArn'] as String).input(),
      ...
      ec2InstanceType: map['ec2InstanceType'] == null ? null : (map['ec2InstanceType'] as String).input(),
      ...
      logPaths: map['logPaths'] == null ? null : ((map['logPaths'] as List).cast<String>()).input(),
      ...
      scriptArn: map['scriptArn'] == null ? null : (map['scriptArn'] as String).input(),
