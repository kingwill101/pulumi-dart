...
class InvocationJobTimeouts {
  ...
  /// Creates a new [InvocationJobTimeouts].
  ...
  factory InvocationJobTimeouts.fromMap(Map<String, dynamic> map) {
    return InvocationJobTimeouts(
