...
import 'invocation_logging_configuration_state.dart';
...
class InvocationLoggingConfiguration extends pulumi.CustomResource {
  ...
  /// Creates a new [InvocationLoggingConfiguration].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [InvocationLoggingConfiguration]. {@macro pulumi_bedrockmodel_invocation_logging_configuration_invocation_logging_configuration_args_doc}
  ...
  static InvocationLoggingConfiguration get(
    String name,
  ...
  InvocationLoggingConfiguration._get(
    String name, {
