...
class InvocationLoggingConfigurationLoggingConfig {
  ...
  factory InvocationLoggingConfigurationLoggingConfig.fromMap(Map<String, dynamic> map) {
    return InvocationLoggingConfigurationLoggingConfig(
      cloudwatchConfig: (() { final guardedValue = map['cloudwatchConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InvocationLoggingConfigurationLoggingConfigCloudwatchConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      embeddingDataDeliveryEnabled: (() { final guardedValue = map['embeddingDataDeliveryEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      imageDataDeliveryEnabled: (() { final guardedValue = map['imageDataDeliveryEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      s3Config: (() { final guardedValue = map['s3Config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InvocationLoggingConfigurationLoggingConfigS3Config.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      textDataDeliveryEnabled: (() { final guardedValue = map['textDataDeliveryEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      videoDataDeliveryEnabled: (() { final guardedValue = map['videoDataDeliveryEnabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
