...
class InvocationLoggingConfigurationState {
  ...
  final pulumi.Input<InvocationLoggingConfigurationLoggingConfig>?
  loggingConfig;
  ...
  InvocationLoggingConfigurationState({this.loggingConfig, this.region});
  ...
  factory InvocationLoggingConfigurationState.fromMap(
