...
class IntentRejectionStatementMessage {
  ...
  /// Creates a new [IntentRejectionStatementMessage].
  ...
  const IntentRejectionStatementMessage({
  ...
  factory IntentRejectionStatementMessage.fromMap(Map<String, dynamic> map) {
    return IntentRejectionStatementMessage(
