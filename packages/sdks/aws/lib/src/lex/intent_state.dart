...
class IntentState {
  ...
  factory IntentState.fromMap(Map<String, dynamic> map) {
    return IntentState(
      ...
      fulfillmentActivity: (() { final guardedValue = map['fulfillmentActivity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntentFulfillmentActivity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
