...
class V2modelsIntentClosingSettingConditional {
  ...
  final pulumi.Input<
    List<V2modelsIntentClosingSettingConditionalConditionalBranch>
  >?
  conditionalBranches;
  ...
  final pulumi.Input<V2modelsIntentClosingSettingConditionalDefaultBranch>?
  defaultBranch;
      ...
      conditionalBranches: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2modelsIntentClosingSettingConditionalConditionalBranch.fromMap(
