...
class V2modelsIntentClosingSettingNextStepIntentSlot {
  ...
  const V2modelsIntentClosingSettingNextStepIntentSlot({
  ...
  factory V2modelsIntentClosingSettingNextStepIntentSlot.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingNextStepIntentSlot(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentClosingSettingNextStepIntentSlotValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
