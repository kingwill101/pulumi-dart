...
class V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot {
  ...
  final pulumi.Input<V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue>? value;
  ...
  const V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'shape': ?shape,
      'value': ?pulumi.Input.mapOptionalInputValue<V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue, Map<String, dynamic>>(value, (value) => value.toMap()),
    };
  }
  ...
  factory V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
