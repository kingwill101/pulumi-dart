...
class V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction].
  ...
  const V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction(
