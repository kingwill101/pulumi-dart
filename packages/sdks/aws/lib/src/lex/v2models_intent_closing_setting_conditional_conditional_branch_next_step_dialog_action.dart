...
class V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction].
  ...
  const V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.fromMap(Map<String, dynamic> map) {
