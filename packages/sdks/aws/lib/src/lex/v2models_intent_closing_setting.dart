...
class V2modelsIntentClosingSetting {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'active': ?active,
      'closingResponse': ?closingResponse == null ? null : closingResponse!.toMap(),
  ...
  factory V2modelsIntentClosingSetting.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSetting(
      ...
      closingResponse: map['closingResponse'] == null ? null : V2modelsIntentClosingSettingClosingResponse.fromMap((map['closingResponse'] as Map).cast<String, dynamic>()),
      conditional: map['conditional'] == null ? null : V2modelsIntentClosingSettingConditional.fromMap((map['conditional'] as Map).cast<String, dynamic>()),
      nextStep: map['nextStep'] == null ? null : V2modelsIntentClosingSettingNextStep.fromMap((map['nextStep'] as Map).cast<String, dynamic>()),
    );
  }
}
