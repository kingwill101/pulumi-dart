...
class V2modelsIntentClosingSetting {
  ...
  final pulumi.Input<V2modelsIntentClosingSettingClosingResponse>?
  closingResponse;
    ...
    return <String, dynamic>{
      ...
      'closingResponse':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(closingResponse, (value) => value.toMap()),
      'conditional':
          ?pulumi.Input.mapOptionalInputValue<
            V2modelsIntentClosingSettingConditional,
            Map<String, dynamic>
          >(conditional, (value) => value.toMap()),
      'nextStep':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory V2modelsIntentClosingSetting.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSetting(
      ...
      closingResponse: (() {
        final guardedValue = map['closingResponse'];
        if (guardedValue == null) return null;
      ...
      conditional: (() {
        final guardedValue = map['conditional'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
