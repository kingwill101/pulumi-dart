...
class V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue {
  ...
  /// Creates a new [V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue].
  ...
  const V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue({
  ...
  factory V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue(
