...
class BotAliasConversationLogs {
  ...
  factory BotAliasConversationLogs.fromMap(Map<String, dynamic> map) {
    return BotAliasConversationLogs(
      ...
      logSettings: (() { final guardedValue = map['logSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BotAliasConversationLogsLogSetting>(guardedValue, (value) => BotAliasConversationLogsLogSetting.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
