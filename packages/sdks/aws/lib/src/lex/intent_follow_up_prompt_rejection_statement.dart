...
class IntentFollowUpPromptRejectionStatement {
  final pulumi.Input<List<IntentFollowUpPromptRejectionStatementMessage>>
  messages;
    ...
    return <String, dynamic>{
      'messages':
          pulumi.Input.mapInputValue<
            List<IntentFollowUpPromptRejectionStatementMessage>,
  ...
  factory IntentFollowUpPromptRejectionStatement.fromMap(
    ...
    return IntentFollowUpPromptRejectionStatement(
      messages: pulumi.Input.fromValue(
        pulumi.Input.decodeList<IntentFollowUpPromptRejectionStatementMessage>(
          map['messages']!,
