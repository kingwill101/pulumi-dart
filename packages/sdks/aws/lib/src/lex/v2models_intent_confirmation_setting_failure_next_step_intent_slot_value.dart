...
class V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue {
  ...
  /// Creates a new [V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue].
  ...
  const V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue({
  ...
  factory V2modelsIntentConfirmationSettingFailureNextStepIntentSlotValue.fromMap(Map<String, dynamic> map) {
