...
class V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlot {
  ...
  const V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlot({
  ...
  factory V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlot.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlot(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
