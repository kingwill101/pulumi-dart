...
/// {@template pulumi_lex_bot_bot_args_doc}
/// The set of arguments for Bot.
/// {@endtemplate}
/// {@macro pulumi_lex_bot_bot_args_doc}
class BotArgs {
  ...
  BotArgs({
    required pulumi.Output<BotAbortStatement> abortStatement,
    required pulumi.Output<bool> childDirected,
    ...
    required pulumi.Output<List<BotIntent>> intents,
    ...
    pulumi.Output<String>? voiceId,
      ...
      abortStatement = pulumi.Input.asInput<BotAbortStatement>(abortStatement),
      childDirected = pulumi.Input.asInput<bool>(childDirected),
      ...
      intents = pulumi.Input.asInput<List<BotIntent>>(intents),
  ...
  factory BotArgs.fromMap(Map<String, dynamic> map) {
    return BotArgs(
      abortStatement: pulumi.Output.create<BotAbortStatement>(BotAbortStatement.fromMap((map['abortStatement'] as Map).cast<String, dynamic>())),
      childDirected: pulumi.Output.create<bool>(map['childDirected'] as bool),
      ...
      intents: pulumi.Output.create<List<BotIntent>>(pulumi.Input.decodeList<BotIntent>(map['intents'], (value) => BotIntent.fromMap((value as Map).cast<String, dynamic>()))),
