...
class V2modelsSlotState {
  ...
  factory V2modelsSlotState.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotState(
      ...
      multipleValuesSettings: (() {
        final guardedValue = map['multipleValuesSettings'];
        if (guardedValue == null) return null;
      ...
      obfuscationSettings: (() {
        final guardedValue = map['obfuscationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      subSlotSettings: (() {
        final guardedValue = map['subSlotSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      valueElicitationSetting: (() {
        final guardedValue = map['valueElicitationSetting'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          V2modelsSlotValueElicitationSetting.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
