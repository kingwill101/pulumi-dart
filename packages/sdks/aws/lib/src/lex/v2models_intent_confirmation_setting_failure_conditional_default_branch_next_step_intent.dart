...
class V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntent {
  ...
  const V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntent({
    this.name,
    this.slots,
  });
  ...
  factory V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntent.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntent(
      ...
      slots: (() { final guardedValue = map['slots']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntentSlot>(guardedValue, (value) => V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntentSlot.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
