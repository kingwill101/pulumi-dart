...
class V2modelsIntentConfirmationSettingConfirmationConditionalConditionalBranchNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentConfirmationSettingConfirmationConditionalConditionalBranchNextStepDialogAction].
  ...
  const V2modelsIntentConfirmationSettingConfirmationConditionalConditionalBranchNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentConfirmationSettingConfirmationConditionalConditionalBranchNextStepDialogAction.fromMap(Map<String, dynamic> map) {
