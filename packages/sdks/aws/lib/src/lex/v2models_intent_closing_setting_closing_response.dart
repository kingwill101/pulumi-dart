...
class V2modelsIntentClosingSettingClosingResponse {
  ...
  factory V2modelsIntentClosingSettingClosingResponse.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingClosingResponse(
      ...
      messageGroups: (() { final guardedValue = map['messageGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2modelsIntentClosingSettingClosingResponseMessageGroup>(guardedValue, (value) => V2modelsIntentClosingSettingClosingResponseMessageGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
