...
class V2modelsIntentClosingSettingClosingResponse {
  ...
  factory V2modelsIntentClosingSettingClosingResponse.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingClosingResponse(
      ...
      messageGroups: map['messageGroups'] == null ? null : ((pulumi.Input.decodeList<V2modelsIntentClosingSettingClosingResponseMessageGroup>(map['messageGroups']!, (value) => V2modelsIntentClosingSettingClosingResponseMessageGroup.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
