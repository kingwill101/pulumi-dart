...
class V2modelsSlotValueElicitationSettingDefaultValueSpecification {
  ...
  const V2modelsSlotValueElicitationSettingDefaultValueSpecification({
  ...
  factory V2modelsSlotValueElicitationSettingDefaultValueSpecification.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotValueElicitationSettingDefaultValueSpecification(
      defaultValueLists: pulumi.Input.fromValue(pulumi.Input.decodeList<V2modelsSlotValueElicitationSettingDefaultValueSpecificationDefaultValueList>(map['defaultValueLists']!, (value) => V2modelsSlotValueElicitationSettingDefaultValueSpecificationDefaultValueList.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
