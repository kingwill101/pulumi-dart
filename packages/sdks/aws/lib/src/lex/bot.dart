...
class Bot extends pulumi.CustomResource {
  ...
  Bot(
    ...
    this.clarificationPrompt = registerOutput<BotClarificationPrompt?>('clarificationPrompt');
    ...
    this.enableModelImprovements = registerOutput<bool?>('enableModelImprovements');
  ...
  /// Gets an existing [Bot] resource's state with the given [name] and [id].
  static Bot get(
    String name,
