...
class V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntentSlotValue {
  ...
  /// Creates a new [V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntentSlotValue].
  ...
  const V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntentSlotValue({
  ...
  factory V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntentSlotValue.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchNextStepIntentSlotValue(
