...
class V2modelsIntentClosingSettingConditionalConditionalBranchNextStepIntentSlotValue {
  ...
  /// Creates a new [V2modelsIntentClosingSettingConditionalConditionalBranchNextStepIntentSlotValue].
  ...
  const V2modelsIntentClosingSettingConditionalConditionalBranchNextStepIntentSlotValue({
