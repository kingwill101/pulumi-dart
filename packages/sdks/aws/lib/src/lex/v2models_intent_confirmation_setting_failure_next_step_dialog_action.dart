...
class V2modelsIntentConfirmationSettingFailureNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentConfirmationSettingFailureNextStepDialogAction].
  ...
  const V2modelsIntentConfirmationSettingFailureNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentConfirmationSettingFailureNextStepDialogAction.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingFailureNextStepDialogAction(
