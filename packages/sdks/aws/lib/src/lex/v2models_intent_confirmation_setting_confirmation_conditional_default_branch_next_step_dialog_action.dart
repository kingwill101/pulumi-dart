...
class V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchNextStepDialogAction].
  ...
  const V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchNextStepDialogAction.fromMap(Map<String, dynamic> map) {
