...
class V2modelsIntentInitialResponseSettingNextStepIntentSlot {
  ...
  final pulumi.Input<V2modelsIntentInitialResponseSettingNextStepIntentSlotValue>? value;
  ...
  const V2modelsIntentInitialResponseSettingNextStepIntentSlot({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'shape': ?shape,
      'value': ?pulumi.Input.mapOptionalInputValue<V2modelsIntentInitialResponseSettingNextStepIntentSlotValue, Map<String, dynamic>>(value, (value) => value.toMap()),
    };
  }
  ...
  factory V2modelsIntentInitialResponseSettingNextStepIntentSlot.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentInitialResponseSettingNextStepIntentSlot(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingNextStepIntentSlotValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
