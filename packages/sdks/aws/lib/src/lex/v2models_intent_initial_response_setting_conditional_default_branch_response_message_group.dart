    ...
    return V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseMessageGroup(
      message: (() {
        ...
        return pulumi.Input.fromValue(
          V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseMessageGroupMessage.fromMap(
      ...
      variations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseMessageGroupVariation.fromMap(
