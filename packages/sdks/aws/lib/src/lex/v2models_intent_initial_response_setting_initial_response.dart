...
class V2modelsIntentInitialResponseSettingInitialResponse {
  ...
  factory V2modelsIntentInitialResponseSettingInitialResponse.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentInitialResponseSettingInitialResponse(
      ...
      messageGroups: map['messageGroups'] == null ? null : ((pulumi.Input.decodeList<V2modelsIntentInitialResponseSettingInitialResponseMessageGroup>(map['messageGroups']!, (value) => V2modelsIntentInitialResponseSettingInitialResponseMessageGroup.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
