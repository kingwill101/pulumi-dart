...
class V2modelsIntentClosingSettingNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentClosingSettingNextStepDialogAction].
  ...
  const V2modelsIntentClosingSettingNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentClosingSettingNextStepDialogAction.fromMap(Map<String, dynamic> map) {
