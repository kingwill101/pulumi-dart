    ...
    return V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchResponseMessageGroup(
      message: (() {
        ...
        return pulumi.Input.fromValue(
          V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchResponseMessageGroupMessage.fromMap(
      ...
      variations: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchResponseMessageGroupVariation.fromMap(
