...
class V2modelsSlotTypeValueSelectionSetting {
  ...
  final pulumi.Input<
    List<V2modelsSlotTypeValueSelectionSettingAdvancedRecognitionSetting>
  >?
  advancedRecognitionSettings;

  /// Used to validate the value of the slot.
  /// See `regex_filter` argument reference below.
  final pulumi.Input<List<V2modelsSlotTypeValueSelectionSettingRegexFilter>>?
  regexFilters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'regexFilters':
          ?pulumi.Input.mapOptionalInputValue<
            List<V2modelsSlotTypeValueSelectionSettingRegexFilter>,
            List<Map<String, dynamic>>
          >(
            regexFilters,
            (value) =>
  ...
  factory V2modelsSlotTypeValueSelectionSetting.fromMap(
    ...
    return V2modelsSlotTypeValueSelectionSetting(
      advancedRecognitionSettings: (() {
        final guardedValue = map['advancedRecognitionSettings'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2modelsSlotTypeValueSelectionSettingAdvancedRecognitionSetting.fromMap(
      ...
      regexFilters: (() {
        final guardedValue = map['regexFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            V2modelsSlotTypeValueSelectionSettingRegexFilter
          >(
            guardedValue,
            (value) => V2modelsSlotTypeValueSelectionSettingRegexFilter.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      resolutionStrategy: pulumi.Input.fromValue(
        map['resolutionStrategy'] as String,
      ),
    );
  }
}
