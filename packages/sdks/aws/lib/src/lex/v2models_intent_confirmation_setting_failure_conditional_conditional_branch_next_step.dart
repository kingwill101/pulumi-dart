...
class V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStep {
  ...
  factory V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStep.fromMap(
    ...
    return V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStep(
      dialogAction: (() {
        ...
        return pulumi.Input.fromValue(
          V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStepDialogAction.fromMap(
      ...
      intent: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStepIntent.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
