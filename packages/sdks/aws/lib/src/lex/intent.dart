...
class Intent extends pulumi.CustomResource {
  ...
  Intent(
    ...
    this.conclusionStatement = registerOutput<IntentConclusionStatement?>('conclusionStatement');
    this.confirmationPrompt = registerOutput<IntentConfirmationPrompt?>('confirmationPrompt');
    this.createVersion = registerOutput<bool?>('createVersion');
    this.createdDate = registerOutput<String>('createdDate');
    this.description = registerOutput<String?>('description');
    this.dialogCodeHook = registerOutput<IntentDialogCodeHook?>('dialogCodeHook');
    this.followUpPrompt = registerOutput<IntentFollowUpPrompt?>('followUpPrompt');
    this.fulfillmentActivity = registerOutput<IntentFulfillmentActivity>('fulfillmentActivity');
    ...
    this.rejectionStatement = registerOutput<IntentRejectionStatement?>('rejectionStatement');
