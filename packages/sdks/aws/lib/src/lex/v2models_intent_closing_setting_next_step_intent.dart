...
class V2modelsIntentClosingSettingNextStepIntent {
  ...
  const V2modelsIntentClosingSettingNextStepIntent({
    this.name,
    this.slots,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': ?name,
      'slots': ?pulumi.Input.mapOptionalInputValue<List<V2modelsIntentClosingSettingNextStepIntentSlot>, List<Map<String, dynamic>>>(slots, (value) => pulumi.Input.encodeList<V2modelsIntentClosingSettingNextStepIntentSlot, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory V2modelsIntentClosingSettingNextStepIntent.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingNextStepIntent(
      ...
      slots: (() { final guardedValue = map['slots']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2modelsIntentClosingSettingNextStepIntentSlot>(guardedValue, (value) => V2modelsIntentClosingSettingNextStepIntentSlot.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
