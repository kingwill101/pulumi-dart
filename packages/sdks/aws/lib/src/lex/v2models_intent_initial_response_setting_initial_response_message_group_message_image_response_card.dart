...
class V2modelsIntentInitialResponseSettingInitialResponseMessageGroupMessageImageResponseCard {
  ...
  factory V2modelsIntentInitialResponseSettingInitialResponseMessageGroupMessageImageResponseCard.fromMap(
      ...
      buttons: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2modelsIntentInitialResponseSettingInitialResponseMessageGroupMessageImageResponseCardButton.fromMap(
