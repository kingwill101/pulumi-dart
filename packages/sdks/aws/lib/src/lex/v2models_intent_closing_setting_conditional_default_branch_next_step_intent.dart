...
class V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntent {
  ...
  const V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntent({
    this.name,
    this.slots,
  });
  ...
  factory V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntent.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntent(
      ...
      slots: (() { final guardedValue = map['slots']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlot>(guardedValue, (value) => V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlot.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
