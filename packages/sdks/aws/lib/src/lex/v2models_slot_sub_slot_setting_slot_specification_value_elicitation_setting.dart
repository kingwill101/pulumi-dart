...
class V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSetting {
  ...
  factory V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSetting.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSetting(
      ...
      promptSpecification: map['promptSpecification'] == null ? null : (V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecification.fromMap((map['promptSpecification'] as Map).cast<String, dynamic>())).input(),
