...
class V2modelsIntentConfirmationSettingCodeHook {
  ...
  factory V2modelsIntentConfirmationSettingCodeHook.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingCodeHook(
      ...
      postCodeHookSpecification: (() { final guardedValue = map['postCodeHookSpecification']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecification.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
