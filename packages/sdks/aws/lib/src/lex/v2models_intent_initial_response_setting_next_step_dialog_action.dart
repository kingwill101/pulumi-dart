...
class V2modelsIntentInitialResponseSettingNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentInitialResponseSettingNextStepDialogAction].
  ...
  const V2modelsIntentInitialResponseSettingNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentInitialResponseSettingNextStepDialogAction.fromMap(Map<String, dynamic> map) {
