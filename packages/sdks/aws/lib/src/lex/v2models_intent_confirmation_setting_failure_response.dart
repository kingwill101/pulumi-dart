...
class V2modelsIntentConfirmationSettingFailureResponse {
  ...
  factory V2modelsIntentConfirmationSettingFailureResponse.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingFailureResponse(
      ...
      messageGroups: map['messageGroups'] == null ? null : ((pulumi.Input.decodeList<V2modelsIntentConfirmationSettingFailureResponseMessageGroup>(map['messageGroups']!, (value) => V2modelsIntentConfirmationSettingFailureResponseMessageGroup.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
