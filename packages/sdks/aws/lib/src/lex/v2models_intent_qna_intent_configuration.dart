...
class V2modelsIntentQnaIntentConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bedrockModelConfiguration': ?pulumi.Input.mapOptionalInputValue<V2modelsIntentQnaIntentConfigurationBedrockModelConfiguration, Map<String, dynamic>>(bedrockModelConfiguration, (value) => value.toMap()),
      'dataSourceConfiguration': ?pulumi.Input.mapOptionalInputValue<V2modelsIntentQnaIntentConfigurationDataSourceConfiguration, Map<String, dynamic>>(dataSourceConfiguration, (value) => value.toMap()),
    };
  }

  factory V2modelsIntentQnaIntentConfiguration.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentQnaIntentConfiguration(
      bedrockModelConfiguration: (() { final guardedValue = map['bedrockModelConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentQnaIntentConfigurationBedrockModelConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataSourceConfiguration: (() { final guardedValue = map['dataSourceConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentQnaIntentConfigurationDataSourceConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
