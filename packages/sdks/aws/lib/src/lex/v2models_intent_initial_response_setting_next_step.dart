...
class V2modelsIntentInitialResponseSettingNextStep {
  ...
  final pulumi.Input<V2modelsIntentInitialResponseSettingNextStepDialogAction>? dialogAction;
  /// Configuration block for override settings to configure the intent state. See `intent`.
  final pulumi.Input<V2modelsIntentInitialResponseSettingNextStepIntent>? intent;
  ...
  const V2modelsIntentInitialResponseSettingNextStep({
    this.dialogAction,
    this.intent,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dialogAction': ?pulumi.Input.mapOptionalInputValue<V2modelsIntentInitialResponseSettingNextStepDialogAction, Map<String, dynamic>>(dialogAction, (value) => value.toMap()),
      'intent': ?pulumi.Input.mapOptionalInputValue<V2modelsIntentInitialResponseSettingNextStepIntent, Map<String, dynamic>>(intent, (value) => value.toMap()),
  ...
  factory V2modelsIntentInitialResponseSettingNextStep.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentInitialResponseSettingNextStep(
      dialogAction: (() { final guardedValue = map['dialogAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingNextStepDialogAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      intent: (() { final guardedValue = map['intent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingNextStepIntent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
