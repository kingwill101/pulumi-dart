...
class IntentSlot {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'valueElicitationPrompt': ?valueElicitationPrompt == null ? null : valueElicitationPrompt!.toMap(),
    };
  }
  ...
  factory IntentSlot.fromMap(Map<String, dynamic> map) {
    return IntentSlot(
      ...
      slotTypeVersion: map['slotTypeVersion'] == null ? null : map['slotTypeVersion'] as String,
      valueElicitationPrompt: map['valueElicitationPrompt'] == null ? null : IntentSlotValueElicitationPrompt.fromMap((map['valueElicitationPrompt'] as Map).cast<String, dynamic>()),
    );
  }
}
