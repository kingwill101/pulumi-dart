...
class IntentSlot {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'valueElicitationPrompt': ?pulumi.Input.mapOptionalInputValue<IntentSlotValueElicitationPrompt, Map<String, dynamic>>(valueElicitationPrompt, (value) => value.toMap()),
    };
  }
  ...
  factory IntentSlot.fromMap(Map<String, dynamic> map) {
    return IntentSlot(
      ...
      slotTypeVersion: (() { final guardedValue = map['slotTypeVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      valueElicitationPrompt: (() { final guardedValue = map['valueElicitationPrompt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntentSlotValueElicitationPrompt.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
