...
class V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecification {
  ...
  factory V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecification.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecification(
      failureConditional: (() { final guardedValue = map['failureConditional']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationFailureConditional.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      failureNextStep: (() { final guardedValue = map['failureNextStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationFailureNextStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      failureResponse: (() { final guardedValue = map['failureResponse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationFailureResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      successConditional: (() { final guardedValue = map['successConditional']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationSuccessConditional.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      successNextStep: (() { final guardedValue = map['successNextStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationSuccessNextStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      successResponse: (() { final guardedValue = map['successResponse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationSuccessResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeoutConditional: (() { final guardedValue = map['timeoutConditional']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationTimeoutConditional.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeoutNextStep: (() { final guardedValue = map['timeoutNextStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationTimeoutNextStep.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeoutResponse: (() { final guardedValue = map['timeoutResponse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationTimeoutResponse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
