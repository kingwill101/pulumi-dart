...
class V2modelsIntentState {
  ...
  factory V2modelsIntentState.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentState(
      ...
      closingSetting: map['closingSetting'] == null ? null : (V2modelsIntentClosingSetting.fromMap((map['closingSetting'] as Map).cast<String, dynamic>())).input(),
      confirmationSetting: map['confirmationSetting'] == null ? null : (V2modelsIntentConfirmationSetting.fromMap((map['confirmationSetting'] as Map).cast<String, dynamic>())).input(),
      creationDateTime: map['creationDateTime'] == null ? null : (map['creationDateTime'] as String).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      dialogCodeHook: map['dialogCodeHook'] == null ? null : (V2modelsIntentDialogCodeHook.fromMap((map['dialogCodeHook'] as Map).cast<String, dynamic>())).input(),
      fulfillmentCodeHook: map['fulfillmentCodeHook'] == null ? null : (V2modelsIntentFulfillmentCodeHook.fromMap((map['fulfillmentCodeHook'] as Map).cast<String, dynamic>())).input(),
      initialResponseSetting: map['initialResponseSetting'] == null ? null : (V2modelsIntentInitialResponseSetting.fromMap((map['initialResponseSetting'] as Map).cast<String, dynamic>())).input(),
      inputContexts: map['inputContexts'] == null ? null : (pulumi.Input.decodeList<V2modelsIntentInputContext>(map['inputContexts'], (value) => V2modelsIntentInputContext.fromMap((value as Map).cast<String, dynamic>()))).input(),
      intentId: map['intentId'] == null ? null : (map['intentId'] as String).input(),
      kendraConfiguration: map['kendraConfiguration'] == null ? null : (V2modelsIntentKendraConfiguration.fromMap((map['kendraConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      outputContexts: map['outputContexts'] == null ? null : (pulumi.Input.decodeList<V2modelsIntentOutputContext>(map['outputContexts'], (value) => V2modelsIntentOutputContext.fromMap((value as Map).cast<String, dynamic>()))).input(),
      parentIntentSignature: map['parentIntentSignature'] == null ? null : (map['parentIntentSignature'] as String).input(),
      qnaIntentConfiguration: map['qnaIntentConfiguration'] == null ? null : (V2modelsIntentQnaIntentConfiguration.fromMap((map['qnaIntentConfiguration'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      sampleUtterances: map['sampleUtterances'] == null ? null : (pulumi.Input.decodeList<V2modelsIntentSampleUtterance>(map['sampleUtterances'], (value) => V2modelsIntentSampleUtterance.fromMap((value as Map).cast<String, dynamic>()))).input(),
      slotPriorities: map['slotPriorities'] == null ? null : (pulumi.Input.decodeList<V2modelsIntentSlotPriority>(map['slotPriorities'], (value) => V2modelsIntentSlotPriority.fromMap((value as Map).cast<String, dynamic>()))).input(),
      timeouts: map['timeouts'] == null ? null : (V2modelsIntentTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
