...
class V2modelsBotLocaleTimeouts {
  ...
  /// Creates a new [V2modelsBotLocaleTimeouts].
  ...
  V2modelsBotLocaleTimeouts({this.create, this.delete, this.update});
  ...
  factory V2modelsBotLocaleTimeouts.fromMap(Map<String, dynamic> map) {
    return V2modelsBotLocaleTimeouts(
      create: (() {
