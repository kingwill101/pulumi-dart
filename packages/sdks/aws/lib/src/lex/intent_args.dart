...
class IntentArgs {
    ...
    return <String, dynamic>{
      'conclusionStatement':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(conclusionStatement, (value) => value.toMap()),
      'confirmationPrompt':
          ?pulumi.Input.mapOptionalInputValue<
            IntentConfirmationPrompt,
            Map<String, dynamic>
          >(confirmationPrompt, (value) => value.toMap()),
      ...
      'followUpPrompt':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(followUpPrompt, (value) => value.toMap()),
      'fulfillmentActivity':
      ...
      'slots':
          ...
          >(
            slots,
            (value) =>
                pulumi.Input.encodeList<IntentSlot, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory IntentArgs.fromMap(Map<String, dynamic> map) {
    return IntentArgs(
      conclusionStatement: (() {
        final guardedValue = map['conclusionStatement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IntentConclusionStatement.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      confirmationPrompt: (() {
        final guardedValue = map['confirmationPrompt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IntentConfirmationPrompt.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      dialogCodeHook: (() {
        final guardedValue = map['dialogCodeHook'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IntentDialogCodeHook.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      followUpPrompt: (() {
        final guardedValue = map['followUpPrompt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IntentFollowUpPrompt.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      fulfillmentActivity: pulumi.Input.fromValue(
        IntentFulfillmentActivity.fromMap(
          (map['fulfillmentActivity']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: (() {
      ...
      parentIntentSignature: (() {
        final guardedValue = map['parentIntentSignature'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      rejectionStatement: (() {
        final guardedValue = map['rejectionStatement'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          IntentRejectionStatement.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      slots: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IntentSlot>(
            guardedValue,
            (value) =>
                IntentSlot.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
