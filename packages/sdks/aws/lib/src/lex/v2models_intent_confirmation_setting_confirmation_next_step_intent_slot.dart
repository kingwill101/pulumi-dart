...
class V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlot {
  ...
  final pulumi.Input<V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValue>? value;
  ...
  const V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlot({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'shape': ?shape,
      'value': ?pulumi.Input.mapOptionalInputValue<V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValue, Map<String, dynamic>>(value, (value) => value.toMap()),
    };
  }

  factory V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlot.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlot(
      ...
      value: (() { final guardedValue = map['value']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValue.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
