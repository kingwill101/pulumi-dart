...
class V2modelsBotArgs {
  ...
  factory V2modelsBotArgs.fromMap(Map<String, dynamic> map) {
    return V2modelsBotArgs(
      dataPrivacies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<V2modelsBotDataPrivacy>(
          map['dataPrivacies']!,
          (value) => V2modelsBotDataPrivacy.fromMap(
      ...
      idleSessionTtlInSeconds: pulumi.Input.fromValue(
        map['idleSessionTtlInSeconds'] as int,
      ),
      members: (() {
        final guardedValue = map['members'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<V2modelsBotMember>(
            guardedValue,
            (value) => V2modelsBotMember.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      testBotAliasTags: (() {
        final guardedValue = map['testBotAliasTags'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
