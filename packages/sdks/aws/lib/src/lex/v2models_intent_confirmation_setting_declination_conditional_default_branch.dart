...
class V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranch {
  ...
  factory V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranch.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranch(
      nextStep: map['nextStep'] == null ? null : ((V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStep.fromMap((map['nextStep']! as Map).cast<String, dynamic>())).input()).input(),
      response: map['response'] == null ? null : ((V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchResponse.fromMap((map['response']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
