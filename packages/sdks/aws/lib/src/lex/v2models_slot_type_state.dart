...
class V2modelsSlotTypeState {
  ...
  factory V2modelsSlotTypeState.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotTypeState(
      ...
      compositeSlotTypeSettings: (() {
        final guardedValue = map['compositeSlotTypeSettings'];
        if (guardedValue == null) return null;
      ...
      externalSourceSettings: (() {
        final guardedValue = map['externalSourceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      parentSlotTypeSignature: (() {
        final guardedValue = map['parentSlotTypeSignature'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      slotTypeId: (() {
        final guardedValue = map['slotTypeId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      slotTypeValues: (() {
        final guardedValue = map['slotTypeValues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      valueSelectionSetting: (() {
        final guardedValue = map['valueSelectionSetting'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
