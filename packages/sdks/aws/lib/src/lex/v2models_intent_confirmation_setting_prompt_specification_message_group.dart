...
class V2modelsIntentConfirmationSettingPromptSpecificationMessageGroup {
  ...
  factory V2modelsIntentConfirmationSettingPromptSpecificationMessageGroup.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingPromptSpecificationMessageGroup(
      message: map['message'] == null ? null : ((V2modelsIntentConfirmationSettingPromptSpecificationMessageGroupMessage.fromMap((map['message']! as Map).cast<String, dynamic>())).input()).input(),
      variations: map['variations'] == null ? null : ((pulumi.Input.decodeList<V2modelsIntentConfirmationSettingPromptSpecificationMessageGroupVariation>(map['variations']!, (value) => V2modelsIntentConfirmationSettingPromptSpecificationMessageGroupVariation.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
