...
class IntentRejectionStatement {
  ...
  factory IntentRejectionStatement.fromMap(Map<String, dynamic> map) {
    return IntentRejectionStatement(
      messages: pulumi.Input.fromValue(pulumi.Input.decodeList<IntentRejectionStatementMessage>(map['messages']!, (value) => IntentRejectionStatementMessage.fromMap((value as Map).cast<String, dynamic>()))),
