...
class V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationCustomPayload {
  ...
  const V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationCustomPayload({
    required this.value,
  });
  ...
  factory V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationCustomPayload.fromMap(Map<String, dynamic> map) {
