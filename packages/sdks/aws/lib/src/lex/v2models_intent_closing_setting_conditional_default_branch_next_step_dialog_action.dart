...
class V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction {
  ...
  /// Creates a new [V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction].
  ...
  const V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction({
    this.slotToElicit,
  ...
  factory V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction(
