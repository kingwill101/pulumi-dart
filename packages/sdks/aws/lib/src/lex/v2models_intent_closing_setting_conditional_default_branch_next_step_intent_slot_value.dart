...
class V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue {
  ...
  /// Creates a new [V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue].
  ...
  const V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue({
  ...
  factory V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValue(
