...
class V2modelsIntentInitialResponseSetting {
  ...
  final pulumi.Input<V2modelsIntentInitialResponseSettingConditional>?
  conditional;

  /// Configuration block for message groups that Amazon Lex uses to respond the user input. See `initial_response`.
  final pulumi.Input<V2modelsIntentInitialResponseSettingInitialResponse>?
  initialResponse;
    ...
    return <String, dynamic>{
      ...
      'initialResponse':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(initialResponse, (value) => value.toMap()),
      'nextStep':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory V2modelsIntentInitialResponseSetting.fromMap(
    ...
    return V2modelsIntentInitialResponseSetting(
      ...
      initialResponse: (() {
        final guardedValue = map['initialResponse'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
