...
class V2modelsIntentConfirmationSettingDeclinationResponse {
  ...
  final pulumi.Input<List<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroup>>? messageGroups;
  ...
  const V2modelsIntentConfirmationSettingDeclinationResponse({
    this.allowInterrupt,
    this.messageGroups,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'messageGroups': ?pulumi.Input.mapOptionalInputValue<List<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroup>, List<Map<String, dynamic>>>(messageGroups, (value) => pulumi.Input.encodeList<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroup, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory V2modelsIntentConfirmationSettingDeclinationResponse.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingDeclinationResponse(
      ...
      messageGroups: (() { final guardedValue = map['messageGroups']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroup>(guardedValue, (value) => V2modelsIntentConfirmationSettingDeclinationResponseMessageGroup.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
