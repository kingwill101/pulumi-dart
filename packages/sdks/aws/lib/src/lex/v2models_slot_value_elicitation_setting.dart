...
class V2modelsSlotValueElicitationSetting {
  ...
  final pulumi.Input<
    List<V2modelsSlotValueElicitationSettingDefaultValueSpecification>
  >?
  ...
  final pulumi.Input<V2modelsSlotValueElicitationSettingPromptSpecification>?
  promptSpecification;
  final pulumi.Input<List<V2modelsSlotValueElicitationSettingSampleUtterance>>?
  sampleUtterances;
  ...
  final pulumi.Input<
    List<V2modelsSlotValueElicitationSettingSlotResolutionSetting>
  >?
  ...
  final pulumi.Input<
    List<V2modelsSlotValueElicitationSettingWaitAndContinueSpecification>
  >?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sampleUtterances':
          ?pulumi.Input.mapOptionalInputValue<
            List<V2modelsSlotValueElicitationSettingSampleUtterance>,
            List<Map<String, dynamic>>
          >(
            sampleUtterances,
            (value) =>
  ...
  factory V2modelsSlotValueElicitationSetting.fromMap(
    ...
    return V2modelsSlotValueElicitationSetting(
      defaultValueSpecifications: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2modelsSlotValueElicitationSettingDefaultValueSpecification.fromMap(
      ...
      slotResolutionSettings: (() {
        final guardedValue = map['slotResolutionSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<
            V2modelsSlotValueElicitationSettingSlotResolutionSetting
          >(
            guardedValue,
            (value) =>
                V2modelsSlotValueElicitationSettingSlotResolutionSetting.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      waitAndContinueSpecifications: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                V2modelsSlotValueElicitationSettingWaitAndContinueSpecification.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
