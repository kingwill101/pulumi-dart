...
class SlotTypeState {
  ...
  factory SlotTypeState.fromMap(Map<String, dynamic> map) {
    return SlotTypeState(
      ...
      enumerationValues: (() {
        final guardedValue = map['enumerationValues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SlotTypeEnumerationValue>(
            guardedValue,
      ...
      valueSelectionStrategy: (() {
        final guardedValue = map['valueSelectionStrategy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      version: (() {
