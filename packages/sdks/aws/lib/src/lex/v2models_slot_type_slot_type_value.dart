...
class V2modelsSlotTypeSlotTypeValue {
  ...
  final pulumi.Input<List<V2modelsSlotTypeSlotTypeValueSampleValue>>?
  sampleValues;
    ...
    return <String, dynamic>{
      'sampleValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<V2modelsSlotTypeSlotTypeValueSampleValue>,
      ...
      'synonyms':
          ?pulumi.Input.mapOptionalInputValue<
            List<V2modelsSlotTypeSlotTypeValueSynonym>,
            List<Map<String, dynamic>>
          >(
            synonyms,
            (value) =>
  ...
  factory V2modelsSlotTypeSlotTypeValue.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotTypeSlotTypeValue(
      sampleValues: (() {
        final guardedValue = map['sampleValues'];
