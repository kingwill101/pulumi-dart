...
class BotState {
  ...
  factory BotState.fromMap(Map<String, dynamic> map) {
    return BotState(
      abortStatement: map['abortStatement'] == null ? null : (BotAbortStatement.fromMap((map['abortStatement'] as Map).cast<String, dynamic>())).input(),
      arn: map['arn'] == null ? null : (map['arn'] as String).input(),
      checksum: map['checksum'] == null ? null : (map['checksum'] as String).input(),
      childDirected: map['childDirected'] == null ? null : (map['childDirected'] as bool).input(),
      ...
      intents: map['intents'] == null ? null : (pulumi.Input.decodeList<BotIntent>(map['intents'], (value) => BotIntent.fromMap((value as Map).cast<String, dynamic>()))).input(),
