...
class IntentConclusionStatement {
  ...
  factory IntentConclusionStatement.fromMap(Map<String, dynamic> map) {
    return IntentConclusionStatement(
      messages: pulumi.Input.fromValue(pulumi.Input.decodeList<IntentConclusionStatementMessage>(map['messages']!, (value) => IntentConclusionStatementMessage.fromMap((value as Map).cast<String, dynamic>()))),
