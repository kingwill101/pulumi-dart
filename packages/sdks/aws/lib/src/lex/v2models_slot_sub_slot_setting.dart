...
class V2modelsSlotSubSlotSetting {
  ...
  final pulumi.Input<List<V2modelsSlotSubSlotSettingSlotSpecification>>?
  slotSpecifications;
    ...
    return <String, dynamic>{
      ...
      'slotSpecifications':
          ?pulumi.Input.mapOptionalInputValue<
            List<V2modelsSlotSubSlotSettingSlotSpecification>,
  ...
  factory V2modelsSlotSubSlotSetting.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotSubSlotSetting(
      ...
      slotSpecifications: (() {
        final guardedValue = map['slotSpecifications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<V2modelsSlotSubSlotSettingSlotSpecification>(
            guardedValue,
