...
class V2modelsSlotSubSlotSetting {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'slotSpecifications': ?slotSpecifications == null ? null : pulumi.Input.encodeList<V2modelsSlotSubSlotSettingSlotSpecification, Map<String, dynamic>>(slotSpecifications!, (value) => value.toMap()),
    };
  }
  ...
  factory V2modelsSlotSubSlotSetting.fromMap(Map<String, dynamic> map) {
    return V2modelsSlotSubSlotSetting(
      ...
      slotSpecifications: map['slotSpecifications'] == null ? null : pulumi.Input.decodeList<V2modelsSlotSubSlotSettingSlotSpecification>(map['slotSpecifications'], (value) => V2modelsSlotSubSlotSettingSlotSpecification.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
