...
class V2modelsIntentConfirmationSettingFailureNextStep {
  ...
  final V2modelsIntentConfirmationSettingFailureNextStepDialogAction? dialogAction;
  ...
  factory V2modelsIntentConfirmationSettingFailureNextStep.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingFailureNextStep(
      dialogAction: map['dialogAction'] == null ? null : V2modelsIntentConfirmationSettingFailureNextStepDialogAction.fromMap((map['dialogAction'] as Map).cast<String, dynamic>()),
      intent: map['intent'] == null ? null : V2modelsIntentConfirmationSettingFailureNextStepIntent.fromMap((map['intent'] as Map).cast<String, dynamic>()),
