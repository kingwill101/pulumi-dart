...
class V2modelsIntentConfirmationSettingFailureNextStep {
  ...
  const V2modelsIntentConfirmationSettingFailureNextStep({
    this.dialogAction,
    this.intent,
  ...
  factory V2modelsIntentConfirmationSettingFailureNextStep.fromMap(Map<String, dynamic> map) {
    return V2modelsIntentConfirmationSettingFailureNextStep(
      dialogAction: (() { final guardedValue = map['dialogAction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentConfirmationSettingFailureNextStepDialogAction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      intent: (() { final guardedValue = map['intent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(V2modelsIntentConfirmationSettingFailureNextStepIntent.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
