...
class ClusterState {
    ...
    return <String, dynamic>{
      'clusterCertificates':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterClusterCertificate>,
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      clusterCertificates: (() {
        final guardedValue = map['clusterCertificates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ClusterClusterCertificate>(
            guardedValue,
            (value) => ClusterClusterCertificate.fromMap(
      ...
      hsmType: (() {
        final guardedValue = map['hsmType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      mode: (() {
      ...
      sourceBackupIdentifier: (() {
        final guardedValue = map['sourceBackupIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subnetIds: (() {
