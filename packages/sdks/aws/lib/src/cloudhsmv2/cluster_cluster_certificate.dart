  ...
  factory ClusterClusterCertificate.fromMap(Map<String, dynamic> map) {
    return ClusterClusterCertificate(
      awsHardwareCertificate: (() {
        final guardedValue = map['awsHardwareCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clusterCertificate: (() {
        final guardedValue = map['clusterCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      clusterCsr: (() {
        final guardedValue = map['clusterCsr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hsmCertificate: (() {
        final guardedValue = map['hsmCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      manufacturerHardwareCertificate: (() {
        final guardedValue = map['manufacturerHardwareCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
