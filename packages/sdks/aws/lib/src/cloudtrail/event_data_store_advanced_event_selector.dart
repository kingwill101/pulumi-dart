...
class EventDataStoreAdvancedEventSelector {
  ...
  final pulumi.Input<List<EventDataStoreAdvancedEventSelectorFieldSelector>>?
  fieldSelectors;
    ...
    return <String, dynamic>{
      'fieldSelectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<EventDataStoreAdvancedEventSelectorFieldSelector>,
    ...
    return EventDataStoreAdvancedEventSelector(
      fieldSelectors: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => EventDataStoreAdvancedEventSelectorFieldSelector.fromMap(
