...
class ResourceLfTagsState {
  ...
  factory ResourceLfTagsState.fromMap(Map<String, dynamic> map) {
    return ResourceLfTagsState(
      ...
      lfTags: (() { final guardedValue = map['lfTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ResourceLfTagsLfTag>(guardedValue, (value) => ResourceLfTagsLfTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
