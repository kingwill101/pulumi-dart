...
class OptInArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'principals': pulumi.Input.mapInputValue<List<OptInPrincipal>, List<Map<String, dynamic>>>(principals, (value) => pulumi.Input.encodeList<OptInPrincipal, Map<String, dynamic>>(value, (value) => value.toMap())),
      'region': ?region,
  ...
  factory OptInArgs.fromMap(Map<String, dynamic> map) {
    return OptInArgs(
      ...
      principals: pulumi.Input.fromValue(pulumi.Input.decodeList<OptInPrincipal>(map['principals']!, (value) => OptInPrincipal.fromMap((value as Map).cast<String, dynamic>()))),
