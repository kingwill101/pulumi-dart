...
class PermissionsState {
    ...
    return <String, dynamic>{
      ...
      'dataCellsFilter':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataCellsFilter, (value) => value.toMap()),
      'dataLocation':
          ?pulumi.Input.mapOptionalInputValue<
            PermissionsDataLocation,
            Map<String, dynamic>
          >(dataLocation, (value) => value.toMap()),
      'database':
          ?pulumi.Input.mapOptionalInputValue<
            PermissionsDatabase,
            Map<String, dynamic>
  ...
  factory PermissionsState.fromMap(Map<String, dynamic> map) {
    return PermissionsState(
      ...
      dataCellsFilter: (() {
        final guardedValue = map['dataCellsFilter'];
        if (guardedValue == null) return null;
      ...
      dataLocation: (() {
        final guardedValue = map['dataLocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lfTagPolicy: (() {
        final guardedValue = map['lfTagPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      permissionsWithGrantOptions: (() {
        final guardedValue = map['permissionsWithGrantOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      principal: (() {
