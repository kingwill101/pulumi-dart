...
class OptInResourceData {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataCellsFilters':
          ?pulumi.Input.mapOptionalInputValue<
            List<OptInResourceDataDataCellsFilter>,
            List<Map<String, dynamic>>
          >(
            dataCellsFilters,
            (value) =>
      ...
      'dataLocations':
          ?pulumi.Input.mapOptionalInputValue<
            List<OptInResourceDataDataLocation>,
            List<Map<String, dynamic>>
          >(
            dataLocations,
            (value) =>
      ...
      'lfTagExpressions':
          ?pulumi.Input.mapOptionalInputValue<
            List<OptInResourceDataLfTagExpression>,
            List<Map<String, dynamic>>
          >(
            lfTagExpressions,
            (value) =>
      ...
      'lfTagPolicies':
          ?pulumi.Input.mapOptionalInputValue<
            List<OptInResourceDataLfTagPolicy>,
            List<Map<String, dynamic>>
          >(
            lfTagPolicies,
            (value) =>
  ...
  factory OptInResourceData.fromMap(Map<String, dynamic> map) {
    return OptInResourceData(
      catalogs: (() {
        final guardedValue = map['catalogs'];
      ...
      dataCellsFilters: (() {
        final guardedValue = map['dataCellsFilters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dataLocations: (() {
        final guardedValue = map['dataLocations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lfTagExpressions: (() {
        final guardedValue = map['lfTagExpressions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lfTagPolicies: (() {
        final guardedValue = map['lfTagPolicies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
