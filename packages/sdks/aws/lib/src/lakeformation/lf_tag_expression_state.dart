...
class LfTagExpressionState {
  ...
  LfTagExpressionState({
    ...
    pulumi.Output<List<LfTagExpressionExpression>>? expressions,
    pulumi.Output<String>? name,
    pulumi.Output<String>? region,
  }) :
      catalogId = pulumi.Input.asOptionalInput<String>(catalogId),
      description = pulumi.Input.asOptionalInput<String>(description),
      expressions = pulumi.Input.asOptionalInput<List<LfTagExpressionExpression>>(expressions),
  ...
  factory LfTagExpressionState.fromMap(Map<String, dynamic> map) {
    return LfTagExpressionState(
      ...
      expressions: map['expressions'] == null ? null : pulumi.Output.create<List<LfTagExpressionExpression>>(pulumi.Input.decodeList<LfTagExpressionExpression>(map['expressions'], (value) => LfTagExpressionExpression.fromMap((value as Map).cast<String, dynamic>()))),
