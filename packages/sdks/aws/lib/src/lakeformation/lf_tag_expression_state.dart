...
class LfTagExpressionState {
  ...
  factory LfTagExpressionState.fromMap(Map<String, dynamic> map) {
    return LfTagExpressionState(
      ...
      expressions: map['expressions'] == null ? null : (pulumi.Input.decodeList<LfTagExpressionExpression>(map['expressions'], (value) => LfTagExpressionExpression.fromMap((value as Map).cast<String, dynamic>()))).input(),
