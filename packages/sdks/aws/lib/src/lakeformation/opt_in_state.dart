...
class OptInState {
  ...
  factory OptInState.fromMap(Map<String, dynamic> map) {
    return OptInState(
      conditions: (() { final guardedValue = map['conditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OptInCondition>(guardedValue, (value) => OptInCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      principals: (() { final guardedValue = map['principals']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OptInPrincipal>(guardedValue, (value) => OptInPrincipal.fromMap((value as Map).cast<String, dynamic>()))); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceDatas: (() { final guardedValue = map['resourceDatas']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OptInResourceData>(guardedValue, (value) => OptInResourceData.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
