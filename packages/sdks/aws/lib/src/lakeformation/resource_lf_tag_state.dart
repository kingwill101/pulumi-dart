...
class ResourceLfTagState {
  ...
  factory ResourceLfTagState.fromMap(Map<String, dynamic> map) {
    return ResourceLfTagState(
      ...
      database: (() { final guardedValue = map['database']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceLfTagDatabase.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      lfTag: (() { final guardedValue = map['lfTag']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceLfTagLfTag.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      table: (() { final guardedValue = map['table']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceLfTagTable.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tableWithColumns: (() { final guardedValue = map['tableWithColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceLfTagTableWithColumns.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ResourceLfTagTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
