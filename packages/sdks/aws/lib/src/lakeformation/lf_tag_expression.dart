...
class LfTagExpression extends pulumi.CustomResource {
  ...
  LfTagExpression(
    ...
    this.expressions = registerOutput<List<LfTagExpressionExpression>>('expressions');
    this.name = registerOutput<String>('name');
    this.region = registerOutput<String>('region');
  }

  /// Gets an existing [LfTagExpression] resource's state with the given [name] and [id].
  static LfTagExpression get(
    String name,
