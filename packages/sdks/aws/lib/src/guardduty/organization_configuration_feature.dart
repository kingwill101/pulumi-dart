...
class OrganizationConfigurationFeature extends pulumi.CustomResource {
  ...
  /// Creates a new [OrganizationConfigurationFeature].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [OrganizationConfigurationFeature]. {@macro pulumi_guardduty_organization_configuration_feature_organization_configuration_feature_args_doc}
  ...
  OrganizationConfigurationFeature(
    ...
    this.additionalConfigurations = registerOutput<List<OrganizationConfigurationFeatureAdditionalConfiguration>?>('additionalConfigurations');
  ...
  /// Gets an existing [OrganizationConfigurationFeature] resource's state with the given [name] and [id].
  static OrganizationConfigurationFeature get(
    String name,
  ...
  OrganizationConfigurationFeature._get(
    String name, {
