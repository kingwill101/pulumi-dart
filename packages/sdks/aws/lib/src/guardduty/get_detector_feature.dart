...
class GetDetectorFeature {
  ...
  final pulumi.Input<List<GetDetectorFeatureAdditionalConfiguration>>
    ...
    return <String, dynamic>{
      'additionalConfigurations':
          pulumi.Input.mapInputValue<
            List<GetDetectorFeatureAdditionalConfiguration>,
  ...
  factory GetDetectorFeature.fromMap(Map<String, dynamic> map) {
    return GetDetectorFeature(
      additionalConfigurations: pulumi.Input.fromValue(
