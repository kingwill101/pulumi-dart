...
class DetectorState {
  ...
  factory DetectorState.fromMap(Map<String, dynamic> map) {
    return DetectorState(
      ...
      datasources: (() { final guardedValue = map['datasources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DetectorDatasources.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
