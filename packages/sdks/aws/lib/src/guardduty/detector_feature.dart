...
import 'detector_feature_state.dart';
...
class DetectorFeature extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DetectorFeatureAdditionalConfiguration>?> additionalConfigurations;
  ...
  /// Creates a new [DetectorFeature].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DetectorFeature]. {@macro pulumi_guardduty_detector_feature_detector_feature_args_doc}
  ...
  DetectorFeature(
    ...
    this.additionalConfigurations = registerOutput<List<DetectorFeatureAdditionalConfiguration>?>('additionalConfigurations');
  ...
  /// Gets an existing [DetectorFeature] resource's state with the given [name] and [id].
  static DetectorFeature get(
    String name,
    pulumi.Input<String> id, {
    DetectorFeatureState? state,
  }) {
    return DetectorFeature._get(
      name,
      state: state?.toMap(),
