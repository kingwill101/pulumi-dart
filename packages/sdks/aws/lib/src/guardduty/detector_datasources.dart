...
class DetectorDatasources {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'kubernetes': ?pulumi.Input.mapOptionalInputValue<DetectorDatasourcesKubernetes, Map<String, dynamic>>(kubernetes, (value) => value.toMap()),
      'malwareProtection': ?pulumi.Input.mapOptionalInputValue<DetectorDatasourcesMalwareProtection, Map<String, dynamic>>(malwareProtection, (value) => value.toMap()),
      's3Logs': ?pulumi.Input.mapOptionalInputValue<DetectorDatasourcesS3Logs, Map<String, dynamic>>(s3Logs, (value) => value.toMap()),
    };
  }

  factory DetectorDatasources.fromMap(Map<String, dynamic> map) {
    return DetectorDatasources(
      kubernetes: (() { final guardedValue = map['kubernetes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DetectorDatasourcesKubernetes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      malwareProtection: (() { final guardedValue = map['malwareProtection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DetectorDatasourcesMalwareProtection.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      s3Logs: (() { final guardedValue = map['s3Logs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DetectorDatasourcesS3Logs.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
