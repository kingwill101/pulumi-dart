...
class FilterFindingCriteriaCriterion {
  ...
  factory FilterFindingCriteriaCriterion.fromMap(Map<String, dynamic> map) {
    return FilterFindingCriteriaCriterion(
      ...
      greaterThan: (() {
        final guardedValue = map['greaterThan'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      greaterThanOrEqual: (() {
        final guardedValue = map['greaterThanOrEqual'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lessThan: (() {
        final guardedValue = map['lessThan'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lessThanOrEqual: (() {
        final guardedValue = map['lessThanOrEqual'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      matches: (() {
      ...
      notMatches: (() {
        final guardedValue = map['notMatches'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
