...
class AccessGrant extends pulumi.CustomResource {
  ...
  AccessGrant(
    ...
    this.accessGrantsLocationConfiguration = registerOutput<AccessGrantAccessGrantsLocationConfiguration?>('accessGrantsLocationConfiguration');
    this.accessGrantsLocationId = registerOutput<String>('accessGrantsLocationId');
