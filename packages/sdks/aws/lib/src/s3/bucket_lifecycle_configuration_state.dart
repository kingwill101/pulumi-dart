...
class BucketLifecycleConfigurationState {
  ...
  const BucketLifecycleConfigurationState({
    this.bucket,
  ...
  factory BucketLifecycleConfigurationState.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleConfigurationState(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketLifecycleConfigurationRule>(guardedValue, (value) => BucketLifecycleConfigurationRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketLifecycleConfigurationTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
