...
class FilesFileSystemTimeouts {
  ...
  /// Creates a new [FilesFileSystemTimeouts].
  ...
  factory FilesFileSystemTimeouts.fromMap(Map<String, dynamic> map) {
    return FilesFileSystemTimeouts(
