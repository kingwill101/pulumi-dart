...
class BucketMetadataConfigurationState {
  ...
  factory BucketMetadataConfigurationState.fromMap(Map<String, dynamic> map) {
    return BucketMetadataConfigurationState(
      ...
      metadataConfiguration: (() { final guardedValue = map['metadataConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketMetadataConfigurationMetadataConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
