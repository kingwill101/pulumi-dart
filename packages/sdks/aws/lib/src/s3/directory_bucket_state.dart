...
class DirectoryBucketState {
  ...
  /// [bucket] Name of the bucket. The name must be in the format `[bucketName]--[azid]--x-s3`. Use the `aws.s3.Bucket` resource to manage general purpose buckets.
  ...
  factory DirectoryBucketState.fromMap(Map<String, dynamic> map) {
    return DirectoryBucketState(
      ...
      dataRedundancy: (() { final guardedValue = map['dataRedundancy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      forceDestroy: (() { final guardedValue = map['forceDestroy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      location: (() { final guardedValue = map['location']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DirectoryBucketLocation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
