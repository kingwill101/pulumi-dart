...
class MultiRegionAccessPointPolicyState {
  ...
  factory MultiRegionAccessPointPolicyState.fromMap(Map<String, dynamic> map) {
    return MultiRegionAccessPointPolicyState(
      ...
      details: (() { final guardedValue = map['details']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MultiRegionAccessPointPolicyDetails.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      established: (() { final guardedValue = map['established']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      proposed: (() { final guardedValue = map['proposed']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
