...
class BucketLifecycleConfigurationRuleTransition {
  ...
  /// Creates a new [BucketLifecycleConfigurationRuleTransition].
  ...
  const BucketLifecycleConfigurationRuleTransition({
    this.date,
    this.days,
  ...
  factory BucketLifecycleConfigurationRuleTransition.fromMap(Map<String, dynamic> map) {
