...
class BucketV2ReplicationConfiguration {
  ...
  BucketV2ReplicationConfiguration({required this.role, required this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<BucketV2ReplicationConfigurationRule>,
  ...
  factory BucketV2ReplicationConfiguration.fromMap(Map<String, dynamic> map) {
    return BucketV2ReplicationConfiguration(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BucketV2ReplicationConfigurationRule>(
          map['rules']!,
