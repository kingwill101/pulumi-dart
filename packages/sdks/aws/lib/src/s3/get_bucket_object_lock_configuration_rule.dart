...
class GetBucketObjectLockConfigurationRule {
  ...
  final pulumi.Input<List<GetBucketObjectLockConfigurationRuleDefaultRetention>>
  defaultRetentions;
    ...
    return <String, dynamic>{
      'defaultRetentions':
          pulumi.Input.mapInputValue<
            List<GetBucketObjectLockConfigurationRuleDefaultRetention>,
  ...
  factory GetBucketObjectLockConfigurationRule.fromMap(
    ...
    return GetBucketObjectLockConfigurationRule(
      defaultRetentions: pulumi.Input.fromValue(
