...
class BucketReplicationConfigurationRule {
  ...
  final pulumi.Input<BucketReplicationConfigurationRuleSourceSelectionCriteria>?
  ...
  factory BucketReplicationConfigurationRule.fromMap(Map<String, dynamic> map) {
    return BucketReplicationConfigurationRule(
      deleteMarkerReplicationStatus: (() {
        final guardedValue = map['deleteMarkerReplicationStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      destination: pulumi.Input.fromValue(
        BucketReplicationConfigurationRuleDestination.fromMap(
