...
class BucketVersioningState {
  ...
  factory BucketVersioningState.fromMap(Map<String, dynamic> map) {
    return BucketVersioningState(
      ...
      versioningConfiguration: map['versioningConfiguration'] == null ? null : ((BucketVersioningVersioningConfiguration.fromMap((map['versioningConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
