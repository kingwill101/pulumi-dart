...
class GetBucketNotificationLambdaFunction {
  ...
  /// Creates a new [GetBucketNotificationLambdaFunction].
  ...
  const GetBucketNotificationLambdaFunction({
  ...
  factory GetBucketNotificationLambdaFunction.fromMap(Map<String, dynamic> map) {
    return GetBucketNotificationLambdaFunction(
