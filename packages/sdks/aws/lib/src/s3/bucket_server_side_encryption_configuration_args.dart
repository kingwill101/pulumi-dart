...
class BucketServerSideEncryptionConfigurationArgs {
  ...
  const BucketServerSideEncryptionConfigurationArgs({
  ...
  factory BucketServerSideEncryptionConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return BucketServerSideEncryptionConfigurationArgs(
      ...
      rules: pulumi.Input.fromValue(pulumi.Input.decodeList<BucketServerSideEncryptionConfigurationRule>(map['rules']!, (value) => BucketServerSideEncryptionConfigurationRule.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
