...
class ObjectCopy extends pulumi.CustomResource {
  ...
  ObjectCopy(
    ...
    expectedSourceBucketOwner = registerOutput<String?>(
    ...
    objectLockLegalHoldStatus = registerOutput<String>(
      'objectLockLegalHoldStatus',
    );
    objectLockMode = registerOutput<String>('objectLockMode');
    objectLockRetainUntilDate = registerOutput<String>(
    ...
    sourceCustomerAlgorithm = registerOutput<String?>(
  ...
  /// Gets an existing [ObjectCopy] resource's state with the given [name] and [id].
  static ObjectCopy get(
    String name,
