...
class TableState {
  ...
  factory TableState.fromMap(Map<String, dynamic> map) {
    return TableState(
      ...
      modifiedBy: map['modifiedBy'] == null ? null : (map['modifiedBy'] as String).input(),
      ...
      warehouseLocation: map['warehouseLocation'] == null ? null : (map['warehouseLocation'] as String).input(),
    );
  }
}
