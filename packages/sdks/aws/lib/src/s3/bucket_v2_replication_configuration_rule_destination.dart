...
class BucketV2ReplicationConfigurationRuleDestination {
  ...
  final pulumi.Input<List<BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation>>? accessControlTranslations;
  ...
  final pulumi.Input<List<BucketV2ReplicationConfigurationRuleDestinationMetric>>? metrics;
  ...
  final pulumi.Input<List<BucketV2ReplicationConfigurationRuleDestinationReplicationTime>>? replicationTimes;
  ...
  /// [accessControlTranslations] Overrides to use for object owners on replication. See `accessControlTranslation` Block below for details. Must be used in conjunction with `accountId` owner override configuration.
  ...
  /// [replicationTimes] Enables S3 Replication Time Control (S3 RTC). See `replicationTime` Block below for details.
  ...
  const BucketV2ReplicationConfigurationRuleDestination({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessControlTranslations': ?pulumi.Input.mapOptionalInputValue<List<BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation>, List<Map<String, dynamic>>>(accessControlTranslations, (value) => pulumi.Input.encodeList<BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation, Map<String, dynamic>>(value, (value) => value.toMap())),
      'accountId': ?accountId,
      'bucket': bucket,
      'metrics': ?pulumi.Input.mapOptionalInputValue<List<BucketV2ReplicationConfigurationRuleDestinationMetric>, List<Map<String, dynamic>>>(metrics, (value) => pulumi.Input.encodeList<BucketV2ReplicationConfigurationRuleDestinationMetric, Map<String, dynamic>>(value, (value) => value.toMap())),
      'replicaKmsKeyId': ?replicaKmsKeyId,
      'replicationTimes': ?pulumi.Input.mapOptionalInputValue<List<BucketV2ReplicationConfigurationRuleDestinationReplicationTime>, List<Map<String, dynamic>>>(replicationTimes, (value) => pulumi.Input.encodeList<BucketV2ReplicationConfigurationRuleDestinationReplicationTime, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BucketV2ReplicationConfigurationRuleDestination.fromMap(Map<String, dynamic> map) {
    return BucketV2ReplicationConfigurationRuleDestination(
      accessControlTranslations: (() { final guardedValue = map['accessControlTranslations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation>(guardedValue, (value) => BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      accountId: (() { final guardedValue = map['accountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bucket: pulumi.Input.fromValue(map['bucket'] as String),
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketV2ReplicationConfigurationRuleDestinationMetric>(guardedValue, (value) => BucketV2ReplicationConfigurationRuleDestinationMetric.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      replicationTimes: (() { final guardedValue = map['replicationTimes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketV2ReplicationConfigurationRuleDestinationReplicationTime>(guardedValue, (value) => BucketV2ReplicationConfigurationRuleDestinationReplicationTime.fromMap((value as Map).cast<String, dynamic>()))); })(),
