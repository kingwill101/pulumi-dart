...
class AnalyticsConfigurationStorageClassAnalysis {
  ...
  final pulumi.Input<AnalyticsConfigurationStorageClassAnalysisDataExport>
  dataExport;
  ...
  factory AnalyticsConfigurationStorageClassAnalysis.fromMap(
    ...
    return AnalyticsConfigurationStorageClassAnalysis(
      dataExport: pulumi.Input.fromValue(
        AnalyticsConfigurationStorageClassAnalysisDataExport.fromMap(
