...
class BucketObjectv2State {
  ...
  /// [overrideProvider] Override provider-level configuration options. See `overrideProvider` Block below for more details.
  ...
  factory BucketObjectv2State.fromMap(Map<String, dynamic> map) {
    return BucketObjectv2State(
      ...
      overrideProvider: (() { final guardedValue = map['overrideProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketObjectv2OverrideProvider.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
