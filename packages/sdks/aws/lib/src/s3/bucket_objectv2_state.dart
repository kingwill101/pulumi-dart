...
class BucketObjectv2State {
  ...
  /// Creates a new [BucketObjectv2State].
  ...
  BucketObjectv2State({
    ...
    pulumi.Output<BucketObjectv2OverrideProvider>? overrideProvider,
    ...
    pulumi.Output<String>? websiteRedirect,
      ...
      overrideProvider = pulumi.Input.asOptionalInput<BucketObjectv2OverrideProvider>(overrideProvider),
  ...
  factory BucketObjectv2State.fromMap(Map<String, dynamic> map) {
    return BucketObjectv2State(
      ...
      overrideProvider: map['overrideProvider'] == null ? null : pulumi.Output.create<BucketObjectv2OverrideProvider>(BucketObjectv2OverrideProvider.fromMap((map['overrideProvider'] as Map).cast<String, dynamic>())),
