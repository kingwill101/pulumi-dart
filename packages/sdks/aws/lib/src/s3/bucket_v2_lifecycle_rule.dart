...
class BucketV2LifecycleRule {
  ...
  /// [expirations] Configuration of the object expiration. See `expiration` Block below for details.
  /// [id] Unique identifier for the rule. Must be less than or equal to 255 characters in length.
  /// [noncurrentVersionExpirations] When noncurrent object versions expire. See `noncurrentVersionExpiration` Block below for details.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': enabled,
      'expirations': ?pulumi.Input.mapOptionalInputValue<List<BucketV2LifecycleRuleExpiration>, List<Map<String, dynamic>>>(expirations, (value) => pulumi.Input.encodeList<BucketV2LifecycleRuleExpiration, Map<String, dynamic>>(value, (value) => value.toMap())),
      'id': ?id,
      'noncurrentVersionExpirations': ?pulumi.Input.mapOptionalInputValue<List<BucketV2LifecycleRuleNoncurrentVersionExpiration>, List<Map<String, dynamic>>>(noncurrentVersionExpirations, (value) => pulumi.Input.encodeList<BucketV2LifecycleRuleNoncurrentVersionExpiration, Map<String, dynamic>>(value, (value) => value.toMap())),
      'noncurrentVersionTransitions': ?pulumi.Input.mapOptionalInputValue<List<BucketV2LifecycleRuleNoncurrentVersionTransition>, List<Map<String, dynamic>>>(noncurrentVersionTransitions, (value) => pulumi.Input.encodeList<BucketV2LifecycleRuleNoncurrentVersionTransition, Map<String, dynamic>>(value, (value) => value.toMap())),
      'prefix': ?prefix,
      'tags': ?tags,
      'transitions': ?pulumi.Input.mapOptionalInputValue<List<BucketV2LifecycleRuleTransition>, List<Map<String, dynamic>>>(transitions, (value) => pulumi.Input.encodeList<BucketV2LifecycleRuleTransition, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory BucketV2LifecycleRule.fromMap(Map<String, dynamic> map) {
    return BucketV2LifecycleRule(
      ...
      noncurrentVersionExpirations: (() { final guardedValue = map['noncurrentVersionExpirations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketV2LifecycleRuleNoncurrentVersionExpiration>(guardedValue, (value) => BucketV2LifecycleRuleNoncurrentVersionExpiration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      noncurrentVersionTransitions: (() { final guardedValue = map['noncurrentVersionTransitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketV2LifecycleRuleNoncurrentVersionTransition>(guardedValue, (value) => BucketV2LifecycleRuleNoncurrentVersionTransition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      prefix: (() { final guardedValue = map['prefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      transitions: (() { final guardedValue = map['transitions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketV2LifecycleRuleTransition>(guardedValue, (value) => BucketV2LifecycleRuleTransition.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
