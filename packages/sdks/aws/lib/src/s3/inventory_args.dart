...
class InventoryArgs {
  ...
  factory InventoryArgs.fromMap(Map<String, dynamic> map) {
    return InventoryArgs(
      ...
      destination: pulumi.Input.fromValue(InventoryDestination.fromMap((map['destination']! as Map).cast<String, dynamic>())),
      ...
      includedObjectVersions: pulumi.Input.fromValue(map['includedObjectVersions'] as String),
      ...
      schedule: pulumi.Input.fromValue(InventorySchedule.fromMap((map['schedule']! as Map).cast<String, dynamic>())),
    );
  }
}
