...
class StorageLensConfigurationStorageLensConfiguration {
  ...
  final pulumi.Input<StorageLensConfigurationStorageLensConfigurationAwsOrg>?
  awsOrg;
  ...
  final pulumi.Input<StorageLensConfigurationStorageLensConfigurationExclude>?
  exclude;

  /// What is included in this configuration. Conflicts with `exclude`. See Include below for more details.
  final pulumi.Input<StorageLensConfigurationStorageLensConfigurationInclude>?
  include;
