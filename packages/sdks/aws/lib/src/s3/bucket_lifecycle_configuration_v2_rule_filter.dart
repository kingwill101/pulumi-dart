...
class BucketLifecycleConfigurationV2RuleFilter {
  ...
  factory BucketLifecycleConfigurationV2RuleFilter.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleConfigurationV2RuleFilter(
      and: map['and'] == null ? null : BucketLifecycleConfigurationV2RuleFilterAnd.fromMap((map['and'] as Map).cast<String, dynamic>()),
      ...
      tag: map['tag'] == null ? null : BucketLifecycleConfigurationV2RuleFilterTag.fromMap((map['tag'] as Map).cast<String, dynamic>()),
    );
  }
}
