...
class BucketReplicationConfigRule {
  ...
  final pulumi.Input<BucketReplicationConfigRuleDeleteMarkerReplication>?
  ...
  final pulumi.Input<BucketReplicationConfigRuleExistingObjectReplication>?
  ...
  final pulumi.Input<BucketReplicationConfigRuleSourceSelectionCriteria>?
    ...
    return <String, dynamic>{
      ...
      'existingObjectReplication':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(existingObjectReplication, (value) => value.toMap()),
      'filter':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory BucketReplicationConfigRule.fromMap(Map<String, dynamic> map) {
    return BucketReplicationConfigRule(
      ...
      destination: pulumi.Input.fromValue(
        BucketReplicationConfigRuleDestination.fromMap(
          (map['destination']! as Map).cast<String, dynamic>(),
        ),
      ),
      existingObjectReplication: (() {
        final guardedValue = map['existingObjectReplication'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
