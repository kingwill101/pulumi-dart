...
class BucketLifecycleConfigurationRuleFilter {
  ...
  factory BucketLifecycleConfigurationRuleFilter.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleConfigurationRuleFilter(
      and: map['and'] == null ? null : BucketLifecycleConfigurationRuleFilterAnd.fromMap((map['and'] as Map).cast<String, dynamic>()),
      ...
      tag: map['tag'] == null ? null : BucketLifecycleConfigurationRuleFilterTag.fromMap((map['tag'] as Map).cast<String, dynamic>()),
    );
  }
}
