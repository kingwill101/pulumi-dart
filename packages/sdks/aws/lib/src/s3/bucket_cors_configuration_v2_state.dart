...
class BucketCorsConfigurationV2State {
  ...
  const BucketCorsConfigurationV2State({
    this.bucket,
    this.corsRules,
  ...
  factory BucketCorsConfigurationV2State.fromMap(Map<String, dynamic> map) {
    return BucketCorsConfigurationV2State(
      ...
      corsRules: (() { final guardedValue = map['corsRules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketCorsConfigurationV2CorsRule>(guardedValue, (value) => BucketCorsConfigurationV2CorsRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
