...
class BucketObjectState {
  ...
  factory BucketObjectState.fromMap(Map<String, dynamic> map) {
    return BucketObjectState(
      ...
      contentBase64: map['contentBase64'] == null ? null : ((map['contentBase64'] as String).input()).input(),
      ...
      source: map['source'] == null ? null : ((map['source']).input()).input(),
      sourceHash: map['sourceHash'] == null ? null : ((map['sourceHash'] as String).input()).input(),
