...
class BucketLoggingS3 extends pulumi.CustomResource {
  ...
  BucketLoggingS3(
    ...
    targetGrants = registerOutput<List<BucketLoggingTargetGrant>?>('targetGrants', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<BucketLoggingTargetGrant>(guardedValue, (value) => BucketLoggingTargetGrant.fromMap((value as Map).cast<String, dynamic>())); });
    targetObjectKeyFormat = registerOutput<BucketLoggingTargetObjectKeyFormat?>('targetObjectKeyFormat', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BucketLoggingTargetObjectKeyFormat.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Creates a typed reference to an existing [BucketLoggingS3] resource.
  BucketLoggingS3.reference(String urn)
    : super(
        'aws:s3/bucketLogging:BucketLogging',
