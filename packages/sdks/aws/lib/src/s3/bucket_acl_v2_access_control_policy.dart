...
class BucketAclV2AccessControlPolicy {
  ...
  BucketAclV2AccessControlPolicy({this.grants, required this.owner});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'grants':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketAclV2AccessControlPolicyGrant>,
  ...
  factory BucketAclV2AccessControlPolicy.fromMap(Map<String, dynamic> map) {
    return BucketAclV2AccessControlPolicy(
      ...
      owner: pulumi.Input.fromValue(
        BucketAclV2AccessControlPolicyOwner.fromMap(
