...
import 'bucket_accelerate_configuration_args.dart';
import 'bucket_accelerate_configuration_state.dart';
...
class BucketAccelerateConfiguration extends pulumi.CustomResource {
  ...
  /// Creates a new [BucketAccelerateConfiguration].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BucketAccelerateConfiguration]. {@macro pulumi_s3_bucket_accelerate_configuration_bucket_accelerate_configuration_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  BucketAccelerateConfiguration(
    String name, {
    BucketAccelerateConfigurationArgs? args,
  ...
  /// Gets an existing [BucketAccelerateConfiguration] resource's state with the given [name] and [id].
  static BucketAccelerateConfiguration get(
    String name,
  ...
  BucketAccelerateConfiguration._get(
    String name, {
