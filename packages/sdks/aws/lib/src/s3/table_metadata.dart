...
class TableMetadata {
  ...
  /// [iceberg] Details about the metadata for an Iceberg table. This block defines the schema structure for the Apache Iceberg table format. See `iceberg` below.
  const TableMetadata({
  ...
  factory TableMetadata.fromMap(Map<String, dynamic> map) {
    return TableMetadata(
      iceberg: pulumi.Input.fromValue(TableMetadataIceberg.fromMap((map['iceberg']! as Map).cast<String, dynamic>())),
    );
  }
}
