...
class BucketLoggingV2Args {
    ...
    return <String, dynamic>{
      ...
      'targetGrants':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketLoggingV2TargetGrant>,
      ...
      'targetObjectKeyFormat':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(targetObjectKeyFormat, (value) => value.toMap()),
  ...
  factory BucketLoggingV2Args.fromMap(Map<String, dynamic> map) {
    return BucketLoggingV2Args(
      ...
      targetGrants: (() {
        final guardedValue = map['targetGrants'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketLoggingV2TargetGrant>(
            guardedValue,
            (value) => BucketLoggingV2TargetGrant.fromMap(
      ...
      targetObjectKeyFormat: (() {
        final guardedValue = map['targetObjectKeyFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketLoggingV2TargetObjectKeyFormat.fromMap(
