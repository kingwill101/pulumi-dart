...
class BucketReplicationConfiguration {
  ...
  BucketReplicationConfiguration({required this.role, required this.rules});
    ...
    return <String, dynamic>{
      ...
      'rules':
          pulumi.Input.mapInputValue<
            List<BucketReplicationConfigurationRule>,
  ...
  factory BucketReplicationConfiguration.fromMap(Map<String, dynamic> map) {
    return BucketReplicationConfiguration(
      ...
      rules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<BucketReplicationConfigurationRule>(
          map['rules']!,
