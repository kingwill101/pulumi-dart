...
class FilesAccessPointTimeouts {
  ...
  /// Creates a new [FilesAccessPointTimeouts].
  ...
  const FilesAccessPointTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory FilesAccessPointTimeouts.fromMap(Map<String, dynamic> map) {
    return FilesAccessPointTimeouts(
