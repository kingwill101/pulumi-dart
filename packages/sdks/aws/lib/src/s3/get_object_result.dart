...
class GetObjectResult {
  ...
  factory GetObjectResult.fromMap(Map<String, dynamic> map) {
    return GetObjectResult(
      ...
      bodyBase64: (() { final guardedValue = map['bodyBase64']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      checksumCrc32: (() { final guardedValue = map['checksumCrc32']; if (guardedValue == null) return null; return guardedValue as String; })(),
      checksumCrc32c: (() { final guardedValue = map['checksumCrc32c']; if (guardedValue == null) return null; return guardedValue as String; })(),
      checksumCrc64nvme: (() { final guardedValue = map['checksumCrc64nvme']; if (guardedValue == null) return null; return guardedValue as String; })(),
      checksumMode: (() { final guardedValue = map['checksumMode']; if (guardedValue == null) return null; return guardedValue as String; })(),
      checksumSha1: (() { final guardedValue = map['checksumSha1']; if (guardedValue == null) return null; return guardedValue as String; })(),
      checksumSha256: (() { final guardedValue = map['checksumSha256']; if (guardedValue == null) return null; return guardedValue as String; })(),
