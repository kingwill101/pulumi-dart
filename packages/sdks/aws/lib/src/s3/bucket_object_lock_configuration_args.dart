...
class BucketObjectLockConfigurationArgs {
  ...
  BucketObjectLockConfigurationArgs({
    ...
    pulumi.Output<BucketObjectLockConfigurationRule>? rule,
    pulumi.Output<String>? token,
      ...
      rule = pulumi.Input.asOptionalInput<BucketObjectLockConfigurationRule>(rule),
  ...
  factory BucketObjectLockConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return BucketObjectLockConfigurationArgs(
      ...
      rule: map['rule'] == null ? null : pulumi.Output.create<BucketObjectLockConfigurationRule>(BucketObjectLockConfigurationRule.fromMap((map['rule'] as Map).cast<String, dynamic>())),
