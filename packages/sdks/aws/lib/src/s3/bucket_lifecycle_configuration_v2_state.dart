...
class BucketLifecycleConfigurationV2State {
  ...
  factory BucketLifecycleConfigurationV2State.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleConfigurationV2State(
      ...
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BucketLifecycleConfigurationV2Rule>(guardedValue, (value) => BucketLifecycleConfigurationV2Rule.fromMap((value as Map).cast<String, dynamic>()))); })(),
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketLifecycleConfigurationV2Timeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      transitionDefaultMinimumObjectSize: (() { final guardedValue = map['transitionDefaultMinimumObjectSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
