...
class BucketCorsConfigurationState {
  ...
  BucketCorsConfigurationState({
    ...
    pulumi.Output<List<BucketCorsConfigurationCorsRule>>? corsRules,
    pulumi.Output<String>? expectedBucketOwner,
    pulumi.Output<String>? region,
  }) :
      bucket = pulumi.Input.asOptionalInput<String>(bucket),
      corsRules = pulumi.Input.asOptionalInput<List<BucketCorsConfigurationCorsRule>>(corsRules),
  ...
  factory BucketCorsConfigurationState.fromMap(Map<String, dynamic> map) {
    return BucketCorsConfigurationState(
      ...
      corsRules: map['corsRules'] == null ? null : pulumi.Output.create<List<BucketCorsConfigurationCorsRule>>(pulumi.Input.decodeList<BucketCorsConfigurationCorsRule>(map['corsRules'], (value) => BucketCorsConfigurationCorsRule.fromMap((value as Map).cast<String, dynamic>()))),
