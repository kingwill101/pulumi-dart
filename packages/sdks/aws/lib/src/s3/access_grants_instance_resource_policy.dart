...
import 'access_grants_instance_resource_policy_state.dart';
...
class AccessGrantsInstanceResourcePolicy extends pulumi.CustomResource {
  ...
  static AccessGrantsInstanceResourcePolicy get(
    String name,
    pulumi.Input<String> id, {
    AccessGrantsInstanceResourcePolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AccessGrantsInstanceResourcePolicy._get(
      name,
      state: state?.toMap(),
  ...
  AccessGrantsInstanceResourcePolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AccessGrantsInstanceResourcePolicy] resource.
  AccessGrantsInstanceResourcePolicy.reference(String urn)
    : super(
        'aws:s3control/accessGrantsInstanceResourcePolicy:AccessGrantsInstanceResourcePolicy',
