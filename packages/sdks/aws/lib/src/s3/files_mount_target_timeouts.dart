...
class FilesMountTargetTimeouts {
  ...
  /// Creates a new [FilesMountTargetTimeouts].
  ...
  const FilesMountTargetTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory FilesMountTargetTimeouts.fromMap(Map<String, dynamic> map) {
    return FilesMountTargetTimeouts(
