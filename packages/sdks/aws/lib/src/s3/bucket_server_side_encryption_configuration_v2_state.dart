...
class BucketServerSideEncryptionConfigurationV2State {
  ...
  final pulumi.Input<List<BucketServerSideEncryptionConfigurationV2Rule>>?
  rules;
  ...
  factory BucketServerSideEncryptionConfigurationV2State.fromMap(
    ...
    return BucketServerSideEncryptionConfigurationV2State(
      ...
      rules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<BucketServerSideEncryptionConfigurationV2Rule>(
            guardedValue,
            (value) => BucketServerSideEncryptionConfigurationV2Rule.fromMap(
