...
class MultiRegionAccessPointDetails {
  ...
  final pulumi.Input<MultiRegionAccessPointDetailsPublicAccessBlock>?
  publicAccessBlock;
    ...
    return <String, dynamic>{
      ...
      'publicAccessBlock':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(publicAccessBlock, (value) => value.toMap()),
      'regions':
          pulumi.Input.mapInputValue<
            List<MultiRegionAccessPointDetailsRegion>,
  ...
  factory MultiRegionAccessPointDetails.fromMap(Map<String, dynamic> map) {
    return MultiRegionAccessPointDetails(
      ...
      publicAccessBlock: (() {
        final guardedValue = map['publicAccessBlock'];
      ...
      regions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<MultiRegionAccessPointDetailsRegion>(
          map['regions']!,
