    ...
    return <String, dynamic>{
      'ands':
          pulumi.Input.mapInputValue<
            List<GetBucketReplicationConfigurationRuleFilterAnd>,
      ...
      'tags':
          pulumi.Input.mapInputValue<
            List<GetBucketReplicationConfigurationRuleFilterTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
  ...
  factory GetBucketReplicationConfigurationRuleFilter.fromMap(
    ...
    return GetBucketReplicationConfigurationRuleFilter(
      ands: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBucketReplicationConfigurationRuleFilterAnd>(
          map['ands']!,
      ...
      tags: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetBucketReplicationConfigurationRuleFilterTag>(
          map['tags']!,
