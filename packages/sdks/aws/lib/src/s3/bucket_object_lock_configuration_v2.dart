...
import 'bucket_object_lock_configuration_v2_state.dart';
...
class BucketObjectLockConfigurationV2 extends pulumi.CustomResource {
  ...
  /// Gets an existing [BucketObjectLockConfigurationV2] resource's state with the given [name] and [id].
  static BucketObjectLockConfigurationV2 get(
    String name,
    pulumi.Input<String> id, {
    BucketObjectLockConfigurationV2State? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BucketObjectLockConfigurationV2._get(
      name,
      state: state?.toMap(),
  ...
  BucketObjectLockConfigurationV2._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [BucketObjectLockConfigurationV2] resource.
  BucketObjectLockConfigurationV2.reference(String urn)
    : super(
        'aws:s3/bucketObjectLockConfigurationV2:BucketObjectLockConfigurationV2',
