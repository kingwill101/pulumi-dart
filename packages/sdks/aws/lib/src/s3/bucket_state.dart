...
class BucketState {
  ...
  factory BucketState.fromMap(Map<String, dynamic> map) {
    return BucketState(
      ...
      grants: map['grants'] == null ? null : (pulumi.Input.decodeList<BucketGrant>(map['grants'], (value) => BucketGrant.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : (BucketObjectLockConfiguration.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>())).input(),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : (map['objectLockEnabled'] as bool).input(),
      policy: map['policy'] == null ? null : (map['policy'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      replicationConfiguration: map['replicationConfiguration'] == null ? null : (BucketReplicationConfiguration.fromMap((map['replicationConfiguration'] as Map).cast<String, dynamic>())).input(),
      requestPayer: map['requestPayer'] == null ? null : (map['requestPayer'] as String).input(),
      serverSideEncryptionConfiguration: map['serverSideEncryptionConfiguration'] == null ? null : (BucketServerSideEncryptionConfiguration.fromMap((map['serverSideEncryptionConfiguration'] as Map).cast<String, dynamic>())).input(),
