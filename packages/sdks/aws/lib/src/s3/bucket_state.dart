    ...
    return <String, dynamic>{
      ...
      'grants':
          ...
          >(
            grants,
            (value) =>
                pulumi.Input.encodeList<BucketGrant, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory BucketState.fromMap(Map<String, dynamic> map) {
    return BucketState(
      ...
      grants: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketGrant>(
            guardedValue,
            (value) =>
                BucketGrant.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      hostedZoneId: (() {
      ...
      objectLockConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketObjectLockConfiguration.fromMap(
      ...
      replicationConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketReplicationConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      serverSideEncryptionConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketServerSideEncryptionConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
