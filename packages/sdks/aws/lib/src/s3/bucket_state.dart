...
class BucketState {
  ...
  BucketState({
    ...
    pulumi.Output<List<BucketGrant>>? grants,
    ...
    pulumi.Output<BucketObjectLockConfiguration>? objectLockConfiguration,
    pulumi.Output<bool>? objectLockEnabled,
    pulumi.Output<String>? policy,
    pulumi.Output<String>? region,
    pulumi.Output<BucketReplicationConfiguration>? replicationConfiguration,
    pulumi.Output<String>? requestPayer,
    pulumi.Output<BucketServerSideEncryptionConfiguration>? serverSideEncryptionConfiguration,
    ...
    pulumi.Output<String>? websiteEndpoint,
      ...
      grants = pulumi.Input.asOptionalInput<List<BucketGrant>>(grants),
      ...
      objectLockConfiguration = pulumi.Input.asOptionalInput<BucketObjectLockConfiguration>(objectLockConfiguration),
      objectLockEnabled = pulumi.Input.asOptionalInput<bool>(objectLockEnabled),
      policy = pulumi.Input.asOptionalInput<String>(policy),
      region = pulumi.Input.asOptionalInput<String>(region),
      replicationConfiguration = pulumi.Input.asOptionalInput<BucketReplicationConfiguration>(replicationConfiguration),
      requestPayer = pulumi.Input.asOptionalInput<String>(requestPayer),
      serverSideEncryptionConfiguration = pulumi.Input.asOptionalInput<BucketServerSideEncryptionConfiguration>(serverSideEncryptionConfiguration),
  ...
  factory BucketState.fromMap(Map<String, dynamic> map) {
    return BucketState(
      ...
      grants: map['grants'] == null ? null : pulumi.Output.create<List<BucketGrant>>(pulumi.Input.decodeList<BucketGrant>(map['grants'], (value) => BucketGrant.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : pulumi.Output.create<BucketObjectLockConfiguration>(BucketObjectLockConfiguration.fromMap((map['objectLockConfiguration'] as Map).cast<String, dynamic>())),
      ...
      replicationConfiguration: map['replicationConfiguration'] == null ? null : pulumi.Output.create<BucketReplicationConfiguration>(BucketReplicationConfiguration.fromMap((map['replicationConfiguration'] as Map).cast<String, dynamic>())),
      requestPayer: map['requestPayer'] == null ? null : pulumi.Output.create<String>(map['requestPayer'] as String),
      serverSideEncryptionConfiguration: map['serverSideEncryptionConfiguration'] == null ? null : pulumi.Output.create<BucketServerSideEncryptionConfiguration>(BucketServerSideEncryptionConfiguration.fromMap((map['serverSideEncryptionConfiguration'] as Map).cast<String, dynamic>())),
