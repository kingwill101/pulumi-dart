...
import 'table_replication_state.dart';
...
class TableReplication extends pulumi.CustomResource {
  ...
  /// Gets an existing [TableReplication] resource's state with the given [name] and [id].
  static TableReplication get(
    String name,
