...
class BucketWebsiteConfigurationRoutingRuleCondition {
  ...
  /// [httpErrorCodeReturnedEquals] HTTP error code when the redirect is applied. If specified with `keyPrefixEquals`, then both must be true for the redirect to be applied.
  /// [keyPrefixEquals] Object key name prefix when the redirect is applied. If specified with `httpErrorCodeReturnedEquals`, then both must be true for the redirect to be applied.
  const BucketWebsiteConfigurationRoutingRuleCondition({
