...
class GetBucketNotificationQueue {
  ...
  /// Creates a new [GetBucketNotificationQueue].
  ...
  const GetBucketNotificationQueue({
  ...
  factory GetBucketNotificationQueue.fromMap(Map<String, dynamic> map) {
    return GetBucketNotificationQueue(
