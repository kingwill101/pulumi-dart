...
class TableBucket extends pulumi.CustomResource {
  ...
  TableBucket(
    ...
    this.encryptionConfiguration = registerOutput<TableBucketEncryptionConfiguration?>('encryptionConfiguration');
    this.forceDestroy = registerOutput<bool>('forceDestroy');
    this.maintenanceConfiguration = registerOutput<TableBucketMaintenanceConfiguration>('maintenanceConfiguration');
