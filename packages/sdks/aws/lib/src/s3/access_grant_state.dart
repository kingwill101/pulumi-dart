...
class AccessGrantState {
  ...
  factory AccessGrantState.fromMap(Map<String, dynamic> map) {
    return AccessGrantState(
      accessGrantArn: (() {
        final guardedValue = map['accessGrantArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      accessGrantId: (() {
        final guardedValue = map['accessGrantId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      accessGrantsLocationConfiguration: (() {
      ...
      accessGrantsLocationId: (() {
        final guardedValue = map['accessGrantsLocationId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      accountId: (() {
      ...
      grantScope: (() {
        final guardedValue = map['grantScope'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      grantee: (() {
