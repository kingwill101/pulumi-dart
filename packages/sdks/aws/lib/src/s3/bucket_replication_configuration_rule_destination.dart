...
class BucketReplicationConfigurationRuleDestination {
  ...
  factory BucketReplicationConfigurationRuleDestination.fromMap(Map<String, dynamic> map) {
    return BucketReplicationConfigurationRuleDestination(
      accessControlTranslation: (() { final guardedValue = map['accessControlTranslation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketReplicationConfigurationRuleDestinationAccessControlTranslation.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      accountId: (() { final guardedValue = map['accountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bucket: pulumi.Input.fromValue(map['bucket'] as String),
      metrics: (() { final guardedValue = map['metrics']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketReplicationConfigurationRuleDestinationMetrics.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      replicationTime: (() { final guardedValue = map['replicationTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketReplicationConfigurationRuleDestinationReplicationTime.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
