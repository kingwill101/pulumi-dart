...
class ObjectLambdaAccessPointArgs {
  ...
  ObjectLambdaAccessPointArgs({
    ...
    required pulumi.Output<ObjectLambdaAccessPointConfiguration> configuration,
    pulumi.Output<String>? name,
    pulumi.Output<String>? region,
  }) :
      accountId = pulumi.Input.asOptionalInput<String>(accountId),
      configuration = pulumi.Input.asInput<ObjectLambdaAccessPointConfiguration>(configuration),
  ...
  factory ObjectLambdaAccessPointArgs.fromMap(Map<String, dynamic> map) {
    return ObjectLambdaAccessPointArgs(
      ...
      configuration: pulumi.Output.create<ObjectLambdaAccessPointConfiguration>(ObjectLambdaAccessPointConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>())),
