...
import 'bucket_lifecycle_configuration_state.dart';
...
class BucketLifecycleConfiguration extends pulumi.CustomResource {
  ...
  BucketLifecycleConfiguration(
    ...
    rules = registerOutput<List<BucketLifecycleConfigurationRule>?>('rules', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<BucketLifecycleConfigurationRule>(guardedValue, (value) => BucketLifecycleConfigurationRule.fromMap((value as Map).cast<String, dynamic>())); });
    timeouts = registerOutput<BucketLifecycleConfigurationTimeouts?>('timeouts', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return BucketLifecycleConfigurationTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    transitionDefaultMinimumObjectSize = registerOutput<String>('transitionDefaultMinimumObjectSize');
  }

  /// Gets an existing [BucketLifecycleConfiguration] resource's state with the given [name] and [id].
  static BucketLifecycleConfiguration get(
    String name,
    pulumi.Input<String> id, {
    BucketLifecycleConfigurationState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BucketLifecycleConfiguration._get(
      name,
      state: state?.toMap(),
  ...
  BucketLifecycleConfiguration._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [BucketLifecycleConfiguration] resource.
  BucketLifecycleConfiguration.reference(String urn)
    : super(
        'aws:s3/bucketLifecycleConfiguration:BucketLifecycleConfiguration',
