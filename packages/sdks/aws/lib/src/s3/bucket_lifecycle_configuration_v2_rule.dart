...
class BucketLifecycleConfigurationV2Rule {
  ...
  final pulumi.Input<List<BucketLifecycleConfigurationV2RuleTransition>>?
  transitions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'transitions':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketLifecycleConfigurationV2RuleTransition>,
            List<Map<String, dynamic>>
          >(
            transitions,
            (value) =>
    ...
    return BucketLifecycleConfigurationV2Rule(
      abortIncompleteMultipartUpload: (() {
        ...
        return pulumi.Input.fromValue(
          BucketLifecycleConfigurationV2RuleAbortIncompleteMultipartUpload.fromMap(
      ...
      noncurrentVersionExpiration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketLifecycleConfigurationV2RuleNoncurrentVersionExpiration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      noncurrentVersionTransitions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                BucketLifecycleConfigurationV2RuleNoncurrentVersionTransition.fromMap(
      ...
      transitions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketLifecycleConfigurationV2RuleTransition>(
            guardedValue,
