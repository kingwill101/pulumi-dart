...
class BucketLifecycleConfigurationV2Rule {
  ...
  final BucketLifecycleConfigurationV2RuleAbortIncompleteMultipartUpload? abortIncompleteMultipartUpload;
  ...
  final BucketLifecycleConfigurationV2RuleNoncurrentVersionExpiration? noncurrentVersionExpiration;
  /// Set of configuration blocks that specify the transition rule for the lifecycle rule that describes when noncurrent objects transition to a specific storage class. See below.
  final List<BucketLifecycleConfigurationV2RuleNoncurrentVersionTransition>? noncurrentVersionTransitions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'noncurrentVersionTransitions': ?noncurrentVersionTransitions == null ? null : pulumi.Input.encodeList<BucketLifecycleConfigurationV2RuleNoncurrentVersionTransition, Map<String, dynamic>>(noncurrentVersionTransitions!, (value) => value.toMap()),
      'prefix': ?prefix,
      'status': status,
      'transitions': ?transitions == null ? null : pulumi.Input.encodeList<BucketLifecycleConfigurationV2RuleTransition, Map<String, dynamic>>(transitions!, (value) => value.toMap()),
    };
  }

  factory BucketLifecycleConfigurationV2Rule.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleConfigurationV2Rule(
      abortIncompleteMultipartUpload: map['abortIncompleteMultipartUpload'] == null ? null : BucketLifecycleConfigurationV2RuleAbortIncompleteMultipartUpload.fromMap((map['abortIncompleteMultipartUpload'] as Map).cast<String, dynamic>()),
      expiration: map['expiration'] == null ? null : BucketLifecycleConfigurationV2RuleExpiration.fromMap((map['expiration'] as Map).cast<String, dynamic>()),
      filter: map['filter'] == null ? null : BucketLifecycleConfigurationV2RuleFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      id: map['id'] as String,
      noncurrentVersionExpiration: map['noncurrentVersionExpiration'] == null ? null : BucketLifecycleConfigurationV2RuleNoncurrentVersionExpiration.fromMap((map['noncurrentVersionExpiration'] as Map).cast<String, dynamic>()),
      noncurrentVersionTransitions: map['noncurrentVersionTransitions'] == null ? null : pulumi.Input.decodeList<BucketLifecycleConfigurationV2RuleNoncurrentVersionTransition>(map['noncurrentVersionTransitions'], (value) => BucketLifecycleConfigurationV2RuleNoncurrentVersionTransition.fromMap((value as Map).cast<String, dynamic>())),
      prefix: map['prefix'] == null ? null : map['prefix'] as String,
      status: map['status'] as String,
      transitions: map['transitions'] == null ? null : pulumi.Input.decodeList<BucketLifecycleConfigurationV2RuleTransition>(map['transitions'], (value) => BucketLifecycleConfigurationV2RuleTransition.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
