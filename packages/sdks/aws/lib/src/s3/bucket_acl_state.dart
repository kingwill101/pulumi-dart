...
class BucketAclState {
  ...
  factory BucketAclState.fromMap(Map<String, dynamic> map) {
    return BucketAclState(
      accessControlPolicy: (() { final guardedValue = map['accessControlPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketAclAccessControlPolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
