...
class BucketServerSideEncryptionConfigurationS3 extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [BucketServerSideEncryptionConfigurationS3]. {@macro pulumi_s3_bucket_server_side_encryption_configuration_bucket_server_side_encryption_configuration_args_doc}
  ...
  static BucketServerSideEncryptionConfigurationS3 get(
    String name,
  ...
  BucketServerSideEncryptionConfigurationS3._get(
    String name, {
