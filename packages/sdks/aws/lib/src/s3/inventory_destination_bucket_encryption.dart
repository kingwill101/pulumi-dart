...
class InventoryDestinationBucketEncryption {
  ...
  /// [sseS3] Server-side encryption with Amazon S3-managed keys (SSE-S3) to encrypt the inventory file.
  const InventoryDestinationBucketEncryption({
    this.sseKms,
    this.sseS3,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'sseKms': ?pulumi.Input.mapOptionalInputValue<InventoryDestinationBucketEncryptionSseKms, Map<String, dynamic>>(sseKms, (value) => value.toMap()),
      'sseS3': ?sseS3,
    };
  }
  ...
  factory InventoryDestinationBucketEncryption.fromMap(Map<String, dynamic> map) {
    return InventoryDestinationBucketEncryption(
      sseKms: (() { final guardedValue = map['sseKms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(InventoryDestinationBucketEncryptionSseKms.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sseS3: (() { final guardedValue = map['sseS3']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
    );
  }
}
