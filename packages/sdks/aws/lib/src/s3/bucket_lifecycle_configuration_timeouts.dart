...
class BucketLifecycleConfigurationTimeouts {
  ...
  const BucketLifecycleConfigurationTimeouts({
    this.create,
    this.update,
  });
  ...
  factory BucketLifecycleConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return BucketLifecycleConfigurationTimeouts(
