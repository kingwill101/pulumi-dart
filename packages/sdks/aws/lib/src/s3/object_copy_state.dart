...
class ObjectCopyState {
  ...
  factory ObjectCopyState.fromMap(Map<String, dynamic> map) {
    return ObjectCopyState(
      ...
      checksumCrc32: map['checksumCrc32'] == null ? null : ((map['checksumCrc32'] as String).input()).input(),
      checksumCrc32c: map['checksumCrc32c'] == null ? null : ((map['checksumCrc32c'] as String).input()).input(),
      checksumCrc64nvme: map['checksumCrc64nvme'] == null ? null : ((map['checksumCrc64nvme'] as String).input()).input(),
      checksumSha1: map['checksumSha1'] == null ? null : ((map['checksumSha1'] as String).input()).input(),
      checksumSha256: map['checksumSha256'] == null ? null : ((map['checksumSha256'] as String).input()).input(),
      ...
      requestCharged: map['requestCharged'] == null ? null : ((map['requestCharged'] as bool).input()).input(),
      ...
      sourceVersionId: map['sourceVersionId'] == null ? null : ((map['sourceVersionId'] as String).input()).input(),
