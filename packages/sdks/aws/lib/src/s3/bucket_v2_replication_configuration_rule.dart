...
class BucketV2ReplicationConfigurationRule {
  ...
  final pulumi.Input<List<BucketV2ReplicationConfigurationRuleDestination>>
  destinations;
  ...
  final pulumi.Input<
    List<BucketV2ReplicationConfigurationRuleSourceSelectionCriteria>
  >?
    ...
    return <String, dynamic>{
      ...
      'destinations':
          pulumi.Input.mapInputValue<
            List<BucketV2ReplicationConfigurationRuleDestination>,
      ...
      'filters':
          ?pulumi.Input.mapOptionalInputValue<
            List<BucketV2ReplicationConfigurationRuleFilter>,
            List<Map<String, dynamic>>
          >(
            filters,
            (value) =>
  ...
  factory BucketV2ReplicationConfigurationRule.fromMap(
    ...
    return BucketV2ReplicationConfigurationRule(
      ...
      sourceSelectionCriterias: (() {
        final guardedValue = map['sourceSelectionCriterias'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
