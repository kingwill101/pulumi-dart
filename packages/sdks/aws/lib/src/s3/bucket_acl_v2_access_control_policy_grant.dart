...
class BucketAclV2AccessControlPolicyGrant {
  ...
  const BucketAclV2AccessControlPolicyGrant({
    this.grantee,
  ...
  factory BucketAclV2AccessControlPolicyGrant.fromMap(Map<String, dynamic> map) {
    return BucketAclV2AccessControlPolicyGrant(
      grantee: (() { final guardedValue = map['grantee']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BucketAclV2AccessControlPolicyGrantGrantee.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
