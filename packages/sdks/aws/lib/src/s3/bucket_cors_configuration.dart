...
class BucketCorsConfiguration extends pulumi.CustomResource {
  ...
  /// Creates a new [BucketCorsConfiguration].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BucketCorsConfiguration]. {@macro pulumi_s3_bucket_cors_configuration_bucket_cors_configuration_args_doc}
  ...
  BucketCorsConfiguration(
    ...
    this.corsRules = registerOutput<List<BucketCorsConfigurationCorsRule>>('corsRules');
    this.expectedBucketOwner = registerOutput<String?>('expectedBucketOwner');
    this.region = registerOutput<String>('region');
  }

  /// Gets an existing [BucketCorsConfiguration] resource's state with the given [name] and [id].
  static BucketCorsConfiguration get(
    String name,
