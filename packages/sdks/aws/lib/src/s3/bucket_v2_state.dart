  ...
  factory BucketV2State.fromMap(Map<String, dynamic> map) {
    return BucketV2State(
      ...
      bucketRegionalDomainName: (() {
        final guardedValue = map['bucketRegionalDomainName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      corsRules: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2CorsRule>(
            guardedValue,
            (value) => BucketV2CorsRule.fromMap(
      ...
      grants: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2Grant>(
            guardedValue,
            (value) =>
                BucketV2Grant.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      hostedZoneId: (() {
      ...
      lifecycleRules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2LifecycleRule>(
            guardedValue,
            (value) => BucketV2LifecycleRule.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      loggings: (() {
        final guardedValue = map['loggings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2Logging>(
            guardedValue,
            (value) =>
                BucketV2Logging.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      objectLockConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BucketV2ObjectLockConfiguration.fromMap(
      ...
      replicationConfigurations: (() {
        final guardedValue = map['replicationConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2ReplicationConfiguration>(
            guardedValue,
            (value) => BucketV2ReplicationConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      serverSideEncryptionConfigurations: (() {
        final guardedValue = map['serverSideEncryptionConfigurations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2ServerSideEncryptionConfiguration>(
            guardedValue,
            (value) => BucketV2ServerSideEncryptionConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      versionings: (() {
        final guardedValue = map['versionings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2Versioning>(
            guardedValue,
            (value) => BucketV2Versioning.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      websiteDomain: (() {
        final guardedValue = map['websiteDomain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      websiteEndpoint: (() {
        final guardedValue = map['websiteEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      websites: (() {
        final guardedValue = map['websites'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BucketV2Website>(
            guardedValue,
            (value) =>
                BucketV2Website.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
