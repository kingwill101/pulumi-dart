...
class BucketV2State {
  ...
  factory BucketV2State.fromMap(Map<String, dynamic> map) {
    return BucketV2State(
      ...
      corsRules: map['corsRules'] == null ? null : ((pulumi.Input.decodeList<BucketV2CorsRule>(map['corsRules']!, (value) => BucketV2CorsRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      forceDestroy: map['forceDestroy'] == null ? null : ((map['forceDestroy'] as bool).input()).input(),
      grants: map['grants'] == null ? null : ((pulumi.Input.decodeList<BucketV2Grant>(map['grants']!, (value) => BucketV2Grant.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      hostedZoneId: map['hostedZoneId'] == null ? null : ((map['hostedZoneId'] as String).input()).input(),
      lifecycleRules: map['lifecycleRules'] == null ? null : ((pulumi.Input.decodeList<BucketV2LifecycleRule>(map['lifecycleRules']!, (value) => BucketV2LifecycleRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      loggings: map['loggings'] == null ? null : ((pulumi.Input.decodeList<BucketV2Logging>(map['loggings']!, (value) => BucketV2Logging.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      objectLockConfiguration: map['objectLockConfiguration'] == null ? null : ((BucketV2ObjectLockConfiguration.fromMap((map['objectLockConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      objectLockEnabled: map['objectLockEnabled'] == null ? null : ((map['objectLockEnabled'] as bool).input()).input(),
      policy: map['policy'] == null ? null : ((map['policy'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      replicationConfigurations: map['replicationConfigurations'] == null ? null : ((pulumi.Input.decodeList<BucketV2ReplicationConfiguration>(map['replicationConfigurations']!, (value) => BucketV2ReplicationConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      requestPayer: map['requestPayer'] == null ? null : ((map['requestPayer'] as String).input()).input(),
      serverSideEncryptionConfigurations: map['serverSideEncryptionConfigurations'] == null ? null : ((pulumi.Input.decodeList<BucketV2ServerSideEncryptionConfiguration>(map['serverSideEncryptionConfigurations']!, (value) => BucketV2ServerSideEncryptionConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      versionings: map['versionings'] == null ? null : ((pulumi.Input.decodeList<BucketV2Versioning>(map['versionings']!, (value) => BucketV2Versioning.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      websites: map['websites'] == null ? null : ((pulumi.Input.decodeList<BucketV2Website>(map['websites']!, (value) => BucketV2Website.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
