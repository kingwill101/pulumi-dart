...
class GetAccessPointsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accessPoints': ?(() { final guardedValue = accessPoints; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetAccessPointsAccessPoint, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'accountId': ?accountId,
      'bucket': ?bucket,
  ...
  factory GetAccessPointsResult.fromMap(Map<String, dynamic> map) {
    return GetAccessPointsResult(
      accessPoints: (() { final guardedValue = map['accessPoints']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetAccessPointsAccessPoint>(guardedValue, (value) => GetAccessPointsAccessPoint.fromMap((value as Map).cast<String, dynamic>())); })(),
