...
import 'bucket_request_payment_configuration_v2_state.dart';
...
class BucketRequestPaymentConfigurationV2 extends pulumi.CustomResource {
  ...
  /// Creates a new [BucketRequestPaymentConfigurationV2].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [BucketRequestPaymentConfigurationV2]. {@macro pulumi_s3_bucket_request_payment_configuration_v2_bucket_request_payment_configuration_v2_args_doc}
  ...
  static BucketRequestPaymentConfigurationV2 get(
    String name,
    pulumi.Input<String> id, {
    BucketRequestPaymentConfigurationV2State? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return BucketRequestPaymentConfigurationV2._get(
      name,
      state: state?.toMap(),
  ...
  BucketRequestPaymentConfigurationV2._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [BucketRequestPaymentConfigurationV2] resource.
  BucketRequestPaymentConfigurationV2.reference(String urn)
    : super(
        'aws:s3/bucketRequestPaymentConfigurationV2:BucketRequestPaymentConfigurationV2',
