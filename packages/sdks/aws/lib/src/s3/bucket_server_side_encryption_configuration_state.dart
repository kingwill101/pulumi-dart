...
class BucketServerSideEncryptionConfigurationState {
  ...
  factory BucketServerSideEncryptionConfigurationState.fromMap(Map<String, dynamic> map) {
    return BucketServerSideEncryptionConfigurationState(
      ...
      rules: map['rules'] == null ? null : ((pulumi.Input.decodeList<BucketServerSideEncryptionConfigurationRule>(map['rules']!, (value) => BucketServerSideEncryptionConfigurationRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
