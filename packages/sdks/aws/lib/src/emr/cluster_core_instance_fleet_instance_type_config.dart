...
class ClusterCoreInstanceFleetInstanceTypeConfig {
  ...
  final pulumi.Input<
    List<ClusterCoreInstanceFleetInstanceTypeConfigConfiguration>
  >?
  configurations;

  /// Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
  final pulumi.Input<List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig>>?
  ebsConfigs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ebsConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig>,
            List<Map<String, dynamic>>
          >(
            ebsConfigs,
            (value) =>
