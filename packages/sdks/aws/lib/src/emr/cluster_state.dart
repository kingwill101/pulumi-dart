...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      additionalInfo: map['additionalInfo'] == null ? null : (map['additionalInfo'] as String).input(),
      applications: map['applications'] == null ? null : ((map['applications'] as List).cast<String>()).input(),
      arn: map['arn'] == null ? null : (map['arn'] as String).input(),
      autoTerminationPolicy: map['autoTerminationPolicy'] == null ? null : (ClusterAutoTerminationPolicy.fromMap((map['autoTerminationPolicy'] as Map).cast<String, dynamic>())).input(),
      ...
      configurations: map['configurations'] == null ? null : (map['configurations'] as String).input(),
      configurationsJson: map['configurationsJson'] == null ? null : (map['configurationsJson'] as String).input(),
      coreInstanceFleet: map['coreInstanceFleet'] == null ? null : (ClusterCoreInstanceFleet.fromMap((map['coreInstanceFleet'] as Map).cast<String, dynamic>())).input(),
      coreInstanceGroup: map['coreInstanceGroup'] == null ? null : (ClusterCoreInstanceGroup.fromMap((map['coreInstanceGroup'] as Map).cast<String, dynamic>())).input(),
      ...
      ec2Attributes: map['ec2Attributes'] == null ? null : (ClusterEc2Attributes.fromMap((map['ec2Attributes'] as Map).cast<String, dynamic>())).input(),
      keepJobFlowAliveWhenNoSteps: map['keepJobFlowAliveWhenNoSteps'] == null ? null : (map['keepJobFlowAliveWhenNoSteps'] as bool).input(),
      kerberosAttributes: map['kerberosAttributes'] == null ? null : (ClusterKerberosAttributes.fromMap((map['kerberosAttributes'] as Map).cast<String, dynamic>())).input(),
      listStepsStates: map['listStepsStates'] == null ? null : ((map['listStepsStates'] as List).cast<String>()).input(),
      ...
      masterInstanceFleet: map['masterInstanceFleet'] == null ? null : (ClusterMasterInstanceFleet.fromMap((map['masterInstanceFleet'] as Map).cast<String, dynamic>())).input(),
      masterInstanceGroup: map['masterInstanceGroup'] == null ? null : (ClusterMasterInstanceGroup.fromMap((map['masterInstanceGroup'] as Map).cast<String, dynamic>())).input(),
      masterPublicDns: map['masterPublicDns'] == null ? null : (map['masterPublicDns'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      osReleaseLabel: map['osReleaseLabel'] == null ? null : (map['osReleaseLabel'] as String).input(),
      placementGroupConfigs: map['placementGroupConfigs'] == null ? null : (pulumi.Input.decodeList<ClusterPlacementGroupConfig>(map['placementGroupConfigs'], (value) => ClusterPlacementGroupConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      releaseLabel: map['releaseLabel'] == null ? null : (map['releaseLabel'] as String).input(),
      scaleDownBehavior: map['scaleDownBehavior'] == null ? null : (map['scaleDownBehavior'] as String).input(),
      ...
      steps: map['steps'] == null ? null : (pulumi.Input.decodeList<ClusterStep>(map['steps'], (value) => ClusterStep.fromMap((value as Map).cast<String, dynamic>()))).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      terminationProtection: map['terminationProtection'] == null ? null : (map['terminationProtection'] as bool).input(),
