...
class ClusterState {
  ...
  ClusterState({
    ...
    pulumi.Output<String>? masterPublicDns,
    ...
    pulumi.Output<bool>? visibleToAllUsers,
      ...
      masterPublicDns = pulumi.Input.asOptionalInput<String>(masterPublicDns),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      masterPublicDns: map['masterPublicDns'] == null ? null : pulumi.Output.create<String>(map['masterPublicDns'] as String),
