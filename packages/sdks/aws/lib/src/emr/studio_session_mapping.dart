...
import 'studio_session_mapping_state.dart';
...
class StudioSessionMapping extends pulumi.CustomResource {
  ...
  /// Creates a new [StudioSessionMapping].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [StudioSessionMapping]. {@macro pulumi_emr_studio_session_mapping_studio_session_mapping_args_doc}
  ...
  /// Gets an existing [StudioSessionMapping] resource's state with the given [name] and [id].
  static StudioSessionMapping get(
    String name,
