...
class StudioState {
  ...
  factory StudioState.fromMap(Map<String, dynamic> map) {
    return StudioState(
      ...
      defaultS3Location: map['defaultS3Location'] == null ? null : (map['defaultS3Location'] as String).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      encryptionKeyArn: map['encryptionKeyArn'] == null ? null : (map['encryptionKeyArn'] as String).input(),
      engineSecurityGroupId: map['engineSecurityGroupId'] == null ? null : (map['engineSecurityGroupId'] as String).input(),
