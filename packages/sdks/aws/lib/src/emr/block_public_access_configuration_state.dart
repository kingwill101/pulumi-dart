...
class BlockPublicAccessConfigurationState {
  ...
  factory BlockPublicAccessConfigurationState.fromMap(
    Map<String, dynamic> map,
  ) {
    return BlockPublicAccessConfigurationState(
      blockPublicSecurityGroupRules: (() {
        final guardedValue = map['blockPublicSecurityGroupRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      permittedPublicSecurityGroupRuleRanges: (() {
        final guardedValue = map['permittedPublicSecurityGroupRuleRanges'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                BlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRange.fromMap(
