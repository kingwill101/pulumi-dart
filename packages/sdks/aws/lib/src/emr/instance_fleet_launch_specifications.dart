...
class InstanceFleetLaunchSpecifications {
  ...
  final pulumi.Input<
    List<InstanceFleetLaunchSpecificationsOnDemandSpecification>
  >?
  onDemandSpecifications;

  /// Configuration block for spot instances launch specifications
  final pulumi.Input<List<InstanceFleetLaunchSpecificationsSpotSpecification>>?
  spotSpecifications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spotSpecifications':
          ?pulumi.Input.mapOptionalInputValue<
            List<InstanceFleetLaunchSpecificationsSpotSpecification>,
            List<Map<String, dynamic>>
          >(
            spotSpecifications,
            (value) =>
      ...
      onDemandSpecifications: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                InstanceFleetLaunchSpecificationsOnDemandSpecification.fromMap(
