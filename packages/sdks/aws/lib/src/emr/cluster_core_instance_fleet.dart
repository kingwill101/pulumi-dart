...
class ClusterCoreInstanceFleet {
  ...
  final pulumi.Input<List<ClusterCoreInstanceFleetInstanceTypeConfig>>?
  instanceTypeConfigs;

  /// Configuration block for launch specification.
  final pulumi.Input<ClusterCoreInstanceFleetLaunchSpecifications>?
    ...
    return <String, dynamic>{
      ...
      'instanceTypeConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClusterCoreInstanceFleetInstanceTypeConfig>,
