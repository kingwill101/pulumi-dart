...
class ClusterCoreInstanceFleet {
  ...
  factory ClusterCoreInstanceFleet.fromMap(Map<String, dynamic> map) {
    return ClusterCoreInstanceFleet(
      ...
      instanceTypeConfigs: map['instanceTypeConfigs'] == null ? null : ((pulumi.Input.decodeList<ClusterCoreInstanceFleetInstanceTypeConfig>(map['instanceTypeConfigs']!, (value) => ClusterCoreInstanceFleetInstanceTypeConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      launchSpecifications: map['launchSpecifications'] == null ? null : ((ClusterCoreInstanceFleetLaunchSpecifications.fromMap((map['launchSpecifications']! as Map).cast<String, dynamic>())).input()).input(),
