...
class ManagedScalingPolicyComputeLimit {
  ...
  factory ManagedScalingPolicyComputeLimit.fromMap(Map<String, dynamic> map) {
    return ManagedScalingPolicyComputeLimit(
      ...
      maximumCoreCapacityUnits: map['maximumCoreCapacityUnits'] == null ? null : map['maximumCoreCapacityUnits'] as int,
      maximumOndemandCapacityUnits: map['maximumOndemandCapacityUnits'] == null ? null : map['maximumOndemandCapacityUnits'] as int,
