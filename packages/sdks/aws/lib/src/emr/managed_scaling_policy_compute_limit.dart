...
class ManagedScalingPolicyComputeLimit {
  ...
  factory ManagedScalingPolicyComputeLimit.fromMap(Map<String, dynamic> map) {
    return ManagedScalingPolicyComputeLimit(
      maximumCapacityUnits: pulumi.Input.fromValue(
        map['maximumCapacityUnits'] as int,
      ),
      maximumCoreCapacityUnits: (() {
        final guardedValue = map['maximumCoreCapacityUnits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maximumOndemandCapacityUnits: (() {
        final guardedValue = map['maximumOndemandCapacityUnits'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      minimumCapacityUnits: pulumi.Input.fromValue(
        map['minimumCapacityUnits'] as int,
      ),
