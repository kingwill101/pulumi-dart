...
class ClusterMasterInstanceFleetLaunchSpecifications {
  ...
  final pulumi.Input<
    List<ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification>
  >?
  spotSpecifications;
      ...
      onDemandSpecifications: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ClusterMasterInstanceFleetLaunchSpecificationsOnDemandSpecification.fromMap(
      ...
      spotSpecifications: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ClusterMasterInstanceFleetLaunchSpecificationsSpotSpecification.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
