...
class ClusterCoreInstanceFleetLaunchSpecifications {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spotSpecifications': ?pulumi.Input.mapOptionalInputValue<List<ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification>, List<Map<String, dynamic>>>(spotSpecifications, (value) => pulumi.Input.encodeList<ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory ClusterCoreInstanceFleetLaunchSpecifications.fromMap(Map<String, dynamic> map) {
    return ClusterCoreInstanceFleetLaunchSpecifications(
      onDemandSpecifications: (() { final guardedValue = map['onDemandSpecifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecification>(guardedValue, (value) => ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecification.fromMap((value as Map).cast<String, dynamic>()))); })(),
      spotSpecifications: (() { final guardedValue = map['spotSpecifications']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification>(guardedValue, (value) => ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
