...
class StudioArgs {
  ...
  StudioArgs({
    ...
    required pulumi.Output<String> defaultS3Location,
    pulumi.Output<String>? description,
    pulumi.Output<String>? encryptionKeyArn,
    required pulumi.Output<String> engineSecurityGroupId,
    ...
    required pulumi.Output<String> workspaceSecurityGroupId,
  }) :
  ...
  factory StudioArgs.fromMap(Map<String, dynamic> map) {
    return StudioArgs(
      ...
      defaultS3Location: pulumi.Output.create<String>(map['defaultS3Location'] as String),
      ...
      engineSecurityGroupId: pulumi.Output.create<String>(map['engineSecurityGroupId'] as String),
      ...
      workspaceSecurityGroupId: pulumi.Output.create<String>(map['workspaceSecurityGroupId'] as String),
    );
  }
}
