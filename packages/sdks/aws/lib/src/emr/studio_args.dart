...
class StudioArgs {
  ...
  /// [vpcId] ID of the VPC to associate with the Studio.
  ...
  factory StudioArgs.fromMap(Map<String, dynamic> map) {
    return StudioArgs(
      ...
      defaultS3Location: pulumi.Input.fromValue(map['defaultS3Location'] as String),
      ...
      engineSecurityGroupId: pulumi.Input.fromValue(map['engineSecurityGroupId'] as String),
      ...
      workspaceSecurityGroupId: pulumi.Input.fromValue(map['workspaceSecurityGroupId'] as String),
    );
  }
}
