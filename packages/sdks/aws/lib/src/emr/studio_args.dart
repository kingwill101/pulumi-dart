...
class StudioArgs {
  ...
  factory StudioArgs.fromMap(Map<String, dynamic> map) {
    return StudioArgs(
      ...
      idpAuthUrl: map['idpAuthUrl'] == null ? null : (map['idpAuthUrl'] as String).input(),
      idpRelayStateParameterName: map['idpRelayStateParameterName'] == null ? null : (map['idpRelayStateParameterName'] as String).input(),
