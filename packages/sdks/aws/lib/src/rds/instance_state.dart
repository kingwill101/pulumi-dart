...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      backupTarget: map['backupTarget'] == null ? null : ((map['backupTarget'] as String).input()).input(),
      backupWindow: map['backupWindow'] == null ? null : ((map['backupWindow'] as String).input()).input(),
      blueGreenUpdate: map['blueGreenUpdate'] == null ? null : ((InstanceBlueGreenUpdate.fromMap((map['blueGreenUpdate']! as Map).cast<String, dynamic>())).input()).input(),
      caCertIdentifier: map['caCertIdentifier'] == null ? null : ((map['caCertIdentifier'] as String).input()).input(),
      characterSetName: map['characterSetName'] == null ? null : ((map['characterSetName'] as String).input()).input(),
      copyTagsToSnapshot: map['copyTagsToSnapshot'] == null ? null : ((map['copyTagsToSnapshot'] as bool).input()).input(),
      customIamInstanceProfile: map['customIamInstanceProfile'] == null ? null : ((map['customIamInstanceProfile'] as String).input()).input(),
      customerOwnedIpEnabled: map['customerOwnedIpEnabled'] == null ? null : ((map['customerOwnedIpEnabled'] as bool).input()).input(),
      ...
      dedicatedLogVolume: map['dedicatedLogVolume'] == null ? null : ((map['dedicatedLogVolume'] as bool).input()).input(),
      ...
      domainAuthSecretArn: map['domainAuthSecretArn'] == null ? null : ((map['domainAuthSecretArn'] as String).input()).input(),
      domainDnsIps: map['domainDnsIps'] == null ? null : (((map['domainDnsIps'] as List).cast<String>()).input()).input(),
      domainFqdn: map['domainFqdn'] == null ? null : ((map['domainFqdn'] as String).input()).input(),
      domainIamRoleName: map['domainIamRoleName'] == null ? null : ((map['domainIamRoleName'] as String).input()).input(),
      domainOu: map['domainOu'] == null ? null : ((map['domainOu'] as String).input()).input(),
      ...
      latestRestorableTime: map['latestRestorableTime'] == null ? null : ((map['latestRestorableTime'] as String).input()).input(),
      licenseModel: map['licenseModel'] == null ? null : ((map['licenseModel'] as String).input()).input(),
      listenerEndpoints: map['listenerEndpoints'] == null ? null : ((pulumi.Input.decodeList<InstanceListenerEndpoint>(map['listenerEndpoints']!, (value) => InstanceListenerEndpoint.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      masterUserSecrets: map['masterUserSecrets'] == null ? null : ((pulumi.Input.decodeList<InstanceMasterUserSecret>(map['masterUserSecrets']!, (value) => InstanceMasterUserSecret.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      maxAllocatedStorage: map['maxAllocatedStorage'] == null ? null : ((map['maxAllocatedStorage'] as int).input()).input(),
      ...
      ncharCharacterSetName: map['ncharCharacterSetName'] == null ? null : ((map['ncharCharacterSetName'] as String).input()).input(),
      ...
      passwordWo: map['passwordWo'] == null ? null : ((map['passwordWo'] as String).input()).input(),
      passwordWoVersion: map['passwordWoVersion'] == null ? null : ((map['passwordWoVersion'] as int).input()).input(),
      ...
      replicaMode: map['replicaMode'] == null ? null : ((map['replicaMode'] as String).input()).input(),
      replicas: map['replicas'] == null ? null : (((map['replicas'] as List).cast<String>()).input()).input(),
      replicateSourceDb: map['replicateSourceDb'] == null ? null : ((map['replicateSourceDb'] as String).input()).input(),
      resourceId: map['resourceId'] == null ? null : ((map['resourceId'] as String).input()).input(),
      restoreToPointInTime: map['restoreToPointInTime'] == null ? null : ((InstanceRestoreToPointInTime.fromMap((map['restoreToPointInTime']! as Map).cast<String, dynamic>())).input()).input(),
      s3Import: map['s3Import'] == null ? null : ((InstanceS3Import.fromMap((map['s3Import']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      storageThroughput: map['storageThroughput'] == null ? null : ((map['storageThroughput'] as int).input()).input(),
      ...
      upgradeRolloutOrder: map['upgradeRolloutOrder'] == null ? null : ((map['upgradeRolloutOrder'] as String).input()).input(),
      upgradeStorageConfig: map['upgradeStorageConfig'] == null ? null : ((map['upgradeStorageConfig'] as bool).input()).input(),
