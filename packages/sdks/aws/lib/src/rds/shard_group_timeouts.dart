...
class ShardGroupTimeouts {
  ...
  /// Creates a new [ShardGroupTimeouts].
  ...
  ShardGroupTimeouts({this.create, this.delete, this.update});
  ...
  factory ShardGroupTimeouts.fromMap(Map<String, dynamic> map) {
    return ShardGroupTimeouts(
      create: (() {
