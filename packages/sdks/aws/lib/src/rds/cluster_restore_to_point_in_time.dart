...
class ClusterRestoreToPointInTime {
  ...
  factory ClusterRestoreToPointInTime.fromMap(Map<String, dynamic> map) {
    return ClusterRestoreToPointInTime(
      ...
      sourceClusterIdentifier: (() { final guardedValue = map['sourceClusterIdentifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
