...
class ClusterRestoreToPointInTime {
  ...
  factory ClusterRestoreToPointInTime.fromMap(Map<String, dynamic> map) {
    return ClusterRestoreToPointInTime(
      ...
      sourceClusterIdentifier: map['sourceClusterIdentifier'] == null ? null : map['sourceClusterIdentifier'] as String,
      sourceClusterResourceId: map['sourceClusterResourceId'] == null ? null : map['sourceClusterResourceId'] as String,
