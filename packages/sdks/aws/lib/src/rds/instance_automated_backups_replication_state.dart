...
class InstanceAutomatedBackupsReplicationState {
  ...
  InstanceAutomatedBackupsReplicationState({
    ...
    pulumi.Output<String>? sourceDbInstanceArn,
  }) :
      ...
      sourceDbInstanceArn = pulumi.Input.asOptionalInput<String>(sourceDbInstanceArn);
  ...
  factory InstanceAutomatedBackupsReplicationState.fromMap(Map<String, dynamic> map) {
    return InstanceAutomatedBackupsReplicationState(
      ...
      sourceDbInstanceArn: map['sourceDbInstanceArn'] == null ? null : pulumi.Output.create<String>(map['sourceDbInstanceArn'] as String),
    );
  }
}
