...
import 'custom_db_engine_version_state.dart';
...
class CustomDbEngineVersion extends pulumi.CustomResource {
  ...
  CustomDbEngineVersion(
    ...
    databaseInstallationFilesS3BucketName = registerOutput<String?>(
      'databaseInstallationFilesS3BucketName',
    );
    databaseInstallationFilesS3Prefix = registerOutput<String?>(
  ...
  static CustomDbEngineVersion get(
    String name,
