...
class CustomDbEngineVersionState {
  ...
  factory CustomDbEngineVersionState.fromMap(Map<String, dynamic> map) {
    return CustomDbEngineVersionState(
      ...
      dbParameterGroupFamily: map['dbParameterGroupFamily'] == null ? null : ((map['dbParameterGroupFamily'] as String).input()).input(),
      ...
      manifestComputed: map['manifestComputed'] == null ? null : ((map['manifestComputed'] as String).input()).input(),
