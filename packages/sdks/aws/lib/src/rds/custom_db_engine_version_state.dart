...
class CustomDbEngineVersionState {
  ...
  factory CustomDbEngineVersionState.fromMap(Map<String, dynamic> map) {
    return CustomDbEngineVersionState(
      ...
      databaseInstallationFilesS3BucketName: (() {
        final guardedValue = map['databaseInstallationFilesS3BucketName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      databaseInstallationFilesS3Prefix: (() {
        final guardedValue = map['databaseInstallationFilesS3Prefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbParameterGroupFamily: (() {
        final guardedValue = map['dbParameterGroupFamily'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      description: (() {
      ...
      manifestComputed: (() {
        final guardedValue = map['manifestComputed'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      manifestHash: (() {
