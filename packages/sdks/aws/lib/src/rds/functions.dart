...
import 'get_events_args.dart';
import 'get_events_result.dart';
...
///           - maintenance
/// ```
/// [args] Arguments passed to this invoke. {@macro pulumi_rds_get_events_get_events_args_doc}
/// [options] Invoke options controlling this call.
Future<GetEventsResult> getEvents(
  ...
  final deployment = pulumi.Deployment.instance;
  final result = await deployment.invoke<Map<String, dynamic>>(
    'aws:rds/getEvents:getEvents',
    args.toMap(),
    options: pulumi.toDeploymentInvokeOptions(options),
  );
  return GetEventsResult.fromMap(result);
}

pulumi.Output<GetEventsResult> getEventsOutput(
  GetEventsArgs args, {
  pulumi.InvokeOutputOptions? options,
}) {
  return pulumi.invokeOutput<Map<String, dynamic>>(
