...
class ProxyAuth {
  ...
  factory ProxyAuth.fromMap(Map<String, dynamic> map) {
    return ProxyAuth(
      authScheme: map['authScheme'] == null ? null : map['authScheme'] as String,
      clientPasswordAuthType: map['clientPasswordAuthType'] == null ? null : map['clientPasswordAuthType'] as String,
