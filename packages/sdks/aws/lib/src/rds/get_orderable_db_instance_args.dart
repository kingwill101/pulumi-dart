...
class GetOrderableDbInstanceArgs {
  ...
  factory GetOrderableDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceArgs(
      availabilityZoneGroup: map['availabilityZoneGroup'] == null ? null : (map['availabilityZoneGroup'] as String).input(),
      engine: (map['engine'] as String).input(),
      engineLatestVersion: map['engineLatestVersion'] == null ? null : (map['engineLatestVersion'] as bool).input(),
      ...
      preferredEngineVersions: map['preferredEngineVersions'] == null ? null : ((map['preferredEngineVersions'] as List).cast<String>()).input(),
      preferredInstanceClasses: map['preferredInstanceClasses'] == null ? null : ((map['preferredInstanceClasses'] as List).cast<String>()).input(),
      readReplicaCapable: map['readReplicaCapable'] == null ? null : (map['readReplicaCapable'] as bool).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      storageType: map['storageType'] == null ? null : (map['storageType'] as String).input(),
      supportedEngineModes: map['supportedEngineModes'] == null ? null : ((map['supportedEngineModes'] as List).cast<String>()).input(),
      supportedNetworkTypes: map['supportedNetworkTypes'] == null ? null : ((map['supportedNetworkTypes'] as List).cast<String>()).input(),
      supportsClusters: map['supportsClusters'] == null ? null : (map['supportsClusters'] as bool).input(),
      supportsEnhancedMonitoring: map['supportsEnhancedMonitoring'] == null ? null : (map['supportsEnhancedMonitoring'] as bool).input(),
      supportsGlobalDatabases: map['supportsGlobalDatabases'] == null ? null : (map['supportsGlobalDatabases'] as bool).input(),
      supportsIamDatabaseAuthentication: map['supportsIamDatabaseAuthentication'] == null ? null : (map['supportsIamDatabaseAuthentication'] as bool).input(),
      supportsIops: map['supportsIops'] == null ? null : (map['supportsIops'] as bool).input(),
      supportsKerberosAuthentication: map['supportsKerberosAuthentication'] == null ? null : (map['supportsKerberosAuthentication'] as bool).input(),
      supportsMultiAz: map['supportsMultiAz'] == null ? null : (map['supportsMultiAz'] as bool).input(),
      supportsPerformanceInsights: map['supportsPerformanceInsights'] == null ? null : (map['supportsPerformanceInsights'] as bool).input(),
      supportsStorageAutoscaling: map['supportsStorageAutoscaling'] == null ? null : (map['supportsStorageAutoscaling'] as bool).input(),
      supportsStorageEncryption: map['supportsStorageEncryption'] == null ? null : (map['supportsStorageEncryption'] as bool).input(),
