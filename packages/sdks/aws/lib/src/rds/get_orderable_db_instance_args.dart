...
class GetOrderableDbInstanceArgs {
  ...
  factory GetOrderableDbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return GetOrderableDbInstanceArgs(
      availabilityZoneGroup: map['availabilityZoneGroup'] == null ? null : ((map['availabilityZoneGroup'] as String).input()).input(),
      engine: (map['engine'] as String).input(),
      engineLatestVersion: map['engineLatestVersion'] == null ? null : ((map['engineLatestVersion'] as bool).input()).input(),
      ...
      preferredEngineVersions: map['preferredEngineVersions'] == null ? null : (((map['preferredEngineVersions'] as List).cast<String>()).input()).input(),
      ...
      readReplicaCapable: map['readReplicaCapable'] == null ? null : ((map['readReplicaCapable'] as bool).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      storageType: map['storageType'] == null ? null : ((map['storageType'] as String).input()).input(),
      supportedEngineModes: map['supportedEngineModes'] == null ? null : (((map['supportedEngineModes'] as List).cast<String>()).input()).input(),
      supportedNetworkTypes: map['supportedNetworkTypes'] == null ? null : (((map['supportedNetworkTypes'] as List).cast<String>()).input()).input(),
      supportsClusters: map['supportsClusters'] == null ? null : ((map['supportsClusters'] as bool).input()).input(),
      supportsEnhancedMonitoring: map['supportsEnhancedMonitoring'] == null ? null : ((map['supportsEnhancedMonitoring'] as bool).input()).input(),
      supportsGlobalDatabases: map['supportsGlobalDatabases'] == null ? null : ((map['supportsGlobalDatabases'] as bool).input()).input(),
      supportsIamDatabaseAuthentication: map['supportsIamDatabaseAuthentication'] == null ? null : ((map['supportsIamDatabaseAuthentication'] as bool).input()).input(),
      supportsIops: map['supportsIops'] == null ? null : ((map['supportsIops'] as bool).input()).input(),
      supportsKerberosAuthentication: map['supportsKerberosAuthentication'] == null ? null : ((map['supportsKerberosAuthentication'] as bool).input()).input(),
      supportsMultiAz: map['supportsMultiAz'] == null ? null : ((map['supportsMultiAz'] as bool).input()).input(),
      supportsPerformanceInsights: map['supportsPerformanceInsights'] == null ? null : ((map['supportsPerformanceInsights'] as bool).input()).input(),
      supportsStorageAutoscaling: map['supportsStorageAutoscaling'] == null ? null : ((map['supportsStorageAutoscaling'] as bool).input()).input(),
      supportsStorageEncryption: map['supportsStorageEncryption'] == null ? null : ((map['supportsStorageEncryption'] as bool).input()).input(),
