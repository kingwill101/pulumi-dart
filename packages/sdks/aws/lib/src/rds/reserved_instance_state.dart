...
class ReservedInstanceState {
    ...
    return <String, dynamic>{
      ...
      'recurringCharges':
          ?pulumi.Input.mapOptionalInputValue<
            List<ReservedInstanceRecurringCharge>,
  ...
  factory ReservedInstanceState.fromMap(Map<String, dynamic> map) {
    return ReservedInstanceState(
      ...
      leaseId: (() {
        final guardedValue = map['leaseId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      multiAz: (() {
      ...
      recurringCharges: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ReservedInstanceRecurringCharge>(
            guardedValue,
            (value) => ReservedInstanceRecurringCharge.fromMap(
