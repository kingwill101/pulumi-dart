...
class ReservedInstanceState {
  ...
  factory ReservedInstanceState.fromMap(Map<String, dynamic> map) {
    return ReservedInstanceState(
      ...
      leaseId: map['leaseId'] == null ? null : (map['leaseId'] as String).input(),
      ...
      recurringCharges: map['recurringCharges'] == null ? null : (pulumi.Input.decodeList<ReservedInstanceRecurringCharge>(map['recurringCharges'], (value) => ReservedInstanceRecurringCharge.fromMap((value as Map).cast<String, dynamic>()))).input(),
