...
class ClusterEndpointState {
  ...
  /// [arn] ARN of cluster
  /// [clusterEndpointIdentifier] Identifier to use for the new endpoint. This parameter is stored as a lowercase string.
  /// [clusterIdentifier] Cluster identifier.
  /// [customEndpointType] Type of the endpoint. One of: READER , ANY .
  /// [endpoint] Custom endpoint for the Aurora cluster
  /// [excludedMembers] List of DB instance identifiers that aren't part of the custom endpoint group. All other eligible instances are reachable through the custom endpoint. Only relevant if the list of static members is empty. Conflicts with `staticMembers`.
  /// [region] Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
  /// [staticMembers] List of DB instance identifiers that are part of the custom endpoint group. Conflicts with `excludedMembers`.
  ...
  factory ClusterEndpointState.fromMap(Map<String, dynamic> map) {
    return ClusterEndpointState(
      ...
      customEndpointType: (() { final guardedValue = map['customEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
