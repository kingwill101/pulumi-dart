...
class ClusterArgs {
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      backtrackWindow: map['backtrackWindow'] == null ? null : (map['backtrackWindow'] as int).input(),
      backupRetentionPeriod: map['backupRetentionPeriod'] == null ? null : (map['backupRetentionPeriod'] as int).input(),
      caCertificateIdentifier: map['caCertificateIdentifier'] == null ? null : (map['caCertificateIdentifier'] as String).input(),
      clusterIdentifier: map['clusterIdentifier'] == null ? null : (map['clusterIdentifier'] as String).input(),
      clusterIdentifierPrefix: map['clusterIdentifierPrefix'] == null ? null : (map['clusterIdentifierPrefix'] as String).input(),
      clusterMembers: map['clusterMembers'] == null ? null : ((map['clusterMembers'] as List).cast<String>()).input(),
      clusterScalabilityType: map['clusterScalabilityType'] == null ? null : (map['clusterScalabilityType'] as String).input(),
      ...
      dbClusterInstanceClass: map['dbClusterInstanceClass'] == null ? null : (map['dbClusterInstanceClass'] as String).input(),
      dbClusterParameterGroupName: map['dbClusterParameterGroupName'] == null ? null : (map['dbClusterParameterGroupName'] as String).input(),
      dbInstanceParameterGroupName: map['dbInstanceParameterGroupName'] == null ? null : (map['dbInstanceParameterGroupName'] as String).input(),
      ...
      enableGlobalWriteForwarding: map['enableGlobalWriteForwarding'] == null ? null : (map['enableGlobalWriteForwarding'] as bool).input(),
      enableHttpEndpoint: map['enableHttpEndpoint'] == null ? null : (map['enableHttpEndpoint'] as bool).input(),
      enableLocalWriteForwarding: map['enableLocalWriteForwarding'] == null ? null : (map['enableLocalWriteForwarding'] as bool).input(),
      ...
      engineMode: map['engineMode'] == null ? null : (map['engineMode'] as String).input(),
      ...
      masterPassword: map['masterPassword'] == null ? null : (map['masterPassword'] as String).input(),
      masterPasswordWo: map['masterPasswordWo'] == null ? null : (map['masterPasswordWo'] as String).input(),
      masterPasswordWoVersion: map['masterPasswordWoVersion'] == null ? null : (map['masterPasswordWoVersion'] as int).input(),
      ...
      replicationSourceIdentifier: map['replicationSourceIdentifier'] == null ? null : (map['replicationSourceIdentifier'] as String).input(),
      restoreToPointInTime: map['restoreToPointInTime'] == null ? null : (ClusterRestoreToPointInTime.fromMap((map['restoreToPointInTime'] as Map).cast<String, dynamic>())).input(),
      s3Import: map['s3Import'] == null ? null : (ClusterS3Import.fromMap((map['s3Import'] as Map).cast<String, dynamic>())).input(),
      scalingConfiguration: map['scalingConfiguration'] == null ? null : (ClusterScalingConfiguration.fromMap((map['scalingConfiguration'] as Map).cast<String, dynamic>())).input(),
      serverlessv2ScalingConfiguration: map['serverlessv2ScalingConfiguration'] == null ? null : (ClusterServerlessv2ScalingConfiguration.fromMap((map['serverlessv2ScalingConfiguration'] as Map).cast<String, dynamic>())).input(),
