...
/// {@template pulumi_rds_instance_automated_backups_replication_instance_automated_backups_replication_args_doc}
/// The set of arguments for InstanceAutomatedBackupsReplication.
/// {@endtemplate}
/// {@macro pulumi_rds_instance_automated_backups_replication_instance_automated_backups_replication_args_doc}
class InstanceAutomatedBackupsReplicationArgs {
  ...
  /// Creates a new [InstanceAutomatedBackupsReplicationArgs].
  ...
  const InstanceAutomatedBackupsReplicationArgs({
    this.kmsKeyId,
    this.preSignedUrl,
    this.region,
  ...
  factory InstanceAutomatedBackupsReplicationArgs.fromMap(Map<String, dynamic> map) {
    return InstanceAutomatedBackupsReplicationArgs(
      ...
      sourceDbInstanceArn: pulumi.Input.fromValue(map['sourceDbInstanceArn'] as String),
    );
  }
}
