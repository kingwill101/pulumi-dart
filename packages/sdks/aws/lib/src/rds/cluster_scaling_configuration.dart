...
class ClusterScalingConfiguration {
  ...
  factory ClusterScalingConfiguration.fromMap(Map<String, dynamic> map) {
    return ClusterScalingConfiguration(
      ...
      secondsBeforeTimeout: (() { final guardedValue = map['secondsBeforeTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
