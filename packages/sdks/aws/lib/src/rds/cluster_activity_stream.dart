...
import 'cluster_activity_stream_state.dart';
...
///   engine_version     = "13.4"
/// }
/// resource "aws_rds_clusterinstance" "default" {
///   identifier         = "aurora-instance-demo"
...
///   description = "AWS KMS Key to encrypt Database Activity Stream"
/// }
/// resource "aws_rds_clusteractivitystream" "default" {
///   depends_on   = [aws_rds_clusterinstance.default]
...
class ClusterActivityStream extends pulumi.CustomResource {
  ...
  /// Gets an existing [ClusterActivityStream] resource's state with the given [name] and [id].
  static ClusterActivityStream get(
    String name,
