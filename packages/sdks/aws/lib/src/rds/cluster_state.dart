...
class ClusterState {
  ...
  ClusterState({
    ...
    pulumi.Output<String>? caCertificateValidTill,
    ...
    pulumi.Output<List<String>>? vpcSecurityGroupIds,
      ...
      caCertificateValidTill = pulumi.Input.asOptionalInput<String>(caCertificateValidTill),
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      caCertificateValidTill: map['caCertificateValidTill'] == null ? null : pulumi.Output.create<String>(map['caCertificateValidTill'] as String),
