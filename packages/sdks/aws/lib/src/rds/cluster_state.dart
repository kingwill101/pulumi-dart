...
class ClusterState {
  ...
  final pulumi.Input<String>? caCertificateValidTill;
  ...
  /// [masterUserSecrets] Block that specifies the master user secret. Only available when `manage_master_user_password` is set to true. Documented below.
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      caCertificateValidTill: map['caCertificateValidTill'] == null ? null : ((map['caCertificateValidTill'] as String).input()).input(),
      ...
      masterUserSecrets: map['masterUserSecrets'] == null ? null : ((pulumi.Input.decodeList<ClusterMasterUserSecret>(map['masterUserSecrets']!, (value) => ClusterMasterUserSecret.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
