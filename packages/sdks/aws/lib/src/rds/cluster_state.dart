...
class ClusterState {
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      caCertificateValidTill: map['caCertificateValidTill'] == null ? null : (map['caCertificateValidTill'] as String).input(),
      ...
      masterUserSecrets: map['masterUserSecrets'] == null ? null : (pulumi.Input.decodeList<ClusterMasterUserSecret>(map['masterUserSecrets'], (value) => ClusterMasterUserSecret.fromMap((value as Map).cast<String, dynamic>()))).input(),
