...
class ClusterState {
  ...
  /// [readerEndpoint] Read-only endpoint for the Aurora cluster, automatically load-balanced across replicas
  ...
  factory ClusterState.fromMap(Map<String, dynamic> map) {
    return ClusterState(
      ...
      caCertificateValidTill: (() { final guardedValue = map['caCertificateValidTill']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      engine: (() { final guardedValue = map['engine']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
