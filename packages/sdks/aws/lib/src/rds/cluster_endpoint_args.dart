...
class ClusterEndpointArgs {
  ...
  ClusterEndpointArgs({
    ...
    required pulumi.Output<String> customEndpointType,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      customEndpointType = pulumi.Input.asInput<String>(customEndpointType),
  ...
  factory ClusterEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ClusterEndpointArgs(
      ...
      customEndpointType: pulumi.Output.create<String>(map['customEndpointType'] as String),
