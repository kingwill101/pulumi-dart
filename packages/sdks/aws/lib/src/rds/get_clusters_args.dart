...
class GetClustersArgs {
  ...
  GetClustersArgs({
    pulumi.Output<List<GetClustersFilter>>? filters,
  ...
  factory GetClustersArgs.fromMap(Map<String, dynamic> map) {
    return GetClustersArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetClustersFilter>>(pulumi.Input.decodeList<GetClustersFilter>(map['filters'], (value) => GetClustersFilter.fromMap((value as Map).cast<String, dynamic>()))),
