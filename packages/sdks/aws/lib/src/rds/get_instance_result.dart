...
class GetInstanceResult {
  ...
  /// [autoMinorVersionUpgrade] Whether minor version patches are applied automatically.
  /// [availabilityZone] Name of the Availability Zone the DB instance is located in.
  /// [backupRetentionPeriod] Number of days for which automatic DB snapshots are retained.
  /// [caCertIdentifier] Identifier of the CA certificate for the DB instance.
  /// [databaseInsightsMode] Mode of Database Insights that is enabled for the DB instance.
  ...
  /// [dbName] Name of the initial database of this instance that was provided at create time, if one was specified when the DB instance was created. This same name is returned for the life of the DB instance.
  ...
  /// [masterUsername] Master username for the DB instance.
  /// [maxAllocatedStorage] Upper limit to which Amazon RDS can automatically scale the storage of the DB instance.
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      ...
      dbInstancePort: (() { final guardedValue = map['dbInstancePort']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      maxAllocatedStorage: (() { final guardedValue = map['maxAllocatedStorage']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      storageThroughput: (() { final guardedValue = map['storageThroughput']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
