  ...
  factory ProxyDefaultTargetGroupConnectionPoolConfig.fromMap(
    ...
    return ProxyDefaultTargetGroupConnectionPoolConfig(
      connectionBorrowTimeout: (() {
        final guardedValue = map['connectionBorrowTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      initQuery: (() {
        final guardedValue = map['initQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maxConnectionsPercent: (() {
        final guardedValue = map['maxConnectionsPercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maxIdleConnectionsPercent: (() {
        final guardedValue = map['maxIdleConnectionsPercent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      sessionPinningFilters: (() {
        final guardedValue = map['sessionPinningFilters'];
        if (guardedValue == null) return null;
