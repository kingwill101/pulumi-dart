...
class ProxyDefaultTargetGroupConnectionPoolConfig {
  ...
  factory ProxyDefaultTargetGroupConnectionPoolConfig.fromMap(Map<String, dynamic> map) {
    return ProxyDefaultTargetGroupConnectionPoolConfig(
      connectionBorrowTimeout: map['connectionBorrowTimeout'] == null ? null : map['connectionBorrowTimeout'] as int,
      initQuery: map['initQuery'] == null ? null : map['initQuery'] as String,
      maxConnectionsPercent: map['maxConnectionsPercent'] == null ? null : map['maxConnectionsPercent'] as int,
      maxIdleConnectionsPercent: map['maxIdleConnectionsPercent'] == null ? null : map['maxIdleConnectionsPercent'] as int,
      sessionPinningFilters: map['sessionPinningFilters'] == null ? null : (map['sessionPinningFilters'] as List).cast<String>(),
    );
  }
}
