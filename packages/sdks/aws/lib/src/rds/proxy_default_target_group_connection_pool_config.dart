...
class ProxyDefaultTargetGroupConnectionPoolConfig {
  ...
  factory ProxyDefaultTargetGroupConnectionPoolConfig.fromMap(Map<String, dynamic> map) {
    return ProxyDefaultTargetGroupConnectionPoolConfig(
      connectionBorrowTimeout: (() { final guardedValue = map['connectionBorrowTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      maxConnectionsPercent: (() { final guardedValue = map['maxConnectionsPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maxIdleConnectionsPercent: (() { final guardedValue = map['maxIdleConnectionsPercent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
