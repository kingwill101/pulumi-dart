...
class StreamProcessorSettings {
  ...
  StreamProcessorSettings({this.connectedHome, this.faceSearch});
    ...
    return <String, dynamic>{
      'connectedHome':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(connectedHome, (value) => value.toMap()),
      'faceSearch':
          ?pulumi.Input.mapOptionalInputValue<
            StreamProcessorSettingsFaceSearch,
            Map<String, dynamic>
          >(faceSearch, (value) => value.toMap()),
    };
  }
  ...
  factory StreamProcessorSettings.fromMap(Map<String, dynamic> map) {
    return StreamProcessorSettings(
      connectedHome: (() {
        final guardedValue = map['connectedHome'];
      ...
      faceSearch: (() {
        final guardedValue = map['faceSearch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
