...
class StreamProcessor extends pulumi.CustomResource {
  ...
  StreamProcessor(
    ...
    this.dataSharingPreference = registerOutput<StreamProcessorDataSharingPreference?>('dataSharingPreference');
    this.input = registerOutput<StreamProcessorInput>('input');
    this.kmsKeyId = registerOutput<String?>('kmsKeyId');
    this.name = registerOutput<String>('name');
    this.notificationChannel = registerOutput<StreamProcessorNotificationChannel?>('notificationChannel');
    this.output = registerOutput<StreamProcessorOutput>('output');
    this.region = registerOutput<String>('region');
    this.regionsOfInterests = registerOutput<List<StreamProcessorRegionsOfInterest>?>('regionsOfInterests');
