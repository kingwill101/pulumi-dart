...
class StreamProcessorArgs {
  ...
  /// [notificationChannel] Amazon Simple Notification Service topic to which Amazon Rekognition publishes the completion status. See `notificationChannel`.
  ...
  /// [regionsOfInterests] Locations in the frames where Amazon Rekognition checks for objects or people. See `regionsOfInterest`.
  /// [roleArn] Amazon Resource Number (ARN) of the IAM role that allows access to the stream processor. The IAM role provides Rekognition read permissions for a Kinesis stream. It also provides write permissions to an Amazon S3 bucket and Amazon Simple Notification Service topic for a label detection stream processor. This is required for both face search and label detection stream processors.
  ...
  factory StreamProcessorArgs.fromMap(Map<String, dynamic> map) {
    return StreamProcessorArgs(
      dataSharingPreference: (() { final guardedValue = map['dataSharingPreference']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamProcessorDataSharingPreference.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      input: pulumi.Input.fromValue(StreamProcessorInput.fromMap((map['input']! as Map).cast<String, dynamic>())),
      kmsKeyId: (() { final guardedValue = map['kmsKeyId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      notificationChannel: (() { final guardedValue = map['notificationChannel']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamProcessorNotificationChannel.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: pulumi.Input.fromValue(StreamProcessorOutput.fromMap((map['output']! as Map).cast<String, dynamic>())),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      regionsOfInterests: (() { final guardedValue = map['regionsOfInterests']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamProcessorRegionsOfInterest>(guardedValue, (value) => StreamProcessorRegionsOfInterest.fromMap((value as Map).cast<String, dynamic>()))); })(),
      roleArn: pulumi.Input.fromValue(map['roleArn'] as String),
      settings: pulumi.Input.fromValue(StreamProcessorSettings.fromMap((map['settings']! as Map).cast<String, dynamic>())),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamProcessorTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
