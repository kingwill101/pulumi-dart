...
class StreamProcessorRegionsOfInterest {
  ...
  StreamProcessorRegionsOfInterest({this.boundingBox, this.polygons});
    ...
    return <String, dynamic>{
      'boundingBox':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(boundingBox, (value) => value.toMap()),
      'polygons':
          ?pulumi.Input.mapOptionalInputValue<
            List<StreamProcessorRegionsOfInterestPolygon>,
  ...
  factory StreamProcessorRegionsOfInterest.fromMap(Map<String, dynamic> map) {
    return StreamProcessorRegionsOfInterest(
      boundingBox: (() {
        final guardedValue = map['boundingBox'];
      ...
      polygons: (() {
        final guardedValue = map['polygons'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
