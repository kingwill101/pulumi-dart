...
class StreamProcessorRegionsOfInterest {
  ...
  factory StreamProcessorRegionsOfInterest.fromMap(Map<String, dynamic> map) {
    return StreamProcessorRegionsOfInterest(
      boundingBox: (() { final guardedValue = map['boundingBox']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamProcessorRegionsOfInterestBoundingBox.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      polygons: (() { final guardedValue = map['polygons']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<StreamProcessorRegionsOfInterestPolygon>(guardedValue, (value) => StreamProcessorRegionsOfInterestPolygon.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
