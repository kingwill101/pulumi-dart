...
class StreamProcessorState {
  ...
  StreamProcessorState({
    ...
    pulumi.Output<StreamProcessorInput>? input,
    pulumi.Output<String>? kmsKeyId,
    pulumi.Output<String>? name,
    pulumi.Output<StreamProcessorNotificationChannel>? notificationChannel,
    pulumi.Output<StreamProcessorOutput>? output,
    pulumi.Output<String>? region,
    pulumi.Output<List<StreamProcessorRegionsOfInterest>>? regionsOfInterests,
    pulumi.Output<String>? roleArn,
    pulumi.Output<StreamProcessorSettings>? settings,
    pulumi.Output<String>? streamProcessorArn,
    ...
    pulumi.Output<StreamProcessorTimeouts>? timeouts,
      ...
      input = pulumi.Input.asOptionalInput<StreamProcessorInput>(input),
      ...
      output = pulumi.Input.asOptionalInput<StreamProcessorOutput>(output),
      ...
      settings = pulumi.Input.asOptionalInput<StreamProcessorSettings>(settings),
      streamProcessorArn = pulumi.Input.asOptionalInput<String>(streamProcessorArn),
  ...
  factory StreamProcessorState.fromMap(Map<String, dynamic> map) {
    return StreamProcessorState(
      ...
      input: map['input'] == null ? null : pulumi.Output.create<StreamProcessorInput>(StreamProcessorInput.fromMap((map['input'] as Map).cast<String, dynamic>())),
      ...
      output: map['output'] == null ? null : pulumi.Output.create<StreamProcessorOutput>(StreamProcessorOutput.fromMap((map['output'] as Map).cast<String, dynamic>())),
      ...
      settings: map['settings'] == null ? null : pulumi.Output.create<StreamProcessorSettings>(StreamProcessorSettings.fromMap((map['settings'] as Map).cast<String, dynamic>())),
      streamProcessorArn: map['streamProcessorArn'] == null ? null : pulumi.Output.create<String>(map['streamProcessorArn'] as String),
