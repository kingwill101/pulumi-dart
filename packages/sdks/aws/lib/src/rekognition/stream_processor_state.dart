...
class StreamProcessorState {
  ...
  /// [streamProcessorArn] (**Deprecated**) ARN of the Stream Processor. Use `arn` instead.
  /// [tags] Map of tags to assign to the resource. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
  /// [tagsAll] Map of tags assigned to the resource, including those inherited from the provider `defaultTags` configuration block.
  /// [timeouts] Optional.
  const StreamProcessorState({
    this.arn,
  ...
  factory StreamProcessorState.fromMap(Map<String, dynamic> map) {
    return StreamProcessorState(
      ...
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamProcessorInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      output: (() { final guardedValue = map['output']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamProcessorOutput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(StreamProcessorSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      streamProcessorArn: (() { final guardedValue = map['streamProcessorArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
