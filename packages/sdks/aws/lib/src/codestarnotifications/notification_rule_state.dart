...
class NotificationRuleState {
  ...
  factory NotificationRuleState.fromMap(Map<String, dynamic> map) {
    return NotificationRuleState(
      ...
      eventTypeIds: (() { final guardedValue = map['eventTypeIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      targets: (() { final guardedValue = map['targets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NotificationRuleTarget>(guardedValue, (value) => NotificationRuleTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
