...
class SavingsPlanTimeouts {
  ...
  /// Creates a new [SavingsPlanTimeouts].
  ...
  SavingsPlanTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory SavingsPlanTimeouts.fromMap(Map<String, dynamic> map) {
    return SavingsPlanTimeouts(
      create: (() {
