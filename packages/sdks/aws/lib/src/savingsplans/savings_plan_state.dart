...
class SavingsPlanState {
  ...
  factory SavingsPlanState.fromMap(Map<String, dynamic> map) {
    return SavingsPlanState(
      ...
      ec2InstanceFamily: map['ec2InstanceFamily'] == null ? null : (map['ec2InstanceFamily'] as String).input(),
      end: map['end'] == null ? null : (map['end'] as String).input(),
      offeringId: map['offeringId'] == null ? null : (map['offeringId'] as String).input(),
      paymentOption: map['paymentOption'] == null ? null : (map['paymentOption'] as String).input(),
      productTypes: map['productTypes'] == null ? null : ((map['productTypes'] as List).cast<String>()).input(),
      purchaseTime: map['purchaseTime'] == null ? null : (map['purchaseTime'] as String).input(),
      recurringPaymentAmount: map['recurringPaymentAmount'] == null ? null : (map['recurringPaymentAmount'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      returnableUntil: map['returnableUntil'] == null ? null : (map['returnableUntil'] as String).input(),
      savingsPlanArn: map['savingsPlanArn'] == null ? null : (map['savingsPlanArn'] as String).input(),
      savingsPlanId: map['savingsPlanId'] == null ? null : (map['savingsPlanId'] as String).input(),
      savingsPlanOfferingId: map['savingsPlanOfferingId'] == null ? null : (map['savingsPlanOfferingId'] as String).input(),
      savingsPlanType: map['savingsPlanType'] == null ? null : (map['savingsPlanType'] as String).input(),
      start: map['start'] == null ? null : (map['start'] as String).input(),
      state: map['state'] == null ? null : (map['state'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      tagsAll: map['tagsAll'] == null ? null : ((map['tagsAll'] as Map).cast<String, String>()).input(),
      termDurationInSeconds: map['termDurationInSeconds'] == null ? null : (map['termDurationInSeconds'] as int).input(),
