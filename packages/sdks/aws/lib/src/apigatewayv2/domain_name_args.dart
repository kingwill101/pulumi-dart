...
class DomainNameArgs {
  ...
  /// [tags] Map of tags to assign to the domain name. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'domainNameConfiguration': pulumi.Input.mapInputValue<DomainNameDomainNameConfiguration, Map<String, dynamic>>(domainNameConfiguration, (value) => value.toMap()),
  ...
  factory DomainNameArgs.fromMap(Map<String, dynamic> map) {
    return DomainNameArgs(
      ...
      domainNameConfiguration: pulumi.Input.fromValue(DomainNameDomainNameConfiguration.fromMap((map['domainNameConfiguration']! as Map).cast<String, dynamic>())),
