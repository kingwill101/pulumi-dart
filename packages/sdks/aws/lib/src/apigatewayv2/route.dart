...
class Route extends pulumi.CustomResource {
  ...
  Route(
    ...
    this.authorizationScopes = registerOutput<List<String>?>('authorizationScopes');
    ...
    this.requestParameters = registerOutput<List<RouteRequestParameter>?>('requestParameters');
    this.routeKey = registerOutput<String>('routeKey');
    this.routeResponseSelectionExpression = registerOutput<String?>('routeResponseSelectionExpression');
