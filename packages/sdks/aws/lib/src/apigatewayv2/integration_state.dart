...
class IntegrationState {
  ...
  factory IntegrationState.fromMap(Map<String, dynamic> map) {
    return IntegrationState(
      ...
      integrationMethod: map['integrationMethod'] == null ? null : (map['integrationMethod'] as String).input(),
      integrationResponseSelectionExpression: map['integrationResponseSelectionExpression'] == null ? null : (map['integrationResponseSelectionExpression'] as String).input(),
      integrationSubtype: map['integrationSubtype'] == null ? null : (map['integrationSubtype'] as String).input(),
      integrationType: map['integrationType'] == null ? null : (map['integrationType'] as String).input(),
      integrationUri: map['integrationUri'] == null ? null : (map['integrationUri'] as String).input(),
      passthroughBehavior: map['passthroughBehavior'] == null ? null : (map['passthroughBehavior'] as String).input(),
      payloadFormatVersion: map['payloadFormatVersion'] == null ? null : (map['payloadFormatVersion'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      requestParameters: map['requestParameters'] == null ? null : ((map['requestParameters'] as Map).cast<String, String>()).input(),
      requestTemplates: map['requestTemplates'] == null ? null : ((map['requestTemplates'] as Map).cast<String, String>()).input(),
      responseParameters: map['responseParameters'] == null ? null : (pulumi.Input.decodeList<IntegrationResponseParameter>(map['responseParameters'], (value) => IntegrationResponseParameter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      templateSelectionExpression: map['templateSelectionExpression'] == null ? null : (map['templateSelectionExpression'] as String).input(),
      timeoutMilliseconds: map['timeoutMilliseconds'] == null ? null : (map['timeoutMilliseconds'] as int).input(),
      tlsConfig: map['tlsConfig'] == null ? null : (IntegrationTlsConfig.fromMap((map['tlsConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
