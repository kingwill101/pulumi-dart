...
class IntegrationState {
  ...
  factory IntegrationState.fromMap(Map<String, dynamic> map) {
    return IntegrationState(
      ...
      integrationResponseSelectionExpression: map['integrationResponseSelectionExpression'] == null ? null : ((map['integrationResponseSelectionExpression'] as String).input()).input(),
      integrationSubtype: map['integrationSubtype'] == null ? null : ((map['integrationSubtype'] as String).input()).input(),
      integrationType: map['integrationType'] == null ? null : ((map['integrationType'] as String).input()).input(),
