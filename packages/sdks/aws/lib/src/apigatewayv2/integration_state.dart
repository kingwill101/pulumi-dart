...
class IntegrationState {
  ...
  IntegrationState({
    ...
    pulumi.Output<String>? integrationResponseSelectionExpression,
    ...
    pulumi.Output<IntegrationTlsConfig>? tlsConfig,
      ...
      integrationResponseSelectionExpression = pulumi.Input.asOptionalInput<String>(integrationResponseSelectionExpression),
  ...
  factory IntegrationState.fromMap(Map<String, dynamic> map) {
    return IntegrationState(
      ...
      integrationResponseSelectionExpression: map['integrationResponseSelectionExpression'] == null ? null : pulumi.Output.create<String>(map['integrationResponseSelectionExpression'] as String),
