...
class ServiceQuotaState {
  ...
  factory ServiceQuotaState.fromMap(Map<String, dynamic> map) {
    return ServiceQuotaState(
      adjustable: (() {
        final guardedValue = map['adjustable'];
      ...
      quotaCode: (() {
        final guardedValue = map['quotaCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      quotaName: (() {
      ...
      requestStatus: (() {
        final guardedValue = map['requestStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceCode: (() {
      ...
      usageMetrics: (() {
        final guardedValue = map['usageMetrics'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceQuotaUsageMetric>(
            guardedValue,
            (value) => ServiceQuotaUsageMetric.fromMap(
