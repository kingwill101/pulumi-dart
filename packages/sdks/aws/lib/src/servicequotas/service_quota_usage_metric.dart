...
class ServiceQuotaUsageMetric {
  ...
  factory ServiceQuotaUsageMetric.fromMap(Map<String, dynamic> map) {
    return ServiceQuotaUsageMetric(
      metricDimensions: (() { final guardedValue = map['metricDimensions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ServiceQuotaUsageMetricMetricDimension>(guardedValue, (value) => ServiceQuotaUsageMetricMetricDimension.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      metricStatisticRecommendation: (() { final guardedValue = map['metricStatisticRecommendation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
