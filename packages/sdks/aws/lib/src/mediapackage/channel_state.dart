...
class ChannelState {
    ...
    return <String, dynamic>{
      ...
      'hlsIngests':
          ?pulumi.Input.mapOptionalInputValue<
            List<ChannelHlsIngest>,
            List<Map<String, dynamic>>
          >(
            hlsIngests,
            (value) =>
                pulumi.Input.encodeList<ChannelHlsIngest, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory ChannelState.fromMap(Map<String, dynamic> map) {
    return ChannelState(
      ...
      hlsIngests: (() {
        final guardedValue = map['hlsIngests'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ChannelHlsIngest>(
            guardedValue,
            (value) => ChannelHlsIngest.fromMap(
