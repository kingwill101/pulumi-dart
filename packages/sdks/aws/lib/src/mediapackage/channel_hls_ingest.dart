...
class ChannelHlsIngest {
  ...
  factory ChannelHlsIngest.fromMap(Map<String, dynamic> map) {
    return ChannelHlsIngest(
      ingestEndpoints: (() { final guardedValue = map['ingestEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ChannelHlsIngestIngestEndpoint>(guardedValue, (value) => ChannelHlsIngestIngestEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
