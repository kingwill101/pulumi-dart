...
class QueueArgs {
  ...
  factory QueueArgs.fromMap(Map<String, dynamic> map) {
    return QueueArgs(
      concurrentJobs: (() { final guardedValue = map['concurrentJobs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      reservationPlanSettings: (() { final guardedValue = map['reservationPlanSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QueueReservationPlanSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
