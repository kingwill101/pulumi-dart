...
class ChannelEncoderSettingsGlobalConfiguration {
    ...
    return <String, dynamic>{
      ...
      'inputLossBehavior':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsGlobalConfigurationInputLossBehavior,
            Map<String, dynamic>
          >(inputLossBehavior, (value) => value.toMap()),
  ...
  factory ChannelEncoderSettingsGlobalConfiguration.fromMap(
    ...
    return ChannelEncoderSettingsGlobalConfiguration(
      initialAudioGain: (() {
        final guardedValue = map['initialAudioGain'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      inputEndAction: (() {
        final guardedValue = map['inputEndAction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inputLossBehavior: (() {
        final guardedValue = map['inputLossBehavior'];
        if (guardedValue == null) return null;
      ...
      outputLockingMode: (() {
        final guardedValue = map['outputLockingMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      outputTimingSource: (() {
        final guardedValue = map['outputTimingSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      supportLowFramerateInputs: (() {
        final guardedValue = map['supportLowFramerateInputs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
