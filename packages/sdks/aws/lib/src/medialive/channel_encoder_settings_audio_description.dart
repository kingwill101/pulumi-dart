...
class ChannelEncoderSettingsAudioDescription {
  ...
  final pulumi.Input<ChannelEncoderSettingsAudioDescriptionCodecSettings>?
  codecSettings;
  ...
  final pulumi.Input<ChannelEncoderSettingsAudioDescriptionRemixSettings>?
  remixSettings;
    ...
    return <String, dynamic>{
      'audioNormalizationSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsAudioDescriptionAudioNormalizationSettings,
            Map<String, dynamic>
          >(audioNormalizationSettings, (value) => value.toMap()),
      ...
      'audioWatermarkSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettings,
            Map<String, dynamic>
          >(audioWatermarkSettings, (value) => value.toMap()),
      'codecSettings':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'remixSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(remixSettings, (value) => value.toMap()),
  ...
  factory ChannelEncoderSettingsAudioDescription.fromMap(
    ...
    return ChannelEncoderSettingsAudioDescription(
      audioNormalizationSettings: (() {
        final guardedValue = map['audioNormalizationSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ChannelEncoderSettingsAudioDescriptionAudioNormalizationSettings.fromMap(
      ...
      audioType: (() {
        final guardedValue = map['audioType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      audioTypeControl: (() {
        final guardedValue = map['audioTypeControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      audioWatermarkSettings: (() {
        final guardedValue = map['audioWatermarkSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      languageCodeControl: (() {
        final guardedValue = map['languageCodeControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      remixSettings: (() {
        final guardedValue = map['remixSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
