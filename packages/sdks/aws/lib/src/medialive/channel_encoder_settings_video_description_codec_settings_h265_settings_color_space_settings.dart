    ...
    return <String, dynamic>{
      ...
      'hdr10Settings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettingsHdr10Settings,
            Map<String, dynamic>
          >(hdr10Settings, (value) => value.toMap()),
  ...
  factory ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettings.fromMap(
    ...
    return ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettings(
      colorSpacePassthroughSettings: (() {
        final guardedValue = map['colorSpacePassthroughSettings'];
      ...
      dolbyVision81Settings: (() {
        final guardedValue = map['dolbyVision81Settings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      hdr10Settings: (() {
        final guardedValue = map['hdr10Settings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rec601Settings: (() {
        final guardedValue = map['rec601Settings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      rec709Settings: (() {
        final guardedValue = map['rec709Settings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
