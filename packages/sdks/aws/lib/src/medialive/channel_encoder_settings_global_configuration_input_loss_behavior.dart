...
class ChannelEncoderSettingsGlobalConfigurationInputLossBehavior {
  ...
  factory ChannelEncoderSettingsGlobalConfigurationInputLossBehavior.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsGlobalConfigurationInputLossBehavior(
      blackFrameMsec: (() { final guardedValue = map['blackFrameMsec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      repeatFrameMsec: (() { final guardedValue = map['repeatFrameMsec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
