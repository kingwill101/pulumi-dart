...
class ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3Settings {
  ...
  factory ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3Settings.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsAudioDescriptionCodecSettingsEac3Settings(
      attenuationControl: map['attenuationControl'] == null ? null : ((map['attenuationControl'] as String).input()).input(),
      ...
      dcFilter: map['dcFilter'] == null ? null : ((map['dcFilter'] as String).input()).input(),
      ...
      lfeControl: map['lfeControl'] == null ? null : ((map['lfeControl'] as String).input()).input(),
      lfeFilter: map['lfeFilter'] == null ? null : ((map['lfeFilter'] as String).input()).input(),
      loRoCenterMixLevel: map['loRoCenterMixLevel'] == null ? null : ((map['loRoCenterMixLevel'] as double).input()).input(),
      loRoSurroundMixLevel: map['loRoSurroundMixLevel'] == null ? null : ((map['loRoSurroundMixLevel'] as double).input()).input(),
      ltRtCenterMixLevel: map['ltRtCenterMixLevel'] == null ? null : ((map['ltRtCenterMixLevel'] as double).input()).input(),
      ltRtSurroundMixLevel: map['ltRtSurroundMixLevel'] == null ? null : ((map['ltRtSurroundMixLevel'] as double).input()).input(),
      metadataControl: map['metadataControl'] == null ? null : ((map['metadataControl'] as String).input()).input(),
      passthroughControl: map['passthroughControl'] == null ? null : ((map['passthroughControl'] as String).input()).input(),
      phaseControl: map['phaseControl'] == null ? null : ((map['phaseControl'] as String).input()).input(),
      stereoDownmix: map['stereoDownmix'] == null ? null : ((map['stereoDownmix'] as String).input()).input(),
      surroundExMode: map['surroundExMode'] == null ? null : ((map['surroundExMode'] as String).input()).input(),
      surroundMode: map['surroundMode'] == null ? null : ((map['surroundMode'] as String).input()).input(),
    );
  }
}
