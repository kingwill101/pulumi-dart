...
class InputState {
  ...
  factory InputState.fromMap(Map<String, dynamic> map) {
    return InputState(
      ...
      attachedChannels: map['attachedChannels'] == null ? null : (((map['attachedChannels'] as List).cast<String>()).input()).input(),
      ...
      inputClass: map['inputClass'] == null ? null : ((map['inputClass'] as String).input()).input(),
      ...
      inputPartnerIds: map['inputPartnerIds'] == null ? null : (((map['inputPartnerIds'] as List).cast<String>()).input()).input(),
      inputSecurityGroups: map['inputSecurityGroups'] == null ? null : (((map['inputSecurityGroups'] as List).cast<String>()).input()).input(),
      inputSourceType: map['inputSourceType'] == null ? null : ((map['inputSourceType'] as String).input()).input(),
