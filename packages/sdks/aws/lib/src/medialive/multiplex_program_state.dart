...
class MultiplexProgramState {
  ...
  MultiplexProgramState({
    pulumi.Output<String>? multiplexId,
    ...
    pulumi.Output<MultiplexProgramTimeouts>? timeouts,
      ...
      multiplexId = pulumi.Input.asOptionalInput<String>(multiplexId),
  ...
  factory MultiplexProgramState.fromMap(Map<String, dynamic> map) {
    return MultiplexProgramState(
      multiplexId: map['multiplexId'] == null ? null : pulumi.Output.create<String>(map['multiplexId'] as String),
