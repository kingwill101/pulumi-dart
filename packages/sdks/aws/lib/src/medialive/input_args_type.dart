    ...
    return <String, dynamic>{
      ...
      'sources':
          ...
          >(
            sources,
            (value) =>
                pulumi.Input.encodeList<InputSource, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return InputArgsType(
      destinations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InputDestination>(
            guardedValue,
            (value) => InputDestination.fromMap(
      ...
      inputDevices: (() {
        final guardedValue = map['inputDevices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InputInputDevice>(
            guardedValue,
            (value) => InputInputDevice.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      inputSecurityGroups: (() {
        final guardedValue = map['inputSecurityGroups'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      mediaConnectFlows: (() {
        final guardedValue = map['mediaConnectFlows'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InputMediaConnectFlow>(
            guardedValue,
            (value) => InputMediaConnectFlow.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      sources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<InputSource>(
            guardedValue,
            (value) =>
                InputSource.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
      ...
      vpc: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          InputVpc.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
