...
class ChannelEncoderSettingsOutputGroupOutputGroupSettings {
  ...
  factory ChannelEncoderSettingsOutputGroupOutputGroupSettings.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsOutputGroupOutputGroupSettings(
      archiveGroupSettings: (() { final guardedValue = map['archiveGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSetting>(guardedValue, (value) => ChannelEncoderSettingsOutputGroupOutputGroupSettingsArchiveGroupSetting.fromMap((value as Map).cast<String, dynamic>()))); })(),
      frameCaptureGroupSettings: (() { final guardedValue = map['frameCaptureGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hlsGroupSettings: (() { final guardedValue = map['hlsGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelEncoderSettingsOutputGroupOutputGroupSettingsHlsGroupSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mediaPackageGroupSettings: (() { final guardedValue = map['mediaPackageGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelEncoderSettingsOutputGroupOutputGroupSettingsMediaPackageGroupSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      msSmoothGroupSettings: (() { final guardedValue = map['msSmoothGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelEncoderSettingsOutputGroupOutputGroupSettingsMsSmoothGroupSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      multiplexGroupSettings: (() { final guardedValue = map['multiplexGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, dynamic>()); })(),
      rtmpGroupSettings: (() { final guardedValue = map['rtmpGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelEncoderSettingsOutputGroupOutputGroupSettingsRtmpGroupSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      udpGroupSettings: (() { final guardedValue = map['udpGroupSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelEncoderSettingsOutputGroupOutputGroupSettingsUdpGroupSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
