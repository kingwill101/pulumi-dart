...
class ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettings {
    ...
    return <String, dynamic>{
      'nielsenCbetSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings,
            Map<String, dynamic>
          >(nielsenCbetSettings, (value) => value.toMap()),
  ...
  factory ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettings.fromMap(
    ...
    return ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettings(
      nielsenCbetSettings: (() {
        final guardedValue = map['nielsenCbetSettings'];
      ...
      nielsenDistributionType: (() {
        final guardedValue = map['nielsenDistributionType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      nielsenNaesIiNwSettings: (() {
        final guardedValue = map['nielsenNaesIiNwSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
