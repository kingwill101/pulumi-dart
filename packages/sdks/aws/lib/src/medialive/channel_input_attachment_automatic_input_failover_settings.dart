...
class ChannelInputAttachmentAutomaticInputFailoverSettings {
  ...
  final List<ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition>? failoverConditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'failoverConditions': ?failoverConditions == null ? null : pulumi.Input.encodeList<ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition, Map<String, dynamic>>(failoverConditions!, (value) => value.toMap()),
  ...
  factory ChannelInputAttachmentAutomaticInputFailoverSettings.fromMap(Map<String, dynamic> map) {
    return ChannelInputAttachmentAutomaticInputFailoverSettings(
      errorClearTimeMsec: map['errorClearTimeMsec'] == null ? null : map['errorClearTimeMsec'] as int,
      failoverConditions: map['failoverConditions'] == null ? null : pulumi.Input.decodeList<ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition>(map['failoverConditions'], (value) => ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition.fromMap((value as Map).cast<String, dynamic>())),
      inputPreference: map['inputPreference'] == null ? null : map['inputPreference'] as String,
