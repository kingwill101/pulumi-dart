...
class ChannelInputAttachmentAutomaticInputFailoverSettings {
  ...
  factory ChannelInputAttachmentAutomaticInputFailoverSettings.fromMap(
    ...
    return ChannelInputAttachmentAutomaticInputFailoverSettings(
      errorClearTimeMsec: (() {
        final guardedValue = map['errorClearTimeMsec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      failoverConditions: (() {
        final guardedValue = map['failoverConditions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition.fromMap(
      ...
      inputPreference: (() {
        final guardedValue = map['inputPreference'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      secondaryInputId: pulumi.Input.fromValue(
        map['secondaryInputId'] as String,
      ),
    );
  }
}
