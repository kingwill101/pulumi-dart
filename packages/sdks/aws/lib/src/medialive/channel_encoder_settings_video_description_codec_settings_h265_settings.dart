...
class ChannelEncoderSettingsVideoDescriptionCodecSettingsH265Settings {
  ...
  factory ChannelEncoderSettingsVideoDescriptionCodecSettingsH265Settings.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsVideoDescriptionCodecSettingsH265Settings(
      ...
      alternativeTransferFunction: map['alternativeTransferFunction'] == null ? null : ((map['alternativeTransferFunction'] as String).input()).input(),
      ...
      colorSpaceSettings: map['colorSpaceSettings'] == null ? null : ((ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsColorSpaceSettings.fromMap((map['colorSpaceSettings']! as Map).cast<String, dynamic>())).input()).input(),
      filterSettings: map['filterSettings'] == null ? null : ((ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsFilterSettings.fromMap((map['filterSettings']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      minQp: map['minQp'] == null ? null : ((map['minQp'] as int).input()).input(),
      mvOverPictureBoundaries: map['mvOverPictureBoundaries'] == null ? null : ((map['mvOverPictureBoundaries'] as String).input()).input(),
      mvTemporalPredictor: map['mvTemporalPredictor'] == null ? null : ((map['mvTemporalPredictor'] as String).input()).input(),
      ...
      tileHeight: map['tileHeight'] == null ? null : ((map['tileHeight'] as int).input()).input(),
      tilePadding: map['tilePadding'] == null ? null : ((map['tilePadding'] as String).input()).input(),
      tileWidth: map['tileWidth'] == null ? null : ((map['tileWidth'] as int).input()).input(),
      timecodeBurninSettings: map['timecodeBurninSettings'] == null ? null : ((ChannelEncoderSettingsVideoDescriptionCodecSettingsH265SettingsTimecodeBurninSettings.fromMap((map['timecodeBurninSettings']! as Map).cast<String, dynamic>())).input()).input(),
      timecodeInsertion: map['timecodeInsertion'] == null ? null : ((map['timecodeInsertion'] as String).input()).input(),
      treeblockSize: map['treeblockSize'] == null ? null : ((map['treeblockSize'] as String).input()).input(),
    );
  }
}
