...
class ChannelState {
  ...
  factory ChannelState.fromMap(Map<String, dynamic> map) {
    return ChannelState(
      ...
      channelClass: (() {
        final guardedValue = map['channelClass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      channelId: (() {
      ...
      encoderSettings: (() {
        final guardedValue = map['encoderSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      inputAttachments: (() {
        final guardedValue = map['inputAttachments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      inputSpecification: (() {
        final guardedValue = map['inputSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
