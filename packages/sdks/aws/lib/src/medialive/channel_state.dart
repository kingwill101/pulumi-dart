...
class ChannelState {
  ...
  factory ChannelState.fromMap(Map<String, dynamic> map) {
    return ChannelState(
      ...
      channelClass: map['channelClass'] == null ? null : (map['channelClass'] as String).input(),
      channelId: map['channelId'] == null ? null : (map['channelId'] as String).input(),
      destinations: map['destinations'] == null ? null : (pulumi.Input.decodeList<ChannelDestination>(map['destinations'], (value) => ChannelDestination.fromMap((value as Map).cast<String, dynamic>()))).input(),
      encoderSettings: map['encoderSettings'] == null ? null : (ChannelEncoderSettings.fromMap((map['encoderSettings'] as Map).cast<String, dynamic>())).input(),
      inputAttachments: map['inputAttachments'] == null ? null : (pulumi.Input.decodeList<ChannelInputAttachment>(map['inputAttachments'], (value) => ChannelInputAttachment.fromMap((value as Map).cast<String, dynamic>()))).input(),
      inputSpecification: map['inputSpecification'] == null ? null : (ChannelInputSpecification.fromMap((map['inputSpecification'] as Map).cast<String, dynamic>())).input(),
