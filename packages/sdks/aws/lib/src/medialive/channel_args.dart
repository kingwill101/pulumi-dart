...
class ChannelArgs {
  ...
  factory ChannelArgs.fromMap(Map<String, dynamic> map) {
    return ChannelArgs(
      cdiInputSpecification: (() {
        final guardedValue = map['cdiInputSpecification'];
      ...
      destinations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ChannelDestination>(
          map['destinations']!,
      ...
      encoderSettings: pulumi.Input.fromValue(
        ChannelEncoderSettings.fromMap(
          (map['encoderSettings']! as Map).cast<String, dynamic>(),
        ),
      ),
      inputAttachments: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ChannelInputAttachment>(
      ...
      inputSpecification: pulumi.Input.fromValue(
        ChannelInputSpecification.fromMap(
      ...
      startChannel: (() {
        final guardedValue = map['startChannel'];
        if (guardedValue == null) return null;
      ...
      vpc: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ChannelVpc.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
