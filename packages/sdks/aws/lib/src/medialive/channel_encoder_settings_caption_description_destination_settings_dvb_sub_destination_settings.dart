...
class ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings {
  ...
  factory ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettings(
      ...
      font: map['font'] == null ? null : ((ChannelEncoderSettingsCaptionDescriptionDestinationSettingsDvbSubDestinationSettingsFont.fromMap((map['font']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      outlineColor: map['outlineColor'] == null ? null : ((map['outlineColor'] as String).input()).input(),
      ...
      teletextGridControl: map['teletextGridControl'] == null ? null : ((map['teletextGridControl'] as String).input()).input(),
