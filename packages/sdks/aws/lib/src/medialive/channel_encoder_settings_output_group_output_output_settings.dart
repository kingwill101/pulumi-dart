...
class ChannelEncoderSettingsOutputGroupOutputOutputSettings {
    ...
    return <String, dynamic>{
      'archiveOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettings,
            Map<String, dynamic>
          >(archiveOutputSettings, (value) => value.toMap()),
      'frameCaptureOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsOutputGroupOutputOutputSettingsFrameCaptureOutputSettings,
            Map<String, dynamic>
          >(frameCaptureOutputSettings, (value) => value.toMap()),
      'hlsOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettings,
            Map<String, dynamic>
          >(hlsOutputSettings, (value) => value.toMap()),
      'mediaPackageOutputSettings': ?mediaPackageOutputSettings,
      'msSmoothOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsOutputGroupOutputOutputSettingsMsSmoothOutputSettings,
            Map<String, dynamic>
          >(msSmoothOutputSettings, (value) => value.toMap()),
      'multiplexOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsOutputGroupOutputOutputSettingsMultiplexOutputSettings,
            Map<String, dynamic>
          >(multiplexOutputSettings, (value) => value.toMap()),
      'rtmpOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsOutputGroupOutputOutputSettingsRtmpOutputSettings,
            Map<String, dynamic>
          >(rtmpOutputSettings, (value) => value.toMap()),
      'udpOutputSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsOutputGroupOutputOutputSettingsUdpOutputSettings,
            Map<String, dynamic>
          >(udpOutputSettings, (value) => value.toMap()),
    };
  }
  ...
  factory ChannelEncoderSettingsOutputGroupOutputOutputSettings.fromMap(
    ...
    return ChannelEncoderSettingsOutputGroupOutputOutputSettings(
      archiveOutputSettings: (() {
        final guardedValue = map['archiveOutputSettings'];
      ...
      frameCaptureOutputSettings: (() {
        final guardedValue = map['frameCaptureOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      hlsOutputSettings: (() {
        final guardedValue = map['hlsOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      mediaPackageOutputSettings: (() {
        final guardedValue = map['mediaPackageOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, dynamic>(),
        );
      ...
      msSmoothOutputSettings: (() {
        final guardedValue = map['msSmoothOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      multiplexOutputSettings: (() {
        final guardedValue = map['multiplexOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rtmpOutputSettings: (() {
        final guardedValue = map['rtmpOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      udpOutputSettings: (() {
        final guardedValue = map['udpOutputSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
