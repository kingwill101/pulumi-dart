...
class ChannelEncoderSettings {
  ...
  final pulumi.Input<List<ChannelEncoderSettingsAudioDescription>>?
  audioDescriptions;
  ...
  final pulumi.Input<List<ChannelEncoderSettingsVideoDescription>>?
  videoDescriptions;
    ...
    return <String, dynamic>{
      'audioDescriptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ChannelEncoderSettingsAudioDescription>,
      ...
      'availBlanking':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(availBlanking, (value) => value.toMap()),
      'captionDescriptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ChannelEncoderSettingsCaptionDescription>,
            List<Map<String, dynamic>>
          >(
            captionDescriptions,
            (value) =>
      ...
      'motionGraphicsConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(motionGraphicsConfiguration, (value) => value.toMap()),
      'nielsenConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ChannelEncoderSettingsNielsenConfiguration,
            Map<String, dynamic>
          >(nielsenConfiguration, (value) => value.toMap()),
      'outputGroups':
          pulumi.Input.mapInputValue<
            List<ChannelEncoderSettingsOutputGroup>,
            List<Map<String, dynamic>>
          >(
            outputGroups,
            (value) =>
      ...
      'timecodeConfig':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(timecodeConfig, (value) => value.toMap()),
      'videoDescriptions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ChannelEncoderSettingsVideoDescription>,
            List<Map<String, dynamic>>
          >(
            videoDescriptions,
            (value) =>
  ...
  factory ChannelEncoderSettings.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettings(
      audioDescriptions: (() {
        final guardedValue = map['audioDescriptions'];
      ...
      availBlanking: (() {
        final guardedValue = map['availBlanking'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      captionDescriptions: (() {
        final guardedValue = map['captionDescriptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      motionGraphicsConfiguration: (() {
        final guardedValue = map['motionGraphicsConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      nielsenConfiguration: (() {
        final guardedValue = map['nielsenConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      outputGroups: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ChannelEncoderSettingsOutputGroup>(
          map['outputGroups']!,
      ...
      timecodeConfig: pulumi.Input.fromValue(
        ChannelEncoderSettingsTimecodeConfig.fromMap(
          (map['timecodeConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      videoDescriptions: (() {
        final guardedValue = map['videoDescriptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
