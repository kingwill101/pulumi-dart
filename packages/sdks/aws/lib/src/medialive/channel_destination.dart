...
class ChannelDestination {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': id,
      'mediaPackageSettings': ?mediaPackageSettings == null ? null : pulumi.Input.encodeList<ChannelDestinationMediaPackageSetting, Map<String, dynamic>>(mediaPackageSettings!, (value) => value.toMap()),
      'multiplexSettings': ?multiplexSettings == null ? null : multiplexSettings!.toMap(),
      'settings': ?settings == null ? null : pulumi.Input.encodeList<ChannelDestinationSetting, Map<String, dynamic>>(settings!, (value) => value.toMap()),
    };
  }
  ...
  factory ChannelDestination.fromMap(Map<String, dynamic> map) {
    return ChannelDestination(
      id: map['id'] as String,
      mediaPackageSettings: map['mediaPackageSettings'] == null ? null : pulumi.Input.decodeList<ChannelDestinationMediaPackageSetting>(map['mediaPackageSettings'], (value) => ChannelDestinationMediaPackageSetting.fromMap((value as Map).cast<String, dynamic>())),
      multiplexSettings: map['multiplexSettings'] == null ? null : ChannelDestinationMultiplexSettings.fromMap((map['multiplexSettings'] as Map).cast<String, dynamic>()),
      settings: map['settings'] == null ? null : pulumi.Input.decodeList<ChannelDestinationSetting>(map['settings'], (value) => ChannelDestinationSetting.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
