...
class ChannelEncoderSettingsAvailBlanking {
  ...
  factory ChannelEncoderSettingsAvailBlanking.fromMap(Map<String, dynamic> map) {
    return ChannelEncoderSettingsAvailBlanking(
      availBlankingImage: (() { final guardedValue = map['availBlankingImage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ChannelEncoderSettingsAvailBlankingAvailBlankingImage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
