...
import 'environment_membership_state.dart';
...
class EnvironmentMembership extends pulumi.CustomResource {
  ...
  /// Creates a new [EnvironmentMembership].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [EnvironmentMembership]. {@macro pulumi_cloud9_environment_membership_environment_membership_args_doc}
  ...
  /// Gets an existing [EnvironmentMembership] resource's state with the given [name] and [id].
  static EnvironmentMembership get(
    String name,
    pulumi.Input<String> id, {
    EnvironmentMembershipState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return EnvironmentMembership._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [EnvironmentMembership] resource.
  EnvironmentMembership.reference(String urn)
    : super(
        'aws:cloud9/environmentMembership:EnvironmentMembership',
