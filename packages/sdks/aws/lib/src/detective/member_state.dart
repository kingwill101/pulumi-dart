...
class MemberState {
  ...
  factory MemberState.fromMap(Map<String, dynamic> map) {
    return MemberState(
      ...
      administratorId: (() {
        final guardedValue = map['administratorId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      disabledReason: (() {
        final guardedValue = map['disabledReason'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      emailAddress: (() {
      ...
      graphArn: (() {
        final guardedValue = map['graphArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      invitedTime: (() {
        final guardedValue = map['invitedTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      message: (() {
      ...
      volumeUsageInBytes: (() {
        final guardedValue = map['volumeUsageInBytes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
