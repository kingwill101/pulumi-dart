...
class MemberState {
  ...
  factory MemberState.fromMap(Map<String, dynamic> map) {
    return MemberState(
      ...
      administratorId: map['administratorId'] == null ? null : (map['administratorId'] as String).input(),
      ...
      invitedTime: map['invitedTime'] == null ? null : (map['invitedTime'] as String).input(),
      message: map['message'] == null ? null : (map['message'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      status: map['status'] == null ? null : (map['status'] as String).input(),
      updatedTime: map['updatedTime'] == null ? null : (map['updatedTime'] as String).input(),
      volumeUsageInBytes: map['volumeUsageInBytes'] == null ? null : (map['volumeUsageInBytes'] as String).input(),
    );
  }
}
