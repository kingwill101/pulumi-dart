...
class GetDirectConnectGatewayAttachmentArgs {
  ...
  const GetDirectConnectGatewayAttachmentArgs({
    this.dxGatewayId,
    this.filters,
    this.region,
    this.tags,
  ...
  factory GetDirectConnectGatewayAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return GetDirectConnectGatewayAttachmentArgs(
      ...
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetDirectConnectGatewayAttachmentFilter>(guardedValue, (value) => GetDirectConnectGatewayAttachmentFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
