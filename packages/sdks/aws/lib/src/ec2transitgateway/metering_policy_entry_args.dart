...
/// {@template pulumi_ec2transitgateway_metering_policy_entry_metering_policy_entry_args_doc}
/// The set of arguments for MeteringPolicyEntry.
/// {@endtemplate}
/// {@macro pulumi_ec2transitgateway_metering_policy_entry_metering_policy_entry_args_doc}
class MeteringPolicyEntryArgs {
  ...
  /// Creates a new [MeteringPolicyEntryArgs].
  ...
  const MeteringPolicyEntryArgs({
    ...
    this.timeouts,
    required this.transitGatewayMeteringPolicyId,
  });
  ...
  factory MeteringPolicyEntryArgs.fromMap(Map<String, dynamic> map) {
    return MeteringPolicyEntryArgs(
      ...
      policyRuleNumber: pulumi.Input.fromValue(map['policyRuleNumber'] as int),
      ...
      transitGatewayMeteringPolicyId: pulumi.Input.fromValue(map['transitGatewayMeteringPolicyId'] as String),
    );
  }
}
