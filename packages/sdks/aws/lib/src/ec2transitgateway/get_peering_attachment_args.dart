...
class GetPeeringAttachmentArgs {
  ...
  GetPeeringAttachmentArgs({
    pulumi.Output<List<GetPeeringAttachmentFilter>>? filters,
    pulumi.Output<String>? id,
    pulumi.Output<String>? region,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      filters = pulumi.Input.asOptionalInput<List<GetPeeringAttachmentFilter>>(filters),
  ...
  factory GetPeeringAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return GetPeeringAttachmentArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetPeeringAttachmentFilter>>(pulumi.Input.decodeList<GetPeeringAttachmentFilter>(map['filters'], (value) => GetPeeringAttachmentFilter.fromMap((value as Map).cast<String, dynamic>()))),
