...
class GetPeeringAttachmentArgs {
  ...
  factory GetPeeringAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return GetPeeringAttachmentArgs(
      filters: map['filters'] == null ? null : (pulumi.Input.decodeList<GetPeeringAttachmentFilter>(map['filters'], (value) => GetPeeringAttachmentFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
