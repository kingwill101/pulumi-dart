...
class GetAttachmentsArgs {
  ...
  factory GetAttachmentsArgs.fromMap(Map<String, dynamic> map) {
    return GetAttachmentsArgs(
      filters: map['filters'] == null ? null : (pulumi.Input.decodeList<GetAttachmentsFilter>(map['filters'], (value) => GetAttachmentsFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
