...
class GetAttachmentsArgs {
  ...
  factory GetAttachmentsArgs.fromMap(Map<String, dynamic> map) {
    return GetAttachmentsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAttachmentsFilter>(guardedValue, (value) => GetAttachmentsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
