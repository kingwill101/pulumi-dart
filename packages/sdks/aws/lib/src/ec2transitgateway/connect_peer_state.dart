...
class ConnectPeerState {
  ...
  factory ConnectPeerState.fromMap(Map<String, dynamic> map) {
    return ConnectPeerState(
      ...
      bgpPeerAddress: (() { final guardedValue = map['bgpPeerAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      bgpTransitGatewayAddresses: (() { final guardedValue = map['bgpTransitGatewayAddresses']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
