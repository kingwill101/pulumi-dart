...
class GetTransitGatewayArgs {
  ...
  factory GetTransitGatewayArgs.fromMap(Map<String, dynamic> map) {
    return GetTransitGatewayArgs(
      filters: map['filters'] == null ? null : ((pulumi.Input.decodeList<GetTransitGatewayFilter>(map['filters']!, (value) => GetTransitGatewayFilter.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
