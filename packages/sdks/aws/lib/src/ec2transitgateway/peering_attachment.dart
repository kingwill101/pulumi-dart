...
import 'peering_attachment_state.dart';
...
class PeeringAttachment extends pulumi.CustomResource {
  ...
  /// Gets an existing [PeeringAttachment] resource's state with the given [name] and [id].
  static PeeringAttachment get(
    String name,
