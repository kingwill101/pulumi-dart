...
import 'route_table_propagation_state.dart';
...
/// }
///
/// resource "aws_ec2transitgateway_routetablepropagation" "example" {
...
class RouteTablePropagation extends pulumi.CustomResource {
  ...
  /// Gets an existing [RouteTablePropagation] resource's state with the given [name] and [id].
  static RouteTablePropagation get(
    String name,
