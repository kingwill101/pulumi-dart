...
class MeteringPolicyEntryTimeouts {
  ...
  /// Creates a new [MeteringPolicyEntryTimeouts].
  ...
  const MeteringPolicyEntryTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory MeteringPolicyEntryTimeouts.fromMap(Map<String, dynamic> map) {
    return MeteringPolicyEntryTimeouts(
