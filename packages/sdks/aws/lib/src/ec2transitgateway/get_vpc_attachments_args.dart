...
class GetVpcAttachmentsArgs {
  ...
  factory GetVpcAttachmentsArgs.fromMap(Map<String, dynamic> map) {
    return GetVpcAttachmentsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVpcAttachmentsFilter>(guardedValue, (value) => GetVpcAttachmentsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
