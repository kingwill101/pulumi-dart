...
class GetPeeringAttachmentsArgs {
  ...
  const GetPeeringAttachmentsArgs({
    this.filters,
    this.region,
  });
  ...
  factory GetPeeringAttachmentsArgs.fromMap(Map<String, dynamic> map) {
    return GetPeeringAttachmentsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetPeeringAttachmentsFilter>(guardedValue, (value) => GetPeeringAttachmentsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
