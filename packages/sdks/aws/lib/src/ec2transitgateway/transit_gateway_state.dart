...
class TransitGatewayState {
  ...
  factory TransitGatewayState.fromMap(Map<String, dynamic> map) {
    return TransitGatewayState(
      ...
      associationDefaultRouteTableId: map['associationDefaultRouteTableId'] == null ? null : (map['associationDefaultRouteTableId'] as String).input(),
      ...
      propagationDefaultRouteTableId: map['propagationDefaultRouteTableId'] == null ? null : (map['propagationDefaultRouteTableId'] as String).input(),
