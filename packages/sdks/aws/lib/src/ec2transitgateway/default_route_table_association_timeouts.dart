...
class DefaultRouteTableAssociationTimeouts {
  ...
  /// Creates a new [DefaultRouteTableAssociationTimeouts].
  ...
  DefaultRouteTableAssociationTimeouts({this.create, this.delete, this.update});
  ...
  factory DefaultRouteTableAssociationTimeouts.fromMap(
    Map<String, dynamic> map,
  ) {
    return DefaultRouteTableAssociationTimeouts(
      create: (() {
