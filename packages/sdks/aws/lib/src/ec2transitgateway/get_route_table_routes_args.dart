...
class GetRouteTableRoutesArgs {
  ...
  factory GetRouteTableRoutesArgs.fromMap(Map<String, dynamic> map) {
    return GetRouteTableRoutesArgs(
      filters: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteTableRoutesFilter>(map['filters']!, (value) => GetRouteTableRoutesFilter.fromMap((value as Map).cast<String, dynamic>()))),
