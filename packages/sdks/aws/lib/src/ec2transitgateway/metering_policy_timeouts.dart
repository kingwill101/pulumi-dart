...
class MeteringPolicyTimeouts {
  ...
  /// Creates a new [MeteringPolicyTimeouts].
  ...
  factory MeteringPolicyTimeouts.fromMap(Map<String, dynamic> map) {
    return MeteringPolicyTimeouts(
