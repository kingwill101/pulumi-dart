...
class GetVpcAttachmentArgs {
  ...
  GetVpcAttachmentArgs({
    pulumi.Output<List<GetVpcAttachmentFilter>>? filters,
    pulumi.Output<String>? id,
    pulumi.Output<String>? region,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      filters = pulumi.Input.asOptionalInput<List<GetVpcAttachmentFilter>>(filters),
  ...
  factory GetVpcAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return GetVpcAttachmentArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetVpcAttachmentFilter>>(pulumi.Input.decodeList<GetVpcAttachmentFilter>(map['filters'], (value) => GetVpcAttachmentFilter.fromMap((value as Map).cast<String, dynamic>()))),
