...
class GetVpcAttachmentArgs {
  ...
  factory GetVpcAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return GetVpcAttachmentArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVpcAttachmentFilter>(guardedValue, (value) => GetVpcAttachmentFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
