...
class GetMulticastDomainResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?filters == null ? null : pulumi.Input.encodeList<GetMulticastDomainFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
      'id': id,
  ...
  factory GetMulticastDomainResult.fromMap(Map<String, dynamic> map) {
    return GetMulticastDomainResult(
      ...
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<GetMulticastDomainFilter>(map['filters']!, (value) => GetMulticastDomainFilter.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
