...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettings {
  ...
  const DataCatalogEncryptionSettingsDataCatalogEncryptionSettings({
  ...
  factory DataCatalogEncryptionSettingsDataCatalogEncryptionSettings.fromMap(Map<String, dynamic> map) {
    return DataCatalogEncryptionSettingsDataCatalogEncryptionSettings(
      connectionPasswordEncryption: pulumi.Input.fromValue(DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsConnectionPasswordEncryption.fromMap((map['connectionPasswordEncryption']! as Map).cast<String, dynamic>())),
      encryptionAtRest: pulumi.Input.fromValue(DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRest.fromMap((map['encryptionAtRest']! as Map).cast<String, dynamic>())),
    );
  }
}
