...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettings {
    ...
    return <String, dynamic>{
      'connectionPasswordEncryption':
          pulumi.Input.mapInputValue<
            DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsConnectionPasswordEncryption,
            Map<String, dynamic>
          >(connectionPasswordEncryption, (value) => value.toMap()),
      'encryptionAtRest':
          pulumi.Input.mapInputValue<
            DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRest,
            Map<String, dynamic>
          >(encryptionAtRest, (value) => value.toMap()),
    };
  }
  ...
  factory DataCatalogEncryptionSettingsDataCatalogEncryptionSettings.fromMap(
    ...
    return DataCatalogEncryptionSettingsDataCatalogEncryptionSettings(
      connectionPasswordEncryption: pulumi.Input.fromValue(
        DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsConnectionPasswordEncryption.fromMap(
          (map['connectionPasswordEncryption']! as Map).cast<String, dynamic>(),
        ),
      ),
      encryptionAtRest: pulumi.Input.fromValue(
