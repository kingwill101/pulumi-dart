...
class GetCatalogTableStorageDescriptor {
  ...
  final pulumi.Input<List<GetCatalogTableStorageDescriptorSchemaReference>>
  schemaReferences;

  /// Configuration block for serialization and deserialization ("SerDe") information. See `ser_de_info` below.
  final pulumi.Input<List<GetCatalogTableStorageDescriptorSerDeInfo>>
  serDeInfos;

  /// Configuration block with information about values that appear very frequently in a column (skewed values). See `skewed_info` below.
  final pulumi.Input<List<GetCatalogTableStorageDescriptorSkewedInfo>>
  skewedInfos;

  /// Configuration block for the sort order of each bucket in the table. See `sort_columns` below.
  final pulumi.Input<List<GetCatalogTableStorageDescriptorSortColumn>>
  sortColumns;
    ...
    return <String, dynamic>{
      ...
      'columns':
          pulumi.Input.mapInputValue<
            List<GetCatalogTableStorageDescriptorColumn>,
      ...
      'skewedInfos':
          pulumi.Input.mapInputValue<
            List<GetCatalogTableStorageDescriptorSkewedInfo>,
            List<Map<String, dynamic>>
          >(
            skewedInfos,
            (value) =>
      ...
      'sortColumns':
          pulumi.Input.mapInputValue<
            List<GetCatalogTableStorageDescriptorSortColumn>,
            List<Map<String, dynamic>>
          >(
            sortColumns,
            (value) =>
  ...
  factory GetCatalogTableStorageDescriptor.fromMap(Map<String, dynamic> map) {
    return GetCatalogTableStorageDescriptor(
      additionalLocations: pulumi.Input.fromValue(
        (map['additionalLocations'] as List).cast<String>(),
      ),
      bucketColumns: pulumi.Input.fromValue(
        (map['bucketColumns'] as List).cast<String>(),
      ),
      columns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetCatalogTableStorageDescriptorColumn>(
          map['columns']!,
      ...
      serDeInfos: pulumi.Input.fromValue(
      ...
      skewedInfos: pulumi.Input.fromValue(
      ...
      sortColumns: pulumi.Input.fromValue(
      ...
      storedAsSubDirectories: pulumi.Input.fromValue(
