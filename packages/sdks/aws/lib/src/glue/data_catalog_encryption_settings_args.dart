...
class DataCatalogEncryptionSettingsArgs {
  ...
  const DataCatalogEncryptionSettingsArgs({
    this.catalogId,
  ...
  factory DataCatalogEncryptionSettingsArgs.fromMap(Map<String, dynamic> map) {
    return DataCatalogEncryptionSettingsArgs(
      ...
      dataCatalogEncryptionSettings: pulumi.Input.fromValue(DataCatalogEncryptionSettingsDataCatalogEncryptionSettings.fromMap((map['dataCatalogEncryptionSettings']! as Map).cast<String, dynamic>())),
