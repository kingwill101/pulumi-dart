...
class TriggerAction {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'jobName': ?jobName,
      'notificationProperty': ?notificationProperty == null ? null : notificationProperty!.toMap(),
  ...
  factory TriggerAction.fromMap(Map<String, dynamic> map) {
    return TriggerAction(
      ...
      notificationProperty: map['notificationProperty'] == null ? null : TriggerActionNotificationProperty.fromMap((map['notificationProperty'] as Map).cast<String, dynamic>()),
