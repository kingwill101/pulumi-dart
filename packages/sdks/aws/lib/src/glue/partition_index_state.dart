...
class PartitionIndexState {
  ...
  factory PartitionIndexState.fromMap(Map<String, dynamic> map) {
    return PartitionIndexState(
      ...
      partitionIndex: (() { final guardedValue = map['partitionIndex']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PartitionIndexPartitionIndex.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
