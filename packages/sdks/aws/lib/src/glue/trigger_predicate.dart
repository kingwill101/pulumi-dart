...
class TriggerPredicate {
  ...
  factory TriggerPredicate.fromMap(Map<String, dynamic> map) {
    return TriggerPredicate(
      conditions: pulumi.Input.fromValue(pulumi.Input.decodeList<TriggerPredicateCondition>(map['conditions']!, (value) => TriggerPredicateCondition.fromMap((value as Map).cast<String, dynamic>()))),
      logical: (() { final guardedValue = map['logical']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
