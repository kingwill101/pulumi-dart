...
class TriggerPredicate {
  ...
  TriggerPredicate({required this.conditions, this.logical});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<TriggerPredicateCondition>,
  ...
  factory TriggerPredicate.fromMap(Map<String, dynamic> map) {
    return TriggerPredicate(
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TriggerPredicateCondition>(
          map['conditions']!,
      ...
      logical: (() {
        final guardedValue = map['logical'];
