...
class DevEndpointState {
  ...
  factory DevEndpointState.fromMap(Map<String, dynamic> map) {
    return DevEndpointState(
      ...
      privateAddress: map['privateAddress'] == null ? null : (map['privateAddress'] as String).input(),
      publicAddress: map['publicAddress'] == null ? null : (map['publicAddress'] as String).input(),
      ...
      yarnEndpointAddress: map['yarnEndpointAddress'] == null ? null : (map['yarnEndpointAddress'] as String).input(),
      zeppelinRemoteSparkInterpreterPort: map['zeppelinRemoteSparkInterpreterPort'] == null ? null : (map['zeppelinRemoteSparkInterpreterPort'] as int).input(),
    );
  }
}
