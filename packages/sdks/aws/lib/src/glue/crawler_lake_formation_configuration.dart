...
class CrawlerLakeFormationConfiguration {
  ...
  factory CrawlerLakeFormationConfiguration.fromMap(Map<String, dynamic> map) {
    return CrawlerLakeFormationConfiguration(
      ...
      useLakeFormationCredentials: (() { final guardedValue = map['useLakeFormationCredentials']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
