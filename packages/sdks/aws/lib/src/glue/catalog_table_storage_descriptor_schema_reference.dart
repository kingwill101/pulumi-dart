...
class CatalogTableStorageDescriptorSchemaReference {
  ...
  final pulumi.Input<CatalogTableStorageDescriptorSchemaReferenceSchemaId>?
  schemaId;
  ...
  factory CatalogTableStorageDescriptorSchemaReference.fromMap(
    ...
    return CatalogTableStorageDescriptorSchemaReference(
      ...
      schemaVersionId: (() {
        final guardedValue = map['schemaVersionId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      schemaVersionNumber: pulumi.Input.fromValue(
        map['schemaVersionNumber'] as int,
      ),
    );
  }
}
