...
class SchemaState {
  ...
  factory SchemaState.fromMap(Map<String, dynamic> map) {
    return SchemaState(
      ...
      latestSchemaVersion: (() { final guardedValue = map['latestSchemaVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      nextSchemaVersion: (() { final guardedValue = map['nextSchemaVersion']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      schemaCheckpoint: (() { final guardedValue = map['schemaCheckpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
