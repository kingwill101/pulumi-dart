...
class CatalogTable extends pulumi.CustomResource {
  ...
  CatalogTable(
    ...
    this.openTableFormatInput = registerOutput<CatalogTableOpenTableFormatInput?>('openTableFormatInput');
    this.owner = registerOutput<String?>('owner');
    this.parameters = registerOutput<Map<String, String>?>('parameters');
    this.partitionIndices = registerOutput<List<CatalogTablePartitionIndex>>('partitionIndices');
    this.partitionKeys = registerOutput<List<CatalogTablePartitionKey>?>('partitionKeys');
    this.region = registerOutput<String>('region');
    this.retention = registerOutput<int?>('retention');
    this.storageDescriptor = registerOutput<CatalogTableStorageDescriptor?>('storageDescriptor');
