...
class MLTransformState {
  ...
  factory MLTransformState.fromMap(Map<String, dynamic> map) {
    return MLTransformState(
      ...
      inputRecordTables: (() {
        final guardedValue = map['inputRecordTables'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MLTransformInputRecordTable>(
            guardedValue,
      ...
      labelCount: (() {
        final guardedValue = map['labelCount'];
        if (guardedValue == null) return null;
      ...
      schemas: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<MLTransformSchema>(
            guardedValue,
            (value) => MLTransformSchema.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
