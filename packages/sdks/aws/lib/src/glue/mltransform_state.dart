...
class MLTransformState {
  ...
  factory MLTransformState.fromMap(Map<String, dynamic> map) {
    return MLTransformState(
      ...
      inputRecordTables: map['inputRecordTables'] == null ? null : (pulumi.Input.decodeList<MLTransformInputRecordTable>(map['inputRecordTables'], (value) => MLTransformInputRecordTable.fromMap((value as Map).cast<String, dynamic>()))).input(),
      labelCount: map['labelCount'] == null ? null : (map['labelCount'] as int).input(),
      ...
      parameters: map['parameters'] == null ? null : (MLTransformParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      roleArn: map['roleArn'] == null ? null : (map['roleArn'] as String).input(),
      schemas: map['schemas'] == null ? null : (pulumi.Input.decodeList<MLTransformSchema>(map['schemas'], (value) => MLTransformSchema.fromMap((value as Map).cast<String, dynamic>()))).input(),
