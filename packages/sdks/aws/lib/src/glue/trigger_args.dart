...
class TriggerArgs {
  ...
  TriggerArgs({
    required pulumi.Output<List<TriggerAction>> actions,
  ...
  factory TriggerArgs.fromMap(Map<String, dynamic> map) {
    return TriggerArgs(
      actions: pulumi.Output.create<List<TriggerAction>>(pulumi.Input.decodeList<TriggerAction>(map['actions'], (value) => TriggerAction.fromMap((value as Map).cast<String, dynamic>()))),
