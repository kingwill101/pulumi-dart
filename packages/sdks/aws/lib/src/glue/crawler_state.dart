...
class CrawlerState {
  ...
  factory CrawlerState.fromMap(Map<String, dynamic> map) {
    return CrawlerState(
      ...
      catalogTargets: map['catalogTargets'] == null ? null : (pulumi.Input.decodeList<CrawlerCatalogTarget>(map['catalogTargets'], (value) => CrawlerCatalogTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      classifiers: map['classifiers'] == null ? null : ((map['classifiers'] as List).cast<String>()).input(),
      configuration: map['configuration'] == null ? null : (map['configuration'] as String).input(),
      databaseName: map['databaseName'] == null ? null : (map['databaseName'] as String).input(),
      deltaTargets: map['deltaTargets'] == null ? null : (pulumi.Input.decodeList<CrawlerDeltaTarget>(map['deltaTargets'], (value) => CrawlerDeltaTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      dynamodbTargets: map['dynamodbTargets'] == null ? null : (pulumi.Input.decodeList<CrawlerDynamodbTarget>(map['dynamodbTargets'], (value) => CrawlerDynamodbTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      hudiTargets: map['hudiTargets'] == null ? null : (pulumi.Input.decodeList<CrawlerHudiTarget>(map['hudiTargets'], (value) => CrawlerHudiTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      icebergTargets: map['icebergTargets'] == null ? null : (pulumi.Input.decodeList<CrawlerIcebergTarget>(map['icebergTargets'], (value) => CrawlerIcebergTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      jdbcTargets: map['jdbcTargets'] == null ? null : (pulumi.Input.decodeList<CrawlerJdbcTarget>(map['jdbcTargets'], (value) => CrawlerJdbcTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      lakeFormationConfiguration: map['lakeFormationConfiguration'] == null ? null : (CrawlerLakeFormationConfiguration.fromMap((map['lakeFormationConfiguration'] as Map).cast<String, dynamic>())).input(),
      lineageConfiguration: map['lineageConfiguration'] == null ? null : (CrawlerLineageConfiguration.fromMap((map['lineageConfiguration'] as Map).cast<String, dynamic>())).input(),
      mongodbTargets: map['mongodbTargets'] == null ? null : (pulumi.Input.decodeList<CrawlerMongodbTarget>(map['mongodbTargets'], (value) => CrawlerMongodbTarget.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      recrawlPolicy: map['recrawlPolicy'] == null ? null : (CrawlerRecrawlPolicy.fromMap((map['recrawlPolicy'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      role: map['role'] == null ? null : (map['role'] as String).input(),
      s3Targets: map['s3Targets'] == null ? null : (pulumi.Input.decodeList<CrawlerS3Target>(map['s3Targets'], (value) => CrawlerS3Target.fromMap((value as Map).cast<String, dynamic>()))).input(),
      schedule: map['schedule'] == null ? null : (map['schedule'] as String).input(),
      schemaChangePolicy: map['schemaChangePolicy'] == null ? null : (CrawlerSchemaChangePolicy.fromMap((map['schemaChangePolicy'] as Map).cast<String, dynamic>())).input(),
