...
class CrawlerState {
  ...
  CrawlerState({
    ...
    pulumi.Output<List<CrawlerCatalogTarget>>? catalogTargets,
    pulumi.Output<List<String>>? classifiers,
    pulumi.Output<String>? configuration,
    pulumi.Output<String>? databaseName,
    pulumi.Output<List<CrawlerDeltaTarget>>? deltaTargets,
    pulumi.Output<String>? description,
    pulumi.Output<List<CrawlerDynamodbTarget>>? dynamodbTargets,
    pulumi.Output<List<CrawlerHudiTarget>>? hudiTargets,
    pulumi.Output<List<CrawlerIcebergTarget>>? icebergTargets,
    pulumi.Output<List<CrawlerJdbcTarget>>? jdbcTargets,
    pulumi.Output<CrawlerLakeFormationConfiguration>? lakeFormationConfiguration,
    pulumi.Output<CrawlerLineageConfiguration>? lineageConfiguration,
    pulumi.Output<List<CrawlerMongodbTarget>>? mongodbTargets,
    pulumi.Output<String>? name,
    pulumi.Output<CrawlerRecrawlPolicy>? recrawlPolicy,
    pulumi.Output<String>? region,
    pulumi.Output<String>? role,
    pulumi.Output<List<CrawlerS3Target>>? s3Targets,
    pulumi.Output<String>? schedule,
    pulumi.Output<CrawlerSchemaChangePolicy>? schemaChangePolicy,
    pulumi.Output<String>? securityConfiguration,
    pulumi.Output<String>? tablePrefix,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<Map<String, String>>? tagsAll,
  }) :
      arn = pulumi.Input.asOptionalInput<String>(arn),
      catalogTargets = pulumi.Input.asOptionalInput<List<CrawlerCatalogTarget>>(catalogTargets),
      ...
      deltaTargets = pulumi.Input.asOptionalInput<List<CrawlerDeltaTarget>>(deltaTargets),
      description = pulumi.Input.asOptionalInput<String>(description),
      dynamodbTargets = pulumi.Input.asOptionalInput<List<CrawlerDynamodbTarget>>(dynamodbTargets),
      hudiTargets = pulumi.Input.asOptionalInput<List<CrawlerHudiTarget>>(hudiTargets),
      icebergTargets = pulumi.Input.asOptionalInput<List<CrawlerIcebergTarget>>(icebergTargets),
      jdbcTargets = pulumi.Input.asOptionalInput<List<CrawlerJdbcTarget>>(jdbcTargets),
      lakeFormationConfiguration = pulumi.Input.asOptionalInput<CrawlerLakeFormationConfiguration>(lakeFormationConfiguration),
      lineageConfiguration = pulumi.Input.asOptionalInput<CrawlerLineageConfiguration>(lineageConfiguration),
      mongodbTargets = pulumi.Input.asOptionalInput<List<CrawlerMongodbTarget>>(mongodbTargets),
      name = pulumi.Input.asOptionalInput<String>(name),
      recrawlPolicy = pulumi.Input.asOptionalInput<CrawlerRecrawlPolicy>(recrawlPolicy),
      region = pulumi.Input.asOptionalInput<String>(region),
      role = pulumi.Input.asOptionalInput<String>(role),
      s3Targets = pulumi.Input.asOptionalInput<List<CrawlerS3Target>>(s3Targets),
      schedule = pulumi.Input.asOptionalInput<String>(schedule),
      schemaChangePolicy = pulumi.Input.asOptionalInput<CrawlerSchemaChangePolicy>(schemaChangePolicy),
  ...
  factory CrawlerState.fromMap(Map<String, dynamic> map) {
    return CrawlerState(
      ...
      catalogTargets: map['catalogTargets'] == null ? null : pulumi.Output.create<List<CrawlerCatalogTarget>>(pulumi.Input.decodeList<CrawlerCatalogTarget>(map['catalogTargets'], (value) => CrawlerCatalogTarget.fromMap((value as Map).cast<String, dynamic>()))),
      classifiers: map['classifiers'] == null ? null : pulumi.Output.create<List<String>>((map['classifiers'] as List).cast<String>()),
      ...
      deltaTargets: map['deltaTargets'] == null ? null : pulumi.Output.create<List<CrawlerDeltaTarget>>(pulumi.Input.decodeList<CrawlerDeltaTarget>(map['deltaTargets'], (value) => CrawlerDeltaTarget.fromMap((value as Map).cast<String, dynamic>()))),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      dynamodbTargets: map['dynamodbTargets'] == null ? null : pulumi.Output.create<List<CrawlerDynamodbTarget>>(pulumi.Input.decodeList<CrawlerDynamodbTarget>(map['dynamodbTargets'], (value) => CrawlerDynamodbTarget.fromMap((value as Map).cast<String, dynamic>()))),
      hudiTargets: map['hudiTargets'] == null ? null : pulumi.Output.create<List<CrawlerHudiTarget>>(pulumi.Input.decodeList<CrawlerHudiTarget>(map['hudiTargets'], (value) => CrawlerHudiTarget.fromMap((value as Map).cast<String, dynamic>()))),
      icebergTargets: map['icebergTargets'] == null ? null : pulumi.Output.create<List<CrawlerIcebergTarget>>(pulumi.Input.decodeList<CrawlerIcebergTarget>(map['icebergTargets'], (value) => CrawlerIcebergTarget.fromMap((value as Map).cast<String, dynamic>()))),
      jdbcTargets: map['jdbcTargets'] == null ? null : pulumi.Output.create<List<CrawlerJdbcTarget>>(pulumi.Input.decodeList<CrawlerJdbcTarget>(map['jdbcTargets'], (value) => CrawlerJdbcTarget.fromMap((value as Map).cast<String, dynamic>()))),
      lakeFormationConfiguration: map['lakeFormationConfiguration'] == null ? null : pulumi.Output.create<CrawlerLakeFormationConfiguration>(CrawlerLakeFormationConfiguration.fromMap((map['lakeFormationConfiguration'] as Map).cast<String, dynamic>())),
      lineageConfiguration: map['lineageConfiguration'] == null ? null : pulumi.Output.create<CrawlerLineageConfiguration>(CrawlerLineageConfiguration.fromMap((map['lineageConfiguration'] as Map).cast<String, dynamic>())),
      mongodbTargets: map['mongodbTargets'] == null ? null : pulumi.Output.create<List<CrawlerMongodbTarget>>(pulumi.Input.decodeList<CrawlerMongodbTarget>(map['mongodbTargets'], (value) => CrawlerMongodbTarget.fromMap((value as Map).cast<String, dynamic>()))),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      recrawlPolicy: map['recrawlPolicy'] == null ? null : pulumi.Output.create<CrawlerRecrawlPolicy>(CrawlerRecrawlPolicy.fromMap((map['recrawlPolicy'] as Map).cast<String, dynamic>())),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      role: map['role'] == null ? null : pulumi.Output.create<String>(map['role'] as String),
      s3Targets: map['s3Targets'] == null ? null : pulumi.Output.create<List<CrawlerS3Target>>(pulumi.Input.decodeList<CrawlerS3Target>(map['s3Targets'], (value) => CrawlerS3Target.fromMap((value as Map).cast<String, dynamic>()))),
      schedule: map['schedule'] == null ? null : pulumi.Output.create<String>(map['schedule'] as String),
      schemaChangePolicy: map['schemaChangePolicy'] == null ? null : pulumi.Output.create<CrawlerSchemaChangePolicy>(CrawlerSchemaChangePolicy.fromMap((map['schemaChangePolicy'] as Map).cast<String, dynamic>())),
      ...
      tablePrefix: map['tablePrefix'] == null ? null : pulumi.Output.create<String>(map['tablePrefix'] as String),
