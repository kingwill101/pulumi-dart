...
class CrawlerState {
  ...
  factory CrawlerState.fromMap(Map<String, dynamic> map) {
    return CrawlerState(
      ...
      catalogTargets: (() {
        final guardedValue = map['catalogTargets'];
        if (guardedValue == null) return null;
      ...
      classifiers: (() {
        final guardedValue = map['classifiers'];
        if (guardedValue == null) return null;
      ...
      deltaTargets: (() {
        final guardedValue = map['deltaTargets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dynamodbTargets: (() {
        final guardedValue = map['dynamodbTargets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      hudiTargets: (() {
        final guardedValue = map['hudiTargets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      icebergTargets: (() {
        final guardedValue = map['icebergTargets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      jdbcTargets: (() {
        final guardedValue = map['jdbcTargets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lakeFormationConfiguration: (() {
        final guardedValue = map['lakeFormationConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      lineageConfiguration: (() {
        final guardedValue = map['lineageConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      mongodbTargets: (() {
        final guardedValue = map['mongodbTargets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      recrawlPolicy: (() {
        final guardedValue = map['recrawlPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      s3Targets: (() {
        final guardedValue = map['s3Targets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CrawlerS3Target>(
            guardedValue,
            (value) =>
                CrawlerS3Target.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      schedule: (() {
      ...
      schemaChangePolicy: (() {
        final guardedValue = map['schemaChangePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
