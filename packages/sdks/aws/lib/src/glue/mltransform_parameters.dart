...
class MLTransformParameters {
  ...
  final pulumi.Input<MLTransformParametersFindMatchesParameters>
    ...
    return <String, dynamic>{
      'findMatchesParameters':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(findMatchesParameters, (value) => value.toMap()),
  ...
  factory MLTransformParameters.fromMap(Map<String, dynamic> map) {
    return MLTransformParameters(
      findMatchesParameters: pulumi.Input.fromValue(
        MLTransformParametersFindMatchesParameters.fromMap(
          (map['findMatchesParameters']! as Map).cast<String, dynamic>(),
        ),
      ),
      transformType: pulumi.Input.fromValue(map['transformType'] as String),
    );
  }
}
