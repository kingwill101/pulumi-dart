...
class Job extends pulumi.CustomResource {
  ...
  Job(
    ...
    this.defaultArguments = registerOutput<Map<String, String>?>('defaultArguments');
    this.description = registerOutput<String?>('description');
    this.executionClass = registerOutput<String?>('executionClass');
    this.executionProperty = registerOutput<JobExecutionProperty>('executionProperty');
    ...
    this.nonOverridableArguments = registerOutput<Map<String, String>?>('nonOverridableArguments');
    this.notificationProperty = registerOutput<JobNotificationProperty>('notificationProperty');
    ...
    this.sourceControlDetails = registerOutput<JobSourceControlDetails?>('sourceControlDetails');
