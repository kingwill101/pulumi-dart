...
class PartitionStorageDescriptor {
  ...
  factory PartitionStorageDescriptor.fromMap(Map<String, dynamic> map) {
    return PartitionStorageDescriptor(
      ...
      columns: (() { final guardedValue = map['columns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PartitionStorageDescriptorColumn>(guardedValue, (value) => PartitionStorageDescriptorColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serDeInfo: (() { final guardedValue = map['serDeInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PartitionStorageDescriptorSerDeInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      skewedInfo: (() { final guardedValue = map['skewedInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PartitionStorageDescriptorSkewedInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sortColumns: (() { final guardedValue = map['sortColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PartitionStorageDescriptorSortColumn>(guardedValue, (value) => PartitionStorageDescriptorSortColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
