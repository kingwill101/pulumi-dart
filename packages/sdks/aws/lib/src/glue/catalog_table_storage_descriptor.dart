...
class CatalogTableStorageDescriptor {
  ...
  factory CatalogTableStorageDescriptor.fromMap(Map<String, dynamic> map) {
    return CatalogTableStorageDescriptor(
      additionalLocations: (() { final guardedValue = map['additionalLocations']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      bucketColumns: (() { final guardedValue = map['bucketColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      columns: (() { final guardedValue = map['columns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CatalogTableStorageDescriptorColumn>(guardedValue, (value) => CatalogTableStorageDescriptorColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      serDeInfo: (() { final guardedValue = map['serDeInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CatalogTableStorageDescriptorSerDeInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      skewedInfo: (() { final guardedValue = map['skewedInfo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CatalogTableStorageDescriptorSkewedInfo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sortColumns: (() { final guardedValue = map['sortColumns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<CatalogTableStorageDescriptorSortColumn>(guardedValue, (value) => CatalogTableStorageDescriptorSortColumn.fromMap((value as Map).cast<String, dynamic>()))); })(),
      storedAsSubDirectories: (() { final guardedValue = map['storedAsSubDirectories']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
