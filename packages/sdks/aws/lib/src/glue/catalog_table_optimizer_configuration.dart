...
class CatalogTableOptimizerConfiguration {
  ...
  final pulumi.Input<CatalogTableOptimizerConfigurationRetentionConfiguration>?
    ...
    return <String, dynamic>{
      ...
      'orphanFileDeletionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            CatalogTableOptimizerConfigurationOrphanFileDeletionConfiguration,
            Map<String, dynamic>
          >(orphanFileDeletionConfiguration, (value) => value.toMap()),
      'retentionConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            CatalogTableOptimizerConfigurationRetentionConfiguration,
            Map<String, dynamic>
          >(retentionConfiguration, (value) => value.toMap()),
      'roleArn': roleArn,
    };
  }
  ...
  factory CatalogTableOptimizerConfiguration.fromMap(Map<String, dynamic> map) {
    return CatalogTableOptimizerConfiguration(
      ...
      orphanFileDeletionConfiguration: (() {
        final guardedValue = map['orphanFileDeletionConfiguration'];
      ...
      retentionConfiguration: (() {
        final guardedValue = map['retentionConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
