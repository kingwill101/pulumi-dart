...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      command: (JobCommand.fromMap((map['command']! as Map).cast<String, dynamic>())).input(),
      connections: map['connections'] == null ? null : (((map['connections'] as List).cast<String>()).input()).input(),
      defaultArguments: map['defaultArguments'] == null ? null : (((map['defaultArguments'] as Map).cast<String, String>()).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      executionClass: map['executionClass'] == null ? null : ((map['executionClass'] as String).input()).input(),
      executionProperty: map['executionProperty'] == null ? null : ((JobExecutionProperty.fromMap((map['executionProperty']! as Map).cast<String, dynamic>())).input()).input(),
      glueVersion: map['glueVersion'] == null ? null : ((map['glueVersion'] as String).input()).input(),
      jobMode: map['jobMode'] == null ? null : ((map['jobMode'] as String).input()).input(),
      jobRunQueuingEnabled: map['jobRunQueuingEnabled'] == null ? null : ((map['jobRunQueuingEnabled'] as bool).input()).input(),
      ...
      nonOverridableArguments: map['nonOverridableArguments'] == null ? null : (((map['nonOverridableArguments'] as Map).cast<String, String>()).input()).input(),
      notificationProperty: map['notificationProperty'] == null ? null : ((JobNotificationProperty.fromMap((map['notificationProperty']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      sourceControlDetails: map['sourceControlDetails'] == null ? null : ((JobSourceControlDetails.fromMap((map['sourceControlDetails']! as Map).cast<String, dynamic>())).input()).input(),
