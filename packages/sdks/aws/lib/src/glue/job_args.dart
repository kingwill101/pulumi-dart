...
class JobArgs {
  ...
  JobArgs({
    required pulumi.Output<JobCommand> command,
    pulumi.Output<List<String>>? connections,
    pulumi.Output<Map<String, String>>? defaultArguments,
    pulumi.Output<String>? description,
    pulumi.Output<String>? executionClass,
    pulumi.Output<JobExecutionProperty>? executionProperty,
    pulumi.Output<String>? glueVersion,
    pulumi.Output<String>? jobMode,
    pulumi.Output<bool>? jobRunQueuingEnabled,
    pulumi.Output<String>? maintenanceWindow,
    pulumi.Output<double>? maxCapacity,
    pulumi.Output<int>? maxRetries,
    pulumi.Output<String>? name,
    pulumi.Output<Map<String, String>>? nonOverridableArguments,
    pulumi.Output<JobNotificationProperty>? notificationProperty,
    pulumi.Output<int>? numberOfWorkers,
    pulumi.Output<String>? region,
    required pulumi.Output<String> roleArn,
    pulumi.Output<String>? securityConfiguration,
    pulumi.Output<JobSourceControlDetails>? sourceControlDetails,
    ...
    pulumi.Output<String>? workerType,
      ...
      defaultArguments = pulumi.Input.asOptionalInput<Map<String, String>>(defaultArguments),
      description = pulumi.Input.asOptionalInput<String>(description),
      executionClass = pulumi.Input.asOptionalInput<String>(executionClass),
      executionProperty = pulumi.Input.asOptionalInput<JobExecutionProperty>(executionProperty),
      glueVersion = pulumi.Input.asOptionalInput<String>(glueVersion),
      jobMode = pulumi.Input.asOptionalInput<String>(jobMode),
      jobRunQueuingEnabled = pulumi.Input.asOptionalInput<bool>(jobRunQueuingEnabled),
      ...
      nonOverridableArguments = pulumi.Input.asOptionalInput<Map<String, String>>(nonOverridableArguments),
      notificationProperty = pulumi.Input.asOptionalInput<JobNotificationProperty>(notificationProperty),
      ...
      sourceControlDetails = pulumi.Input.asOptionalInput<JobSourceControlDetails>(sourceControlDetails),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'command': pulumi.Input.mapInputValue<JobCommand, Map<String, dynamic>>(command, (value) => value.toMap()),
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      command: pulumi.Output.create<JobCommand>(JobCommand.fromMap((map['command'] as Map).cast<String, dynamic>())),
      connections: map['connections'] == null ? null : pulumi.Output.create<List<String>>((map['connections'] as List).cast<String>()),
      defaultArguments: map['defaultArguments'] == null ? null : pulumi.Output.create<Map<String, String>>((map['defaultArguments'] as Map).cast<String, String>()),
      description: map['description'] == null ? null : pulumi.Output.create<String>(map['description'] as String),
      executionClass: map['executionClass'] == null ? null : pulumi.Output.create<String>(map['executionClass'] as String),
      executionProperty: map['executionProperty'] == null ? null : pulumi.Output.create<JobExecutionProperty>(JobExecutionProperty.fromMap((map['executionProperty'] as Map).cast<String, dynamic>())),
      glueVersion: map['glueVersion'] == null ? null : pulumi.Output.create<String>(map['glueVersion'] as String),
      jobMode: map['jobMode'] == null ? null : pulumi.Output.create<String>(map['jobMode'] as String),
      jobRunQueuingEnabled: map['jobRunQueuingEnabled'] == null ? null : pulumi.Output.create<bool>(map['jobRunQueuingEnabled'] as bool),
      ...
      nonOverridableArguments: map['nonOverridableArguments'] == null ? null : pulumi.Output.create<Map<String, String>>((map['nonOverridableArguments'] as Map).cast<String, String>()),
      notificationProperty: map['notificationProperty'] == null ? null : pulumi.Output.create<JobNotificationProperty>(JobNotificationProperty.fromMap((map['notificationProperty'] as Map).cast<String, dynamic>())),
      ...
      sourceControlDetails: map['sourceControlDetails'] == null ? null : pulumi.Output.create<JobSourceControlDetails>(JobSourceControlDetails.fromMap((map['sourceControlDetails'] as Map).cast<String, dynamic>())),
