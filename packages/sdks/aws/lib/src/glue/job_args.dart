...
class JobArgs {
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      connections: map['connections'] == null ? null : ((map['connections'] as List).cast<String>()).input(),
      defaultArguments: map['defaultArguments'] == null ? null : ((map['defaultArguments'] as Map).cast<String, String>()).input(),
      description: map['description'] == null ? null : (map['description'] as String).input(),
      executionClass: map['executionClass'] == null ? null : (map['executionClass'] as String).input(),
      executionProperty: map['executionProperty'] == null ? null : (JobExecutionProperty.fromMap((map['executionProperty'] as Map).cast<String, dynamic>())).input(),
      glueVersion: map['glueVersion'] == null ? null : (map['glueVersion'] as String).input(),
      jobMode: map['jobMode'] == null ? null : (map['jobMode'] as String).input(),
      jobRunQueuingEnabled: map['jobRunQueuingEnabled'] == null ? null : (map['jobRunQueuingEnabled'] as bool).input(),
      ...
      nonOverridableArguments: map['nonOverridableArguments'] == null ? null : ((map['nonOverridableArguments'] as Map).cast<String, String>()).input(),
      notificationProperty: map['notificationProperty'] == null ? null : (JobNotificationProperty.fromMap((map['notificationProperty'] as Map).cast<String, dynamic>())).input(),
      ...
      sourceControlDetails: map['sourceControlDetails'] == null ? null : (JobSourceControlDetails.fromMap((map['sourceControlDetails'] as Map).cast<String, dynamic>())).input(),
