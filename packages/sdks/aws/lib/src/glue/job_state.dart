...
class JobState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arn': ?arn,
      'command':
          ?pulumi.Input.mapOptionalInputValue<JobCommand, Map<String, dynamic>>(
            command,
            (value) => value.toMap(),
          ),
    ...
    return JobState(
      ...
      command: (() {
        ...
        return pulumi.Input.fromValue(
          JobCommand.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      connections: (() {
      ...
      defaultArguments: (() {
        final guardedValue = map['defaultArguments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      executionClass: (() {
        final guardedValue = map['executionClass'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      executionProperty: (() {
        final guardedValue = map['executionProperty'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      jobMode: (() {
        final guardedValue = map['jobMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jobRunQueuingEnabled: (() {
        final guardedValue = map['jobRunQueuingEnabled'];
        if (guardedValue == null) return null;
      ...
      nonOverridableArguments: (() {
        final guardedValue = map['nonOverridableArguments'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          (guardedValue as Map).cast<String, String>(),
        );
      ...
      sourceControlDetails: (() {
        final guardedValue = map['sourceControlDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
