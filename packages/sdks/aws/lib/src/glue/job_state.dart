...
class JobState {
  ...
  JobState({
    ...
    pulumi.Output<JobCommand>? command,
    ...
    pulumi.Output<String>? workerType,
      ...
      command = pulumi.Input.asOptionalInput<JobCommand>(command),
  ...
  factory JobState.fromMap(Map<String, dynamic> map) {
    return JobState(
      ...
      command: map['command'] == null ? null : pulumi.Output.create<JobCommand>(JobCommand.fromMap((map['command'] as Map).cast<String, dynamic>())),
