    ...
    return <String, dynamic>{
      ...
      'federatedDatabase':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(federatedDatabase, (value) => value.toMap()),
      ...
      'targetDatabase':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(targetDatabase, (value) => value.toMap()),
    };
  }
    ...
    return CatalogDatabaseState(
      ...
      createTableDefaultPermissions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<CatalogDatabaseCreateTableDefaultPermission>(
            guardedValue,
      ...
      federatedDatabase: (() {
        final guardedValue = map['federatedDatabase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
