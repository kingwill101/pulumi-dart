...
class CrawlerJdbcTarget {
  ...
  factory CrawlerJdbcTarget.fromMap(Map<String, dynamic> map) {
    return CrawlerJdbcTarget(
      ...
      enableAdditionalMetadatas: (() { final guardedValue = map['enableAdditionalMetadatas']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
