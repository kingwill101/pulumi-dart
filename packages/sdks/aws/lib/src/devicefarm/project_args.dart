...
class ProjectArgs {
  ...
  ProjectArgs({
    pulumi.Output<int>? defaultJobTimeoutMinutes,
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      defaultJobTimeoutMinutes: map['defaultJobTimeoutMinutes'] == null ? null : pulumi.Output.create<int>(map['defaultJobTimeoutMinutes'] as int),
