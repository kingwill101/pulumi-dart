...
class StackSetArgs {
  ...
  factory StackSetArgs.fromMap(Map<String, dynamic> map) {
    return StackSetArgs(
      administrationRoleArn: map['administrationRoleArn'] == null ? null : ((map['administrationRoleArn'] as String).input()).input(),
      autoDeployment: map['autoDeployment'] == null ? null : ((StackSetAutoDeployment.fromMap((map['autoDeployment']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      executionRoleName: map['executionRoleName'] == null ? null : ((map['executionRoleName'] as String).input()).input(),
      managedExecution: map['managedExecution'] == null ? null : ((StackSetManagedExecution.fromMap((map['managedExecution']! as Map).cast<String, dynamic>())).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      operationPreferences: map['operationPreferences'] == null ? null : ((StackSetOperationPreferences.fromMap((map['operationPreferences']! as Map).cast<String, dynamic>())).input()).input(),
      parameters: map['parameters'] == null ? null : (((map['parameters'] as Map).cast<String, String>()).input()).input(),
      permissionModel: map['permissionModel'] == null ? null : ((map['permissionModel'] as String).input()).input(),
