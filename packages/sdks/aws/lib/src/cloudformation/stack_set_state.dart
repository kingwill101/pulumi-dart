...
class StackSetState {
  ...
  factory StackSetState.fromMap(Map<String, dynamic> map) {
    return StackSetState(
      ...
      autoDeployment: map['autoDeployment'] == null ? null : (StackSetAutoDeployment.fromMap((map['autoDeployment'] as Map).cast<String, dynamic>())).input(),
      ...
      managedExecution: map['managedExecution'] == null ? null : (StackSetManagedExecution.fromMap((map['managedExecution'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      operationPreferences: map['operationPreferences'] == null ? null : (StackSetOperationPreferences.fromMap((map['operationPreferences'] as Map).cast<String, dynamic>())).input(),
