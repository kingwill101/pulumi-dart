...
class StackSetInstance extends pulumi.CustomResource {
  ...
  StackSetInstance(
    ...
    this.deploymentTargets = registerOutput<StackSetInstanceDeploymentTargets?>('deploymentTargets');
    this.operationPreferences = registerOutput<StackSetInstanceOperationPreferences?>('operationPreferences');
    this.organizationalUnitId = registerOutput<String>('organizationalUnitId');
    this.parameterOverrides = registerOutput<Map<String, String>?>('parameterOverrides');
    this.region = registerOutput<String>('region');
    this.retainStack = registerOutput<bool?>('retainStack');
    this.stackId = registerOutput<String>('stackId');
    this.stackInstanceSummaries = registerOutput<List<StackSetInstanceStackInstanceSummary>>('stackInstanceSummaries');
    this.stackSetInstanceRegion = registerOutput<String>('stackSetInstanceRegion');
