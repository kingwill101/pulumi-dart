...
class StackInstancesState {
  ...
  final pulumi.Input<List<StackInstancesStackInstanceSummary>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'stackInstanceSummaries':
          ?pulumi.Input.mapOptionalInputValue<
            List<StackInstancesStackInstanceSummary>,
  ...
  factory StackInstancesState.fromMap(Map<String, dynamic> map) {
    return StackInstancesState(
      ...
      stackInstanceSummaries: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StackInstancesStackInstanceSummary>(
            guardedValue,
            (value) => StackInstancesStackInstanceSummary.fromMap(
