...
class GetAvailabilityZonesArgs {
  ...
  factory GetAvailabilityZonesArgs.fromMap(Map<String, dynamic> map) {
    return GetAvailabilityZonesArgs(
      ...
      excludeNames: (() { final guardedValue = map['excludeNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      excludeZoneIds: (() { final guardedValue = map['excludeZoneIds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetAvailabilityZonesFilter>(guardedValue, (value) => GetAvailabilityZonesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
