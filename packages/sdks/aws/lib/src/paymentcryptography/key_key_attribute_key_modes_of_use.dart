...
class KeyKeyAttributeKeyModesOfUse {
  ...
  factory KeyKeyAttributeKeyModesOfUse.fromMap(Map<String, dynamic> map) {
    return KeyKeyAttributeKeyModesOfUse(
      decrypt: (() {
        final guardedValue = map['decrypt'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      deriveKey: (() {
        final guardedValue = map['deriveKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      encrypt: (() {
      ...
      generate: (() {
        final guardedValue = map['generate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      noRestrictions: (() {
        final guardedValue = map['noRestrictions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sign: (() {
