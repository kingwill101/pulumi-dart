...
class GetKeyMultiRegionConfiguration {
  ...
  final pulumi.Input<List<GetKeyMultiRegionConfigurationPrimaryKey>>
  primaryKeys;

  /// The key ARNs and Regions of all replica keys. Includes the current KMS key if it is a replica key.
  final pulumi.Input<List<GetKeyMultiRegionConfigurationReplicaKey>>
  replicaKeys;
    ...
    return <String, dynamic>{
      ...
      'primaryKeys':
          pulumi.Input.mapInputValue<
            List<GetKeyMultiRegionConfigurationPrimaryKey>,
      ...
      'replicaKeys':
          pulumi.Input.mapInputValue<
            List<GetKeyMultiRegionConfigurationReplicaKey>,
            List<Map<String, dynamic>>
          >(
            replicaKeys,
            (value) =>
  ...
  factory GetKeyMultiRegionConfiguration.fromMap(Map<String, dynamic> map) {
    return GetKeyMultiRegionConfiguration(
      multiRegionKeyType: pulumi.Input.fromValue(
        map['multiRegionKeyType'] as String,
      ),
      ...
      replicaKeys: pulumi.Input.fromValue(
