...
class CustomKeyStoreArgs {
  ...
  factory CustomKeyStoreArgs.fromMap(Map<String, dynamic> map) {
    return CustomKeyStoreArgs(
      cloudHsmClusterId: (() {
        final guardedValue = map['cloudHsmClusterId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      customKeyStoreName: pulumi.Input.fromValue(
        map['customKeyStoreName'] as String,
      ),
      customKeyStoreType: (() {
        final guardedValue = map['customKeyStoreType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      keyStorePassword: (() {
      ...
      trustAnchorCertificate: (() {
        final guardedValue = map['trustAnchorCertificate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      xksProxyAuthenticationCredential: (() {
        final guardedValue = map['xksProxyAuthenticationCredential'];
        if (guardedValue == null) return null;
      ...
      xksProxyConnectivity: (() {
        final guardedValue = map['xksProxyConnectivity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      xksProxyUriEndpoint: (() {
        final guardedValue = map['xksProxyUriEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      xksProxyUriPath: (() {
        final guardedValue = map['xksProxyUriPath'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      xksProxyVpcEndpointServiceName: (() {
        final guardedValue = map['xksProxyVpcEndpointServiceName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
