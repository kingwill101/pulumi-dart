...
class KeyArgs {
  ...
  factory KeyArgs.fromMap(Map<String, dynamic> map) {
    return KeyArgs(
      ...
      rotationPeriodInDays: (() { final guardedValue = map['rotationPeriodInDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
