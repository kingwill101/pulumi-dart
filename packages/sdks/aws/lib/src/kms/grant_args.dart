  ...
  factory GrantArgs.fromMap(Map<String, dynamic> map) {
    return GrantArgs(
      constraints: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GrantConstraint>(
            guardedValue,
            (value) =>
                GrantConstraint.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      grantCreationTokens: (() {
        final guardedValue = map['grantCreationTokens'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      granteePrincipal: pulumi.Input.fromValue(
        map['granteePrincipal'] as String,
      ),
      ...
      operations: pulumi.Input.fromValue(
        (map['operations'] as List).cast<String>(),
      ),
      region: (() {
      ...
      retireOnDelete: (() {
        final guardedValue = map['retireOnDelete'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      retiringPrincipal: (() {
        final guardedValue = map['retiringPrincipal'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
