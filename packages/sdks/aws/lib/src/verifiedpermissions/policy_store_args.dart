...
class PolicyStoreArgs {
  ...
  factory PolicyStoreArgs.fromMap(Map<String, dynamic> map) {
    return PolicyStoreArgs(
      ...
      validationSettings: pulumi.Input.fromValue(PolicyStoreValidationSettings.fromMap((map['validationSettings']! as Map).cast<String, dynamic>())),
    );
  }
}
