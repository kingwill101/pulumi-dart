...
class IdentitySourceConfiguration {
  ...
  final pulumi.Input<IdentitySourceConfigurationCognitoUserPoolConfiguration>?
  ...
  final pulumi.Input<IdentitySourceConfigurationOpenIdConnectConfiguration>?
    ...
    return <String, dynamic>{
      'cognitoUserPoolConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cognitoUserPoolConfiguration, (value) => value.toMap()),
      'openIdConnectConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            IdentitySourceConfigurationOpenIdConnectConfiguration,
            Map<String, dynamic>
          >(openIdConnectConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory IdentitySourceConfiguration.fromMap(Map<String, dynamic> map) {
    return IdentitySourceConfiguration(
      cognitoUserPoolConfiguration: (() {
        final guardedValue = map['cognitoUserPoolConfiguration'];
      ...
      openIdConnectConfiguration: (() {
        final guardedValue = map['openIdConnectConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
