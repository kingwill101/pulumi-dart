...
class PolicyDefinition {
  ...
  factory PolicyDefinition.fromMap(Map<String, dynamic> map) {
    return PolicyDefinition(
      static: (() { final guardedValue = map['static']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyDefinitionStatic.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      templateLinked: (() { final guardedValue = map['templateLinked']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PolicyDefinitionTemplateLinked.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
