...
class RemediationConfiguration extends pulumi.CustomResource {
  ...
  RemediationConfiguration(
    ...
    this.executionControls = registerOutput<RemediationConfigurationExecutionControls?>('executionControls');
    this.maximumAutomaticAttempts = registerOutput<int?>('maximumAutomaticAttempts');
    this.parameters = registerOutput<List<RemediationConfigurationParameter>?>('parameters');
