...
class ConformancePackArgs {
  ...
  factory ConformancePackArgs.fromMap(Map<String, dynamic> map) {
    return ConformancePackArgs(
      ...
      inputParameters: (() { final guardedValue = map['inputParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ConformancePackInputParameter>(guardedValue, (value) => ConformancePackInputParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
