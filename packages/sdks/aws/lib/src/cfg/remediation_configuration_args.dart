...
class RemediationConfigurationArgs {
  ...
  factory RemediationConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RemediationConfigurationArgs(
      ...
      maximumAutomaticAttempts: (() { final guardedValue = map['maximumAutomaticAttempts']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      ...
      retryAttemptSeconds: (() { final guardedValue = map['retryAttemptSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
