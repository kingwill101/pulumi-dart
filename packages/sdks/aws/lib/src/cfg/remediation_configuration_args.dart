...
class RemediationConfigurationArgs {
  ...
  factory RemediationConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RemediationConfigurationArgs(
      ...
      configRuleName: pulumi.Input.fromValue(map['configRuleName'] as String),
      executionControls: (() { final guardedValue = map['executionControls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RemediationConfigurationExecutionControls.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      maximumAutomaticAttempts: (() { final guardedValue = map['maximumAutomaticAttempts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RemediationConfigurationParameter>(guardedValue, (value) => RemediationConfigurationParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resourceType: (() { final guardedValue = map['resourceType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      retryAttemptSeconds: (() { final guardedValue = map['retryAttemptSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
