...
class OrganizationConformancePackState {
  ...
  const OrganizationConformancePackState({
    this.arn,
  ...
  factory OrganizationConformancePackState.fromMap(Map<String, dynamic> map) {
    return OrganizationConformancePackState(
      ...
      deliveryS3Bucket: (() { final guardedValue = map['deliveryS3Bucket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deliveryS3KeyPrefix: (() { final guardedValue = map['deliveryS3KeyPrefix']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      inputParameters: (() { final guardedValue = map['inputParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OrganizationConformancePackInputParameter>(guardedValue, (value) => OrganizationConformancePackInputParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      templateS3Uri: (() { final guardedValue = map['templateS3Uri']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
