...
class ConformancePack extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ConformancePack]. {@macro pulumi_cfg_conformance_pack_conformance_pack_args_doc}
  ...
  ConformancePack(
    ...
    this.inputParameters = registerOutput<List<ConformancePackInputParameter>?>('inputParameters');
  ...
  /// Gets an existing [ConformancePack] resource's state with the given [name] and [id].
  static ConformancePack get(
    String name,
