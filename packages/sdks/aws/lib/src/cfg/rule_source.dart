...
class RuleSource {
    ...
    return <String, dynamic>{
      'customPolicyDetails':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(customPolicyDetails, (value) => value.toMap()),
      'owner': owner,
      'sourceDetails':
          ?pulumi.Input.mapOptionalInputValue<
            List<RuleSourceSourceDetail>,
  ...
  factory RuleSource.fromMap(Map<String, dynamic> map) {
    return RuleSource(
      customPolicyDetails: (() {
        final guardedValue = map['customPolicyDetails'];
      ...
      sourceDetails: (() {
        final guardedValue = map['sourceDetails'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      sourceIdentifier: (() {
        final guardedValue = map['sourceIdentifier'];
        if (guardedValue == null) return null;
