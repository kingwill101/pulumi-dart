...
class RemediationConfigurationParameter {
  ...
  factory RemediationConfigurationParameter.fromMap(Map<String, dynamic> map) {
    return RemediationConfigurationParameter(
      ...
      resourceValue: (() { final guardedValue = map['resourceValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      staticValue: (() { final guardedValue = map['staticValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      staticValues: (() { final guardedValue = map['staticValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
