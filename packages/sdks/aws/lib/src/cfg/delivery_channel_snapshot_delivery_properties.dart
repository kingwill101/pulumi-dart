...
class DeliveryChannelSnapshotDeliveryProperties {
  ...
  const DeliveryChannelSnapshotDeliveryProperties({
  ...
  factory DeliveryChannelSnapshotDeliveryProperties.fromMap(Map<String, dynamic> map) {
    return DeliveryChannelSnapshotDeliveryProperties(
      deliveryFrequency: (() { final guardedValue = map['deliveryFrequency']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
