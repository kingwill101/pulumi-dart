...
class RecorderRecordingGroup {
  ...
  final pulumi.Input<List<RecorderRecordingGroupExclusionByResourceType>>?
  ...
  final pulumi.Input<List<RecorderRecordingGroupRecordingStrategy>>?
  recordingStrategies;
  ...
  /// [allSupported] Specifies whether AWS Config records configuration changes for every supported type of regional resource (which includes any new type that will become supported in the future). Conflicts with `resource_types`. Defaults to `true`.
  /// [exclusionByResourceTypes] An object that specifies how AWS Config excludes resource types from being recorded by the configuration recorder.To use this option, you must set the useOnly field of RecordingStrategy to `EXCLUSION_BY_RESOURCE_TYPES` Requires `all_supported = false`. Conflicts with `resource_types`.
    ...
    return <String, dynamic>{
      ...
      'exclusionByResourceTypes':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecorderRecordingGroupExclusionByResourceType>,
      ...
      'recordingStrategies':
          ?pulumi.Input.mapOptionalInputValue<
            List<RecorderRecordingGroupRecordingStrategy>,
            List<Map<String, dynamic>>
          >(
            recordingStrategies,
            (value) =>
  ...
  factory RecorderRecordingGroup.fromMap(Map<String, dynamic> map) {
    return RecorderRecordingGroup(
      allSupported: (() {
        final guardedValue = map['allSupported'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      exclusionByResourceTypes: (() {
        final guardedValue = map['exclusionByResourceTypes'];
        if (guardedValue == null) return null;
      ...
      includeGlobalResourceTypes: (() {
        final guardedValue = map['includeGlobalResourceTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      recordingStrategies: (() {
        final guardedValue = map['recordingStrategies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
