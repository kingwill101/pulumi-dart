...
class OrganizationCustomPolicyRuleState {
  ...
  factory OrganizationCustomPolicyRuleState.fromMap(Map<String, dynamic> map) {
    return OrganizationCustomPolicyRuleState(
      ...
      debugLogDeliveryAccounts: map['debugLogDeliveryAccounts'] == null ? null : ((map['debugLogDeliveryAccounts'] as List).cast<String>()).input(),
      ...
      policyRuntime: map['policyRuntime'] == null ? null : (map['policyRuntime'] as String).input(),
      policyText: map['policyText'] == null ? null : (map['policyText'] as String).input(),
