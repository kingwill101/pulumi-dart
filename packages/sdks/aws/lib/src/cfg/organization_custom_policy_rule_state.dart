...
class OrganizationCustomPolicyRuleState {
  ...
  factory OrganizationCustomPolicyRuleState.fromMap(Map<String, dynamic> map) {
    return OrganizationCustomPolicyRuleState(
      ...
      policyRuntime: (() { final guardedValue = map['policyRuntime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      policyText: (() { final guardedValue = map['policyText']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
