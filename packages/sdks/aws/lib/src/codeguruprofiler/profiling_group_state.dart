...
class ProfilingGroupState {
  ...
  factory ProfilingGroupState.fromMap(Map<String, dynamic> map) {
    return ProfilingGroupState(
      agentOrchestrationConfig: map['agentOrchestrationConfig'] == null ? null : ((ProfilingGroupAgentOrchestrationConfig.fromMap((map['agentOrchestrationConfig']! as Map).cast<String, dynamic>())).input()).input(),
