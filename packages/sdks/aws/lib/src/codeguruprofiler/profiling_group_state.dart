...
class ProfilingGroupState {
  ...
  factory ProfilingGroupState.fromMap(Map<String, dynamic> map) {
    return ProfilingGroupState(
      agentOrchestrationConfig: (() { final guardedValue = map['agentOrchestrationConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ProfilingGroupAgentOrchestrationConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
