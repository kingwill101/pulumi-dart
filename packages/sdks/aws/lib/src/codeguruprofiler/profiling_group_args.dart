...
class ProfilingGroupArgs {
  ...
  factory ProfilingGroupArgs.fromMap(Map<String, dynamic> map) {
    return ProfilingGroupArgs(
      agentOrchestrationConfig: pulumi.Input.fromValue(ProfilingGroupAgentOrchestrationConfig.fromMap((map['agentOrchestrationConfig']! as Map).cast<String, dynamic>())),
