...
class TableArgs {
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      capacitySpecification: (() {
        final guardedValue = map['capacitySpecification'];
      ...
      clientSideTimestamps: (() {
        final guardedValue = map['clientSideTimestamps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      comment: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TableComment.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      defaultTimeToLive: (() {
        final guardedValue = map['defaultTimeToLive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      encryptionSpecification: (() {
        final guardedValue = map['encryptionSpecification'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
