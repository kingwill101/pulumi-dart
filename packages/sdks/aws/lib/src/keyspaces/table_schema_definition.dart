...
class TableSchemaDefinition {
    ...
    return <String, dynamic>{
      'clusteringKeys':
          ?pulumi.Input.mapOptionalInputValue<
            List<TableSchemaDefinitionClusteringKey>,
      ...
      'columns':
          pulumi.Input.mapInputValue<
            List<TableSchemaDefinitionColumn>,
            List<Map<String, dynamic>>
          >(
            columns,
            (value) =>
      ...
      'partitionKeys':
          pulumi.Input.mapInputValue<
            List<TableSchemaDefinitionPartitionKey>,
            List<Map<String, dynamic>>
          >(
            partitionKeys,
            (value) =>
      ...
      'staticColumns':
          ?pulumi.Input.mapOptionalInputValue<
            List<TableSchemaDefinitionStaticColumn>,
            List<Map<String, dynamic>>
          >(
            staticColumns,
            (value) =>
  ...
  factory TableSchemaDefinition.fromMap(Map<String, dynamic> map) {
    return TableSchemaDefinition(
      clusteringKeys: (() {
        final guardedValue = map['clusteringKeys'];
      ...
      columns: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TableSchemaDefinitionColumn>(
          map['columns']!,
      ...
      partitionKeys: pulumi.Input.fromValue(
        pulumi.Input.decodeList<TableSchemaDefinitionPartitionKey>(
          map['partitionKeys']!,
      ...
      staticColumns: (() {
        final guardedValue = map['staticColumns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
