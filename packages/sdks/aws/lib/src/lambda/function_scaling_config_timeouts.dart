...
class FunctionScalingConfigTimeouts {
  ...
  /// Creates a new [FunctionScalingConfigTimeouts].
  ...
  const FunctionScalingConfigTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory FunctionScalingConfigTimeouts.fromMap(Map<String, dynamic> map) {
    return FunctionScalingConfigTimeouts(
