...
class CallbackFunctionArgs {
  ...
  factory CallbackFunctionArgs.fromMap(Map<String, dynamic> map) {
    return CallbackFunctionArgs(
      ...
      callback: map['callback'] == null ? null : ((map['callback']).input()).input(),
      callbackFactory: map['callbackFactory'] == null ? null : ((map['callbackFactory']).input()).input(),
      capacityProviderConfig: map['capacityProviderConfig'] == null ? null : ((FunctionCapacityProviderConfig.fromMap((map['capacityProviderConfig']! as Map).cast<String, dynamic>())).input()).input(),
      codePathOptions: map['codePathOptions'] == null ? null : ((CodePathOptions.fromMap((map['codePathOptions']! as Map).cast<String, dynamic>())).input()).input(),
      codeSha256: map['codeSha256'] == null ? null : ((map['codeSha256'] as String).input()).input(),
      codeSigningConfigArn: map['codeSigningConfigArn'] == null ? null : ((map['codeSigningConfigArn'] as String).input()).input(),
      deadLetterConfig: map['deadLetterConfig'] == null ? null : ((FunctionDeadLetterConfig.fromMap((map['deadLetterConfig']! as Map).cast<String, dynamic>())).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      durableConfig: map['durableConfig'] == null ? null : ((FunctionDurableConfig.fromMap((map['durableConfig']! as Map).cast<String, dynamic>())).input()).input(),
      environment: map['environment'] == null ? null : ((FunctionEnvironment.fromMap((map['environment']! as Map).cast<String, dynamic>())).input()).input(),
      ephemeralStorage: map['ephemeralStorage'] == null ? null : ((FunctionEphemeralStorage.fromMap((map['ephemeralStorage']! as Map).cast<String, dynamic>())).input()).input(),
      fileSystemConfig: map['fileSystemConfig'] == null ? null : ((FunctionFileSystemConfig.fromMap((map['fileSystemConfig']! as Map).cast<String, dynamic>())).input()).input(),
      imageConfig: map['imageConfig'] == null ? null : ((FunctionImageConfig.fromMap((map['imageConfig']! as Map).cast<String, dynamic>())).input()).input(),
      imageUri: map['imageUri'] == null ? null : ((map['imageUri'] as String).input()).input(),
      kmsKeyArn: map['kmsKeyArn'] == null ? null : ((map['kmsKeyArn'] as String).input()).input(),
      layers: map['layers'] == null ? null : (((map['layers'] as List).cast<String>()).input()).input(),
      loggingConfig: map['loggingConfig'] == null ? null : ((FunctionLoggingConfig.fromMap((map['loggingConfig']! as Map).cast<String, dynamic>())).input()).input(),
      memorySize: map['memorySize'] == null ? null : ((map['memorySize'] as int).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      packageType: map['packageType'] == null ? null : ((map['packageType'] as String).input()).input(),
      policies: map['policies'] == null ? null : (((map['policies'] as Map).cast<String, String>()).input()).input(),
      publish: map['publish'] == null ? null : ((map['publish'] as bool).input()).input(),
      publishTo: map['publishTo'] == null ? null : ((map['publishTo'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      replaceSecurityGroupsOnDestroy: map['replaceSecurityGroupsOnDestroy'] == null ? null : ((map['replaceSecurityGroupsOnDestroy'] as bool).input()).input(),
      replacementSecurityGroupIds: map['replacementSecurityGroupIds'] == null ? null : (((map['replacementSecurityGroupIds'] as List).cast<String>()).input()).input(),
      reservedConcurrentExecutions: map['reservedConcurrentExecutions'] == null ? null : ((map['reservedConcurrentExecutions'] as int).input()).input(),
      role: map['role'] == null ? null : ((map['role'] as String).input()).input(),
      runtime: map['runtime'] == null ? null : ((Runtime.fromValue(map['runtime']! as String)).input()).input(),
      ...
      snapStart: map['snapStart'] == null ? null : ((FunctionSnapStart.fromMap((map['snapStart']! as Map).cast<String, dynamic>())).input()).input(),
      sourceCodeHash: map['sourceCodeHash'] == null ? null : ((map['sourceCodeHash'] as String).input()).input(),
      sourceKmsKeyArn: map['sourceKmsKeyArn'] == null ? null : ((map['sourceKmsKeyArn'] as String).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tenancyConfig: map['tenancyConfig'] == null ? null : ((FunctionTenancyConfig.fromMap((map['tenancyConfig']! as Map).cast<String, dynamic>())).input()).input(),
      timeout: map['timeout'] == null ? null : ((map['timeout'] as int).input()).input(),
      tracingConfig: map['tracingConfig'] == null ? null : ((FunctionTracingConfig.fromMap((map['tracingConfig']! as Map).cast<String, dynamic>())).input()).input(),
      vpcConfig: map['vpcConfig'] == null ? null : ((FunctionVpcConfig.fromMap((map['vpcConfig']! as Map).cast<String, dynamic>())).input()).input(),
    );
  }
}
