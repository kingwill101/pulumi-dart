...
class CallbackFunctionArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'role': ?role,
      'runtime': ?pulumi.Input.mapOptionalInputValue<Runtime, String>(runtime, (value) => value.wireValue),
      's3Bucket': ?s3Bucket,
      's3Key': ?s3Key,
  ...
  factory CallbackFunctionArgs.fromMap(Map<String, dynamic> map) {
    return CallbackFunctionArgs(
      ...
      callback: (() { final guardedValue = map['callback']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      callbackFactory: (() { final guardedValue = map['callbackFactory']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      codePathOptions: (() { final guardedValue = map['codePathOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CodePathOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      memorySize: (() { final guardedValue = map['memorySize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      ...
      policies: (() { final guardedValue = map['policies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
      ...
      reservedConcurrentExecutions: (() { final guardedValue = map['reservedConcurrentExecutions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      role: (() { final guardedValue = map['role']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      runtime: (() { final guardedValue = map['runtime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(Runtime.fromValue(guardedValue as String)); })(),
