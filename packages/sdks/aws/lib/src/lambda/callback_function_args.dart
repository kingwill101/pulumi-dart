...
class CallbackFunctionArgs {
  ...
  factory CallbackFunctionArgs.fromMap(Map<String, dynamic> map) {
    return CallbackFunctionArgs(
      ...
      callback: map['callback'] == null ? null : (map['callback']).input(),
      callbackFactory: map['callbackFactory'] == null ? null : (map['callbackFactory']).input(),
      ...
      codePathOptions: map['codePathOptions'] == null ? null : (CodePathOptions.fromMap((map['codePathOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      policies: map['policies'] == null ? null : ((map['policies'] as Map).cast<String, String>()).input(),
      ...
      runtime: map['runtime'] == null ? null : (Runtime.fromValue(map['runtime'] as String)).input(),
