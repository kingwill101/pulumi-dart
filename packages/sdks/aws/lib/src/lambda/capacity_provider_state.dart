...
class CapacityProviderState {
  ...
  factory CapacityProviderState.fromMap(Map<String, dynamic> map) {
    return CapacityProviderState(
      ...
      permissionsConfig: (() { final guardedValue = map['permissionsConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityProviderPermissionsConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vpcConfig: (() { final guardedValue = map['vpcConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(CapacityProviderVpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
