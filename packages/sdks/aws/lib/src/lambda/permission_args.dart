...
class PermissionArgs {
  ...
  factory PermissionArgs.fromMap(Map<String, dynamic> map) {
    return PermissionArgs(
      ...
      eventSourceToken: (() {
        final guardedValue = map['eventSourceToken'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      function: pulumi.Input.fromValue(map['function'] as String),
      functionUrlAuthType: (() {
        final guardedValue = map['functionUrlAuthType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      invokedViaFunctionUrl: (() {
        final guardedValue = map['invokedViaFunctionUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      principal: pulumi.Input.fromValue(map['principal'] as String),
      principalOrgId: (() {
        final guardedValue = map['principalOrgId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      qualifier: (() {
