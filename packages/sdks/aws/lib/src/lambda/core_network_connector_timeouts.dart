...
class CoreNetworkConnectorTimeouts {
  ...
  /// Creates a new [CoreNetworkConnectorTimeouts].
  ...
  const CoreNetworkConnectorTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory CoreNetworkConnectorTimeouts.fromMap(Map<String, dynamic> map) {
    return CoreNetworkConnectorTimeouts(
