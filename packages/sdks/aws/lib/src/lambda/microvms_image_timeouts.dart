...
class MicrovmsImageTimeouts {
  ...
  /// Creates a new [MicrovmsImageTimeouts].
  ...
  factory MicrovmsImageTimeouts.fromMap(Map<String, dynamic> map) {
    return MicrovmsImageTimeouts(
