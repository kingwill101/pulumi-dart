...
import 'provisioned_concurrency_config_state.dart';
...
class ProvisionedConcurrencyConfig extends pulumi.CustomResource {
  ...
  ProvisionedConcurrencyConfig(
    ...
    this.provisionedConcurrentExecutions = registerOutput<int>('provisionedConcurrentExecutions');
    this.qualifier = registerOutput<String>('qualifier');
    this.region = registerOutput<String>('region');
    this.skipDestroy = registerOutput<bool?>('skipDestroy');
  }

  /// Gets an existing [ProvisionedConcurrencyConfig] resource's state with the given [name] and [id].
  static ProvisionedConcurrencyConfig get(
    String name,
  ...
  ProvisionedConcurrencyConfig._get(
    String name, {
