...
class GetFunctionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'arn': arn,
      'capacityProviderConfigs': pulumi.Input.encodeList<GetFunctionCapacityProviderConfig, Map<String, dynamic>>(capacityProviderConfigs, (value) => value.toMap()),
      'codeSha256': codeSha256,
      'codeSigningConfigArn': codeSigningConfigArn,
      'deadLetterConfig': deadLetterConfig.toMap(),
      'description': description,
      'durableConfigs': pulumi.Input.encodeList<GetFunctionDurableConfig, Map<String, dynamic>>(durableConfigs, (value) => value.toMap()),
      'environment': environment.toMap(),
      'ephemeralStorages': pulumi.Input.encodeList<GetFunctionEphemeralStorage, Map<String, dynamic>>(ephemeralStorages, (value) => value.toMap()),
      'fileSystemConfigs': pulumi.Input.encodeList<GetFunctionFileSystemConfig, Map<String, dynamic>>(fileSystemConfigs, (value) => value.toMap()),
      ...
      'layers': layers,
      'loggingConfigs': pulumi.Input.encodeList<GetFunctionLoggingConfig, Map<String, dynamic>>(loggingConfigs, (value) => value.toMap()),
      ...
      'tags': tags,
      'tenancyConfigs': pulumi.Input.encodeList<GetFunctionTenancyConfig, Map<String, dynamic>>(tenancyConfigs, (value) => value.toMap()),
      'timeout': timeout,
  ...
  factory GetFunctionResult.fromMap(Map<String, dynamic> map) {
    return GetFunctionResult(
      ...
      capacityProviderConfigs: pulumi.Input.decodeList<GetFunctionCapacityProviderConfig>(map['capacityProviderConfigs']!, (value) => GetFunctionCapacityProviderConfig.fromMap((value as Map).cast<String, dynamic>())),
      codeSha256: map['codeSha256'] as String,
      codeSigningConfigArn: map['codeSigningConfigArn'] as String,
      deadLetterConfig: GetFunctionDeadLetterConfig.fromMap((map['deadLetterConfig']! as Map).cast<String, dynamic>()),
      description: map['description'] as String,
      durableConfigs: pulumi.Input.decodeList<GetFunctionDurableConfig>(map['durableConfigs']!, (value) => GetFunctionDurableConfig.fromMap((value as Map).cast<String, dynamic>())),
      environment: GetFunctionEnvironment.fromMap((map['environment']! as Map).cast<String, dynamic>()),
      ephemeralStorages: pulumi.Input.decodeList<GetFunctionEphemeralStorage>(map['ephemeralStorages']!, (value) => GetFunctionEphemeralStorage.fromMap((value as Map).cast<String, dynamic>())),
      fileSystemConfigs: pulumi.Input.decodeList<GetFunctionFileSystemConfig>(map['fileSystemConfigs']!, (value) => GetFunctionFileSystemConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      loggingConfigs: pulumi.Input.decodeList<GetFunctionLoggingConfig>(map['loggingConfigs']!, (value) => GetFunctionLoggingConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      tenancyConfigs: pulumi.Input.decodeList<GetFunctionTenancyConfig>(map['tenancyConfigs']!, (value) => GetFunctionTenancyConfig.fromMap((value as Map).cast<String, dynamic>())),
      timeout: map['timeout'] as int,
      tracingConfig: GetFunctionTracingConfig.fromMap((map['tracingConfig']! as Map).cast<String, dynamic>()),
      version: map['version'] as String,
      vpcConfig: GetFunctionVpcConfig.fromMap((map['vpcConfig']! as Map).cast<String, dynamic>()),
    );
  }
}
