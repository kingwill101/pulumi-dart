...
class FunctionEventInvokeConfigDestinationConfig {
  ...
  factory FunctionEventInvokeConfigDestinationConfig.fromMap(Map<String, dynamic> map) {
    return FunctionEventInvokeConfigDestinationConfig(
      onFailure: (() { final guardedValue = map['onFailure']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionEventInvokeConfigDestinationConfigOnFailure.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      onSuccess: (() { final guardedValue = map['onSuccess']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FunctionEventInvokeConfigDestinationConfigOnSuccess.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
