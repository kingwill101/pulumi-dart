...
class FunctionState {
  ...
  factory FunctionState.fromMap(Map<String, dynamic> map) {
    return FunctionState(
      ...
      qualifiedArn: map['qualifiedArn'] == null ? null : ((map['qualifiedArn'] as String).input()).input(),
      qualifiedInvokeArn: map['qualifiedInvokeArn'] == null ? null : ((map['qualifiedInvokeArn'] as String).input()).input(),
      ...
      responseStreamingInvokeArn: map['responseStreamingInvokeArn'] == null ? null : ((map['responseStreamingInvokeArn'] as String).input()).input(),
