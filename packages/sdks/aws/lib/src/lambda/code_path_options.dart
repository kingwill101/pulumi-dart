...
class CodePathOptions {
  ...
  factory CodePathOptions.fromMap(Map<String, dynamic> map) {
    return CodePathOptions(
      extraExcludePackages: (() { final guardedValue = map['extraExcludePackages']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      extraIncludePackages: (() { final guardedValue = map['extraIncludePackages']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      extraIncludePaths: (() { final guardedValue = map['extraIncludePaths']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
