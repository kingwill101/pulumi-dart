...
class EventSourceMappingState {
  ...
  EventSourceMappingState({
    pulumi.Output<EventSourceMappingAmazonManagedKafkaEventSourceConfig>? amazonManagedKafkaEventSourceConfig,
    pulumi.Output<String>? arn,
    pulumi.Output<int>? batchSize,
    pulumi.Output<bool>? bisectBatchOnFunctionError,
    pulumi.Output<EventSourceMappingDestinationConfig>? destinationConfig,
    pulumi.Output<EventSourceMappingDocumentDbEventSourceConfig>? documentDbEventSourceConfig,
    pulumi.Output<bool>? enabled,
    pulumi.Output<String>? eventSourceArn,
    pulumi.Output<EventSourceMappingFilterCriteria>? filterCriteria,
    pulumi.Output<String>? functionArn,
    pulumi.Output<String>? functionName,
    pulumi.Output<List<String>>? functionResponseTypes,
    pulumi.Output<String>? kmsKeyArn,
    pulumi.Output<String>? lastModified,
    pulumi.Output<String>? lastProcessingResult,
    pulumi.Output<int>? maximumBatchingWindowInSeconds,
    pulumi.Output<int>? maximumRecordAgeInSeconds,
    pulumi.Output<int>? maximumRetryAttempts,
    pulumi.Output<EventSourceMappingMetricsConfig>? metricsConfig,
    pulumi.Output<int>? parallelizationFactor,
    pulumi.Output<EventSourceMappingProvisionedPollerConfig>? provisionedPollerConfig,
    pulumi.Output<String>? queues,
    pulumi.Output<String>? region,
    pulumi.Output<EventSourceMappingScalingConfig>? scalingConfig,
    pulumi.Output<EventSourceMappingSelfManagedEventSource>? selfManagedEventSource,
    pulumi.Output<EventSourceMappingSelfManagedKafkaEventSourceConfig>? selfManagedKafkaEventSourceConfig,
    pulumi.Output<List<EventSourceMappingSourceAccessConfiguration>>? sourceAccessConfigurations,
    pulumi.Output<String>? startingPosition,
    pulumi.Output<String>? startingPositionTimestamp,
    pulumi.Output<String>? state,
    pulumi.Output<String>? stateTransitionReason,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<Map<String, String>>? tagsAll,
    pulumi.Output<List<String>>? topics,
    pulumi.Output<int>? tumblingWindowInSeconds,
    pulumi.Output<String>? uuid,
  }) :
      amazonManagedKafkaEventSourceConfig = pulumi.Input.asOptionalInput<EventSourceMappingAmazonManagedKafkaEventSourceConfig>(amazonManagedKafkaEventSourceConfig),
      arn = pulumi.Input.asOptionalInput<String>(arn),
      batchSize = pulumi.Input.asOptionalInput<int>(batchSize),
      bisectBatchOnFunctionError = pulumi.Input.asOptionalInput<bool>(bisectBatchOnFunctionError),
      destinationConfig = pulumi.Input.asOptionalInput<EventSourceMappingDestinationConfig>(destinationConfig),
      documentDbEventSourceConfig = pulumi.Input.asOptionalInput<EventSourceMappingDocumentDbEventSourceConfig>(documentDbEventSourceConfig),
      enabled = pulumi.Input.asOptionalInput<bool>(enabled),
      eventSourceArn = pulumi.Input.asOptionalInput<String>(eventSourceArn),
      filterCriteria = pulumi.Input.asOptionalInput<EventSourceMappingFilterCriteria>(filterCriteria),
      functionArn = pulumi.Input.asOptionalInput<String>(functionArn),
      functionName = pulumi.Input.asOptionalInput<String>(functionName),
      functionResponseTypes = pulumi.Input.asOptionalInput<List<String>>(functionResponseTypes),
      kmsKeyArn = pulumi.Input.asOptionalInput<String>(kmsKeyArn),
      lastModified = pulumi.Input.asOptionalInput<String>(lastModified),
      lastProcessingResult = pulumi.Input.asOptionalInput<String>(lastProcessingResult),
      maximumBatchingWindowInSeconds = pulumi.Input.asOptionalInput<int>(maximumBatchingWindowInSeconds),
      maximumRecordAgeInSeconds = pulumi.Input.asOptionalInput<int>(maximumRecordAgeInSeconds),
      maximumRetryAttempts = pulumi.Input.asOptionalInput<int>(maximumRetryAttempts),
      metricsConfig = pulumi.Input.asOptionalInput<EventSourceMappingMetricsConfig>(metricsConfig),
      parallelizationFactor = pulumi.Input.asOptionalInput<int>(parallelizationFactor),
      provisionedPollerConfig = pulumi.Input.asOptionalInput<EventSourceMappingProvisionedPollerConfig>(provisionedPollerConfig),
      queues = pulumi.Input.asOptionalInput<String>(queues),
      region = pulumi.Input.asOptionalInput<String>(region),
      scalingConfig = pulumi.Input.asOptionalInput<EventSourceMappingScalingConfig>(scalingConfig),
      selfManagedEventSource = pulumi.Input.asOptionalInput<EventSourceMappingSelfManagedEventSource>(selfManagedEventSource),
      selfManagedKafkaEventSourceConfig = pulumi.Input.asOptionalInput<EventSourceMappingSelfManagedKafkaEventSourceConfig>(selfManagedKafkaEventSourceConfig),
      sourceAccessConfigurations = pulumi.Input.asOptionalInput<List<EventSourceMappingSourceAccessConfiguration>>(sourceAccessConfigurations),
      startingPosition = pulumi.Input.asOptionalInput<String>(startingPosition),
      startingPositionTimestamp = pulumi.Input.asOptionalInput<String>(startingPositionTimestamp),
      state = pulumi.Input.asOptionalInput<String>(state),
      stateTransitionReason = pulumi.Input.asOptionalInput<String>(stateTransitionReason),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      tagsAll = pulumi.Input.asOptionalInput<Map<String, String>>(tagsAll),
      topics = pulumi.Input.asOptionalInput<List<String>>(topics),
      tumblingWindowInSeconds = pulumi.Input.asOptionalInput<int>(tumblingWindowInSeconds),
  ...
  factory EventSourceMappingState.fromMap(Map<String, dynamic> map) {
    return EventSourceMappingState(
      amazonManagedKafkaEventSourceConfig: map['amazonManagedKafkaEventSourceConfig'] == null ? null : pulumi.Output.create<EventSourceMappingAmazonManagedKafkaEventSourceConfig>(EventSourceMappingAmazonManagedKafkaEventSourceConfig.fromMap((map['amazonManagedKafkaEventSourceConfig'] as Map).cast<String, dynamic>())),
      arn: map['arn'] == null ? null : pulumi.Output.create<String>(map['arn'] as String),
      batchSize: map['batchSize'] == null ? null : pulumi.Output.create<int>(map['batchSize'] as int),
      bisectBatchOnFunctionError: map['bisectBatchOnFunctionError'] == null ? null : pulumi.Output.create<bool>(map['bisectBatchOnFunctionError'] as bool),
      destinationConfig: map['destinationConfig'] == null ? null : pulumi.Output.create<EventSourceMappingDestinationConfig>(EventSourceMappingDestinationConfig.fromMap((map['destinationConfig'] as Map).cast<String, dynamic>())),
      documentDbEventSourceConfig: map['documentDbEventSourceConfig'] == null ? null : pulumi.Output.create<EventSourceMappingDocumentDbEventSourceConfig>(EventSourceMappingDocumentDbEventSourceConfig.fromMap((map['documentDbEventSourceConfig'] as Map).cast<String, dynamic>())),
      enabled: map['enabled'] == null ? null : pulumi.Output.create<bool>(map['enabled'] as bool),
      eventSourceArn: map['eventSourceArn'] == null ? null : pulumi.Output.create<String>(map['eventSourceArn'] as String),
      filterCriteria: map['filterCriteria'] == null ? null : pulumi.Output.create<EventSourceMappingFilterCriteria>(EventSourceMappingFilterCriteria.fromMap((map['filterCriteria'] as Map).cast<String, dynamic>())),
      ...
      functionResponseTypes: map['functionResponseTypes'] == null ? null : pulumi.Output.create<List<String>>((map['functionResponseTypes'] as List).cast<String>()),
      ...
      lastProcessingResult: map['lastProcessingResult'] == null ? null : pulumi.Output.create<String>(map['lastProcessingResult'] as String),
      maximumBatchingWindowInSeconds: map['maximumBatchingWindowInSeconds'] == null ? null : pulumi.Output.create<int>(map['maximumBatchingWindowInSeconds'] as int),
      maximumRecordAgeInSeconds: map['maximumRecordAgeInSeconds'] == null ? null : pulumi.Output.create<int>(map['maximumRecordAgeInSeconds'] as int),
      maximumRetryAttempts: map['maximumRetryAttempts'] == null ? null : pulumi.Output.create<int>(map['maximumRetryAttempts'] as int),
      metricsConfig: map['metricsConfig'] == null ? null : pulumi.Output.create<EventSourceMappingMetricsConfig>(EventSourceMappingMetricsConfig.fromMap((map['metricsConfig'] as Map).cast<String, dynamic>())),
      parallelizationFactor: map['parallelizationFactor'] == null ? null : pulumi.Output.create<int>(map['parallelizationFactor'] as int),
      provisionedPollerConfig: map['provisionedPollerConfig'] == null ? null : pulumi.Output.create<EventSourceMappingProvisionedPollerConfig>(EventSourceMappingProvisionedPollerConfig.fromMap((map['provisionedPollerConfig'] as Map).cast<String, dynamic>())),
      queues: map['queues'] == null ? null : pulumi.Output.create<String>(map['queues'] as String),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      scalingConfig: map['scalingConfig'] == null ? null : pulumi.Output.create<EventSourceMappingScalingConfig>(EventSourceMappingScalingConfig.fromMap((map['scalingConfig'] as Map).cast<String, dynamic>())),
      selfManagedEventSource: map['selfManagedEventSource'] == null ? null : pulumi.Output.create<EventSourceMappingSelfManagedEventSource>(EventSourceMappingSelfManagedEventSource.fromMap((map['selfManagedEventSource'] as Map).cast<String, dynamic>())),
      selfManagedKafkaEventSourceConfig: map['selfManagedKafkaEventSourceConfig'] == null ? null : pulumi.Output.create<EventSourceMappingSelfManagedKafkaEventSourceConfig>(EventSourceMappingSelfManagedKafkaEventSourceConfig.fromMap((map['selfManagedKafkaEventSourceConfig'] as Map).cast<String, dynamic>())),
      sourceAccessConfigurations: map['sourceAccessConfigurations'] == null ? null : pulumi.Output.create<List<EventSourceMappingSourceAccessConfiguration>>(pulumi.Input.decodeList<EventSourceMappingSourceAccessConfiguration>(map['sourceAccessConfigurations'], (value) => EventSourceMappingSourceAccessConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      startingPosition: map['startingPosition'] == null ? null : pulumi.Output.create<String>(map['startingPosition'] as String),
      startingPositionTimestamp: map['startingPositionTimestamp'] == null ? null : pulumi.Output.create<String>(map['startingPositionTimestamp'] as String),
      state: map['state'] == null ? null : pulumi.Output.create<String>(map['state'] as String),
      stateTransitionReason: map['stateTransitionReason'] == null ? null : pulumi.Output.create<String>(map['stateTransitionReason'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      tagsAll: map['tagsAll'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tagsAll'] as Map).cast<String, String>()),
      topics: map['topics'] == null ? null : pulumi.Output.create<List<String>>((map['topics'] as List).cast<String>()),
      tumblingWindowInSeconds: map['tumblingWindowInSeconds'] == null ? null : pulumi.Output.create<int>(map['tumblingWindowInSeconds'] as int),
