...
class EventSourceMappingState {
  ...
  factory EventSourceMappingState.fromMap(Map<String, dynamic> map) {
    return EventSourceMappingState(
      ...
      lastProcessingResult: (() { final guardedValue = map['lastProcessingResult']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
