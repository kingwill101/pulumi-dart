...
class EventSourceMapping extends pulumi.CustomResource {
  ...
  EventSourceMapping(
    ...
    bisectBatchOnFunctionError = registerOutput<bool?>(
    ...
    functionResponseTypes = registerOutput<List<String>?>(
    ...
    maximumBatchingWindowInSeconds = registerOutput<int?>(
      'maximumBatchingWindowInSeconds',
    );
    maximumRecordAgeInSeconds = registerOutput<int>(
    ...
    startingPositionTimestamp = registerOutput<String?>(
