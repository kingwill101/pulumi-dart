...
class EventSourceMapping extends pulumi.CustomResource {
  ...
  EventSourceMapping(
    ...
    this.amazonManagedKafkaEventSourceConfig = registerOutput<EventSourceMappingAmazonManagedKafkaEventSourceConfig>('amazonManagedKafkaEventSourceConfig');
    this.arn = registerOutput<String>('arn');
    this.batchSize = registerOutput<int?>('batchSize');
    this.bisectBatchOnFunctionError = registerOutput<bool?>('bisectBatchOnFunctionError');
    this.destinationConfig = registerOutput<EventSourceMappingDestinationConfig?>('destinationConfig');
    this.documentDbEventSourceConfig = registerOutput<EventSourceMappingDocumentDbEventSourceConfig?>('documentDbEventSourceConfig');
    this.enabled = registerOutput<bool?>('enabled');
    this.eventSourceArn = registerOutput<String?>('eventSourceArn');
    this.filterCriteria = registerOutput<EventSourceMappingFilterCriteria?>('filterCriteria');
    this.functionArn = registerOutput<String>('functionArn');
    this.functionName = registerOutput<String>('functionName');
    this.functionResponseTypes = registerOutput<List<String>?>('functionResponseTypes');
    ...
    this.maximumBatchingWindowInSeconds = registerOutput<int?>('maximumBatchingWindowInSeconds');
    this.maximumRecordAgeInSeconds = registerOutput<int>('maximumRecordAgeInSeconds');
    this.maximumRetryAttempts = registerOutput<int>('maximumRetryAttempts');
    this.metricsConfig = registerOutput<EventSourceMappingMetricsConfig?>('metricsConfig');
    this.parallelizationFactor = registerOutput<int>('parallelizationFactor');
    this.provisionedPollerConfig = registerOutput<EventSourceMappingProvisionedPollerConfig?>('provisionedPollerConfig');
    this.queues = registerOutput<String?>('queues');
    this.region = registerOutput<String>('region');
    this.scalingConfig = registerOutput<EventSourceMappingScalingConfig?>('scalingConfig');
    this.selfManagedEventSource = registerOutput<EventSourceMappingSelfManagedEventSource?>('selfManagedEventSource');
    this.selfManagedKafkaEventSourceConfig = registerOutput<EventSourceMappingSelfManagedKafkaEventSourceConfig>('selfManagedKafkaEventSourceConfig');
    this.sourceAccessConfigurations = registerOutput<List<EventSourceMappingSourceAccessConfiguration>?>('sourceAccessConfigurations');
    this.startingPosition = registerOutput<String?>('startingPosition');
    this.startingPositionTimestamp = registerOutput<String?>('startingPositionTimestamp');
    this.state = registerOutput<String>('state');
    this.stateTransitionReason = registerOutput<String>('stateTransitionReason');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.topics = registerOutput<List<String>?>('topics');
    this.tumblingWindowInSeconds = registerOutput<int?>('tumblingWindowInSeconds');
