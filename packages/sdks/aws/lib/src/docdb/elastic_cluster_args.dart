...
class ElasticClusterArgs {
  ...
  factory ElasticClusterArgs.fromMap(Map<String, dynamic> map) {
    return ElasticClusterArgs(
      ...
      adminUserPassword: (map['adminUserPassword'] as String).input(),
      ...
      shardCapacity: (map['shardCapacity'] as int).input(),
      ...
      timeouts: map['timeouts'] == null ? null : (ElasticClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())).input(),
