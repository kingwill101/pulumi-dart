...
class ElasticClusterArgs {
  ...
  factory ElasticClusterArgs.fromMap(Map<String, dynamic> map) {
    return ElasticClusterArgs(
      ...
      shardCapacity: pulumi.Input.fromValue((map['shardCapacity'] as num).toInt()),
      shardCount: pulumi.Input.fromValue((map['shardCount'] as num).toInt()),
      shardInstanceCount: (() { final guardedValue = map['shardInstanceCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
