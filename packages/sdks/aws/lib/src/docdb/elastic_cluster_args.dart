...
class ElasticClusterArgs {
  ...
  ElasticClusterArgs({
    ...
    required pulumi.Output<String> adminUserPassword,
    ...
    required pulumi.Output<int> shardCapacity,
    required pulumi.Output<int> shardCount,
    pulumi.Output<List<String>>? subnetIds,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<ElasticClusterTimeouts>? timeouts,
    pulumi.Output<List<String>>? vpcSecurityGroupIds,
      ...
      timeouts = pulumi.Input.asOptionalInput<ElasticClusterTimeouts>(timeouts),
  ...
  factory ElasticClusterArgs.fromMap(Map<String, dynamic> map) {
    return ElasticClusterArgs(
      ...
      adminUserPassword: pulumi.Output.create<String>(map['adminUserPassword'] as String),
      ...
      shardCapacity: pulumi.Output.create<int>(map['shardCapacity'] as int),
      ...
      timeouts: map['timeouts'] == null ? null : pulumi.Output.create<ElasticClusterTimeouts>(ElasticClusterTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())),
