...
class ElasticClusterState {
  ...
  factory ElasticClusterState.fromMap(Map<String, dynamic> map) {
    return ElasticClusterState(
      ...
      shardCapacity: (() { final guardedValue = map['shardCapacity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
