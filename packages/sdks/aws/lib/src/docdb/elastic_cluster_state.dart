...
class ElasticClusterState {
  ...
  ElasticClusterState({
    ...
    pulumi.Output<int>? shardCapacity,
    ...
    pulumi.Output<List<String>>? vpcSecurityGroupIds,
      ...
      shardCapacity = pulumi.Input.asOptionalInput<int>(shardCapacity),
  ...
  factory ElasticClusterState.fromMap(Map<String, dynamic> map) {
    return ElasticClusterState(
      ...
      shardCapacity: map['shardCapacity'] == null ? null : pulumi.Output.create<int>(map['shardCapacity'] as int),
