...
class RoomState {
  ...
  factory RoomState.fromMap(Map<String, dynamic> map) {
    return RoomState(
      ...
      maximumMessageLength: (() { final guardedValue = map['maximumMessageLength']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      maximumMessageRatePerSecond: (() { final guardedValue = map['maximumMessageRatePerSecond']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
