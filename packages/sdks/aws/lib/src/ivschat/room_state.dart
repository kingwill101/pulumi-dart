  ...
  factory RoomState.fromMap(Map<String, dynamic> map) {
    return RoomState(
      ...
      loggingConfigurationIdentifiers: (() {
        final guardedValue = map['loggingConfigurationIdentifiers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      maximumMessageLength: (() {
        final guardedValue = map['maximumMessageLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      maximumMessageRatePerSecond: (() {
        final guardedValue = map['maximumMessageRatePerSecond'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      messageReviewHandler: (() {
        final guardedValue = map['messageReviewHandler'];
        if (guardedValue == null) return null;
