...
class GetGatewayRouteSpecHttpRouteMatchQueryParameter {
  ...
  const GetGatewayRouteSpecHttpRouteMatchQueryParameter({
  ...
  factory GetGatewayRouteSpecHttpRouteMatchQueryParameter.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttpRouteMatchQueryParameter(
      matches: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteMatchQueryParameterMatch>(map['matches']!, (value) => GetGatewayRouteSpecHttpRouteMatchQueryParameterMatch.fromMap((value as Map).cast<String, dynamic>()))),
