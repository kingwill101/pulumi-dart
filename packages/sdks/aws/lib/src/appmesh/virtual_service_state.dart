...
class VirtualServiceState {
  ...
  factory VirtualServiceState.fromMap(Map<String, dynamic> map) {
    return VirtualServiceState(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualServiceSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
