...
class VirtualServiceState {
  ...
  VirtualServiceState({
    ...
    pulumi.Output<VirtualServiceSpec>? spec,
    ...
    pulumi.Output<Map<String, String>>? tagsAll,
      ...
      spec = pulumi.Input.asOptionalInput<VirtualServiceSpec>(spec),
  ...
  factory VirtualServiceState.fromMap(Map<String, dynamic> map) {
    return VirtualServiceState(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<VirtualServiceSpec>(VirtualServiceSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
