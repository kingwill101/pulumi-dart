...
class GetRouteSpecGrpcRouteRetryPolicy {
  ...
  final pulumi.Input<List<GetRouteSpecGrpcRouteRetryPolicyPerRetryTimeout>>
  perRetryTimeouts;
    ...
    return <String, dynamic>{
      ...
      'perRetryTimeouts':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecGrpcRouteRetryPolicyPerRetryTimeout>,
  ...
  factory GetRouteSpecGrpcRouteRetryPolicy.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecGrpcRouteRetryPolicy(
      grpcRetryEvents: pulumi.Input.fromValue(
        (map['grpcRetryEvents'] as List).cast<String>(),
      ),
      httpRetryEvents: pulumi.Input.fromValue(
        (map['httpRetryEvents'] as List).cast<String>(),
      ),
      maxRetries: pulumi.Input.fromValue(map['maxRetries'] as int),
      perRetryTimeouts: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetRouteSpecGrpcRouteRetryPolicyPerRetryTimeout>(
      ...
      tcpRetryEvents: pulumi.Input.fromValue(
