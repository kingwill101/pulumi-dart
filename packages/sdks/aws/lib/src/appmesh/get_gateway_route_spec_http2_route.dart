    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteAction>,
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteMatch>,
            List<Map<String, dynamic>>
          >(
            matches,
            (value) =>
  ...
  factory GetGatewayRouteSpecHttp2Route.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttp2Route(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttp2RouteAction>(
          map['actions']!,
      ...
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttp2RouteMatch>(
          map['matches']!,
