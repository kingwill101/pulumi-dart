...
class VirtualNodeSpecServiceDiscoveryAwsCloudMap {
  ...
  /// [namespaceName] Name of the AWS Cloud Map namespace to use. Use the `aws.servicediscovery.HttpNamespace` resource to configure a Cloud Map namespace. Must be between 1 and 1024 characters in length.
  ...
  const VirtualNodeSpecServiceDiscoveryAwsCloudMap({
    this.attributes,
