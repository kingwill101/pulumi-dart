...
class GetRouteSpecTcpRouteTimeout {
  ...
  factory GetRouteSpecTcpRouteTimeout.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecTcpRouteTimeout(
      idles: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecTcpRouteTimeoutIdle>(map['idles']!, (value) => GetRouteSpecTcpRouteTimeoutIdle.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
