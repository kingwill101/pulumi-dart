...
class GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrust {
  ...
  files;
  final pulumi.Input<
    List<GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustSd>
  >
  sds;
    ...
    return GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrust(
      acms: pulumi.Input.fromValue(
        ...
        >(
          map['acms']!,
          (value) =>
              GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustAcm.fromMap(
      ...
      files: pulumi.Input.fromValue(
        ...
        >(
          map['files']!,
          (value) =>
              GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustFile.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      sds: pulumi.Input.fromValue(
        ...
        >(
          map['sds']!,
          (value) =>
              GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustSd.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
