...
class GetGatewayRouteSpecHttpRouteMatchHeaderMatch {
  ...
  /// [regex] Required.
  /// [suffix] Required.
  const GetGatewayRouteSpecHttpRouteMatchHeaderMatch({
    required this.exact,
  ...
  factory GetGatewayRouteSpecHttpRouteMatchHeaderMatch.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttpRouteMatchHeaderMatch(
      ...
      ranges: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteMatchHeaderMatchRange>(map['ranges']!, (value) => GetGatewayRouteSpecHttpRouteMatchHeaderMatchRange.fromMap((value as Map).cast<String, dynamic>()))),
