...
class VirtualRouterArgs {
  ...
  VirtualRouterArgs({
    ...
    required pulumi.Output<VirtualRouterSpec> spec,
  ...
  factory VirtualRouterArgs.fromMap(Map<String, dynamic> map) {
    return VirtualRouterArgs(
      ...
      spec: pulumi.Output.create<VirtualRouterSpec>(VirtualRouterSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
