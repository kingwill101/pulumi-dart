...
class RouteState {
  ...
  RouteState({
    ...
    pulumi.Output<String>? virtualRouterName,
      ...
      spec = pulumi.Input.asOptionalInput<RouteSpec>(spec),
  ...
  factory RouteState.fromMap(Map<String, dynamic> map) {
    return RouteState(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<RouteSpec>(RouteSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
