...
class VirtualNodeSpecLoggingAccessLogFileFormat {
  ...
  final pulumi.Input<List<VirtualNodeSpecLoggingAccessLogFileFormatJson>>?
  jsons;
  ...
  VirtualNodeSpecLoggingAccessLogFileFormat({this.jsons, this.text});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'jsons':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualNodeSpecLoggingAccessLogFileFormatJson>,
