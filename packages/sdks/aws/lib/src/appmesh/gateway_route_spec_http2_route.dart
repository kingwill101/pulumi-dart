...
class GatewayRouteSpecHttp2Route {
  ...
  factory GatewayRouteSpecHttp2Route.fromMap(Map<String, dynamic> map) {
    return GatewayRouteSpecHttp2Route(
      action: pulumi.Input.fromValue(GatewayRouteSpecHttp2RouteAction.fromMap((map['action']! as Map).cast<String, dynamic>())),
      match: pulumi.Input.fromValue(GatewayRouteSpecHttp2RouteMatch.fromMap((map['match']! as Map).cast<String, dynamic>())),
    );
  }
}
