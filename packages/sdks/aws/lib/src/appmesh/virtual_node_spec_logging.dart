...
class VirtualNodeSpecLogging {
  ...
  factory VirtualNodeSpecLogging.fromMap(Map<String, dynamic> map) {
    return VirtualNodeSpecLogging(
      accessLog: (() { final guardedValue = map['accessLog']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualNodeSpecLoggingAccessLog.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
