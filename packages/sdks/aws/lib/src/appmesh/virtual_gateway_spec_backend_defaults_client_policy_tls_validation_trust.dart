    ...
    return VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrust(
      acm: (() {
        ...
        return pulumi.Input.fromValue(
          VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustAcm.fromMap(
      ...
      file: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustFile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSds.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
