...
class GetRouteSpecHttp2RouteAction {
  final pulumi.Input<List<GetRouteSpecHttp2RouteActionWeightedTarget>>
  weightedTargets;

  /// Creates a new [GetRouteSpecHttp2RouteAction].
  /// [weightedTargets] Required.
  GetRouteSpecHttp2RouteAction({required this.weightedTargets});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'weightedTargets':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteActionWeightedTarget>,
