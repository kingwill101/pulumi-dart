...
class GetRouteSpecHttp2RouteAction {
  ...
  const GetRouteSpecHttp2RouteAction({
  ...
  factory GetRouteSpecHttp2RouteAction.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttp2RouteAction(
      weightedTargets: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecHttp2RouteActionWeightedTarget>(map['weightedTargets']!, (value) => GetRouteSpecHttp2RouteActionWeightedTarget.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
