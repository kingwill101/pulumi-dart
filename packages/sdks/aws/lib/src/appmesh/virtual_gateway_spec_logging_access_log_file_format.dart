...
class VirtualGatewaySpecLoggingAccessLogFileFormat {
  ...
  final pulumi.Input<List<VirtualGatewaySpecLoggingAccessLogFileFormatJson>>?
  jsons;
    ...
    return <String, dynamic>{
      'jsons':
          ?pulumi.Input.mapOptionalInputValue<
            List<VirtualGatewaySpecLoggingAccessLogFileFormatJson>,
    ...
    return VirtualGatewaySpecLoggingAccessLogFileFormat(
      jsons: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => VirtualGatewaySpecLoggingAccessLogFileFormatJson.fromMap(
