...
class GetVirtualGatewaySpecBackendDefaultClientPolicyTl {
  ...
  factory GetVirtualGatewaySpecBackendDefaultClientPolicyTl.fromMap(Map<String, dynamic> map) {
    return GetVirtualGatewaySpecBackendDefaultClientPolicyTl(
      certificates: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualGatewaySpecBackendDefaultClientPolicyTlCertificate>(map['certificates']!, (value) => GetVirtualGatewaySpecBackendDefaultClientPolicyTlCertificate.fromMap((value as Map).cast<String, dynamic>()))),
      enforce: pulumi.Input.fromValue(map['enforce'] as bool),
      ports: pulumi.Input.fromValue((map['ports'] as List).cast<int>()),
      validations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualGatewaySpecBackendDefaultClientPolicyTlValidation>(map['validations']!, (value) => GetVirtualGatewaySpecBackendDefaultClientPolicyTlValidation.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
