...
class GetVirtualNodeSpecListenerTimeoutHttp2 {
  ...
  const GetVirtualNodeSpecListenerTimeoutHttp2({
    required this.idles,
  ...
  factory GetVirtualNodeSpecListenerTimeoutHttp2.fromMap(Map<String, dynamic> map) {
    return GetVirtualNodeSpecListenerTimeoutHttp2(
      idles: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualNodeSpecListenerTimeoutHttp2Idle>(map['idles']!, (value) => GetVirtualNodeSpecListenerTimeoutHttp2Idle.fromMap((value as Map).cast<String, dynamic>()))),
      perRequests: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualNodeSpecListenerTimeoutHttp2PerRequest>(map['perRequests']!, (value) => GetVirtualNodeSpecListenerTimeoutHttp2PerRequest.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
