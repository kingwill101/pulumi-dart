...
class GetVirtualNodeSpecListenerTimeoutHttp2 {
  ...
  final pulumi.Input<List<GetVirtualNodeSpecListenerTimeoutHttp2PerRequest>>
  perRequests;
    ...
    return <String, dynamic>{
      'idles':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerTimeoutHttp2Idle>,
      ...
      'perRequests':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerTimeoutHttp2PerRequest>,
            List<Map<String, dynamic>>
          >(
            perRequests,
            (value) =>
