...
class GetVirtualNodeSpecListenerTimeoutHttp {
  ...
  final pulumi.Input<List<GetVirtualNodeSpecListenerTimeoutHttpPerRequest>>
  perRequests;
    ...
    return <String, dynamic>{
      'idles':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerTimeoutHttpIdle>,
      ...
      'perRequests':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerTimeoutHttpPerRequest>,
            List<Map<String, dynamic>>
          >(
            perRequests,
            (value) =>
  ...
  factory GetVirtualNodeSpecListenerTimeoutHttp.fromMap(
    ...
    return GetVirtualNodeSpecListenerTimeoutHttp(
      idles: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualNodeSpecListenerTimeoutHttpIdle>(
          map['idles']!,
