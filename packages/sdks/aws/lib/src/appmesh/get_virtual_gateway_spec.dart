...
class GetVirtualGatewaySpec {
  ...
  factory GetVirtualGatewaySpec.fromMap(Map<String, dynamic> map) {
    return GetVirtualGatewaySpec(
      backendDefaults: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualGatewaySpecBackendDefault>(map['backendDefaults']!, (value) => GetVirtualGatewaySpecBackendDefault.fromMap((value as Map).cast<String, dynamic>()))),
      listeners: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualGatewaySpecListener>(map['listeners']!, (value) => GetVirtualGatewaySpecListener.fromMap((value as Map).cast<String, dynamic>()))),
      loggings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualGatewaySpecLogging>(map['loggings']!, (value) => GetVirtualGatewaySpecLogging.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
