...
class GetRouteSpecHttp2RouteTimeout {
  ...
  const GetRouteSpecHttp2RouteTimeout({
    required this.idles,
  ...
  factory GetRouteSpecHttp2RouteTimeout.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttp2RouteTimeout(
      idles: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecHttp2RouteTimeoutIdle>(map['idles']!, (value) => GetRouteSpecHttp2RouteTimeoutIdle.fromMap((value as Map).cast<String, dynamic>()))),
      perRequests: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecHttp2RouteTimeoutPerRequest>(map['perRequests']!, (value) => GetRouteSpecHttp2RouteTimeoutPerRequest.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
