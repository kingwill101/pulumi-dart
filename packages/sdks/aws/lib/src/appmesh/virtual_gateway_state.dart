...
class VirtualGatewayState {
  ...
  /// Creates a new [VirtualGatewayState].
  ...
  VirtualGatewayState({
    ...
    pulumi.Output<VirtualGatewaySpec>? spec,
    ...
    pulumi.Output<Map<String, String>>? tagsAll,
      ...
      spec = pulumi.Input.asOptionalInput<VirtualGatewaySpec>(spec),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'spec': ?pulumi.Input.mapOptionalInputValue<VirtualGatewaySpec, Map<String, dynamic>>(spec, (value) => value.toMap()),
      'tags': ?tags,
      'tagsAll': ?tagsAll,
    };
  }

  factory VirtualGatewayState.fromMap(Map<String, dynamic> map) {
    return VirtualGatewayState(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<VirtualGatewaySpec>(VirtualGatewaySpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
