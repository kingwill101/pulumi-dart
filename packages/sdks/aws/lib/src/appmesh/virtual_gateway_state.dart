...
class VirtualGatewayState {
  ...
  factory VirtualGatewayState.fromMap(Map<String, dynamic> map) {
    return VirtualGatewayState(
      ...
      spec: (() { final guardedValue = map['spec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualGatewaySpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
