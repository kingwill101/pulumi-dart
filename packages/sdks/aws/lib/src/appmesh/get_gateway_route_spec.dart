    ...
    return <String, dynamic>{
      'grpcRoutes':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecGrpcRoute>,
      ...
      'http2Routes':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2Route>,
            List<Map<String, dynamic>>
          >(
            http2Routes,
            (value) =>
      ...
      'httpRoutes':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttpRoute>,
            List<Map<String, dynamic>>
          >(
            httpRoutes,
            (value) =>
  ...
  factory GetGatewayRouteSpec.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpec(
      grpcRoutes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecGrpcRoute>(
          map['grpcRoutes']!,
      ...
      http2Routes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttp2Route>(
          map['http2Routes']!,
      ...
      httpRoutes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttpRoute>(
          map['httpRoutes']!,
