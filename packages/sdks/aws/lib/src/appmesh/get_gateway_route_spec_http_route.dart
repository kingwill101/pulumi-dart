    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttpRouteAction>,
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttpRouteMatch>,
            List<Map<String, dynamic>>
          >(
            matches,
            (value) =>
  ...
  factory GetGatewayRouteSpecHttpRoute.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttpRoute(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteAction>(
          map['actions']!,
      ...
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteMatch>(
          map['matches']!,
