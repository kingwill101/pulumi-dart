...
class GetVirtualServiceSpecProvider {
  final pulumi.Input<List<GetVirtualServiceSpecProviderVirtualNode>>
  virtualNodes;
  final pulumi.Input<List<GetVirtualServiceSpecProviderVirtualRouter>>
  virtualRouters;
    ...
    return <String, dynamic>{
      'virtualNodes':
          pulumi.Input.mapInputValue<
            List<GetVirtualServiceSpecProviderVirtualNode>,
      ...
      'virtualRouters':
          pulumi.Input.mapInputValue<
            List<GetVirtualServiceSpecProviderVirtualRouter>,
            List<Map<String, dynamic>>
          >(
            virtualRouters,
            (value) =>
  ...
  factory GetVirtualServiceSpecProvider.fromMap(Map<String, dynamic> map) {
    return GetVirtualServiceSpecProvider(
      virtualNodes: pulumi.Input.fromValue(
      ...
      virtualRouters: pulumi.Input.fromValue(
