...
class VirtualServiceArgs {
  ...
  VirtualServiceArgs({
    ...
    required pulumi.Output<VirtualServiceSpec> spec,
  ...
  factory VirtualServiceArgs.fromMap(Map<String, dynamic> map) {
    return VirtualServiceArgs(
      ...
      spec: pulumi.Output.create<VirtualServiceSpec>(VirtualServiceSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
