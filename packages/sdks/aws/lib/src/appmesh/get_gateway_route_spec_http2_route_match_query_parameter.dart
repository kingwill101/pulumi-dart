...
class GetGatewayRouteSpecHttp2RouteMatchQueryParameter {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'matches': pulumi.Input.encodeList<GetGatewayRouteSpecHttp2RouteMatchQueryParameterMatch, Map<String, dynamic>>(matches, (value) => value.toMap()),
      'name': name,
    };
  }
  ...
  factory GetGatewayRouteSpecHttp2RouteMatchQueryParameter.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttp2RouteMatchQueryParameter(
      matches: pulumi.Input.decodeList<GetGatewayRouteSpecHttp2RouteMatchQueryParameterMatch>(map['matches'], (value) => GetGatewayRouteSpecHttp2RouteMatchQueryParameterMatch.fromMap((value as Map).cast<String, dynamic>())),
