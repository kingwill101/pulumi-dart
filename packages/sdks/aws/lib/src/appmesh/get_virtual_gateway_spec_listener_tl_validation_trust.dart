...
class GetVirtualGatewaySpecListenerTlValidationTrust {
  final pulumi.Input<List<GetVirtualGatewaySpecListenerTlValidationTrustFile>>
  files;
  final pulumi.Input<List<GetVirtualGatewaySpecListenerTlValidationTrustSd>>
  sds;
    ...
    return <String, dynamic>{
      'files':
          pulumi.Input.mapInputValue<
            List<GetVirtualGatewaySpecListenerTlValidationTrustFile>,
      ...
      'sds':
          pulumi.Input.mapInputValue<
            List<GetVirtualGatewaySpecListenerTlValidationTrustSd>,
            List<Map<String, dynamic>>
          >(
            sds,
            (value) =>
  ...
  factory GetVirtualGatewaySpecListenerTlValidationTrust.fromMap(
    ...
    return GetVirtualGatewaySpecListenerTlValidationTrust(
      ...
      sds: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetVirtualGatewaySpecListenerTlValidationTrustSd>(
          map['sds']!,
