...
class GetVirtualGatewaySpecListenerTlValidationTrust {
  ...
  factory GetVirtualGatewaySpecListenerTlValidationTrust.fromMap(Map<String, dynamic> map) {
    return GetVirtualGatewaySpecListenerTlValidationTrust(
      files: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualGatewaySpecListenerTlValidationTrustFile>(map['files']!, (value) => GetVirtualGatewaySpecListenerTlValidationTrustFile.fromMap((value as Map).cast<String, dynamic>()))),
      sds: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualGatewaySpecListenerTlValidationTrustSd>(map['sds']!, (value) => GetVirtualGatewaySpecListenerTlValidationTrustSd.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
