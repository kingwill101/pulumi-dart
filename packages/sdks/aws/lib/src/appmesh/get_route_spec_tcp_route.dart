...
class GetRouteSpecTcpRoute {
  ...
  factory GetRouteSpecTcpRoute.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecTcpRoute(
      actions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecTcpRouteAction>(map['actions']!, (value) => GetRouteSpecTcpRouteAction.fromMap((value as Map).cast<String, dynamic>()))),
      matches: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecTcpRouteMatch>(map['matches']!, (value) => GetRouteSpecTcpRouteMatch.fromMap((value as Map).cast<String, dynamic>()))),
      timeouts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecTcpRouteTimeout>(map['timeouts']!, (value) => GetRouteSpecTcpRouteTimeout.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
