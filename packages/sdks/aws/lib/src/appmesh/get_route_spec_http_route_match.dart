...
class GetRouteSpecHttpRouteMatch {
  ...
  final pulumi.Input<List<GetRouteSpecHttpRouteMatchQueryParameter>>
  queryParameters;
    ...
    return <String, dynamic>{
      'headers':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteMatchHeader>,
      ...
      'paths':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteMatchPath>,
            List<Map<String, dynamic>>
          >(
            paths,
            (value) =>
      ...
      'queryParameters':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteMatchQueryParameter>,
            List<Map<String, dynamic>>
          >(
            queryParameters,
            (value) =>
  ...
  factory GetRouteSpecHttpRouteMatch.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttpRouteMatch(
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttpRouteMatchHeader>(
          map['headers']!,
      ...
      paths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttpRouteMatchPath>(
          map['paths']!,
