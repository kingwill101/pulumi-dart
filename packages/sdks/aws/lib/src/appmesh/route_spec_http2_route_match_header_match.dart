...
class RouteSpecHttp2RouteMatchHeaderMatch {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exact': ?exact,
      'prefix': ?prefix,
      'range': ?pulumi.Input.mapOptionalInputValue<RouteSpecHttp2RouteMatchHeaderMatchRange, Map<String, dynamic>>(range, (value) => value.toMap()),
      'regex': ?regex,
      'suffix': ?suffix,
    };
  }

  factory RouteSpecHttp2RouteMatchHeaderMatch.fromMap(Map<String, dynamic> map) {
    return RouteSpecHttp2RouteMatchHeaderMatch(
      ...
      range: (() { final guardedValue = map['range']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouteSpecHttp2RouteMatchHeaderMatchRange.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
