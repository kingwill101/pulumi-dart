...
class GetVirtualNodeSpec {
  ...
  final pulumi.Input<List<GetVirtualNodeSpecServiceDiscovery>>
  serviceDiscoveries;
    ...
    return <String, dynamic>{
      'backendDefaults':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecBackendDefault>,
      ...
      'backends':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecBackend>,
            List<Map<String, dynamic>>
          >(
            backends,
            (value) =>
      ...
      'listeners':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListener>,
            List<Map<String, dynamic>>
          >(
            listeners,
            (value) =>
      ...
      'loggings':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecLogging>,
            List<Map<String, dynamic>>
          >(
            loggings,
            (value) =>
      ...
      'serviceDiscoveries':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecServiceDiscovery>,
            List<Map<String, dynamic>>
          >(
            serviceDiscoveries,
            (value) =>
  ...
  factory GetVirtualNodeSpec.fromMap(Map<String, dynamic> map) {
    return GetVirtualNodeSpec(
      ...
      backends: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualNodeSpecBackend>(
          map['backends']!,
      ...
      listeners: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualNodeSpecListener>(
          map['listeners']!,
      ...
      loggings: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualNodeSpecLogging>(
          map['loggings']!,
