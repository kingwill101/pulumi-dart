...
class VirtualNodeSpecBackendDefaultsClientPolicy {
  ...
  const VirtualNodeSpecBackendDefaultsClientPolicy({
    this.tls,
  });
  ...
  factory VirtualNodeSpecBackendDefaultsClientPolicy.fromMap(Map<String, dynamic> map) {
    return VirtualNodeSpecBackendDefaultsClientPolicy(
      tls: (() { final guardedValue = map['tls']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VirtualNodeSpecBackendDefaultsClientPolicyTls.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
