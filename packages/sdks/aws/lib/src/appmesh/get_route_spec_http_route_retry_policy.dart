...
class GetRouteSpecHttpRouteRetryPolicy {
  ...
  final pulumi.Input<List<GetRouteSpecHttpRouteRetryPolicyPerRetryTimeout>>
  perRetryTimeouts;
    ...
    return <String, dynamic>{
      ...
      'perRetryTimeouts':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteRetryPolicyPerRetryTimeout>,
    ...
    return GetRouteSpecHttpRouteRetryPolicy(
      ...
      perRetryTimeouts: pulumi.Input.fromValue(
        pulumi
          ...
          (value) => GetRouteSpecHttpRouteRetryPolicyPerRetryTimeout.fromMap(
