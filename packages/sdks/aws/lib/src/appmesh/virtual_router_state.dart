...
class VirtualRouterState {
  ...
  VirtualRouterState({
    ...
    pulumi.Output<VirtualRouterSpec>? spec,
    ...
    pulumi.Output<Map<String, String>>? tagsAll,
      ...
      spec = pulumi.Input.asOptionalInput<VirtualRouterSpec>(spec),
  ...
  factory VirtualRouterState.fromMap(Map<String, dynamic> map) {
    return VirtualRouterState(
      ...
      spec: map['spec'] == null ? null : pulumi.Output.create<VirtualRouterSpec>(VirtualRouterSpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
