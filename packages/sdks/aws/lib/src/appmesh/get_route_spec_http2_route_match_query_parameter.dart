...
class GetRouteSpecHttp2RouteMatchQueryParameter {
  final pulumi.Input<List<GetRouteSpecHttp2RouteMatchQueryParameterMatch>>
  matches;
    ...
    return <String, dynamic>{
      'matches':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteMatchQueryParameterMatch>,
  ...
  factory GetRouteSpecHttp2RouteMatchQueryParameter.fromMap(
    ...
    return GetRouteSpecHttp2RouteMatchQueryParameter(
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteMatchQueryParameterMatch>(
          map['matches']!,
