...
class GetVirtualNodeSpecBackendDefault {
  final pulumi.Input<List<GetVirtualNodeSpecBackendDefaultClientPolicy>>
  clientPolicies;

  /// Creates a new [GetVirtualNodeSpecBackendDefault].
  /// [clientPolicies] Required.
  GetVirtualNodeSpecBackendDefault({required this.clientPolicies});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientPolicies':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecBackendDefaultClientPolicy>,
