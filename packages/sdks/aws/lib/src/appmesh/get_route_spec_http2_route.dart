    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteAction>,
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteMatch>,
            List<Map<String, dynamic>>
          >(
            matches,
            (value) =>
      ...
      'retryPolicies':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteRetryPolicy>,
            List<Map<String, dynamic>>
          >(
            retryPolicies,
            (value) =>
      ...
      'timeouts':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteTimeout>,
            List<Map<String, dynamic>>
          >(
            timeouts,
            (value) =>
  ...
  factory GetRouteSpecHttp2Route.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttp2Route(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteAction>(
          map['actions']!,
      ...
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteMatch>(
          map['matches']!,
      ...
      retryPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteRetryPolicy>(
          map['retryPolicies']!,
      ...
      timeouts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteTimeout>(
          map['timeouts']!,
