...
class GetGatewayRouteSpecHttp2RouteActionRewrite {
  final pulumi.Input<List<GetGatewayRouteSpecHttp2RouteActionRewriteHostname>>
  hostnames;
  final pulumi.Input<List<GetGatewayRouteSpecHttp2RouteActionRewritePath>>
  paths;
  final pulumi.Input<List<GetGatewayRouteSpecHttp2RouteActionRewritePrefix>>
  prefixes;
    ...
    return <String, dynamic>{
      'hostnames':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteActionRewriteHostname>,
      ...
      'paths':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteActionRewritePath>,
            List<Map<String, dynamic>>
          >(
            paths,
            (value) =>
      ...
      'prefixes':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteActionRewritePrefix>,
            List<Map<String, dynamic>>
          >(
            prefixes,
            (value) =>
  ...
  factory GetGatewayRouteSpecHttp2RouteActionRewrite.fromMap(
    ...
    return GetGatewayRouteSpecHttp2RouteActionRewrite(
      ...
      paths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttp2RouteActionRewritePath>(
          map['paths']!,
      ...
      prefixes: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetGatewayRouteSpecHttp2RouteActionRewritePrefix>(
          map['prefixes']!,
