...
class GetRouteSpecHttpRouteAction {
  final pulumi.Input<List<GetRouteSpecHttpRouteActionWeightedTarget>>
  weightedTargets;

  /// Creates a new [GetRouteSpecHttpRouteAction].
  /// [weightedTargets] Required.
  GetRouteSpecHttpRouteAction({required this.weightedTargets});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'weightedTargets':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteActionWeightedTarget>,
