...
class GetVirtualNodeSpecListener {
  final pulumi.Input<List<GetVirtualNodeSpecListenerConnectionPool>>
  connectionPools;
  final pulumi.Input<List<GetVirtualNodeSpecListenerHealthCheck>> healthChecks;
  final pulumi.Input<List<GetVirtualNodeSpecListenerOutlierDetection>>
  outlierDetections;
    ...
    return <String, dynamic>{
      'connectionPools':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerConnectionPool>,
      ...
      'healthChecks':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerHealthCheck>,
            List<Map<String, dynamic>>
          >(
            healthChecks,
            (value) =>
      ...
      'outlierDetections':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerOutlierDetection>,
            List<Map<String, dynamic>>
          >(
            outlierDetections,
            (value) =>
      ...
      'portMappings':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerPortMapping>,
            List<Map<String, dynamic>>
          >(
            portMappings,
            (value) =>
      ...
      'timeouts':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerTimeout>,
            List<Map<String, dynamic>>
          >(
            timeouts,
            (value) =>
      ...
      'tls':
          pulumi.Input.mapInputValue<
            List<GetVirtualNodeSpecListenerTl>,
            List<Map<String, dynamic>>
          >(
            tls,
            (value) =>
  ...
  factory GetVirtualNodeSpecListener.fromMap(Map<String, dynamic> map) {
    return GetVirtualNodeSpecListener(
      connectionPools: pulumi.Input.fromValue(
      ...
      outlierDetections: pulumi.Input.fromValue(
      ...
      timeouts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualNodeSpecListenerTimeout>(
          map['timeouts']!,
      ...
      tls: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualNodeSpecListenerTl>(
          map['tls']!,
