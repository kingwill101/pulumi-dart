...
class GetVirtualGatewaySpecListener {
  final pulumi.Input<List<GetVirtualGatewaySpecListenerConnectionPool>>
  connectionPools;
  final pulumi.Input<List<GetVirtualGatewaySpecListenerHealthCheck>>
  healthChecks;
  final pulumi.Input<List<GetVirtualGatewaySpecListenerPortMapping>>
  portMappings;
    ...
    return <String, dynamic>{
      'connectionPools':
          pulumi.Input.mapInputValue<
            List<GetVirtualGatewaySpecListenerConnectionPool>,
      ...
      'healthChecks':
          pulumi.Input.mapInputValue<
            List<GetVirtualGatewaySpecListenerHealthCheck>,
            List<Map<String, dynamic>>
          >(
            healthChecks,
            (value) =>
      ...
      'portMappings':
          pulumi.Input.mapInputValue<
            List<GetVirtualGatewaySpecListenerPortMapping>,
            List<Map<String, dynamic>>
          >(
            portMappings,
            (value) =>
      ...
      'tls':
          pulumi.Input.mapInputValue<
            List<GetVirtualGatewaySpecListenerTl>,
            List<Map<String, dynamic>>
          >(
            tls,
            (value) =>
  ...
  factory GetVirtualGatewaySpecListener.fromMap(Map<String, dynamic> map) {
    return GetVirtualGatewaySpecListener(
      ...
      tls: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualGatewaySpecListenerTl>(
          map['tls']!,
