...
class RouteSpecTcpRouteTimeout {
  ...
  factory RouteSpecTcpRouteTimeout.fromMap(Map<String, dynamic> map) {
    return RouteSpecTcpRouteTimeout(
      idle: (() { final guardedValue = map['idle']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RouteSpecTcpRouteTimeoutIdle.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
