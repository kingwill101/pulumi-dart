...
class GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidation {
  ...
  final pulumi.Input<
    List<GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrust>
  >
  trusts;
    ...
    return GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidation(
      subjectAlternativeNames: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationSubjectAlternativeName.fromMap(
      ...
      trusts: pulumi.Input.fromValue(
        ...
        >(
          map['trusts']!,
          (value) =>
              GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrust.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
