...
class GetVirtualRouterSpecListener {
  ...
  factory GetVirtualRouterSpecListener.fromMap(Map<String, dynamic> map) {
    return GetVirtualRouterSpecListener(
      portMappings: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualRouterSpecListenerPortMapping>(map['portMappings']!, (value) => GetVirtualRouterSpecListenerPortMapping.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
