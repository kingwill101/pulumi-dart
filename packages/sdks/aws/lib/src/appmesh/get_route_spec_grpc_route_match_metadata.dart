...
class GetRouteSpecGrpcRouteMatchMetadata {
  ...
  factory GetRouteSpecGrpcRouteMatchMetadata.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecGrpcRouteMatchMetadata(
      ...
      matches: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecGrpcRouteMatchMetadataMatch>(map['matches']!, (value) => GetRouteSpecGrpcRouteMatchMetadataMatch.fromMap((value as Map).cast<String, dynamic>()))),
