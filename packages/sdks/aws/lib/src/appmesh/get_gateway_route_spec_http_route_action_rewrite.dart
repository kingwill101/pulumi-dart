...
class GetGatewayRouteSpecHttpRouteActionRewrite {
  final pulumi.Input<List<GetGatewayRouteSpecHttpRouteActionRewriteHostname>>
  hostnames;
  final pulumi.Input<List<GetGatewayRouteSpecHttpRouteActionRewritePath>> paths;
  final pulumi.Input<List<GetGatewayRouteSpecHttpRouteActionRewritePrefix>>
  prefixes;
    ...
    return <String, dynamic>{
      'hostnames':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttpRouteActionRewriteHostname>,
      ...
      'paths':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttpRouteActionRewritePath>,
            List<Map<String, dynamic>>
          >(
            paths,
            (value) =>
      ...
      'prefixes':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttpRouteActionRewritePrefix>,
            List<Map<String, dynamic>>
          >(
            prefixes,
            (value) =>
  ...
  factory GetGatewayRouteSpecHttpRouteActionRewrite.fromMap(
    ...
    return GetGatewayRouteSpecHttpRouteActionRewrite(
      ...
      paths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteActionRewritePath>(
          map['paths']!,
