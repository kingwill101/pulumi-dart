...
class GetGatewayRouteSpecHttpRouteActionRewrite {
  ...
  /// [paths] Required.
  /// [prefixes] Required.
  const GetGatewayRouteSpecHttpRouteActionRewrite({
  ...
  factory GetGatewayRouteSpecHttpRouteActionRewrite.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttpRouteActionRewrite(
      hostnames: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteActionRewriteHostname>(map['hostnames']!, (value) => GetGatewayRouteSpecHttpRouteActionRewriteHostname.fromMap((value as Map).cast<String, dynamic>()))),
      paths: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteActionRewritePath>(map['paths']!, (value) => GetGatewayRouteSpecHttpRouteActionRewritePath.fromMap((value as Map).cast<String, dynamic>()))),
      prefixes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetGatewayRouteSpecHttpRouteActionRewritePrefix>(map['prefixes']!, (value) => GetGatewayRouteSpecHttpRouteActionRewritePrefix.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
