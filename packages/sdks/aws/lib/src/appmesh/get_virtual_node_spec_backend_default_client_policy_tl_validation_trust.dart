...
class GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrust {
  final pulumi.Input<
    List<GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustAcm>
  >
  acms;
  final pulumi.Input<
    List<GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustFile>
  >
  files;
  final pulumi.Input<
    List<GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustSd>
  >
  sds;
    ...
    return GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrust(
      acms: pulumi.Input.fromValue(
        ...
        >(
          map['acms']!,
          (value) =>
              GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustAcm.fromMap(
      ...
      files: pulumi.Input.fromValue(
        ...
        >(
          map['files']!,
          (value) =>
              GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustFile.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      sds: pulumi.Input.fromValue(
        ...
        >(
          map['sds']!,
          (value) =>
              GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustSd.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
