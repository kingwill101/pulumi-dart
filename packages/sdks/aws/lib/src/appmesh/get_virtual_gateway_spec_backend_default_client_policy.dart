...
class GetVirtualGatewaySpecBackendDefaultClientPolicy {
  final pulumi.Input<List<GetVirtualGatewaySpecBackendDefaultClientPolicyTl>>
  tls;

  /// Creates a new [GetVirtualGatewaySpecBackendDefaultClientPolicy].
  /// [tls] Required.
  GetVirtualGatewaySpecBackendDefaultClientPolicy({required this.tls});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'tls':
          pulumi.Input.mapInputValue<
            List<GetVirtualGatewaySpecBackendDefaultClientPolicyTl>,
