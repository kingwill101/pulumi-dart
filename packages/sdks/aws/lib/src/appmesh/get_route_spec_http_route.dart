    ...
    return <String, dynamic>{
      'actions':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteAction>,
      ...
      'matches':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteMatch>,
            List<Map<String, dynamic>>
          >(
            matches,
            (value) =>
      ...
      'retryPolicies':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteRetryPolicy>,
            List<Map<String, dynamic>>
          >(
            retryPolicies,
            (value) =>
      ...
      'timeouts':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttpRouteTimeout>,
            List<Map<String, dynamic>>
          >(
            timeouts,
            (value) =>
  ...
  factory GetRouteSpecHttpRoute.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttpRoute(
      actions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttpRouteAction>(
          map['actions']!,
      ...
      matches: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttpRouteMatch>(
          map['matches']!,
      ...
      retryPolicies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttpRouteRetryPolicy>(
          map['retryPolicies']!,
      ...
      timeouts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttpRouteTimeout>(
          map['timeouts']!,
