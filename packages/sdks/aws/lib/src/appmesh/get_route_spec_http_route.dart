...
class GetRouteSpecHttpRoute {
  ...
  factory GetRouteSpecHttpRoute.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttpRoute(
      actions: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecHttpRouteAction>(map['actions']!, (value) => GetRouteSpecHttpRouteAction.fromMap((value as Map).cast<String, dynamic>()))),
      matches: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecHttpRouteMatch>(map['matches']!, (value) => GetRouteSpecHttpRouteMatch.fromMap((value as Map).cast<String, dynamic>()))),
      retryPolicies: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecHttpRouteRetryPolicy>(map['retryPolicies']!, (value) => GetRouteSpecHttpRouteRetryPolicy.fromMap((value as Map).cast<String, dynamic>()))),
      timeouts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteSpecHttpRouteTimeout>(map['timeouts']!, (value) => GetRouteSpecHttpRouteTimeout.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
