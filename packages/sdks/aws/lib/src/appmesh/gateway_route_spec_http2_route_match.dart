...
class GatewayRouteSpecHttp2RouteMatch {
  ...
  final pulumi.Input<List<GatewayRouteSpecHttp2RouteMatchQueryParameter>>?
  queryParameters;
    ...
    return <String, dynamic>{
      'headers':
          ?pulumi.Input.mapOptionalInputValue<
            List<GatewayRouteSpecHttp2RouteMatchHeader>,
      ...
      'queryParameters':
          ?pulumi.Input.mapOptionalInputValue<
            List<GatewayRouteSpecHttp2RouteMatchQueryParameter>,
            List<Map<String, dynamic>>
          >(
            queryParameters,
            (value) =>
  ...
  factory GatewayRouteSpecHttp2RouteMatch.fromMap(Map<String, dynamic> map) {
    return GatewayRouteSpecHttp2RouteMatch(
      ...
      queryParameters: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<GatewayRouteSpecHttp2RouteMatchQueryParameter>(
            guardedValue,
