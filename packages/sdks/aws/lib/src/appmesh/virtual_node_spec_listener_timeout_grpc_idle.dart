...
class VirtualNodeSpecListenerTimeoutGrpcIdle {
  ...
  factory VirtualNodeSpecListenerTimeoutGrpcIdle.fromMap(Map<String, dynamic> map) {
    return VirtualNodeSpecListenerTimeoutGrpcIdle(
