...
class VirtualGatewayArgs {
  ...
  VirtualGatewayArgs({
    ...
    required pulumi.Output<VirtualGatewaySpec> spec,
  ...
  factory VirtualGatewayArgs.fromMap(Map<String, dynamic> map) {
    return VirtualGatewayArgs(
      ...
      spec: pulumi.Output.create<VirtualGatewaySpec>(VirtualGatewaySpec.fromMap((map['spec'] as Map).cast<String, dynamic>())),
