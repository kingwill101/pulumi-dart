...
class GetGatewayRouteSpecHttp2RouteMatch {
  ...
  final pulumi.Input<List<GetGatewayRouteSpecHttp2RouteMatchHostname>>
  hostnames;
  final pulumi.Input<List<GetGatewayRouteSpecHttp2RouteMatchPath>> paths;
  final pulumi.Input<int> port;
  final pulumi.Input<String> prefix;
  final pulumi.Input<List<GetGatewayRouteSpecHttp2RouteMatchQueryParameter>>
  queryParameters;
    ...
    return <String, dynamic>{
      'headers':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteMatchHeader>,
      ...
      'hostnames':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteMatchHostname>,
            List<Map<String, dynamic>>
          >(
            hostnames,
            (value) =>
      ...
      'paths':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteMatchPath>,
            List<Map<String, dynamic>>
          >(
            paths,
            (value) =>
      ...
      'queryParameters':
          pulumi.Input.mapInputValue<
            List<GetGatewayRouteSpecHttp2RouteMatchQueryParameter>,
            List<Map<String, dynamic>>
          >(
            queryParameters,
            (value) =>
  ...
  factory GetGatewayRouteSpecHttp2RouteMatch.fromMap(Map<String, dynamic> map) {
    return GetGatewayRouteSpecHttp2RouteMatch(
      ...
      paths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetGatewayRouteSpecHttp2RouteMatchPath>(
          map['paths']!,
