...
class GetVirtualNodeSpecListenerTlValidation {
  ...
  factory GetVirtualNodeSpecListenerTlValidation.fromMap(Map<String, dynamic> map) {
    return GetVirtualNodeSpecListenerTlValidation(
      subjectAlternativeNames: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualNodeSpecListenerTlValidationSubjectAlternativeName>(map['subjectAlternativeNames']!, (value) => GetVirtualNodeSpecListenerTlValidationSubjectAlternativeName.fromMap((value as Map).cast<String, dynamic>()))),
      trusts: pulumi.Input.fromValue(pulumi.Input.decodeList<GetVirtualNodeSpecListenerTlValidationTrust>(map['trusts']!, (value) => GetVirtualNodeSpecListenerTlValidationTrust.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
