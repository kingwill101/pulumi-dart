...
class GetRouteSpecHttp2RouteMatch {
  ...
  final pulumi.Input<List<GetRouteSpecHttp2RouteMatchQueryParameter>>
  queryParameters;
    ...
    return <String, dynamic>{
      'headers':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteMatchHeader>,
      ...
      'paths':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteMatchPath>,
            List<Map<String, dynamic>>
          >(
            paths,
            (value) =>
      ...
      'queryParameters':
          pulumi.Input.mapInputValue<
            List<GetRouteSpecHttp2RouteMatchQueryParameter>,
            List<Map<String, dynamic>>
          >(
            queryParameters,
            (value) =>
  ...
  factory GetRouteSpecHttp2RouteMatch.fromMap(Map<String, dynamic> map) {
    return GetRouteSpecHttp2RouteMatch(
      headers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteMatchHeader>(
          map['headers']!,
      ...
      paths: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteMatchPath>(
          map['paths']!,
      ...
      queryParameters: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetRouteSpecHttp2RouteMatchQueryParameter>(
          map['queryParameters']!,
