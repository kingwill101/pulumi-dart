...
class GetListenerRuleTransform {
  ...
  final pulumi.Input<List<GetListenerRuleTransformHostHeaderRewriteConfig>>?
  ...
  final pulumi.Input<List<GetListenerRuleTransformUrlRewriteConfig>>?
  urlRewriteConfigs;
    ...
    return <String, dynamic>{
      'hostHeaderRewriteConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleTransformHostHeaderRewriteConfig>,
      ...
      'urlRewriteConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleTransformUrlRewriteConfig>,
            List<Map<String, dynamic>>
          >(
            urlRewriteConfigs,
            (value) =>
  ...
  factory GetListenerRuleTransform.fromMap(Map<String, dynamic> map) {
    return GetListenerRuleTransform(
      hostHeaderRewriteConfigs: (() {
        final guardedValue = map['hostHeaderRewriteConfigs'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => GetListenerRuleTransformHostHeaderRewriteConfig.fromMap(
      ...
      urlRewriteConfigs: (() {
        final guardedValue = map['urlRewriteConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
