...
class GetListenerDefaultAction {
  final pulumi.Input<List<GetListenerDefaultActionAuthenticateCognito>>
  authenticateCognitos;
  final pulumi.Input<List<GetListenerDefaultActionAuthenticateOidc>>
  authenticateOidcs;
  final pulumi.Input<List<GetListenerDefaultActionFixedResponse>>
  fixedResponses;
  final pulumi.Input<List<GetListenerDefaultActionForward>> forwards;
  final pulumi.Input<List<GetListenerDefaultActionJwtValidation>>
  jwtValidations;
    ...
    return <String, dynamic>{
      'authenticateCognitos':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionAuthenticateCognito>,
      ...
      'authenticateOidcs':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionAuthenticateOidc>,
            List<Map<String, dynamic>>
          >(
            authenticateOidcs,
            (value) =>
      ...
      'fixedResponses':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionFixedResponse>,
            List<Map<String, dynamic>>
          >(
            fixedResponses,
            (value) =>
      ...
      'forwards':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionForward>,
            List<Map<String, dynamic>>
          >(
            forwards,
            (value) =>
      ...
      'jwtValidations':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionJwtValidation>,
            List<Map<String, dynamic>>
          >(
            jwtValidations,
            (value) =>
      ...
      'redirects':
          pulumi.Input.mapInputValue<
            List<GetListenerDefaultActionRedirect>,
            List<Map<String, dynamic>>
          >(
            redirects,
            (value) =>
  ...
  factory GetListenerDefaultAction.fromMap(Map<String, dynamic> map) {
    return GetListenerDefaultAction(
      authenticateCognitos: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenerDefaultActionAuthenticateCognito>(
      ...
      authenticateOidcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenerDefaultActionAuthenticateOidc>(
      ...
      fixedResponses: pulumi.Input.fromValue(
      ...
      forwards: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenerDefaultActionForward>(
          map['forwards']!,
      ...
      jwtValidations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenerDefaultActionJwtValidation>(
          map['jwtValidations']!,
      ...
      redirects: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetListenerDefaultActionRedirect>(
          map['redirects']!,
