...
class ListenerRuleActionJwtValidation {
  ...
  const ListenerRuleActionJwtValidation({
  ...
  factory ListenerRuleActionJwtValidation.fromMap(Map<String, dynamic> map) {
    return ListenerRuleActionJwtValidation(
      additionalClaims: (() { final guardedValue = map['additionalClaims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ListenerRuleActionJwtValidationAdditionalClaim>(guardedValue, (value) => ListenerRuleActionJwtValidationAdditionalClaim.fromMap((value as Map).cast<String, dynamic>()))); })(),
