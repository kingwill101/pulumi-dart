...
class ListenerRuleCondition {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'httpRequestMethod': ?httpRequestMethod == null ? null : httpRequestMethod!.toMap(),
      'pathPattern': ?pathPattern == null ? null : pathPattern!.toMap(),
      'queryStrings': ?queryStrings == null ? null : pulumi.Input.encodeList<ListenerRuleConditionQueryString, Map<String, dynamic>>(queryStrings!, (value) => value.toMap()),
  ...
  factory ListenerRuleCondition.fromMap(Map<String, dynamic> map) {
    return ListenerRuleCondition(
      hostHeader: map['hostHeader'] == null ? null : ListenerRuleConditionHostHeader.fromMap((map['hostHeader'] as Map).cast<String, dynamic>()),
      httpHeader: map['httpHeader'] == null ? null : ListenerRuleConditionHttpHeader.fromMap((map['httpHeader'] as Map).cast<String, dynamic>()),
      httpRequestMethod: map['httpRequestMethod'] == null ? null : ListenerRuleConditionHttpRequestMethod.fromMap((map['httpRequestMethod'] as Map).cast<String, dynamic>()),
      pathPattern: map['pathPattern'] == null ? null : ListenerRuleConditionPathPattern.fromMap((map['pathPattern'] as Map).cast<String, dynamic>()),
      queryStrings: map['queryStrings'] == null ? null : pulumi.Input.decodeList<ListenerRuleConditionQueryString>(map['queryStrings'], (value) => ListenerRuleConditionQueryString.fromMap((value as Map).cast<String, dynamic>())),
      sourceIp: map['sourceIp'] == null ? null : ListenerRuleConditionSourceIp.fromMap((map['sourceIp'] as Map).cast<String, dynamic>()),
    );
  }
}
