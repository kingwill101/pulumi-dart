...
class GetListenerRuleActionForward {
  ...
  /// Detailed below.
  final pulumi.Input<List<GetListenerRuleActionForwardStickiness>>?
  stickinesses;

  /// Set of target groups for the action.
  /// Detailed below.
  final pulumi.Input<List<GetListenerRuleActionForwardTargetGroup>>?
  targetGroups;
  ...
  GetListenerRuleActionForward({this.stickinesses, this.targetGroups});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'stickinesses':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionForwardStickiness>,
      ...
      'targetGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionForwardTargetGroup>,
            List<Map<String, dynamic>>
          >(
            targetGroups,
            (value) =>
  ...
  factory GetListenerRuleActionForward.fromMap(Map<String, dynamic> map) {
    return GetListenerRuleActionForward(
      stickinesses: (() {
        final guardedValue = map['stickinesses'];
