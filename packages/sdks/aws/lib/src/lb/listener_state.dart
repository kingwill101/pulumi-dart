...
class ListenerState {
  ...
  factory ListenerState.fromMap(Map<String, dynamic> map) {
    return ListenerState(
      ...
      defaultActions: map['defaultActions'] == null ? null : ((pulumi.Input.decodeList<ListenerDefaultAction>(map['defaultActions']!, (value) => ListenerDefaultAction.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
