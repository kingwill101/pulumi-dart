...
class ListenerState {
  ...
  ListenerState({
    ...
    pulumi.Output<List<ListenerDefaultAction>>? defaultActions,
    ...
    pulumi.Output<int>? tcpIdleTimeoutSeconds,
      ...
      defaultActions = pulumi.Input.asOptionalInput<List<ListenerDefaultAction>>(defaultActions),
  ...
  factory ListenerState.fromMap(Map<String, dynamic> map) {
    return ListenerState(
      ...
      defaultActions: map['defaultActions'] == null ? null : pulumi.Output.create<List<ListenerDefaultAction>>(pulumi.Input.decodeList<ListenerDefaultAction>(map['defaultActions'], (value) => ListenerDefaultAction.fromMap((value as Map).cast<String, dynamic>()))),
