...
class GetListenerRuleCondition {
  ...
  factory GetListenerRuleCondition.fromMap(Map<String, dynamic> map) {
    return GetListenerRuleCondition(
      hostHeaders: (() { final guardedValue = map['hostHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerRuleConditionHostHeader>(guardedValue, (value) => GetListenerRuleConditionHostHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      httpHeaders: (() { final guardedValue = map['httpHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerRuleConditionHttpHeader>(guardedValue, (value) => GetListenerRuleConditionHttpHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      httpRequestMethods: (() { final guardedValue = map['httpRequestMethods']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerRuleConditionHttpRequestMethod>(guardedValue, (value) => GetListenerRuleConditionHttpRequestMethod.fromMap((value as Map).cast<String, dynamic>()))); })(),
      pathPatterns: (() { final guardedValue = map['pathPatterns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerRuleConditionPathPattern>(guardedValue, (value) => GetListenerRuleConditionPathPattern.fromMap((value as Map).cast<String, dynamic>()))); })(),
      queryStrings: (() { final guardedValue = map['queryStrings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerRuleConditionQueryString>(guardedValue, (value) => GetListenerRuleConditionQueryString.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sourceIps: (() { final guardedValue = map['sourceIps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerRuleConditionSourceIp>(guardedValue, (value) => GetListenerRuleConditionSourceIp.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
