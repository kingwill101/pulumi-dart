...
class GetListenerRuleAction {
  ...
  /// Detailed below.
  final pulumi.Input<List<GetListenerRuleActionAuthenticateCognito>>?
  authenticateCognitos;

  /// An action to authenticate using OIDC.
  /// Detailed below.
  final pulumi.Input<List<GetListenerRuleActionAuthenticateOidc>>?
  authenticateOidcs;
    ...
    return <String, dynamic>{
      'authenticateCognitos':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionAuthenticateCognito>,
      ...
      'authenticateOidcs':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionAuthenticateOidc>,
            List<Map<String, dynamic>>
          >(
            authenticateOidcs,
            (value) =>
      ...
      'fixedResponses':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionFixedResponse>,
            List<Map<String, dynamic>>
          >(
            fixedResponses,
            (value) =>
      ...
      'forwards':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionForward>,
            List<Map<String, dynamic>>
          >(
            forwards,
            (value) =>
      ...
      'jwtValidations':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionJwtValidation>,
            List<Map<String, dynamic>>
          >(
            jwtValidations,
            (value) =>
      ...
      'redirects':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetListenerRuleActionRedirect>,
            List<Map<String, dynamic>>
          >(
            redirects,
            (value) =>
  ...
  factory GetListenerRuleAction.fromMap(Map<String, dynamic> map) {
    return GetListenerRuleAction(
      authenticateCognitos: (() {
        final guardedValue = map['authenticateCognitos'];
      ...
      authenticateOidcs: (() {
        final guardedValue = map['authenticateOidcs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      fixedResponses: (() {
        final guardedValue = map['fixedResponses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      jwtValidations: (() {
        final guardedValue = map['jwtValidations'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
