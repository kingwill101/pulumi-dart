...
import 'trust_store_revocation_state.dart';
...
class TrustStoreRevocation extends pulumi.CustomResource {
  ...
  /// Creates a new [TrustStoreRevocation].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TrustStoreRevocation]. {@macro pulumi_lb_trust_store_revocation_trust_store_revocation_args_doc}
  ...
  /// Gets an existing [TrustStoreRevocation] resource's state with the given [name] and [id].
  static TrustStoreRevocation get(
    String name,
