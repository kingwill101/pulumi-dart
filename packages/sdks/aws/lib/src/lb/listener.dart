...
class Listener extends pulumi.CustomResource {
  ...
  Listener(
    ...
    this.mutualAuthentication = registerOutput<ListenerMutualAuthentication>('mutualAuthentication');
    this.port = registerOutput<int?>('port');
    this.protocol = registerOutput<String>('protocol');
    this.region = registerOutput<String>('region');
    this.routingHttpRequestXAmznMtlsClientcertHeaderName = registerOutput<String>('routingHttpRequestXAmznMtlsClientcertHeaderName');
    this.routingHttpRequestXAmznMtlsClientcertIssuerHeaderName = registerOutput<String>('routingHttpRequestXAmznMtlsClientcertIssuerHeaderName');
    this.routingHttpRequestXAmznMtlsClientcertLeafHeaderName = registerOutput<String>('routingHttpRequestXAmznMtlsClientcertLeafHeaderName');
    this.routingHttpRequestXAmznMtlsClientcertSerialNumberHeaderName = registerOutput<String>('routingHttpRequestXAmznMtlsClientcertSerialNumberHeaderName');
    this.routingHttpRequestXAmznMtlsClientcertSubjectHeaderName = registerOutput<String>('routingHttpRequestXAmznMtlsClientcertSubjectHeaderName');
    this.routingHttpRequestXAmznMtlsClientcertValidityHeaderName = registerOutput<String>('routingHttpRequestXAmznMtlsClientcertValidityHeaderName');
    this.routingHttpRequestXAmznTlsCipherSuiteHeaderName = registerOutput<String>('routingHttpRequestXAmznTlsCipherSuiteHeaderName');
    this.routingHttpRequestXAmznTlsVersionHeaderName = registerOutput<String>('routingHttpRequestXAmznTlsVersionHeaderName');
    this.routingHttpResponseAccessControlAllowCredentialsHeaderValue = registerOutput<String>('routingHttpResponseAccessControlAllowCredentialsHeaderValue');
    this.routingHttpResponseAccessControlAllowHeadersHeaderValue = registerOutput<String>('routingHttpResponseAccessControlAllowHeadersHeaderValue');
    this.routingHttpResponseAccessControlAllowMethodsHeaderValue = registerOutput<String>('routingHttpResponseAccessControlAllowMethodsHeaderValue');
    this.routingHttpResponseAccessControlAllowOriginHeaderValue = registerOutput<String>('routingHttpResponseAccessControlAllowOriginHeaderValue');
    this.routingHttpResponseAccessControlExposeHeadersHeaderValue = registerOutput<String>('routingHttpResponseAccessControlExposeHeadersHeaderValue');
    this.routingHttpResponseAccessControlMaxAgeHeaderValue = registerOutput<String>('routingHttpResponseAccessControlMaxAgeHeaderValue');
    this.routingHttpResponseContentSecurityPolicyHeaderValue = registerOutput<String>('routingHttpResponseContentSecurityPolicyHeaderValue');
    this.routingHttpResponseServerEnabled = registerOutput<bool>('routingHttpResponseServerEnabled');
    this.routingHttpResponseStrictTransportSecurityHeaderValue = registerOutput<String>('routingHttpResponseStrictTransportSecurityHeaderValue');
    this.routingHttpResponseXContentTypeOptionsHeaderValue = registerOutput<String>('routingHttpResponseXContentTypeOptionsHeaderValue');
    this.routingHttpResponseXFrameOptionsHeaderValue = registerOutput<String>('routingHttpResponseXFrameOptionsHeaderValue');
