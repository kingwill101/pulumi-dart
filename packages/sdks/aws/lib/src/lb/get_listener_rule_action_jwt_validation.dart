...
class GetListenerRuleActionJwtValidation {
  ...
  factory GetListenerRuleActionJwtValidation.fromMap(Map<String, dynamic> map) {
    return GetListenerRuleActionJwtValidation(
      additionalClaims: (() { final guardedValue = map['additionalClaims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetListenerRuleActionJwtValidationAdditionalClaim>(guardedValue, (value) => GetListenerRuleActionJwtValidationAdditionalClaim.fromMap((value as Map).cast<String, dynamic>()))); })(),
