...
class TrustStoreArgs {
  ...
  factory TrustStoreArgs.fromMap(Map<String, dynamic> map) {
    return TrustStoreArgs(
      caCertificatesBundleS3Bucket: pulumi.Input.fromValue(
        map['caCertificatesBundleS3Bucket'] as String,
      ),
      caCertificatesBundleS3Key: pulumi.Input.fromValue(
        map['caCertificatesBundleS3Key'] as String,
      ),
      caCertificatesBundleS3ObjectVersion: (() {
        final guardedValue = map['caCertificatesBundleS3ObjectVersion'];
