...
class GraphState {
    ...
    return <String, dynamic>{
      ...
      'vectorSearchConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(vectorSearchConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory GraphState.fromMap(Map<String, dynamic> map) {
    return GraphState(
      ...
      graphNamePrefix: (() {
        final guardedValue = map['graphNamePrefix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kmsKeyIdentifier: (() {
      ...
      provisionedMemory: (() {
        final guardedValue = map['provisionedMemory'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      publicConnectivity: (() {
        final guardedValue = map['publicConnectivity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      region: (() {
      ...
      timeouts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GraphTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      vectorSearchConfiguration: (() {
        final guardedValue = map['vectorSearchConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
