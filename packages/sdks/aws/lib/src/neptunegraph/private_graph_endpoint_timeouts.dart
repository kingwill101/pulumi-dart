...
class PrivateGraphEndpointTimeouts {
  ...
  /// Creates a new [PrivateGraphEndpointTimeouts].
  ...
  const PrivateGraphEndpointTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory PrivateGraphEndpointTimeouts.fromMap(Map<String, dynamic> map) {
    return PrivateGraphEndpointTimeouts(
