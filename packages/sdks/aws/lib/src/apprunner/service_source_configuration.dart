...
class ServiceSourceConfiguration {
  ...
  final pulumi.Input<ServiceSourceConfigurationAuthenticationConfiguration>?
  ...
  final pulumi.Input<ServiceSourceConfigurationImageRepository>?
  imageRepository;
    ...
    return <String, dynamic>{
      ...
      'codeRepository':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(codeRepository, (value) => value.toMap()),
      'imageRepository':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory ServiceSourceConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceSourceConfiguration(
      ...
      autoDeploymentsEnabled: (() {
        final guardedValue = map['autoDeploymentsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      codeRepository: (() {
        final guardedValue = map['codeRepository'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
