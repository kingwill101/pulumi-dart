...
class ServiceSourceConfigurationCodeRepositoryCodeConfiguration {
  ...
  /// [codeConfigurationValues] Basic configuration for building and running the App Runner service. Use this parameter to quickly launch an App Runner service without providing an apprunner.yaml file in the source code repository (or ignoring the file if it exists). See `codeConfigurationValues` below.
  /// [configurationSource] Source of the App Runner configuration. Valid values: `REPOSITORY`, `API`. Use `REPOSITORY` to have App Runner read configuration values from the `apprunner.yaml` file in the source code repository and ignore `codeConfigurationValues`. Use `API` to have App Runner use the configuration values provided in `codeConfigurationValues` and ignore the `apprunner.yaml` file in the source code repository.
  ...
  factory ServiceSourceConfigurationCodeRepositoryCodeConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceSourceConfigurationCodeRepositoryCodeConfiguration(
      codeConfigurationValues: (() { final guardedValue = map['codeConfigurationValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValues.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      configurationSource: pulumi.Input.fromValue(map['configurationSource'] as String),
    );
  }
}
