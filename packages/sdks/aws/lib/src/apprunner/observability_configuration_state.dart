...
class ObservabilityConfigurationState {
  ...
  factory ObservabilityConfigurationState.fromMap(Map<String, dynamic> map) {
    return ObservabilityConfigurationState(
      ...
      observabilityConfigurationRevision: (() { final guardedValue = map['observabilityConfigurationRevision']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
