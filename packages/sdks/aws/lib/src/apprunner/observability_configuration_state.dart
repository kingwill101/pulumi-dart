  ...
  factory ObservabilityConfigurationState.fromMap(Map<String, dynamic> map) {
    return ObservabilityConfigurationState(
      ...
      observabilityConfigurationName: (() {
        final guardedValue = map['observabilityConfigurationName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      observabilityConfigurationRevision: (() {
        final guardedValue = map['observabilityConfigurationRevision'];
        if (guardedValue == null) return null;
      ...
      traceConfiguration: (() {
        final guardedValue = map['traceConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
