...
class ServiceSourceConfigurationImageRepository {
  ...
  /// [imageConfiguration] Configuration for running the identified image. See `imageConfiguration` below.
  /// [imageIdentifier] Identifier of an image. For an image in Amazon Elastic Container Registry (Amazon ECR), this is an image name. For the image name format, see Pulling an image in the Amazon ECR User Guide.
  ...
  factory ServiceSourceConfigurationImageRepository.fromMap(Map<String, dynamic> map) {
    return ServiceSourceConfigurationImageRepository(
      imageConfiguration: (() { final guardedValue = map['imageConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceSourceConfigurationImageRepositoryImageConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      imageIdentifier: pulumi.Input.fromValue(map['imageIdentifier'] as String),
      imageRepositoryType: pulumi.Input.fromValue(map['imageRepositoryType'] as String),
    );
  }
}
