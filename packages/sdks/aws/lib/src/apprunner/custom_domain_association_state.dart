...
class CustomDomainAssociationState {
  ...
  final pulumi.Input<List<CustomDomainAssociationCertificateValidationRecord>>?
  ...
  factory CustomDomainAssociationState.fromMap(Map<String, dynamic> map) {
    return CustomDomainAssociationState(
      certificateValidationRecords: (() {
        final guardedValue = map['certificateValidationRecords'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                CustomDomainAssociationCertificateValidationRecord.fromMap(
      ...
      dnsTarget: (() {
        final guardedValue = map['dnsTarget'];
        if (guardedValue == null) return null;
