...
class ProtectionGroupArgs {
  ...
  /// [members] ARNs of the resources to include in the protection group. You must set this when you set `pattern` to ARBITRARY and you must not set it for any other `pattern` setting.
