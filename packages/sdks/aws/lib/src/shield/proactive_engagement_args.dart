...
class ProactiveEngagementArgs {
  ...
  factory ProactiveEngagementArgs.fromMap(Map<String, dynamic> map) {
    return ProactiveEngagementArgs(
      emergencyContacts: pulumi.Input.fromValue(pulumi.Input.decodeList<ProactiveEngagementEmergencyContact>(map['emergencyContacts']!, (value) => ProactiveEngagementEmergencyContact.fromMap((value as Map).cast<String, dynamic>()))),
