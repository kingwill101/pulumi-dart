...
import 'protection_group_state.dart';
...
class ProtectionGroup extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [ProtectionGroup]. {@macro pulumi_shield_protection_group_protection_group_args_doc}
