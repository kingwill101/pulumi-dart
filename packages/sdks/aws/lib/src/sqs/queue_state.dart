...
class QueueState {
  ...
  factory QueueState.fromMap(Map<String, dynamic> map) {
    return QueueState(
      ...
      messageRetentionSeconds: map['messageRetentionSeconds'] == null ? null : (map['messageRetentionSeconds'] as int).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      namePrefix: map['namePrefix'] == null ? null : (map['namePrefix'] as String).input(),
      policy: map['policy'] == null ? null : (map['policy'] as String).input(),
      receiveWaitTimeSeconds: map['receiveWaitTimeSeconds'] == null ? null : (map['receiveWaitTimeSeconds'] as int).input(),
      ...
      visibilityTimeoutSeconds: map['visibilityTimeoutSeconds'] == null ? null : (map['visibilityTimeoutSeconds'] as int).input(),
    );
  }
}
