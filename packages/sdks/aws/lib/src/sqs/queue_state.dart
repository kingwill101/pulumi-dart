...
class QueueState {
  ...
  factory QueueState.fromMap(Map<String, dynamic> map) {
    return QueueState(
      ...
      deduplicationScope: map['deduplicationScope'] == null ? null : ((map['deduplicationScope'] as String).input()).input(),
      delaySeconds: map['delaySeconds'] == null ? null : ((map['delaySeconds'] as int).input()).input(),
      fifoQueue: map['fifoQueue'] == null ? null : ((map['fifoQueue'] as bool).input()).input(),
      fifoThroughputLimit: map['fifoThroughputLimit'] == null ? null : ((map['fifoThroughputLimit'] as String).input()).input(),
      ...
      maxMessageSize: map['maxMessageSize'] == null ? null : ((map['maxMessageSize'] as int).input()).input(),
      messageRetentionSeconds: map['messageRetentionSeconds'] == null ? null : ((map['messageRetentionSeconds'] as int).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      namePrefix: map['namePrefix'] == null ? null : ((map['namePrefix'] as String).input()).input(),
      policy: map['policy'] == null ? null : ((map['policy'] as String).input()).input(),
      receiveWaitTimeSeconds: map['receiveWaitTimeSeconds'] == null ? null : ((map['receiveWaitTimeSeconds'] as int).input()).input(),
      ...
      sqsManagedSseEnabled: map['sqsManagedSseEnabled'] == null ? null : ((map['sqsManagedSseEnabled'] as bool).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      url: map['url'] == null ? null : ((map['url'] as String).input()).input(),
      visibilityTimeoutSeconds: map['visibilityTimeoutSeconds'] == null ? null : ((map['visibilityTimeoutSeconds'] as int).input()).input(),
    );
  }
}
