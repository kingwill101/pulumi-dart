...
class OntapVolumeState {
  ...
  /// [flexcacheEndpointType] FlexCache endpoint type of the volume, Valid values are `NONE`, `ORIGIN`, `CACHE`. Default value is `NONE`. These can be set by the ONTAP CLI or API and are use with FlexCache feature.
  ...
  factory OntapVolumeState.fromMap(Map<String, dynamic> map) {
    return OntapVolumeState(
      ...
      flexcacheEndpointType: (() { final guardedValue = map['flexcacheEndpointType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      storageVirtualMachineId: (() { final guardedValue = map['storageVirtualMachineId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
