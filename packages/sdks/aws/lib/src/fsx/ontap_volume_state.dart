...
class OntapVolumeState {
  ...
  factory OntapVolumeState.fromMap(Map<String, dynamic> map) {
    return OntapVolumeState(
      ...
      flexcacheEndpointType: map['flexcacheEndpointType'] == null ? null : (map['flexcacheEndpointType'] as String).input(),
      ...
      storageVirtualMachineId: map['storageVirtualMachineId'] == null ? null : (map['storageVirtualMachineId'] as String).input(),
