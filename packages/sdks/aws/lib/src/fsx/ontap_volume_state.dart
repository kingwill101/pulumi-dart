...
class OntapVolumeState {
  ...
  factory OntapVolumeState.fromMap(Map<String, dynamic> map) {
    return OntapVolumeState(
      aggregateConfiguration: map['aggregateConfiguration'] == null ? null : ((OntapVolumeAggregateConfiguration.fromMap((map['aggregateConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      arn: map['arn'] == null ? null : ((map['arn'] as String).input()).input(),
      bypassSnaplockEnterpriseRetention: map['bypassSnaplockEnterpriseRetention'] == null ? null : ((map['bypassSnaplockEnterpriseRetention'] as bool).input()).input(),
      ...
      flexcacheEndpointType: map['flexcacheEndpointType'] == null ? null : ((map['flexcacheEndpointType'] as String).input()).input(),
      junctionPath: map['junctionPath'] == null ? null : ((map['junctionPath'] as String).input()).input(),
      name: map['name'] == null ? null : ((map['name'] as String).input()).input(),
      ontapVolumeType: map['ontapVolumeType'] == null ? null : ((map['ontapVolumeType'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      securityStyle: map['securityStyle'] == null ? null : ((map['securityStyle'] as String).input()).input(),
      sizeInBytes: map['sizeInBytes'] == null ? null : ((map['sizeInBytes'] as String).input()).input(),
      sizeInMegabytes: map['sizeInMegabytes'] == null ? null : ((map['sizeInMegabytes'] as int).input()).input(),
      skipFinalBackup: map['skipFinalBackup'] == null ? null : ((map['skipFinalBackup'] as bool).input()).input(),
      snaplockConfiguration: map['snaplockConfiguration'] == null ? null : ((OntapVolumeSnaplockConfiguration.fromMap((map['snaplockConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      snapshotPolicy: map['snapshotPolicy'] == null ? null : ((map['snapshotPolicy'] as String).input()).input(),
      storageEfficiencyEnabled: map['storageEfficiencyEnabled'] == null ? null : ((map['storageEfficiencyEnabled'] as bool).input()).input(),
      storageVirtualMachineId: map['storageVirtualMachineId'] == null ? null : ((map['storageVirtualMachineId'] as String).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      tagsAll: map['tagsAll'] == null ? null : (((map['tagsAll'] as Map).cast<String, String>()).input()).input(),
      tieringPolicy: map['tieringPolicy'] == null ? null : ((OntapVolumeTieringPolicy.fromMap((map['tieringPolicy']! as Map).cast<String, dynamic>())).input()).input(),
      uuid: map['uuid'] == null ? null : ((map['uuid'] as String).input()).input(),
      volumeStyle: map['volumeStyle'] == null ? null : ((map['volumeStyle'] as String).input()).input(),
