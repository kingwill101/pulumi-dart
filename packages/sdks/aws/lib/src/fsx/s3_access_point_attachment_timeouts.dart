...
class S3AccessPointAttachmentTimeouts {
  ...
  /// Creates a new [S3AccessPointAttachmentTimeouts].
  ...
  S3AccessPointAttachmentTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory S3AccessPointAttachmentTimeouts.fromMap(Map<String, dynamic> map) {
    return S3AccessPointAttachmentTimeouts(
      create: (() {
