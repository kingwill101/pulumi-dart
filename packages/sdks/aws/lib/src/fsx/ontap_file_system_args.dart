    ...
    return OntapFileSystemArgs(
      ...
      diskIopsConfiguration: (() {
        ...
        return pulumi.Input.fromValue(
          OntapFileSystemDiskIopsConfiguration.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      endpointIpAddressRange: (() {
        final guardedValue = map['endpointIpAddressRange'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fsxAdminPassword: (() {
        final guardedValue = map['fsxAdminPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      haPairs: (() {
        final guardedValue = map['haPairs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      kmsKeyId: (() {
      ...
      preferredSubnetId: pulumi.Input.fromValue(
      ...
      throughputCapacityPerHaPair: (() {
        final guardedValue = map['throughputCapacityPerHaPair'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
