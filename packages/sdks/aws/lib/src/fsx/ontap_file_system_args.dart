...
class OntapFileSystemArgs {
  ...
  factory OntapFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return OntapFileSystemArgs(
      ...
      diskIopsConfiguration: map['diskIopsConfiguration'] == null ? null : (OntapFileSystemDiskIopsConfiguration.fromMap((map['diskIopsConfiguration'] as Map).cast<String, dynamic>())).input(),
      endpointIpAddressRange: map['endpointIpAddressRange'] == null ? null : (map['endpointIpAddressRange'] as String).input(),
      fsxAdminPassword: map['fsxAdminPassword'] == null ? null : (map['fsxAdminPassword'] as String).input(),
      haPairs: map['haPairs'] == null ? null : (map['haPairs'] as int).input(),
      kmsKeyId: map['kmsKeyId'] == null ? null : (map['kmsKeyId'] as String).input(),
      preferredSubnetId: (map['preferredSubnetId'] as String).input(),
      ...
      throughputCapacityPerHaPair: map['throughputCapacityPerHaPair'] == null ? null : (map['throughputCapacityPerHaPair'] as int).input(),
