...
class OntapFileSystem extends pulumi.CustomResource {
  ...
  OntapFileSystem(
    ...
    this.diskIopsConfiguration = registerOutput<OntapFileSystemDiskIopsConfiguration>('diskIopsConfiguration');
    ...
    this.throughputCapacityPerHaPair = registerOutput<int>('throughputCapacityPerHaPair');
