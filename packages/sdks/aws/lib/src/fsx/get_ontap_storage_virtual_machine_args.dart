...
class GetOntapStorageVirtualMachineArgs {
  ...
  factory GetOntapStorageVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return GetOntapStorageVirtualMachineArgs(
      filters: map['filters'] == null ? null : (pulumi.Input.decodeList<GetOntapStorageVirtualMachineFilter>(map['filters'], (value) => GetOntapStorageVirtualMachineFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
