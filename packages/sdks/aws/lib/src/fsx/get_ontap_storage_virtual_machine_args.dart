...
class GetOntapStorageVirtualMachineArgs {
  ...
  factory GetOntapStorageVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return GetOntapStorageVirtualMachineArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetOntapStorageVirtualMachineFilter>(guardedValue, (value) => GetOntapStorageVirtualMachineFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
