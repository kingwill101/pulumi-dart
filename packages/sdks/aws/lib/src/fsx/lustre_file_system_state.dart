...
class LustreFileSystemState {
  ...
  factory LustreFileSystemState.fromMap(Map<String, dynamic> map) {
    return LustreFileSystemState(
      ...
      autoImportPolicy: map['autoImportPolicy'] == null ? null : (map['autoImportPolicy'] as String).input(),
      ...
      dataReadCacheConfiguration: map['dataReadCacheConfiguration'] == null ? null : (LustreFileSystemDataReadCacheConfiguration.fromMap((map['dataReadCacheConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      driveCacheType: map['driveCacheType'] == null ? null : (map['driveCacheType'] as String).input(),
      efaEnabled: map['efaEnabled'] == null ? null : (map['efaEnabled'] as bool).input(),
      exportPath: map['exportPath'] == null ? null : (map['exportPath'] as String).input(),
      fileSystemTypeVersion: map['fileSystemTypeVersion'] == null ? null : (map['fileSystemTypeVersion'] as String).input(),
      finalBackupTags: map['finalBackupTags'] == null ? null : ((map['finalBackupTags'] as Map).cast<String, String>()).input(),
      importPath: map['importPath'] == null ? null : (map['importPath'] as String).input(),
      importedFileChunkSize: map['importedFileChunkSize'] == null ? null : (map['importedFileChunkSize'] as int).input(),
      kmsKeyId: map['kmsKeyId'] == null ? null : (map['kmsKeyId'] as String).input(),
      logConfiguration: map['logConfiguration'] == null ? null : (LustreFileSystemLogConfiguration.fromMap((map['logConfiguration'] as Map).cast<String, dynamic>())).input(),
      metadataConfiguration: map['metadataConfiguration'] == null ? null : (LustreFileSystemMetadataConfiguration.fromMap((map['metadataConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      perUnitStorageThroughput: map['perUnitStorageThroughput'] == null ? null : (map['perUnitStorageThroughput'] as int).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      rootSquashConfiguration: map['rootSquashConfiguration'] == null ? null : (LustreFileSystemRootSquashConfiguration.fromMap((map['rootSquashConfiguration'] as Map).cast<String, dynamic>())).input(),
