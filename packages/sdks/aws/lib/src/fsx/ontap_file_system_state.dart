...
class OntapFileSystemState {
  ...
  factory OntapFileSystemState.fromMap(Map<String, dynamic> map) {
    return OntapFileSystemState(
      ...
      endpoints: map['endpoints'] == null ? null : (pulumi.Input.decodeList<OntapFileSystemEndpoint>(map['endpoints'], (value) => OntapFileSystemEndpoint.fromMap((value as Map).cast<String, dynamic>()))).input(),
