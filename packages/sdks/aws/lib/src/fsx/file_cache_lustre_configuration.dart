...
class FileCacheLustreConfiguration {
  ...
  final pulumi.Input<List<FileCacheLustreConfigurationLogConfiguration>>?
  logConfigurations;

  /// The configuration for a Lustre MDT (Metadata Target) storage volume. See the `metadata_configuration` block.
  final pulumi.Input<List<FileCacheLustreConfigurationMetadataConfiguration>>
    ...
    return <String, dynamic>{
      ...
      'logConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<FileCacheLustreConfigurationLogConfiguration>,
    ...
    return FileCacheLustreConfiguration(
      ...
      logConfigurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FileCacheLustreConfigurationLogConfiguration>(
            guardedValue,
      ...
      metadataConfigurations: pulumi.Input.fromValue(
