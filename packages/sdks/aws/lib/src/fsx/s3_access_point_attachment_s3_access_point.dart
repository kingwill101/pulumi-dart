...
class S3AccessPointAttachmentS3AccessPoint {
  ...
  factory S3AccessPointAttachmentS3AccessPoint.fromMap(Map<String, dynamic> map) {
    return S3AccessPointAttachmentS3AccessPoint(
      ...
      vpcConfiguration: (() { final guardedValue = map['vpcConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(S3AccessPointAttachmentS3AccessPointVpcConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
