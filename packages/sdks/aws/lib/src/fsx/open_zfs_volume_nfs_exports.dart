...
class OpenZfsVolumeNfsExports {
  ...
  final pulumi.Input<List<OpenZfsVolumeNfsExportsClientConfiguration>>
    ...
    return <String, dynamic>{
      'clientConfigurations':
          pulumi.Input.mapInputValue<
            List<OpenZfsVolumeNfsExportsClientConfiguration>,
  ...
  factory OpenZfsVolumeNfsExports.fromMap(Map<String, dynamic> map) {
    return OpenZfsVolumeNfsExports(
      clientConfigurations: pulumi.Input.fromValue(
