...
class FileCacheState {
  ...
  factory FileCacheState.fromMap(Map<String, dynamic> map) {
    return FileCacheState(
      ...
      dataRepositoryAssociationIds: map['dataRepositoryAssociationIds'] == null ? null : ((map['dataRepositoryAssociationIds'] as List).cast<String>()).input(),
      ...
      fileCacheType: map['fileCacheType'] == null ? null : (map['fileCacheType'] as String).input(),
      fileCacheTypeVersion: map['fileCacheTypeVersion'] == null ? null : (map['fileCacheTypeVersion'] as String).input(),
