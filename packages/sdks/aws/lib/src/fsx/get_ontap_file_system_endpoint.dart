...
class GetOntapFileSystemEndpoint {
  ...
  final pulumi.Input<List<GetOntapFileSystemEndpointIntercluster>>
  interclusters;
    ...
    return <String, dynamic>{
      'interclusters':
          pulumi.Input.mapInputValue<
            List<GetOntapFileSystemEndpointIntercluster>,
      ...
      'managements':
          pulumi.Input.mapInputValue<
            List<GetOntapFileSystemEndpointManagement>,
            List<Map<String, dynamic>>
          >(
            managements,
            (value) =>
  ...
  factory GetOntapFileSystemEndpoint.fromMap(Map<String, dynamic> map) {
    return GetOntapFileSystemEndpoint(
      interclusters: pulumi.Input.fromValue(
