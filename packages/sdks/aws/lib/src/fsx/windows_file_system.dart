...
import 'windows_file_system_state.dart';
...
class WindowsFileSystem extends pulumi.CustomResource {
  ...
  WindowsFileSystem(
    ...
    remoteAdministrationEndpoint = registerOutput<String>(
  ...
  /// Gets an existing [WindowsFileSystem] resource's state with the given [name] and [id].
  static WindowsFileSystem get(
    String name,
