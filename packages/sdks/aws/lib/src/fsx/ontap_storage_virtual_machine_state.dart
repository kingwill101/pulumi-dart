...
class OntapStorageVirtualMachineState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpoints':
          ?pulumi.Input.mapOptionalInputValue<
            List<OntapStorageVirtualMachineEndpoint>,
  ...
  factory OntapStorageVirtualMachineState.fromMap(Map<String, dynamic> map) {
    return OntapStorageVirtualMachineState(
      activeDirectoryConfiguration: (() {
        final guardedValue = map['activeDirectoryConfiguration'];
      ...
      endpoints: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OntapStorageVirtualMachineEndpoint>(
            guardedValue,
            (value) => OntapStorageVirtualMachineEndpoint.fromMap(
      ...
      rootVolumeSecurityStyle: (() {
        final guardedValue = map['rootVolumeSecurityStyle'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      subtype: (() {
        final guardedValue = map['subtype'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      svmAdminPassword: (() {
        final guardedValue = map['svmAdminPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
