...
class OpenZfsFileSystemArgs {
  ...
  factory OpenZfsFileSystemArgs.fromMap(Map<String, dynamic> map) {
    return OpenZfsFileSystemArgs(
      ...
      copyTagsToVolumes: map['copyTagsToVolumes'] == null ? null : (map['copyTagsToVolumes'] as bool).input(),
      ...
      deleteOptions: map['deleteOptions'] == null ? null : ((map['deleteOptions'] as List).cast<String>()).input(),
      deploymentType: (map['deploymentType'] as String).input(),
      diskIopsConfiguration: map['diskIopsConfiguration'] == null ? null : (OpenZfsFileSystemDiskIopsConfiguration.fromMap((map['diskIopsConfiguration'] as Map).cast<String, dynamic>())).input(),
      endpointIpAddressRange: map['endpointIpAddressRange'] == null ? null : (map['endpointIpAddressRange'] as String).input(),
      ...
      readCacheConfiguration: map['readCacheConfiguration'] == null ? null : (OpenZfsFileSystemReadCacheConfiguration.fromMap((map['readCacheConfiguration'] as Map).cast<String, dynamic>())).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      rootVolumeConfiguration: map['rootVolumeConfiguration'] == null ? null : (OpenZfsFileSystemRootVolumeConfiguration.fromMap((map['rootVolumeConfiguration'] as Map).cast<String, dynamic>())).input(),
