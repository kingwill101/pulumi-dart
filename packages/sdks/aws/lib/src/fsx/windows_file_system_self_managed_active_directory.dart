...
class WindowsFileSystemSelfManagedActiveDirectory {
  ...
  /// [domainJoinServiceAccountSecret] ARN for the AWS Secrets Manager secret that contains the credentials for the service account on your self-managed AD domain. Conflicts with `username` and `password`.
