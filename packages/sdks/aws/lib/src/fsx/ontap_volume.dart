...
class OntapVolume extends pulumi.CustomResource {
  ...
  OntapVolume(
    ...
    this.aggregateConfiguration = registerOutput<OntapVolumeAggregateConfiguration?>('aggregateConfiguration');
    this.arn = registerOutput<String>('arn');
    this.bypassSnaplockEnterpriseRetention = registerOutput<bool?>('bypassSnaplockEnterpriseRetention');
    ...
    this.flexcacheEndpointType = registerOutput<String>('flexcacheEndpointType');
    ...
    this.snaplockConfiguration = registerOutput<OntapVolumeSnaplockConfiguration?>('snaplockConfiguration');
    this.snapshotPolicy = registerOutput<String>('snapshotPolicy');
    this.storageEfficiencyEnabled = registerOutput<bool?>('storageEfficiencyEnabled');
    this.storageVirtualMachineId = registerOutput<String>('storageVirtualMachineId');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.tieringPolicy = registerOutput<OntapVolumeTieringPolicy?>('tieringPolicy');
