...
class FileCache extends pulumi.CustomResource {
  ...
  FileCache(
    ...
    this.copyTagsToDataRepositoryAssociations = registerOutput<bool?>('copyTagsToDataRepositoryAssociations');
    this.dataRepositoryAssociationIds = registerOutput<List<String>>('dataRepositoryAssociationIds');
    this.dataRepositoryAssociations = registerOutput<List<FileCacheDataRepositoryAssociation>?>('dataRepositoryAssociations');
    ...
    this.lustreConfigurations = registerOutput<List<FileCacheLustreConfiguration>?>('lustreConfigurations');
