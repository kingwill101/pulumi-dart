...
class GetOntapStorageVirtualMachineEndpoint {
  ...
  factory GetOntapStorageVirtualMachineEndpoint.fromMap(Map<String, dynamic> map) {
    return GetOntapStorageVirtualMachineEndpoint(
      iscsis: pulumi.Input.fromValue(pulumi.Input.decodeList<GetOntapStorageVirtualMachineEndpointIscsi>(map['iscsis']!, (value) => GetOntapStorageVirtualMachineEndpointIscsi.fromMap((value as Map).cast<String, dynamic>()))),
      managements: pulumi.Input.fromValue(pulumi.Input.decodeList<GetOntapStorageVirtualMachineEndpointManagement>(map['managements']!, (value) => GetOntapStorageVirtualMachineEndpointManagement.fromMap((value as Map).cast<String, dynamic>()))),
      nfs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetOntapStorageVirtualMachineEndpointNf>(map['nfs']!, (value) => GetOntapStorageVirtualMachineEndpointNf.fromMap((value as Map).cast<String, dynamic>()))),
      smbs: pulumi.Input.fromValue(pulumi.Input.decodeList<GetOntapStorageVirtualMachineEndpointSmb>(map['smbs']!, (value) => GetOntapStorageVirtualMachineEndpointSmb.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
