...
import 's3_access_point_attachment_state.dart';
...
class S3AccessPointAttachment extends pulumi.CustomResource {
  ...
  S3AccessPointAttachment(
    ...
    this.openzfsConfiguration = registerOutput<S3AccessPointAttachmentOpenzfsConfiguration>('openzfsConfiguration');
    this.region = registerOutput<String>('region');
    this.s3AccessPoint = registerOutput<S3AccessPointAttachmentS3AccessPoint?>('s3AccessPoint');
    ...
    this.timeouts = registerOutput<S3AccessPointAttachmentTimeouts?>('timeouts');
    this.type = registerOutput<String>('type');
  }

  /// Gets an existing [S3AccessPointAttachment] resource's state with the given [name] and [id].
  static S3AccessPointAttachment get(
    String name,
