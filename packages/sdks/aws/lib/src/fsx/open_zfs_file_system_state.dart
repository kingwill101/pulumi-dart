...
class OpenZfsFileSystemState {
  ...
  factory OpenZfsFileSystemState.fromMap(Map<String, dynamic> map) {
    return OpenZfsFileSystemState(
      ...
      endpointIpAddress: map['endpointIpAddress'] == null ? null : (map['endpointIpAddress'] as String).input(),
      ...
      rootVolumeId: map['rootVolumeId'] == null ? null : (map['rootVolumeId'] as String).input(),
