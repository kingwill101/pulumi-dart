...
class OpenZfsVolumeState {
  ...
  factory OpenZfsVolumeState.fromMap(Map<String, dynamic> map) {
    return OpenZfsVolumeState(
      ...
      deleteVolumeOptions: (() {
        final guardedValue = map['deleteVolumeOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      originSnapshot: (() {
        final guardedValue = map['originSnapshot'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      parentVolumeId: (() {
        final guardedValue = map['parentVolumeId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      readOnly: (() {
      ...
      storageCapacityQuotaGib: (() {
        final guardedValue = map['storageCapacityQuotaGib'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      storageCapacityReservationGib: (() {
        final guardedValue = map['storageCapacityReservationGib'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      tags: (() {
