...
class OpenZfsVolumeState {
  ...
  OpenZfsVolumeState({
    ...
    pulumi.Output<String>? parentVolumeId,
    ...
    pulumi.Output<String>? volumeType,
      ...
      parentVolumeId = pulumi.Input.asOptionalInput<String>(parentVolumeId),
  ...
  factory OpenZfsVolumeState.fromMap(Map<String, dynamic> map) {
    return OpenZfsVolumeState(
      ...
      parentVolumeId: map['parentVolumeId'] == null ? null : pulumi.Output.create<String>(map['parentVolumeId'] as String),
