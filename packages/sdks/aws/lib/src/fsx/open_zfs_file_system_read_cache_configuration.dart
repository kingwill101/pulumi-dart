...
class OpenZfsFileSystemReadCacheConfiguration {
  ...
  OpenZfsFileSystemReadCacheConfiguration({this.size, this.sizingMode});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'size': ?size, 'sizingMode': ?sizingMode};
  }
  ...
  factory OpenZfsFileSystemReadCacheConfiguration.fromMap(
    ...
    return OpenZfsFileSystemReadCacheConfiguration(
      ...
      sizingMode: (() {
        final guardedValue = map['sizingMode'];
        if (guardedValue == null) return null;
