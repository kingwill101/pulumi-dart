...
class OntapFileSystemEndpoint {
  ...
  OntapFileSystemEndpoint({this.interclusters, this.managements});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'interclusters':
          ?pulumi.Input.mapOptionalInputValue<
            List<OntapFileSystemEndpointIntercluster>,
      ...
      'managements':
          ?pulumi.Input.mapOptionalInputValue<
            List<OntapFileSystemEndpointManagement>,
            List<Map<String, dynamic>>
          >(
            managements,
            (value) =>
  ...
  factory OntapFileSystemEndpoint.fromMap(Map<String, dynamic> map) {
    return OntapFileSystemEndpoint(
      interclusters: (() {
        final guardedValue = map['interclusters'];
