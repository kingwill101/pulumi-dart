...
class OntapStorageVirtualMachineEndpoint {
  ...
  final pulumi.Input<List<OntapStorageVirtualMachineEndpointManagement>>?
  managements;
    ...
    return <String, dynamic>{
      'iscsis':
          ?pulumi.Input.mapOptionalInputValue<
            List<OntapStorageVirtualMachineEndpointIscsi>,
      ...
      'managements':
          ?pulumi.Input.mapOptionalInputValue<
            List<OntapStorageVirtualMachineEndpointManagement>,
            List<Map<String, dynamic>>
          >(
            managements,
            (value) =>
      ...
      'nfs':
          ?pulumi.Input.mapOptionalInputValue<
            List<OntapStorageVirtualMachineEndpointNf>,
            List<Map<String, dynamic>>
          >(
            nfs,
            (value) =>
      ...
      'smbs':
          ?pulumi.Input.mapOptionalInputValue<
            List<OntapStorageVirtualMachineEndpointSmb>,
            List<Map<String, dynamic>>
          >(
            smbs,
            (value) =>
  ...
  factory OntapStorageVirtualMachineEndpoint.fromMap(Map<String, dynamic> map) {
    return OntapStorageVirtualMachineEndpoint(
      iscsis: (() {
        final guardedValue = map['iscsis'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OntapStorageVirtualMachineEndpointIscsi>(
            guardedValue,
      ...
      managements: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OntapStorageVirtualMachineEndpointManagement>(
            guardedValue,
      ...
      nfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OntapStorageVirtualMachineEndpointNf>(
            guardedValue,
      ...
      smbs: (() {
        final guardedValue = map['smbs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OntapStorageVirtualMachineEndpointSmb>(
            guardedValue,
