...
class DataRepositoryAssociationS3 {
  ...
  final pulumi.Input<DataRepositoryAssociationS3AutoExportPolicy>?
  autoExportPolicy;

  /// Specifies the type of updated objects that will be automatically imported from the linked S3 bucket to your file system. See the `events` configuration block.
  final pulumi.Input<DataRepositoryAssociationS3AutoImportPolicy>?
  autoImportPolicy;
    ...
    return <String, dynamic>{
      'autoExportPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(autoExportPolicy, (value) => value.toMap()),
      'autoImportPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            DataRepositoryAssociationS3AutoImportPolicy,
            Map<String, dynamic>
          >(autoImportPolicy, (value) => value.toMap()),
    };
  }
  ...
  factory DataRepositoryAssociationS3.fromMap(Map<String, dynamic> map) {
    return DataRepositoryAssociationS3(
      autoExportPolicy: (() {
        final guardedValue = map['autoExportPolicy'];
