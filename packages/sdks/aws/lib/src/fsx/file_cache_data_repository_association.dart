...
class FileCacheDataRepositoryAssociation {
    ...
    return <String, dynamic>{
      ...
      'nfs':
          ?pulumi.Input.mapOptionalInputValue<
            List<FileCacheDataRepositoryAssociationNf>,
  ...
  factory FileCacheDataRepositoryAssociation.fromMap(Map<String, dynamic> map) {
    return FileCacheDataRepositoryAssociation(
      ...
      dataRepositoryPath: pulumi.Input.fromValue(
        map['dataRepositoryPath'] as String,
      ),
      dataRepositorySubdirectories: (() {
        final guardedValue = map['dataRepositorySubdirectories'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      fileCacheId: (() {
        final guardedValue = map['fileCacheId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
