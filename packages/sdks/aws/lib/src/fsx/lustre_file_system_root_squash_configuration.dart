...
class LustreFileSystemRootSquashConfiguration {
  ...
  const LustreFileSystemRootSquashConfiguration({
    this.noSquashNids,
    this.rootSquash,
  });
  ...
  factory LustreFileSystemRootSquashConfiguration.fromMap(Map<String, dynamic> map) {
    return LustreFileSystemRootSquashConfiguration(
      noSquashNids: (() { final guardedValue = map['noSquashNids']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
