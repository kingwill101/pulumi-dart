...
class WindowsFileSystemState {
  ...
  factory WindowsFileSystemState.fromMap(Map<String, dynamic> map) {
    return WindowsFileSystemState(
      ...
      preferredFileServerIp: map['preferredFileServerIp'] == null ? null : ((map['preferredFileServerIp'] as String).input()).input(),
      preferredSubnetId: map['preferredSubnetId'] == null ? null : ((map['preferredSubnetId'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      remoteAdministrationEndpoint: map['remoteAdministrationEndpoint'] == null ? null : ((map['remoteAdministrationEndpoint'] as String).input()).input(),
