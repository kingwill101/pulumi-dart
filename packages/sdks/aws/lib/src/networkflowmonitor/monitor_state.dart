...
class MonitorState {
  ...
  factory MonitorState.fromMap(Map<String, dynamic> map) {
    return MonitorState(
      localResources: (() { final guardedValue = map['localResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MonitorLocalResource>(guardedValue, (value) => MonitorLocalResource.fromMap((value as Map).cast<String, dynamic>()))); })(),
      monitorArn: (() { final guardedValue = map['monitorArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
