...
class ScopeTarget {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'region': region,
      'targetIdentifier': pulumi.Input.mapInputValue<ScopeTargetTargetIdentifier, Map<String, dynamic>>(targetIdentifier, (value) => value.toMap()),
    };
  }
  ...
  factory ScopeTarget.fromMap(Map<String, dynamic> map) {
    return ScopeTarget(
      ...
      targetIdentifier: pulumi.Input.fromValue(ScopeTargetTargetIdentifier.fromMap((map['targetIdentifier']! as Map).cast<String, dynamic>())),
    );
  }
}
