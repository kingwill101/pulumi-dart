...
class InvoiceUnitTimeouts {
  ...
  /// Creates a new [InvoiceUnitTimeouts].
  ...
  InvoiceUnitTimeouts({this.create, this.delete, this.update});
  ...
  factory InvoiceUnitTimeouts.fromMap(Map<String, dynamic> map) {
    return InvoiceUnitTimeouts(
      create: (() {
