...
class WebAclState {
  ...
  factory WebAclState.fromMap(Map<String, dynamic> map) {
    return WebAclState(
      ...
      loggingConfiguration: (() { final guardedValue = map['loggingConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WebAclLoggingConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
