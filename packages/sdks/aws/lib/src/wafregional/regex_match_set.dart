...
/// }
///
/// resource "aws_wafregional_regexmatchset" "example" {
///   regex_match_tuples {
///     field_to_match = {
///       data = "User-Agent"
///       type = "HEADER"
///     }
///     regex_pattern_set_id = aws_wafregional_regexpatternset.example.id
///     text_transformation  = "NONE"
///   }
///   name = "example"
/// }
/// resource "aws_wafregional_regexpatternset" "example" {
///   name                  = "example"
...
class RegexMatchSet extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [RegexMatchSet]. {@macro pulumi_wafregional_regex_match_set_regex_match_set_args_doc}
