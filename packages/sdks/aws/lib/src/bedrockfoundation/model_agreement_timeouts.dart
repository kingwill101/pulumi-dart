...
class ModelAgreementTimeouts {
  ...
  /// Creates a new [ModelAgreementTimeouts].
  ...
  factory ModelAgreementTimeouts.fromMap(Map<String, dynamic> map) {
    return ModelAgreementTimeouts(
