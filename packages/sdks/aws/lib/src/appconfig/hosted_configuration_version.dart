...
import 'hosted_configuration_version_state.dart';
...
class HostedConfigurationVersion extends pulumi.CustomResource {
  ...
  /// Creates a new [HostedConfigurationVersion].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [HostedConfigurationVersion]. {@macro pulumi_appconfig_hosted_configuration_version_hosted_configuration_version_args_doc}
  ...
  /// Gets an existing [HostedConfigurationVersion] resource's state with the given [name] and [id].
  static HostedConfigurationVersion get(
    String name,
  ...
  HostedConfigurationVersion._get(
    String name, {
