...
class DeploymentArgs {
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      ...
      configurationVersion: pulumi.Input.fromValue(map['configurationVersion'] as String),
      deploymentStrategyId: pulumi.Input.fromValue(map['deploymentStrategyId'] as String),
