...
class EventIntegrationState {
  ...
  EventIntegrationState({
    ...
    pulumi.Output<EventIntegrationEventFilter>? eventFilter,
    pulumi.Output<String>? eventbridgeBus,
    ...
    pulumi.Output<Map<String, String>>? tagsAll,
      ...
      eventFilter = pulumi.Input.asOptionalInput<EventIntegrationEventFilter>(eventFilter),
      eventbridgeBus = pulumi.Input.asOptionalInput<String>(eventbridgeBus),
  ...
  factory EventIntegrationState.fromMap(Map<String, dynamic> map) {
    return EventIntegrationState(
      ...
      eventFilter: map['eventFilter'] == null ? null : pulumi.Output.create<EventIntegrationEventFilter>(EventIntegrationEventFilter.fromMap((map['eventFilter'] as Map).cast<String, dynamic>())),
      eventbridgeBus: map['eventbridgeBus'] == null ? null : pulumi.Output.create<String>(map['eventbridgeBus'] as String),
