...
class ExtensionArgs {
  ...
  ExtensionArgs({
    required pulumi.Output<List<ExtensionActionPoint>> actionPoints,
  ...
  factory ExtensionArgs.fromMap(Map<String, dynamic> map) {
    return ExtensionArgs(
      actionPoints: pulumi.Output.create<List<ExtensionActionPoint>>(pulumi.Input.decodeList<ExtensionActionPoint>(map['actionPoints'], (value) => ExtensionActionPoint.fromMap((value as Map).cast<String, dynamic>()))),
