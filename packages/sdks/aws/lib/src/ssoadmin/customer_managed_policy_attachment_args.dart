...
class CustomerManagedPolicyAttachmentArgs {
  ...
  factory CustomerManagedPolicyAttachmentArgs.fromMap(Map<String, dynamic> map) {
    return CustomerManagedPolicyAttachmentArgs(
      customerManagedPolicyReference: pulumi.Input.fromValue(CustomerManagedPolicyAttachmentCustomerManagedPolicyReference.fromMap((map['customerManagedPolicyReference']! as Map).cast<String, dynamic>())),
