...
class ApplicationPortalOptions {
  ...
  factory ApplicationPortalOptions.fromMap(Map<String, dynamic> map) {
    return ApplicationPortalOptions(
      signInOptions: (() { final guardedValue = map['signInOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationPortalOptionsSignInOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
