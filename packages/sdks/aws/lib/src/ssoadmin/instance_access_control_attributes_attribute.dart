...
class InstanceAccessControlAttributesAttribute {
  ...
  final pulumi.Input<List<InstanceAccessControlAttributesAttributeValue>> values;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'key': key,
      'values': pulumi.Input.mapInputValue<List<InstanceAccessControlAttributesAttributeValue>, List<Map<String, dynamic>>>(values, (value) => pulumi.Input.encodeList<InstanceAccessControlAttributesAttributeValue, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory InstanceAccessControlAttributesAttribute.fromMap(Map<String, dynamic> map) {
    return InstanceAccessControlAttributesAttribute(
      ...
      values: pulumi.Input.fromValue(pulumi.Input.decodeList<InstanceAccessControlAttributesAttributeValue>(map['values']!, (value) => InstanceAccessControlAttributesAttributeValue.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
