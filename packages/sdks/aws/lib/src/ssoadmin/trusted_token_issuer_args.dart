...
class TrustedTokenIssuerArgs {
  ...
  /// [trustedTokenIssuerConfiguration] A block that specifies settings that apply to the trusted token issuer, these change depending on the type you specify in `trustedTokenIssuerType`. Documented below.
  ...
  factory TrustedTokenIssuerArgs.fromMap(Map<String, dynamic> map) {
    return TrustedTokenIssuerArgs(
      ...
      trustedTokenIssuerConfiguration: pulumi.Input.fromValue(TrustedTokenIssuerTrustedTokenIssuerConfiguration.fromMap((map['trustedTokenIssuerConfiguration']! as Map).cast<String, dynamic>())),
      trustedTokenIssuerType: pulumi.Input.fromValue(map['trustedTokenIssuerType'] as String),
    );
  }
}
