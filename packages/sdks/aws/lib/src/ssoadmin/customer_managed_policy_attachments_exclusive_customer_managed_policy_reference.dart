...
class CustomerManagedPolicyAttachmentsExclusiveCustomerManagedPolicyReference {
  ...
  const CustomerManagedPolicyAttachmentsExclusiveCustomerManagedPolicyReference({
    required this.name,
    this.path,
  });
  ...
  factory CustomerManagedPolicyAttachmentsExclusiveCustomerManagedPolicyReference.fromMap(Map<String, dynamic> map) {
    return CustomerManagedPolicyAttachmentsExclusiveCustomerManagedPolicyReference(
