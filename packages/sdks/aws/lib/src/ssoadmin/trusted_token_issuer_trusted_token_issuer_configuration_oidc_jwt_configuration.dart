...
class TrustedTokenIssuerTrustedTokenIssuerConfigurationOidcJwtConfiguration {
  ...
  factory TrustedTokenIssuerTrustedTokenIssuerConfigurationOidcJwtConfiguration.fromMap(Map<String, dynamic> map) {
    return TrustedTokenIssuerTrustedTokenIssuerConfigurationOidcJwtConfiguration(
      claimAttributePath: pulumi.Input.fromValue(map['claimAttributePath'] as String),
      identityStoreAttributePath: pulumi.Input.fromValue(map['identityStoreAttributePath'] as String),
      issuerUrl: pulumi.Input.fromValue(map['issuerUrl'] as String),
      jwksRetrievalOption: pulumi.Input.fromValue(map['jwksRetrievalOption'] as String),
    );
  }
}
