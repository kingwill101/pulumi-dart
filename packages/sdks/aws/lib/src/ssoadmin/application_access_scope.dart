...
import 'application_access_scope_state.dart';
...
class ApplicationAccessScope extends pulumi.CustomResource {
  ...
  /// Creates a new [ApplicationAccessScope].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ApplicationAccessScope]. {@macro pulumi_ssoadmin_application_access_scope_application_access_scope_args_doc}
  ...
  static ApplicationAccessScope get(
    String name,
