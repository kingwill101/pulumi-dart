...
class ClassificationJobS3JobDefinitionBucketCriteria {
  ...
  factory ClassificationJobS3JobDefinitionBucketCriteria.fromMap(Map<String, dynamic> map) {
    return ClassificationJobS3JobDefinitionBucketCriteria(
      excludes: (() { final guardedValue = map['excludes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClassificationJobS3JobDefinitionBucketCriteriaExcludes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      includes: (() { final guardedValue = map['includes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClassificationJobS3JobDefinitionBucketCriteriaIncludes.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
