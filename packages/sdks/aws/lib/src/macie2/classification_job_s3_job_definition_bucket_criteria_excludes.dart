...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludes {
  ...
  final pulumi.Input<
    List<ClassificationJobS3JobDefinitionBucketCriteriaExcludesAnd>
  >?
  ands;
  ...
  ClassificationJobS3JobDefinitionBucketCriteriaExcludes({this.ands});
      ...
      ands: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ClassificationJobS3JobDefinitionBucketCriteriaExcludesAnd.fromMap(
