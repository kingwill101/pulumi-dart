...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludes {
  ...
  factory ClassificationJobS3JobDefinitionBucketCriteriaExcludes.fromMap(Map<String, dynamic> map) {
    return ClassificationJobS3JobDefinitionBucketCriteriaExcludes(
      ands: (() { final guardedValue = map['ands']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClassificationJobS3JobDefinitionBucketCriteriaExcludesAnd>(guardedValue, (value) => ClassificationJobS3JobDefinitionBucketCriteriaExcludesAnd.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
