...
class ClassificationJob extends pulumi.CustomResource {
  ...
  ClassificationJob(
    ...
    this.customDataIdentifierIds = registerOutput<List<String>>('customDataIdentifierIds');
    ...
    this.s3JobDefinition = registerOutput<ClassificationJobS3JobDefinition>('s3JobDefinition');
    this.samplingPercentage = registerOutput<int>('samplingPercentage');
    this.scheduleFrequency = registerOutput<ClassificationJobScheduleFrequency>('scheduleFrequency');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.userPausedDetails = registerOutput<List<ClassificationJobUserPausedDetail>>('userPausedDetails');
  }
