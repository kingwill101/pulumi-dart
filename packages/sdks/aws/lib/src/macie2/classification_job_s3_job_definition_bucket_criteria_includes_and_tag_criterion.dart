...
class ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion {
  ...
  factory ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion.fromMap(Map<String, dynamic> map) {
    return ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion(
      ...
      tagValues: (() { final guardedValue = map['tagValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterionTagValue>(guardedValue, (value) => ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterionTagValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
