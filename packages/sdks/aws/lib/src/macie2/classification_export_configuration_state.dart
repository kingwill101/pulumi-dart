...
class ClassificationExportConfigurationState {
  ...
  factory ClassificationExportConfigurationState.fromMap(Map<String, dynamic> map) {
    return ClassificationExportConfigurationState(
      ...
      s3Destination: (() { final guardedValue = map['s3Destination']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClassificationExportConfigurationS3Destination.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
