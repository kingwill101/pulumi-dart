...
class ClassificationJobS3JobDefinition {
  ...
  final pulumi.Input<ClassificationJobS3JobDefinitionBucketCriteria>?
  bucketCriteria;
  ...
  final pulumi.Input<List<ClassificationJobS3JobDefinitionBucketDefinition>>?
  bucketDefinitions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bucketDefinitions':
          ?pulumi.Input.mapOptionalInputValue<
            List<ClassificationJobS3JobDefinitionBucketDefinition>,
    ...
    return ClassificationJobS3JobDefinition(
      ...
      bucketDefinitions: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => ClassificationJobS3JobDefinitionBucketDefinition.fromMap(
      ...
      scoping: (() {
        final guardedValue = map['scoping'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
