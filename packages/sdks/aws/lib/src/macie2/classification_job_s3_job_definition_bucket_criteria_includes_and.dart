    ...
    return ClassificationJobS3JobDefinitionBucketCriteriaIncludesAnd(
      simpleCriterion: (() {
        ...
        return pulumi.Input.fromValue(
          ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion.fromMap(
      ...
      tagCriterion: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
