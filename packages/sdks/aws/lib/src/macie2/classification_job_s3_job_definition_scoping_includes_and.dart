...
class ClassificationJobS3JobDefinitionScopingIncludesAnd {
  ...
  factory ClassificationJobS3JobDefinitionScopingIncludesAnd.fromMap(Map<String, dynamic> map) {
    return ClassificationJobS3JobDefinitionScopingIncludesAnd(
      simpleScopeTerm: (() { final guardedValue = map['simpleScopeTerm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClassificationJobS3JobDefinitionScopingIncludesAndSimpleScopeTerm.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tagScopeTerm: (() { final guardedValue = map['tagScopeTerm']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTerm.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
