...
class LoadBalancerState {
  ...
  factory LoadBalancerState.fromMap(Map<String, dynamic> map) {
    return LoadBalancerState(
      ...
      connectionDraining: map['connectionDraining'] == null ? null : ((map['connectionDraining'] as bool).input()).input(),
      connectionDrainingTimeout: map['connectionDrainingTimeout'] == null ? null : ((map['connectionDrainingTimeout'] as int).input()).input(),
      crossZoneLoadBalancing: map['crossZoneLoadBalancing'] == null ? null : ((map['crossZoneLoadBalancing'] as bool).input()).input(),
      ...
      healthCheck: map['healthCheck'] == null ? null : ((LoadBalancerHealthCheck.fromMap((map['healthCheck']! as Map).cast<String, dynamic>())).input()).input(),
      idleTimeout: map['idleTimeout'] == null ? null : ((map['idleTimeout'] as int).input()).input(),
      instances: map['instances'] == null ? null : (((map['instances'] as List).cast<String>()).input()).input(),
      internal: map['internal'] == null ? null : ((map['internal'] as bool).input()).input(),
      listeners: map['listeners'] == null ? null : ((pulumi.Input.decodeList<LoadBalancerListener>(map['listeners']!, (value) => LoadBalancerListener.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      sourceSecurityGroup: map['sourceSecurityGroup'] == null ? null : ((map['sourceSecurityGroup'] as String).input()).input(),
