...
class LoadBalancerState {
  ...
  factory LoadBalancerState.fromMap(Map<String, dynamic> map) {
    return LoadBalancerState(
      ...
      connectionDrainingTimeout: (() { final guardedValue = map['connectionDrainingTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
