...
class LoadBalancerPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [LoadBalancerPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [LoadBalancerPolicy]. {@macro pulumi_elb_load_balancer_policy_load_balancer_policy_args_doc}
  ...
  LoadBalancerPolicy(
    ...
    this.policyAttributes = registerOutput<List<LoadBalancerPolicyPolicyAttribute>>('policyAttributes');
    this.policyName = registerOutput<String>('policyName');
    this.policyTypeName = registerOutput<String>('policyTypeName');
    this.region = registerOutput<String>('region');
  }

  /// Gets an existing [LoadBalancerPolicy] resource's state with the given [name] and [id].
  static LoadBalancerPolicy get(
    String name,
