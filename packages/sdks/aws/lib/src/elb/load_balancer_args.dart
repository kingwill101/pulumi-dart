...
class LoadBalancerArgs {
  ...
  LoadBalancerArgs({
    ...
    required pulumi.Output<List<LoadBalancerListener>> listeners,
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      listeners: pulumi.Output.create<List<LoadBalancerListener>>(pulumi.Input.decodeList<LoadBalancerListener>(map['listeners'], (value) => LoadBalancerListener.fromMap((value as Map).cast<String, dynamic>()))),
