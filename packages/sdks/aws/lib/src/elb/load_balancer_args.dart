...
class LoadBalancerArgs {
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      listeners: pulumi.Input.fromValue(pulumi.Input.decodeList<LoadBalancerListener>(map['listeners']!, (value) => LoadBalancerListener.fromMap((value as Map).cast<String, dynamic>()))),
