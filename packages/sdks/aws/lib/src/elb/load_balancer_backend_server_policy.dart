...
import 'load_balancer_backend_server_policy_state.dart';
...
class LoadBalancerBackendServerPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [LoadBalancerBackendServerPolicy] resource's state with the given [name] and [id].
  static LoadBalancerBackendServerPolicy get(
    String name,
    pulumi.Input<String> id, {
    LoadBalancerBackendServerPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return LoadBalancerBackendServerPolicy._get(
      name,
      state: state?.toMap(),
  ...
  LoadBalancerBackendServerPolicy._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [LoadBalancerBackendServerPolicy] resource.
  LoadBalancerBackendServerPolicy.reference(String urn)
    : super(
        'aws:elb/loadBalancerBackendServerPolicy:LoadBalancerBackendServerPolicy',
