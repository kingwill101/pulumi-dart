...
/// {@template pulumi_elb_get_service_account_get_service_account_args_doc}
/// Arguments for getServiceAccount.
/// {@endtemplate}
/// {@macro pulumi_elb_get_service_account_get_service_account_args_doc}
class GetServiceAccountArgs {
  ...
  GetServiceAccountArgs({this.region});
