...
import 'get_connection_route.dart';
import 'get_connection_vgw_telemetry.dart';
  ...
  factory GetConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetConnectionResult(
      ...
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetConnectionFilter>(
          guardedValue,
      ...
      routes: pulumi.Input.decodeList<GetConnectionRoute>(
        map['routes']!,
        (value) =>
            GetConnectionRoute.fromMap((value as Map).cast<String, dynamic>()),
      ),
