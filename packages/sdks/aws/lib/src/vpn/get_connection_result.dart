...
class GetConnectionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?filters == null ? null : pulumi.Input.encodeList<GetConnectionFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
  ...
  factory GetConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetConnectionResult(
      ...
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<GetConnectionFilter>(map['filters'], (value) => GetConnectionFilter.fromMap((value as Map).cast<String, dynamic>())),
