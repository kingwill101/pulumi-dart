...
class DbInstanceTimeouts {
  ...
  /// Creates a new [DbInstanceTimeouts].
  ...
  DbInstanceTimeouts({this.create, this.delete, this.update});
  ...
  factory DbInstanceTimeouts.fromMap(Map<String, dynamic> map) {
    return DbInstanceTimeouts(
      create: (() {
