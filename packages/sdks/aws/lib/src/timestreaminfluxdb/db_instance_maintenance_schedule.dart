...
class DbInstanceMaintenanceSchedule {
  ...
  /// Creates a new [DbInstanceMaintenanceSchedule].
  ...
  const DbInstanceMaintenanceSchedule({
  ...
  factory DbInstanceMaintenanceSchedule.fromMap(Map<String, dynamic> map) {
    return DbInstanceMaintenanceSchedule(
