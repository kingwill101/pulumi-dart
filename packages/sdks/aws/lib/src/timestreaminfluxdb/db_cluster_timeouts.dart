...
class DbClusterTimeouts {
  ...
  /// Creates a new [DbClusterTimeouts].
  ...
  DbClusterTimeouts({this.create, this.delete, this.update});
  ...
  factory DbClusterTimeouts.fromMap(Map<String, dynamic> map) {
    return DbClusterTimeouts(
      create: (() {
