...
class DbInstance extends pulumi.CustomResource {
  ...
  DbInstance(
    ...
    this.dbParameterGroupIdentifier = registerOutput<String?>('dbParameterGroupIdentifier');
    this.dbStorageType = registerOutput<String>('dbStorageType');
    this.deploymentType = registerOutput<String>('deploymentType');
    this.endpoint = registerOutput<String>('endpoint');
    this.influxAuthParametersSecretArn = registerOutput<String>('influxAuthParametersSecretArn');
    this.logDeliveryConfiguration = registerOutput<DbInstanceLogDeliveryConfiguration?>('logDeliveryConfiguration');
