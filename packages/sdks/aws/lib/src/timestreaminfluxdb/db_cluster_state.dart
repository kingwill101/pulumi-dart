...
class DbClusterState {
  ...
  factory DbClusterState.fromMap(Map<String, dynamic> map) {
    return DbClusterState(
      ...
      dbInstanceType: (() {
        final guardedValue = map['dbInstanceType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbParameterGroupIdentifier: (() {
        final guardedValue = map['dbParameterGroupIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dbStorageType: (() {
        final guardedValue = map['dbStorageType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deploymentType: (() {
      ...
      influxAuthParametersSecretArn: (() {
        final guardedValue = map['influxAuthParametersSecretArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logDeliveryConfiguration: (() {
        final guardedValue = map['logDeliveryConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DbClusterLogDeliveryConfiguration.fromMap(
      ...
      vpcSubnetIds: (() {
        final guardedValue = map['vpcSubnetIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
    );
