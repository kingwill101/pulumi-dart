...
class DbClusterState {
  ...
  factory DbClusterState.fromMap(Map<String, dynamic> map) {
    return DbClusterState(
      ...
      dbInstanceType: map['dbInstanceType'] == null ? null : ((map['dbInstanceType'] as String).input()).input(),
      dbParameterGroupIdentifier: map['dbParameterGroupIdentifier'] == null ? null : ((map['dbParameterGroupIdentifier'] as String).input()).input(),
      dbStorageType: map['dbStorageType'] == null ? null : ((map['dbStorageType'] as String).input()).input(),
      ...
      failoverMode: map['failoverMode'] == null ? null : ((map['failoverMode'] as String).input()).input(),
      influxAuthParametersSecretArn: map['influxAuthParametersSecretArn'] == null ? null : ((map['influxAuthParametersSecretArn'] as String).input()).input(),
      logDeliveryConfiguration: map['logDeliveryConfiguration'] == null ? null : ((DbClusterLogDeliveryConfiguration.fromMap((map['logDeliveryConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      timeouts: map['timeouts'] == null ? null : ((DbClusterTimeouts.fromMap((map['timeouts']! as Map).cast<String, dynamic>())).input()).input(),
