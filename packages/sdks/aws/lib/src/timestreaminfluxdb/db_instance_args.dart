...
class DbInstanceArgs {
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      ...
      logDeliveryConfiguration: map['logDeliveryConfiguration'] == null ? null : (DbInstanceLogDeliveryConfiguration.fromMap((map['logDeliveryConfiguration'] as Map).cast<String, dynamic>())).input(),
      ...
      timeouts: map['timeouts'] == null ? null : (DbInstanceTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())).input(),
