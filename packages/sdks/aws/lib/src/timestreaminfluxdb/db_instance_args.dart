...
class DbInstanceArgs {
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      allocatedStorage: (map['allocatedStorage'] as int).input(),
      ...
      logDeliveryConfiguration: map['logDeliveryConfiguration'] == null ? null : ((DbInstanceLogDeliveryConfiguration.fromMap((map['logDeliveryConfiguration']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      timeouts: map['timeouts'] == null ? null : ((DbInstanceTimeouts.fromMap((map['timeouts']! as Map).cast<String, dynamic>())).input()).input(),
      username: (map['username'] as String).input(),
      vpcSecurityGroupIds: ((map['vpcSecurityGroupIds'] as List).cast<String>()).input(),
