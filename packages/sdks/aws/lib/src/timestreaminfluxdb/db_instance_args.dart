...
class DbInstanceArgs {
  ...
  DbInstanceArgs({
    required pulumi.Output<int> allocatedStorage,
    required pulumi.Output<String> bucket,
    required pulumi.Output<String> dbInstanceType,
    ...
    required pulumi.Output<List<String>> vpcSecurityGroupIds,
  ...
  factory DbInstanceArgs.fromMap(Map<String, dynamic> map) {
    return DbInstanceArgs(
      allocatedStorage: pulumi.Output.create<int>(map['allocatedStorage'] as int),
      bucket: pulumi.Output.create<String>(map['bucket'] as String),
      dbInstanceType: pulumi.Output.create<String>(map['dbInstanceType'] as String),
      ...
      vpcSecurityGroupIds: pulumi.Output.create<List<String>>((map['vpcSecurityGroupIds'] as List).cast<String>()),
