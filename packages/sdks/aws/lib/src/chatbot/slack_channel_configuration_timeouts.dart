...
class SlackChannelConfigurationTimeouts {
  ...
  /// Creates a new [SlackChannelConfigurationTimeouts].
  ...
  SlackChannelConfigurationTimeouts({this.create, this.delete, this.update});
  ...
  factory SlackChannelConfigurationTimeouts.fromMap(Map<String, dynamic> map) {
    return SlackChannelConfigurationTimeouts(
      create: (() {
