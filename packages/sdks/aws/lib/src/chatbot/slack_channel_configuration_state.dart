...
class SlackChannelConfigurationState {
  ...
  factory SlackChannelConfigurationState.fromMap(Map<String, dynamic> map) {
    return SlackChannelConfigurationState(
      chatConfigurationArn: (() { final guardedValue = map['chatConfigurationArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      guardrailPolicyArns: (() { final guardedValue = map['guardrailPolicyArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      ...
      slackChannelId: (() { final guardedValue = map['slackChannelId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      slackChannelName: (() { final guardedValue = map['slackChannelName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      slackTeamId: (() { final guardedValue = map['slackTeamId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      slackTeamName: (() { final guardedValue = map['slackTeamName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      snsTopicArns: (() { final guardedValue = map['snsTopicArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      tagsAll: (() { final guardedValue = map['tagsAll']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SlackChannelConfigurationTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      userAuthorizationRequired: (() { final guardedValue = map['userAuthorizationRequired']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
