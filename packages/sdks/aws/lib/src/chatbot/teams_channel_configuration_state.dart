...
class TeamsChannelConfigurationState {
  ...
  factory TeamsChannelConfigurationState.fromMap(Map<String, dynamic> map) {
    return TeamsChannelConfigurationState(
      ...
      timeouts: (() { final guardedValue = map['timeouts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TeamsChannelConfigurationTimeouts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
