...
class DatabaseState {
  ...
  factory DatabaseState.fromMap(Map<String, dynamic> map) {
    return DatabaseState(
      ...
      diskSize: map['diskSize'] == null ? null : ((map['diskSize'] as double).input()).input(),
      ...
      masterDatabaseName: map['masterDatabaseName'] == null ? null : ((map['masterDatabaseName'] as String).input()).input(),
      masterEndpointAddress: map['masterEndpointAddress'] == null ? null : ((map['masterEndpointAddress'] as String).input()).input(),
      masterEndpointPort: map['masterEndpointPort'] == null ? null : ((map['masterEndpointPort'] as int).input()).input(),
      ...
      relationalDatabaseName: map['relationalDatabaseName'] == null ? null : ((map['relationalDatabaseName'] as String).input()).input(),
      secondaryAvailabilityZone: map['secondaryAvailabilityZone'] == null ? null : ((map['secondaryAvailabilityZone'] as String).input()).input(),
