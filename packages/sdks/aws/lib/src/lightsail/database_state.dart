...
class DatabaseState {
  ...
  factory DatabaseState.fromMap(Map<String, dynamic> map) {
    return DatabaseState(
      ...
      diskSize: (() { final guardedValue = map['diskSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      masterEndpointPort: (() { final guardedValue = map['masterEndpointPort']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
