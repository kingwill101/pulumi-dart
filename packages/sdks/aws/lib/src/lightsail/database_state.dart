...
class DatabaseState {
  ...
  factory DatabaseState.fromMap(Map<String, dynamic> map) {
    return DatabaseState(
      ...
      diskSize: map['diskSize'] == null ? null : (map['diskSize'] as double).input(),
      engine: map['engine'] == null ? null : (map['engine'] as String).input(),
      engineVersion: map['engineVersion'] == null ? null : (map['engineVersion'] as String).input(),
      finalSnapshotName: map['finalSnapshotName'] == null ? null : (map['finalSnapshotName'] as String).input(),
      masterDatabaseName: map['masterDatabaseName'] == null ? null : (map['masterDatabaseName'] as String).input(),
      masterEndpointAddress: map['masterEndpointAddress'] == null ? null : (map['masterEndpointAddress'] as String).input(),
      masterEndpointPort: map['masterEndpointPort'] == null ? null : (map['masterEndpointPort'] as int).input(),
      ...
      relationalDatabaseName: map['relationalDatabaseName'] == null ? null : (map['relationalDatabaseName'] as String).input(),
