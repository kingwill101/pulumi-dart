...
class DatabaseState {
  ...
  factory DatabaseState.fromMap(Map<String, dynamic> map) {
    return DatabaseState(
      ...
      masterDatabaseName: (() {
        final guardedValue = map['masterDatabaseName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      masterEndpointAddress: (() {
        final guardedValue = map['masterEndpointAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      masterEndpointPort: (() {
        final guardedValue = map['masterEndpointPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      masterPassword: (() {
      ...
      relationalDatabaseName: (() {
        final guardedValue = map['relationalDatabaseName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
