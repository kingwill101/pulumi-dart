...
class ContainerServiceDeploymentVersion extends pulumi.CustomResource {
  ...
  /// Gets an existing [ContainerServiceDeploymentVersion] resource's state with the given [name] and [id].
  static ContainerServiceDeploymentVersion get(
    String name,
  ...
  ContainerServiceDeploymentVersion._get(
    String name, {
