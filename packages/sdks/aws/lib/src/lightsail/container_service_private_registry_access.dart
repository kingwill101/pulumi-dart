...
class ContainerServicePrivateRegistryAccess {
  ...
  final pulumi.Input<ContainerServicePrivateRegistryAccessEcrImagePullerRole>?
  ecrImagePullerRole;
  ...
  ContainerServicePrivateRegistryAccess({this.ecrImagePullerRole});
    ...
    return <String, dynamic>{
      'ecrImagePullerRole':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(ecrImagePullerRole, (value) => value.toMap()),
    };
  }
  ...
  factory ContainerServicePrivateRegistryAccess.fromMap(
    ...
    return ContainerServicePrivateRegistryAccess(
      ecrImagePullerRole: (() {
        final guardedValue = map['ecrImagePullerRole'];
