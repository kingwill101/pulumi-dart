...
import 'bucket_resource_access_state.dart';
...
class BucketResourceAccess extends pulumi.CustomResource {
  ...
  /// Gets an existing [BucketResourceAccess] resource's state with the given [name] and [id].
  static BucketResourceAccess get(
    String name,
