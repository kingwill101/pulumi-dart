...
class ContainerServiceDeploymentVersionState {
  ...
  factory ContainerServiceDeploymentVersionState.fromMap(Map<String, dynamic> map) {
    return ContainerServiceDeploymentVersionState(
      containers: (() { final guardedValue = map['containers']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ContainerServiceDeploymentVersionContainer>(guardedValue, (value) => ContainerServiceDeploymentVersionContainer.fromMap((value as Map).cast<String, dynamic>()))); })(),
      createdAt: (() { final guardedValue = map['createdAt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      publicEndpoint: (() { final guardedValue = map['publicEndpoint']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ContainerServiceDeploymentVersionPublicEndpoint.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
