...
class LbCertificateState {
  ...
  final pulumi.Input<List<LbCertificateDomainValidationRecord>>?
    ...
    return <String, dynamic>{
      ...
      'domainValidationRecords':
          ?pulumi.Input.mapOptionalInputValue<
            List<LbCertificateDomainValidationRecord>,
  ...
  factory LbCertificateState.fromMap(Map<String, dynamic> map) {
    return LbCertificateState(
      ...
      domainValidationRecords: (() {
        final guardedValue = map['domainValidationRecords'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LbCertificateDomainValidationRecord>(
            guardedValue,
            (value) => LbCertificateDomainValidationRecord.fromMap(
