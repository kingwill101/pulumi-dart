...
import 'lb_stickiness_policy_state.dart';
...
class LbStickinessPolicy extends pulumi.CustomResource {
  ...
  /// Gets an existing [LbStickinessPolicy] resource's state with the given [name] and [id].
  static LbStickinessPolicy get(
    String name,
