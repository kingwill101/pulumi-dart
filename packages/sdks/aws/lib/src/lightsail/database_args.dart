...
class DatabaseArgs {
  ...
  DatabaseArgs({
    ...
    required pulumi.Output<String> masterDatabaseName,
    required pulumi.Output<String> masterPassword,
    required pulumi.Output<String> masterUsername,
    ...
    required pulumi.Output<String> relationalDatabaseName,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      relationalDatabaseName = pulumi.Input.asInput<String>(relationalDatabaseName),
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      ...
      masterDatabaseName: pulumi.Output.create<String>(map['masterDatabaseName'] as String),
      masterPassword: pulumi.Output.create<String>(map['masterPassword'] as String),
      masterUsername: pulumi.Output.create<String>(map['masterUsername'] as String),
      ...
      relationalDatabaseName: pulumi.Output.create<String>(map['relationalDatabaseName'] as String),
