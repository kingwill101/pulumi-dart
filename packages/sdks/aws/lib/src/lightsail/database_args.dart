  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      ...
      backupRetentionEnabled: (() {
        final guardedValue = map['backupRetentionEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      finalSnapshotName: (() {
        final guardedValue = map['finalSnapshotName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      masterDatabaseName: pulumi.Input.fromValue(
        map['masterDatabaseName'] as String,
      ),
      ...
      relationalDatabaseName: pulumi.Input.fromValue(
        map['relationalDatabaseName'] as String,
      ),
      skipFinalSnapshot: (() {
