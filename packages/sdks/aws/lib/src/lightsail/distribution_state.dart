...
class DistributionState {
  ...
  factory DistributionState.fromMap(Map<String, dynamic> map) {
    return DistributionState(
      alternativeDomainNames: map['alternativeDomainNames'] == null ? null : ((map['alternativeDomainNames'] as List).cast<String>()).input(),
      ...
      locations: map['locations'] == null ? null : (pulumi.Input.decodeList<DistributionLocation>(map['locations'], (value) => DistributionLocation.fromMap((value as Map).cast<String, dynamic>()))).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      origin: map['origin'] == null ? null : (DistributionOrigin.fromMap((map['origin'] as Map).cast<String, dynamic>())).input(),
      originPublicDns: map['originPublicDns'] == null ? null : (map['originPublicDns'] as String).input(),
