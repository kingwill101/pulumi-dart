    ...
    return <String, dynamic>{
      ...
      'cacheBehaviorSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cacheBehaviorSettings, (value) => value.toMap()),
      'cacheBehaviors':
          ?pulumi.Input.mapOptionalInputValue<
            List<DistributionCacheBehavior>,
  ...
  factory DistributionState.fromMap(Map<String, dynamic> map) {
    return DistributionState(
      alternativeDomainNames: (() {
        final guardedValue = map['alternativeDomainNames'];
      ...
      cacheBehaviorSettings: (() {
        final guardedValue = map['cacheBehaviorSettings'];
        if (guardedValue == null) return null;
      ...
      locations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DistributionLocation>(
            guardedValue,
            (value) => DistributionLocation.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      origin: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DistributionOrigin.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      originPublicDns: (() {
        final guardedValue = map['originPublicDns'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
