...
class ContainerServiceState {
  ...
  factory ContainerServiceState.fromMap(Map<String, dynamic> map) {
    return ContainerServiceState(
      ...
      power: map['power'] == null ? null : (map['power'] as String).input(),
      powerId: map['powerId'] == null ? null : (map['powerId'] as String).input(),
      principalArn: map['principalArn'] == null ? null : (map['principalArn'] as String).input(),
      privateDomainName: map['privateDomainName'] == null ? null : (map['privateDomainName'] as String).input(),
