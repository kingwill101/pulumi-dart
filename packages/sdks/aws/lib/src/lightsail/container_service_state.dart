...
class ContainerServiceState {
  ...
  /// [privateDomainName] Private domain name of the container service. The private domain name is accessible only by other resources within the default VPC of your Lightsail account.
  ...
  factory ContainerServiceState.fromMap(Map<String, dynamic> map) {
    return ContainerServiceState(
      ...
      scale: (() { final guardedValue = map['scale']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
