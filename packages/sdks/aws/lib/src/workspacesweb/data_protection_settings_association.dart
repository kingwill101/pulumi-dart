...
import 'data_protection_settings_association_state.dart';
...
///   display_name = "example"
/// }
/// resource "aws_workspacesweb_dataprotectionsettingsassociation" "example" {
///   data_protection_settings_arn = aws_workspacesweb_dataprotectionsettings.example.data_protection_settings_arn
...
class DataProtectionSettingsAssociation extends pulumi.CustomResource {
  ...
  static DataProtectionSettingsAssociation get(
    String name,
  ...
  DataProtectionSettingsAssociation._get(
    String name, {
