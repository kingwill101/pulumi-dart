...
class IdentityProviderArgs {
  ...
  IdentityProviderArgs({
    required pulumi.Output<Map<String, String>> identityProviderDetails,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      identityProviderDetails = pulumi.Input.asInput<Map<String, String>>(identityProviderDetails),
  ...
  factory IdentityProviderArgs.fromMap(Map<String, dynamic> map) {
    return IdentityProviderArgs(
      identityProviderDetails: pulumi.Output.create<Map<String, String>>((map['identityProviderDetails'] as Map).cast<String, String>()),
