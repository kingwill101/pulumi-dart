...
class UserSettings extends pulumi.CustomResource {
  ...
  UserSettings(
    ...
    disconnectTimeoutInMinutes = registerOutput<int?>(
      'disconnectTimeoutInMinutes',
    );
    downloadAllowed = registerOutput<String>('downloadAllowed');
    idleDisconnectTimeoutInMinutes = registerOutput<int?>(
  ...
  /// Gets an existing [UserSettings] resource's state with the given [name] and [id].
