...
class UserSettingsArgs {
  ...
  factory UserSettingsArgs.fromMap(Map<String, dynamic> map) {
    return UserSettingsArgs(
      ...
      disconnectTimeoutInMinutes: (() { final guardedValue = map['disconnectTimeoutInMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      downloadAllowed: pulumi.Input.fromValue(map['downloadAllowed'] as String),
      idleDisconnectTimeoutInMinutes: (() { final guardedValue = map['idleDisconnectTimeoutInMinutes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
