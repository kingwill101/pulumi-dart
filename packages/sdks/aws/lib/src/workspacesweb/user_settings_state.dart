...
class UserSettingsState {
  ...
  factory UserSettingsState.fromMap(Map<String, dynamic> map) {
    return UserSettingsState(
      ...
      copyAllowed: map['copyAllowed'] == null ? null : (map['copyAllowed'] as String).input(),
      ...
      downloadAllowed: map['downloadAllowed'] == null ? null : (map['downloadAllowed'] as String).input(),
      ...
      pasteAllowed: map['pasteAllowed'] == null ? null : (map['pasteAllowed'] as String).input(),
      printAllowed: map['printAllowed'] == null ? null : (map['printAllowed'] as String).input(),
      ...
      uploadAllowed: map['uploadAllowed'] == null ? null : (map['uploadAllowed'] as String).input(),
