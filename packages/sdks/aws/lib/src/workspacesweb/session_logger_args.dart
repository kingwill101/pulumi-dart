...
class SessionLoggerArgs {
  ...
  SessionLoggerArgs({
    ...
    required pulumi.Output<SessionLoggerEventFilter> eventFilter,
    required pulumi.Output<SessionLoggerLogConfiguration> logConfiguration,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      eventFilter = pulumi.Input.asInput<SessionLoggerEventFilter>(eventFilter),
      logConfiguration = pulumi.Input.asInput<SessionLoggerLogConfiguration>(logConfiguration),
  ...
  factory SessionLoggerArgs.fromMap(Map<String, dynamic> map) {
    return SessionLoggerArgs(
      ...
      eventFilter: pulumi.Output.create<SessionLoggerEventFilter>(SessionLoggerEventFilter.fromMap((map['eventFilter'] as Map).cast<String, dynamic>())),
      logConfiguration: pulumi.Output.create<SessionLoggerLogConfiguration>(SessionLoggerLogConfiguration.fromMap((map['logConfiguration'] as Map).cast<String, dynamic>())),
