...
class SessionLoggerArgs {
  ...
  factory SessionLoggerArgs.fromMap(Map<String, dynamic> map) {
    return SessionLoggerArgs(
      ...
      eventFilter: pulumi.Input.fromValue(SessionLoggerEventFilter.fromMap((map['eventFilter']! as Map).cast<String, dynamic>())),
      logConfiguration: pulumi.Input.fromValue(SessionLoggerLogConfiguration.fromMap((map['logConfiguration']! as Map).cast<String, dynamic>())),
