  ...
  factory DataProtectionSettingsInlineRedactionConfiguration.fromMap(
    ...
    return DataProtectionSettingsInlineRedactionConfiguration(
      globalConfidenceLevel: (() {
        final guardedValue = map['globalConfidenceLevel'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      globalEnforcedUrls: (() {
        final guardedValue = map['globalEnforcedUrls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      globalExemptUrls: (() {
        final guardedValue = map['globalExemptUrls'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      inlineRedactionPatterns: pulumi.Input.fromValue(
