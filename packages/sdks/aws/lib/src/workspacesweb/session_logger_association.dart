...
import 'session_logger_association_state.dart';
...
class SessionLoggerAssociation extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [SessionLoggerAssociation]. {@macro pulumi_workspacesweb_session_logger_association_session_logger_association_args_doc}
  ...
  static SessionLoggerAssociation get(
    String name,
