...
class NetworkSettingsAssociationArgs {
  ...
  NetworkSettingsAssociationArgs({
    required pulumi.Output<String> networkSettingsArn,
    required pulumi.Output<String> portalArn,
    pulumi.Output<String>? region,
  }) :
      networkSettingsArn = pulumi.Input.asInput<String>(networkSettingsArn),
  ...
  factory NetworkSettingsAssociationArgs.fromMap(Map<String, dynamic> map) {
    return NetworkSettingsAssociationArgs(
      networkSettingsArn: pulumi.Output.create<String>(map['networkSettingsArn'] as String),
