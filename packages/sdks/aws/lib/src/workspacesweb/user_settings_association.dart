...
import 'user_settings_association_state.dart';
...
class UserSettingsAssociation extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [UserSettingsAssociation]. {@macro pulumi_workspacesweb_user_settings_association_user_settings_association_args_doc}
  ...
  /// Gets an existing [UserSettingsAssociation] resource's state with the given [name] and [id].
  static UserSettingsAssociation get(
    String name,
