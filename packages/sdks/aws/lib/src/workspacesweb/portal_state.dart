...
class PortalState {
  ...
  factory PortalState.fromMap(Map<String, dynamic> map) {
    return PortalState(
      ...
      browserType: map['browserType'] == null ? null : ((map['browserType'] as String).input()).input(),
      ...
      portalEndpoint: map['portalEndpoint'] == null ? null : ((map['portalEndpoint'] as String).input()).input(),
      portalStatus: map['portalStatus'] == null ? null : ((map['portalStatus'] as String).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      rendererType: map['rendererType'] == null ? null : ((map['rendererType'] as String).input()).input(),
