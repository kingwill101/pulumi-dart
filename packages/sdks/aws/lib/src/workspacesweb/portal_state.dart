...
class PortalState {
  ...
  factory PortalState.fromMap(Map<String, dynamic> map) {
    return PortalState(
      ...
      portalEndpoint: (() {
        final guardedValue = map['portalEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      portalStatus: (() {
        final guardedValue = map['portalStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      rendererType: (() {
        final guardedValue = map['rendererType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sessionLoggerArn: (() {
      ...
      userAccessLoggingSettingsArn: (() {
        final guardedValue = map['userAccessLoggingSettingsArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      userSettingsArn: (() {
