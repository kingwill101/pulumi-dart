...
class LabelingJobInputConfig {
  ...
  LabelingJobInputConfig({this.dataAttributes, required this.dataSource});
    ...
    return <String, dynamic>{
      'dataAttributes':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataAttributes, (value) => value.toMap()),
      'dataSource':
  ...
  factory LabelingJobInputConfig.fromMap(Map<String, dynamic> map) {
    return LabelingJobInputConfig(
      dataAttributes: (() {
        final guardedValue = map['dataAttributes'];
      ...
      dataSource: pulumi.Input.fromValue(
        LabelingJobInputConfigDataSource.fromMap(
