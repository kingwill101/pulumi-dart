...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec {
  ...
  /// Creates a new [DomainDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec].
  ...
  const DomainDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory DomainDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
    return DomainDefaultSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec(
