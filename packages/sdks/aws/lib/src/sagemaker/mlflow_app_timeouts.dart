...
class MlflowAppTimeouts {
  ...
  /// Creates a new [MlflowAppTimeouts].
  ...
  factory MlflowAppTimeouts.fromMap(Map<String, dynamic> map) {
    return MlflowAppTimeouts(
