...
class FeatureGroupFeatureDefinition {
  final pulumi.Input<FeatureGroupFeatureDefinitionCollectionConfig>?
  collectionConfig;
    ...
    return <String, dynamic>{
      'collectionConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(collectionConfig, (value) => value.toMap()),
  ...
  factory FeatureGroupFeatureDefinition.fromMap(Map<String, dynamic> map) {
    return FeatureGroupFeatureDefinition(
      collectionConfig: (() {
        final guardedValue = map['collectionConfig'];
      ...
      collectionType: (() {
        final guardedValue = map['collectionType'];
        if (guardedValue == null) return null;
