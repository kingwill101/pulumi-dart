...
class ModelPrimaryContainerModelDataSource {
  ...
  final pulumi.Input<List<ModelPrimaryContainerModelDataSourceS3DataSource>>
  s3DataSources;

  /// Creates a new [ModelPrimaryContainerModelDataSource].
  /// [s3DataSources] S3 location of model data to deploy. See S3 Data Source.
  ModelPrimaryContainerModelDataSource({required this.s3DataSources});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      's3DataSources':
          pulumi.Input.mapInputValue<
            List<ModelPrimaryContainerModelDataSourceS3DataSource>,
