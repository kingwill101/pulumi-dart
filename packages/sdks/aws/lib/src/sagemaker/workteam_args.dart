...
class WorkteamArgs {
  ...
  factory WorkteamArgs.fromMap(Map<String, dynamic> map) {
    return WorkteamArgs(
      ...
      memberDefinitions: pulumi.Input.fromValue(pulumi.Input.decodeList<WorkteamMemberDefinition>(map['memberDefinitions']!, (value) => WorkteamMemberDefinition.fromMap((value as Map).cast<String, dynamic>()))),
