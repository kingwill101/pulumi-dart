...
class DomainDefaultUserSettings {
  ...
  factory DomainDefaultUserSettings.fromMap(Map<String, dynamic> map) {
    return DomainDefaultUserSettings(
      ...
      canvasAppSettings: map['canvasAppSettings'] == null ? null : (DomainDefaultUserSettingsCanvasAppSettings.fromMap((map['canvasAppSettings'] as Map).cast<String, dynamic>())).input(),
      codeEditorAppSettings: map['codeEditorAppSettings'] == null ? null : (DomainDefaultUserSettingsCodeEditorAppSettings.fromMap((map['codeEditorAppSettings'] as Map).cast<String, dynamic>())).input(),
      customFileSystemConfigs: map['customFileSystemConfigs'] == null ? null : (pulumi.Input.decodeList<DomainDefaultUserSettingsCustomFileSystemConfig>(map['customFileSystemConfigs'], (value) => DomainDefaultUserSettingsCustomFileSystemConfig.fromMap((value as Map).cast<String, dynamic>()))).input(),
      customPosixUserConfig: map['customPosixUserConfig'] == null ? null : (DomainDefaultUserSettingsCustomPosixUserConfig.fromMap((map['customPosixUserConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      jupyterLabAppSettings: map['jupyterLabAppSettings'] == null ? null : (DomainDefaultUserSettingsJupyterLabAppSettings.fromMap((map['jupyterLabAppSettings'] as Map).cast<String, dynamic>())).input(),
      jupyterServerAppSettings: map['jupyterServerAppSettings'] == null ? null : (DomainDefaultUserSettingsJupyterServerAppSettings.fromMap((map['jupyterServerAppSettings'] as Map).cast<String, dynamic>())).input(),
      kernelGatewayAppSettings: map['kernelGatewayAppSettings'] == null ? null : (DomainDefaultUserSettingsKernelGatewayAppSettings.fromMap((map['kernelGatewayAppSettings'] as Map).cast<String, dynamic>())).input(),
      rSessionAppSettings: map['rSessionAppSettings'] == null ? null : (DomainDefaultUserSettingsRSessionAppSettings.fromMap((map['rSessionAppSettings'] as Map).cast<String, dynamic>())).input(),
      rStudioServerProAppSettings: map['rStudioServerProAppSettings'] == null ? null : (DomainDefaultUserSettingsRStudioServerProAppSettings.fromMap((map['rStudioServerProAppSettings'] as Map).cast<String, dynamic>())).input(),
      securityGroups: map['securityGroups'] == null ? null : ((map['securityGroups'] as List).cast<String>()).input(),
      sharingSettings: map['sharingSettings'] == null ? null : (DomainDefaultUserSettingsSharingSettings.fromMap((map['sharingSettings'] as Map).cast<String, dynamic>())).input(),
      spaceStorageSettings: map['spaceStorageSettings'] == null ? null : (DomainDefaultUserSettingsSpaceStorageSettings.fromMap((map['spaceStorageSettings'] as Map).cast<String, dynamic>())).input(),
      studioWebPortal: map['studioWebPortal'] == null ? null : (map['studioWebPortal'] as String).input(),
      studioWebPortalSettings: map['studioWebPortalSettings'] == null ? null : (DomainDefaultUserSettingsStudioWebPortalSettings.fromMap((map['studioWebPortalSettings'] as Map).cast<String, dynamic>())).input(),
      tensorBoardAppSettings: map['tensorBoardAppSettings'] == null ? null : (DomainDefaultUserSettingsTensorBoardAppSettings.fromMap((map['tensorBoardAppSettings'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
