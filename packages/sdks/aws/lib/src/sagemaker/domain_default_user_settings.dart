...
class DomainDefaultUserSettings {
  ...
  factory DomainDefaultUserSettings.fromMap(Map<String, dynamic> map) {
    return DomainDefaultUserSettings(
      ...
      canvasAppSettings: (() { final guardedValue = map['canvasAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsCanvasAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      codeEditorAppSettings: (() { final guardedValue = map['codeEditorAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsCodeEditorAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      customFileSystemConfigs: (() { final guardedValue = map['customFileSystemConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDefaultUserSettingsCustomFileSystemConfig>(guardedValue, (value) => DomainDefaultUserSettingsCustomFileSystemConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      customPosixUserConfig: (() { final guardedValue = map['customPosixUserConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsCustomPosixUserConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      jupyterLabAppSettings: (() { final guardedValue = map['jupyterLabAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsJupyterLabAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      jupyterServerAppSettings: (() { final guardedValue = map['jupyterServerAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsJupyterServerAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kernelGatewayAppSettings: (() { final guardedValue = map['kernelGatewayAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsKernelGatewayAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rSessionAppSettings: (() { final guardedValue = map['rSessionAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsRSessionAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rStudioServerProAppSettings: (() { final guardedValue = map['rStudioServerProAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsRStudioServerProAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      sharingSettings: (() { final guardedValue = map['sharingSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsSharingSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      spaceStorageSettings: (() { final guardedValue = map['spaceStorageSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsSpaceStorageSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      studioWebPortalSettings: (() { final guardedValue = map['studioWebPortalSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsStudioWebPortalSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      tensorBoardAppSettings: (() { final guardedValue = map['tensorBoardAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsTensorBoardAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
