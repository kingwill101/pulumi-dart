...
class AppImageConfigState {
    ...
    return <String, dynamic>{
      ...
      'codeEditorAppImageConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(codeEditorAppImageConfig, (value) => value.toMap()),
      'jupyterLabImageConfig':
          ?pulumi.Input.mapOptionalInputValue<
            AppImageConfigJupyterLabImageConfig,
            Map<String, dynamic>
          >(jupyterLabImageConfig, (value) => value.toMap()),
      'kernelGatewayImageConfig':
          ?pulumi.Input.mapOptionalInputValue<
            AppImageConfigKernelGatewayImageConfig,
            Map<String, dynamic>
          >(kernelGatewayImageConfig, (value) => value.toMap()),
      'region': ?region,
      'tags': ?tags,
      'tagsAll': ?tagsAll,
    };
  ...
  factory AppImageConfigState.fromMap(Map<String, dynamic> map) {
    return AppImageConfigState(
      appImageConfigName: (() {
        final guardedValue = map['appImageConfigName'];
      ...
      codeEditorAppImageConfig: (() {
        final guardedValue = map['codeEditorAppImageConfig'];
        if (guardedValue == null) return null;
      ...
      jupyterLabImageConfig: (() {
        final guardedValue = map['jupyterLabImageConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kernelGatewayImageConfig: (() {
        final guardedValue = map['kernelGatewayImageConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
