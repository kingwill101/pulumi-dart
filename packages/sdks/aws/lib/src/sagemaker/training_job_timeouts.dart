...
class TrainingJobTimeouts {
  ...
  /// Creates a new [TrainingJobTimeouts].
  ...
  factory TrainingJobTimeouts.fromMap(Map<String, dynamic> map) {
    return TrainingJobTimeouts(
