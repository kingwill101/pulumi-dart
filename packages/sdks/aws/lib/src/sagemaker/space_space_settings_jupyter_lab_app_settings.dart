...
class SpaceSpaceSettingsJupyterLabAppSettings {
  ...
  final pulumi.Input<
    List<SpaceSpaceSettingsJupyterLabAppSettingsCodeRepository>
  >?
  codeRepositories;

  /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker AI image created on the instance. See `default_resource_spec` Block below.
  final pulumi.Input<SpaceSpaceSettingsJupyterLabAppSettingsDefaultResourceSpec>
  defaultResourceSpec;
    ...
    return SpaceSpaceSettingsJupyterLabAppSettings(
      appLifecycleManagement: (() {
        ...
        return pulumi.Input.fromValue(
          SpaceSpaceSettingsJupyterLabAppSettingsAppLifecycleManagement.fromMap(
