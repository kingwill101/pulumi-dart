...
class DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec {
  ...
  /// Creates a new [DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec].
  ...
  const DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
