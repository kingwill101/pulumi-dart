...
class EndpointConfigurationDataCaptureConfig {
  ...
  final pulumi.Input<List<EndpointConfigurationDataCaptureConfigCaptureOption>>
  captureOptions;
    ...
    return <String, dynamic>{
      'captureContentTypeHeader':
          ?pulumi.Input.mapOptionalInputValue<
            EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader,
            Map<String, dynamic>
          >(captureContentTypeHeader, (value) => value.toMap()),
      'captureOptions':
  ...
  factory EndpointConfigurationDataCaptureConfig.fromMap(
    ...
    return EndpointConfigurationDataCaptureConfig(
      captureContentTypeHeader: (() {
        final guardedValue = map['captureContentTypeHeader'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      captureOptions: pulumi.Input.fromValue(
      ...
      enableCapture: (() {
        final guardedValue = map['enableCapture'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      initialSamplingPercentage: pulumi.Input.fromValue(
        map['initialSamplingPercentage'] as int,
      ),
      kmsKeyId: (() {
