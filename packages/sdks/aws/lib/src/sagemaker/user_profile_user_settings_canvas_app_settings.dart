...
class UserProfileUserSettingsCanvasAppSettings {
  ...
  final pulumi.Input<
    List<UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting>
  >?
  identityProviderOauthSettings;

  /// The settings for document querying. See Kendra Settings below.
  final pulumi.Input<UserProfileUserSettingsCanvasAppSettingsKendraSettings>?
  kendraSettings;
  ...
  final pulumi.Input<UserProfileUserSettingsCanvasAppSettingsWorkspaceSettings>?
  workspaceSettings;
    ...
    return <String, dynamic>{
      'directDeploySettings':
          ?pulumi.Input.mapOptionalInputValue<
            UserProfileUserSettingsCanvasAppSettingsDirectDeploySettings,
            Map<String, dynamic>
          >(directDeploySettings, (value) => value.toMap()),
      'emrServerlessSettings':
          ?pulumi.Input.mapOptionalInputValue<
            UserProfileUserSettingsCanvasAppSettingsEmrServerlessSettings,
            Map<String, dynamic>
          >(emrServerlessSettings, (value) => value.toMap()),
      'generativeAiSettings':
          ?pulumi.Input.mapOptionalInputValue<
            UserProfileUserSettingsCanvasAppSettingsGenerativeAiSettings,
            Map<String, dynamic>
          >(generativeAiSettings, (value) => value.toMap()),
      'identityProviderOauthSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<
      ...
      'kendraSettings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(kendraSettings, (value) => value.toMap()),
      'modelRegisterSettings':
          ?pulumi.Input.mapOptionalInputValue<
            UserProfileUserSettingsCanvasAppSettingsModelRegisterSettings,
            Map<String, dynamic>
          >(modelRegisterSettings, (value) => value.toMap()),
      'timeSeriesForecastingSettings':
          ?pulumi.Input.mapOptionalInputValue<
            UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings,
            Map<String, dynamic>
          >(timeSeriesForecastingSettings, (value) => value.toMap()),
      'workspaceSettings':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory UserProfileUserSettingsCanvasAppSettings.fromMap(
    ...
    return UserProfileUserSettingsCanvasAppSettings(
      directDeploySettings: (() {
        final guardedValue = map['directDeploySettings'];
      ...
      emrServerlessSettings: (() {
        final guardedValue = map['emrServerlessSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      generativeAiSettings: (() {
        final guardedValue = map['generativeAiSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      identityProviderOauthSettings: (() {
        final guardedValue = map['identityProviderOauthSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kendraSettings: (() {
        final guardedValue = map['kendraSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      modelRegisterSettings: (() {
        final guardedValue = map['modelRegisterSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      timeSeriesForecastingSettings: (() {
        final guardedValue = map['timeSeriesForecastingSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
