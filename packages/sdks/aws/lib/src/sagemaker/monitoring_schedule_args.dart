...
class MonitoringScheduleArgs {
  ...
  factory MonitoringScheduleArgs.fromMap(Map<String, dynamic> map) {
    return MonitoringScheduleArgs(
      monitoringScheduleConfig: pulumi.Input.fromValue(MonitoringScheduleMonitoringScheduleConfig.fromMap((map['monitoringScheduleConfig']! as Map).cast<String, dynamic>())),
