...
class DomainState {
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      defaultUserSettings: map['defaultUserSettings'] == null ? null : (DomainDefaultUserSettings.fromMap((map['defaultUserSettings'] as Map).cast<String, dynamic>())).input(),
      ...
      homeEfsFileSystemId: map['homeEfsFileSystemId'] == null ? null : (map['homeEfsFileSystemId'] as String).input(),
      ...
      securityGroupIdForDomainBoundary: map['securityGroupIdForDomainBoundary'] == null ? null : (map['securityGroupIdForDomainBoundary'] as String).input(),
      singleSignOnApplicationArn: map['singleSignOnApplicationArn'] == null ? null : (map['singleSignOnApplicationArn'] as String).input(),
      singleSignOnManagedApplicationInstanceId: map['singleSignOnManagedApplicationInstanceId'] == null ? null : (map['singleSignOnManagedApplicationInstanceId'] as String).input(),
