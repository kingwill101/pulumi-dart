...
class DomainDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec {
  ...
  /// Creates a new [DomainDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec].
  ...
  const DomainDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory DomainDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
    return DomainDefaultUserSettingsRSessionAppSettingsDefaultResourceSpec(
