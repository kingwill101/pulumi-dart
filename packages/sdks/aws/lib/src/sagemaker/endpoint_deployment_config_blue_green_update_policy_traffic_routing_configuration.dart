...
class EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration {
  ...
  final EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySize? canarySize;
  ...
  final EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationLinearStepSize? linearStepSize;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'linearStepSize': ?linearStepSize == null ? null : linearStepSize!.toMap(),
      'type': type,
  ...
  factory EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration.fromMap(Map<String, dynamic> map) {
    return EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration(
      canarySize: map['canarySize'] == null ? null : EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySize.fromMap((map['canarySize'] as Map).cast<String, dynamic>()),
      linearStepSize: map['linearStepSize'] == null ? null : EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationLinearStepSize.fromMap((map['linearStepSize'] as Map).cast<String, dynamic>()),
