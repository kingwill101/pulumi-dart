...
class ModelPrimaryContainerModelDataSourceS3DataSource {
  ...
  final ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig? modelAccessConfig;
  ...
  factory ModelPrimaryContainerModelDataSourceS3DataSource.fromMap(Map<String, dynamic> map) {
    return ModelPrimaryContainerModelDataSourceS3DataSource(
      ...
      modelAccessConfig: map['modelAccessConfig'] == null ? null : ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig.fromMap((map['modelAccessConfig'] as Map).cast<String, dynamic>()),
