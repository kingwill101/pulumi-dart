...
class DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec {
  ...
  const DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
