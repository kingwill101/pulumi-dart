...
class SpaceArgs {
  ...
  factory SpaceArgs.fromMap(Map<String, dynamic> map) {
    return SpaceArgs(
      ...
      ownershipSettings: (() {
        final guardedValue = map['ownershipSettings'];
      ...
      spaceDisplayName: (() {
        final guardedValue = map['spaceDisplayName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      spaceName: pulumi.Input.fromValue(map['spaceName'] as String),
      spaceSettings: (() {
        final guardedValue = map['spaceSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      spaceSharingSettings: (() {
        final guardedValue = map['spaceSharingSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
