...
import 'notebook_instance_lifecycle_configuration_state.dart';
...
class NotebookInstanceLifecycleConfiguration extends pulumi.CustomResource {
  ...
  static NotebookInstanceLifecycleConfiguration get(
    String name,
  ...
  NotebookInstanceLifecycleConfiguration._get(
    String name, {
