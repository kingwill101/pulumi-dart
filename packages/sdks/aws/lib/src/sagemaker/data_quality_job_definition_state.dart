...
class DataQualityJobDefinitionState {
  ...
  factory DataQualityJobDefinitionState.fromMap(Map<String, dynamic> map) {
    return DataQualityJobDefinitionState(
      ...
      dataQualityAppSpecification: (() {
        final guardedValue = map['dataQualityAppSpecification'];
        if (guardedValue == null) return null;
      ...
      dataQualityJobInput: (() {
        final guardedValue = map['dataQualityJobInput'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      dataQualityJobOutputConfig: (() {
        final guardedValue = map['dataQualityJobOutputConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      jobResources: (() {
        final guardedValue = map['jobResources'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
