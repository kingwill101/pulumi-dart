...
class FeatureGroupOfflineStoreConfig {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      's3StorageConfig': s3StorageConfig.toMap(),
  ...
  factory FeatureGroupOfflineStoreConfig.fromMap(Map<String, dynamic> map) {
    return FeatureGroupOfflineStoreConfig(
      dataCatalogConfig: map['dataCatalogConfig'] == null ? null : FeatureGroupOfflineStoreConfigDataCatalogConfig.fromMap((map['dataCatalogConfig'] as Map).cast<String, dynamic>()),
      disableGlueTableCreation: map['disableGlueTableCreation'] == null ? null : map['disableGlueTableCreation'] as bool,
      s3StorageConfig: FeatureGroupOfflineStoreConfigS3StorageConfig.fromMap((map['s3StorageConfig'] as Map).cast<String, dynamic>()),
