...
class DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec {
  ...
  const DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
