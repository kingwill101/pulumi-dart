    ...
    return DomainDomainSettingsRStudioServerProDomainSettings(
      defaultResourceSpec: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      domainExecutionRoleArn: pulumi.Input.fromValue(
        map['domainExecutionRoleArn'] as String,
      ),
      rStudioConnectUrl: (() {
        final guardedValue = map['rStudioConnectUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rStudioPackageManagerUrl: (() {
        final guardedValue = map['rStudioPackageManagerUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
