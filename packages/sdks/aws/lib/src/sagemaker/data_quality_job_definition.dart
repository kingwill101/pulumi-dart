...
class DataQualityJobDefinition extends pulumi.CustomResource {
  ...
  DataQualityJobDefinition(
    ...
    this.dataQualityAppSpecification = registerOutput<DataQualityJobDefinitionDataQualityAppSpecification>('dataQualityAppSpecification');
    this.dataQualityBaselineConfig = registerOutput<DataQualityJobDefinitionDataQualityBaselineConfig?>('dataQualityBaselineConfig');
    this.dataQualityJobInput = registerOutput<DataQualityJobDefinitionDataQualityJobInput>('dataQualityJobInput');
    this.dataQualityJobOutputConfig = registerOutput<DataQualityJobDefinitionDataQualityJobOutputConfig>('dataQualityJobOutputConfig');
    this.jobResources = registerOutput<DataQualityJobDefinitionJobResources>('jobResources');
    this.name = registerOutput<String>('name');
    this.networkConfig = registerOutput<DataQualityJobDefinitionNetworkConfig?>('networkConfig');
    this.region = registerOutput<String>('region');
    this.roleArn = registerOutput<String>('roleArn');
    this.stoppingCondition = registerOutput<DataQualityJobDefinitionStoppingCondition>('stoppingCondition');
