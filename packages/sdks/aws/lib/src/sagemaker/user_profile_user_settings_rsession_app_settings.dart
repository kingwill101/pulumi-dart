...
class UserProfileUserSettingsRSessionAppSettings {
  ...
  factory UserProfileUserSettingsRSessionAppSettings.fromMap(Map<String, dynamic> map) {
    return UserProfileUserSettingsRSessionAppSettings(
      customImages: (() { final guardedValue = map['customImages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserProfileUserSettingsRSessionAppSettingsCustomImage>(guardedValue, (value) => UserProfileUserSettingsRSessionAppSettingsCustomImage.fromMap((value as Map).cast<String, dynamic>()))); })(),
      defaultResourceSpec: (() { final guardedValue = map['defaultResourceSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserProfileUserSettingsRSessionAppSettingsDefaultResourceSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
