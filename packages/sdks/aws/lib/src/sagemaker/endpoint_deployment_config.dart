...
class EndpointDeploymentConfig {
  ...
  final pulumi.Input<EndpointDeploymentConfigAutoRollbackConfiguration>?
  ...
  final pulumi.Input<EndpointDeploymentConfigBlueGreenUpdatePolicy>?
  blueGreenUpdatePolicy;

  /// Specifies a rolling deployment strategy for updating a SageMaker AI endpoint. See Rolling Update Policy.
  final pulumi.Input<EndpointDeploymentConfigRollingUpdatePolicy>?
  rollingUpdatePolicy;
    ...
    return <String, dynamic>{
      ...
      'blueGreenUpdatePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(blueGreenUpdatePolicy, (value) => value.toMap()),
      'rollingUpdatePolicy':
          ?pulumi.Input.mapOptionalInputValue<
            EndpointDeploymentConfigRollingUpdatePolicy,
            Map<String, dynamic>
          >(rollingUpdatePolicy, (value) => value.toMap()),
    };
  }
  ...
  factory EndpointDeploymentConfig.fromMap(Map<String, dynamic> map) {
    return EndpointDeploymentConfig(
      ...
      blueGreenUpdatePolicy: (() {
        final guardedValue = map['blueGreenUpdatePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      rollingUpdatePolicy: (() {
        final guardedValue = map['rollingUpdatePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
