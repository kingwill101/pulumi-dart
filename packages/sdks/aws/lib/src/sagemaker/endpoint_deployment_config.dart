...
class EndpointDeploymentConfig {
  ...
  const EndpointDeploymentConfig({
  ...
  factory EndpointDeploymentConfig.fromMap(Map<String, dynamic> map) {
    return EndpointDeploymentConfig(
      autoRollbackConfiguration: (() { final guardedValue = map['autoRollbackConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointDeploymentConfigAutoRollbackConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      blueGreenUpdatePolicy: (() { final guardedValue = map['blueGreenUpdatePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointDeploymentConfigBlueGreenUpdatePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rollingUpdatePolicy: (() { final guardedValue = map['rollingUpdatePolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointDeploymentConfigRollingUpdatePolicy.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
