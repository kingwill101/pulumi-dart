...
class UserProfileUserSettingsCustomFileSystemConfig {
  ...
  factory UserProfileUserSettingsCustomFileSystemConfig.fromMap(Map<String, dynamic> map) {
    return UserProfileUserSettingsCustomFileSystemConfig(
      efsFileSystemConfigs: (() { final guardedValue = map['efsFileSystemConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<UserProfileUserSettingsCustomFileSystemConfigEfsFileSystemConfig>(guardedValue, (value) => UserProfileUserSettingsCustomFileSystemConfigEfsFileSystemConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
