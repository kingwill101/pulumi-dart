...
class DataQualityJobDefinitionJobResources {
  ...
  final pulumi.Input<DataQualityJobDefinitionJobResourcesClusterConfig>
  clusterConfig;
  ...
  factory DataQualityJobDefinitionJobResources.fromMap(
    ...
    return DataQualityJobDefinitionJobResources(
      clusterConfig: pulumi.Input.fromValue(
        DataQualityJobDefinitionJobResourcesClusterConfig.fromMap(
