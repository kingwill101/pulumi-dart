...
class AppImageConfigCodeEditorAppImageConfig {
  ...
  factory AppImageConfigCodeEditorAppImageConfig.fromMap(Map<String, dynamic> map) {
    return AppImageConfigCodeEditorAppImageConfig(
      containerConfig: (() { final guardedValue = map['containerConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppImageConfigCodeEditorAppImageConfigContainerConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      fileSystemConfig: (() { final guardedValue = map['fileSystemConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppImageConfigCodeEditorAppImageConfigFileSystemConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
