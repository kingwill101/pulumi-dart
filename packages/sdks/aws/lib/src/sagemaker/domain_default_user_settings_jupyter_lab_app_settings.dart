...
class DomainDefaultUserSettingsJupyterLabAppSettings {
  ...
  final pulumi.Input<
    List<DomainDefaultUserSettingsJupyterLabAppSettingsCodeRepository>
  >?
  codeRepositories;

  /// A list of custom SageMaker AI images that are configured to run as a JupyterLab app. see `custom_image` Block below.
  final pulumi.Input<
    List<DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage>
  >?
  customImages;
  ...
  final pulumi.Input<DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings>?
  emrSettings;
