...
class LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfig {
  ...
  final LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfigVpcConfig? vpcConfig;
  ...
  factory LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfig.fromMap(Map<String, dynamic> map) {
    return LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfig(
      ...
      vpcConfig: map['vpcConfig'] == null ? null : LabelingJobLabelingJobAlgorithmsConfigLabelingJobResourceConfigVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
