...
class HumanTaskUIArgs {
  ...
  factory HumanTaskUIArgs.fromMap(Map<String, dynamic> map) {
    return HumanTaskUIArgs(
      humanTaskUiName: pulumi.Input.fromValue(map['humanTaskUiName'] as String),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      uiTemplate: pulumi.Input.fromValue(HumanTaskUIUiTemplate.fromMap((map['uiTemplate']! as Map).cast<String, dynamic>())),
    );
  }
}
