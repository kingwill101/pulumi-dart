...
class EndpointConfigurationAsyncInferenceConfigOutputConfigNotificationConfig {
  ...
  factory EndpointConfigurationAsyncInferenceConfigOutputConfigNotificationConfig.fromMap(Map<String, dynamic> map) {
    return EndpointConfigurationAsyncInferenceConfigOutputConfigNotificationConfig(
      errorTopic: (() { final guardedValue = map['errorTopic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      includeInferenceResponseIns: (() { final guardedValue = map['includeInferenceResponseIns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      successTopic: (() { final guardedValue = map['successTopic']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
