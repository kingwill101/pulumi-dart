...
class HyperParameterTuningJobTimeouts {
  ...
  /// Creates a new [HyperParameterTuningJobTimeouts].
  ...
  const HyperParameterTuningJobTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory HyperParameterTuningJobTimeouts.fromMap(Map<String, dynamic> map) {
    return HyperParameterTuningJobTimeouts(
