...
class EndpointConfigurationArgs {
  ...
  EndpointConfigurationArgs({
    ...
    required pulumi.Output<List<EndpointConfigurationProductionVariant>> productionVariants,
    ...
    pulumi.Output<Map<String, String>>? tags,
      ...
      productionVariants = pulumi.Input.asInput<List<EndpointConfigurationProductionVariant>>(productionVariants),
  ...
  factory EndpointConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return EndpointConfigurationArgs(
      ...
      productionVariants: pulumi.Output.create<List<EndpointConfigurationProductionVariant>>(pulumi.Input.decodeList<EndpointConfigurationProductionVariant>(map['productionVariants'], (value) => EndpointConfigurationProductionVariant.fromMap((value as Map).cast<String, dynamic>()))),
