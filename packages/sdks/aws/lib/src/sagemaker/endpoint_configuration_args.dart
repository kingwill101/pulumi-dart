...
/// {@template pulumi_sagemaker_endpoint_configuration_endpoint_configuration_args_doc}
...
class EndpointConfigurationArgs {
  ...
  /// Creates a new [EndpointConfigurationArgs].
  ...
  const EndpointConfigurationArgs({
