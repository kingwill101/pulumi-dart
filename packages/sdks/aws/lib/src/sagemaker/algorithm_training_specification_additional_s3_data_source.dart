...
class AlgorithmTrainingSpecificationAdditionalS3DataSource {
  ...
  /// Creates a new [AlgorithmTrainingSpecificationAdditionalS3DataSource].
  ...
  const AlgorithmTrainingSpecificationAdditionalS3DataSource({
  ...
  factory AlgorithmTrainingSpecificationAdditionalS3DataSource.fromMap(Map<String, dynamic> map) {
    return AlgorithmTrainingSpecificationAdditionalS3DataSource(
