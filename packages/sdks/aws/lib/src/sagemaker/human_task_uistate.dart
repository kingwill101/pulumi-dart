...
class HumanTaskUIState {
  ...
  factory HumanTaskUIState.fromMap(Map<String, dynamic> map) {
    return HumanTaskUIState(
      ...
      humanTaskUiName: (() { final guardedValue = map['humanTaskUiName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      tagsAll: (() { final guardedValue = map['tagsAll']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as Map).cast<String, String>()); })(),
      uiTemplate: (() { final guardedValue = map['uiTemplate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(HumanTaskUIUiTemplate.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
