  ...
  factory FeatureGroupState.fromMap(Map<String, dynamic> map) {
    return FeatureGroupState(
      ...
      eventTimeFeatureName: (() {
        final guardedValue = map['eventTimeFeatureName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      featureDefinitions: (() {
        final guardedValue = map['featureDefinitions'];
        if (guardedValue == null) return null;
      ...
      featureGroupName: (() {
        final guardedValue = map['featureGroupName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      offlineStoreConfig: (() {
      ...
      recordIdentifierFeatureName: (() {
        final guardedValue = map['recordIdentifierFeatureName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
