...
class DataQualityJobDefinitionArgs {
    ...
    return <String, dynamic>{
      ...
      'dataQualityBaselineConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dataQualityBaselineConfig, (value) => value.toMap()),
      'dataQualityJobInput':
          pulumi.Input.mapInputValue<
            DataQualityJobDefinitionDataQualityJobInput,
            Map<String, dynamic>
          >(dataQualityJobInput, (value) => value.toMap()),
      'dataQualityJobOutputConfig':
          pulumi.Input.mapInputValue<
      ...
      'jobResources':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(jobResources, (value) => value.toMap()),
      'name': ?name,
      'networkConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'stoppingCondition':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(stoppingCondition, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
  ...
  factory DataQualityJobDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return DataQualityJobDefinitionArgs(
      dataQualityAppSpecification: pulumi.Input.fromValue(
        DataQualityJobDefinitionDataQualityAppSpecification.fromMap(
          (map['dataQualityAppSpecification']! as Map).cast<String, dynamic>(),
        ),
      ),
      dataQualityBaselineConfig: (() {
        final guardedValue = map['dataQualityBaselineConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataQualityJobDefinitionDataQualityBaselineConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      dataQualityJobInput: pulumi.Input.fromValue(
        DataQualityJobDefinitionDataQualityJobInput.fromMap(
          (map['dataQualityJobInput']! as Map).cast<String, dynamic>(),
        ),
      ),
      dataQualityJobOutputConfig: pulumi.Input.fromValue(
        DataQualityJobDefinitionDataQualityJobOutputConfig.fromMap(
          (map['dataQualityJobOutputConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      jobResources: pulumi.Input.fromValue(
        DataQualityJobDefinitionJobResources.fromMap(
          (map['jobResources']! as Map).cast<String, dynamic>(),
        ),
      ),
      name: (() {
      ...
      networkConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataQualityJobDefinitionNetworkConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      stoppingCondition: (() {
        final guardedValue = map['stoppingCondition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DataQualityJobDefinitionStoppingCondition.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
