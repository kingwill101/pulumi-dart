...
class PipelineArgs {
  ...
  factory PipelineArgs.fromMap(Map<String, dynamic> map) {
    return PipelineArgs(
      parallelismConfiguration: (() {
        final guardedValue = map['parallelismConfiguration'];
      ...
      pipelineDefinition: (() {
        final guardedValue = map['pipelineDefinition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      pipelineDefinitionS3Location: (() {
        final guardedValue = map['pipelineDefinitionS3Location'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      pipelineDisplayName: pulumi.Input.fromValue(
        map['pipelineDisplayName'] as String,
      ),
