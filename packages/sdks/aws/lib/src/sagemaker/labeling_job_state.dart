...
class LabelingJobState {
  ...
  factory LabelingJobState.fromMap(Map<String, dynamic> map) {
    return LabelingJobState(
      ...
      humanTaskConfig: map['humanTaskConfig'] == null ? null : ((LabelingJobHumanTaskConfig.fromMap((map['humanTaskConfig']! as Map).cast<String, dynamic>())).input()).input(),
      inputConfig: map['inputConfig'] == null ? null : ((LabelingJobInputConfig.fromMap((map['inputConfig']! as Map).cast<String, dynamic>())).input()).input(),
      jobReferenceCode: map['jobReferenceCode'] == null ? null : ((map['jobReferenceCode'] as String).input()).input(),
      labelAttributeName: map['labelAttributeName'] == null ? null : ((map['labelAttributeName'] as String).input()).input(),
      labelCategoryConfigS3Uri: map['labelCategoryConfigS3Uri'] == null ? null : ((map['labelCategoryConfigS3Uri'] as String).input()).input(),
      labelCounters: map['labelCounters'] == null ? null : ((pulumi.Input.decodeList<LabelingJobLabelCounter>(map['labelCounters']!, (value) => LabelingJobLabelCounter.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      labelingJobArn: map['labelingJobArn'] == null ? null : ((map['labelingJobArn'] as String).input()).input(),
      labelingJobName: map['labelingJobName'] == null ? null : ((map['labelingJobName'] as String).input()).input(),
      labelingJobStatus: map['labelingJobStatus'] == null ? null : ((map['labelingJobStatus'] as String).input()).input(),
      outputConfig: map['outputConfig'] == null ? null : ((LabelingJobOutputConfig.fromMap((map['outputConfig']! as Map).cast<String, dynamic>())).input()).input(),
