...
class LabelingJobState {
  ...
  factory LabelingJobState.fromMap(Map<String, dynamic> map) {
    return LabelingJobState(
      ...
      humanTaskConfig: (() {
        final guardedValue = map['humanTaskConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingJobHumanTaskConfig.fromMap(
      ...
      inputConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingJobInputConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      jobReferenceCode: (() {
        final guardedValue = map['jobReferenceCode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labelAttributeName: (() {
        final guardedValue = map['labelAttributeName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labelCategoryConfigS3Uri: (() {
        final guardedValue = map['labelCategoryConfigS3Uri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labelCounters: (() {
        final guardedValue = map['labelCounters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<LabelingJobLabelCounter>(
            guardedValue,
            (value) => LabelingJobLabelCounter.fromMap(
      ...
      labelingJobAlgorithmsConfig: (() {
        final guardedValue = map['labelingJobAlgorithmsConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      labelingJobArn: (() {
        final guardedValue = map['labelingJobArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labelingJobName: (() {
        final guardedValue = map['labelingJobName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      labelingJobStatus: (() {
        final guardedValue = map['labelingJobStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      outputConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          LabelingJobOutputConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
