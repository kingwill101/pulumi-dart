...
import 'notebook_instance_state.dart';
...
class NotebookInstance extends pulumi.CustomResource {
  ...
  NotebookInstance(
    ...
    this.additionalCodeRepositories = registerOutput<List<String>?>('additionalCodeRepositories');
    this.arn = registerOutput<String>('arn');
    this.defaultCodeRepository = registerOutput<String?>('defaultCodeRepository');
    this.directInternetAccess = registerOutput<String?>('directInternetAccess');
    this.instanceMetadataServiceConfiguration = registerOutput<NotebookInstanceInstanceMetadataServiceConfiguration?>('instanceMetadataServiceConfiguration');
