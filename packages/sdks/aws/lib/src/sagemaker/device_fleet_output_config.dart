...
class DeviceFleetOutputConfig {
  ...
  /// [kmsKeyId] KMS key that Amazon SageMaker AI uses to encrypt data on the storage volume after compilation job. If you don't provide a KMS key ID, Amazon SageMaker AI uses the default KMS key for Amazon S3 for your role's account.
  ...
  factory DeviceFleetOutputConfig.fromMap(Map<String, dynamic> map) {
    return DeviceFleetOutputConfig(
      ...
      s3OutputLocation: pulumi.Input.fromValue(map['s3OutputLocation'] as String),
    );
  }
}
