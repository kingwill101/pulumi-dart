...
class AppImageConfigKernelGatewayImageConfig {
  ...
  factory AppImageConfigKernelGatewayImageConfig.fromMap(Map<String, dynamic> map) {
    return AppImageConfigKernelGatewayImageConfig(
      fileSystemConfig: (() { final guardedValue = map['fileSystemConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AppImageConfigKernelGatewayImageConfigFileSystemConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kernelSpecs: pulumi.Input.fromValue(pulumi.Input.decodeList<AppImageConfigKernelGatewayImageConfigKernelSpec>(map['kernelSpecs']!, (value) => AppImageConfigKernelGatewayImageConfigKernelSpec.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
