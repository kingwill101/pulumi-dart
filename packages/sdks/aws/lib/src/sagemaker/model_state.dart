    ...
    return <String, dynamic>{
      ...
      'inferenceExecutionConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(inferenceExecutionConfig, (value) => value.toMap()),
      'name': ?name,
      'primaryContainer':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return ModelState(
      ...
      containers: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ModelContainer>(
            guardedValue,
            (value) =>
                ModelContainer.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      enableNetworkIsolation: (() {
        final guardedValue = map['enableNetworkIsolation'];
        if (guardedValue == null) return null;
      ...
      inferenceExecutionConfig: (() {
        final guardedValue = map['inferenceExecutionConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ModelInferenceExecutionConfig.fromMap(
      ...
      vpcConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ModelVpcConfig.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
