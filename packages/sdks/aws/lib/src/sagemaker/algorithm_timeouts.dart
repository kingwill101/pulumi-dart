...
class AlgorithmTimeouts {
  ...
  /// Creates a new [AlgorithmTimeouts].
  ...
  factory AlgorithmTimeouts.fromMap(Map<String, dynamic> map) {
    return AlgorithmTimeouts(
