...
class SpaceSpaceSettingsCustomFileSystem {
  ...
  final pulumi.Input<SpaceSpaceSettingsCustomFileSystemEfsFileSystem>
  efsFileSystem;
    ...
    return <String, dynamic>{
      'efsFileSystem':
          pulumi.Input.mapInputValue<
            ...
            Map<String, dynamic>
          >(efsFileSystem, (value) => value.toMap()),
    };
  }

  factory SpaceSpaceSettingsCustomFileSystem.fromMap(Map<String, dynamic> map) {
    return SpaceSpaceSettingsCustomFileSystem(
      efsFileSystem: pulumi.Input.fromValue(
        SpaceSpaceSettingsCustomFileSystemEfsFileSystem.fromMap(
