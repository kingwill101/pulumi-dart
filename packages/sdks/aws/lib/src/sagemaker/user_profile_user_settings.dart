...
class UserProfileUserSettings {
  ...
  final pulumi.Input<UserProfileUserSettingsCanvasAppSettings>?
  canvasAppSettings;

  /// The Code Editor application settings. See Code Editor App Settings below.
  final pulumi.Input<UserProfileUserSettingsCodeEditorAppSettings>?
  ...
  final pulumi.Input<List<UserProfileUserSettingsCustomFileSystemConfig>>?
  customFileSystemConfigs;

  /// Details about the POSIX identity that is used for file system operations. See Custom Posix User Config below.
  final pulumi.Input<UserProfileUserSettingsCustomPosixUserConfig>?
  ...
  final pulumi.Input<UserProfileUserSettingsJupyterLabAppSettings>?
  jupyterLabAppSettings;

  /// The Jupyter server's app settings. See Jupyter Server App Settings below.
  final pulumi.Input<UserProfileUserSettingsJupyterServerAppSettings>?
  jupyterServerAppSettings;

  /// The kernel gateway app settings. See Kernel Gateway App Settings below.
  final pulumi.Input<UserProfileUserSettingsKernelGatewayAppSettings>?
  kernelGatewayAppSettings;

  /// The RSession app settings. See RSession App Settings below.
  final pulumi.Input<UserProfileUserSettingsRSessionAppSettings>?
  rSessionAppSettings;
  ...
  final pulumi.Input<UserProfileUserSettingsRStudioServerProAppSettings>?
  ...
  final pulumi.Input<UserProfileUserSettingsSpaceStorageSettings>?
  ...
  final pulumi.Input<UserProfileUserSettingsStudioWebPortalSettings>?
  studioWebPortalSettings;

  /// The TensorBoard app settings. See TensorBoard App Settings below.
  final pulumi.Input<UserProfileUserSettingsTensorBoardAppSettings>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customFileSystemConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<UserProfileUserSettingsCustomFileSystemConfig>,
