...
class ModelPrimaryContainerImageConfig {
  ...
  final pulumi.Input<ModelPrimaryContainerImageConfigRepositoryAuthConfig>?
    ...
    return <String, dynamic>{
      ...
      'repositoryAuthConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(repositoryAuthConfig, (value) => value.toMap()),
    };
  }

  factory ModelPrimaryContainerImageConfig.fromMap(Map<String, dynamic> map) {
    return ModelPrimaryContainerImageConfig(
      repositoryAccessMode: pulumi.Input.fromValue(
        map['repositoryAccessMode'] as String,
      ),
      repositoryAuthConfig: (() {
        final guardedValue = map['repositoryAuthConfig'];
