...
/// {@template pulumi_sagemaker_training_job_training_job_args_doc}
/// The set of arguments for TrainingJob.
/// {@endtemplate}
/// {@macro pulumi_sagemaker_training_job_training_job_args_doc}
class TrainingJobArgs {
  ...
  factory TrainingJobArgs.fromMap(Map<String, dynamic> map) {
    return TrainingJobArgs(
      ...
      trainingJobName: pulumi.Input.fromValue(map['trainingJobName'] as String),
