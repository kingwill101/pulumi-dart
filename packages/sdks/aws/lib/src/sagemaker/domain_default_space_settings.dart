...
class DomainDefaultSpaceSettings {
  ...
  final List<DomainDefaultSpaceSettingsCustomFileSystemConfig>? customFileSystemConfigs;
  ...
  final DomainDefaultSpaceSettingsJupyterServerAppSettings? jupyterServerAppSettings;
  /// The kernel gateway app settings. See `kernel_gateway_app_settings` Block below.
  final DomainDefaultSpaceSettingsKernelGatewayAppSettings? kernelGatewayAppSettings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customFileSystemConfigs': ?customFileSystemConfigs == null ? null : pulumi.Input.encodeList<DomainDefaultSpaceSettingsCustomFileSystemConfig, Map<String, dynamic>>(customFileSystemConfigs!, (value) => value.toMap()),
  ...
  factory DomainDefaultSpaceSettings.fromMap(Map<String, dynamic> map) {
    return DomainDefaultSpaceSettings(
      customFileSystemConfigs: map['customFileSystemConfigs'] == null ? null : pulumi.Input.decodeList<DomainDefaultSpaceSettingsCustomFileSystemConfig>(map['customFileSystemConfigs'], (value) => DomainDefaultSpaceSettingsCustomFileSystemConfig.fromMap((value as Map).cast<String, dynamic>())),
      customPosixUserConfig: map['customPosixUserConfig'] == null ? null : DomainDefaultSpaceSettingsCustomPosixUserConfig.fromMap((map['customPosixUserConfig'] as Map).cast<String, dynamic>()),
      executionRole: map['executionRole'] as String,
      jupyterLabAppSettings: map['jupyterLabAppSettings'] == null ? null : DomainDefaultSpaceSettingsJupyterLabAppSettings.fromMap((map['jupyterLabAppSettings'] as Map).cast<String, dynamic>()),
      jupyterServerAppSettings: map['jupyterServerAppSettings'] == null ? null : DomainDefaultSpaceSettingsJupyterServerAppSettings.fromMap((map['jupyterServerAppSettings'] as Map).cast<String, dynamic>()),
      kernelGatewayAppSettings: map['kernelGatewayAppSettings'] == null ? null : DomainDefaultSpaceSettingsKernelGatewayAppSettings.fromMap((map['kernelGatewayAppSettings'] as Map).cast<String, dynamic>()),
      securityGroups: map['securityGroups'] == null ? null : (map['securityGroups'] as List).cast<String>(),
      spaceStorageSettings: map['spaceStorageSettings'] == null ? null : DomainDefaultSpaceSettingsSpaceStorageSettings.fromMap((map['spaceStorageSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
