...
class DomainDefaultSpaceSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customFileSystemConfigs': ?pulumi.Input.mapOptionalInputValue<List<DomainDefaultSpaceSettingsCustomFileSystemConfig>, List<Map<String, dynamic>>>(customFileSystemConfigs, (value) => pulumi.Input.encodeList<DomainDefaultSpaceSettingsCustomFileSystemConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      'customPosixUserConfig': ?pulumi.Input.mapOptionalInputValue<DomainDefaultSpaceSettingsCustomPosixUserConfig, Map<String, dynamic>>(customPosixUserConfig, (value) => value.toMap()),
      'executionRole': executionRole,
      'jupyterLabAppSettings': ?pulumi.Input.mapOptionalInputValue<DomainDefaultSpaceSettingsJupyterLabAppSettings, Map<String, dynamic>>(jupyterLabAppSettings, (value) => value.toMap()),
      'jupyterServerAppSettings': ?pulumi.Input.mapOptionalInputValue<DomainDefaultSpaceSettingsJupyterServerAppSettings, Map<String, dynamic>>(jupyterServerAppSettings, (value) => value.toMap()),
      'kernelGatewayAppSettings': ?pulumi.Input.mapOptionalInputValue<DomainDefaultSpaceSettingsKernelGatewayAppSettings, Map<String, dynamic>>(kernelGatewayAppSettings, (value) => value.toMap()),
      'securityGroups': ?securityGroups,
      'spaceStorageSettings': ?pulumi.Input.mapOptionalInputValue<DomainDefaultSpaceSettingsSpaceStorageSettings, Map<String, dynamic>>(spaceStorageSettings, (value) => value.toMap()),
    };
  }

  factory DomainDefaultSpaceSettings.fromMap(Map<String, dynamic> map) {
    return DomainDefaultSpaceSettings(
      customFileSystemConfigs: (() { final guardedValue = map['customFileSystemConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDefaultSpaceSettingsCustomFileSystemConfig>(guardedValue, (value) => DomainDefaultSpaceSettingsCustomFileSystemConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      customPosixUserConfig: (() { final guardedValue = map['customPosixUserConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultSpaceSettingsCustomPosixUserConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      executionRole: pulumi.Input.fromValue(map['executionRole'] as String),
      jupyterLabAppSettings: (() { final guardedValue = map['jupyterLabAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultSpaceSettingsJupyterLabAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      jupyterServerAppSettings: (() { final guardedValue = map['jupyterServerAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultSpaceSettingsJupyterServerAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      kernelGatewayAppSettings: (() { final guardedValue = map['kernelGatewayAppSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultSpaceSettingsKernelGatewayAppSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      spaceStorageSettings: (() { final guardedValue = map['spaceStorageSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultSpaceSettingsSpaceStorageSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
