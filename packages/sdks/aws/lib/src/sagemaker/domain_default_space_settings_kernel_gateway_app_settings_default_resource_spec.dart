...
class DomainDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec {
  ...
  /// Creates a new [DomainDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec].
  ...
  const DomainDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory DomainDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
    return DomainDefaultSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec(
