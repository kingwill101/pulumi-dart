...
class EndpointDeploymentConfigBlueGreenUpdatePolicy {
  ...
  final EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration trafficRoutingConfiguration;
  ...
  factory EndpointDeploymentConfigBlueGreenUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return EndpointDeploymentConfigBlueGreenUpdatePolicy(
      ...
      terminationWaitInSeconds: map['terminationWaitInSeconds'] == null ? null : map['terminationWaitInSeconds'] as int,
      trafficRoutingConfiguration: EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration.fromMap((map['trafficRoutingConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
