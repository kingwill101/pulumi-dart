  ...
  factory UserProfileState.fromMap(Map<String, dynamic> map) {
    return UserProfileState(
      ...
      homeEfsFileSystemUid: (() {
        final guardedValue = map['homeEfsFileSystemUid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      singleSignOnUserIdentifier: (() {
        final guardedValue = map['singleSignOnUserIdentifier'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      singleSignOnUserValue: (() {
        final guardedValue = map['singleSignOnUserValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
      ...
      userProfileName: (() {
        final guardedValue = map['userProfileName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      userSettings: (() {
