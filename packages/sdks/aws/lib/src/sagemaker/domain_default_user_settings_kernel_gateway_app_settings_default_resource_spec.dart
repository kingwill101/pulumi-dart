...
class DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec {
  ...
  /// Creates a new [DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec].
  ...
  const DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
    return DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec(
