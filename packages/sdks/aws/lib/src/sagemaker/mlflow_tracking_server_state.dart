...
class MlflowTrackingServerState {
  ...
  /// [roleArn] ARN for an IAM role in your account that the MLflow Tracking Server uses to access the artifact store in Amazon S3. The role should have AmazonS3FullAccess permissions. For more information on IAM permissions for tracking server creation, see [Set up IAM permissions for MLflow](https://docs.aws.amazon.com/sagemaker/latest/dg/mlflow-create-tracking-server-iam.html).
  ...
  const MlflowTrackingServerState({
    this.arn,
  ...
  factory MlflowTrackingServerState.fromMap(Map<String, dynamic> map) {
    return MlflowTrackingServerState(
      ...
      trackingServerName: (() { final guardedValue = map['trackingServerName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      trackingServerUrl: (() { final guardedValue = map['trackingServerUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
