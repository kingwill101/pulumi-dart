...
class MlflowTrackingServerState {
  ...
  factory MlflowTrackingServerState.fromMap(Map<String, dynamic> map) {
    return MlflowTrackingServerState(
      ...
      artifactStoreUri: (() {
        final guardedValue = map['artifactStoreUri'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      automaticModelRegistration: (() {
        final guardedValue = map['automaticModelRegistration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      mlflowVersion: (() {
        final guardedValue = map['mlflowVersion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      trackingServerName: (() {
        final guardedValue = map['trackingServerName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trackingServerSize: (() {
        final guardedValue = map['trackingServerSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trackingServerUrl: (() {
        final guardedValue = map['trackingServerUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      weeklyMaintenanceWindowStart: (() {
        final guardedValue = map['weeklyMaintenanceWindowStart'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
