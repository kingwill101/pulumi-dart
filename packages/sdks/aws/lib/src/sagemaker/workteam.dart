...
class Workteam extends pulumi.CustomResource {
  ...
  Workteam(
    ...
    this.memberDefinitions = registerOutput<List<WorkteamMemberDefinition>>('memberDefinitions');
    this.notificationConfiguration = registerOutput<WorkteamNotificationConfiguration?>('notificationConfiguration');
    this.region = registerOutput<String>('region');
    this.subdomain = registerOutput<String>('subdomain');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.workerAccessConfiguration = registerOutput<WorkteamWorkerAccessConfiguration>('workerAccessConfiguration');
