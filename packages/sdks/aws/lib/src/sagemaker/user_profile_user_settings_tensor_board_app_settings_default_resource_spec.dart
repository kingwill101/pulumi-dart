...
class UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec {
  ...
  /// Creates a new [UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec].
  ...
  const UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
    return UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec(
