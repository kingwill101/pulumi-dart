...
class HubContentReferenceTimeouts {
  ...
  /// Creates a new [HubContentReferenceTimeouts].
  ...
  const HubContentReferenceTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory HubContentReferenceTimeouts.fromMap(Map<String, dynamic> map) {
    return HubContentReferenceTimeouts(
