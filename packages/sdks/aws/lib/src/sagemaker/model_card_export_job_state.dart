...
class ModelCardExportJobState {
  ...
  factory ModelCardExportJobState.fromMap(Map<String, dynamic> map) {
    return ModelCardExportJobState(
      exportArtifacts: (() {
        final guardedValue = map['exportArtifacts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ModelCardExportJobExportArtifact>(
            guardedValue,
            (value) => ModelCardExportJobExportArtifact.fromMap(
      ...
      modelCardExportJobArn: (() {
        final guardedValue = map['modelCardExportJobArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      modelCardExportJobName: (() {
        final guardedValue = map['modelCardExportJobName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      modelCardName: (() {
        final guardedValue = map['modelCardName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      modelCardVersion: (() {
        final guardedValue = map['modelCardVersion'];
        if (guardedValue == null) return null;
      ...
      outputConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ModelCardExportJobOutputConfig.fromMap(
