...
class EndpointConfigurationProductionVariant {
  ...
  final pulumi.Input<EndpointConfigurationProductionVariantCoreDumpConfig>?
  coreDumpConfig;
  ...
  final pulumi.Input<List<EndpointConfigurationProductionVariantRoutingConfig>>?
  routingConfigs;

  /// How an endpoint performs asynchronous inference.
  final pulumi.Input<EndpointConfigurationProductionVariantServerlessConfig>?
  serverlessConfig;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'routingConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<EndpointConfigurationProductionVariantRoutingConfig>,
