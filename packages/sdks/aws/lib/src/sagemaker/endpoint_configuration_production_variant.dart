...
class EndpointConfigurationProductionVariant {
  ...
  factory EndpointConfigurationProductionVariant.fromMap(Map<String, dynamic> map) {
    return EndpointConfigurationProductionVariant(
      ...
      managedInstanceScaling: (() { final guardedValue = map['managedInstanceScaling']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointConfigurationProductionVariantManagedInstanceScaling.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      routingConfigs: (() { final guardedValue = map['routingConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EndpointConfigurationProductionVariantRoutingConfig>(guardedValue, (value) => EndpointConfigurationProductionVariantRoutingConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      serverlessConfig: (() { final guardedValue = map['serverlessConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EndpointConfigurationProductionVariantServerlessConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
