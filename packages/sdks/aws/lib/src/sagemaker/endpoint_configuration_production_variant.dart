...
class EndpointConfigurationProductionVariant {
  ...
  factory EndpointConfigurationProductionVariant.fromMap(Map<String, dynamic> map) {
    return EndpointConfigurationProductionVariant(
      ...
      coreDumpConfig: map['coreDumpConfig'] == null ? null : ((EndpointConfigurationProductionVariantCoreDumpConfig.fromMap((map['coreDumpConfig']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      managedInstanceScaling: map['managedInstanceScaling'] == null ? null : ((EndpointConfigurationProductionVariantManagedInstanceScaling.fromMap((map['managedInstanceScaling']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      routingConfigs: map['routingConfigs'] == null ? null : ((pulumi.Input.decodeList<EndpointConfigurationProductionVariantRoutingConfig>(map['routingConfigs']!, (value) => EndpointConfigurationProductionVariantRoutingConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      serverlessConfig: map['serverlessConfig'] == null ? null : ((EndpointConfigurationProductionVariantServerlessConfig.fromMap((map['serverlessConfig']! as Map).cast<String, dynamic>())).input()).input(),
