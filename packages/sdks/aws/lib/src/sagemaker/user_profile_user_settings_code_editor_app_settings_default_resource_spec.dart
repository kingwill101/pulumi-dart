...
class UserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec {
  ...
  const UserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec({
    this.instanceType,
  ...
  factory UserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec.fromMap(Map<String, dynamic> map) {
