...
class EndpointDeploymentConfigRollingUpdatePolicy {
  ...
  final pulumi.Input<EndpointDeploymentConfigRollingUpdatePolicyMaximumBatchSize> maximumBatchSize;
  ...
  final pulumi.Input<EndpointDeploymentConfigRollingUpdatePolicyRollbackMaximumBatchSize>? rollbackMaximumBatchSize;
  ...
  const EndpointDeploymentConfigRollingUpdatePolicy({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'maximumBatchSize': pulumi.Input.mapInputValue<EndpointDeploymentConfigRollingUpdatePolicyMaximumBatchSize, Map<String, dynamic>>(maximumBatchSize, (value) => value.toMap()),
      'maximumExecutionTimeoutInSeconds': ?maximumExecutionTimeoutInSeconds,
      'rollbackMaximumBatchSize': ?pulumi.Input.mapOptionalInputValue<EndpointDeploymentConfigRollingUpdatePolicyRollbackMaximumBatchSize, Map<String, dynamic>>(rollbackMaximumBatchSize, (value) => value.toMap()),
  ...
  factory EndpointDeploymentConfigRollingUpdatePolicy.fromMap(Map<String, dynamic> map) {
    return EndpointDeploymentConfigRollingUpdatePolicy(
      ...
      maximumExecutionTimeoutInSeconds: (() { final guardedValue = map['maximumExecutionTimeoutInSeconds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
