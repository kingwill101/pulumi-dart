...
class WorkteamWorkerAccessConfigurationS3Presign {
  ...
  final WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints? iamPolicyConstraints;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'iamPolicyConstraints': ?iamPolicyConstraints == null ? null : iamPolicyConstraints!.toMap(),
    };
  }
  ...
  factory WorkteamWorkerAccessConfigurationS3Presign.fromMap(Map<String, dynamic> map) {
    return WorkteamWorkerAccessConfigurationS3Presign(
      iamPolicyConstraints: map['iamPolicyConstraints'] == null ? null : WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints.fromMap((map['iamPolicyConstraints'] as Map).cast<String, dynamic>()),
    );
  }
}
