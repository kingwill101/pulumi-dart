...
class WorkteamWorkerAccessConfigurationS3Presign {
  ...
  WorkteamWorkerAccessConfigurationS3Presign({this.iamPolicyConstraints});
    ...
    return <String, dynamic>{
      'iamPolicyConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints,
            Map<String, dynamic>
          >(iamPolicyConstraints, (value) => value.toMap()),
    };
  }
  ...
  factory WorkteamWorkerAccessConfigurationS3Presign.fromMap(
    ...
    return WorkteamWorkerAccessConfigurationS3Presign(
      iamPolicyConstraints: (() {
        final guardedValue = map['iamPolicyConstraints'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints.fromMap(
