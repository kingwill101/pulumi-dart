...
class FeatureGroupOnlineStoreConfig {
  ...
  final pulumi.Input<FeatureGroupOnlineStoreConfigSecurityConfig>?
  securityConfig;
  ...
  factory FeatureGroupOnlineStoreConfig.fromMap(Map<String, dynamic> map) {
    return FeatureGroupOnlineStoreConfig(
      enableOnlineStore: (() {
        final guardedValue = map['enableOnlineStore'];
      ...
      ttlDuration: (() {
        final guardedValue = map['ttlDuration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
