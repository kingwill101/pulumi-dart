...
class FlowDefinitionState {
    ...
    return <String, dynamic>{
      ...
      'humanLoopActivationConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(humanLoopActivationConfig, (value) => value.toMap()),
      'humanLoopConfig':
          ?pulumi.Input.mapOptionalInputValue<
            FlowDefinitionHumanLoopConfig,
            Map<String, dynamic>
          >(humanLoopConfig, (value) => value.toMap()),
      'humanLoopRequestSource':
          ?pulumi.Input.mapOptionalInputValue<
            FlowDefinitionHumanLoopRequestSource,
            Map<String, dynamic>
          >(humanLoopRequestSource, (value) => value.toMap()),
      'outputConfig':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory FlowDefinitionState.fromMap(Map<String, dynamic> map) {
    return FlowDefinitionState(
      ...
      flowDefinitionName: (() {
        final guardedValue = map['flowDefinitionName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      humanLoopActivationConfig: (() {
        final guardedValue = map['humanLoopActivationConfig'];
        if (guardedValue == null) return null;
      ...
      humanLoopConfig: (() {
        final guardedValue = map['humanLoopConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowDefinitionHumanLoopConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      humanLoopRequestSource: (() {
        final guardedValue = map['humanLoopRequestSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowDefinitionHumanLoopRequestSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      outputConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FlowDefinitionOutputConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
