...
class UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings {
  ...
  /// Creates a new [UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings].
  ...
  const UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings({
  ...
  factory UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings.fromMap(Map<String, dynamic> map) {
    return UserProfileUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings(
      amazonForecastRoleArn: (() { final guardedValue = map['amazonForecastRoleArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
