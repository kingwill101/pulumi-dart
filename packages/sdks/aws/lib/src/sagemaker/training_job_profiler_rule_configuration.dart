...
class TrainingJobProfilerRuleConfiguration {
  ...
  factory TrainingJobProfilerRuleConfiguration.fromMap(Map<String, dynamic> map) {
    return TrainingJobProfilerRuleConfiguration(
