...
class FeatureGroupArgs {
    ...
    return <String, dynamic>{
      ...
      'offlineStoreConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(offlineStoreConfig, (value) => value.toMap()),
      'onlineStoreConfig':
          ?pulumi.Input.mapOptionalInputValue<
            FeatureGroupOnlineStoreConfig,
            Map<String, dynamic>
          >(onlineStoreConfig, (value) => value.toMap()),
      ...
      'throughputConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(throughputConfig, (value) => value.toMap()),
    };
  }
  ...
  factory FeatureGroupArgs.fromMap(Map<String, dynamic> map) {
    return FeatureGroupArgs(
      ...
      eventTimeFeatureName: pulumi.Input.fromValue(
        map['eventTimeFeatureName'] as String,
      ),
      featureDefinitions: pulumi.Input.fromValue(
      ...
      featureGroupName: pulumi.Input.fromValue(
        map['featureGroupName'] as String,
      ),
      offlineStoreConfig: (() {
        final guardedValue = map['offlineStoreConfig'];
        if (guardedValue == null) return null;
      ...
      onlineStoreConfig: (() {
        final guardedValue = map['onlineStoreConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      recordIdentifierFeatureName: pulumi.Input.fromValue(
        map['recordIdentifierFeatureName'] as String,
      ),
      region: (() {
      ...
      throughputConfig: (() {
        final guardedValue = map['throughputConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
