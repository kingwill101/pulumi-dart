...
class ModelPrimaryContainerMultiModelConfig {
  ...
  ModelPrimaryContainerMultiModelConfig({this.modelCacheSetting});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'modelCacheSetting': ?modelCacheSetting};
  }
  ...
  factory ModelPrimaryContainerMultiModelConfig.fromMap(
    ...
    return ModelPrimaryContainerMultiModelConfig(
      modelCacheSetting: (() {
        final guardedValue = map['modelCacheSetting'];
