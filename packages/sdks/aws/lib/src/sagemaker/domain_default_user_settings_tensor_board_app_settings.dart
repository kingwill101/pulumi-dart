...
class DomainDefaultUserSettingsTensorBoardAppSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultResourceSpec': ?pulumi.Input.mapOptionalInputValue<DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec, Map<String, dynamic>>(defaultResourceSpec, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDefaultUserSettingsTensorBoardAppSettings.fromMap(Map<String, dynamic> map) {
    return DomainDefaultUserSettingsTensorBoardAppSettings(
      defaultResourceSpec: (() { final guardedValue = map['defaultResourceSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDefaultUserSettingsTensorBoardAppSettingsDefaultResourceSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
