...
class ProjectServiceCatalogProvisioningDetails {
  ...
  factory ProjectServiceCatalogProvisioningDetails.fromMap(Map<String, dynamic> map) {
    return ProjectServiceCatalogProvisioningDetails(
      ...
      provisioningParameters: (() { final guardedValue = map['provisioningParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ProjectServiceCatalogProvisioningDetailsProvisioningParameter>(guardedValue, (value) => ProjectServiceCatalogProvisioningDetailsProvisioningParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
