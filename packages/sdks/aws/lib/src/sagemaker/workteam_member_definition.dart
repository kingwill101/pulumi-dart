...
class WorkteamMemberDefinition {
  ...
  final pulumi.Input<WorkteamMemberDefinitionCognitoMemberDefinition>?
  cognitoMemberDefinition;

  /// A list user groups that exist in your OIDC Identity Provider (IdP). One to ten groups can be used to create a single private work team. See Cognito Member Definition details below.
  final pulumi.Input<WorkteamMemberDefinitionOidcMemberDefinition>?
    ...
    return <String, dynamic>{
      'cognitoMemberDefinition':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(cognitoMemberDefinition, (value) => value.toMap()),
      'oidcMemberDefinition':
          ?pulumi.Input.mapOptionalInputValue<
            WorkteamMemberDefinitionOidcMemberDefinition,
            Map<String, dynamic>
          >(oidcMemberDefinition, (value) => value.toMap()),
    };
  }
  ...
  factory WorkteamMemberDefinition.fromMap(Map<String, dynamic> map) {
    return WorkteamMemberDefinition(
      cognitoMemberDefinition: (() {
        final guardedValue = map['cognitoMemberDefinition'];
      ...
      oidcMemberDefinition: (() {
        final guardedValue = map['oidcMemberDefinition'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
