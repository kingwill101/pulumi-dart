...
class WorkteamMemberDefinition {
  ...
  factory WorkteamMemberDefinition.fromMap(Map<String, dynamic> map) {
    return WorkteamMemberDefinition(
      cognitoMemberDefinition: (() { final guardedValue = map['cognitoMemberDefinition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkteamMemberDefinitionCognitoMemberDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      oidcMemberDefinition: (() { final guardedValue = map['oidcMemberDefinition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkteamMemberDefinitionOidcMemberDefinition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
