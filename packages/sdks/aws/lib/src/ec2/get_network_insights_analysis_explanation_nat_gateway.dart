...
class GetNetworkInsightsAnalysisExplanationNatGateway {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationNatGateway].
  ...
  const GetNetworkInsightsAnalysisExplanationNatGateway({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationNatGateway.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationNatGateway(
