...
class NetworkInsightsAccessScopeMatchPathSourcePacketHeaderStatement {
  ...
  /// Creates a new [NetworkInsightsAccessScopeMatchPathSourcePacketHeaderStatement].
  ...
  const NetworkInsightsAccessScopeMatchPathSourcePacketHeaderStatement({
  ...
  factory NetworkInsightsAccessScopeMatchPathSourcePacketHeaderStatement.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAccessScopeMatchPathSourcePacketHeaderStatement(
