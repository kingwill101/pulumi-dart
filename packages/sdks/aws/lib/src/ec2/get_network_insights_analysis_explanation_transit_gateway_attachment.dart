...
class GetNetworkInsightsAnalysisExplanationTransitGatewayAttachment {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationTransitGatewayAttachment].
  ...
  const GetNetworkInsightsAnalysisExplanationTransitGatewayAttachment({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationTransitGatewayAttachment.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationTransitGatewayAttachment(
