    ...
    return TrafficMirrorFilterRuleArgs(
      ...
      destinationPortRange: (() {
        ...
        return pulumi.Input.fromValue(
          TrafficMirrorFilterRuleDestinationPortRange.fromMap(
      ...
      sourcePortRange: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          TrafficMirrorFilterRuleSourcePortRange.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      trafficDirection: pulumi.Input.fromValue(
        map['trafficDirection'] as String,
      ),
