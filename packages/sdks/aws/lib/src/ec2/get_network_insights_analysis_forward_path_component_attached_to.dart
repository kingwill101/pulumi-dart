...
class GetNetworkInsightsAnalysisForwardPathComponentAttachedTo {
  ...
  const GetNetworkInsightsAnalysisForwardPathComponentAttachedTo({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentAttachedTo.fromMap(Map<String, dynamic> map) {
