...
class SpotFleetRequestArgs {
  ...
  SpotFleetRequestArgs({
    ...
    required pulumi.Output<String> iamFleetRole,
    ...
    required pulumi.Output<int> targetCapacity,
  ...
  factory SpotFleetRequestArgs.fromMap(Map<String, dynamic> map) {
    return SpotFleetRequestArgs(
      ...
      iamFleetRole: pulumi.Output.create<String>(map['iamFleetRole'] as String),
      ...
      targetCapacity: pulumi.Output.create<int>(map['targetCapacity'] as int),
