...
class SpotFleetRequestArgs {
  ...
  factory SpotFleetRequestArgs.fromMap(Map<String, dynamic> map) {
    return SpotFleetRequestArgs(
      ...
      iamFleetRole: (map['iamFleetRole'] as String).input(),
      instanceInterruptionBehaviour: map['instanceInterruptionBehaviour'] == null ? null : ((map['instanceInterruptionBehaviour'] as String).input()).input(),
      instancePoolsToUseCount: map['instancePoolsToUseCount'] == null ? null : ((map['instancePoolsToUseCount'] as int).input()).input(),
      launchSpecifications: map['launchSpecifications'] == null ? null : ((pulumi.Input.decodeList<SpotFleetRequestLaunchSpecification>(map['launchSpecifications']!, (value) => SpotFleetRequestLaunchSpecification.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      launchTemplateConfigs: map['launchTemplateConfigs'] == null ? null : ((pulumi.Input.decodeList<SpotFleetRequestLaunchTemplateConfig>(map['launchTemplateConfigs']!, (value) => SpotFleetRequestLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      onDemandMaxTotalPrice: map['onDemandMaxTotalPrice'] == null ? null : ((map['onDemandMaxTotalPrice'] as String).input()).input(),
      ...
      spotMaintenanceStrategies: map['spotMaintenanceStrategies'] == null ? null : ((SpotFleetRequestSpotMaintenanceStrategies.fromMap((map['spotMaintenanceStrategies']! as Map).cast<String, dynamic>())).input()).input(),
      spotPrice: map['spotPrice'] == null ? null : ((map['spotPrice'] as String).input()).input(),
      tags: map['tags'] == null ? null : (((map['tags'] as Map).cast<String, String>()).input()).input(),
      targetCapacity: (map['targetCapacity'] as int).input(),
      ...
      terminateInstancesOnDelete: map['terminateInstancesOnDelete'] == null ? null : ((map['terminateInstancesOnDelete'] as String).input()).input(),
