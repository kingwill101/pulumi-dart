    ...
    return <String, dynamic>{
      'alternatePathHints':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(alternatePathHints, (value) => value.toMap()),
      'arn': arn,
      'explanations':
          pulumi.Input.encodeList<
            GetNetworkInsightsAnalysisExplanation,
            Map<String, dynamic>
          >(explanations, (value) => value.toMap()),
      ...
      'forwardPathComponents':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(forwardPathComponents, (value) => value.toMap()),
      'id': id,
      ...
      'returnPathComponents':
          pulumi.Input.encodeList<
            ...
            Map<String, dynamic>
          >(returnPathComponents, (value) => value.toMap()),
      'startDate': startDate,
      'status': status,
  ...
  factory GetNetworkInsightsAnalysisResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisResult(
      ...
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetNetworkInsightsAnalysisFilter>(
          guardedValue,
