...
class VpcEncryptionControlTimeouts {
  ...
  VpcEncryptionControlTimeouts({this.create, this.delete, this.update});
  ...
  factory VpcEncryptionControlTimeouts.fromMap(Map<String, dynamic> map) {
    return VpcEncryptionControlTimeouts(
      create: (() {
