...
class GetLocalGatewayVirtualInterfaceArgs {
  ...
  factory GetLocalGatewayVirtualInterfaceArgs.fromMap(Map<String, dynamic> map) {
    return GetLocalGatewayVirtualInterfaceArgs(
      filters: map['filters'] == null ? null : ((pulumi.Input.decodeList<GetLocalGatewayVirtualInterfaceFilter>(map['filters']!, (value) => GetLocalGatewayVirtualInterfaceFilter.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
