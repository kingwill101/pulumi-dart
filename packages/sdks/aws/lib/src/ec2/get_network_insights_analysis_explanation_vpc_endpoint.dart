...
class GetNetworkInsightsAnalysisExplanationVpcEndpoint {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationVpcEndpoint].
  ...
  const GetNetworkInsightsAnalysisExplanationVpcEndpoint({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationVpcEndpoint.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationVpcEndpoint(
