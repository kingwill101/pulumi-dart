...
class LaunchTemplateState {
  ...
  LaunchTemplateState({
    ...
    pulumi.Output<int>? latestVersion,
    ...
    pulumi.Output<List<String>>? vpcSecurityGroupIds,
      ...
      latestVersion = pulumi.Input.asOptionalInput<int>(latestVersion),
  ...
  factory LaunchTemplateState.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateState(
      ...
      latestVersion: map['latestVersion'] == null ? null : pulumi.Output.create<int>(map['latestVersion'] as int),
