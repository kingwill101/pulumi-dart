...
class FleetLaunchTemplateConfigOverrideInstanceRequirements {
  ...
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount>? acceleratorCount;
  ...
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib>? acceleratorTotalMemoryMib;
  ...
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps>? baselineEbsBandwidthMbps;
  ...
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu>? memoryGibPerVcpu;
  /// The minimum and maximum amount of memory per vCPU, in GiB. Default is no minimum or maximum limits.
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib> memoryMib;
  /// The minimum and maximum amount of network bandwidth, in gigabits per second (Gbps). Default is No minimum or maximum.
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps>? networkBandwidthGbps;
  /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount>? networkInterfaceCount;
  ...
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb>? totalLocalStorageGb;
  /// Block describing the minimum and maximum number of vCPUs. Default is no maximum.
  final pulumi.Input<FleetLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount> vcpuCount;
  ...
  const FleetLaunchTemplateConfigOverrideInstanceRequirements({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'acceleratorCount': ?pulumi.Input.mapOptionalInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount, Map<String, dynamic>>(acceleratorCount, (value) => value.toMap()),
      'acceleratorManufacturers': ?acceleratorManufacturers,
      'acceleratorNames': ?acceleratorNames,
      'acceleratorTotalMemoryMib': ?pulumi.Input.mapOptionalInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib, Map<String, dynamic>>(acceleratorTotalMemoryMib, (value) => value.toMap()),
      'acceleratorTypes': ?acceleratorTypes,
      'allowedInstanceTypes': ?allowedInstanceTypes,
      'bareMetal': ?bareMetal,
      'baselineEbsBandwidthMbps': ?pulumi.Input.mapOptionalInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps, Map<String, dynamic>>(baselineEbsBandwidthMbps, (value) => value.toMap()),
      ...
      'memoryGibPerVcpu': ?pulumi.Input.mapOptionalInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu, Map<String, dynamic>>(memoryGibPerVcpu, (value) => value.toMap()),
      'memoryMib': pulumi.Input.mapInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib, Map<String, dynamic>>(memoryMib, (value) => value.toMap()),
      'networkBandwidthGbps': ?pulumi.Input.mapOptionalInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps, Map<String, dynamic>>(networkBandwidthGbps, (value) => value.toMap()),
      'networkInterfaceCount': ?pulumi.Input.mapOptionalInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount, Map<String, dynamic>>(networkInterfaceCount, (value) => value.toMap()),
      ...
      'totalLocalStorageGb': ?pulumi.Input.mapOptionalInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb, Map<String, dynamic>>(totalLocalStorageGb, (value) => value.toMap()),
      'vcpuCount': pulumi.Input.mapInputValue<FleetLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount, Map<String, dynamic>>(vcpuCount, (value) => value.toMap()),
    };
  }
  ...
  factory FleetLaunchTemplateConfigOverrideInstanceRequirements.fromMap(Map<String, dynamic> map) {
    return FleetLaunchTemplateConfigOverrideInstanceRequirements(
      acceleratorCount: (() { final guardedValue = map['acceleratorCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      acceleratorTotalMemoryMib: (() { final guardedValue = map['acceleratorTotalMemoryMib']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      baselineEbsBandwidthMbps: (() { final guardedValue = map['baselineEbsBandwidthMbps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      memoryGibPerVcpu: (() { final guardedValue = map['memoryGibPerVcpu']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      memoryMib: pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib.fromMap((map['memoryMib']! as Map).cast<String, dynamic>())),
      networkBandwidthGbps: (() { final guardedValue = map['networkBandwidthGbps']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      networkInterfaceCount: (() { final guardedValue = map['networkInterfaceCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      totalLocalStorageGb: (() { final guardedValue = map['totalLocalStorageGb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vcpuCount: pulumi.Input.fromValue(FleetLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount.fromMap((map['vcpuCount']! as Map).cast<String, dynamic>())),
    );
  }
}
