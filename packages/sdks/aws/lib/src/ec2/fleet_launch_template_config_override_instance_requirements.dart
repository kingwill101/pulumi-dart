...
class FleetLaunchTemplateConfigOverrideInstanceRequirements {
  ...
  factory FleetLaunchTemplateConfigOverrideInstanceRequirements.fromMap(Map<String, dynamic> map) {
    return FleetLaunchTemplateConfigOverrideInstanceRequirements(
      acceleratorCount: map['acceleratorCount'] == null ? null : (FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount.fromMap((map['acceleratorCount'] as Map).cast<String, dynamic>())).input(),
      ...
      acceleratorTotalMemoryMib: map['acceleratorTotalMemoryMib'] == null ? null : (FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib.fromMap((map['acceleratorTotalMemoryMib'] as Map).cast<String, dynamic>())).input(),
      ...
      baselineEbsBandwidthMbps: map['baselineEbsBandwidthMbps'] == null ? null : (FleetLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps.fromMap((map['baselineEbsBandwidthMbps'] as Map).cast<String, dynamic>())).input(),
      ...
      memoryGibPerVcpu: map['memoryGibPerVcpu'] == null ? null : (FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu.fromMap((map['memoryGibPerVcpu'] as Map).cast<String, dynamic>())).input(),
      ...
      networkBandwidthGbps: map['networkBandwidthGbps'] == null ? null : (FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps.fromMap((map['networkBandwidthGbps'] as Map).cast<String, dynamic>())).input(),
      networkInterfaceCount: map['networkInterfaceCount'] == null ? null : (FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount.fromMap((map['networkInterfaceCount'] as Map).cast<String, dynamic>())).input(),
      ...
      totalLocalStorageGb: map['totalLocalStorageGb'] == null ? null : (FleetLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb.fromMap((map['totalLocalStorageGb'] as Map).cast<String, dynamic>())).input(),
