...
class GetInstancesArgs {
  ...
  factory GetInstancesArgs.fromMap(Map<String, dynamic> map) {
    return GetInstancesArgs(
      ...
      instanceStateNames: (() { final guardedValue = map['instanceStateNames']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
