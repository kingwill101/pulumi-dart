...
class VpcEndpointState {
  ...
  factory VpcEndpointState.fromMap(Map<String, dynamic> map) {
    return VpcEndpointState(
      ...
      dnsEntries: map['dnsEntries'] == null ? null : ((pulumi.Input.decodeList<VpcEndpointDnsEntry>(map['dnsEntries']!, (value) => VpcEndpointDnsEntry.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      requesterManaged: map['requesterManaged'] == null ? null : ((map['requesterManaged'] as bool).input()).input(),
