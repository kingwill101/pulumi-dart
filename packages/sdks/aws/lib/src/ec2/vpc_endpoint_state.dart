...
class VpcEndpointState {
  ...
  final pulumi.Input<List<VpcEndpointSubnetConfiguration>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'subnetConfigurations':
          ?pulumi.Input.mapOptionalInputValue<
            List<VpcEndpointSubnetConfiguration>,
            List<Map<String, dynamic>>
          >(
            subnetConfigurations,
            (value) =>
    ...
    return VpcEndpointState(
      ...
      dnsEntries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpcEndpointDnsEntry>(
            guardedValue,
            (value) => VpcEndpointDnsEntry.fromMap(
      ...
      requesterManaged: (() {
        final guardedValue = map['requesterManaged'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ...
      subnetConfigurations: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VpcEndpointSubnetConfiguration>(
            guardedValue,
            (value) => VpcEndpointSubnetConfiguration.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
