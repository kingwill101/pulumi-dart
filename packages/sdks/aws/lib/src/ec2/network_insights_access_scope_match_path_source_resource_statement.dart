...
class NetworkInsightsAccessScopeMatchPathSourceResourceStatement {
  ...
  /// Creates a new [NetworkInsightsAccessScopeMatchPathSourceResourceStatement].
  /// [resourceTypes] List of resource types.
  /// [resources] List of resource ARNs.
  const NetworkInsightsAccessScopeMatchPathSourceResourceStatement({
    this.resourceTypes,
    this.resources,
  });
  ...
  factory NetworkInsightsAccessScopeMatchPathSourceResourceStatement.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAccessScopeMatchPathSourceResourceStatement(
