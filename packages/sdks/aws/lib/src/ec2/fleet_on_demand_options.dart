...
class FleetOnDemandOptions {
  ...
  final pulumi.Input<FleetOnDemandOptionsCapacityReservationOptions>? capacityReservationOptions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'capacityReservationOptions': ?pulumi.Input.mapOptionalInputValue<FleetOnDemandOptionsCapacityReservationOptions, Map<String, dynamic>>(capacityReservationOptions, (value) => value.toMap()),
