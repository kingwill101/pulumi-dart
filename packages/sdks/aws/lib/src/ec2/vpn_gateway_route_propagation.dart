...
import 'vpn_gateway_route_propagation_state.dart';
...
class VpnGatewayRoutePropagation extends pulumi.CustomResource {
  ...
  /// Gets an existing [VpnGatewayRoutePropagation] resource's state with the given [name] and [id].
  static VpnGatewayRoutePropagation get(
    String name,
  ...
  VpnGatewayRoutePropagation._get(
    String name, {
