...
class SecondarySubnetTimeouts {
  ...
  /// Creates a new [SecondarySubnetTimeouts].
  ...
  SecondarySubnetTimeouts({this.create, this.delete, this.update});
  ...
  factory SecondarySubnetTimeouts.fromMap(Map<String, dynamic> map) {
    return SecondarySubnetTimeouts(
      create: (() {
