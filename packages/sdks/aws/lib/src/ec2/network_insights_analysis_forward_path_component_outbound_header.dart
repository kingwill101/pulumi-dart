...
class NetworkInsightsAnalysisForwardPathComponentOutboundHeader {
  ...
  final pulumi.Input<List<NetworkInsightsAnalysisForwardPathComponentOutboundHeaderDestinationPortRange>>? destinationPortRanges;
  final pulumi.Input<String>? protocol;
  final pulumi.Input<List<String>>? sourceAddresses;
  final pulumi.Input<List<NetworkInsightsAnalysisForwardPathComponentOutboundHeaderSourcePortRange>>? sourcePortRanges;
  ...
  factory NetworkInsightsAnalysisForwardPathComponentOutboundHeader.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAnalysisForwardPathComponentOutboundHeader(
      ...
      destinationPortRanges: (() { final guardedValue = map['destinationPortRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentOutboundHeaderDestinationPortRange>(guardedValue, (value) => NetworkInsightsAnalysisForwardPathComponentOutboundHeaderDestinationPortRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      sourcePortRanges: (() { final guardedValue = map['sourcePortRanges']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentOutboundHeaderSourcePortRange>(guardedValue, (value) => NetworkInsightsAnalysisForwardPathComponentOutboundHeaderSourcePortRange.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
