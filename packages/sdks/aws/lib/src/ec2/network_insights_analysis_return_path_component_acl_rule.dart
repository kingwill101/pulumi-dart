...
class NetworkInsightsAnalysisReturnPathComponentAclRule {
  ...
  factory NetworkInsightsAnalysisReturnPathComponentAclRule.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAnalysisReturnPathComponentAclRule(
      ...
      portRanges: map['portRanges'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisReturnPathComponentAclRulePortRange>(map['portRanges']!, (value) => NetworkInsightsAnalysisReturnPathComponentAclRulePortRange.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
