...
class NetworkInsightsAnalysisReturnPathComponentAclRule {
  final String? cidr;
  final bool? egress;
  final List<NetworkInsightsAnalysisReturnPathComponentAclRulePortRange>? portRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cidr': ?cidr,
      'egress': ?egress,
      'portRanges': ?portRanges == null ? null : pulumi.Input.encodeList<NetworkInsightsAnalysisReturnPathComponentAclRulePortRange, Map<String, dynamic>>(portRanges!, (value) => value.toMap()),
      'protocol': ?protocol,
  ...
  factory NetworkInsightsAnalysisReturnPathComponentAclRule.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAnalysisReturnPathComponentAclRule(
      ...
      portRanges: map['portRanges'] == null ? null : pulumi.Input.decodeList<NetworkInsightsAnalysisReturnPathComponentAclRulePortRange>(map['portRanges'], (value) => NetworkInsightsAnalysisReturnPathComponentAclRulePortRange.fromMap((value as Map).cast<String, dynamic>())),
