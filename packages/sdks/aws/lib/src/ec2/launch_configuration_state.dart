...
class LaunchConfigurationState {
  ...
  factory LaunchConfigurationState.fromMap(Map<String, dynamic> map) {
    return LaunchConfigurationState(
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : ((pulumi.Input.decodeList<LaunchConfigurationEbsBlockDevice>(map['ebsBlockDevices']!, (value) => LaunchConfigurationEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ebsOptimized: map['ebsOptimized'] == null ? null : ((map['ebsOptimized'] as bool).input()).input(),
      enableMonitoring: map['enableMonitoring'] == null ? null : ((map['enableMonitoring'] as bool).input()).input(),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : ((pulumi.Input.decodeList<LaunchConfigurationEphemeralBlockDevice>(map['ephemeralBlockDevices']!, (value) => LaunchConfigurationEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      metadataOptions: map['metadataOptions'] == null ? null : ((LaunchConfigurationMetadataOptions.fromMap((map['metadataOptions']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      rootBlockDevice: map['rootBlockDevice'] == null ? null : ((LaunchConfigurationRootBlockDevice.fromMap((map['rootBlockDevice']! as Map).cast<String, dynamic>())).input()).input(),
