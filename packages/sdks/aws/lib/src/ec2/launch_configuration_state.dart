...
class LaunchConfigurationState {
  ...
  const LaunchConfigurationState({
    this.arn,
  ...
  factory LaunchConfigurationState.fromMap(Map<String, dynamic> map) {
    return LaunchConfigurationState(
      ...
      ebsBlockDevices: (() { final guardedValue = map['ebsBlockDevices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<LaunchConfigurationEbsBlockDevice>(guardedValue, (value) => LaunchConfigurationEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      metadataOptions: (() { final guardedValue = map['metadataOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LaunchConfigurationMetadataOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rootBlockDevice: (() { final guardedValue = map['rootBlockDevice']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LaunchConfigurationRootBlockDevice.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
