...
import 'security_group_association_state.dart';
...
class SecurityGroupAssociation extends pulumi.CustomResource {
  ...
  SecurityGroupAssociation(
    ...
    this.replaceDefaultAssociation = registerOutput<bool?>('replaceDefaultAssociation');
    this.securityGroupId = registerOutput<String>('securityGroupId');
    this.vpcEndpointId = registerOutput<String>('vpcEndpointId');
  }

  /// Gets an existing [SecurityGroupAssociation] resource's state with the given [name] and [id].
  static SecurityGroupAssociation get(
    String name,
