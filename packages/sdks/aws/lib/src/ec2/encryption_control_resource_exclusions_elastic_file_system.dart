...
class EncryptionControlResourceExclusionsElasticFileSystem {
  ...
  /// Creates a new [EncryptionControlResourceExclusionsElasticFileSystem].
  ...
  const EncryptionControlResourceExclusionsElasticFileSystem({
    required this.state,
  ...
  factory EncryptionControlResourceExclusionsElasticFileSystem.fromMap(Map<String, dynamic> map) {
