...
class GetTransitGatewayRouteTablesArgs {
  ...
  GetTransitGatewayRouteTablesArgs({
    pulumi.Output<List<GetTransitGatewayRouteTablesFilter>>? filters,
  ...
  factory GetTransitGatewayRouteTablesArgs.fromMap(Map<String, dynamic> map) {
    return GetTransitGatewayRouteTablesArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetTransitGatewayRouteTablesFilter>>(pulumi.Input.decodeList<GetTransitGatewayRouteTablesFilter>(map['filters'], (value) => GetTransitGatewayRouteTablesFilter.fromMap((value as Map).cast<String, dynamic>()))),
