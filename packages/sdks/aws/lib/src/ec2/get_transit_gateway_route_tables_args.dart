...
class GetTransitGatewayRouteTablesArgs {
  ...
  const GetTransitGatewayRouteTablesArgs({
    this.filters,
    this.region,
    this.tags,
  });
  ...
  factory GetTransitGatewayRouteTablesArgs.fromMap(Map<String, dynamic> map) {
    return GetTransitGatewayRouteTablesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetTransitGatewayRouteTablesFilter>(guardedValue, (value) => GetTransitGatewayRouteTablesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
