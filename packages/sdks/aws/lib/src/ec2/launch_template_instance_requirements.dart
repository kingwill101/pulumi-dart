...
class LaunchTemplateInstanceRequirements {
  ...
  final pulumi.Input<LaunchTemplateInstanceRequirementsAcceleratorCount>?
  acceleratorCount;
  ...
  final pulumi.Input<LaunchTemplateInstanceRequirementsMemoryGibPerVcpu>?
  memoryGibPerVcpu;
  ...
  final pulumi.Input<LaunchTemplateInstanceRequirementsNetworkBandwidthGbps>?
  networkBandwidthGbps;

  /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
  final pulumi.Input<LaunchTemplateInstanceRequirementsNetworkInterfaceCount>?
  ...
  final pulumi.Input<LaunchTemplateInstanceRequirementsTotalLocalStorageGb>?
  totalLocalStorageGb;
  ...
  factory LaunchTemplateInstanceRequirements.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateInstanceRequirements(
      ...
      memoryMib: pulumi.Input.fromValue(
        LaunchTemplateInstanceRequirementsMemoryMib.fromMap(
      ...
      vcpuCount: pulumi.Input.fromValue(
        LaunchTemplateInstanceRequirementsVcpuCount.fromMap(
