...
class VolumeAttachmentState {
  ...
  factory VolumeAttachmentState.fromMap(Map<String, dynamic> map) {
    return VolumeAttachmentState(
      ...
      forceDetach: (() { final guardedValue = map['forceDetach']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      stopInstanceBeforeDetaching: (() { final guardedValue = map['stopInstanceBeforeDetaching']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
