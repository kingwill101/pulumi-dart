...
class GetNetworkInsightsAnalysisExplanationSourceVpc {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationSourceVpc].
  ...
  const GetNetworkInsightsAnalysisExplanationSourceVpc({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationSourceVpc.fromMap(Map<String, dynamic> map) {
