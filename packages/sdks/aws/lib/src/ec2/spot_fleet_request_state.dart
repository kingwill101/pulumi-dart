...
class SpotFleetRequestState {
  ...
  final pulumi.Input<List<SpotFleetRequestLaunchSpecification>>? launchSpecifications;
  /// Launch template configuration block. See Launch Template Configs below for more details. Conflicts with `launch_specification`. At least one of `launch_specification` or `launch_template_config` is required.
  final pulumi.Input<List<SpotFleetRequestLaunchTemplateConfig>>? launchTemplateConfigs;
  ...
  final pulumi.Input<SpotFleetRequestSpotMaintenanceStrategies>? spotMaintenanceStrategies;
  ...
  SpotFleetRequestState({
    ...
    pulumi.Output<String>? iamFleetRole,
    pulumi.Output<String>? instanceInterruptionBehaviour,
    pulumi.Output<int>? instancePoolsToUseCount,
    pulumi.Output<List<SpotFleetRequestLaunchSpecification>>? launchSpecifications,
    pulumi.Output<List<SpotFleetRequestLaunchTemplateConfig>>? launchTemplateConfigs,
    pulumi.Output<List<String>>? loadBalancers,
    pulumi.Output<String>? onDemandAllocationStrategy,
    pulumi.Output<String>? onDemandMaxTotalPrice,
    pulumi.Output<int>? onDemandTargetCapacity,
    pulumi.Output<String>? region,
    pulumi.Output<bool>? replaceUnhealthyInstances,
    pulumi.Output<SpotFleetRequestSpotMaintenanceStrategies>? spotMaintenanceStrategies,
    pulumi.Output<String>? spotPrice,
    pulumi.Output<String>? spotRequestState,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<Map<String, String>>? tagsAll,
    pulumi.Output<int>? targetCapacity,
    pulumi.Output<String>? targetCapacityUnitType,
    pulumi.Output<List<String>>? targetGroupArns,
    pulumi.Output<String>? terminateInstancesOnDelete,
    ...
    pulumi.Output<bool>? waitForFulfillment,
      ...
      iamFleetRole = pulumi.Input.asOptionalInput<String>(iamFleetRole),
      instanceInterruptionBehaviour = pulumi.Input.asOptionalInput<String>(instanceInterruptionBehaviour),
      instancePoolsToUseCount = pulumi.Input.asOptionalInput<int>(instancePoolsToUseCount),
      launchSpecifications = pulumi.Input.asOptionalInput<List<SpotFleetRequestLaunchSpecification>>(launchSpecifications),
      launchTemplateConfigs = pulumi.Input.asOptionalInput<List<SpotFleetRequestLaunchTemplateConfig>>(launchTemplateConfigs),
      loadBalancers = pulumi.Input.asOptionalInput<List<String>>(loadBalancers),
      onDemandAllocationStrategy = pulumi.Input.asOptionalInput<String>(onDemandAllocationStrategy),
      onDemandMaxTotalPrice = pulumi.Input.asOptionalInput<String>(onDemandMaxTotalPrice),
      onDemandTargetCapacity = pulumi.Input.asOptionalInput<int>(onDemandTargetCapacity),
      region = pulumi.Input.asOptionalInput<String>(region),
      replaceUnhealthyInstances = pulumi.Input.asOptionalInput<bool>(replaceUnhealthyInstances),
      spotMaintenanceStrategies = pulumi.Input.asOptionalInput<SpotFleetRequestSpotMaintenanceStrategies>(spotMaintenanceStrategies),
      ...
      targetCapacity = pulumi.Input.asOptionalInput<int>(targetCapacity),
      targetCapacityUnitType = pulumi.Input.asOptionalInput<String>(targetCapacityUnitType),
      targetGroupArns = pulumi.Input.asOptionalInput<List<String>>(targetGroupArns),
      terminateInstancesOnDelete = pulumi.Input.asOptionalInput<String>(terminateInstancesOnDelete),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'launchSpecifications': ?pulumi.Input.mapOptionalInputValue<List<SpotFleetRequestLaunchSpecification>, List<Map<String, dynamic>>>(launchSpecifications, (value) => pulumi.Input.encodeList<SpotFleetRequestLaunchSpecification, Map<String, dynamic>>(value, (value) => value.toMap())),
      'launchTemplateConfigs': ?pulumi.Input.mapOptionalInputValue<List<SpotFleetRequestLaunchTemplateConfig>, List<Map<String, dynamic>>>(launchTemplateConfigs, (value) => pulumi.Input.encodeList<SpotFleetRequestLaunchTemplateConfig, Map<String, dynamic>>(value, (value) => value.toMap())),
      ...
      'spotMaintenanceStrategies': ?pulumi.Input.mapOptionalInputValue<SpotFleetRequestSpotMaintenanceStrategies, Map<String, dynamic>>(spotMaintenanceStrategies, (value) => value.toMap()),
      'spotPrice': ?spotPrice,
  ...
  factory SpotFleetRequestState.fromMap(Map<String, dynamic> map) {
    return SpotFleetRequestState(
      ...
      iamFleetRole: map['iamFleetRole'] == null ? null : pulumi.Output.create<String>(map['iamFleetRole'] as String),
      instanceInterruptionBehaviour: map['instanceInterruptionBehaviour'] == null ? null : pulumi.Output.create<String>(map['instanceInterruptionBehaviour'] as String),
      instancePoolsToUseCount: map['instancePoolsToUseCount'] == null ? null : pulumi.Output.create<int>(map['instancePoolsToUseCount'] as int),
      launchSpecifications: map['launchSpecifications'] == null ? null : pulumi.Output.create<List<SpotFleetRequestLaunchSpecification>>(pulumi.Input.decodeList<SpotFleetRequestLaunchSpecification>(map['launchSpecifications'], (value) => SpotFleetRequestLaunchSpecification.fromMap((value as Map).cast<String, dynamic>()))),
      launchTemplateConfigs: map['launchTemplateConfigs'] == null ? null : pulumi.Output.create<List<SpotFleetRequestLaunchTemplateConfig>>(pulumi.Input.decodeList<SpotFleetRequestLaunchTemplateConfig>(map['launchTemplateConfigs'], (value) => SpotFleetRequestLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))),
      loadBalancers: map['loadBalancers'] == null ? null : pulumi.Output.create<List<String>>((map['loadBalancers'] as List).cast<String>()),
      onDemandAllocationStrategy: map['onDemandAllocationStrategy'] == null ? null : pulumi.Output.create<String>(map['onDemandAllocationStrategy'] as String),
      onDemandMaxTotalPrice: map['onDemandMaxTotalPrice'] == null ? null : pulumi.Output.create<String>(map['onDemandMaxTotalPrice'] as String),
      onDemandTargetCapacity: map['onDemandTargetCapacity'] == null ? null : pulumi.Output.create<int>(map['onDemandTargetCapacity'] as int),
      ...
      spotMaintenanceStrategies: map['spotMaintenanceStrategies'] == null ? null : pulumi.Output.create<SpotFleetRequestSpotMaintenanceStrategies>(SpotFleetRequestSpotMaintenanceStrategies.fromMap((map['spotMaintenanceStrategies'] as Map).cast<String, dynamic>())),
      ...
      targetCapacity: map['targetCapacity'] == null ? null : pulumi.Output.create<int>(map['targetCapacity'] as int),
      targetCapacityUnitType: map['targetCapacityUnitType'] == null ? null : pulumi.Output.create<String>(map['targetCapacityUnitType'] as String),
      targetGroupArns: map['targetGroupArns'] == null ? null : pulumi.Output.create<List<String>>((map['targetGroupArns'] as List).cast<String>()),
      terminateInstancesOnDelete: map['terminateInstancesOnDelete'] == null ? null : pulumi.Output.create<String>(map['terminateInstancesOnDelete'] as String),
