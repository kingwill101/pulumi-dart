...
class GetNetworkInsightsAnalysisReturnPathComponentSourceVpc {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisReturnPathComponentSourceVpc].
  ...
  const GetNetworkInsightsAnalysisReturnPathComponentSourceVpc({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponentSourceVpc.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisReturnPathComponentSourceVpc(
