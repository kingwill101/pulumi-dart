...
class GetVpnConnectionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?filters == null ? null : pulumi.Input.encodeList<GetVpnConnectionFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
      ...
      'type': type,
      'vgwTelemetries': pulumi.Input.encodeList<GetVpnConnectionVgwTelemetry, Map<String, dynamic>>(vgwTelemetries, (value) => value.toMap()),
  ...
  factory GetVpnConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetVpnConnectionResult(
      ...
      vgwTelemetries: pulumi.Input.decodeList<GetVpnConnectionVgwTelemetry>(map['vgwTelemetries'], (value) => GetVpnConnectionVgwTelemetry.fromMap((value as Map).cast<String, dynamic>())),
