...
class AmiCopyState {
  ...
  factory AmiCopyState.fromMap(Map<String, dynamic> map) {
    return AmiCopyState(
      ...
      manageEbsSnapshots: map['manageEbsSnapshots'] == null ? null : (map['manageEbsSnapshots'] as bool).input(),
      ...
      rootSnapshotId: map['rootSnapshotId'] == null ? null : (map['rootSnapshotId'] as String).input(),
      sourceAmiId: map['sourceAmiId'] == null ? null : (map['sourceAmiId'] as String).input(),
      sourceAmiRegion: map['sourceAmiRegion'] == null ? null : (map['sourceAmiRegion'] as String).input(),
