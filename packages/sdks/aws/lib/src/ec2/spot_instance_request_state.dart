...
class SpotInstanceRequestState {
  ...
  factory SpotInstanceRequestState.fromMap(Map<String, dynamic> map) {
    return SpotInstanceRequestState(
      ami: map['ami'] == null ? null : (map['ami'] as String).input(),
      ...
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : (SpotInstanceRequestCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>())).input(),
      cpuOptions: map['cpuOptions'] == null ? null : (SpotInstanceRequestCpuOptions.fromMap((map['cpuOptions'] as Map).cast<String, dynamic>())).input(),
      creditSpecification: map['creditSpecification'] == null ? null : (SpotInstanceRequestCreditSpecification.fromMap((map['creditSpecification'] as Map).cast<String, dynamic>())).input(),
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : (pulumi.Input.decodeList<SpotInstanceRequestEbsBlockDevice>(map['ebsBlockDevices'], (value) => SpotInstanceRequestEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      enclaveOptions: map['enclaveOptions'] == null ? null : (SpotInstanceRequestEnclaveOptions.fromMap((map['enclaveOptions'] as Map).cast<String, dynamic>())).input(),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : (pulumi.Input.decodeList<SpotInstanceRequestEphemeralBlockDevice>(map['ephemeralBlockDevices'], (value) => SpotInstanceRequestEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input(),
      forceDestroy: map['forceDestroy'] == null ? null : (map['forceDestroy'] as bool).input(),
      getPasswordData: map['getPasswordData'] == null ? null : (map['getPasswordData'] as bool).input(),
      hibernation: map['hibernation'] == null ? null : (map['hibernation'] as bool).input(),
      ...
      instanceState: map['instanceState'] == null ? null : (map['instanceState'] as String).input(),
      ...
      launchGroup: map['launchGroup'] == null ? null : (map['launchGroup'] as String).input(),
      launchTemplate: map['launchTemplate'] == null ? null : (SpotInstanceRequestLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>())).input(),
      maintenanceOptions: map['maintenanceOptions'] == null ? null : (SpotInstanceRequestMaintenanceOptions.fromMap((map['maintenanceOptions'] as Map).cast<String, dynamic>())).input(),
      metadataOptions: map['metadataOptions'] == null ? null : (SpotInstanceRequestMetadataOptions.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>())).input(),
      monitoring: map['monitoring'] == null ? null : (map['monitoring'] as bool).input(),
      networkInterfaces: map['networkInterfaces'] == null ? null : (pulumi.Input.decodeList<SpotInstanceRequestNetworkInterface>(map['networkInterfaces'], (value) => SpotInstanceRequestNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
      outpostArn: map['outpostArn'] == null ? null : (map['outpostArn'] as String).input(),
      passwordData: map['passwordData'] == null ? null : (map['passwordData'] as String).input(),
      ...
      placementPartitionNumber: map['placementPartitionNumber'] == null ? null : (map['placementPartitionNumber'] as int).input(),
      primaryNetworkInterfaceId: map['primaryNetworkInterfaceId'] == null ? null : (map['primaryNetworkInterfaceId'] as String).input(),
      primaryNetworkInterfaces: map['primaryNetworkInterfaces'] == null ? null : (pulumi.Input.decodeList<SpotInstanceRequestPrimaryNetworkInterface>(map['primaryNetworkInterfaces'], (value) => SpotInstanceRequestPrimaryNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
      privateDns: map['privateDns'] == null ? null : (map['privateDns'] as String).input(),
      privateDnsNameOptions: map['privateDnsNameOptions'] == null ? null : (SpotInstanceRequestPrivateDnsNameOptions.fromMap((map['privateDnsNameOptions'] as Map).cast<String, dynamic>())).input(),
      privateIp: map['privateIp'] == null ? null : (map['privateIp'] as String).input(),
      publicDns: map['publicDns'] == null ? null : (map['publicDns'] as String).input(),
      publicIp: map['publicIp'] == null ? null : (map['publicIp'] as String).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      rootBlockDevice: map['rootBlockDevice'] == null ? null : (SpotInstanceRequestRootBlockDevice.fromMap((map['rootBlockDevice'] as Map).cast<String, dynamic>())).input(),
      secondaryNetworkInterfaces: map['secondaryNetworkInterfaces'] == null ? null : (pulumi.Input.decodeList<SpotInstanceRequestSecondaryNetworkInterface>(map['secondaryNetworkInterfaces'], (value) => SpotInstanceRequestSecondaryNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      spotBidStatus: map['spotBidStatus'] == null ? null : (map['spotBidStatus'] as String).input(),
      spotInstanceId: map['spotInstanceId'] == null ? null : (map['spotInstanceId'] as String).input(),
      spotPrice: map['spotPrice'] == null ? null : (map['spotPrice'] as String).input(),
      spotRequestState: map['spotRequestState'] == null ? null : (map['spotRequestState'] as String).input(),
      spotType: map['spotType'] == null ? null : (map['spotType'] as String).input(),
      ...
      userDataReplaceOnChange: map['userDataReplaceOnChange'] == null ? null : (map['userDataReplaceOnChange'] as bool).input(),
      ...
      waitForFulfillment: map['waitForFulfillment'] == null ? null : (map['waitForFulfillment'] as bool).input(),
    );
  }
}
