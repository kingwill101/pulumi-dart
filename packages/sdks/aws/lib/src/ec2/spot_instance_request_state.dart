...
class SpotInstanceRequestState {
  ...
  factory SpotInstanceRequestState.fromMap(Map<String, dynamic> map) {
    return SpotInstanceRequestState(
      ami: map['ami'] == null ? null : ((map['ami'] as String).input()).input(),
      ...
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : ((SpotInstanceRequestCapacityReservationSpecification.fromMap((map['capacityReservationSpecification']! as Map).cast<String, dynamic>())).input()).input(),
      cpuOptions: map['cpuOptions'] == null ? null : ((SpotInstanceRequestCpuOptions.fromMap((map['cpuOptions']! as Map).cast<String, dynamic>())).input()).input(),
      creditSpecification: map['creditSpecification'] == null ? null : ((SpotInstanceRequestCreditSpecification.fromMap((map['creditSpecification']! as Map).cast<String, dynamic>())).input()).input(),
      disableApiStop: map['disableApiStop'] == null ? null : ((map['disableApiStop'] as bool).input()).input(),
      disableApiTermination: map['disableApiTermination'] == null ? null : ((map['disableApiTermination'] as bool).input()).input(),
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : ((pulumi.Input.decodeList<SpotInstanceRequestEbsBlockDevice>(map['ebsBlockDevices']!, (value) => SpotInstanceRequestEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ebsOptimized: map['ebsOptimized'] == null ? null : ((map['ebsOptimized'] as bool).input()).input(),
      enablePrimaryIpv6: map['enablePrimaryIpv6'] == null ? null : ((map['enablePrimaryIpv6'] as bool).input()).input(),
      enclaveOptions: map['enclaveOptions'] == null ? null : ((SpotInstanceRequestEnclaveOptions.fromMap((map['enclaveOptions']! as Map).cast<String, dynamic>())).input()).input(),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : ((pulumi.Input.decodeList<SpotInstanceRequestEphemeralBlockDevice>(map['ephemeralBlockDevices']!, (value) => SpotInstanceRequestEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      hibernation: map['hibernation'] == null ? null : ((map['hibernation'] as bool).input()).input(),
      ...
      instanceInitiatedShutdownBehavior: map['instanceInitiatedShutdownBehavior'] == null ? null : ((map['instanceInitiatedShutdownBehavior'] as String).input()).input(),
      ...
      instanceState: map['instanceState'] == null ? null : ((map['instanceState'] as String).input()).input(),
      ...
      launchGroup: map['launchGroup'] == null ? null : ((map['launchGroup'] as String).input()).input(),
      launchTemplate: map['launchTemplate'] == null ? null : ((SpotInstanceRequestLaunchTemplate.fromMap((map['launchTemplate']! as Map).cast<String, dynamic>())).input()).input(),
      maintenanceOptions: map['maintenanceOptions'] == null ? null : ((SpotInstanceRequestMaintenanceOptions.fromMap((map['maintenanceOptions']! as Map).cast<String, dynamic>())).input()).input(),
      metadataOptions: map['metadataOptions'] == null ? null : ((SpotInstanceRequestMetadataOptions.fromMap((map['metadataOptions']! as Map).cast<String, dynamic>())).input()).input(),
      monitoring: map['monitoring'] == null ? null : ((map['monitoring'] as bool).input()).input(),
      networkInterfaces: map['networkInterfaces'] == null ? null : ((pulumi.Input.decodeList<SpotInstanceRequestNetworkInterface>(map['networkInterfaces']!, (value) => SpotInstanceRequestNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      outpostArn: map['outpostArn'] == null ? null : ((map['outpostArn'] as String).input()).input(),
      passwordData: map['passwordData'] == null ? null : ((map['passwordData'] as String).input()).input(),
      ...
      placementPartitionNumber: map['placementPartitionNumber'] == null ? null : ((map['placementPartitionNumber'] as int).input()).input(),
      primaryNetworkInterfaceId: map['primaryNetworkInterfaceId'] == null ? null : ((map['primaryNetworkInterfaceId'] as String).input()).input(),
      primaryNetworkInterfaces: map['primaryNetworkInterfaces'] == null ? null : ((pulumi.Input.decodeList<SpotInstanceRequestPrimaryNetworkInterface>(map['primaryNetworkInterfaces']!, (value) => SpotInstanceRequestPrimaryNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      privateDns: map['privateDns'] == null ? null : ((map['privateDns'] as String).input()).input(),
      privateDnsNameOptions: map['privateDnsNameOptions'] == null ? null : ((SpotInstanceRequestPrivateDnsNameOptions.fromMap((map['privateDnsNameOptions']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      rootBlockDevice: map['rootBlockDevice'] == null ? null : ((SpotInstanceRequestRootBlockDevice.fromMap((map['rootBlockDevice']! as Map).cast<String, dynamic>())).input()).input(),
      secondaryNetworkInterfaces: map['secondaryNetworkInterfaces'] == null ? null : ((pulumi.Input.decodeList<SpotInstanceRequestSecondaryNetworkInterface>(map['secondaryNetworkInterfaces']!, (value) => SpotInstanceRequestSecondaryNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      secondaryPrivateIps: map['secondaryPrivateIps'] == null ? null : (((map['secondaryPrivateIps'] as List).cast<String>()).input()).input(),
      ...
      spotBidStatus: map['spotBidStatus'] == null ? null : ((map['spotBidStatus'] as String).input()).input(),
      spotInstanceId: map['spotInstanceId'] == null ? null : ((map['spotInstanceId'] as String).input()).input(),
      spotPrice: map['spotPrice'] == null ? null : ((map['spotPrice'] as String).input()).input(),
      spotRequestState: map['spotRequestState'] == null ? null : ((map['spotRequestState'] as String).input()).input(),
      spotType: map['spotType'] == null ? null : ((map['spotType'] as String).input()).input(),
      ...
      userDataReplaceOnChange: map['userDataReplaceOnChange'] == null ? null : ((map['userDataReplaceOnChange'] as bool).input()).input(),
      ...
      volumeTags: map['volumeTags'] == null ? null : (((map['volumeTags'] as Map).cast<String, String>()).input()).input(),
      vpcSecurityGroupIds: map['vpcSecurityGroupIds'] == null ? null : (((map['vpcSecurityGroupIds'] as List).cast<String>()).input()).input(),
      waitForFulfillment: map['waitForFulfillment'] == null ? null : ((map['waitForFulfillment'] as bool).input()).input(),
    );
  }
}
