...
class SpotInstanceRequestState {
  ...
  final pulumi.Input<List<SpotInstanceRequestPrimaryNetworkInterface>>?
  ...
  factory SpotInstanceRequestState.fromMap(Map<String, dynamic> map) {
    return SpotInstanceRequestState(
      ...
      primaryNetworkInterfaces: (() {
        final guardedValue = map['primaryNetworkInterfaces'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<SpotInstanceRequestPrimaryNetworkInterface>(
            guardedValue,
            (value) => SpotInstanceRequestPrimaryNetworkInterface.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      spotBidStatus: (() {
        final guardedValue = map['spotBidStatus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      spotInstanceId: (() {
        final guardedValue = map['spotInstanceId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      spotPrice: (() {
