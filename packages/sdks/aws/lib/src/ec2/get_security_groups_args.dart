...
class GetSecurityGroupsArgs {
  ...
  GetSecurityGroupsArgs({
    pulumi.Output<List<GetSecurityGroupsFilter>>? filters,
    pulumi.Output<String>? region,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      filters = pulumi.Input.asOptionalInput<List<GetSecurityGroupsFilter>>(filters),
  ...
  factory GetSecurityGroupsArgs.fromMap(Map<String, dynamic> map) {
    return GetSecurityGroupsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetSecurityGroupsFilter>>(pulumi.Input.decodeList<GetSecurityGroupsFilter>(map['filters'], (value) => GetSecurityGroupsFilter.fromMap((value as Map).cast<String, dynamic>()))),
