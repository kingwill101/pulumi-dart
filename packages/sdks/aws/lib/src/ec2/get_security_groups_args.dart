...
class GetSecurityGroupsArgs {
  ...
  factory GetSecurityGroupsArgs.fromMap(Map<String, dynamic> map) {
    return GetSecurityGroupsArgs(
      filters: map['filters'] == null ? null : (pulumi.Input.decodeList<GetSecurityGroupsFilter>(map['filters'], (value) => GetSecurityGroupsFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
