...
import 'instance_metadata_defaults_state.dart';
...
class InstanceMetadataDefaults extends pulumi.CustomResource {
  ...
  /// Gets an existing [InstanceMetadataDefaults] resource's state with the given [name] and [id].
  static InstanceMetadataDefaults get(
    String name,
