...
class NetworkInsightsAnalysisForwardPathComponent {
  ...
  factory NetworkInsightsAnalysisForwardPathComponent.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAnalysisForwardPathComponent(
      aclRules: map['aclRules'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentAclRule>(map['aclRules']!, (value) => NetworkInsightsAnalysisForwardPathComponentAclRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      additionalDetails: map['additionalDetails'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentAdditionalDetail>(map['additionalDetails']!, (value) => NetworkInsightsAnalysisForwardPathComponentAdditionalDetail.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      attachedTos: map['attachedTos'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentAttachedTo>(map['attachedTos']!, (value) => NetworkInsightsAnalysisForwardPathComponentAttachedTo.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      components: map['components'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentComponent>(map['components']!, (value) => NetworkInsightsAnalysisForwardPathComponentComponent.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      destinationVpcs: map['destinationVpcs'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentDestinationVpc>(map['destinationVpcs']!, (value) => NetworkInsightsAnalysisForwardPathComponentDestinationVpc.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      inboundHeaders: map['inboundHeaders'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentInboundHeader>(map['inboundHeaders']!, (value) => NetworkInsightsAnalysisForwardPathComponentInboundHeader.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      outboundHeaders: map['outboundHeaders'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentOutboundHeader>(map['outboundHeaders']!, (value) => NetworkInsightsAnalysisForwardPathComponentOutboundHeader.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      routeTableRoutes: map['routeTableRoutes'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentRouteTableRoute>(map['routeTableRoutes']!, (value) => NetworkInsightsAnalysisForwardPathComponentRouteTableRoute.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      securityGroupRules: map['securityGroupRules'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentSecurityGroupRule>(map['securityGroupRules']!, (value) => NetworkInsightsAnalysisForwardPathComponentSecurityGroupRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      sequenceNumber: map['sequenceNumber'] == null ? null : ((map['sequenceNumber'] as int).input()).input(),
      sourceVpcs: map['sourceVpcs'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentSourceVpc>(map['sourceVpcs']!, (value) => NetworkInsightsAnalysisForwardPathComponentSourceVpc.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      subnets: map['subnets'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentSubnet>(map['subnets']!, (value) => NetworkInsightsAnalysisForwardPathComponentSubnet.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      transitGatewayRouteTableRoutes: map['transitGatewayRouteTableRoutes'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentTransitGatewayRouteTableRoute>(map['transitGatewayRouteTableRoutes']!, (value) => NetworkInsightsAnalysisForwardPathComponentTransitGatewayRouteTableRoute.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      transitGateways: map['transitGateways'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentTransitGateway>(map['transitGateways']!, (value) => NetworkInsightsAnalysisForwardPathComponentTransitGateway.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      vpcs: map['vpcs'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponentVpc>(map['vpcs']!, (value) => NetworkInsightsAnalysisForwardPathComponentVpc.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
