...
class NetworkInsightsAnalysisForwardPathComponent {
  final pulumi.Input<List<NetworkInsightsAnalysisForwardPathComponentAclRule>>?
  aclRules;
  final pulumi.Input<
  ...
  >?
  sourceVpcs;
  final pulumi.Input<List<NetworkInsightsAnalysisForwardPathComponentSubnet>>?
  subnets;
  final pulumi.Input<
    List<
  ...
  >?
  transitGateways;
  final pulumi.Input<List<NetworkInsightsAnalysisForwardPathComponentVpc>>?
  vpcs;
