...
class SpotFleetRequest extends pulumi.CustomResource {
  ...
  SpotFleetRequest(
    ...
    instanceInterruptionBehaviour = registerOutput<String?>(
      'instanceInterruptionBehaviour',
    );
    instancePoolsToUseCount = registerOutput<int?>('instancePoolsToUseCount');
    launchSpecifications = registerOutput<List<Map<String, dynamic>>?>(
      'launchSpecifications',
    );
    ...
    onDemandAllocationStrategy = registerOutput<String?>(
    ...
    terminateInstancesOnDelete = registerOutput<String?>(
