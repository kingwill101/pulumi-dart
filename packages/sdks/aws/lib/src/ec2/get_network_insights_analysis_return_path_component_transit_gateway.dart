...
class GetNetworkInsightsAnalysisReturnPathComponentTransitGateway {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisReturnPathComponentTransitGateway].
  ...
  const GetNetworkInsightsAnalysisReturnPathComponentTransitGateway({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponentTransitGateway.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisReturnPathComponentTransitGateway(
