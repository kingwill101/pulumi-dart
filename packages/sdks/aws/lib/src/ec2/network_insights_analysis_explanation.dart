...
class NetworkInsightsAnalysisExplanation {
  ...
  factory NetworkInsightsAnalysisExplanation.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAnalysisExplanation(
      aclRules: map['aclRules'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationAclRule>(map['aclRules']!, (value) => NetworkInsightsAnalysisExplanationAclRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      acls: map['acls'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationAcl>(map['acls']!, (value) => NetworkInsightsAnalysisExplanationAcl.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      attachedTos: map['attachedTos'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationAttachedTo>(map['attachedTos']!, (value) => NetworkInsightsAnalysisExplanationAttachedTo.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      components: map['components'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationComponent>(map['components']!, (value) => NetworkInsightsAnalysisExplanationComponent.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      customerGateways: map['customerGateways'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationCustomerGateway>(map['customerGateways']!, (value) => NetworkInsightsAnalysisExplanationCustomerGateway.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      destinationVpcs: map['destinationVpcs'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationDestinationVpc>(map['destinationVpcs']!, (value) => NetworkInsightsAnalysisExplanationDestinationVpc.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      destinations: map['destinations'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationDestination>(map['destinations']!, (value) => NetworkInsightsAnalysisExplanationDestination.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      direction: map['direction'] == null ? null : ((map['direction'] as String).input()).input(),
      elasticLoadBalancerListeners: map['elasticLoadBalancerListeners'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationElasticLoadBalancerListener>(map['elasticLoadBalancerListeners']!, (value) => NetworkInsightsAnalysisExplanationElasticLoadBalancerListener.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      explanationCode: map['explanationCode'] == null ? null : ((map['explanationCode'] as String).input()).input(),
      ingressRouteTables: map['ingressRouteTables'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationIngressRouteTable>(map['ingressRouteTables']!, (value) => NetworkInsightsAnalysisExplanationIngressRouteTable.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      internetGateways: map['internetGateways'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationInternetGateway>(map['internetGateways']!, (value) => NetworkInsightsAnalysisExplanationInternetGateway.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      loadBalancerArn: map['loadBalancerArn'] == null ? null : ((map['loadBalancerArn'] as String).input()).input(),
      loadBalancerListenerPort: map['loadBalancerListenerPort'] == null ? null : ((map['loadBalancerListenerPort'] as int).input()).input(),
      loadBalancerTargetGroup: map['loadBalancerTargetGroup'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationLoadBalancerTargetGroup>(map['loadBalancerTargetGroup']!, (value) => NetworkInsightsAnalysisExplanationLoadBalancerTargetGroup.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      loadBalancerTargetGroups: map['loadBalancerTargetGroups'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationLoadBalancerTargetGroup>(map['loadBalancerTargetGroups']!, (value) => NetworkInsightsAnalysisExplanationLoadBalancerTargetGroup.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      loadBalancerTargetPort: map['loadBalancerTargetPort'] == null ? null : ((map['loadBalancerTargetPort'] as int).input()).input(),
      missingComponent: map['missingComponent'] == null ? null : ((map['missingComponent'] as String).input()).input(),
      natGateways: map['natGateways'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationNatGateway>(map['natGateways']!, (value) => NetworkInsightsAnalysisExplanationNatGateway.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      networkInterfaces: map['networkInterfaces'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationNetworkInterface>(map['networkInterfaces']!, (value) => NetworkInsightsAnalysisExplanationNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      packetField: map['packetField'] == null ? null : ((map['packetField'] as String).input()).input(),
      port: map['port'] == null ? null : ((map['port'] as int).input()).input(),
      portRanges: map['portRanges'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationPortRange>(map['portRanges']!, (value) => NetworkInsightsAnalysisExplanationPortRange.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      prefixLists: map['prefixLists'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationPrefixList>(map['prefixLists']!, (value) => NetworkInsightsAnalysisExplanationPrefixList.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      protocols: map['protocols'] == null ? null : (((map['protocols'] as List).cast<String>()).input()).input(),
      routeTableRoutes: map['routeTableRoutes'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationRouteTableRoute>(map['routeTableRoutes']!, (value) => NetworkInsightsAnalysisExplanationRouteTableRoute.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      routeTables: map['routeTables'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationRouteTable>(map['routeTables']!, (value) => NetworkInsightsAnalysisExplanationRouteTable.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      securityGroup: map['securityGroup'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationSecurityGroup>(map['securityGroup']!, (value) => NetworkInsightsAnalysisExplanationSecurityGroup.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      securityGroupRules: map['securityGroupRules'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationSecurityGroupRule>(map['securityGroupRules']!, (value) => NetworkInsightsAnalysisExplanationSecurityGroupRule.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      securityGroups: map['securityGroups'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationSecurityGroup>(map['securityGroups']!, (value) => NetworkInsightsAnalysisExplanationSecurityGroup.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      sourceVpcs: map['sourceVpcs'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationSourceVpc>(map['sourceVpcs']!, (value) => NetworkInsightsAnalysisExplanationSourceVpc.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      state: map['state'] == null ? null : ((map['state'] as String).input()).input(),
      subnetRouteTables: map['subnetRouteTables'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationSubnetRouteTable>(map['subnetRouteTables']!, (value) => NetworkInsightsAnalysisExplanationSubnetRouteTable.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      subnets: map['subnets'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationSubnet>(map['subnets']!, (value) => NetworkInsightsAnalysisExplanationSubnet.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      transitGatewayAttachments: map['transitGatewayAttachments'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationTransitGatewayAttachment>(map['transitGatewayAttachments']!, (value) => NetworkInsightsAnalysisExplanationTransitGatewayAttachment.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      transitGatewayRouteTableRoutes: map['transitGatewayRouteTableRoutes'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationTransitGatewayRouteTableRoute>(map['transitGatewayRouteTableRoutes']!, (value) => NetworkInsightsAnalysisExplanationTransitGatewayRouteTableRoute.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      transitGatewayRouteTables: map['transitGatewayRouteTables'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationTransitGatewayRouteTable>(map['transitGatewayRouteTables']!, (value) => NetworkInsightsAnalysisExplanationTransitGatewayRouteTable.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      transitGateways: map['transitGateways'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationTransitGateway>(map['transitGateways']!, (value) => NetworkInsightsAnalysisExplanationTransitGateway.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      vpcEndpoints: map['vpcEndpoints'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationVpcEndpoint>(map['vpcEndpoints']!, (value) => NetworkInsightsAnalysisExplanationVpcEndpoint.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      vpcPeeringConnections: map['vpcPeeringConnections'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationVpcPeeringConnection>(map['vpcPeeringConnections']!, (value) => NetworkInsightsAnalysisExplanationVpcPeeringConnection.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      vpcs: map['vpcs'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationVpc>(map['vpcs']!, (value) => NetworkInsightsAnalysisExplanationVpc.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      vpnConnections: map['vpnConnections'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationVpnConnection>(map['vpnConnections']!, (value) => NetworkInsightsAnalysisExplanationVpnConnection.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      vpnGateways: map['vpnGateways'] == null ? null : ((pulumi.Input.decodeList<NetworkInsightsAnalysisExplanationVpnGateway>(map['vpnGateways']!, (value) => NetworkInsightsAnalysisExplanationVpnGateway.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
    );
  }
}
