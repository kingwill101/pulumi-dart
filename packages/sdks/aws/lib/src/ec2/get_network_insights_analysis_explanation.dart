...
class GetNetworkInsightsAnalysisExplanation {
  ...
  factory GetNetworkInsightsAnalysisExplanation.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanation(
      ...
      loadBalancerListenerPort: pulumi.Input.fromValue((map['loadBalancerListenerPort'] as num).toInt()),
      ...
      loadBalancerTargetPort: pulumi.Input.fromValue((map['loadBalancerTargetPort'] as num).toInt()),
