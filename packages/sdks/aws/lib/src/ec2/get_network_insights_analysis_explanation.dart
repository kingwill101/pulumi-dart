...
class GetNetworkInsightsAnalysisExplanation {
  ...
  factory GetNetworkInsightsAnalysisExplanation.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanation(
      ...
      loadBalancerListenerPort: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['loadBalancerListenerPort'])),
      ...
      loadBalancerTargetPort: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['loadBalancerTargetPort'])),
