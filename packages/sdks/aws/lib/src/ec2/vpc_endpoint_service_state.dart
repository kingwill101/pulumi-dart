...
class VpcEndpointServiceState {
  ...
  factory VpcEndpointServiceState.fromMap(Map<String, dynamic> map) {
    return VpcEndpointServiceState(
      acceptanceRequired: map['acceptanceRequired'] == null ? null : ((map['acceptanceRequired'] as bool).input()).input(),
      ...
      baseEndpointDnsNames: map['baseEndpointDnsNames'] == null ? null : (((map['baseEndpointDnsNames'] as List).cast<String>()).input()).input(),
      ...
      managesVpcEndpoints: map['managesVpcEndpoints'] == null ? null : ((map['managesVpcEndpoints'] as bool).input()).input(),
      ...
      privateDnsNameConfigurations: map['privateDnsNameConfigurations'] == null ? null : ((pulumi.Input.decodeList<VpcEndpointServicePrivateDnsNameConfiguration>(map['privateDnsNameConfigurations']!, (value) => VpcEndpointServicePrivateDnsNameConfiguration.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
