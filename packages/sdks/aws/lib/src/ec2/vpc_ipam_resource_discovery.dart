...
class VpcIpamResourceDiscovery extends pulumi.CustomResource {
  ...
  VpcIpamResourceDiscovery(
    ...
    this.ipamResourceDiscoveryRegion = registerOutput<String>('ipamResourceDiscoveryRegion');
    this.isDefault = registerOutput<bool>('isDefault');
    this.operatingRegions = registerOutput<List<VpcIpamResourceDiscoveryOperatingRegion>>('operatingRegions');
    this.organizationalUnitExclusions = registerOutput<List<VpcIpamResourceDiscoveryOrganizationalUnitExclusion>?>('organizationalUnitExclusions');
