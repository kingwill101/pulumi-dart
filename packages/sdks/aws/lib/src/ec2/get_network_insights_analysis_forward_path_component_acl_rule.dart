...
class GetNetworkInsightsAnalysisForwardPathComponentAclRule {
  ...
  /// [ruleAction] Required.
  /// [ruleNumber] Required.
  const GetNetworkInsightsAnalysisForwardPathComponentAclRule({
    required this.cidr,
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentAclRule.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisForwardPathComponentAclRule(
      ...
      portRanges: pulumi.Input.fromValue(pulumi.Input.decodeList<GetNetworkInsightsAnalysisForwardPathComponentAclRulePortRange>(map['portRanges']!, (value) => GetNetworkInsightsAnalysisForwardPathComponentAclRulePortRange.fromMap((value as Map).cast<String, dynamic>()))),
