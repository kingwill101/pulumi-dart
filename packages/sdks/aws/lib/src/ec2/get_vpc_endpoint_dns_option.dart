...
class GetVpcEndpointDnsOption {
  ...
  factory GetVpcEndpointDnsOption.fromMap(Map<String, dynamic> map) {
    return GetVpcEndpointDnsOption(
      ...
      privateDnsOnlyForInboundResolverEndpoint: pulumi.Input.fromValue(
        map['privateDnsOnlyForInboundResolverEndpoint'] as bool,
      ),
      privateDnsPreference: pulumi.Input.fromValue(
        map['privateDnsPreference'] as String,
      ),
      privateDnsSpecifiedDomains: pulumi.Input.fromValue(
