...
class GetSubnetArgs {
  ...
  factory GetSubnetArgs.fromMap(Map<String, dynamic> map) {
    return GetSubnetArgs(
      ...
      defaultForAz: (() { final guardedValue = map['defaultForAz']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetSubnetFilter>(guardedValue, (value) => GetSubnetFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
