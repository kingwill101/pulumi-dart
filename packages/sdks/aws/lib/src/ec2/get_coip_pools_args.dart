...
class GetCoipPoolsArgs {
  ...
  factory GetCoipPoolsArgs.fromMap(Map<String, dynamic> map) {
    return GetCoipPoolsArgs(
      filters: map['filters'] == null ? null : (pulumi.Input.decodeList<GetCoipPoolsFilter>(map['filters'], (value) => GetCoipPoolsFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
