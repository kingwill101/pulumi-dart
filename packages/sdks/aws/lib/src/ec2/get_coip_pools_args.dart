...
class GetCoipPoolsArgs {
  ...
  GetCoipPoolsArgs({
    pulumi.Output<List<GetCoipPoolsFilter>>? filters,
    pulumi.Output<String>? region,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      filters = pulumi.Input.asOptionalInput<List<GetCoipPoolsFilter>>(filters),
  ...
  factory GetCoipPoolsArgs.fromMap(Map<String, dynamic> map) {
    return GetCoipPoolsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetCoipPoolsFilter>>(pulumi.Input.decodeList<GetCoipPoolsFilter>(map['filters'], (value) => GetCoipPoolsFilter.fromMap((value as Map).cast<String, dynamic>()))),
