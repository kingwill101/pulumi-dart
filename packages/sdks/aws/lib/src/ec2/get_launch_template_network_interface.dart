...
class GetLaunchTemplateNetworkInterface {
  ...
  factory GetLaunchTemplateNetworkInterface.fromMap(Map<String, dynamic> map) {
    return GetLaunchTemplateNetworkInterface(
      ...
      enaQueueCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['enaQueueCount'])),
      interfaceType: pulumi.Input.fromValue(map['interfaceType'] as String),
      ipv4AddressCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['ipv4AddressCount'])),
      ipv4Addresses: pulumi.Input.fromValue((map['ipv4Addresses'] as List).cast<String>()),
      ipv4PrefixCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['ipv4PrefixCount'])),
      ipv4Prefixes: pulumi.Input.fromValue((map['ipv4Prefixes'] as List).cast<String>()),
      ipv6AddressCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['ipv6AddressCount'])),
      ipv6Addresses: pulumi.Input.fromValue((map['ipv6Addresses'] as List).cast<String>()),
      ipv6PrefixCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['ipv6PrefixCount'])),
