...
import 'vpc_ipv6_cidr_block_association_state.dart';
...
/// }
/// resource "aws_ec2_vpcipv6cidrblockassociation" "test" {
///   ipv6_ipam_pool_id = testAwsVpcIpamPool.id
...
class VpcIpv6CidrBlockAssociation extends pulumi.CustomResource {
  ...
  /// Gets an existing [VpcIpv6CidrBlockAssociation] resource's state with the given [name] and [id].
  static VpcIpv6CidrBlockAssociation get(
    String name,
  ...
  VpcIpv6CidrBlockAssociation._get(
    String name, {
