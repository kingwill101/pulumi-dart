...
import 'vpc_ipam_pool_state.dart';
...
class VpcIpamPool extends pulumi.CustomResource {
  ...
  VpcIpamPool(
    ...
    this.allocationDefaultNetmaskLength = registerOutput<int?>('allocationDefaultNetmaskLength');
    this.allocationMaxNetmaskLength = registerOutput<int?>('allocationMaxNetmaskLength');
    this.allocationMinNetmaskLength = registerOutput<int?>('allocationMinNetmaskLength');
    this.allocationResourceTags = registerOutput<Map<String, String>?>('allocationResourceTags');
    ...
    this.sourceResource = registerOutput<VpcIpamPoolSourceResource?>('sourceResource');
