...
class VpcIpamPool extends pulumi.CustomResource {
  ...
  VpcIpamPool(
    ...
    allocationDefaultNetmaskLength = registerOutput<int?>(
      'allocationDefaultNetmaskLength',
    );
    allocationMaxNetmaskLength = registerOutput<int?>(
      'allocationMaxNetmaskLength',
    );
    allocationMinNetmaskLength = registerOutput<int?>(
      'allocationMinNetmaskLength',
    );
    allocationResourceTags = registerOutput<Map<String, String>?>(
