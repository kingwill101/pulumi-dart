...
class VpcEndpointDnsOptions {
  ...
  factory VpcEndpointDnsOptions.fromMap(Map<String, dynamic> map) {
    return VpcEndpointDnsOptions(
      dnsRecordIpType: (() {
        final guardedValue = map['dnsRecordIpType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateDnsOnlyForInboundResolverEndpoint: (() {
        final guardedValue = map['privateDnsOnlyForInboundResolverEndpoint'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      privateDnsPreference: (() {
        final guardedValue = map['privateDnsPreference'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      privateDnsSpecifiedDomains: (() {
        final guardedValue = map['privateDnsSpecifiedDomains'];
        if (guardedValue == null) return null;
