...
class NetworkInsightsAccessScopeExcludePathSourcePacketHeaderStatement {
  ...
  /// Creates a new [NetworkInsightsAccessScopeExcludePathSourcePacketHeaderStatement].
  ...
  const NetworkInsightsAccessScopeExcludePathSourcePacketHeaderStatement({
  ...
  factory NetworkInsightsAccessScopeExcludePathSourcePacketHeaderStatement.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAccessScopeExcludePathSourcePacketHeaderStatement(
