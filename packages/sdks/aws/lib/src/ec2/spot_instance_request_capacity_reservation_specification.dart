...
class SpotInstanceRequestCapacityReservationSpecification {
  ...
  factory SpotInstanceRequestCapacityReservationSpecification.fromMap(Map<String, dynamic> map) {
    return SpotInstanceRequestCapacityReservationSpecification(
      ...
      capacityReservationTarget: (() { final guardedValue = map['capacityReservationTarget']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
