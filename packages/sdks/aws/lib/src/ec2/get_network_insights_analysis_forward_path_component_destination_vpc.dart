...
class GetNetworkInsightsAnalysisForwardPathComponentDestinationVpc {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisForwardPathComponentDestinationVpc].
  ...
  const GetNetworkInsightsAnalysisForwardPathComponentDestinationVpc({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentDestinationVpc.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisForwardPathComponentDestinationVpc(
