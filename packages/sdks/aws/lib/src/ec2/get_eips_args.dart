...
class GetEipsArgs {
  ...
  factory GetEipsArgs.fromMap(Map<String, dynamic> map) {
    return GetEipsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetEipsFilter>(guardedValue, (value) => GetEipsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
