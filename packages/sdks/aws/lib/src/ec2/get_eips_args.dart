...
class GetEipsArgs {
  ...
  GetEipsArgs({
    pulumi.Output<List<GetEipsFilter>>? filters,
  ...
  factory GetEipsArgs.fromMap(Map<String, dynamic> map) {
    return GetEipsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetEipsFilter>>(pulumi.Input.decodeList<GetEipsFilter>(map['filters'], (value) => GetEipsFilter.fromMap((value as Map).cast<String, dynamic>()))),
