...
class EncryptionControlResourceExclusions {
  ...
  factory EncryptionControlResourceExclusions.fromMap(Map<String, dynamic> map) {
    return EncryptionControlResourceExclusions(
      egressOnlyInternetGateway: pulumi.Input.fromValue(EncryptionControlResourceExclusionsEgressOnlyInternetGateway.fromMap((map['egressOnlyInternetGateway']! as Map).cast<String, dynamic>())),
      elasticFileSystem: pulumi.Input.fromValue(EncryptionControlResourceExclusionsElasticFileSystem.fromMap((map['elasticFileSystem']! as Map).cast<String, dynamic>())),
      internetGateway: pulumi.Input.fromValue(EncryptionControlResourceExclusionsInternetGateway.fromMap((map['internetGateway']! as Map).cast<String, dynamic>())),
      lambda: pulumi.Input.fromValue(EncryptionControlResourceExclusionsLambda.fromMap((map['lambda']! as Map).cast<String, dynamic>())),
      natGateway: pulumi.Input.fromValue(EncryptionControlResourceExclusionsNatGateway.fromMap((map['natGateway']! as Map).cast<String, dynamic>())),
      virtualPrivateGateway: pulumi.Input.fromValue(EncryptionControlResourceExclusionsVirtualPrivateGateway.fromMap((map['virtualPrivateGateway']! as Map).cast<String, dynamic>())),
      vpcLattice: pulumi.Input.fromValue(EncryptionControlResourceExclusionsVpcLattice.fromMap((map['vpcLattice']! as Map).cast<String, dynamic>())),
      vpcPeering: pulumi.Input.fromValue(EncryptionControlResourceExclusionsVpcPeering.fromMap((map['vpcPeering']! as Map).cast<String, dynamic>())),
    );
  }
}
