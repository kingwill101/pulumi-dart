...
import 'serial_console_access_state.dart';
...
/// }
///
/// resource "aws_ec2_serialconsoleaccess" "example" {
///   enabled = true
/// }
/// ```
/// ```java
...
class SerialConsoleAccess extends pulumi.CustomResource {
  ...
  /// Gets an existing [SerialConsoleAccess] resource's state with the given [name] and [id].
  static SerialConsoleAccess get(
    String name,
