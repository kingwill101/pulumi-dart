    ...
    return GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader(
      ...
      destinationPortRanges: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderDestinationPortRange.fromMap(
      ...
      sourcePortRanges: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
