...
class DefaultSubnetState {
  ...
  factory DefaultSubnetState.fromMap(Map<String, dynamic> map) {
    return DefaultSubnetState(
      ...
      existingDefaultSubnet: map['existingDefaultSubnet'] == null ? null : (map['existingDefaultSubnet'] as bool).input(),
      forceDestroy: map['forceDestroy'] == null ? null : (map['forceDestroy'] as bool).input(),
      ipv6CidrBlock: map['ipv6CidrBlock'] == null ? null : (map['ipv6CidrBlock'] as String).input(),
      ipv6CidrBlockAssociationId: map['ipv6CidrBlockAssociationId'] == null ? null : (map['ipv6CidrBlockAssociationId'] as String).input(),
