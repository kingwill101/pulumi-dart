...
class DefaultSubnetState {
  ...
  factory DefaultSubnetState.fromMap(Map<String, dynamic> map) {
    return DefaultSubnetState(
      ...
      ipv6CidrBlockAssociationId: (() { final guardedValue = map['ipv6CidrBlockAssociationId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
