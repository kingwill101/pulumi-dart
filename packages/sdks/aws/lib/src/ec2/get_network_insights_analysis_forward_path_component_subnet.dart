...
class GetNetworkInsightsAnalysisForwardPathComponentSubnet {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisForwardPathComponentSubnet].
  ...
  const GetNetworkInsightsAnalysisForwardPathComponentSubnet({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentSubnet.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisForwardPathComponentSubnet(
