...
class GetNetworkInsightsAnalysisExplanationPrefixList {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationPrefixList].
  ...
  const GetNetworkInsightsAnalysisExplanationPrefixList({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationPrefixList.fromMap(Map<String, dynamic> map) {
