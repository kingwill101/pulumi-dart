...
class NetworkInsightsAnalysisState {
  ...
  factory NetworkInsightsAnalysisState.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAnalysisState(
      alternatePathHints: (() { final guardedValue = map['alternatePathHints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInsightsAnalysisAlternatePathHint>(guardedValue, (value) => NetworkInsightsAnalysisAlternatePathHint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      arn: (() { final guardedValue = map['arn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      explanations: (() { final guardedValue = map['explanations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInsightsAnalysisExplanation>(guardedValue, (value) => NetworkInsightsAnalysisExplanation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      filterInArns: (() { final guardedValue = map['filterInArns']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      forwardPathComponents: (() { final guardedValue = map['forwardPathComponents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInsightsAnalysisForwardPathComponent>(guardedValue, (value) => NetworkInsightsAnalysisForwardPathComponent.fromMap((value as Map).cast<String, dynamic>()))); })(),
      networkInsightsPathId: (() { final guardedValue = map['networkInsightsPathId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pathFound: (() { final guardedValue = map['pathFound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      returnPathComponents: (() { final guardedValue = map['returnPathComponents']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NetworkInsightsAnalysisReturnPathComponent>(guardedValue, (value) => NetworkInsightsAnalysisReturnPathComponent.fromMap((value as Map).cast<String, dynamic>()))); })(),
