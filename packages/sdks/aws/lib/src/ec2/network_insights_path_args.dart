...
class NetworkInsightsPathArgs {
    ...
    return <String, dynamic>{
      ...
      'filterAtDestination':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(filterAtDestination, (value) => value.toMap()),
      'filterAtSource':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkInsightsPathFilterAtSource,
            Map<String, dynamic>
          >(filterAtSource, (value) => value.toMap()),
      'protocol': protocol,
      'region': ?region,
      'source': source,
      'sourceIp': ?sourceIp,
  ...
  factory NetworkInsightsPathArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsPathArgs(
      ...
      filterAtDestination: (() {
        final guardedValue = map['filterAtDestination'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInsightsPathFilterAtDestination.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      filterAtSource: (() {
        final guardedValue = map['filterAtSource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkInsightsPathFilterAtSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
