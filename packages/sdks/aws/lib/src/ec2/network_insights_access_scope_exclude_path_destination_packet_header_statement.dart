...
class NetworkInsightsAccessScopeExcludePathDestinationPacketHeaderStatement {
  ...
  factory NetworkInsightsAccessScopeExcludePathDestinationPacketHeaderStatement.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAccessScopeExcludePathDestinationPacketHeaderStatement(
