...
import 'vpn_concentrator_state.dart';
...
class VpnConcentrator extends pulumi.CustomResource {
  ...
  /// Gets an existing [VpnConcentrator] resource's state with the given [name] and [id].
  static VpnConcentrator get(
    String name,
    pulumi.Input<String> id, {
    VpnConcentratorState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return VpnConcentrator._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [VpnConcentrator] resource.
  VpnConcentrator.reference(String urn)
    : super(
        'aws:ec2/vpnConcentrator:VpnConcentrator',
