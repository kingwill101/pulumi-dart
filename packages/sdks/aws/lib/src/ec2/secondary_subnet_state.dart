...
class SecondarySubnetState {
  ...
  factory SecondarySubnetState.fromMap(Map<String, dynamic> map) {
    return SecondarySubnetState(
      ...
      ipv4CidrBlockAssociations: (() { final guardedValue = map['ipv4CidrBlockAssociations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecondarySubnetIpv4CidrBlockAssociation>(guardedValue, (value) => SecondarySubnetIpv4CidrBlockAssociation.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      secondaryNetworkType: (() { final guardedValue = map['secondaryNetworkType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
