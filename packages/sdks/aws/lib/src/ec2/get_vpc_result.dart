...
class GetVpcResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'arn': arn,
      'cidrBlock': cidrBlock,
      'cidrBlockAssociations': pulumi.Input.encodeList<GetVpcCidrBlockAssociation, Map<String, dynamic>>(cidrBlockAssociations, (value) => value.toMap()),
      'default': default_,
      'dhcpOptionsId': dhcpOptionsId,
      'enableDnsHostnames': enableDnsHostnames,
      'enableDnsSupport': enableDnsSupport,
      'enableNetworkAddressUsageMetrics': enableNetworkAddressUsageMetrics,
      'filters': ?filters == null ? null : pulumi.Input.encodeList<GetVpcFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
      'id': id,
  ...
  factory GetVpcResult.fromMap(Map<String, dynamic> map) {
    return GetVpcResult(
      ...
      cidrBlockAssociations: pulumi.Input.decodeList<GetVpcCidrBlockAssociation>(map['cidrBlockAssociations']!, (value) => GetVpcCidrBlockAssociation.fromMap((value as Map).cast<String, dynamic>())),
      ...
      enableNetworkAddressUsageMetrics: map['enableNetworkAddressUsageMetrics'] as bool,
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<GetVpcFilter>(map['filters']!, (value) => GetVpcFilter.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
