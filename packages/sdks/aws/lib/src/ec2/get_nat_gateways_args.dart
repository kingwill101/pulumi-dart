...
class GetNatGatewaysArgs {
  ...
  factory GetNatGatewaysArgs.fromMap(Map<String, dynamic> map) {
    return GetNatGatewaysArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetNatGatewaysFilter>(guardedValue, (value) => GetNatGatewaysFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
