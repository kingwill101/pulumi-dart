...
class GetInternetGatewayArgs {
  ...
  GetInternetGatewayArgs({
    pulumi.Output<List<GetInternetGatewayFilter>>? filters,
  ...
  factory GetInternetGatewayArgs.fromMap(Map<String, dynamic> map) {
    return GetInternetGatewayArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetInternetGatewayFilter>>(pulumi.Input.decodeList<GetInternetGatewayFilter>(map['filters'], (value) => GetInternetGatewayFilter.fromMap((value as Map).cast<String, dynamic>()))),
