...
class NetworkInsightsAccessScopeMatchPathDestinationResourceStatement {
  ...
  factory NetworkInsightsAccessScopeMatchPathDestinationResourceStatement.fromMap(Map<String, dynamic> map) {
    return NetworkInsightsAccessScopeMatchPathDestinationResourceStatement(
