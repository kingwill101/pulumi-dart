...
class GetNetworkInsightsAnalysisExplanationSubnetRouteTable {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationSubnetRouteTable].
  ...
  const GetNetworkInsightsAnalysisExplanationSubnetRouteTable({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationSubnetRouteTable.fromMap(Map<String, dynamic> map) {
