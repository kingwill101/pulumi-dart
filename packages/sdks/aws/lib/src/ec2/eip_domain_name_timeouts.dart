...
class EipDomainNameTimeouts {
  ...
  /// Creates a new [EipDomainNameTimeouts].
  ...
  EipDomainNameTimeouts({this.create, this.delete, this.update});
  ...
  factory EipDomainNameTimeouts.fromMap(Map<String, dynamic> map) {
    return EipDomainNameTimeouts(
      create: (() {
