...
import 'internet_gateway_state.dart';
...
class InternetGateway extends pulumi.CustomResource {
  ...
  /// Gets an existing [InternetGateway] resource's state with the given [name] and [id].
  static InternetGateway get(
    String name,
    pulumi.Input<String> id, {
    InternetGatewayState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return InternetGateway._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [InternetGateway] resource.
  InternetGateway.reference(String urn)
    : super(
        'aws:ec2/internetGateway:InternetGateway',
