...
class Ami extends pulumi.CustomResource {
  ...
  Ami(
    ...
    this.ebsBlockDevices = registerOutput<List<AmiEbsBlockDevice>>('ebsBlockDevices');
    this.enaSupport = registerOutput<bool?>('enaSupport');
    this.ephemeralBlockDevices = registerOutput<List<AmiEphemeralBlockDevice>>('ephemeralBlockDevices');
