...
class VpnConnection extends pulumi.CustomResource {
  ...
  VpnConnection(
    ...
    coreNetworkAttachmentArn = registerOutput<String>(
      'coreNetworkAttachmentArn',
    );
    customerGatewayConfiguration = registerOutput<String>(
    ...
    transportTransitGatewayAttachmentId = registerOutput<String?>(
    ...
    tunnel1DpdTimeoutAction = registerOutput<String?>(
      'tunnel1DpdTimeoutAction',
    );
    tunnel1DpdTimeoutSeconds = registerOutput<int?>('tunnel1DpdTimeoutSeconds');
    tunnel1EnableTunnelLifecycleControl = registerOutput<bool?>(
    ...
    tunnel1Phase1EncryptionAlgorithms = registerOutput<List<String>?>(
      'tunnel1Phase1EncryptionAlgorithms',
    );
    tunnel1Phase1IntegrityAlgorithms = registerOutput<List<String>?>(
      'tunnel1Phase1IntegrityAlgorithms',
    );
    tunnel1Phase1LifetimeSeconds = registerOutput<int?>(
      'tunnel1Phase1LifetimeSeconds',
    );
    tunnel1Phase2DhGroupNumbers = registerOutput<List<int>?>(
      'tunnel1Phase2DhGroupNumbers',
    );
    tunnel1Phase2EncryptionAlgorithms = registerOutput<List<String>?>(
      'tunnel1Phase2EncryptionAlgorithms',
    );
    tunnel1Phase2IntegrityAlgorithms = registerOutput<List<String>?>(
      'tunnel1Phase2IntegrityAlgorithms',
    );
    tunnel1Phase2LifetimeSeconds = registerOutput<int?>(
      'tunnel1Phase2LifetimeSeconds',
    );
    tunnel1PresharedKey = registerOutput<String>('tunnel1PresharedKey');
    tunnel1RekeyFuzzPercentage = registerOutput<int?>(
      'tunnel1RekeyFuzzPercentage',
    );
    tunnel1RekeyMarginTimeSeconds = registerOutput<int?>(
    ...
    tunnel2DpdTimeoutAction = registerOutput<String?>(
      'tunnel2DpdTimeoutAction',
    );
    tunnel2DpdTimeoutSeconds = registerOutput<int?>('tunnel2DpdTimeoutSeconds');
    tunnel2EnableTunnelLifecycleControl = registerOutput<bool?>(
    ...
    tunnel2Phase1EncryptionAlgorithms = registerOutput<List<String>?>(
      'tunnel2Phase1EncryptionAlgorithms',
    );
    tunnel2Phase1IntegrityAlgorithms = registerOutput<List<String>?>(
      'tunnel2Phase1IntegrityAlgorithms',
    );
    tunnel2Phase1LifetimeSeconds = registerOutput<int?>(
      'tunnel2Phase1LifetimeSeconds',
    );
    tunnel2Phase2DhGroupNumbers = registerOutput<List<int>?>(
      'tunnel2Phase2DhGroupNumbers',
    );
    tunnel2Phase2EncryptionAlgorithms = registerOutput<List<String>?>(
      'tunnel2Phase2EncryptionAlgorithms',
    );
    tunnel2Phase2IntegrityAlgorithms = registerOutput<List<String>?>(
      'tunnel2Phase2IntegrityAlgorithms',
    );
    tunnel2Phase2LifetimeSeconds = registerOutput<int?>(
      'tunnel2Phase2LifetimeSeconds',
    );
    tunnel2PresharedKey = registerOutput<String>('tunnel2PresharedKey');
    tunnel2RekeyFuzzPercentage = registerOutput<int?>(
      'tunnel2RekeyFuzzPercentage',
    );
    tunnel2RekeyMarginTimeSeconds = registerOutput<int?>(
    ...
    vgwTelemetries = registerOutput<List<Map<String, dynamic>>>(
      'vgwTelemetries',
    );
