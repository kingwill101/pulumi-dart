...
class VpnConnection extends pulumi.CustomResource {
  ...
  VpnConnection(
    ...
    this.coreNetworkAttachmentArn = registerOutput<String>('coreNetworkAttachmentArn');
    this.customerGatewayConfiguration = registerOutput<String>('customerGatewayConfiguration');
    ...
    this.remoteIpv4NetworkCidr = registerOutput<String>('remoteIpv4NetworkCidr');
    this.remoteIpv6NetworkCidr = registerOutput<String>('remoteIpv6NetworkCidr');
    ...
    this.transportTransitGatewayAttachmentId = registerOutput<String?>('transportTransitGatewayAttachmentId');
    ...
    this.tunnel1CgwInsideAddress = registerOutput<String>('tunnel1CgwInsideAddress');
    this.tunnel1DpdTimeoutAction = registerOutput<String?>('tunnel1DpdTimeoutAction');
    this.tunnel1DpdTimeoutSeconds = registerOutput<int?>('tunnel1DpdTimeoutSeconds');
    this.tunnel1EnableTunnelLifecycleControl = registerOutput<bool?>('tunnel1EnableTunnelLifecycleControl');
    this.tunnel1IkeVersions = registerOutput<List<String>?>('tunnel1IkeVersions');
    this.tunnel1InsideCidr = registerOutput<String>('tunnel1InsideCidr');
    this.tunnel1InsideIpv6Cidr = registerOutput<String>('tunnel1InsideIpv6Cidr');
    this.tunnel1LogOptions = registerOutput<VpnConnectionTunnel1LogOptions>('tunnel1LogOptions');
    this.tunnel1Phase1DhGroupNumbers = registerOutput<List<int>?>('tunnel1Phase1DhGroupNumbers');
    this.tunnel1Phase1EncryptionAlgorithms = registerOutput<List<String>?>('tunnel1Phase1EncryptionAlgorithms');
    this.tunnel1Phase1IntegrityAlgorithms = registerOutput<List<String>?>('tunnel1Phase1IntegrityAlgorithms');
    this.tunnel1Phase1LifetimeSeconds = registerOutput<int?>('tunnel1Phase1LifetimeSeconds');
    this.tunnel1Phase2DhGroupNumbers = registerOutput<List<int>?>('tunnel1Phase2DhGroupNumbers');
    this.tunnel1Phase2EncryptionAlgorithms = registerOutput<List<String>?>('tunnel1Phase2EncryptionAlgorithms');
    this.tunnel1Phase2IntegrityAlgorithms = registerOutput<List<String>?>('tunnel1Phase2IntegrityAlgorithms');
    this.tunnel1Phase2LifetimeSeconds = registerOutput<int?>('tunnel1Phase2LifetimeSeconds');
    this.tunnel1PresharedKey = registerOutput<String>('tunnel1PresharedKey');
    this.tunnel1RekeyFuzzPercentage = registerOutput<int?>('tunnel1RekeyFuzzPercentage');
    this.tunnel1RekeyMarginTimeSeconds = registerOutput<int?>('tunnel1RekeyMarginTimeSeconds');
    this.tunnel1ReplayWindowSize = registerOutput<int?>('tunnel1ReplayWindowSize');
    this.tunnel1StartupAction = registerOutput<String?>('tunnel1StartupAction');
    this.tunnel1VgwInsideAddress = registerOutput<String>('tunnel1VgwInsideAddress');
    ...
    this.tunnel2CgwInsideAddress = registerOutput<String>('tunnel2CgwInsideAddress');
    this.tunnel2DpdTimeoutAction = registerOutput<String?>('tunnel2DpdTimeoutAction');
    this.tunnel2DpdTimeoutSeconds = registerOutput<int?>('tunnel2DpdTimeoutSeconds');
    this.tunnel2EnableTunnelLifecycleControl = registerOutput<bool?>('tunnel2EnableTunnelLifecycleControl');
    this.tunnel2IkeVersions = registerOutput<List<String>?>('tunnel2IkeVersions');
    this.tunnel2InsideCidr = registerOutput<String>('tunnel2InsideCidr');
    this.tunnel2InsideIpv6Cidr = registerOutput<String>('tunnel2InsideIpv6Cidr');
    this.tunnel2LogOptions = registerOutput<VpnConnectionTunnel2LogOptions>('tunnel2LogOptions');
    this.tunnel2Phase1DhGroupNumbers = registerOutput<List<int>?>('tunnel2Phase1DhGroupNumbers');
    this.tunnel2Phase1EncryptionAlgorithms = registerOutput<List<String>?>('tunnel2Phase1EncryptionAlgorithms');
    this.tunnel2Phase1IntegrityAlgorithms = registerOutput<List<String>?>('tunnel2Phase1IntegrityAlgorithms');
    this.tunnel2Phase1LifetimeSeconds = registerOutput<int?>('tunnel2Phase1LifetimeSeconds');
    this.tunnel2Phase2DhGroupNumbers = registerOutput<List<int>?>('tunnel2Phase2DhGroupNumbers');
    this.tunnel2Phase2EncryptionAlgorithms = registerOutput<List<String>?>('tunnel2Phase2EncryptionAlgorithms');
    this.tunnel2Phase2IntegrityAlgorithms = registerOutput<List<String>?>('tunnel2Phase2IntegrityAlgorithms');
    this.tunnel2Phase2LifetimeSeconds = registerOutput<int?>('tunnel2Phase2LifetimeSeconds');
    this.tunnel2PresharedKey = registerOutput<String>('tunnel2PresharedKey');
    this.tunnel2RekeyFuzzPercentage = registerOutput<int?>('tunnel2RekeyFuzzPercentage');
    this.tunnel2RekeyMarginTimeSeconds = registerOutput<int?>('tunnel2RekeyMarginTimeSeconds');
    this.tunnel2ReplayWindowSize = registerOutput<int?>('tunnel2ReplayWindowSize');
    this.tunnel2StartupAction = registerOutput<String?>('tunnel2StartupAction');
    this.tunnel2VgwInsideAddress = registerOutput<String>('tunnel2VgwInsideAddress');
    this.tunnelBandwidth = registerOutput<String>('tunnelBandwidth');
    this.tunnelInsideIpVersion = registerOutput<String>('tunnelInsideIpVersion');
    this.type = registerOutput<String>('type');
    this.vgwTelemetries = registerOutput<List<VpnConnectionVgwTelemetry>>('vgwTelemetries');
