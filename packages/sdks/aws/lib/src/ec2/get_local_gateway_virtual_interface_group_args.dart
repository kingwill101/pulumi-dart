...
class GetLocalGatewayVirtualInterfaceGroupArgs {
  ...
  const GetLocalGatewayVirtualInterfaceGroupArgs({
    this.filters,
    this.id,
    this.localGatewayId,
    this.region,
  ...
  factory GetLocalGatewayVirtualInterfaceGroupArgs.fromMap(Map<String, dynamic> map) {
    return GetLocalGatewayVirtualInterfaceGroupArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetLocalGatewayVirtualInterfaceGroupFilter>(guardedValue, (value) => GetLocalGatewayVirtualInterfaceGroupFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
