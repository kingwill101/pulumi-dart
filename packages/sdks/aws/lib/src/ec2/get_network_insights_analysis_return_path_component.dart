...
class GetNetworkInsightsAnalysisReturnPathComponent {
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponent.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisReturnPathComponent(
      aclRules: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentAclRule>(map['aclRules']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentAclRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      additionalDetails: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetail>(map['additionalDetails']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetail.fromMap((value as Map).cast<String, dynamic>()))).input(),
      attachedTos: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentAttachedTo>(map['attachedTos']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentAttachedTo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      components: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentComponent>(map['components']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentComponent.fromMap((value as Map).cast<String, dynamic>()))).input(),
      destinationVpcs: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentDestinationVpc>(map['destinationVpcs']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentDestinationVpc.fromMap((value as Map).cast<String, dynamic>()))).input(),
      inboundHeaders: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentInboundHeader>(map['inboundHeaders']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentInboundHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
      outboundHeaders: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader>(map['outboundHeaders']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader.fromMap((value as Map).cast<String, dynamic>()))).input(),
      routeTableRoutes: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentRouteTableRoute>(map['routeTableRoutes']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentRouteTableRoute.fromMap((value as Map).cast<String, dynamic>()))).input(),
      securityGroupRules: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentSecurityGroupRule>(map['securityGroupRules']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentSecurityGroupRule.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sequenceNumber: (map['sequenceNumber'] as int).input(),
      sourceVpcs: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentSourceVpc>(map['sourceVpcs']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentSourceVpc.fromMap((value as Map).cast<String, dynamic>()))).input(),
      subnets: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentSubnet>(map['subnets']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentSubnet.fromMap((value as Map).cast<String, dynamic>()))).input(),
      transitGatewayRouteTableRoutes: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentTransitGatewayRouteTableRoute>(map['transitGatewayRouteTableRoutes']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentTransitGatewayRouteTableRoute.fromMap((value as Map).cast<String, dynamic>()))).input(),
      transitGateways: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentTransitGateway>(map['transitGateways']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentTransitGateway.fromMap((value as Map).cast<String, dynamic>()))).input(),
      vpcs: (pulumi.Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentVpc>(map['vpcs']!, (value) => GetNetworkInsightsAnalysisReturnPathComponentVpc.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
