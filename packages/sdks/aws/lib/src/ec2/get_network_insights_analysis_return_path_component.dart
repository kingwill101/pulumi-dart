...
class GetNetworkInsightsAnalysisReturnPathComponent {
  final pulumi.Input<List<GetNetworkInsightsAnalysisReturnPathComponentAclRule>>
  aclRules;
  final pulumi.Input<
  ...
  >
  sourceVpcs;
  final pulumi.Input<List<GetNetworkInsightsAnalysisReturnPathComponentSubnet>>
  subnets;
  final pulumi.Input<
    List<
  ...
  >
  transitGateways;
  final pulumi.Input<List<GetNetworkInsightsAnalysisReturnPathComponentVpc>>
  vpcs;
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponent.fromMap(
    ...
    return GetNetworkInsightsAnalysisReturnPathComponent(
      aclRules: pulumi.Input.fromValue(
      ...
      additionalDetails: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetail.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      attachedTos: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentAttachedTo
        >(
          map['attachedTos']!,
      ...
      destinationVpcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentDestinationVpc
        >(
          map['destinationVpcs']!,
          (value) =>
              GetNetworkInsightsAnalysisReturnPathComponentDestinationVpc.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      inboundHeaders: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentInboundHeader
        >(
          map['inboundHeaders']!,
      ...
      outboundHeaders: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader
        >(
          map['outboundHeaders']!,
      ...
      routeTableRoutes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentRouteTableRoute
        >(
          map['routeTableRoutes']!,
          (value) =>
              GetNetworkInsightsAnalysisReturnPathComponentRouteTableRoute.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      securityGroupRules: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentSecurityGroupRule
        >(
      ...
      sequenceNumber: pulumi.Input.fromValue(map['sequenceNumber'] as int),
      sourceVpcs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentSourceVpc
        >(
          map['sourceVpcs']!,
      ...
      transitGatewayRouteTableRoutes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentTransitGatewayRouteTableRoute
        >(
          map['transitGatewayRouteTableRoutes']!,
          (value) =>
              GetNetworkInsightsAnalysisReturnPathComponentTransitGatewayRouteTableRoute.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      transitGateways: pulumi.Input.fromValue(
        pulumi.Input.decodeList<
          GetNetworkInsightsAnalysisReturnPathComponentTransitGateway
        >(
          map['transitGateways']!,
          (value) =>
              GetNetworkInsightsAnalysisReturnPathComponentTransitGateway.fromMap(
                (value as Map).cast<String, dynamic>(),
              ),
        ),
      ),
      vpcs: pulumi.Input.fromValue(
        pulumi
            .Input.decodeList<GetNetworkInsightsAnalysisReturnPathComponentVpc>(
          map['vpcs']!,
