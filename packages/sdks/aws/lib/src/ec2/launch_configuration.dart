...
class LaunchConfiguration extends pulumi.CustomResource {
  ...
  LaunchConfiguration(
    ...
    this.ebsBlockDevices = registerOutput<List<LaunchConfigurationEbsBlockDevice>>('ebsBlockDevices');
    this.ebsOptimized = registerOutput<bool>('ebsOptimized');
    this.enableMonitoring = registerOutput<bool?>('enableMonitoring');
    this.ephemeralBlockDevices = registerOutput<List<LaunchConfigurationEphemeralBlockDevice>?>('ephemeralBlockDevices');
    ...
    this.metadataOptions = registerOutput<LaunchConfigurationMetadataOptions>('metadataOptions');
    this.name = registerOutput<String>('name');
    this.namePrefix = registerOutput<String>('namePrefix');
    this.placementTenancy = registerOutput<String?>('placementTenancy');
    this.region = registerOutput<String>('region');
    this.rootBlockDevice = registerOutput<LaunchConfigurationRootBlockDevice>('rootBlockDevice');
