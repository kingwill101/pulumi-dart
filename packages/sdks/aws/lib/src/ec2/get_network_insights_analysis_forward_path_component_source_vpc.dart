...
class GetNetworkInsightsAnalysisForwardPathComponentSourceVpc {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisForwardPathComponentSourceVpc].
  ...
  const GetNetworkInsightsAnalysisForwardPathComponentSourceVpc({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentSourceVpc.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisForwardPathComponentSourceVpc(
