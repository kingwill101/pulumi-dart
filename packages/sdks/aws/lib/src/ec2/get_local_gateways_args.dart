...
class GetLocalGatewaysArgs {
  ...
  factory GetLocalGatewaysArgs.fromMap(Map<String, dynamic> map) {
    return GetLocalGatewaysArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetLocalGatewaysFilter>(guardedValue, (value) => GetLocalGatewaysFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
