...
class FleetArgs {
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      fleetInstanceSets: (() {
        final guardedValue = map['fleetInstanceSets'];
        if (guardedValue == null) return null;
      ...
      fleetState: (() {
        final guardedValue = map['fleetState'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fulfilledCapacity: (() {
        final guardedValue = map['fulfilledCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      fulfilledOnDemandCapacity: (() {
        final guardedValue = map['fulfilledOnDemandCapacity'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      launchTemplateConfigs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<FleetLaunchTemplateConfig>(
      ...
      onDemandOptions: (() {
        final guardedValue = map['onDemandOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      targetCapacitySpecification: pulumi.Input.fromValue(
        FleetTargetCapacitySpecification.fromMap(
          (map['targetCapacitySpecification']! as Map).cast<String, dynamic>(),
        ),
      ),
      terminateInstances: (() {
        final guardedValue = map['terminateInstances'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
