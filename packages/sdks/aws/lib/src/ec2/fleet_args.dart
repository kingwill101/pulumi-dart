...
class FleetArgs {
  ...
  FleetArgs({
    ...
    required pulumi.Output<List<FleetLaunchTemplateConfig>> launchTemplateConfigs,
    ...
    required pulumi.Output<FleetTargetCapacitySpecification> targetCapacitySpecification,
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      launchTemplateConfigs: pulumi.Output.create<List<FleetLaunchTemplateConfig>>(pulumi.Input.decodeList<FleetLaunchTemplateConfig>(map['launchTemplateConfigs'], (value) => FleetLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      targetCapacitySpecification: pulumi.Output.create<FleetTargetCapacitySpecification>(FleetTargetCapacitySpecification.fromMap((map['targetCapacitySpecification'] as Map).cast<String, dynamic>())),
