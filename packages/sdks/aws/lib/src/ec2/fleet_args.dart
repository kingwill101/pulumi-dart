...
class FleetArgs {
  ...
  factory FleetArgs.fromMap(Map<String, dynamic> map) {
    return FleetArgs(
      ...
      launchTemplateConfigs: pulumi.Input.fromValue(pulumi.Input.decodeList<FleetLaunchTemplateConfig>(map['launchTemplateConfigs']!, (value) => FleetLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      targetCapacitySpecification: pulumi.Input.fromValue(FleetTargetCapacitySpecification.fromMap((map['targetCapacitySpecification']! as Map).cast<String, dynamic>())),
