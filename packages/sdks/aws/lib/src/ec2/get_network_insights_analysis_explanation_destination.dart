...
class GetNetworkInsightsAnalysisExplanationDestination {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationDestination].
  ...
  const GetNetworkInsightsAnalysisExplanationDestination({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationDestination.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationDestination(
