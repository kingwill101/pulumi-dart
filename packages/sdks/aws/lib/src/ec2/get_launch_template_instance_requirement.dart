...
class GetLaunchTemplateInstanceRequirement {
  final pulumi.Input<List<GetLaunchTemplateInstanceRequirementAcceleratorCount>>
  acceleratorCounts;
  final pulumi.Input<List<String>> acceleratorManufacturers;
  final pulumi.Input<List<String>> acceleratorNames;
  final pulumi.Input<
    List<GetLaunchTemplateInstanceRequirementAcceleratorTotalMemoryMib>
  >
  ...
  final pulumi.Input<
    List<GetLaunchTemplateInstanceRequirementBaselineEbsBandwidthMbp>
  >
  ...
  final pulumi.Input<
    List<GetLaunchTemplateInstanceRequirementMemoryGibPerVcpus>
  >
  memoryGibPerVcpus;
  final pulumi.Input<List<GetLaunchTemplateInstanceRequirementMemoryMib>>
  memoryMibs;
  final pulumi.Input<
    List<GetLaunchTemplateInstanceRequirementNetworkBandwidthGbp>
  >
  ...
  final pulumi.Input<
    List<GetLaunchTemplateInstanceRequirementTotalLocalStorageGb>
  >
  totalLocalStorageGbs;
  final pulumi.Input<List<GetLaunchTemplateInstanceRequirementVcpuCount>>
  vcpuCounts;
    ...
    return <String, dynamic>{
      'acceleratorCounts':
          pulumi.Input.mapInputValue<
            List<GetLaunchTemplateInstanceRequirementAcceleratorCount>,
      ...
      'memoryMibs':
          pulumi.Input.mapInputValue<
            List<GetLaunchTemplateInstanceRequirementMemoryMib>,
            List<Map<String, dynamic>>
          >(
            memoryMibs,
            (value) =>
      ...
      'vcpuCounts':
          pulumi.Input.mapInputValue<
            List<GetLaunchTemplateInstanceRequirementVcpuCount>,
            List<Map<String, dynamic>>
          >(
            vcpuCounts,
            (value) =>
  ...
  factory GetLaunchTemplateInstanceRequirement.fromMap(
    ...
    return GetLaunchTemplateInstanceRequirement(
      ...
      memoryMibs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLaunchTemplateInstanceRequirementMemoryMib>(
          map['memoryMibs']!,
      ...
      vcpuCounts: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLaunchTemplateInstanceRequirementVcpuCount>(
          map['vcpuCounts']!,
