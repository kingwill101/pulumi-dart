...
class GetVpnConnectionArgs {
  ...
  factory GetVpnConnectionArgs.fromMap(Map<String, dynamic> map) {
    return GetVpnConnectionArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetVpnConnectionFilter>(guardedValue, (value) => GetVpnConnectionFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
