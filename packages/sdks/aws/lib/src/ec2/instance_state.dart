...
class InstanceState {
  ...
  final pulumi.Input<String>? instanceLifecycle;
  ...
  /// [passwordData] Base-64 encoded encrypted password data for the instance. Useful for getting the administrator password for instances running Microsoft Windows. This attribute is only exported if `get_password_data` is true. Note that this encrypted value will be stored in the state file, as with all exported attributes. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
  ...
  InstanceState({
    ...
    pulumi.Output<InstanceCapacityReservationSpecification>? capacityReservationSpecification,
    pulumi.Output<InstanceCpuOptions>? cpuOptions,
    pulumi.Output<InstanceCreditSpecification>? creditSpecification,
    pulumi.Output<bool>? disableApiStop,
    pulumi.Output<bool>? disableApiTermination,
    pulumi.Output<List<InstanceEbsBlockDevice>>? ebsBlockDevices,
    pulumi.Output<bool>? ebsOptimized,
    pulumi.Output<bool>? enablePrimaryIpv6,
    pulumi.Output<InstanceEnclaveOptions>? enclaveOptions,
    pulumi.Output<List<InstanceEphemeralBlockDevice>>? ephemeralBlockDevices,
    ...
    pulumi.Output<String>? instanceLifecycle,
    pulumi.Output<InstanceInstanceMarketOptions>? instanceMarketOptions,
    ...
    pulumi.Output<InstanceLaunchTemplate>? launchTemplate,
    pulumi.Output<InstanceMaintenanceOptions>? maintenanceOptions,
    pulumi.Output<InstanceMetadataOptions>? metadataOptions,
    pulumi.Output<bool>? monitoring,
    pulumi.Output<List<InstanceNetworkInterface>>? networkInterfaces,
    ...
    pulumi.Output<InstancePrimaryNetworkInterface>? primaryNetworkInterface,
    pulumi.Output<String>? primaryNetworkInterfaceId,
    pulumi.Output<String>? privateDns,
    pulumi.Output<InstancePrivateDnsNameOptions>? privateDnsNameOptions,
    pulumi.Output<String>? privateIp,
    pulumi.Output<String>? publicDns,
    pulumi.Output<String>? publicIp,
    pulumi.Output<String>? region,
    pulumi.Output<InstanceRootBlockDevice>? rootBlockDevice,
    pulumi.Output<List<InstanceSecondaryNetworkInterface>>? secondaryNetworkInterfaces,
    pulumi.Output<List<String>>? secondaryPrivateIps,
    pulumi.Output<List<String>>? securityGroups,
    pulumi.Output<bool>? sourceDestCheck,
    pulumi.Output<String>? spotInstanceRequestId,
    ...
    pulumi.Output<List<String>>? vpcSecurityGroupIds,
      ...
      instanceLifecycle = pulumi.Input.asOptionalInput<String>(instanceLifecycle),
      ...
      spotInstanceRequestId = pulumi.Input.asOptionalInput<String>(spotInstanceRequestId),
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : pulumi.Output.create<InstanceCapacityReservationSpecification>(InstanceCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>())),
      ...
      creditSpecification: map['creditSpecification'] == null ? null : pulumi.Output.create<InstanceCreditSpecification>(InstanceCreditSpecification.fromMap((map['creditSpecification'] as Map).cast<String, dynamic>())),
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : pulumi.Output.create<List<InstanceEbsBlockDevice>>(pulumi.Input.decodeList<InstanceEbsBlockDevice>(map['ebsBlockDevices'], (value) => InstanceEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      enclaveOptions: map['enclaveOptions'] == null ? null : pulumi.Output.create<InstanceEnclaveOptions>(InstanceEnclaveOptions.fromMap((map['enclaveOptions'] as Map).cast<String, dynamic>())),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : pulumi.Output.create<List<InstanceEphemeralBlockDevice>>(pulumi.Input.decodeList<InstanceEphemeralBlockDevice>(map['ephemeralBlockDevices'], (value) => InstanceEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      instanceLifecycle: map['instanceLifecycle'] == null ? null : pulumi.Output.create<String>(map['instanceLifecycle'] as String),
      instanceMarketOptions: map['instanceMarketOptions'] == null ? null : pulumi.Output.create<InstanceInstanceMarketOptions>(InstanceInstanceMarketOptions.fromMap((map['instanceMarketOptions'] as Map).cast<String, dynamic>())),
      ...
      launchTemplate: map['launchTemplate'] == null ? null : pulumi.Output.create<InstanceLaunchTemplate>(InstanceLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>())),
      maintenanceOptions: map['maintenanceOptions'] == null ? null : pulumi.Output.create<InstanceMaintenanceOptions>(InstanceMaintenanceOptions.fromMap((map['maintenanceOptions'] as Map).cast<String, dynamic>())),
      metadataOptions: map['metadataOptions'] == null ? null : pulumi.Output.create<InstanceMetadataOptions>(InstanceMetadataOptions.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>())),
      monitoring: map['monitoring'] == null ? null : pulumi.Output.create<bool>(map['monitoring'] as bool),
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Output.create<List<InstanceNetworkInterface>>(pulumi.Input.decodeList<InstanceNetworkInterface>(map['networkInterfaces'], (value) => InstanceNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      primaryNetworkInterface: map['primaryNetworkInterface'] == null ? null : pulumi.Output.create<InstancePrimaryNetworkInterface>(InstancePrimaryNetworkInterface.fromMap((map['primaryNetworkInterface'] as Map).cast<String, dynamic>())),
      ...
      privateDnsNameOptions: map['privateDnsNameOptions'] == null ? null : pulumi.Output.create<InstancePrivateDnsNameOptions>(InstancePrivateDnsNameOptions.fromMap((map['privateDnsNameOptions'] as Map).cast<String, dynamic>())),
      ...
      rootBlockDevice: map['rootBlockDevice'] == null ? null : pulumi.Output.create<InstanceRootBlockDevice>(InstanceRootBlockDevice.fromMap((map['rootBlockDevice'] as Map).cast<String, dynamic>())),
      secondaryNetworkInterfaces: map['secondaryNetworkInterfaces'] == null ? null : pulumi.Output.create<List<InstanceSecondaryNetworkInterface>>(pulumi.Input.decodeList<InstanceSecondaryNetworkInterface>(map['secondaryNetworkInterfaces'], (value) => InstanceSecondaryNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      spotInstanceRequestId: map['spotInstanceRequestId'] == null ? null : pulumi.Output.create<String>(map['spotInstanceRequestId'] as String),
