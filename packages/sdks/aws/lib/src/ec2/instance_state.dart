...
class InstanceState {
  ...
  factory InstanceState.fromMap(Map<String, dynamic> map) {
    return InstanceState(
      ...
      capacityReservationSpecification: map['capacityReservationSpecification'] == null ? null : (InstanceCapacityReservationSpecification.fromMap((map['capacityReservationSpecification'] as Map).cast<String, dynamic>())).input(),
      cpuOptions: map['cpuOptions'] == null ? null : (InstanceCpuOptions.fromMap((map['cpuOptions'] as Map).cast<String, dynamic>())).input(),
      creditSpecification: map['creditSpecification'] == null ? null : (InstanceCreditSpecification.fromMap((map['creditSpecification'] as Map).cast<String, dynamic>())).input(),
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : (pulumi.Input.decodeList<InstanceEbsBlockDevice>(map['ebsBlockDevices'], (value) => InstanceEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      enclaveOptions: map['enclaveOptions'] == null ? null : (InstanceEnclaveOptions.fromMap((map['enclaveOptions'] as Map).cast<String, dynamic>())).input(),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : (pulumi.Input.decodeList<InstanceEphemeralBlockDevice>(map['ephemeralBlockDevices'], (value) => InstanceEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      instanceLifecycle: map['instanceLifecycle'] == null ? null : (map['instanceLifecycle'] as String).input(),
      instanceMarketOptions: map['instanceMarketOptions'] == null ? null : (InstanceInstanceMarketOptions.fromMap((map['instanceMarketOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      launchTemplate: map['launchTemplate'] == null ? null : (InstanceLaunchTemplate.fromMap((map['launchTemplate'] as Map).cast<String, dynamic>())).input(),
      maintenanceOptions: map['maintenanceOptions'] == null ? null : (InstanceMaintenanceOptions.fromMap((map['maintenanceOptions'] as Map).cast<String, dynamic>())).input(),
      metadataOptions: map['metadataOptions'] == null ? null : (InstanceMetadataOptions.fromMap((map['metadataOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      primaryNetworkInterface: map['primaryNetworkInterface'] == null ? null : (InstancePrimaryNetworkInterface.fromMap((map['primaryNetworkInterface'] as Map).cast<String, dynamic>())).input(),
      ...
      privateDnsNameOptions: map['privateDnsNameOptions'] == null ? null : (InstancePrivateDnsNameOptions.fromMap((map['privateDnsNameOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      rootBlockDevice: map['rootBlockDevice'] == null ? null : (InstanceRootBlockDevice.fromMap((map['rootBlockDevice'] as Map).cast<String, dynamic>())).input(),
      secondaryNetworkInterfaces: map['secondaryNetworkInterfaces'] == null ? null : (pulumi.Input.decodeList<InstanceSecondaryNetworkInterface>(map['secondaryNetworkInterfaces'], (value) => InstanceSecondaryNetworkInterface.fromMap((value as Map).cast<String, dynamic>()))).input(),
