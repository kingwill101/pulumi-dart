...
class GetNetworkInsightsPathFilterAtSource {
  ...
  final pulumi.Input<
    List<GetNetworkInsightsPathFilterAtSourceDestinationPortRange>
  >
  destinationPortRanges;
  final pulumi.Input<String> sourceAddress;
  final pulumi.Input<List<GetNetworkInsightsPathFilterAtSourceSourcePortRange>>
  sourcePortRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sourcePortRanges':
          pulumi.Input.mapInputValue<
            List<GetNetworkInsightsPathFilterAtSourceSourcePortRange>,
            List<Map<String, dynamic>>
          >(
            sourcePortRanges,
            (value) =>
  ...
  factory GetNetworkInsightsPathFilterAtSource.fromMap(
