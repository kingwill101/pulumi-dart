...
class GetNetworkAclsArgs {
  ...
  factory GetNetworkAclsArgs.fromMap(Map<String, dynamic> map) {
    return GetNetworkAclsArgs(
      filters: map['filters'] == null ? null : (pulumi.Input.decodeList<GetNetworkAclsFilter>(map['filters'], (value) => GetNetworkAclsFilter.fromMap((value as Map).cast<String, dynamic>()))).input(),
