...
class GetNetworkAclsArgs {
  ...
  factory GetNetworkAclsArgs.fromMap(Map<String, dynamic> map) {
    return GetNetworkAclsArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetNetworkAclsFilter>(guardedValue, (value) => GetNetworkAclsFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
