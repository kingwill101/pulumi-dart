...
class GetPublicIpv4PoolsArgs {
  ...
  GetPublicIpv4PoolsArgs({
    pulumi.Output<List<GetPublicIpv4PoolsFilter>>? filters,
  ...
  factory GetPublicIpv4PoolsArgs.fromMap(Map<String, dynamic> map) {
    return GetPublicIpv4PoolsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetPublicIpv4PoolsFilter>>(pulumi.Input.decodeList<GetPublicIpv4PoolsFilter>(map['filters'], (value) => GetPublicIpv4PoolsFilter.fromMap((value as Map).cast<String, dynamic>()))),
