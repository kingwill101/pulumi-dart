...
class VpnConnectionTunnel2LogOptions {
  ...
  final VpnConnectionTunnel2LogOptionsCloudwatchLogOptions? cloudwatchLogOptions;
  ...
  factory VpnConnectionTunnel2LogOptions.fromMap(Map<String, dynamic> map) {
    return VpnConnectionTunnel2LogOptions(
      cloudwatchLogOptions: map['cloudwatchLogOptions'] == null ? null : VpnConnectionTunnel2LogOptionsCloudwatchLogOptions.fromMap((map['cloudwatchLogOptions'] as Map).cast<String, dynamic>()),
    );
  }
}
