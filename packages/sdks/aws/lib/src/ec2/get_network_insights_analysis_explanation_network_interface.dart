...
class GetNetworkInsightsAnalysisExplanationNetworkInterface {
  ...
  const GetNetworkInsightsAnalysisExplanationNetworkInterface({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationNetworkInterface.fromMap(Map<String, dynamic> map) {
