...
class GetLocalGatewayArgs {
  ...
  factory GetLocalGatewayArgs.fromMap(Map<String, dynamic> map) {
    return GetLocalGatewayArgs(
      filters: map['filters'] == null ? null : ((pulumi.Input.decodeList<GetLocalGatewayFilter>(map['filters']!, (value) => GetLocalGatewayFilter.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
