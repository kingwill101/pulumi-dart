...
class AmiArgs {
  ...
  factory AmiArgs.fromMap(Map<String, dynamic> map) {
    return AmiArgs(
      ...
      ebsBlockDevices: map['ebsBlockDevices'] == null ? null : ((pulumi.Input.decodeList<AmiEbsBlockDevice>(map['ebsBlockDevices']!, (value) => AmiEbsBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      enaSupport: map['enaSupport'] == null ? null : ((map['enaSupport'] as bool).input()).input(),
      ephemeralBlockDevices: map['ephemeralBlockDevices'] == null ? null : ((pulumi.Input.decodeList<AmiEphemeralBlockDevice>(map['ephemeralBlockDevices']!, (value) => AmiEphemeralBlockDevice.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
