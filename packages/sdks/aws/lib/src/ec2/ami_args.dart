    ...
    return AmiArgs(
      ...
      ebsBlockDevices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AmiEbsBlockDevice>(
            guardedValue,
            (value) => AmiEbsBlockDevice.fromMap(
      ...
      ephemeralBlockDevices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<AmiEphemeralBlockDevice>(
            guardedValue,
            (value) => AmiEphemeralBlockDevice.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
