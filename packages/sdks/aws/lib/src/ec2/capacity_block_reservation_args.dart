...
class CapacityBlockReservationArgs {
  ...
  factory CapacityBlockReservationArgs.fromMap(Map<String, dynamic> map) {
    return CapacityBlockReservationArgs(
      capacityBlockOfferingId: pulumi.Input.fromValue(
        map['capacityBlockOfferingId'] as String,
      ),
      instancePlatform: pulumi.Input.fromValue(
        map['instancePlatform'] as String,
      ),
      region: (() {
