...
class VpcEncryptionControlState {
  ...
  factory VpcEncryptionControlState.fromMap(Map<String, dynamic> map) {
    return VpcEncryptionControlState(
      ...
      resourceExclusions: map['resourceExclusions'] == null ? null : (VpcEncryptionControlResourceExclusions.fromMap((map['resourceExclusions'] as Map).cast<String, dynamic>())).input(),
