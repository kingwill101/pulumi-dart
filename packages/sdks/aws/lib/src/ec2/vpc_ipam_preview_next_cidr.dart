...
import 'vpc_ipam_preview_next_cidr_state.dart';
...
class VpcIpamPreviewNextCidr extends pulumi.CustomResource {
  ...
  /// Creates a new [VpcIpamPreviewNextCidr].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [VpcIpamPreviewNextCidr]. {@macro pulumi_ec2_vpc_ipam_preview_next_cidr_vpc_ipam_preview_next_cidr_args_doc}
  ...
  /// Gets an existing [VpcIpamPreviewNextCidr] resource's state with the given [name] and [id].
  static VpcIpamPreviewNextCidr get(
    String name,
