...
class DefaultNetworkAcl extends pulumi.CustomResource {
  ...
  /// Creates a new [DefaultNetworkAcl].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DefaultNetworkAcl]. {@macro pulumi_ec2_default_network_acl_default_network_acl_args_doc}
