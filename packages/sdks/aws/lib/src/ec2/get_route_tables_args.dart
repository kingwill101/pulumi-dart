...
class GetRouteTablesArgs {
  ...
  factory GetRouteTablesArgs.fromMap(Map<String, dynamic> map) {
    return GetRouteTablesArgs(
      filters: (() { final guardedValue = map['filters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetRouteTablesFilter>(guardedValue, (value) => GetRouteTablesFilter.fromMap((value as Map).cast<String, dynamic>()))); })(),
