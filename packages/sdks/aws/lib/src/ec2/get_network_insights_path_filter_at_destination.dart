...
class GetNetworkInsightsPathFilterAtDestination {
  ...
  final pulumi.Input<
    List<GetNetworkInsightsPathFilterAtDestinationDestinationPortRange>
  >
  destinationPortRanges;
  final pulumi.Input<String> sourceAddress;
  final pulumi.Input<
    List<GetNetworkInsightsPathFilterAtDestinationSourcePortRange>
  >
  sourcePortRanges;
    ...
    return GetNetworkInsightsPathFilterAtDestination(
      ...
      destinationPortRanges: pulumi.Input.fromValue(
        ...
        >(
          ...
          (value) =>
              GetNetworkInsightsPathFilterAtDestinationDestinationPortRange.fromMap(
