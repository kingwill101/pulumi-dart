...
class CapacityBlockReservationState {
  ...
  factory CapacityBlockReservationState.fromMap(Map<String, dynamic> map) {
    return CapacityBlockReservationState(
      ...
      capacityBlockOfferingId: map['capacityBlockOfferingId'] == null ? null : (map['capacityBlockOfferingId'] as String).input(),
      ...
      instancePlatform: map['instancePlatform'] == null ? null : (map['instancePlatform'] as String).input(),
      ...
      timeouts: map['timeouts'] == null ? null : (CapacityBlockReservationTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
