...
class LocalGatewayRouteTableTimeouts {
  ...
  /// Creates a new [LocalGatewayRouteTableTimeouts].
  ...
  const LocalGatewayRouteTableTimeouts({
    this.create,
    this.delete,
  });
  ...
  factory LocalGatewayRouteTableTimeouts.fromMap(Map<String, dynamic> map) {
    return LocalGatewayRouteTableTimeouts(
