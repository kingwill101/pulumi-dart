...
class GetNetworkInsightsAnalysisExplanationIngressRouteTable {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationIngressRouteTable].
  ...
  const GetNetworkInsightsAnalysisExplanationIngressRouteTable({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationIngressRouteTable.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationIngressRouteTable(
