...
class TrafficMirrorFilter extends pulumi.CustomResource {
  ...
  TrafficMirrorFilter(
    ...
    networkServices = registerOutput<List<String>?>('networkServices', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); });
  ...
  /// Creates a typed reference to an existing [TrafficMirrorFilter] resource.
  TrafficMirrorFilter.reference(String urn)
    : super(
        'aws:ec2/trafficMirrorFilter:TrafficMirrorFilter',
