...
class EncryptionControlState {
  ...
  factory EncryptionControlState.fromMap(Map<String, dynamic> map) {
    return EncryptionControlState(
      ...
      resourceExclusions: map['resourceExclusions'] == null ? null : ((EncryptionControlResourceExclusions.fromMap((map['resourceExclusions']! as Map).cast<String, dynamic>())).input()).input(),
