...
class EncryptionControlState {
  ...
  EncryptionControlState({
    ...
    pulumi.Output<EncryptionControlResourceExclusions>? resourceExclusions,
    pulumi.Output<String>? state,
    pulumi.Output<String>? stateMessage,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<Map<String, String>>? tagsAll,
    pulumi.Output<EncryptionControlTimeouts>? timeouts,
    ...
    pulumi.Output<String>? vpcPeeringExclusion,
      ...
      resourceExclusions = pulumi.Input.asOptionalInput<EncryptionControlResourceExclusions>(resourceExclusions),
      state = pulumi.Input.asOptionalInput<String>(state),
      stateMessage = pulumi.Input.asOptionalInput<String>(stateMessage),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      tagsAll = pulumi.Input.asOptionalInput<Map<String, String>>(tagsAll),
      timeouts = pulumi.Input.asOptionalInput<EncryptionControlTimeouts>(timeouts),
  ...
  factory EncryptionControlState.fromMap(Map<String, dynamic> map) {
    return EncryptionControlState(
      ...
      resourceExclusions: map['resourceExclusions'] == null ? null : pulumi.Output.create<EncryptionControlResourceExclusions>(EncryptionControlResourceExclusions.fromMap((map['resourceExclusions'] as Map).cast<String, dynamic>())),
      ...
      timeouts: map['timeouts'] == null ? null : pulumi.Output.create<EncryptionControlTimeouts>(EncryptionControlTimeouts.fromMap((map['timeouts'] as Map).cast<String, dynamic>())),
