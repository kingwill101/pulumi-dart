...
class LaunchTemplate extends pulumi.CustomResource {
  ...
  LaunchTemplate(
    ...
    licenseSpecifications = registerOutput<List<Map<String, dynamic>>?>(
    ...
    secondaryInterfaces = registerOutput<List<Map<String, dynamic>>?>(
      'secondaryInterfaces',
    );
    securityGroupNames = registerOutput<List<String>?>('securityGroupNames');
    tagSpecifications = registerOutput<List<Map<String, dynamic>>?>(
      'tagSpecifications',
    );
