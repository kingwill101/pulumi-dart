...
class LaunchTemplate extends pulumi.CustomResource {
  ...
  LaunchTemplate(
    ...
    this.blockDeviceMappings = registerOutput<List<LaunchTemplateBlockDeviceMapping>?>('blockDeviceMappings');
    this.capacityReservationSpecification = registerOutput<LaunchTemplateCapacityReservationSpecification?>('capacityReservationSpecification');
    this.cpuOptions = registerOutput<LaunchTemplateCpuOptions?>('cpuOptions');
    this.creditSpecification = registerOutput<LaunchTemplateCreditSpecification?>('creditSpecification');
    ...
    this.enclaveOptions = registerOutput<LaunchTemplateEnclaveOptions?>('enclaveOptions');
    this.hibernationOptions = registerOutput<LaunchTemplateHibernationOptions?>('hibernationOptions');
    this.iamInstanceProfile = registerOutput<LaunchTemplateIamInstanceProfile?>('iamInstanceProfile');
    ...
    this.instanceMarketOptions = registerOutput<LaunchTemplateInstanceMarketOptions?>('instanceMarketOptions');
    this.instanceRequirements = registerOutput<LaunchTemplateInstanceRequirements?>('instanceRequirements');
    ...
    this.licenseSpecifications = registerOutput<List<LaunchTemplateLicenseSpecification>?>('licenseSpecifications');
    this.maintenanceOptions = registerOutput<LaunchTemplateMaintenanceOptions?>('maintenanceOptions');
    this.metadataOptions = registerOutput<LaunchTemplateMetadataOptions>('metadataOptions');
    this.monitoring = registerOutput<LaunchTemplateMonitoring?>('monitoring');
    this.name = registerOutput<String>('name');
    this.namePrefix = registerOutput<String>('namePrefix');
    this.networkInterfaces = registerOutput<List<LaunchTemplateNetworkInterface>?>('networkInterfaces');
    this.networkPerformanceOptions = registerOutput<LaunchTemplateNetworkPerformanceOptions?>('networkPerformanceOptions');
    this.placement = registerOutput<LaunchTemplatePlacement?>('placement');
    this.privateDnsNameOptions = registerOutput<LaunchTemplatePrivateDnsNameOptions?>('privateDnsNameOptions');
    this.ramDiskId = registerOutput<String?>('ramDiskId');
    this.region = registerOutput<String>('region');
    this.secondaryInterfaces = registerOutput<List<LaunchTemplateSecondaryInterface>?>('secondaryInterfaces');
    this.securityGroupNames = registerOutput<List<String>?>('securityGroupNames');
    this.tagSpecifications = registerOutput<List<LaunchTemplateTagSpecification>?>('tagSpecifications');
