...
import 'network_interface_security_group_attachment_state.dart';
...
class NetworkInterfaceSecurityGroupAttachment extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [NetworkInterfaceSecurityGroupAttachment]. {@macro pulumi_ec2_network_interface_security_group_attachment_network_interface_security_group_attachment_args_doc}
  ...
  static NetworkInterfaceSecurityGroupAttachment get(
    String name,
  ...
  NetworkInterfaceSecurityGroupAttachment._get(
    String name, {
