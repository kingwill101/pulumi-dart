...
class DefaultVpcState {
  ...
  factory DefaultVpcState.fromMap(Map<String, dynamic> map) {
    return DefaultVpcState(
      ...
      defaultSecurityGroupId: map['defaultSecurityGroupId'] == null ? null : (map['defaultSecurityGroupId'] as String).input(),
      ...
      existingDefaultVpc: map['existingDefaultVpc'] == null ? null : (map['existingDefaultVpc'] as bool).input(),
      forceDestroy: map['forceDestroy'] == null ? null : (map['forceDestroy'] as bool).input(),
      instanceTenancy: map['instanceTenancy'] == null ? null : (map['instanceTenancy'] as String).input(),
      ipv6AssociationId: map['ipv6AssociationId'] == null ? null : (map['ipv6AssociationId'] as String).input(),
      ...
      mainRouteTableId: map['mainRouteTableId'] == null ? null : (map['mainRouteTableId'] as String).input(),
