...
class GetNetworkInsightsAnalysisReturnPathComponentAttachedTo {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisReturnPathComponentAttachedTo].
  ...
  const GetNetworkInsightsAnalysisReturnPathComponentAttachedTo({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponentAttachedTo.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisReturnPathComponentAttachedTo(
