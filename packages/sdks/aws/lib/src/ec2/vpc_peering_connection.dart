...
import 'vpc_peering_connection_state.dart';
...
class VpcPeeringConnection extends pulumi.CustomResource {
  ...
  /// Gets an existing [VpcPeeringConnection] resource's state with the given [name] and [id].
  static VpcPeeringConnection get(
    String name,
