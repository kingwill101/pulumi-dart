...
class GetNetworkInsightsAnalysisReturnPathComponentVpc {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisReturnPathComponentVpc].
  ...
  const GetNetworkInsightsAnalysisReturnPathComponentVpc({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisReturnPathComponentVpc.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisReturnPathComponentVpc(
