...
class AllowedImagesSettingsImageCriterion {
  ...
  /// [deprecationTimeCondition] Condition based on AMI deprecation time. See `deprecationTimeCondition` below.
  ...
  factory AllowedImagesSettingsImageCriterion.fromMap(Map<String, dynamic> map) {
    return AllowedImagesSettingsImageCriterion(
      creationDateCondition: (() { final guardedValue = map['creationDateCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllowedImagesSettingsImageCriterionCreationDateCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      deprecationTimeCondition: (() { final guardedValue = map['deprecationTimeCondition']; if (guardedValue == null) return null; return pulumi.Input.fromValue(AllowedImagesSettingsImageCriterionDeprecationTimeCondition.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      imageProviders: (() { final guardedValue = map['imageProviders']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      marketplaceProductCodes: (() { final guardedValue = map['marketplaceProductCodes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
