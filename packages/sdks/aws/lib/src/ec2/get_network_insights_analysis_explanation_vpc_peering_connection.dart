...
class GetNetworkInsightsAnalysisExplanationVpcPeeringConnection {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationVpcPeeringConnection].
  ...
  const GetNetworkInsightsAnalysisExplanationVpcPeeringConnection({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationVpcPeeringConnection.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationVpcPeeringConnection(
