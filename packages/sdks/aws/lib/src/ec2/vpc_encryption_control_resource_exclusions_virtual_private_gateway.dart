...
class VpcEncryptionControlResourceExclusionsVirtualPrivateGateway {
  ...
  /// Creates a new [VpcEncryptionControlResourceExclusionsVirtualPrivateGateway].
  ...
  const VpcEncryptionControlResourceExclusionsVirtualPrivateGateway({
    required this.state,
  ...
  factory VpcEncryptionControlResourceExclusionsVirtualPrivateGateway.fromMap(Map<String, dynamic> map) {
