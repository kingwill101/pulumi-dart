...
class NetworkInterfaceState {
  ...
  factory NetworkInterfaceState.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceState(
      ...
      attachments: map['attachments'] == null ? null : ((pulumi.Input.decodeList<NetworkInterfaceAttachment>(map['attachments']!, (value) => NetworkInterfaceAttachment.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      ipv6AddressListEnabled: map['ipv6AddressListEnabled'] == null ? null : ((map['ipv6AddressListEnabled'] as bool).input()).input(),
      ipv6AddressLists: map['ipv6AddressLists'] == null ? null : (((map['ipv6AddressLists'] as List).cast<String>()).input()).input(),
      ...
      privateIpListEnabled: map['privateIpListEnabled'] == null ? null : ((map['privateIpListEnabled'] as bool).input()).input(),
      privateIpLists: map['privateIpLists'] == null ? null : (((map['privateIpLists'] as List).cast<String>()).input()).input(),
      privateIps: map['privateIps'] == null ? null : (((map['privateIps'] as List).cast<String>()).input()).input(),
      privateIpsCount: map['privateIpsCount'] == null ? null : ((map['privateIpsCount'] as int).input()).input(),
