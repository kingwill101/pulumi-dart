    ...
    return NetworkInterfaceState(
      ...
      attachments: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkInterfaceAttachment>(
            guardedValue,
            (value) => NetworkInterfaceAttachment.fromMap(
      ...
      ipv6AddressListEnabled: (() {
        final guardedValue = map['ipv6AddressListEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      ipv6AddressLists: (() {
        final guardedValue = map['ipv6AddressLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      ipv6Addresses: (() {
      ...
      privateIpListEnabled: (() {
        final guardedValue = map['privateIpListEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      privateIpLists: (() {
        final guardedValue = map['privateIpLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      privateIps: (() {
