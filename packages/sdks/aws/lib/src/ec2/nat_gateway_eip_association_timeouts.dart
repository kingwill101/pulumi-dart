...
class NatGatewayEipAssociationTimeouts {
  ...
  /// Creates a new [NatGatewayEipAssociationTimeouts].
  ...
  NatGatewayEipAssociationTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory NatGatewayEipAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return NatGatewayEipAssociationTimeouts(
      create: (() {
