...
class LaunchTemplateNetworkInterface {
  ...
  factory LaunchTemplateNetworkInterface.fromMap(Map<String, dynamic> map) {
    return LaunchTemplateNetworkInterface(
      associateCarrierIpAddress: map['associateCarrierIpAddress'] == null ? null : (map['associateCarrierIpAddress'] as String).input(),
      associatePublicIpAddress: map['associatePublicIpAddress'] == null ? null : (map['associatePublicIpAddress'] as String).input(),
      connectionTrackingSpecification: map['connectionTrackingSpecification'] == null ? null : (LaunchTemplateNetworkInterfaceConnectionTrackingSpecification.fromMap((map['connectionTrackingSpecification'] as Map).cast<String, dynamic>())).input(),
      ...
      enaSrdSpecification: map['enaSrdSpecification'] == null ? null : (LaunchTemplateNetworkInterfaceEnaSrdSpecification.fromMap((map['enaSrdSpecification'] as Map).cast<String, dynamic>())).input(),
      interfaceType: map['interfaceType'] == null ? null : (map['interfaceType'] as String).input(),
      ipv4AddressCount: map['ipv4AddressCount'] == null ? null : (map['ipv4AddressCount'] as int).input(),
      ...
      primaryIpv6: map['primaryIpv6'] == null ? null : (map['primaryIpv6'] as String).input(),
