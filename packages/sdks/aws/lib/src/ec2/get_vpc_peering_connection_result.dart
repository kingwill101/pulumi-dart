...
class GetVpcPeeringConnectionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accepter': accepter,
      'cidrBlock': cidrBlock,
      'cidrBlockSets': pulumi.Input.encodeList<GetVpcPeeringConnectionCidrBlockSet, Map<String, dynamic>>(cidrBlockSets, (value) => value.toMap()),
      'filters': ?filters == null ? null : pulumi.Input.encodeList<GetVpcPeeringConnectionFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
      'id': id,
      'ipv6CidrBlockSets': pulumi.Input.encodeList<GetVpcPeeringConnectionIpv6CidrBlockSet, Map<String, dynamic>>(ipv6CidrBlockSets, (value) => value.toMap()),
      'ownerId': ownerId,
      'peerCidrBlock': peerCidrBlock,
      'peerCidrBlockSets': pulumi.Input.encodeList<GetVpcPeeringConnectionPeerCidrBlockSet, Map<String, dynamic>>(peerCidrBlockSets, (value) => value.toMap()),
      'peerIpv6CidrBlockSets': pulumi.Input.encodeList<GetVpcPeeringConnectionPeerIpv6CidrBlockSet, Map<String, dynamic>>(peerIpv6CidrBlockSets, (value) => value.toMap()),
  ...
  factory GetVpcPeeringConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetVpcPeeringConnectionResult(
      ...
      cidrBlockSets: pulumi.Input.decodeList<GetVpcPeeringConnectionCidrBlockSet>(map['cidrBlockSets'], (value) => GetVpcPeeringConnectionCidrBlockSet.fromMap((value as Map).cast<String, dynamic>())),
      ...
      id: map['id'] as String,
      ipv6CidrBlockSets: pulumi.Input.decodeList<GetVpcPeeringConnectionIpv6CidrBlockSet>(map['ipv6CidrBlockSets'], (value) => GetVpcPeeringConnectionIpv6CidrBlockSet.fromMap((value as Map).cast<String, dynamic>())),
      ownerId: map['ownerId'] as String,
      peerCidrBlock: map['peerCidrBlock'] as String,
      peerCidrBlockSets: pulumi.Input.decodeList<GetVpcPeeringConnectionPeerCidrBlockSet>(map['peerCidrBlockSets'], (value) => GetVpcPeeringConnectionPeerCidrBlockSet.fromMap((value as Map).cast<String, dynamic>())),
      peerIpv6CidrBlockSets: pulumi.Input.decodeList<GetVpcPeeringConnectionPeerIpv6CidrBlockSet>(map['peerIpv6CidrBlockSets'], (value) => GetVpcPeeringConnectionPeerIpv6CidrBlockSet.fromMap((value as Map).cast<String, dynamic>())),
