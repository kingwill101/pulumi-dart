...
import 'image_block_public_access_state.dart';
...
class ImageBlockPublicAccess extends pulumi.CustomResource {
  ...
  /// Creates a new [ImageBlockPublicAccess].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ImageBlockPublicAccess]. {@macro pulumi_ec2_image_block_public_access_image_block_public_access_args_doc}
  ...
  /// Gets an existing [ImageBlockPublicAccess] resource's state with the given [name] and [id].
  static ImageBlockPublicAccess get(
    String name,
