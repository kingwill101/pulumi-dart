...
class GetVpcPeeringConnectionsArgs {
  ...
  GetVpcPeeringConnectionsArgs({
    pulumi.Output<List<GetVpcPeeringConnectionsFilter>>? filters,
    pulumi.Output<String>? region,
    pulumi.Output<Map<String, String>>? tags,
  }) :
      filters = pulumi.Input.asOptionalInput<List<GetVpcPeeringConnectionsFilter>>(filters),
  ...
  factory GetVpcPeeringConnectionsArgs.fromMap(Map<String, dynamic> map) {
    return GetVpcPeeringConnectionsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetVpcPeeringConnectionsFilter>>(pulumi.Input.decodeList<GetVpcPeeringConnectionsFilter>(map['filters'], (value) => GetVpcPeeringConnectionsFilter.fromMap((value as Map).cast<String, dynamic>()))),
