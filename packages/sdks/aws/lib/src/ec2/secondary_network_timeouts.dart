...
class SecondaryNetworkTimeouts {
  ...
  /// Creates a new [SecondaryNetworkTimeouts].
  ...
  SecondaryNetworkTimeouts({this.create, this.delete, this.update});
  ...
  factory SecondaryNetworkTimeouts.fromMap(Map<String, dynamic> map) {
    return SecondaryNetworkTimeouts(
      create: (() {
