...
class SecondaryNetworkState {
  ...
  factory SecondaryNetworkState.fromMap(Map<String, dynamic> map) {
    return SecondaryNetworkState(
      ...
      ipv4CidrBlockAssociations: (() { final guardedValue = map['ipv4CidrBlockAssociations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SecondaryNetworkIpv4CidrBlockAssociation>(guardedValue, (value) => SecondaryNetworkIpv4CidrBlockAssociation.fromMap((value as Map).cast<String, dynamic>()))); })(),
