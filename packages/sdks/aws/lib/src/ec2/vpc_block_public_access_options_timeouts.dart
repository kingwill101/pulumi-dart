...
class VpcBlockPublicAccessOptionsTimeouts {
  ...
  /// Creates a new [VpcBlockPublicAccessOptionsTimeouts].
  ...
  const VpcBlockPublicAccessOptionsTimeouts({
    this.create,
    this.delete,
    this.update,
  });
  ...
  factory VpcBlockPublicAccessOptionsTimeouts.fromMap(Map<String, dynamic> map) {
