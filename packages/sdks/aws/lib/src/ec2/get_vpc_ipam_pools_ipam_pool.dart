...
class GetVpcIpamPoolsIpamPool {
  ...
  factory GetVpcIpamPoolsIpamPool.fromMap(Map<String, dynamic> map) {
    return GetVpcIpamPoolsIpamPool(
      ...
      allocationDefaultNetmaskLength: pulumi.Input.fromValue(
        map['allocationDefaultNetmaskLength'] as int,
      ),
      allocationMaxNetmaskLength: pulumi.Input.fromValue(
        map['allocationMaxNetmaskLength'] as int,
      ),
      allocationMinNetmaskLength: pulumi.Input.fromValue(
        map['allocationMinNetmaskLength'] as int,
      ),
      allocationResourceTags: pulumi.Input.fromValue(
      ...
      publiclyAdvertisable: pulumi.Input.fromValue(
