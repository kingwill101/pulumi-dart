...
class NatGatewayState {
  ...
  factory NatGatewayState.fromMap(Map<String, dynamic> map) {
    return NatGatewayState(
      ...
      autoProvisionZones: map['autoProvisionZones'] == null ? null : (map['autoProvisionZones'] as String).input(),
      autoScalingIps: map['autoScalingIps'] == null ? null : (map['autoScalingIps'] as String).input(),
      ...
      regionalNatGatewayAddresses: map['regionalNatGatewayAddresses'] == null ? null : (pulumi.Input.decodeList<NatGatewayRegionalNatGatewayAddress>(map['regionalNatGatewayAddresses'], (value) => NatGatewayRegionalNatGatewayAddress.fromMap((value as Map).cast<String, dynamic>()))).input(),
      regionalNatGatewayAutoMode: map['regionalNatGatewayAutoMode'] == null ? null : (map['regionalNatGatewayAutoMode'] as String).input(),
