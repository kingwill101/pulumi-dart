...
class VpcIpamPoolState {
  ...
  factory VpcIpamPoolState.fromMap(Map<String, dynamic> map) {
    return VpcIpamPoolState(
      ...
      allocationDefaultNetmaskLength: map['allocationDefaultNetmaskLength'] == null ? null : ((map['allocationDefaultNetmaskLength'] as int).input()).input(),
      allocationMaxNetmaskLength: map['allocationMaxNetmaskLength'] == null ? null : ((map['allocationMaxNetmaskLength'] as int).input()).input(),
      allocationMinNetmaskLength: map['allocationMinNetmaskLength'] == null ? null : ((map['allocationMinNetmaskLength'] as int).input()).input(),
      ...
      autoImport: map['autoImport'] == null ? null : ((map['autoImport'] as bool).input()).input(),
      awsService: map['awsService'] == null ? null : ((map['awsService'] as String).input()).input(),
      cascade: map['cascade'] == null ? null : ((map['cascade'] as bool).input()).input(),
      description: map['description'] == null ? null : ((map['description'] as String).input()).input(),
      ipamScopeId: map['ipamScopeId'] == null ? null : ((map['ipamScopeId'] as String).input()).input(),
      ...
      poolDepth: map['poolDepth'] == null ? null : ((map['poolDepth'] as int).input()).input(),
      publicIpSource: map['publicIpSource'] == null ? null : ((map['publicIpSource'] as String).input()).input(),
      publiclyAdvertisable: map['publiclyAdvertisable'] == null ? null : ((map['publiclyAdvertisable'] as bool).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      sourceIpamPoolId: map['sourceIpamPoolId'] == null ? null : ((map['sourceIpamPoolId'] as String).input()).input(),
      sourceResource: map['sourceResource'] == null ? null : ((VpcIpamPoolSourceResource.fromMap((map['sourceResource']! as Map).cast<String, dynamic>())).input()).input(),
