...
class GetNetworkInsightsAnalysisForwardPathComponentComponent {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisForwardPathComponentComponent].
  ...
  const GetNetworkInsightsAnalysisForwardPathComponentComponent({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisForwardPathComponentComponent.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisForwardPathComponentComponent(
