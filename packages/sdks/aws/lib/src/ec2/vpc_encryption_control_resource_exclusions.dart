...
class VpcEncryptionControlResourceExclusions {
  ...
  final pulumi.Input<VpcEncryptionControlResourceExclusionsElasticFileSystem>
  elasticFileSystem;

  /// `state` and `state_message` describing encryption enforcement state for Internet Gateways.
  final pulumi.Input<VpcEncryptionControlResourceExclusionsInternetGateway>
  internetGateway;
  ...
  final pulumi.Input<VpcEncryptionControlResourceExclusionsNatGateway>
  natGateway;
  ...
  final pulumi.Input<VpcEncryptionControlResourceExclusionsVpcLattice>
  vpcLattice;

  /// `state` and `state_message` describing encryption enforcement state for peered VPCs.
  final pulumi.Input<VpcEncryptionControlResourceExclusionsVpcPeering>
  vpcPeering;
  ...
  factory VpcEncryptionControlResourceExclusions.fromMap(
    ...
    return VpcEncryptionControlResourceExclusions(
      ...
      lambda: pulumi.Input.fromValue(
        VpcEncryptionControlResourceExclusionsLambda.fromMap(
          (map['lambda']! as Map).cast<String, dynamic>(),
        ),
      ),
      natGateway: pulumi.Input.fromValue(
        VpcEncryptionControlResourceExclusionsNatGateway.fromMap(
      ...
      vpcLattice: pulumi.Input.fromValue(
        VpcEncryptionControlResourceExclusionsVpcLattice.fromMap(
          (map['vpcLattice']! as Map).cast<String, dynamic>(),
        ),
      ),
      vpcPeering: pulumi.Input.fromValue(
        VpcEncryptionControlResourceExclusionsVpcPeering.fromMap(
