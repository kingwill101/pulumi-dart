...
class VpcIpam extends pulumi.CustomResource {
  ...
  VpcIpam(
    ...
    this.defaultResourceDiscoveryAssociationId = registerOutput<String>('defaultResourceDiscoveryAssociationId');
    this.defaultResourceDiscoveryId = registerOutput<String>('defaultResourceDiscoveryId');
    ...
    this.operatingRegions = registerOutput<List<VpcIpamOperatingRegion>>('operatingRegions');
    this.privateDefaultScopeId = registerOutput<String>('privateDefaultScopeId');
  ...
  /// Gets an existing [VpcIpam] resource's state with the given [name] and [id].
  static VpcIpam get(
    String name,
