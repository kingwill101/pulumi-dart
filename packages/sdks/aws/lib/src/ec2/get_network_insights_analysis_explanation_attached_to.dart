...
class GetNetworkInsightsAnalysisExplanationAttachedTo {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationAttachedTo].
  ...
  const GetNetworkInsightsAnalysisExplanationAttachedTo({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationAttachedTo.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationAttachedTo(
