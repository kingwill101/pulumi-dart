...
class FleetState {
  ...
  factory FleetState.fromMap(Map<String, dynamic> map) {
    return FleetState(
      ...
      launchTemplateConfigs: map['launchTemplateConfigs'] == null ? null : ((pulumi.Input.decodeList<FleetLaunchTemplateConfig>(map['launchTemplateConfigs']!, (value) => FleetLaunchTemplateConfig.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      targetCapacitySpecification: map['targetCapacitySpecification'] == null ? null : ((FleetTargetCapacitySpecification.fromMap((map['targetCapacitySpecification']! as Map).cast<String, dynamic>())).input()).input(),
