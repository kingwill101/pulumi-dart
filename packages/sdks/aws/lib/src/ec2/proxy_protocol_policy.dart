...
import 'proxy_protocol_policy_state.dart';
...
class ProxyProtocolPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [ProxyProtocolPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ProxyProtocolPolicy]. {@macro pulumi_ec2_proxy_protocol_policy_proxy_protocol_policy_args_doc}
  ...
  static ProxyProtocolPolicy get(
    String name,
