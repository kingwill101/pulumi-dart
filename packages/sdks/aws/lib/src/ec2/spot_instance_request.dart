...
class SpotInstanceRequest extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SpotInstanceRequestCapacityReservationSpecification>
  ...
  late final pulumi.Output<SpotInstanceRequestCreditSpecification?>
  creditSpecification;
  ...
  late final pulumi.Output<SpotInstanceRequestMaintenanceOptions>
  maintenanceOptions;
  ...
  late final pulumi.Output<SpotInstanceRequestPrivateDnsNameOptions>
  ...
  SpotInstanceRequest(
    ...
    instanceInterruptionBehavior = registerOutput<String?>(
    ...
    primaryNetworkInterfaces = registerOutput<List<Map<String, dynamic>>>(
