...
class GetNetworkInsightsAnalysisExplanationRouteTable {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationRouteTable].
  ...
  const GetNetworkInsightsAnalysisExplanationRouteTable({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationRouteTable.fromMap(Map<String, dynamic> map) {
