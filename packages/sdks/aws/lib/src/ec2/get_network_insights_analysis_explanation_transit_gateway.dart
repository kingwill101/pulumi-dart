...
class GetNetworkInsightsAnalysisExplanationTransitGateway {
  ...
  /// Creates a new [GetNetworkInsightsAnalysisExplanationTransitGateway].
  ...
  const GetNetworkInsightsAnalysisExplanationTransitGateway({
    required this.arn,
    required this.id,
    required this.name,
  });
  ...
  factory GetNetworkInsightsAnalysisExplanationTransitGateway.fromMap(Map<String, dynamic> map) {
    return GetNetworkInsightsAnalysisExplanationTransitGateway(
