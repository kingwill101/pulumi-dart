...
import 'encryption_control_state.dart';
...
class EncryptionControl extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [EncryptionControl]. {@macro pulumi_ec2_encryption_control_encryption_control_args_doc}
  ...
  /// Creates a typed reference to an existing [EncryptionControl] resource.
  EncryptionControl.reference(String urn)
    : super(
        'aws:ec2/encryptionControl:EncryptionControl',
