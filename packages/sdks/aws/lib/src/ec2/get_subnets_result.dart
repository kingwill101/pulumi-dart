  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?(() {
        ...
        return pulumi.Input.encodeList<GetSubnetsFilter, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetSubnetsResult.fromMap(Map<String, dynamic> map) {
    return GetSubnetsResult(
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetSubnetsFilter>(
          guardedValue,
          (value) =>
              GetSubnetsFilter.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      id: map['id'] as String,
