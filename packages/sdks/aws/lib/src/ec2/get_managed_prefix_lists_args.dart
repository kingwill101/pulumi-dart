...
class GetManagedPrefixListsArgs {
  ...
  GetManagedPrefixListsArgs({
    pulumi.Output<List<GetManagedPrefixListsFilter>>? filters,
  ...
  factory GetManagedPrefixListsArgs.fromMap(Map<String, dynamic> map) {
    return GetManagedPrefixListsArgs(
      filters: map['filters'] == null ? null : pulumi.Output.create<List<GetManagedPrefixListsFilter>>(pulumi.Input.decodeList<GetManagedPrefixListsFilter>(map['filters'], (value) => GetManagedPrefixListsFilter.fromMap((value as Map).cast<String, dynamic>()))),
