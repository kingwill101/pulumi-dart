  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'filters': ?(() {
        ...
        return pulumi.Input.encodeList<GetInstanceFilter, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetInstanceResult.fromMap(Map<String, dynamic> map) {
    return GetInstanceResult(
      ...
      filters: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetInstanceFilter>(
          guardedValue,
          (value) =>
              GetInstanceFilter.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      getPasswordData: (() {
