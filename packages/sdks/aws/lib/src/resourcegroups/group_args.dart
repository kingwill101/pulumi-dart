    ...
    return <String, dynamic>{
      ...
      'resourceQuery':
          ?pulumi.Input.mapOptionalInputValue<
            GroupResourceQuery,
            Map<String, dynamic>
          >(resourceQuery, (value) => value.toMap()),
      'tags': ?tags,
    };
  }
    ...
    return GroupArgs(
      configurations: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GroupConfiguration>(
            guardedValue,
            (value) => GroupConfiguration.fromMap(
      ...
      resourceQuery: (() {
        final guardedValue = map['resourceQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GroupResourceQuery.fromMap(
