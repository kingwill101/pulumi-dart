...
class PipelineDefinitionParameterObject {
  ...
  final pulumi.Input<List<PipelineDefinitionParameterObjectAttribute>>?
  attributes;
  ...
  PipelineDefinitionParameterObject({this.attributes, required this.id});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attributes':
          ?pulumi.Input.mapOptionalInputValue<
            List<PipelineDefinitionParameterObjectAttribute>,
