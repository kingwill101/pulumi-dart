...
class PipelineDefinitionState {
  ...
  factory PipelineDefinitionState.fromMap(Map<String, dynamic> map) {
    return PipelineDefinitionState(
      ...
      pipelineObjects: (() { final guardedValue = map['pipelineObjects']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PipelineDefinitionPipelineObject>(guardedValue, (value) => PipelineDefinitionPipelineObject.fromMap((value as Map).cast<String, dynamic>()))); })(),
