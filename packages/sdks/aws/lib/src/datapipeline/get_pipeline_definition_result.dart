...
class GetPipelineDefinitionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': ?id,
      'parameterObjects': ?(() { final guardedValue = parameterObjects; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetPipelineDefinitionParameterObject, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      ...
      'pipelineObjects': ?(() { final guardedValue = pipelineObjects; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetPipelineDefinitionPipelineObject, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'region': ?region,
    };
  }
  ...
  factory GetPipelineDefinitionResult.fromMap(Map<String, dynamic> map) {
    return GetPipelineDefinitionResult(
      ...
      parameterObjects: (() { final guardedValue = map['parameterObjects']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetPipelineDefinitionParameterObject>(guardedValue, (value) => GetPipelineDefinitionParameterObject.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      pipelineObjects: (() { final guardedValue = map['pipelineObjects']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetPipelineDefinitionPipelineObject>(guardedValue, (value) => GetPipelineDefinitionPipelineObject.fromMap((value as Map).cast<String, dynamic>())); })(),
