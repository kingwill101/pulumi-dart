...
class PipelineDefinitionPipelineObject {
  ...
  factory PipelineDefinitionPipelineObject.fromMap(Map<String, dynamic> map) {
    return PipelineDefinitionPipelineObject(
      fields: (() { final guardedValue = map['fields']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<PipelineDefinitionPipelineObjectField>(guardedValue, (value) => PipelineDefinitionPipelineObjectField.fromMap((value as Map).cast<String, dynamic>()))); })(),
