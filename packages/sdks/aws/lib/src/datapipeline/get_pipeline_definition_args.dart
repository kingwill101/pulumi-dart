...
class GetPipelineDefinitionArgs {
  ...
  const GetPipelineDefinitionArgs({
  ...
  factory GetPipelineDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return GetPipelineDefinitionArgs(
      parameterValues: (() { final guardedValue = map['parameterValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetPipelineDefinitionParameterValue>(guardedValue, (value) => GetPipelineDefinitionParameterValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
