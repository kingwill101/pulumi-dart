...
class Broker extends pulumi.CustomResource {
  ...
  Broker(
    ...
    this.dataReplicationPrimaryBrokerArn = registerOutput<String?>('dataReplicationPrimaryBrokerArn');
    this.deploymentMode = registerOutput<String?>('deploymentMode');
    this.encryptionOptions = registerOutput<BrokerEncryptionOptions?>('encryptionOptions');
    ...
    this.ldapServerMetadata = registerOutput<BrokerLdapServerMetadata?>('ldapServerMetadata');
    this.logs = registerOutput<BrokerLogs?>('logs');
    this.maintenanceWindowStartTime = registerOutput<BrokerMaintenanceWindowStartTime>('maintenanceWindowStartTime');
    this.pendingDataReplicationMode = registerOutput<String>('pendingDataReplicationMode');
