...
class BrokerState {
    ...
    return <String, dynamic>{
      ...
      'instances':
          ...
          >(
            instances,
            (value) =>
                pulumi.Input.encodeList<BrokerInstance, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory BrokerState.fromMap(Map<String, dynamic> map) {
    return BrokerState(
      ...
      dataReplicationMode: (() {
        final guardedValue = map['dataReplicationMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dataReplicationPrimaryBrokerArn: (() {
        final guardedValue = map['dataReplicationPrimaryBrokerArn'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      deploymentMode: (() {
      ...
      encryptionOptions: (() {
        final guardedValue = map['encryptionOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      instances: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BrokerInstance>(
            guardedValue,
            (value) =>
                BrokerInstance.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ldapServerMetadata: (() {
        final guardedValue = map['ldapServerMetadata'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      logs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BrokerLogs.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      maintenanceWindowStartTime: (() {
      ...
      pendingDataReplicationMode: (() {
        final guardedValue = map['pendingDataReplicationMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publiclyAccessible: (() {
      ...
      users: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<BrokerUser>(
            guardedValue,
            (value) =>
