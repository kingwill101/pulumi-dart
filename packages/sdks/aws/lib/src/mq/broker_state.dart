...
class BrokerState {
  ...
  BrokerState({
    ...
    pulumi.Output<List<BrokerInstance>>? instances,
    ...
    pulumi.Output<String>? pendingDataReplicationMode,
    ...
    pulumi.Output<List<BrokerUser>>? users,
  }) :
      ...
      instances = pulumi.Input.asOptionalInput<List<BrokerInstance>>(instances),
      ...
      pendingDataReplicationMode = pulumi.Input.asOptionalInput<String>(pendingDataReplicationMode),
      ...
      users = pulumi.Input.asOptionalInput<List<BrokerUser>>(users);
  ...
  factory BrokerState.fromMap(Map<String, dynamic> map) {
    return BrokerState(
      ...
      instances: map['instances'] == null ? null : pulumi.Output.create<List<BrokerInstance>>(pulumi.Input.decodeList<BrokerInstance>(map['instances'], (value) => BrokerInstance.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      pendingDataReplicationMode: map['pendingDataReplicationMode'] == null ? null : pulumi.Output.create<String>(map['pendingDataReplicationMode'] as String),
      ...
      users: map['users'] == null ? null : pulumi.Output.create<List<BrokerUser>>(pulumi.Input.decodeList<BrokerUser>(map['users'], (value) => BrokerUser.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
