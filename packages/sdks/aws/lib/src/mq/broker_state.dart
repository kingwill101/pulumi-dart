...
class BrokerState {
  ...
  /// [sharedResources] List of resources shared with the broker via `resourceShareArns`. Only populated for `engineType` of `RabbitMQ`.
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'sharedResources': ?pulumi.Input.mapOptionalInputValue<List<BrokerSharedResource>, List<Map<String, dynamic>>>(sharedResources, (value) => pulumi.Input.encodeList<BrokerSharedResource, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory BrokerState.fromMap(Map<String, dynamic> map) {
    return BrokerState(
      ...
      sharedResources: (() { final guardedValue = map['sharedResources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<BrokerSharedResource>(guardedValue, (value) => BrokerSharedResource.fromMap((value as Map).cast<String, dynamic>()))); })(),
