...
class BrokerState {
  ...
  factory BrokerState.fromMap(Map<String, dynamic> map) {
    return BrokerState(
      ...
      configuration: map['configuration'] == null ? null : (BrokerConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>())).input(),
      dataReplicationMode: map['dataReplicationMode'] == null ? null : (map['dataReplicationMode'] as String).input(),
      dataReplicationPrimaryBrokerArn: map['dataReplicationPrimaryBrokerArn'] == null ? null : (map['dataReplicationPrimaryBrokerArn'] as String).input(),
      deploymentMode: map['deploymentMode'] == null ? null : (map['deploymentMode'] as String).input(),
      encryptionOptions: map['encryptionOptions'] == null ? null : (BrokerEncryptionOptions.fromMap((map['encryptionOptions'] as Map).cast<String, dynamic>())).input(),
      ...
      instances: map['instances'] == null ? null : (pulumi.Input.decodeList<BrokerInstance>(map['instances'], (value) => BrokerInstance.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ldapServerMetadata: map['ldapServerMetadata'] == null ? null : (BrokerLdapServerMetadata.fromMap((map['ldapServerMetadata'] as Map).cast<String, dynamic>())).input(),
      logs: map['logs'] == null ? null : (BrokerLogs.fromMap((map['logs'] as Map).cast<String, dynamic>())).input(),
      maintenanceWindowStartTime: map['maintenanceWindowStartTime'] == null ? null : (BrokerMaintenanceWindowStartTime.fromMap((map['maintenanceWindowStartTime'] as Map).cast<String, dynamic>())).input(),
      pendingDataReplicationMode: map['pendingDataReplicationMode'] == null ? null : (map['pendingDataReplicationMode'] as String).input(),
      ...
      users: map['users'] == null ? null : (pulumi.Input.decodeList<BrokerUser>(map['users'], (value) => BrokerUser.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
