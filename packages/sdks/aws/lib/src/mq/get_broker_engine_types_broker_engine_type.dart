...
class GetBrokerEngineTypesBrokerEngineType {
  ...
  final pulumi.Input<List<GetBrokerEngineTypesBrokerEngineTypeEngineVersion>>
  engineVersions;
    ...
    return <String, dynamic>{
      ...
      'engineVersions':
          pulumi.Input.mapInputValue<
            List<GetBrokerEngineTypesBrokerEngineTypeEngineVersion>,
  ...
  factory GetBrokerEngineTypesBrokerEngineType.fromMap(
    ...
    return GetBrokerEngineTypesBrokerEngineType(
      ...
      engineVersions: pulumi.Input.fromValue(
