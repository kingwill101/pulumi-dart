...
class DomainMatchingAutoMerging {
  ...
  final pulumi.Input<DomainMatchingAutoMergingConflictResolution>?
  conflictResolution;
    ...
    return <String, dynamic>{
      ...
      'consolidation':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(consolidation, (value) => value.toMap()),
      'enabled': enabled,
  ...
  factory DomainMatchingAutoMerging.fromMap(Map<String, dynamic> map) {
    return DomainMatchingAutoMerging(
      ...
      consolidation: (() {
        final guardedValue = map['consolidation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      minAllowedConfidenceScoreForMerging: (() {
        final guardedValue = map['minAllowedConfidenceScoreForMerging'];
        if (guardedValue == null) return null;
