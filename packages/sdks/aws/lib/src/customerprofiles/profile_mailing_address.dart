...
class ProfileMailingAddress {
  ...
  /// Creates a new [ProfileMailingAddress].
  ...
  factory ProfileMailingAddress.fromMap(Map<String, dynamic> map) {
    return ProfileMailingAddress(
