...
class Profile extends pulumi.CustomResource {
  ...
  Profile(
    ...
    this.additionalInformation = registerOutput<String?>('additionalInformation');
    this.address = registerOutput<ProfileAddress?>('address');
    this.attributes = registerOutput<Map<String, String>?>('attributes');
    this.billingAddress = registerOutput<ProfileBillingAddress?>('billingAddress');
    ...
    this.mailingAddress = registerOutput<ProfileMailingAddress?>('mailingAddress');
    ...
    this.shippingAddress = registerOutput<ProfileShippingAddress?>('shippingAddress');
  }
