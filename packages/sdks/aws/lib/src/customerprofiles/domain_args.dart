...
class DomainArgs {
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      deadLetterQueueUrl: (() {
        final guardedValue = map['deadLetterQueueUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      defaultEncryptionKey: (() {
        final guardedValue = map['defaultEncryptionKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      defaultExpirationDays: pulumi.Input.fromValue(
        map['defaultExpirationDays'] as int,
      ),
      domainName: pulumi.Input.fromValue(map['domainName'] as String),
      matching: (() {
        final guardedValue = map['matching'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainMatching.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      region: (() {
      ...
      ruleBasedMatching: (() {
        final guardedValue = map['ruleBasedMatching'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
