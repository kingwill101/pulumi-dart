...
class Workspace extends pulumi.CustomResource {
  ...
  Workspace(
    ...
    this.rootVolumeEncryptionEnabled = registerOutput<bool?>('rootVolumeEncryptionEnabled');
    this.state = registerOutput<String>('state');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tagsAll = registerOutput<Map<String, String>>('tagsAll');
    this.userName = registerOutput<String>('userName');
    this.userVolumeEncryptionEnabled = registerOutput<bool?>('userVolumeEncryptionEnabled');
    this.volumeEncryptionKey = registerOutput<String?>('volumeEncryptionKey');
    this.workspaceProperties = registerOutput<WorkspaceWorkspaceProperties>('workspaceProperties');
  }
