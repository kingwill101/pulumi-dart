...
class GetDirectorySelfServicePermission {
  ...
  factory GetDirectorySelfServicePermission.fromMap(Map<String, dynamic> map) {
    return GetDirectorySelfServicePermission(
      changeComputeType: pulumi.Input.fromValue(map['changeComputeType'] as bool),
      increaseVolumeSize: pulumi.Input.fromValue(map['increaseVolumeSize'] as bool),
      ...
      switchRunningMode: pulumi.Input.fromValue(map['switchRunningMode'] as bool),
    );
  }
}
