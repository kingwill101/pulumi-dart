...
class DirectoryWorkspaceAccessProperties {
  ...
  factory DirectoryWorkspaceAccessProperties.fromMap(Map<String, dynamic> map) {
    return DirectoryWorkspaceAccessProperties(
      ...
      deviceTypeLinux: (() { final guardedValue = map['deviceTypeLinux']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deviceTypeOsx: (() { final guardedValue = map['deviceTypeOsx']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deviceTypeWeb: (() { final guardedValue = map['deviceTypeWeb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deviceTypeWindows: (() { final guardedValue = map['deviceTypeWindows']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deviceTypeZeroclient: (() { final guardedValue = map['deviceTypeZeroclient']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
