...
class GetDirectoryWorkspaceCreationProperty {
  ...
  factory GetDirectoryWorkspaceCreationProperty.fromMap(Map<String, dynamic> map) {
    return GetDirectoryWorkspaceCreationProperty(
      ...
      enableMaintenanceMode: pulumi.Input.fromValue(map['enableMaintenanceMode'] as bool),
      userEnabledAsLocalAdministrator: pulumi.Input.fromValue(map['userEnabledAsLocalAdministrator'] as bool),
    );
  }
}
