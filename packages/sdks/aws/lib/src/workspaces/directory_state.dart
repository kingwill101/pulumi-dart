...
class DirectoryState {
  ...
  factory DirectoryState.fromMap(Map<String, dynamic> map) {
    return DirectoryState(
      ...
      customerUserName: map['customerUserName'] == null ? null : (map['customerUserName'] as String).input(),
      ...
      iamRoleId: map['iamRoleId'] == null ? null : (map['iamRoleId'] as String).input(),
      ipGroupIds: map['ipGroupIds'] == null ? null : ((map['ipGroupIds'] as List).cast<String>()).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      registrationCode: map['registrationCode'] == null ? null : (map['registrationCode'] as String).input(),
      ...
      workspaceSecurityGroupId: map['workspaceSecurityGroupId'] == null ? null : (map['workspaceSecurityGroupId'] as String).input(),
