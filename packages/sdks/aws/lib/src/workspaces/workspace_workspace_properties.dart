...
class WorkspaceWorkspaceProperties {
  ...
  factory WorkspaceWorkspaceProperties.fromMap(Map<String, dynamic> map) {
    return WorkspaceWorkspaceProperties(
      computeTypeName: (() {
        final guardedValue = map['computeTypeName'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rootVolumeSizeGib: (() {
        final guardedValue = map['rootVolumeSizeGib'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      runningMode: (() {
        final guardedValue = map['runningMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      runningModeAutoStopTimeoutInMinutes: (() {
        final guardedValue = map['runningModeAutoStopTimeoutInMinutes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      userVolumeSizeGib: (() {
        final guardedValue = map['userVolumeSizeGib'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
