...
class DirectorySelfServicePermissions {
  ...
  const DirectorySelfServicePermissions({
  ...
  factory DirectorySelfServicePermissions.fromMap(Map<String, dynamic> map) {
    return DirectorySelfServicePermissions(
      changeComputeType: (() { final guardedValue = map['changeComputeType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      increaseVolumeSize: (() { final guardedValue = map['increaseVolumeSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      rebuildWorkspace: (() { final guardedValue = map['rebuildWorkspace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      restartWorkspace: (() { final guardedValue = map['restartWorkspace']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      switchRunningMode: (() { final guardedValue = map['switchRunningMode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
