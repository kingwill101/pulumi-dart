...
class NotificationHubTimeouts {
  ...
  /// Creates a new [NotificationHubTimeouts].
  ...
  NotificationHubTimeouts({this.create, this.delete});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'create': ?create, 'delete': ?delete};
  }

  factory NotificationHubTimeouts.fromMap(Map<String, dynamic> map) {
    return NotificationHubTimeouts(
      create: (() {
