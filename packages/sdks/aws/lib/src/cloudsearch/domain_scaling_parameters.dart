...
class DomainScalingParameters {
  ...
  factory DomainScalingParameters.fromMap(Map<String, dynamic> map) {
    return DomainScalingParameters(
      ...
      desiredPartitionCount: (() { final guardedValue = map['desiredPartitionCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      desiredReplicationCount: (() { final guardedValue = map['desiredReplicationCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
