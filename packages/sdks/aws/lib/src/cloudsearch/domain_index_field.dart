...
class DomainIndexField {
  ...
  factory DomainIndexField.fromMap(Map<String, dynamic> map) {
    return DomainIndexField(
      analysisScheme: (() {
        final guardedValue = map['analysisScheme'];
      ...
      facet: (() {
        final guardedValue = map['facet'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      highlight: (() {
        final guardedValue = map['highlight'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      return_: (() {
        final guardedValue = map['return'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      search: (() {
        final guardedValue = map['search'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sort: (() {
