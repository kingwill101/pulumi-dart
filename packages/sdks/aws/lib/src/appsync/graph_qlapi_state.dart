...
class GraphQLApiState {
  ...
  factory GraphQLApiState.fromMap(Map<String, dynamic> map) {
    return GraphQLApiState(
      additionalAuthenticationProviders: map['additionalAuthenticationProviders'] == null ? null : (pulumi.Input.decodeList<GraphQLApiAdditionalAuthenticationProvider>(map['additionalAuthenticationProviders'], (value) => GraphQLApiAdditionalAuthenticationProvider.fromMap((value as Map).cast<String, dynamic>()))).input(),
      apiType: map['apiType'] == null ? null : (map['apiType'] as String).input(),
      arn: map['arn'] == null ? null : (map['arn'] as String).input(),
      authenticationType: map['authenticationType'] == null ? null : (map['authenticationType'] as String).input(),
      enhancedMetricsConfig: map['enhancedMetricsConfig'] == null ? null : (GraphQLApiEnhancedMetricsConfig.fromMap((map['enhancedMetricsConfig'] as Map).cast<String, dynamic>())).input(),
      introspectionConfig: map['introspectionConfig'] == null ? null : (map['introspectionConfig'] as String).input(),
      lambdaAuthorizerConfig: map['lambdaAuthorizerConfig'] == null ? null : (GraphQLApiLambdaAuthorizerConfig.fromMap((map['lambdaAuthorizerConfig'] as Map).cast<String, dynamic>())).input(),
      logConfig: map['logConfig'] == null ? null : (GraphQLApiLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>())).input(),
      mergedApiExecutionRoleArn: map['mergedApiExecutionRoleArn'] == null ? null : (map['mergedApiExecutionRoleArn'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      openidConnectConfig: map['openidConnectConfig'] == null ? null : (GraphQLApiOpenidConnectConfig.fromMap((map['openidConnectConfig'] as Map).cast<String, dynamic>())).input(),
      ...
      userPoolConfig: map['userPoolConfig'] == null ? null : (GraphQLApiUserPoolConfig.fromMap((map['userPoolConfig'] as Map).cast<String, dynamic>())).input(),
