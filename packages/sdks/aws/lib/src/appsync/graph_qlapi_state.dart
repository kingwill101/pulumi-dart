...
class GraphQLApiState {
  ...
  GraphQLApiState({
    pulumi.Output<List<GraphQLApiAdditionalAuthenticationProvider>>? additionalAuthenticationProviders,
    pulumi.Output<String>? apiType,
    pulumi.Output<String>? arn,
    pulumi.Output<String>? authenticationType,
    pulumi.Output<GraphQLApiEnhancedMetricsConfig>? enhancedMetricsConfig,
    pulumi.Output<String>? introspectionConfig,
    pulumi.Output<GraphQLApiLambdaAuthorizerConfig>? lambdaAuthorizerConfig,
    pulumi.Output<GraphQLApiLogConfig>? logConfig,
    pulumi.Output<String>? mergedApiExecutionRoleArn,
    pulumi.Output<String>? name,
    pulumi.Output<GraphQLApiOpenidConnectConfig>? openidConnectConfig,
    pulumi.Output<int>? queryDepthLimit,
    pulumi.Output<String>? region,
    pulumi.Output<int>? resolverCountLimit,
    pulumi.Output<String>? schema,
    pulumi.Output<Map<String, String>>? tags,
    pulumi.Output<Map<String, String>>? tagsAll,
    pulumi.Output<Map<String, String>>? uris,
    pulumi.Output<GraphQLApiUserPoolConfig>? userPoolConfig,
    pulumi.Output<String>? visibility,
    pulumi.Output<bool>? xrayEnabled,
  }) :
      additionalAuthenticationProviders = pulumi.Input.asOptionalInput<List<GraphQLApiAdditionalAuthenticationProvider>>(additionalAuthenticationProviders),
      ...
      enhancedMetricsConfig = pulumi.Input.asOptionalInput<GraphQLApiEnhancedMetricsConfig>(enhancedMetricsConfig),
      introspectionConfig = pulumi.Input.asOptionalInput<String>(introspectionConfig),
      lambdaAuthorizerConfig = pulumi.Input.asOptionalInput<GraphQLApiLambdaAuthorizerConfig>(lambdaAuthorizerConfig),
      logConfig = pulumi.Input.asOptionalInput<GraphQLApiLogConfig>(logConfig),
      mergedApiExecutionRoleArn = pulumi.Input.asOptionalInput<String>(mergedApiExecutionRoleArn),
      name = pulumi.Input.asOptionalInput<String>(name),
      openidConnectConfig = pulumi.Input.asOptionalInput<GraphQLApiOpenidConnectConfig>(openidConnectConfig),
      queryDepthLimit = pulumi.Input.asOptionalInput<int>(queryDepthLimit),
      region = pulumi.Input.asOptionalInput<String>(region),
      resolverCountLimit = pulumi.Input.asOptionalInput<int>(resolverCountLimit),
      schema = pulumi.Input.asOptionalInput<String>(schema),
      tags = pulumi.Input.asOptionalInput<Map<String, String>>(tags),
      tagsAll = pulumi.Input.asOptionalInput<Map<String, String>>(tagsAll),
      uris = pulumi.Input.asOptionalInput<Map<String, String>>(uris),
      userPoolConfig = pulumi.Input.asOptionalInput<GraphQLApiUserPoolConfig>(userPoolConfig),
  ...
  factory GraphQLApiState.fromMap(Map<String, dynamic> map) {
    return GraphQLApiState(
      additionalAuthenticationProviders: map['additionalAuthenticationProviders'] == null ? null : pulumi.Output.create<List<GraphQLApiAdditionalAuthenticationProvider>>(pulumi.Input.decodeList<GraphQLApiAdditionalAuthenticationProvider>(map['additionalAuthenticationProviders'], (value) => GraphQLApiAdditionalAuthenticationProvider.fromMap((value as Map).cast<String, dynamic>()))),
      apiType: map['apiType'] == null ? null : pulumi.Output.create<String>(map['apiType'] as String),
      ...
      enhancedMetricsConfig: map['enhancedMetricsConfig'] == null ? null : pulumi.Output.create<GraphQLApiEnhancedMetricsConfig>(GraphQLApiEnhancedMetricsConfig.fromMap((map['enhancedMetricsConfig'] as Map).cast<String, dynamic>())),
      introspectionConfig: map['introspectionConfig'] == null ? null : pulumi.Output.create<String>(map['introspectionConfig'] as String),
      lambdaAuthorizerConfig: map['lambdaAuthorizerConfig'] == null ? null : pulumi.Output.create<GraphQLApiLambdaAuthorizerConfig>(GraphQLApiLambdaAuthorizerConfig.fromMap((map['lambdaAuthorizerConfig'] as Map).cast<String, dynamic>())),
      logConfig: map['logConfig'] == null ? null : pulumi.Output.create<GraphQLApiLogConfig>(GraphQLApiLogConfig.fromMap((map['logConfig'] as Map).cast<String, dynamic>())),
      mergedApiExecutionRoleArn: map['mergedApiExecutionRoleArn'] == null ? null : pulumi.Output.create<String>(map['mergedApiExecutionRoleArn'] as String),
      name: map['name'] == null ? null : pulumi.Output.create<String>(map['name'] as String),
      openidConnectConfig: map['openidConnectConfig'] == null ? null : pulumi.Output.create<GraphQLApiOpenidConnectConfig>(GraphQLApiOpenidConnectConfig.fromMap((map['openidConnectConfig'] as Map).cast<String, dynamic>())),
      queryDepthLimit: map['queryDepthLimit'] == null ? null : pulumi.Output.create<int>(map['queryDepthLimit'] as int),
      region: map['region'] == null ? null : pulumi.Output.create<String>(map['region'] as String),
      resolverCountLimit: map['resolverCountLimit'] == null ? null : pulumi.Output.create<int>(map['resolverCountLimit'] as int),
      schema: map['schema'] == null ? null : pulumi.Output.create<String>(map['schema'] as String),
      tags: map['tags'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tags'] as Map).cast<String, String>()),
      tagsAll: map['tagsAll'] == null ? null : pulumi.Output.create<Map<String, String>>((map['tagsAll'] as Map).cast<String, String>()),
      uris: map['uris'] == null ? null : pulumi.Output.create<Map<String, String>>((map['uris'] as Map).cast<String, String>()),
      userPoolConfig: map['userPoolConfig'] == null ? null : pulumi.Output.create<GraphQLApiUserPoolConfig>(GraphQLApiUserPoolConfig.fromMap((map['userPoolConfig'] as Map).cast<String, dynamic>())),
