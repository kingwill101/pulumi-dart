...
class GraphQLApiState {
  ...
  factory GraphQLApiState.fromMap(Map<String, dynamic> map) {
    return GraphQLApiState(
      ...
      queryDepthLimit: (() { final guardedValue = map['queryDepthLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
      region: (() { final guardedValue = map['region']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      resolverCountLimit: (() { final guardedValue = map['resolverCountLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toInt()); })(),
