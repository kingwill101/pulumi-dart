...
class SourceApiAssociationTimeouts {
  ...
  /// Creates a new [SourceApiAssociationTimeouts].
  ...
  SourceApiAssociationTimeouts({this.create, this.delete, this.update});
  ...
  factory SourceApiAssociationTimeouts.fromMap(Map<String, dynamic> map) {
    return SourceApiAssociationTimeouts(
      create: (() {
