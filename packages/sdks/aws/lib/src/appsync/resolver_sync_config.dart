...
class ResolverSyncConfig {
  ...
  final ResolverSyncConfigLambdaConflictHandlerConfig? lambdaConflictHandlerConfig;
  ...
  factory ResolverSyncConfig.fromMap(Map<String, dynamic> map) {
    return ResolverSyncConfig(
      ...
      lambdaConflictHandlerConfig: map['lambdaConflictHandlerConfig'] == null ? null : ResolverSyncConfigLambdaConflictHandlerConfig.fromMap((map['lambdaConflictHandlerConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
