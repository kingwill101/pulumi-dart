...
class GraphQLApiAdditionalAuthenticationProvider {
  ...
  final pulumi.Input<GraphQLApiAdditionalAuthenticationProviderUserPoolConfig>?
  userPoolConfig;
    ...
    return GraphQLApiAdditionalAuthenticationProvider(
      ...
      lambdaAuthorizerConfig: (() {
        ...
        return pulumi.Input.fromValue(
          GraphQLApiAdditionalAuthenticationProviderLambdaAuthorizerConfig.fromMap(
      ...
      openidConnectConfig: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          GraphQLApiAdditionalAuthenticationProviderOpenidConnectConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
