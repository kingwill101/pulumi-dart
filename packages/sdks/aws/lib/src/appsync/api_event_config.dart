...
class ApiEventConfig {
  ...
  factory ApiEventConfig.fromMap(Map<String, dynamic> map) {
    return ApiEventConfig(
      authProviders: pulumi.Input.fromValue(pulumi.Input.decodeList<ApiEventConfigAuthProvider>(map['authProviders']!, (value) => ApiEventConfigAuthProvider.fromMap((value as Map).cast<String, dynamic>()))),
      connectionAuthModes: pulumi.Input.fromValue(pulumi.Input.decodeList<ApiEventConfigConnectionAuthMode>(map['connectionAuthModes']!, (value) => ApiEventConfigConnectionAuthMode.fromMap((value as Map).cast<String, dynamic>()))),
      defaultPublishAuthModes: pulumi.Input.fromValue(pulumi.Input.decodeList<ApiEventConfigDefaultPublishAuthMode>(map['defaultPublishAuthModes']!, (value) => ApiEventConfigDefaultPublishAuthMode.fromMap((value as Map).cast<String, dynamic>()))),
      defaultSubscribeAuthModes: pulumi.Input.fromValue(pulumi.Input.decodeList<ApiEventConfigDefaultSubscribeAuthMode>(map['defaultSubscribeAuthModes']!, (value) => ApiEventConfigDefaultSubscribeAuthMode.fromMap((value as Map).cast<String, dynamic>()))),
      logConfig: (() { final guardedValue = map['logConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApiEventConfigLogConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
