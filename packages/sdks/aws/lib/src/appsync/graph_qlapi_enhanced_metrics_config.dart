...
class GraphQLApiEnhancedMetricsConfig {
  ...
  factory GraphQLApiEnhancedMetricsConfig.fromMap(Map<String, dynamic> map) {
    return GraphQLApiEnhancedMetricsConfig(
      dataSourceLevelMetricsBehavior: pulumi.Input.fromValue(
        map['dataSourceLevelMetricsBehavior'] as String,
      ),
      operationLevelMetricsConfig: pulumi.Input.fromValue(
        map['operationLevelMetricsConfig'] as String,
      ),
      resolverLevelMetricsBehavior: pulumi.Input.fromValue(
