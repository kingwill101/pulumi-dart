...
class GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation {
  ...
  final List<GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationS3Configuration> s3Configurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      's3Configurations': pulumi.Input.encodeList<GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationS3Configuration, Map<String, dynamic>>(s3Configurations, (value) => value.toMap()),
    };
  }
  ...
  factory GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation.fromMap(Map<String, dynamic> map) {
    return GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation(
      s3Configurations: pulumi.Input.decodeList<GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationS3Configuration>(map['s3Configurations'], (value) => GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocationS3Configuration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
