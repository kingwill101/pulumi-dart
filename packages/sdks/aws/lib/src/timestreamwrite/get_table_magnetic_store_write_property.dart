...
class GetTableMagneticStoreWriteProperty {
  ...
  final pulumi.Input<List<GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation>> magneticStoreRejectedDataLocations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'magneticStoreRejectedDataLocations': pulumi.Input.mapInputValue<List<GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation>, List<Map<String, dynamic>>>(magneticStoreRejectedDataLocations, (value) => pulumi.Input.encodeList<GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory GetTableMagneticStoreWriteProperty.fromMap(Map<String, dynamic> map) {
    return GetTableMagneticStoreWriteProperty(
      enableMagneticStoreWrites: pulumi.Input.fromValue(map['enableMagneticStoreWrites'] as bool),
      magneticStoreRejectedDataLocations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation>(map['magneticStoreRejectedDataLocations']!, (value) => GetTableMagneticStoreWritePropertyMagneticStoreRejectedDataLocation.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
