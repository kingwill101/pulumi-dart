...
class PolicyTargetTrackingScalingPolicyConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customizedMetricSpecification': ?pulumi.Input.mapOptionalInputValue<PolicyTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification, Map<String, dynamic>>(customizedMetricSpecification, (value) => value.toMap()),
      'disableScaleIn': ?disableScaleIn,
      'predefinedMetricSpecification': ?pulumi.Input.mapOptionalInputValue<PolicyTargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification, Map<String, dynamic>>(predefinedMetricSpecification, (value) => value.toMap()),
