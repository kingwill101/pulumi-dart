...
class PolicyState {
    ...
    return <String, dynamic>{
      ...
      'predictiveScalingPolicyConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(predictiveScalingPolicyConfiguration, (value) => value.toMap()),
      'region': ?region,
      ...
      'stepScalingPolicyConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(stepScalingPolicyConfiguration, (value) => value.toMap()),
      'targetTrackingScalingPolicyConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            PolicyTargetTrackingScalingPolicyConfiguration,
            Map<String, dynamic>
          >(targetTrackingScalingPolicyConfiguration, (value) => value.toMap()),
    };
  }
  ...
  factory PolicyState.fromMap(Map<String, dynamic> map) {
    return PolicyState(
      alarmArns: (() {
        final guardedValue = map['alarmArns'];
      ...
      predictiveScalingPolicyConfiguration: (() {
        final guardedValue = map['predictiveScalingPolicyConfiguration'];
        if (guardedValue == null) return null;
      ...
      scalableDimension: (() {
        final guardedValue = map['scalableDimension'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      serviceNamespace: (() {
      ...
      stepScalingPolicyConfiguration: (() {
        final guardedValue = map['stepScalingPolicyConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      targetTrackingScalingPolicyConfiguration: (() {
        final guardedValue = map['targetTrackingScalingPolicyConfiguration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
