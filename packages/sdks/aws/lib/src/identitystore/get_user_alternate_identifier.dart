...
class GetUserAlternateIdentifier {
  ...
  factory GetUserAlternateIdentifier.fromMap(Map<String, dynamic> map) {
    return GetUserAlternateIdentifier(
      externalId: (() { final guardedValue = map['externalId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetUserAlternateIdentifierExternalId.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      uniqueAttribute: (() { final guardedValue = map['uniqueAttribute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetUserAlternateIdentifierUniqueAttribute.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
