    ...
    return <String, dynamic>{
      ...
      'externalIds':
          ?pulumi.Input.mapOptionalInputValue<
            List<GroupExternalId>,
            List<Map<String, dynamic>>
          >(
            externalIds,
            (value) =>
                pulumi.Input.encodeList<GroupExternalId, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return GroupState(
      ...
      externalIds: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GroupExternalId>(
            guardedValue,
            (value) =>
                GroupExternalId.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      groupId: (() {
