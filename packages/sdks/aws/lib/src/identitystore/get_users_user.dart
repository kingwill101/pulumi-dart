...
class GetUsersUser {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'names':
          pulumi.Input.mapInputValue<
            List<GetUsersUserName>,
            List<Map<String, dynamic>>
          >(
            names,
            (value) =>
                pulumi.Input.encodeList<GetUsersUserName, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory GetUsersUser.fromMap(Map<String, dynamic> map) {
    return GetUsersUser(
      addresses: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUsersUserAddress>(
          map['addresses']!,
      ...
      emails: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUsersUserEmail>(
          map['emails']!,
          (value) =>
              GetUsersUserEmail.fromMap((value as Map).cast<String, dynamic>()),
        ),
      ),
      externalIds: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUsersUserExternalId>(
          map['externalIds']!,
      ...
      names: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUsersUserName>(
          map['names']!,
          (value) =>
      ...
      phoneNumbers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetUsersUserPhoneNumber>(
          map['phoneNumbers']!,
      ...
      preferredLanguage: pulumi.Input.fromValue(
