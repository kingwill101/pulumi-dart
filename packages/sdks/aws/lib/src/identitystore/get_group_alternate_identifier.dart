...
class GetGroupAlternateIdentifier {
  ...
  factory GetGroupAlternateIdentifier.fromMap(Map<String, dynamic> map) {
    return GetGroupAlternateIdentifier(
      externalId: (() { final guardedValue = map['externalId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGroupAlternateIdentifierExternalId.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      uniqueAttribute: (() { final guardedValue = map['uniqueAttribute']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGroupAlternateIdentifierUniqueAttribute.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
