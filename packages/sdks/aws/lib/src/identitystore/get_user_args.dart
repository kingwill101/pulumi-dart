...
class GetUserArgs {
  ...
  factory GetUserArgs.fromMap(Map<String, dynamic> map) {
    return GetUserArgs(
      alternateIdentifier: (() { final guardedValue = map['alternateIdentifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetUserAlternateIdentifier.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
