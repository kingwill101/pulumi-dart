...
class UserState {
  ...
  UserState({
    ...
    pulumi.Output<List<UserExternalId>>? externalIds,
    ...
    pulumi.Output<String>? userType,
      ...
      externalIds = pulumi.Input.asOptionalInput<List<UserExternalId>>(externalIds),
  ...
  factory UserState.fromMap(Map<String, dynamic> map) {
    return UserState(
      ...
      externalIds: map['externalIds'] == null ? null : pulumi.Output.create<List<UserExternalId>>(pulumi.Input.decodeList<UserExternalId>(map['externalIds'], (value) => UserExternalId.fromMap((value as Map).cast<String, dynamic>()))),
