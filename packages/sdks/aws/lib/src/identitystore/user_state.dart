...
class UserState {
  ...
  factory UserState.fromMap(Map<String, dynamic> map) {
    return UserState(
      ...
      externalIds: map['externalIds'] == null ? null : (pulumi.Input.decodeList<UserExternalId>(map['externalIds'], (value) => UserExternalId.fromMap((value as Map).cast<String, dynamic>()))).input(),
