    ...
    return <String, dynamic>{
      ...
      'externalIds':
          ...
          >(
            externalIds,
            (value) =>
                pulumi.Input.encodeList<UserExternalId, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return UserState(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          UserAddresses.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      displayName: (() {
      ...
      emails: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserEmails.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      externalIds: (() {
        final guardedValue = map['externalIds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserExternalId>(
            guardedValue,
            (value) =>
                UserExternalId.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      identityStoreId: (() {
      ...
      name: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserName.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      nickname: (() {
      ...
      profileUrl: (() {
        final guardedValue = map['profileUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
