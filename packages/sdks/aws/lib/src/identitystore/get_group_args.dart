...
class GetGroupArgs {
  ...
  factory GetGroupArgs.fromMap(Map<String, dynamic> map) {
    return GetGroupArgs(
      alternateIdentifier: (() { final guardedValue = map['alternateIdentifier']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetGroupAlternateIdentifier.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
