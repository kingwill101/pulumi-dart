...
class ProjectArgs {
  ...
  factory ProjectArgs.fromMap(Map<String, dynamic> map) {
    return ProjectArgs(
      artifacts: (ProjectArtifacts.fromMap((map['artifacts'] as Map).cast<String, dynamic>())).input(),
      autoRetryLimit: map['autoRetryLimit'] == null ? null : (map['autoRetryLimit'] as int).input(),
      ...
      buildTimeout: map['buildTimeout'] == null ? null : (map['buildTimeout'] as int).input(),
      ...
      environment: (ProjectEnvironment.fromMap((map['environment'] as Map).cast<String, dynamic>())).input(),
      ...
      logsConfig: map['logsConfig'] == null ? null : (ProjectLogsConfig.fromMap((map['logsConfig'] as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      projectVisibility: map['projectVisibility'] == null ? null : (map['projectVisibility'] as String).input(),
      queuedTimeout: map['queuedTimeout'] == null ? null : (map['queuedTimeout'] as int).input(),
      region: map['region'] == null ? null : (map['region'] as String).input(),
      resourceAccessRole: map['resourceAccessRole'] == null ? null : (map['resourceAccessRole'] as String).input(),
      secondaryArtifacts: map['secondaryArtifacts'] == null ? null : (pulumi.Input.decodeList<ProjectSecondaryArtifact>(map['secondaryArtifacts'], (value) => ProjectSecondaryArtifact.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secondarySourceVersions: map['secondarySourceVersions'] == null ? null : (pulumi.Input.decodeList<ProjectSecondarySourceVersion>(map['secondarySourceVersions'], (value) => ProjectSecondarySourceVersion.fromMap((value as Map).cast<String, dynamic>()))).input(),
      secondarySources: map['secondarySources'] == null ? null : (pulumi.Input.decodeList<ProjectSecondarySource>(map['secondarySources'], (value) => ProjectSecondarySource.fromMap((value as Map).cast<String, dynamic>()))).input(),
      serviceRole: (map['serviceRole'] as String).input(),
      source: (ProjectSource.fromMap((map['source'] as Map).cast<String, dynamic>())).input(),
      sourceVersion: map['sourceVersion'] == null ? null : (map['sourceVersion'] as String).input(),
      tags: map['tags'] == null ? null : ((map['tags'] as Map).cast<String, String>()).input(),
      vpcConfig: map['vpcConfig'] == null ? null : (ProjectVpcConfig.fromMap((map['vpcConfig'] as Map).cast<String, dynamic>())).input(),
    );
  }
}
