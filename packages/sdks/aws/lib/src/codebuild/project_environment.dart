...
class ProjectEnvironment {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dockerServer': ?dockerServer == null ? null : dockerServer!.toMap(),
      'environmentVariables': ?environmentVariables == null ? null : pulumi.Input.encodeList<ProjectEnvironmentEnvironmentVariable, Map<String, dynamic>>(environmentVariables!, (value) => value.toMap()),
  ...
  factory ProjectEnvironment.fromMap(Map<String, dynamic> map) {
    return ProjectEnvironment(
      ...
      dockerServer: map['dockerServer'] == null ? null : ProjectEnvironmentDockerServer.fromMap((map['dockerServer'] as Map).cast<String, dynamic>()),
      environmentVariables: map['environmentVariables'] == null ? null : pulumi.Input.decodeList<ProjectEnvironmentEnvironmentVariable>(map['environmentVariables'], (value) => ProjectEnvironmentEnvironmentVariable.fromMap((value as Map).cast<String, dynamic>())),
      fleet: map['fleet'] == null ? null : ProjectEnvironmentFleet.fromMap((map['fleet'] as Map).cast<String, dynamic>()),
      image: map['image'] as String,
      imagePullCredentialsType: map['imagePullCredentialsType'] == null ? null : map['imagePullCredentialsType'] as String,
      privilegedMode: map['privilegedMode'] == null ? null : map['privilegedMode'] as bool,
      registryCredential: map['registryCredential'] == null ? null : ProjectEnvironmentRegistryCredential.fromMap((map['registryCredential'] as Map).cast<String, dynamic>()),
