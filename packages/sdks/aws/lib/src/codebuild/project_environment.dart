...
class ProjectEnvironment {
  ...
  /// Configuration block. Detailed below.
  final pulumi.Input<List<ProjectEnvironmentEnvironmentVariable>>?
    ...
    return <String, dynamic>{
      ...
      'dockerServer':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(dockerServer, (value) => value.toMap()),
      'environmentVariables':
          ?pulumi.Input.mapOptionalInputValue<
            List<ProjectEnvironmentEnvironmentVariable>,
  ...
  factory ProjectEnvironment.fromMap(Map<String, dynamic> map) {
    return ProjectEnvironment(
      ...
      dockerServer: (() {
        final guardedValue = map['dockerServer'];
        if (guardedValue == null) return null;
