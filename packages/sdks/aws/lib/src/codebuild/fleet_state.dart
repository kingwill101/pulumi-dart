...
class FleetState {
    ...
    return <String, dynamic>{
      ...
      'statuses':
          ...
          >(
            statuses,
            (value) =>
                pulumi.Input.encodeList<FleetStatus, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory FleetState.fromMap(Map<String, dynamic> map) {
    return FleetState(
      ...
      computeConfiguration: (() {
        final guardedValue = map['computeConfiguration'];
        if (guardedValue == null) return null;
      ...
      fleetServiceRole: (() {
        final guardedValue = map['fleetServiceRole'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      imageId: (() {
      ...
      overflowBehavior: (() {
        final guardedValue = map['overflowBehavior'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
      ...
      statuses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FleetStatus>(
            guardedValue,
            (value) =>
                FleetStatus.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
      ...
      vpcConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FleetVpcConfig>(
            guardedValue,
            (value) =>
                FleetVpcConfig.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
