...
class FleetState {
  ...
  factory FleetState.fromMap(Map<String, dynamic> map) {
    return FleetState(
      ...
      computeType: map['computeType'] == null ? null : ((map['computeType'] as String).input()).input(),
      created: map['created'] == null ? null : ((map['created'] as String).input()).input(),
      environmentType: map['environmentType'] == null ? null : ((map['environmentType'] as String).input()).input(),
      ...
      statuses: map['statuses'] == null ? null : ((pulumi.Input.decodeList<FleetStatus>(map['statuses']!, (value) => FleetStatus.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
