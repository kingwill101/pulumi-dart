...
class ProjectLogsConfig {
  ...
  factory ProjectLogsConfig.fromMap(Map<String, dynamic> map) {
    return ProjectLogsConfig(
      cloudwatchLogs: map['cloudwatchLogs'] == null ? null : ProjectLogsConfigCloudwatchLogs.fromMap((map['cloudwatchLogs'] as Map).cast<String, dynamic>()),
      s3Logs: map['s3Logs'] == null ? null : ProjectLogsConfigS3Logs.fromMap((map['s3Logs'] as Map).cast<String, dynamic>()),
    );
  }
}
