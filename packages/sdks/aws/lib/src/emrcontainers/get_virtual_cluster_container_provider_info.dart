...
class GetVirtualClusterContainerProviderInfo {
  ...
  final pulumi.Input<List<GetVirtualClusterContainerProviderInfoEksInfo>>
  eksInfos;
    ...
    return <String, dynamic>{
      'eksInfos':
          pulumi.Input.mapInputValue<
            List<GetVirtualClusterContainerProviderInfoEksInfo>,
  ...
  factory GetVirtualClusterContainerProviderInfo.fromMap(
    ...
    return GetVirtualClusterContainerProviderInfo(
      eksInfos: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetVirtualClusterContainerProviderInfoEksInfo>(
          map['eksInfos']!,
