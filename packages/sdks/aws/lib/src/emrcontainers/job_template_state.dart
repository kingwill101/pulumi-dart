...
class JobTemplateState {
  ...
  factory JobTemplateState.fromMap(Map<String, dynamic> map) {
    return JobTemplateState(
      ...
      jobTemplateData: (() { final guardedValue = map['jobTemplateData']; if (guardedValue == null) return null; return pulumi.Input.fromValue(JobTemplateJobTemplateData.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
