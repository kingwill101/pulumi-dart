...
class GetLinkLinkConfiguration {
  ...
  final pulumi.Input<List<GetLinkLinkConfigurationLogGroupConfiguration>>
  ...
  final pulumi.Input<List<GetLinkLinkConfigurationMetricConfiguration>>
    ...
    return <String, dynamic>{
      'logGroupConfigurations':
          pulumi.Input.mapInputValue<
            List<GetLinkLinkConfigurationLogGroupConfiguration>,
      ...
      'metricConfigurations':
          pulumi.Input.mapInputValue<
            List<GetLinkLinkConfigurationMetricConfiguration>,
            List<Map<String, dynamic>>
          >(
            metricConfigurations,
            (value) =>
  ...
  factory GetLinkLinkConfiguration.fromMap(Map<String, dynamic> map) {
    return GetLinkLinkConfiguration(
      logGroupConfigurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLinkLinkConfigurationLogGroupConfiguration>(
      ...
      metricConfigurations: pulumi.Input.fromValue(
