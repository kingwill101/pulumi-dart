...
class GetLinkLinkConfiguration {
  ...
  factory GetLinkLinkConfiguration.fromMap(Map<String, dynamic> map) {
    return GetLinkLinkConfiguration(
      logGroupConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLinkLinkConfigurationLogGroupConfiguration>(map['logGroupConfigurations']!, (value) => GetLinkLinkConfigurationLogGroupConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
      metricConfigurations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLinkLinkConfigurationMetricConfiguration>(map['metricConfigurations']!, (value) => GetLinkLinkConfigurationMetricConfiguration.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
