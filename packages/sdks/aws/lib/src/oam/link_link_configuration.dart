...
class LinkLinkConfiguration {
  ...
  factory LinkLinkConfiguration.fromMap(Map<String, dynamic> map) {
    return LinkLinkConfiguration(
      logGroupConfiguration: (() { final guardedValue = map['logGroupConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinkLinkConfigurationLogGroupConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      metricConfiguration: (() { final guardedValue = map['metricConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(LinkLinkConfigurationMetricConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
