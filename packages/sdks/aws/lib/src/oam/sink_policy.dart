...
class SinkPolicy extends pulumi.CustomResource {
  ...
  /// Creates a new [SinkPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SinkPolicy]. {@macro pulumi_oam_sink_policy_sink_policy_args_doc}
  ...
  /// Gets an existing [SinkPolicy] resource's state with the given [name] and [id].
  static SinkPolicy get(
    String name,
