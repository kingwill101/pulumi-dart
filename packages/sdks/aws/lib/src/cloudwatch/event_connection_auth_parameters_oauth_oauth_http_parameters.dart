...
class EventConnectionAuthParametersOauthOauthHttpParameters {
  ...
  final pulumi.Input<
    List<EventConnectionAuthParametersOauthOauthHttpParametersBody>
  >?
  bodies;

  /// Contains additional header parameters for the connection. You can include up to 100 additional body string parameters per request. Each additional parameter counts towards the event payload size, which cannot exceed 64 KB. Each parameter can contain the following:
  final pulumi.Input<
    List<EventConnectionAuthParametersOauthOauthHttpParametersHeader>
  >?
  headers;

  /// Contains additional query string parameters for the connection. You can include up to 100 additional body string parameters per request. Each additional parameter counts towards the event payload size, which cannot exceed 64 KB. Each parameter can contain the following:
  final pulumi.Input<
    List<EventConnectionAuthParametersOauthOauthHttpParametersQueryString>
  >?
  queryStrings;
      ...
      bodies: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EventConnectionAuthParametersOauthOauthHttpParametersBody.fromMap(
      ...
      headers: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EventConnectionAuthParametersOauthOauthHttpParametersHeader.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
      ...
      queryStrings: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EventConnectionAuthParametersOauthOauthHttpParametersQueryString.fromMap(
                  (value as Map).cast<String, dynamic>(),
                ),
          ),
        );
