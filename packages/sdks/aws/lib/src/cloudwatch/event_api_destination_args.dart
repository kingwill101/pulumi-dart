...
class EventApiDestinationArgs {
  ...
  factory EventApiDestinationArgs.fromMap(Map<String, dynamic> map) {
    return EventApiDestinationArgs(
      ...
      invocationRateLimitPerSecond: (() { final guardedValue = map['invocationRateLimitPerSecond']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
