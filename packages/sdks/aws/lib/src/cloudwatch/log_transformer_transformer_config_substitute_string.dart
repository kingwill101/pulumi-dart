...
class LogTransformerTransformerConfigSubstituteString {
  ...
  final pulumi.Input<List<LogTransformerTransformerConfigSubstituteStringEntry>>
  entries;
  ...
  LogTransformerTransformerConfigSubstituteString({required this.entries});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entries':
          pulumi.Input.mapInputValue<
            List<LogTransformerTransformerConfigSubstituteStringEntry>,
