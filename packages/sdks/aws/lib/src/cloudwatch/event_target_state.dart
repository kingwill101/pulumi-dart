...
class EventTargetState {
  ...
  factory EventTargetState.fromMap(Map<String, dynamic> map) {
    return EventTargetState(
      appsyncTarget: map['appsyncTarget'] == null ? null : ((EventTargetAppsyncTarget.fromMap((map['appsyncTarget']! as Map).cast<String, dynamic>())).input()).input(),
      arn: map['arn'] == null ? null : ((map['arn'] as String).input()).input(),
      batchTarget: map['batchTarget'] == null ? null : ((EventTargetBatchTarget.fromMap((map['batchTarget']! as Map).cast<String, dynamic>())).input()).input(),
      deadLetterConfig: map['deadLetterConfig'] == null ? null : ((EventTargetDeadLetterConfig.fromMap((map['deadLetterConfig']! as Map).cast<String, dynamic>())).input()).input(),
      ecsTarget: map['ecsTarget'] == null ? null : ((EventTargetEcsTarget.fromMap((map['ecsTarget']! as Map).cast<String, dynamic>())).input()).input(),
      ...
      httpTarget: map['httpTarget'] == null ? null : ((EventTargetHttpTarget.fromMap((map['httpTarget']! as Map).cast<String, dynamic>())).input()).input(),
      input: map['input'] == null ? null : ((map['input'] as String).input()).input(),
      inputPath: map['inputPath'] == null ? null : ((map['inputPath'] as String).input()).input(),
      inputTransformer: map['inputTransformer'] == null ? null : ((EventTargetInputTransformer.fromMap((map['inputTransformer']! as Map).cast<String, dynamic>())).input()).input(),
      kinesisTarget: map['kinesisTarget'] == null ? null : ((EventTargetKinesisTarget.fromMap((map['kinesisTarget']! as Map).cast<String, dynamic>())).input()).input(),
      redshiftTarget: map['redshiftTarget'] == null ? null : ((EventTargetRedshiftTarget.fromMap((map['redshiftTarget']! as Map).cast<String, dynamic>())).input()).input(),
      region: map['region'] == null ? null : ((map['region'] as String).input()).input(),
      retryPolicy: map['retryPolicy'] == null ? null : ((EventTargetRetryPolicy.fromMap((map['retryPolicy']! as Map).cast<String, dynamic>())).input()).input(),
      roleArn: map['roleArn'] == null ? null : ((map['roleArn'] as String).input()).input(),
      rule: map['rule'] == null ? null : ((map['rule'] as String).input()).input(),
      runCommandTargets: map['runCommandTargets'] == null ? null : ((pulumi.Input.decodeList<EventTargetRunCommandTarget>(map['runCommandTargets']!, (value) => EventTargetRunCommandTarget.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      sagemakerPipelineTarget: map['sagemakerPipelineTarget'] == null ? null : ((EventTargetSagemakerPipelineTarget.fromMap((map['sagemakerPipelineTarget']! as Map).cast<String, dynamic>())).input()).input(),
      sqsTarget: map['sqsTarget'] == null ? null : ((EventTargetSqsTarget.fromMap((map['sqsTarget']! as Map).cast<String, dynamic>())).input()).input(),
