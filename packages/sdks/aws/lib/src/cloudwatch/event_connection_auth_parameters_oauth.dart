...
class EventConnectionAuthParametersOauth {
  ...
  final EventConnectionAuthParametersOauthOauthHttpParameters oauthHttpParameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientParameters': ?clientParameters == null ? null : clientParameters!.toMap(),
      'httpMethod': httpMethod,
      'oauthHttpParameters': oauthHttpParameters.toMap(),
    };
  }
  ...
  factory EventConnectionAuthParametersOauth.fromMap(Map<String, dynamic> map) {
    return EventConnectionAuthParametersOauth(
      ...
      clientParameters: map['clientParameters'] == null ? null : EventConnectionAuthParametersOauthClientParameters.fromMap((map['clientParameters'] as Map).cast<String, dynamic>()),
      httpMethod: map['httpMethod'] as String,
      oauthHttpParameters: EventConnectionAuthParametersOauthOauthHttpParameters.fromMap((map['oauthHttpParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
