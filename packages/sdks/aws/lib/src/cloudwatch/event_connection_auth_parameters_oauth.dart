...
class EventConnectionAuthParametersOauth {
  ...
  final pulumi.Input<EventConnectionAuthParametersOauthOauthHttpParameters> oauthHttpParameters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clientParameters': ?pulumi.Input.mapOptionalInputValue<EventConnectionAuthParametersOauthClientParameters, Map<String, dynamic>>(clientParameters, (value) => value.toMap()),
      'httpMethod': httpMethod,
      'oauthHttpParameters': pulumi.Input.mapInputValue<EventConnectionAuthParametersOauthOauthHttpParameters, Map<String, dynamic>>(oauthHttpParameters, (value) => value.toMap()),
    };
  }
  ...
  factory EventConnectionAuthParametersOauth.fromMap(Map<String, dynamic> map) {
    return EventConnectionAuthParametersOauth(
      ...
      clientParameters: (() { final guardedValue = map['clientParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventConnectionAuthParametersOauthClientParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      httpMethod: pulumi.Input.fromValue(map['httpMethod'] as String),
      oauthHttpParameters: pulumi.Input.fromValue(EventConnectionAuthParametersOauthOauthHttpParameters.fromMap((map['oauthHttpParameters']! as Map).cast<String, dynamic>())),
    );
  }
}
