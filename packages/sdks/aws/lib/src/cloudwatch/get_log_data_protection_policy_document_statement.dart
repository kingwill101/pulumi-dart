...
class GetLogDataProtectionPolicyDocumentStatement {
  ...
  final pulumi.Input<GetLogDataProtectionPolicyDocumentStatementOperation>
  operation;
  ...
  factory GetLogDataProtectionPolicyDocumentStatement.fromMap(
    ...
    return GetLogDataProtectionPolicyDocumentStatement(
      dataIdentifiers: pulumi.Input.fromValue(
        (map['dataIdentifiers'] as List).cast<String>(),
      ),
      operation: pulumi.Input.fromValue(
        GetLogDataProtectionPolicyDocumentStatementOperation.fromMap(
