...
class GetContributorManagedInsightRulesManagedRule {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ruleStates': pulumi.Input.mapInputValue<List<GetContributorManagedInsightRulesManagedRuleRuleState>, List<Map<String, dynamic>>>(ruleStates, (value) => pulumi.Input.encodeList<GetContributorManagedInsightRulesManagedRuleRuleState, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory GetContributorManagedInsightRulesManagedRule.fromMap(Map<String, dynamic> map) {
    return GetContributorManagedInsightRulesManagedRule(
      ...
      ruleStates: pulumi.Input.fromValue(pulumi.Input.decodeList<GetContributorManagedInsightRulesManagedRuleRuleState>(map['ruleStates']!, (value) => GetContributorManagedInsightRulesManagedRuleRuleState.fromMap((value as Map).cast<String, dynamic>()))),
