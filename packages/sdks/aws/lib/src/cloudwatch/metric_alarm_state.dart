...
class MetricAlarmState {
  ...
  factory MetricAlarmState.fromMap(Map<String, dynamic> map) {
    return MetricAlarmState(
      ...
      comparisonOperator: map['comparisonOperator'] == null ? null : ((map['comparisonOperator'] as String).input()).input(),
      datapointsToAlarm: map['datapointsToAlarm'] == null ? null : ((map['datapointsToAlarm'] as int).input()).input(),
      dimensions: map['dimensions'] == null ? null : (((map['dimensions'] as Map).cast<String, String>()).input()).input(),
      evaluateLowSampleCountPercentiles: map['evaluateLowSampleCountPercentiles'] == null ? null : ((map['evaluateLowSampleCountPercentiles'] as String).input()).input(),
      evaluationPeriods: map['evaluationPeriods'] == null ? null : ((map['evaluationPeriods'] as int).input()).input(),
      extendedStatistic: map['extendedStatistic'] == null ? null : ((map['extendedStatistic'] as String).input()).input(),
      ...
      metricQueries: map['metricQueries'] == null ? null : ((pulumi.Input.decodeList<MetricAlarmMetricQuery>(map['metricQueries']!, (value) => MetricAlarmMetricQuery.fromMap((value as Map).cast<String, dynamic>()))).input()).input(),
      ...
      threshold: map['threshold'] == null ? null : ((map['threshold'] as double).input()).input(),
      thresholdMetricId: map['thresholdMetricId'] == null ? null : ((map['thresholdMetricId'] as String).input()).input(),
      treatMissingData: map['treatMissingData'] == null ? null : ((map['treatMissingData'] as String).input()).input(),
