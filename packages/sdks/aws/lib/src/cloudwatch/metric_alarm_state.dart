...
class MetricAlarmState {
  ...
  MetricAlarmState({
    ...
    pulumi.Output<int>? evaluationPeriods,
    ...
    pulumi.Output<String>? unit,
      ...
      evaluationPeriods = pulumi.Input.asOptionalInput<int>(evaluationPeriods),
  ...
  factory MetricAlarmState.fromMap(Map<String, dynamic> map) {
    return MetricAlarmState(
      ...
      evaluationPeriods: map['evaluationPeriods'] == null ? null : pulumi.Output.create<int>(map['evaluationPeriods'] as int),
