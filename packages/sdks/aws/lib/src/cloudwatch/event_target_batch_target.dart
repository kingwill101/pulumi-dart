...
class EventTargetBatchTarget {
  ...
  factory EventTargetBatchTarget.fromMap(Map<String, dynamic> map) {
    return EventTargetBatchTarget(
      arraySize: (() { final guardedValue = map['arraySize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      jobAttempts: (() { final guardedValue = map['jobAttempts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
