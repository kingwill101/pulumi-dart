  ...
  factory LogAnomalyDetectorArgs.fromMap(Map<String, dynamic> map) {
    return LogAnomalyDetectorArgs(
      anomalyVisibilityTime: (() {
        final guardedValue = map['anomalyVisibilityTime'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      detectorName: (() {
        final guardedValue = map['detectorName'];
        if (guardedValue == null) return null;
      ...
      logGroupArnLists: pulumi.Input.fromValue(
        (map['logGroupArnLists'] as List).cast<String>(),
      ),
      region: (() {
