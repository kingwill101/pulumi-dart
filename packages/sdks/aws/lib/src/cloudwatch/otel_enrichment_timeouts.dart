...
class OtelEnrichmentTimeouts {
  ...
  /// Creates a new [OtelEnrichmentTimeouts].
  ...
  factory OtelEnrichmentTimeouts.fromMap(Map<String, dynamic> map) {
    return OtelEnrichmentTimeouts(
