...
class EventEndpointArgs {
  ...
  factory EventEndpointArgs.fromMap(Map<String, dynamic> map) {
    return EventEndpointArgs(
      ...
      eventBuses: pulumi.Input.fromValue(pulumi.Input.decodeList<EventEndpointEventBus>(map['eventBuses']!, (value) => EventEndpointEventBus.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      routingConfig: pulumi.Input.fromValue(EventEndpointRoutingConfig.fromMap((map['routingConfig']! as Map).cast<String, dynamic>())),
    );
  }
}
