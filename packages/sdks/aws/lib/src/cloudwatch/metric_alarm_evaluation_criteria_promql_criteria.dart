...
class MetricAlarmEvaluationCriteriaPromqlCriteria {
  ...
  factory MetricAlarmEvaluationCriteriaPromqlCriteria.fromMap(Map<String, dynamic> map) {
    return MetricAlarmEvaluationCriteriaPromqlCriteria(
      pendingPeriod: (() { final guardedValue = map['pendingPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      query: pulumi.Input.fromValue(map['query'] as String),
      recoveryPeriod: (() { final guardedValue = map['recoveryPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
