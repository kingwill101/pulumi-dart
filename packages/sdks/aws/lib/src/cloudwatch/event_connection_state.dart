...
class EventConnectionState {
  ...
  factory EventConnectionState.fromMap(Map<String, dynamic> map) {
    return EventConnectionState(
      ...
      authParameters: (() { final guardedValue = map['authParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventConnectionAuthParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      invocationConnectivityParameters: (() { final guardedValue = map['invocationConnectivityParameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(EventConnectionInvocationConnectivityParameters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
