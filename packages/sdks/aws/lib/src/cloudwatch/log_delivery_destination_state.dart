...
class LogDeliveryDestinationState {
    ...
    return <String, dynamic>{
      ...
      'deliveryDestinationConfiguration':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(deliveryDestinationConfiguration, (value) => value.toMap()),
  ...
  factory LogDeliveryDestinationState.fromMap(Map<String, dynamic> map) {
    return LogDeliveryDestinationState(
      ...
      deliveryDestinationConfiguration: (() {
        final guardedValue = map['deliveryDestinationConfiguration'];
        if (guardedValue == null) return null;
      ...
      deliveryDestinationType: (() {
        final guardedValue = map['deliveryDestinationType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
