...
class EventConnectionAuthParameters {
  ...
  final pulumi.Input<EventConnectionAuthParametersInvocationHttpParameters>?
    ...
    return <String, dynamic>{
      ...
      'invocationHttpParameters':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(invocationHttpParameters, (value) => value.toMap()),
      'oauth':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory EventConnectionAuthParameters.fromMap(Map<String, dynamic> map) {
    return EventConnectionAuthParameters(
      ...
      invocationHttpParameters: (() {
        final guardedValue = map['invocationHttpParameters'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
