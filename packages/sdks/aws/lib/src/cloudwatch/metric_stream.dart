...
class MetricStream extends pulumi.CustomResource {
  ...
  MetricStream(
    ...
    excludeFilters = registerOutput<List<Map<String, dynamic>>?>(
      'excludeFilters',
    );
    firehoseArn = registerOutput<String>('firehoseArn');
    includeFilters = registerOutput<List<Map<String, dynamic>>?>(
      'includeFilters',
    );
    includeLinkedAccountsMetrics = registerOutput<bool?>(
    ...
    statisticsConfigurations = registerOutput<List<Map<String, dynamic>>?>(
      'statisticsConfigurations',
    );
