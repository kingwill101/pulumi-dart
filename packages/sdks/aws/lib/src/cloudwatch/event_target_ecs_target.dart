...
class EventTargetEcsTarget {
  ...
  final pulumi.Input<List<EventTargetEcsTargetCapacityProviderStrategy>>?
  ...
  final pulumi.Input<EventTargetEcsTargetNetworkConfiguration>?
  networkConfiguration;

  /// An array of placement strategy objects to use for the task. You can specify a maximum of five strategy rules per task.
  final pulumi.Input<List<EventTargetEcsTargetOrderedPlacementStrategy>>?
  orderedPlacementStrategies;

  /// An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime). See Below.
  final pulumi.Input<List<EventTargetEcsTargetPlacementConstraint>>?
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'orderedPlacementStrategies':
          ?pulumi.Input.mapOptionalInputValue<
            List<EventTargetEcsTargetOrderedPlacementStrategy>,
            List<Map<String, dynamic>>
          >(
            orderedPlacementStrategies,
            (value) =>
      ...
      'placementConstraints':
          ?pulumi.Input.mapOptionalInputValue<
            List<EventTargetEcsTargetPlacementConstraint>,
            List<Map<String, dynamic>>
          >(
            placementConstraints,
            (value) =>
    ...
    return EventTargetEcsTarget(
      capacityProviderStrategies: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventTargetEcsTargetCapacityProviderStrategy>(
            guardedValue,
      ...
      networkConfiguration: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          EventTargetEcsTargetNetworkConfiguration.fromMap(
      ...
      orderedPlacementStrategies: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<EventTargetEcsTargetOrderedPlacementStrategy>(
            guardedValue,
