...
class LogDeliveryArgs {
  ...
  factory LogDeliveryArgs.fromMap(Map<String, dynamic> map) {
    return LogDeliveryArgs(
      deliveryDestinationArn: pulumi.Input.fromValue(
        map['deliveryDestinationArn'] as String,
      ),
      deliverySourceName: pulumi.Input.fromValue(
        map['deliverySourceName'] as String,
      ),
      fieldDelimiter: (() {
