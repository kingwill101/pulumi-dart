...
import 'query_definition_state.dart';
...
class QueryDefinition extends pulumi.CustomResource {
  ...
  /// Gets an existing [QueryDefinition] resource's state with the given [name] and [id].
  static QueryDefinition get(
    String name,
