...
class GetLogDataProtectionPolicyDocumentArgs {
  ...
  factory GetLogDataProtectionPolicyDocumentArgs.fromMap(Map<String, dynamic> map) {
    return GetLogDataProtectionPolicyDocumentArgs(
      configuration: (() { final guardedValue = map['configuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(GetLogDataProtectionPolicyDocumentConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      statements: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLogDataProtectionPolicyDocumentStatement>(map['statements']!, (value) => GetLogDataProtectionPolicyDocumentStatement.fromMap((value as Map).cast<String, dynamic>()))),
