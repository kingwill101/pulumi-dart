...
class LogSubscriptionFilterState {
  ...
  final pulumi.Input<dynamic>? logGroup;
  ...
  const LogSubscriptionFilterState({
  ...
  factory LogSubscriptionFilterState.fromMap(Map<String, dynamic> map) {
    return LogSubscriptionFilterState(
      ...
      logGroup: (() { final guardedValue = map['logGroup']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue); })(),
