...
class LogTransformerTransformerConfigRenameKey {
  ...
  factory LogTransformerTransformerConfigRenameKey.fromMap(Map<String, dynamic> map) {
    return LogTransformerTransformerConfigRenameKey(
      entries: pulumi.Input.fromValue(pulumi.Input.decodeList<LogTransformerTransformerConfigRenameKeyEntry>(map['entries']!, (value) => LogTransformerTransformerConfigRenameKeyEntry.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
