...
class LogTransformerTransformerConfigRenameKey {
  ...
  final pulumi.Input<List<LogTransformerTransformerConfigRenameKeyEntry>>
  entries;
    ...
    return <String, dynamic>{
      'entries':
          pulumi.Input.mapInputValue<
            List<LogTransformerTransformerConfigRenameKeyEntry>,
  ...
  factory LogTransformerTransformerConfigRenameKey.fromMap(
    ...
    return LogTransformerTransformerConfigRenameKey(
      entries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<LogTransformerTransformerConfigRenameKeyEntry>(
          map['entries']!,
