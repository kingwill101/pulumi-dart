...
class InternetMonitorState {
  ...
  factory InternetMonitorState.fromMap(Map<String, dynamic> map) {
    return InternetMonitorState(
      ...
      healthEventsConfig: (() {
        final guardedValue = map['healthEventsConfig'];
        if (guardedValue == null) return null;
      ...
      internetMeasurementsLogDelivery: (() {
        final guardedValue = map['internetMeasurementsLogDelivery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      maxCityNetworksToMonitor: (() {
        final guardedValue = map['maxCityNetworksToMonitor'];
        if (guardedValue == null) return null;
      ...
      trafficPercentageToMonitor: (() {
        final guardedValue = map['trafficPercentageToMonitor'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
    );
