...
class LogTransformerTransformerConfigSplitString {
  ...
  final pulumi.Input<List<LogTransformerTransformerConfigSplitStringEntry>>
  entries;
  ...
  LogTransformerTransformerConfigSplitString({required this.entries});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entries':
          pulumi.Input.mapInputValue<
            List<LogTransformerTransformerConfigSplitStringEntry>,
