...
class EventTargetSagemakerPipelineTarget {
  ...
  final pulumi.Input<
    List<EventTargetSagemakerPipelineTargetPipelineParameterList>
  >?
  ...
  EventTargetSagemakerPipelineTarget({this.pipelineParameterLists});
  ...
  factory EventTargetSagemakerPipelineTarget.fromMap(Map<String, dynamic> map) {
    return EventTargetSagemakerPipelineTarget(
      pipelineParameterLists: (() {
        final guardedValue = map['pipelineParameterLists'];
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                EventTargetSagemakerPipelineTargetPipelineParameterList.fromMap(
