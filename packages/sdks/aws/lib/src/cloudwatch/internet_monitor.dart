...
class InternetMonitor extends pulumi.CustomResource {
  ...
  InternetMonitor(
    ...
    this.healthEventsConfig = registerOutput<InternetMonitorHealthEventsConfig?>('healthEventsConfig');
    this.internetMeasurementsLogDelivery = registerOutput<InternetMonitorInternetMeasurementsLogDelivery?>('internetMeasurementsLogDelivery');
    this.maxCityNetworksToMonitor = registerOutput<int?>('maxCityNetworksToMonitor');
    ...
    this.trafficPercentageToMonitor = registerOutput<int?>('trafficPercentageToMonitor');
  }
