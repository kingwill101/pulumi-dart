...
class LogTransformerTransformerConfigMoveKey {
  ...
  /// [entries] Objects containing the information about the keys to move to the log event. You must include at least one entry, and five at most. See `moveKeys` `entry` below for details.
  ...
  factory LogTransformerTransformerConfigMoveKey.fromMap(Map<String, dynamic> map) {
    return LogTransformerTransformerConfigMoveKey(
      entries: pulumi.Input.fromValue(pulumi.Input.decodeList<LogTransformerTransformerConfigMoveKeyEntry>(map['entries']!, (value) => LogTransformerTransformerConfigMoveKeyEntry.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
