...
class LogTransformerTransformerConfig {
  ...
  factory LogTransformerTransformerConfig.fromMap(Map<String, dynamic> map) {
    return LogTransformerTransformerConfig(
      addKeys: map['addKeys'] == null ? null : (LogTransformerTransformerConfigAddKeys.fromMap((map['addKeys'] as Map).cast<String, dynamic>())).input(),
      copyValue: map['copyValue'] == null ? null : (LogTransformerTransformerConfigCopyValue.fromMap((map['copyValue'] as Map).cast<String, dynamic>())).input(),
      csvs: map['csvs'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigCsv>(map['csvs'], (value) => LogTransformerTransformerConfigCsv.fromMap((value as Map).cast<String, dynamic>()))).input(),
      dateTimeConverters: map['dateTimeConverters'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigDateTimeConverter>(map['dateTimeConverters'], (value) => LogTransformerTransformerConfigDateTimeConverter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      deleteKeys: map['deleteKeys'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigDeleteKey>(map['deleteKeys'], (value) => LogTransformerTransformerConfigDeleteKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      grok: map['grok'] == null ? null : (LogTransformerTransformerConfigGrok.fromMap((map['grok'] as Map).cast<String, dynamic>())).input(),
      listToMaps: map['listToMaps'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigListToMap>(map['listToMaps'], (value) => LogTransformerTransformerConfigListToMap.fromMap((value as Map).cast<String, dynamic>()))).input(),
      lowerCaseStrings: map['lowerCaseStrings'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigLowerCaseString>(map['lowerCaseStrings'], (value) => LogTransformerTransformerConfigLowerCaseString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      moveKeys: map['moveKeys'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigMoveKey>(map['moveKeys'], (value) => LogTransformerTransformerConfigMoveKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      parseCloudfront: map['parseCloudfront'] == null ? null : (LogTransformerTransformerConfigParseCloudfront.fromMap((map['parseCloudfront'] as Map).cast<String, dynamic>())).input(),
      parseJsons: map['parseJsons'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigParseJson>(map['parseJsons'], (value) => LogTransformerTransformerConfigParseJson.fromMap((value as Map).cast<String, dynamic>()))).input(),
      parseKeyValues: map['parseKeyValues'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigParseKeyValue>(map['parseKeyValues'], (value) => LogTransformerTransformerConfigParseKeyValue.fromMap((value as Map).cast<String, dynamic>()))).input(),
      parsePostgres: map['parsePostgres'] == null ? null : (LogTransformerTransformerConfigParsePostgres.fromMap((map['parsePostgres'] as Map).cast<String, dynamic>())).input(),
      parseRoute53: map['parseRoute53'] == null ? null : (LogTransformerTransformerConfigParseRoute53.fromMap((map['parseRoute53'] as Map).cast<String, dynamic>())).input(),
      parseToOcsf: map['parseToOcsf'] == null ? null : (LogTransformerTransformerConfigParseToOcsf.fromMap((map['parseToOcsf'] as Map).cast<String, dynamic>())).input(),
      parseVpc: map['parseVpc'] == null ? null : (LogTransformerTransformerConfigParseVpc.fromMap((map['parseVpc'] as Map).cast<String, dynamic>())).input(),
      parseWaf: map['parseWaf'] == null ? null : (LogTransformerTransformerConfigParseWaf.fromMap((map['parseWaf'] as Map).cast<String, dynamic>())).input(),
      renameKeys: map['renameKeys'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigRenameKey>(map['renameKeys'], (value) => LogTransformerTransformerConfigRenameKey.fromMap((value as Map).cast<String, dynamic>()))).input(),
      splitStrings: map['splitStrings'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigSplitString>(map['splitStrings'], (value) => LogTransformerTransformerConfigSplitString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      substituteStrings: map['substituteStrings'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigSubstituteString>(map['substituteStrings'], (value) => LogTransformerTransformerConfigSubstituteString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      trimStrings: map['trimStrings'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigTrimString>(map['trimStrings'], (value) => LogTransformerTransformerConfigTrimString.fromMap((value as Map).cast<String, dynamic>()))).input(),
      typeConverters: map['typeConverters'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigTypeConverter>(map['typeConverters'], (value) => LogTransformerTransformerConfigTypeConverter.fromMap((value as Map).cast<String, dynamic>()))).input(),
      upperCaseStrings: map['upperCaseStrings'] == null ? null : (pulumi.Input.decodeList<LogTransformerTransformerConfigUpperCaseString>(map['upperCaseStrings'], (value) => LogTransformerTransformerConfigUpperCaseString.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
