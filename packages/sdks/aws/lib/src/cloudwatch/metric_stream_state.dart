...
class MetricStreamState {
  ...
  MetricStreamState({
    ...
    pulumi.Output<Map<String, String>>? tagsAll,
      ...
      firehoseArn = pulumi.Input.asOptionalInput<String>(firehoseArn),
      ...
      lastUpdateDate = pulumi.Input.asOptionalInput<String>(lastUpdateDate),
  ...
  factory MetricStreamState.fromMap(Map<String, dynamic> map) {
    return MetricStreamState(
      ...
      firehoseArn: map['firehoseArn'] == null ? null : pulumi.Output.create<String>(map['firehoseArn'] as String),
      ...
      lastUpdateDate: map['lastUpdateDate'] == null ? null : pulumi.Output.create<String>(map['lastUpdateDate'] as String),
