...
class ExportExportDataQuery {
  ...
  factory ExportExportDataQuery.fromMap(Map<String, dynamic> map) {
    return ExportExportDataQuery(
      ...
      tableConfigurations: (() { final guardedValue = map['tableConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeMapValues<Map<String, String>>(guardedValue, (value) => (value as Map).cast<String, String>())); })(),
    );
  }
}
