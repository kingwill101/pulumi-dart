...
class ExportExportDestinationConfiguration {
  ...
  final pulumi.Input<List<ExportExportDestinationConfigurationS3Destination>>?
  s3Destinations;
    ...
    return <String, dynamic>{
      's3Destinations':
          ?pulumi.Input.mapOptionalInputValue<
            List<ExportExportDestinationConfigurationS3Destination>,
  ...
  factory ExportExportDestinationConfiguration.fromMap(
    ...
    return ExportExportDestinationConfiguration(
      s3Destinations: (() {
        final guardedValue = map['s3Destinations'];
