...
class ExportExport {
  ...
  factory ExportExport.fromMap(Map<String, dynamic> map) {
    return ExportExport(
      dataQueries: (() { final guardedValue = map['dataQueries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExportExportDataQuery>(guardedValue, (value) => ExportExportDataQuery.fromMap((value as Map).cast<String, dynamic>()))); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      destinationConfigurations: (() { final guardedValue = map['destinationConfigurations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExportExportDestinationConfiguration>(guardedValue, (value) => ExportExportDestinationConfiguration.fromMap((value as Map).cast<String, dynamic>()))); })(),
      exportArn: (() { final guardedValue = map['exportArn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      refreshCadences: (() { final guardedValue = map['refreshCadences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ExportExportRefreshCadence>(guardedValue, (value) => ExportExportRefreshCadence.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
