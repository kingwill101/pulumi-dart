...
class RuleSetRuleUnlessBooleanExpressionEvaluateIsInAddressList {
  ...
  /// Creates a new [RuleSetRuleUnlessBooleanExpressionEvaluateIsInAddressList].
  ...
  const RuleSetRuleUnlessBooleanExpressionEvaluateIsInAddressList({
  ...
  factory RuleSetRuleUnlessBooleanExpressionEvaluateIsInAddressList.fromMap(Map<String, dynamic> map) {
    return RuleSetRuleUnlessBooleanExpressionEvaluateIsInAddressList(
