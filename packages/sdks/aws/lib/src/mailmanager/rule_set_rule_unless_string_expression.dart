...
import 'rule_set_rule_unless_string_expression_evaluate.dart';

class RuleSetRuleUnlessStringExpression {
  ...
  final pulumi.Input<RuleSetRuleUnlessStringExpressionEvaluate?>? evaluate;
  ...
  /// Creates a new [RuleSetRuleUnlessStringExpression].
  ...
  const RuleSetRuleUnlessStringExpression({
    this.evaluate,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'evaluate': ?pulumi.Input.mapOptionalInputValue<RuleSetRuleUnlessStringExpressionEvaluate, Map<String, dynamic>>(evaluate, (value) => value.toMap()),
      'operator': operator,
      'values': values,
    };
  }

  factory RuleSetRuleUnlessStringExpression.fromMap(Map<String, dynamic> map) {
    return RuleSetRuleUnlessStringExpression(
      evaluate: (() { final guardedValue = map['evaluate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(RuleSetRuleUnlessStringExpressionEvaluate.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
