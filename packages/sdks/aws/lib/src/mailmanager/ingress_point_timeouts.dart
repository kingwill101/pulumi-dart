...
class IngressPointTimeouts {
  ...
  /// Creates a new [IngressPointTimeouts].
  ...
  factory IngressPointTimeouts.fromMap(Map<String, dynamic> map) {
    return IngressPointTimeouts(
