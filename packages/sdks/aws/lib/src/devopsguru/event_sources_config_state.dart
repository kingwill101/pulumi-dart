...
class EventSourcesConfigState {
  ...
  factory EventSourcesConfigState.fromMap(Map<String, dynamic> map) {
    return EventSourcesConfigState(
      eventSources: (() { final guardedValue = map['eventSources']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<EventSourcesConfigEventSource>(guardedValue, (value) => EventSourcesConfigEventSource.fromMap((value as Map).cast<String, dynamic>()))); })(),
