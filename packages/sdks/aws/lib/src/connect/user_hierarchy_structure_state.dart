...
class UserHierarchyStructureState {
  ...
  factory UserHierarchyStructureState.fromMap(Map<String, dynamic> map) {
    return UserHierarchyStructureState(
      hierarchyStructure: (() { final guardedValue = map['hierarchyStructure']; if (guardedValue == null) return null; return pulumi.Input.fromValue(UserHierarchyStructureHierarchyStructure.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
