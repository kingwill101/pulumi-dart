...
class GetHoursOfOperationConfig {
    ...
    return <String, dynamic>{
      ...
      'endTimes':
          pulumi.Input.mapInputValue<
            List<GetHoursOfOperationConfigEndTime>,
      ...
      'startTimes':
          pulumi.Input.mapInputValue<
            List<GetHoursOfOperationConfigStartTime>,
            List<Map<String, dynamic>>
          >(
            startTimes,
            (value) =>
  ...
  factory GetHoursOfOperationConfig.fromMap(Map<String, dynamic> map) {
    return GetHoursOfOperationConfig(
      ...
      endTimes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetHoursOfOperationConfigEndTime>(
          map['endTimes']!,
      ...
      startTimes: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetHoursOfOperationConfigStartTime>(
          map['startTimes']!,
