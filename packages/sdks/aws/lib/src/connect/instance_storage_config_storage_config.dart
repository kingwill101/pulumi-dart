...
class InstanceStorageConfigStorageConfig {
  ...
  final pulumi.Input<InstanceStorageConfigStorageConfigKinesisFirehoseConfig>?
  kinesisFirehoseConfig;

  /// A block that specifies the configuration of the Kinesis data stream. Documented below.
  final pulumi.Input<InstanceStorageConfigStorageConfigKinesisStreamConfig>?
  kinesisStreamConfig;
    ...
    return <String, dynamic>{
      'kinesisFirehoseConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(kinesisFirehoseConfig, (value) => value.toMap()),
      'kinesisStreamConfig':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'kinesisVideoStreamConfig':
          ?pulumi.Input.mapOptionalInputValue<
            InstanceStorageConfigStorageConfigKinesisVideoStreamConfig,
            Map<String, dynamic>
          >(kinesisVideoStreamConfig, (value) => value.toMap()),
      's3Config':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory InstanceStorageConfigStorageConfig.fromMap(Map<String, dynamic> map) {
    return InstanceStorageConfigStorageConfig(
      kinesisFirehoseConfig: (() {
        final guardedValue = map['kinesisFirehoseConfig'];
      ...
      kinesisStreamConfig: (() {
        final guardedValue = map['kinesisStreamConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      kinesisVideoStreamConfig: (() {
        final guardedValue = map['kinesisVideoStreamConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
