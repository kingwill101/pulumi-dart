...
class UserArgs {
    ...
    return <String, dynamic>{
      ...
      'identityInfo':
          ?pulumi.Input.mapOptionalInputValue<
            UserIdentityInfo,
            Map<String, dynamic>
          >(identityInfo, (value) => value.toMap()),
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      directoryUserId: (() {
        final guardedValue = map['directoryUserId'];
      ...
      identityInfo: (() {
        final guardedValue = map['identityInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          UserIdentityInfo.fromMap(
      ...
      phoneConfig: pulumi.Input.fromValue(
        UserPhoneConfig.fromMap(
          (map['phoneConfig']! as Map).cast<String, dynamic>(),
        ),
      ),
      region: (() {
      ...
      routingProfileId: pulumi.Input.fromValue(
        map['routingProfileId'] as String,
      ),
      securityProfileIds: pulumi.Input.fromValue(
        (map['securityProfileIds'] as List).cast<String>(),
      ),
      tags: (() {
