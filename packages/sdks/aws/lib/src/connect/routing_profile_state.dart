...
class RoutingProfileState {
  ...
  factory RoutingProfileState.fromMap(Map<String, dynamic> map) {
    return RoutingProfileState(
      ...
      defaultOutboundQueueId: (() { final guardedValue = map['defaultOutboundQueueId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      description: (() { final guardedValue = map['description']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      instanceId: (() { final guardedValue = map['instanceId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mediaConcurrencies: (() { final guardedValue = map['mediaConcurrencies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RoutingProfileMediaConcurrency>(guardedValue, (value) => RoutingProfileMediaConcurrency.fromMap((value as Map).cast<String, dynamic>()))); })(),
