...
class QueueArgs {
  ...
  /// [tags] Tags to apply to the Queue. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
  const QueueArgs({
    this.description,
