...
class RoutingProfileArgs {
    ...
    return <String, dynamic>{
      ...
      'mediaConcurrencies':
          pulumi.Input.mapInputValue<
            List<RoutingProfileMediaConcurrency>,
  ...
  factory RoutingProfileArgs.fromMap(Map<String, dynamic> map) {
    return RoutingProfileArgs(
      defaultOutboundQueueId: pulumi.Input.fromValue(
        map['defaultOutboundQueueId'] as String,
      ),
      description: pulumi.Input.fromValue(map['description'] as String),
      instanceId: pulumi.Input.fromValue(map['instanceId'] as String),
      mediaConcurrencies: pulumi.Input.fromValue(
        pulumi.Input.decodeList<RoutingProfileMediaConcurrency>(
          map['mediaConcurrencies']!,
          (value) => RoutingProfileMediaConcurrency.fromMap(
      ...
      queueConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RoutingProfileQueueConfig>(
            guardedValue,
            (value) => RoutingProfileQueueConfig.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
