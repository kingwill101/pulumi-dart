...
class GetUserHierarchyGroupHierarchyPath {
  ...
  final pulumi.Input<List<GetUserHierarchyGroupHierarchyPathLevelFife>>
  levelFives;

  /// Details of level four. See below.
  final pulumi.Input<List<GetUserHierarchyGroupHierarchyPathLevelFour>>
  levelFours;

  /// Details of level one. See below.
  final pulumi.Input<List<GetUserHierarchyGroupHierarchyPathLevelOne>>
  levelOnes;

  /// Details of level three. See below.
  final pulumi.Input<List<GetUserHierarchyGroupHierarchyPathLevelThree>>
  levelThrees;

  /// Details of level two. See below.
  final pulumi.Input<List<GetUserHierarchyGroupHierarchyPathLevelTwo>>
  levelTwos;
    ...
    return <String, dynamic>{
      'levelFives':
          pulumi.Input.mapInputValue<
            List<GetUserHierarchyGroupHierarchyPathLevelFife>,
      ...
      'levelFours':
          pulumi.Input.mapInputValue<
            List<GetUserHierarchyGroupHierarchyPathLevelFour>,
            List<Map<String, dynamic>>
          >(
            levelFours,
            (value) =>
      ...
      'levelOnes':
          pulumi.Input.mapInputValue<
            List<GetUserHierarchyGroupHierarchyPathLevelOne>,
            List<Map<String, dynamic>>
          >(
            levelOnes,
            (value) =>
      ...
      'levelThrees':
          pulumi.Input.mapInputValue<
            List<GetUserHierarchyGroupHierarchyPathLevelThree>,
            List<Map<String, dynamic>>
          >(
            levelThrees,
            (value) =>
      ...
      'levelTwos':
          pulumi.Input.mapInputValue<
            List<GetUserHierarchyGroupHierarchyPathLevelTwo>,
            List<Map<String, dynamic>>
          >(
            levelTwos,
            (value) =>
