...
class UserPhoneConfig {
  ...
  factory UserPhoneConfig.fromMap(Map<String, dynamic> map) {
    return UserPhoneConfig(
      afterContactWorkTimeLimit: map['afterContactWorkTimeLimit'] == null ? null : map['afterContactWorkTimeLimit'] as int,
      autoAccept: map['autoAccept'] == null ? null : map['autoAccept'] as bool,
      deskPhoneNumber: map['deskPhoneNumber'] == null ? null : map['deskPhoneNumber'] as String,
