...
class HoursOfOperationConfig {
  ...
  /// [endTime] A end time block specifies the time that your contact center closes. The `endTime` is documented below.
  /// [startTime] A start time block specifies the time that your contact center opens. The `startTime` is documented below.
  ...
  factory HoursOfOperationConfig.fromMap(Map<String, dynamic> map) {
    return HoursOfOperationConfig(
      ...
      endTime: pulumi.Input.fromValue(HoursOfOperationConfigEndTime.fromMap((map['endTime']! as Map).cast<String, dynamic>())),
      startTime: pulumi.Input.fromValue(HoursOfOperationConfigStartTime.fromMap((map['startTime']! as Map).cast<String, dynamic>())),
    );
  }
}
