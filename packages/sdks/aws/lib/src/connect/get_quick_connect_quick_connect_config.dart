...
class GetQuickConnectQuickConnectConfig {
  ...
  final pulumi.Input<List<GetQuickConnectQuickConnectConfigPhoneConfig>>
  phoneConfigs;
  ...
  final pulumi.Input<List<GetQuickConnectQuickConnectConfigQueueConfig>>
  queueConfigs;
  ...
  final pulumi.Input<List<GetQuickConnectQuickConnectConfigUserConfig>>
  userConfigs;
    ...
    return <String, dynamic>{
      'phoneConfigs':
          pulumi.Input.mapInputValue<
            List<GetQuickConnectQuickConnectConfigPhoneConfig>,
      ...
      'queueConfigs':
          pulumi.Input.mapInputValue<
            List<GetQuickConnectQuickConnectConfigQueueConfig>,
            List<Map<String, dynamic>>
          >(
            queueConfigs,
            (value) =>
      ...
      'userConfigs':
          pulumi.Input.mapInputValue<
            List<GetQuickConnectQuickConnectConfigUserConfig>,
            List<Map<String, dynamic>>
          >(
            userConfigs,
            (value) =>
  ...
  factory GetQuickConnectQuickConnectConfig.fromMap(Map<String, dynamic> map) {
    return GetQuickConnectQuickConnectConfig(
      phoneConfigs: pulumi.Input.fromValue(
      ...
      queueConfigs: pulumi.Input.fromValue(
      ...
      quickConnectType: pulumi.Input.fromValue(
        map['quickConnectType'] as String,
      ),
      userConfigs: pulumi.Input.fromValue(
