...
class QuickConnectState {
  ...
  factory QuickConnectState.fromMap(Map<String, dynamic> map) {
    return QuickConnectState(
      ...
      quickConnectConfig: (() { final guardedValue = map['quickConnectConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(QuickConnectQuickConnectConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
