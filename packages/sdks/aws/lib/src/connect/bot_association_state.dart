...
class BotAssociationState {
  ...
  factory BotAssociationState.fromMap(Map<String, dynamic> map) {
    return BotAssociationState(
      ...
      lexBot: (() { final guardedValue = map['lexBot']; if (guardedValue == null) return null; return pulumi.Input.fromValue(BotAssociationLexBot.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
