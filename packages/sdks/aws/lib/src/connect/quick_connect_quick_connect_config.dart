...
class QuickConnectQuickConnectConfig {
  ...
  final pulumi.Input<List<QuickConnectQuickConnectConfigPhoneConfig>>?
  phoneConfigs;
  ...
  final pulumi.Input<List<QuickConnectQuickConnectConfigQueueConfig>>?
  queueConfigs;
  ...
  final pulumi.Input<List<QuickConnectQuickConnectConfigUserConfig>>?
  userConfigs;
    ...
    return <String, dynamic>{
      'phoneConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<QuickConnectQuickConnectConfigPhoneConfig>,
      ...
      'queueConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<QuickConnectQuickConnectConfigQueueConfig>,
            List<Map<String, dynamic>>
          >(
            queueConfigs,
            (value) =>
      ...
      'userConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<QuickConnectQuickConnectConfigUserConfig>,
            List<Map<String, dynamic>>
          >(
            userConfigs,
            (value) =>
  ...
  factory QuickConnectQuickConnectConfig.fromMap(Map<String, dynamic> map) {
    return QuickConnectQuickConnectConfig(
      phoneConfigs: (() {
        final guardedValue = map['phoneConfigs'];
      ...
      queueConfigs: (() {
        final guardedValue = map['queueConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
      ...
      userConfigs: (() {
        final guardedValue = map['userConfigs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
