...
class UserHierarchyGroupState {
    ...
    return <String, dynamic>{
      ...
      'hierarchyPaths':
          ?pulumi.Input.mapOptionalInputValue<
            List<UserHierarchyGroupHierarchyPath>,
  ...
  factory UserHierarchyGroupState.fromMap(Map<String, dynamic> map) {
    return UserHierarchyGroupState(
      ...
      hierarchyPaths: (() {
        final guardedValue = map['hierarchyPaths'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<UserHierarchyGroupHierarchyPath>(
            guardedValue,
            (value) => UserHierarchyGroupHierarchyPath.fromMap(
      ...
      levelId: (() {
        final guardedValue = map['levelId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      parentGroupId: (() {
        final guardedValue = map['parentGroupId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      region: (() {
