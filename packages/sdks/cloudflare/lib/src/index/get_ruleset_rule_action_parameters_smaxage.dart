...
class GetRulesetRuleActionParametersSMaxage {
  ...
  /// Creates a new [GetRulesetRuleActionParametersSMaxage].
  ...
  const GetRulesetRuleActionParametersSMaxage({
  ...
  factory GetRulesetRuleActionParametersSMaxage.fromMap(Map<String, dynamic> map) {
    return GetRulesetRuleActionParametersSMaxage(
