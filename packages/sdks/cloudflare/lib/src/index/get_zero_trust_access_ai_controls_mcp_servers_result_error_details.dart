...
class GetZeroTrustAccessAiControlsMcpServersResultErrorDetails {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpServersResultErrorDetails].
  ...
  const GetZeroTrustAccessAiControlsMcpServersResultErrorDetails({
    required this.cause,
  ...
  factory GetZeroTrustAccessAiControlsMcpServersResultErrorDetails.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpServersResultErrorDetails(
