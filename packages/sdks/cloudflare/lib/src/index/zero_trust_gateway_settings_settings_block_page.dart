...
class ZeroTrustGatewaySettingsSettingsBlockPage {
  ...
  /// Creates a new [ZeroTrustGatewaySettingsSettingsBlockPage].
  ...
  factory ZeroTrustGatewaySettingsSettingsBlockPage.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewaySettingsSettingsBlockPage(
