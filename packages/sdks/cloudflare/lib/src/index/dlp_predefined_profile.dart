...
import 'dlp_predefined_profile_args.dart';
import 'dlp_predefined_profile_entry.dart';
import 'dlp_predefined_profile_state.dart';
...
class DlpPredefinedProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<DlpPredefinedProfileEntry>> entries;
  ...
  /// Creates a new [DlpPredefinedProfile].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DlpPredefinedProfile]. {@macro pulumi_index_dlp_predefined_profile_dlp_predefined_profile_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DlpPredefinedProfile(
    String name, {
    DlpPredefinedProfileArgs? args,
    ...
    entries = registerOutput<List<DlpPredefinedProfileEntry>>('entries', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<DlpPredefinedProfileEntry>(guardedValue, (value) => DlpPredefinedProfileEntry.fromMap((value as Map).cast<String, dynamic>())); });
  ...
  /// Gets an existing [DlpPredefinedProfile] resource's state with the given [name] and [id].
  static DlpPredefinedProfile get(
    String name,
    pulumi.Input<String> id, {
    DlpPredefinedProfileState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DlpPredefinedProfile._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DlpPredefinedProfile] resource.
  DlpPredefinedProfile.reference(String urn)
    : super(
        'cloudflare:index/dlpPredefinedProfile:DlpPredefinedProfile',
