...
class HealthcheckState {
  ...
  factory HealthcheckState.fromMap(Map<String, dynamic> map) {
    return HealthcheckState(
      ...
      consecutiveFails: (() { final guardedValue = map['consecutiveFails']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      consecutiveSuccesses: (() { final guardedValue = map['consecutiveSuccesses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
