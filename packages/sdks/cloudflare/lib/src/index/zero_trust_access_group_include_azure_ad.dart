...
class ZeroTrustAccessGroupIncludeAzureAd {
  ...
  /// Creates a new [ZeroTrustAccessGroupIncludeAzureAd].
  ...
  factory ZeroTrustAccessGroupIncludeAzureAd.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupIncludeAzureAd(
