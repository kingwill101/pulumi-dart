...
class RulesetRuleActionParametersImmutable {
  ...
  /// Creates a new [RulesetRuleActionParametersImmutable].
  /// [cloudflareOnly] Whether to apply the directive only to Cloudflare's cache.
  /// [operation] The operation to perform.
  const RulesetRuleActionParametersImmutable({
    this.cloudflareOnly,
  ...
  factory RulesetRuleActionParametersImmutable.fromMap(Map<String, dynamic> map) {
    return RulesetRuleActionParametersImmutable(
