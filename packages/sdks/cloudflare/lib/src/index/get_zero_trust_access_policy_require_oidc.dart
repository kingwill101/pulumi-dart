...
class GetZeroTrustAccessPolicyRequireOidc {
  ...
  /// Creates a new [GetZeroTrustAccessPolicyRequireOidc].
  ...
  const GetZeroTrustAccessPolicyRequireOidc({
  ...
  factory GetZeroTrustAccessPolicyRequireOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPolicyRequireOidc(
