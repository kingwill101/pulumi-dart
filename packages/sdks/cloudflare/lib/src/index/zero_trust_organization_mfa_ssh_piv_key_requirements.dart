...
class ZeroTrustOrganizationMfaSshPivKeyRequirements {
  ...
  /// Creates a new [ZeroTrustOrganizationMfaSshPivKeyRequirements].
  ...
  factory ZeroTrustOrganizationMfaSshPivKeyRequirements.fromMap(Map<String, dynamic> map) {
    return ZeroTrustOrganizationMfaSshPivKeyRequirements(
