...
class ZeroTrustAccessGroupRequireAzureAd {
  ...
  /// Creates a new [ZeroTrustAccessGroupRequireAzureAd].
  ...
  factory ZeroTrustAccessGroupRequireAzureAd.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupRequireAzureAd(
