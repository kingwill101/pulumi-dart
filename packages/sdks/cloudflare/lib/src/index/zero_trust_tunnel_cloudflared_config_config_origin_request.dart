...
import 'zero_trust_tunnel_cloudflared_config_config_origin_request_access.dart';

class ZeroTrustTunnelCloudflaredConfigConfigOriginRequest {
  /// For all L7 requests to this hostname, cloudflared will validate each request's Cf-Access-Jwt-Assertion request header.
  final pulumi.Input<ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess?>? access;
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredConfigConfigOriginRequest].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'access': ?pulumi.Input.mapOptionalInputValue<ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess, Map<String, dynamic>>(access, (value) => value.toMap()),
      'caPool': ?caPool,
  ...
  factory ZeroTrustTunnelCloudflaredConfigConfigOriginRequest.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelCloudflaredConfigConfigOriginRequest(
      access: (() { final guardedValue = map['access']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
