...
class ZeroTrustDlpEntryVariant {
  ...
  /// Creates a new [ZeroTrustDlpEntryVariant].
  ...
  const ZeroTrustDlpEntryVariant({
    this.description,
    this.topicType,
    this.type,
  });
  ...
  factory ZeroTrustDlpEntryVariant.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDlpEntryVariant(
