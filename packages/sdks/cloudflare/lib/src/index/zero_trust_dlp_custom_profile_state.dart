...
class ZeroTrustDlpCustomProfileState {
  ...
  /// Creates a new [ZeroTrustDlpCustomProfileState].
  /// [accountId] Optional.
  ...
  const ZeroTrustDlpCustomProfileState({
    this.accountId,
  ...
  factory ZeroTrustDlpCustomProfileState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDlpCustomProfileState(
