...
class GetAiGatewaysResultOtel {
  ...
  /// Creates a new [GetAiGatewaysResultOtel].
  /// [authorization] Required.
  /// [contentType] Available values: "json", "protobuf".
  /// [headers] Required.
  /// [url] Required.
  const GetAiGatewaysResultOtel({
  ...
  factory GetAiGatewaysResultOtel.fromMap(Map<String, dynamic> map) {
    return GetAiGatewaysResultOtel(
