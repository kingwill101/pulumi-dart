...
/// {@template pulumi_index_get_zero_trust_tunnel_warp_connectors_get_zero_trust_tunnel_warp_connectors_args_doc}
/// Arguments for getZeroTrustTunnelWarpConnectors.
/// {@endtemplate}
/// {@macro pulumi_index_get_zero_trust_tunnel_warp_connectors_get_zero_trust_tunnel_warp_connectors_args_doc}
class GetZeroTrustTunnelWarpConnectorsArgs {
  ...
  /// Creates a new [GetZeroTrustTunnelWarpConnectorsArgs].
  ...
  const GetZeroTrustTunnelWarpConnectorsArgs({
    this.accountId,
    this.excludePrefix,
    this.existedAt,
    this.includePrefix,
  ...
  factory GetZeroTrustTunnelWarpConnectorsArgs.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustTunnelWarpConnectorsArgs(
