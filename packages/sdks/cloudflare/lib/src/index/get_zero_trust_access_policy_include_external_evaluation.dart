...
class GetZeroTrustAccessPolicyIncludeExternalEvaluation {
  /// The API endpoint containing your business logic.
  final pulumi.Input<String> evaluateUrl;
  /// The API endpoint containing the key that Access uses to verify that the response came from your API.
  final pulumi.Input<String> keysUrl;

  /// Creates a new [GetZeroTrustAccessPolicyIncludeExternalEvaluation].
  ...
  const GetZeroTrustAccessPolicyIncludeExternalEvaluation({
  ...
  factory GetZeroTrustAccessPolicyIncludeExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPolicyIncludeExternalEvaluation(
