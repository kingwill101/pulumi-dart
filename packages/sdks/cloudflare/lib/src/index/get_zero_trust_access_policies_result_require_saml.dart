...
class GetZeroTrustAccessPoliciesResultRequireSaml {
  ...
  /// Creates a new [GetZeroTrustAccessPoliciesResultRequireSaml].
  ...
  const GetZeroTrustAccessPoliciesResultRequireSaml({
  ...
  factory GetZeroTrustAccessPoliciesResultRequireSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultRequireSaml(
