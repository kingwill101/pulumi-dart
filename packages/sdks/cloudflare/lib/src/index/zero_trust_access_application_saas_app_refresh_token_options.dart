...
class ZeroTrustAccessApplicationSaasAppRefreshTokenOptions {
  ...
  /// Creates a new [ZeroTrustAccessApplicationSaasAppRefreshTokenOptions].
  /// [lifetime] How long a refresh token will be valid for after creation. Valid units are m,h,d. Must be longer than 1m.
  const ZeroTrustAccessApplicationSaasAppRefreshTokenOptions({
    this.lifetime,
  });
  ...
  factory ZeroTrustAccessApplicationSaasAppRefreshTokenOptions.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationSaasAppRefreshTokenOptions(
