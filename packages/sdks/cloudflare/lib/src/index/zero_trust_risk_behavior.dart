...
import 'zero_trust_risk_behavior_args.dart';
import 'zero_trust_risk_behavior_behaviors.dart';
import 'zero_trust_risk_behavior_state.dart';
...
class ZeroTrustRiskBehavior extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Map<String, ZeroTrustRiskBehaviorBehaviors>> behaviors;

  /// Creates a new [ZeroTrustRiskBehavior].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustRiskBehavior]. {@macro pulumi_index_zero_trust_risk_behavior_zero_trust_risk_behavior_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustRiskBehavior(
    String name, {
    ZeroTrustRiskBehaviorArgs? args,
  ...
  /// Gets an existing [ZeroTrustRiskBehavior] resource's state with the given [name] and [id].
  static ZeroTrustRiskBehavior get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustRiskBehaviorState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustRiskBehavior._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ZeroTrustRiskBehavior] resource.
  ZeroTrustRiskBehavior.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustRiskBehavior:ZeroTrustRiskBehavior',
