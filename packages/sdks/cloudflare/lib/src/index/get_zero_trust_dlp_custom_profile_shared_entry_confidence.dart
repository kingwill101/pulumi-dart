...
class GetZeroTrustDlpCustomProfileSharedEntryConfidence {
  /// Indicates whether this entry has AI remote service validation.
  final pulumi.Input<bool> aiContextAvailable;
  /// Indicates whether this entry has any form of validation that is not an AI remote service.
  final pulumi.Input<bool> available;

  /// Creates a new [GetZeroTrustDlpCustomProfileSharedEntryConfidence].
  ...
  const GetZeroTrustDlpCustomProfileSharedEntryConfidence({
  ...
  factory GetZeroTrustDlpCustomProfileSharedEntryConfidence.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpCustomProfileSharedEntryConfidence(
