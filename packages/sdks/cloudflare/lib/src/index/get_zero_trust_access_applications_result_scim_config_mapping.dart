...
import 'get_zero_trust_access_applications_result_scim_config_mapping_operations.dart';

class GetZeroTrustAccessApplicationsResultScimConfigMapping {
  /// Whether or not this mapping is enabled.
  final pulumi.Input<bool> enabled;
  /// A [SCIM filter expression](https://datatracker.ietf.org/doc/html/rfc7644#section-3.4.2.2) that matches resources that should be provisioned to this application.
  final pulumi.Input<String> filter;
  /// Whether or not this mapping applies to creates, updates, or deletes.
  final pulumi.Input<GetZeroTrustAccessApplicationsResultScimConfigMappingOperations> operations;
  ...
  /// Creates a new [GetZeroTrustAccessApplicationsResultScimConfigMapping].
  ...
  const GetZeroTrustAccessApplicationsResultScimConfigMapping({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enabled': enabled,
      'filter': filter,
      'operations': pulumi.Input.mapInputValue<GetZeroTrustAccessApplicationsResultScimConfigMappingOperations, Map<String, dynamic>>(operations, (value) => value.toMap()),
      'schema': schema,
  ...
  factory GetZeroTrustAccessApplicationsResultScimConfigMapping.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationsResultScimConfigMapping(
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      filter: pulumi.Input.fromValue(map['filter'] as String),
      operations: pulumi.Input.fromValue(GetZeroTrustAccessApplicationsResultScimConfigMappingOperations.fromMap((map['operations']! as Map).cast<String, dynamic>())),
