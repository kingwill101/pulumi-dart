...
class GetDnsRecordsResultData {
  ...
  /// Creates a new [GetDnsRecordsResultData].
  /// [algorithm] Algorithm.
  ...
  factory GetDnsRecordsResultData.fromMap(Map<String, dynamic> map) {
    return GetDnsRecordsResultData(
