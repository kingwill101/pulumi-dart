...
class ZeroTrustOrganizationMfaConfig {
  ...
  /// Creates a new [ZeroTrustOrganizationMfaConfig].
  /// [allowedAuthenticators] Lists the MFA methods that users can authenticate with. `sshPivKey` is only relevant for infrastructure applications.
  ...
  factory ZeroTrustOrganizationMfaConfig.fromMap(Map<String, dynamic> map) {
    return ZeroTrustOrganizationMfaConfig(
