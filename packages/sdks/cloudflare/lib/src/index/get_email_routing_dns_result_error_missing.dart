...
class GetEmailRoutingDnsResultErrorMissing {
  /// DNS record content.
  ...
  /// Creates a new [GetEmailRoutingDnsResultErrorMissing].
  ...
  const GetEmailRoutingDnsResultErrorMissing({
  ...
  factory GetEmailRoutingDnsResultErrorMissing.fromMap(Map<String, dynamic> map) {
    return GetEmailRoutingDnsResultErrorMissing(
