...
class ZeroTrustOrganizationState {
  ...
  /// Creates a new [ZeroTrustOrganizationState].
  ...
  const ZeroTrustOrganizationState({
    this.accountId,
  ...
  factory ZeroTrustOrganizationState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustOrganizationState(
