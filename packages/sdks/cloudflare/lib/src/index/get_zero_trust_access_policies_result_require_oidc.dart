...
class GetZeroTrustAccessPoliciesResultRequireOidc {
  ...
  /// Creates a new [GetZeroTrustAccessPoliciesResultRequireOidc].
  ...
  const GetZeroTrustAccessPoliciesResultRequireOidc({
  ...
  factory GetZeroTrustAccessPoliciesResultRequireOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultRequireOidc(
