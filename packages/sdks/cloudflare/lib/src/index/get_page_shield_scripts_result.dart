...
class GetPageShieldScriptsResult {
  ...
  factory GetPageShieldScriptsResult.fromMap(Map<String, dynamic> map) {
    return GetPageShieldScriptsResult(
      ...
      cryptominingScore: (() { final guardedValue = map['cryptominingScore']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      dataflowScore: (() { final guardedValue = map['dataflowScore']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      jsIntegrityScore: (() { final guardedValue = map['jsIntegrityScore']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      lastSeenAt: (() { final guardedValue = map['lastSeenAt']; if (guardedValue == null) return null; return guardedValue as String; })(),
      magecartScore: (() { final guardedValue = map['magecartScore']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      ...
      malwareScore: (() { final guardedValue = map['malwareScore']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      obfuscationScore: (() { final guardedValue = map['obfuscationScore']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
