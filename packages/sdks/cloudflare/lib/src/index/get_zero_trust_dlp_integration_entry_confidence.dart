...
class GetZeroTrustDlpIntegrationEntryConfidence {
  ...
  const GetZeroTrustDlpIntegrationEntryConfidence({
  ...
  factory GetZeroTrustDlpIntegrationEntryConfidence.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpIntegrationEntryConfidence(
