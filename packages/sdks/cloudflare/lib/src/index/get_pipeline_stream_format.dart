...
class GetPipelineStreamFormat {
  ...
  /// Creates a new [GetPipelineStreamFormat].
  ...
  factory GetPipelineStreamFormat.fromMap(Map<String, dynamic> map) {
    return GetPipelineStreamFormat(
