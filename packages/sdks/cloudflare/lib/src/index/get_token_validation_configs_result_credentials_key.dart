...
class GetTokenValidationConfigsResultCredentialsKey {
  /// Algorithm
  ...
  /// Creates a new [GetTokenValidationConfigsResultCredentialsKey].
  /// [alg] Algorithm
  /// [crv] Curve
  /// [e] RSA exponent
  /// [kid] Key ID
  ...
  /// [x] X EC coordinate
  /// [y] Y EC coordinate
  const GetTokenValidationConfigsResultCredentialsKey({
    required this.alg,
    required this.crv,
    required this.e,
    required this.kid,
  ...
  factory GetTokenValidationConfigsResultCredentialsKey.fromMap(Map<String, dynamic> map) {
    return GetTokenValidationConfigsResultCredentialsKey(
