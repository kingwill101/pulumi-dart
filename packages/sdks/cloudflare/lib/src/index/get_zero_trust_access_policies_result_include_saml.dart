...
class GetZeroTrustAccessPoliciesResultIncludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessPoliciesResultIncludeSaml].
  ...
  const GetZeroTrustAccessPoliciesResultIncludeSaml({
  ...
  factory GetZeroTrustAccessPoliciesResultIncludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultIncludeSaml(
