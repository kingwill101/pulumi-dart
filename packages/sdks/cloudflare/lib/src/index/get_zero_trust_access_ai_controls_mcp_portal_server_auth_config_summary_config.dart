...
class GetZeroTrustAccessAiControlsMcpPortalServerAuthConfigSummaryConfig {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpPortalServerAuthConfigSummaryConfig].
  /// [authorizationEndpoint] Required.
  /// [issuer] Required.
  /// [resource] Required.
  /// [revocationEndpoint] Required.
  /// [tokenEndpoint] Required.
  const GetZeroTrustAccessAiControlsMcpPortalServerAuthConfigSummaryConfig({
  ...
  factory GetZeroTrustAccessAiControlsMcpPortalServerAuthConfigSummaryConfig.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpPortalServerAuthConfigSummaryConfig(
