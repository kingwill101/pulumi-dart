...
class GetZeroTrustAccessPoliciesResultExcludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessPoliciesResultExcludeOidc].
  ...
  const GetZeroTrustAccessPoliciesResultExcludeOidc({
  ...
  factory GetZeroTrustAccessPoliciesResultExcludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultExcludeOidc(
