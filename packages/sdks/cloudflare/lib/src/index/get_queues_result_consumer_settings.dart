...
class GetQueuesResultConsumerSettings {
  ...
  /// Creates a new [GetQueuesResultConsumerSettings].
  ...
  const GetQueuesResultConsumerSettings({
  ...
  factory GetQueuesResultConsumerSettings.fromMap(Map<String, dynamic> map) {
    return GetQueuesResultConsumerSettings(
