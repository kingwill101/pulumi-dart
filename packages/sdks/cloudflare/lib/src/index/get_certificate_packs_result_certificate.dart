...
import 'get_certificate_packs_result_certificate_geo_restrictions.dart';

class GetCertificatePacksResultCertificate {
  ...
  final pulumi.Input<GetCertificatePacksResultCertificateGeoRestrictions> geoRestrictions;
  ...
  /// Creates a new [GetCertificatePacksResultCertificate].
  ...
  /// [zoneId] Identifier.
  const GetCertificatePacksResultCertificate({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'expiresOn': expiresOn,
      'geoRestrictions': pulumi.Input.mapInputValue<GetCertificatePacksResultCertificateGeoRestrictions, Map<String, dynamic>>(geoRestrictions, (value) => value.toMap()),
      'hosts': hosts,
      'id': id,
      'issuer': issuer,
  ...
  factory GetCertificatePacksResultCertificate.fromMap(Map<String, dynamic> map) {
    return GetCertificatePacksResultCertificate(
      bundleMethod: pulumi.Input.fromValue(map['bundleMethod'] as String),
      expiresOn: pulumi.Input.fromValue(map['expiresOn'] as String),
      geoRestrictions: pulumi.Input.fromValue(GetCertificatePacksResultCertificateGeoRestrictions.fromMap((map['geoRestrictions']! as Map).cast<String, dynamic>())),
