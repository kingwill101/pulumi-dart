...
class GetZeroTrustDevicePostureRuleInputLocations {
  /// List of paths to check for client certificate on linux.
  final pulumi.Input<List<String>> paths;
  /// List of trust stores to check for client certificate.
  final pulumi.Input<List<String>> trustStores;

  /// Creates a new [GetZeroTrustDevicePostureRuleInputLocations].
  ...
  const GetZeroTrustDevicePostureRuleInputLocations({
    required this.paths,
  ...
  factory GetZeroTrustDevicePostureRuleInputLocations.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDevicePostureRuleInputLocations(
