...
class AccessGroupExcludeAuthContext {
  ...
  /// Creates a new [AccessGroupExcludeAuthContext].
  ...
  const AccessGroupExcludeAuthContext({
    required this.acId,
    required this.id,
  ...
  factory AccessGroupExcludeAuthContext.fromMap(Map<String, dynamic> map) {
    return AccessGroupExcludeAuthContext(
