...
class GetZeroTrustTunnelWarpConnectorConnection {
  ...
  /// Creates a new [GetZeroTrustTunnelWarpConnectorConnection].
  ...
  const GetZeroTrustTunnelWarpConnectorConnection({
  ...
  factory GetZeroTrustTunnelWarpConnectorConnection.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustTunnelWarpConnectorConnection(
