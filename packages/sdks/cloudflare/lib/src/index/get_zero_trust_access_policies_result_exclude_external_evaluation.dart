...
class GetZeroTrustAccessPoliciesResultExcludeExternalEvaluation {
  /// The API endpoint containing your business logic.
  final pulumi.Input<String> evaluateUrl;
  /// The API endpoint containing the key that Access uses to verify that the response came from your API.
  final pulumi.Input<String> keysUrl;

  /// Creates a new [GetZeroTrustAccessPoliciesResultExcludeExternalEvaluation].
  ...
  const GetZeroTrustAccessPoliciesResultExcludeExternalEvaluation({
  ...
  factory GetZeroTrustAccessPoliciesResultExcludeExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultExcludeExternalEvaluation(
