...
class GetPagesProjectLatestDeploymentSourceConfig {
  ...
  /// Creates a new [GetPagesProjectLatestDeploymentSourceConfig].
  ...
  const GetPagesProjectLatestDeploymentSourceConfig({
  ...
  factory GetPagesProjectLatestDeploymentSourceConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectLatestDeploymentSourceConfig(
