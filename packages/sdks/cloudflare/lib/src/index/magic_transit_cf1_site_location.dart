...
class MagicTransitCf1SiteLocation {
  ...
  factory MagicTransitCf1SiteLocation.fromMap(Map<String, dynamic> map) {
    return MagicTransitCf1SiteLocation(
