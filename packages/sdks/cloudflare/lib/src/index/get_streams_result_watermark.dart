...
class GetStreamsResultWatermark {
  ...
  /// Creates a new [GetStreamsResultWatermark].
  ...
  const GetStreamsResultWatermark({
  ...
  factory GetStreamsResultWatermark.fromMap(Map<String, dynamic> map) {
