...
class GetZeroTrustAccessGroupRequireSaml {
  ...
  /// Creates a new [GetZeroTrustAccessGroupRequireSaml].
  ...
  const GetZeroTrustAccessGroupRequireSaml({
  ...
  factory GetZeroTrustAccessGroupRequireSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupRequireSaml(
