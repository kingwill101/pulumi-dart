...
class GetPagesProjectCanonicalDeploymentDeploymentTriggerMetadata {
  ...
  /// Creates a new [GetPagesProjectCanonicalDeploymentDeploymentTriggerMetadata].
  ...
  const GetPagesProjectCanonicalDeploymentDeploymentTriggerMetadata({
  ...
  factory GetPagesProjectCanonicalDeploymentDeploymentTriggerMetadata.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectCanonicalDeploymentDeploymentTriggerMetadata(
