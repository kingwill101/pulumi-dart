...
class GetZeroTrustAccessAiControlsMcpPortalServerUpdatedTool {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpPortalServerUpdatedTool].
  /// [enabled] Required.
  /// [name] Required.
  ...
  const GetZeroTrustAccessAiControlsMcpPortalServerUpdatedTool({
  ...
  factory GetZeroTrustAccessAiControlsMcpPortalServerUpdatedTool.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpPortalServerUpdatedTool(
