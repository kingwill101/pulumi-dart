...
class GetWorkersScriptsResultCacheOptions {
  ...
  /// Creates a new [GetWorkersScriptsResultCacheOptions].
  ...
  const GetWorkersScriptsResultCacheOptions({
  ...
  factory GetWorkersScriptsResultCacheOptions.fromMap(Map<String, dynamic> map) {
    return GetWorkersScriptsResultCacheOptions(
