...
import 'get_worker_versions_result_exports_cache.dart';

class GetWorkerVersionsResultExports {
  ...
  final pulumi.Input<GetWorkerVersionsResultExportsCache> cache;
  ...
  /// Creates a new [GetWorkerVersionsResultExports].
  ...
  const GetWorkerVersionsResultExports({
    required this.cache,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cache': pulumi.Input.mapInputValue<GetWorkerVersionsResultExportsCache, Map<String, dynamic>>(cache, (value) => value.toMap()),
      'renamedTo': renamedTo,
      'state': state,
      'storage': storage,
  ...
  factory GetWorkerVersionsResultExports.fromMap(Map<String, dynamic> map) {
    return GetWorkerVersionsResultExports(
      cache: pulumi.Input.fromValue(GetWorkerVersionsResultExportsCache.fromMap((map['cache']! as Map).cast<String, dynamic>())),
