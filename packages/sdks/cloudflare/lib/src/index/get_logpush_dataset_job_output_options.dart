...
class GetLogpushDatasetJobOutputOptions {
  ...
  /// Creates a new [GetLogpushDatasetJobOutputOptions].
  ...
  const GetLogpushDatasetJobOutputOptions({
  ...
  factory GetLogpushDatasetJobOutputOptions.fromMap(Map<String, dynamic> map) {
    return GetLogpushDatasetJobOutputOptions(
