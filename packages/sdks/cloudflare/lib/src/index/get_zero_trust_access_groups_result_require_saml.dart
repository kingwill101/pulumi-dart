...
class GetZeroTrustAccessGroupsResultRequireSaml {
  ...
  /// Creates a new [GetZeroTrustAccessGroupsResultRequireSaml].
  ...
  const GetZeroTrustAccessGroupsResultRequireSaml({
  ...
  factory GetZeroTrustAccessGroupsResultRequireSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupsResultRequireSaml(
