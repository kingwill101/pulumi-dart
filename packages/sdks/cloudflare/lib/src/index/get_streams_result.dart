...
class GetStreamsResult {
  ...
  factory GetStreamsResult.fromMap(Map<String, dynamic> map) {
    return GetStreamsResult(
      ...
      maxDurationSeconds: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['maxDurationSeconds'])),
      maxSizeBytes: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['maxSizeBytes'])),
