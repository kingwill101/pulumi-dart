...
class TunnelVirtualNetworkState {
  ...
  /// Creates a new [TunnelVirtualNetworkState].
  ...
  const TunnelVirtualNetworkState({
    this.accountId,
    this.comment,
    this.createdAt,
    this.deletedAt,
  ...
  factory TunnelVirtualNetworkState.fromMap(Map<String, dynamic> map) {
    return TunnelVirtualNetworkState(
