...
class ZeroTrustAccessMtlsCertificateState {
  ...
  /// Creates a new [ZeroTrustAccessMtlsCertificateState].
  ...
  const ZeroTrustAccessMtlsCertificateState({
    this.accountId,
  ...
  factory ZeroTrustAccessMtlsCertificateState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessMtlsCertificateState(
