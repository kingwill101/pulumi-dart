...
class GetWaitingRoomCookieAttributes {
  ...
  /// Creates a new [GetWaitingRoomCookieAttributes].
  ...
  const GetWaitingRoomCookieAttributes({
  ...
  factory GetWaitingRoomCookieAttributes.fromMap(Map<String, dynamic> map) {
    return GetWaitingRoomCookieAttributes(
