...
class GetKeylessCertificatesResultTunnel {
  ...
  factory GetKeylessCertificatesResultTunnel.fromMap(Map<String, dynamic> map) {
    return GetKeylessCertificatesResultTunnel(
