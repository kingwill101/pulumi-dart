...
class ZeroTrustAccessGroupIncludeGsuite {
  ...
  /// Creates a new [ZeroTrustAccessGroupIncludeGsuite].
  ...
  factory ZeroTrustAccessGroupIncludeGsuite.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupIncludeGsuite(
