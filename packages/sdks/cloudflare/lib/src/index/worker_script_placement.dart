...
import 'worker_script_placement_target.dart';
...
class WorkerScriptPlacement {
  ...
  final pulumi.Input<List<WorkerScriptPlacementTarget>?>? targets;

  /// Creates a new [WorkerScriptPlacement].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'region': ?region,
      'status': ?status,
      'targets': ?pulumi.Input.mapOptionalInputValue<List<WorkerScriptPlacementTarget>, List<Map<String, dynamic>>>(targets, (value) => pulumi.Input.encodeList<WorkerScriptPlacementTarget, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory WorkerScriptPlacement.fromMap(Map<String, dynamic> map) {
    return WorkerScriptPlacement(
      ...
      targets: (() { final guardedValue = map['targets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkerScriptPlacementTarget>(guardedValue, (value) => WorkerScriptPlacementTarget.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
