...
class GetPipelineSinksResultSchemaFormat {
  ...
  /// Creates a new [GetPipelineSinksResultSchemaFormat].
  ...
  const GetPipelineSinksResultSchemaFormat({
  ...
  factory GetPipelineSinksResultSchemaFormat.fromMap(Map<String, dynamic> map) {
    return GetPipelineSinksResultSchemaFormat(
