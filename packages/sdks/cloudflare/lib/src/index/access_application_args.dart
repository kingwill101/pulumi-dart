...
/// {@template pulumi_index_access_application_access_application_args_doc}
/// The set of arguments for AccessApplication.
/// {@endtemplate}
/// {@macro pulumi_index_access_application_access_application_args_doc}
class AccessApplicationArgs {
  ...
  /// Creates a new [AccessApplicationArgs].
  ...
  factory AccessApplicationArgs.fromMap(Map<String, dynamic> map) {
    return AccessApplicationArgs(
