...
class ZeroTrustGatewayProxyEndpointState {
  ...
  /// Creates a new [ZeroTrustGatewayProxyEndpointState].
  /// [accountId] Optional.
  /// [createdAt] Optional.
  ...
  /// [updatedAt] Optional.
  const ZeroTrustGatewayProxyEndpointState({
    this.accountId,
    this.createdAt,
    this.ips,
    this.kind,
  ...
  factory ZeroTrustGatewayProxyEndpointState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewayProxyEndpointState(
