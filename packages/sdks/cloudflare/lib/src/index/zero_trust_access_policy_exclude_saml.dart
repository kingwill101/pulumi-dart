...
class ZeroTrustAccessPolicyExcludeSaml {
  ...
  /// Creates a new [ZeroTrustAccessPolicyExcludeSaml].
  ...
  factory ZeroTrustAccessPolicyExcludeSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyExcludeSaml(
