...
class GetZeroTrustAccessPoliciesResultExcludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessPoliciesResultExcludeSaml].
  ...
  const GetZeroTrustAccessPoliciesResultExcludeSaml({
  ...
  factory GetZeroTrustAccessPoliciesResultExcludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultExcludeSaml(
