...
class GetZeroTrustAccessApplicationPolicyIncludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationPolicyIncludeOidc].
  ...
  const GetZeroTrustAccessApplicationPolicyIncludeOidc({
  ...
  factory GetZeroTrustAccessApplicationPolicyIncludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationPolicyIncludeOidc(
