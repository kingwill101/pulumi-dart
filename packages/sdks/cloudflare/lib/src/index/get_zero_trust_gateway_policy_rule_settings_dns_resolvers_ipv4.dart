...
class GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4 {
  ...
  /// Creates a new [GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4].
  /// [ip] Specify the IPv4 address of the upstream resolver.
  ...
  const GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4({
    required this.ip,
    required this.port,
  ...
  factory GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4(
