...
class GetZeroTrustAccessApplicationPolicyRequireExternalEvaluation {
  /// The API endpoint containing your business logic.
  final pulumi.Input<String> evaluateUrl;
  /// The API endpoint containing the key that Access uses to verify that the response came from your API.
  final pulumi.Input<String> keysUrl;

  /// Creates a new [GetZeroTrustAccessApplicationPolicyRequireExternalEvaluation].
  ...
  const GetZeroTrustAccessApplicationPolicyRequireExternalEvaluation({
  ...
  factory GetZeroTrustAccessApplicationPolicyRequireExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationPolicyRequireExternalEvaluation(
