...
class ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess {
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess].
  ...
  factory ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess(
