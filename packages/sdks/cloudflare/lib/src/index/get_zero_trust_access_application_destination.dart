...
class GetZeroTrustAccessApplicationDestination {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationDestination].
  ...
  const GetZeroTrustAccessApplicationDestination({
    required this.cidr,
  ...
  factory GetZeroTrustAccessApplicationDestination.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationDestination(
