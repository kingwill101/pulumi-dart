...
class GetPipelineStreamSchemaField {
  ...
  /// Creates a new [GetPipelineStreamSchemaField].
  ...
  const GetPipelineStreamSchemaField({
  ...
  factory GetPipelineStreamSchemaField.fromMap(Map<String, dynamic> map) {
    return GetPipelineStreamSchemaField(
