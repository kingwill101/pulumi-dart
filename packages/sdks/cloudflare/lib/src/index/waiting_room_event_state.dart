...
class WaitingRoomEventState {
  ...
  factory WaitingRoomEventState.fromMap(Map<String, dynamic> map) {
    return WaitingRoomEventState(
      ...
      eventEndTime: (() { final guardedValue = map['eventEndTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      eventStartTime: (() { final guardedValue = map['eventStartTime']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
