...
import 'get_custom_ssl_keyless_server_tunnel.dart';

class GetCustomSslKeylessServer {
  ...
  final pulumi.Input<GetCustomSslKeylessServerTunnel> tunnel;

  /// Creates a new [GetCustomSslKeylessServer].
  ...
  const GetCustomSslKeylessServer({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': port,
      'status': status,
      'tunnel': pulumi.Input.mapInputValue<GetCustomSslKeylessServerTunnel, Map<String, dynamic>>(tunnel, (value) => value.toMap()),
    };
  }

  factory GetCustomSslKeylessServer.fromMap(Map<String, dynamic> map) {
    return GetCustomSslKeylessServer(
      ...
      tunnel: pulumi.Input.fromValue(GetCustomSslKeylessServerTunnel.fromMap((map['tunnel']! as Map).cast<String, dynamic>())),
    );
  }
}
