...
class CertificatePackValidationRecord {
  ...
  /// Creates a new [CertificatePackValidationRecord].
  ...
  const CertificatePackValidationRecord({
    this.cname,
    this.cnameTarget,
    this.emails,
    this.httpBody,
  ...
  factory CertificatePackValidationRecord.fromMap(Map<String, dynamic> map) {
    return CertificatePackValidationRecord(
