...
class GetPipelineSinkSchemaFormat {
  ...
  /// Creates a new [GetPipelineSinkSchemaFormat].
  ...
  const GetPipelineSinkSchemaFormat({
  ...
  factory GetPipelineSinkSchemaFormat.fromMap(Map<String, dynamic> map) {
    return GetPipelineSinkSchemaFormat(
