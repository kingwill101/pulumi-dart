...
class MagicTransitSiteLanStaticAddressingDhcpServerDhcpOption {
  ...
  /// Creates a new [MagicTransitSiteLanStaticAddressingDhcpServerDhcpOption].
  ...
  const MagicTransitSiteLanStaticAddressingDhcpServerDhcpOption({
    required this.code,
    required this.type,
    required this.value,
  });
  ...
  factory MagicTransitSiteLanStaticAddressingDhcpServerDhcpOption.fromMap(Map<String, dynamic> map) {
    return MagicTransitSiteLanStaticAddressingDhcpServerDhcpOption(
