...
class GetWorkersResultReferencesDomain {
  ...
  /// Creates a new [GetWorkersResultReferencesDomain].
  ...
  const GetWorkersResultReferencesDomain({
  ...
  factory GetWorkersResultReferencesDomain.fromMap(Map<String, dynamic> map) {
    return GetWorkersResultReferencesDomain(
