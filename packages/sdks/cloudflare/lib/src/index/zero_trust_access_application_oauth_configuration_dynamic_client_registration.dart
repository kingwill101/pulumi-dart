...
class ZeroTrustAccessApplicationOauthConfigurationDynamicClientRegistration {
  ...
  /// Creates a new [ZeroTrustAccessApplicationOauthConfigurationDynamicClientRegistration].
  ...
  factory ZeroTrustAccessApplicationOauthConfigurationDynamicClientRegistration.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationOauthConfigurationDynamicClientRegistration(
