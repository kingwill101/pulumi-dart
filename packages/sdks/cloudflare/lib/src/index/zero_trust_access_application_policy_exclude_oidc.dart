...
class ZeroTrustAccessApplicationPolicyExcludeOidc {
  ...
  /// Creates a new [ZeroTrustAccessApplicationPolicyExcludeOidc].
  ...
  const ZeroTrustAccessApplicationPolicyExcludeOidc({
  ...
  factory ZeroTrustAccessApplicationPolicyExcludeOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationPolicyExcludeOidc(
