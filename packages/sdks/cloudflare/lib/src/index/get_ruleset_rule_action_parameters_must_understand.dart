...
class GetRulesetRuleActionParametersMustUnderstand {
  ...
  /// Creates a new [GetRulesetRuleActionParametersMustUnderstand].
  /// [cloudflareOnly] Whether to apply the directive only to Cloudflare's cache.
  /// [operation] The operation to perform.
  const GetRulesetRuleActionParametersMustUnderstand({
  ...
  factory GetRulesetRuleActionParametersMustUnderstand.fromMap(Map<String, dynamic> map) {
    return GetRulesetRuleActionParametersMustUnderstand(
