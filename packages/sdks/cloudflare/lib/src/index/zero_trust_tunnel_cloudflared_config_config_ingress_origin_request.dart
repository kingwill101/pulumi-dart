...
import 'zero_trust_tunnel_cloudflared_config_config_ingress_origin_request_access.dart';

class ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest {
  /// For all L7 requests to this hostname, cloudflared will validate each request's Cf-Access-Jwt-Assertion request header.
  final pulumi.Input<ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess?>? access;
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'access': ?pulumi.Input.mapOptionalInputValue<ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess, Map<String, dynamic>>(access, (value) => value.toMap()),
      'caPool': ?caPool,
  ...
  factory ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequest.fromMap(Map<String, dynamic> map) {
