...
/// {@template pulumi_index_zero_trust_device_settings_zero_trust_device_settings_args_doc}
/// The set of arguments for ZeroTrustDeviceSettings.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_device_settings_zero_trust_device_settings_args_doc}
class ZeroTrustDeviceSettingsArgs {
  ...
  /// Creates a new [ZeroTrustDeviceSettingsArgs].
  /// [accountId] Required.
  ...
  const ZeroTrustDeviceSettingsArgs({
  ...
  factory ZeroTrustDeviceSettingsArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDeviceSettingsArgs(
