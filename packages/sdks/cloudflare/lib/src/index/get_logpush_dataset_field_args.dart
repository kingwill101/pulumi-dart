...
/// {@template pulumi_index_get_logpush_dataset_field_get_logpush_dataset_field_args_doc}
/// Arguments for getLogpushDatasetField.
/// {@endtemplate}
/// {@macro pulumi_index_get_logpush_dataset_field_get_logpush_dataset_field_args_doc}
class GetLogpushDatasetFieldArgs {
  ...
  /// Creates a new [GetLogpushDatasetFieldArgs].
  ...
  const GetLogpushDatasetFieldArgs({
    this.accountId,
    this.datasetId,
    this.zoneId,
  });
  ...
  factory GetLogpushDatasetFieldArgs.fromMap(Map<String, dynamic> map) {
    return GetLogpushDatasetFieldArgs(
