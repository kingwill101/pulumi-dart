...
class AccessIdentityProviderSamlCertificateSetCurrentCertificate {
  ...
  /// Creates a new [AccessIdentityProviderSamlCertificateSetCurrentCertificate].
  ...
  const AccessIdentityProviderSamlCertificateSetCurrentCertificate({
    this.isCurrent,
    this.notAfter,
  ...
  factory AccessIdentityProviderSamlCertificateSetCurrentCertificate.fromMap(Map<String, dynamic> map) {
    return AccessIdentityProviderSamlCertificateSetCurrentCertificate(
