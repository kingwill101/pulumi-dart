...
/// {@template pulumi_index_zero_trust_access_group_zero_trust_access_group_args_doc}
/// The set of arguments for ZeroTrustAccessGroup.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_access_group_zero_trust_access_group_args_doc}
class ZeroTrustAccessGroupArgs {
  ...
  /// Creates a new [ZeroTrustAccessGroupArgs].
  ...
  const ZeroTrustAccessGroupArgs({
    this.accountId,
    this.excludes,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'includes': pulumi.Input.mapInputValue<List<ZeroTrustAccessGroupInclude>, List<Map<String, dynamic>>>(includes, (value) => pulumi.Input.encodeList<ZeroTrustAccessGroupInclude, Map<String, dynamic>>(value, (value) => value.toMap())),
      'isDefault': ?isDefault,
      'name': name,
  ...
  factory ZeroTrustAccessGroupArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupArgs(
      ...
      includes: pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessGroupInclude>(map['includes']!, (value) => ZeroTrustAccessGroupInclude.fromMap((value as Map).cast<String, dynamic>()))),
