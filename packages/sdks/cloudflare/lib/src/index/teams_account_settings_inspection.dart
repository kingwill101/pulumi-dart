...
class TeamsAccountSettingsInspection {
  ...
  /// Creates a new [TeamsAccountSettingsInspection].
  ...
  const TeamsAccountSettingsInspection({
    this.mode,
  });
  ...
  factory TeamsAccountSettingsInspection.fromMap(Map<String, dynamic> map) {
    return TeamsAccountSettingsInspection(
