...
import 'get_zero_trust_access_application_saas_app_custom_attribute.dart';
import 'get_zero_trust_access_application_saas_app_custom_claim.dart';
import 'get_zero_trust_access_application_saas_app_hybrid_and_implicit_options.dart';
import 'get_zero_trust_access_application_saas_app_refresh_token_options.dart';

class GetZeroTrustAccessApplicationSaasApp {
  ...
  final pulumi.Input<List<GetZeroTrustAccessApplicationSaasAppCustomAttribute>> customAttributes;
  final pulumi.Input<List<GetZeroTrustAccessApplicationSaasAppCustomClaim>> customClaims;
  ...
  final pulumi.Input<GetZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions> hybridAndImplicitOptions;
  ...
  final pulumi.Input<GetZeroTrustAccessApplicationSaasAppRefreshTokenOptions> refreshTokenOptions;
  ...
  /// Creates a new [GetZeroTrustAccessApplicationSaasApp].
  ...
  const GetZeroTrustAccessApplicationSaasApp({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customAttributes': pulumi.Input.mapInputValue<List<GetZeroTrustAccessApplicationSaasAppCustomAttribute>, List<Map<String, dynamic>>>(customAttributes, (value) => pulumi.Input.encodeList<GetZeroTrustAccessApplicationSaasAppCustomAttribute, Map<String, dynamic>>(value, (value) => value.toMap())),
      'customClaims': pulumi.Input.mapInputValue<List<GetZeroTrustAccessApplicationSaasAppCustomClaim>, List<Map<String, dynamic>>>(customClaims, (value) => pulumi.Input.encodeList<GetZeroTrustAccessApplicationSaasAppCustomClaim, Map<String, dynamic>>(value, (value) => value.toMap())),
      'defaultRelayState': defaultRelayState,
      'grantTypes': grantTypes,
      'groupFilterRegex': groupFilterRegex,
      'hybridAndImplicitOptions': pulumi.Input.mapInputValue<GetZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions, Map<String, dynamic>>(hybridAndImplicitOptions, (value) => value.toMap()),
      'idpEntityId': idpEntityId,
      'nameIdFormat': nameIdFormat,
      'nameIdTransformJsonata': nameIdTransformJsonata,
      'publicKey': publicKey,
      'redirectUris': redirectUris,
      'refreshTokenOptions': pulumi.Input.mapInputValue<GetZeroTrustAccessApplicationSaasAppRefreshTokenOptions, Map<String, dynamic>>(refreshTokenOptions, (value) => value.toMap()),
  ...
  factory GetZeroTrustAccessApplicationSaasApp.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationSaasApp(
      ...
      customAttributes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetZeroTrustAccessApplicationSaasAppCustomAttribute>(map['customAttributes']!, (value) => GetZeroTrustAccessApplicationSaasAppCustomAttribute.fromMap((value as Map).cast<String, dynamic>()))),
      customClaims: pulumi.Input.fromValue(pulumi.Input.decodeList<GetZeroTrustAccessApplicationSaasAppCustomClaim>(map['customClaims']!, (value) => GetZeroTrustAccessApplicationSaasAppCustomClaim.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      hybridAndImplicitOptions: pulumi.Input.fromValue(GetZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions.fromMap((map['hybridAndImplicitOptions']! as Map).cast<String, dynamic>())),
      ...
      refreshTokenOptions: pulumi.Input.fromValue(GetZeroTrustAccessApplicationSaasAppRefreshTokenOptions.fromMap((map['refreshTokenOptions']! as Map).cast<String, dynamic>())),
