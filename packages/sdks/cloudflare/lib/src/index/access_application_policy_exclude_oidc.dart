...
class AccessApplicationPolicyExcludeOidc {
  ...
  /// Creates a new [AccessApplicationPolicyExcludeOidc].
  ...
  const AccessApplicationPolicyExcludeOidc({
  ...
  factory AccessApplicationPolicyExcludeOidc.fromMap(Map<String, dynamic> map) {
    return AccessApplicationPolicyExcludeOidc(
