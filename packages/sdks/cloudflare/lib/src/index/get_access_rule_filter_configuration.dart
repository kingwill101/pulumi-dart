...
class GetAccessRuleFilterConfiguration {
  ...
  /// Creates a new [GetAccessRuleFilterConfiguration].
  ...
  const GetAccessRuleFilterConfiguration({
    this.target,
    this.value,
  });
  ...
  factory GetAccessRuleFilterConfiguration.fromMap(Map<String, dynamic> map) {
    return GetAccessRuleFilterConfiguration(
