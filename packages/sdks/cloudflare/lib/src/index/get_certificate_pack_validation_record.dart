...
class GetCertificatePackValidationRecord {
  ...
  /// Creates a new [GetCertificatePackValidationRecord].
  ...
  const GetCertificatePackValidationRecord({
    required this.cname,
  ...
  factory GetCertificatePackValidationRecord.fromMap(Map<String, dynamic> map) {
    return GetCertificatePackValidationRecord(
