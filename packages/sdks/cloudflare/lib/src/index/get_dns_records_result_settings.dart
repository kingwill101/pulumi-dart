...
class GetDnsRecordsResultSettings {
  ...
  /// Creates a new [GetDnsRecordsResultSettings].
  ...
  const GetDnsRecordsResultSettings({
  ...
  factory GetDnsRecordsResultSettings.fromMap(Map<String, dynamic> map) {
    return GetDnsRecordsResultSettings(
