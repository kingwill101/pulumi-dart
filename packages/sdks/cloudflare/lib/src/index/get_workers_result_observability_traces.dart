...
class GetWorkersResultObservabilityTraces {
  ...
  /// Creates a new [GetWorkersResultObservabilityTraces].
  ...
  factory GetWorkersResultObservabilityTraces.fromMap(Map<String, dynamic> map) {
    return GetWorkersResultObservabilityTraces(
