...
class GetZeroTrustTunnelCloudflaredsResultConnection {
  ...
  /// Creates a new [GetZeroTrustTunnelCloudflaredsResultConnection].
  ...
  const GetZeroTrustTunnelCloudflaredsResultConnection({
  ...
  factory GetZeroTrustTunnelCloudflaredsResultConnection.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustTunnelCloudflaredsResultConnection(
