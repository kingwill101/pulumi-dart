...
class LoadBalancerRuleOverridesAdaptiveRouting {
  ...
  factory LoadBalancerRuleOverridesAdaptiveRouting.fromMap(Map<String, dynamic> map) {
    return LoadBalancerRuleOverridesAdaptiveRouting(
