...
class ZeroTrustGatewayPolicyRuleSettingsRedirect {
  ...
  /// Creates a new [ZeroTrustGatewayPolicyRuleSettingsRedirect].
  ...
  factory ZeroTrustGatewayPolicyRuleSettingsRedirect.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewayPolicyRuleSettingsRedirect(
