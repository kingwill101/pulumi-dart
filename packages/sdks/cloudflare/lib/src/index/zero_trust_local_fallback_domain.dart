...
import 'zero_trust_local_fallback_domain_args.dart';
import 'zero_trust_local_fallback_domain_domain.dart';
import 'zero_trust_local_fallback_domain_state.dart';
...
class ZeroTrustLocalFallbackDomain extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ZeroTrustLocalFallbackDomainDomain>> domains;
  late final pulumi.Output<String> policyId;

  /// Creates a new [ZeroTrustLocalFallbackDomain].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustLocalFallbackDomain]. {@macro pulumi_index_zero_trust_local_fallback_domain_zero_trust_local_fallback_domain_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustLocalFallbackDomain(
    String name, {
    ZeroTrustLocalFallbackDomainArgs? args,
  ...
  /// Gets an existing [ZeroTrustLocalFallbackDomain] resource's state with the given [name] and [id].
  static ZeroTrustLocalFallbackDomain get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustLocalFallbackDomainState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustLocalFallbackDomain._get(
      name,
      state: state?.toMap(),
  ...
  ZeroTrustLocalFallbackDomain._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ZeroTrustLocalFallbackDomain] resource.
  ZeroTrustLocalFallbackDomain.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustLocalFallbackDomain:ZeroTrustLocalFallbackDomain',
