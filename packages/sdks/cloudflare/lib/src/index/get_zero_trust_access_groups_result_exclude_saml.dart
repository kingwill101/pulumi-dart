...
class GetZeroTrustAccessGroupsResultExcludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessGroupsResultExcludeSaml].
  ...
  const GetZeroTrustAccessGroupsResultExcludeSaml({
  ...
  factory GetZeroTrustAccessGroupsResultExcludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupsResultExcludeSaml(
