...
class AccessApplicationPolicyRequireSaml {
  ...
  /// Creates a new [AccessApplicationPolicyRequireSaml].
  ...
  const AccessApplicationPolicyRequireSaml({
  ...
  factory AccessApplicationPolicyRequireSaml.fromMap(Map<String, dynamic> map) {
    return AccessApplicationPolicyRequireSaml(
