...
class ZeroTrustOrganizationLoginDesign {
  ...
  /// Creates a new [ZeroTrustOrganizationLoginDesign].
  ...
  factory ZeroTrustOrganizationLoginDesign.fromMap(Map<String, dynamic> map) {
    return ZeroTrustOrganizationLoginDesign(
