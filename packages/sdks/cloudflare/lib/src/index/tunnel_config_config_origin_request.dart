...
import 'tunnel_config_config_origin_request_access.dart';

class TunnelConfigConfigOriginRequest {
  /// For all L7 requests to this hostname, cloudflared will validate each request's Cf-Access-Jwt-Assertion request header.
  final pulumi.Input<TunnelConfigConfigOriginRequestAccess?>? access;
  ...
  /// Creates a new [TunnelConfigConfigOriginRequest].
  ...
  const TunnelConfigConfigOriginRequest({
    this.access,
    this.caPool,
    this.connectTimeout,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'access': ?pulumi.Input.mapOptionalInputValue<TunnelConfigConfigOriginRequestAccess, Map<String, dynamic>>(access, (value) => value.toMap()),
      'caPool': ?caPool,
  ...
  factory TunnelConfigConfigOriginRequest.fromMap(Map<String, dynamic> map) {
    return TunnelConfigConfigOriginRequest(
      access: (() { final guardedValue = map['access']; if (guardedValue == null) return null; return pulumi.Input.fromValue(TunnelConfigConfigOriginRequestAccess.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
