...
class GetPipelineSinkSchemaField {
  ...
  /// Creates a new [GetPipelineSinkSchemaField].
  ...
  const GetPipelineSinkSchemaField({
  ...
  factory GetPipelineSinkSchemaField.fromMap(Map<String, dynamic> map) {
    return GetPipelineSinkSchemaField(
