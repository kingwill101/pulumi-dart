...
import 'schema_validation_operation_settings_args.dart';
import 'schema_validation_operation_settings_state.dart';
...
class SchemaValidationOperationSettings extends pulumi.CustomResource {
  ...
  /// Creates a new [SchemaValidationOperationSettings].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [SchemaValidationOperationSettings]. {@macro pulumi_index_schema_validation_operation_settings_schema_validation_operation_settings_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  SchemaValidationOperationSettings(
    String name, {
    SchemaValidationOperationSettingsArgs? args,
  ...
  /// Gets an existing [SchemaValidationOperationSettings] resource's state with the given [name] and [id].
  static SchemaValidationOperationSettings get(
    String name,
    pulumi.Input<String> id, {
    SchemaValidationOperationSettingsState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return SchemaValidationOperationSettings._get(
      name,
      state: state?.toMap(),
  ...
  SchemaValidationOperationSettings._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [SchemaValidationOperationSettings] resource.
  SchemaValidationOperationSettings.reference(String urn)
    : super(
        'cloudflare:index/schemaValidationOperationSettings:SchemaValidationOperationSettings',
