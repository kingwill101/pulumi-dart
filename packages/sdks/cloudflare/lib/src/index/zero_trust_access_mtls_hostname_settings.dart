...
import 'zero_trust_access_mtls_hostname_settings_args.dart';
import 'zero_trust_access_mtls_hostname_settings_setting.dart';
import 'zero_trust_access_mtls_hostname_settings_state.dart';
...
class ZeroTrustAccessMtlsHostnameSettings extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ZeroTrustAccessMtlsHostnameSettingsSetting>> settings;
  /// The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
  late final pulumi.Output<String?> zoneId;

  /// Creates a new [ZeroTrustAccessMtlsHostnameSettings].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustAccessMtlsHostnameSettings]. {@macro pulumi_index_zero_trust_access_mtls_hostname_settings_zero_trust_access_mtls_hostname_settings_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustAccessMtlsHostnameSettings(
    String name, {
    ZeroTrustAccessMtlsHostnameSettingsArgs? args,
    ...
    settings = registerOutput<List<ZeroTrustAccessMtlsHostnameSettingsSetting>>('settings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ZeroTrustAccessMtlsHostnameSettingsSetting>(guardedValue, (value) => ZeroTrustAccessMtlsHostnameSettingsSetting.fromMap((value as Map).cast<String, dynamic>())); });
    zoneId = registerOutput<String?>('zoneId');
  }

  /// Gets an existing [ZeroTrustAccessMtlsHostnameSettings] resource's state with the given [name] and [id].
  static ZeroTrustAccessMtlsHostnameSettings get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustAccessMtlsHostnameSettingsState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustAccessMtlsHostnameSettings._get(
      name,
      state: state?.toMap(),
  ...
  ZeroTrustAccessMtlsHostnameSettings._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ZeroTrustAccessMtlsHostnameSettings] resource.
  ZeroTrustAccessMtlsHostnameSettings.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustAccessMtlsHostnameSettings:ZeroTrustAccessMtlsHostnameSettings',
