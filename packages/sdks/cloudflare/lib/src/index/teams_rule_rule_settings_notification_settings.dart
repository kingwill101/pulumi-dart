...
class TeamsRuleRuleSettingsNotificationSettings {
  ...
  /// Creates a new [TeamsRuleRuleSettingsNotificationSettings].
  ...
  const TeamsRuleRuleSettingsNotificationSettings({
    this.enabled,
    this.includeContext,
    this.msg,
    this.supportUrl,
  ...
  factory TeamsRuleRuleSettingsNotificationSettings.fromMap(Map<String, dynamic> map) {
    return TeamsRuleRuleSettingsNotificationSettings(
