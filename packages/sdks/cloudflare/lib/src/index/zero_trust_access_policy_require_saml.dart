...
class ZeroTrustAccessPolicyRequireSaml {
  ...
  /// Creates a new [ZeroTrustAccessPolicyRequireSaml].
  ...
  factory ZeroTrustAccessPolicyRequireSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyRequireSaml(
