...
class PipelineStreamSchemaFormat {
  ...
  /// Creates a new [PipelineStreamSchemaFormat].
  ...
  factory PipelineStreamSchemaFormat.fromMap(Map<String, dynamic> map) {
    return PipelineStreamSchemaFormat(
