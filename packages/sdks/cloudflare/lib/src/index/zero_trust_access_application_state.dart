...
class ZeroTrustAccessApplicationState {
  ...
  final pulumi.Input<ZeroTrustAccessApplicationCorsHeaders?>? corsHeaders;
  ...
  final pulumi.Input<List<ZeroTrustAccessApplicationDestination>?>? destinations;
  /// The primary hostname and path secured by Access. This domain will be displayed if the app is visible in the App Launcher.
  final pulumi.Input<String?>? domain;
  /// Enables the binding cookie, which increases security against compromised authorization tokens and CSRF attacks.
  final pulumi.Input<bool?>? enableBindingCookie;
  /// The links in the App Launcher footer.
  final pulumi.Input<List<ZeroTrustAccessApplicationFooterLink>?>? footerLinks;
  ...
  final pulumi.Input<ZeroTrustAccessApplicationLandingPageDesign?>? landingPageDesign;
  ...
  final pulumi.Input<ZeroTrustAccessApplicationMfaConfig?>? mfaConfig;
  ...
  final pulumi.Input<ZeroTrustAccessApplicationOauthConfiguration?>? oauthConfiguration;
  ...
  final pulumi.Input<List<ZeroTrustAccessApplicationPolicy>?>? policies;
  ...
  final pulumi.Input<ZeroTrustAccessApplicationSaasApp?>? saasApp;
  /// Sets the SameSite cookie setting, which provides increased security against CSRF attacks.
  final pulumi.Input<String?>? sameSiteCookieAttribute;
  /// Configuration for provisioning to this application via SCIM. This is currently in closed beta.
  final pulumi.Input<ZeroTrustAccessApplicationScimConfig?>? scimConfig;
  ...
  final pulumi.Input<List<ZeroTrustAccessApplicationTargetCriteria>?>? targetCriterias;
  ...
  /// Creates a new [ZeroTrustAccessApplicationState].
  ...
  const ZeroTrustAccessApplicationState({
    this.accountId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'bgColor': ?bgColor,
      'corsHeaders': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationCorsHeaders, Map<String, dynamic>>(corsHeaders, (value) => value.toMap()),
      'customDenyMessage': ?customDenyMessage,
      'customDenyUrl': ?customDenyUrl,
      'customNonIdentityDenyUrl': ?customNonIdentityDenyUrl,
      'customPages': ?customPages,
      'destinations': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustAccessApplicationDestination>, List<Map<String, dynamic>>>(destinations, (value) => pulumi.Input.encodeList<ZeroTrustAccessApplicationDestination, Map<String, dynamic>>(value, (value) => value.toMap())),
      'domain': ?domain,
      'enableBindingCookie': ?enableBindingCookie,
      'footerLinks': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustAccessApplicationFooterLink>, List<Map<String, dynamic>>>(footerLinks, (value) => pulumi.Input.encodeList<ZeroTrustAccessApplicationFooterLink, Map<String, dynamic>>(value, (value) => value.toMap())),
      'headerBgColor': ?headerBgColor,
      'httpOnlyCookieAttribute': ?httpOnlyCookieAttribute,
      'landingPageDesign': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationLandingPageDesign, Map<String, dynamic>>(landingPageDesign, (value) => value.toMap()),
      'logoUrl': ?logoUrl,
      'mfaConfig': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationMfaConfig, Map<String, dynamic>>(mfaConfig, (value) => value.toMap()),
      'name': ?name,
      'oauthConfiguration': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationOauthConfiguration, Map<String, dynamic>>(oauthConfiguration, (value) => value.toMap()),
      'optionsPreflightBypass': ?optionsPreflightBypass,
      'pathCookieAttribute': ?pathCookieAttribute,
      'policies': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustAccessApplicationPolicy>, List<Map<String, dynamic>>>(policies, (value) => pulumi.Input.encodeList<ZeroTrustAccessApplicationPolicy, Map<String, dynamic>>(value, (value) => value.toMap())),
      'readServiceTokensFromHeader': ?readServiceTokensFromHeader,
      'saasApp': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationSaasApp, Map<String, dynamic>>(saasApp, (value) => value.toMap()),
      'sameSiteCookieAttribute': ?sameSiteCookieAttribute,
      'scimConfig': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationScimConfig, Map<String, dynamic>>(scimConfig, (value) => value.toMap()),
      ...
      'tags': ?tags,
      'targetCriterias': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustAccessApplicationTargetCriteria>, List<Map<String, dynamic>>>(targetCriterias, (value) => pulumi.Input.encodeList<ZeroTrustAccessApplicationTargetCriteria, Map<String, dynamic>>(value, (value) => value.toMap())),
      'type': ?type,
      'zoneId': ?zoneId,
    };
  }

  factory ZeroTrustAccessApplicationState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationState(
      ...
      corsHeaders: (() { final guardedValue = map['corsHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationCorsHeaders.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      destinations: (() { final guardedValue = map['destinations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessApplicationDestination>(guardedValue, (value) => ZeroTrustAccessApplicationDestination.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      footerLinks: (() { final guardedValue = map['footerLinks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessApplicationFooterLink>(guardedValue, (value) => ZeroTrustAccessApplicationFooterLink.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      landingPageDesign: (() { final guardedValue = map['landingPageDesign']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationLandingPageDesign.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      mfaConfig: (() { final guardedValue = map['mfaConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationMfaConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      oauthConfiguration: (() { final guardedValue = map['oauthConfiguration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationOauthConfiguration.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      policies: (() { final guardedValue = map['policies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessApplicationPolicy>(guardedValue, (value) => ZeroTrustAccessApplicationPolicy.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      saasApp: (() { final guardedValue = map['saasApp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationSaasApp.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      scimConfig: (() { final guardedValue = map['scimConfig']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationScimConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      targetCriterias: (() { final guardedValue = map['targetCriterias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessApplicationTargetCriteria>(guardedValue, (value) => ZeroTrustAccessApplicationTargetCriteria.fromMap((value as Map).cast<String, dynamic>()))); })(),
