...
class GetWebAnalyticsSiteRule {
  ...
  /// Creates a new [GetWebAnalyticsSiteRule].
  /// [created] Required.
  ...
  factory GetWebAnalyticsSiteRule.fromMap(Map<String, dynamic> map) {
    return GetWebAnalyticsSiteRule(
