...
class GetZeroTrustDlpEntriesResultVariant {
  ...
  /// Creates a new [GetZeroTrustDlpEntriesResultVariant].
  ...
  const GetZeroTrustDlpEntriesResultVariant({
  ...
  factory GetZeroTrustDlpEntriesResultVariant.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpEntriesResultVariant(
