...
class GetSharesResultResource {
  ...
  /// Creates a new [GetSharesResultResource].
  ...
  factory GetSharesResultResource.fromMap(Map<String, dynamic> map) {
    return GetSharesResultResource(
