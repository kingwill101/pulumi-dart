...
class GetZeroTrustAccessPolicyExcludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessPolicyExcludeOidc].
  ...
  const GetZeroTrustAccessPolicyExcludeOidc({
  ...
  factory GetZeroTrustAccessPolicyExcludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPolicyExcludeOidc(
