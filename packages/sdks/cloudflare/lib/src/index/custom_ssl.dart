...
class CustomSsl extends pulumi.CustomResource {
  ...
  late final pulumi.Output<String?> customCsrId;
  /// The environment to deploy the certificate to.
  /// Available values: "staging", "production".
  late final pulumi.Output<String?> deploy;
  ...
  late final pulumi.Output<CustomSslGeoRestrictions?> geoRestrictions;
  late final pulumi.Output<List<String>> hosts;
  /// The certificate authority that issued the certificate.
  late final pulumi.Output<String> issuer;
  late final pulumi.Output<CustomSslKeylessServer> keylessServer;
  ...
  late final pulumi.Output<String> policyRestrictions;
  ...
  /// Creates a new [CustomSsl].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CustomSsl]. {@macro pulumi_index_custom_ssl_custom_ssl_args_doc}
  ...
  CustomSsl(
    ...
    customCsrId = registerOutput<String?>('customCsrId');
    deploy = registerOutput<String?>('deploy');
    expiresOn = registerOutput<String>('expiresOn');
    geoRestrictions = registerOutput<CustomSslGeoRestrictions?>('geoRestrictions', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomSslGeoRestrictions.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    keylessServer = registerOutput<CustomSslKeylessServer>('keylessServer', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return CustomSslKeylessServer.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    modifiedOn = registerOutput<String>('modifiedOn');
    policy = registerOutput<String?>('policy');
    policyRestrictions = registerOutput<String>('policyRestrictions');
  ...
  /// Gets an existing [CustomSsl] resource's state with the given [name] and [id].
  static CustomSsl get(
    String name,
    pulumi.Input<String> id, {
    CustomSslState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return CustomSsl._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [CustomSsl] resource.
  CustomSsl.reference(String urn)
    : super(
        'cloudflare:index/customSsl:CustomSsl',
