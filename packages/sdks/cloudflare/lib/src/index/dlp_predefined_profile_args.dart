...
/// {@template pulumi_index_dlp_predefined_profile_dlp_predefined_profile_args_doc}
/// The set of arguments for DlpPredefinedProfile.
/// {@endtemplate}
/// {@macro pulumi_index_dlp_predefined_profile_dlp_predefined_profile_args_doc}
class DlpPredefinedProfileArgs {
  ...
  /// Creates a new [DlpPredefinedProfileArgs].
  /// [accountId] Required.
  ...
  /// [ocrEnabled] Optional.
  /// [profileId] Required.
  const DlpPredefinedProfileArgs({
  ...
  factory DlpPredefinedProfileArgs.fromMap(Map<String, dynamic> map) {
    return DlpPredefinedProfileArgs(
