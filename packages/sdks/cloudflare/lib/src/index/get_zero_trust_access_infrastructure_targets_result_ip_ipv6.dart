...
class GetZeroTrustAccessInfrastructureTargetsResultIpIpv6 {
  /// IP address of the target
  final pulumi.Input<String> ipAddr;
  /// (optional) Private virtual network identifier for the target. If omitted, the default virtual network ID will be used.
  final pulumi.Input<String> virtualNetworkId;

  /// Creates a new [GetZeroTrustAccessInfrastructureTargetsResultIpIpv6].
  ...
  const GetZeroTrustAccessInfrastructureTargetsResultIpIpv6({
  ...
  factory GetZeroTrustAccessInfrastructureTargetsResultIpIpv6.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessInfrastructureTargetsResultIpIpv6(
