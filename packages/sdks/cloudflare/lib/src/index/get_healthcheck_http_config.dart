...
class GetHealthcheckHttpConfig {
  ...
  /// Creates a new [GetHealthcheckHttpConfig].
  ...
  const GetHealthcheckHttpConfig({
  ...
  factory GetHealthcheckHttpConfig.fromMap(Map<String, dynamic> map) {
    return GetHealthcheckHttpConfig(
