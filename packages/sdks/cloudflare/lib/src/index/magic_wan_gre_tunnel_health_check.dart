...
import 'magic_wan_gre_tunnel_health_check_target.dart';
...
class MagicWanGreTunnelHealthCheck {
  ...
  final pulumi.Input<MagicWanGreTunnelHealthCheckTarget?>? target;
  /// The type of healthcheck to run, reply or request. The default value is `reply`.
  /// Available values: "reply", "request".
  final pulumi.Input<String?>? type;

  /// Creates a new [MagicWanGreTunnelHealthCheck].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': ?enabled,
      'rate': ?rate,
      'target': ?pulumi.Input.mapOptionalInputValue<MagicWanGreTunnelHealthCheckTarget, Map<String, dynamic>>(target, (value) => value.toMap()),
      'type': ?type,
    };
  }

  factory MagicWanGreTunnelHealthCheck.fromMap(Map<String, dynamic> map) {
    return MagicWanGreTunnelHealthCheck(
      ...
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MagicWanGreTunnelHealthCheckTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
