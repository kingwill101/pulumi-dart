...
class GetPipelineStreamsResultSchemaFormat {
  ...
  /// Creates a new [GetPipelineStreamsResultSchemaFormat].
  ...
  const GetPipelineStreamsResultSchemaFormat({
  ...
  factory GetPipelineStreamsResultSchemaFormat.fromMap(Map<String, dynamic> map) {
    return GetPipelineStreamsResultSchemaFormat(
