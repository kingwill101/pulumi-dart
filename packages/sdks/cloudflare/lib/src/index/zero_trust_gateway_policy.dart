...
import 'zero_trust_gateway_policy_args.dart';
...
import 'zero_trust_gateway_policy_state.dart';
...
class ZeroTrustGatewayPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ZeroTrustGatewayPolicyExpiration> expiration;
  ...
  late final pulumi.Output<ZeroTrustGatewayPolicyRuleSettings> ruleSettings;
  /// Defines the schedule for activating DNS policies. Settable only for `dns` and `dnsResolver` rules.
  late final pulumi.Output<ZeroTrustGatewayPolicySchedule> schedule;
  ...
  /// Creates a new [ZeroTrustGatewayPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustGatewayPolicy]. {@macro pulumi_index_zero_trust_gateway_policy_zero_trust_gateway_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustGatewayPolicy(
    String name, {
    ZeroTrustGatewayPolicyArgs? args,
    ...
    expiration = registerOutput<ZeroTrustGatewayPolicyExpiration>('expiration', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustGatewayPolicyExpiration.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    ruleSettings = registerOutput<ZeroTrustGatewayPolicyRuleSettings>('ruleSettings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustGatewayPolicyRuleSettings.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    schedule = registerOutput<ZeroTrustGatewayPolicySchedule>('schedule', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustGatewayPolicySchedule.fromMap((guardedValue as Map).cast<String, dynamic>()); });
  ...
  /// Gets an existing [ZeroTrustGatewayPolicy] resource's state with the given [name] and [id].
  static ZeroTrustGatewayPolicy get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustGatewayPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustGatewayPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ZeroTrustGatewayPolicy] resource.
  ZeroTrustGatewayPolicy.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustGatewayPolicy:ZeroTrustGatewayPolicy',
