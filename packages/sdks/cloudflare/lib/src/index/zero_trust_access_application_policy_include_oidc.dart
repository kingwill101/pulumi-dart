...
class ZeroTrustAccessApplicationPolicyIncludeOidc {
  ...
  /// Creates a new [ZeroTrustAccessApplicationPolicyIncludeOidc].
  ...
  const ZeroTrustAccessApplicationPolicyIncludeOidc({
  ...
  factory ZeroTrustAccessApplicationPolicyIncludeOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationPolicyIncludeOidc(
