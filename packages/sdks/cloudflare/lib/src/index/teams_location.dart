...
class TeamsLocation extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TeamsLocationEndpoints?> endpoints;
  ...
  late final pulumi.Output<TeamsLocationMaxTtl> maxTtl;
  /// Specify the location name.
  late final pulumi.Output<String> name;
  /// Specify the list of network ranges from which requests at this location originate. The list takes effect only if it is non-empty and the IPv4 endpoint is enabled for this location.
  late final pulumi.Output<List<TeamsLocationNetwork>> networks;
  late final pulumi.Output<String> updatedAt;

  /// Creates a new [TeamsLocation].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TeamsLocation]. {@macro pulumi_index_teams_location_teams_location_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TeamsLocation(
    String name, {
    TeamsLocationArgs? args,
    ...
    endpoints = registerOutput<TeamsLocationEndpoints?>('endpoints', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TeamsLocationEndpoints.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    maxTtl = registerOutput<TeamsLocationMaxTtl>('maxTtl', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return TeamsLocationMaxTtl.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    this.name = registerOutput<String>('name');
    networks = registerOutput<List<TeamsLocationNetwork>>('networks', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<TeamsLocationNetwork>(guardedValue, (value) => TeamsLocationNetwork.fromMap((value as Map).cast<String, dynamic>())); });
    updatedAt = registerOutput<String>('updatedAt');
  }

  /// Gets an existing [TeamsLocation] resource's state with the given [name] and [id].
  static TeamsLocation get(
    String name,
    pulumi.Input<String> id, {
    TeamsLocationState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TeamsLocation._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TeamsLocation] resource.
  TeamsLocation.reference(String urn)
    : super(
        'cloudflare:index/teamsLocation:TeamsLocation',
