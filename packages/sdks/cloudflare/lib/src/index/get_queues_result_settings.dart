...
class GetQueuesResultSettings {
  ...
  /// Creates a new [GetQueuesResultSettings].
  ...
  factory GetQueuesResultSettings.fromMap(Map<String, dynamic> map) {
    return GetQueuesResultSettings(
