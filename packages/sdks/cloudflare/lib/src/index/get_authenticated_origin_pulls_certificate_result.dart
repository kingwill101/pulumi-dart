...
/// Result data returned by getAuthenticatedOriginPullsCertificate.
class GetAuthenticatedOriginPullsCertificateResult {
  ...
  /// Creates a new [GetAuthenticatedOriginPullsCertificateResult].
  ...
  /// [zoneId] Identifier.
  const GetAuthenticatedOriginPullsCertificateResult({
    this.certificate,
    this.certificateId,
    this.expiresOn,
    this.id,
  ...
  factory GetAuthenticatedOriginPullsCertificateResult.fromMap(Map<String, dynamic> map) {
