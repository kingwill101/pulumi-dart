...
class GetAiGatewaysResultGuardrailsResponse {
  ...
  /// Creates a new [GetAiGatewaysResultGuardrailsResponse].
  ...
  const GetAiGatewaysResultGuardrailsResponse({
    required this.p1,
    required this.s1,
    required this.s10,
    required this.s11,
  ...
  factory GetAiGatewaysResultGuardrailsResponse.fromMap(Map<String, dynamic> map) {
    return GetAiGatewaysResultGuardrailsResponse(
