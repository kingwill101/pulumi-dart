...
class TunnelConfigConfigOriginRequestAccess {
  ...
  /// Creates a new [TunnelConfigConfigOriginRequestAccess].
  ...
  /// [teamName] Required.
  const TunnelConfigConfigOriginRequestAccess({
  ...
  factory TunnelConfigConfigOriginRequestAccess.fromMap(Map<String, dynamic> map) {
    return TunnelConfigConfigOriginRequestAccess(
