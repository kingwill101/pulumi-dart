...
class GetZeroTrustGatewayPoliciesResultRuleSettingsDnsResolversIpv4 {
  ...
  /// Creates a new [GetZeroTrustGatewayPoliciesResultRuleSettingsDnsResolversIpv4].
  ...
  const GetZeroTrustGatewayPoliciesResultRuleSettingsDnsResolversIpv4({
    required this.ip,
    required this.port,
