...
class GetLoadBalancerRuleOverridesLocationStrategy {
  /// Determines the authoritative location when ECS is not preferred, does not exist in the request, or its GeoIP lookup is unsuccessful.
  final pulumi.Input<String> mode;
  /// Whether the EDNS Client Subnet (ECS) GeoIP should be preferred as the authoritative location.
  final pulumi.Input<String> preferEcs;

  /// Creates a new [GetLoadBalancerRuleOverridesLocationStrategy].
  ...
  const GetLoadBalancerRuleOverridesLocationStrategy({
    required this.mode,
  ...
  factory GetLoadBalancerRuleOverridesLocationStrategy.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerRuleOverridesLocationStrategy(
