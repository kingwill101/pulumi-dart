...
/// {@template pulumi_index_dlp_custom_profile_dlp_custom_profile_args_doc}
/// The set of arguments for DlpCustomProfile.
/// {@endtemplate}
/// {@macro pulumi_index_dlp_custom_profile_dlp_custom_profile_args_doc}
class DlpCustomProfileArgs {
  ...
  /// Creates a new [DlpCustomProfileArgs].
  /// [accountId] Required.
  ...
  factory DlpCustomProfileArgs.fromMap(Map<String, dynamic> map) {
