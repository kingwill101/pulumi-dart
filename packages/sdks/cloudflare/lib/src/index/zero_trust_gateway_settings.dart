...
import 'zero_trust_gateway_settings_args.dart';
import 'zero_trust_gateway_settings_settings.dart';
import 'zero_trust_gateway_settings_state.dart';
...
class ZeroTrustGatewaySettings extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ZeroTrustGatewaySettingsSettings?> settings;
  late final pulumi.Output<String> updatedAt;

  /// Creates a new [ZeroTrustGatewaySettings].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustGatewaySettings]. {@macro pulumi_index_zero_trust_gateway_settings_zero_trust_gateway_settings_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustGatewaySettings(
    String name, {
    ZeroTrustGatewaySettingsArgs? args,
    ...
    settings = registerOutput<ZeroTrustGatewaySettingsSettings?>('settings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustGatewaySettingsSettings.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    updatedAt = registerOutput<String>('updatedAt');
  }

  /// Gets an existing [ZeroTrustGatewaySettings] resource's state with the given [name] and [id].
  static ZeroTrustGatewaySettings get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustGatewaySettingsState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustGatewaySettings._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ZeroTrustGatewaySettings] resource.
  ZeroTrustGatewaySettings.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustGatewaySettings:ZeroTrustGatewaySettings',
