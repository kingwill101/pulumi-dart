...
class AccessApplicationPolicyIncludeOidc {
  ...
  /// Creates a new [AccessApplicationPolicyIncludeOidc].
  ...
  const AccessApplicationPolicyIncludeOidc({
  ...
  factory AccessApplicationPolicyIncludeOidc.fromMap(Map<String, dynamic> map) {
    return AccessApplicationPolicyIncludeOidc(
