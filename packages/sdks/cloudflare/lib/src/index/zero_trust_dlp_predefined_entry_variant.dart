...
class ZeroTrustDlpPredefinedEntryVariant {
  ...
  /// Creates a new [ZeroTrustDlpPredefinedEntryVariant].
  ...
  const ZeroTrustDlpPredefinedEntryVariant({
    this.description,
    this.topicType,
    this.type,
  });
  ...
  factory ZeroTrustDlpPredefinedEntryVariant.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDlpPredefinedEntryVariant(
