...
class GetZeroTrustAccessIdentityProviderScimConfig {
  ...
  /// Creates a new [GetZeroTrustAccessIdentityProviderScimConfig].
  ...
  const GetZeroTrustAccessIdentityProviderScimConfig({
  ...
  factory GetZeroTrustAccessIdentityProviderScimConfig.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessIdentityProviderScimConfig(
