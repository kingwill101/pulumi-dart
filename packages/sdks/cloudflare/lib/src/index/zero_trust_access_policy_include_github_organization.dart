...
class ZeroTrustAccessPolicyIncludeGithubOrganization {
  ...
  /// Creates a new [ZeroTrustAccessPolicyIncludeGithubOrganization].
  ...
  factory ZeroTrustAccessPolicyIncludeGithubOrganization.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyIncludeGithubOrganization(
