...
class RulesetRuleActionParametersPublic {
  ...
  /// Creates a new [RulesetRuleActionParametersPublic].
  /// [cloudflareOnly] Whether to apply the directive only to Cloudflare's cache.
  /// [operation] The operation to perform.
  const RulesetRuleActionParametersPublic({
    this.cloudflareOnly,
  ...
  factory RulesetRuleActionParametersPublic.fromMap(Map<String, dynamic> map) {
    return RulesetRuleActionParametersPublic(
