...
class ZeroTrustDevicePostureRuleInputLocations {
  ...
  /// Creates a new [ZeroTrustDevicePostureRuleInputLocations].
  ...
  factory ZeroTrustDevicePostureRuleInputLocations.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDevicePostureRuleInputLocations(
