...
class ZeroTrustAccessGroupIncludeOkta {
  ...
  /// Creates a new [ZeroTrustAccessGroupIncludeOkta].
  ...
  factory ZeroTrustAccessGroupIncludeOkta.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupIncludeOkta(
