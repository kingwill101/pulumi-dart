...
class GetZeroTrustTunnelWarpConnectorsResultConnection {
  ...
  /// Creates a new [GetZeroTrustTunnelWarpConnectorsResultConnection].
  ...
  const GetZeroTrustTunnelWarpConnectorsResultConnection({
  ...
  factory GetZeroTrustTunnelWarpConnectorsResultConnection.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustTunnelWarpConnectorsResultConnection(
