...
class GetZeroTrustGatewayPoliciesResultRuleSettingsBisoAdminControls {
  ...
  /// Creates a new [GetZeroTrustGatewayPoliciesResultRuleSettingsBisoAdminControls].
  ...
  const GetZeroTrustGatewayPoliciesResultRuleSettingsBisoAdminControls({
    required this.copy,
    required this.dcp,
    required this.dd,
    required this.dk,
  ...
  factory GetZeroTrustGatewayPoliciesResultRuleSettingsBisoAdminControls.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustGatewayPoliciesResultRuleSettingsBisoAdminControls(
      copy: pulumi.Input.fromValue(map['copy'] as String),
      dcp: pulumi.Input.fromValue(map['dcp'] as bool),
      dd: pulumi.Input.fromValue(map['dd'] as bool),
      dk: pulumi.Input.fromValue(map['dk'] as bool),
      download: pulumi.Input.fromValue(map['download'] as String),
      dp: pulumi.Input.fromValue(map['dp'] as bool),
      du: pulumi.Input.fromValue(map['du'] as bool),
      keyboard: pulumi.Input.fromValue(map['keyboard'] as String),
      paste: pulumi.Input.fromValue(map['paste'] as String),
      printing: pulumi.Input.fromValue(map['printing'] as String),
      upload: pulumi.Input.fromValue(map['upload'] as String),
      version: pulumi.Input.fromValue(map['version'] as String),
      wmId: pulumi.Input.fromValue(map['wmId'] as String),
    );
  }
}
