...
class GetWorkersResultObservabilityLogs {
  ...
  /// Creates a new [GetWorkersResultObservabilityLogs].
  ...
  const GetWorkersResultObservabilityLogs({
  ...
  factory GetWorkersResultObservabilityLogs.fromMap(Map<String, dynamic> map) {
    return GetWorkersResultObservabilityLogs(
