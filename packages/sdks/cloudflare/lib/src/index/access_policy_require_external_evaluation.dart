...
class AccessPolicyRequireExternalEvaluation {
  ...
  /// Creates a new [AccessPolicyRequireExternalEvaluation].
  ...
  const AccessPolicyRequireExternalEvaluation({
  ...
  factory AccessPolicyRequireExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return AccessPolicyRequireExternalEvaluation(
