...
class StreamDownloadAudio {
  ...
  /// Creates a new [StreamDownloadAudio].
  ...
  factory StreamDownloadAudio.fromMap(Map<String, dynamic> map) {
    return StreamDownloadAudio(
