...
class ZeroTrustDnsLocationState {
  ...
  /// Creates a new [ZeroTrustDnsLocationState].
  /// [accountId] Optional.
  ...
  /// [updatedAt] Optional.
  const ZeroTrustDnsLocationState({
    this.accountId,
    this.clientDefault,
    this.createdAt,
  ...
  factory ZeroTrustDnsLocationState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDnsLocationState(
