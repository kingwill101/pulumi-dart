...
class WorkersScriptCacheOptions {
  ...
  /// Creates a new [WorkersScriptCacheOptions].
  ...
  const WorkersScriptCacheOptions({
  ...
  factory WorkersScriptCacheOptions.fromMap(Map<String, dynamic> map) {
    return WorkersScriptCacheOptions(
