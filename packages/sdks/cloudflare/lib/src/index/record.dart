...
class Record extends pulumi.CustomResource {
  ...
  late final pulumi.Output<RecordSettings> settings;
  ...
  /// [args] Arguments used to configure this [Record]. {@macro pulumi_index_record_record_args_doc}
  ...
  Record(
    ...
    settings = registerOutput<RecordSettings>('settings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return RecordSettings.fromMap((guardedValue as Map).cast<String, dynamic>()); });
