...
class ZoneSubscriptionRatePlan {
  ...
  /// Creates a new [ZoneSubscriptionRatePlan].
  ...
  const ZoneSubscriptionRatePlan({
    this.currency,
  ...
  factory ZoneSubscriptionRatePlan.fromMap(Map<String, dynamic> map) {
    return ZoneSubscriptionRatePlan(
