...
class GetZeroTrustAccessGroupsResultIncludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessGroupsResultIncludeSaml].
  ...
  const GetZeroTrustAccessGroupsResultIncludeSaml({
  ...
  factory GetZeroTrustAccessGroupsResultIncludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupsResultIncludeSaml(
