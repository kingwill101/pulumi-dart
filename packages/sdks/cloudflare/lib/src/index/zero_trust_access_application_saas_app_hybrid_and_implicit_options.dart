...
class ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions {
  ...
  /// Creates a new [ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions].
  ...
  factory ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions(
