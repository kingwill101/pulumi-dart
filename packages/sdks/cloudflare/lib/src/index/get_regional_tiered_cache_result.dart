...
/// Result data returned by getRegionalTieredCache.
class GetRegionalTieredCacheResult {
  ...
  factory GetRegionalTieredCacheResult.fromMap(Map<String, dynamic> map) {
