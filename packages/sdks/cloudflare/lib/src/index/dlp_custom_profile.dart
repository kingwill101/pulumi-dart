...
import 'dlp_custom_profile_args.dart';
...
import 'dlp_custom_profile_state.dart';
...
class DlpCustomProfile extends pulumi.CustomResource {
  ...
  late final pulumi.Output<DlpCustomProfileContextAwareness> contextAwareness;
  ...
  late final pulumi.Output<List<DlpCustomProfileEntry>?> entries;
  ...
  late final pulumi.Output<List<DlpCustomProfileSensitivityLevel>?> sensitivityLevels;
  /// Entries from other profiles (e.g. pre-defined Cloudflare profiles, or your Microsoft Information Protection profiles).
  late final pulumi.Output<List<DlpCustomProfileSharedEntry>?> sharedEntries;
  /// Available values: "custom", "predefined", "integration".
  late final pulumi.Output<String> type;
  /// When the profile was lasted updated.
  late final pulumi.Output<String> updatedAt;

  /// Creates a new [DlpCustomProfile].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [DlpCustomProfile]. {@macro pulumi_index_dlp_custom_profile_dlp_custom_profile_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  DlpCustomProfile(
    String name, {
    DlpCustomProfileArgs? args,
    ...
    contextAwareness = registerOutput<DlpCustomProfileContextAwareness>('contextAwareness', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return DlpCustomProfileContextAwareness.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    entries = registerOutput<List<DlpCustomProfileEntry>?>('entries', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<DlpCustomProfileEntry>(guardedValue, (value) => DlpCustomProfileEntry.fromMap((value as Map).cast<String, dynamic>())); });
    this.name = registerOutput<String>('name');
    ocrEnabled = registerOutput<bool>('ocrEnabled');
    openAccess = registerOutput<bool>('openAccess');
    sensitivityLevels = registerOutput<List<DlpCustomProfileSensitivityLevel>?>('sensitivityLevels', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<DlpCustomProfileSensitivityLevel>(guardedValue, (value) => DlpCustomProfileSensitivityLevel.fromMap((value as Map).cast<String, dynamic>())); });
    sharedEntries = registerOutput<List<DlpCustomProfileSharedEntry>?>('sharedEntries', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<DlpCustomProfileSharedEntry>(guardedValue, (value) => DlpCustomProfileSharedEntry.fromMap((value as Map).cast<String, dynamic>())); });
    type = registerOutput<String>('type');
    updatedAt = registerOutput<String>('updatedAt');
  }

  /// Gets an existing [DlpCustomProfile] resource's state with the given [name] and [id].
  static DlpCustomProfile get(
    String name,
    pulumi.Input<String> id, {
    DlpCustomProfileState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return DlpCustomProfile._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [DlpCustomProfile] resource.
  DlpCustomProfile.reference(String urn)
    : super(
        'cloudflare:index/dlpCustomProfile:DlpCustomProfile',
