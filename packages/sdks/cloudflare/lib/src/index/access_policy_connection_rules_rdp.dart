...
class AccessPolicyConnectionRulesRdp {
  ...
  /// Creates a new [AccessPolicyConnectionRulesRdp].
  ...
  const AccessPolicyConnectionRulesRdp({
  ...
  factory AccessPolicyConnectionRulesRdp.fromMap(Map<String, dynamic> map) {
    return AccessPolicyConnectionRulesRdp(
