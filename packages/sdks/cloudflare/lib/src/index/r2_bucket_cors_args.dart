...
/// {@template pulumi_index_r2_bucket_cors_r2_bucket_cors_args_doc}
/// The set of arguments for R2BucketCors.
/// {@endtemplate}
/// {@macro pulumi_index_r2_bucket_cors_r2_bucket_cors_args_doc}
class R2BucketCorsArgs {
  ...
  /// Creates a new [R2BucketCorsArgs].
  /// [accountId] Account ID.
  /// [bucketName] Name of the bucket.
  /// [jurisdiction] Jurisdiction of the bucket
  /// [rules] Optional.
  const R2BucketCorsArgs({
  ...
  factory R2BucketCorsArgs.fromMap(Map<String, dynamic> map) {
    return R2BucketCorsArgs(
