...
class AccessGroupIncludeUserRiskScore {
  ...
  factory AccessGroupIncludeUserRiskScore.fromMap(Map<String, dynamic> map) {
    return AccessGroupIncludeUserRiskScore(
