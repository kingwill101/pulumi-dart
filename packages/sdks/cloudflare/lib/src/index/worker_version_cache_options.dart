...
class WorkerVersionCacheOptions {
  ...
  /// Creates a new [WorkerVersionCacheOptions].
  ...
  const WorkerVersionCacheOptions({
  ...
  factory WorkerVersionCacheOptions.fromMap(Map<String, dynamic> map) {
    return WorkerVersionCacheOptions(
