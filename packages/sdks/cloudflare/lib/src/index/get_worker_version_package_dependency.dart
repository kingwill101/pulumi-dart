...
class GetWorkerVersionPackageDependency {
  ...
  /// Creates a new [GetWorkerVersionPackageDependency].
  ...
  const GetWorkerVersionPackageDependency({
  ...
  factory GetWorkerVersionPackageDependency.fromMap(Map<String, dynamic> map) {
    return GetWorkerVersionPackageDependency(
