...
class GetZeroTrustAccessGroupExcludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupExcludeOidc].
  ...
  const GetZeroTrustAccessGroupExcludeOidc({
  ...
  factory GetZeroTrustAccessGroupExcludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupExcludeOidc(
