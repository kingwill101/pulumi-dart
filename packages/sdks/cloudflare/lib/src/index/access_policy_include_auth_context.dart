...
class AccessPolicyIncludeAuthContext {
  ...
  /// Creates a new [AccessPolicyIncludeAuthContext].
  ...
  const AccessPolicyIncludeAuthContext({
    required this.acId,
    required this.id,
  ...
  factory AccessPolicyIncludeAuthContext.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIncludeAuthContext(
