...
class GetHyperdriveConfigsResultOrigin {
  ...
  /// Creates a new [GetHyperdriveConfigsResultOrigin].
  ...
  const GetHyperdriveConfigsResultOrigin({
  ...
  factory GetHyperdriveConfigsResultOrigin.fromMap(Map<String, dynamic> map) {
    return GetHyperdriveConfigsResultOrigin(
      accessClientId: pulumi.Input.fromValue(map['accessClientId'] as String),
      accessClientSecret: pulumi.Input.fromValue(map['accessClientSecret'] as String),
