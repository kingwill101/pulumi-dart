...
class GetRulesetRuleActionParametersMustRevalidate {
  ...
  /// Creates a new [GetRulesetRuleActionParametersMustRevalidate].
  /// [cloudflareOnly] Whether to apply the directive only to Cloudflare's cache.
  /// [operation] The operation to perform.
  const GetRulesetRuleActionParametersMustRevalidate({
  ...
  factory GetRulesetRuleActionParametersMustRevalidate.fromMap(Map<String, dynamic> map) {
    return GetRulesetRuleActionParametersMustRevalidate(
