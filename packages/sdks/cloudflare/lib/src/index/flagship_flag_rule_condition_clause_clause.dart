...
import 'flagship_flag_rule_condition_clause_clause_clause.dart';

class FlagshipFlagRuleConditionClauseClause {
  final pulumi.Input<String?>? attribute;
  final pulumi.Input<List<FlagshipFlagRuleConditionClauseClauseClause>?>? clauses;
  ...
  /// Creates a new [FlagshipFlagRuleConditionClauseClause].
  /// [attribute] Optional.
  /// [clauses] Optional.
  ...
  const FlagshipFlagRuleConditionClauseClause({
    this.attribute,
    this.clauses,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'attribute': ?attribute,
      'clauses': ?pulumi.Input.mapOptionalInputValue<List<FlagshipFlagRuleConditionClauseClauseClause>, List<Map<String, dynamic>>>(clauses, (value) => pulumi.Input.encodeList<FlagshipFlagRuleConditionClauseClauseClause, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory FlagshipFlagRuleConditionClauseClause.fromMap(Map<String, dynamic> map) {
    return FlagshipFlagRuleConditionClauseClause(
      ...
      clauses: (() { final guardedValue = map['clauses']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<FlagshipFlagRuleConditionClauseClauseClause>(guardedValue, (value) => FlagshipFlagRuleConditionClauseClauseClause.fromMap((value as Map).cast<String, dynamic>()))); })(),
