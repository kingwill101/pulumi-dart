...
class AccessApplicationCorsHeaders {
  ...
  /// Creates a new [AccessApplicationCorsHeaders].
  ...
  const AccessApplicationCorsHeaders({
  ...
  factory AccessApplicationCorsHeaders.fromMap(Map<String, dynamic> map) {
    return AccessApplicationCorsHeaders(
