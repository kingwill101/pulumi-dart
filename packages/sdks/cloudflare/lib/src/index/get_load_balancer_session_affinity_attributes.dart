...
class GetLoadBalancerSessionAffinityAttributes {
  ...
  /// Creates a new [GetLoadBalancerSessionAffinityAttributes].
  ...
  const GetLoadBalancerSessionAffinityAttributes({
  ...
  factory GetLoadBalancerSessionAffinityAttributes.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerSessionAffinityAttributes(
