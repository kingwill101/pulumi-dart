...
/// {@template pulumi_index_teams_location_teams_location_args_doc}
/// The set of arguments for TeamsLocation.
/// {@endtemplate}
/// {@macro pulumi_index_teams_location_teams_location_args_doc}
class TeamsLocationArgs {
  ...
  /// Creates a new [TeamsLocationArgs].
  /// [accountId] Required.
  ...
  factory TeamsLocationArgs.fromMap(Map<String, dynamic> map) {
    return TeamsLocationArgs(
