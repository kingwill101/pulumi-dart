...
class GetMagicTransitSiteAclLan2 {
  ...
  /// Creates a new [GetMagicTransitSiteAclLan2].
  ...
  const GetMagicTransitSiteAclLan2({
    required this.lanId,
  ...
  factory GetMagicTransitSiteAclLan2.fromMap(Map<String, dynamic> map) {
    return GetMagicTransitSiteAclLan2(
