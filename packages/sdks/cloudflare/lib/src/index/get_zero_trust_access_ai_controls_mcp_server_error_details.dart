...
class GetZeroTrustAccessAiControlsMcpServerErrorDetails {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpServerErrorDetails].
  ...
  const GetZeroTrustAccessAiControlsMcpServerErrorDetails({
    required this.cause,
  ...
  factory GetZeroTrustAccessAiControlsMcpServerErrorDetails.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpServerErrorDetails(
