...
class ZeroTrustAccessPolicyIncludeSaml {
  ...
  /// Creates a new [ZeroTrustAccessPolicyIncludeSaml].
  ...
  factory ZeroTrustAccessPolicyIncludeSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyIncludeSaml(
