...
class GetPagesProjectsResultSourceConfig {
  ...
  /// Creates a new [GetPagesProjectsResultSourceConfig].
  ...
  const GetPagesProjectsResultSourceConfig({
  ...
  factory GetPagesProjectsResultSourceConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultSourceConfig(
