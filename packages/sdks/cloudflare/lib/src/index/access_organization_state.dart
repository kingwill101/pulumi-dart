...
class AccessOrganizationState {
  ...
  /// Creates a new [AccessOrganizationState].
  ...
  factory AccessOrganizationState.fromMap(Map<String, dynamic> map) {
    return AccessOrganizationState(
