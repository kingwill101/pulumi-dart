...
class ZeroTrustAccessGroupExcludeSaml {
  ...
  /// Creates a new [ZeroTrustAccessGroupExcludeSaml].
  ...
  factory ZeroTrustAccessGroupExcludeSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupExcludeSaml(
