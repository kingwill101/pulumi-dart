...
class ZeroTrustAccessGroupRequireSaml {
  ...
  /// Creates a new [ZeroTrustAccessGroupRequireSaml].
  ...
  factory ZeroTrustAccessGroupRequireSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupRequireSaml(
