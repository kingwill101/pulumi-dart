...
class AccessPolicyRequireAuthContext {
  ...
  /// Creates a new [AccessPolicyRequireAuthContext].
  ...
  const AccessPolicyRequireAuthContext({
    required this.acId,
    required this.id,
  ...
  factory AccessPolicyRequireAuthContext.fromMap(Map<String, dynamic> map) {
    return AccessPolicyRequireAuthContext(
