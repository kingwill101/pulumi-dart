...
class ZeroTrustAccessPolicyRequireAuthContext {
  ...
  /// Creates a new [ZeroTrustAccessPolicyRequireAuthContext].
  ...
  factory ZeroTrustAccessPolicyRequireAuthContext.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyRequireAuthContext(
