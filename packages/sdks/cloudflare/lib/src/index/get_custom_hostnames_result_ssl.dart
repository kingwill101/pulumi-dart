...
import 'get_custom_hostnames_result_ssl_dcv_delegation_record.dart';
import 'get_custom_hostnames_result_ssl_settings.dart';
import 'get_custom_hostnames_result_ssl_validation_error.dart';
import 'get_custom_hostnames_result_ssl_validation_record.dart';

class GetCustomHostnamesResultSsl {
  ...
  final pulumi.Input<List<GetCustomHostnamesResultSslDcvDelegationRecord>> dcvDelegationRecords;
  ...
  final pulumi.Input<GetCustomHostnamesResultSslSettings> settings;
  ...
  final pulumi.Input<List<GetCustomHostnamesResultSslValidationError>> validationErrors;
  final pulumi.Input<List<GetCustomHostnamesResultSslValidationRecord>> validationRecords;
  /// Indicates whether the certificate covers a wildcard.
  final pulumi.Input<bool> wildcard;

  /// Creates a new [GetCustomHostnamesResultSsl].
  ...
  const GetCustomHostnamesResultSsl({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customKey': customKey,
      'dcvDelegationRecords': pulumi.Input.mapInputValue<List<GetCustomHostnamesResultSslDcvDelegationRecord>, List<Map<String, dynamic>>>(dcvDelegationRecords, (value) => pulumi.Input.encodeList<GetCustomHostnamesResultSslDcvDelegationRecord, Map<String, dynamic>>(value, (value) => value.toMap())),
      'expiresOn': expiresOn,
      'hosts': hosts,
      'id': id,
      'issuer': issuer,
      ...
      'settings': pulumi.Input.mapInputValue<GetCustomHostnamesResultSslSettings, Map<String, dynamic>>(settings, (value) => value.toMap()),
      'signature': signature,
      'status': status,
      'type': type,
      'uploadedOn': uploadedOn,
      'validationErrors': pulumi.Input.mapInputValue<List<GetCustomHostnamesResultSslValidationError>, List<Map<String, dynamic>>>(validationErrors, (value) => pulumi.Input.encodeList<GetCustomHostnamesResultSslValidationError, Map<String, dynamic>>(value, (value) => value.toMap())),
      'validationRecords': pulumi.Input.mapInputValue<List<GetCustomHostnamesResultSslValidationRecord>, List<Map<String, dynamic>>>(validationRecords, (value) => pulumi.Input.encodeList<GetCustomHostnamesResultSslValidationRecord, Map<String, dynamic>>(value, (value) => value.toMap())),
      'wildcard': wildcard,
    };
  }

  factory GetCustomHostnamesResultSsl.fromMap(Map<String, dynamic> map) {
    return GetCustomHostnamesResultSsl(
      ...
      dcvDelegationRecords: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCustomHostnamesResultSslDcvDelegationRecord>(map['dcvDelegationRecords']!, (value) => GetCustomHostnamesResultSslDcvDelegationRecord.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      settings: pulumi.Input.fromValue(GetCustomHostnamesResultSslSettings.fromMap((map['settings']! as Map).cast<String, dynamic>())),
      ...
      validationErrors: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCustomHostnamesResultSslValidationError>(map['validationErrors']!, (value) => GetCustomHostnamesResultSslValidationError.fromMap((value as Map).cast<String, dynamic>()))),
      validationRecords: pulumi.Input.fromValue(pulumi.Input.decodeList<GetCustomHostnamesResultSslValidationRecord>(map['validationRecords']!, (value) => GetCustomHostnamesResultSslValidationRecord.fromMap((value as Map).cast<String, dynamic>()))),
