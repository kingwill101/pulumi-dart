...
import 'zero_trust_dlp_predefined_entry_args.dart';
...
import 'zero_trust_dlp_predefined_entry_state.dart';
...
class ZeroTrustDlpPredefinedEntry extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ZeroTrustDlpPredefinedEntryConfidence> confidence;
  ...
  late final pulumi.Output<ZeroTrustDlpPredefinedEntryPattern> pattern;
  ...
  late final pulumi.Output<List<ZeroTrustDlpPredefinedEntryProfile>> profiles;
  ...
  late final pulumi.Output<ZeroTrustDlpPredefinedEntryVariant> variant;
  late final pulumi.Output<String> wordList;

  /// Creates a new [ZeroTrustDlpPredefinedEntry].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustDlpPredefinedEntry]. {@macro pulumi_index_zero_trust_dlp_predefined_entry_zero_trust_dlp_predefined_entry_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustDlpPredefinedEntry(
    String name, {
    ZeroTrustDlpPredefinedEntryArgs? args,
    ...
    confidence = registerOutput<ZeroTrustDlpPredefinedEntryConfidence>('confidence', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustDlpPredefinedEntryConfidence.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    pattern = registerOutput<ZeroTrustDlpPredefinedEntryPattern>('pattern', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustDlpPredefinedEntryPattern.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    profileId = registerOutput<String>('profileId');
    profiles = registerOutput<List<ZeroTrustDlpPredefinedEntryProfile>>('profiles', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ZeroTrustDlpPredefinedEntryProfile>(guardedValue, (value) => ZeroTrustDlpPredefinedEntryProfile.fromMap((value as Map).cast<String, dynamic>())); });
    secret = registerOutput<bool>('secret');
    type = registerOutput<String>('type');
    updatedAt = registerOutput<String>('updatedAt');
    uploadStatus = registerOutput<String>('uploadStatus');
    variant = registerOutput<ZeroTrustDlpPredefinedEntryVariant>('variant', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustDlpPredefinedEntryVariant.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    wordList = registerOutput<String>('wordList');
  }

  /// Gets an existing [ZeroTrustDlpPredefinedEntry] resource's state with the given [name] and [id].
  static ZeroTrustDlpPredefinedEntry get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustDlpPredefinedEntryState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustDlpPredefinedEntry._get(
      name,
      state: state?.toMap(),
  ...
  ZeroTrustDlpPredefinedEntry._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ZeroTrustDlpPredefinedEntry] resource.
  ZeroTrustDlpPredefinedEntry.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustDlpPredefinedEntry:ZeroTrustDlpPredefinedEntry',
