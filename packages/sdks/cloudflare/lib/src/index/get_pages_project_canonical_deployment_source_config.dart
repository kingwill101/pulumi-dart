...
class GetPagesProjectCanonicalDeploymentSourceConfig {
  ...
  /// Creates a new [GetPagesProjectCanonicalDeploymentSourceConfig].
  ...
  const GetPagesProjectCanonicalDeploymentSourceConfig({
  ...
  factory GetPagesProjectCanonicalDeploymentSourceConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectCanonicalDeploymentSourceConfig(
