...
class GetZeroTrustGatewayPolicyRuleSettingsBisoAdminControls {
  ...
  /// Creates a new [GetZeroTrustGatewayPolicyRuleSettingsBisoAdminControls].
  ...
  const GetZeroTrustGatewayPolicyRuleSettingsBisoAdminControls({
    required this.copy,
    required this.dcp,
    required this.dd,
    required this.dk,
  ...
  factory GetZeroTrustGatewayPolicyRuleSettingsBisoAdminControls.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustGatewayPolicyRuleSettingsBisoAdminControls(
