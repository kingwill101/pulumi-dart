...
class GetPagesProjectsResultLatestDeploymentDeploymentTriggerMetadata {
  ...
  /// Creates a new [GetPagesProjectsResultLatestDeploymentDeploymentTriggerMetadata].
  ...
  const GetPagesProjectsResultLatestDeploymentDeploymentTriggerMetadata({
  ...
  factory GetPagesProjectsResultLatestDeploymentDeploymentTriggerMetadata.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultLatestDeploymentDeploymentTriggerMetadata(
