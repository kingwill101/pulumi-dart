...
class GetRulesetRuleActionParametersNoTransform {
  ...
  /// Creates a new [GetRulesetRuleActionParametersNoTransform].
  /// [cloudflareOnly] Whether to apply the directive only to Cloudflare's cache.
  /// [operation] The operation to perform.
  const GetRulesetRuleActionParametersNoTransform({
  ...
  factory GetRulesetRuleActionParametersNoTransform.fromMap(Map<String, dynamic> map) {
    return GetRulesetRuleActionParametersNoTransform(
