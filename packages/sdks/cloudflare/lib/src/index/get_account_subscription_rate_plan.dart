...
class GetAccountSubscriptionRatePlan {
  ...
  /// Creates a new [GetAccountSubscriptionRatePlan].
  ...
  const GetAccountSubscriptionRatePlan({
  ...
  factory GetAccountSubscriptionRatePlan.fromMap(Map<String, dynamic> map) {
    return GetAccountSubscriptionRatePlan(
