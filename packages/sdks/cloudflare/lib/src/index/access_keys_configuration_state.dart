...
class AccessKeysConfigurationState {
  /// Identifier.
  ...
  /// Creates a new [AccessKeysConfigurationState].
  ...
  const AccessKeysConfigurationState({
    this.accountId,
  ...
  factory AccessKeysConfigurationState.fromMap(Map<String, dynamic> map) {
    return AccessKeysConfigurationState(
