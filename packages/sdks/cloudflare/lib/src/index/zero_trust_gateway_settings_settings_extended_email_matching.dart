...
class ZeroTrustGatewaySettingsSettingsExtendedEmailMatching {
  ...
  /// Creates a new [ZeroTrustGatewaySettingsSettingsExtendedEmailMatching].
  ...
  const ZeroTrustGatewaySettingsSettingsExtendedEmailMatching({
    this.enabled,
    this.readOnly,
    this.sourceAccount,
    this.version,
  ...
  factory ZeroTrustGatewaySettingsSettingsExtendedEmailMatching.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewaySettingsSettingsExtendedEmailMatching(
