...
class AccountDnsSettingsZoneDefaultsSoa {
  ...
  /// Creates a new [AccountDnsSettingsZoneDefaultsSoa].
  ...
  factory AccountDnsSettingsZoneDefaultsSoa.fromMap(Map<String, dynamic> map) {
    return AccountDnsSettingsZoneDefaultsSoa(
