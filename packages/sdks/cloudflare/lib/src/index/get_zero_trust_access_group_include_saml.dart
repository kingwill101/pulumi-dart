...
class GetZeroTrustAccessGroupIncludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessGroupIncludeSaml].
  ...
  const GetZeroTrustAccessGroupIncludeSaml({
  ...
  factory GetZeroTrustAccessGroupIncludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupIncludeSaml(
