...
class GetZeroTrustAccessApplicationsResultCorsHeaders {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationsResultCorsHeaders].
  ...
  const GetZeroTrustAccessApplicationsResultCorsHeaders({
  ...
  factory GetZeroTrustAccessApplicationsResultCorsHeaders.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationsResultCorsHeaders(
