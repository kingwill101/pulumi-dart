...
class GetZeroTrustAccessApplicationsResultPolicyExcludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationsResultPolicyExcludeSaml].
  ...
  const GetZeroTrustAccessApplicationsResultPolicyExcludeSaml({
  ...
  factory GetZeroTrustAccessApplicationsResultPolicyExcludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationsResultPolicyExcludeSaml(
