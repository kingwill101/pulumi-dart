...
class WaitingRoomAdditionalRoute {
  ...
  /// Creates a new [WaitingRoomAdditionalRoute].
  ...
  const WaitingRoomAdditionalRoute({
    this.host,
    this.path,
  });
  ...
  factory WaitingRoomAdditionalRoute.fromMap(Map<String, dynamic> map) {
    return WaitingRoomAdditionalRoute(
