...
class GetImageVariantVariantOptions {
  ...
  /// Creates a new [GetImageVariantVariantOptions].
  ...
  const GetImageVariantVariantOptions({
    required this.fit,
  ...
  factory GetImageVariantVariantOptions.fromMap(Map<String, dynamic> map) {
    return GetImageVariantVariantOptions(
