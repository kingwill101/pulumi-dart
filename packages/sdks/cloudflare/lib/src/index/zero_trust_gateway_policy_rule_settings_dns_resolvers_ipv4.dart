...
class ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4 {
  ...
  /// Creates a new [ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4].
  ...
  factory ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv4(
