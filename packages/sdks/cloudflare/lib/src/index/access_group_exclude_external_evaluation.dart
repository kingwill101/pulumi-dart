...
class AccessGroupExcludeExternalEvaluation {
  ...
  /// Creates a new [AccessGroupExcludeExternalEvaluation].
  ...
  const AccessGroupExcludeExternalEvaluation({
  ...
  factory AccessGroupExcludeExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return AccessGroupExcludeExternalEvaluation(
