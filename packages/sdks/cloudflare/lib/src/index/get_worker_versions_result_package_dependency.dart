...
class GetWorkerVersionsResultPackageDependency {
  ...
  /// Creates a new [GetWorkerVersionsResultPackageDependency].
  ...
  const GetWorkerVersionsResultPackageDependency({
  ...
  factory GetWorkerVersionsResultPackageDependency.fromMap(Map<String, dynamic> map) {
    return GetWorkerVersionsResultPackageDependency(
