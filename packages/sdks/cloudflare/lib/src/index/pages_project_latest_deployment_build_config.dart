...
class PagesProjectLatestDeploymentBuildConfig {
  ...
  /// Creates a new [PagesProjectLatestDeploymentBuildConfig].
  ...
  const PagesProjectLatestDeploymentBuildConfig({
    this.buildCaching,
    this.buildCommand,
    this.destinationDir,
    this.rootDir,
  ...
  factory PagesProjectLatestDeploymentBuildConfig.fromMap(Map<String, dynamic> map) {
    return PagesProjectLatestDeploymentBuildConfig(
