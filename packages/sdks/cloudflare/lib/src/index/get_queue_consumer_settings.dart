...
class GetQueueConsumerSettings {
  ...
  /// Creates a new [GetQueueConsumerSettings].
  ...
  const GetQueueConsumerSettings({
  ...
  factory GetQueueConsumerSettings.fromMap(Map<String, dynamic> map) {
    return GetQueueConsumerSettings(
