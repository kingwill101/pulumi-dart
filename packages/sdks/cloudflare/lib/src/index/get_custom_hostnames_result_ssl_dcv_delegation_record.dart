...
class GetCustomHostnamesResultSslDcvDelegationRecord {
  ...
  /// Creates a new [GetCustomHostnamesResultSslDcvDelegationRecord].
  ...
  const GetCustomHostnamesResultSslDcvDelegationRecord({
    required this.cname,
  ...
  factory GetCustomHostnamesResultSslDcvDelegationRecord.fromMap(Map<String, dynamic> map) {
    return GetCustomHostnamesResultSslDcvDelegationRecord(
