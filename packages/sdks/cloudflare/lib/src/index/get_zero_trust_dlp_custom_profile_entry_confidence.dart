...
class GetZeroTrustDlpCustomProfileEntryConfidence {
  /// Indicates whether this entry has AI remote service validation.
  final pulumi.Input<bool> aiContextAvailable;
  /// Indicates whether this entry has any form of validation that is not an AI remote service.
  final pulumi.Input<bool> available;

  /// Creates a new [GetZeroTrustDlpCustomProfileEntryConfidence].
  ...
  const GetZeroTrustDlpCustomProfileEntryConfidence({
  ...
  factory GetZeroTrustDlpCustomProfileEntryConfidence.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpCustomProfileEntryConfidence(
