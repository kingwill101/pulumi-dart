...
class GetZeroTrustGatewayPolicyRuleSettingsRedirect {
  ...
  /// Creates a new [GetZeroTrustGatewayPolicyRuleSettingsRedirect].
  ...
  const GetZeroTrustGatewayPolicyRuleSettingsRedirect({
  ...
  factory GetZeroTrustGatewayPolicyRuleSettingsRedirect.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustGatewayPolicyRuleSettingsRedirect(
