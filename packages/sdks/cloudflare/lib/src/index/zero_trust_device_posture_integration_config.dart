...
class ZeroTrustDevicePostureIntegrationConfig {
  ...
  /// Creates a new [ZeroTrustDevicePostureIntegrationConfig].
  ...
  factory ZeroTrustDevicePostureIntegrationConfig.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDevicePostureIntegrationConfig(
