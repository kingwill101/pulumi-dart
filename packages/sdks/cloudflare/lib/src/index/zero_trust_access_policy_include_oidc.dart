...
class ZeroTrustAccessPolicyIncludeOidc {
  ...
  /// Creates a new [ZeroTrustAccessPolicyIncludeOidc].
  ...
  factory ZeroTrustAccessPolicyIncludeOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyIncludeOidc(
