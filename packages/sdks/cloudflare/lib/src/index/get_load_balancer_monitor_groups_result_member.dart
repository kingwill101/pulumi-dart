...
class GetLoadBalancerMonitorGroupsResultMember {
  ...
  /// Creates a new [GetLoadBalancerMonitorGroupsResultMember].
  ...
  const GetLoadBalancerMonitorGroupsResultMember({
  ...
  factory GetLoadBalancerMonitorGroupsResultMember.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerMonitorGroupsResultMember(
