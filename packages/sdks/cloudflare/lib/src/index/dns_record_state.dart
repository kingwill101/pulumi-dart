...
class DnsRecordState {
  ...
  final pulumi.Input<DnsRecordData?>? data;
  ...
  final pulumi.Input<DnsRecordSettings?>? settings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'content': ?content,
      'createdOn': ?createdOn,
      'data': ?pulumi.Input.mapOptionalInputValue<DnsRecordData, Map<String, dynamic>>(data, (value) => value.toMap()),
      'meta': ?meta,
      ...
      'proxiable': ?proxiable,
      'proxied': ?proxied,
      'settings': ?pulumi.Input.mapOptionalInputValue<DnsRecordSettings, Map<String, dynamic>>(settings, (value) => value.toMap()),
      'tags': ?tags,
  ...
  factory DnsRecordState.fromMap(Map<String, dynamic> map) {
    return DnsRecordState(
      ...
      data: (() { final guardedValue = map['data']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsRecordData.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DnsRecordSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
