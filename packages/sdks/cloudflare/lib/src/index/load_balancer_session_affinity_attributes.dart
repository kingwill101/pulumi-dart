...
class LoadBalancerSessionAffinityAttributes {
  ...
  /// Creates a new [LoadBalancerSessionAffinityAttributes].
  ...
  factory LoadBalancerSessionAffinityAttributes.fromMap(Map<String, dynamic> map) {
    return LoadBalancerSessionAffinityAttributes(
