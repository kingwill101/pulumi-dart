...
/// {@template pulumi_index_zero_trust_device_default_profile_zero_trust_device_default_profile_args_doc}
/// The set of arguments for ZeroTrustDeviceDefaultProfile.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_device_default_profile_zero_trust_device_default_profile_args_doc}
class ZeroTrustDeviceDefaultProfileArgs {
  ...
  /// Creates a new [ZeroTrustDeviceDefaultProfileArgs].
  /// [accountId] Required.
  ...
  const ZeroTrustDeviceDefaultProfileArgs({
  ...
  factory ZeroTrustDeviceDefaultProfileArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDeviceDefaultProfileArgs(
