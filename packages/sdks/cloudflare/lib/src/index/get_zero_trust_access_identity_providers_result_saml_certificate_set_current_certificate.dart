...
class GetZeroTrustAccessIdentityProvidersResultSamlCertificateSetCurrentCertificate {
  ...
  /// Creates a new [GetZeroTrustAccessIdentityProvidersResultSamlCertificateSetCurrentCertificate].
  ...
  const GetZeroTrustAccessIdentityProvidersResultSamlCertificateSetCurrentCertificate({
  ...
  factory GetZeroTrustAccessIdentityProvidersResultSamlCertificateSetCurrentCertificate.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessIdentityProvidersResultSamlCertificateSetCurrentCertificate(
