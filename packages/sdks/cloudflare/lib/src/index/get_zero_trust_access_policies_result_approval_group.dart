...
class GetZeroTrustAccessPoliciesResultApprovalGroup {
  ...
  /// Creates a new [GetZeroTrustAccessPoliciesResultApprovalGroup].
  ...
  const GetZeroTrustAccessPoliciesResultApprovalGroup({
  ...
  factory GetZeroTrustAccessPoliciesResultApprovalGroup.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultApprovalGroup(
