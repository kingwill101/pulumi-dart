...
class GetZeroTrustAccessAiControlsMcpPortalsResultServerUpdatedTool {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpPortalsResultServerUpdatedTool].
  /// [enabled] Required.
  /// [name] Required.
  ...
  const GetZeroTrustAccessAiControlsMcpPortalsResultServerUpdatedTool({
  ...
  factory GetZeroTrustAccessAiControlsMcpPortalsResultServerUpdatedTool.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpPortalsResultServerUpdatedTool(
