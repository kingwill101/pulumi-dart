...
class GetZeroTrustAccessPolicyIncludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessPolicyIncludeSaml].
  ...
  const GetZeroTrustAccessPolicyIncludeSaml({
  ...
  factory GetZeroTrustAccessPolicyIncludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPolicyIncludeSaml(
