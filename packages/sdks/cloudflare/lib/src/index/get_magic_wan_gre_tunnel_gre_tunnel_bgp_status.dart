...
class GetMagicWanGreTunnelGreTunnelBgpStatus {
  ...
  /// Creates a new [GetMagicWanGreTunnelGreTunnelBgpStatus].
  /// [bgpState] Required.
  ...
  /// [updatedAt] Required.
  const GetMagicWanGreTunnelGreTunnelBgpStatus({
  ...
  factory GetMagicWanGreTunnelGreTunnelBgpStatus.fromMap(Map<String, dynamic> map) {
