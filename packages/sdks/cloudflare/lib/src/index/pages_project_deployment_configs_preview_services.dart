...
class PagesProjectDeploymentConfigsPreviewServices {
  ...
  /// Creates a new [PagesProjectDeploymentConfigsPreviewServices].
  ...
  factory PagesProjectDeploymentConfigsPreviewServices.fromMap(Map<String, dynamic> map) {
    return PagesProjectDeploymentConfigsPreviewServices(
