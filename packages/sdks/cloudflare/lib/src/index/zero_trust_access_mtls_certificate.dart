...
import 'zero_trust_access_mtls_certificate_args.dart';
import 'zero_trust_access_mtls_certificate_state.dart';
...
class ZeroTrustAccessMtlsCertificate extends pulumi.CustomResource {
  ...
  /// Creates a new [ZeroTrustAccessMtlsCertificate].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustAccessMtlsCertificate]. {@macro pulumi_index_zero_trust_access_mtls_certificate_zero_trust_access_mtls_certificate_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustAccessMtlsCertificate(
    String name, {
    ZeroTrustAccessMtlsCertificateArgs? args,
  ...
  /// Gets an existing [ZeroTrustAccessMtlsCertificate] resource's state with the given [name] and [id].
  static ZeroTrustAccessMtlsCertificate get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustAccessMtlsCertificateState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustAccessMtlsCertificate._get(
      name,
      state: state?.toMap(),
  ...
  ZeroTrustAccessMtlsCertificate._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ZeroTrustAccessMtlsCertificate] resource.
  ZeroTrustAccessMtlsCertificate.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustAccessMtlsCertificate:ZeroTrustAccessMtlsCertificate',
