...
import 'access_service_token_args.dart';
import 'access_service_token_state.dart';
...
class AccessServiceToken extends pulumi.CustomResource {
  ...
  /// Creates a new [AccessServiceToken].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AccessServiceToken]. {@macro pulumi_index_access_service_token_access_service_token_args_doc}
  ...
  /// Gets an existing [AccessServiceToken] resource's state with the given [name] and [id].
  static AccessServiceToken get(
    String name,
    pulumi.Input<String> id, {
    AccessServiceTokenState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AccessServiceToken._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AccessServiceToken] resource.
  AccessServiceToken.reference(String urn)
    : super(
        'cloudflare:index/accessServiceToken:AccessServiceToken',
