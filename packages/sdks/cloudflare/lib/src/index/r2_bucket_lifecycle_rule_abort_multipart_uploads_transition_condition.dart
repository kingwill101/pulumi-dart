...
class R2BucketLifecycleRuleAbortMultipartUploadsTransitionCondition {
  final pulumi.Input<int> maxAge;
  /// Available values: "Age".
  final pulumi.Input<String> type;

  /// Creates a new [R2BucketLifecycleRuleAbortMultipartUploadsTransitionCondition].
  /// [maxAge] Required.
  /// [type] Available values: "Age".
  const R2BucketLifecycleRuleAbortMultipartUploadsTransitionCondition({
