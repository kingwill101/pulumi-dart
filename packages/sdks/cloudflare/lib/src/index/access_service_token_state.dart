...
class AccessServiceTokenState {
  ...
  /// Creates a new [AccessServiceTokenState].
  ...
  factory AccessServiceTokenState.fromMap(Map<String, dynamic> map) {
    return AccessServiceTokenState(
