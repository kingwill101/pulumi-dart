...
class ZeroTrustAccessGroupExcludeAuthContext {
  ...
  /// Creates a new [ZeroTrustAccessGroupExcludeAuthContext].
  ...
  factory ZeroTrustAccessGroupExcludeAuthContext.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupExcludeAuthContext(
