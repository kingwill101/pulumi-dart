...
class GetCustomHostnamesResultSslValidationRecord {
  ...
  /// Creates a new [GetCustomHostnamesResultSslValidationRecord].
  ...
  const GetCustomHostnamesResultSslValidationRecord({
    required this.cname,
  ...
  factory GetCustomHostnamesResultSslValidationRecord.fromMap(Map<String, dynamic> map) {
    return GetCustomHostnamesResultSslValidationRecord(
