...
/// {@template pulumi_index_zero_trust_access_service_token_zero_trust_access_service_token_args_doc}
/// The set of arguments for ZeroTrustAccessServiceToken.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_access_service_token_zero_trust_access_service_token_args_doc}
class ZeroTrustAccessServiceTokenArgs {
  ...
  /// Creates a new [ZeroTrustAccessServiceTokenArgs].
  ...
  const ZeroTrustAccessServiceTokenArgs({
    this.accountId,
  ...
  factory ZeroTrustAccessServiceTokenArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessServiceTokenArgs(
