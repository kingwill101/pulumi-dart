...
import 'get_worker_version_exports_cache.dart';

class GetWorkerVersionExports {
  ...
  final pulumi.Input<GetWorkerVersionExportsCache> cache;
  ...
  /// Creates a new [GetWorkerVersionExports].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cache': pulumi.Input.mapInputValue<GetWorkerVersionExportsCache, Map<String, dynamic>>(cache, (value) => value.toMap()),
      'renamedTo': renamedTo,
      'state': state,
      'storage': storage,
  ...
  factory GetWorkerVersionExports.fromMap(Map<String, dynamic> map) {
    return GetWorkerVersionExports(
      cache: pulumi.Input.fromValue(GetWorkerVersionExportsCache.fromMap((map['cache']! as Map).cast<String, dynamic>())),
