...
class GetZeroTrustAccessAiControlsMcpServersResultAuthConfigSummaryConfig {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpServersResultAuthConfigSummaryConfig].
  /// [authorizationEndpoint] Required.
  /// [issuer] Required.
  /// [resource] Required.
  /// [revocationEndpoint] Required.
  /// [tokenEndpoint] Required.
  const GetZeroTrustAccessAiControlsMcpServersResultAuthConfigSummaryConfig({
  ...
  factory GetZeroTrustAccessAiControlsMcpServersResultAuthConfigSummaryConfig.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpServersResultAuthConfigSummaryConfig(
