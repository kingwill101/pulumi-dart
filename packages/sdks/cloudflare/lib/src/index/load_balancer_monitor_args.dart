...
/// {@template pulumi_index_load_balancer_monitor_load_balancer_monitor_args_doc}
/// The set of arguments for LoadBalancerMonitor.
/// {@endtemplate}
/// {@macro pulumi_index_load_balancer_monitor_load_balancer_monitor_args_doc}
class LoadBalancerMonitorArgs {
  ...
  /// Creates a new [LoadBalancerMonitorArgs].
  ...
  factory LoadBalancerMonitorArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerMonitorArgs(
      ...
      consecutiveDown: (() { final guardedValue = map['consecutiveDown']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
      consecutiveUp: (() { final guardedValue = map['consecutiveUp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
