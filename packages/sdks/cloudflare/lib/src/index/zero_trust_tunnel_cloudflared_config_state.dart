...
class ZeroTrustTunnelCloudflaredConfigState {
  /// Identifier.
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredConfigState].
  ...
  const ZeroTrustTunnelCloudflaredConfigState({
    this.accountId,
    this.config,
    this.createdAt,
    this.source,
  ...
  factory ZeroTrustTunnelCloudflaredConfigState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelCloudflaredConfigState(
