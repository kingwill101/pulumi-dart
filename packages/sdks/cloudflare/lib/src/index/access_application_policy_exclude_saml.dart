...
class AccessApplicationPolicyExcludeSaml {
  ...
  /// Creates a new [AccessApplicationPolicyExcludeSaml].
  ...
  const AccessApplicationPolicyExcludeSaml({
  ...
  factory AccessApplicationPolicyExcludeSaml.fromMap(Map<String, dynamic> map) {
    return AccessApplicationPolicyExcludeSaml(
