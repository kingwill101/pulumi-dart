...
class GetPagesProjectsResultLatestDeploymentBuildConfig {
  ...
  /// Creates a new [GetPagesProjectsResultLatestDeploymentBuildConfig].
  ...
  const GetPagesProjectsResultLatestDeploymentBuildConfig({
  ...
  factory GetPagesProjectsResultLatestDeploymentBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultLatestDeploymentBuildConfig(
