...
class GetLoadBalancerPoolsResultLoadShedding {
  ...
  /// Creates a new [GetLoadBalancerPoolsResultLoadShedding].
  ...
  const GetLoadBalancerPoolsResultLoadShedding({
  ...
  factory GetLoadBalancerPoolsResultLoadShedding.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerPoolsResultLoadShedding(
