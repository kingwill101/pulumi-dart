...
class GetZeroTrustDlpCustomEntryVariant {
  ...
  /// Creates a new [GetZeroTrustDlpCustomEntryVariant].
  ...
  const GetZeroTrustDlpCustomEntryVariant({
  ...
  factory GetZeroTrustDlpCustomEntryVariant.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpCustomEntryVariant(
