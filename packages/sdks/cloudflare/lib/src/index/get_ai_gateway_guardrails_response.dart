...
class GetAiGatewayGuardrailsResponse {
  ...
  /// Creates a new [GetAiGatewayGuardrailsResponse].
  ...
  const GetAiGatewayGuardrailsResponse({
    required this.p1,
    required this.s1,
    required this.s10,
    required this.s11,
  ...
  factory GetAiGatewayGuardrailsResponse.fromMap(Map<String, dynamic> map) {
    return GetAiGatewayGuardrailsResponse(
