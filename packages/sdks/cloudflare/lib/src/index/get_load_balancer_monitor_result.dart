...
class GetLoadBalancerMonitorResult {
  ...
  factory GetLoadBalancerMonitorResult.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerMonitorResult(
      ...
      consecutiveDown: (() { final guardedValue = map['consecutiveDown']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
      consecutiveUp: (() { final guardedValue = map['consecutiveUp']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
