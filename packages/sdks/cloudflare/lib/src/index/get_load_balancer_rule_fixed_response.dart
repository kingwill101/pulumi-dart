...
class GetLoadBalancerRuleFixedResponse {
  ...
  /// Creates a new [GetLoadBalancerRuleFixedResponse].
  ...
  const GetLoadBalancerRuleFixedResponse({
  ...
  factory GetLoadBalancerRuleFixedResponse.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerRuleFixedResponse(
