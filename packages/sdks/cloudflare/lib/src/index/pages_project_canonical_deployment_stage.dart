...
class PagesProjectCanonicalDeploymentStage {
  ...
  /// Creates a new [PagesProjectCanonicalDeploymentStage].
  ...
  const PagesProjectCanonicalDeploymentStage({
    this.endedOn,
    this.name,
    this.startedOn,
    this.status,
  ...
  factory PagesProjectCanonicalDeploymentStage.fromMap(Map<String, dynamic> map) {
    return PagesProjectCanonicalDeploymentStage(
