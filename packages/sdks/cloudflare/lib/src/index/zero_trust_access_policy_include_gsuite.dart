...
class ZeroTrustAccessPolicyIncludeGsuite {
  ...
  /// Creates a new [ZeroTrustAccessPolicyIncludeGsuite].
  ...
  factory ZeroTrustAccessPolicyIncludeGsuite.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyIncludeGsuite(
