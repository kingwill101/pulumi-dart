...
class GetPagesProjectBuildConfig {
  ...
  /// Creates a new [GetPagesProjectBuildConfig].
  ...
  const GetPagesProjectBuildConfig({
  ...
  factory GetPagesProjectBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectBuildConfig(
