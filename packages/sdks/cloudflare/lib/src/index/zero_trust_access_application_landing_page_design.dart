...
class ZeroTrustAccessApplicationLandingPageDesign {
  ...
  /// Creates a new [ZeroTrustAccessApplicationLandingPageDesign].
  ...
  factory ZeroTrustAccessApplicationLandingPageDesign.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationLandingPageDesign(
