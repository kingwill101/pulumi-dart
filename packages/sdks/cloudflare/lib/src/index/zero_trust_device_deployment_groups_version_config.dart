...
class ZeroTrustDeviceDeploymentGroupsVersionConfig {
  ...
  /// Creates a new [ZeroTrustDeviceDeploymentGroupsVersionConfig].
  ...
  factory ZeroTrustDeviceDeploymentGroupsVersionConfig.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDeviceDeploymentGroupsVersionConfig(
