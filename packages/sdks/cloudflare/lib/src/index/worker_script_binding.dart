...
import 'worker_script_binding_outbound.dart';
import 'worker_script_binding_simple.dart';

class WorkerScriptBinding {
  ...
  /// Outbound worker.
  final pulumi.Input<WorkerScriptBindingOutbound?>? outbound;
  ...
  /// A simple rate limit.
  final pulumi.Input<WorkerScriptBindingSimple?>? simple;
  ...
  /// Creates a new [WorkerScriptBinding].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkId': ?networkId,
      'oldName': ?oldName,
      'outbound': ?pulumi.Input.mapOptionalInputValue<WorkerScriptBindingOutbound, Map<String, dynamic>>(outbound, (value) => value.toMap()),
      'part': ?part,
      'pipeline': ?pipeline,
      'queueName': ?queueName,
      ...
      'service': ?service,
      'serviceId': ?serviceId,
      'simple': ?pulumi.Input.mapOptionalInputValue<WorkerScriptBindingSimple, Map<String, dynamic>>(simple, (value) => value.toMap()),
      'storeId': ?storeId,
      'text': ?text,
      'tunnelId': ?tunnelId,
      'type': type,
  ...
  factory WorkerScriptBinding.fromMap(Map<String, dynamic> map) {
    return WorkerScriptBinding(
      ...
      outbound: (() { final guardedValue = map['outbound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkerScriptBindingOutbound.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      simple: (() { final guardedValue = map['simple']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkerScriptBindingSimple.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
