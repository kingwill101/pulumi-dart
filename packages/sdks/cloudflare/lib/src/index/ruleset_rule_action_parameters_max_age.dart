...
class RulesetRuleActionParametersMaxAge {
  ...
  /// Creates a new [RulesetRuleActionParametersMaxAge].
  ...
  const RulesetRuleActionParametersMaxAge({
    this.cloudflareOnly,
  ...
  factory RulesetRuleActionParametersMaxAge.fromMap(Map<String, dynamic> map) {
    return RulesetRuleActionParametersMaxAge(
