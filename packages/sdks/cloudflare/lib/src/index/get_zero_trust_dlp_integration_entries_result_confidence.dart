...
class GetZeroTrustDlpIntegrationEntriesResultConfidence {
  /// Indicates whether this entry has AI remote service validation.
  final pulumi.Input<bool> aiContextAvailable;
  /// Indicates whether this entry has any form of validation that is not an AI remote service.
  final pulumi.Input<bool> available;

  /// Creates a new [GetZeroTrustDlpIntegrationEntriesResultConfidence].
  ...
  const GetZeroTrustDlpIntegrationEntriesResultConfidence({
  ...
  factory GetZeroTrustDlpIntegrationEntriesResultConfidence.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpIntegrationEntriesResultConfidence(
