...
class GetFlagshipFlagsResultRuleConditionClauseClauseClauseClauseClause {
  ...
  /// Creates a new [GetFlagshipFlagsResultRuleConditionClauseClauseClauseClauseClause].
  /// [attribute] Required.
  /// [clauses] Required.
  ...
  const GetFlagshipFlagsResultRuleConditionClauseClauseClauseClauseClause({
  ...
  factory GetFlagshipFlagsResultRuleConditionClauseClauseClauseClauseClause.fromMap(Map<String, dynamic> map) {
    return GetFlagshipFlagsResultRuleConditionClauseClauseClauseClauseClause(
