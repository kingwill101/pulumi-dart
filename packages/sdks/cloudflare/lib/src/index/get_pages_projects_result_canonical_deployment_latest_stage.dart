...
class GetPagesProjectsResultCanonicalDeploymentLatestStage {
  ...
  /// Creates a new [GetPagesProjectsResultCanonicalDeploymentLatestStage].
  ...
  const GetPagesProjectsResultCanonicalDeploymentLatestStage({
  ...
  factory GetPagesProjectsResultCanonicalDeploymentLatestStage.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultCanonicalDeploymentLatestStage(
