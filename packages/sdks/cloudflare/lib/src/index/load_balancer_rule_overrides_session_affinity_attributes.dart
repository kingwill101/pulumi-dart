...
class LoadBalancerRuleOverridesSessionAffinityAttributes {
  ...
  /// Creates a new [LoadBalancerRuleOverridesSessionAffinityAttributes].
  ...
  const LoadBalancerRuleOverridesSessionAffinityAttributes({
    this.drainDuration,
    this.headers,
  ...
  factory LoadBalancerRuleOverridesSessionAffinityAttributes.fromMap(Map<String, dynamic> map) {
    return LoadBalancerRuleOverridesSessionAffinityAttributes(
      drainDuration: (() { final guardedValue = map['drainDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      requireAllHeaders: (() { final guardedValue = map['requireAllHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      zeroDowntimeFailover: (() { final guardedValue = map['zeroDowntimeFailover']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
