...
class ZeroTrustAccessApplicationPolicyExcludeSaml {
  ...
  /// Creates a new [ZeroTrustAccessApplicationPolicyExcludeSaml].
  ...
  const ZeroTrustAccessApplicationPolicyExcludeSaml({
  ...
  factory ZeroTrustAccessApplicationPolicyExcludeSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationPolicyExcludeSaml(
