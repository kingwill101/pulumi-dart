...
class GetAiSearchInstanceSourceParams {
  ...
  /// [webCrawler] Required.
  const GetAiSearchInstanceSourceParams({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'webCrawler': pulumi.Input.mapInputValue<GetAiSearchInstanceSourceParamsWebCrawler, Map<String, dynamic>>(webCrawler, (value) => value.toMap()),
    };
  }

  factory GetAiSearchInstanceSourceParams.fromMap(Map<String, dynamic> map) {
    return GetAiSearchInstanceSourceParams(
      ...
      webCrawler: pulumi.Input.fromValue(GetAiSearchInstanceSourceParamsWebCrawler.fromMap((map['webCrawler']! as Map).cast<String, dynamic>())),
    );
  }
}
