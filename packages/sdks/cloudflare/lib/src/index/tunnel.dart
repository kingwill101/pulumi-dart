...
class Tunnel extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<TunnelConnection>> connections;
  ...
  /// [args] Arguments used to configure this [Tunnel]. {@macro pulumi_index_tunnel_tunnel_args_doc}
  ...
  Tunnel(
    ...
    connections = registerOutput<List<TunnelConnection>>('connections', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<TunnelConnection>(guardedValue, (value) => TunnelConnection.fromMap((value as Map).cast<String, dynamic>())); });
  ...
  /// Creates a typed reference to an existing [Tunnel] resource.
  Tunnel.reference(String urn)
    : super(
        'cloudflare:index/tunnel:Tunnel',
