...
class GetPipelineStreamSchemaFormat {
  ...
  /// Creates a new [GetPipelineStreamSchemaFormat].
  ...
  const GetPipelineStreamSchemaFormat({
  ...
  factory GetPipelineStreamSchemaFormat.fromMap(Map<String, dynamic> map) {
    return GetPipelineStreamSchemaFormat(
