...
class GetListItemsResultRedirect {
  ...
  /// Creates a new [GetListItemsResultRedirect].
  ...
  /// [targetUrl] Required.
  const GetListItemsResultRedirect({
  ...
  factory GetListItemsResultRedirect.fromMap(Map<String, dynamic> map) {
    return GetListItemsResultRedirect(
