...
class GetZeroTrustAccessApplicationPolicyExcludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationPolicyExcludeSaml].
  ...
  const GetZeroTrustAccessApplicationPolicyExcludeSaml({
  ...
  factory GetZeroTrustAccessApplicationPolicyExcludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationPolicyExcludeSaml(
