...
class GetPagesProjectsResultLatestDeploymentLatestStage {
  ...
  /// Creates a new [GetPagesProjectsResultLatestDeploymentLatestStage].
  ...
  const GetPagesProjectsResultLatestDeploymentLatestStage({
  ...
  factory GetPagesProjectsResultLatestDeploymentLatestStage.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultLatestDeploymentLatestStage(
