...
class ZeroTrustAccessMtlsHostnameSettingsState {
  ...
  /// Creates a new [ZeroTrustAccessMtlsHostnameSettingsState].
  ...
  const ZeroTrustAccessMtlsHostnameSettingsState({
    this.accountId,
    this.chinaNetwork,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostname': ?hostname,
      'settings': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustAccessMtlsHostnameSettingsSetting>, List<Map<String, dynamic>>>(settings, (value) => pulumi.Input.encodeList<ZeroTrustAccessMtlsHostnameSettingsSetting, Map<String, dynamic>>(value, (value) => value.toMap())),
      'zoneId': ?zoneId,
    };
  }

  factory ZeroTrustAccessMtlsHostnameSettingsState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessMtlsHostnameSettingsState(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessMtlsHostnameSettingsSetting>(guardedValue, (value) => ZeroTrustAccessMtlsHostnameSettingsSetting.fromMap((value as Map).cast<String, dynamic>()))); })(),
