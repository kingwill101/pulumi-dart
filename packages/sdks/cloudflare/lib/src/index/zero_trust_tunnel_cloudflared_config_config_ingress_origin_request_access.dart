...
class ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess {
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess].
  ...
  factory ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestAccess(
