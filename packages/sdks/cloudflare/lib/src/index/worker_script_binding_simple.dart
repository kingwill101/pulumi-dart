...
class WorkerScriptBindingSimple {
  ...
  /// Creates a new [WorkerScriptBindingSimple].
  ...
  const WorkerScriptBindingSimple({
    required this.limit,
  ...
  factory WorkerScriptBindingSimple.fromMap(Map<String, dynamic> map) {
    return WorkerScriptBindingSimple(
