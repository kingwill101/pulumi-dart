...
class ZeroTrustTunnelWarpConnectorConnection {
  ...
  /// Creates a new [ZeroTrustTunnelWarpConnectorConnection].
  ...
  const ZeroTrustTunnelWarpConnectorConnection({
    this.clientId,
    this.clientVersion,
    this.coloName,
    this.id,
  ...
  factory ZeroTrustTunnelWarpConnectorConnection.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelWarpConnectorConnection(
