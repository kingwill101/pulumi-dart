...
class AccessPolicyApprovalGroup {
  ...
  /// Creates a new [AccessPolicyApprovalGroup].
  ...
  const AccessPolicyApprovalGroup({
  ...
  factory AccessPolicyApprovalGroup.fromMap(Map<String, dynamic> map) {
    return AccessPolicyApprovalGroup(
