...
class ZeroTrustAccessPolicyExcludeAzureAd {
  ...
  /// Creates a new [ZeroTrustAccessPolicyExcludeAzureAd].
  ...
  factory ZeroTrustAccessPolicyExcludeAzureAd.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyExcludeAzureAd(
