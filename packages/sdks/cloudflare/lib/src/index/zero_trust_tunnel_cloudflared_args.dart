...
/// {@template pulumi_index_zero_trust_tunnel_cloudflared_zero_trust_tunnel_cloudflared_args_doc}
/// The set of arguments for ZeroTrustTunnelCloudflared.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_tunnel_cloudflared_zero_trust_tunnel_cloudflared_args_doc}
class ZeroTrustTunnelCloudflaredArgs {
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredArgs].
  ...
  const ZeroTrustTunnelCloudflaredArgs({
  ...
  factory ZeroTrustTunnelCloudflaredArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelCloudflaredArgs(
