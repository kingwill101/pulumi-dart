...
class ZeroTrustGatewayPolicyRuleSettingsResolveDnsInternally {
  ...
  /// Creates a new [ZeroTrustGatewayPolicyRuleSettingsResolveDnsInternally].
  ...
  factory ZeroTrustGatewayPolicyRuleSettingsResolveDnsInternally.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewayPolicyRuleSettingsResolveDnsInternally(
