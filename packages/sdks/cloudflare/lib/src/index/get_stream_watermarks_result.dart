...
class GetStreamWatermarksResult {
  ...
  /// Creates a new [GetStreamWatermarksResult].
  ...
  const GetStreamWatermarksResult({
  ...
  factory GetStreamWatermarksResult.fromMap(Map<String, dynamic> map) {
    return GetStreamWatermarksResult(
