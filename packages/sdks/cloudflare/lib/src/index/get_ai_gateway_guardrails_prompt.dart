...
class GetAiGatewayGuardrailsPrompt {
  ...
  /// Creates a new [GetAiGatewayGuardrailsPrompt].
  ...
  const GetAiGatewayGuardrailsPrompt({
    required this.p1,
    required this.s1,
    required this.s10,
    required this.s11,
  ...
  factory GetAiGatewayGuardrailsPrompt.fromMap(Map<String, dynamic> map) {
    return GetAiGatewayGuardrailsPrompt(
