...
class GetCertificatePackDcvDelegationRecord {
  ...
  /// Creates a new [GetCertificatePackDcvDelegationRecord].
  ...
  const GetCertificatePackDcvDelegationRecord({
    required this.cname,
  ...
  factory GetCertificatePackDcvDelegationRecord.fromMap(Map<String, dynamic> map) {
    return GetCertificatePackDcvDelegationRecord(
