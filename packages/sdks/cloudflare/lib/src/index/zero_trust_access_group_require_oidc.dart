...
class ZeroTrustAccessGroupRequireOidc {
  ...
  /// Creates a new [ZeroTrustAccessGroupRequireOidc].
  ...
  factory ZeroTrustAccessGroupRequireOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupRequireOidc(
