...
class GetZeroTrustAccessApplicationsResultPolicyRequireOidc {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationsResultPolicyRequireOidc].
  ...
  const GetZeroTrustAccessApplicationsResultPolicyRequireOidc({
  ...
  factory GetZeroTrustAccessApplicationsResultPolicyRequireOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationsResultPolicyRequireOidc(
