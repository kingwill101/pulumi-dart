...
class AccessGroupIncludeOidc {
  ...
  /// Creates a new [AccessGroupIncludeOidc].
  ...
  factory AccessGroupIncludeOidc.fromMap(Map<String, dynamic> map) {
    return AccessGroupIncludeOidc(
