...
class GetPagesProjectLatestDeploymentBuildConfig {
  ...
  /// Creates a new [GetPagesProjectLatestDeploymentBuildConfig].
  ...
  const GetPagesProjectLatestDeploymentBuildConfig({
  ...
  factory GetPagesProjectLatestDeploymentBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectLatestDeploymentBuildConfig(
