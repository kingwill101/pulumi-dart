...
class TeamsRuleRuleSettingsDnsResolversIpv6 {
  ...
  /// Creates a new [TeamsRuleRuleSettingsDnsResolversIpv6].
  ...
  const TeamsRuleRuleSettingsDnsResolversIpv6({
    required this.ip,
    this.port,
  ...
  factory TeamsRuleRuleSettingsDnsResolversIpv6.fromMap(Map<String, dynamic> map) {
    return TeamsRuleRuleSettingsDnsResolversIpv6(
