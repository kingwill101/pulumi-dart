...
class GetCustomHostnameSslDcvDelegationRecord {
  ...
  /// Creates a new [GetCustomHostnameSslDcvDelegationRecord].
  ...
  const GetCustomHostnameSslDcvDelegationRecord({
    required this.cname,
  ...
  factory GetCustomHostnameSslDcvDelegationRecord.fromMap(Map<String, dynamic> map) {
    return GetCustomHostnameSslDcvDelegationRecord(
