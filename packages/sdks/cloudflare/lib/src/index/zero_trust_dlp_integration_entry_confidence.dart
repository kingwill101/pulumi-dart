...
class ZeroTrustDlpIntegrationEntryConfidence {
  ...
  /// Creates a new [ZeroTrustDlpIntegrationEntryConfidence].
  ...
  const ZeroTrustDlpIntegrationEntryConfidence({
  ...
  factory ZeroTrustDlpIntegrationEntryConfidence.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDlpIntegrationEntryConfidence(
