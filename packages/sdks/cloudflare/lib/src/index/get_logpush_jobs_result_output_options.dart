...
class GetLogpushJobsResultOutputOptions {
  ...
  /// Creates a new [GetLogpushJobsResultOutputOptions].
  ...
  const GetLogpushJobsResultOutputOptions({
  ...
  factory GetLogpushJobsResultOutputOptions.fromMap(Map<String, dynamic> map) {
    return GetLogpushJobsResultOutputOptions(
