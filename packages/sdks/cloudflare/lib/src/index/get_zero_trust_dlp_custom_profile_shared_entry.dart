...
import 'get_zero_trust_dlp_custom_profile_shared_entry_confidence.dart';
import 'get_zero_trust_dlp_custom_profile_shared_entry_pattern.dart';
import 'get_zero_trust_dlp_custom_profile_shared_entry_variant.dart';

class GetZeroTrustDlpCustomProfileSharedEntry {
  ...
  final pulumi.Input<GetZeroTrustDlpCustomProfileSharedEntryPattern> pattern;
  ...
  final pulumi.Input<GetZeroTrustDlpCustomProfileSharedEntryVariant> variant;
  final pulumi.Input<String> wordList;

  /// Creates a new [GetZeroTrustDlpCustomProfileSharedEntry].
  ...
  /// [wordList] Required.
  const GetZeroTrustDlpCustomProfileSharedEntry({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'name': name,
      'pattern': pulumi.Input.mapInputValue<GetZeroTrustDlpCustomProfileSharedEntryPattern, Map<String, dynamic>>(pattern, (value) => value.toMap()),
      'profileId': profileId,
      'secret': secret,
      'type': type,
      'updatedAt': updatedAt,
      'variant': pulumi.Input.mapInputValue<GetZeroTrustDlpCustomProfileSharedEntryVariant, Map<String, dynamic>>(variant, (value) => value.toMap()),
      'wordList': wordList,
    };
  }

  factory GetZeroTrustDlpCustomProfileSharedEntry.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpCustomProfileSharedEntry(
      ...
      pattern: pulumi.Input.fromValue(GetZeroTrustDlpCustomProfileSharedEntryPattern.fromMap((map['pattern']! as Map).cast<String, dynamic>())),
      ...
      variant: pulumi.Input.fromValue(GetZeroTrustDlpCustomProfileSharedEntryVariant.fromMap((map['variant']! as Map).cast<String, dynamic>())),
