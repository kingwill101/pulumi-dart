...
import 'get_zero_trust_access_infrastructure_targets_result.dart';

/// Result data returned by getZeroTrustAccessInfrastructureTargets.
class GetZeroTrustAccessInfrastructureTargetsInvokeResult {
  /// Account identifier
  ...
  final List<GetZeroTrustAccessInfrastructureTargetsResult>? results;
  ...
  /// Creates a new [GetZeroTrustAccessInfrastructureTargetsInvokeResult].
  ...
  const GetZeroTrustAccessInfrastructureTargetsInvokeResult({
    this.accountId,
    this.createdAfter,
    this.createdBefore,
    this.direction,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'order': ?order,
      'results': ?(() { final guardedValue = results; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetZeroTrustAccessInfrastructureTargetsResult, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'targetIds': ?targetIds,
      'virtualNetworkId': ?virtualNetworkId,
    };
  }

  factory GetZeroTrustAccessInfrastructureTargetsInvokeResult.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessInfrastructureTargetsInvokeResult(
      ...
      hostnameContains: (() { final guardedValue = map['hostnameContains']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ipLike: (() { final guardedValue = map['ipLike']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      ipv4End: (() { final guardedValue = map['ipv4End']; if (guardedValue == null) return null; return guardedValue as String; })(),
      ...
      results: (() { final guardedValue = map['results']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetZeroTrustAccessInfrastructureTargetsResult>(guardedValue, (value) => GetZeroTrustAccessInfrastructureTargetsResult.fromMap((value as Map).cast<String, dynamic>())); })(),
      targetIds: (() { final guardedValue = map['targetIds']; if (guardedValue == null) return null; return (guardedValue as List).cast<String>(); })(),
