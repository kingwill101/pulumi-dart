...
import 'get_zero_trust_device_posture_rules_result_input_locations.dart';

class GetZeroTrustDevicePostureRulesResultInput {
  ...
  final pulumi.Input<GetZeroTrustDevicePostureRulesResultInputLocations> locations;
  ...
  /// Creates a new [GetZeroTrustDevicePostureRulesResultInput].
  ...
  const GetZeroTrustDevicePostureRulesResultInput({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lastSeen': lastSeen,
      'locations': pulumi.Input.mapInputValue<GetZeroTrustDevicePostureRulesResultInputLocations, Map<String, dynamic>>(locations, (value) => value.toMap()),
  ...
  factory GetZeroTrustDevicePostureRulesResultInput.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDevicePostureRulesResultInput(
      ...
      locations: pulumi.Input.fromValue(GetZeroTrustDevicePostureRulesResultInputLocations.fromMap((map['locations']! as Map).cast<String, dynamic>())),
