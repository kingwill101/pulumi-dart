...
class GetZeroTrustDeviceManagedNetworksConfig {
  ...
  /// Creates a new [GetZeroTrustDeviceManagedNetworksConfig].
  ...
  const GetZeroTrustDeviceManagedNetworksConfig({
  ...
  factory GetZeroTrustDeviceManagedNetworksConfig.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDeviceManagedNetworksConfig(
