...
class PipelineSinkSchemaField {
  ...
  /// Creates a new [PipelineSinkSchemaField].
  ...
  factory PipelineSinkSchemaField.fromMap(Map<String, dynamic> map) {
    return PipelineSinkSchemaField(
