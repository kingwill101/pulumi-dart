...
/// {@template pulumi_index_r2_bucket_lock_r2_bucket_lock_args_doc}
/// The set of arguments for R2BucketLock.
/// {@endtemplate}
/// {@macro pulumi_index_r2_bucket_lock_r2_bucket_lock_args_doc}
class R2BucketLockArgs {
  ...
  /// Creates a new [R2BucketLockArgs].
  /// [accountId] Account ID.
  /// [bucketName] Name of the bucket.
  /// [jurisdiction] Jurisdiction of the bucket
  /// [rules] Optional.
  const R2BucketLockArgs({
  ...
  factory R2BucketLockArgs.fromMap(Map<String, dynamic> map) {
    return R2BucketLockArgs(
