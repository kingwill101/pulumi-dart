...
/// {@template pulumi_index_zero_trust_access_application_zero_trust_access_application_args_doc}
/// The set of arguments for ZeroTrustAccessApplication.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_access_application_zero_trust_access_application_args_doc}
class ZeroTrustAccessApplicationArgs {
  ...
  /// Creates a new [ZeroTrustAccessApplicationArgs].
  ...
  const ZeroTrustAccessApplicationArgs({
    this.accountId,
  ...
  factory ZeroTrustAccessApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationArgs(
