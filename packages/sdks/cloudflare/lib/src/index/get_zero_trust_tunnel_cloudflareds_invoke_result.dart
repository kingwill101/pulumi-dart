...
import 'get_zero_trust_tunnel_cloudflareds_result.dart';

/// Result data returned by getZeroTrustTunnelCloudflareds.
class GetZeroTrustTunnelCloudflaredsInvokeResult {
  ...
  final List<GetZeroTrustTunnelCloudflaredsResult>? results;
  ...
  /// Creates a new [GetZeroTrustTunnelCloudflaredsInvokeResult].
  ...
  const GetZeroTrustTunnelCloudflaredsInvokeResult({
    this.accountId,
    this.excludePrefix,
    this.existedAt,
    this.includePrefix,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'maxItems': ?maxItems,
      'name': ?name,
      'results': ?(() { final guardedValue = results; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetZeroTrustTunnelCloudflaredsResult, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'status': ?status,
      'uuid': ?uuid,
  ...
  factory GetZeroTrustTunnelCloudflaredsInvokeResult.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustTunnelCloudflaredsInvokeResult(
