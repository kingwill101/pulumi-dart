...
class PagesProjectLatestDeploymentLatestStage {
  ...
  /// Creates a new [PagesProjectLatestDeploymentLatestStage].
  ...
  const PagesProjectLatestDeploymentLatestStage({
    this.endedOn,
    this.name,
    this.startedOn,
    this.status,
  ...
  factory PagesProjectLatestDeploymentLatestStage.fromMap(Map<String, dynamic> map) {
    return PagesProjectLatestDeploymentLatestStage(
