...
/// {@template pulumi_index_zone_dns_settings_zone_dns_settings_args_doc}
/// The set of arguments for ZoneDnsSettings.
/// {@endtemplate}
/// {@macro pulumi_index_zone_dns_settings_zone_dns_settings_args_doc}
class ZoneDnsSettingsArgs {
  ...
  /// Creates a new [ZoneDnsSettingsArgs].
  ...
  factory ZoneDnsSettingsArgs.fromMap(Map<String, dynamic> map) {
    return ZoneDnsSettingsArgs(
