...
class WorkerObservabilityTraces {
  ...
  /// Creates a new [WorkerObservabilityTraces].
  ...
  factory WorkerObservabilityTraces.fromMap(Map<String, dynamic> map) {
    return WorkerObservabilityTraces(
