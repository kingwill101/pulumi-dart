...
class WorkersCustomDomainState {
  /// Identifier.
  ...
  /// Creates a new [WorkersCustomDomainState].
  ...
  const WorkersCustomDomainState({
    this.accountId,
    this.certId,
    this.environment,
    this.hostname,
  ...
  factory WorkersCustomDomainState.fromMap(Map<String, dynamic> map) {
    return WorkersCustomDomainState(
