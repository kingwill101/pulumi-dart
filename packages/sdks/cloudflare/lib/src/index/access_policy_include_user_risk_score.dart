...
class AccessPolicyIncludeUserRiskScore {
  ...
  factory AccessPolicyIncludeUserRiskScore.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIncludeUserRiskScore(
