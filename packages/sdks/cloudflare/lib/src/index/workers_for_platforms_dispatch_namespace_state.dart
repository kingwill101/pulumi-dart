...
class WorkersForPlatformsDispatchNamespaceState {
  /// Identifier.
  ...
  /// Creates a new [WorkersForPlatformsDispatchNamespaceState].
  ...
  const WorkersForPlatformsDispatchNamespaceState({
    this.accountId,
    this.createdBy,
    this.createdOn,
    this.modifiedBy,
  ...
  factory WorkersForPlatformsDispatchNamespaceState.fromMap(Map<String, dynamic> map) {
    return WorkersForPlatformsDispatchNamespaceState(
      ...
      scriptCount: (() { final guardedValue = map['scriptCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue)); })(),
