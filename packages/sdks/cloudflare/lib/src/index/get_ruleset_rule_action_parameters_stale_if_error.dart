...
class GetRulesetRuleActionParametersStaleIfError {
  ...
  /// Creates a new [GetRulesetRuleActionParametersStaleIfError].
  ...
  const GetRulesetRuleActionParametersStaleIfError({
  ...
  factory GetRulesetRuleActionParametersStaleIfError.fromMap(Map<String, dynamic> map) {
    return GetRulesetRuleActionParametersStaleIfError(
