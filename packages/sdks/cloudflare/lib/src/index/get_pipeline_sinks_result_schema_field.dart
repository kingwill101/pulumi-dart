...
class GetPipelineSinksResultSchemaField {
  ...
  /// Creates a new [GetPipelineSinksResultSchemaField].
  ...
  const GetPipelineSinksResultSchemaField({
  ...
  factory GetPipelineSinksResultSchemaField.fromMap(Map<String, dynamic> map) {
    return GetPipelineSinksResultSchemaField(
