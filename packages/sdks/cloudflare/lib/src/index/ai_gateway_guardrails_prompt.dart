...
class AiGatewayGuardrailsPrompt {
  ...
  /// Creates a new [AiGatewayGuardrailsPrompt].
  ...
  factory AiGatewayGuardrailsPrompt.fromMap(Map<String, dynamic> map) {
    return AiGatewayGuardrailsPrompt(
