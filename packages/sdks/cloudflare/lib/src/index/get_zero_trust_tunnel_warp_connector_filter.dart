...
class GetZeroTrustTunnelWarpConnectorFilter {
  ...
  /// Creates a new [GetZeroTrustTunnelWarpConnectorFilter].
  ...
  const GetZeroTrustTunnelWarpConnectorFilter({
    this.excludePrefix,
    this.existedAt,
    this.includePrefix,
    this.isDeleted,
  ...
  factory GetZeroTrustTunnelWarpConnectorFilter.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustTunnelWarpConnectorFilter(
