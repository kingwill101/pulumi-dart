...
class GetZeroTrustAccessGroupsResultRequireOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupsResultRequireOidc].
  ...
  const GetZeroTrustAccessGroupsResultRequireOidc({
  ...
  factory GetZeroTrustAccessGroupsResultRequireOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupsResultRequireOidc(
