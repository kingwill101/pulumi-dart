...
class GetCustomHostnameSslValidationRecord {
  ...
  /// Creates a new [GetCustomHostnameSslValidationRecord].
  ...
  const GetCustomHostnameSslValidationRecord({
    required this.cname,
  ...
  factory GetCustomHostnameSslValidationRecord.fromMap(Map<String, dynamic> map) {
    return GetCustomHostnameSslValidationRecord(
