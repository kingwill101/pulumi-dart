...
class GetZeroTrustAccessInfrastructureTargetFilter {
  ...
  /// Creates a new [GetZeroTrustAccessInfrastructureTargetFilter].
  ...
  const GetZeroTrustAccessInfrastructureTargetFilter({
    this.createdAfter,
    this.createdBefore,
    this.direction,
    this.hostname,
  ...
  factory GetZeroTrustAccessInfrastructureTargetFilter.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessInfrastructureTargetFilter(
