...
class GetZeroTrustDlpEntryVariant {
  ...
  /// Creates a new [GetZeroTrustDlpEntryVariant].
  ...
  const GetZeroTrustDlpEntryVariant({
  ...
  factory GetZeroTrustDlpEntryVariant.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpEntryVariant(
