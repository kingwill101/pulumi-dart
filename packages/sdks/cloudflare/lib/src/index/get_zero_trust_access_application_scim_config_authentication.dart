...
class GetZeroTrustAccessApplicationScimConfigAuthentication {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationScimConfigAuthentication].
  ...
  const GetZeroTrustAccessApplicationScimConfigAuthentication({
  ...
  factory GetZeroTrustAccessApplicationScimConfigAuthentication.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationScimConfigAuthentication(
