...
class GetSsoConnectorVerification {
  ...
  /// Creates a new [GetSsoConnectorVerification].
  ...
  const GetSsoConnectorVerification({
    required this.code,
  ...
  factory GetSsoConnectorVerification.fromMap(Map<String, dynamic> map) {
    return GetSsoConnectorVerification(
