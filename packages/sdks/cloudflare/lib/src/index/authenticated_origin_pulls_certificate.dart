...
import 'authenticated_origin_pulls_certificate_args.dart';
import 'authenticated_origin_pulls_certificate_state.dart';
...
class AuthenticatedOriginPullsCertificate extends pulumi.CustomResource {
  ...
  /// Creates a new [AuthenticatedOriginPullsCertificate].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AuthenticatedOriginPullsCertificate]. {@macro pulumi_index_authenticated_origin_pulls_certificate_authenticated_origin_pulls_certificate_args_doc}
  ...
  /// Gets an existing [AuthenticatedOriginPullsCertificate] resource's state with the given [name] and [id].
  static AuthenticatedOriginPullsCertificate get(
    String name,
    pulumi.Input<String> id, {
    AuthenticatedOriginPullsCertificateState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AuthenticatedOriginPullsCertificate._get(
      name,
      state: state?.toMap(),
  ...
  AuthenticatedOriginPullsCertificate._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [AuthenticatedOriginPullsCertificate] resource.
  AuthenticatedOriginPullsCertificate.reference(String urn)
    : super(
        'cloudflare:index/authenticatedOriginPullsCertificate:AuthenticatedOriginPullsCertificate',
