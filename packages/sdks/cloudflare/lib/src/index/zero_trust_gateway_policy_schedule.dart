...
class ZeroTrustGatewayPolicySchedule {
  ...
  /// Creates a new [ZeroTrustGatewayPolicySchedule].
  ...
  factory ZeroTrustGatewayPolicySchedule.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewayPolicySchedule(
