...
class ObservatoryScheduledTestTestMobileReportError {
  ...
  /// Creates a new [ObservatoryScheduledTestTestMobileReportError].
  /// [code] The error code of the Lighthouse result.
  /// [detail] Detailed error message.
  /// [finalDisplayedUrl] The final URL displayed to the user.
  const ObservatoryScheduledTestTestMobileReportError({
    this.code,
    this.detail,
  ...
  factory ObservatoryScheduledTestTestMobileReportError.fromMap(Map<String, dynamic> map) {
    return ObservatoryScheduledTestTestMobileReportError(
