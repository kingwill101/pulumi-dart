...
class ZeroTrustAccessPolicyRequireGithubOrganization {
  ...
  /// Creates a new [ZeroTrustAccessPolicyRequireGithubOrganization].
  ...
  factory ZeroTrustAccessPolicyRequireGithubOrganization.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyRequireGithubOrganization(
