...
class PagesProjectLatestDeploymentStage {
  ...
  /// Creates a new [PagesProjectLatestDeploymentStage].
  ...
  const PagesProjectLatestDeploymentStage({
    this.endedOn,
    this.name,
    this.startedOn,
    this.status,
  ...
  factory PagesProjectLatestDeploymentStage.fromMap(Map<String, dynamic> map) {
    return PagesProjectLatestDeploymentStage(
