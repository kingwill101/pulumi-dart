...
class GetWorkerVersionCacheOptions {
  ...
  /// Creates a new [GetWorkerVersionCacheOptions].
  ...
  const GetWorkerVersionCacheOptions({
  ...
  factory GetWorkerVersionCacheOptions.fromMap(Map<String, dynamic> map) {
    return GetWorkerVersionCacheOptions(
