...
class GetOrganizationsContaining {
  ...
  /// Creates a new [GetOrganizationsContaining].
  ...
  const GetOrganizationsContaining({
    this.account,
    this.organization,
    this.user,
  });
  ...
  factory GetOrganizationsContaining.fromMap(Map<String, dynamic> map) {
    return GetOrganizationsContaining(
