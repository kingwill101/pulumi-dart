...
class ZeroTrustAccessPolicyExcludeExternalEvaluation {
  ...
  /// Creates a new [ZeroTrustAccessPolicyExcludeExternalEvaluation].
  ...
  factory ZeroTrustAccessPolicyExcludeExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyExcludeExternalEvaluation(
