...
import 'magic_wan_ipsec_tunnel_health_check_target.dart';
...
class MagicWanIpsecTunnelHealthCheck {
  ...
  final pulumi.Input<MagicWanIpsecTunnelHealthCheckTarget?>? target;
  /// The type of healthcheck to run, reply or request. The default value is `reply`.
  /// Available values: "reply", "request".
  final pulumi.Input<String?>? type;

  /// Creates a new [MagicWanIpsecTunnelHealthCheck].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': ?enabled,
      'rate': ?rate,
      'target': ?pulumi.Input.mapOptionalInputValue<MagicWanIpsecTunnelHealthCheckTarget, Map<String, dynamic>>(target, (value) => value.toMap()),
      'type': ?type,
    };
  }

  factory MagicWanIpsecTunnelHealthCheck.fromMap(Map<String, dynamic> map) {
    return MagicWanIpsecTunnelHealthCheck(
      direction: (() { final guardedValue = map['direction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      rate: (() { final guardedValue = map['rate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(MagicWanIpsecTunnelHealthCheckTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
