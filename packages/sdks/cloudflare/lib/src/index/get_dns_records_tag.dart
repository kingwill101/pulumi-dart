...
class GetDnsRecordsTag {
  ...
  /// Creates a new [GetDnsRecordsTag].
  ...
  factory GetDnsRecordsTag.fromMap(Map<String, dynamic> map) {
    return GetDnsRecordsTag(
