...
class GetPagesProjectsResultCanonicalDeploymentSourceConfig {
  ...
  /// Creates a new [GetPagesProjectsResultCanonicalDeploymentSourceConfig].
  ...
  const GetPagesProjectsResultCanonicalDeploymentSourceConfig({
  ...
  factory GetPagesProjectsResultCanonicalDeploymentSourceConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultCanonicalDeploymentSourceConfig(
