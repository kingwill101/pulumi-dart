...
import 'zero_trust_access_identity_provider_config_header_attribute.dart';

class ZeroTrustAccessIdentityProviderConfig {
  /// Your companies TLD
  ...
  /// Creates a new [ZeroTrustAccessIdentityProviderConfig].
  ...
  factory ZeroTrustAccessIdentityProviderConfig.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessIdentityProviderConfig(
