...
import 'get_zero_trust_tunnel_cloudflared_config_config_origin_request_access.dart';

class GetZeroTrustTunnelCloudflaredConfigConfigOriginRequest {
  /// For all L7 requests to this hostname, cloudflared will validate each request's Cf-Access-Jwt-Assertion request header.
  final pulumi.Input<GetZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess> access;
  ...
  /// Creates a new [GetZeroTrustTunnelCloudflaredConfigConfigOriginRequest].
  ...
  const GetZeroTrustTunnelCloudflaredConfigConfigOriginRequest({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'access': pulumi.Input.mapInputValue<GetZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess, Map<String, dynamic>>(access, (value) => value.toMap()),
      'caPool': caPool,
  ...
  factory GetZeroTrustTunnelCloudflaredConfigConfigOriginRequest.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustTunnelCloudflaredConfigConfigOriginRequest(
      access: pulumi.Input.fromValue(GetZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess.fromMap((map['access']! as Map).cast<String, dynamic>())),
