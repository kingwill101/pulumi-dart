...
class GetZeroTrustAccessAiControlsMcpPortalServerErrorDetails {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpPortalServerErrorDetails].
  ...
  const GetZeroTrustAccessAiControlsMcpPortalServerErrorDetails({
    required this.cause,
  ...
  factory GetZeroTrustAccessAiControlsMcpPortalServerErrorDetails.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpPortalServerErrorDetails(
