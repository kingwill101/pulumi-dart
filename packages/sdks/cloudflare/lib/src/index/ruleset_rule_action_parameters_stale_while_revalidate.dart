...
class RulesetRuleActionParametersStaleWhileRevalidate {
  ...
  /// Creates a new [RulesetRuleActionParametersStaleWhileRevalidate].
  ...
  const RulesetRuleActionParametersStaleWhileRevalidate({
    this.cloudflareOnly,
  ...
  factory RulesetRuleActionParametersStaleWhileRevalidate.fromMap(Map<String, dynamic> map) {
    return RulesetRuleActionParametersStaleWhileRevalidate(
