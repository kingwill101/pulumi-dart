...
class GetPagesProjectsResultBuildConfig {
  ...
  /// Creates a new [GetPagesProjectsResultBuildConfig].
  ...
  const GetPagesProjectsResultBuildConfig({
  ...
  factory GetPagesProjectsResultBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultBuildConfig(
