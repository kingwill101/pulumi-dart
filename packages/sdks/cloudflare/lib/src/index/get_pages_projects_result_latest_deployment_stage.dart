...
class GetPagesProjectsResultLatestDeploymentStage {
  ...
  /// Creates a new [GetPagesProjectsResultLatestDeploymentStage].
  ...
  const GetPagesProjectsResultLatestDeploymentStage({
  ...
  factory GetPagesProjectsResultLatestDeploymentStage.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultLatestDeploymentStage(
