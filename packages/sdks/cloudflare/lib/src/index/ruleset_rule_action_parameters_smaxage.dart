...
class RulesetRuleActionParametersSMaxage {
  ...
  /// Creates a new [RulesetRuleActionParametersSMaxage].
  ...
  const RulesetRuleActionParametersSMaxage({
    this.cloudflareOnly,
  ...
  factory RulesetRuleActionParametersSMaxage.fromMap(Map<String, dynamic> map) {
    return RulesetRuleActionParametersSMaxage(
