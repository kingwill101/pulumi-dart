...
class GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv6 {
  ...
  /// Creates a new [GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv6].
  ...
  const GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv6({
    required this.ip,
    required this.port,
  ...
  factory GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv6.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustGatewayPolicyRuleSettingsDnsResolversIpv6(
