...
class GetLoadBalancersResultAdaptiveRouting {
  ...
  factory GetLoadBalancersResultAdaptiveRouting.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersResultAdaptiveRouting(
