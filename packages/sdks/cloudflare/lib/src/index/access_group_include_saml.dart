...
class AccessGroupIncludeSaml {
  ...
  /// Creates a new [AccessGroupIncludeSaml].
  ...
  factory AccessGroupIncludeSaml.fromMap(Map<String, dynamic> map) {
    return AccessGroupIncludeSaml(
