...
class GetZeroTrustAccessGroupIncludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupIncludeOidc].
  ...
  const GetZeroTrustAccessGroupIncludeOidc({
  ...
  factory GetZeroTrustAccessGroupIncludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupIncludeOidc(
