...
import 'static_route_args.dart';
import 'static_route_scope.dart';
import 'static_route_state.dart';
...
class StaticRoute extends pulumi.CustomResource {
  ...
  late final pulumi.Output<StaticRouteScope?> scope;
  /// Optional weight of the ECMP scope - if provided.
  late final pulumi.Output<int?> weight;

  /// Creates a new [StaticRoute].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [StaticRoute]. {@macro pulumi_index_static_route_static_route_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  StaticRoute(
    String name, {
    StaticRouteArgs? args,
    ...
    scope = registerOutput<StaticRouteScope?>('scope', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return StaticRouteScope.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    weight = registerOutput<int?>('weight');
  }

  /// Gets an existing [StaticRoute] resource's state with the given [name] and [id].
  static StaticRoute get(
    String name,
    pulumi.Input<String> id, {
    StaticRouteState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return StaticRoute._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [StaticRoute] resource.
  StaticRoute.reference(String urn)
    : super(
        'cloudflare:index/staticRoute:StaticRoute',
