...
class GetCertificatePacksResultDcvDelegationRecord {
  ...
  /// Creates a new [GetCertificatePacksResultDcvDelegationRecord].
  ...
  const GetCertificatePacksResultDcvDelegationRecord({
    required this.cname,
  ...
  factory GetCertificatePacksResultDcvDelegationRecord.fromMap(Map<String, dynamic> map) {
    return GetCertificatePacksResultDcvDelegationRecord(
