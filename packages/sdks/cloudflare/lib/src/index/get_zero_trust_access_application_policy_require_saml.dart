...
class GetZeroTrustAccessApplicationPolicyRequireSaml {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationPolicyRequireSaml].
  ...
  const GetZeroTrustAccessApplicationPolicyRequireSaml({
  ...
  factory GetZeroTrustAccessApplicationPolicyRequireSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationPolicyRequireSaml(
