...
class GetMagicTransitSiteLansResultStaticAddressingDhcpServerDhcpOption {
  ...
  /// Creates a new [GetMagicTransitSiteLansResultStaticAddressingDhcpServerDhcpOption].
  ...
  const GetMagicTransitSiteLansResultStaticAddressingDhcpServerDhcpOption({
    required this.code,
    required this.type,
    required this.value,
  });
  ...
  factory GetMagicTransitSiteLansResultStaticAddressingDhcpServerDhcpOption.fromMap(Map<String, dynamic> map) {
    return GetMagicTransitSiteLansResultStaticAddressingDhcpServerDhcpOption(
