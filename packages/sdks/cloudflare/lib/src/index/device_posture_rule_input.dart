...
import 'device_posture_rule_input_locations.dart';
...
class DevicePostureRuleInput {
  ...
  final pulumi.Input<DevicePostureRuleInputLocations?>? locations;
  ...
  /// Creates a new [DevicePostureRuleInput].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lastSeen': ?lastSeen,
      'locations': ?pulumi.Input.mapOptionalInputValue<DevicePostureRuleInputLocations, Map<String, dynamic>>(locations, (value) => value.toMap()),
  ...
  factory DevicePostureRuleInput.fromMap(Map<String, dynamic> map) {
    return DevicePostureRuleInput(
      ...
      locations: (() { final guardedValue = map['locations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DevicePostureRuleInputLocations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
