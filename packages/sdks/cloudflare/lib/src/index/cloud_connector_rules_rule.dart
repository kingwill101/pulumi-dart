...
class CloudConnectorRulesRule {
  ...
  final pulumi.Input<String?>? cloudConnectorRulesProvider;
  ...
  factory CloudConnectorRulesRule.fromMap(Map<String, dynamic> map) {
    return CloudConnectorRulesRule(
      cloudConnectorRulesProvider: (() { final guardedValue = map['cloudConnectorRulesProvider']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
