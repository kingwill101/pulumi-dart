...
import 'zero_trust_access_application_saas_app_custom_attribute.dart';
import 'zero_trust_access_application_saas_app_custom_claim.dart';
import 'zero_trust_access_application_saas_app_hybrid_and_implicit_options.dart';
import 'zero_trust_access_application_saas_app_refresh_token_options.dart';
...
class ZeroTrustAccessApplicationSaasApp {
  ...
  final pulumi.Input<List<ZeroTrustAccessApplicationSaasAppCustomAttribute>?>? customAttributes;
  final pulumi.Input<List<ZeroTrustAccessApplicationSaasAppCustomClaim>?>? customClaims;
  ...
  final pulumi.Input<ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions?>? hybridAndImplicitOptions;
  ...
  final pulumi.Input<ZeroTrustAccessApplicationSaasAppRefreshTokenOptions?>? refreshTokenOptions;
  ...
  /// Creates a new [ZeroTrustAccessApplicationSaasApp].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customAttributes': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustAccessApplicationSaasAppCustomAttribute>, List<Map<String, dynamic>>>(customAttributes, (value) => pulumi.Input.encodeList<ZeroTrustAccessApplicationSaasAppCustomAttribute, Map<String, dynamic>>(value, (value) => value.toMap())),
      'customClaims': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustAccessApplicationSaasAppCustomClaim>, List<Map<String, dynamic>>>(customClaims, (value) => pulumi.Input.encodeList<ZeroTrustAccessApplicationSaasAppCustomClaim, Map<String, dynamic>>(value, (value) => value.toMap())),
      'defaultRelayState': ?defaultRelayState,
      'grantTypes': ?grantTypes,
      'groupFilterRegex': ?groupFilterRegex,
      'hybridAndImplicitOptions': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions, Map<String, dynamic>>(hybridAndImplicitOptions, (value) => value.toMap()),
      'idpEntityId': ?idpEntityId,
      'nameIdFormat': ?nameIdFormat,
      'nameIdTransformJsonata': ?nameIdTransformJsonata,
      'publicKey': ?publicKey,
      'redirectUris': ?redirectUris,
      'refreshTokenOptions': ?pulumi.Input.mapOptionalInputValue<ZeroTrustAccessApplicationSaasAppRefreshTokenOptions, Map<String, dynamic>>(refreshTokenOptions, (value) => value.toMap()),
  ...
  factory ZeroTrustAccessApplicationSaasApp.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationSaasApp(
      ...
      customAttributes: (() { final guardedValue = map['customAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessApplicationSaasAppCustomAttribute>(guardedValue, (value) => ZeroTrustAccessApplicationSaasAppCustomAttribute.fromMap((value as Map).cast<String, dynamic>()))); })(),
      customClaims: (() { final guardedValue = map['customClaims']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustAccessApplicationSaasAppCustomClaim>(guardedValue, (value) => ZeroTrustAccessApplicationSaasAppCustomClaim.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      hybridAndImplicitOptions: (() { final guardedValue = map['hybridAndImplicitOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      refreshTokenOptions: (() { final guardedValue = map['refreshTokenOptions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ZeroTrustAccessApplicationSaasAppRefreshTokenOptions.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
