...
class GetZeroTrustAccessApplicationPolicyExcludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationPolicyExcludeOidc].
  ...
  const GetZeroTrustAccessApplicationPolicyExcludeOidc({
  ...
  factory GetZeroTrustAccessApplicationPolicyExcludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationPolicyExcludeOidc(
