...
class GetSharesResult {
  ...
  factory GetSharesResult.fromMap(Map<String, dynamic> map) {
    return GetSharesResult(
      ...
      associatedRecipientCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['associatedRecipientCount'])),
      associatingRecipientCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['associatingRecipientCount'])),
      created: pulumi.Input.fromValue(map['created'] as String),
      disassociatedRecipientCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['disassociatedRecipientCount'])),
      disassociatingRecipientCount: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['disassociatingRecipientCount'])),
