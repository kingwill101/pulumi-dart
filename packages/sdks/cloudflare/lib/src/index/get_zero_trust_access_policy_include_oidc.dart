...
class GetZeroTrustAccessPolicyIncludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessPolicyIncludeOidc].
  ...
  const GetZeroTrustAccessPolicyIncludeOidc({
  ...
  factory GetZeroTrustAccessPolicyIncludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPolicyIncludeOidc(
