...
import 'workers_script_binding_outbound.dart';
import 'workers_script_binding_simple.dart';

class WorkersScriptBinding {
  ...
  /// Outbound worker.
  final pulumi.Input<WorkersScriptBindingOutbound?>? outbound;
  ...
  /// A simple rate limit.
  final pulumi.Input<WorkersScriptBindingSimple?>? simple;
  ...
  /// Creates a new [WorkersScriptBinding].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkId': ?networkId,
      'oldName': ?oldName,
      'outbound': ?pulumi.Input.mapOptionalInputValue<WorkersScriptBindingOutbound, Map<String, dynamic>>(outbound, (value) => value.toMap()),
      'part': ?part,
      'pipeline': ?pipeline,
      'queueName': ?queueName,
      ...
      'service': ?service,
      'serviceId': ?serviceId,
      'simple': ?pulumi.Input.mapOptionalInputValue<WorkersScriptBindingSimple, Map<String, dynamic>>(simple, (value) => value.toMap()),
      'storeId': ?storeId,
      'text': ?text,
      'tunnelId': ?tunnelId,
      'type': type,
  ...
  factory WorkersScriptBinding.fromMap(Map<String, dynamic> map) {
    return WorkersScriptBinding(
      ...
      outbound: (() { final guardedValue = map['outbound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkersScriptBindingOutbound.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      simple: (() { final guardedValue = map['simple']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkersScriptBindingSimple.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
