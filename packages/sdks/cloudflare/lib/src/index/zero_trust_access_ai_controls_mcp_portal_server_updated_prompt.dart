...
class ZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt {
  ...
  /// Creates a new [ZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt].
  ...
  const ZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt({
    this.alias,
    this.description,
    this.enabled,
    required this.name,
  ...
  factory ZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt(
