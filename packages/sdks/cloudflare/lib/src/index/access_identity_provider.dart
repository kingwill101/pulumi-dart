...
import 'access_identity_provider_args.dart';
...
import 'access_identity_provider_state.dart';
...
class AccessIdentityProvider extends pulumi.CustomResource {
  ...
  late final pulumi.Output<AccessIdentityProviderConfig> config;
  ...
  late final pulumi.Output<AccessIdentityProviderSamlCertificateSet> samlCertificateSet;
  ...
  late final pulumi.Output<AccessIdentityProviderScimConfig> scimConfig;
  ...
  /// Creates a new [AccessIdentityProvider].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AccessIdentityProvider]. {@macro pulumi_index_access_identity_provider_access_identity_provider_args_doc}
  ...
  AccessIdentityProvider(
    ...
    config = registerOutput<AccessIdentityProviderConfig>('config', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AccessIdentityProviderConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    this.name = registerOutput<String>('name');
    readOnly = registerOutput<bool?>('readOnly');
    samlCertificateSet = registerOutput<AccessIdentityProviderSamlCertificateSet>('samlCertificateSet', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AccessIdentityProviderSamlCertificateSet.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    samlCertificateSetId = registerOutput<String?>('samlCertificateSetId');
    scimConfig = registerOutput<AccessIdentityProviderScimConfig>('scimConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return AccessIdentityProviderScimConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    type = registerOutput<String>('type');
    zoneId = registerOutput<String?>('zoneId');
  }

  /// Gets an existing [AccessIdentityProvider] resource's state with the given [name] and [id].
  static AccessIdentityProvider get(
    String name,
    pulumi.Input<String> id, {
    AccessIdentityProviderState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AccessIdentityProvider._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AccessIdentityProvider] resource.
  AccessIdentityProvider.reference(String urn)
    : super(
        'cloudflare:index/accessIdentityProvider:AccessIdentityProvider',
