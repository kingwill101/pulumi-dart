...
import 'tunnel_config_args.dart';
import 'tunnel_config_config.dart';
import 'tunnel_config_state.dart';
...
class TunnelConfig extends pulumi.CustomResource {
  ...
  late final pulumi.Output<TunnelConfigConfig> config;
  ...
  /// Creates a new [TunnelConfig].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [TunnelConfig]. {@macro pulumi_index_tunnel_config_tunnel_config_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  TunnelConfig(
    String name, {
    TunnelConfigArgs? args,
  ...
  /// Gets an existing [TunnelConfig] resource's state with the given [name] and [id].
  static TunnelConfig get(
    String name,
    pulumi.Input<String> id, {
    TunnelConfigState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return TunnelConfig._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [TunnelConfig] resource.
  TunnelConfig.reference(String urn)
    : super(
        'cloudflare:index/tunnelConfig:TunnelConfig',
