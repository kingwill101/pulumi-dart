...
class WorkerScriptAnnotations {
  ...
  /// Creates a new [WorkerScriptAnnotations].
  ...
  factory WorkerScriptAnnotations.fromMap(Map<String, dynamic> map) {
    return WorkerScriptAnnotations(
