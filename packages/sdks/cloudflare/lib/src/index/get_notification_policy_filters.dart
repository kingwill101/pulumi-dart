...
class GetNotificationPolicyFilters {
  ...
  /// Creates a new [GetNotificationPolicyFilters].
  ...
  const GetNotificationPolicyFilters({
  ...
  factory GetNotificationPolicyFilters.fromMap(Map<String, dynamic> map) {
    return GetNotificationPolicyFilters(
