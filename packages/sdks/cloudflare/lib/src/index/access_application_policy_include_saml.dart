...
class AccessApplicationPolicyIncludeSaml {
  ...
  /// Creates a new [AccessApplicationPolicyIncludeSaml].
  ...
  const AccessApplicationPolicyIncludeSaml({
  ...
  factory AccessApplicationPolicyIncludeSaml.fromMap(Map<String, dynamic> map) {
    return AccessApplicationPolicyIncludeSaml(
