...
class GetWorkerVersionsResultBindingSimple {
  ...
  /// Creates a new [GetWorkerVersionsResultBindingSimple].
  ...
  const GetWorkerVersionsResultBindingSimple({
    required this.limit,
  ...
  factory GetWorkerVersionsResultBindingSimple.fromMap(Map<String, dynamic> map) {
    return GetWorkerVersionsResultBindingSimple(
