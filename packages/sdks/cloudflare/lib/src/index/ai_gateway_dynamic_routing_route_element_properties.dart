...
class AiGatewayDynamicRoutingRouteElementProperties {
  ...
  /// Creates a new [AiGatewayDynamicRoutingRouteElementProperties].
  ...
  /// [timeout] Optional.
  /// [window] Optional.
  const AiGatewayDynamicRoutingRouteElementProperties({
  ...
  factory AiGatewayDynamicRoutingRouteElementProperties.fromMap(Map<String, dynamic> map) {
    return AiGatewayDynamicRoutingRouteElementProperties(
