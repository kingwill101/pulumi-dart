...
class ZeroTrustAccessGroupIncludeExternalEvaluation {
  ...
  /// Creates a new [ZeroTrustAccessGroupIncludeExternalEvaluation].
  ...
  factory ZeroTrustAccessGroupIncludeExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupIncludeExternalEvaluation(
