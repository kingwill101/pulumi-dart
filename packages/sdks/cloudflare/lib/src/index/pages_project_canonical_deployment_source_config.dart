...
class PagesProjectCanonicalDeploymentSourceConfig {
  ...
  /// Creates a new [PagesProjectCanonicalDeploymentSourceConfig].
  ...
  const PagesProjectCanonicalDeploymentSourceConfig({
  ...
  factory PagesProjectCanonicalDeploymentSourceConfig.fromMap(Map<String, dynamic> map) {
    return PagesProjectCanonicalDeploymentSourceConfig(
