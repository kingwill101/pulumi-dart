...
class GetWorkflowsResultInstances {
  ...
  /// Creates a new [GetWorkflowsResultInstances].
  /// [complete] Required.
  /// [errored] Required.
  /// [paused] Required.
  /// [queued] Required.
  ...
  const GetWorkflowsResultInstances({
  ...
  factory GetWorkflowsResultInstances.fromMap(Map<String, dynamic> map) {
    return GetWorkflowsResultInstances(
