...
class GetPagesProjectLatestDeploymentLatestStage {
  ...
  /// Creates a new [GetPagesProjectLatestDeploymentLatestStage].
  ...
  const GetPagesProjectLatestDeploymentLatestStage({
  ...
  factory GetPagesProjectLatestDeploymentLatestStage.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectLatestDeploymentLatestStage(
