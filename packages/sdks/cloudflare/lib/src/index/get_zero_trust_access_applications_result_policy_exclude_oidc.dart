...
class GetZeroTrustAccessApplicationsResultPolicyExcludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationsResultPolicyExcludeOidc].
  ...
  const GetZeroTrustAccessApplicationsResultPolicyExcludeOidc({
  ...
  factory GetZeroTrustAccessApplicationsResultPolicyExcludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationsResultPolicyExcludeOidc(
