...
class ZeroTrustDeviceDefaultProfileServiceModeV2 {
  ...
  /// Creates a new [ZeroTrustDeviceDefaultProfileServiceModeV2].
  /// [mode] The mode to run the WARP client under.
  /// [port] The port number when used with proxy mode.
  const ZeroTrustDeviceDefaultProfileServiceModeV2({
    this.mode,
    this.port,
  });
  ...
  factory ZeroTrustDeviceDefaultProfileServiceModeV2.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDeviceDefaultProfileServiceModeV2(
