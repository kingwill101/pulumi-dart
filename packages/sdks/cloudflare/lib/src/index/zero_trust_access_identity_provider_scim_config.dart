...
class ZeroTrustAccessIdentityProviderScimConfig {
  ...
  /// Creates a new [ZeroTrustAccessIdentityProviderScimConfig].
  ...
  factory ZeroTrustAccessIdentityProviderScimConfig.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessIdentityProviderScimConfig(
      enabled: (() { final guardedValue = map['enabled']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      identityUpdateBehavior: (() { final guardedValue = map['identityUpdateBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      scimBaseUrl: (() { final guardedValue = map['scimBaseUrl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      seatDeprovision: (() { final guardedValue = map['seatDeprovision']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      userDeprovision: (() { final guardedValue = map['userDeprovision']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
