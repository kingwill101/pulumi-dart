...
class GetZeroTrustAccessGroupsResultIncludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupsResultIncludeOidc].
  ...
  const GetZeroTrustAccessGroupsResultIncludeOidc({
  ...
  factory GetZeroTrustAccessGroupsResultIncludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupsResultIncludeOidc(
