...
class GetCustomHostnameFilterHostname {
  ...
  /// Creates a new [GetCustomHostnameFilterHostname].
  ...
  const GetCustomHostnameFilterHostname({
    this.contain,
    this.exact,
    this.startsWith,
  });
  ...
  factory GetCustomHostnameFilterHostname.fromMap(Map<String, dynamic> map) {
    return GetCustomHostnameFilterHostname(
