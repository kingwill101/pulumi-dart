...
class AccessGroupIncludeAuthContext {
  ...
  /// Creates a new [AccessGroupIncludeAuthContext].
  ...
  const AccessGroupIncludeAuthContext({
    required this.acId,
    required this.id,
  ...
  factory AccessGroupIncludeAuthContext.fromMap(Map<String, dynamic> map) {
    return AccessGroupIncludeAuthContext(
