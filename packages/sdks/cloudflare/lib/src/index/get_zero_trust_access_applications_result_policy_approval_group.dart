...
class GetZeroTrustAccessApplicationsResultPolicyApprovalGroup {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationsResultPolicyApprovalGroup].
  ...
  const GetZeroTrustAccessApplicationsResultPolicyApprovalGroup({
  ...
  factory GetZeroTrustAccessApplicationsResultPolicyApprovalGroup.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationsResultPolicyApprovalGroup(
