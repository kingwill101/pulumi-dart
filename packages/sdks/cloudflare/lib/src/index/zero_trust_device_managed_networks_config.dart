...
class ZeroTrustDeviceManagedNetworksConfig {
  ...
  /// Creates a new [ZeroTrustDeviceManagedNetworksConfig].
  ...
  factory ZeroTrustDeviceManagedNetworksConfig.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDeviceManagedNetworksConfig(
