...
class GetPipelineSinkFormat {
  ...
  /// Creates a new [GetPipelineSinkFormat].
  ...
  factory GetPipelineSinkFormat.fromMap(Map<String, dynamic> map) {
    return GetPipelineSinkFormat(
