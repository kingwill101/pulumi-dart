...
class ZeroTrustAccessApplicationPolicyIncludeSaml {
  ...
  /// Creates a new [ZeroTrustAccessApplicationPolicyIncludeSaml].
  ...
  const ZeroTrustAccessApplicationPolicyIncludeSaml({
  ...
  factory ZeroTrustAccessApplicationPolicyIncludeSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationPolicyIncludeSaml(
