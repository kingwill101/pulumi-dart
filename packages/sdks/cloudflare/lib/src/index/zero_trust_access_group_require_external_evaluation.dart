...
class ZeroTrustAccessGroupRequireExternalEvaluation {
  ...
  /// Creates a new [ZeroTrustAccessGroupRequireExternalEvaluation].
  ...
  factory ZeroTrustAccessGroupRequireExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupRequireExternalEvaluation(
