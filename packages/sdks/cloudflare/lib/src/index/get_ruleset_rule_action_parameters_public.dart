...
class GetRulesetRuleActionParametersPublic {
  ...
  /// Creates a new [GetRulesetRuleActionParametersPublic].
  /// [cloudflareOnly] Whether to apply the directive only to Cloudflare's cache.
  /// [operation] The operation to perform.
  const GetRulesetRuleActionParametersPublic({
  ...
  factory GetRulesetRuleActionParametersPublic.fromMap(Map<String, dynamic> map) {
    return GetRulesetRuleActionParametersPublic(
