...
class TunnelRouteState {
  ...
  /// Creates a new [TunnelRouteState].
  ...
  factory TunnelRouteState.fromMap(Map<String, dynamic> map) {
    return TunnelRouteState(
