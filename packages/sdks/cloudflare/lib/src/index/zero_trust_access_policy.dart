...
import 'zero_trust_access_policy_args.dart';
...
import 'zero_trust_access_policy_state.dart';
...
class ZeroTrustAccessPolicy extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<ZeroTrustAccessPolicyApprovalGroup>?> approvalGroups;
  /// Requires the user to request access from an administrator at the start of each session.
  late final pulumi.Output<bool?> approvalRequired;
  /// The rules that define how users may connect to targets secured by your application.
  late final pulumi.Output<ZeroTrustAccessPolicyConnectionRules?> connectionRules;
  ...
  late final pulumi.Output<List<ZeroTrustAccessPolicyExclude>> excludes;
  /// Rules evaluated with an OR logical operator. A user needs to meet only one of the Include rules.
  late final pulumi.Output<List<ZeroTrustAccessPolicyInclude>> includes;
  /// Require this application to be served in an isolated browser for users matching this policy. 'Client Web Isolation' must be on for the account in order to use this feature.
  late final pulumi.Output<bool?> isolationRequired;
  /// Configures multi-factor authentication (MFA) settings.
  late final pulumi.Output<ZeroTrustAccessPolicyMfaConfig?> mfaConfig;
  ...
  late final pulumi.Output<List<ZeroTrustAccessPolicyRequire>> requires;
  ...
  /// Creates a new [ZeroTrustAccessPolicy].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustAccessPolicy]. {@macro pulumi_index_zero_trust_access_policy_zero_trust_access_policy_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustAccessPolicy(
    String name, {
    ZeroTrustAccessPolicyArgs? args,
    ...
    approvalGroups = registerOutput<List<ZeroTrustAccessPolicyApprovalGroup>?>('approvalGroups', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ZeroTrustAccessPolicyApprovalGroup>(guardedValue, (value) => ZeroTrustAccessPolicyApprovalGroup.fromMap((value as Map).cast<String, dynamic>())); });
    approvalRequired = registerOutput<bool?>('approvalRequired');
    connectionRules = registerOutput<ZeroTrustAccessPolicyConnectionRules?>('connectionRules', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustAccessPolicyConnectionRules.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    createdAt = registerOutput<String>('createdAt');
    decision = registerOutput<String>('decision');
    excludes = registerOutput<List<ZeroTrustAccessPolicyExclude>>('excludes', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ZeroTrustAccessPolicyExclude>(guardedValue, (value) => ZeroTrustAccessPolicyExclude.fromMap((value as Map).cast<String, dynamic>())); });
    includes = registerOutput<List<ZeroTrustAccessPolicyInclude>>('includes', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ZeroTrustAccessPolicyInclude>(guardedValue, (value) => ZeroTrustAccessPolicyInclude.fromMap((value as Map).cast<String, dynamic>())); });
    isolationRequired = registerOutput<bool?>('isolationRequired');
    mfaConfig = registerOutput<ZeroTrustAccessPolicyMfaConfig?>('mfaConfig', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ZeroTrustAccessPolicyMfaConfig.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    requires = registerOutput<List<ZeroTrustAccessPolicyRequire>>('requires', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<ZeroTrustAccessPolicyRequire>(guardedValue, (value) => ZeroTrustAccessPolicyRequire.fromMap((value as Map).cast<String, dynamic>())); });
    reusable = registerOutput<bool>('reusable');
    sessionDuration = registerOutput<String>('sessionDuration');
    updatedAt = registerOutput<String>('updatedAt');
  }

  /// Gets an existing [ZeroTrustAccessPolicy] resource's state with the given [name] and [id].
  static ZeroTrustAccessPolicy get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustAccessPolicyState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustAccessPolicy._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [ZeroTrustAccessPolicy] resource.
  ZeroTrustAccessPolicy.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustAccessPolicy:ZeroTrustAccessPolicy',
