...
class GetLoadBalancerRuleOverridesAdaptiveRouting {
  ...
  factory GetLoadBalancerRuleOverridesAdaptiveRouting.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerRuleOverridesAdaptiveRouting(
