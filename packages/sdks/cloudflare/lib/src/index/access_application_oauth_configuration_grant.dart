...
class AccessApplicationOauthConfigurationGrant {
  ...
  /// Creates a new [AccessApplicationOauthConfigurationGrant].
  ...
  const AccessApplicationOauthConfigurationGrant({
  ...
  factory AccessApplicationOauthConfigurationGrant.fromMap(Map<String, dynamic> map) {
    return AccessApplicationOauthConfigurationGrant(
