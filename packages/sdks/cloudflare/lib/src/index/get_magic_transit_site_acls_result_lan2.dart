...
class GetMagicTransitSiteAclsResultLan2 {
  ...
  /// Creates a new [GetMagicTransitSiteAclsResultLan2].
  ...
  const GetMagicTransitSiteAclsResultLan2({
    required this.lanId,
  ...
  factory GetMagicTransitSiteAclsResultLan2.fromMap(Map<String, dynamic> map) {
    return GetMagicTransitSiteAclsResultLan2(
