...
class GetApiShieldOperationSchemasUploaded {
  ...
  /// Creates a new [GetApiShieldOperationSchemasUploaded].
  ...
  const GetApiShieldOperationSchemasUploaded({
  ...
  factory GetApiShieldOperationSchemasUploaded.fromMap(Map<String, dynamic> map) {
    return GetApiShieldOperationSchemasUploaded(
