...
import 'observatory_scheduled_test_test_desktop_report_error.dart';
...
class ObservatoryScheduledTestTestDesktopReport {
  ...
  final pulumi.Input<ObservatoryScheduledTestTestDesktopReportError?>? error;
  ...
  /// Creates a new [ObservatoryScheduledTestTestDesktopReport].
  ...
  const ObservatoryScheduledTestTestDesktopReport({
    this.cls,
    this.deviceType,
    this.error,
    this.fcp,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'error': ?pulumi.Input.mapOptionalInputValue<ObservatoryScheduledTestTestDesktopReportError, Map<String, dynamic>>(error, (value) => value.toMap()),
      'fcp': ?fcp,
  ...
  factory ObservatoryScheduledTestTestDesktopReport.fromMap(Map<String, dynamic> map) {
    return ObservatoryScheduledTestTestDesktopReport(
      ...
      error: (() { final guardedValue = map['error']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ObservatoryScheduledTestTestDesktopReportError.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
