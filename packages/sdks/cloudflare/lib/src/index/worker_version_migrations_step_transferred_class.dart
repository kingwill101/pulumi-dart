...
class WorkerVersionMigrationsStepTransferredClass {
  final pulumi.Input<String?>? from;
  final pulumi.Input<String?>? fromScript;
  final pulumi.Input<String?>? to;

  /// Creates a new [WorkerVersionMigrationsStepTransferredClass].
  /// [from] Optional.
  /// [fromScript] Optional.
  /// [to] Optional.
  const WorkerVersionMigrationsStepTransferredClass({
    this.from,
    this.fromScript,
    this.to,
  });
  ...
  factory WorkerVersionMigrationsStepTransferredClass.fromMap(Map<String, dynamic> map) {
    return WorkerVersionMigrationsStepTransferredClass(
