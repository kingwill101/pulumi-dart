...
class RulesetRuleActionParametersProxyRevalidate {
  ...
  /// Creates a new [RulesetRuleActionParametersProxyRevalidate].
  /// [cloudflareOnly] Whether to apply the directive only to Cloudflare's cache.
  /// [operation] The operation to perform.
  const RulesetRuleActionParametersProxyRevalidate({
    this.cloudflareOnly,
  ...
  factory RulesetRuleActionParametersProxyRevalidate.fromMap(Map<String, dynamic> map) {
    return RulesetRuleActionParametersProxyRevalidate(
