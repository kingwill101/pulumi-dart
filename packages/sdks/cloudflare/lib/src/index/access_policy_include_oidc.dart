...
class AccessPolicyIncludeOidc {
  ...
  /// Creates a new [AccessPolicyIncludeOidc].
  ...
  factory AccessPolicyIncludeOidc.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIncludeOidc(
