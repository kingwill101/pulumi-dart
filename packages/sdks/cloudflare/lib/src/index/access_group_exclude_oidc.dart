...
class AccessGroupExcludeOidc {
  ...
  /// Creates a new [AccessGroupExcludeOidc].
  ...
  factory AccessGroupExcludeOidc.fromMap(Map<String, dynamic> map) {
    return AccessGroupExcludeOidc(
