...
import 'zero_trust_device_posture_integration_args.dart';
import 'zero_trust_device_posture_integration_config.dart';
import 'zero_trust_device_posture_integration_state.dart';
...
class ZeroTrustDevicePostureIntegration extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ZeroTrustDevicePostureIntegrationConfig> config;
  ...
  /// Creates a new [ZeroTrustDevicePostureIntegration].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustDevicePostureIntegration]. {@macro pulumi_index_zero_trust_device_posture_integration_zero_trust_device_posture_integration_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustDevicePostureIntegration(
    String name, {
    ZeroTrustDevicePostureIntegrationArgs? args,
  ...
  /// Gets an existing [ZeroTrustDevicePostureIntegration] resource's state with the given [name] and [id].
  static ZeroTrustDevicePostureIntegration get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustDevicePostureIntegrationState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustDevicePostureIntegration._get(
      name,
      state: state?.toMap(),
  ...
  ZeroTrustDevicePostureIntegration._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ZeroTrustDevicePostureIntegration] resource.
  ZeroTrustDevicePostureIntegration.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustDevicePostureIntegration:ZeroTrustDevicePostureIntegration',
