...
class GetZeroTrustAccessApplicationPolicyIncludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationPolicyIncludeSaml].
  ...
  const GetZeroTrustAccessApplicationPolicyIncludeSaml({
  ...
  factory GetZeroTrustAccessApplicationPolicyIncludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationPolicyIncludeSaml(
