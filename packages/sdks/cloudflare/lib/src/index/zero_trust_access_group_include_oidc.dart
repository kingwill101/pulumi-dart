...
class ZeroTrustAccessGroupIncludeOidc {
  ...
  /// Creates a new [ZeroTrustAccessGroupIncludeOidc].
  ...
  factory ZeroTrustAccessGroupIncludeOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupIncludeOidc(
