...
class AccessPolicyRequireOidc {
  ...
  /// Creates a new [AccessPolicyRequireOidc].
  ...
  factory AccessPolicyRequireOidc.fromMap(Map<String, dynamic> map) {
    return AccessPolicyRequireOidc(
