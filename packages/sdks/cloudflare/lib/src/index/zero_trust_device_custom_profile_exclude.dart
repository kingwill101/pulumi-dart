...
class ZeroTrustDeviceCustomProfileExclude {
  ...
  /// Creates a new [ZeroTrustDeviceCustomProfileExclude].
  ...
  factory ZeroTrustDeviceCustomProfileExclude.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDeviceCustomProfileExclude(
