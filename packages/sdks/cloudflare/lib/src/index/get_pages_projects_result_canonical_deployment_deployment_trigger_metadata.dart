...
class GetPagesProjectsResultCanonicalDeploymentDeploymentTriggerMetadata {
  ...
  /// Creates a new [GetPagesProjectsResultCanonicalDeploymentDeploymentTriggerMetadata].
  ...
  const GetPagesProjectsResultCanonicalDeploymentDeploymentTriggerMetadata({
  ...
  factory GetPagesProjectsResultCanonicalDeploymentDeploymentTriggerMetadata.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultCanonicalDeploymentDeploymentTriggerMetadata(
