...
class AccessPolicyIncludeSaml {
  ...
  /// Creates a new [AccessPolicyIncludeSaml].
  ...
  factory AccessPolicyIncludeSaml.fromMap(Map<String, dynamic> map) {
    return AccessPolicyIncludeSaml(
