...
class PagesProjectLatestDeploymentDeploymentTriggerMetadata {
  ...
  /// Creates a new [PagesProjectLatestDeploymentDeploymentTriggerMetadata].
  ...
  const PagesProjectLatestDeploymentDeploymentTriggerMetadata({
    this.branch,
    this.commitDirty,
    this.commitHash,
    this.commitMessage,
  ...
  factory PagesProjectLatestDeploymentDeploymentTriggerMetadata.fromMap(Map<String, dynamic> map) {
    return PagesProjectLatestDeploymentDeploymentTriggerMetadata(
