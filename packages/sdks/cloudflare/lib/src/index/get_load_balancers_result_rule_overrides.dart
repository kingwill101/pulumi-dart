...
import 'get_load_balancers_result_rule_overrides_adaptive_routing.dart';
import 'get_load_balancers_result_rule_overrides_location_strategy.dart';
import 'get_load_balancers_result_rule_overrides_random_steering.dart';
import 'get_load_balancers_result_rule_overrides_session_affinity_attributes.dart';

class GetLoadBalancersResultRuleOverrides {
  /// Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin.
  final pulumi.Input<GetLoadBalancersResultRuleOverridesAdaptiveRouting> adaptiveRouting;
  ...
  final pulumi.Input<GetLoadBalancersResultRuleOverridesLocationStrategy> locationStrategy;
  ...
  final pulumi.Input<GetLoadBalancersResultRuleOverridesRandomSteering> randomSteering;
  ...
  final pulumi.Input<GetLoadBalancersResultRuleOverridesSessionAffinityAttributes> sessionAffinityAttributes;
  ...
  /// Creates a new [GetLoadBalancersResultRuleOverrides].
  /// [adaptiveRouting] Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in the same pool, the request is retried once against this alternate origin.
  ...
  const GetLoadBalancersResultRuleOverrides({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'adaptiveRouting': pulumi.Input.mapInputValue<GetLoadBalancersResultRuleOverridesAdaptiveRouting, Map<String, dynamic>>(adaptiveRouting, (value) => value.toMap()),
      'countryPools': countryPools,
      'defaultPools': defaultPools,
      'fallbackPool': fallbackPool,
      'locationStrategy': pulumi.Input.mapInputValue<GetLoadBalancersResultRuleOverridesLocationStrategy, Map<String, dynamic>>(locationStrategy, (value) => value.toMap()),
      'popPools': popPools,
      'randomSteering': pulumi.Input.mapInputValue<GetLoadBalancersResultRuleOverridesRandomSteering, Map<String, dynamic>>(randomSteering, (value) => value.toMap()),
      'regionPools': regionPools,
      'sessionAffinity': sessionAffinity,
      'sessionAffinityAttributes': pulumi.Input.mapInputValue<GetLoadBalancersResultRuleOverridesSessionAffinityAttributes, Map<String, dynamic>>(sessionAffinityAttributes, (value) => value.toMap()),
  ...
  factory GetLoadBalancersResultRuleOverrides.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersResultRuleOverrides(
      adaptiveRouting: pulumi.Input.fromValue(GetLoadBalancersResultRuleOverridesAdaptiveRouting.fromMap((map['adaptiveRouting']! as Map).cast<String, dynamic>())),
      ...
      locationStrategy: pulumi.Input.fromValue(GetLoadBalancersResultRuleOverridesLocationStrategy.fromMap((map['locationStrategy']! as Map).cast<String, dynamic>())),
      popPools: pulumi.Input.fromValue(pulumi.Input.decodeMapValues<List<String>>(map['popPools']!, (value) => (value as List).cast<String>())),
      randomSteering: pulumi.Input.fromValue(GetLoadBalancersResultRuleOverridesRandomSteering.fromMap((map['randomSteering']! as Map).cast<String, dynamic>())),
      ...
      sessionAffinityAttributes: pulumi.Input.fromValue(GetLoadBalancersResultRuleOverridesSessionAffinityAttributes.fromMap((map['sessionAffinityAttributes']! as Map).cast<String, dynamic>())),
