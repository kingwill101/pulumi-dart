...
class WorkersScript extends pulumi.CustomResource {
  ...
  late final pulumi.Output<Map<String, WorkersScriptFiles>?> files;
  ...
  WorkersScript(
    ...
    files = registerOutput<Map<String, WorkersScriptFiles>?>('files', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeMapValues<WorkersScriptFiles>(guardedValue, (value) => WorkersScriptFiles.fromMap((value as Map).cast<String, dynamic>())); });
