...
class GetZeroTrustAccessApplicationMfaConfig {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationMfaConfig].
  ...
  const GetZeroTrustAccessApplicationMfaConfig({
  ...
  factory GetZeroTrustAccessApplicationMfaConfig.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationMfaConfig(
