...
class GetZeroTrustDlpIntegrationEntriesResultVariant {
  ...
  /// Creates a new [GetZeroTrustDlpIntegrationEntriesResultVariant].
  ...
  const GetZeroTrustDlpIntegrationEntriesResultVariant({
  ...
  factory GetZeroTrustDlpIntegrationEntriesResultVariant.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpIntegrationEntriesResultVariant(
