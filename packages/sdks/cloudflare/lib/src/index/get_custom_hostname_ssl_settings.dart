...
class GetCustomHostnameSslSettings {
  ...
  /// Creates a new [GetCustomHostnameSslSettings].
  ...
  const GetCustomHostnameSslSettings({
  ...
  factory GetCustomHostnameSslSettings.fromMap(Map<String, dynamic> map) {
    return GetCustomHostnameSslSettings(
