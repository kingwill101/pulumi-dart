...
class GetDnsRecordFilterComment {
  ...
  /// Creates a new [GetDnsRecordFilterComment].
  ...
  const GetDnsRecordFilterComment({
    this.absent,
    this.contains,
    this.endswith,
    this.exact,
  ...
  factory GetDnsRecordFilterComment.fromMap(Map<String, dynamic> map) {
    return GetDnsRecordFilterComment(
