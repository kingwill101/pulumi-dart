...
class EmailRoutingDnsResultRecord {
  ...
  /// Creates a new [EmailRoutingDnsResultRecord].
  ...
  const EmailRoutingDnsResultRecord({
    this.content,
    this.name,
    this.priority,
    this.ttl,
  ...
  factory EmailRoutingDnsResultRecord.fromMap(Map<String, dynamic> map) {
    return EmailRoutingDnsResultRecord(
