...
import 'get_worker_version_binding_outbound.dart';
import 'get_worker_version_binding_simple.dart';

class GetWorkerVersionBinding {
  ...
  /// Outbound worker.
  final pulumi.Input<GetWorkerVersionBindingOutbound> outbound;
  ...
  final pulumi.Input<GetWorkerVersionBindingSimple> simple;
  ...
  /// Creates a new [GetWorkerVersionBinding].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'networkId': networkId,
      'oldName': oldName,
      'outbound': pulumi.Input.mapInputValue<GetWorkerVersionBindingOutbound, Map<String, dynamic>>(outbound, (value) => value.toMap()),
      'part': part,
      'pipeline': pipeline,
      'queueName': queueName,
      ...
      'service': service,
      'serviceId': serviceId,
      'simple': pulumi.Input.mapInputValue<GetWorkerVersionBindingSimple, Map<String, dynamic>>(simple, (value) => value.toMap()),
      'storeId': storeId,
      'text': text,
      'tunnelId': tunnelId,
      'type': type,
  ...
  factory GetWorkerVersionBinding.fromMap(Map<String, dynamic> map) {
    return GetWorkerVersionBinding(
      ...
      outbound: pulumi.Input.fromValue(GetWorkerVersionBindingOutbound.fromMap((map['outbound']! as Map).cast<String, dynamic>())),
      ...
      simple: pulumi.Input.fromValue(GetWorkerVersionBindingSimple.fromMap((map['simple']! as Map).cast<String, dynamic>())),
