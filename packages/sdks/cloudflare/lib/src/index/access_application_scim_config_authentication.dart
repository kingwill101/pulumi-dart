...
class AccessApplicationScimConfigAuthentication {
  ...
  /// Creates a new [AccessApplicationScimConfigAuthentication].
  ...
  const AccessApplicationScimConfigAuthentication({
  ...
  factory AccessApplicationScimConfigAuthentication.fromMap(Map<String, dynamic> map) {
    return AccessApplicationScimConfigAuthentication(
