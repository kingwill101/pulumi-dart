...
class ZeroTrustTunnelCloudflaredConnection {
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredConnection].
  ...
  const ZeroTrustTunnelCloudflaredConnection({
    this.clientId,
    this.clientVersion,
    this.coloName,
    this.id,
  ...
  factory ZeroTrustTunnelCloudflaredConnection.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelCloudflaredConnection(
