...
import 'zero_trust_tunnel_cloudflared_virtual_network_args.dart';
import 'zero_trust_tunnel_cloudflared_virtual_network_state.dart';
...
class ZeroTrustTunnelCloudflaredVirtualNetwork extends pulumi.CustomResource {
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredVirtualNetwork].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustTunnelCloudflaredVirtualNetwork]. {@macro pulumi_index_zero_trust_tunnel_cloudflared_virtual_network_zero_trust_tunnel_cloudflared_virtual_network_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustTunnelCloudflaredVirtualNetwork(
    String name, {
    ZeroTrustTunnelCloudflaredVirtualNetworkArgs? args,
  ...
  /// Gets an existing [ZeroTrustTunnelCloudflaredVirtualNetwork] resource's state with the given [name] and [id].
  static ZeroTrustTunnelCloudflaredVirtualNetwork get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustTunnelCloudflaredVirtualNetworkState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustTunnelCloudflaredVirtualNetwork._get(
      name,
      state: state?.toMap(),
  ...
  ZeroTrustTunnelCloudflaredVirtualNetwork._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ZeroTrustTunnelCloudflaredVirtualNetwork] resource.
  ZeroTrustTunnelCloudflaredVirtualNetwork.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustTunnelCloudflaredVirtualNetwork:ZeroTrustTunnelCloudflaredVirtualNetwork',
