...
import 'zero_trust_device_managed_networks_args.dart';
import 'zero_trust_device_managed_networks_config.dart';
import 'zero_trust_device_managed_networks_state.dart';
...
class ZeroTrustDeviceManagedNetworks extends pulumi.CustomResource {
  ...
  late final pulumi.Output<ZeroTrustDeviceManagedNetworksConfig> config;
  ...
  /// Creates a new [ZeroTrustDeviceManagedNetworks].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [ZeroTrustDeviceManagedNetworks]. {@macro pulumi_index_zero_trust_device_managed_networks_zero_trust_device_managed_networks_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  ZeroTrustDeviceManagedNetworks(
    String name, {
    ZeroTrustDeviceManagedNetworksArgs? args,
  ...
  /// Gets an existing [ZeroTrustDeviceManagedNetworks] resource's state with the given [name] and [id].
  static ZeroTrustDeviceManagedNetworks get(
    String name,
    pulumi.Input<String> id, {
    ZeroTrustDeviceManagedNetworksState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return ZeroTrustDeviceManagedNetworks._get(
      name,
      state: state?.toMap(),
  ...
  ZeroTrustDeviceManagedNetworks._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [ZeroTrustDeviceManagedNetworks] resource.
  ZeroTrustDeviceManagedNetworks.reference(String urn)
    : super(
        'cloudflare:index/zeroTrustDeviceManagedNetworks:ZeroTrustDeviceManagedNetworks',
