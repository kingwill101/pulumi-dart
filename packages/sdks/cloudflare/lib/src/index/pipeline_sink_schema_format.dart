...
class PipelineSinkSchemaFormat {
  ...
  /// Creates a new [PipelineSinkSchemaFormat].
  ...
  factory PipelineSinkSchemaFormat.fromMap(Map<String, dynamic> map) {
    return PipelineSinkSchemaFormat(
