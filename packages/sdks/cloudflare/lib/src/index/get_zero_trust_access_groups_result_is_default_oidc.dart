...
class GetZeroTrustAccessGroupsResultIsDefaultOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupsResultIsDefaultOidc].
  ...
  const GetZeroTrustAccessGroupsResultIsDefaultOidc({
  ...
  factory GetZeroTrustAccessGroupsResultIsDefaultOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupsResultIsDefaultOidc(
