...
class ZeroTrustAccessApplicationPolicyRequireOidc {
  ...
  /// Creates a new [ZeroTrustAccessApplicationPolicyRequireOidc].
  ...
  const ZeroTrustAccessApplicationPolicyRequireOidc({
  ...
  factory ZeroTrustAccessApplicationPolicyRequireOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationPolicyRequireOidc(
