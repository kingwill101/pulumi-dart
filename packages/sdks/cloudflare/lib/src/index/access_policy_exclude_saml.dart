...
class AccessPolicyExcludeSaml {
  ...
  /// Creates a new [AccessPolicyExcludeSaml].
  ...
  factory AccessPolicyExcludeSaml.fromMap(Map<String, dynamic> map) {
    return AccessPolicyExcludeSaml(
