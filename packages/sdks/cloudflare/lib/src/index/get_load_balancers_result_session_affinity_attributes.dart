...
class GetLoadBalancersResultSessionAffinityAttributes {
  ...
  /// Creates a new [GetLoadBalancersResultSessionAffinityAttributes].
  ...
  const GetLoadBalancersResultSessionAffinityAttributes({
  ...
  factory GetLoadBalancersResultSessionAffinityAttributes.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersResultSessionAffinityAttributes(
