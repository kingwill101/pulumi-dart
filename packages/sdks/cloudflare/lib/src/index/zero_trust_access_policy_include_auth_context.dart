...
class ZeroTrustAccessPolicyIncludeAuthContext {
  ...
  /// Creates a new [ZeroTrustAccessPolicyIncludeAuthContext].
  ...
  factory ZeroTrustAccessPolicyIncludeAuthContext.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyIncludeAuthContext(
