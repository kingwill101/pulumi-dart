...
import 'get_magic_wan_gre_tunnel_gre_tunnel_health_check_target.dart';

class GetMagicWanGreTunnelGreTunnelHealthCheck {
  ...
  final pulumi.Input<GetMagicWanGreTunnelGreTunnelHealthCheckTarget> target;
  /// The type of healthcheck to run, reply or request. The default value is `reply`.
  /// Available values: "reply", "request".
  final pulumi.Input<String> type;

  /// Creates a new [GetMagicWanGreTunnelGreTunnelHealthCheck].
  ...
  const GetMagicWanGreTunnelGreTunnelHealthCheck({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'enabled': enabled,
      'rate': rate,
      'target': pulumi.Input.mapInputValue<GetMagicWanGreTunnelGreTunnelHealthCheckTarget, Map<String, dynamic>>(target, (value) => value.toMap()),
      'type': type,
    };
  }

  factory GetMagicWanGreTunnelGreTunnelHealthCheck.fromMap(Map<String, dynamic> map) {
    return GetMagicWanGreTunnelGreTunnelHealthCheck(
      direction: pulumi.Input.fromValue(map['direction'] as String),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      rate: pulumi.Input.fromValue(map['rate'] as String),
      target: pulumi.Input.fromValue(GetMagicWanGreTunnelGreTunnelHealthCheckTarget.fromMap((map['target']! as Map).cast<String, dynamic>())),
