...
class GetZeroTrustDlpPredefinedEntryVariant {
  ...
  /// Creates a new [GetZeroTrustDlpPredefinedEntryVariant].
  ...
  const GetZeroTrustDlpPredefinedEntryVariant({
  ...
  factory GetZeroTrustDlpPredefinedEntryVariant.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpPredefinedEntryVariant(
