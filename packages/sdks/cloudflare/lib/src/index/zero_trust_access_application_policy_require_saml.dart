...
class ZeroTrustAccessApplicationPolicyRequireSaml {
  ...
  /// Creates a new [ZeroTrustAccessApplicationPolicyRequireSaml].
  ...
  const ZeroTrustAccessApplicationPolicyRequireSaml({
  ...
  factory ZeroTrustAccessApplicationPolicyRequireSaml.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationPolicyRequireSaml(
