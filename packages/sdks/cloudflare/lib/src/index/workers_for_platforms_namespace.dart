...
import 'workers_for_platforms_namespace_args.dart';
import 'workers_for_platforms_namespace_state.dart';
...
class WorkersForPlatformsNamespace extends pulumi.CustomResource {
  ...
  /// Creates a new [WorkersForPlatformsNamespace].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [WorkersForPlatformsNamespace]. {@macro pulumi_index_workers_for_platforms_namespace_workers_for_platforms_namespace_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  WorkersForPlatformsNamespace(
    String name, {
    WorkersForPlatformsNamespaceArgs? args,
  ...
  /// Gets an existing [WorkersForPlatformsNamespace] resource's state with the given [name] and [id].
  static WorkersForPlatformsNamespace get(
    String name,
    pulumi.Input<String> id, {
    WorkersForPlatformsNamespaceState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return WorkersForPlatformsNamespace._get(
      name,
      state: state?.toMap(),
  ...
  WorkersForPlatformsNamespace._get(
    String name, {
  ...
  /// Creates a typed reference to an existing [WorkersForPlatformsNamespace] resource.
  WorkersForPlatformsNamespace.reference(String urn)
    : super(
        'cloudflare:index/workersForPlatformsNamespace:WorkersForPlatformsNamespace',
