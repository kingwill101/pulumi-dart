...
import 'access_custom_page_args.dart';
import 'access_custom_page_state.dart';
...
class AccessCustomPage extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<AccessCustomPageWarning>> warnings;

  /// Creates a new [AccessCustomPage].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [AccessCustomPage]. {@macro pulumi_index_access_custom_page_access_custom_page_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  AccessCustomPage(
    String name, {
    AccessCustomPageArgs? args,
    ...
    warnings = registerOutput<List<AccessCustomPageWarning>>('warnings', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return pulumi.Input.decodeList<AccessCustomPageWarning>(guardedValue, (value) => AccessCustomPageWarning.fromMap((value as Map).cast<String, dynamic>())); });
  }

  /// Gets an existing [AccessCustomPage] resource's state with the given [name] and [id].
  static AccessCustomPage get(
    String name,
    pulumi.Input<String> id, {
    AccessCustomPageState? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return AccessCustomPage._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [AccessCustomPage] resource.
  AccessCustomPage.reference(String urn)
    : super(
        'cloudflare:index/accessCustomPage:AccessCustomPage',
