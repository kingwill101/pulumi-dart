...
class GetEmailRoutingDnsDn {
  ...
  /// Creates a new [GetEmailRoutingDnsDn].
  ...
  factory GetEmailRoutingDnsDn.fromMap(Map<String, dynamic> map) {
    return GetEmailRoutingDnsDn(
