...
class GetZeroTrustAccessGroupIsDefaultSaml {
  ...
  /// Creates a new [GetZeroTrustAccessGroupIsDefaultSaml].
  ...
  const GetZeroTrustAccessGroupIsDefaultSaml({
  ...
  factory GetZeroTrustAccessGroupIsDefaultSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupIsDefaultSaml(
