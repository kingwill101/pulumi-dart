...
/// {@template pulumi_index_access_identity_provider_access_identity_provider_args_doc}
/// The set of arguments for AccessIdentityProvider.
/// {@endtemplate}
/// {@macro pulumi_index_access_identity_provider_access_identity_provider_args_doc}
class AccessIdentityProviderArgs {
  ...
  /// Creates a new [AccessIdentityProviderArgs].
  ...
  const AccessIdentityProviderArgs({
    this.accountId,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'accountId': ?accountId,
      'config': pulumi.Input.mapInputValue<AccessIdentityProviderConfig, Map<String, dynamic>>(config, (value) => value.toMap()),
      'name': name,
      'readOnly': ?readOnly,
  ...
  factory AccessIdentityProviderArgs.fromMap(Map<String, dynamic> map) {
    return AccessIdentityProviderArgs(
      accountId: (() { final guardedValue = map['accountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      config: pulumi.Input.fromValue(AccessIdentityProviderConfig.fromMap((map['config']! as Map).cast<String, dynamic>())),
