...
class GetZeroTrustDeviceCustomProfileExclude {
  ...
  /// Creates a new [GetZeroTrustDeviceCustomProfileExclude].
  ...
  const GetZeroTrustDeviceCustomProfileExclude({
  ...
  factory GetZeroTrustDeviceCustomProfileExclude.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDeviceCustomProfileExclude(
