...
class GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt {
  ...
  /// Creates a new [GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt].
  /// [enabled] Required.
  /// [name] Required.
  ...
  const GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt({
  ...
  factory GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessAiControlsMcpPortalServerUpdatedPrompt(
