...
class GetPagesProjectCanonicalDeploymentBuildConfig {
  ...
  /// Creates a new [GetPagesProjectCanonicalDeploymentBuildConfig].
  ...
  const GetPagesProjectCanonicalDeploymentBuildConfig({
  ...
  factory GetPagesProjectCanonicalDeploymentBuildConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectCanonicalDeploymentBuildConfig(
