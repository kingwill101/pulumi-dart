...
class GetZeroTrustAccessPolicyExcludeSaml {
  ...
  /// Creates a new [GetZeroTrustAccessPolicyExcludeSaml].
  ...
  const GetZeroTrustAccessPolicyExcludeSaml({
  ...
  factory GetZeroTrustAccessPolicyExcludeSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPolicyExcludeSaml(
