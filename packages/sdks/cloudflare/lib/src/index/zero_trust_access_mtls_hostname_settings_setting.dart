...
class ZeroTrustAccessMtlsHostnameSettingsSetting {
  ...
  /// Creates a new [ZeroTrustAccessMtlsHostnameSettingsSetting].
  ...
  const ZeroTrustAccessMtlsHostnameSettingsSetting({
  ...
  factory ZeroTrustAccessMtlsHostnameSettingsSetting.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessMtlsHostnameSettingsSetting(
