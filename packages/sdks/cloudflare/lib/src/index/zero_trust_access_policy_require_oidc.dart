...
class ZeroTrustAccessPolicyRequireOidc {
  ...
  /// Creates a new [ZeroTrustAccessPolicyRequireOidc].
  ...
  factory ZeroTrustAccessPolicyRequireOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyRequireOidc(
