...
import 'get_load_balancer_rule_fixed_response.dart';
import 'get_load_balancer_rule_overrides.dart';

class GetLoadBalancerRule {
  ...
  final pulumi.Input<GetLoadBalancerRuleFixedResponse> fixedResponse;
  /// Name of this rule. Only used for human readability.
  final pulumi.Input<String> name;
  /// A collection of overrides to apply to the load balancer when this rule's condition is true. All fields are optional.
  final pulumi.Input<GetLoadBalancerRuleOverrides> overrides;
  ...
  /// Creates a new [GetLoadBalancerRule].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'condition': condition,
      'disabled': disabled,
      'fixedResponse': pulumi.Input.mapInputValue<GetLoadBalancerRuleFixedResponse, Map<String, dynamic>>(fixedResponse, (value) => value.toMap()),
      'name': name,
      'overrides': pulumi.Input.mapInputValue<GetLoadBalancerRuleOverrides, Map<String, dynamic>>(overrides, (value) => value.toMap()),
      'priority': priority,
      'terminates': terminates,
    };
  }

  factory GetLoadBalancerRule.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerRule(
