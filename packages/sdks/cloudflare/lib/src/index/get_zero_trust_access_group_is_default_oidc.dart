...
class GetZeroTrustAccessGroupIsDefaultOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupIsDefaultOidc].
  ...
  const GetZeroTrustAccessGroupIsDefaultOidc({
  ...
  factory GetZeroTrustAccessGroupIsDefaultOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupIsDefaultOidc(
