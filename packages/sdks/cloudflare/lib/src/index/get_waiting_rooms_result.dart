...
import 'get_waiting_rooms_result_additional_route.dart';
import 'get_waiting_rooms_result_cookie_attributes.dart';
...
class GetWaitingRoomsResult {
  ...
  final pulumi.Input<List<GetWaitingRoomsResultAdditionalRoute>> additionalRoutes;
  /// Configures cookie attributes for the waiting room cookie. This encrypted cookie stores a user's status in the waiting room, such as queue position.
  final pulumi.Input<GetWaitingRoomsResultCookieAttributes> cookieAttributes;
  ...
  final pulumi.Input<String> nextEventPrequeueStartTime;
  /// An ISO 8601 timestamp that marks when the next event will start.
  final pulumi.Input<String> nextEventStartTime;
  ...
  /// Creates a new [GetWaitingRoomsResult].
  ...
  const GetWaitingRoomsResult({
    required this.additionalRoutes,
    required this.cookieAttributes,
    required this.cookieSuffix,
    required this.createdOn,
    required this.customPageHtml,
    required this.defaultTemplateLanguage,
    required this.description,
    required this.disableSessionRenewal,
    required this.enabledOriginCommands,
    required this.host,
    required this.id,
    required this.jsonResponseEnabled,
    required this.modifiedOn,
    required this.name,
    required this.newUsersPerMinute,
    required this.nextEventPrequeueStartTime,
    required this.nextEventStartTime,
    required this.path,
    required this.queueAll,
    required this.queueingMethod,
    required this.queueingStatusCode,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalRoutes': pulumi.Input.mapInputValue<List<GetWaitingRoomsResultAdditionalRoute>, List<Map<String, dynamic>>>(additionalRoutes, (value) => pulumi.Input.encodeList<GetWaitingRoomsResultAdditionalRoute, Map<String, dynamic>>(value, (value) => value.toMap())),
      'cookieAttributes': pulumi.Input.mapInputValue<GetWaitingRoomsResultCookieAttributes, Map<String, dynamic>>(cookieAttributes, (value) => value.toMap()),
  ...
  factory GetWaitingRoomsResult.fromMap(Map<String, dynamic> map) {
    return GetWaitingRoomsResult(
      additionalRoutes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetWaitingRoomsResultAdditionalRoute>(map['additionalRoutes']!, (value) => GetWaitingRoomsResultAdditionalRoute.fromMap((value as Map).cast<String, dynamic>()))),
      cookieAttributes: pulumi.Input.fromValue(GetWaitingRoomsResultCookieAttributes.fromMap((map['cookieAttributes']! as Map).cast<String, dynamic>())),
      cookieSuffix: pulumi.Input.fromValue(map['cookieSuffix'] as String),
      ...
      defaultTemplateLanguage: pulumi.Input.fromValue(map['defaultTemplateLanguage'] as String),
      description: pulumi.Input.fromValue(map['description'] as String),
      disableSessionRenewal: pulumi.Input.fromValue(map['disableSessionRenewal'] as bool),
      enabledOriginCommands: pulumi.Input.fromValue((map['enabledOriginCommands'] as List).cast<String>()),
