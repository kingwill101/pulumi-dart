...
class ZeroTrustAccessGroupIncludeAuthContext {
  ...
  /// Creates a new [ZeroTrustAccessGroupIncludeAuthContext].
  ...
  factory ZeroTrustAccessGroupIncludeAuthContext.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupIncludeAuthContext(
