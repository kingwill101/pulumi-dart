...
class GetLoadBalancerPoolResult {
  ...
  factory GetLoadBalancerPoolResult.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerPoolResult(
      ...
      minimumOrigins: (() { final guardedValue = map['minimumOrigins']; if (guardedValue == null) return null; return ((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(guardedValue); })(),
