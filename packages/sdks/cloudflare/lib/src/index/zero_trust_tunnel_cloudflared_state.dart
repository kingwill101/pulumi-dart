...
class ZeroTrustTunnelCloudflaredState {
  ...
  final pulumi.Input<List<ZeroTrustTunnelCloudflaredConnection>?>? connections;
  ...
  /// Creates a new [ZeroTrustTunnelCloudflaredState].
  ...
  const ZeroTrustTunnelCloudflaredState({
    this.accountId,
    this.accountTag,
    this.configSrc,
    this.connections,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'configSrc': ?configSrc,
      'connections': ?pulumi.Input.mapOptionalInputValue<List<ZeroTrustTunnelCloudflaredConnection>, List<Map<String, dynamic>>>(connections, (value) => pulumi.Input.encodeList<ZeroTrustTunnelCloudflaredConnection, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory ZeroTrustTunnelCloudflaredState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustTunnelCloudflaredState(
      ...
      connections: (() { final guardedValue = map['connections']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ZeroTrustTunnelCloudflaredConnection>(guardedValue, (value) => ZeroTrustTunnelCloudflaredConnection.fromMap((value as Map).cast<String, dynamic>()))); })(),
