...
class ZeroTrustAccessGroupExcludeGithubOrganization {
  ...
  /// Creates a new [ZeroTrustAccessGroupExcludeGithubOrganization].
  ...
  factory ZeroTrustAccessGroupExcludeGithubOrganization.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupExcludeGithubOrganization(
