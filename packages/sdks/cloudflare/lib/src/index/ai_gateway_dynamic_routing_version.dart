...
class AiGatewayDynamicRoutingVersion {
  ...
  /// Creates a new [AiGatewayDynamicRoutingVersion].
  /// [active] Available values: "true", "false".
  /// [createdAt] Optional.
  /// [data] Optional.
  /// [isValid] Optional.
  /// [versionId] Optional.
  const AiGatewayDynamicRoutingVersion({
    this.active,
    this.createdAt,
    this.data,
    this.isValid,
  ...
  factory AiGatewayDynamicRoutingVersion.fromMap(Map<String, dynamic> map) {
    return AiGatewayDynamicRoutingVersion(
