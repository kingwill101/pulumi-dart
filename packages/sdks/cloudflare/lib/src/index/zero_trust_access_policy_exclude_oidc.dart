...
class ZeroTrustAccessPolicyExcludeOidc {
  ...
  /// Creates a new [ZeroTrustAccessPolicyExcludeOidc].
  ...
  factory ZeroTrustAccessPolicyExcludeOidc.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyExcludeOidc(
