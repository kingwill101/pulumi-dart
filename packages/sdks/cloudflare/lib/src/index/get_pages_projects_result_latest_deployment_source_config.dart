...
class GetPagesProjectsResultLatestDeploymentSourceConfig {
  ...
  /// Creates a new [GetPagesProjectsResultLatestDeploymentSourceConfig].
  ...
  const GetPagesProjectsResultLatestDeploymentSourceConfig({
  ...
  factory GetPagesProjectsResultLatestDeploymentSourceConfig.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectsResultLatestDeploymentSourceConfig(
