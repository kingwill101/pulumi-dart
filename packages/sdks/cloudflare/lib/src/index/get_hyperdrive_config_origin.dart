...
class GetHyperdriveConfigOrigin {
  ...
  /// Creates a new [GetHyperdriveConfigOrigin].
  ...
  const GetHyperdriveConfigOrigin({
  ...
  factory GetHyperdriveConfigOrigin.fromMap(Map<String, dynamic> map) {
    return GetHyperdriveConfigOrigin(
