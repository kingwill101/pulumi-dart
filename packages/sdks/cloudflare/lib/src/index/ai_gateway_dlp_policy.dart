...
class AiGatewayDlpPolicy {
  ...
  /// Creates a new [AiGatewayDlpPolicy].
  /// [action] Available values: "FLAG", "BLOCK".
  /// [checks] Required.
  /// [enabled] Required.
  /// [id] Required.
  /// [profiles] Required.
  const AiGatewayDlpPolicy({
  ...
  factory AiGatewayDlpPolicy.fromMap(Map<String, dynamic> map) {
    return AiGatewayDlpPolicy(
