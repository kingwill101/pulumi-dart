...
class ZeroTrustAccessApplicationDestination {
  ...
  factory ZeroTrustAccessApplicationDestination.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationDestination(
