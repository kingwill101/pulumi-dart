...
import 'get_load_balancer_pool_origin_header.dart';

class GetLoadBalancerPoolOrigin {
  ...
  final pulumi.Input<GetLoadBalancerPoolOriginHeader> header;
  ...
  /// Creates a new [GetLoadBalancerPoolOrigin].
  ...
  const GetLoadBalancerPoolOrigin({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'header': pulumi.Input.mapInputValue<GetLoadBalancerPoolOriginHeader, Map<String, dynamic>>(header, (value) => value.toMap()),
      'name': name,
      'port': port,
  ...
  factory GetLoadBalancerPoolOrigin.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerPoolOrigin(
