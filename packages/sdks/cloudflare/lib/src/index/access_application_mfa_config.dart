...
class AccessApplicationMfaConfig {
  ...
  /// Creates a new [AccessApplicationMfaConfig].
  ...
  const AccessApplicationMfaConfig({
  ...
  factory AccessApplicationMfaConfig.fromMap(Map<String, dynamic> map) {
    return AccessApplicationMfaConfig(
