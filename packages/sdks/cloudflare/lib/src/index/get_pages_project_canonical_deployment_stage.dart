...
class GetPagesProjectCanonicalDeploymentStage {
  ...
  /// Creates a new [GetPagesProjectCanonicalDeploymentStage].
  ...
  const GetPagesProjectCanonicalDeploymentStage({
  ...
  factory GetPagesProjectCanonicalDeploymentStage.fromMap(Map<String, dynamic> map) {
    return GetPagesProjectCanonicalDeploymentStage(
