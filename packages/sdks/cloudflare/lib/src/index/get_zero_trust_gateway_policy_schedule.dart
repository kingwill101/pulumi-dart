...
class GetZeroTrustGatewayPolicySchedule {
  ...
  /// Creates a new [GetZeroTrustGatewayPolicySchedule].
  ...
  const GetZeroTrustGatewayPolicySchedule({
    required this.fri,
    required this.mon,
    required this.sat,
    required this.sun,
  ...
  factory GetZeroTrustGatewayPolicySchedule.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustGatewayPolicySchedule(
