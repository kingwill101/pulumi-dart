...
class GetWorkerObservabilityTraces {
  ...
  /// Creates a new [GetWorkerObservabilityTraces].
  ...
  const GetWorkerObservabilityTraces({
  ...
  factory GetWorkerObservabilityTraces.fromMap(Map<String, dynamic> map) {
    return GetWorkerObservabilityTraces(
