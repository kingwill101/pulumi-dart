...
class GetSpectrumApplicationEdgeIps {
  ...
  /// Creates a new [GetSpectrumApplicationEdgeIps].
  ...
  const GetSpectrumApplicationEdgeIps({
  ...
  factory GetSpectrumApplicationEdgeIps.fromMap(Map<String, dynamic> map) {
    return GetSpectrumApplicationEdgeIps(
