...
class TeamsAccountSettingsAntivirusNotificationSettings {
  ...
  /// Creates a new [TeamsAccountSettingsAntivirusNotificationSettings].
  ...
  const TeamsAccountSettingsAntivirusNotificationSettings({
    this.enabled,
    this.includeContext,
    this.msg,
    this.supportUrl,
  ...
  factory TeamsAccountSettingsAntivirusNotificationSettings.fromMap(Map<String, dynamic> map) {
    return TeamsAccountSettingsAntivirusNotificationSettings(
