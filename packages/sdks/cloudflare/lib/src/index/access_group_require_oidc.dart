...
class AccessGroupRequireOidc {
  ...
  /// Creates a new [AccessGroupRequireOidc].
  ...
  factory AccessGroupRequireOidc.fromMap(Map<String, dynamic> map) {
    return AccessGroupRequireOidc(
