...
class GetZeroTrustAccessGroupRequireOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupRequireOidc].
  ...
  const GetZeroTrustAccessGroupRequireOidc({
  ...
  factory GetZeroTrustAccessGroupRequireOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupRequireOidc(
