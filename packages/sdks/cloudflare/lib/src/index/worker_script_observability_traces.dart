...
class WorkerScriptObservabilityTraces {
  ...
  /// Creates a new [WorkerScriptObservabilityTraces].
  ...
  const WorkerScriptObservabilityTraces({
    this.destinations,
    this.enabled,
  ...
  factory WorkerScriptObservabilityTraces.fromMap(Map<String, dynamic> map) {
    return WorkerScriptObservabilityTraces(
