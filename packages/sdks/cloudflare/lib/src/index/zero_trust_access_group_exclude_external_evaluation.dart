...
class ZeroTrustAccessGroupExcludeExternalEvaluation {
  ...
  /// Creates a new [ZeroTrustAccessGroupExcludeExternalEvaluation].
  ...
  factory ZeroTrustAccessGroupExcludeExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupExcludeExternalEvaluation(
