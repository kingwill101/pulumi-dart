...
class GetZeroTrustDeviceDefaultProfileExclude {
  ...
  /// Creates a new [GetZeroTrustDeviceDefaultProfileExclude].
  ...
  const GetZeroTrustDeviceDefaultProfileExclude({
  ...
  factory GetZeroTrustDeviceDefaultProfileExclude.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDeviceDefaultProfileExclude(
