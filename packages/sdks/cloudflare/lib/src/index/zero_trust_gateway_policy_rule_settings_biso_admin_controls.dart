...
class ZeroTrustGatewayPolicyRuleSettingsBisoAdminControls {
  ...
  /// Creates a new [ZeroTrustGatewayPolicyRuleSettingsBisoAdminControls].
  ...
  factory ZeroTrustGatewayPolicyRuleSettingsBisoAdminControls.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewayPolicyRuleSettingsBisoAdminControls(
