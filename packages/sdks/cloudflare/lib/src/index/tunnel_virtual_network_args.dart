...
/// {@template pulumi_index_tunnel_virtual_network_tunnel_virtual_network_args_doc}
/// The set of arguments for TunnelVirtualNetwork.
/// {@endtemplate}
/// {@macro pulumi_index_tunnel_virtual_network_tunnel_virtual_network_args_doc}
class TunnelVirtualNetworkArgs {
  ...
  /// Creates a new [TunnelVirtualNetworkArgs].
  ...
  const TunnelVirtualNetworkArgs({
  ...
  factory TunnelVirtualNetworkArgs.fromMap(Map<String, dynamic> map) {
    return TunnelVirtualNetworkArgs(
