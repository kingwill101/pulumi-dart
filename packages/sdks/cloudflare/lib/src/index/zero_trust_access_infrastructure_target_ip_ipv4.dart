...
class ZeroTrustAccessInfrastructureTargetIpIpv4 {
  ...
  /// Creates a new [ZeroTrustAccessInfrastructureTargetIpIpv4].
  ...
  factory ZeroTrustAccessInfrastructureTargetIpIpv4.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessInfrastructureTargetIpIpv4(
