...
class GetZeroTrustAccessPoliciesResultIncludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessPoliciesResultIncludeOidc].
  ...
  const GetZeroTrustAccessPoliciesResultIncludeOidc({
  ...
  factory GetZeroTrustAccessPoliciesResultIncludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPoliciesResultIncludeOidc(
