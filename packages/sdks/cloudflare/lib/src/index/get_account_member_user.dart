...
class GetAccountMemberUser {
  ...
  /// Creates a new [GetAccountMemberUser].
  ...
  factory GetAccountMemberUser.fromMap(Map<String, dynamic> map) {
    return GetAccountMemberUser(
