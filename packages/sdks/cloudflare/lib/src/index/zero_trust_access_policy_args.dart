...
/// {@template pulumi_index_zero_trust_access_policy_zero_trust_access_policy_args_doc}
/// The set of arguments for ZeroTrustAccessPolicy.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_access_policy_zero_trust_access_policy_args_doc}
class ZeroTrustAccessPolicyArgs {
  ...
  /// Creates a new [ZeroTrustAccessPolicyArgs].
  ...
  const ZeroTrustAccessPolicyArgs({
  ...
  factory ZeroTrustAccessPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessPolicyArgs(
