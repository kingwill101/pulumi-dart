...
class WorkersScriptObservabilityLogs {
  ...
  /// Creates a new [WorkersScriptObservabilityLogs].
  ...
  factory WorkersScriptObservabilityLogs.fromMap(Map<String, dynamic> map) {
    return WorkersScriptObservabilityLogs(
