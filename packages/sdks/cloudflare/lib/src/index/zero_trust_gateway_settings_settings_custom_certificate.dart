...
class ZeroTrustGatewaySettingsSettingsCustomCertificate {
  ...
  /// Creates a new [ZeroTrustGatewaySettingsSettingsCustomCertificate].
  ...
  factory ZeroTrustGatewaySettingsSettingsCustomCertificate.fromMap(Map<String, dynamic> map) {
    return ZeroTrustGatewaySettingsSettingsCustomCertificate(
