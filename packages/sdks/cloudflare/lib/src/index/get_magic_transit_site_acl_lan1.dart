...
class GetMagicTransitSiteAclLan1 {
  ...
  /// Creates a new [GetMagicTransitSiteAclLan1].
  ...
  const GetMagicTransitSiteAclLan1({
    required this.lanId,
  ...
  factory GetMagicTransitSiteAclLan1.fromMap(Map<String, dynamic> map) {
    return GetMagicTransitSiteAclLan1(
