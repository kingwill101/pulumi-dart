...
class GetAccountDnsSettingsZoneDefaultsSoa {
  ...
  /// Creates a new [GetAccountDnsSettingsZoneDefaultsSoa].
  ...
  const GetAccountDnsSettingsZoneDefaultsSoa({
  ...
  factory GetAccountDnsSettingsZoneDefaultsSoa.fromMap(Map<String, dynamic> map) {
    return GetAccountDnsSettingsZoneDefaultsSoa(
