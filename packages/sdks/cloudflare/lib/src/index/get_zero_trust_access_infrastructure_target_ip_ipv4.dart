...
class GetZeroTrustAccessInfrastructureTargetIpIpv4 {
  /// IP address of the target
  final pulumi.Input<String> ipAddr;
  /// (optional) Private virtual network identifier for the target. If omitted, the default virtual network ID will be used.
  final pulumi.Input<String> virtualNetworkId;

  /// Creates a new [GetZeroTrustAccessInfrastructureTargetIpIpv4].
  ...
  const GetZeroTrustAccessInfrastructureTargetIpIpv4({
  ...
  factory GetZeroTrustAccessInfrastructureTargetIpIpv4.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessInfrastructureTargetIpIpv4(
