...
class GetZeroTrustGatewayPolicyRuleSettingsNotificationSettings {
  /// Enable notification.
  ...
  /// Creates a new [GetZeroTrustGatewayPolicyRuleSettingsNotificationSettings].
  ...
  const GetZeroTrustGatewayPolicyRuleSettingsNotificationSettings({
  ...
  factory GetZeroTrustGatewayPolicyRuleSettingsNotificationSettings.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustGatewayPolicyRuleSettingsNotificationSettings(
