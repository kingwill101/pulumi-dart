...
class GetLoadBalancerRuleOverridesSessionAffinityAttributes {
  ...
  /// Creates a new [GetLoadBalancerRuleOverridesSessionAffinityAttributes].
  ...
  const GetLoadBalancerRuleOverridesSessionAffinityAttributes({
  ...
  factory GetLoadBalancerRuleOverridesSessionAffinityAttributes.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerRuleOverridesSessionAffinityAttributes(
