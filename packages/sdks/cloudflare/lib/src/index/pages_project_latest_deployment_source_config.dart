...
class PagesProjectLatestDeploymentSourceConfig {
  ...
  /// Creates a new [PagesProjectLatestDeploymentSourceConfig].
  ...
  const PagesProjectLatestDeploymentSourceConfig({
  ...
  factory PagesProjectLatestDeploymentSourceConfig.fromMap(Map<String, dynamic> map) {
    return PagesProjectLatestDeploymentSourceConfig(
