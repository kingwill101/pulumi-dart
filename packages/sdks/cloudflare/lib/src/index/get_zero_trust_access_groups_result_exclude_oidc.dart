...
class GetZeroTrustAccessGroupsResultExcludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessGroupsResultExcludeOidc].
  ...
  const GetZeroTrustAccessGroupsResultExcludeOidc({
  ...
  factory GetZeroTrustAccessGroupsResultExcludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessGroupsResultExcludeOidc(
