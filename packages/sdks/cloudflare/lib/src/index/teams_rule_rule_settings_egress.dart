...
class TeamsRuleRuleSettingsEgress {
  ...
  /// Creates a new [TeamsRuleRuleSettingsEgress].
  ...
  const TeamsRuleRuleSettingsEgress({
    this.ipv4,
    this.ipv4Fallback,
    this.ipv6,
  });
  ...
  factory TeamsRuleRuleSettingsEgress.fromMap(Map<String, dynamic> map) {
    return TeamsRuleRuleSettingsEgress(
