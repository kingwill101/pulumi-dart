...
class ZeroTrustAccessGroupRequireGithubOrganization {
  ...
  /// Creates a new [ZeroTrustAccessGroupRequireGithubOrganization].
  ...
  factory ZeroTrustAccessGroupRequireGithubOrganization.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupRequireGithubOrganization(
