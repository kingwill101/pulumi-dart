...
class GetAiSearchInstanceRetrievalOptionsBoostBy {
  ...
  /// Creates a new [GetAiSearchInstanceRetrievalOptionsBoostBy].
  ...
  const GetAiSearchInstanceRetrievalOptionsBoostBy({
  ...
  factory GetAiSearchInstanceRetrievalOptionsBoostBy.fromMap(Map<String, dynamic> map) {
    return GetAiSearchInstanceRetrievalOptionsBoostBy(
