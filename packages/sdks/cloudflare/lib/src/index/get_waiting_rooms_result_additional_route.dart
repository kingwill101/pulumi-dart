...
class GetWaitingRoomsResultAdditionalRoute {
  ...
  /// Creates a new [GetWaitingRoomsResultAdditionalRoute].
  ...
  const GetWaitingRoomsResultAdditionalRoute({
    required this.host,
    required this.path,
  });
  ...
  factory GetWaitingRoomsResultAdditionalRoute.fromMap(Map<String, dynamic> map) {
    return GetWaitingRoomsResultAdditionalRoute(
