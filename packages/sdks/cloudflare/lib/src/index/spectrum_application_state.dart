...
class SpectrumApplicationState {
  ...
  /// Creates a new [SpectrumApplicationState].
  ...
  const SpectrumApplicationState({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'createdOn': ?createdOn,
      'dns': ?pulumi.Input.mapOptionalInputValue<SpectrumApplicationDns, Map<String, dynamic>>(dns, (value) => value.toMap()),
  ...
  factory SpectrumApplicationState.fromMap(Map<String, dynamic> map) {
    return SpectrumApplicationState(
      ...
      dns: (() { final guardedValue = map['dns']; if (guardedValue == null) return null; return pulumi.Input.fromValue(SpectrumApplicationDns.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
