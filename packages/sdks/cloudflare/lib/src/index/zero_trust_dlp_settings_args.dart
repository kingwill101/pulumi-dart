...
/// {@template pulumi_index_zero_trust_dlp_settings_zero_trust_dlp_settings_args_doc}
/// The set of arguments for ZeroTrustDlpSettings.
/// {@endtemplate}
/// {@macro pulumi_index_zero_trust_dlp_settings_zero_trust_dlp_settings_args_doc}
class ZeroTrustDlpSettingsArgs {
  ...
  /// Creates a new [ZeroTrustDlpSettingsArgs].
  /// [accountId] Required.
  ...
  const ZeroTrustDlpSettingsArgs({
  ...
  factory ZeroTrustDlpSettingsArgs.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDlpSettingsArgs(
