...
class AccessGroupRequireExternalEvaluation {
  ...
  /// Creates a new [AccessGroupRequireExternalEvaluation].
  ...
  const AccessGroupRequireExternalEvaluation({
  ...
  factory AccessGroupRequireExternalEvaluation.fromMap(Map<String, dynamic> map) {
    return AccessGroupRequireExternalEvaluation(
