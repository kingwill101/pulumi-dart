...
class ZeroTrustAccessGroupExcludeOkta {
  ...
  /// Creates a new [ZeroTrustAccessGroupExcludeOkta].
  ...
  factory ZeroTrustAccessGroupExcludeOkta.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupExcludeOkta(
