...
class ZeroTrustDevicePostureRuleState {
  ...
  /// Creates a new [ZeroTrustDevicePostureRuleState].
  /// [accountId] Optional.
  ...
  const ZeroTrustDevicePostureRuleState({
    this.accountId,
    this.description,
    this.enabled,
    this.expiration,
  ...
  factory ZeroTrustDevicePostureRuleState.fromMap(Map<String, dynamic> map) {
    return ZeroTrustDevicePostureRuleState(
