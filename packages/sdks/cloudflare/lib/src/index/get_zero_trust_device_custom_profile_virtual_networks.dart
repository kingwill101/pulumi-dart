...
class GetZeroTrustDeviceCustomProfileVirtualNetworks {
  ...
  /// Creates a new [GetZeroTrustDeviceCustomProfileVirtualNetworks].
  ...
  const GetZeroTrustDeviceCustomProfileVirtualNetworks({
  ...
  factory GetZeroTrustDeviceCustomProfileVirtualNetworks.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDeviceCustomProfileVirtualNetworks(
