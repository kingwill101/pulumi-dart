...
import 'get_custom_ssls_result_keyless_server_tunnel.dart';

class GetCustomSslsResultKeylessServer {
  ...
  final pulumi.Input<GetCustomSslsResultKeylessServerTunnel> tunnel;

  /// Creates a new [GetCustomSslsResultKeylessServer].
  ...
  const GetCustomSslsResultKeylessServer({
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'port': port,
      'status': status,
      'tunnel': pulumi.Input.mapInputValue<GetCustomSslsResultKeylessServerTunnel, Map<String, dynamic>>(tunnel, (value) => value.toMap()),
    };
  }

  factory GetCustomSslsResultKeylessServer.fromMap(Map<String, dynamic> map) {
    return GetCustomSslsResultKeylessServer(
      ...
      tunnel: pulumi.Input.fromValue(GetCustomSslsResultKeylessServerTunnel.fromMap((map['tunnel']! as Map).cast<String, dynamic>())),
    );
  }
}
