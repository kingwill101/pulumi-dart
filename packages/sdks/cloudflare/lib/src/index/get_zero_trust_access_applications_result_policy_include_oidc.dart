...
class GetZeroTrustAccessApplicationsResultPolicyIncludeOidc {
  ...
  /// Creates a new [GetZeroTrustAccessApplicationsResultPolicyIncludeOidc].
  ...
  const GetZeroTrustAccessApplicationsResultPolicyIncludeOidc({
  ...
  factory GetZeroTrustAccessApplicationsResultPolicyIncludeOidc.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessApplicationsResultPolicyIncludeOidc(
