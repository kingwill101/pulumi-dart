...
class GetHealthchecksResult {
  ...
  factory GetHealthchecksResult.fromMap(Map<String, dynamic> map) {
    return GetHealthchecksResult(
      ...
      consecutiveFails: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['consecutiveFails'])),
      consecutiveSuccesses: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['consecutiveSuccesses'])),
