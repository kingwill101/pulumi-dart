...
class GetRulesetsRuleset {
  ...
  /// Creates a new [GetRulesetsRuleset].
  ...
  factory GetRulesetsRuleset.fromMap(Map<String, dynamic> map) {
    return GetRulesetsRuleset(
