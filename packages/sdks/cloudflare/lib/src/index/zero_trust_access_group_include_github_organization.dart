...
class ZeroTrustAccessGroupIncludeGithubOrganization {
  ...
  /// Creates a new [ZeroTrustAccessGroupIncludeGithubOrganization].
  ...
  factory ZeroTrustAccessGroupIncludeGithubOrganization.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessGroupIncludeGithubOrganization(
