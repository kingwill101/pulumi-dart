...
class GetZeroTrustDlpPredefinedEntryConfidence {
  ...
  const GetZeroTrustDlpPredefinedEntryConfidence({
  ...
  factory GetZeroTrustDlpPredefinedEntryConfidence.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustDlpPredefinedEntryConfidence(
