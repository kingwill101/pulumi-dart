...
class ZeroTrustAccessApplicationPolicyMfaConfig {
  ...
  /// Creates a new [ZeroTrustAccessApplicationPolicyMfaConfig].
  ...
  const ZeroTrustAccessApplicationPolicyMfaConfig({
  ...
  factory ZeroTrustAccessApplicationPolicyMfaConfig.fromMap(Map<String, dynamic> map) {
    return ZeroTrustAccessApplicationPolicyMfaConfig(
