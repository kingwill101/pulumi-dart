...
class GetZeroTrustAccessPolicyRequireSaml {
  ...
  /// Creates a new [GetZeroTrustAccessPolicyRequireSaml].
  ...
  const GetZeroTrustAccessPolicyRequireSaml({
  ...
  factory GetZeroTrustAccessPolicyRequireSaml.fromMap(Map<String, dynamic> map) {
    return GetZeroTrustAccessPolicyRequireSaml(
