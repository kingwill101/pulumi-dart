  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules': ?(() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.encodeList<GetFirewallRule, Map<String, dynamic>>(
          guardedValue,
          (value) => value.toMap(),
        );
      })(),
  ...
  factory GetFirewallResult.fromMap(Map<String, dynamic> map) {
    return GetFirewallResult(
      applyTos: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetFirewallApplyTo>(
          guardedValue,
          (value) => GetFirewallApplyTo.fromMap(
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.decodeList<GetFirewallRule>(
          guardedValue,
          (value) =>
              GetFirewallRule.fromMap((value as Map).cast<String, dynamic>()),
        );
      })(),
      withSelector: (() {
