...
class GetZoneRrsetsResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'id': id,
      'rrsets':
          pulumi.Input.encodeList<GetZoneRrsetsRrset, Map<String, dynamic>>(
            rrsets,
            (value) => value.toMap(),
          ),
  ...
  factory GetZoneRrsetsResult.fromMap(Map<String, dynamic> map) {
    return GetZoneRrsetsResult(
      id: map['id'] as String,
      rrsets: pulumi.Input.decodeList<GetZoneRrsetsRrset>(
        map['rrsets']!,
        (value) =>
            GetZoneRrsetsRrset.fromMap((value as Map).cast<String, dynamic>()),
      ),
      withSelector: (() {
