...
class ZoneState {
    ...
    return <String, dynamic>{
      'authoritativeNameservers':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(authoritativeNameservers, (value) => value.toMap()),
  ...
  factory ZoneState.fromMap(Map<String, dynamic> map) {
    return ZoneState(
      authoritativeNameservers: (() {
        final guardedValue = map['authoritativeNameservers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ZoneAuthoritativeNameservers.fromMap(
      ...
      primaryNameservers: (() {
        final guardedValue = map['primaryNameservers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ZonePrimaryNameserver>(
            guardedValue,
            (value) => ZonePrimaryNameserver.fromMap(
