...
class GetZoneRrsetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'name': ?name,
      'records':
          pulumi.Input.encodeList<GetZoneRrsetRecord, Map<String, dynamic>>(
            records,
            (value) => value.toMap(),
          ),
      'ttl': ttl,
  ...
  factory GetZoneRrsetResult.fromMap(Map<String, dynamic> map) {
    return GetZoneRrsetResult(
      ...
      records: pulumi.Input.decodeList<GetZoneRrsetRecord>(
        map['records']!,
        (value) =>
            GetZoneRrsetRecord.fromMap((value as Map).cast<String, dynamic>()),
      ),
      ttl: map['ttl'] as int,
      type: (() {
