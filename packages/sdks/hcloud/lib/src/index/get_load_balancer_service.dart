    ...
    return <String, dynamic>{
      ...
      'healthChecks':
          pulumi.Input.mapInputValue<
            List<GetLoadBalancerServiceHealthCheck>,
      ...
      'https':
          pulumi.Input.mapInputValue<
            List<GetLoadBalancerServiceHttp>,
            List<Map<String, dynamic>>
          >(
            https,
            (value) =>
  ...
  factory GetLoadBalancerService.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerService(
      ...
      healthChecks: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLoadBalancerServiceHealthCheck>(
          map['healthChecks']!,
          (value) => GetLoadBalancerServiceHealthCheck.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      https: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLoadBalancerServiceHttp>(
          map['https']!,
          (value) => GetLoadBalancerServiceHttp.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
