...
class GetServerTypesServerType {
  ...
  factory GetServerTypesServerType.fromMap(Map<String, dynamic> map) {
    return GetServerTypesServerType(
      ...
      includedTraffic: pulumi.Input.fromValue(((value) { final number = value as num; final integer = number.toInt(); if (number != integer) { throw FormatException('Expected an integer, got $number.'); } return integer; })(map['includedTraffic'])),
      isDeprecated: pulumi.Input.fromValue(map['isDeprecated'] as bool),
      locations: pulumi.Input.fromValue(pulumi.Input.decodeList<GetServerTypesServerTypeLocation>(map['locations']!, (value) => GetServerTypesServerTypeLocation.fromMap((value as Map).cast<String, dynamic>()))),
