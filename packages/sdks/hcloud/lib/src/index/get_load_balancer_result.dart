...
class GetLoadBalancerResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'services':
          pulumi.Input.encodeList<GetLoadBalancerService, Map<String, dynamic>>(
            services,
            (value) => value.toMap(),
          ),
      'targets':
          pulumi.Input.encodeList<GetLoadBalancerTarget, Map<String, dynamic>>(
            targets,
            (value) => value.toMap(),
          ),
  ...
  factory GetLoadBalancerResult.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerResult(
      algorithms: pulumi.Input.decodeList<GetLoadBalancerAlgorithm>(
        map['algorithms']!,
        (value) => GetLoadBalancerAlgorithm.fromMap(
      ...
      services: pulumi.Input.decodeList<GetLoadBalancerService>(
        map['services']!,
        (value) => GetLoadBalancerService.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      targets: pulumi.Input.decodeList<GetLoadBalancerTarget>(
        map['targets']!,
        (value) => GetLoadBalancerTarget.fromMap(
          (value as Map).cast<String, dynamic>(),
        ),
      ),
      withSelector: (() {
