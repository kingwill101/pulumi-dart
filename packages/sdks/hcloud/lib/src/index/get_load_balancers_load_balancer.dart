...
class GetLoadBalancersLoadBalancer {
  ...
  factory GetLoadBalancersLoadBalancer.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancersLoadBalancer(
      ...
      targets: pulumi.Input.fromValue(pulumi.Input.decodeList<GetLoadBalancersLoadBalancerTarget>(map['targets']!, (value) => GetLoadBalancersLoadBalancerTarget.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
