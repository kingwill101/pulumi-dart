...
class GetFirewallArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'rules':
          ?pulumi.Input.mapOptionalInputValue<
            List<GetFirewallRule>,
            List<Map<String, dynamic>>
          >(
            rules,
            (value) =>
                pulumi.Input.encodeList<GetFirewallRule, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return GetFirewallArgs(
      applyTos: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetFirewallApplyTo>(
            guardedValue,
      ...
      rules: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetFirewallRule>(
            guardedValue,
            (value) =>
