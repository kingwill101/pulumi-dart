    ...
    return <String, dynamic>{
      'https':
          pulumi.Input.mapInputValue<
            List<GetLoadBalancerServiceHealthCheckHttp>,
  ...
  factory GetLoadBalancerServiceHealthCheck.fromMap(Map<String, dynamic> map) {
    return GetLoadBalancerServiceHealthCheck(
      https: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetLoadBalancerServiceHealthCheckHttp>(
          map['https']!,
          (value) => GetLoadBalancerServiceHealthCheckHttp.fromMap(
