...
class RandomPasswordState {
  ...
  RandomPasswordState({
    pulumi.Output<String>? bcryptHash,
    ...
    pulumi.Output<bool>? upper,
      ...
      bcryptHash = pulumi.Input.asOptionalInput<String>(bcryptHash),
  ...
  factory RandomPasswordState.fromMap(Map<String, dynamic> map) {
    return RandomPasswordState(
      bcryptHash: map['bcryptHash'] == null ? null : pulumi.Output.create<String>(map['bcryptHash'] as String),
