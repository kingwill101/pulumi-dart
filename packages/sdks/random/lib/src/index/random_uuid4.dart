...
import 'random_uuid4_state.dart';
...
///
/// # The following example shows how to generate a unique name for an Azure Resource Group.
/// resource "random_randomuuid4" "test" {
/// }
/// resource "azurerm_resourcegroup" "test" {
///   name     ="${random_randomuuid4.test.result}-rg"
///   location = "Central US"
/// }
/// ```
/// ```java
...
class RandomUuid4 extends pulumi.CustomResource {
  ...
  /// Gets an existing [RandomUuid4] resource's state with the given [name] and [id].
  static RandomUuid4 get(
    String name,
    pulumi.Input<String> id, {
    RandomUuid4State? state,
    pulumi.CustomResourceOptions? options,
  }) {
    return RandomUuid4._get(
      name,
      state: state?.toMap(),
  ...
  /// Creates a typed reference to an existing [RandomUuid4] resource.
  RandomUuid4.reference(String urn)
    : super(
        'random:index/randomUuid4:RandomUuid4',
