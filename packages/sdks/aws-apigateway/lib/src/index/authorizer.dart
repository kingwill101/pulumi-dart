...
class Authorizer {
  ...
  final double? authorizerResultTtlInSeconds;
  /// The authorizerHandler specifies information about the authorizing Lambda.
  final pulumi_aws_lambda.FunctionType? handler;
  ...
  final List<String>? methodsToAuthorize;
  ...
  factory Authorizer.fromMap(Map<String, dynamic> map) {
    return Authorizer(
      ...
      authorizerName: map['authorizerName'] == null ? null : map['authorizerName'] as String,
      authorizerResultTtlInSeconds: map['authorizerResultTtlInSeconds'] == null ? null : map['authorizerResultTtlInSeconds'] as double,
      handler: map['handler'] == null ? null : map['handler'] as pulumi_aws_lambda.FunctionType,
      identitySource: map['identitySource'] == null ? null : (map['identitySource'] as List).cast<String>(),
      identityValidationExpression: map['identityValidationExpression'] == null ? null : map['identityValidationExpression'] as String,
      methodsToAuthorize: map['methodsToAuthorize'] == null ? null : (map['methodsToAuthorize'] as List).cast<String>(),
