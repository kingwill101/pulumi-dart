...
class Target {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectionType': ?pulumi.Input.mapOptionalInputValue<IntegrationConnectionType, String>(connectionType, (value) => value.wireValue),
      'httpMethod': ?httpMethod,
      'passthroughBehaviour': ?pulumi.Input.mapOptionalInputValue<IntegrationPassthroughBehavior, String>(passthroughBehaviour, (value) => value.wireValue),
      'type': pulumi.Input.mapInputValue<IntegrationType, String>(type, (value) => value.wireValue),
      'uri': ?uri,
    };
  }
  ...
  factory Target.fromMap(Map<String, dynamic> map) {
    return Target(
      ...
      connectionType: (() { final guardedValue = map['connectionType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntegrationConnectionType.fromValue(guardedValue as String)); })(),
      ...
      passthroughBehaviour: (() { final guardedValue = map['passthroughBehaviour']; if (guardedValue == null) return null; return pulumi.Input.fromValue(IntegrationPassthroughBehavior.fromValue(guardedValue as String)); })(),
      type: pulumi.Input.fromValue(IntegrationType.fromValue(map['type']! as String)),
