...
class RestAPIArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'apiKeySource': ?pulumi.Input.mapOptionalInputValue<APIKeySource, String>(
        apiKeySource,
      ...
      'gatewayResponses':
          ?pulumi.Input.mapOptionalInputValue<
            Map<String, SwaggerGatewayResponse>,
    ...
    return RestAPIArgs(
      apiKeySource: (() {
        ...
        return pulumi.Input.fromValue(
          APIKeySource.fromValue(guardedValue as String),
        );
      })(),
      binaryMediaTypes: (() {
      ...
      gatewayResponses: (() {
        final guardedValue = map['gatewayResponses'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeMapValues<SwaggerGatewayResponse>(
            guardedValue,
            (value) => SwaggerGatewayResponse.fromMap(
      ...
      staticRoutesBucket: (() {
        final guardedValue = map['staticRoutesBucket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as pulumi_aws_s3.Bucket);
      })(),
      swaggerString: (() {
        final guardedValue = map['swaggerString'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tags: (() {
