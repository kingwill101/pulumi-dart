...
class GetAwsServiceDiscoveryArgs {
  ...
  factory GetAwsServiceDiscoveryArgs.fromMap(Map<String, dynamic> map) {
    return GetAwsServiceDiscoveryArgs(
      ...
      awsAccessKey: (() { final guardedValue = map['awsAccessKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      awsSecretAccessKey: (() { final guardedValue = map['awsSecretAccessKey']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
