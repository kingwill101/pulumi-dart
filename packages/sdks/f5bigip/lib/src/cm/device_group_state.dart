    ...
    return DeviceGroupState(
      ...
      devices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DeviceGroupDevice>(
            guardedValue,
            (value) => DeviceGroupDevice.fromMap(
      ...
      fullLoadOnSync: (() {
        final guardedValue = map['fullLoadOnSync'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      incrementalConfig: (() {
        final guardedValue = map['incrementalConfig'];
        if (guardedValue == null) return null;
      ...
      networkFailover: (() {
        final guardedValue = map['networkFailover'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      partition: (() {
      ...
      saveOnAutoSync: (() {
        final guardedValue = map['saveOnAutoSync'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      type: (() {
