...
class IAppState {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'lists':
          ...
          >(
            lists,
            (value) => pulumi.Input.encodeList<IAppList, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'metadatas':
          ...
          >(
            metadatas,
            (value) =>
                pulumi.Input.encodeList<IAppMetadata, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'tables':
          ...
          >(
            tables,
            (value) => pulumi.Input.encodeList<IAppTable, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      ...
      'variables':
          ...
          >(
            variables,
            (value) =>
                pulumi.Input.encodeList<IAppVariable, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory IAppState.fromMap(Map<String, dynamic> map) {
    return IAppState(
      ...
      devicegroup: (() {
        final guardedValue = map['devicegroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      executeAction: (() {
        final guardedValue = map['executeAction'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inheritedDevicegroup: (() {
        final guardedValue = map['inheritedDevicegroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inheritedTrafficGroup: (() {
        final guardedValue = map['inheritedTrafficGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      jsonfile: (() {
        final guardedValue = map['jsonfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lists: (() {
        final guardedValue = map['lists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IAppList>(
            guardedValue,
            (value) => IAppList.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      metadatas: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IAppMetadata>(
            guardedValue,
            (value) =>
                IAppMetadata.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      name: (() {
      ...
      strictUpdates: (() {
        final guardedValue = map['strictUpdates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IAppTable>(
            guardedValue,
            (value) =>
                IAppTable.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      template: (() {
      ...
      templateModified: (() {
        final guardedValue = map['templateModified'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      templatePrerequisiteErrors: (() {
        final guardedValue = map['templatePrerequisiteErrors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trafficGroup: (() {
        final guardedValue = map['trafficGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      variables: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<IAppVariable>(
            guardedValue,
            (value) =>
                IAppVariable.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
