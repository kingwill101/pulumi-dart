...
class OcspState {
  ...
  factory OcspState.fromMap(Map<String, dynamic> map) {
    return OcspState(
      cacheErrorTimeout: (() {
        final guardedValue = map['cacheErrorTimeout'];
      ...
      clockSkew: (() {
        final guardedValue = map['clockSkew'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      concurrentConnectionsLimit: (() {
        final guardedValue = map['concurrentConnectionsLimit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      connectionTimeout: (() {
      ...
      dnsResolver: (() {
        final guardedValue = map['dnsResolver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      proxyServerPool: (() {
        final guardedValue = map['proxyServerPool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      responderUrl: (() {
        final guardedValue = map['responderUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      routeDomain: (() {
      ...
      signHash: (() {
        final guardedValue = map['signHash'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signerCert: (() {
        final guardedValue = map['signerCert'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signerKey: (() {
        final guardedValue = map['signerKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      statusAge: (() {
        final guardedValue = map['statusAge'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      strictRespCertCheck: (() {
        final guardedValue = map['strictRespCertCheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      trustedResponders: (() {
        final guardedValue = map['trustedResponders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
