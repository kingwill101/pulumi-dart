...
class Ocsp extends pulumi.CustomResource {
  ...
  Ocsp(
    ...
    proxyServerPool = registerOutput<String?>('proxyServerPool');
    responderUrl = registerOutput<String?>('responderUrl');
    routeDomain = registerOutput<String?>('routeDomain');
    signHash = registerOutput<String?>('signHash');
    signerCert = registerOutput<String?>('signerCert');
    signerKey = registerOutput<String?>('signerKey');
    statusAge = registerOutput<int?>('statusAge');
    strictRespCertCheck = registerOutput<String?>('strictRespCertCheck');
    trustedResponders = registerOutput<String?>('trustedResponders');
  }
