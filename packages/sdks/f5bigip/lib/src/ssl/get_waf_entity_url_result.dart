...
class GetWafEntityUrlResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'crossOriginRequestsEnforcements': ?(() { final guardedValue = crossOriginRequestsEnforcements; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWafEntityUrlCrossOriginRequestsEnforcement, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'description': ?description,
      'id': id,
      'json': json,
      'method': ?method,
      'methodOverrides': ?(() { final guardedValue = methodOverrides; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetWafEntityUrlMethodOverride, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'name': name,
  ...
  factory GetWafEntityUrlResult.fromMap(Map<String, dynamic> map) {
    return GetWafEntityUrlResult(
      crossOriginRequestsEnforcements: (() { final guardedValue = map['crossOriginRequestsEnforcements']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWafEntityUrlCrossOriginRequestsEnforcement>(guardedValue, (value) => GetWafEntityUrlCrossOriginRequestsEnforcement.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      methodOverrides: (() { final guardedValue = map['methodOverrides']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetWafEntityUrlMethodOverride>(guardedValue, (value) => GetWafEntityUrlMethodOverride.fromMap((value as Map).cast<String, dynamic>())); })(),
