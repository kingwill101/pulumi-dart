...
class GetWafEntityUrlArgs {
  ...
  factory GetWafEntityUrlArgs.fromMap(Map<String, dynamic> map) {
    return GetWafEntityUrlArgs(
      crossOriginRequestsEnforcements: (() { final guardedValue = map['crossOriginRequestsEnforcements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetWafEntityUrlCrossOriginRequestsEnforcement>(guardedValue, (value) => GetWafEntityUrlCrossOriginRequestsEnforcement.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      methodOverrides: (() { final guardedValue = map['methodOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetWafEntityUrlMethodOverride>(guardedValue, (value) => GetWafEntityUrlMethodOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
