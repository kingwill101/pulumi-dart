...
class FastHttpsAppArgs {
  ...
  factory FastHttpsAppArgs.fromMap(Map<String, dynamic> map) {
    return FastHttpsAppArgs(
      ...
      existingTlsClientProfile: map['existingTlsClientProfile'] == null ? null : (map['existingTlsClientProfile']! as String).input(),
      existingTlsServerProfile: map['existingTlsServerProfile'] == null ? null : (map['existingTlsServerProfile']! as String).input(),
      ...
      monitor: map['monitor'] == null ? null : (FastHttpsAppMonitor.fromMap((map['monitor']! as Map).cast<String, dynamic>())).input(),
      ...
      poolMembers: map['poolMembers'] == null ? null : (pulumi.Input.decodeList<FastHttpsAppPoolMember>(map['poolMembers']!, (value) => FastHttpsAppPoolMember.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      tlsClientProfile: map['tlsClientProfile'] == null ? null : (FastHttpsAppTlsClientProfile.fromMap((map['tlsClientProfile']! as Map).cast<String, dynamic>())).input(),
      tlsServerProfile: map['tlsServerProfile'] == null ? null : (FastHttpsAppTlsServerProfile.fromMap((map['tlsServerProfile']! as Map).cast<String, dynamic>())).input(),
      virtualServer: map['virtualServer'] == null ? null : (FastHttpsAppVirtualServer.fromMap((map['virtualServer']! as Map).cast<String, dynamic>())).input(),
      wafSecurityPolicy: map['wafSecurityPolicy'] == null ? null : (FastHttpsAppWafSecurityPolicy.fromMap((map['wafSecurityPolicy']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
