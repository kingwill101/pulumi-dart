...
class FastHttpsAppArgs {
    ...
    return <String, dynamic>{
      ...
      'tlsClientProfile':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(tlsClientProfile, (value) => value.toMap()),
      'tlsServerProfile':
          ?pulumi.Input.mapOptionalInputValue<
            FastHttpsAppTlsServerProfile,
            Map<String, dynamic>
          >(tlsServerProfile, (value) => value.toMap()),
      'virtualServer':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory FastHttpsAppArgs.fromMap(Map<String, dynamic> map) {
    return FastHttpsAppArgs(
      ...
      endpointLtmPolicies: (() {
        final guardedValue = map['endpointLtmPolicies'];
      ...
      existingTlsClientProfile: (() {
        final guardedValue = map['existingTlsClientProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      existingTlsServerProfile: (() {
        final guardedValue = map['existingTlsServerProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      existingWafSecurityPolicy: (() {
        final guardedValue = map['existingWafSecurityPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fallbackPersistence: (() {
      ...
      poolMembers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FastHttpsAppPoolMember>(
            guardedValue,
            (value) => FastHttpsAppPoolMember.fromMap(
      ...
      serviceDiscoveries: (() {
        final guardedValue = map['serviceDiscoveries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      slowRampTime: (() {
      ...
      tlsClientProfile: (() {
        final guardedValue = map['tlsClientProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastHttpsAppTlsClientProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      tlsServerProfile: (() {
        final guardedValue = map['tlsServerProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastHttpsAppTlsServerProfile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      virtualServer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastHttpsAppVirtualServer.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      wafSecurityPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastHttpsAppWafSecurityPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
