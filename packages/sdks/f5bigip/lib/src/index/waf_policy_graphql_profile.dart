...
class WafPolicyGraphqlProfile {
  ...
  final pulumi.Input<List<WafPolicyGraphqlProfileDefenseAttribute>>?
  defenseAttributes;
    ...
    return <String, dynamic>{
      ...
      'defenseAttributes':
          ?pulumi.Input.mapOptionalInputValue<
            List<WafPolicyGraphqlProfileDefenseAttribute>,
  ...
  factory WafPolicyGraphqlProfile.fromMap(Map<String, dynamic> map) {
    return WafPolicyGraphqlProfile(
      ...
      defenseAttributes: (() {
        final guardedValue = map['defenseAttributes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafPolicyGraphqlProfileDefenseAttribute>(
            guardedValue,
            (value) => WafPolicyGraphqlProfileDefenseAttribute.fromMap(
      ...
      metacharElementcheck: (() {
        final guardedValue = map['metacharElementcheck'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
