...
class WafPolicyGraphqlProfile {
  ...
  factory WafPolicyGraphqlProfile.fromMap(Map<String, dynamic> map) {
    return WafPolicyGraphqlProfile(
      ...
      defenseAttributes: (() { final guardedValue = map['defenseAttributes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WafPolicyGraphqlProfileDefenseAttribute>(guardedValue, (value) => WafPolicyGraphqlProfileDefenseAttribute.fromMap((value as Map).cast<String, dynamic>()))); })(),
      metacharElementcheck: (() { final guardedValue = map['metacharElementcheck']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
