...
class SaasBotDefenseProfileState {
  ...
  factory SaasBotDefenseProfileState.fromMap(Map<String, dynamic> map) {
    return SaasBotDefenseProfileState(
      ...
      protectedEndpoints: (() { final guardedValue = map['protectedEndpoints']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<SaasBotDefenseProfileProtectedEndpoint>(guardedValue, (value) => SaasBotDefenseProfileProtectedEndpoint.fromMap((value as Map).cast<String, dynamic>()))); })(),
      shapeProtectionPool: (() { final guardedValue = map['shapeProtectionPool']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
