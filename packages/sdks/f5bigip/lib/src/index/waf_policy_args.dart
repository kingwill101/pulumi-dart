...
class WafPolicyArgs {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'signaturesSettings':
          ?pulumi.Input.mapOptionalInputValue<
            List<WafPolicySignaturesSetting>,
            List<Map<String, dynamic>>
          >(
            signaturesSettings,
            (value) =>
  ...
  factory WafPolicyArgs.fromMap(Map<String, dynamic> map) {
    return WafPolicyArgs(
      applicationLanguage: (() {
        final guardedValue = map['applicationLanguage'];
      ...
      enablePassivemode: (() {
        final guardedValue = map['enablePassivemode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enforcementMode: (() {
      ...
      fileTypes: (() {
        final guardedValue = map['fileTypes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafPolicyFileType>(
            guardedValue,
            (value) => WafPolicyFileType.fromMap(
      ...
      graphqlProfiles: (() {
        final guardedValue = map['graphqlProfiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafPolicyGraphqlProfile>(
            guardedValue,
            (value) => WafPolicyGraphqlProfile.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      hostNames: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafPolicyHostName>(
            guardedValue,
            (value) => WafPolicyHostName.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ipExceptions: (() {
        final guardedValue = map['ipExceptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafPolicyIpException>(
            guardedValue,
            (value) => WafPolicyIpException.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      modifications: (() {
        final guardedValue = map['modifications'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      openApiFiles: (() {
        final guardedValue = map['openApiFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      parameters: (() {
      ...
      policyBuilders: (() {
        final guardedValue = map['policyBuilders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafPolicyPolicyBuilder>(
            guardedValue,
            (value) => WafPolicyPolicyBuilder.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      policyImportJson: (() {
        final guardedValue = map['policyImportJson'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      protocolIndependent: (() {
        final guardedValue = map['protocolIndependent'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      serverTechnologies: (() {
        final guardedValue = map['serverTechnologies'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      signatureSets: (() {
        final guardedValue = map['signatureSets'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      signatures: (() {
      ...
      signaturesSettings: (() {
        final guardedValue = map['signaturesSettings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WafPolicySignaturesSetting>(
            guardedValue,
            (value) => WafPolicySignaturesSetting.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
