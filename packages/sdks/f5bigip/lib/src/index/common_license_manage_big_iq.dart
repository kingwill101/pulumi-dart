...
import 'common_license_manage_big_iq_state.dart';
...
class CommonLicenseManageBigIq extends pulumi.CustomResource {
  ...
  CommonLicenseManageBigIq(
    ...
    deviceLicenseStatus = registerOutput<String>('deviceLicenseStatus');
    hypervisor = registerOutput<String?>('hypervisor');
    key = registerOutput<String?>('key');
    licensePoolname = registerOutput<String>('licensePoolname');
    macAddress = registerOutput<String?>('macAddress');
    skukeyword1 = registerOutput<String?>('skukeyword1');
    skukeyword2 = registerOutput<String?>('skukeyword2');
    tenant = registerOutput<String?>('tenant');
    unitOfMeasure = registerOutput<String?>('unitOfMeasure');
  }

  /// Gets an existing [CommonLicenseManageBigIq] resource's state with the given [name] and [id].
  static CommonLicenseManageBigIq get(
    String name,
    pulumi.Input<String> id, {
    CommonLicenseManageBigIqState? state,
  }) {
    return CommonLicenseManageBigIq._get(
      name,
      state: state?.toMap(),
