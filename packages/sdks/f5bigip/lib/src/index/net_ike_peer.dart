...
import 'net_ike_peer_state.dart';
...
class NetIkePeer extends pulumi.CustomResource {
  ...
  NetIkePeer(
    ...
    dpdDelay = registerOutput<int>('dpdDelay');
    generatePolicy = registerOutput<String>('generatePolicy');
    lifetime = registerOutput<int>('lifetime');
    mode = registerOutput<String>('mode');
    myCertFile = registerOutput<String>('myCertFile');
    myCertKeyFile = registerOutput<String>('myCertKeyFile');
    myCertKeyPassphrase = registerOutput<String>('myCertKeyPassphrase');
    myIdType = registerOutput<String>('myIdType');
    myIdValue = registerOutput<String>('myIdValue');
    this.name = registerOutput<String>('name');
    natTraversal = registerOutput<String>('natTraversal');
    passive = registerOutput<String>('passive');
    peersCertFile = registerOutput<String>('peersCertFile');
    peersCertType = registerOutput<String>('peersCertType');
    peersIdType = registerOutput<String>('peersIdType');
    peersIdValue = registerOutput<String>('peersIdValue');
    ...
    proxySupport = registerOutput<String>('proxySupport');
    remoteAddress = registerOutput<String>('remoteAddress');
    replayWindowSize = registerOutput<int>('replayWindowSize');
    state = registerOutput<String>('state');
    trafficSelectors = registerOutput<List<String>>('trafficSelectors');
    verifyCert = registerOutput<String>('verifyCert');
    versions = registerOutput<List<String>>('versions');
  }

  /// Gets an existing [NetIkePeer] resource's state with the given [name] and [id].
  static NetIkePeer get(
    String name,
    pulumi.Input<String> id, {
    NetIkePeerState? state,
  }) {
    return NetIkePeer._get(
      name,
      state: state?.toMap(),
