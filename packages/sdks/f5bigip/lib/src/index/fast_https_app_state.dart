...
class FastHttpsAppState {
  ...
  factory FastHttpsAppState.fromMap(Map<String, dynamic> map) {
    return FastHttpsAppState(
      ...
      fastHttpsJson: (() { final guardedValue = map['fastHttpsJson']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
