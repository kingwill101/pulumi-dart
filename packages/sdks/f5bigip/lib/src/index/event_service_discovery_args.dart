...
/// {@template pulumi_index_event_service_discovery_event_service_discovery_args_doc}
/// The set of arguments for EventServiceDiscovery.
/// {@endtemplate}
/// {@macro pulumi_index_event_service_discovery_event_service_discovery_args_doc}
class EventServiceDiscoveryArgs {
  ...
  const EventServiceDiscoveryArgs({
    this.nodes,
