...
class DoState {
  ...
  DoState({
    ...
    pulumi.Output<int>? timeout,
      ...
      doJson = pulumi.Input.asOptionalInput<String>(doJson),
  ...
  factory DoState.fromMap(Map<String, dynamic> map) {
    return DoState(
      ...
      doJson: map['doJson'] == null ? null : pulumi.Output.create<String>(map['doJson'] as String),
