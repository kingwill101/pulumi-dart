...
class FastTcpAppState {
  ...
  factory FastTcpAppState.fromMap(Map<String, dynamic> map) {
    return FastTcpAppState(
      ...
      fastTcpJson: (() { final guardedValue = map['fastTcpJson']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
