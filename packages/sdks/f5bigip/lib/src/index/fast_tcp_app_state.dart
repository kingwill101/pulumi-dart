...
class FastTcpAppState {
  ...
  factory FastTcpAppState.fromMap(Map<String, dynamic> map) {
    return FastTcpAppState(
      ...
      fastTcpJson: (() {
        final guardedValue = map['fastTcpJson'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loadBalancingMode: (() {
      ...
      poolMembers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FastTcpAppPoolMember>(
            guardedValue,
            (value) => FastTcpAppPoolMember.fromMap(
      ...
      virtualServer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastTcpAppVirtualServer.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
