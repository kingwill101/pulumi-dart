...
class Do extends pulumi.CustomResource {
  ...
  Do(String name, {DoArgs? args, pulumi.CustomResourceOptions? options})
    : super(
        'f5bigip:index/do:Do',
        name,
    ...
    bigipAddress = registerOutput<String?>('bigipAddress');
    bigipPassword = registerOutput<String?>('bigipPassword');
    bigipPort = registerOutput<String?>('bigipPort');
    bigipTokenAuth = registerOutput<bool?>('bigipTokenAuth');
    bigipUser = registerOutput<String?>('bigipUser');
    doJson = registerOutput<String>('doJson');
  ...
  static Do get(String name, pulumi.Input<String> id, {DoState? state}) {
    return Do._get(
      name,
      state: state?.toMap(),
