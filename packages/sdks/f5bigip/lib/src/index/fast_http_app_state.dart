...
class FastHttpAppState {
  ...
  FastHttpAppState({
    ...
    pulumi.Output<String>? fastHttpJson,
    ...
    pulumi.Output<FastHttpAppWafSecurityPolicy>? wafSecurityPolicy,
      ...
      fastHttpJson = pulumi.Input.asOptionalInput<String>(fastHttpJson),
  ...
  factory FastHttpAppState.fromMap(Map<String, dynamic> map) {
    return FastHttpAppState(
      ...
      fastHttpJson: map['fastHttpJson'] == null ? null : pulumi.Output.create<String>(map['fastHttpJson'] as String),
