...
class FastHttpAppState {
  ...
  factory FastHttpAppState.fromMap(Map<String, dynamic> map) {
    return FastHttpAppState(
      ...
      fastHttpJson: (() {
        final guardedValue = map['fastHttpJson'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loadBalancingMode: (() {
      ...
      poolMembers: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<FastHttpAppPoolMember>(
            guardedValue,
            (value) => FastHttpAppPoolMember.fromMap(
      ...
      virtualServer: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastHttpAppVirtualServer.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      wafSecurityPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          FastHttpAppWafSecurityPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
