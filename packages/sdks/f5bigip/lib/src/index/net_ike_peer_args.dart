...
class NetIkePeerArgs {
  ...
  factory NetIkePeerArgs.fromMap(Map<String, dynamic> map) {
    return NetIkePeerArgs(
      ...
      dpdDelay: (() {
        final guardedValue = map['dpdDelay'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      generatePolicy: (() {
        final guardedValue = map['generatePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      lifetime: (() {
      ...
      myCertFile: (() {
        final guardedValue = map['myCertFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      myCertKeyFile: (() {
        final guardedValue = map['myCertKeyFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      myCertKeyPassphrase: (() {
        final guardedValue = map['myCertKeyPassphrase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      myIdType: (() {
        final guardedValue = map['myIdType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      myIdValue: (() {
        final guardedValue = map['myIdValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      natTraversal: (() {
        final guardedValue = map['natTraversal'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      passive: (() {
        final guardedValue = map['passive'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      peersCertFile: (() {
        final guardedValue = map['peersCertFile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      peersCertType: (() {
        final guardedValue = map['peersCertType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      peersIdType: (() {
        final guardedValue = map['peersIdType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      peersIdValue: (() {
        final guardedValue = map['peersIdValue'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      phase1AuthMethod: (() {
        final guardedValue = map['phase1AuthMethod'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      phase1EncryptAlgorithm: (() {
        final guardedValue = map['phase1EncryptAlgorithm'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      phase1HashAlgorithm: (() {
        final guardedValue = map['phase1HashAlgorithm'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      phase1PerfectForwardSecrecy: (() {
        final guardedValue = map['phase1PerfectForwardSecrecy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      presharedKey: (() {
        final guardedValue = map['presharedKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      presharedKeyEncrypted: (() {
        final guardedValue = map['presharedKeyEncrypted'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      prf: (() {
        final guardedValue = map['prf'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      proxySupport: (() {
        final guardedValue = map['proxySupport'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      remoteAddress: pulumi.Input.fromValue(map['remoteAddress'] as String),
      replayWindowSize: (() {
        final guardedValue = map['replayWindowSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      state: (() {
      ...
      trafficSelectors: (() {
        final guardedValue = map['trafficSelectors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      verifyCert: (() {
        final guardedValue = map['verifyCert'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      versions: (() {
