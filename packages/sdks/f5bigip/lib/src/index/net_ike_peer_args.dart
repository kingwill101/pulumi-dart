...
class NetIkePeerArgs {
  ...
  NetIkePeerArgs({
    ...
    required pulumi.Output<String> remoteAddress,
    ...
    pulumi.Output<List<String>>? versions,
      ...
      remoteAddress = pulumi.Input.asInput<String>(remoteAddress),
  ...
  factory NetIkePeerArgs.fromMap(Map<String, dynamic> map) {
    return NetIkePeerArgs(
      ...
      remoteAddress: pulumi.Output.create<String>(map['remoteAddress'] as String),
