...
class NetTunnelState {
  ...
  factory NetTunnelState.fromMap(Map<String, dynamic> map) {
    return NetTunnelState(
      ...
      localAddress: (() { final guardedValue = map['localAddress']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
