...
class IpsecPolicyState {
  ...
  factory IpsecPolicyState.fromMap(Map<String, dynamic> map) {
    return IpsecPolicyState(
      ...
      ipcomp: (() {
        final guardedValue = map['ipcomp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kbLifetime: (() {
        final guardedValue = map['kbLifetime'];
        if (guardedValue == null) return null;
      ...
      perfectForwardSecrecy: (() {
        final guardedValue = map['perfectForwardSecrecy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      protocol: (() {
      ...
      tunnelLocalAddress: (() {
        final guardedValue = map['tunnelLocalAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tunnelRemoteAddress: (() {
        final guardedValue = map['tunnelRemoteAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
