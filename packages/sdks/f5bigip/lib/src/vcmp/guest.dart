...
class Guest extends pulumi.CustomResource {
  ...
  Guest(String name, {GuestArgs? args, pulumi.CustomResourceOptions? options})
    ...
    initialHotfix = registerOutput<String>('initialHotfix');
    initialImage = registerOutput<String>('initialImage');
    mgmtAddress = registerOutput<String>('mgmtAddress');
    mgmtNetwork = registerOutput<String>('mgmtNetwork');
    mgmtRoute = registerOutput<String>('mgmtRoute');
    minNumberOfSlots = registerOutput<int>('minNumberOfSlots');
    this.name = registerOutput<String>('name');
    numberOfSlots = registerOutput<int>('numberOfSlots');
    state = registerOutput<String>('state');
    virtualDisk = registerOutput<String>('virtualDisk');
