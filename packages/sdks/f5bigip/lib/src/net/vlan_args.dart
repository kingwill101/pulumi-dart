...
class VlanArgs {
    ...
    return <String, dynamic>{
      ...
      'interfaces':
          ...
          >(
            interfaces,
            (value) =>
                pulumi.Input.encodeList<VlanInterface, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory VlanArgs.fromMap(Map<String, dynamic> map) {
    return VlanArgs(
      cmpHash: (() {
        final guardedValue = map['cmpHash'];
      ...
      interfaces: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<VlanInterface>(
            guardedValue,
            (value) =>
                VlanInterface.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      mtu: (() {
