...
class VlanInterface {
  ...
  factory VlanInterface.fromMap(Map<String, dynamic> map) {
    return VlanInterface(
      tagged: (() { final guardedValue = map['tagged']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      vlanport: (() { final guardedValue = map['vlanport']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
