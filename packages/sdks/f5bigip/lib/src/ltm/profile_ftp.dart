...
class ProfileFtp extends pulumi.CustomResource {
  ...
  ProfileFtp(
    ...
    enforceTlssessionReuse = registerOutput<String?>('enforceTlssessionReuse');
    ftpsMode = registerOutput<String?>('ftpsMode');
    inheritParentProfile = registerOutput<String?>('inheritParentProfile');
    inheritVlanList = registerOutput<String?>('inheritVlanList');
    logProfile = registerOutput<String>('logProfile');
    logPublisher = registerOutput<String>('logPublisher');
    this.name = registerOutput<String>('name');
    partition = registerOutput<String>('partition');
    port = registerOutput<int?>('port');
    security = registerOutput<String>('security');
    translateExtended = registerOutput<String?>('translateExtended');
  }

  /// Gets an existing [ProfileFtp] resource's state with the given [name] and [id].
  static ProfileFtp get(
    String name,
    pulumi.Input<String> id, {
    ProfileFtpState? state,
  }) {
    return ProfileFtp._get(
      name,
      state: state?.toMap(),
