    ...
    return <String, dynamic>{
      ...
      'records':
          ?pulumi.Input.mapOptionalInputValue<
            List<DataGroupRecord>,
            List<Map<String, dynamic>>
          >(
            records,
            (value) =>
                pulumi.Input.encodeList<DataGroupRecord, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DataGroupArgs(
      ...
      records: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DataGroupRecord>(
            guardedValue,
            (value) =>
                DataGroupRecord.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      recordsSrc: (() {
        final guardedValue = map['recordsSrc'];
        if (guardedValue == null) return null;
