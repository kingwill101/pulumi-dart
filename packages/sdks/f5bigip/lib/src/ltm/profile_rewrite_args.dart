...
class ProfileRewriteArgs {
  ...
  factory ProfileRewriteArgs.fromMap(Map<String, dynamic> map) {
    return ProfileRewriteArgs(
      bypassLists: (() {
        final guardedValue = map['bypassLists'];
      ...
      cacheType: (() {
        final guardedValue = map['cacheType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      cookieRules: (() {
        final guardedValue = map['cookieRules'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProfileRewriteCookieRule>(
            guardedValue,
            (value) => ProfileRewriteCookieRule.fromMap(
      ...
      requests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProfileRewriteRequest>(
            guardedValue,
            (value) => ProfileRewriteRequest.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      responses: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ProfileRewriteResponse>(
            guardedValue,
            (value) => ProfileRewriteResponse.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      rewriteLists: (() {
        final guardedValue = map['rewriteLists'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      rewriteMode: pulumi.Input.fromValue(map['rewriteMode'] as String),
      signingCert: (() {
        final guardedValue = map['signingCert'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signingKey: (() {
        final guardedValue = map['signingKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      signingKeyPassword: (() {
        final guardedValue = map['signingKeyPassword'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      splitTunneling: (() {
        final guardedValue = map['splitTunneling'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
