...
import 'pool_attachment_state.dart';
...
class PoolAttachment extends pulumi.CustomResource {
  ...
  PoolAttachment(
    ...
    fqdnAutopopulate = registerOutput<String?>('fqdnAutopopulate');
    monitor = registerOutput<String>('monitor');
    node = registerOutput<String>('node');
    pool = registerOutput<String>('pool');
    priorityGroup = registerOutput<int>('priorityGroup');
    ratio = registerOutput<int>('ratio');
    state = registerOutput<String?>('state');
  }

  /// Gets an existing [PoolAttachment] resource's state with the given [name] and [id].
  static PoolAttachment get(
    String name,
    pulumi.Input<String> id, {
    PoolAttachmentState? state,
  }) {
    return PoolAttachment._get(
      name,
      state: state?.toMap(),
