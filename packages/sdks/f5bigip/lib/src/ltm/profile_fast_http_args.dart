...
/// {@template pulumi_ltm_profile_fast_http_profile_fast_http_args_doc}
/// The set of arguments for ProfileFastHttp.
/// {@endtemplate}
/// {@macro pulumi_ltm_profile_fast_http_profile_fast_http_args_doc}
class ProfileFastHttpArgs {
  ...
  /// Creates a new [ProfileFastHttpArgs].
  ...
  factory ProfileFastHttpArgs.fromMap(Map<String, dynamic> map) {
    return ProfileFastHttpArgs(
      connpoolMaxreuse: (() { final guardedValue = map['connpoolMaxreuse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      connpoolMaxsize: (() { final guardedValue = map['connpoolMaxsize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      connpoolMinsize: (() { final guardedValue = map['connpoolMinsize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      connpoolReplenish: (() { final guardedValue = map['connpoolReplenish']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      connpoolStep: (() { final guardedValue = map['connpoolStep']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      connpoolidleTimeoutoverride: (() { final guardedValue = map['connpoolidleTimeoutoverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      forcehttp10response: (() { final guardedValue = map['forcehttp10response']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      maxheaderSize: (() { final guardedValue = map['maxheaderSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
