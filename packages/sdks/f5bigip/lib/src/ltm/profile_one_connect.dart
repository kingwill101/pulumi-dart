...
class ProfileOneConnect extends pulumi.CustomResource {
  ...
  ProfileOneConnect(
    ...
    this.idleTimeoutOverride = registerOutput<String>('idleTimeoutOverride');
    this.limitType = registerOutput<String>('limitType');
    this.maxAge = registerOutput<int>('maxAge');
    this.maxReuse = registerOutput<int>('maxReuse');
    this.maxSize = registerOutput<int>('maxSize');
    this.name = registerOutput<String>('name');
    this.partition = registerOutput<String>('partition');
    this.sharePools = registerOutput<String>('sharePools');
    this.sourceMask = registerOutput<String>('sourceMask');
  }
