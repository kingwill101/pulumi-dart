    ...
    return <String, dynamic>{
      'actions':
          ?pulumi.Input.mapOptionalInputValue<
            List<PolicyRuleAction>,
            List<Map<String, dynamic>>
          >(
            actions,
            (value) =>
                pulumi.Input.encodeList<PolicyRuleAction, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return PolicyRule(
      actions: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyRuleAction>(
            guardedValue,
            (value) => PolicyRuleAction.fromMap(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PolicyRuleCondition>(
            guardedValue,
            (value) => PolicyRuleCondition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
