...
class ProfileServerSslState {
  ...
  factory ProfileServerSslState.fromMap(Map<String, dynamic> map) {
    return ProfileServerSslState(
      ...
      c3dCaCert: (() {
        final guardedValue = map['c3dCaCert'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      c3dCaKey: (() {
        final guardedValue = map['c3dCaKey'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      c3dCaPassphrase: (() {
        final guardedValue = map['c3dCaPassphrase'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      c3dCertExtensionCustomOids: (() {
        final guardedValue = map['c3dCertExtensionCustomOids'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      c3dCertExtensionIncludes: (() {
        final guardedValue = map['c3dCertExtensionIncludes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      c3dCertLifespan: (() {
        final guardedValue = map['c3dCertLifespan'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      c3dCertificateExtensions: (() {
        final guardedValue = map['c3dCertificateExtensions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      caFile: (() {
      ...
      expireCertResponseControl: (() {
        final guardedValue = map['expireCertResponseControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      fullPath: (() {
      ...
      untrustedCertResponseControl: (() {
        final guardedValue = map['untrustedCertResponseControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
