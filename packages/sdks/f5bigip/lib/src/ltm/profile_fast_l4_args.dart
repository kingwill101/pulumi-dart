...
class ProfileFastL4Args {
  ...
  factory ProfileFastL4Args.fromMap(Map<String, dynamic> map) {
    return ProfileFastL4Args(
      clientTimeout: (() {
        final guardedValue = map['clientTimeout'];
      ...
      explicitflowMigration: (() {
        final guardedValue = map['explicitflowMigration'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      hardwareSyncookie: (() {
        final guardedValue = map['hardwareSyncookie'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      idleTimeout: (() {
      ...
      iptosToclient: (() {
        final guardedValue = map['iptosToclient'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      iptosToserver: (() {
        final guardedValue = map['iptosToserver'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      keepaliveInterval: (() {
      ...
      lateBinding: (() {
        final guardedValue = map['lateBinding'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      looseClose: (() {
        final guardedValue = map['looseClose'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      looseInitiation: (() {
        final guardedValue = map['looseInitiation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ...
      tcpHandshakeTimeout: (() {
        final guardedValue = map['tcpHandshakeTimeout'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
