...
class ProfileFtpState {
  ...
  factory ProfileFtpState.fromMap(Map<String, dynamic> map) {
    return ProfileFtpState(
      allowActiveMode: (() {
        final guardedValue = map['allowActiveMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      allowFtps: (() {
        final guardedValue = map['allowFtps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      appService: (() {
      ...
      enforceTlssessionReuse: (() {
        final guardedValue = map['enforceTlssessionReuse'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ftpsMode: (() {
        final guardedValue = map['ftpsMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inheritParentProfile: (() {
        final guardedValue = map['inheritParentProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      inheritVlanList: (() {
        final guardedValue = map['inheritVlanList'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logProfile: (() {
        final guardedValue = map['logProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      logPublisher: (() {
        final guardedValue = map['logPublisher'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      translateExtended: (() {
        final guardedValue = map['translateExtended'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
