...
class ProfileOneConnectState {
  ...
  factory ProfileOneConnectState.fromMap(Map<String, dynamic> map) {
    return ProfileOneConnectState(
      ...
      idleTimeoutOverride: (() { final guardedValue = map['idleTimeoutOverride']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      maxReuse: (() { final guardedValue = map['maxReuse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      sharePools: (() { final guardedValue = map['sharePools']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sourceMask: (() { final guardedValue = map['sourceMask']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
