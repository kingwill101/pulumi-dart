...
class VirtualServerState {
  ...
  factory VirtualServerState.fromMap(Map<String, dynamic> map) {
    return VirtualServerState(
      clientProfiles: (() {
        final guardedValue = map['clientProfiles'];
      ...
      defaultPersistenceProfile: (() {
        final guardedValue = map['defaultPersistenceProfile'];
        if (guardedValue == null) return null;
      ...
      fallbackPersistenceProfile: (() {
        final guardedValue = map['fallbackPersistenceProfile'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firewallEnforcedPolicy: (() {
        final guardedValue = map['firewallEnforcedPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ipProtocol: (() {
      ...
      perFlowRequestAccessPolicy: (() {
        final guardedValue = map['perFlowRequestAccessPolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      persistenceProfiles: (() {
        final guardedValue = map['persistenceProfiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      policies: (() {
      ...
      serverProfiles: (() {
        final guardedValue = map['serverProfiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      snatpool: (() {
      ...
      sourceAddressTranslation: (() {
        final guardedValue = map['sourceAddressTranslation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sourcePort: (() {
      ...
      trafficmatchingCriteria: (() {
        final guardedValue = map['trafficmatchingCriteria'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      translateAddress: (() {
        final guardedValue = map['translateAddress'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      translatePort: (() {
        final guardedValue = map['translatePort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      vlans: (() {
      ...
      vlansEnabled: (() {
        final guardedValue = map['vlansEnabled'];
        if (guardedValue == null) return null;
