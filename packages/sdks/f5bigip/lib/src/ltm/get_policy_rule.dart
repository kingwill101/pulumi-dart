...
class GetPolicyRule {
  ...
  GetPolicyRule({this.actions, this.conditions, required this.name});
  ...
  factory GetPolicyRule.fromMap(Map<String, dynamic> map) {
    return GetPolicyRule(
      ...
      conditions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<GetPolicyRuleCondition>(
            guardedValue,
            (value) => GetPolicyRuleCondition.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
