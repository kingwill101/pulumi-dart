...
class PoolAttachmentState {
  ...
  factory PoolAttachmentState.fromMap(Map<String, dynamic> map) {
    return PoolAttachmentState(
      ...
      connectionRateLimit: (() { final guardedValue = map['connectionRateLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      fqdnAutopopulate: (() { final guardedValue = map['fqdnAutopopulate']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
