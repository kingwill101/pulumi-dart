...
class ProfileClientSsl extends pulumi.CustomResource {
  ...
  ProfileClientSsl(
    ...
    c3dDropUnknownOcspStatus = registerOutput<String>('c3dDropUnknownOcspStatus');
    ...
    certExtensionIncludes = registerOutput<List<String>>('certExtensionIncludes');
    certKeyChain = registerOutput<ProfileClientSslCertKeyChain?>('certKeyChain', decoder: (raw) { final guardedValue = raw; if (guardedValue == null) return null; return ProfileClientSslCertKeyChain.fromMap((guardedValue as Map).cast<String, dynamic>()); });
    ...
    forwardProxyBypassDefaultAction = registerOutput<String>('forwardProxyBypassDefaultAction');
