...
import 'persistence_profile_cookie_state.dart';
...
class PersistenceProfileCookie extends pulumi.CustomResource {
  ...
  PersistenceProfileCookie(
    ...
    cookieEncryptionPassphrase = registerOutput<String>('cookieEncryptionPassphrase');
  ...
  static PersistenceProfileCookie get(
    String name,
    pulumi.Input<String> id, {
    PersistenceProfileCookieState? state,
  }) {
    return PersistenceProfileCookie._get(
      name,
      state: state?.toMap(),
