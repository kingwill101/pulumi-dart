...
import 'cipher_group_state.dart';
...
class CipherGroup extends pulumi.CustomResource {
  ...
  CipherGroup(
    ...
    ordering = registerOutput<String?>('ordering');
    requires = registerOutput<List<String>?>('requires');
  }

  /// Gets an existing [CipherGroup] resource's state with the given [name] and [id].
  static CipherGroup get(
    String name,
    pulumi.Input<String> id, {
    CipherGroupState? state,
  }) {
    return CipherGroup._get(
      name,
      state: state?.toMap(),
