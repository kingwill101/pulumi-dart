...
class ProfileRewriteUriRulesArgs {
    ...
    return <String, dynamic>{
      'clients':
          pulumi.Input.mapInputValue<
            List<ProfileRewriteUriRulesClient>,
      ...
      'servers':
          pulumi.Input.mapInputValue<
            List<ProfileRewriteUriRulesServer>,
            List<Map<String, dynamic>>
          >(
            servers,
            (value) =>
  ...
  factory ProfileRewriteUriRulesArgs.fromMap(Map<String, dynamic> map) {
    return ProfileRewriteUriRulesArgs(
      clients: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ProfileRewriteUriRulesClient>(
          map['clients']!,
          (value) => ProfileRewriteUriRulesClient.fromMap(
      ...
      servers: pulumi.Input.fromValue(
        pulumi.Input.decodeList<ProfileRewriteUriRulesServer>(
          map['servers']!,
          (value) => ProfileRewriteUriRulesServer.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
