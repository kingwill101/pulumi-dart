...
class ProfileRewriteUriRulesArgs {
  ...
  factory ProfileRewriteUriRulesArgs.fromMap(Map<String, dynamic> map) {
    return ProfileRewriteUriRulesArgs(
      clients: pulumi.Input.fromValue(pulumi.Input.decodeList<ProfileRewriteUriRulesClient>(map['clients']!, (value) => ProfileRewriteUriRulesClient.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      servers: pulumi.Input.fromValue(pulumi.Input.decodeList<ProfileRewriteUriRulesServer>(map['servers']!, (value) => ProfileRewriteUriRulesServer.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
