...
class ProfileHttpHttpStrictTransportSecurity {
  ...
  factory ProfileHttpHttpStrictTransportSecurity.fromMap(
    Map<String, dynamic> map,
  ) {
    return ProfileHttpHttpStrictTransportSecurity(
      includeSubdomains: (() {
        final guardedValue = map['includeSubdomains'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      maximumAge: (() {
        final guardedValue = map['maximumAge'];
        if (guardedValue == null) return null;
      ...
      preload: (() {
        final guardedValue = map['preload'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
