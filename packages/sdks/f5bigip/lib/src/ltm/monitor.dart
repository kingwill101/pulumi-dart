...
class Monitor extends pulumi.CustomResource {
  ...
  Monitor(
    ...
    chaseReferrals = registerOutput<String>('chaseReferrals');
    compatibility = registerOutput<String?>('compatibility');
    customParent = registerOutput<String?>('customParent');
    ...
    ipDscp = registerOutput<int>('ipDscp');
    mandatoryAttributes = registerOutput<String?>('mandatoryAttributes');
    manualResume = registerOutput<String>('manualResume');
    mode = registerOutput<String>('mode');
    this.name = registerOutput<String>('name');
    parent = registerOutput<String>('parent');
    password = registerOutput<String?>('password');
    receive = registerOutput<String?>('receive');
    receiveDisable = registerOutput<String?>('receiveDisable');
    reverse = registerOutput<String>('reverse');
    security = registerOutput<String?>('security');
    send = registerOutput<String>('send');
    sslProfile = registerOutput<String?>('sslProfile');
    timeUntilUp = registerOutput<int>('timeUntilUp');
    timeout = registerOutput<int>('timeout');
    transparent = registerOutput<String>('transparent');
    upInterval = registerOutput<int>('upInterval');
