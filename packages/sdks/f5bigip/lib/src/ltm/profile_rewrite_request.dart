...
class ProfileRewriteRequest {
  ...
  factory ProfileRewriteRequest.fromMap(Map<String, dynamic> map) {
    return ProfileRewriteRequest(
      insertXfwdFor: (() { final guardedValue = map['insertXfwdFor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      insertXfwdHost: (() { final guardedValue = map['insertXfwdHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      insertXfwdProtocol: (() { final guardedValue = map['insertXfwdProtocol']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
