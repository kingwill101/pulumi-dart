...
class ProfileHttpEnforcement {
  ...
  factory ProfileHttpEnforcement.fromMap(Map<String, dynamic> map) {
    return ProfileHttpEnforcement(
      knownMethods: (() { final guardedValue = map['knownMethods']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      maxHeaderCount: (() { final guardedValue = map['maxHeaderCount']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      unknownMethod: (() { final guardedValue = map['unknownMethod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
