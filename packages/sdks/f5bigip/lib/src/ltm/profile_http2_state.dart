...
class ProfileHttp2State {
  ...
  factory ProfileHttp2State.fromMap(Map<String, dynamic> map) {
    return ProfileHttp2State(
      activationModes: (() { final guardedValue = map['activationModes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      concurrentStreamsPerConnection: (() { final guardedValue = map['concurrentStreamsPerConnection']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      connectionIdleTimeout: (() { final guardedValue = map['connectionIdleTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      enforceTlsRequirements: (() { final guardedValue = map['enforceTlsRequirements']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      frameSize: (() { final guardedValue = map['frameSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      headerTableSize: (() { final guardedValue = map['headerTableSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      includeContentLength: (() { final guardedValue = map['includeContentLength']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      insertHeader: (() { final guardedValue = map['insertHeader']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      insertHeaderName: (() { final guardedValue = map['insertHeaderName']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      receiveWindow: (() { final guardedValue = map['receiveWindow']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      writeSize: (() { final guardedValue = map['writeSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
