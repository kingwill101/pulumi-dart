...
class ProfileTcpState {
  ...
  factory ProfileTcpState.fromMap(Map<String, dynamic> map) {
    return ProfileTcpState(
      closeWaitTimeout: map['closeWaitTimeout'] == null ? null : (map['closeWaitTimeout'] as int).input(),
      congestionControl: map['congestionControl'] == null ? null : (map['congestionControl'] as String).input(),
      defaultsFrom: map['defaultsFrom'] == null ? null : (map['defaultsFrom'] as String).input(),
      deferredAccept: map['deferredAccept'] == null ? null : (map['deferredAccept'] as String).input(),
      delayedAcks: map['delayedAcks'] == null ? null : (map['delayedAcks'] as String).input(),
      earlyRetransmit: map['earlyRetransmit'] == null ? null : (map['earlyRetransmit'] as String).input(),
      fastOpen: map['fastOpen'] == null ? null : (map['fastOpen'] as String).input(),
      finwait2timeout: map['finwait2timeout'] == null ? null : (map['finwait2timeout'] as int).input(),
      finwaitTimeout: map['finwaitTimeout'] == null ? null : (map['finwaitTimeout'] as int).input(),
      idleTimeout: map['idleTimeout'] == null ? null : (map['idleTimeout'] as int).input(),
      initialCongestionWindowsize: map['initialCongestionWindowsize'] == null ? null : (map['initialCongestionWindowsize'] as int).input(),
      keepaliveInterval: map['keepaliveInterval'] == null ? null : (map['keepaliveInterval'] as int).input(),
      nagle: map['nagle'] == null ? null : (map['nagle'] as String).input(),
      name: map['name'] == null ? null : (map['name'] as String).input(),
      partition: map['partition'] == null ? null : (map['partition'] as String).input(),
      proxybufferHigh: map['proxybufferHigh'] == null ? null : (map['proxybufferHigh'] as int).input(),
      receiveWindowsize: map['receiveWindowsize'] == null ? null : (map['receiveWindowsize'] as int).input(),
      sendBuffersize: map['sendBuffersize'] == null ? null : (map['sendBuffersize'] as int).input(),
      taillossProbe: map['taillossProbe'] == null ? null : (map['taillossProbe'] as String).input(),
      timewaitRecycle: map['timewaitRecycle'] == null ? null : (map['timewaitRecycle'] as String).input(),
      verifiedAccept: map['verifiedAccept'] == null ? null : (map['verifiedAccept'] as String).input(),
      zerowindowTimeout: map['zerowindowTimeout'] == null ? null : (map['zerowindowTimeout'] as int).input(),
    );
  }
}
