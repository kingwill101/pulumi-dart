...
class ProfileTcpState {
  ...
  factory ProfileTcpState.fromMap(Map<String, dynamic> map) {
    return ProfileTcpState(
      closeWaitTimeout: (() { final guardedValue = map['closeWaitTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      congestionControl: (() { final guardedValue = map['congestionControl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      deferredAccept: (() { final guardedValue = map['deferredAccept']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      delayedAcks: (() { final guardedValue = map['delayedAcks']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      earlyRetransmit: (() { final guardedValue = map['earlyRetransmit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      fastOpen: (() { final guardedValue = map['fastOpen']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      finwait2timeout: (() { final guardedValue = map['finwait2timeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      finwaitTimeout: (() { final guardedValue = map['finwaitTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      initialCongestionWindowsize: (() { final guardedValue = map['initialCongestionWindowsize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      nagle: (() { final guardedValue = map['nagle']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      proxybufferHigh: (() { final guardedValue = map['proxybufferHigh']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      sendBuffersize: (() { final guardedValue = map['sendBuffersize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      taillossProbe: (() { final guardedValue = map['taillossProbe']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      timewaitRecycle: (() { final guardedValue = map['timewaitRecycle']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      verifiedAccept: (() { final guardedValue = map['verifiedAccept']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      zerowindowTimeout: (() { final guardedValue = map['zerowindowTimeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
    );
  }
}
