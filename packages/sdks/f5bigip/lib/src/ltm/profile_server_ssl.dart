...
class ProfileServerSsl extends pulumi.CustomResource {
  ...
  ProfileServerSsl(
    ...
    c3dCertExtensionCustomOids = registerOutput<List<String>?>(
      'c3dCertExtensionCustomOids',
    );
    c3dCertExtensionIncludes = registerOutput<List<String>?>(
      'c3dCertExtensionIncludes',
    );
    c3dCertLifespan = registerOutput<int>('c3dCertLifespan');
    c3dCertificateExtensions = registerOutput<String>(
    ...
    expireCertResponseControl = registerOutput<String>(
    ...
    untrustedCertResponseControl = registerOutput<String>(
