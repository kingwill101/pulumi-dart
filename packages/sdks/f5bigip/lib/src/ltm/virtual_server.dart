...
class VirtualServer extends pulumi.CustomResource {
  ...
  VirtualServer(
    ...
    defaultPersistenceProfile = registerOutput<String>(
      'defaultPersistenceProfile',
    );
    description = registerOutput<String?>('description');
    destination = registerOutput<String?>('destination');
    fallbackPersistenceProfile = registerOutput<String>(
    ...
    perFlowRequestAccessPolicy = registerOutput<String>(
    ...
    sourceAddressTranslation = registerOutput<String>(
