...
class ProfileRewriteResponse {
  ...
  factory ProfileRewriteResponse.fromMap(Map<String, dynamic> map) {
    return ProfileRewriteResponse(
      rewriteContent: (() { final guardedValue = map['rewriteContent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      rewriteHeaders: (() { final guardedValue = map['rewriteHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
