...
class AwsIntegrationsAwsKinesisAnalytics {
  /// Specify each AWS region that includes the resources that you want to monitor.
  final pulumi.Input<List<String>>? awsRegions;
  /// The data polling interval in seconds.
  final pulumi.Input<int>? metricsPollingInterval;

  /// Creates a new [AwsIntegrationsAwsKinesisAnalytics].
  /// [awsRegions] Specify each AWS region that includes the resources that you want to monitor.
  /// [metricsPollingInterval] The data polling interval in seconds.
  const AwsIntegrationsAwsKinesisAnalytics({
    this.awsRegions,
  ...
  factory AwsIntegrationsAwsKinesisAnalytics.fromMap(Map<String, dynamic> map) {
    return AwsIntegrationsAwsKinesisAnalytics(
