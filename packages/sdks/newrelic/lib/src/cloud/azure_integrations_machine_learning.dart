...
class AzureIntegrationsMachineLearning {
  /// The data polling interval in seconds
  final pulumi.Input<int>? metricsPollingInterval;
  /// Specify each Resource group associated with the resources that you want to monitor. Filter values are case-sensitive
  final pulumi.Input<List<String>>? resourceGroups;

  /// Creates a new [AzureIntegrationsMachineLearning].
  ...
  const AzureIntegrationsMachineLearning({
  ...
  factory AzureIntegrationsMachineLearning.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsMachineLearning(
