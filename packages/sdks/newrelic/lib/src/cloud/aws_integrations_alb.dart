...
class AwsIntegrationsAlb {
  ...
  factory AwsIntegrationsAlb.fromMap(Map<String, dynamic> map) {
    return AwsIntegrationsAlb(
      ...
      loadBalancerPrefixes: (() { final guardedValue = map['loadBalancerPrefixes']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
