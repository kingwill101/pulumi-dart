...
class AwsIntegrationsElasticache {
  ...
  /// Creates a new [AwsIntegrationsElasticache].
  ...
  factory AwsIntegrationsElasticache.fromMap(Map<String, dynamic> map) {
    return AwsIntegrationsElasticache(
