...
class AzureIntegrationsCosmosDb {
  ...
  /// Creates a new [AzureIntegrationsCosmosDb].
  ...
  AzureIntegrationsCosmosDb({this.metricsPollingInterval, this.resourceGroups});
  ...
  factory AzureIntegrationsCosmosDb.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsCosmosDb(
