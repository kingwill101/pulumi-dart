...
class AzureIntegrationsKeyVault {
  ...
  /// Creates a new [AzureIntegrationsKeyVault].
  ...
  AzureIntegrationsKeyVault({this.metricsPollingInterval, this.resourceGroups});
  ...
  factory AzureIntegrationsKeyVault.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsKeyVault(
