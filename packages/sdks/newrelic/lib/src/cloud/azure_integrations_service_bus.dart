...
class AzureIntegrationsServiceBus {
  ...
  const AzureIntegrationsServiceBus({
  ...
  factory AzureIntegrationsServiceBus.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsServiceBus(
