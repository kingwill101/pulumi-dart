...
class AwsIntegrationsEc2 {
  ...
  factory AwsIntegrationsEc2.fromMap(Map<String, dynamic> map) {
    return AwsIntegrationsEc2(
      ...
      duplicateEc2Tags: (() { final guardedValue = map['duplicateEc2Tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
