...
class AwsGovcloudIntegrationsEmr {
  ...
  const AwsGovcloudIntegrationsEmr({
    this.awsRegions,
    this.fetchTags,
  ...
  factory AwsGovcloudIntegrationsEmr.fromMap(Map<String, dynamic> map) {
    return AwsGovcloudIntegrationsEmr(
      awsRegions: (() { final guardedValue = map['awsRegions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
