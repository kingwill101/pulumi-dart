...
class AzureIntegrationsContainers {
  ...
  const AzureIntegrationsContainers({
  ...
  factory AzureIntegrationsContainers.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsContainers(
