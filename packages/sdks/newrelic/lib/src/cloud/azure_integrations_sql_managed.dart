...
class AzureIntegrationsSqlManaged {
  ...
  const AzureIntegrationsSqlManaged({
  ...
  factory AzureIntegrationsSqlManaged.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsSqlManaged(
