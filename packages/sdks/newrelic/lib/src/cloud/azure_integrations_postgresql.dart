...
class AzureIntegrationsPostgresql {
  ...
  const AzureIntegrationsPostgresql({
  ...
  factory AzureIntegrationsPostgresql.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsPostgresql(
