...
class AwsIntegrationsRds {
  ...
  /// Creates a new [AwsIntegrationsRds].
  ...
  factory AwsIntegrationsRds.fromMap(Map<String, dynamic> map) {
    return AwsIntegrationsRds(
