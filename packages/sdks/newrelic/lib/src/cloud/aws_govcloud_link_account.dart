...
import 'aws_govcloud_link_account_state.dart';
...
class AwsGovcloudLinkAccount extends pulumi.CustomResource {
  ...
  /// Gets an existing [AwsGovcloudLinkAccount] resource's state with the given [name] and [id].
  static AwsGovcloudLinkAccount get(
    String name,
    pulumi.Input<String> id, {
    AwsGovcloudLinkAccountState? state,
  }) {
    return AwsGovcloudLinkAccount._get(
      name,
      state: state?.toMap(),
