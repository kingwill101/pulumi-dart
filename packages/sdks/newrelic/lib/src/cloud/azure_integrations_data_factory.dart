...
class AzureIntegrationsDataFactory {
  ...
  const AzureIntegrationsDataFactory({
  ...
  factory AzureIntegrationsDataFactory.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsDataFactory(
