...
class AzureIntegrationsFunctions {
  ...
  const AzureIntegrationsFunctions({
  ...
  factory AzureIntegrationsFunctions.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsFunctions(
