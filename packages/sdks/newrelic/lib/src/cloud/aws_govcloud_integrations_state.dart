...
class AwsGovcloudIntegrationsState {
  ...
  AwsGovcloudIntegrationsState({
    pulumi.Output<String>? accountId,
    pulumi.Output<AwsGovcloudIntegrationsAlb>? alb,
    pulumi.Output<AwsGovcloudIntegrationsApiGateway>? apiGateway,
    pulumi.Output<AwsGovcloudIntegrationsAutoScaling>? autoScaling,
    pulumi.Output<AwsGovcloudIntegrationsAwsDirectConnect>? awsDirectConnect,
    pulumi.Output<AwsGovcloudIntegrationsAwsStates>? awsStates,
    pulumi.Output<AwsGovcloudIntegrationsCloudtrail>? cloudtrail,
    pulumi.Output<AwsGovcloudIntegrationsDynamoDb>? dynamoDb,
    pulumi.Output<AwsGovcloudIntegrationsEbs>? ebs,
    pulumi.Output<AwsGovcloudIntegrationsEc2>? ec2,
    pulumi.Output<AwsGovcloudIntegrationsElasticSearch>? elasticSearch,
    pulumi.Output<AwsGovcloudIntegrationsElb>? elb,
    pulumi.Output<AwsGovcloudIntegrationsEmr>? emr,
    pulumi.Output<AwsGovcloudIntegrationsIam>? iam,
    pulumi.Output<AwsGovcloudIntegrationsLambda>? lambda,
    pulumi.Output<String>? linkedAccountId,
    pulumi.Output<AwsGovcloudIntegrationsRds>? rds,
    pulumi.Output<AwsGovcloudIntegrationsRedShift>? redShift,
    pulumi.Output<AwsGovcloudIntegrationsRoute53>? route53,
    pulumi.Output<AwsGovcloudIntegrationsS3>? s3,
    pulumi.Output<AwsGovcloudIntegrationsSns>? sns,
    pulumi.Output<AwsGovcloudIntegrationsSqs>? sqs,
  }) :
  ...
  factory AwsGovcloudIntegrationsState.fromMap(Map<String, dynamic> map) {
    return AwsGovcloudIntegrationsState(
      ...
      alb: map['alb'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsAlb>(AwsGovcloudIntegrationsAlb.fromMap((map['alb'] as Map).cast<String, dynamic>())),
      apiGateway: map['apiGateway'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsApiGateway>(AwsGovcloudIntegrationsApiGateway.fromMap((map['apiGateway'] as Map).cast<String, dynamic>())),
      autoScaling: map['autoScaling'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsAutoScaling>(AwsGovcloudIntegrationsAutoScaling.fromMap((map['autoScaling'] as Map).cast<String, dynamic>())),
      awsDirectConnect: map['awsDirectConnect'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsAwsDirectConnect>(AwsGovcloudIntegrationsAwsDirectConnect.fromMap((map['awsDirectConnect'] as Map).cast<String, dynamic>())),
      awsStates: map['awsStates'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsAwsStates>(AwsGovcloudIntegrationsAwsStates.fromMap((map['awsStates'] as Map).cast<String, dynamic>())),
      cloudtrail: map['cloudtrail'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsCloudtrail>(AwsGovcloudIntegrationsCloudtrail.fromMap((map['cloudtrail'] as Map).cast<String, dynamic>())),
      dynamoDb: map['dynamoDb'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsDynamoDb>(AwsGovcloudIntegrationsDynamoDb.fromMap((map['dynamoDb'] as Map).cast<String, dynamic>())),
      ebs: map['ebs'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsEbs>(AwsGovcloudIntegrationsEbs.fromMap((map['ebs'] as Map).cast<String, dynamic>())),
      ec2: map['ec2'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsEc2>(AwsGovcloudIntegrationsEc2.fromMap((map['ec2'] as Map).cast<String, dynamic>())),
      elasticSearch: map['elasticSearch'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsElasticSearch>(AwsGovcloudIntegrationsElasticSearch.fromMap((map['elasticSearch'] as Map).cast<String, dynamic>())),
      elb: map['elb'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsElb>(AwsGovcloudIntegrationsElb.fromMap((map['elb'] as Map).cast<String, dynamic>())),
      emr: map['emr'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsEmr>(AwsGovcloudIntegrationsEmr.fromMap((map['emr'] as Map).cast<String, dynamic>())),
      iam: map['iam'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsIam>(AwsGovcloudIntegrationsIam.fromMap((map['iam'] as Map).cast<String, dynamic>())),
      lambda: map['lambda'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsLambda>(AwsGovcloudIntegrationsLambda.fromMap((map['lambda'] as Map).cast<String, dynamic>())),
      linkedAccountId: map['linkedAccountId'] == null ? null : pulumi.Output.create<String>(map['linkedAccountId'] as String),
      rds: map['rds'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsRds>(AwsGovcloudIntegrationsRds.fromMap((map['rds'] as Map).cast<String, dynamic>())),
      redShift: map['redShift'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsRedShift>(AwsGovcloudIntegrationsRedShift.fromMap((map['redShift'] as Map).cast<String, dynamic>())),
      route53: map['route53'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsRoute53>(AwsGovcloudIntegrationsRoute53.fromMap((map['route53'] as Map).cast<String, dynamic>())),
      s3: map['s3'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsS3>(AwsGovcloudIntegrationsS3.fromMap((map['s3'] as Map).cast<String, dynamic>())),
      sns: map['sns'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsSns>(AwsGovcloudIntegrationsSns.fromMap((map['sns'] as Map).cast<String, dynamic>())),
      sqs: map['sqs'] == null ? null : pulumi.Output.create<AwsGovcloudIntegrationsSqs>(AwsGovcloudIntegrationsSqs.fromMap((map['sqs'] as Map).cast<String, dynamic>())),
    );
  }
}
