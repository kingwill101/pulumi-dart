...
class AwsGovcloudIntegrationsRds {
  ...
  /// Creates a new [AwsGovcloudIntegrationsRds].
  ...
  const AwsGovcloudIntegrationsRds({
    this.awsRegions,
    this.fetchTags,
  ...
  factory AwsGovcloudIntegrationsRds.fromMap(Map<String, dynamic> map) {
    return AwsGovcloudIntegrationsRds(
