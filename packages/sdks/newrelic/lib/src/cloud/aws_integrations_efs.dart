...
class AwsIntegrationsEfs {
  ...
  /// Creates a new [AwsIntegrationsEfs].
  ...
  factory AwsIntegrationsEfs.fromMap(Map<String, dynamic> map) {
    return AwsIntegrationsEfs(
