...
class OciLinkAccountState {
  ...
  factory OciLinkAccountState.fromMap(Map<String, dynamic> map) {
    return OciLinkAccountState(
      ...
      compartmentOcid: (() {
        final guardedValue = map['compartmentOcid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ingestVaultOcid: (() {
        final guardedValue = map['ingestVaultOcid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      instrumentationType: (() {
        final guardedValue = map['instrumentationType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loggingStackOcid: (() {
        final guardedValue = map['loggingStackOcid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      metricStackOcid: (() {
        final guardedValue = map['metricStackOcid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      ociClientId: (() {
        final guardedValue = map['ociClientId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ociClientSecret: (() {
        final guardedValue = map['ociClientSecret'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ociDomainUrl: (() {
        final guardedValue = map['ociDomainUrl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ociHomeRegion: (() {
        final guardedValue = map['ociHomeRegion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      ociRegion: (() {
        final guardedValue = map['ociRegion'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      tenantId: (() {
      ...
      userVaultOcid: (() {
        final guardedValue = map['userVaultOcid'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
