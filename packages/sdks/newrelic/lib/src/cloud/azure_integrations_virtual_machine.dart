...
class AzureIntegrationsVirtualMachine {
  ...
  const AzureIntegrationsVirtualMachine({
  ...
  factory AzureIntegrationsVirtualMachine.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsVirtualMachine(
