...
class AzureIntegrationsLogicApps {
  ...
  const AzureIntegrationsLogicApps({
  ...
  factory AzureIntegrationsLogicApps.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsLogicApps(
