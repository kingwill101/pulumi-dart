...
class AwsIntegrationsElasticbeanstalk {
  ...
  /// Creates a new [AwsIntegrationsElasticbeanstalk].
  ...
  const AwsIntegrationsElasticbeanstalk({
    this.awsRegions,
  ...
  factory AwsIntegrationsElasticbeanstalk.fromMap(Map<String, dynamic> map) {
    return AwsIntegrationsElasticbeanstalk(
