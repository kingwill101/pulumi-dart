...
class ApplicationSettingsState {
  ...
  final pulumi.Input<List<ApplicationSettingsTransactionTracer>>?
  transactionTracers;
    ...
    return <String, dynamic>{
      ...
      'errorCollectors':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationSettingsErrorCollector>,
      ...
      'transactionTracers':
          ?pulumi.Input.mapOptionalInputValue<
            List<ApplicationSettingsTransactionTracer>,
            List<Map<String, dynamic>>
          >(
            transactionTracers,
            (value) =>
  ...
  factory ApplicationSettingsState.fromMap(Map<String, dynamic> map) {
    return ApplicationSettingsState(
      appApdexThreshold: (() {
        final guardedValue = map['appApdexThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      enableRealUserMonitoring: (() {
        final guardedValue = map['enableRealUserMonitoring'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableSlowSql: (() {
        final guardedValue = map['enableSlowSql'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      enableThreadProfiler: (() {
        final guardedValue = map['enableThreadProfiler'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      endUserApdexThreshold: (() {
        final guardedValue = map['endUserApdexThreshold'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      errorCollectors: (() {
        final guardedValue = map['errorCollectors'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationSettingsErrorCollector>(
            guardedValue,
            (value) => ApplicationSettingsErrorCollector.fromMap(
      ...
      isImported: (() {
        final guardedValue = map['isImported'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      name: (() {
      ...
      tracerType: (() {
        final guardedValue = map['tracerType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      transactionTracers: (() {
        final guardedValue = map['transactionTracers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ApplicationSettingsTransactionTracer>(
            guardedValue,
            (value) => ApplicationSettingsTransactionTracer.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      useServerSideConfig: (() {
        final guardedValue = map['useServerSideConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
    );
