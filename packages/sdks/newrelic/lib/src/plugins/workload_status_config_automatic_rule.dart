...
class WorkloadStatusConfigAutomaticRule {
  ...
  final pulumi.Input<List<WorkloadStatusConfigAutomaticRuleNrqlQuery>>?
  nrqlQueries;
    ...
    return <String, dynamic>{
      ...
      'nrqlQueries':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkloadStatusConfigAutomaticRuleNrqlQuery>,
  ...
  factory WorkloadStatusConfigAutomaticRule.fromMap(Map<String, dynamic> map) {
    return WorkloadStatusConfigAutomaticRule(
      ...
      nrqlQueries: (() {
        final guardedValue = map['nrqlQueries'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkloadStatusConfigAutomaticRuleNrqlQuery>(
            guardedValue,
            (value) => WorkloadStatusConfigAutomaticRuleNrqlQuery.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      rollup: pulumi.Input.fromValue(
        WorkloadStatusConfigAutomaticRuleRollup.fromMap(
          (map['rollup']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
