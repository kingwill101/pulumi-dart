...
class WorkloadStatusConfigAutomatic {
  ...
  factory WorkloadStatusConfigAutomatic.fromMap(Map<String, dynamic> map) {
    return WorkloadStatusConfigAutomatic(
      ...
      remainingEntitiesRule: (() { final guardedValue = map['remainingEntitiesRule']; if (guardedValue == null) return null; return pulumi.Input.fromValue(WorkloadStatusConfigAutomaticRemainingEntitiesRule.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      rules: (() { final guardedValue = map['rules']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkloadStatusConfigAutomaticRule>(guardedValue, (value) => WorkloadStatusConfigAutomaticRule.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
