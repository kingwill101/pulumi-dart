...
class ApplicationSettingsTransactionTracer {
  ...
  factory ApplicationSettingsTransactionTracer.fromMap(Map<String, dynamic> map) {
    return ApplicationSettingsTransactionTracer(
      explainQueryPlans: (() { final guardedValue = map['explainQueryPlans']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<ApplicationSettingsTransactionTracerExplainQueryPlan>(guardedValue, (value) => ApplicationSettingsTransactionTracerExplainQueryPlan.fromMap((value as Map).cast<String, dynamic>()))); })(),
      sql: (() { final guardedValue = map['sql']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ApplicationSettingsTransactionTracerSql.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      stackTraceThresholdValue: (() { final guardedValue = map['stackTraceThresholdValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      transactionThresholdType: (() { final guardedValue = map['transactionThresholdType']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      transactionThresholdValue: (() { final guardedValue = map['transactionThresholdValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
    );
  }
}
