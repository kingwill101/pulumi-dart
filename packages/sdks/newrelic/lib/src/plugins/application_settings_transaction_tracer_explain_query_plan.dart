...
class ApplicationSettingsTransactionTracerExplainQueryPlan {
  ...
  factory ApplicationSettingsTransactionTracerExplainQueryPlan.fromMap(
    Map<String, dynamic> map,
  ) {
    return ApplicationSettingsTransactionTracerExplainQueryPlan(
      queryPlanThresholdType: (() {
        final guardedValue = map['queryPlanThresholdType'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      queryPlanThresholdValue: (() {
        final guardedValue = map['queryPlanThresholdValue'];
        if (guardedValue == null) return null;
