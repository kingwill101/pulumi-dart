...
class ScriptMonitorLocationPrivate {
  ...
  ScriptMonitorLocationPrivate({required this.guid, this.vsePassword});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'guid': guid, 'vsePassword': ?vsePassword};
  }
  ...
  factory ScriptMonitorLocationPrivate.fromMap(Map<String, dynamic> map) {
    return ScriptMonitorLocationPrivate(
      ...
      vsePassword: (() {
        final guardedValue = map['vsePassword'];
