    ...
    return <String, dynamic>{
      ...
      'locationPrivates':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScriptMonitorLocationPrivate>,
      ...
      'tags':
          ?pulumi.Input.mapOptionalInputValue<
            List<ScriptMonitorTag>,
            List<Map<String, dynamic>>
          >(
            tags,
            (value) =>
                pulumi.Input.encodeList<ScriptMonitorTag, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return ScriptMonitorArgs(
      ...
      locationPrivates: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScriptMonitorLocationPrivate>(
            guardedValue,
            (value) => ScriptMonitorLocationPrivate.fromMap(
      ...
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ScriptMonitorTag>(
            guardedValue,
            (value) => ScriptMonitorTag.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
