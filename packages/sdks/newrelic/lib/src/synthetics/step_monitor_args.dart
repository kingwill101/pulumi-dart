...
class StepMonitorArgs {
  ...
  factory StepMonitorArgs.fromMap(Map<String, dynamic> map) {
    return StepMonitorArgs(
      ...
      steps: pulumi.Input.fromValue(pulumi.Input.decodeList<StepMonitorStep>(map['steps']!, (value) => StepMonitorStep.fromMap((value as Map).cast<String, dynamic>()))),
