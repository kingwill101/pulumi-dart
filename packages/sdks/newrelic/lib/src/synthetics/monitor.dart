...
class Monitor extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<MonitorCustomHeader>?> customHeaders;
  ...
  late final pulumi.Output<List<MonitorTag>?> tags;
  ...
  Monitor(
    ...
    this.bypassHeadRequest = registerOutput<bool?>('bypassHeadRequest');
    this.customHeaders = registerOutput<List<MonitorCustomHeader>?>('customHeaders');
    ...
    this.tags = registerOutput<List<MonitorTag>?>('tags');
    this.treatRedirectAsFailure = registerOutput<bool?>('treatRedirectAsFailure');
    this.type = registerOutput<String>('type');
    this.uri = registerOutput<String?>('uri');
    this.useUnsupportedLegacyRuntime = registerOutput<bool?>('useUnsupportedLegacyRuntime');
    this.validationString = registerOutput<String?>('validationString');
    this.verifySsl = registerOutput<bool?>('verifySsl');
  }
