...
class StepMonitorState {
  ...
  StepMonitorState({
    ...
    pulumi.Output<List<StepMonitorStep>>? steps,
    ...
    pulumi.Output<bool>? useUnsupportedLegacyRuntime,
      ...
      steps = pulumi.Input.asOptionalInput<List<StepMonitorStep>>(steps),
  ...
  factory StepMonitorState.fromMap(Map<String, dynamic> map) {
    return StepMonitorState(
      ...
      steps: map['steps'] == null ? null : pulumi.Output.create<List<StepMonitorStep>>(pulumi.Input.decodeList<StepMonitorStep>(map['steps'], (value) => StepMonitorStep.fromMap((value as Map).cast<String, dynamic>()))),
