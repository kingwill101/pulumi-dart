...
class StepMonitorState {
    ...
    return <String, dynamic>{
      ...
      'locationPrivates':
          ?pulumi.Input.mapOptionalInputValue<
            List<StepMonitorLocationPrivate>,
      ...
      'steps':
          ?pulumi.Input.mapOptionalInputValue<
            List<StepMonitorStep>,
            List<Map<String, dynamic>>
          >(
            steps,
            (value) =>
                pulumi.Input.encodeList<StepMonitorStep, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'tags':
          ...
          >(
            tags,
            (value) =>
                pulumi.Input.encodeList<StepMonitorTag, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory StepMonitorState.fromMap(Map<String, dynamic> map) {
    return StepMonitorState(
      ...
      locationPrivates: (() {
        final guardedValue = map['locationPrivates'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StepMonitorLocationPrivate>(
            guardedValue,
            (value) => StepMonitorLocationPrivate.fromMap(
      ...
      steps: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StepMonitorStep>(
            guardedValue,
            (value) =>
                StepMonitorStep.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      tags: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<StepMonitorTag>(
            guardedValue,
            (value) =>
                StepMonitorTag.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
