...
class StepMonitor extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<StepMonitorLocationPrivate>?> locationPrivates;
  ...
  late final pulumi.Output<List<StepMonitorStep>> steps;
  /// The tags that will be associated with the monitor. See Nested tag blocks below for details.
  late final pulumi.Output<List<StepMonitorTag>?> tags;
  ...
  StepMonitor(
    ...
    this.locationPrivates = registerOutput<List<StepMonitorLocationPrivate>?>('locationPrivates');
    ...
    this.steps = registerOutput<List<StepMonitorStep>>('steps');
    this.tags = registerOutput<List<StepMonitorTag>?>('tags');
