...
class MonitorState {
  ...
  factory MonitorState.fromMap(Map<String, dynamic> map) {
    return MonitorState(
      ...
      bypassHeadRequest: (() { final guardedValue = map['bypassHeadRequest']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      customHeaders: (() { final guardedValue = map['customHeaders']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MonitorCustomHeader>(guardedValue, (value) => MonitorCustomHeader.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<MonitorTag>(guardedValue, (value) => MonitorTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
      treatRedirectAsFailure: (() { final guardedValue = map['treatRedirectAsFailure']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      validationString: (() { final guardedValue = map['validationString']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      verifySsl: (() { final guardedValue = map['verifySsl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
