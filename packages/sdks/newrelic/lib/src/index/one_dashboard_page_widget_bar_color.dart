...
class OneDashboardPageWidgetBarColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBarColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetBarColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetBarColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetBarColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetBarColorSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetBarColorSeriesOverride.fromMap(
