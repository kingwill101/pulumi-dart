...
class OneDashboardPageWidgetLogTable {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetLogTableDataFormat>>?
  dataFormats;
  ...
  final pulumi.Input<OneDashboardPageWidgetLogTableInitialSorting>?
  initialSorting;
    ...
    return <String, dynamic>{
      'colors':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLogTableColor>,
      ...
      'dataFormats':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLogTableDataFormat>,
            List<Map<String, dynamic>>
          >(
            dataFormats,
            (value) =>
      ...
      'nrqlQueries':
          pulumi.Input.mapInputValue<
            List<OneDashboardPageWidgetLogTableNrqlQuery>,
            List<Map<String, dynamic>>
          >(
            nrqlQueries,
            (value) =>
      ...
      'nullValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLogTableNullValue>,
            List<Map<String, dynamic>>
          >(
            nullValues,
            (value) =>
      ...
      'units':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLogTableUnit>,
            List<Map<String, dynamic>>
          >(
            units,
            (value) =>
    ...
    return OneDashboardPageWidgetLogTable(
      colors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetLogTableColor>(
            guardedValue,
            (value) => OneDashboardPageWidgetLogTableColor.fromMap(
      ...
      dataFormats: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetLogTableDataFormat>(
            guardedValue,
            (value) => OneDashboardPageWidgetLogTableDataFormat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      initialSorting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetLogTableInitialSorting.fromMap(
      ...
      nrqlQueries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OneDashboardPageWidgetLogTableNrqlQuery>(
          map['nrqlQueries']!,
          (value) => OneDashboardPageWidgetLogTableNrqlQuery.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nullValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetLogTableNullValue>(
            guardedValue,
            (value) => OneDashboardPageWidgetLogTableNullValue.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      units: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetLogTableUnit>(
            guardedValue,
            (value) => OneDashboardPageWidgetLogTableUnit.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
