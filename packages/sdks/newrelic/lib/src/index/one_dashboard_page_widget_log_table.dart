...
class OneDashboardPageWidgetLogTable {
  ...
  final List<OneDashboardPageWidgetLogTableColor>? colors;
  /// (Required) Column position of widget from top left, starting at `1`.
  final int column;
  /// (Optional) A nested block that describes data format. See Nested data_format blocks below for details.
  final List<OneDashboardPageWidgetLogTableDataFormat>? dataFormats;
  ...
  final OneDashboardPageWidgetLogTableInitialSorting? initialSorting;
  ...
  final List<OneDashboardPageWidgetLogTableNrqlQuery> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final List<OneDashboardPageWidgetLogTableNullValue>? nullValues;
  ...
  final List<OneDashboardPageWidgetLogTableUnit>? units;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?colors == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetLogTableColor, Map<String, dynamic>>(colors!, (value) => value.toMap()),
      'column': column,
      'dataFormats': ?dataFormats == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetLogTableDataFormat, Map<String, dynamic>>(dataFormats!, (value) => value.toMap()),
      ...
      'nrqlQueries': pulumi.Input.encodeList<OneDashboardPageWidgetLogTableNrqlQuery, Map<String, dynamic>>(nrqlQueries, (value) => value.toMap()),
      'nullValues': ?nullValues == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetLogTableNullValue, Map<String, dynamic>>(nullValues!, (value) => value.toMap()),
      'refreshRate': ?refreshRate,
      'row': row,
      'title': title,
      'units': ?units == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetLogTableUnit, Map<String, dynamic>>(units!, (value) => value.toMap()),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetLogTable.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLogTable(
      colors: map['colors'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetLogTableColor>(map['colors'], (value) => OneDashboardPageWidgetLogTableColor.fromMap((value as Map).cast<String, dynamic>())),
      column: map['column'] as int,
      dataFormats: map['dataFormats'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetLogTableDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetLogTableDataFormat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      initialSorting: map['initialSorting'] == null ? null : OneDashboardPageWidgetLogTableInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>()),
      legendEnabled: map['legendEnabled'] == null ? null : map['legendEnabled'] as bool,
      nrqlQueries: pulumi.Input.decodeList<OneDashboardPageWidgetLogTableNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetLogTableNrqlQuery.fromMap((value as Map).cast<String, dynamic>())),
      nullValues: map['nullValues'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetLogTableNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetLogTableNullValue.fromMap((value as Map).cast<String, dynamic>())),
      refreshRate: map['refreshRate'] == null ? null : map['refreshRate'] as String,
      row: map['row'] as int,
      title: map['title'] as String,
      units: map['units'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetLogTableUnit>(map['units'], (value) => OneDashboardPageWidgetLogTableUnit.fromMap((value as Map).cast<String, dynamic>())),
