...
class NrqlDropRuleState {
  ...
  factory NrqlDropRuleState.fromMap(Map<String, dynamic> map) {
    return NrqlDropRuleState(
      ...
      pipelineCloudRuleEntityId: (() { final guardedValue = map['pipelineCloudRuleEntityId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
