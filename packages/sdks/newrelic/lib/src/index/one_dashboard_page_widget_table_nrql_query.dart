...
class OneDashboardPageWidgetTableNrqlQuery {
  ...
  /// Creates a new [OneDashboardPageWidgetTableNrqlQuery].
  ...
  OneDashboardPageWidgetTableNrqlQuery({this.accountId, required this.query});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'accountId': ?accountId, 'query': query};
  }

  factory OneDashboardPageWidgetTableNrqlQuery.fromMap(
    Map<String, dynamic> map,
  ) {
    return OneDashboardPageWidgetTableNrqlQuery(
      accountId: (() {
