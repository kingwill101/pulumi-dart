...
class NrqlAlertConditionTerm {
  ...
  factory NrqlAlertConditionTerm.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionTerm(
      ...
      prediction: (() { final guardedValue = map['prediction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NrqlAlertConditionTermPrediction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
