...
class OneDashboardPageWidgetHeatmapUnit {
  ...
  const OneDashboardPageWidgetHeatmapUnit({
  ...
  factory OneDashboardPageWidgetHeatmapUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHeatmapUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetHeatmapUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
