...
class OneDashboardPageWidgetPyNullValue {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetPyNullValueSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetPyNullValue({this.nullValue, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetPyNullValueSeriesOverride>,
    ...
    return OneDashboardPageWidgetPyNullValue(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => OneDashboardPageWidgetPyNullValueSeriesOverride.fromMap(
