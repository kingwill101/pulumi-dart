...
class OneDashboardPageWidgetPyNullValue {
  ...
  final List<OneDashboardPageWidgetPyNullValueSeriesOverride>? seriesOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nullValue': ?nullValue,
      'seriesOverrides': ?seriesOverrides == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetPyNullValueSeriesOverride, Map<String, dynamic>>(seriesOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory OneDashboardPageWidgetPyNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetPyNullValue(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetPyNullValueSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetPyNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
