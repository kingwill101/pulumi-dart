...
class AlertCompoundConditionState {
  ...
  factory AlertCompoundConditionState.fromMap(Map<String, dynamic> map) {
    return AlertCompoundConditionState(
      ...
      componentConditions: (() { final guardedValue = map['componentConditions']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertCompoundConditionComponentCondition>(guardedValue, (value) => AlertCompoundConditionComponentCondition.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      triggerExpression: (() { final guardedValue = map['triggerExpression']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
