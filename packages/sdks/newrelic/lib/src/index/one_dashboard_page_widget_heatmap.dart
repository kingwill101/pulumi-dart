...
class OneDashboardPageWidgetHeatmap {
  ...
  factory OneDashboardPageWidgetHeatmap.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHeatmap(
      colors: map['colors'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapColor>(map['colors'], (value) => OneDashboardPageWidgetHeatmapColor.fromMap((value as Map).cast<String, dynamic>()))).input(),
      column: (map['column'] as int).input(),
      dataFormats: map['dataFormats'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetHeatmapDataFormat.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      initialSorting: map['initialSorting'] == null ? null : (OneDashboardPageWidgetHeatmapInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>())).input(),
      ...
      nrqlQueries: (pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetHeatmapNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nullValues: map['nullValues'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetHeatmapNullValue.fromMap((value as Map).cast<String, dynamic>()))).input(),
      refreshRate: map['refreshRate'] == null ? null : (map['refreshRate'] as String).input(),
      row: (map['row'] as int).input(),
      title: (map['title'] as String).input(),
      units: map['units'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapUnit>(map['units'], (value) => OneDashboardPageWidgetHeatmapUnit.fromMap((value as Map).cast<String, dynamic>()))).input(),
