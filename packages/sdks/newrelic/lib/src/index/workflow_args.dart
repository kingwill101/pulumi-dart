...
class WorkflowArgs {
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      ...
      destinations: pulumi.Input.fromValue(pulumi.Input.decodeList<WorkflowDestination>(map['destinations']!, (value) => WorkflowDestination.fromMap((value as Map).cast<String, dynamic>()))),
      ...
      issuesFilter: pulumi.Input.fromValue(WorkflowIssuesFilter.fromMap((map['issuesFilter']! as Map).cast<String, dynamic>())),
      mutingRulesHandling: pulumi.Input.fromValue(map['mutingRulesHandling'] as String),
