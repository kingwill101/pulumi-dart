...
class WorkflowArgs {
  ...
  WorkflowArgs({
    ...
    required this.issuesFilter,
    required this.mutingRulesHandling,
    this.name,
  });
    ...
    return <String, dynamic>{
      ...
      'enrichments':
          ?pulumi.Input.mapOptionalInputValue<
            WorkflowEnrichments,
            Map<String, dynamic>
          >(enrichments, (value) => value.toMap()),
      'enrichmentsEnabled': ?enrichmentsEnabled,
      'issuesFilter':
          pulumi.Input.mapInputValue<
            WorkflowIssuesFilter,
            Map<String, dynamic>
          >(issuesFilter, (value) => value.toMap()),
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      ...
      destinations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<WorkflowDestination>(
          map['destinations']!,
          (value) => WorkflowDestination.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      destinationsEnabled: (() {
        final guardedValue = map['destinationsEnabled'];
        if (guardedValue == null) return null;
      ...
      enrichments: (() {
        ...
        return pulumi.Input.fromValue(
          WorkflowEnrichments.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      enrichmentsEnabled: (() {
        final guardedValue = map['enrichmentsEnabled'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      issuesFilter: pulumi.Input.fromValue(
        WorkflowIssuesFilter.fromMap(
          (map['issuesFilter']! as Map).cast<String, dynamic>(),
        ),
      ),
      mutingRulesHandling: pulumi.Input.fromValue(
        map['mutingRulesHandling'] as String,
      ),
      name: (() {
