...
class OneDashboardPageWidgetPy {
  ...
  const OneDashboardPageWidgetPy({
    this.colors,
  ...
  factory OneDashboardPageWidgetPy.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetPy(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetPyColor>(guardedValue, (value) => OneDashboardPageWidgetPyColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetPyDataFormat>(guardedValue, (value) => OneDashboardPageWidgetPyDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetPyInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetPyNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetPyNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetPyNullValue>(guardedValue, (value) => OneDashboardPageWidgetPyNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetPyUnit>(guardedValue, (value) => OneDashboardPageWidgetPyUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
