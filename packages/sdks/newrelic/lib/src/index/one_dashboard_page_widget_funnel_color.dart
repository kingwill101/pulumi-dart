...
class OneDashboardPageWidgetFunnelColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetFunnelColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetFunnelColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetFunnelColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetFunnelColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => OneDashboardPageWidgetFunnelColorSeriesOverride.fromMap(
