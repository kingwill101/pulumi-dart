...
class ServiceLevelEvents {
    ...
    return <String, dynamic>{
      ...
      'badEvents':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(badEvents, (value) => value.toMap()),
      'goodEvents':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceLevelEventsGoodEvents,
            Map<String, dynamic>
          >(goodEvents, (value) => value.toMap()),
      'validEvents':
          pulumi.Input.mapInputValue<
            ServiceLevelEventsValidEvents,
            Map<String, dynamic>
          >(validEvents, (value) => value.toMap()),
    };
  }
  ...
  factory ServiceLevelEvents.fromMap(Map<String, dynamic> map) {
    return ServiceLevelEvents(
      ...
      badEvents: (() {
        final guardedValue = map['badEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceLevelEventsBadEvents.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      goodEvents: (() {
        final guardedValue = map['goodEvents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceLevelEventsGoodEvents.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      validEvents: pulumi.Input.fromValue(
        ServiceLevelEventsValidEvents.fromMap(
          (map['validEvents']! as Map).cast<String, dynamic>(),
        ),
      ),
    );
  }
