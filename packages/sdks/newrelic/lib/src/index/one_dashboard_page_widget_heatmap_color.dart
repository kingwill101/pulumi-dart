...
class OneDashboardPageWidgetHeatmapColor {
  ...
  const OneDashboardPageWidgetHeatmapColor({
    this.color,
  ...
  factory OneDashboardPageWidgetHeatmapColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHeatmapColor(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapColorSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetHeatmapColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
