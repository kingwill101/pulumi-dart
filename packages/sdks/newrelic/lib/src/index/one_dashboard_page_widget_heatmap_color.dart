...
class OneDashboardPageWidgetHeatmapColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetHeatmapColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetHeatmapColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetHeatmapColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetHeatmapColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => OneDashboardPageWidgetHeatmapColorSeriesOverride.fromMap(
