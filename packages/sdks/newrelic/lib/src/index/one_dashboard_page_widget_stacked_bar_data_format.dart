...
class OneDashboardPageWidgetStackedBarDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetStackedBarDataFormat].
  ...
  const OneDashboardPageWidgetStackedBarDataFormat({
    this.format,
    required this.name,
    this.precision,
    required this.type,
  ...
  factory OneDashboardPageWidgetStackedBarDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetStackedBarDataFormat(
