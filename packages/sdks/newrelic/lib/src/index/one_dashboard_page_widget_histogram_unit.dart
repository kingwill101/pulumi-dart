...
class OneDashboardPageWidgetHistogramUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetHistogramUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetHistogramUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetHistogramUnitSeriesOverride>,
  ...
  factory OneDashboardPageWidgetHistogramUnit.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetHistogramUnitSeriesOverride.fromMap(
