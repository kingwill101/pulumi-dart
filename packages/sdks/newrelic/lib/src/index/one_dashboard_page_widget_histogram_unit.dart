...
class OneDashboardPageWidgetHistogramUnit {
  ...
  const OneDashboardPageWidgetHistogramUnit({
  ...
  factory OneDashboardPageWidgetHistogramUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHistogramUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetHistogramUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetHistogramUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
