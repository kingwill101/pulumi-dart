...
class OneDashboardPageWidgetBillboard {
  ...
  const OneDashboardPageWidgetBillboard({
  ...
  factory OneDashboardPageWidgetBillboard.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBillboard(
      billboardSettings: (() { final guardedValue = map['billboardSettings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetBillboardBillboardSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBillboardColor>(guardedValue, (value) => OneDashboardPageWidgetBillboardColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      critical: (() { final guardedValue = map['critical']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBillboardDataFormat>(guardedValue, (value) => OneDashboardPageWidgetBillboardDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetBillboardInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBillboardNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetBillboardNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBillboardNullValue>(guardedValue, (value) => OneDashboardPageWidgetBillboardNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBillboardUnit>(guardedValue, (value) => OneDashboardPageWidgetBillboardUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
