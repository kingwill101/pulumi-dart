...
class OneDashboardPageWidgetBulletUnit {
  ...
  const OneDashboardPageWidgetBulletUnit({
  ...
  factory OneDashboardPageWidgetBulletUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBulletUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBulletUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetBulletUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
