...
class OneDashboardPageWidgetBulletUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBulletUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetBulletUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetBulletUnitSeriesOverride>,
    ...
    return OneDashboardPageWidgetBulletUnit(
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<OneDashboardPageWidgetBulletUnitSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetBulletUnitSeriesOverride.fromMap(
