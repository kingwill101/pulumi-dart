...
class OneDashboardPageWidgetBillboardUnit {
  ...
  const OneDashboardPageWidgetBillboardUnit({
  ...
  factory OneDashboardPageWidgetBillboardUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBillboardUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBillboardUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetBillboardUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
