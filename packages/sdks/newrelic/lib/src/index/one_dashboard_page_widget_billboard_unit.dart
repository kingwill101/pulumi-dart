...
class OneDashboardPageWidgetBillboardUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBillboardUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetBillboardUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetBillboardUnitSeriesOverride>,
  ...
  factory OneDashboardPageWidgetBillboardUnit.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetBillboardUnitSeriesOverride.fromMap(
