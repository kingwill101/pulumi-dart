...
class AlertMutingRuleCondition {
  ...
  AlertMutingRuleCondition({required this.conditions, required this.operator});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'conditions':
          pulumi.Input.mapInputValue<
            List<AlertMutingRuleConditionCondition>,
  ...
  factory AlertMutingRuleCondition.fromMap(Map<String, dynamic> map) {
    return AlertMutingRuleCondition(
      conditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AlertMutingRuleConditionCondition>(
          map['conditions']!,
          (value) => AlertMutingRuleConditionCondition.fromMap(
