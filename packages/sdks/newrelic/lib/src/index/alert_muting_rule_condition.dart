...
class AlertMutingRuleCondition {
  ...
  factory AlertMutingRuleCondition.fromMap(Map<String, dynamic> map) {
    return AlertMutingRuleCondition(
      conditions: (pulumi.Input.decodeList<AlertMutingRuleConditionCondition>(map['conditions'], (value) => AlertMutingRuleConditionCondition.fromMap((value as Map).cast<String, dynamic>()))).input(),
