...
class OneDashboardPageWidgetHistogram {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetHistogramDataFormat>>?
  dataFormats;
  ...
  final pulumi.Input<OneDashboardPageWidgetHistogramInitialSorting>?
  initialSorting;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetHistogramNrqlQuery>>
  nrqlQueries;

  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetHistogramNullValue>>?
  nullValues;
    ...
    return <String, dynamic>{
      'colors':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetHistogramColor>,
      ...
      'dataFormats':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetHistogramDataFormat>,
            List<Map<String, dynamic>>
          >(
            dataFormats,
            (value) =>
      ...
      'nrqlQueries':
          pulumi.Input.mapInputValue<
            List<OneDashboardPageWidgetHistogramNrqlQuery>,
            List<Map<String, dynamic>>
          >(
            nrqlQueries,
            (value) =>
      ...
      'nullValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetHistogramNullValue>,
            List<Map<String, dynamic>>
          >(
            nullValues,
            (value) =>
      ...
      'units':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetHistogramUnit>,
            List<Map<String, dynamic>>
          >(
            units,
            (value) =>
    ...
    return OneDashboardPageWidgetHistogram(
      colors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetHistogramColor>(
            guardedValue,
            (value) => OneDashboardPageWidgetHistogramColor.fromMap(
      ...
      dataFormats: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetHistogramDataFormat>(
            guardedValue,
            (value) => OneDashboardPageWidgetHistogramDataFormat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      initialSorting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetHistogramInitialSorting.fromMap(
      ...
      nrqlQueries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OneDashboardPageWidgetHistogramNrqlQuery>(
          map['nrqlQueries']!,
          (value) => OneDashboardPageWidgetHistogramNrqlQuery.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nullValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetHistogramNullValue>(
            guardedValue,
            (value) => OneDashboardPageWidgetHistogramNullValue.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      units: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetHistogramUnit>(
            guardedValue,
            (value) => OneDashboardPageWidgetHistogramUnit.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
