...
class OneDashboardArgs {
  ...
  OneDashboardArgs({
    ...
    required pulumi.Output<List<OneDashboardPage>> pages,
  ...
  factory OneDashboardArgs.fromMap(Map<String, dynamic> map) {
    return OneDashboardArgs(
      ...
      pages: pulumi.Output.create<List<OneDashboardPage>>(pulumi.Input.decodeList<OneDashboardPage>(map['pages'], (value) => OneDashboardPage.fromMap((value as Map).cast<String, dynamic>()))),
