...
class OneDashboardPageWidgetFunnelUnitSeriesOverride {
  /// Series name
  ...
  OneDashboardPageWidgetFunnelUnitSeriesOverride({this.seriesName, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'seriesName': ?seriesName, 'unit': ?unit};
  }

  factory OneDashboardPageWidgetFunnelUnitSeriesOverride.fromMap(
    Map<String, dynamic> map,
  ) {
    return OneDashboardPageWidgetFunnelUnitSeriesOverride(
      seriesName: (() {
