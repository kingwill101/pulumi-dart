...
class GetEntityResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tags': ?(() { final guardedValue = tags; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetEntityTag, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'type': type,
    };
  }
  ...
  factory GetEntityResult.fromMap(Map<String, dynamic> map) {
    return GetEntityResult(
      ...
      id: map['id'] as String,
      ignoreCase: (() { final guardedValue = map['ignoreCase']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      ignoreNotFound: (() { final guardedValue = map['ignoreNotFound']; if (guardedValue == null) return null; return guardedValue as bool; })(),
      name: map['name'] as String,
      servingApmApplicationId: map['servingApmApplicationId'] as String,
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetEntityTag>(guardedValue, (value) => GetEntityTag.fromMap((value as Map).cast<String, dynamic>())); })(),
