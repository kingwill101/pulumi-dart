...
class OneDashboardPageWidgetLineYAxisRight {
  ...
  factory OneDashboardPageWidgetLineYAxisRight.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLineYAxisRight(
      yAxisRightMax: (() { final guardedValue = map['yAxisRightMax']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      yAxisRightMin: (() { final guardedValue = map['yAxisRightMin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      yAxisRightSeries: (() { final guardedValue = map['yAxisRightSeries']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      yAxisRightZero: (() { final guardedValue = map['yAxisRightZero']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
