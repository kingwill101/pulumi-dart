...
class OneDashboardPageWidgetLineYAxisRight {
  ...
  final List<String>? yAxisRightSeries;
  ...
  factory OneDashboardPageWidgetLineYAxisRight.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLineYAxisRight(
      yAxisRightMax: map['yAxisRightMax'] == null ? null : map['yAxisRightMax'] as double,
      yAxisRightMin: map['yAxisRightMin'] == null ? null : map['yAxisRightMin'] as double,
      yAxisRightSeries: map['yAxisRightSeries'] == null ? null : (map['yAxisRightSeries'] as List).cast<String>(),
      yAxisRightZero: map['yAxisRightZero'] == null ? null : map['yAxisRightZero'] as bool,
    );
  }
}
