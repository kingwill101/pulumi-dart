...
class OneDashboardPageWidgetMarkdownUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetMarkdownUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetMarkdownUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetMarkdownUnitSeriesOverride>,
    ...
    return OneDashboardPageWidgetMarkdownUnit(
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => OneDashboardPageWidgetMarkdownUnitSeriesOverride.fromMap(
