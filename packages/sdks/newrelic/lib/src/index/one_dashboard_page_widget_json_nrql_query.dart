...
class OneDashboardPageWidgetJsonNrqlQuery {
  ...
  /// Creates a new [OneDashboardPageWidgetJsonNrqlQuery].
  ...
  OneDashboardPageWidgetJsonNrqlQuery({this.accountId, required this.query});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'accountId': ?accountId, 'query': query};
  }

  factory OneDashboardPageWidgetJsonNrqlQuery.fromMap(
