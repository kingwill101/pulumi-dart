...
class OneDashboardPageWidgetAreaNullValue {
  ...
  factory OneDashboardPageWidgetAreaNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetAreaNullValue(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetAreaNullValueSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetAreaNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
