...
class ServiceLevelEventsValidEvents {
  ...
  final ServiceLevelEventsValidEventsSelect? select;
  ...
  factory ServiceLevelEventsValidEvents.fromMap(Map<String, dynamic> map) {
    return ServiceLevelEventsValidEvents(
      ...
      select: map['select'] == null ? null : ServiceLevelEventsValidEventsSelect.fromMap((map['select'] as Map).cast<String, dynamic>()),
