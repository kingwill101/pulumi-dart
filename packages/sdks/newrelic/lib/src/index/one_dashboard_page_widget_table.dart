...
class OneDashboardPageWidgetTable {
  ...
  factory OneDashboardPageWidgetTable.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetTable(
      colors: map['colors'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetTableColor>(map['colors'], (value) => OneDashboardPageWidgetTableColor.fromMap((value as Map).cast<String, dynamic>()))).input(),
      column: (map['column'] as int).input(),
      dataFormats: map['dataFormats'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetTableDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetTableDataFormat.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      initialSorting: map['initialSorting'] == null ? null : (OneDashboardPageWidgetTableInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>())).input(),
      ...
      nrqlQueries: (pulumi.Input.decodeList<OneDashboardPageWidgetTableNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetTableNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nullValues: map['nullValues'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetTableNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetTableNullValue.fromMap((value as Map).cast<String, dynamic>()))).input(),
      refreshRate: map['refreshRate'] == null ? null : (map['refreshRate'] as String).input(),
      row: (map['row'] as int).input(),
      thresholds: map['thresholds'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetTableThreshold>(map['thresholds'], (value) => OneDashboardPageWidgetTableThreshold.fromMap((value as Map).cast<String, dynamic>()))).input(),
      title: (map['title'] as String).input(),
      units: map['units'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetTableUnit>(map['units'], (value) => OneDashboardPageWidgetTableUnit.fromMap((value as Map).cast<String, dynamic>()))).input(),
