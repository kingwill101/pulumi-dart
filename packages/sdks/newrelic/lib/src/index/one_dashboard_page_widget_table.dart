...
import 'one_dashboard_page_widget_table_color.dart';
import 'one_dashboard_page_widget_table_data_format.dart';
import 'one_dashboard_page_widget_table_initial_sorting.dart';
import 'one_dashboard_page_widget_table_nrql_query.dart';
import 'one_dashboard_page_widget_table_null_value.dart';
import 'one_dashboard_page_widget_table_threshold.dart';
import 'one_dashboard_page_widget_table_unit.dart';

class OneDashboardPageWidgetTable {
  /// (Optional) A nested block that describes colors of your charts per series. See Nested Colors blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetTableColor>>? colors;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetTableDataFormat>>? dataFormats;
  ...
  final pulumi.Input<OneDashboardPageWidgetTableInitialSorting>? initialSorting;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetTableNrqlQuery>> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetTableNullValue>>? nullValues;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetTableThreshold>>? thresholds;
  /// (Optional) A human-friendly display string for this value.
  final pulumi.Input<String> title;
  /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetTableUnit>>? units;
  ...
  /// Creates a new [OneDashboardPageWidgetTable].
  ...
  const OneDashboardPageWidgetTable({
    this.colors,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetTableColor>, List<Map<String, dynamic>>>(colors, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetTableColor, Map<String, dynamic>>(value, (value) => value.toMap())),
      'column': column,
      'dataFormats': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetTableDataFormat>, List<Map<String, dynamic>>>(dataFormats, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetTableDataFormat, Map<String, dynamic>>(value, (value) => value.toMap())),
      'facetShowOtherSeries': ?facetShowOtherSeries,
      'filterCurrentDashboard': ?filterCurrentDashboard,
      'height': ?height,
      'id': ?id,
      'ignoreTimeRange': ?ignoreTimeRange,
      'initialSorting': ?pulumi.Input.mapOptionalInputValue<OneDashboardPageWidgetTableInitialSorting, Map<String, dynamic>>(initialSorting, (value) => value.toMap()),
      'legendEnabled': ?legendEnabled,
      'linkedEntityGuids': ?linkedEntityGuids,
      'nrqlQueries': pulumi.Input.mapInputValue<List<OneDashboardPageWidgetTableNrqlQuery>, List<Map<String, dynamic>>>(nrqlQueries, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetTableNrqlQuery, Map<String, dynamic>>(value, (value) => value.toMap())),
      'nullValues': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetTableNullValue>, List<Map<String, dynamic>>>(nullValues, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetTableNullValue, Map<String, dynamic>>(value, (value) => value.toMap())),
      'refreshRate': ?refreshRate,
      'row': row,
      'thresholds': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetTableThreshold>, List<Map<String, dynamic>>>(thresholds, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetTableThreshold, Map<String, dynamic>>(value, (value) => value.toMap())),
      'title': title,
      'units': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetTableUnit>, List<Map<String, dynamic>>>(units, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetTableUnit, Map<String, dynamic>>(value, (value) => value.toMap())),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetTable.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetTable(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetTableColor>(guardedValue, (value) => OneDashboardPageWidgetTableColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetTableDataFormat>(guardedValue, (value) => OneDashboardPageWidgetTableDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetTableInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetTableNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetTableNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetTableNullValue>(guardedValue, (value) => OneDashboardPageWidgetTableNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      thresholds: (() { final guardedValue = map['thresholds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetTableThreshold>(guardedValue, (value) => OneDashboardPageWidgetTableThreshold.fromMap((value as Map).cast<String, dynamic>()))); })(),
      title: pulumi.Input.fromValue(map['title'] as String),
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetTableUnit>(guardedValue, (value) => OneDashboardPageWidgetTableUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
