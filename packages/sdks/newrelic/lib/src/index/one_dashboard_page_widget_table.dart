    ...
    return <String, dynamic>{
      'colors':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetTableColor>,
      ...
      'dataFormats':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetTableDataFormat>,
            List<Map<String, dynamic>>
          >(
            dataFormats,
            (value) =>
      ...
      'nrqlQueries':
          pulumi.Input.mapInputValue<
            List<OneDashboardPageWidgetTableNrqlQuery>,
            List<Map<String, dynamic>>
          >(
            nrqlQueries,
            (value) =>
      ...
      'nullValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetTableNullValue>,
            List<Map<String, dynamic>>
          >(
            nullValues,
            (value) =>
      ...
      'thresholds':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetTableThreshold>,
            List<Map<String, dynamic>>
          >(
            thresholds,
            (value) =>
      ...
      'units':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetTableUnit>,
            List<Map<String, dynamic>>
          >(
            units,
            (value) =>
    ...
    return OneDashboardPageWidgetTable(
      colors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetTableColor>(
            guardedValue,
            (value) => OneDashboardPageWidgetTableColor.fromMap(
      ...
      dataFormats: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetTableDataFormat>(
            guardedValue,
            (value) => OneDashboardPageWidgetTableDataFormat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      filterCurrentDashboard: (() {
        final guardedValue = map['filterCurrentDashboard'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      height: (() {
      ...
      initialSorting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetTableInitialSorting.fromMap(
      ...
      nrqlQueries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OneDashboardPageWidgetTableNrqlQuery>(
          map['nrqlQueries']!,
          (value) => OneDashboardPageWidgetTableNrqlQuery.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nullValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetTableNullValue>(
            guardedValue,
            (value) => OneDashboardPageWidgetTableNullValue.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      thresholds: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetTableThreshold>(
            guardedValue,
            (value) => OneDashboardPageWidgetTableThreshold.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      units: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetTableUnit>(
            guardedValue,
            (value) => OneDashboardPageWidgetTableUnit.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
