...
class OneDashboardPageWidgetBulletNullValue {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBulletNullValueSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetBulletNullValue({this.nullValue, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetBulletNullValueSeriesOverride>,
  ...
  factory OneDashboardPageWidgetBulletNullValue.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetBulletNullValueSeriesOverride.fromMap(
