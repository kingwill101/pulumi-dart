...
class OneDashboardPageWidgetBulletNullValue {
  ...
  const OneDashboardPageWidgetBulletNullValue({
    this.nullValue,
  ...
  factory OneDashboardPageWidgetBulletNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBulletNullValue(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBulletNullValueSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetBulletNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
