...
class OneDashboardPageWidgetLogTableColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetLogTableColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetLogTableColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLogTableColorSeriesOverride>,
  ...
  factory OneDashboardPageWidgetLogTableColor.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetLogTableColorSeriesOverride.fromMap(
