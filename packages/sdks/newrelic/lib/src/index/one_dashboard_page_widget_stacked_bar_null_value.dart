...
class OneDashboardPageWidgetStackedBarNullValue {
  ...
  const OneDashboardPageWidgetStackedBarNullValue({
    this.nullValue,
  ...
  factory OneDashboardPageWidgetStackedBarNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetStackedBarNullValue(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarNullValueSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetStackedBarNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
