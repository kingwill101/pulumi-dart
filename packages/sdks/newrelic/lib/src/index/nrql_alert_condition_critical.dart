...
class NrqlAlertConditionCritical {
  ...
  final pulumi.Input<NrqlAlertConditionCriticalPrediction>? prediction;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'duration': ?duration,
      'operator': ?operator,
      'prediction': ?pulumi.Input.mapOptionalInputValue<NrqlAlertConditionCriticalPrediction, Map<String, dynamic>>(prediction, (value) => value.toMap()),
      'threshold': threshold,
  ...
  factory NrqlAlertConditionCritical.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionCritical(
      disableHealthStatusReporting: (() { final guardedValue = map['disableHealthStatusReporting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      prediction: (() { final guardedValue = map['prediction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NrqlAlertConditionCriticalPrediction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      threshold: pulumi.Input.fromValue(map['threshold'] as double),
      thresholdDuration: (() { final guardedValue = map['thresholdDuration']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      thresholdOccurrences: (() { final guardedValue = map['thresholdOccurrences']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
