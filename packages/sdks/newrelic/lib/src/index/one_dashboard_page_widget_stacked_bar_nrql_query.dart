...
class OneDashboardPageWidgetStackedBarNrqlQuery {
  ...
  /// Creates a new [OneDashboardPageWidgetStackedBarNrqlQuery].
  ...
  const OneDashboardPageWidgetStackedBarNrqlQuery({
    this.accountId,
    required this.query,
  });
  ...
  factory OneDashboardPageWidgetStackedBarNrqlQuery.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetStackedBarNrqlQuery(
