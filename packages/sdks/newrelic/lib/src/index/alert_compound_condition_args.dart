...
class AlertCompoundConditionArgs {
  ...
  const AlertCompoundConditionArgs({
    this.accountId,
  ...
  factory AlertCompoundConditionArgs.fromMap(Map<String, dynamic> map) {
    return AlertCompoundConditionArgs(
      ...
      componentConditions: pulumi.Input.fromValue(pulumi.Input.decodeList<AlertCompoundConditionComponentCondition>(map['componentConditions']!, (value) => AlertCompoundConditionComponentCondition.fromMap((value as Map).cast<String, dynamic>()))),
      enabled: pulumi.Input.fromValue(map['enabled'] as bool),
      facetMatchingBehavior: (() { final guardedValue = map['facetMatchingBehavior']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      triggerExpression: pulumi.Input.fromValue(map['triggerExpression'] as String),
    );
  }
}
