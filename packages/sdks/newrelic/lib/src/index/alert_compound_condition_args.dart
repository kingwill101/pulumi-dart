...
class AlertCompoundConditionArgs {
  ...
  final pulumi.Input<List<AlertCompoundConditionComponentCondition>>
  componentConditions;
    ...
    return <String, dynamic>{
      ...
      'componentConditions':
          pulumi.Input.mapInputValue<
            List<AlertCompoundConditionComponentCondition>,
  ...
  factory AlertCompoundConditionArgs.fromMap(Map<String, dynamic> map) {
    return AlertCompoundConditionArgs(
      ...
      componentConditions: pulumi.Input.fromValue(
        pulumi.Input.decodeList<AlertCompoundConditionComponentCondition>(
          map['componentConditions']!,
          (value) => AlertCompoundConditionComponentCondition.fromMap(
      ...
      facetMatchingBehavior: (() {
        final guardedValue = map['facetMatchingBehavior'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      name: (() {
      ...
      triggerExpression: pulumi.Input.fromValue(
        map['triggerExpression'] as String,
      ),
    );
  }
}
