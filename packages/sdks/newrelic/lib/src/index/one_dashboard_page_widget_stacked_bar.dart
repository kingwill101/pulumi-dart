...
class OneDashboardPageWidgetStackedBar {
  ...
  const OneDashboardPageWidgetStackedBar({
    this.colors,
  ...
  factory OneDashboardPageWidgetStackedBar.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetStackedBar(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarColor>(guardedValue, (value) => OneDashboardPageWidgetStackedBarColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarDataFormat>(guardedValue, (value) => OneDashboardPageWidgetStackedBarDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetStackedBarInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetStackedBarNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarNullValue>(guardedValue, (value) => OneDashboardPageWidgetStackedBarNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tooltip: (() { final guardedValue = map['tooltip']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetStackedBarTooltip.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarUnit>(guardedValue, (value) => OneDashboardPageWidgetStackedBarUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
