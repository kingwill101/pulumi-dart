...
class OneDashboardPageWidgetStackedBar {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetStackedBarDataFormat>>?
  dataFormats;
  ...
  final pulumi.Input<OneDashboardPageWidgetStackedBarInitialSorting>?
  initialSorting;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetStackedBarNrqlQuery>>
  nrqlQueries;

  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetStackedBarNullValue>>?
  nullValues;
    ...
    return <String, dynamic>{
      'colors':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetStackedBarColor>,
      ...
      'dataFormats':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetStackedBarDataFormat>,
            List<Map<String, dynamic>>
          >(
            dataFormats,
            (value) =>
      ...
      'nrqlQueries':
          pulumi.Input.mapInputValue<
            List<OneDashboardPageWidgetStackedBarNrqlQuery>,
            List<Map<String, dynamic>>
          >(
            nrqlQueries,
            (value) =>
      ...
      'nullValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetStackedBarNullValue>,
            List<Map<String, dynamic>>
          >(
            nullValues,
            (value) =>
      ...
      'units':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetStackedBarUnit>,
            List<Map<String, dynamic>>
          >(
            units,
            (value) =>
    ...
    return OneDashboardPageWidgetStackedBar(
      colors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarColor>(
            guardedValue,
            (value) => OneDashboardPageWidgetStackedBarColor.fromMap(
      ...
      dataFormats: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarDataFormat>(
            guardedValue,
            (value) => OneDashboardPageWidgetStackedBarDataFormat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      initialSorting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetStackedBarInitialSorting.fromMap(
      ...
      nrqlQueries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarNrqlQuery>(
          map['nrqlQueries']!,
          (value) => OneDashboardPageWidgetStackedBarNrqlQuery.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nullValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarNullValue>(
            guardedValue,
            (value) => OneDashboardPageWidgetStackedBarNullValue.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      tooltip: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetStackedBarTooltip.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      units: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarUnit>(
            guardedValue,
            (value) => OneDashboardPageWidgetStackedBarUnit.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
