...
class ServiceLevelEventsGoodEvents {
  ...
  factory ServiceLevelEventsGoodEvents.fromMap(Map<String, dynamic> map) {
    return ServiceLevelEventsGoodEvents(
      ...
      select: (() { final guardedValue = map['select']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceLevelEventsGoodEventsSelect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
