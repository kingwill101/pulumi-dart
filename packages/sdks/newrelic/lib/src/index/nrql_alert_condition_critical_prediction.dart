...
class NrqlAlertConditionCriticalPrediction {
  ...
  const NrqlAlertConditionCriticalPrediction({
    this.predictBy,
  ...
  factory NrqlAlertConditionCriticalPrediction.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionCriticalPrediction(
      predictBy: (() { final guardedValue = map['predictBy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      preferPredictionViolation: (() { final guardedValue = map['preferPredictionViolation']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
