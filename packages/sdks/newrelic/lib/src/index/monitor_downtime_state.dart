    ...
    return <String, dynamic>{
      ...
      'endRepeat':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(endRepeat, (value) => value.toMap()),
      'endTime': ?endTime,
      'frequency':
          ?pulumi.Input.mapOptionalInputValue<
            MonitorDowntimeFrequency,
            Map<String, dynamic>
          >(frequency, (value) => value.toMap()),
    ...
    return MonitorDowntimeState(
      ...
      endRepeat: (() {
        ...
        return pulumi.Input.fromValue(
          MonitorDowntimeEndRepeat.fromMap(
      ...
      frequency: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          MonitorDowntimeFrequency.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      maintenanceDays: (() {
        final guardedValue = map['maintenanceDays'];
        if (guardedValue == null) return null;
      ...
      monitorGuids: (() {
        final guardedValue = map['monitorGuids'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      name: (() {
