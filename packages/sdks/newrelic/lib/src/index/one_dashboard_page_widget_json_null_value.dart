...
class OneDashboardPageWidgetJsonNullValue {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetJsonNullValueSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetJsonNullValue({this.nullValue, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetJsonNullValueSeriesOverride>,
  ...
  factory OneDashboardPageWidgetJsonNullValue.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetJsonNullValueSeriesOverride.fromMap(
