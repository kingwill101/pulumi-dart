...
class AlertConditionState {
  ...
  factory AlertConditionState.fromMap(Map<String, dynamic> map) {
    return AlertConditionState(
      ...
      terms: (() { final guardedValue = map['terms']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<AlertConditionTerm>(guardedValue, (value) => AlertConditionTerm.fromMap((value as Map).cast<String, dynamic>()))); })(),
