...
class OneDashboardPageWidgetHeatmapNrqlQuery {
  ...
  /// Creates a new [OneDashboardPageWidgetHeatmapNrqlQuery].
  ...
  OneDashboardPageWidgetHeatmapNrqlQuery({this.accountId, required this.query});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'accountId': ?accountId, 'query': query};
  }

  factory OneDashboardPageWidgetHeatmapNrqlQuery.fromMap(
    Map<String, dynamic> map,
  ) {
    return OneDashboardPageWidgetHeatmapNrqlQuery(
      accountId: (() {
