...
class NotificationDestinationState {
  ...
  const NotificationDestinationState({
    this.accountId,
    this.active,
    this.authBasic,
  ...
  factory NotificationDestinationState.fromMap(Map<String, dynamic> map) {
    return NotificationDestinationState(
      ...
      lastSent: (() { final guardedValue = map['lastSent']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      name: (() { final guardedValue = map['name']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      properties: (() { final guardedValue = map['properties']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<NotificationDestinationProperty>(guardedValue, (value) => NotificationDestinationProperty.fromMap((value as Map).cast<String, dynamic>()))); })(),
