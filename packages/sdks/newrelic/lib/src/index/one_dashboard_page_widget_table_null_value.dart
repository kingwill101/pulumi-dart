...
class OneDashboardPageWidgetTableNullValue {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetTableNullValueSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetTableNullValue({this.nullValue, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetTableNullValueSeriesOverride>,
  ...
  factory OneDashboardPageWidgetTableNullValue.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetTableNullValueSeriesOverride.fromMap(
