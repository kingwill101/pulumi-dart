...
class OneDashboardPageWidgetStackedBarUnit {
  ...
  const OneDashboardPageWidgetStackedBarUnit({
  ...
  factory OneDashboardPageWidgetStackedBarUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetStackedBarUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetStackedBarUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
