...
class OneDashboardPageWidgetStackedBarUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetStackedBarUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetStackedBarUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetStackedBarUnitSeriesOverride>,
  ...
  factory OneDashboardPageWidgetStackedBarUnit.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetStackedBarUnitSeriesOverride.fromMap(
