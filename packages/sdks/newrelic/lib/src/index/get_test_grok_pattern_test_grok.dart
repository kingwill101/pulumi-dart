...
class GetTestGrokPatternTestGrok {
  ...
  factory GetTestGrokPatternTestGrok.fromMap(Map<String, dynamic> map) {
    return GetTestGrokPatternTestGrok(
      attributes: pulumi.Input.fromValue(pulumi.Input.decodeList<GetTestGrokPatternTestGrokAttribute>(map['attributes']!, (value) => GetTestGrokPatternTestGrokAttribute.fromMap((value as Map).cast<String, dynamic>()))),
