...
class OneDashboardPageWidgetHistogramColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetHistogramColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetHistogramColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetHistogramColorSeriesOverride>,
  ...
  factory OneDashboardPageWidgetHistogramColor.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetHistogramColorSeriesOverride.fromMap(
