...
class OneDashboardPageWidgetHistogramColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetHistogramColorSeriesOverride>>? seriesOverrides;
  ...
  const OneDashboardPageWidgetHistogramColor({
    this.color,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'color': ?color,
      'seriesOverrides': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetHistogramColorSeriesOverride>, List<Map<String, dynamic>>>(seriesOverrides, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetHistogramColorSeriesOverride, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory OneDashboardPageWidgetHistogramColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHistogramColor(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetHistogramColorSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetHistogramColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
