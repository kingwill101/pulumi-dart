...
class OneDashboardPageWidgetArea {
  ...
  const OneDashboardPageWidgetArea({
    this.colors,
  ...
  factory OneDashboardPageWidgetArea.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetArea(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetAreaColor>(guardedValue, (value) => OneDashboardPageWidgetAreaColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetAreaDataFormat>(guardedValue, (value) => OneDashboardPageWidgetAreaDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetAreaInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetAreaNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetAreaNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetAreaNullValue>(guardedValue, (value) => OneDashboardPageWidgetAreaNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      tooltip: (() { final guardedValue = map['tooltip']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetAreaTooltip.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetAreaUnit>(guardedValue, (value) => OneDashboardPageWidgetAreaUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
