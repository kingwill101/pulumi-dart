...
class OneDashboardPageWidgetLogTableColorSeriesOverride {
  /// (Optional) Choose a color to customize the color of your charts per series in area, bar, line, pie, and stacked bar charts. Accepted values are RGB, HEX, or HSL code.
  final pulumi.Input<String>? color;
  /// Series name
  final pulumi.Input<String>? seriesName;

  /// Creates a new [OneDashboardPageWidgetLogTableColorSeriesOverride].
  ...
  const OneDashboardPageWidgetLogTableColorSeriesOverride({
    this.color,
    this.seriesName,
  });
  ...
  factory OneDashboardPageWidgetLogTableColorSeriesOverride.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLogTableColorSeriesOverride(
