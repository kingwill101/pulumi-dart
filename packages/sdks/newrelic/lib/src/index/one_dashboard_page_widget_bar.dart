...
import 'one_dashboard_page_widget_bar_color.dart';
import 'one_dashboard_page_widget_bar_data_format.dart';
import 'one_dashboard_page_widget_bar_initial_sorting.dart';
import 'one_dashboard_page_widget_bar_nrql_query.dart';
import 'one_dashboard_page_widget_bar_null_value.dart';
import 'one_dashboard_page_widget_bar_unit.dart';

class OneDashboardPageWidgetBar {
  /// (Optional) A nested block that describes colors of your charts per series. See Nested Colors blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetBarColor>>? colors;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBarDataFormat>>? dataFormats;
  ...
  final pulumi.Input<OneDashboardPageWidgetBarInitialSorting>? initialSorting;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBarNrqlQuery>> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetBarNullValue>>? nullValues;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBarUnit>>? units;
  ...
  /// Creates a new [OneDashboardPageWidgetBar].
  ...
  const OneDashboardPageWidgetBar({
    this.colors,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetBarColor>, List<Map<String, dynamic>>>(colors, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetBarColor, Map<String, dynamic>>(value, (value) => value.toMap())),
      'column': column,
      'dataFormats': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetBarDataFormat>, List<Map<String, dynamic>>>(dataFormats, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetBarDataFormat, Map<String, dynamic>>(value, (value) => value.toMap())),
      'facetShowOtherSeries': ?facetShowOtherSeries,
      'filterCurrentDashboard': ?filterCurrentDashboard,
      'height': ?height,
      'id': ?id,
      'ignoreTimeRange': ?ignoreTimeRange,
      'initialSorting': ?pulumi.Input.mapOptionalInputValue<OneDashboardPageWidgetBarInitialSorting, Map<String, dynamic>>(initialSorting, (value) => value.toMap()),
      'legendEnabled': ?legendEnabled,
      'linkedEntityGuids': ?linkedEntityGuids,
      'nrqlQueries': pulumi.Input.mapInputValue<List<OneDashboardPageWidgetBarNrqlQuery>, List<Map<String, dynamic>>>(nrqlQueries, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetBarNrqlQuery, Map<String, dynamic>>(value, (value) => value.toMap())),
      'nullValues': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetBarNullValue>, List<Map<String, dynamic>>>(nullValues, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetBarNullValue, Map<String, dynamic>>(value, (value) => value.toMap())),
      'refreshRate': ?refreshRate,
      'row': row,
      'title': title,
      'units': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetBarUnit>, List<Map<String, dynamic>>>(units, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetBarUnit, Map<String, dynamic>>(value, (value) => value.toMap())),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetBar.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBar(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBarColor>(guardedValue, (value) => OneDashboardPageWidgetBarColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBarDataFormat>(guardedValue, (value) => OneDashboardPageWidgetBarDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetBarInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBarNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetBarNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBarNullValue>(guardedValue, (value) => OneDashboardPageWidgetBarNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBarUnit>(guardedValue, (value) => OneDashboardPageWidgetBarUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
