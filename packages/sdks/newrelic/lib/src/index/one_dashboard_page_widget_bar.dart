...
class OneDashboardPageWidgetBar {
  ...
  factory OneDashboardPageWidgetBar.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBar(
      colors: map['colors'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetBarColor>(map['colors']!, (value) => OneDashboardPageWidgetBarColor.fromMap((value as Map).cast<String, dynamic>()))).input(),
      column: (map['column'] as int).input(),
      dataFormats: map['dataFormats'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetBarDataFormat>(map['dataFormats']!, (value) => OneDashboardPageWidgetBarDataFormat.fromMap((value as Map).cast<String, dynamic>()))).input(),
      ...
      initialSorting: map['initialSorting'] == null ? null : (OneDashboardPageWidgetBarInitialSorting.fromMap((map['initialSorting']! as Map).cast<String, dynamic>())).input(),
      ...
      nrqlQueries: (pulumi.Input.decodeList<OneDashboardPageWidgetBarNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetBarNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))).input(),
      nullValues: map['nullValues'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetBarNullValue>(map['nullValues']!, (value) => OneDashboardPageWidgetBarNullValue.fromMap((value as Map).cast<String, dynamic>()))).input(),
      refreshRate: map['refreshRate'] == null ? null : (map['refreshRate']! as String).input(),
      row: (map['row'] as int).input(),
      title: (map['title'] as String).input(),
      units: map['units'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetBarUnit>(map['units']!, (value) => OneDashboardPageWidgetBarUnit.fromMap((value as Map).cast<String, dynamic>()))).input(),
