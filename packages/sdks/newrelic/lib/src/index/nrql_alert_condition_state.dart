...
class NrqlAlertConditionState {
  ...
  NrqlAlertConditionState({
    ...
    pulumi.Output<NrqlAlertConditionNrql>? nrql,
    ...
    pulumi.Output<NrqlAlertConditionWarning>? warning,
      ...
      nrql = pulumi.Input.asOptionalInput<NrqlAlertConditionNrql>(nrql),
  ...
  factory NrqlAlertConditionState.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionState(
      ...
      nrql: map['nrql'] == null ? null : pulumi.Output.create<NrqlAlertConditionNrql>(NrqlAlertConditionNrql.fromMap((map['nrql'] as Map).cast<String, dynamic>())),
