...
class OneDashboardPageWidgetPyNrqlQuery {
  ...
  /// Creates a new [OneDashboardPageWidgetPyNrqlQuery].
  ...
  OneDashboardPageWidgetPyNrqlQuery({this.accountId, required this.query});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'accountId': ?accountId, 'query': query};
  }

  factory OneDashboardPageWidgetPyNrqlQuery.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetPyNrqlQuery(
      accountId: (() {
