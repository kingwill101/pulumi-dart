...
class OneDashboardPageWidgetLine {
  ...
  const OneDashboardPageWidgetLine({
    this.colors,
  ...
  factory OneDashboardPageWidgetLine.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLine(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLineColor>(guardedValue, (value) => OneDashboardPageWidgetLineColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLineDataFormat>(guardedValue, (value) => OneDashboardPageWidgetLineDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetLineInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      isLabelVisible: (() { final guardedValue = map['isLabelVisible']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLineNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetLineNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLineNullValue>(guardedValue, (value) => OneDashboardPageWidgetLineNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      thresholds: (() { final guardedValue = map['thresholds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLineThreshold>(guardedValue, (value) => OneDashboardPageWidgetLineThreshold.fromMap((value as Map).cast<String, dynamic>()))); })(),
      title: pulumi.Input.fromValue(map['title'] as String),
      tooltip: (() { final guardedValue = map['tooltip']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetLineTooltip.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLineUnit>(guardedValue, (value) => OneDashboardPageWidgetLineUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      yAxisLeftZero: (() { final guardedValue = map['yAxisLeftZero']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      yAxisRight: (() { final guardedValue = map['yAxisRight']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetLineYAxisRight.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
