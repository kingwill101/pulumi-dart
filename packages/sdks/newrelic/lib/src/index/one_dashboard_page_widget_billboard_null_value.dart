...
class OneDashboardPageWidgetBillboardNullValue {
  ...
  final pulumi.Input<
    List<OneDashboardPageWidgetBillboardNullValueSeriesOverride>
  >?
  seriesOverrides;
  ...
  factory OneDashboardPageWidgetBillboardNullValue.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetBillboardNullValueSeriesOverride.fromMap(
