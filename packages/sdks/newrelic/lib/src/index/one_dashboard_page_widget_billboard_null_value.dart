...
class OneDashboardPageWidgetBillboardNullValue {
  ...
  final List<OneDashboardPageWidgetBillboardNullValueSeriesOverride>? seriesOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nullValue': ?nullValue,
      'seriesOverrides': ?seriesOverrides == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetBillboardNullValueSeriesOverride, Map<String, dynamic>>(seriesOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory OneDashboardPageWidgetBillboardNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBillboardNullValue(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetBillboardNullValueSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetBillboardNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
