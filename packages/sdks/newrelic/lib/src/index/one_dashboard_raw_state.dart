...
class OneDashboardRawState {
  ...
  factory OneDashboardRawState.fromMap(Map<String, dynamic> map) {
    return OneDashboardRawState(
      ...
      pages: (() { final guardedValue = map['pages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardRawPage>(guardedValue, (value) => OneDashboardRawPage.fromMap((value as Map).cast<String, dynamic>()))); })(),
