...
class AlertMutingRuleSchedule {
  ...
  factory AlertMutingRuleSchedule.fromMap(Map<String, dynamic> map) {
    return AlertMutingRuleSchedule(
      endRepeat: (() { final guardedValue = map['endRepeat']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      weeklyRepeatDays: (() { final guardedValue = map['weeklyRepeatDays']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
