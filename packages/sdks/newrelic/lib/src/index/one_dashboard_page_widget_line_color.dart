...
class OneDashboardPageWidgetLineColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetLineColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetLineColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLineColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetLineColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<OneDashboardPageWidgetLineColorSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetLineColorSeriesOverride.fromMap(
