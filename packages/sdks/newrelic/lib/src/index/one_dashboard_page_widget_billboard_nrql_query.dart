...
class OneDashboardPageWidgetBillboardNrqlQuery {
  ...
  /// Creates a new [OneDashboardPageWidgetBillboardNrqlQuery].
  ...
  const OneDashboardPageWidgetBillboardNrqlQuery({
    this.accountId,
    required this.query,
  });
  ...
  factory OneDashboardPageWidgetBillboardNrqlQuery.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBillboardNrqlQuery(
