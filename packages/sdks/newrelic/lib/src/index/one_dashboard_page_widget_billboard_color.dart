...
class OneDashboardPageWidgetBillboardColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBillboardColorSeriesOverride>>? seriesOverrides;
  ...
  const OneDashboardPageWidgetBillboardColor({
    this.color,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'color': ?color,
      'seriesOverrides': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetBillboardColorSeriesOverride>, List<Map<String, dynamic>>>(seriesOverrides, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetBillboardColorSeriesOverride, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory OneDashboardPageWidgetBillboardColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBillboardColor(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBillboardColorSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetBillboardColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
