...
class OneDashboardPageWidgetBillboardColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBillboardColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetBillboardColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetBillboardColorSeriesOverride>,
  ...
  factory OneDashboardPageWidgetBillboardColor.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetBillboardColorSeriesOverride.fromMap(
