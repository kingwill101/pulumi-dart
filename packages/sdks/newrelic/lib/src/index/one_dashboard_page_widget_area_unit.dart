...
class OneDashboardPageWidgetAreaUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetAreaUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetAreaUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetAreaUnitSeriesOverride>,
    ...
    return OneDashboardPageWidgetAreaUnit(
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetAreaUnitSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetAreaUnitSeriesOverride.fromMap(
