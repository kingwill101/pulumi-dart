...
class OneDashboardPageWidgetHeatmapDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetHeatmapDataFormat].
  ...
  const OneDashboardPageWidgetHeatmapDataFormat({
    this.format,
    required this.name,
    this.precision,
    required this.type,
  ...
  factory OneDashboardPageWidgetHeatmapDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHeatmapDataFormat(
