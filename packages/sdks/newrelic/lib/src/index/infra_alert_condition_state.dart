...
class InfraAlertConditionState {
  ...
  factory InfraAlertConditionState.fromMap(Map<String, dynamic> map) {
    return InfraAlertConditionState(
      ...
      createdAt: (() { final guardedValue = map['createdAt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      ...
      updatedAt: (() { final guardedValue = map['updatedAt']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
