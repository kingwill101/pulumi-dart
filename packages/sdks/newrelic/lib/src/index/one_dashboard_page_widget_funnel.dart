...
class OneDashboardPageWidgetFunnel {
  ...
  final List<OneDashboardPageWidgetFunnelColor>? colors;
  /// (Required) Column position of widget from top left, starting at `1`.
  final int column;
  /// (Optional) A nested block that describes data format. See Nested data_format blocks below for details.
  final List<OneDashboardPageWidgetFunnelDataFormat>? dataFormats;
  ...
  final OneDashboardPageWidgetFunnelInitialSorting? initialSorting;
  ...
  final List<OneDashboardPageWidgetFunnelNrqlQuery> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final List<OneDashboardPageWidgetFunnelNullValue>? nullValues;
  ...
  final List<OneDashboardPageWidgetFunnelUnit>? units;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?colors == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetFunnelColor, Map<String, dynamic>>(colors!, (value) => value.toMap()),
      'column': column,
      'dataFormats': ?dataFormats == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetFunnelDataFormat, Map<String, dynamic>>(dataFormats!, (value) => value.toMap()),
      ...
      'nrqlQueries': pulumi.Input.encodeList<OneDashboardPageWidgetFunnelNrqlQuery, Map<String, dynamic>>(nrqlQueries, (value) => value.toMap()),
      'nullValues': ?nullValues == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetFunnelNullValue, Map<String, dynamic>>(nullValues!, (value) => value.toMap()),
      'refreshRate': ?refreshRate,
      'row': row,
      'title': title,
      'units': ?units == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetFunnelUnit, Map<String, dynamic>>(units!, (value) => value.toMap()),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetFunnel.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetFunnel(
      colors: map['colors'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetFunnelColor>(map['colors'], (value) => OneDashboardPageWidgetFunnelColor.fromMap((value as Map).cast<String, dynamic>())),
      column: map['column'] as int,
      dataFormats: map['dataFormats'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetFunnelDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetFunnelDataFormat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      initialSorting: map['initialSorting'] == null ? null : OneDashboardPageWidgetFunnelInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>()),
      legendEnabled: map['legendEnabled'] == null ? null : map['legendEnabled'] as bool,
      nrqlQueries: pulumi.Input.decodeList<OneDashboardPageWidgetFunnelNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetFunnelNrqlQuery.fromMap((value as Map).cast<String, dynamic>())),
      nullValues: map['nullValues'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetFunnelNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetFunnelNullValue.fromMap((value as Map).cast<String, dynamic>())),
      refreshRate: map['refreshRate'] == null ? null : map['refreshRate'] as String,
      row: map['row'] as int,
      title: map['title'] as String,
      units: map['units'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetFunnelUnit>(map['units'], (value) => OneDashboardPageWidgetFunnelUnit.fromMap((value as Map).cast<String, dynamic>())),
