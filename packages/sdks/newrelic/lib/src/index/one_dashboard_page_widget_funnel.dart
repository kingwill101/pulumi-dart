...
class OneDashboardPageWidgetFunnel {
  ...
  const OneDashboardPageWidgetFunnel({
    this.colors,
  ...
  factory OneDashboardPageWidgetFunnel.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetFunnel(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetFunnelColor>(guardedValue, (value) => OneDashboardPageWidgetFunnelColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetFunnelDataFormat>(guardedValue, (value) => OneDashboardPageWidgetFunnelDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetFunnelInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetFunnelNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetFunnelNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetFunnelNullValue>(guardedValue, (value) => OneDashboardPageWidgetFunnelNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetFunnelUnit>(guardedValue, (value) => OneDashboardPageWidgetFunnelUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
