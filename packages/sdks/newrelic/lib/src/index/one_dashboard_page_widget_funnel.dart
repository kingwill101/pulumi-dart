...
class OneDashboardPageWidgetFunnel {
  ...
  final pulumi.Input<OneDashboardPageWidgetFunnelInitialSorting>?
  initialSorting;
    ...
    return <String, dynamic>{
      'colors':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetFunnelColor>,
      ...
      'dataFormats':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetFunnelDataFormat>,
            List<Map<String, dynamic>>
          >(
            dataFormats,
            (value) =>
      ...
      'nrqlQueries':
          pulumi.Input.mapInputValue<
            List<OneDashboardPageWidgetFunnelNrqlQuery>,
            List<Map<String, dynamic>>
          >(
            nrqlQueries,
            (value) =>
      ...
      'nullValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetFunnelNullValue>,
            List<Map<String, dynamic>>
          >(
            nullValues,
            (value) =>
      ...
      'units':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetFunnelUnit>,
            List<Map<String, dynamic>>
          >(
            units,
            (value) =>
    ...
    return OneDashboardPageWidgetFunnel(
      colors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetFunnelColor>(
            guardedValue,
            (value) => OneDashboardPageWidgetFunnelColor.fromMap(
      ...
      dataFormats: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetFunnelDataFormat>(
            guardedValue,
            (value) => OneDashboardPageWidgetFunnelDataFormat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      initialSorting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetFunnelInitialSorting.fromMap(
      ...
      nrqlQueries: pulumi.Input.fromValue(
        pulumi.Input.decodeList<OneDashboardPageWidgetFunnelNrqlQuery>(
          map['nrqlQueries']!,
          (value) => OneDashboardPageWidgetFunnelNrqlQuery.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      nullValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetFunnelNullValue>(
            guardedValue,
            (value) => OneDashboardPageWidgetFunnelNullValue.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      units: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetFunnelUnit>(
            guardedValue,
            (value) => OneDashboardPageWidgetFunnelUnit.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
