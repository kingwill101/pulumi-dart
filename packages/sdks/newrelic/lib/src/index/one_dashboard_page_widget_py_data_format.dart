...
class OneDashboardPageWidgetPyDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetPyDataFormat].
  ...
  const OneDashboardPageWidgetPyDataFormat({
    this.format,
    required this.name,
    this.precision,
    required this.type,
  ...
  factory OneDashboardPageWidgetPyDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetPyDataFormat(
