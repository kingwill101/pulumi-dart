...
class WorkflowIssuesFilter {
  ...
  factory WorkflowIssuesFilter.fromMap(Map<String, dynamic> map) {
    return WorkflowIssuesFilter(
      ...
      predicates: (() { final guardedValue = map['predicates']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<WorkflowIssuesFilterPredicate>(guardedValue, (value) => WorkflowIssuesFilterPredicate.fromMap((value as Map).cast<String, dynamic>()))); })(),
