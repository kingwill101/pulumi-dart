...
class WorkflowIssuesFilter {
    ...
    return <String, dynamic>{
      ...
      'predicates':
          ?pulumi.Input.mapOptionalInputValue<
            List<WorkflowIssuesFilterPredicate>,
  ...
  factory WorkflowIssuesFilter.fromMap(Map<String, dynamic> map) {
    return WorkflowIssuesFilter(
      filterId: (() {
        final guardedValue = map['filterId'];
      ...
      predicates: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<WorkflowIssuesFilterPredicate>(
            guardedValue,
            (value) => WorkflowIssuesFilterPredicate.fromMap(
