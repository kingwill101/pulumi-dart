...
class OneDashboardPageWidgetPyUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetPyUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetPyUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetPyUnitSeriesOverride>,
    ...
    return OneDashboardPageWidgetPyUnit(
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetPyUnitSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetPyUnitSeriesOverride.fromMap(
