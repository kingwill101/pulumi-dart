...
class OneDashboardPageWidgetPyUnit {
  ...
  const OneDashboardPageWidgetPyUnit({
  ...
  factory OneDashboardPageWidgetPyUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetPyUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetPyUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetPyUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
