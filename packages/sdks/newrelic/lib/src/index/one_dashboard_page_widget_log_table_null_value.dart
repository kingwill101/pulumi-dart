...
class OneDashboardPageWidgetLogTableNullValue {
  ...
  final List<OneDashboardPageWidgetLogTableNullValueSeriesOverride>? seriesOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nullValue': ?nullValue,
      'seriesOverrides': ?seriesOverrides == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetLogTableNullValueSeriesOverride, Map<String, dynamic>>(seriesOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory OneDashboardPageWidgetLogTableNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLogTableNullValue(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetLogTableNullValueSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetLogTableNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
