...
class OneDashboardPageWidgetLogTableNullValue {
  ...
  final pulumi.Input<
    List<OneDashboardPageWidgetLogTableNullValueSeriesOverride>
  >?
  seriesOverrides;
  ...
  factory OneDashboardPageWidgetLogTableNullValue.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetLogTableNullValueSeriesOverride.fromMap(
