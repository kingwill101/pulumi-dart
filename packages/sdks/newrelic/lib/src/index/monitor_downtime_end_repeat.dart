...
class MonitorDowntimeEndRepeat {
  ...
  MonitorDowntimeEndRepeat({this.onDate, this.onRepeat});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'onDate': ?onDate, 'onRepeat': ?onRepeat};
  }

  factory MonitorDowntimeEndRepeat.fromMap(Map<String, dynamic> map) {
    return MonitorDowntimeEndRepeat(
      onDate: (() {
        final guardedValue = map['onDate'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      onRepeat: (() {
        final guardedValue = map['onRepeat'];
        if (guardedValue == null) return null;
