...
class OneDashboardPageWidgetMarkdown {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetMarkdownDataFormat>>?
  dataFormats;
  ...
  final pulumi.Input<OneDashboardPageWidgetMarkdownInitialSorting>?
  initialSorting;
    ...
    return <String, dynamic>{
      'colors':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetMarkdownColor>,
      ...
      'dataFormats':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetMarkdownDataFormat>,
            List<Map<String, dynamic>>
          >(
            dataFormats,
            (value) =>
      ...
      'nullValues':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetMarkdownNullValue>,
            List<Map<String, dynamic>>
          >(
            nullValues,
            (value) =>
      ...
      'units':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetMarkdownUnit>,
            List<Map<String, dynamic>>
          >(
            units,
            (value) =>
    ...
    return OneDashboardPageWidgetMarkdown(
      colors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownColor>(
            guardedValue,
            (value) => OneDashboardPageWidgetMarkdownColor.fromMap(
      ...
      dataFormats: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownDataFormat>(
            guardedValue,
            (value) => OneDashboardPageWidgetMarkdownDataFormat.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      initialSorting: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetMarkdownInitialSorting.fromMap(
      ...
      nullValues: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownNullValue>(
            guardedValue,
            (value) => OneDashboardPageWidgetMarkdownNullValue.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      units: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownUnit>(
            guardedValue,
            (value) => OneDashboardPageWidgetMarkdownUnit.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
