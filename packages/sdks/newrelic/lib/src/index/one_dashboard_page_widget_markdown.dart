...
class OneDashboardPageWidgetMarkdown {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetMarkdownColor>>? colors;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetMarkdownDataFormat>>? dataFormats;
  ...
  final pulumi.Input<OneDashboardPageWidgetMarkdownInitialSorting>? initialSorting;
  /// (Optional) With this turned on, the legend will be displayed. Defaults to `true`.
  final pulumi.Input<bool>? legendEnabled;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final pulumi.Input<List<OneDashboardPageWidgetMarkdownNullValue>>? nullValues;
  ...
  final pulumi.Input<List<OneDashboardPageWidgetMarkdownUnit>>? units;
  ...
  const OneDashboardPageWidgetMarkdown({
    this.colors,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetMarkdownColor>, List<Map<String, dynamic>>>(colors, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetMarkdownColor, Map<String, dynamic>>(value, (value) => value.toMap())),
      'column': column,
      'dataFormats': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetMarkdownDataFormat>, List<Map<String, dynamic>>>(dataFormats, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetMarkdownDataFormat, Map<String, dynamic>>(value, (value) => value.toMap())),
      'facetShowOtherSeries': ?facetShowOtherSeries,
      'height': ?height,
      'id': ?id,
      'ignoreTimeRange': ?ignoreTimeRange,
      'initialSorting': ?pulumi.Input.mapOptionalInputValue<OneDashboardPageWidgetMarkdownInitialSorting, Map<String, dynamic>>(initialSorting, (value) => value.toMap()),
      'legendEnabled': ?legendEnabled,
      'nullValues': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetMarkdownNullValue>, List<Map<String, dynamic>>>(nullValues, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetMarkdownNullValue, Map<String, dynamic>>(value, (value) => value.toMap())),
      'refreshRate': ?refreshRate,
      'row': row,
      'text': text,
      'title': title,
      'units': ?pulumi.Input.mapOptionalInputValue<List<OneDashboardPageWidgetMarkdownUnit>, List<Map<String, dynamic>>>(units, (value) => pulumi.Input.encodeList<OneDashboardPageWidgetMarkdownUnit, Map<String, dynamic>>(value, (value) => value.toMap())),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetMarkdown.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetMarkdown(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownColor>(guardedValue, (value) => OneDashboardPageWidgetMarkdownColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownDataFormat>(guardedValue, (value) => OneDashboardPageWidgetMarkdownDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetMarkdownInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownNullValue>(guardedValue, (value) => OneDashboardPageWidgetMarkdownNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownUnit>(guardedValue, (value) => OneDashboardPageWidgetMarkdownUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
