...
class OneDashboardState {
  ...
  factory OneDashboardState.fromMap(Map<String, dynamic> map) {
    return OneDashboardState(
      ...
      pages: (() { final guardedValue = map['pages']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPage>(guardedValue, (value) => OneDashboardPage.fromMap((value as Map).cast<String, dynamic>()))); })(),
