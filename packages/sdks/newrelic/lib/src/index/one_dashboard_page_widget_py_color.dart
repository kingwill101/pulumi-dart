...
class OneDashboardPageWidgetPyColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetPyColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetPyColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetPyColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetPyColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetPyColorSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetPyColorSeriesOverride.fromMap(
