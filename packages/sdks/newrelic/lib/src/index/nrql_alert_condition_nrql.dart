...
class NrqlAlertConditionNrql {
  ...
  factory NrqlAlertConditionNrql.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionNrql(
      dataAccountId: (() { final guardedValue = map['dataAccountId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      evaluationOffset: (() { final guardedValue = map['evaluationOffset']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as int); })(),
      query: pulumi.Input.fromValue(map['query'] as String),
      sinceValue: (() { final guardedValue = map['sinceValue']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
