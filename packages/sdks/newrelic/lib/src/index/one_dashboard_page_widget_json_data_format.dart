...
class OneDashboardPageWidgetJsonDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetJsonDataFormat].
  ...
  const OneDashboardPageWidgetJsonDataFormat({
    this.format,
    required this.name,
    this.precision,
    required this.type,
  ...
  factory OneDashboardPageWidgetJsonDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetJsonDataFormat(
