...
class OneDashboardPageWidgetBullet {
  ...
  const OneDashboardPageWidgetBullet({
    this.colors,
  ...
  factory OneDashboardPageWidgetBullet.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBullet(
      colors: (() { final guardedValue = map['colors']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBulletColor>(guardedValue, (value) => OneDashboardPageWidgetBulletColor.fromMap((value as Map).cast<String, dynamic>()))); })(),
      column: pulumi.Input.fromValue(map['column'] as int),
      dataFormats: (() { final guardedValue = map['dataFormats']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBulletDataFormat>(guardedValue, (value) => OneDashboardPageWidgetBulletDataFormat.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      initialSorting: (() { final guardedValue = map['initialSorting']; if (guardedValue == null) return null; return pulumi.Input.fromValue(OneDashboardPageWidgetBulletInitialSorting.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      nrqlQueries: pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBulletNrqlQuery>(map['nrqlQueries']!, (value) => OneDashboardPageWidgetBulletNrqlQuery.fromMap((value as Map).cast<String, dynamic>()))),
      nullValues: (() { final guardedValue = map['nullValues']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBulletNullValue>(guardedValue, (value) => OneDashboardPageWidgetBulletNullValue.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      units: (() { final guardedValue = map['units']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBulletUnit>(guardedValue, (value) => OneDashboardPageWidgetBulletUnit.fromMap((value as Map).cast<String, dynamic>()))); })(),
