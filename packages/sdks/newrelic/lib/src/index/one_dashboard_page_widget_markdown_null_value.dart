...
class OneDashboardPageWidgetMarkdownNullValue {
  ...
  const OneDashboardPageWidgetMarkdownNullValue({
    this.nullValue,
  ...
  factory OneDashboardPageWidgetMarkdownNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetMarkdownNullValue(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetMarkdownNullValueSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetMarkdownNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
