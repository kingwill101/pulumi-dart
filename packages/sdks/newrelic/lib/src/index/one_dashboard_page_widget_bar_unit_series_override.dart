...
class OneDashboardPageWidgetBarUnitSeriesOverride {
  /// Series name
  final pulumi.Input<String>? seriesName;
  /// (Optional) Choose a unit to customize the unit on your Y axis and in each of your series.
  final pulumi.Input<String>? unit;

  /// Creates a new [OneDashboardPageWidgetBarUnitSeriesOverride].
  /// [seriesName] Series name
  /// [unit] (Optional) Choose a unit to customize the unit on your Y axis and in each of your series.
  const OneDashboardPageWidgetBarUnitSeriesOverride({
    this.seriesName,
    this.unit,
  });
  ...
  factory OneDashboardPageWidgetBarUnitSeriesOverride.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBarUnitSeriesOverride(
