...
class OneDashboardPageWidgetLogTableDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetLogTableDataFormat].
  ...
  factory OneDashboardPageWidgetLogTableDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLogTableDataFormat(
