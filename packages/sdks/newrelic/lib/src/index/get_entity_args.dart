...
class GetEntityArgs {
  ...
  factory GetEntityArgs.fromMap(Map<String, dynamic> map) {
    return GetEntityArgs(
      ...
      entityTags: (() { final guardedValue = map['entityTags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      ignoreNotFound: (() { final guardedValue = map['ignoreNotFound']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      name: pulumi.Input.fromValue(map['name'] as String),
      tags: (() { final guardedValue = map['tags']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<GetEntityTag>(guardedValue, (value) => GetEntityTag.fromMap((value as Map).cast<String, dynamic>()))); })(),
