...
class ObfuscationRuleArgs {
  ...
  factory ObfuscationRuleArgs.fromMap(Map<String, dynamic> map) {
    return ObfuscationRuleArgs(
      ...
      actions: pulumi.Input.fromValue(pulumi.Input.decodeList<ObfuscationRuleAction>(map['actions']!, (value) => ObfuscationRuleAction.fromMap((value as Map).cast<String, dynamic>()))),
