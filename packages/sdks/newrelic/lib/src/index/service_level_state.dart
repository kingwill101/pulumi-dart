...
class ServiceLevelState {
  ...
  factory ServiceLevelState.fromMap(Map<String, dynamic> map) {
    return ServiceLevelState(
      ...
      events: (() { final guardedValue = map['events']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceLevelEvents.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      objective: (() { final guardedValue = map['objective']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceLevelObjective.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      sliGuid: (() { final guardedValue = map['sliGuid']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      sliId: (() { final guardedValue = map['sliId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
