...
class OneDashboardPageWidgetBillboardDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetBillboardDataFormat].
  ...
  const OneDashboardPageWidgetBillboardDataFormat({
    this.format,
    required this.name,
    this.precision,
    required this.type,
  ...
  factory OneDashboardPageWidgetBillboardDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBillboardDataFormat(
