...
class NrqlAlertConditionWarning {
  ...
  const NrqlAlertConditionWarning({
  ...
  factory NrqlAlertConditionWarning.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionWarning(
      ...
      prediction: (() { final guardedValue = map['prediction']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NrqlAlertConditionWarningPrediction.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
