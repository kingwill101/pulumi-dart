...
class OneDashboardPageWidgetBillboardBillboardSettings {
  ...
  final pulumi.Input<OneDashboardPageWidgetBillboardBillboardSettingsLink>?
  link;

  /// (Optional) A nested block that configures the visual settings of the billboard widget. This block supports:
  final pulumi.Input<OneDashboardPageWidgetBillboardBillboardSettingsVisual>?
  visual;
    ...
    return <String, dynamic>{
      ...
      'visual':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(visual, (value) => value.toMap()),
    };
  }

  factory OneDashboardPageWidgetBillboardBillboardSettings.fromMap(
    Map<String, dynamic> map,
  ) {
    return OneDashboardPageWidgetBillboardBillboardSettings(
      gridOptions: (() {
        final guardedValue = map['gridOptions'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetBillboardBillboardSettingsGridOptions.fromMap(
      ...
      link: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetBillboardBillboardSettingsLink.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      visual: (() {
        final guardedValue = map['visual'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardPageWidgetBillboardBillboardSettingsVisual.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
