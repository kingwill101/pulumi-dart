...
class OneDashboardPageWidgetLineUnit {
  ...
  const OneDashboardPageWidgetLineUnit({
  ...
  factory OneDashboardPageWidgetLineUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLineUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLineUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetLineUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
