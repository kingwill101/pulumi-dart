...
class OneDashboardPageWidgetLineUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetLineUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetLineUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLineUnitSeriesOverride>,
    ...
    return OneDashboardPageWidgetLineUnit(
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardPageWidgetLineUnitSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetLineUnitSeriesOverride.fromMap(
