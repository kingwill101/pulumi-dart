...
class OneDashboardPageWidgetAreaColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetAreaColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetAreaColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetAreaColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetAreaColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<OneDashboardPageWidgetAreaColorSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetAreaColorSeriesOverride.fromMap(
