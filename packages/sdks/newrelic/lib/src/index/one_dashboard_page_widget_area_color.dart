...
class OneDashboardPageWidgetAreaColor {
  ...
  const OneDashboardPageWidgetAreaColor({
    this.color,
  ...
  factory OneDashboardPageWidgetAreaColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetAreaColor(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetAreaColorSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetAreaColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
