...
class OneDashboardPageWidgetBulletColor {
  ...
  factory OneDashboardPageWidgetBulletColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBulletColor(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : (pulumi.Input.decodeList<OneDashboardPageWidgetBulletColorSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetBulletColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
