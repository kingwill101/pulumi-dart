...
class OneDashboardPageWidgetBulletColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBulletColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetBulletColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetBulletColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetBulletColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => OneDashboardPageWidgetBulletColorSeriesOverride.fromMap(
