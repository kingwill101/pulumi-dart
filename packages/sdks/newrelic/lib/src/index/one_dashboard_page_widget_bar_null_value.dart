...
class OneDashboardPageWidgetBarNullValue {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetBarNullValueSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetBarNullValue({this.nullValue, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetBarNullValueSeriesOverride>,
    ...
    return OneDashboardPageWidgetBarNullValue(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => OneDashboardPageWidgetBarNullValueSeriesOverride.fromMap(
