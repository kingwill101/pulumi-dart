...
class OneDashboardPageWidgetBarNullValue {
  ...
  const OneDashboardPageWidgetBarNullValue({
    this.nullValue,
  ...
  factory OneDashboardPageWidgetBarNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBarNullValue(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetBarNullValueSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetBarNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
