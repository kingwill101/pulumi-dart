...
class OneDashboardPageWidgetLogTableUnit {
  ...
  const OneDashboardPageWidgetLogTableUnit({
  ...
  factory OneDashboardPageWidgetLogTableUnit.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetLogTableUnit(
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetLogTableUnitSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetLogTableUnitSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
