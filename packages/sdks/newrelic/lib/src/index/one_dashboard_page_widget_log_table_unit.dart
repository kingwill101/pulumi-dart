...
class OneDashboardPageWidgetLogTableUnit {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetLogTableUnitSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetLogTableUnit({this.seriesOverrides, this.unit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetLogTableUnitSeriesOverride>,
    ...
    return OneDashboardPageWidgetLogTableUnit(
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => OneDashboardPageWidgetLogTableUnitSeriesOverride.fromMap(
