...
class OneDashboardPageWidgetAreaUnitSeriesOverride {
  /// Series name
  final pulumi.Input<String>? seriesName;
  /// (Optional) Choose a unit to customize the unit on your Y axis and in each of your series.
  final pulumi.Input<String>? unit;

  /// Creates a new [OneDashboardPageWidgetAreaUnitSeriesOverride].
  /// [seriesName] Series name
  /// [unit] (Optional) Choose a unit to customize the unit on your Y axis and in each of your series.
  const OneDashboardPageWidgetAreaUnitSeriesOverride({
    this.seriesName,
    this.unit,
  });
  ...
  factory OneDashboardPageWidgetAreaUnitSeriesOverride.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetAreaUnitSeriesOverride(
