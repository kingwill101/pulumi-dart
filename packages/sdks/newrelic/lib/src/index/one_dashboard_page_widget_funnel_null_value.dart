...
class OneDashboardPageWidgetFunnelNullValue {
  ...
  const OneDashboardPageWidgetFunnelNullValue({
    this.nullValue,
  ...
  factory OneDashboardPageWidgetFunnelNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetFunnelNullValue(
      ...
      seriesOverrides: (() { final guardedValue = map['seriesOverrides']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<OneDashboardPageWidgetFunnelNullValueSeriesOverride>(guardedValue, (value) => OneDashboardPageWidgetFunnelNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
