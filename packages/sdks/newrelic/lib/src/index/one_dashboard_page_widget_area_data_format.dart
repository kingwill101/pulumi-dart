...
class OneDashboardPageWidgetAreaDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetAreaDataFormat].
  ...
  const OneDashboardPageWidgetAreaDataFormat({
    this.format,
    required this.name,
    this.precision,
    required this.type,
  ...
  factory OneDashboardPageWidgetAreaDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetAreaDataFormat(
