...
class OneDashboardPageWidgetTableColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetTableColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetTableColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetTableColorSeriesOverride>,
    ...
    return OneDashboardPageWidgetTableColor(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<OneDashboardPageWidgetTableColorSeriesOverride>(
            guardedValue,
            (value) => OneDashboardPageWidgetTableColorSeriesOverride.fromMap(
