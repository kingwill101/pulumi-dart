...
class OneDashboardPageWidgetBarNrqlQuery {
  ...
  /// Creates a new [OneDashboardPageWidgetBarNrqlQuery].
  ...
  OneDashboardPageWidgetBarNrqlQuery({this.accountId, required this.query});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'accountId': ?accountId, 'query': query};
  }

  factory OneDashboardPageWidgetBarNrqlQuery.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBarNrqlQuery(
      accountId: (() {
