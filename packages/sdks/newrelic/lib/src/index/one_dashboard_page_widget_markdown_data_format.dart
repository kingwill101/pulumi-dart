...
class OneDashboardPageWidgetMarkdownDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetMarkdownDataFormat].
  ...
  const OneDashboardPageWidgetMarkdownDataFormat({
    this.format,
    required this.name,
    this.precision,
    required this.type,
  ...
  factory OneDashboardPageWidgetMarkdownDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetMarkdownDataFormat(
