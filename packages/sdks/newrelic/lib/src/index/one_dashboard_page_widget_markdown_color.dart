...
class OneDashboardPageWidgetMarkdownColor {
  ...
  final pulumi.Input<List<OneDashboardPageWidgetMarkdownColorSeriesOverride>>?
  seriesOverrides;
  ...
  OneDashboardPageWidgetMarkdownColor({this.color, this.seriesOverrides});
    ...
    return <String, dynamic>{
      ...
      'seriesOverrides':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardPageWidgetMarkdownColorSeriesOverride>,
  ...
  factory OneDashboardPageWidgetMarkdownColor.fromMap(
      ...
      seriesOverrides: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                OneDashboardPageWidgetMarkdownColorSeriesOverride.fromMap(
