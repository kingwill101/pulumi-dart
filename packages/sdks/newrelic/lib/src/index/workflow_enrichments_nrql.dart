    ...
    return <String, dynamic>{
      ...
      'configurations':
          pulumi.Input.mapInputValue<
            List<WorkflowEnrichmentsNrqlConfiguration>,
  ...
  factory WorkflowEnrichmentsNrql.fromMap(Map<String, dynamic> map) {
    return WorkflowEnrichmentsNrql(
      ...
      configurations: pulumi.Input.fromValue(
        pulumi.Input.decodeList<WorkflowEnrichmentsNrqlConfiguration>(
          map['configurations']!,
          (value) => WorkflowEnrichmentsNrqlConfiguration.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      enrichmentId: (() {
        final guardedValue = map['enrichmentId'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
