...
class OneDashboardVariable {
    ...
    return <String, dynamic>{
      ...
      'nrqlQuery':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(nrqlQuery, (value) => value.toMap()),
      'options':
          ?pulumi.Input.mapOptionalInputValue<
            List<OneDashboardVariableOption>,
            List<Map<String, dynamic>>
          >(
            options,
            (value) =>
  ...
  factory OneDashboardVariable.fromMap(Map<String, dynamic> map) {
    return OneDashboardVariable(
      defaultValues: (() {
        final guardedValue = map['defaultValues'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      isMultiSelection: (() {
        final guardedValue = map['isMultiSelection'];
        if (guardedValue == null) return null;
      ...
      items: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardVariableItem>(
            guardedValue,
            (value) => OneDashboardVariableItem.fromMap(
      ...
      nrqlQuery: (() {
        final guardedValue = map['nrqlQuery'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          OneDashboardVariableNrqlQuery.fromMap(
      ...
      options: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<OneDashboardVariableOption>(
            guardedValue,
            (value) => OneDashboardVariableOption.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      })(),
      replacementStrategy: pulumi.Input.fromValue(
