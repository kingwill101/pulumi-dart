...
class DomainDevicesConsoleSourceUdp {
  ...
  /// Creates a new [DomainDevicesConsoleSourceUdp].
  ...
  const DomainDevicesConsoleSourceUdp({
  ...
  factory DomainDevicesConsoleSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourceUdp(
