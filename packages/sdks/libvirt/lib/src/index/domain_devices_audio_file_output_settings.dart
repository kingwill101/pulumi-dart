...
class DomainDevicesAudioFileOutputSettings {
  ...
  /// Creates a new [DomainDevicesAudioFileOutputSettings].
  ...
  const DomainDevicesAudioFileOutputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioFileOutputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioFileOutputSettings(
