...
class DomainDevicesConsoleSourceNmdm {
  ...
  /// Creates a new [DomainDevicesConsoleSourceNmdm].
  ...
  DomainDevicesConsoleSourceNmdm({required this.master, required this.slave});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'master': master, 'slave': slave};
  }

  factory DomainDevicesConsoleSourceNmdm.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourceNmdm(
