    ...
    return DomainDevicesRedirDev(
      acpi: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesRedirDevAcpi.fromMap(
      ...
      alias: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesRedirDevAlias.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      boot: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesRedirDevBoot.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      protocol: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesRedirDevProtocol.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesRedirDevSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
