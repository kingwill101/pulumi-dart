...
class DomainDevicesDiskBackingStoreSourceVhostUserFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserFileSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserFileSecLabel(
