...
class DomainDevicesDiskBackingStoreSourceReservationsSourceTcpReconnect {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceReservationsSourceTcpReconnect].
  ...
  const DomainDevicesDiskBackingStoreSourceReservationsSourceTcpReconnect({
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceTcpReconnect.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourceTcpReconnect(
