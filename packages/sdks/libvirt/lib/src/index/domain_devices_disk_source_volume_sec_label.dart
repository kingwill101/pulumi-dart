...
class DomainDevicesDiskSourceVolumeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceVolumeSecLabel].
  ...
  const DomainDevicesDiskSourceVolumeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceVolumeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVolumeSecLabel(
