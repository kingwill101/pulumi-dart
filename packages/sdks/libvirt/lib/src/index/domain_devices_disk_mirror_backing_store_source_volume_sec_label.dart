...
class DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel].
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel(
