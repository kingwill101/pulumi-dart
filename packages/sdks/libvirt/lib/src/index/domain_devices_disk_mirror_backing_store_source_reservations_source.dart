...
class DomainDevicesDiskMirrorBackingStoreSourceReservationsSource {
  ...
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceDbus? dbus;
  /// Defines the device path for the source of the EGD backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceDev? dev;
  /// Defines a file source for the RNG EGD backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceFile? file;
  /// Configures the NMDM (null modem) device source for the EGD backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceNmdm? nmdm;
  /// Configures settings for a null device used in reservations for storage.
  final bool? null_;
  /// Defines a pipe source for the EGD backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePipe? pipe;
  /// Defines a pseudo-terminal (PTY) source for the EGD backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePty? pty;
  /// Configures the QEMU guest agent for the random number generator backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceQemuvdAgent? qemuvdAgent;
  /// Configures the SPICE port settings for the random number generator backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceSpicePort? spicePort;
  ...
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceTcp? tcp;
  /// Configures UDP settings for the random number generator backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUdp? udp;
  /// Configures UNIX domain socket settings for the random number generator backend.
  final DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUnix? unix;
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceReservationsSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceReservationsSource(
      dbus: map['dbus'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceDbus.fromMap((map['dbus'] as Map).cast<String, dynamic>()),
      dev: map['dev'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceDev.fromMap((map['dev'] as Map).cast<String, dynamic>()),
      file: map['file'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceFile.fromMap((map['file'] as Map).cast<String, dynamic>()),
      nmdm: map['nmdm'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceNmdm.fromMap((map['nmdm'] as Map).cast<String, dynamic>()),
      null_: map['null'] == null ? null : map['null'] as bool,
      pipe: map['pipe'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePipe.fromMap((map['pipe'] as Map).cast<String, dynamic>()),
      pty: map['pty'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePty.fromMap((map['pty'] as Map).cast<String, dynamic>()),
      qemuvdAgent: map['qemuvdAgent'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceQemuvdAgent.fromMap((map['qemuvdAgent'] as Map).cast<String, dynamic>()),
      spicePort: map['spicePort'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceSpicePort.fromMap((map['spicePort'] as Map).cast<String, dynamic>()),
      spiceVmc: map['spiceVmc'] == null ? null : map['spiceVmc'] as bool,
      stdIo: map['stdIo'] == null ? null : map['stdIo'] as bool,
      tcp: map['tcp'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceTcp.fromMap((map['tcp'] as Map).cast<String, dynamic>()),
      udp: map['udp'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUdp.fromMap((map['udp'] as Map).cast<String, dynamic>()),
      unix: map['unix'] == null ? null : DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUnix.fromMap((map['unix'] as Map).cast<String, dynamic>()),
