    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesChannelSourceFileSecLabel>,
    ...
    return DomainDevicesChannelSourceFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesChannelSourceFileSecLabel>(
            guardedValue,
            (value) => DomainDevicesChannelSourceFileSecLabel.fromMap(
