...
class DomainDevicesConsoleSourceQemuvdAgent {
  ...
  DomainDevicesConsoleSourceQemuvdAgent({this.clipBoard, this.mouse});
  ...
  factory DomainDevicesConsoleSourceQemuvdAgent.fromMap(
    ...
    return DomainDevicesConsoleSourceQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesConsoleSourceQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesConsoleSourceQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
