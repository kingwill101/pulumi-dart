...
class DomainDevicesDiskSourceVhostUserFile {
  ...
  final pulumi.Input<List<DomainDevicesDiskSourceVhostUserFileSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskSourceVhostUserFileSecLabel>,
  ...
  factory DomainDevicesDiskSourceVhostUserFile.fromMap(
    ...
    return DomainDevicesDiskSourceVhostUserFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskSourceVhostUserFileSecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskSourceVhostUserFileSecLabel.fromMap(
