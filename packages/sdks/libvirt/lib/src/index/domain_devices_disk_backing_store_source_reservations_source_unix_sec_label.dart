...
class DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel(
