...
class DomainDevicesAudioSdlInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioSdlInputSettings].
  ...
  const DomainDevicesAudioSdlInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioSdlInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioSdlInputSettings(
