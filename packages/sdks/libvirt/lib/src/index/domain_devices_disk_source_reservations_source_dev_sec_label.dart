...
class DomainDevicesDiskSourceReservationsSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceReservationsSourceDevSecLabel].
  ...
  const DomainDevicesDiskSourceReservationsSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceReservationsSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourceDevSecLabel(
