...
class DomainDevicesSerialSourcePipe {
  ...
  factory DomainDevicesSerialSourcePipe.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourcePipe(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesSerialSourcePipeSecLabel>(guardedValue, (value) => DomainDevicesSerialSourcePipeSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
