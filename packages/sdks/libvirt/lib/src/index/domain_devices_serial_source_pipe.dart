...
class DomainDevicesSerialSourcePipe {
  ...
  DomainDevicesSerialSourcePipe({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSerialSourcePipeSecLabel>,
    ...
    return DomainDevicesSerialSourcePipe(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesSerialSourcePipeSecLabel>(
            guardedValue,
            (value) => DomainDevicesSerialSourcePipeSecLabel.fromMap(
