...
class DomainDevicesRedirDevSourceDev {
  ...
  final List<DomainDevicesRedirDevSourceDevSecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesRedirDevSourceDevSecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesRedirDevSourceDev.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourceDev(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesRedirDevSourceDevSecLabel>(map['secLabels'], (value) => DomainDevicesRedirDevSourceDevSecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
