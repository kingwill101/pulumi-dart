...
import 'domain_devices_serial_source_tcp_reconnect.dart';

class DomainDevicesSerialSourceTcp {
  ...
  final pulumi.Input<DomainDevicesSerialSourceTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainDevicesSerialSourceTcp].
  ...
  const DomainDevicesSerialSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesSerialSourceTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }

  factory DomainDevicesSerialSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourceTcp(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesSerialSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
