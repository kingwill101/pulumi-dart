...
class DomainOsNvRamSourceReservationsSourcePipe {
  ...
  factory DomainOsNvRamSourceReservationsSourcePipe.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourcePipe(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainOsNvRamSourceReservationsSourcePipeSecLabel>(guardedValue, (value) => DomainOsNvRamSourceReservationsSourcePipeSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
