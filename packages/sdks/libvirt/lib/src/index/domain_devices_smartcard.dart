...
class DomainDevicesSmartcard {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostCerts':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSmartcardHostCert>,
    ...
    return DomainDevicesSmartcard(
      acpi: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesSmartcardAcpi.fromMap(
      ...
      alias: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesSmartcardAlias.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      hostCerts: (() {
        final guardedValue = map['hostCerts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesSmartcardHostCert>(
            guardedValue,
            (value) => DomainDevicesSmartcardHostCert.fromMap(
      ...
      passthrough: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesSmartcardPassthrough.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      protocol: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesSmartcardProtocol.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
