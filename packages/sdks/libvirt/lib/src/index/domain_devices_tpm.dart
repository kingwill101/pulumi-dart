...
class DomainDevicesTpm {
  ...
  factory DomainDevicesTpm.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpm(
      acpi: (() { final guardedValue = map['acpi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesTpmAcpi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      alias: (() { final guardedValue = map['alias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesTpmAlias.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      backend: (() { final guardedValue = map['backend']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesTpmBackend.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
