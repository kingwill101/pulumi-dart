...
class DomainDevicesParallelSourceUdp {
  ...
  /// Creates a new [DomainDevicesParallelSourceUdp].
  ...
  const DomainDevicesParallelSourceUdp({
  ...
  factory DomainDevicesParallelSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceUdp(
