...
class DomainDevicesTpmBackendExternalSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesTpmBackendExternalSourceDevSecLabel].
  ...
  const DomainDevicesTpmBackendExternalSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesTpmBackendExternalSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendExternalSourceDevSecLabel(
