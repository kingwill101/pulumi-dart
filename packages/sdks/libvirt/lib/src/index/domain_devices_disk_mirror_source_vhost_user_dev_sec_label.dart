...
class DomainDevicesDiskMirrorSourceVhostUserDevSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceVhostUserDevSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceVhostUserDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserDevSecLabel(
