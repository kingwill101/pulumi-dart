...
class DomainDevicesSmartcardPassthroughUnix {
  ...
  final DomainDevicesSmartcardPassthroughUnixReconnect? reconnect;
  /// Configures the security label for the UNIX domain socket.
  final List<DomainDevicesSmartcardPassthroughUnixSecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesSmartcardPassthroughUnixSecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesSmartcardPassthroughUnix.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughUnix(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesSmartcardPassthroughUnixReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesSmartcardPassthroughUnixSecLabel>(map['secLabels'], (value) => DomainDevicesSmartcardPassthroughUnixSecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
