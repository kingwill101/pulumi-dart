...
class DomainDevicesSmartcardPassthroughUnix {
  ...
  final pulumi.Input<List<DomainDevicesSmartcardPassthroughUnixSecLabel>>?
  secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSmartcardPassthroughUnixSecLabel>,
  ...
  factory DomainDevicesSmartcardPassthroughUnix.fromMap(
    ...
    return DomainDevicesSmartcardPassthroughUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesSmartcardPassthroughUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<DomainDevicesSmartcardPassthroughUnixSecLabel>(
            guardedValue,
            (value) => DomainDevicesSmartcardPassthroughUnixSecLabel.fromMap(
