...
class DomainCpu {
  ...
  factory DomainCpu.fromMap(Map<String, dynamic> map) {
    return DomainCpu(
      cache: (() { final guardedValue = map['cache']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainCpuCache.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      check: (() { final guardedValue = map['check']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      deprecatedFeatures: (() { final guardedValue = map['deprecatedFeatures']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      features: (() { final guardedValue = map['features']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuFeature>(guardedValue, (value) => DomainCpuFeature.fromMap((value as Map).cast<String, dynamic>()))); })(),
      match: (() { final guardedValue = map['match']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      maxPhysAddr: (() { final guardedValue = map['maxPhysAddr']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainCpuMaxPhysAddr.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      migratable: (() { final guardedValue = map['migratable']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
      ...
      modelFallback: (() { final guardedValue = map['modelFallback']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      modelVendorId: (() { final guardedValue = map['modelVendorId']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      numa: (() { final guardedValue = map['numa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainCpuNuma.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      topology: (() { final guardedValue = map['topology']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainCpuTopology.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
