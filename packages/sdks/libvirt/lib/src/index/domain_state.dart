...
class DomainState {
  ...
  DomainState({
    ...
    pulumi.Output<DomainVcpus>? vcpus,
      ...
      domainId = pulumi.Input.asOptionalInput<double>(domainId),
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      domainId: map['domainId'] == null ? null : pulumi.Output.create<double>(map['domainId'] as double),
