...
class DomainState {
  ...
  /// [domainId] Exposes the numeric domain ID assigned by libvirt at runtime; this value is computed by libvirt and is read-only.
  ...
  factory DomainState.fromMap(Map<String, dynamic> map) {
    return DomainState(
      ...
      blockIoTune: map['blockIoTune'] == null ? null : (DomainBlockIoTune.fromMap((map['blockIoTune']! as Map).cast<String, dynamic>())).input(),
      bootloader: map['bootloader'] == null ? null : (map['bootloader']! as String).input(),
      bootloaderArgs: map['bootloaderArgs'] == null ? null : (map['bootloaderArgs']! as String).input(),
      clock: map['clock'] == null ? null : (DomainClock.fromMap((map['clock']! as Map).cast<String, dynamic>())).input(),
      cpu: map['cpu'] == null ? null : (DomainCpu.fromMap((map['cpu']! as Map).cast<String, dynamic>())).input(),
      cpuTune: map['cpuTune'] == null ? null : (DomainCpuTune.fromMap((map['cpuTune']! as Map).cast<String, dynamic>())).input(),
      create: map['create'] == null ? null : (DomainCreate.fromMap((map['create']! as Map).cast<String, dynamic>())).input(),
      currentMemory: map['currentMemory'] == null ? null : (map['currentMemory']! as double).input(),
      currentMemoryUnit: map['currentMemoryUnit'] == null ? null : (map['currentMemoryUnit']! as String).input(),
      defaultIoThread: map['defaultIoThread'] == null ? null : (DomainDefaultIoThread.fromMap((map['defaultIoThread']! as Map).cast<String, dynamic>())).input(),
      description: map['description'] == null ? null : (map['description']! as String).input(),
      destroy: map['destroy'] == null ? null : (DomainDestroy.fromMap((map['destroy']! as Map).cast<String, dynamic>())).input(),
      devices: map['devices'] == null ? null : (DomainDevices.fromMap((map['devices']! as Map).cast<String, dynamic>())).input(),
      domainId: map['domainId'] == null ? null : (map['domainId']! as double).input(),
      features: map['features'] == null ? null : (DomainFeatures.fromMap((map['features']! as Map).cast<String, dynamic>())).input(),
      genId: map['genId'] == null ? null : (map['genId']! as String).input(),
      hwuuid: map['hwuuid'] == null ? null : (map['hwuuid']! as String).input(),
      idMap: map['idMap'] == null ? null : (DomainIdMap.fromMap((map['idMap']! as Map).cast<String, dynamic>())).input(),
      ioThreadIDs: map['ioThreadIDs'] == null ? null : (DomainIoThreadIDs.fromMap((map['ioThreadIDs']! as Map).cast<String, dynamic>())).input(),
      ioThreads: map['ioThreads'] == null ? null : (map['ioThreads']! as double).input(),
      keyWrap: map['keyWrap'] == null ? null : (DomainKeyWrap.fromMap((map['keyWrap']! as Map).cast<String, dynamic>())).input(),
      launchSecurity: map['launchSecurity'] == null ? null : (DomainLaunchSecurity.fromMap((map['launchSecurity']! as Map).cast<String, dynamic>())).input(),
      maximumMemory: map['maximumMemory'] == null ? null : (map['maximumMemory']! as double).input(),
      maximumMemorySlots: map['maximumMemorySlots'] == null ? null : (map['maximumMemorySlots']! as double).input(),
      maximumMemoryUnit: map['maximumMemoryUnit'] == null ? null : (map['maximumMemoryUnit']! as String).input(),
      memory: map['memory'] == null ? null : (map['memory']! as double).input(),
      memoryBacking: map['memoryBacking'] == null ? null : (DomainMemoryBacking.fromMap((map['memoryBacking']! as Map).cast<String, dynamic>())).input(),
      memoryDumpCore: map['memoryDumpCore'] == null ? null : (map['memoryDumpCore']! as String).input(),
      memoryTune: map['memoryTune'] == null ? null : (DomainMemoryTune.fromMap((map['memoryTune']! as Map).cast<String, dynamic>())).input(),
      memoryUnit: map['memoryUnit'] == null ? null : (map['memoryUnit']! as String).input(),
      metadata: map['metadata'] == null ? null : (DomainMetadata.fromMap((map['metadata']! as Map).cast<String, dynamic>())).input(),
      name: map['name'] == null ? null : (map['name']! as String).input(),
      numaTune: map['numaTune'] == null ? null : (DomainNumaTune.fromMap((map['numaTune']! as Map).cast<String, dynamic>())).input(),
      onCrash: map['onCrash'] == null ? null : (map['onCrash']! as String).input(),
      onPoweroff: map['onPoweroff'] == null ? null : (map['onPoweroff']! as String).input(),
      onReboot: map['onReboot'] == null ? null : (map['onReboot']! as String).input(),
      os: map['os'] == null ? null : (DomainOs.fromMap((map['os']! as Map).cast<String, dynamic>())).input(),
      perf: map['perf'] == null ? null : (DomainPerf.fromMap((map['perf']! as Map).cast<String, dynamic>())).input(),
      pm: map['pm'] == null ? null : (DomainPm.fromMap((map['pm']! as Map).cast<String, dynamic>())).input(),
      resource: map['resource'] == null ? null : (DomainResource.fromMap((map['resource']! as Map).cast<String, dynamic>())).input(),
      running: map['running'] == null ? null : (map['running']! as bool).input(),
      secLabels: map['secLabels'] == null ? null : (pulumi.Input.decodeList<DomainSecLabel>(map['secLabels']!, (value) => DomainSecLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
      sysInfos: map['sysInfos'] == null ? null : (pulumi.Input.decodeList<DomainSysInfo>(map['sysInfos']!, (value) => DomainSysInfo.fromMap((value as Map).cast<String, dynamic>()))).input(),
      throttleGroups: map['throttleGroups'] == null ? null : (DomainThrottleGroups.fromMap((map['throttleGroups']! as Map).cast<String, dynamic>())).input(),
      title: map['title'] == null ? null : (map['title']! as String).input(),
      type: map['type'] == null ? null : (map['type']! as String).input(),
      uuid: map['uuid'] == null ? null : (map['uuid']! as String).input(),
      vcpu: map['vcpu'] == null ? null : (map['vcpu']! as double).input(),
      vcpuCpuset: map['vcpuCpuset'] == null ? null : (map['vcpuCpuset']! as String).input(),
      vcpuCurrent: map['vcpuCurrent'] == null ? null : (map['vcpuCurrent']! as double).input(),
      vcpuPlacement: map['vcpuPlacement'] == null ? null : (map['vcpuPlacement']! as String).input(),
      vcpus: map['vcpus'] == null ? null : (DomainVcpus.fromMap((map['vcpus']! as Map).cast<String, dynamic>())).input(),
    );
  }
}
