...
class DomainClockTimer {
  ...
  factory DomainClockTimer.fromMap(Map<String, dynamic> map) {
    return DomainClockTimer(
      catchUp: (() { final guardedValue = map['catchUp']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainClockTimerCatchUp.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      tickPolicy: (() { final guardedValue = map['tickPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      track: (() { final guardedValue = map['track']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
