...
class DomainDevicesAudioJackInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioJackInputSettings].
  ...
  const DomainDevicesAudioJackInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioJackInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioJackInputSettings(
