...
class NetworkDns {
    ...
    return <String, dynamic>{
      ...
      'hosts':
          ...
          >(
            hosts,
            (value) =>
                pulumi.Input.encodeList<NetworkDnsHost, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'srVs':
          ...
          >(
            srVs,
            (value) =>
                pulumi.Input.encodeList<NetworkDnsSrV, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'txTs':
          ...
          >(
            txTs,
            (value) =>
                pulumi.Input.encodeList<NetworkDnsTxT, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory NetworkDns.fromMap(Map<String, dynamic> map) {
    return NetworkDns(
      ...
      forwardPlainNames: (() {
        final guardedValue = map['forwardPlainNames'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      forwarders: (() {
        final guardedValue = map['forwarders'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkDnsForwarder>(
            guardedValue,
            (value) => NetworkDnsForwarder.fromMap(
      ...
      hosts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkDnsHost>(
            guardedValue,
            (value) =>
                NetworkDnsHost.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      srVs: (() {
        final guardedValue = map['srVs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkDnsSrV>(
            guardedValue,
            (value) =>
                NetworkDnsSrV.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      txTs: (() {
        final guardedValue = map['txTs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkDnsTxT>(
            guardedValue,
            (value) =>
                NetworkDnsTxT.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
