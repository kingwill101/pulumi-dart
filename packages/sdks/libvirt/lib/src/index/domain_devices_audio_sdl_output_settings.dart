...
class DomainDevicesAudioSdlOutputSettings {
  ...
  /// Creates a new [DomainDevicesAudioSdlOutputSettings].
  ...
  const DomainDevicesAudioSdlOutputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioSdlOutputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioSdlOutputSettings(
