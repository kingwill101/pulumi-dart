...
class DomainDevicesParallelSourceDev {
  ...
  factory DomainDevicesParallelSourceDev.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceDev(
      ...
      secLabels: map['secLabels'] == null ? null : (pulumi.Input.decodeList<DomainDevicesParallelSourceDevSecLabel>(map['secLabels'], (value) => DomainDevicesParallelSourceDevSecLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
