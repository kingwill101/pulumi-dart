...
class DomainDevicesParallelSourceDev {
  ...
  DomainDevicesParallelSourceDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesParallelSourceDevSecLabel>,
    ...
    return DomainDevicesParallelSourceDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesParallelSourceDevSecLabel>(
            guardedValue,
            (value) => DomainDevicesParallelSourceDevSecLabel.fromMap(
