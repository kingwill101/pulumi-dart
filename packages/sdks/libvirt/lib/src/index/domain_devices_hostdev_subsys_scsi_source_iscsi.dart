...
class DomainDevicesHostdevSubsysScsiSourceIscsi {
  ...
  factory DomainDevicesHostdevSubsysScsiSourceIscsi.fromMap(Map<String, dynamic> map) {
    return DomainDevicesHostdevSubsysScsiSourceIscsi(
      auth: (() { final guardedValue = map['auth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysScsiSourceIscsiAuth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hosts: (() { final guardedValue = map['hosts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesHostdevSubsysScsiSourceIscsiHost>(guardedValue, (value) => DomainDevicesHostdevSubsysScsiSourceIscsiHost.fromMap((value as Map).cast<String, dynamic>()))); })(),
      initiator: (() { final guardedValue = map['initiator']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysScsiSourceIscsiInitiator.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
