    ...
    return <String, dynamic>{
      ...
      'virtIoSerial':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(virtIoSerial, (value) => value.toMap()),
      'xenBus':
          ?pulumi.Input.mapOptionalInputValue<
            DomainDevicesControllerXenBus,
            Map<String, dynamic>
          >(xenBus, (value) => value.toMap()),
    };
  }
    ...
    return DomainDevicesController(
      acpi: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesControllerAcpi.fromMap(
      ...
      alias: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesControllerAlias.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      driver: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesControllerDriver.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      nvme: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesControllerNvme.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pci: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesControllerPci.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      usb: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesControllerUsb.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      virtIoSerial: (() {
        final guardedValue = map['virtIoSerial'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesControllerVirtIoSerial.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      xenBus: (() {
        final guardedValue = map['xenBus'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesControllerXenBus.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
