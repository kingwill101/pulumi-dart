...
class DomainDevicesDiskMirrorSourceVhostUserDev {
  ...
  final pulumi.Input<List<DomainDevicesDiskMirrorSourceVhostUserDevSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceVhostUserDevSecLabel>,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserDev.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceVhostUserDevSecLabel.fromMap(
