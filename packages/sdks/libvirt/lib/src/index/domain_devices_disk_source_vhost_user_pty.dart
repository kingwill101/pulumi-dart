...
class DomainDevicesDiskSourceVhostUserPty {
  ...
  final pulumi.Input<List<DomainDevicesDiskSourceVhostUserPtySecLabel>>?
  secLabels;
  ...
  DomainDevicesDiskSourceVhostUserPty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskSourceVhostUserPtySecLabel>,
  ...
  factory DomainDevicesDiskSourceVhostUserPty.fromMap(
    ...
    return DomainDevicesDiskSourceVhostUserPty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskSourceVhostUserPtySecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskSourceVhostUserPtySecLabel.fromMap(
