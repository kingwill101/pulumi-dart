...
class DomainDevicesSerialSourcePty {
  ...
  DomainDevicesSerialSourcePty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSerialSourcePtySecLabel>,
    ...
    return DomainDevicesSerialSourcePty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesSerialSourcePtySecLabel>(
            guardedValue,
            (value) => DomainDevicesSerialSourcePtySecLabel.fromMap(
