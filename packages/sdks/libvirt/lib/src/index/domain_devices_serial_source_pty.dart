...
class DomainDevicesSerialSourcePty {
  ...
  const DomainDevicesSerialSourcePty({
    required this.path,
    this.secLabels,
  });
  ...
  factory DomainDevicesSerialSourcePty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourcePty(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesSerialSourcePtySecLabel>(guardedValue, (value) => DomainDevicesSerialSourcePtySecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
