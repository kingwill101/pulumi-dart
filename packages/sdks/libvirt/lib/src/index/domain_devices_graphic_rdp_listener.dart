...
class DomainDevicesGraphicRdpListener {
  ...
  DomainDevicesGraphicRdpListener({this.address, this.network, this.socket});
    ...
    return DomainDevicesGraphicRdpListener(
      address: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesGraphicRdpListenerAddress.fromMap(
      ...
      network: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicRdpListenerNetwork.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      socket: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicRdpListenerSocket.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
