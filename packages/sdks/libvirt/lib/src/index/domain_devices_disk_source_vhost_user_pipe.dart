...
class DomainDevicesDiskSourceVhostUserPipe {
  ...
  final pulumi.Input<List<DomainDevicesDiskSourceVhostUserPipeSecLabel>>?
  secLabels;
  ...
  DomainDevicesDiskSourceVhostUserPipe({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskSourceVhostUserPipeSecLabel>,
  ...
  factory DomainDevicesDiskSourceVhostUserPipe.fromMap(
    ...
    return DomainDevicesDiskSourceVhostUserPipe(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskSourceVhostUserPipeSecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskSourceVhostUserPipeSecLabel.fromMap(
