...
class DomainDevicesDiskBackingStoreSourceNetworkInitiator {
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceNetworkInitiatorIqn>?
  iqn;
  ...
  DomainDevicesDiskBackingStoreSourceNetworkInitiator({this.iqn});
  ...
  factory DomainDevicesDiskBackingStoreSourceNetworkInitiator.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceNetworkInitiator(
      iqn: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkInitiatorIqn.fromMap(
