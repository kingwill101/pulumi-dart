...
import 'domain_os_nv_ram_source_reservations_source_tcp_reconnect.dart';

class DomainOsNvRamSourceReservationsSourceTcp {
  ...
  final pulumi.Input<DomainOsNvRamSourceReservationsSourceTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainOsNvRamSourceReservationsSourceTcp].
  ...
  const DomainOsNvRamSourceReservationsSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainOsNvRamSourceReservationsSourceTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }

  factory DomainOsNvRamSourceReservationsSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourceTcp(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceReservationsSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
