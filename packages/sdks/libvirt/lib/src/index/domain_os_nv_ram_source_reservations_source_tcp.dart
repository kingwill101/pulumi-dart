...
class DomainOsNvRamSourceReservationsSourceTcp {
  ...
  final pulumi.Input<DomainOsNvRamSourceReservationsSourceTcpReconnect>?
  reconnect;
  ...
  factory DomainOsNvRamSourceReservationsSourceTcp.fromMap(
    ...
    return DomainOsNvRamSourceReservationsSourceTcp(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainOsNvRamSourceReservationsSourceTcpReconnect.fromMap(
