...
class DomainDevicesChannelSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesChannelSourcePtySecLabel].
  ...
  const DomainDevicesChannelSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesChannelSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesChannelSourcePtySecLabel(
