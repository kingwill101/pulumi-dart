...
class DomainDevicesDiskMirrorBackingStoreSourceSlices {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorBackingStoreSourceSlicesSlice>
  >?
  slices;
  ...
  DomainDevicesDiskMirrorBackingStoreSourceSlices({this.slices});
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceSlices.fromMap(
      ...
      slices: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceSlicesSlice.fromMap(
