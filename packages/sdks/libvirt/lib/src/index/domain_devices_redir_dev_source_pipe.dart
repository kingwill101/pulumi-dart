...
class DomainDevicesRedirDevSourcePipe {
  ...
  DomainDevicesRedirDevSourcePipe({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesRedirDevSourcePipeSecLabel>,
    ...
    return DomainDevicesRedirDevSourcePipe(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesRedirDevSourcePipeSecLabel>(
            guardedValue,
            (value) => DomainDevicesRedirDevSourcePipeSecLabel.fromMap(
