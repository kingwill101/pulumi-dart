...
class DomainDevicesRngBackendEgdSourcePty {
  ...
  final pulumi.Input<List<DomainDevicesRngBackendEgdSourcePtySecLabel>>?
  secLabels;
  ...
  DomainDevicesRngBackendEgdSourcePty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesRngBackendEgdSourcePtySecLabel>,
  ...
  factory DomainDevicesRngBackendEgdSourcePty.fromMap(
    ...
    return DomainDevicesRngBackendEgdSourcePty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesRngBackendEgdSourcePtySecLabel>(
            guardedValue,
            (value) => DomainDevicesRngBackendEgdSourcePtySecLabel.fromMap(
