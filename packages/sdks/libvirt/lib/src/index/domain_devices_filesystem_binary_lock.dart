...
class DomainDevicesFilesystemBinaryLock {
  ...
  DomainDevicesFilesystemBinaryLock({this.flock, this.posix});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'flock': ?flock, 'posix': ?posix};
  }

  factory DomainDevicesFilesystemBinaryLock.fromMap(Map<String, dynamic> map) {
    return DomainDevicesFilesystemBinaryLock(
      flock: (() {
        final guardedValue = map['flock'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      posix: (() {
        final guardedValue = map['posix'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
