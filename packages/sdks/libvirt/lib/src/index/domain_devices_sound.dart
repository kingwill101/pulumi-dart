...
class DomainDevicesSound {
  ...
  factory DomainDevicesSound.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSound(
      acpi: (() { final guardedValue = map['acpi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesSoundAcpi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      alias: (() { final guardedValue = map['alias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesSoundAlias.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      audio: (() { final guardedValue = map['audio']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesSoundAudio.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      codecs: (() { final guardedValue = map['codecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesSoundCodec>(guardedValue, (value) => DomainDevicesSoundCodec.fromMap((value as Map).cast<String, dynamic>()))); })(),
