    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesConsoleSourceFileSecLabel>,
    ...
    return DomainDevicesConsoleSourceFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesConsoleSourceFileSecLabel>(
            guardedValue,
            (value) => DomainDevicesConsoleSourceFileSecLabel.fromMap(
