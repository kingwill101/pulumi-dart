...
class DomainDevicesAudioCoreAudioInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioCoreAudioInputSettings].
  ...
  const DomainDevicesAudioCoreAudioInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioCoreAudioInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioCoreAudioInputSettings(
