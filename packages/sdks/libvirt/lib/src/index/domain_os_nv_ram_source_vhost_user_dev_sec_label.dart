...
class DomainOsNvRamSourceVhostUserDevSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceVhostUserDevSecLabel].
  ...
  const DomainOsNvRamSourceVhostUserDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceVhostUserDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserDevSecLabel(
