...
class DomainDevicesDiskMirrorBackingStoreSourceVhostUserDev {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorBackingStoreSourceVhostUserDevSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVhostUserDev.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceVhostUserDevSecLabel.fromMap(
