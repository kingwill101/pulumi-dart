...
class DomainDevicesLease {
  ...
  factory DomainDevicesLease.fromMap(Map<String, dynamic> map) {
    return DomainDevicesLease(
      ...
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesLeaseTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
