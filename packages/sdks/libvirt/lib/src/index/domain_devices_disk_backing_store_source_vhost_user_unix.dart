...
class DomainDevicesDiskBackingStoreSourceVhostUserUnix {
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceVhostUserUnixReconnect>?
  reconnect;

  /// Configures the security label for the UNIX domain socket.
  final pulumi.Input<
    List<DomainDevicesDiskBackingStoreSourceVhostUserUnixSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserUnix.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceVhostUserUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceVhostUserUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceVhostUserUnixSecLabel.fromMap(
