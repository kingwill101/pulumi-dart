...
class DomainDevicesInterfaceSourceVhostUserChardevFile {
  ...
  final pulumi.Input<
    List<DomainDevicesInterfaceSourceVhostUserChardevFileSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesInterfaceSourceVhostUserChardevFileSecLabel.fromMap(
