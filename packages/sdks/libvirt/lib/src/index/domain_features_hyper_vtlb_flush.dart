...
class DomainFeaturesHyperVTlbFlush {
  ...
  DomainFeaturesHyperVTlbFlush({this.direct, this.extended});
    ...
    return DomainFeaturesHyperVTlbFlush(
      direct: (() {
        ...
        return pulumi.Input.fromValue(
          DomainFeaturesHyperVTlbFlushDirect.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      extended: (() {
        final guardedValue = map['extended'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainFeaturesHyperVTlbFlushExtended.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
