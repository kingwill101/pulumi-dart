...
class DomainDevicesSerialSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesSerialSourcePipeSecLabel].
  ...
  const DomainDevicesSerialSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesSerialSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourcePipeSecLabel(
