...
class DomainDevicesConsoleSourceTcp {
  ...
  final DomainDevicesConsoleSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesConsoleSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesConsoleSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
