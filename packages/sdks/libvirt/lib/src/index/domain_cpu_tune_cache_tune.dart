...
class DomainCpuTuneCacheTune {
  ...
  DomainCpuTuneCacheTune({this.caches, this.id, this.monitors, this.vcpus});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'caches':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainCpuTuneCacheTuneCach>,
      ...
      'monitors':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainCpuTuneCacheTuneMonitor>,
            List<Map<String, dynamic>>
          >(
            monitors,
            (value) =>
  ...
  factory DomainCpuTuneCacheTune.fromMap(Map<String, dynamic> map) {
    return DomainCpuTuneCacheTune(
      caches: (() {
        final guardedValue = map['caches'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainCpuTuneCacheTuneCach>(
            guardedValue,
            (value) => DomainCpuTuneCacheTuneCach.fromMap(
      ...
      monitors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainCpuTuneCacheTuneMonitor>(
            guardedValue,
            (value) => DomainCpuTuneCacheTuneMonitor.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
