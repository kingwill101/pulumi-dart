...
class DomainDevicesInterfaceSourceHostdevPciAddressZpci {
  ...
  DomainDevicesInterfaceSourceHostdevPciAddressZpci({this.fid, this.uid});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'fid': ?fid, 'uid': ?uid};
  }

  factory DomainDevicesInterfaceSourceHostdevPciAddressZpci.fromMap(
    Map<String, dynamic> map,
  ) {
    return DomainDevicesInterfaceSourceHostdevPciAddressZpci(
      fid: (() {
        final guardedValue = map['fid'];
