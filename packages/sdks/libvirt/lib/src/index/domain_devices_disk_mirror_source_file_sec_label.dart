...
class DomainDevicesDiskMirrorSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceFileSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceFileSecLabel(
