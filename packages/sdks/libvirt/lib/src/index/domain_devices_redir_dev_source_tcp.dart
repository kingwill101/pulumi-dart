...
import 'domain_devices_redir_dev_source_tcp_reconnect.dart';

class DomainDevicesRedirDevSourceTcp {
  ...
  final pulumi.Input<DomainDevicesRedirDevSourceTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainDevicesRedirDevSourceTcp].
  ...
  const DomainDevicesRedirDevSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesRedirDevSourceTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }
  ...
  factory DomainDevicesRedirDevSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourceTcp(
      ...
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesRedirDevSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
