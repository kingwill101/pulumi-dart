...
class DomainDevicesRedirDevSourceTcp {
  ...
  final DomainDevicesRedirDevSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesRedirDevSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesRedirDevSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
