...
class DomainDevicesDiskBackingStoreSourceNetworkIdentity {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceNetworkIdentity].
  ...
  factory DomainDevicesDiskBackingStoreSourceNetworkIdentity.fromMap(
