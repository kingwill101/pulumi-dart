...
class DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel(
