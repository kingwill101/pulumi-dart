...
import 'domain_devices_disk_source_reservations_source_tcp_reconnect.dart';

class DomainDevicesDiskSourceReservationsSourceTcp {
  ...
  final pulumi.Input<DomainDevicesDiskSourceReservationsSourceTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainDevicesDiskSourceReservationsSourceTcp].
  ...
  const DomainDevicesDiskSourceReservationsSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesDiskSourceReservationsSourceTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }

  factory DomainDevicesDiskSourceReservationsSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourceTcp(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskSourceReservationsSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
