...
class DomainDevicesDiskSourceReservationsSourceTcp {
  ...
  final pulumi.Input<DomainDevicesDiskSourceReservationsSourceTcpReconnect>?
  reconnect;
  ...
  factory DomainDevicesDiskSourceReservationsSourceTcp.fromMap(
    ...
    return DomainDevicesDiskSourceReservationsSourceTcp(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskSourceReservationsSourceTcpReconnect.fromMap(
