...
class DomainDevicesDiskDriverIoThreads {
  ...
  factory DomainDevicesDiskDriverIoThreads.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskDriverIoThreads(
      ioThreads: (() { final guardedValue = map['ioThreads']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskDriverIoThreadsIoThread>(guardedValue, (value) => DomainDevicesDiskDriverIoThreadsIoThread.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
