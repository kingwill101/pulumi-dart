...
class DomainDevicesDiskMirrorBackingStoreSourceVhostUserPtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceVhostUserPtySecLabel].
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceVhostUserPtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVhostUserPtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceVhostUserPtySecLabel(
