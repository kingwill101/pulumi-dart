...
class DomainDevicesDiskBackingStoreSourceVhostUserPipeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserPipeSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserPipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserPipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserPipeSecLabel(
