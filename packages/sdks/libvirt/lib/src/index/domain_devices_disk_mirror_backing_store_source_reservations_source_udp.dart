...
class DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUdp {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUdp].
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUdp({
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUdp(
