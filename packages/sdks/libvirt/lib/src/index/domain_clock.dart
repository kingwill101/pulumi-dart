...
class DomainClock {
    ...
    return <String, dynamic>{
      ...
      'timers':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainClockTimer>,
            List<Map<String, dynamic>>
          >(
            timers,
            (value) =>
                pulumi.Input.encodeList<DomainClockTimer, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory DomainClock.fromMap(Map<String, dynamic> map) {
    return DomainClock(
      adjustment: (() {
        final guardedValue = map['adjustment'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      basis: (() {
        final guardedValue = map['basis'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      offset: (() {
      ...
      timers: (() {
        final guardedValue = map['timers'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainClockTimer>(
            guardedValue,
            (value) => DomainClockTimer.fromMap(
