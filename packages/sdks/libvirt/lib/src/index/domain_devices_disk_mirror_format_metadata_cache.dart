...
class DomainDevicesDiskMirrorFormatMetadataCache {
  ...
  final pulumi.Input<DomainDevicesDiskMirrorFormatMetadataCacheMaxSize>?
  maxSize;
  ...
  DomainDevicesDiskMirrorFormatMetadataCache({this.maxSize});
  ...
  factory DomainDevicesDiskMirrorFormatMetadataCache.fromMap(
    ...
    return DomainDevicesDiskMirrorFormatMetadataCache(
      maxSize: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorFormatMetadataCacheMaxSize.fromMap(
