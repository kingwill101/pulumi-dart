...
class DomainDevicesDiskMirrorSourceReservationsSourceUnix {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorSourceReservationsSourceUnixSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceUnix.fromMap(
    ...
    return DomainDevicesDiskMirrorSourceReservationsSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorSourceReservationsSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceReservationsSourceUnixSecLabel.fromMap(
