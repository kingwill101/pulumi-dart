...
class PoolSourceAuth {
  ...
  factory PoolSourceAuth.fromMap(Map<String, dynamic> map) {
    return PoolSourceAuth(
      secret: (() { final guardedValue = map['secret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PoolSourceAuthSecret.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
