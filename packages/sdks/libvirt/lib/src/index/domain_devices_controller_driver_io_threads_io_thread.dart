...
class DomainDevicesControllerDriverIoThreadsIoThread {
  ...
  final pulumi.Input<List<DomainDevicesControllerDriverIoThreadsIoThreadQueue>>?
  queues;
  ...
  DomainDevicesControllerDriverIoThreadsIoThread({this.id, this.queues});
    ...
    return <String, dynamic>{
      ...
      'queues':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesControllerDriverIoThreadsIoThreadQueue>,
  ...
  factory DomainDevicesControllerDriverIoThreadsIoThread.fromMap(
      ...
      queues: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesControllerDriverIoThreadsIoThreadQueue.fromMap(
