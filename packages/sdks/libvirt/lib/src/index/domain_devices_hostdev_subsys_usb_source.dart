...
class DomainDevicesHostdevSubsysUsbSource {
  ...
  factory DomainDevicesHostdevSubsysUsbSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesHostdevSubsysUsbSource(
      address: (() { final guardedValue = map['address']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysUsbSourceAddress.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      product: (() { final guardedValue = map['product']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysUsbSourceProduct.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      vendor: (() { final guardedValue = map['vendor']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysUsbSourceVendor.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
