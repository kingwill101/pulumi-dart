...
class DomainDevicesChannelSourcePipe {
  ...
  DomainDevicesChannelSourcePipe({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesChannelSourcePipeSecLabel>,
    ...
    return DomainDevicesChannelSourcePipe(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesChannelSourcePipeSecLabel>(
            guardedValue,
            (value) => DomainDevicesChannelSourcePipeSecLabel.fromMap(
