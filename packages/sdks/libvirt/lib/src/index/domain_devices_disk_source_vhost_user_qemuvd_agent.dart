...
class DomainDevicesDiskSourceVhostUserQemuvdAgent {
  ...
  final pulumi.Input<DomainDevicesDiskSourceVhostUserQemuvdAgentClipBoard>?
  clipBoard;
  ...
  DomainDevicesDiskSourceVhostUserQemuvdAgent({this.clipBoard, this.mouse});
  ...
  factory DomainDevicesDiskSourceVhostUserQemuvdAgent.fromMap(
    ...
    return DomainDevicesDiskSourceVhostUserQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskSourceVhostUserQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskSourceVhostUserQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
