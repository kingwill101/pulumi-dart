...
class DomainDevicesInterfaceSourceHostdevUsb {
  ...
  factory DomainDevicesInterfaceSourceHostdevUsb.fromMap(
    ...
    return DomainDevicesInterfaceSourceHostdevUsb(
      address: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceSourceHostdevUsbAddress.fromMap(
      ...
      product: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceSourceHostdevUsbProduct.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      vendor: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceSourceHostdevUsbVendor.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
