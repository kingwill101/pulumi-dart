...
class DomainDevicesConsoleSourceUnix {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesConsoleSourceUnixSecLabel>,
    ...
    return DomainDevicesConsoleSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesConsoleSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesConsoleSourceUnixSecLabel>(
            guardedValue,
            (value) => DomainDevicesConsoleSourceUnixSecLabel.fromMap(
