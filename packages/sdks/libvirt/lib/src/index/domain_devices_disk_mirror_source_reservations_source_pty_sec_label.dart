...
class DomainDevicesDiskMirrorSourceReservationsSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceReservationsSourcePtySecLabel].
  ...
  const DomainDevicesDiskMirrorSourceReservationsSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceReservationsSourcePtySecLabel(
