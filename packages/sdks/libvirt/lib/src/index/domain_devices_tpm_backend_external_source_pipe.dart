...
class DomainDevicesTpmBackendExternalSourcePipe {
  ...
  final pulumi.Input<List<DomainDevicesTpmBackendExternalSourcePipeSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesTpmBackendExternalSourcePipeSecLabel>,
  ...
  factory DomainDevicesTpmBackendExternalSourcePipe.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesTpmBackendExternalSourcePipeSecLabel.fromMap(
