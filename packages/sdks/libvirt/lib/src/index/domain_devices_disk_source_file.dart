...
class DomainDevicesDiskSourceFile {
  ...
  factory DomainDevicesDiskSourceFile.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceFile(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskSourceFileSecLabel>(guardedValue, (value) => DomainDevicesDiskSourceFileSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
