...
class GetNodeDeviceInfoCapability {
  ...
  factory GetNodeDeviceInfoCapability.fromMap(Map<String, dynamic> map) {
    return GetNodeDeviceInfoCapability(
      ...
      bus: pulumi.Input.fromValue((map['bus'] as num).toDouble()),
      class_: pulumi.Input.fromValue(map['class'] as String),
      deviceNumber: pulumi.Input.fromValue((map['deviceNumber'] as num).toDouble()),
      domain: pulumi.Input.fromValue((map['domain'] as num).toDouble()),
      driveType: pulumi.Input.fromValue(map['driveType'] as String),
      function: pulumi.Input.fromValue((map['function'] as num).toDouble()),
      host: pulumi.Input.fromValue((map['host'] as num).toDouble()),
      interface: pulumi.Input.fromValue(map['interface'] as String),
      iommuGroup: pulumi.Input.fromValue((map['iommuGroup'] as num).toDouble()),
      linkSpeed: pulumi.Input.fromValue(map['linkSpeed'] as String),
      linkState: pulumi.Input.fromValue(map['linkState'] as String),
      logicalBlockSize: pulumi.Input.fromValue((map['logicalBlockSize'] as num).toDouble()),
      lun: pulumi.Input.fromValue((map['lun'] as num).toDouble()),
      model: pulumi.Input.fromValue(map['model'] as String),
      numBlocks: pulumi.Input.fromValue((map['numBlocks'] as num).toDouble()),
      ...
      slot: pulumi.Input.fromValue((map['slot'] as num).toDouble()),
