...
class DomainDevicesDiskSourceBlockSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceBlockSecLabel].
  ...
  const DomainDevicesDiskSourceBlockSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceBlockSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceBlockSecLabel(
