...
class DomainDevicesConsoleSourcePty {
  ...
  final List<DomainDevicesConsoleSourcePtySecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesConsoleSourcePtySecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesConsoleSourcePty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourcePty(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesConsoleSourcePtySecLabel>(map['secLabels'], (value) => DomainDevicesConsoleSourcePtySecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
