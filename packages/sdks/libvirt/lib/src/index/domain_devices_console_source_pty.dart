...
class DomainDevicesConsoleSourcePty {
  ...
  DomainDevicesConsoleSourcePty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesConsoleSourcePtySecLabel>,
    ...
    return DomainDevicesConsoleSourcePty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesConsoleSourcePtySecLabel>(
            guardedValue,
            (value) => DomainDevicesConsoleSourcePtySecLabel.fromMap(
