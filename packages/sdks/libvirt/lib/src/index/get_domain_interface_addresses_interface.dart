...
class GetDomainInterfaceAddressesInterface {
  ...
  final List<GetDomainInterfaceAddressesInterfaceAddr> addrs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addrs': pulumi.Input.encodeList<GetDomainInterfaceAddressesInterfaceAddr, Map<String, dynamic>>(addrs, (value) => value.toMap()),
      'hwaddr': hwaddr,
      'name': name,
    };
  }
  ...
  factory GetDomainInterfaceAddressesInterface.fromMap(Map<String, dynamic> map) {
    return GetDomainInterfaceAddressesInterface(
      addrs: pulumi.Input.decodeList<GetDomainInterfaceAddressesInterfaceAddr>(map['addrs'], (value) => GetDomainInterfaceAddressesInterfaceAddr.fromMap((value as Map).cast<String, dynamic>())),
      hwaddr: map['hwaddr'] as String,
