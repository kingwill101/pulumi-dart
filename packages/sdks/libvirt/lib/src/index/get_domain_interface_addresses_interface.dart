...
class GetDomainInterfaceAddressesInterface {
    ...
    return <String, dynamic>{
      'addrs':
          pulumi.Input.mapInputValue<
            List<GetDomainInterfaceAddressesInterfaceAddr>,
  ...
  factory GetDomainInterfaceAddressesInterface.fromMap(
    Map<String, dynamic> map,
  ) {
    return GetDomainInterfaceAddressesInterface(
      addrs: pulumi.Input.fromValue(
        pulumi.Input.decodeList<GetDomainInterfaceAddressesInterfaceAddr>(
          map['addrs']!,
          (value) => GetDomainInterfaceAddressesInterfaceAddr.fromMap(
            (value as Map).cast<String, dynamic>(),
          ),
        ),
      ),
      hwaddr: pulumi.Input.fromValue(map['hwaddr'] as String),
