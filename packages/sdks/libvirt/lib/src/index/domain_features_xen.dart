...
class DomainFeaturesXen {
  ...
  DomainFeaturesXen({this.e820host, this.passthrough});
  ...
  factory DomainFeaturesXen.fromMap(Map<String, dynamic> map) {
    return DomainFeaturesXen(
      e820host: (() {
        final guardedValue = map['e820host'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainFeaturesXenE820host.fromMap(
      ...
      passthrough: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainFeaturesXenPassthrough.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
