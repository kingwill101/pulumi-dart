...
class DomainDevicesInterfaceSourceVhostUserChardevFileSecLabel {
  ...
  /// Creates a new [DomainDevicesInterfaceSourceVhostUserChardevFileSecLabel].
  ...
  const DomainDevicesInterfaceSourceVhostUserChardevFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevFileSecLabel(
