...
class DomainDevicesDiskBackingStoreSourceVhostUserPty {
  ...
  final pulumi.Input<List<DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel>>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?pulumi.Input.mapOptionalInputValue<List<DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel>, List<Map<String, dynamic>>>(secLabels, (value) => pulumi.Input.encodeList<DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserPty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserPty(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel>(guardedValue, (value) => DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
