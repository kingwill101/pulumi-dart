...
class DomainDevicesDiskMirrorBackingStore {
  ...
  DomainDevicesDiskMirrorBackingStore({this.format, this.index, this.source});
  ...
  factory DomainDevicesDiskMirrorBackingStore.fromMap(
    ...
    return DomainDevicesDiskMirrorBackingStore(
      format: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreFormat.fromMap(
      ...
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
