...
class DomainDevicesAudioFileInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioFileInputSettings].
  ...
  const DomainDevicesAudioFileInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioFileInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioFileInputSettings(
