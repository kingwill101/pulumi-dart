...
class DomainDevicesDiskMirrorSourceVhostUserTcp {
  ...
  final pulumi.Input<DomainDevicesDiskMirrorSourceVhostUserTcpReconnect>?
  reconnect;
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserTcp.fromMap(
    ...
    return DomainDevicesDiskMirrorSourceVhostUserTcp(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorSourceVhostUserTcpReconnect.fromMap(
