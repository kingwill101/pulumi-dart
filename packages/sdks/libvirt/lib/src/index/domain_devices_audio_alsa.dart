...
class DomainDevicesAudioAlsa {
  ...
  factory DomainDevicesAudioAlsa.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioAlsa(
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesAudioAlsaInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: (() { final guardedValue = map['output']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesAudioAlsaOutput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
