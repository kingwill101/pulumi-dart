...
class DomainDevicesParallelSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesParallelSourcePtySecLabel].
  ...
  const DomainDevicesParallelSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesParallelSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourcePtySecLabel(
