...
class DomainDevicesDiskBackingStoreSourceNetwork {
  ...
  final pulumi.Input<List<DomainDevicesDiskBackingStoreSourceNetworkHost>>?
  hosts;

  /// Sets the identity parameters for the network connection in the backing store source.
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceNetworkIdentity>?
  identity;

  /// Sets the initiator for the network connection in the backing store source configuration.
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceNetworkInitiator>?
  initiator;

  /// Configures the known hosts used for authenticated connections in network storage operations.
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceNetworkKnownHosts>?
  knownHosts;
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceNetworkReconnect>?
  reconnect;

  /// Enables snapshot capabilities for the network storage source, allowing for point-in-time volumes.
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceNetworkSnapshot>?
  snapshot;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hosts':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskBackingStoreSourceNetworkHost>,
  ...
  factory DomainDevicesDiskBackingStoreSourceNetwork.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceNetwork(
      auth: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkAuth.fromMap(
      ...
      config: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hosts: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<DomainDevicesDiskBackingStoreSourceNetworkHost>(
            guardedValue,
            (value) => DomainDevicesDiskBackingStoreSourceNetworkHost.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      initiator: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkInitiator.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      knownHosts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkKnownHosts.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      reconnect: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkReconnect.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      snapshot: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkSnapshot.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
