...
class DomainDevicesConsoleSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesConsoleSourcePipeSecLabel].
  ...
  const DomainDevicesConsoleSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesConsoleSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourcePipeSecLabel(
