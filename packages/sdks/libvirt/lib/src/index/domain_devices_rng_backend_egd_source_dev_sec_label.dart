...
class DomainDevicesRngBackendEgdSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesRngBackendEgdSourceDevSecLabel].
  ...
  const DomainDevicesRngBackendEgdSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRngBackendEgdSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackendEgdSourceDevSecLabel(
