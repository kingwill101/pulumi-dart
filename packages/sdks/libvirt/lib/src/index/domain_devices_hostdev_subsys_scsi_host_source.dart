...
class DomainDevicesHostdevSubsysScsiHostSource {
  ...
  DomainDevicesHostdevSubsysScsiHostSource({this.protocol, this.wwpn});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'protocol': ?protocol, 'wwpn': ?wwpn};
  }

  factory DomainDevicesHostdevSubsysScsiHostSource.fromMap(
