...
class DomainDevicesDiskBackingStoreFormat {
  ...
  const DomainDevicesDiskBackingStoreFormat({
    this.metadataCache,
    required this.type,
  });
  ...
  factory DomainDevicesDiskBackingStoreFormat.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreFormat(
      metadataCache: (() { final guardedValue = map['metadataCache']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskBackingStoreFormatMetadataCache.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
