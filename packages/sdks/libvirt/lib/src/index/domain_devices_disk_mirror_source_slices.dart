...
class DomainDevicesDiskMirrorSourceSlices {
  ...
  DomainDevicesDiskMirrorSourceSlices({this.slices});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'slices':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceSlicesSlice>,
  ...
  factory DomainDevicesDiskMirrorSourceSlices.fromMap(
    ...
    return DomainDevicesDiskMirrorSourceSlices(
      slices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskMirrorSourceSlicesSlice>(
            guardedValue,
            (value) => DomainDevicesDiskMirrorSourceSlicesSlice.fromMap(
