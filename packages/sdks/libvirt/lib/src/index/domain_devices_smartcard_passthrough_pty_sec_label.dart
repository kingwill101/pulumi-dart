...
class DomainDevicesSmartcardPassthroughPtySecLabel {
  ...
  /// Creates a new [DomainDevicesSmartcardPassthroughPtySecLabel].
  ...
  const DomainDevicesSmartcardPassthroughPtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesSmartcardPassthroughPtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughPtySecLabel(
