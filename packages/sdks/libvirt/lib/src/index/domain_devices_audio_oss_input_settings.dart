...
class DomainDevicesAudioOssInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioOssInputSettings].
  ...
  const DomainDevicesAudioOssInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioOssInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioOssInputSettings(
