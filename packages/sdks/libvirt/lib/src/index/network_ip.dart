...
class NetworkIp {
  ...
  factory NetworkIp.fromMap(Map<String, dynamic> map) {
    return NetworkIp(
      ...
      dhcp: (() {
        final guardedValue = map['dhcp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkIpDhcp.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      family: (() {
      ...
      localPtr: (() {
        final guardedValue = map['localPtr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      netmask: (() {
      ...
      tftp: (() {
        final guardedValue = map['tftp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkIpTftp.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
