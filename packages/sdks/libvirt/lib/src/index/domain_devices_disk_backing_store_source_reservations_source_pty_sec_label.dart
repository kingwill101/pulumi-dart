...
class DomainDevicesDiskBackingStoreSourceReservationsSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceReservationsSourcePtySecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceReservationsSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourcePtySecLabel(
