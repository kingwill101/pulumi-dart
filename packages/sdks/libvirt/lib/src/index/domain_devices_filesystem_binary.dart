    ...
    return DomainDevicesFilesystemBinary(
      cache: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemBinaryCache.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      lock: (() {
        final guardedValue = map['lock'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemBinaryLock.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      openFiles: (() {
        final guardedValue = map['openFiles'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemBinaryOpenFiles.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      sandbox: (() {
        final guardedValue = map['sandbox'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemBinarySandbox.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      threadPool: (() {
        final guardedValue = map['threadPool'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemBinaryThreadPool.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      xattr: (() {
        final guardedValue = map['xattr'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
