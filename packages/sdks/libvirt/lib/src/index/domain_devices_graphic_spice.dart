    ...
    return <String, dynamic>{
      ...
      'channels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesGraphicSpiceChannel>,
      ...
      'fileTransfer':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(fileTransfer, (value) => value.toMap()),
      'gl':
          ?pulumi.Input.mapOptionalInputValue<
      ...
      'jpeg':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(jpeg, (value) => value.toMap()),
      'keymap': ?keymap,
      'listen': ?listen,
      'listeners':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesGraphicSpiceListener>,
            List<Map<String, dynamic>>
          >(
            listeners,
            (value) =>
      ...
      'playback':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(playback, (value) => value.toMap()),
      'port': ?port,
      'streaming':
          ?pulumi.Input.mapOptionalInputValue<
            DomainDevicesGraphicSpiceStreaming,
            Map<String, dynamic>
          >(streaming, (value) => value.toMap()),
      'tlsPort': ?tlsPort,
      'zlib':
          ?pulumi.Input.mapOptionalInputValue<
            DomainDevicesGraphicSpiceZlib,
            Map<String, dynamic>
          >(zlib, (value) => value.toMap()),
    };
  }
    ...
    return DomainDevicesGraphicSpice(
      ...
      channels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesGraphicSpiceChannel>(
            guardedValue,
            (value) => DomainDevicesGraphicSpiceChannel.fromMap(
      ...
      clipBoard: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceClipBoard.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      connected: (() {
        final guardedValue = map['connected'];
        if (guardedValue == null) return null;
      ...
      fileTransfer: (() {
        final guardedValue = map['fileTransfer'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceFileTransfer.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      gl: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceGl.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      image: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceImage.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      jpeg: (() {
        final guardedValue = map['jpeg'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceJpeg.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      keymap: (() {
        final guardedValue = map['keymap'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      listen: (() {
      ...
      listeners: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesGraphicSpiceListener>(
            guardedValue,
            (value) => DomainDevicesGraphicSpiceListener.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      passwdValidTo: (() {
        final guardedValue = map['passwdValidTo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      playback: (() {
        final guardedValue = map['playback'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpicePlayback.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      streaming: (() {
        final guardedValue = map['streaming'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceStreaming.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      tlsPort: (() {
        final guardedValue = map['tlsPort'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      zlib: (() {
        final guardedValue = map['zlib'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpiceZlib.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
