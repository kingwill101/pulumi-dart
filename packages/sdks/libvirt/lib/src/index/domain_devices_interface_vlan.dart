...
class DomainDevicesInterfaceVlan {
  ...
  DomainDevicesInterfaceVlan({this.tags, this.trunk});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'tags':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesInterfaceVlanTag>,
    ...
    return DomainDevicesInterfaceVlan(
      tags: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesInterfaceVlanTag>(
            guardedValue,
            (value) => DomainDevicesInterfaceVlanTag.fromMap(
