...
class DomainDevicesSmartcardPassthroughPipeSecLabel {
  ...
  /// Creates a new [DomainDevicesSmartcardPassthroughPipeSecLabel].
  ...
  const DomainDevicesSmartcardPassthroughPipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesSmartcardPassthroughPipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughPipeSecLabel(
