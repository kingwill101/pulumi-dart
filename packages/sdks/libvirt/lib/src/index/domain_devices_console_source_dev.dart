...
class DomainDevicesConsoleSourceDev {
  ...
  DomainDevicesConsoleSourceDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesConsoleSourceDevSecLabel>,
    ...
    return DomainDevicesConsoleSourceDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesConsoleSourceDevSecLabel>(
            guardedValue,
            (value) => DomainDevicesConsoleSourceDevSecLabel.fromMap(
