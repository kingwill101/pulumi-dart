...
class DomainDevicesRngBackendEgdSourceDev {
  ...
  final pulumi.Input<List<DomainDevicesRngBackendEgdSourceDevSecLabel>>?
  secLabels;
  ...
  DomainDevicesRngBackendEgdSourceDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesRngBackendEgdSourceDevSecLabel>,
  ...
  factory DomainDevicesRngBackendEgdSourceDev.fromMap(
    ...
    return DomainDevicesRngBackendEgdSourceDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesRngBackendEgdSourceDevSecLabel>(
            guardedValue,
            (value) => DomainDevicesRngBackendEgdSourceDevSecLabel.fromMap(
