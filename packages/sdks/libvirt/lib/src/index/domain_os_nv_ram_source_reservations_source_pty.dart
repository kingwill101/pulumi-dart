...
class DomainOsNvRamSourceReservationsSourcePty {
  ...
  final pulumi.Input<List<DomainOsNvRamSourceReservationsSourcePtySecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceReservationsSourcePtySecLabel>,
  ...
  factory DomainOsNvRamSourceReservationsSourcePty.fromMap(
    ...
    return DomainOsNvRamSourceReservationsSourcePty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => DomainOsNvRamSourceReservationsSourcePtySecLabel.fromMap(
