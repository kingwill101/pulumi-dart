...
class DomainDevicesInterfaceSourceVds {
  ...
  factory DomainDevicesInterfaceSourceVds.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVds(
      connectionId: (() { final guardedValue = map['connectionId']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      portId: (() { final guardedValue = map['portId']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
