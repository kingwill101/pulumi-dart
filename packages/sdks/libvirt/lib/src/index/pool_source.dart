...
class PoolSource {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
            List<PoolSourceDevice>,
            List<Map<String, dynamic>>
          >(
            devices,
            (value) =>
                pulumi.Input.encodeList<PoolSourceDevice, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'hosts':
          ...
          >(
            hosts,
            (value) =>
                pulumi.Input.encodeList<PoolSourceHost, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory PoolSource.fromMap(Map<String, dynamic> map) {
    return PoolSource(
      ...
      auth: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolSourceAuth.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      devices: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolSourceDevice>(
            guardedValue,
            (value) => PoolSourceDevice.fromMap(
      ...
      dir: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          PoolSourceDir.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      format: (() {
      ...
      hosts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolSourceHost>(
            guardedValue,
            (value) =>
                PoolSourceHost.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      initiator: (() {
