...
class DomainOsNvRamSourceVhostUserPtySecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceVhostUserPtySecLabel].
  ...
  const DomainOsNvRamSourceVhostUserPtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceVhostUserPtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserPtySecLabel(
