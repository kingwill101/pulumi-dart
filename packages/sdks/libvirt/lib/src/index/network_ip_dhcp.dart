...
class NetworkIpDhcp {
  ...
  NetworkIpDhcp({this.bootps, this.hosts, this.ranges});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'bootps':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkIpDhcpBootp>,
  ...
  factory NetworkIpDhcp.fromMap(Map<String, dynamic> map) {
    return NetworkIpDhcp(
      bootps: (() {
        final guardedValue = map['bootps'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkIpDhcpBootp>(
            guardedValue,
            (value) => NetworkIpDhcpBootp.fromMap(
      ...
      hosts: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkIpDhcpHost>(
            guardedValue,
            (value) => NetworkIpDhcpHost.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ranges: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkIpDhcpRange>(
            guardedValue,
            (value) => NetworkIpDhcpRange.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
