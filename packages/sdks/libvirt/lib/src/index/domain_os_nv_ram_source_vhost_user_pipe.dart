...
class DomainOsNvRamSourceVhostUserPipe {
  ...
  DomainOsNvRamSourceVhostUserPipe({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceVhostUserPipeSecLabel>,
    ...
    return DomainOsNvRamSourceVhostUserPipe(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsNvRamSourceVhostUserPipeSecLabel>(
            guardedValue,
            (value) => DomainOsNvRamSourceVhostUserPipeSecLabel.fromMap(
