...
class DomainDevicesParallelSourceTcp {
  ...
  final DomainDevicesParallelSourceTcpReconnect? reconnect;
  ...
  factory DomainDevicesParallelSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceTcp(
      ...
      reconnect: map['reconnect'] == null ? null : DomainDevicesParallelSourceTcpReconnect.fromMap((map['reconnect'] as Map).cast<String, dynamic>()),
