...
class DomainDevicesHub {
  ...
  factory DomainDevicesHub.fromMap(Map<String, dynamic> map) {
    return DomainDevicesHub(
      acpi: (() { final guardedValue = map['acpi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHubAcpi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      alias: (() { final guardedValue = map['alias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHubAlias.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
