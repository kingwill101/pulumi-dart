    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesParallelSourceFileSecLabel>,
    ...
    return DomainDevicesParallelSourceFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesParallelSourceFileSecLabel>(
            guardedValue,
            (value) => DomainDevicesParallelSourceFileSecLabel.fromMap(
