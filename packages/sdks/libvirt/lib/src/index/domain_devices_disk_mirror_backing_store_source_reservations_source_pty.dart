...
class DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePty {
  ...
  final List<DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePty(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel>(map['secLabels'], (value) => DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
