...
class DomainLaunchSecurity {
  ...
  DomainLaunchSecurity({this.s390pv, this.sev, this.sevsnp, this.tdx});
    ...
    return <String, dynamic>{
      ...
      'sev':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(sev, (value) => value.toMap()),
      'sevsnp':
          ?pulumi.Input.mapOptionalInputValue<
            DomainLaunchSecuritySevsnp,
            Map<String, dynamic>
          >(sevsnp, (value) => value.toMap()),
      'tdx':
          ?pulumi.Input.mapOptionalInputValue<
            DomainLaunchSecurityTdx,
            Map<String, dynamic>
          >(tdx, (value) => value.toMap()),
    };
  }
  ...
  factory DomainLaunchSecurity.fromMap(Map<String, dynamic> map) {
    return DomainLaunchSecurity(
      s390pv: (() {
        final guardedValue = map['s390pv'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      sev: (() {
        final guardedValue = map['sev'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainLaunchSecuritySev.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sevsnp: (() {
        final guardedValue = map['sevsnp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainLaunchSecuritySevsnp.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      tdx: (() {
        final guardedValue = map['tdx'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainLaunchSecurityTdx.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
