...
class DomainDevicesDiskSourceReservationsSourceUdp {
  ...
  /// Creates a new [DomainDevicesDiskSourceReservationsSourceUdp].
  ...
  factory DomainDevicesDiskSourceReservationsSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourceUdp(
