...
class DomainDevicesInterfaceSourceVhostUser {
  ...
  DomainDevicesInterfaceSourceVhostUser({this.chardev, required this.dev});
    ...
    return <String, dynamic>{
      'chardev':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(chardev, (value) => value.toMap()),
      'dev': dev,
    };
  }

  factory DomainDevicesInterfaceSourceVhostUser.fromMap(
    Map<String, dynamic> map,
  ) {
    return DomainDevicesInterfaceSourceVhostUser(
      chardev: (() {
        final guardedValue = map['chardev'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceSourceVhostUserChardev.fromMap(
