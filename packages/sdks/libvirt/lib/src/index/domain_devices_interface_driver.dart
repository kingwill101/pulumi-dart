    ...
    return DomainDevicesInterfaceDriver(
      ...
      guest: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceDriverGuest.fromMap(
      ...
      host: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceDriverHost.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      rss: (() {
        final guardedValue = map['rss'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rssHashReport: (() {
        final guardedValue = map['rssHashReport'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      rxQueueSize: (() {
        final guardedValue = map['rxQueueSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      txMode: (() {
        final guardedValue = map['txMode'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      txQueueSize: (() {
        final guardedValue = map['txQueueSize'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
    );
