...
class DomainDevicesRedirDevSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesRedirDevSourcePtySecLabel].
  ...
  factory DomainDevicesRedirDevSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourcePtySecLabel(
