...
class DomainDevicesAudioCoreAudioOutputSettings {
  ...
  /// Creates a new [DomainDevicesAudioCoreAudioOutputSettings].
  ...
  const DomainDevicesAudioCoreAudioOutputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioCoreAudioOutputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioCoreAudioOutputSettings(
