...
class DomainDevicesDiskMirrorFormatMetadataCacheMaxSize {
  ...
  /// Creates a new [DomainDevicesDiskMirrorFormatMetadataCacheMaxSize].
  ...
  const DomainDevicesDiskMirrorFormatMetadataCacheMaxSize({
    this.unit,
    required this.value,
  });
  ...
  factory DomainDevicesDiskMirrorFormatMetadataCacheMaxSize.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorFormatMetadataCacheMaxSize(
