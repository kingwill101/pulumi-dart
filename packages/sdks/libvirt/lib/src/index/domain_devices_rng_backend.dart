...
class DomainDevicesRngBackend {
  ...
  factory DomainDevicesRngBackend.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackend(
      ...
      egd: (() { final guardedValue = map['egd']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesRngBackendEgd.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      random: (() { final guardedValue = map['random']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
