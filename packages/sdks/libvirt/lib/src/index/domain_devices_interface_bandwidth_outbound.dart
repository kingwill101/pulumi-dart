...
class DomainDevicesInterfaceBandwidthOutbound {
  ...
  const DomainDevicesInterfaceBandwidthOutbound({
    this.average,
    this.burst,
    this.floor,
    this.peak,
  ...
  factory DomainDevicesInterfaceBandwidthOutbound.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceBandwidthOutbound(
      average: (() { final guardedValue = map['average']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      burst: (() { final guardedValue = map['burst']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      floor: (() { final guardedValue = map['floor']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      peak: (() { final guardedValue = map['peak']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
    );
  }
}
