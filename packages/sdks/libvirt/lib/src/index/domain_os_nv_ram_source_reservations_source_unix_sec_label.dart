...
class DomainOsNvRamSourceReservationsSourceUnixSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceReservationsSourceUnixSecLabel].
  ...
  const DomainOsNvRamSourceReservationsSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceReservationsSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourceUnixSecLabel(
