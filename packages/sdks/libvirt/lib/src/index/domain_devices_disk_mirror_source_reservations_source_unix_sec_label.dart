...
class DomainDevicesDiskMirrorSourceReservationsSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceReservationsSourceUnixSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceReservationsSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceReservationsSourceUnixSecLabel(
