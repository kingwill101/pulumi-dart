...
class DomainDevicesRedirDevSourceUnix {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesRedirDevSourceUnixSecLabel>,
    ...
    return DomainDevicesRedirDevSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesRedirDevSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesRedirDevSourceUnixSecLabel>(
            guardedValue,
            (value) => DomainDevicesRedirDevSourceUnixSecLabel.fromMap(
