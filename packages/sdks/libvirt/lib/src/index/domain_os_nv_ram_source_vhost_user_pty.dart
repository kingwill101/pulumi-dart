...
class DomainOsNvRamSourceVhostUserPty {
  ...
  const DomainOsNvRamSourceVhostUserPty({
    required this.path,
    this.secLabels,
  });
  ...
  factory DomainOsNvRamSourceVhostUserPty.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserPty(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainOsNvRamSourceVhostUserPtySecLabel>(guardedValue, (value) => DomainOsNvRamSourceVhostUserPtySecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
