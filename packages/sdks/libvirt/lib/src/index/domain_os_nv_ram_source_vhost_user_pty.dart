...
class DomainOsNvRamSourceVhostUserPty {
  ...
  DomainOsNvRamSourceVhostUserPty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceVhostUserPtySecLabel>,
    ...
    return DomainOsNvRamSourceVhostUserPty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsNvRamSourceVhostUserPtySecLabel>(
            guardedValue,
            (value) => DomainOsNvRamSourceVhostUserPtySecLabel.fromMap(
