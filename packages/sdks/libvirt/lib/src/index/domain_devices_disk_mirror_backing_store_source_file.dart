...
class DomainDevicesDiskMirrorBackingStoreSourceFile {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorBackingStoreSourceFileSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceFileSecLabel.fromMap(
