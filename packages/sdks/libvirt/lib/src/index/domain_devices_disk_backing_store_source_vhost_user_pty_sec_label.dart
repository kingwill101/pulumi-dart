...
class DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserPtySecLabel(
