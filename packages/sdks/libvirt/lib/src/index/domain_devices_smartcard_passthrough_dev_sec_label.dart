...
class DomainDevicesSmartcardPassthroughDevSecLabel {
  ...
  /// Creates a new [DomainDevicesSmartcardPassthroughDevSecLabel].
  ...
  const DomainDevicesSmartcardPassthroughDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesSmartcardPassthroughDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughDevSecLabel(
