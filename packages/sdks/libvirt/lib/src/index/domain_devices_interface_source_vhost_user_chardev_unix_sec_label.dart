...
class DomainDevicesInterfaceSourceVhostUserChardevUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesInterfaceSourceVhostUserChardevUnixSecLabel].
  ...
  const DomainDevicesInterfaceSourceVhostUserChardevUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevUnixSecLabel(
