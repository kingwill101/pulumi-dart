...
class DomainDevicesAudioPulseAudioInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioPulseAudioInputSettings].
  ...
  const DomainDevicesAudioPulseAudioInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioPulseAudioInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioPulseAudioInputSettings(
