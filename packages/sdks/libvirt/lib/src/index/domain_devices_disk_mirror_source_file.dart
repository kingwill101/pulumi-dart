...
class DomainDevicesDiskMirrorSourceFile {
  ...
  final pulumi.Input<List<DomainDevicesDiskMirrorSourceFileSecLabel>>?
  secLabels;
  ...
  DomainDevicesDiskMirrorSourceFile({this.fdGroup, this.file, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceFileSecLabel>,
    ...
    return DomainDevicesDiskMirrorSourceFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskMirrorSourceFileSecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskMirrorSourceFileSecLabel.fromMap(
