...
class DomainOsNvRamSourceNetworkAuthSecret {
  ...
  /// Creates a new [DomainOsNvRamSourceNetworkAuthSecret].
  ...
  DomainOsNvRamSourceNetworkAuthSecret({this.type, this.usage, this.uuid});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'type': ?type, 'usage': ?usage, 'uuid': ?uuid};
  }

  factory DomainOsNvRamSourceNetworkAuthSecret.fromMap(
    Map<String, dynamic> map,
  ) {
    return DomainOsNvRamSourceNetworkAuthSecret(
      type: (() {
