...
class DomainPerf {
  ...
  factory DomainPerf.fromMap(Map<String, dynamic> map) {
    return DomainPerf(
      events: (() { final guardedValue = map['events']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainPerfEvent>(guardedValue, (value) => DomainPerfEvent.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
