...
class DomainDevicesDiskEncryption {
  ...
  DomainDevicesDiskEncryption({this.engine, this.format, this.secrets});
    ...
    return <String, dynamic>{
      ...
      'secrets':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskEncryptionSecret>,
    ...
    return DomainDevicesDiskEncryption(
      ...
      secrets: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskEncryptionSecret>(
            guardedValue,
            (value) => DomainDevicesDiskEncryptionSecret.fromMap(
