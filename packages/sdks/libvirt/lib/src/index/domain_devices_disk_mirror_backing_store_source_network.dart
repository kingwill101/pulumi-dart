...
class DomainDevicesDiskMirrorBackingStoreSourceNetwork {
  ...
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceNetworkAuth>?
  auth;

  /// Defines configuration settings for the network in the backing store source.
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceNetworkConfig>?
  config;

  /// Configures the hosts within the network settings of the backing store source.
  final pulumi.Input<
    List<DomainDevicesDiskMirrorBackingStoreSourceNetworkHost>
  >?
  hosts;

  /// Sets the identity parameters for the network connection in the backing store source.
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceNetworkIdentity>?
  identity;

  /// Sets the initiator for the network connection in the backing store source configuration.
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceNetworkInitiator>?
  initiator;
  ...
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceNetworkReconnect>?
  reconnect;

  /// Enables snapshot capabilities for the network storage source, allowing for point-in-time volumes.
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceNetworkSnapshot>?
  snapshot;
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceNetwork.fromMap(
    ...
    return DomainDevicesDiskMirrorBackingStoreSourceNetwork(
      auth: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkAuth.fromMap(
      ...
      config: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      hosts: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceNetworkHost.fromMap(
      ...
      identity: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkIdentity.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      initiator: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkInitiator.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      knownHosts: (() {
        final guardedValue = map['knownHosts'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkKnownHosts.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      reconnect: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkReconnect.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      snapshot: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkSnapshot.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      tlsHostname: (() {
        final guardedValue = map['tlsHostname'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
