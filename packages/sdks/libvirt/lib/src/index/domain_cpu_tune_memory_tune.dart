...
class DomainCpuTuneMemoryTune {
  ...
  DomainCpuTuneMemoryTune({this.monitors, this.nodes, required this.vcpus});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'monitors':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainCpuTuneMemoryTuneMonitor>,
      ...
      'nodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainCpuTuneMemoryTuneNode>,
            List<Map<String, dynamic>>
          >(
            nodes,
            (value) =>
    ...
    return DomainCpuTuneMemoryTune(
      monitors: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainCpuTuneMemoryTuneMonitor>(
            guardedValue,
            (value) => DomainCpuTuneMemoryTuneMonitor.fromMap(
      ...
      nodes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainCpuTuneMemoryTuneNode>(
            guardedValue,
            (value) => DomainCpuTuneMemoryTuneNode.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
