...
import 'domain_devices_disk_mirror_source_ctl.dart';
...
class DomainDevicesDiskMirrorSource {
  ...
  final pulumi.Input<DomainDevicesDiskMirrorSourceCtl?>? ctl;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ctl': ?pulumi.Input.mapOptionalInputValue<DomainDevicesDiskMirrorSourceCtl, Map<String, dynamic>>(ctl, (value) => value.toMap()),
  ...
  factory DomainDevicesDiskMirrorSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSource(
      block: (() { final guardedValue = map['block']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceBlock.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      cookies: (() { final guardedValue = map['cookies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceCookies.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ctl: (() { final guardedValue = map['ctl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceCtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dataStore: (() { final guardedValue = map['dataStore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceDataStore.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      dir: (() { final guardedValue = map['dir']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceDir.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      encryption: (() { final guardedValue = map['encryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceEncryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      file: (() { final guardedValue = map['file']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceFile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceNetwork.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      readahead: (() { final guardedValue = map['readahead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceReadahead.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      reservations: (() { final guardedValue = map['reservations']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceReservations.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      slices: (() { final guardedValue = map['slices']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceSlices.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ssl: (() { final guardedValue = map['ssl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceSsl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      timeout: (() { final guardedValue = map['timeout']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceTimeout.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vhostUser: (() { final guardedValue = map['vhostUser']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceVhostUser.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      vhostVdpa: (() { final guardedValue = map['vhostVdpa']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceVhostVdpa.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      volume: (() { final guardedValue = map['volume']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceVolume.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
