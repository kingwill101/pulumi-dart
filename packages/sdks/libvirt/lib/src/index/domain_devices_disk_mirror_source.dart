...
class DomainDevicesDiskMirrorSource {
  ...
  final DomainDevicesDiskMirrorSourceNetwork? network;
  ...
  final DomainDevicesDiskMirrorSourceReadahead? readahead;
  /// Defines reservations settings for network storage sources, enabling resource management.
  final DomainDevicesDiskMirrorSourceReservations? reservations;
  /// Configures slices for the mirror source device.
  final DomainDevicesDiskMirrorSourceSlices? slices;
  /// Configures SSL settings for the backing store source in disk mirroring.
  final DomainDevicesDiskMirrorSourceSsl? ssl;
  ...
  final DomainDevicesDiskMirrorSourceTimeout? timeout;
  /// Configures VHostUser settings for the backing store source in disk mirroring.
  final DomainDevicesDiskMirrorSourceVhostUser? vhostUser;
  /// Configures the VHostVDPA settings for the source backing store.
  final DomainDevicesDiskMirrorSourceVhostVdpa? vhostVdpa;
  /// Configures the source volume settings for the mirror backing store.
  final DomainDevicesDiskMirrorSourceVolume? volume;
  ...
  factory DomainDevicesDiskMirrorSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSource(
      block: map['block'] == null ? null : DomainDevicesDiskMirrorSourceBlock.fromMap((map['block'] as Map).cast<String, dynamic>()),
      cookies: map['cookies'] == null ? null : DomainDevicesDiskMirrorSourceCookies.fromMap((map['cookies'] as Map).cast<String, dynamic>()),
      dataStore: map['dataStore'] == null ? null : DomainDevicesDiskMirrorSourceDataStore.fromMap((map['dataStore'] as Map).cast<String, dynamic>()),
      dir: map['dir'] == null ? null : DomainDevicesDiskMirrorSourceDir.fromMap((map['dir'] as Map).cast<String, dynamic>()),
      encryption: map['encryption'] == null ? null : DomainDevicesDiskMirrorSourceEncryption.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      file: map['file'] == null ? null : DomainDevicesDiskMirrorSourceFile.fromMap((map['file'] as Map).cast<String, dynamic>()),
      index: map['index'] == null ? null : map['index'] as double,
      network: map['network'] == null ? null : DomainDevicesDiskMirrorSourceNetwork.fromMap((map['network'] as Map).cast<String, dynamic>()),
      nvme: map['nvme'] == null ? null : (map['nvme'] as Map).cast<String, dynamic>(),
      readahead: map['readahead'] == null ? null : DomainDevicesDiskMirrorSourceReadahead.fromMap((map['readahead'] as Map).cast<String, dynamic>()),
      reservations: map['reservations'] == null ? null : DomainDevicesDiskMirrorSourceReservations.fromMap((map['reservations'] as Map).cast<String, dynamic>()),
      slices: map['slices'] == null ? null : DomainDevicesDiskMirrorSourceSlices.fromMap((map['slices'] as Map).cast<String, dynamic>()),
      ssl: map['ssl'] == null ? null : DomainDevicesDiskMirrorSourceSsl.fromMap((map['ssl'] as Map).cast<String, dynamic>()),
      startupPolicy: map['startupPolicy'] == null ? null : map['startupPolicy'] as String,
      timeout: map['timeout'] == null ? null : DomainDevicesDiskMirrorSourceTimeout.fromMap((map['timeout'] as Map).cast<String, dynamic>()),
      vhostUser: map['vhostUser'] == null ? null : DomainDevicesDiskMirrorSourceVhostUser.fromMap((map['vhostUser'] as Map).cast<String, dynamic>()),
      vhostVdpa: map['vhostVdpa'] == null ? null : DomainDevicesDiskMirrorSourceVhostVdpa.fromMap((map['vhostVdpa'] as Map).cast<String, dynamic>()),
      volume: map['volume'] == null ? null : DomainDevicesDiskMirrorSourceVolume.fromMap((map['volume'] as Map).cast<String, dynamic>()),
    );
  }
}
