...
class DomainMemoryBacking {
    ...
    return <String, dynamic>{
      'memoryAccess':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(memoryAccess, (value) => value.toMap()),
      'memoryAllocation':
          ?pulumi.Input.mapOptionalInputValue<
            DomainMemoryBackingMemoryAllocation,
            Map<String, dynamic>
          >(memoryAllocation, (value) => value.toMap()),
      'memoryDiscard': ?memoryDiscard,
      'memoryHugePages':
          ?pulumi.Input.mapOptionalInputValue<
            DomainMemoryBackingMemoryHugePages,
            Map<String, dynamic>
          >(memoryHugePages, (value) => value.toMap()),
      ...
      'memorySource':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(memorySource, (value) => value.toMap()),
    };
  }
  ...
  factory DomainMemoryBacking.fromMap(Map<String, dynamic> map) {
    return DomainMemoryBacking(
      memoryAccess: (() {
        final guardedValue = map['memoryAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainMemoryBackingMemoryAccess.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      memoryAllocation: (() {
        final guardedValue = map['memoryAllocation'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainMemoryBackingMemoryAllocation.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      memoryDiscard: (() {
        final guardedValue = map['memoryDiscard'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      memoryHugePages: (() {
        final guardedValue = map['memoryHugePages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainMemoryBackingMemoryHugePages.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      memoryLocked: (() {
        final guardedValue = map['memoryLocked'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      memoryNosharepages: (() {
        final guardedValue = map['memoryNosharepages'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      memorySource: (() {
        final guardedValue = map['memorySource'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainMemoryBackingMemorySource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
