...
class DomainDevicesRedirDevSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesRedirDevSourcePipeSecLabel].
  ...
  const DomainDevicesRedirDevSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRedirDevSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourcePipeSecLabel(
