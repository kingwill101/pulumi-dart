...
class DomainDevicesTpmBackendEmulatorSource {
  ...
  const DomainDevicesTpmBackendEmulatorSource({
    this.dir,
    this.file,
  });
  ...
  factory DomainDevicesTpmBackendEmulatorSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendEmulatorSource(
      dir: (() { final guardedValue = map['dir']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesTpmBackendEmulatorSourceDir.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      file: (() { final guardedValue = map['file']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesTpmBackendEmulatorSourceFile.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
