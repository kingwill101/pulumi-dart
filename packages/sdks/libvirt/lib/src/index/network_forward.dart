    ...
    return <String, dynamic>{
      ...
      'nat':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkForwardNat,
            Map<String, dynamic>
          >(nat, (value) => value.toMap()),
      'pfs':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkForwardPf>,
            List<Map<String, dynamic>>
          >(
            pfs,
            (value) =>
                pulumi.Input.encodeList<NetworkForwardPf, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return NetworkForward(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkForwardAddress>(
            guardedValue,
            (value) => NetworkForwardAddress.fromMap(
      ...
      interfaces: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkForwardInterface>(
            guardedValue,
            (value) => NetworkForwardInterface.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      nat: (() {
        final guardedValue = map['nat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkForwardNat.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      pfs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkForwardPf>(
            guardedValue,
            (value) => NetworkForwardPf.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
