...
class DomainDevicesSerialSourceDev {
  ...
  factory DomainDevicesSerialSourceDev.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourceDev(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesSerialSourceDevSecLabel>(guardedValue, (value) => DomainDevicesSerialSourceDevSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
