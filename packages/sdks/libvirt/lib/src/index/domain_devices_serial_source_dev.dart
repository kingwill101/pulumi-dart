...
class DomainDevicesSerialSourceDev {
  ...
  DomainDevicesSerialSourceDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSerialSourceDevSecLabel>,
    ...
    return DomainDevicesSerialSourceDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesSerialSourceDevSecLabel>(
            guardedValue,
            (value) => DomainDevicesSerialSourceDevSecLabel.fromMap(
