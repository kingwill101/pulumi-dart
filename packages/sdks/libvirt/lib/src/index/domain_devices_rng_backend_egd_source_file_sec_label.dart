...
class DomainDevicesRngBackendEgdSourceFileSecLabel {
  ...
  const DomainDevicesRngBackendEgdSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRngBackendEgdSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackendEgdSourceFileSecLabel(
