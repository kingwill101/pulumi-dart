...
class DomainSysInfoSmbiosChassis {
  ...
  DomainSysInfoSmbiosChassis({this.entries});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entries':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainSysInfoSmbiosChassisEntry>,
    ...
    return DomainSysInfoSmbiosChassis(
      entries: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainSysInfoSmbiosChassisEntry>(
            guardedValue,
            (value) => DomainSysInfoSmbiosChassisEntry.fromMap(
