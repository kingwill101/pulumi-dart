...
class DomainDevicesDiskSourceReservationsSourcePipe {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskSourceReservationsSourcePipeSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskSourceReservationsSourcePipe.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskSourceReservationsSourcePipeSecLabel.fromMap(
