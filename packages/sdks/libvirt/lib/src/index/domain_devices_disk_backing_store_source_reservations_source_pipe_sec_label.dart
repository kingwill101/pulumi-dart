...
class DomainDevicesDiskBackingStoreSourceReservationsSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceReservationsSourcePipeSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceReservationsSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourcePipeSecLabel(
