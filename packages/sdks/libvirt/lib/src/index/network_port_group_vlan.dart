...
class NetworkPortGroupVlan {
  ...
  NetworkPortGroupVlan({this.tags, this.trunk});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'tags':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkPortGroupVlanTag>,
    ...
    return NetworkPortGroupVlan(
      tags: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPortGroupVlanTag>(
            guardedValue,
            (value) => NetworkPortGroupVlanTag.fromMap(
