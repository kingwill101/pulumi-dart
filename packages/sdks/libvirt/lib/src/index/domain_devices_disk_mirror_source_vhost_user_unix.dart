...
class DomainDevicesDiskMirrorSourceVhostUserUnix {
  ...
  final pulumi.Input<DomainDevicesDiskMirrorSourceVhostUserUnixReconnect>?
  reconnect;

  /// Configures the security label for the UNIX domain socket.
  final pulumi.Input<List<DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel>>?
  secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel>,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserUnix.fromMap(
    ...
    return DomainDevicesDiskMirrorSourceVhostUserUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorSourceVhostUserUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceVhostUserUnixSecLabel.fromMap(
