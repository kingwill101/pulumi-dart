...
class DomainDevicesSmartcardPassthroughUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesSmartcardPassthroughUnixSecLabel].
  ...
  const DomainDevicesSmartcardPassthroughUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesSmartcardPassthroughUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughUnixSecLabel(
