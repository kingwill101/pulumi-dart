...
class DomainDevicesTpmBackendExternalSourceUdp {
  ...
  /// Creates a new [DomainDevicesTpmBackendExternalSourceUdp].
  ...
  const DomainDevicesTpmBackendExternalSourceUdp({
  ...
  factory DomainDevicesTpmBackendExternalSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendExternalSourceUdp(
