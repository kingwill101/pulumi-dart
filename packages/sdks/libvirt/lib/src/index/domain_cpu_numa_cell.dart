    ...
    return DomainCpuNumaCell(
      caches: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainCpuNumaCellCach>(
            guardedValue,
            (value) => DomainCpuNumaCellCach.fromMap(
      ...
      distances: (() {
        final guardedValue = map['distances'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainCpuNumaCellDistances.fromMap(
      ...
      memAccess: (() {
        final guardedValue = map['memAccess'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
