...
class DomainDevicesChannelSourceUdp {
  ...
  /// Creates a new [DomainDevicesChannelSourceUdp].
  ...
  const DomainDevicesChannelSourceUdp({
  ...
  factory DomainDevicesChannelSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesChannelSourceUdp(
