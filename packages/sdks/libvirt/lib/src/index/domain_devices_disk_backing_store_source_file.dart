...
class DomainDevicesDiskBackingStoreSourceFile {
  ...
  final List<DomainDevicesDiskBackingStoreSourceFileSecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'fdGroup': ?fdGroup,
      'file': ?file,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesDiskBackingStoreSourceFileSecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesDiskBackingStoreSourceFile.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceFile(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesDiskBackingStoreSourceFileSecLabel>(map['secLabels'], (value) => DomainDevicesDiskBackingStoreSourceFileSecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
