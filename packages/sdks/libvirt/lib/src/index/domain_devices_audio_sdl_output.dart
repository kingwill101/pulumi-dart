...
import 'domain_devices_audio_sdl_output_settings.dart';
...
class DomainDevicesAudioSdlOutput {
  ...
  final pulumi.Input<DomainDevicesAudioSdlOutputSettings?>? settings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'settings': ?pulumi.Input.mapOptionalInputValue<DomainDevicesAudioSdlOutputSettings, Map<String, dynamic>>(settings, (value) => value.toMap()),
      'voices': ?voices,
    };
  }
  ...
  factory DomainDevicesAudioSdlOutput.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioSdlOutput(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesAudioSdlOutputSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
