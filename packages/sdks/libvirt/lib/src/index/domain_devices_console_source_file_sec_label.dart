...
class DomainDevicesConsoleSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesConsoleSourceFileSecLabel].
  ...
  const DomainDevicesConsoleSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesConsoleSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourceFileSecLabel(
