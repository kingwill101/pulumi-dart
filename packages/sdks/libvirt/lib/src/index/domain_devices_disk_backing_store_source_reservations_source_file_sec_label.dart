...
class DomainDevicesDiskBackingStoreSourceReservationsSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceReservationsSourceFileSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceReservationsSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourceFileSecLabel(
