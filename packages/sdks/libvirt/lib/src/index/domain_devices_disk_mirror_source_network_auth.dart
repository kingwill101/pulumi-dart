...
class DomainDevicesDiskMirrorSourceNetworkAuth {
  ...
  DomainDevicesDiskMirrorSourceNetworkAuth({this.secret, this.username});
  ...
  factory DomainDevicesDiskMirrorSourceNetworkAuth.fromMap(
    ...
    return DomainDevicesDiskMirrorSourceNetworkAuth(
      secret: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorSourceNetworkAuthSecret.fromMap(
