...
class VolumeTargetEncryption {
  ...
  factory VolumeTargetEncryption.fromMap(Map<String, dynamic> map) {
    return VolumeTargetEncryption(
      cipher: (() { final guardedValue = map['cipher']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeTargetEncryptionCipher.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      format: pulumi.Input.fromValue(map['format'] as String),
      ivgen: (() { final guardedValue = map['ivgen']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeTargetEncryptionIvgen.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      secret: (() { final guardedValue = map['secret']; if (guardedValue == null) return null; return pulumi.Input.fromValue(VolumeTargetEncryptionSecret.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
