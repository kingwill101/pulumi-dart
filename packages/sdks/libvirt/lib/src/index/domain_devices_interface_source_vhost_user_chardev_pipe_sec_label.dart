...
class DomainDevicesInterfaceSourceVhostUserChardevPipeSecLabel {
  ...
  /// Creates a new [DomainDevicesInterfaceSourceVhostUserChardevPipeSecLabel].
  ...
  const DomainDevicesInterfaceSourceVhostUserChardevPipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevPipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevPipeSecLabel(
