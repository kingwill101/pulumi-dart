...
class PoolSourceInitiator {
  ...
  factory PoolSourceInitiator.fromMap(Map<String, dynamic> map) {
    return PoolSourceInitiator(
      iqn: (() { final guardedValue = map['iqn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(PoolSourceInitiatorIqn.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
