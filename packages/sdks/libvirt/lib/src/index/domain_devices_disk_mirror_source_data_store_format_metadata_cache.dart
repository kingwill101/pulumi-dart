...
class DomainDevicesDiskMirrorSourceDataStoreFormatMetadataCache {
  ...
  DomainDevicesDiskMirrorSourceDataStoreFormatMetadataCache({this.maxSize});
  ...
  factory DomainDevicesDiskMirrorSourceDataStoreFormatMetadataCache.fromMap(
    ...
    return DomainDevicesDiskMirrorSourceDataStoreFormatMetadataCache(
      maxSize: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorSourceDataStoreFormatMetadataCacheMaxSize.fromMap(
