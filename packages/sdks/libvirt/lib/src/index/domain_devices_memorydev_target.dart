    ...
    return DomainDevicesMemorydevTarget(
      address: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesMemorydevTargetAddress.fromMap(
      ...
      blockUnit: (() {
        final guardedValue = map['blockUnit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      dynamicMemslots: (() {
        final guardedValue = map['dynamicMemslots'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      label: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesMemorydevTargetLabel.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      requestedUnit: (() {
        final guardedValue = map['requestedUnit'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      size: (() {
