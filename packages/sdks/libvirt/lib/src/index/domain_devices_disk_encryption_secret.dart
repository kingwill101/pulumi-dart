...
class DomainDevicesDiskEncryptionSecret {
  ...
  /// Creates a new [DomainDevicesDiskEncryptionSecret].
  ...
  DomainDevicesDiskEncryptionSecret({this.type, this.usage, this.uuid});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'type': ?type, 'usage': ?usage, 'uuid': ?uuid};
  }

  factory DomainDevicesDiskEncryptionSecret.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskEncryptionSecret(
      type: (() {
