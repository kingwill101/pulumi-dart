...
class DomainDevicesRedirDevSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesRedirDevSourceUnixSecLabel].
  ...
  const DomainDevicesRedirDevSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRedirDevSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourceUnixSecLabel(
