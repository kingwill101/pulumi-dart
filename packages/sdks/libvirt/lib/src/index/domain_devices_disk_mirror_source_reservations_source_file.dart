...
class DomainDevicesDiskMirrorSourceReservationsSourceFile {
  ...
  const DomainDevicesDiskMirrorSourceReservationsSourceFile({
    this.append,
    required this.path,
    this.secLabels,
  });
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceFile.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceReservationsSourceFile(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel>(guardedValue, (value) => DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
