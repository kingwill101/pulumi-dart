...
class DomainDevicesDiskMirrorSourceReservationsSourceFile {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel.fromMap(
