...
class DomainDevicesDiskMirrorBackingStoreSourceVhostUserFile {
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceVhostUserFile({
    this.append,
    required this.path,
    this.secLabels,
  });
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVhostUserFile.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceVhostUserFile(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskMirrorBackingStoreSourceVhostUserFileSecLabel>(guardedValue, (value) => DomainDevicesDiskMirrorBackingStoreSourceVhostUserFileSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
