    ...
    return <String, dynamic>{
      ...
      'bridge':
          ?pulumi.Input.mapOptionalInputValue<
            NetworkBridge,
            Map<String, dynamic>
          >(bridge, (value) => value.toMap()),
      'dns':
          ?pulumi.Input.mapOptionalInputValue<NetworkDns, Map<String, dynamic>>(
            dns,
            (value) => value.toMap(),
          ),
      'domain':
      ...
      'ips':
          ...
          >(
            ips,
            (value) => pulumi.Input.encodeList<NetworkIp, Map<String, dynamic>>(
              value,
              (value) => value.toMap(),
            ),
          ),
      'ipv6': ?ipv6,
      'mac':
          ?pulumi.Input.mapOptionalInputValue<NetworkMac, Map<String, dynamic>>(
            mac,
            (value) => value.toMap(),
          ),
      'metadata':
      ...
      'mtu':
          ?pulumi.Input.mapOptionalInputValue<NetworkMtu, Map<String, dynamic>>(
            mtu,
            (value) => value.toMap(),
          ),
      'name': ?name,
      'portGroups':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkPortGroup>,
            List<Map<String, dynamic>>
          >(
            portGroups,
            (value) =>
                pulumi.Input.encodeList<NetworkPortGroup, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      ...
      'routes':
          ...
          >(
            routes,
            (value) =>
                pulumi.Input.encodeList<NetworkRoute, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
  ...
  factory NetworkState.fromMap(Map<String, dynamic> map) {
    return NetworkState(
      ...
      bridge: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkBridge.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      dns: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkDns.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      domain: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkDomain.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      forward: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkForward.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      ips: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkIp>(
            guardedValue,
            (value) =>
                NetworkIp.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      ipv6: (() {
      ...
      mac: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkMac.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      metadata: (() {
      ...
      mtu: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkMtu.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      portGroups: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkPortGroup>(
            guardedValue,
            (value) => NetworkPortGroup.fromMap(
      ...
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkRoute>(
            guardedValue,
            (value) =>
                NetworkRoute.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      trustGuestRxFilters: (() {
      ...
      vlan: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkVlan.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
    );
  }
