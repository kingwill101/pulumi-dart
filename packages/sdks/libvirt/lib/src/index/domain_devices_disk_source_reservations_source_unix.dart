...
class DomainDevicesDiskSourceReservationsSourceUnix {
  ...
  final pulumi.Input<DomainDevicesDiskSourceReservationsSourceUnixReconnect>?
  reconnect;

  /// Configures the security label for the UNIX domain socket.
  final pulumi.Input<
    List<DomainDevicesDiskSourceReservationsSourceUnixSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskSourceReservationsSourceUnix.fromMap(
    ...
    return DomainDevicesDiskSourceReservationsSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskSourceReservationsSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskSourceReservationsSourceUnixSecLabel.fromMap(
