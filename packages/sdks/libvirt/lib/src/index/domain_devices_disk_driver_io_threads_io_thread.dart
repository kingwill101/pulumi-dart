...
class DomainDevicesDiskDriverIoThreadsIoThread {
  ...
  final pulumi.Input<List<DomainDevicesDiskDriverIoThreadsIoThreadQueue>>?
  queues;
  ...
  DomainDevicesDiskDriverIoThreadsIoThread({this.id, this.queues});
    ...
    return <String, dynamic>{
      ...
      'queues':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskDriverIoThreadsIoThreadQueue>,
  ...
  factory DomainDevicesDiskDriverIoThreadsIoThread.fromMap(
    ...
    return DomainDevicesDiskDriverIoThreadsIoThread(
      ...
      queues: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi
              .Input.decodeList<DomainDevicesDiskDriverIoThreadsIoThreadQueue>(
            guardedValue,
            (value) => DomainDevicesDiskDriverIoThreadsIoThreadQueue.fromMap(
