...
class DomainOsNvRamSourceVhostUserUnixSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceVhostUserUnixSecLabel].
  ...
  const DomainOsNvRamSourceVhostUserUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceVhostUserUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserUnixSecLabel(
