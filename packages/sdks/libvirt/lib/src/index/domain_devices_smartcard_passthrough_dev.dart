...
class DomainDevicesSmartcardPassthroughDev {
  ...
  final pulumi.Input<List<DomainDevicesSmartcardPassthroughDevSecLabel>>?
  secLabels;
  ...
  DomainDevicesSmartcardPassthroughDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSmartcardPassthroughDevSecLabel>,
  ...
  factory DomainDevicesSmartcardPassthroughDev.fromMap(
    ...
    return DomainDevicesSmartcardPassthroughDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesSmartcardPassthroughDevSecLabel>(
            guardedValue,
            (value) => DomainDevicesSmartcardPassthroughDevSecLabel.fromMap(
