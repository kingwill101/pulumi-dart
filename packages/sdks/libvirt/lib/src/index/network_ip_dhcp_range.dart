...
class NetworkIpDhcpRange {
  ...
  factory NetworkIpDhcpRange.fromMap(Map<String, dynamic> map) {
    return NetworkIpDhcpRange(
      ...
      lease: (() { final guardedValue = map['lease']; if (guardedValue == null) return null; return pulumi.Input.fromValue(NetworkIpDhcpRangeLease.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
