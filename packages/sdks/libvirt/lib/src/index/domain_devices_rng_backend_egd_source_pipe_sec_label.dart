...
class DomainDevicesRngBackendEgdSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesRngBackendEgdSourcePipeSecLabel].
  ...
  const DomainDevicesRngBackendEgdSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRngBackendEgdSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackendEgdSourcePipeSecLabel(
