...
class DomainDevicesAudioDbusInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioDbusInputSettings].
  ...
  const DomainDevicesAudioDbusInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioDbusInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioDbusInputSettings(
