...
class DomainDevicesControllerDriverIoThreads {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ioThreads': ?pulumi.Input.mapOptionalInputValue<List<DomainDevicesControllerDriverIoThreadsIoThread>, List<Map<String, dynamic>>>(ioThreads, (value) => pulumi.Input.encodeList<DomainDevicesControllerDriverIoThreadsIoThread, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory DomainDevicesControllerDriverIoThreads.fromMap(Map<String, dynamic> map) {
    return DomainDevicesControllerDriverIoThreads(
      ioThreads: (() { final guardedValue = map['ioThreads']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesControllerDriverIoThreadsIoThread>(guardedValue, (value) => DomainDevicesControllerDriverIoThreadsIoThread.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
