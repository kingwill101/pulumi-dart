...
class DomainDevicesTpmBackendExternalSourceDev {
  ...
  final pulumi.Input<List<DomainDevicesTpmBackendExternalSourceDevSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesTpmBackendExternalSourceDevSecLabel>,
  ...
  factory DomainDevicesTpmBackendExternalSourceDev.fromMap(
    ...
    return DomainDevicesTpmBackendExternalSourceDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => DomainDevicesTpmBackendExternalSourceDevSecLabel.fromMap(
