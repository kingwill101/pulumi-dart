...
class DomainBlockIoTune {
  ...
  DomainBlockIoTune({this.devices, this.weight});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'devices':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainBlockIoTuneDevice>,
    ...
    return DomainBlockIoTune(
      devices: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainBlockIoTuneDevice>(
            guardedValue,
            (value) => DomainBlockIoTuneDevice.fromMap(
