...
class DomainOsNvRamSourceVhostUserUnix {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceVhostUserUnixSecLabel>,
    ...
    return DomainOsNvRamSourceVhostUserUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainOsNvRamSourceVhostUserUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsNvRamSourceVhostUserUnixSecLabel>(
            guardedValue,
            (value) => DomainOsNvRamSourceVhostUserUnixSecLabel.fromMap(
