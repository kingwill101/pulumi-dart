...
class DomainDevicesAudioPulseAudio {
  ...
  DomainDevicesAudioPulseAudio({this.input, this.output, this.serverName});
    ...
    return DomainDevicesAudioPulseAudio(
      input: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesAudioPulseAudioInput.fromMap(
      ...
      output: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesAudioPulseAudioOutput.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
