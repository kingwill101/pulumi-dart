...
class DomainDevicesDiskBackingStoreSourceVhostUserFile {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskBackingStoreSourceVhostUserFileSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceVhostUserFileSecLabel.fromMap(
