...
class DomainPm {
  ...
  DomainPm({this.suspendToDisk, this.suspendToMem});
    ...
    return <String, dynamic>{
      'suspendToDisk':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(suspendToDisk, (value) => value.toMap()),
      'suspendToMem':
          ?pulumi.Input.mapOptionalInputValue<
            DomainPmSuspendToMem,
            Map<String, dynamic>
          >(suspendToMem, (value) => value.toMap()),
    };
  }
  ...
  factory DomainPm.fromMap(Map<String, dynamic> map) {
    return DomainPm(
      suspendToDisk: (() {
        final guardedValue = map['suspendToDisk'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainPmSuspendToDisk.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      suspendToMem: (() {
        final guardedValue = map['suspendToMem'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainPmSuspendToMem.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
