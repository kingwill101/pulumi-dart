...
class DomainDevicesDiskBackingStoreSourceVhostUserUdp {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserUdp].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserUdp({
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserUdp(
