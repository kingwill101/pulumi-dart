...
class DomainDevicesDiskMirrorBackingStoreSourceVhostUserPty {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorBackingStoreSourceVhostUserPtySecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVhostUserPty.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceVhostUserPtySecLabel.fromMap(
