...
class DomainDevicesRedirDevSourceUdp {
  ...
  /// Creates a new [DomainDevicesRedirDevSourceUdp].
  ...
  const DomainDevicesRedirDevSourceUdp({
  ...
  factory DomainDevicesRedirDevSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourceUdp(
