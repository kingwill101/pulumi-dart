...
class DomainDevicesDiskMirrorSourceVhostUserPty {
  ...
  final List<DomainDevicesDiskMirrorSourceVhostUserPtySecLabel>? secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'path': path,
      'secLabels': ?secLabels == null ? null : pulumi.Input.encodeList<DomainDevicesDiskMirrorSourceVhostUserPtySecLabel, Map<String, dynamic>>(secLabels!, (value) => value.toMap()),
    };
  }
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserPty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserPty(
      ...
      secLabels: map['secLabels'] == null ? null : pulumi.Input.decodeList<DomainDevicesDiskMirrorSourceVhostUserPtySecLabel>(map['secLabels'], (value) => DomainDevicesDiskMirrorSourceVhostUserPtySecLabel.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
