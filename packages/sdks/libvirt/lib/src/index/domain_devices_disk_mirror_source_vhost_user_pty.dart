...
class DomainDevicesDiskMirrorSourceVhostUserPty {
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserPty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserPty(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskMirrorSourceVhostUserPtySecLabel>(guardedValue, (value) => DomainDevicesDiskMirrorSourceVhostUserPtySecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
