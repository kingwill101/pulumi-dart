...
class DomainDevicesDiskMirrorSourceVhostUserPty {
  ...
  final pulumi.Input<List<DomainDevicesDiskMirrorSourceVhostUserPtySecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceVhostUserPtySecLabel>,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserPty.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceVhostUserPtySecLabel.fromMap(
