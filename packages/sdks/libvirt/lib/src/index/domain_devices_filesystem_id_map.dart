...
class DomainDevicesFilesystemIdMap {
  ...
  DomainDevicesFilesystemIdMap({this.gids, this.uids});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'gids':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesFilesystemIdMapGid>,
      ...
      'uids':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesFilesystemIdMapUid>,
            List<Map<String, dynamic>>
          >(
            uids,
            (value) =>
  ...
  factory DomainDevicesFilesystemIdMap.fromMap(Map<String, dynamic> map) {
    return DomainDevicesFilesystemIdMap(
      gids: (() {
        final guardedValue = map['gids'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesFilesystemIdMapGid>(
            guardedValue,
            (value) => DomainDevicesFilesystemIdMapGid.fromMap(
      ...
      uids: (() {
        final guardedValue = map['uids'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesFilesystemIdMapUid>(
            guardedValue,
            (value) => DomainDevicesFilesystemIdMapUid.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
