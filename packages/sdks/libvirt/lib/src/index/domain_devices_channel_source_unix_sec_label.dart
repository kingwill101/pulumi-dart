...
class DomainDevicesChannelSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesChannelSourceUnixSecLabel].
  ...
  const DomainDevicesChannelSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesChannelSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesChannelSourceUnixSecLabel(
