...
class DomainDevicesGraphicSdl {
  ...
  factory DomainDevicesGraphicSdl.fromMap(Map<String, dynamic> map) {
    return DomainDevicesGraphicSdl(
      ...
      fullScreen: (() { final guardedValue = map['fullScreen']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      gl: (() { final guardedValue = map['gl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesGraphicSdlGl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      xauth: (() { final guardedValue = map['xauth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
