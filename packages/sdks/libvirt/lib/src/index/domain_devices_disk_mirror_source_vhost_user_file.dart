...
class DomainDevicesDiskMirrorSourceVhostUserFile {
  ...
  final pulumi.Input<List<DomainDevicesDiskMirrorSourceVhostUserFileSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceVhostUserFileSecLabel>,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceVhostUserFileSecLabel.fromMap(
