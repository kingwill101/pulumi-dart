...
class DomainDevicesConsoleSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesConsoleSourceDevSecLabel].
  ...
  const DomainDevicesConsoleSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesConsoleSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourceDevSecLabel(
