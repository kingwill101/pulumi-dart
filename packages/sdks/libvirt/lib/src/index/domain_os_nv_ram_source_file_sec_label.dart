...
class DomainOsNvRamSourceFileSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceFileSecLabel].
  ...
  const DomainOsNvRamSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceFileSecLabel(
