...
class DomainDevicesDiskSourceVhostUserUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceVhostUserUnixSecLabel].
  ...
  const DomainDevicesDiskSourceVhostUserUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceVhostUserUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVhostUserUnixSecLabel(
