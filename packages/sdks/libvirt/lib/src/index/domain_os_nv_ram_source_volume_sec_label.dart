...
class DomainOsNvRamSourceVolumeSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceVolumeSecLabel].
  ...
  const DomainOsNvRamSourceVolumeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceVolumeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVolumeSecLabel(
