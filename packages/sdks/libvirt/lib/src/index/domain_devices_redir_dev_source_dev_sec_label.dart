...
class DomainDevicesRedirDevSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesRedirDevSourceDevSecLabel].
  ...
  const DomainDevicesRedirDevSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRedirDevSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourceDevSecLabel(
