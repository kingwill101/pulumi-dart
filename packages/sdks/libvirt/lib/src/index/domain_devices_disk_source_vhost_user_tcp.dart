...
import 'domain_devices_disk_source_vhost_user_tcp_reconnect.dart';

class DomainDevicesDiskSourceVhostUserTcp {
  ...
  final pulumi.Input<DomainDevicesDiskSourceVhostUserTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainDevicesDiskSourceVhostUserTcp].
  ...
  const DomainDevicesDiskSourceVhostUserTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesDiskSourceVhostUserTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }

  factory DomainDevicesDiskSourceVhostUserTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVhostUserTcp(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskSourceVhostUserTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
