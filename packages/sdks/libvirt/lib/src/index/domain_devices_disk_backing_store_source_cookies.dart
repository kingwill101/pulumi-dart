...
class DomainDevicesDiskBackingStoreSourceCookies {
  ...
  const DomainDevicesDiskBackingStoreSourceCookies({
    this.cookies,
  });
  ...
  factory DomainDevicesDiskBackingStoreSourceCookies.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceCookies(
      cookies: (() { final guardedValue = map['cookies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskBackingStoreSourceCookiesCookie>(guardedValue, (value) => DomainDevicesDiskBackingStoreSourceCookiesCookie.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
