...
class DomainDevicesDiskBackingStoreSourceCookies {
  ...
  final pulumi.Input<List<DomainDevicesDiskBackingStoreSourceCookiesCookie>>?
  cookies;
  ...
  DomainDevicesDiskBackingStoreSourceCookies({this.cookies});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cookies':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskBackingStoreSourceCookiesCookie>,
  ...
  factory DomainDevicesDiskBackingStoreSourceCookies.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceCookies(
      cookies: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => DomainDevicesDiskBackingStoreSourceCookiesCookie.fromMap(
