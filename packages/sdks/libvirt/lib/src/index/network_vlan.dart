...
class NetworkVlan {
  ...
  final List<NetworkVlanTag>? tags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'tags': ?tags == null ? null : pulumi.Input.encodeList<NetworkVlanTag, Map<String, dynamic>>(tags!, (value) => value.toMap()),
      'trunk': ?trunk,
    };
  }
  ...
  factory NetworkVlan.fromMap(Map<String, dynamic> map) {
    return NetworkVlan(
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<NetworkVlanTag>(map['tags'], (value) => NetworkVlanTag.fromMap((value as Map).cast<String, dynamic>())),
