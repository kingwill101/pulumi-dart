...
class NetworkVlan {
  ...
  NetworkVlan({this.tags, this.trunk});
    ...
    return <String, dynamic>{
      'tags':
          ...
          >(
            tags,
            (value) =>
                pulumi.Input.encodeList<NetworkVlanTag, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return NetworkVlan(
      tags: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkVlanTag>(
            guardedValue,
            (value) =>
                NetworkVlanTag.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      trunk: (() {
        final guardedValue = map['trunk'];
        if (guardedValue == null) return null;
