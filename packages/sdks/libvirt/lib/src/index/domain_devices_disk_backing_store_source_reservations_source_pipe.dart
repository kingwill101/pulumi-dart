...
class DomainDevicesDiskBackingStoreSourceReservationsSourcePipe {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskBackingStoreSourceReservationsSourcePipeSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourcePipe.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceReservationsSourcePipeSecLabel.fromMap(
