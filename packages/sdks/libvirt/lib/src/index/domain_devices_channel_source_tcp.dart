...
class DomainDevicesChannelSourceTcp {
  ...
  const DomainDevicesChannelSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  factory DomainDevicesChannelSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesChannelSourceTcp(
      ...
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesChannelSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
