...
class DomainDevicesHostdev {
  ...
  factory DomainDevicesHostdev.fromMap(Map<String, dynamic> map) {
    return DomainDevicesHostdev(
      acpi: (() { final guardedValue = map['acpi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevAcpi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      alias: (() { final guardedValue = map['alias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevAlias.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      boot: (() { final guardedValue = map['boot']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevBoot.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      capsMisc: (() { final guardedValue = map['capsMisc']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevCapsMisc.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      capsNet: (() { final guardedValue = map['capsNet']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevCapsNet.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      capsStorage: (() { final guardedValue = map['capsStorage']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevCapsStorage.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      rom: (() { final guardedValue = map['rom']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevRom.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subsysMDev: (() { final guardedValue = map['subsysMDev']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysMDev.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subsysPci: (() { final guardedValue = map['subsysPci']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysPci.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subsysScsi: (() { final guardedValue = map['subsysScsi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysScsi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subsysScsiHost: (() { final guardedValue = map['subsysScsiHost']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysScsiHost.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      subsysUsb: (() { final guardedValue = map['subsysUsb']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysUsb.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
