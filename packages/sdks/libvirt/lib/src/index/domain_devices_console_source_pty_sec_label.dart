...
class DomainDevicesConsoleSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesConsoleSourcePtySecLabel].
  ...
  const DomainDevicesConsoleSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesConsoleSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourcePtySecLabel(
