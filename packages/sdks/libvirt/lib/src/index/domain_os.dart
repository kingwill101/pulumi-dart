    ...
    return <String, dynamic>{
      ...
      'firmwareInfo':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(firmwareInfo, (value) => value.toMap()),
      'init': ?init,
      'initArgs': ?initArgs,
      'initDir': ?initDir,
      'initEnvs':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsInitEnv>,
            List<Map<String, dynamic>>
          >(
            initEnvs,
            (value) =>
                pulumi.Input.encodeList<DomainOsInitEnv, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DomainOs(
      acpi: (() {
        ...
        return pulumi.Input.fromValue(
          DomainOsAcpi.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      bios: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainOsBios.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      bootDevices: (() {
        final guardedValue = map['bootDevices'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsBootDevice>(
            guardedValue,
            (value) => DomainOsBootDevice.fromMap(
      ...
      bootMenu: (() {
        final guardedValue = map['bootMenu'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainOsBootMenu.fromMap(
      ...
      dtb: (() {
        final guardedValue = map['dtb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firmware: (() {
        final guardedValue = map['firmware'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      firmwareInfo: (() {
        final guardedValue = map['firmwareInfo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainOsFirmwareInfo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      initArgs: (() {
        final guardedValue = map['initArgs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue((guardedValue as List).cast<String>());
      })(),
      initDir: (() {
        final guardedValue = map['initDir'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      initEnvs: (() {
        final guardedValue = map['initEnvs'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsInitEnv>(
            guardedValue,
            (value) =>
                DomainOsInitEnv.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      initGroup: (() {
        final guardedValue = map['initGroup'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      initUser: (() {
        final guardedValue = map['initUser'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      initrd: (() {
        final guardedValue = map['initrd'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      kernel: (() {
      ...
      loader: (() {
        final guardedValue = map['loader'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loaderFormat: (() {
        final guardedValue = map['loaderFormat'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loaderReadonly: (() {
        final guardedValue = map['loaderReadonly'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loaderSecure: (() {
        final guardedValue = map['loaderSecure'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loaderStateless: (() {
        final guardedValue = map['loaderStateless'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      loaderType: (() {
      ...
      nvRam: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainOsNvRam.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      shim: (() {
        final guardedValue = map['shim'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      smBios: (() {
        final guardedValue = map['smBios'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainOsSmBios.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      type: (() {
      ...
      typeArch: (() {
        final guardedValue = map['typeArch'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      typeMachine: (() {
        final guardedValue = map['typeMachine'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
    );
