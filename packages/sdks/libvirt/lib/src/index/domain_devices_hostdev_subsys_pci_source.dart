...
class DomainDevicesHostdevSubsysPciSource {
  ...
  DomainDevicesHostdevSubsysPciSource({this.address, this.writeFiltering});
  ...
  factory DomainDevicesHostdevSubsysPciSource.fromMap(
    ...
    return DomainDevicesHostdevSubsysPciSource(
      address: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesHostdevSubsysPciSourceAddress.fromMap(
