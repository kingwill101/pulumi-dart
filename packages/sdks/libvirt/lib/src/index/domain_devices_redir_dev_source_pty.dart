...
class DomainDevicesRedirDevSourcePty {
  ...
  DomainDevicesRedirDevSourcePty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesRedirDevSourcePtySecLabel>,
    ...
    return DomainDevicesRedirDevSourcePty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesRedirDevSourcePtySecLabel>(
            guardedValue,
            (value) => DomainDevicesRedirDevSourcePtySecLabel.fromMap(
