...
class DomainDevicesRedirDevSourcePty {
  ...
  factory DomainDevicesRedirDevSourcePty.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourcePty(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesRedirDevSourcePtySecLabel>(guardedValue, (value) => DomainDevicesRedirDevSourcePtySecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
