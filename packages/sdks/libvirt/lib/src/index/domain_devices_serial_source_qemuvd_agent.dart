...
class DomainDevicesSerialSourceQemuvdAgent {
  ...
  DomainDevicesSerialSourceQemuvdAgent({this.clipBoard, this.mouse});
  ...
  factory DomainDevicesSerialSourceQemuvdAgent.fromMap(
    ...
    return DomainDevicesSerialSourceQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesSerialSourceQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesSerialSourceQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
