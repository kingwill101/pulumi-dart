...
class DomainDevicesDiskBackingStoreSourceVhostUserUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserUnixSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserUnixSecLabel(
