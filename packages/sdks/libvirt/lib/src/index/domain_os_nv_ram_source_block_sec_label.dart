...
class DomainOsNvRamSourceBlockSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceBlockSecLabel].
  ...
  const DomainOsNvRamSourceBlockSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceBlockSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceBlockSecLabel(
