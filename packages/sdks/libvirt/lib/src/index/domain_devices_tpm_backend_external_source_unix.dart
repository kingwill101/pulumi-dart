...
class DomainDevicesTpmBackendExternalSourceUnix {
  ...
  final pulumi.Input<DomainDevicesTpmBackendExternalSourceUnixReconnect>?
  reconnect;

  /// Configures the security label for the UNIX domain socket.
  final pulumi.Input<List<DomainDevicesTpmBackendExternalSourceUnixSecLabel>>?
  secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesTpmBackendExternalSourceUnixSecLabel>,
  ...
  factory DomainDevicesTpmBackendExternalSourceUnix.fromMap(
    ...
    return DomainDevicesTpmBackendExternalSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesTpmBackendExternalSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesTpmBackendExternalSourceUnixSecLabel.fromMap(
