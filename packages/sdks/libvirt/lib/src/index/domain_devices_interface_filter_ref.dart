...
class DomainDevicesInterfaceFilterRef {
  ...
  factory DomainDevicesInterfaceFilterRef.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceFilterRef(
      ...
      parameters: (() { final guardedValue = map['parameters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesInterfaceFilterRefParameter>(guardedValue, (value) => DomainDevicesInterfaceFilterRefParameter.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
