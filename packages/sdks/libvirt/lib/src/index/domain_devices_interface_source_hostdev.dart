...
class DomainDevicesInterfaceSourceHostdev {
  ...
  DomainDevicesInterfaceSourceHostdev({this.pci, this.usb});
    ...
    return <String, dynamic>{
      ...
      'usb':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(usb, (value) => value.toMap()),
    };
  }

  factory DomainDevicesInterfaceSourceHostdev.fromMap(
    ...
    return DomainDevicesInterfaceSourceHostdev(
      pci: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceSourceHostdevPci.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      usb: (() {
        final guardedValue = map['usb'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceSourceHostdevUsb.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
