...
class DomainDevicesTpmBackendExternalSourceQemuvdAgent {
  ...
  final pulumi.Input<DomainDevicesTpmBackendExternalSourceQemuvdAgentClipBoard>?
  clipBoard;

  /// Configures mouse settings for the QEMU guest agent in the random number generator setup.
  final pulumi.Input<DomainDevicesTpmBackendExternalSourceQemuvdAgentMouse>?
  mouse;
  ...
  factory DomainDevicesTpmBackendExternalSourceQemuvdAgent.fromMap(
    ...
    return DomainDevicesTpmBackendExternalSourceQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesTpmBackendExternalSourceQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesTpmBackendExternalSourceQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
