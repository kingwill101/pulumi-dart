...
class DomainDevicesRngBackendEgdSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesRngBackendEgdSourceUnixSecLabel].
  ...
  const DomainDevicesRngBackendEgdSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRngBackendEgdSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackendEgdSourceUnixSecLabel(
