...
class DomainDevicesAudioPipeWireInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioPipeWireInputSettings].
  ...
  const DomainDevicesAudioPipeWireInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioPipeWireInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioPipeWireInputSettings(
