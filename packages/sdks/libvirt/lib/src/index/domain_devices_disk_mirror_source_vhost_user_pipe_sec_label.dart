...
class DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel(
