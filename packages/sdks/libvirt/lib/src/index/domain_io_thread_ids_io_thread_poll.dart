...
class DomainIoThreadIDsIoThreadPoll {
  ...
  DomainIoThreadIDsIoThreadPoll({this.grow, this.max, this.shrink});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'grow': ?grow, 'max': ?max, 'shrink': ?shrink};
  }

  factory DomainIoThreadIDsIoThreadPoll.fromMap(Map<String, dynamic> map) {
    return DomainIoThreadIDsIoThreadPoll(
      grow: (() {
        final guardedValue = map['grow'];
