...
class DomainMemoryBackingMemoryAllocation {
  ...
  DomainMemoryBackingMemoryAllocation({this.mode, this.threads});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'mode': ?mode, 'threads': ?threads};
  }

  factory DomainMemoryBackingMemoryAllocation.fromMap(
