    ...
    return <String, dynamic>{
      ...
      'listeners':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesGraphicVncListener>,
    ...
    return DomainDevicesGraphicVnc(
      ...
      listeners: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesGraphicVncListener>(
            guardedValue,
            (value) => DomainDevicesGraphicVncListener.fromMap(
      ...
      powerControl: (() {
        final guardedValue = map['powerControl'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      sharePolicy: (() {
        final guardedValue = map['sharePolicy'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      socket: (() {
      ...
      webSocket: (() {
        final guardedValue = map['webSocket'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
    );
