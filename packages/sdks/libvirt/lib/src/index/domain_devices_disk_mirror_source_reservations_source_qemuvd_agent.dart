...
class DomainDevicesDiskMirrorSourceReservationsSourceQemuvdAgent {
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceQemuvdAgent.fromMap(
    ...
    return DomainDevicesDiskMirrorSourceReservationsSourceQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorSourceReservationsSourceQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorSourceReservationsSourceQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
