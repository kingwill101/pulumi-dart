...
class DomainCpuNuma {
  ...
  DomainCpuNuma({this.cells, this.interconnects});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'cells':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainCpuNumaCell>,
      ...
      'interconnects':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(interconnects, (value) => value.toMap()),
    };
  }
    ...
    return DomainCpuNuma(
      cells: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainCpuNumaCell>(
            guardedValue,
            (value) => DomainCpuNumaCell.fromMap(
      ...
      interconnects: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainCpuNumaInterconnects.fromMap(
