...
class DomainOsNvRamSourceDataStoreFormatMetadataCache {
  ...
  final pulumi.Input<DomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize>?
  maxSize;
  ...
  DomainOsNvRamSourceDataStoreFormatMetadataCache({this.maxSize});
  ...
  factory DomainOsNvRamSourceDataStoreFormatMetadataCache.fromMap(
    ...
    return DomainOsNvRamSourceDataStoreFormatMetadataCache(
      maxSize: (() {
        ...
        return pulumi.Input.fromValue(
          DomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize.fromMap(
