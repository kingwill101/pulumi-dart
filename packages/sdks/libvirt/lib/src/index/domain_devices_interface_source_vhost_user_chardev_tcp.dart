...
class DomainDevicesInterfaceSourceVhostUserChardevTcp {
  ...
  const DomainDevicesInterfaceSourceVhostUserChardevTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevTcp(
      ...
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesInterfaceSourceVhostUserChardevTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
