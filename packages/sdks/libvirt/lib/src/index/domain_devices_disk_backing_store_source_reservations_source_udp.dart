...
class DomainDevicesDiskBackingStoreSourceReservationsSourceUdp {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceReservationsSourceUdp].
  ...
  const DomainDevicesDiskBackingStoreSourceReservationsSourceUdp({
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourceUdp(
