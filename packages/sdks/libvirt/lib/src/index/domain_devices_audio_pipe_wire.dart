...
class DomainDevicesAudioPipeWire {
  ...
  factory DomainDevicesAudioPipeWire.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioPipeWire(
      input: (() { final guardedValue = map['input']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesAudioPipeWireInput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      output: (() { final guardedValue = map['output']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesAudioPipeWireOutput.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      runtimeDir: (() { final guardedValue = map['runtimeDir']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
