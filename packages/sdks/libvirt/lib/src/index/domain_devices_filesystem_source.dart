    ...
    return <String, dynamic>{
      ...
      'mount':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(mount, (value) => value.toMap()),
      'ram':
          ?pulumi.Input.mapOptionalInputValue<
            DomainDevicesFilesystemSourceRam,
            Map<String, dynamic>
          >(ram, (value) => value.toMap()),
      'template':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return DomainDevicesFilesystemSource(
      bind: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemSourceBind.fromMap(
      ...
      block: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemSourceBlock.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      file: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemSourceFile.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      mount: (() {
        final guardedValue = map['mount'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemSourceMount.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ram: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemSourceRam.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      template: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemSourceTemplate.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      volume: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesFilesystemSourceVolume.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
