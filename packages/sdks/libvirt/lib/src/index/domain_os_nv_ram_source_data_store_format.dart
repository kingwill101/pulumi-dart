...
class DomainOsNvRamSourceDataStoreFormat {
  ...
  final pulumi.Input<DomainOsNvRamSourceDataStoreFormatMetadataCache>?
  metadataCache;
  ...
  DomainOsNvRamSourceDataStoreFormat({this.metadataCache, required this.type});
    ...
    return DomainOsNvRamSourceDataStoreFormat(
      metadataCache: (() {
        ...
        return pulumi.Input.fromValue(
          DomainOsNvRamSourceDataStoreFormatMetadataCache.fromMap(
