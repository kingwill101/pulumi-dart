...
class DomainDevicesDiskSourceVhostUserPtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceVhostUserPtySecLabel].
  ...
  const DomainDevicesDiskSourceVhostUserPtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceVhostUserPtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVhostUserPtySecLabel(
