...
class DomainDevicesInterfaceVirtualPortParams {
  ...
  final pulumi.Input<DomainDevicesInterfaceVirtualPortParamsOpenVSwitch>?
  openVSwitch;

  /// Configures parameters for the VEPA8021QBG virtual port.
  final pulumi.Input<DomainDevicesInterfaceVirtualPortParamsVepa8021qbg>?
  vepa8021qbg;

  /// Configures parameters for the VNTag8011QBH virtual port.
  final pulumi.Input<DomainDevicesInterfaceVirtualPortParamsVnTag8011qbh>?
  vnTag8011qbh;
  ...
  factory DomainDevicesInterfaceVirtualPortParams.fromMap(
    ...
    return DomainDevicesInterfaceVirtualPortParams(
      any: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceVirtualPortParamsAny.fromMap(
      ...
      midoNet: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceVirtualPortParamsMidoNet.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      openVSwitch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceVirtualPortParamsOpenVSwitch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vepa8021qbg: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceVirtualPortParamsVepa8021qbg.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vnTag8011qbh: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInterfaceVirtualPortParamsVnTag8011qbh.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
