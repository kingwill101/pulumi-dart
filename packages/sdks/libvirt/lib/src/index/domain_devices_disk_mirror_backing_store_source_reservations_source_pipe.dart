...
class DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePipe {
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePipe.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePipeSecLabel.fromMap(
