...
class DomainDevicesParallelSourceUnix {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesParallelSourceUnixSecLabel>,
    ...
    return DomainDevicesParallelSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesParallelSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesParallelSourceUnixSecLabel>(
            guardedValue,
            (value) => DomainDevicesParallelSourceUnixSecLabel.fromMap(
