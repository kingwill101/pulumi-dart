...
class DomainDevicesParallelSourceUnix {
  ...
  const DomainDevicesParallelSourceUnix({
    this.mode,
    this.path,
    this.reconnect,
    this.secLabels,
  ...
  factory DomainDevicesParallelSourceUnix.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceUnix(
      ...
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesParallelSourceUnixReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesParallelSourceUnixSecLabel>(guardedValue, (value) => DomainDevicesParallelSourceUnixSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
