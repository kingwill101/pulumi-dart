...
class DomainVcpus {
  ...
  DomainVcpus({this.vcpus});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'vcpus':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainVcpusVcpus>,
            List<Map<String, dynamic>>
          >(
            vcpus,
            (value) =>
                pulumi.Input.encodeList<DomainVcpusVcpus, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DomainVcpus(
      vcpus: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainVcpusVcpus>(
            guardedValue,
            (value) => DomainVcpusVcpus.fromMap(
