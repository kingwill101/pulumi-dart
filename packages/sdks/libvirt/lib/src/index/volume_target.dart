...
class VolumeTarget {
  ...
  factory VolumeTarget.fromMap(Map<String, dynamic> map) {
    return VolumeTarget(
      ...
      clusterSizeUnit: (() {
        final guardedValue = map['clusterSizeUnit'];
        if (guardedValue == null) return null;
      ...
      encryption: (() {
        ...
        return pulumi.Input.fromValue(
          VolumeTargetEncryption.fromMap(
      ...
      permissions: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeTargetPermissions.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      timestamps: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          VolumeTargetTimestamps.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
