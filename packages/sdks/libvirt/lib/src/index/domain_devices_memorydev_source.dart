...
class DomainDevicesMemorydevSource {
  ...
  factory DomainDevicesMemorydevSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesMemorydevSource(
      alignSize: (() { final guardedValue = map['alignSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      alignSizeUnit: (() { final guardedValue = map['alignSizeUnit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      nodeMask: (() { final guardedValue = map['nodeMask']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pageSize: (() { final guardedValue = map['pageSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      pageSizeUnit: (() { final guardedValue = map['pageSizeUnit']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      path: (() { final guardedValue = map['path']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      pmem: (() { final guardedValue = map['pmem']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
