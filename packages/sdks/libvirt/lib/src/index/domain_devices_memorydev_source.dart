...
class DomainDevicesMemorydevSource {
  ...
  factory DomainDevicesMemorydevSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesMemorydevSource(
      alignSize: (() { final guardedValue = map['alignSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      pageSize: (() { final guardedValue = map['pageSize']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
