...
class DomainDevicesDiskBackingStoreSourceReservationsSourceUnix {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceUnix.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceReservationsSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceReservationsSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel.fromMap(
