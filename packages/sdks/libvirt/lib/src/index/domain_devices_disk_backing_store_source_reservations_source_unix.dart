...
class DomainDevicesDiskBackingStoreSourceReservationsSourceUnix {
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceUnix.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceReservationsSourceUnix(
      ...
      reconnect: map['reconnect'] == null ? null : (DomainDevicesDiskBackingStoreSourceReservationsSourceUnixReconnect.fromMap((map['reconnect']! as Map).cast<String, dynamic>())).input(),
      secLabels: map['secLabels'] == null ? null : (pulumi.Input.decodeList<DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel>(map['secLabels']!, (value) => DomainDevicesDiskBackingStoreSourceReservationsSourceUnixSecLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
