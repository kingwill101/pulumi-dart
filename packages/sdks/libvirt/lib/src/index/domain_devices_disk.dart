...
class DomainDevicesDisk {
  ...
  factory DomainDevicesDisk.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDisk(
      acpi: (() { final guardedValue = map['acpi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskAcpi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      alias: (() { final guardedValue = map['alias']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskAlias.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      auth: (() { final guardedValue = map['auth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskAuth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      backendDomain: (() { final guardedValue = map['backendDomain']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskBackendDomain.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      backingStore: (() { final guardedValue = map['backingStore']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskBackingStore.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      blockIo: (() { final guardedValue = map['blockIo']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskBlockIo.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      boot: (() { final guardedValue = map['boot']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskBoot.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      driver: (() { final guardedValue = map['driver']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskDriver.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      encryption: (() { final guardedValue = map['encryption']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskEncryption.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      geometry: (() { final guardedValue = map['geometry']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskGeometry.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ioTune: (() { final guardedValue = map['ioTune']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskIoTune.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mirror: (() { final guardedValue = map['mirror']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirror.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      source: (() { final guardedValue = map['source']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskSource.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      target: (() { final guardedValue = map['target']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskTarget.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      throttleFilters: (() { final guardedValue = map['throttleFilters']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskThrottleFilters.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      transient: (() { final guardedValue = map['transient']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskTransient.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      wwn: (() { final guardedValue = map['wwn']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
