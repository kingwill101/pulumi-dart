...
class DomainDevicesSerialSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesSerialSourcePtySecLabel].
  ...
  const DomainDevicesSerialSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesSerialSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourcePtySecLabel(
