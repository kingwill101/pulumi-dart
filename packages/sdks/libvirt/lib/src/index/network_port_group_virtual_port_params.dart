...
class NetworkPortGroupVirtualPortParams {
  ...
  final pulumi.Input<NetworkPortGroupVirtualPortParamsVnTag8011qbh>?
  vnTag8011qbh;
    ...
    return NetworkPortGroupVirtualPortParams(
      any: (() {
        ...
        return pulumi.Input.fromValue(
          NetworkPortGroupVirtualPortParamsAny.fromMap(
      ...
      midoNet: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkPortGroupVirtualPortParamsMidoNet.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      openVSwitch: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkPortGroupVirtualPortParamsOpenVSwitch.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vepa8021qbg: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkPortGroupVirtualPortParamsVepa8021qbg.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vnTag8011qbh: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          NetworkPortGroupVirtualPortParamsVnTag8011qbh.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
