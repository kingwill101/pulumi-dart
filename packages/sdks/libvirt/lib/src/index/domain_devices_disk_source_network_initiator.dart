...
class DomainDevicesDiskSourceNetworkInitiator {
  ...
  DomainDevicesDiskSourceNetworkInitiator({this.iqn});
  ...
  factory DomainDevicesDiskSourceNetworkInitiator.fromMap(
    ...
    return DomainDevicesDiskSourceNetworkInitiator(
      iqn: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskSourceNetworkInitiatorIqn.fromMap(
