...
class DomainDevicesTpmBackendExternalSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesTpmBackendExternalSourceUnixSecLabel].
  ...
  const DomainDevicesTpmBackendExternalSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesTpmBackendExternalSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendExternalSourceUnixSecLabel(
