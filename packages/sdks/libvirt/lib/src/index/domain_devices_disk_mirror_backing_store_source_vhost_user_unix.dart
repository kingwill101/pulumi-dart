...
class DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnix {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnixSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnix.fromMap(
    ...
    return DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceVhostUserUnixSecLabel.fromMap(
