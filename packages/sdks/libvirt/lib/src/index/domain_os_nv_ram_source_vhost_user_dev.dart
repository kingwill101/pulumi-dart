...
class DomainOsNvRamSourceVhostUserDev {
  ...
  DomainOsNvRamSourceVhostUserDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceVhostUserDevSecLabel>,
    ...
    return DomainOsNvRamSourceVhostUserDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsNvRamSourceVhostUserDevSecLabel>(
            guardedValue,
            (value) => DomainOsNvRamSourceVhostUserDevSecLabel.fromMap(
