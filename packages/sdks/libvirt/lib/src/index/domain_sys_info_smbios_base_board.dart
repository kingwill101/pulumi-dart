...
class DomainSysInfoSmbiosBaseBoard {
  ...
  factory DomainSysInfoSmbiosBaseBoard.fromMap(Map<String, dynamic> map) {
    return DomainSysInfoSmbiosBaseBoard(
      entries: (() { final guardedValue = map['entries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainSysInfoSmbiosBaseBoardEntry>(guardedValue, (value) => DomainSysInfoSmbiosBaseBoardEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
