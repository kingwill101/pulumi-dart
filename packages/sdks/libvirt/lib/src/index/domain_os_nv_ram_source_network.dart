...
class DomainOsNvRamSourceNetwork {
  ...
  const DomainOsNvRamSourceNetwork({
    this.auth,
    this.config,
    this.hosts,
    this.identity,
  ...
  factory DomainOsNvRamSourceNetwork.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceNetwork(
      auth: (() { final guardedValue = map['auth']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceNetworkAuth.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      config: (() { final guardedValue = map['config']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceNetworkConfig.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      hosts: (() { final guardedValue = map['hosts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainOsNvRamSourceNetworkHost>(guardedValue, (value) => DomainOsNvRamSourceNetworkHost.fromMap((value as Map).cast<String, dynamic>()))); })(),
      identity: (() { final guardedValue = map['identity']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceNetworkIdentity.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      initiator: (() { final guardedValue = map['initiator']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceNetworkInitiator.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      knownHosts: (() { final guardedValue = map['knownHosts']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceNetworkKnownHosts.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceNetworkReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      snapshot: (() { final guardedValue = map['snapshot']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainOsNvRamSourceNetworkSnapshot.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
