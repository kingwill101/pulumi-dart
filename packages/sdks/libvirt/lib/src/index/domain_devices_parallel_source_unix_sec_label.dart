...
class DomainDevicesParallelSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesParallelSourceUnixSecLabel].
  ...
  const DomainDevicesParallelSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesParallelSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceUnixSecLabel(
