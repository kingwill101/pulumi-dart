...
class DomainDevicesAudioSpiceInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioSpiceInputSettings].
  ...
  const DomainDevicesAudioSpiceInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioSpiceInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioSpiceInputSettings(
