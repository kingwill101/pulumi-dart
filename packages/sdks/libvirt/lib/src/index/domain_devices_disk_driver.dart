...
class DomainDevicesDiskDriver {
  ...
  factory DomainDevicesDiskDriver.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskDriver(
      ...
      copyOnRead: (() { final guardedValue = map['copyOnRead']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      detectZeros: (() { final guardedValue = map['detectZeros']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      ...
      discardNoUnref: (() { final guardedValue = map['discardNoUnref']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      errorPolicy: (() { final guardedValue = map['errorPolicy']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
