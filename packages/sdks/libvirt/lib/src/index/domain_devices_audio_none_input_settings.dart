...
class DomainDevicesAudioNoneInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioNoneInputSettings].
  ...
  const DomainDevicesAudioNoneInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioNoneInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioNoneInputSettings(
