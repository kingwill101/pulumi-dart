...
class DomainDevicesAudioOssOutputSettings {
  ...
  /// Creates a new [DomainDevicesAudioOssOutputSettings].
  ...
  const DomainDevicesAudioOssOutputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioOssOutputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioOssOutputSettings(
