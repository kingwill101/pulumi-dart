...
class DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel].
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceReservationsSourcePtySecLabel(
