...
class DomainOsNvRamSourceReservationsSourceFile {
  ...
  final pulumi.Input<List<DomainOsNvRamSourceReservationsSourceFileSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceReservationsSourceFileSecLabel>,
  ...
  factory DomainOsNvRamSourceReservationsSourceFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainOsNvRamSourceReservationsSourceFileSecLabel.fromMap(
