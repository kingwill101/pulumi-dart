    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceVhostUserFileSecLabel>,
    ...
    return DomainOsNvRamSourceVhostUserFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsNvRamSourceVhostUserFileSecLabel>(
            guardedValue,
            (value) => DomainOsNvRamSourceVhostUserFileSecLabel.fromMap(
