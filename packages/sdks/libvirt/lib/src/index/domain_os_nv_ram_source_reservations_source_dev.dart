...
class DomainOsNvRamSourceReservationsSourceDev {
  ...
  final pulumi.Input<List<DomainOsNvRamSourceReservationsSourceDevSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceReservationsSourceDevSecLabel>,
  ...
  factory DomainOsNvRamSourceReservationsSourceDev.fromMap(
    ...
    return DomainOsNvRamSourceReservationsSourceDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) => DomainOsNvRamSourceReservationsSourceDevSecLabel.fromMap(
