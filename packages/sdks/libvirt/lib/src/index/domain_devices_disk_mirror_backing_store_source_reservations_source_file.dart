...
class DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceFile {
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceFileSecLabel.fromMap(
