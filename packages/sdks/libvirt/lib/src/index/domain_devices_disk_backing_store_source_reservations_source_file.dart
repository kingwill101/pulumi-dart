...
class DomainDevicesDiskBackingStoreSourceReservationsSourceFile {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskBackingStoreSourceReservationsSourceFileSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskBackingStoreSourceReservationsSourceFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceReservationsSourceFileSecLabel.fromMap(
