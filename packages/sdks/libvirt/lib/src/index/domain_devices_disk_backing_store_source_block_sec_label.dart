...
class DomainDevicesDiskBackingStoreSourceBlockSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceBlockSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceBlockSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceBlockSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceBlockSecLabel(
