...
class DomainDevicesTpmBackendExternalSourceTcp {
  ...
  final pulumi.Input<DomainDevicesTpmBackendExternalSourceTcpReconnect>?
  reconnect;
  ...
  factory DomainDevicesTpmBackendExternalSourceTcp.fromMap(
    ...
    return DomainDevicesTpmBackendExternalSourceTcp(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesTpmBackendExternalSourceTcpReconnect.fromMap(
