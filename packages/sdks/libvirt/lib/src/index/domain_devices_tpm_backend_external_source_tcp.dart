...
import 'domain_devices_tpm_backend_external_source_tcp_reconnect.dart';

class DomainDevicesTpmBackendExternalSourceTcp {
  ...
  final pulumi.Input<DomainDevicesTpmBackendExternalSourceTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainDevicesTpmBackendExternalSourceTcp].
  ...
  const DomainDevicesTpmBackendExternalSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesTpmBackendExternalSourceTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }

  factory DomainDevicesTpmBackendExternalSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendExternalSourceTcp(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesTpmBackendExternalSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
