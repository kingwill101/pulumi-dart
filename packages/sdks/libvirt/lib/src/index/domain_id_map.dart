...
class DomainIdMap {
  ...
  DomainIdMap({this.giDs, this.uiDs});
    ...
    return <String, dynamic>{
      'giDs':
          ...
          >(
            giDs,
            (value) =>
                pulumi.Input.encodeList<DomainIdMapGiD, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'uiDs':
          ...
          >(
            uiDs,
            (value) =>
                pulumi.Input.encodeList<DomainIdMapUiD, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
    ...
    return DomainIdMap(
      giDs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainIdMapGiD>(
            guardedValue,
            (value) =>
                DomainIdMapGiD.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      uiDs: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainIdMapUiD>(
            guardedValue,
            (value) =>
                DomainIdMapUiD.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
    );
