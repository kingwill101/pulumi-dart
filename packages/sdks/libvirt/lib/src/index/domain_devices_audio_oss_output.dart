...
import 'domain_devices_audio_oss_output_settings.dart';
...
class DomainDevicesAudioOssOutput {
  ...
  final pulumi.Input<DomainDevicesAudioOssOutputSettings>? settings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'settings': ?pulumi.Input.mapOptionalInputValue<DomainDevicesAudioOssOutputSettings, Map<String, dynamic>>(settings, (value) => value.toMap()),
      'tryPoll': ?tryPoll,
      'voices': ?voices,
    };
  }
  ...
  factory DomainDevicesAudioOssOutput.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioOssOutput(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesAudioOssOutputSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
