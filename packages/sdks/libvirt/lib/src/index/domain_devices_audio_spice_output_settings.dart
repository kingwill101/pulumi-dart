...
class DomainDevicesAudioSpiceOutputSettings {
  ...
  /// Creates a new [DomainDevicesAudioSpiceOutputSettings].
  ...
  const DomainDevicesAudioSpiceOutputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioSpiceOutputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioSpiceOutputSettings(
