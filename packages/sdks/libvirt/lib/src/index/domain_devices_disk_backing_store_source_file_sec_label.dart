...
class DomainDevicesDiskBackingStoreSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceFileSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceFileSecLabel(
