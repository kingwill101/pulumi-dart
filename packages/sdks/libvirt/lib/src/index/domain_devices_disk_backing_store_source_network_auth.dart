...
class DomainDevicesDiskBackingStoreSourceNetworkAuth {
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceNetworkAuthSecret>?
  secret;
  ...
  DomainDevicesDiskBackingStoreSourceNetworkAuth({this.secret, this.username});
  ...
  factory DomainDevicesDiskBackingStoreSourceNetworkAuth.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceNetworkAuth(
      secret: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceNetworkAuthSecret.fromMap(
