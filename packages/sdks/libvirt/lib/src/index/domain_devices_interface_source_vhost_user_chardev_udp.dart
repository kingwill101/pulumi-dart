...
class DomainDevicesInterfaceSourceVhostUserChardevUdp {
  ...
  /// Creates a new [DomainDevicesInterfaceSourceVhostUserChardevUdp].
  ...
  const DomainDevicesInterfaceSourceVhostUserChardevUdp({
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevUdp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevUdp(
