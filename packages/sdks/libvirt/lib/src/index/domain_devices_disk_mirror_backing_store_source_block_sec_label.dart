...
class DomainDevicesDiskMirrorBackingStoreSourceBlockSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceBlockSecLabel].
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceBlockSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceBlockSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceBlockSecLabel(
