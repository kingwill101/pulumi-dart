...
class DomainDevicesDiskSourceVhostUserDev {
  ...
  final pulumi.Input<List<DomainDevicesDiskSourceVhostUserDevSecLabel>>?
  secLabels;
  ...
  DomainDevicesDiskSourceVhostUserDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskSourceVhostUserDevSecLabel>,
  ...
  factory DomainDevicesDiskSourceVhostUserDev.fromMap(
    ...
    return DomainDevicesDiskSourceVhostUserDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskSourceVhostUserDevSecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskSourceVhostUserDevSecLabel.fromMap(
