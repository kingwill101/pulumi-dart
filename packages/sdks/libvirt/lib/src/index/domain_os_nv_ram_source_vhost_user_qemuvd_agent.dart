...
class DomainOsNvRamSourceVhostUserQemuvdAgent {
  ...
  final pulumi.Input<DomainOsNvRamSourceVhostUserQemuvdAgentClipBoard>?
  clipBoard;
  ...
  DomainOsNvRamSourceVhostUserQemuvdAgent({this.clipBoard, this.mouse});
  ...
  factory DomainOsNvRamSourceVhostUserQemuvdAgent.fromMap(
    ...
    return DomainOsNvRamSourceVhostUserQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainOsNvRamSourceVhostUserQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainOsNvRamSourceVhostUserQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
