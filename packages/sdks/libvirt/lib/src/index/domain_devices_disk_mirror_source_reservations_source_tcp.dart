...
class DomainDevicesDiskMirrorSourceReservationsSourceTcp {
  ...
  const DomainDevicesDiskMirrorSourceReservationsSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceReservationsSourceTcp(
      ...
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorSourceReservationsSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
