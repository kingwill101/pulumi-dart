...
class DomainDevicesDiskSourceVhostUserDevSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceVhostUserDevSecLabel].
  ...
  const DomainDevicesDiskSourceVhostUserDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceVhostUserDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVhostUserDevSecLabel(
