...
class NetworkForwardNat {
  ...
  NetworkForwardNat({this.addresses, this.ipv6, this.ports});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addresses':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkForwardNatAddress>,
    ...
    return NetworkForwardNat(
      addresses: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkForwardNatAddress>(
            guardedValue,
            (value) => NetworkForwardNatAddress.fromMap(
      ...
      ports: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkForwardNatPort>(
            guardedValue,
            (value) => NetworkForwardNatPort.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
