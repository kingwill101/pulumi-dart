...
class DomainDevicesHostdevSubsysScsiSource {
  ...
  factory DomainDevicesHostdevSubsysScsiSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesHostdevSubsysScsiSource(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysScsiSourceHost.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      iscsi: (() { final guardedValue = map['iscsi']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesHostdevSubsysScsiSourceIscsi.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
