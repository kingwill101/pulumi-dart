...
class DomainDevicesTpmBackendExternalSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesTpmBackendExternalSourcePipeSecLabel].
  ...
  const DomainDevicesTpmBackendExternalSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesTpmBackendExternalSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesTpmBackendExternalSourcePipeSecLabel(
