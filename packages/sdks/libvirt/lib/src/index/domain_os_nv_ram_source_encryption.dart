...
class DomainOsNvRamSourceEncryption {
  ...
  factory DomainOsNvRamSourceEncryption.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceEncryption(
      ...
      secrets: (() { final guardedValue = map['secrets']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainOsNvRamSourceEncryptionSecret>(guardedValue, (value) => DomainOsNvRamSourceEncryptionSecret.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
