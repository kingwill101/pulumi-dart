...
class DomainDevicesChannelSourceDev {
  ...
  DomainDevicesChannelSourceDev({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesChannelSourceDevSecLabel>,
    ...
    return DomainDevicesChannelSourceDev(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesChannelSourceDevSecLabel>(
            guardedValue,
            (value) => DomainDevicesChannelSourceDevSecLabel.fromMap(
