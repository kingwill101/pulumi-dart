...
class DomainDevicesHostdevCapsNet {
  ...
  DomainDevicesHostdevCapsNet({this.ips, this.routes, this.source});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'ips':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesHostdevCapsNetIp>,
      ...
      'routes':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesHostdevCapsNetRoute>,
            List<Map<String, dynamic>>
          >(
            routes,
            (value) =>
    ...
    return DomainDevicesHostdevCapsNet(
      ips: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesHostdevCapsNetIp>(
            guardedValue,
            (value) => DomainDevicesHostdevCapsNetIp.fromMap(
      ...
      routes: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesHostdevCapsNetRoute>(
            guardedValue,
            (value) => DomainDevicesHostdevCapsNetRoute.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesHostdevCapsNetSource.fromMap(
