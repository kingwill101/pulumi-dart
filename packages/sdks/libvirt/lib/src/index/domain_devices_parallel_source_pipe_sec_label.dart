...
class DomainDevicesParallelSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesParallelSourcePipeSecLabel].
  ...
  const DomainDevicesParallelSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesParallelSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourcePipeSecLabel(
