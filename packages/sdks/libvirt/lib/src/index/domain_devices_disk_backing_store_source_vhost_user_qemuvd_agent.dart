...
class DomainDevicesDiskBackingStoreSourceVhostUserQemuvdAgent {
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserQemuvdAgent.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceVhostUserQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceVhostUserQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceVhostUserQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
