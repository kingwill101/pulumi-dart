...
class DomainDevicesTpmBackendExternalSourceFile {
  ...
  final pulumi.Input<List<DomainDevicesTpmBackendExternalSourceFileSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesTpmBackendExternalSourceFileSecLabel>,
  ...
  factory DomainDevicesTpmBackendExternalSourceFile.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesTpmBackendExternalSourceFileSecLabel.fromMap(
