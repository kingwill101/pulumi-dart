...
class DomainDevicesDiskSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceFileSecLabel].
  ...
  const DomainDevicesDiskSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceFileSecLabel(
