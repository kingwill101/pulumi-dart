...
class DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceReservationsSourceFileSecLabel(
