...
class DomainDevicesHostdevSubsysScsiSourceHost {
  ...
  DomainDevicesHostdevSubsysScsiSourceHost({this.adapter, this.address});
  ...
  factory DomainDevicesHostdevSubsysScsiSourceHost.fromMap(
    ...
    return DomainDevicesHostdevSubsysScsiSourceHost(
      adapter: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesHostdevSubsysScsiSourceHostAdapter.fromMap(
      ...
      address: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesHostdevSubsysScsiSourceHostAddress.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
