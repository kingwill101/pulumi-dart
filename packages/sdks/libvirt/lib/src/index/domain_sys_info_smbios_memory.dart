...
class DomainSysInfoSmbiosMemory {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'entries': ?pulumi.Input.mapOptionalInputValue<List<DomainSysInfoSmbiosMemoryEntry>, List<Map<String, dynamic>>>(entries, (value) => pulumi.Input.encodeList<DomainSysInfoSmbiosMemoryEntry, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }

  factory DomainSysInfoSmbiosMemory.fromMap(Map<String, dynamic> map) {
    return DomainSysInfoSmbiosMemory(
      entries: (() { final guardedValue = map['entries']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainSysInfoSmbiosMemoryEntry>(guardedValue, (value) => DomainSysInfoSmbiosMemoryEntry.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
