...
class DomainDevicesDiskBackingStoreSourceVhostUserPipe {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskBackingStoreSourceVhostUserPipeSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserPipe.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceVhostUserPipeSecLabel.fromMap(
