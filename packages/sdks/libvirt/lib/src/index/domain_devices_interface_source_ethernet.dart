...
class DomainDevicesInterfaceSourceEthernet {
  ...
  factory DomainDevicesInterfaceSourceEthernet.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceEthernet(
      ips: (() { final guardedValue = map['ips']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesInterfaceSourceEthernetIp>(guardedValue, (value) => DomainDevicesInterfaceSourceEthernetIp.fromMap((value as Map).cast<String, dynamic>()))); })(),
      routes: (() { final guardedValue = map['routes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesInterfaceSourceEthernetRoute>(guardedValue, (value) => DomainDevicesInterfaceSourceEthernetRoute.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
