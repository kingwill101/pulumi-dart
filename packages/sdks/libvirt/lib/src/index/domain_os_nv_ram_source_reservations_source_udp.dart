...
class DomainOsNvRamSourceReservationsSourceUdp {
  ...
  /// Creates a new [DomainOsNvRamSourceReservationsSourceUdp].
  ...
  const DomainOsNvRamSourceReservationsSourceUdp({
  ...
  factory DomainOsNvRamSourceReservationsSourceUdp.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourceUdp(
