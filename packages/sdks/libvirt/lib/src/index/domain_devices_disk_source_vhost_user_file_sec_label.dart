...
class DomainDevicesDiskSourceVhostUserFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceVhostUserFileSecLabel].
  ...
  factory DomainDevicesDiskSourceVhostUserFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceVhostUserFileSecLabel(
