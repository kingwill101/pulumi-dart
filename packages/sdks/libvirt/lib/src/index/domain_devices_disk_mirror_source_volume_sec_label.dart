...
class DomainDevicesDiskMirrorSourceVolumeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceVolumeSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceVolumeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceVolumeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVolumeSecLabel(
