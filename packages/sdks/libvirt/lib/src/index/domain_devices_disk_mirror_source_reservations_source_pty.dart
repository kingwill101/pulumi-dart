...
class DomainDevicesDiskMirrorSourceReservationsSourcePty {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorSourceReservationsSourcePtySecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourcePty.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceReservationsSourcePtySecLabel.fromMap(
