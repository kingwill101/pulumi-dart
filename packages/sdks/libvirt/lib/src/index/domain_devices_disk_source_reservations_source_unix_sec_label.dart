...
class DomainDevicesDiskSourceReservationsSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceReservationsSourceUnixSecLabel].
  ...
  const DomainDevicesDiskSourceReservationsSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceReservationsSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourceUnixSecLabel(
