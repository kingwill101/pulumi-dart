...
class DomainDevicesHostdevSubsysPciTeaming {
  ...
  DomainDevicesHostdevSubsysPciTeaming({this.persistent, required this.type});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'persistent': ?persistent, 'type': type};
  }

  factory DomainDevicesHostdevSubsysPciTeaming.fromMap(
    Map<String, dynamic> map,
  ) {
    return DomainDevicesHostdevSubsysPciTeaming(
      persistent: (() {
        final guardedValue = map['persistent'];
