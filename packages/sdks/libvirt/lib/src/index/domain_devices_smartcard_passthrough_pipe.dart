...
class DomainDevicesSmartcardPassthroughPipe {
  ...
  factory DomainDevicesSmartcardPassthroughPipe.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughPipe(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesSmartcardPassthroughPipeSecLabel>(guardedValue, (value) => DomainDevicesSmartcardPassthroughPipeSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
