...
class DomainDevicesDiskMirrorFormat {
  ...
  const DomainDevicesDiskMirrorFormat({
    this.metadataCache,
    required this.type,
  });
  ...
  factory DomainDevicesDiskMirrorFormat.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorFormat(
      metadataCache: (() { final guardedValue = map['metadataCache']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorFormatMetadataCache.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
