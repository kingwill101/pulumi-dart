...
class DomainDevicesHostdevSubsysScsiSourceIscsiAuth {
  ...
  final pulumi.Input<DomainDevicesHostdevSubsysScsiSourceIscsiAuthSecret>?
  secret;
  ...
  DomainDevicesHostdevSubsysScsiSourceIscsiAuth({this.secret, this.username});
  ...
  factory DomainDevicesHostdevSubsysScsiSourceIscsiAuth.fromMap(
    ...
    return DomainDevicesHostdevSubsysScsiSourceIscsiAuth(
      secret: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesHostdevSubsysScsiSourceIscsiAuthSecret.fromMap(
