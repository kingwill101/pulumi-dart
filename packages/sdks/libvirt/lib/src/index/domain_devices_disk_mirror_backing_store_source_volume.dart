...
class DomainDevicesDiskMirrorBackingStoreSourceVolume {
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVolume.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceVolume(
      ...
      secLabels: map['secLabels'] == null ? null : (pulumi.Input.decodeList<DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel>(map['secLabels']!, (value) => DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
