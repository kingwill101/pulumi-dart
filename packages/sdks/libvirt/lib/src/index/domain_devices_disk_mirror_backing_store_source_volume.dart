...
class DomainDevicesDiskMirrorBackingStoreSourceVolume {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVolume.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorBackingStoreSourceVolumeSecLabel.fromMap(
