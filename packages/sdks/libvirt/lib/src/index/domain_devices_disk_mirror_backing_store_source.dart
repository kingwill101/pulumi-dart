...
import 'domain_devices_disk_mirror_backing_store_source_ctl.dart';
...
class DomainDevicesDiskMirrorBackingStoreSource {
  ...
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceCtl?>? ctl;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ctl': ?pulumi.Input.mapOptionalInputValue<DomainDevicesDiskMirrorBackingStoreSourceCtl, Map<String, dynamic>>(ctl, (value) => value.toMap()),
  ...
  factory DomainDevicesDiskMirrorBackingStoreSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSource(
      ...
      ctl: (() { final guardedValue = map['ctl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorBackingStoreSourceCtl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
