...
class DomainDevicesParallelSourcePipe {
  ...
  DomainDevicesParallelSourcePipe({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesParallelSourcePipeSecLabel>,
    ...
    return DomainDevicesParallelSourcePipe(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesParallelSourcePipeSecLabel>(
            guardedValue,
            (value) => DomainDevicesParallelSourcePipeSecLabel.fromMap(
