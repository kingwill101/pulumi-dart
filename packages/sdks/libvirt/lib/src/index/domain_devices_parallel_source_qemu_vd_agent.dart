...
import 'domain_devices_parallel_source_qemu_vd_agent_clip_board.dart';
import 'domain_devices_parallel_source_qemu_vd_agent_mouse.dart';
...
class DomainDevicesParallelSourceQemuVdAgent {
  ...
  /// [clipBoard] Optional.
  /// [mouse] Optional.
  const DomainDevicesParallelSourceQemuVdAgent({
    this.clipBoard,
    this.mouse,
  });
  ...
  factory DomainDevicesParallelSourceQemuVdAgent.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceQemuVdAgent(
      clipBoard: (() { final guardedValue = map['clipBoard']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesParallelSourceQemuVdAgentClipBoard.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      mouse: (() { final guardedValue = map['mouse']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesParallelSourceQemuVdAgentMouse.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
