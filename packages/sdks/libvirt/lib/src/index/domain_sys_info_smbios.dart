...
class DomainSysInfoSmbios {
    ...
    return <String, dynamic>{
      'baseBoards':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainSysInfoSmbiosBaseBoard>,
      ...
      'bios':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(bios, (value) => value.toMap()),
      'chassis':
          ?pulumi.Input.mapOptionalInputValue<
            DomainSysInfoSmbiosChassis,
            Map<String, dynamic>
          >(chassis, (value) => value.toMap()),
      'memories':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainSysInfoSmbiosMemory>,
            List<Map<String, dynamic>>
          >(
            memories,
            (value) =>
      ...
      'oemStrings':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(oemStrings, (value) => value.toMap()),
      'processors':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainSysInfoSmbiosProcessor>,
            List<Map<String, dynamic>>
          >(
            processors,
            (value) =>
  ...
  factory DomainSysInfoSmbios.fromMap(Map<String, dynamic> map) {
    return DomainSysInfoSmbios(
      baseBoards: (() {
        final guardedValue = map['baseBoards'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainSysInfoSmbiosBaseBoard>(
            guardedValue,
            (value) => DomainSysInfoSmbiosBaseBoard.fromMap(
      ...
      bios: (() {
        final guardedValue = map['bios'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainSysInfoSmbiosBios.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      chassis: (() {
        final guardedValue = map['chassis'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainSysInfoSmbiosChassis.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      memories: (() {
        final guardedValue = map['memories'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainSysInfoSmbiosMemory>(
            guardedValue,
            (value) => DomainSysInfoSmbiosMemory.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      oemStrings: (() {
        final guardedValue = map['oemStrings'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainSysInfoSmbiosOemStrings.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      processors: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainSysInfoSmbiosProcessor>(
            guardedValue,
            (value) => DomainSysInfoSmbiosProcessor.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      system: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainSysInfoSmbiosSystem.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
