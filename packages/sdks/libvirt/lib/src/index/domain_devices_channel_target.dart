...
class DomainDevicesChannelTarget {
  ...
  DomainDevicesChannelTarget({this.guestFwd, this.virtIo, this.xen});
    ...
    return <String, dynamic>{
      'guestFwd':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(guestFwd, (value) => value.toMap()),
      'virtIo':
          ?pulumi.Input.mapOptionalInputValue<
            DomainDevicesChannelTargetVirtIo,
            Map<String, dynamic>
          >(virtIo, (value) => value.toMap()),
      'xen':
          ?pulumi.Input.mapOptionalInputValue<
  ...
  factory DomainDevicesChannelTarget.fromMap(Map<String, dynamic> map) {
    return DomainDevicesChannelTarget(
      guestFwd: (() {
        final guardedValue = map['guestFwd'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesChannelTargetGuestFwd.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      virtIo: (() {
        final guardedValue = map['virtIo'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesChannelTargetVirtIo.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      xen: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesChannelTargetXen.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
