...
class DomainOsNvRamSourceReservationsSourcePtySecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceReservationsSourcePtySecLabel].
  ...
  const DomainOsNvRamSourceReservationsSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceReservationsSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourcePtySecLabel(
