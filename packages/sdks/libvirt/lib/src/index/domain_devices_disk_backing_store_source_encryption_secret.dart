...
class DomainDevicesDiskBackingStoreSourceEncryptionSecret {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceEncryptionSecret].
  ...
  factory DomainDevicesDiskBackingStoreSourceEncryptionSecret.fromMap(
