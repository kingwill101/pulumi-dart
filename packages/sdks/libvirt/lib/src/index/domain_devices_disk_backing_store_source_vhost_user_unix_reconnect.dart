...
class DomainDevicesDiskBackingStoreSourceVhostUserUnixReconnect {
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserUnixReconnect.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserUnixReconnect(
