    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSerialSourceFileSecLabel>,
    ...
    return DomainDevicesSerialSourceFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesSerialSourceFileSecLabel>(
            guardedValue,
            (value) => DomainDevicesSerialSourceFileSecLabel.fromMap(
