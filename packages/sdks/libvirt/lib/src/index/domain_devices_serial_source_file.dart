...
class DomainDevicesSerialSourceFile {
  ...
  const DomainDevicesSerialSourceFile({
    this.append,
    required this.path,
    this.secLabels,
  });
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'append': ?append,
      'path': path,
      'secLabels': ?pulumi.Input.mapOptionalInputValue<List<DomainDevicesSerialSourceFileSecLabel>, List<Map<String, dynamic>>>(secLabels, (value) => pulumi.Input.encodeList<DomainDevicesSerialSourceFileSecLabel, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory DomainDevicesSerialSourceFile.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourceFile(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesSerialSourceFileSecLabel>(guardedValue, (value) => DomainDevicesSerialSourceFileSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
