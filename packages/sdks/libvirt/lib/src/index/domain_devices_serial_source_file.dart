...
class DomainDevicesSerialSourceFile {
  ...
  factory DomainDevicesSerialSourceFile.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSerialSourceFile(
      ...
      secLabels: map['secLabels'] == null ? null : (pulumi.Input.decodeList<DomainDevicesSerialSourceFileSecLabel>(map['secLabels']!, (value) => DomainDevicesSerialSourceFileSecLabel.fromMap((value as Map).cast<String, dynamic>()))).input(),
    );
  }
}
