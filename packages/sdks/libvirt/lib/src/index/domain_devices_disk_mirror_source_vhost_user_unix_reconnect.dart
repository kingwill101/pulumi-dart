...
class DomainDevicesDiskMirrorSourceVhostUserUnixReconnect {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceVhostUserUnixReconnect].
  ...
  const DomainDevicesDiskMirrorSourceVhostUserUnixReconnect({
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserUnixReconnect.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserUnixReconnect(
