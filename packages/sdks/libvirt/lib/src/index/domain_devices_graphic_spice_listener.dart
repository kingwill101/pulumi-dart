...
class DomainDevicesGraphicSpiceListener {
  ...
  const DomainDevicesGraphicSpiceListener({
    this.address,
    this.network,
    this.socket,
  });
  ...
  factory DomainDevicesGraphicSpiceListener.fromMap(Map<String, dynamic> map) {
    return DomainDevicesGraphicSpiceListener(
      address: (() { final guardedValue = map['address']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesGraphicSpiceListenerAddress.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      network: (() { final guardedValue = map['network']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesGraphicSpiceListenerNetwork.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      socket: (() { final guardedValue = map['socket']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesGraphicSpiceListenerSocket.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
