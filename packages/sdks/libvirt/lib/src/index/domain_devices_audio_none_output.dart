...
import 'domain_devices_audio_none_output_settings.dart';

class DomainDevicesAudioNoneOutput {
  final pulumi.Input<double>? bufferLength;
  final pulumi.Input<String>? fixedSettings;
  final pulumi.Input<String>? mixingEngine;
  final pulumi.Input<DomainDevicesAudioNoneOutputSettings>? settings;
  final pulumi.Input<double>? voices;

  /// Creates a new [DomainDevicesAudioNoneOutput].
  /// [bufferLength] Optional.
  /// [fixedSettings] Optional.
  /// [mixingEngine] Optional.
  /// [settings] Optional.
  /// [voices] Optional.
  const DomainDevicesAudioNoneOutput({
    this.bufferLength,
    this.fixedSettings,
    this.mixingEngine,
    this.settings,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'settings': ?pulumi.Input.mapOptionalInputValue<DomainDevicesAudioNoneOutputSettings, Map<String, dynamic>>(settings, (value) => value.toMap()),
      'voices': ?voices,
    };
  }

  factory DomainDevicesAudioNoneOutput.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioNoneOutput(
      ...
      settings: (() { final guardedValue = map['settings']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesAudioNoneOutputSettings.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
