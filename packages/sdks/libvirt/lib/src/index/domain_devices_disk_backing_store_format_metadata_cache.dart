...
class DomainDevicesDiskBackingStoreFormatMetadataCache {
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreFormatMetadataCacheMaxSize>?
  maxSize;
  ...
  DomainDevicesDiskBackingStoreFormatMetadataCache({this.maxSize});
  ...
  factory DomainDevicesDiskBackingStoreFormatMetadataCache.fromMap(
    ...
    return DomainDevicesDiskBackingStoreFormatMetadataCache(
      maxSize: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreFormatMetadataCacheMaxSize.fromMap(
