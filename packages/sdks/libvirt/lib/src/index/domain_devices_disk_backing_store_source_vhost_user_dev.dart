...
class DomainDevicesDiskBackingStoreSourceVhostUserDev {
  ...
  final pulumi.Input<
    List<DomainDevicesDiskBackingStoreSourceVhostUserDevSecLabel>
  >?
  secLabels;
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserDev.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceVhostUserDevSecLabel.fromMap(
