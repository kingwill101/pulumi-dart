...
class DomainDevicesDiskSourceBlock {
  ...
  DomainDevicesDiskSourceBlock({this.dev, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskSourceBlockSecLabel>,
    ...
    return DomainDevicesDiskSourceBlock(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskSourceBlockSecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskSourceBlockSecLabel.fromMap(
