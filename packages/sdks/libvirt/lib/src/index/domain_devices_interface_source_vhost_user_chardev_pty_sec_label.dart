...
class DomainDevicesInterfaceSourceVhostUserChardevPtySecLabel {
  ...
  /// Creates a new [DomainDevicesInterfaceSourceVhostUserChardevPtySecLabel].
  ...
  const DomainDevicesInterfaceSourceVhostUserChardevPtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevPtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevPtySecLabel(
