...
class DomainNumaTune {
  ...
  DomainNumaTune({this.memNodes, this.memory});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'memNodes':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainNumaTuneMemNode>,
  ...
  factory DomainNumaTune.fromMap(Map<String, dynamic> map) {
    return DomainNumaTune(
      memNodes: (() {
        final guardedValue = map['memNodes'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainNumaTuneMemNode>(
            guardedValue,
            (value) => DomainNumaTuneMemNode.fromMap(
