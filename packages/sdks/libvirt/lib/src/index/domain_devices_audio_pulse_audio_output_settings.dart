...
class DomainDevicesAudioPulseAudioOutputSettings {
  ...
  /// Creates a new [DomainDevicesAudioPulseAudioOutputSettings].
  ...
  const DomainDevicesAudioPulseAudioOutputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioPulseAudioOutputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioPulseAudioOutputSettings(
