...
class DomainDevicesDiskBackingStoreSourceVhostUserTcp {
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect>?
  reconnect;
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserTcp.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceVhostUserTcp(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect.fromMap(
