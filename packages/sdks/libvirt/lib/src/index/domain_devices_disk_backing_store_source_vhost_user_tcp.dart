...
import 'domain_devices_disk_backing_store_source_vhost_user_tcp_reconnect.dart';

class DomainDevicesDiskBackingStoreSourceVhostUserTcp {
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserTcp].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }

  factory DomainDevicesDiskBackingStoreSourceVhostUserTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserTcp(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
