...
class DomainDevicesGraphicDbus {
  ...
  factory DomainDevicesGraphicDbus.fromMap(Map<String, dynamic> map) {
    return DomainDevicesGraphicDbus(
      ...
      gl: (() { final guardedValue = map['gl']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesGraphicDbusGl.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      p2p: (() { final guardedValue = map['p2p']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
    );
  }
}
