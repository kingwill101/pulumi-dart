...
class DomainDevicesDiskMirrorSourceVhostUserPipe {
  ...
  final pulumi.Input<List<DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel>>?
  secLabels;
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel>,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserPipe.fromMap(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskMirrorSourceVhostUserPipeSecLabel.fromMap(
