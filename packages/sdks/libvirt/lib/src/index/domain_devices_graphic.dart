    ...
    return <String, dynamic>{
      ...
      'desktop':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(desktop, (value) => value.toMap()),
      'eglHeadless':
          ?pulumi.Input.mapOptionalInputValue<
            DomainDevicesGraphicEglHeadless,
            Map<String, dynamic>
          >(eglHeadless, (value) => value.toMap()),
      'rdp':
          ?pulumi.Input.mapOptionalInputValue<
            DomainDevicesGraphicRdp,
            Map<String, dynamic>
          >(rdp, (value) => value.toMap()),
      'sdl':
          ?pulumi.Input.mapOptionalInputValue<
    ...
    return DomainDevicesGraphic(
      audio: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesGraphicAudio.fromMap(
      ...
      dbus: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicDbus.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      desktop: (() {
        final guardedValue = map['desktop'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicDesktop.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      eglHeadless: (() {
        final guardedValue = map['eglHeadless'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicEglHeadless.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      rdp: (() {
        final guardedValue = map['rdp'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicRdp.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      sdl: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSdl.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      spice: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicSpice.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      vnc: (() {
        final guardedValue = map['vnc'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicVnc.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
