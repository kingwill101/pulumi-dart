...
class DomainOsNvRamSourceVhostUserUdp {
  ...
  /// Creates a new [DomainOsNvRamSourceVhostUserUdp].
  ...
  const DomainOsNvRamSourceVhostUserUdp({
  ...
  factory DomainOsNvRamSourceVhostUserUdp.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserUdp(
