...
class DomainDevicesChannelSourceQemuvdAgent {
  ...
  DomainDevicesChannelSourceQemuvdAgent({this.clipBoard, this.mouse});
  ...
  factory DomainDevicesChannelSourceQemuvdAgent.fromMap(
    ...
    return DomainDevicesChannelSourceQemuvdAgent(
      clipBoard: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesChannelSourceQemuvdAgentClipBoard.fromMap(
      ...
      mouse: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesChannelSourceQemuvdAgentMouse.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
