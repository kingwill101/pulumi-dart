...
class DomainDevicesInputSource {
  ...
  DomainDevicesInputSource({this.evDev, this.passthrough});
  ...
  factory DomainDevicesInputSource.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInputSource(
      evDev: (() {
        final guardedValue = map['evDev'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInputSourceEvDev.fromMap(
      ...
      passthrough: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesInputSourcePassthrough.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
