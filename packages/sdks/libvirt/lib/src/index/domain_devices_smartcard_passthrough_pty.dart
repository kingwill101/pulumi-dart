...
class DomainDevicesSmartcardPassthroughPty {
  ...
  final pulumi.Input<List<DomainDevicesSmartcardPassthroughPtySecLabel>>?
  secLabels;
  ...
  DomainDevicesSmartcardPassthroughPty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesSmartcardPassthroughPtySecLabel>,
  ...
  factory DomainDevicesSmartcardPassthroughPty.fromMap(
    ...
    return DomainDevicesSmartcardPassthroughPty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesSmartcardPassthroughPtySecLabel>(
            guardedValue,
            (value) => DomainDevicesSmartcardPassthroughPtySecLabel.fromMap(
