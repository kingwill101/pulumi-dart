...
class PoolSourceDevice {
  ...
  PoolSourceDevice({this.freeExtents, this.partSeparator, required this.path});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'freeExtents':
          ?pulumi.Input.mapOptionalInputValue<
            List<PoolSourceDeviceFreeExtent>,
  ...
  factory PoolSourceDevice.fromMap(Map<String, dynamic> map) {
    return PoolSourceDevice(
      freeExtents: (() {
        final guardedValue = map['freeExtents'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<PoolSourceDeviceFreeExtent>(
            guardedValue,
            (value) => PoolSourceDeviceFreeExtent.fromMap(
      ...
      partSeparator: (() {
        final guardedValue = map['partSeparator'];
        if (guardedValue == null) return null;
