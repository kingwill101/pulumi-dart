...
class DomainDevicesDiskMirrorBackingStoreSourceDataStore {
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceDataStore({
    this.format,
  });
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceDataStore.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceDataStore(
      format: (() { final guardedValue = map['format']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorBackingStoreSourceDataStoreFormat.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
    );
  }
}
