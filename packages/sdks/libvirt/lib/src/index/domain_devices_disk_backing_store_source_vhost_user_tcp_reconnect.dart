...
class DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect({
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserTcpReconnect(
