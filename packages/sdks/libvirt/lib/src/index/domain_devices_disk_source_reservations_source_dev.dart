...
class DomainDevicesDiskSourceReservationsSourceDev {
  ...
  const DomainDevicesDiskSourceReservationsSourceDev({
    required this.path,
    this.secLabels,
  });
  ...
  factory DomainDevicesDiskSourceReservationsSourceDev.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourceDev(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesDiskSourceReservationsSourceDevSecLabel>(guardedValue, (value) => DomainDevicesDiskSourceReservationsSourceDevSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
