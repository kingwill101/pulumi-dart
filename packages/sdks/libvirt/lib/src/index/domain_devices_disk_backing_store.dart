...
class DomainDevicesDiskBackingStore {
  ...
  DomainDevicesDiskBackingStore({this.format, this.index, this.source});
    ...
    return DomainDevicesDiskBackingStore(
      format: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreFormat.fromMap(
      ...
      source: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSource.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
