...
class DomainDevicesRedirDevSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesRedirDevSourceFileSecLabel].
  ...
  const DomainDevicesRedirDevSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRedirDevSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRedirDevSourceFileSecLabel(
