...
class DomainDevicesParallelSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesParallelSourceFileSecLabel].
  ...
  const DomainDevicesParallelSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesParallelSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceFileSecLabel(
