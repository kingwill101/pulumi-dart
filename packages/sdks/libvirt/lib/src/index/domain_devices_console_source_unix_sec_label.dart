...
class DomainDevicesConsoleSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesConsoleSourceUnixSecLabel].
  ...
  const DomainDevicesConsoleSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesConsoleSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesConsoleSourceUnixSecLabel(
