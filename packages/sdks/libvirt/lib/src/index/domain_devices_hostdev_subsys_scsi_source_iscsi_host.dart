...
class DomainDevicesHostdevSubsysScsiSourceIscsiHost {
  ...
  /// Creates a new [DomainDevicesHostdevSubsysScsiSourceIscsiHost].
  ...
  const DomainDevicesHostdevSubsysScsiSourceIscsiHost({
    this.name,
    this.port,
    this.socket,
    this.transport,
  ...
  factory DomainDevicesHostdevSubsysScsiSourceIscsiHost.fromMap(Map<String, dynamic> map) {
    return DomainDevicesHostdevSubsysScsiSourceIscsiHost(
