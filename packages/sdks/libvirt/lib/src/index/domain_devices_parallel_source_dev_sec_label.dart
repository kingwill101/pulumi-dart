...
class DomainDevicesParallelSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesParallelSourceDevSecLabel].
  ...
  const DomainDevicesParallelSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesParallelSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesParallelSourceDevSecLabel(
