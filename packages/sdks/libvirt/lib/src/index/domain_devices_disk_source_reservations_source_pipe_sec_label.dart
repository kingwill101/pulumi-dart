...
class DomainDevicesDiskSourceReservationsSourcePipeSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskSourceReservationsSourcePipeSecLabel].
  ...
  const DomainDevicesDiskSourceReservationsSourcePipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskSourceReservationsSourcePipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskSourceReservationsSourcePipeSecLabel(
