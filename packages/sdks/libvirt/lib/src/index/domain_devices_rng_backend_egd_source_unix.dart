...
class DomainDevicesRngBackendEgdSourceUnix {
  ...
  final pulumi.Input<List<DomainDevicesRngBackendEgdSourceUnixSecLabel>>?
  secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesRngBackendEgdSourceUnixSecLabel>,
  ...
  factory DomainDevicesRngBackendEgdSourceUnix.fromMap(
    ...
    return DomainDevicesRngBackendEgdSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesRngBackendEgdSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesRngBackendEgdSourceUnixSecLabel>(
            guardedValue,
            (value) => DomainDevicesRngBackendEgdSourceUnixSecLabel.fromMap(
