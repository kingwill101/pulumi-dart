...
class DomainOsNvRamSourceReservationsSourceDevSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceReservationsSourceDevSecLabel].
  ...
  const DomainOsNvRamSourceReservationsSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceReservationsSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceReservationsSourceDevSecLabel(
