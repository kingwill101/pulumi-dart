...
class DomainDevicesDiskMirrorBackingStoreSourceVhostUserTcp {
  ...
  final pulumi.Input<DomainDevicesDiskMirrorBackingStoreSourceVhostUserTcpReconnect?>? reconnect;
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceVhostUserTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesDiskMirrorBackingStoreSourceVhostUserTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceVhostUserTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceVhostUserTcp(
      ...
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesDiskMirrorBackingStoreSourceVhostUserTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
