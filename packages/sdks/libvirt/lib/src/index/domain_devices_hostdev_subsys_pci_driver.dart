...
class DomainDevicesHostdevSubsysPciDriver {
  ...
  DomainDevicesHostdevSubsysPciDriver({this.model, this.name});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'model': ?model, 'name': ?name};
  }

  factory DomainDevicesHostdevSubsysPciDriver.fromMap(
