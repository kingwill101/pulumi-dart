...
import 'domain_cpu_tune_energy_tune.dart';
...
class DomainCpuTune {
  ...
  final pulumi.Input<List<DomainCpuTuneEnergyTune>?>? energyTunes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'energyTunes': ?pulumi.Input.mapOptionalInputValue<List<DomainCpuTuneEnergyTune>, List<Map<String, dynamic>>>(energyTunes, (value) => pulumi.Input.encodeList<DomainCpuTuneEnergyTune, Map<String, dynamic>>(value, (value) => value.toMap())),
  ...
  factory DomainCpuTune.fromMap(Map<String, dynamic> map) {
    return DomainCpuTune(
      cacheTunes: (() { final guardedValue = map['cacheTunes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuTuneCacheTune>(guardedValue, (value) => DomainCpuTuneCacheTune.fromMap((value as Map).cast<String, dynamic>()))); })(),
      emulatorPeriod: (() { final guardedValue = map['emulatorPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      emulatorPin: (() { final guardedValue = map['emulatorPin']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainCpuTuneEmulatorPin.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      emulatorQuota: (() { final guardedValue = map['emulatorQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      emulatorSched: (() { final guardedValue = map['emulatorSched']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainCpuTuneEmulatorSched.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      energyTunes: (() { final guardedValue = map['energyTunes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuTuneEnergyTune>(guardedValue, (value) => DomainCpuTuneEnergyTune.fromMap((value as Map).cast<String, dynamic>()))); })(),
      globalPeriod: (() { final guardedValue = map['globalPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      globalQuota: (() { final guardedValue = map['globalQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ioThreadPeriod: (() { final guardedValue = map['ioThreadPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ioThreadPins: (() { final guardedValue = map['ioThreadPins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuTuneIoThreadPin>(guardedValue, (value) => DomainCpuTuneIoThreadPin.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ioThreadQuota: (() { final guardedValue = map['ioThreadQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ioThreadScheds: (() { final guardedValue = map['ioThreadScheds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuTuneIoThreadSched>(guardedValue, (value) => DomainCpuTuneIoThreadSched.fromMap((value as Map).cast<String, dynamic>()))); })(),
      memoryTunes: (() { final guardedValue = map['memoryTunes']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuTuneMemoryTune>(guardedValue, (value) => DomainCpuTuneMemoryTune.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      quota: (() { final guardedValue = map['quota']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      shares: (() { final guardedValue = map['shares']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      vcpuPins: (() { final guardedValue = map['vcpuPins']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuTuneVcpuPin>(guardedValue, (value) => DomainCpuTuneVcpuPin.fromMap((value as Map).cast<String, dynamic>()))); })(),
      vcpuScheds: (() { final guardedValue = map['vcpuScheds']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuTuneVcpuSched>(guardedValue, (value) => DomainCpuTuneVcpuSched.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
