...
class DomainCpuTune {
  ...
  factory DomainCpuTune.fromMap(Map<String, dynamic> map) {
    return DomainCpuTune(
      ...
      emulatorPeriod: (() { final guardedValue = map['emulatorPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      emulatorQuota: (() { final guardedValue = map['emulatorQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      globalPeriod: (() { final guardedValue = map['globalPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      globalQuota: (() { final guardedValue = map['globalQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ioThreadPeriod: (() { final guardedValue = map['ioThreadPeriod']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      ioThreadQuota: (() { final guardedValue = map['ioThreadQuota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      ...
      quota: (() { final guardedValue = map['quota']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
      shares: (() { final guardedValue = map['shares']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as double); })(),
