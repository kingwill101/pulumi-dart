...
class DomainDevicesAudioNoneOutputSettings {
  ...
  /// Creates a new [DomainDevicesAudioNoneOutputSettings].
  ...
  const DomainDevicesAudioNoneOutputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioNoneOutputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioNoneOutputSettings(
