...
class DomainDevicesDiskMirrorSourceNetworkAuthSecret {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceNetworkAuthSecret].
  ...
  const DomainDevicesDiskMirrorSourceNetworkAuthSecret({
    this.type,
    this.usage,
    this.uuid,
  });
  ...
  factory DomainDevicesDiskMirrorSourceNetworkAuthSecret.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceNetworkAuthSecret(
