...
class DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUnixSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUnixSecLabel].
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUnixSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUnixSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceReservationsSourceUnixSecLabel(
