...
class DomainDevicesDiskSourceDataStoreFormatMetadataCache {
  ...
  DomainDevicesDiskSourceDataStoreFormatMetadataCache({this.maxSize});
  ...
  factory DomainDevicesDiskSourceDataStoreFormatMetadataCache.fromMap(
    ...
    return DomainDevicesDiskSourceDataStoreFormatMetadataCache(
      maxSize: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskSourceDataStoreFormatMetadataCacheMaxSize.fromMap(
