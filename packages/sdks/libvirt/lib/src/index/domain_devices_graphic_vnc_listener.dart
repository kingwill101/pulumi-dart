...
class DomainDevicesGraphicVncListener {
  ...
  DomainDevicesGraphicVncListener({this.address, this.network, this.socket});
    ...
    return DomainDevicesGraphicVncListener(
      address: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesGraphicVncListenerAddress.fromMap(
      ...
      network: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicVncListenerNetwork.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      socket: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          DomainDevicesGraphicVncListenerSocket.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
