...
class DomainDevicesDiskBackingStoreSourceDataStore {
  ...
  final pulumi.Input<DomainDevicesDiskBackingStoreSourceDataStoreFormat>?
  format;
  ...
  DomainDevicesDiskBackingStoreSourceDataStore({this.format});
  ...
  factory DomainDevicesDiskBackingStoreSourceDataStore.fromMap(
    ...
    return DomainDevicesDiskBackingStoreSourceDataStore(
      format: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskBackingStoreSourceDataStoreFormat.fromMap(
