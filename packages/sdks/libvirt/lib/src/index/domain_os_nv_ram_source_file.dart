...
class DomainOsNvRamSourceFile {
  ...
  DomainOsNvRamSourceFile({this.fdGroup, this.file, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceFileSecLabel>,
    ...
    return DomainOsNvRamSourceFile(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsNvRamSourceFileSecLabel>(
            guardedValue,
            (value) => DomainOsNvRamSourceFileSecLabel.fromMap(
