...
class DomainDevicesSmartcardPassthroughNmdm {
  ...
  /// Creates a new [DomainDevicesSmartcardPassthroughNmdm].
  ...
  const DomainDevicesSmartcardPassthroughNmdm({
  ...
  factory DomainDevicesSmartcardPassthroughNmdm.fromMap(Map<String, dynamic> map) {
    return DomainDevicesSmartcardPassthroughNmdm(
