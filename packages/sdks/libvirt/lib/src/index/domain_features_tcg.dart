...
class DomainFeaturesTcg {
  ...
  DomainFeaturesTcg({this.tbCache, this.tbCacheUnit});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{'tbCache': ?tbCache, 'tbCacheUnit': ?tbCacheUnit};
  }

  factory DomainFeaturesTcg.fromMap(Map<String, dynamic> map) {
    return DomainFeaturesTcg(
      tbCache: (() {
        final guardedValue = map['tbCache'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as double);
      })(),
      tbCacheUnit: (() {
        final guardedValue = map['tbCacheUnit'];
        if (guardedValue == null) return null;
