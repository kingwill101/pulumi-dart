...
class DomainDevicesDiskMirrorSourceBlock {
  ...
  final pulumi.Input<List<DomainDevicesDiskMirrorSourceBlockSecLabel>>?
  secLabels;
  ...
  DomainDevicesDiskMirrorSourceBlock({this.dev, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskMirrorSourceBlockSecLabel>,
    ...
    return DomainDevicesDiskMirrorSourceBlock(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskMirrorSourceBlockSecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskMirrorSourceBlockSecLabel.fromMap(
