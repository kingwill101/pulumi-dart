...
class DomainDevicesInterfaceSourceVhostUserChardevPipe {
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevPipe.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevPipe(
      ...
      secLabels: (() { final guardedValue = map['secLabels']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainDevicesInterfaceSourceVhostUserChardevPipeSecLabel>(guardedValue, (value) => DomainDevicesInterfaceSourceVhostUserChardevPipeSecLabel.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
