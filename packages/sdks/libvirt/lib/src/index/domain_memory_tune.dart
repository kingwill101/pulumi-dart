...
class DomainMemoryTune {
  ...
  factory DomainMemoryTune.fromMap(Map<String, dynamic> map) {
    return DomainMemoryTune(
      hardLimit: (() { final guardedValue = map['hardLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      minGuarantee: (() { final guardedValue = map['minGuarantee']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      softLimit: (() { final guardedValue = map['softLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
      ...
      swapHardLimit: (() { final guardedValue = map['swapHardLimit']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as num).toDouble()); })(),
