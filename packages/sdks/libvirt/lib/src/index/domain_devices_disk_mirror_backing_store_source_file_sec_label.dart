...
class DomainDevicesDiskMirrorBackingStoreSourceFileSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorBackingStoreSourceFileSecLabel].
  ...
  const DomainDevicesDiskMirrorBackingStoreSourceFileSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceFileSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorBackingStoreSourceFileSecLabel(
