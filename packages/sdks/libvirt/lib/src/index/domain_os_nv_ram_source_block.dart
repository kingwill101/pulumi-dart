...
class DomainOsNvRamSourceBlock {
  ...
  DomainOsNvRamSourceBlock({this.dev, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainOsNvRamSourceBlockSecLabel>,
    ...
    return DomainOsNvRamSourceBlock(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainOsNvRamSourceBlockSecLabel>(
            guardedValue,
            (value) => DomainOsNvRamSourceBlockSecLabel.fromMap(
