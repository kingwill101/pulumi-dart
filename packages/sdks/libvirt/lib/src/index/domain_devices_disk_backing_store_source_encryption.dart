...
class DomainDevicesDiskBackingStoreSourceEncryption {
  ...
  final pulumi.Input<List<DomainDevicesDiskBackingStoreSourceEncryptionSecret>>?
  secrets;
    ...
    return <String, dynamic>{
      ...
      'secrets':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskBackingStoreSourceEncryptionSecret>,
  ...
  factory DomainDevicesDiskBackingStoreSourceEncryption.fromMap(
      ...
      secrets: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                DomainDevicesDiskBackingStoreSourceEncryptionSecret.fromMap(
