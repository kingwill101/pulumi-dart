...
import 'domain_devices_rng_backend_egd_source_tcp_reconnect.dart';

class DomainDevicesRngBackendEgdSourceTcp {
  ...
  final pulumi.Input<DomainDevicesRngBackendEgdSourceTcpReconnect>? reconnect;
  ...
  /// Creates a new [DomainDevicesRngBackendEgdSourceTcp].
  ...
  const DomainDevicesRngBackendEgdSourceTcp({
    this.host,
    this.mode,
    this.reconnect,
    this.service,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'mode': ?mode,
      'reconnect': ?pulumi.Input.mapOptionalInputValue<DomainDevicesRngBackendEgdSourceTcpReconnect, Map<String, dynamic>>(reconnect, (value) => value.toMap()),
      'service': ?service,
      'tls': ?tls,
    };
  }

  factory DomainDevicesRngBackendEgdSourceTcp.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackendEgdSourceTcp(
      host: (() { final guardedValue = map['host']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      mode: (() { final guardedValue = map['mode']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as String); })(),
      reconnect: (() { final guardedValue = map['reconnect']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DomainDevicesRngBackendEgdSourceTcpReconnect.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
