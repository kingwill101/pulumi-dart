...
class DomainDevicesChannelSourceUnix {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesChannelSourceUnixSecLabel>,
    ...
    return DomainDevicesChannelSourceUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesChannelSourceUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesChannelSourceUnixSecLabel>(
            guardedValue,
            (value) => DomainDevicesChannelSourceUnixSecLabel.fromMap(
