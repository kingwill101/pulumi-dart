...
class DomainDevicesDiskMirrorSourceReservationsSourceDevSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceReservationsSourceDevSecLabel].
  ...
  const DomainDevicesDiskMirrorSourceReservationsSourceDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceReservationsSourceDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceReservationsSourceDevSecLabel(
