...
class DomainDevicesParallelSourcePty {
  ...
  DomainDevicesParallelSourcePty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesParallelSourcePtySecLabel>,
    ...
    return DomainDevicesParallelSourcePty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesParallelSourcePtySecLabel>(
            guardedValue,
            (value) => DomainDevicesParallelSourcePtySecLabel.fromMap(
