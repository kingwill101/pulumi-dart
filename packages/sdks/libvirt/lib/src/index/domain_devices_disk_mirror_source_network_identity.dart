...
class DomainDevicesDiskMirrorSourceNetworkIdentity {
  ...
  const DomainDevicesDiskMirrorSourceNetworkIdentity({
    this.agentSock,
    this.group,
    this.keyfile,
    this.user,
  ...
  factory DomainDevicesDiskMirrorSourceNetworkIdentity.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceNetworkIdentity(
