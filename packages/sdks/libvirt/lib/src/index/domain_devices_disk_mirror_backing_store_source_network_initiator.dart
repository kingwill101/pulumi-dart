...
class DomainDevicesDiskMirrorBackingStoreSourceNetworkInitiator {
  ...
  DomainDevicesDiskMirrorBackingStoreSourceNetworkInitiator({this.iqn});
  ...
  factory DomainDevicesDiskMirrorBackingStoreSourceNetworkInitiator.fromMap(
    ...
    return DomainDevicesDiskMirrorBackingStoreSourceNetworkInitiator(
      iqn: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskMirrorBackingStoreSourceNetworkInitiatorIqn.fromMap(
