...
class DomainDevicesRngBackendEgdSourcePtySecLabel {
  ...
  /// Creates a new [DomainDevicesRngBackendEgdSourcePtySecLabel].
  ...
  const DomainDevicesRngBackendEgdSourcePtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesRngBackendEgdSourcePtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesRngBackendEgdSourcePtySecLabel(
