...
class DomainDevicesChannelSourcePty {
  ...
  DomainDevicesChannelSourcePty({required this.path, this.secLabels});
    ...
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesChannelSourcePtySecLabel>,
    ...
    return DomainDevicesChannelSourcePty(
      ...
      secLabels: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesChannelSourcePtySecLabel>(
            guardedValue,
            (value) => DomainDevicesChannelSourcePtySecLabel.fromMap(
