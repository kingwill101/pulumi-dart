...
class DomainDevicesDiskBackingStoreSourceVhostUserDevSecLabel {
  ...
  /// Creates a new [DomainDevicesDiskBackingStoreSourceVhostUserDevSecLabel].
  ...
  const DomainDevicesDiskBackingStoreSourceVhostUserDevSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskBackingStoreSourceVhostUserDevSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskBackingStoreSourceVhostUserDevSecLabel(
