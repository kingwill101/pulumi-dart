...
class DomainDevicesAudioAlsaInputSettings {
  ...
  /// Creates a new [DomainDevicesAudioAlsaInputSettings].
  ...
  const DomainDevicesAudioAlsaInputSettings({
    this.channels,
    this.format,
    this.frequency,
  });
  ...
  factory DomainDevicesAudioAlsaInputSettings.fromMap(Map<String, dynamic> map) {
    return DomainDevicesAudioAlsaInputSettings(
