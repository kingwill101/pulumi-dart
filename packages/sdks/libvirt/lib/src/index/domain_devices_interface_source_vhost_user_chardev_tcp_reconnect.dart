...
class DomainDevicesInterfaceSourceVhostUserChardevTcpReconnect {
  ...
  /// Creates a new [DomainDevicesInterfaceSourceVhostUserChardevTcpReconnect].
  ...
  const DomainDevicesInterfaceSourceVhostUserChardevTcpReconnect({
  ...
  factory DomainDevicesInterfaceSourceVhostUserChardevTcpReconnect.fromMap(Map<String, dynamic> map) {
    return DomainDevicesInterfaceSourceVhostUserChardevTcpReconnect(
