...
class DomainOsNvRamSourceVhostUserPipeSecLabel {
  ...
  /// Creates a new [DomainOsNvRamSourceVhostUserPipeSecLabel].
  ...
  const DomainOsNvRamSourceVhostUserPipeSecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainOsNvRamSourceVhostUserPipeSecLabel.fromMap(Map<String, dynamic> map) {
    return DomainOsNvRamSourceVhostUserPipeSecLabel(
