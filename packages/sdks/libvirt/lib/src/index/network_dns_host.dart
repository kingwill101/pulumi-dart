...
class NetworkDnsHost {
  ...
  NetworkDnsHost({this.hostnames, required this.ip});

  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'hostnames':
          ?pulumi.Input.mapOptionalInputValue<
            List<NetworkDnsHostHostname>,
    ...
    return NetworkDnsHost(
      hostnames: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<NetworkDnsHostHostname>(
            guardedValue,
            (value) => NetworkDnsHostHostname.fromMap(
