...
class DomainDevicesDiskMirrorSourceVhostUserPtySecLabel {
  ...
  /// Creates a new [DomainDevicesDiskMirrorSourceVhostUserPtySecLabel].
  ...
  const DomainDevicesDiskMirrorSourceVhostUserPtySecLabel({
    this.label,
    this.labelSkip,
    this.model,
    this.relabel,
  ...
  factory DomainDevicesDiskMirrorSourceVhostUserPtySecLabel.fromMap(Map<String, dynamic> map) {
    return DomainDevicesDiskMirrorSourceVhostUserPtySecLabel(
