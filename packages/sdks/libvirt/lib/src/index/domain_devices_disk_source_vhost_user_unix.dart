...
class DomainDevicesDiskSourceVhostUserUnix {
  ...
  final pulumi.Input<List<DomainDevicesDiskSourceVhostUserUnixSecLabel>>?
  secLabels;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'secLabels':
          ?pulumi.Input.mapOptionalInputValue<
            List<DomainDevicesDiskSourceVhostUserUnixSecLabel>,
  ...
  factory DomainDevicesDiskSourceVhostUserUnix.fromMap(
    ...
    return DomainDevicesDiskSourceVhostUserUnix(
      ...
      reconnect: (() {
        ...
        return pulumi.Input.fromValue(
          DomainDevicesDiskSourceVhostUserUnixReconnect.fromMap(
      ...
      secLabels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<DomainDevicesDiskSourceVhostUserUnixSecLabel>(
            guardedValue,
            (value) => DomainDevicesDiskSourceVhostUserUnixSecLabel.fromMap(
