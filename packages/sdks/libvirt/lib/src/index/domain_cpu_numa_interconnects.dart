...
class DomainCpuNumaInterconnects {
  ...
  factory DomainCpuNumaInterconnects.fromMap(Map<String, dynamic> map) {
    return DomainCpuNumaInterconnects(
      bandwidths: (() { final guardedValue = map['bandwidths']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuNumaInterconnectsBandwidth>(guardedValue, (value) => DomainCpuNumaInterconnectsBandwidth.fromMap((value as Map).cast<String, dynamic>()))); })(),
      latencies: (() { final guardedValue = map['latencies']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<DomainCpuNumaInterconnectsLatency>(guardedValue, (value) => DomainCpuNumaInterconnectsLatency.fromMap((value as Map).cast<String, dynamic>()))); })(),
    );
  }
}
