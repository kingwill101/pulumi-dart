...
class PrivateKey extends pulumi.CustomResource {
  ...
  PrivateKey(
    ...
    this.ecdsaCurve = registerOutput<String>('ecdsaCurve');
    this.privateKeyOpenssh = registerOutput<String>('privateKeyOpenssh');
    this.privateKeyPem = registerOutput<String>('privateKeyPem');
    this.privateKeyPemPkcs8 = registerOutput<String>('privateKeyPemPkcs8');
    this.publicKeyFingerprintMd5 = registerOutput<String>('publicKeyFingerprintMd5');
    this.publicKeyFingerprintSha256 = registerOutput<String>('publicKeyFingerprintSha256');
    this.publicKeyOpenssh = registerOutput<String>('publicKeyOpenssh');
    this.publicKeyPem = registerOutput<String>('publicKeyPem');
    this.rsaBits = registerOutput<int>('rsaBits');
  }
