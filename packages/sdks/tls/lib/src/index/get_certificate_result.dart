...
class GetCertificateResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'certificates': ?(() { final guardedValue = certificates; if (guardedValue == null) return null; return pulumi.Input.encodeList<GetCertificateCertificate, Map<String, dynamic>>(guardedValue, (value) => value.toMap()); })(),
      'content': ?content,
      'id': ?id,
      'url': ?url,
  ...
  factory GetCertificateResult.fromMap(Map<String, dynamic> map) {
    return GetCertificateResult(
      certificates: (() { final guardedValue = map['certificates']; if (guardedValue == null) return null; return pulumi.Input.decodeList<GetCertificateCertificate>(guardedValue, (value) => GetCertificateCertificate.fromMap((value as Map).cast<String, dynamic>())); })(),
      ...
      verifyChain: (() { final guardedValue = map['verifyChain']; if (guardedValue == null) return null; return guardedValue as bool; })(),
    );
  }
}
