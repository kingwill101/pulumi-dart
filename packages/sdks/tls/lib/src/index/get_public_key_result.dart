...
class GetPublicKeyResult {
  ...
  /// [publicKeyFingerprintMd5] The fingerprint of the public key data in OpenSSH MD5 hash format, e.g. `aa:bb:cc:...`. Only available if the selected private key format is compatible, as per the rules for `publicKeyOpenssh` and ECDSA P224 limitations.
  /// [publicKeyFingerprintSha256] The fingerprint of the public key data in OpenSSH SHA256 hash format, e.g. `SHA256:...`. Only available if the selected private key format is compatible, as per the rules for `publicKeyOpenssh` and ECDSA P224 limitations.
  ...
  factory GetPublicKeyResult.fromMap(Map<String, dynamic> map) {
    return GetPublicKeyResult(
      ...
      privateKeyOpenssh: (() { final guardedValue = map['privateKeyOpenssh']; if (guardedValue == null) return null; return guardedValue as String; })(),
      privateKeyPem: (() { final guardedValue = map['privateKeyPem']; if (guardedValue == null) return null; return guardedValue as String; })(),
      publicKeyFingerprintMd5: (() { final guardedValue = map['publicKeyFingerprintMd5']; if (guardedValue == null) return null; return guardedValue as String; })(),
      publicKeyFingerprintSha256: (() { final guardedValue = map['publicKeyFingerprintSha256']; if (guardedValue == null) return null; return guardedValue as String; })(),
