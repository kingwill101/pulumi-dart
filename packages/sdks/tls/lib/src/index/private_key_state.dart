...
class PrivateKeyState {
  ...
  factory PrivateKeyState.fromMap(Map<String, dynamic> map) {
    return PrivateKeyState(
      ...
      privateKeyPemPkcs8: (() {
        final guardedValue = map['privateKeyPemPkcs8'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publicKeyFingerprintMd5: (() {
        final guardedValue = map['publicKeyFingerprintMd5'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publicKeyFingerprintSha256: (() {
        final guardedValue = map['publicKeyFingerprintSha256'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publicKeyOpenssh: (() {
        final guardedValue = map['publicKeyOpenssh'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      publicKeyPem: (() {
