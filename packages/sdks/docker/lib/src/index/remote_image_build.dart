...
class RemoteImageBuild {
  ...
  factory RemoteImageBuild.fromMap(Map<String, dynamic> map) {
    return RemoteImageBuild(
      ...
      authConfigs: (() { final guardedValue = map['authConfigs']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RemoteImageBuildAuthConfig>(guardedValue, (value) => RemoteImageBuildAuthConfig.fromMap((value as Map).cast<String, dynamic>()))); })(),
      ...
      ulimits: (() { final guardedValue = map['ulimits']; if (guardedValue == null) return null; return pulumi.Input.fromValue(pulumi.Input.decodeList<RemoteImageBuildUlimit>(guardedValue, (value) => RemoteImageBuildUlimit.fromMap((value as Map).cast<String, dynamic>()))); })(),
