    ...
    return <String, dynamic>{
      ...
      'authConfigs':
          ?pulumi.Input.mapOptionalInputValue<
            List<RemoteImageBuildAuthConfig>,
    ...
    return RemoteImageBuild(
      ...
      authConfigs: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RemoteImageBuildAuthConfig>(
            guardedValue,
            (value) => RemoteImageBuildAuthConfig.fromMap(
      ...
      secrets: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RemoteImageBuildSecret>(
            guardedValue,
            (value) => RemoteImageBuildSecret.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
      ...
      ulimits: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<RemoteImageBuildUlimit>(
            guardedValue,
            (value) => RemoteImageBuildUlimit.fromMap(
              (value as Map).cast<String, dynamic>(),
            ),
          ),
        );
