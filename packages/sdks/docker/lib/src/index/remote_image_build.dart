...
class RemoteImageBuild {
  ...
  final List<RemoteImageBuildAuthConfig>? authConfigs;
  ...
  final List<RemoteImageBuildSecret>? secrets;
  ...
  final List<RemoteImageBuildUlimit>? ulimits;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'authConfigs': ?authConfigs == null ? null : pulumi.Input.encodeList<RemoteImageBuildAuthConfig, Map<String, dynamic>>(authConfigs!, (value) => value.toMap()),
      'buildArgs': ?buildArgs,
      'buildId': ?buildId,
      ...
      'remove': ?remove,
      'secrets': ?secrets == null ? null : pulumi.Input.encodeList<RemoteImageBuildSecret, Map<String, dynamic>>(secrets!, (value) => value.toMap()),
      ...
      'tags': ?tags,
      'target': ?target,
      'ulimits': ?ulimits == null ? null : pulumi.Input.encodeList<RemoteImageBuildUlimit, Map<String, dynamic>>(ulimits!, (value) => value.toMap()),
      'version': ?version,
    };
  }
  ...
  factory RemoteImageBuild.fromMap(Map<String, dynamic> map) {
    return RemoteImageBuild(
      ...
      authConfigs: map['authConfigs'] == null ? null : pulumi.Input.decodeList<RemoteImageBuildAuthConfig>(map['authConfigs'], (value) => RemoteImageBuildAuthConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      secrets: map['secrets'] == null ? null : pulumi.Input.decodeList<RemoteImageBuildSecret>(map['secrets'], (value) => RemoteImageBuildSecret.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ulimits: map['ulimits'] == null ? null : pulumi.Input.decodeList<RemoteImageBuildUlimit>(map['ulimits'], (value) => RemoteImageBuildUlimit.fromMap((value as Map).cast<String, dynamic>())),
