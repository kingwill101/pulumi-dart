...
class ServiceState {
  ...
  ServiceState({
    ...
    pulumi.Output<ServiceTaskSpec>? taskSpec,
    pulumi.Output<ServiceUpdateConfig>? updateConfig,
      ...
      taskSpec = pulumi.Input.asOptionalInput<ServiceTaskSpec>(taskSpec),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taskSpec': ?pulumi.Input.mapOptionalInputValue<ServiceTaskSpec, Map<String, dynamic>>(taskSpec, (value) => value.toMap()),
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      taskSpec: map['taskSpec'] == null ? null : pulumi.Output.create<ServiceTaskSpec>(ServiceTaskSpec.fromMap((map['taskSpec'] as Map).cast<String, dynamic>())),
