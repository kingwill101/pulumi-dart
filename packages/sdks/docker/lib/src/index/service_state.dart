...
class ServiceState {
  ...
  factory ServiceState.fromMap(Map<String, dynamic> map) {
    return ServiceState(
      ...
      taskSpec: (() { final guardedValue = map['taskSpec']; if (guardedValue == null) return null; return pulumi.Input.fromValue(ServiceTaskSpec.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
