    ...
    return <String, dynamic>{
      ...
      'convergeConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(convergeConfig, (value) => value.toMap()),
      'endpointSpec':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceEndpointSpec,
            Map<String, dynamic>
          >(endpointSpec, (value) => value.toMap()),
      'labels':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceLabel>,
          ...
          >(
            labels,
            (value) =>
                pulumi.Input.encodeList<ServiceLabel, Map<String, dynamic>>(
                  value,
                  (value) => value.toMap(),
                ),
          ),
      'mode':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceMode,
            Map<String, dynamic>
          >(mode, (value) => value.toMap()),
      'name': ?name,
      'rollbackConfig':
          ?pulumi.Input.mapOptionalInputValue<
            ServiceRollbackConfig,
            Map<String, dynamic>
          >(rollbackConfig, (value) => value.toMap()),
      'taskSpec':
          pulumi.Input.mapInputValue<ServiceTaskSpec, Map<String, dynamic>>(
            taskSpec,
            (value) => value.toMap(),
          ),
      'updateConfig':
    ...
    return ServiceArgs(
      auth: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceAuth.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      convergeConfig: (() {
        final guardedValue = map['convergeConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceConvergeConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      endpointSpec: (() {
        final guardedValue = map['endpointSpec'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceEndpointSpec.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      labels: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceLabel>(
            guardedValue,
            (value) =>
                ServiceLabel.fromMap((value as Map).cast<String, dynamic>()),
          ),
        );
      })(),
      mode: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceMode.fromMap((guardedValue as Map).cast<String, dynamic>()),
        );
      })(),
      name: (() {
      ...
      rollbackConfig: (() {
        final guardedValue = map['rollbackConfig'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceRollbackConfig.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      taskSpec: pulumi.Input.fromValue(
        ServiceTaskSpec.fromMap(
