...
class ServiceTaskSpecContainerSpecMountVolumeOptions {
  ...
  final pulumi.Input<List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabel>>?
  labels;
    ...
    return <String, dynamic>{
      ...
      'labels':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTaskSpecContainerSpecMountVolumeOptionsLabel>,
  ...
  factory ServiceTaskSpecContainerSpecMountVolumeOptions.fromMap(
      ...
      labels: (() {
        ...
        return pulumi.Input.fromValue(
          ...
          >(
            guardedValue,
            (value) =>
                ServiceTaskSpecContainerSpecMountVolumeOptionsLabel.fromMap(
