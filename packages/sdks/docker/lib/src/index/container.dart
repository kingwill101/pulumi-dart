...
class Container extends pulumi.CustomResource {
  ...
  Container(
    ...
    this.attach = registerOutput<bool?>('attach');
    this.bridge = registerOutput<String>('bridge');
    this.capabilities = registerOutput<ContainerCapabilities?>('capabilities');
    this.cgroupParent = registerOutput<String?>('cgroupParent');
    this.cgroupnsMode = registerOutput<String?>('cgroupnsMode');
    this.command = registerOutput<List<String>>('command');
    this.containerLogs = registerOutput<String>('containerLogs');
    this.containerReadRefreshTimeoutMilliseconds = registerOutput<int?>('containerReadRefreshTimeoutMilliseconds');
    this.cpuPeriod = registerOutput<int?>('cpuPeriod');
    this.cpuQuota = registerOutput<int?>('cpuQuota');
    this.cpuSet = registerOutput<String?>('cpuSet');
    this.cpuShares = registerOutput<int?>('cpuShares');
    this.cpus = registerOutput<String?>('cpus');
    this.destroyGraceSeconds = registerOutput<int?>('destroyGraceSeconds');
    this.devices = registerOutput<List<ContainerDevice>?>('devices');
    this.dns = registerOutput<List<String>?>('dns');
    this.dnsOpts = registerOutput<List<String>?>('dnsOpts');
    this.dnsSearches = registerOutput<List<String>?>('dnsSearches');
    this.domainname = registerOutput<String?>('domainname');
    this.entrypoints = registerOutput<List<String>>('entrypoints');
    this.envs = registerOutput<List<String>>('envs');
    this.exitCode = registerOutput<int>('exitCode');
    this.gpus = registerOutput<String?>('gpus');
    this.groupAdds = registerOutput<List<String>?>('groupAdds');
    this.healthcheck = registerOutput<ContainerHealthcheck>('healthcheck');
    this.hostname = registerOutput<String>('hostname');
    this.hosts = registerOutput<List<ContainerHost>?>('hosts');
    this.image = registerOutput<String>('image');
    this.init = registerOutput<bool>('init');
    this.ipcMode = registerOutput<String>('ipcMode');
    this.labels = registerOutput<List<ContainerLabel>>('labels');
    this.logDriver = registerOutput<String>('logDriver');
    this.logOpts = registerOutput<Map<String, String>?>('logOpts');
    this.logs = registerOutput<bool?>('logs');
    this.maxRetryCount = registerOutput<int?>('maxRetryCount');
    this.memory = registerOutput<int?>('memory');
    this.memoryReservation = registerOutput<int?>('memoryReservation');
    this.memorySwap = registerOutput<int?>('memorySwap');
    this.mounts = registerOutput<List<ContainerMount>?>('mounts');
    this.mustRun = registerOutput<bool?>('mustRun');
    this.name = registerOutput<String>('name');
    this.networkDatas = registerOutput<List<ContainerNetworkData>>('networkDatas');
    this.networkMode = registerOutput<String?>('networkMode');
    this.networksAdvanced = registerOutput<List<ContainerNetworksAdvanced>?>('networksAdvanced');
    this.pidMode = registerOutput<String?>('pidMode');
    this.ports = registerOutput<List<ContainerPort>?>('ports');
    this.privileged = registerOutput<bool?>('privileged');
    this.publishAllPorts = registerOutput<bool?>('publishAllPorts');
    this.readOnly = registerOutput<bool?>('readOnly');
    this.removeVolumes = registerOutput<bool?>('removeVolumes');
    this.restart = registerOutput<String?>('restart');
    this.rm = registerOutput<bool?>('rm');
    this.runtime = registerOutput<String>('runtime');
    this.securityOpts = registerOutput<List<String>>('securityOpts');
    this.shmSize = registerOutput<int>('shmSize');
    this.start = registerOutput<bool?>('start');
    this.stdinOpen = registerOutput<bool?>('stdinOpen');
    this.stopSignal = registerOutput<String>('stopSignal');
    this.stopTimeout = registerOutput<int>('stopTimeout');
    this.storageOpts = registerOutput<Map<String, String>?>('storageOpts');
    this.sysctls = registerOutput<Map<String, String>?>('sysctls');
    this.tmpfs = registerOutput<Map<String, String>?>('tmpfs');
    this.tty = registerOutput<bool?>('tty');
    this.ulimits = registerOutput<List<ContainerUlimit>?>('ulimits');
    this.uploads = registerOutput<List<ContainerUpload>?>('uploads');
    this.user = registerOutput<String?>('user');
    this.usernsMode = registerOutput<String?>('usernsMode');
    this.volumes = registerOutput<List<ContainerVolume>?>('volumes');
    this.wait = registerOutput<bool?>('wait');
