...
class ContainerNetworkData {
  ...
  factory ContainerNetworkData.fromMap(Map<String, dynamic> map) {
    return ContainerNetworkData(
      ...
      globalIpv6Address: (() {
        final guardedValue = map['globalIpv6Address'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      globalIpv6PrefixLength: (() {
        final guardedValue = map['globalIpv6PrefixLength'];
        if (guardedValue == null) return null;
      ...
      ipPrefixLength: (() {
        final guardedValue = map['ipPrefixLength'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as int);
      })(),
      ipv6Gateway: (() {
        final guardedValue = map['ipv6Gateway'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      macAddress: (() {
