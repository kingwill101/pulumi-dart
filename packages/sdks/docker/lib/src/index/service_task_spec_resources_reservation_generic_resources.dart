...
class ServiceTaskSpecResourcesReservationGenericResources {
  ...
  factory ServiceTaskSpecResourcesReservationGenericResources.fromMap(Map<String, dynamic> map) {
    return ServiceTaskSpecResourcesReservationGenericResources(
      discreteResourcesSpecs: (() { final guardedValue = map['discreteResourcesSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
      namedResourcesSpecs: (() { final guardedValue = map['namedResourcesSpecs']; if (guardedValue == null) return null; return pulumi.Input.fromValue((guardedValue as List).cast<String>()); })(),
    );
  }
}
