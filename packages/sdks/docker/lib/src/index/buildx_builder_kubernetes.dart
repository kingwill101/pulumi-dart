    ...
    return BuildxBuilderKubernetes(
      ...
      limits: (() {
        ...
        return pulumi.Input.fromValue(
          BuildxBuilderKubernetesLimits.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      loadbalance: (() {
        final guardedValue = map['loadbalance'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as String);
      })(),
      namespace: (() {
      ...
      qemu: (() {
        final guardedValue = map['qemu'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BuildxBuilderKubernetesQemu.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      ...
      requests: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          BuildxBuilderKubernetesRequests.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      rootless: (() {
        final guardedValue = map['rootless'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(guardedValue as bool);
      })(),
      schedulername: (() {
