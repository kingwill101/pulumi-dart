...
class ImageArgs {
  ...
  factory ImageArgs.fromMap(Map<String, dynamic> map) {
    return ImageArgs(
      build: (() { final guardedValue = map['build']; if (guardedValue == null) return null; return pulumi.Input.fromValue(DockerBuild.fromMap((guardedValue as Map).cast<String, dynamic>())); })(),
      ...
      skipPush: (() { final guardedValue = map['skipPush']; if (guardedValue == null) return null; return pulumi.Input.fromValue(guardedValue as bool); })(),
    );
  }
}
