...
class ServiceEndpointSpec {
  ...
  ServiceEndpointSpec({this.mode, this.ports});
    ...
    return ServiceEndpointSpec(
      ...
      ports: (() {
        ...
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceEndpointSpecPort>(
            guardedValue,
            (value) => ServiceEndpointSpecPort.fromMap(
