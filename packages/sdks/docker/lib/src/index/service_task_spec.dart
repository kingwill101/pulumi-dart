    ...
    return <String, dynamic>{
      ...
      'logDriver':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(logDriver, (value) => value.toMap()),
      'networksAdvanceds':
          ?pulumi.Input.mapOptionalInputValue<
            List<ServiceTaskSpecNetworksAdvanced>,
      ...
      'restartPolicy':
          ?pulumi.Input.mapOptionalInputValue<
            ...
            Map<String, dynamic>
          >(restartPolicy, (value) => value.toMap()),
      'runtime': ?runtime,
    };
  }
  ...
  factory ServiceTaskSpec.fromMap(Map<String, dynamic> map) {
    return ServiceTaskSpec(
      containerSpec: pulumi.Input.fromValue(
        ServiceTaskSpecContainerSpec.fromMap(
      ...
      logDriver: (() {
        ...
        return pulumi.Input.fromValue(
          ServiceTaskSpecLogDriver.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      networksAdvanceds: (() {
        final guardedValue = map['networksAdvanceds'];
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          pulumi.Input.decodeList<ServiceTaskSpecNetworksAdvanced>(
            guardedValue,
            (value) => ServiceTaskSpecNetworksAdvanced.fromMap(
      ...
      placement: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceTaskSpecPlacement.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      resources: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceTaskSpecResources.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
      restartPolicy: (() {
        ...
        if (guardedValue == null) return null;
        return pulumi.Input.fromValue(
          ServiceTaskSpecRestartPolicy.fromMap(
            (guardedValue as Map).cast<String, dynamic>(),
          ),
        );
      })(),
