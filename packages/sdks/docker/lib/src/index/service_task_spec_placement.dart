...
class ServiceTaskSpecPlacement {
  ...
  final List<ServiceTaskSpecPlacementPlatform>? platforms;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'platforms': ?platforms == null ? null : pulumi.Input.encodeList<ServiceTaskSpecPlacementPlatform, Map<String, dynamic>>(platforms!, (value) => value.toMap()),
      'prefs': ?prefs,
    };
  }
  ...
  factory ServiceTaskSpecPlacement.fromMap(Map<String, dynamic> map) {
    return ServiceTaskSpecPlacement(
      constraints: map['constraints'] == null ? null : (map['constraints'] as List).cast<String>(),
      maxReplicas: map['maxReplicas'] == null ? null : map['maxReplicas'] as int,
      platforms: map['platforms'] == null ? null : pulumi.Input.decodeList<ServiceTaskSpecPlacementPlatform>(map['platforms'], (value) => ServiceTaskSpecPlacementPlatform.fromMap((value as Map).cast<String, dynamic>())),
      prefs: map['prefs'] == null ? null : (map['prefs'] as List).cast<String>(),
    );
  }
}
