...
class WorkloadArgs {
  ...
  WorkloadArgs({
    String? accountId,
    String? description,
    List<String>? entityGuids,
    List<WorkloadEntitySearchQuery>? entitySearchQueries,
    String? name,
    List<String>? scopeAccountIds,
    WorkloadStatusConfigAutomatic? statusConfigAutomatic,
    WorkloadStatusConfigStatic? statusConfigStatic,
  }) :
  ...
  factory WorkloadArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadArgs(
      ...
      entitySearchQueries: map['entitySearchQueries'] == null ? null : pulumi.Input.decodeList<WorkloadEntitySearchQuery>(map['entitySearchQueries'], (value) => WorkloadEntitySearchQuery.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      scopeAccountIds: map['scopeAccountIds'] == null ? null : (map['scopeAccountIds'] as List).cast<String>(),
      statusConfigAutomatic: map['statusConfigAutomatic'] == null ? null : WorkloadStatusConfigAutomatic.fromMap((map['statusConfigAutomatic'] as Map).cast<String, dynamic>()),
      statusConfigStatic: map['statusConfigStatic'] == null ? null : WorkloadStatusConfigStatic.fromMap((map['statusConfigStatic'] as Map).cast<String, dynamic>()),
    );
  }
}
