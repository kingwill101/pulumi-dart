...
/// {@template pulumi_plugins_application_settings_application_settings_args_doc}
/// The set of arguments for ApplicationSettings.
/// {@endtemplate}
/// {@macro pulumi_plugins_application_settings_application_settings_args_doc}
class ApplicationSettingsArgs {
  ...
  /// Creates a new [ApplicationSettingsArgs].
  ...
  ApplicationSettingsArgs({
    ...
    bool? enableRealUserMonitoring,
    bool? enableSlowSql,
    bool? enableThreadProfiler,
    double? endUserApdexThreshold,
    List<ApplicationSettingsErrorCollector>? errorCollectors,
    String? guid,
    String? name,
    String? tracerType,
    List<ApplicationSettingsTransactionTracer>? transactionTracers,
    bool? useServerSideConfig,
  }) :
  ...
  factory ApplicationSettingsArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationSettingsArgs(
      appApdexThreshold: map['appApdexThreshold'] == null ? null : map['appApdexThreshold'] as double,
      enableRealUserMonitoring: map['enableRealUserMonitoring'] == null ? null : map['enableRealUserMonitoring'] as bool,
      enableSlowSql: map['enableSlowSql'] == null ? null : map['enableSlowSql'] as bool,
      enableThreadProfiler: map['enableThreadProfiler'] == null ? null : map['enableThreadProfiler'] as bool,
      endUserApdexThreshold: map['endUserApdexThreshold'] == null ? null : map['endUserApdexThreshold'] as double,
      errorCollectors: map['errorCollectors'] == null ? null : pulumi.Input.decodeList<ApplicationSettingsErrorCollector>(map['errorCollectors'], (value) => ApplicationSettingsErrorCollector.fromMap((value as Map).cast<String, dynamic>())),
      guid: map['guid'] == null ? null : map['guid'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      tracerType: map['tracerType'] == null ? null : map['tracerType'] as String,
      transactionTracers: map['transactionTracers'] == null ? null : pulumi.Input.decodeList<ApplicationSettingsTransactionTracer>(map['transactionTracers'], (value) => ApplicationSettingsTransactionTracer.fromMap((value as Map).cast<String, dynamic>())),
      useServerSideConfig: map['useServerSideConfig'] == null ? null : map['useServerSideConfig'] as bool,
    );
  }
}
