...
class AzureIntegrationsLoadBalancer {
  /// The data polling interval in seconds
  final int? metricsPollingInterval;
  /// Specify each Resource group associated with the resources that you want to monitor. Filter values are case-sensitive
  final List<String>? resourceGroups;

  /// Creates a new [AzureIntegrationsLoadBalancer].
  ...
  factory AzureIntegrationsLoadBalancer.fromMap(Map<String, dynamic> map) {
    return AzureIntegrationsLoadBalancer(
