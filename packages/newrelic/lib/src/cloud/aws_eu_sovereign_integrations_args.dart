...
class AwsEuSovereignIntegrationsArgs {
  ...
  AwsEuSovereignIntegrationsArgs({
    String? accountId,
    AwsEuSovereignIntegrationsBilling? billing,
    AwsEuSovereignIntegrationsCloudtrail? cloudtrail,
    required String linkedAccountId,
    AwsEuSovereignIntegrationsXRay? xRay,
  }) :
  ...
  factory AwsEuSovereignIntegrationsArgs.fromMap(Map<String, dynamic> map) {
    return AwsEuSovereignIntegrationsArgs(
      ...
      billing: map['billing'] == null ? null : AwsEuSovereignIntegrationsBilling.fromMap((map['billing'] as Map).cast<String, dynamic>()),
      cloudtrail: map['cloudtrail'] == null ? null : AwsEuSovereignIntegrationsCloudtrail.fromMap((map['cloudtrail'] as Map).cast<String, dynamic>()),
      linkedAccountId: map['linkedAccountId'] as String,
      xRay: map['xRay'] == null ? null : AwsEuSovereignIntegrationsXRay.fromMap((map['xRay'] as Map).cast<String, dynamic>()),
    );
  }
}
