...
class GcpIntegrationsArgs {
  ...
  GcpIntegrationsArgs({
    String? accountId,
    GcpIntegrationsAlloyDb? alloyDb,
    GcpIntegrationsAppEngine? appEngine,
    GcpIntegrationsBigQuery? bigQuery,
    GcpIntegrationsBigTable? bigTable,
    GcpIntegrationsComposer? composer,
    GcpIntegrationsDataFlow? dataFlow,
    GcpIntegrationsDataProc? dataProc,
    GcpIntegrationsDataStore? dataStore,
    GcpIntegrationsFireBaseDatabase? fireBaseDatabase,
    GcpIntegrationsFireBaseHosting? fireBaseHosting,
    GcpIntegrationsFireBaseStorage? fireBaseStorage,
    GcpIntegrationsFireStore? fireStore,
    GcpIntegrationsFunctions? functions,
    GcpIntegrationsInterconnect? interconnect,
    GcpIntegrationsKubernetes? kubernetes,
    required String linkedAccountId,
    GcpIntegrationsLoadBalancing? loadBalancing,
    GcpIntegrationsMemCache? memCache,
    GcpIntegrationsPubSub? pubSub,
    GcpIntegrationsRedis? redis,
    GcpIntegrationsRouter? router,
    GcpIntegrationsRun? run,
    GcpIntegrationsSpanner? spanner,
    GcpIntegrationsSql? sql,
    GcpIntegrationsStorage? storage,
    GcpIntegrationsVirtualMachines? virtualMachines,
    GcpIntegrationsVpcAccess? vpcAccess,
  }) :
  ...
  factory GcpIntegrationsArgs.fromMap(Map<String, dynamic> map) {
    return GcpIntegrationsArgs(
      ...
      alloyDb: map['alloyDb'] == null ? null : GcpIntegrationsAlloyDb.fromMap((map['alloyDb'] as Map).cast<String, dynamic>()),
      appEngine: map['appEngine'] == null ? null : GcpIntegrationsAppEngine.fromMap((map['appEngine'] as Map).cast<String, dynamic>()),
      bigQuery: map['bigQuery'] == null ? null : GcpIntegrationsBigQuery.fromMap((map['bigQuery'] as Map).cast<String, dynamic>()),
      bigTable: map['bigTable'] == null ? null : GcpIntegrationsBigTable.fromMap((map['bigTable'] as Map).cast<String, dynamic>()),
      composer: map['composer'] == null ? null : GcpIntegrationsComposer.fromMap((map['composer'] as Map).cast<String, dynamic>()),
      dataFlow: map['dataFlow'] == null ? null : GcpIntegrationsDataFlow.fromMap((map['dataFlow'] as Map).cast<String, dynamic>()),
      dataProc: map['dataProc'] == null ? null : GcpIntegrationsDataProc.fromMap((map['dataProc'] as Map).cast<String, dynamic>()),
      dataStore: map['dataStore'] == null ? null : GcpIntegrationsDataStore.fromMap((map['dataStore'] as Map).cast<String, dynamic>()),
      fireBaseDatabase: map['fireBaseDatabase'] == null ? null : GcpIntegrationsFireBaseDatabase.fromMap((map['fireBaseDatabase'] as Map).cast<String, dynamic>()),
      fireBaseHosting: map['fireBaseHosting'] == null ? null : GcpIntegrationsFireBaseHosting.fromMap((map['fireBaseHosting'] as Map).cast<String, dynamic>()),
      fireBaseStorage: map['fireBaseStorage'] == null ? null : GcpIntegrationsFireBaseStorage.fromMap((map['fireBaseStorage'] as Map).cast<String, dynamic>()),
      fireStore: map['fireStore'] == null ? null : GcpIntegrationsFireStore.fromMap((map['fireStore'] as Map).cast<String, dynamic>()),
      functions: map['functions'] == null ? null : GcpIntegrationsFunctions.fromMap((map['functions'] as Map).cast<String, dynamic>()),
      interconnect: map['interconnect'] == null ? null : GcpIntegrationsInterconnect.fromMap((map['interconnect'] as Map).cast<String, dynamic>()),
      kubernetes: map['kubernetes'] == null ? null : GcpIntegrationsKubernetes.fromMap((map['kubernetes'] as Map).cast<String, dynamic>()),
      linkedAccountId: map['linkedAccountId'] as String,
      loadBalancing: map['loadBalancing'] == null ? null : GcpIntegrationsLoadBalancing.fromMap((map['loadBalancing'] as Map).cast<String, dynamic>()),
      memCache: map['memCache'] == null ? null : GcpIntegrationsMemCache.fromMap((map['memCache'] as Map).cast<String, dynamic>()),
      pubSub: map['pubSub'] == null ? null : GcpIntegrationsPubSub.fromMap((map['pubSub'] as Map).cast<String, dynamic>()),
      redis: map['redis'] == null ? null : GcpIntegrationsRedis.fromMap((map['redis'] as Map).cast<String, dynamic>()),
      router: map['router'] == null ? null : GcpIntegrationsRouter.fromMap((map['router'] as Map).cast<String, dynamic>()),
      run: map['run'] == null ? null : GcpIntegrationsRun.fromMap((map['run'] as Map).cast<String, dynamic>()),
      spanner: map['spanner'] == null ? null : GcpIntegrationsSpanner.fromMap((map['spanner'] as Map).cast<String, dynamic>()),
      sql: map['sql'] == null ? null : GcpIntegrationsSql.fromMap((map['sql'] as Map).cast<String, dynamic>()),
      storage: map['storage'] == null ? null : GcpIntegrationsStorage.fromMap((map['storage'] as Map).cast<String, dynamic>()),
      virtualMachines: map['virtualMachines'] == null ? null : GcpIntegrationsVirtualMachines.fromMap((map['virtualMachines'] as Map).cast<String, dynamic>()),
      vpcAccess: map['vpcAccess'] == null ? null : GcpIntegrationsVpcAccess.fromMap((map['vpcAccess'] as Map).cast<String, dynamic>()),
    );
  }
}
