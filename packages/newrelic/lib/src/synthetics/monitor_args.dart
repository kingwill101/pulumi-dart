...
/// {@template pulumi_synthetics_monitor_monitor_args_doc}
/// The set of arguments for Monitor.
/// {@endtemplate}
/// {@macro pulumi_synthetics_monitor_monitor_args_doc}
class MonitorArgs {
  ...
  MonitorArgs({
    ...
    bool? bypassHeadRequest,
    List<MonitorCustomHeader>? customHeaders,
    String? deviceOrientation,
    String? deviceType,
    List<String>? devices,
    bool? enableScreenshotOnFailureAndScript,
    List<String>? locationsPrivates,
    ...
    List<MonitorTag>? tags,
    bool? treatRedirectAsFailure,
  ...
  factory MonitorArgs.fromMap(Map<String, dynamic> map) {
    return MonitorArgs(
      ...
      bypassHeadRequest: map['bypassHeadRequest'] == null ? null : map['bypassHeadRequest'] as bool,
      customHeaders: map['customHeaders'] == null ? null : pulumi.Input.decodeList<MonitorCustomHeader>(map['customHeaders'], (value) => MonitorCustomHeader.fromMap((value as Map).cast<String, dynamic>())),
      ...
      locationsPrivates: map['locationsPrivates'] == null ? null : (map['locationsPrivates'] as List).cast<String>(),
      ...
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<MonitorTag>(map['tags'], (value) => MonitorTag.fromMap((value as Map).cast<String, dynamic>())),
      treatRedirectAsFailure: map['treatRedirectAsFailure'] == null ? null : map['treatRedirectAsFailure'] as bool,
      type: map['type'] as String,
      uri: map['uri'] == null ? null : map['uri'] as String,
      useUnsupportedLegacyRuntime: map['useUnsupportedLegacyRuntime'] == null ? null : map['useUnsupportedLegacyRuntime'] as bool,
      validationString: map['validationString'] == null ? null : map['validationString'] as String,
      verifySsl: map['verifySsl'] == null ? null : map['verifySsl'] as bool,
    );
  }
}
