...
class CertCheckMonitorArgs {
  ...
  CertCheckMonitorArgs({
    String? accountId,
    required int certificateExpiration,
    ...
    List<CertCheckMonitorTag>? tags,
    bool? useUnsupportedLegacyRuntime,
  }) :
      accountId = pulumi.Input.asOptionalInput<String>(accountId),
      certificateExpiration = pulumi.Input.asInput<int>(certificateExpiration),
  ...
  factory CertCheckMonitorArgs.fromMap(Map<String, dynamic> map) {
    return CertCheckMonitorArgs(
      ...
      certificateExpiration: map['certificateExpiration'] as int,
      ...
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<CertCheckMonitorTag>(map['tags'], (value) => CertCheckMonitorTag.fromMap((value as Map).cast<String, dynamic>())),
