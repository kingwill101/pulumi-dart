...
class ScriptMonitorArgs {
  ...
  ScriptMonitorArgs({
    ...
    List<ScriptMonitorLocationPrivate>? locationPrivates,
  ...
  factory ScriptMonitorArgs.fromMap(Map<String, dynamic> map) {
    return ScriptMonitorArgs(
      ...
      deviceOrientation: map['deviceOrientation'] == null ? null : map['deviceOrientation'] as String,
      ...
      locationPrivates: map['locationPrivates'] == null ? null : pulumi.Input.decodeList<ScriptMonitorLocationPrivate>(map['locationPrivates'], (value) => ScriptMonitorLocationPrivate.fromMap((value as Map).cast<String, dynamic>())),
      ...
      scriptLanguage: map['scriptLanguage'] == null ? null : map['scriptLanguage'] as String,
      status: map['status'] as String,
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<ScriptMonitorTag>(map['tags'], (value) => ScriptMonitorTag.fromMap((value as Map).cast<String, dynamic>())),
