...
class MultiLocationAlertConditionArgs {
  ...
  MultiLocationAlertConditionArgs({
    required MultiLocationAlertConditionCritical critical,
    bool? enabled,
    ...
    MultiLocationAlertConditionWarning? warning,
  }) :
  ...
  factory MultiLocationAlertConditionArgs.fromMap(Map<String, dynamic> map) {
    return MultiLocationAlertConditionArgs(
      critical: MultiLocationAlertConditionCritical.fromMap((map['critical'] as Map).cast<String, dynamic>()),
      ...
      warning: map['warning'] == null ? null : MultiLocationAlertConditionWarning.fromMap((map['warning'] as Map).cast<String, dynamic>()),
    );
  }
}
