...
class BrokenLinksMonitorArgs {
  ...
  BrokenLinksMonitorArgs({
    ...
    List<BrokenLinksMonitorTag>? tags,
    required String uri,
  ...
  factory BrokenLinksMonitorArgs.fromMap(Map<String, dynamic> map) {
    return BrokenLinksMonitorArgs(
      ...
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<BrokenLinksMonitorTag>(map['tags'], (value) => BrokenLinksMonitorTag.fromMap((value as Map).cast<String, dynamic>())),
