...
class OneDashboardPageWidgetBar {
  ...
  final OneDashboardPageWidgetBarInitialSorting? initialSorting;
  ...
  final List<OneDashboardPageWidgetBarNrqlQuery> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final List<OneDashboardPageWidgetBarNullValue>? nullValues;
  ...
  final List<OneDashboardPageWidgetBarUnit>? units;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?colors == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetBarColor, Map<String, dynamic>>(colors!, (value) => value.toMap()),
      'column': column,
      'dataFormats': ?dataFormats == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetBarDataFormat, Map<String, dynamic>>(dataFormats!, (value) => value.toMap()),
      ...
      'nrqlQueries': pulumi.Input.encodeList<OneDashboardPageWidgetBarNrqlQuery, Map<String, dynamic>>(nrqlQueries, (value) => value.toMap()),
      'nullValues': ?nullValues == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetBarNullValue, Map<String, dynamic>>(nullValues!, (value) => value.toMap()),
      'refreshRate': ?refreshRate,
      'row': row,
      'title': title,
      'units': ?units == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetBarUnit, Map<String, dynamic>>(units!, (value) => value.toMap()),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetBar.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetBar(
      colors: map['colors'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetBarColor>(map['colors'], (value) => OneDashboardPageWidgetBarColor.fromMap((value as Map).cast<String, dynamic>())),
      column: map['column'] as int,
      dataFormats: map['dataFormats'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetBarDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetBarDataFormat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      initialSorting: map['initialSorting'] == null ? null : OneDashboardPageWidgetBarInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>()),
      ...
      nrqlQueries: pulumi.Input.decodeList<OneDashboardPageWidgetBarNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetBarNrqlQuery.fromMap((value as Map).cast<String, dynamic>())),
      nullValues: map['nullValues'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetBarNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetBarNullValue.fromMap((value as Map).cast<String, dynamic>())),
      refreshRate: map['refreshRate'] == null ? null : map['refreshRate'] as String,
      row: map['row'] as int,
      title: map['title'] as String,
      units: map['units'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetBarUnit>(map['units'], (value) => OneDashboardPageWidgetBarUnit.fromMap((value as Map).cast<String, dynamic>())),
