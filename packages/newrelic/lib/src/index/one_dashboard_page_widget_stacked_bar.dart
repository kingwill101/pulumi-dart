...
class OneDashboardPageWidgetStackedBar {
  ...
  final List<OneDashboardPageWidgetStackedBarColor>? colors;
  /// (Required) Column position of widget from top left, starting at `1`.
  final int column;
  /// (Optional) A nested block that describes data format. See Nested data_format blocks below for details.
  final List<OneDashboardPageWidgetStackedBarDataFormat>? dataFormats;
  ...
  final OneDashboardPageWidgetStackedBarInitialSorting? initialSorting;
  ...
  final List<OneDashboardPageWidgetStackedBarNrqlQuery> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final List<OneDashboardPageWidgetStackedBarNullValue>? nullValues;
  ...
  final OneDashboardPageWidgetStackedBarTooltip? tooltip;
  /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
  final List<OneDashboardPageWidgetStackedBarUnit>? units;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?colors == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetStackedBarColor, Map<String, dynamic>>(colors!, (value) => value.toMap()),
      'column': column,
      'dataFormats': ?dataFormats == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetStackedBarDataFormat, Map<String, dynamic>>(dataFormats!, (value) => value.toMap()),
      ...
      'nrqlQueries': pulumi.Input.encodeList<OneDashboardPageWidgetStackedBarNrqlQuery, Map<String, dynamic>>(nrqlQueries, (value) => value.toMap()),
      'nullValues': ?nullValues == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetStackedBarNullValue, Map<String, dynamic>>(nullValues!, (value) => value.toMap()),
      'refreshRate': ?refreshRate,
      'row': row,
      'title': title,
      'tooltip': ?tooltip == null ? null : tooltip!.toMap(),
      'units': ?units == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetStackedBarUnit, Map<String, dynamic>>(units!, (value) => value.toMap()),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetStackedBar.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetStackedBar(
      colors: map['colors'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarColor>(map['colors'], (value) => OneDashboardPageWidgetStackedBarColor.fromMap((value as Map).cast<String, dynamic>())),
      column: map['column'] as int,
      dataFormats: map['dataFormats'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetStackedBarDataFormat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      initialSorting: map['initialSorting'] == null ? null : OneDashboardPageWidgetStackedBarInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>()),
      legendEnabled: map['legendEnabled'] == null ? null : map['legendEnabled'] as bool,
      nrqlQueries: pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetStackedBarNrqlQuery.fromMap((value as Map).cast<String, dynamic>())),
      nullValues: map['nullValues'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetStackedBarNullValue.fromMap((value as Map).cast<String, dynamic>())),
      refreshRate: map['refreshRate'] == null ? null : map['refreshRate'] as String,
      row: map['row'] as int,
      title: map['title'] as String,
      tooltip: map['tooltip'] == null ? null : OneDashboardPageWidgetStackedBarTooltip.fromMap((map['tooltip'] as Map).cast<String, dynamic>()),
      units: map['units'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetStackedBarUnit>(map['units'], (value) => OneDashboardPageWidgetStackedBarUnit.fromMap((value as Map).cast<String, dynamic>())),
