...
class OneDashboardPageWidgetPyColor {
  ...
  final List<OneDashboardPageWidgetPyColorSeriesOverride>? seriesOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'color': ?color,
      'seriesOverrides': ?seriesOverrides == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetPyColorSeriesOverride, Map<String, dynamic>>(seriesOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory OneDashboardPageWidgetPyColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetPyColor(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetPyColorSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetPyColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
