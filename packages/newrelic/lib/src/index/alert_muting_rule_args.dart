...
class AlertMutingRuleArgs {
  ...
  AlertMutingRuleArgs({
    String? accountId,
    String? actionOnMutingRuleWindowEnded,
    required AlertMutingRuleCondition condition,
    String? description,
    required bool enabled,
    String? name,
    AlertMutingRuleSchedule? schedule,
  }) :
  ...
  factory AlertMutingRuleArgs.fromMap(Map<String, dynamic> map) {
    return AlertMutingRuleArgs(
      ...
      actionOnMutingRuleWindowEnded: map['actionOnMutingRuleWindowEnded'] == null ? null : map['actionOnMutingRuleWindowEnded'] as String,
      condition: AlertMutingRuleCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enabled: map['enabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      schedule: map['schedule'] == null ? null : AlertMutingRuleSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
    );
  }
}
