...
class GetNotificationDestinationArgs {
  ...
  GetNotificationDestinationArgs({
    ...
    String? id,
    String? name,
    List<GetNotificationDestinationSecureUrl>? secureUrls,
  }) :
  ...
  factory GetNotificationDestinationArgs.fromMap(Map<String, dynamic> map) {
    return GetNotificationDestinationArgs(
      ...
      secureUrls: map['secureUrls'] == null ? null : pulumi.Input.decodeList<GetNotificationDestinationSecureUrl>(map['secureUrls'], (value) => GetNotificationDestinationSecureUrl.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
