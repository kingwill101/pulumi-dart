...
class NrqlAlertConditionTerm {
  ...
  final NrqlAlertConditionTermPrediction? prediction;
  ...
  factory NrqlAlertConditionTerm.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionTerm(
      ...
      prediction: map['prediction'] == null ? null : NrqlAlertConditionTermPrediction.fromMap((map['prediction'] as Map).cast<String, dynamic>()),
