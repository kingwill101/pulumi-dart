...
class OneDashboardPageWidgetTableNullValue {
  ...
  final List<OneDashboardPageWidgetTableNullValueSeriesOverride>? seriesOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nullValue': ?nullValue,
      'seriesOverrides': ?seriesOverrides == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetTableNullValueSeriesOverride, Map<String, dynamic>>(seriesOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory OneDashboardPageWidgetTableNullValue.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetTableNullValue(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetTableNullValueSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetTableNullValueSeriesOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
