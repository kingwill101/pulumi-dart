...
class NrqlAlertConditionWarning {
  ...
  final NrqlAlertConditionWarningPrediction? prediction;
  ...
  factory NrqlAlertConditionWarning.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionWarning(
      ...
      prediction: map['prediction'] == null ? null : NrqlAlertConditionWarningPrediction.fromMap((map['prediction'] as Map).cast<String, dynamic>()),
