...
class OneDashboardPageWidgetTable {
  ...
  final List<OneDashboardPageWidgetTableColor>? colors;
  /// (Required) Column position of widget from top left, starting at `1`.
  final int column;
  /// (Optional) A nested block that describes data format. See Nested data_format blocks below for details.
  final List<OneDashboardPageWidgetTableDataFormat>? dataFormats;
  ...
  final OneDashboardPageWidgetTableInitialSorting? initialSorting;
  ...
  final List<OneDashboardPageWidgetTableNrqlQuery> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final List<OneDashboardPageWidgetTableNullValue>? nullValues;
  ...
  final List<OneDashboardPageWidgetTableThreshold>? thresholds;
  /// (Optional) A human-friendly display string for this value.
  final String title;
  /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
  final List<OneDashboardPageWidgetTableUnit>? units;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?colors == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetTableColor, Map<String, dynamic>>(colors!, (value) => value.toMap()),
      'column': column,
      'dataFormats': ?dataFormats == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetTableDataFormat, Map<String, dynamic>>(dataFormats!, (value) => value.toMap()),
      ...
      'nrqlQueries': pulumi.Input.encodeList<OneDashboardPageWidgetTableNrqlQuery, Map<String, dynamic>>(nrqlQueries, (value) => value.toMap()),
      'nullValues': ?nullValues == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetTableNullValue, Map<String, dynamic>>(nullValues!, (value) => value.toMap()),
      'refreshRate': ?refreshRate,
      'row': row,
      'thresholds': ?thresholds == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetTableThreshold, Map<String, dynamic>>(thresholds!, (value) => value.toMap()),
      'title': title,
      'units': ?units == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetTableUnit, Map<String, dynamic>>(units!, (value) => value.toMap()),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetTable.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetTable(
      colors: map['colors'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetTableColor>(map['colors'], (value) => OneDashboardPageWidgetTableColor.fromMap((value as Map).cast<String, dynamic>())),
      column: map['column'] as int,
      dataFormats: map['dataFormats'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetTableDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetTableDataFormat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      initialSorting: map['initialSorting'] == null ? null : OneDashboardPageWidgetTableInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>()),
      ...
      nrqlQueries: pulumi.Input.decodeList<OneDashboardPageWidgetTableNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetTableNrqlQuery.fromMap((value as Map).cast<String, dynamic>())),
      nullValues: map['nullValues'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetTableNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetTableNullValue.fromMap((value as Map).cast<String, dynamic>())),
      refreshRate: map['refreshRate'] == null ? null : map['refreshRate'] as String,
      row: map['row'] as int,
      thresholds: map['thresholds'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetTableThreshold>(map['thresholds'], (value) => OneDashboardPageWidgetTableThreshold.fromMap((value as Map).cast<String, dynamic>())),
      title: map['title'] as String,
      units: map['units'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetTableUnit>(map['units'], (value) => OneDashboardPageWidgetTableUnit.fromMap((value as Map).cast<String, dynamic>())),
