...
class MonitorDowntimeArgs {
  ...
  MonitorDowntimeArgs({
    String? accountId,
    MonitorDowntimeEndRepeat? endRepeat,
    required String endTime,
    MonitorDowntimeFrequency? frequency,
    List<String>? maintenanceDays,
    required String mode,
    List<String>? monitorGuids,
    String? name,
  ...
  factory MonitorDowntimeArgs.fromMap(Map<String, dynamic> map) {
    return MonitorDowntimeArgs(
      ...
      endRepeat: map['endRepeat'] == null ? null : MonitorDowntimeEndRepeat.fromMap((map['endRepeat'] as Map).cast<String, dynamic>()),
      endTime: map['endTime'] as String,
      frequency: map['frequency'] == null ? null : MonitorDowntimeFrequency.fromMap((map['frequency'] as Map).cast<String, dynamic>()),
      maintenanceDays: map['maintenanceDays'] == null ? null : (map['maintenanceDays'] as List).cast<String>(),
      mode: map['mode'] as String,
      monitorGuids: map['monitorGuids'] == null ? null : (map['monitorGuids'] as List).cast<String>(),
