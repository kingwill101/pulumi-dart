...
class GetTestGrokPatternResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'logLines': logLines,
      'testGroks': pulumi.Input.encodeList<GetTestGrokPatternTestGrok, Map<String, dynamic>>(testGroks, (value) => value.toMap()),
    };
  }
  ...
  factory GetTestGrokPatternResult.fromMap(Map<String, dynamic> map) {
    return GetTestGrokPatternResult(
      ...
      testGroks: pulumi.Input.decodeList<GetTestGrokPatternTestGrok>(map['testGroks'], (value) => GetTestGrokPatternTestGrok.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
