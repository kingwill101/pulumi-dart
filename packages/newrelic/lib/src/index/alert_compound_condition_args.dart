...
class AlertCompoundConditionArgs {
  ...
  AlertCompoundConditionArgs({
    String? accountId,
    required List<AlertCompoundConditionComponentCondition> componentConditions,
    required bool enabled,
    String? facetMatchingBehavior,
    String? name,
    required String policyId,
    String? runbookUrl,
    int? thresholdDuration,
    required String triggerExpression,
  }) :
  ...
  factory AlertCompoundConditionArgs.fromMap(Map<String, dynamic> map) {
    return AlertCompoundConditionArgs(
      ...
      componentConditions: pulumi.Input.decodeList<AlertCompoundConditionComponentCondition>(map['componentConditions'], (value) => AlertCompoundConditionComponentCondition.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] as bool,
      facetMatchingBehavior: map['facetMatchingBehavior'] == null ? null : map['facetMatchingBehavior'] as String,
      ...
      triggerExpression: map['triggerExpression'] as String,
    );
  }
}
