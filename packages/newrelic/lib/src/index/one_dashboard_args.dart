...
class OneDashboardArgs {
  ...
  OneDashboardArgs({
    ...
    String? description,
    String? name,
    required List<OneDashboardPage> pages,
    String? permissions,
    List<OneDashboardVariable>? variables,
  }) :
      accountId = pulumi.Input.asOptionalInput<String>(accountId),
      description = pulumi.Input.asOptionalInput<String>(description),
      name = pulumi.Input.asOptionalInput<String>(name),
      pages = pulumi.Input.asInput<List<OneDashboardPage>>(pages),
  ...
  factory OneDashboardArgs.fromMap(Map<String, dynamic> map) {
    return OneDashboardArgs(
      ...
      pages: pulumi.Input.decodeList<OneDashboardPage>(map['pages'], (value) => OneDashboardPage.fromMap((value as Map).cast<String, dynamic>())),
      permissions: map['permissions'] == null ? null : map['permissions'] as String,
      variables: map['variables'] == null ? null : pulumi.Input.decodeList<OneDashboardVariable>(map['variables'], (value) => OneDashboardVariable.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
