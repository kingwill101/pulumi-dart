...
class NrqlAlertConditionArgs {
  ...
  NrqlAlertConditionArgs({
    ...
    bool? closeViolationsOnExpiration,
    ...
    String? fillOption,
    double? fillValue,
    bool? ignoreOnExpectedTermination,
    String? name,
    required NrqlAlertConditionNrql nrql,
    bool? openViolationOnExpiration,
    NrqlAlertConditionOutlierConfiguration? outlierConfiguration,
    required String policyId,
    String? runbookUrl,
    String? signalSeasonality,
    int? slideBy,
    String? targetEntity,
    List<NrqlAlertConditionTerm>? terms,
    String? titleTemplate,
    String? type,
    String? violationTimeLimit,
    int? violationTimeLimitSeconds,
  ...
  factory NrqlAlertConditionArgs.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionArgs(
      ...
      aggregationDelay: map['aggregationDelay'] == null ? null : map['aggregationDelay'] as String,
      aggregationMethod: map['aggregationMethod'] == null ? null : map['aggregationMethod'] as String,
      aggregationTimer: map['aggregationTimer'] == null ? null : map['aggregationTimer'] as String,
      aggregationWindow: map['aggregationWindow'] == null ? null : map['aggregationWindow'] as int,
      baselineDirection: map['baselineDirection'] == null ? null : map['baselineDirection'] as String,
      closeViolationsOnExpiration: map['closeViolationsOnExpiration'] == null ? null : map['closeViolationsOnExpiration'] as bool,
      critical: map['critical'] == null ? null : NrqlAlertConditionCritical.fromMap((map['critical'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      evaluationDelay: map['evaluationDelay'] == null ? null : map['evaluationDelay'] as int,
      expirationDuration: map['expirationDuration'] == null ? null : map['expirationDuration'] as int,
      fillOption: map['fillOption'] == null ? null : map['fillOption'] as String,
      fillValue: map['fillValue'] == null ? null : map['fillValue'] as double,
      ignoreOnExpectedTermination: map['ignoreOnExpectedTermination'] == null ? null : map['ignoreOnExpectedTermination'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      nrql: NrqlAlertConditionNrql.fromMap((map['nrql'] as Map).cast<String, dynamic>()),
      openViolationOnExpiration: map['openViolationOnExpiration'] == null ? null : map['openViolationOnExpiration'] as bool,
      outlierConfiguration: map['outlierConfiguration'] == null ? null : NrqlAlertConditionOutlierConfiguration.fromMap((map['outlierConfiguration'] as Map).cast<String, dynamic>()),
      policyId: map['policyId'] as String,
      runbookUrl: map['runbookUrl'] == null ? null : map['runbookUrl'] as String,
      signalSeasonality: map['signalSeasonality'] == null ? null : map['signalSeasonality'] as String,
      slideBy: map['slideBy'] == null ? null : map['slideBy'] as int,
      targetEntity: map['targetEntity'] == null ? null : map['targetEntity'] as String,
      terms: map['terms'] == null ? null : pulumi.Input.decodeList<NrqlAlertConditionTerm>(map['terms'], (value) => NrqlAlertConditionTerm.fromMap((value as Map).cast<String, dynamic>())),
      titleTemplate: map['titleTemplate'] == null ? null : map['titleTemplate'] as String,
      type: map['type'] == null ? null : map['type'] as String,
      violationTimeLimit: map['violationTimeLimit'] == null ? null : map['violationTimeLimit'] as String,
      violationTimeLimitSeconds: map['violationTimeLimitSeconds'] == null ? null : map['violationTimeLimitSeconds'] as int,
      warning: map['warning'] == null ? null : NrqlAlertConditionWarning.fromMap((map['warning'] as Map).cast<String, dynamic>()),
    );
  }
}
