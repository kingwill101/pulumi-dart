...
class AlertConditionArgs {
  ...
  AlertConditionArgs({
    ...
    String? runbookUrl,
    required List<AlertConditionTerm> terms,
  ...
  factory AlertConditionArgs.fromMap(Map<String, dynamic> map) {
    return AlertConditionArgs(
      conditionScope: map['conditionScope'] == null ? null : map['conditionScope'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      entities: (map['entities'] as List).cast<String>(),
      gcMetric: map['gcMetric'] == null ? null : map['gcMetric'] as String,
      metric: map['metric'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      policyId: map['policyId'] as String,
      runbookUrl: map['runbookUrl'] == null ? null : map['runbookUrl'] as String,
      terms: pulumi.Input.decodeList<AlertConditionTerm>(map['terms'], (value) => AlertConditionTerm.fromMap((value as Map).cast<String, dynamic>())),
      type: map['type'] as String,
      userDefinedMetric: map['userDefinedMetric'] == null ? null : map['userDefinedMetric'] as String,
      userDefinedValueFunction: map['userDefinedValueFunction'] == null ? null : map['userDefinedValueFunction'] as String,
