...
class NotificationChannelArgs {
  ...
  NotificationChannelArgs({
    ...
    required List<NotificationChannelProperty> properties,
  ...
  factory NotificationChannelArgs.fromMap(Map<String, dynamic> map) {
    return NotificationChannelArgs(
      ...
      properties: pulumi.Input.decodeList<NotificationChannelProperty>(map['properties'], (value) => NotificationChannelProperty.fromMap((value as Map).cast<String, dynamic>())),
