...
class BrowserApplicationArgs {
  ...
  factory BrowserApplicationArgs.fromMap(Map<String, dynamic> map) {
    return BrowserApplicationArgs(
      ...
      cookiesEnabled: map['cookiesEnabled'] == null ? null : map['cookiesEnabled'] as bool,
      distributedTracingEnabled: map['distributedTracingEnabled'] == null ? null : map['distributedTracingEnabled'] as bool,
