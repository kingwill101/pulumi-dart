...
class OneDashboardPageWidgetHeatmapColor {
  ...
  final List<OneDashboardPageWidgetHeatmapColorSeriesOverride>? seriesOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'color': ?color,
      'seriesOverrides': ?seriesOverrides == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetHeatmapColorSeriesOverride, Map<String, dynamic>>(seriesOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory OneDashboardPageWidgetHeatmapColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHeatmapColor(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapColorSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetHeatmapColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
