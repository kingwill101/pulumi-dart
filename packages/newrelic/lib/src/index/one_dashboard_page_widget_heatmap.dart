...
class OneDashboardPageWidgetHeatmap {
  ...
  final List<OneDashboardPageWidgetHeatmapColor>? colors;
  /// (Required) Column position of widget from top left, starting at `1`.
  final int column;
  /// (Optional) A nested block that describes data format. See Nested data_format blocks below for details.
  final List<OneDashboardPageWidgetHeatmapDataFormat>? dataFormats;
  ...
  final OneDashboardPageWidgetHeatmapInitialSorting? initialSorting;
  ...
  final List<OneDashboardPageWidgetHeatmapNrqlQuery> nrqlQueries;
  /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
  final List<OneDashboardPageWidgetHeatmapNullValue>? nullValues;
  ...
  final List<OneDashboardPageWidgetHeatmapUnit>? units;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'colors': ?colors == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetHeatmapColor, Map<String, dynamic>>(colors!, (value) => value.toMap()),
      'column': column,
      'dataFormats': ?dataFormats == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetHeatmapDataFormat, Map<String, dynamic>>(dataFormats!, (value) => value.toMap()),
      ...
      'nrqlQueries': pulumi.Input.encodeList<OneDashboardPageWidgetHeatmapNrqlQuery, Map<String, dynamic>>(nrqlQueries, (value) => value.toMap()),
      'nullValues': ?nullValues == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetHeatmapNullValue, Map<String, dynamic>>(nullValues!, (value) => value.toMap()),
      'refreshRate': ?refreshRate,
      'row': row,
      'title': title,
      'units': ?units == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetHeatmapUnit, Map<String, dynamic>>(units!, (value) => value.toMap()),
      'width': ?width,
  ...
  factory OneDashboardPageWidgetHeatmap.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetHeatmap(
      colors: map['colors'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapColor>(map['colors'], (value) => OneDashboardPageWidgetHeatmapColor.fromMap((value as Map).cast<String, dynamic>())),
      column: map['column'] as int,
      dataFormats: map['dataFormats'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapDataFormat>(map['dataFormats'], (value) => OneDashboardPageWidgetHeatmapDataFormat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      initialSorting: map['initialSorting'] == null ? null : OneDashboardPageWidgetHeatmapInitialSorting.fromMap((map['initialSorting'] as Map).cast<String, dynamic>()),
      ...
      nrqlQueries: pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapNrqlQuery>(map['nrqlQueries'], (value) => OneDashboardPageWidgetHeatmapNrqlQuery.fromMap((value as Map).cast<String, dynamic>())),
      nullValues: map['nullValues'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapNullValue>(map['nullValues'], (value) => OneDashboardPageWidgetHeatmapNullValue.fromMap((value as Map).cast<String, dynamic>())),
      refreshRate: map['refreshRate'] == null ? null : map['refreshRate'] as String,
      row: map['row'] as int,
      title: map['title'] as String,
      units: map['units'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetHeatmapUnit>(map['units'], (value) => OneDashboardPageWidgetHeatmapUnit.fromMap((value as Map).cast<String, dynamic>())),
