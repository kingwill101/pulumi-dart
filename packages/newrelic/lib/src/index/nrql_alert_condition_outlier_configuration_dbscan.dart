...
class NrqlAlertConditionOutlierConfigurationDbscan {
  ...
  final String? evaluationGroupFacet;
  ...
  factory NrqlAlertConditionOutlierConfigurationDbscan.fromMap(Map<String, dynamic> map) {
    return NrqlAlertConditionOutlierConfigurationDbscan(
      epsilon: map['epsilon'] as double,
      evaluationGroupFacet: map['evaluationGroupFacet'] == null ? null : map['evaluationGroupFacet'] as String,
      minimumPoints: map['minimumPoints'] as int,
    );
  }
}
