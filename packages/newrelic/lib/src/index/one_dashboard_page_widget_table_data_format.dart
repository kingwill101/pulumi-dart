...
class OneDashboardPageWidgetTableDataFormat {
  ...
  /// Creates a new [OneDashboardPageWidgetTableDataFormat].
  ...
  factory OneDashboardPageWidgetTableDataFormat.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetTableDataFormat(
