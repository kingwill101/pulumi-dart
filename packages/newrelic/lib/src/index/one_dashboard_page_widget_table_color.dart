...
class OneDashboardPageWidgetTableColor {
  ...
  final List<OneDashboardPageWidgetTableColorSeriesOverride>? seriesOverrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'color': ?color,
      'seriesOverrides': ?seriesOverrides == null ? null : pulumi.Input.encodeList<OneDashboardPageWidgetTableColorSeriesOverride, Map<String, dynamic>>(seriesOverrides!, (value) => value.toMap()),
    };
  }
  ...
  factory OneDashboardPageWidgetTableColor.fromMap(Map<String, dynamic> map) {
    return OneDashboardPageWidgetTableColor(
      ...
      seriesOverrides: map['seriesOverrides'] == null ? null : pulumi.Input.decodeList<OneDashboardPageWidgetTableColorSeriesOverride>(map['seriesOverrides'], (value) => OneDashboardPageWidgetTableColorSeriesOverride.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
