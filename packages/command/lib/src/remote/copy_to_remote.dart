...
import 'copy_to_remote_args.dart';
...
class CopyToRemote extends pulumi.CustomResource {
  ...
  /// Creates a new [CopyToRemote].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [CopyToRemote]. {@macro pulumi_remote_copy_to_remote_args_doc}
