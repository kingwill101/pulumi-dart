...
class ApprovalRuleArgs {
  ...
  ApprovalRuleArgs({
    required ApprovalRuleConfig approvalRuleConfig,
    required bool enabled,
    required EnvironmentIdentifier environmentIdentifier,
    required String name,
    required List<TargetActionType> targetActionTypes,
  }) :
  ...
  factory ApprovalRuleArgs.fromMap(Map<String, dynamic> map) {
    return ApprovalRuleArgs(
      approvalRuleConfig: ApprovalRuleConfig.fromMap((map['approvalRuleConfig'] as Map).cast<String, dynamic>()),
      enabled: map['enabled'] as bool,
      environmentIdentifier: EnvironmentIdentifier.fromMap((map['environmentIdentifier'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      targetActionTypes: pulumi.Input.decodeList<TargetActionType>(map['targetActionTypes'], (value) => TargetActionType.fromValue(value as String)),
    );
  }
}
