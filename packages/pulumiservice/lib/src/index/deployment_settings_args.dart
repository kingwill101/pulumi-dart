...
class DeploymentSettingsArgs {
  ...
  DeploymentSettingsArgs({
    String? agentPoolId,
    DeploymentSettingsCacheOptions? cacheOptions,
    DeploymentSettingsExecutorContext? executorContext,
    DeploymentSettingsGithub? github,
    DeploymentSettingsOperationContext? operationContext,
    required String organization,
    required String project,
    DeploymentSettingsSourceContext? sourceContext,
  ...
  factory DeploymentSettingsArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentSettingsArgs(
      agentPoolId: map['agentPoolId'] == null ? null : map['agentPoolId'] as String,
      cacheOptions: map['cacheOptions'] == null ? null : DeploymentSettingsCacheOptions.fromMap((map['cacheOptions'] as Map).cast<String, dynamic>()),
      executorContext: map['executorContext'] == null ? null : DeploymentSettingsExecutorContext.fromMap((map['executorContext'] as Map).cast<String, dynamic>()),
      github: map['github'] == null ? null : DeploymentSettingsGithub.fromMap((map['github'] as Map).cast<String, dynamic>()),
      operationContext: map['operationContext'] == null ? null : DeploymentSettingsOperationContext.fromMap((map['operationContext'] as Map).cast<String, dynamic>()),
      organization: map['organization'] as String,
      project: map['project'] as String,
      sourceContext: map['sourceContext'] == null ? null : DeploymentSettingsSourceContext.fromMap((map['sourceContext'] as Map).cast<String, dynamic>()),
