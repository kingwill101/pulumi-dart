...
class PolicyGroupArgs {
  ...
  PolicyGroupArgs({
    ...
    List<PolicyGroupPolicyPackReference>? policyPacks,
    List<PolicyGroupStackReference>? stacks,
  }) :
  ...
  factory PolicyGroupArgs.fromMap(Map<String, dynamic> map) {
    return PolicyGroupArgs(
      ...
      policyPacks: map['policyPacks'] == null ? null : pulumi.Input.decodeList<PolicyGroupPolicyPackReference>(map['policyPacks'], (value) => PolicyGroupPolicyPackReference.fromMap((value as Map).cast<String, dynamic>())),
      stacks: map['stacks'] == null ? null : pulumi.Input.decodeList<PolicyGroupStackReference>(map['stacks'], (value) => PolicyGroupStackReference.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
