...
class AccountArgs {
  ...
  AccountArgs({
    ...
    String? location,
    List<PrivateEndpointConnectionDeviceupdate>? privateEndpointConnections,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      privateEndpointConnections: map['privateEndpointConnections'] == null ? null : (map['privateEndpointConnections'] as List).cast<PrivateEndpointConnectionDeviceupdate>(),
