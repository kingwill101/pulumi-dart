...
class EnterprisePolicyArgs {
  ...
  factory EnterprisePolicyArgs.fromMap(Map<String, dynamic> map) {
    return EnterprisePolicyArgs(
      encryption: map['encryption'] == null ? null : PropertiesEncryption.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      enterprisePolicyName: map['enterprisePolicyName'] == null ? null : map['enterprisePolicyName'] as String,
      healthStatus: map['healthStatus'] == null ? null : map['healthStatus'] as String,
      identity: map['identity'] == null ? null : EnterprisePolicyIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      lockbox: map['lockbox'] == null ? null : PropertiesLockbox.fromMap((map['lockbox'] as Map).cast<String, dynamic>()),
      networkInjection: map['networkInjection'] == null ? null : PropertiesNetworkInjection.fromMap((map['networkInjection'] as Map).cast<String, dynamic>()),
