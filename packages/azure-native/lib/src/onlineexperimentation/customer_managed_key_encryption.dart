...
class CustomerManagedKeyEncryption {
  ...
  final KeyEncryptionKeyIdentity? keyEncryptionKeyIdentity;
  ...
  factory CustomerManagedKeyEncryption.fromMap(Map<String, dynamic> map) {
    return CustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: map['keyEncryptionKeyIdentity'] == null ? null : KeyEncryptionKeyIdentity.fromMap((map['keyEncryptionKeyIdentity'] as Map).cast<String, dynamic>()),
