...
class OnlineExperimentationWorkspaceArgs {
  ...
  factory OnlineExperimentationWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return OnlineExperimentationWorkspaceArgs(
      ...
      properties: map['properties'] == null ? null : OnlineExperimentationWorkspaceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      sku: map['sku'] == null ? null : OnlineExperimentationWorkspaceSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
