...
class KeyEncryptionKeyIdentityResponse {
  ...
  /// Creates a new [KeyEncryptionKeyIdentityResponse].
  ...
  factory KeyEncryptionKeyIdentityResponse.fromMap(Map<String, dynamic> map) {
    return KeyEncryptionKeyIdentityResponse(
