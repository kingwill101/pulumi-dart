...
class IotDpsResourceArgs {
  ...
  IotDpsResourceArgs({
    ...
    String? location,
    required IotDpsPropertiesDescription properties,
    String? provisioningServiceName,
    required String resourceGroupName,
    String? resourcegroup,
    required IotDpsSkuInfo sku,
  ...
  factory IotDpsResourceArgs.fromMap(Map<String, dynamic> map) {
    return IotDpsResourceArgs(
      ...
      properties: IotDpsPropertiesDescription.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      provisioningServiceName: map['provisioningServiceName'] == null ? null : map['provisioningServiceName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      resourcegroup: map['resourcegroup'] == null ? null : map['resourcegroup'] as String,
      sku: IotDpsSkuInfo.fromMap((map['sku'] as Map).cast<String, dynamic>()),
