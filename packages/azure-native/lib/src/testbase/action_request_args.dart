...
class ActionRequestArgs {
  ...
  factory ActionRequestArgs.fromMap(Map<String, dynamic> map) {
    return ActionRequestArgs(
      actionRequestName: map['actionRequestName'] == null ? null : map['actionRequestName'] as String,
      preReleaseAccessRequestSpec: map['preReleaseAccessRequestSpec'] == null ? null : PreReleaseAccessRequestSpec.fromMap((map['preReleaseAccessRequestSpec'] as Map).cast<String, dynamic>()),
