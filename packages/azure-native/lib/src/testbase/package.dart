...
class Package extends pulumi.CustomResource {
  ...
  Package(
    ...
    this.blobPath = registerOutput<String?>('blobPath');
    this.draftPackageId = registerOutput<String?>('draftPackageId');
    ...
    this.packageStatus = registerOutput<String>('packageStatus');
    ...
    this.validationResults = registerOutput<List<PackageValidationResultResponse>>('validationResults');
