...
class LogConfigResponse {
  ...
  final FieldLogLevelEnumValueResponse? fieldLogLevel;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fieldLogLevel': ?fieldLogLevel == null ? null : fieldLogLevel!.toMap(),
    };
  }
  ...
  factory LogConfigResponse.fromMap(Map<String, dynamic> map) {
    return LogConfigResponse(
      ...
      fieldLogLevel: map['fieldLogLevel'] == null ? null : FieldLogLevelEnumValueResponse.fromMap((map['fieldLogLevel'] as Map).cast<String, dynamic>()),
    );
  }
}
