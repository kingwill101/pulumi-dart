...
class ElasticLoadBalancingV2ListenerPropertiesResponse {
  ...
  /// AWS Properties
  final AwsElasticLoadBalancingV2ListenerPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory ElasticLoadBalancingV2ListenerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2ListenerPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticLoadBalancingV2ListenerPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
