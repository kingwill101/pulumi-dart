...
class CloudFrontDistributionProperties {
  ...
  /// AWS Properties
  final AwsCloudFrontDistributionProperties? awsProperties;
  /// AWS Region
  ...
  factory CloudFrontDistributionProperties.fromMap(Map<String, dynamic> map) {
    return CloudFrontDistributionProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudFrontDistributionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
