...
class AwsEfsFileSystemProperties {
  ...
  final FileSystemProtection? fileSystemProtection;
  /// Use to create one or more tags associated with the file system. Each tag is a user-defined key-value pair. Name your file system on creation by including a ``'Key':'Name','Value':'{value}'`` key-value pair. Each key must be unique. For more information, see [Tagging resources](https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) in the *General Reference Guide*.
  final List<ElasticFileSystemTag>? fileSystemTags;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileSystemTags': ?fileSystemTags == null ? null : pulumi.Input.encodeList<ElasticFileSystemTag, Map<String, dynamic>>(fileSystemTags!, (value) => value.toMap()),
      'kmsKeyId': ?kmsKeyId,
  ...
  factory AwsEfsFileSystemProperties.fromMap(Map<String, dynamic> map) {
    return AwsEfsFileSystemProperties(
      ...
      fileSystemProtection: map['fileSystemProtection'] == null ? null : FileSystemProtection.fromMap((map['fileSystemProtection'] as Map).cast<String, dynamic>()),
      fileSystemTags: map['fileSystemTags'] == null ? null : pulumi.Input.decodeList<ElasticFileSystemTag>(map['fileSystemTags'], (value) => ElasticFileSystemTag.fromMap((value as Map).cast<String, dynamic>())),
