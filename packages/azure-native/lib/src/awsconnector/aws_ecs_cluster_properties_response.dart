...
class AwsEcsClusterPropertiesResponse {
  ...
  final List<ClusterSettingsResponse>? clusterSettings;
  /// The execute command configuration for the cluster. The execute command configuration for the cluster.
  final ClusterConfigurationResponse? configuration;
  /// The default capacity provider strategy for the cluster. When services or tasks are run in the cluster with no launch type or capacity provider strategy specified, the default capacity provider strategy is used.
  final List<CapacityProviderStrategyItemResponse>? defaultCapacityProviderStrategy;
  ...
  final ServiceConnectDefaultsResponse? serviceConnectDefaults;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'clusterSettings': ?clusterSettings == null ? null : pulumi.Input.encodeList<ClusterSettingsResponse, Map<String, dynamic>>(clusterSettings!, (value) => value.toMap()),
      'configuration': ?configuration == null ? null : configuration!.toMap(),
      'defaultCapacityProviderStrategy': ?defaultCapacityProviderStrategy == null ? null : pulumi.Input.encodeList<CapacityProviderStrategyItemResponse, Map<String, dynamic>>(defaultCapacityProviderStrategy!, (value) => value.toMap()),
  ...
  factory AwsEcsClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEcsClusterPropertiesResponse(
      ...
      clusterSettings: map['clusterSettings'] == null ? null : pulumi.Input.decodeList<ClusterSettingsResponse>(map['clusterSettings'], (value) => ClusterSettingsResponse.fromMap((value as Map).cast<String, dynamic>())),
      configuration: map['configuration'] == null ? null : ClusterConfigurationResponse.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      defaultCapacityProviderStrategy: map['defaultCapacityProviderStrategy'] == null ? null : pulumi.Input.decodeList<CapacityProviderStrategyItemResponse>(map['defaultCapacityProviderStrategy'], (value) => CapacityProviderStrategyItemResponse.fromMap((value as Map).cast<String, dynamic>())),
      serviceConnectDefaults: map['serviceConnectDefaults'] == null ? null : ServiceConnectDefaultsResponse.fromMap((map['serviceConnectDefaults'] as Map).cast<String, dynamic>()),
