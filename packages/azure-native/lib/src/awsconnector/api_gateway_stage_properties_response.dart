...
import 'aws_api_gateway_stage_properties_response.dart';

/// Definition of ApiGatewayStage
class ApiGatewayStagePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsApiGatewayStagePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ApiGatewayStagePropertiesResponse].
  ...
  factory ApiGatewayStagePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApiGatewayStagePropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsApiGatewayStagePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
