...
import 'aws_lambda_function_properties_response.dart';

/// Definition of LambdaFunction
class LambdaFunctionPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsLambdaFunctionPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LambdaFunctionPropertiesResponse].
  ...
  factory LambdaFunctionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsLambdaFunctionPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
