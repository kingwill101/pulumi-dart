...
import 'aws_network_firewall_firewall_policy_properties.dart';

/// Definition of NetworkFirewallFirewallPolicy
class NetworkFirewallFirewallPolicyProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsNetworkFirewallFirewallPolicyProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [NetworkFirewallFirewallPolicyProperties].
  ...
  factory NetworkFirewallFirewallPolicyProperties.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallFirewallPolicyProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsNetworkFirewallFirewallPolicyProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
