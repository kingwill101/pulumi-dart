...
class ModifyingProperties {
  ...
  final PropertyValueTypeEnumValue? valueType;
  ...
  factory ModifyingProperties.fromMap(Map<String, dynamic> map) {
    return ModifyingProperties(
      ...
      valueType: map['valueType'] == null ? null : PropertyValueTypeEnumValue.fromMap((map['valueType'] as Map).cast<String, dynamic>()),
    );
  }
}
