...
class AwsEcrRepositoryProperties {
  ...
  factory AwsEcrRepositoryProperties.fromMap(Map<String, dynamic> map) {
    return AwsEcrRepositoryProperties(
      ...
      imageScanningConfiguration: map['imageScanningConfiguration'] == null ? null : ImageScanningConfiguration.fromMap((map['imageScanningConfiguration'] as Map).cast<String, dynamic>()),
