...
class KmsAliasProperties {
  ...
  /// AWS Properties
  final AwsKmsAliasProperties? awsProperties;
  /// AWS Region
  ...
  factory KmsAliasProperties.fromMap(Map<String, dynamic> map) {
    return KmsAliasProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsKmsAliasProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
