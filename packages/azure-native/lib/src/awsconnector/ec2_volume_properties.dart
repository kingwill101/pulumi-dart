...
import 'aws_ec2_volume_properties.dart';

/// Definition of Ec2Volume
class Ec2VolumeProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEc2VolumeProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2VolumeProperties].
  ...
  factory Ec2VolumeProperties.fromMap(Map<String, dynamic> map) {
    return Ec2VolumeProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEc2VolumeProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
