...
class AwsAcmCertificateSummaryProperties {
  ...
  final KeyAlgorithmEnumValue? keyAlgorithm;
  ...
  final RenewalEligibilityEnumValue? renewalEligibility;
  ...
  final CertificateStatusEnumValue? status;
  ...
  final CertificateTypeEnumValue? type;
  ...
  factory AwsAcmCertificateSummaryProperties.fromMap(Map<String, dynamic> map) {
    return AwsAcmCertificateSummaryProperties(
      ...
      keyAlgorithm: map['keyAlgorithm'] == null ? null : KeyAlgorithmEnumValue.fromMap((map['keyAlgorithm'] as Map).cast<String, dynamic>()),
      ...
      renewalEligibility: map['renewalEligibility'] == null ? null : RenewalEligibilityEnumValue.fromMap((map['renewalEligibility'] as Map).cast<String, dynamic>()),
      revokedAt: map['revokedAt'] == null ? null : map['revokedAt'] as String,
      status: map['status'] == null ? null : CertificateStatusEnumValue.fromMap((map['status'] as Map).cast<String, dynamic>()),
      ...
      type: map['type'] == null ? null : CertificateTypeEnumValue.fromMap((map['type'] as Map).cast<String, dynamic>()),
    );
  }
}
