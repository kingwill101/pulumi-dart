...
class SsmInstanceInformationPropertiesResponse {
  ...
  /// AWS Properties
  final AwsSsmInstanceInformationPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory SsmInstanceInformationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SsmInstanceInformationPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSsmInstanceInformationPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
