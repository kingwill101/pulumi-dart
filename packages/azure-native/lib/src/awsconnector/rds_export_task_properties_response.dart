...
class RdsExportTaskPropertiesResponse {
  ...
  /// AWS Properties
  final AwsRdsExportTaskPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory RdsExportTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsExportTaskPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsExportTaskPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
