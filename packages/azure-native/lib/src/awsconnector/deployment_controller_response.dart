...
class DeploymentControllerResponse {
  ...
  /// Creates a new [DeploymentControllerResponse].
  ...
  factory DeploymentControllerResponse.fromMap(Map<String, dynamic> map) {
    return DeploymentControllerResponse(
