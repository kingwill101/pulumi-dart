...
class LogsLogGroupPropertiesResponse {
  ...
  /// AWS Properties
  final AwsLogsLogGroupPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory LogsLogGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LogsLogGroupPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLogsLogGroupPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
