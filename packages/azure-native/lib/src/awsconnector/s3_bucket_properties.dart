...
class S3BucketProperties {
  ...
  /// AWS Properties
  final AwsS3BucketProperties? awsProperties;
  /// AWS Region
  ...
  factory S3BucketProperties.fromMap(Map<String, dynamic> map) {
    return S3BucketProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3BucketProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
