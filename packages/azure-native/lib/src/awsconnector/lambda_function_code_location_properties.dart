...
class LambdaFunctionCodeLocationProperties {
  ...
  /// AWS Properties
  final AwsLambdaFunctionCodeLocationProperties? awsProperties;
  /// AWS Region
  ...
  factory LambdaFunctionCodeLocationProperties.fromMap(Map<String, dynamic> map) {
    return LambdaFunctionCodeLocationProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLambdaFunctionCodeLocationProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
