...
class Ec2InstanceStatusPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2InstanceStatusPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2InstanceStatusPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceStatusPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2InstanceStatusPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
