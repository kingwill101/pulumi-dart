...
class ReplicationRule {
  ...
  final ReplicationDestination? destination;
  ...
  factory ReplicationRule.fromMap(Map<String, dynamic> map) {
    return ReplicationRule(
      deleteMarkerReplication: map['deleteMarkerReplication'] == null ? null : DeleteMarkerReplication.fromMap((map['deleteMarkerReplication'] as Map).cast<String, dynamic>()),
      destination: map['destination'] == null ? null : ReplicationDestination.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      filter: map['filter'] == null ? null : ReplicationRuleFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      prefix: map['prefix'] == null ? null : map['prefix'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      sourceSelectionCriteria: map['sourceSelectionCriteria'] == null ? null : SourceSelectionCriteria.fromMap((map['sourceSelectionCriteria'] as Map).cast<String, dynamic>()),
