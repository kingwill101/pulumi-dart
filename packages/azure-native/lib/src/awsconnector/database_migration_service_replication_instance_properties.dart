...
class DatabaseMigrationServiceReplicationInstanceProperties {
  ...
  /// AWS Properties
  final AwsDatabaseMigrationServiceReplicationInstanceProperties? awsProperties;
  /// AWS Region
  ...
  factory DatabaseMigrationServiceReplicationInstanceProperties.fromMap(Map<String, dynamic> map) {
    return DatabaseMigrationServiceReplicationInstanceProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsDatabaseMigrationServiceReplicationInstanceProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
