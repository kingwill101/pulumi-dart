...
import 'aws_sage_maker_app_properties_response.dart';

/// Definition of SageMakerApp
class SageMakerAppPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsSageMakerAppPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SageMakerAppPropertiesResponse].
  ...
  factory SageMakerAppPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SageMakerAppPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsSageMakerAppPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
