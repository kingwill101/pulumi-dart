...
class SimpleCriterionForJobResponse {
  ...
  final SimpleCriterionKeyForJobEnumValueResponse? key;
  ...
  factory SimpleCriterionForJobResponse.fromMap(Map<String, dynamic> map) {
    return SimpleCriterionForJobResponse(
      ...
      key: map['key'] == null ? null : SimpleCriterionKeyForJobEnumValueResponse.fromMap((map['key'] as Map).cast<String, dynamic>()),
