...
class Ec2NetworkInterfaceProperties {
  ...
  /// AWS Properties
  final AwsEc2NetworkInterfaceProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2NetworkInterfaceProperties.fromMap(Map<String, dynamic> map) {
    return Ec2NetworkInterfaceProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2NetworkInterfaceProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
