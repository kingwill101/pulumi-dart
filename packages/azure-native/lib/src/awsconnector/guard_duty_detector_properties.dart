...
class GuardDutyDetectorProperties {
  ...
  /// AWS Properties
  final AwsGuardDutyDetectorProperties? awsProperties;
  /// AWS Region
  ...
  factory GuardDutyDetectorProperties.fromMap(Map<String, dynamic> map) {
    return GuardDutyDetectorProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsGuardDutyDetectorProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
