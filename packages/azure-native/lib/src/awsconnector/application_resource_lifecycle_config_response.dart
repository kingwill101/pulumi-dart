...
class ApplicationResourceLifecycleConfigResponse {
  ...
  final ApplicationVersionLifecycleConfigResponse? versionLifecycleConfig;
  ...
  factory ApplicationResourceLifecycleConfigResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationResourceLifecycleConfigResponse(
      ...
      versionLifecycleConfig: map['versionLifecycleConfig'] == null ? null : ApplicationVersionLifecycleConfigResponse.fromMap((map['versionLifecycleConfig'] as Map).cast<String, dynamic>()),
    );
  }
}
