...
class LogsSubscriptionFilterArgs {
  ...
  LogsSubscriptionFilterArgs({
    ...
    Map<String, String>? tags,
      ...
      properties = pulumi.Input.asOptionalInput<LogsSubscriptionFilterProperties>(properties),
  ...
  factory LogsSubscriptionFilterArgs.fromMap(Map<String, dynamic> map) {
    return LogsSubscriptionFilterArgs(
      ...
      properties: map['properties'] == null ? null : LogsSubscriptionFilterProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
