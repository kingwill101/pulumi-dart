...
class IamRoleProperties {
  ...
  /// AWS Properties
  final AwsIamRoleProperties? awsProperties;
  /// AWS Region
  ...
  factory IamRoleProperties.fromMap(Map<String, dynamic> map) {
    return IamRoleProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamRoleProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
