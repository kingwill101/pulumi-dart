...
class AwsDatabaseMigrationServiceReplicationInstanceProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'vpcSecurityGroups': ?vpcSecurityGroups == null ? null : pulumi.Input.encodeList<VpcSecurityGroupMembership, Map<String, dynamic>>(vpcSecurityGroups!, (value) => value.toMap()),
    };
  }
  ...
  factory AwsDatabaseMigrationServiceReplicationInstanceProperties.fromMap(Map<String, dynamic> map) {
    return AwsDatabaseMigrationServiceReplicationInstanceProperties(
      ...
      pendingModifiedValues: map['pendingModifiedValues'] == null ? null : ReplicationPendingModifiedValues.fromMap((map['pendingModifiedValues'] as Map).cast<String, dynamic>()),
      ...
      replicationSubnetGroup: map['replicationSubnetGroup'] == null ? null : ReplicationSubnetGroup.fromMap((map['replicationSubnetGroup'] as Map).cast<String, dynamic>()),
      secondaryAvailabilityZone: map['secondaryAvailabilityZone'] == null ? null : map['secondaryAvailabilityZone'] as String,
      vpcSecurityGroups: map['vpcSecurityGroups'] == null ? null : pulumi.Input.decodeList<VpcSecurityGroupMembership>(map['vpcSecurityGroups'], (value) => VpcSecurityGroupMembership.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
