...
class Ec2InstanceProperties {
  ...
  /// AWS Properties
  final AwsEc2InstanceProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2InstanceProperties.fromMap(Map<String, dynamic> map) {
    return Ec2InstanceProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2InstanceProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
