...
class EcsTaskDefinitionPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEcsTaskDefinitionPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory EcsTaskDefinitionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcsTaskDefinitionPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcsTaskDefinitionPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
