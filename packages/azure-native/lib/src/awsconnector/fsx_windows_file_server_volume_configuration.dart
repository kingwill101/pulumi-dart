...
class FSxWindowsFileServerVolumeConfiguration {
  ...
  final FSxAuthorizationConfig? authorizationConfig;
  ...
  factory FSxWindowsFileServerVolumeConfiguration.fromMap(Map<String, dynamic> map) {
    return FSxWindowsFileServerVolumeConfiguration(
      authorizationConfig: map['authorizationConfig'] == null ? null : FSxAuthorizationConfig.fromMap((map['authorizationConfig'] as Map).cast<String, dynamic>()),
