...
import 'aws_elastic_beanstalk_configuration_template_properties_response.dart';

/// Definition of ElasticBeanstalkConfigurationTemplate
class ElasticBeanstalkConfigurationTemplatePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsElasticBeanstalkConfigurationTemplatePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [ElasticBeanstalkConfigurationTemplatePropertiesResponse].
  ...
  factory ElasticBeanstalkConfigurationTemplatePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkConfigurationTemplatePropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsElasticBeanstalkConfigurationTemplatePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
