...
class AwsSecretsManagerSecretPropertiesResponse {
  ...
  final GenerateSecretStringResponse? generateSecretString;
  /// Property id
  final String? id;
  ...
  final List<ReplicaRegionResponse>? replicaRegions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'kmsKeyId': ?kmsKeyId,
      'name': ?name,
      'replicaRegions': ?replicaRegions == null ? null : pulumi.Input.encodeList<ReplicaRegionResponse, Map<String, dynamic>>(replicaRegions!, (value) => value.toMap()),
  ...
  factory AwsSecretsManagerSecretPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsSecretsManagerSecretPropertiesResponse(
      ...
      generateSecretString: map['generateSecretString'] == null ? null : GenerateSecretStringResponse.fromMap((map['generateSecretString'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      replicaRegions: map['replicaRegions'] == null ? null : pulumi.Input.decodeList<ReplicaRegionResponse>(map['replicaRegions'], (value) => ReplicaRegionResponse.fromMap((value as Map).cast<String, dynamic>())),
