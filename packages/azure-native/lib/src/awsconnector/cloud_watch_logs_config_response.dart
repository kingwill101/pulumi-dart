...
class CloudWatchLogsConfigResponse {
  ...
  final LogsConfigStatusTypeEnumValueResponse? status;
  ...
  factory CloudWatchLogsConfigResponse.fromMap(Map<String, dynamic> map) {
    return CloudWatchLogsConfigResponse(
      ...
      status: map['status'] == null ? null : LogsConfigStatusTypeEnumValueResponse.fromMap((map['status'] as Map).cast<String, dynamic>()),
