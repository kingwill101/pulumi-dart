...
class ConfigServiceDeliveryChannelProperties {
  ...
  /// AWS Properties
  final AwsConfigServiceDeliveryChannelProperties? awsProperties;
  /// AWS Region
  ...
  factory ConfigServiceDeliveryChannelProperties.fromMap(Map<String, dynamic> map) {
    return ConfigServiceDeliveryChannelProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsConfigServiceDeliveryChannelProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
