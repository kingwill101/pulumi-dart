...
class S3AccessPointProperties {
  ...
  /// AWS Properties
  final AwsS3AccessPointProperties? awsProperties;
  /// AWS Region
  ...
  factory S3AccessPointProperties.fromMap(Map<String, dynamic> map) {
    return S3AccessPointProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3AccessPointProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
