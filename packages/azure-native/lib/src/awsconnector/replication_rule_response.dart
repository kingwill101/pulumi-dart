...
class ReplicationRuleResponse {
  ...
  final DeleteMarkerReplicationResponse? deleteMarkerReplication;
  ...
  final ReplicationDestinationResponse? destination;
  ...
  final ReplicationRuleFilterResponse? filter;
  ...
  final SourceSelectionCriteriaResponse? sourceSelectionCriteria;
  ...
  factory ReplicationRuleResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationRuleResponse(
      deleteMarkerReplication: map['deleteMarkerReplication'] == null ? null : DeleteMarkerReplicationResponse.fromMap((map['deleteMarkerReplication'] as Map).cast<String, dynamic>()),
      destination: map['destination'] == null ? null : ReplicationDestinationResponse.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      filter: map['filter'] == null ? null : ReplicationRuleFilterResponse.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      prefix: map['prefix'] == null ? null : map['prefix'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      sourceSelectionCriteria: map['sourceSelectionCriteria'] == null ? null : SourceSelectionCriteriaResponse.fromMap((map['sourceSelectionCriteria'] as Map).cast<String, dynamic>()),
