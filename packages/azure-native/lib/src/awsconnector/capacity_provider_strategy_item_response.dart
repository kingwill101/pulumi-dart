...
class CapacityProviderStrategyItemResponse {
  ...
  /// Creates a new [CapacityProviderStrategyItemResponse].
  ...
  factory CapacityProviderStrategyItemResponse.fromMap(Map<String, dynamic> map) {
    return CapacityProviderStrategyItemResponse(
      ...
      capacityProvider: map['capacityProvider'] == null ? null : map['capacityProvider'] as String,
