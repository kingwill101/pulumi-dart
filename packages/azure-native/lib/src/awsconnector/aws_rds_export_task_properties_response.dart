...
class AwsRdsExportTaskPropertiesResponse {
  ...
  final ExportSourceTypeEnumValueResponse? sourceType;
  ...
  factory AwsRdsExportTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRdsExportTaskPropertiesResponse(
      ...
      sourceType: map['sourceType'] == null ? null : ExportSourceTypeEnumValueResponse.fromMap((map['sourceType'] as Map).cast<String, dynamic>()),
