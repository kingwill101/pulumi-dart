...
class EfsMountTargetProperties {
  ...
  /// AWS Properties
  final AwsEfsMountTargetProperties? awsProperties;
  /// AWS Region
  ...
  factory EfsMountTargetProperties.fromMap(Map<String, dynamic> map) {
    return EfsMountTargetProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEfsMountTargetProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
