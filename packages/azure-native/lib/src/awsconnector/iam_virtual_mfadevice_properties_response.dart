...
class IamVirtualMFADevicePropertiesResponse {
  ...
  /// AWS Properties
  final AwsIamVirtualMFADevicePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory IamVirtualMFADevicePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamVirtualMFADevicePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamVirtualMFADevicePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
