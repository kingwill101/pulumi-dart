...
class Macie2JobSummaryArgs {
  ...
  Macie2JobSummaryArgs({
    ...
    Map<String, String>? tags,
      ...
      properties = pulumi.Input.asOptionalInput<Macie2JobSummaryProperties>(properties),
  ...
  factory Macie2JobSummaryArgs.fromMap(Map<String, dynamic> map) {
    return Macie2JobSummaryArgs(
      ...
      properties: map['properties'] == null ? null : Macie2JobSummaryProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
