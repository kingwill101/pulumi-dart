...
class Ec2SecurityGroupPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2SecurityGroupPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2SecurityGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2SecurityGroupPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2SecurityGroupPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
