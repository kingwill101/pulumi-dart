...
class KmsKeyProperties {
  ...
  /// AWS Properties
  final AwsKmsKeyProperties? awsProperties;
  /// AWS Region
  ...
  factory KmsKeyProperties.fromMap(Map<String, dynamic> map) {
    return KmsKeyProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsKmsKeyProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
