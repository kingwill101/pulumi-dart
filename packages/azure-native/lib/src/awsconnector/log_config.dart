...
class LogConfig {
  ...
  final FieldLogLevelEnumValue? fieldLogLevel;
  ...
  factory LogConfig.fromMap(Map<String, dynamic> map) {
    return LogConfig(
      ...
      fieldLogLevel: map['fieldLogLevel'] == null ? null : FieldLogLevelEnumValue.fromMap((map['fieldLogLevel'] as Map).cast<String, dynamic>()),
    );
  }
}
