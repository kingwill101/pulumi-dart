...
class CloudWatchAlarmProperties {
  ...
  /// AWS Properties
  final AwsCloudWatchAlarmProperties? awsProperties;
  /// AWS Region
  ...
  factory CloudWatchAlarmProperties.fromMap(Map<String, dynamic> map) {
    return CloudWatchAlarmProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudWatchAlarmProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
