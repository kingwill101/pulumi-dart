...
import 'aws_cloud_watch_alarm_properties_response.dart';
...
class CloudWatchAlarmPropertiesResponse {
  ...
  /// AWS Properties
  final AwsCloudWatchAlarmPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory CloudWatchAlarmPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudWatchAlarmPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsCloudWatchAlarmPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
