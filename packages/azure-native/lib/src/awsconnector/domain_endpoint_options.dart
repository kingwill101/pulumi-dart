...
class DomainEndpointOptions {
  ...
  final TLSSecurityPolicyEnumValue? tlsSecurityPolicy;
  ...
  factory DomainEndpointOptions.fromMap(Map<String, dynamic> map) {
    return DomainEndpointOptions(
      ...
      tlsSecurityPolicy: map['tlsSecurityPolicy'] == null ? null : TLSSecurityPolicyEnumValue.fromMap((map['tlsSecurityPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
