...
class EcrImageDetailProperties {
  ...
  /// AWS Properties
  final AwsEcrImageDetailProperties? awsProperties;
  /// AWS Region
  ...
  factory EcrImageDetailProperties.fromMap(Map<String, dynamic> map) {
    return EcrImageDetailProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcrImageDetailProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
