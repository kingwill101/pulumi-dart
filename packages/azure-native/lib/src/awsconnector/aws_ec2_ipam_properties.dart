...
class AwsEc2IpamProperties {
  ...
  final IpamStateEnumValue? state;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'operatingRegions': ?operatingRegions == null ? null : pulumi.Input.encodeList<IpamOperatingRegion, Map<String, dynamic>>(operatingRegions!, (value) => value.toMap()),
      'ownerId': ?ownerId,
  ...
  factory AwsEc2IpamProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2IpamProperties(
      ...
      operatingRegions: map['operatingRegions'] == null ? null : pulumi.Input.decodeList<IpamOperatingRegion>(map['operatingRegions'], (value) => IpamOperatingRegion.fromMap((value as Map).cast<String, dynamic>())),
      ...
      state: map['state'] == null ? null : IpamStateEnumValue.fromMap((map['state'] as Map).cast<String, dynamic>()),
      ...
      tier: map['tier'] == null ? null : IpamTierEnumValue.fromMap((map['tier'] as Map).cast<String, dynamic>()),
    );
  }
}
