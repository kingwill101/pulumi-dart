...
class NetworkFirewallFirewallPolicyArgs {
  ...
  NetworkFirewallFirewallPolicyArgs({
    String? location,
    String? name,
    NetworkFirewallFirewallPolicyProperties? properties,
  ...
  factory NetworkFirewallFirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallFirewallPolicyArgs(
      ...
      properties: map['properties'] == null ? null : NetworkFirewallFirewallPolicyProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
