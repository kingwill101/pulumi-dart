...
import 'aws_wafv2_logging_configuration_properties.dart';

/// Definition of Wafv2LoggingConfiguration
class Wafv2LoggingConfigurationProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsWafv2LoggingConfigurationProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Wafv2LoggingConfigurationProperties].
  ...
  factory Wafv2LoggingConfigurationProperties.fromMap(Map<String, dynamic> map) {
    return Wafv2LoggingConfigurationProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsWafv2LoggingConfigurationProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
