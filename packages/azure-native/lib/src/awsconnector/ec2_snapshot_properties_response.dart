...
import 'aws_ec2_snapshot_properties_response.dart';

/// Definition of Ec2Snapshot
class Ec2SnapshotPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEc2SnapshotPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2SnapshotPropertiesResponse].
  ...
  factory Ec2SnapshotPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2SnapshotPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEc2SnapshotPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
