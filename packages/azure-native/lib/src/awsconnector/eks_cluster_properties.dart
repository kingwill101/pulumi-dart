...
import 'aws_eks_cluster_properties.dart';

/// Definition of EksCluster
class EksClusterProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEksClusterProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EksClusterProperties].
  ...
  factory EksClusterProperties.fromMap(Map<String, dynamic> map) {
    return EksClusterProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEksClusterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
