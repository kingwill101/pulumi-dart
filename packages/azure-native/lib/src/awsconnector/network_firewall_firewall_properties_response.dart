...
class NetworkFirewallFirewallPropertiesResponse {
  ...
  /// AWS Properties
  final AwsNetworkFirewallFirewallPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory NetworkFirewallFirewallPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallFirewallPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsNetworkFirewallFirewallPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
