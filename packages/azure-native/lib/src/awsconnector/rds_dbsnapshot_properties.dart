...
class RdsDBSnapshotProperties {
  ...
  /// AWS Properties
  final AwsRdsDBSnapshotProperties? awsProperties;
  /// AWS Region
  ...
  factory RdsDBSnapshotProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBSnapshotProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
