...
class Ec2IpamProperties {
  ...
  /// AWS Properties
  final AwsEc2IpamProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2IpamProperties.fromMap(Map<String, dynamic> map) {
    return Ec2IpamProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2IpamProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
