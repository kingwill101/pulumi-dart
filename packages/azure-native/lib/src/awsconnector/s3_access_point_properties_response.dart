...
class S3AccessPointPropertiesResponse {
  ...
  /// AWS Properties
  final AwsS3AccessPointPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory S3AccessPointPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3AccessPointPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3AccessPointPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
