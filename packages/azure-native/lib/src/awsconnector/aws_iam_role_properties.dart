...
class AwsIamRoleProperties {
  ...
  final dynamic assumeRolePolicyDocument;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'policies': ?policies == null ? null : pulumi.Input.encodeList<Policy, Map<String, dynamic>>(policies!, (value) => value.toMap()),
      'roleId': ?roleId,
      'roleName': ?roleName,
  ...
  factory AwsIamRoleProperties.fromMap(Map<String, dynamic> map) {
    return AwsIamRoleProperties(
      ...
      assumeRolePolicyDocument: map['assumeRolePolicyDocument'] == null ? null : map['assumeRolePolicyDocument'],
      ...
      policies: map['policies'] == null ? null : pulumi.Input.decodeList<Policy>(map['policies'], (value) => Policy.fromMap((value as Map).cast<String, dynamic>())),
