...
class EfsFileSystemProperties {
  ...
  /// AWS Properties
  final AwsEfsFileSystemProperties? awsProperties;
  /// AWS Region
  ...
  factory EfsFileSystemProperties.fromMap(Map<String, dynamic> map) {
    return EfsFileSystemProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEfsFileSystemProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
