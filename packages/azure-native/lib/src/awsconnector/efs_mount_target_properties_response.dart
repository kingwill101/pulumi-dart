...
import 'aws_efs_mount_target_properties_response.dart';

/// Definition of EfsMountTarget
class EfsMountTargetPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEfsMountTargetPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EfsMountTargetPropertiesResponse].
  ...
  factory EfsMountTargetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EfsMountTargetPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEfsMountTargetPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
