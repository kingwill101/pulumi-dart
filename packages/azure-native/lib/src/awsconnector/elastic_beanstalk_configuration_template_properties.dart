...
class ElasticBeanstalkConfigurationTemplateProperties {
  ...
  /// AWS Properties
  final AwsElasticBeanstalkConfigurationTemplateProperties? awsProperties;
  /// AWS Region
  ...
  factory ElasticBeanstalkConfigurationTemplateProperties.fromMap(Map<String, dynamic> map) {
    return ElasticBeanstalkConfigurationTemplateProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsElasticBeanstalkConfigurationTemplateProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
