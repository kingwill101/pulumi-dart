...
import 'aws_logs_metric_filter_properties.dart';

/// Definition of LogsMetricFilter
class LogsMetricFilterProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsLogsMetricFilterProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LogsMetricFilterProperties].
  ...
  factory LogsMetricFilterProperties.fromMap(Map<String, dynamic> map) {
    return LogsMetricFilterProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsLogsMetricFilterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
