...
class LinuxParameters {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tmpfs': ?tmpfs == null ? null : pulumi.Input.encodeList<Tmpfs, Map<String, dynamic>>(tmpfs!, (value) => value.toMap()),
    };
  }

  factory LinuxParameters.fromMap(Map<String, dynamic> map) {
    return LinuxParameters(
      capabilities: map['capabilities'] == null ? null : KernelCapabilities.fromMap((map['capabilities'] as Map).cast<String, dynamic>()),
      ...
      tmpfs: map['tmpfs'] == null ? null : pulumi.Input.decodeList<Tmpfs>(map['tmpfs'], (value) => Tmpfs.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
