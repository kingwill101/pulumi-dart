...
import 'aws_eks_nodegroup_properties.dart';

/// Definition of EksNodegroup
class EksNodegroupProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEksNodegroupProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EksNodegroupProperties].
  ...
  factory EksNodegroupProperties.fromMap(Map<String, dynamic> map) {
    return EksNodegroupProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEksNodegroupProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
