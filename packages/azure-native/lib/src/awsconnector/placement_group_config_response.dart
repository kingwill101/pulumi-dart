...
class PlacementGroupConfigResponse {
  ...
  final InstanceRoleTypeEnumValueResponse? instanceRole;
  ...
  final PlacementGroupStrategyEnumValueResponse? placementStrategy;
  ...
  factory PlacementGroupConfigResponse.fromMap(Map<String, dynamic> map) {
    return PlacementGroupConfigResponse(
      instanceRole: map['instanceRole'] == null ? null : InstanceRoleTypeEnumValueResponse.fromMap((map['instanceRole'] as Map).cast<String, dynamic>()),
      placementStrategy: map['placementStrategy'] == null ? null : PlacementGroupStrategyEnumValueResponse.fromMap((map['placementStrategy'] as Map).cast<String, dynamic>()),
    );
  }
}
