...
class RdsDBInstanceProperties {
  ...
  /// AWS Properties
  final AwsRdsDBInstanceProperties? awsProperties;
  /// AWS Region
  ...
  factory RdsDBInstanceProperties.fromMap(Map<String, dynamic> map) {
    return RdsDBInstanceProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBInstanceProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
