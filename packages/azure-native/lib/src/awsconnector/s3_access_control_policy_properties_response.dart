...
class S3AccessControlPolicyPropertiesResponse {
  ...
  /// AWS Properties
  final AwsS3AccessControlPolicyPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory S3AccessControlPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3AccessControlPolicyPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3AccessControlPolicyPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
