...
class IamPolicyVersionPropertiesResponse {
  ...
  /// AWS Properties
  final AwsIamPolicyVersionPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory IamPolicyVersionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamPolicyVersionPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamPolicyVersionPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
