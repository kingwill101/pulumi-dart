...
class ReplicationRuleFilterResponse {
  ...
  final ReplicationRuleAndOperatorResponse? and;
  ...
  final TagFilterResponse? tagFilter;
  ...
  factory ReplicationRuleFilterResponse.fromMap(Map<String, dynamic> map) {
    return ReplicationRuleFilterResponse(
      and: map['and'] == null ? null : ReplicationRuleAndOperatorResponse.fromMap((map['and'] as Map).cast<String, dynamic>()),
      prefix: map['prefix'] == null ? null : map['prefix'] as String,
      tagFilter: map['tagFilter'] == null ? null : TagFilterResponse.fromMap((map['tagFilter'] as Map).cast<String, dynamic>()),
    );
  }
}
