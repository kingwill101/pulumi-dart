...
class RdsDBClusterPropertiesResponse {
  ...
  /// AWS Properties
  final AwsRdsDBClusterPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory RdsDBClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBClusterPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBClusterPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
