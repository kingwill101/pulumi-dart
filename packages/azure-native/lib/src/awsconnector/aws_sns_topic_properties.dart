...
class AwsSnsTopicProperties {
  ...
  final List<LoggingConfig>? deliveryStatusLogging;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'deliveryStatusLogging': ?deliveryStatusLogging == null ? null : pulumi.Input.encodeList<LoggingConfig, Map<String, dynamic>>(deliveryStatusLogging!, (value) => value.toMap()),
      'displayName': ?displayName,
      'fifoTopic': ?fifoTopic,
      'kmsMasterKeyId': ?kmsMasterKeyId,
      'signatureVersion': ?signatureVersion,
      'subscription': ?subscription == null ? null : pulumi.Input.encodeList<Subscription, Map<String, dynamic>>(subscription!, (value) => value.toMap()),
  ...
  factory AwsSnsTopicProperties.fromMap(Map<String, dynamic> map) {
    return AwsSnsTopicProperties(
      ...
      deliveryStatusLogging: map['deliveryStatusLogging'] == null ? null : pulumi.Input.decodeList<LoggingConfig>(map['deliveryStatusLogging'], (value) => LoggingConfig.fromMap((value as Map).cast<String, dynamic>())),
      ...
      subscription: map['subscription'] == null ? null : pulumi.Input.decodeList<Subscription>(map['subscription'], (value) => Subscription.fromMap((value as Map).cast<String, dynamic>())),
