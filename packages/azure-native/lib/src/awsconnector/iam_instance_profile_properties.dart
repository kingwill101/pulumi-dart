...
class IamInstanceProfileProperties {
  ...
  /// AWS Properties
  final AwsIamInstanceProfileProperties? awsProperties;
  /// AWS Region
  ...
  factory IamInstanceProfileProperties.fromMap(Map<String, dynamic> map) {
    return IamInstanceProfileProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamInstanceProfileProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
