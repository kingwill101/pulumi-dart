...
import 'aws_organizations_organization_properties_response.dart';

/// Definition of OrganizationsOrganization
class OrganizationsOrganizationPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsOrganizationsOrganizationPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [OrganizationsOrganizationPropertiesResponse].
  ...
  factory OrganizationsOrganizationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return OrganizationsOrganizationPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsOrganizationsOrganizationPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
