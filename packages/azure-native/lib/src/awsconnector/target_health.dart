...
class TargetHealth {
  ...
  final TargetHealthReasonEnumEnumValue? reason;
  /// <p>The state of the target.</p>
  final TargetHealthStateEnumEnumValue? state;
  ...
  factory TargetHealth.fromMap(Map<String, dynamic> map) {
    return TargetHealth(
      ...
      reason: map['reason'] == null ? null : TargetHealthReasonEnumEnumValue.fromMap((map['reason'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : TargetHealthStateEnumEnumValue.fromMap((map['state'] as Map).cast<String, dynamic>()),
    );
  }
}
