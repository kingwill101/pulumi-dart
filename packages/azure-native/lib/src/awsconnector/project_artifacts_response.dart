...
class ProjectArtifactsResponse {
  ...
  final BucketOwnerAccessEnumValueResponse? bucketOwnerAccess;
  ...
  final ArtifactNamespaceEnumValueResponse? namespaceType;
  ...
  final ArtifactPackagingEnumValueResponse? packaging;
  ...
  final ArtifactsTypeEnumValueResponse? type;
  ...
  factory ProjectArtifactsResponse.fromMap(Map<String, dynamic> map) {
    return ProjectArtifactsResponse(
      ...
      bucketOwnerAccess: map['bucketOwnerAccess'] == null ? null : BucketOwnerAccessEnumValueResponse.fromMap((map['bucketOwnerAccess'] as Map).cast<String, dynamic>()),
      encryptionDisabled: map['encryptionDisabled'] == null ? null : map['encryptionDisabled'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      namespaceType: map['namespaceType'] == null ? null : ArtifactNamespaceEnumValueResponse.fromMap((map['namespaceType'] as Map).cast<String, dynamic>()),
      overrideArtifactName: map['overrideArtifactName'] == null ? null : map['overrideArtifactName'] as bool,
      packaging: map['packaging'] == null ? null : ArtifactPackagingEnumValueResponse.fromMap((map['packaging'] as Map).cast<String, dynamic>()),
      path: map['path'] == null ? null : map['path'] as String,
      type: map['type'] == null ? null : ArtifactsTypeEnumValueResponse.fromMap((map['type'] as Map).cast<String, dynamic>()),
    );
  }
}
