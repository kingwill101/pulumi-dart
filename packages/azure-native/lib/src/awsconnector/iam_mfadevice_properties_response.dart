...
import 'aws_iam_mfadevice_properties_response.dart';

/// Definition of IamMFADevice
class IamMFADevicePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsIamMFADevicePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamMFADevicePropertiesResponse].
  ...
  factory IamMFADevicePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamMFADevicePropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsIamMFADevicePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
