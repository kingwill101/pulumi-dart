...
class ServiceConnectServiceResponse {
  ...
  final List<ServiceConnectClientAliasResponse>? clientAliases;
  ...
  final TimeoutConfigurationResponse? timeout;
  ...
  final ServiceConnectTlsConfigurationResponse? tls;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientAliases': ?clientAliases == null ? null : pulumi.Input.encodeList<ServiceConnectClientAliasResponse, Map<String, dynamic>>(clientAliases!, (value) => value.toMap()),
  ...
  factory ServiceConnectServiceResponse.fromMap(Map<String, dynamic> map) {
    return ServiceConnectServiceResponse(
      clientAliases: map['clientAliases'] == null ? null : pulumi.Input.decodeList<ServiceConnectClientAliasResponse>(map['clientAliases'], (value) => ServiceConnectClientAliasResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      timeout: map['timeout'] == null ? null : TimeoutConfigurationResponse.fromMap((map['timeout'] as Map).cast<String, dynamic>()),
      tls: map['tls'] == null ? null : ServiceConnectTlsConfigurationResponse.fromMap((map['tls'] as Map).cast<String, dynamic>()),
    );
  }
}
