...
class IamPasswordPolicyPropertiesResponse {
  ...
  /// AWS Properties
  final AwsIamPasswordPolicyPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory IamPasswordPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamPasswordPolicyPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamPasswordPolicyPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
