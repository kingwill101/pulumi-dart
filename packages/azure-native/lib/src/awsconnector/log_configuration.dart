...
class LogConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logDriver': ?logDriver,
      'options': ?options,
      'secretOptions': ?secretOptions == null ? null : pulumi.Input.encodeList<Secret, Map<String, dynamic>>(secretOptions!, (value) => value.toMap()),
    };
  }

  factory LogConfiguration.fromMap(Map<String, dynamic> map) {
    return LogConfiguration(
      logDriver: map['logDriver'] == null ? null : map['logDriver'] as String,
      options: map['options'] == null ? null : map['options'],
      secretOptions: map['secretOptions'] == null ? null : pulumi.Input.decodeList<Secret>(map['secretOptions'], (value) => Secret.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
