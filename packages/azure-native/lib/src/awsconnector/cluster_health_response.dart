...
class ClusterHealthResponse {
  ...
  final List<ClusterIssueResponse>? issues;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'issues': ?issues == null ? null : pulumi.Input.encodeList<ClusterIssueResponse, Map<String, dynamic>>(issues!, (value) => value.toMap()),
    };
  }

  factory ClusterHealthResponse.fromMap(Map<String, dynamic> map) {
    return ClusterHealthResponse(
      issues: map['issues'] == null ? null : pulumi.Input.decodeList<ClusterIssueResponse>(map['issues'], (value) => ClusterIssueResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
