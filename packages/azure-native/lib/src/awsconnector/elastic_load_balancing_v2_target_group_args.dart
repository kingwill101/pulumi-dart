...
class ElasticLoadBalancingV2TargetGroupArgs {
  ...
  ElasticLoadBalancingV2TargetGroupArgs({
    ...
    Map<String, String>? tags,
      ...
      properties = pulumi.Input.asOptionalInput<ElasticLoadBalancingV2TargetGroupProperties>(properties),
  ...
  factory ElasticLoadBalancingV2TargetGroupArgs.fromMap(Map<String, dynamic> map) {
    return ElasticLoadBalancingV2TargetGroupArgs(
      ...
      properties: map['properties'] == null ? null : ElasticLoadBalancingV2TargetGroupProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
