...
class ServiceManagedEBSVolumeConfiguration {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tagSpecifications': ?tagSpecifications == null ? null : pulumi.Input.encodeList<EBSTagSpecification, Map<String, dynamic>>(tagSpecifications!, (value) => value.toMap()),
  ...
  factory ServiceManagedEBSVolumeConfiguration.fromMap(Map<String, dynamic> map) {
    return ServiceManagedEBSVolumeConfiguration(
      ...
      tagSpecifications: map['tagSpecifications'] == null ? null : pulumi.Input.decodeList<EBSTagSpecification>(map['tagSpecifications'], (value) => EBSTagSpecification.fromMap((value as Map).cast<String, dynamic>())),
