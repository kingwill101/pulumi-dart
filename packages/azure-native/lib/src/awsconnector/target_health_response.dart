...
class TargetHealthResponse {
  ...
  final TargetHealthReasonEnumEnumValueResponse? reason;
  /// <p>The state of the target.</p>
  final TargetHealthStateEnumEnumValueResponse? state;
  ...
  factory TargetHealthResponse.fromMap(Map<String, dynamic> map) {
    return TargetHealthResponse(
      ...
      reason: map['reason'] == null ? null : TargetHealthReasonEnumEnumValueResponse.fromMap((map['reason'] as Map).cast<String, dynamic>()),
      state: map['state'] == null ? null : TargetHealthStateEnumEnumValueResponse.fromMap((map['state'] as Map).cast<String, dynamic>()),
    );
  }
}
