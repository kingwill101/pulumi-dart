...
import 'aws_cloud_trail_trail_properties.dart';

/// Definition of CloudTrailTrail
class CloudTrailTrailProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsCloudTrailTrailProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CloudTrailTrailProperties].
  ...
  factory CloudTrailTrailProperties.fromMap(Map<String, dynamic> map) {
    return CloudTrailTrailProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsCloudTrailTrailProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
