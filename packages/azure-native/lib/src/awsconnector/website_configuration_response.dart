...
class WebsiteConfigurationResponse {
  ...
  final RedirectAllRequestsToResponse? redirectAllRequestsTo;
  ...
  factory WebsiteConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return WebsiteConfigurationResponse(
      ...
      redirectAllRequestsTo: map['redirectAllRequestsTo'] == null ? null : RedirectAllRequestsToResponse.fromMap((map['redirectAllRequestsTo'] as Map).cast<String, dynamic>()),
