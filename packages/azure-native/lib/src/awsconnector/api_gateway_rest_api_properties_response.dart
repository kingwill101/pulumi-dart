...
class ApiGatewayRestApiPropertiesResponse {
  ...
  /// AWS Properties
  final AwsApiGatewayRestApiPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory ApiGatewayRestApiPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApiGatewayRestApiPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsApiGatewayRestApiPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
