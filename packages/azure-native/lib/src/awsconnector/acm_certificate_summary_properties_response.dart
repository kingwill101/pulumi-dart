...
import 'aws_acm_certificate_summary_properties_response.dart';

/// Definition of AcmCertificateSummary
class AcmCertificateSummaryPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsAcmCertificateSummaryPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [AcmCertificateSummaryPropertiesResponse].
  ...
  factory AcmCertificateSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AcmCertificateSummaryPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsAcmCertificateSummaryPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
