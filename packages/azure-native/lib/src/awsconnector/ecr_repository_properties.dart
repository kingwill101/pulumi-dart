...
import 'aws_ecr_repository_properties.dart';

/// Definition of EcrRepository
class EcrRepositoryProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEcrRepositoryProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [EcrRepositoryProperties].
  ...
  factory EcrRepositoryProperties.fromMap(Map<String, dynamic> map) {
    return EcrRepositoryProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEcrRepositoryProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
