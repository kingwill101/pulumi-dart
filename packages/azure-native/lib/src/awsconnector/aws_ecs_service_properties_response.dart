...
class AwsEcsServicePropertiesResponse {
  ...
  final List<CapacityProviderStrategyItemResponse>? capacityProviderStrategy;
  ...
  final DeploymentControllerResponse? deploymentController;
  ...
  final List<LoadBalancerResponse>? loadBalancers;
  /// Property name
  final String? name;
  ...
  final List<PlacementConstraintResponse>? placementConstraints;
  /// The placement strategy objects to use for tasks in your service. You can specify a maximum of 5 strategy rules for each service.
  final List<PlacementStrategyResponse>? placementStrategies;
  ...
  final ServiceConnectConfigurationResponse? serviceConnectConfiguration;
  ...
  final List<ServiceRegistryResponse>? serviceRegistries;
  ...
  final List<ServiceVolumeConfigurationResponse>? volumeConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'capacityProviderStrategy': ?capacityProviderStrategy == null ? null : pulumi.Input.encodeList<CapacityProviderStrategyItemResponse, Map<String, dynamic>>(capacityProviderStrategy!, (value) => value.toMap()),
      'cluster': ?cluster,
      ...
      'loadBalancers': ?loadBalancers == null ? null : pulumi.Input.encodeList<LoadBalancerResponse, Map<String, dynamic>>(loadBalancers!, (value) => value.toMap()),
      'name': ?name,
      'networkConfiguration': ?networkConfiguration == null ? null : networkConfiguration!.toMap(),
      'placementConstraints': ?placementConstraints == null ? null : pulumi.Input.encodeList<PlacementConstraintResponse, Map<String, dynamic>>(placementConstraints!, (value) => value.toMap()),
      'placementStrategies': ?placementStrategies == null ? null : pulumi.Input.encodeList<PlacementStrategyResponse, Map<String, dynamic>>(placementStrategies!, (value) => value.toMap()),
      ...
      'serviceRegistries': ?serviceRegistries == null ? null : pulumi.Input.encodeList<ServiceRegistryResponse, Map<String, dynamic>>(serviceRegistries!, (value) => value.toMap()),
      'tags': ?tags == null ? null : pulumi.Input.encodeList<TagResponse, Map<String, dynamic>>(tags!, (value) => value.toMap()),
      'taskDefinition': ?taskDefinition,
      'volumeConfigurations': ?volumeConfigurations == null ? null : pulumi.Input.encodeList<ServiceVolumeConfigurationResponse, Map<String, dynamic>>(volumeConfigurations!, (value) => value.toMap()),
    };
  }

  factory AwsEcsServicePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEcsServicePropertiesResponse(
      capacityProviderStrategy: map['capacityProviderStrategy'] == null ? null : pulumi.Input.decodeList<CapacityProviderStrategyItemResponse>(map['capacityProviderStrategy'], (value) => CapacityProviderStrategyItemResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      deploymentController: map['deploymentController'] == null ? null : DeploymentControllerResponse.fromMap((map['deploymentController'] as Map).cast<String, dynamic>()),
      ...
      loadBalancers: map['loadBalancers'] == null ? null : pulumi.Input.decodeList<LoadBalancerResponse>(map['loadBalancers'], (value) => LoadBalancerResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      placementConstraints: map['placementConstraints'] == null ? null : pulumi.Input.decodeList<PlacementConstraintResponse>(map['placementConstraints'], (value) => PlacementConstraintResponse.fromMap((value as Map).cast<String, dynamic>())),
      placementStrategies: map['placementStrategies'] == null ? null : pulumi.Input.decodeList<PlacementStrategyResponse>(map['placementStrategies'], (value) => PlacementStrategyResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      serviceConnectConfiguration: map['serviceConnectConfiguration'] == null ? null : ServiceConnectConfigurationResponse.fromMap((map['serviceConnectConfiguration'] as Map).cast<String, dynamic>()),
      serviceName: map['serviceName'] == null ? null : map['serviceName'] as String,
      serviceRegistries: map['serviceRegistries'] == null ? null : pulumi.Input.decodeList<ServiceRegistryResponse>(map['serviceRegistries'], (value) => ServiceRegistryResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      volumeConfigurations: map['volumeConfigurations'] == null ? null : pulumi.Input.decodeList<ServiceVolumeConfigurationResponse>(map['volumeConfigurations'], (value) => ServiceVolumeConfigurationResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
