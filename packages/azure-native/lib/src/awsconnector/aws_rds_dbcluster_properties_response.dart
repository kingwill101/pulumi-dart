...
class AwsRdsDBClusterPropertiesResponse {
  ...
  final List<DBClusterRoleResponse>? associatedRoles;
  ...
  /// Property endpoint
  final RdsDbClusterEndpointResponse? endpoint;
  ...
  final MasterUserSecretResponse? masterUserSecret;
  ...
  final ReadEndpointResponse? readEndpoint;
  ...
  final ScalingConfigurationResponse? scalingConfiguration;
  ...
  final ServerlessV2ScalingConfigurationResponse? serverlessV2ScalingConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'associatedRoles': ?associatedRoles == null ? null : pulumi.Input.encodeList<DBClusterRoleResponse, Map<String, dynamic>>(associatedRoles!, (value) => value.toMap()),
  ...
  factory AwsRdsDBClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBClusterPropertiesResponse(
      ...
      associatedRoles: map['associatedRoles'] == null ? null : pulumi.Input.decodeList<DBClusterRoleResponse>(map['associatedRoles'], (value) => DBClusterRoleResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      endpoint: map['endpoint'] == null ? null : RdsDbClusterEndpointResponse.fromMap((map['endpoint'] as Map).cast<String, dynamic>()),
      ...
      masterUserSecret: map['masterUserSecret'] == null ? null : MasterUserSecretResponse.fromMap((map['masterUserSecret'] as Map).cast<String, dynamic>()),
      ...
      readEndpoint: map['readEndpoint'] == null ? null : ReadEndpointResponse.fromMap((map['readEndpoint'] as Map).cast<String, dynamic>()),
      ...
      scalingConfiguration: map['scalingConfiguration'] == null ? null : ScalingConfigurationResponse.fromMap((map['scalingConfiguration'] as Map).cast<String, dynamic>()),
      serverlessV2ScalingConfiguration: map['serverlessV2ScalingConfiguration'] == null ? null : ServerlessV2ScalingConfigurationResponse.fromMap((map['serverlessV2ScalingConfiguration'] as Map).cast<String, dynamic>()),
