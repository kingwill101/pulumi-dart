...
class S3BucketPropertiesResponse {
  ...
  /// AWS Properties
  final AwsS3BucketPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory S3BucketPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3BucketPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3BucketPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
