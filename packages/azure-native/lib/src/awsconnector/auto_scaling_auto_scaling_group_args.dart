...
class AutoScalingAutoScalingGroupArgs {
  ...
  AutoScalingAutoScalingGroupArgs({
    String? location,
    String? name,
    AutoScalingAutoScalingGroupProperties? properties,
    required String resourceGroupName,
    Map<String, String>? tags,
  }) :
      location = pulumi.Input.asOptionalInput<String>(location),
      name = pulumi.Input.asOptionalInput<String>(name),
      properties = pulumi.Input.asOptionalInput<AutoScalingAutoScalingGroupProperties>(properties),
  ...
  factory AutoScalingAutoScalingGroupArgs.fromMap(Map<String, dynamic> map) {
    return AutoScalingAutoScalingGroupArgs(
      ...
      properties: map['properties'] == null ? null : AutoScalingAutoScalingGroupProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
