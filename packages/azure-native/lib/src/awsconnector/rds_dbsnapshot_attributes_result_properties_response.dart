...
class RdsDBSnapshotAttributesResultPropertiesResponse {
  ...
  /// AWS Properties
  final AwsRdsDBSnapshotAttributesResultPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory RdsDBSnapshotAttributesResultPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBSnapshotAttributesResultPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBSnapshotAttributesResultPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
