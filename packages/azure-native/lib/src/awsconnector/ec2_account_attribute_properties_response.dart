...
class Ec2AccountAttributePropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2AccountAttributePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2AccountAttributePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2AccountAttributePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2AccountAttributePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
