...
class Ec2FlowLogProperties {
  ...
  /// AWS Properties
  final AwsEc2FlowLogProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2FlowLogProperties.fromMap(Map<String, dynamic> map) {
    return Ec2FlowLogProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2FlowLogProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
