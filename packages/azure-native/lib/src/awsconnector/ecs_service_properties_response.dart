...
class EcsServicePropertiesResponse {
  ...
  /// AWS Properties
  final AwsEcsServicePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory EcsServicePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EcsServicePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEcsServicePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
