...
class AwsEfsFileSystemPropertiesResponse {
  /// Property arn
  final String? arn;
  ...
  /// Creates a new [AwsEfsFileSystemPropertiesResponse].
  /// [arn] Property arn
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileSystemProtection': ?fileSystemProtection == null ? null : fileSystemProtection!.toMap(),
      'fileSystemTags': ?fileSystemTags == null ? null : pulumi.Input.encodeList<ElasticFileSystemTagResponse, Map<String, dynamic>>(fileSystemTags!, (value) => value.toMap()),
      'kmsKeyId': ?kmsKeyId,
      'lifecyclePolicies': ?lifecyclePolicies == null ? null : pulumi.Input.encodeList<LifecyclePolicyResponse, Map<String, dynamic>>(lifecyclePolicies!, (value) => value.toMap()),
  ...
  factory AwsEfsFileSystemPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsEfsFileSystemPropertiesResponse(
      ...
      fileSystemPolicy: map['fileSystemPolicy'] == null ? null : map['fileSystemPolicy'],
      fileSystemProtection: map['fileSystemProtection'] == null ? null : FileSystemProtectionResponse.fromMap((map['fileSystemProtection'] as Map).cast<String, dynamic>()),
      fileSystemTags: map['fileSystemTags'] == null ? null : pulumi.Input.decodeList<ElasticFileSystemTagResponse>(map['fileSystemTags'], (value) => ElasticFileSystemTagResponse.fromMap((value as Map).cast<String, dynamic>())),
      kmsKeyId: map['kmsKeyId'] == null ? null : map['kmsKeyId'] as String,
      lifecyclePolicies: map['lifecyclePolicies'] == null ? null : pulumi.Input.decodeList<LifecyclePolicyResponse>(map['lifecyclePolicies'], (value) => LifecyclePolicyResponse.fromMap((value as Map).cast<String, dynamic>())),
      performanceMode: map['performanceMode'] == null ? null : map['performanceMode'] as String,
