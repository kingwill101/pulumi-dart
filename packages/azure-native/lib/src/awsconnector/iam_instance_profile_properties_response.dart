...
class IamInstanceProfilePropertiesResponse {
  ...
  /// AWS Properties
  final AwsIamInstanceProfilePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory IamInstanceProfilePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamInstanceProfilePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamInstanceProfilePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
