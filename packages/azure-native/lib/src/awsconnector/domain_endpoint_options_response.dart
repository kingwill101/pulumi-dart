...
class DomainEndpointOptionsResponse {
  ...
  final TLSSecurityPolicyEnumValueResponse? tlsSecurityPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tlsSecurityPolicy': ?tlsSecurityPolicy == null ? null : tlsSecurityPolicy!.toMap(),
    };
  }
  ...
  factory DomainEndpointOptionsResponse.fromMap(Map<String, dynamic> map) {
    return DomainEndpointOptionsResponse(
      ...
      tlsSecurityPolicy: map['tlsSecurityPolicy'] == null ? null : TLSSecurityPolicyEnumValueResponse.fromMap((map['tlsSecurityPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
