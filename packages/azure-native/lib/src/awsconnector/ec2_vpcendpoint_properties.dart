...
import 'aws_ec2_vpcendpoint_properties.dart';

/// Definition of Ec2VPCEndpoint
class Ec2VPCEndpointProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEc2VPCEndpointProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2VPCEndpointProperties].
  ...
  factory Ec2VPCEndpointProperties.fromMap(Map<String, dynamic> map) {
    return Ec2VPCEndpointProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEc2VPCEndpointProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
