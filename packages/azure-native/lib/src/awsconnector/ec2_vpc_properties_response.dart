...
class Ec2VpcPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2VpcPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2VpcPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2VpcPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2VpcPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
