...
class OutpostConfigResponseResponse {
  ...
  final ControlPlanePlacementResponseResponse? controlPlanePlacement;
  ...
  factory OutpostConfigResponseResponse.fromMap(Map<String, dynamic> map) {
    return OutpostConfigResponseResponse(
      ...
      controlPlanePlacement: map['controlPlanePlacement'] == null ? null : ControlPlanePlacementResponseResponse.fromMap((map['controlPlanePlacement'] as Map).cast<String, dynamic>()),
