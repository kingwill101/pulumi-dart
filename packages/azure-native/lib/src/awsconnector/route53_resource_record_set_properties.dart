...
class Route53ResourceRecordSetProperties {
  ...
  /// AWS Properties
  final AwsRoute53ResourceRecordSetProperties? awsProperties;
  /// AWS Region
  ...
  factory Route53ResourceRecordSetProperties.fromMap(Map<String, dynamic> map) {
    return Route53ResourceRecordSetProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRoute53ResourceRecordSetProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
