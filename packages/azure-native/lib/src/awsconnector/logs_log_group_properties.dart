...
import 'aws_logs_log_group_properties.dart';

/// Definition of LogsLogGroup
class LogsLogGroupProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsLogsLogGroupProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [LogsLogGroupProperties].
  ...
  factory LogsLogGroupProperties.fromMap(Map<String, dynamic> map) {
    return LogsLogGroupProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsLogsLogGroupProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
