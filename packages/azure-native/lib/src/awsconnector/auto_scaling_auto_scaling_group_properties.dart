...
class AutoScalingAutoScalingGroupProperties {
  ...
  /// AWS Properties
  final AwsAutoScalingAutoScalingGroupProperties? awsProperties;
  /// AWS Region
  ...
  factory AutoScalingAutoScalingGroupProperties.fromMap(Map<String, dynamic> map) {
    return AutoScalingAutoScalingGroupProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsAutoScalingAutoScalingGroupProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
