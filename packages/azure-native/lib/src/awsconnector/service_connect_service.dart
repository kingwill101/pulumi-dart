...
class ServiceConnectService {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'clientAliases': ?clientAliases == null ? null : pulumi.Input.encodeList<ServiceConnectClientAlias, Map<String, dynamic>>(clientAliases!, (value) => value.toMap()),
  ...
  factory ServiceConnectService.fromMap(Map<String, dynamic> map) {
    return ServiceConnectService(
      clientAliases: map['clientAliases'] == null ? null : pulumi.Input.decodeList<ServiceConnectClientAlias>(map['clientAliases'], (value) => ServiceConnectClientAlias.fromMap((value as Map).cast<String, dynamic>())),
      ...
      timeout: map['timeout'] == null ? null : TimeoutConfiguration.fromMap((map['timeout'] as Map).cast<String, dynamic>()),
      tls: map['tls'] == null ? null : ServiceConnectTlsConfiguration.fromMap((map['tls'] as Map).cast<String, dynamic>()),
    );
  }
}
