...
class LogsLogStreamProperties {
  ...
  /// AWS Properties
  final AwsLogsLogStreamProperties? awsProperties;
  /// AWS Region
  ...
  factory LogsLogStreamProperties.fromMap(Map<String, dynamic> map) {
    return LogsLogStreamProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLogsLogStreamProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
