...
class CloudFormationStackProperties {
  ...
  /// AWS Properties
  final AwsCloudFormationStackProperties? awsProperties;
  /// AWS Region
  ...
  factory CloudFormationStackProperties.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudFormationStackProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
