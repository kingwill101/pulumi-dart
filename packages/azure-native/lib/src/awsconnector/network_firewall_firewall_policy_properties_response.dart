...
import 'aws_network_firewall_firewall_policy_properties_response.dart';

/// Definition of NetworkFirewallFirewallPolicy
class NetworkFirewallFirewallPolicyPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsNetworkFirewallFirewallPolicyPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [NetworkFirewallFirewallPolicyPropertiesResponse].
  ...
  factory NetworkFirewallFirewallPolicyPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallFirewallPolicyPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsNetworkFirewallFirewallPolicyPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
