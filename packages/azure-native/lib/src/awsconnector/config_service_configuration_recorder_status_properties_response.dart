...
class ConfigServiceConfigurationRecorderStatusPropertiesResponse {
  ...
  /// AWS Properties
  final AwsConfigServiceConfigurationRecorderStatusPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory ConfigServiceConfigurationRecorderStatusPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConfigServiceConfigurationRecorderStatusPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsConfigServiceConfigurationRecorderStatusPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
