...
import 'aws_sqs_queue_properties.dart';
...
class SqsQueueProperties {
  ...
  /// AWS Properties
  final AwsSqsQueueProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SqsQueueProperties].
  ...
  factory SqsQueueProperties.fromMap(Map<String, dynamic> map) {
    return SqsQueueProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsSqsQueueProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
