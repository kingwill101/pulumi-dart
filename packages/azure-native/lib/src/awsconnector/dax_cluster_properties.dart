...
class DaxClusterProperties {
  ...
  /// AWS Properties
  final AwsDaxClusterProperties? awsProperties;
  /// AWS Region
  ...
  factory DaxClusterProperties.fromMap(Map<String, dynamic> map) {
    return DaxClusterProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsDaxClusterProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
