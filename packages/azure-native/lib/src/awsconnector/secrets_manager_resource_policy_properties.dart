...
class SecretsManagerResourcePolicyProperties {
  ...
  /// AWS Properties
  final AwsSecretsManagerResourcePolicyProperties? awsProperties;
  /// AWS Region
  ...
  factory SecretsManagerResourcePolicyProperties.fromMap(Map<String, dynamic> map) {
    return SecretsManagerResourcePolicyProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSecretsManagerResourcePolicyProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
