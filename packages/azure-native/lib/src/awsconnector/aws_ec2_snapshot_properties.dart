...
class AwsEc2SnapshotProperties {
  ...
  final SSETypeEnumValue? sseType;
  /// <p>The time stamp when the snapshot was initiated.</p>
  final String? startTime;
  /// <p>The snapshot state.</p>
  final SnapshotStateEnumValue? state;
  ...
  final StorageTierEnumValue? storageTier;
  ...
  factory AwsEc2SnapshotProperties.fromMap(Map<String, dynamic> map) {
    return AwsEc2SnapshotProperties(
      ...
      sseType: map['sseType'] == null ? null : SSETypeEnumValue.fromMap((map['sseType'] as Map).cast<String, dynamic>()),
      startTime: map['startTime'] == null ? null : map['startTime'] as String,
      state: map['state'] == null ? null : SnapshotStateEnumValue.fromMap((map['state'] as Map).cast<String, dynamic>()),
      stateMessage: map['stateMessage'] == null ? null : map['stateMessage'] as String,
      storageTier: map['storageTier'] == null ? null : StorageTierEnumValue.fromMap((map['storageTier'] as Map).cast<String, dynamic>()),
