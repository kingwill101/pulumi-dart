...
import 'recording_group.dart';
import 'recording_mode.dart';

/// Definition of awsConfigServiceConfigurationRecorder
class AwsConfigServiceConfigurationRecorderProperties {
  ...
  /// Creates a new [AwsConfigServiceConfigurationRecorderProperties].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'name': ?name,
      'recordingGroup': ?recordingGroup == null ? null : recordingGroup!.toMap(),
      'recordingMode': ?recordingMode == null ? null : recordingMode!.toMap(),
      'roleARN': ?roleARN,
    };
  }
  ...
  factory AwsConfigServiceConfigurationRecorderProperties.fromMap(Map<String, dynamic> map) {
    return AwsConfigServiceConfigurationRecorderProperties(
      ...
      recordingGroup: map['recordingGroup'] == null ? null : RecordingGroup.fromMap((map['recordingGroup'] as Map).cast<String, dynamic>()),
      recordingMode: map['recordingMode'] == null ? null : RecordingMode.fromMap((map['recordingMode'] as Map).cast<String, dynamic>()),
