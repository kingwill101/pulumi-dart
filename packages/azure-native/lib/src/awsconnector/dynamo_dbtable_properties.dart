...
class DynamoDBTableProperties {
  ...
  /// AWS Properties
  final AwsDynamoDBTableProperties? awsProperties;
  /// AWS Region
  ...
  factory DynamoDBTableProperties.fromMap(Map<String, dynamic> map) {
    return DynamoDBTableProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsDynamoDBTableProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
