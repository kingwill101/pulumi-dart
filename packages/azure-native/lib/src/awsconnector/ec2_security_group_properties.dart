...
class Ec2SecurityGroupProperties {
  ...
  /// AWS Properties
  final AwsEc2SecurityGroupProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2SecurityGroupProperties.fromMap(Map<String, dynamic> map) {
    return Ec2SecurityGroupProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2SecurityGroupProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
