...
import 'aws_ec2_route_table_properties_response.dart';

/// Definition of Ec2RouteTable
class Ec2RouteTablePropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEc2RouteTablePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2RouteTablePropertiesResponse].
  ...
  factory Ec2RouteTablePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2RouteTablePropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEc2RouteTablePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
