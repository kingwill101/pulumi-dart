...
import 'aws_iam_group_properties_response.dart';

/// Definition of IamGroup
class IamGroupPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsIamGroupPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamGroupPropertiesResponse].
  ...
  factory IamGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamGroupPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsIamGroupPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
