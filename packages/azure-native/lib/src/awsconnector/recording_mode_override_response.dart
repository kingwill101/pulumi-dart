...
class RecordingModeOverrideResponse {
  ...
  final RecordingFrequencyEnumValueResponse? recordingFrequency;
  ...
  factory RecordingModeOverrideResponse.fromMap(Map<String, dynamic> map) {
    return RecordingModeOverrideResponse(
      ...
      recordingFrequency: map['recordingFrequency'] == null ? null : RecordingFrequencyEnumValueResponse.fromMap((map['recordingFrequency'] as Map).cast<String, dynamic>()),
