...
class EnvironmentVariableResponse {
  ...
  final EnvironmentVariableTypeEnumValueResponse? type;
  ...
  factory EnvironmentVariableResponse.fromMap(Map<String, dynamic> map) {
    return EnvironmentVariableResponse(
      ...
      type: map['type'] == null ? null : EnvironmentVariableTypeEnumValueResponse.fromMap((map['type'] as Map).cast<String, dynamic>()),
