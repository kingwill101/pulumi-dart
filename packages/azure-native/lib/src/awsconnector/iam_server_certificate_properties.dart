...
class IamServerCertificateProperties {
  ...
  /// AWS Properties
  final AwsIamServerCertificateProperties? awsProperties;
  /// AWS Region
  ...
  factory IamServerCertificateProperties.fromMap(Map<String, dynamic> map) {
    return IamServerCertificateProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamServerCertificateProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
