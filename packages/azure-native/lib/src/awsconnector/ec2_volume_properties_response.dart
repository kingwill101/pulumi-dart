...
import 'aws_ec2_volume_properties_response.dart';
...
class Ec2VolumePropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2VolumePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2VolumePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2VolumePropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEc2VolumePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
