...
class NetworkFirewallRuleGroupPropertiesResponse {
  ...
  /// AWS Properties
  final AwsNetworkFirewallRuleGroupPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory NetworkFirewallRuleGroupPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return NetworkFirewallRuleGroupPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsNetworkFirewallRuleGroupPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
