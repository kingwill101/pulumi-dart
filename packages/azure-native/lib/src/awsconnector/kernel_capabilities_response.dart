...
class KernelCapabilitiesResponse {
  ...
  /// Creates a new [KernelCapabilitiesResponse].
  ...
  factory KernelCapabilitiesResponse.fromMap(Map<String, dynamic> map) {
    return KernelCapabilitiesResponse(
