...
class Route53ResourceRecordSetPropertiesResponse {
  ...
  /// AWS Properties
  final AwsRoute53ResourceRecordSetPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Route53ResourceRecordSetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Route53ResourceRecordSetPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRoute53ResourceRecordSetPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
