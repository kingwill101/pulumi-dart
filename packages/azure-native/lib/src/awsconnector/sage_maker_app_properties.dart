...
class SageMakerAppProperties {
  ...
  /// AWS Properties
  final AwsSageMakerAppProperties? awsProperties;
  /// AWS Region
  ...
  factory SageMakerAppProperties.fromMap(Map<String, dynamic> map) {
    return SageMakerAppProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsSageMakerAppProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
