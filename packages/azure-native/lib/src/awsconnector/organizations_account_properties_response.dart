...
import 'aws_organizations_account_properties_response.dart';

/// Definition of OrganizationsAccount
class OrganizationsAccountPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsOrganizationsAccountPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [OrganizationsAccountPropertiesResponse].
  ...
  factory OrganizationsAccountPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return OrganizationsAccountPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsOrganizationsAccountPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
