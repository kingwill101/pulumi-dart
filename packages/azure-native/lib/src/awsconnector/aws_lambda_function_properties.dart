...
class AwsLambdaFunctionProperties {
  ...
  final RuntimeManagementConfig? runtimeManagementConfig;
  ...
  final SnapStart? snapStart;
  /// The function's [SnapStart](https://docs.aws.amazon.com/lambda/latest/dg/snapstart.html) setting.
  final SnapStartResponse? snapStartResponse;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'fileSystemConfigs': ?fileSystemConfigs == null ? null : pulumi.Input.encodeList<FileSystemConfig, Map<String, dynamic>>(fileSystemConfigs!, (value) => value.toMap()),
  ...
  factory AwsLambdaFunctionProperties.fromMap(Map<String, dynamic> map) {
    return AwsLambdaFunctionProperties(
      ...
      code: map['code'] == null ? null : Code.fromMap((map['code'] as Map).cast<String, dynamic>()),
      codeSigningConfigArn: map['codeSigningConfigArn'] == null ? null : map['codeSigningConfigArn'] as String,
      deadLetterConfig: map['deadLetterConfig'] == null ? null : DeadLetterConfig.fromMap((map['deadLetterConfig'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      environment: map['environment'] == null ? null : Environment.fromMap((map['environment'] as Map).cast<String, dynamic>()),
      ephemeralStorage: map['ephemeralStorage'] == null ? null : EphemeralStorage.fromMap((map['ephemeralStorage'] as Map).cast<String, dynamic>()),
      fileSystemConfigs: map['fileSystemConfigs'] == null ? null : pulumi.Input.decodeList<FileSystemConfig>(map['fileSystemConfigs'], (value) => FileSystemConfig.fromMap((value as Map).cast<String, dynamic>())),
      functionName: map['functionName'] == null ? null : map['functionName'] as String,
      handler: map['handler'] == null ? null : map['handler'] as String,
      imageConfig: map['imageConfig'] == null ? null : ImageConfig.fromMap((map['imageConfig'] as Map).cast<String, dynamic>()),
      ...
      runtimeManagementConfig: map['runtimeManagementConfig'] == null ? null : RuntimeManagementConfig.fromMap((map['runtimeManagementConfig'] as Map).cast<String, dynamic>()),
      snapStart: map['snapStart'] == null ? null : SnapStart.fromMap((map['snapStart'] as Map).cast<String, dynamic>()),
      snapStartResponse: map['snapStartResponse'] == null ? null : SnapStartResponse.fromMap((map['snapStartResponse'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : pulumi.Input.decodeList<Tag>(map['tags'], (value) => Tag.fromMap((value as Map).cast<String, dynamic>())),
      timeout: map['timeout'] == null ? null : map['timeout'] as int,
      tracingConfig: map['tracingConfig'] == null ? null : TracingConfig.fromMap((map['tracingConfig'] as Map).cast<String, dynamic>()),
