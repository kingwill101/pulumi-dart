...
class AwsRdsDBSnapshotAttributesResultProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dbSnapshotAttributes': ?dbSnapshotAttributes == null ? null : pulumi.Input.encodeList<DBSnapshotAttribute, Map<String, dynamic>>(dbSnapshotAttributes!, (value) => value.toMap()),
  ...
  factory AwsRdsDBSnapshotAttributesResultProperties.fromMap(Map<String, dynamic> map) {
    return AwsRdsDBSnapshotAttributesResultProperties(
      dbSnapshotAttributes: map['dbSnapshotAttributes'] == null ? null : pulumi.Input.decodeList<DBSnapshotAttribute>(map['dbSnapshotAttributes'], (value) => DBSnapshotAttribute.fromMap((value as Map).cast<String, dynamic>())),
