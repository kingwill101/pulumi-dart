...
class ApiGatewayStageProperties {
  ...
  /// AWS Properties
  final AwsApiGatewayStageProperties? awsProperties;
  /// AWS Region
  ...
  factory ApiGatewayStageProperties.fromMap(Map<String, dynamic> map) {
    return ApiGatewayStageProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsApiGatewayStageProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
