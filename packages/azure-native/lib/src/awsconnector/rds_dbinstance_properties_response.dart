...
class RdsDBInstancePropertiesResponse {
  ...
  /// AWS Properties
  final AwsRdsDBInstancePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory RdsDBInstancePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return RdsDBInstancePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsRdsDBInstancePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
