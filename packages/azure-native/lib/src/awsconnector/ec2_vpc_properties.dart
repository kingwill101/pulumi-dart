...
import 'aws_ec2_vpc_properties.dart';

/// Definition of Ec2Vpc
class Ec2VpcProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsEc2VpcProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [Ec2VpcProperties].
  ...
  factory Ec2VpcProperties.fromMap(Map<String, dynamic> map) {
    return Ec2VpcProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsEc2VpcProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
