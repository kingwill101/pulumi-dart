...
import 'aws_ssm_instance_information_properties.dart';

/// Definition of SsmInstanceInformation
class SsmInstanceInformationProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsSsmInstanceInformationProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SsmInstanceInformationProperties].
  ...
  factory SsmInstanceInformationProperties.fromMap(Map<String, dynamic> map) {
    return SsmInstanceInformationProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsSsmInstanceInformationProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
