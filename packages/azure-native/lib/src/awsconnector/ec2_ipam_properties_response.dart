...
class Ec2IpamPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2IpamPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2IpamPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2IpamPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2IpamPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
