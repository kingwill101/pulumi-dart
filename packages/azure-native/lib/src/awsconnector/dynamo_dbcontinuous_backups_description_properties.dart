...
import 'aws_dynamo_dbcontinuous_backups_description_properties.dart';

/// Definition of DynamoDBContinuousBackupsDescription
class DynamoDBContinuousBackupsDescriptionProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsDynamoDBContinuousBackupsDescriptionProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [DynamoDBContinuousBackupsDescriptionProperties].
  ...
  factory DynamoDBContinuousBackupsDescriptionProperties.fromMap(Map<String, dynamic> map) {
    return DynamoDBContinuousBackupsDescriptionProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsDynamoDBContinuousBackupsDescriptionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
