...
class AwsDaxClusterPropertiesResponse {
  ...
  final DaxClusterEndpointResponse? clusterDiscoveryEndpoint;
  ...
  final ClusterEndpointEncryptionTypeEnumValueResponse? clusterEndpointEncryptionType;
  ...
  final DaxClusterNotificationConfigurationResponse? notificationConfiguration;
  /// <p>The parameter group being used by nodes in the cluster.</p>
  final ParameterGroupStatusResponse? parameterGroup;
  ...
  final List<SecurityGroupMembershipResponse>? securityGroups;
  /// <p>The description of the server-side encryption status on the specified DAX cluster.</p>
  final SSEDescriptionResponse? sseDescription;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'nodeType': ?nodeType,
      'nodes': ?nodes == null ? null : pulumi.Input.encodeList<NodeResponse, Map<String, dynamic>>(nodes!, (value) => value.toMap()),
      ...
      'securityGroups': ?securityGroups == null ? null : pulumi.Input.encodeList<SecurityGroupMembershipResponse, Map<String, dynamic>>(securityGroups!, (value) => value.toMap()),
  ...
  factory AwsDaxClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AwsDaxClusterPropertiesResponse(
      ...
      clusterDiscoveryEndpoint: map['clusterDiscoveryEndpoint'] == null ? null : DaxClusterEndpointResponse.fromMap((map['clusterDiscoveryEndpoint'] as Map).cast<String, dynamic>()),
      clusterEndpointEncryptionType: map['clusterEndpointEncryptionType'] == null ? null : ClusterEndpointEncryptionTypeEnumValueResponse.fromMap((map['clusterEndpointEncryptionType'] as Map).cast<String, dynamic>()),
      ...
      nodes: map['nodes'] == null ? null : pulumi.Input.decodeList<NodeResponse>(map['nodes'], (value) => NodeResponse.fromMap((value as Map).cast<String, dynamic>())),
      notificationConfiguration: map['notificationConfiguration'] == null ? null : DaxClusterNotificationConfigurationResponse.fromMap((map['notificationConfiguration'] as Map).cast<String, dynamic>()),
      parameterGroup: map['parameterGroup'] == null ? null : ParameterGroupStatusResponse.fromMap((map['parameterGroup'] as Map).cast<String, dynamic>()),
      preferredMaintenanceWindow: map['preferredMaintenanceWindow'] == null ? null : map['preferredMaintenanceWindow'] as String,
      securityGroups: map['securityGroups'] == null ? null : pulumi.Input.decodeList<SecurityGroupMembershipResponse>(map['securityGroups'], (value) => SecurityGroupMembershipResponse.fromMap((value as Map).cast<String, dynamic>())),
      sseDescription: map['sseDescription'] == null ? null : SSEDescriptionResponse.fromMap((map['sseDescription'] as Map).cast<String, dynamic>()),
