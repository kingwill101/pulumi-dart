...
class InstanceMaintenanceOptionsResponse {
  ...
  final InstanceAutoRecoveryStateEnumValueResponse? autoRecovery;
  ...
  factory InstanceMaintenanceOptionsResponse.fromMap(Map<String, dynamic> map) {
    return InstanceMaintenanceOptionsResponse(
      autoRecovery: map['autoRecovery'] == null ? null : InstanceAutoRecoveryStateEnumValueResponse.fromMap((map['autoRecovery'] as Map).cast<String, dynamic>()),
    );
  }
}
