...
class AwsSsmInstanceInformationProperties {
  ...
  final ResourceTypeEnumValue? resourceType;
  ...
  final SourceTypeEnumValue? sourceType;
  ...
  factory AwsSsmInstanceInformationProperties.fromMap(Map<String, dynamic> map) {
    return AwsSsmInstanceInformationProperties(
      ...
      associationOverview: map['associationOverview'] == null ? null : InstanceAggregatedAssociationOverview.fromMap((map['associationOverview'] as Map).cast<String, dynamic>()),
      ...
      pingStatus: map['pingStatus'] == null ? null : PingStatusEnumValue.fromMap((map['pingStatus'] as Map).cast<String, dynamic>()),
      platformName: map['platformName'] == null ? null : map['platformName'] as String,
      platformType: map['platformType'] == null ? null : PlatformTypeEnumValue.fromMap((map['platformType'] as Map).cast<String, dynamic>()),
      ...
      resourceType: map['resourceType'] == null ? null : ResourceTypeEnumValue.fromMap((map['resourceType'] as Map).cast<String, dynamic>()),
      sourceId: map['sourceId'] == null ? null : map['sourceId'] as String,
      sourceType: map['sourceType'] == null ? null : SourceTypeEnumValue.fromMap((map['sourceType'] as Map).cast<String, dynamic>()),
    );
  }
}
