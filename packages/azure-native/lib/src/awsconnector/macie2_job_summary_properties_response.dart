...
class Macie2JobSummaryPropertiesResponse {
  ...
  /// AWS Properties
  final AwsMacie2JobSummaryPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Macie2JobSummaryPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Macie2JobSummaryPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsMacie2JobSummaryPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
