...
import 'aws_iam_access_key_last_used_properties_response.dart';

/// Definition of IamAccessKeyLastUsed
class IamAccessKeyLastUsedPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsIamAccessKeyLastUsedPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [IamAccessKeyLastUsedPropertiesResponse].
  ...
  factory IamAccessKeyLastUsedPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return IamAccessKeyLastUsedPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsIamAccessKeyLastUsedPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
