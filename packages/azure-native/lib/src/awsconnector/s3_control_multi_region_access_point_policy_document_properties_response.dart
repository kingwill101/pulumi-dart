...
class S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse {
  ...
  /// AWS Properties
  final AwsS3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return S3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsS3ControlMultiRegionAccessPointPolicyDocumentPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
