...
class LightsailInstanceProperties {
  ...
  /// AWS Properties
  final AwsLightsailInstanceProperties? awsProperties;
  /// AWS Region
  ...
  factory LightsailInstanceProperties.fromMap(Map<String, dynamic> map) {
    return LightsailInstanceProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsLightsailInstanceProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
