...
class DynamoDBTablePropertiesResponse {
  ...
  /// AWS Properties
  final AwsDynamoDBTablePropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory DynamoDBTablePropertiesResponse.fromMap(Map<String, dynamic> map) {
    return DynamoDBTablePropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsDynamoDBTablePropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
