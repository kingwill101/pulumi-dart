...
class CloudFormationStackSetPropertiesResponse {
  ...
  /// AWS Properties
  final AwsCloudFormationStackSetPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory CloudFormationStackSetPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudFormationStackSetPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudFormationStackSetPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
