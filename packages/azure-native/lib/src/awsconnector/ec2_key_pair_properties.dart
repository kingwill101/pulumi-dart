...
class Ec2KeyPairProperties {
  ...
  /// AWS Properties
  final AwsEc2KeyPairProperties? awsProperties;
  /// AWS Region
  ...
  factory Ec2KeyPairProperties.fromMap(Map<String, dynamic> map) {
    return Ec2KeyPairProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2KeyPairProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
