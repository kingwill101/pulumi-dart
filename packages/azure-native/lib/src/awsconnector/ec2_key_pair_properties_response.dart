...
class Ec2KeyPairPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEc2KeyPairPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory Ec2KeyPairPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return Ec2KeyPairPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEc2KeyPairPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
