...
class AccessAnalyzerAnalyzerPropertiesResponse {
  ...
  /// AWS Properties
  final AwsAccessAnalyzerAnalyzerPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory AccessAnalyzerAnalyzerPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AccessAnalyzerAnalyzerPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsAccessAnalyzerAnalyzerPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
