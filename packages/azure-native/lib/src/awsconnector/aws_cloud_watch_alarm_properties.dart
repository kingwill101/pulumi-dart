...
class AwsCloudWatchAlarmProperties {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'metrics': ?metrics == null ? null : pulumi.Input.encodeList<MetricDataQuery, Map<String, dynamic>>(metrics!, (value) => value.toMap()),
      'namespace': ?namespace,
      'okActions': ?okActions,
      'period': ?period,
      'statistic': ?statistic,
  ...
  factory AwsCloudWatchAlarmProperties.fromMap(Map<String, dynamic> map) {
    return AwsCloudWatchAlarmProperties(
      ...
      metrics: map['metrics'] == null ? null : pulumi.Input.decodeList<MetricDataQuery>(map['metrics'], (value) => MetricDataQuery.fromMap((value as Map).cast<String, dynamic>())),
