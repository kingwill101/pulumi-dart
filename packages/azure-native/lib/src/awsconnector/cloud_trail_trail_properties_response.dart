...
class CloudTrailTrailPropertiesResponse {
  ...
  /// AWS Properties
  final AwsCloudTrailTrailPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory CloudTrailTrailPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return CloudTrailTrailPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsCloudTrailTrailPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
