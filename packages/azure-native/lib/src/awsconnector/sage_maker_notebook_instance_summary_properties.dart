...
import 'aws_sage_maker_notebook_instance_summary_properties.dart';

/// Definition of SageMakerNotebookInstanceSummary
class SageMakerNotebookInstanceSummaryProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsSageMakerNotebookInstanceSummaryProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [SageMakerNotebookInstanceSummaryProperties].
  ...
  factory SageMakerNotebookInstanceSummaryProperties.fromMap(Map<String, dynamic> map) {
    return SageMakerNotebookInstanceSummaryProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsSageMakerNotebookInstanceSummaryProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
