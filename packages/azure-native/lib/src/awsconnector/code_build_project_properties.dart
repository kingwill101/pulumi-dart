...
import 'aws_code_build_project_properties.dart';

/// Definition of CodeBuildProject
class CodeBuildProjectProperties {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsCodeBuildProjectProperties? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [CodeBuildProjectProperties].
  ...
  factory CodeBuildProjectProperties.fromMap(Map<String, dynamic> map) {
    return CodeBuildProjectProperties(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsCodeBuildProjectProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
