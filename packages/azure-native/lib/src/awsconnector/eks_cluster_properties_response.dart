...
class EksClusterPropertiesResponse {
  ...
  /// AWS Properties
  final AwsEksClusterPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  factory EksClusterPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return EksClusterPropertiesResponse(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsEksClusterPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
