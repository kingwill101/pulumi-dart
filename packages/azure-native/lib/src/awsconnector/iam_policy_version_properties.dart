...
class IamPolicyVersionProperties {
  ...
  /// AWS Properties
  final AwsIamPolicyVersionProperties? awsProperties;
  /// AWS Region
  ...
  factory IamPolicyVersionProperties.fromMap(Map<String, dynamic> map) {
    return IamPolicyVersionProperties(
      ...
      awsProperties: map['awsProperties'] == null ? null : AwsIamPolicyVersionProperties.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
