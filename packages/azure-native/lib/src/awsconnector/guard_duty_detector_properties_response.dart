...
import 'aws_guard_duty_detector_properties_response.dart';

/// Definition of GuardDutyDetector
class GuardDutyDetectorPropertiesResponse {
  /// Amazon Resource Name (ARN)
  final String? arn;
  /// AWS Account ID
  final String? awsAccountId;
  /// AWS Properties
  final AwsGuardDutyDetectorPropertiesResponse? awsProperties;
  /// AWS Region
  ...
  /// Creates a new [GuardDutyDetectorPropertiesResponse].
  ...
  factory GuardDutyDetectorPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GuardDutyDetectorPropertiesResponse(
      arn: map['arn'] == null ? null : map['arn'] as String,
      awsAccountId: map['awsAccountId'] == null ? null : map['awsAccountId'] as String,
      awsProperties: map['awsProperties'] == null ? null : AwsGuardDutyDetectorPropertiesResponse.fromMap((map['awsProperties'] as Map).cast<String, dynamic>()),
