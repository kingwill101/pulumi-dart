...
class CIAMTenantArgs {
  ...
  CIAMTenantArgs({
    required CreateCIAMTenantProperties createTenantProperties,
    String? location,
    required String resourceGroupName,
    String? resourceName,
    required CIAMResourceSKU sku,
  ...
  factory CIAMTenantArgs.fromMap(Map<String, dynamic> map) {
    return CIAMTenantArgs(
      createTenantProperties: CreateCIAMTenantProperties.fromMap((map['createTenantProperties'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      resourceName: map['resourceName'] == null ? null : map['resourceName'] as String,
      sku: CIAMResourceSKU.fromMap((map['sku'] as Map).cast<String, dynamic>()),
