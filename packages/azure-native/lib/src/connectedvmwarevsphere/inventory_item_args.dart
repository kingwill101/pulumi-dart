...
class InventoryItemArgs {
  ...
  factory InventoryItemArgs.fromMap(Map<String, dynamic> map) {
    return InventoryItemArgs(
      inventoryItemName: map['inventoryItemName'] == null ? null : map['inventoryItemName'] as String,
      inventoryType: map['inventoryType'] as String,
      kind: map['kind'] == null ? null : map['kind'] as String,
      managedResourceId: map['managedResourceId'] == null ? null : map['managedResourceId'] as String,
      moName: map['moName'] == null ? null : map['moName'] as String,
