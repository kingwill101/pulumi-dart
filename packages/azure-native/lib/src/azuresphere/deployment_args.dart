...
class DeploymentArgs {
  ...
  DeploymentArgs({
    ...
    List<ImageAzuresphere>? deployedImages,
    String? deploymentId,
    ...
    required String resourceGroupName,
      ...
      deployedImages = pulumi.Input.asOptionalInput<List<ImageAzuresphere>>(deployedImages),
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      ...
      deployedImages: map['deployedImages'] == null ? null : (map['deployedImages'] as List).cast<ImageAzuresphere>(),
