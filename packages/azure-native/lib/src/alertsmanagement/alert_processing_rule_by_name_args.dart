...
class AlertProcessingRuleByNameArgs {
  ...
  factory AlertProcessingRuleByNameArgs.fromMap(Map<String, dynamic> map) {
    return AlertProcessingRuleByNameArgs(
      alertProcessingRuleName: map['alertProcessingRuleName'] == null ? null : map['alertProcessingRuleName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : AlertProcessingRuleProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
