...
class SmartDetectorAlertRuleArgs {
  ...
  SmartDetectorAlertRuleArgs({
    required ActionGroupsInformation actionGroups,
    ...
    ThrottlingInformation? throttling,
  }) :
  ...
  factory SmartDetectorAlertRuleArgs.fromMap(Map<String, dynamic> map) {
    return SmartDetectorAlertRuleArgs(
      actionGroups: ActionGroupsInformation.fromMap((map['actionGroups'] as Map).cast<String, dynamic>()),
      alertRuleName: map['alertRuleName'] == null ? null : map['alertRuleName'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      detector: Detector.fromMap((map['detector'] as Map).cast<String, dynamic>()),
      ...
      throttling: map['throttling'] == null ? null : ThrottlingInformation.fromMap((map['throttling'] as Map).cast<String, dynamic>()),
    );
  }
}
