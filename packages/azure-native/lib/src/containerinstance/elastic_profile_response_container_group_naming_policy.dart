...
class ElasticProfileResponseContainerGroupNamingPolicy {
  final ElasticProfileResponseGuidNamingPolicy? guidNamingPolicy;
  ...
  factory ElasticProfileResponseContainerGroupNamingPolicy.fromMap(Map<String, dynamic> map) {
    return ElasticProfileResponseContainerGroupNamingPolicy(
      guidNamingPolicy: map['guidNamingPolicy'] == null ? null : ElasticProfileResponseGuidNamingPolicy.fromMap((map['guidNamingPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
