...
class ContainerGroupArgs {
  ...
  factory ContainerGroupArgs.fromMap(Map<String, dynamic> map) {
    return ContainerGroupArgs(
      ...
      containerGroupProfile: map['containerGroupProfile'] == null ? null : ContainerGroupProfileReferenceDefinition.fromMap((map['containerGroupProfile'] as Map).cast<String, dynamic>()),
      ...
      dnsConfig: map['dnsConfig'] == null ? null : DnsConfiguration.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      ...
      identity: map['identity'] == null ? null : ContainerGroupIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      standbyPoolProfile: map['standbyPoolProfile'] == null ? null : StandbyPoolProfileDefinition.fromMap((map['standbyPoolProfile'] as Map).cast<String, dynamic>()),
