...
class SmtpUsernameArgs {
  ...
  SmtpUsernameArgs({
    required String communicationServiceName,
    required String entraApplicationId,
  ...
  factory SmtpUsernameArgs.fromMap(Map<String, dynamic> map) {
    return SmtpUsernameArgs(
      communicationServiceName: map['communicationServiceName'] as String,
      entraApplicationId: map['entraApplicationId'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      smtpUsername: map['smtpUsername'] == null ? null : map['smtpUsername'] as String,
