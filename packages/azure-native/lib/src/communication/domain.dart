...
class Domain extends pulumi.CustomResource {
  ...
  Domain(
    ...
    this.userEngagementTracking = registerOutput<String?>('userEngagementTracking');
    this.verificationRecords = registerOutput<DomainPropertiesResponseVerificationRecords>('verificationRecords');
    this.verificationStates = registerOutput<DomainPropertiesResponseVerificationStates>('verificationStates');
  }
}
