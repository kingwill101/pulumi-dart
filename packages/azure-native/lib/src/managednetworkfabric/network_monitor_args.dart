...
class NetworkMonitorArgs {
  ...
  NetworkMonitorArgs({
    ...
    required NetworkMonitorProperties properties,
  ...
  factory NetworkMonitorArgs.fromMap(Map<String, dynamic> map) {
    return NetworkMonitorArgs(
      ...
      networkMonitorName: map['networkMonitorName'] == null ? null : map['networkMonitorName'] as String,
      properties: NetworkMonitorProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
