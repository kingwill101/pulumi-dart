...
class RoutePolicyArgs {
  ...
  RoutePolicyArgs({
    ...
    required List<RoutePolicyStatementProperties> statements,
  ...
  factory RoutePolicyArgs.fromMap(Map<String, dynamic> map) {
    return RoutePolicyArgs(
      ...
      routePolicyName: map['routePolicyName'] == null ? null : map['routePolicyName'] as String,
      statements: pulumi.Input.decodeList<RoutePolicyStatementProperties>(map['statements'], (value) => RoutePolicyStatementProperties.fromMap((value as Map).cast<String, dynamic>())),
