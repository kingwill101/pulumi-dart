...
class L3IsolationDomainArgs {
  ...
  factory L3IsolationDomainArgs.fromMap(Map<String, dynamic> map) {
    return L3IsolationDomainArgs(
      aggregateRouteConfiguration: map['aggregateRouteConfiguration'] == null ? null : AggregateRouteConfiguration.fromMap((map['aggregateRouteConfiguration'] as Map).cast<String, dynamic>()),
      annotation: map['annotation'] == null ? null : map['annotation'] as String,
      connectedSubnetRoutePolicy: map['connectedSubnetRoutePolicy'] == null ? null : ConnectedSubnetRoutePolicy.fromMap((map['connectedSubnetRoutePolicy'] as Map).cast<String, dynamic>()),
      l3IsolationDomainName: map['l3IsolationDomainName'] == null ? null : map['l3IsolationDomainName'] as String,
