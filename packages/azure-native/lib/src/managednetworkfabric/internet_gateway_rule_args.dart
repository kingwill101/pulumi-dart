...
class InternetGatewayRuleArgs {
  ...
  InternetGatewayRuleArgs({
    ...
    required RuleProperties ruleProperties,
  ...
  factory InternetGatewayRuleArgs.fromMap(Map<String, dynamic> map) {
    return InternetGatewayRuleArgs(
      ...
      internetGatewayRuleName: map['internetGatewayRuleName'] == null ? null : map['internetGatewayRuleName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      ruleProperties: RuleProperties.fromMap((map['ruleProperties'] as Map).cast<String, dynamic>()),
