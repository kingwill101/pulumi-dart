...
class IpPrefixArgs {
  ...
  IpPrefixArgs({
    String? annotation,
    String? ipPrefixName,
    required List<IpPrefixRule> ipPrefixRules,
    String? location,
  ...
  factory IpPrefixArgs.fromMap(Map<String, dynamic> map) {
    return IpPrefixArgs(
      ...
      ipPrefixName: map['ipPrefixName'] == null ? null : map['ipPrefixName'] as String,
      ipPrefixRules: pulumi.Input.decodeList<IpPrefixRule>(map['ipPrefixRules'], (value) => IpPrefixRule.fromMap((value as Map).cast<String, dynamic>())),
