...
class AccessControlListArgs {
  ...
  factory AccessControlListArgs.fromMap(Map<String, dynamic> map) {
    return AccessControlListArgs(
      accessControlListName: map['accessControlListName'] == null ? null : map['accessControlListName'] as String,
      ...
      matchConfigurations: map['matchConfigurations'] == null ? null : pulumi.Input.decodeList<AccessControlListMatchConfiguration>(map['matchConfigurations'], (value) => AccessControlListMatchConfiguration.fromMap((value as Map).cast<String, dynamic>())),
