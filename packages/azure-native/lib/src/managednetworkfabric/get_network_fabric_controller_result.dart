...
class GetNetworkFabricControllerResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'id': id,
      'infrastructureExpressRouteConnections': ?infrastructureExpressRouteConnections == null ? null : pulumi.Input.encodeList<ExpressRouteConnectionInformationResponse, Map<String, dynamic>>(infrastructureExpressRouteConnections!, (value) => value.toMap()),
      ...
      'type': type,
      'workloadExpressRouteConnections': ?workloadExpressRouteConnections == null ? null : pulumi.Input.encodeList<ExpressRouteConnectionInformationResponse, Map<String, dynamic>>(workloadExpressRouteConnections!, (value) => value.toMap()),
  ...
  factory GetNetworkFabricControllerResult.fromMap(Map<String, dynamic> map) {
    return GetNetworkFabricControllerResult(
      ...
      id: map['id'] as String,
      infrastructureExpressRouteConnections: map['infrastructureExpressRouteConnections'] == null ? null : pulumi.Input.decodeList<ExpressRouteConnectionInformationResponse>(map['infrastructureExpressRouteConnections'], (value) => ExpressRouteConnectionInformationResponse.fromMap((value as Map).cast<String, dynamic>())),
      infrastructureServices: ControllerServicesResponse.fromMap((map['infrastructureServices'] as Map).cast<String, dynamic>()),
      ...
      tenantInternetGatewayIds: (map['tenantInternetGatewayIds'] as List).cast<String>(),
      type: map['type'] as String,
      workloadExpressRouteConnections: map['workloadExpressRouteConnections'] == null ? null : pulumi.Input.decodeList<ExpressRouteConnectionInformationResponse>(map['workloadExpressRouteConnections'], (value) => ExpressRouteConnectionInformationResponse.fromMap((value as Map).cast<String, dynamic>())),
      workloadManagementNetwork: map['workloadManagementNetwork'] as bool,
      workloadServices: ControllerServicesResponse.fromMap((map['workloadServices'] as Map).cast<String, dynamic>()),
    );
  }
}
