...
class IpExtendedCommunityArgs {
  ...
  IpExtendedCommunityArgs({
    ...
    required List<IpExtendedCommunityRule> ipExtendedCommunityRules,
    String? location,
  ...
  factory IpExtendedCommunityArgs.fromMap(Map<String, dynamic> map) {
    return IpExtendedCommunityArgs(
      ...
      ipExtendedCommunityName: map['ipExtendedCommunityName'] == null ? null : map['ipExtendedCommunityName'] as String,
      ipExtendedCommunityRules: pulumi.Input.decodeList<IpExtendedCommunityRule>(map['ipExtendedCommunityRules'], (value) => IpExtendedCommunityRule.fromMap((value as Map).cast<String, dynamic>())),
