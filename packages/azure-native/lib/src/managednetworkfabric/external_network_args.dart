...
class ExternalNetworkArgs {
  ...
  factory ExternalNetworkArgs.fromMap(Map<String, dynamic> map) {
    return ExternalNetworkArgs(
      ...
      externalNetworkName: map['externalNetworkName'] == null ? null : map['externalNetworkName'] as String,
      ...
      optionAProperties: map['optionAProperties'] == null ? null : ExternalNetworkPropertiesOptionAProperties.fromMap((map['optionAProperties'] as Map).cast<String, dynamic>()),
      optionBProperties: map['optionBProperties'] == null ? null : L3OptionBProperties.fromMap((map['optionBProperties'] as Map).cast<String, dynamic>()),
