...
class SecurityStandardArgs {
  ...
  factory SecurityStandardArgs.fromMap(Map<String, dynamic> map) {
    return SecurityStandardArgs(
      assessments: map['assessments'] == null ? null : pulumi.Input.decodeList<PartialAssessmentProperties>(map['assessments'], (value) => PartialAssessmentProperties.fromMap((value as Map).cast<String, dynamic>())),
      ...
      standardId: map['standardId'] == null ? null : map['standardId'] as String,
    );
  }
}
