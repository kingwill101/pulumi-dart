...
class StandardArgs {
  ...
  factory StandardArgs.fromMap(Map<String, dynamic> map) {
    return StandardArgs(
      ...
      components: map['components'] == null ? null : pulumi.Input.decodeList<StandardComponentProperties>(map['components'], (value) => StandardComponentProperties.fromMap((value as Map).cast<String, dynamic>())),
      ...
      supportedClouds: map['supportedClouds'] == null ? null : pulumi.Input.decodeList<StandardSupportedClouds>(map['supportedClouds'], (value) => StandardSupportedClouds.fromValue(value as String)),
