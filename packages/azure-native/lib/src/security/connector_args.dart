...
class ConnectorArgs {
  ...
  ConnectorArgs({
    AwAssumeRoleAuthenticationDetailsProperties? authenticationDetails,
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      authenticationDetails: map['authenticationDetails'] == null ? null : AwAssumeRoleAuthenticationDetailsProperties.fromMap((map['authenticationDetails'] as Map).cast<String, dynamic>()),
      connectorName: map['connectorName'] == null ? null : map['connectorName'] as String,
      hybridComputeSettings: map['hybridComputeSettings'] == null ? null : HybridComputeSettingsProperties.fromMap((map['hybridComputeSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
