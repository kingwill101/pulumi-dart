...
class AssignmentArgs {
  ...
  factory AssignmentArgs.fromMap(Map<String, dynamic> map) {
    return AssignmentArgs(
      additionalData: map['additionalData'] == null ? null : AssignmentPropertiesAdditionalData.fromMap((map['additionalData'] as Map).cast<String, dynamic>()),
      assignedComponent: map['assignedComponent'] == null ? null : AssignedComponentItem.fromMap((map['assignedComponent'] as Map).cast<String, dynamic>()),
      ...
      assignmentId: map['assignmentId'] == null ? null : map['assignmentId'] as String,
