...
class NamespaceDiscoveredAssetArgs {
  ...
  factory NamespaceDiscoveredAssetArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceDiscoveredAssetArgs(
      ...
      datasets: map['datasets'] == null ? null : pulumi.Input.decodeList<NamespaceDiscoveredDataset>(map['datasets'], (value) => NamespaceDiscoveredDataset.fromMap((value as Map).cast<String, dynamic>())),
      ...
      events: map['events'] == null ? null : pulumi.Input.decodeList<NamespaceDiscoveredEvent>(map['events'], (value) => NamespaceDiscoveredEvent.fromMap((value as Map).cast<String, dynamic>())),
      ...
      managementGroups: map['managementGroups'] == null ? null : pulumi.Input.decodeList<NamespaceDiscoveredManagementGroup>(map['managementGroups'], (value) => NamespaceDiscoveredManagementGroup.fromMap((value as Map).cast<String, dynamic>())),
      ...
      streams: map['streams'] == null ? null : pulumi.Input.decodeList<NamespaceDiscoveredStream>(map['streams'], (value) => NamespaceDiscoveredStream.fromMap((value as Map).cast<String, dynamic>())),
