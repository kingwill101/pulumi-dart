...
class ScheduledActionsScheduleResponse {
  ...
  final ExecutionParametersResponse? executionParameters;
  ...
  factory ScheduledActionsScheduleResponse.fromMap(Map<String, dynamic> map) {
    return ScheduledActionsScheduleResponse(
      ...
      executionParameters: map['executionParameters'] == null ? null : ExecutionParametersResponse.fromMap((map['executionParameters'] as Map).cast<String, dynamic>()),
