...
class RoutingIntentArgs {
  ...
  factory RoutingIntentArgs.fromMap(Map<String, dynamic> map) {
    return RoutingIntentArgs(
      ...
      routingIntentName: map['routingIntentName'] == null ? null : map['routingIntentName'] as String,
      routingPolicies: map['routingPolicies'] == null ? null : pulumi.Input.decodeList<RoutingPolicy>(map['routingPolicies'], (value) => RoutingPolicy.fromMap((value as Map).cast<String, dynamic>())),
