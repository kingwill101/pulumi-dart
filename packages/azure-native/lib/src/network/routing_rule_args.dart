...
class RoutingRuleArgs {
  ...
  RoutingRuleArgs({
    ...
    String? description,
    required RoutingRuleRouteDestination destination,
    required String networkManagerName,
    required RoutingRuleNextHop nextHop,
  ...
  factory RoutingRuleArgs.fromMap(Map<String, dynamic> map) {
    return RoutingRuleArgs(
      ...
      destination: RoutingRuleRouteDestination.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      networkManagerName: map['networkManagerName'] as String,
      nextHop: RoutingRuleNextHop.fromMap((map['nextHop'] as Map).cast<String, dynamic>()),
