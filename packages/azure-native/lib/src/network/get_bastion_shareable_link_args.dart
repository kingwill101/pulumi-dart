...
class GetBastionShareableLinkArgs {
  ...
  factory GetBastionShareableLinkArgs.fromMap(Map<String, dynamic> map) {
    return GetBastionShareableLinkArgs(
      ...
      vms: map['vms'] == null ? null : pulumi.Input.decodeList<BastionShareableLink>(map['vms'], (value) => BastionShareableLink.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
