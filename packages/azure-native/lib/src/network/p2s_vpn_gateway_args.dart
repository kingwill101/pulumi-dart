...
class P2sVpnGatewayArgs {
  ...
  factory P2sVpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return P2sVpnGatewayArgs(
      ...
      p2SConnectionConfigurations: map['p2SConnectionConfigurations'] == null ? null : pulumi.Input.decodeList<P2SConnectionConfiguration>(map['p2SConnectionConfigurations'], (value) => P2SConnectionConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      vpnServerConfiguration: map['vpnServerConfiguration'] == null ? null : SubResource.fromMap((map['vpnServerConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
