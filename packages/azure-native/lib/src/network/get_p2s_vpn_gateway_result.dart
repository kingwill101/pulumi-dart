...
/// Result data returned by getP2sVpnGateway.
class GetP2sVpnGatewayResult {
  ...
  /// Creates a new [GetP2sVpnGatewayResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'location': location,
      'name': name,
      'p2SConnectionConfigurations': ?p2SConnectionConfigurations == null ? null : pulumi.Input.encodeList<P2SConnectionConfigurationResponse, Map<String, dynamic>>(p2SConnectionConfigurations!, (value) => value.toMap()),
      ...
      'vpnServerConfiguration': ?vpnServerConfiguration == null ? null : vpnServerConfiguration!.toMap(),
    };
  }

  factory GetP2sVpnGatewayResult.fromMap(Map<String, dynamic> map) {
