...
class HubPublicIPAddresses {
  ...
  final List<AzureFirewallPublicIPAddress>? addresses;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'addresses': ?addresses == null ? null : pulumi.Input.encodeList<AzureFirewallPublicIPAddress, Map<String, dynamic>>(addresses!, (value) => value.toMap()),
      'count': ?count,
    };
  }
  ...
  factory HubPublicIPAddresses.fromMap(Map<String, dynamic> map) {
    return HubPublicIPAddresses(
      addresses: map['addresses'] == null ? null : pulumi.Input.decodeList<AzureFirewallPublicIPAddress>(map['addresses'], (value) => AzureFirewallPublicIPAddress.fromMap((value as Map).cast<String, dynamic>())),
