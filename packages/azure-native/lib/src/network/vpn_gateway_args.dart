...
class VpnGatewayArgs {
  ...
  VpnGatewayArgs({
    ...
    List<VpnConnectionNetwork>? connections,
  ...
  factory VpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return VpnGatewayArgs(
      ...
      connections: map['connections'] == null ? null : (map['connections'] as List).cast<VpnConnectionNetwork>(),
      ...
      natRules: map['natRules'] == null ? null : pulumi.Input.decodeList<VpnGatewayNatRule>(map['natRules'], (value) => VpnGatewayNatRule.fromMap((value as Map).cast<String, dynamic>())),
