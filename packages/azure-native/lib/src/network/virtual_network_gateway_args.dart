...
class VirtualNetworkGatewayArgs {
  ...
  VirtualNetworkGatewayArgs({
    ...
    String? location,
    List<VirtualNetworkGatewayNatRuleNetwork>? natRules,
  ...
  factory VirtualNetworkGatewayArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayArgs(
      ...
      natRules: map['natRules'] == null ? null : (map['natRules'] as List).cast<VirtualNetworkGatewayNatRuleNetwork>(),
      ...
      virtualNetworkGatewayName: map['virtualNetworkGatewayName'] == null ? null : map['virtualNetworkGatewayName'] as String,
