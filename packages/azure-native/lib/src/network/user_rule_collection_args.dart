...
class UserRuleCollectionArgs {
  ...
  UserRuleCollectionArgs({
    required List<NetworkManagerSecurityGroupItem> appliesToGroups,
  ...
  factory UserRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return UserRuleCollectionArgs(
      appliesToGroups: pulumi.Input.decodeList<NetworkManagerSecurityGroupItem>(map['appliesToGroups'], (value) => NetworkManagerSecurityGroupItem.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ruleCollectionName: map['ruleCollectionName'] == null ? null : map['ruleCollectionName'] as String,
    );
  }
}
