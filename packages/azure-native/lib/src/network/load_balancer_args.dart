...
class LoadBalancerArgs {
  ...
  LoadBalancerArgs({
    ...
    List<InboundNatRuleNetwork>? inboundNatRules,
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      frontendIPConfigurations: map['frontendIPConfigurations'] == null ? null : pulumi.Input.decodeList<FrontendIPConfiguration>(map['frontendIPConfigurations'], (value) => FrontendIPConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] == null ? null : map['id'] as String,
      inboundNatPools: map['inboundNatPools'] == null ? null : pulumi.Input.decodeList<InboundNatPool>(map['inboundNatPools'], (value) => InboundNatPool.fromMap((value as Map).cast<String, dynamic>())),
      inboundNatRules: map['inboundNatRules'] == null ? null : (map['inboundNatRules'] as List).cast<InboundNatRuleNetwork>(),
      ...
      outboundRules: map['outboundRules'] == null ? null : pulumi.Input.decodeList<OutboundRule>(map['outboundRules'], (value) => OutboundRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sku: map['sku'] == null ? null : LoadBalancerSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
