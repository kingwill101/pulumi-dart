...
class SecurityRuleArgs {
  ...
  SecurityRuleArgs({
    ...
    List<ApplicationSecurityGroupNetwork>? destinationApplicationSecurityGroups,
    ...
    List<ApplicationSecurityGroupNetwork>? sourceApplicationSecurityGroups,
  ...
  factory SecurityRuleArgs.fromMap(Map<String, dynamic> map) {
    return SecurityRuleArgs(
      ...
      destinationApplicationSecurityGroups: map['destinationApplicationSecurityGroups'] == null ? null : (map['destinationApplicationSecurityGroups'] as List).cast<ApplicationSecurityGroupNetwork>(),
      ...
      sourceApplicationSecurityGroups: map['sourceApplicationSecurityGroups'] == null ? null : (map['sourceApplicationSecurityGroups'] as List).cast<ApplicationSecurityGroupNetwork>(),
