...
class P2sVpnServerConfigurationArgs {
  ...
  P2sVpnServerConfigurationArgs({
    ...
    P2SVpnServerConfigurationProperties? properties,
  ...
  factory P2sVpnServerConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return P2sVpnServerConfigurationArgs(
      ...
      p2SVpnServerConfigurationName: map['p2SVpnServerConfigurationName'] == null ? null : map['p2SVpnServerConfigurationName'] as String,
      properties: map['properties'] == null ? null : P2SVpnServerConfigurationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
