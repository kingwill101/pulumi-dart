...
class PacketCaptureArgs {
  ...
  factory PacketCaptureArgs.fromMap(Map<String, dynamic> map) {
    return PacketCaptureArgs(
      ...
      captureSettings: map['captureSettings'] == null ? null : PacketCaptureSettings.fromMap((map['captureSettings'] as Map).cast<String, dynamic>()),
      ...
      packetCaptureName: map['packetCaptureName'] == null ? null : map['packetCaptureName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      scope: map['scope'] == null ? null : PacketCaptureMachineScope.fromMap((map['scope'] as Map).cast<String, dynamic>()),
      storageLocation: PacketCaptureStorageLocation.fromMap((map['storageLocation'] as Map).cast<String, dynamic>()),
      target: map['target'] as String,
      targetType: map['targetType'] == null ? null : PacketCaptureTargetType.fromValue(map['targetType'] as String),
