...
/// Result data returned by getAdminRuleCollection.
class GetAdminRuleCollectionResult {
  ...
  /// Creates a new [GetAdminRuleCollectionResult].
  ...
  factory GetAdminRuleCollectionResult.fromMap(Map<String, dynamic> map) {
