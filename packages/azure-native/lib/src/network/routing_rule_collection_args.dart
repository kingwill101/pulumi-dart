...
class RoutingRuleCollectionArgs {
  ...
  RoutingRuleCollectionArgs({
    required List<NetworkManagerRoutingGroupItem> appliesTo,
  ...
  factory RoutingRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return RoutingRuleCollectionArgs(
      appliesTo: pulumi.Input.decodeList<NetworkManagerRoutingGroupItem>(map['appliesTo'], (value) => NetworkManagerRoutingGroupItem.fromMap((value as Map).cast<String, dynamic>())),
