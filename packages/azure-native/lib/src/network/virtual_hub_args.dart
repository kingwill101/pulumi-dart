...
class VirtualHubArgs {
  ...
  VirtualHubArgs({
    ...
    List<VirtualHubRouteTableV2Network>? virtualHubRouteTableV2s,
  ...
  factory VirtualHubArgs.fromMap(Map<String, dynamic> map) {
    return VirtualHubArgs(
      ...
      azureFirewall: map['azureFirewall'] == null ? null : SubResource.fromMap((map['azureFirewall'] as Map).cast<String, dynamic>()),
      expressRouteGateway: map['expressRouteGateway'] == null ? null : SubResource.fromMap((map['expressRouteGateway'] as Map).cast<String, dynamic>()),
      hubRoutingPreference: map['hubRoutingPreference'] == null ? null : map['hubRoutingPreference'] as String,
      id: map['id'] == null ? null : map['id'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      p2SVpnGateway: map['p2SVpnGateway'] == null ? null : SubResource.fromMap((map['p2SVpnGateway'] as Map).cast<String, dynamic>()),
      preferredRoutingGateway: map['preferredRoutingGateway'] == null ? null : map['preferredRoutingGateway'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      routeTable: map['routeTable'] == null ? null : VirtualHubRouteTable.fromMap((map['routeTable'] as Map).cast<String, dynamic>()),
      securityPartnerProvider: map['securityPartnerProvider'] == null ? null : SubResource.fromMap((map['securityPartnerProvider'] as Map).cast<String, dynamic>()),
      ...
      virtualHubName: map['virtualHubName'] == null ? null : map['virtualHubName'] as String,
      virtualHubRouteTableV2s: map['virtualHubRouteTableV2s'] == null ? null : (map['virtualHubRouteTableV2s'] as List).cast<VirtualHubRouteTableV2Network>(),
      virtualRouterAsn: map['virtualRouterAsn'] == null ? null : map['virtualRouterAsn'] as double,
      virtualRouterAutoScaleConfiguration: map['virtualRouterAutoScaleConfiguration'] == null ? null : VirtualRouterAutoScaleConfiguration.fromMap((map['virtualRouterAutoScaleConfiguration'] as Map).cast<String, dynamic>()),
      virtualRouterIps: map['virtualRouterIps'] == null ? null : (map['virtualRouterIps'] as List).cast<String>(),
      virtualWan: map['virtualWan'] == null ? null : SubResource.fromMap((map['virtualWan'] as Map).cast<String, dynamic>()),
      vpnGateway: map['vpnGateway'] == null ? null : SubResource.fromMap((map['vpnGateway'] as Map).cast<String, dynamic>()),
    );
  }
}
