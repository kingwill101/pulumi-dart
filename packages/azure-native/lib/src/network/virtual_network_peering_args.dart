...
class VirtualNetworkPeeringArgs {
  ...
  factory VirtualNetworkPeeringArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkPeeringArgs(
      ...
      syncRemoteAddressSpace: map['syncRemoteAddressSpace'] == null ? null : map['syncRemoteAddressSpace'] as String,
      ...
      virtualNetworkPeeringName: map['virtualNetworkPeeringName'] == null ? null : map['virtualNetworkPeeringName'] as String,
    );
  }
}
