...
class ReachabilityAnalysisIntentArgs {
  ...
  ReachabilityAnalysisIntentArgs({
    ...
    required ReachabilityAnalysisIntentProperties properties,
  ...
  factory ReachabilityAnalysisIntentArgs.fromMap(Map<String, dynamic> map) {
    return ReachabilityAnalysisIntentArgs(
      ...
      properties: ReachabilityAnalysisIntentProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      reachabilityAnalysisIntentName: map['reachabilityAnalysisIntentName'] == null ? null : map['reachabilityAnalysisIntentName'] as String,
