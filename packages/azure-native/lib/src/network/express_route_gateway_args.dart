...
class ExpressRouteGatewayArgs {
  ...
  ExpressRouteGatewayArgs({
    ...
    List<ExpressRouteConnectionNetwork>? expressRouteConnections,
    String? expressRouteGatewayName,
    String? id,
    String? location,
    required String resourceGroupName,
    Map<String, String>? tags,
    required VirtualHubId virtualHub,
  }) :
  ...
  factory ExpressRouteGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteGatewayArgs(
      ...
      autoScaleConfiguration: map['autoScaleConfiguration'] == null ? null : ExpressRouteGatewayPropertiesAutoScaleConfiguration.fromMap((map['autoScaleConfiguration'] as Map).cast<String, dynamic>()),
      expressRouteConnections: map['expressRouteConnections'] == null ? null : (map['expressRouteConnections'] as List).cast<ExpressRouteConnectionNetwork>(),
      expressRouteGatewayName: map['expressRouteGatewayName'] == null ? null : map['expressRouteGatewayName'] as String,
      id: map['id'] == null ? null : map['id'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      virtualHub: VirtualHubId.fromMap((map['virtualHub'] as Map).cast<String, dynamic>()),
    );
  }
}
