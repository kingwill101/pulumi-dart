...
class InterfaceEndpointArgs {
  ...
  factory InterfaceEndpointArgs.fromMap(Map<String, dynamic> map) {
    return InterfaceEndpointArgs(
      endpointService: map['endpointService'] == null ? null : EndpointService.fromMap((map['endpointService'] as Map).cast<String, dynamic>()),
      fqdn: map['fqdn'] == null ? null : map['fqdn'] as String,
      id: map['id'] == null ? null : map['id'] as String,
      interfaceEndpointName: map['interfaceEndpointName'] == null ? null : map['interfaceEndpointName'] as String,
