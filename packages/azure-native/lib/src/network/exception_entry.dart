...
class ExceptionEntry {
  ...
  final List<ExclusionManagedRuleSet>? exceptionManagedRuleSets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exceptionManagedRuleSets': ?exceptionManagedRuleSets == null ? null : pulumi.Input.encodeList<ExclusionManagedRuleSet, Map<String, dynamic>>(exceptionManagedRuleSets!, (value) => value.toMap()),
  ...
  factory ExceptionEntry.fromMap(Map<String, dynamic> map) {
    return ExceptionEntry(
      exceptionManagedRuleSets: map['exceptionManagedRuleSets'] == null ? null : pulumi.Input.decodeList<ExclusionManagedRuleSet>(map['exceptionManagedRuleSets'], (value) => ExclusionManagedRuleSet.fromMap((value as Map).cast<String, dynamic>())),
