...
class ConnectionMonitorArgs {
  ...
  factory ConnectionMonitorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionMonitorArgs(
      ...
      connectionMonitorName: map['connectionMonitorName'] == null ? null : map['connectionMonitorName'] as String,
      destination: map['destination'] == null ? null : ConnectionMonitorDestination.fromMap((map['destination'] as Map).cast<String, dynamic>()),
      endpoints: map['endpoints'] == null ? null : pulumi.Input.decodeList<ConnectionMonitorEndpoint>(map['endpoints'], (value) => ConnectionMonitorEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      migrate: map['migrate'] == null ? null : map['migrate'] as String,
      ...
      outputs: map['outputs'] == null ? null : pulumi.Input.decodeList<ConnectionMonitorOutput>(map['outputs'], (value) => ConnectionMonitorOutput.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      source: map['source'] == null ? null : ConnectionMonitorSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      testConfigurations: map['testConfigurations'] == null ? null : pulumi.Input.decodeList<ConnectionMonitorTestConfiguration>(map['testConfigurations'], (value) => ConnectionMonitorTestConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      testGroups: map['testGroups'] == null ? null : pulumi.Input.decodeList<ConnectionMonitorTestGroup>(map['testGroups'], (value) => ConnectionMonitorTestGroup.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
