...
class FirewallPolicyRuleCollectionGroupArgs {
  ...
  FirewallPolicyRuleCollectionGroupArgs({
    ...
    List<FirewallPolicyFilterRuleCollection>? ruleCollections,
  }) :
      ...
      ruleCollectionGroupName = pulumi.Input.asOptionalInput<String>(ruleCollectionGroupName),
  ...
  factory FirewallPolicyRuleCollectionGroupArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyRuleCollectionGroupArgs(
      ...
      ruleCollectionGroupName: map['ruleCollectionGroupName'] == null ? null : map['ruleCollectionGroupName'] as String,
      ruleCollections: map['ruleCollections'] == null ? null : pulumi.Input.decodeList<FirewallPolicyFilterRuleCollection>(map['ruleCollections'], (value) => FirewallPolicyFilterRuleCollection.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
