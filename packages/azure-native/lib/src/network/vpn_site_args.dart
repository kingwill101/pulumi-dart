...
class VpnSiteArgs {
  ...
  factory VpnSiteArgs.fromMap(Map<String, dynamic> map) {
    return VpnSiteArgs(
      ...
      bgpProperties: map['bgpProperties'] == null ? null : BgpSettings.fromMap((map['bgpProperties'] as Map).cast<String, dynamic>()),
      deviceProperties: map['deviceProperties'] == null ? null : DeviceProperties.fromMap((map['deviceProperties'] as Map).cast<String, dynamic>()),
      id: map['id'] == null ? null : map['id'] as String,
      ipAddress: map['ipAddress'] == null ? null : map['ipAddress'] as String,
      isSecuritySite: map['isSecuritySite'] == null ? null : map['isSecuritySite'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      o365Policy: map['o365Policy'] == null ? null : O365PolicyProperties.fromMap((map['o365Policy'] as Map).cast<String, dynamic>()),
      ...
      vpnSiteLinks: map['vpnSiteLinks'] == null ? null : pulumi.Input.decodeList<VpnSiteLink>(map['vpnSiteLinks'], (value) => VpnSiteLink.fromMap((value as Map).cast<String, dynamic>())),
      vpnSiteName: map['vpnSiteName'] == null ? null : map['vpnSiteName'] as String,
    );
  }
}
