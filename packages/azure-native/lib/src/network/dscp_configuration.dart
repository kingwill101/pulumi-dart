...
class DscpConfiguration extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NetworkInterfaceResponse>> associatedNetworkInterfaces;
  /// The Azure API version of the resource.
  late final pulumi.Output<String> azureApiVersion;
  /// Destination IP ranges.
  late final pulumi.Output<List<QosIpRangeResponse>?> destinationIpRanges;
  /// Destination port ranges.
  late final pulumi.Output<List<QosPortRangeResponse>?> destinationPortRanges;
  ...
  late final pulumi.Output<List<QosDefinitionResponse>?> qosDefinitionCollection;
  /// The resource GUID property of the DSCP Configuration resource.
  late final pulumi.Output<String> resourceGuid;
  /// Source IP ranges.
  late final pulumi.Output<List<QosIpRangeResponse>?> sourceIpRanges;
  /// Sources port ranges.
  late final pulumi.Output<List<QosPortRangeResponse>?> sourcePortRanges;
  /// Resource tags.
  ...
  DscpConfiguration(
    ...
    this.associatedNetworkInterfaces = registerOutput<List<NetworkInterfaceResponse>>('associatedNetworkInterfaces');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.destinationIpRanges = registerOutput<List<QosIpRangeResponse>?>('destinationIpRanges');
    this.destinationPortRanges = registerOutput<List<QosPortRangeResponse>?>('destinationPortRanges');
    this.etag = registerOutput<String>('etag');
    this.location = registerOutput<String?>('location');
    this.markings = registerOutput<List<int>?>('markings');
    this.name = registerOutput<String>('name');
    this.protocol = registerOutput<String?>('protocol');
    this.provisioningState = registerOutput<String>('provisioningState');
    this.qosCollectionId = registerOutput<String>('qosCollectionId');
    this.qosDefinitionCollection = registerOutput<List<QosDefinitionResponse>?>('qosDefinitionCollection');
    this.resourceGuid = registerOutput<String>('resourceGuid');
    this.sourceIpRanges = registerOutput<List<QosIpRangeResponse>?>('sourceIpRanges');
    this.sourcePortRanges = registerOutput<List<QosPortRangeResponse>?>('sourcePortRanges');
