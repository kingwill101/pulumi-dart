...
class NetworkManagerArgs {
  ...
  NetworkManagerArgs({
    ...
    List<String>? networkManagerScopeAccesses,
    required NetworkManagerPropertiesNetworkManagerScopes networkManagerScopes,
  ...
  factory NetworkManagerArgs.fromMap(Map<String, dynamic> map) {
    return NetworkManagerArgs(
      ...
      networkManagerName: map['networkManagerName'] == null ? null : map['networkManagerName'] as String,
      ...
      networkManagerScopes: NetworkManagerPropertiesNetworkManagerScopes.fromMap((map['networkManagerScopes'] as Map).cast<String, dynamic>()),
