...
class ServiceGatewayArgs {
  ...
  ServiceGatewayArgs({
    ...
    RouteTargetAddressPropertiesFormat? routeTargetAddress,
    RouteTargetAddressPropertiesFormat? routeTargetAddressV6,
    String? serviceGatewayName,
    ServiceGatewaySku? sku,
    Map<String, String>? tags,
    VirtualNetworkNetwork? virtualNetwork,
    List<String>? zones,
  }) :
  ...
  factory ServiceGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ServiceGatewayArgs(
      ...
      routeTargetAddress: map['routeTargetAddress'] == null ? null : RouteTargetAddressPropertiesFormat.fromMap((map['routeTargetAddress'] as Map).cast<String, dynamic>()),
      routeTargetAddressV6: map['routeTargetAddressV6'] == null ? null : RouteTargetAddressPropertiesFormat.fromMap((map['routeTargetAddressV6'] as Map).cast<String, dynamic>()),
      serviceGatewayName: map['serviceGatewayName'] == null ? null : map['serviceGatewayName'] as String,
      sku: map['sku'] == null ? null : ServiceGatewaySku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      virtualNetwork: map['virtualNetwork'] == null ? null : map['virtualNetwork'] as VirtualNetworkNetwork,
