...
class ApplicationGatewayArgs {
  ...
  factory ApplicationGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayArgs(
      applicationGatewayName: map['applicationGatewayName'] == null ? null : map['applicationGatewayName'] as String,
      authenticationCertificates: map['authenticationCertificates'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayAuthenticationCertificate>(map['authenticationCertificates'], (value) => ApplicationGatewayAuthenticationCertificate.fromMap((value as Map).cast<String, dynamic>())),
      autoscaleConfiguration: map['autoscaleConfiguration'] == null ? null : ApplicationGatewayAutoscaleConfiguration.fromMap((map['autoscaleConfiguration'] as Map).cast<String, dynamic>()),
      ...
      backendHttpSettingsCollection: map['backendHttpSettingsCollection'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayBackendHttpSettings>(map['backendHttpSettingsCollection'], (value) => ApplicationGatewayBackendHttpSettings.fromMap((value as Map).cast<String, dynamic>())),
      backendSettingsCollection: map['backendSettingsCollection'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayBackendSettings>(map['backendSettingsCollection'], (value) => ApplicationGatewayBackendSettings.fromMap((value as Map).cast<String, dynamic>())),
      ...
      frontendIPConfigurations: map['frontendIPConfigurations'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayFrontendIPConfiguration>(map['frontendIPConfigurations'], (value) => ApplicationGatewayFrontendIPConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      frontendPorts: map['frontendPorts'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayFrontendPort>(map['frontendPorts'], (value) => ApplicationGatewayFrontendPort.fromMap((value as Map).cast<String, dynamic>())),
      gatewayIPConfigurations: map['gatewayIPConfigurations'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayIPConfiguration>(map['gatewayIPConfigurations'], (value) => ApplicationGatewayIPConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      globalConfiguration: map['globalConfiguration'] == null ? null : ApplicationGatewayGlobalConfiguration.fromMap((map['globalConfiguration'] as Map).cast<String, dynamic>()),
      httpListeners: map['httpListeners'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayHttpListener>(map['httpListeners'], (value) => ApplicationGatewayHttpListener.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] == null ? null : map['id'] as String,
      identity: map['identity'] == null ? null : ManagedServiceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      listeners: map['listeners'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayListener>(map['listeners'], (value) => ApplicationGatewayListener.fromMap((value as Map).cast<String, dynamic>())),
      loadDistributionPolicies: map['loadDistributionPolicies'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayLoadDistributionPolicy>(map['loadDistributionPolicies'], (value) => ApplicationGatewayLoadDistributionPolicy.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      privateLinkConfigurations: map['privateLinkConfigurations'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayPrivateLinkConfiguration>(map['privateLinkConfigurations'], (value) => ApplicationGatewayPrivateLinkConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      probes: map['probes'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayProbe>(map['probes'], (value) => ApplicationGatewayProbe.fromMap((value as Map).cast<String, dynamic>())),
      redirectConfigurations: map['redirectConfigurations'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayRedirectConfiguration>(map['redirectConfigurations'], (value) => ApplicationGatewayRedirectConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      requestRoutingRules: map['requestRoutingRules'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayRequestRoutingRule>(map['requestRoutingRules'], (value) => ApplicationGatewayRequestRoutingRule.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      rewriteRuleSets: map['rewriteRuleSets'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayRewriteRuleSet>(map['rewriteRuleSets'], (value) => ApplicationGatewayRewriteRuleSet.fromMap((value as Map).cast<String, dynamic>())),
      routingRules: map['routingRules'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayRoutingRule>(map['routingRules'], (value) => ApplicationGatewayRoutingRule.fromMap((value as Map).cast<String, dynamic>())),
      sku: map['sku'] == null ? null : ApplicationGatewaySku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      sslCertificates: map['sslCertificates'] == null ? null : pulumi.Input.decodeList<ApplicationGatewaySslCertificate>(map['sslCertificates'], (value) => ApplicationGatewaySslCertificate.fromMap((value as Map).cast<String, dynamic>())),
      sslPolicy: map['sslPolicy'] == null ? null : ApplicationGatewaySslPolicy.fromMap((map['sslPolicy'] as Map).cast<String, dynamic>()),
      sslProfiles: map['sslProfiles'] == null ? null : pulumi.Input.decodeList<ApplicationGatewaySslProfile>(map['sslProfiles'], (value) => ApplicationGatewaySslProfile.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      trustedClientCertificates: map['trustedClientCertificates'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayTrustedClientCertificate>(map['trustedClientCertificates'], (value) => ApplicationGatewayTrustedClientCertificate.fromMap((value as Map).cast<String, dynamic>())),
      trustedRootCertificates: map['trustedRootCertificates'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayTrustedRootCertificate>(map['trustedRootCertificates'], (value) => ApplicationGatewayTrustedRootCertificate.fromMap((value as Map).cast<String, dynamic>())),
      urlPathMaps: map['urlPathMaps'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayUrlPathMap>(map['urlPathMaps'], (value) => ApplicationGatewayUrlPathMap.fromMap((value as Map).cast<String, dynamic>())),
      webApplicationFirewallConfiguration: map['webApplicationFirewallConfiguration'] == null ? null : ApplicationGatewayWebApplicationFirewallConfiguration.fromMap((map['webApplicationFirewallConfiguration'] as Map).cast<String, dynamic>()),
