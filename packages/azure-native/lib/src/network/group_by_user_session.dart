...
class GroupByUserSession {
  ...
  final List<GroupByVariable> groupByVariables;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'groupByVariables': pulumi.Input.encodeList<GroupByVariable, Map<String, dynamic>>(groupByVariables, (value) => value.toMap()),
    };
  }

  factory GroupByUserSession.fromMap(Map<String, dynamic> map) {
    return GroupByUserSession(
      groupByVariables: pulumi.Input.decodeList<GroupByVariable>(map['groupByVariables'], (value) => GroupByVariable.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
