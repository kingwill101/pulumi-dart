...
class ListNetworkManagerDeploymentStatusResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'skipToken': ?skipToken,
      'value': ?value == null ? null : pulumi.Input.encodeList<NetworkManagerDeploymentStatusResponse, Map<String, dynamic>>(value!, (value) => value.toMap()),
    };
  }
  ...
  factory ListNetworkManagerDeploymentStatusResult.fromMap(Map<String, dynamic> map) {
    return ListNetworkManagerDeploymentStatusResult(
      ...
      value: map['value'] == null ? null : pulumi.Input.decodeList<NetworkManagerDeploymentStatusResponse>(map['value'], (value) => NetworkManagerDeploymentStatusResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
