...
class NetworkSecurityGroupArgs {
  ...
  NetworkSecurityGroupArgs({
    ...
    List<SecurityRuleNetwork>? securityRules,
  ...
  factory NetworkSecurityGroupArgs.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityGroupArgs(
      ...
      networkSecurityGroupName: map['networkSecurityGroupName'] == null ? null : map['networkSecurityGroupName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      securityRules: map['securityRules'] == null ? null : (map['securityRules'] as List).cast<SecurityRuleNetwork>(),
