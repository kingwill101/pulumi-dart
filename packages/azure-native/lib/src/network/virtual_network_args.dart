...
class VirtualNetworkArgs {
  ...
  VirtualNetworkArgs({
    ...
    List<SubnetNetwork>? subnets,
    Map<String, String>? tags,
    String? virtualNetworkName,
    List<VirtualNetworkPeeringNetwork>? virtualNetworkPeerings,
  }) :
  ...
  factory VirtualNetworkArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkArgs(
      ...
      subnets: map['subnets'] == null ? null : (map['subnets'] as List).cast<SubnetNetwork>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      virtualNetworkName: map['virtualNetworkName'] == null ? null : map['virtualNetworkName'] as String,
      virtualNetworkPeerings: map['virtualNetworkPeerings'] == null ? null : (map['virtualNetworkPeerings'] as List).cast<VirtualNetworkPeeringNetwork>(),
    );
  }
}
