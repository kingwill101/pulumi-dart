...
class FirewallPolicyArgs {
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      basePolicy: map['basePolicy'] == null ? null : SubResource.fromMap((map['basePolicy'] as Map).cast<String, dynamic>()),
      dnsSettings: map['dnsSettings'] == null ? null : DnsSettings.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      explicitProxy: map['explicitProxy'] == null ? null : ExplicitProxy.fromMap((map['explicitProxy'] as Map).cast<String, dynamic>()),
      ...
      sku: map['sku'] == null ? null : FirewallPolicySku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      snat: map['snat'] == null ? null : FirewallPolicySNAT.fromMap((map['snat'] as Map).cast<String, dynamic>()),
      sql: map['sql'] == null ? null : FirewallPolicySQL.fromMap((map['sql'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      threatIntelMode: map['threatIntelMode'] == null ? null : map['threatIntelMode'] as String,
      threatIntelWhitelist: map['threatIntelWhitelist'] == null ? null : FirewallPolicyThreatIntelWhitelist.fromMap((map['threatIntelWhitelist'] as Map).cast<String, dynamic>()),
      transportSecurity: map['transportSecurity'] == null ? null : FirewallPolicyTransportSecurity.fromMap((map['transportSecurity'] as Map).cast<String, dynamic>()),
    );
  }
}
