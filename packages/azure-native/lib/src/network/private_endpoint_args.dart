...
class PrivateEndpointArgs {
  ...
  /// [tags] Resource tags.
  PrivateEndpointArgs({
    List<ApplicationSecurityGroupNetwork>? applicationSecurityGroups,
  ...
  factory PrivateEndpointArgs.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointArgs(
      applicationSecurityGroups: map['applicationSecurityGroups'] == null ? null : (map['applicationSecurityGroups'] as List).cast<ApplicationSecurityGroupNetwork>(),
      customDnsConfigs: map['customDnsConfigs'] == null ? null : pulumi.Input.decodeList<CustomDnsConfigPropertiesFormat>(map['customDnsConfigs'], (value) => CustomDnsConfigPropertiesFormat.fromMap((value as Map).cast<String, dynamic>())),
      ...
      ipConfigurations: map['ipConfigurations'] == null ? null : pulumi.Input.decodeList<PrivateEndpointIPConfiguration>(map['ipConfigurations'], (value) => PrivateEndpointIPConfiguration.fromMap((value as Map).cast<String, dynamic>())),
