...
class NetworkInterfaceTapConfigurationArgs {
  ...
  NetworkInterfaceTapConfigurationArgs({
    ...
    VirtualNetworkTapNetwork? virtualNetworkTap,
  }) :
  ...
  factory NetworkInterfaceTapConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceTapConfigurationArgs(
      ...
      tapConfigurationName: map['tapConfigurationName'] == null ? null : map['tapConfigurationName'] as String,
      virtualNetworkTap: map['virtualNetworkTap'] == null ? null : map['virtualNetworkTap'] as VirtualNetworkTapNetwork,
    );
  }
}
