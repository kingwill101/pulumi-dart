...
class SecurityRule {
  ...
  final List<ApplicationSecurityGroup>? destinationApplicationSecurityGroups;
  ...
  final List<ApplicationSecurityGroup>? sourceApplicationSecurityGroups;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'destinationApplicationSecurityGroups': ?destinationApplicationSecurityGroups == null ? null : pulumi.Input.encodeList<ApplicationSecurityGroup, Map<String, dynamic>>(destinationApplicationSecurityGroups!, (value) => value.toMap()),
      ...
      'sourceApplicationSecurityGroups': ?sourceApplicationSecurityGroups == null ? null : pulumi.Input.encodeList<ApplicationSecurityGroup, Map<String, dynamic>>(sourceApplicationSecurityGroups!, (value) => value.toMap()),
  ...
  factory SecurityRule.fromMap(Map<String, dynamic> map) {
    return SecurityRule(
      ...
      destinationApplicationSecurityGroups: map['destinationApplicationSecurityGroups'] == null ? null : pulumi.Input.decodeList<ApplicationSecurityGroup>(map['destinationApplicationSecurityGroups'], (value) => ApplicationSecurityGroup.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceApplicationSecurityGroups: map['sourceApplicationSecurityGroups'] == null ? null : pulumi.Input.decodeList<ApplicationSecurityGroup>(map['sourceApplicationSecurityGroups'], (value) => ApplicationSecurityGroup.fromMap((value as Map).cast<String, dynamic>())),
