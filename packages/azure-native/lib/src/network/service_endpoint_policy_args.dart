...
class ServiceEndpointPolicyArgs {
  ...
  ServiceEndpointPolicyArgs({
    ...
    String? serviceAlias,
    List<ServiceEndpointPolicyDefinitionNetwork>? serviceEndpointPolicyDefinitions,
  ...
  factory ServiceEndpointPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ServiceEndpointPolicyArgs(
      ...
      serviceEndpointPolicyDefinitions: map['serviceEndpointPolicyDefinitions'] == null ? null : (map['serviceEndpointPolicyDefinitions'] as List).cast<ServiceEndpointPolicyDefinitionNetwork>(),
      serviceEndpointPolicyName: map['serviceEndpointPolicyName'] == null ? null : map['serviceEndpointPolicyName'] as String,
