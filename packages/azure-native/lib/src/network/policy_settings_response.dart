...
class PolicySettingsResponse {
  ...
  final PolicySettingsResponseLogScrubbing? logScrubbing;
  ...
  factory PolicySettingsResponse.fromMap(Map<String, dynamic> map) {
    return PolicySettingsResponse(
      ...
      logScrubbing: map['logScrubbing'] == null ? null : PolicySettingsResponseLogScrubbing.fromMap((map['logScrubbing'] as Map).cast<String, dynamic>()),
