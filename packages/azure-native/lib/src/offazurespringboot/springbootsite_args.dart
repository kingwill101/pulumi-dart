...
class SpringbootsiteArgs {
  ...
  factory SpringbootsiteArgs.fromMap(Map<String, dynamic> map) {
    return SpringbootsiteArgs(
      extendedLocation: map['extendedLocation'] == null ? null : SpringbootsitesModelExtendedLocation.fromMap((map['extendedLocation'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : SpringbootsitesProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      springbootsitesName: map['springbootsitesName'] == null ? null : map['springbootsitesName'] as String,
