...
class SpringbootappsProperties {
  ...
  final List<SpringbootappsPropertiesApplicationConfigurations>? applicationConfigurations;
  ...
  final List<SpringbootappsPropertiesInstances>? instances;
  ...
  final List<SpringbootappsPropertiesMiscs>? miscs;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'appPort': ?appPort,
      'appType': ?appType,
      'applicationConfigurations': ?applicationConfigurations == null ? null : pulumi.Input.encodeList<SpringbootappsPropertiesApplicationConfigurations, Map<String, dynamic>>(applicationConfigurations!, (value) => value.toMap()),
      ...
      'instances': ?instances == null ? null : pulumi.Input.encodeList<SpringbootappsPropertiesInstances, Map<String, dynamic>>(instances!, (value) => value.toMap()),
      ...
      'miscs': ?miscs == null ? null : pulumi.Input.encodeList<SpringbootappsPropertiesMiscs, Map<String, dynamic>>(miscs!, (value) => value.toMap()),
  ...
  factory SpringbootappsProperties.fromMap(Map<String, dynamic> map) {
    return SpringbootappsProperties(
      ...
      applicationConfigurations: map['applicationConfigurations'] == null ? null : pulumi.Input.decodeList<SpringbootappsPropertiesApplicationConfigurations>(map['applicationConfigurations'], (value) => SpringbootappsPropertiesApplicationConfigurations.fromMap((value as Map).cast<String, dynamic>())),
      ...
      instances: map['instances'] == null ? null : pulumi.Input.decodeList<SpringbootappsPropertiesInstances>(map['instances'], (value) => SpringbootappsPropertiesInstances.fromMap((value as Map).cast<String, dynamic>())),
      ...
      miscs: map['miscs'] == null ? null : pulumi.Input.decodeList<SpringbootappsPropertiesMiscs>(map['miscs'], (value) => SpringbootappsPropertiesMiscs.fromMap((value as Map).cast<String, dynamic>())),
