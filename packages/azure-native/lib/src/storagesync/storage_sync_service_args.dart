...
class StorageSyncServiceArgs {
  ...
  factory StorageSyncServiceArgs.fromMap(Map<String, dynamic> map) {
    return StorageSyncServiceArgs(
      ...
      storageSyncServiceName: map['storageSyncServiceName'] == null ? null : map['storageSyncServiceName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      useIdentity: map['useIdentity'] == null ? null : map['useIdentity'] as bool,
    );
  }
}
