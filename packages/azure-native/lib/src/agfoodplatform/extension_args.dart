...
class ExtensionArgs {
  ...
  factory ExtensionArgs.fromMap(Map<String, dynamic> map) {
    return ExtensionArgs(
      additionalApiProperties: map['additionalApiProperties'] == null ? null : pulumi.Input.decodeMapValues<ApiProperties>(map['additionalApiProperties'], (value) => ApiProperties.fromMap((value as Map).cast<String, dynamic>())),
