...
class GetHostPoolResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'agentUpdate': ?agentUpdate == null ? null : agentUpdate!.toMap(),
      ...
      'registrationInfo': ?registrationInfo == null ? null : registrationInfo!.toMap(),
      'ring': ?ring,
  ...
  factory GetHostPoolResult.fromMap(Map<String, dynamic> map) {
    return GetHostPoolResult(
      agentUpdate: map['agentUpdate'] == null ? null : AgentUpdatePropertiesResponse.fromMap((map['agentUpdate'] as Map).cast<String, dynamic>()),
      ...
      registrationInfo: map['registrationInfo'] == null ? null : RegistrationInfoResponse.fromMap((map['registrationInfo'] as Map).cast<String, dynamic>()),
