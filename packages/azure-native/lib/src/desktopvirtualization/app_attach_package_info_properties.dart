...
class AppAttachPackageInfoProperties {
  ...
  final List<MsixPackageApplications>? packageApplications;
  /// List of package dependencies.
  final List<MsixPackageDependencies>? packageDependencies;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'packageApplications': ?packageApplications == null ? null : pulumi.Input.encodeList<MsixPackageApplications, Map<String, dynamic>>(packageApplications!, (value) => value.toMap()),
      'packageDependencies': ?packageDependencies == null ? null : pulumi.Input.encodeList<MsixPackageDependencies, Map<String, dynamic>>(packageDependencies!, (value) => value.toMap()),
  ...
  factory AppAttachPackageInfoProperties.fromMap(Map<String, dynamic> map) {
    return AppAttachPackageInfoProperties(
      ...
      packageApplications: map['packageApplications'] == null ? null : pulumi.Input.decodeList<MsixPackageApplications>(map['packageApplications'], (value) => MsixPackageApplications.fromMap((value as Map).cast<String, dynamic>())),
      packageDependencies: map['packageDependencies'] == null ? null : pulumi.Input.decodeList<MsixPackageDependencies>(map['packageDependencies'], (value) => MsixPackageDependencies.fromMap((value as Map).cast<String, dynamic>())),
