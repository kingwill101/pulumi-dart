...
class AppAttachPackageArgs {
  ...
  AppAttachPackageArgs({
    ...
    String? location,
    required AppAttachPackageProperties properties,
  ...
  factory AppAttachPackageArgs.fromMap(Map<String, dynamic> map) {
    return AppAttachPackageArgs(
      appAttachPackageName: map['appAttachPackageName'] == null ? null : map['appAttachPackageName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: AppAttachPackageProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
