...
class HostPoolArgs {
  ...
  factory HostPoolArgs.fromMap(Map<String, dynamic> map) {
    return HostPoolArgs(
      agentUpdate: map['agentUpdate'] == null ? null : AgentUpdateProperties.fromMap((map['agentUpdate'] as Map).cast<String, dynamic>()),
      customRdpProperty: map['customRdpProperty'] == null ? null : map['customRdpProperty'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      friendlyName: map['friendlyName'] == null ? null : map['friendlyName'] as String,
      hostPoolName: map['hostPoolName'] == null ? null : map['hostPoolName'] as String,
      ...
      maxSessionLimit: map['maxSessionLimit'] == null ? null : map['maxSessionLimit'] as int,
      personalDesktopAssignmentType: map['personalDesktopAssignmentType'] == null ? null : map['personalDesktopAssignmentType'] as String,
      ...
      registrationInfo: map['registrationInfo'] == null ? null : RegistrationInfo.fromMap((map['registrationInfo'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      ring: map['ring'] == null ? null : map['ring'] as int,
      sku: map['sku'] == null ? null : ResourceModelWithAllowedPropertySetSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      ssoClientId: map['ssoClientId'] == null ? null : map['ssoClientId'] as String,
      ssoClientSecretKeyVaultPath: map['ssoClientSecretKeyVaultPath'] == null ? null : map['ssoClientSecretKeyVaultPath'] as String,
      ssoSecretType: map['ssoSecretType'] == null ? null : map['ssoSecretType'] as String,
      ssoadfsAuthority: map['ssoadfsAuthority'] == null ? null : map['ssoadfsAuthority'] as String,
      startVMOnConnect: map['startVMOnConnect'] == null ? null : map['startVMOnConnect'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      validationEnvironment: map['validationEnvironment'] == null ? null : map['validationEnvironment'] as bool,
      vmTemplate: map['vmTemplate'] == null ? null : map['vmTemplate'] as String,
    );
  }
}
