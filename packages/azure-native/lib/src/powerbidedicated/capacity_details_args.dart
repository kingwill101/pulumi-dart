...
class CapacityDetailsArgs {
  ...
  factory CapacityDetailsArgs.fromMap(Map<String, dynamic> map) {
    return CapacityDetailsArgs(
      administration: map['administration'] == null ? null : DedicatedCapacityAdministrators.fromMap((map['administration'] as Map).cast<String, dynamic>()),
      dedicatedCapacityName: map['dedicatedCapacityName'] == null ? null : map['dedicatedCapacityName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      mode: map['mode'] == null ? null : map['mode'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sku: CapacitySku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
