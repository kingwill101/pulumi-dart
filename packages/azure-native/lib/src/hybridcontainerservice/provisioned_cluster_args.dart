...
class ProvisionedClusterArgs {
  ...
  ProvisionedClusterArgs({
    ProvisionedClustersExtendedLocation? extendedLocation,
    ProvisionedClusterIdentity? identity,
    String? location,
    ProvisionedClustersAllProperties? properties,
  ...
  factory ProvisionedClusterArgs.fromMap(Map<String, dynamic> map) {
    return ProvisionedClusterArgs(
      extendedLocation: map['extendedLocation'] == null ? null : ProvisionedClustersExtendedLocation.fromMap((map['extendedLocation'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : ProvisionedClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : ProvisionedClustersAllProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
