...
class AgentPoolArgs {
  ...
  factory AgentPoolArgs.fromMap(Map<String, dynamic> map) {
    return AgentPoolArgs(
      ...
      extendedLocation: map['extendedLocation'] == null ? null : AgentPoolExtendedLocation.fromMap((map['extendedLocation'] as Map).cast<String, dynamic>()),
      ...
      status: map['status'] == null ? null : AgentPoolProvisioningStatusStatus.fromMap((map['status'] as Map).cast<String, dynamic>()),
