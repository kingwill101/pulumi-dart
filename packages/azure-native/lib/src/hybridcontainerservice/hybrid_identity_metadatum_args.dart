...
class HybridIdentityMetadatumArgs {
  ...
  factory HybridIdentityMetadatumArgs.fromMap(Map<String, dynamic> map) {
    return HybridIdentityMetadatumArgs(
      hybridIdentityMetadataResourceName: map['hybridIdentityMetadataResourceName'] == null ? null : map['hybridIdentityMetadataResourceName'] as String,
      identity: map['identity'] == null ? null : ProvisionedClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
