...
import 'private_endpoint_connections_adt_apiargs.dart';
...
class PrivateEndpointConnectionsAdtAPI extends pulumi.CustomResource {
  ...
  /// Creates a new [PrivateEndpointConnectionsAdtAPI].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [PrivateEndpointConnectionsAdtAPI]. {@macro pulumi_securityandcompliance_private_endpoint_connections_adt_apiargs_doc}
  /// [options] Resource options controlling this resource's behavior.
  PrivateEndpointConnectionsAdtAPI(
    String name, {
    PrivateEndpointConnectionsAdtAPIArgs? args,
