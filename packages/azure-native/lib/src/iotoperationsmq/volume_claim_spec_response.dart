...
class VolumeClaimSpecResponse {
  ...
  final VolumeClaimDataSourceResponse? dataSource;
  ...
  final VolumeClaimDataSourceRefResponse? dataSourceRef;
  /// Resources represents the minimum resources the volume should have. If RecoverVolumeExpansionFailure feature is enabled users are allowed to specify resource requirements that are lower than previous value but must still be higher than capacity recorded in the status field of the claim. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
  final VolumeClaimResourceRequirementsResponse? resources;
  /// A label query over volumes to consider for binding.
  final VolumeClaimSpecSelectorResponse? selector;
  ...
  factory VolumeClaimSpecResponse.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpecResponse(
      ...
      dataSource: map['dataSource'] == null ? null : VolumeClaimDataSourceResponse.fromMap((map['dataSource'] as Map).cast<String, dynamic>()),
      dataSourceRef: map['dataSourceRef'] == null ? null : VolumeClaimDataSourceRefResponse.fromMap((map['dataSourceRef'] as Map).cast<String, dynamic>()),
      resources: map['resources'] == null ? null : VolumeClaimResourceRequirementsResponse.fromMap((map['resources'] as Map).cast<String, dynamic>()),
      selector: map['selector'] == null ? null : VolumeClaimSpecSelectorResponse.fromMap((map['selector'] as Map).cast<String, dynamic>()),
