...
class BrokerArgs {
  ...
  /// [tags] Resource tags.
  BrokerArgs({
    required ContainerImage authImage,
    required ContainerImage brokerImage,
    String? brokerName,
    NodeTolerations? brokerNodeTolerations,
    ...
    required ContainerImage healthManagerImage,
    NodeTolerations? healthManagerNodeTolerations,
    CertManagerCertOptions? internalCerts,
    String? location,
    ...
    Map<String, String>? tags,
      ...
      authImage = pulumi.Input.asInput<ContainerImage>(authImage),
      brokerImage = pulumi.Input.asInput<ContainerImage>(brokerImage),
      brokerName = pulumi.Input.asOptionalInput<String>(brokerName),
      brokerNodeTolerations = pulumi.Input.asOptionalInput<NodeTolerations>(brokerNodeTolerations),
      cardinality = pulumi.Input.asOptionalInput<Cardinality>(cardinality),
      diagnostics = pulumi.Input.asOptionalInput<BrokerDiagnostics>(diagnostics),
      diskBackedMessageBufferSettings = pulumi.Input.asOptionalInput<DiskBackedMessageBufferSettings>(diskBackedMessageBufferSettings),
      encryptInternalTraffic = pulumi.Input.asOptionalInput<bool>(encryptInternalTraffic),
      extendedLocation = pulumi.Input.asInput<ExtendedLocationProperty>(extendedLocation),
      healthManagerImage = pulumi.Input.asInput<ContainerImage>(healthManagerImage),
      healthManagerNodeTolerations = pulumi.Input.asOptionalInput<NodeTolerations>(healthManagerNodeTolerations),
      internalCerts = pulumi.Input.asOptionalInput<CertManagerCertOptions>(internalCerts),
      location = pulumi.Input.asOptionalInput<String>(location),
      memoryProfile = pulumi.Input.asOptionalInput<String>(memoryProfile),
  ...
  factory BrokerArgs.fromMap(Map<String, dynamic> map) {
    return BrokerArgs(
      authImage: ContainerImage.fromMap((map['authImage'] as Map).cast<String, dynamic>()),
      brokerImage: ContainerImage.fromMap((map['brokerImage'] as Map).cast<String, dynamic>()),
      brokerName: map['brokerName'] == null ? null : map['brokerName'] as String,
      brokerNodeTolerations: map['brokerNodeTolerations'] == null ? null : NodeTolerations.fromMap((map['brokerNodeTolerations'] as Map).cast<String, dynamic>()),
      ...
      diskBackedMessageBufferSettings: map['diskBackedMessageBufferSettings'] == null ? null : DiskBackedMessageBufferSettings.fromMap((map['diskBackedMessageBufferSettings'] as Map).cast<String, dynamic>()),
      ...
      healthManagerImage: ContainerImage.fromMap((map['healthManagerImage'] as Map).cast<String, dynamic>()),
      healthManagerNodeTolerations: map['healthManagerNodeTolerations'] == null ? null : NodeTolerations.fromMap((map['healthManagerNodeTolerations'] as Map).cast<String, dynamic>()),
