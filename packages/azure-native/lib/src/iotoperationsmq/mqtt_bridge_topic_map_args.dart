...
class MqttBridgeTopicMapArgs {
  ...
  MqttBridgeTopicMapArgs({
    ...
    required String mqttBridgeConnectorRef,
    required String resourceGroupName,
    List<MqttBridgeRoutes>? routes,
  ...
  factory MqttBridgeTopicMapArgs.fromMap(Map<String, dynamic> map) {
    return MqttBridgeTopicMapArgs(
      ...
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<MqttBridgeRoutes>(map['routes'], (value) => MqttBridgeRoutes.fromMap((value as Map).cast<String, dynamic>())),
