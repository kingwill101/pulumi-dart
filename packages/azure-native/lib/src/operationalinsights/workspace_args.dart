...
class WorkspaceArgs {
  ...
  factory WorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceArgs(
      ...
      features: map['features'] == null ? null : WorkspaceFeatures.fromMap((map['features'] as Map).cast<String, dynamic>()),
      ...
      sku: map['sku'] == null ? null : WorkspaceSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      workspaceCapping: map['workspaceCapping'] == null ? null : WorkspaceCapping.fromMap((map['workspaceCapping'] as Map).cast<String, dynamic>()),
