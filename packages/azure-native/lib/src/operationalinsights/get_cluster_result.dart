...
class GetClusterResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'associatedWorkspaces': ?associatedWorkspaces == null ? null : pulumi.Input.encodeList<AssociatedWorkspaceResponse, Map<String, dynamic>>(associatedWorkspaces!, (value) => value.toMap()),
      'azureApiVersion': azureApiVersion,
      'billingType': ?billingType,
      'capacityReservationProperties': ?capacityReservationProperties == null ? null : capacityReservationProperties!.toMap(),
      'clusterId': clusterId,
