...
class ConfigurationServiceArgs {
  ...
  factory ConfigurationServiceArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationServiceArgs(
      configurationServiceName: map['configurationServiceName'] == null ? null : map['configurationServiceName'] as String,
      properties: map['properties'] == null ? null : ConfigurationServiceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
