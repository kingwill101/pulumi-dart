...
class GatewayRouteConfigArgs {
  ...
  factory GatewayRouteConfigArgs.fromMap(Map<String, dynamic> map) {
    return GatewayRouteConfigArgs(
      ...
      properties: map['properties'] == null ? null : GatewayRouteConfigProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      routeConfigName: map['routeConfigName'] == null ? null : map['routeConfigName'] as String,
