...
class BuildServiceBuilderArgs {
  ...
  factory BuildServiceBuilderArgs.fromMap(Map<String, dynamic> map) {
    return BuildServiceBuilderArgs(
      ...
      builderName: map['builderName'] == null ? null : map['builderName'] as String,
      properties: map['properties'] == null ? null : BuilderProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
