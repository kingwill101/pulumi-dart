...
class CustomizedAcceleratorArgs {
  ...
  factory CustomizedAcceleratorArgs.fromMap(Map<String, dynamic> map) {
    return CustomizedAcceleratorArgs(
      ...
      customizedAcceleratorName: map['customizedAcceleratorName'] == null ? null : map['customizedAcceleratorName'] as String,
      properties: map['properties'] == null ? null : CustomizedAcceleratorProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
