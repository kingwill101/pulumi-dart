...
class AppArgs {
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      identity: map['identity'] == null ? null : ManagedIdentityProperties.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : AppResourceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
