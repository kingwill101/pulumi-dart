...
class BuildpackBindingArgs {
  ...
  factory BuildpackBindingArgs.fromMap(Map<String, dynamic> map) {
    return BuildpackBindingArgs(
      ...
      buildpackBindingName: map['buildpackBindingName'] == null ? null : map['buildpackBindingName'] as String,
      properties: map['properties'] == null ? null : BuildpackBindingProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
