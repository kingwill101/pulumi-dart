...
class ApmArgs {
  ...
  factory ApmArgs.fromMap(Map<String, dynamic> map) {
    return ApmArgs(
      apmName: map['apmName'] == null ? null : map['apmName'] as String,
      properties: map['properties'] == null ? null : ApmProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
