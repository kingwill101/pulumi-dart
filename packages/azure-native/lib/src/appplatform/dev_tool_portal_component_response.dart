...
class DevToolPortalComponentResponse {
  ...
  final List<DevToolPortalInstanceResponse> instances;
  final String name;
  /// The requested resource quantity for required CPU and Memory.
  final DevToolPortalResourceRequestsResponse resourceRequests;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'instances': pulumi.Input.encodeList<DevToolPortalInstanceResponse, Map<String, dynamic>>(instances, (value) => value.toMap()),
      'name': name,
  ...
  factory DevToolPortalComponentResponse.fromMap(Map<String, dynamic> map) {
    return DevToolPortalComponentResponse(
      instances: pulumi.Input.decodeList<DevToolPortalInstanceResponse>(map['instances'], (value) => DevToolPortalInstanceResponse.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] as String,
      resourceRequests: DevToolPortalResourceRequestsResponse.fromMap((map['resourceRequests'] as Map).cast<String, dynamic>()),
    );
  }
}
