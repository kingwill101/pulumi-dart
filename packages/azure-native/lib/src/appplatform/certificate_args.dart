...
class CertificateArgs {
  ...
  CertificateArgs({
    ...
    ContentCertificateProperties? properties,
  ...
  factory CertificateArgs.fromMap(Map<String, dynamic> map) {
    return CertificateArgs(
      ...
      properties: map['properties'] == null ? null : ContentCertificateProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
