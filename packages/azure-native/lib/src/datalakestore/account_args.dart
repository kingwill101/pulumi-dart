...
class AccountArgs {
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      defaultGroup: map['defaultGroup'] == null ? null : map['defaultGroup'] as String,
      encryptionConfig: map['encryptionConfig'] == null ? null : EncryptionConfig.fromMap((map['encryptionConfig'] as Map).cast<String, dynamic>()),
      encryptionState: map['encryptionState'] == null ? null : EncryptionState.fromValue(map['encryptionState'] as String),
      ...
      trustedIdProviderState: map['trustedIdProviderState'] == null ? null : TrustedIdProviderState.fromValue(map['trustedIdProviderState'] as String),
      trustedIdProviders: map['trustedIdProviders'] == null ? null : pulumi.Input.decodeList<CreateTrustedIdProviderWithAccountParameters>(map['trustedIdProviders'], (value) => CreateTrustedIdProviderWithAccountParameters.fromMap((value as Map).cast<String, dynamic>())),
      virtualNetworkRules: map['virtualNetworkRules'] == null ? null : pulumi.Input.decodeList<CreateVirtualNetworkRuleWithAccountParameters>(map['virtualNetworkRules'], (value) => CreateVirtualNetworkRuleWithAccountParameters.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
