...
class CompoundAssessmentOperationArgs {
  ...
  factory CompoundAssessmentOperationArgs.fromMap(Map<String, dynamic> map) {
    return CompoundAssessmentOperationArgs(
      compoundAssessmentName: map['compoundAssessmentName'] == null ? null : map['compoundAssessmentName'] as String,
      projectName: map['projectName'] as String,
      properties: map['properties'] == null ? null : CompoundAssessmentProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
