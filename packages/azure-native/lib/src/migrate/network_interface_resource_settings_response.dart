...
class NetworkInterfaceResourceSettingsResponse {
  ...
  final List<NicIpConfigurationResourceSettingsResponse>? ipConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipConfigurations': ?ipConfigurations == null ? null : pulumi.Input.encodeList<NicIpConfigurationResourceSettingsResponse, Map<String, dynamic>>(ipConfigurations!, (value) => value.toMap()),
  ...
  factory NetworkInterfaceResourceSettingsResponse.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceResourceSettingsResponse(
      ...
      ipConfigurations: map['ipConfigurations'] == null ? null : pulumi.Input.decodeList<NicIpConfigurationResourceSettingsResponse>(map['ipConfigurations'], (value) => NicIpConfigurationResourceSettingsResponse.fromMap((value as Map).cast<String, dynamic>())),
