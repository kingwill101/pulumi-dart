...
class WorkloadInstanceArgs {
  ...
  WorkloadInstanceArgs({
    ...
    WorkloadInstanceModelProperties? properties,
  ...
  factory WorkloadInstanceArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadInstanceArgs(
      ...
      properties: map['properties'] == null ? null : WorkloadInstanceModelProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      subscriptionId: map['subscriptionId'] == null ? null : map['subscriptionId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      workloadInstanceName: map['workloadInstanceName'] == null ? null : map['workloadInstanceName'] as String,
    );
  }
}
