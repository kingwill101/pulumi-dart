...
class AssessmentProjectsOperation extends pulumi.CustomResource {
  ...
  AssessmentProjectsOperation(
    ...
    this.assessmentSolutionId = registerOutput<String?>('assessmentSolutionId');
    ...
    this.customerWorkspaceId = registerOutput<String?>('customerWorkspaceId');
    this.customerWorkspaceLocation = registerOutput<String?>('customerWorkspaceLocation');
