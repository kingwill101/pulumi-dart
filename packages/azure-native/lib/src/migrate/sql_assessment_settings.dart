...
class SqlAssessmentSettings {
  ...
  final SqlDbSettingsV3? azureSqlDatabaseSettings;
  /// Gets or sets user configurable SQL managed instance settings.
  final SqlMiSettingsV3? azureSqlManagedInstanceSettings;
  /// Gets or sets user configurable SQL VM settings.
  final SqlVmSettings? azureSqlVmSettings;
  ...
  final EntityUptime? entityUptime;
  ...
  factory SqlAssessmentSettings.fromMap(Map<String, dynamic> map) {
    return SqlAssessmentSettings(
      ...
      azureSqlDatabaseSettings: map['azureSqlDatabaseSettings'] == null ? null : SqlDbSettingsV3.fromMap((map['azureSqlDatabaseSettings'] as Map).cast<String, dynamic>()),
      azureSqlManagedInstanceSettings: map['azureSqlManagedInstanceSettings'] == null ? null : SqlMiSettingsV3.fromMap((map['azureSqlManagedInstanceSettings'] as Map).cast<String, dynamic>()),
