...
class WaveArgs {
  ...
  factory WaveArgs.fromMap(Map<String, dynamic> map) {
    return WaveArgs(
      ...
      properties: map['properties'] == null ? null : WaveProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      waveName: map['waveName'] == null ? null : map['waveName'] as String,
    );
  }
}
