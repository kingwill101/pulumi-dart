...
class WorkloadDeploymentArgs {
  ...
  WorkloadDeploymentArgs({
    ...
    WorkloadDeploymentModelProperties? properties,
  ...
  factory WorkloadDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadDeploymentArgs(
      ...
      properties: map['properties'] == null ? null : WorkloadDeploymentModelProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      subscriptionId: map['subscriptionId'] == null ? null : map['subscriptionId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      workloadDeploymentName: map['workloadDeploymentName'] == null ? null : map['workloadDeploymentName'] as String,
    );
  }
}
