...
class AksAssessmentOperationArgs {
  ...
  AksAssessmentOperationArgs({
    ...
    AssessmentScopeParameters? scope,
    required AKSAssessmentSettings settings,
  }) :
  ...
  factory AksAssessmentOperationArgs.fromMap(Map<String, dynamic> map) {
    return AksAssessmentOperationArgs(
      ...
      scope: map['scope'] == null ? null : AssessmentScopeParameters.fromMap((map['scope'] as Map).cast<String, dynamic>()),
      settings: AKSAssessmentSettings.fromMap((map['settings'] as Map).cast<String, dynamic>()),
    );
  }
}
