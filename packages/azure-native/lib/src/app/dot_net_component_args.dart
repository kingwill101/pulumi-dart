...
class DotNetComponentArgs {
  ...
  factory DotNetComponentArgs.fromMap(Map<String, dynamic> map) {
    return DotNetComponentArgs(
      ...
      configurations: map['configurations'] == null ? null : pulumi.Input.decodeList<DotNetComponentConfigurationProperty>(map['configurations'], (value) => DotNetComponentConfigurationProperty.fromMap((value as Map).cast<String, dynamic>())),
      environmentName: map['environmentName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      serviceBinds: map['serviceBinds'] == null ? null : pulumi.Input.decodeList<DotNetComponentServiceBind>(map['serviceBinds'], (value) => DotNetComponentServiceBind.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
