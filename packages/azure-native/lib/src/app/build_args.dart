...
class BuildArgs {
  ...
  factory BuildArgs.fromMap(Map<String, dynamic> map) {
    return BuildArgs(
      buildName: map['buildName'] == null ? null : map['buildName'] as String,
      builderName: map['builderName'] as String,
      configuration: map['configuration'] == null ? null : BuildConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      destinationContainerRegistry: map['destinationContainerRegistry'] == null ? null : ContainerRegistryWithCustomImage.fromMap((map['destinationContainerRegistry'] as Map).cast<String, dynamic>()),
