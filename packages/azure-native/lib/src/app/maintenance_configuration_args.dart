...
class MaintenanceConfigurationArgs {
  ...
  MaintenanceConfigurationArgs({
    ...
    required List<ScheduledEntry> scheduledEntries,
  }) :
  ...
  factory MaintenanceConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceConfigurationArgs(
      ...
      scheduledEntries: pulumi.Input.decodeList<ScheduledEntry>(map['scheduledEntries'], (value) => ScheduledEntry.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
