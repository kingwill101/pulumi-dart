...
class AppResiliencyArgs {
  ...
  factory AppResiliencyArgs.fromMap(Map<String, dynamic> map) {
    return AppResiliencyArgs(
      ...
      circuitBreakerPolicy: map['circuitBreakerPolicy'] == null ? null : CircuitBreakerPolicy.fromMap((map['circuitBreakerPolicy'] as Map).cast<String, dynamic>()),
      httpConnectionPool: map['httpConnectionPool'] == null ? null : HttpConnectionPool.fromMap((map['httpConnectionPool'] as Map).cast<String, dynamic>()),
      httpRetryPolicy: map['httpRetryPolicy'] == null ? null : HttpRetryPolicy.fromMap((map['httpRetryPolicy'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tcpConnectionPool: map['tcpConnectionPool'] == null ? null : TcpConnectionPool.fromMap((map['tcpConnectionPool'] as Map).cast<String, dynamic>()),
      tcpRetryPolicy: map['tcpRetryPolicy'] == null ? null : TcpRetryPolicy.fromMap((map['tcpRetryPolicy'] as Map).cast<String, dynamic>()),
      timeoutPolicy: map['timeoutPolicy'] == null ? null : TimeoutPolicy.fromMap((map['timeoutPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
