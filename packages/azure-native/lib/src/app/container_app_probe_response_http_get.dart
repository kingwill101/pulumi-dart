...
class ContainerAppProbeResponseHttpGet {
  ...
  final List<ContainerAppProbeResponseHttpHeaders>? httpHeaders;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'host': ?host,
      'httpHeaders': ?httpHeaders == null ? null : pulumi.Input.encodeList<ContainerAppProbeResponseHttpHeaders, Map<String, dynamic>>(httpHeaders!, (value) => value.toMap()),
      'path': ?path,
      'port': port,
      'scheme': ?scheme,
    };
  ...
  factory ContainerAppProbeResponseHttpGet.fromMap(Map<String, dynamic> map) {
    return ContainerAppProbeResponseHttpGet(
      ...
      httpHeaders: map['httpHeaders'] == null ? null : pulumi.Input.decodeList<ContainerAppProbeResponseHttpHeaders>(map['httpHeaders'], (value) => ContainerAppProbeResponseHttpHeaders.fromMap((value as Map).cast<String, dynamic>())),
