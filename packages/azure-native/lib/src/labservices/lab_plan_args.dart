...
class LabPlanArgs {
  ...
  factory LabPlanArgs.fromMap(Map<String, dynamic> map) {
    return LabPlanArgs(
      ...
      defaultAutoShutdownProfile: map['defaultAutoShutdownProfile'] == null ? null : AutoShutdownProfile.fromMap((map['defaultAutoShutdownProfile'] as Map).cast<String, dynamic>()),
      defaultConnectionProfile: map['defaultConnectionProfile'] == null ? null : ConnectionProfile.fromMap((map['defaultConnectionProfile'] as Map).cast<String, dynamic>()),
      defaultNetworkProfile: map['defaultNetworkProfile'] == null ? null : LabPlanNetworkProfile.fromMap((map['defaultNetworkProfile'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : Identity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      labPlanName: map['labPlanName'] == null ? null : map['labPlanName'] as String,
      ...
      supportInfo: map['supportInfo'] == null ? null : SupportInfo.fromMap((map['supportInfo'] as Map).cast<String, dynamic>()),
