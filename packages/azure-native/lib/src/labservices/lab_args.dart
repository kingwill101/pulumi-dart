...
class LabArgs {
  ...
  LabArgs({
    required AutoShutdownProfile autoShutdownProfile,
    required ConnectionProfile connectionProfile,
    String? description,
    String? labName,
    String? labPlanId,
    String? location,
    ...
    required SecurityProfile securityProfile,
    Map<String, String>? tags,
    String? title,
    required VirtualMachineProfile virtualMachineProfile,
  }) :
  ...
  factory LabArgs.fromMap(Map<String, dynamic> map) {
    return LabArgs(
      autoShutdownProfile: AutoShutdownProfile.fromMap((map['autoShutdownProfile'] as Map).cast<String, dynamic>()),
      connectionProfile: ConnectionProfile.fromMap((map['connectionProfile'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      labName: map['labName'] == null ? null : map['labName'] as String,
      labPlanId: map['labPlanId'] == null ? null : map['labPlanId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      networkProfile: map['networkProfile'] == null ? null : LabNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      rosterProfile: map['rosterProfile'] == null ? null : RosterProfile.fromMap((map['rosterProfile'] as Map).cast<String, dynamic>()),
      securityProfile: SecurityProfile.fromMap((map['securityProfile'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      title: map['title'] == null ? null : map['title'] as String,
      virtualMachineProfile: VirtualMachineProfile.fromMap((map['virtualMachineProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
