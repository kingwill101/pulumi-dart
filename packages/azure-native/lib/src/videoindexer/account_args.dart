...
class AccountArgs {
  ...
  AccountArgs({
    ...
    Map<String, String>? tags,
      ...
      storageServices = pulumi.Input.asOptionalInput<StorageServicesForPutRequest>(storageServices),
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      ...
      storageServices: map['storageServices'] == null ? null : StorageServicesForPutRequest.fromMap((map['storageServices'] as Map).cast<String, dynamic>()),
