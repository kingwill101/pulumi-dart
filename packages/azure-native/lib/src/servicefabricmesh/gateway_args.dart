...
class GatewayArgs {
  ...
  GatewayArgs({
    String? description,
    required NetworkRef destinationNetwork,
    String? gatewayResourceName,
    List<HttpConfig>? http,
    String? location,
    required String resourceGroupName,
    required NetworkRef sourceNetwork,
  ...
  factory GatewayArgs.fromMap(Map<String, dynamic> map) {
    return GatewayArgs(
      ...
      destinationNetwork: NetworkRef.fromMap((map['destinationNetwork'] as Map).cast<String, dynamic>()),
      gatewayResourceName: map['gatewayResourceName'] == null ? null : map['gatewayResourceName'] as String,
      http: map['http'] == null ? null : pulumi.Input.decodeList<HttpConfig>(map['http'], (value) => HttpConfig.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sourceNetwork: NetworkRef.fromMap((map['sourceNetwork'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tcp: map['tcp'] == null ? null : pulumi.Input.decodeList<TcpConfig>(map['tcp'], (value) => TcpConfig.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
