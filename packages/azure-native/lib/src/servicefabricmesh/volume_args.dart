...
class VolumeArgs {
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      azureFileParameters: map['azureFileParameters'] == null ? null : VolumeProviderParametersAzureFile.fromMap((map['azureFileParameters'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      provider: map['provider'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      volumeResourceName: map['volumeResourceName'] == null ? null : map['volumeResourceName'] as String,
    );
  }
}
