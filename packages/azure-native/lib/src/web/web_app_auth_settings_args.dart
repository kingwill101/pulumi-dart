...
class WebAppAuthSettingsArgs {
  ...
  factory WebAppAuthSettingsArgs.fromMap(Map<String, dynamic> map) {
    return WebAppAuthSettingsArgs(
      aadClaimsAuthorization: map['aadClaimsAuthorization'] == null ? null : map['aadClaimsAuthorization'] as String,
      additionalLoginParams: map['additionalLoginParams'] == null ? null : (map['additionalLoginParams'] as List).cast<String>(),
      ...
      authFilePath: map['authFilePath'] == null ? null : map['authFilePath'] as String,
      ...
      configVersion: map['configVersion'] == null ? null : map['configVersion'] as String,
      defaultProvider: map['defaultProvider'] == null ? null : BuiltInAuthenticationProvider.fromValue(map['defaultProvider'] as String),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      facebookAppId: map['facebookAppId'] == null ? null : map['facebookAppId'] as String,
      facebookAppSecret: map['facebookAppSecret'] == null ? null : map['facebookAppSecret'] as String,
      facebookAppSecretSettingName: map['facebookAppSecretSettingName'] == null ? null : map['facebookAppSecretSettingName'] as String,
      facebookOAuthScopes: map['facebookOAuthScopes'] == null ? null : (map['facebookOAuthScopes'] as List).cast<String>(),
      gitHubClientId: map['gitHubClientId'] == null ? null : map['gitHubClientId'] as String,
      gitHubClientSecret: map['gitHubClientSecret'] == null ? null : map['gitHubClientSecret'] as String,
      gitHubClientSecretSettingName: map['gitHubClientSecretSettingName'] == null ? null : map['gitHubClientSecretSettingName'] as String,
      gitHubOAuthScopes: map['gitHubOAuthScopes'] == null ? null : (map['gitHubOAuthScopes'] as List).cast<String>(),
      googleClientId: map['googleClientId'] == null ? null : map['googleClientId'] as String,
      googleClientSecret: map['googleClientSecret'] == null ? null : map['googleClientSecret'] as String,
      googleClientSecretSettingName: map['googleClientSecretSettingName'] == null ? null : map['googleClientSecretSettingName'] as String,
      googleOAuthScopes: map['googleOAuthScopes'] == null ? null : (map['googleOAuthScopes'] as List).cast<String>(),
      isAuthFromFile: map['isAuthFromFile'] == null ? null : map['isAuthFromFile'] as String,
      issuer: map['issuer'] == null ? null : map['issuer'] as String,
      kind: map['kind'] == null ? null : map['kind'] as String,
      microsoftAccountClientId: map['microsoftAccountClientId'] == null ? null : map['microsoftAccountClientId'] as String,
      microsoftAccountClientSecret: map['microsoftAccountClientSecret'] == null ? null : map['microsoftAccountClientSecret'] as String,
      microsoftAccountClientSecretSettingName: map['microsoftAccountClientSecretSettingName'] == null ? null : map['microsoftAccountClientSecretSettingName'] as String,
      microsoftAccountOAuthScopes: map['microsoftAccountOAuthScopes'] == null ? null : (map['microsoftAccountOAuthScopes'] as List).cast<String>(),
      ...
      twitterConsumerKey: map['twitterConsumerKey'] == null ? null : map['twitterConsumerKey'] as String,
      twitterConsumerSecret: map['twitterConsumerSecret'] == null ? null : map['twitterConsumerSecret'] as String,
      twitterConsumerSecretSettingName: map['twitterConsumerSecretSettingName'] == null ? null : map['twitterConsumerSecretSettingName'] as String,
      unauthenticatedClientAction: map['unauthenticatedClientAction'] == null ? null : UnauthenticatedClientAction.fromValue(map['unauthenticatedClientAction'] as String),
      validateIssuer: map['validateIssuer'] == null ? null : map['validateIssuer'] as bool,
    );
  }
}
