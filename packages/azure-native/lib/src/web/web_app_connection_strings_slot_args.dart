...
class WebAppConnectionStringsSlotArgs {
  ...
  factory WebAppConnectionStringsSlotArgs.fromMap(Map<String, dynamic> map) {
    return WebAppConnectionStringsSlotArgs(
      ...
      properties: map['properties'] == null ? null : pulumi.Input.decodeMapValues<ConnStringValueTypePair>(map['properties'], (value) => ConnStringValueTypePair.fromMap((value as Map).cast<String, dynamic>())),
