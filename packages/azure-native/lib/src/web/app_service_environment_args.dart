...
class AppServiceEnvironmentArgs {
  ...
  AppServiceEnvironmentArgs({
    ...
    required VirtualNetworkProfile virtualNetwork,
    bool? zoneRedundant,
  }) :
  ...
  factory AppServiceEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return AppServiceEnvironmentArgs(
      clusterSettings: map['clusterSettings'] == null ? null : pulumi.Input.decodeList<NameValuePair>(map['clusterSettings'], (value) => NameValuePair.fromMap((value as Map).cast<String, dynamic>())),
      customDnsSuffixConfiguration: map['customDnsSuffixConfiguration'] == null ? null : CustomDnsSuffixConfiguration.fromMap((map['customDnsSuffixConfiguration'] as Map).cast<String, dynamic>()),
      ...
      networkingConfiguration: map['networkingConfiguration'] == null ? null : AseV3NetworkingConfiguration.fromMap((map['networkingConfiguration'] as Map).cast<String, dynamic>()),
      ...
      virtualNetwork: VirtualNetworkProfile.fromMap((map['virtualNetwork'] as Map).cast<String, dynamic>()),
