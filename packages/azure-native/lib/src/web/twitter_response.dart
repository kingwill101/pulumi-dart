...
class TwitterResponse {
  ...
  final TwitterRegistrationResponse? registration;
  ...
  factory TwitterResponse.fromMap(Map<String, dynamic> map) {
    return TwitterResponse(
      ...
      registration: map['registration'] == null ? null : TwitterRegistrationResponse.fromMap((map['registration'] as Map).cast<String, dynamic>()),
    );
  }
}
