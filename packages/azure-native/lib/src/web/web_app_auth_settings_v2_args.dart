...
/// {@template pulumi_web_web_app_auth_settings_v2_args_doc}
/// The set of arguments for WebAppAuthSettingsV2.
/// {@endtemplate}
...
class WebAppAuthSettingsV2Args {
  ...
  /// Creates a new [WebAppAuthSettingsV2Args].
  ...
  factory WebAppAuthSettingsV2Args.fromMap(Map<String, dynamic> map) {
    return WebAppAuthSettingsV2Args(
      globalValidation: map['globalValidation'] == null ? null : GlobalValidation.fromMap((map['globalValidation'] as Map).cast<String, dynamic>()),
      httpSettings: map['httpSettings'] == null ? null : HttpSettings.fromMap((map['httpSettings'] as Map).cast<String, dynamic>()),
      identityProviders: map['identityProviders'] == null ? null : IdentityProviders.fromMap((map['identityProviders'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      login: map['login'] == null ? null : Login.fromMap((map['login'] as Map).cast<String, dynamic>()),
      name: map['name'] as String,
      platform: map['platform'] == null ? null : AuthPlatform.fromMap((map['platform'] as Map).cast<String, dynamic>()),
