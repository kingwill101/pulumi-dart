...
class IdentityProviders {
  ...
  final LegacyMicrosoftAccount? legacyMicrosoftAccount;
  ...
  factory IdentityProviders.fromMap(Map<String, dynamic> map) {
    return IdentityProviders(
      ...
      legacyMicrosoftAccount: map['legacyMicrosoftAccount'] == null ? null : LegacyMicrosoftAccount.fromMap((map['legacyMicrosoftAccount'] as Map).cast<String, dynamic>()),
