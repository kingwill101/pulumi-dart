...
class IdentityProvidersResponse {
  ...
  final LegacyMicrosoftAccountResponse? legacyMicrosoftAccount;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'legacyMicrosoftAccount': ?legacyMicrosoftAccount == null ? null : legacyMicrosoftAccount!.toMap(),
  ...
  factory IdentityProvidersResponse.fromMap(Map<String, dynamic> map) {
    return IdentityProvidersResponse(
      ...
      legacyMicrosoftAccount: map['legacyMicrosoftAccount'] == null ? null : LegacyMicrosoftAccountResponse.fromMap((map['legacyMicrosoftAccount'] as Map).cast<String, dynamic>()),
