...
class WebAppAuthSettings extends pulumi.CustomResource {
  ...
  WebAppAuthSettings(
    ...
    this.aadClaimsAuthorization = registerOutput<String?>('aadClaimsAuthorization');
    this.additionalLoginParams = registerOutput<List<String>?>('additionalLoginParams');
    this.allowedAudiences = registerOutput<List<String>?>('allowedAudiences');
    this.allowedExternalRedirectUrls = registerOutput<List<String>?>('allowedExternalRedirectUrls');
    this.authFilePath = registerOutput<String?>('authFilePath');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.clientId = registerOutput<String?>('clientId');
    this.clientSecret = registerOutput<String?>('clientSecret');
    this.clientSecretCertificateThumbprint = registerOutput<String?>('clientSecretCertificateThumbprint');
    this.clientSecretSettingName = registerOutput<String?>('clientSecretSettingName');
    this.configVersion = registerOutput<String?>('configVersion');
    this.defaultProvider = registerOutput<String?>('defaultProvider');
    this.enabled = registerOutput<bool?>('enabled');
    this.facebookAppId = registerOutput<String?>('facebookAppId');
    this.facebookAppSecret = registerOutput<String?>('facebookAppSecret');
    this.facebookAppSecretSettingName = registerOutput<String?>('facebookAppSecretSettingName');
    this.facebookOAuthScopes = registerOutput<List<String>?>('facebookOAuthScopes');
    this.gitHubClientId = registerOutput<String?>('gitHubClientId');
    this.gitHubClientSecret = registerOutput<String?>('gitHubClientSecret');
    this.gitHubClientSecretSettingName = registerOutput<String?>('gitHubClientSecretSettingName');
    this.gitHubOAuthScopes = registerOutput<List<String>?>('gitHubOAuthScopes');
    this.googleClientId = registerOutput<String?>('googleClientId');
    this.googleClientSecret = registerOutput<String?>('googleClientSecret');
    this.googleClientSecretSettingName = registerOutput<String?>('googleClientSecretSettingName');
    this.googleOAuthScopes = registerOutput<List<String>?>('googleOAuthScopes');
    this.isAuthFromFile = registerOutput<String?>('isAuthFromFile');
    this.issuer = registerOutput<String?>('issuer');
    this.kind = registerOutput<String?>('kind');
    this.microsoftAccountClientId = registerOutput<String?>('microsoftAccountClientId');
    this.microsoftAccountClientSecret = registerOutput<String?>('microsoftAccountClientSecret');
    this.microsoftAccountClientSecretSettingName = registerOutput<String?>('microsoftAccountClientSecretSettingName');
    this.microsoftAccountOAuthScopes = registerOutput<List<String>?>('microsoftAccountOAuthScopes');
    this.name = registerOutput<String>('name');
    this.runtimeVersion = registerOutput<String?>('runtimeVersion');
    this.tokenRefreshExtensionHours = registerOutput<double?>('tokenRefreshExtensionHours');
    this.tokenStoreEnabled = registerOutput<bool?>('tokenStoreEnabled');
    this.twitterConsumerKey = registerOutput<String?>('twitterConsumerKey');
    this.twitterConsumerSecret = registerOutput<String?>('twitterConsumerSecret');
    this.twitterConsumerSecretSettingName = registerOutput<String?>('twitterConsumerSecretSettingName');
    this.type = registerOutput<String>('type');
    this.unauthenticatedClientAction = registerOutput<String?>('unauthenticatedClientAction');
    this.validateIssuer = registerOutput<bool?>('validateIssuer');
  }
}
