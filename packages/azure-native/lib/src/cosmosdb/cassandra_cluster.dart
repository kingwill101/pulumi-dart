...
class CassandraCluster extends pulumi.CustomResource {
  ...
  CassandraCluster(
    ...
    this.identity = registerOutput<ManagedCassandraManagedServiceIdentityResponse?>('identity');
    this.location = registerOutput<String?>('location');
    this.name = registerOutput<String>('name');
    this.properties = registerOutput<ClusterResourceResponseProperties>('properties');
