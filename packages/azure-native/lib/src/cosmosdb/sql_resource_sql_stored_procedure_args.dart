...
class SqlResourceSqlStoredProcedureArgs {
  ...
  SqlResourceSqlStoredProcedureArgs({
    ...
    required SqlStoredProcedureResource resource,
  ...
  factory SqlResourceSqlStoredProcedureArgs.fromMap(Map<String, dynamic> map) {
    return SqlResourceSqlStoredProcedureArgs(
      ...
      resource: SqlStoredProcedureResource.fromMap((map['resource'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      storedProcedureName: map['storedProcedureName'] == null ? null : map['storedProcedureName'] as String,
