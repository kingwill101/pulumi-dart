...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    DataTransferServiceResourceCreateUpdateProperties? properties,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      properties: map['properties'] == null ? null : DataTransferServiceResourceCreateUpdateProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
