...
class SqlResourceSqlUserDefinedFunctionArgs {
  ...
  SqlResourceSqlUserDefinedFunctionArgs({
    ...
    required SqlUserDefinedFunctionResource resource,
  ...
  factory SqlResourceSqlUserDefinedFunctionArgs.fromMap(Map<String, dynamic> map) {
    return SqlResourceSqlUserDefinedFunctionArgs(
      ...
      resource: SqlUserDefinedFunctionResource.fromMap((map['resource'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userDefinedFunctionName: map['userDefinedFunctionName'] == null ? null : map['userDefinedFunctionName'] as String,
    );
  }
}
