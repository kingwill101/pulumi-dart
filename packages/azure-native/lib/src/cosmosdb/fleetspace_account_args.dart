...
class FleetspaceAccountArgs {
  ...
  factory FleetspaceAccountArgs.fromMap(Map<String, dynamic> map) {
    return FleetspaceAccountArgs(
      ...
      fleetspaceAccountName: map['fleetspaceAccountName'] == null ? null : map['fleetspaceAccountName'] as String,
      fleetspaceName: map['fleetspaceName'] as String,
      globalDatabaseAccountProperties: map['globalDatabaseAccountProperties'] == null ? null : FleetspaceAccountPropertiesGlobalDatabaseAccountProperties.fromMap((map['globalDatabaseAccountProperties'] as Map).cast<String, dynamic>()),
