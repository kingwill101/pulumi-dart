...
class ConsistencyPolicy {
  ...
  final DefaultConsistencyLevel defaultConsistencyLevel;
  ...
  final double? maxStalenessPrefix;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'defaultConsistencyLevel': defaultConsistencyLevel.value,
  ...
  factory ConsistencyPolicy.fromMap(Map<String, dynamic> map) {
    return ConsistencyPolicy(
      defaultConsistencyLevel: DefaultConsistencyLevel.fromValue(map['defaultConsistencyLevel'] as String),
      maxIntervalInSeconds: map['maxIntervalInSeconds'] == null ? null : map['maxIntervalInSeconds'] as int,
      maxStalenessPrefix: map['maxStalenessPrefix'] == null ? null : map['maxStalenessPrefix'] as double,
    );
  }
}
