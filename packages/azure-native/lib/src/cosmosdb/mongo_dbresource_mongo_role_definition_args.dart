...
class MongoDBResourceMongoRoleDefinitionArgs {
  ...
  factory MongoDBResourceMongoRoleDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return MongoDBResourceMongoRoleDefinitionArgs(
      ...
      mongoRoleDefinitionId: map['mongoRoleDefinitionId'] == null ? null : map['mongoRoleDefinitionId'] as String,
      privileges: map['privileges'] == null ? null : pulumi.Input.decodeList<Privilege>(map['privileges'], (value) => Privilege.fromMap((value as Map).cast<String, dynamic>())),
      ...
      type: map['type'] == null ? null : MongoRoleDefinitionType.fromValue(map['type'] as String),
    );
  }
}
