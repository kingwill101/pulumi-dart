...
class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
  ...
  CassandraResourceCassandraKeyspace(
    ...
    this.options = registerOutput<CassandraKeyspaceGetPropertiesResponseOptions?>('options');
    this.resource = registerOutput<CassandraKeyspaceGetPropertiesResponseResource?>('resource');
