...
class WebTestArgs {
  ...
  WebTestArgs({
    ...
    WebTestKind? kind,
    String? location,
    required List<WebTestGeolocation> locations,
    WebTestPropertiesRequest? request,
    required String resourceGroupName,
    bool? retryEnabled,
    required String syntheticMonitorId,
    Map<String, String>? tags,
    int? timeout,
    WebTestPropertiesValidationRules? validationRules,
    required WebTestKind webTestKind,
    String? webTestName,
  }) :
  ...
  factory WebTestArgs.fromMap(Map<String, dynamic> map) {
    return WebTestArgs(
      configuration: map['configuration'] == null ? null : WebTestPropertiesConfiguration.fromMap((map['configuration'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      frequency: map['frequency'] == null ? null : map['frequency'] as int,
      kind: map['kind'] == null ? null : WebTestKind.fromValue(map['kind'] as String),
      location: map['location'] == null ? null : map['location'] as String,
      locations: pulumi.Input.decodeList<WebTestGeolocation>(map['locations'], (value) => WebTestGeolocation.fromMap((value as Map).cast<String, dynamic>())),
      request: map['request'] == null ? null : WebTestPropertiesRequest.fromMap((map['request'] as Map).cast<String, dynamic>()),
      ...
      validationRules: map['validationRules'] == null ? null : WebTestPropertiesValidationRules.fromMap((map['validationRules'] as Map).cast<String, dynamic>()),
      webTestKind: WebTestKind.fromValue(map['webTestKind'] as String),
      webTestName: map['webTestName'] == null ? null : map['webTestName'] as String,
    );
  }
}
