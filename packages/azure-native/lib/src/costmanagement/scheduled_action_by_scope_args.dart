...
class ScheduledActionByScopeArgs {
  ...
  ScheduledActionByScopeArgs({
    ...
    String? kind,
    String? name,
    required NotificationProperties notification,
    String? notificationEmail,
    required ScheduleProperties schedule,
  ...
  factory ScheduledActionByScopeArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledActionByScopeArgs(
      ...
      fileDestination: map['fileDestination'] == null ? null : FileDestination.fromMap((map['fileDestination'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      notification: NotificationProperties.fromMap((map['notification'] as Map).cast<String, dynamic>()),
      notificationEmail: map['notificationEmail'] == null ? null : map['notificationEmail'] as String,
      schedule: ScheduleProperties.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
