...
class ViewArgs {
  ...
  factory ViewArgs.fromMap(Map<String, dynamic> map) {
    return ViewArgs(
      ...
      dataSet: map['dataSet'] == null ? null : ReportConfigDataset.fromMap((map['dataSet'] as Map).cast<String, dynamic>()),
      ...
      kpis: map['kpis'] == null ? null : pulumi.Input.decodeList<KpiProperties>(map['kpis'], (value) => KpiProperties.fromMap((value as Map).cast<String, dynamic>())),
      metric: map['metric'] == null ? null : map['metric'] as String,
      modifiedOn: map['modifiedOn'] == null ? null : map['modifiedOn'] as String,
      pivots: map['pivots'] == null ? null : pulumi.Input.decodeList<PivotProperties>(map['pivots'], (value) => PivotProperties.fromMap((value as Map).cast<String, dynamic>())),
      scope: map['scope'] == null ? null : map['scope'] as String,
      timePeriod: map['timePeriod'] == null ? null : ReportConfigTimePeriod.fromMap((map['timePeriod'] as Map).cast<String, dynamic>()),
