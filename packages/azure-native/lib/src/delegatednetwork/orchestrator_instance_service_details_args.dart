...
class OrchestratorInstanceServiceDetailsArgs {
  ...
  OrchestratorInstanceServiceDetailsArgs({
    ...
    required ControllerDetailsDelegatednetwork controllerDetails,
  ...
  factory OrchestratorInstanceServiceDetailsArgs.fromMap(Map<String, dynamic> map) {
    return OrchestratorInstanceServiceDetailsArgs(
      ...
      controllerDetails: map['controllerDetails'] as ControllerDetailsDelegatednetwork,
      identity: map['identity'] == null ? null : OrchestratorIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
