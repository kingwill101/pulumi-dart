...
class GetRedisResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'redisConfiguration': ?redisConfiguration == null ? null : redisConfiguration!.toMap(),
  ...
  factory GetRedisResult.fromMap(Map<String, dynamic> map) {
    return GetRedisResult(
      ...
      disableAccessKeyAuthentication: map['disableAccessKeyAuthentication'] == null ? null : map['disableAccessKeyAuthentication'] as bool,
      enableNonSslPort: map['enableNonSslPort'] == null ? null : map['enableNonSslPort'] as bool,
      ...
      redisConfiguration: map['redisConfiguration'] == null ? null : RedisCommonPropertiesRedisConfigurationResponse.fromMap((map['redisConfiguration'] as Map).cast<String, dynamic>()),
      redisVersion: map['redisVersion'] == null ? null : map['redisVersion'] as String,
      replicasPerMaster: map['replicasPerMaster'] == null ? null : map['replicasPerMaster'] as int,
      replicasPerPrimary: map['replicasPerPrimary'] == null ? null : map['replicasPerPrimary'] as int,
      ...
      tenantSettings: map['tenantSettings'] == null ? null : (map['tenantSettings'] as Map).cast<String, String>(),
      type: map['type'] as String,
      updateChannel: map['updateChannel'] == null ? null : map['updateChannel'] as String,
      zonalAllocationPolicy: map['zonalAllocationPolicy'] == null ? null : map['zonalAllocationPolicy'] as String,
