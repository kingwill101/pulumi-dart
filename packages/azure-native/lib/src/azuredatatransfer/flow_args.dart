...
class FlowArgs {
  ...
  factory FlowArgs.fromMap(Map<String, dynamic> map) {
    return FlowArgs(
      ...
      flowName: map['flowName'] == null ? null : map['flowName'] as String,
      ...
      properties: map['properties'] == null ? null : FlowProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
