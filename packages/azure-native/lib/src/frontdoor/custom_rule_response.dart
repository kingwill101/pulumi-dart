...
class CustomRuleResponse {
  ...
  final List<GroupByVariableResponse>? groupBy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'groupBy': ?groupBy == null ? null : pulumi.Input.encodeList<GroupByVariableResponse, Map<String, dynamic>>(groupBy!, (value) => value.toMap()),
  ...
  factory CustomRuleResponse.fromMap(Map<String, dynamic> map) {
    return CustomRuleResponse(
      ...
      groupBy: map['groupBy'] == null ? null : pulumi.Input.decodeList<GroupByVariableResponse>(map['groupBy'], (value) => GroupByVariableResponse.fromMap((value as Map).cast<String, dynamic>())),
