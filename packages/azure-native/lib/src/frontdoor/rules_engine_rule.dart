...
class RulesEngineRule {
  ...
  final RulesEngineAction action;
  /// A list of match conditions that must meet in order for the actions of this rule to run. Having no match conditions means the actions will always run.
  final List<RulesEngineMatchCondition>? matchConditions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action.toMap(),
      'matchConditions': ?matchConditions == null ? null : pulumi.Input.encodeList<RulesEngineMatchCondition, Map<String, dynamic>>(matchConditions!, (value) => value.toMap()),
  ...
  factory RulesEngineRule.fromMap(Map<String, dynamic> map) {
    return RulesEngineRule(
      action: RulesEngineAction.fromMap((map['action'] as Map).cast<String, dynamic>()),
      matchConditions: map['matchConditions'] == null ? null : pulumi.Input.decodeList<RulesEngineMatchCondition>(map['matchConditions'], (value) => RulesEngineMatchCondition.fromMap((value as Map).cast<String, dynamic>())),
