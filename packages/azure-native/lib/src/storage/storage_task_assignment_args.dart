...
class StorageTaskAssignmentArgs {
  ...
  StorageTaskAssignmentArgs({
    ...
    required StorageTaskAssignmentProperties properties,
  ...
  factory StorageTaskAssignmentArgs.fromMap(Map<String, dynamic> map) {
    return StorageTaskAssignmentArgs(
      ...
      properties: StorageTaskAssignmentProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      storageTaskAssignmentName: map['storageTaskAssignmentName'] == null ? null : map['storageTaskAssignmentName'] as String,
    );
  }
}
