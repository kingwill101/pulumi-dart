...
class StorageAccountArgs {
  ...
  factory StorageAccountArgs.fromMap(Map<String, dynamic> map) {
    return StorageAccountArgs(
      accessTier: map['accessTier'] == null ? null : AccessTier.fromValue(map['accessTier'] as String),
      ...
      allowCrossTenantReplication: map['allowCrossTenantReplication'] == null ? null : map['allowCrossTenantReplication'] as bool,
      allowSharedKeyAccess: map['allowSharedKeyAccess'] == null ? null : map['allowSharedKeyAccess'] as bool,
      allowedCopyScope: map['allowedCopyScope'] == null ? null : map['allowedCopyScope'] as String,
      azureFilesIdentityBasedAuthentication: map['azureFilesIdentityBasedAuthentication'] == null ? null : AzureFilesIdentityBasedAuthentication.fromMap((map['azureFilesIdentityBasedAuthentication'] as Map).cast<String, dynamic>()),
      customDomain: map['customDomain'] == null ? null : CustomDomain.fromMap((map['customDomain'] as Map).cast<String, dynamic>()),
      defaultToOAuthAuthentication: map['defaultToOAuthAuthentication'] == null ? null : map['defaultToOAuthAuthentication'] as bool,
      dnsEndpointType: map['dnsEndpointType'] == null ? null : map['dnsEndpointType'] as String,
      enableExtendedGroups: map['enableExtendedGroups'] == null ? null : map['enableExtendedGroups'] as bool,
      enableHttpsTrafficOnly: map['enableHttpsTrafficOnly'] == null ? null : map['enableHttpsTrafficOnly'] as bool,
      enableNfsV3: map['enableNfsV3'] == null ? null : map['enableNfsV3'] as bool,
      ...
      immutableStorageWithVersioning: map['immutableStorageWithVersioning'] == null ? null : ImmutableStorageAccount.fromMap((map['immutableStorageWithVersioning'] as Map).cast<String, dynamic>()),
      isHnsEnabled: map['isHnsEnabled'] == null ? null : map['isHnsEnabled'] as bool,
      isLocalUserEnabled: map['isLocalUserEnabled'] == null ? null : map['isLocalUserEnabled'] as bool,
      isSftpEnabled: map['isSftpEnabled'] == null ? null : map['isSftpEnabled'] as bool,
      keyPolicy: map['keyPolicy'] == null ? null : KeyPolicy.fromMap((map['keyPolicy'] as Map).cast<String, dynamic>()),
      kind: map['kind'] as String,
      largeFileSharesState: map['largeFileSharesState'] == null ? null : map['largeFileSharesState'] as String,
      ...
      routingPreference: map['routingPreference'] == null ? null : RoutingPreference.fromMap((map['routingPreference'] as Map).cast<String, dynamic>()),
      sasPolicy: map['sasPolicy'] == null ? null : SasPolicy.fromMap((map['sasPolicy'] as Map).cast<String, dynamic>()),
