...
class FileShareArgs {
  ...
  factory FileShareArgs.fromMap(Map<String, dynamic> map) {
    return FileShareArgs(
      ...
      fileSharePaidBursting: map['fileSharePaidBursting'] == null ? null : FileSharePropertiesFileSharePaidBursting.fromMap((map['fileSharePaidBursting'] as Map).cast<String, dynamic>()),
      ...
      signedIdentifiers: map['signedIdentifiers'] == null ? null : pulumi.Input.decodeList<SignedIdentifier>(map['signedIdentifiers'], (value) => SignedIdentifier.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
