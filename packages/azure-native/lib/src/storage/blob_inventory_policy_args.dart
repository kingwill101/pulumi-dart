...
class BlobInventoryPolicyArgs {
  ...
  BlobInventoryPolicyArgs({
    ...
    required BlobInventoryPolicySchema policy,
  ...
  factory BlobInventoryPolicyArgs.fromMap(Map<String, dynamic> map) {
    return BlobInventoryPolicyArgs(
      ...
      blobInventoryPolicyName: map['blobInventoryPolicyName'] == null ? null : map['blobInventoryPolicyName'] as String,
      policy: BlobInventoryPolicySchema.fromMap((map['policy'] as Map).cast<String, dynamic>()),
