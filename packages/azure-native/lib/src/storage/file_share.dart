...
class FileShare extends pulumi.CustomResource {
  ...
  FileShare(
    ...
    this.accessTierChangeTime = registerOutput<String>('accessTierChangeTime');
    this.accessTierStatus = registerOutput<String>('accessTierStatus');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.deleted = registerOutput<bool>('deleted');
    this.deletedTime = registerOutput<String>('deletedTime');
    this.enabledProtocols = registerOutput<String?>('enabledProtocols');
    this.etag = registerOutput<String>('etag');
    this.fileSharePaidBursting = registerOutput<FileSharePropertiesResponseFileSharePaidBursting?>('fileSharePaidBursting');
    this.includedBurstIops = registerOutput<int>('includedBurstIops');
    ...
    this.maxBurstCreditsForIops = registerOutput<double>('maxBurstCreditsForIops');
    this.metadata = registerOutput<Map<String, String>?>('metadata');
    this.name = registerOutput<String>('name');
    this.nextAllowedProvisionedBandwidthDowngradeTime = registerOutput<String>('nextAllowedProvisionedBandwidthDowngradeTime');
    this.nextAllowedProvisionedIopsDowngradeTime = registerOutput<String>('nextAllowedProvisionedIopsDowngradeTime');
    this.nextAllowedQuotaDowngradeTime = registerOutput<String>('nextAllowedQuotaDowngradeTime');
    this.provisionedBandwidthMibps = registerOutput<int?>('provisionedBandwidthMibps');
    ...
    this.rootSquash = registerOutput<String?>('rootSquash');
    this.shareQuota = registerOutput<int?>('shareQuota');
    this.shareUsageBytes = registerOutput<double>('shareUsageBytes');
    this.signedIdentifiers = registerOutput<List<SignedIdentifierResponse>?>('signedIdentifiers');
