...
class TriggerParameters {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'endBy': ?endBy,
      'interval': ?interval,
      'intervalUnit': ?intervalUnit == null ? null : intervalUnit!.value,
      'startFrom': ?startFrom,
      'startOn': ?startOn,
    };
  }
  ...
  factory TriggerParameters.fromMap(Map<String, dynamic> map) {
    return TriggerParameters(
      endBy: map['endBy'] == null ? null : map['endBy'] as String,
      interval: map['interval'] == null ? null : map['interval'] as int,
      intervalUnit: map['intervalUnit'] == null ? null : IntervalUnit.fromValue(map['intervalUnit'] as String),
      startFrom: map['startFrom'] == null ? null : map['startFrom'] as String,
