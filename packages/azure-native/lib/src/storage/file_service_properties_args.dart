...
class FileServicePropertiesArgs {
  ...
  factory FileServicePropertiesArgs.fromMap(Map<String, dynamic> map) {
    return FileServicePropertiesArgs(
      ...
      fileServicesName: map['fileServicesName'] == null ? null : map['fileServicesName'] as String,
      protocolSettings: map['protocolSettings'] == null ? null : ProtocolSettings.fromMap((map['protocolSettings'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      shareDeleteRetentionPolicy: map['shareDeleteRetentionPolicy'] == null ? null : DeleteRetentionPolicy.fromMap((map['shareDeleteRetentionPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
