...
class ManagementPolicyArgs {
  ...
  ManagementPolicyArgs({
    ...
    required ManagementPolicySchema policy,
  ...
  factory ManagementPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ManagementPolicyArgs(
      ...
      managementPolicyName: map['managementPolicyName'] == null ? null : map['managementPolicyName'] as String,
      policy: ManagementPolicySchema.fromMap((map['policy'] as Map).cast<String, dynamic>()),
