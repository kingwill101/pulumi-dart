...
class FileSharePropertiesResponseFileSharePaidBursting {
  ...
  final bool? paidBurstingEnabled;
  ...
  final int? paidBurstingMaxBandwidthMibps;
  ...
  factory FileSharePropertiesResponseFileSharePaidBursting.fromMap(Map<String, dynamic> map) {
    return FileSharePropertiesResponseFileSharePaidBursting(
      paidBurstingEnabled: map['paidBurstingEnabled'] == null ? null : map['paidBurstingEnabled'] as bool,
      paidBurstingMaxBandwidthMibps: map['paidBurstingMaxBandwidthMibps'] == null ? null : map['paidBurstingMaxBandwidthMibps'] as int,
      paidBurstingMaxIops: map['paidBurstingMaxIops'] == null ? null : map['paidBurstingMaxIops'] as int,
    );
  }
}
