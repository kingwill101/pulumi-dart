...
class TargetArgs {
  ...
  TargetArgs({
    SqlDbElasticPoolTargetProperties? properties,
  ...
  factory TargetArgs.fromMap(Map<String, dynamic> map) {
    return TargetArgs(
      properties: map['properties'] == null ? null : SqlDbElasticPoolTargetProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
