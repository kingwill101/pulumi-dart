...
class AlertRuleResourceArgs {
  ...
  AlertRuleResourceArgs({
    required String alertRuleResourceId,
    String? alertRuleResourceName,
    required String alertRuleTemplateId,
    required String alertRuleTemplateVersion,
    required String createdWithProperties,
  ...
  factory AlertRuleResourceArgs.fromMap(Map<String, dynamic> map) {
    return AlertRuleResourceArgs(
      ...
      alertRuleResourceName: map['alertRuleResourceName'] == null ? null : map['alertRuleResourceName'] as String,
