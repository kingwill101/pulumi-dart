...
class SqlVirtualMachineArgs {
  ...
  factory SqlVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return SqlVirtualMachineArgs(
      assessmentSettings: map['assessmentSettings'] == null ? null : AssessmentSettings.fromMap((map['assessmentSettings'] as Map).cast<String, dynamic>()),
      autoBackupSettings: map['autoBackupSettings'] == null ? null : AutoBackupSettings.fromMap((map['autoBackupSettings'] as Map).cast<String, dynamic>()),
      autoPatchingSettings: map['autoPatchingSettings'] == null ? null : AutoPatchingSettings.fromMap((map['autoPatchingSettings'] as Map).cast<String, dynamic>()),
      ...
      keyVaultCredentialSettings: map['keyVaultCredentialSettings'] == null ? null : KeyVaultCredentialSettings.fromMap((map['keyVaultCredentialSettings'] as Map).cast<String, dynamic>()),
      leastPrivilegeMode: map['leastPrivilegeMode'] == null ? null : map['leastPrivilegeMode'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      serverConfigurationsManagementSettings: map['serverConfigurationsManagementSettings'] == null ? null : ServerConfigurationsManagementSettings.fromMap((map['serverConfigurationsManagementSettings'] as Map).cast<String, dynamic>()),
      ...
      sqlVirtualMachineName: map['sqlVirtualMachineName'] == null ? null : map['sqlVirtualMachineName'] as String,
      storageConfigurationSettings: map['storageConfigurationSettings'] == null ? null : StorageConfigurationSettings.fromMap((map['storageConfigurationSettings'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      virtualMachineIdentitySettings: map['virtualMachineIdentitySettings'] == null ? null : VirtualMachineIdentity.fromMap((map['virtualMachineIdentitySettings'] as Map).cast<String, dynamic>()),
      virtualMachineResourceId: map['virtualMachineResourceId'] == null ? null : map['virtualMachineResourceId'] as String,
      wsfcDomainCredentials: map['wsfcDomainCredentials'] == null ? null : WsfcDomainCredentials.fromMap((map['wsfcDomainCredentials'] as Map).cast<String, dynamic>()),
