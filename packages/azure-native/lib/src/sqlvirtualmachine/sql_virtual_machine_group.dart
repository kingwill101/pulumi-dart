...
class SqlVirtualMachineGroup extends pulumi.CustomResource {
  ...
  SqlVirtualMachineGroup(
    ...
    this.clusterConfiguration = registerOutput<String>('clusterConfiguration');
    this.clusterManagerType = registerOutput<String>('clusterManagerType');
    ...
    this.wsfcDomainProfile = registerOutput<WsfcDomainProfileResponse?>('wsfcDomainProfile');
  }
}
