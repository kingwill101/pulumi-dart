...
class AvailabilityGroupListenerArgs {
  ...
  AvailabilityGroupListenerArgs({
    ...
    required String sqlVirtualMachineGroupName,
  }) :
  ...
  factory AvailabilityGroupListenerArgs.fromMap(Map<String, dynamic> map) {
    return AvailabilityGroupListenerArgs(
      availabilityGroupConfiguration: map['availabilityGroupConfiguration'] == null ? null : AgConfiguration.fromMap((map['availabilityGroupConfiguration'] as Map).cast<String, dynamic>()),
      availabilityGroupListenerName: map['availabilityGroupListenerName'] == null ? null : map['availabilityGroupListenerName'] as String,
      ...
      multiSubnetIpConfigurations: map['multiSubnetIpConfigurations'] == null ? null : pulumi.Input.decodeList<MultiSubnetIpConfiguration>(map['multiSubnetIpConfigurations'], (value) => MultiSubnetIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      port: map['port'] == null ? null : map['port'] as int,
      resourceGroupName: map['resourceGroupName'] as String,
      sqlVirtualMachineGroupName: map['sqlVirtualMachineGroupName'] as String,
    );
  }
}
