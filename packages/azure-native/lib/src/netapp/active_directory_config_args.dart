...
class ActiveDirectoryConfigArgs {
  ...
  ActiveDirectoryConfigArgs({
    ...
    String? location,
    ActiveDirectoryConfigProperties? properties,
  ...
  factory ActiveDirectoryConfigArgs.fromMap(Map<String, dynamic> map) {
    return ActiveDirectoryConfigArgs(
      activeDirectoryConfigName: map['activeDirectoryConfigName'] == null ? null : map['activeDirectoryConfigName'] as String,
      identity: map['identity'] == null ? null : ManagedServiceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : ActiveDirectoryConfigProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
