...
class ContactProfileArgs {
  ...
  ContactProfileArgs({
    ...
    required ContactProfilesPropertiesNetworkConfiguration networkConfiguration,
  ...
  factory ContactProfileArgs.fromMap(Map<String, dynamic> map) {
    return ContactProfileArgs(
      autoTrackingConfiguration: map['autoTrackingConfiguration'] == null ? null : AutoTrackingConfiguration.fromValue(map['autoTrackingConfiguration'] as String),
      contactProfileName: map['contactProfileName'] == null ? null : map['contactProfileName'] as String,
      ...
      networkConfiguration: ContactProfilesPropertiesNetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      thirdPartyConfigurations: map['thirdPartyConfigurations'] == null ? null : pulumi.Input.decodeList<ContactProfileThirdPartyConfiguration>(map['thirdPartyConfigurations'], (value) => ContactProfileThirdPartyConfiguration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
