...
class SpacecraftArgs {
  ...
  SpacecraftArgs({
    required List<SpacecraftLink> links,
    String? location,
    String? noradId,
    ...
    required String tleLine1,
    required String tleLine2,
  }) :
  ...
  factory SpacecraftArgs.fromMap(Map<String, dynamic> map) {
    return SpacecraftArgs(
      links: pulumi.Input.decodeList<SpacecraftLink>(map['links'], (value) => SpacecraftLink.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      noradId: map['noradId'] == null ? null : map['noradId'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      spacecraftName: map['spacecraftName'] == null ? null : map['spacecraftName'] as String,
