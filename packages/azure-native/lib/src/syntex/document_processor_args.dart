...
class DocumentProcessorArgs {
  ...
  factory DocumentProcessorArgs.fromMap(Map<String, dynamic> map) {
    return DocumentProcessorArgs(
      ...
      processorName: map['processorName'] == null ? null : map['processorName'] as String,
      properties: map['properties'] == null ? null : DocumentProcessorProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
