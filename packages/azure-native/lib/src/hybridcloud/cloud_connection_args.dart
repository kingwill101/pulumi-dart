...
class CloudConnectionArgs {
  ...
  factory CloudConnectionArgs.fromMap(Map<String, dynamic> map) {
    return CloudConnectionArgs(
      cloudConnectionName: map['cloudConnectionName'] == null ? null : map['cloudConnectionName'] as String,
      cloudConnector: map['cloudConnector'] == null ? null : ResourceReference.fromMap((map['cloudConnector'] as Map).cast<String, dynamic>()),
      ...
      virtualHub: map['virtualHub'] == null ? null : ResourceReference.fromMap((map['virtualHub'] as Map).cast<String, dynamic>()),
    );
  }
}
