...
class LicenseArgs {
  ...
  LicenseArgs({
    ...
    VmwareFirewallLicenseProperties? properties,
  ...
  factory LicenseArgs.fromMap(Map<String, dynamic> map) {
    return LicenseArgs(
      licenseName: map['licenseName'] == null ? null : map['licenseName'] as String,
      privateCloudName: map['privateCloudName'] as String,
      properties: map['properties'] == null ? null : VmwareFirewallLicenseProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
