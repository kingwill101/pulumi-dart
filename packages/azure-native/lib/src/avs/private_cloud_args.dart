...
class PrivateCloudArgs {
  ...
  factory PrivateCloudArgs.fromMap(Map<String, dynamic> map) {
    return PrivateCloudArgs(
      availability: map['availability'] == null ? null : AvailabilityProperties.fromMap((map['availability'] as Map).cast<String, dynamic>()),
      ...
      identitySources: map['identitySources'] == null ? null : pulumi.Input.decodeList<IdentitySource>(map['identitySources'], (value) => IdentitySource.fromMap((value as Map).cast<String, dynamic>())),
      internet: map['internet'] == null ? null : map['internet'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      managementCluster: ManagementCluster.fromMap((map['managementCluster'] as Map).cast<String, dynamic>()),
      networkBlock: map['networkBlock'] as String,
      nsxtPassword: map['nsxtPassword'] == null ? null : map['nsxtPassword'] as String,
      privateCloudName: map['privateCloudName'] == null ? null : map['privateCloudName'] as String,
