...
class WorkloadNetworkDhcpArgs {
  ...
  WorkloadNetworkDhcpArgs({
    ...
    WorkloadNetworkDhcpRelay? properties,
  ...
  factory WorkloadNetworkDhcpArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadNetworkDhcpArgs(
      dhcpId: map['dhcpId'] == null ? null : map['dhcpId'] as String,
      privateCloudName: map['privateCloudName'] as String,
      properties: map['properties'] == null ? null : WorkloadNetworkDhcpRelay.fromMap((map['properties'] as Map).cast<String, dynamic>()),
