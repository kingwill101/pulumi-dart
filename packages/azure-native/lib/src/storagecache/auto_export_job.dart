...
class AutoExportJob extends pulumi.CustomResource {
  ...
  AutoExportJob(
    ...
    this.autoExportPrefixes = registerOutput<List<String>?>('autoExportPrefixes');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.currentIterationFilesDiscovered = registerOutput<double>('currentIterationFilesDiscovered');
    this.currentIterationFilesExported = registerOutput<double>('currentIterationFilesExported');
    this.currentIterationFilesFailed = registerOutput<double>('currentIterationFilesFailed');
    this.currentIterationMiBDiscovered = registerOutput<double>('currentIterationMiBDiscovered');
    this.currentIterationMiBExported = registerOutput<double>('currentIterationMiBExported');
    this.exportIterationCount = registerOutput<int>('exportIterationCount');
    ...
    this.lastSuccessfulIterationCompletionTimeUTC = registerOutput<String>('lastSuccessfulIterationCompletionTimeUTC');
    ...
    this.totalFilesExported = registerOutput<double>('totalFilesExported');
    this.totalFilesFailed = registerOutput<double>('totalFilesFailed');
    this.totalMiBExported = registerOutput<double>('totalMiBExported');
