...
class CacheArgs {
  ...
  factory CacheArgs.fromMap(Map<String, dynamic> map) {
    return CacheArgs(
      ...
      directoryServicesSettings: map['directoryServicesSettings'] == null ? null : CacheDirectorySettings.fromMap((map['directoryServicesSettings'] as Map).cast<String, dynamic>()),
      encryptionSettings: map['encryptionSettings'] == null ? null : CacheEncryptionSettings.fromMap((map['encryptionSettings'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : CacheIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      networkSettings: map['networkSettings'] == null ? null : CacheNetworkSettings.fromMap((map['networkSettings'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      securitySettings: map['securitySettings'] == null ? null : CacheSecuritySettings.fromMap((map['securitySettings'] as Map).cast<String, dynamic>()),
      sku: map['sku'] == null ? null : CacheSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      subnet: map['subnet'] == null ? null : map['subnet'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradeSettings: map['upgradeSettings'] == null ? null : CacheUpgradeSettings.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>()),
