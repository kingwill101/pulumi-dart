...
class ImportJobArgs {
  ...
  factory ImportJobArgs.fromMap(Map<String, dynamic> map) {
    return ImportJobArgs(
      ...
      importJobName: map['importJobName'] == null ? null : map['importJobName'] as String,
      importPrefixes: map['importPrefixes'] == null ? null : (map['importPrefixes'] as List).cast<String>(),
      location: map['location'] == null ? null : map['location'] as String,
      maximumErrors: map['maximumErrors'] == null ? null : map['maximumErrors'] as int,
