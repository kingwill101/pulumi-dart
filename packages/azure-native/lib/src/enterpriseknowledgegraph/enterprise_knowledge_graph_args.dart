...
class EnterpriseKnowledgeGraphArgs {
  ...
  EnterpriseKnowledgeGraphArgs({
    String? location,
    EnterpriseKnowledgeGraphProperties? properties,
  ...
  factory EnterpriseKnowledgeGraphArgs.fromMap(Map<String, dynamic> map) {
    return EnterpriseKnowledgeGraphArgs(
      ...
      properties: map['properties'] == null ? null : EnterpriseKnowledgeGraphProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
