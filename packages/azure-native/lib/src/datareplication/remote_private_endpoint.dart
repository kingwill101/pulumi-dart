...
class RemotePrivateEndpoint {
  ...
  final List<ConnectionDetails>? connectionDetails;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'connectionDetails': ?connectionDetails == null ? null : pulumi.Input.encodeList<ConnectionDetails, Map<String, dynamic>>(connectionDetails!, (value) => value.toMap()),
      'id': id,
  ...
  factory RemotePrivateEndpoint.fromMap(Map<String, dynamic> map) {
    return RemotePrivateEndpoint(
      connectionDetails: map['connectionDetails'] == null ? null : pulumi.Input.decodeList<ConnectionDetails>(map['connectionDetails'], (value) => ConnectionDetails.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
