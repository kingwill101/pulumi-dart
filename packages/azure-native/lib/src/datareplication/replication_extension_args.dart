...
class ReplicationExtensionArgs {
  ...
  ReplicationExtensionArgs({
    required ReplicationExtensionModelProperties properties,
  ...
  factory ReplicationExtensionArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationExtensionArgs(
      properties: ReplicationExtensionModelProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      replicationExtensionName: map['replicationExtensionName'] == null ? null : map['replicationExtensionName'] as String,
