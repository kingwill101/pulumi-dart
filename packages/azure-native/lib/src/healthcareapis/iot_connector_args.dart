...
class IotConnectorArgs {
  ...
  factory IotConnectorArgs.fromMap(Map<String, dynamic> map) {
    return IotConnectorArgs(
      deviceMapping: map['deviceMapping'] == null ? null : IotMappingProperties.fromMap((map['deviceMapping'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : ServiceManagedIdentityIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ingestionEndpointConfiguration: map['ingestionEndpointConfiguration'] == null ? null : IotEventHubIngestionEndpointConfiguration.fromMap((map['ingestionEndpointConfiguration'] as Map).cast<String, dynamic>()),
      iotConnectorName: map['iotConnectorName'] == null ? null : map['iotConnectorName'] as String,
