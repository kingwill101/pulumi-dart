...
class FhirServiceArgs {
  ...
  factory FhirServiceArgs.fromMap(Map<String, dynamic> map) {
    return FhirServiceArgs(
      acrConfiguration: map['acrConfiguration'] == null ? null : FhirServiceAcrConfiguration.fromMap((map['acrConfiguration'] as Map).cast<String, dynamic>()),
      authenticationConfiguration: map['authenticationConfiguration'] == null ? null : FhirServiceAuthenticationConfiguration.fromMap((map['authenticationConfiguration'] as Map).cast<String, dynamic>()),
      corsConfiguration: map['corsConfiguration'] == null ? null : FhirServiceCorsConfiguration.fromMap((map['corsConfiguration'] as Map).cast<String, dynamic>()),
      encryption: map['encryption'] == null ? null : Encryption.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      exportConfiguration: map['exportConfiguration'] == null ? null : FhirServiceExportConfiguration.fromMap((map['exportConfiguration'] as Map).cast<String, dynamic>()),
      fhirServiceName: map['fhirServiceName'] == null ? null : map['fhirServiceName'] as String,
      identity: map['identity'] == null ? null : ServiceManagedIdentityIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      implementationGuidesConfiguration: map['implementationGuidesConfiguration'] == null ? null : ImplementationGuidesConfiguration.fromMap((map['implementationGuidesConfiguration'] as Map).cast<String, dynamic>()),
      importConfiguration: map['importConfiguration'] == null ? null : FhirServiceImportConfiguration.fromMap((map['importConfiguration'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      resourceVersionPolicyConfiguration: map['resourceVersionPolicyConfiguration'] == null ? null : ResourceVersionPolicyConfiguration.fromMap((map['resourceVersionPolicyConfiguration'] as Map).cast<String, dynamic>()),
