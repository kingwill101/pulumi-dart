...
class PoolArgs {
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      assignments: map['assignments'] == null ? null : pulumi.Input.decodeList<Assignment>(map['assignments'], (value) => Assignment.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      poolName: map['poolName'] == null ? null : map['poolName'] as String,
      poolType: PoolType.fromMap((map['poolType'] as Map).cast<String, dynamic>()),
