...
class ManagedClusterApplicationArgs {
  ...
  factory ManagedClusterApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ManagedClusterApplicationArgs(
      ...
      managedIdentities: map['managedIdentities'] == null ? null : pulumi.Input.decodeList<ApplicationUserAssignedIdentity>(map['managedIdentities'], (value) => ApplicationUserAssignedIdentity.fromMap((value as Map).cast<String, dynamic>())),
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradePolicy: map['upgradePolicy'] == null ? null : ApplicationUpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>()),
