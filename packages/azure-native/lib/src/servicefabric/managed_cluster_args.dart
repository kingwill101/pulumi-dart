...
class ManagedClusterArgs {
  ...
  factory ManagedClusterArgs.fromMap(Map<String, dynamic> map) {
    return ManagedClusterArgs(
      ...
      applicationTypeVersionsCleanupPolicy: map['applicationTypeVersionsCleanupPolicy'] == null ? null : ApplicationTypeVersionsCleanupPolicy.fromMap((map['applicationTypeVersionsCleanupPolicy'] as Map).cast<String, dynamic>()),
      auxiliarySubnets: map['auxiliarySubnets'] == null ? null : pulumi.Input.decodeList<Subnet>(map['auxiliarySubnets'], (value) => Subnet.fromMap((value as Map).cast<String, dynamic>())),
      ...
      clients: map['clients'] == null ? null : pulumi.Input.decodeList<ClientCertificate>(map['clients'], (value) => ClientCertificate.fromMap((value as Map).cast<String, dynamic>())),
      ...
      fabricSettings: map['fabricSettings'] == null ? null : pulumi.Input.decodeList<SettingsSectionDescription>(map['fabricSettings'], (value) => SettingsSectionDescription.fromMap((value as Map).cast<String, dynamic>())),
      ...
      loadBalancingRules: map['loadBalancingRules'] == null ? null : pulumi.Input.decodeList<LoadBalancingRule>(map['loadBalancingRules'], (value) => LoadBalancingRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      serviceEndpoints: map['serviceEndpoints'] == null ? null : pulumi.Input.decodeList<ServiceEndpoint>(map['serviceEndpoints'], (value) => ServiceEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      sku: Sku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      subnetId: map['subnetId'] == null ? null : map['subnetId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradeDescription: map['upgradeDescription'] == null ? null : ClusterUpgradePolicy.fromMap((map['upgradeDescription'] as Map).cast<String, dynamic>()),
