...
import 'application_health_policy_response.dart';
import 'rolling_upgrade_monitoring_policy_response.dart';

/// Describes the policy for a monitored application upgrade.
class ApplicationUpgradePolicyResponse {
  /// Defines a health policy used to evaluate the health of an application or one of its children entities.
  final ApplicationHealthPolicyResponse? applicationHealthPolicy;
  ...
  final RollingUpgradeMonitoringPolicyResponse? rollingUpgradeMonitoringPolicy;
  ...
  /// Creates a new [ApplicationUpgradePolicyResponse].
  ...
  factory ApplicationUpgradePolicyResponse.fromMap(Map<String, dynamic> map) {
    return ApplicationUpgradePolicyResponse(
      applicationHealthPolicy: map['applicationHealthPolicy'] == null ? null : ApplicationHealthPolicyResponse.fromMap((map['applicationHealthPolicy'] as Map).cast<String, dynamic>()),
      ...
      rollingUpgradeMonitoringPolicy: map['rollingUpgradeMonitoringPolicy'] == null ? null : RollingUpgradeMonitoringPolicyResponse.fromMap((map['rollingUpgradeMonitoringPolicy'] as Map).cast<String, dynamic>()),
