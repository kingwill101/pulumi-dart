...
class NodeTypeArgs {
  ...
  factory NodeTypeArgs.fromMap(Map<String, dynamic> map) {
    return NodeTypeArgs(
      additionalDataDisks: map['additionalDataDisks'] == null ? null : pulumi.Input.decodeList<VmssDataDisk>(map['additionalDataDisks'], (value) => VmssDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      additionalNetworkInterfaceConfigurations: map['additionalNetworkInterfaceConfigurations'] == null ? null : pulumi.Input.decodeList<AdditionalNetworkInterfaceConfiguration>(map['additionalNetworkInterfaceConfigurations'], (value) => AdditionalNetworkInterfaceConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      applicationPorts: map['applicationPorts'] == null ? null : EndpointRangeDescription.fromMap((map['applicationPorts'] as Map).cast<String, dynamic>()),
      ...
      ephemeralPorts: map['ephemeralPorts'] == null ? null : EndpointRangeDescription.fromMap((map['ephemeralPorts'] as Map).cast<String, dynamic>()),
      evictionPolicy: map['evictionPolicy'] == null ? null : map['evictionPolicy'] as String,
      frontendConfigurations: map['frontendConfigurations'] == null ? null : pulumi.Input.decodeList<FrontendConfiguration>(map['frontendConfigurations'], (value) => FrontendConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      natConfigurations: map['natConfigurations'] == null ? null : pulumi.Input.decodeList<NodeTypeNatConfig>(map['natConfigurations'], (value) => NodeTypeNatConfig.fromMap((value as Map).cast<String, dynamic>())),
      natGatewayId: map['natGatewayId'] == null ? null : map['natGatewayId'] as String,
      networkSecurityRules: map['networkSecurityRules'] == null ? null : pulumi.Input.decodeList<NetworkSecurityRule>(map['networkSecurityRules'], (value) => NetworkSecurityRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sku: map['sku'] == null ? null : NodeTypeSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      ...
      vmExtensions: map['vmExtensions'] == null ? null : pulumi.Input.decodeList<VMSSExtension>(map['vmExtensions'], (value) => VMSSExtension.fromMap((value as Map).cast<String, dynamic>())),
      vmImageOffer: map['vmImageOffer'] == null ? null : map['vmImageOffer'] as String,
      vmImagePlan: map['vmImagePlan'] == null ? null : VmImagePlan.fromMap((map['vmImagePlan'] as Map).cast<String, dynamic>()),
      ...
      vmManagedIdentity: map['vmManagedIdentity'] == null ? null : VmManagedIdentity.fromMap((map['vmManagedIdentity'] as Map).cast<String, dynamic>()),
      vmSecrets: map['vmSecrets'] == null ? null : pulumi.Input.decodeList<VaultSecretGroup>(map['vmSecrets'], (value) => VaultSecretGroup.fromMap((value as Map).cast<String, dynamic>())),
