...
class ClusterUpgradePolicy {
  ...
  final ClusterUpgradeDeltaHealthPolicy? deltaHealthPolicy;
  ...
  factory ClusterUpgradePolicy.fromMap(Map<String, dynamic> map) {
    return ClusterUpgradePolicy(
      deltaHealthPolicy: map['deltaHealthPolicy'] == null ? null : ClusterUpgradeDeltaHealthPolicy.fromMap((map['deltaHealthPolicy'] as Map).cast<String, dynamic>()),
      forceRestart: map['forceRestart'] == null ? null : map['forceRestart'] as bool,
      healthPolicy: map['healthPolicy'] == null ? null : ClusterHealthPolicy.fromMap((map['healthPolicy'] as Map).cast<String, dynamic>()),
      monitoringPolicy: map['monitoringPolicy'] == null ? null : ClusterMonitoringPolicy.fromMap((map['monitoringPolicy'] as Map).cast<String, dynamic>()),
