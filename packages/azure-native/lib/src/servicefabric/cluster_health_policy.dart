...
class ClusterHealthPolicy {
  ...
  final int maxPercentUnhealthyApplications;
  ...
  final int maxPercentUnhealthyNodes;

  /// Creates a new [ClusterHealthPolicy].
  ...
  factory ClusterHealthPolicy.fromMap(Map<String, dynamic> map) {
    return ClusterHealthPolicy(
      maxPercentUnhealthyApplications: map['maxPercentUnhealthyApplications'] as int,
      maxPercentUnhealthyNodes: map['maxPercentUnhealthyNodes'] as int,
    );
  }
}
