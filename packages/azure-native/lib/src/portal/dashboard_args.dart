...
class DashboardArgs {
  ...
  factory DashboardArgs.fromMap(Map<String, dynamic> map) {
    return DashboardArgs(
      dashboardName: map['dashboardName'] == null ? null : map['dashboardName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : DashboardPropertiesWithProvisioningState.fromMap((map['properties'] as Map).cast<String, dynamic>()),
