...
class UserSettingsArgs {
  ...
  UserSettingsArgs({
    required UserProperties properties,
  ...
  factory UserSettingsArgs.fromMap(Map<String, dynamic> map) {
    return UserSettingsArgs(
      properties: UserProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      userSettingsName: map['userSettingsName'] == null ? null : map['userSettingsName'] as String,
    );
  }
}
