...
class PipelineRunArgs {
  ...
  factory PipelineRunArgs.fromMap(Map<String, dynamic> map) {
    return PipelineRunArgs(
      ...
      pipelineRunName: map['pipelineRunName'] == null ? null : map['pipelineRunName'] as String,
      registryName: map['registryName'] as String,
      request: map['request'] == null ? null : PipelineRunRequest.fromMap((map['request'] as Map).cast<String, dynamic>()),
