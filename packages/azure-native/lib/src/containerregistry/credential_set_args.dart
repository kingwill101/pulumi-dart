...
class CredentialSetArgs {
  ...
  factory CredentialSetArgs.fromMap(Map<String, dynamic> map) {
    return CredentialSetArgs(
      authCredentials: map['authCredentials'] == null ? null : pulumi.Input.decodeList<AuthCredential>(map['authCredentials'], (value) => AuthCredential.fromMap((value as Map).cast<String, dynamic>())),
      credentialSetName: map['credentialSetName'] == null ? null : map['credentialSetName'] as String,
