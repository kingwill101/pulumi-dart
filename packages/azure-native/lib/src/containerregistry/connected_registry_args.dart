...
class ConnectedRegistryArgs {
  ...
  ConnectedRegistryArgs({
    ...
    required ParentProperties parent,
  ...
  factory ConnectedRegistryArgs.fromMap(Map<String, dynamic> map) {
    return ConnectedRegistryArgs(
      ...
      connectedRegistryName: map['connectedRegistryName'] == null ? null : map['connectedRegistryName'] as String,
      garbageCollection: map['garbageCollection'] == null ? null : GarbageCollectionProperties.fromMap((map['garbageCollection'] as Map).cast<String, dynamic>()),
      logging: map['logging'] == null ? null : LoggingProperties.fromMap((map['logging'] as Map).cast<String, dynamic>()),
      mode: map['mode'] as String,
      notificationsList: map['notificationsList'] == null ? null : (map['notificationsList'] as List).cast<String>(),
      parent: ParentProperties.fromMap((map['parent'] as Map).cast<String, dynamic>()),
