...
class ImportPipelineArgs {
  ...
  ImportPipelineArgs({
    ...
    required ImportPipelineSourceProperties source,
  ...
  factory ImportPipelineArgs.fromMap(Map<String, dynamic> map) {
    return ImportPipelineArgs(
      ...
      importPipelineName: map['importPipelineName'] == null ? null : map['importPipelineName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      options: map['options'] == null ? null : (map['options'] as List).cast<String>(),
      registryName: map['registryName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      source: ImportPipelineSourceProperties.fromMap((map['source'] as Map).cast<String, dynamic>()),
      trigger: map['trigger'] == null ? null : PipelineTriggerProperties.fromMap((map['trigger'] as Map).cast<String, dynamic>()),
    );
  }
}
