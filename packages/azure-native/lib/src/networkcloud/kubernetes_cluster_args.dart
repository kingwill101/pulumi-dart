...
class KubernetesClusterArgs {
  ...
  KubernetesClusterArgs({
    ...
    required ControlPlaneNodeConfiguration controlPlaneNodeConfiguration,
    required ExtendedLocation extendedLocation,
    required List<InitialAgentPoolConfiguration> initialAgentPoolConfigurations,
  ...
  factory KubernetesClusterArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterArgs(
      aadConfiguration: map['aadConfiguration'] == null ? null : AadConfiguration.fromMap((map['aadConfiguration'] as Map).cast<String, dynamic>()),
      ...
      controlPlaneNodeConfiguration: ControlPlaneNodeConfiguration.fromMap((map['controlPlaneNodeConfiguration'] as Map).cast<String, dynamic>()),
      extendedLocation: ExtendedLocation.fromMap((map['extendedLocation'] as Map).cast<String, dynamic>()),
      initialAgentPoolConfigurations: pulumi.Input.decodeList<InitialAgentPoolConfiguration>(map['initialAgentPoolConfigurations'], (value) => InitialAgentPoolConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      kubernetesClusterName: map['kubernetesClusterName'] == null ? null : map['kubernetesClusterName'] as String,
      ...
      networkConfiguration: NetworkConfiguration.fromMap((map['networkConfiguration'] as Map).cast<String, dynamic>()),
