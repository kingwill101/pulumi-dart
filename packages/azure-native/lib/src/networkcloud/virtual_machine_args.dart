...
class VirtualMachineArgs {
  ...
  VirtualMachineArgs({
    ...
    String? bootMethod,
    required NetworkAttachment cloudServicesNetworkAttachment,
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      cloudServicesNetworkAttachment: NetworkAttachment.fromMap((map['cloudServicesNetworkAttachment'] as Map).cast<String, dynamic>()),
      consoleExtendedLocation: map['consoleExtendedLocation'] == null ? null : ExtendedLocation.fromMap((map['consoleExtendedLocation'] as Map).cast<String, dynamic>()),
      ...
      networkAttachments: map['networkAttachments'] == null ? null : pulumi.Input.decodeList<NetworkAttachment>(map['networkAttachments'], (value) => NetworkAttachment.fromMap((value as Map).cast<String, dynamic>())),
      networkData: map['networkData'] == null ? null : map['networkData'] as String,
      placementHints: map['placementHints'] == null ? null : pulumi.Input.decodeList<VirtualMachinePlacementHint>(map['placementHints'], (value) => VirtualMachinePlacementHint.fromMap((value as Map).cast<String, dynamic>())),
      ...
      vmImageRepositoryCredentials: map['vmImageRepositoryCredentials'] == null ? null : ImageRepositoryCredentials.fromMap((map['vmImageRepositoryCredentials'] as Map).cast<String, dynamic>()),
    );
  }
}
