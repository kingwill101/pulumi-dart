...
class ActionGroupArgs {
  ...
  factory ActionGroupArgs.fromMap(Map<String, dynamic> map) {
    return ActionGroupArgs(
      actionGroupName: map['actionGroupName'] == null ? null : map['actionGroupName'] as String,
      armRoleReceivers: map['armRoleReceivers'] == null ? null : pulumi.Input.decodeList<ArmRoleReceiver>(map['armRoleReceivers'], (value) => ArmRoleReceiver.fromMap((value as Map).cast<String, dynamic>())),
      automationRunbookReceivers: map['automationRunbookReceivers'] == null ? null : pulumi.Input.decodeList<AutomationRunbookReceiver>(map['automationRunbookReceivers'], (value) => AutomationRunbookReceiver.fromMap((value as Map).cast<String, dynamic>())),
      ...
      azureFunctionReceivers: map['azureFunctionReceivers'] == null ? null : pulumi.Input.decodeList<AzureFunctionReceiver>(map['azureFunctionReceivers'], (value) => AzureFunctionReceiver.fromMap((value as Map).cast<String, dynamic>())),
      ...
      eventHubReceivers: map['eventHubReceivers'] == null ? null : pulumi.Input.decodeList<EventHubReceiver>(map['eventHubReceivers'], (value) => EventHubReceiver.fromMap((value as Map).cast<String, dynamic>())),
      ...
      incidentReceivers: map['incidentReceivers'] == null ? null : pulumi.Input.decodeList<IncidentReceiver>(map['incidentReceivers'], (value) => IncidentReceiver.fromMap((value as Map).cast<String, dynamic>())),
      itsmReceivers: map['itsmReceivers'] == null ? null : pulumi.Input.decodeList<ItsmReceiver>(map['itsmReceivers'], (value) => ItsmReceiver.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      logicAppReceivers: map['logicAppReceivers'] == null ? null : pulumi.Input.decodeList<LogicAppReceiver>(map['logicAppReceivers'], (value) => LogicAppReceiver.fromMap((value as Map).cast<String, dynamic>())),
