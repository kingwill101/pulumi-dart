...
class ScheduledQueryRule extends pulumi.CustomResource {
  ...
  ScheduledQueryRule(
    ...
    this.actions = registerOutput<ActionsResponse?>('actions');
    this.autoMitigate = registerOutput<bool?>('autoMitigate');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.checkWorkspaceAlertsStorageConfigured = registerOutput<bool?>('checkWorkspaceAlertsStorageConfigured');
    this.createdWithApiVersion = registerOutput<String>('createdWithApiVersion');
    this.criteria = registerOutput<ScheduledQueryRuleCriteriaResponse>('criteria');
    ...
    this.isLegacyLogAnalyticsRule = registerOutput<bool>('isLegacyLogAnalyticsRule');
    this.isWorkspaceAlertsStorageConfigured = registerOutput<bool>('isWorkspaceAlertsStorageConfigured');
    this.kind = registerOutput<String?>('kind');
    this.location = registerOutput<String>('location');
    this.muteActionsDuration = registerOutput<String?>('muteActionsDuration');
    this.name = registerOutput<String>('name');
    this.overrideQueryTimeRange = registerOutput<String?>('overrideQueryTimeRange');
    this.resolveConfiguration = registerOutput<RuleResolveConfigurationResponse?>('resolveConfiguration');
    this.scopes = registerOutput<List<String>>('scopes');
    this.severity = registerOutput<double?>('severity');
