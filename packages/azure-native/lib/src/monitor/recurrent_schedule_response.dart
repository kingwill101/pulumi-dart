...
class RecurrentScheduleResponse {
  ...
  /// Creates a new [RecurrentScheduleResponse].
  ...
  factory RecurrentScheduleResponse.fromMap(Map<String, dynamic> map) {
    return RecurrentScheduleResponse(
