...
class DiscoveryRuleArgs {
  ...
  DiscoveryRuleArgs({
    ...
    ApplicationInsightsTopologyDiscoveryRuleProperties? properties,
  ...
  factory DiscoveryRuleArgs.fromMap(Map<String, dynamic> map) {
    return DiscoveryRuleArgs(
      ...
      properties: map['properties'] == null ? null : ApplicationInsightsTopologyDiscoveryRuleProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
