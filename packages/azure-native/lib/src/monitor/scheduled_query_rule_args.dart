...
class ScheduledQueryRuleArgs {
  ...
  ScheduledQueryRuleArgs({
    ...
    required ScheduledQueryRuleCriteria criteria,
    String? description,
    String? displayName,
  ...
  factory ScheduledQueryRuleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRuleArgs(
      actions: map['actions'] == null ? null : Actions.fromMap((map['actions'] as Map).cast<String, dynamic>()),
      ...
      criteria: ScheduledQueryRuleCriteria.fromMap((map['criteria'] as Map).cast<String, dynamic>()),
      ...
      resolveConfiguration: map['resolveConfiguration'] == null ? null : RuleResolveConfiguration.fromMap((map['resolveConfiguration'] as Map).cast<String, dynamic>()),
