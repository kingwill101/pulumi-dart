...
class ScaleRuleResponse {
  ...
  final MetricTriggerResponse metricTrigger;
  /// the parameters for the scaling action.
  final ScaleActionResponse scaleAction;
  ...
  factory ScaleRuleResponse.fromMap(Map<String, dynamic> map) {
    return ScaleRuleResponse(
      metricTrigger: MetricTriggerResponse.fromMap((map['metricTrigger'] as Map).cast<String, dynamic>()),
      scaleAction: ScaleActionResponse.fromMap((map['scaleAction'] as Map).cast<String, dynamic>()),
    );
  }
}
