...
class GetDataCollectionRuleResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'dataFlows': ?dataFlows == null ? null : pulumi.Input.encodeList<DataFlowResponse, Map<String, dynamic>>(dataFlows!, (value) => value.toMap()),
      ...
      'streamDeclarations': ?streamDeclarations == null ? null : pulumi.Input.encodeMapValues<StreamDeclarationResponse, Map<String, dynamic>>(streamDeclarations!, (value) => value.toMap()),
  ...
  factory GetDataCollectionRuleResult.fromMap(Map<String, dynamic> map) {
    return GetDataCollectionRuleResult(
      ...
      dataFlows: map['dataFlows'] == null ? null : pulumi.Input.decodeList<DataFlowResponse>(map['dataFlows'], (value) => DataFlowResponse.fromMap((value as Map).cast<String, dynamic>())),
      dataSources: map['dataSources'] == null ? null : DataCollectionRuleResponseDataSources.fromMap((map['dataSources'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      destinations: map['destinations'] == null ? null : DataCollectionRuleResponseDestinations.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
      etag: map['etag'] as String,
      id: map['id'] as String,
      identity: map['identity'] == null ? null : DataCollectionRuleResourceResponseIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      streamDeclarations: map['streamDeclarations'] == null ? null : pulumi.Input.decodeMapValues<StreamDeclarationResponse>(map['streamDeclarations'], (value) => StreamDeclarationResponse.fromMap((value as Map).cast<String, dynamic>())),
