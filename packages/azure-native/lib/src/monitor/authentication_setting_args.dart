...
class AuthenticationSettingArgs {
  ...
  AuthenticationSettingArgs({
    ...
    ManagedIdentityAuthenticationSettingProperties? properties,
  ...
  factory AuthenticationSettingArgs.fromMap(Map<String, dynamic> map) {
    return AuthenticationSettingArgs(
      authenticationSettingName: map['authenticationSettingName'] == null ? null : map['authenticationSettingName'] as String,
      azureMonitorWorkspaceName: map['azureMonitorWorkspaceName'] as String,
      healthModelName: map['healthModelName'] as String,
      properties: map['properties'] == null ? null : ManagedIdentityAuthenticationSettingProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
