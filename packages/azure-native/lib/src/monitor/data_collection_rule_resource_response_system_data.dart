...
class DataCollectionRuleResourceResponseSystemData {
  ...
  /// Creates a new [DataCollectionRuleResourceResponseSystemData].
  ...
  factory DataCollectionRuleResourceResponseSystemData.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleResourceResponseSystemData(
