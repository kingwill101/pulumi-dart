...
class MetricAlertArgs {
  ...
  MetricAlertArgs({
    ...
    bool? autoMitigate,
    required MetricAlertMultipleResourceMultipleMetricCriteria criteria,
    String? description,
  ...
  factory MetricAlertArgs.fromMap(Map<String, dynamic> map) {
    return MetricAlertArgs(
      ...
      criteria: MetricAlertMultipleResourceMultipleMetricCriteria.fromMap((map['criteria'] as Map).cast<String, dynamic>()),
