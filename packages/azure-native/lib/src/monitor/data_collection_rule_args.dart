...
class DataCollectionRuleArgs {
  ...
  factory DataCollectionRuleArgs.fromMap(Map<String, dynamic> map) {
    return DataCollectionRuleArgs(
      ...
      dataCollectionRuleName: map['dataCollectionRuleName'] == null ? null : map['dataCollectionRuleName'] as String,
      dataFlows: map['dataFlows'] == null ? null : pulumi.Input.decodeList<DataFlow>(map['dataFlows'], (value) => DataFlow.fromMap((value as Map).cast<String, dynamic>())),
      ...
      destinations: map['destinations'] == null ? null : DataCollectionRuleDestinations.fromMap((map['destinations'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : DataCollectionRuleResourceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      streamDeclarations: map['streamDeclarations'] == null ? null : pulumi.Input.decodeMapValues<StreamDeclaration>(map['streamDeclarations'], (value) => StreamDeclaration.fromMap((value as Map).cast<String, dynamic>())),
