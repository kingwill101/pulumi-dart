...
class ConditionResponseFailingPeriods {
  ...
  factory ConditionResponseFailingPeriods.fromMap(Map<String, dynamic> map) {
    return ConditionResponseFailingPeriods(
      minFailingPeriodsToAlert: map['minFailingPeriodsToAlert'] == null ? null : map['minFailingPeriodsToAlert'] as double,
      numberOfEvaluationPeriods: map['numberOfEvaluationPeriods'] == null ? null : map['numberOfEvaluationPeriods'] as double,
    );
  }
}
