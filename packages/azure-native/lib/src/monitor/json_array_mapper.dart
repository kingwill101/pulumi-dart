...
class JsonArrayMapper {
  ...
  final JsonMapperDestinationField? destinationField;
  ...
  final JsonMapperSourceField? sourceField;
  ...
  factory JsonArrayMapper.fromMap(Map<String, dynamic> map) {
    return JsonArrayMapper(
      destinationField: map['destinationField'] == null ? null : JsonMapperDestinationField.fromMap((map['destinationField'] as Map).cast<String, dynamic>()),
      keys: (map['keys'] as List).cast<String>(),
      sourceField: map['sourceField'] == null ? null : JsonMapperSourceField.fromMap((map['sourceField'] as Map).cast<String, dynamic>()),
    );
  }
}
