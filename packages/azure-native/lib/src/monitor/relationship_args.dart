...
class RelationshipArgs {
  ...
  factory RelationshipArgs.fromMap(Map<String, dynamic> map) {
    return RelationshipArgs(
      ...
      properties: map['properties'] == null ? null : RelationshipProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      relationshipName: map['relationshipName'] == null ? null : map['relationshipName'] as String,
