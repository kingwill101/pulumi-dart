...
class ServerArgs {
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      ...
      backup: map['backup'] == null ? null : map['backup'] as BackupDbforpostgresql,
      cluster: map['cluster'] == null ? null : Cluster.fromMap((map['cluster'] as Map).cast<String, dynamic>()),
      ...
      identity: map['identity'] == null ? null : UserAssignedIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      replica: map['replica'] == null ? null : Replica.fromMap((map['replica'] as Map).cast<String, dynamic>()),
