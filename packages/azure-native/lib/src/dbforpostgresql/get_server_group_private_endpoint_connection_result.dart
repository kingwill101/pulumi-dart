...
/// Result data returned by getServerGroupPrivateEndpointConnection.
class GetServerGroupPrivateEndpointConnectionResult {
  ...
  /// Creates a new [GetServerGroupPrivateEndpointConnectionResult].
  ...
  factory GetServerGroupPrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
