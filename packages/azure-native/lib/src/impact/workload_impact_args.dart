...
class WorkloadImpactArgs {
  ...
  WorkloadImpactArgs({
    WorkloadImpactProperties? properties,
    String? workloadImpactName,
  }) :
  ...
  factory WorkloadImpactArgs.fromMap(Map<String, dynamic> map) {
    return WorkloadImpactArgs(
      properties: map['properties'] == null ? null : WorkloadImpactProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      workloadImpactName: map['workloadImpactName'] == null ? null : map['workloadImpactName'] as String,
    );
  }
}
