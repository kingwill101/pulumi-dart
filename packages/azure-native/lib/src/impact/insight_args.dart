...
class InsightArgs {
  ...
  InsightArgs({
    ...
    required String workloadImpactName,
  }) :
  ...
  factory InsightArgs.fromMap(Map<String, dynamic> map) {
    return InsightArgs(
      insightName: map['insightName'] == null ? null : map['insightName'] as String,
      properties: map['properties'] == null ? null : InsightProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      workloadImpactName: map['workloadImpactName'] as String,
    );
  }
}
