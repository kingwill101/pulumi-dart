...
class ResourceSharingProfileResponse {
  ...
  final List<SubResourceResponse>? subscriptionIds;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'subscriptionIds': ?subscriptionIds == null ? null : pulumi.Input.encodeList<SubResourceResponse, Map<String, dynamic>>(subscriptionIds!, (value) => value.toMap()),
    };
  }

  factory ResourceSharingProfileResponse.fromMap(Map<String, dynamic> map) {
    return ResourceSharingProfileResponse(
      subscriptionIds: map['subscriptionIds'] == null ? null : pulumi.Input.decodeList<SubResourceResponse>(map['subscriptionIds'], (value) => SubResourceResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
