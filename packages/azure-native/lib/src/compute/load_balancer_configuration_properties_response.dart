...
class LoadBalancerConfigurationPropertiesResponse {
  ...
  final List<LoadBalancerFrontendIpConfigurationResponse> frontendIpConfigurations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'frontendIpConfigurations': pulumi.Input.encodeList<LoadBalancerFrontendIpConfigurationResponse, Map<String, dynamic>>(frontendIpConfigurations, (value) => value.toMap()),
    };
  }
  ...
  factory LoadBalancerConfigurationPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return LoadBalancerConfigurationPropertiesResponse(
      frontendIpConfigurations: pulumi.Input.decodeList<LoadBalancerFrontendIpConfigurationResponse>(map['frontendIpConfigurations'], (value) => LoadBalancerFrontendIpConfigurationResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
