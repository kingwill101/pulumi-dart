...
class VirtualMachineScaleSetArgs {
  ...
  factory VirtualMachineScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineScaleSetArgs(
      ...
      automaticRepairsPolicy: map['automaticRepairsPolicy'] == null ? null : AutomaticRepairsPolicy.fromMap((map['automaticRepairsPolicy'] as Map).cast<String, dynamic>()),
      ...
      hostGroup: map['hostGroup'] == null ? null : SubResource.fromMap((map['hostGroup'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : VirtualMachineScaleSetIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      priorityMixPolicy: map['priorityMixPolicy'] == null ? null : PriorityMixPolicy.fromMap((map['priorityMixPolicy'] as Map).cast<String, dynamic>()),
      ...
      resiliencyPolicy: map['resiliencyPolicy'] == null ? null : ResiliencyPolicy.fromMap((map['resiliencyPolicy'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      scaleInPolicy: map['scaleInPolicy'] == null ? null : ScaleInPolicy.fromMap((map['scaleInPolicy'] as Map).cast<String, dynamic>()),
      ...
      skuProfile: map['skuProfile'] == null ? null : SkuProfile.fromMap((map['skuProfile'] as Map).cast<String, dynamic>()),
      spotRestorePolicy: map['spotRestorePolicy'] == null ? null : SpotRestorePolicy.fromMap((map['spotRestorePolicy'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradePolicy: map['upgradePolicy'] == null ? null : UpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>()),
      virtualMachineProfile: map['virtualMachineProfile'] == null ? null : VirtualMachineScaleSetVMProfile.fromMap((map['virtualMachineProfile'] as Map).cast<String, dynamic>()),
      vmScaleSetName: map['vmScaleSetName'] == null ? null : map['vmScaleSetName'] as String,
