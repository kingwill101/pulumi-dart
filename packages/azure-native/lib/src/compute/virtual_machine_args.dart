...
class VirtualMachineArgs {
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      host: map['host'] == null ? null : SubResource.fromMap((map['host'] as Map).cast<String, dynamic>()),
      ...
      virtualMachineScaleSet: map['virtualMachineScaleSet'] == null ? null : SubResource.fromMap((map['virtualMachineScaleSet'] as Map).cast<String, dynamic>()),
