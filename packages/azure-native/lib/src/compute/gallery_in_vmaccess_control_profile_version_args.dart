...
class GalleryInVMAccessControlProfileVersionArgs {
  ...
  factory GalleryInVMAccessControlProfileVersionArgs.fromMap(Map<String, dynamic> map) {
    return GalleryInVMAccessControlProfileVersionArgs(
      ...
      inVMAccessControlProfileVersionName: map['inVMAccessControlProfileVersionName'] == null ? null : map['inVMAccessControlProfileVersionName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      mode: map['mode'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      rules: map['rules'] == null ? null : AccessControlRules.fromMap((map['rules'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetLocations: map['targetLocations'] == null ? null : pulumi.Input.decodeList<TargetRegion>(map['targetLocations'], (value) => TargetRegion.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
