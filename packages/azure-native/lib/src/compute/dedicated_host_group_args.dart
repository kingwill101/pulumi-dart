...
class DedicatedHostGroupArgs {
  ...
  factory DedicatedHostGroupArgs.fromMap(Map<String, dynamic> map) {
    return DedicatedHostGroupArgs(
      additionalCapabilities: map['additionalCapabilities'] == null ? null : DedicatedHostGroupPropertiesAdditionalCapabilities.fromMap((map['additionalCapabilities'] as Map).cast<String, dynamic>()),
