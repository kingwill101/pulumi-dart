...
class CreationDataResponse {
  ...
  final ImageDiskReferenceResponse? galleryImageReference;
  /// Disk source information for PIR or user images.
  final ImageDiskReferenceResponse? imageReference;
  ...
  factory CreationDataResponse.fromMap(Map<String, dynamic> map) {
    return CreationDataResponse(
      ...
      galleryImageReference: map['galleryImageReference'] == null ? null : ImageDiskReferenceResponse.fromMap((map['galleryImageReference'] as Map).cast<String, dynamic>()),
      imageReference: map['imageReference'] == null ? null : ImageDiskReferenceResponse.fromMap((map['imageReference'] as Map).cast<String, dynamic>()),
      ...
      sourceUniqueId: map['sourceUniqueId'] as String,
