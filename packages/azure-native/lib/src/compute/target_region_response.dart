...
class TargetRegionResponse {
  ...
  final List<AdditionalReplicaSetResponse>? additionalReplicaSets;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'additionalReplicaSets': ?additionalReplicaSets == null ? null : pulumi.Input.encodeList<AdditionalReplicaSetResponse, Map<String, dynamic>>(additionalReplicaSets!, (value) => value.toMap()),
  ...
  factory TargetRegionResponse.fromMap(Map<String, dynamic> map) {
    return TargetRegionResponse(
      additionalReplicaSets: map['additionalReplicaSets'] == null ? null : pulumi.Input.decodeList<AdditionalReplicaSetResponse>(map['additionalReplicaSets'], (value) => AdditionalReplicaSetResponse.fromMap((value as Map).cast<String, dynamic>())),
