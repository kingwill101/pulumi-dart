...
class GalleryArgs {
  ...
  factory GalleryArgs.fromMap(Map<String, dynamic> map) {
    return GalleryArgs(
      ...
      identity: map['identity'] == null ? null : GalleryIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sharingProfile: map['sharingProfile'] == null ? null : SharingProfile.fromMap((map['sharingProfile'] as Map).cast<String, dynamic>()),
