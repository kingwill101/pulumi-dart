...
class RestorePointArgs {
  ...
  factory RestorePointArgs.fromMap(Map<String, dynamic> map) {
    return RestorePointArgs(
      ...
      excludeDisks: map['excludeDisks'] == null ? null : pulumi.Input.decodeList<ApiEntityReference>(map['excludeDisks'], (value) => ApiEntityReference.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      restorePointCollectionName: map['restorePointCollectionName'] as String,
      restorePointName: map['restorePointName'] == null ? null : map['restorePointName'] as String,
      sourceMetadata: map['sourceMetadata'] == null ? null : RestorePointSourceMetadata.fromMap((map['sourceMetadata'] as Map).cast<String, dynamic>()),
      sourceRestorePoint: map['sourceRestorePoint'] == null ? null : ApiEntityReference.fromMap((map['sourceRestorePoint'] as Map).cast<String, dynamic>()),
