...
class GalleryImageArgs {
  ...
  GalleryImageArgs({
    ...
    required GalleryImageIdentifier identifier,
    String? location,
    required OperatingSystemStateTypes osState,
    required OperatingSystemTypes osType,
  ...
  factory GalleryImageArgs.fromMap(Map<String, dynamic> map) {
    return GalleryImageArgs(
      ...
      disallowed: map['disallowed'] == null ? null : Disallowed.fromMap((map['disallowed'] as Map).cast<String, dynamic>()),
      endOfLifeDate: map['endOfLifeDate'] == null ? null : map['endOfLifeDate'] as String,
      eula: map['eula'] == null ? null : map['eula'] as String,
      features: map['features'] == null ? null : pulumi.Input.decodeList<GalleryImageFeature>(map['features'], (value) => GalleryImageFeature.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identifier: GalleryImageIdentifier.fromMap((map['identifier'] as Map).cast<String, dynamic>()),
      ...
      purchasePlan: map['purchasePlan'] == null ? null : ImagePurchasePlan.fromMap((map['purchasePlan'] as Map).cast<String, dynamic>()),
      recommended: map['recommended'] == null ? null : RecommendedMachineConfiguration.fromMap((map['recommended'] as Map).cast<String, dynamic>()),
