...
class ScaleInPolicyResponse {
  ...
  final bool? prioritizeUnhealthyVMs;
  ...
  /// Creates a new [ScaleInPolicyResponse].
  ...
  factory ScaleInPolicyResponse.fromMap(Map<String, dynamic> map) {
    return ScaleInPolicyResponse(
      forceDeletion: map['forceDeletion'] == null ? null : map['forceDeletion'] as bool,
      prioritizeUnhealthyVMs: map['prioritizeUnhealthyVMs'] == null ? null : map['prioritizeUnhealthyVMs'] as bool,
