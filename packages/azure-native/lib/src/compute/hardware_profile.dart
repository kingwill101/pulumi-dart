...
class HardwareProfile {
  ...
  final VMSizeProperties? vmSizeProperties;
  ...
  factory HardwareProfile.fromMap(Map<String, dynamic> map) {
    return HardwareProfile(
      ...
      vmSizeProperties: map['vmSizeProperties'] == null ? null : VMSizeProperties.fromMap((map['vmSizeProperties'] as Map).cast<String, dynamic>()),
    );
  }
}
