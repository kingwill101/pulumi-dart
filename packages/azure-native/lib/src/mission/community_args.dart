...
class CommunityArgs {
  ...
  factory CommunityArgs.fromMap(Map<String, dynamic> map) {
    return CommunityArgs(
      ...
      approvalSettings: map['approvalSettings'] == null ? null : ApprovalSettings.fromMap((map['approvalSettings'] as Map).cast<String, dynamic>()),
      communityName: map['communityName'] == null ? null : map['communityName'] as String,
      communityRoleAssignments: map['communityRoleAssignments'] == null ? null : pulumi.Input.decodeList<RoleAssignmentItem>(map['communityRoleAssignments'], (value) => RoleAssignmentItem.fromMap((value as Map).cast<String, dynamic>())),
