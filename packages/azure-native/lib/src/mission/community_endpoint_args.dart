...
class CommunityEndpointArgs {
  ...
  CommunityEndpointArgs({
    ...
    required List<CommunityEndpointDestinationRule> ruleCollection,
  ...
  factory CommunityEndpointArgs.fromMap(Map<String, dynamic> map) {
    return CommunityEndpointArgs(
      communityEndpointName: map['communityEndpointName'] == null ? null : map['communityEndpointName'] as String,
      communityName: map['communityName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      ruleCollection: pulumi.Input.decodeList<CommunityEndpointDestinationRule>(map['ruleCollection'], (value) => CommunityEndpointDestinationRule.fromMap((value as Map).cast<String, dynamic>())),
