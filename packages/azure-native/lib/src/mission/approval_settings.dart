...
class ApprovalSettings {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mandatoryApprovers': ?mandatoryApprovers == null ? null : pulumi.Input.encodeList<MandatoryApprover, Map<String, dynamic>>(mandatoryApprovers!, (value) => value.toMap()),
  ...
  factory ApprovalSettings.fromMap(Map<String, dynamic> map) {
    return ApprovalSettings(
      connectionCreation: map['connectionCreation'] == null ? null : map['connectionCreation'] as String,
      connectionDeletion: map['connectionDeletion'] == null ? null : map['connectionDeletion'] as String,
      connectionUpdate: map['connectionUpdate'] == null ? null : map['connectionUpdate'] as String,
      enclaveCreation: map['enclaveCreation'] == null ? null : map['enclaveCreation'] as String,
      enclaveDeletion: map['enclaveDeletion'] == null ? null : map['enclaveDeletion'] as String,
      endpointCreation: map['endpointCreation'] == null ? null : map['endpointCreation'] as String,
      endpointDeletion: map['endpointDeletion'] == null ? null : map['endpointDeletion'] as String,
      endpointUpdate: map['endpointUpdate'] == null ? null : map['endpointUpdate'] as String,
      maintenanceMode: map['maintenanceMode'] == null ? null : map['maintenanceMode'] as String,
      mandatoryApprovers: map['mandatoryApprovers'] == null ? null : pulumi.Input.decodeList<MandatoryApprover>(map['mandatoryApprovers'], (value) => MandatoryApprover.fromMap((value as Map).cast<String, dynamic>())),
      minimumApproversRequired: map['minimumApproversRequired'] == null ? null : map['minimumApproversRequired'] as double,
      notificationOnApprovalAction: map['notificationOnApprovalAction'] == null ? null : map['notificationOnApprovalAction'] as String,
      notificationOnApprovalCreation: map['notificationOnApprovalCreation'] == null ? null : map['notificationOnApprovalCreation'] as String,
      notificationOnApprovalDeletion: map['notificationOnApprovalDeletion'] == null ? null : map['notificationOnApprovalDeletion'] as String,
      serviceCatalogDeployment: map['serviceCatalogDeployment'] == null ? null : map['serviceCatalogDeployment'] as String,
    );
  }
}
