...
class GetReportResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'status': status,
      'storageInfo': ?storageInfo == null ? null : storageInfo!.toMap(),
  ...
  factory GetReportResult.fromMap(Map<String, dynamic> map) {
    return GetReportResult(
      ...
      storageInfo: map['storageInfo'] == null ? null : StorageInfoResponse.fromMap((map['storageInfo'] as Map).cast<String, dynamic>()),
