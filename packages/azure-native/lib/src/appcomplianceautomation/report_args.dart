...
class ReportArgs {
  ...
  ReportArgs({
    String? offerGuid,
    String? reportName,
    required List<ResourceMetadata> resources,
  ...
  factory ReportArgs.fromMap(Map<String, dynamic> map) {
    return ReportArgs(
      ...
      resources: pulumi.Input.decodeList<ResourceMetadata>(map['resources'], (value) => ResourceMetadata.fromMap((value as Map).cast<String, dynamic>())),
      storageInfo: map['storageInfo'] == null ? null : StorageInfo.fromMap((map['storageInfo'] as Map).cast<String, dynamic>()),
