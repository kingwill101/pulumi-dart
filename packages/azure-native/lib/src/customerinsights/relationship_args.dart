...
class RelationshipArgs {
  ...
  RelationshipArgs({
    ...
    required String relatedProfileType,
  ...
  factory RelationshipArgs.fromMap(Map<String, dynamic> map) {
    return RelationshipArgs(
      cardinality: map['cardinality'] == null ? null : CardinalityTypes.fromValue(map['cardinality'] as String),
      ...
      lookupMappings: map['lookupMappings'] == null ? null : pulumi.Input.decodeList<RelationshipTypeMapping>(map['lookupMappings'], (value) => RelationshipTypeMapping.fromMap((value as Map).cast<String, dynamic>())),
