...
/// {@template pulumi_m365securityandcompliance_private_endpoint_connections_adt_apiargs_doc}
/// The set of arguments for PrivateEndpointConnectionsAdtAPI.
/// {@endtemplate}
/// {@macro pulumi_m365securityandcompliance_private_endpoint_connections_adt_apiargs_doc}
class PrivateEndpointConnectionsAdtAPIArgs {
  ...
  /// Creates a new [PrivateEndpointConnectionsAdtAPIArgs].
  ...
  factory PrivateEndpointConnectionsAdtAPIArgs.fromMap(Map<String, dynamic> map) {
    return PrivateEndpointConnectionsAdtAPIArgs(
