...
class PublicCloudConnectorArgs {
  ...
  PublicCloudConnectorArgs({
    required AwsCloudProfile awsCloudProfile,
  ...
  factory PublicCloudConnectorArgs.fromMap(Map<String, dynamic> map) {
    return PublicCloudConnectorArgs(
      awsCloudProfile: AwsCloudProfile.fromMap((map['awsCloudProfile'] as Map).cast<String, dynamic>()),
      hostType: map['hostType'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      publicCloudConnector: map['publicCloudConnector'] == null ? null : map['publicCloudConnector'] as String,
