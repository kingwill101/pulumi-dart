...
class DscConfigurationArgs {
  ...
  factory DscConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return DscConfigurationArgs(
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeMapValues<DscConfigurationParameter>(map['parameters'], (value) => DscConfigurationParameter.fromMap((value as Map).cast<String, dynamic>())),
