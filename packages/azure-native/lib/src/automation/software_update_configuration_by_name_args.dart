...
class SoftwareUpdateConfigurationByNameArgs {
  ...
  SoftwareUpdateConfigurationByNameArgs({
    ...
    required SUCScheduleProperties scheduleInfo,
  ...
  factory SoftwareUpdateConfigurationByNameArgs.fromMap(Map<String, dynamic> map) {
    return SoftwareUpdateConfigurationByNameArgs(
      ...
      scheduleInfo: SUCScheduleProperties.fromMap((map['scheduleInfo'] as Map).cast<String, dynamic>()),
      softwareUpdateConfigurationName: map['softwareUpdateConfigurationName'] == null ? null : map['softwareUpdateConfigurationName'] as String,
      tasks: map['tasks'] == null ? null : SoftwareUpdateConfigurationTasks.fromMap((map['tasks'] as Map).cast<String, dynamic>()),
      updateConfiguration: UpdateConfiguration.fromMap((map['updateConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
