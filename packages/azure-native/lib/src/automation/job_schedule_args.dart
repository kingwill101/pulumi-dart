...
class JobScheduleArgs {
  ...
  JobScheduleArgs({
    ...
    String? runOn,
    required RunbookAssociationProperty runbook,
    required ScheduleAssociationProperty schedule,
  }) :
  ...
  factory JobScheduleArgs.fromMap(Map<String, dynamic> map) {
    return JobScheduleArgs(
      ...
      runbook: RunbookAssociationProperty.fromMap((map['runbook'] as Map).cast<String, dynamic>()),
      schedule: ScheduleAssociationProperty.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
    );
  }
}
