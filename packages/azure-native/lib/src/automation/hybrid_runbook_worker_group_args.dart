...
class HybridRunbookWorkerGroupArgs {
  ...
  factory HybridRunbookWorkerGroupArgs.fromMap(Map<String, dynamic> map) {
    return HybridRunbookWorkerGroupArgs(
      ...
      credential: map['credential'] == null ? null : RunAsCredentialAssociationProperty.fromMap((map['credential'] as Map).cast<String, dynamic>()),
      hybridRunbookWorkerGroupName: map['hybridRunbookWorkerGroupName'] == null ? null : map['hybridRunbookWorkerGroupName'] as String,
