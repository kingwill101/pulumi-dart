...
class ConnectionTypeArgs {
  ...
  factory ConnectionTypeArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionTypeArgs(
      ...
      connectionTypeName: map['connectionTypeName'] == null ? null : map['connectionTypeName'] as String,
      fieldDefinitions: pulumi.Input.decodeMapValues<FieldDefinition>(map['fieldDefinitions'], (value) => FieldDefinition.fromMap((value as Map).cast<String, dynamic>())),
