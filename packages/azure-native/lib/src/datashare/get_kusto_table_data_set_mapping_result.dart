...
/// Result data returned by getKustoTableDataSetMapping.
class GetKustoTableDataSetMappingResult {
  ...
  /// Creates a new [GetKustoTableDataSetMappingResult].
  ...
  factory GetKustoTableDataSetMappingResult.fromMap(Map<String, dynamic> map) {
