...
class Invitation extends pulumi.CustomResource {
  ...
  Invitation(
    ...
    this.invitationStatus = registerOutput<String>('invitationStatus');
    this.name = registerOutput<String>('name');
    this.respondedAt = registerOutput<String>('respondedAt');
    this.sentAt = registerOutput<String>('sentAt');
    this.systemData = registerOutput<SystemDataResponse>('systemData');
    this.targetActiveDirectoryId = registerOutput<String?>('targetActiveDirectoryId');
    this.targetEmail = registerOutput<String?>('targetEmail');
    this.targetObjectId = registerOutput<String?>('targetObjectId');
