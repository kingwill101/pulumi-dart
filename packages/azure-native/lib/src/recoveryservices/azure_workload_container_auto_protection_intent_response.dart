...
class AzureWorkloadContainerAutoProtectionIntentResponse {
  ...
  /// Creates a new [AzureWorkloadContainerAutoProtectionIntentResponse].
  ...
  factory AzureWorkloadContainerAutoProtectionIntentResponse.fromMap(Map<String, dynamic> map) {
    return AzureWorkloadContainerAutoProtectionIntentResponse(
