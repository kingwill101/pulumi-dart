...
class AzureSQLAGWorkloadContainerProtectionContainerResponse {
  ...
  /// Creates a new [AzureSQLAGWorkloadContainerProtectionContainerResponse].
  ...
  factory AzureSQLAGWorkloadContainerProtectionContainerResponse.fromMap(Map<String, dynamic> map) {
    return AzureSQLAGWorkloadContainerProtectionContainerResponse(
