...
class ReplicationProtectedItemArgs {
  ...
  factory ReplicationProtectedItemArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationProtectedItemArgs(
      ...
      properties: map['properties'] == null ? null : EnableProtectionInputProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      protectionContainerName: map['protectionContainerName'] as String,
      replicatedProtectedItemName: map['replicatedProtectedItemName'] == null ? null : map['replicatedProtectedItemName'] as String,
