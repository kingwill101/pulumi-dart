...
class ReplicationPolicyArgs {
  ...
  ReplicationPolicyArgs({
    String? policyName,
    CreatePolicyInputProperties? properties,
  ...
  factory ReplicationPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationPolicyArgs(
      ...
      properties: map['properties'] == null ? null : CreatePolicyInputProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
