...
class InMageVolumeExclusionOptions {
  ...
  final String? onlyExcludeIfSingleVolume;
  ...
  factory InMageVolumeExclusionOptions.fromMap(Map<String, dynamic> map) {
    return InMageVolumeExclusionOptions(
      onlyExcludeIfSingleVolume: map['onlyExcludeIfSingleVolume'] == null ? null : map['onlyExcludeIfSingleVolume'] as String,
      volumeLabel: map['volumeLabel'] == null ? null : map['volumeLabel'] as String,
    );
  }
}
