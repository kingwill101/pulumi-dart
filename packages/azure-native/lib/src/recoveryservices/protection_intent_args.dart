...
class ProtectionIntentArgs {
  ...
  ProtectionIntentArgs({
    ...
    String? location,
    AzureRecoveryServiceVaultProtectionIntent? properties,
  ...
  factory ProtectionIntentArgs.fromMap(Map<String, dynamic> map) {
    return ProtectionIntentArgs(
      ...
      intentObjectName: map['intentObjectName'] == null ? null : map['intentObjectName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : AzureRecoveryServiceVaultProtectionIntent.fromMap((map['properties'] as Map).cast<String, dynamic>()),
