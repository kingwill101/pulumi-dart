...
class ReplicationStorageClassificationMappingArgs {
  ...
  ReplicationStorageClassificationMappingArgs({
    ...
    StorageMappingInputProperties? properties,
  ...
  factory ReplicationStorageClassificationMappingArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationStorageClassificationMappingArgs(
      ...
      properties: map['properties'] == null ? null : StorageMappingInputProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      resourceName: map['resourceName'] as String,
      storageClassificationMappingName: map['storageClassificationMappingName'] == null ? null : map['storageClassificationMappingName'] as String,
