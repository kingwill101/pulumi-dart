...
class ProtectionPolicyArgs {
  ...
  ProtectionPolicyArgs({
    ...
    String? location,
    String? policyName,
    AzureFileShareProtectionPolicy? properties,
  ...
  factory ProtectionPolicyArgs.fromMap(Map<String, dynamic> map) {
    return ProtectionPolicyArgs(
      ...
      properties: map['properties'] == null ? null : AzureFileShareProtectionPolicy.fromMap((map['properties'] as Map).cast<String, dynamic>()),
