...
class IoTRoleArgs {
  ...
  factory IoTRoleArgs.fromMap(Map<String, dynamic> map) {
    return IoTRoleArgs(
      ...
      ioTEdgeAgentInfo: map['ioTEdgeAgentInfo'] == null ? null : IoTEdgeAgentInfo.fromMap((map['ioTEdgeAgentInfo'] as Map).cast<String, dynamic>()),
      ...
      shareMappings: map['shareMappings'] == null ? null : pulumi.Input.decodeList<MountPointMap>(map['shareMappings'], (value) => MountPointMap.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
