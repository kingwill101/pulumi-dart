...
class KubernetesRoleArgs {
  ...
  KubernetesRoleArgs({
    ...
    required KubernetesClusterInfo kubernetesClusterInfo,
    required KubernetesRoleResources kubernetesRoleResources,
    String? name,
  ...
  factory KubernetesRoleArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesRoleArgs(
      ...
      kubernetesClusterInfo: KubernetesClusterInfo.fromMap((map['kubernetesClusterInfo'] as Map).cast<String, dynamic>()),
      kubernetesRoleResources: KubernetesRoleResources.fromMap((map['kubernetesRoleResources'] as Map).cast<String, dynamic>()),
