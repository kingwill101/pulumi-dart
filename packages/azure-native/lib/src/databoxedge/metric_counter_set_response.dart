...
class MetricCounterSetResponse {
  ...
  final List<MetricCounterResponse> counters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'counters': pulumi.Input.encodeList<MetricCounterResponse, Map<String, dynamic>>(counters, (value) => value.toMap()),
    };
  }

  factory MetricCounterSetResponse.fromMap(Map<String, dynamic> map) {
    return MetricCounterSetResponse(
      counters: pulumi.Input.decodeList<MetricCounterResponse>(map['counters'], (value) => MetricCounterResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
