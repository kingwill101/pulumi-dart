...
class ManagementConfigurationArgs {
  ...
  factory ManagementConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ManagementConfigurationArgs(
      ...
      managementConfigurationName: map['managementConfigurationName'] == null ? null : map['managementConfigurationName'] as String,
      properties: map['properties'] == null ? null : ManagementConfigurationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
