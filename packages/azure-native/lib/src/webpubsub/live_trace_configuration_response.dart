...
class LiveTraceConfigurationResponse {
  ...
  final List<LiveTraceCategoryResponse>? categories;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'categories': ?categories == null ? null : pulumi.Input.encodeList<LiveTraceCategoryResponse, Map<String, dynamic>>(categories!, (value) => value.toMap()),
      'enabled': ?enabled,
    };
  }
  ...
  factory LiveTraceConfigurationResponse.fromMap(Map<String, dynamic> map) {
    return LiveTraceConfigurationResponse(
      categories: map['categories'] == null ? null : pulumi.Input.decodeList<LiveTraceCategoryResponse>(map['categories'], (value) => LiveTraceCategoryResponse.fromMap((value as Map).cast<String, dynamic>())),
