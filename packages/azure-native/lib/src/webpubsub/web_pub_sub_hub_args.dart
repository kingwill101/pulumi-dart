...
class WebPubSubHubArgs {
  ...
  WebPubSubHubArgs({
    String? hubName,
    required WebPubSubHubProperties properties,
  ...
  factory WebPubSubHubArgs.fromMap(Map<String, dynamic> map) {
    return WebPubSubHubArgs(
      hubName: map['hubName'] == null ? null : map['hubName'] as String,
      properties: WebPubSubHubProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
