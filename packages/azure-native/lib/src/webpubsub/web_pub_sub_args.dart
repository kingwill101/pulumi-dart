...
class WebPubSubArgs {
  ...
  factory WebPubSubArgs.fromMap(Map<String, dynamic> map) {
    return WebPubSubArgs(
      ...
      liveTraceConfiguration: map['liveTraceConfiguration'] == null ? null : LiveTraceConfiguration.fromMap((map['liveTraceConfiguration'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      networkACLs: map['networkACLs'] == null ? null : WebPubSubNetworkACLs.fromMap((map['networkACLs'] as Map).cast<String, dynamic>()),
      publicNetworkAccess: map['publicNetworkAccess'] == null ? null : map['publicNetworkAccess'] as String,
      regionEndpointEnabled: map['regionEndpointEnabled'] == null ? null : map['regionEndpointEnabled'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      resourceLogConfiguration: map['resourceLogConfiguration'] == null ? null : ResourceLogConfiguration.fromMap((map['resourceLogConfiguration'] as Map).cast<String, dynamic>()),
      ...
      socketIO: map['socketIO'] == null ? null : WebPubSubSocketIOSettings.fromMap((map['socketIO'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tls: map['tls'] == null ? null : WebPubSubTlsSettings.fromMap((map['tls'] as Map).cast<String, dynamic>()),
    );
  }
}
