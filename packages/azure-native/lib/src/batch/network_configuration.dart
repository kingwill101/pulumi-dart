...
class NetworkConfiguration {
  ...
  final DynamicVNetAssignmentScope? dynamicVnetAssignmentScope;
  ...
  final PoolEndpointConfiguration? endpointConfiguration;
  /// The public IP Address configuration of the networking configuration of a Pool.
  final PublicIPAddressConfiguration? publicIPAddressConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dynamicVnetAssignmentScope': ?dynamicVnetAssignmentScope == null ? null : dynamicVnetAssignmentScope!.value,
  ...
  factory NetworkConfiguration.fromMap(Map<String, dynamic> map) {
    return NetworkConfiguration(
      dynamicVnetAssignmentScope: map['dynamicVnetAssignmentScope'] == null ? null : DynamicVNetAssignmentScope.fromValue(map['dynamicVnetAssignmentScope'] as String),
      enableAcceleratedNetworking: map['enableAcceleratedNetworking'] == null ? null : map['enableAcceleratedNetworking'] as bool,
      endpointConfiguration: map['endpointConfiguration'] == null ? null : PoolEndpointConfiguration.fromMap((map['endpointConfiguration'] as Map).cast<String, dynamic>()),
      publicIPAddressConfiguration: map['publicIPAddressConfiguration'] == null ? null : PublicIPAddressConfiguration.fromMap((map['publicIPAddressConfiguration'] as Map).cast<String, dynamic>()),
