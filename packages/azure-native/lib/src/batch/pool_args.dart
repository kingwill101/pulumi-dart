...
class PoolArgs {
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      applicationPackages: map['applicationPackages'] == null ? null : pulumi.Input.decodeList<ApplicationPackageReference>(map['applicationPackages'], (value) => ApplicationPackageReference.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : BatchPoolIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      interNodeCommunication: map['interNodeCommunication'] == null ? null : InterNodeCommunicationState.fromValue(map['interNodeCommunication'] as String),
      ...
      mountConfiguration: map['mountConfiguration'] == null ? null : pulumi.Input.decodeList<MountConfiguration>(map['mountConfiguration'], (value) => MountConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      startTask: map['startTask'] == null ? null : StartTask.fromMap((map['startTask'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      targetNodeCommunicationMode: map['targetNodeCommunicationMode'] == null ? null : NodeCommunicationMode.fromValue(map['targetNodeCommunicationMode'] as String),
      taskSchedulingPolicy: map['taskSchedulingPolicy'] == null ? null : TaskSchedulingPolicy.fromMap((map['taskSchedulingPolicy'] as Map).cast<String, dynamic>()),
      ...
      userAccounts: map['userAccounts'] == null ? null : pulumi.Input.decodeList<UserAccount>(map['userAccounts'], (value) => UserAccount.fromMap((value as Map).cast<String, dynamic>())),
