...
class DomainServiceArgs {
  ...
  factory DomainServiceArgs.fromMap(Map<String, dynamic> map) {
    return DomainServiceArgs(
      configDiagnostics: map['configDiagnostics'] == null ? null : ConfigDiagnostics.fromMap((map['configDiagnostics'] as Map).cast<String, dynamic>()),
      ...
      domainSecuritySettings: map['domainSecuritySettings'] == null ? null : DomainSecuritySettings.fromMap((map['domainSecuritySettings'] as Map).cast<String, dynamic>()),
      domainServiceName: map['domainServiceName'] == null ? null : map['domainServiceName'] as String,
      filteredSync: map['filteredSync'] == null ? null : map['filteredSync'] as String,
      ldapsSettings: map['ldapsSettings'] == null ? null : LdapsSettings.fromMap((map['ldapsSettings'] as Map).cast<String, dynamic>()),
      ...
      replicaSets: map['replicaSets'] == null ? null : pulumi.Input.decodeList<ReplicaSet>(map['replicaSets'], (value) => ReplicaSet.fromMap((value as Map).cast<String, dynamic>())),
      resourceForestSettings: map['resourceForestSettings'] == null ? null : ResourceForestSettings.fromMap((map['resourceForestSettings'] as Map).cast<String, dynamic>()),
