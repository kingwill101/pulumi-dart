...
class SubnetOverride {
  ...
  final SubnetSharedPublicIpAddressConfiguration? sharedPublicIpAddressConfiguration;
  ...
  factory SubnetOverride.fromMap(Map<String, dynamic> map) {
    return SubnetOverride(
      ...
      sharedPublicIpAddressConfiguration: map['sharedPublicIpAddressConfiguration'] == null ? null : SubnetSharedPublicIpAddressConfiguration.fromMap((map['sharedPublicIpAddressConfiguration'] as Map).cast<String, dynamic>()),
