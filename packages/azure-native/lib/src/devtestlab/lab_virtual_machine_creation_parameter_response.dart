...
class LabVirtualMachineCreationParameterResponse {
  ...
  final BulkCreationParametersResponse? bulkCreationParameters;
  ...
  factory LabVirtualMachineCreationParameterResponse.fromMap(Map<String, dynamic> map) {
    return LabVirtualMachineCreationParameterResponse(
      ...
      bulkCreationParameters: map['bulkCreationParameters'] == null ? null : BulkCreationParametersResponse.fromMap((map['bulkCreationParameters'] as Map).cast<String, dynamic>()),
