...
class LabArgs {
  ...
  factory LabArgs.fromMap(Map<String, dynamic> map) {
    return LabArgs(
      announcement: map['announcement'] == null ? null : LabAnnouncementProperties.fromMap((map['announcement'] as Map).cast<String, dynamic>()),
      ...
      support: map['support'] == null ? null : LabSupportProperties.fromMap((map['support'] as Map).cast<String, dynamic>()),
