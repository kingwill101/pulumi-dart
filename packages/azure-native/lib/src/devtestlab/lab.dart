...
class Lab extends pulumi.CustomResource {
  ...
  Lab(
    ...
    this.announcement = registerOutput<LabAnnouncementPropertiesResponse?>('announcement');
    this.artifactsStorageAccount = registerOutput<String>('artifactsStorageAccount');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.createdDate = registerOutput<String>('createdDate');
    this.defaultPremiumStorageAccount = registerOutput<String>('defaultPremiumStorageAccount');
    this.defaultStorageAccount = registerOutput<String>('defaultStorageAccount');
    this.environmentPermission = registerOutput<String?>('environmentPermission');
    this.extendedProperties = registerOutput<Map<String, String>?>('extendedProperties');
    this.labStorageType = registerOutput<String?>('labStorageType');
    this.loadBalancerId = registerOutput<String>('loadBalancerId');
    this.location = registerOutput<String?>('location');
    this.mandatoryArtifactsResourceIdsLinux = registerOutput<List<String>?>('mandatoryArtifactsResourceIdsLinux');
    this.mandatoryArtifactsResourceIdsWindows = registerOutput<List<String>?>('mandatoryArtifactsResourceIdsWindows');
    this.name = registerOutput<String>('name');
    this.networkSecurityGroupId = registerOutput<String>('networkSecurityGroupId');
    this.premiumDataDiskStorageAccount = registerOutput<String>('premiumDataDiskStorageAccount');
    this.premiumDataDisks = registerOutput<String?>('premiumDataDisks');
    this.provisioningState = registerOutput<String>('provisioningState');
    this.publicIpId = registerOutput<String>('publicIpId');
    this.support = registerOutput<LabSupportPropertiesResponse?>('support');
    ...
    this.vmCreationResourceGroup = registerOutput<String>('vmCreationResourceGroup');
  }
}
