...
class UserArgs {
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      identity: map['identity'] == null ? null : UserIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      labName: map['labName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      secretStore: map['secretStore'] == null ? null : UserSecretStore.fromMap((map['secretStore'] as Map).cast<String, dynamic>()),
