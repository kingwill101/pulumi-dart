...
class ResourceProviderEndpointResponse {
  ...
  /// The feature rules.
  final ResourceProviderEndpointFeaturesRuleResponse? featuresRule;
  /// The locations.
  ...
  factory ResourceProviderEndpointResponse.fromMap(Map<String, dynamic> map) {
    return ResourceProviderEndpointResponse(
      ...
      featuresRule: map['featuresRule'] == null ? null : ResourceProviderEndpointFeaturesRuleResponse.fromMap((map['featuresRule'] as Map).cast<String, dynamic>()),
