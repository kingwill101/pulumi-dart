...
class ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse {
  ...
  /// Task input
  final ValidateSyncMigrationInputSqlServerTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<ValidateSyncMigrationInputSqlServerTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<ValidateSyncMigrationInputSqlServerTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ValidateMigrationInputSqlServerSqlDbSyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : ValidateSyncMigrationInputSqlServerTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<ValidateSyncMigrationInputSqlServerTaskOutputResponse>(map['output'], (value) => ValidateSyncMigrationInputSqlServerTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
