...
class GetUserTablesPostgreSqlTaskPropertiesResponse {
  ...
  /// Task input
  final GetUserTablesPostgreSqlTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<GetUserTablesPostgreSqlTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<GetUserTablesPostgreSqlTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory GetUserTablesPostgreSqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return GetUserTablesPostgreSqlTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : GetUserTablesPostgreSqlTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<GetUserTablesPostgreSqlTaskOutputResponse>(map['output'], (value) => GetUserTablesPostgreSqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
