...
class MigrateMongoDbTaskPropertiesResponse {
  ...
  final List<MongoDbCollectionProgressResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<MongoDbCollectionProgressResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory MigrateMongoDbTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return MigrateMongoDbTaskPropertiesResponse(
      ...
      output: pulumi.Input.decodeList<MongoDbCollectionProgressResponse>(map['output'], (value) => MongoDbCollectionProgressResponse.fromMap((value as Map).cast<String, dynamic>())),
