...
class ConnectToSourceOracleSyncTaskPropertiesResponse {
  ...
  /// Task input
  final ConnectToSourceOracleSyncTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<ConnectToSourceOracleSyncTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<ConnectToSourceOracleSyncTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToSourceOracleSyncTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToSourceOracleSyncTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : ConnectToSourceOracleSyncTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<ConnectToSourceOracleSyncTaskOutputResponse>(map['output'], (value) => ConnectToSourceOracleSyncTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
