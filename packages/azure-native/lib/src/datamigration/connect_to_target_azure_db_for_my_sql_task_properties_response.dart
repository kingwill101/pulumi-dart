...
class ConnectToTargetAzureDbForMySqlTaskPropertiesResponse {
  ...
  /// Task input
  final ConnectToTargetAzureDbForMySqlTaskInputResponse? input;
  /// Task output. This is ignored if submitted.
  final List<ConnectToTargetAzureDbForMySqlTaskOutputResponse> output;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'output': pulumi.Input.encodeList<ConnectToTargetAzureDbForMySqlTaskOutputResponse, Map<String, dynamic>>(output, (value) => value.toMap()),
      'state': state,
      'taskType': taskType,
    };
  }
  ...
  factory ConnectToTargetAzureDbForMySqlTaskPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ConnectToTargetAzureDbForMySqlTaskPropertiesResponse(
      ...
      input: map['input'] == null ? null : ConnectToTargetAzureDbForMySqlTaskInputResponse.fromMap((map['input'] as Map).cast<String, dynamic>()),
      output: pulumi.Input.decodeList<ConnectToTargetAzureDbForMySqlTaskOutputResponse>(map['output'], (value) => ConnectToTargetAzureDbForMySqlTaskOutputResponse.fromMap((value as Map).cast<String, dynamic>())),
