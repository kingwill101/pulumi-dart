...
class NetworkServiceDesignGroupArgs {
  ...
  factory NetworkServiceDesignGroupArgs.fromMap(Map<String, dynamic> map) {
    return NetworkServiceDesignGroupArgs(
      ...
      networkServiceDesignGroupName: map['networkServiceDesignGroupName'] == null ? null : map['networkServiceDesignGroupName'] as String,
      properties: map['properties'] == null ? null : NetworkServiceDesignGroupPropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>()),
