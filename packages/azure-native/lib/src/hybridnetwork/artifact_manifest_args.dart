...
class ArtifactManifestArgs {
  ...
  factory ArtifactManifestArgs.fromMap(Map<String, dynamic> map) {
    return ArtifactManifestArgs(
      artifactManifestName: map['artifactManifestName'] == null ? null : map['artifactManifestName'] as String,
      artifactStoreName: map['artifactStoreName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : ArtifactManifestPropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>()),
