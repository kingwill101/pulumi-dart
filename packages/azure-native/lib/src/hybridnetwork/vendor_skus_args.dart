...
class VendorSkusArgs {
  ...
  VendorSkusArgs({
    ...
    dynamic managedApplicationParameters,
    dynamic managedApplicationTemplate,
  ...
  factory VendorSkusArgs.fromMap(Map<String, dynamic> map) {
    return VendorSkusArgs(
      ...
      networkFunctionTemplate: map['networkFunctionTemplate'] == null ? null : NetworkFunctionTemplate.fromMap((map['networkFunctionTemplate'] as Map).cast<String, dynamic>()),
