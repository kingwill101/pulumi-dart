...
class AzureOperatorNexusNetworkFunctionTemplate {
  ...
  final List<AzureOperatorNexusNetworkFunctionArmTemplateApplication>? networkFunctionApplications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'networkFunctionApplications': ?networkFunctionApplications == null ? null : pulumi.Input.encodeList<AzureOperatorNexusNetworkFunctionArmTemplateApplication, Map<String, dynamic>>(networkFunctionApplications!, (value) => value.toMap()),
      'nfviType': nfviType,
    };
  }
  ...
  factory AzureOperatorNexusNetworkFunctionTemplate.fromMap(Map<String, dynamic> map) {
    return AzureOperatorNexusNetworkFunctionTemplate(
      networkFunctionApplications: map['networkFunctionApplications'] == null ? null : pulumi.Input.decodeList<AzureOperatorNexusNetworkFunctionArmTemplateApplication>(map['networkFunctionApplications'], (value) => AzureOperatorNexusNetworkFunctionArmTemplateApplication.fromMap((value as Map).cast<String, dynamic>())),
