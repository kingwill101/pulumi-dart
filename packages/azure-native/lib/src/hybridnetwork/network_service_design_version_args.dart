...
class NetworkServiceDesignVersionArgs {
  ...
  factory NetworkServiceDesignVersionArgs.fromMap(Map<String, dynamic> map) {
    return NetworkServiceDesignVersionArgs(
      ...
      networkServiceDesignVersionName: map['networkServiceDesignVersionName'] == null ? null : map['networkServiceDesignVersionName'] as String,
      properties: map['properties'] == null ? null : NetworkServiceDesignVersionPropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>()),
