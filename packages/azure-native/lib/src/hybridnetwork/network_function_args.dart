...
class NetworkFunctionArgs {
  ...
  NetworkFunctionArgs({
    ...
    NetworkFunctionValueWithSecrets? properties,
  ...
  factory NetworkFunctionArgs.fromMap(Map<String, dynamic> map) {
    return NetworkFunctionArgs(
      ...
      networkFunctionName: map['networkFunctionName'] == null ? null : map['networkFunctionName'] as String,
      properties: map['properties'] == null ? null : NetworkFunctionValueWithSecrets.fromMap((map['properties'] as Map).cast<String, dynamic>()),
