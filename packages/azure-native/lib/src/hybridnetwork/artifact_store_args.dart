...
class ArtifactStoreArgs {
  ...
  factory ArtifactStoreArgs.fromMap(Map<String, dynamic> map) {
    return ArtifactStoreArgs(
      artifactStoreName: map['artifactStoreName'] == null ? null : map['artifactStoreName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : ArtifactStorePropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>()),
