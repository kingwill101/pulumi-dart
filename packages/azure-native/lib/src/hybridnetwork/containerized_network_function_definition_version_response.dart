...
class ContainerizedNetworkFunctionDefinitionVersionResponse {
  ...
  final AzureArcKubernetesNetworkFunctionTemplateResponse? networkFunctionTemplate;
  ...
  factory ContainerizedNetworkFunctionDefinitionVersionResponse.fromMap(Map<String, dynamic> map) {
    return ContainerizedNetworkFunctionDefinitionVersionResponse(
      ...
      networkFunctionTemplate: map['networkFunctionTemplate'] == null ? null : AzureArcKubernetesNetworkFunctionTemplateResponse.fromMap((map['networkFunctionTemplate'] as Map).cast<String, dynamic>()),
