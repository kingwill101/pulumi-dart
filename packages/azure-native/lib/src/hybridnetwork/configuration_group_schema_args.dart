...
class ConfigurationGroupSchemaArgs {
  ...
  factory ConfigurationGroupSchemaArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationGroupSchemaArgs(
      configurationGroupSchemaName: map['configurationGroupSchemaName'] == null ? null : map['configurationGroupSchemaName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : ConfigurationGroupSchemaPropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>()),
