...
class SiteNetworkServiceArgs {
  ...
  factory SiteNetworkServiceArgs.fromMap(Map<String, dynamic> map) {
    return SiteNetworkServiceArgs(
      ...
      properties: map['properties'] == null ? null : SiteNetworkServicePropertiesFormat.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      siteNetworkServiceName: map['siteNetworkServiceName'] == null ? null : map['siteNetworkServiceName'] as String,
