...
class ManagedDiskEncryption {
  ...
  final ManagedDiskEncryptionKeyVaultProperties keyVaultProperties;
  ...
  factory ManagedDiskEncryption.fromMap(Map<String, dynamic> map) {
    return ManagedDiskEncryption(
      ...
      keyVaultProperties: ManagedDiskEncryptionKeyVaultProperties.fromMap((map['keyVaultProperties'] as Map).cast<String, dynamic>()),
