...
import 'customer_managed_key_encryption_key_encryption_key_identity.dart';

/// All Customer-managed key encryption properties for the resource.
class CustomerManagedKeyEncryption {
  /// All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
  final CustomerManagedKeyEncryptionKeyEncryptionKeyIdentity? keyEncryptionKeyIdentity;
  ...
  factory CustomerManagedKeyEncryption.fromMap(Map<String, dynamic> map) {
    return CustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: map['keyEncryptionKeyIdentity'] == null ? null : CustomerManagedKeyEncryptionKeyEncryptionKeyIdentity.fromMap((map['keyEncryptionKeyIdentity'] as Map).cast<String, dynamic>()),
