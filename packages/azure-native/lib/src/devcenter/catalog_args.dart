...
class CatalogArgs {
  ...
  factory CatalogArgs.fromMap(Map<String, dynamic> map) {
    return CatalogArgs(
      adoGit: map['adoGit'] == null ? null : GitCatalog.fromMap((map['adoGit'] as Map).cast<String, dynamic>()),
      catalogName: map['catalogName'] == null ? null : map['catalogName'] as String,
      devCenterName: map['devCenterName'] as String,
      gitHub: map['gitHub'] == null ? null : GitCatalog.fromMap((map['gitHub'] as Map).cast<String, dynamic>()),
