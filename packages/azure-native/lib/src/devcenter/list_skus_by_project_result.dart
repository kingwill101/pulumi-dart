...
class ListSkusByProjectResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': nextLink,
      'value': pulumi.Input.encodeList<DevCenterSkuResponse, Map<String, dynamic>>(value, (value) => value.toMap()),
    };
  }
  ...
  factory ListSkusByProjectResult.fromMap(Map<String, dynamic> map) {
    return ListSkusByProjectResult(
      ...
      value: pulumi.Input.decodeList<DevCenterSkuResponse>(map['value'], (value) => DevCenterSkuResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
