...
class ConfigurationStoreArgs {
  ...
  factory ConfigurationStoreArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationStoreArgs(
      configStoreName: map['configStoreName'] == null ? null : map['configStoreName'] as String,
      createMode: map['createMode'] == null ? null : CreateMode.fromValue(map['createMode'] as String),
      dataPlaneProxy: map['dataPlaneProxy'] == null ? null : DataPlaneProxyProperties.fromMap((map['dataPlaneProxy'] as Map).cast<String, dynamic>()),
