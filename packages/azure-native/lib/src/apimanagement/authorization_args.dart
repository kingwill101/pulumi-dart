...
class AuthorizationArgs {
  ...
  factory AuthorizationArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationArgs(
      authorizationId: map['authorizationId'] == null ? null : map['authorizationId'] as String,
      ...
      error: map['error'] == null ? null : AuthorizationError.fromMap((map['error'] as Map).cast<String, dynamic>()),
