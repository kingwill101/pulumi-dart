...
class UserArgs {
  ...
  factory UserArgs.fromMap(Map<String, dynamic> map) {
    return UserArgs(
      ...
      identities: map['identities'] == null ? null : pulumi.Input.decodeList<UserIdentityContract>(map['identities'], (value) => UserIdentityContract.fromMap((value as Map).cast<String, dynamic>())),
      lastName: map['lastName'] as String,
      note: map['note'] == null ? null : map['note'] as String,
      notify: map['notify'] == null ? null : map['notify'] as bool,
