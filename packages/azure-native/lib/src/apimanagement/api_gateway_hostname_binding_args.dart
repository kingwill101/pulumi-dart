...
class ApiGatewayHostnameBindingArgs {
  ...
  ApiGatewayHostnameBindingArgs({
    ...
    required GatewayHostnameBindingKeyVault keyVault,
  ...
  factory ApiGatewayHostnameBindingArgs.fromMap(Map<String, dynamic> map) {
    return ApiGatewayHostnameBindingArgs(
      ...
      hostnameBindingName: map['hostnameBindingName'] == null ? null : map['hostnameBindingName'] as String,
      keyVault: GatewayHostnameBindingKeyVault.fromMap((map['keyVault'] as Map).cast<String, dynamic>()),
