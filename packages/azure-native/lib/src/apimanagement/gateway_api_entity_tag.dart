...
import 'gateway_api_entity_tag_args.dart';
...
class GatewayApiEntityTag extends pulumi.CustomResource {
  ...
  /// Creates a new [GatewayApiEntityTag].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [GatewayApiEntityTag]. {@macro pulumi_apimanagement_gateway_api_entity_tag_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  GatewayApiEntityTag(
    String name, {
    GatewayApiEntityTagArgs? args,
    ...
    this.apiRevision = registerOutput<String?>('apiRevision');
    this.apiRevisionDescription = registerOutput<String?>('apiRevisionDescription');
    this.apiType = registerOutput<String?>('apiType');
    this.apiVersion = registerOutput<String?>('apiVersion');
    this.apiVersionDescription = registerOutput<String?>('apiVersionDescription');
    this.apiVersionSet = registerOutput<ApiVersionSetContractDetailsResponse?>('apiVersionSet');
    this.apiVersionSetId = registerOutput<String?>('apiVersionSetId');
    this.authenticationSettings = registerOutput<AuthenticationSettingsContractResponse?>('authenticationSettings');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.contact = registerOutput<ApiContactInformationResponse?>('contact');
    this.description = registerOutput<String?>('description');
    this.displayName = registerOutput<String?>('displayName');
    this.isCurrent = registerOutput<bool?>('isCurrent');
    this.isOnline = registerOutput<bool>('isOnline');
    this.license = registerOutput<ApiLicenseInformationResponse?>('license');
    ...
    this.subscriptionKeyParameterNames = registerOutput<SubscriptionKeyParameterNamesContractResponse?>('subscriptionKeyParameterNames');
