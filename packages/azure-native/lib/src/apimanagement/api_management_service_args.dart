...
class ApiManagementServiceArgs {
  ...
  ApiManagementServiceArgs({
    ...
    bool? restore,
    String? serviceName,
    required ApiManagementServiceSkuProperties sku,
  ...
  factory ApiManagementServiceArgs.fromMap(Map<String, dynamic> map) {
    return ApiManagementServiceArgs(
      additionalLocations: map['additionalLocations'] == null ? null : pulumi.Input.decodeList<AdditionalLocation>(map['additionalLocations'], (value) => AdditionalLocation.fromMap((value as Map).cast<String, dynamic>())),
      apiVersionConstraint: map['apiVersionConstraint'] == null ? null : ApiVersionConstraint.fromMap((map['apiVersionConstraint'] as Map).cast<String, dynamic>()),
      certificates: map['certificates'] == null ? null : pulumi.Input.decodeList<CertificateConfiguration>(map['certificates'], (value) => CertificateConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      hostnameConfigurations: map['hostnameConfigurations'] == null ? null : pulumi.Input.decodeList<HostnameConfiguration>(map['hostnameConfigurations'], (value) => HostnameConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      identity: map['identity'] == null ? null : ApiManagementServiceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      privateEndpointConnections: map['privateEndpointConnections'] == null ? null : pulumi.Input.decodeList<RemotePrivateEndpointConnectionWrapper>(map['privateEndpointConnections'], (value) => RemotePrivateEndpointConnectionWrapper.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sku: ApiManagementServiceSkuProperties.fromMap((map['sku'] as Map).cast<String, dynamic>()),
