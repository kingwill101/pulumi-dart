...
/// {@template pulumi_apimanagement_workspace_logger_args_doc}
/// The set of arguments for WorkspaceLogger.
/// {@endtemplate}
/// {@macro pulumi_apimanagement_workspace_logger_args_doc}
class WorkspaceLoggerArgs {
  ...
  /// Creates a new [WorkspaceLoggerArgs].
  ...
  factory WorkspaceLoggerArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceLoggerArgs(
      ...
      loggerId: map['loggerId'] == null ? null : map['loggerId'] as String,
