...
class VirtualMachineResourceNames {
  ...
  final List<NetworkInterfaceResourceNames>? networkInterfaces;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'hostName': ?hostName,
      'networkInterfaces': ?networkInterfaces == null ? null : pulumi.Input.encodeList<NetworkInterfaceResourceNames, Map<String, dynamic>>(networkInterfaces!, (value) => value.toMap()),
  ...
  factory VirtualMachineResourceNames.fromMap(Map<String, dynamic> map) {
    return VirtualMachineResourceNames(
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<NetworkInterfaceResourceNames>(map['networkInterfaces'], (value) => NetworkInterfaceResourceNames.fromMap((value as Map).cast<String, dynamic>())),
