...
class OSProfile {
  ...
  final LinuxConfiguration? osConfiguration;
  ...
  factory OSProfile.fromMap(Map<String, dynamic> map) {
    return OSProfile(
      ...
      osConfiguration: map['osConfiguration'] == null ? null : LinuxConfiguration.fromMap((map['osConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
