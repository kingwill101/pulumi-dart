...
class OSProfileResponse {
  ...
  final LinuxConfigurationResponse? osConfiguration;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'osConfiguration': ?osConfiguration == null ? null : osConfiguration!.toMap(),
    };
  }
  ...
  factory OSProfileResponse.fromMap(Map<String, dynamic> map) {
    return OSProfileResponse(
      ...
      osConfiguration: map['osConfiguration'] == null ? null : LinuxConfigurationResponse.fromMap((map['osConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
