...
class GetIscsiTargetResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'endpoints': ?endpoints,
      'id': id,
      'luns': ?luns == null ? null : pulumi.Input.encodeList<IscsiLunResponse, Map<String, dynamic>>(luns!, (value) => value.toMap()),
      'managedBy': managedBy,
      ...
      'sessions': sessions,
      'staticAcls': ?staticAcls == null ? null : pulumi.Input.encodeList<AclResponse, Map<String, dynamic>>(staticAcls!, (value) => value.toMap()),
      'status': status,
  ...
  factory GetIscsiTargetResult.fromMap(Map<String, dynamic> map) {
    return GetIscsiTargetResult(
      ...
      id: map['id'] as String,
      luns: map['luns'] == null ? null : pulumi.Input.decodeList<IscsiLunResponse>(map['luns'], (value) => IscsiLunResponse.fromMap((value as Map).cast<String, dynamic>())),
      ...
      staticAcls: map['staticAcls'] == null ? null : pulumi.Input.decodeList<AclResponse>(map['staticAcls'], (value) => AclResponse.fromMap((value as Map).cast<String, dynamic>())),
