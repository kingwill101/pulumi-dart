...
class GalleryImageArgs {
  ...
  factory GalleryImageArgs.fromMap(Map<String, dynamic> map) {
    return GalleryImageArgs(
      ...
      galleryImageName: map['galleryImageName'] == null ? null : map['galleryImageName'] as String,
      hyperVGeneration: map['hyperVGeneration'] == null ? null : map['hyperVGeneration'] as String,
      identifier: map['identifier'] == null ? null : GalleryImageIdentifier.fromMap((map['identifier'] as Map).cast<String, dynamic>()),
      imagePath: map['imagePath'] == null ? null : map['imagePath'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      osType: map['osType'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sourceVirtualMachineId: map['sourceVirtualMachineId'] == null ? null : map['sourceVirtualMachineId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      version: map['version'] == null ? null : GalleryImageVersion.fromMap((map['version'] as Map).cast<String, dynamic>()),
    );
  }
}
