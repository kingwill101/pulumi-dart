...
class LogicalNetworkArgs {
  ...
  factory LogicalNetworkArgs.fromMap(Map<String, dynamic> map) {
    return LogicalNetworkArgs(
      dhcpOptions: map['dhcpOptions'] == null ? null : LogicalNetworkPropertiesDhcpOptions.fromMap((map['dhcpOptions'] as Map).cast<String, dynamic>()),
      ...
      logicalNetworkName: map['logicalNetworkName'] == null ? null : map['logicalNetworkName'] as String,
