...
class AssociatedTenantArgs {
  ...
  AssociatedTenantArgs({
    ...
    AssociatedTenantProperties? properties,
  ...
  factory AssociatedTenantArgs.fromMap(Map<String, dynamic> map) {
    return AssociatedTenantArgs(
      associatedTenantName: map['associatedTenantName'] == null ? null : map['associatedTenantName'] as String,
      billingAccountName: map['billingAccountName'] as String,
      properties: map['properties'] == null ? null : AssociatedTenantProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
