...
class InvoiceSectionArgs {
  ...
  factory InvoiceSectionArgs.fromMap(Map<String, dynamic> map) {
    return InvoiceSectionArgs(
      ...
      invoiceSectionName: map['invoiceSectionName'] == null ? null : map['invoiceSectionName'] as String,
      properties: map['properties'] == null ? null : InvoiceSectionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
