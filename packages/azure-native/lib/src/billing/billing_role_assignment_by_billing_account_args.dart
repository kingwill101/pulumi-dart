...
class BillingRoleAssignmentByBillingAccountArgs {
  ...
  factory BillingRoleAssignmentByBillingAccountArgs.fromMap(Map<String, dynamic> map) {
    return BillingRoleAssignmentByBillingAccountArgs(
      ...
      billingRoleAssignmentName: map['billingRoleAssignmentName'] == null ? null : map['billingRoleAssignmentName'] as String,
      properties: map['properties'] == null ? null : BillingRoleAssignmentProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
