...
/// Result data returned by getBillingRoleAssignmentByDepartment.
class GetBillingRoleAssignmentByDepartmentResult {
  ...
  /// Creates a new [GetBillingRoleAssignmentByDepartmentResult].
  ...
  factory GetBillingRoleAssignmentByDepartmentResult.fromMap(Map<String, dynamic> map) {
