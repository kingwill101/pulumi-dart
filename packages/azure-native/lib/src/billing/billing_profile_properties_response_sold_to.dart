...
class BillingProfilePropertiesResponseSoldTo {
  /// Address line 1.
  ...
  /// Creates a new [BillingProfilePropertiesResponseSoldTo].
  ...
  factory BillingProfilePropertiesResponseSoldTo.fromMap(Map<String, dynamic> map) {
    return BillingProfilePropertiesResponseSoldTo(
