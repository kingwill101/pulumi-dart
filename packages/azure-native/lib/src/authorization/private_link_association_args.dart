...
class PrivateLinkAssociationArgs {
  ...
  PrivateLinkAssociationArgs({
    ...
    String? plaId,
    PrivateLinkAssociationProperties? properties,
  }) :
  ...
  factory PrivateLinkAssociationArgs.fromMap(Map<String, dynamic> map) {
    return PrivateLinkAssociationArgs(
      ...
      plaId: map['plaId'] == null ? null : map['plaId'] as String,
      properties: map['properties'] == null ? null : PrivateLinkAssociationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
    );
  }
}
