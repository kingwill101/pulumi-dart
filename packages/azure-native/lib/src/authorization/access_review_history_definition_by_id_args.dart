...
class AccessReviewHistoryDefinitionByIdArgs {
  ...
  factory AccessReviewHistoryDefinitionByIdArgs.fromMap(Map<String, dynamic> map) {
    return AccessReviewHistoryDefinitionByIdArgs(
      ...
      historyDefinitionId: map['historyDefinitionId'] == null ? null : map['historyDefinitionId'] as String,
      instances: map['instances'] == null ? null : pulumi.Input.decodeList<AccessReviewHistoryInstance>(map['instances'], (value) => AccessReviewHistoryInstance.fromMap((value as Map).cast<String, dynamic>())),
      interval: map['interval'] == null ? null : map['interval'] as int,
      range: map['range'] == null ? null : AccessReviewRecurrenceRange.fromMap((map['range'] as Map).cast<String, dynamic>()),
      scopes: map['scopes'] == null ? null : pulumi.Input.decodeList<AccessReviewScope>(map['scopes'], (value) => AccessReviewScope.fromMap((value as Map).cast<String, dynamic>())),
