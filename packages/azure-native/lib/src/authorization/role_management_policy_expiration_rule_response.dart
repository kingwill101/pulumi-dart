...
class RoleManagementPolicyExpirationRuleResponse {
  ...
  final List<UserSetResponse>? exceptionMembers;
  /// The id of the rule.
  final String? id;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'exceptionMembers': ?exceptionMembers == null ? null : pulumi.Input.encodeList<UserSetResponse, Map<String, dynamic>>(exceptionMembers!, (value) => value.toMap()),
      'id': ?id,
  ...
  factory RoleManagementPolicyExpirationRuleResponse.fromMap(Map<String, dynamic> map) {
    return RoleManagementPolicyExpirationRuleResponse(
      exceptionMembers: map['exceptionMembers'] == null ? null : pulumi.Input.decodeList<UserSetResponse>(map['exceptionMembers'], (value) => UserSetResponse.fromMap((value as Map).cast<String, dynamic>())),
