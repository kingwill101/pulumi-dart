...
class VariableArgs {
  ...
  VariableArgs({
    required List<PolicyVariableColumn> columns,
    String? variableName,
  }) :
  ...
  factory VariableArgs.fromMap(Map<String, dynamic> map) {
    return VariableArgs(
      columns: pulumi.Input.decodeList<PolicyVariableColumn>(map['columns'], (value) => PolicyVariableColumn.fromMap((value as Map).cast<String, dynamic>())),
