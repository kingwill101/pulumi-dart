...
class HuntArgs {
  ...
  factory HuntArgs.fromMap(Map<String, dynamic> map) {
    return HuntArgs(
      ...
      huntId: map['huntId'] == null ? null : map['huntId'] as String,
      ...
      owner: map['owner'] == null ? null : HuntOwner.fromMap((map['owner'] as Map).cast<String, dynamic>()),
