...
class AlertDetailsOverride {
  ...
  final List<AlertPropertyMapping>? alertDynamicProperties;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'alertDynamicProperties': ?alertDynamicProperties == null ? null : pulumi.Input.encodeList<AlertPropertyMapping, Map<String, dynamic>>(alertDynamicProperties!, (value) => value.toMap()),
  ...
  factory AlertDetailsOverride.fromMap(Map<String, dynamic> map) {
    return AlertDetailsOverride(
      ...
      alertDynamicProperties: map['alertDynamicProperties'] == null ? null : pulumi.Input.decodeList<AlertPropertyMapping>(map['alertDynamicProperties'], (value) => AlertPropertyMapping.fromMap((value as Map).cast<String, dynamic>())),
