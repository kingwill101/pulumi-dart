...
class BookmarkArgs {
  ...
  factory BookmarkArgs.fromMap(Map<String, dynamic> map) {
    return BookmarkArgs(
      bookmarkId: map['bookmarkId'] == null ? null : map['bookmarkId'] as String,
      created: map['created'] == null ? null : map['created'] as String,
      createdBy: map['createdBy'] == null ? null : UserInfo.fromMap((map['createdBy'] as Map).cast<String, dynamic>()),
      displayName: map['displayName'] as String,
      eventTime: map['eventTime'] == null ? null : map['eventTime'] as String,
      incidentInfo: map['incidentInfo'] == null ? null : IncidentInfo.fromMap((map['incidentInfo'] as Map).cast<String, dynamic>()),
      ...
      updatedBy: map['updatedBy'] == null ? null : UserInfo.fromMap((map['updatedBy'] as Map).cast<String, dynamic>()),
