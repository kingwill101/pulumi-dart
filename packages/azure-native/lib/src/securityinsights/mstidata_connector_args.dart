...
class MSTIDataConnectorArgs {
  ...
  MSTIDataConnectorArgs({
    ...
    required MSTIDataConnectorDataTypes dataTypes,
    ...
    required String workspaceName,
      ...
      dataTypes = pulumi.Input.asInput<MSTIDataConnectorDataTypes>(dataTypes),
  ...
  factory MSTIDataConnectorArgs.fromMap(Map<String, dynamic> map) {
    return MSTIDataConnectorArgs(
      ...
      dataTypes: MSTIDataConnectorDataTypes.fromMap((map['dataTypes'] as Map).cast<String, dynamic>()),
