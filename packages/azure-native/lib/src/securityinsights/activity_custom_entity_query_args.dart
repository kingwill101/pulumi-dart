...
class ActivityCustomEntityQueryArgs {
  ...
  factory ActivityCustomEntityQueryArgs.fromMap(Map<String, dynamic> map) {
    return ActivityCustomEntityQueryArgs(
      ...
      entityQueryId: map['entityQueryId'] == null ? null : map['entityQueryId'] as String,
      inputEntityType: map['inputEntityType'] == null ? null : map['inputEntityType'] as String,
      kind: map['kind'] as String,
      queryDefinitions: map['queryDefinitions'] == null ? null : ActivityEntityQueriesPropertiesQueryDefinitions.fromMap((map['queryDefinitions'] as Map).cast<String, dynamic>()),
