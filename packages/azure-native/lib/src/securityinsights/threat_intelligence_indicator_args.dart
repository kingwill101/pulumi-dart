...
class ThreatIntelligenceIndicatorArgs {
  ...
  ThreatIntelligenceIndicatorArgs({
    ...
    dynamic extensions,
    String? externalId,
    String? externalLastUpdatedTimeUtc,
    ...
    bool? revoked,
    String? source,
    List<String>? threatIntelligenceTags,
  ...
  factory ThreatIntelligenceIndicatorArgs.fromMap(Map<String, dynamic> map) {
    return ThreatIntelligenceIndicatorArgs(
      ...
      createdByRef: map['createdByRef'] == null ? null : map['createdByRef'] as String,
      defanged: map['defanged'] == null ? null : map['defanged'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      extensions: map['extensions'] == null ? null : map['extensions'],
      externalId: map['externalId'] == null ? null : map['externalId'] as String,
      externalLastUpdatedTimeUtc: map['externalLastUpdatedTimeUtc'] == null ? null : map['externalLastUpdatedTimeUtc'] as String,
      externalReferences: map['externalReferences'] == null ? null : pulumi.Input.decodeList<ThreatIntelligenceExternalReference>(map['externalReferences'], (value) => ThreatIntelligenceExternalReference.fromMap((value as Map).cast<String, dynamic>())),
      granularMarkings: map['granularMarkings'] == null ? null : pulumi.Input.decodeList<ThreatIntelligenceGranularMarkingModel>(map['granularMarkings'], (value) => ThreatIntelligenceGranularMarkingModel.fromMap((value as Map).cast<String, dynamic>())),
      indicatorTypes: map['indicatorTypes'] == null ? null : (map['indicatorTypes'] as List).cast<String>(),
      killChainPhases: map['killChainPhases'] == null ? null : pulumi.Input.decodeList<ThreatIntelligenceKillChainPhase>(map['killChainPhases'], (value) => ThreatIntelligenceKillChainPhase.fromMap((value as Map).cast<String, dynamic>())),
      ...
      modified: map['modified'] == null ? null : map['modified'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      objectMarkingRefs: map['objectMarkingRefs'] == null ? null : (map['objectMarkingRefs'] as List).cast<String>(),
      parsedPattern: map['parsedPattern'] == null ? null : pulumi.Input.decodeList<ThreatIntelligenceParsedPattern>(map['parsedPattern'], (value) => ThreatIntelligenceParsedPattern.fromMap((value as Map).cast<String, dynamic>())),
      pattern: map['pattern'] == null ? null : map['pattern'] as String,
      patternType: map['patternType'] == null ? null : map['patternType'] as String,
      patternVersion: map['patternVersion'] == null ? null : map['patternVersion'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      revoked: map['revoked'] == null ? null : map['revoked'] as bool,
      source: map['source'] == null ? null : map['source'] as String,
      threatIntelligenceTags: map['threatIntelligenceTags'] == null ? null : (map['threatIntelligenceTags'] as List).cast<String>(),
      threatTypes: map['threatTypes'] == null ? null : (map['threatTypes'] as List).cast<String>(),
