...
class HealthModel extends pulumi.CustomResource {
  ...
  /// [args] Arguments used to configure this [HealthModel]. {@macro pulumi_cloudhealth_health_model_args_doc}
  ...
  HealthModel(
    ...
    this.properties = registerOutput<HealthModelPropertiesResponse>('properties');
