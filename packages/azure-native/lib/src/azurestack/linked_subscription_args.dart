...
class LinkedSubscriptionArgs {
  ...
  LinkedSubscriptionArgs({
    required String linkedSubscriptionId,
    String? linkedSubscriptionName,
    String? location,
    required String registrationResourceId,
  ...
  factory LinkedSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return LinkedSubscriptionArgs(
      linkedSubscriptionId: map['linkedSubscriptionId'] as String,
      linkedSubscriptionName: map['linkedSubscriptionName'] == null ? null : map['linkedSubscriptionName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      registrationResourceId: map['registrationResourceId'] as String,
