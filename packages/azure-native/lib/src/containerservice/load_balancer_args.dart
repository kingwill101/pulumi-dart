...
class LoadBalancerArgs {
  ...
  LoadBalancerArgs({
    ...
    required String primaryAgentPoolName,
  ...
  factory LoadBalancerArgs.fromMap(Map<String, dynamic> map) {
    return LoadBalancerArgs(
      ...
      nodeSelector: map['nodeSelector'] == null ? null : LabelSelector.fromMap((map['nodeSelector'] as Map).cast<String, dynamic>()),
      primaryAgentPoolName: map['primaryAgentPoolName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      resourceName: map['resourceName'] as String,
      serviceLabelSelector: map['serviceLabelSelector'] == null ? null : LabelSelector.fromMap((map['serviceLabelSelector'] as Map).cast<String, dynamic>()),
      serviceNamespaceSelector: map['serviceNamespaceSelector'] == null ? null : LabelSelector.fromMap((map['serviceNamespaceSelector'] as Map).cast<String, dynamic>()),
    );
  }
}
