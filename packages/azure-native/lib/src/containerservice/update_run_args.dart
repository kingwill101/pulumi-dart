...
class UpdateRunArgs {
  ...
  UpdateRunArgs({
    ...
    required ManagedClusterUpdate managedClusterUpdate,
  ...
  factory UpdateRunArgs.fromMap(Map<String, dynamic> map) {
    return UpdateRunArgs(
      ...
      managedClusterUpdate: ManagedClusterUpdate.fromMap((map['managedClusterUpdate'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      strategy: map['strategy'] == null ? null : UpdateRunStrategy.fromMap((map['strategy'] as Map).cast<String, dynamic>()),
