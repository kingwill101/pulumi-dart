...
class UpdateStage {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'groups': ?groups == null ? null : pulumi.Input.encodeList<UpdateGroup, Map<String, dynamic>>(groups!, (value) => value.toMap()),
      'name': name,
    };
  }
  ...
  factory UpdateStage.fromMap(Map<String, dynamic> map) {
    return UpdateStage(
      ...
      groups: map['groups'] == null ? null : pulumi.Input.decodeList<UpdateGroup>(map['groups'], (value) => UpdateGroup.fromMap((value as Map).cast<String, dynamic>())),
