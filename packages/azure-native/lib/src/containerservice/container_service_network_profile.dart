...
class ContainerServiceNetworkProfile {
  ...
  final AdvancedNetworking? advancedNetworking;
  ...
  final ManagedClusterLoadBalancerProfile? loadBalancerProfile;
  ...
  final ManagedClusterNATGatewayProfile? natGatewayProfile;
  ...
  final ManagedClusterStaticEgressGatewayProfile? staticEgressGatewayProfile;
  ...
  factory ContainerServiceNetworkProfile.fromMap(Map<String, dynamic> map) {
    return ContainerServiceNetworkProfile(
      advancedNetworking: map['advancedNetworking'] == null ? null : AdvancedNetworking.fromMap((map['advancedNetworking'] as Map).cast<String, dynamic>()),
      ...
      loadBalancerProfile: map['loadBalancerProfile'] == null ? null : ManagedClusterLoadBalancerProfile.fromMap((map['loadBalancerProfile'] as Map).cast<String, dynamic>()),
      loadBalancerSku: map['loadBalancerSku'] == null ? null : map['loadBalancerSku'] as String,
      natGatewayProfile: map['natGatewayProfile'] == null ? null : ManagedClusterNATGatewayProfile.fromMap((map['natGatewayProfile'] as Map).cast<String, dynamic>()),
      ...
      staticEgressGatewayProfile: map['staticEgressGatewayProfile'] == null ? null : ManagedClusterStaticEgressGatewayProfile.fromMap((map['staticEgressGatewayProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
