...
class NodeCustomizationProperties {
  ...
  final List<NodeCustomizationScript>? customizationScripts;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customizationScripts': ?customizationScripts == null ? null : pulumi.Input.encodeList<NodeCustomizationScript, Map<String, dynamic>>(customizationScripts!, (value) => value.toMap()),
    };
  }
  ...
  factory NodeCustomizationProperties.fromMap(Map<String, dynamic> map) {
    return NodeCustomizationProperties(
      ...
      customizationScripts: map['customizationScripts'] == null ? null : pulumi.Input.decodeList<NodeCustomizationScript>(map['customizationScripts'], (value) => NodeCustomizationScript.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
