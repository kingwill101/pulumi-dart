...
class ManagedClusterWindowsProfile {
  ...
  final WindowsGmsaProfile? gmsaProfile;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'gmsaProfile': ?gmsaProfile == null ? null : gmsaProfile!.toMap(),
  ...
  factory ManagedClusterWindowsProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterWindowsProfile(
      ...
      gmsaProfile: map['gmsaProfile'] == null ? null : WindowsGmsaProfile.fromMap((map['gmsaProfile'] as Map).cast<String, dynamic>()),
