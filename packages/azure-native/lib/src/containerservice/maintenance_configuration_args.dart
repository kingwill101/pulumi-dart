...
class MaintenanceConfigurationArgs {
  ...
  factory MaintenanceConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return MaintenanceConfigurationArgs(
      ...
      notAllowedTime: map['notAllowedTime'] == null ? null : pulumi.Input.decodeList<TimeSpan>(map['notAllowedTime'], (value) => TimeSpan.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      resourceName: map['resourceName'] as String,
      timeInWeek: map['timeInWeek'] == null ? null : pulumi.Input.decodeList<TimeInWeek>(map['timeInWeek'], (value) => TimeInWeek.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
