...
class DeploymentSafeguard extends pulumi.CustomResource {
  ...
  DeploymentSafeguard(
    ...
    this.excludedNamespaces = registerOutput<List<String>?>('excludedNamespaces');
    this.level = registerOutput<String>('level');
    this.name = registerOutput<String>('name');
    this.provisioningState = registerOutput<String>('provisioningState');
    this.systemData = registerOutput<SystemDataResponse>('systemData');
    this.systemExcludedNamespaces = registerOutput<List<String>>('systemExcludedNamespaces');
