...
class ManagedClusterSecurityProfileResponse {
  ...
  final AzureKeyVaultKmsResponse? azureKeyVaultKms;
  ...
  final ManagedClusterSecurityProfileDefenderResponse? defender;
  /// Image Cleaner settings for the security profile.
  final ManagedClusterSecurityProfileImageCleanerResponse? imageCleaner;
  /// Workload identity settings for the security profile. Workload identity enables Kubernetes applications to access Azure cloud resources securely with Azure AD. See https://aka.ms/aks/wi for more details.
  final ManagedClusterSecurityProfileWorkloadIdentityResponse? workloadIdentity;
  ...
  factory ManagedClusterSecurityProfileResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterSecurityProfileResponse(
      azureKeyVaultKms: map['azureKeyVaultKms'] == null ? null : AzureKeyVaultKmsResponse.fromMap((map['azureKeyVaultKms'] as Map).cast<String, dynamic>()),
      customCATrustCertificates: map['customCATrustCertificates'] == null ? null : (map['customCATrustCertificates'] as List).cast<String>(),
      defender: map['defender'] == null ? null : ManagedClusterSecurityProfileDefenderResponse.fromMap((map['defender'] as Map).cast<String, dynamic>()),
      imageCleaner: map['imageCleaner'] == null ? null : ManagedClusterSecurityProfileImageCleanerResponse.fromMap((map['imageCleaner'] as Map).cast<String, dynamic>()),
      workloadIdentity: map['workloadIdentity'] == null ? null : ManagedClusterSecurityProfileWorkloadIdentityResponse.fromMap((map['workloadIdentity'] as Map).cast<String, dynamic>()),
    );
  }
}
