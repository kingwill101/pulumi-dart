...
class ManagedClusterAgentPoolProfile {
  ...
  final AgentPoolGatewayProfile? gatewayProfile;
  /// GPUInstanceProfile to be used to specify GPU MIG instance profile for supported GPU VM SKU.
  final String? gpuInstanceProfile;
  /// GPU settings for the Agent Pool.
  final GPUProfile? gpuProfile;
  ...
  final KubeletConfig? kubeletConfig;
  /// Determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage.
  final String? kubeletDiskType;
  /// The OS configuration of Linux agent nodes.
  final LinuxOSConfig? linuxOSConfig;
  /// Configures the per-node local DNS, with VnetDNS and KubeDNS overrides. LocalDNS helps improve performance and reliability of DNS resolution in an AKS cluster. For more details see aka.ms/aks/localdns.
  final LocalDNSProfile? localDNSProfile;
  ...
  final AgentPoolNetworkProfile? networkProfile;
  ...
  final AgentPoolSecurityProfile? securityProfile;
  ...
  final AgentPoolUpgradeSettings? upgradeSettings;
  /// The status of nodes in a VirtualMachines agent pool.
  final List<VirtualMachineNodes>? virtualMachineNodesStatus;
  /// Specifications on VirtualMachines agent pool.
  final VirtualMachinesProfile? virtualMachinesProfile;
  ...
  final AgentPoolWindowsProfile? windowsProfile;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'virtualMachineNodesStatus': ?virtualMachineNodesStatus == null ? null : pulumi.Input.encodeList<VirtualMachineNodes, Map<String, dynamic>>(virtualMachineNodesStatus!, (value) => value.toMap()),
  ...
  factory ManagedClusterAgentPoolProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterAgentPoolProfile(
      ...
      creationData: map['creationData'] == null ? null : CreationData.fromMap((map['creationData'] as Map).cast<String, dynamic>()),
      ...
      gatewayProfile: map['gatewayProfile'] == null ? null : AgentPoolGatewayProfile.fromMap((map['gatewayProfile'] as Map).cast<String, dynamic>()),
      gpuInstanceProfile: map['gpuInstanceProfile'] == null ? null : map['gpuInstanceProfile'] as String,
      gpuProfile: map['gpuProfile'] == null ? null : GPUProfile.fromMap((map['gpuProfile'] as Map).cast<String, dynamic>()),
      hostGroupID: map['hostGroupID'] == null ? null : map['hostGroupID'] as String,
      kubeletConfig: map['kubeletConfig'] == null ? null : KubeletConfig.fromMap((map['kubeletConfig'] as Map).cast<String, dynamic>()),
      kubeletDiskType: map['kubeletDiskType'] == null ? null : map['kubeletDiskType'] as String,
      linuxOSConfig: map['linuxOSConfig'] == null ? null : LinuxOSConfig.fromMap((map['linuxOSConfig'] as Map).cast<String, dynamic>()),
      localDNSProfile: map['localDNSProfile'] == null ? null : LocalDNSProfile.fromMap((map['localDNSProfile'] as Map).cast<String, dynamic>()),
      ...
      networkProfile: map['networkProfile'] == null ? null : AgentPoolNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
      ...
      powerState: map['powerState'] == null ? null : PowerState.fromMap((map['powerState'] as Map).cast<String, dynamic>()),
      ...
      securityProfile: map['securityProfile'] == null ? null : AgentPoolSecurityProfile.fromMap((map['securityProfile'] as Map).cast<String, dynamic>()),
      ...
      virtualMachineNodesStatus: map['virtualMachineNodesStatus'] == null ? null : pulumi.Input.decodeList<VirtualMachineNodes>(map['virtualMachineNodesStatus'], (value) => VirtualMachineNodes.fromMap((value as Map).cast<String, dynamic>())),
      virtualMachinesProfile: map['virtualMachinesProfile'] == null ? null : VirtualMachinesProfile.fromMap((map['virtualMachinesProfile'] as Map).cast<String, dynamic>()),
      vmSize: map['vmSize'] == null ? null : map['vmSize'] as String,
      vnetSubnetID: map['vnetSubnetID'] == null ? null : map['vnetSubnetID'] as String,
      windowsProfile: map['windowsProfile'] == null ? null : AgentPoolWindowsProfile.fromMap((map['windowsProfile'] as Map).cast<String, dynamic>()),
