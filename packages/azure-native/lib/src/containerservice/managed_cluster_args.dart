...
class ManagedClusterArgs {
  ...
  factory ManagedClusterArgs.fromMap(Map<String, dynamic> map) {
    return ManagedClusterArgs(
      aadProfile: map['aadProfile'] == null ? null : ManagedClusterAADProfile.fromMap((map['aadProfile'] as Map).cast<String, dynamic>()),
      addonProfiles: map['addonProfiles'] == null ? null : pulumi.Input.decodeMapValues<ManagedClusterAddonProfile>(map['addonProfiles'], (value) => ManagedClusterAddonProfile.fromMap((value as Map).cast<String, dynamic>())),
      agentPoolProfiles: map['agentPoolProfiles'] == null ? null : pulumi.Input.decodeList<ManagedClusterAgentPoolProfile>(map['agentPoolProfiles'], (value) => ManagedClusterAgentPoolProfile.fromMap((value as Map).cast<String, dynamic>())),
      aiToolchainOperatorProfile: map['aiToolchainOperatorProfile'] == null ? null : ManagedClusterAIToolchainOperatorProfile.fromMap((map['aiToolchainOperatorProfile'] as Map).cast<String, dynamic>()),
      apiServerAccessProfile: map['apiServerAccessProfile'] == null ? null : ManagedClusterAPIServerAccessProfile.fromMap((map['apiServerAccessProfile'] as Map).cast<String, dynamic>()),
      autoScalerProfile: map['autoScalerProfile'] == null ? null : ManagedClusterPropertiesAutoScalerProfile.fromMap((map['autoScalerProfile'] as Map).cast<String, dynamic>()),
      autoUpgradeProfile: map['autoUpgradeProfile'] == null ? null : ManagedClusterAutoUpgradeProfile.fromMap((map['autoUpgradeProfile'] as Map).cast<String, dynamic>()),
      azureMonitorProfile: map['azureMonitorProfile'] == null ? null : ManagedClusterAzureMonitorProfile.fromMap((map['azureMonitorProfile'] as Map).cast<String, dynamic>()),
      bootstrapProfile: map['bootstrapProfile'] == null ? null : ManagedClusterBootstrapProfile.fromMap((map['bootstrapProfile'] as Map).cast<String, dynamic>()),
      ...
      httpProxyConfig: map['httpProxyConfig'] == null ? null : ManagedClusterHTTPProxyConfig.fromMap((map['httpProxyConfig'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : ManagedClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      identityProfile: map['identityProfile'] == null ? null : pulumi.Input.decodeMapValues<UserAssignedIdentity>(map['identityProfile'], (value) => UserAssignedIdentity.fromMap((value as Map).cast<String, dynamic>())),
      ingressProfile: map['ingressProfile'] == null ? null : ManagedClusterIngressProfile.fromMap((map['ingressProfile'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      kubernetesVersion: map['kubernetesVersion'] == null ? null : map['kubernetesVersion'] as String,
      linuxProfile: map['linuxProfile'] == null ? null : ContainerServiceLinuxProfile.fromMap((map['linuxProfile'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      metricsProfile: map['metricsProfile'] == null ? null : ManagedClusterMetricsProfile.fromMap((map['metricsProfile'] as Map).cast<String, dynamic>()),
      networkProfile: map['networkProfile'] == null ? null : ContainerServiceNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
      nodeProvisioningProfile: map['nodeProvisioningProfile'] == null ? null : ManagedClusterNodeProvisioningProfile.fromMap((map['nodeProvisioningProfile'] as Map).cast<String, dynamic>()),
      nodeResourceGroup: map['nodeResourceGroup'] == null ? null : map['nodeResourceGroup'] as String,
      nodeResourceGroupProfile: map['nodeResourceGroupProfile'] == null ? null : ManagedClusterNodeResourceGroupProfile.fromMap((map['nodeResourceGroupProfile'] as Map).cast<String, dynamic>()),
      oidcIssuerProfile: map['oidcIssuerProfile'] == null ? null : ManagedClusterOIDCIssuerProfile.fromMap((map['oidcIssuerProfile'] as Map).cast<String, dynamic>()),
      podIdentityProfile: map['podIdentityProfile'] == null ? null : ManagedClusterPodIdentityProfile.fromMap((map['podIdentityProfile'] as Map).cast<String, dynamic>()),
      privateLinkResources: map['privateLinkResources'] == null ? null : pulumi.Input.decodeList<PrivateLinkResource>(map['privateLinkResources'], (value) => PrivateLinkResource.fromMap((value as Map).cast<String, dynamic>())),
      publicNetworkAccess: map['publicNetworkAccess'] == null ? null : map['publicNetworkAccess'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      resourceName: map['resourceName'] == null ? null : map['resourceName'] as String,
      securityProfile: map['securityProfile'] == null ? null : ManagedClusterSecurityProfile.fromMap((map['securityProfile'] as Map).cast<String, dynamic>()),
      serviceMeshProfile: map['serviceMeshProfile'] == null ? null : ServiceMeshProfile.fromMap((map['serviceMeshProfile'] as Map).cast<String, dynamic>()),
      servicePrincipalProfile: map['servicePrincipalProfile'] == null ? null : ManagedClusterServicePrincipalProfile.fromMap((map['servicePrincipalProfile'] as Map).cast<String, dynamic>()),
      sku: map['sku'] == null ? null : ManagedClusterSKU.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      storageProfile: map['storageProfile'] == null ? null : ManagedClusterStorageProfile.fromMap((map['storageProfile'] as Map).cast<String, dynamic>()),
      supportPlan: map['supportPlan'] == null ? null : map['supportPlan'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradeSettings: map['upgradeSettings'] == null ? null : ClusterUpgradeSettings.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>()),
      windowsProfile: map['windowsProfile'] == null ? null : ManagedClusterWindowsProfile.fromMap((map['windowsProfile'] as Map).cast<String, dynamic>()),
      workloadAutoScalerProfile: map['workloadAutoScalerProfile'] == null ? null : ManagedClusterWorkloadAutoScalerProfile.fromMap((map['workloadAutoScalerProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
