...
class ManagedClusterPropertiesAutoScalerProfile {
  ...
  final String? balanceSimilarNodeGroups;
  ...
  final bool? daemonsetEvictionForEmptyNodes;
  /// DaemonSet pods will be gracefully terminated from non-empty nodes. If set to true, all daemonset pods on occupied nodes will be evicted before deletion of the node. If the daemonset pod cannot be evicted another node will be chosen for scaling. If set to false, the node will be deleted without ensuring that daemonset pods are deleted or evicted.
  final bool? daemonsetEvictionForOccupiedNodes;
  ...
  final String? maxNodeProvisionTime;
  ...
  final String? maxTotalUnreadyPercentage;
  ...
  final String? okTotalUnreadyCount;
  ...
  final String? scaleDownUnreadyTime;
  ...
  final String? skipNodesWithLocalStorage;
  ...
  final String? skipNodesWithSystemPods;
  ...
  factory ManagedClusterPropertiesAutoScalerProfile.fromMap(Map<String, dynamic> map) {
    return ManagedClusterPropertiesAutoScalerProfile(
      balanceSimilarNodeGroups: map['balanceSimilarNodeGroups'] == null ? null : map['balanceSimilarNodeGroups'] as String,
      daemonsetEvictionForEmptyNodes: map['daemonsetEvictionForEmptyNodes'] == null ? null : map['daemonsetEvictionForEmptyNodes'] as bool,
      daemonsetEvictionForOccupiedNodes: map['daemonsetEvictionForOccupiedNodes'] == null ? null : map['daemonsetEvictionForOccupiedNodes'] as bool,
      expander: map['expander'] == null ? null : map['expander'] as String,
      ignoreDaemonsetsUtilization: map['ignoreDaemonsetsUtilization'] == null ? null : map['ignoreDaemonsetsUtilization'] as bool,
      maxEmptyBulkDelete: map['maxEmptyBulkDelete'] == null ? null : map['maxEmptyBulkDelete'] as String,
      maxGracefulTerminationSec: map['maxGracefulTerminationSec'] == null ? null : map['maxGracefulTerminationSec'] as String,
      maxNodeProvisionTime: map['maxNodeProvisionTime'] == null ? null : map['maxNodeProvisionTime'] as String,
      maxTotalUnreadyPercentage: map['maxTotalUnreadyPercentage'] == null ? null : map['maxTotalUnreadyPercentage'] as String,
      newPodScaleUpDelay: map['newPodScaleUpDelay'] == null ? null : map['newPodScaleUpDelay'] as String,
      okTotalUnreadyCount: map['okTotalUnreadyCount'] == null ? null : map['okTotalUnreadyCount'] as String,
      ...
      scaleDownUnreadyTime: map['scaleDownUnreadyTime'] == null ? null : map['scaleDownUnreadyTime'] as String,
      ...
      skipNodesWithLocalStorage: map['skipNodesWithLocalStorage'] == null ? null : map['skipNodesWithLocalStorage'] as String,
      skipNodesWithSystemPods: map['skipNodesWithSystemPods'] == null ? null : map['skipNodesWithSystemPods'] as String,
    );
  }
}
