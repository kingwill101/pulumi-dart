...
class ManagedClusterSecurityProfileDefenderResponse {
  ...
  final ManagedClusterSecurityProfileDefenderSecurityMonitoringResponse? securityMonitoring;
  ...
  factory ManagedClusterSecurityProfileDefenderResponse.fromMap(Map<String, dynamic> map) {
    return ManagedClusterSecurityProfileDefenderResponse(
      ...
      securityMonitoring: map['securityMonitoring'] == null ? null : ManagedClusterSecurityProfileDefenderSecurityMonitoringResponse.fromMap((map['securityMonitoring'] as Map).cast<String, dynamic>()),
    );
  }
}
