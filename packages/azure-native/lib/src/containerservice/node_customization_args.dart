...
class NodeCustomizationArgs {
  ...
  factory NodeCustomizationArgs.fromMap(Map<String, dynamic> map) {
    return NodeCustomizationArgs(
      ...
      nodeCustomizationName: map['nodeCustomizationName'] == null ? null : map['nodeCustomizationName'] as String,
      properties: map['properties'] == null ? null : NodeCustomizationProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
