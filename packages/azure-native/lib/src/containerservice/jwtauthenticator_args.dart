...
class JWTAuthenticatorArgs {
  ...
  JWTAuthenticatorArgs({
    ...
    required JWTAuthenticatorProperties properties,
  ...
  factory JWTAuthenticatorArgs.fromMap(Map<String, dynamic> map) {
    return JWTAuthenticatorArgs(
      jwtAuthenticatorName: map['jwtAuthenticatorName'] == null ? null : map['jwtAuthenticatorName'] as String,
      properties: JWTAuthenticatorProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
