...
class PlacementV1PlacementPolicyResponse {
  ...
  final PlacementV1AffinityResponse? affinity;
  ...
  final List<PlacementV1TolerationResponse>? tolerations;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'tolerations': ?tolerations == null ? null : pulumi.Input.encodeList<PlacementV1TolerationResponse, Map<String, dynamic>>(tolerations!, (value) => value.toMap()),
    };
  }

  factory PlacementV1PlacementPolicyResponse.fromMap(Map<String, dynamic> map) {
    return PlacementV1PlacementPolicyResponse(
      affinity: map['affinity'] == null ? null : PlacementV1AffinityResponse.fromMap((map['affinity'] as Map).cast<String, dynamic>()),
      ...
      tolerations: map['tolerations'] == null ? null : pulumi.Input.decodeList<PlacementV1TolerationResponse>(map['tolerations'], (value) => PlacementV1TolerationResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
