...
class WebChatChannelResponse {
  ...
  final WebChatChannelPropertiesResponse? properties;
  ...
  factory WebChatChannelResponse.fromMap(Map<String, dynamic> map) {
    return WebChatChannelResponse(
      ...
      properties: map['properties'] == null ? null : WebChatChannelPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
