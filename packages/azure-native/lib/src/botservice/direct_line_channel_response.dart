...
class DirectLineChannelResponse {
  ...
  final DirectLineChannelPropertiesResponse? properties;
  ...
  factory DirectLineChannelResponse.fromMap(Map<String, dynamic> map) {
    return DirectLineChannelResponse(
      ...
      properties: map['properties'] == null ? null : DirectLineChannelPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
