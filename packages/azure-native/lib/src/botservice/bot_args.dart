...
class BotArgs {
  ...
  BotArgs({
    ...
    Map<String, String>? tags,
      ...
      properties = pulumi.Input.asOptionalInput<BotProperties>(properties),
  ...
  factory BotArgs.fromMap(Map<String, dynamic> map) {
    return BotArgs(
      ...
      properties: map['properties'] == null ? null : BotProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
