...
class DeploymentStacksWhatIfResultsAtManagementGroupArgs {
  ...
  factory DeploymentStacksWhatIfResultsAtManagementGroupArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentStacksWhatIfResultsAtManagementGroupArgs(
      deploymentStacksWhatIfResultName: map['deploymentStacksWhatIfResultName'] == null ? null : map['deploymentStacksWhatIfResultName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      managementGroupId: map['managementGroupId'] as String,
      properties: map['properties'] == null ? null : DeploymentStacksWhatIfResultProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
