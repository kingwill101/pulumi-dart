...
/// {@template pulumi_resources_azure_power_shell_script_args_doc}
/// The set of arguments for AzurePowerShellScript.
/// {@endtemplate}
...
class AzurePowerShellScriptArgs {
  ...
  AzurePowerShellScriptArgs({
    String? arguments,
    required String azPowerShellVersion,
    ...
    String? timeout,
      ...
      azPowerShellVersion = pulumi.Input.asInput<String>(azPowerShellVersion),
  ...
  factory AzurePowerShellScriptArgs.fromMap(Map<String, dynamic> map) {
