...
class CustomPriceProperties {
  ...
  final List<CatalogClaimsItem> catalogClaims;
  ...
  final List<MarketSetPricesItems> marketSetPrices;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'catalogClaims': pulumi.Input.encodeList<CatalogClaimsItem, Map<String, dynamic>>(catalogClaims, (value) => value.toMap()),
      'catalogId': catalogId,
      'marketSetPrices': pulumi.Input.encodeList<MarketSetPricesItems, Map<String, dynamic>>(marketSetPrices, (value) => value.toMap()),
      'meterType': ?meterType,
      'ruleType': ruleType,
      'termUnits': ?termUnits,
    };
  ...
  factory CustomPriceProperties.fromMap(Map<String, dynamic> map) {
    return CustomPriceProperties(
      ...
      catalogClaims: pulumi.Input.decodeList<CatalogClaimsItem>(map['catalogClaims'], (value) => CatalogClaimsItem.fromMap((value as Map).cast<String, dynamic>())),
      catalogId: map['catalogId'] as String,
      marketSetPrices: pulumi.Input.decodeList<MarketSetPricesItems>(map['marketSetPrices'], (value) => MarketSetPricesItems.fromMap((value as Map).cast<String, dynamic>())),
