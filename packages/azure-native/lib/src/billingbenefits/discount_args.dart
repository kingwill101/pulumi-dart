...
class DiscountArgs {
  ...
  DiscountArgs({
    ...
    String? managedBy,
    Plan? plan,
    EntityTypeAffiliateDiscount? properties,
  ...
  factory DiscountArgs.fromMap(Map<String, dynamic> map) {
    return DiscountArgs(
      discountName: map['discountName'] == null ? null : map['discountName'] as String,
      ...
      properties: map['properties'] == null ? null : EntityTypeAffiliateDiscount.fromMap((map['properties'] as Map).cast<String, dynamic>()),
