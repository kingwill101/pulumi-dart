...
class PowerBIResourceArgs {
  ...
  PowerBIResourceArgs({
    ...
    String? location,
    List<PrivateEndpointConnectionPowerbi>? privateEndpointConnections,
  ...
  factory PowerBIResourceArgs.fromMap(Map<String, dynamic> map) {
    return PowerBIResourceArgs(
      ...
      privateEndpointConnections: map['privateEndpointConnections'] == null ? null : (map['privateEndpointConnections'] as List).cast<PrivateEndpointConnectionPowerbi>(),
