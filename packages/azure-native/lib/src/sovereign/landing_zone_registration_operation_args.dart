...
class LandingZoneRegistrationOperationArgs {
  ...
  factory LandingZoneRegistrationOperationArgs.fromMap(Map<String, dynamic> map) {
    return LandingZoneRegistrationOperationArgs(
      ...
      landingZoneRegistrationName: map['landingZoneRegistrationName'] == null ? null : map['landingZoneRegistrationName'] as String,
      properties: map['properties'] == null ? null : LandingZoneRegistrationResourceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
