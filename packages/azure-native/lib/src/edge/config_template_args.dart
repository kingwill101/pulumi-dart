...
class ConfigTemplateArgs {
  ...
  ConfigTemplateArgs({
    ...
    Map<String, String>? tags,
      ...
      configTemplateName = pulumi.Input.asOptionalInput<String>(configTemplateName),
      location = pulumi.Input.asOptionalInput<String>(location),
      properties = pulumi.Input.asOptionalInput<ConfigTemplateProperties>(properties),
  ...
  factory ConfigTemplateArgs.fromMap(Map<String, dynamic> map) {
    return ConfigTemplateArgs(
      configTemplateName: map['configTemplateName'] == null ? null : map['configTemplateName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : ConfigTemplateProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
