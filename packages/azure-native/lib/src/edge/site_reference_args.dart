...
class SiteReferenceArgs {
  ...
  factory SiteReferenceArgs.fromMap(Map<String, dynamic> map) {
    return SiteReferenceArgs(
      ...
      properties: map['properties'] == null ? null : SiteReferenceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      siteReferenceName: map['siteReferenceName'] == null ? null : map['siteReferenceName'] as String,
    );
  }
}
