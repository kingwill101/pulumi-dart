...
class ContextArgs {
  ...
  factory ContextArgs.fromMap(Map<String, dynamic> map) {
    return ContextArgs(
      contextName: map['contextName'] == null ? null : map['contextName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : ContextProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
