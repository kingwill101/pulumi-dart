...
class ExecutionArgs {
  ...
  factory ExecutionArgs.fromMap(Map<String, dynamic> map) {
    return ExecutionArgs(
      ...
      executionName: map['executionName'] == null ? null : map['executionName'] as String,
      ...
      properties: map['properties'] == null ? null : ExecutionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
