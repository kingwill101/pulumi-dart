...
class DynamicConfigurationVersionArgs {
  ...
  DynamicConfigurationVersionArgs({
    ...
    String? dynamicConfigurationVersionName,
    DynamicConfigurationVersionProperties? properties,
  ...
  factory DynamicConfigurationVersionArgs.fromMap(Map<String, dynamic> map) {
    return DynamicConfigurationVersionArgs(
      ...
      dynamicConfigurationVersionName: map['dynamicConfigurationVersionName'] == null ? null : map['dynamicConfigurationVersionName'] as String,
      properties: map['properties'] == null ? null : DynamicConfigurationVersionProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
