...
class CacheNodesOperationArgs {
  ...
  CacheNodesOperationArgs({
    ...
    Map<String, String>? tags,
      ...
      properties = pulumi.Input.asOptionalInput<CacheNodeOldResponse>(properties),
  ...
  factory CacheNodesOperationArgs.fromMap(Map<String, dynamic> map) {
    return CacheNodesOperationArgs(
      ...
      properties: map['properties'] == null ? null : CacheNodeOldResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
