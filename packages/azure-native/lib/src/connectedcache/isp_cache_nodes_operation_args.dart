...
class IspCacheNodesOperationArgs {
  ...
  factory IspCacheNodesOperationArgs.fromMap(Map<String, dynamic> map) {
    return IspCacheNodesOperationArgs(
      cacheNodeResourceName: map['cacheNodeResourceName'] == null ? null : map['cacheNodeResourceName'] as String,
      customerResourceName: map['customerResourceName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : CacheNodeProperty.fromMap((map['properties'] as Map).cast<String, dynamic>()),
