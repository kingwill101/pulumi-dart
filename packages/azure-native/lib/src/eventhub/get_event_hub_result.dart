...
class GetEventHubResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'captureDescription': ?captureDescription == null ? null : captureDescription!.toMap(),
      'createdAt': createdAt,
      'id': id,
      'location': location,
      ...
      'retentionDescription': ?retentionDescription == null ? null : retentionDescription!.toMap(),
      'status': ?status,
