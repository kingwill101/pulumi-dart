...
class SchemaRegistryArgs {
  ...
  factory SchemaRegistryArgs.fromMap(Map<String, dynamic> map) {
    return SchemaRegistryArgs(
      groupProperties: map['groupProperties'] == null ? null : (map['groupProperties'] as Map).cast<String, String>(),
      namespaceName: map['namespaceName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      schemaCompatibility: map['schemaCompatibility'] == null ? null : map['schemaCompatibility'] as String,
      schemaGroupName: map['schemaGroupName'] == null ? null : map['schemaGroupName'] as String,
