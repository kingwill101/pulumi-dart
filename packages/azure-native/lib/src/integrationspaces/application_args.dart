...
class ApplicationArgs {
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      ...
      trackingDataStores: map['trackingDataStores'] == null ? null : pulumi.Input.decodeMapValues<TrackingDataStore>(map['trackingDataStores'], (value) => TrackingDataStore.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
