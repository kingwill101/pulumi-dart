...
class NamespaceArgs {
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      networkAcls: map['networkAcls'] == null ? null : NetworkAcls.fromMap((map['networkAcls'] as Map).cast<String, dynamic>()),
      pnsCredentials: map['pnsCredentials'] == null ? null : PnsCredentials.fromMap((map['pnsCredentials'] as Map).cast<String, dynamic>()),
