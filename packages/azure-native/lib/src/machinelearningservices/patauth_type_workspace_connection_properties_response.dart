...
class PATAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final WorkspaceConnectionPersonalAccessTokenResponse? credentials;
  ...
  factory PATAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return PATAuthTypeWorkspaceConnectionPropertiesResponse(
      ...
      credentials: map['credentials'] == null ? null : WorkspaceConnectionPersonalAccessTokenResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
