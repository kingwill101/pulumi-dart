...
class DatasetCreateRequestTimeSeries {
  ...
  final String? coarseGrainTimestamp;
  /// Column name to be used as FineGrainTimestamp
  final String? fineGrainTimestamp;
  ...
  factory DatasetCreateRequestTimeSeries.fromMap(Map<String, dynamic> map) {
    return DatasetCreateRequestTimeSeries(
      coarseGrainTimestamp: map['coarseGrainTimestamp'] == null ? null : map['coarseGrainTimestamp'] as String,
      fineGrainTimestamp: map['fineGrainTimestamp'] == null ? null : map['fineGrainTimestamp'] as String,
    );
  }
}
