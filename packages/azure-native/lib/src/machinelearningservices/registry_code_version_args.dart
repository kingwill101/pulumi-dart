...
class RegistryCodeVersionArgs {
  ...
  RegistryCodeVersionArgs({
    ...
    required CodeVersionMachinelearningservices codeVersionProperties,
  ...
  factory RegistryCodeVersionArgs.fromMap(Map<String, dynamic> map) {
    return RegistryCodeVersionArgs(
      ...
      codeVersionProperties: map['codeVersionProperties'] as CodeVersionMachinelearningservices,
