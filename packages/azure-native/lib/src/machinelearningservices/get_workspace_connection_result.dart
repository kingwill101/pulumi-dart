...
/// Result data returned by getWorkspaceConnection.
class GetWorkspaceConnectionResult {
  ...
  /// Creates a new [GetWorkspaceConnectionResult].
  ...
  factory GetWorkspaceConnectionResult.fromMap(Map<String, dynamic> map) {
