...
class BatchDeploymentArgs {
  ...
  BatchDeploymentArgs({
    required BatchDeploymentMachinelearningservices batchDeploymentProperties,
  ...
  factory BatchDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return BatchDeploymentArgs(
      batchDeploymentProperties: map['batchDeploymentProperties'] as BatchDeploymentMachinelearningservices,
