...
class InferenceEndpointArgs {
  ...
  InferenceEndpointArgs({
    ...
    required InferenceEndpointMachinelearningservices inferenceEndpointProperties,
    String? kind,
    String? location,
  ...
  factory InferenceEndpointArgs.fromMap(Map<String, dynamic> map) {
    return InferenceEndpointArgs(
      ...
      inferenceEndpointProperties: map['inferenceEndpointProperties'] as InferenceEndpointMachinelearningservices,
