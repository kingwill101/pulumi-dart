...
import 'workspace_connection_personal_access_token.dart';
...
class PATAuthTypeWorkspaceConnectionProperties {
  ...
  final WorkspaceConnectionPersonalAccessToken? credentials;
  ...
  /// Creates a new [PATAuthTypeWorkspaceConnectionProperties].
  ...
  factory PATAuthTypeWorkspaceConnectionProperties.fromMap(Map<String, dynamic> map) {
    return PATAuthTypeWorkspaceConnectionProperties(
      authType: map['authType'] as String,
      category: map['category'] == null ? null : map['category'] as String,
      credentials: map['credentials'] == null ? null : WorkspaceConnectionPersonalAccessToken.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
