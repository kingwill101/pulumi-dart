...
class ImageClassification {
  ...
  final ImageModelSettingsClassification? modelSettings;
  /// Primary metric to optimize for this task.
  final String? primaryMetric;
  /// Search space for sampling different combinations of models and their hyperparameters.
  final List<ImageModelDistributionSettingsClassification>? searchSpace;
  ...
  /// Creates a new [ImageClassification].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'searchSpace': ?searchSpace == null ? null : pulumi.Input.encodeList<ImageModelDistributionSettingsClassification, Map<String, dynamic>>(searchSpace!, (value) => value.toMap()),
  ...
  factory ImageClassification.fromMap(Map<String, dynamic> map) {
    return ImageClassification(
      ...
      modelSettings: map['modelSettings'] == null ? null : ImageModelSettingsClassification.fromMap((map['modelSettings'] as Map).cast<String, dynamic>()),
      primaryMetric: map['primaryMetric'] == null ? null : map['primaryMetric'] as String,
      searchSpace: map['searchSpace'] == null ? null : pulumi.Input.decodeList<ImageModelDistributionSettingsClassification>(map['searchSpace'], (value) => ImageModelDistributionSettingsClassification.fromMap((value as Map).cast<String, dynamic>())),
