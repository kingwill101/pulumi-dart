...
class RegistryModelContainerArgs {
  ...
  RegistryModelContainerArgs({
    required ModelContainerMachinelearningservices modelContainerProperties,
    String? modelName,
  ...
  factory RegistryModelContainerArgs.fromMap(Map<String, dynamic> map) {
    return RegistryModelContainerArgs(
      modelContainerProperties: map['modelContainerProperties'] as ModelContainerMachinelearningservices,
