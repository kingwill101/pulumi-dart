...
class ComputeArgs {
  ...
  factory ComputeArgs.fromMap(Map<String, dynamic> map) {
    return ComputeArgs(
      computeName: map['computeName'] == null ? null : map['computeName'] as String,
      identity: map['identity'] == null ? null : ManagedServiceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : AKS.fromMap((map['properties'] as Map).cast<String, dynamic>()),
