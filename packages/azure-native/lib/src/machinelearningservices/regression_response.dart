...
class RegressionResponse {
  ...
  final RegressionTrainingSettingsResponse? trainingSettings;
  ...
  factory RegressionResponse.fromMap(Map<String, dynamic> map) {
    return RegressionResponse(
      ...
      trainingSettings: map['trainingSettings'] == null ? null : RegressionTrainingSettingsResponse.fromMap((map['trainingSettings'] as Map).cast<String, dynamic>()),
