...
/// Result data returned by getRegistryEnvironmentContainer.
class GetRegistryEnvironmentContainerResult {
  ...
  /// Creates a new [GetRegistryEnvironmentContainerResult].
  ...
  factory GetRegistryEnvironmentContainerResult.fromMap(Map<String, dynamic> map) {
