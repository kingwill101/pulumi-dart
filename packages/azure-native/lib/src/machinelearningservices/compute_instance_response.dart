...
class ComputeInstanceResponse {
  ...
  final ComputeInstancePropertiesResponse? properties;
  ...
  factory ComputeInstanceResponse.fromMap(Map<String, dynamic> map) {
    return ComputeInstanceResponse(
      ...
      properties: map['properties'] == null ? null : ComputeInstancePropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
