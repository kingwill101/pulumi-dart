...
class CapabilityHostArgs {
  ...
  CapabilityHostArgs({
    required CapabilityHostMachinelearningservices capabilityHostProperties,
    String? name,
  ...
  factory CapabilityHostArgs.fromMap(Map<String, dynamic> map) {
    return CapabilityHostArgs(
      capabilityHostProperties: map['capabilityHostProperties'] as CapabilityHostMachinelearningservices,
