...
class DataCollector {
  ...
  final RequestLogging? requestLogging;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'collections': pulumi.Input.encodeMapValues<Collection, Map<String, dynamic>>(collections, (value) => value.toMap()),
  ...
  factory DataCollector.fromMap(Map<String, dynamic> map) {
    return DataCollector(
      collections: pulumi.Input.decodeMapValues<Collection>(map['collections'], (value) => Collection.fromMap((value as Map).cast<String, dynamic>())),
      requestLogging: map['requestLogging'] == null ? null : RequestLogging.fromMap((map['requestLogging'] as Map).cast<String, dynamic>()),
      rollingRate: map['rollingRate'] == null ? null : map['rollingRate'] as String,
    );
  }
}
