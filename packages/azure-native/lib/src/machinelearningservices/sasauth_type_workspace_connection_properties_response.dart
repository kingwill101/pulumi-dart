...
import 'workspace_connection_shared_access_signature_response.dart';

class SASAuthTypeWorkspaceConnectionPropertiesResponse {
  ...
  final WorkspaceConnectionSharedAccessSignatureResponse? credentials;
  ...
  /// Creates a new [SASAuthTypeWorkspaceConnectionPropertiesResponse].
  ...
  factory SASAuthTypeWorkspaceConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return SASAuthTypeWorkspaceConnectionPropertiesResponse(
      authType: map['authType'] as String,
      category: map['category'] == null ? null : map['category'] as String,
      createdByWorkspaceArmId: map['createdByWorkspaceArmId'] as String,
      credentials: map['credentials'] == null ? null : WorkspaceConnectionSharedAccessSignatureResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
