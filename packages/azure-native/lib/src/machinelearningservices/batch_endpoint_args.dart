...
class BatchEndpointArgs {
  ...
  BatchEndpointArgs({
    required BatchEndpointMachinelearningservices batchEndpointProperties,
    String? endpointName,
  ...
  factory BatchEndpointArgs.fromMap(Map<String, dynamic> map) {
    return BatchEndpointArgs(
      batchEndpointProperties: map['batchEndpointProperties'] as BatchEndpointMachinelearningservices,
