...
class ConnectionDeploymentArgs {
  ...
  ConnectionDeploymentArgs({
    ...
    required ContentSafetyEndpointDeploymentResourceProperties properties,
  ...
  factory ConnectionDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionDeploymentArgs(
      ...
      properties: ContentSafetyEndpointDeploymentResourceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
