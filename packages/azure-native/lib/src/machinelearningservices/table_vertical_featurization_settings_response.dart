...
class TableVerticalFeaturizationSettingsResponse {
  ...
  final Map<String, List<ColumnTransformerResponse>>? transformerParams;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'mode': ?mode,
      'transformerParams': ?transformerParams == null ? null : pulumi.Input.encodeMapValues<List<ColumnTransformerResponse>, List<Map<String, dynamic>>>(transformerParams!, (value) => pulumi.Input.encodeList<ColumnTransformerResponse, Map<String, dynamic>>(value, (value) => value.toMap())),
    };
  }
  ...
  factory TableVerticalFeaturizationSettingsResponse.fromMap(Map<String, dynamic> map) {
    return TableVerticalFeaturizationSettingsResponse(
      ...
      transformerParams: map['transformerParams'] == null ? null : pulumi.Input.decodeMapValues<List<ColumnTransformerResponse>>(map['transformerParams'], (value) => pulumi.Input.decodeList<ColumnTransformerResponse>(value, (value) => ColumnTransformerResponse.fromMap((value as Map).cast<String, dynamic>()))),
    );
  }
}
