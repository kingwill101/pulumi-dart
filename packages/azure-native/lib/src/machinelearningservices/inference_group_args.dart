...
class InferenceGroupArgs {
  ...
  InferenceGroupArgs({
    ...
    required InferenceGroupMachinelearningservices inferenceGroupProperties,
    String? kind,
    String? location,
    ...
    required String workspaceName,
      ...
      inferenceGroupProperties = pulumi.Input.asInput<InferenceGroupMachinelearningservices>(inferenceGroupProperties),
  ...
  factory InferenceGroupArgs.fromMap(Map<String, dynamic> map) {
    return InferenceGroupArgs(
      ...
      inferenceGroupProperties: map['inferenceGroupProperties'] as InferenceGroupMachinelearningservices,
