...
class KubernetesResponse {
  ...
  final KubernetesPropertiesResponse? properties;
  ...
  factory KubernetesResponse.fromMap(Map<String, dynamic> map) {
    return KubernetesResponse(
      ...
      properties: map['properties'] == null ? null : KubernetesPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
