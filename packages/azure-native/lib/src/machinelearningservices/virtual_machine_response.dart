...
class VirtualMachineResponse {
  ...
  final VirtualMachineSchemaResponseProperties? properties;
  ...
  factory VirtualMachineResponse.fromMap(Map<String, dynamic> map) {
    return VirtualMachineResponse(
      ...
      properties: map['properties'] == null ? null : VirtualMachineSchemaResponseProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
