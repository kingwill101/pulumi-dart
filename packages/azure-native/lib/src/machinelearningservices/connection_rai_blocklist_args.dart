...
class ConnectionRaiBlocklistArgs {
  ...
  ConnectionRaiBlocklistArgs({
    required String connectionName,
    required RaiBlocklistProperties properties,
    ...
    required String workspaceName,
      ...
      properties = pulumi.Input.asInput<RaiBlocklistProperties>(properties),
  ...
  factory ConnectionRaiBlocklistArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionRaiBlocklistArgs(
      ...
      properties: RaiBlocklistProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      proxyApiVersion: map['proxyApiVersion'] == null ? null : map['proxyApiVersion'] as String,
      raiBlocklistName: map['raiBlocklistName'] == null ? null : map['raiBlocklistName'] as String,
