...
class MachineLearningDatasetArgs {
  ...
  MachineLearningDatasetArgs({
    ...
    required DatasetCreateRequestParameters parameters,
    required DatasetCreateRequestRegistration registration,
    required String resourceGroupName,
    bool? skipValidation,
    DatasetCreateRequestTimeSeries? timeSeries,
  ...
  factory MachineLearningDatasetArgs.fromMap(Map<String, dynamic> map) {
    return MachineLearningDatasetArgs(
      ...
      parameters: DatasetCreateRequestParameters.fromMap((map['parameters'] as Map).cast<String, dynamic>()),
      registration: DatasetCreateRequestRegistration.fromMap((map['registration'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      skipValidation: map['skipValidation'] == null ? null : map['skipValidation'] as bool,
      timeSeries: map['timeSeries'] == null ? null : DatasetCreateRequestTimeSeries.fromMap((map['timeSeries'] as Map).cast<String, dynamic>()),
