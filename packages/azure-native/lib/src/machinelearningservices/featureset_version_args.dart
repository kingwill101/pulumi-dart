...
class FeaturesetVersionArgs {
  ...
  FeaturesetVersionArgs({
    required FeaturesetVersionMachinelearningservices featuresetVersionProperties,
  ...
  factory FeaturesetVersionArgs.fromMap(Map<String, dynamic> map) {
    return FeaturesetVersionArgs(
      featuresetVersionProperties: map['featuresetVersionProperties'] as FeaturesetVersionMachinelearningservices,
