...
/// Result data returned by getConnectionRaiPolicy.
class GetConnectionRaiPolicyResult {
  ...
  /// Creates a new [GetConnectionRaiPolicyResult].
  ...
  factory GetConnectionRaiPolicyResult.fromMap(Map<String, dynamic> map) {
