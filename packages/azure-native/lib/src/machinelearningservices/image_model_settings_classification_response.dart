...
import 'mlflow_model_job_input_response.dart';

/// Settings used for training the model.
/// For more information on the available settings please visit the official documentation:
/// https://docs.microsoft.com/en-us/azure/machine-learning/how-to-auto-train-image-models.
class ImageModelSettingsClassificationResponse {
  ...
  final MLFlowModelJobInputResponse? checkpointModel;
  ...
  /// Creates a new [ImageModelSettingsClassificationResponse].
  ...
  factory ImageModelSettingsClassificationResponse.fromMap(Map<String, dynamic> map) {
    return ImageModelSettingsClassificationResponse(
      ...
      checkpointModel: map['checkpointModel'] == null ? null : MLFlowModelJobInputResponse.fromMap((map['checkpointModel'] as Map).cast<String, dynamic>()),
