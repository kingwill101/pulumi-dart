...
class OnlineDeploymentArgs {
  ...
  OnlineDeploymentArgs({
    ...
    String? kind,
    String? location,
    required KubernetesOnlineDeployment onlineDeploymentProperties,
  ...
  factory OnlineDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return OnlineDeploymentArgs(
      ...
      onlineDeploymentProperties: KubernetesOnlineDeployment.fromMap((map['onlineDeploymentProperties'] as Map).cast<String, dynamic>()),
