...
/// Result data returned by getComponentContainer.
class GetComponentContainerResult {
  ...
  /// Creates a new [GetComponentContainerResult].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'componentContainerProperties': componentContainerProperties.toMap(),
      'id': id,
      'name': name,
  ...
  factory GetComponentContainerResult.fromMap(Map<String, dynamic> map) {
