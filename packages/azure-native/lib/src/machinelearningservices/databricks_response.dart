...
class DatabricksResponse {
  ...
  final DatabricksPropertiesResponse? properties;
  ...
  factory DatabricksResponse.fromMap(Map<String, dynamic> map) {
    return DatabricksResponse(
      ...
      properties: map['properties'] == null ? null : DatabricksPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
