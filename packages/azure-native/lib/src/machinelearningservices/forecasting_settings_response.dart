...
class ForecastingSettingsResponse {
  ...
  final AutoForecastHorizonResponse? forecastHorizon;
  ...
  final AutoSeasonalityResponse? seasonality;
  ...
  final AutoTargetLagsResponse? targetLags;
  /// The number of past periods used to create a rolling window average of the target column.
  final AutoTargetRollingWindowSizeResponse? targetRollingWindowSize;
  ...
  factory ForecastingSettingsResponse.fromMap(Map<String, dynamic> map) {
    return ForecastingSettingsResponse(
      ...
      forecastHorizon: map['forecastHorizon'] == null ? null : AutoForecastHorizonResponse.fromMap((map['forecastHorizon'] as Map).cast<String, dynamic>()),
      frequency: map['frequency'] == null ? null : map['frequency'] as String,
      seasonality: map['seasonality'] == null ? null : AutoSeasonalityResponse.fromMap((map['seasonality'] as Map).cast<String, dynamic>()),
      ...
      targetLags: map['targetLags'] == null ? null : AutoTargetLagsResponse.fromMap((map['targetLags'] as Map).cast<String, dynamic>()),
      targetRollingWindowSize: map['targetRollingWindowSize'] == null ? null : AutoTargetRollingWindowSizeResponse.fromMap((map['targetRollingWindowSize'] as Map).cast<String, dynamic>()),
