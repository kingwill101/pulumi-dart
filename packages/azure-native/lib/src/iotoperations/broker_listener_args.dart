...
class BrokerListenerArgs {
  ...
  factory BrokerListenerArgs.fromMap(Map<String, dynamic> map) {
    return BrokerListenerArgs(
      ...
      listenerName: map['listenerName'] == null ? null : map['listenerName'] as String,
      properties: map['properties'] == null ? null : BrokerListenerProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
