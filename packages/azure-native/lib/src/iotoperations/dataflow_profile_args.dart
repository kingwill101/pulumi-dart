...
class DataflowProfileArgs {
  ...
  factory DataflowProfileArgs.fromMap(Map<String, dynamic> map) {
    return DataflowProfileArgs(
      dataflowProfileName: map['dataflowProfileName'] == null ? null : map['dataflowProfileName'] as String,
      extendedLocation: ExtendedLocation.fromMap((map['extendedLocation'] as Map).cast<String, dynamic>()),
      instanceName: map['instanceName'] as String,
      properties: map['properties'] == null ? null : DataflowProfileProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
