...
class DataflowEndpointKafkaResponse {
  ...
  final DataflowEndpointKafkaAuthenticationResponse authentication;
  /// Batching configuration.
  final DataflowEndpointKafkaBatchingResponse? batching;
  ...
  factory DataflowEndpointKafkaResponse.fromMap(Map<String, dynamic> map) {
    return DataflowEndpointKafkaResponse(
      authentication: DataflowEndpointKafkaAuthenticationResponse.fromMap((map['authentication'] as Map).cast<String, dynamic>()),
      batching: map['batching'] == null ? null : DataflowEndpointKafkaBatchingResponse.fromMap((map['batching'] as Map).cast<String, dynamic>()),
