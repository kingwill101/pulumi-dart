...
class DataflowGraphArgs {
  ...
  factory DataflowGraphArgs.fromMap(Map<String, dynamic> map) {
    return DataflowGraphArgs(
      dataflowGraphName: map['dataflowGraphName'] == null ? null : map['dataflowGraphName'] as String,
      ...
      properties: map['properties'] == null ? null : DataflowGraphProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
