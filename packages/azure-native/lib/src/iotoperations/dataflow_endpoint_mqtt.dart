...
class DataflowEndpointMqtt {
  ...
  final DataflowEndpointMqttAuthentication authentication;
  ...
  factory DataflowEndpointMqtt.fromMap(Map<String, dynamic> map) {
    return DataflowEndpointMqtt(
      authentication: DataflowEndpointMqttAuthentication.fromMap((map['authentication'] as Map).cast<String, dynamic>()),
