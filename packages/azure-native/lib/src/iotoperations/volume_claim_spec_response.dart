...
class VolumeClaimSpecResponse {
  ...
  final LocalKubernetesReferenceResponse? dataSource;
  ...
  final KubernetesReferenceResponse? dataSourceRef;
  ...
  factory VolumeClaimSpecResponse.fromMap(Map<String, dynamic> map) {
    return VolumeClaimSpecResponse(
      ...
      dataSource: map['dataSource'] == null ? null : LocalKubernetesReferenceResponse.fromMap((map['dataSource'] as Map).cast<String, dynamic>()),
      dataSourceRef: map['dataSourceRef'] == null ? null : KubernetesReferenceResponse.fromMap((map['dataSourceRef'] as Map).cast<String, dynamic>()),
