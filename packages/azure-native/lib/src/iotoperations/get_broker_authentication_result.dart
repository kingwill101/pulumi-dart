...
class GetBrokerAuthenticationResult {
  ...
  final BrokerAuthenticationPropertiesResponse properties;
  ...
  factory GetBrokerAuthenticationResult.fromMap(Map<String, dynamic> map) {
    return GetBrokerAuthenticationResult(
      ...
      properties: BrokerAuthenticationPropertiesResponse.fromMap((map['properties'] as Map).cast<String, dynamic>()),
