...
class GroupQuotaArgs {
  ...
  factory GroupQuotaArgs.fromMap(Map<String, dynamic> map) {
    return GroupQuotaArgs(
      groupQuotaName: map['groupQuotaName'] == null ? null : map['groupQuotaName'] as String,
      managementGroupId: map['managementGroupId'] as String,
      properties: map['properties'] == null ? null : GroupQuotasEntityProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
    );
  }
}
