...
class AzureHybridBenefitPropertiesResponse {
  /// SCOM license type. Maximize savings by using license you already own
  final String? scomLicenseType;
  ...
  final String? windowsServerLicenseType;

  /// Creates a new [AzureHybridBenefitPropertiesResponse].
  ...
  factory AzureHybridBenefitPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return AzureHybridBenefitPropertiesResponse(
      scomLicenseType: map['scomLicenseType'] == null ? null : map['scomLicenseType'] as String,
      sqlServerLicenseType: map['sqlServerLicenseType'] == null ? null : map['sqlServerLicenseType'] as String,
      windowsServerLicenseType: map['windowsServerLicenseType'] == null ? null : map['windowsServerLicenseType'] as String,
    );
  }
}
