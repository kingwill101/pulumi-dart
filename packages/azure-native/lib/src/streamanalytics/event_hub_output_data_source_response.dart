...
class EventHubOutputDataSourceResponse {
  /// Authentication Mode.
  ...
  /// Creates a new [EventHubOutputDataSourceResponse].
  ...
  factory EventHubOutputDataSourceResponse.fromMap(Map<String, dynamic> map) {
    return EventHubOutputDataSourceResponse(
