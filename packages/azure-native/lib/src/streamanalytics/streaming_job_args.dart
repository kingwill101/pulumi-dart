...
class StreamingJobArgs {
  ...
  StreamingJobArgs({
    ...
    List<FunctionStreamanalytics>? functions,
    Identity? identity,
    List<InputStreamanalytics>? inputs,
    String? jobName,
    ...
    List<OutputStreamanalytics>? outputs,
  ...
  factory StreamingJobArgs.fromMap(Map<String, dynamic> map) {
    return StreamingJobArgs(
      cluster: map['cluster'] == null ? null : ClusterInfo.fromMap((map['cluster'] as Map).cast<String, dynamic>()),
      ...
      functions: map['functions'] == null ? null : (map['functions'] as List).cast<FunctionStreamanalytics>(),
      identity: map['identity'] == null ? null : Identity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      inputs: map['inputs'] == null ? null : (map['inputs'] as List).cast<InputStreamanalytics>(),
      jobName: map['jobName'] == null ? null : map['jobName'] as String,
      jobStorageAccount: map['jobStorageAccount'] == null ? null : JobStorageAccount.fromMap((map['jobStorageAccount'] as Map).cast<String, dynamic>()),
      ...
      outputs: map['outputs'] == null ? null : (map['outputs'] as List).cast<OutputStreamanalytics>(),
      resourceGroupName: map['resourceGroupName'] as String,
      sku: map['sku'] == null ? null : Sku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      transformation: map['transformation'] == null ? null : Transformation.fromMap((map['transformation'] as Map).cast<String, dynamic>()),
    );
  }
}
