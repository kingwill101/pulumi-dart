...
class ServiceBusTopicOutputDataSource {
  /// Authentication Mode.
  ...
  /// Creates a new [ServiceBusTopicOutputDataSource].
  ...
  factory ServiceBusTopicOutputDataSource.fromMap(Map<String, dynamic> map) {
