...
class PeerAsnArgs {
  ...
  factory PeerAsnArgs.fromMap(Map<String, dynamic> map) {
    return PeerAsnArgs(
      ...
      peerAsnName: map['peerAsnName'] == null ? null : map['peerAsnName'] as String,
      peerContactDetail: map['peerContactDetail'] == null ? null : pulumi.Input.decodeList<ContactDetail>(map['peerContactDetail'], (value) => ContactDetail.fromMap((value as Map).cast<String, dynamic>())),
