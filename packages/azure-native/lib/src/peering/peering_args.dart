...
class PeeringArgs {
  ...
  factory PeeringArgs.fromMap(Map<String, dynamic> map) {
    return PeeringArgs(
      direct: map['direct'] == null ? null : PeeringPropertiesDirect.fromMap((map['direct'] as Map).cast<String, dynamic>()),
      exchange: map['exchange'] == null ? null : PeeringPropertiesExchange.fromMap((map['exchange'] as Map).cast<String, dynamic>()),
      ...
      sku: PeeringSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
