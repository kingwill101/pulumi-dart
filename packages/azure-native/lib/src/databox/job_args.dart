...
class JobArgs {
  ...
  JobArgs({
    ...
    String? deliveryType,
    DataBoxCustomerDiskJobDetails? details,
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      deliveryInfo: map['deliveryInfo'] == null ? null : JobDeliveryInfo.fromMap((map['deliveryInfo'] as Map).cast<String, dynamic>()),
      deliveryType: map['deliveryType'] == null ? null : map['deliveryType'] as String,
      details: map['details'] == null ? null : DataBoxCustomerDiskJobDetails.fromMap((map['details'] as Map).cast<String, dynamic>()),
