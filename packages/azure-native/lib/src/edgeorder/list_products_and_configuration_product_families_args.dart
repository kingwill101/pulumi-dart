...
class ListProductsAndConfigurationProductFamiliesArgs {
  ...
  ListProductsAndConfigurationProductFamiliesArgs({
    ...
    String? expand,
    required Map<String, List<FilterableProperty>> filterableProperties,
    String? skipToken,
  }) :
  ...
  factory ListProductsAndConfigurationProductFamiliesArgs.fromMap(Map<String, dynamic> map) {
    return ListProductsAndConfigurationProductFamiliesArgs(
      ...
      filterableProperties: pulumi.Input.decodeMapValues<List<FilterableProperty>>(map['filterableProperties'], (value) => pulumi.Input.decodeList<FilterableProperty>(value, (value) => FilterableProperty.fromMap((value as Map).cast<String, dynamic>()))),
