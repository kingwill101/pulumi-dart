...
class OrderItemArgs {
  ...
  OrderItemArgs({
    ...
    required OrderItemDetails orderItemDetails,
  ...
  factory OrderItemArgs.fromMap(Map<String, dynamic> map) {
    return OrderItemArgs(
      addressDetails: map['addressDetails'] == null ? null : AddressDetails.fromMap((map['addressDetails'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : ResourceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      orderId: map['orderId'] as String,
      orderItemDetails: OrderItemDetails.fromMap((map['orderItemDetails'] as Map).cast<String, dynamic>()),
      orderItemName: map['orderItemName'] == null ? null : map['orderItemName'] as String,
