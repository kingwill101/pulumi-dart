...
class BigDataPoolArgs {
  ...
  factory BigDataPoolArgs.fromMap(Map<String, dynamic> map) {
    return BigDataPoolArgs(
      autoPause: map['autoPause'] == null ? null : AutoPauseProperties.fromMap((map['autoPause'] as Map).cast<String, dynamic>()),
      autoScale: map['autoScale'] == null ? null : AutoScaleProperties.fromMap((map['autoScale'] as Map).cast<String, dynamic>()),
      bigDataPoolName: map['bigDataPoolName'] == null ? null : map['bigDataPoolName'] as String,
      cacheSize: map['cacheSize'] == null ? null : map['cacheSize'] as int,
      customLibraries: map['customLibraries'] == null ? null : pulumi.Input.decodeList<LibraryInfo>(map['customLibraries'], (value) => LibraryInfo.fromMap((value as Map).cast<String, dynamic>())),
      defaultSparkLogFolder: map['defaultSparkLogFolder'] == null ? null : map['defaultSparkLogFolder'] as String,
      dynamicExecutorAllocation: map['dynamicExecutorAllocation'] == null ? null : DynamicExecutorAllocation.fromMap((map['dynamicExecutorAllocation'] as Map).cast<String, dynamic>()),
      ...
      libraryRequirements: map['libraryRequirements'] == null ? null : LibraryRequirements.fromMap((map['libraryRequirements'] as Map).cast<String, dynamic>()),
      ...
      sparkConfigProperties: map['sparkConfigProperties'] == null ? null : SparkConfigProperties.fromMap((map['sparkConfigProperties'] as Map).cast<String, dynamic>()),
