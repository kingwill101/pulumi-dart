...
class LocationProfile {
  ...
  final BaseVirtualMachineProfile? virtualMachineProfileOverride;
  ...
  factory LocationProfile.fromMap(Map<String, dynamic> map) {
    return LocationProfile(
      ...
      virtualMachineProfileOverride: map['virtualMachineProfileOverride'] == null ? null : BaseVirtualMachineProfile.fromMap((map['virtualMachineProfileOverride'] as Map).cast<String, dynamic>()),
    );
  }
}
