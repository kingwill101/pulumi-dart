...
class VMAttributesResponse {
  ...
  final VMAttributeMinMaxIntegerResponse? acceleratorCount;
  ...
  final VMAttributeMinMaxIntegerResponse? dataDiskCount;
  ...
  /// If localStorageSupport is "Excluded", this VMAttribute can not be used.
  final VMAttributeMinMaxDoubleResponse? localStorageInGiB;
  ...
  final VMAttributeMinMaxDoubleResponse memoryInGiB;
  ...
  final VMAttributeMinMaxDoubleResponse? memoryInGiBPerVCpu;
  ...
  final VMAttributeMinMaxDoubleResponse? networkBandwidthInMbps;
  ...
  final VMAttributeMinMaxIntegerResponse? networkInterfaceCount;
  ...
  final VMAttributeMinMaxIntegerResponse? rdmaNetworkInterfaceCount;
  ...
  final VMAttributeMinMaxIntegerResponse vCpuCount;
  ...
  factory VMAttributesResponse.fromMap(Map<String, dynamic> map) {
    return VMAttributesResponse(
      acceleratorCount: map['acceleratorCount'] == null ? null : VMAttributeMinMaxIntegerResponse.fromMap((map['acceleratorCount'] as Map).cast<String, dynamic>()),
      ...
      dataDiskCount: map['dataDiskCount'] == null ? null : VMAttributeMinMaxIntegerResponse.fromMap((map['dataDiskCount'] as Map).cast<String, dynamic>()),
      ...
      localStorageInGiB: map['localStorageInGiB'] == null ? null : VMAttributeMinMaxDoubleResponse.fromMap((map['localStorageInGiB'] as Map).cast<String, dynamic>()),
      localStorageSupport: map['localStorageSupport'] == null ? null : map['localStorageSupport'] as String,
      memoryInGiB: VMAttributeMinMaxDoubleResponse.fromMap((map['memoryInGiB'] as Map).cast<String, dynamic>()),
      memoryInGiBPerVCpu: map['memoryInGiBPerVCpu'] == null ? null : VMAttributeMinMaxDoubleResponse.fromMap((map['memoryInGiBPerVCpu'] as Map).cast<String, dynamic>()),
      networkBandwidthInMbps: map['networkBandwidthInMbps'] == null ? null : VMAttributeMinMaxDoubleResponse.fromMap((map['networkBandwidthInMbps'] as Map).cast<String, dynamic>()),
      networkInterfaceCount: map['networkInterfaceCount'] == null ? null : VMAttributeMinMaxIntegerResponse.fromMap((map['networkInterfaceCount'] as Map).cast<String, dynamic>()),
      rdmaNetworkInterfaceCount: map['rdmaNetworkInterfaceCount'] == null ? null : VMAttributeMinMaxIntegerResponse.fromMap((map['rdmaNetworkInterfaceCount'] as Map).cast<String, dynamic>()),
      rdmaSupport: map['rdmaSupport'] == null ? null : map['rdmaSupport'] as String,
      vCpuCount: VMAttributeMinMaxIntegerResponse.fromMap((map['vCpuCount'] as Map).cast<String, dynamic>()),
