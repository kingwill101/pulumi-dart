...
class ComputeProfile {
  ...
  final AdditionalCapabilities? additionalVirtualMachineCapabilities;
  /// Base Virtual Machine Profile Properties to be specified according to "specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/{computeApiVersion}/virtualMachineScaleSet.json#/definitions/VirtualMachineScaleSetVMProfile"
  final BaseVirtualMachineProfile baseVirtualMachineProfile;
  ...
  factory ComputeProfile.fromMap(Map<String, dynamic> map) {
    return ComputeProfile(
      additionalVirtualMachineCapabilities: map['additionalVirtualMachineCapabilities'] == null ? null : AdditionalCapabilities.fromMap((map['additionalVirtualMachineCapabilities'] as Map).cast<String, dynamic>()),
      baseVirtualMachineProfile: BaseVirtualMachineProfile.fromMap((map['baseVirtualMachineProfile'] as Map).cast<String, dynamic>()),
