...
class AssignmentArgs {
  ...
  AssignmentArgs({
    ...
    String? location,
    AssignmentLockSettings? locks,
    required Map<String, ParameterValue> parameters,
    required Map<String, ResourceGroupValue> resourceGroups,
  ...
  factory AssignmentArgs.fromMap(Map<String, dynamic> map) {
    return AssignmentArgs(
      ...
      locks: map['locks'] == null ? null : AssignmentLockSettings.fromMap((map['locks'] as Map).cast<String, dynamic>()),
      ...
      resourceGroups: pulumi.Input.decodeMapValues<ResourceGroupValue>(map['resourceGroups'], (value) => ResourceGroupValue.fromMap((value as Map).cast<String, dynamic>())),
