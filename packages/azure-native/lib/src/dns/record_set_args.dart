...
class RecordSetArgs {
  ...
  factory RecordSetArgs.fromMap(Map<String, dynamic> map) {
    return RecordSetArgs(
      aRecords: map['aRecords'] == null ? null : pulumi.Input.decodeList<ARecord>(map['aRecords'], (value) => ARecord.fromMap((value as Map).cast<String, dynamic>())),
      aaaaRecords: map['aaaaRecords'] == null ? null : pulumi.Input.decodeList<AaaaRecord>(map['aaaaRecords'], (value) => AaaaRecord.fromMap((value as Map).cast<String, dynamic>())),
      caaRecords: map['caaRecords'] == null ? null : pulumi.Input.decodeList<CaaRecord>(map['caaRecords'], (value) => CaaRecord.fromMap((value as Map).cast<String, dynamic>())),
      cnameRecord: map['cnameRecord'] == null ? null : CnameRecord.fromMap((map['cnameRecord'] as Map).cast<String, dynamic>()),
      dsRecords: map['dsRecords'] == null ? null : pulumi.Input.decodeList<DsRecord>(map['dsRecords'], (value) => DsRecord.fromMap((value as Map).cast<String, dynamic>())),
      metadata: map['metadata'] == null ? null : (map['metadata'] as Map).cast<String, String>(),
      mxRecords: map['mxRecords'] == null ? null : pulumi.Input.decodeList<MxRecord>(map['mxRecords'], (value) => MxRecord.fromMap((value as Map).cast<String, dynamic>())),
      naptrRecords: map['naptrRecords'] == null ? null : pulumi.Input.decodeList<NaptrRecord>(map['naptrRecords'], (value) => NaptrRecord.fromMap((value as Map).cast<String, dynamic>())),
      nsRecords: map['nsRecords'] == null ? null : pulumi.Input.decodeList<NsRecord>(map['nsRecords'], (value) => NsRecord.fromMap((value as Map).cast<String, dynamic>())),
      ptrRecords: map['ptrRecords'] == null ? null : pulumi.Input.decodeList<PtrRecord>(map['ptrRecords'], (value) => PtrRecord.fromMap((value as Map).cast<String, dynamic>())),
      recordType: map['recordType'] as String,
      relativeRecordSetName: map['relativeRecordSetName'] == null ? null : map['relativeRecordSetName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      soaRecord: map['soaRecord'] == null ? null : SoaRecord.fromMap((map['soaRecord'] as Map).cast<String, dynamic>()),
      srvRecords: map['srvRecords'] == null ? null : pulumi.Input.decodeList<SrvRecord>(map['srvRecords'], (value) => SrvRecord.fromMap((value as Map).cast<String, dynamic>())),
      targetResource: map['targetResource'] == null ? null : SubResource.fromMap((map['targetResource'] as Map).cast<String, dynamic>()),
      tlsaRecords: map['tlsaRecords'] == null ? null : pulumi.Input.decodeList<TlsaRecord>(map['tlsaRecords'], (value) => TlsaRecord.fromMap((value as Map).cast<String, dynamic>())),
      trafficManagementProfile: map['trafficManagementProfile'] == null ? null : SubResource.fromMap((map['trafficManagementProfile'] as Map).cast<String, dynamic>()),
      ttl: map['ttl'] == null ? null : map['ttl'] as double,
      txtRecords: map['txtRecords'] == null ? null : pulumi.Input.decodeList<TxtRecord>(map['txtRecords'], (value) => TxtRecord.fromMap((value as Map).cast<String, dynamic>())),
