...
class GetCertificateProfileResult {
  ...
  factory GetCertificateProfileResult.fromMap(Map<String, dynamic> map) {
    return GetCertificateProfileResult(
      ...
      includeCity: map['includeCity'] == null ? null : map['includeCity'] as bool,
      includeCountry: map['includeCountry'] == null ? null : map['includeCountry'] as bool,
      includePostalCode: map['includePostalCode'] == null ? null : map['includePostalCode'] as bool,
      includeState: map['includeState'] == null ? null : map['includeState'] as bool,
      includeStreetAddress: map['includeStreetAddress'] == null ? null : map['includeStreetAddress'] as bool,
