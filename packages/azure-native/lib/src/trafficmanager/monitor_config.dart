...
class MonitorConfig {
  ...
  final List<MonitorConfigCustomHeadersItem>? customHeaders;
  /// List of expected status code ranges.
  final List<MonitorConfigExpectedStatusCodeRangesItem>? expectedStatusCodeRanges;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'customHeaders': ?customHeaders == null ? null : pulumi.Input.encodeList<MonitorConfigCustomHeadersItem, Map<String, dynamic>>(customHeaders!, (value) => value.toMap()),
      'expectedStatusCodeRanges': ?expectedStatusCodeRanges == null ? null : pulumi.Input.encodeList<MonitorConfigExpectedStatusCodeRangesItem, Map<String, dynamic>>(expectedStatusCodeRanges!, (value) => value.toMap()),
  ...
  factory MonitorConfig.fromMap(Map<String, dynamic> map) {
    return MonitorConfig(
      customHeaders: map['customHeaders'] == null ? null : pulumi.Input.decodeList<MonitorConfigCustomHeadersItem>(map['customHeaders'], (value) => MonitorConfigCustomHeadersItem.fromMap((value as Map).cast<String, dynamic>())),
      expectedStatusCodeRanges: map['expectedStatusCodeRanges'] == null ? null : pulumi.Input.decodeList<MonitorConfigExpectedStatusCodeRangesItem>(map['expectedStatusCodeRanges'], (value) => MonitorConfigExpectedStatusCodeRangesItem.fromMap((value as Map).cast<String, dynamic>())),
