...
class OrganizationClusterByIdArgs {
  ...
  factory OrganizationClusterByIdArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationClusterByIdArgs(
      ...
      spec: map['spec'] == null ? null : SCClusterSpecEntity.fromMap((map['spec'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : ClusterStatusEntity.fromMap((map['status'] as Map).cast<String, dynamic>()),
    );
  }
}
