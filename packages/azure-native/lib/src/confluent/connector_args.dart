...
class ConnectorArgs {
  ...
  ConnectorArgs({
    ...
    AzureBlobStorageSinkConnectorServiceInfo? connectorServiceTypeInfo,
    required String environmentId,
    required String organizationName,
    KafkaAzureBlobStorageSinkConnectorInfo? partnerConnectorInfo,
  ...
  factory ConnectorArgs.fromMap(Map<String, dynamic> map) {
    return ConnectorArgs(
      ...
      connectorBasicInfo: map['connectorBasicInfo'] == null ? null : ConnectorInfoBase.fromMap((map['connectorBasicInfo'] as Map).cast<String, dynamic>()),
      connectorName: map['connectorName'] == null ? null : map['connectorName'] as String,
      connectorServiceTypeInfo: map['connectorServiceTypeInfo'] == null ? null : AzureBlobStorageSinkConnectorServiceInfo.fromMap((map['connectorServiceTypeInfo'] as Map).cast<String, dynamic>()),
      environmentId: map['environmentId'] as String,
      organizationName: map['organizationName'] as String,
      partnerConnectorInfo: map['partnerConnectorInfo'] == null ? null : KafkaAzureBlobStorageSinkConnectorInfo.fromMap((map['partnerConnectorInfo'] as Map).cast<String, dynamic>()),
