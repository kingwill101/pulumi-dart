...
class OrganizationArgs {
  ...
  OrganizationArgs({
    ...
    String? location,
    required OfferDetail offerDetail,
  ...
  factory OrganizationArgs.fromMap(Map<String, dynamic> map) {
    return OrganizationArgs(
      linkOrganization: map['linkOrganization'] == null ? null : LinkOrganization.fromMap((map['linkOrganization'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      offerDetail: OfferDetail.fromMap((map['offerDetail'] as Map).cast<String, dynamic>()),
      organizationName: map['organizationName'] == null ? null : map['organizationName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userDetail: UserDetail.fromMap((map['userDetail'] as Map).cast<String, dynamic>()),
    );
  }
}
