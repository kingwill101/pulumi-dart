...
class NamespaceArgs {
  ...
  NamespaceArgs({
    ...
    List<PrivateEndpointConnectionRelay>? privateEndpointConnections,
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      privateEndpointConnections: map['privateEndpointConnections'] == null ? null : (map['privateEndpointConnections'] as List).cast<PrivateEndpointConnectionRelay>(),
