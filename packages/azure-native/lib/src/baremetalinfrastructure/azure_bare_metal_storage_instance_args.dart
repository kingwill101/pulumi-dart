...
class AzureBareMetalStorageInstanceArgs {
  ...
  factory AzureBareMetalStorageInstanceArgs.fromMap(Map<String, dynamic> map) {
    return AzureBareMetalStorageInstanceArgs(
      azureBareMetalStorageInstanceName: map['azureBareMetalStorageInstanceName'] == null ? null : map['azureBareMetalStorageInstanceName'] as String,
      ...
      identity: map['identity'] == null ? null : AzureBareMetalStorageInstanceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      storageProperties: map['storageProperties'] == null ? null : StorageProperties.fromMap((map['storageProperties'] as Map).cast<String, dynamic>()),
