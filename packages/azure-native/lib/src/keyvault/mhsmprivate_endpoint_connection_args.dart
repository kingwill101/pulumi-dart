...
class MHSMPrivateEndpointConnectionArgs {
  ...
  factory MHSMPrivateEndpointConnectionArgs.fromMap(Map<String, dynamic> map) {
    return MHSMPrivateEndpointConnectionArgs(
      ...
      privateLinkServiceConnectionState: map['privateLinkServiceConnectionState'] == null ? null : MHSMPrivateLinkServiceConnectionState.fromMap((map['privateLinkServiceConnectionState'] as Map).cast<String, dynamic>()),
