...
class MHSMPrivateLinkServiceConnectionStateResponse {
  ...
  /// Creates a new [MHSMPrivateLinkServiceConnectionStateResponse].
  ...
  factory MHSMPrivateLinkServiceConnectionStateResponse.fromMap(Map<String, dynamic> map) {
    return MHSMPrivateLinkServiceConnectionStateResponse(
