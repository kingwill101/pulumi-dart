...
class ServerDetailsArgs {
  ...
  ServerDetailsArgs({
    ...
    String? location,
    int? managedMode,
    ConnectionMode? querypoolConnectionMode,
    required String resourceGroupName,
    int? serverMonitorMode,
    String? serverName,
    required ResourceSku sku,
  ...
  factory ServerDetailsArgs.fromMap(Map<String, dynamic> map) {
    return ServerDetailsArgs(
      asAdministrators: map['asAdministrators'] == null ? null : ServerAdministrators.fromMap((map['asAdministrators'] as Map).cast<String, dynamic>()),
      backupBlobContainerUri: map['backupBlobContainerUri'] == null ? null : map['backupBlobContainerUri'] as String,
      gatewayDetails: map['gatewayDetails'] == null ? null : GatewayDetails.fromMap((map['gatewayDetails'] as Map).cast<String, dynamic>()),
      ipV4FirewallSettings: map['ipV4FirewallSettings'] == null ? null : IPv4FirewallSettings.fromMap((map['ipV4FirewallSettings'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      managedMode: map['managedMode'] == null ? null : map['managedMode'] as int,
      querypoolConnectionMode: map['querypoolConnectionMode'] == null ? null : ConnectionMode.fromValue(map['querypoolConnectionMode'] as String),
      ...
      sku: ResourceSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
