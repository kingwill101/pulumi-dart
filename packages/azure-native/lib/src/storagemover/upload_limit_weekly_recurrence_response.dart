...
class UploadLimitWeeklyRecurrenceResponse {
  ...
  factory UploadLimitWeeklyRecurrenceResponse.fromMap(Map<String, dynamic> map) {
    return UploadLimitWeeklyRecurrenceResponse(
      ...
      endTime: TimeResponse.fromMap((map['endTime'] as Map).cast<String, dynamic>()),
      limitInMbps: map['limitInMbps'] as int,
      startTime: TimeResponse.fromMap((map['startTime'] as Map).cast<String, dynamic>()),
    );
  }
}
