...
class AgentArgs {
  ...
  AgentArgs({
    String? agentName,
    required String arcResourceId,
    required String arcVmUuid,
    String? description,
  ...
  factory AgentArgs.fromMap(Map<String, dynamic> map) {
    return AgentArgs(
      ...
      uploadLimitSchedule: map['uploadLimitSchedule'] == null ? null : UploadLimitSchedule.fromMap((map['uploadLimitSchedule'] as Map).cast<String, dynamic>()),
    );
  }
}
