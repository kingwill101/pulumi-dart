...
class ModelingArgs {
  ...
  factory ModelingArgs.fromMap(Map<String, dynamic> map) {
    return ModelingArgs(
      ...
      modelingName: map['modelingName'] == null ? null : map['modelingName'] as String,
      properties: map['properties'] == null ? null : ModelingResourceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
