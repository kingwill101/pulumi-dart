...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    this.authOptions = registerOutput<DataPlaneAuthOptionsResponse?>('authOptions');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.computeType = registerOutput<String?>('computeType');
    this.dataExfiltrationProtections = registerOutput<List<String>?>('dataExfiltrationProtections');
    this.disableLocalAuth = registerOutput<bool?>('disableLocalAuth');
    this.eTag = registerOutput<String>('eTag');
    this.encryptionWithCmk = registerOutput<EncryptionWithCmkResponse?>('encryptionWithCmk');
    ...
    this.semanticSearch = registerOutput<String?>('semanticSearch');
    this.serviceUpgradedAt = registerOutput<String>('serviceUpgradedAt');
    ...
    this.upgradeAvailable = registerOutput<String?>('upgradeAvailable');
  }
}
