...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    String? computeType,
    List<String>? dataExfiltrationProtections,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      authOptions: map['authOptions'] == null ? null : DataPlaneAuthOptions.fromMap((map['authOptions'] as Map).cast<String, dynamic>()),
      ...
      encryptionWithCmk: map['encryptionWithCmk'] == null ? null : EncryptionWithCmk.fromMap((map['encryptionWithCmk'] as Map).cast<String, dynamic>()),
      endpoint: map['endpoint'] == null ? null : map['endpoint'] as String,
      hostingMode: map['hostingMode'] == null ? null : HostingMode.fromValue(map['hostingMode'] as String),
      ...
      searchServiceName: map['searchServiceName'] == null ? null : map['searchServiceName'] as String,
