...
class AttestationProviderArgs {
  ...
  AttestationProviderArgs({
    String? location,
    required AttestationServiceCreationSpecificParams properties,
    String? providerName,
  ...
  factory AttestationProviderArgs.fromMap(Map<String, dynamic> map) {
    return AttestationProviderArgs(
      ...
      properties: AttestationServiceCreationSpecificParams.fromMap((map['properties'] as Map).cast<String, dynamic>()),
