...
class DigitalTwinArgs {
  ...
  DigitalTwinArgs({
    ...
    String? location,
    List<PrivateEndpointConnectionDigitaltwins>? privateEndpointConnections,
  ...
  factory DigitalTwinArgs.fromMap(Map<String, dynamic> map) {
    return DigitalTwinArgs(
      identity: map['identity'] == null ? null : DigitalTwinsIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      privateEndpointConnections: map['privateEndpointConnections'] == null ? null : (map['privateEndpointConnections'] as List).cast<PrivateEndpointConnectionDigitaltwins>(),
