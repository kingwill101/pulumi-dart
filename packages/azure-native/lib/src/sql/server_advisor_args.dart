...
class ServerAdvisorArgs {
  ...
  ServerAdvisorArgs({
    String? advisorName,
    required AutoExecuteStatus autoExecuteStatus,
  ...
  factory ServerAdvisorArgs.fromMap(Map<String, dynamic> map) {
    return ServerAdvisorArgs(
      advisorName: map['advisorName'] == null ? null : map['advisorName'] as String,
      autoExecuteStatus: AutoExecuteStatus.fromValue(map['autoExecuteStatus'] as String),
