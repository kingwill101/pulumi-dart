...
class StartStopManagedInstanceScheduleArgs {
  ...
  factory StartStopManagedInstanceScheduleArgs.fromMap(Map<String, dynamic> map) {
    return StartStopManagedInstanceScheduleArgs(
      ...
      scheduleList: pulumi.Input.decodeList<ScheduleItem>(map['scheduleList'], (value) => ScheduleItem.fromMap((value as Map).cast<String, dynamic>())),
      startStopScheduleName: map['startStopScheduleName'] == null ? null : map['startStopScheduleName'] as String,
