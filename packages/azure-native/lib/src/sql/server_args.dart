...
class ServerArgs {
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      ...
      administrators: map['administrators'] == null ? null : ServerExternalAdministrator.fromMap((map['administrators'] as Map).cast<String, dynamic>()),
      ...
      isIPv6Enabled: map['isIPv6Enabled'] == null ? null : map['isIPv6Enabled'] as String,
