...
/// {@template pulumi_sql_database_blob_auditing_policy_args_doc}
/// The set of arguments for DatabaseBlobAuditingPolicy.
/// {@endtemplate}
/// {@macro pulumi_sql_database_blob_auditing_policy_args_doc}
class DatabaseBlobAuditingPolicyArgs {
  ...
  /// Creates a new [DatabaseBlobAuditingPolicyArgs].
  ...
  DatabaseBlobAuditingPolicyArgs({
    ...
    required BlobAuditingPolicyState state,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'state': pulumi.Input.mapInputValue<BlobAuditingPolicyState, String>(state, (value) => value.value),
  ...
  factory DatabaseBlobAuditingPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseBlobAuditingPolicyArgs(
      ...
      blobAuditingPolicyName: map['blobAuditingPolicyName'] == null ? null : map['blobAuditingPolicyName'] as String,
      ...
      state: BlobAuditingPolicyState.fromValue(map['state'] as String),
