...
class Database extends pulumi.CustomResource {
  ...
  Database(
    ...
    this.currentServiceObjectiveName = registerOutput<String>('currentServiceObjectiveName');
    this.currentSku = registerOutput<SkuResponse>('currentSku');
    ...
    this.encryptionProtector = registerOutput<String?>('encryptionProtector');
    this.encryptionProtectorAutoRotation = registerOutput<bool?>('encryptionProtectorAutoRotation');
    this.failoverGroupId = registerOutput<String>('failoverGroupId');
    this.federatedClientId = registerOutput<String?>('federatedClientId');
    this.freeLimitExhaustionBehavior = registerOutput<String?>('freeLimitExhaustionBehavior');
    this.highAvailabilityReplicaCount = registerOutput<int?>('highAvailabilityReplicaCount');
    this.identity = registerOutput<DatabaseIdentityResponse?>('identity');
    this.isInfraEncryptionEnabled = registerOutput<bool>('isInfraEncryptionEnabled');
    this.isLedgerOn = registerOutput<bool?>('isLedgerOn');
    this.keys = registerOutput<Map<String, DatabaseKeyResponse>?>('keys');
    ...
    this.manualCutover = registerOutput<bool?>('manualCutover');
    this.maxLogSizeBytes = registerOutput<double>('maxLogSizeBytes');
    this.maxSizeBytes = registerOutput<double?>('maxSizeBytes');
    this.minCapacity = registerOutput<double?>('minCapacity');
    this.name = registerOutput<String>('name');
    this.pausedDate = registerOutput<String>('pausedDate');
    this.performCutover = registerOutput<bool?>('performCutover');
    this.preferredEnclaveType = registerOutput<String?>('preferredEnclaveType');
    this.readScale = registerOutput<String?>('readScale');
    this.requestedBackupStorageRedundancy = registerOutput<String?>('requestedBackupStorageRedundancy');
    this.requestedServiceObjectiveName = registerOutput<String>('requestedServiceObjectiveName');
    this.resumedDate = registerOutput<String>('resumedDate');
    this.secondaryType = registerOutput<String?>('secondaryType');
    this.sku = registerOutput<SkuResponse?>('sku');
    this.status = registerOutput<String>('status');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.type = registerOutput<String>('type');
    this.useFreeLimit = registerOutput<bool?>('useFreeLimit');
