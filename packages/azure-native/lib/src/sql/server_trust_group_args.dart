...
class ServerTrustGroupArgs {
  ...
  ServerTrustGroupArgs({
    required List<ServerInfo> groupMembers,
    required String locationName,
    required String resourceGroupName,
    String? serverTrustGroupName,
    required List<String> trustScopes,
  }) :
  ...
  factory ServerTrustGroupArgs.fromMap(Map<String, dynamic> map) {
    return ServerTrustGroupArgs(
      groupMembers: pulumi.Input.decodeList<ServerInfo>(map['groupMembers'], (value) => ServerInfo.fromMap((value as Map).cast<String, dynamic>())),
      locationName: map['locationName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      serverTrustGroupName: map['serverTrustGroupName'] == null ? null : map['serverTrustGroupName'] as String,
