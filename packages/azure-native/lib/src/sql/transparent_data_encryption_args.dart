...
class TransparentDataEncryptionArgs {
  ...
  TransparentDataEncryptionArgs({
    ...
    required TransparentDataEncryptionState state,
    String? tdeName,
  }) :
  ...
  factory TransparentDataEncryptionArgs.fromMap(Map<String, dynamic> map) {
    return TransparentDataEncryptionArgs(
      ...
      state: TransparentDataEncryptionState.fromValue(map['state'] as String),
      tdeName: map['tdeName'] == null ? null : map['tdeName'] as String,
    );
  }
}
