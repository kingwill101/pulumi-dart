...
class ManagedInstancePrivateEndpointConnectionArgs {
  ...
  factory ManagedInstancePrivateEndpointConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstancePrivateEndpointConnectionArgs(
      ...
      privateEndpoint: map['privateEndpoint'] == null ? null : ManagedInstancePrivateEndpointProperty.fromMap((map['privateEndpoint'] as Map).cast<String, dynamic>()),
      privateEndpointConnectionName: map['privateEndpointConnectionName'] == null ? null : map['privateEndpointConnectionName'] as String,
      privateLinkServiceConnectionState: map['privateLinkServiceConnectionState'] == null ? null : ManagedInstancePrivateLinkServiceConnectionStateProperty.fromMap((map['privateLinkServiceConnectionState'] as Map).cast<String, dynamic>()),
