...
class ManagedInstanceArgs {
  ...
  factory ManagedInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstanceArgs(
      ...
      administrators: map['administrators'] == null ? null : ManagedInstanceExternalAdministrator.fromMap((map['administrators'] as Map).cast<String, dynamic>()),
      ...
      dnsZonePartner: map['dnsZonePartner'] == null ? null : map['dnsZonePartner'] as String,
      ...
      managedInstanceCreateMode: map['managedInstanceCreateMode'] == null ? null : map['managedInstanceCreateMode'] as String,
      managedInstanceName: map['managedInstanceName'] == null ? null : map['managedInstanceName'] as String,
      ...
      servicePrincipal: map['servicePrincipal'] == null ? null : ServicePrincipal.fromMap((map['servicePrincipal'] as Map).cast<String, dynamic>()),
      sku: map['sku'] == null ? null : Sku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      sourceManagedInstanceId: map['sourceManagedInstanceId'] == null ? null : map['sourceManagedInstanceId'] as String,
