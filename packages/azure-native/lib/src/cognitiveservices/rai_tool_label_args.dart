...
class RaiToolLabelArgs {
  ...
  factory RaiToolLabelArgs.fromMap(Map<String, dynamic> map) {
    return RaiToolLabelArgs(
      ...
      properties: map['properties'] == null ? null : RaiToolLabelProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      raiToolConnectionName: map['raiToolConnectionName'] == null ? null : map['raiToolConnectionName'] as String,
