...
class RaiTopicArgs {
  ...
  factory RaiTopicArgs.fromMap(Map<String, dynamic> map) {
    return RaiTopicArgs(
      ...
      properties: map['properties'] == null ? null : RaiTopicProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      raiTopicName: map['raiTopicName'] == null ? null : map['raiTopicName'] as String,
