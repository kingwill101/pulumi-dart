...
class RaiExternalSafetyProviderArgs {
  ...
  RaiExternalSafetyProviderArgs({
    RaiExternalSafetyProviderSchemaProperties? properties,
  ...
  factory RaiExternalSafetyProviderArgs.fromMap(Map<String, dynamic> map) {
    return RaiExternalSafetyProviderArgs(
      properties: map['properties'] == null ? null : RaiExternalSafetyProviderSchemaProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
