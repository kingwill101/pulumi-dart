...
class ApiKeyAuthConnectionPropertiesResponse {
  ...
  final ConnectionApiKeyResponse? credentials;
  final String? error;
  ...
  factory ApiKeyAuthConnectionPropertiesResponse.fromMap(Map<String, dynamic> map) {
    return ApiKeyAuthConnectionPropertiesResponse(
      ...
      credentials: map['credentials'] == null ? null : ConnectionApiKeyResponse.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
