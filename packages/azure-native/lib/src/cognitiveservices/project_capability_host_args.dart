...
class ProjectCapabilityHostArgs {
  ...
  ProjectCapabilityHostArgs({
    ...
    required ProjectCapabilityHostCognitiveservices projectCapabilityHostProperties,
  ...
  factory ProjectCapabilityHostArgs.fromMap(Map<String, dynamic> map) {
    return ProjectCapabilityHostArgs(
      ...
      projectCapabilityHostProperties: map['projectCapabilityHostProperties'] as ProjectCapabilityHostCognitiveservices,
