...
import 'connection_shared_access_signature.dart';
...
class SASAuthTypeConnectionProperties {
  ...
  final ConnectionSharedAccessSignature? credentials;
  final String? error;
  ...
  factory SASAuthTypeConnectionProperties.fromMap(Map<String, dynamic> map) {
    return SASAuthTypeConnectionProperties(
      authType: map['authType'] as String,
      category: map['category'] == null ? null : map['category'] as String,
      credentials: map['credentials'] == null ? null : ConnectionSharedAccessSignature.fromMap((map['credentials'] as Map).cast<String, dynamic>()),
