...
class AgenticApplicationResponse {
  ...
  final AssignedIdentityResponse? agentIdentityBlueprint;
  ...
  final ApplicationTrafficRoutingPolicyResponse? trafficRoutingPolicy;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'agents': ?agents == null ? null : pulumi.Input.encodeList<AgentReferenceResponse, Map<String, dynamic>>(agents!, (value) => value.toMap()),
  ...
  factory AgenticApplicationResponse.fromMap(Map<String, dynamic> map) {
    return AgenticApplicationResponse(
      agentIdentityBlueprint: map['agentIdentityBlueprint'] == null ? null : AssignedIdentityResponse.fromMap((map['agentIdentityBlueprint'] as Map).cast<String, dynamic>()),
      agents: map['agents'] == null ? null : pulumi.Input.decodeList<AgentReferenceResponse>(map['agents'], (value) => AgentReferenceResponse.fromMap((value as Map).cast<String, dynamic>())),
      authorizationPolicy: map['authorizationPolicy'] == null ? null : ChannelsBuiltInAuthorizationPolicyResponse.fromMap((map['authorizationPolicy'] as Map).cast<String, dynamic>()),
      baseUrl: map['baseUrl'] == null ? null : map['baseUrl'] as String,
      defaultInstanceIdentity: map['defaultInstanceIdentity'] == null ? null : AssignedIdentityResponse.fromMap((map['defaultInstanceIdentity'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      displayName: map['displayName'] == null ? null : map['displayName'] as String,
      isEnabled: map['isEnabled'] as bool,
      provisioningState: map['provisioningState'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      trafficRoutingPolicy: map['trafficRoutingPolicy'] == null ? null : ApplicationTrafficRoutingPolicyResponse.fromMap((map['trafficRoutingPolicy'] as Map).cast<String, dynamic>()),
    );
  }
}
