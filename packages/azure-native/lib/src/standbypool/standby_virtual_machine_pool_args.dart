...
class StandbyVirtualMachinePoolArgs {
  ...
  factory StandbyVirtualMachinePoolArgs.fromMap(Map<String, dynamic> map) {
    return StandbyVirtualMachinePoolArgs(
      ...
      elasticityProfile: map['elasticityProfile'] == null ? null : StandbyVirtualMachinePoolElasticityProfile.fromMap((map['elasticityProfile'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      standbyVirtualMachinePoolName: map['standbyVirtualMachinePoolName'] == null ? null : map['standbyVirtualMachinePoolName'] as String,
