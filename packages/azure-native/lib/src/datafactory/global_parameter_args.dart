...
class GlobalParameterArgs {
  ...
  GlobalParameterArgs({
    ...
    required Map<String, GlobalParameterSpecification> properties,
  ...
  factory GlobalParameterArgs.fromMap(Map<String, dynamic> map) {
    return GlobalParameterArgs(
      ...
      globalParameterName: map['globalParameterName'] == null ? null : map['globalParameterName'] as String,
      properties: pulumi.Input.decodeMapValues<GlobalParameterSpecification>(map['properties'], (value) => GlobalParameterSpecification.fromMap((value as Map).cast<String, dynamic>())),
