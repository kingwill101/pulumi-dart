...
class SybaseTableDatasetResponse {
  ...
  /// Creates a new [SybaseTableDatasetResponse].
  ...
  factory SybaseTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SybaseTableDatasetResponse(
