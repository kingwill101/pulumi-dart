...
class ComponentSetupResponse {
  ...
  final AzureKeyVaultSecretReferenceResponse? licenseKey;
  ...
  factory ComponentSetupResponse.fromMap(Map<String, dynamic> map) {
    return ComponentSetupResponse(
      ...
      licenseKey: map['licenseKey'] == null ? null : AzureKeyVaultSecretReferenceResponse.fromMap((map['licenseKey'] as Map).cast<String, dynamic>()),
