...
class FactoryArgs {
  ...
  FactoryArgs({
    ...
    FactoryGitHubConfiguration? repoConfiguration,
  ...
  factory FactoryArgs.fromMap(Map<String, dynamic> map) {
    return FactoryArgs(
      encryption: map['encryption'] == null ? null : EncryptionConfiguration.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      factoryName: map['factoryName'] == null ? null : map['factoryName'] as String,
      globalParameters: map['globalParameters'] == null ? null : pulumi.Input.decodeMapValues<GlobalParameterSpecification>(map['globalParameters'], (value) => GlobalParameterSpecification.fromMap((value as Map).cast<String, dynamic>())),
      ...
      repoConfiguration: map['repoConfiguration'] == null ? null : FactoryGitHubConfiguration.fromMap((map['repoConfiguration'] as Map).cast<String, dynamic>()),
