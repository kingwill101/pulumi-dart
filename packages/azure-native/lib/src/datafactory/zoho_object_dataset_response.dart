...
/// Zoho server dataset.
class ZohoObjectDatasetResponse {
  ...
  /// Creates a new [ZohoObjectDatasetResponse].
  ...
  factory ZohoObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ZohoObjectDatasetResponse(
