...
class AmazonMWSObjectDatasetResponse {
  ...
  /// Creates a new [AmazonMWSObjectDatasetResponse].
  ...
  factory AmazonMWSObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AmazonMWSObjectDatasetResponse(
