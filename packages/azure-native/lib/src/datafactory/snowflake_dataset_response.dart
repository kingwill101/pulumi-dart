...
class SnowflakeDatasetResponse {
  ...
  /// Creates a new [SnowflakeDatasetResponse].
  ...
  factory SnowflakeDatasetResponse.fromMap(Map<String, dynamic> map) {
    return SnowflakeDatasetResponse(
