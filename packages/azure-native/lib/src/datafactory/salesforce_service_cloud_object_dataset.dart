...
class SalesforceServiceCloudObjectDataset {
  ...
  factory SalesforceServiceCloudObjectDataset.fromMap(Map<String, dynamic> map) {
    return SalesforceServiceCloudObjectDataset(
