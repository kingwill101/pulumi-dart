...
class SalesforceServiceCloudV2Sink {
  ...
  /// Creates a new [SalesforceServiceCloudV2Sink].
  ...
  factory SalesforceServiceCloudV2Sink.fromMap(Map<String, dynamic> map) {
    return SalesforceServiceCloudV2Sink(
