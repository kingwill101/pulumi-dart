...
class HdfsSourceResponse {
  ...
  final DistcpSettingsResponse? distcpSettings;
  ...
  factory HdfsSourceResponse.fromMap(Map<String, dynamic> map) {
    return HdfsSourceResponse(
      ...
      distcpSettings: map['distcpSettings'] == null ? null : DistcpSettingsResponse.fromMap((map['distcpSettings'] as Map).cast<String, dynamic>()),
