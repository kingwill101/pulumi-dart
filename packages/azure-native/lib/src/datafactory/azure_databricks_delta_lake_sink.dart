...
import 'azure_databricks_delta_lake_import_command.dart';

/// A copy activity Azure Databricks Delta Lake sink.
class AzureDatabricksDeltaLakeSink {
  /// If true, disable data store metrics collection. Default is false. Type: boolean (or Expression with resultType boolean).
  final dynamic disableMetricsCollection;
  /// Azure Databricks Delta Lake import settings.
  final AzureDatabricksDeltaLakeImportCommand? importSettings;
  ...
  factory AzureDatabricksDeltaLakeSink.fromMap(Map<String, dynamic> map) {
    return AzureDatabricksDeltaLakeSink(
      disableMetricsCollection: map['disableMetricsCollection'] == null ? null : map['disableMetricsCollection'],
      importSettings: map['importSettings'] == null ? null : AzureDatabricksDeltaLakeImportCommand.fromMap((map['importSettings'] as Map).cast<String, dynamic>()),
