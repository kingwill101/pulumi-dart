...
class AmazonRedshiftTableDatasetResponse {
  ...
  /// Creates a new [AmazonRedshiftTableDatasetResponse].
  ...
  factory AmazonRedshiftTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRedshiftTableDatasetResponse(
