...
class DelimitedTextSink {
  ...
  final DelimitedTextWriteSettings? formatSettings;
  ...
  factory DelimitedTextSink.fromMap(Map<String, dynamic> map) {
    return DelimitedTextSink(
      ...
      formatSettings: map['formatSettings'] == null ? null : DelimitedTextWriteSettings.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
