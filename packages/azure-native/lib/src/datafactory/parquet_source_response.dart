...
class ParquetSourceResponse {
  ...
  final ParquetReadSettingsResponse? formatSettings;
  ...
  factory ParquetSourceResponse.fromMap(Map<String, dynamic> map) {
    return ParquetSourceResponse(
      ...
      formatSettings: map['formatSettings'] == null ? null : ParquetReadSettingsResponse.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
