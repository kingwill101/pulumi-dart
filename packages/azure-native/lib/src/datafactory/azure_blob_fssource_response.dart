...
class AzureBlobFSSourceResponse {
  ...
  /// Creates a new [AzureBlobFSSourceResponse].
  ...
  factory AzureBlobFSSourceResponse.fromMap(Map<String, dynamic> map) {
    return AzureBlobFSSourceResponse(
