...
class ExpressionV2Response {
  ...
  final List<ExpressionV2Response>? operands;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'operands': ?operands == null ? null : pulumi.Input.encodeList<ExpressionV2Response, Map<String, dynamic>>(operands!, (value) => value.toMap()),
      'operators': ?operators,
      'type': ?type,
      'value': ?value,
    };
  ...
  factory ExpressionV2Response.fromMap(Map<String, dynamic> map) {
    return ExpressionV2Response(
      operands: map['operands'] == null ? null : pulumi.Input.decodeList<ExpressionV2Response>(map['operands'], (value) => ExpressionV2Response.fromMap((value as Map).cast<String, dynamic>())),
