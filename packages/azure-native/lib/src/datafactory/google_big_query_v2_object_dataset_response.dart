...
class GoogleBigQueryV2ObjectDatasetResponse {
  ...
  /// Creates a new [GoogleBigQueryV2ObjectDatasetResponse].
  ...
  factory GoogleBigQueryV2ObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return GoogleBigQueryV2ObjectDatasetResponse(
