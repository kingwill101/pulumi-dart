...
class AmazonRdsForSqlServerTableDataset {
  ...
  factory AmazonRdsForSqlServerTableDataset.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForSqlServerTableDataset(
