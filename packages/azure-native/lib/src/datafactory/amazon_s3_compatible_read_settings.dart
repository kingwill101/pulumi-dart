...
class AmazonS3CompatibleReadSettings {
  ...
  /// Creates a new [AmazonS3CompatibleReadSettings].
  ...
  factory AmazonS3CompatibleReadSettings.fromMap(Map<String, dynamic> map) {
    return AmazonS3CompatibleReadSettings(
