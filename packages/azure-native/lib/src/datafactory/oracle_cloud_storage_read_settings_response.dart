...
class OracleCloudStorageReadSettingsResponse {
  ...
  /// Creates a new [OracleCloudStorageReadSettingsResponse].
  ...
  factory OracleCloudStorageReadSettingsResponse.fromMap(Map<String, dynamic> map) {
    return OracleCloudStorageReadSettingsResponse(
