...
class JsonSinkResponse {
  ...
  final JsonWriteSettingsResponse? formatSettings;
  ...
  factory JsonSinkResponse.fromMap(Map<String, dynamic> map) {
    return JsonSinkResponse(
      ...
      formatSettings: map['formatSettings'] == null ? null : JsonWriteSettingsResponse.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
