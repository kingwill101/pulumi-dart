...
import 'delimited_text_read_settings.dart';
...
class DelimitedTextSource {
  ...
  final DelimitedTextReadSettings? formatSettings;
  ...
  factory DelimitedTextSource.fromMap(Map<String, dynamic> map) {
    return DelimitedTextSource(
      additionalColumns: map['additionalColumns'] == null ? null : map['additionalColumns'],
      disableMetricsCollection: map['disableMetricsCollection'] == null ? null : map['disableMetricsCollection'],
      formatSettings: map['formatSettings'] == null ? null : DelimitedTextReadSettings.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
