...
class IcebergSinkResponse {
  ...
  final IcebergWriteSettingsResponse? formatSettings;
  ...
  factory IcebergSinkResponse.fromMap(Map<String, dynamic> map) {
    return IcebergSinkResponse(
      ...
      formatSettings: map['formatSettings'] == null ? null : IcebergWriteSettingsResponse.fromMap((map['formatSettings'] as Map).cast<String, dynamic>()),
