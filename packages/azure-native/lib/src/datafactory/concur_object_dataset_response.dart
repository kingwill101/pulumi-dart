...
class ConcurObjectDatasetResponse {
  ...
  /// Creates a new [ConcurObjectDatasetResponse].
  ...
  factory ConcurObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return ConcurObjectDatasetResponse(
