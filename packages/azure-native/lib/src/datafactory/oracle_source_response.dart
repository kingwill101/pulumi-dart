...
class OracleSourceResponse {
  ...
  final OraclePartitionSettingsResponse? partitionSettings;
  ...
  factory OracleSourceResponse.fromMap(Map<String, dynamic> map) {
    return OracleSourceResponse(
      ...
      partitionSettings: map['partitionSettings'] == null ? null : OraclePartitionSettingsResponse.fromMap((map['partitionSettings'] as Map).cast<String, dynamic>()),
