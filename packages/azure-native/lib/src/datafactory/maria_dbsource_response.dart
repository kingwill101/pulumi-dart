...
class MariaDBSourceResponse {
  ...
  /// Creates a new [MariaDBSourceResponse].
  ...
  factory MariaDBSourceResponse.fromMap(Map<String, dynamic> map) {
    return MariaDBSourceResponse(
