...
class OracleServiceCloudSource {
  ...
  /// Creates a new [OracleServiceCloudSource].
  ...
  factory OracleServiceCloudSource.fromMap(Map<String, dynamic> map) {
    return OracleServiceCloudSource(
