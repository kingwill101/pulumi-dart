...
class TeradataSink {
  ...
  final TeradataImportCommand? importSettings;
  ...
  factory TeradataSink.fromMap(Map<String, dynamic> map) {
    return TeradataSink(
      ...
      importSettings: map['importSettings'] == null ? null : TeradataImportCommand.fromMap((map['importSettings'] as Map).cast<String, dynamic>()),
