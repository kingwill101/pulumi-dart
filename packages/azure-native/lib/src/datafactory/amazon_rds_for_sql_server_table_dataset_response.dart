...
class AmazonRdsForSqlServerTableDatasetResponse {
  ...
  /// Creates a new [AmazonRdsForSqlServerTableDatasetResponse].
  ...
  factory AmazonRdsForSqlServerTableDatasetResponse.fromMap(Map<String, dynamic> map) {
    return AmazonRdsForSqlServerTableDatasetResponse(
