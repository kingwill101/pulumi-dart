...
class PaypalObjectDatasetResponse {
  ...
  /// Creates a new [PaypalObjectDatasetResponse].
  ...
  factory PaypalObjectDatasetResponse.fromMap(Map<String, dynamic> map) {
    return PaypalObjectDatasetResponse(
