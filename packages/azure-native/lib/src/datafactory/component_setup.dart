...
class ComponentSetup {
  ...
  final AzureKeyVaultSecretReference? licenseKey;
  ...
  factory ComponentSetup.fromMap(Map<String, dynamic> map) {
    return ComponentSetup(
      ...
      licenseKey: map['licenseKey'] == null ? null : AzureKeyVaultSecretReference.fromMap((map['licenseKey'] as Map).cast<String, dynamic>()),
