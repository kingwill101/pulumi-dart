...
class FileServerWriteSettingsResponse {
  ...
  /// Creates a new [FileServerWriteSettingsResponse].
  ...
  factory FileServerWriteSettingsResponse.fromMap(Map<String, dynamic> map) {
    return FileServerWriteSettingsResponse(
