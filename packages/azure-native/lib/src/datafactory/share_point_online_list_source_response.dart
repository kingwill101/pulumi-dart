...
class SharePointOnlineListSourceResponse {
  ...
  /// Creates a new [SharePointOnlineListSourceResponse].
  ...
  factory SharePointOnlineListSourceResponse.fromMap(Map<String, dynamic> map) {
    return SharePointOnlineListSourceResponse(
