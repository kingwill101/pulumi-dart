...
class EncryptionResponseCustomerManagedKeyEncryption {
  ...
  final EncryptionResponseKeyEncryptionKeyIdentity? keyEncryptionKeyIdentity;
  ...
  factory EncryptionResponseCustomerManagedKeyEncryption.fromMap(Map<String, dynamic> map) {
    return EncryptionResponseCustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: map['keyEncryptionKeyIdentity'] == null ? null : EncryptionResponseKeyEncryptionKeyIdentity.fromMap((map['keyEncryptionKeyIdentity'] as Map).cast<String, dynamic>()),
