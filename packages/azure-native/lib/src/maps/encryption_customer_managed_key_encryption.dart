...
class EncryptionCustomerManagedKeyEncryption {
  ...
  final EncryptionKeyEncryptionKeyIdentity? keyEncryptionKeyIdentity;
  ...
  factory EncryptionCustomerManagedKeyEncryption.fromMap(Map<String, dynamic> map) {
    return EncryptionCustomerManagedKeyEncryption(
      keyEncryptionKeyIdentity: map['keyEncryptionKeyIdentity'] == null ? null : EncryptionKeyEncryptionKeyIdentity.fromMap((map['keyEncryptionKeyIdentity'] as Map).cast<String, dynamic>()),
