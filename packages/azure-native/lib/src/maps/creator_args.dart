...
class CreatorArgs {
  ...
  CreatorArgs({
    ...
    String? creatorName,
    String? location,
    required CreatorProperties properties,
  ...
  factory CreatorArgs.fromMap(Map<String, dynamic> map) {
    return CreatorArgs(
      ...
      creatorName: map['creatorName'] == null ? null : map['creatorName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: CreatorProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
