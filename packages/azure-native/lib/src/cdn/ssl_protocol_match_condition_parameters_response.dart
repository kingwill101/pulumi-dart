...
class SslProtocolMatchConditionParametersResponse {
  ...
  /// Creates a new [SslProtocolMatchConditionParametersResponse].
  ...
  factory SslProtocolMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return SslProtocolMatchConditionParametersResponse(
