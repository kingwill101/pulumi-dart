...
class AFDOriginArgs {
  ...
  AFDOriginArgs({
    ...
    int? httpPort,
    int? httpsPort,
    required String originGroupName,
  ...
  factory AFDOriginArgs.fromMap(Map<String, dynamic> map) {
    return AFDOriginArgs(
      azureOrigin: map['azureOrigin'] == null ? null : ResourceReference.fromMap((map['azureOrigin'] as Map).cast<String, dynamic>()),
      ...
      sharedPrivateLinkResource: map['sharedPrivateLinkResource'] == null ? null : SharedPrivateLinkResourceProperties.fromMap((map['sharedPrivateLinkResource'] as Map).cast<String, dynamic>()),
