...
class IsDeviceMatchConditionParametersResponse {
  ...
  /// Creates a new [IsDeviceMatchConditionParametersResponse].
  ...
  factory IsDeviceMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return IsDeviceMatchConditionParametersResponse(
