...
class EndpointArgs {
  ...
  EndpointArgs({
    ...
    String? originPath,
    required List<DeepCreatedOrigin> origins,
    String? probePath,
  ...
  factory EndpointArgs.fromMap(Map<String, dynamic> map) {
    return EndpointArgs(
      ...
      defaultOriginGroup: map['defaultOriginGroup'] == null ? null : ResourceReference.fromMap((map['defaultOriginGroup'] as Map).cast<String, dynamic>()),
      deliveryPolicy: map['deliveryPolicy'] == null ? null : EndpointPropertiesUpdateParametersDeliveryPolicy.fromMap((map['deliveryPolicy'] as Map).cast<String, dynamic>()),
      endpointName: map['endpointName'] == null ? null : map['endpointName'] as String,
      geoFilters: map['geoFilters'] == null ? null : pulumi.Input.decodeList<GeoFilter>(map['geoFilters'], (value) => GeoFilter.fromMap((value as Map).cast<String, dynamic>())),
      ...
      originGroups: map['originGroups'] == null ? null : pulumi.Input.decodeList<DeepCreatedOriginGroup>(map['originGroups'], (value) => DeepCreatedOriginGroup.fromMap((value as Map).cast<String, dynamic>())),
      ...
      origins: pulumi.Input.decodeList<DeepCreatedOrigin>(map['origins'], (value) => DeepCreatedOrigin.fromMap((value as Map).cast<String, dynamic>())),
      probePath: map['probePath'] == null ? null : map['probePath'] as String,
      profileName: map['profileName'] as String,
      queryStringCachingBehavior: map['queryStringCachingBehavior'] == null ? null : QueryStringCachingBehavior.fromValue(map['queryStringCachingBehavior'] as String),
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      urlSigningKeys: map['urlSigningKeys'] == null ? null : pulumi.Input.decodeList<UrlSigningKey>(map['urlSigningKeys'], (value) => UrlSigningKey.fromMap((value as Map).cast<String, dynamic>())),
      webApplicationFirewallPolicyLink: map['webApplicationFirewallPolicyLink'] == null ? null : EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink.fromMap((map['webApplicationFirewallPolicyLink'] as Map).cast<String, dynamic>()),
    );
  }
}
