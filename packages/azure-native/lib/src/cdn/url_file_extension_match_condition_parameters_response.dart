...
class UrlFileExtensionMatchConditionParametersResponse {
  ...
  /// Creates a new [UrlFileExtensionMatchConditionParametersResponse].
  ...
  factory UrlFileExtensionMatchConditionParametersResponse.fromMap(Map<String, dynamic> map) {
    return UrlFileExtensionMatchConditionParametersResponse(
