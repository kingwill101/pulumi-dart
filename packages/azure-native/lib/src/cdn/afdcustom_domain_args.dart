...
class AFDCustomDomainArgs {
  ...
  factory AFDCustomDomainArgs.fromMap(Map<String, dynamic> map) {
    return AFDCustomDomainArgs(
      azureDnsZone: map['azureDnsZone'] == null ? null : ResourceReference.fromMap((map['azureDnsZone'] as Map).cast<String, dynamic>()),
      ...
      preValidatedCustomDomainResourceId: map['preValidatedCustomDomainResourceId'] == null ? null : ResourceReference.fromMap((map['preValidatedCustomDomainResourceId'] as Map).cast<String, dynamic>()),
      profileName: map['profileName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tlsSettings: map['tlsSettings'] == null ? null : AFDDomainHttpsParameters.fromMap((map['tlsSettings'] as Map).cast<String, dynamic>()),
    );
  }
}
