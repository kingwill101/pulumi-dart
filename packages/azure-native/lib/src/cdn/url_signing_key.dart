...
class UrlSigningKey {
  ...
  final KeyVaultSigningKeyParameters keySourceParameters;
  ...
  factory UrlSigningKey.fromMap(Map<String, dynamic> map) {
    return UrlSigningKey(
      ...
      keySourceParameters: KeyVaultSigningKeyParameters.fromMap((map['keySourceParameters'] as Map).cast<String, dynamic>()),
    );
  }
}
