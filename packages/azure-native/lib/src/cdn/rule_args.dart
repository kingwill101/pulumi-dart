...
class RuleArgs {
  ...
  RuleArgs({
    List<DeliveryRuleCacheExpirationAction>? actions,
    List<DeliveryRuleClientPortCondition>? conditions,
  ...
  factory RuleArgs.fromMap(Map<String, dynamic> map) {
    return RuleArgs(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<DeliveryRuleCacheExpirationAction>(map['actions'], (value) => DeliveryRuleCacheExpirationAction.fromMap((value as Map).cast<String, dynamic>())),
