...
class VirtualMachineImageTemplateArgs {
  ...
  VirtualMachineImageTemplateArgs({
    ...
    List<ImageTemplateFileCustomizer>? customize,
    required List<ImageTemplateManagedImageDistributor> distribute,
    ImageTemplatePropertiesErrorHandling? errorHandling,
    required ImageTemplateIdentity identity,
    String? imageTemplateName,
    String? location,
    Map<String, String>? managedResourceTags,
    ImageTemplatePropertiesOptimize? optimize,
    required String resourceGroupName,
    required ImageTemplateManagedImageSource source,
  ...
  factory VirtualMachineImageTemplateArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineImageTemplateArgs(
      autoRun: map['autoRun'] == null ? null : ImageTemplateAutoRun.fromMap((map['autoRun'] as Map).cast<String, dynamic>()),
      buildTimeoutInMinutes: map['buildTimeoutInMinutes'] == null ? null : map['buildTimeoutInMinutes'] as int,
      customize: map['customize'] == null ? null : pulumi.Input.decodeList<ImageTemplateFileCustomizer>(map['customize'], (value) => ImageTemplateFileCustomizer.fromMap((value as Map).cast<String, dynamic>())),
      distribute: pulumi.Input.decodeList<ImageTemplateManagedImageDistributor>(map['distribute'], (value) => ImageTemplateManagedImageDistributor.fromMap((value as Map).cast<String, dynamic>())),
      errorHandling: map['errorHandling'] == null ? null : ImageTemplatePropertiesErrorHandling.fromMap((map['errorHandling'] as Map).cast<String, dynamic>()),
      identity: ImageTemplateIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      imageTemplateName: map['imageTemplateName'] == null ? null : map['imageTemplateName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      managedResourceTags: map['managedResourceTags'] == null ? null : (map['managedResourceTags'] as Map).cast<String, String>(),
      optimize: map['optimize'] == null ? null : ImageTemplatePropertiesOptimize.fromMap((map['optimize'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      source: ImageTemplateManagedImageSource.fromMap((map['source'] as Map).cast<String, dynamic>()),
      stagingResourceGroup: map['stagingResourceGroup'] == null ? null : map['stagingResourceGroup'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      validate: map['validate'] == null ? null : ImageTemplatePropertiesValidate.fromMap((map['validate'] as Map).cast<String, dynamic>()),
      vmProfile: map['vmProfile'] == null ? null : ImageTemplateVmProfile.fromMap((map['vmProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
