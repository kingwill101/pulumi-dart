...
class AzureBlobDefinition {
  ...
  final ManagedIdentityDefinition? managedIdentity;
  /// The Shared Access token to access the storage container
  final String? sasToken;
  /// Parameters to authenticate using Service Principal.
  final ServicePrincipalDefinition? servicePrincipal;
  ...
  factory AzureBlobDefinition.fromMap(Map<String, dynamic> map) {
    return AzureBlobDefinition(
      ...
      managedIdentity: map['managedIdentity'] == null ? null : ManagedIdentityDefinition.fromMap((map['managedIdentity'] as Map).cast<String, dynamic>()),
      sasToken: map['sasToken'] == null ? null : map['sasToken'] as String,
      servicePrincipal: map['servicePrincipal'] == null ? null : ServicePrincipalDefinition.fromMap((map['servicePrincipal'] as Map).cast<String, dynamic>()),
