...
class PostBuildDefinition {
  ...
  final List<SubstituteFromDefinition>? substituteFrom;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'substituteFrom': ?substituteFrom == null ? null : pulumi.Input.encodeList<SubstituteFromDefinition, Map<String, dynamic>>(substituteFrom!, (value) => value.toMap()),
    };
  }
  ...
  factory PostBuildDefinition.fromMap(Map<String, dynamic> map) {
    return PostBuildDefinition(
      ...
      substituteFrom: map['substituteFrom'] == null ? null : pulumi.Input.decodeList<SubstituteFromDefinition>(map['substituteFrom'], (value) => SubstituteFromDefinition.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
