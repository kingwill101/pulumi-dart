...
class SourceControlConfigurationArgs {
  ...
  factory SourceControlConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return SourceControlConfigurationArgs(
      ...
      helmOperatorProperties: map['helmOperatorProperties'] == null ? null : HelmOperatorProperties.fromMap((map['helmOperatorProperties'] as Map).cast<String, dynamic>()),
      ...
      sourceControlConfigurationName: map['sourceControlConfigurationName'] == null ? null : map['sourceControlConfigurationName'] as String,
