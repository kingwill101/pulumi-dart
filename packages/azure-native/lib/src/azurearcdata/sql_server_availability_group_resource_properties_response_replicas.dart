...
class SqlServerAvailabilityGroupResourcePropertiesResponseReplicas {
  ...
  final List<SqlAvailabilityGroupReplicaResourcePropertiesResponse>? value;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'nextLink': nextLink,
      'value': ?value == null ? null : pulumi.Input.encodeList<SqlAvailabilityGroupReplicaResourcePropertiesResponse, Map<String, dynamic>>(value!, (value) => value.toMap()),
    };
  }
  ...
  factory SqlServerAvailabilityGroupResourcePropertiesResponseReplicas.fromMap(Map<String, dynamic> map) {
    return SqlServerAvailabilityGroupResourcePropertiesResponseReplicas(
      ...
      value: map['value'] == null ? null : pulumi.Input.decodeList<SqlAvailabilityGroupReplicaResourcePropertiesResponse>(map['value'], (value) => SqlAvailabilityGroupReplicaResourcePropertiesResponse.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
