...
class SqlServerInstanceArgs {
  ...
  factory SqlServerInstanceArgs.fromMap(Map<String, dynamic> map) {
    return SqlServerInstanceArgs(
      ...
      properties: map['properties'] == null ? null : SqlServerInstanceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      sqlServerInstanceName: map['sqlServerInstanceName'] == null ? null : map['sqlServerInstanceName'] as String,
