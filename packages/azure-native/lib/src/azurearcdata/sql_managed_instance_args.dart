...
class SqlManagedInstanceArgs {
  ...
  SqlManagedInstanceArgs({
    ...
    String? location,
    required SqlManagedInstanceProperties properties,
  ...
  factory SqlManagedInstanceArgs.fromMap(Map<String, dynamic> map) {
    return SqlManagedInstanceArgs(
      ...
      properties: SqlManagedInstanceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      sku: map['sku'] == null ? null : SqlManagedInstanceSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      sqlManagedInstanceName: map['sqlManagedInstanceName'] == null ? null : map['sqlManagedInstanceName'] as String,
