...
class SqlServerAvailabilityGroupArgs {
  ...
  SqlServerAvailabilityGroupArgs({
    ...
    String? location,
    required SqlServerAvailabilityGroupResourceProperties properties,
  ...
  factory SqlServerAvailabilityGroupArgs.fromMap(Map<String, dynamic> map) {
    return SqlServerAvailabilityGroupArgs(
      ...
      properties: SqlServerAvailabilityGroupResourceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
