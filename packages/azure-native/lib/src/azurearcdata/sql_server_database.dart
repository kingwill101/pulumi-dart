...
class SqlServerDatabase extends pulumi.CustomResource {
  ...
  late final pulumi.Output<SqlServerDatabaseResourcePropertiesResponse> properties;
  ...
  SqlServerDatabase(
    ...
    this.properties = registerOutput<SqlServerDatabaseResourcePropertiesResponse>('properties');
