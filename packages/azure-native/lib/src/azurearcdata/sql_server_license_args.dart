...
class SqlServerLicenseArgs {
  ...
  SqlServerLicenseArgs({
    String? location,
    required SqlServerLicenseProperties properties,
  ...
  factory SqlServerLicenseArgs.fromMap(Map<String, dynamic> map) {
    return SqlServerLicenseArgs(
      ...
      properties: SqlServerLicenseProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      sqlServerLicenseName: map['sqlServerLicenseName'] == null ? null : map['sqlServerLicenseName'] as String,
