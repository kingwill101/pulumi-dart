...
class ActiveDirectoryConnector extends pulumi.CustomResource {
  ...
  /// null
  late final pulumi.Output<ActiveDirectoryConnectorPropertiesResponse> properties;
  ...
  ActiveDirectoryConnector(
    ...
    this.properties = registerOutput<ActiveDirectoryConnectorPropertiesResponse>('properties');
