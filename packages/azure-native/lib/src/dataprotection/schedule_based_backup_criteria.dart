...
class ScheduleBasedBackupCriteria {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'daysOfMonth': ?daysOfMonth == null ? null : pulumi.Input.encodeList<Day, Map<String, dynamic>>(daysOfMonth!, (value) => value.toMap()),
  ...
  factory ScheduleBasedBackupCriteria.fromMap(Map<String, dynamic> map) {
    return ScheduleBasedBackupCriteria(
      ...
      daysOfMonth: map['daysOfMonth'] == null ? null : pulumi.Input.decodeList<Day>(map['daysOfMonth'], (value) => Day.fromMap((value as Map).cast<String, dynamic>())),
