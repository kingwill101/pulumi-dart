...
class KubernetesClusterBackupDatasourceParameters {
  ...
  final List<NamespacedNameResource>? backupHookReferences;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'backupHookReferences': ?backupHookReferences == null ? null : pulumi.Input.encodeList<NamespacedNameResource, Map<String, dynamic>>(backupHookReferences!, (value) => value.toMap()),
  ...
  factory KubernetesClusterBackupDatasourceParameters.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterBackupDatasourceParameters(
      backupHookReferences: map['backupHookReferences'] == null ? null : pulumi.Input.decodeList<NamespacedNameResource>(map['backupHookReferences'], (value) => NamespacedNameResource.fromMap((value as Map).cast<String, dynamic>())),
