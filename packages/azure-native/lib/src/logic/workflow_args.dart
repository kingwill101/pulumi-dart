...
class WorkflowArgs {
  ...
  factory WorkflowArgs.fromMap(Map<String, dynamic> map) {
    return WorkflowArgs(
      accessControl: map['accessControl'] == null ? null : FlowAccessControlConfiguration.fromMap((map['accessControl'] as Map).cast<String, dynamic>()),
      ...
      integrationAccount: map['integrationAccount'] == null ? null : ResourceReference.fromMap((map['integrationAccount'] as Map).cast<String, dynamic>()),
      ...
      parameters: map['parameters'] == null ? null : pulumi.Input.decodeMapValues<WorkflowParameter>(map['parameters'], (value) => WorkflowParameter.fromMap((value as Map).cast<String, dynamic>())),
