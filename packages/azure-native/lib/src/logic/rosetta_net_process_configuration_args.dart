...
class RosettaNetProcessConfigurationArgs {
  ...
  RosettaNetProcessConfigurationArgs({
    required RosettaNetPipActivitySettings activitySettings,
    String? description,
    required RosettaNetPipRoleSettings initiatorRoleSettings,
    required String integrationAccountName,
    String? location,
    Map<String, String>? metadata,
    required String processCode,
    required String processName,
    required String processVersion,
    required String resourceGroupName,
    required RosettaNetPipRoleSettings responderRoleSettings,
  ...
  factory RosettaNetProcessConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return RosettaNetProcessConfigurationArgs(
      activitySettings: RosettaNetPipActivitySettings.fromMap((map['activitySettings'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      initiatorRoleSettings: RosettaNetPipRoleSettings.fromMap((map['initiatorRoleSettings'] as Map).cast<String, dynamic>()),
      ...
      responderRoleSettings: RosettaNetPipRoleSettings.fromMap((map['responderRoleSettings'] as Map).cast<String, dynamic>()),
      rosettaNetProcessConfigurationName: map['rosettaNetProcessConfigurationName'] == null ? null : map['rosettaNetProcessConfigurationName'] as String,
