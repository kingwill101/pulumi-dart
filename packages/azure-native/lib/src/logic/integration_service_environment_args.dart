...
class IntegrationServiceEnvironmentArgs {
  ...
  factory IntegrationServiceEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationServiceEnvironmentArgs(
      ...
      integrationServiceEnvironmentName: map['integrationServiceEnvironmentName'] == null ? null : map['integrationServiceEnvironmentName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : IntegrationServiceEnvironmentProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroup: map['resourceGroup'] as String,
      sku: map['sku'] == null ? null : IntegrationServiceEnvironmentSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
