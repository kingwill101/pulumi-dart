...
class SecretSyncArgs {
  ...
  SecretSyncArgs({
    ...
    required String kubernetesSecretType,
    String? location,
    required List<KubernetesSecretObjectMapping> objectSecretMapping,
    required String resourceGroupName,
    required String secretProviderClassName,
  ...
  factory SecretSyncArgs.fromMap(Map<String, dynamic> map) {
    return SecretSyncArgs(
      ...
      objectSecretMapping: pulumi.Input.decodeList<KubernetesSecretObjectMapping>(map['objectSecretMapping'], (value) => KubernetesSecretObjectMapping.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      secretProviderClassName: map['secretProviderClassName'] as String,
      secretSyncName: map['secretSyncName'] == null ? null : map['secretSyncName'] as String,
