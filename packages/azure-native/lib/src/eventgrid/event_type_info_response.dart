...
class EventTypeInfoResponse {
  ...
  final Map<String, InlineEventPropertiesResponse>? inlineEventTypes;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'inlineEventTypes': ?inlineEventTypes == null ? null : pulumi.Input.encodeMapValues<InlineEventPropertiesResponse, Map<String, dynamic>>(inlineEventTypes!, (value) => value.toMap()),
      'kind': ?kind,
    };
  }
  ...
  factory EventTypeInfoResponse.fromMap(Map<String, dynamic> map) {
    return EventTypeInfoResponse(
      inlineEventTypes: map['inlineEventTypes'] == null ? null : pulumi.Input.decodeMapValues<InlineEventPropertiesResponse>(map['inlineEventTypes'], (value) => InlineEventPropertiesResponse.fromMap((value as Map).cast<String, dynamic>())),
