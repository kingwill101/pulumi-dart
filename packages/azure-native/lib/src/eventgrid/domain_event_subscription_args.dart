...
class DomainEventSubscriptionArgs {
  ...
  DomainEventSubscriptionArgs({
    ...
    AzureFunctionEventSubscriptionDestination? destination,
  ...
  factory DomainEventSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return DomainEventSubscriptionArgs(
      ...
      deadLetterWithResourceIdentity: map['deadLetterWithResourceIdentity'] == null ? null : DeadLetterWithResourceIdentity.fromMap((map['deadLetterWithResourceIdentity'] as Map).cast<String, dynamic>()),
      ...
      filter: map['filter'] == null ? null : EventSubscriptionFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
