...
class PartnerDestination extends pulumi.CustomResource {
  ...
  PartnerDestination(
    ...
    this.activationState = registerOutput<String?>('activationState');
    this.azureApiVersion = registerOutput<String>('azureApiVersion');
    this.endpointBaseUrl = registerOutput<String?>('endpointBaseUrl');
    this.endpointServiceContext = registerOutput<String?>('endpointServiceContext');
