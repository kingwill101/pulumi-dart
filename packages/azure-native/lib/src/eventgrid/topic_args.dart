...
class TopicArgs {
  ...
  TopicArgs({
    ...
    String? inputSchema,
    JsonInputSchemaMapping? inputSchemaMapping,
    String? location,
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ...
      inboundIpRules: map['inboundIpRules'] == null ? null : pulumi.Input.decodeList<InboundIpRule>(map['inboundIpRules'], (value) => InboundIpRule.fromMap((value as Map).cast<String, dynamic>())),
      inputSchema: map['inputSchema'] == null ? null : map['inputSchema'] as String,
      inputSchemaMapping: map['inputSchemaMapping'] == null ? null : JsonInputSchemaMapping.fromMap((map['inputSchemaMapping'] as Map).cast<String, dynamic>()),
