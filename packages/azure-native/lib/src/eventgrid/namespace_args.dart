...
class NamespaceArgs {
  ...
  NamespaceArgs({
    ...
    List<PrivateEndpointConnectionEventgrid>? privateEndpointConnections,
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      privateEndpointConnections: map['privateEndpointConnections'] == null ? null : (map['privateEndpointConnections'] as List).cast<PrivateEndpointConnectionEventgrid>(),
      publicNetworkAccess: map['publicNetworkAccess'] == null ? null : map['publicNetworkAccess'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sku: map['sku'] == null ? null : NamespaceSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      topicSpacesConfiguration: map['topicSpacesConfiguration'] == null ? null : TopicSpacesConfiguration.fromMap((map['topicSpacesConfiguration'] as Map).cast<String, dynamic>()),
      topicsConfiguration: map['topicsConfiguration'] == null ? null : TopicsConfiguration.fromMap((map['topicsConfiguration'] as Map).cast<String, dynamic>()),
    );
  }
}
