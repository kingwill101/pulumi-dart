...
class DeidServiceArgs {
  ...
  factory DeidServiceArgs.fromMap(Map<String, dynamic> map) {
    return DeidServiceArgs(
      deidServiceName: map['deidServiceName'] == null ? null : map['deidServiceName'] as String,
      identity: map['identity'] == null ? null : ManagedServiceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : DeidServiceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
