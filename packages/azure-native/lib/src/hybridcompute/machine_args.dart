...
class MachineArgs {
  ...
  factory MachineArgs.fromMap(Map<String, dynamic> map) {
    return MachineArgs(
      agentUpgrade: map['agentUpgrade'] == null ? null : AgentUpgrade.fromMap((map['agentUpgrade'] as Map).cast<String, dynamic>()),
      ...
      extensions: map['extensions'] == null ? null : pulumi.Input.decodeList<MachineExtensionInstanceView>(map['extensions'], (value) => MachineExtensionInstanceView.fromMap((value as Map).cast<String, dynamic>())),
      identity: map['identity'] == null ? null : Identity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      kind: map['kind'] == null ? null : map['kind'] as String,
      licenseProfile: map['licenseProfile'] == null ? null : LicenseProfileMachineInstanceView.fromMap((map['licenseProfile'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      locationData: map['locationData'] == null ? null : LocationData.fromMap((map['locationData'] as Map).cast<String, dynamic>()),
      ...
      serviceStatuses: map['serviceStatuses'] == null ? null : ServiceStatuses.fromMap((map['serviceStatuses'] as Map).cast<String, dynamic>()),
