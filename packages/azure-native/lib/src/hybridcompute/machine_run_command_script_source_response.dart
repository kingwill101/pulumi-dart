...
class MachineRunCommandScriptSourceResponse {
  ...
  final RunCommandManagedIdentityResponse? scriptUriManagedIdentity;
  ...
  factory MachineRunCommandScriptSourceResponse.fromMap(Map<String, dynamic> map) {
    return MachineRunCommandScriptSourceResponse(
      ...
      scriptUriManagedIdentity: map['scriptUriManagedIdentity'] == null ? null : RunCommandManagedIdentityResponse.fromMap((map['scriptUriManagedIdentity'] as Map).cast<String, dynamic>()),
    );
  }
}
