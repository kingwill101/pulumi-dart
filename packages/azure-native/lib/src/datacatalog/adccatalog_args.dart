...
class ADCCatalogArgs {
  ...
  factory ADCCatalogArgs.fromMap(Map<String, dynamic> map) {
    return ADCCatalogArgs(
      admins: map['admins'] == null ? null : pulumi.Input.decodeList<Principals>(map['admins'], (value) => Principals.fromMap((value as Map).cast<String, dynamic>())),
      ...
      users: map['users'] == null ? null : pulumi.Input.decodeList<Principals>(map['users'], (value) => Principals.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
