...
/// Result data returned by getSignalRPrivateEndpointConnection.
class GetSignalRPrivateEndpointConnectionResult {
  ...
  /// Creates a new [GetSignalRPrivateEndpointConnectionResult].
  ...
  factory GetSignalRPrivateEndpointConnectionResult.fromMap(Map<String, dynamic> map) {
