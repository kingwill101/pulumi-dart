...
class SignalRArgs {
  ...
  factory SignalRArgs.fromMap(Map<String, dynamic> map) {
    return SignalRArgs(
      cors: map['cors'] == null ? null : SignalRCorsSettings.fromMap((map['cors'] as Map).cast<String, dynamic>()),
      ...
      features: map['features'] == null ? null : pulumi.Input.decodeList<SignalRFeature>(map['features'], (value) => SignalRFeature.fromMap((value as Map).cast<String, dynamic>())),
      ...
      networkACLs: map['networkACLs'] == null ? null : SignalRNetworkACLs.fromMap((map['networkACLs'] as Map).cast<String, dynamic>()),
      ...
      serverless: map['serverless'] == null ? null : ServerlessSettings.fromMap((map['serverless'] as Map).cast<String, dynamic>()),
      sku: map['sku'] == null ? null : ResourceSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tls: map['tls'] == null ? null : SignalRTlsSettings.fromMap((map['tls'] as Map).cast<String, dynamic>()),
      upstream: map['upstream'] == null ? null : ServerlessUpstreamSettings.fromMap((map['upstream'] as Map).cast<String, dynamic>()),
    );
  }
}
