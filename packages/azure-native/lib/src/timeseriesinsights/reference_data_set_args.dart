...
class ReferenceDataSetArgs {
  ...
  ReferenceDataSetArgs({
    ...
    required List<ReferenceDataSetKeyProperty> keyProperties,
    String? location,
  ...
  factory ReferenceDataSetArgs.fromMap(Map<String, dynamic> map) {
    return ReferenceDataSetArgs(
      ...
      keyProperties: pulumi.Input.decodeList<ReferenceDataSetKeyProperty>(map['keyProperties'], (value) => ReferenceDataSetKeyProperty.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      referenceDataSetName: map['referenceDataSetName'] == null ? null : map['referenceDataSetName'] as String,
