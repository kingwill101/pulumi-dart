...
class Gen1EnvironmentArgs {
  ...
  Gen1EnvironmentArgs({
    required String dataRetentionTime,
  ...
  factory Gen1EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return Gen1EnvironmentArgs(
      ...
      partitionKeyProperties: map['partitionKeyProperties'] == null ? null : pulumi.Input.decodeList<TimeSeriesIdProperty>(map['partitionKeyProperties'], (value) => TimeSeriesIdProperty.fromMap((value as Map).cast<String, dynamic>())),
