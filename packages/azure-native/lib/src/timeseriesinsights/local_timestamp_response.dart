...
class LocalTimestampResponse {
  ...
  final LocalTimestampResponseTimeZoneOffset? timeZoneOffset;
  ...
  factory LocalTimestampResponse.fromMap(Map<String, dynamic> map) {
    return LocalTimestampResponse(
      ...
      timeZoneOffset: map['timeZoneOffset'] == null ? null : LocalTimestampResponseTimeZoneOffset.fromMap((map['timeZoneOffset'] as Map).cast<String, dynamic>()),
    );
  }
}
