...
class EmployeeArgs {
  ...
  factory EmployeeArgs.fromMap(Map<String, dynamic> map) {
    return EmployeeArgs(
      employeeName: map['employeeName'] == null ? null : map['employeeName'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      properties: map['properties'] == null ? null : EmployeeProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
