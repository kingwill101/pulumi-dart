...
class StorageDiscoveryWorkspaceArgs {
  ...
  factory StorageDiscoveryWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return StorageDiscoveryWorkspaceArgs(
      ...
      properties: map['properties'] == null ? null : StorageDiscoveryWorkspaceProperties.fromMap((map['properties'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      storageDiscoveryWorkspaceName: map['storageDiscoveryWorkspaceName'] == null ? null : map['storageDiscoveryWorkspaceName'] as String,
