...
class _RecordingDeployment extends Deployment {
  ...
  EngineLogger get logger =>
      throw StateError('logger is not used in this test');

  @override
  Stack get stack => throw StateError('stack is not used in this test');
  ...
  Future<T> invoke<T>(
    ...
    throw StateError('invoke is not used in this test');
  }
  ...
  Future<T> invokeSingle<T>(
    ...
    throw StateError('invokeSingle is not used in this test');
  }
}
