...
void main() {
  group('deployment transform registration', () {
    ...
    test(
      'registerResourceTransform fails with message when transforms are unsupported',
      () async {
    ...
    test(
      'registerInvokeTransform fails with message when invoke transforms are unsupported',
      () async {
