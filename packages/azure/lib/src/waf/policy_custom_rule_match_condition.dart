...
class PolicyCustomRuleMatchCondition {
  ...
  final List<PolicyCustomRuleMatchConditionMatchVariable> matchVariables;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'matchVariables': pulumi.Input.encodeList<PolicyCustomRuleMatchConditionMatchVariable, Map<String, dynamic>>(matchVariables, (value) => value.toMap()),
  ...
  factory PolicyCustomRuleMatchCondition.fromMap(Map<String, dynamic> map) {
    return PolicyCustomRuleMatchCondition(
      ...
      matchVariables: pulumi.Input.decodeList<PolicyCustomRuleMatchConditionMatchVariable>(map['matchVariables'], (value) => PolicyCustomRuleMatchConditionMatchVariable.fromMap((value as Map).cast<String, dynamic>())),
