...
class PolicyArgs {
  ...
  PolicyArgs({
    List<PolicyCustomRule>? customRules,
    String? location,
    required PolicyManagedRules managedRules,
    String? name,
    PolicyPolicySettings? policySettings,
  ...
  factory PolicyArgs.fromMap(Map<String, dynamic> map) {
    return PolicyArgs(
      customRules: map['customRules'] == null ? null : pulumi.Input.decodeList<PolicyCustomRule>(map['customRules'], (value) => PolicyCustomRule.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      managedRules: PolicyManagedRules.fromMap((map['managedRules'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      policySettings: map['policySettings'] == null ? null : PolicyPolicySettings.fromMap((map['policySettings'] as Map).cast<String, dynamic>()),
