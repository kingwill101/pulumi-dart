...
class ProjectPoolArgs {
  ...
  ProjectPoolArgs({
    ...
    required String devCenterAttachedNetworkName,
    required String devCenterProjectId,
    required bool localAdministratorEnabled,
    String? location,
  ...
  factory ProjectPoolArgs.fromMap(Map<String, dynamic> map) {
    return ProjectPoolArgs(
      ...
      managedVirtualNetworkRegions: map['managedVirtualNetworkRegions'] == null ? null : map['managedVirtualNetworkRegions'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      singleSignOnEnabled: map['singleSignOnEnabled'] == null ? null : map['singleSignOnEnabled'] as bool,
      stopOnDisconnectGracePeriodMinutes: map['stopOnDisconnectGracePeriodMinutes'] == null ? null : map['stopOnDisconnectGracePeriodMinutes'] as int,
