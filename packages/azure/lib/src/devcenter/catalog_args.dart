...
class CatalogArgs {
  ...
  CatalogArgs({
    CatalogCatalogAdogit? catalogAdogit,
    CatalogCatalogGithub? catalogGithub,
  ...
  factory CatalogArgs.fromMap(Map<String, dynamic> map) {
    return CatalogArgs(
      catalogAdogit: map['catalogAdogit'] == null ? null : CatalogCatalogAdogit.fromMap((map['catalogAdogit'] as Map).cast<String, dynamic>()),
      catalogGithub: map['catalogGithub'] == null ? null : CatalogCatalogGithub.fromMap((map['catalogGithub'] as Map).cast<String, dynamic>()),
