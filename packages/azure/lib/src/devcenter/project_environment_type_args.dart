...
class ProjectEnvironmentTypeArgs {
  ...
  ProjectEnvironmentTypeArgs({
    List<String>? creatorRoleAssignmentRoles,
    required String deploymentTargetId,
    required String devCenterProjectId,
    required ProjectEnvironmentTypeIdentity identity,
    String? location,
    String? name,
    Map<String, String>? tags,
    List<ProjectEnvironmentTypeUserRoleAssignment>? userRoleAssignments,
  }) :
  ...
  factory ProjectEnvironmentTypeArgs.fromMap(Map<String, dynamic> map) {
    return ProjectEnvironmentTypeArgs(
      creatorRoleAssignmentRoles: map['creatorRoleAssignmentRoles'] == null ? null : (map['creatorRoleAssignmentRoles'] as List).cast<String>(),
      deploymentTargetId: map['deploymentTargetId'] as String,
      devCenterProjectId: map['devCenterProjectId'] as String,
      identity: ProjectEnvironmentTypeIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userRoleAssignments: map['userRoleAssignments'] == null ? null : pulumi.Input.decodeList<ProjectEnvironmentTypeUserRoleAssignment>(map['userRoleAssignments'], (value) => ProjectEnvironmentTypeUserRoleAssignment.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
