...
class SnapshotPolicyArgs {
  ...
  SnapshotPolicyArgs({
    ...
    SnapshotPolicyDailySchedule? dailySchedule,
    required bool enabled,
    SnapshotPolicyHourlySchedule? hourlySchedule,
    String? location,
    SnapshotPolicyMonthlySchedule? monthlySchedule,
    String? name,
    required String resourceGroupName,
    Map<String, String>? tags,
    SnapshotPolicyWeeklySchedule? weeklySchedule,
  }) :
  ...
  factory SnapshotPolicyArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotPolicyArgs(
      ...
      dailySchedule: map['dailySchedule'] == null ? null : SnapshotPolicyDailySchedule.fromMap((map['dailySchedule'] as Map).cast<String, dynamic>()),
      enabled: map['enabled'] as bool,
      hourlySchedule: map['hourlySchedule'] == null ? null : SnapshotPolicyHourlySchedule.fromMap((map['hourlySchedule'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      monthlySchedule: map['monthlySchedule'] == null ? null : SnapshotPolicyMonthlySchedule.fromMap((map['monthlySchedule'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      weeklySchedule: map['weeklySchedule'] == null ? null : SnapshotPolicyWeeklySchedule.fromMap((map['weeklySchedule'] as Map).cast<String, dynamic>()),
    );
  }
}
