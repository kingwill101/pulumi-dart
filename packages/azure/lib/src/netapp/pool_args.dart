...
class PoolArgs {
  ...
  factory PoolArgs.fromMap(Map<String, dynamic> map) {
    return PoolArgs(
      ...
      coolAccessEnabled: map['coolAccessEnabled'] == null ? null : map['coolAccessEnabled'] as bool,
      customThroughputMibps: map['customThroughputMibps'] == null ? null : map['customThroughputMibps'] as int,
