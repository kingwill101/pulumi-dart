...
class AccountEncryptionArgs {
  ...
  factory AccountEncryptionArgs.fromMap(Map<String, dynamic> map) {
    return AccountEncryptionArgs(
      crossTenantKeyVaultResourceId: map['crossTenantKeyVaultResourceId'] == null ? null : map['crossTenantKeyVaultResourceId'] as String,
      ...
      systemAssignedIdentityPrincipalId: map['systemAssignedIdentityPrincipalId'] == null ? null : map['systemAssignedIdentityPrincipalId'] as String,
