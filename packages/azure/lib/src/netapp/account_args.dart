...
class AccountArgs {
  ...
  AccountArgs({
    AccountActiveDirectory? activeDirectory,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      activeDirectory: map['activeDirectory'] == null ? null : AccountActiveDirectory.fromMap((map['activeDirectory'] as Map).cast<String, dynamic>()),
