...
class VolumeArgs {
  ...
  VolumeArgs({
    ...
    bool? azureVmwareDataStoreEnabled,
    VolumeCoolAccess? coolAccess,
    String? createFromSnapshotResourceId,
    VolumeDataProtectionBackupPolicy? dataProtectionBackupPolicy,
    VolumeDataProtectionReplication? dataProtectionReplication,
    VolumeDataProtectionSnapshotPolicy? dataProtectionSnapshotPolicy,
    String? encryptionKeySource,
    List<VolumeExportPolicyRule>? exportPolicyRules,
    ...
    bool? smb3ProtocolEncryptionEnabled,
    bool? smbAccessBasedEnumerationEnabled,
    bool? smbContinuousAvailabilityEnabled,
    bool? smbNonBrowsableEnabled,
    bool? snapshotDirectoryVisible,
    required int storageQuotaInGb,
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      acceptGrowCapacityPoolForShortTermCloneSplit: map['acceptGrowCapacityPoolForShortTermCloneSplit'] == null ? null : map['acceptGrowCapacityPoolForShortTermCloneSplit'] as String,
      accountName: map['accountName'] as String,
      azureVmwareDataStoreEnabled: map['azureVmwareDataStoreEnabled'] == null ? null : map['azureVmwareDataStoreEnabled'] as bool,
      coolAccess: map['coolAccess'] == null ? null : VolumeCoolAccess.fromMap((map['coolAccess'] as Map).cast<String, dynamic>()),
      createFromSnapshotResourceId: map['createFromSnapshotResourceId'] == null ? null : map['createFromSnapshotResourceId'] as String,
      dataProtectionBackupPolicy: map['dataProtectionBackupPolicy'] == null ? null : VolumeDataProtectionBackupPolicy.fromMap((map['dataProtectionBackupPolicy'] as Map).cast<String, dynamic>()),
      dataProtectionReplication: map['dataProtectionReplication'] == null ? null : VolumeDataProtectionReplication.fromMap((map['dataProtectionReplication'] as Map).cast<String, dynamic>()),
      dataProtectionSnapshotPolicy: map['dataProtectionSnapshotPolicy'] == null ? null : VolumeDataProtectionSnapshotPolicy.fromMap((map['dataProtectionSnapshotPolicy'] as Map).cast<String, dynamic>()),
      encryptionKeySource: map['encryptionKeySource'] == null ? null : map['encryptionKeySource'] as String,
      exportPolicyRules: map['exportPolicyRules'] == null ? null : pulumi.Input.decodeList<VolumeExportPolicyRule>(map['exportPolicyRules'], (value) => VolumeExportPolicyRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      largeVolumeEnabled: map['largeVolumeEnabled'] == null ? null : map['largeVolumeEnabled'] as bool,
      ...
      smb3ProtocolEncryptionEnabled: map['smb3ProtocolEncryptionEnabled'] == null ? null : map['smb3ProtocolEncryptionEnabled'] as bool,
      smbAccessBasedEnumerationEnabled: map['smbAccessBasedEnumerationEnabled'] == null ? null : map['smbAccessBasedEnumerationEnabled'] as bool,
      smbContinuousAvailabilityEnabled: map['smbContinuousAvailabilityEnabled'] == null ? null : map['smbContinuousAvailabilityEnabled'] as bool,
      smbNonBrowsableEnabled: map['smbNonBrowsableEnabled'] == null ? null : map['smbNonBrowsableEnabled'] as bool,
      ...
      throughputInMibps: map['throughputInMibps'] == null ? null : map['throughputInMibps'] as double,
