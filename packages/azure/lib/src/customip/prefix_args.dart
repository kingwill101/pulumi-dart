...
/// {@template pulumi_customip_prefix_prefix_args_doc}
/// The set of arguments for Prefix.
/// {@endtemplate}
/// {@macro pulumi_customip_prefix_prefix_args_doc}
class PrefixArgs {
  ...
  PrefixArgs({
    ...
    bool? internetAdvertisingDisabled,
    String? location,
    String? name,
  ...
  factory PrefixArgs.fromMap(Map<String, dynamic> map) {
    return PrefixArgs(
      ...
      commissioningEnabled: map['commissioningEnabled'] == null ? null : map['commissioningEnabled'] as bool,
      internetAdvertisingDisabled: map['internetAdvertisingDisabled'] == null ? null : map['internetAdvertisingDisabled'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parentCustomIpPrefixId: map['parentCustomIpPrefixId'] == null ? null : map['parentCustomIpPrefixId'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      roaValidityEndDate: map['roaValidityEndDate'] == null ? null : map['roaValidityEndDate'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      wanValidationSignedMessage: map['wanValidationSignedMessage'] == null ? null : map['wanValidationSignedMessage'] as String,
