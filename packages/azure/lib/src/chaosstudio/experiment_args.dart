...
class ExperimentArgs {
  ...
  ExperimentArgs({
    ...
    required List<ExperimentSelector> selectors,
    required List<ExperimentStep> steps,
  }) :
  ...
  factory ExperimentArgs.fromMap(Map<String, dynamic> map) {
    return ExperimentArgs(
      ...
      selectors: pulumi.Input.decodeList<ExperimentSelector>(map['selectors'], (value) => ExperimentSelector.fromMap((value as Map).cast<String, dynamic>())),
      steps: pulumi.Input.decodeList<ExperimentStep>(map['steps'], (value) => ExperimentStep.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
