...
class MongoRoleDefinitionArgs {
  ...
  MongoRoleDefinitionArgs({
    required String cosmosMongoDatabaseId,
    List<String>? inheritedRoleNames,
    List<MongoRoleDefinitionPrivilege>? privileges,
  ...
  factory MongoRoleDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return MongoRoleDefinitionArgs(
      cosmosMongoDatabaseId: map['cosmosMongoDatabaseId'] as String,
      inheritedRoleNames: map['inheritedRoleNames'] == null ? null : (map['inheritedRoleNames'] as List).cast<String>(),
      privileges: map['privileges'] == null ? null : pulumi.Input.decodeList<MongoRoleDefinitionPrivilege>(map['privileges'], (value) => MongoRoleDefinitionPrivilege.fromMap((value as Map).cast<String, dynamic>())),
