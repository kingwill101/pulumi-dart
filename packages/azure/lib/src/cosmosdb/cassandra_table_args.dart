...
class CassandraTableArgs {
  ...
  CassandraTableArgs({
    ...
    CassandraTableAutoscaleSettings? autoscaleSettings,
    required String cassandraKeyspaceId,
    int? defaultTtl,
    String? name,
    required CassandraTableSchema schema,
    int? throughput,
  }) :
      ...
      cassandraKeyspaceId = pulumi.Input.asInput<String>(cassandraKeyspaceId),
      defaultTtl = pulumi.Input.asOptionalInput<int>(defaultTtl),
      name = pulumi.Input.asOptionalInput<String>(name),
      schema = pulumi.Input.asInput<CassandraTableSchema>(schema),
  ...
  factory CassandraTableArgs.fromMap(Map<String, dynamic> map) {
    return CassandraTableArgs(
      ...
      autoscaleSettings: map['autoscaleSettings'] == null ? null : CassandraTableAutoscaleSettings.fromMap((map['autoscaleSettings'] as Map).cast<String, dynamic>()),
      cassandraKeyspaceId: map['cassandraKeyspaceId'] as String,
      defaultTtl: map['defaultTtl'] == null ? null : map['defaultTtl'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      schema: CassandraTableSchema.fromMap((map['schema'] as Map).cast<String, dynamic>()),
