...
class CassandraClusterArgs {
  ...
  CassandraClusterArgs({
    ...
    List<String>? clientCertificatePems,
    required String defaultAdminPassword,
    required String delegatedManagementSubnetId,
    List<String>? externalGossipCertificatePems,
    List<String>? externalSeedNodeIpAddresses,
    int? hoursBetweenBackups,
    CassandraClusterIdentity? identity,
    String? location,
    String? name,
    bool? repairEnabled,
  ...
  factory CassandraClusterArgs.fromMap(Map<String, dynamic> map) {
    return CassandraClusterArgs(
      ...
      clientCertificatePems: map['clientCertificatePems'] == null ? null : (map['clientCertificatePems'] as List).cast<String>(),
      defaultAdminPassword: map['defaultAdminPassword'] as String,
      delegatedManagementSubnetId: map['delegatedManagementSubnetId'] as String,
      externalGossipCertificatePems: map['externalGossipCertificatePems'] == null ? null : (map['externalGossipCertificatePems'] as List).cast<String>(),
      externalSeedNodeIpAddresses: map['externalSeedNodeIpAddresses'] == null ? null : (map['externalSeedNodeIpAddresses'] as List).cast<String>(),
      hoursBetweenBackups: map['hoursBetweenBackups'] == null ? null : map['hoursBetweenBackups'] as int,
      identity: map['identity'] == null ? null : CassandraClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
