...
import 'mongo_database_args.dart';
...
class MongoDatabase extends pulumi.CustomResource {
  ...
  late final pulumi.Output<MongoDatabaseAutoscaleSettings?> autoscaleSettings;
  ...
  /// [args] Arguments used to configure this [MongoDatabase]. {@macro pulumi_cosmosdb_mongo_database_mongo_database_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  MongoDatabase(
    String name, {
    MongoDatabaseArgs? args,
    ...
    this.autoscaleSettings = registerOutput<MongoDatabaseAutoscaleSettings?>('autoscaleSettings');
