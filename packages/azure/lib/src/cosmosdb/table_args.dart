...
class TableArgs {
  ...
  TableArgs({
    ...
    TableAutoscaleSettings? autoscaleSettings,
    String? name,
  ...
  factory TableArgs.fromMap(Map<String, dynamic> map) {
    return TableArgs(
      ...
      autoscaleSettings: map['autoscaleSettings'] == null ? null : TableAutoscaleSettings.fromMap((map['autoscaleSettings'] as Map).cast<String, dynamic>()),
