...
class MongoCollectionArgs {
  ...
  MongoCollectionArgs({
    ...
    MongoCollectionAutoscaleSettings? autoscaleSettings,
    required String databaseName,
    int? defaultTtlSeconds,
    List<MongoCollectionIndex>? indices,
    String? name,
  ...
  factory MongoCollectionArgs.fromMap(Map<String, dynamic> map) {
    return MongoCollectionArgs(
      ...
      autoscaleSettings: map['autoscaleSettings'] == null ? null : MongoCollectionAutoscaleSettings.fromMap((map['autoscaleSettings'] as Map).cast<String, dynamic>()),
      databaseName: map['databaseName'] as String,
      defaultTtlSeconds: map['defaultTtlSeconds'] == null ? null : map['defaultTtlSeconds'] as int,
      indices: map['indices'] == null ? null : pulumi.Input.decodeList<MongoCollectionIndex>(map['indices'], (value) => MongoCollectionIndex.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      shardKey: map['shardKey'] == null ? null : map['shardKey'] as String,
