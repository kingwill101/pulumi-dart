...
class GremlinDatabaseArgs {
  ...
  GremlinDatabaseArgs({
    ...
    GremlinDatabaseAutoscaleSettings? autoscaleSettings,
    String? name,
  ...
  factory GremlinDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return GremlinDatabaseArgs(
      ...
      autoscaleSettings: map['autoscaleSettings'] == null ? null : GremlinDatabaseAutoscaleSettings.fromMap((map['autoscaleSettings'] as Map).cast<String, dynamic>()),
