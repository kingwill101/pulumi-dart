...
class MongoDatabaseArgs {
  ...
  MongoDatabaseArgs({
    ...
    MongoDatabaseAutoscaleSettings? autoscaleSettings,
    String? name,
  ...
  factory MongoDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return MongoDatabaseArgs(
      ...
      autoscaleSettings: map['autoscaleSettings'] == null ? null : MongoDatabaseAutoscaleSettings.fromMap((map['autoscaleSettings'] as Map).cast<String, dynamic>()),
