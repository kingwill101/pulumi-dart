...
class CassandraKeyspaceArgs {
  ...
  CassandraKeyspaceArgs({
    ...
    CassandraKeyspaceAutoscaleSettings? autoscaleSettings,
    String? name,
  ...
  factory CassandraKeyspaceArgs.fromMap(Map<String, dynamic> map) {
    return CassandraKeyspaceArgs(
      ...
      autoscaleSettings: map['autoscaleSettings'] == null ? null : CassandraKeyspaceAutoscaleSettings.fromMap((map['autoscaleSettings'] as Map).cast<String, dynamic>()),
