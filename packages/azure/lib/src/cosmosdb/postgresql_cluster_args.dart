...
class PostgresqlClusterArgs {
  ...
  PostgresqlClusterArgs({
    ...
    String? citusVersion,
    bool? coordinatorPublicIpAccessEnabled,
    String? coordinatorServerEdition,
    int? coordinatorStorageQuotaInMb,
    int? coordinatorVcoreCount,
    bool? haEnabled,
    String? location,
    PostgresqlClusterMaintenanceWindow? maintenanceWindow,
    String? name,
    required int nodeCount,
    bool? nodePublicIpAccessEnabled,
    ...
    bool? shardsOnCoordinatorEnabled,
  ...
  factory PostgresqlClusterArgs.fromMap(Map<String, dynamic> map) {
    return PostgresqlClusterArgs(
      ...
      coordinatorPublicIpAccessEnabled: map['coordinatorPublicIpAccessEnabled'] == null ? null : map['coordinatorPublicIpAccessEnabled'] as bool,
      ...
      coordinatorVcoreCount: map['coordinatorVcoreCount'] == null ? null : map['coordinatorVcoreCount'] as int,
      haEnabled: map['haEnabled'] == null ? null : map['haEnabled'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : PostgresqlClusterMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      nodeCount: map['nodeCount'] as int,
      nodePublicIpAccessEnabled: map['nodePublicIpAccessEnabled'] == null ? null : map['nodePublicIpAccessEnabled'] as bool,
      ...
      pointInTimeInUtc: map['pointInTimeInUtc'] == null ? null : map['pointInTimeInUtc'] as String,
      preferredPrimaryZone: map['preferredPrimaryZone'] == null ? null : map['preferredPrimaryZone'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      shardsOnCoordinatorEnabled: map['shardsOnCoordinatorEnabled'] == null ? null : map['shardsOnCoordinatorEnabled'] as bool,
      ...
      sqlVersion: map['sqlVersion'] == null ? null : map['sqlVersion'] as String,
