...
class SqlRoleDefinitionArgs {
  ...
  SqlRoleDefinitionArgs({
    ...
    required List<String> assignableScopes,
    String? name,
    required List<SqlRoleDefinitionPermission> permissions,
  ...
  factory SqlRoleDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return SqlRoleDefinitionArgs(
      ...
      permissions: pulumi.Input.decodeList<SqlRoleDefinitionPermission>(map['permissions'], (value) => SqlRoleDefinitionPermission.fromMap((value as Map).cast<String, dynamic>())),
