...
class SpringCloudConfigurationServiceArgs {
  ...
  SpringCloudConfigurationServiceArgs({
    ...
    List<SpringCloudConfigurationServiceRepository>? repositories,
  ...
  factory SpringCloudConfigurationServiceArgs.fromMap(Map<String, dynamic> map) {
    return SpringCloudConfigurationServiceArgs(
      ...
      repositories: map['repositories'] == null ? null : pulumi.Input.decodeList<SpringCloudConfigurationServiceRepository>(map['repositories'], (value) => SpringCloudConfigurationServiceRepository.fromMap((value as Map).cast<String, dynamic>())),
