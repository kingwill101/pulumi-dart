...
class SpringCloudGatewayRouteConfigArgs {
  ...
  SpringCloudGatewayRouteConfigArgs({
    List<String>? filters,
    String? name,
    SpringCloudGatewayRouteConfigOpenApi? openApi,
    List<String>? predicates,
    required String protocol,
    List<SpringCloudGatewayRouteConfigRoute>? routes,
  ...
  factory SpringCloudGatewayRouteConfigArgs.fromMap(Map<String, dynamic> map) {
    return SpringCloudGatewayRouteConfigArgs(
      ...
      openApi: map['openApi'] == null ? null : SpringCloudGatewayRouteConfigOpenApi.fromMap((map['openApi'] as Map).cast<String, dynamic>()),
      predicates: map['predicates'] == null ? null : (map['predicates'] as List).cast<String>(),
      protocol: map['protocol'] as String,
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<SpringCloudGatewayRouteConfigRoute>(map['routes'], (value) => SpringCloudGatewayRouteConfigRoute.fromMap((value as Map).cast<String, dynamic>())),
      springCloudAppId: map['springCloudAppId'] == null ? null : map['springCloudAppId'] as String,
