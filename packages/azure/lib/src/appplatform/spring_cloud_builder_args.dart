...
class SpringCloudBuilderArgs {
  ...
  SpringCloudBuilderArgs({
    required List<SpringCloudBuilderBuildPackGroup> buildPackGroups,
    String? name,
    required String springCloudServiceId,
    required SpringCloudBuilderStack stack,
  }) :
  ...
  factory SpringCloudBuilderArgs.fromMap(Map<String, dynamic> map) {
    return SpringCloudBuilderArgs(
      buildPackGroups: pulumi.Input.decodeList<SpringCloudBuilderBuildPackGroup>(map['buildPackGroups'], (value) => SpringCloudBuilderBuildPackGroup.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      springCloudServiceId: map['springCloudServiceId'] as String,
      stack: SpringCloudBuilderStack.fromMap((map['stack'] as Map).cast<String, dynamic>()),
    );
  }
}
