...
class SpringCloudBuildPackBindingArgs {
  ...
  SpringCloudBuildPackBindingArgs({
    String? bindingType,
    SpringCloudBuildPackBindingLaunch? launch,
    String? name,
    required String springCloudBuilderId,
  }) :
  ...
  factory SpringCloudBuildPackBindingArgs.fromMap(Map<String, dynamic> map) {
    return SpringCloudBuildPackBindingArgs(
      ...
      launch: map['launch'] == null ? null : SpringCloudBuildPackBindingLaunch.fromMap((map['launch'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      springCloudBuilderId: map['springCloudBuilderId'] as String,
    );
  }
}
