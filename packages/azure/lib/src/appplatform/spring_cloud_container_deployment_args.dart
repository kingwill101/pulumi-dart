...
class SpringCloudContainerDeploymentArgs {
  ...
  SpringCloudContainerDeploymentArgs({
    ...
    String? name,
    SpringCloudContainerDeploymentQuota? quota,
  ...
  factory SpringCloudContainerDeploymentArgs.fromMap(Map<String, dynamic> map) {
    return SpringCloudContainerDeploymentArgs(
      ...
      arguments: map['arguments'] == null ? null : (map['arguments'] as List).cast<String>(),
      ...
      quota: map['quota'] == null ? null : SpringCloudContainerDeploymentQuota.fromMap((map['quota'] as Map).cast<String, dynamic>()),
