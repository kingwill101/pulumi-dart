...
class SpringCloudServiceArgs {
  ...
  SpringCloudServiceArgs({
    ...
    SpringCloudServiceConfigServerGitSetting? configServerGitSetting,
    List<SpringCloudServiceContainerRegistry>? containerRegistries,
    SpringCloudServiceDefaultBuildService? defaultBuildService,
    String? location,
    bool? logStreamPublicEndpointEnabled,
    String? managedEnvironmentId,
    SpringCloudServiceMarketplace? marketplace,
    String? name,
    SpringCloudServiceNetwork? network,
    required String resourceGroupName,
    bool? serviceRegistryEnabled,
    String? skuName,
    String? skuTier,
    Map<String, String>? tags,
    SpringCloudServiceTrace? trace,
    bool? zoneRedundant,
  }) :
  ...
  factory SpringCloudServiceArgs.fromMap(Map<String, dynamic> map) {
    return SpringCloudServiceArgs(
      buildAgentPoolSize: map['buildAgentPoolSize'] == null ? null : map['buildAgentPoolSize'] as String,
      configServerGitSetting: map['configServerGitSetting'] == null ? null : SpringCloudServiceConfigServerGitSetting.fromMap((map['configServerGitSetting'] as Map).cast<String, dynamic>()),
      containerRegistries: map['containerRegistries'] == null ? null : pulumi.Input.decodeList<SpringCloudServiceContainerRegistry>(map['containerRegistries'], (value) => SpringCloudServiceContainerRegistry.fromMap((value as Map).cast<String, dynamic>())),
      defaultBuildService: map['defaultBuildService'] == null ? null : SpringCloudServiceDefaultBuildService.fromMap((map['defaultBuildService'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      logStreamPublicEndpointEnabled: map['logStreamPublicEndpointEnabled'] == null ? null : map['logStreamPublicEndpointEnabled'] as bool,
      managedEnvironmentId: map['managedEnvironmentId'] == null ? null : map['managedEnvironmentId'] as String,
      marketplace: map['marketplace'] == null ? null : SpringCloudServiceMarketplace.fromMap((map['marketplace'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : SpringCloudServiceNetwork.fromMap((map['network'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      serviceRegistryEnabled: map['serviceRegistryEnabled'] == null ? null : map['serviceRegistryEnabled'] as bool,
      skuName: map['skuName'] == null ? null : map['skuName'] as String,
      skuTier: map['skuTier'] == null ? null : map['skuTier'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      trace: map['trace'] == null ? null : SpringCloudServiceTrace.fromMap((map['trace'] as Map).cast<String, dynamic>()),
