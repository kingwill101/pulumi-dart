...
class GetDeploymentResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'autoScaleProfiles': pulumi.Input.encodeList<GetDeploymentAutoScaleProfile, Map<String, dynamic>>(autoScaleProfiles, (value) => value.toMap()),
      ...
      'email': email,
      'frontendPrivates': pulumi.Input.encodeList<GetDeploymentFrontendPrivate, Map<String, dynamic>>(frontendPrivates, (value) => value.toMap()),
      'frontendPublics': pulumi.Input.encodeList<GetDeploymentFrontendPublic, Map<String, dynamic>>(frontendPublics, (value) => value.toMap()),
      'id': id,
      'identities': pulumi.Input.encodeList<GetDeploymentIdentity, Map<String, dynamic>>(identities, (value) => value.toMap()),
      'ipAddress': ipAddress,
      'location': location,
      'loggingStorageAccounts': pulumi.Input.encodeList<GetDeploymentLoggingStorageAccount, Map<String, dynamic>>(loggingStorageAccounts, (value) => value.toMap()),
      'managedResourceGroup': managedResourceGroup,
      'name': name,
      'networkInterfaces': pulumi.Input.encodeList<GetDeploymentNetworkInterface, Map<String, dynamic>>(networkInterfaces, (value) => value.toMap()),
      'nginxVersion': nginxVersion,
      'resourceGroupName': resourceGroupName,
      'sku': sku,
      'tags': tags,
      'webApplicationFirewalls': pulumi.Input.encodeList<GetDeploymentWebApplicationFirewall, Map<String, dynamic>>(webApplicationFirewalls, (value) => value.toMap()),
    };
  }

  factory GetDeploymentResult.fromMap(Map<String, dynamic> map) {
    return GetDeploymentResult(
      autoScaleProfiles: pulumi.Input.decodeList<GetDeploymentAutoScaleProfile>(map['autoScaleProfiles'], (value) => GetDeploymentAutoScaleProfile.fromMap((value as Map).cast<String, dynamic>())),
      ...
      frontendPrivates: pulumi.Input.decodeList<GetDeploymentFrontendPrivate>(map['frontendPrivates'], (value) => GetDeploymentFrontendPrivate.fromMap((value as Map).cast<String, dynamic>())),
      frontendPublics: pulumi.Input.decodeList<GetDeploymentFrontendPublic>(map['frontendPublics'], (value) => GetDeploymentFrontendPublic.fromMap((value as Map).cast<String, dynamic>())),
      id: map['id'] as String,
      identities: pulumi.Input.decodeList<GetDeploymentIdentity>(map['identities'], (value) => GetDeploymentIdentity.fromMap((value as Map).cast<String, dynamic>())),
      ipAddress: map['ipAddress'] as String,
      location: map['location'] as String,
      loggingStorageAccounts: pulumi.Input.decodeList<GetDeploymentLoggingStorageAccount>(map['loggingStorageAccounts'], (value) => GetDeploymentLoggingStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
      managedResourceGroup: map['managedResourceGroup'] as String,
      name: map['name'] as String,
      networkInterfaces: pulumi.Input.decodeList<GetDeploymentNetworkInterface>(map['networkInterfaces'], (value) => GetDeploymentNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      nginxVersion: map['nginxVersion'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sku: map['sku'] as String,
      tags: (map['tags'] as Map).cast<String, String>(),
      webApplicationFirewalls: pulumi.Input.decodeList<GetDeploymentWebApplicationFirewall>(map['webApplicationFirewalls'], (value) => GetDeploymentWebApplicationFirewall.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
