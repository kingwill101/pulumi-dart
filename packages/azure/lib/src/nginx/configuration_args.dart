...
class ConfigurationArgs {
  ...
  ConfigurationArgs({
    List<ConfigurationConfigFile>? configFiles,
    required String nginxDeploymentId,
    String? packageData,
    List<ConfigurationProtectedFile>? protectedFiles,
  ...
  factory ConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return ConfigurationArgs(
      configFiles: map['configFiles'] == null ? null : pulumi.Input.decodeList<ConfigurationConfigFile>(map['configFiles'], (value) => ConfigurationConfigFile.fromMap((value as Map).cast<String, dynamic>())),
      nginxDeploymentId: map['nginxDeploymentId'] as String,
      packageData: map['packageData'] == null ? null : map['packageData'] as String,
      protectedFiles: map['protectedFiles'] == null ? null : pulumi.Input.decodeList<ConfigurationProtectedFile>(map['protectedFiles'], (value) => ConfigurationProtectedFile.fromMap((value as Map).cast<String, dynamic>())),
