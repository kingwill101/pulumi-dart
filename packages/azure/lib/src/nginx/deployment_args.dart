...
class DeploymentArgs {
  ...
  DeploymentArgs({
    List<DeploymentAutoScaleProfile>? autoScaleProfiles,
    String? automaticUpgradeChannel,
    int? capacity,
    bool? diagnoseSupportEnabled,
    String? email,
    List<DeploymentFrontendPrivate>? frontendPrivates,
    DeploymentFrontendPublic? frontendPublic,
    DeploymentIdentity? identity,
    String? location,
    List<DeploymentLoggingStorageAccount>? loggingStorageAccounts,
    String? managedResourceGroup,
    String? name,
    List<DeploymentNetworkInterface>? networkInterfaces,
    required String resourceGroupName,
    required String sku,
    Map<String, String>? tags,
    DeploymentWebApplicationFirewall? webApplicationFirewall,
  }) :
  ...
  factory DeploymentArgs.fromMap(Map<String, dynamic> map) {
    return DeploymentArgs(
      autoScaleProfiles: map['autoScaleProfiles'] == null ? null : pulumi.Input.decodeList<DeploymentAutoScaleProfile>(map['autoScaleProfiles'], (value) => DeploymentAutoScaleProfile.fromMap((value as Map).cast<String, dynamic>())),
      automaticUpgradeChannel: map['automaticUpgradeChannel'] == null ? null : map['automaticUpgradeChannel'] as String,
      capacity: map['capacity'] == null ? null : map['capacity'] as int,
      diagnoseSupportEnabled: map['diagnoseSupportEnabled'] == null ? null : map['diagnoseSupportEnabled'] as bool,
      email: map['email'] == null ? null : map['email'] as String,
      frontendPrivates: map['frontendPrivates'] == null ? null : pulumi.Input.decodeList<DeploymentFrontendPrivate>(map['frontendPrivates'], (value) => DeploymentFrontendPrivate.fromMap((value as Map).cast<String, dynamic>())),
      frontendPublic: map['frontendPublic'] == null ? null : DeploymentFrontendPublic.fromMap((map['frontendPublic'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : DeploymentIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      loggingStorageAccounts: map['loggingStorageAccounts'] == null ? null : pulumi.Input.decodeList<DeploymentLoggingStorageAccount>(map['loggingStorageAccounts'], (value) => DeploymentLoggingStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
      managedResourceGroup: map['managedResourceGroup'] == null ? null : map['managedResourceGroup'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<DeploymentNetworkInterface>(map['networkInterfaces'], (value) => DeploymentNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      sku: map['sku'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      webApplicationFirewall: map['webApplicationFirewall'] == null ? null : DeploymentWebApplicationFirewall.fromMap((map['webApplicationFirewall'] as Map).cast<String, dynamic>()),
    );
  }
}
