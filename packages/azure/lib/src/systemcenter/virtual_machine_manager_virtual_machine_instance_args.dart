...
class VirtualMachineManagerVirtualMachineInstanceArgs {
  ...
  VirtualMachineManagerVirtualMachineInstanceArgs({
    ...
    VirtualMachineManagerVirtualMachineInstanceHardware? hardware,
    required VirtualMachineManagerVirtualMachineInstanceInfrastructure infrastructure,
    List<VirtualMachineManagerVirtualMachineInstanceNetworkInterface>? networkInterfaces,
    VirtualMachineManagerVirtualMachineInstanceOperatingSystem? operatingSystem,
    required String scopedResourceId,
    List<VirtualMachineManagerVirtualMachineInstanceStorageDisk>? storageDisks,
    List<String>? systemCenterVirtualMachineManagerAvailabilitySetIds,
  }) :
  ...
  factory VirtualMachineManagerVirtualMachineInstanceArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineManagerVirtualMachineInstanceArgs(
      ...
      hardware: map['hardware'] == null ? null : VirtualMachineManagerVirtualMachineInstanceHardware.fromMap((map['hardware'] as Map).cast<String, dynamic>()),
      infrastructure: VirtualMachineManagerVirtualMachineInstanceInfrastructure.fromMap((map['infrastructure'] as Map).cast<String, dynamic>()),
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<VirtualMachineManagerVirtualMachineInstanceNetworkInterface>(map['networkInterfaces'], (value) => VirtualMachineManagerVirtualMachineInstanceNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      operatingSystem: map['operatingSystem'] == null ? null : VirtualMachineManagerVirtualMachineInstanceOperatingSystem.fromMap((map['operatingSystem'] as Map).cast<String, dynamic>()),
      scopedResourceId: map['scopedResourceId'] as String,
      storageDisks: map['storageDisks'] == null ? null : pulumi.Input.decodeList<VirtualMachineManagerVirtualMachineInstanceStorageDisk>(map['storageDisks'], (value) => VirtualMachineManagerVirtualMachineInstanceStorageDisk.fromMap((value as Map).cast<String, dynamic>())),
      systemCenterVirtualMachineManagerAvailabilitySetIds: map['systemCenterVirtualMachineManagerAvailabilitySetIds'] == null ? null : (map['systemCenterVirtualMachineManagerAvailabilitySetIds'] as List).cast<String>(),
    );
  }
}
