...
class FlexibleServerArgs {
  ...
  FlexibleServerArgs({
    ...
    FlexibleServerAuthentication? authentication,
    bool? autoGrowEnabled,
    int? backupRetentionDays,
    FlexibleServerCluster? cluster,
    String? createMode,
  ...
  factory FlexibleServerArgs.fromMap(Map<String, dynamic> map) {
    return FlexibleServerArgs(
      ...
      authentication: map['authentication'] == null ? null : FlexibleServerAuthentication.fromMap((map['authentication'] as Map).cast<String, dynamic>()),
      ...
      cluster: map['cluster'] == null ? null : FlexibleServerCluster.fromMap((map['cluster'] as Map).cast<String, dynamic>()),
