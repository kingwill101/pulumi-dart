...
class ServerArgs {
  ...
  ServerArgs({
    ...
    required bool sslEnforcementEnabled,
    String? sslMinimalTlsVersionEnforced,
    int? storageMb,
    Map<String, String>? tags,
    ServerThreatDetectionPolicy? threatDetectionPolicy,
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      ...
      creationSourceServerId: map['creationSourceServerId'] == null ? null : map['creationSourceServerId'] as String,
      ...
      sslEnforcementEnabled: map['sslEnforcementEnabled'] as bool,
      sslMinimalTlsVersionEnforced: map['sslMinimalTlsVersionEnforced'] == null ? null : map['sslMinimalTlsVersionEnforced'] as String,
      storageMb: map['storageMb'] == null ? null : map['storageMb'] as int,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      threatDetectionPolicy: map['threatDetectionPolicy'] == null ? null : ServerThreatDetectionPolicy.fromMap((map['threatDetectionPolicy'] as Map).cast<String, dynamic>()),
