...
class ProfileArgs {
  ...
  ProfileArgs({
    required ProfileDnsConfig dnsConfig,
    int? maxReturn,
    required ProfileMonitorConfig monitorConfig,
    String? name,
    String? profileStatus,
    required String resourceGroupName,
    Map<String, String>? tags,
    required String trafficRoutingMethod,
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      dnsConfig: ProfileDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      maxReturn: map['maxReturn'] == null ? null : map['maxReturn'] as int,
      monitorConfig: ProfileMonitorConfig.fromMap((map['monitorConfig'] as Map).cast<String, dynamic>()),
