...
class FrontdoorArgs {
  ...
  FrontdoorArgs({
    required List<FrontdoorBackendPoolHealthProbe> backendPoolHealthProbes,
    required List<FrontdoorBackendPoolLoadBalancing> backendPoolLoadBalancings,
    List<FrontdoorBackendPoolSetting>? backendPoolSettings,
    required List<FrontdoorBackendPool> backendPools,
    String? friendlyName,
    required List<FrontdoorFrontendEndpoint> frontendEndpoints,
    bool? loadBalancerEnabled,
    String? name,
    required String resourceGroupName,
    required List<FrontdoorRoutingRule> routingRules,
  ...
  factory FrontdoorArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorArgs(
      backendPoolHealthProbes: pulumi.Input.decodeList<FrontdoorBackendPoolHealthProbe>(map['backendPoolHealthProbes'], (value) => FrontdoorBackendPoolHealthProbe.fromMap((value as Map).cast<String, dynamic>())),
      backendPoolLoadBalancings: pulumi.Input.decodeList<FrontdoorBackendPoolLoadBalancing>(map['backendPoolLoadBalancings'], (value) => FrontdoorBackendPoolLoadBalancing.fromMap((value as Map).cast<String, dynamic>())),
      backendPoolSettings: map['backendPoolSettings'] == null ? null : pulumi.Input.decodeList<FrontdoorBackendPoolSetting>(map['backendPoolSettings'], (value) => FrontdoorBackendPoolSetting.fromMap((value as Map).cast<String, dynamic>())),
      backendPools: pulumi.Input.decodeList<FrontdoorBackendPool>(map['backendPools'], (value) => FrontdoorBackendPool.fromMap((value as Map).cast<String, dynamic>())),
      friendlyName: map['friendlyName'] == null ? null : map['friendlyName'] as String,
      frontendEndpoints: pulumi.Input.decodeList<FrontdoorFrontendEndpoint>(map['frontendEndpoints'], (value) => FrontdoorFrontendEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      loadBalancerEnabled: map['loadBalancerEnabled'] == null ? null : map['loadBalancerEnabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      routingRules: pulumi.Input.decodeList<FrontdoorRoutingRule>(map['routingRules'], (value) => FrontdoorRoutingRule.fromMap((value as Map).cast<String, dynamic>())),
