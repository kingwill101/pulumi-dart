...
class CustomHttpsConfigurationCustomHttpsConfiguration {
  ...
  final String? azureKeyVaultCertificateSecretName;
  ...
  final String? azureKeyVaultCertificateSecretVersion;
  /// The ID of the Key Vault containing the SSL certificate.
  final String? azureKeyVaultCertificateVaultId;
  ...
  final String? provisioningSubstate;
  ...
  factory CustomHttpsConfigurationCustomHttpsConfiguration.fromMap(Map<String, dynamic> map) {
    return CustomHttpsConfigurationCustomHttpsConfiguration(
      azureKeyVaultCertificateSecretName: map['azureKeyVaultCertificateSecretName'] == null ? null : map['azureKeyVaultCertificateSecretName'] as String,
      azureKeyVaultCertificateSecretVersion: map['azureKeyVaultCertificateSecretVersion'] == null ? null : map['azureKeyVaultCertificateSecretVersion'] as String,
      azureKeyVaultCertificateVaultId: map['azureKeyVaultCertificateVaultId'] == null ? null : map['azureKeyVaultCertificateVaultId'] as String,
      ...
      provisioningSubstate: map['provisioningSubstate'] == null ? null : map['provisioningSubstate'] as String,
    );
  }
}
