...
class CustomHttpsConfigurationArgs {
  ...
  CustomHttpsConfigurationArgs({
    CustomHttpsConfigurationCustomHttpsConfiguration? customHttpsConfiguration,
    required bool customHttpsProvisioningEnabled,
    required String frontendEndpointId,
  }) :
  ...
  factory CustomHttpsConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return CustomHttpsConfigurationArgs(
      customHttpsConfiguration: map['customHttpsConfiguration'] == null ? null : CustomHttpsConfigurationCustomHttpsConfiguration.fromMap((map['customHttpsConfiguration'] as Map).cast<String, dynamic>()),
      customHttpsProvisioningEnabled: map['customHttpsProvisioningEnabled'] as bool,
      frontendEndpointId: map['frontendEndpointId'] as String,
    );
  }
}
