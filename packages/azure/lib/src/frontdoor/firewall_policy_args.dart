...
class FirewallPolicyArgs {
  ...
  FirewallPolicyArgs({
    ...
    List<FirewallPolicyCustomRule>? customRules,
    bool? enabled,
    List<FirewallPolicyManagedRule>? managedRules,
    String? mode,
    String? name,
    String? redirectUrl,
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      ...
      customRules: map['customRules'] == null ? null : pulumi.Input.decodeList<FirewallPolicyCustomRule>(map['customRules'], (value) => FirewallPolicyCustomRule.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      managedRules: map['managedRules'] == null ? null : pulumi.Input.decodeList<FirewallPolicyManagedRule>(map['managedRules'], (value) => FirewallPolicyManagedRule.fromMap((value as Map).cast<String, dynamic>())),
