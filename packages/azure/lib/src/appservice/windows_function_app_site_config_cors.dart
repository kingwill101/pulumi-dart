...
class WindowsFunctionAppSiteConfigCors {
  ...
  /// Creates a new [WindowsFunctionAppSiteConfigCors].
  ...
  factory WindowsFunctionAppSiteConfigCors.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSiteConfigCors(
