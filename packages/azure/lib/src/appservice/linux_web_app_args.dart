...
class LinuxWebAppArgs {
  ...
  LinuxWebAppArgs({
    ...
    LinuxWebAppAuthSettings? authSettings,
    LinuxWebAppAuthSettingsV2? authSettingsV2,
    LinuxWebAppBackup? backup,
    bool? clientAffinityEnabled,
    bool? clientCertificateEnabled,
    String? clientCertificateExclusionPaths,
    String? clientCertificateMode,
    List<LinuxWebAppConnectionString>? connectionStrings,
    bool? enabled,
    bool? ftpPublishBasicAuthenticationEnabled,
    bool? httpsOnly,
    LinuxWebAppIdentity? identity,
    String? keyVaultReferenceIdentityId,
    String? location,
    LinuxWebAppLogs? logs,
    String? name,
    bool? publicNetworkAccessEnabled,
    required String resourceGroupName,
    required String servicePlanId,
    required LinuxWebAppSiteConfig siteConfig,
    LinuxWebAppStickySettings? stickySettings,
    List<LinuxWebAppStorageAccount>? storageAccounts,
  ...
  factory LinuxWebAppArgs.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppArgs(
      ...
      authSettings: map['authSettings'] == null ? null : LinuxWebAppAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>()),
      authSettingsV2: map['authSettingsV2'] == null ? null : LinuxWebAppAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>()),
      backup: map['backup'] == null ? null : LinuxWebAppBackup.fromMap((map['backup'] as Map).cast<String, dynamic>()),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Input.decodeList<LinuxWebAppConnectionString>(map['connectionStrings'], (value) => LinuxWebAppConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : LinuxWebAppIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      logs: map['logs'] == null ? null : LinuxWebAppLogs.fromMap((map['logs'] as Map).cast<String, dynamic>()),
      ...
      siteConfig: LinuxWebAppSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>()),
      stickySettings: map['stickySettings'] == null ? null : LinuxWebAppStickySettings.fromMap((map['stickySettings'] as Map).cast<String, dynamic>()),
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Input.decodeList<LinuxWebAppStorageAccount>(map['storageAccounts'], (value) => LinuxWebAppStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
