...
class AppServiceSiteConfigScmIpRestriction {
  ...
  final AppServiceSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory AppServiceSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return AppServiceSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : AppServiceSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
