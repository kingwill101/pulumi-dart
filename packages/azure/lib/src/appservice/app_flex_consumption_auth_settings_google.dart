...
class AppFlexConsumptionAuthSettingsGoogle {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsGoogle].
  ...
  factory AppFlexConsumptionAuthSettingsGoogle.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsGoogle(
