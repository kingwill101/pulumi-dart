...
class FunctionAppArgs {
  ...
  FunctionAppArgs({
    ...
    FunctionAppAuthSettings? authSettings,
    String? clientCertMode,
    List<FunctionAppConnectionString>? connectionStrings,
    int? dailyMemoryTimeQuota,
    bool? enableBuiltinLogging,
    bool? enabled,
    bool? httpsOnly,
    FunctionAppIdentity? identity,
    String? keyVaultReferenceIdentityId,
    String? location,
    String? name,
    String? osType,
    required String resourceGroupName,
    FunctionAppSiteConfig? siteConfig,
    FunctionAppSourceControl? sourceControl,
  ...
  factory FunctionAppArgs.fromMap(Map<String, dynamic> map) {
    return FunctionAppArgs(
      ...
      authSettings: map['authSettings'] == null ? null : FunctionAppAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>()),
      clientCertMode: map['clientCertMode'] == null ? null : map['clientCertMode'] as String,
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Input.decodeList<FunctionAppConnectionString>(map['connectionStrings'], (value) => FunctionAppConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      dailyMemoryTimeQuota: map['dailyMemoryTimeQuota'] == null ? null : map['dailyMemoryTimeQuota'] as int,
      enableBuiltinLogging: map['enableBuiltinLogging'] == null ? null : map['enableBuiltinLogging'] as bool,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      httpsOnly: map['httpsOnly'] == null ? null : map['httpsOnly'] as bool,
      identity: map['identity'] == null ? null : FunctionAppIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      siteConfig: map['siteConfig'] == null ? null : FunctionAppSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>()),
      sourceControl: map['sourceControl'] == null ? null : FunctionAppSourceControl.fromMap((map['sourceControl'] as Map).cast<String, dynamic>()),
