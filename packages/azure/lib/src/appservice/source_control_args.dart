...
class SourceControlArgs {
  ...
  SourceControlArgs({
    ...
    String? branch,
    SourceControlGithubActionConfiguration? githubActionConfiguration,
    String? repoUrl,
  ...
  factory SourceControlArgs.fromMap(Map<String, dynamic> map) {
    return SourceControlArgs(
      ...
      githubActionConfiguration: map['githubActionConfiguration'] == null ? null : SourceControlGithubActionConfiguration.fromMap((map['githubActionConfiguration'] as Map).cast<String, dynamic>()),
