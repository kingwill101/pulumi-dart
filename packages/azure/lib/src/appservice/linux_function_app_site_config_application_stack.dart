...
class LinuxFunctionAppSiteConfigApplicationStack {
  ...
  final List<LinuxFunctionAppSiteConfigApplicationStackDocker>? dockers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dockers': ?dockers == null ? null : pulumi.Input.encodeList<LinuxFunctionAppSiteConfigApplicationStackDocker, Map<String, dynamic>>(dockers!, (value) => value.toMap()),
  ...
  factory LinuxFunctionAppSiteConfigApplicationStack.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSiteConfigApplicationStack(
      dockers: map['dockers'] == null ? null : pulumi.Input.decodeList<LinuxFunctionAppSiteConfigApplicationStackDocker>(map['dockers'], (value) => LinuxFunctionAppSiteConfigApplicationStackDocker.fromMap((value as Map).cast<String, dynamic>())),
