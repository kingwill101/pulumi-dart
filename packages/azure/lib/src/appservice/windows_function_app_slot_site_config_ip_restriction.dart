...
class WindowsFunctionAppSlotSiteConfigIpRestriction {
  ...
  final WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders? headers;
  ...
  factory WindowsFunctionAppSlotSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotSiteConfigIpRestriction(
      ...
      headers: map['headers'] == null ? null : WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
