...
class GetAppServiceResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'connectionStrings': pulumi.Input.encodeList<GetAppServiceConnectionString, Map<String, dynamic>>(connectionStrings, (value) => value.toMap()),
      ...
      'siteConfigs': pulumi.Input.encodeList<GetAppServiceSiteConfig, Map<String, dynamic>>(siteConfigs, (value) => value.toMap()),
      'siteCredentials': pulumi.Input.encodeList<GetAppServiceSiteCredential, Map<String, dynamic>>(siteCredentials, (value) => value.toMap()),
      'sourceControls': pulumi.Input.encodeList<GetAppServiceSourceControl, Map<String, dynamic>>(sourceControls, (value) => value.toMap()),
      'tags': tags,
    };
  }
  ...
  factory GetAppServiceResult.fromMap(Map<String, dynamic> map) {
    return GetAppServiceResult(
      ...
      connectionStrings: pulumi.Input.decodeList<GetAppServiceConnectionString>(map['connectionStrings'], (value) => GetAppServiceConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      ...
      siteConfigs: pulumi.Input.decodeList<GetAppServiceSiteConfig>(map['siteConfigs'], (value) => GetAppServiceSiteConfig.fromMap((value as Map).cast<String, dynamic>())),
      siteCredentials: pulumi.Input.decodeList<GetAppServiceSiteCredential>(map['siteCredentials'], (value) => GetAppServiceSiteCredential.fromMap((value as Map).cast<String, dynamic>())),
      sourceControls: pulumi.Input.decodeList<GetAppServiceSourceControl>(map['sourceControls'], (value) => GetAppServiceSourceControl.fromMap((value as Map).cast<String, dynamic>())),
