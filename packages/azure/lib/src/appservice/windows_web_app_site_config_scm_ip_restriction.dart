...
class WindowsWebAppSiteConfigScmIpRestriction {
  ...
  final WindowsWebAppSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory WindowsWebAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : WindowsWebAppSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
