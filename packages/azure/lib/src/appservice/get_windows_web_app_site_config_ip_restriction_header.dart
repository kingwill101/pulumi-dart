...
class GetWindowsWebAppSiteConfigIpRestrictionHeader {
  ...
  /// Creates a new [GetWindowsWebAppSiteConfigIpRestrictionHeader].
  ...
  factory GetWindowsWebAppSiteConfigIpRestrictionHeader.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppSiteConfigIpRestrictionHeader(
