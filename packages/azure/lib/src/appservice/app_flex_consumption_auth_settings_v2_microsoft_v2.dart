...
class AppFlexConsumptionAuthSettingsV2MicrosoftV2 {
  ...
  /// Creates a new [AppFlexConsumptionAuthSettingsV2MicrosoftV2].
  ...
  factory AppFlexConsumptionAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionAuthSettingsV2MicrosoftV2(
