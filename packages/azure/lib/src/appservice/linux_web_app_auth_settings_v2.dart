...
import 'linux_web_app_auth_settings_v2_active_directory_v2.dart';
import 'linux_web_app_auth_settings_v2_apple_v2.dart';
import 'linux_web_app_auth_settings_v2_azure_static_web_app_v2.dart';
import 'linux_web_app_auth_settings_v2_custom_oidc_v2.dart';
import 'linux_web_app_auth_settings_v2_facebook_v2.dart';
import 'linux_web_app_auth_settings_v2_github_v2.dart';
import 'linux_web_app_auth_settings_v2_google_v2.dart';
import 'linux_web_app_auth_settings_v2_login.dart';
import 'linux_web_app_auth_settings_v2_microsoft_v2.dart';
import 'linux_web_app_auth_settings_v2_twitter_v2.dart';

class LinuxWebAppAuthSettingsV2 {
  /// An `active_directory_v2` block as defined below.
  final LinuxWebAppAuthSettingsV2ActiveDirectoryV2? activeDirectoryV2;
  /// An `apple_v2` block as defined below.
  final LinuxWebAppAuthSettingsV2AppleV2? appleV2;
  /// Should the AuthV2 Settings be enabled. Defaults to `false`.
  final bool? authEnabled;
  /// An `azure_static_web_app_v2` block as defined below.
  final LinuxWebAppAuthSettingsV2AzureStaticWebAppV2? azureStaticWebAppV2;
  /// The path to the App Auth settings.
  ///
  /// > **Note:** Relative Paths are evaluated from the Site Root directory.
  final String? configFilePath;
  /// Zero or more `custom_oidc_v2` blocks as defined below.
  final List<LinuxWebAppAuthSettingsV2CustomOidcV2>? customOidcV2s;
  ...
  final LinuxWebAppAuthSettingsV2FacebookV2? facebookV2;
  ...
  final LinuxWebAppAuthSettingsV2GithubV2? githubV2;
  /// A `google_v2` block as defined below.
  final LinuxWebAppAuthSettingsV2GoogleV2? googleV2;
  /// The prefix that should precede all the authentication and authorisation paths. Defaults to `/.auth`.
  final String? httpRouteApiPrefix;
  /// A `login` block as defined below.
  final LinuxWebAppAuthSettingsV2Login login;
  /// A `microsoft_v2` block as defined below.
  final LinuxWebAppAuthSettingsV2MicrosoftV2? microsoftV2;
  ...
  final LinuxWebAppAuthSettingsV2TwitterV2? twitterV2;
  /// The action to take for requests made without authentication. Possible values include `RedirectToLoginPage`, `AllowAnonymous`, `Return401`, and `Return403`. Defaults to `RedirectToLoginPage`.
  final String? unauthenticatedAction;

  /// Creates a new [LinuxWebAppAuthSettingsV2].
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'customOidcV2s': ?customOidcV2s == null ? null : pulumi.Input.encodeList<LinuxWebAppAuthSettingsV2CustomOidcV2, Map<String, dynamic>>(customOidcV2s!, (value) => value.toMap()),
  ...
  factory LinuxWebAppAuthSettingsV2.fromMap(Map<String, dynamic> map) {
    return LinuxWebAppAuthSettingsV2(
      activeDirectoryV2: map['activeDirectoryV2'] == null ? null : LinuxWebAppAuthSettingsV2ActiveDirectoryV2.fromMap((map['activeDirectoryV2'] as Map).cast<String, dynamic>()),
      appleV2: map['appleV2'] == null ? null : LinuxWebAppAuthSettingsV2AppleV2.fromMap((map['appleV2'] as Map).cast<String, dynamic>()),
      authEnabled: map['authEnabled'] == null ? null : map['authEnabled'] as bool,
      azureStaticWebAppV2: map['azureStaticWebAppV2'] == null ? null : LinuxWebAppAuthSettingsV2AzureStaticWebAppV2.fromMap((map['azureStaticWebAppV2'] as Map).cast<String, dynamic>()),
      configFilePath: map['configFilePath'] == null ? null : map['configFilePath'] as String,
      customOidcV2s: map['customOidcV2s'] == null ? null : pulumi.Input.decodeList<LinuxWebAppAuthSettingsV2CustomOidcV2>(map['customOidcV2s'], (value) => LinuxWebAppAuthSettingsV2CustomOidcV2.fromMap((value as Map).cast<String, dynamic>())),
      ...
      facebookV2: map['facebookV2'] == null ? null : LinuxWebAppAuthSettingsV2FacebookV2.fromMap((map['facebookV2'] as Map).cast<String, dynamic>()),
      ...
      githubV2: map['githubV2'] == null ? null : LinuxWebAppAuthSettingsV2GithubV2.fromMap((map['githubV2'] as Map).cast<String, dynamic>()),
      googleV2: map['googleV2'] == null ? null : LinuxWebAppAuthSettingsV2GoogleV2.fromMap((map['googleV2'] as Map).cast<String, dynamic>()),
      httpRouteApiPrefix: map['httpRouteApiPrefix'] == null ? null : map['httpRouteApiPrefix'] as String,
      login: LinuxWebAppAuthSettingsV2Login.fromMap((map['login'] as Map).cast<String, dynamic>()),
      microsoftV2: map['microsoftV2'] == null ? null : LinuxWebAppAuthSettingsV2MicrosoftV2.fromMap((map['microsoftV2'] as Map).cast<String, dynamic>()),
      ...
      twitterV2: map['twitterV2'] == null ? null : LinuxWebAppAuthSettingsV2TwitterV2.fromMap((map['twitterV2'] as Map).cast<String, dynamic>()),
