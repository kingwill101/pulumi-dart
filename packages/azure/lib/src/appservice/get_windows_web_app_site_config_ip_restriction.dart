...
class GetWindowsWebAppSiteConfigIpRestriction {
  ...
  final List<GetWindowsWebAppSiteConfigIpRestrictionHeader> headers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': pulumi.Input.encodeList<GetWindowsWebAppSiteConfigIpRestrictionHeader, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ipAddress,
      'name': name,
      'priority': priority,
  ...
  factory GetWindowsWebAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppSiteConfigIpRestriction(
      ...
      headers: pulumi.Input.decodeList<GetWindowsWebAppSiteConfigIpRestrictionHeader>(map['headers'], (value) => GetWindowsWebAppSiteConfigIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>())),
