...
class GetWindowsFunctionAppSiteConfigIpRestriction {
  ...
  final List<GetWindowsFunctionAppSiteConfigIpRestrictionHeader> headers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': pulumi.Input.encodeList<GetWindowsFunctionAppSiteConfigIpRestrictionHeader, Map<String, dynamic>>(headers, (value) => value.toMap()),
      'ipAddress': ipAddress,
      'name': name,
      'priority': priority,
  ...
  factory GetWindowsFunctionAppSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppSiteConfigIpRestriction(
      ...
      headers: pulumi.Input.decodeList<GetWindowsFunctionAppSiteConfigIpRestrictionHeader>(map['headers'], (value) => GetWindowsFunctionAppSiteConfigIpRestrictionHeader.fromMap((value as Map).cast<String, dynamic>())),
