...
class AppFlexConsumptionArgs {
  ...
  AppFlexConsumptionArgs({
    List<AppFlexConsumptionAlwaysReady>? alwaysReadies,
    Map<String, String>? appSettings,
    AppFlexConsumptionAuthSettings? authSettings,
    AppFlexConsumptionAuthSettingsV2? authSettingsV2,
    bool? clientCertificateEnabled,
    String? clientCertificateExclusionPaths,
    String? clientCertificateMode,
    List<AppFlexConsumptionConnectionString>? connectionStrings,
    bool? enabled,
    int? httpConcurrency,
    bool? httpsOnly,
    AppFlexConsumptionIdentity? identity,
    ...
    required AppFlexConsumptionSiteConfig siteConfig,
    AppFlexConsumptionStickySettings? stickySettings,
    String? storageAccessKey,
    required String storageAuthenticationType,
    required String storageContainerEndpoint,
    required String storageContainerType,
    ...
    String? zipDeployFile,
      ...
      siteConfig = pulumi.Input.asInput<AppFlexConsumptionSiteConfig>(siteConfig),
      ...
      storageAuthenticationType = pulumi.Input.asInput<String>(storageAuthenticationType),
      storageContainerEndpoint = pulumi.Input.asInput<String>(storageContainerEndpoint),
      storageContainerType = pulumi.Input.asInput<String>(storageContainerType),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'siteConfig': pulumi.Input.mapInputValue<AppFlexConsumptionSiteConfig, Map<String, dynamic>>(siteConfig, (value) => value.toMap()),
  ...
  factory AppFlexConsumptionArgs.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionArgs(
      alwaysReadies: map['alwaysReadies'] == null ? null : pulumi.Input.decodeList<AppFlexConsumptionAlwaysReady>(map['alwaysReadies'], (value) => AppFlexConsumptionAlwaysReady.fromMap((value as Map).cast<String, dynamic>())),
      appSettings: map['appSettings'] == null ? null : (map['appSettings'] as Map).cast<String, String>(),
      authSettings: map['authSettings'] == null ? null : AppFlexConsumptionAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>()),
      authSettingsV2: map['authSettingsV2'] == null ? null : AppFlexConsumptionAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>()),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Input.decodeList<AppFlexConsumptionConnectionString>(map['connectionStrings'], (value) => AppFlexConsumptionConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      httpConcurrency: map['httpConcurrency'] == null ? null : map['httpConcurrency'] as int,
      httpsOnly: map['httpsOnly'] == null ? null : map['httpsOnly'] as bool,
      identity: map['identity'] == null ? null : AppFlexConsumptionIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      instanceMemoryInMb: map['instanceMemoryInMb'] == null ? null : map['instanceMemoryInMb'] as int,
      ...
      siteConfig: AppFlexConsumptionSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>()),
      stickySettings: map['stickySettings'] == null ? null : AppFlexConsumptionStickySettings.fromMap((map['stickySettings'] as Map).cast<String, dynamic>()),
      storageAccessKey: map['storageAccessKey'] == null ? null : map['storageAccessKey'] as String,
      storageAuthenticationType: map['storageAuthenticationType'] as String,
      storageContainerEndpoint: map['storageContainerEndpoint'] as String,
      storageContainerType: map['storageContainerType'] as String,
      storageUserAssignedIdentityId: map['storageUserAssignedIdentityId'] == null ? null : map['storageUserAssignedIdentityId'] as String,
