...
class AppConnectionArgs {
  ...
  AppConnectionArgs({
    required AppConnectionAuthentication authentication,
    String? clientType,
    required String functionAppId,
    String? name,
    AppConnectionSecretStore? secretStore,
  ...
  factory AppConnectionArgs.fromMap(Map<String, dynamic> map) {
    return AppConnectionArgs(
      authentication: AppConnectionAuthentication.fromMap((map['authentication'] as Map).cast<String, dynamic>()),
      clientType: map['clientType'] == null ? null : map['clientType'] as String,
      functionAppId: map['functionAppId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      secretStore: map['secretStore'] == null ? null : AppConnectionSecretStore.fromMap((map['secretStore'] as Map).cast<String, dynamic>()),
