...
class FunctionAppSlotArgs {
  ...
  FunctionAppSlotArgs({
    ...
    FunctionAppSlotAuthSettings? authSettings,
    List<FunctionAppSlotConnectionString>? connectionStrings,
    int? dailyMemoryTimeQuota,
    bool? enableBuiltinLogging,
    bool? enabled,
    required String functionAppName,
    bool? httpsOnly,
    FunctionAppSlotIdentity? identity,
    String? location,
    String? name,
    String? osType,
    required String resourceGroupName,
    FunctionAppSlotSiteConfig? siteConfig,
  ...
  factory FunctionAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotArgs(
      ...
      authSettings: map['authSettings'] == null ? null : FunctionAppSlotAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>()),
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Input.decodeList<FunctionAppSlotConnectionString>(map['connectionStrings'], (value) => FunctionAppSlotConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : FunctionAppSlotIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      osType: map['osType'] == null ? null : map['osType'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      siteConfig: map['siteConfig'] == null ? null : FunctionAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>()),
