...
class WindowsFunctionAppSlotArgs {
  ...
  WindowsFunctionAppSlotArgs({
    ...
    WindowsFunctionAppSlotAuthSettings? authSettings,
    WindowsFunctionAppSlotAuthSettingsV2? authSettingsV2,
    WindowsFunctionAppSlotBackup? backup,
    bool? builtinLoggingEnabled,
    bool? clientCertificateEnabled,
    String? clientCertificateExclusionPaths,
    String? clientCertificateMode,
    List<WindowsFunctionAppSlotConnectionString>? connectionStrings,
    ...
    bool? httpsOnly,
    WindowsFunctionAppSlotIdentity? identity,
    String? keyVaultReferenceIdentityId,
    String? name,
    bool? publicNetworkAccessEnabled,
    String? servicePlanId,
    required WindowsFunctionAppSlotSiteConfig siteConfig,
    String? storageAccountAccessKey,
    String? storageAccountName,
    List<WindowsFunctionAppSlotStorageAccount>? storageAccounts,
  ...
  factory WindowsFunctionAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotArgs(
      ...
      authSettings: map['authSettings'] == null ? null : WindowsFunctionAppSlotAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>()),
      authSettingsV2: map['authSettingsV2'] == null ? null : WindowsFunctionAppSlotAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>()),
      backup: map['backup'] == null ? null : WindowsFunctionAppSlotBackup.fromMap((map['backup'] as Map).cast<String, dynamic>()),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Input.decodeList<WindowsFunctionAppSlotConnectionString>(map['connectionStrings'], (value) => WindowsFunctionAppSlotConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : WindowsFunctionAppSlotIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      siteConfig: WindowsFunctionAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>()),
      ...
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Input.decodeList<WindowsFunctionAppSlotStorageAccount>(map['storageAccounts'], (value) => WindowsFunctionAppSlotStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
