...
class GetWindowsFunctionAppAuthSettingsV2Login {
  ...
  /// Creates a new [GetWindowsFunctionAppAuthSettingsV2Login].
  ...
  factory GetWindowsFunctionAppAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppAuthSettingsV2Login(
