...
class GetFunctionAppSiteConfigScmIpRestriction {
  ...
  final String action;
  final GetFunctionAppSiteConfigScmIpRestrictionHeaders headers;
  ...
  factory GetFunctionAppSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return GetFunctionAppSiteConfigScmIpRestriction(
      ...
      headers: GetFunctionAppSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
