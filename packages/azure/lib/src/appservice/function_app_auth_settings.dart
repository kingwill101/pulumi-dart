...
class FunctionAppAuthSettings {
  ...
  final FunctionAppAuthSettingsActiveDirectory? activeDirectory;
  ...
  final FunctionAppAuthSettingsFacebook? facebook;
  /// A `google` block as defined below.
  final FunctionAppAuthSettingsGoogle? google;
  /// Issuer URI. When using Azure Active Directory, this value is the URI of the directory tenant, e.g. <https://sts.windows.net/{tenant-guid}/>.
  final String? issuer;
  /// A `microsoft` block as defined below.
  final FunctionAppAuthSettingsMicrosoft? microsoft;
  ...
  final FunctionAppAuthSettingsTwitter? twitter;
  ...
  factory FunctionAppAuthSettings.fromMap(Map<String, dynamic> map) {
    return FunctionAppAuthSettings(
      activeDirectory: map['activeDirectory'] == null ? null : FunctionAppAuthSettingsActiveDirectory.fromMap((map['activeDirectory'] as Map).cast<String, dynamic>()),
      ...
      facebook: map['facebook'] == null ? null : FunctionAppAuthSettingsFacebook.fromMap((map['facebook'] as Map).cast<String, dynamic>()),
      google: map['google'] == null ? null : FunctionAppAuthSettingsGoogle.fromMap((map['google'] as Map).cast<String, dynamic>()),
      issuer: map['issuer'] == null ? null : map['issuer'] as String,
      microsoft: map['microsoft'] == null ? null : FunctionAppAuthSettingsMicrosoft.fromMap((map['microsoft'] as Map).cast<String, dynamic>()),
      ...
      twitter: map['twitter'] == null ? null : FunctionAppAuthSettingsTwitter.fromMap((map['twitter'] as Map).cast<String, dynamic>()),
