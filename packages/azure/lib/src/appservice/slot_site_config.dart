...
class SlotSiteConfig {
  ...
  final List<SlotSiteConfigIpRestriction>? ipRestrictions;
  ...
  final List<SlotSiteConfigScmIpRestriction>? scmIpRestrictions;
  ...
  /// [numberOfWorkers] The scaled number of workers (for per site scaling) of this App Service Slot. Requires that `per_site_scaling` is enabled on the `azure.appservice.Plan`. [For more information - please see Microsoft documentation on high-density hosting](https://docs.microsoft.com/azure/app-service/manage-scale-per-app).
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipRestrictions': ?ipRestrictions == null ? null : pulumi.Input.encodeList<SlotSiteConfigIpRestriction, Map<String, dynamic>>(ipRestrictions!, (value) => value.toMap()),
      ...
      'scmIpRestrictions': ?scmIpRestrictions == null ? null : pulumi.Input.encodeList<SlotSiteConfigScmIpRestriction, Map<String, dynamic>>(scmIpRestrictions!, (value) => value.toMap()),
      'scmType': ?scmType,
  ...
  factory SlotSiteConfig.fromMap(Map<String, dynamic> map) {
    return SlotSiteConfig(
      ...
      cors: map['cors'] == null ? null : SlotSiteConfigCors.fromMap((map['cors'] as Map).cast<String, dynamic>()),
      ...
      ipRestrictions: map['ipRestrictions'] == null ? null : pulumi.Input.decodeList<SlotSiteConfigIpRestriction>(map['ipRestrictions'], (value) => SlotSiteConfigIpRestriction.fromMap((value as Map).cast<String, dynamic>())),
      ...
      scmIpRestrictions: map['scmIpRestrictions'] == null ? null : pulumi.Input.decodeList<SlotSiteConfigScmIpRestriction>(map['scmIpRestrictions'], (value) => SlotSiteConfigScmIpRestriction.fromMap((value as Map).cast<String, dynamic>())),
