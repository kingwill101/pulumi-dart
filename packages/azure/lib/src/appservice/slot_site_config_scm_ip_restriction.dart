...
class SlotSiteConfigScmIpRestriction {
  ...
  final SlotSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory SlotSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return SlotSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : SlotSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
