...
class WindowsWebAppSlotArgs {
  ...
  WindowsWebAppSlotArgs({
    ...
    WindowsWebAppSlotAuthSettings? authSettings,
    WindowsWebAppSlotAuthSettingsV2? authSettingsV2,
    WindowsWebAppSlotBackup? backup,
    bool? clientAffinityEnabled,
    bool? clientCertificateEnabled,
    String? clientCertificateExclusionPaths,
    String? clientCertificateMode,
    List<WindowsWebAppSlotConnectionString>? connectionStrings,
    bool? enabled,
    bool? ftpPublishBasicAuthenticationEnabled,
    bool? httpsOnly,
    WindowsWebAppSlotIdentity? identity,
    String? keyVaultReferenceIdentityId,
    WindowsWebAppSlotLogs? logs,
    String? name,
    bool? publicNetworkAccessEnabled,
    String? servicePlanId,
    required WindowsWebAppSlotSiteConfig siteConfig,
    List<WindowsWebAppSlotStorageAccount>? storageAccounts,
  ...
  factory WindowsWebAppSlotArgs.fromMap(Map<String, dynamic> map) {
    return WindowsWebAppSlotArgs(
      ...
      authSettings: map['authSettings'] == null ? null : WindowsWebAppSlotAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>()),
      authSettingsV2: map['authSettingsV2'] == null ? null : WindowsWebAppSlotAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>()),
      backup: map['backup'] == null ? null : WindowsWebAppSlotBackup.fromMap((map['backup'] as Map).cast<String, dynamic>()),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Input.decodeList<WindowsWebAppSlotConnectionString>(map['connectionStrings'], (value) => WindowsWebAppSlotConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : WindowsWebAppSlotIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      keyVaultReferenceIdentityId: map['keyVaultReferenceIdentityId'] == null ? null : map['keyVaultReferenceIdentityId'] as String,
      logs: map['logs'] == null ? null : WindowsWebAppSlotLogs.fromMap((map['logs'] as Map).cast<String, dynamic>()),
      ...
      siteConfig: WindowsWebAppSlotSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>()),
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Input.decodeList<WindowsWebAppSlotStorageAccount>(map['storageAccounts'], (value) => WindowsWebAppSlotStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
