...
class GetWindowsWebAppAuthSettingsV2MicrosoftV2 {
  ...
  /// Creates a new [GetWindowsWebAppAuthSettingsV2MicrosoftV2].
  ...
  factory GetWindowsWebAppAuthSettingsV2MicrosoftV2.fromMap(Map<String, dynamic> map) {
    return GetWindowsWebAppAuthSettingsV2MicrosoftV2(
