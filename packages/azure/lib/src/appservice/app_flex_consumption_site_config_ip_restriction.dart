...
import 'app_flex_consumption_site_config_ip_restriction_headers.dart';

class AppFlexConsumptionSiteConfigIpRestriction {
  /// The action to take. Possible values are `Allow` or `Deny`. Defaults to `Allow`.
  final String? action;
  /// The Description of this IP Restriction.
  final String? description;
  /// A `headers` block as defined above.
  final AppFlexConsumptionSiteConfigIpRestrictionHeaders? headers;
  ...
  /// Creates a new [AppFlexConsumptionSiteConfigIpRestriction].
  ...
  factory AppFlexConsumptionSiteConfigIpRestriction.fromMap(Map<String, dynamic> map) {
    return AppFlexConsumptionSiteConfigIpRestriction(
      action: map['action'] == null ? null : map['action'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      headers: map['headers'] == null ? null : AppFlexConsumptionSiteConfigIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
