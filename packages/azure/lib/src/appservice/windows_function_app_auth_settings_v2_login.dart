...
class WindowsFunctionAppAuthSettingsV2Login {
  ...
  /// Creates a new [WindowsFunctionAppAuthSettingsV2Login].
  ...
  factory WindowsFunctionAppAuthSettingsV2Login.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppAuthSettingsV2Login(
