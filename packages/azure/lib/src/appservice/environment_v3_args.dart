...
class EnvironmentV3Args {
  ...
  EnvironmentV3Args({
    ...
    List<EnvironmentV3ClusterSetting>? clusterSettings,
  ...
  factory EnvironmentV3Args.fromMap(Map<String, dynamic> map) {
    return EnvironmentV3Args(
      ...
      clusterSettings: map['clusterSettings'] == null ? null : pulumi.Input.decodeList<EnvironmentV3ClusterSetting>(map['clusterSettings'], (value) => EnvironmentV3ClusterSetting.fromMap((value as Map).cast<String, dynamic>())),
