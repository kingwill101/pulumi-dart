...
class GetWindowsFunctionAppAuthSettingGoogle {
  ...
  /// Creates a new [GetWindowsFunctionAppAuthSettingGoogle].
  ...
  factory GetWindowsFunctionAppAuthSettingGoogle.fromMap(Map<String, dynamic> map) {
    return GetWindowsFunctionAppAuthSettingGoogle(
