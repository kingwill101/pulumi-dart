...
class ConnectionArgs {
  ...
  ConnectionArgs({
    ...
    required ConnectionAuthentication authentication,
    String? clientType,
    String? name,
  ...
  factory ConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionArgs(
      ...
      authentication: ConnectionAuthentication.fromMap((map['authentication'] as Map).cast<String, dynamic>()),
      clientType: map['clientType'] == null ? null : map['clientType'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      secretStore: map['secretStore'] == null ? null : ConnectionSecretStore.fromMap((map['secretStore'] as Map).cast<String, dynamic>()),
