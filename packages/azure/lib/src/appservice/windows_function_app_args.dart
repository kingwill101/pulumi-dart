...
class WindowsFunctionAppArgs {
  ...
  WindowsFunctionAppArgs({
    ...
    WindowsFunctionAppAuthSettings? authSettings,
    WindowsFunctionAppAuthSettingsV2? authSettingsV2,
    WindowsFunctionAppBackup? backup,
    bool? builtinLoggingEnabled,
    bool? clientCertificateEnabled,
    String? clientCertificateExclusionPaths,
    String? clientCertificateMode,
    List<WindowsFunctionAppConnectionString>? connectionStrings,
    ...
    bool? httpsOnly,
    WindowsFunctionAppIdentity? identity,
    ...
    required WindowsFunctionAppSiteConfig siteConfig,
    WindowsFunctionAppStickySettings? stickySettings,
    String? storageAccountAccessKey,
    String? storageAccountName,
    List<WindowsFunctionAppStorageAccount>? storageAccounts,
    ...
    String? zipDeployFile,
      ...
      siteConfig = pulumi.Input.asInput<WindowsFunctionAppSiteConfig>(siteConfig),
  ...
  factory WindowsFunctionAppArgs.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppArgs(
      ...
      authSettings: map['authSettings'] == null ? null : WindowsFunctionAppAuthSettings.fromMap((map['authSettings'] as Map).cast<String, dynamic>()),
      authSettingsV2: map['authSettingsV2'] == null ? null : WindowsFunctionAppAuthSettingsV2.fromMap((map['authSettingsV2'] as Map).cast<String, dynamic>()),
      backup: map['backup'] == null ? null : WindowsFunctionAppBackup.fromMap((map['backup'] as Map).cast<String, dynamic>()),
      ...
      connectionStrings: map['connectionStrings'] == null ? null : pulumi.Input.decodeList<WindowsFunctionAppConnectionString>(map['connectionStrings'], (value) => WindowsFunctionAppConnectionString.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : WindowsFunctionAppIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      siteConfig: WindowsFunctionAppSiteConfig.fromMap((map['siteConfig'] as Map).cast<String, dynamic>()),
      stickySettings: map['stickySettings'] == null ? null : WindowsFunctionAppStickySettings.fromMap((map['stickySettings'] as Map).cast<String, dynamic>()),
      ...
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Input.decodeList<WindowsFunctionAppStorageAccount>(map['storageAccounts'], (value) => WindowsFunctionAppStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
