...
class GetFunctionAppSourceControl {
  ...
  /// Creates a new [GetFunctionAppSourceControl].
  ...
  factory GetFunctionAppSourceControl.fromMap(Map<String, dynamic> map) {
    return GetFunctionAppSourceControl(
