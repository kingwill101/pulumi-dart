...
class FunctionAppSiteConfigScmIpRestrictionHeaders {
  ...
  /// Creates a new [FunctionAppSiteConfigScmIpRestrictionHeaders].
  ...
  factory FunctionAppSiteConfigScmIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return FunctionAppSiteConfigScmIpRestrictionHeaders(
