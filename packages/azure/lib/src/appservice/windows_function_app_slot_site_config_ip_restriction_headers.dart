...
class WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders].
  ...
  factory WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders(
