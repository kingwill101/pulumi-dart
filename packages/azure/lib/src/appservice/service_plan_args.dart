...
class ServicePlanArgs {
  ...
  ServicePlanArgs({
    ...
    bool? premiumPlanAutoScaleEnabled,
  ...
  factory ServicePlanArgs.fromMap(Map<String, dynamic> map) {
    return ServicePlanArgs(
      appServiceEnvironmentId: map['appServiceEnvironmentId'] == null ? null : map['appServiceEnvironmentId'] as String,
      ...
      perSiteScalingEnabled: map['perSiteScalingEnabled'] == null ? null : map['perSiteScalingEnabled'] as bool,
      premiumPlanAutoScaleEnabled: map['premiumPlanAutoScaleEnabled'] == null ? null : map['premiumPlanAutoScaleEnabled'] as bool,
      resourceGroupName: map['resourceGroupName'] as String,
      skuName: map['skuName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      workerCount: map['workerCount'] == null ? null : map['workerCount'] as int,
      zoneBalancingEnabled: map['zoneBalancingEnabled'] == null ? null : map['zoneBalancingEnabled'] as bool,
    );
  }
}
