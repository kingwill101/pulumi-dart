...
class FunctionAppSlotSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [FunctionAppSlotSiteConfigIpRestrictionHeaders].
  ...
  factory FunctionAppSlotSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return FunctionAppSlotSiteConfigIpRestrictionHeaders(
