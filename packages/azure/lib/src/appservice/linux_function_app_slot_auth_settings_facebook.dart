...
class LinuxFunctionAppSlotAuthSettingsFacebook {
  ...
  /// Creates a new [LinuxFunctionAppSlotAuthSettingsFacebook].
  ...
  factory LinuxFunctionAppSlotAuthSettingsFacebook.fromMap(Map<String, dynamic> map) {
    return LinuxFunctionAppSlotAuthSettingsFacebook(
