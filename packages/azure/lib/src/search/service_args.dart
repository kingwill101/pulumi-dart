...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    bool? customerManagedKeyEnforcementEnabled,
    String? hostingMode,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      authenticationFailureMode: map['authenticationFailureMode'] == null ? null : map['authenticationFailureMode'] as String,
      customerManagedKeyEnforcementEnabled: map['customerManagedKeyEnforcementEnabled'] == null ? null : map['customerManagedKeyEnforcementEnabled'] as bool,
      ...
      semanticSearchSku: map['semanticSearchSku'] == null ? null : map['semanticSearchSku'] as String,
