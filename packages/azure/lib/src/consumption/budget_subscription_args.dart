...
class BudgetSubscriptionArgs {
  ...
  BudgetSubscriptionArgs({
    ...
    String? etag,
    BudgetSubscriptionFilter? filter,
    String? name,
    required List<BudgetSubscriptionNotification> notifications,
    required String subscriptionId,
    String? timeGrain,
    required BudgetSubscriptionTimePeriod timePeriod,
  }) :
  ...
  factory BudgetSubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return BudgetSubscriptionArgs(
      ...
      filter: map['filter'] == null ? null : BudgetSubscriptionFilter.fromMap((map['filter'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      notifications: pulumi.Input.decodeList<BudgetSubscriptionNotification>(map['notifications'], (value) => BudgetSubscriptionNotification.fromMap((value as Map).cast<String, dynamic>())),
      subscriptionId: map['subscriptionId'] as String,
      timeGrain: map['timeGrain'] == null ? null : map['timeGrain'] as String,
      timePeriod: BudgetSubscriptionTimePeriod.fromMap((map['timePeriod'] as Map).cast<String, dynamic>()),
    );
  }
}
