...
class VirtualMachineArgs {
  ...
  VirtualMachineArgs({
    ...
    VirtualMachineBootDiagnostics? bootDiagnostics,
    bool? deleteDataDisksOnTermination,
    bool? deleteOsDiskOnTermination,
    ...
    VirtualMachineOsProfileLinuxConfig? osProfileLinuxConfig,
    List<VirtualMachineOsProfileSecret>? osProfileSecrets,
    VirtualMachineOsProfileWindowsConfig? osProfileWindowsConfig,
    VirtualMachinePlan? plan,
    String? primaryNetworkInterfaceId,
    String? proximityPlacementGroupId,
    required String resourceGroupName,
    List<VirtualMachineStorageDataDisk>? storageDataDisks,
    VirtualMachineStorageImageReference? storageImageReference,
    required VirtualMachineStorageOsDisk storageOsDisk,
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      ...
      bootDiagnostics: map['bootDiagnostics'] == null ? null : VirtualMachineBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>()),
      deleteDataDisksOnTermination: map['deleteDataDisksOnTermination'] == null ? null : map['deleteDataDisksOnTermination'] as bool,
      deleteOsDiskOnTermination: map['deleteOsDiskOnTermination'] == null ? null : map['deleteOsDiskOnTermination'] as bool,
      ...
      osProfile: map['osProfile'] == null ? null : VirtualMachineOsProfile.fromMap((map['osProfile'] as Map).cast<String, dynamic>()),
      osProfileLinuxConfig: map['osProfileLinuxConfig'] == null ? null : VirtualMachineOsProfileLinuxConfig.fromMap((map['osProfileLinuxConfig'] as Map).cast<String, dynamic>()),
      osProfileSecrets: map['osProfileSecrets'] == null ? null : pulumi.Input.decodeList<VirtualMachineOsProfileSecret>(map['osProfileSecrets'], (value) => VirtualMachineOsProfileSecret.fromMap((value as Map).cast<String, dynamic>())),
      osProfileWindowsConfig: map['osProfileWindowsConfig'] == null ? null : VirtualMachineOsProfileWindowsConfig.fromMap((map['osProfileWindowsConfig'] as Map).cast<String, dynamic>()),
      plan: map['plan'] == null ? null : VirtualMachinePlan.fromMap((map['plan'] as Map).cast<String, dynamic>()),
      primaryNetworkInterfaceId: map['primaryNetworkInterfaceId'] == null ? null : map['primaryNetworkInterfaceId'] as String,
      proximityPlacementGroupId: map['proximityPlacementGroupId'] == null ? null : map['proximityPlacementGroupId'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      storageDataDisks: map['storageDataDisks'] == null ? null : pulumi.Input.decodeList<VirtualMachineStorageDataDisk>(map['storageDataDisks'], (value) => VirtualMachineStorageDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      storageImageReference: map['storageImageReference'] == null ? null : VirtualMachineStorageImageReference.fromMap((map['storageImageReference'] as Map).cast<String, dynamic>()),
      storageOsDisk: VirtualMachineStorageOsDisk.fromMap((map['storageOsDisk'] as Map).cast<String, dynamic>()),
