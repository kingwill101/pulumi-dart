...
class ScaleSetArgs {
  ...
  ScaleSetArgs({
    ...
    ScaleSetBootDiagnostics? bootDiagnostics,
    String? evictionPolicy,
    List<ScaleSetExtension>? extensions,
    String? healthProbeId,
    ScaleSetIdentity? identity,
    String? licenseType,
    String? location,
    String? name,
    required List<ScaleSetNetworkProfile> networkProfiles,
    required ScaleSetOsProfile osProfile,
    ScaleSetOsProfileLinuxConfig? osProfileLinuxConfig,
    List<ScaleSetOsProfileSecret>? osProfileSecrets,
    ScaleSetOsProfileWindowsConfig? osProfileWindowsConfig,
    bool? overprovision,
    ScaleSetPlan? plan,
    String? priority,
    String? proximityPlacementGroupId,
    required String resourceGroupName,
    ScaleSetRollingUpgradePolicy? rollingUpgradePolicy,
    bool? singlePlacementGroup,
    required ScaleSetSku sku,
    List<ScaleSetStorageProfileDataDisk>? storageProfileDataDisks,
    ScaleSetStorageProfileImageReference? storageProfileImageReference,
    required ScaleSetStorageProfileOsDisk storageProfileOsDisk,
    Map<String, String>? tags,
    required String upgradePolicyMode,
    List<String>? zones,
  }) :
  ...
  factory ScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return ScaleSetArgs(
      automaticOsUpgrade: map['automaticOsUpgrade'] == null ? null : map['automaticOsUpgrade'] as bool,
      bootDiagnostics: map['bootDiagnostics'] == null ? null : ScaleSetBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>()),
      evictionPolicy: map['evictionPolicy'] == null ? null : map['evictionPolicy'] as String,
      extensions: map['extensions'] == null ? null : pulumi.Input.decodeList<ScaleSetExtension>(map['extensions'], (value) => ScaleSetExtension.fromMap((value as Map).cast<String, dynamic>())),
      healthProbeId: map['healthProbeId'] == null ? null : map['healthProbeId'] as String,
      identity: map['identity'] == null ? null : ScaleSetIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      licenseType: map['licenseType'] == null ? null : map['licenseType'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfiles: pulumi.Input.decodeList<ScaleSetNetworkProfile>(map['networkProfiles'], (value) => ScaleSetNetworkProfile.fromMap((value as Map).cast<String, dynamic>())),
      osProfile: ScaleSetOsProfile.fromMap((map['osProfile'] as Map).cast<String, dynamic>()),
      osProfileLinuxConfig: map['osProfileLinuxConfig'] == null ? null : ScaleSetOsProfileLinuxConfig.fromMap((map['osProfileLinuxConfig'] as Map).cast<String, dynamic>()),
      osProfileSecrets: map['osProfileSecrets'] == null ? null : pulumi.Input.decodeList<ScaleSetOsProfileSecret>(map['osProfileSecrets'], (value) => ScaleSetOsProfileSecret.fromMap((value as Map).cast<String, dynamic>())),
      osProfileWindowsConfig: map['osProfileWindowsConfig'] == null ? null : ScaleSetOsProfileWindowsConfig.fromMap((map['osProfileWindowsConfig'] as Map).cast<String, dynamic>()),
      overprovision: map['overprovision'] == null ? null : map['overprovision'] as bool,
      plan: map['plan'] == null ? null : ScaleSetPlan.fromMap((map['plan'] as Map).cast<String, dynamic>()),
      ...
      rollingUpgradePolicy: map['rollingUpgradePolicy'] == null ? null : ScaleSetRollingUpgradePolicy.fromMap((map['rollingUpgradePolicy'] as Map).cast<String, dynamic>()),
      singlePlacementGroup: map['singlePlacementGroup'] == null ? null : map['singlePlacementGroup'] as bool,
      sku: ScaleSetSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      storageProfileDataDisks: map['storageProfileDataDisks'] == null ? null : pulumi.Input.decodeList<ScaleSetStorageProfileDataDisk>(map['storageProfileDataDisks'], (value) => ScaleSetStorageProfileDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      storageProfileImageReference: map['storageProfileImageReference'] == null ? null : ScaleSetStorageProfileImageReference.fromMap((map['storageProfileImageReference'] as Map).cast<String, dynamic>()),
      storageProfileOsDisk: ScaleSetStorageProfileOsDisk.fromMap((map['storageProfileOsDisk'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradePolicyMode: map['upgradePolicyMode'] as String,
