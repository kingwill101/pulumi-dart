...
class WindowsVirtualMachineScaleSetOsDisk {
  ...
  final WindowsVirtualMachineScaleSetOsDiskDiffDiskSettings? diffDiskSettings;
  ...
  factory WindowsVirtualMachineScaleSetOsDisk.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineScaleSetOsDisk(
      ...
      diffDiskSettings: map['diffDiskSettings'] == null ? null : WindowsVirtualMachineScaleSetOsDiskDiffDiskSettings.fromMap((map['diffDiskSettings'] as Map).cast<String, dynamic>()),
