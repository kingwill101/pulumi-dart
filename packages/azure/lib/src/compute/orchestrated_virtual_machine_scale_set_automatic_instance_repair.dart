...
class OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair {
  ...
  /// Creates a new [OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair].
  ...
  /// [enabled] Should the automatic instance repair be enabled on this Virtual Machine Scale Set? Possible values are `true` and `false`.
  ...
  factory OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair.fromMap(Map<String, dynamic> map) {
    return OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair(
