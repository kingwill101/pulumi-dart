...
/// {@template pulumi_compute_orchestrated_virtual_machine_scale_set_orchestrated_virtual_machine_scale_set_args_doc}
/// The set of arguments for OrchestratedVirtualMachineScaleSet.
/// {@endtemplate}
/// {@macro pulumi_compute_orchestrated_virtual_machine_scale_set_orchestrated_virtual_machine_scale_set_args_doc}
class OrchestratedVirtualMachineScaleSetArgs {
  ...
  /// Creates a new [OrchestratedVirtualMachineScaleSetArgs].
  ...
  OrchestratedVirtualMachineScaleSetArgs({
    OrchestratedVirtualMachineScaleSetAdditionalCapabilities? additionalCapabilities,
    OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair? automaticInstanceRepair,
    OrchestratedVirtualMachineScaleSetBootDiagnostics? bootDiagnostics,
    String? capacityReservationGroupId,
    List<OrchestratedVirtualMachineScaleSetDataDisk>? dataDisks,
    bool? encryptionAtHostEnabled,
    String? evictionPolicy,
    bool? extensionOperationsEnabled,
    List<OrchestratedVirtualMachineScaleSetExtension>? extensions,
    String? extensionsTimeBudget,
    OrchestratedVirtualMachineScaleSetIdentity? identity,
    int? instances,
    String? licenseType,
    String? location,
    double? maxBidPrice,
    ...
    List<OrchestratedVirtualMachineScaleSetNetworkInterface>? networkInterfaces,
    OrchestratedVirtualMachineScaleSetOsDisk? osDisk,
    OrchestratedVirtualMachineScaleSetOsProfile? osProfile,
    OrchestratedVirtualMachineScaleSetPlan? plan,
    required int platformFaultDomainCount,
    String? priority,
    OrchestratedVirtualMachineScaleSetPriorityMix? priorityMix,
    String? proximityPlacementGroupId,
    required String resourceGroupName,
    OrchestratedVirtualMachineScaleSetRollingUpgradePolicy? rollingUpgradePolicy,
    bool? singlePlacementGroup,
    String? skuName,
    OrchestratedVirtualMachineScaleSetSkuProfile? skuProfile,
    String? sourceImageId,
    OrchestratedVirtualMachineScaleSetSourceImageReference? sourceImageReference,
    Map<String, String>? tags,
    OrchestratedVirtualMachineScaleSetTerminationNotification? terminationNotification,
    String? upgradeMode,
  ...
  factory OrchestratedVirtualMachineScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return OrchestratedVirtualMachineScaleSetArgs(
      additionalCapabilities: map['additionalCapabilities'] == null ? null : OrchestratedVirtualMachineScaleSetAdditionalCapabilities.fromMap((map['additionalCapabilities'] as Map).cast<String, dynamic>()),
      automaticInstanceRepair: map['automaticInstanceRepair'] == null ? null : OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair.fromMap((map['automaticInstanceRepair'] as Map).cast<String, dynamic>()),
      bootDiagnostics: map['bootDiagnostics'] == null ? null : OrchestratedVirtualMachineScaleSetBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>()),
      capacityReservationGroupId: map['capacityReservationGroupId'] == null ? null : map['capacityReservationGroupId'] as String,
      dataDisks: map['dataDisks'] == null ? null : pulumi.Input.decodeList<OrchestratedVirtualMachineScaleSetDataDisk>(map['dataDisks'], (value) => OrchestratedVirtualMachineScaleSetDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      ...
      extensions: map['extensions'] == null ? null : pulumi.Input.decodeList<OrchestratedVirtualMachineScaleSetExtension>(map['extensions'], (value) => OrchestratedVirtualMachineScaleSetExtension.fromMap((value as Map).cast<String, dynamic>())),
      extensionsTimeBudget: map['extensionsTimeBudget'] == null ? null : map['extensionsTimeBudget'] as String,
      identity: map['identity'] == null ? null : OrchestratedVirtualMachineScaleSetIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<OrchestratedVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces'], (value) => OrchestratedVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      osDisk: map['osDisk'] == null ? null : OrchestratedVirtualMachineScaleSetOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>()),
      osProfile: map['osProfile'] == null ? null : OrchestratedVirtualMachineScaleSetOsProfile.fromMap((map['osProfile'] as Map).cast<String, dynamic>()),
      plan: map['plan'] == null ? null : OrchestratedVirtualMachineScaleSetPlan.fromMap((map['plan'] as Map).cast<String, dynamic>()),
      platformFaultDomainCount: map['platformFaultDomainCount'] as int,
      priority: map['priority'] == null ? null : map['priority'] as String,
      priorityMix: map['priorityMix'] == null ? null : OrchestratedVirtualMachineScaleSetPriorityMix.fromMap((map['priorityMix'] as Map).cast<String, dynamic>()),
      proximityPlacementGroupId: map['proximityPlacementGroupId'] == null ? null : map['proximityPlacementGroupId'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      rollingUpgradePolicy: map['rollingUpgradePolicy'] == null ? null : OrchestratedVirtualMachineScaleSetRollingUpgradePolicy.fromMap((map['rollingUpgradePolicy'] as Map).cast<String, dynamic>()),
      ...
      skuProfile: map['skuProfile'] == null ? null : OrchestratedVirtualMachineScaleSetSkuProfile.fromMap((map['skuProfile'] as Map).cast<String, dynamic>()),
      sourceImageId: map['sourceImageId'] == null ? null : map['sourceImageId'] as String,
      sourceImageReference: map['sourceImageReference'] == null ? null : OrchestratedVirtualMachineScaleSetSourceImageReference.fromMap((map['sourceImageReference'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      terminationNotification: map['terminationNotification'] == null ? null : OrchestratedVirtualMachineScaleSetTerminationNotification.fromMap((map['terminationNotification'] as Map).cast<String, dynamic>()),
