...
class BastionHostArgs {
  ...
  factory BastionHostArgs.fromMap(Map<String, dynamic> map) {
    return BastionHostArgs(
      copyPasteEnabled: map['copyPasteEnabled'] == null ? null : map['copyPasteEnabled'] as bool,
      fileCopyEnabled: map['fileCopyEnabled'] == null ? null : map['fileCopyEnabled'] as bool,
      ipConfiguration: map['ipConfiguration'] == null ? null : BastionHostIpConfiguration.fromMap((map['ipConfiguration'] as Map).cast<String, dynamic>()),
      ipConnectEnabled: map['ipConnectEnabled'] == null ? null : map['ipConnectEnabled'] as bool,
      ...
      sessionRecordingEnabled: map['sessionRecordingEnabled'] == null ? null : map['sessionRecordingEnabled'] as bool,
      shareableLinkEnabled: map['shareableLinkEnabled'] == null ? null : map['shareableLinkEnabled'] as bool,
      sku: map['sku'] == null ? null : map['sku'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tunnelingEnabled: map['tunnelingEnabled'] == null ? null : map['tunnelingEnabled'] as bool,
