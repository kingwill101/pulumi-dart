...
class SharedImageArgs {
  ...
  SharedImageArgs({
    ...
    String? description,
    bool? diskControllerTypeNvmeEnabled,
    List<String>? diskTypesNotAlloweds,
    String? endOfLifeDate,
    String? eula,
    required String galleryName,
    bool? hibernationEnabled,
    String? hyperVGeneration,
    required SharedImageIdentifier identifier,
    String? location,
    int? maxRecommendedMemoryInGb,
    int? maxRecommendedVcpuCount,
    int? minRecommendedMemoryInGb,
    int? minRecommendedVcpuCount,
    String? name,
    required String osType,
    String? privacyStatementUri,
    SharedImagePurchasePlan? purchasePlan,
  ...
  factory SharedImageArgs.fromMap(Map<String, dynamic> map) {
    return SharedImageArgs(
      acceleratedNetworkSupportEnabled: map['acceleratedNetworkSupportEnabled'] == null ? null : map['acceleratedNetworkSupportEnabled'] as bool,
      architecture: map['architecture'] == null ? null : map['architecture'] as String,
      confidentialVmEnabled: map['confidentialVmEnabled'] == null ? null : map['confidentialVmEnabled'] as bool,
      confidentialVmSupported: map['confidentialVmSupported'] == null ? null : map['confidentialVmSupported'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      diskControllerTypeNvmeEnabled: map['diskControllerTypeNvmeEnabled'] == null ? null : map['diskControllerTypeNvmeEnabled'] as bool,
      diskTypesNotAlloweds: map['diskTypesNotAlloweds'] == null ? null : (map['diskTypesNotAlloweds'] as List).cast<String>(),
      ...
      identifier: SharedImageIdentifier.fromMap((map['identifier'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      maxRecommendedMemoryInGb: map['maxRecommendedMemoryInGb'] == null ? null : map['maxRecommendedMemoryInGb'] as int,
      maxRecommendedVcpuCount: map['maxRecommendedVcpuCount'] == null ? null : map['maxRecommendedVcpuCount'] as int,
      minRecommendedMemoryInGb: map['minRecommendedMemoryInGb'] == null ? null : map['minRecommendedMemoryInGb'] as int,
      minRecommendedVcpuCount: map['minRecommendedVcpuCount'] == null ? null : map['minRecommendedVcpuCount'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      osType: map['osType'] as String,
      privacyStatementUri: map['privacyStatementUri'] == null ? null : map['privacyStatementUri'] as String,
      purchasePlan: map['purchasePlan'] == null ? null : SharedImagePurchasePlan.fromMap((map['purchasePlan'] as Map).cast<String, dynamic>()),
      releaseNoteUri: map['releaseNoteUri'] == null ? null : map['releaseNoteUri'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      specialized: map['specialized'] == null ? null : map['specialized'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      trustedLaunchEnabled: map['trustedLaunchEnabled'] == null ? null : map['trustedLaunchEnabled'] as bool,
      trustedLaunchSupported: map['trustedLaunchSupported'] == null ? null : map['trustedLaunchSupported'] as bool,
    );
  }
}
