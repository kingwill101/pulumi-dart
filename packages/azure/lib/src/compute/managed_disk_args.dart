...
/// {@template pulumi_compute_managed_disk_managed_disk_args_doc}
/// The set of arguments for ManagedDisk.
/// {@endtemplate}
/// {@macro pulumi_compute_managed_disk_managed_disk_args_doc}
class ManagedDiskArgs {
  ...
  ManagedDiskArgs({
    ...
    int? diskSizeGb,
    String? edgeZone,
    ManagedDiskEncryptionSettings? encryptionSettings,
    ...
    bool? onDemandBurstingEnabled,
    bool? optimizedFrequentAttachEnabled,
    String? osType,
    bool? performancePlusEnabled,
  ...
  factory ManagedDiskArgs.fromMap(Map<String, dynamic> map) {
    return ManagedDiskArgs(
      ...
      diskIopsReadOnly: map['diskIopsReadOnly'] == null ? null : map['diskIopsReadOnly'] as int,
      diskIopsReadWrite: map['diskIopsReadWrite'] == null ? null : map['diskIopsReadWrite'] as int,
      diskMbpsReadOnly: map['diskMbpsReadOnly'] == null ? null : map['diskMbpsReadOnly'] as int,
      diskMbpsReadWrite: map['diskMbpsReadWrite'] == null ? null : map['diskMbpsReadWrite'] as int,
      diskSizeGb: map['diskSizeGb'] == null ? null : map['diskSizeGb'] as int,
      edgeZone: map['edgeZone'] == null ? null : map['edgeZone'] as String,
      encryptionSettings: map['encryptionSettings'] == null ? null : ManagedDiskEncryptionSettings.fromMap((map['encryptionSettings'] as Map).cast<String, dynamic>()),
      galleryImageReferenceId: map['galleryImageReferenceId'] == null ? null : map['galleryImageReferenceId'] as String,
      hyperVGeneration: map['hyperVGeneration'] == null ? null : map['hyperVGeneration'] as String,
      imageReferenceId: map['imageReferenceId'] == null ? null : map['imageReferenceId'] as String,
      ...
      onDemandBurstingEnabled: map['onDemandBurstingEnabled'] == null ? null : map['onDemandBurstingEnabled'] as bool,
      optimizedFrequentAttachEnabled: map['optimizedFrequentAttachEnabled'] == null ? null : map['optimizedFrequentAttachEnabled'] as bool,
      osType: map['osType'] == null ? null : map['osType'] as String,
      performancePlusEnabled: map['performancePlusEnabled'] == null ? null : map['performancePlusEnabled'] as bool,
      ...
      trustedLaunchEnabled: map['trustedLaunchEnabled'] == null ? null : map['trustedLaunchEnabled'] as bool,
      uploadSizeBytes: map['uploadSizeBytes'] == null ? null : map['uploadSizeBytes'] as int,
