...
class RestorePointArgs {
  ...
  RestorePointArgs({
    bool? crashConsistencyModeEnabled,
    List<String>? excludedDisks,
    String? name,
    required String virtualMachineRestorePointCollectionId,
  }) :
  ...
  factory RestorePointArgs.fromMap(Map<String, dynamic> map) {
    return RestorePointArgs(
      crashConsistencyModeEnabled: map['crashConsistencyModeEnabled'] == null ? null : map['crashConsistencyModeEnabled'] as bool,
      excludedDisks: map['excludedDisks'] == null ? null : (map['excludedDisks'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      virtualMachineRestorePointCollectionId: map['virtualMachineRestorePointCollectionId'] as String,
    );
  }
}
