...
class ManagedDisk extends pulumi.CustomResource {
  ...
  ManagedDisk(
    ...
    this.diskIopsReadOnly = registerOutput<int>('diskIopsReadOnly');
    this.diskIopsReadWrite = registerOutput<int>('diskIopsReadWrite');
    this.diskMbpsReadOnly = registerOutput<int>('diskMbpsReadOnly');
    this.diskMbpsReadWrite = registerOutput<int>('diskMbpsReadWrite');
    this.diskSizeGb = registerOutput<int>('diskSizeGb');
    this.edgeZone = registerOutput<String?>('edgeZone');
    this.encryptionSettings = registerOutput<ManagedDiskEncryptionSettings?>('encryptionSettings');
    this.galleryImageReferenceId = registerOutput<String?>('galleryImageReferenceId');
    ...
    this.logicalSectorSize = registerOutput<int>('logicalSectorSize');
    this.maxShares = registerOutput<int>('maxShares');
    this.name = registerOutput<String>('name');
    this.networkAccessPolicy = registerOutput<String?>('networkAccessPolicy');
    this.onDemandBurstingEnabled = registerOutput<bool?>('onDemandBurstingEnabled');
    this.optimizedFrequentAttachEnabled = registerOutput<bool?>('optimizedFrequentAttachEnabled');
    this.osType = registerOutput<String?>('osType');
    this.performancePlusEnabled = registerOutput<bool?>('performancePlusEnabled');
    this.publicNetworkAccessEnabled = registerOutput<bool?>('publicNetworkAccessEnabled');
    this.resourceGroupName = registerOutput<String>('resourceGroupName');
    this.secureVmDiskEncryptionSetId = registerOutput<String?>('secureVmDiskEncryptionSetId');
    ...
    this.uploadSizeBytes = registerOutput<int?>('uploadSizeBytes');
