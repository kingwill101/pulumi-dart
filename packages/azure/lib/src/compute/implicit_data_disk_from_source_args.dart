...
/// {@template pulumi_compute_implicit_data_disk_from_source_implicit_data_disk_from_source_args_doc}
/// The set of arguments for ImplicitDataDiskFromSource.
/// {@endtemplate}
...
class ImplicitDataDiskFromSourceArgs {
  ...
  ImplicitDataDiskFromSourceArgs({
    String? caching,
    required String createOption,
    required int diskSizeGb,
    required int lun,
    String? name,
    ...
    bool? writeAcceleratorEnabled,
      ...
      diskSizeGb = pulumi.Input.asInput<int>(diskSizeGb),
