...
class WindowsVirtualMachineArgs {
  ...
  WindowsVirtualMachineArgs({
    WindowsVirtualMachineAdditionalCapabilities? additionalCapabilities,
    List<WindowsVirtualMachineAdditionalUnattendContent>? additionalUnattendContents,
    String? adminPassword,
    String? adminUsername,
    bool? allowExtensionOperations,
    bool? automaticUpdatesEnabled,
    String? availabilitySetId,
    WindowsVirtualMachineBootDiagnostics? bootDiagnostics,
    ...
    List<WindowsVirtualMachineGalleryApplication>? galleryApplications,
    bool? hotpatchingEnabled,
    WindowsVirtualMachineIdentity? identity,
    String? licenseType,
    String? location,
    double? maxBidPrice,
    String? name,
    required List<String> networkInterfaceIds,
    required WindowsVirtualMachineOsDisk osDisk,
    WindowsVirtualMachineOsImageNotification? osImageNotification,
    String? osManagedDiskId,
    String? patchAssessmentMode,
    String? patchMode,
    WindowsVirtualMachinePlan? plan,
    ...
    List<WindowsVirtualMachineSecret>? secrets,
    bool? secureBootEnabled,
    required String size,
    String? sourceImageId,
    WindowsVirtualMachineSourceImageReference? sourceImageReference,
    Map<String, String>? tags,
    WindowsVirtualMachineTerminationNotification? terminationNotification,
    String? timezone,
    String? userData,
    String? virtualMachineScaleSetId,
    bool? vmAgentPlatformUpdatesEnabled,
    bool? vtpmEnabled,
    List<WindowsVirtualMachineWinrmListener>? winrmListeners,
    String? zone,
  }) :
      ...
      osDisk = pulumi.Input.asInput<WindowsVirtualMachineOsDisk>(osDisk),
  ...
  factory WindowsVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineArgs(
      additionalCapabilities: map['additionalCapabilities'] == null ? null : WindowsVirtualMachineAdditionalCapabilities.fromMap((map['additionalCapabilities'] as Map).cast<String, dynamic>()),
      additionalUnattendContents: map['additionalUnattendContents'] == null ? null : pulumi.Input.decodeList<WindowsVirtualMachineAdditionalUnattendContent>(map['additionalUnattendContents'], (value) => WindowsVirtualMachineAdditionalUnattendContent.fromMap((value as Map).cast<String, dynamic>())),
      ...
      automaticUpdatesEnabled: map['automaticUpdatesEnabled'] == null ? null : map['automaticUpdatesEnabled'] as bool,
      availabilitySetId: map['availabilitySetId'] == null ? null : map['availabilitySetId'] as String,
      bootDiagnostics: map['bootDiagnostics'] == null ? null : WindowsVirtualMachineBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>()),
      ...
      galleryApplications: map['galleryApplications'] == null ? null : pulumi.Input.decodeList<WindowsVirtualMachineGalleryApplication>(map['galleryApplications'], (value) => WindowsVirtualMachineGalleryApplication.fromMap((value as Map).cast<String, dynamic>())),
      hotpatchingEnabled: map['hotpatchingEnabled'] == null ? null : map['hotpatchingEnabled'] as bool,
      identity: map['identity'] == null ? null : WindowsVirtualMachineIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      osDisk: WindowsVirtualMachineOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>()),
      osImageNotification: map['osImageNotification'] == null ? null : WindowsVirtualMachineOsImageNotification.fromMap((map['osImageNotification'] as Map).cast<String, dynamic>()),
      ...
      plan: map['plan'] == null ? null : WindowsVirtualMachinePlan.fromMap((map['plan'] as Map).cast<String, dynamic>()),
      ...
      secrets: map['secrets'] == null ? null : pulumi.Input.decodeList<WindowsVirtualMachineSecret>(map['secrets'], (value) => WindowsVirtualMachineSecret.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceImageReference: map['sourceImageReference'] == null ? null : WindowsVirtualMachineSourceImageReference.fromMap((map['sourceImageReference'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      terminationNotification: map['terminationNotification'] == null ? null : WindowsVirtualMachineTerminationNotification.fromMap((map['terminationNotification'] as Map).cast<String, dynamic>()),
      ...
      winrmListeners: map['winrmListeners'] == null ? null : pulumi.Input.decodeList<WindowsVirtualMachineWinrmListener>(map['winrmListeners'], (value) => WindowsVirtualMachineWinrmListener.fromMap((value as Map).cast<String, dynamic>())),
