...
class WindowsVirtualMachineOsDisk {
  ...
  final WindowsVirtualMachineOsDiskDiffDiskSettings? diffDiskSettings;
  ...
  factory WindowsVirtualMachineOsDisk.fromMap(Map<String, dynamic> map) {
    return WindowsVirtualMachineOsDisk(
      ...
      diffDiskSettings: map['diffDiskSettings'] == null ? null : WindowsVirtualMachineOsDiskDiffDiskSettings.fromMap((map['diffDiskSettings'] as Map).cast<String, dynamic>()),
