...
class LinuxVirtualMachineScaleSetArgs {
  ...
  LinuxVirtualMachineScaleSetArgs({
    LinuxVirtualMachineScaleSetAdditionalCapabilities? additionalCapabilities,
    String? adminPassword,
    List<LinuxVirtualMachineScaleSetAdminSshKey>? adminSshKeys,
    required String adminUsername,
    LinuxVirtualMachineScaleSetAutomaticInstanceRepair? automaticInstanceRepair,
    LinuxVirtualMachineScaleSetAutomaticOsUpgradePolicy? automaticOsUpgradePolicy,
    LinuxVirtualMachineScaleSetBootDiagnostics? bootDiagnostics,
    String? capacityReservationGroupId,
    String? computerNamePrefix,
    String? customData,
    List<LinuxVirtualMachineScaleSetDataDisk>? dataDisks,
    ...
    List<LinuxVirtualMachineScaleSetExtension>? extensions,
    String? extensionsTimeBudget,
    List<LinuxVirtualMachineScaleSetGalleryApplication>? galleryApplications,
    String? healthProbeId,
    String? hostGroupId,
    LinuxVirtualMachineScaleSetIdentity? identity,
    int? instances,
    String? location,
    double? maxBidPrice,
    String? name,
    required List<LinuxVirtualMachineScaleSetNetworkInterface> networkInterfaces,
    required LinuxVirtualMachineScaleSetOsDisk osDisk,
    bool? overprovision,
    LinuxVirtualMachineScaleSetPlan? plan,
    ...
    LinuxVirtualMachineScaleSetRollingUpgradePolicy? rollingUpgradePolicy,
    LinuxVirtualMachineScaleSetScaleIn? scaleIn,
    List<LinuxVirtualMachineScaleSetSecret>? secrets,
    bool? secureBootEnabled,
    bool? singlePlacementGroup,
    required String sku,
    String? sourceImageId,
    LinuxVirtualMachineScaleSetSourceImageReference? sourceImageReference,
    LinuxVirtualMachineScaleSetSpotRestore? spotRestore,
    Map<String, String>? tags,
    LinuxVirtualMachineScaleSetTerminationNotification? terminationNotification,
    String? upgradeMode,
    String? userData,
    bool? vtpmEnabled,
    bool? zoneBalance,
    List<String>? zones,
      ...
      networkInterfaces = pulumi.Input.asInput<List<LinuxVirtualMachineScaleSetNetworkInterface>>(networkInterfaces),
      osDisk = pulumi.Input.asInput<LinuxVirtualMachineScaleSetOsDisk>(osDisk),
  ...
  factory LinuxVirtualMachineScaleSetArgs.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineScaleSetArgs(
      additionalCapabilities: map['additionalCapabilities'] == null ? null : LinuxVirtualMachineScaleSetAdditionalCapabilities.fromMap((map['additionalCapabilities'] as Map).cast<String, dynamic>()),
      adminPassword: map['adminPassword'] == null ? null : map['adminPassword'] as String,
      adminSshKeys: map['adminSshKeys'] == null ? null : pulumi.Input.decodeList<LinuxVirtualMachineScaleSetAdminSshKey>(map['adminSshKeys'], (value) => LinuxVirtualMachineScaleSetAdminSshKey.fromMap((value as Map).cast<String, dynamic>())),
      adminUsername: map['adminUsername'] as String,
      automaticInstanceRepair: map['automaticInstanceRepair'] == null ? null : LinuxVirtualMachineScaleSetAutomaticInstanceRepair.fromMap((map['automaticInstanceRepair'] as Map).cast<String, dynamic>()),
      automaticOsUpgradePolicy: map['automaticOsUpgradePolicy'] == null ? null : LinuxVirtualMachineScaleSetAutomaticOsUpgradePolicy.fromMap((map['automaticOsUpgradePolicy'] as Map).cast<String, dynamic>()),
      bootDiagnostics: map['bootDiagnostics'] == null ? null : LinuxVirtualMachineScaleSetBootDiagnostics.fromMap((map['bootDiagnostics'] as Map).cast<String, dynamic>()),
      ...
      dataDisks: map['dataDisks'] == null ? null : pulumi.Input.decodeList<LinuxVirtualMachineScaleSetDataDisk>(map['dataDisks'], (value) => LinuxVirtualMachineScaleSetDataDisk.fromMap((value as Map).cast<String, dynamic>())),
      ...
      extensions: map['extensions'] == null ? null : pulumi.Input.decodeList<LinuxVirtualMachineScaleSetExtension>(map['extensions'], (value) => LinuxVirtualMachineScaleSetExtension.fromMap((value as Map).cast<String, dynamic>())),
      extensionsTimeBudget: map['extensionsTimeBudget'] == null ? null : map['extensionsTimeBudget'] as String,
      galleryApplications: map['galleryApplications'] == null ? null : pulumi.Input.decodeList<LinuxVirtualMachineScaleSetGalleryApplication>(map['galleryApplications'], (value) => LinuxVirtualMachineScaleSetGalleryApplication.fromMap((value as Map).cast<String, dynamic>())),
      ...
      identity: map['identity'] == null ? null : LinuxVirtualMachineScaleSetIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      networkInterfaces: pulumi.Input.decodeList<LinuxVirtualMachineScaleSetNetworkInterface>(map['networkInterfaces'], (value) => LinuxVirtualMachineScaleSetNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      osDisk: LinuxVirtualMachineScaleSetOsDisk.fromMap((map['osDisk'] as Map).cast<String, dynamic>()),
      overprovision: map['overprovision'] == null ? null : map['overprovision'] as bool,
      plan: map['plan'] == null ? null : LinuxVirtualMachineScaleSetPlan.fromMap((map['plan'] as Map).cast<String, dynamic>()),
      ...
      rollingUpgradePolicy: map['rollingUpgradePolicy'] == null ? null : LinuxVirtualMachineScaleSetRollingUpgradePolicy.fromMap((map['rollingUpgradePolicy'] as Map).cast<String, dynamic>()),
      scaleIn: map['scaleIn'] == null ? null : LinuxVirtualMachineScaleSetScaleIn.fromMap((map['scaleIn'] as Map).cast<String, dynamic>()),
      secrets: map['secrets'] == null ? null : pulumi.Input.decodeList<LinuxVirtualMachineScaleSetSecret>(map['secrets'], (value) => LinuxVirtualMachineScaleSetSecret.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceImageReference: map['sourceImageReference'] == null ? null : LinuxVirtualMachineScaleSetSourceImageReference.fromMap((map['sourceImageReference'] as Map).cast<String, dynamic>()),
      spotRestore: map['spotRestore'] == null ? null : LinuxVirtualMachineScaleSetSpotRestore.fromMap((map['spotRestore'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      terminationNotification: map['terminationNotification'] == null ? null : LinuxVirtualMachineScaleSetTerminationNotification.fromMap((map['terminationNotification'] as Map).cast<String, dynamic>()),
