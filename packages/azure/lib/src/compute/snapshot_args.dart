...
class SnapshotArgs {
  ...
  SnapshotArgs({
    ...
    String? diskAccessId,
    int? diskSizeGb,
    SnapshotEncryptionSettings? encryptionSettings,
  ...
  factory SnapshotArgs.fromMap(Map<String, dynamic> map) {
    return SnapshotArgs(
      ...
      encryptionSettings: map['encryptionSettings'] == null ? null : SnapshotEncryptionSettings.fromMap((map['encryptionSettings'] as Map).cast<String, dynamic>()),
      incrementalEnabled: map['incrementalEnabled'] == null ? null : map['incrementalEnabled'] as bool,
