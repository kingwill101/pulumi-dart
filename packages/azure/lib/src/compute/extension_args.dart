...
class ExtensionArgs {
  ...
  ExtensionArgs({
    ...
    ExtensionProtectedSettingsFromKeyVault? protectedSettingsFromKeyVault,
  ...
  factory ExtensionArgs.fromMap(Map<String, dynamic> map) {
    return ExtensionArgs(
      ...
      protectedSettingsFromKeyVault: map['protectedSettingsFromKeyVault'] == null ? null : ExtensionProtectedSettingsFromKeyVault.fromMap((map['protectedSettingsFromKeyVault'] as Map).cast<String, dynamic>()),
