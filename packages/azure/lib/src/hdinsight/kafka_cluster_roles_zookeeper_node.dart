...
class KafkaClusterRolesZookeeperNode {
  ...
  final List<KafkaClusterRolesZookeeperNodeScriptAction>? scriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?scriptActions == null ? null : pulumi.Input.encodeList<KafkaClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(scriptActions!, (value) => value.toMap()),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory KafkaClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return KafkaClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : pulumi.Input.decodeList<KafkaClusterRolesZookeeperNodeScriptAction>(map['scriptActions'], (value) => KafkaClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>())),
