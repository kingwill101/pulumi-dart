...
class HBaseClusterRolesZookeeperNode {
  ...
  final List<HBaseClusterRolesZookeeperNodeScriptAction>? scriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?scriptActions == null ? null : pulumi.Input.encodeList<HBaseClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(scriptActions!, (value) => value.toMap()),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory HBaseClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return HBaseClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : pulumi.Input.decodeList<HBaseClusterRolesZookeeperNodeScriptAction>(map['scriptActions'], (value) => HBaseClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>())),
