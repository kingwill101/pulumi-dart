...
class InteractiveQueryClusterRolesZookeeperNode {
  ...
  final List<InteractiveQueryClusterRolesZookeeperNodeScriptAction>? scriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?scriptActions == null ? null : pulumi.Input.encodeList<InteractiveQueryClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(scriptActions!, (value) => value.toMap()),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory InteractiveQueryClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return InteractiveQueryClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : pulumi.Input.decodeList<InteractiveQueryClusterRolesZookeeperNodeScriptAction>(map['scriptActions'], (value) => InteractiveQueryClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>())),
