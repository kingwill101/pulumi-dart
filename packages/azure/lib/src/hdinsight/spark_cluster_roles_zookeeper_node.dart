...
class SparkClusterRolesZookeeperNode {
  ...
  final List<SparkClusterRolesZookeeperNodeScriptAction>? scriptActions;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'password': ?password,
      'scriptActions': ?scriptActions == null ? null : pulumi.Input.encodeList<SparkClusterRolesZookeeperNodeScriptAction, Map<String, dynamic>>(scriptActions!, (value) => value.toMap()),
      'sshKeys': ?sshKeys,
      'subnetId': ?subnetId,
      'username': username,
  ...
  factory SparkClusterRolesZookeeperNode.fromMap(Map<String, dynamic> map) {
    return SparkClusterRolesZookeeperNode(
      ...
      scriptActions: map['scriptActions'] == null ? null : pulumi.Input.decodeList<SparkClusterRolesZookeeperNodeScriptAction>(map['scriptActions'], (value) => SparkClusterRolesZookeeperNodeScriptAction.fromMap((value as Map).cast<String, dynamic>())),
