...
class HBaseClusterArgs {
  ...
  HBaseClusterArgs({
    ...
    required HBaseClusterComponentVersion componentVersion,
    HBaseClusterComputeIsolation? computeIsolation,
    List<HBaseClusterDiskEncryption>? diskEncryptions,
    HBaseClusterExtension? extension,
    required HBaseClusterGateway gateway,
    String? location,
    HBaseClusterMetastores? metastores,
    HBaseClusterMonitor? monitor,
    String? name,
    HBaseClusterNetwork? network,
    HBaseClusterPrivateLinkConfiguration? privateLinkConfiguration,
    required String resourceGroupName,
    required HBaseClusterRoles roles,
    HBaseClusterSecurityProfile? securityProfile,
    HBaseClusterStorageAccountGen2? storageAccountGen2,
    List<HBaseClusterStorageAccount>? storageAccounts,
  ...
  factory HBaseClusterArgs.fromMap(Map<String, dynamic> map) {
    return HBaseClusterArgs(
      ...
      componentVersion: HBaseClusterComponentVersion.fromMap((map['componentVersion'] as Map).cast<String, dynamic>()),
      computeIsolation: map['computeIsolation'] == null ? null : HBaseClusterComputeIsolation.fromMap((map['computeIsolation'] as Map).cast<String, dynamic>()),
      diskEncryptions: map['diskEncryptions'] == null ? null : pulumi.Input.decodeList<HBaseClusterDiskEncryption>(map['diskEncryptions'], (value) => HBaseClusterDiskEncryption.fromMap((value as Map).cast<String, dynamic>())),
      extension: map['extension'] == null ? null : HBaseClusterExtension.fromMap((map['extension'] as Map).cast<String, dynamic>()),
      gateway: HBaseClusterGateway.fromMap((map['gateway'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      metastores: map['metastores'] == null ? null : HBaseClusterMetastores.fromMap((map['metastores'] as Map).cast<String, dynamic>()),
      monitor: map['monitor'] == null ? null : HBaseClusterMonitor.fromMap((map['monitor'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      network: map['network'] == null ? null : HBaseClusterNetwork.fromMap((map['network'] as Map).cast<String, dynamic>()),
      privateLinkConfiguration: map['privateLinkConfiguration'] == null ? null : HBaseClusterPrivateLinkConfiguration.fromMap((map['privateLinkConfiguration'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      roles: HBaseClusterRoles.fromMap((map['roles'] as Map).cast<String, dynamic>()),
      securityProfile: map['securityProfile'] == null ? null : HBaseClusterSecurityProfile.fromMap((map['securityProfile'] as Map).cast<String, dynamic>()),
      storageAccountGen2: map['storageAccountGen2'] == null ? null : HBaseClusterStorageAccountGen2.fromMap((map['storageAccountGen2'] as Map).cast<String, dynamic>()),
      storageAccounts: map['storageAccounts'] == null ? null : pulumi.Input.decodeList<HBaseClusterStorageAccount>(map['storageAccounts'], (value) => HBaseClusterStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
