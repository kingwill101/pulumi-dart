...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    ClusterAzureActiveDirectory? azureActiveDirectory,
    ClusterCertificate? certificate,
    ClusterCertificateCommonNames? certificateCommonNames,
    List<ClusterClientCertificateCommonName>? clientCertificateCommonNames,
    List<ClusterClientCertificateThumbprint>? clientCertificateThumbprints,
    String? clusterCodeVersion,
    ClusterDiagnosticsConfig? diagnosticsConfig,
    List<ClusterFabricSetting>? fabricSettings,
    String? location,
    required String managementEndpoint,
    String? name,
    required List<ClusterNodeType> nodeTypes,
    required String reliabilityLevel,
    required String resourceGroupName,
    ClusterReverseProxyCertificate? reverseProxyCertificate,
    ClusterReverseProxyCertificateCommonNames? reverseProxyCertificateCommonNames,
    String? serviceFabricZonalUpgradeMode,
    Map<String, String>? tags,
    required String upgradeMode,
    ClusterUpgradePolicy? upgradePolicy,
    required String vmImage,
    String? vmssZonalUpgradeMode,
      ...
      managementEndpoint = pulumi.Input.asInput<String>(managementEndpoint),
      name = pulumi.Input.asOptionalInput<String>(name),
      nodeTypes = pulumi.Input.asInput<List<ClusterNodeType>>(nodeTypes),
      reliabilityLevel = pulumi.Input.asInput<String>(reliabilityLevel),
      ...
      upgradeMode = pulumi.Input.asInput<String>(upgradeMode),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      ...
      azureActiveDirectory: map['azureActiveDirectory'] == null ? null : ClusterAzureActiveDirectory.fromMap((map['azureActiveDirectory'] as Map).cast<String, dynamic>()),
      certificate: map['certificate'] == null ? null : ClusterCertificate.fromMap((map['certificate'] as Map).cast<String, dynamic>()),
      certificateCommonNames: map['certificateCommonNames'] == null ? null : ClusterCertificateCommonNames.fromMap((map['certificateCommonNames'] as Map).cast<String, dynamic>()),
      clientCertificateCommonNames: map['clientCertificateCommonNames'] == null ? null : pulumi.Input.decodeList<ClusterClientCertificateCommonName>(map['clientCertificateCommonNames'], (value) => ClusterClientCertificateCommonName.fromMap((value as Map).cast<String, dynamic>())),
      clientCertificateThumbprints: map['clientCertificateThumbprints'] == null ? null : pulumi.Input.decodeList<ClusterClientCertificateThumbprint>(map['clientCertificateThumbprints'], (value) => ClusterClientCertificateThumbprint.fromMap((value as Map).cast<String, dynamic>())),
      clusterCodeVersion: map['clusterCodeVersion'] == null ? null : map['clusterCodeVersion'] as String,
      diagnosticsConfig: map['diagnosticsConfig'] == null ? null : ClusterDiagnosticsConfig.fromMap((map['diagnosticsConfig'] as Map).cast<String, dynamic>()),
      fabricSettings: map['fabricSettings'] == null ? null : pulumi.Input.decodeList<ClusterFabricSetting>(map['fabricSettings'], (value) => ClusterFabricSetting.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      managementEndpoint: map['managementEndpoint'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nodeTypes: pulumi.Input.decodeList<ClusterNodeType>(map['nodeTypes'], (value) => ClusterNodeType.fromMap((value as Map).cast<String, dynamic>())),
      reliabilityLevel: map['reliabilityLevel'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      reverseProxyCertificate: map['reverseProxyCertificate'] == null ? null : ClusterReverseProxyCertificate.fromMap((map['reverseProxyCertificate'] as Map).cast<String, dynamic>()),
      reverseProxyCertificateCommonNames: map['reverseProxyCertificateCommonNames'] == null ? null : ClusterReverseProxyCertificateCommonNames.fromMap((map['reverseProxyCertificateCommonNames'] as Map).cast<String, dynamic>()),
      serviceFabricZonalUpgradeMode: map['serviceFabricZonalUpgradeMode'] == null ? null : map['serviceFabricZonalUpgradeMode'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradeMode: map['upgradeMode'] as String,
      upgradePolicy: map['upgradePolicy'] == null ? null : ClusterUpgradePolicy.fromMap((map['upgradePolicy'] as Map).cast<String, dynamic>()),
      vmImage: map['vmImage'] as String,
      vmssZonalUpgradeMode: map['vmssZonalUpgradeMode'] == null ? null : map['vmssZonalUpgradeMode'] as String,
    );
  }
}
