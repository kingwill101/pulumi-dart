...
class ManagedClusterArgs {
  ...
  ManagedClusterArgs({
    ManagedClusterAuthentication? authentication,
    bool? backupServiceEnabled,
    required int clientConnectionPort,
    List<ManagedClusterCustomFabricSetting>? customFabricSettings,
    String? dnsName,
    bool? dnsServiceEnabled,
    required int httpGatewayPort,
    required List<ManagedClusterLbRule> lbRules,
    String? location,
    String? name,
    List<ManagedClusterNodeType>? nodeTypes,
    String? password,
  ...
  factory ManagedClusterArgs.fromMap(Map<String, dynamic> map) {
    return ManagedClusterArgs(
      authentication: map['authentication'] == null ? null : ManagedClusterAuthentication.fromMap((map['authentication'] as Map).cast<String, dynamic>()),
      backupServiceEnabled: map['backupServiceEnabled'] == null ? null : map['backupServiceEnabled'] as bool,
      clientConnectionPort: map['clientConnectionPort'] as int,
      customFabricSettings: map['customFabricSettings'] == null ? null : pulumi.Input.decodeList<ManagedClusterCustomFabricSetting>(map['customFabricSettings'], (value) => ManagedClusterCustomFabricSetting.fromMap((value as Map).cast<String, dynamic>())),
      dnsName: map['dnsName'] == null ? null : map['dnsName'] as String,
      dnsServiceEnabled: map['dnsServiceEnabled'] == null ? null : map['dnsServiceEnabled'] as bool,
      httpGatewayPort: map['httpGatewayPort'] as int,
      lbRules: pulumi.Input.decodeList<ManagedClusterLbRule>(map['lbRules'], (value) => ManagedClusterLbRule.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      nodeTypes: map['nodeTypes'] == null ? null : pulumi.Input.decodeList<ManagedClusterNodeType>(map['nodeTypes'], (value) => ManagedClusterNodeType.fromMap((value as Map).cast<String, dynamic>())),
      password: map['password'] == null ? null : map['password'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sku: map['sku'] == null ? null : map['sku'] as String,
      subnetId: map['subnetId'] == null ? null : map['subnetId'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradeWave: map['upgradeWave'] == null ? null : map['upgradeWave'] as String,
