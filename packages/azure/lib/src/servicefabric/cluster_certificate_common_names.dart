...
class ClusterCertificateCommonNames {
  ...
  final List<ClusterCertificateCommonNamesCommonName> commonNames;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'commonNames': pulumi.Input.encodeList<ClusterCertificateCommonNamesCommonName, Map<String, dynamic>>(commonNames, (value) => value.toMap()),
  ...
  factory ClusterCertificateCommonNames.fromMap(Map<String, dynamic> map) {
    return ClusterCertificateCommonNames(
      commonNames: pulumi.Input.decodeList<ClusterCertificateCommonNamesCommonName>(map['commonNames'], (value) => ClusterCertificateCommonNamesCommonName.fromMap((value as Map).cast<String, dynamic>())),
