...
class CustomLocationArgs {
  ...
  CustomLocationArgs({
    CustomLocationAuthentication? authentication,
    required List<String> clusterExtensionIds,
    String? displayName,
    required String hostResourceId,
    String? hostType,
    String? location,
    String? name,
  ...
  factory CustomLocationArgs.fromMap(Map<String, dynamic> map) {
    return CustomLocationArgs(
      authentication: map['authentication'] == null ? null : CustomLocationAuthentication.fromMap((map['authentication'] as Map).cast<String, dynamic>()),
