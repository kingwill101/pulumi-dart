...
class DatasetSqlServerTableArgs {
  ...
  DatasetSqlServerTableArgs({
    ...
    List<DatasetSqlServerTableSchemaColumn>? schemaColumns,
    String? tableName,
  }) :
  ...
  factory DatasetSqlServerTableArgs.fromMap(Map<String, dynamic> map) {
    return DatasetSqlServerTableArgs(
      ...
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetSqlServerTableSchemaColumn>(map['schemaColumns'], (value) => DatasetSqlServerTableSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
