...
class LinkedServiceAzureFunctionArgs {
  ...
  LinkedServiceAzureFunctionArgs({
    ...
    String? key,
    LinkedServiceAzureFunctionKeyVaultKey? keyVaultKey,
    String? name,
  ...
  factory LinkedServiceAzureFunctionArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceAzureFunctionArgs(
      ...
      keyVaultKey: map['keyVaultKey'] == null ? null : LinkedServiceAzureFunctionKeyVaultKey.fromMap((map['keyVaultKey'] as Map).cast<String, dynamic>()),
