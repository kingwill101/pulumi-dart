...
class DatasetCosmosDBApiArgs {
  ...
  DatasetCosmosDBApiArgs({
    ...
    List<DatasetCosmosDBApiSchemaColumn>? schemaColumns,
  }) :
  ...
  factory DatasetCosmosDBApiArgs.fromMap(Map<String, dynamic> map) {
    return DatasetCosmosDBApiArgs(
      ...
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetCosmosDBApiSchemaColumn>(map['schemaColumns'], (value) => DatasetCosmosDBApiSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
