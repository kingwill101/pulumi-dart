...
class IntegrationRuntimeRuleArgs {
  ...
  factory IntegrationRuntimeRuleArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationRuntimeRuleArgs(
      cleanupEnabled: map['cleanupEnabled'] == null ? null : map['cleanupEnabled'] as bool,
      ...
      timeToLiveMin: map['timeToLiveMin'] == null ? null : map['timeToLiveMin'] as int,
      virtualNetworkEnabled: map['virtualNetworkEnabled'] == null ? null : map['virtualNetworkEnabled'] as bool,
    );
  }
}
