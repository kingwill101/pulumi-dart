...
class TriggerTumblingWindowArgs {
  ...
  TriggerTumblingWindowArgs({
    ...
    int? maxConcurrency,
    String? name,
    required TriggerTumblingWindowPipeline pipeline,
    TriggerTumblingWindowRetry? retry,
    required String startTime,
    List<TriggerTumblingWindowTriggerDependency>? triggerDependencies,
  }) :
  ...
  factory TriggerTumblingWindowArgs.fromMap(Map<String, dynamic> map) {
    return TriggerTumblingWindowArgs(
      ...
      pipeline: TriggerTumblingWindowPipeline.fromMap((map['pipeline'] as Map).cast<String, dynamic>()),
      retry: map['retry'] == null ? null : TriggerTumblingWindowRetry.fromMap((map['retry'] as Map).cast<String, dynamic>()),
      startTime: map['startTime'] as String,
      triggerDependencies: map['triggerDependencies'] == null ? null : pulumi.Input.decodeList<TriggerTumblingWindowTriggerDependency>(map['triggerDependencies'], (value) => TriggerTumblingWindowTriggerDependency.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
