...
class FlowletDataFlowArgs {
  ...
  FlowletDataFlowArgs({
    ...
    List<FlowletDataFlowSink>? sinks,
    List<FlowletDataFlowSource>? sources,
    List<FlowletDataFlowTransformation>? transformations,
  }) :
  ...
  factory FlowletDataFlowArgs.fromMap(Map<String, dynamic> map) {
    return FlowletDataFlowArgs(
      ...
      sinks: map['sinks'] == null ? null : pulumi.Input.decodeList<FlowletDataFlowSink>(map['sinks'], (value) => FlowletDataFlowSink.fromMap((value as Map).cast<String, dynamic>())),
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<FlowletDataFlowSource>(map['sources'], (value) => FlowletDataFlowSource.fromMap((value as Map).cast<String, dynamic>())),
      transformations: map['transformations'] == null ? null : pulumi.Input.decodeList<FlowletDataFlowTransformation>(map['transformations'], (value) => FlowletDataFlowTransformation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
