...
class LinkedServiceSqlServerArgs {
  ...
  LinkedServiceSqlServerArgs({
    ...
    LinkedServiceSqlServerKeyVaultConnectionString? keyVaultConnectionString,
    LinkedServiceSqlServerKeyVaultPassword? keyVaultPassword,
    String? name,
  ...
  factory LinkedServiceSqlServerArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceSqlServerArgs(
      ...
      keyVaultConnectionString: map['keyVaultConnectionString'] == null ? null : LinkedServiceSqlServerKeyVaultConnectionString.fromMap((map['keyVaultConnectionString'] as Map).cast<String, dynamic>()),
      keyVaultPassword: map['keyVaultPassword'] == null ? null : LinkedServiceSqlServerKeyVaultPassword.fromMap((map['keyVaultPassword'] as Map).cast<String, dynamic>()),
