...
class LinkedServiceAzureSqlDatabase extends pulumi.CustomResource {
  ...
  LinkedServiceAzureSqlDatabase(
    ...
    this.keyVaultConnectionString = registerOutput<LinkedServiceAzureSqlDatabaseKeyVaultConnectionString?>('keyVaultConnectionString');
    this.keyVaultPassword = registerOutput<LinkedServiceAzureSqlDatabaseKeyVaultPassword?>('keyVaultPassword');
