...
class DatasetParquetArgs {
  ...
  DatasetParquetArgs({
    ...
    DatasetParquetAzureBlobFsLocation? azureBlobFsLocation,
    DatasetParquetAzureBlobStorageLocation? azureBlobStorageLocation,
    String? compressionCodec,
    String? compressionLevel,
    required String dataFactoryId,
    String? description,
    String? folder,
    DatasetParquetHttpServerLocation? httpServerLocation,
    required String linkedServiceName,
    String? name,
    Map<String, String>? parameters,
    List<DatasetParquetSchemaColumn>? schemaColumns,
  }) :
  ...
  factory DatasetParquetArgs.fromMap(Map<String, dynamic> map) {
    return DatasetParquetArgs(
      ...
      azureBlobFsLocation: map['azureBlobFsLocation'] == null ? null : DatasetParquetAzureBlobFsLocation.fromMap((map['azureBlobFsLocation'] as Map).cast<String, dynamic>()),
      azureBlobStorageLocation: map['azureBlobStorageLocation'] == null ? null : DatasetParquetAzureBlobStorageLocation.fromMap((map['azureBlobStorageLocation'] as Map).cast<String, dynamic>()),
      ...
      httpServerLocation: map['httpServerLocation'] == null ? null : DatasetParquetHttpServerLocation.fromMap((map['httpServerLocation'] as Map).cast<String, dynamic>()),
      linkedServiceName: map['linkedServiceName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetParquetSchemaColumn>(map['schemaColumns'], (value) => DatasetParquetSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
