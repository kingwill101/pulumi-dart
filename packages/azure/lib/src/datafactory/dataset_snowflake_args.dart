...
class DatasetSnowflakeArgs {
  ...
  DatasetSnowflakeArgs({
    ...
    List<DatasetSnowflakeSchemaColumn>? schemaColumns,
    String? schemaName,
    String? tableName,
  }) :
  ...
  factory DatasetSnowflakeArgs.fromMap(Map<String, dynamic> map) {
    return DatasetSnowflakeArgs(
      ...
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetSnowflakeSchemaColumn>(map['schemaColumns'], (value) => DatasetSnowflakeSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
