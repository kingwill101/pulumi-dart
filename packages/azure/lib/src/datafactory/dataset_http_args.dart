...
class DatasetHttpArgs {
  ...
  DatasetHttpArgs({
    ...
    List<DatasetHttpSchemaColumn>? schemaColumns,
  }) :
  ...
  factory DatasetHttpArgs.fromMap(Map<String, dynamic> map) {
    return DatasetHttpArgs(
      ...
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetHttpSchemaColumn>(map['schemaColumns'], (value) => DatasetHttpSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
