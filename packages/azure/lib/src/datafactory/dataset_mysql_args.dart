...
class DatasetMysqlArgs {
  ...
  DatasetMysqlArgs({
    ...
    List<DatasetMysqlSchemaColumn>? schemaColumns,
    String? tableName,
  }) :
  ...
  factory DatasetMysqlArgs.fromMap(Map<String, dynamic> map) {
    return DatasetMysqlArgs(
      ...
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetMysqlSchemaColumn>(map['schemaColumns'], (value) => DatasetMysqlSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
