...
class TriggerBlobEvent extends pulumi.CustomResource {
  ...
  TriggerBlobEvent(
    ...
    this.blobPathBeginsWith = registerOutput<String?>('blobPathBeginsWith');
    this.blobPathEndsWith = registerOutput<String?>('blobPathEndsWith');
    this.dataFactoryId = registerOutput<String>('dataFactoryId');
    this.description = registerOutput<String?>('description');
    this.events = registerOutput<List<String>>('events');
    this.ignoreEmptyBlobs = registerOutput<bool?>('ignoreEmptyBlobs');
    this.name = registerOutput<String>('name');
    this.pipelines = registerOutput<List<TriggerBlobEventPipeline>>('pipelines');
