...
class LinkedServiceAzureFileStorageArgs {
  ...
  LinkedServiceAzureFileStorageArgs({
    ...
    LinkedServiceAzureFileStorageKeyVaultPassword? keyVaultPassword,
    String? name,
  ...
  factory LinkedServiceAzureFileStorageArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceAzureFileStorageArgs(
      ...
      keyVaultPassword: map['keyVaultPassword'] == null ? null : LinkedServiceAzureFileStorageKeyVaultPassword.fromMap((map['keyVaultPassword'] as Map).cast<String, dynamic>()),
