...
class DatasetAzureSqlTableArgs {
  ...
  DatasetAzureSqlTableArgs({
    ...
    String? description,
    String? folder,
    required String linkedServiceId,
    String? name,
    Map<String, String>? parameters,
    String? schema,
    List<DatasetAzureSqlTableSchemaColumn>? schemaColumns,
    String? table,
  }) :
  ...
  factory DatasetAzureSqlTableArgs.fromMap(Map<String, dynamic> map) {
    return DatasetAzureSqlTableArgs(
      ...
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetAzureSqlTableSchemaColumn>(map['schemaColumns'], (value) => DatasetAzureSqlTableSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
