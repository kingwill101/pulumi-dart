...
class TriggerScheduleArgs {
  ...
  TriggerScheduleArgs({
    ...
    List<TriggerSchedulePipeline>? pipelines,
    TriggerScheduleSchedule? schedule,
    String? startTime,
    String? timeZone,
  }) :
  ...
  factory TriggerScheduleArgs.fromMap(Map<String, dynamic> map) {
    return TriggerScheduleArgs(
      ...
      pipelineParameters: map['pipelineParameters'] == null ? null : (map['pipelineParameters'] as Map).cast<String, String>(),
      pipelines: map['pipelines'] == null ? null : pulumi.Input.decodeList<TriggerSchedulePipeline>(map['pipelines'], (value) => TriggerSchedulePipeline.fromMap((value as Map).cast<String, dynamic>())),
      schedule: map['schedule'] == null ? null : TriggerScheduleSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
