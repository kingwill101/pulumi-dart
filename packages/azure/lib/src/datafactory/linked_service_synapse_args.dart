...
class LinkedServiceSynapseArgs {
  ...
  LinkedServiceSynapseArgs({
    ...
    LinkedServiceSynapseKeyVaultPassword? keyVaultPassword,
    String? name,
  ...
  factory LinkedServiceSynapseArgs.fromMap(Map<String, dynamic> map) {
    return LinkedServiceSynapseArgs(
      ...
      keyVaultPassword: map['keyVaultPassword'] == null ? null : LinkedServiceSynapseKeyVaultPassword.fromMap((map['keyVaultPassword'] as Map).cast<String, dynamic>()),
