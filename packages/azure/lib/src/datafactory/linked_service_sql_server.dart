...
class LinkedServiceSqlServer extends pulumi.CustomResource {
  ...
  LinkedServiceSqlServer(
    ...
    this.keyVaultConnectionString = registerOutput<LinkedServiceSqlServerKeyVaultConnectionString?>('keyVaultConnectionString');
    this.keyVaultPassword = registerOutput<LinkedServiceSqlServerKeyVaultPassword?>('keyVaultPassword');
