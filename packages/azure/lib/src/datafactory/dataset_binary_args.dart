...
class DatasetBinaryArgs {
  ...
  DatasetBinaryArgs({
    ...
    DatasetBinaryAzureBlobStorageLocation? azureBlobStorageLocation,
    DatasetBinaryCompression? compression,
    required String dataFactoryId,
    String? description,
    String? folder,
    DatasetBinaryHttpServerLocation? httpServerLocation,
    required String linkedServiceName,
    String? name,
    Map<String, String>? parameters,
    DatasetBinarySftpServerLocation? sftpServerLocation,
  }) :
  ...
  factory DatasetBinaryArgs.fromMap(Map<String, dynamic> map) {
    return DatasetBinaryArgs(
      ...
      azureBlobStorageLocation: map['azureBlobStorageLocation'] == null ? null : DatasetBinaryAzureBlobStorageLocation.fromMap((map['azureBlobStorageLocation'] as Map).cast<String, dynamic>()),
      compression: map['compression'] == null ? null : DatasetBinaryCompression.fromMap((map['compression'] as Map).cast<String, dynamic>()),
      dataFactoryId: map['dataFactoryId'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      folder: map['folder'] == null ? null : map['folder'] as String,
      httpServerLocation: map['httpServerLocation'] == null ? null : DatasetBinaryHttpServerLocation.fromMap((map['httpServerLocation'] as Map).cast<String, dynamic>()),
      linkedServiceName: map['linkedServiceName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      sftpServerLocation: map['sftpServerLocation'] == null ? null : DatasetBinarySftpServerLocation.fromMap((map['sftpServerLocation'] as Map).cast<String, dynamic>()),
    );
  }
}
