...
class DatasetCosmosDBApiSchemaColumn {
  ...
  /// Creates a new [DatasetCosmosDBApiSchemaColumn].
  ...
  factory DatasetCosmosDBApiSchemaColumn.fromMap(Map<String, dynamic> map) {
    return DatasetCosmosDBApiSchemaColumn(
