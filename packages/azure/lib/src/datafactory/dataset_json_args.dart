...
class DatasetJsonArgs {
  ...
  DatasetJsonArgs({
    ...
    DatasetJsonAzureBlobStorageLocation? azureBlobStorageLocation,
    required String dataFactoryId,
    String? description,
    String? encoding,
    String? folder,
    DatasetJsonHttpServerLocation? httpServerLocation,
    required String linkedServiceName,
    String? name,
    Map<String, String>? parameters,
    List<DatasetJsonSchemaColumn>? schemaColumns,
  }) :
  ...
  factory DatasetJsonArgs.fromMap(Map<String, dynamic> map) {
    return DatasetJsonArgs(
      ...
      azureBlobStorageLocation: map['azureBlobStorageLocation'] == null ? null : DatasetJsonAzureBlobStorageLocation.fromMap((map['azureBlobStorageLocation'] as Map).cast<String, dynamic>()),
      ...
      httpServerLocation: map['httpServerLocation'] == null ? null : DatasetJsonHttpServerLocation.fromMap((map['httpServerLocation'] as Map).cast<String, dynamic>()),
      linkedServiceName: map['linkedServiceName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      parameters: map['parameters'] == null ? null : (map['parameters'] as Map).cast<String, String>(),
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetJsonSchemaColumn>(map['schemaColumns'], (value) => DatasetJsonSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
