...
class DatasetPostgresqlArgs {
  ...
  DatasetPostgresqlArgs({
    ...
    List<DatasetPostgresqlSchemaColumn>? schemaColumns,
    String? tableName,
  }) :
  ...
  factory DatasetPostgresqlArgs.fromMap(Map<String, dynamic> map) {
    return DatasetPostgresqlArgs(
      ...
      schemaColumns: map['schemaColumns'] == null ? null : pulumi.Input.decodeList<DatasetPostgresqlSchemaColumn>(map['schemaColumns'], (value) => DatasetPostgresqlSchemaColumn.fromMap((value as Map).cast<String, dynamic>())),
