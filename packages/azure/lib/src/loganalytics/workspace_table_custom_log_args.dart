...
class WorkspaceTableCustomLogArgs {
  ...
  WorkspaceTableCustomLogArgs({
    required List<WorkspaceTableCustomLogColumn> columns,
    String? description,
    String? displayName,
    String? name,
    String? plan,
  ...
  factory WorkspaceTableCustomLogArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceTableCustomLogArgs(
      columns: pulumi.Input.decodeList<WorkspaceTableCustomLogColumn>(map['columns'], (value) => WorkspaceTableCustomLogColumn.fromMap((value as Map).cast<String, dynamic>())),
