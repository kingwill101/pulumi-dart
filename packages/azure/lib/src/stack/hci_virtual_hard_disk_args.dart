...
class HciVirtualHardDiskArgs {
  ...
  HciVirtualHardDiskArgs({
    ...
    required int diskSizeInGb,
    bool? dynamicEnabled,
    String? hypervGeneration,
    String? location,
    int? logicalSectorInBytes,
    String? name,
    int? physicalSectorInBytes,
  ...
  factory HciVirtualHardDiskArgs.fromMap(Map<String, dynamic> map) {
    return HciVirtualHardDiskArgs(
      blockSizeInBytes: map['blockSizeInBytes'] == null ? null : map['blockSizeInBytes'] as int,
      ...
      dynamicEnabled: map['dynamicEnabled'] == null ? null : map['dynamicEnabled'] as bool,
      hypervGeneration: map['hypervGeneration'] == null ? null : map['hypervGeneration'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      logicalSectorInBytes: map['logicalSectorInBytes'] == null ? null : map['logicalSectorInBytes'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      physicalSectorInBytes: map['physicalSectorInBytes'] == null ? null : map['physicalSectorInBytes'] as int,
