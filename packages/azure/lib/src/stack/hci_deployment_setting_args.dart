...
class HciDeploymentSettingArgs {
  ...
  HciDeploymentSettingArgs({
    required List<String> arcResourceIds,
    required List<HciDeploymentSettingScaleUnit> scaleUnits,
    required String stackHciClusterId,
  ...
  factory HciDeploymentSettingArgs.fromMap(Map<String, dynamic> map) {
    return HciDeploymentSettingArgs(
      arcResourceIds: (map['arcResourceIds'] as List).cast<String>(),
      scaleUnits: pulumi.Input.decodeList<HciDeploymentSettingScaleUnit>(map['scaleUnits'], (value) => HciDeploymentSettingScaleUnit.fromMap((value as Map).cast<String, dynamic>())),
      stackHciClusterId: map['stackHciClusterId'] as String,
