...
class BackupPolicyMysqlFlexibleServerArgs {
  ...
  BackupPolicyMysqlFlexibleServerArgs({
    ...
    required BackupPolicyMysqlFlexibleServerDefaultRetentionRule defaultRetentionRule,
    String? name,
    List<BackupPolicyMysqlFlexibleServerRetentionRule>? retentionRules,
    String? timeZone,
  ...
  factory BackupPolicyMysqlFlexibleServerArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyMysqlFlexibleServerArgs(
      ...
      defaultRetentionRule: BackupPolicyMysqlFlexibleServerDefaultRetentionRule.fromMap((map['defaultRetentionRule'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      retentionRules: map['retentionRules'] == null ? null : pulumi.Input.decodeList<BackupPolicyMysqlFlexibleServerRetentionRule>(map['retentionRules'], (value) => BackupPolicyMysqlFlexibleServerRetentionRule.fromMap((value as Map).cast<String, dynamic>())),
