...
class ResourceGuardArgs {
  ...
  ResourceGuardArgs({
    ...
    List<String>? vaultCriticalOperationExclusionLists,
  }) :
  ...
  factory ResourceGuardArgs.fromMap(Map<String, dynamic> map) {
    return ResourceGuardArgs(
      ...
      vaultCriticalOperationExclusionLists: map['vaultCriticalOperationExclusionLists'] == null ? null : (map['vaultCriticalOperationExclusionLists'] as List).cast<String>(),
    );
  }
}
