...
class BackupPolicyKubernetesClusterArgs {
  ...
  BackupPolicyKubernetesClusterArgs({
    ...
    required BackupPolicyKubernetesClusterDefaultRetentionRule defaultRetentionRule,
    String? name,
    required String resourceGroupName,
    List<BackupPolicyKubernetesClusterRetentionRule>? retentionRules,
    String? timeZone,
  ...
  factory BackupPolicyKubernetesClusterArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyKubernetesClusterArgs(
      ...
      defaultRetentionRule: BackupPolicyKubernetesClusterDefaultRetentionRule.fromMap((map['defaultRetentionRule'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      retentionRules: map['retentionRules'] == null ? null : pulumi.Input.decodeList<BackupPolicyKubernetesClusterRetentionRule>(map['retentionRules'], (value) => BackupPolicyKubernetesClusterRetentionRule.fromMap((value as Map).cast<String, dynamic>())),
