...
class BackupPolicyPostgresqlArgs {
  ...
  BackupPolicyPostgresqlArgs({
    ...
    required String defaultRetentionDuration,
    String? name,
    required String resourceGroupName,
    List<BackupPolicyPostgresqlRetentionRule>? retentionRules,
    String? timeZone,
    required String vaultName,
  }) :
      backupRepeatingTimeIntervals = pulumi.Input.asInput<List<String>>(backupRepeatingTimeIntervals),
      defaultRetentionDuration = pulumi.Input.asInput<String>(defaultRetentionDuration),
  ...
  factory BackupPolicyPostgresqlArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyPostgresqlArgs(
      ...
      defaultRetentionDuration: map['defaultRetentionDuration'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      retentionRules: map['retentionRules'] == null ? null : pulumi.Input.decodeList<BackupPolicyPostgresqlRetentionRule>(map['retentionRules'], (value) => BackupPolicyPostgresqlRetentionRule.fromMap((value as Map).cast<String, dynamic>())),
