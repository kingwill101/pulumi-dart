...
class BackupPolicyBlobStorageArgs {
  ...
  BackupPolicyBlobStorageArgs({
    List<String>? backupRepeatingTimeIntervals,
    String? name,
    String? operationalDefaultRetentionDuration,
    List<BackupPolicyBlobStorageRetentionRule>? retentionRules,
    String? timeZone,
  ...
  factory BackupPolicyBlobStorageArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyBlobStorageArgs(
      backupRepeatingTimeIntervals: map['backupRepeatingTimeIntervals'] == null ? null : (map['backupRepeatingTimeIntervals'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      operationalDefaultRetentionDuration: map['operationalDefaultRetentionDuration'] == null ? null : map['operationalDefaultRetentionDuration'] as String,
      retentionRules: map['retentionRules'] == null ? null : pulumi.Input.decodeList<BackupPolicyBlobStorageRetentionRule>(map['retentionRules'], (value) => BackupPolicyBlobStorageRetentionRule.fromMap((value as Map).cast<String, dynamic>())),
      timeZone: map['timeZone'] == null ? null : map['timeZone'] as String,
      vaultDefaultRetentionDuration: map['vaultDefaultRetentionDuration'] == null ? null : map['vaultDefaultRetentionDuration'] as String,
