...
class BackupPolicyPostgresqlFlexibleServerArgs {
  ...
  BackupPolicyPostgresqlFlexibleServerArgs({
    required List<String> backupRepeatingTimeIntervals,
    required BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule defaultRetentionRule,
    String? name,
    List<BackupPolicyPostgresqlFlexibleServerRetentionRule>? retentionRules,
    String? timeZone,
  ...
  factory BackupPolicyPostgresqlFlexibleServerArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyPostgresqlFlexibleServerArgs(
      backupRepeatingTimeIntervals: (map['backupRepeatingTimeIntervals'] as List).cast<String>(),
      defaultRetentionRule: BackupPolicyPostgresqlFlexibleServerDefaultRetentionRule.fromMap((map['defaultRetentionRule'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      retentionRules: map['retentionRules'] == null ? null : pulumi.Input.decodeList<BackupPolicyPostgresqlFlexibleServerRetentionRule>(map['retentionRules'], (value) => BackupPolicyPostgresqlFlexibleServerRetentionRule.fromMap((value as Map).cast<String, dynamic>())),
