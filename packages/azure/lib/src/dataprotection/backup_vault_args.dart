...
class BackupVaultArgs {
  ...
  BackupVaultArgs({
    ...
    BackupVaultIdentity? identity,
    String? immutability,
    String? location,
    String? name,
    required String redundancy,
  ...
  factory BackupVaultArgs.fromMap(Map<String, dynamic> map) {
    return BackupVaultArgs(
      ...
      identity: map['identity'] == null ? null : BackupVaultIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      softDelete: map['softDelete'] == null ? null : map['softDelete'] as String,
