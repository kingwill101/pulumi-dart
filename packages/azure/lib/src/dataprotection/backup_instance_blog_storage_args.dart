...
class BackupInstanceBlogStorageArgs {
  ...
  BackupInstanceBlogStorageArgs({
    ...
    String? location,
    String? name,
    List<String>? storageAccountContainerNames,
  ...
  factory BackupInstanceBlogStorageArgs.fromMap(Map<String, dynamic> map) {
    return BackupInstanceBlogStorageArgs(
      ...
      storageAccountContainerNames: map['storageAccountContainerNames'] == null ? null : (map['storageAccountContainerNames'] as List).cast<String>(),
