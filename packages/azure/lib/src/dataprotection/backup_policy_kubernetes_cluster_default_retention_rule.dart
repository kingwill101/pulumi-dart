...
class BackupPolicyKubernetesClusterDefaultRetentionRule {
  ...
  final List<BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycle> lifeCycles;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'lifeCycles': pulumi.Input.encodeList<BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycle, Map<String, dynamic>>(lifeCycles, (value) => value.toMap()),
    };
  }
  ...
  factory BackupPolicyKubernetesClusterDefaultRetentionRule.fromMap(Map<String, dynamic> map) {
    return BackupPolicyKubernetesClusterDefaultRetentionRule(
      lifeCycles: pulumi.Input.decodeList<BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycle>(map['lifeCycles'], (value) => BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycle.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
