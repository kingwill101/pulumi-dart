...
class BackupPolicyDiskArgs {
  ...
  BackupPolicyDiskArgs({
    ...
    String? name,
    List<BackupPolicyDiskRetentionRule>? retentionRules,
    String? timeZone,
  ...
  factory BackupPolicyDiskArgs.fromMap(Map<String, dynamic> map) {
    return BackupPolicyDiskArgs(
      ...
      retentionRules: map['retentionRules'] == null ? null : pulumi.Input.decodeList<BackupPolicyDiskRetentionRule>(map['retentionRules'], (value) => BackupPolicyDiskRetentionRule.fromMap((value as Map).cast<String, dynamic>())),
