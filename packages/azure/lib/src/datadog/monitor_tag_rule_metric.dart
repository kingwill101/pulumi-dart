...
class MonitorTagRuleMetric {
  ...
  final List<MonitorTagRuleMetricFilter>? filters;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'filters': ?filters == null ? null : pulumi.Input.encodeList<MonitorTagRuleMetricFilter, Map<String, dynamic>>(filters!, (value) => value.toMap()),
    };
  }

  factory MonitorTagRuleMetric.fromMap(Map<String, dynamic> map) {
    return MonitorTagRuleMetric(
      filters: map['filters'] == null ? null : pulumi.Input.decodeList<MonitorTagRuleMetricFilter>(map['filters'], (value) => MonitorTagRuleMetricFilter.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
