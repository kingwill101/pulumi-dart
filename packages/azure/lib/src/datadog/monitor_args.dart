...
class MonitorArgs {
  ...
  MonitorArgs({
    required MonitorDatadogOrganization datadogOrganization,
  ...
  factory MonitorArgs.fromMap(Map<String, dynamic> map) {
    return MonitorArgs(
      datadogOrganization: MonitorDatadogOrganization.fromMap((map['datadogOrganization'] as Map).cast<String, dynamic>()),
