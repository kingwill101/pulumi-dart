...
class FrontdoorFirewallPolicyManagedRule {
  ...
  final List<FrontdoorFirewallPolicyManagedRuleExclusion>? exclusions;
  /// One or more `override` blocks as defined below.
  final List<FrontdoorFirewallPolicyManagedRuleOverride>? overrides;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'action': action,
      'exclusions': ?exclusions == null ? null : pulumi.Input.encodeList<FrontdoorFirewallPolicyManagedRuleExclusion, Map<String, dynamic>>(exclusions!, (value) => value.toMap()),
      'overrides': ?overrides == null ? null : pulumi.Input.encodeList<FrontdoorFirewallPolicyManagedRuleOverride, Map<String, dynamic>>(overrides!, (value) => value.toMap()),
      'type': type,
      'version': version,
    };
  }
  ...
  factory FrontdoorFirewallPolicyManagedRule.fromMap(Map<String, dynamic> map) {
    return FrontdoorFirewallPolicyManagedRule(
      ...
      exclusions: map['exclusions'] == null ? null : pulumi.Input.decodeList<FrontdoorFirewallPolicyManagedRuleExclusion>(map['exclusions'], (value) => FrontdoorFirewallPolicyManagedRuleExclusion.fromMap((value as Map).cast<String, dynamic>())),
      overrides: map['overrides'] == null ? null : pulumi.Input.decodeList<FrontdoorFirewallPolicyManagedRuleOverride>(map['overrides'], (value) => FrontdoorFirewallPolicyManagedRuleOverride.fromMap((value as Map).cast<String, dynamic>())),
