...
class FrontdoorOriginArgs {
  ...
  FrontdoorOriginArgs({
    ...
    required bool certificateNameCheckEnabled,
    bool? enabled,
    ...
    int? priority,
    FrontdoorOriginPrivateLink? privateLink,
    int? weight,
  }) :
  ...
  factory FrontdoorOriginArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorOriginArgs(
      ...
      certificateNameCheckEnabled: map['certificateNameCheckEnabled'] as bool,
      ...
      privateLink: map['privateLink'] == null ? null : FrontdoorOriginPrivateLink.fromMap((map['privateLink'] as Map).cast<String, dynamic>()),
