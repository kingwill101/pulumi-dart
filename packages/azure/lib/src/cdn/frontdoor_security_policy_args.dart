...
class FrontdoorSecurityPolicyArgs {
  ...
  FrontdoorSecurityPolicyArgs({
    ...
    String? name,
    required FrontdoorSecurityPolicySecurityPolicies securityPolicies,
  }) :
  ...
  factory FrontdoorSecurityPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorSecurityPolicyArgs(
      ...
      securityPolicies: FrontdoorSecurityPolicySecurityPolicies.fromMap((map['securityPolicies'] as Map).cast<String, dynamic>()),
    );
  }
}
