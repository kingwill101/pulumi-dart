...
class EndpointDeliveryRuleUrlFileExtensionCondition {
  ...
  /// Creates a new [EndpointDeliveryRuleUrlFileExtensionCondition].
  ...
  factory EndpointDeliveryRuleUrlFileExtensionCondition.fromMap(Map<String, dynamic> map) {
    return EndpointDeliveryRuleUrlFileExtensionCondition(
