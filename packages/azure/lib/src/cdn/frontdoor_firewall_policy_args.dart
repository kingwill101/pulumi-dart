...
class FrontdoorFirewallPolicyArgs {
  ...
  FrontdoorFirewallPolicyArgs({
    ...
    List<FrontdoorFirewallPolicyCustomRule>? customRules,
    bool? enabled,
    int? jsChallengeCookieExpirationInMinutes,
    FrontdoorFirewallPolicyLogScrubbing? logScrubbing,
    List<FrontdoorFirewallPolicyManagedRule>? managedRules,
    required String mode,
    String? name,
    String? redirectUrl,
    bool? requestBodyCheckEnabled,
  ...
  factory FrontdoorFirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorFirewallPolicyArgs(
      captchaCookieExpirationInMinutes: map['captchaCookieExpirationInMinutes'] == null ? null : map['captchaCookieExpirationInMinutes'] as int,
      ...
      customRules: map['customRules'] == null ? null : pulumi.Input.decodeList<FrontdoorFirewallPolicyCustomRule>(map['customRules'], (value) => FrontdoorFirewallPolicyCustomRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      logScrubbing: map['logScrubbing'] == null ? null : FrontdoorFirewallPolicyLogScrubbing.fromMap((map['logScrubbing'] as Map).cast<String, dynamic>()),
      managedRules: map['managedRules'] == null ? null : pulumi.Input.decodeList<FrontdoorFirewallPolicyManagedRule>(map['managedRules'], (value) => FrontdoorFirewallPolicyManagedRule.fromMap((value as Map).cast<String, dynamic>())),
      mode: map['mode'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      redirectUrl: map['redirectUrl'] == null ? null : map['redirectUrl'] as String,
      requestBodyCheckEnabled: map['requestBodyCheckEnabled'] == null ? null : map['requestBodyCheckEnabled'] as bool,
