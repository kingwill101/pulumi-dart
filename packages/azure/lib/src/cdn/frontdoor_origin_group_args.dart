...
class FrontdoorOriginGroupArgs {
  ...
  FrontdoorOriginGroupArgs({
    ...
    FrontdoorOriginGroupHealthProbe? healthProbe,
    required FrontdoorOriginGroupLoadBalancing loadBalancing,
    String? name,
  ...
  factory FrontdoorOriginGroupArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorOriginGroupArgs(
      ...
      healthProbe: map['healthProbe'] == null ? null : FrontdoorOriginGroupHealthProbe.fromMap((map['healthProbe'] as Map).cast<String, dynamic>()),
      loadBalancing: FrontdoorOriginGroupLoadBalancing.fromMap((map['loadBalancing'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      restoreTrafficTimeToHealedOrNewEndpointInMinutes: map['restoreTrafficTimeToHealedOrNewEndpointInMinutes'] == null ? null : map['restoreTrafficTimeToHealedOrNewEndpointInMinutes'] as int,
