...
class FrontdoorCustomDomainAssociationArgs {
  ...
  FrontdoorCustomDomainAssociationArgs({
    required String cdnFrontdoorCustomDomainId,
    required List<String> cdnFrontdoorRouteIds,
  }) :
  ...
  factory FrontdoorCustomDomainAssociationArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorCustomDomainAssociationArgs(
      cdnFrontdoorCustomDomainId: map['cdnFrontdoorCustomDomainId'] as String,
      cdnFrontdoorRouteIds: (map['cdnFrontdoorRouteIds'] as List).cast<String>(),
    );
  }
}
