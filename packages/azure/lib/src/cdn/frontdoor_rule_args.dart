...
class FrontdoorRuleArgs {
  ...
  FrontdoorRuleArgs({
    required FrontdoorRuleActions actions,
    String? behaviorOnMatch,
    required String cdnFrontdoorRuleSetId,
    FrontdoorRuleConditions? conditions,
    String? name,
    required int order,
  }) :
  ...
  factory FrontdoorRuleArgs.fromMap(Map<String, dynamic> map) {
    return FrontdoorRuleArgs(
      actions: FrontdoorRuleActions.fromMap((map['actions'] as Map).cast<String, dynamic>()),
      behaviorOnMatch: map['behaviorOnMatch'] == null ? null : map['behaviorOnMatch'] as String,
      cdnFrontdoorRuleSetId: map['cdnFrontdoorRuleSetId'] as String,
      conditions: map['conditions'] == null ? null : FrontdoorRuleConditions.fromMap((map['conditions'] as Map).cast<String, dynamic>()),
