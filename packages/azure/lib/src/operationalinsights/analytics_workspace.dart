...
class AnalyticsWorkspace extends pulumi.CustomResource {
  ...
  AnalyticsWorkspace(
    ...
    this.allowResourceOnlyPermissions = registerOutput<bool?>('allowResourceOnlyPermissions');
    this.cmkForQueryForced = registerOutput<bool?>('cmkForQueryForced');
    this.dailyQuotaGb = registerOutput<double?>('dailyQuotaGb');
    this.dataCollectionRuleId = registerOutput<String?>('dataCollectionRuleId');
    this.identity = registerOutput<AnalyticsWorkspaceIdentity?>('identity');
    this.immediateDataPurgeOn30DaysEnabled = registerOutput<bool?>('immediateDataPurgeOn30DaysEnabled');
    ...
    this.primarySharedKey = registerOutput<String>('primarySharedKey');
    this.reservationCapacityInGbPerDay = registerOutput<int?>('reservationCapacityInGbPerDay');
    this.resourceGroupName = registerOutput<String>('resourceGroupName');
    this.retentionInDays = registerOutput<int>('retentionInDays');
    this.secondarySharedKey = registerOutput<String>('secondarySharedKey');
