...
class AnalyticsWorkspaceArgs {
  ...
  AnalyticsWorkspaceArgs({
    bool? allowResourceOnlyPermissions,
    bool? cmkForQueryForced,
    double? dailyQuotaGb,
    String? dataCollectionRuleId,
    AnalyticsWorkspaceIdentity? identity,
    bool? immediateDataPurgeOn30DaysEnabled,
    ...
    String? location,
    String? name,
    int? reservationCapacityInGbPerDay,
  ...
  factory AnalyticsWorkspaceArgs.fromMap(Map<String, dynamic> map) {
    return AnalyticsWorkspaceArgs(
      allowResourceOnlyPermissions: map['allowResourceOnlyPermissions'] == null ? null : map['allowResourceOnlyPermissions'] as bool,
      cmkForQueryForced: map['cmkForQueryForced'] == null ? null : map['cmkForQueryForced'] as bool,
      ...
      identity: map['identity'] == null ? null : AnalyticsWorkspaceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      immediateDataPurgeOn30DaysEnabled: map['immediateDataPurgeOn30DaysEnabled'] == null ? null : map['immediateDataPurgeOn30DaysEnabled'] as bool,
      ...
      reservationCapacityInGbPerDay: map['reservationCapacityInGbPerDay'] == null ? null : map['reservationCapacityInGbPerDay'] as int,
