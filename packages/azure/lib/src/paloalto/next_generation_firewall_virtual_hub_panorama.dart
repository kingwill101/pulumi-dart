...
class NextGenerationFirewallVirtualHubPanorama extends pulumi.CustomResource {
  ...
  NextGenerationFirewallVirtualHubPanorama(
    ...
    this.destinationNats = registerOutput<List<NextGenerationFirewallVirtualHubPanoramaDestinationNat>?>('destinationNats');
    this.dnsSettings = registerOutput<NextGenerationFirewallVirtualHubPanoramaDnsSettings?>('dnsSettings');
    this.location = registerOutput<String>('location');
    this.marketplaceOfferId = registerOutput<String?>('marketplaceOfferId');
    this.name = registerOutput<String>('name');
    this.networkProfile = registerOutput<NextGenerationFirewallVirtualHubPanoramaNetworkProfile>('networkProfile');
    this.panoramaBase64Config = registerOutput<String>('panoramaBase64Config');
    this.panoramas = registerOutput<List<NextGenerationFirewallVirtualHubPanoramaPanorama>>('panoramas');
