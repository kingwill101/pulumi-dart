...
class NextGenerationFirewallVirtualNetworkLocalRulestackArgs {
  ...
  NextGenerationFirewallVirtualNetworkLocalRulestackArgs({
    List<NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat>? destinationNats,
    NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings? dnsSettings,
    String? marketplaceOfferId,
    String? name,
    required NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfile networkProfile,
    String? planId,
  ...
  factory NextGenerationFirewallVirtualNetworkLocalRulestackArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualNetworkLocalRulestackArgs(
      destinationNats: map['destinationNats'] == null ? null : pulumi.Input.decodeList<NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat>(map['destinationNats'], (value) => NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat.fromMap((value as Map).cast<String, dynamic>())),
      dnsSettings: map['dnsSettings'] == null ? null : NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      marketplaceOfferId: map['marketplaceOfferId'] == null ? null : map['marketplaceOfferId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
