...
class NextGenerationFirewallVirtualHubStrataCloudManagerArgs {
  ...
  NextGenerationFirewallVirtualHubStrataCloudManagerArgs({
    List<NextGenerationFirewallVirtualHubStrataCloudManagerDestinationNat>? destinationNats,
    NextGenerationFirewallVirtualHubStrataCloudManagerDnsSettings? dnsSettings,
    NextGenerationFirewallVirtualHubStrataCloudManagerIdentity? identity,
    String? location,
    String? marketplaceOfferId,
    String? name,
    required NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile networkProfile,
    String? planId,
    required String resourceGroupName,
    required String strataCloudManagerTenantName,
  ...
  factory NextGenerationFirewallVirtualHubStrataCloudManagerArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualHubStrataCloudManagerArgs(
      destinationNats: map['destinationNats'] == null ? null : pulumi.Input.decodeList<NextGenerationFirewallVirtualHubStrataCloudManagerDestinationNat>(map['destinationNats'], (value) => NextGenerationFirewallVirtualHubStrataCloudManagerDestinationNat.fromMap((value as Map).cast<String, dynamic>())),
      dnsSettings: map['dnsSettings'] == null ? null : NextGenerationFirewallVirtualHubStrataCloudManagerDnsSettings.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : NextGenerationFirewallVirtualHubStrataCloudManagerIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      marketplaceOfferId: map['marketplaceOfferId'] == null ? null : map['marketplaceOfferId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
      planId: map['planId'] == null ? null : map['planId'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      strataCloudManagerTenantName: map['strataCloudManagerTenantName'] as String,
