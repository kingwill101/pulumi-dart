...
class NextGenerationFirewallVirtualHubLocalRulestackArgs {
  ...
  NextGenerationFirewallVirtualHubLocalRulestackArgs({
    List<NextGenerationFirewallVirtualHubLocalRulestackDestinationNat>? destinationNats,
    NextGenerationFirewallVirtualHubLocalRulestackDnsSettings? dnsSettings,
    String? marketplaceOfferId,
    String? name,
    required NextGenerationFirewallVirtualHubLocalRulestackNetworkProfile networkProfile,
    String? planId,
  ...
  factory NextGenerationFirewallVirtualHubLocalRulestackArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualHubLocalRulestackArgs(
      destinationNats: map['destinationNats'] == null ? null : pulumi.Input.decodeList<NextGenerationFirewallVirtualHubLocalRulestackDestinationNat>(map['destinationNats'], (value) => NextGenerationFirewallVirtualHubLocalRulestackDestinationNat.fromMap((value as Map).cast<String, dynamic>())),
      dnsSettings: map['dnsSettings'] == null ? null : NextGenerationFirewallVirtualHubLocalRulestackDnsSettings.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      marketplaceOfferId: map['marketplaceOfferId'] == null ? null : map['marketplaceOfferId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: NextGenerationFirewallVirtualHubLocalRulestackNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
