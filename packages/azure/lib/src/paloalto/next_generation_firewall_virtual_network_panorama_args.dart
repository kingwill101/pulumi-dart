...
class NextGenerationFirewallVirtualNetworkPanoramaArgs {
  ...
  NextGenerationFirewallVirtualNetworkPanoramaArgs({
    List<NextGenerationFirewallVirtualNetworkPanoramaDestinationNat>? destinationNats,
    NextGenerationFirewallVirtualNetworkPanoramaDnsSettings? dnsSettings,
    String? location,
    String? marketplaceOfferId,
    String? name,
    required NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile networkProfile,
  ...
  factory NextGenerationFirewallVirtualNetworkPanoramaArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualNetworkPanoramaArgs(
      destinationNats: map['destinationNats'] == null ? null : pulumi.Input.decodeList<NextGenerationFirewallVirtualNetworkPanoramaDestinationNat>(map['destinationNats'], (value) => NextGenerationFirewallVirtualNetworkPanoramaDestinationNat.fromMap((value as Map).cast<String, dynamic>())),
      dnsSettings: map['dnsSettings'] == null ? null : NextGenerationFirewallVirtualNetworkPanoramaDnsSettings.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      marketplaceOfferId: map['marketplaceOfferId'] == null ? null : map['marketplaceOfferId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: NextGenerationFirewallVirtualNetworkPanoramaNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
