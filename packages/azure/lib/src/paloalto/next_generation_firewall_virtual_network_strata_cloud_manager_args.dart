...
class NextGenerationFirewallVirtualNetworkStrataCloudManagerArgs {
  ...
  NextGenerationFirewallVirtualNetworkStrataCloudManagerArgs({
    List<NextGenerationFirewallVirtualNetworkStrataCloudManagerDestinationNat>? destinationNats,
    NextGenerationFirewallVirtualNetworkStrataCloudManagerDnsSettings? dnsSettings,
    NextGenerationFirewallVirtualNetworkStrataCloudManagerIdentity? identity,
    String? location,
    String? marketplaceOfferId,
    String? name,
    required NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfile networkProfile,
    String? planId,
  ...
  factory NextGenerationFirewallVirtualNetworkStrataCloudManagerArgs.fromMap(Map<String, dynamic> map) {
    return NextGenerationFirewallVirtualNetworkStrataCloudManagerArgs(
      destinationNats: map['destinationNats'] == null ? null : pulumi.Input.decodeList<NextGenerationFirewallVirtualNetworkStrataCloudManagerDestinationNat>(map['destinationNats'], (value) => NextGenerationFirewallVirtualNetworkStrataCloudManagerDestinationNat.fromMap((value as Map).cast<String, dynamic>())),
      dnsSettings: map['dnsSettings'] == null ? null : NextGenerationFirewallVirtualNetworkStrataCloudManagerDnsSettings.fromMap((map['dnsSettings'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : NextGenerationFirewallVirtualNetworkStrataCloudManagerIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      marketplaceOfferId: map['marketplaceOfferId'] == null ? null : map['marketplaceOfferId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
