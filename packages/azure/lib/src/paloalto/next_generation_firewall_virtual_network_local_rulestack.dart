...
class NextGenerationFirewallVirtualNetworkLocalRulestack extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat>?> destinationNats;
  ...
  NextGenerationFirewallVirtualNetworkLocalRulestack(
    ...
    this.destinationNats = registerOutput<List<NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat>?>('destinationNats');
    this.dnsSettings = registerOutput<NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings?>('dnsSettings');
    this.marketplaceOfferId = registerOutput<String?>('marketplaceOfferId');
    this.name = registerOutput<String>('name');
    this.networkProfile = registerOutput<NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfile>('networkProfile');
