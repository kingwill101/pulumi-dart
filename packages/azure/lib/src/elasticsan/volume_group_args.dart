...
class VolumeGroupArgs {
  ...
  VolumeGroupArgs({
    ...
    VolumeGroupEncryption? encryption,
    String? encryptionType,
    VolumeGroupIdentity? identity,
    String? name,
    List<VolumeGroupNetworkRule>? networkRules,
    String? protocolType,
  }) :
  ...
  factory VolumeGroupArgs.fromMap(Map<String, dynamic> map) {
    return VolumeGroupArgs(
      ...
      encryption: map['encryption'] == null ? null : VolumeGroupEncryption.fromMap((map['encryption'] as Map).cast<String, dynamic>()),
      encryptionType: map['encryptionType'] == null ? null : map['encryptionType'] as String,
      identity: map['identity'] == null ? null : VolumeGroupIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networkRules: map['networkRules'] == null ? null : pulumi.Input.decodeList<VolumeGroupNetworkRule>(map['networkRules'], (value) => VolumeGroupNetworkRule.fromMap((value as Map).cast<String, dynamic>())),
