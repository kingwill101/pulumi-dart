...
class VolumeArgs {
  ...
  VolumeArgs({
    VolumeCreateSource? createSource,
    String? name,
    required int sizeInGib,
  ...
  factory VolumeArgs.fromMap(Map<String, dynamic> map) {
    return VolumeArgs(
      createSource: map['createSource'] == null ? null : VolumeCreateSource.fromMap((map['createSource'] as Map).cast<String, dynamic>()),
