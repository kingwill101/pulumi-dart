...
class CacheArgs {
  ...
  CacheArgs({
    ...
    List<CachePatchSchedule>? patchSchedules,
    String? privateStaticIpAddress,
    bool? publicNetworkAccessEnabled,
    CacheRedisConfiguration? redisConfiguration,
    String? redisVersion,
  ...
  factory CacheArgs.fromMap(Map<String, dynamic> map) {
    return CacheArgs(
      ...
      nonSslPortEnabled: map['nonSslPortEnabled'] == null ? null : map['nonSslPortEnabled'] as bool,
      patchSchedules: map['patchSchedules'] == null ? null : pulumi.Input.decodeList<CachePatchSchedule>(map['patchSchedules'], (value) => CachePatchSchedule.fromMap((value as Map).cast<String, dynamic>())),
      privateStaticIpAddress: map['privateStaticIpAddress'] == null ? null : map['privateStaticIpAddress'] as String,
      publicNetworkAccessEnabled: map['publicNetworkAccessEnabled'] == null ? null : map['publicNetworkAccessEnabled'] as bool,
      redisConfiguration: map['redisConfiguration'] == null ? null : CacheRedisConfiguration.fromMap((map['redisConfiguration'] as Map).cast<String, dynamic>()),
