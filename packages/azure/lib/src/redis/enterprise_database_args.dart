...
class EnterpriseDatabaseArgs {
  ...
  EnterpriseDatabaseArgs({
    ...
    List<String>? linkedDatabaseIds,
    List<EnterpriseDatabaseModule>? modules,
    String? name,
    int? port,
  }) :
  ...
  factory EnterpriseDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return EnterpriseDatabaseArgs(
      ...
      linkedDatabaseGroupNickname: map['linkedDatabaseGroupNickname'] == null ? null : map['linkedDatabaseGroupNickname'] as String,
      linkedDatabaseIds: map['linkedDatabaseIds'] == null ? null : (map['linkedDatabaseIds'] as List).cast<String>(),
      modules: map['modules'] == null ? null : pulumi.Input.decodeList<EnterpriseDatabaseModule>(map['modules'], (value) => EnterpriseDatabaseModule.fromMap((value as Map).cast<String, dynamic>())),
