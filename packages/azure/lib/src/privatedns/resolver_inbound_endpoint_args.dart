...
class ResolverInboundEndpointArgs {
  ...
  ResolverInboundEndpointArgs({
    required ResolverInboundEndpointIpConfigurations ipConfigurations,
    String? location,
    String? name,
  ...
  factory ResolverInboundEndpointArgs.fromMap(Map<String, dynamic> map) {
    return ResolverInboundEndpointArgs(
      ipConfigurations: ResolverInboundEndpointIpConfigurations.fromMap((map['ipConfigurations'] as Map).cast<String, dynamic>()),
