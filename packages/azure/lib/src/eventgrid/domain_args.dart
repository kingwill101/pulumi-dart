...
/// {@template pulumi_eventgrid_domain_domain_args_doc}
/// The set of arguments for Domain.
/// {@endtemplate}
/// {@macro pulumi_eventgrid_domain_domain_args_doc}
class DomainArgs {
  ...
  DomainArgs({
    ...
    List<DomainInboundIpRule>? inboundIpRules,
    DomainInputMappingDefaultValues? inputMappingDefaultValues,
    DomainInputMappingFields? inputMappingFields,
    String? inputSchema,
  ...
  factory DomainArgs.fromMap(Map<String, dynamic> map) {
    return DomainArgs(
      autoCreateTopicWithFirstSubscription: map['autoCreateTopicWithFirstSubscription'] == null ? null : map['autoCreateTopicWithFirstSubscription'] as bool,
      autoDeleteTopicWithLastSubscription: map['autoDeleteTopicWithLastSubscription'] == null ? null : map['autoDeleteTopicWithLastSubscription'] as bool,
      identity: map['identity'] == null ? null : DomainIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      inboundIpRules: map['inboundIpRules'] == null ? null : pulumi.Input.decodeList<DomainInboundIpRule>(map['inboundIpRules'], (value) => DomainInboundIpRule.fromMap((value as Map).cast<String, dynamic>())),
      inputMappingDefaultValues: map['inputMappingDefaultValues'] == null ? null : DomainInputMappingDefaultValues.fromMap((map['inputMappingDefaultValues'] as Map).cast<String, dynamic>()),
      inputMappingFields: map['inputMappingFields'] == null ? null : DomainInputMappingFields.fromMap((map['inputMappingFields'] as Map).cast<String, dynamic>()),
