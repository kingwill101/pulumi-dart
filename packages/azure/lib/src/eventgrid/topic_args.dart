...
class TopicArgs {
  ...
  TopicArgs({
    ...
    List<TopicInboundIpRule>? inboundIpRules,
    TopicInputMappingDefaultValues? inputMappingDefaultValues,
    TopicInputMappingFields? inputMappingFields,
    String? inputSchema,
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      identity: map['identity'] == null ? null : TopicIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      inboundIpRules: map['inboundIpRules'] == null ? null : pulumi.Input.decodeList<TopicInboundIpRule>(map['inboundIpRules'], (value) => TopicInboundIpRule.fromMap((value as Map).cast<String, dynamic>())),
      inputMappingDefaultValues: map['inputMappingDefaultValues'] == null ? null : TopicInputMappingDefaultValues.fromMap((map['inputMappingDefaultValues'] as Map).cast<String, dynamic>()),
      inputMappingFields: map['inputMappingFields'] == null ? null : TopicInputMappingFields.fromMap((map['inputMappingFields'] as Map).cast<String, dynamic>()),
