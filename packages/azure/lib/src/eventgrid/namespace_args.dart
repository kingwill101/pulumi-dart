...
class NamespaceArgs {
  ...
  NamespaceArgs({
    ...
    List<NamespaceInboundIpRule>? inboundIpRules,
    String? location,
    String? name,
    ...
    List<NamespaceTopicSpacesConfiguration>? topicSpacesConfigurations,
  }) :
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      inboundIpRules: map['inboundIpRules'] == null ? null : pulumi.Input.decodeList<NamespaceInboundIpRule>(map['inboundIpRules'], (value) => NamespaceInboundIpRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      topicSpacesConfigurations: map['topicSpacesConfigurations'] == null ? null : pulumi.Input.decodeList<NamespaceTopicSpacesConfiguration>(map['topicSpacesConfigurations'], (value) => NamespaceTopicSpacesConfiguration.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
