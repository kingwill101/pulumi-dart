...
class ApplicationNetworkRuleSetArgs {
  ...
  ApplicationNetworkRuleSetArgs({
    ...
    required String iotcentralApplicationId,
    List<ApplicationNetworkRuleSetIpRule>? ipRules,
  }) :
  ...
  factory ApplicationNetworkRuleSetArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationNetworkRuleSetArgs(
      applyToDevice: map['applyToDevice'] == null ? null : map['applyToDevice'] as bool,
      defaultAction: map['defaultAction'] == null ? null : map['defaultAction'] as String,
      iotcentralApplicationId: map['iotcentralApplicationId'] as String,
      ipRules: map['ipRules'] == null ? null : pulumi.Input.decodeList<ApplicationNetworkRuleSetIpRule>(map['ipRules'], (value) => ApplicationNetworkRuleSetIpRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
