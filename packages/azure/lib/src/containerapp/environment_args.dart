...
class EnvironmentArgs {
  ...
  EnvironmentArgs({
    ...
    List<EnvironmentWorkloadProfile>? workloadProfiles,
  ...
  factory EnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return EnvironmentArgs(
      daprApplicationInsightsConnectionString: map['daprApplicationInsightsConnectionString'] == null ? null : map['daprApplicationInsightsConnectionString'] as String,
      identity: map['identity'] == null ? null : EnvironmentIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      infrastructureResourceGroupName: map['infrastructureResourceGroupName'] == null ? null : map['infrastructureResourceGroupName'] as String,
      ...
      logsDestination: map['logsDestination'] == null ? null : map['logsDestination'] as String,
      mutualTlsEnabled: map['mutualTlsEnabled'] == null ? null : map['mutualTlsEnabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      publicNetworkAccess: map['publicNetworkAccess'] == null ? null : map['publicNetworkAccess'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      workloadProfiles: map['workloadProfiles'] == null ? null : pulumi.Input.decodeList<EnvironmentWorkloadProfile>(map['workloadProfiles'], (value) => EnvironmentWorkloadProfile.fromMap((value as Map).cast<String, dynamic>())),
