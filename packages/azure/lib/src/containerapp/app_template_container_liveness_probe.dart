...
class AppTemplateContainerLivenessProbe {
  ...
  final List<AppTemplateContainerLivenessProbeHeader>? headers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'headers': ?headers == null ? null : pulumi.Input.encodeList<AppTemplateContainerLivenessProbeHeader, Map<String, dynamic>>(headers!, (value) => value.toMap()),
      'host': ?host,
  ...
  factory AppTemplateContainerLivenessProbe.fromMap(Map<String, dynamic> map) {
    return AppTemplateContainerLivenessProbe(
      ...
      headers: map['headers'] == null ? null : pulumi.Input.decodeList<AppTemplateContainerLivenessProbeHeader>(map['headers'], (value) => AppTemplateContainerLivenessProbeHeader.fromMap((value as Map).cast<String, dynamic>())),
