...
class AppArgs {
  ...
  AppArgs({
    ...
    String? name,
    List<AppRegistry>? registries,
    required String resourceGroupName,
    required String revisionMode,
  ...
  factory AppArgs.fromMap(Map<String, dynamic> map) {
    return AppArgs(
      ...
      dapr: map['dapr'] == null ? null : AppDapr.fromMap((map['dapr'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : AppIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ingress: map['ingress'] == null ? null : AppIngress.fromMap((map['ingress'] as Map).cast<String, dynamic>()),
      maxInactiveRevisions: map['maxInactiveRevisions'] == null ? null : map['maxInactiveRevisions'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      registries: map['registries'] == null ? null : pulumi.Input.decodeList<AppRegistry>(map['registries'], (value) => AppRegistry.fromMap((value as Map).cast<String, dynamic>())),
      resourceGroupName: map['resourceGroupName'] as String,
      revisionMode: map['revisionMode'] as String,
      secrets: map['secrets'] == null ? null : pulumi.Input.decodeList<AppSecret>(map['secrets'], (value) => AppSecret.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      template: AppTemplate.fromMap((map['template'] as Map).cast<String, dynamic>()),
