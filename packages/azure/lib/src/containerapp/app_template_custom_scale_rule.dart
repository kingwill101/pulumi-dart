...
class AppTemplateCustomScaleRule {
  ...
  final List<AppTemplateCustomScaleRuleAuthentication>? authentications;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'authentications': ?authentications == null ? null : pulumi.Input.encodeList<AppTemplateCustomScaleRuleAuthentication, Map<String, dynamic>>(authentications!, (value) => value.toMap()),
  ...
  factory AppTemplateCustomScaleRule.fromMap(Map<String, dynamic> map) {
    return AppTemplateCustomScaleRule(
      authentications: map['authentications'] == null ? null : pulumi.Input.decodeList<AppTemplateCustomScaleRuleAuthentication>(map['authentications'], (value) => AppTemplateCustomScaleRuleAuthentication.fromMap((value as Map).cast<String, dynamic>())),
