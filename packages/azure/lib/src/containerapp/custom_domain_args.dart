...
class CustomDomainArgs {
  ...
  CustomDomainArgs({
    ...
    required String containerAppId,
    String? name,
  }) :
  ...
  factory CustomDomainArgs.fromMap(Map<String, dynamic> map) {
    return CustomDomainArgs(
      ...
      containerAppEnvironmentCertificateId: map['containerAppEnvironmentCertificateId'] == null ? null : map['containerAppEnvironmentCertificateId'] as String,
      containerAppId: map['containerAppId'] as String,
