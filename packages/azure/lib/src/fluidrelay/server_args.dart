...
class ServerArgs {
  ...
  ServerArgs({
    ServerCustomerManagedKey? customerManagedKey,
  ...
  factory ServerArgs.fromMap(Map<String, dynamic> map) {
    return ServerArgs(
      customerManagedKey: map['customerManagedKey'] == null ? null : ServerCustomerManagedKey.fromMap((map['customerManagedKey'] as Map).cast<String, dynamic>()),
