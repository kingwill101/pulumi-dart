...
class EndpointServicebusArgs {
  ...
  EndpointServicebusArgs({
    ...
    String? name,
    required String servicebusPrimaryConnectionString,
    required String servicebusSecondaryConnectionString,
  }) :
  ...
  factory EndpointServicebusArgs.fromMap(Map<String, dynamic> map) {
    return EndpointServicebusArgs(
      ...
      servicebusPrimaryConnectionString: map['servicebusPrimaryConnectionString'] as String,
      servicebusSecondaryConnectionString: map['servicebusSecondaryConnectionString'] as String,
    );
  }
}
