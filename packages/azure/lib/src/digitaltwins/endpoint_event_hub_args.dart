...
class EndpointEventHubArgs {
  ...
  EndpointEventHubArgs({
    ...
    required String eventhubPrimaryConnectionString,
    required String eventhubSecondaryConnectionString,
    String? name,
  }) :
  ...
  factory EndpointEventHubArgs.fromMap(Map<String, dynamic> map) {
    return EndpointEventHubArgs(
      ...
      eventhubPrimaryConnectionString: map['eventhubPrimaryConnectionString'] as String,
      eventhubSecondaryConnectionString: map['eventhubSecondaryConnectionString'] as String,
