...
class StreamInputEventHubV2Args {
  ...
  StreamInputEventHubV2Args({
    ...
    String? name,
    String? partitionKey,
    required StreamInputEventHubV2Serialization serialization,
  ...
  factory StreamInputEventHubV2Args.fromMap(Map<String, dynamic> map) {
    return StreamInputEventHubV2Args(
      ...
      serialization: StreamInputEventHubV2Serialization.fromMap((map['serialization'] as Map).cast<String, dynamic>()),
