...
class OutputServiceBusQueueArgs {
  ...
  OutputServiceBusQueueArgs({
    ...
    required OutputServiceBusQueueSerialization serialization,
  ...
  factory OutputServiceBusQueueArgs.fromMap(Map<String, dynamic> map) {
    return OutputServiceBusQueueArgs(
      ...
      serialization: OutputServiceBusQueueSerialization.fromMap((map['serialization'] as Map).cast<String, dynamic>()),
