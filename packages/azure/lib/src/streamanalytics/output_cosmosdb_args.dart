...
class OutputCosmosdbArgs {
  ...
  OutputCosmosdbArgs({
    ...
    required String cosmosdbAccountKey,
    required String cosmosdbSqlDatabaseId,
    String? documentId,
    String? name,
    String? partitionKey,
  ...
  factory OutputCosmosdbArgs.fromMap(Map<String, dynamic> map) {
    return OutputCosmosdbArgs(
      ...
      cosmosdbAccountKey: map['cosmosdbAccountKey'] as String,
      cosmosdbSqlDatabaseId: map['cosmosdbSqlDatabaseId'] as String,
