...
class JobArgs {
  ...
  JobArgs({
    ...
    List<JobJobStorageAccount>? jobStorageAccounts,
    String? location,
    String? name,
    ...
    required String transformationQuery,
    String? type,
  }) :
      ...
      transformationQuery = pulumi.Input.asInput<String>(transformationQuery),
  ...
  factory JobArgs.fromMap(Map<String, dynamic> map) {
    return JobArgs(
      ...
      jobStorageAccounts: map['jobStorageAccounts'] == null ? null : pulumi.Input.decodeList<JobJobStorageAccount>(map['jobStorageAccounts'], (value) => JobJobStorageAccount.fromMap((value as Map).cast<String, dynamic>())),
      ...
      streamAnalyticsClusterId: map['streamAnalyticsClusterId'] == null ? null : map['streamAnalyticsClusterId'] as String,
