...
class Job extends pulumi.CustomResource {
  ...
  Job(
    ...
    this.jobStorageAccounts = registerOutput<List<JobJobStorageAccount>?>('jobStorageAccounts');
    ...
    this.streamAnalyticsClusterId = registerOutput<String?>('streamAnalyticsClusterId');
    this.streamingUnits = registerOutput<int?>('streamingUnits');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.transformationQuery = registerOutput<String>('transformationQuery');
