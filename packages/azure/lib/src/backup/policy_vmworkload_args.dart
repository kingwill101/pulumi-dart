...
class PolicyVMWorkloadArgs {
  ...
  PolicyVMWorkloadArgs({
    String? name,
    required List<PolicyVMWorkloadProtectionPolicy> protectionPolicies,
    required String recoveryVaultName,
    required String resourceGroupName,
    required PolicyVMWorkloadSettings settings,
  ...
  factory PolicyVMWorkloadArgs.fromMap(Map<String, dynamic> map) {
    return PolicyVMWorkloadArgs(
      ...
      protectionPolicies: pulumi.Input.decodeList<PolicyVMWorkloadProtectionPolicy>(map['protectionPolicies'], (value) => PolicyVMWorkloadProtectionPolicy.fromMap((value as Map).cast<String, dynamic>())),
      recoveryVaultName: map['recoveryVaultName'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      settings: PolicyVMWorkloadSettings.fromMap((map['settings'] as Map).cast<String, dynamic>()),
