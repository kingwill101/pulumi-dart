...
class ProtectedVMArgs {
  ...
  ProtectedVMArgs({
    ...
    List<int>? excludeDiskLuns,
    List<int>? includeDiskLuns,
  ...
  factory ProtectedVMArgs.fromMap(Map<String, dynamic> map) {
    return ProtectedVMArgs(
      ...
      excludeDiskLuns: map['excludeDiskLuns'] == null ? null : (map['excludeDiskLuns'] as List).cast<int>(),
      includeDiskLuns: map['includeDiskLuns'] == null ? null : (map['includeDiskLuns'] as List).cast<int>(),
