...
/// {@template pulumi_backup_policy_vm_policy_vmargs_doc}
/// The set of arguments for PolicyVM.
/// {@endtemplate}
/// {@macro pulumi_backup_policy_vm_policy_vmargs_doc}
class PolicyVMArgs {
  ...
  PolicyVMArgs({
    required PolicyVMBackup backup,
    PolicyVMInstantRestoreResourceGroup? instantRestoreResourceGroup,
    int? instantRestoreRetentionDays,
    String? name,
    String? policyType,
    required String recoveryVaultName,
    required String resourceGroupName,
    PolicyVMRetentionDaily? retentionDaily,
    PolicyVMRetentionMonthly? retentionMonthly,
    PolicyVMRetentionWeekly? retentionWeekly,
    PolicyVMRetentionYearly? retentionYearly,
    PolicyVMTieringPolicy? tieringPolicy,
    String? timezone,
  }) :
  ...
  factory PolicyVMArgs.fromMap(Map<String, dynamic> map) {
    return PolicyVMArgs(
      backup: PolicyVMBackup.fromMap((map['backup'] as Map).cast<String, dynamic>()),
      instantRestoreResourceGroup: map['instantRestoreResourceGroup'] == null ? null : PolicyVMInstantRestoreResourceGroup.fromMap((map['instantRestoreResourceGroup'] as Map).cast<String, dynamic>()),
      instantRestoreRetentionDays: map['instantRestoreRetentionDays'] == null ? null : map['instantRestoreRetentionDays'] as int,
      ...
      retentionDaily: map['retentionDaily'] == null ? null : PolicyVMRetentionDaily.fromMap((map['retentionDaily'] as Map).cast<String, dynamic>()),
      retentionMonthly: map['retentionMonthly'] == null ? null : PolicyVMRetentionMonthly.fromMap((map['retentionMonthly'] as Map).cast<String, dynamic>()),
      retentionWeekly: map['retentionWeekly'] == null ? null : PolicyVMRetentionWeekly.fromMap((map['retentionWeekly'] as Map).cast<String, dynamic>()),
      retentionYearly: map['retentionYearly'] == null ? null : PolicyVMRetentionYearly.fromMap((map['retentionYearly'] as Map).cast<String, dynamic>()),
      tieringPolicy: map['tieringPolicy'] == null ? null : PolicyVMTieringPolicy.fromMap((map['tieringPolicy'] as Map).cast<String, dynamic>()),
