...
class ServiceArgs {
  ...
  ServiceArgs({
    ...
    required ServiceInitialReplicaSet initialReplicaSet,
    String? location,
    String? name,
    ServiceNotifications? notifications,
    required String resourceGroupName,
    ServiceSecureLdap? secureLdap,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      ...
      filteredSyncEnabled: map['filteredSyncEnabled'] == null ? null : map['filteredSyncEnabled'] as bool,
      initialReplicaSet: ServiceInitialReplicaSet.fromMap((map['initialReplicaSet'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      notifications: map['notifications'] == null ? null : ServiceNotifications.fromMap((map['notifications'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      secureLdap: map['secureLdap'] == null ? null : ServiceSecureLdap.fromMap((map['secureLdap'] as Map).cast<String, dynamic>()),
      security: map['security'] == null ? null : ServiceSecurity.fromMap((map['security'] as Map).cast<String, dynamic>()),
