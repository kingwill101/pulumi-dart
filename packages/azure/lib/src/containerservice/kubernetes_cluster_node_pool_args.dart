...
class KubernetesClusterNodePoolArgs {
  ...
  KubernetesClusterNodePoolArgs({
    ...
    String? hostGroupId,
    KubernetesClusterNodePoolKubeletConfig? kubeletConfig,
    String? kubeletDiskType,
    required String kubernetesClusterId,
    KubernetesClusterNodePoolLinuxOsConfig? linuxOsConfig,
    int? maxCount,
    int? maxPods,
    int? minCount,
    String? mode,
    ...
    KubernetesClusterNodePoolNodeNetworkProfile? nodeNetworkProfile,
    ...
    KubernetesClusterNodePoolUpgradeSettings? upgradeSettings,
    String? vmSize,
    String? vnetSubnetId,
    KubernetesClusterNodePoolWindowsProfile? windowsProfile,
  ...
  factory KubernetesClusterNodePoolArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterNodePoolArgs(
      ...
      kubeletConfig: map['kubeletConfig'] == null ? null : KubernetesClusterNodePoolKubeletConfig.fromMap((map['kubeletConfig'] as Map).cast<String, dynamic>()),
      ...
      linuxOsConfig: map['linuxOsConfig'] == null ? null : KubernetesClusterNodePoolLinuxOsConfig.fromMap((map['linuxOsConfig'] as Map).cast<String, dynamic>()),
      ...
      nodeNetworkProfile: map['nodeNetworkProfile'] == null ? null : KubernetesClusterNodePoolNodeNetworkProfile.fromMap((map['nodeNetworkProfile'] as Map).cast<String, dynamic>()),
      ...
      upgradeSettings: map['upgradeSettings'] == null ? null : KubernetesClusterNodePoolUpgradeSettings.fromMap((map['upgradeSettings'] as Map).cast<String, dynamic>()),
      vmSize: map['vmSize'] == null ? null : map['vmSize'] as String,
      vnetSubnetId: map['vnetSubnetId'] == null ? null : map['vnetSubnetId'] as String,
      windowsProfile: map['windowsProfile'] == null ? null : KubernetesClusterNodePoolWindowsProfile.fromMap((map['windowsProfile'] as Map).cast<String, dynamic>()),
