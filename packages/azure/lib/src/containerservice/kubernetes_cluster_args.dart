...
class KubernetesClusterArgs {
  ...
  KubernetesClusterArgs({
    KubernetesClusterAciConnectorLinux? aciConnectorLinux,
    bool? aiToolchainOperatorEnabled,
    KubernetesClusterApiServerAccessProfile? apiServerAccessProfile,
    KubernetesClusterAutoScalerProfile? autoScalerProfile,
    ...
    KubernetesClusterBootstrapProfile? bootstrapProfile,
    KubernetesClusterConfidentialComputing? confidentialComputing,
    bool? costAnalysisEnabled,
    List<String>? customCaTrustCertificatesBase64s,
    required KubernetesClusterDefaultNodePool defaultNodePool,
    String? diskEncryptionSetId,
    String? dnsPrefix,
    String? dnsPrefixPrivateCluster,
    String? edgeZone,
    bool? httpApplicationRoutingEnabled,
    KubernetesClusterHttpProxyConfig? httpProxyConfig,
    KubernetesClusterIdentity? identity,
    bool? imageCleanerEnabled,
    int? imageCleanerIntervalHours,
    KubernetesClusterIngressApplicationGateway? ingressApplicationGateway,
    KubernetesClusterKeyManagementService? keyManagementService,
    KubernetesClusterKeyVaultSecretsProvider? keyVaultSecretsProvider,
    KubernetesClusterKubeletIdentity? kubeletIdentity,
    String? kubernetesVersion,
    KubernetesClusterLinuxProfile? linuxProfile,
    bool? localAccountDisabled,
    String? location,
    KubernetesClusterMaintenanceWindow? maintenanceWindow,
    KubernetesClusterMaintenanceWindowAutoUpgrade? maintenanceWindowAutoUpgrade,
    KubernetesClusterMaintenanceWindowNodeOs? maintenanceWindowNodeOs,
    KubernetesClusterMicrosoftDefender? microsoftDefender,
    KubernetesClusterMonitorMetrics? monitorMetrics,
    String? name,
    KubernetesClusterNetworkProfile? networkProfile,
    String? nodeOsUpgradeChannel,
    KubernetesClusterNodeProvisioningProfile? nodeProvisioningProfile,
    String? nodeResourceGroup,
    bool? oidcIssuerEnabled,
    KubernetesClusterOmsAgent? omsAgent,
    bool? openServiceMeshEnabled,
    bool? privateClusterEnabled,
    bool? privateClusterPublicFqdnEnabled,
    String? privateDnsZoneId,
    required String resourceGroupName,
    bool? roleBasedAccessControlEnabled,
    bool? runCommandEnabled,
    KubernetesClusterServiceMeshProfile? serviceMeshProfile,
    KubernetesClusterServicePrincipal? servicePrincipal,
    String? skuTier,
    KubernetesClusterStorageProfile? storageProfile,
    String? supportPlan,
    Map<String, String>? tags,
    KubernetesClusterUpgradeOverride? upgradeOverride,
    KubernetesClusterWebAppRouting? webAppRouting,
    KubernetesClusterWindowsProfile? windowsProfile,
    KubernetesClusterWorkloadAutoscalerProfile? workloadAutoscalerProfile,
    bool? workloadIdentityEnabled,
  }) :
  ...
  factory KubernetesClusterArgs.fromMap(Map<String, dynamic> map) {
    return KubernetesClusterArgs(
      aciConnectorLinux: map['aciConnectorLinux'] == null ? null : KubernetesClusterAciConnectorLinux.fromMap((map['aciConnectorLinux'] as Map).cast<String, dynamic>()),
      aiToolchainOperatorEnabled: map['aiToolchainOperatorEnabled'] == null ? null : map['aiToolchainOperatorEnabled'] as bool,
      apiServerAccessProfile: map['apiServerAccessProfile'] == null ? null : KubernetesClusterApiServerAccessProfile.fromMap((map['apiServerAccessProfile'] as Map).cast<String, dynamic>()),
      autoScalerProfile: map['autoScalerProfile'] == null ? null : KubernetesClusterAutoScalerProfile.fromMap((map['autoScalerProfile'] as Map).cast<String, dynamic>()),
      automaticUpgradeChannel: map['automaticUpgradeChannel'] == null ? null : map['automaticUpgradeChannel'] as String,
      azureActiveDirectoryRoleBasedAccessControl: map['azureActiveDirectoryRoleBasedAccessControl'] == null ? null : KubernetesClusterAzureActiveDirectoryRoleBasedAccessControl.fromMap((map['azureActiveDirectoryRoleBasedAccessControl'] as Map).cast<String, dynamic>()),
      azurePolicyEnabled: map['azurePolicyEnabled'] == null ? null : map['azurePolicyEnabled'] as bool,
      bootstrapProfile: map['bootstrapProfile'] == null ? null : KubernetesClusterBootstrapProfile.fromMap((map['bootstrapProfile'] as Map).cast<String, dynamic>()),
      confidentialComputing: map['confidentialComputing'] == null ? null : KubernetesClusterConfidentialComputing.fromMap((map['confidentialComputing'] as Map).cast<String, dynamic>()),
      costAnalysisEnabled: map['costAnalysisEnabled'] == null ? null : map['costAnalysisEnabled'] as bool,
      customCaTrustCertificatesBase64s: map['customCaTrustCertificatesBase64s'] == null ? null : (map['customCaTrustCertificatesBase64s'] as List).cast<String>(),
      defaultNodePool: KubernetesClusterDefaultNodePool.fromMap((map['defaultNodePool'] as Map).cast<String, dynamic>()),
      ...
      dnsPrefixPrivateCluster: map['dnsPrefixPrivateCluster'] == null ? null : map['dnsPrefixPrivateCluster'] as String,
      edgeZone: map['edgeZone'] == null ? null : map['edgeZone'] as String,
      httpApplicationRoutingEnabled: map['httpApplicationRoutingEnabled'] == null ? null : map['httpApplicationRoutingEnabled'] as bool,
      httpProxyConfig: map['httpProxyConfig'] == null ? null : KubernetesClusterHttpProxyConfig.fromMap((map['httpProxyConfig'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : KubernetesClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      imageCleanerEnabled: map['imageCleanerEnabled'] == null ? null : map['imageCleanerEnabled'] as bool,
      imageCleanerIntervalHours: map['imageCleanerIntervalHours'] == null ? null : map['imageCleanerIntervalHours'] as int,
      ingressApplicationGateway: map['ingressApplicationGateway'] == null ? null : KubernetesClusterIngressApplicationGateway.fromMap((map['ingressApplicationGateway'] as Map).cast<String, dynamic>()),
      keyManagementService: map['keyManagementService'] == null ? null : KubernetesClusterKeyManagementService.fromMap((map['keyManagementService'] as Map).cast<String, dynamic>()),
      keyVaultSecretsProvider: map['keyVaultSecretsProvider'] == null ? null : KubernetesClusterKeyVaultSecretsProvider.fromMap((map['keyVaultSecretsProvider'] as Map).cast<String, dynamic>()),
      kubeletIdentity: map['kubeletIdentity'] == null ? null : KubernetesClusterKubeletIdentity.fromMap((map['kubeletIdentity'] as Map).cast<String, dynamic>()),
      kubernetesVersion: map['kubernetesVersion'] == null ? null : map['kubernetesVersion'] as String,
      linuxProfile: map['linuxProfile'] == null ? null : KubernetesClusterLinuxProfile.fromMap((map['linuxProfile'] as Map).cast<String, dynamic>()),
      localAccountDisabled: map['localAccountDisabled'] == null ? null : map['localAccountDisabled'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      maintenanceWindow: map['maintenanceWindow'] == null ? null : KubernetesClusterMaintenanceWindow.fromMap((map['maintenanceWindow'] as Map).cast<String, dynamic>()),
      maintenanceWindowAutoUpgrade: map['maintenanceWindowAutoUpgrade'] == null ? null : KubernetesClusterMaintenanceWindowAutoUpgrade.fromMap((map['maintenanceWindowAutoUpgrade'] as Map).cast<String, dynamic>()),
      maintenanceWindowNodeOs: map['maintenanceWindowNodeOs'] == null ? null : KubernetesClusterMaintenanceWindowNodeOs.fromMap((map['maintenanceWindowNodeOs'] as Map).cast<String, dynamic>()),
      microsoftDefender: map['microsoftDefender'] == null ? null : KubernetesClusterMicrosoftDefender.fromMap((map['microsoftDefender'] as Map).cast<String, dynamic>()),
      monitorMetrics: map['monitorMetrics'] == null ? null : KubernetesClusterMonitorMetrics.fromMap((map['monitorMetrics'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: map['networkProfile'] == null ? null : KubernetesClusterNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
      nodeOsUpgradeChannel: map['nodeOsUpgradeChannel'] == null ? null : map['nodeOsUpgradeChannel'] as String,
      nodeProvisioningProfile: map['nodeProvisioningProfile'] == null ? null : KubernetesClusterNodeProvisioningProfile.fromMap((map['nodeProvisioningProfile'] as Map).cast<String, dynamic>()),
      nodeResourceGroup: map['nodeResourceGroup'] == null ? null : map['nodeResourceGroup'] as String,
      oidcIssuerEnabled: map['oidcIssuerEnabled'] == null ? null : map['oidcIssuerEnabled'] as bool,
      omsAgent: map['omsAgent'] == null ? null : KubernetesClusterOmsAgent.fromMap((map['omsAgent'] as Map).cast<String, dynamic>()),
      openServiceMeshEnabled: map['openServiceMeshEnabled'] == null ? null : map['openServiceMeshEnabled'] as bool,
      privateClusterEnabled: map['privateClusterEnabled'] == null ? null : map['privateClusterEnabled'] as bool,
      privateClusterPublicFqdnEnabled: map['privateClusterPublicFqdnEnabled'] == null ? null : map['privateClusterPublicFqdnEnabled'] as bool,
      privateDnsZoneId: map['privateDnsZoneId'] == null ? null : map['privateDnsZoneId'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      roleBasedAccessControlEnabled: map['roleBasedAccessControlEnabled'] == null ? null : map['roleBasedAccessControlEnabled'] as bool,
      runCommandEnabled: map['runCommandEnabled'] == null ? null : map['runCommandEnabled'] as bool,
      serviceMeshProfile: map['serviceMeshProfile'] == null ? null : KubernetesClusterServiceMeshProfile.fromMap((map['serviceMeshProfile'] as Map).cast<String, dynamic>()),
      servicePrincipal: map['servicePrincipal'] == null ? null : KubernetesClusterServicePrincipal.fromMap((map['servicePrincipal'] as Map).cast<String, dynamic>()),
      skuTier: map['skuTier'] == null ? null : map['skuTier'] as String,
      storageProfile: map['storageProfile'] == null ? null : KubernetesClusterStorageProfile.fromMap((map['storageProfile'] as Map).cast<String, dynamic>()),
      supportPlan: map['supportPlan'] == null ? null : map['supportPlan'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      upgradeOverride: map['upgradeOverride'] == null ? null : KubernetesClusterUpgradeOverride.fromMap((map['upgradeOverride'] as Map).cast<String, dynamic>()),
      webAppRouting: map['webAppRouting'] == null ? null : KubernetesClusterWebAppRouting.fromMap((map['webAppRouting'] as Map).cast<String, dynamic>()),
      windowsProfile: map['windowsProfile'] == null ? null : KubernetesClusterWindowsProfile.fromMap((map['windowsProfile'] as Map).cast<String, dynamic>()),
      workloadAutoscalerProfile: map['workloadAutoscalerProfile'] == null ? null : KubernetesClusterWorkloadAutoscalerProfile.fromMap((map['workloadAutoscalerProfile'] as Map).cast<String, dynamic>()),
      workloadIdentityEnabled: map['workloadIdentityEnabled'] == null ? null : map['workloadIdentityEnabled'] as bool,
    );
  }
}
