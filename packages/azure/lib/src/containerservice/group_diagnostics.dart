...
class GroupDiagnostics {
  ...
  final GroupDiagnosticsLogAnalytics logAnalytics;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'logAnalytics': logAnalytics.toMap(),
    };
  }

  factory GroupDiagnostics.fromMap(Map<String, dynamic> map) {
    return GroupDiagnostics(
      logAnalytics: GroupDiagnosticsLogAnalytics.fromMap((map['logAnalytics'] as Map).cast<String, dynamic>()),
    );
  }
}
