...
class ConnectedRegistryArgs {
  ...
  ConnectedRegistryArgs({
    ...
    String? mode,
    String? name,
    List<ConnectedRegistryNotification>? notifications,
    String? parentRegistryId,
    String? syncMessageTtl,
    String? syncSchedule,
    required String syncTokenId,
    String? syncWindow,
  }) :
  ...
  factory ConnectedRegistryArgs.fromMap(Map<String, dynamic> map) {
    return ConnectedRegistryArgs(
      auditLogEnabled: map['auditLogEnabled'] == null ? null : map['auditLogEnabled'] as bool,
      ...
      notifications: map['notifications'] == null ? null : pulumi.Input.decodeList<ConnectedRegistryNotification>(map['notifications'], (value) => ConnectedRegistryNotification.fromMap((value as Map).cast<String, dynamic>())),
      parentRegistryId: map['parentRegistryId'] == null ? null : map['parentRegistryId'] as String,
      syncMessageTtl: map['syncMessageTtl'] == null ? null : map['syncMessageTtl'] as String,
      syncSchedule: map['syncSchedule'] == null ? null : map['syncSchedule'] as String,
      syncTokenId: map['syncTokenId'] as String,
