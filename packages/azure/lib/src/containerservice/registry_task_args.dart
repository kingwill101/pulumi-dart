...
/// {@template pulumi_containerservice_registry_task_registry_task_args_doc}
/// The set of arguments for RegistryTask.
/// {@endtemplate}
/// {@macro pulumi_containerservice_registry_task_registry_task_args_doc}
class RegistryTaskArgs {
  ...
  /// Creates a new [RegistryTaskArgs].
  ...
  RegistryTaskArgs({
    ...
    RegistryTaskAgentSetting? agentSetting,
    RegistryTaskBaseImageTrigger? baseImageTrigger,
    required String containerRegistryId,
    RegistryTaskDockerStep? dockerStep,
    bool? enabled,
    RegistryTaskEncodedStep? encodedStep,
    RegistryTaskFileStep? fileStep,
    RegistryTaskIdentity? identity,
    bool? isSystemTask,
    String? logTemplate,
    String? name,
    RegistryTaskPlatform? platform,
    RegistryTaskRegistryCredential? registryCredential,
    List<RegistryTaskSourceTrigger>? sourceTriggers,
    Map<String, String>? tags,
    int? timeoutInSeconds,
    List<RegistryTaskTimerTrigger>? timerTriggers,
  }) :
  ...
  factory RegistryTaskArgs.fromMap(Map<String, dynamic> map) {
    return RegistryTaskArgs(
      agentPoolName: map['agentPoolName'] == null ? null : map['agentPoolName'] as String,
      agentSetting: map['agentSetting'] == null ? null : RegistryTaskAgentSetting.fromMap((map['agentSetting'] as Map).cast<String, dynamic>()),
      baseImageTrigger: map['baseImageTrigger'] == null ? null : RegistryTaskBaseImageTrigger.fromMap((map['baseImageTrigger'] as Map).cast<String, dynamic>()),
      containerRegistryId: map['containerRegistryId'] as String,
      dockerStep: map['dockerStep'] == null ? null : RegistryTaskDockerStep.fromMap((map['dockerStep'] as Map).cast<String, dynamic>()),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      encodedStep: map['encodedStep'] == null ? null : RegistryTaskEncodedStep.fromMap((map['encodedStep'] as Map).cast<String, dynamic>()),
      fileStep: map['fileStep'] == null ? null : RegistryTaskFileStep.fromMap((map['fileStep'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : RegistryTaskIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      platform: map['platform'] == null ? null : RegistryTaskPlatform.fromMap((map['platform'] as Map).cast<String, dynamic>()),
      registryCredential: map['registryCredential'] == null ? null : RegistryTaskRegistryCredential.fromMap((map['registryCredential'] as Map).cast<String, dynamic>()),
      sourceTriggers: map['sourceTriggers'] == null ? null : pulumi.Input.decodeList<RegistryTaskSourceTrigger>(map['sourceTriggers'], (value) => RegistryTaskSourceTrigger.fromMap((value as Map).cast<String, dynamic>())),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      timeoutInSeconds: map['timeoutInSeconds'] == null ? null : map['timeoutInSeconds'] as int,
      timerTriggers: map['timerTriggers'] == null ? null : pulumi.Input.decodeList<RegistryTaskTimerTrigger>(map['timerTriggers'], (value) => RegistryTaskTimerTrigger.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
