...
import 'registry_webook_args.dart';
...
class RegistryWebook extends pulumi.CustomResource {
  ...
  /// Creates a new [RegistryWebook].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [RegistryWebook]. {@macro pulumi_containerservice_registry_webook_registry_webook_args_doc}
  ...
  RegistryWebook(
    ...
    this.customHeaders = registerOutput<Map<String, String>?>('customHeaders');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.registryName = registerOutput<String>('registryName');
    this.resourceGroupName = registerOutput<String>('resourceGroupName');
    this.scope = registerOutput<String?>('scope');
    this.serviceUri = registerOutput<String>('serviceUri');
