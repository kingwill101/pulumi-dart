...
class GroupArgs {
  ...
  GroupArgs({
    required List<GroupContainer> containers,
    GroupDiagnostics? diagnostics,
    GroupDnsConfig? dnsConfig,
    String? dnsNameLabel,
    String? dnsNameLabelReusePolicy,
    List<GroupExposedPort>? exposedPorts,
    GroupIdentity? identity,
    List<GroupImageRegistryCredential>? imageRegistryCredentials,
    List<GroupInitContainer>? initContainers,
  ...
  factory GroupArgs.fromMap(Map<String, dynamic> map) {
    return GroupArgs(
      containers: pulumi.Input.decodeList<GroupContainer>(map['containers'], (value) => GroupContainer.fromMap((value as Map).cast<String, dynamic>())),
      diagnostics: map['diagnostics'] == null ? null : GroupDiagnostics.fromMap((map['diagnostics'] as Map).cast<String, dynamic>()),
      dnsConfig: map['dnsConfig'] == null ? null : GroupDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      dnsNameLabel: map['dnsNameLabel'] == null ? null : map['dnsNameLabel'] as String,
      dnsNameLabelReusePolicy: map['dnsNameLabelReusePolicy'] == null ? null : map['dnsNameLabelReusePolicy'] as String,
      exposedPorts: map['exposedPorts'] == null ? null : pulumi.Input.decodeList<GroupExposedPort>(map['exposedPorts'], (value) => GroupExposedPort.fromMap((value as Map).cast<String, dynamic>())),
      identity: map['identity'] == null ? null : GroupIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      imageRegistryCredentials: map['imageRegistryCredentials'] == null ? null : pulumi.Input.decodeList<GroupImageRegistryCredential>(map['imageRegistryCredentials'], (value) => GroupImageRegistryCredential.fromMap((value as Map).cast<String, dynamic>())),
      initContainers: map['initContainers'] == null ? null : pulumi.Input.decodeList<GroupInitContainer>(map['initContainers'], (value) => GroupInitContainer.fromMap((value as Map).cast<String, dynamic>())),
      ...
      keyVaultUserAssignedIdentityId: map['keyVaultUserAssignedIdentityId'] == null ? null : map['keyVaultUserAssignedIdentityId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkProfileId: map['networkProfileId'] == null ? null : map['networkProfileId'] as String,
      ...
      subnetIds: map['subnetIds'] == null ? null : map['subnetIds'] as String,
