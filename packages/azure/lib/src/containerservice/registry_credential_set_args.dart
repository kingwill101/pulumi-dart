...
class RegistryCredentialSetArgs {
  ...
  RegistryCredentialSetArgs({
    required RegistryCredentialSetAuthenticationCredentials authenticationCredentials,
    required String containerRegistryId,
    required RegistryCredentialSetIdentity identity,
    required String loginServer,
    String? name,
  }) :
  ...
  factory RegistryCredentialSetArgs.fromMap(Map<String, dynamic> map) {
    return RegistryCredentialSetArgs(
      authenticationCredentials: RegistryCredentialSetAuthenticationCredentials.fromMap((map['authenticationCredentials'] as Map).cast<String, dynamic>()),
      containerRegistryId: map['containerRegistryId'] as String,
      identity: RegistryCredentialSetIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
