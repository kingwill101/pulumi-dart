...
class FleetUpdateStrategyArgs {
  ...
  FleetUpdateStrategyArgs({
    ...
    String? name,
    required List<FleetUpdateStrategyStage> stages,
  }) :
  ...
  factory FleetUpdateStrategyArgs.fromMap(Map<String, dynamic> map) {
    return FleetUpdateStrategyArgs(
      ...
      stages: pulumi.Input.decodeList<FleetUpdateStrategyStage>(map['stages'], (value) => FleetUpdateStrategyStage.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
