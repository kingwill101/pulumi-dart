...
class KubernetesClusterNodePool extends pulumi.CustomResource {
  ...
  KubernetesClusterNodePool(
    ...
    this.gpuDriver = registerOutput<String?>('gpuDriver');
    this.gpuInstance = registerOutput<String?>('gpuInstance');
    this.hostEncryptionEnabled = registerOutput<bool?>('hostEncryptionEnabled');
    this.hostGroupId = registerOutput<String?>('hostGroupId');
    this.kubeletConfig = registerOutput<KubernetesClusterNodePoolKubeletConfig?>('kubeletConfig');
    ...
    this.linuxOsConfig = registerOutput<KubernetesClusterNodePoolLinuxOsConfig?>('linuxOsConfig');
    ...
    this.nodeNetworkProfile = registerOutput<KubernetesClusterNodePoolNodeNetworkProfile?>('nodeNetworkProfile');
    ...
    this.temporaryNameForRotation = registerOutput<String?>('temporaryNameForRotation');
    this.ultraSsdEnabled = registerOutput<bool?>('ultraSsdEnabled');
    this.upgradeSettings = registerOutput<KubernetesClusterNodePoolUpgradeSettings?>('upgradeSettings');
    this.vmSize = registerOutput<String>('vmSize');
    this.vnetSubnetId = registerOutput<String?>('vnetSubnetId');
    this.windowsProfile = registerOutput<KubernetesClusterNodePoolWindowsProfile?>('windowsProfile');
