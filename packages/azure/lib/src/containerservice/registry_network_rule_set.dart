...
class RegistryNetworkRuleSet {
  ...
  final List<RegistryNetworkRuleSetIpRule>? ipRules;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipRules': ?ipRules == null ? null : pulumi.Input.encodeList<RegistryNetworkRuleSetIpRule, Map<String, dynamic>>(ipRules!, (value) => value.toMap()),
    };
  }
  ...
  factory RegistryNetworkRuleSet.fromMap(Map<String, dynamic> map) {
    return RegistryNetworkRuleSet(
      ...
      ipRules: map['ipRules'] == null ? null : pulumi.Input.decodeList<RegistryNetworkRuleSetIpRule>(map['ipRules'], (value) => RegistryNetworkRuleSetIpRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
