...
class SubscriptionArgs {
  ...
  SubscriptionArgs({
    ...
    SubscriptionClientScopedSubscription? clientScopedSubscription,
    bool? clientScopedSubscriptionEnabled,
  ...
  factory SubscriptionArgs.fromMap(Map<String, dynamic> map) {
    return SubscriptionArgs(
      ...
      batchedOperationsEnabled: map['batchedOperationsEnabled'] == null ? null : map['batchedOperationsEnabled'] as bool,
      clientScopedSubscription: map['clientScopedSubscription'] == null ? null : SubscriptionClientScopedSubscription.fromMap((map['clientScopedSubscription'] as Map).cast<String, dynamic>()),
      clientScopedSubscriptionEnabled: map['clientScopedSubscriptionEnabled'] == null ? null : map['clientScopedSubscriptionEnabled'] as bool,
      deadLetteringOnFilterEvaluationError: map['deadLetteringOnFilterEvaluationError'] == null ? null : map['deadLetteringOnFilterEvaluationError'] as bool,
      ...
      defaultMessageTtl: map['defaultMessageTtl'] == null ? null : map['defaultMessageTtl'] as String,
