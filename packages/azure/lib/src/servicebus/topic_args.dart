...
class TopicArgs {
  ...
  factory TopicArgs.fromMap(Map<String, dynamic> map) {
    return TopicArgs(
      ...
      expressEnabled: map['expressEnabled'] == null ? null : map['expressEnabled'] as bool,
      maxMessageSizeInKilobytes: map['maxMessageSizeInKilobytes'] == null ? null : map['maxMessageSizeInKilobytes'] as int,
      ...
      partitioningEnabled: map['partitioningEnabled'] == null ? null : map['partitioningEnabled'] as bool,
