...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames {
  ...
  final List<SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDisk>? dataDisks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataDisks': ?dataDisks == null ? null : pulumi.Input.encodeList<SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDisk, Map<String, dynamic>>(dataDisks!, (value) => value.toMap()),
      'hostName': ?hostName,
  ...
  factory SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames.fromMap(Map<String, dynamic> map) {
    return SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames(
      dataDisks: map['dataDisks'] == null ? null : pulumi.Input.decodeList<SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDisk>(map['dataDisks'], (value) => SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDisk.fromMap((value as Map).cast<String, dynamic>())),
