...
class SingleNodeVirtualInstanceSingleServerConfiguration {
  ...
  final List<SingleNodeVirtualInstanceSingleServerConfigurationDiskVolumeConfiguration>? diskVolumeConfigurations;
  ...
  final SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfiguration virtualMachineConfiguration;
  /// A `virtual_machine_resource_names` block as defined below. Changing this forces a new resource to be created.
  final SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames? virtualMachineResourceNames;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'diskVolumeConfigurations': ?diskVolumeConfigurations == null ? null : pulumi.Input.encodeList<SingleNodeVirtualInstanceSingleServerConfigurationDiskVolumeConfiguration, Map<String, dynamic>>(diskVolumeConfigurations!, (value) => value.toMap()),
      'secondaryIpEnabled': ?secondaryIpEnabled,
      'subnetId': subnetId,
      'virtualMachineConfiguration': virtualMachineConfiguration.toMap(),
      'virtualMachineResourceNames': ?virtualMachineResourceNames == null ? null : virtualMachineResourceNames!.toMap(),
    };
  }
  ...
  factory SingleNodeVirtualInstanceSingleServerConfiguration.fromMap(Map<String, dynamic> map) {
    return SingleNodeVirtualInstanceSingleServerConfiguration(
      ...
      virtualMachineConfiguration: SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfiguration.fromMap((map['virtualMachineConfiguration'] as Map).cast<String, dynamic>()),
      virtualMachineResourceNames: map['virtualMachineResourceNames'] == null ? null : SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames.fromMap((map['virtualMachineResourceNames'] as Map).cast<String, dynamic>()),
    );
  }
}
