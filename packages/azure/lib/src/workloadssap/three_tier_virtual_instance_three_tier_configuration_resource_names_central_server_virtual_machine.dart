...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachine {
  ...
  final List<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDisk>? dataDisks;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'dataDisks': ?dataDisks == null ? null : pulumi.Input.encodeList<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDisk, Map<String, dynamic>>(dataDisks!, (value) => value.toMap()),
      'hostName': ?hostName,
