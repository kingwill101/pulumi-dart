...
class CaaRecordArgs {
  ...
  CaaRecordArgs({
    String? name,
    required List<CaaRecordRecord> records,
  ...
  factory CaaRecordArgs.fromMap(Map<String, dynamic> map) {
    return CaaRecordArgs(
      ...
      records: pulumi.Input.decodeList<CaaRecordRecord>(map['records'], (value) => CaaRecordRecord.fromMap((value as Map).cast<String, dynamic>())),
