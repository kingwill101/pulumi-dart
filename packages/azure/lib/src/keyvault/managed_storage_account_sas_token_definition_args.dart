...
class ManagedStorageAccountSasTokenDefinitionArgs {
  ...
  ManagedStorageAccountSasTokenDefinitionArgs({
    required String managedStorageAccountId,
    String? name,
    required String sasTemplateUri,
    required String sasType,
  ...
  factory ManagedStorageAccountSasTokenDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return ManagedStorageAccountSasTokenDefinitionArgs(
      managedStorageAccountId: map['managedStorageAccountId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      sasTemplateUri: map['sasTemplateUri'] as String,
      sasType: map['sasType'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      validityPeriod: map['validityPeriod'] as String,
    );
  }
}
