...
class ManagedHardwareSecurityModuleArgs {
  ...
  ManagedHardwareSecurityModuleArgs({
    required List<String> adminObjectIds,
    String? location,
    String? name,
    ManagedHardwareSecurityModuleNetworkAcls? networkAcls,
    bool? publicNetworkAccessEnabled,
    bool? purgeProtectionEnabled,
    required String resourceGroupName,
    List<String>? securityDomainKeyVaultCertificateIds,
    int? securityDomainQuorum,
  ...
  factory ManagedHardwareSecurityModuleArgs.fromMap(Map<String, dynamic> map) {
    return ManagedHardwareSecurityModuleArgs(
      ...
      networkAcls: map['networkAcls'] == null ? null : ManagedHardwareSecurityModuleNetworkAcls.fromMap((map['networkAcls'] as Map).cast<String, dynamic>()),
      ...
      securityDomainKeyVaultCertificateIds: map['securityDomainKeyVaultCertificateIds'] == null ? null : (map['securityDomainKeyVaultCertificateIds'] as List).cast<String>(),
      securityDomainQuorum: map['securityDomainQuorum'] == null ? null : map['securityDomainQuorum'] as int,
