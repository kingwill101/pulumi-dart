...
class CertificateContactsArgs {
  ...
  CertificateContactsArgs({
    List<CertificateContactsContact>? contacts,
  ...
  factory CertificateContactsArgs.fromMap(Map<String, dynamic> map) {
    return CertificateContactsArgs(
      contacts: map['contacts'] == null ? null : pulumi.Input.decodeList<CertificateContactsContact>(map['contacts'], (value) => CertificateContactsContact.fromMap((value as Map).cast<String, dynamic>())),
