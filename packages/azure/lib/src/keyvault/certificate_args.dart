...
class CertificateArgs {
  ...
  CertificateArgs({
    ...
    CertificateCertificatePolicy? certificatePolicy,
  ...
  factory CertificateArgs.fromMap(Map<String, dynamic> map) {
    return CertificateArgs(
      certificate: map['certificate'] == null ? null : CertificateCertificate.fromMap((map['certificate'] as Map).cast<String, dynamic>()),
      certificatePolicy: map['certificatePolicy'] == null ? null : CertificateCertificatePolicy.fromMap((map['certificatePolicy'] as Map).cast<String, dynamic>()),
