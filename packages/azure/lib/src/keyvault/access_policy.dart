...
class AccessPolicy extends pulumi.CustomResource {
  ...
  AccessPolicy(
    ...
    this.certificatePermissions = registerOutput<List<String>?>('certificatePermissions');
    this.keyPermissions = registerOutput<List<String>?>('keyPermissions');
    this.keyVaultId = registerOutput<String>('keyVaultId');
    this.objectId = registerOutput<String>('objectId');
    this.secretPermissions = registerOutput<List<String>?>('secretPermissions');
    this.storagePermissions = registerOutput<List<String>?>('storagePermissions');
