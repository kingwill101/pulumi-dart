...
class KeyVault extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<KeyVaultAccessPolicy>> accessPolicies;
  late final pulumi.Output<List<KeyVaultContact>> contacts;
  ...
  KeyVault(
    ...
    this.accessPolicies = registerOutput<List<KeyVaultAccessPolicy>>('accessPolicies');
    this.contacts = registerOutput<List<KeyVaultContact>>('contacts');
    this.enableRbacAuthorization = registerOutput<bool>('enableRbacAuthorization');
    this.enabledForDeployment = registerOutput<bool?>('enabledForDeployment');
    this.enabledForDiskEncryption = registerOutput<bool?>('enabledForDiskEncryption');
    this.enabledForTemplateDeployment = registerOutput<bool?>('enabledForTemplateDeployment');
    this.location = registerOutput<String>('location');
    this.name = registerOutput<String>('name');
    this.networkAcls = registerOutput<KeyVaultNetworkAcls>('networkAcls');
    ...
    this.rbacAuthorizationEnabled = registerOutput<bool>('rbacAuthorizationEnabled');
    ...
    this.vaultUri = registerOutput<String>('vaultUri');
  }
}
