...
class Certificate extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<CertificateCertificateAttribute>> certificateAttributes;
  ...
  Certificate(
    ...
    this.certificate = registerOutput<CertificateCertificate?>('certificate');
    this.certificateAttributes = registerOutput<List<CertificateCertificateAttribute>>('certificateAttributes');
    ...
    this.certificatePolicy = registerOutput<CertificateCertificatePolicy>('certificatePolicy');
