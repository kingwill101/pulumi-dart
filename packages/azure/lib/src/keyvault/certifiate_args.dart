...
class CertifiateArgs {
  ...
  CertifiateArgs({
    CertifiateCertificate? certificate,
    CertifiateCertificatePolicy? certificatePolicy,
  ...
  factory CertifiateArgs.fromMap(Map<String, dynamic> map) {
    return CertifiateArgs(
      certificate: map['certificate'] == null ? null : CertifiateCertificate.fromMap((map['certificate'] as Map).cast<String, dynamic>()),
      certificatePolicy: map['certificatePolicy'] == null ? null : CertifiateCertificatePolicy.fromMap((map['certificatePolicy'] as Map).cast<String, dynamic>()),
