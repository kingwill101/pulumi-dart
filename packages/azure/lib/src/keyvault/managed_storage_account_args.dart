...
class ManagedStorageAccountArgs {
  ...
  ManagedStorageAccountArgs({
    ...
    String? name,
    bool? regenerateKeyAutomatically,
  ...
  factory ManagedStorageAccountArgs.fromMap(Map<String, dynamic> map) {
    return ManagedStorageAccountArgs(
      ...
      regenerateKeyAutomatically: map['regenerateKeyAutomatically'] == null ? null : map['regenerateKeyAutomatically'] as bool,
      regenerationPeriod: map['regenerationPeriod'] == null ? null : map['regenerationPeriod'] as String,
