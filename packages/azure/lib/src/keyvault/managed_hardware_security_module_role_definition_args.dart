...
class ManagedHardwareSecurityModuleRoleDefinitionArgs {
  ...
  ManagedHardwareSecurityModuleRoleDefinitionArgs({
    ...
    String? name,
    List<ManagedHardwareSecurityModuleRoleDefinitionPermission>? permissions,
    String? roleName,
  }) :
  ...
  factory ManagedHardwareSecurityModuleRoleDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return ManagedHardwareSecurityModuleRoleDefinitionArgs(
      ...
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<ManagedHardwareSecurityModuleRoleDefinitionPermission>(map['permissions'], (value) => ManagedHardwareSecurityModuleRoleDefinitionPermission.fromMap((value as Map).cast<String, dynamic>())),
