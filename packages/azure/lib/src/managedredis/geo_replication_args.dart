...
/// {@template pulumi_managedredis_geo_replication_geo_replication_args_doc}
/// The set of arguments for GeoReplication.
/// {@endtemplate}
...
class GeoReplicationArgs {
  ...
  GeoReplicationArgs({
    required List<String> linkedManagedRedisIds,
    required String managedRedisId,
  }) :
  ...
  factory GeoReplicationArgs.fromMap(Map<String, dynamic> map) {
    return GeoReplicationArgs(
      linkedManagedRedisIds: (map['linkedManagedRedisIds'] as List).cast<String>(),
      managedRedisId: map['managedRedisId'] as String,
    );
  }
}
