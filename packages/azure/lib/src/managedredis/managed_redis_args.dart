...
class ManagedRedisArgs {
  ...
  ManagedRedisArgs({
    ManagedRedisCustomerManagedKey? customerManagedKey,
    ManagedRedisDefaultDatabase? defaultDatabase,
    bool? highAvailabilityEnabled,
    ManagedRedisIdentity? identity,
    String? location,
    String? name,
  ...
  factory ManagedRedisArgs.fromMap(Map<String, dynamic> map) {
    return ManagedRedisArgs(
      customerManagedKey: map['customerManagedKey'] == null ? null : ManagedRedisCustomerManagedKey.fromMap((map['customerManagedKey'] as Map).cast<String, dynamic>()),
      defaultDatabase: map['defaultDatabase'] == null ? null : ManagedRedisDefaultDatabase.fromMap((map['defaultDatabase'] as Map).cast<String, dynamic>()),
      highAvailabilityEnabled: map['highAvailabilityEnabled'] == null ? null : map['highAvailabilityEnabled'] as bool,
      identity: map['identity'] == null ? null : ManagedRedisIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
