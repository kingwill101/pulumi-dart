...
class RoleDefinitionArgs {
  ...
  RoleDefinitionArgs({
    ...
    String? description,
    String? name,
    List<RoleDefinitionPermission>? permissions,
  ...
  factory RoleDefinitionArgs.fromMap(Map<String, dynamic> map) {
    return RoleDefinitionArgs(
      ...
      permissions: map['permissions'] == null ? null : pulumi.Input.decodeList<RoleDefinitionPermission>(map['permissions'], (value) => RoleDefinitionPermission.fromMap((value as Map).cast<String, dynamic>())),
