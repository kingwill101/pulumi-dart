...
/// {@template pulumi_portal_azurerm_portal_dashboard_azurerm_portal_dashboard_args_doc}
...
class AzurermPortalDashboardArgs {
  ...
  factory AzurermPortalDashboardArgs.fromMap(Map<String, dynamic> map) {
    return AzurermPortalDashboardArgs(
      dashboardProperties: map['dashboardProperties'] == null ? null : map['dashboardProperties'] as String,
