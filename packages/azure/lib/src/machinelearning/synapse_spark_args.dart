...
class SynapseSparkArgs {
  ...
  SynapseSparkArgs({
    String? description,
    SynapseSparkIdentity? identity,
    bool? localAuthEnabled,
    String? location,
    required String machineLearningWorkspaceId,
    String? name,
    required String synapseSparkPoolId,
  ...
  factory SynapseSparkArgs.fromMap(Map<String, dynamic> map) {
    return SynapseSparkArgs(
      ...
      identity: map['identity'] == null ? null : SynapseSparkIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      synapseSparkPoolId: map['synapseSparkPoolId'] as String,
