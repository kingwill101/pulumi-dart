...
class ComputeInstanceArgs {
  ...
  ComputeInstanceArgs({
    ComputeInstanceAssignToUser? assignToUser,
    String? authorizationType,
    String? description,
    ComputeInstanceIdentity? identity,
    bool? localAuthEnabled,
    required String machineLearningWorkspaceId,
    String? name,
    bool? nodePublicIpEnabled,
    ComputeInstanceSsh? ssh,
    String? subnetResourceId,
    Map<String, String>? tags,
    required String virtualMachineSize,
  }) :
  ...
  factory ComputeInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ComputeInstanceArgs(
      assignToUser: map['assignToUser'] == null ? null : ComputeInstanceAssignToUser.fromMap((map['assignToUser'] as Map).cast<String, dynamic>()),
      authorizationType: map['authorizationType'] == null ? null : map['authorizationType'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      identity: map['identity'] == null ? null : ComputeInstanceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      ssh: map['ssh'] == null ? null : ComputeInstanceSsh.fromMap((map['ssh'] as Map).cast<String, dynamic>()),
