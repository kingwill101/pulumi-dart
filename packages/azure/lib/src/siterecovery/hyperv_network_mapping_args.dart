...
class HypervNetworkMappingArgs {
  ...
  HypervNetworkMappingArgs({
    ...
    required String sourceNetworkName,
    required String sourceSystemCenterVirtualMachineManagerName,
  ...
  factory HypervNetworkMappingArgs.fromMap(Map<String, dynamic> map) {
    return HypervNetworkMappingArgs(
      ...
      sourceNetworkName: map['sourceNetworkName'] as String,
      sourceSystemCenterVirtualMachineManagerName: map['sourceSystemCenterVirtualMachineManagerName'] as String,
