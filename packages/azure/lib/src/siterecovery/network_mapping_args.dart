...
class NetworkMappingArgs {
  ...
  NetworkMappingArgs({
    ...
    required String sourceRecoveryFabricName,
    required String targetNetworkId,
    required String targetRecoveryFabricName,
  }) :
  ...
  factory NetworkMappingArgs.fromMap(Map<String, dynamic> map) {
    return NetworkMappingArgs(
      ...
      sourceRecoveryFabricName: map['sourceRecoveryFabricName'] as String,
      targetNetworkId: map['targetNetworkId'] as String,
      targetRecoveryFabricName: map['targetRecoveryFabricName'] as String,
    );
  }
}
