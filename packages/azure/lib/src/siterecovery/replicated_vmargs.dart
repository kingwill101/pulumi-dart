...
class ReplicatedVMArgs {
  ...
  ReplicatedVMArgs({
    List<ReplicatedVMManagedDisk>? managedDisks,
    String? multiVmGroupName,
    String? name,
    List<ReplicatedVMNetworkInterface>? networkInterfaces,
    ...
    required String sourceRecoveryProtectionContainerName,
    required String sourceVmId,
    ...
    required String targetRecoveryProtectionContainerId,
    ...
    List<ReplicatedVMUnmanagedDisk>? unmanagedDisks,
  }) :
  ...
  factory ReplicatedVMArgs.fromMap(Map<String, dynamic> map) {
    return ReplicatedVMArgs(
      managedDisks: map['managedDisks'] == null ? null : pulumi.Input.decodeList<ReplicatedVMManagedDisk>(map['managedDisks'], (value) => ReplicatedVMManagedDisk.fromMap((value as Map).cast<String, dynamic>())),
      multiVmGroupName: map['multiVmGroupName'] == null ? null : map['multiVmGroupName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<ReplicatedVMNetworkInterface>(map['networkInterfaces'], (value) => ReplicatedVMNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sourceRecoveryProtectionContainerName: map['sourceRecoveryProtectionContainerName'] as String,
      ...
      targetBootDiagnosticStorageAccountId: map['targetBootDiagnosticStorageAccountId'] == null ? null : map['targetBootDiagnosticStorageAccountId'] as String,
      targetCapacityReservationGroupId: map['targetCapacityReservationGroupId'] == null ? null : map['targetCapacityReservationGroupId'] as String,
      targetEdgeZone: map['targetEdgeZone'] == null ? null : map['targetEdgeZone'] as String,
      ...
      targetRecoveryProtectionContainerId: map['targetRecoveryProtectionContainerId'] as String,
      targetResourceGroupId: map['targetResourceGroupId'] as String,
      targetVirtualMachineScaleSetId: map['targetVirtualMachineScaleSetId'] == null ? null : map['targetVirtualMachineScaleSetId'] as String,
      targetVirtualMachineSize: map['targetVirtualMachineSize'] == null ? null : map['targetVirtualMachineSize'] as String,
      ...
      unmanagedDisks: map['unmanagedDisks'] == null ? null : pulumi.Input.decodeList<ReplicatedVMUnmanagedDisk>(map['unmanagedDisks'], (value) => ReplicatedVMUnmanagedDisk.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
