...
class ReplicationRecoveryPlanArgs {
  ...
  ReplicationRecoveryPlanArgs({
    ReplicationRecoveryPlanAzureToAzureSettings? azureToAzureSettings,
    required List<ReplicationRecoveryPlanBootRecoveryGroup> bootRecoveryGroups,
    required ReplicationRecoveryPlanFailoverRecoveryGroup failoverRecoveryGroup,
    String? name,
    required String recoveryVaultId,
    required ReplicationRecoveryPlanShutdownRecoveryGroup shutdownRecoveryGroup,
    required String sourceRecoveryFabricId,
    required String targetRecoveryFabricId,
  }) :
  ...
  factory ReplicationRecoveryPlanArgs.fromMap(Map<String, dynamic> map) {
    return ReplicationRecoveryPlanArgs(
      azureToAzureSettings: map['azureToAzureSettings'] == null ? null : ReplicationRecoveryPlanAzureToAzureSettings.fromMap((map['azureToAzureSettings'] as Map).cast<String, dynamic>()),
      bootRecoveryGroups: pulumi.Input.decodeList<ReplicationRecoveryPlanBootRecoveryGroup>(map['bootRecoveryGroups'], (value) => ReplicationRecoveryPlanBootRecoveryGroup.fromMap((value as Map).cast<String, dynamic>())),
      failoverRecoveryGroup: ReplicationRecoveryPlanFailoverRecoveryGroup.fromMap((map['failoverRecoveryGroup'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      recoveryVaultId: map['recoveryVaultId'] as String,
      shutdownRecoveryGroup: ReplicationRecoveryPlanShutdownRecoveryGroup.fromMap((map['shutdownRecoveryGroup'] as Map).cast<String, dynamic>()),
