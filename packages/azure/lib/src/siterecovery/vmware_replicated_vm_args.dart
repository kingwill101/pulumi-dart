...
class VmwareReplicatedVmArgs {
  ...
  factory VmwareReplicatedVmArgs.fromMap(Map<String, dynamic> map) {
    return VmwareReplicatedVmArgs(
      ...
      defaultLogStorageAccountId: map['defaultLogStorageAccountId'] == null ? null : map['defaultLogStorageAccountId'] as String,
      defaultRecoveryDiskType: map['defaultRecoveryDiskType'] == null ? null : map['defaultRecoveryDiskType'] as String,
      defaultTargetDiskEncryptionSetId: map['defaultTargetDiskEncryptionSetId'] == null ? null : map['defaultTargetDiskEncryptionSetId'] as String,
      licenseType: map['licenseType'] == null ? null : map['licenseType'] as String,
      managedDisks: map['managedDisks'] == null ? null : pulumi.Input.decodeList<VmwareReplicatedVmManagedDisk>(map['managedDisks'], (value) => VmwareReplicatedVmManagedDisk.fromMap((value as Map).cast<String, dynamic>())),
      multiVmGroupName: map['multiVmGroupName'] == null ? null : map['multiVmGroupName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkInterfaces: map['networkInterfaces'] == null ? null : pulumi.Input.decodeList<VmwareReplicatedVmNetworkInterface>(map['networkInterfaces'], (value) => VmwareReplicatedVmNetworkInterface.fromMap((value as Map).cast<String, dynamic>())),
      physicalServerCredentialName: map['physicalServerCredentialName'] as String,
      ...
      targetZone: map['targetZone'] == null ? null : map['targetZone'] as String,
