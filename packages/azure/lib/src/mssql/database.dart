...
class Database extends pulumi.CustomResource {
  ...
  Database(
    ...
    this.autoPauseDelayInMinutes = registerOutput<int>('autoPauseDelayInMinutes');
    this.collation = registerOutput<String>('collation');
    this.createMode = registerOutput<String?>('createMode');
    this.creationSourceDatabaseId = registerOutput<String>('creationSourceDatabaseId');
    this.elasticPoolId = registerOutput<String?>('elasticPoolId');
    this.enclaveType = registerOutput<String>('enclaveType');
    this.geoBackupEnabled = registerOutput<bool?>('geoBackupEnabled');
    this.identity = registerOutput<DatabaseIdentity?>('identity');
    this.import = registerOutput<DatabaseImport?>('import');
    this.ledgerEnabled = registerOutput<bool>('ledgerEnabled');
    this.licenseType = registerOutput<String>('licenseType');
    this.longTermRetentionPolicy = registerOutput<DatabaseLongTermRetentionPolicy>('longTermRetentionPolicy');
    ...
    this.readReplicaCount = registerOutput<int>('readReplicaCount');
    this.readScale = registerOutput<bool>('readScale');
    this.recoverDatabaseId = registerOutput<String?>('recoverDatabaseId');
    this.recoveryPointId = registerOutput<String?>('recoveryPointId');
    this.restoreDroppedDatabaseId = registerOutput<String?>('restoreDroppedDatabaseId');
    this.restoreLongTermRetentionBackupId = registerOutput<String?>('restoreLongTermRetentionBackupId');
    this.restorePointInTime = registerOutput<String>('restorePointInTime');
    this.sampleName = registerOutput<String>('sampleName');
    this.secondaryType = registerOutput<String>('secondaryType');
    this.serverId = registerOutput<String>('serverId');
    this.shortTermRetentionPolicy = registerOutput<DatabaseShortTermRetentionPolicy>('shortTermRetentionPolicy');
    this.skuName = registerOutput<String>('skuName');
    this.storageAccountType = registerOutput<String?>('storageAccountType');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.threatDetectionPolicy = registerOutput<DatabaseThreatDetectionPolicy>('threatDetectionPolicy');
    this.transparentDataEncryptionEnabled = registerOutput<bool?>('transparentDataEncryptionEnabled');
    this.transparentDataEncryptionKeyAutomaticRotationEnabled = registerOutput<bool?>('transparentDataEncryptionKeyAutomaticRotationEnabled');
