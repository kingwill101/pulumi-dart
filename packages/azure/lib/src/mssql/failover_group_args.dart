...
class FailoverGroupArgs {
  ...
  FailoverGroupArgs({
    ...
    String? name,
    required List<FailoverGroupPartnerServer> partnerServers,
    required FailoverGroupReadWriteEndpointFailoverPolicy readWriteEndpointFailoverPolicy,
  ...
  factory FailoverGroupArgs.fromMap(Map<String, dynamic> map) {
    return FailoverGroupArgs(
      ...
      partnerServers: pulumi.Input.decodeList<FailoverGroupPartnerServer>(map['partnerServers'], (value) => FailoverGroupPartnerServer.fromMap((value as Map).cast<String, dynamic>())),
      readWriteEndpointFailoverPolicy: FailoverGroupReadWriteEndpointFailoverPolicy.fromMap((map['readWriteEndpointFailoverPolicy'] as Map).cast<String, dynamic>()),
      readonlyEndpointFailoverPolicyEnabled: map['readonlyEndpointFailoverPolicyEnabled'] == null ? null : map['readonlyEndpointFailoverPolicyEnabled'] as bool,
