...
class JobTargetGroupArgs {
  ...
  JobTargetGroupArgs({
    required String jobAgentId,
    List<JobTargetGroupJobTarget>? jobTargets,
    String? name,
  }) :
  ...
  factory JobTargetGroupArgs.fromMap(Map<String, dynamic> map) {
    return JobTargetGroupArgs(
      jobAgentId: map['jobAgentId'] as String,
      jobTargets: map['jobTargets'] == null ? null : pulumi.Input.decodeList<JobTargetGroupJobTarget>(map['jobTargets'], (value) => JobTargetGroupJobTarget.fromMap((value as Map).cast<String, dynamic>())),
