...
class ManagedInstanceStartStopScheduleArgs {
  ...
  ManagedInstanceStartStopScheduleArgs({
    ...
    required List<ManagedInstanceStartStopScheduleSchedule> schedules,
    String? timezoneId,
  }) :
  ...
  factory ManagedInstanceStartStopScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstanceStartStopScheduleArgs(
      ...
      schedules: pulumi.Input.decodeList<ManagedInstanceStartStopScheduleSchedule>(map['schedules'], (value) => ManagedInstanceStartStopScheduleSchedule.fromMap((value as Map).cast<String, dynamic>())),
