...
/// {@template pulumi_mssql_virtual_machine_virtual_machine_args_doc}
...
class VirtualMachineArgs {
  ...
  VirtualMachineArgs({
    VirtualMachineAssessment? assessment,
    VirtualMachineAutoBackup? autoBackup,
    VirtualMachineAutoPatching? autoPatching,
    VirtualMachineKeyVaultCredential? keyVaultCredential,
    bool? rServicesEnabled,
    int? sqlConnectivityPort,
    String? sqlConnectivityType,
    String? sqlConnectivityUpdatePassword,
    String? sqlConnectivityUpdateUsername,
    VirtualMachineSqlInstance? sqlInstance,
    String? sqlLicenseType,
    String? sqlVirtualMachineGroupId,
    VirtualMachineStorageConfiguration? storageConfiguration,
    Map<String, String>? tags,
    required String virtualMachineId,
    VirtualMachineWsfcDomainCredential? wsfcDomainCredential,
  }) :
  ...
  factory VirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineArgs(
      assessment: map['assessment'] == null ? null : VirtualMachineAssessment.fromMap((map['assessment'] as Map).cast<String, dynamic>()),
      autoBackup: map['autoBackup'] == null ? null : VirtualMachineAutoBackup.fromMap((map['autoBackup'] as Map).cast<String, dynamic>()),
      autoPatching: map['autoPatching'] == null ? null : VirtualMachineAutoPatching.fromMap((map['autoPatching'] as Map).cast<String, dynamic>()),
      keyVaultCredential: map['keyVaultCredential'] == null ? null : VirtualMachineKeyVaultCredential.fromMap((map['keyVaultCredential'] as Map).cast<String, dynamic>()),
      rServicesEnabled: map['rServicesEnabled'] == null ? null : map['rServicesEnabled'] as bool,
      sqlConnectivityPort: map['sqlConnectivityPort'] == null ? null : map['sqlConnectivityPort'] as int,
      sqlConnectivityType: map['sqlConnectivityType'] == null ? null : map['sqlConnectivityType'] as String,
      sqlConnectivityUpdatePassword: map['sqlConnectivityUpdatePassword'] == null ? null : map['sqlConnectivityUpdatePassword'] as String,
      sqlConnectivityUpdateUsername: map['sqlConnectivityUpdateUsername'] == null ? null : map['sqlConnectivityUpdateUsername'] as String,
      sqlInstance: map['sqlInstance'] == null ? null : VirtualMachineSqlInstance.fromMap((map['sqlInstance'] as Map).cast<String, dynamic>()),
      sqlLicenseType: map['sqlLicenseType'] == null ? null : map['sqlLicenseType'] as String,
      sqlVirtualMachineGroupId: map['sqlVirtualMachineGroupId'] == null ? null : map['sqlVirtualMachineGroupId'] as String,
      storageConfiguration: map['storageConfiguration'] == null ? null : VirtualMachineStorageConfiguration.fromMap((map['storageConfiguration'] as Map).cast<String, dynamic>()),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      virtualMachineId: map['virtualMachineId'] as String,
      wsfcDomainCredential: map['wsfcDomainCredential'] == null ? null : VirtualMachineWsfcDomainCredential.fromMap((map['wsfcDomainCredential'] as Map).cast<String, dynamic>()),
    );
  }
}
