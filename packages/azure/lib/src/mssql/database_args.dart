...
class DatabaseArgs {
  ...
  DatabaseArgs({
    int? autoPauseDelayInMinutes,
    String? collation,
    String? createMode,
    String? creationSourceDatabaseId,
    String? elasticPoolId,
    String? enclaveType,
    bool? geoBackupEnabled,
    DatabaseIdentity? identity,
    DatabaseImport? import,
    bool? ledgerEnabled,
    String? licenseType,
    DatabaseLongTermRetentionPolicy? longTermRetentionPolicy,
    ...
    DatabaseShortTermRetentionPolicy? shortTermRetentionPolicy,
    String? skuName,
    String? storageAccountType,
    Map<String, String>? tags,
    DatabaseThreatDetectionPolicy? threatDetectionPolicy,
    ...
    bool? zoneRedundant,
      ...
      autoPauseDelayInMinutes = pulumi.Input.asOptionalInput<int>(autoPauseDelayInMinutes),
      collation = pulumi.Input.asOptionalInput<String>(collation),
      createMode = pulumi.Input.asOptionalInput<String>(createMode),
      creationSourceDatabaseId = pulumi.Input.asOptionalInput<String>(creationSourceDatabaseId),
      ...
      geoBackupEnabled = pulumi.Input.asOptionalInput<bool>(geoBackupEnabled),
      identity = pulumi.Input.asOptionalInput<DatabaseIdentity>(identity),
      import = pulumi.Input.asOptionalInput<DatabaseImport>(import),
      ledgerEnabled = pulumi.Input.asOptionalInput<bool>(ledgerEnabled),
      licenseType = pulumi.Input.asOptionalInput<String>(licenseType),
      longTermRetentionPolicy = pulumi.Input.asOptionalInput<DatabaseLongTermRetentionPolicy>(longTermRetentionPolicy),
      ...
      readReplicaCount = pulumi.Input.asOptionalInput<int>(readReplicaCount),
      readScale = pulumi.Input.asOptionalInput<bool>(readScale),
      recoverDatabaseId = pulumi.Input.asOptionalInput<String>(recoverDatabaseId),
      recoveryPointId = pulumi.Input.asOptionalInput<String>(recoveryPointId),
      restoreDroppedDatabaseId = pulumi.Input.asOptionalInput<String>(restoreDroppedDatabaseId),
      restoreLongTermRetentionBackupId = pulumi.Input.asOptionalInput<String>(restoreLongTermRetentionBackupId),
      ...
      shortTermRetentionPolicy = pulumi.Input.asOptionalInput<DatabaseShortTermRetentionPolicy>(shortTermRetentionPolicy),
      ...
      threatDetectionPolicy = pulumi.Input.asOptionalInput<DatabaseThreatDetectionPolicy>(threatDetectionPolicy),
      transparentDataEncryptionEnabled = pulumi.Input.asOptionalInput<bool>(transparentDataEncryptionEnabled),
      transparentDataEncryptionKeyAutomaticRotationEnabled = pulumi.Input.asOptionalInput<bool>(transparentDataEncryptionKeyAutomaticRotationEnabled),
  ...
  factory DatabaseArgs.fromMap(Map<String, dynamic> map) {
    return DatabaseArgs(
      autoPauseDelayInMinutes: map['autoPauseDelayInMinutes'] == null ? null : map['autoPauseDelayInMinutes'] as int,
      collation: map['collation'] == null ? null : map['collation'] as String,
      createMode: map['createMode'] == null ? null : map['createMode'] as String,
      creationSourceDatabaseId: map['creationSourceDatabaseId'] == null ? null : map['creationSourceDatabaseId'] as String,
      ...
      geoBackupEnabled: map['geoBackupEnabled'] == null ? null : map['geoBackupEnabled'] as bool,
      identity: map['identity'] == null ? null : DatabaseIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      import: map['import'] == null ? null : DatabaseImport.fromMap((map['import'] as Map).cast<String, dynamic>()),
      ledgerEnabled: map['ledgerEnabled'] == null ? null : map['ledgerEnabled'] as bool,
      licenseType: map['licenseType'] == null ? null : map['licenseType'] as String,
      longTermRetentionPolicy: map['longTermRetentionPolicy'] == null ? null : DatabaseLongTermRetentionPolicy.fromMap((map['longTermRetentionPolicy'] as Map).cast<String, dynamic>()),
      ...
      readReplicaCount: map['readReplicaCount'] == null ? null : map['readReplicaCount'] as int,
      readScale: map['readScale'] == null ? null : map['readScale'] as bool,
      recoverDatabaseId: map['recoverDatabaseId'] == null ? null : map['recoverDatabaseId'] as String,
      recoveryPointId: map['recoveryPointId'] == null ? null : map['recoveryPointId'] as String,
      restoreDroppedDatabaseId: map['restoreDroppedDatabaseId'] == null ? null : map['restoreDroppedDatabaseId'] as String,
      restoreLongTermRetentionBackupId: map['restoreLongTermRetentionBackupId'] == null ? null : map['restoreLongTermRetentionBackupId'] as String,
      ...
      shortTermRetentionPolicy: map['shortTermRetentionPolicy'] == null ? null : DatabaseShortTermRetentionPolicy.fromMap((map['shortTermRetentionPolicy'] as Map).cast<String, dynamic>()),
      ...
      threatDetectionPolicy: map['threatDetectionPolicy'] == null ? null : DatabaseThreatDetectionPolicy.fromMap((map['threatDetectionPolicy'] as Map).cast<String, dynamic>()),
      transparentDataEncryptionEnabled: map['transparentDataEncryptionEnabled'] == null ? null : map['transparentDataEncryptionEnabled'] as bool,
      transparentDataEncryptionKeyAutomaticRotationEnabled: map['transparentDataEncryptionKeyAutomaticRotationEnabled'] == null ? null : map['transparentDataEncryptionKeyAutomaticRotationEnabled'] as bool,
