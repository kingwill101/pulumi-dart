...
class ManagedInstanceFailoverGroupArgs {
  ...
  ManagedInstanceFailoverGroupArgs({
    ...
    String? name,
    required String partnerManagedInstanceId,
    required ManagedInstanceFailoverGroupReadWriteEndpointFailoverPolicy readWriteEndpointFailoverPolicy,
  ...
  factory ManagedInstanceFailoverGroupArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstanceFailoverGroupArgs(
      ...
      readWriteEndpointFailoverPolicy: ManagedInstanceFailoverGroupReadWriteEndpointFailoverPolicy.fromMap((map['readWriteEndpointFailoverPolicy'] as Map).cast<String, dynamic>()),
