...
class VirtualMachineGroupArgs {
  ...
  VirtualMachineGroupArgs({
    ...
    required String sqlImageOffer,
    required String sqlImageSku,
    Map<String, String>? tags,
    required VirtualMachineGroupWsfcDomainProfile wsfcDomainProfile,
  }) :
  ...
  factory VirtualMachineGroupArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineGroupArgs(
      ...
      sqlImageOffer: map['sqlImageOffer'] as String,
      sqlImageSku: map['sqlImageSku'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      wsfcDomainProfile: VirtualMachineGroupWsfcDomainProfile.fromMap((map['wsfcDomainProfile'] as Map).cast<String, dynamic>()),
    );
  }
}
