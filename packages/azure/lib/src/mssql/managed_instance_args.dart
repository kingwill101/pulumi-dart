...
class ManagedInstanceArgs {
  ...
  ManagedInstanceArgs({
    ...
    ManagedInstanceAzureActiveDirectoryAdministrator? azureActiveDirectoryAdministrator,
    String? collation,
    ...
    required int storageSizeInGb,
    required String subnetId,
    Map<String, String>? tags,
    String? timezoneId,
    required int vcores,
    bool? zoneRedundantEnabled,
  }) :
  ...
  factory ManagedInstanceArgs.fromMap(Map<String, dynamic> map) {
    return ManagedInstanceArgs(
      ...
      azureActiveDirectoryAdministrator: map['azureActiveDirectoryAdministrator'] == null ? null : ManagedInstanceAzureActiveDirectoryAdministrator.fromMap((map['azureActiveDirectoryAdministrator'] as Map).cast<String, dynamic>()),
      ...
      dnsZonePartnerId: map['dnsZonePartnerId'] == null ? null : map['dnsZonePartnerId'] as String,
      hybridSecondaryUsage: map['hybridSecondaryUsage'] == null ? null : map['hybridSecondaryUsage'] as String,
      identity: map['identity'] == null ? null : ManagedInstanceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      servicePrincipalType: map['servicePrincipalType'] == null ? null : map['servicePrincipalType'] as String,
      ...
      zoneRedundantEnabled: map['zoneRedundantEnabled'] == null ? null : map['zoneRedundantEnabled'] as bool,
    );
  }
}
