...
class VirtualMachineAvailabilityGroupListenerArgs {
  ...
  VirtualMachineAvailabilityGroupListenerArgs({
    ...
    VirtualMachineAvailabilityGroupListenerLoadBalancerConfiguration? loadBalancerConfiguration,
    List<VirtualMachineAvailabilityGroupListenerMultiSubnetIpConfiguration>? multiSubnetIpConfigurations,
    String? name,
    int? port,
    required List<VirtualMachineAvailabilityGroupListenerReplica> replicas,
    required String sqlVirtualMachineGroupId,
  }) :
  ...
  factory VirtualMachineAvailabilityGroupListenerArgs.fromMap(Map<String, dynamic> map) {
    return VirtualMachineAvailabilityGroupListenerArgs(
      ...
      loadBalancerConfiguration: map['loadBalancerConfiguration'] == null ? null : VirtualMachineAvailabilityGroupListenerLoadBalancerConfiguration.fromMap((map['loadBalancerConfiguration'] as Map).cast<String, dynamic>()),
      ...
      replicas: pulumi.Input.decodeList<VirtualMachineAvailabilityGroupListenerReplica>(map['replicas'], (value) => VirtualMachineAvailabilityGroupListenerReplica.fromMap((value as Map).cast<String, dynamic>())),
      sqlVirtualMachineGroupId: map['sqlVirtualMachineGroupId'] as String,
    );
  }
}
