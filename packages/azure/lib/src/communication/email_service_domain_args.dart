...
class EmailServiceDomainArgs {
  ...
  EmailServiceDomainArgs({
    ...
    required String emailServiceId,
    String? name,
    Map<String, String>? tags,
    bool? userEngagementTrackingEnabled,
  }) :
  ...
  factory EmailServiceDomainArgs.fromMap(Map<String, dynamic> map) {
    return EmailServiceDomainArgs(
      ...
      emailServiceId: map['emailServiceId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      userEngagementTrackingEnabled: map['userEngagementTrackingEnabled'] == null ? null : map['userEngagementTrackingEnabled'] as bool,
    );
  }
}
