...
class ApplicationArgs {
  ...
  ApplicationArgs({
    ...
    required String commandLineArgumentPolicy,
  ...
  factory ApplicationArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationArgs(
      applicationGroupId: map['applicationGroupId'] as String,
      commandLineArgumentPolicy: map['commandLineArgumentPolicy'] as String,
