...
class HostPoolArgs {
  ...
  HostPoolArgs({
    ...
    HostPoolScheduledAgentUpdates? scheduledAgentUpdates,
  ...
  factory HostPoolArgs.fromMap(Map<String, dynamic> map) {
    return HostPoolArgs(
      customRdpProperties: map['customRdpProperties'] == null ? null : map['customRdpProperties'] as String,
      ...
      maximumSessionsAllowed: map['maximumSessionsAllowed'] == null ? null : map['maximumSessionsAllowed'] as int,
      ...
      preferredAppGroupType: map['preferredAppGroupType'] == null ? null : map['preferredAppGroupType'] as String,
      publicNetworkAccess: map['publicNetworkAccess'] == null ? null : map['publicNetworkAccess'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      scheduledAgentUpdates: map['scheduledAgentUpdates'] == null ? null : HostPoolScheduledAgentUpdates.fromMap((map['scheduledAgentUpdates'] as Map).cast<String, dynamic>()),
      startVmOnConnect: map['startVmOnConnect'] == null ? null : map['startVmOnConnect'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      type: map['type'] as String,
      validateEnvironment: map['validateEnvironment'] == null ? null : map['validateEnvironment'] as bool,
