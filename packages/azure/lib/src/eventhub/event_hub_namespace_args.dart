...
class EventHubNamespaceArgs {
  ...
  EventHubNamespaceArgs({
    ...
    EventHubNamespaceIdentity? identity,
    bool? localAuthenticationEnabled,
    String? location,
    int? maximumThroughputUnits,
    String? minimumTlsVersion,
    String? name,
    EventHubNamespaceNetworkRulesets? networkRulesets,
  ...
  factory EventHubNamespaceArgs.fromMap(Map<String, dynamic> map) {
    return EventHubNamespaceArgs(
      autoInflateEnabled: map['autoInflateEnabled'] == null ? null : map['autoInflateEnabled'] as bool,
      capacity: map['capacity'] == null ? null : map['capacity'] as int,
      dedicatedClusterId: map['dedicatedClusterId'] == null ? null : map['dedicatedClusterId'] as String,
      identity: map['identity'] == null ? null : EventHubNamespaceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      networkRulesets: map['networkRulesets'] == null ? null : EventHubNamespaceNetworkRulesets.fromMap((map['networkRulesets'] as Map).cast<String, dynamic>()),
