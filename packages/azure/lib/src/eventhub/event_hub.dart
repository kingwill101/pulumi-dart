...
class EventHub extends pulumi.CustomResource {
  ...
  EventHub(
    ...
    this.captureDescription = registerOutput<EventHubCaptureDescription?>('captureDescription');
    this.messageRetention = registerOutput<int>('messageRetention');
    ...
    this.retentionDescription = registerOutput<EventHubRetentionDescription>('retentionDescription');
