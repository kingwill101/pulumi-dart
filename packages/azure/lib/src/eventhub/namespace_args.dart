...
class NamespaceArgs {
  ...
  NamespaceArgs({
    int? capacity,
    NamespaceCustomerManagedKey? customerManagedKey,
    NamespaceIdentity? identity,
    bool? localAuthEnabled,
    String? location,
    String? minimumTlsVersion,
    String? name,
    NamespaceNetworkRuleSet? networkRuleSet,
  ...
  factory NamespaceArgs.fromMap(Map<String, dynamic> map) {
    return NamespaceArgs(
      ...
      customerManagedKey: map['customerManagedKey'] == null ? null : NamespaceCustomerManagedKey.fromMap((map['customerManagedKey'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : NamespaceIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      networkRuleSet: map['networkRuleSet'] == null ? null : NamespaceNetworkRuleSet.fromMap((map['networkRuleSet'] as Map).cast<String, dynamic>()),
