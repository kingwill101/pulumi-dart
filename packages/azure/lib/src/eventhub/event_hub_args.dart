...
class EventHubArgs {
  ...
  EventHubArgs({
    EventHubCaptureDescription? captureDescription,
    ...
    EventHubRetentionDescription? retentionDescription,
    String? status,
  }) :
  ...
  factory EventHubArgs.fromMap(Map<String, dynamic> map) {
    return EventHubArgs(
      captureDescription: map['captureDescription'] == null ? null : EventHubCaptureDescription.fromMap((map['captureDescription'] as Map).cast<String, dynamic>()),
      messageRetention: map['messageRetention'] == null ? null : map['messageRetention'] as int,
      ...
      retentionDescription: map['retentionDescription'] == null ? null : EventHubRetentionDescription.fromMap((map['retentionDescription'] as Map).cast<String, dynamic>()),
