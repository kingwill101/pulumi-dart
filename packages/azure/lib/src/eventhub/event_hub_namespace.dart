...
class EventHubNamespace extends pulumi.CustomResource {
  ...
  EventHubNamespace(
    ...
    this.autoInflateEnabled = registerOutput<bool?>('autoInflateEnabled');
    ...
    this.defaultPrimaryConnectionStringAlias = registerOutput<String>('defaultPrimaryConnectionStringAlias');
    ...
    this.defaultSecondaryConnectionStringAlias = registerOutput<String>('defaultSecondaryConnectionStringAlias');
    this.defaultSecondaryKey = registerOutput<String>('defaultSecondaryKey');
    this.identity = registerOutput<EventHubNamespaceIdentity?>('identity');
    ...
    this.networkRulesets = registerOutput<EventHubNamespaceNetworkRulesets>('networkRulesets');
