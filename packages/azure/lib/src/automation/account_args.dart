...
class AccountArgs {
  ...
  AccountArgs({
    List<AccountEncryption>? encryptions,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      encryptions: map['encryptions'] == null ? null : pulumi.Input.decodeList<AccountEncryption>(map['encryptions'], (value) => AccountEncryption.fromMap((value as Map).cast<String, dynamic>())),
