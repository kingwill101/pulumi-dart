...
class RuntimeEnvironmentArgs {
  ...
  RuntimeEnvironmentArgs({
    ...
    String? location,
    String? name,
    Map<String, String>? runtimeDefaultPackages,
    required String runtimeLanguage,
  ...
  factory RuntimeEnvironmentArgs.fromMap(Map<String, dynamic> map) {
    return RuntimeEnvironmentArgs(
      ...
      runtimeDefaultPackages: map['runtimeDefaultPackages'] == null ? null : (map['runtimeDefaultPackages'] as Map).cast<String, String>(),
      runtimeLanguage: map['runtimeLanguage'] as String,
