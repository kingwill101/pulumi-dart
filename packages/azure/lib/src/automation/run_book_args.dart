...
class RunBookArgs {
  ...
  RunBookArgs({
    ...
    String? description,
    RunBookDraft? draft,
    List<RunBookJobSchedule>? jobSchedules,
    String? location,
    int? logActivityTraceLevel,
    required bool logProgress,
    required bool logVerbose,
    String? name,
    RunBookPublishContentLink? publishContentLink,
  ...
  factory RunBookArgs.fromMap(Map<String, dynamic> map) {
    return RunBookArgs(
      ...
      jobSchedules: map['jobSchedules'] == null ? null : pulumi.Input.decodeList<RunBookJobSchedule>(map['jobSchedules'], (value) => RunBookJobSchedule.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      logActivityTraceLevel: map['logActivityTraceLevel'] == null ? null : map['logActivityTraceLevel'] as int,
      logProgress: map['logProgress'] as bool,
      logVerbose: map['logVerbose'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      publishContentLink: map['publishContentLink'] == null ? null : RunBookPublishContentLink.fromMap((map['publishContentLink'] as Map).cast<String, dynamic>()),
