...
class ScheduleArgs {
  ...
  ScheduleArgs({
    ...
    int? interval,
    List<int>? monthDays,
    ScheduleMonthlyOccurrence? monthlyOccurrence,
    String? name,
  ...
  factory ScheduleArgs.fromMap(Map<String, dynamic> map) {
    return ScheduleArgs(
      ...
      monthlyOccurrence: map['monthlyOccurrence'] == null ? null : ScheduleMonthlyOccurrence.fromMap((map['monthlyOccurrence'] as Map).cast<String, dynamic>()),
