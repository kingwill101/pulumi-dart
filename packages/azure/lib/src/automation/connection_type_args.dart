...
class ConnectionTypeArgs {
  ...
  ConnectionTypeArgs({
    ...
    required List<ConnectionTypeField> fields,
    bool? isGlobal,
    String? name,
  ...
  factory ConnectionTypeArgs.fromMap(Map<String, dynamic> map) {
    return ConnectionTypeArgs(
      ...
      fields: pulumi.Input.decodeList<ConnectionTypeField>(map['fields'], (value) => ConnectionTypeField.fromMap((value as Map).cast<String, dynamic>())),
