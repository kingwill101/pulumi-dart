...
class GlobalVMShutdownScheduleArgs {
  ...
  GlobalVMShutdownScheduleArgs({
    required String dailyRecurrenceTime,
    bool? enabled,
    String? location,
    required GlobalVMShutdownScheduleNotificationSettings notificationSettings,
  ...
  factory GlobalVMShutdownScheduleArgs.fromMap(Map<String, dynamic> map) {
    return GlobalVMShutdownScheduleArgs(
      dailyRecurrenceTime: map['dailyRecurrenceTime'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      location: map['location'] == null ? null : map['location'] as String,
      notificationSettings: GlobalVMShutdownScheduleNotificationSettings.fromMap((map['notificationSettings'] as Map).cast<String, dynamic>()),
