...
class LinuxVirtualMachineArgs {
  ...
  LinuxVirtualMachineArgs({
    ...
    required LinuxVirtualMachineGalleryImageReference galleryImageReference,
    List<LinuxVirtualMachineInboundNatRule>? inboundNatRules,
    required String labName,
    required String labSubnetName,
    required String labVirtualNetworkId,
    String? location,
    String? name,
    String? notes,
    String? password,
    ...
    required String username,
      ...
      galleryImageReference = pulumi.Input.asInput<LinuxVirtualMachineGalleryImageReference>(galleryImageReference),
  ...
  factory LinuxVirtualMachineArgs.fromMap(Map<String, dynamic> map) {
    return LinuxVirtualMachineArgs(
      ...
      galleryImageReference: LinuxVirtualMachineGalleryImageReference.fromMap((map['galleryImageReference'] as Map).cast<String, dynamic>()),
      inboundNatRules: map['inboundNatRules'] == null ? null : pulumi.Input.decodeList<LinuxVirtualMachineInboundNatRule>(map['inboundNatRules'], (value) => LinuxVirtualMachineInboundNatRule.fromMap((value as Map).cast<String, dynamic>())),
      labName: map['labName'] as String,
      labSubnetName: map['labSubnetName'] as String,
      labVirtualNetworkId: map['labVirtualNetworkId'] as String,
