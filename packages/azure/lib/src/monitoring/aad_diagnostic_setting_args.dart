...
class AadDiagnosticSettingArgs {
  ...
  AadDiagnosticSettingArgs({
    List<AadDiagnosticSettingEnabledLog>? enabledLogs,
  ...
  factory AadDiagnosticSettingArgs.fromMap(Map<String, dynamic> map) {
    return AadDiagnosticSettingArgs(
      enabledLogs: map['enabledLogs'] == null ? null : pulumi.Input.decodeList<AadDiagnosticSettingEnabledLog>(map['enabledLogs'], (value) => AadDiagnosticSettingEnabledLog.fromMap((value as Map).cast<String, dynamic>())),
      ...
      logAnalyticsWorkspaceId: map['logAnalyticsWorkspaceId'] == null ? null : map['logAnalyticsWorkspaceId'] as String,
