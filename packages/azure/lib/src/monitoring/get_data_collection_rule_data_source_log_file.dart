...
class GetDataCollectionRuleDataSourceLogFile {
  ...
  final List<GetDataCollectionRuleDataSourceLogFileSetting> settings;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'format': format,
      'name': name,
      'settings': pulumi.Input.encodeList<GetDataCollectionRuleDataSourceLogFileSetting, Map<String, dynamic>>(settings, (value) => value.toMap()),
      'streams': streams,
    };
  }
  ...
  factory GetDataCollectionRuleDataSourceLogFile.fromMap(Map<String, dynamic> map) {
    return GetDataCollectionRuleDataSourceLogFile(
      ...
      settings: pulumi.Input.decodeList<GetDataCollectionRuleDataSourceLogFileSetting>(map['settings'], (value) => GetDataCollectionRuleDataSourceLogFileSetting.fromMap((value as Map).cast<String, dynamic>())),
