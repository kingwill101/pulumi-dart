...
class ActivityLogAlertArgs {
  ...
  ActivityLogAlertArgs({
    List<ActivityLogAlertAction>? actions,
    required ActivityLogAlertCriteria criteria,
    String? description,
    bool? enabled,
    String? location,
    String? name,
  ...
  factory ActivityLogAlertArgs.fromMap(Map<String, dynamic> map) {
    return ActivityLogAlertArgs(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<ActivityLogAlertAction>(map['actions'], (value) => ActivityLogAlertAction.fromMap((value as Map).cast<String, dynamic>())),
      criteria: ActivityLogAlertCriteria.fromMap((map['criteria'] as Map).cast<String, dynamic>()),
