...
class AlertProcessingRuleActionGroupArgs {
  ...
  AlertProcessingRuleActionGroupArgs({
    required List<String> addActionGroupIds,
    AlertProcessingRuleActionGroupCondition? condition,
    String? description,
    bool? enabled,
    String? name,
    required String resourceGroupName,
    AlertProcessingRuleActionGroupSchedule? schedule,
  ...
  factory AlertProcessingRuleActionGroupArgs.fromMap(Map<String, dynamic> map) {
    return AlertProcessingRuleActionGroupArgs(
      addActionGroupIds: (map['addActionGroupIds'] as List).cast<String>(),
      condition: map['condition'] == null ? null : AlertProcessingRuleActionGroupCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      schedule: map['schedule'] == null ? null : AlertProcessingRuleActionGroupSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
