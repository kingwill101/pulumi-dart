...
class ScheduledQueryRulesAlertArgs {
  ...
  ScheduledQueryRulesAlertArgs({
    required ScheduledQueryRulesAlertAction action,
    ...
    required ScheduledQueryRulesAlertTrigger trigger,
  }) :
  ...
  factory ScheduledQueryRulesAlertArgs.fromMap(Map<String, dynamic> map) {
    return ScheduledQueryRulesAlertArgs(
      action: ScheduledQueryRulesAlertAction.fromMap((map['action'] as Map).cast<String, dynamic>()),
      ...
      queryType: map['queryType'] == null ? null : map['queryType'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      severity: map['severity'] == null ? null : map['severity'] as int,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      throttling: map['throttling'] == null ? null : map['throttling'] as int,
      timeWindow: map['timeWindow'] as int,
      trigger: ScheduledQueryRulesAlertTrigger.fromMap((map['trigger'] as Map).cast<String, dynamic>()),
    );
  }
}
