...
class MetricAlertArgs {
  ...
  MetricAlertArgs({
    ...
    MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteria? applicationInsightsWebTestLocationAvailabilityCriteria,
    bool? autoMitigate,
    List<MetricAlertCriteria>? criterias,
    String? description,
    MetricAlertDynamicCriteria? dynamicCriteria,
    bool? enabled,
    String? frequency,
    String? name,
  ...
  factory MetricAlertArgs.fromMap(Map<String, dynamic> map) {
    return MetricAlertArgs(
      actions: map['actions'] == null ? null : pulumi.Input.decodeList<MetricAlertAction>(map['actions'], (value) => MetricAlertAction.fromMap((value as Map).cast<String, dynamic>())),
      applicationInsightsWebTestLocationAvailabilityCriteria: map['applicationInsightsWebTestLocationAvailabilityCriteria'] == null ? null : MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteria.fromMap((map['applicationInsightsWebTestLocationAvailabilityCriteria'] as Map).cast<String, dynamic>()),
      autoMitigate: map['autoMitigate'] == null ? null : map['autoMitigate'] as bool,
      criterias: map['criterias'] == null ? null : pulumi.Input.decodeList<MetricAlertCriteria>(map['criterias'], (value) => MetricAlertCriteria.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      dynamicCriteria: map['dynamicCriteria'] == null ? null : MetricAlertDynamicCriteria.fromMap((map['dynamicCriteria'] as Map).cast<String, dynamic>()),
