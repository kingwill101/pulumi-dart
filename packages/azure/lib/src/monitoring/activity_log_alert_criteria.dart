...
class ActivityLogAlertCriteria {
  ...
  final ActivityLogAlertCriteriaResourceHealth? resourceHealth;
  ...
  final List<String>? resourceProviders;
  ...
  final ActivityLogAlertCriteriaServiceHealth? serviceHealth;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'resourceHealth': ?resourceHealth == null ? null : resourceHealth!.toMap(),
      ...
      'serviceHealth': ?serviceHealth == null ? null : serviceHealth!.toMap(),
      'status': ?status,
      'statuses': ?statuses,
      'subStatus': ?subStatus,
  ...
  factory ActivityLogAlertCriteria.fromMap(Map<String, dynamic> map) {
    return ActivityLogAlertCriteria(
      ...
      levels: map['levels'] == null ? null : (map['levels'] as List).cast<String>(),
      operationName: map['operationName'] == null ? null : map['operationName'] as String,
      recommendationCategory: map['recommendationCategory'] == null ? null : map['recommendationCategory'] as String,
      recommendationImpact: map['recommendationImpact'] == null ? null : map['recommendationImpact'] as String,
      recommendationType: map['recommendationType'] == null ? null : map['recommendationType'] as String,
      ...
      resourceHealth: map['resourceHealth'] == null ? null : ActivityLogAlertCriteriaResourceHealth.fromMap((map['resourceHealth'] as Map).cast<String, dynamic>()),
      resourceId: map['resourceId'] == null ? null : map['resourceId'] as String,
      resourceIds: map['resourceIds'] == null ? null : (map['resourceIds'] as List).cast<String>(),
      resourceProvider: map['resourceProvider'] == null ? null : map['resourceProvider'] as String,
      resourceProviders: map['resourceProviders'] == null ? null : (map['resourceProviders'] as List).cast<String>(),
      resourceType: map['resourceType'] == null ? null : map['resourceType'] as String,
      resourceTypes: map['resourceTypes'] == null ? null : (map['resourceTypes'] as List).cast<String>(),
      serviceHealth: map['serviceHealth'] == null ? null : ActivityLogAlertCriteriaServiceHealth.fromMap((map['serviceHealth'] as Map).cast<String, dynamic>()),
      status: map['status'] == null ? null : map['status'] as String,
      statuses: map['statuses'] == null ? null : (map['statuses'] as List).cast<String>(),
      subStatus: map['subStatus'] == null ? null : map['subStatus'] as String,
      subStatuses: map['subStatuses'] == null ? null : (map['subStatuses'] as List).cast<String>(),
    );
  }
}
