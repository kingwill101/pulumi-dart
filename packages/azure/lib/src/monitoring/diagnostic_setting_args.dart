...
class DiagnosticSettingArgs {
  ...
  DiagnosticSettingArgs({
    List<DiagnosticSettingEnabledLog>? enabledLogs,
    List<DiagnosticSettingEnabledMetric>? enabledMetrics,
    String? eventhubAuthorizationRuleId,
    String? eventhubName,
    String? logAnalyticsDestinationType,
    String? logAnalyticsWorkspaceId,
    List<DiagnosticSettingMetric>? metrics,
    String? name,
  ...
  factory DiagnosticSettingArgs.fromMap(Map<String, dynamic> map) {
    return DiagnosticSettingArgs(
      enabledLogs: map['enabledLogs'] == null ? null : pulumi.Input.decodeList<DiagnosticSettingEnabledLog>(map['enabledLogs'], (value) => DiagnosticSettingEnabledLog.fromMap((value as Map).cast<String, dynamic>())),
      enabledMetrics: map['enabledMetrics'] == null ? null : pulumi.Input.decodeList<DiagnosticSettingEnabledMetric>(map['enabledMetrics'], (value) => DiagnosticSettingEnabledMetric.fromMap((value as Map).cast<String, dynamic>())),
      ...
      metrics: map['metrics'] == null ? null : pulumi.Input.decodeList<DiagnosticSettingMetric>(map['metrics'], (value) => DiagnosticSettingMetric.fromMap((value as Map).cast<String, dynamic>())),
      name: map['name'] == null ? null : map['name'] as String,
      partnerSolutionId: map['partnerSolutionId'] == null ? null : map['partnerSolutionId'] as String,
