...
class AutoscaleSettingArgs {
  ...
  AutoscaleSettingArgs({
    ...
    String? location,
    String? name,
    AutoscaleSettingNotification? notification,
    AutoscaleSettingPredictive? predictive,
    required List<AutoscaleSettingProfile> profiles,
  ...
  factory AutoscaleSettingArgs.fromMap(Map<String, dynamic> map) {
    return AutoscaleSettingArgs(
      ...
      notification: map['notification'] == null ? null : AutoscaleSettingNotification.fromMap((map['notification'] as Map).cast<String, dynamic>()),
      predictive: map['predictive'] == null ? null : AutoscaleSettingPredictive.fromMap((map['predictive'] as Map).cast<String, dynamic>()),
      profiles: pulumi.Input.decodeList<AutoscaleSettingProfile>(map['profiles'], (value) => AutoscaleSettingProfile.fromMap((value as Map).cast<String, dynamic>())),
