...
class AlertProcessingRuleSuppressionArgs {
  ...
  AlertProcessingRuleSuppressionArgs({
    AlertProcessingRuleSuppressionCondition? condition,
    String? description,
    bool? enabled,
    String? name,
    required String resourceGroupName,
    AlertProcessingRuleSuppressionSchedule? schedule,
  ...
  factory AlertProcessingRuleSuppressionArgs.fromMap(Map<String, dynamic> map) {
    return AlertProcessingRuleSuppressionArgs(
      condition: map['condition'] == null ? null : AlertProcessingRuleSuppressionCondition.fromMap((map['condition'] as Map).cast<String, dynamic>()),
      description: map['description'] == null ? null : map['description'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      schedule: map['schedule'] == null ? null : AlertProcessingRuleSuppressionSchedule.fromMap((map['schedule'] as Map).cast<String, dynamic>()),
