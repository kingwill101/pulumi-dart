...
class OutboundRuleArgs {
  ...
  OutboundRuleArgs({
    ...
    bool? enableTcpReset,
    List<OutboundRuleFrontendIpConfiguration>? frontendIpConfigurations,
  ...
  factory OutboundRuleArgs.fromMap(Map<String, dynamic> map) {
    return OutboundRuleArgs(
      ...
      frontendIpConfigurations: map['frontendIpConfigurations'] == null ? null : pulumi.Input.decodeList<OutboundRuleFrontendIpConfiguration>(map['frontendIpConfigurations'], (value) => OutboundRuleFrontendIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
