...
class BackendAddressPoolArgs {
  ...
  BackendAddressPoolArgs({
    ...
    List<BackendAddressPoolTunnelInterface>? tunnelInterfaces,
  ...
  factory BackendAddressPoolArgs.fromMap(Map<String, dynamic> map) {
    return BackendAddressPoolArgs(
      ...
      synchronousMode: map['synchronousMode'] == null ? null : map['synchronousMode'] as String,
      tunnelInterfaces: map['tunnelInterfaces'] == null ? null : pulumi.Input.decodeList<BackendAddressPoolTunnelInterface>(map['tunnelInterfaces'], (value) => BackendAddressPoolTunnelInterface.fromMap((value as Map).cast<String, dynamic>())),
