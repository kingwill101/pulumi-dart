...
class DpsSharedAccessPolicyArgs {
  ...
  DpsSharedAccessPolicyArgs({
    bool? enrollmentRead,
    bool? enrollmentWrite,
    required String iothubDpsName,
    String? name,
    bool? registrationRead,
    bool? registrationWrite,
  ...
  factory DpsSharedAccessPolicyArgs.fromMap(Map<String, dynamic> map) {
    return DpsSharedAccessPolicyArgs(
      enrollmentRead: map['enrollmentRead'] == null ? null : map['enrollmentRead'] as bool,
      enrollmentWrite: map['enrollmentWrite'] == null ? null : map['enrollmentWrite'] as bool,
      iothubDpsName: map['iothubDpsName'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      registrationRead: map['registrationRead'] == null ? null : map['registrationRead'] as bool,
      registrationWrite: map['registrationWrite'] == null ? null : map['registrationWrite'] as bool,
      resourceGroupName: map['resourceGroupName'] as String,
      serviceConfig: map['serviceConfig'] == null ? null : map['serviceConfig'] as bool,
    );
  }
}
