...
class IoTHubArgs {
  ...
  /// [tags] Optional.
  IoTHubArgs({
    IoTHubCloudToDevice? cloudToDevice,
    List<IoTHubEndpoint>? endpoints,
    List<IoTHubEnrichment>? enrichments,
    int? eventHubPartitionCount,
    int? eventHubRetentionInDays,
    IoTHubFallbackRoute? fallbackRoute,
    IoTHubFileUpload? fileUpload,
    IoTHubIdentity? identity,
    bool? localAuthenticationEnabled,
    String? location,
    String? minTlsVersion,
    String? name,
    List<IoTHubNetworkRuleSet>? networkRuleSets,
    bool? publicNetworkAccessEnabled,
    required String resourceGroupName,
    List<IoTHubRoute>? routes,
    required IoTHubSku sku,
  ...
  factory IoTHubArgs.fromMap(Map<String, dynamic> map) {
    return IoTHubArgs(
      cloudToDevice: map['cloudToDevice'] == null ? null : IoTHubCloudToDevice.fromMap((map['cloudToDevice'] as Map).cast<String, dynamic>()),
      endpoints: map['endpoints'] == null ? null : pulumi.Input.decodeList<IoTHubEndpoint>(map['endpoints'], (value) => IoTHubEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      enrichments: map['enrichments'] == null ? null : pulumi.Input.decodeList<IoTHubEnrichment>(map['enrichments'], (value) => IoTHubEnrichment.fromMap((value as Map).cast<String, dynamic>())),
      eventHubPartitionCount: map['eventHubPartitionCount'] == null ? null : map['eventHubPartitionCount'] as int,
      eventHubRetentionInDays: map['eventHubRetentionInDays'] == null ? null : map['eventHubRetentionInDays'] as int,
      fallbackRoute: map['fallbackRoute'] == null ? null : IoTHubFallbackRoute.fromMap((map['fallbackRoute'] as Map).cast<String, dynamic>()),
      fileUpload: map['fileUpload'] == null ? null : IoTHubFileUpload.fromMap((map['fileUpload'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : IoTHubIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      networkRuleSets: map['networkRuleSets'] == null ? null : pulumi.Input.decodeList<IoTHubNetworkRuleSet>(map['networkRuleSets'], (value) => IoTHubNetworkRuleSet.fromMap((value as Map).cast<String, dynamic>())),
      publicNetworkAccessEnabled: map['publicNetworkAccessEnabled'] == null ? null : map['publicNetworkAccessEnabled'] as bool,
      resourceGroupName: map['resourceGroupName'] as String,
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<IoTHubRoute>(map['routes'], (value) => IoTHubRoute.fromMap((value as Map).cast<String, dynamic>())),
      sku: IoTHubSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
