...
class SecuritySolutionArgs {
  ...
  SecuritySolutionArgs({
    List<SecuritySolutionAdditionalWorkspace>? additionalWorkspaces,
    List<String>? disabledDataSources,
    required String displayName,
    bool? enabled,
    List<String>? eventsToExports,
    required List<String> iothubIds,
    String? location,
    String? logAnalyticsWorkspaceId,
    bool? logUnmaskedIpsEnabled,
    String? name,
    String? queryForResources,
    List<String>? querySubscriptionIds,
    SecuritySolutionRecommendationsEnabled? recommendationsEnabled,
  ...
  factory SecuritySolutionArgs.fromMap(Map<String, dynamic> map) {
    return SecuritySolutionArgs(
      additionalWorkspaces: map['additionalWorkspaces'] == null ? null : pulumi.Input.decodeList<SecuritySolutionAdditionalWorkspace>(map['additionalWorkspaces'], (value) => SecuritySolutionAdditionalWorkspace.fromMap((value as Map).cast<String, dynamic>())),
      disabledDataSources: map['disabledDataSources'] == null ? null : (map['disabledDataSources'] as List).cast<String>(),
      displayName: map['displayName'] as String,
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      eventsToExports: map['eventsToExports'] == null ? null : (map['eventsToExports'] as List).cast<String>(),
      iothubIds: (map['iothubIds'] as List).cast<String>(),
      location: map['location'] == null ? null : map['location'] as String,
      logAnalyticsWorkspaceId: map['logAnalyticsWorkspaceId'] == null ? null : map['logAnalyticsWorkspaceId'] as String,
      logUnmaskedIpsEnabled: map['logUnmaskedIpsEnabled'] == null ? null : map['logUnmaskedIpsEnabled'] as bool,
      name: map['name'] == null ? null : map['name'] as String,
      queryForResources: map['queryForResources'] == null ? null : map['queryForResources'] as String,
      querySubscriptionIds: map['querySubscriptionIds'] == null ? null : (map['querySubscriptionIds'] as List).cast<String>(),
      recommendationsEnabled: map['recommendationsEnabled'] == null ? null : SecuritySolutionRecommendationsEnabled.fromMap((map['recommendationsEnabled'] as Map).cast<String, dynamic>()),
