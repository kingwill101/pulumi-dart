...
class IotHubDpsArgs {
  ...
  IotHubDpsArgs({
    ...
    bool? dataResidencyEnabled,
    List<IotHubDpsIpFilterRule>? ipFilterRules,
    List<IotHubDpsLinkedHub>? linkedHubs,
    String? location,
    String? name,
    bool? publicNetworkAccessEnabled,
    required String resourceGroupName,
    required IotHubDpsSku sku,
  ...
  factory IotHubDpsArgs.fromMap(Map<String, dynamic> map) {
    return IotHubDpsArgs(
      ...
      dataResidencyEnabled: map['dataResidencyEnabled'] == null ? null : map['dataResidencyEnabled'] as bool,
      ipFilterRules: map['ipFilterRules'] == null ? null : pulumi.Input.decodeList<IotHubDpsIpFilterRule>(map['ipFilterRules'], (value) => IotHubDpsIpFilterRule.fromMap((value as Map).cast<String, dynamic>())),
      linkedHubs: map['linkedHubs'] == null ? null : pulumi.Input.decodeList<IotHubDpsLinkedHub>(map['linkedHubs'], (value) => IotHubDpsLinkedHub.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sku: IotHubDpsSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
