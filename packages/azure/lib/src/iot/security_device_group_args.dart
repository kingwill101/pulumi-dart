...
class SecurityDeviceGroupArgs {
  ...
  SecurityDeviceGroupArgs({
    SecurityDeviceGroupAllowRule? allowRule,
    required String iothubId,
    String? name,
    List<SecurityDeviceGroupRangeRule>? rangeRules,
  }) :
  ...
  factory SecurityDeviceGroupArgs.fromMap(Map<String, dynamic> map) {
    return SecurityDeviceGroupArgs(
      allowRule: map['allowRule'] == null ? null : SecurityDeviceGroupAllowRule.fromMap((map['allowRule'] as Map).cast<String, dynamic>()),
      iothubId: map['iothubId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      rangeRules: map['rangeRules'] == null ? null : pulumi.Input.decodeList<SecurityDeviceGroupRangeRule>(map['rangeRules'], (value) => SecurityDeviceGroupRangeRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
