...
class CloudVmClusterArgs {
  ...
  CloudVmClusterArgs({
    ...
    CloudVmClusterDataCollectionOptions? dataCollectionOptions,
    ...
    String? domain,
    List<CloudVmClusterFileSystemConfiguration>? fileSystemConfigurations,
  ...
  factory CloudVmClusterArgs.fromMap(Map<String, dynamic> map) {
    return CloudVmClusterArgs(
      ...
      dataCollectionOptions: map['dataCollectionOptions'] == null ? null : CloudVmClusterDataCollectionOptions.fromMap((map['dataCollectionOptions'] as Map).cast<String, dynamic>()),
      dataStoragePercentage: map['dataStoragePercentage'] == null ? null : map['dataStoragePercentage'] as int,
      dataStorageSizeInTbs: map['dataStorageSizeInTbs'] == null ? null : map['dataStorageSizeInTbs'] as double,
      dbNodeStorageSizeInGbs: map['dbNodeStorageSizeInGbs'] == null ? null : map['dbNodeStorageSizeInGbs'] as int,
      dbServers: (map['dbServers'] as List).cast<String>(),
      displayName: map['displayName'] as String,
      domain: map['domain'] == null ? null : map['domain'] as String,
      fileSystemConfigurations: map['fileSystemConfigurations'] == null ? null : pulumi.Input.decodeList<CloudVmClusterFileSystemConfiguration>(map['fileSystemConfigurations'], (value) => CloudVmClusterFileSystemConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      memorySizeInGbs: map['memorySizeInGbs'] == null ? null : map['memorySizeInGbs'] as int,
