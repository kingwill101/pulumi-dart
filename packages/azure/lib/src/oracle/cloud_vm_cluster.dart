...
class CloudVmCluster extends pulumi.CustomResource {
  ...
  CloudVmCluster(
    ...
    this.dataStoragePercentage = registerOutput<int>('dataStoragePercentage');
    ...
    this.fileSystemConfigurations = registerOutput<List<CloudVmClusterFileSystemConfiguration>?>('fileSystemConfigurations');
    this.giVersion = registerOutput<String>('giVersion');
    this.hostname = registerOutput<String>('hostname');
    this.hostnameActual = registerOutput<String>('hostnameActual');
    this.licenseModel = registerOutput<String>('licenseModel');
    this.localBackupEnabled = registerOutput<bool>('localBackupEnabled');
    ...
    this.scanListenerPortTcpSsl = registerOutput<int?>('scanListenerPortTcpSsl');
    this.sparseDiskgroupEnabled = registerOutput<bool>('sparseDiskgroupEnabled');
