...
class ExadataInfrastructureArgs {
  ...
  ExadataInfrastructureArgs({
    ...
    String? location,
    List<ExadataInfrastructureMaintenanceWindow>? maintenanceWindows,
    String? name,
  ...
  factory ExadataInfrastructureArgs.fromMap(Map<String, dynamic> map) {
    return ExadataInfrastructureArgs(
      ...
      maintenanceWindows: map['maintenanceWindows'] == null ? null : pulumi.Input.decodeList<ExadataInfrastructureMaintenanceWindow>(map['maintenanceWindows'], (value) => ExadataInfrastructureMaintenanceWindow.fromMap((value as Map).cast<String, dynamic>())),
