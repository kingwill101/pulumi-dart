...
class ExascaleDatabaseStorageVaultArgs {
  ...
  ExascaleDatabaseStorageVaultArgs({
    required int additionalFlashCachePercentage,
    String? description,
    required String displayName,
    required ExascaleDatabaseStorageVaultHighCapacityDatabaseStorage highCapacityDatabaseStorage,
    String? location,
    String? name,
  ...
  factory ExascaleDatabaseStorageVaultArgs.fromMap(Map<String, dynamic> map) {
    return ExascaleDatabaseStorageVaultArgs(
      ...
      highCapacityDatabaseStorage: ExascaleDatabaseStorageVaultHighCapacityDatabaseStorage.fromMap((map['highCapacityDatabaseStorage'] as Map).cast<String, dynamic>()),
