...
/// {@template pulumi_oracle_autonomous_database_autonomous_database_args_doc}
/// The set of arguments for AutonomousDatabase.
/// {@endtemplate}
/// {@macro pulumi_oracle_autonomous_database_autonomous_database_args_doc}
class AutonomousDatabaseArgs {
  ...
  AutonomousDatabaseArgs({
    ...
    required int dataStorageSizeInTbs,
    required String dbVersion,
    required String dbWorkload,
    required String displayName,
    required String licenseModel,
    String? location,
    AutonomousDatabaseLongTermBackupSchedule? longTermBackupSchedule,
    ...
    String? virtualNetworkId,
      ...
      dataStorageSizeInTbs = pulumi.Input.asInput<int>(dataStorageSizeInTbs),
      dbVersion = pulumi.Input.asInput<String>(dbVersion),
      dbWorkload = pulumi.Input.asInput<String>(dbWorkload),
  ...
  factory AutonomousDatabaseArgs.fromMap(Map<String, dynamic> map) {
    return AutonomousDatabaseArgs(
      ...
      longTermBackupSchedule: map['longTermBackupSchedule'] == null ? null : AutonomousDatabaseLongTermBackupSchedule.fromMap((map['longTermBackupSchedule'] as Map).cast<String, dynamic>()),
