...
class DefinitionArgs {
  ...
  DefinitionArgs({
    required List<DefinitionAuthorization> authorizations,
    String? description,
    List<DefinitionEligibleAuthorization>? eligibleAuthorizations,
    String? lighthouseDefinitionId,
    required String managingTenantId,
    String? name,
    DefinitionPlan? plan,
  ...
  factory DefinitionArgs.fromMap(Map<String, dynamic> map) {
    return DefinitionArgs(
      authorizations: pulumi.Input.decodeList<DefinitionAuthorization>(map['authorizations'], (value) => DefinitionAuthorization.fromMap((value as Map).cast<String, dynamic>())),
      description: map['description'] == null ? null : map['description'] as String,
      eligibleAuthorizations: map['eligibleAuthorizations'] == null ? null : pulumi.Input.decodeList<DefinitionEligibleAuthorization>(map['eligibleAuthorizations'], (value) => DefinitionEligibleAuthorization.fromMap((value as Map).cast<String, dynamic>())),
      lighthouseDefinitionId: map['lighthouseDefinitionId'] == null ? null : map['lighthouseDefinitionId'] as String,
      managingTenantId: map['managingTenantId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      plan: map['plan'] == null ? null : DefinitionPlan.fromMap((map['plan'] as Map).cast<String, dynamic>()),
