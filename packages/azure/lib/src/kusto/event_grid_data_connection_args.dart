...
class EventGridDataConnectionArgs {
  ...
  EventGridDataConnectionArgs({
    ...
    String? eventgridEventSubscriptionId,
    ...
    String? tableName,
      ...
      eventgridEventSubscriptionId = pulumi.Input.asOptionalInput<String>(eventgridEventSubscriptionId),
      eventgridResourceId = pulumi.Input.asOptionalInput<String>(eventgridResourceId),
      eventhubConsumerGroupName = pulumi.Input.asInput<String>(eventhubConsumerGroupName),
      eventhubId = pulumi.Input.asInput<String>(eventhubId),
      ...
      skipFirstRecord = pulumi.Input.asOptionalInput<bool>(skipFirstRecord),
  ...
  factory EventGridDataConnectionArgs.fromMap(Map<String, dynamic> map) {
    return EventGridDataConnectionArgs(
      ...
      eventgridEventSubscriptionId: map['eventgridEventSubscriptionId'] == null ? null : map['eventgridEventSubscriptionId'] as String,
      eventgridResourceId: map['eventgridResourceId'] == null ? null : map['eventgridResourceId'] as String,
      eventhubConsumerGroupName: map['eventhubConsumerGroupName'] as String,
      eventhubId: map['eventhubId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      managedIdentityId: map['managedIdentityId'] == null ? null : map['managedIdentityId'] as String,
      ...
      skipFirstRecord: map['skipFirstRecord'] == null ? null : map['skipFirstRecord'] as bool,
