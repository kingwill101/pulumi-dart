...
class ClusterArgs {
  ...
  ClusterArgs({
    ...
    List<ClusterLanguageExtension>? languageExtension,
    List<ClusterLanguageExtension>? languageExtensions,
    String? location,
    String? name,
    ClusterOptimizedAutoScale? optimizedAutoScale,
    bool? outboundNetworkAccessRestricted,
    String? publicIpType,
    bool? publicNetworkAccessEnabled,
    bool? purgeEnabled,
    required String resourceGroupName,
    required ClusterSku sku,
    bool? streamingIngestionEnabled,
    Map<String, String>? tags,
    List<String>? trustedExternalTenants,
    ClusterVirtualNetworkConfiguration? virtualNetworkConfiguration,
    List<String>? zones,
  }) :
      ...
      sku = pulumi.Input.asInput<ClusterSku>(sku),
  ...
  factory ClusterArgs.fromMap(Map<String, dynamic> map) {
    return ClusterArgs(
      allowedFqdns: map['allowedFqdns'] == null ? null : (map['allowedFqdns'] as List).cast<String>(),
      allowedIpRanges: map['allowedIpRanges'] == null ? null : (map['allowedIpRanges'] as List).cast<String>(),
      autoStopEnabled: map['autoStopEnabled'] == null ? null : map['autoStopEnabled'] as bool,
      diskEncryptionEnabled: map['diskEncryptionEnabled'] == null ? null : map['diskEncryptionEnabled'] as bool,
      doubleEncryptionEnabled: map['doubleEncryptionEnabled'] == null ? null : map['doubleEncryptionEnabled'] as bool,
      identity: map['identity'] == null ? null : ClusterIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      languageExtension: map['languageExtension'] == null ? null : pulumi.Input.decodeList<ClusterLanguageExtension>(map['languageExtension'], (value) => ClusterLanguageExtension.fromMap((value as Map).cast<String, dynamic>())),
      languageExtensions: map['languageExtensions'] == null ? null : pulumi.Input.decodeList<ClusterLanguageExtension>(map['languageExtensions'], (value) => ClusterLanguageExtension.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      optimizedAutoScale: map['optimizedAutoScale'] == null ? null : ClusterOptimizedAutoScale.fromMap((map['optimizedAutoScale'] as Map).cast<String, dynamic>()),
      ...
      purgeEnabled: map['purgeEnabled'] == null ? null : map['purgeEnabled'] as bool,
      resourceGroupName: map['resourceGroupName'] as String,
      sku: ClusterSku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      streamingIngestionEnabled: map['streamingIngestionEnabled'] == null ? null : map['streamingIngestionEnabled'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      trustedExternalTenants: map['trustedExternalTenants'] == null ? null : (map['trustedExternalTenants'] as List).cast<String>(),
      virtualNetworkConfiguration: map['virtualNetworkConfiguration'] == null ? null : ClusterVirtualNetworkConfiguration.fromMap((map['virtualNetworkConfiguration'] as Map).cast<String, dynamic>()),
