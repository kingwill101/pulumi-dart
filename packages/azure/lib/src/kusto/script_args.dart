...
class ScriptArgs {
  ...
  factory ScriptArgs.fromMap(Map<String, dynamic> map) {
    return ScriptArgs(
      continueOnErrorsEnabled: map['continueOnErrorsEnabled'] == null ? null : map['continueOnErrorsEnabled'] as bool,
      databaseId: map['databaseId'] as String,
      forceAnUpdateWhenValueChanged: map['forceAnUpdateWhenValueChanged'] == null ? null : map['forceAnUpdateWhenValueChanged'] as String,
