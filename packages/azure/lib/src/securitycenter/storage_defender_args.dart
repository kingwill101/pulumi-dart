...
class StorageDefenderArgs {
  ...
  StorageDefenderArgs({
    int? malwareScanningOnUploadCapGbPerMonth,
    bool? malwareScanningOnUploadEnabled,
    bool? overrideSubscriptionSettingsEnabled,
    String? scanResultsEventGridTopicId,
    bool? sensitiveDataDiscoveryEnabled,
  ...
  factory StorageDefenderArgs.fromMap(Map<String, dynamic> map) {
    return StorageDefenderArgs(
      malwareScanningOnUploadCapGbPerMonth: map['malwareScanningOnUploadCapGbPerMonth'] == null ? null : map['malwareScanningOnUploadCapGbPerMonth'] as int,
      malwareScanningOnUploadEnabled: map['malwareScanningOnUploadEnabled'] == null ? null : map['malwareScanningOnUploadEnabled'] as bool,
      overrideSubscriptionSettingsEnabled: map['overrideSubscriptionSettingsEnabled'] == null ? null : map['overrideSubscriptionSettingsEnabled'] as bool,
      scanResultsEventGridTopicId: map['scanResultsEventGridTopicId'] == null ? null : map['scanResultsEventGridTopicId'] as String,
      sensitiveDataDiscoveryEnabled: map['sensitiveDataDiscoveryEnabled'] == null ? null : map['sensitiveDataDiscoveryEnabled'] as bool,
