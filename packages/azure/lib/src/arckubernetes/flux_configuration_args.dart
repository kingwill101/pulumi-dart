...
class FluxConfigurationArgs {
  ...
  FluxConfigurationArgs({
    FluxConfigurationBlobStorage? blobStorage,
    FluxConfigurationBucket? bucket,
    required String clusterId,
    bool? continuousReconciliationEnabled,
    FluxConfigurationGitRepository? gitRepository,
    required List<FluxConfigurationKustomization> kustomizations,
    String? name,
  ...
  factory FluxConfigurationArgs.fromMap(Map<String, dynamic> map) {
    return FluxConfigurationArgs(
      blobStorage: map['blobStorage'] == null ? null : FluxConfigurationBlobStorage.fromMap((map['blobStorage'] as Map).cast<String, dynamic>()),
      bucket: map['bucket'] == null ? null : FluxConfigurationBucket.fromMap((map['bucket'] as Map).cast<String, dynamic>()),
      clusterId: map['clusterId'] as String,
      continuousReconciliationEnabled: map['continuousReconciliationEnabled'] == null ? null : map['continuousReconciliationEnabled'] as bool,
      gitRepository: map['gitRepository'] == null ? null : FluxConfigurationGitRepository.fromMap((map['gitRepository'] as Map).cast<String, dynamic>()),
      kustomizations: pulumi.Input.decodeList<FluxConfigurationKustomization>(map['kustomizations'], (value) => FluxConfigurationKustomization.fromMap((value as Map).cast<String, dynamic>())),
