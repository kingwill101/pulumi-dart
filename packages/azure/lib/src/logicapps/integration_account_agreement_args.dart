...
class IntegrationAccountAgreementArgs {
  ...
  IntegrationAccountAgreementArgs({
    ...
    required IntegrationAccountAgreementGuestIdentity guestIdentity,
    required String guestPartnerName,
    required IntegrationAccountAgreementHostIdentity hostIdentity,
    required String hostPartnerName,
  ...
  factory IntegrationAccountAgreementArgs.fromMap(Map<String, dynamic> map) {
    return IntegrationAccountAgreementArgs(
      ...
      guestIdentity: IntegrationAccountAgreementGuestIdentity.fromMap((map['guestIdentity'] as Map).cast<String, dynamic>()),
      guestPartnerName: map['guestPartnerName'] as String,
      hostIdentity: IntegrationAccountAgreementHostIdentity.fromMap((map['hostIdentity'] as Map).cast<String, dynamic>()),
      hostPartnerName: map['hostPartnerName'] as String,
