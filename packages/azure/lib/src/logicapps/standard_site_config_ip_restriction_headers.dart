...
class StandardSiteConfigIpRestrictionHeaders {
  ...
  /// Creates a new [StandardSiteConfigIpRestrictionHeaders].
  ...
  factory StandardSiteConfigIpRestrictionHeaders.fromMap(Map<String, dynamic> map) {
    return StandardSiteConfigIpRestrictionHeaders(
