...
class StandardSiteConfigScmIpRestriction {
  ...
  final StandardSiteConfigScmIpRestrictionHeaders? headers;
  ...
  factory StandardSiteConfigScmIpRestriction.fromMap(Map<String, dynamic> map) {
    return StandardSiteConfigScmIpRestriction(
      ...
      headers: map['headers'] == null ? null : StandardSiteConfigScmIpRestrictionHeaders.fromMap((map['headers'] as Map).cast<String, dynamic>()),
