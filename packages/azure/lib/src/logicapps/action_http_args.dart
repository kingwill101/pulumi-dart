...
class ActionHttpArgs {
  ...
  ActionHttpArgs({
    ...
    List<ActionHttpRunAfter>? runAfters,
    required String uri,
  }) :
  ...
  factory ActionHttpArgs.fromMap(Map<String, dynamic> map) {
    return ActionHttpArgs(
      ...
      queries: map['queries'] == null ? null : (map['queries'] as Map).cast<String, String>(),
      runAfters: map['runAfters'] == null ? null : pulumi.Input.decodeList<ActionHttpRunAfter>(map['runAfters'], (value) => ActionHttpRunAfter.fromMap((value as Map).cast<String, dynamic>())),
