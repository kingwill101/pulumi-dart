...
class NetworkSecurityGroupArgs {
  ...
  factory NetworkSecurityGroupArgs.fromMap(Map<String, dynamic> map) {
    return NetworkSecurityGroupArgs(
      ...
      securityRules: map['securityRules'] == null ? null : pulumi.Input.decodeList<NetworkSecurityGroupSecurityRule>(map['securityRules'], (value) => NetworkSecurityGroupSecurityRule.fromMap((value as Map).cast<String, dynamic>())),
