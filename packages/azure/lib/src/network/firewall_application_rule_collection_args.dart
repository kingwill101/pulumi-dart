...
class FirewallApplicationRuleCollectionArgs {
  ...
  FirewallApplicationRuleCollectionArgs({
    ...
    required List<FirewallApplicationRuleCollectionRule> rules,
  }) :
  ...
  factory FirewallApplicationRuleCollectionArgs.fromMap(Map<String, dynamic> map) {
    return FirewallApplicationRuleCollectionArgs(
      ...
      rules: pulumi.Input.decodeList<FirewallApplicationRuleCollectionRule>(map['rules'], (value) => FirewallApplicationRuleCollectionRule.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
