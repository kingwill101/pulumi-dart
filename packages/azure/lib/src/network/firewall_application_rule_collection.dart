...
import 'firewall_application_rule_collection_args.dart';
...
class FirewallApplicationRuleCollection extends pulumi.CustomResource {
  ...
  late final pulumi.Output<List<FirewallApplicationRuleCollectionRule>> rules;

  /// Creates a new [FirewallApplicationRuleCollection].
  /// [name] The Pulumi resource name.
  /// [args] Arguments used to configure this [FirewallApplicationRuleCollection]. {@macro pulumi_network_firewall_application_rule_collection_firewall_application_rule_collection_args_doc}
  /// [options] Resource options controlling this resource's behavior.
  FirewallApplicationRuleCollection(
    String name, {
    FirewallApplicationRuleCollectionArgs? args,
    ...
    this.rules = registerOutput<List<FirewallApplicationRuleCollectionRule>>('rules');
  }
}
