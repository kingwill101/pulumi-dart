...
class VirtualNetworkArgs {
  ...
  VirtualNetworkArgs({
    ...
    String? bgpCommunity,
    VirtualNetworkDdosProtectionPlan? ddosProtectionPlan,
    List<String>? dnsServers,
    String? edgeZone,
    VirtualNetworkEncryption? encryption,
    int? flowTimeoutInMinutes,
    List<VirtualNetworkIpAddressPool>? ipAddressPools,
    String? location,
    String? name,
  ...
  factory VirtualNetworkArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkArgs(
      ...
      bgpCommunity: map['bgpCommunity'] == null ? null : map['bgpCommunity'] as String,
      ddosProtectionPlan: map['ddosProtectionPlan'] == null ? null : VirtualNetworkDdosProtectionPlan.fromMap((map['ddosProtectionPlan'] as Map).cast<String, dynamic>()),
      ...
      ipAddressPools: map['ipAddressPools'] == null ? null : pulumi.Input.decodeList<VirtualNetworkIpAddressPool>(map['ipAddressPools'], (value) => VirtualNetworkIpAddressPool.fromMap((value as Map).cast<String, dynamic>())),
      ...
      subnets: map['subnets'] == null ? null : pulumi.Input.decodeList<VirtualNetworkSubnet>(map['subnets'], (value) => VirtualNetworkSubnet.fromMap((value as Map).cast<String, dynamic>())),
