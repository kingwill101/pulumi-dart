...
class GetVirtualNetworkGatewayVpnClientConfiguration {
  ...
  final List<GetVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate> revokedCertificates;
  /// One or more `root_certificate` blocks which are
  /// defined below. These root certificates are used to sign the client certificate
  /// used by the VPN clients to connect to the gateway.
  /// This setting is incompatible with the use of
  /// `aad_tenant`, `aad_audience`, `aad_issuer`, `radius_server_address`, and `radius_server_secret`.
  final List<GetVirtualNetworkGatewayVpnClientConfigurationRootCertificate> rootCertificates;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'revokedCertificates': pulumi.Input.encodeList<GetVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate, Map<String, dynamic>>(revokedCertificates, (value) => value.toMap()),
      'rootCertificates': pulumi.Input.encodeList<GetVirtualNetworkGatewayVpnClientConfigurationRootCertificate, Map<String, dynamic>>(rootCertificates, (value) => value.toMap()),
  ...
  factory GetVirtualNetworkGatewayVpnClientConfiguration.fromMap(Map<String, dynamic> map) {
    return GetVirtualNetworkGatewayVpnClientConfiguration(
      aadAudience: map['aadAudience'] as String,
      aadIssuer: map['aadIssuer'] as String,
      aadTenant: map['aadTenant'] as String,
      addressSpaces: (map['addressSpaces'] as List).cast<String>(),
      radiusServerAddress: map['radiusServerAddress'] as String,
      radiusServerSecret: map['radiusServerSecret'] as String,
      revokedCertificates: pulumi.Input.decodeList<GetVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate>(map['revokedCertificates'], (value) => GetVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate.fromMap((value as Map).cast<String, dynamic>())),
      rootCertificates: pulumi.Input.decodeList<GetVirtualNetworkGatewayVpnClientConfigurationRootCertificate>(map['rootCertificates'], (value) => GetVirtualNetworkGatewayVpnClientConfigurationRootCertificate.fromMap((value as Map).cast<String, dynamic>())),
      vpnClientProtocols: (map['vpnClientProtocols'] as List).cast<String>(),
    );
  }
}
