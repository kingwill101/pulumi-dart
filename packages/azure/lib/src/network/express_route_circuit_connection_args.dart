...
class ExpressRouteCircuitConnectionArgs {
  ...
  ExpressRouteCircuitConnectionArgs({
    required String addressPrefixIpv4,
    String? addressPrefixIpv6,
    String? authorizationKey,
    String? name,
    required String peerPeeringId,
  ...
  factory ExpressRouteCircuitConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteCircuitConnectionArgs(
      addressPrefixIpv4: map['addressPrefixIpv4'] as String,
      addressPrefixIpv6: map['addressPrefixIpv6'] == null ? null : map['addressPrefixIpv6'] as String,
      authorizationKey: map['authorizationKey'] == null ? null : map['authorizationKey'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      peerPeeringId: map['peerPeeringId'] as String,
