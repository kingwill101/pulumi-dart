...
class VirtualNetworkGatewayConnectionArgs {
  ...
  VirtualNetworkGatewayConnectionArgs({
    ...
    VirtualNetworkGatewayConnectionCustomBgpAddresses? customBgpAddresses,
    int? dpdTimeoutSeconds,
    List<String>? egressNatRuleIds,
    bool? enableBgp,
    String? expressRouteCircuitId,
    bool? expressRouteGatewayBypass,
    List<String>? ingressNatRuleIds,
    ...
    VirtualNetworkGatewayConnectionTrafficSelectorPolicy? trafficSelectorPolicy,
    required String type,
    bool? usePolicyBasedTrafficSelectors,
    required String virtualNetworkGatewayId,
  }) :
  ...
  factory VirtualNetworkGatewayConnectionArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayConnectionArgs(
      ...
      customBgpAddresses: map['customBgpAddresses'] == null ? null : VirtualNetworkGatewayConnectionCustomBgpAddresses.fromMap((map['customBgpAddresses'] as Map).cast<String, dynamic>()),
      ...
      expressRouteCircuitId: map['expressRouteCircuitId'] == null ? null : map['expressRouteCircuitId'] as String,
      ...
      ipsecPolicy: map['ipsecPolicy'] == null ? null : VirtualNetworkGatewayConnectionIpsecPolicy.fromMap((map['ipsecPolicy'] as Map).cast<String, dynamic>()),
      localAzureIpAddressEnabled: map['localAzureIpAddressEnabled'] == null ? null : map['localAzureIpAddressEnabled'] as bool,
      localNetworkGatewayId: map['localNetworkGatewayId'] == null ? null : map['localNetworkGatewayId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      peerVirtualNetworkGatewayId: map['peerVirtualNetworkGatewayId'] == null ? null : map['peerVirtualNetworkGatewayId'] as String,
      privateLinkFastPathEnabled: map['privateLinkFastPathEnabled'] == null ? null : map['privateLinkFastPathEnabled'] as bool,
      ...
      trafficSelectorPolicy: map['trafficSelectorPolicy'] == null ? null : VirtualNetworkGatewayConnectionTrafficSelectorPolicy.fromMap((map['trafficSelectorPolicy'] as Map).cast<String, dynamic>()),
