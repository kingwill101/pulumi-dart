...
class TrafficManagerAzureEndpointArgs {
  ...
  TrafficManagerAzureEndpointArgs({
    ...
    List<TrafficManagerAzureEndpointCustomHeader>? customHeaders,
    bool? enabled,
    List<String>? geoMappings,
    String? name,
    int? priority,
    required String profileId,
    List<TrafficManagerAzureEndpointSubnet>? subnets,
  ...
  factory TrafficManagerAzureEndpointArgs.fromMap(Map<String, dynamic> map) {
    return TrafficManagerAzureEndpointArgs(
      ...
      customHeaders: map['customHeaders'] == null ? null : pulumi.Input.decodeList<TrafficManagerAzureEndpointCustomHeader>(map['customHeaders'], (value) => TrafficManagerAzureEndpointCustomHeader.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      geoMappings: map['geoMappings'] == null ? null : (map['geoMappings'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      profileId: map['profileId'] as String,
      subnets: map['subnets'] == null ? null : pulumi.Input.decodeList<TrafficManagerAzureEndpointSubnet>(map['subnets'], (value) => TrafficManagerAzureEndpointSubnet.fromMap((value as Map).cast<String, dynamic>())),
