...
class VirtualHubRouteTableArgs {
  ...
  VirtualHubRouteTableArgs({
    List<String>? labels,
    String? name,
    List<VirtualHubRouteTableRoute>? routes,
  ...
  factory VirtualHubRouteTableArgs.fromMap(Map<String, dynamic> map) {
    return VirtualHubRouteTableArgs(
      ...
      routes: map['routes'] == null ? null : pulumi.Input.decodeList<VirtualHubRouteTableRoute>(map['routes'], (value) => VirtualHubRouteTableRoute.fromMap((value as Map).cast<String, dynamic>())),
