...
class TrafficManagerNestedEndpointArgs {
  ...
  TrafficManagerNestedEndpointArgs({
    List<TrafficManagerNestedEndpointCustomHeader>? customHeaders,
    bool? enabled,
    String? endpointLocation,
    List<String>? geoMappings,
    required int minimumChildEndpoints,
    int? minimumRequiredChildEndpointsIpv4,
    int? minimumRequiredChildEndpointsIpv6,
    String? name,
    int? priority,
    required String profileId,
    List<TrafficManagerNestedEndpointSubnet>? subnets,
    ...
    int? weight,
      ...
      minimumChildEndpoints = pulumi.Input.asInput<int>(minimumChildEndpoints),
  ...
  factory TrafficManagerNestedEndpointArgs.fromMap(Map<String, dynamic> map) {
    return TrafficManagerNestedEndpointArgs(
      customHeaders: map['customHeaders'] == null ? null : pulumi.Input.decodeList<TrafficManagerNestedEndpointCustomHeader>(map['customHeaders'], (value) => TrafficManagerNestedEndpointCustomHeader.fromMap((value as Map).cast<String, dynamic>())),
      ...
      minimumChildEndpoints: map['minimumChildEndpoints'] as int,
      minimumRequiredChildEndpointsIpv4: map['minimumRequiredChildEndpointsIpv4'] == null ? null : map['minimumRequiredChildEndpointsIpv4'] as int,
      minimumRequiredChildEndpointsIpv6: map['minimumRequiredChildEndpointsIpv6'] == null ? null : map['minimumRequiredChildEndpointsIpv6'] as int,
      name: map['name'] == null ? null : map['name'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      profileId: map['profileId'] as String,
      subnets: map['subnets'] == null ? null : pulumi.Input.decodeList<TrafficManagerNestedEndpointSubnet>(map['subnets'], (value) => TrafficManagerNestedEndpointSubnet.fromMap((value as Map).cast<String, dynamic>())),
