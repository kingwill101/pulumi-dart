...
class SubnetArgs {
  ...
  SubnetArgs({
    ...
    List<SubnetDelegation>? delegations,
    SubnetIpAddressPool? ipAddressPool,
    String? name,
    String? privateEndpointNetworkPolicies,
    bool? privateLinkServiceNetworkPoliciesEnabled,
    required String resourceGroupName,
    List<String>? serviceEndpointPolicyIds,
  ...
  factory SubnetArgs.fromMap(Map<String, dynamic> map) {
    return SubnetArgs(
      ...
      delegations: map['delegations'] == null ? null : pulumi.Input.decodeList<SubnetDelegation>(map['delegations'], (value) => SubnetDelegation.fromMap((value as Map).cast<String, dynamic>())),
      ipAddressPool: map['ipAddressPool'] == null ? null : SubnetIpAddressPool.fromMap((map['ipAddressPool'] as Map).cast<String, dynamic>()),
