...
class ExpressRouteCircuitPeeringArgs {
  ...
  ExpressRouteCircuitPeeringArgs({
    required String expressRouteCircuitName,
    bool? ipv4Enabled,
    ExpressRouteCircuitPeeringIpv6? ipv6,
    ExpressRouteCircuitPeeringMicrosoftPeeringConfig? microsoftPeeringConfig,
    int? peerAsn,
    required String peeringType,
  ...
  factory ExpressRouteCircuitPeeringArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteCircuitPeeringArgs(
      ...
      ipv6: map['ipv6'] == null ? null : ExpressRouteCircuitPeeringIpv6.fromMap((map['ipv6'] as Map).cast<String, dynamic>()),
      microsoftPeeringConfig: map['microsoftPeeringConfig'] == null ? null : ExpressRouteCircuitPeeringMicrosoftPeeringConfig.fromMap((map['microsoftPeeringConfig'] as Map).cast<String, dynamic>()),
