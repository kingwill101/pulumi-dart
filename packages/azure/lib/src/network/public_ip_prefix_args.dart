...
/// {@template pulumi_network_public_ip_prefix_public_ip_prefix_args_doc}
/// The set of arguments for PublicIpPrefix.
/// {@endtemplate}
/// {@macro pulumi_network_public_ip_prefix_public_ip_prefix_args_doc}
class PublicIpPrefixArgs {
  ...
  factory PublicIpPrefixArgs.fromMap(Map<String, dynamic> map) {
    return PublicIpPrefixArgs(
      customIpPrefixId: map['customIpPrefixId'] == null ? null : map['customIpPrefixId'] as String,
