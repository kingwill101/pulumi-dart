...
/// {@template pulumi_network_firewall_firewall_args_doc}
/// The set of arguments for Firewall.
/// {@endtemplate}
/// {@macro pulumi_network_firewall_firewall_args_doc}
class FirewallArgs {
  ...
  FirewallArgs({
    ...
    List<FirewallIpConfiguration>? ipConfigurations,
    String? location,
    FirewallManagementIpConfiguration? managementIpConfiguration,
    String? name,
    List<String>? privateIpRanges,
    required String resourceGroupName,
    required String skuName,
    required String skuTier,
    Map<String, String>? tags,
    String? threatIntelMode,
    FirewallVirtualHub? virtualHub,
    List<String>? zones,
  }) :
      ...
      skuTier = pulumi.Input.asInput<String>(skuTier),
  ...
  factory FirewallArgs.fromMap(Map<String, dynamic> map) {
    return FirewallArgs(
      ...
      ipConfigurations: map['ipConfigurations'] == null ? null : pulumi.Input.decodeList<FirewallIpConfiguration>(map['ipConfigurations'], (value) => FirewallIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      managementIpConfiguration: map['managementIpConfiguration'] == null ? null : FirewallManagementIpConfiguration.fromMap((map['managementIpConfiguration'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      privateIpRanges: map['privateIpRanges'] == null ? null : (map['privateIpRanges'] as List).cast<String>(),
      ...
      virtualHub: map['virtualHub'] == null ? null : FirewallVirtualHub.fromMap((map['virtualHub'] as Map).cast<String, dynamic>()),
