...
class VirtualNetworkPeeringArgs {
  ...
  factory VirtualNetworkPeeringArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkPeeringArgs(
      ...
      onlyIpv6PeeringEnabled: map['onlyIpv6PeeringEnabled'] == null ? null : map['onlyIpv6PeeringEnabled'] as bool,
      peerCompleteVirtualNetworksEnabled: map['peerCompleteVirtualNetworksEnabled'] == null ? null : map['peerCompleteVirtualNetworksEnabled'] as bool,
