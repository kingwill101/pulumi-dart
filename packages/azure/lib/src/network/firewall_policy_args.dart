...
class FirewallPolicyArgs {
  ...
  FirewallPolicyArgs({
    bool? autoLearnPrivateRangesEnabled,
    String? basePolicyId,
    FirewallPolicyDns? dns,
    FirewallPolicyExplicitProxy? explicitProxy,
    FirewallPolicyIdentity? identity,
    ...
    String? sku,
    bool? sqlRedirectAllowed,
    Map<String, String>? tags,
    FirewallPolicyThreatIntelligenceAllowlist? threatIntelligenceAllowlist,
    String? threatIntelligenceMode,
    FirewallPolicyTlsCertificate? tlsCertificate,
  }) :
  ...
  factory FirewallPolicyArgs.fromMap(Map<String, dynamic> map) {
    return FirewallPolicyArgs(
      autoLearnPrivateRangesEnabled: map['autoLearnPrivateRangesEnabled'] == null ? null : map['autoLearnPrivateRangesEnabled'] as bool,
      basePolicyId: map['basePolicyId'] == null ? null : map['basePolicyId'] as String,
      dns: map['dns'] == null ? null : FirewallPolicyDns.fromMap((map['dns'] as Map).cast<String, dynamic>()),
      explicitProxy: map['explicitProxy'] == null ? null : FirewallPolicyExplicitProxy.fromMap((map['explicitProxy'] as Map).cast<String, dynamic>()),
      identity: map['identity'] == null ? null : FirewallPolicyIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      insights: map['insights'] == null ? null : FirewallPolicyInsights.fromMap((map['insights'] as Map).cast<String, dynamic>()),
      intrusionDetection: map['intrusionDetection'] == null ? null : FirewallPolicyIntrusionDetection.fromMap((map['intrusionDetection'] as Map).cast<String, dynamic>()),
      ...
      sqlRedirectAllowed: map['sqlRedirectAllowed'] == null ? null : map['sqlRedirectAllowed'] as bool,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      threatIntelligenceAllowlist: map['threatIntelligenceAllowlist'] == null ? null : FirewallPolicyThreatIntelligenceAllowlist.fromMap((map['threatIntelligenceAllowlist'] as Map).cast<String, dynamic>()),
      threatIntelligenceMode: map['threatIntelligenceMode'] == null ? null : map['threatIntelligenceMode'] as String,
      tlsCertificate: map['tlsCertificate'] == null ? null : FirewallPolicyTlsCertificate.fromMap((map['tlsCertificate'] as Map).cast<String, dynamic>()),
    );
  }
}
