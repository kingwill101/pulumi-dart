...
class ExpressRouteConnectionArgs {
  ...
  ExpressRouteConnectionArgs({
    ...
    required String expressRouteCircuitPeeringId,
    bool? expressRouteGatewayBypassEnabled,
    required String expressRouteGatewayId,
    String? name,
    bool? privateLinkFastPathEnabled,
    ExpressRouteConnectionRouting? routing,
    int? routingWeight,
  }) :
      ...
      expressRouteCircuitPeeringId = pulumi.Input.asInput<String>(expressRouteCircuitPeeringId),
      expressRouteGatewayBypassEnabled = pulumi.Input.asOptionalInput<bool>(expressRouteGatewayBypassEnabled),
      expressRouteGatewayId = pulumi.Input.asInput<String>(expressRouteGatewayId),
  ...
  factory ExpressRouteConnectionArgs.fromMap(Map<String, dynamic> map) {
    return ExpressRouteConnectionArgs(
      ...
      expressRouteCircuitPeeringId: map['expressRouteCircuitPeeringId'] as String,
      expressRouteGatewayBypassEnabled: map['expressRouteGatewayBypassEnabled'] == null ? null : map['expressRouteGatewayBypassEnabled'] as bool,
      expressRouteGatewayId: map['expressRouteGatewayId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      privateLinkFastPathEnabled: map['privateLinkFastPathEnabled'] == null ? null : map['privateLinkFastPathEnabled'] as bool,
      routing: map['routing'] == null ? null : ExpressRouteConnectionRouting.fromMap((map['routing'] as Map).cast<String, dynamic>()),
