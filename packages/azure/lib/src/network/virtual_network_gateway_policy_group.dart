...
class VirtualNetworkGatewayPolicyGroup {
  ...
  final List<VirtualNetworkGatewayPolicyGroupPolicyMember> policyMembers;
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'isDefault': ?isDefault,
      'name': name,
      'policyMembers': pulumi.Input.encodeList<VirtualNetworkGatewayPolicyGroupPolicyMember, Map<String, dynamic>>(policyMembers, (value) => value.toMap()),
      'priority': ?priority,
    };
  }
  ...
  factory VirtualNetworkGatewayPolicyGroup.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayPolicyGroup(
      ...
      policyMembers: pulumi.Input.decodeList<VirtualNetworkGatewayPolicyGroupPolicyMember>(map['policyMembers'], (value) => VirtualNetworkGatewayPolicyGroupPolicyMember.fromMap((value as Map).cast<String, dynamic>())),
