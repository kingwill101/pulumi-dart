...
class ProfileArgs {
  ...
  ProfileArgs({
    required ProfileContainerNetworkInterface containerNetworkInterface,
    String? location,
    String? name,
  ...
  factory ProfileArgs.fromMap(Map<String, dynamic> map) {
    return ProfileArgs(
      containerNetworkInterface: ProfileContainerNetworkInterface.fromMap((map['containerNetworkInterface'] as Map).cast<String, dynamic>()),
