...
class GetNatGatewayArgs {
  ...
  factory GetNatGatewayArgs.fromMap(Map<String, dynamic> map) {
    return GetNatGatewayArgs(
      ...
      publicIpAddressIds: map['publicIpAddressIds'] == null ? null : (map['publicIpAddressIds'] as List).cast<String>(),
      publicIpPrefixIds: map['publicIpPrefixIds'] == null ? null : (map['publicIpPrefixIds'] as List).cast<String>(),
