...
class GetGatewayConnectionResult {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'ipsecPolicies': pulumi.Input.encodeList<GetGatewayConnectionIpsecPolicy, Map<String, dynamic>>(ipsecPolicies, (value) => value.toMap()),
      ...
      'sharedKey': sharedKey,
      'tags': tags,
      'trafficSelectorPolicies': pulumi.Input.encodeList<GetGatewayConnectionTrafficSelectorPolicy, Map<String, dynamic>>(trafficSelectorPolicies, (value) => value.toMap()),
      'type': type,
  ...
  factory GetGatewayConnectionResult.fromMap(Map<String, dynamic> map) {
    return GetGatewayConnectionResult(
      ...
      ipsecPolicies: pulumi.Input.decodeList<GetGatewayConnectionIpsecPolicy>(map['ipsecPolicies'], (value) => GetGatewayConnectionIpsecPolicy.fromMap((value as Map).cast<String, dynamic>())),
      ...
      trafficSelectorPolicies: pulumi.Input.decodeList<GetGatewayConnectionTrafficSelectorPolicy>(map['trafficSelectorPolicies'], (value) => GetGatewayConnectionTrafficSelectorPolicy.fromMap((value as Map).cast<String, dynamic>())),
      type: map['type'] as String,
      usePolicyBasedTrafficSelectors: map['usePolicyBasedTrafficSelectors'] as bool,
