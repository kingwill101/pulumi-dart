...
class VirtualNetworkGatewayNatRuleArgs {
  ...
  VirtualNetworkGatewayNatRuleArgs({
    required List<VirtualNetworkGatewayNatRuleExternalMapping> externalMappings,
    required List<VirtualNetworkGatewayNatRuleInternalMapping> internalMappings,
  ...
  factory VirtualNetworkGatewayNatRuleArgs.fromMap(Map<String, dynamic> map) {
    return VirtualNetworkGatewayNatRuleArgs(
      externalMappings: pulumi.Input.decodeList<VirtualNetworkGatewayNatRuleExternalMapping>(map['externalMappings'], (value) => VirtualNetworkGatewayNatRuleExternalMapping.fromMap((value as Map).cast<String, dynamic>())),
      internalMappings: pulumi.Input.decodeList<VirtualNetworkGatewayNatRuleInternalMapping>(map['internalMappings'], (value) => VirtualNetworkGatewayNatRuleInternalMapping.fromMap((value as Map).cast<String, dynamic>())),
