...
class NetworkManagerAdminRuleArgs {
  ...
  NetworkManagerAdminRuleArgs({
    ...
    required String adminRuleCollectionId,
    String? description,
    List<String>? destinationPortRanges,
    List<NetworkManagerAdminRuleDestination>? destinations,
    required String direction,
    String? name,
    required int priority,
    required String protocol,
    List<String>? sourcePortRanges,
    List<NetworkManagerAdminRuleSource>? sources,
  }) :
      action = pulumi.Input.asInput<String>(action),
      adminRuleCollectionId = pulumi.Input.asInput<String>(adminRuleCollectionId),
  ...
  factory NetworkManagerAdminRuleArgs.fromMap(Map<String, dynamic> map) {
    return NetworkManagerAdminRuleArgs(
      ...
      adminRuleCollectionId: map['adminRuleCollectionId'] as String,
      description: map['description'] == null ? null : map['description'] as String,
      destinationPortRanges: map['destinationPortRanges'] == null ? null : (map['destinationPortRanges'] as List).cast<String>(),
      destinations: map['destinations'] == null ? null : pulumi.Input.decodeList<NetworkManagerAdminRuleDestination>(map['destinations'], (value) => NetworkManagerAdminRuleDestination.fromMap((value as Map).cast<String, dynamic>())),
      direction: map['direction'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      priority: map['priority'] as int,
      protocol: map['protocol'] as String,
      sourcePortRanges: map['sourcePortRanges'] == null ? null : (map['sourcePortRanges'] as List).cast<String>(),
      sources: map['sources'] == null ? null : pulumi.Input.decodeList<NetworkManagerAdminRuleSource>(map['sources'], (value) => NetworkManagerAdminRuleSource.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
