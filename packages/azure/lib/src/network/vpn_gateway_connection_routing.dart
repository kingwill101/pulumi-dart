...
class VpnGatewayConnectionRouting {
  ...
  factory VpnGatewayConnectionRouting.fromMap(Map<String, dynamic> map) {
    return VpnGatewayConnectionRouting(
      associatedRouteTable: map['associatedRouteTable'] as String,
      ...
      propagatedRouteTable: map['propagatedRouteTable'] == null ? null : VpnGatewayConnectionRoutingPropagatedRouteTable.fromMap((map['propagatedRouteTable'] as Map).cast<String, dynamic>()),
    );
  }
}
