...
class VpnGatewayArgs {
  ...
  VpnGatewayArgs({
    ...
    VpnGatewayBgpSettings? bgpSettings,
    String? location,
    String? name,
  ...
  factory VpnGatewayArgs.fromMap(Map<String, dynamic> map) {
    return VpnGatewayArgs(
      ...
      bgpSettings: map['bgpSettings'] == null ? null : VpnGatewayBgpSettings.fromMap((map['bgpSettings'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      routingPreference: map['routingPreference'] == null ? null : map['routingPreference'] as String,
      scaleUnit: map['scaleUnit'] == null ? null : map['scaleUnit'] as int,
