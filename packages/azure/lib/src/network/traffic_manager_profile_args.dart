...
class TrafficManagerProfileArgs {
  ...
  TrafficManagerProfileArgs({
    required TrafficManagerProfileDnsConfig dnsConfig,
    int? maxReturn,
    required TrafficManagerProfileMonitorConfig monitorConfig,
    String? name,
  ...
  factory TrafficManagerProfileArgs.fromMap(Map<String, dynamic> map) {
    return TrafficManagerProfileArgs(
      dnsConfig: TrafficManagerProfileDnsConfig.fromMap((map['dnsConfig'] as Map).cast<String, dynamic>()),
      maxReturn: map['maxReturn'] == null ? null : map['maxReturn'] as int,
      monitorConfig: TrafficManagerProfileMonitorConfig.fromMap((map['monitorConfig'] as Map).cast<String, dynamic>()),
