...
class NetworkInterfaceArgs {
  ...
  NetworkInterfaceArgs({
    ...
    required List<NetworkInterfaceIpConfiguration> ipConfigurations,
  ...
  factory NetworkInterfaceArgs.fromMap(Map<String, dynamic> map) {
    return NetworkInterfaceArgs(
      ...
      ipConfigurations: pulumi.Input.decodeList<NetworkInterfaceIpConfiguration>(map['ipConfigurations'], (value) => NetworkInterfaceIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ipForwardingEnabled: map['ipForwardingEnabled'] == null ? null : map['ipForwardingEnabled'] as bool,
