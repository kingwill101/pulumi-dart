...
class VirtualHubArgs {
  ...
  VirtualHubArgs({
    ...
    bool? branchToBranchTrafficEnabled,
    ...
    int? virtualRouterAutoScaleMinCapacity,
    String? virtualWanId,
  }) :
  ...
  factory VirtualHubArgs.fromMap(Map<String, dynamic> map) {
    return VirtualHubArgs(
      ...
      branchToBranchTrafficEnabled: map['branchToBranchTrafficEnabled'] == null ? null : map['branchToBranchTrafficEnabled'] as bool,
      ...
      virtualRouterAutoScaleMinCapacity: map['virtualRouterAutoScaleMinCapacity'] == null ? null : map['virtualRouterAutoScaleMinCapacity'] as int,
      virtualWanId: map['virtualWanId'] == null ? null : map['virtualWanId'] as String,
    );
  }
}
