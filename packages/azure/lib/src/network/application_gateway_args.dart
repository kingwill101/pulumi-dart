...
class ApplicationGatewayArgs {
  ...
  ApplicationGatewayArgs({
    ...
    required List<ApplicationGatewayBackendAddressPool> backendAddressPools,
    required List<ApplicationGatewayBackendHttpSetting> backendHttpSettings,
    List<ApplicationGatewayCustomErrorConfiguration>? customErrorConfigurations,
    bool? enableHttp2,
    bool? fipsEnabled,
    String? firewallPolicyId,
    bool? forceFirewallPolicyAssociation,
    required List<ApplicationGatewayFrontendIpConfiguration> frontendIpConfigurations,
    required List<ApplicationGatewayFrontendPort> frontendPorts,
    required List<ApplicationGatewayGatewayIpConfiguration> gatewayIpConfigurations,
    ApplicationGatewayGlobal? global,
    required List<ApplicationGatewayHttpListener> httpListeners,
    ApplicationGatewayIdentity? identity,
    String? location,
    String? name,
    ...
    required List<ApplicationGatewayRequestRoutingRule> requestRoutingRules,
    required String resourceGroupName,
    List<ApplicationGatewayRewriteRuleSet>? rewriteRuleSets,
    required ApplicationGatewaySku sku,
    ...
    ApplicationGatewayWafConfiguration? wafConfiguration,
    List<String>? zones,
  }) :
  ...
  factory ApplicationGatewayArgs.fromMap(Map<String, dynamic> map) {
    return ApplicationGatewayArgs(
      ...
      backendAddressPools: pulumi.Input.decodeList<ApplicationGatewayBackendAddressPool>(map['backendAddressPools'], (value) => ApplicationGatewayBackendAddressPool.fromMap((value as Map).cast<String, dynamic>())),
      backendHttpSettings: pulumi.Input.decodeList<ApplicationGatewayBackendHttpSetting>(map['backendHttpSettings'], (value) => ApplicationGatewayBackendHttpSetting.fromMap((value as Map).cast<String, dynamic>())),
      customErrorConfigurations: map['customErrorConfigurations'] == null ? null : pulumi.Input.decodeList<ApplicationGatewayCustomErrorConfiguration>(map['customErrorConfigurations'], (value) => ApplicationGatewayCustomErrorConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      ...
      frontendIpConfigurations: pulumi.Input.decodeList<ApplicationGatewayFrontendIpConfiguration>(map['frontendIpConfigurations'], (value) => ApplicationGatewayFrontendIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      frontendPorts: pulumi.Input.decodeList<ApplicationGatewayFrontendPort>(map['frontendPorts'], (value) => ApplicationGatewayFrontendPort.fromMap((value as Map).cast<String, dynamic>())),
      gatewayIpConfigurations: pulumi.Input.decodeList<ApplicationGatewayGatewayIpConfiguration>(map['gatewayIpConfigurations'], (value) => ApplicationGatewayGatewayIpConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      global: map['global'] == null ? null : ApplicationGatewayGlobal.fromMap((map['global'] as Map).cast<String, dynamic>()),
      httpListeners: pulumi.Input.decodeList<ApplicationGatewayHttpListener>(map['httpListeners'], (value) => ApplicationGatewayHttpListener.fromMap((value as Map).cast<String, dynamic>())),
      identity: map['identity'] == null ? null : ApplicationGatewayIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      ...
      requestRoutingRules: pulumi.Input.decodeList<ApplicationGatewayRequestRoutingRule>(map['requestRoutingRules'], (value) => ApplicationGatewayRequestRoutingRule.fromMap((value as Map).cast<String, dynamic>())),
      ...
      sku: ApplicationGatewaySku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
      ...
      wafConfiguration: map['wafConfiguration'] == null ? null : ApplicationGatewayWafConfiguration.fromMap((map['wafConfiguration'] as Map).cast<String, dynamic>()),
