...
class VpnServerConfigurationPolicyGroupArgs {
  ...
  VpnServerConfigurationPolicyGroupArgs({
    bool? isDefault,
    String? name,
    required List<VpnServerConfigurationPolicyGroupPolicy> policies,
    int? priority,
  ...
  factory VpnServerConfigurationPolicyGroupArgs.fromMap(Map<String, dynamic> map) {
    return VpnServerConfigurationPolicyGroupArgs(
      ...
      policies: pulumi.Input.decodeList<VpnServerConfigurationPolicyGroupPolicy>(map['policies'], (value) => VpnServerConfigurationPolicyGroupPolicy.fromMap((value as Map).cast<String, dynamic>())),
