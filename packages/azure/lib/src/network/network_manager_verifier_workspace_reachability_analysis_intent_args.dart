...
class NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentArgs {
  ...
  NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentArgs({
    ...
    required NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentIpTraffic ipTraffic,
    String? name,
    required String sourceResourceId,
    required String verifierWorkspaceId,
  }) :
  ...
  factory NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentArgs.fromMap(Map<String, dynamic> map) {
    return NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentArgs(
      ...
      ipTraffic: NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentIpTraffic.fromMap((map['ipTraffic'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      sourceResourceId: map['sourceResourceId'] as String,
      verifierWorkspaceId: map['verifierWorkspaceId'] as String,
    );
  }
}
