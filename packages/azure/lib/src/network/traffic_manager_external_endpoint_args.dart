...
/// {@template pulumi_network_traffic_manager_external_endpoint_traffic_manager_external_endpoint_args_doc}
/// The set of arguments for TrafficManagerExternalEndpoint.
/// {@endtemplate}
/// {@macro pulumi_network_traffic_manager_external_endpoint_traffic_manager_external_endpoint_args_doc}
class TrafficManagerExternalEndpointArgs {
  ...
  TrafficManagerExternalEndpointArgs({
    bool? alwaysServeEnabled,
    List<TrafficManagerExternalEndpointCustomHeader>? customHeaders,
    bool? enabled,
    String? endpointLocation,
    List<String>? geoMappings,
    String? name,
    int? priority,
    required String profileId,
    List<TrafficManagerExternalEndpointSubnet>? subnets,
  ...
  factory TrafficManagerExternalEndpointArgs.fromMap(Map<String, dynamic> map) {
    return TrafficManagerExternalEndpointArgs(
      alwaysServeEnabled: map['alwaysServeEnabled'] == null ? null : map['alwaysServeEnabled'] as bool,
      customHeaders: map['customHeaders'] == null ? null : pulumi.Input.decodeList<TrafficManagerExternalEndpointCustomHeader>(map['customHeaders'], (value) => TrafficManagerExternalEndpointCustomHeader.fromMap((value as Map).cast<String, dynamic>())),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      endpointLocation: map['endpointLocation'] == null ? null : map['endpointLocation'] as String,
      geoMappings: map['geoMappings'] == null ? null : (map['geoMappings'] as List).cast<String>(),
      name: map['name'] == null ? null : map['name'] as String,
      priority: map['priority'] == null ? null : map['priority'] as int,
      profileId: map['profileId'] as String,
      subnets: map['subnets'] == null ? null : pulumi.Input.decodeList<TrafficManagerExternalEndpointSubnet>(map['subnets'], (value) => TrafficManagerExternalEndpointSubnet.fromMap((value as Map).cast<String, dynamic>())),
