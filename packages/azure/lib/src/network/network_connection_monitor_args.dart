...
class NetworkConnectionMonitorArgs {
  ...
  NetworkConnectionMonitorArgs({
    required List<NetworkConnectionMonitorEndpoint> endpoints,
    String? location,
    String? name,
    required String networkWatcherId,
    String? notes,
    List<String>? outputWorkspaceResourceIds,
    Map<String, String>? tags,
    required List<NetworkConnectionMonitorTestConfiguration> testConfigurations,
    required List<NetworkConnectionMonitorTestGroup> testGroups,
  }) :
  ...
  factory NetworkConnectionMonitorArgs.fromMap(Map<String, dynamic> map) {
    return NetworkConnectionMonitorArgs(
      endpoints: pulumi.Input.decodeList<NetworkConnectionMonitorEndpoint>(map['endpoints'], (value) => NetworkConnectionMonitorEndpoint.fromMap((value as Map).cast<String, dynamic>())),
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      networkWatcherId: map['networkWatcherId'] as String,
      notes: map['notes'] == null ? null : map['notes'] as String,
      outputWorkspaceResourceIds: map['outputWorkspaceResourceIds'] == null ? null : (map['outputWorkspaceResourceIds'] as List).cast<String>(),
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      testConfigurations: pulumi.Input.decodeList<NetworkConnectionMonitorTestConfiguration>(map['testConfigurations'], (value) => NetworkConnectionMonitorTestConfiguration.fromMap((value as Map).cast<String, dynamic>())),
      testGroups: pulumi.Input.decodeList<NetworkConnectionMonitorTestGroup>(map['testGroups'], (value) => NetworkConnectionMonitorTestGroup.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
