...
class ServiceAzureBotArgs {
  ...
  factory ServiceAzureBotArgs.fromMap(Map<String, dynamic> map) {
    return ServiceAzureBotArgs(
      cmkKeyVaultKeyUrl: map['cmkKeyVaultKeyUrl'] == null ? null : map['cmkKeyVaultKeyUrl'] as String,
      ...
      microsoftAppMsiId: map['microsoftAppMsiId'] == null ? null : map['microsoftAppMsiId'] as String,
      microsoftAppTenantId: map['microsoftAppTenantId'] == null ? null : map['microsoftAppTenantId'] as String,
      microsoftAppType: map['microsoftAppType'] == null ? null : map['microsoftAppType'] as String,
      ...
      streamingEndpointEnabled: map['streamingEndpointEnabled'] == null ? null : map['streamingEndpointEnabled'] as bool,
