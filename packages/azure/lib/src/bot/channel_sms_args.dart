...
class ChannelSmsArgs {
  ...
  ChannelSmsArgs({
    ...
    required String smsChannelAccountSecurityId,
    required String smsChannelAuthToken,
  }) :
  ...
  factory ChannelSmsArgs.fromMap(Map<String, dynamic> map) {
    return ChannelSmsArgs(
      ...
      smsChannelAccountSecurityId: map['smsChannelAccountSecurityId'] as String,
      smsChannelAuthToken: map['smsChannelAuthToken'] as String,
    );
  }
}
