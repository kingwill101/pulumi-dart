...
class ChannelWebChatArgs {
  ...
  factory ChannelWebChatArgs.fromMap(Map<String, dynamic> map) {
    return ChannelWebChatArgs(
      ...
      sites: map['sites'] == null ? null : pulumi.Input.decodeList<ChannelWebChatSite>(map['sites'], (value) => ChannelWebChatSite.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
