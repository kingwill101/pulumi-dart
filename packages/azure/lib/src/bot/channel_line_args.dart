...
class ChannelLineArgs {
  ...
  ChannelLineArgs({
    ...
    required List<ChannelLineLineChannel> lineChannels,
    String? location,
  ...
  factory ChannelLineArgs.fromMap(Map<String, dynamic> map) {
    return ChannelLineArgs(
      ...
      lineChannels: pulumi.Input.decodeList<ChannelLineLineChannel>(map['lineChannels'], (value) => ChannelLineLineChannel.fromMap((value as Map).cast<String, dynamic>())),
