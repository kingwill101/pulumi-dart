...
class ChannelDirectLineArgs {
  ...
  ChannelDirectLineArgs({
    ...
    required List<ChannelDirectLineSite> sites,
  }) :
  ...
  factory ChannelDirectLineArgs.fromMap(Map<String, dynamic> map) {
    return ChannelDirectLineArgs(
      ...
      sites: pulumi.Input.decodeList<ChannelDirectLineSite>(map['sites'], (value) => ChannelDirectLineSite.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
