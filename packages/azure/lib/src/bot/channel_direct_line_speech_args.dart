...
class ChannelDirectLineSpeechArgs {
  ...
  ChannelDirectLineSpeechArgs({
    ...
    required String cognitiveServiceAccessKey,
    required String cognitiveServiceLocation,
  ...
  factory ChannelDirectLineSpeechArgs.fromMap(Map<String, dynamic> map) {
    return ChannelDirectLineSpeechArgs(
      ...
      cognitiveAccountId: map['cognitiveAccountId'] == null ? null : map['cognitiveAccountId'] as String,
      cognitiveServiceAccessKey: map['cognitiveServiceAccessKey'] as String,
      cognitiveServiceLocation: map['cognitiveServiceLocation'] as String,
