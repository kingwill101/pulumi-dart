...
class AccountArgs {
  ...
  AccountArgs({
    AccountCors? cors,
    List<AccountDataStore>? dataStores,
  ...
  factory AccountArgs.fromMap(Map<String, dynamic> map) {
    return AccountArgs(
      cors: map['cors'] == null ? null : AccountCors.fromMap((map['cors'] as Map).cast<String, dynamic>()),
      dataStores: map['dataStores'] == null ? null : pulumi.Input.decodeList<AccountDataStore>(map['dataStores'], (value) => AccountDataStore.fromMap((value as Map).cast<String, dynamic>())),
