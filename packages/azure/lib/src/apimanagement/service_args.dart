...
class ServiceArgs {
  ...
  ServiceArgs({
    List<ServiceAdditionalLocation>? additionalLocations,
    List<ServiceCertificate>? certificates,
    bool? clientCertificateEnabled,
    ServiceDelegation? delegation,
    bool? gatewayDisabled,
    ServiceHostnameConfiguration? hostnameConfiguration,
    ServiceIdentity? identity,
    String? location,
    String? minApiVersion,
    String? name,
    String? notificationSenderEmail,
    ServiceProtocols? protocols,
    ...
    ServiceSignIn? signIn,
    ServiceSignUp? signUp,
    required String skuName,
    Map<String, String>? tags,
    ServiceTenantAccess? tenantAccess,
    ServiceVirtualNetworkConfiguration? virtualNetworkConfiguration,
  ...
  factory ServiceArgs.fromMap(Map<String, dynamic> map) {
    return ServiceArgs(
      additionalLocations: map['additionalLocations'] == null ? null : pulumi.Input.decodeList<ServiceAdditionalLocation>(map['additionalLocations'], (value) => ServiceAdditionalLocation.fromMap((value as Map).cast<String, dynamic>())),
      certificates: map['certificates'] == null ? null : pulumi.Input.decodeList<ServiceCertificate>(map['certificates'], (value) => ServiceCertificate.fromMap((value as Map).cast<String, dynamic>())),
      clientCertificateEnabled: map['clientCertificateEnabled'] == null ? null : map['clientCertificateEnabled'] as bool,
      delegation: map['delegation'] == null ? null : ServiceDelegation.fromMap((map['delegation'] as Map).cast<String, dynamic>()),
      gatewayDisabled: map['gatewayDisabled'] == null ? null : map['gatewayDisabled'] as bool,
      hostnameConfiguration: map['hostnameConfiguration'] == null ? null : ServiceHostnameConfiguration.fromMap((map['hostnameConfiguration'] as Map).cast<String, dynamic>()),
      ...
      protocols: map['protocols'] == null ? null : ServiceProtocols.fromMap((map['protocols'] as Map).cast<String, dynamic>()),
      ...
      signIn: map['signIn'] == null ? null : ServiceSignIn.fromMap((map['signIn'] as Map).cast<String, dynamic>()),
      signUp: map['signUp'] == null ? null : ServiceSignUp.fromMap((map['signUp'] as Map).cast<String, dynamic>()),
      skuName: map['skuName'] as String,
      tags: map['tags'] == null ? null : (map['tags'] as Map).cast<String, String>(),
      tenantAccess: map['tenantAccess'] == null ? null : ServiceTenantAccess.fromMap((map['tenantAccess'] as Map).cast<String, dynamic>()),
      virtualNetworkConfiguration: map['virtualNetworkConfiguration'] == null ? null : ServiceVirtualNetworkConfiguration.fromMap((map['virtualNetworkConfiguration'] as Map).cast<String, dynamic>()),
