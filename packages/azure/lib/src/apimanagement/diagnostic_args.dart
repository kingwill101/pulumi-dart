...
class DiagnosticArgs {
  ...
  DiagnosticArgs({
    ...
    DiagnosticBackendRequest? backendRequest,
    DiagnosticBackendResponse? backendResponse,
    DiagnosticFrontendRequest? frontendRequest,
    DiagnosticFrontendResponse? frontendResponse,
  ...
  factory DiagnosticArgs.fromMap(Map<String, dynamic> map) {
    return DiagnosticArgs(
      ...
      backendRequest: map['backendRequest'] == null ? null : DiagnosticBackendRequest.fromMap((map['backendRequest'] as Map).cast<String, dynamic>()),
      backendResponse: map['backendResponse'] == null ? null : DiagnosticBackendResponse.fromMap((map['backendResponse'] as Map).cast<String, dynamic>()),
      frontendRequest: map['frontendRequest'] == null ? null : DiagnosticFrontendRequest.fromMap((map['frontendRequest'] as Map).cast<String, dynamic>()),
      frontendResponse: map['frontendResponse'] == null ? null : DiagnosticFrontendResponse.fromMap((map['frontendResponse'] as Map).cast<String, dynamic>()),
