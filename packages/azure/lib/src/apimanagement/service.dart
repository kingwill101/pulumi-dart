...
class Service extends pulumi.CustomResource {
  ...
  Service(
    ...
    this.additionalLocations = registerOutput<List<ServiceAdditionalLocation>?>('additionalLocations');
    this.certificates = registerOutput<List<ServiceCertificate>?>('certificates');
    this.clientCertificateEnabled = registerOutput<bool?>('clientCertificateEnabled');
    this.delegation = registerOutput<ServiceDelegation>('delegation');
    this.developerPortalUrl = registerOutput<String>('developerPortalUrl');
    this.gatewayDisabled = registerOutput<bool?>('gatewayDisabled');
    this.gatewayRegionalUrl = registerOutput<String>('gatewayRegionalUrl');
    this.gatewayUrl = registerOutput<String>('gatewayUrl');
    this.hostnameConfiguration = registerOutput<ServiceHostnameConfiguration>('hostnameConfiguration');
    ...
    this.minApiVersion = registerOutput<String?>('minApiVersion');
    ...
    this.protocols = registerOutput<ServiceProtocols>('protocols');
    ...
    this.signIn = registerOutput<ServiceSignIn>('signIn');
    this.signUp = registerOutput<ServiceSignUp>('signUp');
    this.skuName = registerOutput<String>('skuName');
    this.tags = registerOutput<Map<String, String>?>('tags');
    this.tenantAccess = registerOutput<ServiceTenantAccess>('tenantAccess');
    this.virtualNetworkConfiguration = registerOutput<ServiceVirtualNetworkConfiguration?>('virtualNetworkConfiguration');
