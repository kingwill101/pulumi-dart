...
class StandaloneGatewayArgs {
  ...
  StandaloneGatewayArgs({
    ...
    required StandaloneGatewaySku sku,
  ...
  factory StandaloneGatewayArgs.fromMap(Map<String, dynamic> map) {
    return StandaloneGatewayArgs(
      backendSubnetId: map['backendSubnetId'] == null ? null : map['backendSubnetId'] as String,
      location: map['location'] == null ? null : map['location'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      resourceGroupName: map['resourceGroupName'] as String,
      sku: StandaloneGatewaySku.fromMap((map['sku'] as Map).cast<String, dynamic>()),
