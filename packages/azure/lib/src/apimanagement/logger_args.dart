...
class LoggerArgs {
  ...
  LoggerArgs({
    ...
    LoggerApplicationInsights? applicationInsights,
    bool? buffered,
    String? description,
    LoggerEventhub? eventhub,
    String? name,
  ...
  factory LoggerArgs.fromMap(Map<String, dynamic> map) {
    return LoggerArgs(
      ...
      applicationInsights: map['applicationInsights'] == null ? null : LoggerApplicationInsights.fromMap((map['applicationInsights'] as Map).cast<String, dynamic>()),
      buffered: map['buffered'] == null ? null : map['buffered'] as bool,
      description: map['description'] == null ? null : map['description'] as String,
      eventhub: map['eventhub'] == null ? null : LoggerEventhub.fromMap((map['eventhub'] as Map).cast<String, dynamic>()),
