...
class AuthorizationServerArgs {
  ...
  AuthorizationServerArgs({
    ...
    required List<String> authorizationMethods,
    ...
    bool? supportState,
    List<AuthorizationServerTokenBodyParameter>? tokenBodyParameters,
  ...
  factory AuthorizationServerArgs.fromMap(Map<String, dynamic> map) {
    return AuthorizationServerArgs(
      ...
      authorizationMethods: (map['authorizationMethods'] as List).cast<String>(),
      bearerTokenSendingMethods: map['bearerTokenSendingMethods'] == null ? null : (map['bearerTokenSendingMethods'] as List).cast<String>(),
      clientAuthenticationMethods: map['clientAuthenticationMethods'] == null ? null : (map['clientAuthenticationMethods'] as List).cast<String>(),
      ...
      tokenBodyParameters: map['tokenBodyParameters'] == null ? null : pulumi.Input.decodeList<AuthorizationServerTokenBodyParameter>(map['tokenBodyParameters'], (value) => AuthorizationServerTokenBodyParameter.fromMap((value as Map).cast<String, dynamic>())),
