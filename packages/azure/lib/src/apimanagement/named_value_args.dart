...
class NamedValueArgs {
  ...
  NamedValueArgs({
    ...
    List<String>? tags,
    String? value,
    NamedValueValueFromKeyVault? valueFromKeyVault,
  }) :
  ...
  factory NamedValueArgs.fromMap(Map<String, dynamic> map) {
    return NamedValueArgs(
      ...
      valueFromKeyVault: map['valueFromKeyVault'] == null ? null : NamedValueValueFromKeyVault.fromMap((map['valueFromKeyVault'] as Map).cast<String, dynamic>()),
    );
  }
}
