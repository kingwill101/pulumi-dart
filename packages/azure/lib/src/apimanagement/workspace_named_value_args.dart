...
class WorkspaceNamedValueArgs {
  ...
  WorkspaceNamedValueArgs({
    ...
    List<String>? tags,
    String? value,
    WorkspaceNamedValueValueFromKeyVault? valueFromKeyVault,
  }) :
  ...
  factory WorkspaceNamedValueArgs.fromMap(Map<String, dynamic> map) {
    return WorkspaceNamedValueArgs(
      ...
      valueFromKeyVault: map['valueFromKeyVault'] == null ? null : WorkspaceNamedValueValueFromKeyVault.fromMap((map['valueFromKeyVault'] as Map).cast<String, dynamic>()),
    );
  }
}
