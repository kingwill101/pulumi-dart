...
class ApiOperationArgs {
  ...
  ApiOperationArgs({
    ...
    List<ApiOperationResponse>? responses,
    List<ApiOperationTemplateParameter>? templateParameters,
  ...
  factory ApiOperationArgs.fromMap(Map<String, dynamic> map) {
    return ApiOperationArgs(
      ...
      request: map['request'] == null ? null : ApiOperationRequest.fromMap((map['request'] as Map).cast<String, dynamic>()),
      resourceGroupName: map['resourceGroupName'] as String,
      responses: map['responses'] == null ? null : pulumi.Input.decodeList<ApiOperationResponse>(map['responses'], (value) => ApiOperationResponse.fromMap((value as Map).cast<String, dynamic>())),
      templateParameters: map['templateParameters'] == null ? null : pulumi.Input.decodeList<ApiOperationTemplateParameter>(map['templateParameters'], (value) => ApiOperationTemplateParameter.fromMap((value as Map).cast<String, dynamic>())),
