...
class ModuleArgs {
  ...
  ModuleArgs({
    String? location,
    ModuleManagementNetworkProfile? managementNetworkProfile,
    String? name,
    required ModuleNetworkProfile networkProfile,
  ...
  factory ModuleArgs.fromMap(Map<String, dynamic> map) {
    return ModuleArgs(
      ...
      managementNetworkProfile: map['managementNetworkProfile'] == null ? null : ModuleManagementNetworkProfile.fromMap((map['managementNetworkProfile'] as Map).cast<String, dynamic>()),
      name: map['name'] == null ? null : map['name'] as String,
      networkProfile: ModuleNetworkProfile.fromMap((map['networkProfile'] as Map).cast<String, dynamic>()),
