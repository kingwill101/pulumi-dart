...
class HubArgs {
  ...
  HubArgs({
    HubApnsCredential? apnsCredential,
    HubBrowserCredential? browserCredential,
    HubGcmCredential? gcmCredential,
    String? location,
    String? name,
  ...
  factory HubArgs.fromMap(Map<String, dynamic> map) {
    return HubArgs(
      apnsCredential: map['apnsCredential'] == null ? null : HubApnsCredential.fromMap((map['apnsCredential'] as Map).cast<String, dynamic>()),
      browserCredential: map['browserCredential'] == null ? null : HubBrowserCredential.fromMap((map['browserCredential'] as Map).cast<String, dynamic>()),
      gcmCredential: map['gcmCredential'] == null ? null : HubGcmCredential.fromMap((map['gcmCredential'] as Map).cast<String, dynamic>()),
