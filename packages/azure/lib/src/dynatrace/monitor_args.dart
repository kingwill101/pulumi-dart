...
class MonitorArgs {
  ...
  MonitorArgs({
    List<MonitorEnvironmentProperty>? environmentProperties,
    required MonitorIdentity identity,
    String? location,
    required String marketplaceSubscription,
  ...
  factory MonitorArgs.fromMap(Map<String, dynamic> map) {
    return MonitorArgs(
      environmentProperties: map['environmentProperties'] == null ? null : pulumi.Input.decodeList<MonitorEnvironmentProperty>(map['environmentProperties'], (value) => MonitorEnvironmentProperty.fromMap((value as Map).cast<String, dynamic>())),
      identity: MonitorIdentity.fromMap((map['identity'] as Map).cast<String, dynamic>()),
      location: map['location'] == null ? null : map['location'] as String,
      marketplaceSubscription: map['marketplaceSubscription'] as String,
      monitoringEnabled: map['monitoringEnabled'] == null ? null : map['monitoringEnabled'] as bool,
