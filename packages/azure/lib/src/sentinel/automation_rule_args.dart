...
class AutomationRuleArgs {
  ...
  AutomationRuleArgs({
    List<AutomationRuleActionIncidentTask>? actionIncidentTasks,
    List<AutomationRuleActionIncident>? actionIncidents,
    List<AutomationRuleActionPlaybook>? actionPlaybooks,
  ...
  factory AutomationRuleArgs.fromMap(Map<String, dynamic> map) {
    return AutomationRuleArgs(
      actionIncidentTasks: map['actionIncidentTasks'] == null ? null : pulumi.Input.decodeList<AutomationRuleActionIncidentTask>(map['actionIncidentTasks'], (value) => AutomationRuleActionIncidentTask.fromMap((value as Map).cast<String, dynamic>())),
      actionIncidents: map['actionIncidents'] == null ? null : pulumi.Input.decodeList<AutomationRuleActionIncident>(map['actionIncidents'], (value) => AutomationRuleActionIncident.fromMap((value as Map).cast<String, dynamic>())),
      actionPlaybooks: map['actionPlaybooks'] == null ? null : pulumi.Input.decodeList<AutomationRuleActionPlaybook>(map['actionPlaybooks'], (value) => AutomationRuleActionPlaybook.fromMap((value as Map).cast<String, dynamic>())),
