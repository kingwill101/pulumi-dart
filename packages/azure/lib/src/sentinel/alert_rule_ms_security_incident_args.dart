...
class AlertRuleMsSecurityIncidentArgs {
  ...
  AlertRuleMsSecurityIncidentArgs({
    ...
    List<String>? displayNameExcludeFilters,
    List<String>? displayNameFilters,
    bool? enabled,
    required String logAnalyticsWorkspaceId,
    String? name,
    required String productFilter,
    required List<String> severityFilters,
  }) :
  ...
  factory AlertRuleMsSecurityIncidentArgs.fromMap(Map<String, dynamic> map) {
    return AlertRuleMsSecurityIncidentArgs(
      ...
      displayNameExcludeFilters: map['displayNameExcludeFilters'] == null ? null : (map['displayNameExcludeFilters'] as List).cast<String>(),
      displayNameFilters: map['displayNameFilters'] == null ? null : (map['displayNameFilters'] as List).cast<String>(),
      enabled: map['enabled'] == null ? null : map['enabled'] as bool,
      logAnalyticsWorkspaceId: map['logAnalyticsWorkspaceId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      productFilter: map['productFilter'] as String,
      severityFilters: (map['severityFilters'] as List).cast<String>(),
    );
  }
}
