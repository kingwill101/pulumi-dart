...
class ThreatIntelligenceIndicatorArgs {
  ...
  ThreatIntelligenceIndicatorArgs({
    ...
    String? extension,
    List<ThreatIntelligenceIndicatorExternalReference>? externalReferences,
    List<ThreatIntelligenceIndicatorGranularMarking>? granularMarkings,
    List<ThreatIntelligenceIndicatorKillChainPhase>? killChainPhases,
    String? language,
    ...
    required String validateFromUtc,
  ...
  factory ThreatIntelligenceIndicatorArgs.fromMap(Map<String, dynamic> map) {
    return ThreatIntelligenceIndicatorArgs(
      ...
      externalReferences: map['externalReferences'] == null ? null : pulumi.Input.decodeList<ThreatIntelligenceIndicatorExternalReference>(map['externalReferences'], (value) => ThreatIntelligenceIndicatorExternalReference.fromMap((value as Map).cast<String, dynamic>())),
      granularMarkings: map['granularMarkings'] == null ? null : pulumi.Input.decodeList<ThreatIntelligenceIndicatorGranularMarking>(map['granularMarkings'], (value) => ThreatIntelligenceIndicatorGranularMarking.fromMap((value as Map).cast<String, dynamic>())),
      killChainPhases: map['killChainPhases'] == null ? null : pulumi.Input.decodeList<ThreatIntelligenceIndicatorKillChainPhase>(map['killChainPhases'], (value) => ThreatIntelligenceIndicatorKillChainPhase.fromMap((value as Map).cast<String, dynamic>())),
      ...
      validateFromUtc: map['validateFromUtc'] as String,
      validateUntilUtc: map['validateUntilUtc'] == null ? null : map['validateUntilUtc'] as String,
