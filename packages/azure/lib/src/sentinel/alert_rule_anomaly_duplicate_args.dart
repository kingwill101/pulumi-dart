...
class AlertRuleAnomalyDuplicateArgs {
  ...
  AlertRuleAnomalyDuplicateArgs({
    required String builtInRuleId,
    required String displayName,
    required bool enabled,
    required String logAnalyticsWorkspaceId,
    required String mode,
    List<AlertRuleAnomalyDuplicateMultiSelectObservation>? multiSelectObservations,
    List<AlertRuleAnomalyDuplicatePrioritizedExcludeObservation>? prioritizedExcludeObservations,
    List<AlertRuleAnomalyDuplicateSingleSelectObservation>? singleSelectObservations,
    List<AlertRuleAnomalyDuplicateThresholdObservation>? thresholdObservations,
  }) :
  ...
  factory AlertRuleAnomalyDuplicateArgs.fromMap(Map<String, dynamic> map) {
    return AlertRuleAnomalyDuplicateArgs(
      builtInRuleId: map['builtInRuleId'] as String,
      displayName: map['displayName'] as String,
      enabled: map['enabled'] as bool,
      logAnalyticsWorkspaceId: map['logAnalyticsWorkspaceId'] as String,
      mode: map['mode'] as String,
      multiSelectObservations: map['multiSelectObservations'] == null ? null : pulumi.Input.decodeList<AlertRuleAnomalyDuplicateMultiSelectObservation>(map['multiSelectObservations'], (value) => AlertRuleAnomalyDuplicateMultiSelectObservation.fromMap((value as Map).cast<String, dynamic>())),
      prioritizedExcludeObservations: map['prioritizedExcludeObservations'] == null ? null : pulumi.Input.decodeList<AlertRuleAnomalyDuplicatePrioritizedExcludeObservation>(map['prioritizedExcludeObservations'], (value) => AlertRuleAnomalyDuplicatePrioritizedExcludeObservation.fromMap((value as Map).cast<String, dynamic>())),
      singleSelectObservations: map['singleSelectObservations'] == null ? null : pulumi.Input.decodeList<AlertRuleAnomalyDuplicateSingleSelectObservation>(map['singleSelectObservations'], (value) => AlertRuleAnomalyDuplicateSingleSelectObservation.fromMap((value as Map).cast<String, dynamic>())),
      thresholdObservations: map['thresholdObservations'] == null ? null : pulumi.Input.decodeList<AlertRuleAnomalyDuplicateThresholdObservation>(map['thresholdObservations'], (value) => AlertRuleAnomalyDuplicateThresholdObservation.fromMap((value as Map).cast<String, dynamic>())),
    );
  }
}
