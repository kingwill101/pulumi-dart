...
class AlertRuleScheduledArgs {
  ...
  AlertRuleScheduledArgs({
    ...
    bool? enabled,
    List<AlertRuleScheduledEntityMapping>? entityMappings,
    AlertRuleScheduledEventGrouping? eventGrouping,
    AlertRuleScheduledIncident? incident,
    required String logAnalyticsWorkspaceId,
    String? name,
    required String query,
    String? queryFrequency,
    String? queryPeriod,
    List<AlertRuleScheduledSentinelEntityMapping>? sentinelEntityMappings,
  ...
  factory AlertRuleScheduledArgs.fromMap(Map<String, dynamic> map) {
    return AlertRuleScheduledArgs(
      alertDetailsOverrides: map['alertDetailsOverrides'] == null ? null : pulumi.Input.decodeList<AlertRuleScheduledAlertDetailsOverride>(map['alertDetailsOverrides'], (value) => AlertRuleScheduledAlertDetailsOverride.fromMap((value as Map).cast<String, dynamic>())),
      ...
      entityMappings: map['entityMappings'] == null ? null : pulumi.Input.decodeList<AlertRuleScheduledEntityMapping>(map['entityMappings'], (value) => AlertRuleScheduledEntityMapping.fromMap((value as Map).cast<String, dynamic>())),
      eventGrouping: map['eventGrouping'] == null ? null : AlertRuleScheduledEventGrouping.fromMap((map['eventGrouping'] as Map).cast<String, dynamic>()),
      incident: map['incident'] == null ? null : AlertRuleScheduledIncident.fromMap((map['incident'] as Map).cast<String, dynamic>()),
      logAnalyticsWorkspaceId: map['logAnalyticsWorkspaceId'] as String,
      name: map['name'] == null ? null : map['name'] as String,
      query: map['query'] as String,
      queryFrequency: map['queryFrequency'] == null ? null : map['queryFrequency'] as String,
      queryPeriod: map['queryPeriod'] == null ? null : map['queryPeriod'] as String,
      sentinelEntityMappings: map['sentinelEntityMappings'] == null ? null : pulumi.Input.decodeList<AlertRuleScheduledSentinelEntityMapping>(map['sentinelEntityMappings'], (value) => AlertRuleScheduledSentinelEntityMapping.fromMap((value as Map).cast<String, dynamic>())),
      ...
      triggerOperator: map['triggerOperator'] == null ? null : map['triggerOperator'] as String,
      triggerThreshold: map['triggerThreshold'] == null ? null : map['triggerThreshold'] as int,
    );
  }
}
